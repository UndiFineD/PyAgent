...
@Data
public class Idea64906Config {
    private String name = "idea_064906";
 ...
 */
@Slf4j
public class Idea64906Service {
    private static final int IDEA_ID = 64906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64906Service() {
        this(new Idea64906Config());
    }

    public Idea64906Service(Idea64906Config config) {
        this.config = config != null ? config : new Idea64906Config();
