...
@Data
public class Idea64640Config {
    private String name = "idea_064640";
 ...
 */
@Slf4j
public class Idea64640Service {
    private static final int IDEA_ID = 64640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64640Service() {
        this(new Idea64640Config());
    }

    public Idea64640Service(Idea64640Config config) {
        this.config = config != null ? config : new Idea64640Config();
