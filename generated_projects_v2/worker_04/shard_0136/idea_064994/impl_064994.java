...
@Data
public class Idea64994Config {
    private String name = "idea_064994";
 ...
 */
@Slf4j
public class Idea64994Service {
    private static final int IDEA_ID = 64994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64994Service() {
        this(new Idea64994Config());
    }

    public Idea64994Service(Idea64994Config config) {
        this.config = config != null ? config : new Idea64994Config();
