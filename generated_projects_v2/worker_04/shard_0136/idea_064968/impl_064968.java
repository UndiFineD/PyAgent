...
@Data
public class Idea64968Config {
    private String name = "idea_064968";
 ...
 */
@Slf4j
public class Idea64968Service {
    private static final int IDEA_ID = 64968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64968Service() {
        this(new Idea64968Config());
    }

    public Idea64968Service(Idea64968Config config) {
        this.config = config != null ? config : new Idea64968Config();
