...
@Data
public class Idea64779Config {
    private String name = "idea_064779";
 ...
 */
@Slf4j
public class Idea64779Service {
    private static final int IDEA_ID = 64779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64779Service() {
        this(new Idea64779Config());
    }

    public Idea64779Service(Idea64779Config config) {
        this.config = config != null ? config : new Idea64779Config();
