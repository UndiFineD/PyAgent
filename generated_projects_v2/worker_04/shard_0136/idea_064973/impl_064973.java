...
@Data
public class Idea64973Config {
    private String name = "idea_064973";
 ...
 */
@Slf4j
public class Idea64973Service {
    private static final int IDEA_ID = 64973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64973Service() {
        this(new Idea64973Config());
    }

    public Idea64973Service(Idea64973Config config) {
        this.config = config != null ? config : new Idea64973Config();
