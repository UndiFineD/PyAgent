...
@Data
public class Idea64790Config {
    private String name = "idea_064790";
 ...
 */
@Slf4j
public class Idea64790Service {
    private static final int IDEA_ID = 64790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64790Service() {
        this(new Idea64790Config());
    }

    public Idea64790Service(Idea64790Config config) {
        this.config = config != null ? config : new Idea64790Config();
