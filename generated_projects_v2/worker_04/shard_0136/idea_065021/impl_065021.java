...
@Data
public class Idea65021Config {
    private String name = "idea_065021";
 ...
 */
@Slf4j
public class Idea65021Service {
    private static final int IDEA_ID = 65021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65021Service() {
        this(new Idea65021Config());
    }

    public Idea65021Service(Idea65021Config config) {
        this.config = config != null ? config : new Idea65021Config();
