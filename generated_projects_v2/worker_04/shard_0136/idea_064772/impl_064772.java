...
@Data
public class Idea64772Config {
    private String name = "idea_064772";
 ...
 */
@Slf4j
public class Idea64772Service {
    private static final int IDEA_ID = 64772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64772Service() {
        this(new Idea64772Config());
    }

    public Idea64772Service(Idea64772Config config) {
        this.config = config != null ? config : new Idea64772Config();
