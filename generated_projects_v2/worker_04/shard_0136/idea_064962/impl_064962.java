...
@Data
public class Idea64962Config {
    private String name = "idea_064962";
 ...
 */
@Slf4j
public class Idea64962Service {
    private static final int IDEA_ID = 64962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64962Service() {
        this(new Idea64962Config());
    }

    public Idea64962Service(Idea64962Config config) {
        this.config = config != null ? config : new Idea64962Config();
