...
@Data
public class Idea64953Config {
    private String name = "idea_064953";
 ...
 */
@Slf4j
public class Idea64953Service {
    private static final int IDEA_ID = 64953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64953Service() {
        this(new Idea64953Config());
    }

    public Idea64953Service(Idea64953Config config) {
        this.config = config != null ? config : new Idea64953Config();
