...
@Data
public class Idea64674Config {
    private String name = "idea_064674";
 ...
 */
@Slf4j
public class Idea64674Service {
    private static final int IDEA_ID = 64674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64674Service() {
        this(new Idea64674Config());
    }

    public Idea64674Service(Idea64674Config config) {
        this.config = config != null ? config : new Idea64674Config();
