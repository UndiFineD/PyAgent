...
@Data
public class Idea64986Config {
    private String name = "idea_064986";
 ...
 */
@Slf4j
public class Idea64986Service {
    private static final int IDEA_ID = 64986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64986Service() {
        this(new Idea64986Config());
    }

    public Idea64986Service(Idea64986Config config) {
        this.config = config != null ? config : new Idea64986Config();
