...
@Data
public class Idea64613Config {
    private String name = "idea_064613";
 ...
 */
@Slf4j
public class Idea64613Service {
    private static final int IDEA_ID = 64613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64613Service() {
        this(new Idea64613Config());
    }

    public Idea64613Service(Idea64613Config config) {
        this.config = config != null ? config : new Idea64613Config();
