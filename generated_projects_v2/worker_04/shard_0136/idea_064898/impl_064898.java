...
@Data
public class Idea64898Config {
    private String name = "idea_064898";
 ...
 */
@Slf4j
public class Idea64898Service {
    private static final int IDEA_ID = 64898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64898Service() {
        this(new Idea64898Config());
    }

    public Idea64898Service(Idea64898Config config) {
        this.config = config != null ? config : new Idea64898Config();
