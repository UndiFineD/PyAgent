...
@Data
public class Idea64840Config {
    private String name = "idea_064840";
 ...
 */
@Slf4j
public class Idea64840Service {
    private static final int IDEA_ID = 64840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64840Service() {
        this(new Idea64840Config());
    }

    public Idea64840Service(Idea64840Config config) {
        this.config = config != null ? config : new Idea64840Config();
