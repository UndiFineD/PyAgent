...
@Data
public class Idea64635Config {
    private String name = "idea_064635";
 ...
 */
@Slf4j
public class Idea64635Service {
    private static final int IDEA_ID = 64635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64635Service() {
        this(new Idea64635Config());
    }

    public Idea64635Service(Idea64635Config config) {
        this.config = config != null ? config : new Idea64635Config();
