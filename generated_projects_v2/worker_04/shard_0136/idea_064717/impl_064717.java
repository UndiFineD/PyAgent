...
@Data
public class Idea64717Config {
    private String name = "idea_064717";
 ...
 */
@Slf4j
public class Idea64717Service {
    private static final int IDEA_ID = 64717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64717Service() {
        this(new Idea64717Config());
    }

    public Idea64717Service(Idea64717Config config) {
        this.config = config != null ? config : new Idea64717Config();
