...
@Data
public class Idea64652Config {
    private String name = "idea_064652";
 ...
 */
@Slf4j
public class Idea64652Service {
    private static final int IDEA_ID = 64652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64652Service() {
        this(new Idea64652Config());
    }

    public Idea64652Service(Idea64652Config config) {
        this.config = config != null ? config : new Idea64652Config();
