...
@Data
public class Idea64843Config {
    private String name = "idea_064843";
 ...
 */
@Slf4j
public class Idea64843Service {
    private static final int IDEA_ID = 64843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64843Service() {
        this(new Idea64843Config());
    }

    public Idea64843Service(Idea64843Config config) {
        this.config = config != null ? config : new Idea64843Config();
