...
@Data
public class Idea64990Config {
    private String name = "idea_064990";
 ...
 */
@Slf4j
public class Idea64990Service {
    private static final int IDEA_ID = 64990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64990Service() {
        this(new Idea64990Config());
    }

    public Idea64990Service(Idea64990Config config) {
        this.config = config != null ? config : new Idea64990Config();
