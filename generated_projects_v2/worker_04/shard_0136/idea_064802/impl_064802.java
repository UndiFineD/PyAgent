...
@Data
public class Idea64802Config {
    private String name = "idea_064802";
 ...
 */
@Slf4j
public class Idea64802Service {
    private static final int IDEA_ID = 64802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64802Service() {
        this(new Idea64802Config());
    }

    public Idea64802Service(Idea64802Config config) {
        this.config = config != null ? config : new Idea64802Config();
