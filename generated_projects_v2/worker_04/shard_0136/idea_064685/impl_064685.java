...
@Data
public class Idea64685Config {
    private String name = "idea_064685";
 ...
 */
@Slf4j
public class Idea64685Service {
    private static final int IDEA_ID = 64685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64685Service() {
        this(new Idea64685Config());
    }

    public Idea64685Service(Idea64685Config config) {
        this.config = config != null ? config : new Idea64685Config();
