...
@Data
public class Idea64719Config {
    private String name = "idea_064719";
 ...
 */
@Slf4j
public class Idea64719Service {
    private static final int IDEA_ID = 64719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64719Service() {
        this(new Idea64719Config());
    }

    public Idea64719Service(Idea64719Config config) {
        this.config = config != null ? config : new Idea64719Config();
