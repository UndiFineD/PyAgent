...
@Data
public class Idea64693Config {
    private String name = "idea_064693";
 ...
 */
@Slf4j
public class Idea64693Service {
    private static final int IDEA_ID = 64693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64693Service() {
        this(new Idea64693Config());
    }

    public Idea64693Service(Idea64693Config config) {
        this.config = config != null ? config : new Idea64693Config();
