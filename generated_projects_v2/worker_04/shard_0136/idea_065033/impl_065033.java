...
@Data
public class Idea65033Config {
    private String name = "idea_065033";
 ...
 */
@Slf4j
public class Idea65033Service {
    private static final int IDEA_ID = 65033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65033Service() {
        this(new Idea65033Config());
    }

    public Idea65033Service(Idea65033Config config) {
        this.config = config != null ? config : new Idea65033Config();
