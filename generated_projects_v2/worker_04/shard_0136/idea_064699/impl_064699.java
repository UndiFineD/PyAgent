...
@Data
public class Idea64699Config {
    private String name = "idea_064699";
 ...
 */
@Slf4j
public class Idea64699Service {
    private static final int IDEA_ID = 64699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64699Service() {
        this(new Idea64699Config());
    }

    public Idea64699Service(Idea64699Config config) {
        this.config = config != null ? config : new Idea64699Config();
