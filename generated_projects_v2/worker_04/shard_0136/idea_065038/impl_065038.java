...
@Data
public class Idea65038Config {
    private String name = "idea_065038";
 ...
 */
@Slf4j
public class Idea65038Service {
    private static final int IDEA_ID = 65038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65038Service() {
        this(new Idea65038Config());
    }

    public Idea65038Service(Idea65038Config config) {
        this.config = config != null ? config : new Idea65038Config();
