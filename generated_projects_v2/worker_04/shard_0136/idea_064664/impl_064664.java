...
@Data
public class Idea64664Config {
    private String name = "idea_064664";
 ...
 */
@Slf4j
public class Idea64664Service {
    private static final int IDEA_ID = 64664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64664Service() {
        this(new Idea64664Config());
    }

    public Idea64664Service(Idea64664Config config) {
        this.config = config != null ? config : new Idea64664Config();
