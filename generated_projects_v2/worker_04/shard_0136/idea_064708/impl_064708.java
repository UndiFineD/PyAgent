...
@Data
public class Idea64708Config {
    private String name = "idea_064708";
 ...
 */
@Slf4j
public class Idea64708Service {
    private static final int IDEA_ID = 64708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64708Service() {
        this(new Idea64708Config());
    }

    public Idea64708Service(Idea64708Config config) {
        this.config = config != null ? config : new Idea64708Config();
