...
@Data
public class Idea64873Config {
    private String name = "idea_064873";
 ...
 */
@Slf4j
public class Idea64873Service {
    private static final int IDEA_ID = 64873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64873Service() {
        this(new Idea64873Config());
    }

    public Idea64873Service(Idea64873Config config) {
        this.config = config != null ? config : new Idea64873Config();
