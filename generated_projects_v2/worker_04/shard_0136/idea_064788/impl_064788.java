...
@Data
public class Idea64788Config {
    private String name = "idea_064788";
 ...
 */
@Slf4j
public class Idea64788Service {
    private static final int IDEA_ID = 64788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64788Service() {
        this(new Idea64788Config());
    }

    public Idea64788Service(Idea64788Config config) {
        this.config = config != null ? config : new Idea64788Config();
