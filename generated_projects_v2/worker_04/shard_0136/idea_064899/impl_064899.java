...
@Data
public class Idea64899Config {
    private String name = "idea_064899";
 ...
 */
@Slf4j
public class Idea64899Service {
    private static final int IDEA_ID = 64899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64899Service() {
        this(new Idea64899Config());
    }

    public Idea64899Service(Idea64899Config config) {
        this.config = config != null ? config : new Idea64899Config();
