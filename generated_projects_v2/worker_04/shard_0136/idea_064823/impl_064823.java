...
@Data
public class Idea64823Config {
    private String name = "idea_064823";
 ...
 */
@Slf4j
public class Idea64823Service {
    private static final int IDEA_ID = 64823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64823Service() {
        this(new Idea64823Config());
    }

    public Idea64823Service(Idea64823Config config) {
        this.config = config != null ? config : new Idea64823Config();
