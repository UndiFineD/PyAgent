...
@Data
public class Idea64971Config {
    private String name = "idea_064971";
 ...
 */
@Slf4j
public class Idea64971Service {
    private static final int IDEA_ID = 64971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64971Service() {
        this(new Idea64971Config());
    }

    public Idea64971Service(Idea64971Config config) {
        this.config = config != null ? config : new Idea64971Config();
