...
@Data
public class Idea64633Config {
    private String name = "idea_064633";
 ...
 */
@Slf4j
public class Idea64633Service {
    private static final int IDEA_ID = 64633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64633Service() {
        this(new Idea64633Config());
    }

    public Idea64633Service(Idea64633Config config) {
        this.config = config != null ? config : new Idea64633Config();
