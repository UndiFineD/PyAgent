...
@Data
public class Idea64858Config {
    private String name = "idea_064858";
 ...
 */
@Slf4j
public class Idea64858Service {
    private static final int IDEA_ID = 64858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64858Service() {
        this(new Idea64858Config());
    }

    public Idea64858Service(Idea64858Config config) {
        this.config = config != null ? config : new Idea64858Config();
