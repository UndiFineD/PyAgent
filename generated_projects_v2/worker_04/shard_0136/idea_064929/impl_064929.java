...
@Data
public class Idea64929Config {
    private String name = "idea_064929";
 ...
 */
@Slf4j
public class Idea64929Service {
    private static final int IDEA_ID = 64929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64929Service() {
        this(new Idea64929Config());
    }

    public Idea64929Service(Idea64929Config config) {
        this.config = config != null ? config : new Idea64929Config();
