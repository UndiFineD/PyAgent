...
@Data
public class Idea64626Config {
    private String name = "idea_064626";
 ...
 */
@Slf4j
public class Idea64626Service {
    private static final int IDEA_ID = 64626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64626Service() {
        this(new Idea64626Config());
    }

    public Idea64626Service(Idea64626Config config) {
        this.config = config != null ? config : new Idea64626Config();
