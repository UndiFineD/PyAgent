...
@Data
public class Idea64606Config {
    private String name = "idea_064606";
 ...
 */
@Slf4j
public class Idea64606Service {
    private static final int IDEA_ID = 64606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64606Service() {
        this(new Idea64606Config());
    }

    public Idea64606Service(Idea64606Config config) {
        this.config = config != null ? config : new Idea64606Config();
