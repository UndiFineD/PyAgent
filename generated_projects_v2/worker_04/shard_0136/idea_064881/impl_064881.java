...
@Data
public class Idea64881Config {
    private String name = "idea_064881";
 ...
 */
@Slf4j
public class Idea64881Service {
    private static final int IDEA_ID = 64881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64881Service() {
        this(new Idea64881Config());
    }

    public Idea64881Service(Idea64881Config config) {
        this.config = config != null ? config : new Idea64881Config();
