...
@Data
public class Idea64907Config {
    private String name = "idea_064907";
 ...
 */
@Slf4j
public class Idea64907Service {
    private static final int IDEA_ID = 64907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64907Service() {
        this(new Idea64907Config());
    }

    public Idea64907Service(Idea64907Config config) {
        this.config = config != null ? config : new Idea64907Config();
