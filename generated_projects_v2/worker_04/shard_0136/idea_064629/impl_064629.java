...
@Data
public class Idea64629Config {
    private String name = "idea_064629";
 ...
 */
@Slf4j
public class Idea64629Service {
    private static final int IDEA_ID = 64629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64629Service() {
        this(new Idea64629Config());
    }

    public Idea64629Service(Idea64629Config config) {
        this.config = config != null ? config : new Idea64629Config();
