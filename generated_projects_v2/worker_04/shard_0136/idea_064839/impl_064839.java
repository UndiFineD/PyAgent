...
@Data
public class Idea64839Config {
    private String name = "idea_064839";
 ...
 */
@Slf4j
public class Idea64839Service {
    private static final int IDEA_ID = 64839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64839Service() {
        this(new Idea64839Config());
    }

    public Idea64839Service(Idea64839Config config) {
        this.config = config != null ? config : new Idea64839Config();
