...
@Data
public class Idea64855Config {
    private String name = "idea_064855";
 ...
 */
@Slf4j
public class Idea64855Service {
    private static final int IDEA_ID = 64855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64855Service() {
        this(new Idea64855Config());
    }

    public Idea64855Service(Idea64855Config config) {
        this.config = config != null ? config : new Idea64855Config();
