...
@Data
public class Idea64730Config {
    private String name = "idea_064730";
 ...
 */
@Slf4j
public class Idea64730Service {
    private static final int IDEA_ID = 64730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64730Service() {
        this(new Idea64730Config());
    }

    public Idea64730Service(Idea64730Config config) {
        this.config = config != null ? config : new Idea64730Config();
