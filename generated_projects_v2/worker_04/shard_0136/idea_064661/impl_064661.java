...
@Data
public class Idea64661Config {
    private String name = "idea_064661";
 ...
 */
@Slf4j
public class Idea64661Service {
    private static final int IDEA_ID = 64661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64661Service() {
        this(new Idea64661Config());
    }

    public Idea64661Service(Idea64661Config config) {
        this.config = config != null ? config : new Idea64661Config();
