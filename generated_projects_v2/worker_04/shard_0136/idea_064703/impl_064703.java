...
@Data
public class Idea64703Config {
    private String name = "idea_064703";
 ...
 */
@Slf4j
public class Idea64703Service {
    private static final int IDEA_ID = 64703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64703Service() {
        this(new Idea64703Config());
    }

    public Idea64703Service(Idea64703Config config) {
        this.config = config != null ? config : new Idea64703Config();
