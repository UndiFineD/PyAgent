...
@Data
public class Idea64632Config {
    private String name = "idea_064632";
 ...
 */
@Slf4j
public class Idea64632Service {
    private static final int IDEA_ID = 64632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64632Service() {
        this(new Idea64632Config());
    }

    public Idea64632Service(Idea64632Config config) {
        this.config = config != null ? config : new Idea64632Config();
