...
@Data
public class Idea64838Config {
    private String name = "idea_064838";
 ...
 */
@Slf4j
public class Idea64838Service {
    private static final int IDEA_ID = 64838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64838Service() {
        this(new Idea64838Config());
    }

    public Idea64838Service(Idea64838Config config) {
        this.config = config != null ? config : new Idea64838Config();
