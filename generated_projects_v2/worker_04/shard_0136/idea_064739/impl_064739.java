...
@Data
public class Idea64739Config {
    private String name = "idea_064739";
 ...
 */
@Slf4j
public class Idea64739Service {
    private static final int IDEA_ID = 64739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64739Service() {
        this(new Idea64739Config());
    }

    public Idea64739Service(Idea64739Config config) {
        this.config = config != null ? config : new Idea64739Config();
