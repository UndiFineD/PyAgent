...
@Data
public class Idea64952Config {
    private String name = "idea_064952";
 ...
 */
@Slf4j
public class Idea64952Service {
    private static final int IDEA_ID = 64952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64952Service() {
        this(new Idea64952Config());
    }

    public Idea64952Service(Idea64952Config config) {
        this.config = config != null ? config : new Idea64952Config();
