...
@Data
public class Idea64712Config {
    private String name = "idea_064712";
 ...
 */
@Slf4j
public class Idea64712Service {
    private static final int IDEA_ID = 64712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64712Service() {
        this(new Idea64712Config());
    }

    public Idea64712Service(Idea64712Config config) {
        this.config = config != null ? config : new Idea64712Config();
