...
@Data
public class Idea64741Config {
    private String name = "idea_064741";
 ...
 */
@Slf4j
public class Idea64741Service {
    private static final int IDEA_ID = 64741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64741Service() {
        this(new Idea64741Config());
    }

    public Idea64741Service(Idea64741Config config) {
        this.config = config != null ? config : new Idea64741Config();
