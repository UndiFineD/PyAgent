...
@Data
public class Idea64616Config {
    private String name = "idea_064616";
 ...
 */
@Slf4j
public class Idea64616Service {
    private static final int IDEA_ID = 64616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64616Service() {
        this(new Idea64616Config());
    }

    public Idea64616Service(Idea64616Config config) {
        this.config = config != null ? config : new Idea64616Config();
