...
@Data
public class Idea64770Config {
    private String name = "idea_064770";
 ...
 */
@Slf4j
public class Idea64770Service {
    private static final int IDEA_ID = 64770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64770Service() {
        this(new Idea64770Config());
    }

    public Idea64770Service(Idea64770Config config) {
        this.config = config != null ? config : new Idea64770Config();
