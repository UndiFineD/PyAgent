...
@Data
public class Idea64834Config {
    private String name = "idea_064834";
 ...
 */
@Slf4j
public class Idea64834Service {
    private static final int IDEA_ID = 64834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64834Service() {
        this(new Idea64834Config());
    }

    public Idea64834Service(Idea64834Config config) {
        this.config = config != null ? config : new Idea64834Config();
