...
@Data
public class Idea64865Config {
    private String name = "idea_064865";
 ...
 */
@Slf4j
public class Idea64865Service {
    private static final int IDEA_ID = 64865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64865Service() {
        this(new Idea64865Config());
    }

    public Idea64865Service(Idea64865Config config) {
        this.config = config != null ? config : new Idea64865Config();
