...
@Data
public class Idea64951Config {
    private String name = "idea_064951";
 ...
 */
@Slf4j
public class Idea64951Service {
    private static final int IDEA_ID = 64951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64951Service() {
        this(new Idea64951Config());
    }

    public Idea64951Service(Idea64951Config config) {
        this.config = config != null ? config : new Idea64951Config();
