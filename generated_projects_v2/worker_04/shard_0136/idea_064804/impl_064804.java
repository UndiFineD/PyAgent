...
@Data
public class Idea64804Config {
    private String name = "idea_064804";
 ...
 */
@Slf4j
public class Idea64804Service {
    private static final int IDEA_ID = 64804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64804Service() {
        this(new Idea64804Config());
    }

    public Idea64804Service(Idea64804Config config) {
        this.config = config != null ? config : new Idea64804Config();
