...
@Data
public class Idea64651Config {
    private String name = "idea_064651";
 ...
 */
@Slf4j
public class Idea64651Service {
    private static final int IDEA_ID = 64651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64651Service() {
        this(new Idea64651Config());
    }

    public Idea64651Service(Idea64651Config config) {
        this.config = config != null ? config : new Idea64651Config();
