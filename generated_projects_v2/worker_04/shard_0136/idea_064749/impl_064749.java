...
@Data
public class Idea64749Config {
    private String name = "idea_064749";
 ...
 */
@Slf4j
public class Idea64749Service {
    private static final int IDEA_ID = 64749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64749Service() {
        this(new Idea64749Config());
    }

    public Idea64749Service(Idea64749Config config) {
        this.config = config != null ? config : new Idea64749Config();
