...
@Data
public class Idea64875Config {
    private String name = "idea_064875";
 ...
 */
@Slf4j
public class Idea64875Service {
    private static final int IDEA_ID = 64875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64875Service() {
        this(new Idea64875Config());
    }

    public Idea64875Service(Idea64875Config config) {
        this.config = config != null ? config : new Idea64875Config();
