...
@Data
public class Idea64902Config {
    private String name = "idea_064902";
 ...
 */
@Slf4j
public class Idea64902Service {
    private static final int IDEA_ID = 64902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64902Service() {
        this(new Idea64902Config());
    }

    public Idea64902Service(Idea64902Config config) {
        this.config = config != null ? config : new Idea64902Config();
