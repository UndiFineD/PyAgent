...
@Data
public class Idea64622Config {
    private String name = "idea_064622";
 ...
 */
@Slf4j
public class Idea64622Service {
    private static final int IDEA_ID = 64622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64622Service() {
        this(new Idea64622Config());
    }

    public Idea64622Service(Idea64622Config config) {
        this.config = config != null ? config : new Idea64622Config();
