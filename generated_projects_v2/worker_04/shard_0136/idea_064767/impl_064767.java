...
@Data
public class Idea64767Config {
    private String name = "idea_064767";
 ...
 */
@Slf4j
public class Idea64767Service {
    private static final int IDEA_ID = 64767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64767Service() {
        this(new Idea64767Config());
    }

    public Idea64767Service(Idea64767Config config) {
        this.config = config != null ? config : new Idea64767Config();
