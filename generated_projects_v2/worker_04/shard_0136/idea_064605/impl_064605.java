...
@Data
public class Idea64605Config {
    private String name = "idea_064605";
 ...
 */
@Slf4j
public class Idea64605Service {
    private static final int IDEA_ID = 64605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64605Service() {
        this(new Idea64605Config());
    }

    public Idea64605Service(Idea64605Config config) {
        this.config = config != null ? config : new Idea64605Config();
