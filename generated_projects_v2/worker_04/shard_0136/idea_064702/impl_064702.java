...
@Data
public class Idea64702Config {
    private String name = "idea_064702";
 ...
 */
@Slf4j
public class Idea64702Service {
    private static final int IDEA_ID = 64702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64702Service() {
        this(new Idea64702Config());
    }

    public Idea64702Service(Idea64702Config config) {
        this.config = config != null ? config : new Idea64702Config();
