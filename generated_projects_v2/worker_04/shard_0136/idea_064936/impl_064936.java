...
@Data
public class Idea64936Config {
    private String name = "idea_064936";
 ...
 */
@Slf4j
public class Idea64936Service {
    private static final int IDEA_ID = 64936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64936Service() {
        this(new Idea64936Config());
    }

    public Idea64936Service(Idea64936Config config) {
        this.config = config != null ? config : new Idea64936Config();
