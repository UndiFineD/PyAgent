...
@Data
public class Idea64733Config {
    private String name = "idea_064733";
 ...
 */
@Slf4j
public class Idea64733Service {
    private static final int IDEA_ID = 64733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64733Service() {
        this(new Idea64733Config());
    }

    public Idea64733Service(Idea64733Config config) {
        this.config = config != null ? config : new Idea64733Config();
