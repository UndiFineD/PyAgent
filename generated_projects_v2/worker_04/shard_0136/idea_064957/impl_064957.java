...
@Data
public class Idea64957Config {
    private String name = "idea_064957";
 ...
 */
@Slf4j
public class Idea64957Service {
    private static final int IDEA_ID = 64957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64957Service() {
        this(new Idea64957Config());
    }

    public Idea64957Service(Idea64957Config config) {
        this.config = config != null ? config : new Idea64957Config();
