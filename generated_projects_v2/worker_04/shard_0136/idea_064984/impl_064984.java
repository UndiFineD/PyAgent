...
@Data
public class Idea64984Config {
    private String name = "idea_064984";
 ...
 */
@Slf4j
public class Idea64984Service {
    private static final int IDEA_ID = 64984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64984Service() {
        this(new Idea64984Config());
    }

    public Idea64984Service(Idea64984Config config) {
        this.config = config != null ? config : new Idea64984Config();
