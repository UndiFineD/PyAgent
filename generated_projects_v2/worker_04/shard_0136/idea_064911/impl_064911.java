...
@Data
public class Idea64911Config {
    private String name = "idea_064911";
 ...
 */
@Slf4j
public class Idea64911Service {
    private static final int IDEA_ID = 64911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64911Service() {
        this(new Idea64911Config());
    }

    public Idea64911Service(Idea64911Config config) {
        this.config = config != null ? config : new Idea64911Config();
