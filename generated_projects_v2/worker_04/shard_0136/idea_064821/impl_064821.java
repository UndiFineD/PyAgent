...
@Data
public class Idea64821Config {
    private String name = "idea_064821";
 ...
 */
@Slf4j
public class Idea64821Service {
    private static final int IDEA_ID = 64821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64821Service() {
        this(new Idea64821Config());
    }

    public Idea64821Service(Idea64821Config config) {
        this.config = config != null ? config : new Idea64821Config();
