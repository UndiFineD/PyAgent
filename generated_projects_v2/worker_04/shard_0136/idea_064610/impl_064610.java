...
@Data
public class Idea64610Config {
    private String name = "idea_064610";
 ...
 */
@Slf4j
public class Idea64610Service {
    private static final int IDEA_ID = 64610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64610Service() {
        this(new Idea64610Config());
    }

    public Idea64610Service(Idea64610Config config) {
        this.config = config != null ? config : new Idea64610Config();
