...
@Data
public class Idea64877Config {
    private String name = "idea_064877";
 ...
 */
@Slf4j
public class Idea64877Service {
    private static final int IDEA_ID = 64877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64877Service() {
        this(new Idea64877Config());
    }

    public Idea64877Service(Idea64877Config config) {
        this.config = config != null ? config : new Idea64877Config();
