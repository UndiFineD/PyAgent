...
@Data
public class Idea64815Config {
    private String name = "idea_064815";
 ...
 */
@Slf4j
public class Idea64815Service {
    private static final int IDEA_ID = 64815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64815Service() {
        this(new Idea64815Config());
    }

    public Idea64815Service(Idea64815Config config) {
        this.config = config != null ? config : new Idea64815Config();
