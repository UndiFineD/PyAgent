...
@Data
public class Idea64833Config {
    private String name = "idea_064833";
 ...
 */
@Slf4j
public class Idea64833Service {
    private static final int IDEA_ID = 64833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64833Service() {
        this(new Idea64833Config());
    }

    public Idea64833Service(Idea64833Config config) {
        this.config = config != null ? config : new Idea64833Config();
