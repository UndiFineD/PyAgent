...
@Data
public class Idea64808Config {
    private String name = "idea_064808";
 ...
 */
@Slf4j
public class Idea64808Service {
    private static final int IDEA_ID = 64808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64808Service() {
        this(new Idea64808Config());
    }

    public Idea64808Service(Idea64808Config config) {
        this.config = config != null ? config : new Idea64808Config();
