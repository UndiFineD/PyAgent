...
@Data
public class Idea64983Config {
    private String name = "idea_064983";
 ...
 */
@Slf4j
public class Idea64983Service {
    private static final int IDEA_ID = 64983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64983Service() {
        this(new Idea64983Config());
    }

    public Idea64983Service(Idea64983Config config) {
        this.config = config != null ? config : new Idea64983Config();
