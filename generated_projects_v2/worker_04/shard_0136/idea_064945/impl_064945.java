...
@Data
public class Idea64945Config {
    private String name = "idea_064945";
 ...
 */
@Slf4j
public class Idea64945Service {
    private static final int IDEA_ID = 64945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64945Service() {
        this(new Idea64945Config());
    }

    public Idea64945Service(Idea64945Config config) {
        this.config = config != null ? config : new Idea64945Config();
