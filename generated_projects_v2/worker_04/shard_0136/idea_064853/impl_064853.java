...
@Data
public class Idea64853Config {
    private String name = "idea_064853";
 ...
 */
@Slf4j
public class Idea64853Service {
    private static final int IDEA_ID = 64853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64853Service() {
        this(new Idea64853Config());
    }

    public Idea64853Service(Idea64853Config config) {
        this.config = config != null ? config : new Idea64853Config();
