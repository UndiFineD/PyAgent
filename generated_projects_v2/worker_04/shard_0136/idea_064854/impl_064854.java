...
@Data
public class Idea64854Config {
    private String name = "idea_064854";
 ...
 */
@Slf4j
public class Idea64854Service {
    private static final int IDEA_ID = 64854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64854Service() {
        this(new Idea64854Config());
    }

    public Idea64854Service(Idea64854Config config) {
        this.config = config != null ? config : new Idea64854Config();
