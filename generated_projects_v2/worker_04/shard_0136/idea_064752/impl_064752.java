...
@Data
public class Idea64752Config {
    private String name = "idea_064752";
 ...
 */
@Slf4j
public class Idea64752Service {
    private static final int IDEA_ID = 64752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64752Service() {
        this(new Idea64752Config());
    }

    public Idea64752Service(Idea64752Config config) {
        this.config = config != null ? config : new Idea64752Config();
