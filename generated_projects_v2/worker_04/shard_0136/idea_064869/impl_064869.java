...
@Data
public class Idea64869Config {
    private String name = "idea_064869";
 ...
 */
@Slf4j
public class Idea64869Service {
    private static final int IDEA_ID = 64869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64869Service() {
        this(new Idea64869Config());
    }

    public Idea64869Service(Idea64869Config config) {
        this.config = config != null ? config : new Idea64869Config();
