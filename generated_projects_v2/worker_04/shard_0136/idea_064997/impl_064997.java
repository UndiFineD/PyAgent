...
@Data
public class Idea64997Config {
    private String name = "idea_064997";
 ...
 */
@Slf4j
public class Idea64997Service {
    private static final int IDEA_ID = 64997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64997Service() {
        this(new Idea64997Config());
    }

    public Idea64997Service(Idea64997Config config) {
        this.config = config != null ? config : new Idea64997Config();
