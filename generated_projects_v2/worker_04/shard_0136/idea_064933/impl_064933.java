...
@Data
public class Idea64933Config {
    private String name = "idea_064933";
 ...
 */
@Slf4j
public class Idea64933Service {
    private static final int IDEA_ID = 64933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64933Service() {
        this(new Idea64933Config());
    }

    public Idea64933Service(Idea64933Config config) {
        this.config = config != null ? config : new Idea64933Config();
