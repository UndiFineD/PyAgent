...
@Data
public class Idea64655Config {
    private String name = "idea_064655";
 ...
 */
@Slf4j
public class Idea64655Service {
    private static final int IDEA_ID = 64655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64655Service() {
        this(new Idea64655Config());
    }

    public Idea64655Service(Idea64655Config config) {
        this.config = config != null ? config : new Idea64655Config();
