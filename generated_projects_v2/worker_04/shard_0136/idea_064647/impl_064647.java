...
@Data
public class Idea64647Config {
    private String name = "idea_064647";
 ...
 */
@Slf4j
public class Idea64647Service {
    private static final int IDEA_ID = 64647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64647Service() {
        this(new Idea64647Config());
    }

    public Idea64647Service(Idea64647Config config) {
        this.config = config != null ? config : new Idea64647Config();
