...
@Data
public class Idea64644Config {
    private String name = "idea_064644";
 ...
 */
@Slf4j
public class Idea64644Service {
    private static final int IDEA_ID = 64644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64644Service() {
        this(new Idea64644Config());
    }

    public Idea64644Service(Idea64644Config config) {
        this.config = config != null ? config : new Idea64644Config();
