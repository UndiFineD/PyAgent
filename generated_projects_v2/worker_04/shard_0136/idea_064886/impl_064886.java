...
@Data
public class Idea64886Config {
    private String name = "idea_064886";
 ...
 */
@Slf4j
public class Idea64886Service {
    private static final int IDEA_ID = 64886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64886Service() {
        this(new Idea64886Config());
    }

    public Idea64886Service(Idea64886Config config) {
        this.config = config != null ? config : new Idea64886Config();
