...
@Data
public class Idea64656Config {
    private String name = "idea_064656";
 ...
 */
@Slf4j
public class Idea64656Service {
    private static final int IDEA_ID = 64656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64656Service() {
        this(new Idea64656Config());
    }

    public Idea64656Service(Idea64656Config config) {
        this.config = config != null ? config : new Idea64656Config();
