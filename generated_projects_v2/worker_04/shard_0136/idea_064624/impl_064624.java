...
@Data
public class Idea64624Config {
    private String name = "idea_064624";
 ...
 */
@Slf4j
public class Idea64624Service {
    private static final int IDEA_ID = 64624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64624Service() {
        this(new Idea64624Config());
    }

    public Idea64624Service(Idea64624Config config) {
        this.config = config != null ? config : new Idea64624Config();
