...
@Data
public class Idea64744Config {
    private String name = "idea_064744";
 ...
 */
@Slf4j
public class Idea64744Service {
    private static final int IDEA_ID = 64744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64744Service() {
        this(new Idea64744Config());
    }

    public Idea64744Service(Idea64744Config config) {
        this.config = config != null ? config : new Idea64744Config();
