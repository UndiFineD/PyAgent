...
@Data
public class Idea64659Config {
    private String name = "idea_064659";
 ...
 */
@Slf4j
public class Idea64659Service {
    private static final int IDEA_ID = 64659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64659Service() {
        this(new Idea64659Config());
    }

    public Idea64659Service(Idea64659Config config) {
        this.config = config != null ? config : new Idea64659Config();
