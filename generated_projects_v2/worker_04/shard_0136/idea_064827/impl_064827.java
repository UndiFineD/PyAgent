...
@Data
public class Idea64827Config {
    private String name = "idea_064827";
 ...
 */
@Slf4j
public class Idea64827Service {
    private static final int IDEA_ID = 64827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64827Service() {
        this(new Idea64827Config());
    }

    public Idea64827Service(Idea64827Config config) {
        this.config = config != null ? config : new Idea64827Config();
