...
@Data
public class Idea64689Config {
    private String name = "idea_064689";
 ...
 */
@Slf4j
public class Idea64689Service {
    private static final int IDEA_ID = 64689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64689Service() {
        this(new Idea64689Config());
    }

    public Idea64689Service(Idea64689Config config) {
        this.config = config != null ? config : new Idea64689Config();
