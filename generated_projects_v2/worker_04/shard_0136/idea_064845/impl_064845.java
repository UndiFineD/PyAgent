...
@Data
public class Idea64845Config {
    private String name = "idea_064845";
 ...
 */
@Slf4j
public class Idea64845Service {
    private static final int IDEA_ID = 64845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64845Service() {
        this(new Idea64845Config());
    }

    public Idea64845Service(Idea64845Config config) {
        this.config = config != null ? config : new Idea64845Config();
