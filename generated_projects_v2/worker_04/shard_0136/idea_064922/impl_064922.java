...
@Data
public class Idea64922Config {
    private String name = "idea_064922";
 ...
 */
@Slf4j
public class Idea64922Service {
    private static final int IDEA_ID = 64922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64922Service() {
        this(new Idea64922Config());
    }

    public Idea64922Service(Idea64922Config config) {
        this.config = config != null ? config : new Idea64922Config();
