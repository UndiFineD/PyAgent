...
@Data
public class Idea64675Config {
    private String name = "idea_064675";
 ...
 */
@Slf4j
public class Idea64675Service {
    private static final int IDEA_ID = 64675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64675Service() {
        this(new Idea64675Config());
    }

    public Idea64675Service(Idea64675Config config) {
        this.config = config != null ? config : new Idea64675Config();
