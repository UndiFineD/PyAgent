...
@Data
public class Idea64889Config {
    private String name = "idea_064889";
 ...
 */
@Slf4j
public class Idea64889Service {
    private static final int IDEA_ID = 64889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64889Service() {
        this(new Idea64889Config());
    }

    public Idea64889Service(Idea64889Config config) {
        this.config = config != null ? config : new Idea64889Config();
