...
@Data
public class Idea64967Config {
    private String name = "idea_064967";
 ...
 */
@Slf4j
public class Idea64967Service {
    private static final int IDEA_ID = 64967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64967Service() {
        this(new Idea64967Config());
    }

    public Idea64967Service(Idea64967Config config) {
        this.config = config != null ? config : new Idea64967Config();
