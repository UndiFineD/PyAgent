...
@Data
public class Idea64992Config {
    private String name = "idea_064992";
 ...
 */
@Slf4j
public class Idea64992Service {
    private static final int IDEA_ID = 64992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64992Service() {
        this(new Idea64992Config());
    }

    public Idea64992Service(Idea64992Config config) {
        this.config = config != null ? config : new Idea64992Config();
