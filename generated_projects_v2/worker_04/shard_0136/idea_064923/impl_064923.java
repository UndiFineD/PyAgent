...
@Data
public class Idea64923Config {
    private String name = "idea_064923";
 ...
 */
@Slf4j
public class Idea64923Service {
    private static final int IDEA_ID = 64923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64923Service() {
        this(new Idea64923Config());
    }

    public Idea64923Service(Idea64923Config config) {
        this.config = config != null ? config : new Idea64923Config();
