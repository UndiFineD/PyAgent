...
@Data
public class Idea64625Config {
    private String name = "idea_064625";
 ...
 */
@Slf4j
public class Idea64625Service {
    private static final int IDEA_ID = 64625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64625Service() {
        this(new Idea64625Config());
    }

    public Idea64625Service(Idea64625Config config) {
        this.config = config != null ? config : new Idea64625Config();
