...
@Data
public class Idea64734Config {
    private String name = "idea_064734";
 ...
 */
@Slf4j
public class Idea64734Service {
    private static final int IDEA_ID = 64734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64734Service() {
        this(new Idea64734Config());
    }

    public Idea64734Service(Idea64734Config config) {
        this.config = config != null ? config : new Idea64734Config();
