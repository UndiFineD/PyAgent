...
@Data
public class Idea64641Config {
    private String name = "idea_064641";
 ...
 */
@Slf4j
public class Idea64641Service {
    private static final int IDEA_ID = 64641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64641Service() {
        this(new Idea64641Config());
    }

    public Idea64641Service(Idea64641Config config) {
        this.config = config != null ? config : new Idea64641Config();
