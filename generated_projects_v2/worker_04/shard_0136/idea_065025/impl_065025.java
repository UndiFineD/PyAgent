...
@Data
public class Idea65025Config {
    private String name = "idea_065025";
 ...
 */
@Slf4j
public class Idea65025Service {
    private static final int IDEA_ID = 65025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65025Service() {
        this(new Idea65025Config());
    }

    public Idea65025Service(Idea65025Config config) {
        this.config = config != null ? config : new Idea65025Config();
