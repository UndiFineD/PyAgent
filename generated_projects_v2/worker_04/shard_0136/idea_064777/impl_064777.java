...
@Data
public class Idea64777Config {
    private String name = "idea_064777";
 ...
 */
@Slf4j
public class Idea64777Service {
    private static final int IDEA_ID = 64777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64777Service() {
        this(new Idea64777Config());
    }

    public Idea64777Service(Idea64777Config config) {
        this.config = config != null ? config : new Idea64777Config();
