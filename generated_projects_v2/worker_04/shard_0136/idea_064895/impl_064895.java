...
@Data
public class Idea64895Config {
    private String name = "idea_064895";
 ...
 */
@Slf4j
public class Idea64895Service {
    private static final int IDEA_ID = 64895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64895Service() {
        this(new Idea64895Config());
    }

    public Idea64895Service(Idea64895Config config) {
        this.config = config != null ? config : new Idea64895Config();
