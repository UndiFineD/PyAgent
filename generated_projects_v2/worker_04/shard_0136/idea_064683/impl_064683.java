...
@Data
public class Idea64683Config {
    private String name = "idea_064683";
 ...
 */
@Slf4j
public class Idea64683Service {
    private static final int IDEA_ID = 64683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64683Service() {
        this(new Idea64683Config());
    }

    public Idea64683Service(Idea64683Config config) {
        this.config = config != null ? config : new Idea64683Config();
