...
@Data
public class Idea65061Config {
    private String name = "idea_065061";
 ...
 */
@Slf4j
public class Idea65061Service {
    private static final int IDEA_ID = 65061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65061Service() {
        this(new Idea65061Config());
    }

    public Idea65061Service(Idea65061Config config) {
        this.config = config != null ? config : new Idea65061Config();
