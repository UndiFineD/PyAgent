...
@Data
public class Idea64921Config {
    private String name = "idea_064921";
 ...
 */
@Slf4j
public class Idea64921Service {
    private static final int IDEA_ID = 64921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64921Service() {
        this(new Idea64921Config());
    }

    public Idea64921Service(Idea64921Config config) {
        this.config = config != null ? config : new Idea64921Config();
