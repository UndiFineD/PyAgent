...
@Data
public class Idea64871Config {
    private String name = "idea_064871";
 ...
 */
@Slf4j
public class Idea64871Service {
    private static final int IDEA_ID = 64871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64871Service() {
        this(new Idea64871Config());
    }

    public Idea64871Service(Idea64871Config config) {
        this.config = config != null ? config : new Idea64871Config();
