...
@Data
public class Idea64757Config {
    private String name = "idea_064757";
 ...
 */
@Slf4j
public class Idea64757Service {
    private static final int IDEA_ID = 64757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64757Service() {
        this(new Idea64757Config());
    }

    public Idea64757Service(Idea64757Config config) {
        this.config = config != null ? config : new Idea64757Config();
