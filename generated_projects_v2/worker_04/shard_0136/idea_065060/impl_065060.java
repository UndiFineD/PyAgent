...
@Data
public class Idea65060Config {
    private String name = "idea_065060";
 ...
 */
@Slf4j
public class Idea65060Service {
    private static final int IDEA_ID = 65060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65060Service() {
        this(new Idea65060Config());
    }

    public Idea65060Service(Idea65060Config config) {
        this.config = config != null ? config : new Idea65060Config();
