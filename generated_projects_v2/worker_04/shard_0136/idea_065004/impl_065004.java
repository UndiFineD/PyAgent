...
@Data
public class Idea65004Config {
    private String name = "idea_065004";
 ...
 */
@Slf4j
public class Idea65004Service {
    private static final int IDEA_ID = 65004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65004Service() {
        this(new Idea65004Config());
    }

    public Idea65004Service(Idea65004Config config) {
        this.config = config != null ? config : new Idea65004Config();
