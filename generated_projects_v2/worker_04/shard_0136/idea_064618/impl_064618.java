...
@Data
public class Idea64618Config {
    private String name = "idea_064618";
 ...
 */
@Slf4j
public class Idea64618Service {
    private static final int IDEA_ID = 64618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64618Service() {
        this(new Idea64618Config());
    }

    public Idea64618Service(Idea64618Config config) {
        this.config = config != null ? config : new Idea64618Config();
