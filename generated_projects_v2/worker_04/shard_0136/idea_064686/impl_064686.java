...
@Data
public class Idea64686Config {
    private String name = "idea_064686";
 ...
 */
@Slf4j
public class Idea64686Service {
    private static final int IDEA_ID = 64686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64686Service() {
        this(new Idea64686Config());
    }

    public Idea64686Service(Idea64686Config config) {
        this.config = config != null ? config : new Idea64686Config();
