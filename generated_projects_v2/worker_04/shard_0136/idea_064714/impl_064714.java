...
@Data
public class Idea64714Config {
    private String name = "idea_064714";
 ...
 */
@Slf4j
public class Idea64714Service {
    private static final int IDEA_ID = 64714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64714Service() {
        this(new Idea64714Config());
    }

    public Idea64714Service(Idea64714Config config) {
        this.config = config != null ? config : new Idea64714Config();
