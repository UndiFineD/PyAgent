...
@Data
public class Idea64793Config {
    private String name = "idea_064793";
 ...
 */
@Slf4j
public class Idea64793Service {
    private static final int IDEA_ID = 64793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64793Service() {
        this(new Idea64793Config());
    }

    public Idea64793Service(Idea64793Config config) {
        this.config = config != null ? config : new Idea64793Config();
