...
@Data
public class Idea64738Config {
    private String name = "idea_064738";
 ...
 */
@Slf4j
public class Idea64738Service {
    private static final int IDEA_ID = 64738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64738Service() {
        this(new Idea64738Config());
    }

    public Idea64738Service(Idea64738Config config) {
        this.config = config != null ? config : new Idea64738Config();
