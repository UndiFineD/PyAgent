...
@Data
public class Idea65012Config {
    private String name = "idea_065012";
 ...
 */
@Slf4j
public class Idea65012Service {
    private static final int IDEA_ID = 65012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65012Service() {
        this(new Idea65012Config());
    }

    public Idea65012Service(Idea65012Config config) {
        this.config = config != null ? config : new Idea65012Config();
