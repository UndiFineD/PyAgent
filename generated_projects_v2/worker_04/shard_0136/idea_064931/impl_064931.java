...
@Data
public class Idea64931Config {
    private String name = "idea_064931";
 ...
 */
@Slf4j
public class Idea64931Service {
    private static final int IDEA_ID = 64931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64931Service() {
        this(new Idea64931Config());
    }

    public Idea64931Service(Idea64931Config config) {
        this.config = config != null ? config : new Idea64931Config();
