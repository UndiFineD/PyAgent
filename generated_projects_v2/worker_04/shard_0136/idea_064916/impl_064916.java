...
@Data
public class Idea64916Config {
    private String name = "idea_064916";
 ...
 */
@Slf4j
public class Idea64916Service {
    private static final int IDEA_ID = 64916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64916Service() {
        this(new Idea64916Config());
    }

    public Idea64916Service(Idea64916Config config) {
        this.config = config != null ? config : new Idea64916Config();
