...
@Data
public class Idea64981Config {
    private String name = "idea_064981";
 ...
 */
@Slf4j
public class Idea64981Service {
    private static final int IDEA_ID = 64981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64981Service() {
        this(new Idea64981Config());
    }

    public Idea64981Service(Idea64981Config config) {
        this.config = config != null ? config : new Idea64981Config();
