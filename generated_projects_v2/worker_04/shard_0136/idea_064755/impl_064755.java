...
@Data
public class Idea64755Config {
    private String name = "idea_064755";
 ...
 */
@Slf4j
public class Idea64755Service {
    private static final int IDEA_ID = 64755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64755Service() {
        this(new Idea64755Config());
    }

    public Idea64755Service(Idea64755Config config) {
        this.config = config != null ? config : new Idea64755Config();
