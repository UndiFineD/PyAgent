...
@Data
public class Idea64893Config {
    private String name = "idea_064893";
 ...
 */
@Slf4j
public class Idea64893Service {
    private static final int IDEA_ID = 64893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64893Service() {
        this(new Idea64893Config());
    }

    public Idea64893Service(Idea64893Config config) {
        this.config = config != null ? config : new Idea64893Config();
