...
@Data
public class Idea64974Config {
    private String name = "idea_064974";
 ...
 */
@Slf4j
public class Idea64974Service {
    private static final int IDEA_ID = 64974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64974Service() {
        this(new Idea64974Config());
    }

    public Idea64974Service(Idea64974Config config) {
        this.config = config != null ? config : new Idea64974Config();
