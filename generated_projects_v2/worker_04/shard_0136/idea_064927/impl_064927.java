...
@Data
public class Idea64927Config {
    private String name = "idea_064927";
 ...
 */
@Slf4j
public class Idea64927Service {
    private static final int IDEA_ID = 64927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64927Service() {
        this(new Idea64927Config());
    }

    public Idea64927Service(Idea64927Config config) {
        this.config = config != null ? config : new Idea64927Config();
