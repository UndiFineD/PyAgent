...
@Data
public class Idea64860Config {
    private String name = "idea_064860";
 ...
 */
@Slf4j
public class Idea64860Service {
    private static final int IDEA_ID = 64860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64860Service() {
        this(new Idea64860Config());
    }

    public Idea64860Service(Idea64860Config config) {
        this.config = config != null ? config : new Idea64860Config();
