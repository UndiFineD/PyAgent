...
@Data
public class Idea64634Config {
    private String name = "idea_064634";
 ...
 */
@Slf4j
public class Idea64634Service {
    private static final int IDEA_ID = 64634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64634Service() {
        this(new Idea64634Config());
    }

    public Idea64634Service(Idea64634Config config) {
        this.config = config != null ? config : new Idea64634Config();
