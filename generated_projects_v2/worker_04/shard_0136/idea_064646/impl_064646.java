...
@Data
public class Idea64646Config {
    private String name = "idea_064646";
 ...
 */
@Slf4j
public class Idea64646Service {
    private static final int IDEA_ID = 64646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64646Service() {
        this(new Idea64646Config());
    }

    public Idea64646Service(Idea64646Config config) {
        this.config = config != null ? config : new Idea64646Config();
