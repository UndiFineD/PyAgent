...
@Data
public class Idea64826Config {
    private String name = "idea_064826";
 ...
 */
@Slf4j
public class Idea64826Service {
    private static final int IDEA_ID = 64826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64826Service() {
        this(new Idea64826Config());
    }

    public Idea64826Service(Idea64826Config config) {
        this.config = config != null ? config : new Idea64826Config();
