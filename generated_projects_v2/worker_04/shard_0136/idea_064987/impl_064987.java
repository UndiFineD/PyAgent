...
@Data
public class Idea64987Config {
    private String name = "idea_064987";
 ...
 */
@Slf4j
public class Idea64987Service {
    private static final int IDEA_ID = 64987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64987Service() {
        this(new Idea64987Config());
    }

    public Idea64987Service(Idea64987Config config) {
        this.config = config != null ? config : new Idea64987Config();
