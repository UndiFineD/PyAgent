...
@Data
public class Idea64944Config {
    private String name = "idea_064944";
 ...
 */
@Slf4j
public class Idea64944Service {
    private static final int IDEA_ID = 64944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64944Service() {
        this(new Idea64944Config());
    }

    public Idea64944Service(Idea64944Config config) {
        this.config = config != null ? config : new Idea64944Config();
