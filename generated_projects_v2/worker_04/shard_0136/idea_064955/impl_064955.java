...
@Data
public class Idea64955Config {
    private String name = "idea_064955";
 ...
 */
@Slf4j
public class Idea64955Service {
    private static final int IDEA_ID = 64955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64955Service() {
        this(new Idea64955Config());
    }

    public Idea64955Service(Idea64955Config config) {
        this.config = config != null ? config : new Idea64955Config();
