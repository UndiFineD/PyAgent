...
@Data
public class Idea64852Config {
    private String name = "idea_064852";
 ...
 */
@Slf4j
public class Idea64852Service {
    private static final int IDEA_ID = 64852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64852Service() {
        this(new Idea64852Config());
    }

    public Idea64852Service(Idea64852Config config) {
        this.config = config != null ? config : new Idea64852Config();
