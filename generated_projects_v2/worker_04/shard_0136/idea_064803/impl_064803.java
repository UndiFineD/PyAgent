...
@Data
public class Idea64803Config {
    private String name = "idea_064803";
 ...
 */
@Slf4j
public class Idea64803Service {
    private static final int IDEA_ID = 64803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64803Service() {
        this(new Idea64803Config());
    }

    public Idea64803Service(Idea64803Config config) {
        this.config = config != null ? config : new Idea64803Config();
