...
@Data
public class Idea64892Config {
    private String name = "idea_064892";
 ...
 */
@Slf4j
public class Idea64892Service {
    private static final int IDEA_ID = 64892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64892Service() {
        this(new Idea64892Config());
    }

    public Idea64892Service(Idea64892Config config) {
        this.config = config != null ? config : new Idea64892Config();
