...
@Data
public class Idea64819Config {
    private String name = "idea_064819";
 ...
 */
@Slf4j
public class Idea64819Service {
    private static final int IDEA_ID = 64819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64819Service() {
        this(new Idea64819Config());
    }

    public Idea64819Service(Idea64819Config config) {
        this.config = config != null ? config : new Idea64819Config();
