...
@Data
public class Idea64684Config {
    private String name = "idea_064684";
 ...
 */
@Slf4j
public class Idea64684Service {
    private static final int IDEA_ID = 64684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64684Service() {
        this(new Idea64684Config());
    }

    public Idea64684Service(Idea64684Config config) {
        this.config = config != null ? config : new Idea64684Config();
