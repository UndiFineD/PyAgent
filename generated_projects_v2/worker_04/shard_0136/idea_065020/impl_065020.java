...
@Data
public class Idea65020Config {
    private String name = "idea_065020";
 ...
 */
@Slf4j
public class Idea65020Service {
    private static final int IDEA_ID = 65020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65020Service() {
        this(new Idea65020Config());
    }

    public Idea65020Service(Idea65020Config config) {
        this.config = config != null ? config : new Idea65020Config();
