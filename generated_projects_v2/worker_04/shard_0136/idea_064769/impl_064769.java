...
@Data
public class Idea64769Config {
    private String name = "idea_064769";
 ...
 */
@Slf4j
public class Idea64769Service {
    private static final int IDEA_ID = 64769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64769Service() {
        this(new Idea64769Config());
    }

    public Idea64769Service(Idea64769Config config) {
        this.config = config != null ? config : new Idea64769Config();
