...
@Data
public class Idea64989Config {
    private String name = "idea_064989";
 ...
 */
@Slf4j
public class Idea64989Service {
    private static final int IDEA_ID = 64989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64989Service() {
        this(new Idea64989Config());
    }

    public Idea64989Service(Idea64989Config config) {
        this.config = config != null ? config : new Idea64989Config();
