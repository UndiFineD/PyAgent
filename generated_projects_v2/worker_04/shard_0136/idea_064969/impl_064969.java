...
@Data
public class Idea64969Config {
    private String name = "idea_064969";
 ...
 */
@Slf4j
public class Idea64969Service {
    private static final int IDEA_ID = 64969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64969Service() {
        this(new Idea64969Config());
    }

    public Idea64969Service(Idea64969Config config) {
        this.config = config != null ? config : new Idea64969Config();
