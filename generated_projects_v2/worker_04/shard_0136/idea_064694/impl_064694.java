...
@Data
public class Idea64694Config {
    private String name = "idea_064694";
 ...
 */
@Slf4j
public class Idea64694Service {
    private static final int IDEA_ID = 64694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64694Service() {
        this(new Idea64694Config());
    }

    public Idea64694Service(Idea64694Config config) {
        this.config = config != null ? config : new Idea64694Config();
