...
@Data
public class Idea64743Config {
    private String name = "idea_064743";
 ...
 */
@Slf4j
public class Idea64743Service {
    private static final int IDEA_ID = 64743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64743Service() {
        this(new Idea64743Config());
    }

    public Idea64743Service(Idea64743Config config) {
        this.config = config != null ? config : new Idea64743Config();
