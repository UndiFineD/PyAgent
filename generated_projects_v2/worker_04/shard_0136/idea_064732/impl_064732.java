...
@Data
public class Idea64732Config {
    private String name = "idea_064732";
 ...
 */
@Slf4j
public class Idea64732Service {
    private static final int IDEA_ID = 64732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64732Service() {
        this(new Idea64732Config());
    }

    public Idea64732Service(Idea64732Config config) {
        this.config = config != null ? config : new Idea64732Config();
