...
@Data
public class Idea64846Config {
    private String name = "idea_064846";
 ...
 */
@Slf4j
public class Idea64846Service {
    private static final int IDEA_ID = 64846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64846Service() {
        this(new Idea64846Config());
    }

    public Idea64846Service(Idea64846Config config) {
        this.config = config != null ? config : new Idea64846Config();
