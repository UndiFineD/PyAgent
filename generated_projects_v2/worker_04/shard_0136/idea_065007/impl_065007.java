...
@Data
public class Idea65007Config {
    private String name = "idea_065007";
 ...
 */
@Slf4j
public class Idea65007Service {
    private static final int IDEA_ID = 65007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65007Service() {
        this(new Idea65007Config());
    }

    public Idea65007Service(Idea65007Config config) {
        this.config = config != null ? config : new Idea65007Config();
