...
@Data
public class Idea64797Config {
    private String name = "idea_064797";
 ...
 */
@Slf4j
public class Idea64797Service {
    private static final int IDEA_ID = 64797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64797Service() {
        this(new Idea64797Config());
    }

    public Idea64797Service(Idea64797Config config) {
        this.config = config != null ? config : new Idea64797Config();
