...
@Data
public class Idea64884Config {
    private String name = "idea_064884";
 ...
 */
@Slf4j
public class Idea64884Service {
    private static final int IDEA_ID = 64884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64884Service() {
        this(new Idea64884Config());
    }

    public Idea64884Service(Idea64884Config config) {
        this.config = config != null ? config : new Idea64884Config();
