...
@Data
public class Idea64774Config {
    private String name = "idea_064774";
 ...
 */
@Slf4j
public class Idea64774Service {
    private static final int IDEA_ID = 64774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64774Service() {
        this(new Idea64774Config());
    }

    public Idea64774Service(Idea64774Config config) {
        this.config = config != null ? config : new Idea64774Config();
