...
@Data
public class Idea66364Config {
    private String name = "idea_066364";
 ...
 */
@Slf4j
public class Idea66364Service {
    private static final int IDEA_ID = 66364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66364Service() {
        this(new Idea66364Config());
    }

    public Idea66364Service(Idea66364Config config) {
        this.config = config != null ? config : new Idea66364Config();
