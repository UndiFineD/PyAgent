...
@Data
public class Idea66096Config {
    private String name = "idea_066096";
 ...
 */
@Slf4j
public class Idea66096Service {
    private static final int IDEA_ID = 66096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66096Service() {
        this(new Idea66096Config());
    }

    public Idea66096Service(Idea66096Config config) {
        this.config = config != null ? config : new Idea66096Config();
