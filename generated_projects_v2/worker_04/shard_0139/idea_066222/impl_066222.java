...
@Data
public class Idea66222Config {
    private String name = "idea_066222";
 ...
 */
@Slf4j
public class Idea66222Service {
    private static final int IDEA_ID = 66222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66222Service() {
        this(new Idea66222Config());
    }

    public Idea66222Service(Idea66222Config config) {
        this.config = config != null ? config : new Idea66222Config();
