...
@Data
public class Idea66251Config {
    private String name = "idea_066251";
 ...
 */
@Slf4j
public class Idea66251Service {
    private static final int IDEA_ID = 66251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66251Service() {
        this(new Idea66251Config());
    }

    public Idea66251Service(Idea66251Config config) {
        this.config = config != null ? config : new Idea66251Config();
