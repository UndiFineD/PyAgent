...
@Data
public class Idea66037Config {
    private String name = "idea_066037";
 ...
 */
@Slf4j
public class Idea66037Service {
    private static final int IDEA_ID = 66037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66037Service() {
        this(new Idea66037Config());
    }

    public Idea66037Service(Idea66037Config config) {
        this.config = config != null ? config : new Idea66037Config();
