...
@Data
public class Idea66270Config {
    private String name = "idea_066270";
 ...
 */
@Slf4j
public class Idea66270Service {
    private static final int IDEA_ID = 66270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66270Service() {
        this(new Idea66270Config());
    }

    public Idea66270Service(Idea66270Config config) {
        this.config = config != null ? config : new Idea66270Config();
