...
@Data
public class Idea66237Config {
    private String name = "idea_066237";
 ...
 */
@Slf4j
public class Idea66237Service {
    private static final int IDEA_ID = 66237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66237Service() {
        this(new Idea66237Config());
    }

    public Idea66237Service(Idea66237Config config) {
        this.config = config != null ? config : new Idea66237Config();
