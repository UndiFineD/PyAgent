...
@Data
public class Idea66099Config {
    private String name = "idea_066099";
 ...
 */
@Slf4j
public class Idea66099Service {
    private static final int IDEA_ID = 66099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66099Service() {
        this(new Idea66099Config());
    }

    public Idea66099Service(Idea66099Config config) {
        this.config = config != null ? config : new Idea66099Config();
