...
@Data
public class Idea66297Config {
    private String name = "idea_066297";
 ...
 */
@Slf4j
public class Idea66297Service {
    private static final int IDEA_ID = 66297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66297Service() {
        this(new Idea66297Config());
    }

    public Idea66297Service(Idea66297Config config) {
        this.config = config != null ? config : new Idea66297Config();
