...
@Data
public class Idea66427Config {
    private String name = "idea_066427";
 ...
 */
@Slf4j
public class Idea66427Service {
    private static final int IDEA_ID = 66427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66427Service() {
        this(new Idea66427Config());
    }

    public Idea66427Service(Idea66427Config config) {
        this.config = config != null ? config : new Idea66427Config();
