...
@Data
public class Idea66035Config {
    private String name = "idea_066035";
 ...
 */
@Slf4j
public class Idea66035Service {
    private static final int IDEA_ID = 66035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66035Service() {
        this(new Idea66035Config());
    }

    public Idea66035Service(Idea66035Config config) {
        this.config = config != null ? config : new Idea66035Config();
