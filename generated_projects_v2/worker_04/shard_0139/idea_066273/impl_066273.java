...
@Data
public class Idea66273Config {
    private String name = "idea_066273";
 ...
 */
@Slf4j
public class Idea66273Service {
    private static final int IDEA_ID = 66273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66273Service() {
        this(new Idea66273Config());
    }

    public Idea66273Service(Idea66273Config config) {
        this.config = config != null ? config : new Idea66273Config();
