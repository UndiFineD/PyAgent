...
@Data
public class Idea66248Config {
    private String name = "idea_066248";
 ...
 */
@Slf4j
public class Idea66248Service {
    private static final int IDEA_ID = 66248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66248Service() {
        this(new Idea66248Config());
    }

    public Idea66248Service(Idea66248Config config) {
        this.config = config != null ? config : new Idea66248Config();
