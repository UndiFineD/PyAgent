...
@Data
public class Idea66300Config {
    private String name = "idea_066300";
 ...
 */
@Slf4j
public class Idea66300Service {
    private static final int IDEA_ID = 66300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66300Service() {
        this(new Idea66300Config());
    }

    public Idea66300Service(Idea66300Config config) {
        this.config = config != null ? config : new Idea66300Config();
