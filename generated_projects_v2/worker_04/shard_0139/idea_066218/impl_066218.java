...
@Data
public class Idea66218Config {
    private String name = "idea_066218";
 ...
 */
@Slf4j
public class Idea66218Service {
    private static final int IDEA_ID = 66218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66218Service() {
        this(new Idea66218Config());
    }

    public Idea66218Service(Idea66218Config config) {
        this.config = config != null ? config : new Idea66218Config();
