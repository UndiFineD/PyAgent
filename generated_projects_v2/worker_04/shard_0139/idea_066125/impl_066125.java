...
@Data
public class Idea66125Config {
    private String name = "idea_066125";
 ...
 */
@Slf4j
public class Idea66125Service {
    private static final int IDEA_ID = 66125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66125Service() {
        this(new Idea66125Config());
    }

    public Idea66125Service(Idea66125Config config) {
        this.config = config != null ? config : new Idea66125Config();
