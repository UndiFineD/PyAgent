...
@Data
public class Idea66260Config {
    private String name = "idea_066260";
 ...
 */
@Slf4j
public class Idea66260Service {
    private static final int IDEA_ID = 66260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66260Service() {
        this(new Idea66260Config());
    }

    public Idea66260Service(Idea66260Config config) {
        this.config = config != null ? config : new Idea66260Config();
