...
@Data
public class Idea66207Config {
    private String name = "idea_066207";
 ...
 */
@Slf4j
public class Idea66207Service {
    private static final int IDEA_ID = 66207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66207Service() {
        this(new Idea66207Config());
    }

    public Idea66207Service(Idea66207Config config) {
        this.config = config != null ? config : new Idea66207Config();
