...
@Data
public class Idea66387Config {
    private String name = "idea_066387";
 ...
 */
@Slf4j
public class Idea66387Service {
    private static final int IDEA_ID = 66387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66387Service() {
        this(new Idea66387Config());
    }

    public Idea66387Service(Idea66387Config config) {
        this.config = config != null ? config : new Idea66387Config();
