...
@Data
public class Idea66073Config {
    private String name = "idea_066073";
 ...
 */
@Slf4j
public class Idea66073Service {
    private static final int IDEA_ID = 66073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66073Service() {
        this(new Idea66073Config());
    }

    public Idea66073Service(Idea66073Config config) {
        this.config = config != null ? config : new Idea66073Config();
