...
@Data
public class Idea66205Config {
    private String name = "idea_066205";
 ...
 */
@Slf4j
public class Idea66205Service {
    private static final int IDEA_ID = 66205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66205Service() {
        this(new Idea66205Config());
    }

    public Idea66205Service(Idea66205Config config) {
        this.config = config != null ? config : new Idea66205Config();
