...
@Data
public class Idea66039Config {
    private String name = "idea_066039";
 ...
 */
@Slf4j
public class Idea66039Service {
    private static final int IDEA_ID = 66039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66039Service() {
        this(new Idea66039Config());
    }

    public Idea66039Service(Idea66039Config config) {
        this.config = config != null ? config : new Idea66039Config();
