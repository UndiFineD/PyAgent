...
@Data
public class Idea66167Config {
    private String name = "idea_066167";
 ...
 */
@Slf4j
public class Idea66167Service {
    private static final int IDEA_ID = 66167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66167Service() {
        this(new Idea66167Config());
    }

    public Idea66167Service(Idea66167Config config) {
        this.config = config != null ? config : new Idea66167Config();
