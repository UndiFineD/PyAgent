...
@Data
public class Idea66138Config {
    private String name = "idea_066138";
 ...
 */
@Slf4j
public class Idea66138Service {
    private static final int IDEA_ID = 66138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66138Service() {
        this(new Idea66138Config());
    }

    public Idea66138Service(Idea66138Config config) {
        this.config = config != null ? config : new Idea66138Config();
