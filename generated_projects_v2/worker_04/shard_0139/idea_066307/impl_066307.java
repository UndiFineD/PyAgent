...
@Data
public class Idea66307Config {
    private String name = "idea_066307";
 ...
 */
@Slf4j
public class Idea66307Service {
    private static final int IDEA_ID = 66307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66307Service() {
        this(new Idea66307Config());
    }

    public Idea66307Service(Idea66307Config config) {
        this.config = config != null ? config : new Idea66307Config();
