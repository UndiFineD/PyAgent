...
@Data
public class Idea66278Config {
    private String name = "idea_066278";
 ...
 */
@Slf4j
public class Idea66278Service {
    private static final int IDEA_ID = 66278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66278Service() {
        this(new Idea66278Config());
    }

    public Idea66278Service(Idea66278Config config) {
        this.config = config != null ? config : new Idea66278Config();
