...
@Data
public class Idea66390Config {
    private String name = "idea_066390";
 ...
 */
@Slf4j
public class Idea66390Service {
    private static final int IDEA_ID = 66390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66390Service() {
        this(new Idea66390Config());
    }

    public Idea66390Service(Idea66390Config config) {
        this.config = config != null ? config : new Idea66390Config();
