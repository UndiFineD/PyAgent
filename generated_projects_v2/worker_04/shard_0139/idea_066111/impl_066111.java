...
@Data
public class Idea66111Config {
    private String name = "idea_066111";
 ...
 */
@Slf4j
public class Idea66111Service {
    private static final int IDEA_ID = 66111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66111Service() {
        this(new Idea66111Config());
    }

    public Idea66111Service(Idea66111Config config) {
        this.config = config != null ? config : new Idea66111Config();
