...
@Data
public class Idea66491Config {
    private String name = "idea_066491";
 ...
 */
@Slf4j
public class Idea66491Service {
    private static final int IDEA_ID = 66491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66491Service() {
        this(new Idea66491Config());
    }

    public Idea66491Service(Idea66491Config config) {
        this.config = config != null ? config : new Idea66491Config();
