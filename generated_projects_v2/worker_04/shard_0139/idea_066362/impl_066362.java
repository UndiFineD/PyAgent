...
@Data
public class Idea66362Config {
    private String name = "idea_066362";
 ...
 */
@Slf4j
public class Idea66362Service {
    private static final int IDEA_ID = 66362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66362Service() {
        this(new Idea66362Config());
    }

    public Idea66362Service(Idea66362Config config) {
        this.config = config != null ? config : new Idea66362Config();
