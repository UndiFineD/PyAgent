...
@Data
public class Idea66397Config {
    private String name = "idea_066397";
 ...
 */
@Slf4j
public class Idea66397Service {
    private static final int IDEA_ID = 66397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66397Service() {
        this(new Idea66397Config());
    }

    public Idea66397Service(Idea66397Config config) {
        this.config = config != null ? config : new Idea66397Config();
