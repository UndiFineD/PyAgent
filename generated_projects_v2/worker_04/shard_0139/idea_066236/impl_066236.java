...
@Data
public class Idea66236Config {
    private String name = "idea_066236";
 ...
 */
@Slf4j
public class Idea66236Service {
    private static final int IDEA_ID = 66236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66236Service() {
        this(new Idea66236Config());
    }

    public Idea66236Service(Idea66236Config config) {
        this.config = config != null ? config : new Idea66236Config();
