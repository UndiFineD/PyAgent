...
@Data
public class Idea66323Config {
    private String name = "idea_066323";
 ...
 */
@Slf4j
public class Idea66323Service {
    private static final int IDEA_ID = 66323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66323Service() {
        this(new Idea66323Config());
    }

    public Idea66323Service(Idea66323Config config) {
        this.config = config != null ? config : new Idea66323Config();
