...
@Data
public class Idea66331Config {
    private String name = "idea_066331";
 ...
 */
@Slf4j
public class Idea66331Service {
    private static final int IDEA_ID = 66331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66331Service() {
        this(new Idea66331Config());
    }

    public Idea66331Service(Idea66331Config config) {
        this.config = config != null ? config : new Idea66331Config();
