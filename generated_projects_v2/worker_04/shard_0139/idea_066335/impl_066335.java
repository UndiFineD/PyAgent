...
@Data
public class Idea66335Config {
    private String name = "idea_066335";
 ...
 */
@Slf4j
public class Idea66335Service {
    private static final int IDEA_ID = 66335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66335Service() {
        this(new Idea66335Config());
    }

    public Idea66335Service(Idea66335Config config) {
        this.config = config != null ? config : new Idea66335Config();
