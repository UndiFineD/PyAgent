...
@Data
public class Idea66113Config {
    private String name = "idea_066113";
 ...
 */
@Slf4j
public class Idea66113Service {
    private static final int IDEA_ID = 66113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66113Service() {
        this(new Idea66113Config());
    }

    public Idea66113Service(Idea66113Config config) {
        this.config = config != null ? config : new Idea66113Config();
