...
@Data
public class Idea66334Config {
    private String name = "idea_066334";
 ...
 */
@Slf4j
public class Idea66334Service {
    private static final int IDEA_ID = 66334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66334Service() {
        this(new Idea66334Config());
    }

    public Idea66334Service(Idea66334Config config) {
        this.config = config != null ? config : new Idea66334Config();
