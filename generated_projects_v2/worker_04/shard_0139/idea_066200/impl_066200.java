...
@Data
public class Idea66200Config {
    private String name = "idea_066200";
 ...
 */
@Slf4j
public class Idea66200Service {
    private static final int IDEA_ID = 66200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66200Service() {
        this(new Idea66200Config());
    }

    public Idea66200Service(Idea66200Config config) {
        this.config = config != null ? config : new Idea66200Config();
