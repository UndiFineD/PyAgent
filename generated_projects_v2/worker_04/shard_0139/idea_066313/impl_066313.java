...
@Data
public class Idea66313Config {
    private String name = "idea_066313";
 ...
 */
@Slf4j
public class Idea66313Service {
    private static final int IDEA_ID = 66313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66313Service() {
        this(new Idea66313Config());
    }

    public Idea66313Service(Idea66313Config config) {
        this.config = config != null ? config : new Idea66313Config();
