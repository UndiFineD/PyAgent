...
@Data
public class Idea66391Config {
    private String name = "idea_066391";
 ...
 */
@Slf4j
public class Idea66391Service {
    private static final int IDEA_ID = 66391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66391Service() {
        this(new Idea66391Config());
    }

    public Idea66391Service(Idea66391Config config) {
        this.config = config != null ? config : new Idea66391Config();
