...
@Data
public class Idea66367Config {
    private String name = "idea_066367";
 ...
 */
@Slf4j
public class Idea66367Service {
    private static final int IDEA_ID = 66367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66367Service() {
        this(new Idea66367Config());
    }

    public Idea66367Service(Idea66367Config config) {
        this.config = config != null ? config : new Idea66367Config();
