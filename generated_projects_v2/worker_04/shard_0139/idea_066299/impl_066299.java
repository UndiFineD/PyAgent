...
@Data
public class Idea66299Config {
    private String name = "idea_066299";
 ...
 */
@Slf4j
public class Idea66299Service {
    private static final int IDEA_ID = 66299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66299Service() {
        this(new Idea66299Config());
    }

    public Idea66299Service(Idea66299Config config) {
        this.config = config != null ? config : new Idea66299Config();
