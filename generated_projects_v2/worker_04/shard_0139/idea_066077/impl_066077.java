...
@Data
public class Idea66077Config {
    private String name = "idea_066077";
 ...
 */
@Slf4j
public class Idea66077Service {
    private static final int IDEA_ID = 66077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66077Service() {
        this(new Idea66077Config());
    }

    public Idea66077Service(Idea66077Config config) {
        this.config = config != null ? config : new Idea66077Config();
