...
@Data
public class Idea66110Config {
    private String name = "idea_066110";
 ...
 */
@Slf4j
public class Idea66110Service {
    private static final int IDEA_ID = 66110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66110Service() {
        this(new Idea66110Config());
    }

    public Idea66110Service(Idea66110Config config) {
        this.config = config != null ? config : new Idea66110Config();
