...
@Data
public class Idea66306Config {
    private String name = "idea_066306";
 ...
 */
@Slf4j
public class Idea66306Service {
    private static final int IDEA_ID = 66306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66306Service() {
        this(new Idea66306Config());
    }

    public Idea66306Service(Idea66306Config config) {
        this.config = config != null ? config : new Idea66306Config();
