...
@Data
public class Idea66043Config {
    private String name = "idea_066043";
 ...
 */
@Slf4j
public class Idea66043Service {
    private static final int IDEA_ID = 66043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66043Service() {
        this(new Idea66043Config());
    }

    public Idea66043Service(Idea66043Config config) {
        this.config = config != null ? config : new Idea66043Config();
