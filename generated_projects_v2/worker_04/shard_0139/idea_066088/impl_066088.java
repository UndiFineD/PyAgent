...
@Data
public class Idea66088Config {
    private String name = "idea_066088";
 ...
 */
@Slf4j
public class Idea66088Service {
    private static final int IDEA_ID = 66088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66088Service() {
        this(new Idea66088Config());
    }

    public Idea66088Service(Idea66088Config config) {
        this.config = config != null ? config : new Idea66088Config();
