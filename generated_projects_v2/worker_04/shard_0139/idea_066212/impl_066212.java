...
@Data
public class Idea66212Config {
    private String name = "idea_066212";
 ...
 */
@Slf4j
public class Idea66212Service {
    private static final int IDEA_ID = 66212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66212Service() {
        this(new Idea66212Config());
    }

    public Idea66212Service(Idea66212Config config) {
        this.config = config != null ? config : new Idea66212Config();
