...
@Data
public class Idea66382Config {
    private String name = "idea_066382";
 ...
 */
@Slf4j
public class Idea66382Service {
    private static final int IDEA_ID = 66382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66382Service() {
        this(new Idea66382Config());
    }

    public Idea66382Service(Idea66382Config config) {
        this.config = config != null ? config : new Idea66382Config();
