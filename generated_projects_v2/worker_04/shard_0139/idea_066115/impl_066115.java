...
@Data
public class Idea66115Config {
    private String name = "idea_066115";
 ...
 */
@Slf4j
public class Idea66115Service {
    private static final int IDEA_ID = 66115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66115Service() {
        this(new Idea66115Config());
    }

    public Idea66115Service(Idea66115Config config) {
        this.config = config != null ? config : new Idea66115Config();
