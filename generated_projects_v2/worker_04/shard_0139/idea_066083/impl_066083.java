...
@Data
public class Idea66083Config {
    private String name = "idea_066083";
 ...
 */
@Slf4j
public class Idea66083Service {
    private static final int IDEA_ID = 66083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66083Service() {
        this(new Idea66083Config());
    }

    public Idea66083Service(Idea66083Config config) {
        this.config = config != null ? config : new Idea66083Config();
