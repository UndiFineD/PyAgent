...
@Data
public class Idea66250Config {
    private String name = "idea_066250";
 ...
 */
@Slf4j
public class Idea66250Service {
    private static final int IDEA_ID = 66250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66250Service() {
        this(new Idea66250Config());
    }

    public Idea66250Service(Idea66250Config config) {
        this.config = config != null ? config : new Idea66250Config();
