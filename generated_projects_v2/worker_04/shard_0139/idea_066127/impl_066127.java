...
@Data
public class Idea66127Config {
    private String name = "idea_066127";
 ...
 */
@Slf4j
public class Idea66127Service {
    private static final int IDEA_ID = 66127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66127Service() {
        this(new Idea66127Config());
    }

    public Idea66127Service(Idea66127Config config) {
        this.config = config != null ? config : new Idea66127Config();
