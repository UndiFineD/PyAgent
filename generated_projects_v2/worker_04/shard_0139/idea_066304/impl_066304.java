...
@Data
public class Idea66304Config {
    private String name = "idea_066304";
 ...
 */
@Slf4j
public class Idea66304Service {
    private static final int IDEA_ID = 66304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66304Service() {
        this(new Idea66304Config());
    }

    public Idea66304Service(Idea66304Config config) {
        this.config = config != null ? config : new Idea66304Config();
