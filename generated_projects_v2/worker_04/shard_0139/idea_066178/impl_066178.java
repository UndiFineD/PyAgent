...
@Data
public class Idea66178Config {
    private String name = "idea_066178";
 ...
 */
@Slf4j
public class Idea66178Service {
    private static final int IDEA_ID = 66178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66178Service() {
        this(new Idea66178Config());
    }

    public Idea66178Service(Idea66178Config config) {
        this.config = config != null ? config : new Idea66178Config();
