...
@Data
public class Idea66357Config {
    private String name = "idea_066357";
 ...
 */
@Slf4j
public class Idea66357Service {
    private static final int IDEA_ID = 66357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66357Service() {
        this(new Idea66357Config());
    }

    public Idea66357Service(Idea66357Config config) {
        this.config = config != null ? config : new Idea66357Config();
