...
@Data
public class Idea66206Config {
    private String name = "idea_066206";
 ...
 */
@Slf4j
public class Idea66206Service {
    private static final int IDEA_ID = 66206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66206Service() {
        this(new Idea66206Config());
    }

    public Idea66206Service(Idea66206Config config) {
        this.config = config != null ? config : new Idea66206Config();
