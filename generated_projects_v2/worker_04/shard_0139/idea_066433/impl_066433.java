...
@Data
public class Idea66433Config {
    private String name = "idea_066433";
 ...
 */
@Slf4j
public class Idea66433Service {
    private static final int IDEA_ID = 66433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66433Service() {
        this(new Idea66433Config());
    }

    public Idea66433Service(Idea66433Config config) {
        this.config = config != null ? config : new Idea66433Config();
