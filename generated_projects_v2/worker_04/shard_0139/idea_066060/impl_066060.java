...
@Data
public class Idea66060Config {
    private String name = "idea_066060";
 ...
 */
@Slf4j
public class Idea66060Service {
    private static final int IDEA_ID = 66060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66060Service() {
        this(new Idea66060Config());
    }

    public Idea66060Service(Idea66060Config config) {
        this.config = config != null ? config : new Idea66060Config();
