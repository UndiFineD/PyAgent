...
@Data
public class Idea66407Config {
    private String name = "idea_066407";
 ...
 */
@Slf4j
public class Idea66407Service {
    private static final int IDEA_ID = 66407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66407Service() {
        this(new Idea66407Config());
    }

    public Idea66407Service(Idea66407Config config) {
        this.config = config != null ? config : new Idea66407Config();
