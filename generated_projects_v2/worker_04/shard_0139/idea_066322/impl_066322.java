...
@Data
public class Idea66322Config {
    private String name = "idea_066322";
 ...
 */
@Slf4j
public class Idea66322Service {
    private static final int IDEA_ID = 66322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66322Service() {
        this(new Idea66322Config());
    }

    public Idea66322Service(Idea66322Config config) {
        this.config = config != null ? config : new Idea66322Config();
