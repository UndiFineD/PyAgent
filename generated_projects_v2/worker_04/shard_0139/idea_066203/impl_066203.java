...
@Data
public class Idea66203Config {
    private String name = "idea_066203";
 ...
 */
@Slf4j
public class Idea66203Service {
    private static final int IDEA_ID = 66203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66203Service() {
        this(new Idea66203Config());
    }

    public Idea66203Service(Idea66203Config config) {
        this.config = config != null ? config : new Idea66203Config();
