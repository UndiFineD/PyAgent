...
@Data
public class Idea66262Config {
    private String name = "idea_066262";
 ...
 */
@Slf4j
public class Idea66262Service {
    private static final int IDEA_ID = 66262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66262Service() {
        this(new Idea66262Config());
    }

    public Idea66262Service(Idea66262Config config) {
        this.config = config != null ? config : new Idea66262Config();
