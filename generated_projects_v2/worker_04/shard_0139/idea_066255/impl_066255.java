...
@Data
public class Idea66255Config {
    private String name = "idea_066255";
 ...
 */
@Slf4j
public class Idea66255Service {
    private static final int IDEA_ID = 66255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66255Service() {
        this(new Idea66255Config());
    }

    public Idea66255Service(Idea66255Config config) {
        this.config = config != null ? config : new Idea66255Config();
