...
@Data
public class Idea66240Config {
    private String name = "idea_066240";
 ...
 */
@Slf4j
public class Idea66240Service {
    private static final int IDEA_ID = 66240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66240Service() {
        this(new Idea66240Config());
    }

    public Idea66240Service(Idea66240Config config) {
        this.config = config != null ? config : new Idea66240Config();
