...
@Data
public class Idea66400Config {
    private String name = "idea_066400";
 ...
 */
@Slf4j
public class Idea66400Service {
    private static final int IDEA_ID = 66400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66400Service() {
        this(new Idea66400Config());
    }

    public Idea66400Service(Idea66400Config config) {
        this.config = config != null ? config : new Idea66400Config();
