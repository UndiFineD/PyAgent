...
@Data
public class Idea66215Config {
    private String name = "idea_066215";
 ...
 */
@Slf4j
public class Idea66215Service {
    private static final int IDEA_ID = 66215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66215Service() {
        this(new Idea66215Config());
    }

    public Idea66215Service(Idea66215Config config) {
        this.config = config != null ? config : new Idea66215Config();
