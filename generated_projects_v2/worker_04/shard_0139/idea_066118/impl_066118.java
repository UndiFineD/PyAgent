...
@Data
public class Idea66118Config {
    private String name = "idea_066118";
 ...
 */
@Slf4j
public class Idea66118Service {
    private static final int IDEA_ID = 66118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66118Service() {
        this(new Idea66118Config());
    }

    public Idea66118Service(Idea66118Config config) {
        this.config = config != null ? config : new Idea66118Config();
