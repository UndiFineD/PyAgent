...
@Data
public class Idea66398Config {
    private String name = "idea_066398";
 ...
 */
@Slf4j
public class Idea66398Service {
    private static final int IDEA_ID = 66398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66398Service() {
        this(new Idea66398Config());
    }

    public Idea66398Service(Idea66398Config config) {
        this.config = config != null ? config : new Idea66398Config();
