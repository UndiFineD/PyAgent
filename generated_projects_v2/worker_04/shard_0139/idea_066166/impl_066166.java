...
@Data
public class Idea66166Config {
    private String name = "idea_066166";
 ...
 */
@Slf4j
public class Idea66166Service {
    private static final int IDEA_ID = 66166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66166Service() {
        this(new Idea66166Config());
    }

    public Idea66166Service(Idea66166Config config) {
        this.config = config != null ? config : new Idea66166Config();
