...
@Data
public class Idea66276Config {
    private String name = "idea_066276";
 ...
 */
@Slf4j
public class Idea66276Service {
    private static final int IDEA_ID = 66276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66276Service() {
        this(new Idea66276Config());
    }

    public Idea66276Service(Idea66276Config config) {
        this.config = config != null ? config : new Idea66276Config();
