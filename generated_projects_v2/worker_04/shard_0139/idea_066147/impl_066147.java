...
@Data
public class Idea66147Config {
    private String name = "idea_066147";
 ...
 */
@Slf4j
public class Idea66147Service {
    private static final int IDEA_ID = 66147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66147Service() {
        this(new Idea66147Config());
    }

    public Idea66147Service(Idea66147Config config) {
        this.config = config != null ? config : new Idea66147Config();
