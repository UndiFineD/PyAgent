...
@Data
public class Idea66405Config {
    private String name = "idea_066405";
 ...
 */
@Slf4j
public class Idea66405Service {
    private static final int IDEA_ID = 66405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66405Service() {
        this(new Idea66405Config());
    }

    public Idea66405Service(Idea66405Config config) {
        this.config = config != null ? config : new Idea66405Config();
