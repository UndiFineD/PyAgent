...
@Data
public class Idea66249Config {
    private String name = "idea_066249";
 ...
 */
@Slf4j
public class Idea66249Service {
    private static final int IDEA_ID = 66249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66249Service() {
        this(new Idea66249Config());
    }

    public Idea66249Service(Idea66249Config config) {
        this.config = config != null ? config : new Idea66249Config();
