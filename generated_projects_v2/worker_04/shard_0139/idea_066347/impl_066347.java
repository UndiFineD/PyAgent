...
@Data
public class Idea66347Config {
    private String name = "idea_066347";
 ...
 */
@Slf4j
public class Idea66347Service {
    private static final int IDEA_ID = 66347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66347Service() {
        this(new Idea66347Config());
    }

    public Idea66347Service(Idea66347Config config) {
        this.config = config != null ? config : new Idea66347Config();
