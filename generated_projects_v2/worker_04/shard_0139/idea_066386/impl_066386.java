...
@Data
public class Idea66386Config {
    private String name = "idea_066386";
 ...
 */
@Slf4j
public class Idea66386Service {
    private static final int IDEA_ID = 66386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66386Service() {
        this(new Idea66386Config());
    }

    public Idea66386Service(Idea66386Config config) {
        this.config = config != null ? config : new Idea66386Config();
