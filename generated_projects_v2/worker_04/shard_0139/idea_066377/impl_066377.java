...
@Data
public class Idea66377Config {
    private String name = "idea_066377";
 ...
 */
@Slf4j
public class Idea66377Service {
    private static final int IDEA_ID = 66377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66377Service() {
        this(new Idea66377Config());
    }

    public Idea66377Service(Idea66377Config config) {
        this.config = config != null ? config : new Idea66377Config();
