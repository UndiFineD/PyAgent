...
@Data
public class Idea66164Config {
    private String name = "idea_066164";
 ...
 */
@Slf4j
public class Idea66164Service {
    private static final int IDEA_ID = 66164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66164Service() {
        this(new Idea66164Config());
    }

    public Idea66164Service(Idea66164Config config) {
        this.config = config != null ? config : new Idea66164Config();
