...
@Data
public class Idea66408Config {
    private String name = "idea_066408";
 ...
 */
@Slf4j
public class Idea66408Service {
    private static final int IDEA_ID = 66408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66408Service() {
        this(new Idea66408Config());
    }

    public Idea66408Service(Idea66408Config config) {
        this.config = config != null ? config : new Idea66408Config();
