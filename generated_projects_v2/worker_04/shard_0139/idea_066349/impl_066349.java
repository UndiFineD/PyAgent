...
@Data
public class Idea66349Config {
    private String name = "idea_066349";
 ...
 */
@Slf4j
public class Idea66349Service {
    private static final int IDEA_ID = 66349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66349Service() {
        this(new Idea66349Config());
    }

    public Idea66349Service(Idea66349Config config) {
        this.config = config != null ? config : new Idea66349Config();
