...
@Data
public class Idea66145Config {
    private String name = "idea_066145";
 ...
 */
@Slf4j
public class Idea66145Service {
    private static final int IDEA_ID = 66145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66145Service() {
        this(new Idea66145Config());
    }

    public Idea66145Service(Idea66145Config config) {
        this.config = config != null ? config : new Idea66145Config();
