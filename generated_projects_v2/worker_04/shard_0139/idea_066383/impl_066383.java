...
@Data
public class Idea66383Config {
    private String name = "idea_066383";
 ...
 */
@Slf4j
public class Idea66383Service {
    private static final int IDEA_ID = 66383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66383Service() {
        this(new Idea66383Config());
    }

    public Idea66383Service(Idea66383Config config) {
        this.config = config != null ? config : new Idea66383Config();
