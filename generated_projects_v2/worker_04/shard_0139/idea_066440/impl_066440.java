...
@Data
public class Idea66440Config {
    private String name = "idea_066440";
 ...
 */
@Slf4j
public class Idea66440Service {
    private static final int IDEA_ID = 66440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66440Service() {
        this(new Idea66440Config());
    }

    public Idea66440Service(Idea66440Config config) {
        this.config = config != null ? config : new Idea66440Config();
