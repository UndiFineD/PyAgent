...
@Data
public class Idea66221Config {
    private String name = "idea_066221";
 ...
 */
@Slf4j
public class Idea66221Service {
    private static final int IDEA_ID = 66221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66221Service() {
        this(new Idea66221Config());
    }

    public Idea66221Service(Idea66221Config config) {
        this.config = config != null ? config : new Idea66221Config();
