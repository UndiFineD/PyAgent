...
@Data
public class Idea66303Config {
    private String name = "idea_066303";
 ...
 */
@Slf4j
public class Idea66303Service {
    private static final int IDEA_ID = 66303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66303Service() {
        this(new Idea66303Config());
    }

    public Idea66303Service(Idea66303Config config) {
        this.config = config != null ? config : new Idea66303Config();
