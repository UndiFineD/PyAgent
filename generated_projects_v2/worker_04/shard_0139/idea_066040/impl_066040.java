...
@Data
public class Idea66040Config {
    private String name = "idea_066040";
 ...
 */
@Slf4j
public class Idea66040Service {
    private static final int IDEA_ID = 66040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66040Service() {
        this(new Idea66040Config());
    }

    public Idea66040Service(Idea66040Config config) {
        this.config = config != null ? config : new Idea66040Config();
