...
@Data
public class Idea66414Config {
    private String name = "idea_066414";
 ...
 */
@Slf4j
public class Idea66414Service {
    private static final int IDEA_ID = 66414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66414Service() {
        this(new Idea66414Config());
    }

    public Idea66414Service(Idea66414Config config) {
        this.config = config != null ? config : new Idea66414Config();
