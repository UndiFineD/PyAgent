...
@Data
public class Idea66078Config {
    private String name = "idea_066078";
 ...
 */
@Slf4j
public class Idea66078Service {
    private static final int IDEA_ID = 66078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66078Service() {
        this(new Idea66078Config());
    }

    public Idea66078Service(Idea66078Config config) {
        this.config = config != null ? config : new Idea66078Config();
