...
@Data
public class Idea66425Config {
    private String name = "idea_066425";
 ...
 */
@Slf4j
public class Idea66425Service {
    private static final int IDEA_ID = 66425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66425Service() {
        this(new Idea66425Config());
    }

    public Idea66425Service(Idea66425Config config) {
        this.config = config != null ? config : new Idea66425Config();
