...
@Data
public class Idea66226Config {
    private String name = "idea_066226";
 ...
 */
@Slf4j
public class Idea66226Service {
    private static final int IDEA_ID = 66226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66226Service() {
        this(new Idea66226Config());
    }

    public Idea66226Service(Idea66226Config config) {
        this.config = config != null ? config : new Idea66226Config();
