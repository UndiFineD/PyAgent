...
@Data
public class Idea66075Config {
    private String name = "idea_066075";
 ...
 */
@Slf4j
public class Idea66075Service {
    private static final int IDEA_ID = 66075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66075Service() {
        this(new Idea66075Config());
    }

    public Idea66075Service(Idea66075Config config) {
        this.config = config != null ? config : new Idea66075Config();
