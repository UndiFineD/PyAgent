...
@Data
public class Idea66301Config {
    private String name = "idea_066301";
 ...
 */
@Slf4j
public class Idea66301Service {
    private static final int IDEA_ID = 66301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66301Service() {
        this(new Idea66301Config());
    }

    public Idea66301Service(Idea66301Config config) {
        this.config = config != null ? config : new Idea66301Config();
