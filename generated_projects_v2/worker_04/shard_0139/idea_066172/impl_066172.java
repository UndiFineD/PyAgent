...
@Data
public class Idea66172Config {
    private String name = "idea_066172";
 ...
 */
@Slf4j
public class Idea66172Service {
    private static final int IDEA_ID = 66172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66172Service() {
        this(new Idea66172Config());
    }

    public Idea66172Service(Idea66172Config config) {
        this.config = config != null ? config : new Idea66172Config();
