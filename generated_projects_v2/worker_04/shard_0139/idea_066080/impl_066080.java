...
@Data
public class Idea66080Config {
    private String name = "idea_066080";
 ...
 */
@Slf4j
public class Idea66080Service {
    private static final int IDEA_ID = 66080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66080Service() {
        this(new Idea66080Config());
    }

    public Idea66080Service(Idea66080Config config) {
        this.config = config != null ? config : new Idea66080Config();
