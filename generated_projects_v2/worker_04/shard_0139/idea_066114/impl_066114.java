...
@Data
public class Idea66114Config {
    private String name = "idea_066114";
 ...
 */
@Slf4j
public class Idea66114Service {
    private static final int IDEA_ID = 66114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66114Service() {
        this(new Idea66114Config());
    }

    public Idea66114Service(Idea66114Config config) {
        this.config = config != null ? config : new Idea66114Config();
