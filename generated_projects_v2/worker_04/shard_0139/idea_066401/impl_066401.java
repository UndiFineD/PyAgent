...
@Data
public class Idea66401Config {
    private String name = "idea_066401";
 ...
 */
@Slf4j
public class Idea66401Service {
    private static final int IDEA_ID = 66401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66401Service() {
        this(new Idea66401Config());
    }

    public Idea66401Service(Idea66401Config config) {
        this.config = config != null ? config : new Idea66401Config();
