...
@Data
public class Idea66275Config {
    private String name = "idea_066275";
 ...
 */
@Slf4j
public class Idea66275Service {
    private static final int IDEA_ID = 66275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66275Service() {
        this(new Idea66275Config());
    }

    public Idea66275Service(Idea66275Config config) {
        this.config = config != null ? config : new Idea66275Config();
