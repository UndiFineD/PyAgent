...
@Data
public class Idea66351Config {
    private String name = "idea_066351";
 ...
 */
@Slf4j
public class Idea66351Service {
    private static final int IDEA_ID = 66351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66351Service() {
        this(new Idea66351Config());
    }

    public Idea66351Service(Idea66351Config config) {
        this.config = config != null ? config : new Idea66351Config();
