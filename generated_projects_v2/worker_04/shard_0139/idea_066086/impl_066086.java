...
@Data
public class Idea66086Config {
    private String name = "idea_066086";
 ...
 */
@Slf4j
public class Idea66086Service {
    private static final int IDEA_ID = 66086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66086Service() {
        this(new Idea66086Config());
    }

    public Idea66086Service(Idea66086Config config) {
        this.config = config != null ? config : new Idea66086Config();
