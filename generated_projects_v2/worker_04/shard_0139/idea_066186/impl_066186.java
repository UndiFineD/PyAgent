...
@Data
public class Idea66186Config {
    private String name = "idea_066186";
 ...
 */
@Slf4j
public class Idea66186Service {
    private static final int IDEA_ID = 66186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66186Service() {
        this(new Idea66186Config());
    }

    public Idea66186Service(Idea66186Config config) {
        this.config = config != null ? config : new Idea66186Config();
