...
@Data
public class Idea66217Config {
    private String name = "idea_066217";
 ...
 */
@Slf4j
public class Idea66217Service {
    private static final int IDEA_ID = 66217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66217Service() {
        this(new Idea66217Config());
    }

    public Idea66217Service(Idea66217Config config) {
        this.config = config != null ? config : new Idea66217Config();
