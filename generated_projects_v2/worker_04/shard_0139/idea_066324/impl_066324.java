...
@Data
public class Idea66324Config {
    private String name = "idea_066324";
 ...
 */
@Slf4j
public class Idea66324Service {
    private static final int IDEA_ID = 66324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66324Service() {
        this(new Idea66324Config());
    }

    public Idea66324Service(Idea66324Config config) {
        this.config = config != null ? config : new Idea66324Config();
