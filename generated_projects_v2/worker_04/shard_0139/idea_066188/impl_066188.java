...
@Data
public class Idea66188Config {
    private String name = "idea_066188";
 ...
 */
@Slf4j
public class Idea66188Service {
    private static final int IDEA_ID = 66188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66188Service() {
        this(new Idea66188Config());
    }

    public Idea66188Service(Idea66188Config config) {
        this.config = config != null ? config : new Idea66188Config();
