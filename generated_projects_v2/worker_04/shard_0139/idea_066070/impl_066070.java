...
@Data
public class Idea66070Config {
    private String name = "idea_066070";
 ...
 */
@Slf4j
public class Idea66070Service {
    private static final int IDEA_ID = 66070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66070Service() {
        this(new Idea66070Config());
    }

    public Idea66070Service(Idea66070Config config) {
        this.config = config != null ? config : new Idea66070Config();
