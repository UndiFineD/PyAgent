...
@Data
public class Idea66241Config {
    private String name = "idea_066241";
 ...
 */
@Slf4j
public class Idea66241Service {
    private static final int IDEA_ID = 66241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66241Service() {
        this(new Idea66241Config());
    }

    public Idea66241Service(Idea66241Config config) {
        this.config = config != null ? config : new Idea66241Config();
