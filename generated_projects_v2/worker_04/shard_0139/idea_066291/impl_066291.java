...
@Data
public class Idea66291Config {
    private String name = "idea_066291";
 ...
 */
@Slf4j
public class Idea66291Service {
    private static final int IDEA_ID = 66291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66291Service() {
        this(new Idea66291Config());
    }

    public Idea66291Service(Idea66291Config config) {
        this.config = config != null ? config : new Idea66291Config();
