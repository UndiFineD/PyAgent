...
@Data
public class Idea66321Config {
    private String name = "idea_066321";
 ...
 */
@Slf4j
public class Idea66321Service {
    private static final int IDEA_ID = 66321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66321Service() {
        this(new Idea66321Config());
    }

    public Idea66321Service(Idea66321Config config) {
        this.config = config != null ? config : new Idea66321Config();
