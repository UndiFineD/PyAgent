...
@Data
public class Idea66311Config {
    private String name = "idea_066311";
 ...
 */
@Slf4j
public class Idea66311Service {
    private static final int IDEA_ID = 66311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66311Service() {
        this(new Idea66311Config());
    }

    public Idea66311Service(Idea66311Config config) {
        this.config = config != null ? config : new Idea66311Config();
