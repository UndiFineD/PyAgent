...
@Data
public class Idea66106Config {
    private String name = "idea_066106";
 ...
 */
@Slf4j
public class Idea66106Service {
    private static final int IDEA_ID = 66106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66106Service() {
        this(new Idea66106Config());
    }

    public Idea66106Service(Idea66106Config config) {
        this.config = config != null ? config : new Idea66106Config();
