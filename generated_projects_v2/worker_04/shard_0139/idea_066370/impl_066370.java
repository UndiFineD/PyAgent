...
@Data
public class Idea66370Config {
    private String name = "idea_066370";
 ...
 */
@Slf4j
public class Idea66370Service {
    private static final int IDEA_ID = 66370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66370Service() {
        this(new Idea66370Config());
    }

    public Idea66370Service(Idea66370Config config) {
        this.config = config != null ? config : new Idea66370Config();
