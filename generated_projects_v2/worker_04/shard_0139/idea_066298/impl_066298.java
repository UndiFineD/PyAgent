...
@Data
public class Idea66298Config {
    private String name = "idea_066298";
 ...
 */
@Slf4j
public class Idea66298Service {
    private static final int IDEA_ID = 66298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66298Service() {
        this(new Idea66298Config());
    }

    public Idea66298Service(Idea66298Config config) {
        this.config = config != null ? config : new Idea66298Config();
