...
@Data
public class Idea62209Config {
    private String name = "idea_062209";
 ...
 */
@Slf4j
public class Idea62209Service {
    private static final int IDEA_ID = 62209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62209Service() {
        this(new Idea62209Config());
    }

    public Idea62209Service(Idea62209Config config) {
        this.config = config != null ? config : new Idea62209Config();
