...
@Data
public class Idea62007Config {
    private String name = "idea_062007";
 ...
 */
@Slf4j
public class Idea62007Service {
    private static final int IDEA_ID = 62007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62007Service() {
        this(new Idea62007Config());
    }

    public Idea62007Service(Idea62007Config config) {
        this.config = config != null ? config : new Idea62007Config();
