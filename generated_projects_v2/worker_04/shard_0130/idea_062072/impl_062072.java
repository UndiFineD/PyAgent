...
@Data
public class Idea62072Config {
    private String name = "idea_062072";
 ...
 */
@Slf4j
public class Idea62072Service {
    private static final int IDEA_ID = 62072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62072Service() {
        this(new Idea62072Config());
    }

    public Idea62072Service(Idea62072Config config) {
        this.config = config != null ? config : new Idea62072Config();
