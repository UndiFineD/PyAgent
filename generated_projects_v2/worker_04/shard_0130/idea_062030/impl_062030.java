...
@Data
public class Idea62030Config {
    private String name = "idea_062030";
 ...
 */
@Slf4j
public class Idea62030Service {
    private static final int IDEA_ID = 62030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62030Service() {
        this(new Idea62030Config());
    }

    public Idea62030Service(Idea62030Config config) {
        this.config = config != null ? config : new Idea62030Config();
