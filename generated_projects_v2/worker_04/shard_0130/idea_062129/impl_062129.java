...
@Data
public class Idea62129Config {
    private String name = "idea_062129";
 ...
 */
@Slf4j
public class Idea62129Service {
    private static final int IDEA_ID = 62129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62129Service() {
        this(new Idea62129Config());
    }

    public Idea62129Service(Idea62129Config config) {
        this.config = config != null ? config : new Idea62129Config();
