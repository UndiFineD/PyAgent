...
@Data
public class Idea61946Config {
    private String name = "idea_061946";
 ...
 */
@Slf4j
public class Idea61946Service {
    private static final int IDEA_ID = 61946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61946Service() {
        this(new Idea61946Config());
    }

    public Idea61946Service(Idea61946Config config) {
        this.config = config != null ? config : new Idea61946Config();
