...
@Data
public class Idea61980Config {
    private String name = "idea_061980";
 ...
 */
@Slf4j
public class Idea61980Service {
    private static final int IDEA_ID = 61980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61980Service() {
        this(new Idea61980Config());
    }

    public Idea61980Service(Idea61980Config config) {
        this.config = config != null ? config : new Idea61980Config();
