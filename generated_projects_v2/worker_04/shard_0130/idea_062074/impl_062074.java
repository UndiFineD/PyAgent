...
@Data
public class Idea62074Config {
    private String name = "idea_062074";
 ...
 */
@Slf4j
public class Idea62074Service {
    private static final int IDEA_ID = 62074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62074Service() {
        this(new Idea62074Config());
    }

    public Idea62074Service(Idea62074Config config) {
        this.config = config != null ? config : new Idea62074Config();
