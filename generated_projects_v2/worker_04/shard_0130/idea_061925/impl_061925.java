...
@Data
public class Idea61925Config {
    private String name = "idea_061925";
 ...
 */
@Slf4j
public class Idea61925Service {
    private static final int IDEA_ID = 61925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61925Service() {
        this(new Idea61925Config());
    }

    public Idea61925Service(Idea61925Config config) {
        this.config = config != null ? config : new Idea61925Config();
