...
@Data
public class Idea62020Config {
    private String name = "idea_062020";
 ...
 */
@Slf4j
public class Idea62020Service {
    private static final int IDEA_ID = 62020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62020Service() {
        this(new Idea62020Config());
    }

    public Idea62020Service(Idea62020Config config) {
        this.config = config != null ? config : new Idea62020Config();
