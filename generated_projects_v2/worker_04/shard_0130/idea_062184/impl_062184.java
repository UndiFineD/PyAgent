...
@Data
public class Idea62184Config {
    private String name = "idea_062184";
 ...
 */
@Slf4j
public class Idea62184Service {
    private static final int IDEA_ID = 62184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62184Service() {
        this(new Idea62184Config());
    }

    public Idea62184Service(Idea62184Config config) {
        this.config = config != null ? config : new Idea62184Config();
