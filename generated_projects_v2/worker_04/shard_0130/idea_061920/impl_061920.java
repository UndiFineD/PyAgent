...
@Data
public class Idea61920Config {
    private String name = "idea_061920";
 ...
 */
@Slf4j
public class Idea61920Service {
    private static final int IDEA_ID = 61920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61920Service() {
        this(new Idea61920Config());
    }

    public Idea61920Service(Idea61920Config config) {
        this.config = config != null ? config : new Idea61920Config();
