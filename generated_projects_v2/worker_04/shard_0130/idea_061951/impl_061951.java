...
@Data
public class Idea61951Config {
    private String name = "idea_061951";
 ...
 */
@Slf4j
public class Idea61951Service {
    private static final int IDEA_ID = 61951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61951Service() {
        this(new Idea61951Config());
    }

    public Idea61951Service(Idea61951Config config) {
        this.config = config != null ? config : new Idea61951Config();
