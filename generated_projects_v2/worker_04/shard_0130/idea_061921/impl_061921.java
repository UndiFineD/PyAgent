...
@Data
public class Idea61921Config {
    private String name = "idea_061921";
 ...
 */
@Slf4j
public class Idea61921Service {
    private static final int IDEA_ID = 61921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61921Service() {
        this(new Idea61921Config());
    }

    public Idea61921Service(Idea61921Config config) {
        this.config = config != null ? config : new Idea61921Config();
