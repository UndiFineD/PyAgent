...
@Data
public class Idea62089Config {
    private String name = "idea_062089";
 ...
 */
@Slf4j
public class Idea62089Service {
    private static final int IDEA_ID = 62089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62089Service() {
        this(new Idea62089Config());
    }

    public Idea62089Service(Idea62089Config config) {
        this.config = config != null ? config : new Idea62089Config();
