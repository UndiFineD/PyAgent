...
@Data
public class Idea61991Config {
    private String name = "idea_061991";
 ...
 */
@Slf4j
public class Idea61991Service {
    private static final int IDEA_ID = 61991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61991Service() {
        this(new Idea61991Config());
    }

    public Idea61991Service(Idea61991Config config) {
        this.config = config != null ? config : new Idea61991Config();
