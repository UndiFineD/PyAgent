...
@Data
public class Idea61861Config {
    private String name = "idea_061861";
 ...
 */
@Slf4j
public class Idea61861Service {
    private static final int IDEA_ID = 61861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61861Service() {
        this(new Idea61861Config());
    }

    public Idea61861Service(Idea61861Config config) {
        this.config = config != null ? config : new Idea61861Config();
