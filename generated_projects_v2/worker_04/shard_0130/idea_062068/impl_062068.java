...
@Data
public class Idea62068Config {
    private String name = "idea_062068";
 ...
 */
@Slf4j
public class Idea62068Service {
    private static final int IDEA_ID = 62068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62068Service() {
        this(new Idea62068Config());
    }

    public Idea62068Service(Idea62068Config config) {
        this.config = config != null ? config : new Idea62068Config();
