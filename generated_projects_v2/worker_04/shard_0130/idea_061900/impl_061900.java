...
@Data
public class Idea61900Config {
    private String name = "idea_061900";
 ...
 */
@Slf4j
public class Idea61900Service {
    private static final int IDEA_ID = 61900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61900Service() {
        this(new Idea61900Config());
    }

    public Idea61900Service(Idea61900Config config) {
        this.config = config != null ? config : new Idea61900Config();
