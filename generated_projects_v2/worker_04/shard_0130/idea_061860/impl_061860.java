...
@Data
public class Idea61860Config {
    private String name = "idea_061860";
 ...
 */
@Slf4j
public class Idea61860Service {
    private static final int IDEA_ID = 61860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61860Service() {
        this(new Idea61860Config());
    }

    public Idea61860Service(Idea61860Config config) {
        this.config = config != null ? config : new Idea61860Config();
