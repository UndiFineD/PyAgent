...
@Data
public class Idea62191Config {
    private String name = "idea_062191";
 ...
 */
@Slf4j
public class Idea62191Service {
    private static final int IDEA_ID = 62191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62191Service() {
        this(new Idea62191Config());
    }

    public Idea62191Service(Idea62191Config config) {
        this.config = config != null ? config : new Idea62191Config();
