...
@Data
public class Idea61945Config {
    private String name = "idea_061945";
 ...
 */
@Slf4j
public class Idea61945Service {
    private static final int IDEA_ID = 61945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61945Service() {
        this(new Idea61945Config());
    }

    public Idea61945Service(Idea61945Config config) {
        this.config = config != null ? config : new Idea61945Config();
