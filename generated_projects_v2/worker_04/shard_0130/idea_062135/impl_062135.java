...
@Data
public class Idea62135Config {
    private String name = "idea_062135";
 ...
 */
@Slf4j
public class Idea62135Service {
    private static final int IDEA_ID = 62135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62135Service() {
        this(new Idea62135Config());
    }

    public Idea62135Service(Idea62135Config config) {
        this.config = config != null ? config : new Idea62135Config();
