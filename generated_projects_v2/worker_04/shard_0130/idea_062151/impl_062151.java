...
@Data
public class Idea62151Config {
    private String name = "idea_062151";
 ...
 */
@Slf4j
public class Idea62151Service {
    private static final int IDEA_ID = 62151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62151Service() {
        this(new Idea62151Config());
    }

    public Idea62151Service(Idea62151Config config) {
        this.config = config != null ? config : new Idea62151Config();
