...
@Data
public class Idea62196Config {
    private String name = "idea_062196";
 ...
 */
@Slf4j
public class Idea62196Service {
    private static final int IDEA_ID = 62196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62196Service() {
        this(new Idea62196Config());
    }

    public Idea62196Service(Idea62196Config config) {
        this.config = config != null ? config : new Idea62196Config();
