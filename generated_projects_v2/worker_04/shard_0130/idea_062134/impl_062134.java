...
@Data
public class Idea62134Config {
    private String name = "idea_062134";
 ...
 */
@Slf4j
public class Idea62134Service {
    private static final int IDEA_ID = 62134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62134Service() {
        this(new Idea62134Config());
    }

    public Idea62134Service(Idea62134Config config) {
        this.config = config != null ? config : new Idea62134Config();
