...
@Data
public class Idea61895Config {
    private String name = "idea_061895";
 ...
 */
@Slf4j
public class Idea61895Service {
    private static final int IDEA_ID = 61895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61895Service() {
        this(new Idea61895Config());
    }

    public Idea61895Service(Idea61895Config config) {
        this.config = config != null ? config : new Idea61895Config();
