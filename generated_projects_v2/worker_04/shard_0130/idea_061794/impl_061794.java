...
@Data
public class Idea61794Config {
    private String name = "idea_061794";
 ...
 */
@Slf4j
public class Idea61794Service {
    private static final int IDEA_ID = 61794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61794Service() {
        this(new Idea61794Config());
    }

    public Idea61794Service(Idea61794Config config) {
        this.config = config != null ? config : new Idea61794Config();
