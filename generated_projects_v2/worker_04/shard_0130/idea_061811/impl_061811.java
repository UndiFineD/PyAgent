...
@Data
public class Idea61811Config {
    private String name = "idea_061811";
 ...
 */
@Slf4j
public class Idea61811Service {
    private static final int IDEA_ID = 61811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61811Service() {
        this(new Idea61811Config());
    }

    public Idea61811Service(Idea61811Config config) {
        this.config = config != null ? config : new Idea61811Config();
