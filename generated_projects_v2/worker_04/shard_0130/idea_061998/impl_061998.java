...
@Data
public class Idea61998Config {
    private String name = "idea_061998";
 ...
 */
@Slf4j
public class Idea61998Service {
    private static final int IDEA_ID = 61998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61998Service() {
        this(new Idea61998Config());
    }

    public Idea61998Service(Idea61998Config config) {
        this.config = config != null ? config : new Idea61998Config();
