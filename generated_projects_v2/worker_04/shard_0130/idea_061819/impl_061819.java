...
@Data
public class Idea61819Config {
    private String name = "idea_061819";
 ...
 */
@Slf4j
public class Idea61819Service {
    private static final int IDEA_ID = 61819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61819Service() {
        this(new Idea61819Config());
    }

    public Idea61819Service(Idea61819Config config) {
        this.config = config != null ? config : new Idea61819Config();
