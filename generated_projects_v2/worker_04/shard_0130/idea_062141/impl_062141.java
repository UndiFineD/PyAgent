...
@Data
public class Idea62141Config {
    private String name = "idea_062141";
 ...
 */
@Slf4j
public class Idea62141Service {
    private static final int IDEA_ID = 62141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62141Service() {
        this(new Idea62141Config());
    }

    public Idea62141Service(Idea62141Config config) {
        this.config = config != null ? config : new Idea62141Config();
