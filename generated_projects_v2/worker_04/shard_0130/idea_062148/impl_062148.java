...
@Data
public class Idea62148Config {
    private String name = "idea_062148";
 ...
 */
@Slf4j
public class Idea62148Service {
    private static final int IDEA_ID = 62148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62148Service() {
        this(new Idea62148Config());
    }

    public Idea62148Service(Idea62148Config config) {
        this.config = config != null ? config : new Idea62148Config();
