...
@Data
public class Idea62180Config {
    private String name = "idea_062180";
 ...
 */
@Slf4j
public class Idea62180Service {
    private static final int IDEA_ID = 62180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62180Service() {
        this(new Idea62180Config());
    }

    public Idea62180Service(Idea62180Config config) {
        this.config = config != null ? config : new Idea62180Config();
