...
@Data
public class Idea62157Config {
    private String name = "idea_062157";
 ...
 */
@Slf4j
public class Idea62157Service {
    private static final int IDEA_ID = 62157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62157Service() {
        this(new Idea62157Config());
    }

    public Idea62157Service(Idea62157Config config) {
        this.config = config != null ? config : new Idea62157Config();
