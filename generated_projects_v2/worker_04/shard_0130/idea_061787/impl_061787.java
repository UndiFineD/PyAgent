...
@Data
public class Idea61787Config {
    private String name = "idea_061787";
 ...
 */
@Slf4j
public class Idea61787Service {
    private static final int IDEA_ID = 61787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61787Service() {
        this(new Idea61787Config());
    }

    public Idea61787Service(Idea61787Config config) {
        this.config = config != null ? config : new Idea61787Config();
