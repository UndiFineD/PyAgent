...
@Data
public class Idea61933Config {
    private String name = "idea_061933";
 ...
 */
@Slf4j
public class Idea61933Service {
    private static final int IDEA_ID = 61933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61933Service() {
        this(new Idea61933Config());
    }

    public Idea61933Service(Idea61933Config config) {
        this.config = config != null ? config : new Idea61933Config();
