...
@Data
public class Idea62022Config {
    private String name = "idea_062022";
 ...
 */
@Slf4j
public class Idea62022Service {
    private static final int IDEA_ID = 62022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62022Service() {
        this(new Idea62022Config());
    }

    public Idea62022Service(Idea62022Config config) {
        this.config = config != null ? config : new Idea62022Config();
