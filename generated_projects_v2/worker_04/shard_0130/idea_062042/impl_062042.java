...
@Data
public class Idea62042Config {
    private String name = "idea_062042";
 ...
 */
@Slf4j
public class Idea62042Service {
    private static final int IDEA_ID = 62042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62042Service() {
        this(new Idea62042Config());
    }

    public Idea62042Service(Idea62042Config config) {
        this.config = config != null ? config : new Idea62042Config();
