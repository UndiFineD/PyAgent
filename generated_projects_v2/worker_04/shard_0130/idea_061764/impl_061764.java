...
@Data
public class Idea61764Config {
    private String name = "idea_061764";
 ...
 */
@Slf4j
public class Idea61764Service {
    private static final int IDEA_ID = 61764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61764Service() {
        this(new Idea61764Config());
    }

    public Idea61764Service(Idea61764Config config) {
        this.config = config != null ? config : new Idea61764Config();
