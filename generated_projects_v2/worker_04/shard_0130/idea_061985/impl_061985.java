...
@Data
public class Idea61985Config {
    private String name = "idea_061985";
 ...
 */
@Slf4j
public class Idea61985Service {
    private static final int IDEA_ID = 61985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61985Service() {
        this(new Idea61985Config());
    }

    public Idea61985Service(Idea61985Config config) {
        this.config = config != null ? config : new Idea61985Config();
