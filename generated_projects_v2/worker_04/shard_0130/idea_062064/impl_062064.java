...
@Data
public class Idea62064Config {
    private String name = "idea_062064";
 ...
 */
@Slf4j
public class Idea62064Service {
    private static final int IDEA_ID = 62064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62064Service() {
        this(new Idea62064Config());
    }

    public Idea62064Service(Idea62064Config config) {
        this.config = config != null ? config : new Idea62064Config();
