...
@Data
public class Idea61960Config {
    private String name = "idea_061960";
 ...
 */
@Slf4j
public class Idea61960Service {
    private static final int IDEA_ID = 61960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61960Service() {
        this(new Idea61960Config());
    }

    public Idea61960Service(Idea61960Config config) {
        this.config = config != null ? config : new Idea61960Config();
