...
@Data
public class Idea62059Config {
    private String name = "idea_062059";
 ...
 */
@Slf4j
public class Idea62059Service {
    private static final int IDEA_ID = 62059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62059Service() {
        this(new Idea62059Config());
    }

    public Idea62059Service(Idea62059Config config) {
        this.config = config != null ? config : new Idea62059Config();
