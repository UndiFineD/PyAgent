...
@Data
public class Idea62081Config {
    private String name = "idea_062081";
 ...
 */
@Slf4j
public class Idea62081Service {
    private static final int IDEA_ID = 62081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62081Service() {
        this(new Idea62081Config());
    }

    public Idea62081Service(Idea62081Config config) {
        this.config = config != null ? config : new Idea62081Config();
