...
@Data
public class Idea61888Config {
    private String name = "idea_061888";
 ...
 */
@Slf4j
public class Idea61888Service {
    private static final int IDEA_ID = 61888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61888Service() {
        this(new Idea61888Config());
    }

    public Idea61888Service(Idea61888Config config) {
        this.config = config != null ? config : new Idea61888Config();
