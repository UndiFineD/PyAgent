...
@Data
public class Idea62057Config {
    private String name = "idea_062057";
 ...
 */
@Slf4j
public class Idea62057Service {
    private static final int IDEA_ID = 62057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62057Service() {
        this(new Idea62057Config());
    }

    public Idea62057Service(Idea62057Config config) {
        this.config = config != null ? config : new Idea62057Config();
