...
@Data
public class Idea61949Config {
    private String name = "idea_061949";
 ...
 */
@Slf4j
public class Idea61949Service {
    private static final int IDEA_ID = 61949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61949Service() {
        this(new Idea61949Config());
    }

    public Idea61949Service(Idea61949Config config) {
        this.config = config != null ? config : new Idea61949Config();
