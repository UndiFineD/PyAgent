...
@Data
public class Idea61760Config {
    private String name = "idea_061760";
 ...
 */
@Slf4j
public class Idea61760Service {
    private static final int IDEA_ID = 61760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61760Service() {
        this(new Idea61760Config());
    }

    public Idea61760Service(Idea61760Config config) {
        this.config = config != null ? config : new Idea61760Config();
