...
@Data
public class Idea61856Config {
    private String name = "idea_061856";
 ...
 */
@Slf4j
public class Idea61856Service {
    private static final int IDEA_ID = 61856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61856Service() {
        this(new Idea61856Config());
    }

    public Idea61856Service(Idea61856Config config) {
        this.config = config != null ? config : new Idea61856Config();
