...
@Data
public class Idea62222Config {
    private String name = "idea_062222";
 ...
 */
@Slf4j
public class Idea62222Service {
    private static final int IDEA_ID = 62222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62222Service() {
        this(new Idea62222Config());
    }

    public Idea62222Service(Idea62222Config config) {
        this.config = config != null ? config : new Idea62222Config();
