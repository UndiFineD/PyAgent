...
@Data
public class Idea61864Config {
    private String name = "idea_061864";
 ...
 */
@Slf4j
public class Idea61864Service {
    private static final int IDEA_ID = 61864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61864Service() {
        this(new Idea61864Config());
    }

    public Idea61864Service(Idea61864Config config) {
        this.config = config != null ? config : new Idea61864Config();
