...
@Data
public class Idea62029Config {
    private String name = "idea_062029";
 ...
 */
@Slf4j
public class Idea62029Service {
    private static final int IDEA_ID = 62029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62029Service() {
        this(new Idea62029Config());
    }

    public Idea62029Service(Idea62029Config config) {
        this.config = config != null ? config : new Idea62029Config();
