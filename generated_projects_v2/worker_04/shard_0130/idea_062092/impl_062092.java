...
@Data
public class Idea62092Config {
    private String name = "idea_062092";
 ...
 */
@Slf4j
public class Idea62092Service {
    private static final int IDEA_ID = 62092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62092Service() {
        this(new Idea62092Config());
    }

    public Idea62092Service(Idea62092Config config) {
        this.config = config != null ? config : new Idea62092Config();
