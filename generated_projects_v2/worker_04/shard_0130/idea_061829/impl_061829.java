...
@Data
public class Idea61829Config {
    private String name = "idea_061829";
 ...
 */
@Slf4j
public class Idea61829Service {
    private static final int IDEA_ID = 61829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61829Service() {
        this(new Idea61829Config());
    }

    public Idea61829Service(Idea61829Config config) {
        this.config = config != null ? config : new Idea61829Config();
