...
@Data
public class Idea62035Config {
    private String name = "idea_062035";
 ...
 */
@Slf4j
public class Idea62035Service {
    private static final int IDEA_ID = 62035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62035Service() {
        this(new Idea62035Config());
    }

    public Idea62035Service(Idea62035Config config) {
        this.config = config != null ? config : new Idea62035Config();
