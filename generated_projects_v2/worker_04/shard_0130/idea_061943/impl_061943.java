...
@Data
public class Idea61943Config {
    private String name = "idea_061943";
 ...
 */
@Slf4j
public class Idea61943Service {
    private static final int IDEA_ID = 61943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61943Service() {
        this(new Idea61943Config());
    }

    public Idea61943Service(Idea61943Config config) {
        this.config = config != null ? config : new Idea61943Config();
