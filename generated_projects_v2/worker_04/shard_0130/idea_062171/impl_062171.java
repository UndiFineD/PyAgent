...
@Data
public class Idea62171Config {
    private String name = "idea_062171";
 ...
 */
@Slf4j
public class Idea62171Service {
    private static final int IDEA_ID = 62171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62171Service() {
        this(new Idea62171Config());
    }

    public Idea62171Service(Idea62171Config config) {
        this.config = config != null ? config : new Idea62171Config();
