...
@Data
public class Idea61847Config {
    private String name = "idea_061847";
 ...
 */
@Slf4j
public class Idea61847Service {
    private static final int IDEA_ID = 61847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61847Service() {
        this(new Idea61847Config());
    }

    public Idea61847Service(Idea61847Config config) {
        this.config = config != null ? config : new Idea61847Config();
