...
@Data
public class Idea61890Config {
    private String name = "idea_061890";
 ...
 */
@Slf4j
public class Idea61890Service {
    private static final int IDEA_ID = 61890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61890Service() {
        this(new Idea61890Config());
    }

    public Idea61890Service(Idea61890Config config) {
        this.config = config != null ? config : new Idea61890Config();
