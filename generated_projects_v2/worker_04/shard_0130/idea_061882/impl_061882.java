...
@Data
public class Idea61882Config {
    private String name = "idea_061882";
 ...
 */
@Slf4j
public class Idea61882Service {
    private static final int IDEA_ID = 61882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61882Service() {
        this(new Idea61882Config());
    }

    public Idea61882Service(Idea61882Config config) {
        this.config = config != null ? config : new Idea61882Config();
