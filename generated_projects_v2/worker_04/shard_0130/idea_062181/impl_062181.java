...
@Data
public class Idea62181Config {
    private String name = "idea_062181";
 ...
 */
@Slf4j
public class Idea62181Service {
    private static final int IDEA_ID = 62181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62181Service() {
        this(new Idea62181Config());
    }

    public Idea62181Service(Idea62181Config config) {
        this.config = config != null ? config : new Idea62181Config();
