...
@Data
public class Idea61975Config {
    private String name = "idea_061975";
 ...
 */
@Slf4j
public class Idea61975Service {
    private static final int IDEA_ID = 61975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61975Service() {
        this(new Idea61975Config());
    }

    public Idea61975Service(Idea61975Config config) {
        this.config = config != null ? config : new Idea61975Config();
