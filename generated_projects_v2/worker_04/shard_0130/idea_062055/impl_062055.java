...
@Data
public class Idea62055Config {
    private String name = "idea_062055";
 ...
 */
@Slf4j
public class Idea62055Service {
    private static final int IDEA_ID = 62055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62055Service() {
        this(new Idea62055Config());
    }

    public Idea62055Service(Idea62055Config config) {
        this.config = config != null ? config : new Idea62055Config();
