...
@Data
public class Idea62100Config {
    private String name = "idea_062100";
 ...
 */
@Slf4j
public class Idea62100Service {
    private static final int IDEA_ID = 62100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62100Service() {
        this(new Idea62100Config());
    }

    public Idea62100Service(Idea62100Config config) {
        this.config = config != null ? config : new Idea62100Config();
