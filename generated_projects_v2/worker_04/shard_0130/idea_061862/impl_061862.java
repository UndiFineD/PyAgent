...
@Data
public class Idea61862Config {
    private String name = "idea_061862";
 ...
 */
@Slf4j
public class Idea61862Service {
    private static final int IDEA_ID = 61862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61862Service() {
        this(new Idea61862Config());
    }

    public Idea61862Service(Idea61862Config config) {
        this.config = config != null ? config : new Idea61862Config();
