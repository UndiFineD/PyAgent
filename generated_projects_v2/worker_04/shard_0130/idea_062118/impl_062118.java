...
@Data
public class Idea62118Config {
    private String name = "idea_062118";
 ...
 */
@Slf4j
public class Idea62118Service {
    private static final int IDEA_ID = 62118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62118Service() {
        this(new Idea62118Config());
    }

    public Idea62118Service(Idea62118Config config) {
        this.config = config != null ? config : new Idea62118Config();
