...
@Data
public class Idea62152Config {
    private String name = "idea_062152";
 ...
 */
@Slf4j
public class Idea62152Service {
    private static final int IDEA_ID = 62152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62152Service() {
        this(new Idea62152Config());
    }

    public Idea62152Service(Idea62152Config config) {
        this.config = config != null ? config : new Idea62152Config();
