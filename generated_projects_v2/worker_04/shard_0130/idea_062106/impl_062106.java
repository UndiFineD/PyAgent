...
@Data
public class Idea62106Config {
    private String name = "idea_062106";
 ...
 */
@Slf4j
public class Idea62106Service {
    private static final int IDEA_ID = 62106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62106Service() {
        this(new Idea62106Config());
    }

    public Idea62106Service(Idea62106Config config) {
        this.config = config != null ? config : new Idea62106Config();
