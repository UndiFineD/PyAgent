...
@Data
public class Idea61904Config {
    private String name = "idea_061904";
 ...
 */
@Slf4j
public class Idea61904Service {
    private static final int IDEA_ID = 61904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61904Service() {
        this(new Idea61904Config());
    }

    public Idea61904Service(Idea61904Config config) {
        this.config = config != null ? config : new Idea61904Config();
