...
@Data
public class Idea61777Config {
    private String name = "idea_061777";
 ...
 */
@Slf4j
public class Idea61777Service {
    private static final int IDEA_ID = 61777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61777Service() {
        this(new Idea61777Config());
    }

    public Idea61777Service(Idea61777Config config) {
        this.config = config != null ? config : new Idea61777Config();
