...
@Data
public class Idea61881Config {
    private String name = "idea_061881";
 ...
 */
@Slf4j
public class Idea61881Service {
    private static final int IDEA_ID = 61881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61881Service() {
        this(new Idea61881Config());
    }

    public Idea61881Service(Idea61881Config config) {
        this.config = config != null ? config : new Idea61881Config();
