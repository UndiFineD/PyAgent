...
@Data
public class Idea61893Config {
    private String name = "idea_061893";
 ...
 */
@Slf4j
public class Idea61893Service {
    private static final int IDEA_ID = 61893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61893Service() {
        this(new Idea61893Config());
    }

    public Idea61893Service(Idea61893Config config) {
        this.config = config != null ? config : new Idea61893Config();
