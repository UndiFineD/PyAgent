...
@Data
public class Idea62047Config {
    private String name = "idea_062047";
 ...
 */
@Slf4j
public class Idea62047Service {
    private static final int IDEA_ID = 62047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62047Service() {
        this(new Idea62047Config());
    }

    public Idea62047Service(Idea62047Config config) {
        this.config = config != null ? config : new Idea62047Config();
