...
@Data
public class Idea62018Config {
    private String name = "idea_062018";
 ...
 */
@Slf4j
public class Idea62018Service {
    private static final int IDEA_ID = 62018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62018Service() {
        this(new Idea62018Config());
    }

    public Idea62018Service(Idea62018Config config) {
        this.config = config != null ? config : new Idea62018Config();
