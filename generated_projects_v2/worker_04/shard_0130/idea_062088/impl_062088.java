...
@Data
public class Idea62088Config {
    private String name = "idea_062088";
 ...
 */
@Slf4j
public class Idea62088Service {
    private static final int IDEA_ID = 62088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62088Service() {
        this(new Idea62088Config());
    }

    public Idea62088Service(Idea62088Config config) {
        this.config = config != null ? config : new Idea62088Config();
