...
@Data
public class Idea61950Config {
    private String name = "idea_061950";
 ...
 */
@Slf4j
public class Idea61950Service {
    private static final int IDEA_ID = 61950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61950Service() {
        this(new Idea61950Config());
    }

    public Idea61950Service(Idea61950Config config) {
        this.config = config != null ? config : new Idea61950Config();
