...
@Data
public class Idea61978Config {
    private String name = "idea_061978";
 ...
 */
@Slf4j
public class Idea61978Service {
    private static final int IDEA_ID = 61978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61978Service() {
        this(new Idea61978Config());
    }

    public Idea61978Service(Idea61978Config config) {
        this.config = config != null ? config : new Idea61978Config();
