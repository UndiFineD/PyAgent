...
@Data
public class Idea61785Config {
    private String name = "idea_061785";
 ...
 */
@Slf4j
public class Idea61785Service {
    private static final int IDEA_ID = 61785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61785Service() {
        this(new Idea61785Config());
    }

    public Idea61785Service(Idea61785Config config) {
        this.config = config != null ? config : new Idea61785Config();
