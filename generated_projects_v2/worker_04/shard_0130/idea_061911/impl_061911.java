...
@Data
public class Idea61911Config {
    private String name = "idea_061911";
 ...
 */
@Slf4j
public class Idea61911Service {
    private static final int IDEA_ID = 61911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61911Service() {
        this(new Idea61911Config());
    }

    public Idea61911Service(Idea61911Config config) {
        this.config = config != null ? config : new Idea61911Config();
