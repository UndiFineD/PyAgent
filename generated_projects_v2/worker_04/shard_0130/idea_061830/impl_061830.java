...
@Data
public class Idea61830Config {
    private String name = "idea_061830";
 ...
 */
@Slf4j
public class Idea61830Service {
    private static final int IDEA_ID = 61830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61830Service() {
        this(new Idea61830Config());
    }

    public Idea61830Service(Idea61830Config config) {
        this.config = config != null ? config : new Idea61830Config();
