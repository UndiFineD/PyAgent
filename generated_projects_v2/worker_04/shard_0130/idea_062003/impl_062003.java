...
@Data
public class Idea62003Config {
    private String name = "idea_062003";
 ...
 */
@Slf4j
public class Idea62003Service {
    private static final int IDEA_ID = 62003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62003Service() {
        this(new Idea62003Config());
    }

    public Idea62003Service(Idea62003Config config) {
        this.config = config != null ? config : new Idea62003Config();
