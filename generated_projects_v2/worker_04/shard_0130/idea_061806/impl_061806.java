...
@Data
public class Idea61806Config {
    private String name = "idea_061806";
 ...
 */
@Slf4j
public class Idea61806Service {
    private static final int IDEA_ID = 61806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61806Service() {
        this(new Idea61806Config());
    }

    public Idea61806Service(Idea61806Config config) {
        this.config = config != null ? config : new Idea61806Config();
