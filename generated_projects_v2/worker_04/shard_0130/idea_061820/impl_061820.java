...
@Data
public class Idea61820Config {
    private String name = "idea_061820";
 ...
 */
@Slf4j
public class Idea61820Service {
    private static final int IDEA_ID = 61820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61820Service() {
        this(new Idea61820Config());
    }

    public Idea61820Service(Idea61820Config config) {
        this.config = config != null ? config : new Idea61820Config();
