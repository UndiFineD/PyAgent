...
@Data
public class Idea62143Config {
    private String name = "idea_062143";
 ...
 */
@Slf4j
public class Idea62143Service {
    private static final int IDEA_ID = 62143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62143Service() {
        this(new Idea62143Config());
    }

    public Idea62143Service(Idea62143Config config) {
        this.config = config != null ? config : new Idea62143Config();
