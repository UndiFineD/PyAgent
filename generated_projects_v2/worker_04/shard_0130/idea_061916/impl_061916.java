...
@Data
public class Idea61916Config {
    private String name = "idea_061916";
 ...
 */
@Slf4j
public class Idea61916Service {
    private static final int IDEA_ID = 61916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61916Service() {
        this(new Idea61916Config());
    }

    public Idea61916Service(Idea61916Config config) {
        this.config = config != null ? config : new Idea61916Config();
