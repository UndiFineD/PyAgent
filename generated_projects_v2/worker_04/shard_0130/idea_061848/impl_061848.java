...
@Data
public class Idea61848Config {
    private String name = "idea_061848";
 ...
 */
@Slf4j
public class Idea61848Service {
    private static final int IDEA_ID = 61848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61848Service() {
        this(new Idea61848Config());
    }

    public Idea61848Service(Idea61848Config config) {
        this.config = config != null ? config : new Idea61848Config();
