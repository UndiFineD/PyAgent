...
@Data
public class Idea62066Config {
    private String name = "idea_062066";
 ...
 */
@Slf4j
public class Idea62066Service {
    private static final int IDEA_ID = 62066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62066Service() {
        this(new Idea62066Config());
    }

    public Idea62066Service(Idea62066Config config) {
        this.config = config != null ? config : new Idea62066Config();
