...
@Data
public class Idea62062Config {
    private String name = "idea_062062";
 ...
 */
@Slf4j
public class Idea62062Service {
    private static final int IDEA_ID = 62062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62062Service() {
        this(new Idea62062Config());
    }

    public Idea62062Service(Idea62062Config config) {
        this.config = config != null ? config : new Idea62062Config();
