...
@Data
public class Idea62214Config {
    private String name = "idea_062214";
 ...
 */
@Slf4j
public class Idea62214Service {
    private static final int IDEA_ID = 62214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62214Service() {
        this(new Idea62214Config());
    }

    public Idea62214Service(Idea62214Config config) {
        this.config = config != null ? config : new Idea62214Config();
