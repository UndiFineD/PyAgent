...
@Data
public class Idea62002Config {
    private String name = "idea_062002";
 ...
 */
@Slf4j
public class Idea62002Service {
    private static final int IDEA_ID = 62002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62002Service() {
        this(new Idea62002Config());
    }

    public Idea62002Service(Idea62002Config config) {
        this.config = config != null ? config : new Idea62002Config();
