...
@Data
public class Idea62098Config {
    private String name = "idea_062098";
 ...
 */
@Slf4j
public class Idea62098Service {
    private static final int IDEA_ID = 62098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62098Service() {
        this(new Idea62098Config());
    }

    public Idea62098Service(Idea62098Config config) {
        this.config = config != null ? config : new Idea62098Config();
