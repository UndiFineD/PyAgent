...
@Data
public class Idea61774Config {
    private String name = "idea_061774";
 ...
 */
@Slf4j
public class Idea61774Service {
    private static final int IDEA_ID = 61774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61774Service() {
        this(new Idea61774Config());
    }

    public Idea61774Service(Idea61774Config config) {
        this.config = config != null ? config : new Idea61774Config();
