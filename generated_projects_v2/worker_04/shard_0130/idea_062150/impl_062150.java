...
@Data
public class Idea62150Config {
    private String name = "idea_062150";
 ...
 */
@Slf4j
public class Idea62150Service {
    private static final int IDEA_ID = 62150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62150Service() {
        this(new Idea62150Config());
    }

    public Idea62150Service(Idea62150Config config) {
        this.config = config != null ? config : new Idea62150Config();
