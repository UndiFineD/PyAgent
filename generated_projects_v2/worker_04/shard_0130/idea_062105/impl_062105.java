...
@Data
public class Idea62105Config {
    private String name = "idea_062105";
 ...
 */
@Slf4j
public class Idea62105Service {
    private static final int IDEA_ID = 62105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62105Service() {
        this(new Idea62105Config());
    }

    public Idea62105Service(Idea62105Config config) {
        this.config = config != null ? config : new Idea62105Config();
