...
@Data
public class Idea61932Config {
    private String name = "idea_061932";
 ...
 */
@Slf4j
public class Idea61932Service {
    private static final int IDEA_ID = 61932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61932Service() {
        this(new Idea61932Config());
    }

    public Idea61932Service(Idea61932Config config) {
        this.config = config != null ? config : new Idea61932Config();
