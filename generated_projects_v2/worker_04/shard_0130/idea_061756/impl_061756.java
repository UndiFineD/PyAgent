...
@Data
public class Idea61756Config {
    private String name = "idea_061756";
 ...
 */
@Slf4j
public class Idea61756Service {
    private static final int IDEA_ID = 61756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61756Service() {
        this(new Idea61756Config());
    }

    public Idea61756Service(Idea61756Config config) {
        this.config = config != null ? config : new Idea61756Config();
