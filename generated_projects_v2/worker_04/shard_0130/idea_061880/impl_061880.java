...
@Data
public class Idea61880Config {
    private String name = "idea_061880";
 ...
 */
@Slf4j
public class Idea61880Service {
    private static final int IDEA_ID = 61880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61880Service() {
        this(new Idea61880Config());
    }

    public Idea61880Service(Idea61880Config config) {
        this.config = config != null ? config : new Idea61880Config();
