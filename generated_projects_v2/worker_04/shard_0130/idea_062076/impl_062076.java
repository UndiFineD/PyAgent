...
@Data
public class Idea62076Config {
    private String name = "idea_062076";
 ...
 */
@Slf4j
public class Idea62076Service {
    private static final int IDEA_ID = 62076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62076Service() {
        this(new Idea62076Config());
    }

    public Idea62076Service(Idea62076Config config) {
        this.config = config != null ? config : new Idea62076Config();
