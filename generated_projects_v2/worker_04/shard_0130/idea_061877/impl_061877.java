...
@Data
public class Idea61877Config {
    private String name = "idea_061877";
 ...
 */
@Slf4j
public class Idea61877Service {
    private static final int IDEA_ID = 61877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61877Service() {
        this(new Idea61877Config());
    }

    public Idea61877Service(Idea61877Config config) {
        this.config = config != null ? config : new Idea61877Config();
