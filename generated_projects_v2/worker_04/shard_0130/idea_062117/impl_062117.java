...
@Data
public class Idea62117Config {
    private String name = "idea_062117";
 ...
 */
@Slf4j
public class Idea62117Service {
    private static final int IDEA_ID = 62117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62117Service() {
        this(new Idea62117Config());
    }

    public Idea62117Service(Idea62117Config config) {
        this.config = config != null ? config : new Idea62117Config();
