...
@Data
public class Idea61821Config {
    private String name = "idea_061821";
 ...
 */
@Slf4j
public class Idea61821Service {
    private static final int IDEA_ID = 61821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61821Service() {
        this(new Idea61821Config());
    }

    public Idea61821Service(Idea61821Config config) {
        this.config = config != null ? config : new Idea61821Config();
