...
@Data
public class Idea62194Config {
    private String name = "idea_062194";
 ...
 */
@Slf4j
public class Idea62194Service {
    private static final int IDEA_ID = 62194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62194Service() {
        this(new Idea62194Config());
    }

    public Idea62194Service(Idea62194Config config) {
        this.config = config != null ? config : new Idea62194Config();
