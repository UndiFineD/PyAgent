...
@Data
public class Idea62201Config {
    private String name = "idea_062201";
 ...
 */
@Slf4j
public class Idea62201Service {
    private static final int IDEA_ID = 62201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62201Service() {
        this(new Idea62201Config());
    }

    public Idea62201Service(Idea62201Config config) {
        this.config = config != null ? config : new Idea62201Config();
