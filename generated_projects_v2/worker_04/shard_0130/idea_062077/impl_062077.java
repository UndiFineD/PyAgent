...
@Data
public class Idea62077Config {
    private String name = "idea_062077";
 ...
 */
@Slf4j
public class Idea62077Service {
    private static final int IDEA_ID = 62077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62077Service() {
        this(new Idea62077Config());
    }

    public Idea62077Service(Idea62077Config config) {
        this.config = config != null ? config : new Idea62077Config();
