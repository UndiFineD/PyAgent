...
@Data
public class Idea62218Config {
    private String name = "idea_062218";
 ...
 */
@Slf4j
public class Idea62218Service {
    private static final int IDEA_ID = 62218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62218Service() {
        this(new Idea62218Config());
    }

    public Idea62218Service(Idea62218Config config) {
        this.config = config != null ? config : new Idea62218Config();
