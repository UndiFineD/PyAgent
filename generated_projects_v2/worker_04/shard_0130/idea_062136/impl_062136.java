...
@Data
public class Idea62136Config {
    private String name = "idea_062136";
 ...
 */
@Slf4j
public class Idea62136Service {
    private static final int IDEA_ID = 62136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62136Service() {
        this(new Idea62136Config());
    }

    public Idea62136Service(Idea62136Config config) {
        this.config = config != null ? config : new Idea62136Config();
