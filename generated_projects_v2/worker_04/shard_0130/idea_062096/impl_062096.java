...
@Data
public class Idea62096Config {
    private String name = "idea_062096";
 ...
 */
@Slf4j
public class Idea62096Service {
    private static final int IDEA_ID = 62096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62096Service() {
        this(new Idea62096Config());
    }

    public Idea62096Service(Idea62096Config config) {
        this.config = config != null ? config : new Idea62096Config();
