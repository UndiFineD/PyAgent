...
@Data
public class Idea62080Config {
    private String name = "idea_062080";
 ...
 */
@Slf4j
public class Idea62080Service {
    private static final int IDEA_ID = 62080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62080Service() {
        this(new Idea62080Config());
    }

    public Idea62080Service(Idea62080Config config) {
        this.config = config != null ? config : new Idea62080Config();
