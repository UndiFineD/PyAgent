...
@Data
public class Idea61977Config {
    private String name = "idea_061977";
 ...
 */
@Slf4j
public class Idea61977Service {
    private static final int IDEA_ID = 61977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61977Service() {
        this(new Idea61977Config());
    }

    public Idea61977Service(Idea61977Config config) {
        this.config = config != null ? config : new Idea61977Config();
