...
@Data
public class Idea62193Config {
    private String name = "idea_062193";
 ...
 */
@Slf4j
public class Idea62193Service {
    private static final int IDEA_ID = 62193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62193Service() {
        this(new Idea62193Config());
    }

    public Idea62193Service(Idea62193Config config) {
        this.config = config != null ? config : new Idea62193Config();
