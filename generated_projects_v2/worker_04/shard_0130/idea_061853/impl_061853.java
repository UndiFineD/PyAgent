...
@Data
public class Idea61853Config {
    private String name = "idea_061853";
 ...
 */
@Slf4j
public class Idea61853Service {
    private static final int IDEA_ID = 61853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61853Service() {
        this(new Idea61853Config());
    }

    public Idea61853Service(Idea61853Config config) {
        this.config = config != null ? config : new Idea61853Config();
