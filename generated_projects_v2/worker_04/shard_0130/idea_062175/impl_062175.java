...
@Data
public class Idea62175Config {
    private String name = "idea_062175";
 ...
 */
@Slf4j
public class Idea62175Service {
    private static final int IDEA_ID = 62175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62175Service() {
        this(new Idea62175Config());
    }

    public Idea62175Service(Idea62175Config config) {
        this.config = config != null ? config : new Idea62175Config();
