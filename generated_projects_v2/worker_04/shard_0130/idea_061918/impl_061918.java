...
@Data
public class Idea61918Config {
    private String name = "idea_061918";
 ...
 */
@Slf4j
public class Idea61918Service {
    private static final int IDEA_ID = 61918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61918Service() {
        this(new Idea61918Config());
    }

    public Idea61918Service(Idea61918Config config) {
        this.config = config != null ? config : new Idea61918Config();
