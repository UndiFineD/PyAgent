...
@Data
public class Idea62161Config {
    private String name = "idea_062161";
 ...
 */
@Slf4j
public class Idea62161Service {
    private static final int IDEA_ID = 62161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62161Service() {
        this(new Idea62161Config());
    }

    public Idea62161Service(Idea62161Config config) {
        this.config = config != null ? config : new Idea62161Config();
