...
@Data
public class Idea61928Config {
    private String name = "idea_061928";
 ...
 */
@Slf4j
public class Idea61928Service {
    private static final int IDEA_ID = 61928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61928Service() {
        this(new Idea61928Config());
    }

    public Idea61928Service(Idea61928Config config) {
        this.config = config != null ? config : new Idea61928Config();
