...
@Data
public class Idea61973Config {
    private String name = "idea_061973";
 ...
 */
@Slf4j
public class Idea61973Service {
    private static final int IDEA_ID = 61973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61973Service() {
        this(new Idea61973Config());
    }

    public Idea61973Service(Idea61973Config config) {
        this.config = config != null ? config : new Idea61973Config();
