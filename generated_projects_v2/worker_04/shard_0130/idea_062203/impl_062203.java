...
@Data
public class Idea62203Config {
    private String name = "idea_062203";
 ...
 */
@Slf4j
public class Idea62203Service {
    private static final int IDEA_ID = 62203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62203Service() {
        this(new Idea62203Config());
    }

    public Idea62203Service(Idea62203Config config) {
        this.config = config != null ? config : new Idea62203Config();
