...
@Data
public class Idea61924Config {
    private String name = "idea_061924";
 ...
 */
@Slf4j
public class Idea61924Service {
    private static final int IDEA_ID = 61924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61924Service() {
        this(new Idea61924Config());
    }

    public Idea61924Service(Idea61924Config config) {
        this.config = config != null ? config : new Idea61924Config();
