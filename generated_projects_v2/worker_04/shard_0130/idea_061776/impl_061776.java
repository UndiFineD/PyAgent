...
@Data
public class Idea61776Config {
    private String name = "idea_061776";
 ...
 */
@Slf4j
public class Idea61776Service {
    private static final int IDEA_ID = 61776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61776Service() {
        this(new Idea61776Config());
    }

    public Idea61776Service(Idea61776Config config) {
        this.config = config != null ? config : new Idea61776Config();
