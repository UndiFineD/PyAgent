...
@Data
public class Idea62154Config {
    private String name = "idea_062154";
 ...
 */
@Slf4j
public class Idea62154Service {
    private static final int IDEA_ID = 62154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62154Service() {
        this(new Idea62154Config());
    }

    public Idea62154Service(Idea62154Config config) {
        this.config = config != null ? config : new Idea62154Config();
