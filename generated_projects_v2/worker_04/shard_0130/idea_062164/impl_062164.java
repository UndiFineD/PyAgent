...
@Data
public class Idea62164Config {
    private String name = "idea_062164";
 ...
 */
@Slf4j
public class Idea62164Service {
    private static final int IDEA_ID = 62164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62164Service() {
        this(new Idea62164Config());
    }

    public Idea62164Service(Idea62164Config config) {
        this.config = config != null ? config : new Idea62164Config();
