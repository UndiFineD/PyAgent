...
@Data
public class Idea61898Config {
    private String name = "idea_061898";
 ...
 */
@Slf4j
public class Idea61898Service {
    private static final int IDEA_ID = 61898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61898Service() {
        this(new Idea61898Config());
    }

    public Idea61898Service(Idea61898Config config) {
        this.config = config != null ? config : new Idea61898Config();
