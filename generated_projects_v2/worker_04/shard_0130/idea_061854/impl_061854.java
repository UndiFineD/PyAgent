...
@Data
public class Idea61854Config {
    private String name = "idea_061854";
 ...
 */
@Slf4j
public class Idea61854Service {
    private static final int IDEA_ID = 61854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61854Service() {
        this(new Idea61854Config());
    }

    public Idea61854Service(Idea61854Config config) {
        this.config = config != null ? config : new Idea61854Config();
