...
@Data
public class Idea62097Config {
    private String name = "idea_062097";
 ...
 */
@Slf4j
public class Idea62097Service {
    private static final int IDEA_ID = 62097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62097Service() {
        this(new Idea62097Config());
    }

    public Idea62097Service(Idea62097Config config) {
        this.config = config != null ? config : new Idea62097Config();
