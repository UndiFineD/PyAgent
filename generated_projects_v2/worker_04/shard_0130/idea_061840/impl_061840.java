...
@Data
public class Idea61840Config {
    private String name = "idea_061840";
 ...
 */
@Slf4j
public class Idea61840Service {
    private static final int IDEA_ID = 61840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61840Service() {
        this(new Idea61840Config());
    }

    public Idea61840Service(Idea61840Config config) {
        this.config = config != null ? config : new Idea61840Config();
