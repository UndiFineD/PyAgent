...
@Data
public class Idea62189Config {
    private String name = "idea_062189";
 ...
 */
@Slf4j
public class Idea62189Service {
    private static final int IDEA_ID = 62189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62189Service() {
        this(new Idea62189Config());
    }

    public Idea62189Service(Idea62189Config config) {
        this.config = config != null ? config : new Idea62189Config();
