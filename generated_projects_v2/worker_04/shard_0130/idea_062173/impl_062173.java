...
@Data
public class Idea62173Config {
    private String name = "idea_062173";
 ...
 */
@Slf4j
public class Idea62173Service {
    private static final int IDEA_ID = 62173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62173Service() {
        this(new Idea62173Config());
    }

    public Idea62173Service(Idea62173Config config) {
        this.config = config != null ? config : new Idea62173Config();
