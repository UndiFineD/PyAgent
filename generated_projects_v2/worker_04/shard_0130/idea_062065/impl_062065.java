...
@Data
public class Idea62065Config {
    private String name = "idea_062065";
 ...
 */
@Slf4j
public class Idea62065Service {
    private static final int IDEA_ID = 62065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62065Service() {
        this(new Idea62065Config());
    }

    public Idea62065Service(Idea62065Config config) {
        this.config = config != null ? config : new Idea62065Config();
