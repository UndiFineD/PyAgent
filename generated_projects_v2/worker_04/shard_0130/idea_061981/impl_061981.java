...
@Data
public class Idea61981Config {
    private String name = "idea_061981";
 ...
 */
@Slf4j
public class Idea61981Service {
    private static final int IDEA_ID = 61981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61981Service() {
        this(new Idea61981Config());
    }

    public Idea61981Service(Idea61981Config config) {
        this.config = config != null ? config : new Idea61981Config();
