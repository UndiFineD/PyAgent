...
@Data
public class Idea62224Config {
    private String name = "idea_062224";
 ...
 */
@Slf4j
public class Idea62224Service {
    private static final int IDEA_ID = 62224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62224Service() {
        this(new Idea62224Config());
    }

    public Idea62224Service(Idea62224Config config) {
        this.config = config != null ? config : new Idea62224Config();
