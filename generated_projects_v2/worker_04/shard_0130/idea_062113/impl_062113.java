...
@Data
public class Idea62113Config {
    private String name = "idea_062113";
 ...
 */
@Slf4j
public class Idea62113Service {
    private static final int IDEA_ID = 62113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62113Service() {
        this(new Idea62113Config());
    }

    public Idea62113Service(Idea62113Config config) {
        this.config = config != null ? config : new Idea62113Config();
