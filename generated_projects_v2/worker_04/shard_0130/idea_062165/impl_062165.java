...
@Data
public class Idea62165Config {
    private String name = "idea_062165";
 ...
 */
@Slf4j
public class Idea62165Service {
    private static final int IDEA_ID = 62165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62165Service() {
        this(new Idea62165Config());
    }

    public Idea62165Service(Idea62165Config config) {
        this.config = config != null ? config : new Idea62165Config();
