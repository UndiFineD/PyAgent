...
@Data
public class Idea61762Config {
    private String name = "idea_061762";
 ...
 */
@Slf4j
public class Idea61762Service {
    private static final int IDEA_ID = 61762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61762Service() {
        this(new Idea61762Config());
    }

    public Idea61762Service(Idea61762Config config) {
        this.config = config != null ? config : new Idea61762Config();
