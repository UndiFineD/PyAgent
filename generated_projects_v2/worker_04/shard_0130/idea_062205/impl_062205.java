...
@Data
public class Idea62205Config {
    private String name = "idea_062205";
 ...
 */
@Slf4j
public class Idea62205Service {
    private static final int IDEA_ID = 62205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62205Service() {
        this(new Idea62205Config());
    }

    public Idea62205Service(Idea62205Config config) {
        this.config = config != null ? config : new Idea62205Config();
