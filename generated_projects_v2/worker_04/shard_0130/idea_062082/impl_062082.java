...
@Data
public class Idea62082Config {
    private String name = "idea_062082";
 ...
 */
@Slf4j
public class Idea62082Service {
    private static final int IDEA_ID = 62082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62082Service() {
        this(new Idea62082Config());
    }

    public Idea62082Service(Idea62082Config config) {
        this.config = config != null ? config : new Idea62082Config();
