...
@Data
public class Idea62119Config {
    private String name = "idea_062119";
 ...
 */
@Slf4j
public class Idea62119Service {
    private static final int IDEA_ID = 62119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62119Service() {
        this(new Idea62119Config());
    }

    public Idea62119Service(Idea62119Config config) {
        this.config = config != null ? config : new Idea62119Config();
