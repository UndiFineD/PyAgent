...
@Data
public class Idea62036Config {
    private String name = "idea_062036";
 ...
 */
@Slf4j
public class Idea62036Service {
    private static final int IDEA_ID = 62036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62036Service() {
        this(new Idea62036Config());
    }

    public Idea62036Service(Idea62036Config config) {
        this.config = config != null ? config : new Idea62036Config();
