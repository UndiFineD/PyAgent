...
@Data
public class Idea61780Config {
    private String name = "idea_061780";
 ...
 */
@Slf4j
public class Idea61780Service {
    private static final int IDEA_ID = 61780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61780Service() {
        this(new Idea61780Config());
    }

    public Idea61780Service(Idea61780Config config) {
        this.config = config != null ? config : new Idea61780Config();
