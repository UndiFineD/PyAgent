...
@Data
public class Idea61908Config {
    private String name = "idea_061908";
 ...
 */
@Slf4j
public class Idea61908Service {
    private static final int IDEA_ID = 61908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61908Service() {
        this(new Idea61908Config());
    }

    public Idea61908Service(Idea61908Config config) {
        this.config = config != null ? config : new Idea61908Config();
