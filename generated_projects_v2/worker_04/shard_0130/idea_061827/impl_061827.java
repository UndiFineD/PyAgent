...
@Data
public class Idea61827Config {
    private String name = "idea_061827";
 ...
 */
@Slf4j
public class Idea61827Service {
    private static final int IDEA_ID = 61827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61827Service() {
        this(new Idea61827Config());
    }

    public Idea61827Service(Idea61827Config config) {
        this.config = config != null ? config : new Idea61827Config();
