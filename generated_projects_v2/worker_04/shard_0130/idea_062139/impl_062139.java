...
@Data
public class Idea62139Config {
    private String name = "idea_062139";
 ...
 */
@Slf4j
public class Idea62139Service {
    private static final int IDEA_ID = 62139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62139Service() {
        this(new Idea62139Config());
    }

    public Idea62139Service(Idea62139Config config) {
        this.config = config != null ? config : new Idea62139Config();
