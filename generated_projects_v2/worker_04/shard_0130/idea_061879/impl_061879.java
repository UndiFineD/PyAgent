...
@Data
public class Idea61879Config {
    private String name = "idea_061879";
 ...
 */
@Slf4j
public class Idea61879Service {
    private static final int IDEA_ID = 61879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61879Service() {
        this(new Idea61879Config());
    }

    public Idea61879Service(Idea61879Config config) {
        this.config = config != null ? config : new Idea61879Config();
