...
@Data
public class Idea61818Config {
    private String name = "idea_061818";
 ...
 */
@Slf4j
public class Idea61818Service {
    private static final int IDEA_ID = 61818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61818Service() {
        this(new Idea61818Config());
    }

    public Idea61818Service(Idea61818Config config) {
        this.config = config != null ? config : new Idea61818Config();
