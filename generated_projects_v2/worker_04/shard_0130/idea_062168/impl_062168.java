...
@Data
public class Idea62168Config {
    private String name = "idea_062168";
 ...
 */
@Slf4j
public class Idea62168Service {
    private static final int IDEA_ID = 62168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62168Service() {
        this(new Idea62168Config());
    }

    public Idea62168Service(Idea62168Config config) {
        this.config = config != null ? config : new Idea62168Config();
