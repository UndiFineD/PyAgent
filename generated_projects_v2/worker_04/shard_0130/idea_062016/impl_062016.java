...
@Data
public class Idea62016Config {
    private String name = "idea_062016";
 ...
 */
@Slf4j
public class Idea62016Service {
    private static final int IDEA_ID = 62016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62016Service() {
        this(new Idea62016Config());
    }

    public Idea62016Service(Idea62016Config config) {
        this.config = config != null ? config : new Idea62016Config();
