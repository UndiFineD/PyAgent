...
@Data
public class Idea62195Config {
    private String name = "idea_062195";
 ...
 */
@Slf4j
public class Idea62195Service {
    private static final int IDEA_ID = 62195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62195Service() {
        this(new Idea62195Config());
    }

    public Idea62195Service(Idea62195Config config) {
        this.config = config != null ? config : new Idea62195Config();
