...
@Data
public class Idea61783Config {
    private String name = "idea_061783";
 ...
 */
@Slf4j
public class Idea61783Service {
    private static final int IDEA_ID = 61783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61783Service() {
        this(new Idea61783Config());
    }

    public Idea61783Service(Idea61783Config config) {
        this.config = config != null ? config : new Idea61783Config();
