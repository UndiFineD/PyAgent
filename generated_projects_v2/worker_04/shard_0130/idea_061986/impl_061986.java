...
@Data
public class Idea61986Config {
    private String name = "idea_061986";
 ...
 */
@Slf4j
public class Idea61986Service {
    private static final int IDEA_ID = 61986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61986Service() {
        this(new Idea61986Config());
    }

    public Idea61986Service(Idea61986Config config) {
        this.config = config != null ? config : new Idea61986Config();
