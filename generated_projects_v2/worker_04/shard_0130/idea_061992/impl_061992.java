...
@Data
public class Idea61992Config {
    private String name = "idea_061992";
 ...
 */
@Slf4j
public class Idea61992Service {
    private static final int IDEA_ID = 61992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61992Service() {
        this(new Idea61992Config());
    }

    public Idea61992Service(Idea61992Config config) {
        this.config = config != null ? config : new Idea61992Config();
