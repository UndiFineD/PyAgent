...
@Data
public class Idea61987Config {
    private String name = "idea_061987";
 ...
 */
@Slf4j
public class Idea61987Service {
    private static final int IDEA_ID = 61987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61987Service() {
        this(new Idea61987Config());
    }

    public Idea61987Service(Idea61987Config config) {
        this.config = config != null ? config : new Idea61987Config();
