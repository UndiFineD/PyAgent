...
@Data
public class Idea61906Config {
    private String name = "idea_061906";
 ...
 */
@Slf4j
public class Idea61906Service {
    private static final int IDEA_ID = 61906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61906Service() {
        this(new Idea61906Config());
    }

    public Idea61906Service(Idea61906Config config) {
        this.config = config != null ? config : new Idea61906Config();
