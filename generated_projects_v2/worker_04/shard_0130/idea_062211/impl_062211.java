...
@Data
public class Idea62211Config {
    private String name = "idea_062211";
 ...
 */
@Slf4j
public class Idea62211Service {
    private static final int IDEA_ID = 62211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62211Service() {
        this(new Idea62211Config());
    }

    public Idea62211Service(Idea62211Config config) {
        this.config = config != null ? config : new Idea62211Config();
