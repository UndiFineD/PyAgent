...
@Data
public class Idea61867Config {
    private String name = "idea_061867";
 ...
 */
@Slf4j
public class Idea61867Service {
    private static final int IDEA_ID = 61867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61867Service() {
        this(new Idea61867Config());
    }

    public Idea61867Service(Idea61867Config config) {
        this.config = config != null ? config : new Idea61867Config();
