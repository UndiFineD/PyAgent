...
@Data
public class Idea61751Config {
    private String name = "idea_061751";
 ...
 */
@Slf4j
public class Idea61751Service {
    private static final int IDEA_ID = 61751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61751Service() {
        this(new Idea61751Config());
    }

    public Idea61751Service(Idea61751Config config) {
        this.config = config != null ? config : new Idea61751Config();
