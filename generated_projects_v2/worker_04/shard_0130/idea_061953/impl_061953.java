...
@Data
public class Idea61953Config {
    private String name = "idea_061953";
 ...
 */
@Slf4j
public class Idea61953Service {
    private static final int IDEA_ID = 61953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61953Service() {
        this(new Idea61953Config());
    }

    public Idea61953Service(Idea61953Config config) {
        this.config = config != null ? config : new Idea61953Config();
