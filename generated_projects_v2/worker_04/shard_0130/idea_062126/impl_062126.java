...
@Data
public class Idea62126Config {
    private String name = "idea_062126";
 ...
 */
@Slf4j
public class Idea62126Service {
    private static final int IDEA_ID = 62126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62126Service() {
        this(new Idea62126Config());
    }

    public Idea62126Service(Idea62126Config config) {
        this.config = config != null ? config : new Idea62126Config();
