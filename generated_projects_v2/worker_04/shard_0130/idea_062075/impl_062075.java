...
@Data
public class Idea62075Config {
    private String name = "idea_062075";
 ...
 */
@Slf4j
public class Idea62075Service {
    private static final int IDEA_ID = 62075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62075Service() {
        this(new Idea62075Config());
    }

    public Idea62075Service(Idea62075Config config) {
        this.config = config != null ? config : new Idea62075Config();
