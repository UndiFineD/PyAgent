...
@Data
public class Idea61894Config {
    private String name = "idea_061894";
 ...
 */
@Slf4j
public class Idea61894Service {
    private static final int IDEA_ID = 61894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61894Service() {
        this(new Idea61894Config());
    }

    public Idea61894Service(Idea61894Config config) {
        this.config = config != null ? config : new Idea61894Config();
