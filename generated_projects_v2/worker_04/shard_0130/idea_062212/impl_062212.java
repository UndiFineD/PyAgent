...
@Data
public class Idea62212Config {
    private String name = "idea_062212";
 ...
 */
@Slf4j
public class Idea62212Service {
    private static final int IDEA_ID = 62212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62212Service() {
        this(new Idea62212Config());
    }

    public Idea62212Service(Idea62212Config config) {
        this.config = config != null ? config : new Idea62212Config();
