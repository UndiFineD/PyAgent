...
@Data
public class Idea62208Config {
    private String name = "idea_062208";
 ...
 */
@Slf4j
public class Idea62208Service {
    private static final int IDEA_ID = 62208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62208Service() {
        this(new Idea62208Config());
    }

    public Idea62208Service(Idea62208Config config) {
        this.config = config != null ? config : new Idea62208Config();
