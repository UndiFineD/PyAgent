...
@Data
public class Idea62060Config {
    private String name = "idea_062060";
 ...
 */
@Slf4j
public class Idea62060Service {
    private static final int IDEA_ID = 62060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62060Service() {
        this(new Idea62060Config());
    }

    public Idea62060Service(Idea62060Config config) {
        this.config = config != null ? config : new Idea62060Config();
