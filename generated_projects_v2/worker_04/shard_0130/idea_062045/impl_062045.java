...
@Data
public class Idea62045Config {
    private String name = "idea_062045";
 ...
 */
@Slf4j
public class Idea62045Service {
    private static final int IDEA_ID = 62045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62045Service() {
        this(new Idea62045Config());
    }

    public Idea62045Service(Idea62045Config config) {
        this.config = config != null ? config : new Idea62045Config();
