...
@Data
public class Idea61775Config {
    private String name = "idea_061775";
 ...
 */
@Slf4j
public class Idea61775Service {
    private static final int IDEA_ID = 61775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61775Service() {
        this(new Idea61775Config());
    }

    public Idea61775Service(Idea61775Config config) {
        this.config = config != null ? config : new Idea61775Config();
