...
@Data
public class Idea62207Config {
    private String name = "idea_062207";
 ...
 */
@Slf4j
public class Idea62207Service {
    private static final int IDEA_ID = 62207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62207Service() {
        this(new Idea62207Config());
    }

    public Idea62207Service(Idea62207Config config) {
        this.config = config != null ? config : new Idea62207Config();
