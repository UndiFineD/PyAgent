...
@Data
public class Idea61765Config {
    private String name = "idea_061765";
 ...
 */
@Slf4j
public class Idea61765Service {
    private static final int IDEA_ID = 61765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61765Service() {
        this(new Idea61765Config());
    }

    public Idea61765Service(Idea61765Config config) {
        this.config = config != null ? config : new Idea61765Config();
