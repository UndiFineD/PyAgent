...
@Data
public class Idea61968Config {
    private String name = "idea_061968";
 ...
 */
@Slf4j
public class Idea61968Service {
    private static final int IDEA_ID = 61968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61968Service() {
        this(new Idea61968Config());
    }

    public Idea61968Service(Idea61968Config config) {
        this.config = config != null ? config : new Idea61968Config();
