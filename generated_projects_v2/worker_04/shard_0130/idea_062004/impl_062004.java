...
@Data
public class Idea62004Config {
    private String name = "idea_062004";
 ...
 */
@Slf4j
public class Idea62004Service {
    private static final int IDEA_ID = 62004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62004Service() {
        this(new Idea62004Config());
    }

    public Idea62004Service(Idea62004Config config) {
        this.config = config != null ? config : new Idea62004Config();
