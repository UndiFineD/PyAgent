...
@Data
public class Idea61914Config {
    private String name = "idea_061914";
 ...
 */
@Slf4j
public class Idea61914Service {
    private static final int IDEA_ID = 61914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61914Service() {
        this(new Idea61914Config());
    }

    public Idea61914Service(Idea61914Config config) {
        this.config = config != null ? config : new Idea61914Config();
