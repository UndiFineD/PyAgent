...
@Data
public class Idea61990Config {
    private String name = "idea_061990";
 ...
 */
@Slf4j
public class Idea61990Service {
    private static final int IDEA_ID = 61990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61990Service() {
        this(new Idea61990Config());
    }

    public Idea61990Service(Idea61990Config config) {
        this.config = config != null ? config : new Idea61990Config();
