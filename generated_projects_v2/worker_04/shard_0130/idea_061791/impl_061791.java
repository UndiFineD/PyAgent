...
@Data
public class Idea61791Config {
    private String name = "idea_061791";
 ...
 */
@Slf4j
public class Idea61791Service {
    private static final int IDEA_ID = 61791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61791Service() {
        this(new Idea61791Config());
    }

    public Idea61791Service(Idea61791Config config) {
        this.config = config != null ? config : new Idea61791Config();
