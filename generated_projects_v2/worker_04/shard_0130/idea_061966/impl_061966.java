...
@Data
public class Idea61966Config {
    private String name = "idea_061966";
 ...
 */
@Slf4j
public class Idea61966Service {
    private static final int IDEA_ID = 61966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61966Service() {
        this(new Idea61966Config());
    }

    public Idea61966Service(Idea61966Config config) {
        this.config = config != null ? config : new Idea61966Config();
