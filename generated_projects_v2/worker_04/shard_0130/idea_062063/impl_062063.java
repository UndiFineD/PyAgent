...
@Data
public class Idea62063Config {
    private String name = "idea_062063";
 ...
 */
@Slf4j
public class Idea62063Service {
    private static final int IDEA_ID = 62063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62063Service() {
        this(new Idea62063Config());
    }

    public Idea62063Service(Idea62063Config config) {
        this.config = config != null ? config : new Idea62063Config();
