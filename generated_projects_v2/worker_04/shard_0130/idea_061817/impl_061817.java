...
@Data
public class Idea61817Config {
    private String name = "idea_061817";
 ...
 */
@Slf4j
public class Idea61817Service {
    private static final int IDEA_ID = 61817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61817Service() {
        this(new Idea61817Config());
    }

    public Idea61817Service(Idea61817Config config) {
        this.config = config != null ? config : new Idea61817Config();
