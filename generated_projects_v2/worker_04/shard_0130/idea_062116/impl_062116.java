...
@Data
public class Idea62116Config {
    private String name = "idea_062116";
 ...
 */
@Slf4j
public class Idea62116Service {
    private static final int IDEA_ID = 62116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62116Service() {
        this(new Idea62116Config());
    }

    public Idea62116Service(Idea62116Config config) {
        this.config = config != null ? config : new Idea62116Config();
