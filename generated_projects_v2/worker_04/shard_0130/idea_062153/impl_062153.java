...
@Data
public class Idea62153Config {
    private String name = "idea_062153";
 ...
 */
@Slf4j
public class Idea62153Service {
    private static final int IDEA_ID = 62153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62153Service() {
        this(new Idea62153Config());
    }

    public Idea62153Service(Idea62153Config config) {
        this.config = config != null ? config : new Idea62153Config();
