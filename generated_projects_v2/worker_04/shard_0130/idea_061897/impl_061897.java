...
@Data
public class Idea61897Config {
    private String name = "idea_061897";
 ...
 */
@Slf4j
public class Idea61897Service {
    private static final int IDEA_ID = 61897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61897Service() {
        this(new Idea61897Config());
    }

    public Idea61897Service(Idea61897Config config) {
        this.config = config != null ? config : new Idea61897Config();
