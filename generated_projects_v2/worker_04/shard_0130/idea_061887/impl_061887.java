...
@Data
public class Idea61887Config {
    private String name = "idea_061887";
 ...
 */
@Slf4j
public class Idea61887Service {
    private static final int IDEA_ID = 61887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61887Service() {
        this(new Idea61887Config());
    }

    public Idea61887Service(Idea61887Config config) {
        this.config = config != null ? config : new Idea61887Config();
