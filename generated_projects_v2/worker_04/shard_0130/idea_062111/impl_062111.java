...
@Data
public class Idea62111Config {
    private String name = "idea_062111";
 ...
 */
@Slf4j
public class Idea62111Service {
    private static final int IDEA_ID = 62111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62111Service() {
        this(new Idea62111Config());
    }

    public Idea62111Service(Idea62111Config config) {
        this.config = config != null ? config : new Idea62111Config();
