...
@Data
public class Idea61997Config {
    private String name = "idea_061997";
 ...
 */
@Slf4j
public class Idea61997Service {
    private static final int IDEA_ID = 61997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61997Service() {
        this(new Idea61997Config());
    }

    public Idea61997Service(Idea61997Config config) {
        this.config = config != null ? config : new Idea61997Config();
