...
@Data
public class Idea61788Config {
    private String name = "idea_061788";
 ...
 */
@Slf4j
public class Idea61788Service {
    private static final int IDEA_ID = 61788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61788Service() {
        this(new Idea61788Config());
    }

    public Idea61788Service(Idea61788Config config) {
        this.config = config != null ? config : new Idea61788Config();
