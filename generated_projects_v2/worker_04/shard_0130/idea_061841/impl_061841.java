...
@Data
public class Idea61841Config {
    private String name = "idea_061841";
 ...
 */
@Slf4j
public class Idea61841Service {
    private static final int IDEA_ID = 61841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61841Service() {
        this(new Idea61841Config());
    }

    public Idea61841Service(Idea61841Config config) {
        this.config = config != null ? config : new Idea61841Config();
