...
@Data
public class Idea61875Config {
    private String name = "idea_061875";
 ...
 */
@Slf4j
public class Idea61875Service {
    private static final int IDEA_ID = 61875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61875Service() {
        this(new Idea61875Config());
    }

    public Idea61875Service(Idea61875Config config) {
        this.config = config != null ? config : new Idea61875Config();
