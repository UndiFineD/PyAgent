...
@Data
public class Idea61983Config {
    private String name = "idea_061983";
 ...
 */
@Slf4j
public class Idea61983Service {
    private static final int IDEA_ID = 61983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61983Service() {
        this(new Idea61983Config());
    }

    public Idea61983Service(Idea61983Config config) {
        this.config = config != null ? config : new Idea61983Config();
