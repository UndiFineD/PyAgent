...
@Data
public class Idea61931Config {
    private String name = "idea_061931";
 ...
 */
@Slf4j
public class Idea61931Service {
    private static final int IDEA_ID = 61931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61931Service() {
        this(new Idea61931Config());
    }

    public Idea61931Service(Idea61931Config config) {
        this.config = config != null ? config : new Idea61931Config();
