...
@Data
public class Idea62093Config {
    private String name = "idea_062093";
 ...
 */
@Slf4j
public class Idea62093Service {
    private static final int IDEA_ID = 62093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62093Service() {
        this(new Idea62093Config());
    }

    public Idea62093Service(Idea62093Config config) {
        this.config = config != null ? config : new Idea62093Config();
