...
@Data
public class Idea62170Config {
    private String name = "idea_062170";
 ...
 */
@Slf4j
public class Idea62170Service {
    private static final int IDEA_ID = 62170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62170Service() {
        this(new Idea62170Config());
    }

    public Idea62170Service(Idea62170Config config) {
        this.config = config != null ? config : new Idea62170Config();
