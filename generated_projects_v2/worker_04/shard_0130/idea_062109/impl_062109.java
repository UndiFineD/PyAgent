...
@Data
public class Idea62109Config {
    private String name = "idea_062109";
 ...
 */
@Slf4j
public class Idea62109Service {
    private static final int IDEA_ID = 62109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62109Service() {
        this(new Idea62109Config());
    }

    public Idea62109Service(Idea62109Config config) {
        this.config = config != null ? config : new Idea62109Config();
