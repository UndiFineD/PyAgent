...
@Data
public class Idea61863Config {
    private String name = "idea_061863";
 ...
 */
@Slf4j
public class Idea61863Service {
    private static final int IDEA_ID = 61863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61863Service() {
        this(new Idea61863Config());
    }

    public Idea61863Service(Idea61863Config config) {
        this.config = config != null ? config : new Idea61863Config();
