...
@Data
public class Idea61947Config {
    private String name = "idea_061947";
 ...
 */
@Slf4j
public class Idea61947Service {
    private static final int IDEA_ID = 61947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61947Service() {
        this(new Idea61947Config());
    }

    public Idea61947Service(Idea61947Config config) {
        this.config = config != null ? config : new Idea61947Config();
