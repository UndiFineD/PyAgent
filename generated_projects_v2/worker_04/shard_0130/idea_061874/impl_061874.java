...
@Data
public class Idea61874Config {
    private String name = "idea_061874";
 ...
 */
@Slf4j
public class Idea61874Service {
    private static final int IDEA_ID = 61874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61874Service() {
        this(new Idea61874Config());
    }

    public Idea61874Service(Idea61874Config config) {
        this.config = config != null ? config : new Idea61874Config();
