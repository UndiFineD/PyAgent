...
@Data
public class Idea62024Config {
    private String name = "idea_062024";
 ...
 */
@Slf4j
public class Idea62024Service {
    private static final int IDEA_ID = 62024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62024Service() {
        this(new Idea62024Config());
    }

    public Idea62024Service(Idea62024Config config) {
        this.config = config != null ? config : new Idea62024Config();
