...
@Data
public class Idea61969Config {
    private String name = "idea_061969";
 ...
 */
@Slf4j
public class Idea61969Service {
    private static final int IDEA_ID = 61969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61969Service() {
        this(new Idea61969Config());
    }

    public Idea61969Service(Idea61969Config config) {
        this.config = config != null ? config : new Idea61969Config();
