...
@Data
public class Idea62087Config {
    private String name = "idea_062087";
 ...
 */
@Slf4j
public class Idea62087Service {
    private static final int IDEA_ID = 62087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62087Service() {
        this(new Idea62087Config());
    }

    public Idea62087Service(Idea62087Config config) {
        this.config = config != null ? config : new Idea62087Config();
