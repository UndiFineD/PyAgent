...
@Data
public class Idea61984Config {
    private String name = "idea_061984";
 ...
 */
@Slf4j
public class Idea61984Service {
    private static final int IDEA_ID = 61984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61984Service() {
        this(new Idea61984Config());
    }

    public Idea61984Service(Idea61984Config config) {
        this.config = config != null ? config : new Idea61984Config();
