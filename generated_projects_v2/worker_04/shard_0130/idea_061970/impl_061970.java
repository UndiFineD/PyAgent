...
@Data
public class Idea61970Config {
    private String name = "idea_061970";
 ...
 */
@Slf4j
public class Idea61970Service {
    private static final int IDEA_ID = 61970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61970Service() {
        this(new Idea61970Config());
    }

    public Idea61970Service(Idea61970Config config) {
        this.config = config != null ? config : new Idea61970Config();
