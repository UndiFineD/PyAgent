...
@Data
public class Idea62124Config {
    private String name = "idea_062124";
 ...
 */
@Slf4j
public class Idea62124Service {
    private static final int IDEA_ID = 62124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62124Service() {
        this(new Idea62124Config());
    }

    public Idea62124Service(Idea62124Config config) {
        this.config = config != null ? config : new Idea62124Config();
