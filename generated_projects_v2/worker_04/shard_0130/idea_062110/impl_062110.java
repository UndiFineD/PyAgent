...
@Data
public class Idea62110Config {
    private String name = "idea_062110";
 ...
 */
@Slf4j
public class Idea62110Service {
    private static final int IDEA_ID = 62110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62110Service() {
        this(new Idea62110Config());
    }

    public Idea62110Service(Idea62110Config config) {
        this.config = config != null ? config : new Idea62110Config();
