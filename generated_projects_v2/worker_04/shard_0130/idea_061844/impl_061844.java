...
@Data
public class Idea61844Config {
    private String name = "idea_061844";
 ...
 */
@Slf4j
public class Idea61844Service {
    private static final int IDEA_ID = 61844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61844Service() {
        this(new Idea61844Config());
    }

    public Idea61844Service(Idea61844Config config) {
        this.config = config != null ? config : new Idea61844Config();
