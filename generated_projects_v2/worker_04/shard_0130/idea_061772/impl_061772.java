...
@Data
public class Idea61772Config {
    private String name = "idea_061772";
 ...
 */
@Slf4j
public class Idea61772Service {
    private static final int IDEA_ID = 61772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61772Service() {
        this(new Idea61772Config());
    }

    public Idea61772Service(Idea61772Config config) {
        this.config = config != null ? config : new Idea61772Config();
