...
@Data
public class Idea61828Config {
    private String name = "idea_061828";
 ...
 */
@Slf4j
public class Idea61828Service {
    private static final int IDEA_ID = 61828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61828Service() {
        this(new Idea61828Config());
    }

    public Idea61828Service(Idea61828Config config) {
        this.config = config != null ? config : new Idea61828Config();
