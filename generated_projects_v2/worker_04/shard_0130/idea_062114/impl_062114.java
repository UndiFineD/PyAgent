...
@Data
public class Idea62114Config {
    private String name = "idea_062114";
 ...
 */
@Slf4j
public class Idea62114Service {
    private static final int IDEA_ID = 62114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62114Service() {
        this(new Idea62114Config());
    }

    public Idea62114Service(Idea62114Config config) {
        this.config = config != null ? config : new Idea62114Config();
