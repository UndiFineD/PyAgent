...
@Data
public class Idea61822Config {
    private String name = "idea_061822";
 ...
 */
@Slf4j
public class Idea61822Service {
    private static final int IDEA_ID = 61822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61822Service() {
        this(new Idea61822Config());
    }

    public Idea61822Service(Idea61822Config config) {
        this.config = config != null ? config : new Idea61822Config();
