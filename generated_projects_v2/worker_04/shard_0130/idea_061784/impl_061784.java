...
@Data
public class Idea61784Config {
    private String name = "idea_061784";
 ...
 */
@Slf4j
public class Idea61784Service {
    private static final int IDEA_ID = 61784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61784Service() {
        this(new Idea61784Config());
    }

    public Idea61784Service(Idea61784Config config) {
        this.config = config != null ? config : new Idea61784Config();
