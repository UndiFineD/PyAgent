...
@Data
public class Idea62041Config {
    private String name = "idea_062041";
 ...
 */
@Slf4j
public class Idea62041Service {
    private static final int IDEA_ID = 62041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62041Service() {
        this(new Idea62041Config());
    }

    public Idea62041Service(Idea62041Config config) {
        this.config = config != null ? config : new Idea62041Config();
