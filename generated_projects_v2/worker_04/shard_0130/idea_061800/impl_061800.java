...
@Data
public class Idea61800Config {
    private String name = "idea_061800";
 ...
 */
@Slf4j
public class Idea61800Service {
    private static final int IDEA_ID = 61800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61800Service() {
        this(new Idea61800Config());
    }

    public Idea61800Service(Idea61800Config config) {
        this.config = config != null ? config : new Idea61800Config();
