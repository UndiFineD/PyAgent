...
@Data
public class Idea61982Config {
    private String name = "idea_061982";
 ...
 */
@Slf4j
public class Idea61982Service {
    private static final int IDEA_ID = 61982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61982Service() {
        this(new Idea61982Config());
    }

    public Idea61982Service(Idea61982Config config) {
        this.config = config != null ? config : new Idea61982Config();
