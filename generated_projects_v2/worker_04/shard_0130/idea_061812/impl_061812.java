...
@Data
public class Idea61812Config {
    private String name = "idea_061812";
 ...
 */
@Slf4j
public class Idea61812Service {
    private static final int IDEA_ID = 61812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61812Service() {
        this(new Idea61812Config());
    }

    public Idea61812Service(Idea61812Config config) {
        this.config = config != null ? config : new Idea61812Config();
