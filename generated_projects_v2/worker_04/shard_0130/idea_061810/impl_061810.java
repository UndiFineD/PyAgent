...
@Data
public class Idea61810Config {
    private String name = "idea_061810";
 ...
 */
@Slf4j
public class Idea61810Service {
    private static final int IDEA_ID = 61810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61810Service() {
        this(new Idea61810Config());
    }

    public Idea61810Service(Idea61810Config config) {
        this.config = config != null ? config : new Idea61810Config();
