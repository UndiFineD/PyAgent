...
@Data
public class Idea62102Config {
    private String name = "idea_062102";
 ...
 */
@Slf4j
public class Idea62102Service {
    private static final int IDEA_ID = 62102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62102Service() {
        this(new Idea62102Config());
    }

    public Idea62102Service(Idea62102Config config) {
        this.config = config != null ? config : new Idea62102Config();
