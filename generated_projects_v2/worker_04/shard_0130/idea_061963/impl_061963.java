...
@Data
public class Idea61963Config {
    private String name = "idea_061963";
 ...
 */
@Slf4j
public class Idea61963Service {
    private static final int IDEA_ID = 61963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61963Service() {
        this(new Idea61963Config());
    }

    public Idea61963Service(Idea61963Config config) {
        this.config = config != null ? config : new Idea61963Config();
