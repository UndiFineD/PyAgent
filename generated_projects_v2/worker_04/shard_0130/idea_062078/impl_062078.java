...
@Data
public class Idea62078Config {
    private String name = "idea_062078";
 ...
 */
@Slf4j
public class Idea62078Service {
    private static final int IDEA_ID = 62078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62078Service() {
        this(new Idea62078Config());
    }

    public Idea62078Service(Idea62078Config config) {
        this.config = config != null ? config : new Idea62078Config();
