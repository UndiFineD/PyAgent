...
@Data
public class Idea61793Config {
    private String name = "idea_061793";
 ...
 */
@Slf4j
public class Idea61793Service {
    private static final int IDEA_ID = 61793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61793Service() {
        this(new Idea61793Config());
    }

    public Idea61793Service(Idea61793Config config) {
        this.config = config != null ? config : new Idea61793Config();
