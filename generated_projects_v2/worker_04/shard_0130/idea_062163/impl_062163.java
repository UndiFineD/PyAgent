...
@Data
public class Idea62163Config {
    private String name = "idea_062163";
 ...
 */
@Slf4j
public class Idea62163Service {
    private static final int IDEA_ID = 62163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62163Service() {
        this(new Idea62163Config());
    }

    public Idea62163Service(Idea62163Config config) {
        this.config = config != null ? config : new Idea62163Config();
