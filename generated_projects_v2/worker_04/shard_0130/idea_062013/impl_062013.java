...
@Data
public class Idea62013Config {
    private String name = "idea_062013";
 ...
 */
@Slf4j
public class Idea62013Service {
    private static final int IDEA_ID = 62013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62013Service() {
        this(new Idea62013Config());
    }

    public Idea62013Service(Idea62013Config config) {
        this.config = config != null ? config : new Idea62013Config();
