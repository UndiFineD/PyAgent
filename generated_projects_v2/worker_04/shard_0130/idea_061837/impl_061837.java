...
@Data
public class Idea61837Config {
    private String name = "idea_061837";
 ...
 */
@Slf4j
public class Idea61837Service {
    private static final int IDEA_ID = 61837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61837Service() {
        this(new Idea61837Config());
    }

    public Idea61837Service(Idea61837Config config) {
        this.config = config != null ? config : new Idea61837Config();
