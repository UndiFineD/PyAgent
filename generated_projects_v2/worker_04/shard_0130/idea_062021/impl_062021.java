...
@Data
public class Idea62021Config {
    private String name = "idea_062021";
 ...
 */
@Slf4j
public class Idea62021Service {
    private static final int IDEA_ID = 62021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62021Service() {
        this(new Idea62021Config());
    }

    public Idea62021Service(Idea62021Config config) {
        this.config = config != null ? config : new Idea62021Config();
