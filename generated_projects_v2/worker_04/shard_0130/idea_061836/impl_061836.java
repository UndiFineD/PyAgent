...
@Data
public class Idea61836Config {
    private String name = "idea_061836";
 ...
 */
@Slf4j
public class Idea61836Service {
    private static final int IDEA_ID = 61836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61836Service() {
        this(new Idea61836Config());
    }

    public Idea61836Service(Idea61836Config config) {
        this.config = config != null ? config : new Idea61836Config();
