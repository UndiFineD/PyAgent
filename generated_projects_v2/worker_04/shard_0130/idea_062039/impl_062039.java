...
@Data
public class Idea62039Config {
    private String name = "idea_062039";
 ...
 */
@Slf4j
public class Idea62039Service {
    private static final int IDEA_ID = 62039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62039Service() {
        this(new Idea62039Config());
    }

    public Idea62039Service(Idea62039Config config) {
        this.config = config != null ? config : new Idea62039Config();
