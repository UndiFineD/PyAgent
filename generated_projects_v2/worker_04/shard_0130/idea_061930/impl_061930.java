...
@Data
public class Idea61930Config {
    private String name = "idea_061930";
 ...
 */
@Slf4j
public class Idea61930Service {
    private static final int IDEA_ID = 61930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61930Service() {
        this(new Idea61930Config());
    }

    public Idea61930Service(Idea61930Config config) {
        this.config = config != null ? config : new Idea61930Config();
