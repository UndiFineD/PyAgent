...
@Data
public class Idea61885Config {
    private String name = "idea_061885";
 ...
 */
@Slf4j
public class Idea61885Service {
    private static final int IDEA_ID = 61885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61885Service() {
        this(new Idea61885Config());
    }

    public Idea61885Service(Idea61885Config config) {
        this.config = config != null ? config : new Idea61885Config();
