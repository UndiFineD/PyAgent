...
@Data
public class Idea61850Config {
    private String name = "idea_061850";
 ...
 */
@Slf4j
public class Idea61850Service {
    private static final int IDEA_ID = 61850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61850Service() {
        this(new Idea61850Config());
    }

    public Idea61850Service(Idea61850Config config) {
        this.config = config != null ? config : new Idea61850Config();
