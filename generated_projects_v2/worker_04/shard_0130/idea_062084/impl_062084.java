...
@Data
public class Idea62084Config {
    private String name = "idea_062084";
 ...
 */
@Slf4j
public class Idea62084Service {
    private static final int IDEA_ID = 62084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62084Service() {
        this(new Idea62084Config());
    }

    public Idea62084Service(Idea62084Config config) {
        this.config = config != null ? config : new Idea62084Config();
