...
@Data
public class Idea62217Config {
    private String name = "idea_062217";
 ...
 */
@Slf4j
public class Idea62217Service {
    private static final int IDEA_ID = 62217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62217Service() {
        this(new Idea62217Config());
    }

    public Idea62217Service(Idea62217Config config) {
        this.config = config != null ? config : new Idea62217Config();
