...
@Data
public class Idea61889Config {
    private String name = "idea_061889";
 ...
 */
@Slf4j
public class Idea61889Service {
    private static final int IDEA_ID = 61889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61889Service() {
        this(new Idea61889Config());
    }

    public Idea61889Service(Idea61889Config config) {
        this.config = config != null ? config : new Idea61889Config();
