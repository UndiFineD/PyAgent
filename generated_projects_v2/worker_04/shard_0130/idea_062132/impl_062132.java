...
@Data
public class Idea62132Config {
    private String name = "idea_062132";
 ...
 */
@Slf4j
public class Idea62132Service {
    private static final int IDEA_ID = 62132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62132Service() {
        this(new Idea62132Config());
    }

    public Idea62132Service(Idea62132Config config) {
        this.config = config != null ? config : new Idea62132Config();
