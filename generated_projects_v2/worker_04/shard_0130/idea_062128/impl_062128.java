...
@Data
public class Idea62128Config {
    private String name = "idea_062128";
 ...
 */
@Slf4j
public class Idea62128Service {
    private static final int IDEA_ID = 62128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62128Service() {
        this(new Idea62128Config());
    }

    public Idea62128Service(Idea62128Config config) {
        this.config = config != null ? config : new Idea62128Config();
