...
@Data
public class Idea61929Config {
    private String name = "idea_061929";
 ...
 */
@Slf4j
public class Idea61929Service {
    private static final int IDEA_ID = 61929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61929Service() {
        this(new Idea61929Config());
    }

    public Idea61929Service(Idea61929Config config) {
        this.config = config != null ? config : new Idea61929Config();
