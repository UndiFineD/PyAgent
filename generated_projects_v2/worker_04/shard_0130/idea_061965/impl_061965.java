...
@Data
public class Idea61965Config {
    private String name = "idea_061965";
 ...
 */
@Slf4j
public class Idea61965Service {
    private static final int IDEA_ID = 61965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61965Service() {
        this(new Idea61965Config());
    }

    public Idea61965Service(Idea61965Config config) {
        this.config = config != null ? config : new Idea61965Config();
