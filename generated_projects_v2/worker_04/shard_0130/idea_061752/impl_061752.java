...
@Data
public class Idea61752Config {
    private String name = "idea_061752";
 ...
 */
@Slf4j
public class Idea61752Service {
    private static final int IDEA_ID = 61752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61752Service() {
        this(new Idea61752Config());
    }

    public Idea61752Service(Idea61752Config config) {
        this.config = config != null ? config : new Idea61752Config();
