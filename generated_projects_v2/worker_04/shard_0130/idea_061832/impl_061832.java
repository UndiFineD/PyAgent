...
@Data
public class Idea61832Config {
    private String name = "idea_061832";
 ...
 */
@Slf4j
public class Idea61832Service {
    private static final int IDEA_ID = 61832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61832Service() {
        this(new Idea61832Config());
    }

    public Idea61832Service(Idea61832Config config) {
        this.config = config != null ? config : new Idea61832Config();
