...
@Data
public class Idea61989Config {
    private String name = "idea_061989";
 ...
 */
@Slf4j
public class Idea61989Service {
    private static final int IDEA_ID = 61989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61989Service() {
        this(new Idea61989Config());
    }

    public Idea61989Service(Idea61989Config config) {
        this.config = config != null ? config : new Idea61989Config();
