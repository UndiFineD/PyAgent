...
@Data
public class Idea61884Config {
    private String name = "idea_061884";
 ...
 */
@Slf4j
public class Idea61884Service {
    private static final int IDEA_ID = 61884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61884Service() {
        this(new Idea61884Config());
    }

    public Idea61884Service(Idea61884Config config) {
        this.config = config != null ? config : new Idea61884Config();
