...
@Data
public class Idea62200Config {
    private String name = "idea_062200";
 ...
 */
@Slf4j
public class Idea62200Service {
    private static final int IDEA_ID = 62200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62200Service() {
        this(new Idea62200Config());
    }

    public Idea62200Service(Idea62200Config config) {
        this.config = config != null ? config : new Idea62200Config();
