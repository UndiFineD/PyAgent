...
@Data
public class Idea61923Config {
    private String name = "idea_061923";
 ...
 */
@Slf4j
public class Idea61923Service {
    private static final int IDEA_ID = 61923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61923Service() {
        this(new Idea61923Config());
    }

    public Idea61923Service(Idea61923Config config) {
        this.config = config != null ? config : new Idea61923Config();
