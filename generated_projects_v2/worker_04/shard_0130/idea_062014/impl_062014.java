...
@Data
public class Idea62014Config {
    private String name = "idea_062014";
 ...
 */
@Slf4j
public class Idea62014Service {
    private static final int IDEA_ID = 62014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62014Service() {
        this(new Idea62014Config());
    }

    public Idea62014Service(Idea62014Config config) {
        this.config = config != null ? config : new Idea62014Config();
