...
@Data
public class Idea62213Config {
    private String name = "idea_062213";
 ...
 */
@Slf4j
public class Idea62213Service {
    private static final int IDEA_ID = 62213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62213Service() {
        this(new Idea62213Config());
    }

    public Idea62213Service(Idea62213Config config) {
        this.config = config != null ? config : new Idea62213Config();
