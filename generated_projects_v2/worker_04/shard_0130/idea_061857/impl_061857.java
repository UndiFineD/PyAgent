...
@Data
public class Idea61857Config {
    private String name = "idea_061857";
 ...
 */
@Slf4j
public class Idea61857Service {
    private static final int IDEA_ID = 61857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61857Service() {
        this(new Idea61857Config());
    }

    public Idea61857Service(Idea61857Config config) {
        this.config = config != null ? config : new Idea61857Config();
