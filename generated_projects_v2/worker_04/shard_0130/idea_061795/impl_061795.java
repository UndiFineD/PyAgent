...
@Data
public class Idea61795Config {
    private String name = "idea_061795";
 ...
 */
@Slf4j
public class Idea61795Service {
    private static final int IDEA_ID = 61795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61795Service() {
        this(new Idea61795Config());
    }

    public Idea61795Service(Idea61795Config config) {
        this.config = config != null ? config : new Idea61795Config();
