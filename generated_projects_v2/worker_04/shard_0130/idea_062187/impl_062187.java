...
@Data
public class Idea62187Config {
    private String name = "idea_062187";
 ...
 */
@Slf4j
public class Idea62187Service {
    private static final int IDEA_ID = 62187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62187Service() {
        this(new Idea62187Config());
    }

    public Idea62187Service(Idea62187Config config) {
        this.config = config != null ? config : new Idea62187Config();
