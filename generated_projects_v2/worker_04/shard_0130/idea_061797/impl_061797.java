...
@Data
public class Idea61797Config {
    private String name = "idea_061797";
 ...
 */
@Slf4j
public class Idea61797Service {
    private static final int IDEA_ID = 61797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61797Service() {
        this(new Idea61797Config());
    }

    public Idea61797Service(Idea61797Config config) {
        this.config = config != null ? config : new Idea61797Config();
