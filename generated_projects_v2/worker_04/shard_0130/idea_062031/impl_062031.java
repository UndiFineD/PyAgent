...
@Data
public class Idea62031Config {
    private String name = "idea_062031";
 ...
 */
@Slf4j
public class Idea62031Service {
    private static final int IDEA_ID = 62031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62031Service() {
        this(new Idea62031Config());
    }

    public Idea62031Service(Idea62031Config config) {
        this.config = config != null ? config : new Idea62031Config();
