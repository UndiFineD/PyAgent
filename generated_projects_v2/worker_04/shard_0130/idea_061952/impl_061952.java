...
@Data
public class Idea61952Config {
    private String name = "idea_061952";
 ...
 */
@Slf4j
public class Idea61952Service {
    private static final int IDEA_ID = 61952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61952Service() {
        this(new Idea61952Config());
    }

    public Idea61952Service(Idea61952Config config) {
        this.config = config != null ? config : new Idea61952Config();
