...
@Data
public class Idea61939Config {
    private String name = "idea_061939";
 ...
 */
@Slf4j
public class Idea61939Service {
    private static final int IDEA_ID = 61939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61939Service() {
        this(new Idea61939Config());
    }

    public Idea61939Service(Idea61939Config config) {
        this.config = config != null ? config : new Idea61939Config();
