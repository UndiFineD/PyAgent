...
@Data
public class Idea61871Config {
    private String name = "idea_061871";
 ...
 */
@Slf4j
public class Idea61871Service {
    private static final int IDEA_ID = 61871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61871Service() {
        this(new Idea61871Config());
    }

    public Idea61871Service(Idea61871Config config) {
        this.config = config != null ? config : new Idea61871Config();
