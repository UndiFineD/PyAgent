...
@Data
public class Idea67015Config {
    private String name = "idea_067015";
 ...
 */
@Slf4j
public class Idea67015Service {
    private static final int IDEA_ID = 67015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67015Service() {
        this(new Idea67015Config());
    }

    public Idea67015Service(Idea67015Config config) {
        this.config = config != null ? config : new Idea67015Config();
