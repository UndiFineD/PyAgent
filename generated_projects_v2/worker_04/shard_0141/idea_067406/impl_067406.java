...
@Data
public class Idea67406Config {
    private String name = "idea_067406";
 ...
 */
@Slf4j
public class Idea67406Service {
    private static final int IDEA_ID = 67406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67406Service() {
        this(new Idea67406Config());
    }

    public Idea67406Service(Idea67406Config config) {
        this.config = config != null ? config : new Idea67406Config();
