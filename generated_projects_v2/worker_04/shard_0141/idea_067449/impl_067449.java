...
@Data
public class Idea67449Config {
    private String name = "idea_067449";
 ...
 */
@Slf4j
public class Idea67449Service {
    private static final int IDEA_ID = 67449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67449Service() {
        this(new Idea67449Config());
    }

    public Idea67449Service(Idea67449Config config) {
        this.config = config != null ? config : new Idea67449Config();
