...
@Data
public class Idea67161Config {
    private String name = "idea_067161";
 ...
 */
@Slf4j
public class Idea67161Service {
    private static final int IDEA_ID = 67161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67161Service() {
        this(new Idea67161Config());
    }

    public Idea67161Service(Idea67161Config config) {
        this.config = config != null ? config : new Idea67161Config();
