...
@Data
public class Idea67260Config {
    private String name = "idea_067260";
 ...
 */
@Slf4j
public class Idea67260Service {
    private static final int IDEA_ID = 67260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67260Service() {
        this(new Idea67260Config());
    }

    public Idea67260Service(Idea67260Config config) {
        this.config = config != null ? config : new Idea67260Config();
