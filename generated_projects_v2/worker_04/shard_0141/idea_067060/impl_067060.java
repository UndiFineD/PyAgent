...
@Data
public class Idea67060Config {
    private String name = "idea_067060";
 ...
 */
@Slf4j
public class Idea67060Service {
    private static final int IDEA_ID = 67060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67060Service() {
        this(new Idea67060Config());
    }

    public Idea67060Service(Idea67060Config config) {
        this.config = config != null ? config : new Idea67060Config();
