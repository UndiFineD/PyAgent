...
@Data
public class Idea67419Config {
    private String name = "idea_067419";
 ...
 */
@Slf4j
public class Idea67419Service {
    private static final int IDEA_ID = 67419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67419Service() {
        this(new Idea67419Config());
    }

    public Idea67419Service(Idea67419Config config) {
        this.config = config != null ? config : new Idea67419Config();
