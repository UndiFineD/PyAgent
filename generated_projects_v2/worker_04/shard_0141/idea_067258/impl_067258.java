...
@Data
public class Idea67258Config {
    private String name = "idea_067258";
 ...
 */
@Slf4j
public class Idea67258Service {
    private static final int IDEA_ID = 67258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67258Service() {
        this(new Idea67258Config());
    }

    public Idea67258Service(Idea67258Config config) {
        this.config = config != null ? config : new Idea67258Config();
