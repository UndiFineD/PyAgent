...
@Data
public class Idea67111Config {
    private String name = "idea_067111";
 ...
 */
@Slf4j
public class Idea67111Service {
    private static final int IDEA_ID = 67111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67111Service() {
        this(new Idea67111Config());
    }

    public Idea67111Service(Idea67111Config config) {
        this.config = config != null ? config : new Idea67111Config();
