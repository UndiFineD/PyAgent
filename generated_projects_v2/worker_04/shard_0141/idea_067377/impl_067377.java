...
@Data
public class Idea67377Config {
    private String name = "idea_067377";
 ...
 */
@Slf4j
public class Idea67377Service {
    private static final int IDEA_ID = 67377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67377Service() {
        this(new Idea67377Config());
    }

    public Idea67377Service(Idea67377Config config) {
        this.config = config != null ? config : new Idea67377Config();
