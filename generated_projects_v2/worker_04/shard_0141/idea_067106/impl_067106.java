...
@Data
public class Idea67106Config {
    private String name = "idea_067106";
 ...
 */
@Slf4j
public class Idea67106Service {
    private static final int IDEA_ID = 67106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67106Service() {
        this(new Idea67106Config());
    }

    public Idea67106Service(Idea67106Config config) {
        this.config = config != null ? config : new Idea67106Config();
