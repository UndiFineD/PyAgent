...
@Data
public class Idea67006Config {
    private String name = "idea_067006";
 ...
 */
@Slf4j
public class Idea67006Service {
    private static final int IDEA_ID = 67006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67006Service() {
        this(new Idea67006Config());
    }

    public Idea67006Service(Idea67006Config config) {
        this.config = config != null ? config : new Idea67006Config();
