...
@Data
public class Idea67198Config {
    private String name = "idea_067198";
 ...
 */
@Slf4j
public class Idea67198Service {
    private static final int IDEA_ID = 67198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67198Service() {
        this(new Idea67198Config());
    }

    public Idea67198Service(Idea67198Config config) {
        this.config = config != null ? config : new Idea67198Config();
