...
@Data
public class Idea67365Config {
    private String name = "idea_067365";
 ...
 */
@Slf4j
public class Idea67365Service {
    private static final int IDEA_ID = 67365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67365Service() {
        this(new Idea67365Config());
    }

    public Idea67365Service(Idea67365Config config) {
        this.config = config != null ? config : new Idea67365Config();
