...
@Data
public class Idea67395Config {
    private String name = "idea_067395";
 ...
 */
@Slf4j
public class Idea67395Service {
    private static final int IDEA_ID = 67395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67395Service() {
        this(new Idea67395Config());
    }

    public Idea67395Service(Idea67395Config config) {
        this.config = config != null ? config : new Idea67395Config();
