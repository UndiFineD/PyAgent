...
@Data
public class Idea67028Config {
    private String name = "idea_067028";
 ...
 */
@Slf4j
public class Idea67028Service {
    private static final int IDEA_ID = 67028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67028Service() {
        this(new Idea67028Config());
    }

    public Idea67028Service(Idea67028Config config) {
        this.config = config != null ? config : new Idea67028Config();
