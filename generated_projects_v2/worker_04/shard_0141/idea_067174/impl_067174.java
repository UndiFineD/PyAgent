...
@Data
public class Idea67174Config {
    private String name = "idea_067174";
 ...
 */
@Slf4j
public class Idea67174Service {
    private static final int IDEA_ID = 67174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67174Service() {
        this(new Idea67174Config());
    }

    public Idea67174Service(Idea67174Config config) {
        this.config = config != null ? config : new Idea67174Config();
