...
@Data
public class Idea67207Config {
    private String name = "idea_067207";
 ...
 */
@Slf4j
public class Idea67207Service {
    private static final int IDEA_ID = 67207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67207Service() {
        this(new Idea67207Config());
    }

    public Idea67207Service(Idea67207Config config) {
        this.config = config != null ? config : new Idea67207Config();
