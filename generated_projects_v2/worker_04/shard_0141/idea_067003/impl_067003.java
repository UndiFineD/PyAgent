...
@Data
public class Idea67003Config {
    private String name = "idea_067003";
 ...
 */
@Slf4j
public class Idea67003Service {
    private static final int IDEA_ID = 67003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67003Service() {
        this(new Idea67003Config());
    }

    public Idea67003Service(Idea67003Config config) {
        this.config = config != null ? config : new Idea67003Config();
