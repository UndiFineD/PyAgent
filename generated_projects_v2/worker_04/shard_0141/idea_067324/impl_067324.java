...
@Data
public class Idea67324Config {
    private String name = "idea_067324";
 ...
 */
@Slf4j
public class Idea67324Service {
    private static final int IDEA_ID = 67324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67324Service() {
        this(new Idea67324Config());
    }

    public Idea67324Service(Idea67324Config config) {
        this.config = config != null ? config : new Idea67324Config();
