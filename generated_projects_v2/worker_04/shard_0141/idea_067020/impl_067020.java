...
@Data
public class Idea67020Config {
    private String name = "idea_067020";
 ...
 */
@Slf4j
public class Idea67020Service {
    private static final int IDEA_ID = 67020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67020Service() {
        this(new Idea67020Config());
    }

    public Idea67020Service(Idea67020Config config) {
        this.config = config != null ? config : new Idea67020Config();
