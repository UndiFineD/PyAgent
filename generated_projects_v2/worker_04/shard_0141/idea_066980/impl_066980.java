...
@Data
public class Idea66980Config {
    private String name = "idea_066980";
 ...
 */
@Slf4j
public class Idea66980Service {
    private static final int IDEA_ID = 66980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66980Service() {
        this(new Idea66980Config());
    }

    public Idea66980Service(Idea66980Config config) {
        this.config = config != null ? config : new Idea66980Config();
