...
@Data
public class Idea67389Config {
    private String name = "idea_067389";
 ...
 */
@Slf4j
public class Idea67389Service {
    private static final int IDEA_ID = 67389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67389Service() {
        this(new Idea67389Config());
    }

    public Idea67389Service(Idea67389Config config) {
        this.config = config != null ? config : new Idea67389Config();
