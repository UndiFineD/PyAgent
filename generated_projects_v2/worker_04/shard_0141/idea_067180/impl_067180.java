...
@Data
public class Idea67180Config {
    private String name = "idea_067180";
 ...
 */
@Slf4j
public class Idea67180Service {
    private static final int IDEA_ID = 67180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67180Service() {
        this(new Idea67180Config());
    }

    public Idea67180Service(Idea67180Config config) {
        this.config = config != null ? config : new Idea67180Config();
