...
@Data
public class Idea67371Config {
    private String name = "idea_067371";
 ...
 */
@Slf4j
public class Idea67371Service {
    private static final int IDEA_ID = 67371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67371Service() {
        this(new Idea67371Config());
    }

    public Idea67371Service(Idea67371Config config) {
        this.config = config != null ? config : new Idea67371Config();
