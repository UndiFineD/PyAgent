...
@Data
public class Idea67038Config {
    private String name = "idea_067038";
 ...
 */
@Slf4j
public class Idea67038Service {
    private static final int IDEA_ID = 67038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67038Service() {
        this(new Idea67038Config());
    }

    public Idea67038Service(Idea67038Config config) {
        this.config = config != null ? config : new Idea67038Config();
