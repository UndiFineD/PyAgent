...
@Data
public class Idea67165Config {
    private String name = "idea_067165";
 ...
 */
@Slf4j
public class Idea67165Service {
    private static final int IDEA_ID = 67165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67165Service() {
        this(new Idea67165Config());
    }

    public Idea67165Service(Idea67165Config config) {
        this.config = config != null ? config : new Idea67165Config();
