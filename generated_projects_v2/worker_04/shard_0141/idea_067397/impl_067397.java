...
@Data
public class Idea67397Config {
    private String name = "idea_067397";
 ...
 */
@Slf4j
public class Idea67397Service {
    private static final int IDEA_ID = 67397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67397Service() {
        this(new Idea67397Config());
    }

    public Idea67397Service(Idea67397Config config) {
        this.config = config != null ? config : new Idea67397Config();
