...
@Data
public class Idea67178Config {
    private String name = "idea_067178";
 ...
 */
@Slf4j
public class Idea67178Service {
    private static final int IDEA_ID = 67178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67178Service() {
        this(new Idea67178Config());
    }

    public Idea67178Service(Idea67178Config config) {
        this.config = config != null ? config : new Idea67178Config();
