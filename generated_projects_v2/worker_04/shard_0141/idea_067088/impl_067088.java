...
@Data
public class Idea67088Config {
    private String name = "idea_067088";
 ...
 */
@Slf4j
public class Idea67088Service {
    private static final int IDEA_ID = 67088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67088Service() {
        this(new Idea67088Config());
    }

    public Idea67088Service(Idea67088Config config) {
        this.config = config != null ? config : new Idea67088Config();
