...
@Data
public class Idea67201Config {
    private String name = "idea_067201";
 ...
 */
@Slf4j
public class Idea67201Service {
    private static final int IDEA_ID = 67201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67201Service() {
        this(new Idea67201Config());
    }

    public Idea67201Service(Idea67201Config config) {
        this.config = config != null ? config : new Idea67201Config();
