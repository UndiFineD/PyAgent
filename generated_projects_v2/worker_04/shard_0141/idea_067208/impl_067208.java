...
@Data
public class Idea67208Config {
    private String name = "idea_067208";
 ...
 */
@Slf4j
public class Idea67208Service {
    private static final int IDEA_ID = 67208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67208Service() {
        this(new Idea67208Config());
    }

    public Idea67208Service(Idea67208Config config) {
        this.config = config != null ? config : new Idea67208Config();
