...
@Data
public class Idea67013Config {
    private String name = "idea_067013";
 ...
 */
@Slf4j
public class Idea67013Service {
    private static final int IDEA_ID = 67013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67013Service() {
        this(new Idea67013Config());
    }

    public Idea67013Service(Idea67013Config config) {
        this.config = config != null ? config : new Idea67013Config();
