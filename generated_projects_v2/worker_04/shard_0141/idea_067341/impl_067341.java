...
@Data
public class Idea67341Config {
    private String name = "idea_067341";
 ...
 */
@Slf4j
public class Idea67341Service {
    private static final int IDEA_ID = 67341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67341Service() {
        this(new Idea67341Config());
    }

    public Idea67341Service(Idea67341Config config) {
        this.config = config != null ? config : new Idea67341Config();
