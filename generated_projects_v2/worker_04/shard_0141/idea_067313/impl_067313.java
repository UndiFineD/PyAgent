...
@Data
public class Idea67313Config {
    private String name = "idea_067313";
 ...
 */
@Slf4j
public class Idea67313Service {
    private static final int IDEA_ID = 67313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67313Service() {
        this(new Idea67313Config());
    }

    public Idea67313Service(Idea67313Config config) {
        this.config = config != null ? config : new Idea67313Config();
