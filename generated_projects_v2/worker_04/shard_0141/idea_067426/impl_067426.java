...
@Data
public class Idea67426Config {
    private String name = "idea_067426";
 ...
 */
@Slf4j
public class Idea67426Service {
    private static final int IDEA_ID = 67426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67426Service() {
        this(new Idea67426Config());
    }

    public Idea67426Service(Idea67426Config config) {
        this.config = config != null ? config : new Idea67426Config();
