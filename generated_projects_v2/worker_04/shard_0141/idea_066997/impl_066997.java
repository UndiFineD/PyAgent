...
@Data
public class Idea66997Config {
    private String name = "idea_066997";
 ...
 */
@Slf4j
public class Idea66997Service {
    private static final int IDEA_ID = 66997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66997Service() {
        this(new Idea66997Config());
    }

    public Idea66997Service(Idea66997Config config) {
        this.config = config != null ? config : new Idea66997Config();
