...
@Data
public class Idea67123Config {
    private String name = "idea_067123";
 ...
 */
@Slf4j
public class Idea67123Service {
    private static final int IDEA_ID = 67123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67123Service() {
        this(new Idea67123Config());
    }

    public Idea67123Service(Idea67123Config config) {
        this.config = config != null ? config : new Idea67123Config();
