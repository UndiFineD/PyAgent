...
@Data
public class Idea67195Config {
    private String name = "idea_067195";
 ...
 */
@Slf4j
public class Idea67195Service {
    private static final int IDEA_ID = 67195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67195Service() {
        this(new Idea67195Config());
    }

    public Idea67195Service(Idea67195Config config) {
        this.config = config != null ? config : new Idea67195Config();
