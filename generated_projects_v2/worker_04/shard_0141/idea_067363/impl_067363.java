...
@Data
public class Idea67363Config {
    private String name = "idea_067363";
 ...
 */
@Slf4j
public class Idea67363Service {
    private static final int IDEA_ID = 67363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67363Service() {
        this(new Idea67363Config());
    }

    public Idea67363Service(Idea67363Config config) {
        this.config = config != null ? config : new Idea67363Config();
