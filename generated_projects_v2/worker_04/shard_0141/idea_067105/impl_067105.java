...
@Data
public class Idea67105Config {
    private String name = "idea_067105";
 ...
 */
@Slf4j
public class Idea67105Service {
    private static final int IDEA_ID = 67105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67105Service() {
        this(new Idea67105Config());
    }

    public Idea67105Service(Idea67105Config config) {
        this.config = config != null ? config : new Idea67105Config();
