...
@Data
public class Idea67037Config {
    private String name = "idea_067037";
 ...
 */
@Slf4j
public class Idea67037Service {
    private static final int IDEA_ID = 67037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67037Service() {
        this(new Idea67037Config());
    }

    public Idea67037Service(Idea67037Config config) {
        this.config = config != null ? config : new Idea67037Config();
