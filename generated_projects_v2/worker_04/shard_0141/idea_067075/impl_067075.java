...
@Data
public class Idea67075Config {
    private String name = "idea_067075";
 ...
 */
@Slf4j
public class Idea67075Service {
    private static final int IDEA_ID = 67075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67075Service() {
        this(new Idea67075Config());
    }

    public Idea67075Service(Idea67075Config config) {
        this.config = config != null ? config : new Idea67075Config();
