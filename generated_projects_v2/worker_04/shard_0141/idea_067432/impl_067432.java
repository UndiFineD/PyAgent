...
@Data
public class Idea67432Config {
    private String name = "idea_067432";
 ...
 */
@Slf4j
public class Idea67432Service {
    private static final int IDEA_ID = 67432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67432Service() {
        this(new Idea67432Config());
    }

    public Idea67432Service(Idea67432Config config) {
        this.config = config != null ? config : new Idea67432Config();
