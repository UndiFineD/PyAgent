...
@Data
public class Idea67233Config {
    private String name = "idea_067233";
 ...
 */
@Slf4j
public class Idea67233Service {
    private static final int IDEA_ID = 67233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67233Service() {
        this(new Idea67233Config());
    }

    public Idea67233Service(Idea67233Config config) {
        this.config = config != null ? config : new Idea67233Config();
