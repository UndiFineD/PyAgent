...
@Data
public class Idea66981Config {
    private String name = "idea_066981";
 ...
 */
@Slf4j
public class Idea66981Service {
    private static final int IDEA_ID = 66981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66981Service() {
        this(new Idea66981Config());
    }

    public Idea66981Service(Idea66981Config config) {
        this.config = config != null ? config : new Idea66981Config();
