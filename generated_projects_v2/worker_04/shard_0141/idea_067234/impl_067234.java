...
@Data
public class Idea67234Config {
    private String name = "idea_067234";
 ...
 */
@Slf4j
public class Idea67234Service {
    private static final int IDEA_ID = 67234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67234Service() {
        this(new Idea67234Config());
    }

    public Idea67234Service(Idea67234Config config) {
        this.config = config != null ? config : new Idea67234Config();
