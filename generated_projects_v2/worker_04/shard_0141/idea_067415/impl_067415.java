...
@Data
public class Idea67415Config {
    private String name = "idea_067415";
 ...
 */
@Slf4j
public class Idea67415Service {
    private static final int IDEA_ID = 67415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67415Service() {
        this(new Idea67415Config());
    }

    public Idea67415Service(Idea67415Config config) {
        this.config = config != null ? config : new Idea67415Config();
