...
@Data
public class Idea67023Config {
    private String name = "idea_067023";
 ...
 */
@Slf4j
public class Idea67023Service {
    private static final int IDEA_ID = 67023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67023Service() {
        this(new Idea67023Config());
    }

    public Idea67023Service(Idea67023Config config) {
        this.config = config != null ? config : new Idea67023Config();
