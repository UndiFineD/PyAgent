...
@Data
public class Idea67333Config {
    private String name = "idea_067333";
 ...
 */
@Slf4j
public class Idea67333Service {
    private static final int IDEA_ID = 67333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67333Service() {
        this(new Idea67333Config());
    }

    public Idea67333Service(Idea67333Config config) {
        this.config = config != null ? config : new Idea67333Config();
