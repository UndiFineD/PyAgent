...
@Data
public class Idea67370Config {
    private String name = "idea_067370";
 ...
 */
@Slf4j
public class Idea67370Service {
    private static final int IDEA_ID = 67370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67370Service() {
        this(new Idea67370Config());
    }

    public Idea67370Service(Idea67370Config config) {
        this.config = config != null ? config : new Idea67370Config();
