...
@Data
public class Idea67100Config {
    private String name = "idea_067100";
 ...
 */
@Slf4j
public class Idea67100Service {
    private static final int IDEA_ID = 67100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67100Service() {
        this(new Idea67100Config());
    }

    public Idea67100Service(Idea67100Config config) {
        this.config = config != null ? config : new Idea67100Config();
