...
@Data
public class Idea67167Config {
    private String name = "idea_067167";
 ...
 */
@Slf4j
public class Idea67167Service {
    private static final int IDEA_ID = 67167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67167Service() {
        this(new Idea67167Config());
    }

    public Idea67167Service(Idea67167Config config) {
        this.config = config != null ? config : new Idea67167Config();
