...
@Data
public class Idea67376Config {
    private String name = "idea_067376";
 ...
 */
@Slf4j
public class Idea67376Service {
    private static final int IDEA_ID = 67376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67376Service() {
        this(new Idea67376Config());
    }

    public Idea67376Service(Idea67376Config config) {
        this.config = config != null ? config : new Idea67376Config();
