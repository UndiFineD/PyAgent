...
@Data
public class Idea66977Config {
    private String name = "idea_066977";
 ...
 */
@Slf4j
public class Idea66977Service {
    private static final int IDEA_ID = 66977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66977Service() {
        this(new Idea66977Config());
    }

    public Idea66977Service(Idea66977Config config) {
        this.config = config != null ? config : new Idea66977Config();
