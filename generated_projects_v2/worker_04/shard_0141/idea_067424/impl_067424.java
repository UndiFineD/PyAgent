...
@Data
public class Idea67424Config {
    private String name = "idea_067424";
 ...
 */
@Slf4j
public class Idea67424Service {
    private static final int IDEA_ID = 67424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67424Service() {
        this(new Idea67424Config());
    }

    public Idea67424Service(Idea67424Config config) {
        this.config = config != null ? config : new Idea67424Config();
