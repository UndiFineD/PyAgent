...
@Data
public class Idea66999Config {
    private String name = "idea_066999";
 ...
 */
@Slf4j
public class Idea66999Service {
    private static final int IDEA_ID = 66999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66999Service() {
        this(new Idea66999Config());
    }

    public Idea66999Service(Idea66999Config config) {
        this.config = config != null ? config : new Idea66999Config();
