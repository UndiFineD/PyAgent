...
@Data
public class Idea67396Config {
    private String name = "idea_067396";
 ...
 */
@Slf4j
public class Idea67396Service {
    private static final int IDEA_ID = 67396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67396Service() {
        this(new Idea67396Config());
    }

    public Idea67396Service(Idea67396Config config) {
        this.config = config != null ? config : new Idea67396Config();
