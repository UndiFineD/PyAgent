...
@Data
public class Idea67041Config {
    private String name = "idea_067041";
 ...
 */
@Slf4j
public class Idea67041Service {
    private static final int IDEA_ID = 67041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67041Service() {
        this(new Idea67041Config());
    }

    public Idea67041Service(Idea67041Config config) {
        this.config = config != null ? config : new Idea67041Config();
