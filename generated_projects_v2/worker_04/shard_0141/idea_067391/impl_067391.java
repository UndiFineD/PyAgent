...
@Data
public class Idea67391Config {
    private String name = "idea_067391";
 ...
 */
@Slf4j
public class Idea67391Service {
    private static final int IDEA_ID = 67391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67391Service() {
        this(new Idea67391Config());
    }

    public Idea67391Service(Idea67391Config config) {
        this.config = config != null ? config : new Idea67391Config();
