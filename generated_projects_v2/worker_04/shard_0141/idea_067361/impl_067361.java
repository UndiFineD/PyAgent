...
@Data
public class Idea67361Config {
    private String name = "idea_067361";
 ...
 */
@Slf4j
public class Idea67361Service {
    private static final int IDEA_ID = 67361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67361Service() {
        this(new Idea67361Config());
    }

    public Idea67361Service(Idea67361Config config) {
        this.config = config != null ? config : new Idea67361Config();
