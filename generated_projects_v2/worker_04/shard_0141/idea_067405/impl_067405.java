...
@Data
public class Idea67405Config {
    private String name = "idea_067405";
 ...
 */
@Slf4j
public class Idea67405Service {
    private static final int IDEA_ID = 67405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67405Service() {
        this(new Idea67405Config());
    }

    public Idea67405Service(Idea67405Config config) {
        this.config = config != null ? config : new Idea67405Config();
