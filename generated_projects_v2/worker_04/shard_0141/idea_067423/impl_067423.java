...
@Data
public class Idea67423Config {
    private String name = "idea_067423";
 ...
 */
@Slf4j
public class Idea67423Service {
    private static final int IDEA_ID = 67423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67423Service() {
        this(new Idea67423Config());
    }

    public Idea67423Service(Idea67423Config config) {
        this.config = config != null ? config : new Idea67423Config();
