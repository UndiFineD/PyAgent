...
@Data
public class Idea67440Config {
    private String name = "idea_067440";
 ...
 */
@Slf4j
public class Idea67440Service {
    private static final int IDEA_ID = 67440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67440Service() {
        this(new Idea67440Config());
    }

    public Idea67440Service(Idea67440Config config) {
        this.config = config != null ? config : new Idea67440Config();
