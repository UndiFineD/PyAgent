...
@Data
public class Idea67411Config {
    private String name = "idea_067411";
 ...
 */
@Slf4j
public class Idea67411Service {
    private static final int IDEA_ID = 67411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67411Service() {
        this(new Idea67411Config());
    }

    public Idea67411Service(Idea67411Config config) {
        this.config = config != null ? config : new Idea67411Config();
