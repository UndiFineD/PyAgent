...
@Data
public class Idea67191Config {
    private String name = "idea_067191";
 ...
 */
@Slf4j
public class Idea67191Service {
    private static final int IDEA_ID = 67191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67191Service() {
        this(new Idea67191Config());
    }

    public Idea67191Service(Idea67191Config config) {
        this.config = config != null ? config : new Idea67191Config();
