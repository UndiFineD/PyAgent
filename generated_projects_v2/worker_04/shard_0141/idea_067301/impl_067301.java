...
@Data
public class Idea67301Config {
    private String name = "idea_067301";
 ...
 */
@Slf4j
public class Idea67301Service {
    private static final int IDEA_ID = 67301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67301Service() {
        this(new Idea67301Config());
    }

    public Idea67301Service(Idea67301Config config) {
        this.config = config != null ? config : new Idea67301Config();
