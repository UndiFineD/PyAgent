...
@Data
public class Idea67007Config {
    private String name = "idea_067007";
 ...
 */
@Slf4j
public class Idea67007Service {
    private static final int IDEA_ID = 67007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67007Service() {
        this(new Idea67007Config());
    }

    public Idea67007Service(Idea67007Config config) {
        this.config = config != null ? config : new Idea67007Config();
