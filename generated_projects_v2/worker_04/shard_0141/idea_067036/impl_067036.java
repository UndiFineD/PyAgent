...
@Data
public class Idea67036Config {
    private String name = "idea_067036";
 ...
 */
@Slf4j
public class Idea67036Service {
    private static final int IDEA_ID = 67036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67036Service() {
        this(new Idea67036Config());
    }

    public Idea67036Service(Idea67036Config config) {
        this.config = config != null ? config : new Idea67036Config();
