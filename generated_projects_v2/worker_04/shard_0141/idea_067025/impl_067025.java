...
@Data
public class Idea67025Config {
    private String name = "idea_067025";
 ...
 */
@Slf4j
public class Idea67025Service {
    private static final int IDEA_ID = 67025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67025Service() {
        this(new Idea67025Config());
    }

    public Idea67025Service(Idea67025Config config) {
        this.config = config != null ? config : new Idea67025Config();
