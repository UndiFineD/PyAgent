...
@Data
public class Idea67408Config {
    private String name = "idea_067408";
 ...
 */
@Slf4j
public class Idea67408Service {
    private static final int IDEA_ID = 67408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67408Service() {
        this(new Idea67408Config());
    }

    public Idea67408Service(Idea67408Config config) {
        this.config = config != null ? config : new Idea67408Config();
