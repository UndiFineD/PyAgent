...
@Data
public class Idea67091Config {
    private String name = "idea_067091";
 ...
 */
@Slf4j
public class Idea67091Service {
    private static final int IDEA_ID = 67091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67091Service() {
        this(new Idea67091Config());
    }

    public Idea67091Service(Idea67091Config config) {
        this.config = config != null ? config : new Idea67091Config();
