...
@Data
public class Idea67250Config {
    private String name = "idea_067250";
 ...
 */
@Slf4j
public class Idea67250Service {
    private static final int IDEA_ID = 67250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67250Service() {
        this(new Idea67250Config());
    }

    public Idea67250Service(Idea67250Config config) {
        this.config = config != null ? config : new Idea67250Config();
