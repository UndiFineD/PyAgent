...
@Data
public class Idea67197Config {
    private String name = "idea_067197";
 ...
 */
@Slf4j
public class Idea67197Service {
    private static final int IDEA_ID = 67197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67197Service() {
        this(new Idea67197Config());
    }

    public Idea67197Service(Idea67197Config config) {
        this.config = config != null ? config : new Idea67197Config();
