...
@Data
public class Idea67133Config {
    private String name = "idea_067133";
 ...
 */
@Slf4j
public class Idea67133Service {
    private static final int IDEA_ID = 67133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67133Service() {
        this(new Idea67133Config());
    }

    public Idea67133Service(Idea67133Config config) {
        this.config = config != null ? config : new Idea67133Config();
