...
@Data
public class Idea67386Config {
    private String name = "idea_067386";
 ...
 */
@Slf4j
public class Idea67386Service {
    private static final int IDEA_ID = 67386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67386Service() {
        this(new Idea67386Config());
    }

    public Idea67386Service(Idea67386Config config) {
        this.config = config != null ? config : new Idea67386Config();
