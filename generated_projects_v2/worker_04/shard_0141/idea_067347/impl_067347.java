...
@Data
public class Idea67347Config {
    private String name = "idea_067347";
 ...
 */
@Slf4j
public class Idea67347Service {
    private static final int IDEA_ID = 67347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67347Service() {
        this(new Idea67347Config());
    }

    public Idea67347Service(Idea67347Config config) {
        this.config = config != null ? config : new Idea67347Config();
