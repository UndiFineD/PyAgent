...
@Data
public class Idea67193Config {
    private String name = "idea_067193";
 ...
 */
@Slf4j
public class Idea67193Service {
    private static final int IDEA_ID = 67193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67193Service() {
        this(new Idea67193Config());
    }

    public Idea67193Service(Idea67193Config config) {
        this.config = config != null ? config : new Idea67193Config();
