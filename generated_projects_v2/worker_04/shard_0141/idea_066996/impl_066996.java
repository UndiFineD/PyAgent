...
@Data
public class Idea66996Config {
    private String name = "idea_066996";
 ...
 */
@Slf4j
public class Idea66996Service {
    private static final int IDEA_ID = 66996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66996Service() {
        this(new Idea66996Config());
    }

    public Idea66996Service(Idea66996Config config) {
        this.config = config != null ? config : new Idea66996Config();
