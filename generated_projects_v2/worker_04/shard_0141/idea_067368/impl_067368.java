...
@Data
public class Idea67368Config {
    private String name = "idea_067368";
 ...
 */
@Slf4j
public class Idea67368Service {
    private static final int IDEA_ID = 67368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67368Service() {
        this(new Idea67368Config());
    }

    public Idea67368Service(Idea67368Config config) {
        this.config = config != null ? config : new Idea67368Config();
