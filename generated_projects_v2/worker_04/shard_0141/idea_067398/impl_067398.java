...
@Data
public class Idea67398Config {
    private String name = "idea_067398";
 ...
 */
@Slf4j
public class Idea67398Service {
    private static final int IDEA_ID = 67398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67398Service() {
        this(new Idea67398Config());
    }

    public Idea67398Service(Idea67398Config config) {
        this.config = config != null ? config : new Idea67398Config();
