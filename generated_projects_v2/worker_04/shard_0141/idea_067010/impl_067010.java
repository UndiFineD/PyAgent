...
@Data
public class Idea67010Config {
    private String name = "idea_067010";
 ...
 */
@Slf4j
public class Idea67010Service {
    private static final int IDEA_ID = 67010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67010Service() {
        this(new Idea67010Config());
    }

    public Idea67010Service(Idea67010Config config) {
        this.config = config != null ? config : new Idea67010Config();
