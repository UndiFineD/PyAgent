...
@Data
public class Idea67235Config {
    private String name = "idea_067235";
 ...
 */
@Slf4j
public class Idea67235Service {
    private static final int IDEA_ID = 67235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67235Service() {
        this(new Idea67235Config());
    }

    public Idea67235Service(Idea67235Config config) {
        this.config = config != null ? config : new Idea67235Config();
