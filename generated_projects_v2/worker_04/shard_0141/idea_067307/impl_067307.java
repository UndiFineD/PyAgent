...
@Data
public class Idea67307Config {
    private String name = "idea_067307";
 ...
 */
@Slf4j
public class Idea67307Service {
    private static final int IDEA_ID = 67307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67307Service() {
        this(new Idea67307Config());
    }

    public Idea67307Service(Idea67307Config config) {
        this.config = config != null ? config : new Idea67307Config();
