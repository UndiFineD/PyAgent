...
@Data
public class Idea67122Config {
    private String name = "idea_067122";
 ...
 */
@Slf4j
public class Idea67122Service {
    private static final int IDEA_ID = 67122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67122Service() {
        this(new Idea67122Config());
    }

    public Idea67122Service(Idea67122Config config) {
        this.config = config != null ? config : new Idea67122Config();
