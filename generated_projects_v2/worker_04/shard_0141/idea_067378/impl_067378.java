...
@Data
public class Idea67378Config {
    private String name = "idea_067378";
 ...
 */
@Slf4j
public class Idea67378Service {
    private static final int IDEA_ID = 67378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67378Service() {
        this(new Idea67378Config());
    }

    public Idea67378Service(Idea67378Config config) {
        this.config = config != null ? config : new Idea67378Config();
