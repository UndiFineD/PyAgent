...
@Data
public class Idea67117Config {
    private String name = "idea_067117";
 ...
 */
@Slf4j
public class Idea67117Service {
    private static final int IDEA_ID = 67117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67117Service() {
        this(new Idea67117Config());
    }

    public Idea67117Service(Idea67117Config config) {
        this.config = config != null ? config : new Idea67117Config();
