...
@Data
public class Idea67259Config {
    private String name = "idea_067259";
 ...
 */
@Slf4j
public class Idea67259Service {
    private static final int IDEA_ID = 67259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67259Service() {
        this(new Idea67259Config());
    }

    public Idea67259Service(Idea67259Config config) {
        this.config = config != null ? config : new Idea67259Config();
