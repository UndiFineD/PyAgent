...
@Data
public class Idea67263Config {
    private String name = "idea_067263";
 ...
 */
@Slf4j
public class Idea67263Service {
    private static final int IDEA_ID = 67263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67263Service() {
        this(new Idea67263Config());
    }

    public Idea67263Service(Idea67263Config config) {
        this.config = config != null ? config : new Idea67263Config();
