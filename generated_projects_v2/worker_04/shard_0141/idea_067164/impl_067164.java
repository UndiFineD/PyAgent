...
@Data
public class Idea67164Config {
    private String name = "idea_067164";
 ...
 */
@Slf4j
public class Idea67164Service {
    private static final int IDEA_ID = 67164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67164Service() {
        this(new Idea67164Config());
    }

    public Idea67164Service(Idea67164Config config) {
        this.config = config != null ? config : new Idea67164Config();
