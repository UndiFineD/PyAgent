...
@Data
public class Idea67303Config {
    private String name = "idea_067303";
 ...
 */
@Slf4j
public class Idea67303Service {
    private static final int IDEA_ID = 67303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67303Service() {
        this(new Idea67303Config());
    }

    public Idea67303Service(Idea67303Config config) {
        this.config = config != null ? config : new Idea67303Config();
