...
@Data
public class Idea66993Config {
    private String name = "idea_066993";
 ...
 */
@Slf4j
public class Idea66993Service {
    private static final int IDEA_ID = 66993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66993Service() {
        this(new Idea66993Config());
    }

    public Idea66993Service(Idea66993Config config) {
        this.config = config != null ? config : new Idea66993Config();
