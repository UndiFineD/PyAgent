...
@Data
public class Idea67390Config {
    private String name = "idea_067390";
 ...
 */
@Slf4j
public class Idea67390Service {
    private static final int IDEA_ID = 67390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67390Service() {
        this(new Idea67390Config());
    }

    public Idea67390Service(Idea67390Config config) {
        this.config = config != null ? config : new Idea67390Config();
