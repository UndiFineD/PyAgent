...
@Data
public class Idea67166Config {
    private String name = "idea_067166";
 ...
 */
@Slf4j
public class Idea67166Service {
    private static final int IDEA_ID = 67166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67166Service() {
        this(new Idea67166Config());
    }

    public Idea67166Service(Idea67166Config config) {
        this.config = config != null ? config : new Idea67166Config();
