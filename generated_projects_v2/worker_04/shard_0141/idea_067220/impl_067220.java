...
@Data
public class Idea67220Config {
    private String name = "idea_067220";
 ...
 */
@Slf4j
public class Idea67220Service {
    private static final int IDEA_ID = 67220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67220Service() {
        this(new Idea67220Config());
    }

    public Idea67220Service(Idea67220Config config) {
        this.config = config != null ? config : new Idea67220Config();
