...
@Data
public class Idea67441Config {
    private String name = "idea_067441";
 ...
 */
@Slf4j
public class Idea67441Service {
    private static final int IDEA_ID = 67441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67441Service() {
        this(new Idea67441Config());
    }

    public Idea67441Service(Idea67441Config config) {
        this.config = config != null ? config : new Idea67441Config();
