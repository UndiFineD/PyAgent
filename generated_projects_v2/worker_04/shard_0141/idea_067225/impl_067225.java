...
@Data
public class Idea67225Config {
    private String name = "idea_067225";
 ...
 */
@Slf4j
public class Idea67225Service {
    private static final int IDEA_ID = 67225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67225Service() {
        this(new Idea67225Config());
    }

    public Idea67225Service(Idea67225Config config) {
        this.config = config != null ? config : new Idea67225Config();
