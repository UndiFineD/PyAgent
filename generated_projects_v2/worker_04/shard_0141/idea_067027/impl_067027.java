...
@Data
public class Idea67027Config {
    private String name = "idea_067027";
 ...
 */
@Slf4j
public class Idea67027Service {
    private static final int IDEA_ID = 67027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67027Service() {
        this(new Idea67027Config());
    }

    public Idea67027Service(Idea67027Config config) {
        this.config = config != null ? config : new Idea67027Config();
