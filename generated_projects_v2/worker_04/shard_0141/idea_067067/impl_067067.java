...
@Data
public class Idea67067Config {
    private String name = "idea_067067";
 ...
 */
@Slf4j
public class Idea67067Service {
    private static final int IDEA_ID = 67067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67067Service() {
        this(new Idea67067Config());
    }

    public Idea67067Service(Idea67067Config config) {
        this.config = config != null ? config : new Idea67067Config();
