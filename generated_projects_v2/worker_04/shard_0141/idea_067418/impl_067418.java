...
@Data
public class Idea67418Config {
    private String name = "idea_067418";
 ...
 */
@Slf4j
public class Idea67418Service {
    private static final int IDEA_ID = 67418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67418Service() {
        this(new Idea67418Config());
    }

    public Idea67418Service(Idea67418Config config) {
        this.config = config != null ? config : new Idea67418Config();
