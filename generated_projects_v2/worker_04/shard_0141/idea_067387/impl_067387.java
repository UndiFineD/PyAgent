...
@Data
public class Idea67387Config {
    private String name = "idea_067387";
 ...
 */
@Slf4j
public class Idea67387Service {
    private static final int IDEA_ID = 67387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67387Service() {
        this(new Idea67387Config());
    }

    public Idea67387Service(Idea67387Config config) {
        this.config = config != null ? config : new Idea67387Config();
