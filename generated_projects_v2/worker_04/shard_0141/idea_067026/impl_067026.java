...
@Data
public class Idea67026Config {
    private String name = "idea_067026";
 ...
 */
@Slf4j
public class Idea67026Service {
    private static final int IDEA_ID = 67026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67026Service() {
        this(new Idea67026Config());
    }

    public Idea67026Service(Idea67026Config config) {
        this.config = config != null ? config : new Idea67026Config();
