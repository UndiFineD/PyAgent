...
@Data
public class Idea67033Config {
    private String name = "idea_067033";
 ...
 */
@Slf4j
public class Idea67033Service {
    private static final int IDEA_ID = 67033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67033Service() {
        this(new Idea67033Config());
    }

    public Idea67033Service(Idea67033Config config) {
        this.config = config != null ? config : new Idea67033Config();
