...
@Data
public class Idea67317Config {
    private String name = "idea_067317";
 ...
 */
@Slf4j
public class Idea67317Service {
    private static final int IDEA_ID = 67317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67317Service() {
        this(new Idea67317Config());
    }

    public Idea67317Service(Idea67317Config config) {
        this.config = config != null ? config : new Idea67317Config();
