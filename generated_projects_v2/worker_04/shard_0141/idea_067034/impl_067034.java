...
@Data
public class Idea67034Config {
    private String name = "idea_067034";
 ...
 */
@Slf4j
public class Idea67034Service {
    private static final int IDEA_ID = 67034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67034Service() {
        this(new Idea67034Config());
    }

    public Idea67034Service(Idea67034Config config) {
        this.config = config != null ? config : new Idea67034Config();
