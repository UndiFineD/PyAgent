...
@Data
public class Idea67356Config {
    private String name = "idea_067356";
 ...
 */
@Slf4j
public class Idea67356Service {
    private static final int IDEA_ID = 67356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67356Service() {
        this(new Idea67356Config());
    }

    public Idea67356Service(Idea67356Config config) {
        this.config = config != null ? config : new Idea67356Config();
