...
@Data
public class Idea67205Config {
    private String name = "idea_067205";
 ...
 */
@Slf4j
public class Idea67205Service {
    private static final int IDEA_ID = 67205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67205Service() {
        this(new Idea67205Config());
    }

    public Idea67205Service(Idea67205Config config) {
        this.config = config != null ? config : new Idea67205Config();
