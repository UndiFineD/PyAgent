...
@Data
public class Idea67090Config {
    private String name = "idea_067090";
 ...
 */
@Slf4j
public class Idea67090Service {
    private static final int IDEA_ID = 67090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67090Service() {
        this(new Idea67090Config());
    }

    public Idea67090Service(Idea67090Config config) {
        this.config = config != null ? config : new Idea67090Config();
