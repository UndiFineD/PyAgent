...
@Data
public class Idea67008Config {
    private String name = "idea_067008";
 ...
 */
@Slf4j
public class Idea67008Service {
    private static final int IDEA_ID = 67008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67008Service() {
        this(new Idea67008Config());
    }

    public Idea67008Service(Idea67008Config config) {
        this.config = config != null ? config : new Idea67008Config();
