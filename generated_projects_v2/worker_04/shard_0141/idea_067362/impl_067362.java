...
@Data
public class Idea67362Config {
    private String name = "idea_067362";
 ...
 */
@Slf4j
public class Idea67362Service {
    private static final int IDEA_ID = 67362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67362Service() {
        this(new Idea67362Config());
    }

    public Idea67362Service(Idea67362Config config) {
        this.config = config != null ? config : new Idea67362Config();
