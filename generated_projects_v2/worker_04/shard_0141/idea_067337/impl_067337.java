...
@Data
public class Idea67337Config {
    private String name = "idea_067337";
 ...
 */
@Slf4j
public class Idea67337Service {
    private static final int IDEA_ID = 67337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67337Service() {
        this(new Idea67337Config());
    }

    public Idea67337Service(Idea67337Config config) {
        this.config = config != null ? config : new Idea67337Config();
