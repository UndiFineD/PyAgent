...
@Data
public class Idea67338Config {
    private String name = "idea_067338";
 ...
 */
@Slf4j
public class Idea67338Service {
    private static final int IDEA_ID = 67338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67338Service() {
        this(new Idea67338Config());
    }

    public Idea67338Service(Idea67338Config config) {
        this.config = config != null ? config : new Idea67338Config();
