...
@Data
public class Idea67266Config {
    private String name = "idea_067266";
 ...
 */
@Slf4j
public class Idea67266Service {
    private static final int IDEA_ID = 67266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67266Service() {
        this(new Idea67266Config());
    }

    public Idea67266Service(Idea67266Config config) {
        this.config = config != null ? config : new Idea67266Config();
