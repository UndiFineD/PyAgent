...
@Data
public class Idea67382Config {
    private String name = "idea_067382";
 ...
 */
@Slf4j
public class Idea67382Service {
    private static final int IDEA_ID = 67382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67382Service() {
        this(new Idea67382Config());
    }

    public Idea67382Service(Idea67382Config config) {
        this.config = config != null ? config : new Idea67382Config();
