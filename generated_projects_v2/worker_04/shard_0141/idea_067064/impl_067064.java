...
@Data
public class Idea67064Config {
    private String name = "idea_067064";
 ...
 */
@Slf4j
public class Idea67064Service {
    private static final int IDEA_ID = 67064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67064Service() {
        this(new Idea67064Config());
    }

    public Idea67064Service(Idea67064Config config) {
        this.config = config != null ? config : new Idea67064Config();
