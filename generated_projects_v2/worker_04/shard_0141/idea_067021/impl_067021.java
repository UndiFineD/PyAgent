...
@Data
public class Idea67021Config {
    private String name = "idea_067021";
 ...
 */
@Slf4j
public class Idea67021Service {
    private static final int IDEA_ID = 67021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67021Service() {
        this(new Idea67021Config());
    }

    public Idea67021Service(Idea67021Config config) {
        this.config = config != null ? config : new Idea67021Config();
