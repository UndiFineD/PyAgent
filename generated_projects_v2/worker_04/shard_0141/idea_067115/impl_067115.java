...
@Data
public class Idea67115Config {
    private String name = "idea_067115";
 ...
 */
@Slf4j
public class Idea67115Service {
    private static final int IDEA_ID = 67115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67115Service() {
        this(new Idea67115Config());
    }

    public Idea67115Service(Idea67115Config config) {
        this.config = config != null ? config : new Idea67115Config();
