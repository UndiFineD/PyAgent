...
@Data
public class Idea66990Config {
    private String name = "idea_066990";
 ...
 */
@Slf4j
public class Idea66990Service {
    private static final int IDEA_ID = 66990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66990Service() {
        this(new Idea66990Config());
    }

    public Idea66990Service(Idea66990Config config) {
        this.config = config != null ? config : new Idea66990Config();
