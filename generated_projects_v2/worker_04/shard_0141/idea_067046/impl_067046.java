...
@Data
public class Idea67046Config {
    private String name = "idea_067046";
 ...
 */
@Slf4j
public class Idea67046Service {
    private static final int IDEA_ID = 67046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67046Service() {
        this(new Idea67046Config());
    }

    public Idea67046Service(Idea67046Config config) {
        this.config = config != null ? config : new Idea67046Config();
