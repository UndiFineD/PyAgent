...
@Data
public class Idea67360Config {
    private String name = "idea_067360";
 ...
 */
@Slf4j
public class Idea67360Service {
    private static final int IDEA_ID = 67360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67360Service() {
        this(new Idea67360Config());
    }

    public Idea67360Service(Idea67360Config config) {
        this.config = config != null ? config : new Idea67360Config();
