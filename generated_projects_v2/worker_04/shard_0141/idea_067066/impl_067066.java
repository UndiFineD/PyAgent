...
@Data
public class Idea67066Config {
    private String name = "idea_067066";
 ...
 */
@Slf4j
public class Idea67066Service {
    private static final int IDEA_ID = 67066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67066Service() {
        this(new Idea67066Config());
    }

    public Idea67066Service(Idea67066Config config) {
        this.config = config != null ? config : new Idea67066Config();
