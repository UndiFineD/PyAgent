...
@Data
public class Idea67053Config {
    private String name = "idea_067053";
 ...
 */
@Slf4j
public class Idea67053Service {
    private static final int IDEA_ID = 67053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67053Service() {
        this(new Idea67053Config());
    }

    public Idea67053Service(Idea67053Config config) {
        this.config = config != null ? config : new Idea67053Config();
