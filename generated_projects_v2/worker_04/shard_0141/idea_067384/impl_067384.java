...
@Data
public class Idea67384Config {
    private String name = "idea_067384";
 ...
 */
@Slf4j
public class Idea67384Service {
    private static final int IDEA_ID = 67384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67384Service() {
        this(new Idea67384Config());
    }

    public Idea67384Service(Idea67384Config config) {
        this.config = config != null ? config : new Idea67384Config();
