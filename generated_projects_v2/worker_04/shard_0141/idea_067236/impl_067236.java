...
@Data
public class Idea67236Config {
    private String name = "idea_067236";
 ...
 */
@Slf4j
public class Idea67236Service {
    private static final int IDEA_ID = 67236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67236Service() {
        this(new Idea67236Config());
    }

    public Idea67236Service(Idea67236Config config) {
        this.config = config != null ? config : new Idea67236Config();
