...
@Data
public class Idea67323Config {
    private String name = "idea_067323";
 ...
 */
@Slf4j
public class Idea67323Service {
    private static final int IDEA_ID = 67323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67323Service() {
        this(new Idea67323Config());
    }

    public Idea67323Service(Idea67323Config config) {
        this.config = config != null ? config : new Idea67323Config();
