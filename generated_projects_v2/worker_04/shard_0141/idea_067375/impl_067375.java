...
@Data
public class Idea67375Config {
    private String name = "idea_067375";
 ...
 */
@Slf4j
public class Idea67375Service {
    private static final int IDEA_ID = 67375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67375Service() {
        this(new Idea67375Config());
    }

    public Idea67375Service(Idea67375Config config) {
        this.config = config != null ? config : new Idea67375Config();
