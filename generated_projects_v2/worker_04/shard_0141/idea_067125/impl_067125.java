...
@Data
public class Idea67125Config {
    private String name = "idea_067125";
 ...
 */
@Slf4j
public class Idea67125Service {
    private static final int IDEA_ID = 67125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67125Service() {
        this(new Idea67125Config());
    }

    public Idea67125Service(Idea67125Config config) {
        this.config = config != null ? config : new Idea67125Config();
