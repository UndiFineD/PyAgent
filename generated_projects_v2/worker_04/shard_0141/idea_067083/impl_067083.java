...
@Data
public class Idea67083Config {
    private String name = "idea_067083";
 ...
 */
@Slf4j
public class Idea67083Service {
    private static final int IDEA_ID = 67083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67083Service() {
        this(new Idea67083Config());
    }

    public Idea67083Service(Idea67083Config config) {
        this.config = config != null ? config : new Idea67083Config();
