...
@Data
public class Idea67372Config {
    private String name = "idea_067372";
 ...
 */
@Slf4j
public class Idea67372Service {
    private static final int IDEA_ID = 67372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67372Service() {
        this(new Idea67372Config());
    }

    public Idea67372Service(Idea67372Config config) {
        this.config = config != null ? config : new Idea67372Config();
