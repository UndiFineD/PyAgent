...
@Data
public class Idea67215Config {
    private String name = "idea_067215";
 ...
 */
@Slf4j
public class Idea67215Service {
    private static final int IDEA_ID = 67215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67215Service() {
        this(new Idea67215Config());
    }

    public Idea67215Service(Idea67215Config config) {
        this.config = config != null ? config : new Idea67215Config();
