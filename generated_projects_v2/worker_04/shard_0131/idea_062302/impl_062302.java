...
@Data
public class Idea62302Config {
    private String name = "idea_062302";
 ...
 */
@Slf4j
public class Idea62302Service {
    private static final int IDEA_ID = 62302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62302Service() {
        this(new Idea62302Config());
    }

    public Idea62302Service(Idea62302Config config) {
        this.config = config != null ? config : new Idea62302Config();
