...
@Data
public class Idea62562Config {
    private String name = "idea_062562";
 ...
 */
@Slf4j
public class Idea62562Service {
    private static final int IDEA_ID = 62562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62562Service() {
        this(new Idea62562Config());
    }

    public Idea62562Service(Idea62562Config config) {
        this.config = config != null ? config : new Idea62562Config();
