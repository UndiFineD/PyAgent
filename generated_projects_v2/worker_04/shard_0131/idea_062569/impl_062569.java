...
@Data
public class Idea62569Config {
    private String name = "idea_062569";
 ...
 */
@Slf4j
public class Idea62569Service {
    private static final int IDEA_ID = 62569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62569Service() {
        this(new Idea62569Config());
    }

    public Idea62569Service(Idea62569Config config) {
        this.config = config != null ? config : new Idea62569Config();
