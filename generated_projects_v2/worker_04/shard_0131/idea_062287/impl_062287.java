...
@Data
public class Idea62287Config {
    private String name = "idea_062287";
 ...
 */
@Slf4j
public class Idea62287Service {
    private static final int IDEA_ID = 62287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62287Service() {
        this(new Idea62287Config());
    }

    public Idea62287Service(Idea62287Config config) {
        this.config = config != null ? config : new Idea62287Config();
