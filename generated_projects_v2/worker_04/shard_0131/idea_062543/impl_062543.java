...
@Data
public class Idea62543Config {
    private String name = "idea_062543";
 ...
 */
@Slf4j
public class Idea62543Service {
    private static final int IDEA_ID = 62543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62543Service() {
        this(new Idea62543Config());
    }

    public Idea62543Service(Idea62543Config config) {
        this.config = config != null ? config : new Idea62543Config();
