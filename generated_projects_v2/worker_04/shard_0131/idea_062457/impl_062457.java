...
@Data
public class Idea62457Config {
    private String name = "idea_062457";
 ...
 */
@Slf4j
public class Idea62457Service {
    private static final int IDEA_ID = 62457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62457Service() {
        this(new Idea62457Config());
    }

    public Idea62457Service(Idea62457Config config) {
        this.config = config != null ? config : new Idea62457Config();
