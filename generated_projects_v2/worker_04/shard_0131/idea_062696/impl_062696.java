...
@Data
public class Idea62696Config {
    private String name = "idea_062696";
 ...
 */
@Slf4j
public class Idea62696Service {
    private static final int IDEA_ID = 62696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62696Service() {
        this(new Idea62696Config());
    }

    public Idea62696Service(Idea62696Config config) {
        this.config = config != null ? config : new Idea62696Config();
