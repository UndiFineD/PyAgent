...
@Data
public class Idea62608Config {
    private String name = "idea_062608";
 ...
 */
@Slf4j
public class Idea62608Service {
    private static final int IDEA_ID = 62608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62608Service() {
        this(new Idea62608Config());
    }

    public Idea62608Service(Idea62608Config config) {
        this.config = config != null ? config : new Idea62608Config();
