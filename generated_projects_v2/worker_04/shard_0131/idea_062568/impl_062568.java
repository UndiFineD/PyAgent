...
@Data
public class Idea62568Config {
    private String name = "idea_062568";
 ...
 */
@Slf4j
public class Idea62568Service {
    private static final int IDEA_ID = 62568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62568Service() {
        this(new Idea62568Config());
    }

    public Idea62568Service(Idea62568Config config) {
        this.config = config != null ? config : new Idea62568Config();
