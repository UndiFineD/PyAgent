...
@Data
public class Idea62293Config {
    private String name = "idea_062293";
 ...
 */
@Slf4j
public class Idea62293Service {
    private static final int IDEA_ID = 62293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62293Service() {
        this(new Idea62293Config());
    }

    public Idea62293Service(Idea62293Config config) {
        this.config = config != null ? config : new Idea62293Config();
