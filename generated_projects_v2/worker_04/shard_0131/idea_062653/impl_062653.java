...
@Data
public class Idea62653Config {
    private String name = "idea_062653";
 ...
 */
@Slf4j
public class Idea62653Service {
    private static final int IDEA_ID = 62653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62653Service() {
        this(new Idea62653Config());
    }

    public Idea62653Service(Idea62653Config config) {
        this.config = config != null ? config : new Idea62653Config();
