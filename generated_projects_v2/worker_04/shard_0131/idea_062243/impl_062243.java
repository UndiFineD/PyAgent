...
@Data
public class Idea62243Config {
    private String name = "idea_062243";
 ...
 */
@Slf4j
public class Idea62243Service {
    private static final int IDEA_ID = 62243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62243Service() {
        this(new Idea62243Config());
    }

    public Idea62243Service(Idea62243Config config) {
        this.config = config != null ? config : new Idea62243Config();
