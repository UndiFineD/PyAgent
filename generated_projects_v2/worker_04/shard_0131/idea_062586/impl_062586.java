...
@Data
public class Idea62586Config {
    private String name = "idea_062586";
 ...
 */
@Slf4j
public class Idea62586Service {
    private static final int IDEA_ID = 62586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62586Service() {
        this(new Idea62586Config());
    }

    public Idea62586Service(Idea62586Config config) {
        this.config = config != null ? config : new Idea62586Config();
