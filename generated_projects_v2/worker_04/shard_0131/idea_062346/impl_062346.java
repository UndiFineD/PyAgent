...
@Data
public class Idea62346Config {
    private String name = "idea_062346";
 ...
 */
@Slf4j
public class Idea62346Service {
    private static final int IDEA_ID = 62346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62346Service() {
        this(new Idea62346Config());
    }

    public Idea62346Service(Idea62346Config config) {
        this.config = config != null ? config : new Idea62346Config();
