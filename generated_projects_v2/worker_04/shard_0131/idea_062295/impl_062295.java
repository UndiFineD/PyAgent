...
@Data
public class Idea62295Config {
    private String name = "idea_062295";
 ...
 */
@Slf4j
public class Idea62295Service {
    private static final int IDEA_ID = 62295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62295Service() {
        this(new Idea62295Config());
    }

    public Idea62295Service(Idea62295Config config) {
        this.config = config != null ? config : new Idea62295Config();
