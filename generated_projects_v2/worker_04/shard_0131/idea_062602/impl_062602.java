...
@Data
public class Idea62602Config {
    private String name = "idea_062602";
 ...
 */
@Slf4j
public class Idea62602Service {
    private static final int IDEA_ID = 62602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62602Service() {
        this(new Idea62602Config());
    }

    public Idea62602Service(Idea62602Config config) {
        this.config = config != null ? config : new Idea62602Config();
