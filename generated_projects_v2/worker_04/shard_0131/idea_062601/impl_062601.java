...
@Data
public class Idea62601Config {
    private String name = "idea_062601";
 ...
 */
@Slf4j
public class Idea62601Service {
    private static final int IDEA_ID = 62601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62601Service() {
        this(new Idea62601Config());
    }

    public Idea62601Service(Idea62601Config config) {
        this.config = config != null ? config : new Idea62601Config();
