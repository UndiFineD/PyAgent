...
@Data
public class Idea62453Config {
    private String name = "idea_062453";
 ...
 */
@Slf4j
public class Idea62453Service {
    private static final int IDEA_ID = 62453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62453Service() {
        this(new Idea62453Config());
    }

    public Idea62453Service(Idea62453Config config) {
        this.config = config != null ? config : new Idea62453Config();
