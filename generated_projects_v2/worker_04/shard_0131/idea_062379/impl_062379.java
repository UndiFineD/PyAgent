...
@Data
public class Idea62379Config {
    private String name = "idea_062379";
 ...
 */
@Slf4j
public class Idea62379Service {
    private static final int IDEA_ID = 62379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62379Service() {
        this(new Idea62379Config());
    }

    public Idea62379Service(Idea62379Config config) {
        this.config = config != null ? config : new Idea62379Config();
