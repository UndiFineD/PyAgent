...
@Data
public class Idea62648Config {
    private String name = "idea_062648";
 ...
 */
@Slf4j
public class Idea62648Service {
    private static final int IDEA_ID = 62648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62648Service() {
        this(new Idea62648Config());
    }

    public Idea62648Service(Idea62648Config config) {
        this.config = config != null ? config : new Idea62648Config();
