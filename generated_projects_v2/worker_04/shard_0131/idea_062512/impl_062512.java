...
@Data
public class Idea62512Config {
    private String name = "idea_062512";
 ...
 */
@Slf4j
public class Idea62512Service {
    private static final int IDEA_ID = 62512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62512Service() {
        this(new Idea62512Config());
    }

    public Idea62512Service(Idea62512Config config) {
        this.config = config != null ? config : new Idea62512Config();
