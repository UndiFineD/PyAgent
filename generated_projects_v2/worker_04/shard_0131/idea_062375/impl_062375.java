...
@Data
public class Idea62375Config {
    private String name = "idea_062375";
 ...
 */
@Slf4j
public class Idea62375Service {
    private static final int IDEA_ID = 62375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62375Service() {
        this(new Idea62375Config());
    }

    public Idea62375Service(Idea62375Config config) {
        this.config = config != null ? config : new Idea62375Config();
