...
@Data
public class Idea62627Config {
    private String name = "idea_062627";
 ...
 */
@Slf4j
public class Idea62627Service {
    private static final int IDEA_ID = 62627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62627Service() {
        this(new Idea62627Config());
    }

    public Idea62627Service(Idea62627Config config) {
        this.config = config != null ? config : new Idea62627Config();
