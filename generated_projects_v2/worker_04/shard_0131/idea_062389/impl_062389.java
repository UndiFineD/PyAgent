...
@Data
public class Idea62389Config {
    private String name = "idea_062389";
 ...
 */
@Slf4j
public class Idea62389Service {
    private static final int IDEA_ID = 62389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62389Service() {
        this(new Idea62389Config());
    }

    public Idea62389Service(Idea62389Config config) {
        this.config = config != null ? config : new Idea62389Config();
