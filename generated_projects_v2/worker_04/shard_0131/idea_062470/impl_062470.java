...
@Data
public class Idea62470Config {
    private String name = "idea_062470";
 ...
 */
@Slf4j
public class Idea62470Service {
    private static final int IDEA_ID = 62470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62470Service() {
        this(new Idea62470Config());
    }

    public Idea62470Service(Idea62470Config config) {
        this.config = config != null ? config : new Idea62470Config();
