...
@Data
public class Idea62637Config {
    private String name = "idea_062637";
 ...
 */
@Slf4j
public class Idea62637Service {
    private static final int IDEA_ID = 62637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62637Service() {
        this(new Idea62637Config());
    }

    public Idea62637Service(Idea62637Config config) {
        this.config = config != null ? config : new Idea62637Config();
