...
@Data
public class Idea62664Config {
    private String name = "idea_062664";
 ...
 */
@Slf4j
public class Idea62664Service {
    private static final int IDEA_ID = 62664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62664Service() {
        this(new Idea62664Config());
    }

    public Idea62664Service(Idea62664Config config) {
        this.config = config != null ? config : new Idea62664Config();
