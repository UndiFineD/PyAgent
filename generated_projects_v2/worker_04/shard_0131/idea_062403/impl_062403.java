...
@Data
public class Idea62403Config {
    private String name = "idea_062403";
 ...
 */
@Slf4j
public class Idea62403Service {
    private static final int IDEA_ID = 62403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62403Service() {
        this(new Idea62403Config());
    }

    public Idea62403Service(Idea62403Config config) {
        this.config = config != null ? config : new Idea62403Config();
