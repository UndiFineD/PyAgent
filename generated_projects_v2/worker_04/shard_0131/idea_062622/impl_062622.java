...
@Data
public class Idea62622Config {
    private String name = "idea_062622";
 ...
 */
@Slf4j
public class Idea62622Service {
    private static final int IDEA_ID = 62622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62622Service() {
        this(new Idea62622Config());
    }

    public Idea62622Service(Idea62622Config config) {
        this.config = config != null ? config : new Idea62622Config();
