...
@Data
public class Idea62429Config {
    private String name = "idea_062429";
 ...
 */
@Slf4j
public class Idea62429Service {
    private static final int IDEA_ID = 62429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62429Service() {
        this(new Idea62429Config());
    }

    public Idea62429Service(Idea62429Config config) {
        this.config = config != null ? config : new Idea62429Config();
