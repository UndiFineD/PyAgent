...
@Data
public class Idea62275Config {
    private String name = "idea_062275";
 ...
 */
@Slf4j
public class Idea62275Service {
    private static final int IDEA_ID = 62275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62275Service() {
        this(new Idea62275Config());
    }

    public Idea62275Service(Idea62275Config config) {
        this.config = config != null ? config : new Idea62275Config();
