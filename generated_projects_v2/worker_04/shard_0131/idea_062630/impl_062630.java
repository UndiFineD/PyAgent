...
@Data
public class Idea62630Config {
    private String name = "idea_062630";
 ...
 */
@Slf4j
public class Idea62630Service {
    private static final int IDEA_ID = 62630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62630Service() {
        this(new Idea62630Config());
    }

    public Idea62630Service(Idea62630Config config) {
        this.config = config != null ? config : new Idea62630Config();
