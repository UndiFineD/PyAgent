...
@Data
public class Idea62528Config {
    private String name = "idea_062528";
 ...
 */
@Slf4j
public class Idea62528Service {
    private static final int IDEA_ID = 62528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62528Service() {
        this(new Idea62528Config());
    }

    public Idea62528Service(Idea62528Config config) {
        this.config = config != null ? config : new Idea62528Config();
