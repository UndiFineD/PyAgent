...
@Data
public class Idea62480Config {
    private String name = "idea_062480";
 ...
 */
@Slf4j
public class Idea62480Service {
    private static final int IDEA_ID = 62480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62480Service() {
        this(new Idea62480Config());
    }

    public Idea62480Service(Idea62480Config config) {
        this.config = config != null ? config : new Idea62480Config();
