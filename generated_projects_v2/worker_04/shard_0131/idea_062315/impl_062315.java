...
@Data
public class Idea62315Config {
    private String name = "idea_062315";
 ...
 */
@Slf4j
public class Idea62315Service {
    private static final int IDEA_ID = 62315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62315Service() {
        this(new Idea62315Config());
    }

    public Idea62315Service(Idea62315Config config) {
        this.config = config != null ? config : new Idea62315Config();
