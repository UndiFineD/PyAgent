...
@Data
public class Idea62474Config {
    private String name = "idea_062474";
 ...
 */
@Slf4j
public class Idea62474Service {
    private static final int IDEA_ID = 62474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62474Service() {
        this(new Idea62474Config());
    }

    public Idea62474Service(Idea62474Config config) {
        this.config = config != null ? config : new Idea62474Config();
