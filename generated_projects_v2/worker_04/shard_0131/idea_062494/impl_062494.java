...
@Data
public class Idea62494Config {
    private String name = "idea_062494";
 ...
 */
@Slf4j
public class Idea62494Service {
    private static final int IDEA_ID = 62494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62494Service() {
        this(new Idea62494Config());
    }

    public Idea62494Service(Idea62494Config config) {
        this.config = config != null ? config : new Idea62494Config();
