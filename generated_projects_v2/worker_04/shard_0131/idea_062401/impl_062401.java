...
@Data
public class Idea62401Config {
    private String name = "idea_062401";
 ...
 */
@Slf4j
public class Idea62401Service {
    private static final int IDEA_ID = 62401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62401Service() {
        this(new Idea62401Config());
    }

    public Idea62401Service(Idea62401Config config) {
        this.config = config != null ? config : new Idea62401Config();
