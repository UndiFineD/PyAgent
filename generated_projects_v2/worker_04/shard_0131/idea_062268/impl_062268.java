...
@Data
public class Idea62268Config {
    private String name = "idea_062268";
 ...
 */
@Slf4j
public class Idea62268Service {
    private static final int IDEA_ID = 62268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62268Service() {
        this(new Idea62268Config());
    }

    public Idea62268Service(Idea62268Config config) {
        this.config = config != null ? config : new Idea62268Config();
