...
@Data
public class Idea62609Config {
    private String name = "idea_062609";
 ...
 */
@Slf4j
public class Idea62609Service {
    private static final int IDEA_ID = 62609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62609Service() {
        this(new Idea62609Config());
    }

    public Idea62609Service(Idea62609Config config) {
        this.config = config != null ? config : new Idea62609Config();
