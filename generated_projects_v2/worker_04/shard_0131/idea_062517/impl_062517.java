...
@Data
public class Idea62517Config {
    private String name = "idea_062517";
 ...
 */
@Slf4j
public class Idea62517Service {
    private static final int IDEA_ID = 62517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62517Service() {
        this(new Idea62517Config());
    }

    public Idea62517Service(Idea62517Config config) {
        this.config = config != null ? config : new Idea62517Config();
