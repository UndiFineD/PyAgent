...
@Data
public class Idea62327Config {
    private String name = "idea_062327";
 ...
 */
@Slf4j
public class Idea62327Service {
    private static final int IDEA_ID = 62327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62327Service() {
        this(new Idea62327Config());
    }

    public Idea62327Service(Idea62327Config config) {
        this.config = config != null ? config : new Idea62327Config();
