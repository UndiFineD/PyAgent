...
@Data
public class Idea62235Config {
    private String name = "idea_062235";
 ...
 */
@Slf4j
public class Idea62235Service {
    private static final int IDEA_ID = 62235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62235Service() {
        this(new Idea62235Config());
    }

    public Idea62235Service(Idea62235Config config) {
        this.config = config != null ? config : new Idea62235Config();
