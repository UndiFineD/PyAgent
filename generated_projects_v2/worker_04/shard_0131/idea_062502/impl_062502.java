...
@Data
public class Idea62502Config {
    private String name = "idea_062502";
 ...
 */
@Slf4j
public class Idea62502Service {
    private static final int IDEA_ID = 62502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62502Service() {
        this(new Idea62502Config());
    }

    public Idea62502Service(Idea62502Config config) {
        this.config = config != null ? config : new Idea62502Config();
