...
@Data
public class Idea62677Config {
    private String name = "idea_062677";
 ...
 */
@Slf4j
public class Idea62677Service {
    private static final int IDEA_ID = 62677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62677Service() {
        this(new Idea62677Config());
    }

    public Idea62677Service(Idea62677Config config) {
        this.config = config != null ? config : new Idea62677Config();
