...
@Data
public class Idea62301Config {
    private String name = "idea_062301";
 ...
 */
@Slf4j
public class Idea62301Service {
    private static final int IDEA_ID = 62301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62301Service() {
        this(new Idea62301Config());
    }

    public Idea62301Service(Idea62301Config config) {
        this.config = config != null ? config : new Idea62301Config();
