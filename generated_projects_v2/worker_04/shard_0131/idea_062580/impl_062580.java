...
@Data
public class Idea62580Config {
    private String name = "idea_062580";
 ...
 */
@Slf4j
public class Idea62580Service {
    private static final int IDEA_ID = 62580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62580Service() {
        this(new Idea62580Config());
    }

    public Idea62580Service(Idea62580Config config) {
        this.config = config != null ? config : new Idea62580Config();
