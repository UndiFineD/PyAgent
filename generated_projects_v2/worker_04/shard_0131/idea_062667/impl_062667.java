...
@Data
public class Idea62667Config {
    private String name = "idea_062667";
 ...
 */
@Slf4j
public class Idea62667Service {
    private static final int IDEA_ID = 62667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62667Service() {
        this(new Idea62667Config());
    }

    public Idea62667Service(Idea62667Config config) {
        this.config = config != null ? config : new Idea62667Config();
