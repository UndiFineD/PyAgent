...
@Data
public class Idea62541Config {
    private String name = "idea_062541";
 ...
 */
@Slf4j
public class Idea62541Service {
    private static final int IDEA_ID = 62541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62541Service() {
        this(new Idea62541Config());
    }

    public Idea62541Service(Idea62541Config config) {
        this.config = config != null ? config : new Idea62541Config();
