...
@Data
public class Idea62521Config {
    private String name = "idea_062521";
 ...
 */
@Slf4j
public class Idea62521Service {
    private static final int IDEA_ID = 62521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62521Service() {
        this(new Idea62521Config());
    }

    public Idea62521Service(Idea62521Config config) {
        this.config = config != null ? config : new Idea62521Config();
