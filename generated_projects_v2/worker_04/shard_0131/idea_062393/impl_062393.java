...
@Data
public class Idea62393Config {
    private String name = "idea_062393";
 ...
 */
@Slf4j
public class Idea62393Service {
    private static final int IDEA_ID = 62393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62393Service() {
        this(new Idea62393Config());
    }

    public Idea62393Service(Idea62393Config config) {
        this.config = config != null ? config : new Idea62393Config();
