...
@Data
public class Idea62333Config {
    private String name = "idea_062333";
 ...
 */
@Slf4j
public class Idea62333Service {
    private static final int IDEA_ID = 62333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62333Service() {
        this(new Idea62333Config());
    }

    public Idea62333Service(Idea62333Config config) {
        this.config = config != null ? config : new Idea62333Config();
