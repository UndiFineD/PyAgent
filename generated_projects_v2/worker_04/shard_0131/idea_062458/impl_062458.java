...
@Data
public class Idea62458Config {
    private String name = "idea_062458";
 ...
 */
@Slf4j
public class Idea62458Service {
    private static final int IDEA_ID = 62458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62458Service() {
        this(new Idea62458Config());
    }

    public Idea62458Service(Idea62458Config config) {
        this.config = config != null ? config : new Idea62458Config();
