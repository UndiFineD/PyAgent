...
@Data
public class Idea62406Config {
    private String name = "idea_062406";
 ...
 */
@Slf4j
public class Idea62406Service {
    private static final int IDEA_ID = 62406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62406Service() {
        this(new Idea62406Config());
    }

    public Idea62406Service(Idea62406Config config) {
        this.config = config != null ? config : new Idea62406Config();
