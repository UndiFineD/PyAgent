...
@Data
public class Idea62323Config {
    private String name = "idea_062323";
 ...
 */
@Slf4j
public class Idea62323Service {
    private static final int IDEA_ID = 62323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62323Service() {
        this(new Idea62323Config());
    }

    public Idea62323Service(Idea62323Config config) {
        this.config = config != null ? config : new Idea62323Config();
