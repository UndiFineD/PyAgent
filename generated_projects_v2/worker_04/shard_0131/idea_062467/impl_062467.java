...
@Data
public class Idea62467Config {
    private String name = "idea_062467";
 ...
 */
@Slf4j
public class Idea62467Service {
    private static final int IDEA_ID = 62467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62467Service() {
        this(new Idea62467Config());
    }

    public Idea62467Service(Idea62467Config config) {
        this.config = config != null ? config : new Idea62467Config();
