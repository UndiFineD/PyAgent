...
@Data
public class Idea62618Config {
    private String name = "idea_062618";
 ...
 */
@Slf4j
public class Idea62618Service {
    private static final int IDEA_ID = 62618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62618Service() {
        this(new Idea62618Config());
    }

    public Idea62618Service(Idea62618Config config) {
        this.config = config != null ? config : new Idea62618Config();
