...
@Data
public class Idea62492Config {
    private String name = "idea_062492";
 ...
 */
@Slf4j
public class Idea62492Service {
    private static final int IDEA_ID = 62492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62492Service() {
        this(new Idea62492Config());
    }

    public Idea62492Service(Idea62492Config config) {
        this.config = config != null ? config : new Idea62492Config();
