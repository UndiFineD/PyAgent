...
@Data
public class Idea62349Config {
    private String name = "idea_062349";
 ...
 */
@Slf4j
public class Idea62349Service {
    private static final int IDEA_ID = 62349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62349Service() {
        this(new Idea62349Config());
    }

    public Idea62349Service(Idea62349Config config) {
        this.config = config != null ? config : new Idea62349Config();
