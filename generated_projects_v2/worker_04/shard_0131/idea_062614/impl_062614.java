...
@Data
public class Idea62614Config {
    private String name = "idea_062614";
 ...
 */
@Slf4j
public class Idea62614Service {
    private static final int IDEA_ID = 62614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62614Service() {
        this(new Idea62614Config());
    }

    public Idea62614Service(Idea62614Config config) {
        this.config = config != null ? config : new Idea62614Config();
