...
@Data
public class Idea62308Config {
    private String name = "idea_062308";
 ...
 */
@Slf4j
public class Idea62308Service {
    private static final int IDEA_ID = 62308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62308Service() {
        this(new Idea62308Config());
    }

    public Idea62308Service(Idea62308Config config) {
        this.config = config != null ? config : new Idea62308Config();
