...
@Data
public class Idea62679Config {
    private String name = "idea_062679";
 ...
 */
@Slf4j
public class Idea62679Service {
    private static final int IDEA_ID = 62679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62679Service() {
        this(new Idea62679Config());
    }

    public Idea62679Service(Idea62679Config config) {
        this.config = config != null ? config : new Idea62679Config();
