...
@Data
public class Idea62498Config {
    private String name = "idea_062498";
 ...
 */
@Slf4j
public class Idea62498Service {
    private static final int IDEA_ID = 62498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62498Service() {
        this(new Idea62498Config());
    }

    public Idea62498Service(Idea62498Config config) {
        this.config = config != null ? config : new Idea62498Config();
