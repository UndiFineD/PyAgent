...
@Data
public class Idea62579Config {
    private String name = "idea_062579";
 ...
 */
@Slf4j
public class Idea62579Service {
    private static final int IDEA_ID = 62579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62579Service() {
        this(new Idea62579Config());
    }

    public Idea62579Service(Idea62579Config config) {
        this.config = config != null ? config : new Idea62579Config();
