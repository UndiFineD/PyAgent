...
@Data
public class Idea62339Config {
    private String name = "idea_062339";
 ...
 */
@Slf4j
public class Idea62339Service {
    private static final int IDEA_ID = 62339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62339Service() {
        this(new Idea62339Config());
    }

    public Idea62339Service(Idea62339Config config) {
        this.config = config != null ? config : new Idea62339Config();
