...
@Data
public class Idea62504Config {
    private String name = "idea_062504";
 ...
 */
@Slf4j
public class Idea62504Service {
    private static final int IDEA_ID = 62504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62504Service() {
        this(new Idea62504Config());
    }

    public Idea62504Service(Idea62504Config config) {
        this.config = config != null ? config : new Idea62504Config();
