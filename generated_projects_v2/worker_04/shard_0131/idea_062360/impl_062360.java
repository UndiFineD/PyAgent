...
@Data
public class Idea62360Config {
    private String name = "idea_062360";
 ...
 */
@Slf4j
public class Idea62360Service {
    private static final int IDEA_ID = 62360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62360Service() {
        this(new Idea62360Config());
    }

    public Idea62360Service(Idea62360Config config) {
        this.config = config != null ? config : new Idea62360Config();
