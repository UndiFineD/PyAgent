...
@Data
public class Idea62526Config {
    private String name = "idea_062526";
 ...
 */
@Slf4j
public class Idea62526Service {
    private static final int IDEA_ID = 62526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62526Service() {
        this(new Idea62526Config());
    }

    public Idea62526Service(Idea62526Config config) {
        this.config = config != null ? config : new Idea62526Config();
