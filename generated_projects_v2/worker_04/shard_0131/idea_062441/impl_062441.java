...
@Data
public class Idea62441Config {
    private String name = "idea_062441";
 ...
 */
@Slf4j
public class Idea62441Service {
    private static final int IDEA_ID = 62441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62441Service() {
        this(new Idea62441Config());
    }

    public Idea62441Service(Idea62441Config config) {
        this.config = config != null ? config : new Idea62441Config();
