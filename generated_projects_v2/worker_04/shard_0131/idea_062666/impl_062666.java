...
@Data
public class Idea62666Config {
    private String name = "idea_062666";
 ...
 */
@Slf4j
public class Idea62666Service {
    private static final int IDEA_ID = 62666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62666Service() {
        this(new Idea62666Config());
    }

    public Idea62666Service(Idea62666Config config) {
        this.config = config != null ? config : new Idea62666Config();
