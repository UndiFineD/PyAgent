...
@Data
public class Idea62649Config {
    private String name = "idea_062649";
 ...
 */
@Slf4j
public class Idea62649Service {
    private static final int IDEA_ID = 62649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62649Service() {
        this(new Idea62649Config());
    }

    public Idea62649Service(Idea62649Config config) {
        this.config = config != null ? config : new Idea62649Config();
