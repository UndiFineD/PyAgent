...
@Data
public class Idea62361Config {
    private String name = "idea_062361";
 ...
 */
@Slf4j
public class Idea62361Service {
    private static final int IDEA_ID = 62361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62361Service() {
        this(new Idea62361Config());
    }

    public Idea62361Service(Idea62361Config config) {
        this.config = config != null ? config : new Idea62361Config();
