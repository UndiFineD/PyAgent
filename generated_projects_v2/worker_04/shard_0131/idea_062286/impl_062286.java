...
@Data
public class Idea62286Config {
    private String name = "idea_062286";
 ...
 */
@Slf4j
public class Idea62286Service {
    private static final int IDEA_ID = 62286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62286Service() {
        this(new Idea62286Config());
    }

    public Idea62286Service(Idea62286Config config) {
        this.config = config != null ? config : new Idea62286Config();
