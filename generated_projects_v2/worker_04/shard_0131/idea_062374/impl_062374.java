...
@Data
public class Idea62374Config {
    private String name = "idea_062374";
 ...
 */
@Slf4j
public class Idea62374Service {
    private static final int IDEA_ID = 62374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62374Service() {
        this(new Idea62374Config());
    }

    public Idea62374Service(Idea62374Config config) {
        this.config = config != null ? config : new Idea62374Config();
