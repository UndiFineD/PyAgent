...
@Data
public class Idea62555Config {
    private String name = "idea_062555";
 ...
 */
@Slf4j
public class Idea62555Service {
    private static final int IDEA_ID = 62555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62555Service() {
        this(new Idea62555Config());
    }

    public Idea62555Service(Idea62555Config config) {
        this.config = config != null ? config : new Idea62555Config();
