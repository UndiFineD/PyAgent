...
@Data
public class Idea62633Config {
    private String name = "idea_062633";
 ...
 */
@Slf4j
public class Idea62633Service {
    private static final int IDEA_ID = 62633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62633Service() {
        this(new Idea62633Config());
    }

    public Idea62633Service(Idea62633Config config) {
        this.config = config != null ? config : new Idea62633Config();
