...
@Data
public class Idea62422Config {
    private String name = "idea_062422";
 ...
 */
@Slf4j
public class Idea62422Service {
    private static final int IDEA_ID = 62422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62422Service() {
        this(new Idea62422Config());
    }

    public Idea62422Service(Idea62422Config config) {
        this.config = config != null ? config : new Idea62422Config();
