...
@Data
public class Idea62599Config {
    private String name = "idea_062599";
 ...
 */
@Slf4j
public class Idea62599Service {
    private static final int IDEA_ID = 62599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62599Service() {
        this(new Idea62599Config());
    }

    public Idea62599Service(Idea62599Config config) {
        this.config = config != null ? config : new Idea62599Config();
