...
@Data
public class Idea62352Config {
    private String name = "idea_062352";
 ...
 */
@Slf4j
public class Idea62352Service {
    private static final int IDEA_ID = 62352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62352Service() {
        this(new Idea62352Config());
    }

    public Idea62352Service(Idea62352Config config) {
        this.config = config != null ? config : new Idea62352Config();
