...
@Data
public class Idea62348Config {
    private String name = "idea_062348";
 ...
 */
@Slf4j
public class Idea62348Service {
    private static final int IDEA_ID = 62348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62348Service() {
        this(new Idea62348Config());
    }

    public Idea62348Service(Idea62348Config config) {
        this.config = config != null ? config : new Idea62348Config();
