...
@Data
public class Idea62511Config {
    private String name = "idea_062511";
 ...
 */
@Slf4j
public class Idea62511Service {
    private static final int IDEA_ID = 62511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62511Service() {
        this(new Idea62511Config());
    }

    public Idea62511Service(Idea62511Config config) {
        this.config = config != null ? config : new Idea62511Config();
