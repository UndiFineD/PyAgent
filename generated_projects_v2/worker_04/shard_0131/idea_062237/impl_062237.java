...
@Data
public class Idea62237Config {
    private String name = "idea_062237";
 ...
 */
@Slf4j
public class Idea62237Service {
    private static final int IDEA_ID = 62237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62237Service() {
        this(new Idea62237Config());
    }

    public Idea62237Service(Idea62237Config config) {
        this.config = config != null ? config : new Idea62237Config();
