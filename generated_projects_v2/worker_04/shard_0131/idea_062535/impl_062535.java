...
@Data
public class Idea62535Config {
    private String name = "idea_062535";
 ...
 */
@Slf4j
public class Idea62535Service {
    private static final int IDEA_ID = 62535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62535Service() {
        this(new Idea62535Config());
    }

    public Idea62535Service(Idea62535Config config) {
        this.config = config != null ? config : new Idea62535Config();
