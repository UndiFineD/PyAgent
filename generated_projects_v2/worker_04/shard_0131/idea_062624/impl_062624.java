...
@Data
public class Idea62624Config {
    private String name = "idea_062624";
 ...
 */
@Slf4j
public class Idea62624Service {
    private static final int IDEA_ID = 62624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62624Service() {
        this(new Idea62624Config());
    }

    public Idea62624Service(Idea62624Config config) {
        this.config = config != null ? config : new Idea62624Config();
