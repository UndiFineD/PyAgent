...
@Data
public class Idea62317Config {
    private String name = "idea_062317";
 ...
 */
@Slf4j
public class Idea62317Service {
    private static final int IDEA_ID = 62317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62317Service() {
        this(new Idea62317Config());
    }

    public Idea62317Service(Idea62317Config config) {
        this.config = config != null ? config : new Idea62317Config();
