...
@Data
public class Idea62270Config {
    private String name = "idea_062270";
 ...
 */
@Slf4j
public class Idea62270Service {
    private static final int IDEA_ID = 62270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62270Service() {
        this(new Idea62270Config());
    }

    public Idea62270Service(Idea62270Config config) {
        this.config = config != null ? config : new Idea62270Config();
