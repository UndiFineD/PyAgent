...
@Data
public class Idea62556Config {
    private String name = "idea_062556";
 ...
 */
@Slf4j
public class Idea62556Service {
    private static final int IDEA_ID = 62556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62556Service() {
        this(new Idea62556Config());
    }

    public Idea62556Service(Idea62556Config config) {
        this.config = config != null ? config : new Idea62556Config();
