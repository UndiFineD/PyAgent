...
@Data
public class Idea62665Config {
    private String name = "idea_062665";
 ...
 */
@Slf4j
public class Idea62665Service {
    private static final int IDEA_ID = 62665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62665Service() {
        this(new Idea62665Config());
    }

    public Idea62665Service(Idea62665Config config) {
        this.config = config != null ? config : new Idea62665Config();
