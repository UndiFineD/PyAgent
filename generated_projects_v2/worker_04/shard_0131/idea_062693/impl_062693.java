...
@Data
public class Idea62693Config {
    private String name = "idea_062693";
 ...
 */
@Slf4j
public class Idea62693Service {
    private static final int IDEA_ID = 62693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62693Service() {
        this(new Idea62693Config());
    }

    public Idea62693Service(Idea62693Config config) {
        this.config = config != null ? config : new Idea62693Config();
