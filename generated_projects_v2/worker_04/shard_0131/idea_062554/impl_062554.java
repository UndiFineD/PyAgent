...
@Data
public class Idea62554Config {
    private String name = "idea_062554";
 ...
 */
@Slf4j
public class Idea62554Service {
    private static final int IDEA_ID = 62554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62554Service() {
        this(new Idea62554Config());
    }

    public Idea62554Service(Idea62554Config config) {
        this.config = config != null ? config : new Idea62554Config();
