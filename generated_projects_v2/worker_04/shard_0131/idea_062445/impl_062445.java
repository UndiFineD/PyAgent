...
@Data
public class Idea62445Config {
    private String name = "idea_062445";
 ...
 */
@Slf4j
public class Idea62445Service {
    private static final int IDEA_ID = 62445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62445Service() {
        this(new Idea62445Config());
    }

    public Idea62445Service(Idea62445Config config) {
        this.config = config != null ? config : new Idea62445Config();
