...
@Data
public class Idea62276Config {
    private String name = "idea_062276";
 ...
 */
@Slf4j
public class Idea62276Service {
    private static final int IDEA_ID = 62276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62276Service() {
        this(new Idea62276Config());
    }

    public Idea62276Service(Idea62276Config config) {
        this.config = config != null ? config : new Idea62276Config();
