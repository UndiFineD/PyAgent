...
@Data
public class Idea62359Config {
    private String name = "idea_062359";
 ...
 */
@Slf4j
public class Idea62359Service {
    private static final int IDEA_ID = 62359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62359Service() {
        this(new Idea62359Config());
    }

    public Idea62359Service(Idea62359Config config) {
        this.config = config != null ? config : new Idea62359Config();
