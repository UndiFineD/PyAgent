...
@Data
public class Idea62245Config {
    private String name = "idea_062245";
 ...
 */
@Slf4j
public class Idea62245Service {
    private static final int IDEA_ID = 62245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62245Service() {
        this(new Idea62245Config());
    }

    public Idea62245Service(Idea62245Config config) {
        this.config = config != null ? config : new Idea62245Config();
