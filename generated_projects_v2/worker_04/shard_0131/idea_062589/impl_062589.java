...
@Data
public class Idea62589Config {
    private String name = "idea_062589";
 ...
 */
@Slf4j
public class Idea62589Service {
    private static final int IDEA_ID = 62589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62589Service() {
        this(new Idea62589Config());
    }

    public Idea62589Service(Idea62589Config config) {
        this.config = config != null ? config : new Idea62589Config();
