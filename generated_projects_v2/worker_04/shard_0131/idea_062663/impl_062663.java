...
@Data
public class Idea62663Config {
    private String name = "idea_062663";
 ...
 */
@Slf4j
public class Idea62663Service {
    private static final int IDEA_ID = 62663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62663Service() {
        this(new Idea62663Config());
    }

    public Idea62663Service(Idea62663Config config) {
        this.config = config != null ? config : new Idea62663Config();
