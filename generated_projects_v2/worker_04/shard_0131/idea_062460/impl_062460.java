...
@Data
public class Idea62460Config {
    private String name = "idea_062460";
 ...
 */
@Slf4j
public class Idea62460Service {
    private static final int IDEA_ID = 62460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62460Service() {
        this(new Idea62460Config());
    }

    public Idea62460Service(Idea62460Config config) {
        this.config = config != null ? config : new Idea62460Config();
