...
@Data
public class Idea62616Config {
    private String name = "idea_062616";
 ...
 */
@Slf4j
public class Idea62616Service {
    private static final int IDEA_ID = 62616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62616Service() {
        this(new Idea62616Config());
    }

    public Idea62616Service(Idea62616Config config) {
        this.config = config != null ? config : new Idea62616Config();
