...
@Data
public class Idea62576Config {
    private String name = "idea_062576";
 ...
 */
@Slf4j
public class Idea62576Service {
    private static final int IDEA_ID = 62576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62576Service() {
        this(new Idea62576Config());
    }

    public Idea62576Service(Idea62576Config config) {
        this.config = config != null ? config : new Idea62576Config();
