...
@Data
public class Idea62388Config {
    private String name = "idea_062388";
 ...
 */
@Slf4j
public class Idea62388Service {
    private static final int IDEA_ID = 62388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62388Service() {
        this(new Idea62388Config());
    }

    public Idea62388Service(Idea62388Config config) {
        this.config = config != null ? config : new Idea62388Config();
