...
@Data
public class Idea62500Config {
    private String name = "idea_062500";
 ...
 */
@Slf4j
public class Idea62500Service {
    private static final int IDEA_ID = 62500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62500Service() {
        this(new Idea62500Config());
    }

    public Idea62500Service(Idea62500Config config) {
        this.config = config != null ? config : new Idea62500Config();
