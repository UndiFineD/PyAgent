...
@Data
public class Idea62697Config {
    private String name = "idea_062697";
 ...
 */
@Slf4j
public class Idea62697Service {
    private static final int IDEA_ID = 62697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62697Service() {
        this(new Idea62697Config());
    }

    public Idea62697Service(Idea62697Config config) {
        this.config = config != null ? config : new Idea62697Config();
