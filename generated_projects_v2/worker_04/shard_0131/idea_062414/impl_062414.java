...
@Data
public class Idea62414Config {
    private String name = "idea_062414";
 ...
 */
@Slf4j
public class Idea62414Service {
    private static final int IDEA_ID = 62414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62414Service() {
        this(new Idea62414Config());
    }

    public Idea62414Service(Idea62414Config config) {
        this.config = config != null ? config : new Idea62414Config();
