...
@Data
public class Idea62472Config {
    private String name = "idea_062472";
 ...
 */
@Slf4j
public class Idea62472Service {
    private static final int IDEA_ID = 62472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62472Service() {
        this(new Idea62472Config());
    }

    public Idea62472Service(Idea62472Config config) {
        this.config = config != null ? config : new Idea62472Config();
