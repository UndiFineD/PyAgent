...
@Data
public class Idea62506Config {
    private String name = "idea_062506";
 ...
 */
@Slf4j
public class Idea62506Service {
    private static final int IDEA_ID = 62506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62506Service() {
        this(new Idea62506Config());
    }

    public Idea62506Service(Idea62506Config config) {
        this.config = config != null ? config : new Idea62506Config();
