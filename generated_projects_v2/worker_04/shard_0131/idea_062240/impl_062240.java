...
@Data
public class Idea62240Config {
    private String name = "idea_062240";
 ...
 */
@Slf4j
public class Idea62240Service {
    private static final int IDEA_ID = 62240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62240Service() {
        this(new Idea62240Config());
    }

    public Idea62240Service(Idea62240Config config) {
        this.config = config != null ? config : new Idea62240Config();
