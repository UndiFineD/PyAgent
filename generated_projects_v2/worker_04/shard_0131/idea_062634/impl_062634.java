...
@Data
public class Idea62634Config {
    private String name = "idea_062634";
 ...
 */
@Slf4j
public class Idea62634Service {
    private static final int IDEA_ID = 62634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62634Service() {
        this(new Idea62634Config());
    }

    public Idea62634Service(Idea62634Config config) {
        this.config = config != null ? config : new Idea62634Config();
