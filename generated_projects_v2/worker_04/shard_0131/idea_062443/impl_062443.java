...
@Data
public class Idea62443Config {
    private String name = "idea_062443";
 ...
 */
@Slf4j
public class Idea62443Service {
    private static final int IDEA_ID = 62443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62443Service() {
        this(new Idea62443Config());
    }

    public Idea62443Service(Idea62443Config config) {
        this.config = config != null ? config : new Idea62443Config();
