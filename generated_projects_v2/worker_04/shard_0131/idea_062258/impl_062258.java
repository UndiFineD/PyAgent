...
@Data
public class Idea62258Config {
    private String name = "idea_062258";
 ...
 */
@Slf4j
public class Idea62258Service {
    private static final int IDEA_ID = 62258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62258Service() {
        this(new Idea62258Config());
    }

    public Idea62258Service(Idea62258Config config) {
        this.config = config != null ? config : new Idea62258Config();
