...
@Data
public class Idea62250Config {
    private String name = "idea_062250";
 ...
 */
@Slf4j
public class Idea62250Service {
    private static final int IDEA_ID = 62250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62250Service() {
        this(new Idea62250Config());
    }

    public Idea62250Service(Idea62250Config config) {
        this.config = config != null ? config : new Idea62250Config();
