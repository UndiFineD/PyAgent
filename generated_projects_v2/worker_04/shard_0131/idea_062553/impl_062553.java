...
@Data
public class Idea62553Config {
    private String name = "idea_062553";
 ...
 */
@Slf4j
public class Idea62553Service {
    private static final int IDEA_ID = 62553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62553Service() {
        this(new Idea62553Config());
    }

    public Idea62553Service(Idea62553Config config) {
        this.config = config != null ? config : new Idea62553Config();
