...
@Data
public class Idea62254Config {
    private String name = "idea_062254";
 ...
 */
@Slf4j
public class Idea62254Service {
    private static final int IDEA_ID = 62254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62254Service() {
        this(new Idea62254Config());
    }

    public Idea62254Service(Idea62254Config config) {
        this.config = config != null ? config : new Idea62254Config();
