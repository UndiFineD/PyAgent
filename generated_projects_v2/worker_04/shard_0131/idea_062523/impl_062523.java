...
@Data
public class Idea62523Config {
    private String name = "idea_062523";
 ...
 */
@Slf4j
public class Idea62523Service {
    private static final int IDEA_ID = 62523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62523Service() {
        this(new Idea62523Config());
    }

    public Idea62523Service(Idea62523Config config) {
        this.config = config != null ? config : new Idea62523Config();
