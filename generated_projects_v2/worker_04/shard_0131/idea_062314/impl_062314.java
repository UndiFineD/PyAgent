...
@Data
public class Idea62314Config {
    private String name = "idea_062314";
 ...
 */
@Slf4j
public class Idea62314Service {
    private static final int IDEA_ID = 62314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62314Service() {
        this(new Idea62314Config());
    }

    public Idea62314Service(Idea62314Config config) {
        this.config = config != null ? config : new Idea62314Config();
