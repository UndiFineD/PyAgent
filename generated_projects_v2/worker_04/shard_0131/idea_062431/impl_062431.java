...
@Data
public class Idea62431Config {
    private String name = "idea_062431";
 ...
 */
@Slf4j
public class Idea62431Service {
    private static final int IDEA_ID = 62431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62431Service() {
        this(new Idea62431Config());
    }

    public Idea62431Service(Idea62431Config config) {
        this.config = config != null ? config : new Idea62431Config();
