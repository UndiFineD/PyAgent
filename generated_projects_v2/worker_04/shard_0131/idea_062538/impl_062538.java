...
@Data
public class Idea62538Config {
    private String name = "idea_062538";
 ...
 */
@Slf4j
public class Idea62538Service {
    private static final int IDEA_ID = 62538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62538Service() {
        this(new Idea62538Config());
    }

    public Idea62538Service(Idea62538Config config) {
        this.config = config != null ? config : new Idea62538Config();
