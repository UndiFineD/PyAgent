...
@Data
public class Idea62611Config {
    private String name = "idea_062611";
 ...
 */
@Slf4j
public class Idea62611Service {
    private static final int IDEA_ID = 62611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62611Service() {
        this(new Idea62611Config());
    }

    public Idea62611Service(Idea62611Config config) {
        this.config = config != null ? config : new Idea62611Config();
