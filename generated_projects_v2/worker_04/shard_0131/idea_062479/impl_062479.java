...
@Data
public class Idea62479Config {
    private String name = "idea_062479";
 ...
 */
@Slf4j
public class Idea62479Service {
    private static final int IDEA_ID = 62479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62479Service() {
        this(new Idea62479Config());
    }

    public Idea62479Service(Idea62479Config config) {
        this.config = config != null ? config : new Idea62479Config();
