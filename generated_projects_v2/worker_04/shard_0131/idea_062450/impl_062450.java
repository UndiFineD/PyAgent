...
@Data
public class Idea62450Config {
    private String name = "idea_062450";
 ...
 */
@Slf4j
public class Idea62450Service {
    private static final int IDEA_ID = 62450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62450Service() {
        this(new Idea62450Config());
    }

    public Idea62450Service(Idea62450Config config) {
        this.config = config != null ? config : new Idea62450Config();
