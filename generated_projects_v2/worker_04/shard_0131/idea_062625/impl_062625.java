...
@Data
public class Idea62625Config {
    private String name = "idea_062625";
 ...
 */
@Slf4j
public class Idea62625Service {
    private static final int IDEA_ID = 62625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62625Service() {
        this(new Idea62625Config());
    }

    public Idea62625Service(Idea62625Config config) {
        this.config = config != null ? config : new Idea62625Config();
