...
@Data
public class Idea62416Config {
    private String name = "idea_062416";
 ...
 */
@Slf4j
public class Idea62416Service {
    private static final int IDEA_ID = 62416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62416Service() {
        this(new Idea62416Config());
    }

    public Idea62416Service(Idea62416Config config) {
        this.config = config != null ? config : new Idea62416Config();
