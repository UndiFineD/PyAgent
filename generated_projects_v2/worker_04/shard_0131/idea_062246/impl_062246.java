...
@Data
public class Idea62246Config {
    private String name = "idea_062246";
 ...
 */
@Slf4j
public class Idea62246Service {
    private static final int IDEA_ID = 62246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62246Service() {
        this(new Idea62246Config());
    }

    public Idea62246Service(Idea62246Config config) {
        this.config = config != null ? config : new Idea62246Config();
