...
@Data
public class Idea62615Config {
    private String name = "idea_062615";
 ...
 */
@Slf4j
public class Idea62615Service {
    private static final int IDEA_ID = 62615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62615Service() {
        this(new Idea62615Config());
    }

    public Idea62615Service(Idea62615Config config) {
        this.config = config != null ? config : new Idea62615Config();
