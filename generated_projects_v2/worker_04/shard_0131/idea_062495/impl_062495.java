...
@Data
public class Idea62495Config {
    private String name = "idea_062495";
 ...
 */
@Slf4j
public class Idea62495Service {
    private static final int IDEA_ID = 62495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62495Service() {
        this(new Idea62495Config());
    }

    public Idea62495Service(Idea62495Config config) {
        this.config = config != null ? config : new Idea62495Config();
