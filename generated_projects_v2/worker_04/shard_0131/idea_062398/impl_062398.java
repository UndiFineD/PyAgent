...
@Data
public class Idea62398Config {
    private String name = "idea_062398";
 ...
 */
@Slf4j
public class Idea62398Service {
    private static final int IDEA_ID = 62398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62398Service() {
        this(new Idea62398Config());
    }

    public Idea62398Service(Idea62398Config config) {
        this.config = config != null ? config : new Idea62398Config();
