...
@Data
public class Idea62459Config {
    private String name = "idea_062459";
 ...
 */
@Slf4j
public class Idea62459Service {
    private static final int IDEA_ID = 62459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62459Service() {
        this(new Idea62459Config());
    }

    public Idea62459Service(Idea62459Config config) {
        this.config = config != null ? config : new Idea62459Config();
