...
@Data
public class Idea62288Config {
    private String name = "idea_062288";
 ...
 */
@Slf4j
public class Idea62288Service {
    private static final int IDEA_ID = 62288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62288Service() {
        this(new Idea62288Config());
    }

    public Idea62288Service(Idea62288Config config) {
        this.config = config != null ? config : new Idea62288Config();
