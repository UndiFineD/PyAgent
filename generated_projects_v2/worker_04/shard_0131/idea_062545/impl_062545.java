...
@Data
public class Idea62545Config {
    private String name = "idea_062545";
 ...
 */
@Slf4j
public class Idea62545Service {
    private static final int IDEA_ID = 62545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62545Service() {
        this(new Idea62545Config());
    }

    public Idea62545Service(Idea62545Config config) {
        this.config = config != null ? config : new Idea62545Config();
