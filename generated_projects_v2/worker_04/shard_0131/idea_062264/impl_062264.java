...
@Data
public class Idea62264Config {
    private String name = "idea_062264";
 ...
 */
@Slf4j
public class Idea62264Service {
    private static final int IDEA_ID = 62264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62264Service() {
        this(new Idea62264Config());
    }

    public Idea62264Service(Idea62264Config config) {
        this.config = config != null ? config : new Idea62264Config();
