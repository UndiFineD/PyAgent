...
@Data
public class Idea62350Config {
    private String name = "idea_062350";
 ...
 */
@Slf4j
public class Idea62350Service {
    private static final int IDEA_ID = 62350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62350Service() {
        this(new Idea62350Config());
    }

    public Idea62350Service(Idea62350Config config) {
        this.config = config != null ? config : new Idea62350Config();
