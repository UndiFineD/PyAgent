...
@Data
public class Idea62354Config {
    private String name = "idea_062354";
 ...
 */
@Slf4j
public class Idea62354Service {
    private static final int IDEA_ID = 62354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62354Service() {
        this(new Idea62354Config());
    }

    public Idea62354Service(Idea62354Config config) {
        this.config = config != null ? config : new Idea62354Config();
