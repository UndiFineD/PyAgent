...
@Data
public class Idea62382Config {
    private String name = "idea_062382";
 ...
 */
@Slf4j
public class Idea62382Service {
    private static final int IDEA_ID = 62382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62382Service() {
        this(new Idea62382Config());
    }

    public Idea62382Service(Idea62382Config config) {
        this.config = config != null ? config : new Idea62382Config();
