...
@Data
public class Idea62687Config {
    private String name = "idea_062687";
 ...
 */
@Slf4j
public class Idea62687Service {
    private static final int IDEA_ID = 62687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62687Service() {
        this(new Idea62687Config());
    }

    public Idea62687Service(Idea62687Config config) {
        this.config = config != null ? config : new Idea62687Config();
