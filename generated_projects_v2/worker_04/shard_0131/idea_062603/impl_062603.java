...
@Data
public class Idea62603Config {
    private String name = "idea_062603";
 ...
 */
@Slf4j
public class Idea62603Service {
    private static final int IDEA_ID = 62603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62603Service() {
        this(new Idea62603Config());
    }

    public Idea62603Service(Idea62603Config config) {
        this.config = config != null ? config : new Idea62603Config();
