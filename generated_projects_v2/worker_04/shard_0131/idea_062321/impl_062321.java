...
@Data
public class Idea62321Config {
    private String name = "idea_062321";
 ...
 */
@Slf4j
public class Idea62321Service {
    private static final int IDEA_ID = 62321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62321Service() {
        this(new Idea62321Config());
    }

    public Idea62321Service(Idea62321Config config) {
        this.config = config != null ? config : new Idea62321Config();
