...
@Data
public class Idea62534Config {
    private String name = "idea_062534";
 ...
 */
@Slf4j
public class Idea62534Service {
    private static final int IDEA_ID = 62534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62534Service() {
        this(new Idea62534Config());
    }

    public Idea62534Service(Idea62534Config config) {
        this.config = config != null ? config : new Idea62534Config();
