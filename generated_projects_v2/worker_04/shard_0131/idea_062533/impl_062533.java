...
@Data
public class Idea62533Config {
    private String name = "idea_062533";
 ...
 */
@Slf4j
public class Idea62533Service {
    private static final int IDEA_ID = 62533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62533Service() {
        this(new Idea62533Config());
    }

    public Idea62533Service(Idea62533Config config) {
        this.config = config != null ? config : new Idea62533Config();
