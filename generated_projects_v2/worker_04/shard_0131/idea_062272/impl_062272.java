...
@Data
public class Idea62272Config {
    private String name = "idea_062272";
 ...
 */
@Slf4j
public class Idea62272Service {
    private static final int IDEA_ID = 62272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62272Service() {
        this(new Idea62272Config());
    }

    public Idea62272Service(Idea62272Config config) {
        this.config = config != null ? config : new Idea62272Config();
