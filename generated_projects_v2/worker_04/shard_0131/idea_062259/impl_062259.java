...
@Data
public class Idea62259Config {
    private String name = "idea_062259";
 ...
 */
@Slf4j
public class Idea62259Service {
    private static final int IDEA_ID = 62259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62259Service() {
        this(new Idea62259Config());
    }

    public Idea62259Service(Idea62259Config config) {
        this.config = config != null ? config : new Idea62259Config();
