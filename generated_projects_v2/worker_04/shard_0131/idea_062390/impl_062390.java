...
@Data
public class Idea62390Config {
    private String name = "idea_062390";
 ...
 */
@Slf4j
public class Idea62390Service {
    private static final int IDEA_ID = 62390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62390Service() {
        this(new Idea62390Config());
    }

    public Idea62390Service(Idea62390Config config) {
        this.config = config != null ? config : new Idea62390Config();
