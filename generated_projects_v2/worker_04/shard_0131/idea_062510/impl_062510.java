...
@Data
public class Idea62510Config {
    private String name = "idea_062510";
 ...
 */
@Slf4j
public class Idea62510Service {
    private static final int IDEA_ID = 62510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62510Service() {
        this(new Idea62510Config());
    }

    public Idea62510Service(Idea62510Config config) {
        this.config = config != null ? config : new Idea62510Config();
