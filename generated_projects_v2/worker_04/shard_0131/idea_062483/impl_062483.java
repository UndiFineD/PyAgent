...
@Data
public class Idea62483Config {
    private String name = "idea_062483";
 ...
 */
@Slf4j
public class Idea62483Service {
    private static final int IDEA_ID = 62483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62483Service() {
        this(new Idea62483Config());
    }

    public Idea62483Service(Idea62483Config config) {
        this.config = config != null ? config : new Idea62483Config();
