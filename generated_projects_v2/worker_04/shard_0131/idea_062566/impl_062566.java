...
@Data
public class Idea62566Config {
    private String name = "idea_062566";
 ...
 */
@Slf4j
public class Idea62566Service {
    private static final int IDEA_ID = 62566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62566Service() {
        this(new Idea62566Config());
    }

    public Idea62566Service(Idea62566Config config) {
        this.config = config != null ? config : new Idea62566Config();
