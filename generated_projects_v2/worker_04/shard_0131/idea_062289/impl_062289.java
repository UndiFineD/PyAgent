...
@Data
public class Idea62289Config {
    private String name = "idea_062289";
 ...
 */
@Slf4j
public class Idea62289Service {
    private static final int IDEA_ID = 62289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62289Service() {
        this(new Idea62289Config());
    }

    public Idea62289Service(Idea62289Config config) {
        this.config = config != null ? config : new Idea62289Config();
