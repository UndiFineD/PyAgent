...
@Data
public class Idea62392Config {
    private String name = "idea_062392";
 ...
 */
@Slf4j
public class Idea62392Service {
    private static final int IDEA_ID = 62392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62392Service() {
        this(new Idea62392Config());
    }

    public Idea62392Service(Idea62392Config config) {
        this.config = config != null ? config : new Idea62392Config();
