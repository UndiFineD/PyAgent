...
@Data
public class Idea62591Config {
    private String name = "idea_062591";
 ...
 */
@Slf4j
public class Idea62591Service {
    private static final int IDEA_ID = 62591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62591Service() {
        this(new Idea62591Config());
    }

    public Idea62591Service(Idea62591Config config) {
        this.config = config != null ? config : new Idea62591Config();
