...
@Data
public class Idea62328Config {
    private String name = "idea_062328";
 ...
 */
@Slf4j
public class Idea62328Service {
    private static final int IDEA_ID = 62328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62328Service() {
        this(new Idea62328Config());
    }

    public Idea62328Service(Idea62328Config config) {
        this.config = config != null ? config : new Idea62328Config();
