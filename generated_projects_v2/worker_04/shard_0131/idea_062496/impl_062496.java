...
@Data
public class Idea62496Config {
    private String name = "idea_062496";
 ...
 */
@Slf4j
public class Idea62496Service {
    private static final int IDEA_ID = 62496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62496Service() {
        this(new Idea62496Config());
    }

    public Idea62496Service(Idea62496Config config) {
        this.config = config != null ? config : new Idea62496Config();
