...
@Data
public class Idea62420Config {
    private String name = "idea_062420";
 ...
 */
@Slf4j
public class Idea62420Service {
    private static final int IDEA_ID = 62420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62420Service() {
        this(new Idea62420Config());
    }

    public Idea62420Service(Idea62420Config config) {
        this.config = config != null ? config : new Idea62420Config();
