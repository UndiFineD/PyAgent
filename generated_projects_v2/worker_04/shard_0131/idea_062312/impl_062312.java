...
@Data
public class Idea62312Config {
    private String name = "idea_062312";
 ...
 */
@Slf4j
public class Idea62312Service {
    private static final int IDEA_ID = 62312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62312Service() {
        this(new Idea62312Config());
    }

    public Idea62312Service(Idea62312Config config) {
        this.config = config != null ? config : new Idea62312Config();
