...
@Data
public class Idea62464Config {
    private String name = "idea_062464";
 ...
 */
@Slf4j
public class Idea62464Service {
    private static final int IDEA_ID = 62464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62464Service() {
        this(new Idea62464Config());
    }

    public Idea62464Service(Idea62464Config config) {
        this.config = config != null ? config : new Idea62464Config();
