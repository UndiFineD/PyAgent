...
@Data
public class Idea62644Config {
    private String name = "idea_062644";
 ...
 */
@Slf4j
public class Idea62644Service {
    private static final int IDEA_ID = 62644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62644Service() {
        this(new Idea62644Config());
    }

    public Idea62644Service(Idea62644Config config) {
        this.config = config != null ? config : new Idea62644Config();
