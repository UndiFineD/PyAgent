...
@Data
public class Idea62642Config {
    private String name = "idea_062642";
 ...
 */
@Slf4j
public class Idea62642Service {
    private static final int IDEA_ID = 62642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62642Service() {
        this(new Idea62642Config());
    }

    public Idea62642Service(Idea62642Config config) {
        this.config = config != null ? config : new Idea62642Config();
