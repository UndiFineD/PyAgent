...
@Data
public class Idea62239Config {
    private String name = "idea_062239";
 ...
 */
@Slf4j
public class Idea62239Service {
    private static final int IDEA_ID = 62239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62239Service() {
        this(new Idea62239Config());
    }

    public Idea62239Service(Idea62239Config config) {
        this.config = config != null ? config : new Idea62239Config();
