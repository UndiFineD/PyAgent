...
@Data
public class Idea62252Config {
    private String name = "idea_062252";
 ...
 */
@Slf4j
public class Idea62252Service {
    private static final int IDEA_ID = 62252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62252Service() {
        this(new Idea62252Config());
    }

    public Idea62252Service(Idea62252Config config) {
        this.config = config != null ? config : new Idea62252Config();
