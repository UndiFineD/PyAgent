...
@Data
public class Idea62324Config {
    private String name = "idea_062324";
 ...
 */
@Slf4j
public class Idea62324Service {
    private static final int IDEA_ID = 62324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62324Service() {
        this(new Idea62324Config());
    }

    public Idea62324Service(Idea62324Config config) {
        this.config = config != null ? config : new Idea62324Config();
