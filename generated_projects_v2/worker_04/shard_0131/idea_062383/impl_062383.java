...
@Data
public class Idea62383Config {
    private String name = "idea_062383";
 ...
 */
@Slf4j
public class Idea62383Service {
    private static final int IDEA_ID = 62383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62383Service() {
        this(new Idea62383Config());
    }

    public Idea62383Service(Idea62383Config config) {
        this.config = config != null ? config : new Idea62383Config();
