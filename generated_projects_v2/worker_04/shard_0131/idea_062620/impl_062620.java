...
@Data
public class Idea62620Config {
    private String name = "idea_062620";
 ...
 */
@Slf4j
public class Idea62620Service {
    private static final int IDEA_ID = 62620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62620Service() {
        this(new Idea62620Config());
    }

    public Idea62620Service(Idea62620Config config) {
        this.config = config != null ? config : new Idea62620Config();
