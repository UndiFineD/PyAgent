...
@Data
public class Idea62662Config {
    private String name = "idea_062662";
 ...
 */
@Slf4j
public class Idea62662Service {
    private static final int IDEA_ID = 62662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62662Service() {
        this(new Idea62662Config());
    }

    public Idea62662Service(Idea62662Config config) {
        this.config = config != null ? config : new Idea62662Config();
