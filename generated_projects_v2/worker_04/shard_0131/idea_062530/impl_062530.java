...
@Data
public class Idea62530Config {
    private String name = "idea_062530";
 ...
 */
@Slf4j
public class Idea62530Service {
    private static final int IDEA_ID = 62530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62530Service() {
        this(new Idea62530Config());
    }

    public Idea62530Service(Idea62530Config config) {
        this.config = config != null ? config : new Idea62530Config();
