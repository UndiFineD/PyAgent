...
@Data
public class Idea62593Config {
    private String name = "idea_062593";
 ...
 */
@Slf4j
public class Idea62593Service {
    private static final int IDEA_ID = 62593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62593Service() {
        this(new Idea62593Config());
    }

    public Idea62593Service(Idea62593Config config) {
        this.config = config != null ? config : new Idea62593Config();
