...
@Data
public class Idea62271Config {
    private String name = "idea_062271";
 ...
 */
@Slf4j
public class Idea62271Service {
    private static final int IDEA_ID = 62271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62271Service() {
        this(new Idea62271Config());
    }

    public Idea62271Service(Idea62271Config config) {
        this.config = config != null ? config : new Idea62271Config();
