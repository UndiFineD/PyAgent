...
@Data
public class Idea62698Config {
    private String name = "idea_062698";
 ...
 */
@Slf4j
public class Idea62698Service {
    private static final int IDEA_ID = 62698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62698Service() {
        this(new Idea62698Config());
    }

    public Idea62698Service(Idea62698Config config) {
        this.config = config != null ? config : new Idea62698Config();
