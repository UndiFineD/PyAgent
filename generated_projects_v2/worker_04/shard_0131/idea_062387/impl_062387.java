...
@Data
public class Idea62387Config {
    private String name = "idea_062387";
 ...
 */
@Slf4j
public class Idea62387Service {
    private static final int IDEA_ID = 62387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62387Service() {
        this(new Idea62387Config());
    }

    public Idea62387Service(Idea62387Config config) {
        this.config = config != null ? config : new Idea62387Config();
