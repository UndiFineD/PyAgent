...
@Data
public class Idea62643Config {
    private String name = "idea_062643";
 ...
 */
@Slf4j
public class Idea62643Service {
    private static final int IDEA_ID = 62643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62643Service() {
        this(new Idea62643Config());
    }

    public Idea62643Service(Idea62643Config config) {
        this.config = config != null ? config : new Idea62643Config();
