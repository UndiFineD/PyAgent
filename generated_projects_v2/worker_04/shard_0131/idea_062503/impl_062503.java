...
@Data
public class Idea62503Config {
    private String name = "idea_062503";
 ...
 */
@Slf4j
public class Idea62503Service {
    private static final int IDEA_ID = 62503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62503Service() {
        this(new Idea62503Config());
    }

    public Idea62503Service(Idea62503Config config) {
        this.config = config != null ? config : new Idea62503Config();
