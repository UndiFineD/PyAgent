...
@Data
public class Idea62318Config {
    private String name = "idea_062318";
 ...
 */
@Slf4j
public class Idea62318Service {
    private static final int IDEA_ID = 62318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62318Service() {
        this(new Idea62318Config());
    }

    public Idea62318Service(Idea62318Config config) {
        this.config = config != null ? config : new Idea62318Config();
