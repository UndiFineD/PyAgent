...
@Data
public class Idea62427Config {
    private String name = "idea_062427";
 ...
 */
@Slf4j
public class Idea62427Service {
    private static final int IDEA_ID = 62427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62427Service() {
        this(new Idea62427Config());
    }

    public Idea62427Service(Idea62427Config config) {
        this.config = config != null ? config : new Idea62427Config();
