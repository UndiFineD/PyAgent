...
@Data
public class Idea62476Config {
    private String name = "idea_062476";
 ...
 */
@Slf4j
public class Idea62476Service {
    private static final int IDEA_ID = 62476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62476Service() {
        this(new Idea62476Config());
    }

    public Idea62476Service(Idea62476Config config) {
        this.config = config != null ? config : new Idea62476Config();
