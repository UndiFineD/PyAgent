...
@Data
public class Idea62685Config {
    private String name = "idea_062685";
 ...
 */
@Slf4j
public class Idea62685Service {
    private static final int IDEA_ID = 62685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62685Service() {
        this(new Idea62685Config());
    }

    public Idea62685Service(Idea62685Config config) {
        this.config = config != null ? config : new Idea62685Config();
