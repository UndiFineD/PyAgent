...
@Data
public class Idea62466Config {
    private String name = "idea_062466";
 ...
 */
@Slf4j
public class Idea62466Service {
    private static final int IDEA_ID = 62466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62466Service() {
        this(new Idea62466Config());
    }

    public Idea62466Service(Idea62466Config config) {
        this.config = config != null ? config : new Idea62466Config();
