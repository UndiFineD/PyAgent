...
@Data
public class Idea62415Config {
    private String name = "idea_062415";
 ...
 */
@Slf4j
public class Idea62415Service {
    private static final int IDEA_ID = 62415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62415Service() {
        this(new Idea62415Config());
    }

    public Idea62415Service(Idea62415Config config) {
        this.config = config != null ? config : new Idea62415Config();
