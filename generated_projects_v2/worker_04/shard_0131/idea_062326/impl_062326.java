...
@Data
public class Idea62326Config {
    private String name = "idea_062326";
 ...
 */
@Slf4j
public class Idea62326Service {
    private static final int IDEA_ID = 62326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62326Service() {
        this(new Idea62326Config());
    }

    public Idea62326Service(Idea62326Config config) {
        this.config = config != null ? config : new Idea62326Config();
