...
@Data
public class Idea62347Config {
    private String name = "idea_062347";
 ...
 */
@Slf4j
public class Idea62347Service {
    private static final int IDEA_ID = 62347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62347Service() {
        this(new Idea62347Config());
    }

    public Idea62347Service(Idea62347Config config) {
        this.config = config != null ? config : new Idea62347Config();
