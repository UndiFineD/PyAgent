...
@Data
public class Idea62583Config {
    private String name = "idea_062583";
 ...
 */
@Slf4j
public class Idea62583Service {
    private static final int IDEA_ID = 62583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62583Service() {
        this(new Idea62583Config());
    }

    public Idea62583Service(Idea62583Config config) {
        this.config = config != null ? config : new Idea62583Config();
