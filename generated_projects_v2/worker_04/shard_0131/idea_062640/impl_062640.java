...
@Data
public class Idea62640Config {
    private String name = "idea_062640";
 ...
 */
@Slf4j
public class Idea62640Service {
    private static final int IDEA_ID = 62640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62640Service() {
        this(new Idea62640Config());
    }

    public Idea62640Service(Idea62640Config config) {
        this.config = config != null ? config : new Idea62640Config();
