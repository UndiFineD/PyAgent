...
@Data
public class Idea62438Config {
    private String name = "idea_062438";
 ...
 */
@Slf4j
public class Idea62438Service {
    private static final int IDEA_ID = 62438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62438Service() {
        this(new Idea62438Config());
    }

    public Idea62438Service(Idea62438Config config) {
        this.config = config != null ? config : new Idea62438Config();
