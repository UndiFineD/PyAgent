...
@Data
public class Idea62678Config {
    private String name = "idea_062678";
 ...
 */
@Slf4j
public class Idea62678Service {
    private static final int IDEA_ID = 62678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62678Service() {
        this(new Idea62678Config());
    }

    public Idea62678Service(Idea62678Config config) {
        this.config = config != null ? config : new Idea62678Config();
