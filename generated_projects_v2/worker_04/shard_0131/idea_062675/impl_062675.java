...
@Data
public class Idea62675Config {
    private String name = "idea_062675";
 ...
 */
@Slf4j
public class Idea62675Service {
    private static final int IDEA_ID = 62675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62675Service() {
        this(new Idea62675Config());
    }

    public Idea62675Service(Idea62675Config config) {
        this.config = config != null ? config : new Idea62675Config();
