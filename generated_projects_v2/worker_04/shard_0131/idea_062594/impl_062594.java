...
@Data
public class Idea62594Config {
    private String name = "idea_062594";
 ...
 */
@Slf4j
public class Idea62594Service {
    private static final int IDEA_ID = 62594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62594Service() {
        this(new Idea62594Config());
    }

    public Idea62594Service(Idea62594Config config) {
        this.config = config != null ? config : new Idea62594Config();
