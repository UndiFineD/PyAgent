...
@Data
public class Idea62650Config {
    private String name = "idea_062650";
 ...
 */
@Slf4j
public class Idea62650Service {
    private static final int IDEA_ID = 62650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62650Service() {
        this(new Idea62650Config());
    }

    public Idea62650Service(Idea62650Config config) {
        this.config = config != null ? config : new Idea62650Config();
