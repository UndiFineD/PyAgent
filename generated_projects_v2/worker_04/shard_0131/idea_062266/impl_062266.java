...
@Data
public class Idea62266Config {
    private String name = "idea_062266";
 ...
 */
@Slf4j
public class Idea62266Service {
    private static final int IDEA_ID = 62266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62266Service() {
        this(new Idea62266Config());
    }

    public Idea62266Service(Idea62266Config config) {
        this.config = config != null ? config : new Idea62266Config();
