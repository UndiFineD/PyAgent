...
@Data
public class Idea62514Config {
    private String name = "idea_062514";
 ...
 */
@Slf4j
public class Idea62514Service {
    private static final int IDEA_ID = 62514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62514Service() {
        this(new Idea62514Config());
    }

    public Idea62514Service(Idea62514Config config) {
        this.config = config != null ? config : new Idea62514Config();
