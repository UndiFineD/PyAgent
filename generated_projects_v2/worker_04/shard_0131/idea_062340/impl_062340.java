...
@Data
public class Idea62340Config {
    private String name = "idea_062340";
 ...
 */
@Slf4j
public class Idea62340Service {
    private static final int IDEA_ID = 62340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62340Service() {
        this(new Idea62340Config());
    }

    public Idea62340Service(Idea62340Config config) {
        this.config = config != null ? config : new Idea62340Config();
