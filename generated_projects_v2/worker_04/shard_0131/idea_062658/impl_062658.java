...
@Data
public class Idea62658Config {
    private String name = "idea_062658";
 ...
 */
@Slf4j
public class Idea62658Service {
    private static final int IDEA_ID = 62658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62658Service() {
        this(new Idea62658Config());
    }

    public Idea62658Service(Idea62658Config config) {
        this.config = config != null ? config : new Idea62658Config();
