...
@Data
public class Idea62560Config {
    private String name = "idea_062560";
 ...
 */
@Slf4j
public class Idea62560Service {
    private static final int IDEA_ID = 62560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62560Service() {
        this(new Idea62560Config());
    }

    public Idea62560Service(Idea62560Config config) {
        this.config = config != null ? config : new Idea62560Config();
