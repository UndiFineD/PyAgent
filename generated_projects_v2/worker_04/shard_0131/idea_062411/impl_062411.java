...
@Data
public class Idea62411Config {
    private String name = "idea_062411";
 ...
 */
@Slf4j
public class Idea62411Service {
    private static final int IDEA_ID = 62411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62411Service() {
        this(new Idea62411Config());
    }

    public Idea62411Service(Idea62411Config config) {
        this.config = config != null ? config : new Idea62411Config();
