...
@Data
public class Idea62278Config {
    private String name = "idea_062278";
 ...
 */
@Slf4j
public class Idea62278Service {
    private static final int IDEA_ID = 62278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62278Service() {
        this(new Idea62278Config());
    }

    public Idea62278Service(Idea62278Config config) {
        this.config = config != null ? config : new Idea62278Config();
