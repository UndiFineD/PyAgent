...
@Data
public class Idea62595Config {
    private String name = "idea_062595";
 ...
 */
@Slf4j
public class Idea62595Service {
    private static final int IDEA_ID = 62595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62595Service() {
        this(new Idea62595Config());
    }

    public Idea62595Service(Idea62595Config config) {
        this.config = config != null ? config : new Idea62595Config();
