...
@Data
public class Idea62657Config {
    private String name = "idea_062657";
 ...
 */
@Slf4j
public class Idea62657Service {
    private static final int IDEA_ID = 62657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62657Service() {
        this(new Idea62657Config());
    }

    public Idea62657Service(Idea62657Config config) {
        this.config = config != null ? config : new Idea62657Config();
