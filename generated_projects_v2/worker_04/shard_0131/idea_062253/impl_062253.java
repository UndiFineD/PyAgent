...
@Data
public class Idea62253Config {
    private String name = "idea_062253";
 ...
 */
@Slf4j
public class Idea62253Service {
    private static final int IDEA_ID = 62253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62253Service() {
        this(new Idea62253Config());
    }

    public Idea62253Service(Idea62253Config config) {
        this.config = config != null ? config : new Idea62253Config();
