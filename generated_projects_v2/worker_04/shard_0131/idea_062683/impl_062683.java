...
@Data
public class Idea62683Config {
    private String name = "idea_062683";
 ...
 */
@Slf4j
public class Idea62683Service {
    private static final int IDEA_ID = 62683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62683Service() {
        this(new Idea62683Config());
    }

    public Idea62683Service(Idea62683Config config) {
        this.config = config != null ? config : new Idea62683Config();
