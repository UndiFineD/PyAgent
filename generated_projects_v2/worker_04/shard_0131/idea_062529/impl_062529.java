...
@Data
public class Idea62529Config {
    private String name = "idea_062529";
 ...
 */
@Slf4j
public class Idea62529Service {
    private static final int IDEA_ID = 62529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62529Service() {
        this(new Idea62529Config());
    }

    public Idea62529Service(Idea62529Config config) {
        this.config = config != null ? config : new Idea62529Config();
