...
@Data
public class Idea62493Config {
    private String name = "idea_062493";
 ...
 */
@Slf4j
public class Idea62493Service {
    private static final int IDEA_ID = 62493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62493Service() {
        this(new Idea62493Config());
    }

    public Idea62493Service(Idea62493Config config) {
        this.config = config != null ? config : new Idea62493Config();
