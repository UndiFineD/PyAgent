...
@Data
public class Idea62255Config {
    private String name = "idea_062255";
 ...
 */
@Slf4j
public class Idea62255Service {
    private static final int IDEA_ID = 62255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62255Service() {
        this(new Idea62255Config());
    }

    public Idea62255Service(Idea62255Config config) {
        this.config = config != null ? config : new Idea62255Config();
