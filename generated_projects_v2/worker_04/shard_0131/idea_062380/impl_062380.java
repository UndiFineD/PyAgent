...
@Data
public class Idea62380Config {
    private String name = "idea_062380";
 ...
 */
@Slf4j
public class Idea62380Service {
    private static final int IDEA_ID = 62380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62380Service() {
        this(new Idea62380Config());
    }

    public Idea62380Service(Idea62380Config config) {
        this.config = config != null ? config : new Idea62380Config();
