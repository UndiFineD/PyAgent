...
@Data
public class Idea62230Config {
    private String name = "idea_062230";
 ...
 */
@Slf4j
public class Idea62230Service {
    private static final int IDEA_ID = 62230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62230Service() {
        this(new Idea62230Config());
    }

    public Idea62230Service(Idea62230Config config) {
        this.config = config != null ? config : new Idea62230Config();
