...
@Data
public class Idea62552Config {
    private String name = "idea_062552";
 ...
 */
@Slf4j
public class Idea62552Service {
    private static final int IDEA_ID = 62552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62552Service() {
        this(new Idea62552Config());
    }

    public Idea62552Service(Idea62552Config config) {
        this.config = config != null ? config : new Idea62552Config();
