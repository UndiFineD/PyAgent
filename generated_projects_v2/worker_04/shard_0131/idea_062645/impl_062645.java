...
@Data
public class Idea62645Config {
    private String name = "idea_062645";
 ...
 */
@Slf4j
public class Idea62645Service {
    private static final int IDEA_ID = 62645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62645Service() {
        this(new Idea62645Config());
    }

    public Idea62645Service(Idea62645Config config) {
        this.config = config != null ? config : new Idea62645Config();
