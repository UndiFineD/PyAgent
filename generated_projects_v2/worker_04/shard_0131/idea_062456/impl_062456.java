...
@Data
public class Idea62456Config {
    private String name = "idea_062456";
 ...
 */
@Slf4j
public class Idea62456Service {
    private static final int IDEA_ID = 62456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62456Service() {
        this(new Idea62456Config());
    }

    public Idea62456Service(Idea62456Config config) {
        this.config = config != null ? config : new Idea62456Config();
