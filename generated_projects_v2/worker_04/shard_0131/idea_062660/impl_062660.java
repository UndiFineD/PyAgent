...
@Data
public class Idea62660Config {
    private String name = "idea_062660";
 ...
 */
@Slf4j
public class Idea62660Service {
    private static final int IDEA_ID = 62660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62660Service() {
        this(new Idea62660Config());
    }

    public Idea62660Service(Idea62660Config config) {
        this.config = config != null ? config : new Idea62660Config();
