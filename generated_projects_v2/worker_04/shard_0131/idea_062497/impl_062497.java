...
@Data
public class Idea62497Config {
    private String name = "idea_062497";
 ...
 */
@Slf4j
public class Idea62497Service {
    private static final int IDEA_ID = 62497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62497Service() {
        this(new Idea62497Config());
    }

    public Idea62497Service(Idea62497Config config) {
        this.config = config != null ? config : new Idea62497Config();
