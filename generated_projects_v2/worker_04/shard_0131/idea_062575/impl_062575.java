...
@Data
public class Idea62575Config {
    private String name = "idea_062575";
 ...
 */
@Slf4j
public class Idea62575Service {
    private static final int IDEA_ID = 62575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62575Service() {
        this(new Idea62575Config());
    }

    public Idea62575Service(Idea62575Config config) {
        this.config = config != null ? config : new Idea62575Config();
