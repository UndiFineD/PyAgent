...
@Data
public class Idea62342Config {
    private String name = "idea_062342";
 ...
 */
@Slf4j
public class Idea62342Service {
    private static final int IDEA_ID = 62342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62342Service() {
        this(new Idea62342Config());
    }

    public Idea62342Service(Idea62342Config config) {
        this.config = config != null ? config : new Idea62342Config();
