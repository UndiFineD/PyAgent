...
@Data
public class Idea62688Config {
    private String name = "idea_062688";
 ...
 */
@Slf4j
public class Idea62688Service {
    private static final int IDEA_ID = 62688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62688Service() {
        this(new Idea62688Config());
    }

    public Idea62688Service(Idea62688Config config) {
        this.config = config != null ? config : new Idea62688Config();
