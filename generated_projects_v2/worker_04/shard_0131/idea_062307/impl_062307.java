...
@Data
public class Idea62307Config {
    private String name = "idea_062307";
 ...
 */
@Slf4j
public class Idea62307Service {
    private static final int IDEA_ID = 62307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62307Service() {
        this(new Idea62307Config());
    }

    public Idea62307Service(Idea62307Config config) {
        this.config = config != null ? config : new Idea62307Config();
