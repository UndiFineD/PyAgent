...
@Data
public class Idea62680Config {
    private String name = "idea_062680";
 ...
 */
@Slf4j
public class Idea62680Service {
    private static final int IDEA_ID = 62680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62680Service() {
        this(new Idea62680Config());
    }

    public Idea62680Service(Idea62680Config config) {
        this.config = config != null ? config : new Idea62680Config();
