...
@Data
public class Idea62628Config {
    private String name = "idea_062628";
 ...
 */
@Slf4j
public class Idea62628Service {
    private static final int IDEA_ID = 62628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62628Service() {
        this(new Idea62628Config());
    }

    public Idea62628Service(Idea62628Config config) {
        this.config = config != null ? config : new Idea62628Config();
