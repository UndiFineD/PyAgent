...
@Data
public class Idea62473Config {
    private String name = "idea_062473";
 ...
 */
@Slf4j
public class Idea62473Service {
    private static final int IDEA_ID = 62473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62473Service() {
        this(new Idea62473Config());
    }

    public Idea62473Service(Idea62473Config config) {
        this.config = config != null ? config : new Idea62473Config();
