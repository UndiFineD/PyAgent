...
@Data
public class Idea62520Config {
    private String name = "idea_062520";
 ...
 */
@Slf4j
public class Idea62520Service {
    private static final int IDEA_ID = 62520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62520Service() {
        this(new Idea62520Config());
    }

    public Idea62520Service(Idea62520Config config) {
        this.config = config != null ? config : new Idea62520Config();
