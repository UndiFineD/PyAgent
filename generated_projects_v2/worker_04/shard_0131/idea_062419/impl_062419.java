...
@Data
public class Idea62419Config {
    private String name = "idea_062419";
 ...
 */
@Slf4j
public class Idea62419Service {
    private static final int IDEA_ID = 62419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62419Service() {
        this(new Idea62419Config());
    }

    public Idea62419Service(Idea62419Config config) {
        this.config = config != null ? config : new Idea62419Config();
