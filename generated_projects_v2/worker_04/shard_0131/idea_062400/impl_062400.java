...
@Data
public class Idea62400Config {
    private String name = "idea_062400";
 ...
 */
@Slf4j
public class Idea62400Service {
    private static final int IDEA_ID = 62400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62400Service() {
        this(new Idea62400Config());
    }

    public Idea62400Service(Idea62400Config config) {
        this.config = config != null ? config : new Idea62400Config();
