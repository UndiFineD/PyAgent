...
@Data
public class Idea62277Config {
    private String name = "idea_062277";
 ...
 */
@Slf4j
public class Idea62277Service {
    private static final int IDEA_ID = 62277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62277Service() {
        this(new Idea62277Config());
    }

    public Idea62277Service(Idea62277Config config) {
        this.config = config != null ? config : new Idea62277Config();
