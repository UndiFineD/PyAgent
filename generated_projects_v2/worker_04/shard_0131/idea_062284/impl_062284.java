...
@Data
public class Idea62284Config {
    private String name = "idea_062284";
 ...
 */
@Slf4j
public class Idea62284Service {
    private static final int IDEA_ID = 62284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62284Service() {
        this(new Idea62284Config());
    }

    public Idea62284Service(Idea62284Config config) {
        this.config = config != null ? config : new Idea62284Config();
