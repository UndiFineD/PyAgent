...
@Data
public class Idea62509Config {
    private String name = "idea_062509";
 ...
 */
@Slf4j
public class Idea62509Service {
    private static final int IDEA_ID = 62509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62509Service() {
        this(new Idea62509Config());
    }

    public Idea62509Service(Idea62509Config config) {
        this.config = config != null ? config : new Idea62509Config();
