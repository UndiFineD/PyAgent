...
@Data
public class Idea62376Config {
    private String name = "idea_062376";
 ...
 */
@Slf4j
public class Idea62376Service {
    private static final int IDEA_ID = 62376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62376Service() {
        this(new Idea62376Config());
    }

    public Idea62376Service(Idea62376Config config) {
        this.config = config != null ? config : new Idea62376Config();
