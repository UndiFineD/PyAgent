...
@Data
public class Idea62461Config {
    private String name = "idea_062461";
 ...
 */
@Slf4j
public class Idea62461Service {
    private static final int IDEA_ID = 62461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62461Service() {
        this(new Idea62461Config());
    }

    public Idea62461Service(Idea62461Config config) {
        this.config = config != null ? config : new Idea62461Config();
