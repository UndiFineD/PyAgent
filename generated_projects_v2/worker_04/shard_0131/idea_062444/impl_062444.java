...
@Data
public class Idea62444Config {
    private String name = "idea_062444";
 ...
 */
@Slf4j
public class Idea62444Service {
    private static final int IDEA_ID = 62444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62444Service() {
        this(new Idea62444Config());
    }

    public Idea62444Service(Idea62444Config config) {
        this.config = config != null ? config : new Idea62444Config();
