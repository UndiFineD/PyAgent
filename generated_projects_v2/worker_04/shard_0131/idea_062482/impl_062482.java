...
@Data
public class Idea62482Config {
    private String name = "idea_062482";
 ...
 */
@Slf4j
public class Idea62482Service {
    private static final int IDEA_ID = 62482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62482Service() {
        this(new Idea62482Config());
    }

    public Idea62482Service(Idea62482Config config) {
        this.config = config != null ? config : new Idea62482Config();
