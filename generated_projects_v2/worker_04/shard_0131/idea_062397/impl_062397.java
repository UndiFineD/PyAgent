...
@Data
public class Idea62397Config {
    private String name = "idea_062397";
 ...
 */
@Slf4j
public class Idea62397Service {
    private static final int IDEA_ID = 62397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62397Service() {
        this(new Idea62397Config());
    }

    public Idea62397Service(Idea62397Config config) {
        this.config = config != null ? config : new Idea62397Config();
