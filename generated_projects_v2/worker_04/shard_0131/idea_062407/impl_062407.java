...
@Data
public class Idea62407Config {
    private String name = "idea_062407";
 ...
 */
@Slf4j
public class Idea62407Service {
    private static final int IDEA_ID = 62407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62407Service() {
        this(new Idea62407Config());
    }

    public Idea62407Service(Idea62407Config config) {
        this.config = config != null ? config : new Idea62407Config();
