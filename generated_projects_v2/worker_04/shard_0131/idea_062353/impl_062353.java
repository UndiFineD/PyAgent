...
@Data
public class Idea62353Config {
    private String name = "idea_062353";
 ...
 */
@Slf4j
public class Idea62353Service {
    private static final int IDEA_ID = 62353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62353Service() {
        this(new Idea62353Config());
    }

    public Idea62353Service(Idea62353Config config) {
        this.config = config != null ? config : new Idea62353Config();
