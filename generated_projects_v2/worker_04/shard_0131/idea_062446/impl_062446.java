...
@Data
public class Idea62446Config {
    private String name = "idea_062446";
 ...
 */
@Slf4j
public class Idea62446Service {
    private static final int IDEA_ID = 62446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62446Service() {
        this(new Idea62446Config());
    }

    public Idea62446Service(Idea62446Config config) {
        this.config = config != null ? config : new Idea62446Config();
