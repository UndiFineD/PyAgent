...
@Data
public class Idea62274Config {
    private String name = "idea_062274";
 ...
 */
@Slf4j
public class Idea62274Service {
    private static final int IDEA_ID = 62274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62274Service() {
        this(new Idea62274Config());
    }

    public Idea62274Service(Idea62274Config config) {
        this.config = config != null ? config : new Idea62274Config();
