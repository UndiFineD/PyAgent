...
@Data
public class Idea62635Config {
    private String name = "idea_062635";
 ...
 */
@Slf4j
public class Idea62635Service {
    private static final int IDEA_ID = 62635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62635Service() {
        this(new Idea62635Config());
    }

    public Idea62635Service(Idea62635Config config) {
        this.config = config != null ? config : new Idea62635Config();
