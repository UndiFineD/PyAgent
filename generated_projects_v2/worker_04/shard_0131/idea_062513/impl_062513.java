...
@Data
public class Idea62513Config {
    private String name = "idea_062513";
 ...
 */
@Slf4j
public class Idea62513Service {
    private static final int IDEA_ID = 62513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62513Service() {
        this(new Idea62513Config());
    }

    public Idea62513Service(Idea62513Config config) {
        this.config = config != null ? config : new Idea62513Config();
