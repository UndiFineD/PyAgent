...
@Data
public class Idea62377Config {
    private String name = "idea_062377";
 ...
 */
@Slf4j
public class Idea62377Service {
    private static final int IDEA_ID = 62377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62377Service() {
        this(new Idea62377Config());
    }

    public Idea62377Service(Idea62377Config config) {
        this.config = config != null ? config : new Idea62377Config();
