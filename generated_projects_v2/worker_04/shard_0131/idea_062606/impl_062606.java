...
@Data
public class Idea62606Config {
    private String name = "idea_062606";
 ...
 */
@Slf4j
public class Idea62606Service {
    private static final int IDEA_ID = 62606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62606Service() {
        this(new Idea62606Config());
    }

    public Idea62606Service(Idea62606Config config) {
        this.config = config != null ? config : new Idea62606Config();
