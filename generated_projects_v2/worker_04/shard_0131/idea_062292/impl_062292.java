...
@Data
public class Idea62292Config {
    private String name = "idea_062292";
 ...
 */
@Slf4j
public class Idea62292Service {
    private static final int IDEA_ID = 62292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62292Service() {
        this(new Idea62292Config());
    }

    public Idea62292Service(Idea62292Config config) {
        this.config = config != null ? config : new Idea62292Config();
