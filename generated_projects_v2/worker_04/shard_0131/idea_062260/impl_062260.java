...
@Data
public class Idea62260Config {
    private String name = "idea_062260";
 ...
 */
@Slf4j
public class Idea62260Service {
    private static final int IDEA_ID = 62260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62260Service() {
        this(new Idea62260Config());
    }

    public Idea62260Service(Idea62260Config config) {
        this.config = config != null ? config : new Idea62260Config();
