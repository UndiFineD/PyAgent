...
@Data
public class Idea62501Config {
    private String name = "idea_062501";
 ...
 */
@Slf4j
public class Idea62501Service {
    private static final int IDEA_ID = 62501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62501Service() {
        this(new Idea62501Config());
    }

    public Idea62501Service(Idea62501Config config) {
        this.config = config != null ? config : new Idea62501Config();
