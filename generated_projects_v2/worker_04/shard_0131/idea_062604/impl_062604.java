...
@Data
public class Idea62604Config {
    private String name = "idea_062604";
 ...
 */
@Slf4j
public class Idea62604Service {
    private static final int IDEA_ID = 62604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62604Service() {
        this(new Idea62604Config());
    }

    public Idea62604Service(Idea62604Config config) {
        this.config = config != null ? config : new Idea62604Config();
