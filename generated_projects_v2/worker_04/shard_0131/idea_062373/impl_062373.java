...
@Data
public class Idea62373Config {
    private String name = "idea_062373";
 ...
 */
@Slf4j
public class Idea62373Service {
    private static final int IDEA_ID = 62373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62373Service() {
        this(new Idea62373Config());
    }

    public Idea62373Service(Idea62373Config config) {
        this.config = config != null ? config : new Idea62373Config();
