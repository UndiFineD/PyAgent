...
@Data
public class Idea62341Config {
    private String name = "idea_062341";
 ...
 */
@Slf4j
public class Idea62341Service {
    private static final int IDEA_ID = 62341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62341Service() {
        this(new Idea62341Config());
    }

    public Idea62341Service(Idea62341Config config) {
        this.config = config != null ? config : new Idea62341Config();
