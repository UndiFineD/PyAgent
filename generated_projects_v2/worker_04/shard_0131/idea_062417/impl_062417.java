...
@Data
public class Idea62417Config {
    private String name = "idea_062417";
 ...
 */
@Slf4j
public class Idea62417Service {
    private static final int IDEA_ID = 62417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62417Service() {
        this(new Idea62417Config());
    }

    public Idea62417Service(Idea62417Config config) {
        this.config = config != null ? config : new Idea62417Config();
