...
@Data
public class Idea62577Config {
    private String name = "idea_062577";
 ...
 */
@Slf4j
public class Idea62577Service {
    private static final int IDEA_ID = 62577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62577Service() {
        this(new Idea62577Config());
    }

    public Idea62577Service(Idea62577Config config) {
        this.config = config != null ? config : new Idea62577Config();
