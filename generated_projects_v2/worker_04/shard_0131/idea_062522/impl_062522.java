...
@Data
public class Idea62522Config {
    private String name = "idea_062522";
 ...
 */
@Slf4j
public class Idea62522Service {
    private static final int IDEA_ID = 62522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62522Service() {
        this(new Idea62522Config());
    }

    public Idea62522Service(Idea62522Config config) {
        this.config = config != null ? config : new Idea62522Config();
