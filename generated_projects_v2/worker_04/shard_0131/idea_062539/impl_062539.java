...
@Data
public class Idea62539Config {
    private String name = "idea_062539";
 ...
 */
@Slf4j
public class Idea62539Service {
    private static final int IDEA_ID = 62539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62539Service() {
        this(new Idea62539Config());
    }

    public Idea62539Service(Idea62539Config config) {
        this.config = config != null ? config : new Idea62539Config();
