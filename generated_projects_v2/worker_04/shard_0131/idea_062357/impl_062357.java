...
@Data
public class Idea62357Config {
    private String name = "idea_062357";
 ...
 */
@Slf4j
public class Idea62357Service {
    private static final int IDEA_ID = 62357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62357Service() {
        this(new Idea62357Config());
    }

    public Idea62357Service(Idea62357Config config) {
        this.config = config != null ? config : new Idea62357Config();
