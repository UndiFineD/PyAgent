...
@Data
public class Idea62433Config {
    private String name = "idea_062433";
 ...
 */
@Slf4j
public class Idea62433Service {
    private static final int IDEA_ID = 62433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62433Service() {
        this(new Idea62433Config());
    }

    public Idea62433Service(Idea62433Config config) {
        this.config = config != null ? config : new Idea62433Config();
