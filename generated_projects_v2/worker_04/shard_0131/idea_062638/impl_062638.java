...
@Data
public class Idea62638Config {
    private String name = "idea_062638";
 ...
 */
@Slf4j
public class Idea62638Service {
    private static final int IDEA_ID = 62638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62638Service() {
        this(new Idea62638Config());
    }

    public Idea62638Service(Idea62638Config config) {
        this.config = config != null ? config : new Idea62638Config();
