...
@Data
public class Idea62490Config {
    private String name = "idea_062490";
 ...
 */
@Slf4j
public class Idea62490Service {
    private static final int IDEA_ID = 62490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62490Service() {
        this(new Idea62490Config());
    }

    public Idea62490Service(Idea62490Config config) {
        this.config = config != null ? config : new Idea62490Config();
