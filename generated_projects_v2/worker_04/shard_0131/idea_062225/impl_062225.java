...
@Data
public class Idea62225Config {
    private String name = "idea_062225";
 ...
 */
@Slf4j
public class Idea62225Service {
    private static final int IDEA_ID = 62225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62225Service() {
        this(new Idea62225Config());
    }

    public Idea62225Service(Idea62225Config config) {
        this.config = config != null ? config : new Idea62225Config();
