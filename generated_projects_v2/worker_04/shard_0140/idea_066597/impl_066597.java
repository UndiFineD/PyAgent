...
@Data
public class Idea66597Config {
    private String name = "idea_066597";
 ...
 */
@Slf4j
public class Idea66597Service {
    private static final int IDEA_ID = 66597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66597Service() {
        this(new Idea66597Config());
    }

    public Idea66597Service(Idea66597Config config) {
        this.config = config != null ? config : new Idea66597Config();
