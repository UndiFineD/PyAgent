...
@Data
public class Idea66965Config {
    private String name = "idea_066965";
 ...
 */
@Slf4j
public class Idea66965Service {
    private static final int IDEA_ID = 66965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66965Service() {
        this(new Idea66965Config());
    }

    public Idea66965Service(Idea66965Config config) {
        this.config = config != null ? config : new Idea66965Config();
