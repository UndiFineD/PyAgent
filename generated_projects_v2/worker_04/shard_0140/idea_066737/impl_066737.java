...
@Data
public class Idea66737Config {
    private String name = "idea_066737";
 ...
 */
@Slf4j
public class Idea66737Service {
    private static final int IDEA_ID = 66737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66737Service() {
        this(new Idea66737Config());
    }

    public Idea66737Service(Idea66737Config config) {
        this.config = config != null ? config : new Idea66737Config();
