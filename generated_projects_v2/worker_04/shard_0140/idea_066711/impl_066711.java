...
@Data
public class Idea66711Config {
    private String name = "idea_066711";
 ...
 */
@Slf4j
public class Idea66711Service {
    private static final int IDEA_ID = 66711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66711Service() {
        this(new Idea66711Config());
    }

    public Idea66711Service(Idea66711Config config) {
        this.config = config != null ? config : new Idea66711Config();
