...
@Data
public class Idea66767Config {
    private String name = "idea_066767";
 ...
 */
@Slf4j
public class Idea66767Service {
    private static final int IDEA_ID = 66767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66767Service() {
        this(new Idea66767Config());
    }

    public Idea66767Service(Idea66767Config config) {
        this.config = config != null ? config : new Idea66767Config();
