...
@Data
public class Idea66598Config {
    private String name = "idea_066598";
 ...
 */
@Slf4j
public class Idea66598Service {
    private static final int IDEA_ID = 66598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66598Service() {
        this(new Idea66598Config());
    }

    public Idea66598Service(Idea66598Config config) {
        this.config = config != null ? config : new Idea66598Config();
