...
@Data
public class Idea66602Config {
    private String name = "idea_066602";
 ...
 */
@Slf4j
public class Idea66602Service {
    private static final int IDEA_ID = 66602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66602Service() {
        this(new Idea66602Config());
    }

    public Idea66602Service(Idea66602Config config) {
        this.config = config != null ? config : new Idea66602Config();
