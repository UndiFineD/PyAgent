...
@Data
public class Idea66666Config {
    private String name = "idea_066666";
 ...
 */
@Slf4j
public class Idea66666Service {
    private static final int IDEA_ID = 66666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66666Service() {
        this(new Idea66666Config());
    }

    public Idea66666Service(Idea66666Config config) {
        this.config = config != null ? config : new Idea66666Config();
