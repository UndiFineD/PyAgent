...
@Data
public class Idea66799Config {
    private String name = "idea_066799";
 ...
 */
@Slf4j
public class Idea66799Service {
    private static final int IDEA_ID = 66799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66799Service() {
        this(new Idea66799Config());
    }

    public Idea66799Service(Idea66799Config config) {
        this.config = config != null ? config : new Idea66799Config();
