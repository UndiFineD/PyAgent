...
@Data
public class Idea66735Config {
    private String name = "idea_066735";
 ...
 */
@Slf4j
public class Idea66735Service {
    private static final int IDEA_ID = 66735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66735Service() {
        this(new Idea66735Config());
    }

    public Idea66735Service(Idea66735Config config) {
        this.config = config != null ? config : new Idea66735Config();
