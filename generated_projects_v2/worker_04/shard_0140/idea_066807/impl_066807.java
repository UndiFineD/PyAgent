...
@Data
public class Idea66807Config {
    private String name = "idea_066807";
 ...
 */
@Slf4j
public class Idea66807Service {
    private static final int IDEA_ID = 66807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66807Service() {
        this(new Idea66807Config());
    }

    public Idea66807Service(Idea66807Config config) {
        this.config = config != null ? config : new Idea66807Config();
