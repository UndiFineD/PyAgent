...
@Data
public class Idea66738Config {
    private String name = "idea_066738";
 ...
 */
@Slf4j
public class Idea66738Service {
    private static final int IDEA_ID = 66738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66738Service() {
        this(new Idea66738Config());
    }

    public Idea66738Service(Idea66738Config config) {
        this.config = config != null ? config : new Idea66738Config();
