...
@Data
public class Idea66771Config {
    private String name = "idea_066771";
 ...
 */
@Slf4j
public class Idea66771Service {
    private static final int IDEA_ID = 66771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66771Service() {
        this(new Idea66771Config());
    }

    public Idea66771Service(Idea66771Config config) {
        this.config = config != null ? config : new Idea66771Config();
