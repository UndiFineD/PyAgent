...
@Data
public class Idea66667Config {
    private String name = "idea_066667";
 ...
 */
@Slf4j
public class Idea66667Service {
    private static final int IDEA_ID = 66667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66667Service() {
        this(new Idea66667Config());
    }

    public Idea66667Service(Idea66667Config config) {
        this.config = config != null ? config : new Idea66667Config();
