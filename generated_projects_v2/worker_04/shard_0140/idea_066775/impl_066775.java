...
@Data
public class Idea66775Config {
    private String name = "idea_066775";
 ...
 */
@Slf4j
public class Idea66775Service {
    private static final int IDEA_ID = 66775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66775Service() {
        this(new Idea66775Config());
    }

    public Idea66775Service(Idea66775Config config) {
        this.config = config != null ? config : new Idea66775Config();
