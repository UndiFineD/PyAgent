...
@Data
public class Idea66702Config {
    private String name = "idea_066702";
 ...
 */
@Slf4j
public class Idea66702Service {
    private static final int IDEA_ID = 66702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66702Service() {
        this(new Idea66702Config());
    }

    public Idea66702Service(Idea66702Config config) {
        this.config = config != null ? config : new Idea66702Config();
