...
@Data
public class Idea66622Config {
    private String name = "idea_066622";
 ...
 */
@Slf4j
public class Idea66622Service {
    private static final int IDEA_ID = 66622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66622Service() {
        this(new Idea66622Config());
    }

    public Idea66622Service(Idea66622Config config) {
        this.config = config != null ? config : new Idea66622Config();
