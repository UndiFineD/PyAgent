...
@Data
public class Idea66826Config {
    private String name = "idea_066826";
 ...
 */
@Slf4j
public class Idea66826Service {
    private static final int IDEA_ID = 66826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66826Service() {
        this(new Idea66826Config());
    }

    public Idea66826Service(Idea66826Config config) {
        this.config = config != null ? config : new Idea66826Config();
