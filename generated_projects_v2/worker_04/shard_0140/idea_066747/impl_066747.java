...
@Data
public class Idea66747Config {
    private String name = "idea_066747";
 ...
 */
@Slf4j
public class Idea66747Service {
    private static final int IDEA_ID = 66747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66747Service() {
        this(new Idea66747Config());
    }

    public Idea66747Service(Idea66747Config config) {
        this.config = config != null ? config : new Idea66747Config();
