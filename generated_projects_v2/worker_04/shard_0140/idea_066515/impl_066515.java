...
@Data
public class Idea66515Config {
    private String name = "idea_066515";
 ...
 */
@Slf4j
public class Idea66515Service {
    private static final int IDEA_ID = 66515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66515Service() {
        this(new Idea66515Config());
    }

    public Idea66515Service(Idea66515Config config) {
        this.config = config != null ? config : new Idea66515Config();
