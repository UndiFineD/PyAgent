...
@Data
public class Idea66630Config {
    private String name = "idea_066630";
 ...
 */
@Slf4j
public class Idea66630Service {
    private static final int IDEA_ID = 66630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66630Service() {
        this(new Idea66630Config());
    }

    public Idea66630Service(Idea66630Config config) {
        this.config = config != null ? config : new Idea66630Config();
