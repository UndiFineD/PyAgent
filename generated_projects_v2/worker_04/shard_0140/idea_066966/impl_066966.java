...
@Data
public class Idea66966Config {
    private String name = "idea_066966";
 ...
 */
@Slf4j
public class Idea66966Service {
    private static final int IDEA_ID = 66966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66966Service() {
        this(new Idea66966Config());
    }

    public Idea66966Service(Idea66966Config config) {
        this.config = config != null ? config : new Idea66966Config();
