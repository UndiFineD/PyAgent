...
@Data
public class Idea66637Config {
    private String name = "idea_066637";
 ...
 */
@Slf4j
public class Idea66637Service {
    private static final int IDEA_ID = 66637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66637Service() {
        this(new Idea66637Config());
    }

    public Idea66637Service(Idea66637Config config) {
        this.config = config != null ? config : new Idea66637Config();
