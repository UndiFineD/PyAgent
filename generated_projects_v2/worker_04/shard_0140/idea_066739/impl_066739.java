...
@Data
public class Idea66739Config {
    private String name = "idea_066739";
 ...
 */
@Slf4j
public class Idea66739Service {
    private static final int IDEA_ID = 66739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66739Service() {
        this(new Idea66739Config());
    }

    public Idea66739Service(Idea66739Config config) {
        this.config = config != null ? config : new Idea66739Config();
