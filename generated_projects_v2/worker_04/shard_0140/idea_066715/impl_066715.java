...
@Data
public class Idea66715Config {
    private String name = "idea_066715";
 ...
 */
@Slf4j
public class Idea66715Service {
    private static final int IDEA_ID = 66715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66715Service() {
        this(new Idea66715Config());
    }

    public Idea66715Service(Idea66715Config config) {
        this.config = config != null ? config : new Idea66715Config();
