...
@Data
public class Idea66571Config {
    private String name = "idea_066571";
 ...
 */
@Slf4j
public class Idea66571Service {
    private static final int IDEA_ID = 66571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66571Service() {
        this(new Idea66571Config());
    }

    public Idea66571Service(Idea66571Config config) {
        this.config = config != null ? config : new Idea66571Config();
