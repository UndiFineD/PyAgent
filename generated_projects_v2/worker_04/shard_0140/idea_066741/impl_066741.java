...
@Data
public class Idea66741Config {
    private String name = "idea_066741";
 ...
 */
@Slf4j
public class Idea66741Service {
    private static final int IDEA_ID = 66741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66741Service() {
        this(new Idea66741Config());
    }

    public Idea66741Service(Idea66741Config config) {
        this.config = config != null ? config : new Idea66741Config();
