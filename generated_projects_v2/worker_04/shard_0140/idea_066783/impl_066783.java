...
@Data
public class Idea66783Config {
    private String name = "idea_066783";
 ...
 */
@Slf4j
public class Idea66783Service {
    private static final int IDEA_ID = 66783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66783Service() {
        this(new Idea66783Config());
    }

    public Idea66783Service(Idea66783Config config) {
        this.config = config != null ? config : new Idea66783Config();
