...
@Data
public class Idea66706Config {
    private String name = "idea_066706";
 ...
 */
@Slf4j
public class Idea66706Service {
    private static final int IDEA_ID = 66706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66706Service() {
        this(new Idea66706Config());
    }

    public Idea66706Service(Idea66706Config config) {
        this.config = config != null ? config : new Idea66706Config();
