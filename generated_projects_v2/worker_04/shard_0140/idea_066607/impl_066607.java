...
@Data
public class Idea66607Config {
    private String name = "idea_066607";
 ...
 */
@Slf4j
public class Idea66607Service {
    private static final int IDEA_ID = 66607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66607Service() {
        this(new Idea66607Config());
    }

    public Idea66607Service(Idea66607Config config) {
        this.config = config != null ? config : new Idea66607Config();
