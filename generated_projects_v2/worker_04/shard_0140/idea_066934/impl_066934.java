...
@Data
public class Idea66934Config {
    private String name = "idea_066934";
 ...
 */
@Slf4j
public class Idea66934Service {
    private static final int IDEA_ID = 66934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66934Service() {
        this(new Idea66934Config());
    }

    public Idea66934Service(Idea66934Config config) {
        this.config = config != null ? config : new Idea66934Config();
