...
@Data
public class Idea66753Config {
    private String name = "idea_066753";
 ...
 */
@Slf4j
public class Idea66753Service {
    private static final int IDEA_ID = 66753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66753Service() {
        this(new Idea66753Config());
    }

    public Idea66753Service(Idea66753Config config) {
        this.config = config != null ? config : new Idea66753Config();
