...
@Data
public class Idea66718Config {
    private String name = "idea_066718";
 ...
 */
@Slf4j
public class Idea66718Service {
    private static final int IDEA_ID = 66718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66718Service() {
        this(new Idea66718Config());
    }

    public Idea66718Service(Idea66718Config config) {
        this.config = config != null ? config : new Idea66718Config();
