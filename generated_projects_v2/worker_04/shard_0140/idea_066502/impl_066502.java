...
@Data
public class Idea66502Config {
    private String name = "idea_066502";
 ...
 */
@Slf4j
public class Idea66502Service {
    private static final int IDEA_ID = 66502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66502Service() {
        this(new Idea66502Config());
    }

    public Idea66502Service(Idea66502Config config) {
        this.config = config != null ? config : new Idea66502Config();
