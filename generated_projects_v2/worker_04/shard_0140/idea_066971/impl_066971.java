...
@Data
public class Idea66971Config {
    private String name = "idea_066971";
 ...
 */
@Slf4j
public class Idea66971Service {
    private static final int IDEA_ID = 66971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66971Service() {
        this(new Idea66971Config());
    }

    public Idea66971Service(Idea66971Config config) {
        this.config = config != null ? config : new Idea66971Config();
