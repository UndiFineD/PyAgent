...
@Data
public class Idea66603Config {
    private String name = "idea_066603";
 ...
 */
@Slf4j
public class Idea66603Service {
    private static final int IDEA_ID = 66603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66603Service() {
        this(new Idea66603Config());
    }

    public Idea66603Service(Idea66603Config config) {
        this.config = config != null ? config : new Idea66603Config();
