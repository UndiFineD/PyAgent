...
@Data
public class Idea66621Config {
    private String name = "idea_066621";
 ...
 */
@Slf4j
public class Idea66621Service {
    private static final int IDEA_ID = 66621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66621Service() {
        this(new Idea66621Config());
    }

    public Idea66621Service(Idea66621Config config) {
        this.config = config != null ? config : new Idea66621Config();
