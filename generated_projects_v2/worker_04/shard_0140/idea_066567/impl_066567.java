...
@Data
public class Idea66567Config {
    private String name = "idea_066567";
 ...
 */
@Slf4j
public class Idea66567Service {
    private static final int IDEA_ID = 66567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66567Service() {
        this(new Idea66567Config());
    }

    public Idea66567Service(Idea66567Config config) {
        this.config = config != null ? config : new Idea66567Config();
