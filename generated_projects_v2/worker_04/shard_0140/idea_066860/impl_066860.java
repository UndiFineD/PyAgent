...
@Data
public class Idea66860Config {
    private String name = "idea_066860";
 ...
 */
@Slf4j
public class Idea66860Service {
    private static final int IDEA_ID = 66860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66860Service() {
        this(new Idea66860Config());
    }

    public Idea66860Service(Idea66860Config config) {
        this.config = config != null ? config : new Idea66860Config();
