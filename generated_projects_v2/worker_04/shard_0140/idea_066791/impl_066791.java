...
@Data
public class Idea66791Config {
    private String name = "idea_066791";
 ...
 */
@Slf4j
public class Idea66791Service {
    private static final int IDEA_ID = 66791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66791Service() {
        this(new Idea66791Config());
    }

    public Idea66791Service(Idea66791Config config) {
        this.config = config != null ? config : new Idea66791Config();
