...
@Data
public class Idea66964Config {
    private String name = "idea_066964";
 ...
 */
@Slf4j
public class Idea66964Service {
    private static final int IDEA_ID = 66964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66964Service() {
        this(new Idea66964Config());
    }

    public Idea66964Service(Idea66964Config config) {
        this.config = config != null ? config : new Idea66964Config();
