...
@Data
public class Idea66821Config {
    private String name = "idea_066821";
 ...
 */
@Slf4j
public class Idea66821Service {
    private static final int IDEA_ID = 66821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66821Service() {
        this(new Idea66821Config());
    }

    public Idea66821Service(Idea66821Config config) {
        this.config = config != null ? config : new Idea66821Config();
