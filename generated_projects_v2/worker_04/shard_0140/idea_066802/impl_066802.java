...
@Data
public class Idea66802Config {
    private String name = "idea_066802";
 ...
 */
@Slf4j
public class Idea66802Service {
    private static final int IDEA_ID = 66802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66802Service() {
        this(new Idea66802Config());
    }

    public Idea66802Service(Idea66802Config config) {
        this.config = config != null ? config : new Idea66802Config();
