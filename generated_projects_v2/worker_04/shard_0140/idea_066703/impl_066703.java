...
@Data
public class Idea66703Config {
    private String name = "idea_066703";
 ...
 */
@Slf4j
public class Idea66703Service {
    private static final int IDEA_ID = 66703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66703Service() {
        this(new Idea66703Config());
    }

    public Idea66703Service(Idea66703Config config) {
        this.config = config != null ? config : new Idea66703Config();
