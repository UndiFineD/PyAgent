...
@Data
public class Idea66958Config {
    private String name = "idea_066958";
 ...
 */
@Slf4j
public class Idea66958Service {
    private static final int IDEA_ID = 66958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66958Service() {
        this(new Idea66958Config());
    }

    public Idea66958Service(Idea66958Config config) {
        this.config = config != null ? config : new Idea66958Config();
