...
@Data
public class Idea66817Config {
    private String name = "idea_066817";
 ...
 */
@Slf4j
public class Idea66817Service {
    private static final int IDEA_ID = 66817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66817Service() {
        this(new Idea66817Config());
    }

    public Idea66817Service(Idea66817Config config) {
        this.config = config != null ? config : new Idea66817Config();
