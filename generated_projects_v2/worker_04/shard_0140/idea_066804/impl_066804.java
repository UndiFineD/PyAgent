...
@Data
public class Idea66804Config {
    private String name = "idea_066804";
 ...
 */
@Slf4j
public class Idea66804Service {
    private static final int IDEA_ID = 66804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66804Service() {
        this(new Idea66804Config());
    }

    public Idea66804Service(Idea66804Config config) {
        this.config = config != null ? config : new Idea66804Config();
