...
@Data
public class Idea66518Config {
    private String name = "idea_066518";
 ...
 */
@Slf4j
public class Idea66518Service {
    private static final int IDEA_ID = 66518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66518Service() {
        this(new Idea66518Config());
    }

    public Idea66518Service(Idea66518Config config) {
        this.config = config != null ? config : new Idea66518Config();
