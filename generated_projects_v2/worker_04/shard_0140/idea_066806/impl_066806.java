...
@Data
public class Idea66806Config {
    private String name = "idea_066806";
 ...
 */
@Slf4j
public class Idea66806Service {
    private static final int IDEA_ID = 66806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66806Service() {
        this(new Idea66806Config());
    }

    public Idea66806Service(Idea66806Config config) {
        this.config = config != null ? config : new Idea66806Config();
