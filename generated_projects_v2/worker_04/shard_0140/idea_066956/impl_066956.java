...
@Data
public class Idea66956Config {
    private String name = "idea_066956";
 ...
 */
@Slf4j
public class Idea66956Service {
    private static final int IDEA_ID = 66956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66956Service() {
        this(new Idea66956Config());
    }

    public Idea66956Service(Idea66956Config config) {
        this.config = config != null ? config : new Idea66956Config();
