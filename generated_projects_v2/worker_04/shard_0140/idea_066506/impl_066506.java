...
@Data
public class Idea66506Config {
    private String name = "idea_066506";
 ...
 */
@Slf4j
public class Idea66506Service {
    private static final int IDEA_ID = 66506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66506Service() {
        this(new Idea66506Config());
    }

    public Idea66506Service(Idea66506Config config) {
        this.config = config != null ? config : new Idea66506Config();
