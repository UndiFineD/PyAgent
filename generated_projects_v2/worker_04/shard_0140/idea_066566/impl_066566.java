...
@Data
public class Idea66566Config {
    private String name = "idea_066566";
 ...
 */
@Slf4j
public class Idea66566Service {
    private static final int IDEA_ID = 66566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66566Service() {
        this(new Idea66566Config());
    }

    public Idea66566Service(Idea66566Config config) {
        this.config = config != null ? config : new Idea66566Config();
