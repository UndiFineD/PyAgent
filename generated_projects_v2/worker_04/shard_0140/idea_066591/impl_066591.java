...
@Data
public class Idea66591Config {
    private String name = "idea_066591";
 ...
 */
@Slf4j
public class Idea66591Service {
    private static final int IDEA_ID = 66591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66591Service() {
        this(new Idea66591Config());
    }

    public Idea66591Service(Idea66591Config config) {
        this.config = config != null ? config : new Idea66591Config();
