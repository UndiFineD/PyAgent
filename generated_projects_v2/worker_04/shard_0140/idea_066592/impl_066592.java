...
@Data
public class Idea66592Config {
    private String name = "idea_066592";
 ...
 */
@Slf4j
public class Idea66592Service {
    private static final int IDEA_ID = 66592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66592Service() {
        this(new Idea66592Config());
    }

    public Idea66592Service(Idea66592Config config) {
        this.config = config != null ? config : new Idea66592Config();
