...
@Data
public class Idea66935Config {
    private String name = "idea_066935";
 ...
 */
@Slf4j
public class Idea66935Service {
    private static final int IDEA_ID = 66935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66935Service() {
        this(new Idea66935Config());
    }

    public Idea66935Service(Idea66935Config config) {
        this.config = config != null ? config : new Idea66935Config();
