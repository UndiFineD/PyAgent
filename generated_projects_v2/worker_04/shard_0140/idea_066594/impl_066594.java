...
@Data
public class Idea66594Config {
    private String name = "idea_066594";
 ...
 */
@Slf4j
public class Idea66594Service {
    private static final int IDEA_ID = 66594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66594Service() {
        this(new Idea66594Config());
    }

    public Idea66594Service(Idea66594Config config) {
        this.config = config != null ? config : new Idea66594Config();
