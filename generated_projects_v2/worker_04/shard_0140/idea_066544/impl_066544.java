...
@Data
public class Idea66544Config {
    private String name = "idea_066544";
 ...
 */
@Slf4j
public class Idea66544Service {
    private static final int IDEA_ID = 66544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66544Service() {
        this(new Idea66544Config());
    }

    public Idea66544Service(Idea66544Config config) {
        this.config = config != null ? config : new Idea66544Config();
