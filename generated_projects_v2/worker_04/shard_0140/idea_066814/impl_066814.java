...
@Data
public class Idea66814Config {
    private String name = "idea_066814";
 ...
 */
@Slf4j
public class Idea66814Service {
    private static final int IDEA_ID = 66814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66814Service() {
        this(new Idea66814Config());
    }

    public Idea66814Service(Idea66814Config config) {
        this.config = config != null ? config : new Idea66814Config();
