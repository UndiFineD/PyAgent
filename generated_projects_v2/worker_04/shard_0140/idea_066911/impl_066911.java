...
@Data
public class Idea66911Config {
    private String name = "idea_066911";
 ...
 */
@Slf4j
public class Idea66911Service {
    private static final int IDEA_ID = 66911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66911Service() {
        this(new Idea66911Config());
    }

    public Idea66911Service(Idea66911Config config) {
        this.config = config != null ? config : new Idea66911Config();
