...
@Data
public class Idea66720Config {
    private String name = "idea_066720";
 ...
 */
@Slf4j
public class Idea66720Service {
    private static final int IDEA_ID = 66720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66720Service() {
        this(new Idea66720Config());
    }

    public Idea66720Service(Idea66720Config config) {
        this.config = config != null ? config : new Idea66720Config();
