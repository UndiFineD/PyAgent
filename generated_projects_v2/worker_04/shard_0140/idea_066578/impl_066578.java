...
@Data
public class Idea66578Config {
    private String name = "idea_066578";
 ...
 */
@Slf4j
public class Idea66578Service {
    private static final int IDEA_ID = 66578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66578Service() {
        this(new Idea66578Config());
    }

    public Idea66578Service(Idea66578Config config) {
        this.config = config != null ? config : new Idea66578Config();
