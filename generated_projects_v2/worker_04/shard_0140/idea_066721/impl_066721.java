...
@Data
public class Idea66721Config {
    private String name = "idea_066721";
 ...
 */
@Slf4j
public class Idea66721Service {
    private static final int IDEA_ID = 66721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66721Service() {
        this(new Idea66721Config());
    }

    public Idea66721Service(Idea66721Config config) {
        this.config = config != null ? config : new Idea66721Config();
