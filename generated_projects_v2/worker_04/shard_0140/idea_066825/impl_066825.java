...
@Data
public class Idea66825Config {
    private String name = "idea_066825";
 ...
 */
@Slf4j
public class Idea66825Service {
    private static final int IDEA_ID = 66825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66825Service() {
        this(new Idea66825Config());
    }

    public Idea66825Service(Idea66825Config config) {
        this.config = config != null ? config : new Idea66825Config();
