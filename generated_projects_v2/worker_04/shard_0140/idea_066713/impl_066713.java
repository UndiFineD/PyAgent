...
@Data
public class Idea66713Config {
    private String name = "idea_066713";
 ...
 */
@Slf4j
public class Idea66713Service {
    private static final int IDEA_ID = 66713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66713Service() {
        this(new Idea66713Config());
    }

    public Idea66713Service(Idea66713Config config) {
        this.config = config != null ? config : new Idea66713Config();
