...
@Data
public class Idea66837Config {
    private String name = "idea_066837";
 ...
 */
@Slf4j
public class Idea66837Service {
    private static final int IDEA_ID = 66837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66837Service() {
        this(new Idea66837Config());
    }

    public Idea66837Service(Idea66837Config config) {
        this.config = config != null ? config : new Idea66837Config();
