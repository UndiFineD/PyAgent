...
@Data
public class Idea66797Config {
    private String name = "idea_066797";
 ...
 */
@Slf4j
public class Idea66797Service {
    private static final int IDEA_ID = 66797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66797Service() {
        this(new Idea66797Config());
    }

    public Idea66797Service(Idea66797Config config) {
        this.config = config != null ? config : new Idea66797Config();
