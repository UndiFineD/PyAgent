...
@Data
public class Idea66560Config {
    private String name = "idea_066560";
 ...
 */
@Slf4j
public class Idea66560Service {
    private static final int IDEA_ID = 66560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66560Service() {
        this(new Idea66560Config());
    }

    public Idea66560Service(Idea66560Config config) {
        this.config = config != null ? config : new Idea66560Config();
