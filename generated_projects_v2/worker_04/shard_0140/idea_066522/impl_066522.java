...
@Data
public class Idea66522Config {
    private String name = "idea_066522";
 ...
 */
@Slf4j
public class Idea66522Service {
    private static final int IDEA_ID = 66522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66522Service() {
        this(new Idea66522Config());
    }

    public Idea66522Service(Idea66522Config config) {
        this.config = config != null ? config : new Idea66522Config();
