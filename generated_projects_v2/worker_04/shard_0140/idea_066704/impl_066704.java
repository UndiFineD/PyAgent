...
@Data
public class Idea66704Config {
    private String name = "idea_066704";
 ...
 */
@Slf4j
public class Idea66704Service {
    private static final int IDEA_ID = 66704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66704Service() {
        this(new Idea66704Config());
    }

    public Idea66704Service(Idea66704Config config) {
        this.config = config != null ? config : new Idea66704Config();
