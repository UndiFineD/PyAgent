...
@Data
public class Idea66838Config {
    private String name = "idea_066838";
 ...
 */
@Slf4j
public class Idea66838Service {
    private static final int IDEA_ID = 66838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66838Service() {
        this(new Idea66838Config());
    }

    public Idea66838Service(Idea66838Config config) {
        this.config = config != null ? config : new Idea66838Config();
