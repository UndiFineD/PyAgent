...
@Data
public class Idea66949Config {
    private String name = "idea_066949";
 ...
 */
@Slf4j
public class Idea66949Service {
    private static final int IDEA_ID = 66949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66949Service() {
        this(new Idea66949Config());
    }

    public Idea66949Service(Idea66949Config config) {
        this.config = config != null ? config : new Idea66949Config();
