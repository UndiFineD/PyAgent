...
@Data
public class Idea66901Config {
    private String name = "idea_066901";
 ...
 */
@Slf4j
public class Idea66901Service {
    private static final int IDEA_ID = 66901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66901Service() {
        this(new Idea66901Config());
    }

    public Idea66901Service(Idea66901Config config) {
        this.config = config != null ? config : new Idea66901Config();
