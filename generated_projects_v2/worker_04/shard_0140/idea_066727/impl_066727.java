...
@Data
public class Idea66727Config {
    private String name = "idea_066727";
 ...
 */
@Slf4j
public class Idea66727Service {
    private static final int IDEA_ID = 66727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66727Service() {
        this(new Idea66727Config());
    }

    public Idea66727Service(Idea66727Config config) {
        this.config = config != null ? config : new Idea66727Config();
