...
@Data
public class Idea66833Config {
    private String name = "idea_066833";
 ...
 */
@Slf4j
public class Idea66833Service {
    private static final int IDEA_ID = 66833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66833Service() {
        this(new Idea66833Config());
    }

    public Idea66833Service(Idea66833Config config) {
        this.config = config != null ? config : new Idea66833Config();
