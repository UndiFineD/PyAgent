...
@Data
public class Idea66650Config {
    private String name = "idea_066650";
 ...
 */
@Slf4j
public class Idea66650Service {
    private static final int IDEA_ID = 66650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66650Service() {
        this(new Idea66650Config());
    }

    public Idea66650Service(Idea66650Config config) {
        this.config = config != null ? config : new Idea66650Config();
