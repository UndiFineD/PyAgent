...
@Data
public class Idea66861Config {
    private String name = "idea_066861";
 ...
 */
@Slf4j
public class Idea66861Service {
    private static final int IDEA_ID = 66861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66861Service() {
        this(new Idea66861Config());
    }

    public Idea66861Service(Idea66861Config config) {
        this.config = config != null ? config : new Idea66861Config();
