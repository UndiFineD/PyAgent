...
@Data
public class Idea66700Config {
    private String name = "idea_066700";
 ...
 */
@Slf4j
public class Idea66700Service {
    private static final int IDEA_ID = 66700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66700Service() {
        this(new Idea66700Config());
    }

    public Idea66700Service(Idea66700Config config) {
        this.config = config != null ? config : new Idea66700Config();
