...
@Data
public class Idea66505Config {
    private String name = "idea_066505";
 ...
 */
@Slf4j
public class Idea66505Service {
    private static final int IDEA_ID = 66505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66505Service() {
        this(new Idea66505Config());
    }

    public Idea66505Service(Idea66505Config config) {
        this.config = config != null ? config : new Idea66505Config();
