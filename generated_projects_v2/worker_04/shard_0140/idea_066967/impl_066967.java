...
@Data
public class Idea66967Config {
    private String name = "idea_066967";
 ...
 */
@Slf4j
public class Idea66967Service {
    private static final int IDEA_ID = 66967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66967Service() {
        this(new Idea66967Config());
    }

    public Idea66967Service(Idea66967Config config) {
        this.config = config != null ? config : new Idea66967Config();
