...
@Data
public class Idea66660Config {
    private String name = "idea_066660";
 ...
 */
@Slf4j
public class Idea66660Service {
    private static final int IDEA_ID = 66660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66660Service() {
        this(new Idea66660Config());
    }

    public Idea66660Service(Idea66660Config config) {
        this.config = config != null ? config : new Idea66660Config();
