...
@Data
public class Idea66777Config {
    private String name = "idea_066777";
 ...
 */
@Slf4j
public class Idea66777Service {
    private static final int IDEA_ID = 66777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66777Service() {
        this(new Idea66777Config());
    }

    public Idea66777Service(Idea66777Config config) {
        this.config = config != null ? config : new Idea66777Config();
