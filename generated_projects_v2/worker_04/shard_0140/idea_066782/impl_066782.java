...
@Data
public class Idea66782Config {
    private String name = "idea_066782";
 ...
 */
@Slf4j
public class Idea66782Service {
    private static final int IDEA_ID = 66782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66782Service() {
        this(new Idea66782Config());
    }

    public Idea66782Service(Idea66782Config config) {
        this.config = config != null ? config : new Idea66782Config();
