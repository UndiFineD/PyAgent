...
@Data
public class Idea66626Config {
    private String name = "idea_066626";
 ...
 */
@Slf4j
public class Idea66626Service {
    private static final int IDEA_ID = 66626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66626Service() {
        this(new Idea66626Config());
    }

    public Idea66626Service(Idea66626Config config) {
        this.config = config != null ? config : new Idea66626Config();
