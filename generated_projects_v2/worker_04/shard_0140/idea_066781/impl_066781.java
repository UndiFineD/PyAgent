...
@Data
public class Idea66781Config {
    private String name = "idea_066781";
 ...
 */
@Slf4j
public class Idea66781Service {
    private static final int IDEA_ID = 66781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66781Service() {
        this(new Idea66781Config());
    }

    public Idea66781Service(Idea66781Config config) {
        this.config = config != null ? config : new Idea66781Config();
