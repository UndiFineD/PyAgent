...
@Data
public class Idea66500Config {
    private String name = "idea_066500";
 ...
 */
@Slf4j
public class Idea66500Service {
    private static final int IDEA_ID = 66500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66500Service() {
        this(new Idea66500Config());
    }

    public Idea66500Service(Idea66500Config config) {
        this.config = config != null ? config : new Idea66500Config();
