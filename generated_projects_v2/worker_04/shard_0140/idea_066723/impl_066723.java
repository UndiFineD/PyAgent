...
@Data
public class Idea66723Config {
    private String name = "idea_066723";
 ...
 */
@Slf4j
public class Idea66723Service {
    private static final int IDEA_ID = 66723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66723Service() {
        this(new Idea66723Config());
    }

    public Idea66723Service(Idea66723Config config) {
        this.config = config != null ? config : new Idea66723Config();
