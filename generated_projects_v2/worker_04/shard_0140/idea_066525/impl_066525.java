...
@Data
public class Idea66525Config {
    private String name = "idea_066525";
 ...
 */
@Slf4j
public class Idea66525Service {
    private static final int IDEA_ID = 66525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66525Service() {
        this(new Idea66525Config());
    }

    public Idea66525Service(Idea66525Config config) {
        this.config = config != null ? config : new Idea66525Config();
