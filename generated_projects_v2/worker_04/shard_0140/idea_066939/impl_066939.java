...
@Data
public class Idea66939Config {
    private String name = "idea_066939";
 ...
 */
@Slf4j
public class Idea66939Service {
    private static final int IDEA_ID = 66939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66939Service() {
        this(new Idea66939Config());
    }

    public Idea66939Service(Idea66939Config config) {
        this.config = config != null ? config : new Idea66939Config();
