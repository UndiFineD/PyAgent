...
@Data
public class Idea66600Config {
    private String name = "idea_066600";
 ...
 */
@Slf4j
public class Idea66600Service {
    private static final int IDEA_ID = 66600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66600Service() {
        this(new Idea66600Config());
    }

    public Idea66600Service(Idea66600Config config) {
        this.config = config != null ? config : new Idea66600Config();
