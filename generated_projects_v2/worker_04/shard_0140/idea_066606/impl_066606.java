...
@Data
public class Idea66606Config {
    private String name = "idea_066606";
 ...
 */
@Slf4j
public class Idea66606Service {
    private static final int IDEA_ID = 66606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66606Service() {
        this(new Idea66606Config());
    }

    public Idea66606Service(Idea66606Config config) {
        this.config = config != null ? config : new Idea66606Config();
