...
@Data
public class Idea66925Config {
    private String name = "idea_066925";
 ...
 */
@Slf4j
public class Idea66925Service {
    private static final int IDEA_ID = 66925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66925Service() {
        this(new Idea66925Config());
    }

    public Idea66925Service(Idea66925Config config) {
        this.config = config != null ? config : new Idea66925Config();
