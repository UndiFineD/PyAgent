...
@Data
public class Idea66677Config {
    private String name = "idea_066677";
 ...
 */
@Slf4j
public class Idea66677Service {
    private static final int IDEA_ID = 66677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66677Service() {
        this(new Idea66677Config());
    }

    public Idea66677Service(Idea66677Config config) {
        this.config = config != null ? config : new Idea66677Config();
