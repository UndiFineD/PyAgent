...
@Data
public class Idea66733Config {
    private String name = "idea_066733";
 ...
 */
@Slf4j
public class Idea66733Service {
    private static final int IDEA_ID = 66733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66733Service() {
        this(new Idea66733Config());
    }

    public Idea66733Service(Idea66733Config config) {
        this.config = config != null ? config : new Idea66733Config();
