...
@Data
public class Idea66761Config {
    private String name = "idea_066761";
 ...
 */
@Slf4j
public class Idea66761Service {
    private static final int IDEA_ID = 66761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66761Service() {
        this(new Idea66761Config());
    }

    public Idea66761Service(Idea66761Config config) {
        this.config = config != null ? config : new Idea66761Config();
