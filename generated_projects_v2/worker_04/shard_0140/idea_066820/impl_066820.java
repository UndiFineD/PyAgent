...
@Data
public class Idea66820Config {
    private String name = "idea_066820";
 ...
 */
@Slf4j
public class Idea66820Service {
    private static final int IDEA_ID = 66820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66820Service() {
        this(new Idea66820Config());
    }

    public Idea66820Service(Idea66820Config config) {
        this.config = config != null ? config : new Idea66820Config();
