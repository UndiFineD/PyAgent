...
@Data
public class Idea66624Config {
    private String name = "idea_066624";
 ...
 */
@Slf4j
public class Idea66624Service {
    private static final int IDEA_ID = 66624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66624Service() {
        this(new Idea66624Config());
    }

    public Idea66624Service(Idea66624Config config) {
        this.config = config != null ? config : new Idea66624Config();
