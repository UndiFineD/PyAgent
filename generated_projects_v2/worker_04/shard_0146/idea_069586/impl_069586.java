...
@Data
public class Idea69586Config {
    private String name = "idea_069586";
 ...
 */
@Slf4j
public class Idea69586Service {
    private static final int IDEA_ID = 69586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69586Service() {
        this(new Idea69586Config());
    }

    public Idea69586Service(Idea69586Config config) {
        this.config = config != null ? config : new Idea69586Config();
