...
@Data
public class Idea69718Config {
    private String name = "idea_069718";
 ...
 */
@Slf4j
public class Idea69718Service {
    private static final int IDEA_ID = 69718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69718Service() {
        this(new Idea69718Config());
    }

    public Idea69718Service(Idea69718Config config) {
        this.config = config != null ? config : new Idea69718Config();
