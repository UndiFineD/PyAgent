...
@Data
public class Idea69612Config {
    private String name = "idea_069612";
 ...
 */
@Slf4j
public class Idea69612Service {
    private static final int IDEA_ID = 69612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69612Service() {
        this(new Idea69612Config());
    }

    public Idea69612Service(Idea69612Config config) {
        this.config = config != null ? config : new Idea69612Config();
