...
@Data
public class Idea69703Config {
    private String name = "idea_069703";
 ...
 */
@Slf4j
public class Idea69703Service {
    private static final int IDEA_ID = 69703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69703Service() {
        this(new Idea69703Config());
    }

    public Idea69703Service(Idea69703Config config) {
        this.config = config != null ? config : new Idea69703Config();
