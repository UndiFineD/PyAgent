...
@Data
public class Idea69406Config {
    private String name = "idea_069406";
 ...
 */
@Slf4j
public class Idea69406Service {
    private static final int IDEA_ID = 69406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69406Service() {
        this(new Idea69406Config());
    }

    public Idea69406Service(Idea69406Config config) {
        this.config = config != null ? config : new Idea69406Config();
