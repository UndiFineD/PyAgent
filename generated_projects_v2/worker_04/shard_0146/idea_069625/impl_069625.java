...
@Data
public class Idea69625Config {
    private String name = "idea_069625";
 ...
 */
@Slf4j
public class Idea69625Service {
    private static final int IDEA_ID = 69625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69625Service() {
        this(new Idea69625Config());
    }

    public Idea69625Service(Idea69625Config config) {
        this.config = config != null ? config : new Idea69625Config();
