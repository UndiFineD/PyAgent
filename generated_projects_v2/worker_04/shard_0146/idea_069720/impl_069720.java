...
@Data
public class Idea69720Config {
    private String name = "idea_069720";
 ...
 */
@Slf4j
public class Idea69720Service {
    private static final int IDEA_ID = 69720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69720Service() {
        this(new Idea69720Config());
    }

    public Idea69720Service(Idea69720Config config) {
        this.config = config != null ? config : new Idea69720Config();
