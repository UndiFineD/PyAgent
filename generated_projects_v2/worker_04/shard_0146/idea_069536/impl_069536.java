...
@Data
public class Idea69536Config {
    private String name = "idea_069536";
 ...
 */
@Slf4j
public class Idea69536Service {
    private static final int IDEA_ID = 69536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69536Service() {
        this(new Idea69536Config());
    }

    public Idea69536Service(Idea69536Config config) {
        this.config = config != null ? config : new Idea69536Config();
