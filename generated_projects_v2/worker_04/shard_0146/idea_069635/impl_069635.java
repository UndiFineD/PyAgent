...
@Data
public class Idea69635Config {
    private String name = "idea_069635";
 ...
 */
@Slf4j
public class Idea69635Service {
    private static final int IDEA_ID = 69635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69635Service() {
        this(new Idea69635Config());
    }

    public Idea69635Service(Idea69635Config config) {
        this.config = config != null ? config : new Idea69635Config();
