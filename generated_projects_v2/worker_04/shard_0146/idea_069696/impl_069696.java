...
@Data
public class Idea69696Config {
    private String name = "idea_069696";
 ...
 */
@Slf4j
public class Idea69696Service {
    private static final int IDEA_ID = 69696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69696Service() {
        this(new Idea69696Config());
    }

    public Idea69696Service(Idea69696Config config) {
        this.config = config != null ? config : new Idea69696Config();
