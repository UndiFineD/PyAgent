...
@Data
public class Idea69388Config {
    private String name = "idea_069388";
 ...
 */
@Slf4j
public class Idea69388Service {
    private static final int IDEA_ID = 69388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69388Service() {
        this(new Idea69388Config());
    }

    public Idea69388Service(Idea69388Config config) {
        this.config = config != null ? config : new Idea69388Config();
