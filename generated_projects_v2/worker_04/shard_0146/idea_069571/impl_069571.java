...
@Data
public class Idea69571Config {
    private String name = "idea_069571";
 ...
 */
@Slf4j
public class Idea69571Service {
    private static final int IDEA_ID = 69571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69571Service() {
        this(new Idea69571Config());
    }

    public Idea69571Service(Idea69571Config config) {
        this.config = config != null ? config : new Idea69571Config();
