...
@Data
public class Idea69771Config {
    private String name = "idea_069771";
 ...
 */
@Slf4j
public class Idea69771Service {
    private static final int IDEA_ID = 69771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69771Service() {
        this(new Idea69771Config());
    }

    public Idea69771Service(Idea69771Config config) {
        this.config = config != null ? config : new Idea69771Config();
