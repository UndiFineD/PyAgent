...
@Data
public class Idea69801Config {
    private String name = "idea_069801";
 ...
 */
@Slf4j
public class Idea69801Service {
    private static final int IDEA_ID = 69801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69801Service() {
        this(new Idea69801Config());
    }

    public Idea69801Service(Idea69801Config config) {
        this.config = config != null ? config : new Idea69801Config();
