...
@Data
public class Idea69798Config {
    private String name = "idea_069798";
 ...
 */
@Slf4j
public class Idea69798Service {
    private static final int IDEA_ID = 69798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69798Service() {
        this(new Idea69798Config());
    }

    public Idea69798Service(Idea69798Config config) {
        this.config = config != null ? config : new Idea69798Config();
