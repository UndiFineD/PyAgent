...
@Data
public class Idea69797Config {
    private String name = "idea_069797";
 ...
 */
@Slf4j
public class Idea69797Service {
    private static final int IDEA_ID = 69797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69797Service() {
        this(new Idea69797Config());
    }

    public Idea69797Service(Idea69797Config config) {
        this.config = config != null ? config : new Idea69797Config();
