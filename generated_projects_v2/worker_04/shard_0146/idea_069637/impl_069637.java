...
@Data
public class Idea69637Config {
    private String name = "idea_069637";
 ...
 */
@Slf4j
public class Idea69637Service {
    private static final int IDEA_ID = 69637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69637Service() {
        this(new Idea69637Config());
    }

    public Idea69637Service(Idea69637Config config) {
        this.config = config != null ? config : new Idea69637Config();
