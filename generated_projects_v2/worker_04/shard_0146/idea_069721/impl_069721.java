...
@Data
public class Idea69721Config {
    private String name = "idea_069721";
 ...
 */
@Slf4j
public class Idea69721Service {
    private static final int IDEA_ID = 69721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69721Service() {
        this(new Idea69721Config());
    }

    public Idea69721Service(Idea69721Config config) {
        this.config = config != null ? config : new Idea69721Config();
