...
@Data
public class Idea69791Config {
    private String name = "idea_069791";
 ...
 */
@Slf4j
public class Idea69791Service {
    private static final int IDEA_ID = 69791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69791Service() {
        this(new Idea69791Config());
    }

    public Idea69791Service(Idea69791Config config) {
        this.config = config != null ? config : new Idea69791Config();
