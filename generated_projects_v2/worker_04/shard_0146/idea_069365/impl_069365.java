...
@Data
public class Idea69365Config {
    private String name = "idea_069365";
 ...
 */
@Slf4j
public class Idea69365Service {
    private static final int IDEA_ID = 69365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69365Service() {
        this(new Idea69365Config());
    }

    public Idea69365Service(Idea69365Config config) {
        this.config = config != null ? config : new Idea69365Config();
