...
@Data
public class Idea69474Config {
    private String name = "idea_069474";
 ...
 */
@Slf4j
public class Idea69474Service {
    private static final int IDEA_ID = 69474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69474Service() {
        this(new Idea69474Config());
    }

    public Idea69474Service(Idea69474Config config) {
        this.config = config != null ? config : new Idea69474Config();
