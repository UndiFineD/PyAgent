...
@Data
public class Idea69697Config {
    private String name = "idea_069697";
 ...
 */
@Slf4j
public class Idea69697Service {
    private static final int IDEA_ID = 69697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69697Service() {
        this(new Idea69697Config());
    }

    public Idea69697Service(Idea69697Config config) {
        this.config = config != null ? config : new Idea69697Config();
