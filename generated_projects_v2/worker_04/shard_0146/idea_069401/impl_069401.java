...
@Data
public class Idea69401Config {
    private String name = "idea_069401";
 ...
 */
@Slf4j
public class Idea69401Service {
    private static final int IDEA_ID = 69401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69401Service() {
        this(new Idea69401Config());
    }

    public Idea69401Service(Idea69401Config config) {
        this.config = config != null ? config : new Idea69401Config();
