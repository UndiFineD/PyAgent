...
@Data
public class Idea69587Config {
    private String name = "idea_069587";
 ...
 */
@Slf4j
public class Idea69587Service {
    private static final int IDEA_ID = 69587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69587Service() {
        this(new Idea69587Config());
    }

    public Idea69587Service(Idea69587Config config) {
        this.config = config != null ? config : new Idea69587Config();
