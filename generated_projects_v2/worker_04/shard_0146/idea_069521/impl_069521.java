...
@Data
public class Idea69521Config {
    private String name = "idea_069521";
 ...
 */
@Slf4j
public class Idea69521Service {
    private static final int IDEA_ID = 69521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69521Service() {
        this(new Idea69521Config());
    }

    public Idea69521Service(Idea69521Config config) {
        this.config = config != null ? config : new Idea69521Config();
