...
@Data
public class Idea69754Config {
    private String name = "idea_069754";
 ...
 */
@Slf4j
public class Idea69754Service {
    private static final int IDEA_ID = 69754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69754Service() {
        this(new Idea69754Config());
    }

    public Idea69754Service(Idea69754Config config) {
        this.config = config != null ? config : new Idea69754Config();
