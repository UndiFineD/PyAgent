...
@Data
public class Idea69502Config {
    private String name = "idea_069502";
 ...
 */
@Slf4j
public class Idea69502Service {
    private static final int IDEA_ID = 69502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69502Service() {
        this(new Idea69502Config());
    }

    public Idea69502Service(Idea69502Config config) {
        this.config = config != null ? config : new Idea69502Config();
