...
@Data
public class Idea69725Config {
    private String name = "idea_069725";
 ...
 */
@Slf4j
public class Idea69725Service {
    private static final int IDEA_ID = 69725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69725Service() {
        this(new Idea69725Config());
    }

    public Idea69725Service(Idea69725Config config) {
        this.config = config != null ? config : new Idea69725Config();
