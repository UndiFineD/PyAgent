...
@Data
public class Idea69764Config {
    private String name = "idea_069764";
 ...
 */
@Slf4j
public class Idea69764Service {
    private static final int IDEA_ID = 69764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69764Service() {
        this(new Idea69764Config());
    }

    public Idea69764Service(Idea69764Config config) {
        this.config = config != null ? config : new Idea69764Config();
