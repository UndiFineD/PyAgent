...
@Data
public class Idea69770Config {
    private String name = "idea_069770";
 ...
 */
@Slf4j
public class Idea69770Service {
    private static final int IDEA_ID = 69770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69770Service() {
        this(new Idea69770Config());
    }

    public Idea69770Service(Idea69770Config config) {
        this.config = config != null ? config : new Idea69770Config();
