...
@Data
public class Idea69621Config {
    private String name = "idea_069621";
 ...
 */
@Slf4j
public class Idea69621Service {
    private static final int IDEA_ID = 69621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69621Service() {
        this(new Idea69621Config());
    }

    public Idea69621Service(Idea69621Config config) {
        this.config = config != null ? config : new Idea69621Config();
