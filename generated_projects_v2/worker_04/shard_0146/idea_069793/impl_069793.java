...
@Data
public class Idea69793Config {
    private String name = "idea_069793";
 ...
 */
@Slf4j
public class Idea69793Service {
    private static final int IDEA_ID = 69793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69793Service() {
        this(new Idea69793Config());
    }

    public Idea69793Service(Idea69793Config config) {
        this.config = config != null ? config : new Idea69793Config();
