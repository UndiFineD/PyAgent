...
@Data
public class Idea69731Config {
    private String name = "idea_069731";
 ...
 */
@Slf4j
public class Idea69731Service {
    private static final int IDEA_ID = 69731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69731Service() {
        this(new Idea69731Config());
    }

    public Idea69731Service(Idea69731Config config) {
        this.config = config != null ? config : new Idea69731Config();
