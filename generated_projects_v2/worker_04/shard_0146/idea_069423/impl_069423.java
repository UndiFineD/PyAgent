...
@Data
public class Idea69423Config {
    private String name = "idea_069423";
 ...
 */
@Slf4j
public class Idea69423Service {
    private static final int IDEA_ID = 69423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69423Service() {
        this(new Idea69423Config());
    }

    public Idea69423Service(Idea69423Config config) {
        this.config = config != null ? config : new Idea69423Config();
