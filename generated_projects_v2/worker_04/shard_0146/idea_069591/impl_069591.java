...
@Data
public class Idea69591Config {
    private String name = "idea_069591";
 ...
 */
@Slf4j
public class Idea69591Service {
    private static final int IDEA_ID = 69591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69591Service() {
        this(new Idea69591Config());
    }

    public Idea69591Service(Idea69591Config config) {
        this.config = config != null ? config : new Idea69591Config();
