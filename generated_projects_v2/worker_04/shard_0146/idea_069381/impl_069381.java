...
@Data
public class Idea69381Config {
    private String name = "idea_069381";
 ...
 */
@Slf4j
public class Idea69381Service {
    private static final int IDEA_ID = 69381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69381Service() {
        this(new Idea69381Config());
    }

    public Idea69381Service(Idea69381Config config) {
        this.config = config != null ? config : new Idea69381Config();
