...
@Data
public class Idea69570Config {
    private String name = "idea_069570";
 ...
 */
@Slf4j
public class Idea69570Service {
    private static final int IDEA_ID = 69570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69570Service() {
        this(new Idea69570Config());
    }

    public Idea69570Service(Idea69570Config config) {
        this.config = config != null ? config : new Idea69570Config();
