...
@Data
public class Idea69439Config {
    private String name = "idea_069439";
 ...
 */
@Slf4j
public class Idea69439Service {
    private static final int IDEA_ID = 69439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69439Service() {
        this(new Idea69439Config());
    }

    public Idea69439Service(Idea69439Config config) {
        this.config = config != null ? config : new Idea69439Config();
