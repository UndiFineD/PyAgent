...
@Data
public class Idea69633Config {
    private String name = "idea_069633";
 ...
 */
@Slf4j
public class Idea69633Service {
    private static final int IDEA_ID = 69633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69633Service() {
        this(new Idea69633Config());
    }

    public Idea69633Service(Idea69633Config config) {
        this.config = config != null ? config : new Idea69633Config();
