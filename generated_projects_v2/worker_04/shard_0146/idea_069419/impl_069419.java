...
@Data
public class Idea69419Config {
    private String name = "idea_069419";
 ...
 */
@Slf4j
public class Idea69419Service {
    private static final int IDEA_ID = 69419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69419Service() {
        this(new Idea69419Config());
    }

    public Idea69419Service(Idea69419Config config) {
        this.config = config != null ? config : new Idea69419Config();
