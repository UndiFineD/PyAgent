...
@Data
public class Idea69802Config {
    private String name = "idea_069802";
 ...
 */
@Slf4j
public class Idea69802Service {
    private static final int IDEA_ID = 69802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69802Service() {
        this(new Idea69802Config());
    }

    public Idea69802Service(Idea69802Config config) {
        this.config = config != null ? config : new Idea69802Config();
