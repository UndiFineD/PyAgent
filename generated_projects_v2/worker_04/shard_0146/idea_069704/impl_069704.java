...
@Data
public class Idea69704Config {
    private String name = "idea_069704";
 ...
 */
@Slf4j
public class Idea69704Service {
    private static final int IDEA_ID = 69704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69704Service() {
        this(new Idea69704Config());
    }

    public Idea69704Service(Idea69704Config config) {
        this.config = config != null ? config : new Idea69704Config();
