...
@Data
public class Idea69670Config {
    private String name = "idea_069670";
 ...
 */
@Slf4j
public class Idea69670Service {
    private static final int IDEA_ID = 69670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69670Service() {
        this(new Idea69670Config());
    }

    public Idea69670Service(Idea69670Config config) {
        this.config = config != null ? config : new Idea69670Config();
