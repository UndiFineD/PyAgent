...
@Data
public class Idea69639Config {
    private String name = "idea_069639";
 ...
 */
@Slf4j
public class Idea69639Service {
    private static final int IDEA_ID = 69639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69639Service() {
        this(new Idea69639Config());
    }

    public Idea69639Service(Idea69639Config config) {
        this.config = config != null ? config : new Idea69639Config();
