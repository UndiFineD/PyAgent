...
@Data
public class Idea62848Config {
    private String name = "idea_062848";
 ...
 */
@Slf4j
public class Idea62848Service {
    private static final int IDEA_ID = 62848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62848Service() {
        this(new Idea62848Config());
    }

    public Idea62848Service(Idea62848Config config) {
        this.config = config != null ? config : new Idea62848Config();
