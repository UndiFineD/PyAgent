...
@Data
public class Idea63007Config {
    private String name = "idea_063007";
 ...
 */
@Slf4j
public class Idea63007Service {
    private static final int IDEA_ID = 63007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63007Service() {
        this(new Idea63007Config());
    }

    public Idea63007Service(Idea63007Config config) {
        this.config = config != null ? config : new Idea63007Config();
