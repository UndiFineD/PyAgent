...
@Data
public class Idea62808Config {
    private String name = "idea_062808";
 ...
 */
@Slf4j
public class Idea62808Service {
    private static final int IDEA_ID = 62808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62808Service() {
        this(new Idea62808Config());
    }

    public Idea62808Service(Idea62808Config config) {
        this.config = config != null ? config : new Idea62808Config();
