...
@Data
public class Idea62970Config {
    private String name = "idea_062970";
 ...
 */
@Slf4j
public class Idea62970Service {
    private static final int IDEA_ID = 62970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62970Service() {
        this(new Idea62970Config());
    }

    public Idea62970Service(Idea62970Config config) {
        this.config = config != null ? config : new Idea62970Config();
