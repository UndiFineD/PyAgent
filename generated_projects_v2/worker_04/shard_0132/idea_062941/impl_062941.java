...
@Data
public class Idea62941Config {
    private String name = "idea_062941";
 ...
 */
@Slf4j
public class Idea62941Service {
    private static final int IDEA_ID = 62941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62941Service() {
        this(new Idea62941Config());
    }

    public Idea62941Service(Idea62941Config config) {
        this.config = config != null ? config : new Idea62941Config();
