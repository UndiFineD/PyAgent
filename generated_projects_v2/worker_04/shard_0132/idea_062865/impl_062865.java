...
@Data
public class Idea62865Config {
    private String name = "idea_062865";
 ...
 */
@Slf4j
public class Idea62865Service {
    private static final int IDEA_ID = 62865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62865Service() {
        this(new Idea62865Config());
    }

    public Idea62865Service(Idea62865Config config) {
        this.config = config != null ? config : new Idea62865Config();
