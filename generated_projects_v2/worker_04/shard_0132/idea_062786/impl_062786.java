...
@Data
public class Idea62786Config {
    private String name = "idea_062786";
 ...
 */
@Slf4j
public class Idea62786Service {
    private static final int IDEA_ID = 62786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62786Service() {
        this(new Idea62786Config());
    }

    public Idea62786Service(Idea62786Config config) {
        this.config = config != null ? config : new Idea62786Config();
