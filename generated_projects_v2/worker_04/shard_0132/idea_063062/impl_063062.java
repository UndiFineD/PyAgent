...
@Data
public class Idea63062Config {
    private String name = "idea_063062";
 ...
 */
@Slf4j
public class Idea63062Service {
    private static final int IDEA_ID = 63062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63062Service() {
        this(new Idea63062Config());
    }

    public Idea63062Service(Idea63062Config config) {
        this.config = config != null ? config : new Idea63062Config();
