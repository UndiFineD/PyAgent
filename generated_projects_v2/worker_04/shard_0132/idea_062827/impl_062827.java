...
@Data
public class Idea62827Config {
    private String name = "idea_062827";
 ...
 */
@Slf4j
public class Idea62827Service {
    private static final int IDEA_ID = 62827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62827Service() {
        this(new Idea62827Config());
    }

    public Idea62827Service(Idea62827Config config) {
        this.config = config != null ? config : new Idea62827Config();
