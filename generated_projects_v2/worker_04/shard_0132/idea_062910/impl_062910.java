...
@Data
public class Idea62910Config {
    private String name = "idea_062910";
 ...
 */
@Slf4j
public class Idea62910Service {
    private static final int IDEA_ID = 62910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62910Service() {
        this(new Idea62910Config());
    }

    public Idea62910Service(Idea62910Config config) {
        this.config = config != null ? config : new Idea62910Config();
