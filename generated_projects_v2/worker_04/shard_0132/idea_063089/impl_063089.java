...
@Data
public class Idea63089Config {
    private String name = "idea_063089";
 ...
 */
@Slf4j
public class Idea63089Service {
    private static final int IDEA_ID = 63089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63089Service() {
        this(new Idea63089Config());
    }

    public Idea63089Service(Idea63089Config config) {
        this.config = config != null ? config : new Idea63089Config();
