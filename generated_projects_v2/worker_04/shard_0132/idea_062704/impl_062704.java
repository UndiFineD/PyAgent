...
@Data
public class Idea62704Config {
    private String name = "idea_062704";
 ...
 */
@Slf4j
public class Idea62704Service {
    private static final int IDEA_ID = 62704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62704Service() {
        this(new Idea62704Config());
    }

    public Idea62704Service(Idea62704Config config) {
        this.config = config != null ? config : new Idea62704Config();
