...
@Data
public class Idea63155Config {
    private String name = "idea_063155";
 ...
 */
@Slf4j
public class Idea63155Service {
    private static final int IDEA_ID = 63155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63155Service() {
        this(new Idea63155Config());
    }

    public Idea63155Service(Idea63155Config config) {
        this.config = config != null ? config : new Idea63155Config();
