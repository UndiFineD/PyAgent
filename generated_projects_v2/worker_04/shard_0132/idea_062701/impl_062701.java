...
@Data
public class Idea62701Config {
    private String name = "idea_062701";
 ...
 */
@Slf4j
public class Idea62701Service {
    private static final int IDEA_ID = 62701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62701Service() {
        this(new Idea62701Config());
    }

    public Idea62701Service(Idea62701Config config) {
        this.config = config != null ? config : new Idea62701Config();
