...
@Data
public class Idea62878Config {
    private String name = "idea_062878";
 ...
 */
@Slf4j
public class Idea62878Service {
    private static final int IDEA_ID = 62878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62878Service() {
        this(new Idea62878Config());
    }

    public Idea62878Service(Idea62878Config config) {
        this.config = config != null ? config : new Idea62878Config();
