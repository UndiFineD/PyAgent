...
@Data
public class Idea62783Config {
    private String name = "idea_062783";
 ...
 */
@Slf4j
public class Idea62783Service {
    private static final int IDEA_ID = 62783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62783Service() {
        this(new Idea62783Config());
    }

    public Idea62783Service(Idea62783Config config) {
        this.config = config != null ? config : new Idea62783Config();
