...
@Data
public class Idea63064Config {
    private String name = "idea_063064";
 ...
 */
@Slf4j
public class Idea63064Service {
    private static final int IDEA_ID = 63064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63064Service() {
        this(new Idea63064Config());
    }

    public Idea63064Service(Idea63064Config config) {
        this.config = config != null ? config : new Idea63064Config();
