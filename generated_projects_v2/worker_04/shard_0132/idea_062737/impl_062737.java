...
@Data
public class Idea62737Config {
    private String name = "idea_062737";
 ...
 */
@Slf4j
public class Idea62737Service {
    private static final int IDEA_ID = 62737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62737Service() {
        this(new Idea62737Config());
    }

    public Idea62737Service(Idea62737Config config) {
        this.config = config != null ? config : new Idea62737Config();
