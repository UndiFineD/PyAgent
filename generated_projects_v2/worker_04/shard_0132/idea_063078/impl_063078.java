...
@Data
public class Idea63078Config {
    private String name = "idea_063078";
 ...
 */
@Slf4j
public class Idea63078Service {
    private static final int IDEA_ID = 63078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63078Service() {
        this(new Idea63078Config());
    }

    public Idea63078Service(Idea63078Config config) {
        this.config = config != null ? config : new Idea63078Config();
