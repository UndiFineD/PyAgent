...
@Data
public class Idea62828Config {
    private String name = "idea_062828";
 ...
 */
@Slf4j
public class Idea62828Service {
    private static final int IDEA_ID = 62828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62828Service() {
        this(new Idea62828Config());
    }

    public Idea62828Service(Idea62828Config config) {
        this.config = config != null ? config : new Idea62828Config();
