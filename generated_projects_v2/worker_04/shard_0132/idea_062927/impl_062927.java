...
@Data
public class Idea62927Config {
    private String name = "idea_062927";
 ...
 */
@Slf4j
public class Idea62927Service {
    private static final int IDEA_ID = 62927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62927Service() {
        this(new Idea62927Config());
    }

    public Idea62927Service(Idea62927Config config) {
        this.config = config != null ? config : new Idea62927Config();
