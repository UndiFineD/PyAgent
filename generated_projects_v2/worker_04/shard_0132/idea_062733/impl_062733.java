...
@Data
public class Idea62733Config {
    private String name = "idea_062733";
 ...
 */
@Slf4j
public class Idea62733Service {
    private static final int IDEA_ID = 62733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62733Service() {
        this(new Idea62733Config());
    }

    public Idea62733Service(Idea62733Config config) {
        this.config = config != null ? config : new Idea62733Config();
