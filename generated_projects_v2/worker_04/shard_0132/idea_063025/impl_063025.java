...
@Data
public class Idea63025Config {
    private String name = "idea_063025";
 ...
 */
@Slf4j
public class Idea63025Service {
    private static final int IDEA_ID = 63025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63025Service() {
        this(new Idea63025Config());
    }

    public Idea63025Service(Idea63025Config config) {
        this.config = config != null ? config : new Idea63025Config();
