...
@Data
public class Idea62739Config {
    private String name = "idea_062739";
 ...
 */
@Slf4j
public class Idea62739Service {
    private static final int IDEA_ID = 62739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62739Service() {
        this(new Idea62739Config());
    }

    public Idea62739Service(Idea62739Config config) {
        this.config = config != null ? config : new Idea62739Config();
