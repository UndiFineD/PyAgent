...
@Data
public class Idea62771Config {
    private String name = "idea_062771";
 ...
 */
@Slf4j
public class Idea62771Service {
    private static final int IDEA_ID = 62771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62771Service() {
        this(new Idea62771Config());
    }

    public Idea62771Service(Idea62771Config config) {
        this.config = config != null ? config : new Idea62771Config();
