...
@Data
public class Idea62845Config {
    private String name = "idea_062845";
 ...
 */
@Slf4j
public class Idea62845Service {
    private static final int IDEA_ID = 62845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62845Service() {
        this(new Idea62845Config());
    }

    public Idea62845Service(Idea62845Config config) {
        this.config = config != null ? config : new Idea62845Config();
