...
@Data
public class Idea62830Config {
    private String name = "idea_062830";
 ...
 */
@Slf4j
public class Idea62830Service {
    private static final int IDEA_ID = 62830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62830Service() {
        this(new Idea62830Config());
    }

    public Idea62830Service(Idea62830Config config) {
        this.config = config != null ? config : new Idea62830Config();
