...
@Data
public class Idea62820Config {
    private String name = "idea_062820";
 ...
 */
@Slf4j
public class Idea62820Service {
    private static final int IDEA_ID = 62820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62820Service() {
        this(new Idea62820Config());
    }

    public Idea62820Service(Idea62820Config config) {
        this.config = config != null ? config : new Idea62820Config();
