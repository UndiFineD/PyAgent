...
@Data
public class Idea62982Config {
    private String name = "idea_062982";
 ...
 */
@Slf4j
public class Idea62982Service {
    private static final int IDEA_ID = 62982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62982Service() {
        this(new Idea62982Config());
    }

    public Idea62982Service(Idea62982Config config) {
        this.config = config != null ? config : new Idea62982Config();
