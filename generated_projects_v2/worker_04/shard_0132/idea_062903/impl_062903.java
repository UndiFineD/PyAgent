...
@Data
public class Idea62903Config {
    private String name = "idea_062903";
 ...
 */
@Slf4j
public class Idea62903Service {
    private static final int IDEA_ID = 62903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62903Service() {
        this(new Idea62903Config());
    }

    public Idea62903Service(Idea62903Config config) {
        this.config = config != null ? config : new Idea62903Config();
