...
@Data
public class Idea62838Config {
    private String name = "idea_062838";
 ...
 */
@Slf4j
public class Idea62838Service {
    private static final int IDEA_ID = 62838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62838Service() {
        this(new Idea62838Config());
    }

    public Idea62838Service(Idea62838Config config) {
        this.config = config != null ? config : new Idea62838Config();
