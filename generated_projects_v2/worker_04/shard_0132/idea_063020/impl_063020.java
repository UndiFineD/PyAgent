...
@Data
public class Idea63020Config {
    private String name = "idea_063020";
 ...
 */
@Slf4j
public class Idea63020Service {
    private static final int IDEA_ID = 63020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63020Service() {
        this(new Idea63020Config());
    }

    public Idea63020Service(Idea63020Config config) {
        this.config = config != null ? config : new Idea63020Config();
