...
@Data
public class Idea63037Config {
    private String name = "idea_063037";
 ...
 */
@Slf4j
public class Idea63037Service {
    private static final int IDEA_ID = 63037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63037Service() {
        this(new Idea63037Config());
    }

    public Idea63037Service(Idea63037Config config) {
        this.config = config != null ? config : new Idea63037Config();
