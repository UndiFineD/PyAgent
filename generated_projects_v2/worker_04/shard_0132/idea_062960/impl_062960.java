...
@Data
public class Idea62960Config {
    private String name = "idea_062960";
 ...
 */
@Slf4j
public class Idea62960Service {
    private static final int IDEA_ID = 62960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62960Service() {
        this(new Idea62960Config());
    }

    public Idea62960Service(Idea62960Config config) {
        this.config = config != null ? config : new Idea62960Config();
