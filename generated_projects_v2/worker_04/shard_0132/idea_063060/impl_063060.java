...
@Data
public class Idea63060Config {
    private String name = "idea_063060";
 ...
 */
@Slf4j
public class Idea63060Service {
    private static final int IDEA_ID = 63060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63060Service() {
        this(new Idea63060Config());
    }

    public Idea63060Service(Idea63060Config config) {
        this.config = config != null ? config : new Idea63060Config();
