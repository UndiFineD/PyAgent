...
@Data
public class Idea62906Config {
    private String name = "idea_062906";
 ...
 */
@Slf4j
public class Idea62906Service {
    private static final int IDEA_ID = 62906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62906Service() {
        this(new Idea62906Config());
    }

    public Idea62906Service(Idea62906Config config) {
        this.config = config != null ? config : new Idea62906Config();
