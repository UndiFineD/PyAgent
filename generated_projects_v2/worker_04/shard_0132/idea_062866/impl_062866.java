...
@Data
public class Idea62866Config {
    private String name = "idea_062866";
 ...
 */
@Slf4j
public class Idea62866Service {
    private static final int IDEA_ID = 62866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62866Service() {
        this(new Idea62866Config());
    }

    public Idea62866Service(Idea62866Config config) {
        this.config = config != null ? config : new Idea62866Config();
