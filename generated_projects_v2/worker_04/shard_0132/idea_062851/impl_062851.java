...
@Data
public class Idea62851Config {
    private String name = "idea_062851";
 ...
 */
@Slf4j
public class Idea62851Service {
    private static final int IDEA_ID = 62851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62851Service() {
        this(new Idea62851Config());
    }

    public Idea62851Service(Idea62851Config config) {
        this.config = config != null ? config : new Idea62851Config();
