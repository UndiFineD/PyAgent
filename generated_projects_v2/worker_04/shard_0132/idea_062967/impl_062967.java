...
@Data
public class Idea62967Config {
    private String name = "idea_062967";
 ...
 */
@Slf4j
public class Idea62967Service {
    private static final int IDEA_ID = 62967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62967Service() {
        this(new Idea62967Config());
    }

    public Idea62967Service(Idea62967Config config) {
        this.config = config != null ? config : new Idea62967Config();
