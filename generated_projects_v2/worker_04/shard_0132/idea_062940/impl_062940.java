...
@Data
public class Idea62940Config {
    private String name = "idea_062940";
 ...
 */
@Slf4j
public class Idea62940Service {
    private static final int IDEA_ID = 62940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62940Service() {
        this(new Idea62940Config());
    }

    public Idea62940Service(Idea62940Config config) {
        this.config = config != null ? config : new Idea62940Config();
