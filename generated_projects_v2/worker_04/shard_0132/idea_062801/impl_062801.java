...
@Data
public class Idea62801Config {
    private String name = "idea_062801";
 ...
 */
@Slf4j
public class Idea62801Service {
    private static final int IDEA_ID = 62801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62801Service() {
        this(new Idea62801Config());
    }

    public Idea62801Service(Idea62801Config config) {
        this.config = config != null ? config : new Idea62801Config();
