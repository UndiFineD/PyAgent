...
@Data
public class Idea62946Config {
    private String name = "idea_062946";
 ...
 */
@Slf4j
public class Idea62946Service {
    private static final int IDEA_ID = 62946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62946Service() {
        this(new Idea62946Config());
    }

    public Idea62946Service(Idea62946Config config) {
        this.config = config != null ? config : new Idea62946Config();
