...
@Data
public class Idea62971Config {
    private String name = "idea_062971";
 ...
 */
@Slf4j
public class Idea62971Service {
    private static final int IDEA_ID = 62971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62971Service() {
        this(new Idea62971Config());
    }

    public Idea62971Service(Idea62971Config config) {
        this.config = config != null ? config : new Idea62971Config();
