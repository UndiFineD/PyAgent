...
@Data
public class Idea62772Config {
    private String name = "idea_062772";
 ...
 */
@Slf4j
public class Idea62772Service {
    private static final int IDEA_ID = 62772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62772Service() {
        this(new Idea62772Config());
    }

    public Idea62772Service(Idea62772Config config) {
        this.config = config != null ? config : new Idea62772Config();
