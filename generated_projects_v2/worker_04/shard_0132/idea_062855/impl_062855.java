...
@Data
public class Idea62855Config {
    private String name = "idea_062855";
 ...
 */
@Slf4j
public class Idea62855Service {
    private static final int IDEA_ID = 62855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62855Service() {
        this(new Idea62855Config());
    }

    public Idea62855Service(Idea62855Config config) {
        this.config = config != null ? config : new Idea62855Config();
