...
@Data
public class Idea63043Config {
    private String name = "idea_063043";
 ...
 */
@Slf4j
public class Idea63043Service {
    private static final int IDEA_ID = 63043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63043Service() {
        this(new Idea63043Config());
    }

    public Idea63043Service(Idea63043Config config) {
        this.config = config != null ? config : new Idea63043Config();
