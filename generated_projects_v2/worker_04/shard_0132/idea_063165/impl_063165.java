...
@Data
public class Idea63165Config {
    private String name = "idea_063165";
 ...
 */
@Slf4j
public class Idea63165Service {
    private static final int IDEA_ID = 63165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63165Service() {
        this(new Idea63165Config());
    }

    public Idea63165Service(Idea63165Config config) {
        this.config = config != null ? config : new Idea63165Config();
