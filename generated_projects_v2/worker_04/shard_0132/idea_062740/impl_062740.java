...
@Data
public class Idea62740Config {
    private String name = "idea_062740";
 ...
 */
@Slf4j
public class Idea62740Service {
    private static final int IDEA_ID = 62740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62740Service() {
        this(new Idea62740Config());
    }

    public Idea62740Service(Idea62740Config config) {
        this.config = config != null ? config : new Idea62740Config();
