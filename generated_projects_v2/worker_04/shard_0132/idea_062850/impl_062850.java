...
@Data
public class Idea62850Config {
    private String name = "idea_062850";
 ...
 */
@Slf4j
public class Idea62850Service {
    private static final int IDEA_ID = 62850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62850Service() {
        this(new Idea62850Config());
    }

    public Idea62850Service(Idea62850Config config) {
        this.config = config != null ? config : new Idea62850Config();
