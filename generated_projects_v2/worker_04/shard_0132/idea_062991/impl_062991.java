...
@Data
public class Idea62991Config {
    private String name = "idea_062991";
 ...
 */
@Slf4j
public class Idea62991Service {
    private static final int IDEA_ID = 62991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62991Service() {
        this(new Idea62991Config());
    }

    public Idea62991Service(Idea62991Config config) {
        this.config = config != null ? config : new Idea62991Config();
