...
@Data
public class Idea62821Config {
    private String name = "idea_062821";
 ...
 */
@Slf4j
public class Idea62821Service {
    private static final int IDEA_ID = 62821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62821Service() {
        this(new Idea62821Config());
    }

    public Idea62821Service(Idea62821Config config) {
        this.config = config != null ? config : new Idea62821Config();
