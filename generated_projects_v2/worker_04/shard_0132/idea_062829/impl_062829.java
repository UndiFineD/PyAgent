...
@Data
public class Idea62829Config {
    private String name = "idea_062829";
 ...
 */
@Slf4j
public class Idea62829Service {
    private static final int IDEA_ID = 62829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62829Service() {
        this(new Idea62829Config());
    }

    public Idea62829Service(Idea62829Config config) {
        this.config = config != null ? config : new Idea62829Config();
