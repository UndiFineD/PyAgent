...
@Data
public class Idea62700Config {
    private String name = "idea_062700";
 ...
 */
@Slf4j
public class Idea62700Service {
    private static final int IDEA_ID = 62700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62700Service() {
        this(new Idea62700Config());
    }

    public Idea62700Service(Idea62700Config config) {
        this.config = config != null ? config : new Idea62700Config();
