...
@Data
public class Idea62793Config {
    private String name = "idea_062793";
 ...
 */
@Slf4j
public class Idea62793Service {
    private static final int IDEA_ID = 62793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62793Service() {
        this(new Idea62793Config());
    }

    public Idea62793Service(Idea62793Config config) {
        this.config = config != null ? config : new Idea62793Config();
