...
@Data
public class Idea63027Config {
    private String name = "idea_063027";
 ...
 */
@Slf4j
public class Idea63027Service {
    private static final int IDEA_ID = 63027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63027Service() {
        this(new Idea63027Config());
    }

    public Idea63027Service(Idea63027Config config) {
        this.config = config != null ? config : new Idea63027Config();
