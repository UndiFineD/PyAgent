...
@Data
public class Idea63137Config {
    private String name = "idea_063137";
 ...
 */
@Slf4j
public class Idea63137Service {
    private static final int IDEA_ID = 63137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63137Service() {
        this(new Idea63137Config());
    }

    public Idea63137Service(Idea63137Config config) {
        this.config = config != null ? config : new Idea63137Config();
