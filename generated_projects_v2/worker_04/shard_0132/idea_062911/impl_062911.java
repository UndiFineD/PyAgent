...
@Data
public class Idea62911Config {
    private String name = "idea_062911";
 ...
 */
@Slf4j
public class Idea62911Service {
    private static final int IDEA_ID = 62911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62911Service() {
        this(new Idea62911Config());
    }

    public Idea62911Service(Idea62911Config config) {
        this.config = config != null ? config : new Idea62911Config();
