...
@Data
public class Idea63039Config {
    private String name = "idea_063039";
 ...
 */
@Slf4j
public class Idea63039Service {
    private static final int IDEA_ID = 63039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63039Service() {
        this(new Idea63039Config());
    }

    public Idea63039Service(Idea63039Config config) {
        this.config = config != null ? config : new Idea63039Config();
