...
@Data
public class Idea63072Config {
    private String name = "idea_063072";
 ...
 */
@Slf4j
public class Idea63072Service {
    private static final int IDEA_ID = 63072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63072Service() {
        this(new Idea63072Config());
    }

    public Idea63072Service(Idea63072Config config) {
        this.config = config != null ? config : new Idea63072Config();
