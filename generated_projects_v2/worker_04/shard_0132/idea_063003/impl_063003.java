...
@Data
public class Idea63003Config {
    private String name = "idea_063003";
 ...
 */
@Slf4j
public class Idea63003Service {
    private static final int IDEA_ID = 63003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63003Service() {
        this(new Idea63003Config());
    }

    public Idea63003Service(Idea63003Config config) {
        this.config = config != null ? config : new Idea63003Config();
