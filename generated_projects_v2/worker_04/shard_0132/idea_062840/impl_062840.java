...
@Data
public class Idea62840Config {
    private String name = "idea_062840";
 ...
 */
@Slf4j
public class Idea62840Service {
    private static final int IDEA_ID = 62840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62840Service() {
        this(new Idea62840Config());
    }

    public Idea62840Service(Idea62840Config config) {
        this.config = config != null ? config : new Idea62840Config();
