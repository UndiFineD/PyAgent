...
@Data
public class Idea62952Config {
    private String name = "idea_062952";
 ...
 */
@Slf4j
public class Idea62952Service {
    private static final int IDEA_ID = 62952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62952Service() {
        this(new Idea62952Config());
    }

    public Idea62952Service(Idea62952Config config) {
        this.config = config != null ? config : new Idea62952Config();
