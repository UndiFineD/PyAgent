...
@Data
public class Idea62799Config {
    private String name = "idea_062799";
 ...
 */
@Slf4j
public class Idea62799Service {
    private static final int IDEA_ID = 62799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62799Service() {
        this(new Idea62799Config());
    }

    public Idea62799Service(Idea62799Config config) {
        this.config = config != null ? config : new Idea62799Config();
