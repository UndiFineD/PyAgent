...
@Data
public class Idea62794Config {
    private String name = "idea_062794";
 ...
 */
@Slf4j
public class Idea62794Service {
    private static final int IDEA_ID = 62794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62794Service() {
        this(new Idea62794Config());
    }

    public Idea62794Service(Idea62794Config config) {
        this.config = config != null ? config : new Idea62794Config();
