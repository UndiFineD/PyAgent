...
@Data
public class Idea63112Config {
    private String name = "idea_063112";
 ...
 */
@Slf4j
public class Idea63112Service {
    private static final int IDEA_ID = 63112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63112Service() {
        this(new Idea63112Config());
    }

    public Idea63112Service(Idea63112Config config) {
        this.config = config != null ? config : new Idea63112Config();
