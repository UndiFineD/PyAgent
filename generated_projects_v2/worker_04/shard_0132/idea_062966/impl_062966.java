...
@Data
public class Idea62966Config {
    private String name = "idea_062966";
 ...
 */
@Slf4j
public class Idea62966Service {
    private static final int IDEA_ID = 62966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62966Service() {
        this(new Idea62966Config());
    }

    public Idea62966Service(Idea62966Config config) {
        this.config = config != null ? config : new Idea62966Config();
