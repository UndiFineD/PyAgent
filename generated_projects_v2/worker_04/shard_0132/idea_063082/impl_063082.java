...
@Data
public class Idea63082Config {
    private String name = "idea_063082";
 ...
 */
@Slf4j
public class Idea63082Service {
    private static final int IDEA_ID = 63082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63082Service() {
        this(new Idea63082Config());
    }

    public Idea63082Service(Idea63082Config config) {
        this.config = config != null ? config : new Idea63082Config();
