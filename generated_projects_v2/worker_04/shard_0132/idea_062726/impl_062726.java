...
@Data
public class Idea62726Config {
    private String name = "idea_062726";
 ...
 */
@Slf4j
public class Idea62726Service {
    private static final int IDEA_ID = 62726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62726Service() {
        this(new Idea62726Config());
    }

    public Idea62726Service(Idea62726Config config) {
        this.config = config != null ? config : new Idea62726Config();
