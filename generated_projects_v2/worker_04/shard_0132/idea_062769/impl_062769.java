...
@Data
public class Idea62769Config {
    private String name = "idea_062769";
 ...
 */
@Slf4j
public class Idea62769Service {
    private static final int IDEA_ID = 62769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62769Service() {
        this(new Idea62769Config());
    }

    public Idea62769Service(Idea62769Config config) {
        this.config = config != null ? config : new Idea62769Config();
