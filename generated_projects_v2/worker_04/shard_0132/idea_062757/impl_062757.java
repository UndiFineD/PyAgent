...
@Data
public class Idea62757Config {
    private String name = "idea_062757";
 ...
 */
@Slf4j
public class Idea62757Service {
    private static final int IDEA_ID = 62757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62757Service() {
        this(new Idea62757Config());
    }

    public Idea62757Service(Idea62757Config config) {
        this.config = config != null ? config : new Idea62757Config();
