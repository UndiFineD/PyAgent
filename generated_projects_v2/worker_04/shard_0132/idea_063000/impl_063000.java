...
@Data
public class Idea63000Config {
    private String name = "idea_063000";
 ...
 */
@Slf4j
public class Idea63000Service {
    private static final int IDEA_ID = 63000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63000Service() {
        this(new Idea63000Config());
    }

    public Idea63000Service(Idea63000Config config) {
        this.config = config != null ? config : new Idea63000Config();
