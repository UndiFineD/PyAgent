...
@Data
public class Idea63073Config {
    private String name = "idea_063073";
 ...
 */
@Slf4j
public class Idea63073Service {
    private static final int IDEA_ID = 63073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63073Service() {
        this(new Idea63073Config());
    }

    public Idea63073Service(Idea63073Config config) {
        this.config = config != null ? config : new Idea63073Config();
