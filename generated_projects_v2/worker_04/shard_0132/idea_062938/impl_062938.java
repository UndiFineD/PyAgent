...
@Data
public class Idea62938Config {
    private String name = "idea_062938";
 ...
 */
@Slf4j
public class Idea62938Service {
    private static final int IDEA_ID = 62938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62938Service() {
        this(new Idea62938Config());
    }

    public Idea62938Service(Idea62938Config config) {
        this.config = config != null ? config : new Idea62938Config();
