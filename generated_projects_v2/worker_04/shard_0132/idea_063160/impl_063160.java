...
@Data
public class Idea63160Config {
    private String name = "idea_063160";
 ...
 */
@Slf4j
public class Idea63160Service {
    private static final int IDEA_ID = 63160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63160Service() {
        this(new Idea63160Config());
    }

    public Idea63160Service(Idea63160Config config) {
        this.config = config != null ? config : new Idea63160Config();
