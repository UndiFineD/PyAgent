...
@Data
public class Idea62881Config {
    private String name = "idea_062881";
 ...
 */
@Slf4j
public class Idea62881Service {
    private static final int IDEA_ID = 62881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62881Service() {
        this(new Idea62881Config());
    }

    public Idea62881Service(Idea62881Config config) {
        this.config = config != null ? config : new Idea62881Config();
