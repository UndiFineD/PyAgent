...
@Data
public class Idea63017Config {
    private String name = "idea_063017";
 ...
 */
@Slf4j
public class Idea63017Service {
    private static final int IDEA_ID = 63017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63017Service() {
        this(new Idea63017Config());
    }

    public Idea63017Service(Idea63017Config config) {
        this.config = config != null ? config : new Idea63017Config();
