...
@Data
public class Idea62918Config {
    private String name = "idea_062918";
 ...
 */
@Slf4j
public class Idea62918Service {
    private static final int IDEA_ID = 62918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62918Service() {
        this(new Idea62918Config());
    }

    public Idea62918Service(Idea62918Config config) {
        this.config = config != null ? config : new Idea62918Config();
