...
@Data
public class Idea62811Config {
    private String name = "idea_062811";
 ...
 */
@Slf4j
public class Idea62811Service {
    private static final int IDEA_ID = 62811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62811Service() {
        this(new Idea62811Config());
    }

    public Idea62811Service(Idea62811Config config) {
        this.config = config != null ? config : new Idea62811Config();
