...
@Data
public class Idea62951Config {
    private String name = "idea_062951";
 ...
 */
@Slf4j
public class Idea62951Service {
    private static final int IDEA_ID = 62951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62951Service() {
        this(new Idea62951Config());
    }

    public Idea62951Service(Idea62951Config config) {
        this.config = config != null ? config : new Idea62951Config();
