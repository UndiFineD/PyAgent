...
@Data
public class Idea62824Config {
    private String name = "idea_062824";
 ...
 */
@Slf4j
public class Idea62824Service {
    private static final int IDEA_ID = 62824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62824Service() {
        this(new Idea62824Config());
    }

    public Idea62824Service(Idea62824Config config) {
        this.config = config != null ? config : new Idea62824Config();
