...
@Data
public class Idea62905Config {
    private String name = "idea_062905";
 ...
 */
@Slf4j
public class Idea62905Service {
    private static final int IDEA_ID = 62905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62905Service() {
        this(new Idea62905Config());
    }

    public Idea62905Service(Idea62905Config config) {
        this.config = config != null ? config : new Idea62905Config();
