...
@Data
public class Idea62976Config {
    private String name = "idea_062976";
 ...
 */
@Slf4j
public class Idea62976Service {
    private static final int IDEA_ID = 62976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62976Service() {
        this(new Idea62976Config());
    }

    public Idea62976Service(Idea62976Config config) {
        this.config = config != null ? config : new Idea62976Config();
