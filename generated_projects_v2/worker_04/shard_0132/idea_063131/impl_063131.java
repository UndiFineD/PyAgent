...
@Data
public class Idea63131Config {
    private String name = "idea_063131";
 ...
 */
@Slf4j
public class Idea63131Service {
    private static final int IDEA_ID = 63131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63131Service() {
        this(new Idea63131Config());
    }

    public Idea63131Service(Idea63131Config config) {
        this.config = config != null ? config : new Idea63131Config();
