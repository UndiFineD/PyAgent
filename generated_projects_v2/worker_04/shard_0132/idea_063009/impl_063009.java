...
@Data
public class Idea63009Config {
    private String name = "idea_063009";
 ...
 */
@Slf4j
public class Idea63009Service {
    private static final int IDEA_ID = 63009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63009Service() {
        this(new Idea63009Config());
    }

    public Idea63009Service(Idea63009Config config) {
        this.config = config != null ? config : new Idea63009Config();
