...
@Data
public class Idea62763Config {
    private String name = "idea_062763";
 ...
 */
@Slf4j
public class Idea62763Service {
    private static final int IDEA_ID = 62763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62763Service() {
        this(new Idea62763Config());
    }

    public Idea62763Service(Idea62763Config config) {
        this.config = config != null ? config : new Idea62763Config();
