...
@Data
public class Idea62892Config {
    private String name = "idea_062892";
 ...
 */
@Slf4j
public class Idea62892Service {
    private static final int IDEA_ID = 62892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62892Service() {
        this(new Idea62892Config());
    }

    public Idea62892Service(Idea62892Config config) {
        this.config = config != null ? config : new Idea62892Config();
