...
@Data
public class Idea62924Config {
    private String name = "idea_062924";
 ...
 */
@Slf4j
public class Idea62924Service {
    private static final int IDEA_ID = 62924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62924Service() {
        this(new Idea62924Config());
    }

    public Idea62924Service(Idea62924Config config) {
        this.config = config != null ? config : new Idea62924Config();
