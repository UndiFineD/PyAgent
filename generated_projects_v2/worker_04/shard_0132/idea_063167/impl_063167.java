...
@Data
public class Idea63167Config {
    private String name = "idea_063167";
 ...
 */
@Slf4j
public class Idea63167Service {
    private static final int IDEA_ID = 63167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63167Service() {
        this(new Idea63167Config());
    }

    public Idea63167Service(Idea63167Config config) {
        this.config = config != null ? config : new Idea63167Config();
