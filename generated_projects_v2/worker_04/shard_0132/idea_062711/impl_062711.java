...
@Data
public class Idea62711Config {
    private String name = "idea_062711";
 ...
 */
@Slf4j
public class Idea62711Service {
    private static final int IDEA_ID = 62711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62711Service() {
        this(new Idea62711Config());
    }

    public Idea62711Service(Idea62711Config config) {
        this.config = config != null ? config : new Idea62711Config();
