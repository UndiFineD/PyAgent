...
@Data
public class Idea62765Config {
    private String name = "idea_062765";
 ...
 */
@Slf4j
public class Idea62765Service {
    private static final int IDEA_ID = 62765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62765Service() {
        this(new Idea62765Config());
    }

    public Idea62765Service(Idea62765Config config) {
        this.config = config != null ? config : new Idea62765Config();
