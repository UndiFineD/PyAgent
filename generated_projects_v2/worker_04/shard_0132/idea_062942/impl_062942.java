...
@Data
public class Idea62942Config {
    private String name = "idea_062942";
 ...
 */
@Slf4j
public class Idea62942Service {
    private static final int IDEA_ID = 62942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62942Service() {
        this(new Idea62942Config());
    }

    public Idea62942Service(Idea62942Config config) {
        this.config = config != null ? config : new Idea62942Config();
