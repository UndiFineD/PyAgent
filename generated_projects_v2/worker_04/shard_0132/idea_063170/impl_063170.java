...
@Data
public class Idea63170Config {
    private String name = "idea_063170";
 ...
 */
@Slf4j
public class Idea63170Service {
    private static final int IDEA_ID = 63170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63170Service() {
        this(new Idea63170Config());
    }

    public Idea63170Service(Idea63170Config config) {
        this.config = config != null ? config : new Idea63170Config();
