...
@Data
public class Idea63157Config {
    private String name = "idea_063157";
 ...
 */
@Slf4j
public class Idea63157Service {
    private static final int IDEA_ID = 63157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63157Service() {
        this(new Idea63157Config());
    }

    public Idea63157Service(Idea63157Config config) {
        this.config = config != null ? config : new Idea63157Config();
