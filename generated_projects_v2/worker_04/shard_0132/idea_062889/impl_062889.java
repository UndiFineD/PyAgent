...
@Data
public class Idea62889Config {
    private String name = "idea_062889";
 ...
 */
@Slf4j
public class Idea62889Service {
    private static final int IDEA_ID = 62889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62889Service() {
        this(new Idea62889Config());
    }

    public Idea62889Service(Idea62889Config config) {
        this.config = config != null ? config : new Idea62889Config();
