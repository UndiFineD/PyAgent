...
@Data
public class Idea62948Config {
    private String name = "idea_062948";
 ...
 */
@Slf4j
public class Idea62948Service {
    private static final int IDEA_ID = 62948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62948Service() {
        this(new Idea62948Config());
    }

    public Idea62948Service(Idea62948Config config) {
        this.config = config != null ? config : new Idea62948Config();
