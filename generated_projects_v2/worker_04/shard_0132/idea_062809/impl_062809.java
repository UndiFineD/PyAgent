...
@Data
public class Idea62809Config {
    private String name = "idea_062809";
 ...
 */
@Slf4j
public class Idea62809Service {
    private static final int IDEA_ID = 62809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62809Service() {
        this(new Idea62809Config());
    }

    public Idea62809Service(Idea62809Config config) {
        this.config = config != null ? config : new Idea62809Config();
