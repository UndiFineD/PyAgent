...
@Data
public class Idea62904Config {
    private String name = "idea_062904";
 ...
 */
@Slf4j
public class Idea62904Service {
    private static final int IDEA_ID = 62904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62904Service() {
        this(new Idea62904Config());
    }

    public Idea62904Service(Idea62904Config config) {
        this.config = config != null ? config : new Idea62904Config();
