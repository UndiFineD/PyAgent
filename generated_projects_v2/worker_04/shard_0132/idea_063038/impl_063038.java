...
@Data
public class Idea63038Config {
    private String name = "idea_063038";
 ...
 */
@Slf4j
public class Idea63038Service {
    private static final int IDEA_ID = 63038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63038Service() {
        this(new Idea63038Config());
    }

    public Idea63038Service(Idea63038Config config) {
        this.config = config != null ? config : new Idea63038Config();
