...
@Data
public class Idea62871Config {
    private String name = "idea_062871";
 ...
 */
@Slf4j
public class Idea62871Service {
    private static final int IDEA_ID = 62871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62871Service() {
        this(new Idea62871Config());
    }

    public Idea62871Service(Idea62871Config config) {
        this.config = config != null ? config : new Idea62871Config();
