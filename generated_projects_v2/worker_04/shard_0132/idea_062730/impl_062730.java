...
@Data
public class Idea62730Config {
    private String name = "idea_062730";
 ...
 */
@Slf4j
public class Idea62730Service {
    private static final int IDEA_ID = 62730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62730Service() {
        this(new Idea62730Config());
    }

    public Idea62730Service(Idea62730Config config) {
        this.config = config != null ? config : new Idea62730Config();
