...
@Data
public class Idea63079Config {
    private String name = "idea_063079";
 ...
 */
@Slf4j
public class Idea63079Service {
    private static final int IDEA_ID = 63079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63079Service() {
        this(new Idea63079Config());
    }

    public Idea63079Service(Idea63079Config config) {
        this.config = config != null ? config : new Idea63079Config();
