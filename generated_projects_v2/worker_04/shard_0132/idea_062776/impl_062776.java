...
@Data
public class Idea62776Config {
    private String name = "idea_062776";
 ...
 */
@Slf4j
public class Idea62776Service {
    private static final int IDEA_ID = 62776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62776Service() {
        this(new Idea62776Config());
    }

    public Idea62776Service(Idea62776Config config) {
        this.config = config != null ? config : new Idea62776Config();
