...
@Data
public class Idea62975Config {
    private String name = "idea_062975";
 ...
 */
@Slf4j
public class Idea62975Service {
    private static final int IDEA_ID = 62975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62975Service() {
        this(new Idea62975Config());
    }

    public Idea62975Service(Idea62975Config config) {
        this.config = config != null ? config : new Idea62975Config();
