...
@Data
public class Idea62764Config {
    private String name = "idea_062764";
 ...
 */
@Slf4j
public class Idea62764Service {
    private static final int IDEA_ID = 62764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62764Service() {
        this(new Idea62764Config());
    }

    public Idea62764Service(Idea62764Config config) {
        this.config = config != null ? config : new Idea62764Config();
