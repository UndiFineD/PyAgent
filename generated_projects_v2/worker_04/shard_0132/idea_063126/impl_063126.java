...
@Data
public class Idea63126Config {
    private String name = "idea_063126";
 ...
 */
@Slf4j
public class Idea63126Service {
    private static final int IDEA_ID = 63126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63126Service() {
        this(new Idea63126Config());
    }

    public Idea63126Service(Idea63126Config config) {
        this.config = config != null ? config : new Idea63126Config();
