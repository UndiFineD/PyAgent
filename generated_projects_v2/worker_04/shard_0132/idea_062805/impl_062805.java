...
@Data
public class Idea62805Config {
    private String name = "idea_062805";
 ...
 */
@Slf4j
public class Idea62805Service {
    private static final int IDEA_ID = 62805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62805Service() {
        this(new Idea62805Config());
    }

    public Idea62805Service(Idea62805Config config) {
        this.config = config != null ? config : new Idea62805Config();
