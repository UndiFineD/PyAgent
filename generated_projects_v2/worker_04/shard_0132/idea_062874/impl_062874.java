...
@Data
public class Idea62874Config {
    private String name = "idea_062874";
 ...
 */
@Slf4j
public class Idea62874Service {
    private static final int IDEA_ID = 62874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62874Service() {
        this(new Idea62874Config());
    }

    public Idea62874Service(Idea62874Config config) {
        this.config = config != null ? config : new Idea62874Config();
