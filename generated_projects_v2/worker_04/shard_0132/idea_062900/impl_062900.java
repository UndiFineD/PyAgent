...
@Data
public class Idea62900Config {
    private String name = "idea_062900";
 ...
 */
@Slf4j
public class Idea62900Service {
    private static final int IDEA_ID = 62900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62900Service() {
        this(new Idea62900Config());
    }

    public Idea62900Service(Idea62900Config config) {
        this.config = config != null ? config : new Idea62900Config();
