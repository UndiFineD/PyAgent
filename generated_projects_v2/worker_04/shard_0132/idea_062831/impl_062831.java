...
@Data
public class Idea62831Config {
    private String name = "idea_062831";
 ...
 */
@Slf4j
public class Idea62831Service {
    private static final int IDEA_ID = 62831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62831Service() {
        this(new Idea62831Config());
    }

    public Idea62831Service(Idea62831Config config) {
        this.config = config != null ? config : new Idea62831Config();
