...
@Data
public class Idea62862Config {
    private String name = "idea_062862";
 ...
 */
@Slf4j
public class Idea62862Service {
    private static final int IDEA_ID = 62862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62862Service() {
        this(new Idea62862Config());
    }

    public Idea62862Service(Idea62862Config config) {
        this.config = config != null ? config : new Idea62862Config();
