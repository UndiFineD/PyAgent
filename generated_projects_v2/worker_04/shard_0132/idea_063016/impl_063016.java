...
@Data
public class Idea63016Config {
    private String name = "idea_063016";
 ...
 */
@Slf4j
public class Idea63016Service {
    private static final int IDEA_ID = 63016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63016Service() {
        this(new Idea63016Config());
    }

    public Idea63016Service(Idea63016Config config) {
        this.config = config != null ? config : new Idea63016Config();
