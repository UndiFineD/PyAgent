...
@Data
public class Idea62997Config {
    private String name = "idea_062997";
 ...
 */
@Slf4j
public class Idea62997Service {
    private static final int IDEA_ID = 62997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62997Service() {
        this(new Idea62997Config());
    }

    public Idea62997Service(Idea62997Config config) {
        this.config = config != null ? config : new Idea62997Config();
