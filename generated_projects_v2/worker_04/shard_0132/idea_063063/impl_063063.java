...
@Data
public class Idea63063Config {
    private String name = "idea_063063";
 ...
 */
@Slf4j
public class Idea63063Service {
    private static final int IDEA_ID = 63063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63063Service() {
        this(new Idea63063Config());
    }

    public Idea63063Service(Idea63063Config config) {
        this.config = config != null ? config : new Idea63063Config();
