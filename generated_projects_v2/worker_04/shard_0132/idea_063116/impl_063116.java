...
@Data
public class Idea63116Config {
    private String name = "idea_063116";
 ...
 */
@Slf4j
public class Idea63116Service {
    private static final int IDEA_ID = 63116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63116Service() {
        this(new Idea63116Config());
    }

    public Idea63116Service(Idea63116Config config) {
        this.config = config != null ? config : new Idea63116Config();
