...
@Data
public class Idea62859Config {
    private String name = "idea_062859";
 ...
 */
@Slf4j
public class Idea62859Service {
    private static final int IDEA_ID = 62859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62859Service() {
        this(new Idea62859Config());
    }

    public Idea62859Service(Idea62859Config config) {
        this.config = config != null ? config : new Idea62859Config();
