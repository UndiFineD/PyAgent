...
@Data
public class Idea62751Config {
    private String name = "idea_062751";
 ...
 */
@Slf4j
public class Idea62751Service {
    private static final int IDEA_ID = 62751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62751Service() {
        this(new Idea62751Config());
    }

    public Idea62751Service(Idea62751Config config) {
        this.config = config != null ? config : new Idea62751Config();
