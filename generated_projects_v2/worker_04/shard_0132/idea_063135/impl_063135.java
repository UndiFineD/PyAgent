...
@Data
public class Idea63135Config {
    private String name = "idea_063135";
 ...
 */
@Slf4j
public class Idea63135Service {
    private static final int IDEA_ID = 63135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63135Service() {
        this(new Idea63135Config());
    }

    public Idea63135Service(Idea63135Config config) {
        this.config = config != null ? config : new Idea63135Config();
