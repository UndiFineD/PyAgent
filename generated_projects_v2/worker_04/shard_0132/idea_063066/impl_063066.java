...
@Data
public class Idea63066Config {
    private String name = "idea_063066";
 ...
 */
@Slf4j
public class Idea63066Service {
    private static final int IDEA_ID = 63066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63066Service() {
        this(new Idea63066Config());
    }

    public Idea63066Service(Idea63066Config config) {
        this.config = config != null ? config : new Idea63066Config();
