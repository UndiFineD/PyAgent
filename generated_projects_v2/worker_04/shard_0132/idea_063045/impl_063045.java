...
@Data
public class Idea63045Config {
    private String name = "idea_063045";
 ...
 */
@Slf4j
public class Idea63045Service {
    private static final int IDEA_ID = 63045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63045Service() {
        this(new Idea63045Config());
    }

    public Idea63045Service(Idea63045Config config) {
        this.config = config != null ? config : new Idea63045Config();
