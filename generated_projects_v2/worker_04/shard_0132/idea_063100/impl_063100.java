...
@Data
public class Idea63100Config {
    private String name = "idea_063100";
 ...
 */
@Slf4j
public class Idea63100Service {
    private static final int IDEA_ID = 63100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63100Service() {
        this(new Idea63100Config());
    }

    public Idea63100Service(Idea63100Config config) {
        this.config = config != null ? config : new Idea63100Config();
