...
@Data
public class Idea62908Config {
    private String name = "idea_062908";
 ...
 */
@Slf4j
public class Idea62908Service {
    private static final int IDEA_ID = 62908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62908Service() {
        this(new Idea62908Config());
    }

    public Idea62908Service(Idea62908Config config) {
        this.config = config != null ? config : new Idea62908Config();
