...
@Data
public class Idea62898Config {
    private String name = "idea_062898";
 ...
 */
@Slf4j
public class Idea62898Service {
    private static final int IDEA_ID = 62898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62898Service() {
        this(new Idea62898Config());
    }

    public Idea62898Service(Idea62898Config config) {
        this.config = config != null ? config : new Idea62898Config();
