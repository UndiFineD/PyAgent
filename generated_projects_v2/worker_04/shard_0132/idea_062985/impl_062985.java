...
@Data
public class Idea62985Config {
    private String name = "idea_062985";
 ...
 */
@Slf4j
public class Idea62985Service {
    private static final int IDEA_ID = 62985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62985Service() {
        this(new Idea62985Config());
    }

    public Idea62985Service(Idea62985Config config) {
        this.config = config != null ? config : new Idea62985Config();
