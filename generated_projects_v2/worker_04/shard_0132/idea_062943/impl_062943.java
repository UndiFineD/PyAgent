...
@Data
public class Idea62943Config {
    private String name = "idea_062943";
 ...
 */
@Slf4j
public class Idea62943Service {
    private static final int IDEA_ID = 62943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62943Service() {
        this(new Idea62943Config());
    }

    public Idea62943Service(Idea62943Config config) {
        this.config = config != null ? config : new Idea62943Config();
