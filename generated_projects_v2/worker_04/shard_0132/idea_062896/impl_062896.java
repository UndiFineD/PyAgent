...
@Data
public class Idea62896Config {
    private String name = "idea_062896";
 ...
 */
@Slf4j
public class Idea62896Service {
    private static final int IDEA_ID = 62896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62896Service() {
        this(new Idea62896Config());
    }

    public Idea62896Service(Idea62896Config config) {
        this.config = config != null ? config : new Idea62896Config();
