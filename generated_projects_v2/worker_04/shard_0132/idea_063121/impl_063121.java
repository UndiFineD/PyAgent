...
@Data
public class Idea63121Config {
    private String name = "idea_063121";
 ...
 */
@Slf4j
public class Idea63121Service {
    private static final int IDEA_ID = 63121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63121Service() {
        this(new Idea63121Config());
    }

    public Idea63121Service(Idea63121Config config) {
        this.config = config != null ? config : new Idea63121Config();
