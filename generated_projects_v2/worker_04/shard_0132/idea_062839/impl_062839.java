...
@Data
public class Idea62839Config {
    private String name = "idea_062839";
 ...
 */
@Slf4j
public class Idea62839Service {
    private static final int IDEA_ID = 62839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62839Service() {
        this(new Idea62839Config());
    }

    public Idea62839Service(Idea62839Config config) {
        this.config = config != null ? config : new Idea62839Config();
