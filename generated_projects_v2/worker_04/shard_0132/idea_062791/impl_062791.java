...
@Data
public class Idea62791Config {
    private String name = "idea_062791";
 ...
 */
@Slf4j
public class Idea62791Service {
    private static final int IDEA_ID = 62791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62791Service() {
        this(new Idea62791Config());
    }

    public Idea62791Service(Idea62791Config config) {
        this.config = config != null ? config : new Idea62791Config();
