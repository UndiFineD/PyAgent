...
@Data
public class Idea62950Config {
    private String name = "idea_062950";
 ...
 */
@Slf4j
public class Idea62950Service {
    private static final int IDEA_ID = 62950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62950Service() {
        this(new Idea62950Config());
    }

    public Idea62950Service(Idea62950Config config) {
        this.config = config != null ? config : new Idea62950Config();
