...
@Data
public class Idea63102Config {
    private String name = "idea_063102";
 ...
 */
@Slf4j
public class Idea63102Service {
    private static final int IDEA_ID = 63102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63102Service() {
        this(new Idea63102Config());
    }

    public Idea63102Service(Idea63102Config config) {
        this.config = config != null ? config : new Idea63102Config();
