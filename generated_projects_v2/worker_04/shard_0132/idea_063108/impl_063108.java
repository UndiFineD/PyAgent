...
@Data
public class Idea63108Config {
    private String name = "idea_063108";
 ...
 */
@Slf4j
public class Idea63108Service {
    private static final int IDEA_ID = 63108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63108Service() {
        this(new Idea63108Config());
    }

    public Idea63108Service(Idea63108Config config) {
        this.config = config != null ? config : new Idea63108Config();
