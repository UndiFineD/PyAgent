...
@Data
public class Idea62746Config {
    private String name = "idea_062746";
 ...
 */
@Slf4j
public class Idea62746Service {
    private static final int IDEA_ID = 62746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62746Service() {
        this(new Idea62746Config());
    }

    public Idea62746Service(Idea62746Config config) {
        this.config = config != null ? config : new Idea62746Config();
