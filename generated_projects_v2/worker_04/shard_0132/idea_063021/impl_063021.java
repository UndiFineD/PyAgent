...
@Data
public class Idea63021Config {
    private String name = "idea_063021";
 ...
 */
@Slf4j
public class Idea63021Service {
    private static final int IDEA_ID = 63021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63021Service() {
        this(new Idea63021Config());
    }

    public Idea63021Service(Idea63021Config config) {
        this.config = config != null ? config : new Idea63021Config();
