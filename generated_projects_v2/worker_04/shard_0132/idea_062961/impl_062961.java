...
@Data
public class Idea62961Config {
    private String name = "idea_062961";
 ...
 */
@Slf4j
public class Idea62961Service {
    private static final int IDEA_ID = 62961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62961Service() {
        this(new Idea62961Config());
    }

    public Idea62961Service(Idea62961Config config) {
        this.config = config != null ? config : new Idea62961Config();
