...
@Data
public class Idea62935Config {
    private String name = "idea_062935";
 ...
 */
@Slf4j
public class Idea62935Service {
    private static final int IDEA_ID = 62935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62935Service() {
        this(new Idea62935Config());
    }

    public Idea62935Service(Idea62935Config config) {
        this.config = config != null ? config : new Idea62935Config();
