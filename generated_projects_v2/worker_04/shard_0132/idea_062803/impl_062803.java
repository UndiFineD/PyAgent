...
@Data
public class Idea62803Config {
    private String name = "idea_062803";
 ...
 */
@Slf4j
public class Idea62803Service {
    private static final int IDEA_ID = 62803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62803Service() {
        this(new Idea62803Config());
    }

    public Idea62803Service(Idea62803Config config) {
        this.config = config != null ? config : new Idea62803Config();
