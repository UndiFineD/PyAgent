...
@Data
public class Idea62956Config {
    private String name = "idea_062956";
 ...
 */
@Slf4j
public class Idea62956Service {
    private static final int IDEA_ID = 62956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62956Service() {
        this(new Idea62956Config());
    }

    public Idea62956Service(Idea62956Config config) {
        this.config = config != null ? config : new Idea62956Config();
