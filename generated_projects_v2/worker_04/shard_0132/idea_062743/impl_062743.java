...
@Data
public class Idea62743Config {
    private String name = "idea_062743";
 ...
 */
@Slf4j
public class Idea62743Service {
    private static final int IDEA_ID = 62743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62743Service() {
        this(new Idea62743Config());
    }

    public Idea62743Service(Idea62743Config config) {
        this.config = config != null ? config : new Idea62743Config();
