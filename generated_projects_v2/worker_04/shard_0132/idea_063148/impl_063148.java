...
@Data
public class Idea63148Config {
    private String name = "idea_063148";
 ...
 */
@Slf4j
public class Idea63148Service {
    private static final int IDEA_ID = 63148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63148Service() {
        this(new Idea63148Config());
    }

    public Idea63148Service(Idea63148Config config) {
        this.config = config != null ? config : new Idea63148Config();
