...
@Data
public class Idea62736Config {
    private String name = "idea_062736";
 ...
 */
@Slf4j
public class Idea62736Service {
    private static final int IDEA_ID = 62736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62736Service() {
        this(new Idea62736Config());
    }

    public Idea62736Service(Idea62736Config config) {
        this.config = config != null ? config : new Idea62736Config();
