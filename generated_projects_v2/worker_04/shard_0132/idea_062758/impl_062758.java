...
@Data
public class Idea62758Config {
    private String name = "idea_062758";
 ...
 */
@Slf4j
public class Idea62758Service {
    private static final int IDEA_ID = 62758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62758Service() {
        this(new Idea62758Config());
    }

    public Idea62758Service(Idea62758Config config) {
        this.config = config != null ? config : new Idea62758Config();
