...
@Data
public class Idea63067Config {
    private String name = "idea_063067";
 ...
 */
@Slf4j
public class Idea63067Service {
    private static final int IDEA_ID = 63067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63067Service() {
        this(new Idea63067Config());
    }

    public Idea63067Service(Idea63067Config config) {
        this.config = config != null ? config : new Idea63067Config();
