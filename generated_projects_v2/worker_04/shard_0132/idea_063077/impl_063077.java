...
@Data
public class Idea63077Config {
    private String name = "idea_063077";
 ...
 */
@Slf4j
public class Idea63077Service {
    private static final int IDEA_ID = 63077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63077Service() {
        this(new Idea63077Config());
    }

    public Idea63077Service(Idea63077Config config) {
        this.config = config != null ? config : new Idea63077Config();
