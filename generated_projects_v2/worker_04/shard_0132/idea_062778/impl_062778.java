...
@Data
public class Idea62778Config {
    private String name = "idea_062778";
 ...
 */
@Slf4j
public class Idea62778Service {
    private static final int IDEA_ID = 62778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62778Service() {
        this(new Idea62778Config());
    }

    public Idea62778Service(Idea62778Config config) {
        this.config = config != null ? config : new Idea62778Config();
