...
@Data
public class Idea62847Config {
    private String name = "idea_062847";
 ...
 */
@Slf4j
public class Idea62847Service {
    private static final int IDEA_ID = 62847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62847Service() {
        this(new Idea62847Config());
    }

    public Idea62847Service(Idea62847Config config) {
        this.config = config != null ? config : new Idea62847Config();
