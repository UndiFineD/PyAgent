...
@Data
public class Idea62792Config {
    private String name = "idea_062792";
 ...
 */
@Slf4j
public class Idea62792Service {
    private static final int IDEA_ID = 62792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62792Service() {
        this(new Idea62792Config());
    }

    public Idea62792Service(Idea62792Config config) {
        this.config = config != null ? config : new Idea62792Config();
