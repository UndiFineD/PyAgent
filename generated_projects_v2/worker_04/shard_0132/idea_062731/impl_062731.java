...
@Data
public class Idea62731Config {
    private String name = "idea_062731";
 ...
 */
@Slf4j
public class Idea62731Service {
    private static final int IDEA_ID = 62731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62731Service() {
        this(new Idea62731Config());
    }

    public Idea62731Service(Idea62731Config config) {
        this.config = config != null ? config : new Idea62731Config();
