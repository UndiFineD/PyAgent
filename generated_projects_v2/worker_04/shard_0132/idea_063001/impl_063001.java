...
@Data
public class Idea63001Config {
    private String name = "idea_063001";
 ...
 */
@Slf4j
public class Idea63001Service {
    private static final int IDEA_ID = 63001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63001Service() {
        this(new Idea63001Config());
    }

    public Idea63001Service(Idea63001Config config) {
        this.config = config != null ? config : new Idea63001Config();
