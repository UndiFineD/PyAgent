...
@Data
public class Idea62858Config {
    private String name = "idea_062858";
 ...
 */
@Slf4j
public class Idea62858Service {
    private static final int IDEA_ID = 62858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62858Service() {
        this(new Idea62858Config());
    }

    public Idea62858Service(Idea62858Config config) {
        this.config = config != null ? config : new Idea62858Config();
