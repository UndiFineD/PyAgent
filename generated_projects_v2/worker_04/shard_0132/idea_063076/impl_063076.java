...
@Data
public class Idea63076Config {
    private String name = "idea_063076";
 ...
 */
@Slf4j
public class Idea63076Service {
    private static final int IDEA_ID = 63076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63076Service() {
        this(new Idea63076Config());
    }

    public Idea63076Service(Idea63076Config config) {
        this.config = config != null ? config : new Idea63076Config();
