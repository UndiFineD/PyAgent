...
@Data
public class Idea63147Config {
    private String name = "idea_063147";
 ...
 */
@Slf4j
public class Idea63147Service {
    private static final int IDEA_ID = 63147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63147Service() {
        this(new Idea63147Config());
    }

    public Idea63147Service(Idea63147Config config) {
        this.config = config != null ? config : new Idea63147Config();
