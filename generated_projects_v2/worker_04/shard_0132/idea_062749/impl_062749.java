...
@Data
public class Idea62749Config {
    private String name = "idea_062749";
 ...
 */
@Slf4j
public class Idea62749Service {
    private static final int IDEA_ID = 62749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62749Service() {
        this(new Idea62749Config());
    }

    public Idea62749Service(Idea62749Config config) {
        this.config = config != null ? config : new Idea62749Config();
