...
@Data
public class Idea62716Config {
    private String name = "idea_062716";
 ...
 */
@Slf4j
public class Idea62716Service {
    private static final int IDEA_ID = 62716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62716Service() {
        this(new Idea62716Config());
    }

    public Idea62716Service(Idea62716Config config) {
        this.config = config != null ? config : new Idea62716Config();
