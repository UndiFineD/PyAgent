...
@Data
public class Idea62800Config {
    private String name = "idea_062800";
 ...
 */
@Slf4j
public class Idea62800Service {
    private static final int IDEA_ID = 62800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62800Service() {
        this(new Idea62800Config());
    }

    public Idea62800Service(Idea62800Config config) {
        this.config = config != null ? config : new Idea62800Config();
