...
@Data
public class Idea62920Config {
    private String name = "idea_062920";
 ...
 */
@Slf4j
public class Idea62920Service {
    private static final int IDEA_ID = 62920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62920Service() {
        this(new Idea62920Config());
    }

    public Idea62920Service(Idea62920Config config) {
        this.config = config != null ? config : new Idea62920Config();
