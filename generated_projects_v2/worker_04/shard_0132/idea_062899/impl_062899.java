...
@Data
public class Idea62899Config {
    private String name = "idea_062899";
 ...
 */
@Slf4j
public class Idea62899Service {
    private static final int IDEA_ID = 62899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62899Service() {
        this(new Idea62899Config());
    }

    public Idea62899Service(Idea62899Config config) {
        this.config = config != null ? config : new Idea62899Config();
