...
@Data
public class Idea62926Config {
    private String name = "idea_062926";
 ...
 */
@Slf4j
public class Idea62926Service {
    private static final int IDEA_ID = 62926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62926Service() {
        this(new Idea62926Config());
    }

    public Idea62926Service(Idea62926Config config) {
        this.config = config != null ? config : new Idea62926Config();
