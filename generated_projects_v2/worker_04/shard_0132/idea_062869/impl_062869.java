...
@Data
public class Idea62869Config {
    private String name = "idea_062869";
 ...
 */
@Slf4j
public class Idea62869Service {
    private static final int IDEA_ID = 62869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62869Service() {
        this(new Idea62869Config());
    }

    public Idea62869Service(Idea62869Config config) {
        this.config = config != null ? config : new Idea62869Config();
