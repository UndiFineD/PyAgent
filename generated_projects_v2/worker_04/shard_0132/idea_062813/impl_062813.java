...
@Data
public class Idea62813Config {
    private String name = "idea_062813";
 ...
 */
@Slf4j
public class Idea62813Service {
    private static final int IDEA_ID = 62813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62813Service() {
        this(new Idea62813Config());
    }

    public Idea62813Service(Idea62813Config config) {
        this.config = config != null ? config : new Idea62813Config();
