...
@Data
public class Idea62822Config {
    private String name = "idea_062822";
 ...
 */
@Slf4j
public class Idea62822Service {
    private static final int IDEA_ID = 62822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62822Service() {
        this(new Idea62822Config());
    }

    public Idea62822Service(Idea62822Config config) {
        this.config = config != null ? config : new Idea62822Config();
