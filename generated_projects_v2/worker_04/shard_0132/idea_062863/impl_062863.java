...
@Data
public class Idea62863Config {
    private String name = "idea_062863";
 ...
 */
@Slf4j
public class Idea62863Service {
    private static final int IDEA_ID = 62863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62863Service() {
        this(new Idea62863Config());
    }

    public Idea62863Service(Idea62863Config config) {
        this.config = config != null ? config : new Idea62863Config();
