...
@Data
public class Idea63023Config {
    private String name = "idea_063023";
 ...
 */
@Slf4j
public class Idea63023Service {
    private static final int IDEA_ID = 63023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63023Service() {
        this(new Idea63023Config());
    }

    public Idea63023Service(Idea63023Config config) {
        this.config = config != null ? config : new Idea63023Config();
