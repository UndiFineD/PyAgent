...
@Data
public class Idea62999Config {
    private String name = "idea_062999";
 ...
 */
@Slf4j
public class Idea62999Service {
    private static final int IDEA_ID = 62999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62999Service() {
        this(new Idea62999Config());
    }

    public Idea62999Service(Idea62999Config config) {
        this.config = config != null ? config : new Idea62999Config();
