...
@Data
public class Idea62963Config {
    private String name = "idea_062963";
 ...
 */
@Slf4j
public class Idea62963Service {
    private static final int IDEA_ID = 62963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62963Service() {
        this(new Idea62963Config());
    }

    public Idea62963Service(Idea62963Config config) {
        this.config = config != null ? config : new Idea62963Config();
