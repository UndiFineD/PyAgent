...
@Data
public class Idea63111Config {
    private String name = "idea_063111";
 ...
 */
@Slf4j
public class Idea63111Service {
    private static final int IDEA_ID = 63111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63111Service() {
        this(new Idea63111Config());
    }

    public Idea63111Service(Idea63111Config config) {
        this.config = config != null ? config : new Idea63111Config();
