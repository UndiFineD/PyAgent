...
@Data
public class Idea63018Config {
    private String name = "idea_063018";
 ...
 */
@Slf4j
public class Idea63018Service {
    private static final int IDEA_ID = 63018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63018Service() {
        this(new Idea63018Config());
    }

    public Idea63018Service(Idea63018Config config) {
        this.config = config != null ? config : new Idea63018Config();
