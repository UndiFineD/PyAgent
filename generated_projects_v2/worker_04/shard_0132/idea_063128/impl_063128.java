...
@Data
public class Idea63128Config {
    private String name = "idea_063128";
 ...
 */
@Slf4j
public class Idea63128Service {
    private static final int IDEA_ID = 63128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63128Service() {
        this(new Idea63128Config());
    }

    public Idea63128Service(Idea63128Config config) {
        this.config = config != null ? config : new Idea63128Config();
