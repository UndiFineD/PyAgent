...
@Data
public class Idea62891Config {
    private String name = "idea_062891";
 ...
 */
@Slf4j
public class Idea62891Service {
    private static final int IDEA_ID = 62891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62891Service() {
        this(new Idea62891Config());
    }

    public Idea62891Service(Idea62891Config config) {
        this.config = config != null ? config : new Idea62891Config();
