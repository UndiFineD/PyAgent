...
@Data
public class Idea62738Config {
    private String name = "idea_062738";
 ...
 */
@Slf4j
public class Idea62738Service {
    private static final int IDEA_ID = 62738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62738Service() {
        this(new Idea62738Config());
    }

    public Idea62738Service(Idea62738Config config) {
        this.config = config != null ? config : new Idea62738Config();
