...
@Data
public class Idea62760Config {
    private String name = "idea_062760";
 ...
 */
@Slf4j
public class Idea62760Service {
    private static final int IDEA_ID = 62760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62760Service() {
        this(new Idea62760Config());
    }

    public Idea62760Service(Idea62760Config config) {
        this.config = config != null ? config : new Idea62760Config();
