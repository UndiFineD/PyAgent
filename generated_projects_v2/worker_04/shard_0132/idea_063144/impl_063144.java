...
@Data
public class Idea63144Config {
    private String name = "idea_063144";
 ...
 */
@Slf4j
public class Idea63144Service {
    private static final int IDEA_ID = 63144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63144Service() {
        this(new Idea63144Config());
    }

    public Idea63144Service(Idea63144Config config) {
        this.config = config != null ? config : new Idea63144Config();
