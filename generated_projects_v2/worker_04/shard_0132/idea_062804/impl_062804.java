...
@Data
public class Idea62804Config {
    private String name = "idea_062804";
 ...
 */
@Slf4j
public class Idea62804Service {
    private static final int IDEA_ID = 62804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62804Service() {
        this(new Idea62804Config());
    }

    public Idea62804Service(Idea62804Config config) {
        this.config = config != null ? config : new Idea62804Config();
