...
@Data
public class Idea63095Config {
    private String name = "idea_063095";
 ...
 */
@Slf4j
public class Idea63095Service {
    private static final int IDEA_ID = 63095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63095Service() {
        this(new Idea63095Config());
    }

    public Idea63095Service(Idea63095Config config) {
        this.config = config != null ? config : new Idea63095Config();
