...
@Data
public class Idea63168Config {
    private String name = "idea_063168";
 ...
 */
@Slf4j
public class Idea63168Service {
    private static final int IDEA_ID = 63168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63168Service() {
        this(new Idea63168Config());
    }

    public Idea63168Service(Idea63168Config config) {
        this.config = config != null ? config : new Idea63168Config();
