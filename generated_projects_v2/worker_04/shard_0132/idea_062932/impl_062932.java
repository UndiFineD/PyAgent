...
@Data
public class Idea62932Config {
    private String name = "idea_062932";
 ...
 */
@Slf4j
public class Idea62932Service {
    private static final int IDEA_ID = 62932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62932Service() {
        this(new Idea62932Config());
    }

    public Idea62932Service(Idea62932Config config) {
        this.config = config != null ? config : new Idea62932Config();
