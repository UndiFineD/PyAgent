...
@Data
public class Idea63011Config {
    private String name = "idea_063011";
 ...
 */
@Slf4j
public class Idea63011Service {
    private static final int IDEA_ID = 63011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63011Service() {
        this(new Idea63011Config());
    }

    public Idea63011Service(Idea63011Config config) {
        this.config = config != null ? config : new Idea63011Config();
