...
```bash
python -m pytest test_idea_062741.py -v
```

## Docker

```bash
docker build -t idea-062741 .
docker run idea-062741
```
...
```
idea_062741/
├── idea_062741.py          (Python)
├── idea_062741.ts          (TypeScript)
├── idea_062741.rs          (Rust)
├── idea_062741.go          (Go)
├── idea_062741.java        (Java)
├── test_idea_062741.py     (Tests)
├── config.yaml                     (Config)
├── Dockerfile                      (Docker)
├── README.md                       (This file)
