...
@Data
public class Idea62761Config {
    private String name = "idea_062761";
 ...
 */
@Slf4j
public class Idea62761Service {
    private static final int IDEA_ID = 62761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62761Service() {
        this(new Idea62761Config());
    }

    public Idea62761Service(Idea62761Config config) {
        this.config = config != null ? config : new Idea62761Config();
