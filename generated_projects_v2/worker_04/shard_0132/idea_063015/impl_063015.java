...
@Data
public class Idea63015Config {
    private String name = "idea_063015";
 ...
 */
@Slf4j
public class Idea63015Service {
    private static final int IDEA_ID = 63015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63015Service() {
        this(new Idea63015Config());
    }

    public Idea63015Service(Idea63015Config config) {
        this.config = config != null ? config : new Idea63015Config();
