...
@Data
public class Idea62728Config {
    private String name = "idea_062728";
 ...
 */
@Slf4j
public class Idea62728Service {
    private static final int IDEA_ID = 62728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62728Service() {
        this(new Idea62728Config());
    }

    public Idea62728Service(Idea62728Config config) {
        this.config = config != null ? config : new Idea62728Config();
