...
@Data
public class Idea63096Config {
    private String name = "idea_063096";
 ...
 */
@Slf4j
public class Idea63096Service {
    private static final int IDEA_ID = 63096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63096Service() {
        this(new Idea63096Config());
    }

    public Idea63096Service(Idea63096Config config) {
        this.config = config != null ? config : new Idea63096Config();
