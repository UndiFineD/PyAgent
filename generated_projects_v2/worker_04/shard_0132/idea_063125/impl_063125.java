...
@Data
public class Idea63125Config {
    private String name = "idea_063125";
 ...
 */
@Slf4j
public class Idea63125Service {
    private static final int IDEA_ID = 63125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63125Service() {
        this(new Idea63125Config());
    }

    public Idea63125Service(Idea63125Config config) {
        this.config = config != null ? config : new Idea63125Config();
