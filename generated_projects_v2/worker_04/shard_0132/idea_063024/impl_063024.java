...
@Data
public class Idea63024Config {
    private String name = "idea_063024";
 ...
 */
@Slf4j
public class Idea63024Service {
    private static final int IDEA_ID = 63024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63024Service() {
        this(new Idea63024Config());
    }

    public Idea63024Service(Idea63024Config config) {
        this.config = config != null ? config : new Idea63024Config();
