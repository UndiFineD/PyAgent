...
@Data
public class Idea62974Config {
    private String name = "idea_062974";
 ...
 */
@Slf4j
public class Idea62974Service {
    private static final int IDEA_ID = 62974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62974Service() {
        this(new Idea62974Config());
    }

    public Idea62974Service(Idea62974Config config) {
        this.config = config != null ? config : new Idea62974Config();
