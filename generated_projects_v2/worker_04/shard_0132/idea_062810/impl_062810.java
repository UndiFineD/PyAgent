...
@Data
public class Idea62810Config {
    private String name = "idea_062810";
 ...
 */
@Slf4j
public class Idea62810Service {
    private static final int IDEA_ID = 62810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62810Service() {
        this(new Idea62810Config());
    }

    public Idea62810Service(Idea62810Config config) {
        this.config = config != null ? config : new Idea62810Config();
