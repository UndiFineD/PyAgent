...
@Data
public class Idea62912Config {
    private String name = "idea_062912";
 ...
 */
@Slf4j
public class Idea62912Service {
    private static final int IDEA_ID = 62912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62912Service() {
        this(new Idea62912Config());
    }

    public Idea62912Service(Idea62912Config config) {
        this.config = config != null ? config : new Idea62912Config();
