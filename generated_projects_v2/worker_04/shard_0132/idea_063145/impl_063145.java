...
@Data
public class Idea63145Config {
    private String name = "idea_063145";
 ...
 */
@Slf4j
public class Idea63145Service {
    private static final int IDEA_ID = 63145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63145Service() {
        this(new Idea63145Config());
    }

    public Idea63145Service(Idea63145Config config) {
        this.config = config != null ? config : new Idea63145Config();
