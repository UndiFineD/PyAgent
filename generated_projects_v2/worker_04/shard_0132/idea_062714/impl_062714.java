...
@Data
public class Idea62714Config {
    private String name = "idea_062714";
 ...
 */
@Slf4j
public class Idea62714Service {
    private static final int IDEA_ID = 62714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62714Service() {
        this(new Idea62714Config());
    }

    public Idea62714Service(Idea62714Config config) {
        this.config = config != null ? config : new Idea62714Config();
