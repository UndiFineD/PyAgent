...
@Data
public class Idea62990Config {
    private String name = "idea_062990";
 ...
 */
@Slf4j
public class Idea62990Service {
    private static final int IDEA_ID = 62990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62990Service() {
        this(new Idea62990Config());
    }

    public Idea62990Service(Idea62990Config config) {
        this.config = config != null ? config : new Idea62990Config();
