...
@Data
public class Idea63059Config {
    private String name = "idea_063059";
 ...
 */
@Slf4j
public class Idea63059Service {
    private static final int IDEA_ID = 63059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63059Service() {
        this(new Idea63059Config());
    }

    public Idea63059Service(Idea63059Config config) {
        this.config = config != null ? config : new Idea63059Config();
