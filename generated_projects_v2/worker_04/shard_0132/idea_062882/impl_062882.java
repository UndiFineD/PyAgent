...
@Data
public class Idea62882Config {
    private String name = "idea_062882";
 ...
 */
@Slf4j
public class Idea62882Service {
    private static final int IDEA_ID = 62882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62882Service() {
        this(new Idea62882Config());
    }

    public Idea62882Service(Idea62882Config config) {
        this.config = config != null ? config : new Idea62882Config();
