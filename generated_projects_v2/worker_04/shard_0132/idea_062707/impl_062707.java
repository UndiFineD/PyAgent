...
@Data
public class Idea62707Config {
    private String name = "idea_062707";
 ...
 */
@Slf4j
public class Idea62707Service {
    private static final int IDEA_ID = 62707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62707Service() {
        this(new Idea62707Config());
    }

    public Idea62707Service(Idea62707Config config) {
        this.config = config != null ? config : new Idea62707Config();
