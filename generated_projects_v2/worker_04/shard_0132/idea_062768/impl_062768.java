...
@Data
public class Idea62768Config {
    private String name = "idea_062768";
 ...
 */
@Slf4j
public class Idea62768Service {
    private static final int IDEA_ID = 62768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62768Service() {
        this(new Idea62768Config());
    }

    public Idea62768Service(Idea62768Config config) {
        this.config = config != null ? config : new Idea62768Config();
