...
@Data
public class Idea63173Config {
    private String name = "idea_063173";
 ...
 */
@Slf4j
public class Idea63173Service {
    private static final int IDEA_ID = 63173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63173Service() {
        this(new Idea63173Config());
    }

    public Idea63173Service(Idea63173Config config) {
        this.config = config != null ? config : new Idea63173Config();
