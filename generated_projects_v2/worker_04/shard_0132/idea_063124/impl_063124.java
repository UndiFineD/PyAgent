...
@Data
public class Idea63124Config {
    private String name = "idea_063124";
 ...
 */
@Slf4j
public class Idea63124Service {
    private static final int IDEA_ID = 63124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63124Service() {
        this(new Idea63124Config());
    }

    public Idea63124Service(Idea63124Config config) {
        this.config = config != null ? config : new Idea63124Config();
