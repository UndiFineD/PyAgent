...
@Data
public class Idea63172Config {
    private String name = "idea_063172";
 ...
 */
@Slf4j
public class Idea63172Service {
    private static final int IDEA_ID = 63172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63172Service() {
        this(new Idea63172Config());
    }

    public Idea63172Service(Idea63172Config config) {
        this.config = config != null ? config : new Idea63172Config();
