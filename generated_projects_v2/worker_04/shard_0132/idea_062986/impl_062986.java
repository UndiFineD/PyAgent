...
@Data
public class Idea62986Config {
    private String name = "idea_062986";
 ...
 */
@Slf4j
public class Idea62986Service {
    private static final int IDEA_ID = 62986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62986Service() {
        this(new Idea62986Config());
    }

    public Idea62986Service(Idea62986Config config) {
        this.config = config != null ? config : new Idea62986Config();
