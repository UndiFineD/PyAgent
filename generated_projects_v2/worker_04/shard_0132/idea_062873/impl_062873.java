...
@Data
public class Idea62873Config {
    private String name = "idea_062873";
 ...
 */
@Slf4j
public class Idea62873Service {
    private static final int IDEA_ID = 62873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62873Service() {
        this(new Idea62873Config());
    }

    public Idea62873Service(Idea62873Config config) {
        this.config = config != null ? config : new Idea62873Config();
