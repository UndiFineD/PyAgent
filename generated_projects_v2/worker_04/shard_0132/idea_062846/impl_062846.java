...
@Data
public class Idea62846Config {
    private String name = "idea_062846";
 ...
 */
@Slf4j
public class Idea62846Service {
    private static final int IDEA_ID = 62846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62846Service() {
        this(new Idea62846Config());
    }

    public Idea62846Service(Idea62846Config config) {
        this.config = config != null ? config : new Idea62846Config();
