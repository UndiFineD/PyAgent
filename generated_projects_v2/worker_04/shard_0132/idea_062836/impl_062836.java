...
@Data
public class Idea62836Config {
    private String name = "idea_062836";
 ...
 */
@Slf4j
public class Idea62836Service {
    private static final int IDEA_ID = 62836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62836Service() {
        this(new Idea62836Config());
    }

    public Idea62836Service(Idea62836Config config) {
        this.config = config != null ? config : new Idea62836Config();
