...
@Data
public class Idea62944Config {
    private String name = "idea_062944";
 ...
 */
@Slf4j
public class Idea62944Service {
    private static final int IDEA_ID = 62944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62944Service() {
        this(new Idea62944Config());
    }

    public Idea62944Service(Idea62944Config config) {
        this.config = config != null ? config : new Idea62944Config();
