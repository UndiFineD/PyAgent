...
@Data
public class Idea63120Config {
    private String name = "idea_063120";
 ...
 */
@Slf4j
public class Idea63120Service {
    private static final int IDEA_ID = 63120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63120Service() {
        this(new Idea63120Config());
    }

    public Idea63120Service(Idea63120Config config) {
        this.config = config != null ? config : new Idea63120Config();
