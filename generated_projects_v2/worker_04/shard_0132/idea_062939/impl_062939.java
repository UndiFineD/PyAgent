...
@Data
public class Idea62939Config {
    private String name = "idea_062939";
 ...
 */
@Slf4j
public class Idea62939Service {
    private static final int IDEA_ID = 62939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62939Service() {
        this(new Idea62939Config());
    }

    public Idea62939Service(Idea62939Config config) {
        this.config = config != null ? config : new Idea62939Config();
