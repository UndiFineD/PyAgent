...
@Data
public class Idea62715Config {
    private String name = "idea_062715";
 ...
 */
@Slf4j
public class Idea62715Service {
    private static final int IDEA_ID = 62715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62715Service() {
        this(new Idea62715Config());
    }

    public Idea62715Service(Idea62715Config config) {
        this.config = config != null ? config : new Idea62715Config();
