...
@Data
public class Idea63104Config {
    private String name = "idea_063104";
 ...
 */
@Slf4j
public class Idea63104Service {
    private static final int IDEA_ID = 63104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63104Service() {
        this(new Idea63104Config());
    }

    public Idea63104Service(Idea63104Config config) {
        this.config = config != null ? config : new Idea63104Config();
