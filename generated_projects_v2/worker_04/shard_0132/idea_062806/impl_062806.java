...
@Data
public class Idea62806Config {
    private String name = "idea_062806";
 ...
 */
@Slf4j
public class Idea62806Service {
    private static final int IDEA_ID = 62806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62806Service() {
        this(new Idea62806Config());
    }

    public Idea62806Service(Idea62806Config config) {
        this.config = config != null ? config : new Idea62806Config();
