...
@Data
public class Idea62825Config {
    private String name = "idea_062825";
 ...
 */
@Slf4j
public class Idea62825Service {
    private static final int IDEA_ID = 62825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62825Service() {
        this(new Idea62825Config());
    }

    public Idea62825Service(Idea62825Config config) {
        this.config = config != null ? config : new Idea62825Config();
