...
@Data
public class Idea62841Config {
    private String name = "idea_062841";
 ...
 */
@Slf4j
public class Idea62841Service {
    private static final int IDEA_ID = 62841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62841Service() {
        this(new Idea62841Config());
    }

    public Idea62841Service(Idea62841Config config) {
        this.config = config != null ? config : new Idea62841Config();
