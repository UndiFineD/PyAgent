...
@Data
public class Idea63088Config {
    private String name = "idea_063088";
 ...
 */
@Slf4j
public class Idea63088Service {
    private static final int IDEA_ID = 63088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63088Service() {
        this(new Idea63088Config());
    }

    public Idea63088Service(Idea63088Config config) {
        this.config = config != null ? config : new Idea63088Config();
