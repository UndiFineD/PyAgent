...
@Data
public class Idea62979Config {
    private String name = "idea_062979";
 ...
 */
@Slf4j
public class Idea62979Service {
    private static final int IDEA_ID = 62979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62979Service() {
        this(new Idea62979Config());
    }

    public Idea62979Service(Idea62979Config config) {
        this.config = config != null ? config : new Idea62979Config();
