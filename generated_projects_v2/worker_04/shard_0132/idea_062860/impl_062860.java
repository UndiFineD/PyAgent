...
@Data
public class Idea62860Config {
    private String name = "idea_062860";
 ...
 */
@Slf4j
public class Idea62860Service {
    private static final int IDEA_ID = 62860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62860Service() {
        this(new Idea62860Config());
    }

    public Idea62860Service(Idea62860Config config) {
        this.config = config != null ? config : new Idea62860Config();
