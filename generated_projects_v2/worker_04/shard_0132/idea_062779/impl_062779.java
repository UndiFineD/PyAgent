...
@Data
public class Idea62779Config {
    private String name = "idea_062779";
 ...
 */
@Slf4j
public class Idea62779Service {
    private static final int IDEA_ID = 62779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62779Service() {
        this(new Idea62779Config());
    }

    public Idea62779Service(Idea62779Config config) {
        this.config = config != null ? config : new Idea62779Config();
