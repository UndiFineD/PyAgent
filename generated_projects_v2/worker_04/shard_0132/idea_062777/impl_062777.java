...
@Data
public class Idea62777Config {
    private String name = "idea_062777";
 ...
 */
@Slf4j
public class Idea62777Service {
    private static final int IDEA_ID = 62777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62777Service() {
        this(new Idea62777Config());
    }

    public Idea62777Service(Idea62777Config config) {
        this.config = config != null ? config : new Idea62777Config();
