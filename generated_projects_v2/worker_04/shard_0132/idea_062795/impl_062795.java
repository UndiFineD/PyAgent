...
@Data
public class Idea62795Config {
    private String name = "idea_062795";
 ...
 */
@Slf4j
public class Idea62795Service {
    private static final int IDEA_ID = 62795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62795Service() {
        this(new Idea62795Config());
    }

    public Idea62795Service(Idea62795Config config) {
        this.config = config != null ? config : new Idea62795Config();
