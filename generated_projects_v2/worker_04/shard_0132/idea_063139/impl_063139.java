...
@Data
public class Idea63139Config {
    private String name = "idea_063139";
 ...
 */
@Slf4j
public class Idea63139Service {
    private static final int IDEA_ID = 63139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63139Service() {
        this(new Idea63139Config());
    }

    public Idea63139Service(Idea63139Config config) {
        this.config = config != null ? config : new Idea63139Config();
