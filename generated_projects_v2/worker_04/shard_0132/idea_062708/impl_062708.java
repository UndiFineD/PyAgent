...
@Data
public class Idea62708Config {
    private String name = "idea_062708";
 ...
 */
@Slf4j
public class Idea62708Service {
    private static final int IDEA_ID = 62708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62708Service() {
        this(new Idea62708Config());
    }

    public Idea62708Service(Idea62708Config config) {
        this.config = config != null ? config : new Idea62708Config();
