...
@Data
public class Idea63081Config {
    private String name = "idea_063081";
 ...
 */
@Slf4j
public class Idea63081Service {
    private static final int IDEA_ID = 63081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63081Service() {
        this(new Idea63081Config());
    }

    public Idea63081Service(Idea63081Config config) {
        this.config = config != null ? config : new Idea63081Config();
