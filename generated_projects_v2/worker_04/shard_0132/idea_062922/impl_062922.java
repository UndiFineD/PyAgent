...
@Data
public class Idea62922Config {
    private String name = "idea_062922";
 ...
 */
@Slf4j
public class Idea62922Service {
    private static final int IDEA_ID = 62922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62922Service() {
        this(new Idea62922Config());
    }

    public Idea62922Service(Idea62922Config config) {
        this.config = config != null ? config : new Idea62922Config();
