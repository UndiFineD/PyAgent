...
@Data
public class Idea62723Config {
    private String name = "idea_062723";
 ...
 */
@Slf4j
public class Idea62723Service {
    private static final int IDEA_ID = 62723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62723Service() {
        this(new Idea62723Config());
    }

    public Idea62723Service(Idea62723Config config) {
        this.config = config != null ? config : new Idea62723Config();
