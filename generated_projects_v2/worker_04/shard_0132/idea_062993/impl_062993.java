...
@Data
public class Idea62993Config {
    private String name = "idea_062993";
 ...
 */
@Slf4j
public class Idea62993Service {
    private static final int IDEA_ID = 62993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62993Service() {
        this(new Idea62993Config());
    }

    public Idea62993Service(Idea62993Config config) {
        this.config = config != null ? config : new Idea62993Config();
