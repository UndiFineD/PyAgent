...
@Data
public class Idea63106Config {
    private String name = "idea_063106";
 ...
 */
@Slf4j
public class Idea63106Service {
    private static final int IDEA_ID = 63106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63106Service() {
        this(new Idea63106Config());
    }

    public Idea63106Service(Idea63106Config config) {
        this.config = config != null ? config : new Idea63106Config();
