...
@Data
public class Idea62994Config {
    private String name = "idea_062994";
 ...
 */
@Slf4j
public class Idea62994Service {
    private static final int IDEA_ID = 62994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62994Service() {
        this(new Idea62994Config());
    }

    public Idea62994Service(Idea62994Config config) {
        this.config = config != null ? config : new Idea62994Config();
