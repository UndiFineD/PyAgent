...
@Data
public class Idea63083Config {
    private String name = "idea_063083";
 ...
 */
@Slf4j
public class Idea63083Service {
    private static final int IDEA_ID = 63083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63083Service() {
        this(new Idea63083Config());
    }

    public Idea63083Service(Idea63083Config config) {
        this.config = config != null ? config : new Idea63083Config();
