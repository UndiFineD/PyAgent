...
@Data
public class Idea63163Config {
    private String name = "idea_063163";
 ...
 */
@Slf4j
public class Idea63163Service {
    private static final int IDEA_ID = 63163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63163Service() {
        this(new Idea63163Config());
    }

    public Idea63163Service(Idea63163Config config) {
        this.config = config != null ? config : new Idea63163Config();
