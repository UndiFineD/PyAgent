...
@Data
public class Idea62735Config {
    private String name = "idea_062735";
 ...
 */
@Slf4j
public class Idea62735Service {
    private static final int IDEA_ID = 62735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62735Service() {
        this(new Idea62735Config());
    }

    public Idea62735Service(Idea62735Config config) {
        this.config = config != null ? config : new Idea62735Config();
