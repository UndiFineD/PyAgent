...
@Data
public class Idea62930Config {
    private String name = "idea_062930";
 ...
 */
@Slf4j
public class Idea62930Service {
    private static final int IDEA_ID = 62930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62930Service() {
        this(new Idea62930Config());
    }

    public Idea62930Service(Idea62930Config config) {
        this.config = config != null ? config : new Idea62930Config();
