...
@Data
public class Idea62750Config {
    private String name = "idea_062750";
 ...
 */
@Slf4j
public class Idea62750Service {
    private static final int IDEA_ID = 62750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62750Service() {
        this(new Idea62750Config());
    }

    public Idea62750Service(Idea62750Config config) {
        this.config = config != null ? config : new Idea62750Config();
