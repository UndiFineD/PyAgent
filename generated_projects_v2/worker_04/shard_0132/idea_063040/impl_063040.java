...
@Data
public class Idea63040Config {
    private String name = "idea_063040";
 ...
 */
@Slf4j
public class Idea63040Service {
    private static final int IDEA_ID = 63040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63040Service() {
        this(new Idea63040Config());
    }

    public Idea63040Service(Idea63040Config config) {
        this.config = config != null ? config : new Idea63040Config();
