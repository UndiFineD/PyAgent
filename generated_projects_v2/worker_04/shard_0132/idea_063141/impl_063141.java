...
@Data
public class Idea63141Config {
    private String name = "idea_063141";
 ...
 */
@Slf4j
public class Idea63141Service {
    private static final int IDEA_ID = 63141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63141Service() {
        this(new Idea63141Config());
    }

    public Idea63141Service(Idea63141Config config) {
        this.config = config != null ? config : new Idea63141Config();
