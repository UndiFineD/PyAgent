...
@Data
public class Idea63123Config {
    private String name = "idea_063123";
 ...
 */
@Slf4j
public class Idea63123Service {
    private static final int IDEA_ID = 63123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63123Service() {
        this(new Idea63123Config());
    }

    public Idea63123Service(Idea63123Config config) {
        this.config = config != null ? config : new Idea63123Config();
