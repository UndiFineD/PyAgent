...
@Data
public class Idea63114Config {
    private String name = "idea_063114";
 ...
 */
@Slf4j
public class Idea63114Service {
    private static final int IDEA_ID = 63114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63114Service() {
        this(new Idea63114Config());
    }

    public Idea63114Service(Idea63114Config config) {
        this.config = config != null ? config : new Idea63114Config();
