...
@Data
public class Idea63012Config {
    private String name = "idea_063012";
 ...
 */
@Slf4j
public class Idea63012Service {
    private static final int IDEA_ID = 63012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63012Service() {
        this(new Idea63012Config());
    }

    public Idea63012Service(Idea63012Config config) {
        this.config = config != null ? config : new Idea63012Config();
