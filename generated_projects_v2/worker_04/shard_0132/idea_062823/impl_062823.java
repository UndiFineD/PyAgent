...
@Data
public class Idea62823Config {
    private String name = "idea_062823";
 ...
 */
@Slf4j
public class Idea62823Service {
    private static final int IDEA_ID = 62823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62823Service() {
        this(new Idea62823Config());
    }

    public Idea62823Service(Idea62823Config config) {
        this.config = config != null ? config : new Idea62823Config();
