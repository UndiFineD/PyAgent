...
@Data
public class Idea62713Config {
    private String name = "idea_062713";
 ...
 */
@Slf4j
public class Idea62713Service {
    private static final int IDEA_ID = 62713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62713Service() {
        this(new Idea62713Config());
    }

    public Idea62713Service(Idea62713Config config) {
        this.config = config != null ? config : new Idea62713Config();
