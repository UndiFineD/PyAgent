...
@Data
public class Idea63109Config {
    private String name = "idea_063109";
 ...
 */
@Slf4j
public class Idea63109Service {
    private static final int IDEA_ID = 63109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63109Service() {
        this(new Idea63109Config());
    }

    public Idea63109Service(Idea63109Config config) {
        this.config = config != null ? config : new Idea63109Config();
