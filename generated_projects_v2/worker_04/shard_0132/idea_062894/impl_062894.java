...
@Data
public class Idea62894Config {
    private String name = "idea_062894";
 ...
 */
@Slf4j
public class Idea62894Service {
    private static final int IDEA_ID = 62894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62894Service() {
        this(new Idea62894Config());
    }

    public Idea62894Service(Idea62894Config config) {
        this.config = config != null ? config : new Idea62894Config();
