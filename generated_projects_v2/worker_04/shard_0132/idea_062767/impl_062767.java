...
@Data
public class Idea62767Config {
    private String name = "idea_062767";
 ...
 */
@Slf4j
public class Idea62767Service {
    private static final int IDEA_ID = 62767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea62767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea62767Service() {
        this(new Idea62767Config());
    }

    public Idea62767Service(Idea62767Config config) {
        this.config = config != null ? config : new Idea62767Config();
