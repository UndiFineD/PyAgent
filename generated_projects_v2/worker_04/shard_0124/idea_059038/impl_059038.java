...
@Data
public class Idea59038Config {
    private String name = "idea_059038";
 ...
 */
@Slf4j
public class Idea59038Service {
    private static final int IDEA_ID = 59038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59038Service() {
        this(new Idea59038Config());
    }

    public Idea59038Service(Idea59038Config config) {
        this.config = config != null ? config : new Idea59038Config();
