...
@Data
public class Idea59301Config {
    private String name = "idea_059301";
 ...
 */
@Slf4j
public class Idea59301Service {
    private static final int IDEA_ID = 59301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59301Service() {
        this(new Idea59301Config());
    }

    public Idea59301Service(Idea59301Config config) {
        this.config = config != null ? config : new Idea59301Config();
