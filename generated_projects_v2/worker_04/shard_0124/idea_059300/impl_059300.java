...
@Data
public class Idea59300Config {
    private String name = "idea_059300";
 ...
 */
@Slf4j
public class Idea59300Service {
    private static final int IDEA_ID = 59300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59300Service() {
        this(new Idea59300Config());
    }

    public Idea59300Service(Idea59300Config config) {
        this.config = config != null ? config : new Idea59300Config();
