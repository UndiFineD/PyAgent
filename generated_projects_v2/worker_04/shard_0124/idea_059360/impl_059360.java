...
@Data
public class Idea59360Config {
    private String name = "idea_059360";
 ...
 */
@Slf4j
public class Idea59360Service {
    private static final int IDEA_ID = 59360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59360Service() {
        this(new Idea59360Config());
    }

    public Idea59360Service(Idea59360Config config) {
        this.config = config != null ? config : new Idea59360Config();
