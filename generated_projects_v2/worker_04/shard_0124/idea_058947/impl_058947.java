...
@Data
public class Idea58947Config {
    private String name = "idea_058947";
 ...
 */
@Slf4j
public class Idea58947Service {
    private static final int IDEA_ID = 58947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58947Service() {
        this(new Idea58947Config());
    }

    public Idea58947Service(Idea58947Config config) {
        this.config = config != null ? config : new Idea58947Config();
