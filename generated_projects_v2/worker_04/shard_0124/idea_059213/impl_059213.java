...
@Data
public class Idea59213Config {
    private String name = "idea_059213";
 ...
 */
@Slf4j
public class Idea59213Service {
    private static final int IDEA_ID = 59213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59213Service() {
        this(new Idea59213Config());
    }

    public Idea59213Service(Idea59213Config config) {
        this.config = config != null ? config : new Idea59213Config();
