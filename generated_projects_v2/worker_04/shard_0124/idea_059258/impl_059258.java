...
@Data
public class Idea59258Config {
    private String name = "idea_059258";
 ...
 */
@Slf4j
public class Idea59258Service {
    private static final int IDEA_ID = 59258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59258Service() {
        this(new Idea59258Config());
    }

    public Idea59258Service(Idea59258Config config) {
        this.config = config != null ? config : new Idea59258Config();
