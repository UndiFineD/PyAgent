...
@Data
public class Idea59123Config {
    private String name = "idea_059123";
 ...
 */
@Slf4j
public class Idea59123Service {
    private static final int IDEA_ID = 59123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59123Service() {
        this(new Idea59123Config());
    }

    public Idea59123Service(Idea59123Config config) {
        this.config = config != null ? config : new Idea59123Config();
