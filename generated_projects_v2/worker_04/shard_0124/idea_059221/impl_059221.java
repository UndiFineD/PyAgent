...
@Data
public class Idea59221Config {
    private String name = "idea_059221";
 ...
 */
@Slf4j
public class Idea59221Service {
    private static final int IDEA_ID = 59221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59221Service() {
        this(new Idea59221Config());
    }

    public Idea59221Service(Idea59221Config config) {
        this.config = config != null ? config : new Idea59221Config();
