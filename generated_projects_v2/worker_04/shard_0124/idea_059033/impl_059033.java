...
@Data
public class Idea59033Config {
    private String name = "idea_059033";
 ...
 */
@Slf4j
public class Idea59033Service {
    private static final int IDEA_ID = 59033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59033Service() {
        this(new Idea59033Config());
    }

    public Idea59033Service(Idea59033Config config) {
        this.config = config != null ? config : new Idea59033Config();
