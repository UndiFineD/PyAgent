...
@Data
public class Idea58979Config {
    private String name = "idea_058979";
 ...
 */
@Slf4j
public class Idea58979Service {
    private static final int IDEA_ID = 58979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58979Service() {
        this(new Idea58979Config());
    }

    public Idea58979Service(Idea58979Config config) {
        this.config = config != null ? config : new Idea58979Config();
