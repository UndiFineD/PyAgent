...
@Data
public class Idea58945Config {
    private String name = "idea_058945";
 ...
 */
@Slf4j
public class Idea58945Service {
    private static final int IDEA_ID = 58945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58945Service() {
        this(new Idea58945Config());
    }

    public Idea58945Service(Idea58945Config config) {
        this.config = config != null ? config : new Idea58945Config();
