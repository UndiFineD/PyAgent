...
@Data
public class Idea58966Config {
    private String name = "idea_058966";
 ...
 */
@Slf4j
public class Idea58966Service {
    private static final int IDEA_ID = 58966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58966Service() {
        this(new Idea58966Config());
    }

    public Idea58966Service(Idea58966Config config) {
        this.config = config != null ? config : new Idea58966Config();
