...
@Data
public class Idea58902Config {
    private String name = "idea_058902";
 ...
 */
@Slf4j
public class Idea58902Service {
    private static final int IDEA_ID = 58902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58902Service() {
        this(new Idea58902Config());
    }

    public Idea58902Service(Idea58902Config config) {
        this.config = config != null ? config : new Idea58902Config();
