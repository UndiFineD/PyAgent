...
@Data
public class Idea59320Config {
    private String name = "idea_059320";
 ...
 */
@Slf4j
public class Idea59320Service {
    private static final int IDEA_ID = 59320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59320Service() {
        this(new Idea59320Config());
    }

    public Idea59320Service(Idea59320Config config) {
        this.config = config != null ? config : new Idea59320Config();
