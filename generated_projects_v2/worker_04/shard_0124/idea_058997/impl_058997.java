...
@Data
public class Idea58997Config {
    private String name = "idea_058997";
 ...
 */
@Slf4j
public class Idea58997Service {
    private static final int IDEA_ID = 58997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58997Service() {
        this(new Idea58997Config());
    }

    public Idea58997Service(Idea58997Config config) {
        this.config = config != null ? config : new Idea58997Config();
