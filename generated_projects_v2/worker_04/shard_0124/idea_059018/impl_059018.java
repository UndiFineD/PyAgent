...
@Data
public class Idea59018Config {
    private String name = "idea_059018";
 ...
 */
@Slf4j
public class Idea59018Service {
    private static final int IDEA_ID = 59018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59018Service() {
        this(new Idea59018Config());
    }

    public Idea59018Service(Idea59018Config config) {
        this.config = config != null ? config : new Idea59018Config();
