...
@Data
public class Idea59202Config {
    private String name = "idea_059202";
 ...
 */
@Slf4j
public class Idea59202Service {
    private static final int IDEA_ID = 59202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59202Service() {
        this(new Idea59202Config());
    }

    public Idea59202Service(Idea59202Config config) {
        this.config = config != null ? config : new Idea59202Config();
