...
@Data
public class Idea59306Config {
    private String name = "idea_059306";
 ...
 */
@Slf4j
public class Idea59306Service {
    private static final int IDEA_ID = 59306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59306Service() {
        this(new Idea59306Config());
    }

    public Idea59306Service(Idea59306Config config) {
        this.config = config != null ? config : new Idea59306Config();
