...
@Data
public class Idea58961Config {
    private String name = "idea_058961";
 ...
 */
@Slf4j
public class Idea58961Service {
    private static final int IDEA_ID = 58961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58961Service() {
        this(new Idea58961Config());
    }

    public Idea58961Service(Idea58961Config config) {
        this.config = config != null ? config : new Idea58961Config();
