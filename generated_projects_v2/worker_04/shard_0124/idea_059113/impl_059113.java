...
@Data
public class Idea59113Config {
    private String name = "idea_059113";
 ...
 */
@Slf4j
public class Idea59113Service {
    private static final int IDEA_ID = 59113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59113Service() {
        this(new Idea59113Config());
    }

    public Idea59113Service(Idea59113Config config) {
        this.config = config != null ? config : new Idea59113Config();
