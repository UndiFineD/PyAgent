...
@Data
public class Idea58976Config {
    private String name = "idea_058976";
 ...
 */
@Slf4j
public class Idea58976Service {
    private static final int IDEA_ID = 58976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58976Service() {
        this(new Idea58976Config());
    }

    public Idea58976Service(Idea58976Config config) {
        this.config = config != null ? config : new Idea58976Config();
