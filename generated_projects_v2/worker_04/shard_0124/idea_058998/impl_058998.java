...
@Data
public class Idea58998Config {
    private String name = "idea_058998";
 ...
 */
@Slf4j
public class Idea58998Service {
    private static final int IDEA_ID = 58998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58998Service() {
        this(new Idea58998Config());
    }

    public Idea58998Service(Idea58998Config config) {
        this.config = config != null ? config : new Idea58998Config();
