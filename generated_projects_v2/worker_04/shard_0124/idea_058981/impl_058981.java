...
@Data
public class Idea58981Config {
    private String name = "idea_058981";
 ...
 */
@Slf4j
public class Idea58981Service {
    private static final int IDEA_ID = 58981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58981Service() {
        this(new Idea58981Config());
    }

    public Idea58981Service(Idea58981Config config) {
        this.config = config != null ? config : new Idea58981Config();
