...
@Data
public class Idea58906Config {
    private String name = "idea_058906";
 ...
 */
@Slf4j
public class Idea58906Service {
    private static final int IDEA_ID = 58906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58906Service() {
        this(new Idea58906Config());
    }

    public Idea58906Service(Idea58906Config config) {
        this.config = config != null ? config : new Idea58906Config();
