...
@Data
public class Idea58938Config {
    private String name = "idea_058938";
 ...
 */
@Slf4j
public class Idea58938Service {
    private static final int IDEA_ID = 58938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58938Service() {
        this(new Idea58938Config());
    }

    public Idea58938Service(Idea58938Config config) {
        this.config = config != null ? config : new Idea58938Config();
