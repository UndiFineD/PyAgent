...
@Data
public class Idea58937Config {
    private String name = "idea_058937";
 ...
 */
@Slf4j
public class Idea58937Service {
    private static final int IDEA_ID = 58937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58937Service() {
        this(new Idea58937Config());
    }

    public Idea58937Service(Idea58937Config config) {
        this.config = config != null ? config : new Idea58937Config();
