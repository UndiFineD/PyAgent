...
@Data
public class Idea59076Config {
    private String name = "idea_059076";
 ...
 */
@Slf4j
public class Idea59076Service {
    private static final int IDEA_ID = 59076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59076Service() {
        this(new Idea59076Config());
    }

    public Idea59076Service(Idea59076Config config) {
        this.config = config != null ? config : new Idea59076Config();
