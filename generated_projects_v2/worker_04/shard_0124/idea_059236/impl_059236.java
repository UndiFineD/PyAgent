...
@Data
public class Idea59236Config {
    private String name = "idea_059236";
 ...
 */
@Slf4j
public class Idea59236Service {
    private static final int IDEA_ID = 59236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59236Service() {
        this(new Idea59236Config());
    }

    public Idea59236Service(Idea59236Config config) {
        this.config = config != null ? config : new Idea59236Config();
