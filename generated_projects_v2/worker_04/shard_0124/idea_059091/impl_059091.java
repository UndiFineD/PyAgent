...
@Data
public class Idea59091Config {
    private String name = "idea_059091";
 ...
 */
@Slf4j
public class Idea59091Service {
    private static final int IDEA_ID = 59091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59091Service() {
        this(new Idea59091Config());
    }

    public Idea59091Service(Idea59091Config config) {
        this.config = config != null ? config : new Idea59091Config();
