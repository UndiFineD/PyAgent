...
@Data
public class Idea58919Config {
    private String name = "idea_058919";
 ...
 */
@Slf4j
public class Idea58919Service {
    private static final int IDEA_ID = 58919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58919Service() {
        this(new Idea58919Config());
    }

    public Idea58919Service(Idea58919Config config) {
        this.config = config != null ? config : new Idea58919Config();
