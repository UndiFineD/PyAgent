...
@Data
public class Idea59104Config {
    private String name = "idea_059104";
 ...
 */
@Slf4j
public class Idea59104Service {
    private static final int IDEA_ID = 59104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59104Service() {
        this(new Idea59104Config());
    }

    public Idea59104Service(Idea59104Config config) {
        this.config = config != null ? config : new Idea59104Config();
