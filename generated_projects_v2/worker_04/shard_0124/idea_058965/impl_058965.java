...
@Data
public class Idea58965Config {
    private String name = "idea_058965";
 ...
 */
@Slf4j
public class Idea58965Service {
    private static final int IDEA_ID = 58965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58965Service() {
        this(new Idea58965Config());
    }

    public Idea58965Service(Idea58965Config config) {
        this.config = config != null ? config : new Idea58965Config();
