...
@Data
public class Idea59364Config {
    private String name = "idea_059364";
 ...
 */
@Slf4j
public class Idea59364Service {
    private static final int IDEA_ID = 59364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59364Service() {
        this(new Idea59364Config());
    }

    public Idea59364Service(Idea59364Config config) {
        this.config = config != null ? config : new Idea59364Config();
