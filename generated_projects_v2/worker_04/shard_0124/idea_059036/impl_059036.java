...
@Data
public class Idea59036Config {
    private String name = "idea_059036";
 ...
 */
@Slf4j
public class Idea59036Service {
    private static final int IDEA_ID = 59036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59036Service() {
        this(new Idea59036Config());
    }

    public Idea59036Service(Idea59036Config config) {
        this.config = config != null ? config : new Idea59036Config();
