...
@Data
public class Idea59088Config {
    private String name = "idea_059088";
 ...
 */
@Slf4j
public class Idea59088Service {
    private static final int IDEA_ID = 59088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59088Service() {
        this(new Idea59088Config());
    }

    public Idea59088Service(Idea59088Config config) {
        this.config = config != null ? config : new Idea59088Config();
