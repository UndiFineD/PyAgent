...
@Data
public class Idea59070Config {
    private String name = "idea_059070";
 ...
 */
@Slf4j
public class Idea59070Service {
    private static final int IDEA_ID = 59070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59070Service() {
        this(new Idea59070Config());
    }

    public Idea59070Service(Idea59070Config config) {
        this.config = config != null ? config : new Idea59070Config();
