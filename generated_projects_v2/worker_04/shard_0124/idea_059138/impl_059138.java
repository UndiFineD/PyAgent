...
@Data
public class Idea59138Config {
    private String name = "idea_059138";
 ...
 */
@Slf4j
public class Idea59138Service {
    private static final int IDEA_ID = 59138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59138Service() {
        this(new Idea59138Config());
    }

    public Idea59138Service(Idea59138Config config) {
        this.config = config != null ? config : new Idea59138Config();
