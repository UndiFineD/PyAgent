...
@Data
public class Idea58921Config {
    private String name = "idea_058921";
 ...
 */
@Slf4j
public class Idea58921Service {
    private static final int IDEA_ID = 58921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58921Service() {
        this(new Idea58921Config());
    }

    public Idea58921Service(Idea58921Config config) {
        this.config = config != null ? config : new Idea58921Config();
