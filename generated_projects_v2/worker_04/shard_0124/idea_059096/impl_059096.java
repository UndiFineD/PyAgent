...
@Data
public class Idea59096Config {
    private String name = "idea_059096";
 ...
 */
@Slf4j
public class Idea59096Service {
    private static final int IDEA_ID = 59096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59096Service() {
        this(new Idea59096Config());
    }

    public Idea59096Service(Idea59096Config config) {
        this.config = config != null ? config : new Idea59096Config();
