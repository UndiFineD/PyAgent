...
@Data
public class Idea58908Config {
    private String name = "idea_058908";
 ...
 */
@Slf4j
public class Idea58908Service {
    private static final int IDEA_ID = 58908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58908Service() {
        this(new Idea58908Config());
    }

    public Idea58908Service(Idea58908Config config) {
        this.config = config != null ? config : new Idea58908Config();
