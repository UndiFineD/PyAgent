...
@Data
public class Idea58910Config {
    private String name = "idea_058910";
 ...
 */
@Slf4j
public class Idea58910Service {
    private static final int IDEA_ID = 58910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58910Service() {
        this(new Idea58910Config());
    }

    public Idea58910Service(Idea58910Config config) {
        this.config = config != null ? config : new Idea58910Config();
