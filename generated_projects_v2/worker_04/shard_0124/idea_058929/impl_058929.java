...
@Data
public class Idea58929Config {
    private String name = "idea_058929";
 ...
 */
@Slf4j
public class Idea58929Service {
    private static final int IDEA_ID = 58929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58929Service() {
        this(new Idea58929Config());
    }

    public Idea58929Service(Idea58929Config config) {
        this.config = config != null ? config : new Idea58929Config();
