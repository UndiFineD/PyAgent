...
@Data
public class Idea59303Config {
    private String name = "idea_059303";
 ...
 */
@Slf4j
public class Idea59303Service {
    private static final int IDEA_ID = 59303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59303Service() {
        this(new Idea59303Config());
    }

    public Idea59303Service(Idea59303Config config) {
        this.config = config != null ? config : new Idea59303Config();
