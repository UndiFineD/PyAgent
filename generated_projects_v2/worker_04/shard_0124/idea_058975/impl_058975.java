...
@Data
public class Idea58975Config {
    private String name = "idea_058975";
 ...
 */
@Slf4j
public class Idea58975Service {
    private static final int IDEA_ID = 58975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58975Service() {
        this(new Idea58975Config());
    }

    public Idea58975Service(Idea58975Config config) {
        this.config = config != null ? config : new Idea58975Config();
