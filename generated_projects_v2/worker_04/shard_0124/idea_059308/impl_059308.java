...
@Data
public class Idea59308Config {
    private String name = "idea_059308";
 ...
 */
@Slf4j
public class Idea59308Service {
    private static final int IDEA_ID = 59308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59308Service() {
        this(new Idea59308Config());
    }

    public Idea59308Service(Idea59308Config config) {
        this.config = config != null ? config : new Idea59308Config();
