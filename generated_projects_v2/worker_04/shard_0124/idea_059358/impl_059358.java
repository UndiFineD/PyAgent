...
@Data
public class Idea59358Config {
    private String name = "idea_059358";
 ...
 */
@Slf4j
public class Idea59358Service {
    private static final int IDEA_ID = 59358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59358Service() {
        this(new Idea59358Config());
    }

    public Idea59358Service(Idea59358Config config) {
        this.config = config != null ? config : new Idea59358Config();
