...
@Data
public class Idea58982Config {
    private String name = "idea_058982";
 ...
 */
@Slf4j
public class Idea58982Service {
    private static final int IDEA_ID = 58982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58982Service() {
        this(new Idea58982Config());
    }

    public Idea58982Service(Idea58982Config config) {
        this.config = config != null ? config : new Idea58982Config();
