...
@Data
public class Idea59370Config {
    private String name = "idea_059370";
 ...
 */
@Slf4j
public class Idea59370Service {
    private static final int IDEA_ID = 59370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59370Service() {
        this(new Idea59370Config());
    }

    public Idea59370Service(Idea59370Config config) {
        this.config = config != null ? config : new Idea59370Config();
