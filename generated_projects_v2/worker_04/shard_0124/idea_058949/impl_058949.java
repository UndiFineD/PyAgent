...
@Data
public class Idea58949Config {
    private String name = "idea_058949";
 ...
 */
@Slf4j
public class Idea58949Service {
    private static final int IDEA_ID = 58949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58949Service() {
        this(new Idea58949Config());
    }

    public Idea58949Service(Idea58949Config config) {
        this.config = config != null ? config : new Idea58949Config();
