...
@Data
public class Idea59105Config {
    private String name = "idea_059105";
 ...
 */
@Slf4j
public class Idea59105Service {
    private static final int IDEA_ID = 59105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59105Service() {
        this(new Idea59105Config());
    }

    public Idea59105Service(Idea59105Config config) {
        this.config = config != null ? config : new Idea59105Config();
