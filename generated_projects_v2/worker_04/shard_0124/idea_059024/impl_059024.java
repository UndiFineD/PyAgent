...
@Data
public class Idea59024Config {
    private String name = "idea_059024";
 ...
 */
@Slf4j
public class Idea59024Service {
    private static final int IDEA_ID = 59024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59024Service() {
        this(new Idea59024Config());
    }

    public Idea59024Service(Idea59024Config config) {
        this.config = config != null ? config : new Idea59024Config();
