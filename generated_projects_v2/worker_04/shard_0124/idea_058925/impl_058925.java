...
@Data
public class Idea58925Config {
    private String name = "idea_058925";
 ...
 */
@Slf4j
public class Idea58925Service {
    private static final int IDEA_ID = 58925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58925Service() {
        this(new Idea58925Config());
    }

    public Idea58925Service(Idea58925Config config) {
        this.config = config != null ? config : new Idea58925Config();
