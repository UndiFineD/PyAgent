...
@Data
public class Idea58926Config {
    private String name = "idea_058926";
 ...
 */
@Slf4j
public class Idea58926Service {
    private static final int IDEA_ID = 58926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58926Service() {
        this(new Idea58926Config());
    }

    public Idea58926Service(Idea58926Config config) {
        this.config = config != null ? config : new Idea58926Config();
