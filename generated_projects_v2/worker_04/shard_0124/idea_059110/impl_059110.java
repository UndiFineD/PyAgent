...
@Data
public class Idea59110Config {
    private String name = "idea_059110";
 ...
 */
@Slf4j
public class Idea59110Service {
    private static final int IDEA_ID = 59110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59110Service() {
        this(new Idea59110Config());
    }

    public Idea59110Service(Idea59110Config config) {
        this.config = config != null ? config : new Idea59110Config();
