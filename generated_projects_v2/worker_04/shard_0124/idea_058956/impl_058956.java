...
@Data
public class Idea58956Config {
    private String name = "idea_058956";
 ...
 */
@Slf4j
public class Idea58956Service {
    private static final int IDEA_ID = 58956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58956Service() {
        this(new Idea58956Config());
    }

    public Idea58956Service(Idea58956Config config) {
        this.config = config != null ? config : new Idea58956Config();
