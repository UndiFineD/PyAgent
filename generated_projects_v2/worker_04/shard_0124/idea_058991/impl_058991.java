...
@Data
public class Idea58991Config {
    private String name = "idea_058991";
 ...
 */
@Slf4j
public class Idea58991Service {
    private static final int IDEA_ID = 58991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58991Service() {
        this(new Idea58991Config());
    }

    public Idea58991Service(Idea58991Config config) {
        this.config = config != null ? config : new Idea58991Config();
