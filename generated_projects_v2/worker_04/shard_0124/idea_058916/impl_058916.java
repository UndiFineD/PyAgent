...
@Data
public class Idea58916Config {
    private String name = "idea_058916";
 ...
 */
@Slf4j
public class Idea58916Service {
    private static final int IDEA_ID = 58916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58916Service() {
        this(new Idea58916Config());
    }

    public Idea58916Service(Idea58916Config config) {
        this.config = config != null ? config : new Idea58916Config();
