...
@Data
public class Idea58912Config {
    private String name = "idea_058912";
 ...
 */
@Slf4j
public class Idea58912Service {
    private static final int IDEA_ID = 58912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58912Service() {
        this(new Idea58912Config());
    }

    public Idea58912Service(Idea58912Config config) {
        this.config = config != null ? config : new Idea58912Config();
