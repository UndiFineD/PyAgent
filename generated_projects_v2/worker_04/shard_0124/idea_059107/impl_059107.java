...
@Data
public class Idea59107Config {
    private String name = "idea_059107";
 ...
 */
@Slf4j
public class Idea59107Service {
    private static final int IDEA_ID = 59107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59107Service() {
        this(new Idea59107Config());
    }

    public Idea59107Service(Idea59107Config config) {
        this.config = config != null ? config : new Idea59107Config();
