...
@Data
public class Idea59208Config {
    private String name = "idea_059208";
 ...
 */
@Slf4j
public class Idea59208Service {
    private static final int IDEA_ID = 59208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59208Service() {
        this(new Idea59208Config());
    }

    public Idea59208Service(Idea59208Config config) {
        this.config = config != null ? config : new Idea59208Config();
