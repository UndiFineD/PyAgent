...
@Data
public class Idea58960Config {
    private String name = "idea_058960";
 ...
 */
@Slf4j
public class Idea58960Service {
    private static final int IDEA_ID = 58960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58960Service() {
        this(new Idea58960Config());
    }

    public Idea58960Service(Idea58960Config config) {
        this.config = config != null ? config : new Idea58960Config();
