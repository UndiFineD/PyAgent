...
@Data
public class Idea59171Config {
    private String name = "idea_059171";
 ...
 */
@Slf4j
public class Idea59171Service {
    private static final int IDEA_ID = 59171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59171Service() {
        this(new Idea59171Config());
    }

    public Idea59171Service(Idea59171Config config) {
        this.config = config != null ? config : new Idea59171Config();
