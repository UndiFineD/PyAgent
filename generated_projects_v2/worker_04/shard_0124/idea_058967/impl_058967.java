...
@Data
public class Idea58967Config {
    private String name = "idea_058967";
 ...
 */
@Slf4j
public class Idea58967Service {
    private static final int IDEA_ID = 58967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58967Service() {
        this(new Idea58967Config());
    }

    public Idea58967Service(Idea58967Config config) {
        this.config = config != null ? config : new Idea58967Config();
