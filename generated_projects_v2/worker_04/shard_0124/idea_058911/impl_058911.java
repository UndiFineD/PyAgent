...
@Data
public class Idea58911Config {
    private String name = "idea_058911";
 ...
 */
@Slf4j
public class Idea58911Service {
    private static final int IDEA_ID = 58911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58911Service() {
        this(new Idea58911Config());
    }

    public Idea58911Service(Idea58911Config config) {
        this.config = config != null ? config : new Idea58911Config();
