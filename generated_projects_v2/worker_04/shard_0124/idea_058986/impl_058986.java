...
@Data
public class Idea58986Config {
    private String name = "idea_058986";
 ...
 */
@Slf4j
public class Idea58986Service {
    private static final int IDEA_ID = 58986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58986Service() {
        this(new Idea58986Config());
    }

    public Idea58986Service(Idea58986Config config) {
        this.config = config != null ? config : new Idea58986Config();
