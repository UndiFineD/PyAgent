...
@Data
public class Idea59002Config {
    private String name = "idea_059002";
 ...
 */
@Slf4j
public class Idea59002Service {
    private static final int IDEA_ID = 59002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59002Service() {
        this(new Idea59002Config());
    }

    public Idea59002Service(Idea59002Config config) {
        this.config = config != null ? config : new Idea59002Config();
