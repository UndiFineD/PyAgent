...
@Data
public class Idea58907Config {
    private String name = "idea_058907";
 ...
 */
@Slf4j
public class Idea58907Service {
    private static final int IDEA_ID = 58907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58907Service() {
        this(new Idea58907Config());
    }

    public Idea58907Service(Idea58907Config config) {
        this.config = config != null ? config : new Idea58907Config();
