...
@Data
public class Idea59015Config {
    private String name = "idea_059015";
 ...
 */
@Slf4j
public class Idea59015Service {
    private static final int IDEA_ID = 59015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59015Service() {
        this(new Idea59015Config());
    }

    public Idea59015Service(Idea59015Config config) {
        this.config = config != null ? config : new Idea59015Config();
