...
@Data
public class Idea58905Config {
    private String name = "idea_058905";
 ...
 */
@Slf4j
public class Idea58905Service {
    private static final int IDEA_ID = 58905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58905Service() {
        this(new Idea58905Config());
    }

    public Idea58905Service(Idea58905Config config) {
        this.config = config != null ? config : new Idea58905Config();
