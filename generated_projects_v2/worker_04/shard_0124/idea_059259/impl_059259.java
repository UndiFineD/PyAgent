...
@Data
public class Idea59259Config {
    private String name = "idea_059259";
 ...
 */
@Slf4j
public class Idea59259Service {
    private static final int IDEA_ID = 59259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59259Service() {
        this(new Idea59259Config());
    }

    public Idea59259Service(Idea59259Config config) {
        this.config = config != null ? config : new Idea59259Config();
