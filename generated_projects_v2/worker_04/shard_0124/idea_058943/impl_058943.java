...
@Data
public class Idea58943Config {
    private String name = "idea_058943";
 ...
 */
@Slf4j
public class Idea58943Service {
    private static final int IDEA_ID = 58943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58943Service() {
        this(new Idea58943Config());
    }

    public Idea58943Service(Idea58943Config config) {
        this.config = config != null ? config : new Idea58943Config();
