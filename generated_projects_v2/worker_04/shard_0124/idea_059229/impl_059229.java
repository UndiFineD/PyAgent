...
@Data
public class Idea59229Config {
    private String name = "idea_059229";
 ...
 */
@Slf4j
public class Idea59229Service {
    private static final int IDEA_ID = 59229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59229Service() {
        this(new Idea59229Config());
    }

    public Idea59229Service(Idea59229Config config) {
        this.config = config != null ? config : new Idea59229Config();
