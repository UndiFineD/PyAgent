...
@Data
public class Idea59307Config {
    private String name = "idea_059307";
 ...
 */
@Slf4j
public class Idea59307Service {
    private static final int IDEA_ID = 59307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59307Service() {
        this(new Idea59307Config());
    }

    public Idea59307Service(Idea59307Config config) {
        this.config = config != null ? config : new Idea59307Config();
