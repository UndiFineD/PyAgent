...
@Data
public class Idea58915Config {
    private String name = "idea_058915";
 ...
 */
@Slf4j
public class Idea58915Service {
    private static final int IDEA_ID = 58915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58915Service() {
        this(new Idea58915Config());
    }

    public Idea58915Service(Idea58915Config config) {
        this.config = config != null ? config : new Idea58915Config();
