...
@Data
public class Idea59371Config {
    private String name = "idea_059371";
 ...
 */
@Slf4j
public class Idea59371Service {
    private static final int IDEA_ID = 59371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59371Service() {
        this(new Idea59371Config());
    }

    public Idea59371Service(Idea59371Config config) {
        this.config = config != null ? config : new Idea59371Config();
