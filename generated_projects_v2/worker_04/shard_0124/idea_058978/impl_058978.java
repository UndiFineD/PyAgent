...
@Data
public class Idea58978Config {
    private String name = "idea_058978";
 ...
 */
@Slf4j
public class Idea58978Service {
    private static final int IDEA_ID = 58978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58978Service() {
        this(new Idea58978Config());
    }

    public Idea58978Service(Idea58978Config config) {
        this.config = config != null ? config : new Idea58978Config();
