...
@Data
public class Idea58946Config {
    private String name = "idea_058946";
 ...
 */
@Slf4j
public class Idea58946Service {
    private static final int IDEA_ID = 58946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58946Service() {
        this(new Idea58946Config());
    }

    public Idea58946Service(Idea58946Config config) {
        this.config = config != null ? config : new Idea58946Config();
