...
@Data
public class Idea58935Config {
    private String name = "idea_058935";
 ...
 */
@Slf4j
public class Idea58935Service {
    private static final int IDEA_ID = 58935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58935Service() {
        this(new Idea58935Config());
    }

    public Idea58935Service(Idea58935Config config) {
        this.config = config != null ? config : new Idea58935Config();
