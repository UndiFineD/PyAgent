...
@Data
public class Idea58914Config {
    private String name = "idea_058914";
 ...
 */
@Slf4j
public class Idea58914Service {
    private static final int IDEA_ID = 58914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58914Service() {
        this(new Idea58914Config());
    }

    public Idea58914Service(Idea58914Config config) {
        this.config = config != null ? config : new Idea58914Config();
