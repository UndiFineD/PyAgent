...
@Data
public class Idea58962Config {
    private String name = "idea_058962";
 ...
 */
@Slf4j
public class Idea58962Service {
    private static final int IDEA_ID = 58962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58962Service() {
        this(new Idea58962Config());
    }

    public Idea58962Service(Idea58962Config config) {
        this.config = config != null ? config : new Idea58962Config();
