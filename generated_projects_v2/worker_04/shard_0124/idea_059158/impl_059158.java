...
@Data
public class Idea59158Config {
    private String name = "idea_059158";
 ...
 */
@Slf4j
public class Idea59158Service {
    private static final int IDEA_ID = 59158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59158Service() {
        this(new Idea59158Config());
    }

    public Idea59158Service(Idea59158Config config) {
        this.config = config != null ? config : new Idea59158Config();
