...
@Data
public class Idea58990Config {
    private String name = "idea_058990";
 ...
 */
@Slf4j
public class Idea58990Service {
    private static final int IDEA_ID = 58990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58990Service() {
        this(new Idea58990Config());
    }

    public Idea58990Service(Idea58990Config config) {
        this.config = config != null ? config : new Idea58990Config();
