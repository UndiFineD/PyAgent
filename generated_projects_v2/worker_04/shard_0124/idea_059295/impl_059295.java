...
@Data
public class Idea59295Config {
    private String name = "idea_059295";
 ...
 */
@Slf4j
public class Idea59295Service {
    private static final int IDEA_ID = 59295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59295Service() {
        this(new Idea59295Config());
    }

    public Idea59295Service(Idea59295Config config) {
        this.config = config != null ? config : new Idea59295Config();
