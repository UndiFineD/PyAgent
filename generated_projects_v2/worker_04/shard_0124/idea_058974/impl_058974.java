...
@Data
public class Idea58974Config {
    private String name = "idea_058974";
 ...
 */
@Slf4j
public class Idea58974Service {
    private static final int IDEA_ID = 58974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58974Service() {
        this(new Idea58974Config());
    }

    public Idea58974Service(Idea58974Config config) {
        this.config = config != null ? config : new Idea58974Config();
