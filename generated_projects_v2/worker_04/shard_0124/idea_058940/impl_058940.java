...
@Data
public class Idea58940Config {
    private String name = "idea_058940";
 ...
 */
@Slf4j
public class Idea58940Service {
    private static final int IDEA_ID = 58940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58940Service() {
        this(new Idea58940Config());
    }

    public Idea58940Service(Idea58940Config config) {
        this.config = config != null ? config : new Idea58940Config();
