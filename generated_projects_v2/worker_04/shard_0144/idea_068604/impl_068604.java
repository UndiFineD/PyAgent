...
@Data
public class Idea68604Config {
    private String name = "idea_068604";
 ...
 */
@Slf4j
public class Idea68604Service {
    private static final int IDEA_ID = 68604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68604Service() {
        this(new Idea68604Config());
    }

    public Idea68604Service(Idea68604Config config) {
        this.config = config != null ? config : new Idea68604Config();
