...
@Data
public class Idea68405Config {
    private String name = "idea_068405";
 ...
 */
@Slf4j
public class Idea68405Service {
    private static final int IDEA_ID = 68405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68405Service() {
        this(new Idea68405Config());
    }

    public Idea68405Service(Idea68405Config config) {
        this.config = config != null ? config : new Idea68405Config();
