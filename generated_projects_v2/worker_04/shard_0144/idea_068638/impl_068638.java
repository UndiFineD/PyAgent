...
@Data
public class Idea68638Config {
    private String name = "idea_068638";
 ...
 */
@Slf4j
public class Idea68638Service {
    private static final int IDEA_ID = 68638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68638Service() {
        this(new Idea68638Config());
    }

    public Idea68638Service(Idea68638Config config) {
        this.config = config != null ? config : new Idea68638Config();
