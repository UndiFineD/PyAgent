...
@Data
public class Idea68590Config {
    private String name = "idea_068590";
 ...
 */
@Slf4j
public class Idea68590Service {
    private static final int IDEA_ID = 68590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68590Service() {
        this(new Idea68590Config());
    }

    public Idea68590Service(Idea68590Config config) {
        this.config = config != null ? config : new Idea68590Config();
