...
@Data
public class Idea68804Config {
    private String name = "idea_068804";
 ...
 */
@Slf4j
public class Idea68804Service {
    private static final int IDEA_ID = 68804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68804Service() {
        this(new Idea68804Config());
    }

    public Idea68804Service(Idea68804Config config) {
        this.config = config != null ? config : new Idea68804Config();
