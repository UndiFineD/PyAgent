...
@Data
public class Idea68417Config {
    private String name = "idea_068417";
 ...
 */
@Slf4j
public class Idea68417Service {
    private static final int IDEA_ID = 68417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68417Service() {
        this(new Idea68417Config());
    }

    public Idea68417Service(Idea68417Config config) {
        this.config = config != null ? config : new Idea68417Config();
