...
@Data
public class Idea68443Config {
    private String name = "idea_068443";
 ...
 */
@Slf4j
public class Idea68443Service {
    private static final int IDEA_ID = 68443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68443Service() {
        this(new Idea68443Config());
    }

    public Idea68443Service(Idea68443Config config) {
        this.config = config != null ? config : new Idea68443Config();
