...
@Data
public class Idea68527Config {
    private String name = "idea_068527";
 ...
 */
@Slf4j
public class Idea68527Service {
    private static final int IDEA_ID = 68527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68527Service() {
        this(new Idea68527Config());
    }

    public Idea68527Service(Idea68527Config config) {
        this.config = config != null ? config : new Idea68527Config();
