...
@Data
public class Idea68801Config {
    private String name = "idea_068801";
 ...
 */
@Slf4j
public class Idea68801Service {
    private static final int IDEA_ID = 68801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68801Service() {
        this(new Idea68801Config());
    }

    public Idea68801Service(Idea68801Config config) {
        this.config = config != null ? config : new Idea68801Config();
