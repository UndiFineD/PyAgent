...
@Data
public class Idea68560Config {
    private String name = "idea_068560";
 ...
 */
@Slf4j
public class Idea68560Service {
    private static final int IDEA_ID = 68560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68560Service() {
        this(new Idea68560Config());
    }

    public Idea68560Service(Idea68560Config config) {
        this.config = config != null ? config : new Idea68560Config();
