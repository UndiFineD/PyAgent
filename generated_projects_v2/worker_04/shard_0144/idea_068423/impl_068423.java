...
@Data
public class Idea68423Config {
    private String name = "idea_068423";
 ...
 */
@Slf4j
public class Idea68423Service {
    private static final int IDEA_ID = 68423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68423Service() {
        this(new Idea68423Config());
    }

    public Idea68423Service(Idea68423Config config) {
        this.config = config != null ? config : new Idea68423Config();
