...
@Data
public class Idea68734Config {
    private String name = "idea_068734";
 ...
 */
@Slf4j
public class Idea68734Service {
    private static final int IDEA_ID = 68734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68734Service() {
        this(new Idea68734Config());
    }

    public Idea68734Service(Idea68734Config config) {
        this.config = config != null ? config : new Idea68734Config();
