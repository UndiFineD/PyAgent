...
@Data
public class Idea68700Config {
    private String name = "idea_068700";
 ...
 */
@Slf4j
public class Idea68700Service {
    private static final int IDEA_ID = 68700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68700Service() {
        this(new Idea68700Config());
    }

    public Idea68700Service(Idea68700Config config) {
        this.config = config != null ? config : new Idea68700Config();
