...
@Data
public class Idea68591Config {
    private String name = "idea_068591";
 ...
 */
@Slf4j
public class Idea68591Service {
    private static final int IDEA_ID = 68591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68591Service() {
        this(new Idea68591Config());
    }

    public Idea68591Service(Idea68591Config config) {
        this.config = config != null ? config : new Idea68591Config();
