...
@Data
public class Idea68807Config {
    private String name = "idea_068807";
 ...
 */
@Slf4j
public class Idea68807Service {
    private static final int IDEA_ID = 68807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68807Service() {
        this(new Idea68807Config());
    }

    public Idea68807Service(Idea68807Config config) {
        this.config = config != null ? config : new Idea68807Config();
