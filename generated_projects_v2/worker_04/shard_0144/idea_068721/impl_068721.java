...
@Data
public class Idea68721Config {
    private String name = "idea_068721";
 ...
 */
@Slf4j
public class Idea68721Service {
    private static final int IDEA_ID = 68721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68721Service() {
        this(new Idea68721Config());
    }

    public Idea68721Service(Idea68721Config config) {
        this.config = config != null ? config : new Idea68721Config();
