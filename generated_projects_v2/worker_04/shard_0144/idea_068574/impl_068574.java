...
@Data
public class Idea68574Config {
    private String name = "idea_068574";
 ...
 */
@Slf4j
public class Idea68574Service {
    private static final int IDEA_ID = 68574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68574Service() {
        this(new Idea68574Config());
    }

    public Idea68574Service(Idea68574Config config) {
        this.config = config != null ? config : new Idea68574Config();
