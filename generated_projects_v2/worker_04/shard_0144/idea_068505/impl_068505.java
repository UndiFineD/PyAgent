...
@Data
public class Idea68505Config {
    private String name = "idea_068505";
 ...
 */
@Slf4j
public class Idea68505Service {
    private static final int IDEA_ID = 68505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68505Service() {
        this(new Idea68505Config());
    }

    public Idea68505Service(Idea68505Config config) {
        this.config = config != null ? config : new Idea68505Config();
