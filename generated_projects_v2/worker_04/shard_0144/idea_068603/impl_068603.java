...
@Data
public class Idea68603Config {
    private String name = "idea_068603";
 ...
 */
@Slf4j
public class Idea68603Service {
    private static final int IDEA_ID = 68603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68603Service() {
        this(new Idea68603Config());
    }

    public Idea68603Service(Idea68603Config config) {
        this.config = config != null ? config : new Idea68603Config();
