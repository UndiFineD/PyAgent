...
@Data
public class Idea68862Config {
    private String name = "idea_068862";
 ...
 */
@Slf4j
public class Idea68862Service {
    private static final int IDEA_ID = 68862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68862Service() {
        this(new Idea68862Config());
    }

    public Idea68862Service(Idea68862Config config) {
        this.config = config != null ? config : new Idea68862Config();
