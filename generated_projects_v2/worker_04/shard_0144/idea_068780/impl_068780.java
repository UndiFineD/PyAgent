...
@Data
public class Idea68780Config {
    private String name = "idea_068780";
 ...
 */
@Slf4j
public class Idea68780Service {
    private static final int IDEA_ID = 68780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68780Service() {
        this(new Idea68780Config());
    }

    public Idea68780Service(Idea68780Config config) {
        this.config = config != null ? config : new Idea68780Config();
