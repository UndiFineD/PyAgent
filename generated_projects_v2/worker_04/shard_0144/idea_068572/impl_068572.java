...
@Data
public class Idea68572Config {
    private String name = "idea_068572";
 ...
 */
@Slf4j
public class Idea68572Service {
    private static final int IDEA_ID = 68572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68572Service() {
        this(new Idea68572Config());
    }

    public Idea68572Service(Idea68572Config config) {
        this.config = config != null ? config : new Idea68572Config();
