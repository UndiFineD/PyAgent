...
@Data
public class Idea68870Config {
    private String name = "idea_068870";
 ...
 */
@Slf4j
public class Idea68870Service {
    private static final int IDEA_ID = 68870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68870Service() {
        this(new Idea68870Config());
    }

    public Idea68870Service(Idea68870Config config) {
        this.config = config != null ? config : new Idea68870Config();
