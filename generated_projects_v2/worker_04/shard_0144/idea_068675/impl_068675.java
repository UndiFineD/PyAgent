...
@Data
public class Idea68675Config {
    private String name = "idea_068675";
 ...
 */
@Slf4j
public class Idea68675Service {
    private static final int IDEA_ID = 68675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68675Service() {
        this(new Idea68675Config());
    }

    public Idea68675Service(Idea68675Config config) {
        this.config = config != null ? config : new Idea68675Config();
