...
@Data
public class Idea68712Config {
    private String name = "idea_068712";
 ...
 */
@Slf4j
public class Idea68712Service {
    private static final int IDEA_ID = 68712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68712Service() {
        this(new Idea68712Config());
    }

    public Idea68712Service(Idea68712Config config) {
        this.config = config != null ? config : new Idea68712Config();
