...
@Data
public class Idea68678Config {
    private String name = "idea_068678";
 ...
 */
@Slf4j
public class Idea68678Service {
    private static final int IDEA_ID = 68678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68678Service() {
        this(new Idea68678Config());
    }

    public Idea68678Service(Idea68678Config config) {
        this.config = config != null ? config : new Idea68678Config();
