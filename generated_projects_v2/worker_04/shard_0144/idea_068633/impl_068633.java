...
@Data
public class Idea68633Config {
    private String name = "idea_068633";
 ...
 */
@Slf4j
public class Idea68633Service {
    private static final int IDEA_ID = 68633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68633Service() {
        this(new Idea68633Config());
    }

    public Idea68633Service(Idea68633Config config) {
        this.config = config != null ? config : new Idea68633Config();
