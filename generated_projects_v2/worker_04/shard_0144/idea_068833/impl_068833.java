...
@Data
public class Idea68833Config {
    private String name = "idea_068833";
 ...
 */
@Slf4j
public class Idea68833Service {
    private static final int IDEA_ID = 68833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68833Service() {
        this(new Idea68833Config());
    }

    public Idea68833Service(Idea68833Config config) {
        this.config = config != null ? config : new Idea68833Config();
