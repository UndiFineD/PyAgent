...
@Data
public class Idea68531Config {
    private String name = "idea_068531";
 ...
 */
@Slf4j
public class Idea68531Service {
    private static final int IDEA_ID = 68531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68531Service() {
        this(new Idea68531Config());
    }

    public Idea68531Service(Idea68531Config config) {
        this.config = config != null ? config : new Idea68531Config();
