...
@Data
public class Idea68797Config {
    private String name = "idea_068797";
 ...
 */
@Slf4j
public class Idea68797Service {
    private static final int IDEA_ID = 68797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68797Service() {
        this(new Idea68797Config());
    }

    public Idea68797Service(Idea68797Config config) {
        this.config = config != null ? config : new Idea68797Config();
