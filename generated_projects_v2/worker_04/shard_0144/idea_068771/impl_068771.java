...
@Data
public class Idea68771Config {
    private String name = "idea_068771";
 ...
 */
@Slf4j
public class Idea68771Service {
    private static final int IDEA_ID = 68771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68771Service() {
        this(new Idea68771Config());
    }

    public Idea68771Service(Idea68771Config config) {
        this.config = config != null ? config : new Idea68771Config();
