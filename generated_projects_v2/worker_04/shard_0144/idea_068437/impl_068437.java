...
@Data
public class Idea68437Config {
    private String name = "idea_068437";
 ...
 */
@Slf4j
public class Idea68437Service {
    private static final int IDEA_ID = 68437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68437Service() {
        this(new Idea68437Config());
    }

    public Idea68437Service(Idea68437Config config) {
        this.config = config != null ? config : new Idea68437Config();
