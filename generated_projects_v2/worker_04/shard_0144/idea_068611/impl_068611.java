...
@Data
public class Idea68611Config {
    private String name = "idea_068611";
 ...
 */
@Slf4j
public class Idea68611Service {
    private static final int IDEA_ID = 68611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68611Service() {
        this(new Idea68611Config());
    }

    public Idea68611Service(Idea68611Config config) {
        this.config = config != null ? config : new Idea68611Config();
