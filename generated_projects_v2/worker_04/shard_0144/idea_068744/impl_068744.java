...
@Data
public class Idea68744Config {
    private String name = "idea_068744";
 ...
 */
@Slf4j
public class Idea68744Service {
    private static final int IDEA_ID = 68744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68744Service() {
        this(new Idea68744Config());
    }

    public Idea68744Service(Idea68744Config config) {
        this.config = config != null ? config : new Idea68744Config();
