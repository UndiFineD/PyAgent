...
@Data
public class Idea68783Config {
    private String name = "idea_068783";
 ...
 */
@Slf4j
public class Idea68783Service {
    private static final int IDEA_ID = 68783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68783Service() {
        this(new Idea68783Config());
    }

    public Idea68783Service(Idea68783Config config) {
        this.config = config != null ? config : new Idea68783Config();
