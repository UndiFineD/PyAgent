...
@Data
public class Idea68490Config {
    private String name = "idea_068490";
 ...
 */
@Slf4j
public class Idea68490Service {
    private static final int IDEA_ID = 68490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68490Service() {
        this(new Idea68490Config());
    }

    public Idea68490Service(Idea68490Config config) {
        this.config = config != null ? config : new Idea68490Config();
