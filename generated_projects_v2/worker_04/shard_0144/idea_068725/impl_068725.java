...
@Data
public class Idea68725Config {
    private String name = "idea_068725";
 ...
 */
@Slf4j
public class Idea68725Service {
    private static final int IDEA_ID = 68725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68725Service() {
        this(new Idea68725Config());
    }

    public Idea68725Service(Idea68725Config config) {
        this.config = config != null ? config : new Idea68725Config();
