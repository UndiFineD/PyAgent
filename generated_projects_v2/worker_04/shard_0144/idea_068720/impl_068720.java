...
@Data
public class Idea68720Config {
    private String name = "idea_068720";
 ...
 */
@Slf4j
public class Idea68720Service {
    private static final int IDEA_ID = 68720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68720Service() {
        this(new Idea68720Config());
    }

    public Idea68720Service(Idea68720Config config) {
        this.config = config != null ? config : new Idea68720Config();
