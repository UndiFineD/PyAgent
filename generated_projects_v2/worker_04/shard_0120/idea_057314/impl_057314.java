...
@Data
public class Idea57314Config {
    private String name = "idea_057314";
 ...
 */
@Slf4j
public class Idea57314Service {
    private static final int IDEA_ID = 57314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57314Service() {
        this(new Idea57314Config());
    }

    public Idea57314Service(Idea57314Config config) {
        this.config = config != null ? config : new Idea57314Config();
