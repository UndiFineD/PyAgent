...
@Data
public class Idea57291Config {
    private String name = "idea_057291";
 ...
 */
@Slf4j
public class Idea57291Service {
    private static final int IDEA_ID = 57291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57291Service() {
        this(new Idea57291Config());
    }

    public Idea57291Service(Idea57291Config config) {
        this.config = config != null ? config : new Idea57291Config();
