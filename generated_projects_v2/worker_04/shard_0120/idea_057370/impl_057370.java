...
@Data
public class Idea57370Config {
    private String name = "idea_057370";
 ...
 */
@Slf4j
public class Idea57370Service {
    private static final int IDEA_ID = 57370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57370Service() {
        this(new Idea57370Config());
    }

    public Idea57370Service(Idea57370Config config) {
        this.config = config != null ? config : new Idea57370Config();
