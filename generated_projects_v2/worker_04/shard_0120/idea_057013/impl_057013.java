...
@Data
public class Idea57013Config {
    private String name = "idea_057013";
 ...
 */
@Slf4j
public class Idea57013Service {
    private static final int IDEA_ID = 57013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57013Service() {
        this(new Idea57013Config());
    }

    public Idea57013Service(Idea57013Config config) {
        this.config = config != null ? config : new Idea57013Config();
