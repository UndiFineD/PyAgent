...
@Data
public class Idea57414Config {
    private String name = "idea_057414";
 ...
 */
@Slf4j
public class Idea57414Service {
    private static final int IDEA_ID = 57414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57414Service() {
        this(new Idea57414Config());
    }

    public Idea57414Service(Idea57414Config config) {
        this.config = config != null ? config : new Idea57414Config();
