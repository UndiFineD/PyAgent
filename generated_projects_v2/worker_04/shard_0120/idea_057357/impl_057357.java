...
@Data
public class Idea57357Config {
    private String name = "idea_057357";
 ...
 */
@Slf4j
public class Idea57357Service {
    private static final int IDEA_ID = 57357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57357Service() {
        this(new Idea57357Config());
    }

    public Idea57357Service(Idea57357Config config) {
        this.config = config != null ? config : new Idea57357Config();
