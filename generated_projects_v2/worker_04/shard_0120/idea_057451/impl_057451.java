...
@Data
public class Idea57451Config {
    private String name = "idea_057451";
 ...
 */
@Slf4j
public class Idea57451Service {
    private static final int IDEA_ID = 57451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57451Service() {
        this(new Idea57451Config());
    }

    public Idea57451Service(Idea57451Config config) {
        this.config = config != null ? config : new Idea57451Config();
