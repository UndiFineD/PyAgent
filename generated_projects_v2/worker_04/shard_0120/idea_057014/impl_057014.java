...
@Data
public class Idea57014Config {
    private String name = "idea_057014";
 ...
 */
@Slf4j
public class Idea57014Service {
    private static final int IDEA_ID = 57014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57014Service() {
        this(new Idea57014Config());
    }

    public Idea57014Service(Idea57014Config config) {
        this.config = config != null ? config : new Idea57014Config();
