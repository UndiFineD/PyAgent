...
@Data
public class Idea57301Config {
    private String name = "idea_057301";
 ...
 */
@Slf4j
public class Idea57301Service {
    private static final int IDEA_ID = 57301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57301Service() {
        this(new Idea57301Config());
    }

    public Idea57301Service(Idea57301Config config) {
        this.config = config != null ? config : new Idea57301Config();
