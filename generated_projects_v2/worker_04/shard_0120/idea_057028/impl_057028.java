...
@Data
public class Idea57028Config {
    private String name = "idea_057028";
 ...
 */
@Slf4j
public class Idea57028Service {
    private static final int IDEA_ID = 57028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57028Service() {
        this(new Idea57028Config());
    }

    public Idea57028Service(Idea57028Config config) {
        this.config = config != null ? config : new Idea57028Config();
