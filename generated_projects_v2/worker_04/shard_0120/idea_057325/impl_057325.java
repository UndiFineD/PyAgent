...
@Data
public class Idea57325Config {
    private String name = "idea_057325";
 ...
 */
@Slf4j
public class Idea57325Service {
    private static final int IDEA_ID = 57325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57325Service() {
        this(new Idea57325Config());
    }

    public Idea57325Service(Idea57325Config config) {
        this.config = config != null ? config : new Idea57325Config();
