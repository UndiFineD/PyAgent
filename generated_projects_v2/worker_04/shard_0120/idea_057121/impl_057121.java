...
@Data
public class Idea57121Config {
    private String name = "idea_057121";
 ...
 */
@Slf4j
public class Idea57121Service {
    private static final int IDEA_ID = 57121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57121Service() {
        this(new Idea57121Config());
    }

    public Idea57121Service(Idea57121Config config) {
        this.config = config != null ? config : new Idea57121Config();
