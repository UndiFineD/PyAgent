...
@Data
public class Idea57203Config {
    private String name = "idea_057203";
 ...
 */
@Slf4j
public class Idea57203Service {
    private static final int IDEA_ID = 57203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57203Service() {
        this(new Idea57203Config());
    }

    public Idea57203Service(Idea57203Config config) {
        this.config = config != null ? config : new Idea57203Config();
