...
@Data
public class Idea57391Config {
    private String name = "idea_057391";
 ...
 */
@Slf4j
public class Idea57391Service {
    private static final int IDEA_ID = 57391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57391Service() {
        this(new Idea57391Config());
    }

    public Idea57391Service(Idea57391Config config) {
        this.config = config != null ? config : new Idea57391Config();
