...
@Data
public class Idea57083Config {
    private String name = "idea_057083";
 ...
 */
@Slf4j
public class Idea57083Service {
    private static final int IDEA_ID = 57083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57083Service() {
        this(new Idea57083Config());
    }

    public Idea57083Service(Idea57083Config config) {
        this.config = config != null ? config : new Idea57083Config();
