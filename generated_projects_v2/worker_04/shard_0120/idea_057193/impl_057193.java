...
@Data
public class Idea57193Config {
    private String name = "idea_057193";
 ...
 */
@Slf4j
public class Idea57193Service {
    private static final int IDEA_ID = 57193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57193Service() {
        this(new Idea57193Config());
    }

    public Idea57193Service(Idea57193Config config) {
        this.config = config != null ? config : new Idea57193Config();
