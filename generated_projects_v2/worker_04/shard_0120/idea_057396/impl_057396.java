...
@Data
public class Idea57396Config {
    private String name = "idea_057396";
 ...
 */
@Slf4j
public class Idea57396Service {
    private static final int IDEA_ID = 57396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57396Service() {
        this(new Idea57396Config());
    }

    public Idea57396Service(Idea57396Config config) {
        this.config = config != null ? config : new Idea57396Config();
