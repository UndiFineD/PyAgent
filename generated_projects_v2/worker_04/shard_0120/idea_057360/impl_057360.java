...
@Data
public class Idea57360Config {
    private String name = "idea_057360";
 ...
 */
@Slf4j
public class Idea57360Service {
    private static final int IDEA_ID = 57360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57360Service() {
        this(new Idea57360Config());
    }

    public Idea57360Service(Idea57360Config config) {
        this.config = config != null ? config : new Idea57360Config();
