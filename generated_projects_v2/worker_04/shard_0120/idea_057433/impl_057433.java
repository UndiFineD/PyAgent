...
@Data
public class Idea57433Config {
    private String name = "idea_057433";
 ...
 */
@Slf4j
public class Idea57433Service {
    private static final int IDEA_ID = 57433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57433Service() {
        this(new Idea57433Config());
    }

    public Idea57433Service(Idea57433Config config) {
        this.config = config != null ? config : new Idea57433Config();
