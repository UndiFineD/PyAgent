...
@Data
public class Idea57272Config {
    private String name = "idea_057272";
 ...
 */
@Slf4j
public class Idea57272Service {
    private static final int IDEA_ID = 57272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57272Service() {
        this(new Idea57272Config());
    }

    public Idea57272Service(Idea57272Config config) {
        this.config = config != null ? config : new Idea57272Config();
