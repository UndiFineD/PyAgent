...
@Data
public class Idea57378Config {
    private String name = "idea_057378";
 ...
 */
@Slf4j
public class Idea57378Service {
    private static final int IDEA_ID = 57378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57378Service() {
        this(new Idea57378Config());
    }

    public Idea57378Service(Idea57378Config config) {
        this.config = config != null ? config : new Idea57378Config();
