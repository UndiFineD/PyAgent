...
@Data
public class Idea57402Config {
    private String name = "idea_057402";
 ...
 */
@Slf4j
public class Idea57402Service {
    private static final int IDEA_ID = 57402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57402Service() {
        this(new Idea57402Config());
    }

    public Idea57402Service(Idea57402Config config) {
        this.config = config != null ? config : new Idea57402Config();
