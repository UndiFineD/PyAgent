...
@Data
public class Idea57351Config {
    private String name = "idea_057351";
 ...
 */
@Slf4j
public class Idea57351Service {
    private static final int IDEA_ID = 57351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57351Service() {
        this(new Idea57351Config());
    }

    public Idea57351Service(Idea57351Config config) {
        this.config = config != null ? config : new Idea57351Config();
