...
@Data
public class Idea57327Config {
    private String name = "idea_057327";
 ...
 */
@Slf4j
public class Idea57327Service {
    private static final int IDEA_ID = 57327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57327Service() {
        this(new Idea57327Config());
    }

    public Idea57327Service(Idea57327Config config) {
        this.config = config != null ? config : new Idea57327Config();
