...
@Data
public class Idea57354Config {
    private String name = "idea_057354";
 ...
 */
@Slf4j
public class Idea57354Service {
    private static final int IDEA_ID = 57354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57354Service() {
        this(new Idea57354Config());
    }

    public Idea57354Service(Idea57354Config config) {
        this.config = config != null ? config : new Idea57354Config();
