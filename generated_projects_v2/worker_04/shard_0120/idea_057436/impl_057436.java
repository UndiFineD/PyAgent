...
@Data
public class Idea57436Config {
    private String name = "idea_057436";
 ...
 */
@Slf4j
public class Idea57436Service {
    private static final int IDEA_ID = 57436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57436Service() {
        this(new Idea57436Config());
    }

    public Idea57436Service(Idea57436Config config) {
        this.config = config != null ? config : new Idea57436Config();
