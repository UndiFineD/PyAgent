...
@Data
public class Idea57261Config {
    private String name = "idea_057261";
 ...
 */
@Slf4j
public class Idea57261Service {
    private static final int IDEA_ID = 57261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57261Service() {
        this(new Idea57261Config());
    }

    public Idea57261Service(Idea57261Config config) {
        this.config = config != null ? config : new Idea57261Config();
