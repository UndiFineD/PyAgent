...
@Data
public class Idea57300Config {
    private String name = "idea_057300";
 ...
 */
@Slf4j
public class Idea57300Service {
    private static final int IDEA_ID = 57300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57300Service() {
        this(new Idea57300Config());
    }

    public Idea57300Service(Idea57300Config config) {
        this.config = config != null ? config : new Idea57300Config();
