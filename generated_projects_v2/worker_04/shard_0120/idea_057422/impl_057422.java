...
@Data
public class Idea57422Config {
    private String name = "idea_057422";
 ...
 */
@Slf4j
public class Idea57422Service {
    private static final int IDEA_ID = 57422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57422Service() {
        this(new Idea57422Config());
    }

    public Idea57422Service(Idea57422Config config) {
        this.config = config != null ? config : new Idea57422Config();
