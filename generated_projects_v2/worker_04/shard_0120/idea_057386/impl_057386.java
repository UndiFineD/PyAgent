...
@Data
public class Idea57386Config {
    private String name = "idea_057386";
 ...
 */
@Slf4j
public class Idea57386Service {
    private static final int IDEA_ID = 57386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57386Service() {
        this(new Idea57386Config());
    }

    public Idea57386Service(Idea57386Config config) {
        this.config = config != null ? config : new Idea57386Config();
