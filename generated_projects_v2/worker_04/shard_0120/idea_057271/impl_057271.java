...
@Data
public class Idea57271Config {
    private String name = "idea_057271";
 ...
 */
@Slf4j
public class Idea57271Service {
    private static final int IDEA_ID = 57271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57271Service() {
        this(new Idea57271Config());
    }

    public Idea57271Service(Idea57271Config config) {
        this.config = config != null ? config : new Idea57271Config();
