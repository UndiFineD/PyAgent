...
@Data
public class Idea57033Config {
    private String name = "idea_057033";
 ...
 */
@Slf4j
public class Idea57033Service {
    private static final int IDEA_ID = 57033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57033Service() {
        this(new Idea57033Config());
    }

    public Idea57033Service(Idea57033Config config) {
        this.config = config != null ? config : new Idea57033Config();
