...
@Data
public class Idea57374Config {
    private String name = "idea_057374";
 ...
 */
@Slf4j
public class Idea57374Service {
    private static final int IDEA_ID = 57374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57374Service() {
        this(new Idea57374Config());
    }

    public Idea57374Service(Idea57374Config config) {
        this.config = config != null ? config : new Idea57374Config();
