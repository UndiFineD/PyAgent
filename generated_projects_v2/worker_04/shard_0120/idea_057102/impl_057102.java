...
@Data
public class Idea57102Config {
    private String name = "idea_057102";
 ...
 */
@Slf4j
public class Idea57102Service {
    private static final int IDEA_ID = 57102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57102Service() {
        this(new Idea57102Config());
    }

    public Idea57102Service(Idea57102Config config) {
        this.config = config != null ? config : new Idea57102Config();
