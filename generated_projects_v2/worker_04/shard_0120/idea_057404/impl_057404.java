...
@Data
public class Idea57404Config {
    private String name = "idea_057404";
 ...
 */
@Slf4j
public class Idea57404Service {
    private static final int IDEA_ID = 57404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57404Service() {
        this(new Idea57404Config());
    }

    public Idea57404Service(Idea57404Config config) {
        this.config = config != null ? config : new Idea57404Config();
