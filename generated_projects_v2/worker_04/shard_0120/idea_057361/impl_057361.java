...
@Data
public class Idea57361Config {
    private String name = "idea_057361";
 ...
 */
@Slf4j
public class Idea57361Service {
    private static final int IDEA_ID = 57361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57361Service() {
        this(new Idea57361Config());
    }

    public Idea57361Service(Idea57361Config config) {
        this.config = config != null ? config : new Idea57361Config();
