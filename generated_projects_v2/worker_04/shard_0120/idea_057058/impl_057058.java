...
@Data
public class Idea57058Config {
    private String name = "idea_057058";
 ...
 */
@Slf4j
public class Idea57058Service {
    private static final int IDEA_ID = 57058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57058Service() {
        this(new Idea57058Config());
    }

    public Idea57058Service(Idea57058Config config) {
        this.config = config != null ? config : new Idea57058Config();
