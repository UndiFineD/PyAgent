...
@Data
public class Idea57087Config {
    private String name = "idea_057087";
 ...
 */
@Slf4j
public class Idea57087Service {
    private static final int IDEA_ID = 57087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57087Service() {
        this(new Idea57087Config());
    }

    public Idea57087Service(Idea57087Config config) {
        this.config = config != null ? config : new Idea57087Config();
