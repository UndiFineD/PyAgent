...
@Data
public class Idea57001Config {
    private String name = "idea_057001";
 ...
 */
@Slf4j
public class Idea57001Service {
    private static final int IDEA_ID = 57001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57001Service() {
        this(new Idea57001Config());
    }

    public Idea57001Service(Idea57001Config config) {
        this.config = config != null ? config : new Idea57001Config();
