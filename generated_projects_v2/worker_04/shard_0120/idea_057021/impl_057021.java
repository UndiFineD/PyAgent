...
@Data
public class Idea57021Config {
    private String name = "idea_057021";
 ...
 */
@Slf4j
public class Idea57021Service {
    private static final int IDEA_ID = 57021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57021Service() {
        this(new Idea57021Config());
    }

    public Idea57021Service(Idea57021Config config) {
        this.config = config != null ? config : new Idea57021Config();
