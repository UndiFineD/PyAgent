...
@Data
public class Idea57410Config {
    private String name = "idea_057410";
 ...
 */
@Slf4j
public class Idea57410Service {
    private static final int IDEA_ID = 57410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57410Service() {
        this(new Idea57410Config());
    }

    public Idea57410Service(Idea57410Config config) {
        this.config = config != null ? config : new Idea57410Config();
