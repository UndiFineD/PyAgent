...
@Data
public class Idea57158Config {
    private String name = "idea_057158";
 ...
 */
@Slf4j
public class Idea57158Service {
    private static final int IDEA_ID = 57158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57158Service() {
        this(new Idea57158Config());
    }

    public Idea57158Service(Idea57158Config config) {
        this.config = config != null ? config : new Idea57158Config();
