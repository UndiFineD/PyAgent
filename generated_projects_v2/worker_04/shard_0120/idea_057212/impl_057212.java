...
@Data
public class Idea57212Config {
    private String name = "idea_057212";
 ...
 */
@Slf4j
public class Idea57212Service {
    private static final int IDEA_ID = 57212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57212Service() {
        this(new Idea57212Config());
    }

    public Idea57212Service(Idea57212Config config) {
        this.config = config != null ? config : new Idea57212Config();
