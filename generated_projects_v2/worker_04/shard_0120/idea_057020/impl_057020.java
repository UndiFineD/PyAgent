...
@Data
public class Idea57020Config {
    private String name = "idea_057020";
 ...
 */
@Slf4j
public class Idea57020Service {
    private static final int IDEA_ID = 57020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57020Service() {
        this(new Idea57020Config());
    }

    public Idea57020Service(Idea57020Config config) {
        this.config = config != null ? config : new Idea57020Config();
