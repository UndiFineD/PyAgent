...
@Data
public class Idea57358Config {
    private String name = "idea_057358";
 ...
 */
@Slf4j
public class Idea57358Service {
    private static final int IDEA_ID = 57358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57358Service() {
        this(new Idea57358Config());
    }

    public Idea57358Service(Idea57358Config config) {
        this.config = config != null ? config : new Idea57358Config();
