...
@Data
public class Idea57332Config {
    private String name = "idea_057332";
 ...
 */
@Slf4j
public class Idea57332Service {
    private static final int IDEA_ID = 57332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57332Service() {
        this(new Idea57332Config());
    }

    public Idea57332Service(Idea57332Config config) {
        this.config = config != null ? config : new Idea57332Config();
