...
@Data
public class Idea57420Config {
    private String name = "idea_057420";
 ...
 */
@Slf4j
public class Idea57420Service {
    private static final int IDEA_ID = 57420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57420Service() {
        this(new Idea57420Config());
    }

    public Idea57420Service(Idea57420Config config) {
        this.config = config != null ? config : new Idea57420Config();
