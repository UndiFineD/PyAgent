...
@Data
public class Idea57344Config {
    private String name = "idea_057344";
 ...
 */
@Slf4j
public class Idea57344Service {
    private static final int IDEA_ID = 57344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57344Service() {
        this(new Idea57344Config());
    }

    public Idea57344Service(Idea57344Config config) {
        this.config = config != null ? config : new Idea57344Config();
