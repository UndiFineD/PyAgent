...
@Data
public class Idea57210Config {
    private String name = "idea_057210";
 ...
 */
@Slf4j
public class Idea57210Service {
    private static final int IDEA_ID = 57210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57210Service() {
        this(new Idea57210Config());
    }

    public Idea57210Service(Idea57210Config config) {
        this.config = config != null ? config : new Idea57210Config();
