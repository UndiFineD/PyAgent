...
@Data
public class Idea57120Config {
    private String name = "idea_057120";
 ...
 */
@Slf4j
public class Idea57120Service {
    private static final int IDEA_ID = 57120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57120Service() {
        this(new Idea57120Config());
    }

    public Idea57120Service(Idea57120Config config) {
        this.config = config != null ? config : new Idea57120Config();
