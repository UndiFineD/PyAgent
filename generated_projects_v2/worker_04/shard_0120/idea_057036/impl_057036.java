...
@Data
public class Idea57036Config {
    private String name = "idea_057036";
 ...
 */
@Slf4j
public class Idea57036Service {
    private static final int IDEA_ID = 57036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57036Service() {
        this(new Idea57036Config());
    }

    public Idea57036Service(Idea57036Config config) {
        this.config = config != null ? config : new Idea57036Config();
