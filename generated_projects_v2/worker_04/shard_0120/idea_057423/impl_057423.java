...
@Data
public class Idea57423Config {
    private String name = "idea_057423";
 ...
 */
@Slf4j
public class Idea57423Service {
    private static final int IDEA_ID = 57423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57423Service() {
        this(new Idea57423Config());
    }

    public Idea57423Service(Idea57423Config config) {
        this.config = config != null ? config : new Idea57423Config();
