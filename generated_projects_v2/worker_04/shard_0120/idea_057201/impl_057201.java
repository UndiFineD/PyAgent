...
@Data
public class Idea57201Config {
    private String name = "idea_057201";
 ...
 */
@Slf4j
public class Idea57201Service {
    private static final int IDEA_ID = 57201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57201Service() {
        this(new Idea57201Config());
    }

    public Idea57201Service(Idea57201Config config) {
        this.config = config != null ? config : new Idea57201Config();
