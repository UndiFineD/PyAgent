...
@Data
public class Idea57408Config {
    private String name = "idea_057408";
 ...
 */
@Slf4j
public class Idea57408Service {
    private static final int IDEA_ID = 57408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57408Service() {
        this(new Idea57408Config());
    }

    public Idea57408Service(Idea57408Config config) {
        this.config = config != null ? config : new Idea57408Config();
