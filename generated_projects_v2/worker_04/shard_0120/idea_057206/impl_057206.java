...
@Data
public class Idea57206Config {
    private String name = "idea_057206";
 ...
 */
@Slf4j
public class Idea57206Service {
    private static final int IDEA_ID = 57206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57206Service() {
        this(new Idea57206Config());
    }

    public Idea57206Service(Idea57206Config config) {
        this.config = config != null ? config : new Idea57206Config();
