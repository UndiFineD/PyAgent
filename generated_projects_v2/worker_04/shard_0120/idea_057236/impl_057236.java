...
@Data
public class Idea57236Config {
    private String name = "idea_057236";
 ...
 */
@Slf4j
public class Idea57236Service {
    private static final int IDEA_ID = 57236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57236Service() {
        this(new Idea57236Config());
    }

    public Idea57236Service(Idea57236Config config) {
        this.config = config != null ? config : new Idea57236Config();
