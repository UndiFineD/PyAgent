...
@Data
public class Idea57233Config {
    private String name = "idea_057233";
 ...
 */
@Slf4j
public class Idea57233Service {
    private static final int IDEA_ID = 57233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57233Service() {
        this(new Idea57233Config());
    }

    public Idea57233Service(Idea57233Config config) {
        this.config = config != null ? config : new Idea57233Config();
