...
@Data
public class Idea57383Config {
    private String name = "idea_057383";
 ...
 */
@Slf4j
public class Idea57383Service {
    private static final int IDEA_ID = 57383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57383Service() {
        this(new Idea57383Config());
    }

    public Idea57383Service(Idea57383Config config) {
        this.config = config != null ? config : new Idea57383Config();
