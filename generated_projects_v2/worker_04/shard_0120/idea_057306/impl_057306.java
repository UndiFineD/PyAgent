...
@Data
public class Idea57306Config {
    private String name = "idea_057306";
 ...
 */
@Slf4j
public class Idea57306Service {
    private static final int IDEA_ID = 57306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57306Service() {
        this(new Idea57306Config());
    }

    public Idea57306Service(Idea57306Config config) {
        this.config = config != null ? config : new Idea57306Config();
