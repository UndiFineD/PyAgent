...
@Data
public class Idea57108Config {
    private String name = "idea_057108";
 ...
 */
@Slf4j
public class Idea57108Service {
    private static final int IDEA_ID = 57108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57108Service() {
        this(new Idea57108Config());
    }

    public Idea57108Service(Idea57108Config config) {
        this.config = config != null ? config : new Idea57108Config();
