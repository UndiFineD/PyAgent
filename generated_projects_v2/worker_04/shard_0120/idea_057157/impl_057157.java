...
@Data
public class Idea57157Config {
    private String name = "idea_057157";
 ...
 */
@Slf4j
public class Idea57157Service {
    private static final int IDEA_ID = 57157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57157Service() {
        this(new Idea57157Config());
    }

    public Idea57157Service(Idea57157Config config) {
        this.config = config != null ? config : new Idea57157Config();
