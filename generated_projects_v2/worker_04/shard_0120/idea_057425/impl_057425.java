...
@Data
public class Idea57425Config {
    private String name = "idea_057425";
 ...
 */
@Slf4j
public class Idea57425Service {
    private static final int IDEA_ID = 57425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57425Service() {
        this(new Idea57425Config());
    }

    public Idea57425Service(Idea57425Config config) {
        this.config = config != null ? config : new Idea57425Config();
