...
@Data
public class Idea57321Config {
    private String name = "idea_057321";
 ...
 */
@Slf4j
public class Idea57321Service {
    private static final int IDEA_ID = 57321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57321Service() {
        this(new Idea57321Config());
    }

    public Idea57321Service(Idea57321Config config) {
        this.config = config != null ? config : new Idea57321Config();
