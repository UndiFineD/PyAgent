...
@Data
public class Idea57298Config {
    private String name = "idea_057298";
 ...
 */
@Slf4j
public class Idea57298Service {
    private static final int IDEA_ID = 57298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57298Service() {
        this(new Idea57298Config());
    }

    public Idea57298Service(Idea57298Config config) {
        this.config = config != null ? config : new Idea57298Config();
