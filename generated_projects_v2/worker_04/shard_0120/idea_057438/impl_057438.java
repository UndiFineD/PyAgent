...
@Data
public class Idea57438Config {
    private String name = "idea_057438";
 ...
 */
@Slf4j
public class Idea57438Service {
    private static final int IDEA_ID = 57438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57438Service() {
        this(new Idea57438Config());
    }

    public Idea57438Service(Idea57438Config config) {
        this.config = config != null ? config : new Idea57438Config();
