...
@Data
public class Idea57104Config {
    private String name = "idea_057104";
 ...
 */
@Slf4j
public class Idea57104Service {
    private static final int IDEA_ID = 57104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57104Service() {
        this(new Idea57104Config());
    }

    public Idea57104Service(Idea57104Config config) {
        this.config = config != null ? config : new Idea57104Config();
