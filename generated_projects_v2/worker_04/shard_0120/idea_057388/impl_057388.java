...
@Data
public class Idea57388Config {
    private String name = "idea_057388";
 ...
 */
@Slf4j
public class Idea57388Service {
    private static final int IDEA_ID = 57388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57388Service() {
        this(new Idea57388Config());
    }

    public Idea57388Service(Idea57388Config config) {
        this.config = config != null ? config : new Idea57388Config();
