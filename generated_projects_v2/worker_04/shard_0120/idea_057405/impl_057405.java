...
@Data
public class Idea57405Config {
    private String name = "idea_057405";
 ...
 */
@Slf4j
public class Idea57405Service {
    private static final int IDEA_ID = 57405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57405Service() {
        this(new Idea57405Config());
    }

    public Idea57405Service(Idea57405Config config) {
        this.config = config != null ? config : new Idea57405Config();
