...
@Data
public class Idea57380Config {
    private String name = "idea_057380";
 ...
 */
@Slf4j
public class Idea57380Service {
    private static final int IDEA_ID = 57380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57380Service() {
        this(new Idea57380Config());
    }

    public Idea57380Service(Idea57380Config config) {
        this.config = config != null ? config : new Idea57380Config();
