...
@Data
public class Idea57037Config {
    private String name = "idea_057037";
 ...
 */
@Slf4j
public class Idea57037Service {
    private static final int IDEA_ID = 57037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57037Service() {
        this(new Idea57037Config());
    }

    public Idea57037Service(Idea57037Config config) {
        this.config = config != null ? config : new Idea57037Config();
