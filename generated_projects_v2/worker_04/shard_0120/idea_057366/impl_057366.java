...
@Data
public class Idea57366Config {
    private String name = "idea_057366";
 ...
 */
@Slf4j
public class Idea57366Service {
    private static final int IDEA_ID = 57366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57366Service() {
        this(new Idea57366Config());
    }

    public Idea57366Service(Idea57366Config config) {
        this.config = config != null ? config : new Idea57366Config();
