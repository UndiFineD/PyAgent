...
@Data
public class Idea57027Config {
    private String name = "idea_057027";
 ...
 */
@Slf4j
public class Idea57027Service {
    private static final int IDEA_ID = 57027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57027Service() {
        this(new Idea57027Config());
    }

    public Idea57027Service(Idea57027Config config) {
        this.config = config != null ? config : new Idea57027Config();
