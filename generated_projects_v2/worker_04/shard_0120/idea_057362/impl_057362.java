...
@Data
public class Idea57362Config {
    private String name = "idea_057362";
 ...
 */
@Slf4j
public class Idea57362Service {
    private static final int IDEA_ID = 57362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57362Service() {
        this(new Idea57362Config());
    }

    public Idea57362Service(Idea57362Config config) {
        this.config = config != null ? config : new Idea57362Config();
