...
@Data
public class Idea57302Config {
    private String name = "idea_057302";
 ...
 */
@Slf4j
public class Idea57302Service {
    private static final int IDEA_ID = 57302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57302Service() {
        this(new Idea57302Config());
    }

    public Idea57302Service(Idea57302Config config) {
        this.config = config != null ? config : new Idea57302Config();
