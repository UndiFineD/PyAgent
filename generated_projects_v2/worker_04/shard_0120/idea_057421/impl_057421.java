...
@Data
public class Idea57421Config {
    private String name = "idea_057421";
 ...
 */
@Slf4j
public class Idea57421Service {
    private static final int IDEA_ID = 57421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57421Service() {
        this(new Idea57421Config());
    }

    public Idea57421Service(Idea57421Config config) {
        this.config = config != null ? config : new Idea57421Config();
