...
@Data
public class Idea57470Config {
    private String name = "idea_057470";
 ...
 */
@Slf4j
public class Idea57470Service {
    private static final int IDEA_ID = 57470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57470Service() {
        this(new Idea57470Config());
    }

    public Idea57470Service(Idea57470Config config) {
        this.config = config != null ? config : new Idea57470Config();
