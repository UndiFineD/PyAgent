...
@Data
public class Idea57308Config {
    private String name = "idea_057308";
 ...
 */
@Slf4j
public class Idea57308Service {
    private static final int IDEA_ID = 57308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57308Service() {
        this(new Idea57308Config());
    }

    public Idea57308Service(Idea57308Config config) {
        this.config = config != null ? config : new Idea57308Config();
