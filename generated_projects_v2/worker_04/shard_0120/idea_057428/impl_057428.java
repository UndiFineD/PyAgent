...
@Data
public class Idea57428Config {
    private String name = "idea_057428";
 ...
 */
@Slf4j
public class Idea57428Service {
    private static final int IDEA_ID = 57428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57428Service() {
        this(new Idea57428Config());
    }

    public Idea57428Service(Idea57428Config config) {
        this.config = config != null ? config : new Idea57428Config();
