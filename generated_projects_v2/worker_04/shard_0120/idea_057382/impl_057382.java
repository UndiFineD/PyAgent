...
@Data
public class Idea57382Config {
    private String name = "idea_057382";
 ...
 */
@Slf4j
public class Idea57382Service {
    private static final int IDEA_ID = 57382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57382Service() {
        this(new Idea57382Config());
    }

    public Idea57382Service(Idea57382Config config) {
        this.config = config != null ? config : new Idea57382Config();
