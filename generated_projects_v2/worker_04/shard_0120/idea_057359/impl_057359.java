...
@Data
public class Idea57359Config {
    private String name = "idea_057359";
 ...
 */
@Slf4j
public class Idea57359Service {
    private static final int IDEA_ID = 57359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57359Service() {
        this(new Idea57359Config());
    }

    public Idea57359Service(Idea57359Config config) {
        this.config = config != null ? config : new Idea57359Config();
