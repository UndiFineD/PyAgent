...
@Data
public class Idea57101Config {
    private String name = "idea_057101";
 ...
 */
@Slf4j
public class Idea57101Service {
    private static final int IDEA_ID = 57101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57101Service() {
        this(new Idea57101Config());
    }

    public Idea57101Service(Idea57101Config config) {
        this.config = config != null ? config : new Idea57101Config();
