...
@Data
public class Idea57125Config {
    private String name = "idea_057125";
 ...
 */
@Slf4j
public class Idea57125Service {
    private static final int IDEA_ID = 57125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57125Service() {
        this(new Idea57125Config());
    }

    public Idea57125Service(Idea57125Config config) {
        this.config = config != null ? config : new Idea57125Config();
