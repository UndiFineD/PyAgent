...
@Data
public class Idea57138Config {
    private String name = "idea_057138";
 ...
 */
@Slf4j
public class Idea57138Service {
    private static final int IDEA_ID = 57138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57138Service() {
        this(new Idea57138Config());
    }

    public Idea57138Service(Idea57138Config config) {
        this.config = config != null ? config : new Idea57138Config();
