...
@Data
public class Idea57122Config {
    private String name = "idea_057122";
 ...
 */
@Slf4j
public class Idea57122Service {
    private static final int IDEA_ID = 57122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57122Service() {
        this(new Idea57122Config());
    }

    public Idea57122Service(Idea57122Config config) {
        this.config = config != null ? config : new Idea57122Config();
