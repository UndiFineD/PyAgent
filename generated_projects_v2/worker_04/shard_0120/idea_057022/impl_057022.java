...
@Data
public class Idea57022Config {
    private String name = "idea_057022";
 ...
 */
@Slf4j
public class Idea57022Service {
    private static final int IDEA_ID = 57022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57022Service() {
        this(new Idea57022Config());
    }

    public Idea57022Service(Idea57022Config config) {
        this.config = config != null ? config : new Idea57022Config();
