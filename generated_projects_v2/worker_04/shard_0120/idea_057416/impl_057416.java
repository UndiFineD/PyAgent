...
@Data
public class Idea57416Config {
    private String name = "idea_057416";
 ...
 */
@Slf4j
public class Idea57416Service {
    private static final int IDEA_ID = 57416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57416Service() {
        this(new Idea57416Config());
    }

    public Idea57416Service(Idea57416Config config) {
        this.config = config != null ? config : new Idea57416Config();
