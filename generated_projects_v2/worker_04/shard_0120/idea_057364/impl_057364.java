...
@Data
public class Idea57364Config {
    private String name = "idea_057364";
 ...
 */
@Slf4j
public class Idea57364Service {
    private static final int IDEA_ID = 57364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57364Service() {
        this(new Idea57364Config());
    }

    public Idea57364Service(Idea57364Config config) {
        this.config = config != null ? config : new Idea57364Config();
