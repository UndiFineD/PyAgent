...
@Data
public class Idea57005Config {
    private String name = "idea_057005";
 ...
 */
@Slf4j
public class Idea57005Service {
    private static final int IDEA_ID = 57005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57005Service() {
        this(new Idea57005Config());
    }

    public Idea57005Service(Idea57005Config config) {
        this.config = config != null ? config : new Idea57005Config();
