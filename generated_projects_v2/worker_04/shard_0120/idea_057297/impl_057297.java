...
@Data
public class Idea57297Config {
    private String name = "idea_057297";
 ...
 */
@Slf4j
public class Idea57297Service {
    private static final int IDEA_ID = 57297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57297Service() {
        this(new Idea57297Config());
    }

    public Idea57297Service(Idea57297Config config) {
        this.config = config != null ? config : new Idea57297Config();
