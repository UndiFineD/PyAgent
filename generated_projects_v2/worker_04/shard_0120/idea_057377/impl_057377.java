...
@Data
public class Idea57377Config {
    private String name = "idea_057377";
 ...
 */
@Slf4j
public class Idea57377Service {
    private static final int IDEA_ID = 57377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57377Service() {
        this(new Idea57377Config());
    }

    public Idea57377Service(Idea57377Config config) {
        this.config = config != null ? config : new Idea57377Config();
