...
@Data
public class Idea57023Config {
    private String name = "idea_057023";
 ...
 */
@Slf4j
public class Idea57023Service {
    private static final int IDEA_ID = 57023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57023Service() {
        this(new Idea57023Config());
    }

    public Idea57023Service(Idea57023Config config) {
        this.config = config != null ? config : new Idea57023Config();
