...
@Data
public class Idea57375Config {
    private String name = "idea_057375";
 ...
 */
@Slf4j
public class Idea57375Service {
    private static final int IDEA_ID = 57375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57375Service() {
        this(new Idea57375Config());
    }

    public Idea57375Service(Idea57375Config config) {
        this.config = config != null ? config : new Idea57375Config();
