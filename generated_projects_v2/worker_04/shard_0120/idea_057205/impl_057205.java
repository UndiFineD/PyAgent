...
@Data
public class Idea57205Config {
    private String name = "idea_057205";
 ...
 */
@Slf4j
public class Idea57205Service {
    private static final int IDEA_ID = 57205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57205Service() {
        this(new Idea57205Config());
    }

    public Idea57205Service(Idea57205Config config) {
        this.config = config != null ? config : new Idea57205Config();
