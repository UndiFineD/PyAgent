...
@Data
public class Idea57409Config {
    private String name = "idea_057409";
 ...
 */
@Slf4j
public class Idea57409Service {
    private static final int IDEA_ID = 57409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57409Service() {
        this(new Idea57409Config());
    }

    public Idea57409Service(Idea57409Config config) {
        this.config = config != null ? config : new Idea57409Config();
