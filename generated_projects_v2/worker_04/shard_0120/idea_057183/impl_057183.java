...
@Data
public class Idea57183Config {
    private String name = "idea_057183";
 ...
 */
@Slf4j
public class Idea57183Service {
    private static final int IDEA_ID = 57183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57183Service() {
        this(new Idea57183Config());
    }

    public Idea57183Service(Idea57183Config config) {
        this.config = config != null ? config : new Idea57183Config();
