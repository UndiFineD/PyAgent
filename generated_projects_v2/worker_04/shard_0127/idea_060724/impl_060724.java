...
@Data
public class Idea60724Config {
    private String name = "idea_060724";
 ...
 */
@Slf4j
public class Idea60724Service {
    private static final int IDEA_ID = 60724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60724Service() {
        this(new Idea60724Config());
    }

    public Idea60724Service(Idea60724Config config) {
        this.config = config != null ? config : new Idea60724Config();
