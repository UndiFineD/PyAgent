...
@Data
public class Idea60401Config {
    private String name = "idea_060401";
 ...
 */
@Slf4j
public class Idea60401Service {
    private static final int IDEA_ID = 60401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60401Service() {
        this(new Idea60401Config());
    }

    public Idea60401Service(Idea60401Config config) {
        this.config = config != null ? config : new Idea60401Config();
