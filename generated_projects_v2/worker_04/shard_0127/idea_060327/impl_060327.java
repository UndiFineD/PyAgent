...
@Data
public class Idea60327Config {
    private String name = "idea_060327";
 ...
 */
@Slf4j
public class Idea60327Service {
    private static final int IDEA_ID = 60327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60327Service() {
        this(new Idea60327Config());
    }

    public Idea60327Service(Idea60327Config config) {
        this.config = config != null ? config : new Idea60327Config();
