...
@Data
public class Idea60541Config {
    private String name = "idea_060541";
 ...
 */
@Slf4j
public class Idea60541Service {
    private static final int IDEA_ID = 60541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60541Service() {
        this(new Idea60541Config());
    }

    public Idea60541Service(Idea60541Config config) {
        this.config = config != null ? config : new Idea60541Config();
