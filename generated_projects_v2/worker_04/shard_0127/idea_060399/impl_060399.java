...
@Data
public class Idea60399Config {
    private String name = "idea_060399";
 ...
 */
@Slf4j
public class Idea60399Service {
    private static final int IDEA_ID = 60399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60399Service() {
        this(new Idea60399Config());
    }

    public Idea60399Service(Idea60399Config config) {
        this.config = config != null ? config : new Idea60399Config();
