...
@Data
public class Idea60506Config {
    private String name = "idea_060506";
 ...
 */
@Slf4j
public class Idea60506Service {
    private static final int IDEA_ID = 60506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60506Service() {
        this(new Idea60506Config());
    }

    public Idea60506Service(Idea60506Config config) {
        this.config = config != null ? config : new Idea60506Config();
