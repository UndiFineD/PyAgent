...
@Data
public class Idea60379Config {
    private String name = "idea_060379";
 ...
 */
@Slf4j
public class Idea60379Service {
    private static final int IDEA_ID = 60379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60379Service() {
        this(new Idea60379Config());
    }

    public Idea60379Service(Idea60379Config config) {
        this.config = config != null ? config : new Idea60379Config();
