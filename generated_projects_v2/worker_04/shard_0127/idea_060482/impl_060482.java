...
@Data
public class Idea60482Config {
    private String name = "idea_060482";
 ...
 */
@Slf4j
public class Idea60482Service {
    private static final int IDEA_ID = 60482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60482Service() {
        this(new Idea60482Config());
    }

    public Idea60482Service(Idea60482Config config) {
        this.config = config != null ? config : new Idea60482Config();
