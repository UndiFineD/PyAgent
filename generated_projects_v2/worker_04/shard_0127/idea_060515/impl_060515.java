...
@Data
public class Idea60515Config {
    private String name = "idea_060515";
 ...
 */
@Slf4j
public class Idea60515Service {
    private static final int IDEA_ID = 60515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60515Service() {
        this(new Idea60515Config());
    }

    public Idea60515Service(Idea60515Config config) {
        this.config = config != null ? config : new Idea60515Config();
