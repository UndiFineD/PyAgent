...
@Data
public class Idea60778Config {
    private String name = "idea_060778";
 ...
 */
@Slf4j
public class Idea60778Service {
    private static final int IDEA_ID = 60778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60778Service() {
        this(new Idea60778Config());
    }

    public Idea60778Service(Idea60778Config config) {
        this.config = config != null ? config : new Idea60778Config();
