...
@Data
public class Idea60603Config {
    private String name = "idea_060603";
 ...
 */
@Slf4j
public class Idea60603Service {
    private static final int IDEA_ID = 60603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60603Service() {
        this(new Idea60603Config());
    }

    public Idea60603Service(Idea60603Config config) {
        this.config = config != null ? config : new Idea60603Config();
