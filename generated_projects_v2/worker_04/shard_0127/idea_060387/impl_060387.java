...
@Data
public class Idea60387Config {
    private String name = "idea_060387";
 ...
 */
@Slf4j
public class Idea60387Service {
    private static final int IDEA_ID = 60387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60387Service() {
        this(new Idea60387Config());
    }

    public Idea60387Service(Idea60387Config config) {
        this.config = config != null ? config : new Idea60387Config();
