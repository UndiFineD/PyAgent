...
@Data
public class Idea60592Config {
    private String name = "idea_060592";
 ...
 */
@Slf4j
public class Idea60592Service {
    private static final int IDEA_ID = 60592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60592Service() {
        this(new Idea60592Config());
    }

    public Idea60592Service(Idea60592Config config) {
        this.config = config != null ? config : new Idea60592Config();
