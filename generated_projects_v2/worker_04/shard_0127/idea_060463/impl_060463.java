...
@Data
public class Idea60463Config {
    private String name = "idea_060463";
 ...
 */
@Slf4j
public class Idea60463Service {
    private static final int IDEA_ID = 60463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60463Service() {
        this(new Idea60463Config());
    }

    public Idea60463Service(Idea60463Config config) {
        this.config = config != null ? config : new Idea60463Config();
