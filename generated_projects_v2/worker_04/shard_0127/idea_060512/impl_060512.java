...
@Data
public class Idea60512Config {
    private String name = "idea_060512";
 ...
 */
@Slf4j
public class Idea60512Service {
    private static final int IDEA_ID = 60512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60512Service() {
        this(new Idea60512Config());
    }

    public Idea60512Service(Idea60512Config config) {
        this.config = config != null ? config : new Idea60512Config();
