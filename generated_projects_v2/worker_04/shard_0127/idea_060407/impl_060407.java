...
@Data
public class Idea60407Config {
    private String name = "idea_060407";
 ...
 */
@Slf4j
public class Idea60407Service {
    private static final int IDEA_ID = 60407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60407Service() {
        this(new Idea60407Config());
    }

    public Idea60407Service(Idea60407Config config) {
        this.config = config != null ? config : new Idea60407Config();
