...
@Data
public class Idea60340Config {
    private String name = "idea_060340";
 ...
 */
@Slf4j
public class Idea60340Service {
    private static final int IDEA_ID = 60340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60340Service() {
        this(new Idea60340Config());
    }

    public Idea60340Service(Idea60340Config config) {
        this.config = config != null ? config : new Idea60340Config();
