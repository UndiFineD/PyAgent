...
@Data
public class Idea60587Config {
    private String name = "idea_060587";
 ...
 */
@Slf4j
public class Idea60587Service {
    private static final int IDEA_ID = 60587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60587Service() {
        this(new Idea60587Config());
    }

    public Idea60587Service(Idea60587Config config) {
        this.config = config != null ? config : new Idea60587Config();
