...
@Data
public class Idea60522Config {
    private String name = "idea_060522";
 ...
 */
@Slf4j
public class Idea60522Service {
    private static final int IDEA_ID = 60522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60522Service() {
        this(new Idea60522Config());
    }

    public Idea60522Service(Idea60522Config config) {
        this.config = config != null ? config : new Idea60522Config();
