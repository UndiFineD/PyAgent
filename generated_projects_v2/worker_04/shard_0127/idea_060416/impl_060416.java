...
@Data
public class Idea60416Config {
    private String name = "idea_060416";
 ...
 */
@Slf4j
public class Idea60416Service {
    private static final int IDEA_ID = 60416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60416Service() {
        this(new Idea60416Config());
    }

    public Idea60416Service(Idea60416Config config) {
        this.config = config != null ? config : new Idea60416Config();
