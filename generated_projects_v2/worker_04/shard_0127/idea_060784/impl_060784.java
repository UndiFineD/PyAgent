...
@Data
public class Idea60784Config {
    private String name = "idea_060784";
 ...
 */
@Slf4j
public class Idea60784Service {
    private static final int IDEA_ID = 60784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60784Service() {
        this(new Idea60784Config());
    }

    public Idea60784Service(Idea60784Config config) {
        this.config = config != null ? config : new Idea60784Config();
