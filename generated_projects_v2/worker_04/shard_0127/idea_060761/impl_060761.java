...
@Data
public class Idea60761Config {
    private String name = "idea_060761";
 ...
 */
@Slf4j
public class Idea60761Service {
    private static final int IDEA_ID = 60761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60761Service() {
        this(new Idea60761Config());
    }

    public Idea60761Service(Idea60761Config config) {
        this.config = config != null ? config : new Idea60761Config();
