...
@Data
public class Idea60386Config {
    private String name = "idea_060386";
 ...
 */
@Slf4j
public class Idea60386Service {
    private static final int IDEA_ID = 60386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60386Service() {
        this(new Idea60386Config());
    }

    public Idea60386Service(Idea60386Config config) {
        this.config = config != null ? config : new Idea60386Config();
