...
@Data
public class Idea60599Config {
    private String name = "idea_060599";
 ...
 */
@Slf4j
public class Idea60599Service {
    private static final int IDEA_ID = 60599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60599Service() {
        this(new Idea60599Config());
    }

    public Idea60599Service(Idea60599Config config) {
        this.config = config != null ? config : new Idea60599Config();
