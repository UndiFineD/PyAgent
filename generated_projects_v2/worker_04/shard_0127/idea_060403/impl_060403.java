...
@Data
public class Idea60403Config {
    private String name = "idea_060403";
 ...
 */
@Slf4j
public class Idea60403Service {
    private static final int IDEA_ID = 60403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60403Service() {
        this(new Idea60403Config());
    }

    public Idea60403Service(Idea60403Config config) {
        this.config = config != null ? config : new Idea60403Config();
