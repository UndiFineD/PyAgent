...
@Data
public class Idea60369Config {
    private String name = "idea_060369";
 ...
 */
@Slf4j
public class Idea60369Service {
    private static final int IDEA_ID = 60369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60369Service() {
        this(new Idea60369Config());
    }

    public Idea60369Service(Idea60369Config config) {
        this.config = config != null ? config : new Idea60369Config();
