...
@Data
public class Idea60670Config {
    private String name = "idea_060670";
 ...
 */
@Slf4j
public class Idea60670Service {
    private static final int IDEA_ID = 60670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60670Service() {
        this(new Idea60670Config());
    }

    public Idea60670Service(Idea60670Config config) {
        this.config = config != null ? config : new Idea60670Config();
