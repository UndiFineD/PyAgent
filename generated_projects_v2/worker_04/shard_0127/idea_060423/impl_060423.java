...
@Data
public class Idea60423Config {
    private String name = "idea_060423";
 ...
 */
@Slf4j
public class Idea60423Service {
    private static final int IDEA_ID = 60423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60423Service() {
        this(new Idea60423Config());
    }

    public Idea60423Service(Idea60423Config config) {
        this.config = config != null ? config : new Idea60423Config();
