...
@Data
public class Idea60610Config {
    private String name = "idea_060610";
 ...
 */
@Slf4j
public class Idea60610Service {
    private static final int IDEA_ID = 60610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60610Service() {
        this(new Idea60610Config());
    }

    public Idea60610Service(Idea60610Config config) {
        this.config = config != null ? config : new Idea60610Config();
