...
@Data
public class Idea60459Config {
    private String name = "idea_060459";
 ...
 */
@Slf4j
public class Idea60459Service {
    private static final int IDEA_ID = 60459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60459Service() {
        this(new Idea60459Config());
    }

    public Idea60459Service(Idea60459Config config) {
        this.config = config != null ? config : new Idea60459Config();
