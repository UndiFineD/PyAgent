...
@Data
public class Idea60684Config {
    private String name = "idea_060684";
 ...
 */
@Slf4j
public class Idea60684Service {
    private static final int IDEA_ID = 60684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60684Service() {
        this(new Idea60684Config());
    }

    public Idea60684Service(Idea60684Config config) {
        this.config = config != null ? config : new Idea60684Config();
