...
@Data
public class Idea60354Config {
    private String name = "idea_060354";
 ...
 */
@Slf4j
public class Idea60354Service {
    private static final int IDEA_ID = 60354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60354Service() {
        this(new Idea60354Config());
    }

    public Idea60354Service(Idea60354Config config) {
        this.config = config != null ? config : new Idea60354Config();
