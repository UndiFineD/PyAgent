...
@Data
public class Idea60577Config {
    private String name = "idea_060577";
 ...
 */
@Slf4j
public class Idea60577Service {
    private static final int IDEA_ID = 60577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60577Service() {
        this(new Idea60577Config());
    }

    public Idea60577Service(Idea60577Config config) {
        this.config = config != null ? config : new Idea60577Config();
