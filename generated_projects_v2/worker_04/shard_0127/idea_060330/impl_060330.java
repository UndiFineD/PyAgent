...
@Data
public class Idea60330Config {
    private String name = "idea_060330";
 ...
 */
@Slf4j
public class Idea60330Service {
    private static final int IDEA_ID = 60330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60330Service() {
        this(new Idea60330Config());
    }

    public Idea60330Service(Idea60330Config config) {
        this.config = config != null ? config : new Idea60330Config();
