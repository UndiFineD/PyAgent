...
@Data
public class Idea60793Config {
    private String name = "idea_060793";
 ...
 */
@Slf4j
public class Idea60793Service {
    private static final int IDEA_ID = 60793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60793Service() {
        this(new Idea60793Config());
    }

    public Idea60793Service(Idea60793Config config) {
        this.config = config != null ? config : new Idea60793Config();
