...
@Data
public class Idea60554Config {
    private String name = "idea_060554";
 ...
 */
@Slf4j
public class Idea60554Service {
    private static final int IDEA_ID = 60554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60554Service() {
        this(new Idea60554Config());
    }

    public Idea60554Service(Idea60554Config config) {
        this.config = config != null ? config : new Idea60554Config();
