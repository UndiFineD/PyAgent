...
@Data
public class Idea60623Config {
    private String name = "idea_060623";
 ...
 */
@Slf4j
public class Idea60623Service {
    private static final int IDEA_ID = 60623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60623Service() {
        this(new Idea60623Config());
    }

    public Idea60623Service(Idea60623Config config) {
        this.config = config != null ? config : new Idea60623Config();
