...
@Data
public class Idea60581Config {
    private String name = "idea_060581";
 ...
 */
@Slf4j
public class Idea60581Service {
    private static final int IDEA_ID = 60581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60581Service() {
        this(new Idea60581Config());
    }

    public Idea60581Service(Idea60581Config config) {
        this.config = config != null ? config : new Idea60581Config();
