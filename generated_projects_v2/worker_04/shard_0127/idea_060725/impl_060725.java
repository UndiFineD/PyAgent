...
@Data
public class Idea60725Config {
    private String name = "idea_060725";
 ...
 */
@Slf4j
public class Idea60725Service {
    private static final int IDEA_ID = 60725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60725Service() {
        this(new Idea60725Config());
    }

    public Idea60725Service(Idea60725Config config) {
        this.config = config != null ? config : new Idea60725Config();
