...
@Data
public class Idea60419Config {
    private String name = "idea_060419";
 ...
 */
@Slf4j
public class Idea60419Service {
    private static final int IDEA_ID = 60419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60419Service() {
        this(new Idea60419Config());
    }

    public Idea60419Service(Idea60419Config config) {
        this.config = config != null ? config : new Idea60419Config();
