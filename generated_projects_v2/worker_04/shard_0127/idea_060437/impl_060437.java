...
@Data
public class Idea60437Config {
    private String name = "idea_060437";
 ...
 */
@Slf4j
public class Idea60437Service {
    private static final int IDEA_ID = 60437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60437Service() {
        this(new Idea60437Config());
    }

    public Idea60437Service(Idea60437Config config) {
        this.config = config != null ? config : new Idea60437Config();
