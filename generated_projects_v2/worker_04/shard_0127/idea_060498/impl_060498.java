...
@Data
public class Idea60498Config {
    private String name = "idea_060498";
 ...
 */
@Slf4j
public class Idea60498Service {
    private static final int IDEA_ID = 60498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60498Service() {
        this(new Idea60498Config());
    }

    public Idea60498Service(Idea60498Config config) {
        this.config = config != null ? config : new Idea60498Config();
