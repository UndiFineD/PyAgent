...
@Data
public class Idea60639Config {
    private String name = "idea_060639";
 ...
 */
@Slf4j
public class Idea60639Service {
    private static final int IDEA_ID = 60639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60639Service() {
        this(new Idea60639Config());
    }

    public Idea60639Service(Idea60639Config config) {
        this.config = config != null ? config : new Idea60639Config();
