...
@Data
public class Idea60462Config {
    private String name = "idea_060462";
 ...
 */
@Slf4j
public class Idea60462Service {
    private static final int IDEA_ID = 60462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60462Service() {
        this(new Idea60462Config());
    }

    public Idea60462Service(Idea60462Config config) {
        this.config = config != null ? config : new Idea60462Config();
