...
@Data
public class Idea60641Config {
    private String name = "idea_060641";
 ...
 */
@Slf4j
public class Idea60641Service {
    private static final int IDEA_ID = 60641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60641Service() {
        this(new Idea60641Config());
    }

    public Idea60641Service(Idea60641Config config) {
        this.config = config != null ? config : new Idea60641Config();
