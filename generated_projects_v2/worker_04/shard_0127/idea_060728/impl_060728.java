...
@Data
public class Idea60728Config {
    private String name = "idea_060728";
 ...
 */
@Slf4j
public class Idea60728Service {
    private static final int IDEA_ID = 60728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60728Service() {
        this(new Idea60728Config());
    }

    public Idea60728Service(Idea60728Config config) {
        this.config = config != null ? config : new Idea60728Config();
