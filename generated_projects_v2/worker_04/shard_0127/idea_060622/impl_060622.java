...
@Data
public class Idea60622Config {
    private String name = "idea_060622";
 ...
 */
@Slf4j
public class Idea60622Service {
    private static final int IDEA_ID = 60622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60622Service() {
        this(new Idea60622Config());
    }

    public Idea60622Service(Idea60622Config config) {
        this.config = config != null ? config : new Idea60622Config();
