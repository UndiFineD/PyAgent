...
@Data
public class Idea60433Config {
    private String name = "idea_060433";
 ...
 */
@Slf4j
public class Idea60433Service {
    private static final int IDEA_ID = 60433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60433Service() {
        this(new Idea60433Config());
    }

    public Idea60433Service(Idea60433Config config) {
        this.config = config != null ? config : new Idea60433Config();
