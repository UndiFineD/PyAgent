...
@Data
public class Idea60565Config {
    private String name = "idea_060565";
 ...
 */
@Slf4j
public class Idea60565Service {
    private static final int IDEA_ID = 60565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60565Service() {
        this(new Idea60565Config());
    }

    public Idea60565Service(Idea60565Config config) {
        this.config = config != null ? config : new Idea60565Config();
