...
@Data
public class Idea60750Config {
    private String name = "idea_060750";
 ...
 */
@Slf4j
public class Idea60750Service {
    private static final int IDEA_ID = 60750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60750Service() {
        this(new Idea60750Config());
    }

    public Idea60750Service(Idea60750Config config) {
        this.config = config != null ? config : new Idea60750Config();
