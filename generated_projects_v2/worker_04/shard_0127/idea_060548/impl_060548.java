...
@Data
public class Idea60548Config {
    private String name = "idea_060548";
 ...
 */
@Slf4j
public class Idea60548Service {
    private static final int IDEA_ID = 60548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60548Service() {
        this(new Idea60548Config());
    }

    public Idea60548Service(Idea60548Config config) {
        this.config = config != null ? config : new Idea60548Config();
