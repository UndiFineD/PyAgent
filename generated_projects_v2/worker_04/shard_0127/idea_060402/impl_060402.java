...
@Data
public class Idea60402Config {
    private String name = "idea_060402";
 ...
 */
@Slf4j
public class Idea60402Service {
    private static final int IDEA_ID = 60402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60402Service() {
        this(new Idea60402Config());
    }

    public Idea60402Service(Idea60402Config config) {
        this.config = config != null ? config : new Idea60402Config();
