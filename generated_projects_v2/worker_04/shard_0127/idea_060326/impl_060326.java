...
@Data
public class Idea60326Config {
    private String name = "idea_060326";
 ...
 */
@Slf4j
public class Idea60326Service {
    private static final int IDEA_ID = 60326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60326Service() {
        this(new Idea60326Config());
    }

    public Idea60326Service(Idea60326Config config) {
        this.config = config != null ? config : new Idea60326Config();
