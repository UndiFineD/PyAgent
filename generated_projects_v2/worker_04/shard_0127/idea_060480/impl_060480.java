...
@Data
public class Idea60480Config {
    private String name = "idea_060480";
 ...
 */
@Slf4j
public class Idea60480Service {
    private static final int IDEA_ID = 60480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60480Service() {
        this(new Idea60480Config());
    }

    public Idea60480Service(Idea60480Config config) {
        this.config = config != null ? config : new Idea60480Config();
