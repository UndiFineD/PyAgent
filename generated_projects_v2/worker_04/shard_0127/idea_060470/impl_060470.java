...
@Data
public class Idea60470Config {
    private String name = "idea_060470";
 ...
 */
@Slf4j
public class Idea60470Service {
    private static final int IDEA_ID = 60470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60470Service() {
        this(new Idea60470Config());
    }

    public Idea60470Service(Idea60470Config config) {
        this.config = config != null ? config : new Idea60470Config();
