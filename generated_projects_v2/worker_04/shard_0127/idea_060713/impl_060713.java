...
@Data
public class Idea60713Config {
    private String name = "idea_060713";
 ...
 */
@Slf4j
public class Idea60713Service {
    private static final int IDEA_ID = 60713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60713Service() {
        this(new Idea60713Config());
    }

    public Idea60713Service(Idea60713Config config) {
        this.config = config != null ? config : new Idea60713Config();
