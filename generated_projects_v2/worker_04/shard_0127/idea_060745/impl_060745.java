...
@Data
public class Idea60745Config {
    private String name = "idea_060745";
 ...
 */
@Slf4j
public class Idea60745Service {
    private static final int IDEA_ID = 60745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60745Service() {
        this(new Idea60745Config());
    }

    public Idea60745Service(Idea60745Config config) {
        this.config = config != null ? config : new Idea60745Config();
