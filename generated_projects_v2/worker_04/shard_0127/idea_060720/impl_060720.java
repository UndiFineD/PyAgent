...
@Data
public class Idea60720Config {
    private String name = "idea_060720";
 ...
 */
@Slf4j
public class Idea60720Service {
    private static final int IDEA_ID = 60720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60720Service() {
        this(new Idea60720Config());
    }

    public Idea60720Service(Idea60720Config config) {
        this.config = config != null ? config : new Idea60720Config();
