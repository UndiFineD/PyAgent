...
@Data
public class Idea60409Config {
    private String name = "idea_060409";
 ...
 */
@Slf4j
public class Idea60409Service {
    private static final int IDEA_ID = 60409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60409Service() {
        this(new Idea60409Config());
    }

    public Idea60409Service(Idea60409Config config) {
        this.config = config != null ? config : new Idea60409Config();
