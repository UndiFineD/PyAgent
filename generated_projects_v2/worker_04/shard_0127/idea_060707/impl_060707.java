...
@Data
public class Idea60707Config {
    private String name = "idea_060707";
 ...
 */
@Slf4j
public class Idea60707Service {
    private static final int IDEA_ID = 60707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60707Service() {
        this(new Idea60707Config());
    }

    public Idea60707Service(Idea60707Config config) {
        this.config = config != null ? config : new Idea60707Config();
