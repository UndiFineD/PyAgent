...
@Data
public class Idea60722Config {
    private String name = "idea_060722";
 ...
 */
@Slf4j
public class Idea60722Service {
    private static final int IDEA_ID = 60722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60722Service() {
        this(new Idea60722Config());
    }

    public Idea60722Service(Idea60722Config config) {
        this.config = config != null ? config : new Idea60722Config();
