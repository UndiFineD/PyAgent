...
@Data
public class Idea60516Config {
    private String name = "idea_060516";
 ...
 */
@Slf4j
public class Idea60516Service {
    private static final int IDEA_ID = 60516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60516Service() {
        this(new Idea60516Config());
    }

    public Idea60516Service(Idea60516Config config) {
        this.config = config != null ? config : new Idea60516Config();
