...
@Data
public class Idea60566Config {
    private String name = "idea_060566";
 ...
 */
@Slf4j
public class Idea60566Service {
    private static final int IDEA_ID = 60566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60566Service() {
        this(new Idea60566Config());
    }

    public Idea60566Service(Idea60566Config config) {
        this.config = config != null ? config : new Idea60566Config();
