...
@Data
public class Idea60359Config {
    private String name = "idea_060359";
 ...
 */
@Slf4j
public class Idea60359Service {
    private static final int IDEA_ID = 60359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60359Service() {
        this(new Idea60359Config());
    }

    public Idea60359Service(Idea60359Config config) {
        this.config = config != null ? config : new Idea60359Config();
