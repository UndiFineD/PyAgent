...
@Data
public class Idea60696Config {
    private String name = "idea_060696";
 ...
 */
@Slf4j
public class Idea60696Service {
    private static final int IDEA_ID = 60696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60696Service() {
        this(new Idea60696Config());
    }

    public Idea60696Service(Idea60696Config config) {
        this.config = config != null ? config : new Idea60696Config();
