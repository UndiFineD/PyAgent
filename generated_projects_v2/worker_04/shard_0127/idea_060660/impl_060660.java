...
@Data
public class Idea60660Config {
    private String name = "idea_060660";
 ...
 */
@Slf4j
public class Idea60660Service {
    private static final int IDEA_ID = 60660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60660Service() {
        this(new Idea60660Config());
    }

    public Idea60660Service(Idea60660Config config) {
        this.config = config != null ? config : new Idea60660Config();
