...
@Data
public class Idea60507Config {
    private String name = "idea_060507";
 ...
 */
@Slf4j
public class Idea60507Service {
    private static final int IDEA_ID = 60507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60507Service() {
        this(new Idea60507Config());
    }

    public Idea60507Service(Idea60507Config config) {
        this.config = config != null ? config : new Idea60507Config();
