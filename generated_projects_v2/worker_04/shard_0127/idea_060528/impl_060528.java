...
@Data
public class Idea60528Config {
    private String name = "idea_060528";
 ...
 */
@Slf4j
public class Idea60528Service {
    private static final int IDEA_ID = 60528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60528Service() {
        this(new Idea60528Config());
    }

    public Idea60528Service(Idea60528Config config) {
        this.config = config != null ? config : new Idea60528Config();
