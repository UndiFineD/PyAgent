...
@Data
public class Idea60583Config {
    private String name = "idea_060583";
 ...
 */
@Slf4j
public class Idea60583Service {
    private static final int IDEA_ID = 60583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60583Service() {
        this(new Idea60583Config());
    }

    public Idea60583Service(Idea60583Config config) {
        this.config = config != null ? config : new Idea60583Config();
