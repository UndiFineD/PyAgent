...
@Data
public class Idea60673Config {
    private String name = "idea_060673";
 ...
 */
@Slf4j
public class Idea60673Service {
    private static final int IDEA_ID = 60673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60673Service() {
        this(new Idea60673Config());
    }

    public Idea60673Service(Idea60673Config config) {
        this.config = config != null ? config : new Idea60673Config();
