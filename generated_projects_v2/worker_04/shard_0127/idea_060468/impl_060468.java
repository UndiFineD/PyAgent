...
@Data
public class Idea60468Config {
    private String name = "idea_060468";
 ...
 */
@Slf4j
public class Idea60468Service {
    private static final int IDEA_ID = 60468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60468Service() {
        this(new Idea60468Config());
    }

    public Idea60468Service(Idea60468Config config) {
        this.config = config != null ? config : new Idea60468Config();
