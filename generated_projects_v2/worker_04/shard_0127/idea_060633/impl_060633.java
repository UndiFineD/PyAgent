...
@Data
public class Idea60633Config {
    private String name = "idea_060633";
 ...
 */
@Slf4j
public class Idea60633Service {
    private static final int IDEA_ID = 60633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60633Service() {
        this(new Idea60633Config());
    }

    public Idea60633Service(Idea60633Config config) {
        this.config = config != null ? config : new Idea60633Config();
