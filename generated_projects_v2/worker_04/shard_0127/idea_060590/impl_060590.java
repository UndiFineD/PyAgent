...
@Data
public class Idea60590Config {
    private String name = "idea_060590";
 ...
 */
@Slf4j
public class Idea60590Service {
    private static final int IDEA_ID = 60590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60590Service() {
        this(new Idea60590Config());
    }

    public Idea60590Service(Idea60590Config config) {
        this.config = config != null ? config : new Idea60590Config();
