...
@Data
public class Idea60776Config {
    private String name = "idea_060776";
 ...
 */
@Slf4j
public class Idea60776Service {
    private static final int IDEA_ID = 60776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60776Service() {
        this(new Idea60776Config());
    }

    public Idea60776Service(Idea60776Config config) {
        this.config = config != null ? config : new Idea60776Config();
