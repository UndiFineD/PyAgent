...
@Data
public class Idea60339Config {
    private String name = "idea_060339";
 ...
 */
@Slf4j
public class Idea60339Service {
    private static final int IDEA_ID = 60339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60339Service() {
        this(new Idea60339Config());
    }

    public Idea60339Service(Idea60339Config config) {
        this.config = config != null ? config : new Idea60339Config();
