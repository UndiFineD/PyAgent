...
@Data
public class Idea60544Config {
    private String name = "idea_060544";
 ...
 */
@Slf4j
public class Idea60544Service {
    private static final int IDEA_ID = 60544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60544Service() {
        this(new Idea60544Config());
    }

    public Idea60544Service(Idea60544Config config) {
        this.config = config != null ? config : new Idea60544Config();
