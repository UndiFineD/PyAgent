...
@Data
public class Idea60446Config {
    private String name = "idea_060446";
 ...
 */
@Slf4j
public class Idea60446Service {
    private static final int IDEA_ID = 60446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60446Service() {
        this(new Idea60446Config());
    }

    public Idea60446Service(Idea60446Config config) {
        this.config = config != null ? config : new Idea60446Config();
