...
@Data
public class Idea60733Config {
    private String name = "idea_060733";
 ...
 */
@Slf4j
public class Idea60733Service {
    private static final int IDEA_ID = 60733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60733Service() {
        this(new Idea60733Config());
    }

    public Idea60733Service(Idea60733Config config) {
        this.config = config != null ? config : new Idea60733Config();
