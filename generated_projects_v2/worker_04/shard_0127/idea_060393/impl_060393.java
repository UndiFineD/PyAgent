...
@Data
public class Idea60393Config {
    private String name = "idea_060393";
 ...
 */
@Slf4j
public class Idea60393Service {
    private static final int IDEA_ID = 60393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60393Service() {
        this(new Idea60393Config());
    }

    public Idea60393Service(Idea60393Config config) {
        this.config = config != null ? config : new Idea60393Config();
