...
@Data
public class Idea60575Config {
    private String name = "idea_060575";
 ...
 */
@Slf4j
public class Idea60575Service {
    private static final int IDEA_ID = 60575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60575Service() {
        this(new Idea60575Config());
    }

    public Idea60575Service(Idea60575Config config) {
        this.config = config != null ? config : new Idea60575Config();
