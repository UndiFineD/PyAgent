...
@Data
public class Idea60570Config {
    private String name = "idea_060570";
 ...
 */
@Slf4j
public class Idea60570Service {
    private static final int IDEA_ID = 60570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60570Service() {
        this(new Idea60570Config());
    }

    public Idea60570Service(Idea60570Config config) {
        this.config = config != null ? config : new Idea60570Config();
