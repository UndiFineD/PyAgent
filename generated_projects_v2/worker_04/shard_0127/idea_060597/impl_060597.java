...
@Data
public class Idea60597Config {
    private String name = "idea_060597";
 ...
 */
@Slf4j
public class Idea60597Service {
    private static final int IDEA_ID = 60597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60597Service() {
        this(new Idea60597Config());
    }

    public Idea60597Service(Idea60597Config config) {
        this.config = config != null ? config : new Idea60597Config();
