...
@Data
public class Idea60536Config {
    private String name = "idea_060536";
 ...
 */
@Slf4j
public class Idea60536Service {
    private static final int IDEA_ID = 60536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60536Service() {
        this(new Idea60536Config());
    }

    public Idea60536Service(Idea60536Config config) {
        this.config = config != null ? config : new Idea60536Config();
