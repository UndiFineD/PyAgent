...
@Data
public class Idea60478Config {
    private String name = "idea_060478";
 ...
 */
@Slf4j
public class Idea60478Service {
    private static final int IDEA_ID = 60478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60478Service() {
        this(new Idea60478Config());
    }

    public Idea60478Service(Idea60478Config config) {
        this.config = config != null ? config : new Idea60478Config();
