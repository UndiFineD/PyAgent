...
@Data
public class Idea60334Config {
    private String name = "idea_060334";
 ...
 */
@Slf4j
public class Idea60334Service {
    private static final int IDEA_ID = 60334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60334Service() {
        this(new Idea60334Config());
    }

    public Idea60334Service(Idea60334Config config) {
        this.config = config != null ? config : new Idea60334Config();
