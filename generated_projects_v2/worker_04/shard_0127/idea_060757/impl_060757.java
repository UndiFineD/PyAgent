...
@Data
public class Idea60757Config {
    private String name = "idea_060757";
 ...
 */
@Slf4j
public class Idea60757Service {
    private static final int IDEA_ID = 60757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60757Service() {
        this(new Idea60757Config());
    }

    public Idea60757Service(Idea60757Config config) {
        this.config = config != null ? config : new Idea60757Config();
