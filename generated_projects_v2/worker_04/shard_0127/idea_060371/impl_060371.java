...
@Data
public class Idea60371Config {
    private String name = "idea_060371";
 ...
 */
@Slf4j
public class Idea60371Service {
    private static final int IDEA_ID = 60371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60371Service() {
        this(new Idea60371Config());
    }

    public Idea60371Service(Idea60371Config config) {
        this.config = config != null ? config : new Idea60371Config();
