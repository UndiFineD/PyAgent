...
@Data
public class Idea60451Config {
    private String name = "idea_060451";
 ...
 */
@Slf4j
public class Idea60451Service {
    private static final int IDEA_ID = 60451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60451Service() {
        this(new Idea60451Config());
    }

    public Idea60451Service(Idea60451Config config) {
        this.config = config != null ? config : new Idea60451Config();
