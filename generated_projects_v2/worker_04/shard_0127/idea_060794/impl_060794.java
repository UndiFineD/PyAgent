...
@Data
public class Idea60794Config {
    private String name = "idea_060794";
 ...
 */
@Slf4j
public class Idea60794Service {
    private static final int IDEA_ID = 60794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60794Service() {
        this(new Idea60794Config());
    }

    public Idea60794Service(Idea60794Config config) {
        this.config = config != null ? config : new Idea60794Config();
