...
@Data
public class Idea60381Config {
    private String name = "idea_060381";
 ...
 */
@Slf4j
public class Idea60381Service {
    private static final int IDEA_ID = 60381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60381Service() {
        this(new Idea60381Config());
    }

    public Idea60381Service(Idea60381Config config) {
        this.config = config != null ? config : new Idea60381Config();
