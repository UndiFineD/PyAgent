...
@Data
public class Idea60763Config {
    private String name = "idea_060763";
 ...
 */
@Slf4j
public class Idea60763Service {
    private static final int IDEA_ID = 60763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60763Service() {
        this(new Idea60763Config());
    }

    public Idea60763Service(Idea60763Config config) {
        this.config = config != null ? config : new Idea60763Config();
