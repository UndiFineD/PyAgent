...
@Data
public class Idea60545Config {
    private String name = "idea_060545";
 ...
 */
@Slf4j
public class Idea60545Service {
    private static final int IDEA_ID = 60545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60545Service() {
        this(new Idea60545Config());
    }

    public Idea60545Service(Idea60545Config config) {
        this.config = config != null ? config : new Idea60545Config();
