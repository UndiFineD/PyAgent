...
@Data
public class Idea60604Config {
    private String name = "idea_060604";
 ...
 */
@Slf4j
public class Idea60604Service {
    private static final int IDEA_ID = 60604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60604Service() {
        this(new Idea60604Config());
    }

    public Idea60604Service(Idea60604Config config) {
        this.config = config != null ? config : new Idea60604Config();
