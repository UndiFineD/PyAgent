...
@Data
public class Idea60384Config {
    private String name = "idea_060384";
 ...
 */
@Slf4j
public class Idea60384Service {
    private static final int IDEA_ID = 60384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60384Service() {
        this(new Idea60384Config());
    }

    public Idea60384Service(Idea60384Config config) {
        this.config = config != null ? config : new Idea60384Config();
