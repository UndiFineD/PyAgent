...
@Data
public class Idea60749Config {
    private String name = "idea_060749";
 ...
 */
@Slf4j
public class Idea60749Service {
    private static final int IDEA_ID = 60749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60749Service() {
        this(new Idea60749Config());
    }

    public Idea60749Service(Idea60749Config config) {
        this.config = config != null ? config : new Idea60749Config();
