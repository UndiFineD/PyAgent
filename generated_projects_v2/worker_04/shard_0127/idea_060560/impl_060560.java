...
@Data
public class Idea60560Config {
    private String name = "idea_060560";
 ...
 */
@Slf4j
public class Idea60560Service {
    private static final int IDEA_ID = 60560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60560Service() {
        this(new Idea60560Config());
    }

    public Idea60560Service(Idea60560Config config) {
        this.config = config != null ? config : new Idea60560Config();
