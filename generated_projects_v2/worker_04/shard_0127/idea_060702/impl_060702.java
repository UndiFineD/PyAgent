...
@Data
public class Idea60702Config {
    private String name = "idea_060702";
 ...
 */
@Slf4j
public class Idea60702Service {
    private static final int IDEA_ID = 60702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60702Service() {
        this(new Idea60702Config());
    }

    public Idea60702Service(Idea60702Config config) {
        this.config = config != null ? config : new Idea60702Config();
