...
@Data
public class Idea60349Config {
    private String name = "idea_060349";
 ...
 */
@Slf4j
public class Idea60349Service {
    private static final int IDEA_ID = 60349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60349Service() {
        this(new Idea60349Config());
    }

    public Idea60349Service(Idea60349Config config) {
        this.config = config != null ? config : new Idea60349Config();
