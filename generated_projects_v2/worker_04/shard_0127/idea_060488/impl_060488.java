...
@Data
public class Idea60488Config {
    private String name = "idea_060488";
 ...
 */
@Slf4j
public class Idea60488Service {
    private static final int IDEA_ID = 60488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60488Service() {
        this(new Idea60488Config());
    }

    public Idea60488Service(Idea60488Config config) {
        this.config = config != null ? config : new Idea60488Config();
