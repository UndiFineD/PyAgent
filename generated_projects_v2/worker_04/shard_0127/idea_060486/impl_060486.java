...
@Data
public class Idea60486Config {
    private String name = "idea_060486";
 ...
 */
@Slf4j
public class Idea60486Service {
    private static final int IDEA_ID = 60486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60486Service() {
        this(new Idea60486Config());
    }

    public Idea60486Service(Idea60486Config config) {
        this.config = config != null ? config : new Idea60486Config();
