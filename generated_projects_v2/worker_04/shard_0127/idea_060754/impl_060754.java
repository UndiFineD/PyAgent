...
@Data
public class Idea60754Config {
    private String name = "idea_060754";
 ...
 */
@Slf4j
public class Idea60754Service {
    private static final int IDEA_ID = 60754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60754Service() {
        this(new Idea60754Config());
    }

    public Idea60754Service(Idea60754Config config) {
        this.config = config != null ? config : new Idea60754Config();
