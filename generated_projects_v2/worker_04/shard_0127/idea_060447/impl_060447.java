...
@Data
public class Idea60447Config {
    private String name = "idea_060447";
 ...
 */
@Slf4j
public class Idea60447Service {
    private static final int IDEA_ID = 60447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60447Service() {
        this(new Idea60447Config());
    }

    public Idea60447Service(Idea60447Config config) {
        this.config = config != null ? config : new Idea60447Config();
