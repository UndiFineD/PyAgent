...
@Data
public class Idea60594Config {
    private String name = "idea_060594";
 ...
 */
@Slf4j
public class Idea60594Service {
    private static final int IDEA_ID = 60594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60594Service() {
        this(new Idea60594Config());
    }

    public Idea60594Service(Idea60594Config config) {
        this.config = config != null ? config : new Idea60594Config();
