...
@Data
public class Idea60681Config {
    private String name = "idea_060681";
 ...
 */
@Slf4j
public class Idea60681Service {
    private static final int IDEA_ID = 60681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60681Service() {
        this(new Idea60681Config());
    }

    public Idea60681Service(Idea60681Config config) {
        this.config = config != null ? config : new Idea60681Config();
