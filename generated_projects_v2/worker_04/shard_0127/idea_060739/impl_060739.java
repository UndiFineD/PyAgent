...
@Data
public class Idea60739Config {
    private String name = "idea_060739";
 ...
 */
@Slf4j
public class Idea60739Service {
    private static final int IDEA_ID = 60739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60739Service() {
        this(new Idea60739Config());
    }

    public Idea60739Service(Idea60739Config config) {
        this.config = config != null ? config : new Idea60739Config();
