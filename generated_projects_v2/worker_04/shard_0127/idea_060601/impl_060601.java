...
@Data
public class Idea60601Config {
    private String name = "idea_060601";
 ...
 */
@Slf4j
public class Idea60601Service {
    private static final int IDEA_ID = 60601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60601Service() {
        this(new Idea60601Config());
    }

    public Idea60601Service(Idea60601Config config) {
        this.config = config != null ? config : new Idea60601Config();
