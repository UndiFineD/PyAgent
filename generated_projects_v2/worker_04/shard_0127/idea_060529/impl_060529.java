...
@Data
public class Idea60529Config {
    private String name = "idea_060529";
 ...
 */
@Slf4j
public class Idea60529Service {
    private static final int IDEA_ID = 60529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60529Service() {
        this(new Idea60529Config());
    }

    public Idea60529Service(Idea60529Config config) {
        this.config = config != null ? config : new Idea60529Config();
