...
@Data
public class Idea60752Config {
    private String name = "idea_060752";
 ...
 */
@Slf4j
public class Idea60752Service {
    private static final int IDEA_ID = 60752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60752Service() {
        this(new Idea60752Config());
    }

    public Idea60752Service(Idea60752Config config) {
        this.config = config != null ? config : new Idea60752Config();
