...
@Data
public class Idea60582Config {
    private String name = "idea_060582";
 ...
 */
@Slf4j
public class Idea60582Service {
    private static final int IDEA_ID = 60582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60582Service() {
        this(new Idea60582Config());
    }

    public Idea60582Service(Idea60582Config config) {
        this.config = config != null ? config : new Idea60582Config();
