...
@Data
public class Idea60709Config {
    private String name = "idea_060709";
 ...
 */
@Slf4j
public class Idea60709Service {
    private static final int IDEA_ID = 60709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60709Service() {
        this(new Idea60709Config());
    }

    public Idea60709Service(Idea60709Config config) {
        this.config = config != null ? config : new Idea60709Config();
