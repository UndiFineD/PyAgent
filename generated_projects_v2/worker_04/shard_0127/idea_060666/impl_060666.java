...
@Data
public class Idea60666Config {
    private String name = "idea_060666";
 ...
 */
@Slf4j
public class Idea60666Service {
    private static final int IDEA_ID = 60666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60666Service() {
        this(new Idea60666Config());
    }

    public Idea60666Service(Idea60666Config config) {
        this.config = config != null ? config : new Idea60666Config();
