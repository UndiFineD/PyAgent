...
@Data
public class Idea60520Config {
    private String name = "idea_060520";
 ...
 */
@Slf4j
public class Idea60520Service {
    private static final int IDEA_ID = 60520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60520Service() {
        this(new Idea60520Config());
    }

    public Idea60520Service(Idea60520Config config) {
        this.config = config != null ? config : new Idea60520Config();
