...
@Data
public class Idea60626Config {
    private String name = "idea_060626";
 ...
 */
@Slf4j
public class Idea60626Service {
    private static final int IDEA_ID = 60626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60626Service() {
        this(new Idea60626Config());
    }

    public Idea60626Service(Idea60626Config config) {
        this.config = config != null ? config : new Idea60626Config();
