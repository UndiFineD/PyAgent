...
@Data
public class Idea60558Config {
    private String name = "idea_060558";
 ...
 */
@Slf4j
public class Idea60558Service {
    private static final int IDEA_ID = 60558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60558Service() {
        this(new Idea60558Config());
    }

    public Idea60558Service(Idea60558Config config) {
        this.config = config != null ? config : new Idea60558Config();
