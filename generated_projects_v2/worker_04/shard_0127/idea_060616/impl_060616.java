...
@Data
public class Idea60616Config {
    private String name = "idea_060616";
 ...
 */
@Slf4j
public class Idea60616Service {
    private static final int IDEA_ID = 60616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60616Service() {
        this(new Idea60616Config());
    }

    public Idea60616Service(Idea60616Config config) {
        this.config = config != null ? config : new Idea60616Config();
