...
@Data
public class Idea60538Config {
    private String name = "idea_060538";
 ...
 */
@Slf4j
public class Idea60538Service {
    private static final int IDEA_ID = 60538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60538Service() {
        this(new Idea60538Config());
    }

    public Idea60538Service(Idea60538Config config) {
        this.config = config != null ? config : new Idea60538Config();
