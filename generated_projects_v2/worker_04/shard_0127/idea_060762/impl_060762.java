...
@Data
public class Idea60762Config {
    private String name = "idea_060762";
 ...
 */
@Slf4j
public class Idea60762Service {
    private static final int IDEA_ID = 60762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60762Service() {
        this(new Idea60762Config());
    }

    public Idea60762Service(Idea60762Config config) {
        this.config = config != null ? config : new Idea60762Config();
