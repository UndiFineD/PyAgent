...
@Data
public class Idea60799Config {
    private String name = "idea_060799";
 ...
 */
@Slf4j
public class Idea60799Service {
    private static final int IDEA_ID = 60799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60799Service() {
        this(new Idea60799Config());
    }

    public Idea60799Service(Idea60799Config config) {
        this.config = config != null ? config : new Idea60799Config();
