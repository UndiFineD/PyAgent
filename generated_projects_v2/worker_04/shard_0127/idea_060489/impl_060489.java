...
@Data
public class Idea60489Config {
    private String name = "idea_060489";
 ...
 */
@Slf4j
public class Idea60489Service {
    private static final int IDEA_ID = 60489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60489Service() {
        this(new Idea60489Config());
    }

    public Idea60489Service(Idea60489Config config) {
        this.config = config != null ? config : new Idea60489Config();
