...
@Data
public class Idea60561Config {
    private String name = "idea_060561";
 ...
 */
@Slf4j
public class Idea60561Service {
    private static final int IDEA_ID = 60561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60561Service() {
        this(new Idea60561Config());
    }

    public Idea60561Service(Idea60561Config config) {
        this.config = config != null ? config : new Idea60561Config();
