...
@Data
public class Idea60646Config {
    private String name = "idea_060646";
 ...
 */
@Slf4j
public class Idea60646Service {
    private static final int IDEA_ID = 60646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60646Service() {
        this(new Idea60646Config());
    }

    public Idea60646Service(Idea60646Config config) {
        this.config = config != null ? config : new Idea60646Config();
