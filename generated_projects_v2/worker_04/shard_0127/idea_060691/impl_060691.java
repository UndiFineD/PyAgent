...
@Data
public class Idea60691Config {
    private String name = "idea_060691";
 ...
 */
@Slf4j
public class Idea60691Service {
    private static final int IDEA_ID = 60691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60691Service() {
        this(new Idea60691Config());
    }

    public Idea60691Service(Idea60691Config config) {
        this.config = config != null ? config : new Idea60691Config();
