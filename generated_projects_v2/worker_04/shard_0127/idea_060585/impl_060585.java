...
@Data
public class Idea60585Config {
    private String name = "idea_060585";
 ...
 */
@Slf4j
public class Idea60585Service {
    private static final int IDEA_ID = 60585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60585Service() {
        this(new Idea60585Config());
    }

    public Idea60585Service(Idea60585Config config) {
        this.config = config != null ? config : new Idea60585Config();
