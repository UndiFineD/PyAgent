...
@Data
public class Idea60718Config {
    private String name = "idea_060718";
 ...
 */
@Slf4j
public class Idea60718Service {
    private static final int IDEA_ID = 60718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60718Service() {
        this(new Idea60718Config());
    }

    public Idea60718Service(Idea60718Config config) {
        this.config = config != null ? config : new Idea60718Config();
