...
@Data
public class Idea60611Config {
    private String name = "idea_060611";
 ...
 */
@Slf4j
public class Idea60611Service {
    private static final int IDEA_ID = 60611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60611Service() {
        this(new Idea60611Config());
    }

    public Idea60611Service(Idea60611Config config) {
        this.config = config != null ? config : new Idea60611Config();
