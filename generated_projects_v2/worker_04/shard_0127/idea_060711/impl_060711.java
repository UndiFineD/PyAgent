...
@Data
public class Idea60711Config {
    private String name = "idea_060711";
 ...
 */
@Slf4j
public class Idea60711Service {
    private static final int IDEA_ID = 60711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60711Service() {
        this(new Idea60711Config());
    }

    public Idea60711Service(Idea60711Config config) {
        this.config = config != null ? config : new Idea60711Config();
