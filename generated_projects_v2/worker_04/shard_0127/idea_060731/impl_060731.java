...
@Data
public class Idea60731Config {
    private String name = "idea_060731";
 ...
 */
@Slf4j
public class Idea60731Service {
    private static final int IDEA_ID = 60731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60731Service() {
        this(new Idea60731Config());
    }

    public Idea60731Service(Idea60731Config config) {
        this.config = config != null ? config : new Idea60731Config();
