...
@Data
public class Idea60532Config {
    private String name = "idea_060532";
 ...
 */
@Slf4j
public class Idea60532Service {
    private static final int IDEA_ID = 60532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60532Service() {
        this(new Idea60532Config());
    }

    public Idea60532Service(Idea60532Config config) {
        this.config = config != null ? config : new Idea60532Config();
