...
@Data
public class Idea60657Config {
    private String name = "idea_060657";
 ...
 */
@Slf4j
public class Idea60657Service {
    private static final int IDEA_ID = 60657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60657Service() {
        this(new Idea60657Config());
    }

    public Idea60657Service(Idea60657Config config) {
        this.config = config != null ? config : new Idea60657Config();
