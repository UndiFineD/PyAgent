...
@Data
public class Idea60533Config {
    private String name = "idea_060533";
 ...
 */
@Slf4j
public class Idea60533Service {
    private static final int IDEA_ID = 60533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60533Service() {
        this(new Idea60533Config());
    }

    public Idea60533Service(Idea60533Config config) {
        this.config = config != null ? config : new Idea60533Config();
