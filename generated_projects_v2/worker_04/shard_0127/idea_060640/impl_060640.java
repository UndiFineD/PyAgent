...
@Data
public class Idea60640Config {
    private String name = "idea_060640";
 ...
 */
@Slf4j
public class Idea60640Service {
    private static final int IDEA_ID = 60640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60640Service() {
        this(new Idea60640Config());
    }

    public Idea60640Service(Idea60640Config config) {
        this.config = config != null ? config : new Idea60640Config();
