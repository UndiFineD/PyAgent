...
@Data
public class Idea60430Config {
    private String name = "idea_060430";
 ...
 */
@Slf4j
public class Idea60430Service {
    private static final int IDEA_ID = 60430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60430Service() {
        this(new Idea60430Config());
    }

    public Idea60430Service(Idea60430Config config) {
        this.config = config != null ? config : new Idea60430Config();
