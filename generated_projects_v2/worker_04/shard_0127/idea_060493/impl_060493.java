...
@Data
public class Idea60493Config {
    private String name = "idea_060493";
 ...
 */
@Slf4j
public class Idea60493Service {
    private static final int IDEA_ID = 60493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60493Service() {
        this(new Idea60493Config());
    }

    public Idea60493Service(Idea60493Config config) {
        this.config = config != null ? config : new Idea60493Config();
