...
@Data
public class Idea60661Config {
    private String name = "idea_060661";
 ...
 */
@Slf4j
public class Idea60661Service {
    private static final int IDEA_ID = 60661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60661Service() {
        this(new Idea60661Config());
    }

    public Idea60661Service(Idea60661Config config) {
        this.config = config != null ? config : new Idea60661Config();
