...
@Data
public class Idea60391Config {
    private String name = "idea_060391";
 ...
 */
@Slf4j
public class Idea60391Service {
    private static final int IDEA_ID = 60391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60391Service() {
        this(new Idea60391Config());
    }

    public Idea60391Service(Idea60391Config config) {
        this.config = config != null ? config : new Idea60391Config();
