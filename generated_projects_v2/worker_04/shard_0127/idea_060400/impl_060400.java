...
@Data
public class Idea60400Config {
    private String name = "idea_060400";
 ...
 */
@Slf4j
public class Idea60400Service {
    private static final int IDEA_ID = 60400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60400Service() {
        this(new Idea60400Config());
    }

    public Idea60400Service(Idea60400Config config) {
        this.config = config != null ? config : new Idea60400Config();
