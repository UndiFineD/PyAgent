...
@Data
public class Idea60461Config {
    private String name = "idea_060461";
 ...
 */
@Slf4j
public class Idea60461Service {
    private static final int IDEA_ID = 60461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60461Service() {
        this(new Idea60461Config());
    }

    public Idea60461Service(Idea60461Config config) {
        this.config = config != null ? config : new Idea60461Config();
