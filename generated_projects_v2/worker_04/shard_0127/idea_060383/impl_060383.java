...
@Data
public class Idea60383Config {
    private String name = "idea_060383";
 ...
 */
@Slf4j
public class Idea60383Service {
    private static final int IDEA_ID = 60383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60383Service() {
        this(new Idea60383Config());
    }

    public Idea60383Service(Idea60383Config config) {
        this.config = config != null ? config : new Idea60383Config();
