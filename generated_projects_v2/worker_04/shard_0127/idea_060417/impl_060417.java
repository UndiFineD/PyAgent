...
@Data
public class Idea60417Config {
    private String name = "idea_060417";
 ...
 */
@Slf4j
public class Idea60417Service {
    private static final int IDEA_ID = 60417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60417Service() {
        this(new Idea60417Config());
    }

    public Idea60417Service(Idea60417Config config) {
        this.config = config != null ? config : new Idea60417Config();
