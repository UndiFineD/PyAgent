...
@Data
public class Idea60328Config {
    private String name = "idea_060328";
 ...
 */
@Slf4j
public class Idea60328Service {
    private static final int IDEA_ID = 60328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60328Service() {
        this(new Idea60328Config());
    }

    public Idea60328Service(Idea60328Config config) {
        this.config = config != null ? config : new Idea60328Config();
