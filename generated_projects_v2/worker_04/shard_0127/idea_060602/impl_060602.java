...
@Data
public class Idea60602Config {
    private String name = "idea_060602";
 ...
 */
@Slf4j
public class Idea60602Service {
    private static final int IDEA_ID = 60602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60602Service() {
        this(new Idea60602Config());
    }

    public Idea60602Service(Idea60602Config config) {
        this.config = config != null ? config : new Idea60602Config();
