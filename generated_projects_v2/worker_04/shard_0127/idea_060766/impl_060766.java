...
@Data
public class Idea60766Config {
    private String name = "idea_060766";
 ...
 */
@Slf4j
public class Idea60766Service {
    private static final int IDEA_ID = 60766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60766Service() {
        this(new Idea60766Config());
    }

    public Idea60766Service(Idea60766Config config) {
        this.config = config != null ? config : new Idea60766Config();
