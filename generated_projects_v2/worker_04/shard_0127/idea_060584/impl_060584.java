...
@Data
public class Idea60584Config {
    private String name = "idea_060584";
 ...
 */
@Slf4j
public class Idea60584Service {
    private static final int IDEA_ID = 60584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60584Service() {
        this(new Idea60584Config());
    }

    public Idea60584Service(Idea60584Config config) {
        this.config = config != null ? config : new Idea60584Config();
