...
@Data
public class Idea60578Config {
    private String name = "idea_060578";
 ...
 */
@Slf4j
public class Idea60578Service {
    private static final int IDEA_ID = 60578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60578Service() {
        this(new Idea60578Config());
    }

    public Idea60578Service(Idea60578Config config) {
        this.config = config != null ? config : new Idea60578Config();
