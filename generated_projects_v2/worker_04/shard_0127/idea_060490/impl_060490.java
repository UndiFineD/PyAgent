...
@Data
public class Idea60490Config {
    private String name = "idea_060490";
 ...
 */
@Slf4j
public class Idea60490Service {
    private static final int IDEA_ID = 60490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60490Service() {
        this(new Idea60490Config());
    }

    public Idea60490Service(Idea60490Config config) {
        this.config = config != null ? config : new Idea60490Config();
