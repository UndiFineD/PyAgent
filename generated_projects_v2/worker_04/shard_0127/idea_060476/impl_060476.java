...
@Data
public class Idea60476Config {
    private String name = "idea_060476";
 ...
 */
@Slf4j
public class Idea60476Service {
    private static final int IDEA_ID = 60476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60476Service() {
        this(new Idea60476Config());
    }

    public Idea60476Service(Idea60476Config config) {
        this.config = config != null ? config : new Idea60476Config();
