...
@Data
public class Idea60499Config {
    private String name = "idea_060499";
 ...
 */
@Slf4j
public class Idea60499Service {
    private static final int IDEA_ID = 60499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60499Service() {
        this(new Idea60499Config());
    }

    public Idea60499Service(Idea60499Config config) {
        this.config = config != null ? config : new Idea60499Config();
