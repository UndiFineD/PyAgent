...
@Data
public class Idea60598Config {
    private String name = "idea_060598";
 ...
 */
@Slf4j
public class Idea60598Service {
    private static final int IDEA_ID = 60598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60598Service() {
        this(new Idea60598Config());
    }

    public Idea60598Service(Idea60598Config config) {
        this.config = config != null ? config : new Idea60598Config();
