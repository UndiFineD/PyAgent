...
@Data
public class Idea60764Config {
    private String name = "idea_060764";
 ...
 */
@Slf4j
public class Idea60764Service {
    private static final int IDEA_ID = 60764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60764Service() {
        this(new Idea60764Config());
    }

    public Idea60764Service(Idea60764Config config) {
        this.config = config != null ? config : new Idea60764Config();
