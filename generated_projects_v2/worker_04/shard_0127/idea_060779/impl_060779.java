...
@Data
public class Idea60779Config {
    private String name = "idea_060779";
 ...
 */
@Slf4j
public class Idea60779Service {
    private static final int IDEA_ID = 60779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60779Service() {
        this(new Idea60779Config());
    }

    public Idea60779Service(Idea60779Config config) {
        this.config = config != null ? config : new Idea60779Config();
