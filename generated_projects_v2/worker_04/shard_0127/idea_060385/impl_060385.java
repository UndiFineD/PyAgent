...
@Data
public class Idea60385Config {
    private String name = "idea_060385";
 ...
 */
@Slf4j
public class Idea60385Service {
    private static final int IDEA_ID = 60385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60385Service() {
        this(new Idea60385Config());
    }

    public Idea60385Service(Idea60385Config config) {
        this.config = config != null ? config : new Idea60385Config();
