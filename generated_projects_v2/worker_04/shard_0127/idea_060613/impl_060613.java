...
@Data
public class Idea60613Config {
    private String name = "idea_060613";
 ...
 */
@Slf4j
public class Idea60613Service {
    private static final int IDEA_ID = 60613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60613Service() {
        this(new Idea60613Config());
    }

    public Idea60613Service(Idea60613Config config) {
        this.config = config != null ? config : new Idea60613Config();
