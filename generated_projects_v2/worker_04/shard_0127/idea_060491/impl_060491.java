...
@Data
public class Idea60491Config {
    private String name = "idea_060491";
 ...
 */
@Slf4j
public class Idea60491Service {
    private static final int IDEA_ID = 60491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60491Service() {
        this(new Idea60491Config());
    }

    public Idea60491Service(Idea60491Config config) {
        this.config = config != null ? config : new Idea60491Config();
