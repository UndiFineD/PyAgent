...
@Data
public class Idea60643Config {
    private String name = "idea_060643";
 ...
 */
@Slf4j
public class Idea60643Service {
    private static final int IDEA_ID = 60643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60643Service() {
        this(new Idea60643Config());
    }

    public Idea60643Service(Idea60643Config config) {
        this.config = config != null ? config : new Idea60643Config();
