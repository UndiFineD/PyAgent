...
@Data
public class Idea60501Config {
    private String name = "idea_060501";
 ...
 */
@Slf4j
public class Idea60501Service {
    private static final int IDEA_ID = 60501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60501Service() {
        this(new Idea60501Config());
    }

    public Idea60501Service(Idea60501Config config) {
        this.config = config != null ? config : new Idea60501Config();
