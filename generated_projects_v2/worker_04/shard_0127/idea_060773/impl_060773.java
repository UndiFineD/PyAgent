...
@Data
public class Idea60773Config {
    private String name = "idea_060773";
 ...
 */
@Slf4j
public class Idea60773Service {
    private static final int IDEA_ID = 60773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60773Service() {
        this(new Idea60773Config());
    }

    public Idea60773Service(Idea60773Config config) {
        this.config = config != null ? config : new Idea60773Config();
