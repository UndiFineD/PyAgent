...
@Data
public class Idea60701Config {
    private String name = "idea_060701";
 ...
 */
@Slf4j
public class Idea60701Service {
    private static final int IDEA_ID = 60701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60701Service() {
        this(new Idea60701Config());
    }

    public Idea60701Service(Idea60701Config config) {
        this.config = config != null ? config : new Idea60701Config();
