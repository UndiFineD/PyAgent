...
@Data
public class Idea60345Config {
    private String name = "idea_060345";
 ...
 */
@Slf4j
public class Idea60345Service {
    private static final int IDEA_ID = 60345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60345Service() {
        this(new Idea60345Config());
    }

    public Idea60345Service(Idea60345Config config) {
        this.config = config != null ? config : new Idea60345Config();
