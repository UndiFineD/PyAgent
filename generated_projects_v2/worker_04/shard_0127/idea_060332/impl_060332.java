...
@Data
public class Idea60332Config {
    private String name = "idea_060332";
 ...
 */
@Slf4j
public class Idea60332Service {
    private static final int IDEA_ID = 60332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60332Service() {
        this(new Idea60332Config());
    }

    public Idea60332Service(Idea60332Config config) {
        this.config = config != null ? config : new Idea60332Config();
