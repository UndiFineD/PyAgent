...
@Data
public class Idea60546Config {
    private String name = "idea_060546";
 ...
 */
@Slf4j
public class Idea60546Service {
    private static final int IDEA_ID = 60546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60546Service() {
        this(new Idea60546Config());
    }

    public Idea60546Service(Idea60546Config config) {
        this.config = config != null ? config : new Idea60546Config();
