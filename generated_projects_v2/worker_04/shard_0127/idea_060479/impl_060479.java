...
@Data
public class Idea60479Config {
    private String name = "idea_060479";
 ...
 */
@Slf4j
public class Idea60479Service {
    private static final int IDEA_ID = 60479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60479Service() {
        this(new Idea60479Config());
    }

    public Idea60479Service(Idea60479Config config) {
        this.config = config != null ? config : new Idea60479Config();
