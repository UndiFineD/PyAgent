...
@Data
public class Idea60370Config {
    private String name = "idea_060370";
 ...
 */
@Slf4j
public class Idea60370Service {
    private static final int IDEA_ID = 60370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60370Service() {
        this(new Idea60370Config());
    }

    public Idea60370Service(Idea60370Config config) {
        this.config = config != null ? config : new Idea60370Config();
