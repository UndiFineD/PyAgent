...
@Data
public class Idea60620Config {
    private String name = "idea_060620";
 ...
 */
@Slf4j
public class Idea60620Service {
    private static final int IDEA_ID = 60620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60620Service() {
        this(new Idea60620Config());
    }

    public Idea60620Service(Idea60620Config config) {
        this.config = config != null ? config : new Idea60620Config();
