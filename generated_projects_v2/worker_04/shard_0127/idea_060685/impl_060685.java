...
@Data
public class Idea60685Config {
    private String name = "idea_060685";
 ...
 */
@Slf4j
public class Idea60685Service {
    private static final int IDEA_ID = 60685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60685Service() {
        this(new Idea60685Config());
    }

    public Idea60685Service(Idea60685Config config) {
        this.config = config != null ? config : new Idea60685Config();
