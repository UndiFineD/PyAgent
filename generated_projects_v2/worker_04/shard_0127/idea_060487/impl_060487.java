...
@Data
public class Idea60487Config {
    private String name = "idea_060487";
 ...
 */
@Slf4j
public class Idea60487Service {
    private static final int IDEA_ID = 60487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60487Service() {
        this(new Idea60487Config());
    }

    public Idea60487Service(Idea60487Config config) {
        this.config = config != null ? config : new Idea60487Config();
