...
@Data
public class Idea60580Config {
    private String name = "idea_060580";
 ...
 */
@Slf4j
public class Idea60580Service {
    private static final int IDEA_ID = 60580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60580Service() {
        this(new Idea60580Config());
    }

    public Idea60580Service(Idea60580Config config) {
        this.config = config != null ? config : new Idea60580Config();
