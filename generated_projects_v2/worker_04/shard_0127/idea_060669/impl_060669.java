...
@Data
public class Idea60669Config {
    private String name = "idea_060669";
 ...
 */
@Slf4j
public class Idea60669Service {
    private static final int IDEA_ID = 60669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60669Service() {
        this(new Idea60669Config());
    }

    public Idea60669Service(Idea60669Config config) {
        this.config = config != null ? config : new Idea60669Config();
