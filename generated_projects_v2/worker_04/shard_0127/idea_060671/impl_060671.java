...
@Data
public class Idea60671Config {
    private String name = "idea_060671";
 ...
 */
@Slf4j
public class Idea60671Service {
    private static final int IDEA_ID = 60671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60671Service() {
        this(new Idea60671Config());
    }

    public Idea60671Service(Idea60671Config config) {
        this.config = config != null ? config : new Idea60671Config();
