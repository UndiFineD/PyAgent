...
@Data
public class Idea60456Config {
    private String name = "idea_060456";
 ...
 */
@Slf4j
public class Idea60456Service {
    private static final int IDEA_ID = 60456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60456Service() {
        this(new Idea60456Config());
    }

    public Idea60456Service(Idea60456Config config) {
        this.config = config != null ? config : new Idea60456Config();
