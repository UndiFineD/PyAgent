...
@Data
public class Idea60445Config {
    private String name = "idea_060445";
 ...
 */
@Slf4j
public class Idea60445Service {
    private static final int IDEA_ID = 60445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60445Service() {
        this(new Idea60445Config());
    }

    public Idea60445Service(Idea60445Config config) {
        this.config = config != null ? config : new Idea60445Config();
