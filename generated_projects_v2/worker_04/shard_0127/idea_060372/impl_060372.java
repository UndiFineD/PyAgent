...
@Data
public class Idea60372Config {
    private String name = "idea_060372";
 ...
 */
@Slf4j
public class Idea60372Service {
    private static final int IDEA_ID = 60372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60372Service() {
        this(new Idea60372Config());
    }

    public Idea60372Service(Idea60372Config config) {
        this.config = config != null ? config : new Idea60372Config();
