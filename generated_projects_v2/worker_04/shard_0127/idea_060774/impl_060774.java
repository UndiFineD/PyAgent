...
@Data
public class Idea60774Config {
    private String name = "idea_060774";
 ...
 */
@Slf4j
public class Idea60774Service {
    private static final int IDEA_ID = 60774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60774Service() {
        this(new Idea60774Config());
    }

    public Idea60774Service(Idea60774Config config) {
        this.config = config != null ? config : new Idea60774Config();
