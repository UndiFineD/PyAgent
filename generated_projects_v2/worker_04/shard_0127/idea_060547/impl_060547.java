...
@Data
public class Idea60547Config {
    private String name = "idea_060547";
 ...
 */
@Slf4j
public class Idea60547Service {
    private static final int IDEA_ID = 60547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60547Service() {
        this(new Idea60547Config());
    }

    public Idea60547Service(Idea60547Config config) {
        this.config = config != null ? config : new Idea60547Config();
