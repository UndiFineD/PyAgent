...
@Data
public class Idea60682Config {
    private String name = "idea_060682";
 ...
 */
@Slf4j
public class Idea60682Service {
    private static final int IDEA_ID = 60682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60682Service() {
        this(new Idea60682Config());
    }

    public Idea60682Service(Idea60682Config config) {
        this.config = config != null ? config : new Idea60682Config();
