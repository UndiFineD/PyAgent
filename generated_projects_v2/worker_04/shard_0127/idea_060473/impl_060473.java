...
@Data
public class Idea60473Config {
    private String name = "idea_060473";
 ...
 */
@Slf4j
public class Idea60473Service {
    private static final int IDEA_ID = 60473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60473Service() {
        this(new Idea60473Config());
    }

    public Idea60473Service(Idea60473Config config) {
        this.config = config != null ? config : new Idea60473Config();
