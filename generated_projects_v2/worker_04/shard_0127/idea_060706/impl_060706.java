...
@Data
public class Idea60706Config {
    private String name = "idea_060706";
 ...
 */
@Slf4j
public class Idea60706Service {
    private static final int IDEA_ID = 60706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60706Service() {
        this(new Idea60706Config());
    }

    public Idea60706Service(Idea60706Config config) {
        this.config = config != null ? config : new Idea60706Config();
