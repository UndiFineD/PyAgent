...
@Data
public class Idea60380Config {
    private String name = "idea_060380";
 ...
 */
@Slf4j
public class Idea60380Service {
    private static final int IDEA_ID = 60380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60380Service() {
        this(new Idea60380Config());
    }

    public Idea60380Service(Idea60380Config config) {
        this.config = config != null ? config : new Idea60380Config();
