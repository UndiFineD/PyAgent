...
@Data
public class Idea60510Config {
    private String name = "idea_060510";
 ...
 */
@Slf4j
public class Idea60510Service {
    private static final int IDEA_ID = 60510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60510Service() {
        this(new Idea60510Config());
    }

    public Idea60510Service(Idea60510Config config) {
        this.config = config != null ? config : new Idea60510Config();
