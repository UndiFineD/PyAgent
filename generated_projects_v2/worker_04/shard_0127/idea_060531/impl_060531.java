...
@Data
public class Idea60531Config {
    private String name = "idea_060531";
 ...
 */
@Slf4j
public class Idea60531Service {
    private static final int IDEA_ID = 60531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60531Service() {
        this(new Idea60531Config());
    }

    public Idea60531Service(Idea60531Config config) {
        this.config = config != null ? config : new Idea60531Config();
