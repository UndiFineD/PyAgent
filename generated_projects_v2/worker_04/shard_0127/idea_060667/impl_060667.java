...
@Data
public class Idea60667Config {
    private String name = "idea_060667";
 ...
 */
@Slf4j
public class Idea60667Service {
    private static final int IDEA_ID = 60667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60667Service() {
        this(new Idea60667Config());
    }

    public Idea60667Service(Idea60667Config config) {
        this.config = config != null ? config : new Idea60667Config();
