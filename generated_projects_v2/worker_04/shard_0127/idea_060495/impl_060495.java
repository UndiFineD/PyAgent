...
@Data
public class Idea60495Config {
    private String name = "idea_060495";
 ...
 */
@Slf4j
public class Idea60495Service {
    private static final int IDEA_ID = 60495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60495Service() {
        this(new Idea60495Config());
    }

    public Idea60495Service(Idea60495Config config) {
        this.config = config != null ? config : new Idea60495Config();
