...
@Data
public class Idea60329Config {
    private String name = "idea_060329";
 ...
 */
@Slf4j
public class Idea60329Service {
    private static final int IDEA_ID = 60329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60329Service() {
        this(new Idea60329Config());
    }

    public Idea60329Service(Idea60329Config config) {
        this.config = config != null ? config : new Idea60329Config();
