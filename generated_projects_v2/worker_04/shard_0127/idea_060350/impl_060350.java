...
@Data
public class Idea60350Config {
    private String name = "idea_060350";
 ...
 */
@Slf4j
public class Idea60350Service {
    private static final int IDEA_ID = 60350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60350Service() {
        this(new Idea60350Config());
    }

    public Idea60350Service(Idea60350Config config) {
        this.config = config != null ? config : new Idea60350Config();
