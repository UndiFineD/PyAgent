...
@Data
public class Idea60406Config {
    private String name = "idea_060406";
 ...
 */
@Slf4j
public class Idea60406Service {
    private static final int IDEA_ID = 60406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60406Service() {
        this(new Idea60406Config());
    }

    public Idea60406Service(Idea60406Config config) {
        this.config = config != null ? config : new Idea60406Config();
