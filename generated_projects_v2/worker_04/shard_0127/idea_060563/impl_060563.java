...
@Data
public class Idea60563Config {
    private String name = "idea_060563";
 ...
 */
@Slf4j
public class Idea60563Service {
    private static final int IDEA_ID = 60563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60563Service() {
        this(new Idea60563Config());
    }

    public Idea60563Service(Idea60563Config config) {
        this.config = config != null ? config : new Idea60563Config();
