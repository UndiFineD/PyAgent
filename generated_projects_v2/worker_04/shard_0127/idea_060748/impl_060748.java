...
@Data
public class Idea60748Config {
    private String name = "idea_060748";
 ...
 */
@Slf4j
public class Idea60748Service {
    private static final int IDEA_ID = 60748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60748Service() {
        this(new Idea60748Config());
    }

    public Idea60748Service(Idea60748Config config) {
        this.config = config != null ? config : new Idea60748Config();
