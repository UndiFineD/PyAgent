...
@Data
public class Idea60619Config {
    private String name = "idea_060619";
 ...
 */
@Slf4j
public class Idea60619Service {
    private static final int IDEA_ID = 60619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60619Service() {
        this(new Idea60619Config());
    }

    public Idea60619Service(Idea60619Config config) {
        this.config = config != null ? config : new Idea60619Config();
