...
@Data
public class Idea60425Config {
    private String name = "idea_060425";
 ...
 */
@Slf4j
public class Idea60425Service {
    private static final int IDEA_ID = 60425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60425Service() {
        this(new Idea60425Config());
    }

    public Idea60425Service(Idea60425Config config) {
        this.config = config != null ? config : new Idea60425Config();
