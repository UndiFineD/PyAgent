...
@Data
public class Idea60692Config {
    private String name = "idea_060692";
 ...
 */
@Slf4j
public class Idea60692Service {
    private static final int IDEA_ID = 60692;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60692Service() {
        this(new Idea60692Config());
    }

    public Idea60692Service(Idea60692Config config) {
        this.config = config != null ? config : new Idea60692Config();
