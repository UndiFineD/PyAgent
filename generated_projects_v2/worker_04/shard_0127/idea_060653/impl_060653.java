...
@Data
public class Idea60653Config {
    private String name = "idea_060653";
 ...
 */
@Slf4j
public class Idea60653Service {
    private static final int IDEA_ID = 60653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60653Service() {
        this(new Idea60653Config());
    }

    public Idea60653Service(Idea60653Config config) {
        this.config = config != null ? config : new Idea60653Config();
