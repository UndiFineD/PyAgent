...
@Data
public class Idea60647Config {
    private String name = "idea_060647";
 ...
 */
@Slf4j
public class Idea60647Service {
    private static final int IDEA_ID = 60647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60647Service() {
        this(new Idea60647Config());
    }

    public Idea60647Service(Idea60647Config config) {
        this.config = config != null ? config : new Idea60647Config();
