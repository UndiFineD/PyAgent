...
@Data
public class Idea60645Config {
    private String name = "idea_060645";
 ...
 */
@Slf4j
public class Idea60645Service {
    private static final int IDEA_ID = 60645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60645Service() {
        this(new Idea60645Config());
    }

    public Idea60645Service(Idea60645Config config) {
        this.config = config != null ? config : new Idea60645Config();
