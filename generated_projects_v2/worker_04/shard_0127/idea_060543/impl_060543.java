...
@Data
public class Idea60543Config {
    private String name = "idea_060543";
 ...
 */
@Slf4j
public class Idea60543Service {
    private static final int IDEA_ID = 60543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60543Service() {
        this(new Idea60543Config());
    }

    public Idea60543Service(Idea60543Config config) {
        this.config = config != null ? config : new Idea60543Config();
