...
@Data
public class Idea60614Config {
    private String name = "idea_060614";
 ...
 */
@Slf4j
public class Idea60614Service {
    private static final int IDEA_ID = 60614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60614Service() {
        this(new Idea60614Config());
    }

    public Idea60614Service(Idea60614Config config) {
        this.config = config != null ? config : new Idea60614Config();
