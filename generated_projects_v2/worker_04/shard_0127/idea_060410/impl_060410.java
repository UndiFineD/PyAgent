...
@Data
public class Idea60410Config {
    private String name = "idea_060410";
 ...
 */
@Slf4j
public class Idea60410Service {
    private static final int IDEA_ID = 60410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60410Service() {
        this(new Idea60410Config());
    }

    public Idea60410Service(Idea60410Config config) {
        this.config = config != null ? config : new Idea60410Config();
