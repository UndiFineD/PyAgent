...
@Data
public class Idea60502Config {
    private String name = "idea_060502";
 ...
 */
@Slf4j
public class Idea60502Service {
    private static final int IDEA_ID = 60502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60502Service() {
        this(new Idea60502Config());
    }

    public Idea60502Service(Idea60502Config config) {
        this.config = config != null ? config : new Idea60502Config();
