...
@Data
public class Idea60443Config {
    private String name = "idea_060443";
 ...
 */
@Slf4j
public class Idea60443Service {
    private static final int IDEA_ID = 60443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60443Service() {
        this(new Idea60443Config());
    }

    public Idea60443Service(Idea60443Config config) {
        this.config = config != null ? config : new Idea60443Config();
