...
@Data
public class Idea60796Config {
    private String name = "idea_060796";
 ...
 */
@Slf4j
public class Idea60796Service {
    private static final int IDEA_ID = 60796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60796Service() {
        this(new Idea60796Config());
    }

    public Idea60796Service(Idea60796Config config) {
        this.config = config != null ? config : new Idea60796Config();
