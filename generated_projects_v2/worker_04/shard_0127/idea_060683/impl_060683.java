...
@Data
public class Idea60683Config {
    private String name = "idea_060683";
 ...
 */
@Slf4j
public class Idea60683Service {
    private static final int IDEA_ID = 60683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60683Service() {
        this(new Idea60683Config());
    }

    public Idea60683Service(Idea60683Config config) {
        this.config = config != null ? config : new Idea60683Config();
