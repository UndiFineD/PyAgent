...
@Data
public class Idea60637Config {
    private String name = "idea_060637";
 ...
 */
@Slf4j
public class Idea60637Service {
    private static final int IDEA_ID = 60637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60637Service() {
        this(new Idea60637Config());
    }

    public Idea60637Service(Idea60637Config config) {
        this.config = config != null ? config : new Idea60637Config();
