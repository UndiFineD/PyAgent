...
@Data
public class Idea60677Config {
    private String name = "idea_060677";
 ...
 */
@Slf4j
public class Idea60677Service {
    private static final int IDEA_ID = 60677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60677Service() {
        this(new Idea60677Config());
    }

    public Idea60677Service(Idea60677Config config) {
        this.config = config != null ? config : new Idea60677Config();
