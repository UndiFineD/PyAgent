...
@Data
public class Idea60655Config {
    private String name = "idea_060655";
 ...
 */
@Slf4j
public class Idea60655Service {
    private static final int IDEA_ID = 60655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60655Service() {
        this(new Idea60655Config());
    }

    public Idea60655Service(Idea60655Config config) {
        this.config = config != null ? config : new Idea60655Config();
