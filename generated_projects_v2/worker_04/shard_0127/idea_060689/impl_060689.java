...
@Data
public class Idea60689Config {
    private String name = "idea_060689";
 ...
 */
@Slf4j
public class Idea60689Service {
    private static final int IDEA_ID = 60689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60689Service() {
        this(new Idea60689Config());
    }

    public Idea60689Service(Idea60689Config config) {
        this.config = config != null ? config : new Idea60689Config();
