...
@Data
public class Idea60568Config {
    private String name = "idea_060568";
 ...
 */
@Slf4j
public class Idea60568Service {
    private static final int IDEA_ID = 60568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60568Service() {
        this(new Idea60568Config());
    }

    public Idea60568Service(Idea60568Config config) {
        this.config = config != null ? config : new Idea60568Config();
