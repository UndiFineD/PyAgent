...
@Data
public class Idea60390Config {
    private String name = "idea_060390";
 ...
 */
@Slf4j
public class Idea60390Service {
    private static final int IDEA_ID = 60390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60390Service() {
        this(new Idea60390Config());
    }

    public Idea60390Service(Idea60390Config config) {
        this.config = config != null ? config : new Idea60390Config();
