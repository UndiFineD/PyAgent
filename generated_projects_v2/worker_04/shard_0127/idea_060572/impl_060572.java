...
@Data
public class Idea60572Config {
    private String name = "idea_060572";
 ...
 */
@Slf4j
public class Idea60572Service {
    private static final int IDEA_ID = 60572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60572Service() {
        this(new Idea60572Config());
    }

    public Idea60572Service(Idea60572Config config) {
        this.config = config != null ? config : new Idea60572Config();
