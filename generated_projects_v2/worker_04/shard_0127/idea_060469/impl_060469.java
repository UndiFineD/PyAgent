...
@Data
public class Idea60469Config {
    private String name = "idea_060469";
 ...
 */
@Slf4j
public class Idea60469Service {
    private static final int IDEA_ID = 60469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60469Service() {
        this(new Idea60469Config());
    }

    public Idea60469Service(Idea60469Config config) {
        this.config = config != null ? config : new Idea60469Config();
