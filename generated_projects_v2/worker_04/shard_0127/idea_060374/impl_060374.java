...
@Data
public class Idea60374Config {
    private String name = "idea_060374";
 ...
 */
@Slf4j
public class Idea60374Service {
    private static final int IDEA_ID = 60374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60374Service() {
        this(new Idea60374Config());
    }

    public Idea60374Service(Idea60374Config config) {
        this.config = config != null ? config : new Idea60374Config();
