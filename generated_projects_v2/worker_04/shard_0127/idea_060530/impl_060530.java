...
@Data
public class Idea60530Config {
    private String name = "idea_060530";
 ...
 */
@Slf4j
public class Idea60530Service {
    private static final int IDEA_ID = 60530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60530Service() {
        this(new Idea60530Config());
    }

    public Idea60530Service(Idea60530Config config) {
        this.config = config != null ? config : new Idea60530Config();
