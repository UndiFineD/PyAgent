...
@Data
public class Idea60760Config {
    private String name = "idea_060760";
 ...
 */
@Slf4j
public class Idea60760Service {
    private static final int IDEA_ID = 60760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60760Service() {
        this(new Idea60760Config());
    }

    public Idea60760Service(Idea60760Config config) {
        this.config = config != null ? config : new Idea60760Config();
