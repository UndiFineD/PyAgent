...
@Data
public class Idea60721Config {
    private String name = "idea_060721";
 ...
 */
@Slf4j
public class Idea60721Service {
    private static final int IDEA_ID = 60721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60721Service() {
        this(new Idea60721Config());
    }

    public Idea60721Service(Idea60721Config config) {
        this.config = config != null ? config : new Idea60721Config();
