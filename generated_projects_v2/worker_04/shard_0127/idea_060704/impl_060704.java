...
@Data
public class Idea60704Config {
    private String name = "idea_060704";
 ...
 */
@Slf4j
public class Idea60704Service {
    private static final int IDEA_ID = 60704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60704Service() {
        this(new Idea60704Config());
    }

    public Idea60704Service(Idea60704Config config) {
        this.config = config != null ? config : new Idea60704Config();
