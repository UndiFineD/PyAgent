...
@Data
public class Idea60348Config {
    private String name = "idea_060348";
 ...
 */
@Slf4j
public class Idea60348Service {
    private static final int IDEA_ID = 60348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60348Service() {
        this(new Idea60348Config());
    }

    public Idea60348Service(Idea60348Config config) {
        this.config = config != null ? config : new Idea60348Config();
