...
@Data
public class Idea60395Config {
    private String name = "idea_060395";
 ...
 */
@Slf4j
public class Idea60395Service {
    private static final int IDEA_ID = 60395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60395Service() {
        this(new Idea60395Config());
    }

    public Idea60395Service(Idea60395Config config) {
        this.config = config != null ? config : new Idea60395Config();
