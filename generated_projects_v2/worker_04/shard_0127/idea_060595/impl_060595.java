...
@Data
public class Idea60595Config {
    private String name = "idea_060595";
 ...
 */
@Slf4j
public class Idea60595Service {
    private static final int IDEA_ID = 60595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60595Service() {
        this(new Idea60595Config());
    }

    public Idea60595Service(Idea60595Config config) {
        this.config = config != null ? config : new Idea60595Config();
