...
@Data
public class Idea60675Config {
    private String name = "idea_060675";
 ...
 */
@Slf4j
public class Idea60675Service {
    private static final int IDEA_ID = 60675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60675Service() {
        this(new Idea60675Config());
    }

    public Idea60675Service(Idea60675Config config) {
        this.config = config != null ? config : new Idea60675Config();
