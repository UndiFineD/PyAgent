...
@Data
public class Idea60688Config {
    private String name = "idea_060688";
 ...
 */
@Slf4j
public class Idea60688Service {
    private static final int IDEA_ID = 60688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60688Service() {
        this(new Idea60688Config());
    }

    public Idea60688Service(Idea60688Config config) {
        this.config = config != null ? config : new Idea60688Config();
