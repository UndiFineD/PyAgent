...
@Data
public class Idea60360Config {
    private String name = "idea_060360";
 ...
 */
@Slf4j
public class Idea60360Service {
    private static final int IDEA_ID = 60360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60360Service() {
        this(new Idea60360Config());
    }

    public Idea60360Service(Idea60360Config config) {
        this.config = config != null ? config : new Idea60360Config();
