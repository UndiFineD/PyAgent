...
@Data
public class Idea60458Config {
    private String name = "idea_060458";
 ...
 */
@Slf4j
public class Idea60458Service {
    private static final int IDEA_ID = 60458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60458Service() {
        this(new Idea60458Config());
    }

    public Idea60458Service(Idea60458Config config) {
        this.config = config != null ? config : new Idea60458Config();
