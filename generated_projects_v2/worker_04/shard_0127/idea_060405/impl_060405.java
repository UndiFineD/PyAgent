...
@Data
public class Idea60405Config {
    private String name = "idea_060405";
 ...
 */
@Slf4j
public class Idea60405Service {
    private static final int IDEA_ID = 60405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60405Service() {
        this(new Idea60405Config());
    }

    public Idea60405Service(Idea60405Config config) {
        this.config = config != null ? config : new Idea60405Config();
