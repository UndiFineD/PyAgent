...
@Data
public class Idea60674Config {
    private String name = "idea_060674";
 ...
 */
@Slf4j
public class Idea60674Service {
    private static final int IDEA_ID = 60674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60674Service() {
        this(new Idea60674Config());
    }

    public Idea60674Service(Idea60674Config config) {
        this.config = config != null ? config : new Idea60674Config();
