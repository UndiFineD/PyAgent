...
@Data
public class Idea60373Config {
    private String name = "idea_060373";
 ...
 */
@Slf4j
public class Idea60373Service {
    private static final int IDEA_ID = 60373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60373Service() {
        this(new Idea60373Config());
    }

    public Idea60373Service(Idea60373Config config) {
        this.config = config != null ? config : new Idea60373Config();
