...
@Data
public class Idea60444Config {
    private String name = "idea_060444";
 ...
 */
@Slf4j
public class Idea60444Service {
    private static final int IDEA_ID = 60444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60444Service() {
        this(new Idea60444Config());
    }

    public Idea60444Service(Idea60444Config config) {
        this.config = config != null ? config : new Idea60444Config();
