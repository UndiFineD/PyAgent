...
@Data
public class Idea60555Config {
    private String name = "idea_060555";
 ...
 */
@Slf4j
public class Idea60555Service {
    private static final int IDEA_ID = 60555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60555Service() {
        this(new Idea60555Config());
    }

    public Idea60555Service(Idea60555Config config) {
        this.config = config != null ? config : new Idea60555Config();
