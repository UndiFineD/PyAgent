...
@Data
public class Idea60589Config {
    private String name = "idea_060589";
 ...
 */
@Slf4j
public class Idea60589Service {
    private static final int IDEA_ID = 60589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60589Service() {
        this(new Idea60589Config());
    }

    public Idea60589Service(Idea60589Config config) {
        this.config = config != null ? config : new Idea60589Config();
