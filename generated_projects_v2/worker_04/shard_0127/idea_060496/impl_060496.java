...
@Data
public class Idea60496Config {
    private String name = "idea_060496";
 ...
 */
@Slf4j
public class Idea60496Service {
    private static final int IDEA_ID = 60496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60496Service() {
        this(new Idea60496Config());
    }

    public Idea60496Service(Idea60496Config config) {
        this.config = config != null ? config : new Idea60496Config();
