...
@Data
public class Idea60576Config {
    private String name = "idea_060576";
 ...
 */
@Slf4j
public class Idea60576Service {
    private static final int IDEA_ID = 60576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60576Service() {
        this(new Idea60576Config());
    }

    public Idea60576Service(Idea60576Config config) {
        this.config = config != null ? config : new Idea60576Config();
