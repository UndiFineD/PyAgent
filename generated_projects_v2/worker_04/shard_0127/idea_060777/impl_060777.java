...
@Data
public class Idea60777Config {
    private String name = "idea_060777";
 ...
 */
@Slf4j
public class Idea60777Service {
    private static final int IDEA_ID = 60777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60777Service() {
        this(new Idea60777Config());
    }

    public Idea60777Service(Idea60777Config config) {
        this.config = config != null ? config : new Idea60777Config();
