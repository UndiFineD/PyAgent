...
@Data
public class Idea60628Config {
    private String name = "idea_060628";
 ...
 */
@Slf4j
public class Idea60628Service {
    private static final int IDEA_ID = 60628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60628Service() {
        this(new Idea60628Config());
    }

    public Idea60628Service(Idea60628Config config) {
        this.config = config != null ? config : new Idea60628Config();
