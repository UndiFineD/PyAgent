...
@Data
public class Idea60746Config {
    private String name = "idea_060746";
 ...
 */
@Slf4j
public class Idea60746Service {
    private static final int IDEA_ID = 60746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60746Service() {
        this(new Idea60746Config());
    }

    public Idea60746Service(Idea60746Config config) {
        this.config = config != null ? config : new Idea60746Config();
