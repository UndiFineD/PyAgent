...
@Data
public class Idea60336Config {
    private String name = "idea_060336";
 ...
 */
@Slf4j
public class Idea60336Service {
    private static final int IDEA_ID = 60336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60336Service() {
        this(new Idea60336Config());
    }

    public Idea60336Service(Idea60336Config config) {
        this.config = config != null ? config : new Idea60336Config();
