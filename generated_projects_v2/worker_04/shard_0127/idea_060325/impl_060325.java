...
@Data
public class Idea60325Config {
    private String name = "idea_060325";
 ...
 */
@Slf4j
public class Idea60325Service {
    private static final int IDEA_ID = 60325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60325Service() {
        this(new Idea60325Config());
    }

    public Idea60325Service(Idea60325Config config) {
        this.config = config != null ? config : new Idea60325Config();
