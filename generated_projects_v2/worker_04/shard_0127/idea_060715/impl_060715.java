...
@Data
public class Idea60715Config {
    private String name = "idea_060715";
 ...
 */
@Slf4j
public class Idea60715Service {
    private static final int IDEA_ID = 60715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60715Service() {
        this(new Idea60715Config());
    }

    public Idea60715Service(Idea60715Config config) {
        this.config = config != null ? config : new Idea60715Config();
