...
@Data
public class Idea60392Config {
    private String name = "idea_060392";
 ...
 */
@Slf4j
public class Idea60392Service {
    private static final int IDEA_ID = 60392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60392Service() {
        this(new Idea60392Config());
    }

    public Idea60392Service(Idea60392Config config) {
        this.config = config != null ? config : new Idea60392Config();
