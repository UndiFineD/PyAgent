...
@Data
public class Idea60791Config {
    private String name = "idea_060791";
 ...
 */
@Slf4j
public class Idea60791Service {
    private static final int IDEA_ID = 60791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60791Service() {
        this(new Idea60791Config());
    }

    public Idea60791Service(Idea60791Config config) {
        this.config = config != null ? config : new Idea60791Config();
