...
@Data
public class Idea60629Config {
    private String name = "idea_060629";
 ...
 */
@Slf4j
public class Idea60629Service {
    private static final int IDEA_ID = 60629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60629Service() {
        this(new Idea60629Config());
    }

    public Idea60629Service(Idea60629Config config) {
        this.config = config != null ? config : new Idea60629Config();
