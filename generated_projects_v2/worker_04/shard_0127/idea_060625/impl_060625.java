...
@Data
public class Idea60625Config {
    private String name = "idea_060625";
 ...
 */
@Slf4j
public class Idea60625Service {
    private static final int IDEA_ID = 60625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60625Service() {
        this(new Idea60625Config());
    }

    public Idea60625Service(Idea60625Config config) {
        this.config = config != null ? config : new Idea60625Config();
