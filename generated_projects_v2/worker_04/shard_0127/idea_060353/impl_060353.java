...
@Data
public class Idea60353Config {
    private String name = "idea_060353";
 ...
 */
@Slf4j
public class Idea60353Service {
    private static final int IDEA_ID = 60353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60353Service() {
        this(new Idea60353Config());
    }

    public Idea60353Service(Idea60353Config config) {
        this.config = config != null ? config : new Idea60353Config();
