...
@Data
public class Idea60573Config {
    private String name = "idea_060573";
 ...
 */
@Slf4j
public class Idea60573Service {
    private static final int IDEA_ID = 60573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60573Service() {
        this(new Idea60573Config());
    }

    public Idea60573Service(Idea60573Config config) {
        this.config = config != null ? config : new Idea60573Config();
