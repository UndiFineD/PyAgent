...
@Data
public class Idea60415Config {
    private String name = "idea_060415";
 ...
 */
@Slf4j
public class Idea60415Service {
    private static final int IDEA_ID = 60415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60415Service() {
        this(new Idea60415Config());
    }

    public Idea60415Service(Idea60415Config config) {
        this.config = config != null ? config : new Idea60415Config();
