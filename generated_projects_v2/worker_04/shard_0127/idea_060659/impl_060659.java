...
@Data
public class Idea60659Config {
    private String name = "idea_060659";
 ...
 */
@Slf4j
public class Idea60659Service {
    private static final int IDEA_ID = 60659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60659Service() {
        this(new Idea60659Config());
    }

    public Idea60659Service(Idea60659Config config) {
        this.config = config != null ? config : new Idea60659Config();
