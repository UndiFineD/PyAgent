...
@Data
public class Idea60517Config {
    private String name = "idea_060517";
 ...
 */
@Slf4j
public class Idea60517Service {
    private static final int IDEA_ID = 60517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60517Service() {
        this(new Idea60517Config());
    }

    public Idea60517Service(Idea60517Config config) {
        this.config = config != null ? config : new Idea60517Config();
