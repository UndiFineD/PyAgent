...
@Data
public class Idea60352Config {
    private String name = "idea_060352";
 ...
 */
@Slf4j
public class Idea60352Service {
    private static final int IDEA_ID = 60352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60352Service() {
        this(new Idea60352Config());
    }

    public Idea60352Service(Idea60352Config config) {
        this.config = config != null ? config : new Idea60352Config();
