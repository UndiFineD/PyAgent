...
@Data
public class Idea60591Config {
    private String name = "idea_060591";
 ...
 */
@Slf4j
public class Idea60591Service {
    private static final int IDEA_ID = 60591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60591Service() {
        this(new Idea60591Config());
    }

    public Idea60591Service(Idea60591Config config) {
        this.config = config != null ? config : new Idea60591Config();
