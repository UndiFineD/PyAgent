...
@Data
public class Idea60413Config {
    private String name = "idea_060413";
 ...
 */
@Slf4j
public class Idea60413Service {
    private static final int IDEA_ID = 60413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60413Service() {
        this(new Idea60413Config());
    }

    public Idea60413Service(Idea60413Config config) {
        this.config = config != null ? config : new Idea60413Config();
