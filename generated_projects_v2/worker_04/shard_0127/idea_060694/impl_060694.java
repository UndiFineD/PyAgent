...
@Data
public class Idea60694Config {
    private String name = "idea_060694";
 ...
 */
@Slf4j
public class Idea60694Service {
    private static final int IDEA_ID = 60694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60694Service() {
        this(new Idea60694Config());
    }

    public Idea60694Service(Idea60694Config config) {
        this.config = config != null ? config : new Idea60694Config();
