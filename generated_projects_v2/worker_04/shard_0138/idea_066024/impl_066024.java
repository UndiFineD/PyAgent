...
@Data
public class Idea66024Config {
    private String name = "idea_066024";
 ...
 */
@Slf4j
public class Idea66024Service {
    private static final int IDEA_ID = 66024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66024Service() {
        this(new Idea66024Config());
    }

    public Idea66024Service(Idea66024Config config) {
        this.config = config != null ? config : new Idea66024Config();
