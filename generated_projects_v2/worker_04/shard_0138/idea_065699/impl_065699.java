...
@Data
public class Idea65699Config {
    private String name = "idea_065699";
 ...
 */
@Slf4j
public class Idea65699Service {
    private static final int IDEA_ID = 65699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65699Service() {
        this(new Idea65699Config());
    }

    public Idea65699Service(Idea65699Config config) {
        this.config = config != null ? config : new Idea65699Config();
