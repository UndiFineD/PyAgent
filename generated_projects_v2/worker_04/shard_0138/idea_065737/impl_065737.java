...
@Data
public class Idea65737Config {
    private String name = "idea_065737";
 ...
 */
@Slf4j
public class Idea65737Service {
    private static final int IDEA_ID = 65737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65737Service() {
        this(new Idea65737Config());
    }

    public Idea65737Service(Idea65737Config config) {
        this.config = config != null ? config : new Idea65737Config();
