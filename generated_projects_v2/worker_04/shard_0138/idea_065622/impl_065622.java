...
@Data
public class Idea65622Config {
    private String name = "idea_065622";
 ...
 */
@Slf4j
public class Idea65622Service {
    private static final int IDEA_ID = 65622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65622Service() {
        this(new Idea65622Config());
    }

    public Idea65622Service(Idea65622Config config) {
        this.config = config != null ? config : new Idea65622Config();
