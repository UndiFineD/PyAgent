...
@Data
public class Idea65973Config {
    private String name = "idea_065973";
 ...
 */
@Slf4j
public class Idea65973Service {
    private static final int IDEA_ID = 65973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65973Service() {
        this(new Idea65973Config());
    }

    public Idea65973Service(Idea65973Config config) {
        this.config = config != null ? config : new Idea65973Config();
