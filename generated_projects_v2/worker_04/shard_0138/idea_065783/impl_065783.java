...
@Data
public class Idea65783Config {
    private String name = "idea_065783";
 ...
 */
@Slf4j
public class Idea65783Service {
    private static final int IDEA_ID = 65783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65783Service() {
        this(new Idea65783Config());
    }

    public Idea65783Service(Idea65783Config config) {
        this.config = config != null ? config : new Idea65783Config();
