...
@Data
public class Idea65762Config {
    private String name = "idea_065762";
 ...
 */
@Slf4j
public class Idea65762Service {
    private static final int IDEA_ID = 65762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65762Service() {
        this(new Idea65762Config());
    }

    public Idea65762Service(Idea65762Config config) {
        this.config = config != null ? config : new Idea65762Config();
