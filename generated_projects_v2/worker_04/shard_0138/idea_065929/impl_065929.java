...
@Data
public class Idea65929Config {
    private String name = "idea_065929";
 ...
 */
@Slf4j
public class Idea65929Service {
    private static final int IDEA_ID = 65929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65929Service() {
        this(new Idea65929Config());
    }

    public Idea65929Service(Idea65929Config config) {
        this.config = config != null ? config : new Idea65929Config();
