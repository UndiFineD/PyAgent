...
@Data
public class Idea65663Config {
    private String name = "idea_065663";
 ...
 */
@Slf4j
public class Idea65663Service {
    private static final int IDEA_ID = 65663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65663Service() {
        this(new Idea65663Config());
    }

    public Idea65663Service(Idea65663Config config) {
        this.config = config != null ? config : new Idea65663Config();
