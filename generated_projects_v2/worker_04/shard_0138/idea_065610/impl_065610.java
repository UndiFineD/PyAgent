...
@Data
public class Idea65610Config {
    private String name = "idea_065610";
 ...
 */
@Slf4j
public class Idea65610Service {
    private static final int IDEA_ID = 65610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65610Service() {
        this(new Idea65610Config());
    }

    public Idea65610Service(Idea65610Config config) {
        this.config = config != null ? config : new Idea65610Config();
