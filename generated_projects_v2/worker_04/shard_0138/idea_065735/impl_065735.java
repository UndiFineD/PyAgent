...
@Data
public class Idea65735Config {
    private String name = "idea_065735";
 ...
 */
@Slf4j
public class Idea65735Service {
    private static final int IDEA_ID = 65735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65735Service() {
        this(new Idea65735Config());
    }

    public Idea65735Service(Idea65735Config config) {
        this.config = config != null ? config : new Idea65735Config();
