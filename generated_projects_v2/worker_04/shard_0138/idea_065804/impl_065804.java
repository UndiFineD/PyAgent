...
@Data
public class Idea65804Config {
    private String name = "idea_065804";
 ...
 */
@Slf4j
public class Idea65804Service {
    private static final int IDEA_ID = 65804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65804Service() {
        this(new Idea65804Config());
    }

    public Idea65804Service(Idea65804Config config) {
        this.config = config != null ? config : new Idea65804Config();
