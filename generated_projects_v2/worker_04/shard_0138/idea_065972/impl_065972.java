...
@Data
public class Idea65972Config {
    private String name = "idea_065972";
 ...
 */
@Slf4j
public class Idea65972Service {
    private static final int IDEA_ID = 65972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65972Service() {
        this(new Idea65972Config());
    }

    public Idea65972Service(Idea65972Config config) {
        this.config = config != null ? config : new Idea65972Config();
