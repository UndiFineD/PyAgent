...
@Data
public class Idea65655Config {
    private String name = "idea_065655";
 ...
 */
@Slf4j
public class Idea65655Service {
    private static final int IDEA_ID = 65655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65655Service() {
        this(new Idea65655Config());
    }

    public Idea65655Service(Idea65655Config config) {
        this.config = config != null ? config : new Idea65655Config();
