...
@Data
public class Idea65968Config {
    private String name = "idea_065968";
 ...
 */
@Slf4j
public class Idea65968Service {
    private static final int IDEA_ID = 65968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65968Service() {
        this(new Idea65968Config());
    }

    public Idea65968Service(Idea65968Config config) {
        this.config = config != null ? config : new Idea65968Config();
