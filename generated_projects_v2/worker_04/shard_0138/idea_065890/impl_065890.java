...
@Data
public class Idea65890Config {
    private String name = "idea_065890";
 ...
 */
@Slf4j
public class Idea65890Service {
    private static final int IDEA_ID = 65890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65890Service() {
        this(new Idea65890Config());
    }

    public Idea65890Service(Idea65890Config config) {
        this.config = config != null ? config : new Idea65890Config();
