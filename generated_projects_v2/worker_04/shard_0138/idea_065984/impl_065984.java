...
@Data
public class Idea65984Config {
    private String name = "idea_065984";
 ...
 */
@Slf4j
public class Idea65984Service {
    private static final int IDEA_ID = 65984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65984Service() {
        this(new Idea65984Config());
    }

    public Idea65984Service(Idea65984Config config) {
        this.config = config != null ? config : new Idea65984Config();
