...
@Data
public class Idea65964Config {
    private String name = "idea_065964";
 ...
 */
@Slf4j
public class Idea65964Service {
    private static final int IDEA_ID = 65964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65964Service() {
        this(new Idea65964Config());
    }

    public Idea65964Service(Idea65964Config config) {
        this.config = config != null ? config : new Idea65964Config();
