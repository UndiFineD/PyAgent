...
@Data
public class Idea65595Config {
    private String name = "idea_065595";
 ...
 */
@Slf4j
public class Idea65595Service {
    private static final int IDEA_ID = 65595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65595Service() {
        this(new Idea65595Config());
    }

    public Idea65595Service(Idea65595Config config) {
        this.config = config != null ? config : new Idea65595Config();
