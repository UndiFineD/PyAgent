...
@Data
public class Idea65786Config {
    private String name = "idea_065786";
 ...
 */
@Slf4j
public class Idea65786Service {
    private static final int IDEA_ID = 65786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65786Service() {
        this(new Idea65786Config());
    }

    public Idea65786Service(Idea65786Config config) {
        this.config = config != null ? config : new Idea65786Config();
