...
@Data
public class Idea65603Config {
    private String name = "idea_065603";
 ...
 */
@Slf4j
public class Idea65603Service {
    private static final int IDEA_ID = 65603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65603Service() {
        this(new Idea65603Config());
    }

    public Idea65603Service(Idea65603Config config) {
        this.config = config != null ? config : new Idea65603Config();
