...
@Data
public class Idea65665Config {
    private String name = "idea_065665";
 ...
 */
@Slf4j
public class Idea65665Service {
    private static final int IDEA_ID = 65665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65665Service() {
        this(new Idea65665Config());
    }

    public Idea65665Service(Idea65665Config config) {
        this.config = config != null ? config : new Idea65665Config();
