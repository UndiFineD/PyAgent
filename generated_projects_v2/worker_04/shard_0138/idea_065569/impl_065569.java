...
@Data
public class Idea65569Config {
    private String name = "idea_065569";
 ...
 */
@Slf4j
public class Idea65569Service {
    private static final int IDEA_ID = 65569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65569Service() {
        this(new Idea65569Config());
    }

    public Idea65569Service(Idea65569Config config) {
        this.config = config != null ? config : new Idea65569Config();
