...
@Data
public class Idea66005Config {
    private String name = "idea_066005";
 ...
 */
@Slf4j
public class Idea66005Service {
    private static final int IDEA_ID = 66005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66005Service() {
        this(new Idea66005Config());
    }

    public Idea66005Service(Idea66005Config config) {
        this.config = config != null ? config : new Idea66005Config();
