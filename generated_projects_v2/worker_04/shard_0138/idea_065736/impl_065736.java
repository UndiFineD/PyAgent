...
@Data
public class Idea65736Config {
    private String name = "idea_065736";
 ...
 */
@Slf4j
public class Idea65736Service {
    private static final int IDEA_ID = 65736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65736Service() {
        this(new Idea65736Config());
    }

    public Idea65736Service(Idea65736Config config) {
        this.config = config != null ? config : new Idea65736Config();
