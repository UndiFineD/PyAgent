...
@Data
public class Idea65996Config {
    private String name = "idea_065996";
 ...
 */
@Slf4j
public class Idea65996Service {
    private static final int IDEA_ID = 65996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65996Service() {
        this(new Idea65996Config());
    }

    public Idea65996Service(Idea65996Config config) {
        this.config = config != null ? config : new Idea65996Config();
