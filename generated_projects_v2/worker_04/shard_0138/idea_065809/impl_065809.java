...
@Data
public class Idea65809Config {
    private String name = "idea_065809";
 ...
 */
@Slf4j
public class Idea65809Service {
    private static final int IDEA_ID = 65809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65809Service() {
        this(new Idea65809Config());
    }

    public Idea65809Service(Idea65809Config config) {
        this.config = config != null ? config : new Idea65809Config();
