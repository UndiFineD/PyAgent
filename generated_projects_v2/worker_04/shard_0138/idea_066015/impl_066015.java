...
@Data
public class Idea66015Config {
    private String name = "idea_066015";
 ...
 */
@Slf4j
public class Idea66015Service {
    private static final int IDEA_ID = 66015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66015Service() {
        this(new Idea66015Config());
    }

    public Idea66015Service(Idea66015Config config) {
        this.config = config != null ? config : new Idea66015Config();
