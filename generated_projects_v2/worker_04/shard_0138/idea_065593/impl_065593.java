...
@Data
public class Idea65593Config {
    private String name = "idea_065593";
 ...
 */
@Slf4j
public class Idea65593Service {
    private static final int IDEA_ID = 65593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65593Service() {
        this(new Idea65593Config());
    }

    public Idea65593Service(Idea65593Config config) {
        this.config = config != null ? config : new Idea65593Config();
