...
@Data
public class Idea65790Config {
    private String name = "idea_065790";
 ...
 */
@Slf4j
public class Idea65790Service {
    private static final int IDEA_ID = 65790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65790Service() {
        this(new Idea65790Config());
    }

    public Idea65790Service(Idea65790Config config) {
        this.config = config != null ? config : new Idea65790Config();
