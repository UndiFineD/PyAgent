...
@Data
public class Idea65559Config {
    private String name = "idea_065559";
 ...
 */
@Slf4j
public class Idea65559Service {
    private static final int IDEA_ID = 65559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65559Service() {
        this(new Idea65559Config());
    }

    public Idea65559Service(Idea65559Config config) {
        this.config = config != null ? config : new Idea65559Config();
