...
@Data
public class Idea65806Config {
    private String name = "idea_065806";
 ...
 */
@Slf4j
public class Idea65806Service {
    private static final int IDEA_ID = 65806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65806Service() {
        this(new Idea65806Config());
    }

    public Idea65806Service(Idea65806Config config) {
        this.config = config != null ? config : new Idea65806Config();
