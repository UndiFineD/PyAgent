...
@Data
public class Idea65656Config {
    private String name = "idea_065656";
 ...
 */
@Slf4j
public class Idea65656Service {
    private static final int IDEA_ID = 65656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65656Service() {
        this(new Idea65656Config());
    }

    public Idea65656Service(Idea65656Config config) {
        this.config = config != null ? config : new Idea65656Config();
