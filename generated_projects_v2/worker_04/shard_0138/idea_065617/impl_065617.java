...
@Data
public class Idea65617Config {
    private String name = "idea_065617";
 ...
 */
@Slf4j
public class Idea65617Service {
    private static final int IDEA_ID = 65617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65617Service() {
        this(new Idea65617Config());
    }

    public Idea65617Service(Idea65617Config config) {
        this.config = config != null ? config : new Idea65617Config();
