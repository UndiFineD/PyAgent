...
@Data
public class Idea65974Config {
    private String name = "idea_065974";
 ...
 */
@Slf4j
public class Idea65974Service {
    private static final int IDEA_ID = 65974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65974Service() {
        this(new Idea65974Config());
    }

    public Idea65974Service(Idea65974Config config) {
        this.config = config != null ? config : new Idea65974Config();
