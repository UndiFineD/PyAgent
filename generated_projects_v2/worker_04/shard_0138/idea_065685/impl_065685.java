...
@Data
public class Idea65685Config {
    private String name = "idea_065685";
 ...
 */
@Slf4j
public class Idea65685Service {
    private static final int IDEA_ID = 65685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65685Service() {
        this(new Idea65685Config());
    }

    public Idea65685Service(Idea65685Config config) {
        this.config = config != null ? config : new Idea65685Config();
