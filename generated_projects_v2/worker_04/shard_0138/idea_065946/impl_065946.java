...
@Data
public class Idea65946Config {
    private String name = "idea_065946";
 ...
 */
@Slf4j
public class Idea65946Service {
    private static final int IDEA_ID = 65946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65946Service() {
        this(new Idea65946Config());
    }

    public Idea65946Service(Idea65946Config config) {
        this.config = config != null ? config : new Idea65946Config();
