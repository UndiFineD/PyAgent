...
@Data
public class Idea65670Config {
    private String name = "idea_065670";
 ...
 */
@Slf4j
public class Idea65670Service {
    private static final int IDEA_ID = 65670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65670Service() {
        this(new Idea65670Config());
    }

    public Idea65670Service(Idea65670Config config) {
        this.config = config != null ? config : new Idea65670Config();
