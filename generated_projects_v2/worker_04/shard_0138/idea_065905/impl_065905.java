...
@Data
public class Idea65905Config {
    private String name = "idea_065905";
 ...
 */
@Slf4j
public class Idea65905Service {
    private static final int IDEA_ID = 65905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65905Service() {
        this(new Idea65905Config());
    }

    public Idea65905Service(Idea65905Config config) {
        this.config = config != null ? config : new Idea65905Config();
