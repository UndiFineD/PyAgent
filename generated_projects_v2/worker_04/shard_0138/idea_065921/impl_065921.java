...
@Data
public class Idea65921Config {
    private String name = "idea_065921";
 ...
 */
@Slf4j
public class Idea65921Service {
    private static final int IDEA_ID = 65921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65921Service() {
        this(new Idea65921Config());
    }

    public Idea65921Service(Idea65921Config config) {
        this.config = config != null ? config : new Idea65921Config();
