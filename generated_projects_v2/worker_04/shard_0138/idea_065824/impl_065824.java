...
@Data
public class Idea65824Config {
    private String name = "idea_065824";
 ...
 */
@Slf4j
public class Idea65824Service {
    private static final int IDEA_ID = 65824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65824Service() {
        this(new Idea65824Config());
    }

    public Idea65824Service(Idea65824Config config) {
        this.config = config != null ? config : new Idea65824Config();
