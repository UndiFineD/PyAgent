...
@Data
public class Idea65982Config {
    private String name = "idea_065982";
 ...
 */
@Slf4j
public class Idea65982Service {
    private static final int IDEA_ID = 65982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65982Service() {
        this(new Idea65982Config());
    }

    public Idea65982Service(Idea65982Config config) {
        this.config = config != null ? config : new Idea65982Config();
