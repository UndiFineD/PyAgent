...
@Data
public class Idea65752Config {
    private String name = "idea_065752";
 ...
 */
@Slf4j
public class Idea65752Service {
    private static final int IDEA_ID = 65752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65752Service() {
        this(new Idea65752Config());
    }

    public Idea65752Service(Idea65752Config config) {
        this.config = config != null ? config : new Idea65752Config();
