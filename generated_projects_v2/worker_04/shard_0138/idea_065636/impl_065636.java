...
@Data
public class Idea65636Config {
    private String name = "idea_065636";
 ...
 */
@Slf4j
public class Idea65636Service {
    private static final int IDEA_ID = 65636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65636Service() {
        this(new Idea65636Config());
    }

    public Idea65636Service(Idea65636Config config) {
        this.config = config != null ? config : new Idea65636Config();
