...
@Data
public class Idea66006Config {
    private String name = "idea_066006";
 ...
 */
@Slf4j
public class Idea66006Service {
    private static final int IDEA_ID = 66006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66006Service() {
        this(new Idea66006Config());
    }

    public Idea66006Service(Idea66006Config config) {
        this.config = config != null ? config : new Idea66006Config();
