...
@Data
public class Idea65873Config {
    private String name = "idea_065873";
 ...
 */
@Slf4j
public class Idea65873Service {
    private static final int IDEA_ID = 65873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65873Service() {
        this(new Idea65873Config());
    }

    public Idea65873Service(Idea65873Config config) {
        this.config = config != null ? config : new Idea65873Config();
