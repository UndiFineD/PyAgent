...
@Data
public class Idea65720Config {
    private String name = "idea_065720";
 ...
 */
@Slf4j
public class Idea65720Service {
    private static final int IDEA_ID = 65720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65720Service() {
        this(new Idea65720Config());
    }

    public Idea65720Service(Idea65720Config config) {
        this.config = config != null ? config : new Idea65720Config();
