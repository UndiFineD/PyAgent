...
@Data
public class Idea65999Config {
    private String name = "idea_065999";
 ...
 */
@Slf4j
public class Idea65999Service {
    private static final int IDEA_ID = 65999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65999Service() {
        this(new Idea65999Config());
    }

    public Idea65999Service(Idea65999Config config) {
        this.config = config != null ? config : new Idea65999Config();
