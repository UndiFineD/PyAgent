...
@Data
public class Idea65935Config {
    private String name = "idea_065935";
 ...
 */
@Slf4j
public class Idea65935Service {
    private static final int IDEA_ID = 65935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65935Service() {
        this(new Idea65935Config());
    }

    public Idea65935Service(Idea65935Config config) {
        this.config = config != null ? config : new Idea65935Config();
