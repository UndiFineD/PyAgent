...
@Data
public class Idea65623Config {
    private String name = "idea_065623";
 ...
 */
@Slf4j
public class Idea65623Service {
    private static final int IDEA_ID = 65623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65623Service() {
        this(new Idea65623Config());
    }

    public Idea65623Service(Idea65623Config config) {
        this.config = config != null ? config : new Idea65623Config();
