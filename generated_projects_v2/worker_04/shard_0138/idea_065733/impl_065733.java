...
@Data
public class Idea65733Config {
    private String name = "idea_065733";
 ...
 */
@Slf4j
public class Idea65733Service {
    private static final int IDEA_ID = 65733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65733Service() {
        this(new Idea65733Config());
    }

    public Idea65733Service(Idea65733Config config) {
        this.config = config != null ? config : new Idea65733Config();
