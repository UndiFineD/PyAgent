...
@Data
public class Idea65960Config {
    private String name = "idea_065960";
 ...
 */
@Slf4j
public class Idea65960Service {
    private static final int IDEA_ID = 65960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65960Service() {
        this(new Idea65960Config());
    }

    public Idea65960Service(Idea65960Config config) {
        this.config = config != null ? config : new Idea65960Config();
