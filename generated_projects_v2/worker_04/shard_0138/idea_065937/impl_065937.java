...
@Data
public class Idea65937Config {
    private String name = "idea_065937";
 ...
 */
@Slf4j
public class Idea65937Service {
    private static final int IDEA_ID = 65937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65937Service() {
        this(new Idea65937Config());
    }

    public Idea65937Service(Idea65937Config config) {
        this.config = config != null ? config : new Idea65937Config();
