...
@Data
public class Idea66008Config {
    private String name = "idea_066008";
 ...
 */
@Slf4j
public class Idea66008Service {
    private static final int IDEA_ID = 66008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66008Service() {
        this(new Idea66008Config());
    }

    public Idea66008Service(Idea66008Config config) {
        this.config = config != null ? config : new Idea66008Config();
