...
@Data
public class Idea65667Config {
    private String name = "idea_065667";
 ...
 */
@Slf4j
public class Idea65667Service {
    private static final int IDEA_ID = 65667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65667Service() {
        this(new Idea65667Config());
    }

    public Idea65667Service(Idea65667Config config) {
        this.config = config != null ? config : new Idea65667Config();
