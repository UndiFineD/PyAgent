...
@Data
public class Idea65571Config {
    private String name = "idea_065571";
 ...
 */
@Slf4j
public class Idea65571Service {
    private static final int IDEA_ID = 65571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65571Service() {
        this(new Idea65571Config());
    }

    public Idea65571Service(Idea65571Config config) {
        this.config = config != null ? config : new Idea65571Config();
