...
@Data
public class Idea65723Config {
    private String name = "idea_065723";
 ...
 */
@Slf4j
public class Idea65723Service {
    private static final int IDEA_ID = 65723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65723Service() {
        this(new Idea65723Config());
    }

    public Idea65723Service(Idea65723Config config) {
        this.config = config != null ? config : new Idea65723Config();
