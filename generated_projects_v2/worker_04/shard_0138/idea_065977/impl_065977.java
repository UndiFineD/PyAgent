...
@Data
public class Idea65977Config {
    private String name = "idea_065977";
 ...
 */
@Slf4j
public class Idea65977Service {
    private static final int IDEA_ID = 65977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65977Service() {
        this(new Idea65977Config());
    }

    public Idea65977Service(Idea65977Config config) {
        this.config = config != null ? config : new Idea65977Config();
