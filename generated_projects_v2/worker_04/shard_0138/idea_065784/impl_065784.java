...
@Data
public class Idea65784Config {
    private String name = "idea_065784";
 ...
 */
@Slf4j
public class Idea65784Service {
    private static final int IDEA_ID = 65784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65784Service() {
        this(new Idea65784Config());
    }

    public Idea65784Service(Idea65784Config config) {
        this.config = config != null ? config : new Idea65784Config();
