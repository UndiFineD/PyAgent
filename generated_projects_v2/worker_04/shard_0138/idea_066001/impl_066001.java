...
@Data
public class Idea66001Config {
    private String name = "idea_066001";
 ...
 */
@Slf4j
public class Idea66001Service {
    private static final int IDEA_ID = 66001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66001Service() {
        this(new Idea66001Config());
    }

    public Idea66001Service(Idea66001Config config) {
        this.config = config != null ? config : new Idea66001Config();
