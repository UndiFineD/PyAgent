...
@Data
public class Idea65560Config {
    private String name = "idea_065560";
 ...
 */
@Slf4j
public class Idea65560Service {
    private static final int IDEA_ID = 65560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65560Service() {
        this(new Idea65560Config());
    }

    public Idea65560Service(Idea65560Config config) {
        this.config = config != null ? config : new Idea65560Config();
