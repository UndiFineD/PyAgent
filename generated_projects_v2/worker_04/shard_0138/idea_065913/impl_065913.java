...
@Data
public class Idea65913Config {
    private String name = "idea_065913";
 ...
 */
@Slf4j
public class Idea65913Service {
    private static final int IDEA_ID = 65913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65913Service() {
        this(new Idea65913Config());
    }

    public Idea65913Service(Idea65913Config config) {
        this.config = config != null ? config : new Idea65913Config();
