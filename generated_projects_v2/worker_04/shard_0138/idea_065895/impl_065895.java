...
@Data
public class Idea65895Config {
    private String name = "idea_065895";
 ...
 */
@Slf4j
public class Idea65895Service {
    private static final int IDEA_ID = 65895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65895Service() {
        this(new Idea65895Config());
    }

    public Idea65895Service(Idea65895Config config) {
        this.config = config != null ? config : new Idea65895Config();
