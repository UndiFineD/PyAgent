...
@Data
public class Idea66018Config {
    private String name = "idea_066018";
 ...
 */
@Slf4j
public class Idea66018Service {
    private static final int IDEA_ID = 66018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66018Service() {
        this(new Idea66018Config());
    }

    public Idea66018Service(Idea66018Config config) {
        this.config = config != null ? config : new Idea66018Config();
