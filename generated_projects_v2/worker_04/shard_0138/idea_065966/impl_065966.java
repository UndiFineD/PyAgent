...
@Data
public class Idea65966Config {
    private String name = "idea_065966";
 ...
 */
@Slf4j
public class Idea65966Service {
    private static final int IDEA_ID = 65966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65966Service() {
        this(new Idea65966Config());
    }

    public Idea65966Service(Idea65966Config config) {
        this.config = config != null ? config : new Idea65966Config();
