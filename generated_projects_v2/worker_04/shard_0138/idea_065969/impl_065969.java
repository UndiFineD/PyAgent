...
@Data
public class Idea65969Config {
    private String name = "idea_065969";
 ...
 */
@Slf4j
public class Idea65969Service {
    private static final int IDEA_ID = 65969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65969Service() {
        this(new Idea65969Config());
    }

    public Idea65969Service(Idea65969Config config) {
        this.config = config != null ? config : new Idea65969Config();
