...
@Data
public class Idea65705Config {
    private String name = "idea_065705";
 ...
 */
@Slf4j
public class Idea65705Service {
    private static final int IDEA_ID = 65705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65705Service() {
        this(new Idea65705Config());
    }

    public Idea65705Service(Idea65705Config config) {
        this.config = config != null ? config : new Idea65705Config();
