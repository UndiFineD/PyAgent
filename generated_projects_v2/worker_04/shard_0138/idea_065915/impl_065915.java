...
@Data
public class Idea65915Config {
    private String name = "idea_065915";
 ...
 */
@Slf4j
public class Idea65915Service {
    private static final int IDEA_ID = 65915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65915Service() {
        this(new Idea65915Config());
    }

    public Idea65915Service(Idea65915Config config) {
        this.config = config != null ? config : new Idea65915Config();
