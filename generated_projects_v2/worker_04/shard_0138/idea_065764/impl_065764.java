...
@Data
public class Idea65764Config {
    private String name = "idea_065764";
 ...
 */
@Slf4j
public class Idea65764Service {
    private static final int IDEA_ID = 65764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65764Service() {
        this(new Idea65764Config());
    }

    public Idea65764Service(Idea65764Config config) {
        this.config = config != null ? config : new Idea65764Config();
