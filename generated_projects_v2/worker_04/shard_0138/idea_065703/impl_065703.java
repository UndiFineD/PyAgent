...
@Data
public class Idea65703Config {
    private String name = "idea_065703";
 ...
 */
@Slf4j
public class Idea65703Service {
    private static final int IDEA_ID = 65703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65703Service() {
        this(new Idea65703Config());
    }

    public Idea65703Service(Idea65703Config config) {
        this.config = config != null ? config : new Idea65703Config();
