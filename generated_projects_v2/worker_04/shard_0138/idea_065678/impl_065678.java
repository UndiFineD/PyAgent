...
@Data
public class Idea65678Config {
    private String name = "idea_065678";
 ...
 */
@Slf4j
public class Idea65678Service {
    private static final int IDEA_ID = 65678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65678Service() {
        this(new Idea65678Config());
    }

    public Idea65678Service(Idea65678Config config) {
        this.config = config != null ? config : new Idea65678Config();
