...
@Data
public class Idea65875Config {
    private String name = "idea_065875";
 ...
 */
@Slf4j
public class Idea65875Service {
    private static final int IDEA_ID = 65875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65875Service() {
        this(new Idea65875Config());
    }

    public Idea65875Service(Idea65875Config config) {
        this.config = config != null ? config : new Idea65875Config();
