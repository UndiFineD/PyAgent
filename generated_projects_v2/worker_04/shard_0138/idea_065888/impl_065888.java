...
@Data
public class Idea65888Config {
    private String name = "idea_065888";
 ...
 */
@Slf4j
public class Idea65888Service {
    private static final int IDEA_ID = 65888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65888Service() {
        this(new Idea65888Config());
    }

    public Idea65888Service(Idea65888Config config) {
        this.config = config != null ? config : new Idea65888Config();
