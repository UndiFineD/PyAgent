...
@Data
public class Idea65844Config {
    private String name = "idea_065844";
 ...
 */
@Slf4j
public class Idea65844Service {
    private static final int IDEA_ID = 65844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65844Service() {
        this(new Idea65844Config());
    }

    public Idea65844Service(Idea65844Config config) {
        this.config = config != null ? config : new Idea65844Config();
