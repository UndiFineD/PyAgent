...
@Data
public class Idea65943Config {
    private String name = "idea_065943";
 ...
 */
@Slf4j
public class Idea65943Service {
    private static final int IDEA_ID = 65943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65943Service() {
        this(new Idea65943Config());
    }

    public Idea65943Service(Idea65943Config config) {
        this.config = config != null ? config : new Idea65943Config();
