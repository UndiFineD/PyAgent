...
@Data
public class Idea65963Config {
    private String name = "idea_065963";
 ...
 */
@Slf4j
public class Idea65963Service {
    private static final int IDEA_ID = 65963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65963Service() {
        this(new Idea65963Config());
    }

    public Idea65963Service(Idea65963Config config) {
        this.config = config != null ? config : new Idea65963Config();
