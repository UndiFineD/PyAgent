...
@Data
public class Idea65765Config {
    private String name = "idea_065765";
 ...
 */
@Slf4j
public class Idea65765Service {
    private static final int IDEA_ID = 65765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65765Service() {
        this(new Idea65765Config());
    }

    public Idea65765Service(Idea65765Config config) {
        this.config = config != null ? config : new Idea65765Config();
