...
@Data
public class Idea65741Config {
    private String name = "idea_065741";
 ...
 */
@Slf4j
public class Idea65741Service {
    private static final int IDEA_ID = 65741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65741Service() {
        this(new Idea65741Config());
    }

    public Idea65741Service(Idea65741Config config) {
        this.config = config != null ? config : new Idea65741Config();
