...
@Data
public class Idea65945Config {
    private String name = "idea_065945";
 ...
 */
@Slf4j
public class Idea65945Service {
    private static final int IDEA_ID = 65945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65945Service() {
        this(new Idea65945Config());
    }

    public Idea65945Service(Idea65945Config config) {
        this.config = config != null ? config : new Idea65945Config();
