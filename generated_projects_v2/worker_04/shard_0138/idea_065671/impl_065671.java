...
@Data
public class Idea65671Config {
    private String name = "idea_065671";
 ...
 */
@Slf4j
public class Idea65671Service {
    private static final int IDEA_ID = 65671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65671Service() {
        this(new Idea65671Config());
    }

    public Idea65671Service(Idea65671Config config) {
        this.config = config != null ? config : new Idea65671Config();
