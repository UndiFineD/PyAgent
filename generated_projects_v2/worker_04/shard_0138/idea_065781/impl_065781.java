...
@Data
public class Idea65781Config {
    private String name = "idea_065781";
 ...
 */
@Slf4j
public class Idea65781Service {
    private static final int IDEA_ID = 65781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65781Service() {
        this(new Idea65781Config());
    }

    public Idea65781Service(Idea65781Config config) {
        this.config = config != null ? config : new Idea65781Config();
