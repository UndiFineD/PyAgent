...
@Data
public class Idea65777Config {
    private String name = "idea_065777";
 ...
 */
@Slf4j
public class Idea65777Service {
    private static final int IDEA_ID = 65777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65777Service() {
        this(new Idea65777Config());
    }

    public Idea65777Service(Idea65777Config config) {
        this.config = config != null ? config : new Idea65777Config();
