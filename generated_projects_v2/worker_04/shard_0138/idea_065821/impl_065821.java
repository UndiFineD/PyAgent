...
@Data
public class Idea65821Config {
    private String name = "idea_065821";
 ...
 */
@Slf4j
public class Idea65821Service {
    private static final int IDEA_ID = 65821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65821Service() {
        this(new Idea65821Config());
    }

    public Idea65821Service(Idea65821Config config) {
        this.config = config != null ? config : new Idea65821Config();
