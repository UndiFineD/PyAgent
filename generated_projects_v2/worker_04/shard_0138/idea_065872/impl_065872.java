...
@Data
public class Idea65872Config {
    private String name = "idea_065872";
 ...
 */
@Slf4j
public class Idea65872Service {
    private static final int IDEA_ID = 65872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65872Service() {
        this(new Idea65872Config());
    }

    public Idea65872Service(Idea65872Config config) {
        this.config = config != null ? config : new Idea65872Config();
