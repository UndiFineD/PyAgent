...
@Data
public class Idea65659Config {
    private String name = "idea_065659";
 ...
 */
@Slf4j
public class Idea65659Service {
    private static final int IDEA_ID = 65659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65659Service() {
        this(new Idea65659Config());
    }

    public Idea65659Service(Idea65659Config config) {
        this.config = config != null ? config : new Idea65659Config();
