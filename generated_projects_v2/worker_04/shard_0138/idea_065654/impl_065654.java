...
@Data
public class Idea65654Config {
    private String name = "idea_065654";
 ...
 */
@Slf4j
public class Idea65654Service {
    private static final int IDEA_ID = 65654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65654Service() {
        this(new Idea65654Config());
    }

    public Idea65654Service(Idea65654Config config) {
        this.config = config != null ? config : new Idea65654Config();
