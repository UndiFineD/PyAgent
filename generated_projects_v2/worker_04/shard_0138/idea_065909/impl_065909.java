...
@Data
public class Idea65909Config {
    private String name = "idea_065909";
 ...
 */
@Slf4j
public class Idea65909Service {
    private static final int IDEA_ID = 65909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65909Service() {
        this(new Idea65909Config());
    }

    public Idea65909Service(Idea65909Config config) {
        this.config = config != null ? config : new Idea65909Config();
