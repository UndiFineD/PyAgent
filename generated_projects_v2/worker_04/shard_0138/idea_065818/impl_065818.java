...
@Data
public class Idea65818Config {
    private String name = "idea_065818";
 ...
 */
@Slf4j
public class Idea65818Service {
    private static final int IDEA_ID = 65818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65818Service() {
        this(new Idea65818Config());
    }

    public Idea65818Service(Idea65818Config config) {
        this.config = config != null ? config : new Idea65818Config();
