...
@Data
public class Idea65866Config {
    private String name = "idea_065866";
 ...
 */
@Slf4j
public class Idea65866Service {
    private static final int IDEA_ID = 65866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65866Service() {
        this(new Idea65866Config());
    }

    public Idea65866Service(Idea65866Config config) {
        this.config = config != null ? config : new Idea65866Config();
