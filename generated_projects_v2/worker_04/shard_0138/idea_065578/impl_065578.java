...
@Data
public class Idea65578Config {
    private String name = "idea_065578";
 ...
 */
@Slf4j
public class Idea65578Service {
    private static final int IDEA_ID = 65578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65578Service() {
        this(new Idea65578Config());
    }

    public Idea65578Service(Idea65578Config config) {
        this.config = config != null ? config : new Idea65578Config();
