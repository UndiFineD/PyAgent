...
@Data
public class Idea65761Config {
    private String name = "idea_065761";
 ...
 */
@Slf4j
public class Idea65761Service {
    private static final int IDEA_ID = 65761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65761Service() {
        this(new Idea65761Config());
    }

    public Idea65761Service(Idea65761Config config) {
        this.config = config != null ? config : new Idea65761Config();
