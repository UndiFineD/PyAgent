...
@Data
public class Idea65811Config {
    private String name = "idea_065811";
 ...
 */
@Slf4j
public class Idea65811Service {
    private static final int IDEA_ID = 65811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65811Service() {
        this(new Idea65811Config());
    }

    public Idea65811Service(Idea65811Config config) {
        this.config = config != null ? config : new Idea65811Config();
