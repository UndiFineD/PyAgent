...
@Data
public class Idea65753Config {
    private String name = "idea_065753";
 ...
 */
@Slf4j
public class Idea65753Service {
    private static final int IDEA_ID = 65753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65753Service() {
        this(new Idea65753Config());
    }

    public Idea65753Service(Idea65753Config config) {
        this.config = config != null ? config : new Idea65753Config();
