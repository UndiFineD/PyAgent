...
@Data
public class Idea65991Config {
    private String name = "idea_065991";
 ...
 */
@Slf4j
public class Idea65991Service {
    private static final int IDEA_ID = 65991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65991Service() {
        this(new Idea65991Config());
    }

    public Idea65991Service(Idea65991Config config) {
        this.config = config != null ? config : new Idea65991Config();
