...
@Data
public class Idea65975Config {
    private String name = "idea_065975";
 ...
 */
@Slf4j
public class Idea65975Service {
    private static final int IDEA_ID = 65975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65975Service() {
        this(new Idea65975Config());
    }

    public Idea65975Service(Idea65975Config config) {
        this.config = config != null ? config : new Idea65975Config();
