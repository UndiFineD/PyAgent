...
@Data
public class Idea65583Config {
    private String name = "idea_065583";
 ...
 */
@Slf4j
public class Idea65583Service {
    private static final int IDEA_ID = 65583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65583Service() {
        this(new Idea65583Config());
    }

    public Idea65583Service(Idea65583Config config) {
        this.config = config != null ? config : new Idea65583Config();
