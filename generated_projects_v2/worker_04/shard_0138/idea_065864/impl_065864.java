...
@Data
public class Idea65864Config {
    private String name = "idea_065864";
 ...
 */
@Slf4j
public class Idea65864Service {
    private static final int IDEA_ID = 65864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65864Service() {
        this(new Idea65864Config());
    }

    public Idea65864Service(Idea65864Config config) {
        this.config = config != null ? config : new Idea65864Config();
