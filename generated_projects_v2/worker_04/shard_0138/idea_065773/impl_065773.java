...
@Data
public class Idea65773Config {
    private String name = "idea_065773";
 ...
 */
@Slf4j
public class Idea65773Service {
    private static final int IDEA_ID = 65773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65773Service() {
        this(new Idea65773Config());
    }

    public Idea65773Service(Idea65773Config config) {
        this.config = config != null ? config : new Idea65773Config();
