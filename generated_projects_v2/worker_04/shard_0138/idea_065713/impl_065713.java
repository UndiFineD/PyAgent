...
@Data
public class Idea65713Config {
    private String name = "idea_065713";
 ...
 */
@Slf4j
public class Idea65713Service {
    private static final int IDEA_ID = 65713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65713Service() {
        this(new Idea65713Config());
    }

    public Idea65713Service(Idea65713Config config) {
        this.config = config != null ? config : new Idea65713Config();
