...
@Data
public class Idea65580Config {
    private String name = "idea_065580";
 ...
 */
@Slf4j
public class Idea65580Service {
    private static final int IDEA_ID = 65580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65580Service() {
        this(new Idea65580Config());
    }

    public Idea65580Service(Idea65580Config config) {
        this.config = config != null ? config : new Idea65580Config();
