...
@Data
public class Idea65567Config {
    private String name = "idea_065567";
 ...
 */
@Slf4j
public class Idea65567Service {
    private static final int IDEA_ID = 65567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65567Service() {
        this(new Idea65567Config());
    }

    public Idea65567Service(Idea65567Config config) {
        this.config = config != null ? config : new Idea65567Config();
