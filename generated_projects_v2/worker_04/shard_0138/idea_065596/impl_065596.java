...
@Data
public class Idea65596Config {
    private String name = "idea_065596";
 ...
 */
@Slf4j
public class Idea65596Service {
    private static final int IDEA_ID = 65596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65596Service() {
        this(new Idea65596Config());
    }

    public Idea65596Service(Idea65596Config config) {
        this.config = config != null ? config : new Idea65596Config();
