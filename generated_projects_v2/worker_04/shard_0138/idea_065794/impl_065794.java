...
@Data
public class Idea65794Config {
    private String name = "idea_065794";
 ...
 */
@Slf4j
public class Idea65794Service {
    private static final int IDEA_ID = 65794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65794Service() {
        this(new Idea65794Config());
    }

    public Idea65794Service(Idea65794Config config) {
        this.config = config != null ? config : new Idea65794Config();
