...
@Data
public class Idea65854Config {
    private String name = "idea_065854";
 ...
 */
@Slf4j
public class Idea65854Service {
    private static final int IDEA_ID = 65854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65854Service() {
        this(new Idea65854Config());
    }

    public Idea65854Service(Idea65854Config config) {
        this.config = config != null ? config : new Idea65854Config();
