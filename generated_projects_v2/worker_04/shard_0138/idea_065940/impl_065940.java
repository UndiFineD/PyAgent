...
@Data
public class Idea65940Config {
    private String name = "idea_065940";
 ...
 */
@Slf4j
public class Idea65940Service {
    private static final int IDEA_ID = 65940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65940Service() {
        this(new Idea65940Config());
    }

    public Idea65940Service(Idea65940Config config) {
        this.config = config != null ? config : new Idea65940Config();
