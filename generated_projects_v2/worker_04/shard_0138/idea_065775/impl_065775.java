...
@Data
public class Idea65775Config {
    private String name = "idea_065775";
 ...
 */
@Slf4j
public class Idea65775Service {
    private static final int IDEA_ID = 65775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65775Service() {
        this(new Idea65775Config());
    }

    public Idea65775Service(Idea65775Config config) {
        this.config = config != null ? config : new Idea65775Config();
