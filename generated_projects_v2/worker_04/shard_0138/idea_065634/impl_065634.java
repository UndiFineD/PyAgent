...
@Data
public class Idea65634Config {
    private String name = "idea_065634";
 ...
 */
@Slf4j
public class Idea65634Service {
    private static final int IDEA_ID = 65634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65634Service() {
        this(new Idea65634Config());
    }

    public Idea65634Service(Idea65634Config config) {
        this.config = config != null ? config : new Idea65634Config();
