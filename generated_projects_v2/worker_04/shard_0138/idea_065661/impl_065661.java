...
@Data
public class Idea65661Config {
    private String name = "idea_065661";
 ...
 */
@Slf4j
public class Idea65661Service {
    private static final int IDEA_ID = 65661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65661Service() {
        this(new Idea65661Config());
    }

    public Idea65661Service(Idea65661Config config) {
        this.config = config != null ? config : new Idea65661Config();
