...
@Data
public class Idea65744Config {
    private String name = "idea_065744";
 ...
 */
@Slf4j
public class Idea65744Service {
    private static final int IDEA_ID = 65744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65744Service() {
        this(new Idea65744Config());
    }

    public Idea65744Service(Idea65744Config config) {
        this.config = config != null ? config : new Idea65744Config();
