...
@Data
public class Idea65837Config {
    private String name = "idea_065837";
 ...
 */
@Slf4j
public class Idea65837Service {
    private static final int IDEA_ID = 65837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65837Service() {
        this(new Idea65837Config());
    }

    public Idea65837Service(Idea65837Config config) {
        this.config = config != null ? config : new Idea65837Config();
