...
@Data
public class Idea65939Config {
    private String name = "idea_065939";
 ...
 */
@Slf4j
public class Idea65939Service {
    private static final int IDEA_ID = 65939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65939Service() {
        this(new Idea65939Config());
    }

    public Idea65939Service(Idea65939Config config) {
        this.config = config != null ? config : new Idea65939Config();
