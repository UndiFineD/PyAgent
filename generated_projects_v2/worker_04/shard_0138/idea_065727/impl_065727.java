...
@Data
public class Idea65727Config {
    private String name = "idea_065727";
 ...
 */
@Slf4j
public class Idea65727Service {
    private static final int IDEA_ID = 65727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65727Service() {
        this(new Idea65727Config());
    }

    public Idea65727Service(Idea65727Config config) {
        this.config = config != null ? config : new Idea65727Config();
