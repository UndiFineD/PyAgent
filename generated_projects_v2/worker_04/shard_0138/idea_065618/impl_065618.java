...
@Data
public class Idea65618Config {
    private String name = "idea_065618";
 ...
 */
@Slf4j
public class Idea65618Service {
    private static final int IDEA_ID = 65618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65618Service() {
        this(new Idea65618Config());
    }

    public Idea65618Service(Idea65618Config config) {
        this.config = config != null ? config : new Idea65618Config();
