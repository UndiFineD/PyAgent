...
@Data
public class Idea66003Config {
    private String name = "idea_066003";
 ...
 */
@Slf4j
public class Idea66003Service {
    private static final int IDEA_ID = 66003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66003Service() {
        this(new Idea66003Config());
    }

    public Idea66003Service(Idea66003Config config) {
        this.config = config != null ? config : new Idea66003Config();
