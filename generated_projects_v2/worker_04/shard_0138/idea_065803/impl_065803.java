...
@Data
public class Idea65803Config {
    private String name = "idea_065803";
 ...
 */
@Slf4j
public class Idea65803Service {
    private static final int IDEA_ID = 65803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65803Service() {
        this(new Idea65803Config());
    }

    public Idea65803Service(Idea65803Config config) {
        this.config = config != null ? config : new Idea65803Config();
