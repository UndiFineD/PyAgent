...
@Data
public class Idea65881Config {
    private String name = "idea_065881";
 ...
 */
@Slf4j
public class Idea65881Service {
    private static final int IDEA_ID = 65881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65881Service() {
        this(new Idea65881Config());
    }

    public Idea65881Service(Idea65881Config config) {
        this.config = config != null ? config : new Idea65881Config();
