...
@Data
public class Idea65566Config {
    private String name = "idea_065566";
 ...
 */
@Slf4j
public class Idea65566Service {
    private static final int IDEA_ID = 65566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65566Service() {
        this(new Idea65566Config());
    }

    public Idea65566Service(Idea65566Config config) {
        this.config = config != null ? config : new Idea65566Config();
