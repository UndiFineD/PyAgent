...
@Data
public class Idea65568Config {
    private String name = "idea_065568";
 ...
 */
@Slf4j
public class Idea65568Service {
    private static final int IDEA_ID = 65568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65568Service() {
        this(new Idea65568Config());
    }

    public Idea65568Service(Idea65568Config config) {
        this.config = config != null ? config : new Idea65568Config();
