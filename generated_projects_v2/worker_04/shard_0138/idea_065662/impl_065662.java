...
@Data
public class Idea65662Config {
    private String name = "idea_065662";
 ...
 */
@Slf4j
public class Idea65662Service {
    private static final int IDEA_ID = 65662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65662Service() {
        this(new Idea65662Config());
    }

    public Idea65662Service(Idea65662Config config) {
        this.config = config != null ? config : new Idea65662Config();
