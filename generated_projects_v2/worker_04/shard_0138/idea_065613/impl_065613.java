...
@Data
public class Idea65613Config {
    private String name = "idea_065613";
 ...
 */
@Slf4j
public class Idea65613Service {
    private static final int IDEA_ID = 65613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65613Service() {
        this(new Idea65613Config());
    }

    public Idea65613Service(Idea65613Config config) {
        this.config = config != null ? config : new Idea65613Config();
