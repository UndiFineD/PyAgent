...
@Data
public class Idea65947Config {
    private String name = "idea_065947";
 ...
 */
@Slf4j
public class Idea65947Service {
    private static final int IDEA_ID = 65947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65947Service() {
        this(new Idea65947Config());
    }

    public Idea65947Service(Idea65947Config config) {
        this.config = config != null ? config : new Idea65947Config();
