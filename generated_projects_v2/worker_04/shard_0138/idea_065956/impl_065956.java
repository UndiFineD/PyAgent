...
@Data
public class Idea65956Config {
    private String name = "idea_065956";
 ...
 */
@Slf4j
public class Idea65956Service {
    private static final int IDEA_ID = 65956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65956Service() {
        this(new Idea65956Config());
    }

    public Idea65956Service(Idea65956Config config) {
        this.config = config != null ? config : new Idea65956Config();
