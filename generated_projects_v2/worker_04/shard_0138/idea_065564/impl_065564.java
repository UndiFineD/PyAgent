...
@Data
public class Idea65564Config {
    private String name = "idea_065564";
 ...
 */
@Slf4j
public class Idea65564Service {
    private static final int IDEA_ID = 65564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65564Service() {
        this(new Idea65564Config());
    }

    public Idea65564Service(Idea65564Config config) {
        this.config = config != null ? config : new Idea65564Config();
