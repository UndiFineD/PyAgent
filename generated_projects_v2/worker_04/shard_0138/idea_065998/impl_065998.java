...
@Data
public class Idea65998Config {
    private String name = "idea_065998";
 ...
 */
@Slf4j
public class Idea65998Service {
    private static final int IDEA_ID = 65998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65998Service() {
        this(new Idea65998Config());
    }

    public Idea65998Service(Idea65998Config config) {
        this.config = config != null ? config : new Idea65998Config();
