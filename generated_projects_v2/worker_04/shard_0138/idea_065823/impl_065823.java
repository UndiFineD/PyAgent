...
@Data
public class Idea65823Config {
    private String name = "idea_065823";
 ...
 */
@Slf4j
public class Idea65823Service {
    private static final int IDEA_ID = 65823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65823Service() {
        this(new Idea65823Config());
    }

    public Idea65823Service(Idea65823Config config) {
        this.config = config != null ? config : new Idea65823Config();
