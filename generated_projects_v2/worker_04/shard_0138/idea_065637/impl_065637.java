...
@Data
public class Idea65637Config {
    private String name = "idea_065637";
 ...
 */
@Slf4j
public class Idea65637Service {
    private static final int IDEA_ID = 65637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65637Service() {
        this(new Idea65637Config());
    }

    public Idea65637Service(Idea65637Config config) {
        this.config = config != null ? config : new Idea65637Config();
