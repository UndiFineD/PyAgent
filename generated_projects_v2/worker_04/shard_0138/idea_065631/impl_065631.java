...
@Data
public class Idea65631Config {
    private String name = "idea_065631";
 ...
 */
@Slf4j
public class Idea65631Service {
    private static final int IDEA_ID = 65631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65631Service() {
        this(new Idea65631Config());
    }

    public Idea65631Service(Idea65631Config config) {
        this.config = config != null ? config : new Idea65631Config();
