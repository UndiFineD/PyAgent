...
@Data
public class Idea65757Config {
    private String name = "idea_065757";
 ...
 */
@Slf4j
public class Idea65757Service {
    private static final int IDEA_ID = 65757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65757Service() {
        this(new Idea65757Config());
    }

    public Idea65757Service(Idea65757Config config) {
        this.config = config != null ? config : new Idea65757Config();
