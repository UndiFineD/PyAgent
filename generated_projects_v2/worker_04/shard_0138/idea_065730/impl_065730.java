...
@Data
public class Idea65730Config {
    private String name = "idea_065730";
 ...
 */
@Slf4j
public class Idea65730Service {
    private static final int IDEA_ID = 65730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65730Service() {
        this(new Idea65730Config());
    }

    public Idea65730Service(Idea65730Config config) {
        this.config = config != null ? config : new Idea65730Config();
