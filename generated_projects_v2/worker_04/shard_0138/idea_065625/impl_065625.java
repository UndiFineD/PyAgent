...
@Data
public class Idea65625Config {
    private String name = "idea_065625";
 ...
 */
@Slf4j
public class Idea65625Service {
    private static final int IDEA_ID = 65625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65625Service() {
        this(new Idea65625Config());
    }

    public Idea65625Service(Idea65625Config config) {
        this.config = config != null ? config : new Idea65625Config();
