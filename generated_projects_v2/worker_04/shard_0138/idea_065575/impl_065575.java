...
@Data
public class Idea65575Config {
    private String name = "idea_065575";
 ...
 */
@Slf4j
public class Idea65575Service {
    private static final int IDEA_ID = 65575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65575Service() {
        this(new Idea65575Config());
    }

    public Idea65575Service(Idea65575Config config) {
        this.config = config != null ? config : new Idea65575Config();
