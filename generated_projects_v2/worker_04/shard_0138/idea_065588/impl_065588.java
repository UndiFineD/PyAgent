...
@Data
public class Idea65588Config {
    private String name = "idea_065588";
 ...
 */
@Slf4j
public class Idea65588Service {
    private static final int IDEA_ID = 65588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65588Service() {
        this(new Idea65588Config());
    }

    public Idea65588Service(Idea65588Config config) {
        this.config = config != null ? config : new Idea65588Config();
