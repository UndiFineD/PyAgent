...
@Data
public class Idea65751Config {
    private String name = "idea_065751";
 ...
 */
@Slf4j
public class Idea65751Service {
    private static final int IDEA_ID = 65751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65751Service() {
        this(new Idea65751Config());
    }

    public Idea65751Service(Idea65751Config config) {
        this.config = config != null ? config : new Idea65751Config();
