...
@Data
public class Idea65951Config {
    private String name = "idea_065951";
 ...
 */
@Slf4j
public class Idea65951Service {
    private static final int IDEA_ID = 65951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65951Service() {
        this(new Idea65951Config());
    }

    public Idea65951Service(Idea65951Config config) {
        this.config = config != null ? config : new Idea65951Config();
