...
@Data
public class Idea65800Config {
    private String name = "idea_065800";
 ...
 */
@Slf4j
public class Idea65800Service {
    private static final int IDEA_ID = 65800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65800Service() {
        this(new Idea65800Config());
    }

    public Idea65800Service(Idea65800Config config) {
        this.config = config != null ? config : new Idea65800Config();
