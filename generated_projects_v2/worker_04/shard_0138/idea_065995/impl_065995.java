...
@Data
public class Idea65995Config {
    private String name = "idea_065995";
 ...
 */
@Slf4j
public class Idea65995Service {
    private static final int IDEA_ID = 65995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65995Service() {
        this(new Idea65995Config());
    }

    public Idea65995Service(Idea65995Config config) {
        this.config = config != null ? config : new Idea65995Config();
