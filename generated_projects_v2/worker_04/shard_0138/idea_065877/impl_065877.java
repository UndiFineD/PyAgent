...
@Data
public class Idea65877Config {
    private String name = "idea_065877";
 ...
 */
@Slf4j
public class Idea65877Service {
    private static final int IDEA_ID = 65877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65877Service() {
        this(new Idea65877Config());
    }

    public Idea65877Service(Idea65877Config config) {
        this.config = config != null ? config : new Idea65877Config();
