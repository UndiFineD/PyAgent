...
@Data
public class Idea65763Config {
    private String name = "idea_065763";
 ...
 */
@Slf4j
public class Idea65763Service {
    private static final int IDEA_ID = 65763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65763Service() {
        this(new Idea65763Config());
    }

    public Idea65763Service(Idea65763Config config) {
        this.config = config != null ? config : new Idea65763Config();
