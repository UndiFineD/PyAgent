...
@Data
public class Idea65706Config {
    private String name = "idea_065706";
 ...
 */
@Slf4j
public class Idea65706Service {
    private static final int IDEA_ID = 65706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65706Service() {
        this(new Idea65706Config());
    }

    public Idea65706Service(Idea65706Config config) {
        this.config = config != null ? config : new Idea65706Config();
