...
@Data
public class Idea65891Config {
    private String name = "idea_065891";
 ...
 */
@Slf4j
public class Idea65891Service {
    private static final int IDEA_ID = 65891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65891Service() {
        this(new Idea65891Config());
    }

    public Idea65891Service(Idea65891Config config) {
        this.config = config != null ? config : new Idea65891Config();
