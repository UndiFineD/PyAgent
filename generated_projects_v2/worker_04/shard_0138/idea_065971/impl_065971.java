...
@Data
public class Idea65971Config {
    private String name = "idea_065971";
 ...
 */
@Slf4j
public class Idea65971Service {
    private static final int IDEA_ID = 65971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65971Service() {
        this(new Idea65971Config());
    }

    public Idea65971Service(Idea65971Config config) {
        this.config = config != null ? config : new Idea65971Config();
