...
@Data
public class Idea65646Config {
    private String name = "idea_065646";
 ...
 */
@Slf4j
public class Idea65646Service {
    private static final int IDEA_ID = 65646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65646Service() {
        this(new Idea65646Config());
    }

    public Idea65646Service(Idea65646Config config) {
        this.config = config != null ? config : new Idea65646Config();
