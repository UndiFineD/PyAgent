...
@Data
public class Idea65658Config {
    private String name = "idea_065658";
 ...
 */
@Slf4j
public class Idea65658Service {
    private static final int IDEA_ID = 65658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65658Service() {
        this(new Idea65658Config());
    }

    public Idea65658Service(Idea65658Config config) {
        this.config = config != null ? config : new Idea65658Config();
