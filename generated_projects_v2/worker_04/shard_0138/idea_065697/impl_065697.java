...
@Data
public class Idea65697Config {
    private String name = "idea_065697";
 ...
 */
@Slf4j
public class Idea65697Service {
    private static final int IDEA_ID = 65697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65697Service() {
        this(new Idea65697Config());
    }

    public Idea65697Service(Idea65697Config config) {
        this.config = config != null ? config : new Idea65697Config();
