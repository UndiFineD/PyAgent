...
@Data
public class Idea65641Config {
    private String name = "idea_065641";
 ...
 */
@Slf4j
public class Idea65641Service {
    private static final int IDEA_ID = 65641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65641Service() {
        this(new Idea65641Config());
    }

    public Idea65641Service(Idea65641Config config) {
        this.config = config != null ? config : new Idea65641Config();
