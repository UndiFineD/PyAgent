...
@Data
public class Idea65798Config {
    private String name = "idea_065798";
 ...
 */
@Slf4j
public class Idea65798Service {
    private static final int IDEA_ID = 65798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65798Service() {
        this(new Idea65798Config());
    }

    public Idea65798Service(Idea65798Config config) {
        this.config = config != null ? config : new Idea65798Config();
