...
@Data
public class Idea65808Config {
    private String name = "idea_065808";
 ...
 */
@Slf4j
public class Idea65808Service {
    private static final int IDEA_ID = 65808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65808Service() {
        this(new Idea65808Config());
    }

    public Idea65808Service(Idea65808Config config) {
        this.config = config != null ? config : new Idea65808Config();
