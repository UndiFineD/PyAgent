...
@Data
public class Idea65976Config {
    private String name = "idea_065976";
 ...
 */
@Slf4j
public class Idea65976Service {
    private static final int IDEA_ID = 65976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65976Service() {
        this(new Idea65976Config());
    }

    public Idea65976Service(Idea65976Config config) {
        this.config = config != null ? config : new Idea65976Config();
