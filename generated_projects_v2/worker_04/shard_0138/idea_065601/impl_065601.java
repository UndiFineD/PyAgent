...
@Data
public class Idea65601Config {
    private String name = "idea_065601";
 ...
 */
@Slf4j
public class Idea65601Service {
    private static final int IDEA_ID = 65601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65601Service() {
        this(new Idea65601Config());
    }

    public Idea65601Service(Idea65601Config config) {
        this.config = config != null ? config : new Idea65601Config();
