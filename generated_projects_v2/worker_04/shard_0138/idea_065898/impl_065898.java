...
@Data
public class Idea65898Config {
    private String name = "idea_065898";
 ...
 */
@Slf4j
public class Idea65898Service {
    private static final int IDEA_ID = 65898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65898Service() {
        this(new Idea65898Config());
    }

    public Idea65898Service(Idea65898Config config) {
        this.config = config != null ? config : new Idea65898Config();
