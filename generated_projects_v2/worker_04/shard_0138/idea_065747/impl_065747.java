...
@Data
public class Idea65747Config {
    private String name = "idea_065747";
 ...
 */
@Slf4j
public class Idea65747Service {
    private static final int IDEA_ID = 65747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65747Service() {
        this(new Idea65747Config());
    }

    public Idea65747Service(Idea65747Config config) {
        this.config = config != null ? config : new Idea65747Config();
