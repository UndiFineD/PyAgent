...
@Data
public class Idea65572Config {
    private String name = "idea_065572";
 ...
 */
@Slf4j
public class Idea65572Service {
    private static final int IDEA_ID = 65572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65572Service() {
        this(new Idea65572Config());
    }

    public Idea65572Service(Idea65572Config config) {
        this.config = config != null ? config : new Idea65572Config();
