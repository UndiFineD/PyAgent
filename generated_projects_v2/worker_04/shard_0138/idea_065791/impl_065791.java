...
@Data
public class Idea65791Config {
    private String name = "idea_065791";
 ...
 */
@Slf4j
public class Idea65791Service {
    private static final int IDEA_ID = 65791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65791Service() {
        this(new Idea65791Config());
    }

    public Idea65791Service(Idea65791Config config) {
        this.config = config != null ? config : new Idea65791Config();
