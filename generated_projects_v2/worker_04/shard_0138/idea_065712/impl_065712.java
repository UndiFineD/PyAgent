...
@Data
public class Idea65712Config {
    private String name = "idea_065712";
 ...
 */
@Slf4j
public class Idea65712Service {
    private static final int IDEA_ID = 65712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65712Service() {
        this(new Idea65712Config());
    }

    public Idea65712Service(Idea65712Config config) {
        this.config = config != null ? config : new Idea65712Config();
