...
@Data
public class Idea65640Config {
    private String name = "idea_065640";
 ...
 */
@Slf4j
public class Idea65640Service {
    private static final int IDEA_ID = 65640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65640Service() {
        this(new Idea65640Config());
    }

    public Idea65640Service(Idea65640Config config) {
        this.config = config != null ? config : new Idea65640Config();
