...
@Data
public class Idea65805Config {
    private String name = "idea_065805";
 ...
 */
@Slf4j
public class Idea65805Service {
    private static final int IDEA_ID = 65805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65805Service() {
        this(new Idea65805Config());
    }

    public Idea65805Service(Idea65805Config config) {
        this.config = config != null ? config : new Idea65805Config();
