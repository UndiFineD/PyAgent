...
@Data
public class Idea65708Config {
    private String name = "idea_065708";
 ...
 */
@Slf4j
public class Idea65708Service {
    private static final int IDEA_ID = 65708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65708Service() {
        this(new Idea65708Config());
    }

    public Idea65708Service(Idea65708Config config) {
        this.config = config != null ? config : new Idea65708Config();
