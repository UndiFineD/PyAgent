...
@Data
public class Idea66016Config {
    private String name = "idea_066016";
 ...
 */
@Slf4j
public class Idea66016Service {
    private static final int IDEA_ID = 66016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66016Service() {
        this(new Idea66016Config());
    }

    public Idea66016Service(Idea66016Config config) {
        this.config = config != null ? config : new Idea66016Config();
