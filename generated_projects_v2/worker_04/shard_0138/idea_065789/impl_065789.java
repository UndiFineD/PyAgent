...
@Data
public class Idea65789Config {
    private String name = "idea_065789";
 ...
 */
@Slf4j
public class Idea65789Service {
    private static final int IDEA_ID = 65789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65789Service() {
        this(new Idea65789Config());
    }

    public Idea65789Service(Idea65789Config config) {
        this.config = config != null ? config : new Idea65789Config();
