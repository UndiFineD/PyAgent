...
@Data
public class Idea65604Config {
    private String name = "idea_065604";
 ...
 */
@Slf4j
public class Idea65604Service {
    private static final int IDEA_ID = 65604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65604Service() {
        this(new Idea65604Config());
    }

    public Idea65604Service(Idea65604Config config) {
        this.config = config != null ? config : new Idea65604Config();
