...
@Data
public class Idea65607Config {
    private String name = "idea_065607";
 ...
 */
@Slf4j
public class Idea65607Service {
    private static final int IDEA_ID = 65607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65607Service() {
        this(new Idea65607Config());
    }

    public Idea65607Service(Idea65607Config config) {
        this.config = config != null ? config : new Idea65607Config();
