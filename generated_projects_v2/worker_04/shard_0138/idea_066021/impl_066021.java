...
@Data
public class Idea66021Config {
    private String name = "idea_066021";
 ...
 */
@Slf4j
public class Idea66021Service {
    private static final int IDEA_ID = 66021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66021Service() {
        this(new Idea66021Config());
    }

    public Idea66021Service(Idea66021Config config) {
        this.config = config != null ? config : new Idea66021Config();
