...
@Data
public class Idea65698Config {
    private String name = "idea_065698";
 ...
 */
@Slf4j
public class Idea65698Service {
    private static final int IDEA_ID = 65698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65698Service() {
        this(new Idea65698Config());
    }

    public Idea65698Service(Idea65698Config config) {
        this.config = config != null ? config : new Idea65698Config();
