...
@Data
public class Idea65739Config {
    private String name = "idea_065739";
 ...
 */
@Slf4j
public class Idea65739Service {
    private static final int IDEA_ID = 65739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65739Service() {
        this(new Idea65739Config());
    }

    public Idea65739Service(Idea65739Config config) {
        this.config = config != null ? config : new Idea65739Config();
