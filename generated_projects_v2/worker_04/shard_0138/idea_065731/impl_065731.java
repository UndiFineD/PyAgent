...
@Data
public class Idea65731Config {
    private String name = "idea_065731";
 ...
 */
@Slf4j
public class Idea65731Service {
    private static final int IDEA_ID = 65731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65731Service() {
        this(new Idea65731Config());
    }

    public Idea65731Service(Idea65731Config config) {
        this.config = config != null ? config : new Idea65731Config();
