...
@Data
public class Idea65908Config {
    private String name = "idea_065908";
 ...
 */
@Slf4j
public class Idea65908Service {
    private static final int IDEA_ID = 65908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65908Service() {
        this(new Idea65908Config());
    }

    public Idea65908Service(Idea65908Config config) {
        this.config = config != null ? config : new Idea65908Config();
