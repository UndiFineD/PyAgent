...
@Data
public class Idea65672Config {
    private String name = "idea_065672";
 ...
 */
@Slf4j
public class Idea65672Service {
    private static final int IDEA_ID = 65672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65672Service() {
        this(new Idea65672Config());
    }

    public Idea65672Service(Idea65672Config config) {
        this.config = config != null ? config : new Idea65672Config();
