...
@Data
public class Idea65961Config {
    private String name = "idea_065961";
 ...
 */
@Slf4j
public class Idea65961Service {
    private static final int IDEA_ID = 65961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65961Service() {
        this(new Idea65961Config());
    }

    public Idea65961Service(Idea65961Config config) {
        this.config = config != null ? config : new Idea65961Config();
