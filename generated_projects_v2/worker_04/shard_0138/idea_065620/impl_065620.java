...
@Data
public class Idea65620Config {
    private String name = "idea_065620";
 ...
 */
@Slf4j
public class Idea65620Service {
    private static final int IDEA_ID = 65620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65620Service() {
        this(new Idea65620Config());
    }

    public Idea65620Service(Idea65620Config config) {
        this.config = config != null ? config : new Idea65620Config();
