...
@Data
public class Idea65721Config {
    private String name = "idea_065721";
 ...
 */
@Slf4j
public class Idea65721Service {
    private static final int IDEA_ID = 65721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65721Service() {
        this(new Idea65721Config());
    }

    public Idea65721Service(Idea65721Config config) {
        this.config = config != null ? config : new Idea65721Config();
