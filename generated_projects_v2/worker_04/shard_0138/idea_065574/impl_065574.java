...
@Data
public class Idea65574Config {
    private String name = "idea_065574";
 ...
 */
@Slf4j
public class Idea65574Service {
    private static final int IDEA_ID = 65574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65574Service() {
        this(new Idea65574Config());
    }

    public Idea65574Service(Idea65574Config config) {
        this.config = config != null ? config : new Idea65574Config();
