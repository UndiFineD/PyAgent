...
@Data
public class Idea65912Config {
    private String name = "idea_065912";
 ...
 */
@Slf4j
public class Idea65912Service {
    private static final int IDEA_ID = 65912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65912Service() {
        this(new Idea65912Config());
    }

    public Idea65912Service(Idea65912Config config) {
        this.config = config != null ? config : new Idea65912Config();
