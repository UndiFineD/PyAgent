...
@Data
public class Idea65758Config {
    private String name = "idea_065758";
 ...
 */
@Slf4j
public class Idea65758Service {
    private static final int IDEA_ID = 65758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65758Service() {
        this(new Idea65758Config());
    }

    public Idea65758Service(Idea65758Config config) {
        this.config = config != null ? config : new Idea65758Config();
