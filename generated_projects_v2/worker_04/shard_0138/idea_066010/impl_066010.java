...
@Data
public class Idea66010Config {
    private String name = "idea_066010";
 ...
 */
@Slf4j
public class Idea66010Service {
    private static final int IDEA_ID = 66010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea66010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea66010Service() {
        this(new Idea66010Config());
    }

    public Idea66010Service(Idea66010Config config) {
        this.config = config != null ? config : new Idea66010Config();
