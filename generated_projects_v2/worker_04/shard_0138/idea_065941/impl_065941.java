...
@Data
public class Idea65941Config {
    private String name = "idea_065941";
 ...
 */
@Slf4j
public class Idea65941Service {
    private static final int IDEA_ID = 65941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65941Service() {
        this(new Idea65941Config());
    }

    public Idea65941Service(Idea65941Config config) {
        this.config = config != null ? config : new Idea65941Config();
