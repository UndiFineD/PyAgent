...
@Data
public class Idea65611Config {
    private String name = "idea_065611";
 ...
 */
@Slf4j
public class Idea65611Service {
    private static final int IDEA_ID = 65611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65611Service() {
        this(new Idea65611Config());
    }

    public Idea65611Service(Idea65611Config config) {
        this.config = config != null ? config : new Idea65611Config();
