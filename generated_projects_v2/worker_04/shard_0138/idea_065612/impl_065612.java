...
@Data
public class Idea65612Config {
    private String name = "idea_065612";
 ...
 */
@Slf4j
public class Idea65612Service {
    private static final int IDEA_ID = 65612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65612Service() {
        this(new Idea65612Config());
    }

    public Idea65612Service(Idea65612Config config) {
        this.config = config != null ? config : new Idea65612Config();
