...
@Data
public class Idea65986Config {
    private String name = "idea_065986";
 ...
 */
@Slf4j
public class Idea65986Service {
    private static final int IDEA_ID = 65986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65986Service() {
        this(new Idea65986Config());
    }

    public Idea65986Service(Idea65986Config config) {
        this.config = config != null ? config : new Idea65986Config();
