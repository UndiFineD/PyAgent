...
@Data
public class Idea65923Config {
    private String name = "idea_065923";
 ...
 */
@Slf4j
public class Idea65923Service {
    private static final int IDEA_ID = 65923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65923Service() {
        this(new Idea65923Config());
    }

    public Idea65923Service(Idea65923Config config) {
        this.config = config != null ? config : new Idea65923Config();
