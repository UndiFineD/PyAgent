...
@Data
public class Idea65931Config {
    private String name = "idea_065931";
 ...
 */
@Slf4j
public class Idea65931Service {
    private static final int IDEA_ID = 65931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65931Service() {
        this(new Idea65931Config());
    }

    public Idea65931Service(Idea65931Config config) {
        this.config = config != null ? config : new Idea65931Config();
