...
@Data
public class Idea65989Config {
    private String name = "idea_065989";
 ...
 */
@Slf4j
public class Idea65989Service {
    private static final int IDEA_ID = 65989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65989Service() {
        this(new Idea65989Config());
    }

    public Idea65989Service(Idea65989Config config) {
        this.config = config != null ? config : new Idea65989Config();
