...
@Data
public class Idea65645Config {
    private String name = "idea_065645";
 ...
 */
@Slf4j
public class Idea65645Service {
    private static final int IDEA_ID = 65645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65645Service() {
        this(new Idea65645Config());
    }

    public Idea65645Service(Idea65645Config config) {
        this.config = config != null ? config : new Idea65645Config();
