...
@Data
public class Idea65952Config {
    private String name = "idea_065952";
 ...
 */
@Slf4j
public class Idea65952Service {
    private static final int IDEA_ID = 65952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65952Service() {
        this(new Idea65952Config());
    }

    public Idea65952Service(Idea65952Config config) {
        this.config = config != null ? config : new Idea65952Config();
