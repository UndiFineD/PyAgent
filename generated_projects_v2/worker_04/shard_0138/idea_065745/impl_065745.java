...
@Data
public class Idea65745Config {
    private String name = "idea_065745";
 ...
 */
@Slf4j
public class Idea65745Service {
    private static final int IDEA_ID = 65745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65745Service() {
        this(new Idea65745Config());
    }

    public Idea65745Service(Idea65745Config config) {
        this.config = config != null ? config : new Idea65745Config();
