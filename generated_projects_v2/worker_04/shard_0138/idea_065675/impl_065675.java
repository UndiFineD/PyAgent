...
@Data
public class Idea65675Config {
    private String name = "idea_065675";
 ...
 */
@Slf4j
public class Idea65675Service {
    private static final int IDEA_ID = 65675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65675Service() {
        this(new Idea65675Config());
    }

    public Idea65675Service(Idea65675Config config) {
        this.config = config != null ? config : new Idea65675Config();
