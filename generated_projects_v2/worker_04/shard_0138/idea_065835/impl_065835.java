...
@Data
public class Idea65835Config {
    private String name = "idea_065835";
 ...
 */
@Slf4j
public class Idea65835Service {
    private static final int IDEA_ID = 65835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65835Service() {
        this(new Idea65835Config());
    }

    public Idea65835Service(Idea65835Config config) {
        this.config = config != null ? config : new Idea65835Config();
