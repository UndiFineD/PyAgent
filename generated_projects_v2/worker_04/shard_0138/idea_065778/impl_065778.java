...
@Data
public class Idea65778Config {
    private String name = "idea_065778";
 ...
 */
@Slf4j
public class Idea65778Service {
    private static final int IDEA_ID = 65778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65778Service() {
        this(new Idea65778Config());
    }

    public Idea65778Service(Idea65778Config config) {
        this.config = config != null ? config : new Idea65778Config();
