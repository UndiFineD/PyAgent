...
@Data
public class Idea65878Config {
    private String name = "idea_065878";
 ...
 */
@Slf4j
public class Idea65878Service {
    private static final int IDEA_ID = 65878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65878Service() {
        this(new Idea65878Config());
    }

    public Idea65878Service(Idea65878Config config) {
        this.config = config != null ? config : new Idea65878Config();
