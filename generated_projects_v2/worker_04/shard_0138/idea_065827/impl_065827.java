...
@Data
public class Idea65827Config {
    private String name = "idea_065827";
 ...
 */
@Slf4j
public class Idea65827Service {
    private static final int IDEA_ID = 65827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65827Service() {
        this(new Idea65827Config());
    }

    public Idea65827Service(Idea65827Config config) {
        this.config = config != null ? config : new Idea65827Config();
