...
@Data
public class Idea65621Config {
    private String name = "idea_065621";
 ...
 */
@Slf4j
public class Idea65621Service {
    private static final int IDEA_ID = 65621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65621Service() {
        this(new Idea65621Config());
    }

    public Idea65621Service(Idea65621Config config) {
        this.config = config != null ? config : new Idea65621Config();
