...
@Data
public class Idea65883Config {
    private String name = "idea_065883";
 ...
 */
@Slf4j
public class Idea65883Service {
    private static final int IDEA_ID = 65883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65883Service() {
        this(new Idea65883Config());
    }

    public Idea65883Service(Idea65883Config config) {
        this.config = config != null ? config : new Idea65883Config();
