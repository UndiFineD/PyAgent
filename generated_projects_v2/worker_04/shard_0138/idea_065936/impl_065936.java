...
@Data
public class Idea65936Config {
    private String name = "idea_065936";
 ...
 */
@Slf4j
public class Idea65936Service {
    private static final int IDEA_ID = 65936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65936Service() {
        this(new Idea65936Config());
    }

    public Idea65936Service(Idea65936Config config) {
        this.config = config != null ? config : new Idea65936Config();
