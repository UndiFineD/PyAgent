...
@Data
public class Idea65725Config {
    private String name = "idea_065725";
 ...
 */
@Slf4j
public class Idea65725Service {
    private static final int IDEA_ID = 65725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65725Service() {
        this(new Idea65725Config());
    }

    public Idea65725Service(Idea65725Config config) {
        this.config = config != null ? config : new Idea65725Config();
