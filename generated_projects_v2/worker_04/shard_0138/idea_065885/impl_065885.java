...
@Data
public class Idea65885Config {
    private String name = "idea_065885";
 ...
 */
@Slf4j
public class Idea65885Service {
    private static final int IDEA_ID = 65885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65885Service() {
        this(new Idea65885Config());
    }

    public Idea65885Service(Idea65885Config config) {
        this.config = config != null ? config : new Idea65885Config();
