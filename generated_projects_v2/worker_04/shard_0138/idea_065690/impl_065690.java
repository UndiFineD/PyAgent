...
@Data
public class Idea65690Config {
    private String name = "idea_065690";
 ...
 */
@Slf4j
public class Idea65690Service {
    private static final int IDEA_ID = 65690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65690Service() {
        this(new Idea65690Config());
    }

    public Idea65690Service(Idea65690Config config) {
        this.config = config != null ? config : new Idea65690Config();
