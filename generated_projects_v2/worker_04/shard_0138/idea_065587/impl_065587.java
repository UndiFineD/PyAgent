...
@Data
public class Idea65587Config {
    private String name = "idea_065587";
 ...
 */
@Slf4j
public class Idea65587Service {
    private static final int IDEA_ID = 65587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65587Service() {
        this(new Idea65587Config());
    }

    public Idea65587Service(Idea65587Config config) {
        this.config = config != null ? config : new Idea65587Config();
