...
@Data
public class Idea65860Config {
    private String name = "idea_065860";
 ...
 */
@Slf4j
public class Idea65860Service {
    private static final int IDEA_ID = 65860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65860Service() {
        this(new Idea65860Config());
    }

    public Idea65860Service(Idea65860Config config) {
        this.config = config != null ? config : new Idea65860Config();
