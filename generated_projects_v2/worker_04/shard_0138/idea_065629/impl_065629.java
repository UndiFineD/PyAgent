...
@Data
public class Idea65629Config {
    private String name = "idea_065629";
 ...
 */
@Slf4j
public class Idea65629Service {
    private static final int IDEA_ID = 65629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65629Service() {
        this(new Idea65629Config());
    }

    public Idea65629Service(Idea65629Config config) {
        this.config = config != null ? config : new Idea65629Config();
