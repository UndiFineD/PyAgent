...
@Data
public class Idea65716Config {
    private String name = "idea_065716";
 ...
 */
@Slf4j
public class Idea65716Service {
    private static final int IDEA_ID = 65716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65716Service() {
        this(new Idea65716Config());
    }

    public Idea65716Service(Idea65716Config config) {
        this.config = config != null ? config : new Idea65716Config();
