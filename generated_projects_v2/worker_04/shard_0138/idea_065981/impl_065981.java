...
@Data
public class Idea65981Config {
    private String name = "idea_065981";
 ...
 */
@Slf4j
public class Idea65981Service {
    private static final int IDEA_ID = 65981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65981Service() {
        this(new Idea65981Config());
    }

    public Idea65981Service(Idea65981Config config) {
        this.config = config != null ? config : new Idea65981Config();
