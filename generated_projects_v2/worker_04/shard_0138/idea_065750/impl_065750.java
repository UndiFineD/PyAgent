...
@Data
public class Idea65750Config {
    private String name = "idea_065750";
 ...
 */
@Slf4j
public class Idea65750Service {
    private static final int IDEA_ID = 65750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65750Service() {
        this(new Idea65750Config());
    }

    public Idea65750Service(Idea65750Config config) {
        this.config = config != null ? config : new Idea65750Config();
