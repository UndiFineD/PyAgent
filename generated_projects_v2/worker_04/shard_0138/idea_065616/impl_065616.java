...
@Data
public class Idea65616Config {
    private String name = "idea_065616";
 ...
 */
@Slf4j
public class Idea65616Service {
    private static final int IDEA_ID = 65616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65616Service() {
        this(new Idea65616Config());
    }

    public Idea65616Service(Idea65616Config config) {
        this.config = config != null ? config : new Idea65616Config();
