...
@Data
public class Idea65850Config {
    private String name = "idea_065850";
 ...
 */
@Slf4j
public class Idea65850Service {
    private static final int IDEA_ID = 65850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65850Service() {
        this(new Idea65850Config());
    }

    public Idea65850Service(Idea65850Config config) {
        this.config = config != null ? config : new Idea65850Config();
