...
@Data
public class Idea65710Config {
    private String name = "idea_065710";
 ...
 */
@Slf4j
public class Idea65710Service {
    private static final int IDEA_ID = 65710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65710Service() {
        this(new Idea65710Config());
    }

    public Idea65710Service(Idea65710Config config) {
        this.config = config != null ? config : new Idea65710Config();
