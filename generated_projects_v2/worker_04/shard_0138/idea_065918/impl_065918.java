...
@Data
public class Idea65918Config {
    private String name = "idea_065918";
 ...
 */
@Slf4j
public class Idea65918Service {
    private static final int IDEA_ID = 65918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65918Service() {
        this(new Idea65918Config());
    }

    public Idea65918Service(Idea65918Config config) {
        this.config = config != null ? config : new Idea65918Config();
