...
@Data
public class Idea65925Config {
    private String name = "idea_065925";
 ...
 */
@Slf4j
public class Idea65925Service {
    private static final int IDEA_ID = 65925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65925Service() {
        this(new Idea65925Config());
    }

    public Idea65925Service(Idea65925Config config) {
        this.config = config != null ? config : new Idea65925Config();
