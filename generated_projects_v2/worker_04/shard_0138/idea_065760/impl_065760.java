...
@Data
public class Idea65760Config {
    private String name = "idea_065760";
 ...
 */
@Slf4j
public class Idea65760Service {
    private static final int IDEA_ID = 65760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65760Service() {
        this(new Idea65760Config());
    }

    public Idea65760Service(Idea65760Config config) {
        this.config = config != null ? config : new Idea65760Config();
