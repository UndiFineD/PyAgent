...
@Data
public class Idea65980Config {
    private String name = "idea_065980";
 ...
 */
@Slf4j
public class Idea65980Service {
    private static final int IDEA_ID = 65980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65980Service() {
        this(new Idea65980Config());
    }

    public Idea65980Service(Idea65980Config config) {
        this.config = config != null ? config : new Idea65980Config();
