...
@Data
public class Idea67715Config {
    private String name = "idea_067715";
 ...
 */
@Slf4j
public class Idea67715Service {
    private static final int IDEA_ID = 67715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67715Service() {
        this(new Idea67715Config());
    }

    public Idea67715Service(Idea67715Config config) {
        this.config = config != null ? config : new Idea67715Config();
