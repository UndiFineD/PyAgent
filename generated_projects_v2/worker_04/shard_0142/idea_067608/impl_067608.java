...
@Data
public class Idea67608Config {
    private String name = "idea_067608";
 ...
 */
@Slf4j
public class Idea67608Service {
    private static final int IDEA_ID = 67608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67608Service() {
        this(new Idea67608Config());
    }

    public Idea67608Service(Idea67608Config config) {
        this.config = config != null ? config : new Idea67608Config();
