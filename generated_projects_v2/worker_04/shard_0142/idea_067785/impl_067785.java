...
@Data
public class Idea67785Config {
    private String name = "idea_067785";
 ...
 */
@Slf4j
public class Idea67785Service {
    private static final int IDEA_ID = 67785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67785Service() {
        this(new Idea67785Config());
    }

    public Idea67785Service(Idea67785Config config) {
        this.config = config != null ? config : new Idea67785Config();
