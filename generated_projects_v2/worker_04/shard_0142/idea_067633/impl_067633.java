...
@Data
public class Idea67633Config {
    private String name = "idea_067633";
 ...
 */
@Slf4j
public class Idea67633Service {
    private static final int IDEA_ID = 67633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67633Service() {
        this(new Idea67633Config());
    }

    public Idea67633Service(Idea67633Config config) {
        this.config = config != null ? config : new Idea67633Config();
