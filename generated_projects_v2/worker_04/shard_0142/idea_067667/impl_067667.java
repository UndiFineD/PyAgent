...
@Data
public class Idea67667Config {
    private String name = "idea_067667";
 ...
 */
@Slf4j
public class Idea67667Service {
    private static final int IDEA_ID = 67667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67667Service() {
        this(new Idea67667Config());
    }

    public Idea67667Service(Idea67667Config config) {
        this.config = config != null ? config : new Idea67667Config();
