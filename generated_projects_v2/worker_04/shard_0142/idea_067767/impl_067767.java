...
@Data
public class Idea67767Config {
    private String name = "idea_067767";
 ...
 */
@Slf4j
public class Idea67767Service {
    private static final int IDEA_ID = 67767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67767Service() {
        this(new Idea67767Config());
    }

    public Idea67767Service(Idea67767Config config) {
        this.config = config != null ? config : new Idea67767Config();
