...
@Data
public class Idea67660Config {
    private String name = "idea_067660";
 ...
 */
@Slf4j
public class Idea67660Service {
    private static final int IDEA_ID = 67660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67660Service() {
        this(new Idea67660Config());
    }

    public Idea67660Service(Idea67660Config config) {
        this.config = config != null ? config : new Idea67660Config();
