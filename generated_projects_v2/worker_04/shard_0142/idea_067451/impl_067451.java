...
@Data
public class Idea67451Config {
    private String name = "idea_067451";
 ...
 */
@Slf4j
public class Idea67451Service {
    private static final int IDEA_ID = 67451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67451Service() {
        this(new Idea67451Config());
    }

    public Idea67451Service(Idea67451Config config) {
        this.config = config != null ? config : new Idea67451Config();
