...
@Data
public class Idea67887Config {
    private String name = "idea_067887";
 ...
 */
@Slf4j
public class Idea67887Service {
    private static final int IDEA_ID = 67887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67887Service() {
        this(new Idea67887Config());
    }

    public Idea67887Service(Idea67887Config config) {
        this.config = config != null ? config : new Idea67887Config();
