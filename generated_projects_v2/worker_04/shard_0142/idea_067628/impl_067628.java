...
@Data
public class Idea67628Config {
    private String name = "idea_067628";
 ...
 */
@Slf4j
public class Idea67628Service {
    private static final int IDEA_ID = 67628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67628Service() {
        this(new Idea67628Config());
    }

    public Idea67628Service(Idea67628Config config) {
        this.config = config != null ? config : new Idea67628Config();
