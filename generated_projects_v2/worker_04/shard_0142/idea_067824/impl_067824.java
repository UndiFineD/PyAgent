...
@Data
public class Idea67824Config {
    private String name = "idea_067824";
 ...
 */
@Slf4j
public class Idea67824Service {
    private static final int IDEA_ID = 67824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67824Service() {
        this(new Idea67824Config());
    }

    public Idea67824Service(Idea67824Config config) {
        this.config = config != null ? config : new Idea67824Config();
