...
@Data
public class Idea67693Config {
    private String name = "idea_067693";
 ...
 */
@Slf4j
public class Idea67693Service {
    private static final int IDEA_ID = 67693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67693Service() {
        this(new Idea67693Config());
    }

    public Idea67693Service(Idea67693Config config) {
        this.config = config != null ? config : new Idea67693Config();
