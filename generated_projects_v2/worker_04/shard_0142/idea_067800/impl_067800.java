...
@Data
public class Idea67800Config {
    private String name = "idea_067800";
 ...
 */
@Slf4j
public class Idea67800Service {
    private static final int IDEA_ID = 67800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67800Service() {
        this(new Idea67800Config());
    }

    public Idea67800Service(Idea67800Config config) {
        this.config = config != null ? config : new Idea67800Config();
