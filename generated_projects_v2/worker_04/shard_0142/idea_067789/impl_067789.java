...
@Data
public class Idea67789Config {
    private String name = "idea_067789";
 ...
 */
@Slf4j
public class Idea67789Service {
    private static final int IDEA_ID = 67789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67789Service() {
        this(new Idea67789Config());
    }

    public Idea67789Service(Idea67789Config config) {
        this.config = config != null ? config : new Idea67789Config();
