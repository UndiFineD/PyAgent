...
@Data
public class Idea67623Config {
    private String name = "idea_067623";
 ...
 */
@Slf4j
public class Idea67623Service {
    private static final int IDEA_ID = 67623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67623Service() {
        this(new Idea67623Config());
    }

    public Idea67623Service(Idea67623Config config) {
        this.config = config != null ? config : new Idea67623Config();
