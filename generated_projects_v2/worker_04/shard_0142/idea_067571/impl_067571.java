...
@Data
public class Idea67571Config {
    private String name = "idea_067571";
 ...
 */
@Slf4j
public class Idea67571Service {
    private static final int IDEA_ID = 67571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67571Service() {
        this(new Idea67571Config());
    }

    public Idea67571Service(Idea67571Config config) {
        this.config = config != null ? config : new Idea67571Config();
