...
@Data
public class Idea67500Config {
    private String name = "idea_067500";
 ...
 */
@Slf4j
public class Idea67500Service {
    private static final int IDEA_ID = 67500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67500Service() {
        this(new Idea67500Config());
    }

    public Idea67500Service(Idea67500Config config) {
        this.config = config != null ? config : new Idea67500Config();
