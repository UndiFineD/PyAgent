...
@Data
public class Idea67517Config {
    private String name = "idea_067517";
 ...
 */
@Slf4j
public class Idea67517Service {
    private static final int IDEA_ID = 67517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67517Service() {
        this(new Idea67517Config());
    }

    public Idea67517Service(Idea67517Config config) {
        this.config = config != null ? config : new Idea67517Config();
