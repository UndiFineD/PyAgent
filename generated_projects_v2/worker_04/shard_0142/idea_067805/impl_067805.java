...
@Data
public class Idea67805Config {
    private String name = "idea_067805";
 ...
 */
@Slf4j
public class Idea67805Service {
    private static final int IDEA_ID = 67805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67805Service() {
        this(new Idea67805Config());
    }

    public Idea67805Service(Idea67805Config config) {
        this.config = config != null ? config : new Idea67805Config();
