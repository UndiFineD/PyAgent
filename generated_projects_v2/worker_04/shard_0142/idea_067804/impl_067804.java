...
@Data
public class Idea67804Config {
    private String name = "idea_067804";
 ...
 */
@Slf4j
public class Idea67804Service {
    private static final int IDEA_ID = 67804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67804Service() {
        this(new Idea67804Config());
    }

    public Idea67804Service(Idea67804Config config) {
        this.config = config != null ? config : new Idea67804Config();
