...
@Data
public class Idea67587Config {
    private String name = "idea_067587";
 ...
 */
@Slf4j
public class Idea67587Service {
    private static final int IDEA_ID = 67587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67587Service() {
        this(new Idea67587Config());
    }

    public Idea67587Service(Idea67587Config config) {
        this.config = config != null ? config : new Idea67587Config();
