...
@Data
public class Idea67611Config {
    private String name = "idea_067611";
 ...
 */
@Slf4j
public class Idea67611Service {
    private static final int IDEA_ID = 67611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67611Service() {
        this(new Idea67611Config());
    }

    public Idea67611Service(Idea67611Config config) {
        this.config = config != null ? config : new Idea67611Config();
