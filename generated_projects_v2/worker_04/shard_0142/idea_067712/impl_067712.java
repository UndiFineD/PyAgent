...
@Data
public class Idea67712Config {
    private String name = "idea_067712";
 ...
 */
@Slf4j
public class Idea67712Service {
    private static final int IDEA_ID = 67712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67712Service() {
        this(new Idea67712Config());
    }

    public Idea67712Service(Idea67712Config config) {
        this.config = config != null ? config : new Idea67712Config();
