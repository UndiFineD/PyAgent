...
@Data
public class Idea67670Config {
    private String name = "idea_067670";
 ...
 */
@Slf4j
public class Idea67670Service {
    private static final int IDEA_ID = 67670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67670Service() {
        this(new Idea67670Config());
    }

    public Idea67670Service(Idea67670Config config) {
        this.config = config != null ? config : new Idea67670Config();
