...
@Data
public class Idea67903Config {
    private String name = "idea_067903";
 ...
 */
@Slf4j
public class Idea67903Service {
    private static final int IDEA_ID = 67903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67903Service() {
        this(new Idea67903Config());
    }

    public Idea67903Service(Idea67903Config config) {
        this.config = config != null ? config : new Idea67903Config();
