...
@Data
public class Idea67458Config {
    private String name = "idea_067458";
 ...
 */
@Slf4j
public class Idea67458Service {
    private static final int IDEA_ID = 67458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67458Service() {
        this(new Idea67458Config());
    }

    public Idea67458Service(Idea67458Config config) {
        this.config = config != null ? config : new Idea67458Config();
