...
@Data
public class Idea67652Config {
    private String name = "idea_067652";
 ...
 */
@Slf4j
public class Idea67652Service {
    private static final int IDEA_ID = 67652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67652Service() {
        this(new Idea67652Config());
    }

    public Idea67652Service(Idea67652Config config) {
        this.config = config != null ? config : new Idea67652Config();
