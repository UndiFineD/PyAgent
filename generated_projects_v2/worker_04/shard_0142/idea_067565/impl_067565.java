...
@Data
public class Idea67565Config {
    private String name = "idea_067565";
 ...
 */
@Slf4j
public class Idea67565Service {
    private static final int IDEA_ID = 67565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67565Service() {
        this(new Idea67565Config());
    }

    public Idea67565Service(Idea67565Config config) {
        this.config = config != null ? config : new Idea67565Config();
