...
@Data
public class Idea67778Config {
    private String name = "idea_067778";
 ...
 */
@Slf4j
public class Idea67778Service {
    private static final int IDEA_ID = 67778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67778Service() {
        this(new Idea67778Config());
    }

    public Idea67778Service(Idea67778Config config) {
        this.config = config != null ? config : new Idea67778Config();
