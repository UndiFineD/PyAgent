...
@Data
public class Idea67780Config {
    private String name = "idea_067780";
 ...
 */
@Slf4j
public class Idea67780Service {
    private static final int IDEA_ID = 67780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67780Service() {
        this(new Idea67780Config());
    }

    public Idea67780Service(Idea67780Config config) {
        this.config = config != null ? config : new Idea67780Config();
