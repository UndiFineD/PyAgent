...
@Data
public class Idea67555Config {
    private String name = "idea_067555";
 ...
 */
@Slf4j
public class Idea67555Service {
    private static final int IDEA_ID = 67555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67555Service() {
        this(new Idea67555Config());
    }

    public Idea67555Service(Idea67555Config config) {
        this.config = config != null ? config : new Idea67555Config();
