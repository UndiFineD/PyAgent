...
@Data
public class Idea67704Config {
    private String name = "idea_067704";
 ...
 */
@Slf4j
public class Idea67704Service {
    private static final int IDEA_ID = 67704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67704Service() {
        this(new Idea67704Config());
    }

    public Idea67704Service(Idea67704Config config) {
        this.config = config != null ? config : new Idea67704Config();
