...
@Data
public class Idea67671Config {
    private String name = "idea_067671";
 ...
 */
@Slf4j
public class Idea67671Service {
    private static final int IDEA_ID = 67671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67671Service() {
        this(new Idea67671Config());
    }

    public Idea67671Service(Idea67671Config config) {
        this.config = config != null ? config : new Idea67671Config();
