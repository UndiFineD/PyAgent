...
@Data
public class Idea67673Config {
    private String name = "idea_067673";
 ...
 */
@Slf4j
public class Idea67673Service {
    private static final int IDEA_ID = 67673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67673Service() {
        this(new Idea67673Config());
    }

    public Idea67673Service(Idea67673Config config) {
        this.config = config != null ? config : new Idea67673Config();
