...
@Data
public class Idea67752Config {
    private String name = "idea_067752";
 ...
 */
@Slf4j
public class Idea67752Service {
    private static final int IDEA_ID = 67752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67752Service() {
        this(new Idea67752Config());
    }

    public Idea67752Service(Idea67752Config config) {
        this.config = config != null ? config : new Idea67752Config();
