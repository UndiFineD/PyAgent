...
@Data
public class Idea67773Config {
    private String name = "idea_067773";
 ...
 */
@Slf4j
public class Idea67773Service {
    private static final int IDEA_ID = 67773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67773Service() {
        this(new Idea67773Config());
    }

    public Idea67773Service(Idea67773Config config) {
        this.config = config != null ? config : new Idea67773Config();
