...
@Data
public class Idea67605Config {
    private String name = "idea_067605";
 ...
 */
@Slf4j
public class Idea67605Service {
    private static final int IDEA_ID = 67605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67605Service() {
        this(new Idea67605Config());
    }

    public Idea67605Service(Idea67605Config config) {
        this.config = config != null ? config : new Idea67605Config();
