...
@Data
public class Idea67473Config {
    private String name = "idea_067473";
 ...
 */
@Slf4j
public class Idea67473Service {
    private static final int IDEA_ID = 67473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67473Service() {
        this(new Idea67473Config());
    }

    public Idea67473Service(Idea67473Config config) {
        this.config = config != null ? config : new Idea67473Config();
