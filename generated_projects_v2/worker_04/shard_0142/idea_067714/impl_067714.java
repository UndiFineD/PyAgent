...
@Data
public class Idea67714Config {
    private String name = "idea_067714";
 ...
 */
@Slf4j
public class Idea67714Service {
    private static final int IDEA_ID = 67714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67714Service() {
        this(new Idea67714Config());
    }

    public Idea67714Service(Idea67714Config config) {
        this.config = config != null ? config : new Idea67714Config();
