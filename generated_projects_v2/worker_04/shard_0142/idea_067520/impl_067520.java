...
@Data
public class Idea67520Config {
    private String name = "idea_067520";
 ...
 */
@Slf4j
public class Idea67520Service {
    private static final int IDEA_ID = 67520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67520Service() {
        this(new Idea67520Config());
    }

    public Idea67520Service(Idea67520Config config) {
        this.config = config != null ? config : new Idea67520Config();
