...
@Data
public class Idea67702Config {
    private String name = "idea_067702";
 ...
 */
@Slf4j
public class Idea67702Service {
    private static final int IDEA_ID = 67702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67702Service() {
        this(new Idea67702Config());
    }

    public Idea67702Service(Idea67702Config config) {
        this.config = config != null ? config : new Idea67702Config();
