...
@Data
public class Idea67563Config {
    private String name = "idea_067563";
 ...
 */
@Slf4j
public class Idea67563Service {
    private static final int IDEA_ID = 67563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67563Service() {
        this(new Idea67563Config());
    }

    public Idea67563Service(Idea67563Config config) {
        this.config = config != null ? config : new Idea67563Config();
