...
@Data
public class Idea67578Config {
    private String name = "idea_067578";
 ...
 */
@Slf4j
public class Idea67578Service {
    private static final int IDEA_ID = 67578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67578Service() {
        this(new Idea67578Config());
    }

    public Idea67578Service(Idea67578Config config) {
        this.config = config != null ? config : new Idea67578Config();
