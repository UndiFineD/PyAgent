...
@Data
public class Idea67635Config {
    private String name = "idea_067635";
 ...
 */
@Slf4j
public class Idea67635Service {
    private static final int IDEA_ID = 67635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67635Service() {
        this(new Idea67635Config());
    }

    public Idea67635Service(Idea67635Config config) {
        this.config = config != null ? config : new Idea67635Config();
