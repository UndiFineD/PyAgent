...
@Data
public class Idea67527Config {
    private String name = "idea_067527";
 ...
 */
@Slf4j
public class Idea67527Service {
    private static final int IDEA_ID = 67527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67527Service() {
        this(new Idea67527Config());
    }

    public Idea67527Service(Idea67527Config config) {
        this.config = config != null ? config : new Idea67527Config();
