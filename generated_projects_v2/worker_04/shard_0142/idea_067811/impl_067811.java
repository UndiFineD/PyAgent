...
@Data
public class Idea67811Config {
    private String name = "idea_067811";
 ...
 */
@Slf4j
public class Idea67811Service {
    private static final int IDEA_ID = 67811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67811Service() {
        this(new Idea67811Config());
    }

    public Idea67811Service(Idea67811Config config) {
        this.config = config != null ? config : new Idea67811Config();
