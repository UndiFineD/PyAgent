...
@Data
public class Idea67513Config {
    private String name = "idea_067513";
 ...
 */
@Slf4j
public class Idea67513Service {
    private static final int IDEA_ID = 67513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67513Service() {
        this(new Idea67513Config());
    }

    public Idea67513Service(Idea67513Config config) {
        this.config = config != null ? config : new Idea67513Config();
