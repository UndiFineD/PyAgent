...
@Data
public class Idea67698Config {
    private String name = "idea_067698";
 ...
 */
@Slf4j
public class Idea67698Service {
    private static final int IDEA_ID = 67698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67698Service() {
        this(new Idea67698Config());
    }

    public Idea67698Service(Idea67698Config config) {
        this.config = config != null ? config : new Idea67698Config();
