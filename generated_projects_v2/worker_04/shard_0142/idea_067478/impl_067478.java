...
@Data
public class Idea67478Config {
    private String name = "idea_067478";
 ...
 */
@Slf4j
public class Idea67478Service {
    private static final int IDEA_ID = 67478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67478Service() {
        this(new Idea67478Config());
    }

    public Idea67478Service(Idea67478Config config) {
        this.config = config != null ? config : new Idea67478Config();
