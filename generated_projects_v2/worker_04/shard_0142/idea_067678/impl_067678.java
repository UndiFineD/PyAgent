...
@Data
public class Idea67678Config {
    private String name = "idea_067678";
 ...
 */
@Slf4j
public class Idea67678Service {
    private static final int IDEA_ID = 67678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67678Service() {
        this(new Idea67678Config());
    }

    public Idea67678Service(Idea67678Config config) {
        this.config = config != null ? config : new Idea67678Config();
