...
@Data
public class Idea67595Config {
    private String name = "idea_067595";
 ...
 */
@Slf4j
public class Idea67595Service {
    private static final int IDEA_ID = 67595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67595Service() {
        this(new Idea67595Config());
    }

    public Idea67595Service(Idea67595Config config) {
        this.config = config != null ? config : new Idea67595Config();
