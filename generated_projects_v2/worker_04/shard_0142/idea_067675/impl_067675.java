...
@Data
public class Idea67675Config {
    private String name = "idea_067675";
 ...
 */
@Slf4j
public class Idea67675Service {
    private static final int IDEA_ID = 67675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67675Service() {
        this(new Idea67675Config());
    }

    public Idea67675Service(Idea67675Config config) {
        this.config = config != null ? config : new Idea67675Config();
