...
@Data
public class Idea67858Config {
    private String name = "idea_067858";
 ...
 */
@Slf4j
public class Idea67858Service {
    private static final int IDEA_ID = 67858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67858Service() {
        this(new Idea67858Config());
    }

    public Idea67858Service(Idea67858Config config) {
        this.config = config != null ? config : new Idea67858Config();
