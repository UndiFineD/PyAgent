...
@Data
public class Idea67591Config {
    private String name = "idea_067591";
 ...
 */
@Slf4j
public class Idea67591Service {
    private static final int IDEA_ID = 67591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67591Service() {
        this(new Idea67591Config());
    }

    public Idea67591Service(Idea67591Config config) {
        this.config = config != null ? config : new Idea67591Config();
