...
@Data
public class Idea67462Config {
    private String name = "idea_067462";
 ...
 */
@Slf4j
public class Idea67462Service {
    private static final int IDEA_ID = 67462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67462Service() {
        this(new Idea67462Config());
    }

    public Idea67462Service(Idea67462Config config) {
        this.config = config != null ? config : new Idea67462Config();
