...
@Data
public class Idea67793Config {
    private String name = "idea_067793";
 ...
 */
@Slf4j
public class Idea67793Service {
    private static final int IDEA_ID = 67793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67793Service() {
        this(new Idea67793Config());
    }

    public Idea67793Service(Idea67793Config config) {
        this.config = config != null ? config : new Idea67793Config();
