...
@Data
public class Idea67801Config {
    private String name = "idea_067801";
 ...
 */
@Slf4j
public class Idea67801Service {
    private static final int IDEA_ID = 67801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67801Service() {
        this(new Idea67801Config());
    }

    public Idea67801Service(Idea67801Config config) {
        this.config = config != null ? config : new Idea67801Config();
