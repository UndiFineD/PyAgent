...
@Data
public class Idea67666Config {
    private String name = "idea_067666";
 ...
 */
@Slf4j
public class Idea67666Service {
    private static final int IDEA_ID = 67666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67666Service() {
        this(new Idea67666Config());
    }

    public Idea67666Service(Idea67666Config config) {
        this.config = config != null ? config : new Idea67666Config();
