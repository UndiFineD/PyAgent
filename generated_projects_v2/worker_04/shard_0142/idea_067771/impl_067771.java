...
@Data
public class Idea67771Config {
    private String name = "idea_067771";
 ...
 */
@Slf4j
public class Idea67771Service {
    private static final int IDEA_ID = 67771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67771Service() {
        this(new Idea67771Config());
    }

    public Idea67771Service(Idea67771Config config) {
        this.config = config != null ? config : new Idea67771Config();
