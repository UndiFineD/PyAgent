...
@Data
public class Idea67554Config {
    private String name = "idea_067554";
 ...
 */
@Slf4j
public class Idea67554Service {
    private static final int IDEA_ID = 67554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67554Service() {
        this(new Idea67554Config());
    }

    public Idea67554Service(Idea67554Config config) {
        this.config = config != null ? config : new Idea67554Config();
