...
@Data
public class Idea67718Config {
    private String name = "idea_067718";
 ...
 */
@Slf4j
public class Idea67718Service {
    private static final int IDEA_ID = 67718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67718Service() {
        this(new Idea67718Config());
    }

    public Idea67718Service(Idea67718Config config) {
        this.config = config != null ? config : new Idea67718Config();
