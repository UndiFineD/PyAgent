...
@Data
public class Idea67794Config {
    private String name = "idea_067794";
 ...
 */
@Slf4j
public class Idea67794Service {
    private static final int IDEA_ID = 67794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67794Service() {
        this(new Idea67794Config());
    }

    public Idea67794Service(Idea67794Config config) {
        this.config = config != null ? config : new Idea67794Config();
