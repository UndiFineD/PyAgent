...
@Data
public class Idea67537Config {
    private String name = "idea_067537";
 ...
 */
@Slf4j
public class Idea67537Service {
    private static final int IDEA_ID = 67537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67537Service() {
        this(new Idea67537Config());
    }

    public Idea67537Service(Idea67537Config config) {
        this.config = config != null ? config : new Idea67537Config();
