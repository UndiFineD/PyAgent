...
@Data
public class Idea67825Config {
    private String name = "idea_067825";
 ...
 */
@Slf4j
public class Idea67825Service {
    private static final int IDEA_ID = 67825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67825Service() {
        this(new Idea67825Config());
    }

    public Idea67825Service(Idea67825Config config) {
        this.config = config != null ? config : new Idea67825Config();
