...
@Data
public class Idea67597Config {
    private String name = "idea_067597";
 ...
 */
@Slf4j
public class Idea67597Service {
    private static final int IDEA_ID = 67597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67597Service() {
        this(new Idea67597Config());
    }

    public Idea67597Service(Idea67597Config config) {
        this.config = config != null ? config : new Idea67597Config();
