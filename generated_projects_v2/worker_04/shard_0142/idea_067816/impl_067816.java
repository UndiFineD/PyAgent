...
@Data
public class Idea67816Config {
    private String name = "idea_067816";
 ...
 */
@Slf4j
public class Idea67816Service {
    private static final int IDEA_ID = 67816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67816Service() {
        this(new Idea67816Config());
    }

    public Idea67816Service(Idea67816Config config) {
        this.config = config != null ? config : new Idea67816Config();
