...
@Data
public class Idea67814Config {
    private String name = "idea_067814";
 ...
 */
@Slf4j
public class Idea67814Service {
    private static final int IDEA_ID = 67814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67814Service() {
        this(new Idea67814Config());
    }

    public Idea67814Service(Idea67814Config config) {
        this.config = config != null ? config : new Idea67814Config();
