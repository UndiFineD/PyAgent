...
@Data
public class Idea67783Config {
    private String name = "idea_067783";
 ...
 */
@Slf4j
public class Idea67783Service {
    private static final int IDEA_ID = 67783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67783Service() {
        this(new Idea67783Config());
    }

    public Idea67783Service(Idea67783Config config) {
        this.config = config != null ? config : new Idea67783Config();
