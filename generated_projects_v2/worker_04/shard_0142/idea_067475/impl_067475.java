...
@Data
public class Idea67475Config {
    private String name = "idea_067475";
 ...
 */
@Slf4j
public class Idea67475Service {
    private static final int IDEA_ID = 67475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67475Service() {
        this(new Idea67475Config());
    }

    public Idea67475Service(Idea67475Config config) {
        this.config = config != null ? config : new Idea67475Config();
