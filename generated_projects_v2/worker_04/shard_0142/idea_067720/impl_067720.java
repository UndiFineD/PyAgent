...
@Data
public class Idea67720Config {
    private String name = "idea_067720";
 ...
 */
@Slf4j
public class Idea67720Service {
    private static final int IDEA_ID = 67720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67720Service() {
        this(new Idea67720Config());
    }

    public Idea67720Service(Idea67720Config config) {
        this.config = config != null ? config : new Idea67720Config();
