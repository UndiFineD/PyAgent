...
@Data
public class Idea67657Config {
    private String name = "idea_067657";
 ...
 */
@Slf4j
public class Idea67657Service {
    private static final int IDEA_ID = 67657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67657Service() {
        this(new Idea67657Config());
    }

    public Idea67657Service(Idea67657Config config) {
        this.config = config != null ? config : new Idea67657Config();
