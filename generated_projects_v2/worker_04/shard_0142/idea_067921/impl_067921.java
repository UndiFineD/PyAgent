...
@Data
public class Idea67921Config {
    private String name = "idea_067921";
 ...
 */
@Slf4j
public class Idea67921Service {
    private static final int IDEA_ID = 67921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67921Service() {
        this(new Idea67921Config());
    }

    public Idea67921Service(Idea67921Config config) {
        this.config = config != null ? config : new Idea67921Config();
