...
@Data
public class Idea67870Config {
    private String name = "idea_067870";
 ...
 */
@Slf4j
public class Idea67870Service {
    private static final int IDEA_ID = 67870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67870Service() {
        this(new Idea67870Config());
    }

    public Idea67870Service(Idea67870Config config) {
        this.config = config != null ? config : new Idea67870Config();
