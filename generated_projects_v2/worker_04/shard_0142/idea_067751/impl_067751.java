...
@Data
public class Idea67751Config {
    private String name = "idea_067751";
 ...
 */
@Slf4j
public class Idea67751Service {
    private static final int IDEA_ID = 67751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67751Service() {
        this(new Idea67751Config());
    }

    public Idea67751Service(Idea67751Config config) {
        this.config = config != null ? config : new Idea67751Config();
