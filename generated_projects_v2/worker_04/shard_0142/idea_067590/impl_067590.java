...
@Data
public class Idea67590Config {
    private String name = "idea_067590";
 ...
 */
@Slf4j
public class Idea67590Service {
    private static final int IDEA_ID = 67590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67590Service() {
        this(new Idea67590Config());
    }

    public Idea67590Service(Idea67590Config config) {
        this.config = config != null ? config : new Idea67590Config();
