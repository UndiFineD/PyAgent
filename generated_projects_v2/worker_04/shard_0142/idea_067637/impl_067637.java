...
@Data
public class Idea67637Config {
    private String name = "idea_067637";
 ...
 */
@Slf4j
public class Idea67637Service {
    private static final int IDEA_ID = 67637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67637Service() {
        this(new Idea67637Config());
    }

    public Idea67637Service(Idea67637Config config) {
        this.config = config != null ? config : new Idea67637Config();
