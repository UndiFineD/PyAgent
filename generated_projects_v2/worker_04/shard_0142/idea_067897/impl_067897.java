...
@Data
public class Idea67897Config {
    private String name = "idea_067897";
 ...
 */
@Slf4j
public class Idea67897Service {
    private static final int IDEA_ID = 67897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67897Service() {
        this(new Idea67897Config());
    }

    public Idea67897Service(Idea67897Config config) {
        this.config = config != null ? config : new Idea67897Config();
