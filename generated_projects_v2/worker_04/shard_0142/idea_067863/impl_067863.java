...
@Data
public class Idea67863Config {
    private String name = "idea_067863";
 ...
 */
@Slf4j
public class Idea67863Service {
    private static final int IDEA_ID = 67863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67863Service() {
        this(new Idea67863Config());
    }

    public Idea67863Service(Idea67863Config config) {
        this.config = config != null ? config : new Idea67863Config();
