...
@Data
public class Idea67706Config {
    private String name = "idea_067706";
 ...
 */
@Slf4j
public class Idea67706Service {
    private static final int IDEA_ID = 67706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67706Service() {
        this(new Idea67706Config());
    }

    public Idea67706Service(Idea67706Config config) {
        this.config = config != null ? config : new Idea67706Config();
