...
@Data
public class Idea67797Config {
    private String name = "idea_067797";
 ...
 */
@Slf4j
public class Idea67797Service {
    private static final int IDEA_ID = 67797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67797Service() {
        this(new Idea67797Config());
    }

    public Idea67797Service(Idea67797Config config) {
        this.config = config != null ? config : new Idea67797Config();
