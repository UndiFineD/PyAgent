...
@Data
public class Idea67798Config {
    private String name = "idea_067798";
 ...
 */
@Slf4j
public class Idea67798Service {
    private static final int IDEA_ID = 67798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67798Service() {
        this(new Idea67798Config());
    }

    public Idea67798Service(Idea67798Config config) {
        this.config = config != null ? config : new Idea67798Config();
