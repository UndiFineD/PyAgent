...
@Data
public class Idea67703Config {
    private String name = "idea_067703";
 ...
 */
@Slf4j
public class Idea67703Service {
    private static final int IDEA_ID = 67703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67703Service() {
        this(new Idea67703Config());
    }

    public Idea67703Service(Idea67703Config config) {
        this.config = config != null ? config : new Idea67703Config();
