...
@Data
public class Idea67907Config {
    private String name = "idea_067907";
 ...
 */
@Slf4j
public class Idea67907Service {
    private static final int IDEA_ID = 67907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67907Service() {
        this(new Idea67907Config());
    }

    public Idea67907Service(Idea67907Config config) {
        this.config = config != null ? config : new Idea67907Config();
