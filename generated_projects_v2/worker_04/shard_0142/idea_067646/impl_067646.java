...
@Data
public class Idea67646Config {
    private String name = "idea_067646";
 ...
 */
@Slf4j
public class Idea67646Service {
    private static final int IDEA_ID = 67646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67646Service() {
        this(new Idea67646Config());
    }

    public Idea67646Service(Idea67646Config config) {
        this.config = config != null ? config : new Idea67646Config();
