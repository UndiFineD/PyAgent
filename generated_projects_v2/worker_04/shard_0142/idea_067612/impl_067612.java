...
@Data
public class Idea67612Config {
    private String name = "idea_067612";
 ...
 */
@Slf4j
public class Idea67612Service {
    private static final int IDEA_ID = 67612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67612Service() {
        this(new Idea67612Config());
    }

    public Idea67612Service(Idea67612Config config) {
        this.config = config != null ? config : new Idea67612Config();
