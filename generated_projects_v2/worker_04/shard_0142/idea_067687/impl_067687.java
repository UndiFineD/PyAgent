...
@Data
public class Idea67687Config {
    private String name = "idea_067687";
 ...
 */
@Slf4j
public class Idea67687Service {
    private static final int IDEA_ID = 67687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67687Service() {
        this(new Idea67687Config());
    }

    public Idea67687Service(Idea67687Config config) {
        this.config = config != null ? config : new Idea67687Config();
