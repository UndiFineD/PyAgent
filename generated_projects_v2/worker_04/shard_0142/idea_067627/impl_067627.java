...
@Data
public class Idea67627Config {
    private String name = "idea_067627";
 ...
 */
@Slf4j
public class Idea67627Service {
    private static final int IDEA_ID = 67627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67627Service() {
        this(new Idea67627Config());
    }

    public Idea67627Service(Idea67627Config config) {
        this.config = config != null ? config : new Idea67627Config();
