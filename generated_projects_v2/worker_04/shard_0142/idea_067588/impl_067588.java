...
@Data
public class Idea67588Config {
    private String name = "idea_067588";
 ...
 */
@Slf4j
public class Idea67588Service {
    private static final int IDEA_ID = 67588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67588Service() {
        this(new Idea67588Config());
    }

    public Idea67588Service(Idea67588Config config) {
        this.config = config != null ? config : new Idea67588Config();
