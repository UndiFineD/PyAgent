...
@Data
public class Idea67647Config {
    private String name = "idea_067647";
 ...
 */
@Slf4j
public class Idea67647Service {
    private static final int IDEA_ID = 67647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67647Service() {
        this(new Idea67647Config());
    }

    public Idea67647Service(Idea67647Config config) {
        this.config = config != null ? config : new Idea67647Config();
