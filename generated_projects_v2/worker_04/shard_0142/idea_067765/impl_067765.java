...
@Data
public class Idea67765Config {
    private String name = "idea_067765";
 ...
 */
@Slf4j
public class Idea67765Service {
    private static final int IDEA_ID = 67765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67765Service() {
        this(new Idea67765Config());
    }

    public Idea67765Service(Idea67765Config config) {
        this.config = config != null ? config : new Idea67765Config();
