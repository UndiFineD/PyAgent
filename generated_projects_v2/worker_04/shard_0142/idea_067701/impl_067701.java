...
@Data
public class Idea67701Config {
    private String name = "idea_067701";
 ...
 */
@Slf4j
public class Idea67701Service {
    private static final int IDEA_ID = 67701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67701Service() {
        this(new Idea67701Config());
    }

    public Idea67701Service(Idea67701Config config) {
        this.config = config != null ? config : new Idea67701Config();
