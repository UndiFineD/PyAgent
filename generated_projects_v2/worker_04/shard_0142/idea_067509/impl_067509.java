...
@Data
public class Idea67509Config {
    private String name = "idea_067509";
 ...
 */
@Slf4j
public class Idea67509Service {
    private static final int IDEA_ID = 67509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67509Service() {
        this(new Idea67509Config());
    }

    public Idea67509Service(Idea67509Config config) {
        this.config = config != null ? config : new Idea67509Config();
