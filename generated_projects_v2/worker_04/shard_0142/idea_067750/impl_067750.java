...
@Data
public class Idea67750Config {
    private String name = "idea_067750";
 ...
 */
@Slf4j
public class Idea67750Service {
    private static final int IDEA_ID = 67750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67750Service() {
        this(new Idea67750Config());
    }

    public Idea67750Service(Idea67750Config config) {
        this.config = config != null ? config : new Idea67750Config();
