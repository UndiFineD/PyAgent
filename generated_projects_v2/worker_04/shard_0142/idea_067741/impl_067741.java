...
@Data
public class Idea67741Config {
    private String name = "idea_067741";
 ...
 */
@Slf4j
public class Idea67741Service {
    private static final int IDEA_ID = 67741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67741Service() {
        this(new Idea67741Config());
    }

    public Idea67741Service(Idea67741Config config) {
        this.config = config != null ? config : new Idea67741Config();
