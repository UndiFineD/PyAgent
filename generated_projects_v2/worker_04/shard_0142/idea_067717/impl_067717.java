...
@Data
public class Idea67717Config {
    private String name = "idea_067717";
 ...
 */
@Slf4j
public class Idea67717Service {
    private static final int IDEA_ID = 67717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67717Service() {
        this(new Idea67717Config());
    }

    public Idea67717Service(Idea67717Config config) {
        this.config = config != null ? config : new Idea67717Config();
