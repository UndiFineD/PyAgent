...
@Data
public class Idea67806Config {
    private String name = "idea_067806";
 ...
 */
@Slf4j
public class Idea67806Service {
    private static final int IDEA_ID = 67806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67806Service() {
        this(new Idea67806Config());
    }

    public Idea67806Service(Idea67806Config config) {
        this.config = config != null ? config : new Idea67806Config();
