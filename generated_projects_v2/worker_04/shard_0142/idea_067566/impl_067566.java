...
@Data
public class Idea67566Config {
    private String name = "idea_067566";
 ...
 */
@Slf4j
public class Idea67566Service {
    private static final int IDEA_ID = 67566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67566Service() {
        this(new Idea67566Config());
    }

    public Idea67566Service(Idea67566Config config) {
        this.config = config != null ? config : new Idea67566Config();
