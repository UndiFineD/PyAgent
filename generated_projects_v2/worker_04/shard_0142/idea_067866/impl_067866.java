...
@Data
public class Idea67866Config {
    private String name = "idea_067866";
 ...
 */
@Slf4j
public class Idea67866Service {
    private static final int IDEA_ID = 67866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67866Service() {
        this(new Idea67866Config());
    }

    public Idea67866Service(Idea67866Config config) {
        this.config = config != null ? config : new Idea67866Config();
