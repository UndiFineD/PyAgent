...
@Data
public class Idea67911Config {
    private String name = "idea_067911";
 ...
 */
@Slf4j
public class Idea67911Service {
    private static final int IDEA_ID = 67911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67911Service() {
        this(new Idea67911Config());
    }

    public Idea67911Service(Idea67911Config config) {
        this.config = config != null ? config : new Idea67911Config();
