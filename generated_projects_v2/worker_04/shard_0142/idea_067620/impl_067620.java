...
@Data
public class Idea67620Config {
    private String name = "idea_067620";
 ...
 */
@Slf4j
public class Idea67620Service {
    private static final int IDEA_ID = 67620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67620Service() {
        this(new Idea67620Config());
    }

    public Idea67620Service(Idea67620Config config) {
        this.config = config != null ? config : new Idea67620Config();
