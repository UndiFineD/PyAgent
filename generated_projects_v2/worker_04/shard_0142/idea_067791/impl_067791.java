...
@Data
public class Idea67791Config {
    private String name = "idea_067791";
 ...
 */
@Slf4j
public class Idea67791Service {
    private static final int IDEA_ID = 67791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67791Service() {
        this(new Idea67791Config());
    }

    public Idea67791Service(Idea67791Config config) {
        this.config = config != null ? config : new Idea67791Config();
