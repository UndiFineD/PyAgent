...
@Data
public class Idea67547Config {
    private String name = "idea_067547";
 ...
 */
@Slf4j
public class Idea67547Service {
    private static final int IDEA_ID = 67547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67547Service() {
        this(new Idea67547Config());
    }

    public Idea67547Service(Idea67547Config config) {
        this.config = config != null ? config : new Idea67547Config();
