...
@Data
public class Idea67506Config {
    private String name = "idea_067506";
 ...
 */
@Slf4j
public class Idea67506Service {
    private static final int IDEA_ID = 67506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67506Service() {
        this(new Idea67506Config());
    }

    public Idea67506Service(Idea67506Config config) {
        this.config = config != null ? config : new Idea67506Config();
