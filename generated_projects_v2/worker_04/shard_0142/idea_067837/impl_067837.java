...
@Data
public class Idea67837Config {
    private String name = "idea_067837";
 ...
 */
@Slf4j
public class Idea67837Service {
    private static final int IDEA_ID = 67837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67837Service() {
        this(new Idea67837Config());
    }

    public Idea67837Service(Idea67837Config config) {
        this.config = config != null ? config : new Idea67837Config();
