...
@Data
public class Idea67781Config {
    private String name = "idea_067781";
 ...
 */
@Slf4j
public class Idea67781Service {
    private static final int IDEA_ID = 67781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67781Service() {
        this(new Idea67781Config());
    }

    public Idea67781Service(Idea67781Config config) {
        this.config = config != null ? config : new Idea67781Config();
