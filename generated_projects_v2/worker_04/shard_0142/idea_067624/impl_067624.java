...
@Data
public class Idea67624Config {
    private String name = "idea_067624";
 ...
 */
@Slf4j
public class Idea67624Service {
    private static final int IDEA_ID = 67624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67624Service() {
        this(new Idea67624Config());
    }

    public Idea67624Service(Idea67624Config config) {
        this.config = config != null ? config : new Idea67624Config();
