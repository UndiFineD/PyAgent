...
@Data
public class Idea67696Config {
    private String name = "idea_067696";
 ...
 */
@Slf4j
public class Idea67696Service {
    private static final int IDEA_ID = 67696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67696Service() {
        this(new Idea67696Config());
    }

    public Idea67696Service(Idea67696Config config) {
        this.config = config != null ? config : new Idea67696Config();
