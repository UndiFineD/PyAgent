...
@Data
public class Idea67823Config {
    private String name = "idea_067823";
 ...
 */
@Slf4j
public class Idea67823Service {
    private static final int IDEA_ID = 67823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67823Service() {
        this(new Idea67823Config());
    }

    public Idea67823Service(Idea67823Config config) {
        this.config = config != null ? config : new Idea67823Config();
