...
@Data
public class Idea67631Config {
    private String name = "idea_067631";
 ...
 */
@Slf4j
public class Idea67631Service {
    private static final int IDEA_ID = 67631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67631Service() {
        this(new Idea67631Config());
    }

    public Idea67631Service(Idea67631Config config) {
        this.config = config != null ? config : new Idea67631Config();
