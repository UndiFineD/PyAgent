...
@Data
public class Idea67502Config {
    private String name = "idea_067502";
 ...
 */
@Slf4j
public class Idea67502Service {
    private static final int IDEA_ID = 67502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67502Service() {
        this(new Idea67502Config());
    }

    public Idea67502Service(Idea67502Config config) {
        this.config = config != null ? config : new Idea67502Config();
