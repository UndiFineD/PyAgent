...
@Data
public class Idea67505Config {
    private String name = "idea_067505";
 ...
 */
@Slf4j
public class Idea67505Service {
    private static final int IDEA_ID = 67505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67505Service() {
        this(new Idea67505Config());
    }

    public Idea67505Service(Idea67505Config config) {
        this.config = config != null ? config : new Idea67505Config();
