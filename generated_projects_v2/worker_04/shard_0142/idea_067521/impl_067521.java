...
@Data
public class Idea67521Config {
    private String name = "idea_067521";
 ...
 */
@Slf4j
public class Idea67521Service {
    private static final int IDEA_ID = 67521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67521Service() {
        this(new Idea67521Config());
    }

    public Idea67521Service(Idea67521Config config) {
        this.config = config != null ? config : new Idea67521Config();
