...
@Data
public class Idea67872Config {
    private String name = "idea_067872";
 ...
 */
@Slf4j
public class Idea67872Service {
    private static final int IDEA_ID = 67872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67872Service() {
        this(new Idea67872Config());
    }

    public Idea67872Service(Idea67872Config config) {
        this.config = config != null ? config : new Idea67872Config();
