...
@Data
public class Idea67898Config {
    private String name = "idea_067898";
 ...
 */
@Slf4j
public class Idea67898Service {
    private static final int IDEA_ID = 67898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67898Service() {
        this(new Idea67898Config());
    }

    public Idea67898Service(Idea67898Config config) {
        this.config = config != null ? config : new Idea67898Config();
