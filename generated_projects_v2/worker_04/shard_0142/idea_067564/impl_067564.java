...
@Data
public class Idea67564Config {
    private String name = "idea_067564";
 ...
 */
@Slf4j
public class Idea67564Service {
    private static final int IDEA_ID = 67564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67564Service() {
        this(new Idea67564Config());
    }

    public Idea67564Service(Idea67564Config config) {
        this.config = config != null ? config : new Idea67564Config();
