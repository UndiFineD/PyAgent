...
@Data
public class Idea67838Config {
    private String name = "idea_067838";
 ...
 */
@Slf4j
public class Idea67838Service {
    private static final int IDEA_ID = 67838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67838Service() {
        this(new Idea67838Config());
    }

    public Idea67838Service(Idea67838Config config) {
        this.config = config != null ? config : new Idea67838Config();
