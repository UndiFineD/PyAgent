...
@Data
public class Idea67613Config {
    private String name = "idea_067613";
 ...
 */
@Slf4j
public class Idea67613Service {
    private static final int IDEA_ID = 67613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67613Service() {
        this(new Idea67613Config());
    }

    public Idea67613Service(Idea67613Config config) {
        this.config = config != null ? config : new Idea67613Config();
