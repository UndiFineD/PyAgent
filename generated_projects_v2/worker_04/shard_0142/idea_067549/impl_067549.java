...
@Data
public class Idea67549Config {
    private String name = "idea_067549";
 ...
 */
@Slf4j
public class Idea67549Service {
    private static final int IDEA_ID = 67549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67549Service() {
        this(new Idea67549Config());
    }

    public Idea67549Service(Idea67549Config config) {
        this.config = config != null ? config : new Idea67549Config();
