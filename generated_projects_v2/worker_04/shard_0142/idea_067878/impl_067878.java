...
@Data
public class Idea67878Config {
    private String name = "idea_067878";
 ...
 */
@Slf4j
public class Idea67878Service {
    private static final int IDEA_ID = 67878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67878Service() {
        this(new Idea67878Config());
    }

    public Idea67878Service(Idea67878Config config) {
        this.config = config != null ? config : new Idea67878Config();
