...
@Data
public class Idea67525Config {
    private String name = "idea_067525";
 ...
 */
@Slf4j
public class Idea67525Service {
    private static final int IDEA_ID = 67525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67525Service() {
        this(new Idea67525Config());
    }

    public Idea67525Service(Idea67525Config config) {
        this.config = config != null ? config : new Idea67525Config();
