...
@Data
public class Idea67585Config {
    private String name = "idea_067585";
 ...
 */
@Slf4j
public class Idea67585Service {
    private static final int IDEA_ID = 67585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67585Service() {
        this(new Idea67585Config());
    }

    public Idea67585Service(Idea67585Config config) {
        this.config = config != null ? config : new Idea67585Config();
