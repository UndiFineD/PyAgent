...
@Data
public class Idea67818Config {
    private String name = "idea_067818";
 ...
 */
@Slf4j
public class Idea67818Service {
    private static final int IDEA_ID = 67818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67818Service() {
        this(new Idea67818Config());
    }

    public Idea67818Service(Idea67818Config config) {
        this.config = config != null ? config : new Idea67818Config();
