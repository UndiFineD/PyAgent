...
@Data
public class Idea67507Config {
    private String name = "idea_067507";
 ...
 */
@Slf4j
public class Idea67507Service {
    private static final int IDEA_ID = 67507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67507Service() {
        this(new Idea67507Config());
    }

    public Idea67507Service(Idea67507Config config) {
        this.config = config != null ? config : new Idea67507Config();
