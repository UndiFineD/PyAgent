...
@Data
public class Idea67622Config {
    private String name = "idea_067622";
 ...
 */
@Slf4j
public class Idea67622Service {
    private static final int IDEA_ID = 67622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67622Service() {
        this(new Idea67622Config());
    }

    public Idea67622Service(Idea67622Config config) {
        this.config = config != null ? config : new Idea67622Config();
