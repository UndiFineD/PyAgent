...
@Data
public class Idea67901Config {
    private String name = "idea_067901";
 ...
 */
@Slf4j
public class Idea67901Service {
    private static final int IDEA_ID = 67901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67901Service() {
        this(new Idea67901Config());
    }

    public Idea67901Service(Idea67901Config config) {
        this.config = config != null ? config : new Idea67901Config();
