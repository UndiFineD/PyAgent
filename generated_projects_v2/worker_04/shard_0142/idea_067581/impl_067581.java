...
@Data
public class Idea67581Config {
    private String name = "idea_067581";
 ...
 */
@Slf4j
public class Idea67581Service {
    private static final int IDEA_ID = 67581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67581Service() {
        this(new Idea67581Config());
    }

    public Idea67581Service(Idea67581Config config) {
        this.config = config != null ? config : new Idea67581Config();
