...
@Data
public class Idea67786Config {
    private String name = "idea_067786";
 ...
 */
@Slf4j
public class Idea67786Service {
    private static final int IDEA_ID = 67786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67786Service() {
        this(new Idea67786Config());
    }

    public Idea67786Service(Idea67786Config config) {
        this.config = config != null ? config : new Idea67786Config();
