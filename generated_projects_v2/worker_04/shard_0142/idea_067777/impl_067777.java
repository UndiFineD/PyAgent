...
@Data
public class Idea67777Config {
    private String name = "idea_067777";
 ...
 */
@Slf4j
public class Idea67777Service {
    private static final int IDEA_ID = 67777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67777Service() {
        this(new Idea67777Config());
    }

    public Idea67777Service(Idea67777Config config) {
        this.config = config != null ? config : new Idea67777Config();
