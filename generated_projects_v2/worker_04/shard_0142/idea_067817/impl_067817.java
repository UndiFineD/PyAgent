...
@Data
public class Idea67817Config {
    private String name = "idea_067817";
 ...
 */
@Slf4j
public class Idea67817Service {
    private static final int IDEA_ID = 67817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67817Service() {
        this(new Idea67817Config());
    }

    public Idea67817Service(Idea67817Config config) {
        this.config = config != null ? config : new Idea67817Config();
