...
@Data
public class Idea67802Config {
    private String name = "idea_067802";
 ...
 */
@Slf4j
public class Idea67802Service {
    private static final int IDEA_ID = 67802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67802Service() {
        this(new Idea67802Config());
    }

    public Idea67802Service(Idea67802Config config) {
        this.config = config != null ? config : new Idea67802Config();
