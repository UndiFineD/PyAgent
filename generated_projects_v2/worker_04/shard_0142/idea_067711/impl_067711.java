...
@Data
public class Idea67711Config {
    private String name = "idea_067711";
 ...
 */
@Slf4j
public class Idea67711Service {
    private static final int IDEA_ID = 67711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67711Service() {
        this(new Idea67711Config());
    }

    public Idea67711Service(Idea67711Config config) {
        this.config = config != null ? config : new Idea67711Config();
