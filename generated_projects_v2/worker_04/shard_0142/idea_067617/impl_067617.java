...
@Data
public class Idea67617Config {
    private String name = "idea_067617";
 ...
 */
@Slf4j
public class Idea67617Service {
    private static final int IDEA_ID = 67617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67617Service() {
        this(new Idea67617Config());
    }

    public Idea67617Service(Idea67617Config config) {
        this.config = config != null ? config : new Idea67617Config();
