...
@Data
public class Idea67917Config {
    private String name = "idea_067917";
 ...
 */
@Slf4j
public class Idea67917Service {
    private static final int IDEA_ID = 67917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67917Service() {
        this(new Idea67917Config());
    }

    public Idea67917Service(Idea67917Config config) {
        this.config = config != null ? config : new Idea67917Config();
