...
@Data
public class Idea67747Config {
    private String name = "idea_067747";
 ...
 */
@Slf4j
public class Idea67747Service {
    private static final int IDEA_ID = 67747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67747Service() {
        this(new Idea67747Config());
    }

    public Idea67747Service(Idea67747Config config) {
        this.config = config != null ? config : new Idea67747Config();
