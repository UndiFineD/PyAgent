...
@Data
public class Idea67504Config {
    private String name = "idea_067504";
 ...
 */
@Slf4j
public class Idea67504Service {
    private static final int IDEA_ID = 67504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67504Service() {
        this(new Idea67504Config());
    }

    public Idea67504Service(Idea67504Config config) {
        this.config = config != null ? config : new Idea67504Config();
