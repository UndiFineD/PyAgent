...
@Data
public class Idea67920Config {
    private String name = "idea_067920";
 ...
 */
@Slf4j
public class Idea67920Service {
    private static final int IDEA_ID = 67920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67920Service() {
        this(new Idea67920Config());
    }

    public Idea67920Service(Idea67920Config config) {
        this.config = config != null ? config : new Idea67920Config();
