...
@Data
public class Idea67774Config {
    private String name = "idea_067774";
 ...
 */
@Slf4j
public class Idea67774Service {
    private static final int IDEA_ID = 67774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67774Service() {
        this(new Idea67774Config());
    }

    public Idea67774Service(Idea67774Config config) {
        this.config = config != null ? config : new Idea67774Config();
