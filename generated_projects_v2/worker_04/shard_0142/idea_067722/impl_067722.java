...
@Data
public class Idea67722Config {
    private String name = "idea_067722";
 ...
 */
@Slf4j
public class Idea67722Service {
    private static final int IDEA_ID = 67722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67722Service() {
        this(new Idea67722Config());
    }

    public Idea67722Service(Idea67722Config config) {
        this.config = config != null ? config : new Idea67722Config();
