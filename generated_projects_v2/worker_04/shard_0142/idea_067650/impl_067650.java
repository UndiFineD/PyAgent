...
@Data
public class Idea67650Config {
    private String name = "idea_067650";
 ...
 */
@Slf4j
public class Idea67650Service {
    private static final int IDEA_ID = 67650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67650Service() {
        this(new Idea67650Config());
    }

    public Idea67650Service(Idea67650Config config) {
        this.config = config != null ? config : new Idea67650Config();
