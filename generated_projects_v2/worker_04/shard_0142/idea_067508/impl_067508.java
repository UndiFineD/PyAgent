...
@Data
public class Idea67508Config {
    private String name = "idea_067508";
 ...
 */
@Slf4j
public class Idea67508Service {
    private static final int IDEA_ID = 67508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67508Service() {
        this(new Idea67508Config());
    }

    public Idea67508Service(Idea67508Config config) {
        this.config = config != null ? config : new Idea67508Config();
