...
@Data
public class Idea68971Config {
    private String name = "idea_068971";
 ...
 */
@Slf4j
public class Idea68971Service {
    private static final int IDEA_ID = 68971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68971Service() {
        this(new Idea68971Config());
    }

    public Idea68971Service(Idea68971Config config) {
        this.config = config != null ? config : new Idea68971Config();
