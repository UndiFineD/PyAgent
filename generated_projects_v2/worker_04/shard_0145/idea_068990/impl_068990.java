...
@Data
public class Idea68990Config {
    private String name = "idea_068990";
 ...
 */
@Slf4j
public class Idea68990Service {
    private static final int IDEA_ID = 68990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68990Service() {
        this(new Idea68990Config());
    }

    public Idea68990Service(Idea68990Config config) {
        this.config = config != null ? config : new Idea68990Config();
