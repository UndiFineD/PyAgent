...
@Data
public class Idea69201Config {
    private String name = "idea_069201";
 ...
 */
@Slf4j
public class Idea69201Service {
    private static final int IDEA_ID = 69201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69201Service() {
        this(new Idea69201Config());
    }

    public Idea69201Service(Idea69201Config config) {
        this.config = config != null ? config : new Idea69201Config();
