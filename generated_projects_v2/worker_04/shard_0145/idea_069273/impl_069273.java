...
@Data
public class Idea69273Config {
    private String name = "idea_069273";
 ...
 */
@Slf4j
public class Idea69273Service {
    private static final int IDEA_ID = 69273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69273Service() {
        this(new Idea69273Config());
    }

    public Idea69273Service(Idea69273Config config) {
        this.config = config != null ? config : new Idea69273Config();
