...
@Data
public class Idea69236Config {
    private String name = "idea_069236";
 ...
 */
@Slf4j
public class Idea69236Service {
    private static final int IDEA_ID = 69236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69236Service() {
        this(new Idea69236Config());
    }

    public Idea69236Service(Idea69236Config config) {
        this.config = config != null ? config : new Idea69236Config();
