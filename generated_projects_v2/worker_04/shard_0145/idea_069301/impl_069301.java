...
@Data
public class Idea69301Config {
    private String name = "idea_069301";
 ...
 */
@Slf4j
public class Idea69301Service {
    private static final int IDEA_ID = 69301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69301Service() {
        this(new Idea69301Config());
    }

    public Idea69301Service(Idea69301Config config) {
        this.config = config != null ? config : new Idea69301Config();
