...
@Data
public class Idea69005Config {
    private String name = "idea_069005";
 ...
 */
@Slf4j
public class Idea69005Service {
    private static final int IDEA_ID = 69005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69005Service() {
        this(new Idea69005Config());
    }

    public Idea69005Service(Idea69005Config config) {
        this.config = config != null ? config : new Idea69005Config();
