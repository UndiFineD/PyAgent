...
@Data
public class Idea69097Config {
    private String name = "idea_069097";
 ...
 */
@Slf4j
public class Idea69097Service {
    private static final int IDEA_ID = 69097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69097Service() {
        this(new Idea69097Config());
    }

    public Idea69097Service(Idea69097Config config) {
        this.config = config != null ? config : new Idea69097Config();
