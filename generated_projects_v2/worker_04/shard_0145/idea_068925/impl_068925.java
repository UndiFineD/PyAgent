...
@Data
public class Idea68925Config {
    private String name = "idea_068925";
 ...
 */
@Slf4j
public class Idea68925Service {
    private static final int IDEA_ID = 68925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68925Service() {
        this(new Idea68925Config());
    }

    public Idea68925Service(Idea68925Config config) {
        this.config = config != null ? config : new Idea68925Config();
