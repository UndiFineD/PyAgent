...
@Data
public class Idea69106Config {
    private String name = "idea_069106";
 ...
 */
@Slf4j
public class Idea69106Service {
    private static final int IDEA_ID = 69106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69106Service() {
        this(new Idea69106Config());
    }

    public Idea69106Service(Idea69106Config config) {
        this.config = config != null ? config : new Idea69106Config();
