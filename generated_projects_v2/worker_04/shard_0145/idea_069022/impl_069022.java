...
@Data
public class Idea69022Config {
    private String name = "idea_069022";
 ...
 */
@Slf4j
public class Idea69022Service {
    private static final int IDEA_ID = 69022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69022Service() {
        this(new Idea69022Config());
    }

    public Idea69022Service(Idea69022Config config) {
        this.config = config != null ? config : new Idea69022Config();
