...
@Data
public class Idea68973Config {
    private String name = "idea_068973";
 ...
 */
@Slf4j
public class Idea68973Service {
    private static final int IDEA_ID = 68973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68973Service() {
        this(new Idea68973Config());
    }

    public Idea68973Service(Idea68973Config config) {
        this.config = config != null ? config : new Idea68973Config();
