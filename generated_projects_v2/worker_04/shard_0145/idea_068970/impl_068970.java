...
@Data
public class Idea68970Config {
    private String name = "idea_068970";
 ...
 */
@Slf4j
public class Idea68970Service {
    private static final int IDEA_ID = 68970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68970Service() {
        this(new Idea68970Config());
    }

    public Idea68970Service(Idea68970Config config) {
        this.config = config != null ? config : new Idea68970Config();
