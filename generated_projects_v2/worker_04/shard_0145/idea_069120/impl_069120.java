...
@Data
public class Idea69120Config {
    private String name = "idea_069120";
 ...
 */
@Slf4j
public class Idea69120Service {
    private static final int IDEA_ID = 69120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69120Service() {
        this(new Idea69120Config());
    }

    public Idea69120Service(Idea69120Config config) {
        this.config = config != null ? config : new Idea69120Config();
