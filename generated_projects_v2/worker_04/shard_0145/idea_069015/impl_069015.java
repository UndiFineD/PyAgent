...
@Data
public class Idea69015Config {
    private String name = "idea_069015";
 ...
 */
@Slf4j
public class Idea69015Service {
    private static final int IDEA_ID = 69015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69015Service() {
        this(new Idea69015Config());
    }

    public Idea69015Service(Idea69015Config config) {
        this.config = config != null ? config : new Idea69015Config();
