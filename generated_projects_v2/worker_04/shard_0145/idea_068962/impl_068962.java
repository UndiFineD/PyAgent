...
@Data
public class Idea68962Config {
    private String name = "idea_068962";
 ...
 */
@Slf4j
public class Idea68962Service {
    private static final int IDEA_ID = 68962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68962Service() {
        this(new Idea68962Config());
    }

    public Idea68962Service(Idea68962Config config) {
        this.config = config != null ? config : new Idea68962Config();
