...
@Data
public class Idea69076Config {
    private String name = "idea_069076";
 ...
 */
@Slf4j
public class Idea69076Service {
    private static final int IDEA_ID = 69076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69076Service() {
        this(new Idea69076Config());
    }

    public Idea69076Service(Idea69076Config config) {
        this.config = config != null ? config : new Idea69076Config();
