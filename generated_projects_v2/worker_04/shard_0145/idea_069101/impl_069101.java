...
@Data
public class Idea69101Config {
    private String name = "idea_069101";
 ...
 */
@Slf4j
public class Idea69101Service {
    private static final int IDEA_ID = 69101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69101Service() {
        this(new Idea69101Config());
    }

    public Idea69101Service(Idea69101Config config) {
        this.config = config != null ? config : new Idea69101Config();
