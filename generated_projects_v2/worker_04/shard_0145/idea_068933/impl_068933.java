...
@Data
public class Idea68933Config {
    private String name = "idea_068933";
 ...
 */
@Slf4j
public class Idea68933Service {
    private static final int IDEA_ID = 68933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68933Service() {
        this(new Idea68933Config());
    }

    public Idea68933Service(Idea68933Config config) {
        this.config = config != null ? config : new Idea68933Config();
