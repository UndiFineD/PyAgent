...
@Data
public class Idea68950Config {
    private String name = "idea_068950";
 ...
 */
@Slf4j
public class Idea68950Service {
    private static final int IDEA_ID = 68950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68950Service() {
        this(new Idea68950Config());
    }

    public Idea68950Service(Idea68950Config config) {
        this.config = config != null ? config : new Idea68950Config();
