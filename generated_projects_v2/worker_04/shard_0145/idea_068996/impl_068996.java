...
@Data
public class Idea68996Config {
    private String name = "idea_068996";
 ...
 */
@Slf4j
public class Idea68996Service {
    private static final int IDEA_ID = 68996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68996Service() {
        this(new Idea68996Config());
    }

    public Idea68996Service(Idea68996Config config) {
        this.config = config != null ? config : new Idea68996Config();
