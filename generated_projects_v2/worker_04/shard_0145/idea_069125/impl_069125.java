...
@Data
public class Idea69125Config {
    private String name = "idea_069125";
 ...
 */
@Slf4j
public class Idea69125Service {
    private static final int IDEA_ID = 69125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69125Service() {
        this(new Idea69125Config());
    }

    public Idea69125Service(Idea69125Config config) {
        this.config = config != null ? config : new Idea69125Config();
