...
@Data
public class Idea69036Config {
    private String name = "idea_069036";
 ...
 */
@Slf4j
public class Idea69036Service {
    private static final int IDEA_ID = 69036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69036Service() {
        this(new Idea69036Config());
    }

    public Idea69036Service(Idea69036Config config) {
        this.config = config != null ? config : new Idea69036Config();
