...
@Data
public class Idea69128Config {
    private String name = "idea_069128";
 ...
 */
@Slf4j
public class Idea69128Service {
    private static final int IDEA_ID = 69128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69128Service() {
        this(new Idea69128Config());
    }

    public Idea69128Service(Idea69128Config config) {
        this.config = config != null ? config : new Idea69128Config();
