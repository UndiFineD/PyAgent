...
@Data
public class Idea68987Config {
    private String name = "idea_068987";
 ...
 */
@Slf4j
public class Idea68987Service {
    private static final int IDEA_ID = 68987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68987Service() {
        this(new Idea68987Config());
    }

    public Idea68987Service(Idea68987Config config) {
        this.config = config != null ? config : new Idea68987Config();
