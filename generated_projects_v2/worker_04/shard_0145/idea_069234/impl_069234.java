...
@Data
public class Idea69234Config {
    private String name = "idea_069234";
 ...
 */
@Slf4j
public class Idea69234Service {
    private static final int IDEA_ID = 69234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69234Service() {
        this(new Idea69234Config());
    }

    public Idea69234Service(Idea69234Config config) {
        this.config = config != null ? config : new Idea69234Config();
