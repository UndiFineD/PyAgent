...
@Data
public class Idea69171Config {
    private String name = "idea_069171";
 ...
 */
@Slf4j
public class Idea69171Service {
    private static final int IDEA_ID = 69171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69171Service() {
        this(new Idea69171Config());
    }

    public Idea69171Service(Idea69171Config config) {
        this.config = config != null ? config : new Idea69171Config();
