...
@Data
public class Idea68960Config {
    private String name = "idea_068960";
 ...
 */
@Slf4j
public class Idea68960Service {
    private static final int IDEA_ID = 68960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68960Service() {
        this(new Idea68960Config());
    }

    public Idea68960Service(Idea68960Config config) {
        this.config = config != null ? config : new Idea68960Config();
