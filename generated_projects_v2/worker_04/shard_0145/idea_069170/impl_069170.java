...
@Data
public class Idea69170Config {
    private String name = "idea_069170";
 ...
 */
@Slf4j
public class Idea69170Service {
    private static final int IDEA_ID = 69170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69170Service() {
        this(new Idea69170Config());
    }

    public Idea69170Service(Idea69170Config config) {
        this.config = config != null ? config : new Idea69170Config();
