...
@Data
public class Idea69115Config {
    private String name = "idea_069115";
 ...
 */
@Slf4j
public class Idea69115Service {
    private static final int IDEA_ID = 69115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69115Service() {
        this(new Idea69115Config());
    }

    public Idea69115Service(Idea69115Config config) {
        this.config = config != null ? config : new Idea69115Config();
