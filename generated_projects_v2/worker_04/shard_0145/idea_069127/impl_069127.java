...
@Data
public class Idea69127Config {
    private String name = "idea_069127";
 ...
 */
@Slf4j
public class Idea69127Service {
    private static final int IDEA_ID = 69127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69127Service() {
        this(new Idea69127Config());
    }

    public Idea69127Service(Idea69127Config config) {
        this.config = config != null ? config : new Idea69127Config();
