...
@Data
public class Idea69100Config {
    private String name = "idea_069100";
 ...
 */
@Slf4j
public class Idea69100Service {
    private static final int IDEA_ID = 69100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69100Service() {
        this(new Idea69100Config());
    }

    public Idea69100Service(Idea69100Config config) {
        this.config = config != null ? config : new Idea69100Config();
