...
@Data
public class Idea69096Config {
    private String name = "idea_069096";
 ...
 */
@Slf4j
public class Idea69096Service {
    private static final int IDEA_ID = 69096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69096Service() {
        this(new Idea69096Config());
    }

    public Idea69096Service(Idea69096Config config) {
        this.config = config != null ? config : new Idea69096Config();
