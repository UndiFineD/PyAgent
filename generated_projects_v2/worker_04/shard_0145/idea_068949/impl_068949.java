...
@Data
public class Idea68949Config {
    private String name = "idea_068949";
 ...
 */
@Slf4j
public class Idea68949Service {
    private static final int IDEA_ID = 68949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68949Service() {
        this(new Idea68949Config());
    }

    public Idea68949Service(Idea68949Config config) {
        this.config = config != null ? config : new Idea68949Config();
