...
@Data
public class Idea68958Config {
    private String name = "idea_068958";
 ...
 */
@Slf4j
public class Idea68958Service {
    private static final int IDEA_ID = 68958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68958Service() {
        this(new Idea68958Config());
    }

    public Idea68958Service(Idea68958Config config) {
        this.config = config != null ? config : new Idea68958Config();
