...
@Data
public class Idea69012Config {
    private String name = "idea_069012";
 ...
 */
@Slf4j
public class Idea69012Service {
    private static final int IDEA_ID = 69012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69012Service() {
        this(new Idea69012Config());
    }

    public Idea69012Service(Idea69012Config config) {
        this.config = config != null ? config : new Idea69012Config();
