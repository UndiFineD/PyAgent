...
@Data
public class Idea68963Config {
    private String name = "idea_068963";
 ...
 */
@Slf4j
public class Idea68963Service {
    private static final int IDEA_ID = 68963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68963Service() {
        this(new Idea68963Config());
    }

    public Idea68963Service(Idea68963Config config) {
        this.config = config != null ? config : new Idea68963Config();
