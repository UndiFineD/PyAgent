...
@Data
public class Idea68901Config {
    private String name = "idea_068901";
 ...
 */
@Slf4j
public class Idea68901Service {
    private static final int IDEA_ID = 68901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68901Service() {
        this(new Idea68901Config());
    }

    public Idea68901Service(Idea68901Config config) {
        this.config = config != null ? config : new Idea68901Config();
