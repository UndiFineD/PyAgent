...
@Data
public class Idea69038Config {
    private String name = "idea_069038";
 ...
 */
@Slf4j
public class Idea69038Service {
    private static final int IDEA_ID = 69038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69038Service() {
        this(new Idea69038Config());
    }

    public Idea69038Service(Idea69038Config config) {
        this.config = config != null ? config : new Idea69038Config();
