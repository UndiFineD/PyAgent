...
@Data
public class Idea68937Config {
    private String name = "idea_068937";
 ...
 */
@Slf4j
public class Idea68937Service {
    private static final int IDEA_ID = 68937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68937Service() {
        this(new Idea68937Config());
    }

    public Idea68937Service(Idea68937Config config) {
        this.config = config != null ? config : new Idea68937Config();
