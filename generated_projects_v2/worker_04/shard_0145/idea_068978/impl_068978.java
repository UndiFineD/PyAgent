...
@Data
public class Idea68978Config {
    private String name = "idea_068978";
 ...
 */
@Slf4j
public class Idea68978Service {
    private static final int IDEA_ID = 68978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68978Service() {
        this(new Idea68978Config());
    }

    public Idea68978Service(Idea68978Config config) {
        this.config = config != null ? config : new Idea68978Config();
