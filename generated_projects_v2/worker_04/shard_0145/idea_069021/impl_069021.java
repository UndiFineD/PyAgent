...
@Data
public class Idea69021Config {
    private String name = "idea_069021";
 ...
 */
@Slf4j
public class Idea69021Service {
    private static final int IDEA_ID = 69021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69021Service() {
        this(new Idea69021Config());
    }

    public Idea69021Service(Idea69021Config config) {
        this.config = config != null ? config : new Idea69021Config();
