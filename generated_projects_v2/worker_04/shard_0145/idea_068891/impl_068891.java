...
@Data
public class Idea68891Config {
    private String name = "idea_068891";
 ...
 */
@Slf4j
public class Idea68891Service {
    private static final int IDEA_ID = 68891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68891Service() {
        this(new Idea68891Config());
    }

    public Idea68891Service(Idea68891Config config) {
        this.config = config != null ? config : new Idea68891Config();
