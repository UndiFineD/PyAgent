...
@Data
public class Idea58624Config {
    private String name = "idea_058624";
 ...
 */
@Slf4j
public class Idea58624Service {
    private static final int IDEA_ID = 58624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58624Service() {
        this(new Idea58624Config());
    }

    public Idea58624Service(Idea58624Config config) {
        this.config = config != null ? config : new Idea58624Config();
