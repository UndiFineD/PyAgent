...
@Data
public class Idea58864Config {
    private String name = "idea_058864";
 ...
 */
@Slf4j
public class Idea58864Service {
    private static final int IDEA_ID = 58864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58864Service() {
        this(new Idea58864Config());
    }

    public Idea58864Service(Idea58864Config config) {
        this.config = config != null ? config : new Idea58864Config();
