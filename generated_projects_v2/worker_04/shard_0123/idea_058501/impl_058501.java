...
@Data
public class Idea58501Config {
    private String name = "idea_058501";
 ...
 */
@Slf4j
public class Idea58501Service {
    private static final int IDEA_ID = 58501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58501Service() {
        this(new Idea58501Config());
    }

    public Idea58501Service(Idea58501Config config) {
        this.config = config != null ? config : new Idea58501Config();
