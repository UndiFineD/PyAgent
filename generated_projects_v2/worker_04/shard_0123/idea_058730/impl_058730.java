...
@Data
public class Idea58730Config {
    private String name = "idea_058730";
 ...
 */
@Slf4j
public class Idea58730Service {
    private static final int IDEA_ID = 58730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58730Service() {
        this(new Idea58730Config());
    }

    public Idea58730Service(Idea58730Config config) {
        this.config = config != null ? config : new Idea58730Config();
