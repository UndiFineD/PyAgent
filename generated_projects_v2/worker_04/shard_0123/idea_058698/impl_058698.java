...
@Data
public class Idea58698Config {
    private String name = "idea_058698";
 ...
 */
@Slf4j
public class Idea58698Service {
    private static final int IDEA_ID = 58698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58698Service() {
        this(new Idea58698Config());
    }

    public Idea58698Service(Idea58698Config config) {
        this.config = config != null ? config : new Idea58698Config();
