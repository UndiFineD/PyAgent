...
@Data
public class Idea58440Config {
    private String name = "idea_058440";
 ...
 */
@Slf4j
public class Idea58440Service {
    private static final int IDEA_ID = 58440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58440Service() {
        this(new Idea58440Config());
    }

    public Idea58440Service(Idea58440Config config) {
        this.config = config != null ? config : new Idea58440Config();
