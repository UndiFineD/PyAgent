...
@Data
public class Idea58603Config {
    private String name = "idea_058603";
 ...
 */
@Slf4j
public class Idea58603Service {
    private static final int IDEA_ID = 58603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58603Service() {
        this(new Idea58603Config());
    }

    public Idea58603Service(Idea58603Config config) {
        this.config = config != null ? config : new Idea58603Config();
