...
@Data
public class Idea58447Config {
    private String name = "idea_058447";
 ...
 */
@Slf4j
public class Idea58447Service {
    private static final int IDEA_ID = 58447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58447Service() {
        this(new Idea58447Config());
    }

    public Idea58447Service(Idea58447Config config) {
        this.config = config != null ? config : new Idea58447Config();
