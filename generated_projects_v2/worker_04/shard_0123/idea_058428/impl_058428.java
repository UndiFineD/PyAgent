...
@Data
public class Idea58428Config {
    private String name = "idea_058428";
 ...
 */
@Slf4j
public class Idea58428Service {
    private static final int IDEA_ID = 58428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58428Service() {
        this(new Idea58428Config());
    }

    public Idea58428Service(Idea58428Config config) {
        this.config = config != null ? config : new Idea58428Config();
