...
@Data
public class Idea58849Config {
    private String name = "idea_058849";
 ...
 */
@Slf4j
public class Idea58849Service {
    private static final int IDEA_ID = 58849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58849Service() {
        this(new Idea58849Config());
    }

    public Idea58849Service(Idea58849Config config) {
        this.config = config != null ? config : new Idea58849Config();
