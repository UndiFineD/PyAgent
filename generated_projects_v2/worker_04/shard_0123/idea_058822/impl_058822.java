...
@Data
public class Idea58822Config {
    private String name = "idea_058822";
 ...
 */
@Slf4j
public class Idea58822Service {
    private static final int IDEA_ID = 58822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58822Service() {
        this(new Idea58822Config());
    }

    public Idea58822Service(Idea58822Config config) {
        this.config = config != null ? config : new Idea58822Config();
