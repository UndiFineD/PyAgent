...
@Data
public class Idea58710Config {
    private String name = "idea_058710";
 ...
 */
@Slf4j
public class Idea58710Service {
    private static final int IDEA_ID = 58710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58710Service() {
        this(new Idea58710Config());
    }

    public Idea58710Service(Idea58710Config config) {
        this.config = config != null ? config : new Idea58710Config();
