...
@Data
public class Idea58589Config {
    private String name = "idea_058589";
 ...
 */
@Slf4j
public class Idea58589Service {
    private static final int IDEA_ID = 58589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58589Service() {
        this(new Idea58589Config());
    }

    public Idea58589Service(Idea58589Config config) {
        this.config = config != null ? config : new Idea58589Config();
