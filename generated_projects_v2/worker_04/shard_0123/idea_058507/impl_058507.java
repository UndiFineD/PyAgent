...
@Data
public class Idea58507Config {
    private String name = "idea_058507";
 ...
 */
@Slf4j
public class Idea58507Service {
    private static final int IDEA_ID = 58507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58507Service() {
        this(new Idea58507Config());
    }

    public Idea58507Service(Idea58507Config config) {
        this.config = config != null ? config : new Idea58507Config();
