...
@Data
public class Idea58838Config {
    private String name = "idea_058838";
 ...
 */
@Slf4j
public class Idea58838Service {
    private static final int IDEA_ID = 58838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58838Service() {
        this(new Idea58838Config());
    }

    public Idea58838Service(Idea58838Config config) {
        this.config = config != null ? config : new Idea58838Config();
