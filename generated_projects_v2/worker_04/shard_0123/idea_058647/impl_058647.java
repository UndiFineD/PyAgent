...
@Data
public class Idea58647Config {
    private String name = "idea_058647";
 ...
 */
@Slf4j
public class Idea58647Service {
    private static final int IDEA_ID = 58647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58647Service() {
        this(new Idea58647Config());
    }

    public Idea58647Service(Idea58647Config config) {
        this.config = config != null ? config : new Idea58647Config();
