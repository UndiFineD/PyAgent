...
@Data
public class Idea58812Config {
    private String name = "idea_058812";
 ...
 */
@Slf4j
public class Idea58812Service {
    private static final int IDEA_ID = 58812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58812Service() {
        this(new Idea58812Config());
    }

    public Idea58812Service(Idea58812Config config) {
        this.config = config != null ? config : new Idea58812Config();
