...
@Data
public class Idea58712Config {
    private String name = "idea_058712";
 ...
 */
@Slf4j
public class Idea58712Service {
    private static final int IDEA_ID = 58712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58712Service() {
        this(new Idea58712Config());
    }

    public Idea58712Service(Idea58712Config config) {
        this.config = config != null ? config : new Idea58712Config();
