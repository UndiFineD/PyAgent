...
@Data
public class Idea58899Config {
    private String name = "idea_058899";
 ...
 */
@Slf4j
public class Idea58899Service {
    private static final int IDEA_ID = 58899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58899Service() {
        this(new Idea58899Config());
    }

    public Idea58899Service(Idea58899Config config) {
        this.config = config != null ? config : new Idea58899Config();
