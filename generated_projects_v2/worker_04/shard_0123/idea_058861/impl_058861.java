...
@Data
public class Idea58861Config {
    private String name = "idea_058861";
 ...
 */
@Slf4j
public class Idea58861Service {
    private static final int IDEA_ID = 58861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58861Service() {
        this(new Idea58861Config());
    }

    public Idea58861Service(Idea58861Config config) {
        this.config = config != null ? config : new Idea58861Config();
