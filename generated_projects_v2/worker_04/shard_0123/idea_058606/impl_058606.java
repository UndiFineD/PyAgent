...
@Data
public class Idea58606Config {
    private String name = "idea_058606";
 ...
 */
@Slf4j
public class Idea58606Service {
    private static final int IDEA_ID = 58606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58606Service() {
        this(new Idea58606Config());
    }

    public Idea58606Service(Idea58606Config config) {
        this.config = config != null ? config : new Idea58606Config();
