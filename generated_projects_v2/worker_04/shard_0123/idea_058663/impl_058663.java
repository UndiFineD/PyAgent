...
@Data
public class Idea58663Config {
    private String name = "idea_058663";
 ...
 */
@Slf4j
public class Idea58663Service {
    private static final int IDEA_ID = 58663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58663Service() {
        this(new Idea58663Config());
    }

    public Idea58663Service(Idea58663Config config) {
        this.config = config != null ? config : new Idea58663Config();
