...
@Data
public class Idea58883Config {
    private String name = "idea_058883";
 ...
 */
@Slf4j
public class Idea58883Service {
    private static final int IDEA_ID = 58883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58883Service() {
        this(new Idea58883Config());
    }

    public Idea58883Service(Idea58883Config config) {
        this.config = config != null ? config : new Idea58883Config();
