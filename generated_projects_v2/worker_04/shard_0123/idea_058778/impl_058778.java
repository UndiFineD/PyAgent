...
@Data
public class Idea58778Config {
    private String name = "idea_058778";
 ...
 */
@Slf4j
public class Idea58778Service {
    private static final int IDEA_ID = 58778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58778Service() {
        this(new Idea58778Config());
    }

    public Idea58778Service(Idea58778Config config) {
        this.config = config != null ? config : new Idea58778Config();
