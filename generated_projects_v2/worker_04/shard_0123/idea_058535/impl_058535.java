...
@Data
public class Idea58535Config {
    private String name = "idea_058535";
 ...
 */
@Slf4j
public class Idea58535Service {
    private static final int IDEA_ID = 58535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58535Service() {
        this(new Idea58535Config());
    }

    public Idea58535Service(Idea58535Config config) {
        this.config = config != null ? config : new Idea58535Config();
