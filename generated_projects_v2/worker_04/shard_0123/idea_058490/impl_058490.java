...
@Data
public class Idea58490Config {
    private String name = "idea_058490";
 ...
 */
@Slf4j
public class Idea58490Service {
    private static final int IDEA_ID = 58490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58490Service() {
        this(new Idea58490Config());
    }

    public Idea58490Service(Idea58490Config config) {
        this.config = config != null ? config : new Idea58490Config();
