...
@Data
public class Idea58665Config {
    private String name = "idea_058665";
 ...
 */
@Slf4j
public class Idea58665Service {
    private static final int IDEA_ID = 58665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58665Service() {
        this(new Idea58665Config());
    }

    public Idea58665Service(Idea58665Config config) {
        this.config = config != null ? config : new Idea58665Config();
