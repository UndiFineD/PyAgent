...
@Data
public class Idea58733Config {
    private String name = "idea_058733";
 ...
 */
@Slf4j
public class Idea58733Service {
    private static final int IDEA_ID = 58733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58733Service() {
        this(new Idea58733Config());
    }

    public Idea58733Service(Idea58733Config config) {
        this.config = config != null ? config : new Idea58733Config();
