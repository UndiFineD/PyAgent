...
@Data
public class Idea58513Config {
    private String name = "idea_058513";
 ...
 */
@Slf4j
public class Idea58513Service {
    private static final int IDEA_ID = 58513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58513Service() {
        this(new Idea58513Config());
    }

    public Idea58513Service(Idea58513Config config) {
        this.config = config != null ? config : new Idea58513Config();
