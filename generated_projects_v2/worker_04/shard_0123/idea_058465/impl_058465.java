...
@Data
public class Idea58465Config {
    private String name = "idea_058465";
 ...
 */
@Slf4j
public class Idea58465Service {
    private static final int IDEA_ID = 58465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58465Service() {
        this(new Idea58465Config());
    }

    public Idea58465Service(Idea58465Config config) {
        this.config = config != null ? config : new Idea58465Config();
