...
@Data
public class Idea58683Config {
    private String name = "idea_058683";
 ...
 */
@Slf4j
public class Idea58683Service {
    private static final int IDEA_ID = 58683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58683Service() {
        this(new Idea58683Config());
    }

    public Idea58683Service(Idea58683Config config) {
        this.config = config != null ? config : new Idea58683Config();
