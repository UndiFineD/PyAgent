...
@Data
public class Idea58500Config {
    private String name = "idea_058500";
 ...
 */
@Slf4j
public class Idea58500Service {
    private static final int IDEA_ID = 58500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58500Service() {
        this(new Idea58500Config());
    }

    public Idea58500Service(Idea58500Config config) {
        this.config = config != null ? config : new Idea58500Config();
