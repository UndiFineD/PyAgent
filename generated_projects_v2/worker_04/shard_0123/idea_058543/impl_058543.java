...
@Data
public class Idea58543Config {
    private String name = "idea_058543";
 ...
 */
@Slf4j
public class Idea58543Service {
    private static final int IDEA_ID = 58543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58543Service() {
        this(new Idea58543Config());
    }

    public Idea58543Service(Idea58543Config config) {
        this.config = config != null ? config : new Idea58543Config();
