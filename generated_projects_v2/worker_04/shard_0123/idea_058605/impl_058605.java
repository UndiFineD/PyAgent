...
@Data
public class Idea58605Config {
    private String name = "idea_058605";
 ...
 */
@Slf4j
public class Idea58605Service {
    private static final int IDEA_ID = 58605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58605Service() {
        this(new Idea58605Config());
    }

    public Idea58605Service(Idea58605Config config) {
        this.config = config != null ? config : new Idea58605Config();
