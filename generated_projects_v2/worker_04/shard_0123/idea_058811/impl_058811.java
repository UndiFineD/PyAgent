...
@Data
public class Idea58811Config {
    private String name = "idea_058811";
 ...
 */
@Slf4j
public class Idea58811Service {
    private static final int IDEA_ID = 58811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58811Service() {
        this(new Idea58811Config());
    }

    public Idea58811Service(Idea58811Config config) {
        this.config = config != null ? config : new Idea58811Config();
