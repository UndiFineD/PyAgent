...
@Data
public class Idea58431Config {
    private String name = "idea_058431";
 ...
 */
@Slf4j
public class Idea58431Service {
    private static final int IDEA_ID = 58431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58431Service() {
        this(new Idea58431Config());
    }

    public Idea58431Service(Idea58431Config config) {
        this.config = config != null ? config : new Idea58431Config();
