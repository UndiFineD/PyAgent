...
@Data
public class Idea58600Config {
    private String name = "idea_058600";
 ...
 */
@Slf4j
public class Idea58600Service {
    private static final int IDEA_ID = 58600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58600Service() {
        this(new Idea58600Config());
    }

    public Idea58600Service(Idea58600Config config) {
        this.config = config != null ? config : new Idea58600Config();
