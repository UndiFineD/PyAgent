...
@Data
public class Idea58740Config {
    private String name = "idea_058740";
 ...
 */
@Slf4j
public class Idea58740Service {
    private static final int IDEA_ID = 58740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58740Service() {
        this(new Idea58740Config());
    }

    public Idea58740Service(Idea58740Config config) {
        this.config = config != null ? config : new Idea58740Config();
