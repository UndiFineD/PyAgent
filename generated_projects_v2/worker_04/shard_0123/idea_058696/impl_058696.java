...
@Data
public class Idea58696Config {
    private String name = "idea_058696";
 ...
 */
@Slf4j
public class Idea58696Service {
    private static final int IDEA_ID = 58696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58696Service() {
        this(new Idea58696Config());
    }

    public Idea58696Service(Idea58696Config config) {
        this.config = config != null ? config : new Idea58696Config();
