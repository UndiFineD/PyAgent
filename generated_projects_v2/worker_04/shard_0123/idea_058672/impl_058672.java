...
@Data
public class Idea58672Config {
    private String name = "idea_058672";
 ...
 */
@Slf4j
public class Idea58672Service {
    private static final int IDEA_ID = 58672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58672Service() {
        this(new Idea58672Config());
    }

    public Idea58672Service(Idea58672Config config) {
        this.config = config != null ? config : new Idea58672Config();
