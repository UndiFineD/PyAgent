...
@Data
public class Idea58830Config {
    private String name = "idea_058830";
 ...
 */
@Slf4j
public class Idea58830Service {
    private static final int IDEA_ID = 58830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58830Service() {
        this(new Idea58830Config());
    }

    public Idea58830Service(Idea58830Config config) {
        this.config = config != null ? config : new Idea58830Config();
