...
@Data
public class Idea58641Config {
    private String name = "idea_058641";
 ...
 */
@Slf4j
public class Idea58641Service {
    private static final int IDEA_ID = 58641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58641Service() {
        this(new Idea58641Config());
    }

    public Idea58641Service(Idea58641Config config) {
        this.config = config != null ? config : new Idea58641Config();
