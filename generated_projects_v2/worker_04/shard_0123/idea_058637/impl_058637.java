...
@Data
public class Idea58637Config {
    private String name = "idea_058637";
 ...
 */
@Slf4j
public class Idea58637Service {
    private static final int IDEA_ID = 58637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58637Service() {
        this(new Idea58637Config());
    }

    public Idea58637Service(Idea58637Config config) {
        this.config = config != null ? config : new Idea58637Config();
