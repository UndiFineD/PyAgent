...
@Data
public class Idea58766Config {
    private String name = "idea_058766";
 ...
 */
@Slf4j
public class Idea58766Service {
    private static final int IDEA_ID = 58766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58766Service() {
        this(new Idea58766Config());
    }

    public Idea58766Service(Idea58766Config config) {
        this.config = config != null ? config : new Idea58766Config();
