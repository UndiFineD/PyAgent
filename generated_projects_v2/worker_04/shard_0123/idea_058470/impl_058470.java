...
@Data
public class Idea58470Config {
    private String name = "idea_058470";
 ...
 */
@Slf4j
public class Idea58470Service {
    private static final int IDEA_ID = 58470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58470Service() {
        this(new Idea58470Config());
    }

    public Idea58470Service(Idea58470Config config) {
        this.config = config != null ? config : new Idea58470Config();
