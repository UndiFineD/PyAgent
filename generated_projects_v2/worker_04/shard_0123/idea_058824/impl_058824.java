...
@Data
public class Idea58824Config {
    private String name = "idea_058824";
 ...
 */
@Slf4j
public class Idea58824Service {
    private static final int IDEA_ID = 58824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58824Service() {
        this(new Idea58824Config());
    }

    public Idea58824Service(Idea58824Config config) {
        this.config = config != null ? config : new Idea58824Config();
