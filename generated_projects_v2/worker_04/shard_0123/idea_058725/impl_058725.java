...
@Data
public class Idea58725Config {
    private String name = "idea_058725";
 ...
 */
@Slf4j
public class Idea58725Service {
    private static final int IDEA_ID = 58725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58725Service() {
        this(new Idea58725Config());
    }

    public Idea58725Service(Idea58725Config config) {
        this.config = config != null ? config : new Idea58725Config();
