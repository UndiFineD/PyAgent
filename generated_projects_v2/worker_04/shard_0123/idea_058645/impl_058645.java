...
@Data
public class Idea58645Config {
    private String name = "idea_058645";
 ...
 */
@Slf4j
public class Idea58645Service {
    private static final int IDEA_ID = 58645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58645Service() {
        this(new Idea58645Config());
    }

    public Idea58645Service(Idea58645Config config) {
        this.config = config != null ? config : new Idea58645Config();
