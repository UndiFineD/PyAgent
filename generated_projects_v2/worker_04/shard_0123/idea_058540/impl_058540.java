...
@Data
public class Idea58540Config {
    private String name = "idea_058540";
 ...
 */
@Slf4j
public class Idea58540Service {
    private static final int IDEA_ID = 58540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58540Service() {
        this(new Idea58540Config());
    }

    public Idea58540Service(Idea58540Config config) {
        this.config = config != null ? config : new Idea58540Config();
