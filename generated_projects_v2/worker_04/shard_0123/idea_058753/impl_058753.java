...
@Data
public class Idea58753Config {
    private String name = "idea_058753";
 ...
 */
@Slf4j
public class Idea58753Service {
    private static final int IDEA_ID = 58753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58753Service() {
        this(new Idea58753Config());
    }

    public Idea58753Service(Idea58753Config config) {
        this.config = config != null ? config : new Idea58753Config();
