...
@Data
public class Idea58541Config {
    private String name = "idea_058541";
 ...
 */
@Slf4j
public class Idea58541Service {
    private static final int IDEA_ID = 58541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58541Service() {
        this(new Idea58541Config());
    }

    public Idea58541Service(Idea58541Config config) {
        this.config = config != null ? config : new Idea58541Config();
