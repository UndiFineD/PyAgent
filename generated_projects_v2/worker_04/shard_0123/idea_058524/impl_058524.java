...
@Data
public class Idea58524Config {
    private String name = "idea_058524";
 ...
 */
@Slf4j
public class Idea58524Service {
    private static final int IDEA_ID = 58524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58524Service() {
        this(new Idea58524Config());
    }

    public Idea58524Service(Idea58524Config config) {
        this.config = config != null ? config : new Idea58524Config();
