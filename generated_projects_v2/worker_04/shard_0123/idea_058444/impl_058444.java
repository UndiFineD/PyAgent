...
@Data
public class Idea58444Config {
    private String name = "idea_058444";
 ...
 */
@Slf4j
public class Idea58444Service {
    private static final int IDEA_ID = 58444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58444Service() {
        this(new Idea58444Config());
    }

    public Idea58444Service(Idea58444Config config) {
        this.config = config != null ? config : new Idea58444Config();
