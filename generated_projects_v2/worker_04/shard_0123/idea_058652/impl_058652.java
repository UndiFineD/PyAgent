...
@Data
public class Idea58652Config {
    private String name = "idea_058652";
 ...
 */
@Slf4j
public class Idea58652Service {
    private static final int IDEA_ID = 58652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58652Service() {
        this(new Idea58652Config());
    }

    public Idea58652Service(Idea58652Config config) {
        this.config = config != null ? config : new Idea58652Config();
