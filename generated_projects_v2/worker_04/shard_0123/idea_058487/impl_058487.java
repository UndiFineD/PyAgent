...
@Data
public class Idea58487Config {
    private String name = "idea_058487";
 ...
 */
@Slf4j
public class Idea58487Service {
    private static final int IDEA_ID = 58487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58487Service() {
        this(new Idea58487Config());
    }

    public Idea58487Service(Idea58487Config config) {
        this.config = config != null ? config : new Idea58487Config();
