...
@Data
public class Idea58789Config {
    private String name = "idea_058789";
 ...
 */
@Slf4j
public class Idea58789Service {
    private static final int IDEA_ID = 58789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58789Service() {
        this(new Idea58789Config());
    }

    public Idea58789Service(Idea58789Config config) {
        this.config = config != null ? config : new Idea58789Config();
