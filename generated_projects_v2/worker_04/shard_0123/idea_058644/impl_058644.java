...
@Data
public class Idea58644Config {
    private String name = "idea_058644";
 ...
 */
@Slf4j
public class Idea58644Service {
    private static final int IDEA_ID = 58644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58644Service() {
        this(new Idea58644Config());
    }

    public Idea58644Service(Idea58644Config config) {
        this.config = config != null ? config : new Idea58644Config();
