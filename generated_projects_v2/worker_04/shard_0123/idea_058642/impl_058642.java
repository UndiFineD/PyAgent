...
@Data
public class Idea58642Config {
    private String name = "idea_058642";
 ...
 */
@Slf4j
public class Idea58642Service {
    private static final int IDEA_ID = 58642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58642Service() {
        this(new Idea58642Config());
    }

    public Idea58642Service(Idea58642Config config) {
        this.config = config != null ? config : new Idea58642Config();
