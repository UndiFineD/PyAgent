...
@Data
public class Idea58572Config {
    private String name = "idea_058572";
 ...
 */
@Slf4j
public class Idea58572Service {
    private static final int IDEA_ID = 58572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58572Service() {
        this(new Idea58572Config());
    }

    public Idea58572Service(Idea58572Config config) {
        this.config = config != null ? config : new Idea58572Config();
