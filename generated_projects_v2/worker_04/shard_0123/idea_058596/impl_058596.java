...
@Data
public class Idea58596Config {
    private String name = "idea_058596";
 ...
 */
@Slf4j
public class Idea58596Service {
    private static final int IDEA_ID = 58596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58596Service() {
        this(new Idea58596Config());
    }

    public Idea58596Service(Idea58596Config config) {
        this.config = config != null ? config : new Idea58596Config();
