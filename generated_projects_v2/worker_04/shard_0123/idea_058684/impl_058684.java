...
@Data
public class Idea58684Config {
    private String name = "idea_058684";
 ...
 */
@Slf4j
public class Idea58684Service {
    private static final int IDEA_ID = 58684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58684Service() {
        this(new Idea58684Config());
    }

    public Idea58684Service(Idea58684Config config) {
        this.config = config != null ? config : new Idea58684Config();
