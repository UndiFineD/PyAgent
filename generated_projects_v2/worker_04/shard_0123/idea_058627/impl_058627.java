...
@Data
public class Idea58627Config {
    private String name = "idea_058627";
 ...
 */
@Slf4j
public class Idea58627Service {
    private static final int IDEA_ID = 58627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58627Service() {
        this(new Idea58627Config());
    }

    public Idea58627Service(Idea58627Config config) {
        this.config = config != null ? config : new Idea58627Config();
