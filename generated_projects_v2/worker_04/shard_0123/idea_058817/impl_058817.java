...
@Data
public class Idea58817Config {
    private String name = "idea_058817";
 ...
 */
@Slf4j
public class Idea58817Service {
    private static final int IDEA_ID = 58817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58817Service() {
        this(new Idea58817Config());
    }

    public Idea58817Service(Idea58817Config config) {
        this.config = config != null ? config : new Idea58817Config();
