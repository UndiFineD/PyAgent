...
@Data
public class Idea58576Config {
    private String name = "idea_058576";
 ...
 */
@Slf4j
public class Idea58576Service {
    private static final int IDEA_ID = 58576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58576Service() {
        this(new Idea58576Config());
    }

    public Idea58576Service(Idea58576Config config) {
        this.config = config != null ? config : new Idea58576Config();
