...
@Data
public class Idea58625Config {
    private String name = "idea_058625";
 ...
 */
@Slf4j
public class Idea58625Service {
    private static final int IDEA_ID = 58625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58625Service() {
        this(new Idea58625Config());
    }

    public Idea58625Service(Idea58625Config config) {
        this.config = config != null ? config : new Idea58625Config();
