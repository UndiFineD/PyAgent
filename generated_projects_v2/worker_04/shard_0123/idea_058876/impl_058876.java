...
@Data
public class Idea58876Config {
    private String name = "idea_058876";
 ...
 */
@Slf4j
public class Idea58876Service {
    private static final int IDEA_ID = 58876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58876Service() {
        this(new Idea58876Config());
    }

    public Idea58876Service(Idea58876Config config) {
        this.config = config != null ? config : new Idea58876Config();
