...
@Data
public class Idea58486Config {
    private String name = "idea_058486";
 ...
 */
@Slf4j
public class Idea58486Service {
    private static final int IDEA_ID = 58486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58486Service() {
        this(new Idea58486Config());
    }

    public Idea58486Service(Idea58486Config config) {
        this.config = config != null ? config : new Idea58486Config();
