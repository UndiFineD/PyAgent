...
@Data
public class Idea58525Config {
    private String name = "idea_058525";
 ...
 */
@Slf4j
public class Idea58525Service {
    private static final int IDEA_ID = 58525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58525Service() {
        this(new Idea58525Config());
    }

    public Idea58525Service(Idea58525Config config) {
        this.config = config != null ? config : new Idea58525Config();
