...
@Data
public class Idea58482Config {
    private String name = "idea_058482";
 ...
 */
@Slf4j
public class Idea58482Service {
    private static final int IDEA_ID = 58482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58482Service() {
        this(new Idea58482Config());
    }

    public Idea58482Service(Idea58482Config config) {
        this.config = config != null ? config : new Idea58482Config();
