...
@Data
public class Idea58707Config {
    private String name = "idea_058707";
 ...
 */
@Slf4j
public class Idea58707Service {
    private static final int IDEA_ID = 58707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58707Service() {
        this(new Idea58707Config());
    }

    public Idea58707Service(Idea58707Config config) {
        this.config = config != null ? config : new Idea58707Config();
