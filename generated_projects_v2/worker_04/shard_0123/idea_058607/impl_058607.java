...
@Data
public class Idea58607Config {
    private String name = "idea_058607";
 ...
 */
@Slf4j
public class Idea58607Service {
    private static final int IDEA_ID = 58607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58607Service() {
        this(new Idea58607Config());
    }

    public Idea58607Service(Idea58607Config config) {
        this.config = config != null ? config : new Idea58607Config();
