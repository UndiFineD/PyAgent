...
@Data
public class Idea58649Config {
    private String name = "idea_058649";
 ...
 */
@Slf4j
public class Idea58649Service {
    private static final int IDEA_ID = 58649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58649Service() {
        this(new Idea58649Config());
    }

    public Idea58649Service(Idea58649Config config) {
        this.config = config != null ? config : new Idea58649Config();
