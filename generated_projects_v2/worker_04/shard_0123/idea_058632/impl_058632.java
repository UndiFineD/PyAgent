...
@Data
public class Idea58632Config {
    private String name = "idea_058632";
 ...
 */
@Slf4j
public class Idea58632Service {
    private static final int IDEA_ID = 58632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58632Service() {
        this(new Idea58632Config());
    }

    public Idea58632Service(Idea58632Config config) {
        this.config = config != null ? config : new Idea58632Config();
