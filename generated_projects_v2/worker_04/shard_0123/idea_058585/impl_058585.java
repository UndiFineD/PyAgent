...
@Data
public class Idea58585Config {
    private String name = "idea_058585";
 ...
 */
@Slf4j
public class Idea58585Service {
    private static final int IDEA_ID = 58585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58585Service() {
        this(new Idea58585Config());
    }

    public Idea58585Service(Idea58585Config config) {
        this.config = config != null ? config : new Idea58585Config();
