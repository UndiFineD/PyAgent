...
@Data
public class Idea58721Config {
    private String name = "idea_058721";
 ...
 */
@Slf4j
public class Idea58721Service {
    private static final int IDEA_ID = 58721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58721Service() {
        this(new Idea58721Config());
    }

    public Idea58721Service(Idea58721Config config) {
        this.config = config != null ? config : new Idea58721Config();
