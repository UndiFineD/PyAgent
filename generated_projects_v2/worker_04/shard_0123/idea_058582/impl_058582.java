...
@Data
public class Idea58582Config {
    private String name = "idea_058582";
 ...
 */
@Slf4j
public class Idea58582Service {
    private static final int IDEA_ID = 58582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58582Service() {
        this(new Idea58582Config());
    }

    public Idea58582Service(Idea58582Config config) {
        this.config = config != null ? config : new Idea58582Config();
