...
@Data
public class Idea58504Config {
    private String name = "idea_058504";
 ...
 */
@Slf4j
public class Idea58504Service {
    private static final int IDEA_ID = 58504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58504Service() {
        this(new Idea58504Config());
    }

    public Idea58504Service(Idea58504Config config) {
        this.config = config != null ? config : new Idea58504Config();
