...
@Data
public class Idea58843Config {
    private String name = "idea_058843";
 ...
 */
@Slf4j
public class Idea58843Service {
    private static final int IDEA_ID = 58843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58843Service() {
        this(new Idea58843Config());
    }

    public Idea58843Service(Idea58843Config config) {
        this.config = config != null ? config : new Idea58843Config();
