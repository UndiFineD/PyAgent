...
@Data
public class Idea58673Config {
    private String name = "idea_058673";
 ...
 */
@Slf4j
public class Idea58673Service {
    private static final int IDEA_ID = 58673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58673Service() {
        this(new Idea58673Config());
    }

    public Idea58673Service(Idea58673Config config) {
        this.config = config != null ? config : new Idea58673Config();
