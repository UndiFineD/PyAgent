...
@Data
public class Idea58661Config {
    private String name = "idea_058661";
 ...
 */
@Slf4j
public class Idea58661Service {
    private static final int IDEA_ID = 58661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58661Service() {
        this(new Idea58661Config());
    }

    public Idea58661Service(Idea58661Config config) {
        this.config = config != null ? config : new Idea58661Config();
