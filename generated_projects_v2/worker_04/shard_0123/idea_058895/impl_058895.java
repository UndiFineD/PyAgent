...
@Data
public class Idea58895Config {
    private String name = "idea_058895";
 ...
 */
@Slf4j
public class Idea58895Service {
    private static final int IDEA_ID = 58895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58895Service() {
        this(new Idea58895Config());
    }

    public Idea58895Service(Idea58895Config config) {
        this.config = config != null ? config : new Idea58895Config();
