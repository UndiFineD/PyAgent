...
@Data
public class Idea58675Config {
    private String name = "idea_058675";
 ...
 */
@Slf4j
public class Idea58675Service {
    private static final int IDEA_ID = 58675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58675Service() {
        this(new Idea58675Config());
    }

    public Idea58675Service(Idea58675Config config) {
        this.config = config != null ? config : new Idea58675Config();
