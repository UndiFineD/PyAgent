...
@Data
public class Idea58526Config {
    private String name = "idea_058526";
 ...
 */
@Slf4j
public class Idea58526Service {
    private static final int IDEA_ID = 58526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58526Service() {
        this(new Idea58526Config());
    }

    public Idea58526Service(Idea58526Config config) {
        this.config = config != null ? config : new Idea58526Config();
