...
@Data
public class Idea58821Config {
    private String name = "idea_058821";
 ...
 */
@Slf4j
public class Idea58821Service {
    private static final int IDEA_ID = 58821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58821Service() {
        this(new Idea58821Config());
    }

    public Idea58821Service(Idea58821Config config) {
        this.config = config != null ? config : new Idea58821Config();
