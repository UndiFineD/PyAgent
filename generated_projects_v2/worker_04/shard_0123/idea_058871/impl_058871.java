...
@Data
public class Idea58871Config {
    private String name = "idea_058871";
 ...
 */
@Slf4j
public class Idea58871Service {
    private static final int IDEA_ID = 58871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58871Service() {
        this(new Idea58871Config());
    }

    public Idea58871Service(Idea58871Config config) {
        this.config = config != null ? config : new Idea58871Config();
