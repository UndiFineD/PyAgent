...
@Data
public class Idea58768Config {
    private String name = "idea_058768";
 ...
 */
@Slf4j
public class Idea58768Service {
    private static final int IDEA_ID = 58768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58768Service() {
        this(new Idea58768Config());
    }

    public Idea58768Service(Idea58768Config config) {
        this.config = config != null ? config : new Idea58768Config();
