...
@Data
public class Idea58846Config {
    private String name = "idea_058846";
 ...
 */
@Slf4j
public class Idea58846Service {
    private static final int IDEA_ID = 58846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58846Service() {
        this(new Idea58846Config());
    }

    public Idea58846Service(Idea58846Config config) {
        this.config = config != null ? config : new Idea58846Config();
