...
@Data
public class Idea58516Config {
    private String name = "idea_058516";
 ...
 */
@Slf4j
public class Idea58516Service {
    private static final int IDEA_ID = 58516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58516Service() {
        this(new Idea58516Config());
    }

    public Idea58516Service(Idea58516Config config) {
        this.config = config != null ? config : new Idea58516Config();
