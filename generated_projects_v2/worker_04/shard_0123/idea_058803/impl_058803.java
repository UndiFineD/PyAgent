...
@Data
public class Idea58803Config {
    private String name = "idea_058803";
 ...
 */
@Slf4j
public class Idea58803Service {
    private static final int IDEA_ID = 58803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58803Service() {
        this(new Idea58803Config());
    }

    public Idea58803Service(Idea58803Config config) {
        this.config = config != null ? config : new Idea58803Config();
