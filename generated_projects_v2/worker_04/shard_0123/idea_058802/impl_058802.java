...
@Data
public class Idea58802Config {
    private String name = "idea_058802";
 ...
 */
@Slf4j
public class Idea58802Service {
    private static final int IDEA_ID = 58802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58802Service() {
        this(new Idea58802Config());
    }

    public Idea58802Service(Idea58802Config config) {
        this.config = config != null ? config : new Idea58802Config();
