...
@Data
public class Idea58623Config {
    private String name = "idea_058623";
 ...
 */
@Slf4j
public class Idea58623Service {
    private static final int IDEA_ID = 58623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58623Service() {
        this(new Idea58623Config());
    }

    public Idea58623Service(Idea58623Config config) {
        this.config = config != null ? config : new Idea58623Config();
