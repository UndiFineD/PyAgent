...
@Data
public class Idea58691Config {
    private String name = "idea_058691";
 ...
 */
@Slf4j
public class Idea58691Service {
    private static final int IDEA_ID = 58691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58691Service() {
        this(new Idea58691Config());
    }

    public Idea58691Service(Idea58691Config config) {
        this.config = config != null ? config : new Idea58691Config();
