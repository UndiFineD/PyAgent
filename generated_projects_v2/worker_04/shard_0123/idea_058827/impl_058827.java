...
@Data
public class Idea58827Config {
    private String name = "idea_058827";
 ...
 */
@Slf4j
public class Idea58827Service {
    private static final int IDEA_ID = 58827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58827Service() {
        this(new Idea58827Config());
    }

    public Idea58827Service(Idea58827Config config) {
        this.config = config != null ? config : new Idea58827Config();
