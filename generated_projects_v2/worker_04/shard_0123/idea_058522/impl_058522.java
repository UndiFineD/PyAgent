...
@Data
public class Idea58522Config {
    private String name = "idea_058522";
 ...
 */
@Slf4j
public class Idea58522Service {
    private static final int IDEA_ID = 58522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58522Service() {
        this(new Idea58522Config());
    }

    public Idea58522Service(Idea58522Config config) {
        this.config = config != null ? config : new Idea58522Config();
