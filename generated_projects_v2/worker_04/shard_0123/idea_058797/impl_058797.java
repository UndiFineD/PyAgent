...
@Data
public class Idea58797Config {
    private String name = "idea_058797";
 ...
 */
@Slf4j
public class Idea58797Service {
    private static final int IDEA_ID = 58797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58797Service() {
        this(new Idea58797Config());
    }

    public Idea58797Service(Idea58797Config config) {
        this.config = config != null ? config : new Idea58797Config();
