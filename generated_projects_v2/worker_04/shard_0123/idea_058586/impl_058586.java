...
@Data
public class Idea58586Config {
    private String name = "idea_058586";
 ...
 */
@Slf4j
public class Idea58586Service {
    private static final int IDEA_ID = 58586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58586Service() {
        this(new Idea58586Config());
    }

    public Idea58586Service(Idea58586Config config) {
        this.config = config != null ? config : new Idea58586Config();
