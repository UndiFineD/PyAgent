...
@Data
public class Idea58438Config {
    private String name = "idea_058438";
 ...
 */
@Slf4j
public class Idea58438Service {
    private static final int IDEA_ID = 58438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58438Service() {
        this(new Idea58438Config());
    }

    public Idea58438Service(Idea58438Config config) {
        this.config = config != null ? config : new Idea58438Config();
