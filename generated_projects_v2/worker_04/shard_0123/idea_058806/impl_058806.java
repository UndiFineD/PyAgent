...
@Data
public class Idea58806Config {
    private String name = "idea_058806";
 ...
 */
@Slf4j
public class Idea58806Service {
    private static final int IDEA_ID = 58806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58806Service() {
        this(new Idea58806Config());
    }

    public Idea58806Service(Idea58806Config config) {
        this.config = config != null ? config : new Idea58806Config();
