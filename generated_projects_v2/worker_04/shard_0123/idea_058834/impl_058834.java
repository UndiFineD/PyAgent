...
@Data
public class Idea58834Config {
    private String name = "idea_058834";
 ...
 */
@Slf4j
public class Idea58834Service {
    private static final int IDEA_ID = 58834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58834Service() {
        this(new Idea58834Config());
    }

    public Idea58834Service(Idea58834Config config) {
        this.config = config != null ? config : new Idea58834Config();
