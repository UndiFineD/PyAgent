...
@Data
public class Idea58570Config {
    private String name = "idea_058570";
 ...
 */
@Slf4j
public class Idea58570Service {
    private static final int IDEA_ID = 58570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58570Service() {
        this(new Idea58570Config());
    }

    public Idea58570Service(Idea58570Config config) {
        this.config = config != null ? config : new Idea58570Config();
