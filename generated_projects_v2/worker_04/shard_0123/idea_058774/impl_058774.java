...
@Data
public class Idea58774Config {
    private String name = "idea_058774";
 ...
 */
@Slf4j
public class Idea58774Service {
    private static final int IDEA_ID = 58774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58774Service() {
        this(new Idea58774Config());
    }

    public Idea58774Service(Idea58774Config config) {
        this.config = config != null ? config : new Idea58774Config();
