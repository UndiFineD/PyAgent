...
@Data
public class Idea58859Config {
    private String name = "idea_058859";
 ...
 */
@Slf4j
public class Idea58859Service {
    private static final int IDEA_ID = 58859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58859Service() {
        this(new Idea58859Config());
    }

    public Idea58859Service(Idea58859Config config) {
        this.config = config != null ? config : new Idea58859Config();
