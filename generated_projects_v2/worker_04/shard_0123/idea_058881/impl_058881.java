...
@Data
public class Idea58881Config {
    private String name = "idea_058881";
 ...
 */
@Slf4j
public class Idea58881Service {
    private static final int IDEA_ID = 58881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58881Service() {
        this(new Idea58881Config());
    }

    public Idea58881Service(Idea58881Config config) {
        this.config = config != null ? config : new Idea58881Config();
