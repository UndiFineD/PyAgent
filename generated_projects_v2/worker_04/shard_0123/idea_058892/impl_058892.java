...
@Data
public class Idea58892Config {
    private String name = "idea_058892";
 ...
 */
@Slf4j
public class Idea58892Service {
    private static final int IDEA_ID = 58892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58892Service() {
        this(new Idea58892Config());
    }

    public Idea58892Service(Idea58892Config config) {
        this.config = config != null ? config : new Idea58892Config();
