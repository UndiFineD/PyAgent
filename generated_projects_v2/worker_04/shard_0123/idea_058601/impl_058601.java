...
@Data
public class Idea58601Config {
    private String name = "idea_058601";
 ...
 */
@Slf4j
public class Idea58601Service {
    private static final int IDEA_ID = 58601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58601Service() {
        this(new Idea58601Config());
    }

    public Idea58601Service(Idea58601Config config) {
        this.config = config != null ? config : new Idea58601Config();
