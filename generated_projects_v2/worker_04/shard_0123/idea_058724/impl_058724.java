...
@Data
public class Idea58724Config {
    private String name = "idea_058724";
 ...
 */
@Slf4j
public class Idea58724Service {
    private static final int IDEA_ID = 58724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58724Service() {
        this(new Idea58724Config());
    }

    public Idea58724Service(Idea58724Config config) {
        this.config = config != null ? config : new Idea58724Config();
