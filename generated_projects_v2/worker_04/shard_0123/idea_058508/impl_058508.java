...
@Data
public class Idea58508Config {
    private String name = "idea_058508";
 ...
 */
@Slf4j
public class Idea58508Service {
    private static final int IDEA_ID = 58508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58508Service() {
        this(new Idea58508Config());
    }

    public Idea58508Service(Idea58508Config config) {
        this.config = config != null ? config : new Idea58508Config();
