...
@Data
public class Idea58752Config {
    private String name = "idea_058752";
 ...
 */
@Slf4j
public class Idea58752Service {
    private static final int IDEA_ID = 58752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58752Service() {
        this(new Idea58752Config());
    }

    public Idea58752Service(Idea58752Config config) {
        this.config = config != null ? config : new Idea58752Config();
