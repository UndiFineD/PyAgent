...
@Data
public class Idea58599Config {
    private String name = "idea_058599";
 ...
 */
@Slf4j
public class Idea58599Service {
    private static final int IDEA_ID = 58599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58599Service() {
        this(new Idea58599Config());
    }

    public Idea58599Service(Idea58599Config config) {
        this.config = config != null ? config : new Idea58599Config();
