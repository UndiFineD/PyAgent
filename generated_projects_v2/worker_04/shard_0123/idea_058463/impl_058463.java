...
@Data
public class Idea58463Config {
    private String name = "idea_058463";
 ...
 */
@Slf4j
public class Idea58463Service {
    private static final int IDEA_ID = 58463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58463Service() {
        this(new Idea58463Config());
    }

    public Idea58463Service(Idea58463Config config) {
        this.config = config != null ? config : new Idea58463Config();
