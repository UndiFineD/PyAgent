...
@Data
public class Idea58703Config {
    private String name = "idea_058703";
 ...
 */
@Slf4j
public class Idea58703Service {
    private static final int IDEA_ID = 58703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58703Service() {
        this(new Idea58703Config());
    }

    public Idea58703Service(Idea58703Config config) {
        this.config = config != null ? config : new Idea58703Config();
