...
@Data
public class Idea58677Config {
    private String name = "idea_058677";
 ...
 */
@Slf4j
public class Idea58677Service {
    private static final int IDEA_ID = 58677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58677Service() {
        this(new Idea58677Config());
    }

    public Idea58677Service(Idea58677Config config) {
        this.config = config != null ? config : new Idea58677Config();
