...
@Data
public class Idea58520Config {
    private String name = "idea_058520";
 ...
 */
@Slf4j
public class Idea58520Service {
    private static final int IDEA_ID = 58520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58520Service() {
        this(new Idea58520Config());
    }

    public Idea58520Service(Idea58520Config config) {
        this.config = config != null ? config : new Idea58520Config();
