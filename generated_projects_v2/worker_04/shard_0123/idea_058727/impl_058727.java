...
@Data
public class Idea58727Config {
    private String name = "idea_058727";
 ...
 */
@Slf4j
public class Idea58727Service {
    private static final int IDEA_ID = 58727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58727Service() {
        this(new Idea58727Config());
    }

    public Idea58727Service(Idea58727Config config) {
        this.config = config != null ? config : new Idea58727Config();
