...
@Data
public class Idea58770Config {
    private String name = "idea_058770";
 ...
 */
@Slf4j
public class Idea58770Service {
    private static final int IDEA_ID = 58770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58770Service() {
        this(new Idea58770Config());
    }

    public Idea58770Service(Idea58770Config config) {
        this.config = config != null ? config : new Idea58770Config();
