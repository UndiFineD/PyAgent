...
@Data
public class Idea58515Config {
    private String name = "idea_058515";
 ...
 */
@Slf4j
public class Idea58515Service {
    private static final int IDEA_ID = 58515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58515Service() {
        this(new Idea58515Config());
    }

    public Idea58515Service(Idea58515Config config) {
        this.config = config != null ? config : new Idea58515Config();
