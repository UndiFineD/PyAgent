...
@Data
public class Idea58761Config {
    private String name = "idea_058761";
 ...
 */
@Slf4j
public class Idea58761Service {
    private static final int IDEA_ID = 58761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58761Service() {
        this(new Idea58761Config());
    }

    public Idea58761Service(Idea58761Config config) {
        this.config = config != null ? config : new Idea58761Config();
