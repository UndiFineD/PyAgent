...
@Data
public class Idea58747Config {
    private String name = "idea_058747";
 ...
 */
@Slf4j
public class Idea58747Service {
    private static final int IDEA_ID = 58747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58747Service() {
        this(new Idea58747Config());
    }

    public Idea58747Service(Idea58747Config config) {
        this.config = config != null ? config : new Idea58747Config();
