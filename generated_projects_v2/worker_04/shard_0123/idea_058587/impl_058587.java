...
@Data
public class Idea58587Config {
    private String name = "idea_058587";
 ...
 */
@Slf4j
public class Idea58587Service {
    private static final int IDEA_ID = 58587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58587Service() {
        this(new Idea58587Config());
    }

    public Idea58587Service(Idea58587Config config) {
        this.config = config != null ? config : new Idea58587Config();
