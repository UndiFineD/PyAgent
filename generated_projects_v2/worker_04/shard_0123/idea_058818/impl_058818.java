...
@Data
public class Idea58818Config {
    private String name = "idea_058818";
 ...
 */
@Slf4j
public class Idea58818Service {
    private static final int IDEA_ID = 58818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58818Service() {
        this(new Idea58818Config());
    }

    public Idea58818Service(Idea58818Config config) {
        this.config = config != null ? config : new Idea58818Config();
