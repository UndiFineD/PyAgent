...
@Data
public class Idea58475Config {
    private String name = "idea_058475";
 ...
 */
@Slf4j
public class Idea58475Service {
    private static final int IDEA_ID = 58475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58475Service() {
        this(new Idea58475Config());
    }

    public Idea58475Service(Idea58475Config config) {
        this.config = config != null ? config : new Idea58475Config();
