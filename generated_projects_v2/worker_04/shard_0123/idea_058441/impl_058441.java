...
@Data
public class Idea58441Config {
    private String name = "idea_058441";
 ...
 */
@Slf4j
public class Idea58441Service {
    private static final int IDEA_ID = 58441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58441Service() {
        this(new Idea58441Config());
    }

    public Idea58441Service(Idea58441Config config) {
        this.config = config != null ? config : new Idea58441Config();
