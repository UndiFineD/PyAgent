...
@Data
public class Idea58510Config {
    private String name = "idea_058510";
 ...
 */
@Slf4j
public class Idea58510Service {
    private static final int IDEA_ID = 58510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58510Service() {
        this(new Idea58510Config());
    }

    public Idea58510Service(Idea58510Config config) {
        this.config = config != null ? config : new Idea58510Config();
