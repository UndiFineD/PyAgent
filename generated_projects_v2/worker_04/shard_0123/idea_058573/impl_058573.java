...
@Data
public class Idea58573Config {
    private String name = "idea_058573";
 ...
 */
@Slf4j
public class Idea58573Service {
    private static final int IDEA_ID = 58573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58573Service() {
        this(new Idea58573Config());
    }

    public Idea58573Service(Idea58573Config config) {
        this.config = config != null ? config : new Idea58573Config();
