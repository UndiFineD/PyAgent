...
@Data
public class Idea58583Config {
    private String name = "idea_058583";
 ...
 */
@Slf4j
public class Idea58583Service {
    private static final int IDEA_ID = 58583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58583Service() {
        this(new Idea58583Config());
    }

    public Idea58583Service(Idea58583Config config) {
        this.config = config != null ? config : new Idea58583Config();
