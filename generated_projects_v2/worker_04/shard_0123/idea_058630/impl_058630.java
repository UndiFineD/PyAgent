...
@Data
public class Idea58630Config {
    private String name = "idea_058630";
 ...
 */
@Slf4j
public class Idea58630Service {
    private static final int IDEA_ID = 58630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58630Service() {
        this(new Idea58630Config());
    }

    public Idea58630Service(Idea58630Config config) {
        this.config = config != null ? config : new Idea58630Config();
