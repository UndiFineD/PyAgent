...
@Data
public class Idea58736Config {
    private String name = "idea_058736";
 ...
 */
@Slf4j
public class Idea58736Service {
    private static final int IDEA_ID = 58736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58736Service() {
        this(new Idea58736Config());
    }

    public Idea58736Service(Idea58736Config config) {
        this.config = config != null ? config : new Idea58736Config();
