...
@Data
public class Idea58717Config {
    private String name = "idea_058717";
 ...
 */
@Slf4j
public class Idea58717Service {
    private static final int IDEA_ID = 58717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58717Service() {
        this(new Idea58717Config());
    }

    public Idea58717Service(Idea58717Config config) {
        this.config = config != null ? config : new Idea58717Config();
