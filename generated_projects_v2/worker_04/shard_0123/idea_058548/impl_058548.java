...
@Data
public class Idea58548Config {
    private String name = "idea_058548";
 ...
 */
@Slf4j
public class Idea58548Service {
    private static final int IDEA_ID = 58548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58548Service() {
        this(new Idea58548Config());
    }

    public Idea58548Service(Idea58548Config config) {
        this.config = config != null ? config : new Idea58548Config();
