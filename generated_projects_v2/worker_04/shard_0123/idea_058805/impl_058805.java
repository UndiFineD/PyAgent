...
@Data
public class Idea58805Config {
    private String name = "idea_058805";
 ...
 */
@Slf4j
public class Idea58805Service {
    private static final int IDEA_ID = 58805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58805Service() {
        this(new Idea58805Config());
    }

    public Idea58805Service(Idea58805Config config) {
        this.config = config != null ? config : new Idea58805Config();
