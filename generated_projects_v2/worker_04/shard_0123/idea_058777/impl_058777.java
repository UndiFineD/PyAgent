...
@Data
public class Idea58777Config {
    private String name = "idea_058777";
 ...
 */
@Slf4j
public class Idea58777Service {
    private static final int IDEA_ID = 58777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58777Service() {
        this(new Idea58777Config());
    }

    public Idea58777Service(Idea58777Config config) {
        this.config = config != null ? config : new Idea58777Config();
