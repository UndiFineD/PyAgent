...
@Data
public class Idea58678Config {
    private String name = "idea_058678";
 ...
 */
@Slf4j
public class Idea58678Service {
    private static final int IDEA_ID = 58678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58678Service() {
        this(new Idea58678Config());
    }

    public Idea58678Service(Idea58678Config config) {
        this.config = config != null ? config : new Idea58678Config();
