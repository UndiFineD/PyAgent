...
@Data
public class Idea58633Config {
    private String name = "idea_058633";
 ...
 */
@Slf4j
public class Idea58633Service {
    private static final int IDEA_ID = 58633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58633Service() {
        this(new Idea58633Config());
    }

    public Idea58633Service(Idea58633Config config) {
        this.config = config != null ? config : new Idea58633Config();
