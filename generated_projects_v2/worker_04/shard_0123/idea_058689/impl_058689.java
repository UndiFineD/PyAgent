...
@Data
public class Idea58689Config {
    private String name = "idea_058689";
 ...
 */
@Slf4j
public class Idea58689Service {
    private static final int IDEA_ID = 58689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58689Service() {
        this(new Idea58689Config());
    }

    public Idea58689Service(Idea58689Config config) {
        this.config = config != null ? config : new Idea58689Config();
