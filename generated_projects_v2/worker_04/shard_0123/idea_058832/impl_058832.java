...
@Data
public class Idea58832Config {
    private String name = "idea_058832";
 ...
 */
@Slf4j
public class Idea58832Service {
    private static final int IDEA_ID = 58832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58832Service() {
        this(new Idea58832Config());
    }

    public Idea58832Service(Idea58832Config config) {
        this.config = config != null ? config : new Idea58832Config();
