...
@Data
public class Idea58776Config {
    private String name = "idea_058776";
 ...
 */
@Slf4j
public class Idea58776Service {
    private static final int IDEA_ID = 58776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58776Service() {
        this(new Idea58776Config());
    }

    public Idea58776Service(Idea58776Config config) {
        this.config = config != null ? config : new Idea58776Config();
