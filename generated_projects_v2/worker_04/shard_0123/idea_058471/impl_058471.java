...
@Data
public class Idea58471Config {
    private String name = "idea_058471";
 ...
 */
@Slf4j
public class Idea58471Service {
    private static final int IDEA_ID = 58471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58471Service() {
        this(new Idea58471Config());
    }

    public Idea58471Service(Idea58471Config config) {
        this.config = config != null ? config : new Idea58471Config();
