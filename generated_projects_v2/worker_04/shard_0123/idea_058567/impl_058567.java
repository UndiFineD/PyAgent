...
@Data
public class Idea58567Config {
    private String name = "idea_058567";
 ...
 */
@Slf4j
public class Idea58567Service {
    private static final int IDEA_ID = 58567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58567Service() {
        this(new Idea58567Config());
    }

    public Idea58567Service(Idea58567Config config) {
        this.config = config != null ? config : new Idea58567Config();
