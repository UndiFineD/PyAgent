...
@Data
public class Idea58533Config {
    private String name = "idea_058533";
 ...
 */
@Slf4j
public class Idea58533Service {
    private static final int IDEA_ID = 58533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58533Service() {
        this(new Idea58533Config());
    }

    public Idea58533Service(Idea58533Config config) {
        this.config = config != null ? config : new Idea58533Config();
