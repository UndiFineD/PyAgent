...
@Data
public class Idea58464Config {
    private String name = "idea_058464";
 ...
 */
@Slf4j
public class Idea58464Service {
    private static final int IDEA_ID = 58464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58464Service() {
        this(new Idea58464Config());
    }

    public Idea58464Service(Idea58464Config config) {
        this.config = config != null ? config : new Idea58464Config();
