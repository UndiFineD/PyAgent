...
@Data
public class Idea58794Config {
    private String name = "idea_058794";
 ...
 */
@Slf4j
public class Idea58794Service {
    private static final int IDEA_ID = 58794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58794Service() {
        this(new Idea58794Config());
    }

    public Idea58794Service(Idea58794Config config) {
        this.config = config != null ? config : new Idea58794Config();
