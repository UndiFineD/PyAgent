...
@Data
public class Idea58613Config {
    private String name = "idea_058613";
 ...
 */
@Slf4j
public class Idea58613Service {
    private static final int IDEA_ID = 58613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58613Service() {
        this(new Idea58613Config());
    }

    public Idea58613Service(Idea58613Config config) {
        this.config = config != null ? config : new Idea58613Config();
