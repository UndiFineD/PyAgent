...
@Data
public class Idea58653Config {
    private String name = "idea_058653";
 ...
 */
@Slf4j
public class Idea58653Service {
    private static final int IDEA_ID = 58653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58653Service() {
        this(new Idea58653Config());
    }

    public Idea58653Service(Idea58653Config config) {
        this.config = config != null ? config : new Idea58653Config();
