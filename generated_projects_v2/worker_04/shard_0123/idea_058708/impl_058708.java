...
@Data
public class Idea58708Config {
    private String name = "idea_058708";
 ...
 */
@Slf4j
public class Idea58708Service {
    private static final int IDEA_ID = 58708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58708Service() {
        this(new Idea58708Config());
    }

    public Idea58708Service(Idea58708Config config) {
        this.config = config != null ? config : new Idea58708Config();
