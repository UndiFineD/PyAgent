...
@Data
public class Idea58701Config {
    private String name = "idea_058701";
 ...
 */
@Slf4j
public class Idea58701Service {
    private static final int IDEA_ID = 58701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58701Service() {
        this(new Idea58701Config());
    }

    public Idea58701Service(Idea58701Config config) {
        this.config = config != null ? config : new Idea58701Config();
