...
@Data
public class Idea58786Config {
    private String name = "idea_058786";
 ...
 */
@Slf4j
public class Idea58786Service {
    private static final int IDEA_ID = 58786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58786Service() {
        this(new Idea58786Config());
    }

    public Idea58786Service(Idea58786Config config) {
        this.config = config != null ? config : new Idea58786Config();
