...
@Data
public class Idea58865Config {
    private String name = "idea_058865";
 ...
 */
@Slf4j
public class Idea58865Service {
    private static final int IDEA_ID = 58865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58865Service() {
        this(new Idea58865Config());
    }

    public Idea58865Service(Idea58865Config config) {
        this.config = config != null ? config : new Idea58865Config();
