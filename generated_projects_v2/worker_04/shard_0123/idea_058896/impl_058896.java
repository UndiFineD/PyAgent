...
@Data
public class Idea58896Config {
    private String name = "idea_058896";
 ...
 */
@Slf4j
public class Idea58896Service {
    private static final int IDEA_ID = 58896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58896Service() {
        this(new Idea58896Config());
    }

    public Idea58896Service(Idea58896Config config) {
        this.config = config != null ? config : new Idea58896Config();
