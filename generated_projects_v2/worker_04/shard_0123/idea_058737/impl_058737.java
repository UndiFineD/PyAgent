...
@Data
public class Idea58737Config {
    private String name = "idea_058737";
 ...
 */
@Slf4j
public class Idea58737Service {
    private static final int IDEA_ID = 58737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58737Service() {
        this(new Idea58737Config());
    }

    public Idea58737Service(Idea58737Config config) {
        this.config = config != null ? config : new Idea58737Config();
