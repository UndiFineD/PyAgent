...
@Data
public class Idea58502Config {
    private String name = "idea_058502";
 ...
 */
@Slf4j
public class Idea58502Service {
    private static final int IDEA_ID = 58502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58502Service() {
        this(new Idea58502Config());
    }

    public Idea58502Service(Idea58502Config config) {
        this.config = config != null ? config : new Idea58502Config();
