...
@Data
public class Idea58720Config {
    private String name = "idea_058720";
 ...
 */
@Slf4j
public class Idea58720Service {
    private static final int IDEA_ID = 58720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58720Service() {
        this(new Idea58720Config());
    }

    public Idea58720Service(Idea58720Config config) {
        this.config = config != null ? config : new Idea58720Config();
