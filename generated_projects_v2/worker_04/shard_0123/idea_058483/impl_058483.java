...
@Data
public class Idea58483Config {
    private String name = "idea_058483";
 ...
 */
@Slf4j
public class Idea58483Service {
    private static final int IDEA_ID = 58483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58483Service() {
        this(new Idea58483Config());
    }

    public Idea58483Service(Idea58483Config config) {
        this.config = config != null ? config : new Idea58483Config();
