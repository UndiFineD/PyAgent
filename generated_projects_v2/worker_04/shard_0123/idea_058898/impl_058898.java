...
@Data
public class Idea58898Config {
    private String name = "idea_058898";
 ...
 */
@Slf4j
public class Idea58898Service {
    private static final int IDEA_ID = 58898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58898Service() {
        this(new Idea58898Config());
    }

    public Idea58898Service(Idea58898Config config) {
        this.config = config != null ? config : new Idea58898Config();
