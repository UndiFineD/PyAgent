...
@Data
public class Idea58555Config {
    private String name = "idea_058555";
 ...
 */
@Slf4j
public class Idea58555Service {
    private static final int IDEA_ID = 58555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58555Service() {
        this(new Idea58555Config());
    }

    public Idea58555Service(Idea58555Config config) {
        this.config = config != null ? config : new Idea58555Config();
