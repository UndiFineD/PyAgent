...
@Data
public class Idea58837Config {
    private String name = "idea_058837";
 ...
 */
@Slf4j
public class Idea58837Service {
    private static final int IDEA_ID = 58837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58837Service() {
        this(new Idea58837Config());
    }

    public Idea58837Service(Idea58837Config config) {
        this.config = config != null ? config : new Idea58837Config();
