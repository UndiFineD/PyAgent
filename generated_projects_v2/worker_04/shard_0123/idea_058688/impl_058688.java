...
@Data
public class Idea58688Config {
    private String name = "idea_058688";
 ...
 */
@Slf4j
public class Idea58688Service {
    private static final int IDEA_ID = 58688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58688Service() {
        this(new Idea58688Config());
    }

    public Idea58688Service(Idea58688Config config) {
        this.config = config != null ? config : new Idea58688Config();
