...
@Data
public class Idea58561Config {
    private String name = "idea_058561";
 ...
 */
@Slf4j
public class Idea58561Service {
    private static final int IDEA_ID = 58561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58561Service() {
        this(new Idea58561Config());
    }

    public Idea58561Service(Idea58561Config config) {
        this.config = config != null ? config : new Idea58561Config();
