...
@Data
public class Idea58731Config {
    private String name = "idea_058731";
 ...
 */
@Slf4j
public class Idea58731Service {
    private static final int IDEA_ID = 58731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58731Service() {
        this(new Idea58731Config());
    }

    public Idea58731Service(Idea58731Config config) {
        this.config = config != null ? config : new Idea58731Config();
