...
@Data
public class Idea58435Config {
    private String name = "idea_058435";
 ...
 */
@Slf4j
public class Idea58435Service {
    private static final int IDEA_ID = 58435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58435Service() {
        this(new Idea58435Config());
    }

    public Idea58435Service(Idea58435Config config) {
        this.config = config != null ? config : new Idea58435Config();
