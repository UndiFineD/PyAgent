...
@Data
public class Idea58518Config {
    private String name = "idea_058518";
 ...
 */
@Slf4j
public class Idea58518Service {
    private static final int IDEA_ID = 58518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58518Service() {
        this(new Idea58518Config());
    }

    public Idea58518Service(Idea58518Config config) {
        this.config = config != null ? config : new Idea58518Config();
