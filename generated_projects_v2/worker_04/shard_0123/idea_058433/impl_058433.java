...
@Data
public class Idea58433Config {
    private String name = "idea_058433";
 ...
 */
@Slf4j
public class Idea58433Service {
    private static final int IDEA_ID = 58433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58433Service() {
        this(new Idea58433Config());
    }

    public Idea58433Service(Idea58433Config config) {
        this.config = config != null ? config : new Idea58433Config();
