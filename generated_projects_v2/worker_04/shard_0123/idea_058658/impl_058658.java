...
@Data
public class Idea58658Config {
    private String name = "idea_058658";
 ...
 */
@Slf4j
public class Idea58658Service {
    private static final int IDEA_ID = 58658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58658Service() {
        this(new Idea58658Config());
    }

    public Idea58658Service(Idea58658Config config) {
        this.config = config != null ? config : new Idea58658Config();
