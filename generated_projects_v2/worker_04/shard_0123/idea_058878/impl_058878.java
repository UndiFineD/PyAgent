...
@Data
public class Idea58878Config {
    private String name = "idea_058878";
 ...
 */
@Slf4j
public class Idea58878Service {
    private static final int IDEA_ID = 58878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58878Service() {
        this(new Idea58878Config());
    }

    public Idea58878Service(Idea58878Config config) {
        this.config = config != null ? config : new Idea58878Config();
