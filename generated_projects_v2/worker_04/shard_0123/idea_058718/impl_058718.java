...
@Data
public class Idea58718Config {
    private String name = "idea_058718";
 ...
 */
@Slf4j
public class Idea58718Service {
    private static final int IDEA_ID = 58718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58718Service() {
        this(new Idea58718Config());
    }

    public Idea58718Service(Idea58718Config config) {
        this.config = config != null ? config : new Idea58718Config();
