...
@Data
public class Idea58868Config {
    private String name = "idea_058868";
 ...
 */
@Slf4j
public class Idea58868Service {
    private static final int IDEA_ID = 58868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58868Service() {
        this(new Idea58868Config());
    }

    public Idea58868Service(Idea58868Config config) {
        this.config = config != null ? config : new Idea58868Config();
