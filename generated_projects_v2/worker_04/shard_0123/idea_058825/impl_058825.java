...
@Data
public class Idea58825Config {
    private String name = "idea_058825";
 ...
 */
@Slf4j
public class Idea58825Service {
    private static final int IDEA_ID = 58825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58825Service() {
        this(new Idea58825Config());
    }

    public Idea58825Service(Idea58825Config config) {
        this.config = config != null ? config : new Idea58825Config();
