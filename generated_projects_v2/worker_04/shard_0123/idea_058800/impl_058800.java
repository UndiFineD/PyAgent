...
@Data
public class Idea58800Config {
    private String name = "idea_058800";
 ...
 */
@Slf4j
public class Idea58800Service {
    private static final int IDEA_ID = 58800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58800Service() {
        this(new Idea58800Config());
    }

    public Idea58800Service(Idea58800Config config) {
        this.config = config != null ? config : new Idea58800Config();
