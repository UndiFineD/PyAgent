...
@Data
public class Idea58836Config {
    private String name = "idea_058836";
 ...
 */
@Slf4j
public class Idea58836Service {
    private static final int IDEA_ID = 58836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58836Service() {
        this(new Idea58836Config());
    }

    public Idea58836Service(Idea58836Config config) {
        this.config = config != null ? config : new Idea58836Config();
