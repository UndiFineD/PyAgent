...
@Data
public class Idea58668Config {
    private String name = "idea_058668";
 ...
 */
@Slf4j
public class Idea58668Service {
    private static final int IDEA_ID = 58668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58668Service() {
        this(new Idea58668Config());
    }

    public Idea58668Service(Idea58668Config config) {
        this.config = config != null ? config : new Idea58668Config();
