...
@Data
public class Idea58790Config {
    private String name = "idea_058790";
 ...
 */
@Slf4j
public class Idea58790Service {
    private static final int IDEA_ID = 58790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58790Service() {
        this(new Idea58790Config());
    }

    public Idea58790Service(Idea58790Config config) {
        this.config = config != null ? config : new Idea58790Config();
