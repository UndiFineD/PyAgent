...
@Data
public class Idea58458Config {
    private String name = "idea_058458";
 ...
 */
@Slf4j
public class Idea58458Service {
    private static final int IDEA_ID = 58458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58458Service() {
        this(new Idea58458Config());
    }

    public Idea58458Service(Idea58458Config config) {
        this.config = config != null ? config : new Idea58458Config();
