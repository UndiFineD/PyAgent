...
@Data
public class Idea58635Config {
    private String name = "idea_058635";
 ...
 */
@Slf4j
public class Idea58635Service {
    private static final int IDEA_ID = 58635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58635Service() {
        this(new Idea58635Config());
    }

    public Idea58635Service(Idea58635Config config) {
        this.config = config != null ? config : new Idea58635Config();
