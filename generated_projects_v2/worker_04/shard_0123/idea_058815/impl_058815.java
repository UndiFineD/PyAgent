...
@Data
public class Idea58815Config {
    private String name = "idea_058815";
 ...
 */
@Slf4j
public class Idea58815Service {
    private static final int IDEA_ID = 58815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58815Service() {
        this(new Idea58815Config());
    }

    public Idea58815Service(Idea58815Config config) {
        this.config = config != null ? config : new Idea58815Config();
