...
@Data
public class Idea58638Config {
    private String name = "idea_058638";
 ...
 */
@Slf4j
public class Idea58638Service {
    private static final int IDEA_ID = 58638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58638Service() {
        this(new Idea58638Config());
    }

    public Idea58638Service(Idea58638Config config) {
        this.config = config != null ? config : new Idea58638Config();
