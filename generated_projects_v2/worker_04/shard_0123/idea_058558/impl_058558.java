...
@Data
public class Idea58558Config {
    private String name = "idea_058558";
 ...
 */
@Slf4j
public class Idea58558Service {
    private static final int IDEA_ID = 58558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58558Service() {
        this(new Idea58558Config());
    }

    public Idea58558Service(Idea58558Config config) {
        this.config = config != null ? config : new Idea58558Config();
