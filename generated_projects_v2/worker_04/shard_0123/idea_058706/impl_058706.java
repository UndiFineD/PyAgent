...
@Data
public class Idea58706Config {
    private String name = "idea_058706";
 ...
 */
@Slf4j
public class Idea58706Service {
    private static final int IDEA_ID = 58706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58706Service() {
        this(new Idea58706Config());
    }

    public Idea58706Service(Idea58706Config config) {
        this.config = config != null ? config : new Idea58706Config();
