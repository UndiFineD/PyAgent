...
@Data
public class Idea58851Config {
    private String name = "idea_058851";
 ...
 */
@Slf4j
public class Idea58851Service {
    private static final int IDEA_ID = 58851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58851Service() {
        this(new Idea58851Config());
    }

    public Idea58851Service(Idea58851Config config) {
        this.config = config != null ? config : new Idea58851Config();
