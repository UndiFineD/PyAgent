...
@Data
public class Idea58850Config {
    private String name = "idea_058850";
 ...
 */
@Slf4j
public class Idea58850Service {
    private static final int IDEA_ID = 58850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58850Service() {
        this(new Idea58850Config());
    }

    public Idea58850Service(Idea58850Config config) {
        this.config = config != null ? config : new Idea58850Config();
