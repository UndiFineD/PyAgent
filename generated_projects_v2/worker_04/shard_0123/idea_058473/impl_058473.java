...
@Data
public class Idea58473Config {
    private String name = "idea_058473";
 ...
 */
@Slf4j
public class Idea58473Service {
    private static final int IDEA_ID = 58473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58473Service() {
        this(new Idea58473Config());
    }

    public Idea58473Service(Idea58473Config config) {
        this.config = config != null ? config : new Idea58473Config();
