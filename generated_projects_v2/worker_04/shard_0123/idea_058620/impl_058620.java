...
@Data
public class Idea58620Config {
    private String name = "idea_058620";
 ...
 */
@Slf4j
public class Idea58620Service {
    private static final int IDEA_ID = 58620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58620Service() {
        this(new Idea58620Config());
    }

    public Idea58620Service(Idea58620Config config) {
        this.config = config != null ? config : new Idea58620Config();
