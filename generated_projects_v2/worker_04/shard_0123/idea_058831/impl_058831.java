...
@Data
public class Idea58831Config {
    private String name = "idea_058831";
 ...
 */
@Slf4j
public class Idea58831Service {
    private static final int IDEA_ID = 58831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58831Service() {
        this(new Idea58831Config());
    }

    public Idea58831Service(Idea58831Config config) {
        this.config = config != null ? config : new Idea58831Config();
