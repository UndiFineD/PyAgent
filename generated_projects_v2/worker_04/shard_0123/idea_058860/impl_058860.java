...
@Data
public class Idea58860Config {
    private String name = "idea_058860";
 ...
 */
@Slf4j
public class Idea58860Service {
    private static final int IDEA_ID = 58860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58860Service() {
        this(new Idea58860Config());
    }

    public Idea58860Service(Idea58860Config config) {
        this.config = config != null ? config : new Idea58860Config();
