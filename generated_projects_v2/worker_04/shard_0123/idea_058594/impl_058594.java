...
@Data
public class Idea58594Config {
    private String name = "idea_058594";
 ...
 */
@Slf4j
public class Idea58594Service {
    private static final int IDEA_ID = 58594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58594Service() {
        this(new Idea58594Config());
    }

    public Idea58594Service(Idea58594Config config) {
        this.config = config != null ? config : new Idea58594Config();
