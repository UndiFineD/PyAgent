...
@Data
public class Idea58604Config {
    private String name = "idea_058604";
 ...
 */
@Slf4j
public class Idea58604Service {
    private static final int IDEA_ID = 58604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58604Service() {
        this(new Idea58604Config());
    }

    public Idea58604Service(Idea58604Config config) {
        this.config = config != null ? config : new Idea58604Config();
