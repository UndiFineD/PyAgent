...
@Data
public class Idea58884Config {
    private String name = "idea_058884";
 ...
 */
@Slf4j
public class Idea58884Service {
    private static final int IDEA_ID = 58884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58884Service() {
        this(new Idea58884Config());
    }

    public Idea58884Service(Idea58884Config config) {
        this.config = config != null ? config : new Idea58884Config();
