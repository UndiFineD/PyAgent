...
@Data
public class Idea58456Config {
    private String name = "idea_058456";
 ...
 */
@Slf4j
public class Idea58456Service {
    private static final int IDEA_ID = 58456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58456Service() {
        this(new Idea58456Config());
    }

    public Idea58456Service(Idea58456Config config) {
        this.config = config != null ? config : new Idea58456Config();
