...
@Data
public class Idea58748Config {
    private String name = "idea_058748";
 ...
 */
@Slf4j
public class Idea58748Service {
    private static final int IDEA_ID = 58748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58748Service() {
        this(new Idea58748Config());
    }

    public Idea58748Service(Idea58748Config config) {
        this.config = config != null ? config : new Idea58748Config();
