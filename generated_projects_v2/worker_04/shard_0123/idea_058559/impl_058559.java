...
@Data
public class Idea58559Config {
    private String name = "idea_058559";
 ...
 */
@Slf4j
public class Idea58559Service {
    private static final int IDEA_ID = 58559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58559Service() {
        this(new Idea58559Config());
    }

    public Idea58559Service(Idea58559Config config) {
        this.config = config != null ? config : new Idea58559Config();
