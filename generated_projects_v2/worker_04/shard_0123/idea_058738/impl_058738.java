...
@Data
public class Idea58738Config {
    private String name = "idea_058738";
 ...
 */
@Slf4j
public class Idea58738Service {
    private static final int IDEA_ID = 58738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58738Service() {
        this(new Idea58738Config());
    }

    public Idea58738Service(Idea58738Config config) {
        this.config = config != null ? config : new Idea58738Config();
