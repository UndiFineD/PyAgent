...
@Data
public class Idea58547Config {
    private String name = "idea_058547";
 ...
 */
@Slf4j
public class Idea58547Service {
    private static final int IDEA_ID = 58547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58547Service() {
        this(new Idea58547Config());
    }

    public Idea58547Service(Idea58547Config config) {
        this.config = config != null ? config : new Idea58547Config();
