...
@Data
public class Idea58662Config {
    private String name = "idea_058662";
 ...
 */
@Slf4j
public class Idea58662Service {
    private static final int IDEA_ID = 58662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58662Service() {
        this(new Idea58662Config());
    }

    public Idea58662Service(Idea58662Config config) {
        this.config = config != null ? config : new Idea58662Config();
