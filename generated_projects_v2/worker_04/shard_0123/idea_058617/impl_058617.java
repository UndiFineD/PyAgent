...
@Data
public class Idea58617Config {
    private String name = "idea_058617";
 ...
 */
@Slf4j
public class Idea58617Service {
    private static final int IDEA_ID = 58617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58617Service() {
        this(new Idea58617Config());
    }

    public Idea58617Service(Idea58617Config config) {
        this.config = config != null ? config : new Idea58617Config();
