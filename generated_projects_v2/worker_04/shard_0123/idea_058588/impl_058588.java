...
@Data
public class Idea58588Config {
    private String name = "idea_058588";
 ...
 */
@Slf4j
public class Idea58588Service {
    private static final int IDEA_ID = 58588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58588Service() {
        this(new Idea58588Config());
    }

    public Idea58588Service(Idea58588Config config) {
        this.config = config != null ? config : new Idea58588Config();
