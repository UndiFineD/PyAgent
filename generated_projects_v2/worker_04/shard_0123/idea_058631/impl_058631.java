...
@Data
public class Idea58631Config {
    private String name = "idea_058631";
 ...
 */
@Slf4j
public class Idea58631Service {
    private static final int IDEA_ID = 58631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58631Service() {
        this(new Idea58631Config());
    }

    public Idea58631Service(Idea58631Config config) {
        this.config = config != null ? config : new Idea58631Config();
