...
@Data
public class Idea58560Config {
    private String name = "idea_058560";
 ...
 */
@Slf4j
public class Idea58560Service {
    private static final int IDEA_ID = 58560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58560Service() {
        this(new Idea58560Config());
    }

    public Idea58560Service(Idea58560Config config) {
        this.config = config != null ? config : new Idea58560Config();
