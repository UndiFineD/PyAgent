...
@Data
public class Idea58461Config {
    private String name = "idea_058461";
 ...
 */
@Slf4j
public class Idea58461Service {
    private static final int IDEA_ID = 58461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58461Service() {
        this(new Idea58461Config());
    }

    public Idea58461Service(Idea58461Config config) {
        this.config = config != null ? config : new Idea58461Config();
