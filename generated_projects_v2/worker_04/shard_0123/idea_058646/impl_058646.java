...
@Data
public class Idea58646Config {
    private String name = "idea_058646";
 ...
 */
@Slf4j
public class Idea58646Service {
    private static final int IDEA_ID = 58646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58646Service() {
        this(new Idea58646Config());
    }

    public Idea58646Service(Idea58646Config config) {
        this.config = config != null ? config : new Idea58646Config();
