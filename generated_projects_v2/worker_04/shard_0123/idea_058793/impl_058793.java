...
@Data
public class Idea58793Config {
    private String name = "idea_058793";
 ...
 */
@Slf4j
public class Idea58793Service {
    private static final int IDEA_ID = 58793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58793Service() {
        this(new Idea58793Config());
    }

    public Idea58793Service(Idea58793Config config) {
        this.config = config != null ? config : new Idea58793Config();
