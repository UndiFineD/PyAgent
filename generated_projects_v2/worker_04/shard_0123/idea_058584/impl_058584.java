...
@Data
public class Idea58584Config {
    private String name = "idea_058584";
 ...
 */
@Slf4j
public class Idea58584Service {
    private static final int IDEA_ID = 58584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58584Service() {
        this(new Idea58584Config());
    }

    public Idea58584Service(Idea58584Config config) {
        this.config = config != null ? config : new Idea58584Config();
