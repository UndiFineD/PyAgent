...
@Data
public class Idea58697Config {
    private String name = "idea_058697";
 ...
 */
@Slf4j
public class Idea58697Service {
    private static final int IDEA_ID = 58697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58697Service() {
        this(new Idea58697Config());
    }

    public Idea58697Service(Idea58697Config config) {
        this.config = config != null ? config : new Idea58697Config();
