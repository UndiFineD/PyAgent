...
@Data
public class Idea58839Config {
    private String name = "idea_058839";
 ...
 */
@Slf4j
public class Idea58839Service {
    private static final int IDEA_ID = 58839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58839Service() {
        this(new Idea58839Config());
    }

    public Idea58839Service(Idea58839Config config) {
        this.config = config != null ? config : new Idea58839Config();
