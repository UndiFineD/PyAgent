...
@Data
public class Idea60823Config {
    private String name = "idea_060823";
 ...
 */
@Slf4j
public class Idea60823Service {
    private static final int IDEA_ID = 60823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60823Service() {
        this(new Idea60823Config());
    }

    public Idea60823Service(Idea60823Config config) {
        this.config = config != null ? config : new Idea60823Config();
