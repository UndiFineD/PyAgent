...
@Data
public class Idea61049Config {
    private String name = "idea_061049";
 ...
 */
@Slf4j
public class Idea61049Service {
    private static final int IDEA_ID = 61049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61049Service() {
        this(new Idea61049Config());
    }

    public Idea61049Service(Idea61049Config config) {
        this.config = config != null ? config : new Idea61049Config();
