...
@Data
public class Idea61206Config {
    private String name = "idea_061206";
 ...
 */
@Slf4j
public class Idea61206Service {
    private static final int IDEA_ID = 61206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61206Service() {
        this(new Idea61206Config());
    }

    public Idea61206Service(Idea61206Config config) {
        this.config = config != null ? config : new Idea61206Config();
