...
@Data
public class Idea61037Config {
    private String name = "idea_061037";
 ...
 */
@Slf4j
public class Idea61037Service {
    private static final int IDEA_ID = 61037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61037Service() {
        this(new Idea61037Config());
    }

    public Idea61037Service(Idea61037Config config) {
        this.config = config != null ? config : new Idea61037Config();
