...
@Data
public class Idea60885Config {
    private String name = "idea_060885";
 ...
 */
@Slf4j
public class Idea60885Service {
    private static final int IDEA_ID = 60885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60885Service() {
        this(new Idea60885Config());
    }

    public Idea60885Service(Idea60885Config config) {
        this.config = config != null ? config : new Idea60885Config();
