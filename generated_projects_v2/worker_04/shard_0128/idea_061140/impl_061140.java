...
@Data
public class Idea61140Config {
    private String name = "idea_061140";
 ...
 */
@Slf4j
public class Idea61140Service {
    private static final int IDEA_ID = 61140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61140Service() {
        this(new Idea61140Config());
    }

    public Idea61140Service(Idea61140Config config) {
        this.config = config != null ? config : new Idea61140Config();
