...
@Data
public class Idea61046Config {
    private String name = "idea_061046";
 ...
 */
@Slf4j
public class Idea61046Service {
    private static final int IDEA_ID = 61046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61046Service() {
        this(new Idea61046Config());
    }

    public Idea61046Service(Idea61046Config config) {
        this.config = config != null ? config : new Idea61046Config();
