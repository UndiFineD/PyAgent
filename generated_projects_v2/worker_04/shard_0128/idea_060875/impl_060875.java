...
@Data
public class Idea60875Config {
    private String name = "idea_060875";
 ...
 */
@Slf4j
public class Idea60875Service {
    private static final int IDEA_ID = 60875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60875Service() {
        this(new Idea60875Config());
    }

    public Idea60875Service(Idea60875Config config) {
        this.config = config != null ? config : new Idea60875Config();
