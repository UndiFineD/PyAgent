...
@Data
public class Idea60862Config {
    private String name = "idea_060862";
 ...
 */
@Slf4j
public class Idea60862Service {
    private static final int IDEA_ID = 60862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60862Service() {
        this(new Idea60862Config());
    }

    public Idea60862Service(Idea60862Config config) {
        this.config = config != null ? config : new Idea60862Config();
