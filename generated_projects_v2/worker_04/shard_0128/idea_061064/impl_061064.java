...
@Data
public class Idea61064Config {
    private String name = "idea_061064";
 ...
 */
@Slf4j
public class Idea61064Service {
    private static final int IDEA_ID = 61064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61064Service() {
        this(new Idea61064Config());
    }

    public Idea61064Service(Idea61064Config config) {
        this.config = config != null ? config : new Idea61064Config();
