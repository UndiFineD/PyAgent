...
@Data
public class Idea60851Config {
    private String name = "idea_060851";
 ...
 */
@Slf4j
public class Idea60851Service {
    private static final int IDEA_ID = 60851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60851Service() {
        this(new Idea60851Config());
    }

    public Idea60851Service(Idea60851Config config) {
        this.config = config != null ? config : new Idea60851Config();
