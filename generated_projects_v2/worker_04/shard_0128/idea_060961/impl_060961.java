...
@Data
public class Idea60961Config {
    private String name = "idea_060961";
 ...
 */
@Slf4j
public class Idea60961Service {
    private static final int IDEA_ID = 60961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60961Service() {
        this(new Idea60961Config());
    }

    public Idea60961Service(Idea60961Config config) {
        this.config = config != null ? config : new Idea60961Config();
