...
@Data
public class Idea61039Config {
    private String name = "idea_061039";
 ...
 */
@Slf4j
public class Idea61039Service {
    private static final int IDEA_ID = 61039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61039Service() {
        this(new Idea61039Config());
    }

    public Idea61039Service(Idea61039Config config) {
        this.config = config != null ? config : new Idea61039Config();
