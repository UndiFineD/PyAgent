...
@Data
public class Idea61137Config {
    private String name = "idea_061137";
 ...
 */
@Slf4j
public class Idea61137Service {
    private static final int IDEA_ID = 61137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61137Service() {
        this(new Idea61137Config());
    }

    public Idea61137Service(Idea61137Config config) {
        this.config = config != null ? config : new Idea61137Config();
