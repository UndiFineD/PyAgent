...
@Data
public class Idea61262Config {
    private String name = "idea_061262";
 ...
 */
@Slf4j
public class Idea61262Service {
    private static final int IDEA_ID = 61262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61262Service() {
        this(new Idea61262Config());
    }

    public Idea61262Service(Idea61262Config config) {
        this.config = config != null ? config : new Idea61262Config();
