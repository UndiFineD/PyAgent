...
@Data
public class Idea60945Config {
    private String name = "idea_060945";
 ...
 */
@Slf4j
public class Idea60945Service {
    private static final int IDEA_ID = 60945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60945Service() {
        this(new Idea60945Config());
    }

    public Idea60945Service(Idea60945Config config) {
        this.config = config != null ? config : new Idea60945Config();
