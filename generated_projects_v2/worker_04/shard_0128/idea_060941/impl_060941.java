...
@Data
public class Idea60941Config {
    private String name = "idea_060941";
 ...
 */
@Slf4j
public class Idea60941Service {
    private static final int IDEA_ID = 60941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60941Service() {
        this(new Idea60941Config());
    }

    public Idea60941Service(Idea60941Config config) {
        this.config = config != null ? config : new Idea60941Config();
