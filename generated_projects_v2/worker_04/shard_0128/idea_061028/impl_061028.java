...
@Data
public class Idea61028Config {
    private String name = "idea_061028";
 ...
 */
@Slf4j
public class Idea61028Service {
    private static final int IDEA_ID = 61028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61028Service() {
        this(new Idea61028Config());
    }

    public Idea61028Service(Idea61028Config config) {
        this.config = config != null ? config : new Idea61028Config();
