...
@Data
public class Idea61218Config {
    private String name = "idea_061218";
 ...
 */
@Slf4j
public class Idea61218Service {
    private static final int IDEA_ID = 61218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61218Service() {
        this(new Idea61218Config());
    }

    public Idea61218Service(Idea61218Config config) {
        this.config = config != null ? config : new Idea61218Config();
