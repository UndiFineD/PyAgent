...
@Data
public class Idea60909Config {
    private String name = "idea_060909";
 ...
 */
@Slf4j
public class Idea60909Service {
    private static final int IDEA_ID = 60909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60909Service() {
        this(new Idea60909Config());
    }

    public Idea60909Service(Idea60909Config config) {
        this.config = config != null ? config : new Idea60909Config();
