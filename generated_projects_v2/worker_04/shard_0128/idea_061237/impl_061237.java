...
@Data
public class Idea61237Config {
    private String name = "idea_061237";
 ...
 */
@Slf4j
public class Idea61237Service {
    private static final int IDEA_ID = 61237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61237Service() {
        this(new Idea61237Config());
    }

    public Idea61237Service(Idea61237Config config) {
        this.config = config != null ? config : new Idea61237Config();
