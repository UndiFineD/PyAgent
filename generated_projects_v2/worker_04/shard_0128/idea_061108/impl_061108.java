...
@Data
public class Idea61108Config {
    private String name = "idea_061108";
 ...
 */
@Slf4j
public class Idea61108Service {
    private static final int IDEA_ID = 61108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61108Service() {
        this(new Idea61108Config());
    }

    public Idea61108Service(Idea61108Config config) {
        this.config = config != null ? config : new Idea61108Config();
