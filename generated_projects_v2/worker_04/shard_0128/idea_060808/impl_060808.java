...
@Data
public class Idea60808Config {
    private String name = "idea_060808";
 ...
 */
@Slf4j
public class Idea60808Service {
    private static final int IDEA_ID = 60808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60808Service() {
        this(new Idea60808Config());
    }

    public Idea60808Service(Idea60808Config config) {
        this.config = config != null ? config : new Idea60808Config();
