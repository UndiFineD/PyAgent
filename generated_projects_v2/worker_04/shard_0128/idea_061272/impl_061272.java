...
@Data
public class Idea61272Config {
    private String name = "idea_061272";
 ...
 */
@Slf4j
public class Idea61272Service {
    private static final int IDEA_ID = 61272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61272Service() {
        this(new Idea61272Config());
    }

    public Idea61272Service(Idea61272Config config) {
        this.config = config != null ? config : new Idea61272Config();
