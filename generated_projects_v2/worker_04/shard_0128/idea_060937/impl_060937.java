...
@Data
public class Idea60937Config {
    private String name = "idea_060937";
 ...
 */
@Slf4j
public class Idea60937Service {
    private static final int IDEA_ID = 60937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60937Service() {
        this(new Idea60937Config());
    }

    public Idea60937Service(Idea60937Config config) {
        this.config = config != null ? config : new Idea60937Config();
