...
@Data
public class Idea61246Config {
    private String name = "idea_061246";
 ...
 */
@Slf4j
public class Idea61246Service {
    private static final int IDEA_ID = 61246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61246Service() {
        this(new Idea61246Config());
    }

    public Idea61246Service(Idea61246Config config) {
        this.config = config != null ? config : new Idea61246Config();
