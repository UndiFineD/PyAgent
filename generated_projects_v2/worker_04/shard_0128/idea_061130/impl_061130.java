...
@Data
public class Idea61130Config {
    private String name = "idea_061130";
 ...
 */
@Slf4j
public class Idea61130Service {
    private static final int IDEA_ID = 61130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61130Service() {
        this(new Idea61130Config());
    }

    public Idea61130Service(Idea61130Config config) {
        this.config = config != null ? config : new Idea61130Config();
