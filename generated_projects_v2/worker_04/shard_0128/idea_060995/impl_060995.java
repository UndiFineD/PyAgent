...
@Data
public class Idea60995Config {
    private String name = "idea_060995";
 ...
 */
@Slf4j
public class Idea60995Service {
    private static final int IDEA_ID = 60995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60995Service() {
        this(new Idea60995Config());
    }

    public Idea60995Service(Idea60995Config config) {
        this.config = config != null ? config : new Idea60995Config();
