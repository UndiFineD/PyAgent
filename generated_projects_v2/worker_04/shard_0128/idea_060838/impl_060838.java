...
@Data
public class Idea60838Config {
    private String name = "idea_060838";
 ...
 */
@Slf4j
public class Idea60838Service {
    private static final int IDEA_ID = 60838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60838Service() {
        this(new Idea60838Config());
    }

    public Idea60838Service(Idea60838Config config) {
        this.config = config != null ? config : new Idea60838Config();
