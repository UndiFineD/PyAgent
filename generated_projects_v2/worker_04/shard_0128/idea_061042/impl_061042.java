...
@Data
public class Idea61042Config {
    private String name = "idea_061042";
 ...
 */
@Slf4j
public class Idea61042Service {
    private static final int IDEA_ID = 61042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61042Service() {
        this(new Idea61042Config());
    }

    public Idea61042Service(Idea61042Config config) {
        this.config = config != null ? config : new Idea61042Config();
