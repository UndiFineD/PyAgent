...
@Data
public class Idea61101Config {
    private String name = "idea_061101";
 ...
 */
@Slf4j
public class Idea61101Service {
    private static final int IDEA_ID = 61101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61101Service() {
        this(new Idea61101Config());
    }

    public Idea61101Service(Idea61101Config config) {
        this.config = config != null ? config : new Idea61101Config();
