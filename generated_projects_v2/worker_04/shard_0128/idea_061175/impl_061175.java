...
@Data
public class Idea61175Config {
    private String name = "idea_061175";
 ...
 */
@Slf4j
public class Idea61175Service {
    private static final int IDEA_ID = 61175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61175Service() {
        this(new Idea61175Config());
    }

    public Idea61175Service(Idea61175Config config) {
        this.config = config != null ? config : new Idea61175Config();
