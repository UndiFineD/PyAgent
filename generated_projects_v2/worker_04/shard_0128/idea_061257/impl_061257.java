...
@Data
public class Idea61257Config {
    private String name = "idea_061257";
 ...
 */
@Slf4j
public class Idea61257Service {
    private static final int IDEA_ID = 61257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61257Service() {
        this(new Idea61257Config());
    }

    public Idea61257Service(Idea61257Config config) {
        this.config = config != null ? config : new Idea61257Config();
