...
@Data
public class Idea60951Config {
    private String name = "idea_060951";
 ...
 */
@Slf4j
public class Idea60951Service {
    private static final int IDEA_ID = 60951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60951Service() {
        this(new Idea60951Config());
    }

    public Idea60951Service(Idea60951Config config) {
        this.config = config != null ? config : new Idea60951Config();
