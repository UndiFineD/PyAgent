...
@Data
public class Idea61087Config {
    private String name = "idea_061087";
 ...
 */
@Slf4j
public class Idea61087Service {
    private static final int IDEA_ID = 61087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61087Service() {
        this(new Idea61087Config());
    }

    public Idea61087Service(Idea61087Config config) {
        this.config = config != null ? config : new Idea61087Config();
