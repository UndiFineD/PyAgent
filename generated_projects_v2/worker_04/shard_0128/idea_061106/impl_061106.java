...
@Data
public class Idea61106Config {
    private String name = "idea_061106";
 ...
 */
@Slf4j
public class Idea61106Service {
    private static final int IDEA_ID = 61106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61106Service() {
        this(new Idea61106Config());
    }

    public Idea61106Service(Idea61106Config config) {
        this.config = config != null ? config : new Idea61106Config();
