...
@Data
public class Idea61083Config {
    private String name = "idea_061083";
 ...
 */
@Slf4j
public class Idea61083Service {
    private static final int IDEA_ID = 61083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61083Service() {
        this(new Idea61083Config());
    }

    public Idea61083Service(Idea61083Config config) {
        this.config = config != null ? config : new Idea61083Config();
