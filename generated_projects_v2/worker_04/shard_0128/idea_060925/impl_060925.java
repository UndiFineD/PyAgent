...
@Data
public class Idea60925Config {
    private String name = "idea_060925";
 ...
 */
@Slf4j
public class Idea60925Service {
    private static final int IDEA_ID = 60925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60925Service() {
        this(new Idea60925Config());
    }

    public Idea60925Service(Idea60925Config config) {
        this.config = config != null ? config : new Idea60925Config();
