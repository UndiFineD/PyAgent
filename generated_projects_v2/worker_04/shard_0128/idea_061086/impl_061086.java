...
@Data
public class Idea61086Config {
    private String name = "idea_061086";
 ...
 */
@Slf4j
public class Idea61086Service {
    private static final int IDEA_ID = 61086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61086Service() {
        this(new Idea61086Config());
    }

    public Idea61086Service(Idea61086Config config) {
        this.config = config != null ? config : new Idea61086Config();
