...
@Data
public class Idea61111Config {
    private String name = "idea_061111";
 ...
 */
@Slf4j
public class Idea61111Service {
    private static final int IDEA_ID = 61111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61111Service() {
        this(new Idea61111Config());
    }

    public Idea61111Service(Idea61111Config config) {
        this.config = config != null ? config : new Idea61111Config();
