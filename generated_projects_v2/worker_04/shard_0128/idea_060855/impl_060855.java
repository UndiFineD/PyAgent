...
@Data
public class Idea60855Config {
    private String name = "idea_060855";
 ...
 */
@Slf4j
public class Idea60855Service {
    private static final int IDEA_ID = 60855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60855Service() {
        this(new Idea60855Config());
    }

    public Idea60855Service(Idea60855Config config) {
        this.config = config != null ? config : new Idea60855Config();
