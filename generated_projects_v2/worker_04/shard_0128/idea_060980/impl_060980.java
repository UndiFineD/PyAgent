...
@Data
public class Idea60980Config {
    private String name = "idea_060980";
 ...
 */
@Slf4j
public class Idea60980Service {
    private static final int IDEA_ID = 60980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60980Service() {
        this(new Idea60980Config());
    }

    public Idea60980Service(Idea60980Config config) {
        this.config = config != null ? config : new Idea60980Config();
