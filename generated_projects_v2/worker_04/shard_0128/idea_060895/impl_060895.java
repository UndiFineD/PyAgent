...
@Data
public class Idea60895Config {
    private String name = "idea_060895";
 ...
 */
@Slf4j
public class Idea60895Service {
    private static final int IDEA_ID = 60895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60895Service() {
        this(new Idea60895Config());
    }

    public Idea60895Service(Idea60895Config config) {
        this.config = config != null ? config : new Idea60895Config();
