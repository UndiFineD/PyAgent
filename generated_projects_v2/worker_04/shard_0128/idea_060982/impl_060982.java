...
@Data
public class Idea60982Config {
    private String name = "idea_060982";
 ...
 */
@Slf4j
public class Idea60982Service {
    private static final int IDEA_ID = 60982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60982Service() {
        this(new Idea60982Config());
    }

    public Idea60982Service(Idea60982Config config) {
        this.config = config != null ? config : new Idea60982Config();
