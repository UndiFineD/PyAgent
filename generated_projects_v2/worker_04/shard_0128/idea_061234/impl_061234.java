...
@Data
public class Idea61234Config {
    private String name = "idea_061234";
 ...
 */
@Slf4j
public class Idea61234Service {
    private static final int IDEA_ID = 61234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61234Service() {
        this(new Idea61234Config());
    }

    public Idea61234Service(Idea61234Config config) {
        this.config = config != null ? config : new Idea61234Config();
