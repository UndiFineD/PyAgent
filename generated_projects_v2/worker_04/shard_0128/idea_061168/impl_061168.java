...
@Data
public class Idea61168Config {
    private String name = "idea_061168";
 ...
 */
@Slf4j
public class Idea61168Service {
    private static final int IDEA_ID = 61168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61168Service() {
        this(new Idea61168Config());
    }

    public Idea61168Service(Idea61168Config config) {
        this.config = config != null ? config : new Idea61168Config();
