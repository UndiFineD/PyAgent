...
@Data
public class Idea60863Config {
    private String name = "idea_060863";
 ...
 */
@Slf4j
public class Idea60863Service {
    private static final int IDEA_ID = 60863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60863Service() {
        this(new Idea60863Config());
    }

    public Idea60863Service(Idea60863Config config) {
        this.config = config != null ? config : new Idea60863Config();
