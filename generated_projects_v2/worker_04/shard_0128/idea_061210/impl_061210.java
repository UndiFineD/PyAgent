...
@Data
public class Idea61210Config {
    private String name = "idea_061210";
 ...
 */
@Slf4j
public class Idea61210Service {
    private static final int IDEA_ID = 61210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61210Service() {
        this(new Idea61210Config());
    }

    public Idea61210Service(Idea61210Config config) {
        this.config = config != null ? config : new Idea61210Config();
