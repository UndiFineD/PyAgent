...
@Data
public class Idea61094Config {
    private String name = "idea_061094";
 ...
 */
@Slf4j
public class Idea61094Service {
    private static final int IDEA_ID = 61094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61094Service() {
        this(new Idea61094Config());
    }

    public Idea61094Service(Idea61094Config config) {
        this.config = config != null ? config : new Idea61094Config();
