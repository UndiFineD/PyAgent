...
@Data
public class Idea60963Config {
    private String name = "idea_060963";
 ...
 */
@Slf4j
public class Idea60963Service {
    private static final int IDEA_ID = 60963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60963Service() {
        this(new Idea60963Config());
    }

    public Idea60963Service(Idea60963Config config) {
        this.config = config != null ? config : new Idea60963Config();
