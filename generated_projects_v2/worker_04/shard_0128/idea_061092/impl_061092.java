...
@Data
public class Idea61092Config {
    private String name = "idea_061092";
 ...
 */
@Slf4j
public class Idea61092Service {
    private static final int IDEA_ID = 61092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61092Service() {
        this(new Idea61092Config());
    }

    public Idea61092Service(Idea61092Config config) {
        this.config = config != null ? config : new Idea61092Config();
