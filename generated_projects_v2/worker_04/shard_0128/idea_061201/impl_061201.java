...
@Data
public class Idea61201Config {
    private String name = "idea_061201";
 ...
 */
@Slf4j
public class Idea61201Service {
    private static final int IDEA_ID = 61201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61201Service() {
        this(new Idea61201Config());
    }

    public Idea61201Service(Idea61201Config config) {
        this.config = config != null ? config : new Idea61201Config();
