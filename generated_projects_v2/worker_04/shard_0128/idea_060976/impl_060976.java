...
@Data
public class Idea60976Config {
    private String name = "idea_060976";
 ...
 */
@Slf4j
public class Idea60976Service {
    private static final int IDEA_ID = 60976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60976Service() {
        this(new Idea60976Config());
    }

    public Idea60976Service(Idea60976Config config) {
        this.config = config != null ? config : new Idea60976Config();
