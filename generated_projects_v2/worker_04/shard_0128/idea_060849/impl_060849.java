...
@Data
public class Idea60849Config {
    private String name = "idea_060849";
 ...
 */
@Slf4j
public class Idea60849Service {
    private static final int IDEA_ID = 60849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60849Service() {
        this(new Idea60849Config());
    }

    public Idea60849Service(Idea60849Config config) {
        this.config = config != null ? config : new Idea60849Config();
