...
@Data
public class Idea60960Config {
    private String name = "idea_060960";
 ...
 */
@Slf4j
public class Idea60960Service {
    private static final int IDEA_ID = 60960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60960Service() {
        this(new Idea60960Config());
    }

    public Idea60960Service(Idea60960Config config) {
        this.config = config != null ? config : new Idea60960Config();
