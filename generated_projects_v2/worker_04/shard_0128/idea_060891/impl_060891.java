...
@Data
public class Idea60891Config {
    private String name = "idea_060891";
 ...
 */
@Slf4j
public class Idea60891Service {
    private static final int IDEA_ID = 60891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60891Service() {
        this(new Idea60891Config());
    }

    public Idea60891Service(Idea60891Config config) {
        this.config = config != null ? config : new Idea60891Config();
