...
@Data
public class Idea61003Config {
    private String name = "idea_061003";
 ...
 */
@Slf4j
public class Idea61003Service {
    private static final int IDEA_ID = 61003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61003Service() {
        this(new Idea61003Config());
    }

    public Idea61003Service(Idea61003Config config) {
        this.config = config != null ? config : new Idea61003Config();
