...
@Data
public class Idea60830Config {
    private String name = "idea_060830";
 ...
 */
@Slf4j
public class Idea60830Service {
    private static final int IDEA_ID = 60830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60830Service() {
        this(new Idea60830Config());
    }

    public Idea60830Service(Idea60830Config config) {
        this.config = config != null ? config : new Idea60830Config();
