...
@Data
public class Idea60940Config {
    private String name = "idea_060940";
 ...
 */
@Slf4j
public class Idea60940Service {
    private static final int IDEA_ID = 60940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60940Service() {
        this(new Idea60940Config());
    }

    public Idea60940Service(Idea60940Config config) {
        this.config = config != null ? config : new Idea60940Config();
