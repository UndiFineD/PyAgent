...
@Data
public class Idea60846Config {
    private String name = "idea_060846";
 ...
 */
@Slf4j
public class Idea60846Service {
    private static final int IDEA_ID = 60846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60846Service() {
        this(new Idea60846Config());
    }

    public Idea60846Service(Idea60846Config config) {
        this.config = config != null ? config : new Idea60846Config();
