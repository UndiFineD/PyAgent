...
@Data
public class Idea60888Config {
    private String name = "idea_060888";
 ...
 */
@Slf4j
public class Idea60888Service {
    private static final int IDEA_ID = 60888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60888Service() {
        this(new Idea60888Config());
    }

    public Idea60888Service(Idea60888Config config) {
        this.config = config != null ? config : new Idea60888Config();
