...
@Data
public class Idea60834Config {
    private String name = "idea_060834";
 ...
 */
@Slf4j
public class Idea60834Service {
    private static final int IDEA_ID = 60834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60834Service() {
        this(new Idea60834Config());
    }

    public Idea60834Service(Idea60834Config config) {
        this.config = config != null ? config : new Idea60834Config();
