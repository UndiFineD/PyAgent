...
@Data
public class Idea60858Config {
    private String name = "idea_060858";
 ...
 */
@Slf4j
public class Idea60858Service {
    private static final int IDEA_ID = 60858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60858Service() {
        this(new Idea60858Config());
    }

    public Idea60858Service(Idea60858Config config) {
        this.config = config != null ? config : new Idea60858Config();
