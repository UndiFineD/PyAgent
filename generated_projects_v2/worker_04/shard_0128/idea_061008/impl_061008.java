...
@Data
public class Idea61008Config {
    private String name = "idea_061008";
 ...
 */
@Slf4j
public class Idea61008Service {
    private static final int IDEA_ID = 61008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61008Service() {
        this(new Idea61008Config());
    }

    public Idea61008Service(Idea61008Config config) {
        this.config = config != null ? config : new Idea61008Config();
