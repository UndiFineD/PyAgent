...
@Data
public class Idea61187Config {
    private String name = "idea_061187";
 ...
 */
@Slf4j
public class Idea61187Service {
    private static final int IDEA_ID = 61187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61187Service() {
        this(new Idea61187Config());
    }

    public Idea61187Service(Idea61187Config config) {
        this.config = config != null ? config : new Idea61187Config();
