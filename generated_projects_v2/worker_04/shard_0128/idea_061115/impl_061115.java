...
@Data
public class Idea61115Config {
    private String name = "idea_061115";
 ...
 */
@Slf4j
public class Idea61115Service {
    private static final int IDEA_ID = 61115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61115Service() {
        this(new Idea61115Config());
    }

    public Idea61115Service(Idea61115Config config) {
        this.config = config != null ? config : new Idea61115Config();
