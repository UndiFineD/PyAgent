...
@Data
public class Idea60857Config {
    private String name = "idea_060857";
 ...
 */
@Slf4j
public class Idea60857Service {
    private static final int IDEA_ID = 60857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60857Service() {
        this(new Idea60857Config());
    }

    public Idea60857Service(Idea60857Config config) {
        this.config = config != null ? config : new Idea60857Config();
