...
@Data
public class Idea61112Config {
    private String name = "idea_061112";
 ...
 */
@Slf4j
public class Idea61112Service {
    private static final int IDEA_ID = 61112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61112Service() {
        this(new Idea61112Config());
    }

    public Idea61112Service(Idea61112Config config) {
        this.config = config != null ? config : new Idea61112Config();
