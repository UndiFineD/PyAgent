...
@Data
public class Idea60865Config {
    private String name = "idea_060865";
 ...
 */
@Slf4j
public class Idea60865Service {
    private static final int IDEA_ID = 60865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60865Service() {
        this(new Idea60865Config());
    }

    public Idea60865Service(Idea60865Config config) {
        this.config = config != null ? config : new Idea60865Config();
