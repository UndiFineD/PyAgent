...
@Data
public class Idea61019Config {
    private String name = "idea_061019";
 ...
 */
@Slf4j
public class Idea61019Service {
    private static final int IDEA_ID = 61019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61019Service() {
        this(new Idea61019Config());
    }

    public Idea61019Service(Idea61019Config config) {
        this.config = config != null ? config : new Idea61019Config();
