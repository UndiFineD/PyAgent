...
@Data
public class Idea61265Config {
    private String name = "idea_061265";
 ...
 */
@Slf4j
public class Idea61265Service {
    private static final int IDEA_ID = 61265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61265Service() {
        this(new Idea61265Config());
    }

    public Idea61265Service(Idea61265Config config) {
        this.config = config != null ? config : new Idea61265Config();
