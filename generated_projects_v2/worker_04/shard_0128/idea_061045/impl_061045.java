...
@Data
public class Idea61045Config {
    private String name = "idea_061045";
 ...
 */
@Slf4j
public class Idea61045Service {
    private static final int IDEA_ID = 61045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61045Service() {
        this(new Idea61045Config());
    }

    public Idea61045Service(Idea61045Config config) {
        this.config = config != null ? config : new Idea61045Config();
