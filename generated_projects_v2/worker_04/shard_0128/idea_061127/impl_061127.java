...
@Data
public class Idea61127Config {
    private String name = "idea_061127";
 ...
 */
@Slf4j
public class Idea61127Service {
    private static final int IDEA_ID = 61127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61127Service() {
        this(new Idea61127Config());
    }

    public Idea61127Service(Idea61127Config config) {
        this.config = config != null ? config : new Idea61127Config();
