...
@Data
public class Idea61267Config {
    private String name = "idea_061267";
 ...
 */
@Slf4j
public class Idea61267Service {
    private static final int IDEA_ID = 61267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61267Service() {
        this(new Idea61267Config());
    }

    public Idea61267Service(Idea61267Config config) {
        this.config = config != null ? config : new Idea61267Config();
