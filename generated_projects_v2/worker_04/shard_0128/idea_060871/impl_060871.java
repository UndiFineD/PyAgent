...
@Data
public class Idea60871Config {
    private String name = "idea_060871";
 ...
 */
@Slf4j
public class Idea60871Service {
    private static final int IDEA_ID = 60871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60871Service() {
        this(new Idea60871Config());
    }

    public Idea60871Service(Idea60871Config config) {
        this.config = config != null ? config : new Idea60871Config();
