...
@Data
public class Idea61146Config {
    private String name = "idea_061146";
 ...
 */
@Slf4j
public class Idea61146Service {
    private static final int IDEA_ID = 61146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61146Service() {
        this(new Idea61146Config());
    }

    public Idea61146Service(Idea61146Config config) {
        this.config = config != null ? config : new Idea61146Config();
