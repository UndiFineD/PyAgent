...
@Data
public class Idea60879Config {
    private String name = "idea_060879";
 ...
 */
@Slf4j
public class Idea60879Service {
    private static final int IDEA_ID = 60879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60879Service() {
        this(new Idea60879Config());
    }

    public Idea60879Service(Idea60879Config config) {
        this.config = config != null ? config : new Idea60879Config();
