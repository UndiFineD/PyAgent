...
@Data
public class Idea61116Config {
    private String name = "idea_061116";
 ...
 */
@Slf4j
public class Idea61116Service {
    private static final int IDEA_ID = 61116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61116Service() {
        this(new Idea61116Config());
    }

    public Idea61116Service(Idea61116Config config) {
        this.config = config != null ? config : new Idea61116Config();
