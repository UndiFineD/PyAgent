...
@Data
public class Idea60813Config {
    private String name = "idea_060813";
 ...
 */
@Slf4j
public class Idea60813Service {
    private static final int IDEA_ID = 60813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60813Service() {
        this(new Idea60813Config());
    }

    public Idea60813Service(Idea60813Config config) {
        this.config = config != null ? config : new Idea60813Config();
