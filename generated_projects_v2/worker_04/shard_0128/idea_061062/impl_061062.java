...
@Data
public class Idea61062Config {
    private String name = "idea_061062";
 ...
 */
@Slf4j
public class Idea61062Service {
    private static final int IDEA_ID = 61062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61062Service() {
        this(new Idea61062Config());
    }

    public Idea61062Service(Idea61062Config config) {
        this.config = config != null ? config : new Idea61062Config();
