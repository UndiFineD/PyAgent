...
@Data
public class Idea60886Config {
    private String name = "idea_060886";
 ...
 */
@Slf4j
public class Idea60886Service {
    private static final int IDEA_ID = 60886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60886Service() {
        this(new Idea60886Config());
    }

    public Idea60886Service(Idea60886Config config) {
        this.config = config != null ? config : new Idea60886Config();
