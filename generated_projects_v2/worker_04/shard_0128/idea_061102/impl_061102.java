...
@Data
public class Idea61102Config {
    private String name = "idea_061102";
 ...
 */
@Slf4j
public class Idea61102Service {
    private static final int IDEA_ID = 61102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61102Service() {
        this(new Idea61102Config());
    }

    public Idea61102Service(Idea61102Config config) {
        this.config = config != null ? config : new Idea61102Config();
