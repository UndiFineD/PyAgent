...
@Data
public class Idea60943Config {
    private String name = "idea_060943";
 ...
 */
@Slf4j
public class Idea60943Service {
    private static final int IDEA_ID = 60943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60943Service() {
        this(new Idea60943Config());
    }

    public Idea60943Service(Idea60943Config config) {
        this.config = config != null ? config : new Idea60943Config();
