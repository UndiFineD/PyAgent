...
@Data
public class Idea61016Config {
    private String name = "idea_061016";
 ...
 */
@Slf4j
public class Idea61016Service {
    private static final int IDEA_ID = 61016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61016Service() {
        this(new Idea61016Config());
    }

    public Idea61016Service(Idea61016Config config) {
        this.config = config != null ? config : new Idea61016Config();
