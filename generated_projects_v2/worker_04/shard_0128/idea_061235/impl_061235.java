...
@Data
public class Idea61235Config {
    private String name = "idea_061235";
 ...
 */
@Slf4j
public class Idea61235Service {
    private static final int IDEA_ID = 61235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61235Service() {
        this(new Idea61235Config());
    }

    public Idea61235Service(Idea61235Config config) {
        this.config = config != null ? config : new Idea61235Config();
