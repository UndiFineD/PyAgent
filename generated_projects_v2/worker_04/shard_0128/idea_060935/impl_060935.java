...
@Data
public class Idea60935Config {
    private String name = "idea_060935";
 ...
 */
@Slf4j
public class Idea60935Service {
    private static final int IDEA_ID = 60935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60935Service() {
        this(new Idea60935Config());
    }

    public Idea60935Service(Idea60935Config config) {
        this.config = config != null ? config : new Idea60935Config();
