...
@Data
public class Idea60999Config {
    private String name = "idea_060999";
 ...
 */
@Slf4j
public class Idea60999Service {
    private static final int IDEA_ID = 60999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60999Service() {
        this(new Idea60999Config());
    }

    public Idea60999Service(Idea60999Config config) {
        this.config = config != null ? config : new Idea60999Config();
