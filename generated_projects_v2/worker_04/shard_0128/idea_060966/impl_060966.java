...
@Data
public class Idea60966Config {
    private String name = "idea_060966";
 ...
 */
@Slf4j
public class Idea60966Service {
    private static final int IDEA_ID = 60966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60966Service() {
        this(new Idea60966Config());
    }

    public Idea60966Service(Idea60966Config config) {
        this.config = config != null ? config : new Idea60966Config();
