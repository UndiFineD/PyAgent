...
@Data
public class Idea61093Config {
    private String name = "idea_061093";
 ...
 */
@Slf4j
public class Idea61093Service {
    private static final int IDEA_ID = 61093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61093Service() {
        this(new Idea61093Config());
    }

    public Idea61093Service(Idea61093Config config) {
        this.config = config != null ? config : new Idea61093Config();
