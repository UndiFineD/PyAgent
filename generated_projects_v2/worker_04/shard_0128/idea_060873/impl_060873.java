...
@Data
public class Idea60873Config {
    private String name = "idea_060873";
 ...
 */
@Slf4j
public class Idea60873Service {
    private static final int IDEA_ID = 60873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60873Service() {
        this(new Idea60873Config());
    }

    public Idea60873Service(Idea60873Config config) {
        this.config = config != null ? config : new Idea60873Config();
