...
@Data
public class Idea61202Config {
    private String name = "idea_061202";
 ...
 */
@Slf4j
public class Idea61202Service {
    private static final int IDEA_ID = 61202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61202Service() {
        this(new Idea61202Config());
    }

    public Idea61202Service(Idea61202Config config) {
        this.config = config != null ? config : new Idea61202Config();
