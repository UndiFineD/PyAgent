...
@Data
public class Idea61063Config {
    private String name = "idea_061063";
 ...
 */
@Slf4j
public class Idea61063Service {
    private static final int IDEA_ID = 61063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61063Service() {
        this(new Idea61063Config());
    }

    public Idea61063Service(Idea61063Config config) {
        this.config = config != null ? config : new Idea61063Config();
