...
@Data
public class Idea61035Config {
    private String name = "idea_061035";
 ...
 */
@Slf4j
public class Idea61035Service {
    private static final int IDEA_ID = 61035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61035Service() {
        this(new Idea61035Config());
    }

    public Idea61035Service(Idea61035Config config) {
        this.config = config != null ? config : new Idea61035Config();
