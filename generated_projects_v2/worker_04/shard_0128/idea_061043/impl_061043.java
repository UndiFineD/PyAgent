...
@Data
public class Idea61043Config {
    private String name = "idea_061043";
 ...
 */
@Slf4j
public class Idea61043Service {
    private static final int IDEA_ID = 61043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61043Service() {
        this(new Idea61043Config());
    }

    public Idea61043Service(Idea61043Config config) {
        this.config = config != null ? config : new Idea61043Config();
