...
@Data
public class Idea61242Config {
    private String name = "idea_061242";
 ...
 */
@Slf4j
public class Idea61242Service {
    private static final int IDEA_ID = 61242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61242Service() {
        this(new Idea61242Config());
    }

    public Idea61242Service(Idea61242Config config) {
        this.config = config != null ? config : new Idea61242Config();
