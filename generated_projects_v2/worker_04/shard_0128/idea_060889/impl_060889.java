...
@Data
public class Idea60889Config {
    private String name = "idea_060889";
 ...
 */
@Slf4j
public class Idea60889Service {
    private static final int IDEA_ID = 60889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60889Service() {
        this(new Idea60889Config());
    }

    public Idea60889Service(Idea60889Config config) {
        this.config = config != null ? config : new Idea60889Config();
