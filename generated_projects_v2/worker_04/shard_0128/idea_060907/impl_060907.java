...
@Data
public class Idea60907Config {
    private String name = "idea_060907";
 ...
 */
@Slf4j
public class Idea60907Service {
    private static final int IDEA_ID = 60907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60907Service() {
        this(new Idea60907Config());
    }

    public Idea60907Service(Idea60907Config config) {
        this.config = config != null ? config : new Idea60907Config();
