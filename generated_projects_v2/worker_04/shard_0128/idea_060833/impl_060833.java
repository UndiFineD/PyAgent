...
@Data
public class Idea60833Config {
    private String name = "idea_060833";
 ...
 */
@Slf4j
public class Idea60833Service {
    private static final int IDEA_ID = 60833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60833Service() {
        this(new Idea60833Config());
    }

    public Idea60833Service(Idea60833Config config) {
        this.config = config != null ? config : new Idea60833Config();
