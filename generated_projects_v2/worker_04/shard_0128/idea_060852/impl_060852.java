...
@Data
public class Idea60852Config {
    private String name = "idea_060852";
 ...
 */
@Slf4j
public class Idea60852Service {
    private static final int IDEA_ID = 60852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60852Service() {
        this(new Idea60852Config());
    }

    public Idea60852Service(Idea60852Config config) {
        this.config = config != null ? config : new Idea60852Config();
