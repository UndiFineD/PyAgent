...
@Data
public class Idea61017Config {
    private String name = "idea_061017";
 ...
 */
@Slf4j
public class Idea61017Service {
    private static final int IDEA_ID = 61017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61017Service() {
        this(new Idea61017Config());
    }

    public Idea61017Service(Idea61017Config config) {
        this.config = config != null ? config : new Idea61017Config();
