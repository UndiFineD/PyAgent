...
@Data
public class Idea61002Config {
    private String name = "idea_061002";
 ...
 */
@Slf4j
public class Idea61002Service {
    private static final int IDEA_ID = 61002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61002Service() {
        this(new Idea61002Config());
    }

    public Idea61002Service(Idea61002Config config) {
        this.config = config != null ? config : new Idea61002Config();
