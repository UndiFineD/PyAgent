...
@Data
public class Idea61032Config {
    private String name = "idea_061032";
 ...
 */
@Slf4j
public class Idea61032Service {
    private static final int IDEA_ID = 61032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61032Service() {
        this(new Idea61032Config());
    }

    public Idea61032Service(Idea61032Config config) {
        this.config = config != null ? config : new Idea61032Config();
