...
@Data
public class Idea61125Config {
    private String name = "idea_061125";
 ...
 */
@Slf4j
public class Idea61125Service {
    private static final int IDEA_ID = 61125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61125Service() {
        this(new Idea61125Config());
    }

    public Idea61125Service(Idea61125Config config) {
        this.config = config != null ? config : new Idea61125Config();
