...
@Data
public class Idea60828Config {
    private String name = "idea_060828";
 ...
 */
@Slf4j
public class Idea60828Service {
    private static final int IDEA_ID = 60828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60828Service() {
        this(new Idea60828Config());
    }

    public Idea60828Service(Idea60828Config config) {
        this.config = config != null ? config : new Idea60828Config();
