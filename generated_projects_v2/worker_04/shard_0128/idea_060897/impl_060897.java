...
@Data
public class Idea60897Config {
    private String name = "idea_060897";
 ...
 */
@Slf4j
public class Idea60897Service {
    private static final int IDEA_ID = 60897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60897Service() {
        this(new Idea60897Config());
    }

    public Idea60897Service(Idea60897Config config) {
        this.config = config != null ? config : new Idea60897Config();
