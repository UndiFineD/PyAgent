...
@Data
public class Idea61241Config {
    private String name = "idea_061241";
 ...
 */
@Slf4j
public class Idea61241Service {
    private static final int IDEA_ID = 61241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61241Service() {
        this(new Idea61241Config());
    }

    public Idea61241Service(Idea61241Config config) {
        this.config = config != null ? config : new Idea61241Config();
