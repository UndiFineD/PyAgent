...
@Data
public class Idea61193Config {
    private String name = "idea_061193";
 ...
 */
@Slf4j
public class Idea61193Service {
    private static final int IDEA_ID = 61193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61193Service() {
        this(new Idea61193Config());
    }

    public Idea61193Service(Idea61193Config config) {
        this.config = config != null ? config : new Idea61193Config();
