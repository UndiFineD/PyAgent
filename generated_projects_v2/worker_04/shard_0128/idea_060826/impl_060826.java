...
@Data
public class Idea60826Config {
    private String name = "idea_060826";
 ...
 */
@Slf4j
public class Idea60826Service {
    private static final int IDEA_ID = 60826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60826Service() {
        this(new Idea60826Config());
    }

    public Idea60826Service(Idea60826Config config) {
        this.config = config != null ? config : new Idea60826Config();
