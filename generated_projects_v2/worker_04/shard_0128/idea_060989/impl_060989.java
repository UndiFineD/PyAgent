...
@Data
public class Idea60989Config {
    private String name = "idea_060989";
 ...
 */
@Slf4j
public class Idea60989Service {
    private static final int IDEA_ID = 60989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60989Service() {
        this(new Idea60989Config());
    }

    public Idea60989Service(Idea60989Config config) {
        this.config = config != null ? config : new Idea60989Config();
