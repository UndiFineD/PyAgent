...
@Data
public class Idea61154Config {
    private String name = "idea_061154";
 ...
 */
@Slf4j
public class Idea61154Service {
    private static final int IDEA_ID = 61154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61154Service() {
        this(new Idea61154Config());
    }

    public Idea61154Service(Idea61154Config config) {
        this.config = config != null ? config : new Idea61154Config();
