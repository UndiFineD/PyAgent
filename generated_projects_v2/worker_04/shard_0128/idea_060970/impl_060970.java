...
@Data
public class Idea60970Config {
    private String name = "idea_060970";
 ...
 */
@Slf4j
public class Idea60970Service {
    private static final int IDEA_ID = 60970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60970Service() {
        this(new Idea60970Config());
    }

    public Idea60970Service(Idea60970Config config) {
        this.config = config != null ? config : new Idea60970Config();
