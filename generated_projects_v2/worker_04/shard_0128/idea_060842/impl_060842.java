...
@Data
public class Idea60842Config {
    private String name = "idea_060842";
 ...
 */
@Slf4j
public class Idea60842Service {
    private static final int IDEA_ID = 60842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60842Service() {
        this(new Idea60842Config());
    }

    public Idea60842Service(Idea60842Config config) {
        this.config = config != null ? config : new Idea60842Config();
