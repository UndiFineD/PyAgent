...
@Data
public class Idea60930Config {
    private String name = "idea_060930";
 ...
 */
@Slf4j
public class Idea60930Service {
    private static final int IDEA_ID = 60930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60930Service() {
        this(new Idea60930Config());
    }

    public Idea60930Service(Idea60930Config config) {
        this.config = config != null ? config : new Idea60930Config();
