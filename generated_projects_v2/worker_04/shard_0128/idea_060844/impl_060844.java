...
@Data
public class Idea60844Config {
    private String name = "idea_060844";
 ...
 */
@Slf4j
public class Idea60844Service {
    private static final int IDEA_ID = 60844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60844Service() {
        this(new Idea60844Config());
    }

    public Idea60844Service(Idea60844Config config) {
        this.config = config != null ? config : new Idea60844Config();
