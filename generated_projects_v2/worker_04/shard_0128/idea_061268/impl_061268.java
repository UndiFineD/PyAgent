...
@Data
public class Idea61268Config {
    private String name = "idea_061268";
 ...
 */
@Slf4j
public class Idea61268Service {
    private static final int IDEA_ID = 61268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61268Service() {
        this(new Idea61268Config());
    }

    public Idea61268Service(Idea61268Config config) {
        this.config = config != null ? config : new Idea61268Config();
