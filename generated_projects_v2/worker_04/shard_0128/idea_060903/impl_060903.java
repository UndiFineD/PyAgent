...
@Data
public class Idea60903Config {
    private String name = "idea_060903";
 ...
 */
@Slf4j
public class Idea60903Service {
    private static final int IDEA_ID = 60903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60903Service() {
        this(new Idea60903Config());
    }

    public Idea60903Service(Idea60903Config config) {
        this.config = config != null ? config : new Idea60903Config();
