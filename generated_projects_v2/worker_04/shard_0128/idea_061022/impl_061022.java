...
@Data
public class Idea61022Config {
    private String name = "idea_061022";
 ...
 */
@Slf4j
public class Idea61022Service {
    private static final int IDEA_ID = 61022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61022Service() {
        this(new Idea61022Config());
    }

    public Idea61022Service(Idea61022Config config) {
        this.config = config != null ? config : new Idea61022Config();
