...
@Data
public class Idea61084Config {
    private String name = "idea_061084";
 ...
 */
@Slf4j
public class Idea61084Service {
    private static final int IDEA_ID = 61084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61084Service() {
        this(new Idea61084Config());
    }

    public Idea61084Service(Idea61084Config config) {
        this.config = config != null ? config : new Idea61084Config();
