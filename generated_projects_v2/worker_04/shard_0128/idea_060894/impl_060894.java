...
@Data
public class Idea60894Config {
    private String name = "idea_060894";
 ...
 */
@Slf4j
public class Idea60894Service {
    private static final int IDEA_ID = 60894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60894Service() {
        this(new Idea60894Config());
    }

    public Idea60894Service(Idea60894Config config) {
        this.config = config != null ? config : new Idea60894Config();
