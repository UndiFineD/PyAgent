...
@Data
public class Idea61152Config {
    private String name = "idea_061152";
 ...
 */
@Slf4j
public class Idea61152Service {
    private static final int IDEA_ID = 61152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61152Service() {
        this(new Idea61152Config());
    }

    public Idea61152Service(Idea61152Config config) {
        this.config = config != null ? config : new Idea61152Config();
