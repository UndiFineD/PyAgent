...
@Data
public class Idea61104Config {
    private String name = "idea_061104";
 ...
 */
@Slf4j
public class Idea61104Service {
    private static final int IDEA_ID = 61104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61104Service() {
        this(new Idea61104Config());
    }

    public Idea61104Service(Idea61104Config config) {
        this.config = config != null ? config : new Idea61104Config();
