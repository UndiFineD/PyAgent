...
@Data
public class Idea61189Config {
    private String name = "idea_061189";
 ...
 */
@Slf4j
public class Idea61189Service {
    private static final int IDEA_ID = 61189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61189Service() {
        this(new Idea61189Config());
    }

    public Idea61189Service(Idea61189Config config) {
        this.config = config != null ? config : new Idea61189Config();
