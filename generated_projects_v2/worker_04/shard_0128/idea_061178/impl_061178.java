...
@Data
public class Idea61178Config {
    private String name = "idea_061178";
 ...
 */
@Slf4j
public class Idea61178Service {
    private static final int IDEA_ID = 61178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61178Service() {
        this(new Idea61178Config());
    }

    public Idea61178Service(Idea61178Config config) {
        this.config = config != null ? config : new Idea61178Config();
