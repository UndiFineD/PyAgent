...
@Data
public class Idea60929Config {
    private String name = "idea_060929";
 ...
 */
@Slf4j
public class Idea60929Service {
    private static final int IDEA_ID = 60929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60929Service() {
        this(new Idea60929Config());
    }

    public Idea60929Service(Idea60929Config config) {
        this.config = config != null ? config : new Idea60929Config();
