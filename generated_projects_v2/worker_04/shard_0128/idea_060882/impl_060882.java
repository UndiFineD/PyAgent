...
@Data
public class Idea60882Config {
    private String name = "idea_060882";
 ...
 */
@Slf4j
public class Idea60882Service {
    private static final int IDEA_ID = 60882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60882Service() {
        this(new Idea60882Config());
    }

    public Idea60882Service(Idea60882Config config) {
        this.config = config != null ? config : new Idea60882Config();
