...
@Data
public class Idea61047Config {
    private String name = "idea_061047";
 ...
 */
@Slf4j
public class Idea61047Service {
    private static final int IDEA_ID = 61047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61047Service() {
        this(new Idea61047Config());
    }

    public Idea61047Service(Idea61047Config config) {
        this.config = config != null ? config : new Idea61047Config();
