...
@Data
public class Idea60994Config {
    private String name = "idea_060994";
 ...
 */
@Slf4j
public class Idea60994Service {
    private static final int IDEA_ID = 60994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60994Service() {
        this(new Idea60994Config());
    }

    public Idea60994Service(Idea60994Config config) {
        this.config = config != null ? config : new Idea60994Config();
