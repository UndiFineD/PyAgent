...
@Data
public class Idea60807Config {
    private String name = "idea_060807";
 ...
 */
@Slf4j
public class Idea60807Service {
    private static final int IDEA_ID = 60807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60807Service() {
        this(new Idea60807Config());
    }

    public Idea60807Service(Idea60807Config config) {
        this.config = config != null ? config : new Idea60807Config();
