...
@Data
public class Idea61070Config {
    private String name = "idea_061070";
 ...
 */
@Slf4j
public class Idea61070Service {
    private static final int IDEA_ID = 61070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61070Service() {
        this(new Idea61070Config());
    }

    public Idea61070Service(Idea61070Config config) {
        this.config = config != null ? config : new Idea61070Config();
