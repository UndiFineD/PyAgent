...
@Data
public class Idea60954Config {
    private String name = "idea_060954";
 ...
 */
@Slf4j
public class Idea60954Service {
    private static final int IDEA_ID = 60954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60954Service() {
        this(new Idea60954Config());
    }

    public Idea60954Service(Idea60954Config config) {
        this.config = config != null ? config : new Idea60954Config();
