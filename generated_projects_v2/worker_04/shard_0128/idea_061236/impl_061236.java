...
@Data
public class Idea61236Config {
    private String name = "idea_061236";
 ...
 */
@Slf4j
public class Idea61236Service {
    private static final int IDEA_ID = 61236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61236Service() {
        this(new Idea61236Config());
    }

    public Idea61236Service(Idea61236Config config) {
        this.config = config != null ? config : new Idea61236Config();
