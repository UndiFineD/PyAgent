...
@Data
public class Idea61203Config {
    private String name = "idea_061203";
 ...
 */
@Slf4j
public class Idea61203Service {
    private static final int IDEA_ID = 61203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61203Service() {
        this(new Idea61203Config());
    }

    public Idea61203Service(Idea61203Config config) {
        this.config = config != null ? config : new Idea61203Config();
