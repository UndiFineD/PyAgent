...
@Data
public class Idea61074Config {
    private String name = "idea_061074";
 ...
 */
@Slf4j
public class Idea61074Service {
    private static final int IDEA_ID = 61074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61074Service() {
        this(new Idea61074Config());
    }

    public Idea61074Service(Idea61074Config config) {
        this.config = config != null ? config : new Idea61074Config();
