...
@Data
public class Idea61077Config {
    private String name = "idea_061077";
 ...
 */
@Slf4j
public class Idea61077Service {
    private static final int IDEA_ID = 61077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61077Service() {
        this(new Idea61077Config());
    }

    public Idea61077Service(Idea61077Config config) {
        this.config = config != null ? config : new Idea61077Config();
