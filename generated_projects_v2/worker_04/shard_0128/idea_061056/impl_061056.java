...
@Data
public class Idea61056Config {
    private String name = "idea_061056";
 ...
 */
@Slf4j
public class Idea61056Service {
    private static final int IDEA_ID = 61056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61056Service() {
        this(new Idea61056Config());
    }

    public Idea61056Service(Idea61056Config config) {
        this.config = config != null ? config : new Idea61056Config();
