...
@Data
public class Idea60800Config {
    private String name = "idea_060800";
 ...
 */
@Slf4j
public class Idea60800Service {
    private static final int IDEA_ID = 60800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60800Service() {
        this(new Idea60800Config());
    }

    public Idea60800Service(Idea60800Config config) {
        this.config = config != null ? config : new Idea60800Config();
