...
@Data
public class Idea61099Config {
    private String name = "idea_061099";
 ...
 */
@Slf4j
public class Idea61099Service {
    private static final int IDEA_ID = 61099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61099Service() {
        this(new Idea61099Config());
    }

    public Idea61099Service(Idea61099Config config) {
        this.config = config != null ? config : new Idea61099Config();
