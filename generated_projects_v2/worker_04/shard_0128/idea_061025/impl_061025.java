...
@Data
public class Idea61025Config {
    private String name = "idea_061025";
 ...
 */
@Slf4j
public class Idea61025Service {
    private static final int IDEA_ID = 61025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61025Service() {
        this(new Idea61025Config());
    }

    public Idea61025Service(Idea61025Config config) {
        this.config = config != null ? config : new Idea61025Config();
