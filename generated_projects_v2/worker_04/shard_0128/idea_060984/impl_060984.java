...
@Data
public class Idea60984Config {
    private String name = "idea_060984";
 ...
 */
@Slf4j
public class Idea60984Service {
    private static final int IDEA_ID = 60984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60984Service() {
        this(new Idea60984Config());
    }

    public Idea60984Service(Idea60984Config config) {
        this.config = config != null ? config : new Idea60984Config();
