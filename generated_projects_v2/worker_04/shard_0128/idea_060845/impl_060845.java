...
@Data
public class Idea60845Config {
    private String name = "idea_060845";
 ...
 */
@Slf4j
public class Idea60845Service {
    private static final int IDEA_ID = 60845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60845Service() {
        this(new Idea60845Config());
    }

    public Idea60845Service(Idea60845Config config) {
        this.config = config != null ? config : new Idea60845Config();
