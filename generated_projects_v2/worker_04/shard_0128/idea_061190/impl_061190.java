...
@Data
public class Idea61190Config {
    private String name = "idea_061190";
 ...
 */
@Slf4j
public class Idea61190Service {
    private static final int IDEA_ID = 61190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61190Service() {
        this(new Idea61190Config());
    }

    public Idea61190Service(Idea61190Config config) {
        this.config = config != null ? config : new Idea61190Config();
