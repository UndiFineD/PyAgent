...
@Data
public class Idea61027Config {
    private String name = "idea_061027";
 ...
 */
@Slf4j
public class Idea61027Service {
    private static final int IDEA_ID = 61027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61027Service() {
        this(new Idea61027Config());
    }

    public Idea61027Service(Idea61027Config config) {
        this.config = config != null ? config : new Idea61027Config();
