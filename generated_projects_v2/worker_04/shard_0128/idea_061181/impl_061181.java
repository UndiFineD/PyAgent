...
@Data
public class Idea61181Config {
    private String name = "idea_061181";
 ...
 */
@Slf4j
public class Idea61181Service {
    private static final int IDEA_ID = 61181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61181Service() {
        this(new Idea61181Config());
    }

    public Idea61181Service(Idea61181Config config) {
        this.config = config != null ? config : new Idea61181Config();
