...
@Data
public class Idea60870Config {
    private String name = "idea_060870";
 ...
 */
@Slf4j
public class Idea60870Service {
    private static final int IDEA_ID = 60870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60870Service() {
        this(new Idea60870Config());
    }

    public Idea60870Service(Idea60870Config config) {
        this.config = config != null ? config : new Idea60870Config();
