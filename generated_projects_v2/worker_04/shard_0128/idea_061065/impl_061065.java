...
@Data
public class Idea61065Config {
    private String name = "idea_061065";
 ...
 */
@Slf4j
public class Idea61065Service {
    private static final int IDEA_ID = 61065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61065Service() {
        this(new Idea61065Config());
    }

    public Idea61065Service(Idea61065Config config) {
        this.config = config != null ? config : new Idea61065Config();
