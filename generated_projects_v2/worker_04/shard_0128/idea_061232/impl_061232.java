...
@Data
public class Idea61232Config {
    private String name = "idea_061232";
 ...
 */
@Slf4j
public class Idea61232Service {
    private static final int IDEA_ID = 61232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61232Service() {
        this(new Idea61232Config());
    }

    public Idea61232Service(Idea61232Config config) {
        this.config = config != null ? config : new Idea61232Config();
