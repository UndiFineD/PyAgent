...
@Data
public class Idea61227Config {
    private String name = "idea_061227";
 ...
 */
@Slf4j
public class Idea61227Service {
    private static final int IDEA_ID = 61227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61227Service() {
        this(new Idea61227Config());
    }

    public Idea61227Service(Idea61227Config config) {
        this.config = config != null ? config : new Idea61227Config();
