...
@Data
public class Idea61121Config {
    private String name = "idea_061121";
 ...
 */
@Slf4j
public class Idea61121Service {
    private static final int IDEA_ID = 61121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61121Service() {
        this(new Idea61121Config());
    }

    public Idea61121Service(Idea61121Config config) {
        this.config = config != null ? config : new Idea61121Config();
