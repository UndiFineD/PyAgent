...
@Data
public class Idea60908Config {
    private String name = "idea_060908";
 ...
 */
@Slf4j
public class Idea60908Service {
    private static final int IDEA_ID = 60908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60908Service() {
        this(new Idea60908Config());
    }

    public Idea60908Service(Idea60908Config config) {
        this.config = config != null ? config : new Idea60908Config();
