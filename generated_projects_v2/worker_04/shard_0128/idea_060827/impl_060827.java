...
@Data
public class Idea60827Config {
    private String name = "idea_060827";
 ...
 */
@Slf4j
public class Idea60827Service {
    private static final int IDEA_ID = 60827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60827Service() {
        this(new Idea60827Config());
    }

    public Idea60827Service(Idea60827Config config) {
        this.config = config != null ? config : new Idea60827Config();
