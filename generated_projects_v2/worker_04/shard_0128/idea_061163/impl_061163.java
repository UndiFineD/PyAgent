...
@Data
public class Idea61163Config {
    private String name = "idea_061163";
 ...
 */
@Slf4j
public class Idea61163Service {
    private static final int IDEA_ID = 61163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61163Service() {
        this(new Idea61163Config());
    }

    public Idea61163Service(Idea61163Config config) {
        this.config = config != null ? config : new Idea61163Config();
