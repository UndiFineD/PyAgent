...
@Data
public class Idea61124Config {
    private String name = "idea_061124";
 ...
 */
@Slf4j
public class Idea61124Service {
    private static final int IDEA_ID = 61124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61124Service() {
        this(new Idea61124Config());
    }

    public Idea61124Service(Idea61124Config config) {
        this.config = config != null ? config : new Idea61124Config();
