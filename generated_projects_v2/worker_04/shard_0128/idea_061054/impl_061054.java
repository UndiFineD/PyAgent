...
@Data
public class Idea61054Config {
    private String name = "idea_061054";
 ...
 */
@Slf4j
public class Idea61054Service {
    private static final int IDEA_ID = 61054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61054Service() {
        this(new Idea61054Config());
    }

    public Idea61054Service(Idea61054Config config) {
        this.config = config != null ? config : new Idea61054Config();
