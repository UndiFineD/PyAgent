...
@Data
public class Idea61082Config {
    private String name = "idea_061082";
 ...
 */
@Slf4j
public class Idea61082Service {
    private static final int IDEA_ID = 61082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61082Service() {
        this(new Idea61082Config());
    }

    public Idea61082Service(Idea61082Config config) {
        this.config = config != null ? config : new Idea61082Config();
