...
@Data
public class Idea60814Config {
    private String name = "idea_060814";
 ...
 */
@Slf4j
public class Idea60814Service {
    private static final int IDEA_ID = 60814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60814Service() {
        this(new Idea60814Config());
    }

    public Idea60814Service(Idea60814Config config) {
        this.config = config != null ? config : new Idea60814Config();
