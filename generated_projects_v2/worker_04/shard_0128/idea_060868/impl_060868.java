...
@Data
public class Idea60868Config {
    private String name = "idea_060868";
 ...
 */
@Slf4j
public class Idea60868Service {
    private static final int IDEA_ID = 60868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60868Service() {
        this(new Idea60868Config());
    }

    public Idea60868Service(Idea60868Config config) {
        this.config = config != null ? config : new Idea60868Config();
