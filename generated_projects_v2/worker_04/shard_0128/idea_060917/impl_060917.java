...
@Data
public class Idea60917Config {
    private String name = "idea_060917";
 ...
 */
@Slf4j
public class Idea60917Service {
    private static final int IDEA_ID = 60917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60917Service() {
        this(new Idea60917Config());
    }

    public Idea60917Service(Idea60917Config config) {
        this.config = config != null ? config : new Idea60917Config();
