...
@Data
public class Idea60942Config {
    private String name = "idea_060942";
 ...
 */
@Slf4j
public class Idea60942Service {
    private static final int IDEA_ID = 60942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60942Service() {
        this(new Idea60942Config());
    }

    public Idea60942Service(Idea60942Config config) {
        this.config = config != null ? config : new Idea60942Config();
