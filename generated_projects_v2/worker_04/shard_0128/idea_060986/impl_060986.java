...
@Data
public class Idea60986Config {
    private String name = "idea_060986";
 ...
 */
@Slf4j
public class Idea60986Service {
    private static final int IDEA_ID = 60986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60986Service() {
        this(new Idea60986Config());
    }

    public Idea60986Service(Idea60986Config config) {
        this.config = config != null ? config : new Idea60986Config();
