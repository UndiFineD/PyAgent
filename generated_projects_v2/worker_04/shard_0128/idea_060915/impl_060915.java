...
@Data
public class Idea60915Config {
    private String name = "idea_060915";
 ...
 */
@Slf4j
public class Idea60915Service {
    private static final int IDEA_ID = 60915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60915Service() {
        this(new Idea60915Config());
    }

    public Idea60915Service(Idea60915Config config) {
        this.config = config != null ? config : new Idea60915Config();
