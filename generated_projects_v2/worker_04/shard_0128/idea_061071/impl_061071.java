...
@Data
public class Idea61071Config {
    private String name = "idea_061071";
 ...
 */
@Slf4j
public class Idea61071Service {
    private static final int IDEA_ID = 61071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61071Service() {
        this(new Idea61071Config());
    }

    public Idea61071Service(Idea61071Config config) {
        this.config = config != null ? config : new Idea61071Config();
