...
@Data
public class Idea60959Config {
    private String name = "idea_060959";
 ...
 */
@Slf4j
public class Idea60959Service {
    private static final int IDEA_ID = 60959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60959Service() {
        this(new Idea60959Config());
    }

    public Idea60959Service(Idea60959Config config) {
        this.config = config != null ? config : new Idea60959Config();
