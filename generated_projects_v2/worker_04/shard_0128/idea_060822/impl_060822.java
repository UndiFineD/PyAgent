...
@Data
public class Idea60822Config {
    private String name = "idea_060822";
 ...
 */
@Slf4j
public class Idea60822Service {
    private static final int IDEA_ID = 60822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60822Service() {
        this(new Idea60822Config());
    }

    public Idea60822Service(Idea60822Config config) {
        this.config = config != null ? config : new Idea60822Config();
