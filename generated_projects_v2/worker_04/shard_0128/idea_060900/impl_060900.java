...
@Data
public class Idea60900Config {
    private String name = "idea_060900";
 ...
 */
@Slf4j
public class Idea60900Service {
    private static final int IDEA_ID = 60900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60900Service() {
        this(new Idea60900Config());
    }

    public Idea60900Service(Idea60900Config config) {
        this.config = config != null ? config : new Idea60900Config();
