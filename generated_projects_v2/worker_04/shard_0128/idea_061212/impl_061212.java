...
@Data
public class Idea61212Config {
    private String name = "idea_061212";
 ...
 */
@Slf4j
public class Idea61212Service {
    private static final int IDEA_ID = 61212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61212Service() {
        this(new Idea61212Config());
    }

    public Idea61212Service(Idea61212Config config) {
        this.config = config != null ? config : new Idea61212Config();
