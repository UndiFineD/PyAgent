...
@Data
public class Idea61161Config {
    private String name = "idea_061161";
 ...
 */
@Slf4j
public class Idea61161Service {
    private static final int IDEA_ID = 61161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61161Service() {
        this(new Idea61161Config());
    }

    public Idea61161Service(Idea61161Config config) {
        this.config = config != null ? config : new Idea61161Config();
