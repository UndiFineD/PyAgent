...
@Data
public class Idea60988Config {
    private String name = "idea_060988";
 ...
 */
@Slf4j
public class Idea60988Service {
    private static final int IDEA_ID = 60988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60988Service() {
        this(new Idea60988Config());
    }

    public Idea60988Service(Idea60988Config config) {
        this.config = config != null ? config : new Idea60988Config();
