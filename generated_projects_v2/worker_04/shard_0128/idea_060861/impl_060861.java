...
@Data
public class Idea60861Config {
    private String name = "idea_060861";
 ...
 */
@Slf4j
public class Idea60861Service {
    private static final int IDEA_ID = 60861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60861Service() {
        this(new Idea60861Config());
    }

    public Idea60861Service(Idea60861Config config) {
        this.config = config != null ? config : new Idea60861Config();
