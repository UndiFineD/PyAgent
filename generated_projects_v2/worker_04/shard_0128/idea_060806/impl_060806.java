...
@Data
public class Idea60806Config {
    private String name = "idea_060806";
 ...
 */
@Slf4j
public class Idea60806Service {
    private static final int IDEA_ID = 60806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60806Service() {
        this(new Idea60806Config());
    }

    public Idea60806Service(Idea60806Config config) {
        this.config = config != null ? config : new Idea60806Config();
