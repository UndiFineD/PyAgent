...
@Data
public class Idea60848Config {
    private String name = "idea_060848";
 ...
 */
@Slf4j
public class Idea60848Service {
    private static final int IDEA_ID = 60848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60848Service() {
        this(new Idea60848Config());
    }

    public Idea60848Service(Idea60848Config config) {
        this.config = config != null ? config : new Idea60848Config();
