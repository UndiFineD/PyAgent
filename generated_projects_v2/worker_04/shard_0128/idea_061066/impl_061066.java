...
@Data
public class Idea61066Config {
    private String name = "idea_061066";
 ...
 */
@Slf4j
public class Idea61066Service {
    private static final int IDEA_ID = 61066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61066Service() {
        this(new Idea61066Config());
    }

    public Idea61066Service(Idea61066Config config) {
        this.config = config != null ? config : new Idea61066Config();
