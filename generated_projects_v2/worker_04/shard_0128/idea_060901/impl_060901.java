...
@Data
public class Idea60901Config {
    private String name = "idea_060901";
 ...
 */
@Slf4j
public class Idea60901Service {
    private static final int IDEA_ID = 60901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60901Service() {
        this(new Idea60901Config());
    }

    public Idea60901Service(Idea60901Config config) {
        this.config = config != null ? config : new Idea60901Config();
