...
@Data
public class Idea61177Config {
    private String name = "idea_061177";
 ...
 */
@Slf4j
public class Idea61177Service {
    private static final int IDEA_ID = 61177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61177Service() {
        this(new Idea61177Config());
    }

    public Idea61177Service(Idea61177Config config) {
        this.config = config != null ? config : new Idea61177Config();
