...
@Data
public class Idea61085Config {
    private String name = "idea_061085";
 ...
 */
@Slf4j
public class Idea61085Service {
    private static final int IDEA_ID = 61085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61085Service() {
        this(new Idea61085Config());
    }

    public Idea61085Service(Idea61085Config config) {
        this.config = config != null ? config : new Idea61085Config();
