...
@Data
public class Idea60877Config {
    private String name = "idea_060877";
 ...
 */
@Slf4j
public class Idea60877Service {
    private static final int IDEA_ID = 60877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60877Service() {
        this(new Idea60877Config());
    }

    public Idea60877Service(Idea60877Config config) {
        this.config = config != null ? config : new Idea60877Config();
