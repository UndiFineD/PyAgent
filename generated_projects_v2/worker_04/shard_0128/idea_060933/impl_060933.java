...
@Data
public class Idea60933Config {
    private String name = "idea_060933";
 ...
 */
@Slf4j
public class Idea60933Service {
    private static final int IDEA_ID = 60933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60933Service() {
        this(new Idea60933Config());
    }

    public Idea60933Service(Idea60933Config config) {
        this.config = config != null ? config : new Idea60933Config();
