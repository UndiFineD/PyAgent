...
@Data
public class Idea61030Config {
    private String name = "idea_061030";
 ...
 */
@Slf4j
public class Idea61030Service {
    private static final int IDEA_ID = 61030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61030Service() {
        this(new Idea61030Config());
    }

    public Idea61030Service(Idea61030Config config) {
        this.config = config != null ? config : new Idea61030Config();
