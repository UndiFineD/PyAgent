...
@Data
public class Idea60820Config {
    private String name = "idea_060820";
 ...
 */
@Slf4j
public class Idea60820Service {
    private static final int IDEA_ID = 60820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60820Service() {
        this(new Idea60820Config());
    }

    public Idea60820Service(Idea60820Config config) {
        this.config = config != null ? config : new Idea60820Config();
