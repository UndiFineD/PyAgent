...
@Data
public class Idea60832Config {
    private String name = "idea_060832";
 ...
 */
@Slf4j
public class Idea60832Service {
    private static final int IDEA_ID = 60832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60832Service() {
        this(new Idea60832Config());
    }

    public Idea60832Service(Idea60832Config config) {
        this.config = config != null ? config : new Idea60832Config();
