...
@Data
public class Idea60887Config {
    private String name = "idea_060887";
 ...
 */
@Slf4j
public class Idea60887Service {
    private static final int IDEA_ID = 60887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60887Service() {
        this(new Idea60887Config());
    }

    public Idea60887Service(Idea60887Config config) {
        this.config = config != null ? config : new Idea60887Config();
