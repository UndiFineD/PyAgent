...
@Data
public class Idea60815Config {
    private String name = "idea_060815";
 ...
 */
@Slf4j
public class Idea60815Service {
    private static final int IDEA_ID = 60815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60815Service() {
        this(new Idea60815Config());
    }

    public Idea60815Service(Idea60815Config config) {
        this.config = config != null ? config : new Idea60815Config();
