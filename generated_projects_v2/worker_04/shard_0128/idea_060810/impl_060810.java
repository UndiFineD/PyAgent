...
@Data
public class Idea60810Config {
    private String name = "idea_060810";
 ...
 */
@Slf4j
public class Idea60810Service {
    private static final int IDEA_ID = 60810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60810Service() {
        this(new Idea60810Config());
    }

    public Idea60810Service(Idea60810Config config) {
        this.config = config != null ? config : new Idea60810Config();
