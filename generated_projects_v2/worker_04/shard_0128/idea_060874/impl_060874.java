...
@Data
public class Idea60874Config {
    private String name = "idea_060874";
 ...
 */
@Slf4j
public class Idea60874Service {
    private static final int IDEA_ID = 60874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60874Service() {
        this(new Idea60874Config());
    }

    public Idea60874Service(Idea60874Config config) {
        this.config = config != null ? config : new Idea60874Config();
