...
@Data
public class Idea60965Config {
    private String name = "idea_060965";
 ...
 */
@Slf4j
public class Idea60965Service {
    private static final int IDEA_ID = 60965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60965Service() {
        this(new Idea60965Config());
    }

    public Idea60965Service(Idea60965Config config) {
        this.config = config != null ? config : new Idea60965Config();
