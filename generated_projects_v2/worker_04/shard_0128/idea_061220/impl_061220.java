...
@Data
public class Idea61220Config {
    private String name = "idea_061220";
 ...
 */
@Slf4j
public class Idea61220Service {
    private static final int IDEA_ID = 61220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61220Service() {
        this(new Idea61220Config());
    }

    public Idea61220Service(Idea61220Config config) {
        this.config = config != null ? config : new Idea61220Config();
