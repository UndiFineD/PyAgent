...
@Data
public class Idea60939Config {
    private String name = "idea_060939";
 ...
 */
@Slf4j
public class Idea60939Service {
    private static final int IDEA_ID = 60939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60939Service() {
        this(new Idea60939Config());
    }

    public Idea60939Service(Idea60939Config config) {
        this.config = config != null ? config : new Idea60939Config();
