...
@Data
public class Idea61014Config {
    private String name = "idea_061014";
 ...
 */
@Slf4j
public class Idea61014Service {
    private static final int IDEA_ID = 61014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61014Service() {
        this(new Idea61014Config());
    }

    public Idea61014Service(Idea61014Config config) {
        this.config = config != null ? config : new Idea61014Config();
