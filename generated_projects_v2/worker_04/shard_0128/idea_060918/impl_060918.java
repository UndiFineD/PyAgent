...
@Data
public class Idea60918Config {
    private String name = "idea_060918";
 ...
 */
@Slf4j
public class Idea60918Service {
    private static final int IDEA_ID = 60918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60918Service() {
        this(new Idea60918Config());
    }

    public Idea60918Service(Idea60918Config config) {
        this.config = config != null ? config : new Idea60918Config();
