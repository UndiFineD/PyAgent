...
@Data
public class Idea61260Config {
    private String name = "idea_061260";
 ...
 */
@Slf4j
public class Idea61260Service {
    private static final int IDEA_ID = 61260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61260Service() {
        this(new Idea61260Config());
    }

    public Idea61260Service(Idea61260Config config) {
        this.config = config != null ? config : new Idea61260Config();
