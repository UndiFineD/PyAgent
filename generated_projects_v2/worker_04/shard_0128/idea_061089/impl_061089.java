...
@Data
public class Idea61089Config {
    private String name = "idea_061089";
 ...
 */
@Slf4j
public class Idea61089Service {
    private static final int IDEA_ID = 61089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61089Service() {
        this(new Idea61089Config());
    }

    public Idea61089Service(Idea61089Config config) {
        this.config = config != null ? config : new Idea61089Config();
