...
@Data
public class Idea61076Config {
    private String name = "idea_061076";
 ...
 */
@Slf4j
public class Idea61076Service {
    private static final int IDEA_ID = 61076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61076Service() {
        this(new Idea61076Config());
    }

    public Idea61076Service(Idea61076Config config) {
        this.config = config != null ? config : new Idea61076Config();
