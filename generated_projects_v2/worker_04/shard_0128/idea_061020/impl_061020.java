...
@Data
public class Idea61020Config {
    private String name = "idea_061020";
 ...
 */
@Slf4j
public class Idea61020Service {
    private static final int IDEA_ID = 61020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61020Service() {
        this(new Idea61020Config());
    }

    public Idea61020Service(Idea61020Config config) {
        this.config = config != null ? config : new Idea61020Config();
