...
@Data
public class Idea61158Config {
    private String name = "idea_061158";
 ...
 */
@Slf4j
public class Idea61158Service {
    private static final int IDEA_ID = 61158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61158Service() {
        this(new Idea61158Config());
    }

    public Idea61158Service(Idea61158Config config) {
        this.config = config != null ? config : new Idea61158Config();
