...
@Data
public class Idea61147Config {
    private String name = "idea_061147";
 ...
 */
@Slf4j
public class Idea61147Service {
    private static final int IDEA_ID = 61147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61147Service() {
        this(new Idea61147Config());
    }

    public Idea61147Service(Idea61147Config config) {
        this.config = config != null ? config : new Idea61147Config();
