...
@Data
public class Idea61100Config {
    private String name = "idea_061100";
 ...
 */
@Slf4j
public class Idea61100Service {
    private static final int IDEA_ID = 61100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61100Service() {
        this(new Idea61100Config());
    }

    public Idea61100Service(Idea61100Config config) {
        this.config = config != null ? config : new Idea61100Config();
