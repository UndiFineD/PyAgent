...
@Data
public class Idea61057Config {
    private String name = "idea_061057";
 ...
 */
@Slf4j
public class Idea61057Service {
    private static final int IDEA_ID = 61057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61057Service() {
        this(new Idea61057Config());
    }

    public Idea61057Service(Idea61057Config config) {
        this.config = config != null ? config : new Idea61057Config();
