...
@Data
public class Idea60987Config {
    private String name = "idea_060987";
 ...
 */
@Slf4j
public class Idea60987Service {
    private static final int IDEA_ID = 60987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60987Service() {
        this(new Idea60987Config());
    }

    public Idea60987Service(Idea60987Config config) {
        this.config = config != null ? config : new Idea60987Config();
