...
@Data
public class Idea60837Config {
    private String name = "idea_060837";
 ...
 */
@Slf4j
public class Idea60837Service {
    private static final int IDEA_ID = 60837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60837Service() {
        this(new Idea60837Config());
    }

    public Idea60837Service(Idea60837Config config) {
        this.config = config != null ? config : new Idea60837Config();
