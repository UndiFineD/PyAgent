...
@Data
public class Idea60899Config {
    private String name = "idea_060899";
 ...
 */
@Slf4j
public class Idea60899Service {
    private static final int IDEA_ID = 60899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60899Service() {
        this(new Idea60899Config());
    }

    public Idea60899Service(Idea60899Config config) {
        this.config = config != null ? config : new Idea60899Config();
