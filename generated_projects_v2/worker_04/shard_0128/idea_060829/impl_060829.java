...
@Data
public class Idea60829Config {
    private String name = "idea_060829";
 ...
 */
@Slf4j
public class Idea60829Service {
    private static final int IDEA_ID = 60829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60829Service() {
        this(new Idea60829Config());
    }

    public Idea60829Service(Idea60829Config config) {
        this.config = config != null ? config : new Idea60829Config();
