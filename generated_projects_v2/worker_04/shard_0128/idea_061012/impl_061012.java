...
@Data
public class Idea61012Config {
    private String name = "idea_061012";
 ...
 */
@Slf4j
public class Idea61012Service {
    private static final int IDEA_ID = 61012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61012Service() {
        this(new Idea61012Config());
    }

    public Idea61012Service(Idea61012Config config) {
        this.config = config != null ? config : new Idea61012Config();
