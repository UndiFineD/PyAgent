...
@Data
public class Idea60985Config {
    private String name = "idea_060985";
 ...
 */
@Slf4j
public class Idea60985Service {
    private static final int IDEA_ID = 60985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60985Service() {
        this(new Idea60985Config());
    }

    public Idea60985Service(Idea60985Config config) {
        this.config = config != null ? config : new Idea60985Config();
