...
@Data
public class Idea61229Config {
    private String name = "idea_061229";
 ...
 */
@Slf4j
public class Idea61229Service {
    private static final int IDEA_ID = 61229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61229Service() {
        this(new Idea61229Config());
    }

    public Idea61229Service(Idea61229Config config) {
        this.config = config != null ? config : new Idea61229Config();
