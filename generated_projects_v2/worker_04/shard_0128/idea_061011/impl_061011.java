...
@Data
public class Idea61011Config {
    private String name = "idea_061011";
 ...
 */
@Slf4j
public class Idea61011Service {
    private static final int IDEA_ID = 61011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61011Service() {
        this(new Idea61011Config());
    }

    public Idea61011Service(Idea61011Config config) {
        this.config = config != null ? config : new Idea61011Config();
