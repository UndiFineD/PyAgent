...
@Data
public class Idea60924Config {
    private String name = "idea_060924";
 ...
 */
@Slf4j
public class Idea60924Service {
    private static final int IDEA_ID = 60924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60924Service() {
        this(new Idea60924Config());
    }

    public Idea60924Service(Idea60924Config config) {
        this.config = config != null ? config : new Idea60924Config();
