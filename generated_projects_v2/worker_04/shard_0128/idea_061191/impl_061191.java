...
@Data
public class Idea61191Config {
    private String name = "idea_061191";
 ...
 */
@Slf4j
public class Idea61191Service {
    private static final int IDEA_ID = 61191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61191Service() {
        this(new Idea61191Config());
    }

    public Idea61191Service(Idea61191Config config) {
        this.config = config != null ? config : new Idea61191Config();
