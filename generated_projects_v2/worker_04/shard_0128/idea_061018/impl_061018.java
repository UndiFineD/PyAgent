...
@Data
public class Idea61018Config {
    private String name = "idea_061018";
 ...
 */
@Slf4j
public class Idea61018Service {
    private static final int IDEA_ID = 61018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61018Service() {
        this(new Idea61018Config());
    }

    public Idea61018Service(Idea61018Config config) {
        this.config = config != null ? config : new Idea61018Config();
