...
@Data
public class Idea61031Config {
    private String name = "idea_061031";
 ...
 */
@Slf4j
public class Idea61031Service {
    private static final int IDEA_ID = 61031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61031Service() {
        this(new Idea61031Config());
    }

    public Idea61031Service(Idea61031Config config) {
        this.config = config != null ? config : new Idea61031Config();
