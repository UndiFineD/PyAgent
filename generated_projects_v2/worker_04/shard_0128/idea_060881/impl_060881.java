...
@Data
public class Idea60881Config {
    private String name = "idea_060881";
 ...
 */
@Slf4j
public class Idea60881Service {
    private static final int IDEA_ID = 60881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60881Service() {
        this(new Idea60881Config());
    }

    public Idea60881Service(Idea60881Config config) {
        this.config = config != null ? config : new Idea60881Config();
