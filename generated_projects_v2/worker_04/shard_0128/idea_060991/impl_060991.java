...
@Data
public class Idea60991Config {
    private String name = "idea_060991";
 ...
 */
@Slf4j
public class Idea60991Service {
    private static final int IDEA_ID = 60991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60991Service() {
        this(new Idea60991Config());
    }

    public Idea60991Service(Idea60991Config config) {
        this.config = config != null ? config : new Idea60991Config();
