...
@Data
public class Idea61223Config {
    private String name = "idea_061223";
 ...
 */
@Slf4j
public class Idea61223Service {
    private static final int IDEA_ID = 61223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61223Service() {
        this(new Idea61223Config());
    }

    public Idea61223Service(Idea61223Config config) {
        this.config = config != null ? config : new Idea61223Config();
