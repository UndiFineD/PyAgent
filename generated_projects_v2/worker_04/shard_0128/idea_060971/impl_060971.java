...
@Data
public class Idea60971Config {
    private String name = "idea_060971";
 ...
 */
@Slf4j
public class Idea60971Service {
    private static final int IDEA_ID = 60971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60971Service() {
        this(new Idea60971Config());
    }

    public Idea60971Service(Idea60971Config config) {
        this.config = config != null ? config : new Idea60971Config();
