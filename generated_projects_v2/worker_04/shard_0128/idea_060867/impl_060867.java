...
@Data
public class Idea60867Config {
    private String name = "idea_060867";
 ...
 */
@Slf4j
public class Idea60867Service {
    private static final int IDEA_ID = 60867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60867Service() {
        this(new Idea60867Config());
    }

    public Idea60867Service(Idea60867Config config) {
        this.config = config != null ? config : new Idea60867Config();
