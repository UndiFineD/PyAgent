...
@Data
public class Idea60993Config {
    private String name = "idea_060993";
 ...
 */
@Slf4j
public class Idea60993Service {
    private static final int IDEA_ID = 60993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60993Service() {
        this(new Idea60993Config());
    }

    public Idea60993Service(Idea60993Config config) {
        this.config = config != null ? config : new Idea60993Config();
