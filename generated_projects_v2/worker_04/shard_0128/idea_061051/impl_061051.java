...
@Data
public class Idea61051Config {
    private String name = "idea_061051";
 ...
 */
@Slf4j
public class Idea61051Service {
    private static final int IDEA_ID = 61051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61051Service() {
        this(new Idea61051Config());
    }

    public Idea61051Service(Idea61051Config config) {
        this.config = config != null ? config : new Idea61051Config();
