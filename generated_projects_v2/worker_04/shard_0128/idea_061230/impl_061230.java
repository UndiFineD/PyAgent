...
@Data
public class Idea61230Config {
    private String name = "idea_061230";
 ...
 */
@Slf4j
public class Idea61230Service {
    private static final int IDEA_ID = 61230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61230Service() {
        this(new Idea61230Config());
    }

    public Idea61230Service(Idea61230Config config) {
        this.config = config != null ? config : new Idea61230Config();
