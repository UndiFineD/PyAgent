...
@Data
public class Idea61184Config {
    private String name = "idea_061184";
 ...
 */
@Slf4j
public class Idea61184Service {
    private static final int IDEA_ID = 61184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61184Service() {
        this(new Idea61184Config());
    }

    public Idea61184Service(Idea61184Config config) {
        this.config = config != null ? config : new Idea61184Config();
