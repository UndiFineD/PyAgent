...
@Data
public class Idea61219Config {
    private String name = "idea_061219";
 ...
 */
@Slf4j
public class Idea61219Service {
    private static final int IDEA_ID = 61219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61219Service() {
        this(new Idea61219Config());
    }

    public Idea61219Service(Idea61219Config config) {
        this.config = config != null ? config : new Idea61219Config();
