...
@Data
public class Idea60132Config {
    private String name = "idea_060132";
 ...
 */
@Slf4j
public class Idea60132Service {
    private static final int IDEA_ID = 60132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60132Service() {
        this(new Idea60132Config());
    }

    public Idea60132Service(Idea60132Config config) {
        this.config = config != null ? config : new Idea60132Config();
