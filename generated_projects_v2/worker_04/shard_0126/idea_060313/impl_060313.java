...
@Data
public class Idea60313Config {
    private String name = "idea_060313";
 ...
 */
@Slf4j
public class Idea60313Service {
    private static final int IDEA_ID = 60313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60313Service() {
        this(new Idea60313Config());
    }

    public Idea60313Service(Idea60313Config config) {
        this.config = config != null ? config : new Idea60313Config();
