...
@Data
public class Idea60078Config {
    private String name = "idea_060078";
 ...
 */
@Slf4j
public class Idea60078Service {
    private static final int IDEA_ID = 60078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60078Service() {
        this(new Idea60078Config());
    }

    public Idea60078Service(Idea60078Config config) {
        this.config = config != null ? config : new Idea60078Config();
