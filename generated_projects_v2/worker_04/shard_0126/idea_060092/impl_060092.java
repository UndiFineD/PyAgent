...
@Data
public class Idea60092Config {
    private String name = "idea_060092";
 ...
 */
@Slf4j
public class Idea60092Service {
    private static final int IDEA_ID = 60092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60092Service() {
        this(new Idea60092Config());
    }

    public Idea60092Service(Idea60092Config config) {
        this.config = config != null ? config : new Idea60092Config();
