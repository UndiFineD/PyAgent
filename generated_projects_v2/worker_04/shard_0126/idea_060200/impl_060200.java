...
@Data
public class Idea60200Config {
    private String name = "idea_060200";
 ...
 */
@Slf4j
public class Idea60200Service {
    private static final int IDEA_ID = 60200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60200Service() {
        this(new Idea60200Config());
    }

    public Idea60200Service(Idea60200Config config) {
        this.config = config != null ? config : new Idea60200Config();
