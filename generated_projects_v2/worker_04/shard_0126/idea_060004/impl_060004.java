...
@Data
public class Idea60004Config {
    private String name = "idea_060004";
 ...
 */
@Slf4j
public class Idea60004Service {
    private static final int IDEA_ID = 60004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60004Service() {
        this(new Idea60004Config());
    }

    public Idea60004Service(Idea60004Config config) {
        this.config = config != null ? config : new Idea60004Config();
