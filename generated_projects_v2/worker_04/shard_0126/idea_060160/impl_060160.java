...
@Data
public class Idea60160Config {
    private String name = "idea_060160";
 ...
 */
@Slf4j
public class Idea60160Service {
    private static final int IDEA_ID = 60160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60160Service() {
        this(new Idea60160Config());
    }

    public Idea60160Service(Idea60160Config config) {
        this.config = config != null ? config : new Idea60160Config();
