...
@Data
public class Idea60130Config {
    private String name = "idea_060130";
 ...
 */
@Slf4j
public class Idea60130Service {
    private static final int IDEA_ID = 60130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60130Service() {
        this(new Idea60130Config());
    }

    public Idea60130Service(Idea60130Config config) {
        this.config = config != null ? config : new Idea60130Config();
