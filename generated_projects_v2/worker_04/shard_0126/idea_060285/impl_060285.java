...
@Data
public class Idea60285Config {
    private String name = "idea_060285";
 ...
 */
@Slf4j
public class Idea60285Service {
    private static final int IDEA_ID = 60285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60285Service() {
        this(new Idea60285Config());
    }

    public Idea60285Service(Idea60285Config config) {
        this.config = config != null ? config : new Idea60285Config();
