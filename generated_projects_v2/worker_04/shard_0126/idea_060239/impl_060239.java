...
@Data
public class Idea60239Config {
    private String name = "idea_060239";
 ...
 */
@Slf4j
public class Idea60239Service {
    private static final int IDEA_ID = 60239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60239Service() {
        this(new Idea60239Config());
    }

    public Idea60239Service(Idea60239Config config) {
        this.config = config != null ? config : new Idea60239Config();
