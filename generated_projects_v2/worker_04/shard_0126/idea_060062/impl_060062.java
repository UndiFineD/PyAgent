...
@Data
public class Idea60062Config {
    private String name = "idea_060062";
 ...
 */
@Slf4j
public class Idea60062Service {
    private static final int IDEA_ID = 60062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60062Service() {
        this(new Idea60062Config());
    }

    public Idea60062Service(Idea60062Config config) {
        this.config = config != null ? config : new Idea60062Config();
