...
@Data
public class Idea60305Config {
    private String name = "idea_060305";
 ...
 */
@Slf4j
public class Idea60305Service {
    private static final int IDEA_ID = 60305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60305Service() {
        this(new Idea60305Config());
    }

    public Idea60305Service(Idea60305Config config) {
        this.config = config != null ? config : new Idea60305Config();
