...
@Data
public class Idea60125Config {
    private String name = "idea_060125";
 ...
 */
@Slf4j
public class Idea60125Service {
    private static final int IDEA_ID = 60125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60125Service() {
        this(new Idea60125Config());
    }

    public Idea60125Service(Idea60125Config config) {
        this.config = config != null ? config : new Idea60125Config();
