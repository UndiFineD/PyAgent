...
@Data
public class Idea60211Config {
    private String name = "idea_060211";
 ...
 */
@Slf4j
public class Idea60211Service {
    private static final int IDEA_ID = 60211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60211Service() {
        this(new Idea60211Config());
    }

    public Idea60211Service(Idea60211Config config) {
        this.config = config != null ? config : new Idea60211Config();
