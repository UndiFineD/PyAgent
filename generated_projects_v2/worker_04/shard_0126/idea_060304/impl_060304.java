...
@Data
public class Idea60304Config {
    private String name = "idea_060304";
 ...
 */
@Slf4j
public class Idea60304Service {
    private static final int IDEA_ID = 60304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60304Service() {
        this(new Idea60304Config());
    }

    public Idea60304Service(Idea60304Config config) {
        this.config = config != null ? config : new Idea60304Config();
