...
@Data
public class Idea60025Config {
    private String name = "idea_060025";
 ...
 */
@Slf4j
public class Idea60025Service {
    private static final int IDEA_ID = 60025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60025Service() {
        this(new Idea60025Config());
    }

    public Idea60025Service(Idea60025Config config) {
        this.config = config != null ? config : new Idea60025Config();
