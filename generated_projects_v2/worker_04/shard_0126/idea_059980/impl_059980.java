...
@Data
public class Idea59980Config {
    private String name = "idea_059980";
 ...
 */
@Slf4j
public class Idea59980Service {
    private static final int IDEA_ID = 59980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59980Service() {
        this(new Idea59980Config());
    }

    public Idea59980Service(Idea59980Config config) {
        this.config = config != null ? config : new Idea59980Config();
