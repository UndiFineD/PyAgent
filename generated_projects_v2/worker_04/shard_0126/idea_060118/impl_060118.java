...
@Data
public class Idea60118Config {
    private String name = "idea_060118";
 ...
 */
@Slf4j
public class Idea60118Service {
    private static final int IDEA_ID = 60118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60118Service() {
        this(new Idea60118Config());
    }

    public Idea60118Service(Idea60118Config config) {
        this.config = config != null ? config : new Idea60118Config();
