...
@Data
public class Idea60129Config {
    private String name = "idea_060129";
 ...
 */
@Slf4j
public class Idea60129Service {
    private static final int IDEA_ID = 60129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60129Service() {
        this(new Idea60129Config());
    }

    public Idea60129Service(Idea60129Config config) {
        this.config = config != null ? config : new Idea60129Config();
