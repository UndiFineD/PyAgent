...
@Data
public class Idea60292Config {
    private String name = "idea_060292";
 ...
 */
@Slf4j
public class Idea60292Service {
    private static final int IDEA_ID = 60292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60292Service() {
        this(new Idea60292Config());
    }

    public Idea60292Service(Idea60292Config config) {
        this.config = config != null ? config : new Idea60292Config();
