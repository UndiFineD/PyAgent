...
@Data
public class Idea59978Config {
    private String name = "idea_059978";
 ...
 */
@Slf4j
public class Idea59978Service {
    private static final int IDEA_ID = 59978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59978Service() {
        this(new Idea59978Config());
    }

    public Idea59978Service(Idea59978Config config) {
        this.config = config != null ? config : new Idea59978Config();
