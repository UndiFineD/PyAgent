...
@Data
public class Idea60060Config {
    private String name = "idea_060060";
 ...
 */
@Slf4j
public class Idea60060Service {
    private static final int IDEA_ID = 60060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60060Service() {
        this(new Idea60060Config());
    }

    public Idea60060Service(Idea60060Config config) {
        this.config = config != null ? config : new Idea60060Config();
