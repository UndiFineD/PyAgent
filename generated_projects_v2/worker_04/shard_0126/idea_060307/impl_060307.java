...
@Data
public class Idea60307Config {
    private String name = "idea_060307";
 ...
 */
@Slf4j
public class Idea60307Service {
    private static final int IDEA_ID = 60307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60307Service() {
        this(new Idea60307Config());
    }

    public Idea60307Service(Idea60307Config config) {
        this.config = config != null ? config : new Idea60307Config();
