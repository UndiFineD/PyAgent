...
@Data
public class Idea60145Config {
    private String name = "idea_060145";
 ...
 */
@Slf4j
public class Idea60145Service {
    private static final int IDEA_ID = 60145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60145Service() {
        this(new Idea60145Config());
    }

    public Idea60145Service(Idea60145Config config) {
        this.config = config != null ? config : new Idea60145Config();
