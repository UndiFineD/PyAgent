...
@Data
public class Idea60158Config {
    private String name = "idea_060158";
 ...
 */
@Slf4j
public class Idea60158Service {
    private static final int IDEA_ID = 60158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60158Service() {
        this(new Idea60158Config());
    }

    public Idea60158Service(Idea60158Config config) {
        this.config = config != null ? config : new Idea60158Config();
