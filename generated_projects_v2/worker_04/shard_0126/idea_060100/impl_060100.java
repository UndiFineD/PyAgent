...
@Data
public class Idea60100Config {
    private String name = "idea_060100";
 ...
 */
@Slf4j
public class Idea60100Service {
    private static final int IDEA_ID = 60100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60100Service() {
        this(new Idea60100Config());
    }

    public Idea60100Service(Idea60100Config config) {
        this.config = config != null ? config : new Idea60100Config();
