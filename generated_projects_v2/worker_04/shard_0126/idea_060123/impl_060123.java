...
@Data
public class Idea60123Config {
    private String name = "idea_060123";
 ...
 */
@Slf4j
public class Idea60123Service {
    private static final int IDEA_ID = 60123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60123Service() {
        this(new Idea60123Config());
    }

    public Idea60123Service(Idea60123Config config) {
        this.config = config != null ? config : new Idea60123Config();
