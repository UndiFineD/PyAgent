...
@Data
public class Idea60277Config {
    private String name = "idea_060277";
 ...
 */
@Slf4j
public class Idea60277Service {
    private static final int IDEA_ID = 60277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60277Service() {
        this(new Idea60277Config());
    }

    public Idea60277Service(Idea60277Config config) {
        this.config = config != null ? config : new Idea60277Config();
