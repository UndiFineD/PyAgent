...
@Data
public class Idea60319Config {
    private String name = "idea_060319";
 ...
 */
@Slf4j
public class Idea60319Service {
    private static final int IDEA_ID = 60319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60319Service() {
        this(new Idea60319Config());
    }

    public Idea60319Service(Idea60319Config config) {
        this.config = config != null ? config : new Idea60319Config();
