...
@Data
public class Idea60142Config {
    private String name = "idea_060142";
 ...
 */
@Slf4j
public class Idea60142Service {
    private static final int IDEA_ID = 60142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60142Service() {
        this(new Idea60142Config());
    }

    public Idea60142Service(Idea60142Config config) {
        this.config = config != null ? config : new Idea60142Config();
