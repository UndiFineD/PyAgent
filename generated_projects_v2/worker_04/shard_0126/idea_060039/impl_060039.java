...
@Data
public class Idea60039Config {
    private String name = "idea_060039";
 ...
 */
@Slf4j
public class Idea60039Service {
    private static final int IDEA_ID = 60039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60039Service() {
        this(new Idea60039Config());
    }

    public Idea60039Service(Idea60039Config config) {
        this.config = config != null ? config : new Idea60039Config();
