...
@Data
public class Idea60148Config {
    private String name = "idea_060148";
 ...
 */
@Slf4j
public class Idea60148Service {
    private static final int IDEA_ID = 60148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60148Service() {
        this(new Idea60148Config());
    }

    public Idea60148Service(Idea60148Config config) {
        this.config = config != null ? config : new Idea60148Config();
