...
@Data
public class Idea60127Config {
    private String name = "idea_060127";
 ...
 */
@Slf4j
public class Idea60127Service {
    private static final int IDEA_ID = 60127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60127Service() {
        this(new Idea60127Config());
    }

    public Idea60127Service(Idea60127Config config) {
        this.config = config != null ? config : new Idea60127Config();
