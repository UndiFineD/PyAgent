...
@Data
public class Idea60175Config {
    private String name = "idea_060175";
 ...
 */
@Slf4j
public class Idea60175Service {
    private static final int IDEA_ID = 60175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60175Service() {
        this(new Idea60175Config());
    }

    public Idea60175Service(Idea60175Config config) {
        this.config = config != null ? config : new Idea60175Config();
