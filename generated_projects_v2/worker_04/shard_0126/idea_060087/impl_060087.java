...
@Data
public class Idea60087Config {
    private String name = "idea_060087";
 ...
 */
@Slf4j
public class Idea60087Service {
    private static final int IDEA_ID = 60087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60087Service() {
        this(new Idea60087Config());
    }

    public Idea60087Service(Idea60087Config config) {
        this.config = config != null ? config : new Idea60087Config();
