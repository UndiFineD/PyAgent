...
@Data
public class Idea60165Config {
    private String name = "idea_060165";
 ...
 */
@Slf4j
public class Idea60165Service {
    private static final int IDEA_ID = 60165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60165Service() {
        this(new Idea60165Config());
    }

    public Idea60165Service(Idea60165Config config) {
        this.config = config != null ? config : new Idea60165Config();
