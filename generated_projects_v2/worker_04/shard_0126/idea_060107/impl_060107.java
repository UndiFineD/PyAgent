...
@Data
public class Idea60107Config {
    private String name = "idea_060107";
 ...
 */
@Slf4j
public class Idea60107Service {
    private static final int IDEA_ID = 60107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60107Service() {
        this(new Idea60107Config());
    }

    public Idea60107Service(Idea60107Config config) {
        this.config = config != null ? config : new Idea60107Config();
