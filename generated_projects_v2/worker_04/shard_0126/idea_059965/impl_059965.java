...
@Data
public class Idea59965Config {
    private String name = "idea_059965";
 ...
 */
@Slf4j
public class Idea59965Service {
    private static final int IDEA_ID = 59965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59965Service() {
        this(new Idea59965Config());
    }

    public Idea59965Service(Idea59965Config config) {
        this.config = config != null ? config : new Idea59965Config();
