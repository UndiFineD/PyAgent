...
@Data
public class Idea60109Config {
    private String name = "idea_060109";
 ...
 */
@Slf4j
public class Idea60109Service {
    private static final int IDEA_ID = 60109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60109Service() {
        this(new Idea60109Config());
    }

    public Idea60109Service(Idea60109Config config) {
        this.config = config != null ? config : new Idea60109Config();
