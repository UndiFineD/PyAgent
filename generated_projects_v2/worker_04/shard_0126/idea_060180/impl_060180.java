...
@Data
public class Idea60180Config {
    private String name = "idea_060180";
 ...
 */
@Slf4j
public class Idea60180Service {
    private static final int IDEA_ID = 60180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60180Service() {
        this(new Idea60180Config());
    }

    public Idea60180Service(Idea60180Config config) {
        this.config = config != null ? config : new Idea60180Config();
