...
@Data
public class Idea60218Config {
    private String name = "idea_060218";
 ...
 */
@Slf4j
public class Idea60218Service {
    private static final int IDEA_ID = 60218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60218Service() {
        this(new Idea60218Config());
    }

    public Idea60218Service(Idea60218Config config) {
        this.config = config != null ? config : new Idea60218Config();
