...
@Data
public class Idea60150Config {
    private String name = "idea_060150";
 ...
 */
@Slf4j
public class Idea60150Service {
    private static final int IDEA_ID = 60150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60150Service() {
        this(new Idea60150Config());
    }

    public Idea60150Service(Idea60150Config config) {
        this.config = config != null ? config : new Idea60150Config();
