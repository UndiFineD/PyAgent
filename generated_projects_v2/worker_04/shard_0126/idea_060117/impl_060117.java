...
@Data
public class Idea60117Config {
    private String name = "idea_060117";
 ...
 */
@Slf4j
public class Idea60117Service {
    private static final int IDEA_ID = 60117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60117Service() {
        this(new Idea60117Config());
    }

    public Idea60117Service(Idea60117Config config) {
        this.config = config != null ? config : new Idea60117Config();
