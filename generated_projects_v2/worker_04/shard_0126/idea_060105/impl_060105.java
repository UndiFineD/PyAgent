...
@Data
public class Idea60105Config {
    private String name = "idea_060105";
 ...
 */
@Slf4j
public class Idea60105Service {
    private static final int IDEA_ID = 60105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60105Service() {
        this(new Idea60105Config());
    }

    public Idea60105Service(Idea60105Config config) {
        this.config = config != null ? config : new Idea60105Config();
