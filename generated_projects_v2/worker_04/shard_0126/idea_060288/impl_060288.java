...
@Data
public class Idea60288Config {
    private String name = "idea_060288";
 ...
 */
@Slf4j
public class Idea60288Service {
    private static final int IDEA_ID = 60288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60288Service() {
        this(new Idea60288Config());
    }

    public Idea60288Service(Idea60288Config config) {
        this.config = config != null ? config : new Idea60288Config();
