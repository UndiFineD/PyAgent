...
@Data
public class Idea60164Config {
    private String name = "idea_060164";
 ...
 */
@Slf4j
public class Idea60164Service {
    private static final int IDEA_ID = 60164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60164Service() {
        this(new Idea60164Config());
    }

    public Idea60164Service(Idea60164Config config) {
        this.config = config != null ? config : new Idea60164Config();
