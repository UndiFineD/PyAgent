...
@Data
public class Idea60106Config {
    private String name = "idea_060106";
 ...
 */
@Slf4j
public class Idea60106Service {
    private static final int IDEA_ID = 60106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60106Service() {
        this(new Idea60106Config());
    }

    public Idea60106Service(Idea60106Config config) {
        this.config = config != null ? config : new Idea60106Config();
