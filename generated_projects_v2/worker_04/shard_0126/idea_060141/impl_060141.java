...
@Data
public class Idea60141Config {
    private String name = "idea_060141";
 ...
 */
@Slf4j
public class Idea60141Service {
    private static final int IDEA_ID = 60141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60141Service() {
        this(new Idea60141Config());
    }

    public Idea60141Service(Idea60141Config config) {
        this.config = config != null ? config : new Idea60141Config();
