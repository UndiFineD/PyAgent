...
@Data
public class Idea60050Config {
    private String name = "idea_060050";
 ...
 */
@Slf4j
public class Idea60050Service {
    private static final int IDEA_ID = 60050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60050Service() {
        this(new Idea60050Config());
    }

    public Idea60050Service(Idea60050Config config) {
        this.config = config != null ? config : new Idea60050Config();
