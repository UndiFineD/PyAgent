...
@Data
public class Idea60246Config {
    private String name = "idea_060246";
 ...
 */
@Slf4j
public class Idea60246Service {
    private static final int IDEA_ID = 60246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60246Service() {
        this(new Idea60246Config());
    }

    public Idea60246Service(Idea60246Config config) {
        this.config = config != null ? config : new Idea60246Config();
