...
@Data
public class Idea59873Config {
    private String name = "idea_059873";
 ...
 */
@Slf4j
public class Idea59873Service {
    private static final int IDEA_ID = 59873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59873Service() {
        this(new Idea59873Config());
    }

    public Idea59873Service(Idea59873Config config) {
        this.config = config != null ? config : new Idea59873Config();
