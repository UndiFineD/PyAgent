...
@Data
public class Idea60023Config {
    private String name = "idea_060023";
 ...
 */
@Slf4j
public class Idea60023Service {
    private static final int IDEA_ID = 60023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60023Service() {
        this(new Idea60023Config());
    }

    public Idea60023Service(Idea60023Config config) {
        this.config = config != null ? config : new Idea60023Config();
