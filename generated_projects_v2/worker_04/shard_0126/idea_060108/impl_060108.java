...
@Data
public class Idea60108Config {
    private String name = "idea_060108";
 ...
 */
@Slf4j
public class Idea60108Service {
    private static final int IDEA_ID = 60108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60108Service() {
        this(new Idea60108Config());
    }

    public Idea60108Service(Idea60108Config config) {
        this.config = config != null ? config : new Idea60108Config();
