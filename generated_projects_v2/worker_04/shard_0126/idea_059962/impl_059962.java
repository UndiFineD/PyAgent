...
@Data
public class Idea59962Config {
    private String name = "idea_059962";
 ...
 */
@Slf4j
public class Idea59962Service {
    private static final int IDEA_ID = 59962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59962Service() {
        this(new Idea59962Config());
    }

    public Idea59962Service(Idea59962Config config) {
        this.config = config != null ? config : new Idea59962Config();
