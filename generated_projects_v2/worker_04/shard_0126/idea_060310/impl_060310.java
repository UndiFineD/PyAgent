...
@Data
public class Idea60310Config {
    private String name = "idea_060310";
 ...
 */
@Slf4j
public class Idea60310Service {
    private static final int IDEA_ID = 60310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60310Service() {
        this(new Idea60310Config());
    }

    public Idea60310Service(Idea60310Config config) {
        this.config = config != null ? config : new Idea60310Config();
