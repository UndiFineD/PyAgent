...
@Data
public class Idea60242Config {
    private String name = "idea_060242";
 ...
 */
@Slf4j
public class Idea60242Service {
    private static final int IDEA_ID = 60242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60242Service() {
        this(new Idea60242Config());
    }

    public Idea60242Service(Idea60242Config config) {
        this.config = config != null ? config : new Idea60242Config();
