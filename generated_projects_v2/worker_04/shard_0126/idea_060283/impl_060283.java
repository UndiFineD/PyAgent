...
@Data
public class Idea60283Config {
    private String name = "idea_060283";
 ...
 */
@Slf4j
public class Idea60283Service {
    private static final int IDEA_ID = 60283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60283Service() {
        this(new Idea60283Config());
    }

    public Idea60283Service(Idea60283Config config) {
        this.config = config != null ? config : new Idea60283Config();
