...
@Data
public class Idea60224Config {
    private String name = "idea_060224";
 ...
 */
@Slf4j
public class Idea60224Service {
    private static final int IDEA_ID = 60224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60224Service() {
        this(new Idea60224Config());
    }

    public Idea60224Service(Idea60224Config config) {
        this.config = config != null ? config : new Idea60224Config();
