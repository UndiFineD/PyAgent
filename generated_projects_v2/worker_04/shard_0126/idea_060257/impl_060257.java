...
@Data
public class Idea60257Config {
    private String name = "idea_060257";
 ...
 */
@Slf4j
public class Idea60257Service {
    private static final int IDEA_ID = 60257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60257Service() {
        this(new Idea60257Config());
    }

    public Idea60257Service(Idea60257Config config) {
        this.config = config != null ? config : new Idea60257Config();
