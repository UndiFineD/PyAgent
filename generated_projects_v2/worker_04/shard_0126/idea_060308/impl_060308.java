...
@Data
public class Idea60308Config {
    private String name = "idea_060308";
 ...
 */
@Slf4j
public class Idea60308Service {
    private static final int IDEA_ID = 60308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60308Service() {
        this(new Idea60308Config());
    }

    public Idea60308Service(Idea60308Config config) {
        this.config = config != null ? config : new Idea60308Config();
