...
@Data
public class Idea60273Config {
    private String name = "idea_060273";
 ...
 */
@Slf4j
public class Idea60273Service {
    private static final int IDEA_ID = 60273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60273Service() {
        this(new Idea60273Config());
    }

    public Idea60273Service(Idea60273Config config) {
        this.config = config != null ? config : new Idea60273Config();
