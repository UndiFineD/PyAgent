...
@Data
public class Idea60095Config {
    private String name = "idea_060095";
 ...
 */
@Slf4j
public class Idea60095Service {
    private static final int IDEA_ID = 60095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60095Service() {
        this(new Idea60095Config());
    }

    public Idea60095Service(Idea60095Config config) {
        this.config = config != null ? config : new Idea60095Config();
