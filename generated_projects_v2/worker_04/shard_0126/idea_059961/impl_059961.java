...
@Data
public class Idea59961Config {
    private String name = "idea_059961";
 ...
 */
@Slf4j
public class Idea59961Service {
    private static final int IDEA_ID = 59961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59961Service() {
        this(new Idea59961Config());
    }

    public Idea59961Service(Idea59961Config config) {
        this.config = config != null ? config : new Idea59961Config();
