...
@Data
public class Idea60028Config {
    private String name = "idea_060028";
 ...
 */
@Slf4j
public class Idea60028Service {
    private static final int IDEA_ID = 60028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60028Service() {
        this(new Idea60028Config());
    }

    public Idea60028Service(Idea60028Config config) {
        this.config = config != null ? config : new Idea60028Config();
