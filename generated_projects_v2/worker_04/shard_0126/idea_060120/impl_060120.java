...
@Data
public class Idea60120Config {
    private String name = "idea_060120";
 ...
 */
@Slf4j
public class Idea60120Service {
    private static final int IDEA_ID = 60120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60120Service() {
        this(new Idea60120Config());
    }

    public Idea60120Service(Idea60120Config config) {
        this.config = config != null ? config : new Idea60120Config();
