...
@Data
public class Idea60073Config {
    private String name = "idea_060073";
 ...
 */
@Slf4j
public class Idea60073Service {
    private static final int IDEA_ID = 60073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60073Service() {
        this(new Idea60073Config());
    }

    public Idea60073Service(Idea60073Config config) {
        this.config = config != null ? config : new Idea60073Config();
