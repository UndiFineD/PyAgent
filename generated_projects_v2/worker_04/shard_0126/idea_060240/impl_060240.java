...
@Data
public class Idea60240Config {
    private String name = "idea_060240";
 ...
 */
@Slf4j
public class Idea60240Service {
    private static final int IDEA_ID = 60240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60240Service() {
        this(new Idea60240Config());
    }

    public Idea60240Service(Idea60240Config config) {
        this.config = config != null ? config : new Idea60240Config();
