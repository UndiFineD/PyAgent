...
@Data
public class Idea60002Config {
    private String name = "idea_060002";
 ...
 */
@Slf4j
public class Idea60002Service {
    private static final int IDEA_ID = 60002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60002Service() {
        this(new Idea60002Config());
    }

    public Idea60002Service(Idea60002Config config) {
        this.config = config != null ? config : new Idea60002Config();
