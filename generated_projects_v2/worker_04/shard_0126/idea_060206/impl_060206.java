...
@Data
public class Idea60206Config {
    private String name = "idea_060206";
 ...
 */
@Slf4j
public class Idea60206Service {
    private static final int IDEA_ID = 60206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60206Service() {
        this(new Idea60206Config());
    }

    public Idea60206Service(Idea60206Config config) {
        this.config = config != null ? config : new Idea60206Config();
