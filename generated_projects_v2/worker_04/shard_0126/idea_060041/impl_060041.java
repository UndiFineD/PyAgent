...
@Data
public class Idea60041Config {
    private String name = "idea_060041";
 ...
 */
@Slf4j
public class Idea60041Service {
    private static final int IDEA_ID = 60041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60041Service() {
        this(new Idea60041Config());
    }

    public Idea60041Service(Idea60041Config config) {
        this.config = config != null ? config : new Idea60041Config();
