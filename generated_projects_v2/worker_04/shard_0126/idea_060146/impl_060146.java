...
@Data
public class Idea60146Config {
    private String name = "idea_060146";
 ...
 */
@Slf4j
public class Idea60146Service {
    private static final int IDEA_ID = 60146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60146Service() {
        this(new Idea60146Config());
    }

    public Idea60146Service(Idea60146Config config) {
        this.config = config != null ? config : new Idea60146Config();
