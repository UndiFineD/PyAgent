...
@Data
public class Idea60094Config {
    private String name = "idea_060094";
 ...
 */
@Slf4j
public class Idea60094Service {
    private static final int IDEA_ID = 60094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60094Service() {
        this(new Idea60094Config());
    }

    public Idea60094Service(Idea60094Config config) {
        this.config = config != null ? config : new Idea60094Config();
