...
@Data
public class Idea59925Config {
    private String name = "idea_059925";
 ...
 */
@Slf4j
public class Idea59925Service {
    private static final int IDEA_ID = 59925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59925Service() {
        this(new Idea59925Config());
    }

    public Idea59925Service(Idea59925Config config) {
        this.config = config != null ? config : new Idea59925Config();
