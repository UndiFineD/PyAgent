...
@Data
public class Idea60187Config {
    private String name = "idea_060187";
 ...
 */
@Slf4j
public class Idea60187Service {
    private static final int IDEA_ID = 60187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60187Service() {
        this(new Idea60187Config());
    }

    public Idea60187Service(Idea60187Config config) {
        this.config = config != null ? config : new Idea60187Config();
