...
@Data
public class Idea60104Config {
    private String name = "idea_060104";
 ...
 */
@Slf4j
public class Idea60104Service {
    private static final int IDEA_ID = 60104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60104Service() {
        this(new Idea60104Config());
    }

    public Idea60104Service(Idea60104Config config) {
        this.config = config != null ? config : new Idea60104Config();
