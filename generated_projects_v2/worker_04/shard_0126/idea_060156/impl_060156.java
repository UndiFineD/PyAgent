...
@Data
public class Idea60156Config {
    private String name = "idea_060156";
 ...
 */
@Slf4j
public class Idea60156Service {
    private static final int IDEA_ID = 60156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60156Service() {
        this(new Idea60156Config());
    }

    public Idea60156Service(Idea60156Config config) {
        this.config = config != null ? config : new Idea60156Config();
