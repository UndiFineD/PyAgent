...
@Data
public class Idea60140Config {
    private String name = "idea_060140";
 ...
 */
@Slf4j
public class Idea60140Service {
    private static final int IDEA_ID = 60140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60140Service() {
        this(new Idea60140Config());
    }

    public Idea60140Service(Idea60140Config config) {
        this.config = config != null ? config : new Idea60140Config();
