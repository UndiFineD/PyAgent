...
@Data
public class Idea60047Config {
    private String name = "idea_060047";
 ...
 */
@Slf4j
public class Idea60047Service {
    private static final int IDEA_ID = 60047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60047Service() {
        this(new Idea60047Config());
    }

    public Idea60047Service(Idea60047Config config) {
        this.config = config != null ? config : new Idea60047Config();
