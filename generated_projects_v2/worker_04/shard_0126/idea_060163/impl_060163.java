...
@Data
public class Idea60163Config {
    private String name = "idea_060163";
 ...
 */
@Slf4j
public class Idea60163Service {
    private static final int IDEA_ID = 60163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60163Service() {
        this(new Idea60163Config());
    }

    public Idea60163Service(Idea60163Config config) {
        this.config = config != null ? config : new Idea60163Config();
