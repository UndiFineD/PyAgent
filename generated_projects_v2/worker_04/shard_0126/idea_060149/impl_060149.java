...
@Data
public class Idea60149Config {
    private String name = "idea_060149";
 ...
 */
@Slf4j
public class Idea60149Service {
    private static final int IDEA_ID = 60149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60149Service() {
        this(new Idea60149Config());
    }

    public Idea60149Service(Idea60149Config config) {
        this.config = config != null ? config : new Idea60149Config();
