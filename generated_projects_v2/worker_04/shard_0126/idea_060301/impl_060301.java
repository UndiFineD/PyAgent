...
@Data
public class Idea60301Config {
    private String name = "idea_060301";
 ...
 */
@Slf4j
public class Idea60301Service {
    private static final int IDEA_ID = 60301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60301Service() {
        this(new Idea60301Config());
    }

    public Idea60301Service(Idea60301Config config) {
        this.config = config != null ? config : new Idea60301Config();
