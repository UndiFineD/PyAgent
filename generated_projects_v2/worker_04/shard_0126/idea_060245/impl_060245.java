...
@Data
public class Idea60245Config {
    private String name = "idea_060245";
 ...
 */
@Slf4j
public class Idea60245Service {
    private static final int IDEA_ID = 60245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60245Service() {
        this(new Idea60245Config());
    }

    public Idea60245Service(Idea60245Config config) {
        this.config = config != null ? config : new Idea60245Config();
