...
@Data
public class Idea59963Config {
    private String name = "idea_059963";
 ...
 */
@Slf4j
public class Idea59963Service {
    private static final int IDEA_ID = 59963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59963Service() {
        this(new Idea59963Config());
    }

    public Idea59963Service(Idea59963Config config) {
        this.config = config != null ? config : new Idea59963Config();
