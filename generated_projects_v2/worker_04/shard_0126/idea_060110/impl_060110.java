...
@Data
public class Idea60110Config {
    private String name = "idea_060110";
 ...
 */
@Slf4j
public class Idea60110Service {
    private static final int IDEA_ID = 60110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60110Service() {
        this(new Idea60110Config());
    }

    public Idea60110Service(Idea60110Config config) {
        this.config = config != null ? config : new Idea60110Config();
