...
@Data
public class Idea60322Config {
    private String name = "idea_060322";
 ...
 */
@Slf4j
public class Idea60322Service {
    private static final int IDEA_ID = 60322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60322Service() {
        this(new Idea60322Config());
    }

    public Idea60322Service(Idea60322Config config) {
        this.config = config != null ? config : new Idea60322Config();
