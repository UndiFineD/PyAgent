...
@Data
public class Idea60241Config {
    private String name = "idea_060241";
 ...
 */
@Slf4j
public class Idea60241Service {
    private static final int IDEA_ID = 60241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60241Service() {
        this(new Idea60241Config());
    }

    public Idea60241Service(Idea60241Config config) {
        this.config = config != null ? config : new Idea60241Config();
