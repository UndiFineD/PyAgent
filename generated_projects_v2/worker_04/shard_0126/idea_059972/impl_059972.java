...
@Data
public class Idea59972Config {
    private String name = "idea_059972";
 ...
 */
@Slf4j
public class Idea59972Service {
    private static final int IDEA_ID = 59972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59972Service() {
        this(new Idea59972Config());
    }

    public Idea59972Service(Idea59972Config config) {
        this.config = config != null ? config : new Idea59972Config();
