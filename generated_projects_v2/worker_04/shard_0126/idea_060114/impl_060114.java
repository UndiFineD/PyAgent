...
@Data
public class Idea60114Config {
    private String name = "idea_060114";
 ...
 */
@Slf4j
public class Idea60114Service {
    private static final int IDEA_ID = 60114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60114Service() {
        this(new Idea60114Config());
    }

    public Idea60114Service(Idea60114Config config) {
        this.config = config != null ? config : new Idea60114Config();
