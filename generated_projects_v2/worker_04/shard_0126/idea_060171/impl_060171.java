...
@Data
public class Idea60171Config {
    private String name = "idea_060171";
 ...
 */
@Slf4j
public class Idea60171Service {
    private static final int IDEA_ID = 60171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60171Service() {
        this(new Idea60171Config());
    }

    public Idea60171Service(Idea60171Config config) {
        this.config = config != null ? config : new Idea60171Config();
