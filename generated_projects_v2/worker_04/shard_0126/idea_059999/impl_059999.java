...
@Data
public class Idea59999Config {
    private String name = "idea_059999";
 ...
 */
@Slf4j
public class Idea59999Service {
    private static final int IDEA_ID = 59999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59999Service() {
        this(new Idea59999Config());
    }

    public Idea59999Service(Idea59999Config config) {
        this.config = config != null ? config : new Idea59999Config();
