...
@Data
public class Idea60042Config {
    private String name = "idea_060042";
 ...
 */
@Slf4j
public class Idea60042Service {
    private static final int IDEA_ID = 60042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60042Service() {
        this(new Idea60042Config());
    }

    public Idea60042Service(Idea60042Config config) {
        this.config = config != null ? config : new Idea60042Config();
