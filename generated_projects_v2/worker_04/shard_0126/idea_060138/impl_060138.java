...
@Data
public class Idea60138Config {
    private String name = "idea_060138";
 ...
 */
@Slf4j
public class Idea60138Service {
    private static final int IDEA_ID = 60138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60138Service() {
        this(new Idea60138Config());
    }

    public Idea60138Service(Idea60138Config config) {
        this.config = config != null ? config : new Idea60138Config();
