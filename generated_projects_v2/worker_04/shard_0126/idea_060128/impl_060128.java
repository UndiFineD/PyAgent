...
@Data
public class Idea60128Config {
    private String name = "idea_060128";
 ...
 */
@Slf4j
public class Idea60128Service {
    private static final int IDEA_ID = 60128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60128Service() {
        this(new Idea60128Config());
    }

    public Idea60128Service(Idea60128Config config) {
        this.config = config != null ? config : new Idea60128Config();
