...
@Data
public class Idea60185Config {
    private String name = "idea_060185";
 ...
 */
@Slf4j
public class Idea60185Service {
    private static final int IDEA_ID = 60185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60185Service() {
        this(new Idea60185Config());
    }

    public Idea60185Service(Idea60185Config config) {
        this.config = config != null ? config : new Idea60185Config();
