...
@Data
public class Idea60075Config {
    private String name = "idea_060075";
 ...
 */
@Slf4j
public class Idea60075Service {
    private static final int IDEA_ID = 60075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60075Service() {
        this(new Idea60075Config());
    }

    public Idea60075Service(Idea60075Config config) {
        this.config = config != null ? config : new Idea60075Config();
