...
@Data
public class Idea60113Config {
    private String name = "idea_060113";
 ...
 */
@Slf4j
public class Idea60113Service {
    private static final int IDEA_ID = 60113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60113Service() {
        this(new Idea60113Config());
    }

    public Idea60113Service(Idea60113Config config) {
        this.config = config != null ? config : new Idea60113Config();
