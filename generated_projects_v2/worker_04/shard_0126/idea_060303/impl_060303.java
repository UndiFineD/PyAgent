...
@Data
public class Idea60303Config {
    private String name = "idea_060303";
 ...
 */
@Slf4j
public class Idea60303Service {
    private static final int IDEA_ID = 60303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60303Service() {
        this(new Idea60303Config());
    }

    public Idea60303Service(Idea60303Config config) {
        this.config = config != null ? config : new Idea60303Config();
