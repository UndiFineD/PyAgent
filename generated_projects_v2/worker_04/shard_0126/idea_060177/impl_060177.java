...
@Data
public class Idea60177Config {
    private String name = "idea_060177";
 ...
 */
@Slf4j
public class Idea60177Service {
    private static final int IDEA_ID = 60177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60177Service() {
        this(new Idea60177Config());
    }

    public Idea60177Service(Idea60177Config config) {
        this.config = config != null ? config : new Idea60177Config();
