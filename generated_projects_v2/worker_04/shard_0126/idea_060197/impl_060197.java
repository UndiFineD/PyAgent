...
@Data
public class Idea60197Config {
    private String name = "idea_060197";
 ...
 */
@Slf4j
public class Idea60197Service {
    private static final int IDEA_ID = 60197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60197Service() {
        this(new Idea60197Config());
    }

    public Idea60197Service(Idea60197Config config) {
        this.config = config != null ? config : new Idea60197Config();
