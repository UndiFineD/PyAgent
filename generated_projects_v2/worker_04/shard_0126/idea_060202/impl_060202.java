...
@Data
public class Idea60202Config {
    private String name = "idea_060202";
 ...
 */
@Slf4j
public class Idea60202Service {
    private static final int IDEA_ID = 60202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60202Service() {
        this(new Idea60202Config());
    }

    public Idea60202Service(Idea60202Config config) {
        this.config = config != null ? config : new Idea60202Config();
