...
@Data
public class Idea60011Config {
    private String name = "idea_060011";
 ...
 */
@Slf4j
public class Idea60011Service {
    private static final int IDEA_ID = 60011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60011Service() {
        this(new Idea60011Config());
    }

    public Idea60011Service(Idea60011Config config) {
        this.config = config != null ? config : new Idea60011Config();
