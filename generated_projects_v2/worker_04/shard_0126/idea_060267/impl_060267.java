...
@Data
public class Idea60267Config {
    private String name = "idea_060267";
 ...
 */
@Slf4j
public class Idea60267Service {
    private static final int IDEA_ID = 60267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60267Service() {
        this(new Idea60267Config());
    }

    public Idea60267Service(Idea60267Config config) {
        this.config = config != null ? config : new Idea60267Config();
