...
@Data
public class Idea59893Config {
    private String name = "idea_059893";
 ...
 */
@Slf4j
public class Idea59893Service {
    private static final int IDEA_ID = 59893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59893Service() {
        this(new Idea59893Config());
    }

    public Idea59893Service(Idea59893Config config) {
        this.config = config != null ? config : new Idea59893Config();
