...
@Data
public class Idea60061Config {
    private String name = "idea_060061";
 ...
 */
@Slf4j
public class Idea60061Service {
    private static final int IDEA_ID = 60061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60061Service() {
        this(new Idea60061Config());
    }

    public Idea60061Service(Idea60061Config config) {
        this.config = config != null ? config : new Idea60061Config();
