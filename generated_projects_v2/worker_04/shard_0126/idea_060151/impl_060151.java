...
@Data
public class Idea60151Config {
    private String name = "idea_060151";
 ...
 */
@Slf4j
public class Idea60151Service {
    private static final int IDEA_ID = 60151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60151Service() {
        this(new Idea60151Config());
    }

    public Idea60151Service(Idea60151Config config) {
        this.config = config != null ? config : new Idea60151Config();
