...
@Data
public class Idea60112Config {
    private String name = "idea_060112";
 ...
 */
@Slf4j
public class Idea60112Service {
    private static final int IDEA_ID = 60112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60112Service() {
        this(new Idea60112Config());
    }

    public Idea60112Service(Idea60112Config config) {
        this.config = config != null ? config : new Idea60112Config();
