...
@Data
public class Idea60278Config {
    private String name = "idea_060278";
 ...
 */
@Slf4j
public class Idea60278Service {
    private static final int IDEA_ID = 60278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60278Service() {
        this(new Idea60278Config());
    }

    public Idea60278Service(Idea60278Config config) {
        this.config = config != null ? config : new Idea60278Config();
