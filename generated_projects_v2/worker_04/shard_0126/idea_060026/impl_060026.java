...
@Data
public class Idea60026Config {
    private String name = "idea_060026";
 ...
 */
@Slf4j
public class Idea60026Service {
    private static final int IDEA_ID = 60026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60026Service() {
        this(new Idea60026Config());
    }

    public Idea60026Service(Idea60026Config config) {
        this.config = config != null ? config : new Idea60026Config();
