...
@Data
public class Idea60207Config {
    private String name = "idea_060207";
 ...
 */
@Slf4j
public class Idea60207Service {
    private static final int IDEA_ID = 60207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60207Service() {
        this(new Idea60207Config());
    }

    public Idea60207Service(Idea60207Config config) {
        this.config = config != null ? config : new Idea60207Config();
