...
@Data
public class Idea60201Config {
    private String name = "idea_060201";
 ...
 */
@Slf4j
public class Idea60201Service {
    private static final int IDEA_ID = 60201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60201Service() {
        this(new Idea60201Config());
    }

    public Idea60201Service(Idea60201Config config) {
        this.config = config != null ? config : new Idea60201Config();
