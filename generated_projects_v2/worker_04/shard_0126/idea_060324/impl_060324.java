...
@Data
public class Idea60324Config {
    private String name = "idea_060324";
 ...
 */
@Slf4j
public class Idea60324Service {
    private static final int IDEA_ID = 60324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60324Service() {
        this(new Idea60324Config());
    }

    public Idea60324Service(Idea60324Config config) {
        this.config = config != null ? config : new Idea60324Config();
