...
@Data
public class Idea60022Config {
    private String name = "idea_060022";
 ...
 */
@Slf4j
public class Idea60022Service {
    private static final int IDEA_ID = 60022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60022Service() {
        this(new Idea60022Config());
    }

    public Idea60022Service(Idea60022Config config) {
        this.config = config != null ? config : new Idea60022Config();
