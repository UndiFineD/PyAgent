...
@Data
public class Idea60058Config {
    private String name = "idea_060058";
 ...
 */
@Slf4j
public class Idea60058Service {
    private static final int IDEA_ID = 60058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60058Service() {
        this(new Idea60058Config());
    }

    public Idea60058Service(Idea60058Config config) {
        this.config = config != null ? config : new Idea60058Config();
