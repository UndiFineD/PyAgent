...
@Data
public class Idea60284Config {
    private String name = "idea_060284";
 ...
 */
@Slf4j
public class Idea60284Service {
    private static final int IDEA_ID = 60284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60284Service() {
        this(new Idea60284Config());
    }

    public Idea60284Service(Idea60284Config config) {
        this.config = config != null ? config : new Idea60284Config();
