...
@Data
public class Idea60264Config {
    private String name = "idea_060264";
 ...
 */
@Slf4j
public class Idea60264Service {
    private static final int IDEA_ID = 60264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60264Service() {
        this(new Idea60264Config());
    }

    public Idea60264Service(Idea60264Config config) {
        this.config = config != null ? config : new Idea60264Config();
