...
@Data
public class Idea60216Config {
    private String name = "idea_060216";
 ...
 */
@Slf4j
public class Idea60216Service {
    private static final int IDEA_ID = 60216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60216Service() {
        this(new Idea60216Config());
    }

    public Idea60216Service(Idea60216Config config) {
        this.config = config != null ? config : new Idea60216Config();
