...
@Data
public class Idea60271Config {
    private String name = "idea_060271";
 ...
 */
@Slf4j
public class Idea60271Service {
    private static final int IDEA_ID = 60271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60271Service() {
        this(new Idea60271Config());
    }

    public Idea60271Service(Idea60271Config config) {
        this.config = config != null ? config : new Idea60271Config();
