...
@Data
public class Idea60236Config {
    private String name = "idea_060236";
 ...
 */
@Slf4j
public class Idea60236Service {
    private static final int IDEA_ID = 60236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60236Service() {
        this(new Idea60236Config());
    }

    public Idea60236Service(Idea60236Config config) {
        this.config = config != null ? config : new Idea60236Config();
