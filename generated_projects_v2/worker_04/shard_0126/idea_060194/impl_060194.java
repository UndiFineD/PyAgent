...
@Data
public class Idea60194Config {
    private String name = "idea_060194";
 ...
 */
@Slf4j
public class Idea60194Service {
    private static final int IDEA_ID = 60194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60194Service() {
        this(new Idea60194Config());
    }

    public Idea60194Service(Idea60194Config config) {
        this.config = config != null ? config : new Idea60194Config();
