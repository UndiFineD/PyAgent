...
@Data
public class Idea60088Config {
    private String name = "idea_060088";
 ...
 */
@Slf4j
public class Idea60088Service {
    private static final int IDEA_ID = 60088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60088Service() {
        this(new Idea60088Config());
    }

    public Idea60088Service(Idea60088Config config) {
        this.config = config != null ? config : new Idea60088Config();
