...
@Data
public class Idea60256Config {
    private String name = "idea_060256";
 ...
 */
@Slf4j
public class Idea60256Service {
    private static final int IDEA_ID = 60256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60256Service() {
        this(new Idea60256Config());
    }

    public Idea60256Service(Idea60256Config config) {
        this.config = config != null ? config : new Idea60256Config();
