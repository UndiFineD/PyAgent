...
@Data
public class Idea60299Config {
    private String name = "idea_060299";
 ...
 */
@Slf4j
public class Idea60299Service {
    private static final int IDEA_ID = 60299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60299Service() {
        this(new Idea60299Config());
    }

    public Idea60299Service(Idea60299Config config) {
        this.config = config != null ? config : new Idea60299Config();
