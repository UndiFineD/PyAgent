...
@Data
public class Idea60162Config {
    private String name = "idea_060162";
 ...
 */
@Slf4j
public class Idea60162Service {
    private static final int IDEA_ID = 60162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60162Service() {
        this(new Idea60162Config());
    }

    public Idea60162Service(Idea60162Config config) {
        this.config = config != null ? config : new Idea60162Config();
