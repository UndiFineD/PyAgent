...
@Data
public class Idea60085Config {
    private String name = "idea_060085";
 ...
 */
@Slf4j
public class Idea60085Service {
    private static final int IDEA_ID = 60085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60085Service() {
        this(new Idea60085Config());
    }

    public Idea60085Service(Idea60085Config config) {
        this.config = config != null ? config : new Idea60085Config();
