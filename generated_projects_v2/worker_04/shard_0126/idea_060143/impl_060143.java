...
@Data
public class Idea60143Config {
    private String name = "idea_060143";
 ...
 */
@Slf4j
public class Idea60143Service {
    private static final int IDEA_ID = 60143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60143Service() {
        this(new Idea60143Config());
    }

    public Idea60143Service(Idea60143Config config) {
        this.config = config != null ? config : new Idea60143Config();
