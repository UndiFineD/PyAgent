...
@Data
public class Idea60036Config {
    private String name = "idea_060036";
 ...
 */
@Slf4j
public class Idea60036Service {
    private static final int IDEA_ID = 60036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60036Service() {
        this(new Idea60036Config());
    }

    public Idea60036Service(Idea60036Config config) {
        this.config = config != null ? config : new Idea60036Config();
