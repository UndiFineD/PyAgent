...
@Data
public class Idea60122Config {
    private String name = "idea_060122";
 ...
 */
@Slf4j
public class Idea60122Service {
    private static final int IDEA_ID = 60122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60122Service() {
        this(new Idea60122Config());
    }

    public Idea60122Service(Idea60122Config config) {
        this.config = config != null ? config : new Idea60122Config();
