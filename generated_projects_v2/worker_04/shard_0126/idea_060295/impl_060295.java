...
@Data
public class Idea60295Config {
    private String name = "idea_060295";
 ...
 */
@Slf4j
public class Idea60295Service {
    private static final int IDEA_ID = 60295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60295Service() {
        this(new Idea60295Config());
    }

    public Idea60295Service(Idea60295Config config) {
        this.config = config != null ? config : new Idea60295Config();
