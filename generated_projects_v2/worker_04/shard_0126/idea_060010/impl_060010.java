...
@Data
public class Idea60010Config {
    private String name = "idea_060010";
 ...
 */
@Slf4j
public class Idea60010Service {
    private static final int IDEA_ID = 60010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60010Service() {
        this(new Idea60010Config());
    }

    public Idea60010Service(Idea60010Config config) {
        this.config = config != null ? config : new Idea60010Config();
