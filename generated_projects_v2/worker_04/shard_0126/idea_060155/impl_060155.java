...
@Data
public class Idea60155Config {
    private String name = "idea_060155";
 ...
 */
@Slf4j
public class Idea60155Service {
    private static final int IDEA_ID = 60155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60155Service() {
        this(new Idea60155Config());
    }

    public Idea60155Service(Idea60155Config config) {
        this.config = config != null ? config : new Idea60155Config();
