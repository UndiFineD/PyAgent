...
@Data
public class Idea60001Config {
    private String name = "idea_060001";
 ...
 */
@Slf4j
public class Idea60001Service {
    private static final int IDEA_ID = 60001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60001Service() {
        this(new Idea60001Config());
    }

    public Idea60001Service(Idea60001Config config) {
        this.config = config != null ? config : new Idea60001Config();
