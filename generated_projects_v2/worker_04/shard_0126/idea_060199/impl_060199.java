...
@Data
public class Idea60199Config {
    private String name = "idea_060199";
 ...
 */
@Slf4j
public class Idea60199Service {
    private static final int IDEA_ID = 60199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60199Service() {
        this(new Idea60199Config());
    }

    public Idea60199Service(Idea60199Config config) {
        this.config = config != null ? config : new Idea60199Config();
