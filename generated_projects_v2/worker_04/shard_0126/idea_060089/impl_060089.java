...
@Data
public class Idea60089Config {
    private String name = "idea_060089";
 ...
 */
@Slf4j
public class Idea60089Service {
    private static final int IDEA_ID = 60089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60089Service() {
        this(new Idea60089Config());
    }

    public Idea60089Service(Idea60089Config config) {
        this.config = config != null ? config : new Idea60089Config();
