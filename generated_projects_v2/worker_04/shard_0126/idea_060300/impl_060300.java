...
@Data
public class Idea60300Config {
    private String name = "idea_060300";
 ...
 */
@Slf4j
public class Idea60300Service {
    private static final int IDEA_ID = 60300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60300Service() {
        this(new Idea60300Config());
    }

    public Idea60300Service(Idea60300Config config) {
        this.config = config != null ? config : new Idea60300Config();
