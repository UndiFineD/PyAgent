...
@Data
public class Idea60247Config {
    private String name = "idea_060247";
 ...
 */
@Slf4j
public class Idea60247Service {
    private static final int IDEA_ID = 60247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60247Service() {
        this(new Idea60247Config());
    }

    public Idea60247Service(Idea60247Config config) {
        this.config = config != null ? config : new Idea60247Config();
