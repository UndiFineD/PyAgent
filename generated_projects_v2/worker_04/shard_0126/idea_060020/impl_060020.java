...
@Data
public class Idea60020Config {
    private String name = "idea_060020";
 ...
 */
@Slf4j
public class Idea60020Service {
    private static final int IDEA_ID = 60020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60020Service() {
        this(new Idea60020Config());
    }

    public Idea60020Service(Idea60020Config config) {
        this.config = config != null ? config : new Idea60020Config();
