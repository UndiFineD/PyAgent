...
@Data
public class Idea60115Config {
    private String name = "idea_060115";
 ...
 */
@Slf4j
public class Idea60115Service {
    private static final int IDEA_ID = 60115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60115Service() {
        this(new Idea60115Config());
    }

    public Idea60115Service(Idea60115Config config) {
        this.config = config != null ? config : new Idea60115Config();
