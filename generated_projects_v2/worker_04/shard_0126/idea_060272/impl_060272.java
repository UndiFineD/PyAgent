...
@Data
public class Idea60272Config {
    private String name = "idea_060272";
 ...
 */
@Slf4j
public class Idea60272Service {
    private static final int IDEA_ID = 60272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60272Service() {
        this(new Idea60272Config());
    }

    public Idea60272Service(Idea60272Config config) {
        this.config = config != null ? config : new Idea60272Config();
