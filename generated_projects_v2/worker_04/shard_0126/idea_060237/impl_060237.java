...
@Data
public class Idea60237Config {
    private String name = "idea_060237";
 ...
 */
@Slf4j
public class Idea60237Service {
    private static final int IDEA_ID = 60237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60237Service() {
        this(new Idea60237Config());
    }

    public Idea60237Service(Idea60237Config config) {
        this.config = config != null ? config : new Idea60237Config();
