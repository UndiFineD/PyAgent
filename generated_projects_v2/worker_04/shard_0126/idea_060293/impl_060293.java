...
@Data
public class Idea60293Config {
    private String name = "idea_060293";
 ...
 */
@Slf4j
public class Idea60293Service {
    private static final int IDEA_ID = 60293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60293Service() {
        this(new Idea60293Config());
    }

    public Idea60293Service(Idea60293Config config) {
        this.config = config != null ? config : new Idea60293Config();
