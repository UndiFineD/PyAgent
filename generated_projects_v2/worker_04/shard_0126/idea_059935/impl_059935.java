...
@Data
public class Idea59935Config {
    private String name = "idea_059935";
 ...
 */
@Slf4j
public class Idea59935Service {
    private static final int IDEA_ID = 59935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59935Service() {
        this(new Idea59935Config());
    }

    public Idea59935Service(Idea59935Config config) {
        this.config = config != null ? config : new Idea59935Config();
