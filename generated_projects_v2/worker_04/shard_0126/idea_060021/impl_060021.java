...
@Data
public class Idea60021Config {
    private String name = "idea_060021";
 ...
 */
@Slf4j
public class Idea60021Service {
    private static final int IDEA_ID = 60021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60021Service() {
        this(new Idea60021Config());
    }

    public Idea60021Service(Idea60021Config config) {
        this.config = config != null ? config : new Idea60021Config();
