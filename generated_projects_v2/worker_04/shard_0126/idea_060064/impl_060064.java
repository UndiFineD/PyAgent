...
@Data
public class Idea60064Config {
    private String name = "idea_060064";
 ...
 */
@Slf4j
public class Idea60064Service {
    private static final int IDEA_ID = 60064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60064Service() {
        this(new Idea60064Config());
    }

    public Idea60064Service(Idea60064Config config) {
        this.config = config != null ? config : new Idea60064Config();
