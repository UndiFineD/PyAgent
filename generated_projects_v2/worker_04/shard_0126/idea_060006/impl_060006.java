...
@Data
public class Idea60006Config {
    private String name = "idea_060006";
 ...
 */
@Slf4j
public class Idea60006Service {
    private static final int IDEA_ID = 60006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60006Service() {
        this(new Idea60006Config());
    }

    public Idea60006Service(Idea60006Config config) {
        this.config = config != null ? config : new Idea60006Config();
