...
@Data
public class Idea60321Config {
    private String name = "idea_060321";
 ...
 */
@Slf4j
public class Idea60321Service {
    private static final int IDEA_ID = 60321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60321Service() {
        this(new Idea60321Config());
    }

    public Idea60321Service(Idea60321Config config) {
        this.config = config != null ? config : new Idea60321Config();
