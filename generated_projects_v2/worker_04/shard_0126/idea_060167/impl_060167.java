...
@Data
public class Idea60167Config {
    private String name = "idea_060167";
 ...
 */
@Slf4j
public class Idea60167Service {
    private static final int IDEA_ID = 60167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60167Service() {
        this(new Idea60167Config());
    }

    public Idea60167Service(Idea60167Config config) {
        this.config = config != null ? config : new Idea60167Config();
