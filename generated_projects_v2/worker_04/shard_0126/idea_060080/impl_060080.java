...
@Data
public class Idea60080Config {
    private String name = "idea_060080";
 ...
 */
@Slf4j
public class Idea60080Service {
    private static final int IDEA_ID = 60080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60080Service() {
        this(new Idea60080Config());
    }

    public Idea60080Service(Idea60080Config config) {
        this.config = config != null ? config : new Idea60080Config();
