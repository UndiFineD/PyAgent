...
@Data
public class Idea60323Config {
    private String name = "idea_060323";
 ...
 */
@Slf4j
public class Idea60323Service {
    private static final int IDEA_ID = 60323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60323Service() {
        this(new Idea60323Config());
    }

    public Idea60323Service(Idea60323Config config) {
        this.config = config != null ? config : new Idea60323Config();
