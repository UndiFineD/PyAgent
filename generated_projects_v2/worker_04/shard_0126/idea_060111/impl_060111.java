...
@Data
public class Idea60111Config {
    private String name = "idea_060111";
 ...
 */
@Slf4j
public class Idea60111Service {
    private static final int IDEA_ID = 60111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60111Service() {
        this(new Idea60111Config());
    }

    public Idea60111Service(Idea60111Config config) {
        this.config = config != null ? config : new Idea60111Config();
