...
@Data
public class Idea60016Config {
    private String name = "idea_060016";
 ...
 */
@Slf4j
public class Idea60016Service {
    private static final int IDEA_ID = 60016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60016Service() {
        this(new Idea60016Config());
    }

    public Idea60016Service(Idea60016Config config) {
        this.config = config != null ? config : new Idea60016Config();
