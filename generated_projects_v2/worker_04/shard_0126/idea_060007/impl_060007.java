...
@Data
public class Idea60007Config {
    private String name = "idea_060007";
 ...
 */
@Slf4j
public class Idea60007Service {
    private static final int IDEA_ID = 60007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60007Service() {
        this(new Idea60007Config());
    }

    public Idea60007Service(Idea60007Config config) {
        this.config = config != null ? config : new Idea60007Config();
