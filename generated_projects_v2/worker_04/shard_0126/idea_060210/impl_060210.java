...
@Data
public class Idea60210Config {
    private String name = "idea_060210";
 ...
 */
@Slf4j
public class Idea60210Service {
    private static final int IDEA_ID = 60210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60210Service() {
        this(new Idea60210Config());
    }

    public Idea60210Service(Idea60210Config config) {
        this.config = config != null ? config : new Idea60210Config();
