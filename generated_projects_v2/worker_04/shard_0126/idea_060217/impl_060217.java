...
@Data
public class Idea60217Config {
    private String name = "idea_060217";
 ...
 */
@Slf4j
public class Idea60217Service {
    private static final int IDEA_ID = 60217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60217Service() {
        this(new Idea60217Config());
    }

    public Idea60217Service(Idea60217Config config) {
        this.config = config != null ? config : new Idea60217Config();
