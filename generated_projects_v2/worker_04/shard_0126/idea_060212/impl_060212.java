...
@Data
public class Idea60212Config {
    private String name = "idea_060212";
 ...
 */
@Slf4j
public class Idea60212Service {
    private static final int IDEA_ID = 60212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60212Service() {
        this(new Idea60212Config());
    }

    public Idea60212Service(Idea60212Config config) {
        this.config = config != null ? config : new Idea60212Config();
