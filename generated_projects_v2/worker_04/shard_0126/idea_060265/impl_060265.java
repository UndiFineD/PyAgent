...
@Data
public class Idea60265Config {
    private String name = "idea_060265";
 ...
 */
@Slf4j
public class Idea60265Service {
    private static final int IDEA_ID = 60265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60265Service() {
        this(new Idea60265Config());
    }

    public Idea60265Service(Idea60265Config config) {
        this.config = config != null ? config : new Idea60265Config();
