...
@Data
public class Idea60027Config {
    private String name = "idea_060027";
 ...
 */
@Slf4j
public class Idea60027Service {
    private static final int IDEA_ID = 60027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60027Service() {
        this(new Idea60027Config());
    }

    public Idea60027Service(Idea60027Config config) {
        this.config = config != null ? config : new Idea60027Config();
