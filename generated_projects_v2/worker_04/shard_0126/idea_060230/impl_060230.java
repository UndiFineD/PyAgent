...
@Data
public class Idea60230Config {
    private String name = "idea_060230";
 ...
 */
@Slf4j
public class Idea60230Service {
    private static final int IDEA_ID = 60230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60230Service() {
        this(new Idea60230Config());
    }

    public Idea60230Service(Idea60230Config config) {
        this.config = config != null ? config : new Idea60230Config();
