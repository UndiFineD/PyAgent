...
@Data
public class Idea60268Config {
    private String name = "idea_060268";
 ...
 */
@Slf4j
public class Idea60268Service {
    private static final int IDEA_ID = 60268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60268Service() {
        this(new Idea60268Config());
    }

    public Idea60268Service(Idea60268Config config) {
        this.config = config != null ? config : new Idea60268Config();
