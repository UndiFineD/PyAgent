...
@Data
public class Idea60154Config {
    private String name = "idea_060154";
 ...
 */
@Slf4j
public class Idea60154Service {
    private static final int IDEA_ID = 60154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60154Service() {
        this(new Idea60154Config());
    }

    public Idea60154Service(Idea60154Config config) {
        this.config = config != null ? config : new Idea60154Config();
