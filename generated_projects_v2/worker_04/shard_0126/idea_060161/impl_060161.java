...
@Data
public class Idea60161Config {
    private String name = "idea_060161";
 ...
 */
@Slf4j
public class Idea60161Service {
    private static final int IDEA_ID = 60161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60161Service() {
        this(new Idea60161Config());
    }

    public Idea60161Service(Idea60161Config config) {
        this.config = config != null ? config : new Idea60161Config();
