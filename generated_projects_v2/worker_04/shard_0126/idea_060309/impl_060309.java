...
@Data
public class Idea60309Config {
    private String name = "idea_060309";
 ...
 */
@Slf4j
public class Idea60309Service {
    private static final int IDEA_ID = 60309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60309Service() {
        this(new Idea60309Config());
    }

    public Idea60309Service(Idea60309Config config) {
        this.config = config != null ? config : new Idea60309Config();
