...
@Data
public class Idea60260Config {
    private String name = "idea_060260";
 ...
 */
@Slf4j
public class Idea60260Service {
    private static final int IDEA_ID = 60260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60260Service() {
        this(new Idea60260Config());
    }

    public Idea60260Service(Idea60260Config config) {
        this.config = config != null ? config : new Idea60260Config();
