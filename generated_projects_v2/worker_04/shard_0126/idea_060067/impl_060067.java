...
@Data
public class Idea60067Config {
    private String name = "idea_060067";
 ...
 */
@Slf4j
public class Idea60067Service {
    private static final int IDEA_ID = 60067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60067Service() {
        this(new Idea60067Config());
    }

    public Idea60067Service(Idea60067Config config) {
        this.config = config != null ? config : new Idea60067Config();
