...
@Data
public class Idea60196Config {
    private String name = "idea_060196";
 ...
 */
@Slf4j
public class Idea60196Service {
    private static final int IDEA_ID = 60196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea60196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea60196Service() {
        this(new Idea60196Config());
    }

    public Idea60196Service(Idea60196Config config) {
        this.config = config != null ? config : new Idea60196Config();
