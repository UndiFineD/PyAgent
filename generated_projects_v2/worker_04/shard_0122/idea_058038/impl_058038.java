...
@Data
public class Idea58038Config {
    private String name = "idea_058038";
 ...
 */
@Slf4j
public class Idea58038Service {
    private static final int IDEA_ID = 58038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58038Service() {
        this(new Idea58038Config());
    }

    public Idea58038Service(Idea58038Config config) {
        this.config = config != null ? config : new Idea58038Config();
