...
@Data
public class Idea58341Config {
    private String name = "idea_058341";
 ...
 */
@Slf4j
public class Idea58341Service {
    private static final int IDEA_ID = 58341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58341Service() {
        this(new Idea58341Config());
    }

    public Idea58341Service(Idea58341Config config) {
        this.config = config != null ? config : new Idea58341Config();
