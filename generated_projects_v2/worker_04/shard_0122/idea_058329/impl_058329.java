...
@Data
public class Idea58329Config {
    private String name = "idea_058329";
 ...
 */
@Slf4j
public class Idea58329Service {
    private static final int IDEA_ID = 58329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58329Service() {
        this(new Idea58329Config());
    }

    public Idea58329Service(Idea58329Config config) {
        this.config = config != null ? config : new Idea58329Config();
