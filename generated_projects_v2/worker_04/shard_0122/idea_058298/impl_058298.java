...
@Data
public class Idea58298Config {
    private String name = "idea_058298";
 ...
 */
@Slf4j
public class Idea58298Service {
    private static final int IDEA_ID = 58298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58298Service() {
        this(new Idea58298Config());
    }

    public Idea58298Service(Idea58298Config config) {
        this.config = config != null ? config : new Idea58298Config();
