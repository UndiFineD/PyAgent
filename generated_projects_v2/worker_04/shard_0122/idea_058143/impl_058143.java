...
@Data
public class Idea58143Config {
    private String name = "idea_058143";
 ...
 */
@Slf4j
public class Idea58143Service {
    private static final int IDEA_ID = 58143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58143Service() {
        this(new Idea58143Config());
    }

    public Idea58143Service(Idea58143Config config) {
        this.config = config != null ? config : new Idea58143Config();
