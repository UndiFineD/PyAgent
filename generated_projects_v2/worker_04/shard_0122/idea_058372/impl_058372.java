...
@Data
public class Idea58372Config {
    private String name = "idea_058372";
 ...
 */
@Slf4j
public class Idea58372Service {
    private static final int IDEA_ID = 58372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58372Service() {
        this(new Idea58372Config());
    }

    public Idea58372Service(Idea58372Config config) {
        this.config = config != null ? config : new Idea58372Config();
