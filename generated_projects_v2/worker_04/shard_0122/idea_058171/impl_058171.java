...
@Data
public class Idea58171Config {
    private String name = "idea_058171";
 ...
 */
@Slf4j
public class Idea58171Service {
    private static final int IDEA_ID = 58171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58171Service() {
        this(new Idea58171Config());
    }

    public Idea58171Service(Idea58171Config config) {
        this.config = config != null ? config : new Idea58171Config();
