...
@Data
public class Idea57985Config {
    private String name = "idea_057985";
 ...
 */
@Slf4j
public class Idea57985Service {
    private static final int IDEA_ID = 57985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57985Service() {
        this(new Idea57985Config());
    }

    public Idea57985Service(Idea57985Config config) {
        this.config = config != null ? config : new Idea57985Config();
