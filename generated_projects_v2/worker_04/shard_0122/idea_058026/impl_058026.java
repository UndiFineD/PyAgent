...
@Data
public class Idea58026Config {
    private String name = "idea_058026";
 ...
 */
@Slf4j
public class Idea58026Service {
    private static final int IDEA_ID = 58026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58026Service() {
        this(new Idea58026Config());
    }

    public Idea58026Service(Idea58026Config config) {
        this.config = config != null ? config : new Idea58026Config();
