...
@Data
public class Idea58262Config {
    private String name = "idea_058262";
 ...
 */
@Slf4j
public class Idea58262Service {
    private static final int IDEA_ID = 58262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58262Service() {
        this(new Idea58262Config());
    }

    public Idea58262Service(Idea58262Config config) {
        this.config = config != null ? config : new Idea58262Config();
