...
@Data
public class Idea58122Config {
    private String name = "idea_058122";
 ...
 */
@Slf4j
public class Idea58122Service {
    private static final int IDEA_ID = 58122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58122Service() {
        this(new Idea58122Config());
    }

    public Idea58122Service(Idea58122Config config) {
        this.config = config != null ? config : new Idea58122Config();
