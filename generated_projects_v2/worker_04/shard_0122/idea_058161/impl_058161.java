...
@Data
public class Idea58161Config {
    private String name = "idea_058161";
 ...
 */
@Slf4j
public class Idea58161Service {
    private static final int IDEA_ID = 58161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58161Service() {
        this(new Idea58161Config());
    }

    public Idea58161Service(Idea58161Config config) {
        this.config = config != null ? config : new Idea58161Config();
