...
@Data
public class Idea58415Config {
    private String name = "idea_058415";
 ...
 */
@Slf4j
public class Idea58415Service {
    private static final int IDEA_ID = 58415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58415Service() {
        this(new Idea58415Config());
    }

    public Idea58415Service(Idea58415Config config) {
        this.config = config != null ? config : new Idea58415Config();
