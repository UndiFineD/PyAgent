...
@Data
public class Idea58000Config {
    private String name = "idea_058000";
 ...
 */
@Slf4j
public class Idea58000Service {
    private static final int IDEA_ID = 58000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58000Service() {
        this(new Idea58000Config());
    }

    public Idea58000Service(Idea58000Config config) {
        this.config = config != null ? config : new Idea58000Config();
