...
@Data
public class Idea58274Config {
    private String name = "idea_058274";
 ...
 */
@Slf4j
public class Idea58274Service {
    private static final int IDEA_ID = 58274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58274Service() {
        this(new Idea58274Config());
    }

    public Idea58274Service(Idea58274Config config) {
        this.config = config != null ? config : new Idea58274Config();
