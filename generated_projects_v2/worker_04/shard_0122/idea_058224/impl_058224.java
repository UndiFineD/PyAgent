...
@Data
public class Idea58224Config {
    private String name = "idea_058224";
 ...
 */
@Slf4j
public class Idea58224Service {
    private static final int IDEA_ID = 58224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58224Service() {
        this(new Idea58224Config());
    }

    public Idea58224Service(Idea58224Config config) {
        this.config = config != null ? config : new Idea58224Config();
