...
@Data
public class Idea58129Config {
    private String name = "idea_058129";
 ...
 */
@Slf4j
public class Idea58129Service {
    private static final int IDEA_ID = 58129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58129Service() {
        this(new Idea58129Config());
    }

    public Idea58129Service(Idea58129Config config) {
        this.config = config != null ? config : new Idea58129Config();
