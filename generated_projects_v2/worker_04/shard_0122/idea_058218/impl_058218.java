...
@Data
public class Idea58218Config {
    private String name = "idea_058218";
 ...
 */
@Slf4j
public class Idea58218Service {
    private static final int IDEA_ID = 58218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58218Service() {
        this(new Idea58218Config());
    }

    public Idea58218Service(Idea58218Config config) {
        this.config = config != null ? config : new Idea58218Config();
