...
@Data
public class Idea58233Config {
    private String name = "idea_058233";
 ...
 */
@Slf4j
public class Idea58233Service {
    private static final int IDEA_ID = 58233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58233Service() {
        this(new Idea58233Config());
    }

    public Idea58233Service(Idea58233Config config) {
        this.config = config != null ? config : new Idea58233Config();
