...
@Data
public class Idea58325Config {
    private String name = "idea_058325";
 ...
 */
@Slf4j
public class Idea58325Service {
    private static final int IDEA_ID = 58325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58325Service() {
        this(new Idea58325Config());
    }

    public Idea58325Service(Idea58325Config config) {
        this.config = config != null ? config : new Idea58325Config();
