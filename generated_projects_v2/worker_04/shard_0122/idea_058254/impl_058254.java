...
@Data
public class Idea58254Config {
    private String name = "idea_058254";
 ...
 */
@Slf4j
public class Idea58254Service {
    private static final int IDEA_ID = 58254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58254Service() {
        this(new Idea58254Config());
    }

    public Idea58254Service(Idea58254Config config) {
        this.config = config != null ? config : new Idea58254Config();
