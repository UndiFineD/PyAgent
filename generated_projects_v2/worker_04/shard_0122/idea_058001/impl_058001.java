...
@Data
public class Idea58001Config {
    private String name = "idea_058001";
 ...
 */
@Slf4j
public class Idea58001Service {
    private static final int IDEA_ID = 58001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58001Service() {
        this(new Idea58001Config());
    }

    public Idea58001Service(Idea58001Config config) {
        this.config = config != null ? config : new Idea58001Config();
