...
@Data
public class Idea58193Config {
    private String name = "idea_058193";
 ...
 */
@Slf4j
public class Idea58193Service {
    private static final int IDEA_ID = 58193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58193Service() {
        this(new Idea58193Config());
    }

    public Idea58193Service(Idea58193Config config) {
        this.config = config != null ? config : new Idea58193Config();
