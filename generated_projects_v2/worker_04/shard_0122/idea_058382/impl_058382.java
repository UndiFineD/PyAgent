...
@Data
public class Idea58382Config {
    private String name = "idea_058382";
 ...
 */
@Slf4j
public class Idea58382Service {
    private static final int IDEA_ID = 58382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58382Service() {
        this(new Idea58382Config());
    }

    public Idea58382Service(Idea58382Config config) {
        this.config = config != null ? config : new Idea58382Config();
