...
@Data
public class Idea58364Config {
    private String name = "idea_058364";
 ...
 */
@Slf4j
public class Idea58364Service {
    private static final int IDEA_ID = 58364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58364Service() {
        this(new Idea58364Config());
    }

    public Idea58364Service(Idea58364Config config) {
        this.config = config != null ? config : new Idea58364Config();
