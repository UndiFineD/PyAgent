...
@Data
public class Idea58253Config {
    private String name = "idea_058253";
 ...
 */
@Slf4j
public class Idea58253Service {
    private static final int IDEA_ID = 58253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58253Service() {
        this(new Idea58253Config());
    }

    public Idea58253Service(Idea58253Config config) {
        this.config = config != null ? config : new Idea58253Config();
