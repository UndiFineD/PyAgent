...
@Data
public class Idea57973Config {
    private String name = "idea_057973";
 ...
 */
@Slf4j
public class Idea57973Service {
    private static final int IDEA_ID = 57973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57973Service() {
        this(new Idea57973Config());
    }

    public Idea57973Service(Idea57973Config config) {
        this.config = config != null ? config : new Idea57973Config();
