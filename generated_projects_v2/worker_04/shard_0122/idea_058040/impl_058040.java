...
@Data
public class Idea58040Config {
    private String name = "idea_058040";
 ...
 */
@Slf4j
public class Idea58040Service {
    private static final int IDEA_ID = 58040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58040Service() {
        this(new Idea58040Config());
    }

    public Idea58040Service(Idea58040Config config) {
        this.config = config != null ? config : new Idea58040Config();
