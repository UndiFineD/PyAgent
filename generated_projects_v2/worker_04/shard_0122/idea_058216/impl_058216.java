...
@Data
public class Idea58216Config {
    private String name = "idea_058216";
 ...
 */
@Slf4j
public class Idea58216Service {
    private static final int IDEA_ID = 58216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58216Service() {
        this(new Idea58216Config());
    }

    public Idea58216Service(Idea58216Config config) {
        this.config = config != null ? config : new Idea58216Config();
