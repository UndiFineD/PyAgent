...
@Data
public class Idea58299Config {
    private String name = "idea_058299";
 ...
 */
@Slf4j
public class Idea58299Service {
    private static final int IDEA_ID = 58299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58299Service() {
        this(new Idea58299Config());
    }

    public Idea58299Service(Idea58299Config config) {
        this.config = config != null ? config : new Idea58299Config();
