...
@Data
public class Idea58018Config {
    private String name = "idea_058018";
 ...
 */
@Slf4j
public class Idea58018Service {
    private static final int IDEA_ID = 58018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58018Service() {
        this(new Idea58018Config());
    }

    public Idea58018Service(Idea58018Config config) {
        this.config = config != null ? config : new Idea58018Config();
