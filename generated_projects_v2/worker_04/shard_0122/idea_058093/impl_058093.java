...
@Data
public class Idea58093Config {
    private String name = "idea_058093";
 ...
 */
@Slf4j
public class Idea58093Service {
    private static final int IDEA_ID = 58093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58093Service() {
        this(new Idea58093Config());
    }

    public Idea58093Service(Idea58093Config config) {
        this.config = config != null ? config : new Idea58093Config();
