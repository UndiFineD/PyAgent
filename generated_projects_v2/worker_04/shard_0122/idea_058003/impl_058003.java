...
@Data
public class Idea58003Config {
    private String name = "idea_058003";
 ...
 */
@Slf4j
public class Idea58003Service {
    private static final int IDEA_ID = 58003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58003Service() {
        this(new Idea58003Config());
    }

    public Idea58003Service(Idea58003Config config) {
        this.config = config != null ? config : new Idea58003Config();
