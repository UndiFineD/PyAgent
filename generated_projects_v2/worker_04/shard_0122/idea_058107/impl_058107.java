...
@Data
public class Idea58107Config {
    private String name = "idea_058107";
 ...
 */
@Slf4j
public class Idea58107Service {
    private static final int IDEA_ID = 58107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58107Service() {
        this(new Idea58107Config());
    }

    public Idea58107Service(Idea58107Config config) {
        this.config = config != null ? config : new Idea58107Config();
