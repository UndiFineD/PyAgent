...
@Data
public class Idea58398Config {
    private String name = "idea_058398";
 ...
 */
@Slf4j
public class Idea58398Service {
    private static final int IDEA_ID = 58398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58398Service() {
        this(new Idea58398Config());
    }

    public Idea58398Service(Idea58398Config config) {
        this.config = config != null ? config : new Idea58398Config();
