...
@Data
public class Idea58313Config {
    private String name = "idea_058313";
 ...
 */
@Slf4j
public class Idea58313Service {
    private static final int IDEA_ID = 58313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58313Service() {
        this(new Idea58313Config());
    }

    public Idea58313Service(Idea58313Config config) {
        this.config = config != null ? config : new Idea58313Config();
