...
@Data
public class Idea58012Config {
    private String name = "idea_058012";
 ...
 */
@Slf4j
public class Idea58012Service {
    private static final int IDEA_ID = 58012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58012Service() {
        this(new Idea58012Config());
    }

    public Idea58012Service(Idea58012Config config) {
        this.config = config != null ? config : new Idea58012Config();
