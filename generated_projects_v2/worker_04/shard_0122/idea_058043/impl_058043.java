...
@Data
public class Idea58043Config {
    private String name = "idea_058043";
 ...
 */
@Slf4j
public class Idea58043Service {
    private static final int IDEA_ID = 58043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58043Service() {
        this(new Idea58043Config());
    }

    public Idea58043Service(Idea58043Config config) {
        this.config = config != null ? config : new Idea58043Config();
