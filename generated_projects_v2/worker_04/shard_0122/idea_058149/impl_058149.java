...
@Data
public class Idea58149Config {
    private String name = "idea_058149";
 ...
 */
@Slf4j
public class Idea58149Service {
    private static final int IDEA_ID = 58149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58149Service() {
        this(new Idea58149Config());
    }

    public Idea58149Service(Idea58149Config config) {
        this.config = config != null ? config : new Idea58149Config();
