...
@Data
public class Idea58057Config {
    private String name = "idea_058057";
 ...
 */
@Slf4j
public class Idea58057Service {
    private static final int IDEA_ID = 58057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58057Service() {
        this(new Idea58057Config());
    }

    public Idea58057Service(Idea58057Config config) {
        this.config = config != null ? config : new Idea58057Config();
