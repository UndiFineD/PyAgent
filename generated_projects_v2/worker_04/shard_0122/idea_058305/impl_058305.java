...
@Data
public class Idea58305Config {
    private String name = "idea_058305";
 ...
 */
@Slf4j
public class Idea58305Service {
    private static final int IDEA_ID = 58305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58305Service() {
        this(new Idea58305Config());
    }

    public Idea58305Service(Idea58305Config config) {
        this.config = config != null ? config : new Idea58305Config();
