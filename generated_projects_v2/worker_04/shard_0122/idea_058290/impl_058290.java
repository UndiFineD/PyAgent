...
@Data
public class Idea58290Config {
    private String name = "idea_058290";
 ...
 */
@Slf4j
public class Idea58290Service {
    private static final int IDEA_ID = 58290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58290Service() {
        this(new Idea58290Config());
    }

    public Idea58290Service(Idea58290Config config) {
        this.config = config != null ? config : new Idea58290Config();
