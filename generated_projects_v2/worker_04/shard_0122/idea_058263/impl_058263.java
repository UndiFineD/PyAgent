...
@Data
public class Idea58263Config {
    private String name = "idea_058263";
 ...
 */
@Slf4j
public class Idea58263Service {
    private static final int IDEA_ID = 58263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58263Service() {
        this(new Idea58263Config());
    }

    public Idea58263Service(Idea58263Config config) {
        this.config = config != null ? config : new Idea58263Config();
