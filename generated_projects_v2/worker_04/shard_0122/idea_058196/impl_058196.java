...
@Data
public class Idea58196Config {
    private String name = "idea_058196";
 ...
 */
@Slf4j
public class Idea58196Service {
    private static final int IDEA_ID = 58196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58196Service() {
        this(new Idea58196Config());
    }

    public Idea58196Service(Idea58196Config config) {
        this.config = config != null ? config : new Idea58196Config();
