...
@Data
public class Idea58241Config {
    private String name = "idea_058241";
 ...
 */
@Slf4j
public class Idea58241Service {
    private static final int IDEA_ID = 58241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58241Service() {
        this(new Idea58241Config());
    }

    public Idea58241Service(Idea58241Config config) {
        this.config = config != null ? config : new Idea58241Config();
