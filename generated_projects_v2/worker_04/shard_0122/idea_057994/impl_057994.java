...
@Data
public class Idea57994Config {
    private String name = "idea_057994";
 ...
 */
@Slf4j
public class Idea57994Service {
    private static final int IDEA_ID = 57994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57994Service() {
        this(new Idea57994Config());
    }

    public Idea57994Service(Idea57994Config config) {
        this.config = config != null ? config : new Idea57994Config();
