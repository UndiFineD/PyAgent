...
@Data
public class Idea58061Config {
    private String name = "idea_058061";
 ...
 */
@Slf4j
public class Idea58061Service {
    private static final int IDEA_ID = 58061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58061Service() {
        this(new Idea58061Config());
    }

    public Idea58061Service(Idea58061Config config) {
        this.config = config != null ? config : new Idea58061Config();
