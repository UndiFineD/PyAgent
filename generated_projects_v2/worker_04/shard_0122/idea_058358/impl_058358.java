...
@Data
public class Idea58358Config {
    private String name = "idea_058358";
 ...
 */
@Slf4j
public class Idea58358Service {
    private static final int IDEA_ID = 58358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58358Service() {
        this(new Idea58358Config());
    }

    public Idea58358Service(Idea58358Config config) {
        this.config = config != null ? config : new Idea58358Config();
