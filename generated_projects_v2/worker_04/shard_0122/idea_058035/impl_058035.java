...
@Data
public class Idea58035Config {
    private String name = "idea_058035";
 ...
 */
@Slf4j
public class Idea58035Service {
    private static final int IDEA_ID = 58035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58035Service() {
        this(new Idea58035Config());
    }

    public Idea58035Service(Idea58035Config config) {
        this.config = config != null ? config : new Idea58035Config();
