...
@Data
public class Idea58283Config {
    private String name = "idea_058283";
 ...
 */
@Slf4j
public class Idea58283Service {
    private static final int IDEA_ID = 58283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58283Service() {
        this(new Idea58283Config());
    }

    public Idea58283Service(Idea58283Config config) {
        this.config = config != null ? config : new Idea58283Config();
