...
@Data
public class Idea58135Config {
    private String name = "idea_058135";
 ...
 */
@Slf4j
public class Idea58135Service {
    private static final int IDEA_ID = 58135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58135Service() {
        this(new Idea58135Config());
    }

    public Idea58135Service(Idea58135Config config) {
        this.config = config != null ? config : new Idea58135Config();
