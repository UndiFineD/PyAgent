...
@Data
public class Idea58158Config {
    private String name = "idea_058158";
 ...
 */
@Slf4j
public class Idea58158Service {
    private static final int IDEA_ID = 58158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58158Service() {
        this(new Idea58158Config());
    }

    public Idea58158Service(Idea58158Config config) {
        this.config = config != null ? config : new Idea58158Config();
