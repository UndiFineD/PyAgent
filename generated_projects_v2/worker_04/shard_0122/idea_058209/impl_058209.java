...
@Data
public class Idea58209Config {
    private String name = "idea_058209";
 ...
 */
@Slf4j
public class Idea58209Service {
    private static final int IDEA_ID = 58209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58209Service() {
        this(new Idea58209Config());
    }

    public Idea58209Service(Idea58209Config config) {
        this.config = config != null ? config : new Idea58209Config();
