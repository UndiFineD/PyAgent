...
@Data
public class Idea58198Config {
    private String name = "idea_058198";
 ...
 */
@Slf4j
public class Idea58198Service {
    private static final int IDEA_ID = 58198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58198Service() {
        this(new Idea58198Config());
    }

    public Idea58198Service(Idea58198Config config) {
        this.config = config != null ? config : new Idea58198Config();
