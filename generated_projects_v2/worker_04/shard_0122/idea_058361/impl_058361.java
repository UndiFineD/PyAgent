...
@Data
public class Idea58361Config {
    private String name = "idea_058361";
 ...
 */
@Slf4j
public class Idea58361Service {
    private static final int IDEA_ID = 58361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58361Service() {
        this(new Idea58361Config());
    }

    public Idea58361Service(Idea58361Config config) {
        this.config = config != null ? config : new Idea58361Config();
