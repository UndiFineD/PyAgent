...
@Data
public class Idea58330Config {
    private String name = "idea_058330";
 ...
 */
@Slf4j
public class Idea58330Service {
    private static final int IDEA_ID = 58330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58330Service() {
        this(new Idea58330Config());
    }

    public Idea58330Service(Idea58330Config config) {
        this.config = config != null ? config : new Idea58330Config();
