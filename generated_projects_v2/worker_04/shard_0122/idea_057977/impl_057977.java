...
@Data
public class Idea57977Config {
    private String name = "idea_057977";
 ...
 */
@Slf4j
public class Idea57977Service {
    private static final int IDEA_ID = 57977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57977Service() {
        this(new Idea57977Config());
    }

    public Idea57977Service(Idea57977Config config) {
        this.config = config != null ? config : new Idea57977Config();
