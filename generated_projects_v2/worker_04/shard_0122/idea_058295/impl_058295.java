...
@Data
public class Idea58295Config {
    private String name = "idea_058295";
 ...
 */
@Slf4j
public class Idea58295Service {
    private static final int IDEA_ID = 58295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58295Service() {
        this(new Idea58295Config());
    }

    public Idea58295Service(Idea58295Config config) {
        this.config = config != null ? config : new Idea58295Config();
