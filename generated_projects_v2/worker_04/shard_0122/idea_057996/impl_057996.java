...
@Data
public class Idea57996Config {
    private String name = "idea_057996";
 ...
 */
@Slf4j
public class Idea57996Service {
    private static final int IDEA_ID = 57996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57996Service() {
        this(new Idea57996Config());
    }

    public Idea57996Service(Idea57996Config config) {
        this.config = config != null ? config : new Idea57996Config();
