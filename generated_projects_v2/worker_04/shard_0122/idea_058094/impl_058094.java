...
@Data
public class Idea58094Config {
    private String name = "idea_058094";
 ...
 */
@Slf4j
public class Idea58094Service {
    private static final int IDEA_ID = 58094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58094Service() {
        this(new Idea58094Config());
    }

    public Idea58094Service(Idea58094Config config) {
        this.config = config != null ? config : new Idea58094Config();
