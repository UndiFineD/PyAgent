...
@Data
public class Idea58393Config {
    private String name = "idea_058393";
 ...
 */
@Slf4j
public class Idea58393Service {
    private static final int IDEA_ID = 58393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58393Service() {
        this(new Idea58393Config());
    }

    public Idea58393Service(Idea58393Config config) {
        this.config = config != null ? config : new Idea58393Config();
