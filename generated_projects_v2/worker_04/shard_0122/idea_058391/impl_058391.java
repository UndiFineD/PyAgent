...
@Data
public class Idea58391Config {
    private String name = "idea_058391";
 ...
 */
@Slf4j
public class Idea58391Service {
    private static final int IDEA_ID = 58391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58391Service() {
        this(new Idea58391Config());
    }

    public Idea58391Service(Idea58391Config config) {
        this.config = config != null ? config : new Idea58391Config();
