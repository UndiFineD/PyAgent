...
@Data
public class Idea57961Config {
    private String name = "idea_057961";
 ...
 */
@Slf4j
public class Idea57961Service {
    private static final int IDEA_ID = 57961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57961Service() {
        this(new Idea57961Config());
    }

    public Idea57961Service(Idea57961Config config) {
        this.config = config != null ? config : new Idea57961Config();
