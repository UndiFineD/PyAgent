...
@Data
public class Idea58403Config {
    private String name = "idea_058403";
 ...
 */
@Slf4j
public class Idea58403Service {
    private static final int IDEA_ID = 58403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58403Service() {
        this(new Idea58403Config());
    }

    public Idea58403Service(Idea58403Config config) {
        this.config = config != null ? config : new Idea58403Config();
