...
@Data
public class Idea58103Config {
    private String name = "idea_058103";
 ...
 */
@Slf4j
public class Idea58103Service {
    private static final int IDEA_ID = 58103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58103Service() {
        this(new Idea58103Config());
    }

    public Idea58103Service(Idea58103Config config) {
        this.config = config != null ? config : new Idea58103Config();
