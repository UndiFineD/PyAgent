...
@Data
public class Idea58362Config {
    private String name = "idea_058362";
 ...
 */
@Slf4j
public class Idea58362Service {
    private static final int IDEA_ID = 58362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58362Service() {
        this(new Idea58362Config());
    }

    public Idea58362Service(Idea58362Config config) {
        this.config = config != null ? config : new Idea58362Config();
