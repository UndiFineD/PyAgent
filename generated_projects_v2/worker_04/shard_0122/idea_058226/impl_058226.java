...
@Data
public class Idea58226Config {
    private String name = "idea_058226";
 ...
 */
@Slf4j
public class Idea58226Service {
    private static final int IDEA_ID = 58226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58226Service() {
        this(new Idea58226Config());
    }

    public Idea58226Service(Idea58226Config config) {
        this.config = config != null ? config : new Idea58226Config();
