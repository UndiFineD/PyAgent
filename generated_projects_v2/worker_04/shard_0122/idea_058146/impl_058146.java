...
@Data
public class Idea58146Config {
    private String name = "idea_058146";
 ...
 */
@Slf4j
public class Idea58146Service {
    private static final int IDEA_ID = 58146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58146Service() {
        this(new Idea58146Config());
    }

    public Idea58146Service(Idea58146Config config) {
        this.config = config != null ? config : new Idea58146Config();
