...
@Data
public class Idea58041Config {
    private String name = "idea_058041";
 ...
 */
@Slf4j
public class Idea58041Service {
    private static final int IDEA_ID = 58041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58041Service() {
        this(new Idea58041Config());
    }

    public Idea58041Service(Idea58041Config config) {
        this.config = config != null ? config : new Idea58041Config();
