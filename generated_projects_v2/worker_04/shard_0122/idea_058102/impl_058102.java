...
@Data
public class Idea58102Config {
    private String name = "idea_058102";
 ...
 */
@Slf4j
public class Idea58102Service {
    private static final int IDEA_ID = 58102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58102Service() {
        this(new Idea58102Config());
    }

    public Idea58102Service(Idea58102Config config) {
        this.config = config != null ? config : new Idea58102Config();
