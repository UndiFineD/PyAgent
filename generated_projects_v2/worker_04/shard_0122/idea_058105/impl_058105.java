...
@Data
public class Idea58105Config {
    private String name = "idea_058105";
 ...
 */
@Slf4j
public class Idea58105Service {
    private static final int IDEA_ID = 58105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58105Service() {
        this(new Idea58105Config());
    }

    public Idea58105Service(Idea58105Config config) {
        this.config = config != null ? config : new Idea58105Config();
