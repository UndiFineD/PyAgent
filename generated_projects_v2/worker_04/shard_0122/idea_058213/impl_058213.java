...
@Data
public class Idea58213Config {
    private String name = "idea_058213";
 ...
 */
@Slf4j
public class Idea58213Service {
    private static final int IDEA_ID = 58213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58213Service() {
        this(new Idea58213Config());
    }

    public Idea58213Service(Idea58213Config config) {
        this.config = config != null ? config : new Idea58213Config();
