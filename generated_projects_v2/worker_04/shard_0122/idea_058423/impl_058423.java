...
@Data
public class Idea58423Config {
    private String name = "idea_058423";
 ...
 */
@Slf4j
public class Idea58423Service {
    private static final int IDEA_ID = 58423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58423Service() {
        this(new Idea58423Config());
    }

    public Idea58423Service(Idea58423Config config) {
        this.config = config != null ? config : new Idea58423Config();
