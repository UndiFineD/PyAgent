...
@Data
public class Idea58401Config {
    private String name = "idea_058401";
 ...
 */
@Slf4j
public class Idea58401Service {
    private static final int IDEA_ID = 58401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58401Service() {
        this(new Idea58401Config());
    }

    public Idea58401Service(Idea58401Config config) {
        this.config = config != null ? config : new Idea58401Config();
