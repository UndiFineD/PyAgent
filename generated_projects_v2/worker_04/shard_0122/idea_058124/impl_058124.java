...
@Data
public class Idea58124Config {
    private String name = "idea_058124";
 ...
 */
@Slf4j
public class Idea58124Service {
    private static final int IDEA_ID = 58124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58124Service() {
        this(new Idea58124Config());
    }

    public Idea58124Service(Idea58124Config config) {
        this.config = config != null ? config : new Idea58124Config();
