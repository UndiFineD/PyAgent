...
@Data
public class Idea58378Config {
    private String name = "idea_058378";
 ...
 */
@Slf4j
public class Idea58378Service {
    private static final int IDEA_ID = 58378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58378Service() {
        this(new Idea58378Config());
    }

    public Idea58378Service(Idea58378Config config) {
        this.config = config != null ? config : new Idea58378Config();
