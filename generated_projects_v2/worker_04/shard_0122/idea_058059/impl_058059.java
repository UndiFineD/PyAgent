...
@Data
public class Idea58059Config {
    private String name = "idea_058059";
 ...
 */
@Slf4j
public class Idea58059Service {
    private static final int IDEA_ID = 58059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58059Service() {
        this(new Idea58059Config());
    }

    public Idea58059Service(Idea58059Config config) {
        this.config = config != null ? config : new Idea58059Config();
