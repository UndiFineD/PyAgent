...
@Data
public class Idea58285Config {
    private String name = "idea_058285";
 ...
 */
@Slf4j
public class Idea58285Service {
    private static final int IDEA_ID = 58285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58285Service() {
        this(new Idea58285Config());
    }

    public Idea58285Service(Idea58285Config config) {
        this.config = config != null ? config : new Idea58285Config();
