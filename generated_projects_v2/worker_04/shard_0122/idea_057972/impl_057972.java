...
@Data
public class Idea57972Config {
    private String name = "idea_057972";
 ...
 */
@Slf4j
public class Idea57972Service {
    private static final int IDEA_ID = 57972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57972Service() {
        this(new Idea57972Config());
    }

    public Idea57972Service(Idea57972Config config) {
        this.config = config != null ? config : new Idea57972Config();
