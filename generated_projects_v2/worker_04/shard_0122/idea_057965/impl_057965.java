...
@Data
public class Idea57965Config {
    private String name = "idea_057965";
 ...
 */
@Slf4j
public class Idea57965Service {
    private static final int IDEA_ID = 57965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57965Service() {
        this(new Idea57965Config());
    }

    public Idea57965Service(Idea57965Config config) {
        this.config = config != null ? config : new Idea57965Config();
