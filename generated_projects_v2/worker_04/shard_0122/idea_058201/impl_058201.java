...
@Data
public class Idea58201Config {
    private String name = "idea_058201";
 ...
 */
@Slf4j
public class Idea58201Service {
    private static final int IDEA_ID = 58201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58201Service() {
        this(new Idea58201Config());
    }

    public Idea58201Service(Idea58201Config config) {
        this.config = config != null ? config : new Idea58201Config();
