...
@Data
public class Idea58350Config {
    private String name = "idea_058350";
 ...
 */
@Slf4j
public class Idea58350Service {
    private static final int IDEA_ID = 58350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58350Service() {
        this(new Idea58350Config());
    }

    public Idea58350Service(Idea58350Config config) {
        this.config = config != null ? config : new Idea58350Config();
