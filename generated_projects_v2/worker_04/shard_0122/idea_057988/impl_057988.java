...
@Data
public class Idea57988Config {
    private String name = "idea_057988";
 ...
 */
@Slf4j
public class Idea57988Service {
    private static final int IDEA_ID = 57988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57988Service() {
        this(new Idea57988Config());
    }

    public Idea57988Service(Idea57988Config config) {
        this.config = config != null ? config : new Idea57988Config();
