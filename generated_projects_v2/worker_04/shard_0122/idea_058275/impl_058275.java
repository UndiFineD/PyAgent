...
@Data
public class Idea58275Config {
    private String name = "idea_058275";
 ...
 */
@Slf4j
public class Idea58275Service {
    private static final int IDEA_ID = 58275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58275Service() {
        this(new Idea58275Config());
    }

    public Idea58275Service(Idea58275Config config) {
        this.config = config != null ? config : new Idea58275Config();
