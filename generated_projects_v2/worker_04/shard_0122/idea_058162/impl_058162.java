...
@Data
public class Idea58162Config {
    private String name = "idea_058162";
 ...
 */
@Slf4j
public class Idea58162Service {
    private static final int IDEA_ID = 58162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58162Service() {
        this(new Idea58162Config());
    }

    public Idea58162Service(Idea58162Config config) {
        this.config = config != null ? config : new Idea58162Config();
