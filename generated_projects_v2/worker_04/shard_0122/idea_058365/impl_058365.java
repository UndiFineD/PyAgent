...
@Data
public class Idea58365Config {
    private String name = "idea_058365";
 ...
 */
@Slf4j
public class Idea58365Service {
    private static final int IDEA_ID = 58365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58365Service() {
        this(new Idea58365Config());
    }

    public Idea58365Service(Idea58365Config config) {
        this.config = config != null ? config : new Idea58365Config();
