...
@Data
public class Idea58172Config {
    private String name = "idea_058172";
 ...
 */
@Slf4j
public class Idea58172Service {
    private static final int IDEA_ID = 58172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58172Service() {
        this(new Idea58172Config());
    }

    public Idea58172Service(Idea58172Config config) {
        this.config = config != null ? config : new Idea58172Config();
