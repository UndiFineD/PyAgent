...
@Data
public class Idea58395Config {
    private String name = "idea_058395";
 ...
 */
@Slf4j
public class Idea58395Service {
    private static final int IDEA_ID = 58395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58395Service() {
        this(new Idea58395Config());
    }

    public Idea58395Service(Idea58395Config config) {
        this.config = config != null ? config : new Idea58395Config();
