...
@Data
public class Idea57997Config {
    private String name = "idea_057997";
 ...
 */
@Slf4j
public class Idea57997Service {
    private static final int IDEA_ID = 57997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57997Service() {
        this(new Idea57997Config());
    }

    public Idea57997Service(Idea57997Config config) {
        this.config = config != null ? config : new Idea57997Config();
