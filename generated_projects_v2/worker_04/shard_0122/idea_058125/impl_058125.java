...
@Data
public class Idea58125Config {
    private String name = "idea_058125";
 ...
 */
@Slf4j
public class Idea58125Service {
    private static final int IDEA_ID = 58125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58125Service() {
        this(new Idea58125Config());
    }

    public Idea58125Service(Idea58125Config config) {
        this.config = config != null ? config : new Idea58125Config();
