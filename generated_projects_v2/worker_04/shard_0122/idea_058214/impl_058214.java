...
@Data
public class Idea58214Config {
    private String name = "idea_058214";
 ...
 */
@Slf4j
public class Idea58214Service {
    private static final int IDEA_ID = 58214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58214Service() {
        this(new Idea58214Config());
    }

    public Idea58214Service(Idea58214Config config) {
        this.config = config != null ? config : new Idea58214Config();
