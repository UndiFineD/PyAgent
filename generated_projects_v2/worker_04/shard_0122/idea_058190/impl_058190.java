...
@Data
public class Idea58190Config {
    private String name = "idea_058190";
 ...
 */
@Slf4j
public class Idea58190Service {
    private static final int IDEA_ID = 58190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58190Service() {
        this(new Idea58190Config());
    }

    public Idea58190Service(Idea58190Config config) {
        this.config = config != null ? config : new Idea58190Config();
