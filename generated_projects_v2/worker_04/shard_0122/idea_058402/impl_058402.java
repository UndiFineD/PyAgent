...
@Data
public class Idea58402Config {
    private String name = "idea_058402";
 ...
 */
@Slf4j
public class Idea58402Service {
    private static final int IDEA_ID = 58402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58402Service() {
        this(new Idea58402Config());
    }

    public Idea58402Service(Idea58402Config config) {
        this.config = config != null ? config : new Idea58402Config();
