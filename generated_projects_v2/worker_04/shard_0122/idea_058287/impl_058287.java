...
@Data
public class Idea58287Config {
    private String name = "idea_058287";
 ...
 */
@Slf4j
public class Idea58287Service {
    private static final int IDEA_ID = 58287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58287Service() {
        this(new Idea58287Config());
    }

    public Idea58287Service(Idea58287Config config) {
        this.config = config != null ? config : new Idea58287Config();
