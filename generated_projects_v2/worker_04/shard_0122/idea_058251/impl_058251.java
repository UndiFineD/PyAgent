...
@Data
public class Idea58251Config {
    private String name = "idea_058251";
 ...
 */
@Slf4j
public class Idea58251Service {
    private static final int IDEA_ID = 58251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58251Service() {
        this(new Idea58251Config());
    }

    public Idea58251Service(Idea58251Config config) {
        this.config = config != null ? config : new Idea58251Config();
