...
@Data
public class Idea58021Config {
    private String name = "idea_058021";
 ...
 */
@Slf4j
public class Idea58021Service {
    private static final int IDEA_ID = 58021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58021Service() {
        this(new Idea58021Config());
    }

    public Idea58021Service(Idea58021Config config) {
        this.config = config != null ? config : new Idea58021Config();
