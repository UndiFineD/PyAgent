...
@Data
public class Idea58137Config {
    private String name = "idea_058137";
 ...
 */
@Slf4j
public class Idea58137Service {
    private static final int IDEA_ID = 58137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58137Service() {
        this(new Idea58137Config());
    }

    public Idea58137Service(Idea58137Config config) {
        this.config = config != null ? config : new Idea58137Config();
