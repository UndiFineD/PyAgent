...
@Data
public class Idea58408Config {
    private String name = "idea_058408";
 ...
 */
@Slf4j
public class Idea58408Service {
    private static final int IDEA_ID = 58408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58408Service() {
        this(new Idea58408Config());
    }

    public Idea58408Service(Idea58408Config config) {
        this.config = config != null ? config : new Idea58408Config();
