...
@Data
public class Idea58309Config {
    private String name = "idea_058309";
 ...
 */
@Slf4j
public class Idea58309Service {
    private static final int IDEA_ID = 58309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58309Service() {
        this(new Idea58309Config());
    }

    public Idea58309Service(Idea58309Config config) {
        this.config = config != null ? config : new Idea58309Config();
