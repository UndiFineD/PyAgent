...
@Data
public class Idea58348Config {
    private String name = "idea_058348";
 ...
 */
@Slf4j
public class Idea58348Service {
    private static final int IDEA_ID = 58348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58348Service() {
        this(new Idea58348Config());
    }

    public Idea58348Service(Idea58348Config config) {
        this.config = config != null ? config : new Idea58348Config();
