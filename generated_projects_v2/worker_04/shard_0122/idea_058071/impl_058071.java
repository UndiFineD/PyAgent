...
@Data
public class Idea58071Config {
    private String name = "idea_058071";
 ...
 */
@Slf4j
public class Idea58071Service {
    private static final int IDEA_ID = 58071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58071Service() {
        this(new Idea58071Config());
    }

    public Idea58071Service(Idea58071Config config) {
        this.config = config != null ? config : new Idea58071Config();
