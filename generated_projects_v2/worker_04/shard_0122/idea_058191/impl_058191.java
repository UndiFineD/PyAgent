...
@Data
public class Idea58191Config {
    private String name = "idea_058191";
 ...
 */
@Slf4j
public class Idea58191Service {
    private static final int IDEA_ID = 58191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58191Service() {
        this(new Idea58191Config());
    }

    public Idea58191Service(Idea58191Config config) {
        this.config = config != null ? config : new Idea58191Config();
