...
@Data
public class Idea58170Config {
    private String name = "idea_058170";
 ...
 */
@Slf4j
public class Idea58170Service {
    private static final int IDEA_ID = 58170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58170Service() {
        this(new Idea58170Config());
    }

    public Idea58170Service(Idea58170Config config) {
        this.config = config != null ? config : new Idea58170Config();
