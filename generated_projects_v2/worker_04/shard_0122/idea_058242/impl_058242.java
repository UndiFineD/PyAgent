...
@Data
public class Idea58242Config {
    private String name = "idea_058242";
 ...
 */
@Slf4j
public class Idea58242Service {
    private static final int IDEA_ID = 58242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58242Service() {
        this(new Idea58242Config());
    }

    public Idea58242Service(Idea58242Config config) {
        this.config = config != null ? config : new Idea58242Config();
