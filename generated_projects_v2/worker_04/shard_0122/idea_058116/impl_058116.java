...
@Data
public class Idea58116Config {
    private String name = "idea_058116";
 ...
 */
@Slf4j
public class Idea58116Service {
    private static final int IDEA_ID = 58116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58116Service() {
        this(new Idea58116Config());
    }

    public Idea58116Service(Idea58116Config config) {
        this.config = config != null ? config : new Idea58116Config();
