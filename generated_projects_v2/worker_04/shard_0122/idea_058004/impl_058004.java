...
@Data
public class Idea58004Config {
    private String name = "idea_058004";
 ...
 */
@Slf4j
public class Idea58004Service {
    private static final int IDEA_ID = 58004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58004Service() {
        this(new Idea58004Config());
    }

    public Idea58004Service(Idea58004Config config) {
        this.config = config != null ? config : new Idea58004Config();
