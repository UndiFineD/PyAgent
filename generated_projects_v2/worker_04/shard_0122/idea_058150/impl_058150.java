...
@Data
public class Idea58150Config {
    private String name = "idea_058150";
 ...
 */
@Slf4j
public class Idea58150Service {
    private static final int IDEA_ID = 58150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58150Service() {
        this(new Idea58150Config());
    }

    public Idea58150Service(Idea58150Config config) {
        this.config = config != null ? config : new Idea58150Config();
