...
@Data
public class Idea58126Config {
    private String name = "idea_058126";
 ...
 */
@Slf4j
public class Idea58126Service {
    private static final int IDEA_ID = 58126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58126Service() {
        this(new Idea58126Config());
    }

    public Idea58126Service(Idea58126Config config) {
        this.config = config != null ? config : new Idea58126Config();
