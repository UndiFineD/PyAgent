...
@Data
public class Idea58060Config {
    private String name = "idea_058060";
 ...
 */
@Slf4j
public class Idea58060Service {
    private static final int IDEA_ID = 58060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58060Service() {
        this(new Idea58060Config());
    }

    public Idea58060Service(Idea58060Config config) {
        this.config = config != null ? config : new Idea58060Config();
