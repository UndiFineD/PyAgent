...
@Data
public class Idea58113Config {
    private String name = "idea_058113";
 ...
 */
@Slf4j
public class Idea58113Service {
    private static final int IDEA_ID = 58113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58113Service() {
        this(new Idea58113Config());
    }

    public Idea58113Service(Idea58113Config config) {
        this.config = config != null ? config : new Idea58113Config();
