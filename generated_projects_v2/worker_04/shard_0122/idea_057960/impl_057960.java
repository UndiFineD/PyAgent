...
@Data
public class Idea57960Config {
    private String name = "idea_057960";
 ...
 */
@Slf4j
public class Idea57960Service {
    private static final int IDEA_ID = 57960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57960Service() {
        this(new Idea57960Config());
    }

    public Idea57960Service(Idea57960Config config) {
        this.config = config != null ? config : new Idea57960Config();
