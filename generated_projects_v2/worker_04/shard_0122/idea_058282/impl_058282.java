...
@Data
public class Idea58282Config {
    private String name = "idea_058282";
 ...
 */
@Slf4j
public class Idea58282Service {
    private static final int IDEA_ID = 58282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58282Service() {
        this(new Idea58282Config());
    }

    public Idea58282Service(Idea58282Config config) {
        this.config = config != null ? config : new Idea58282Config();
