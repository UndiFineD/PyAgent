...
@Data
public class Idea58272Config {
    private String name = "idea_058272";
 ...
 */
@Slf4j
public class Idea58272Service {
    private static final int IDEA_ID = 58272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58272Service() {
        this(new Idea58272Config());
    }

    public Idea58272Service(Idea58272Config config) {
        this.config = config != null ? config : new Idea58272Config();
