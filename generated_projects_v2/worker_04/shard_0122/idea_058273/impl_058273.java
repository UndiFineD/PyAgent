...
@Data
public class Idea58273Config {
    private String name = "idea_058273";
 ...
 */
@Slf4j
public class Idea58273Service {
    private static final int IDEA_ID = 58273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58273Service() {
        this(new Idea58273Config());
    }

    public Idea58273Service(Idea58273Config config) {
        this.config = config != null ? config : new Idea58273Config();
