...
@Data
public class Idea58320Config {
    private String name = "idea_058320";
 ...
 */
@Slf4j
public class Idea58320Service {
    private static final int IDEA_ID = 58320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58320Service() {
        this(new Idea58320Config());
    }

    public Idea58320Service(Idea58320Config config) {
        this.config = config != null ? config : new Idea58320Config();
