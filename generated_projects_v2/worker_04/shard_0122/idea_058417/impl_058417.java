...
@Data
public class Idea58417Config {
    private String name = "idea_058417";
 ...
 */
@Slf4j
public class Idea58417Service {
    private static final int IDEA_ID = 58417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58417Service() {
        this(new Idea58417Config());
    }

    public Idea58417Service(Idea58417Config config) {
        this.config = config != null ? config : new Idea58417Config();
