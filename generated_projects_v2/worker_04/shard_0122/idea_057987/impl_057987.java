...
@Data
public class Idea57987Config {
    private String name = "idea_057987";
 ...
 */
@Slf4j
public class Idea57987Service {
    private static final int IDEA_ID = 57987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57987Service() {
        this(new Idea57987Config());
    }

    public Idea57987Service(Idea57987Config config) {
        this.config = config != null ? config : new Idea57987Config();
