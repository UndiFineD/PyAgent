...
@Data
public class Idea58042Config {
    private String name = "idea_058042";
 ...
 */
@Slf4j
public class Idea58042Service {
    private static final int IDEA_ID = 58042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58042Service() {
        this(new Idea58042Config());
    }

    public Idea58042Service(Idea58042Config config) {
        this.config = config != null ? config : new Idea58042Config();
