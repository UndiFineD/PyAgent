...
@Data
public class Idea58075Config {
    private String name = "idea_058075";
 ...
 */
@Slf4j
public class Idea58075Service {
    private static final int IDEA_ID = 58075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58075Service() {
        this(new Idea58075Config());
    }

    public Idea58075Service(Idea58075Config config) {
        this.config = config != null ? config : new Idea58075Config();
