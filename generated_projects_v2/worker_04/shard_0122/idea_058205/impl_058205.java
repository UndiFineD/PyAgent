...
@Data
public class Idea58205Config {
    private String name = "idea_058205";
 ...
 */
@Slf4j
public class Idea58205Service {
    private static final int IDEA_ID = 58205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58205Service() {
        this(new Idea58205Config());
    }

    public Idea58205Service(Idea58205Config config) {
        this.config = config != null ? config : new Idea58205Config();
