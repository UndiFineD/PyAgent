...
@Data
public class Idea58010Config {
    private String name = "idea_058010";
 ...
 */
@Slf4j
public class Idea58010Service {
    private static final int IDEA_ID = 58010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58010Service() {
        this(new Idea58010Config());
    }

    public Idea58010Service(Idea58010Config config) {
        this.config = config != null ? config : new Idea58010Config();
