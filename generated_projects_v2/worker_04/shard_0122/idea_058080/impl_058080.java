...
@Data
public class Idea58080Config {
    private String name = "idea_058080";
 ...
 */
@Slf4j
public class Idea58080Service {
    private static final int IDEA_ID = 58080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58080Service() {
        this(new Idea58080Config());
    }

    public Idea58080Service(Idea58080Config config) {
        this.config = config != null ? config : new Idea58080Config();
