...
@Data
public class Idea58217Config {
    private String name = "idea_058217";
 ...
 */
@Slf4j
public class Idea58217Service {
    private static final int IDEA_ID = 58217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58217Service() {
        this(new Idea58217Config());
    }

    public Idea58217Service(Idea58217Config config) {
        this.config = config != null ? config : new Idea58217Config();
