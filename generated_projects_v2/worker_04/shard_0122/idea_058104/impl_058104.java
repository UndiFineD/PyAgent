...
@Data
public class Idea58104Config {
    private String name = "idea_058104";
 ...
 */
@Slf4j
public class Idea58104Service {
    private static final int IDEA_ID = 58104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58104Service() {
        this(new Idea58104Config());
    }

    public Idea58104Service(Idea58104Config config) {
        this.config = config != null ? config : new Idea58104Config();
