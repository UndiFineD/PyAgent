...
@Data
public class Idea58386Config {
    private String name = "idea_058386";
 ...
 */
@Slf4j
public class Idea58386Service {
    private static final int IDEA_ID = 58386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58386Service() {
        this(new Idea58386Config());
    }

    public Idea58386Service(Idea58386Config config) {
        this.config = config != null ? config : new Idea58386Config();
