...
@Data
public class Idea58101Config {
    private String name = "idea_058101";
 ...
 */
@Slf4j
public class Idea58101Service {
    private static final int IDEA_ID = 58101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58101Service() {
        this(new Idea58101Config());
    }

    public Idea58101Service(Idea58101Config config) {
        this.config = config != null ? config : new Idea58101Config();
