...
@Data
public class Idea58024Config {
    private String name = "idea_058024";
 ...
 */
@Slf4j
public class Idea58024Service {
    private static final int IDEA_ID = 58024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58024Service() {
        this(new Idea58024Config());
    }

    public Idea58024Service(Idea58024Config config) {
        this.config = config != null ? config : new Idea58024Config();
