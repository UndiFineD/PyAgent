...
@Data
public class Idea58230Config {
    private String name = "idea_058230";
 ...
 */
@Slf4j
public class Idea58230Service {
    private static final int IDEA_ID = 58230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58230Service() {
        this(new Idea58230Config());
    }

    public Idea58230Service(Idea58230Config config) {
        this.config = config != null ? config : new Idea58230Config();
