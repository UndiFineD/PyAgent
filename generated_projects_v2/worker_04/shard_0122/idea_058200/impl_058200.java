...
@Data
public class Idea58200Config {
    private String name = "idea_058200";
 ...
 */
@Slf4j
public class Idea58200Service {
    private static final int IDEA_ID = 58200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58200Service() {
        this(new Idea58200Config());
    }

    public Idea58200Service(Idea58200Config config) {
        this.config = config != null ? config : new Idea58200Config();
