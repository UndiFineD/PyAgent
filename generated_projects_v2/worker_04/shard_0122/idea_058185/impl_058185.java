...
@Data
public class Idea58185Config {
    private String name = "idea_058185";
 ...
 */
@Slf4j
public class Idea58185Service {
    private static final int IDEA_ID = 58185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58185Service() {
        this(new Idea58185Config());
    }

    public Idea58185Service(Idea58185Config config) {
        this.config = config != null ? config : new Idea58185Config();
