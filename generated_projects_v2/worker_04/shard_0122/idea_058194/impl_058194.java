...
@Data
public class Idea58194Config {
    private String name = "idea_058194";
 ...
 */
@Slf4j
public class Idea58194Service {
    private static final int IDEA_ID = 58194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58194Service() {
        this(new Idea58194Config());
    }

    public Idea58194Service(Idea58194Config config) {
        this.config = config != null ? config : new Idea58194Config();
