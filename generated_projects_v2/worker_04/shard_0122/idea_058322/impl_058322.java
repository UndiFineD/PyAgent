...
@Data
public class Idea58322Config {
    private String name = "idea_058322";
 ...
 */
@Slf4j
public class Idea58322Service {
    private static final int IDEA_ID = 58322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58322Service() {
        this(new Idea58322Config());
    }

    public Idea58322Service(Idea58322Config config) {
        this.config = config != null ? config : new Idea58322Config();
