...
@Data
public class Idea58153Config {
    private String name = "idea_058153";
 ...
 */
@Slf4j
public class Idea58153Service {
    private static final int IDEA_ID = 58153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58153Service() {
        this(new Idea58153Config());
    }

    public Idea58153Service(Idea58153Config config) {
        this.config = config != null ? config : new Idea58153Config();
