...
@Data
public class Idea58375Config {
    private String name = "idea_058375";
 ...
 */
@Slf4j
public class Idea58375Service {
    private static final int IDEA_ID = 58375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58375Service() {
        this(new Idea58375Config());
    }

    public Idea58375Service(Idea58375Config config) {
        this.config = config != null ? config : new Idea58375Config();
