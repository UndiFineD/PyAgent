...
@Data
public class Idea58231Config {
    private String name = "idea_058231";
 ...
 */
@Slf4j
public class Idea58231Service {
    private static final int IDEA_ID = 58231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58231Service() {
        this(new Idea58231Config());
    }

    public Idea58231Service(Idea58231Config config) {
        this.config = config != null ? config : new Idea58231Config();
