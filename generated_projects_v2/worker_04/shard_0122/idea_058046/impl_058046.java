...
@Data
public class Idea58046Config {
    private String name = "idea_058046";
 ...
 */
@Slf4j
public class Idea58046Service {
    private static final int IDEA_ID = 58046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58046Service() {
        this(new Idea58046Config());
    }

    public Idea58046Service(Idea58046Config config) {
        this.config = config != null ? config : new Idea58046Config();
