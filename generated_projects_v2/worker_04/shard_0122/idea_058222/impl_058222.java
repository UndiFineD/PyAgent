...
@Data
public class Idea58222Config {
    private String name = "idea_058222";
 ...
 */
@Slf4j
public class Idea58222Service {
    private static final int IDEA_ID = 58222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58222Service() {
        this(new Idea58222Config());
    }

    public Idea58222Service(Idea58222Config config) {
        this.config = config != null ? config : new Idea58222Config();
