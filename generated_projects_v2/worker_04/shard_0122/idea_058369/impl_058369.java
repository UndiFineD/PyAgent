...
@Data
public class Idea58369Config {
    private String name = "idea_058369";
 ...
 */
@Slf4j
public class Idea58369Service {
    private static final int IDEA_ID = 58369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58369Service() {
        this(new Idea58369Config());
    }

    public Idea58369Service(Idea58369Config config) {
        this.config = config != null ? config : new Idea58369Config();
