...
@Data
public class Idea58327Config {
    private String name = "idea_058327";
 ...
 */
@Slf4j
public class Idea58327Service {
    private static final int IDEA_ID = 58327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58327Service() {
        this(new Idea58327Config());
    }

    public Idea58327Service(Idea58327Config config) {
        this.config = config != null ? config : new Idea58327Config();
