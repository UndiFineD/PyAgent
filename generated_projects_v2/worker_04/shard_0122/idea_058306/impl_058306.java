...
@Data
public class Idea58306Config {
    private String name = "idea_058306";
 ...
 */
@Slf4j
public class Idea58306Service {
    private static final int IDEA_ID = 58306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58306Service() {
        this(new Idea58306Config());
    }

    public Idea58306Service(Idea58306Config config) {
        this.config = config != null ? config : new Idea58306Config();
