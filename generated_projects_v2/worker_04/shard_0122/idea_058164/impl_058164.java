...
@Data
public class Idea58164Config {
    private String name = "idea_058164";
 ...
 */
@Slf4j
public class Idea58164Service {
    private static final int IDEA_ID = 58164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58164Service() {
        this(new Idea58164Config());
    }

    public Idea58164Service(Idea58164Config config) {
        this.config = config != null ? config : new Idea58164Config();
