...
@Data
public class Idea57970Config {
    private String name = "idea_057970";
 ...
 */
@Slf4j
public class Idea57970Service {
    private static final int IDEA_ID = 57970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57970Service() {
        this(new Idea57970Config());
    }

    public Idea57970Service(Idea57970Config config) {
        this.config = config != null ? config : new Idea57970Config();
