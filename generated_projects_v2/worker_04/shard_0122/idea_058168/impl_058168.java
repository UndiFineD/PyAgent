...
@Data
public class Idea58168Config {
    private String name = "idea_058168";
 ...
 */
@Slf4j
public class Idea58168Service {
    private static final int IDEA_ID = 58168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58168Service() {
        this(new Idea58168Config());
    }

    public Idea58168Service(Idea58168Config config) {
        this.config = config != null ? config : new Idea58168Config();
