...
@Data
public class Idea58258Config {
    private String name = "idea_058258";
 ...
 */
@Slf4j
public class Idea58258Service {
    private static final int IDEA_ID = 58258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58258Service() {
        this(new Idea58258Config());
    }

    public Idea58258Service(Idea58258Config config) {
        this.config = config != null ? config : new Idea58258Config();
