...
@Data
public class Idea58017Config {
    private String name = "idea_058017";
 ...
 */
@Slf4j
public class Idea58017Service {
    private static final int IDEA_ID = 58017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58017Service() {
        this(new Idea58017Config());
    }

    public Idea58017Service(Idea58017Config config) {
        this.config = config != null ? config : new Idea58017Config();
