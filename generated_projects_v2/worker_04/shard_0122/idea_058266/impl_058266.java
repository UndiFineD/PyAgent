...
@Data
public class Idea58266Config {
    private String name = "idea_058266";
 ...
 */
@Slf4j
public class Idea58266Service {
    private static final int IDEA_ID = 58266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58266Service() {
        this(new Idea58266Config());
    }

    public Idea58266Service(Idea58266Config config) {
        this.config = config != null ? config : new Idea58266Config();
