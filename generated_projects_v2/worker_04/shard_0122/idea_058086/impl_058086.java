...
@Data
public class Idea58086Config {
    private String name = "idea_058086";
 ...
 */
@Slf4j
public class Idea58086Service {
    private static final int IDEA_ID = 58086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58086Service() {
        this(new Idea58086Config());
    }

    public Idea58086Service(Idea58086Config config) {
        this.config = config != null ? config : new Idea58086Config();
