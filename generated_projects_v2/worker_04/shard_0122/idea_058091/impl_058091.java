...
@Data
public class Idea58091Config {
    private String name = "idea_058091";
 ...
 */
@Slf4j
public class Idea58091Service {
    private static final int IDEA_ID = 58091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58091Service() {
        this(new Idea58091Config());
    }

    public Idea58091Service(Idea58091Config config) {
        this.config = config != null ? config : new Idea58091Config();
