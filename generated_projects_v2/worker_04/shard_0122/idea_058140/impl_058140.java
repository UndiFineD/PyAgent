...
@Data
public class Idea58140Config {
    private String name = "idea_058140";
 ...
 */
@Slf4j
public class Idea58140Service {
    private static final int IDEA_ID = 58140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58140Service() {
        this(new Idea58140Config());
    }

    public Idea58140Service(Idea58140Config config) {
        this.config = config != null ? config : new Idea58140Config();
