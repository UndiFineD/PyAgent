...
@Data
public class Idea58373Config {
    private String name = "idea_058373";
 ...
 */
@Slf4j
public class Idea58373Service {
    private static final int IDEA_ID = 58373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58373Service() {
        this(new Idea58373Config());
    }

    public Idea58373Service(Idea58373Config config) {
        this.config = config != null ? config : new Idea58373Config();
