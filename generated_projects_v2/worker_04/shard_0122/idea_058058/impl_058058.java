...
@Data
public class Idea58058Config {
    private String name = "idea_058058";
 ...
 */
@Slf4j
public class Idea58058Service {
    private static final int IDEA_ID = 58058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58058Service() {
        this(new Idea58058Config());
    }

    public Idea58058Service(Idea58058Config config) {
        this.config = config != null ? config : new Idea58058Config();
