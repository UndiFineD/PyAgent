...
@Data
public class Idea58079Config {
    private String name = "idea_058079";
 ...
 */
@Slf4j
public class Idea58079Service {
    private static final int IDEA_ID = 58079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58079Service() {
        this(new Idea58079Config());
    }

    public Idea58079Service(Idea58079Config config) {
        this.config = config != null ? config : new Idea58079Config();
