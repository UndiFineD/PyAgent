...
@Data
public class Idea58098Config {
    private String name = "idea_058098";
 ...
 */
@Slf4j
public class Idea58098Service {
    private static final int IDEA_ID = 58098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58098Service() {
        this(new Idea58098Config());
    }

    public Idea58098Service(Idea58098Config config) {
        this.config = config != null ? config : new Idea58098Config();
