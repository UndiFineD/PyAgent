...
@Data
public class Idea58284Config {
    private String name = "idea_058284";
 ...
 */
@Slf4j
public class Idea58284Service {
    private static final int IDEA_ID = 58284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58284Service() {
        this(new Idea58284Config());
    }

    public Idea58284Service(Idea58284Config config) {
        this.config = config != null ? config : new Idea58284Config();
