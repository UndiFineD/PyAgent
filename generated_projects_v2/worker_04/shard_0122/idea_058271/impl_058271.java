...
@Data
public class Idea58271Config {
    private String name = "idea_058271";
 ...
 */
@Slf4j
public class Idea58271Service {
    private static final int IDEA_ID = 58271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58271Service() {
        this(new Idea58271Config());
    }

    public Idea58271Service(Idea58271Config config) {
        this.config = config != null ? config : new Idea58271Config();
