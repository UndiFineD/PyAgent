...
@Data
public class Idea58064Config {
    private String name = "idea_058064";
 ...
 */
@Slf4j
public class Idea58064Service {
    private static final int IDEA_ID = 58064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58064Service() {
        this(new Idea58064Config());
    }

    public Idea58064Service(Idea58064Config config) {
        this.config = config != null ? config : new Idea58064Config();
