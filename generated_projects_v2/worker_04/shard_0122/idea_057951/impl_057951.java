...
@Data
public class Idea57951Config {
    private String name = "idea_057951";
 ...
 */
@Slf4j
public class Idea57951Service {
    private static final int IDEA_ID = 57951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57951Service() {
        this(new Idea57951Config());
    }

    public Idea57951Service(Idea57951Config config) {
        this.config = config != null ? config : new Idea57951Config();
