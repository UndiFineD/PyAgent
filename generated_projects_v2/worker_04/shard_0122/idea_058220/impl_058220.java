...
@Data
public class Idea58220Config {
    private String name = "idea_058220";
 ...
 */
@Slf4j
public class Idea58220Service {
    private static final int IDEA_ID = 58220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58220Service() {
        this(new Idea58220Config());
    }

    public Idea58220Service(Idea58220Config config) {
        this.config = config != null ? config : new Idea58220Config();
