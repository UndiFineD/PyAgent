...
@Data
public class Idea58333Config {
    private String name = "idea_058333";
 ...
 */
@Slf4j
public class Idea58333Service {
    private static final int IDEA_ID = 58333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58333Service() {
        this(new Idea58333Config());
    }

    public Idea58333Service(Idea58333Config config) {
        this.config = config != null ? config : new Idea58333Config();
