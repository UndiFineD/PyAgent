...
@Data
public class Idea58311Config {
    private String name = "idea_058311";
 ...
 */
@Slf4j
public class Idea58311Service {
    private static final int IDEA_ID = 58311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58311Service() {
        this(new Idea58311Config());
    }

    public Idea58311Service(Idea58311Config config) {
        this.config = config != null ? config : new Idea58311Config();
