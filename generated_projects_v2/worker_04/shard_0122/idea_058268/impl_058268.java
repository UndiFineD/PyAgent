...
@Data
public class Idea58268Config {
    private String name = "idea_058268";
 ...
 */
@Slf4j
public class Idea58268Service {
    private static final int IDEA_ID = 58268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58268Service() {
        this(new Idea58268Config());
    }

    public Idea58268Service(Idea58268Config config) {
        this.config = config != null ? config : new Idea58268Config();
