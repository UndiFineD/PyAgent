...
@Data
public class Idea58383Config {
    private String name = "idea_058383";
 ...
 */
@Slf4j
public class Idea58383Service {
    private static final int IDEA_ID = 58383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58383Service() {
        this(new Idea58383Config());
    }

    public Idea58383Service(Idea58383Config config) {
        this.config = config != null ? config : new Idea58383Config();
