...
@Data
public class Idea58289Config {
    private String name = "idea_058289";
 ...
 */
@Slf4j
public class Idea58289Service {
    private static final int IDEA_ID = 58289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58289Service() {
        this(new Idea58289Config());
    }

    public Idea58289Service(Idea58289Config config) {
        this.config = config != null ? config : new Idea58289Config();
