...
@Data
public class Idea58118Config {
    private String name = "idea_058118";
 ...
 */
@Slf4j
public class Idea58118Service {
    private static final int IDEA_ID = 58118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58118Service() {
        this(new Idea58118Config());
    }

    public Idea58118Service(Idea58118Config config) {
        this.config = config != null ? config : new Idea58118Config();
