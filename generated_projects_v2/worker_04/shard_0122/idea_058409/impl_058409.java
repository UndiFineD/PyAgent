...
@Data
public class Idea58409Config {
    private String name = "idea_058409";
 ...
 */
@Slf4j
public class Idea58409Service {
    private static final int IDEA_ID = 58409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58409Service() {
        this(new Idea58409Config());
    }

    public Idea58409Service(Idea58409Config config) {
        this.config = config != null ? config : new Idea58409Config();
