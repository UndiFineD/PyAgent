...
@Data
public class Idea58343Config {
    private String name = "idea_058343";
 ...
 */
@Slf4j
public class Idea58343Service {
    private static final int IDEA_ID = 58343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58343Service() {
        this(new Idea58343Config());
    }

    public Idea58343Service(Idea58343Config config) {
        this.config = config != null ? config : new Idea58343Config();
