...
@Data
public class Idea58188Config {
    private String name = "idea_058188";
 ...
 */
@Slf4j
public class Idea58188Service {
    private static final int IDEA_ID = 58188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58188Service() {
        this(new Idea58188Config());
    }

    public Idea58188Service(Idea58188Config config) {
        this.config = config != null ? config : new Idea58188Config();
