...
@Data
public class Idea58261Config {
    private String name = "idea_058261";
 ...
 */
@Slf4j
public class Idea58261Service {
    private static final int IDEA_ID = 58261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58261Service() {
        this(new Idea58261Config());
    }

    public Idea58261Service(Idea58261Config config) {
        this.config = config != null ? config : new Idea58261Config();
