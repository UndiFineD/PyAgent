...
@Data
public class Idea58356Config {
    private String name = "idea_058356";
 ...
 */
@Slf4j
public class Idea58356Service {
    private static final int IDEA_ID = 58356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58356Service() {
        this(new Idea58356Config());
    }

    public Idea58356Service(Idea58356Config config) {
        this.config = config != null ? config : new Idea58356Config();
