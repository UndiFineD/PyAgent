...
@Data
public class Idea58085Config {
    private String name = "idea_058085";
 ...
 */
@Slf4j
public class Idea58085Service {
    private static final int IDEA_ID = 58085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58085Service() {
        this(new Idea58085Config());
    }

    public Idea58085Service(Idea58085Config config) {
        this.config = config != null ? config : new Idea58085Config();
