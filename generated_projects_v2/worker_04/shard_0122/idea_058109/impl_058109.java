...
@Data
public class Idea58109Config {
    private String name = "idea_058109";
 ...
 */
@Slf4j
public class Idea58109Service {
    private static final int IDEA_ID = 58109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58109Service() {
        this(new Idea58109Config());
    }

    public Idea58109Service(Idea58109Config config) {
        this.config = config != null ? config : new Idea58109Config();
