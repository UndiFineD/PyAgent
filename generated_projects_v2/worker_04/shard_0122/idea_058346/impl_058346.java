...
@Data
public class Idea58346Config {
    private String name = "idea_058346";
 ...
 */
@Slf4j
public class Idea58346Service {
    private static final int IDEA_ID = 58346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58346Service() {
        this(new Idea58346Config());
    }

    public Idea58346Service(Idea58346Config config) {
        this.config = config != null ? config : new Idea58346Config();
