...
@Data
public class Idea58411Config {
    private String name = "idea_058411";
 ...
 */
@Slf4j
public class Idea58411Service {
    private static final int IDEA_ID = 58411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58411Service() {
        this(new Idea58411Config());
    }

    public Idea58411Service(Idea58411Config config) {
        this.config = config != null ? config : new Idea58411Config();
