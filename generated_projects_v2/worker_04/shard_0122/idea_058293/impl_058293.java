...
@Data
public class Idea58293Config {
    private String name = "idea_058293";
 ...
 */
@Slf4j
public class Idea58293Service {
    private static final int IDEA_ID = 58293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58293Service() {
        this(new Idea58293Config());
    }

    public Idea58293Service(Idea58293Config config) {
        this.config = config != null ? config : new Idea58293Config();
