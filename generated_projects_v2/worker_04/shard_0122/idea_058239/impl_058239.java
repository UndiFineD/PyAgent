...
@Data
public class Idea58239Config {
    private String name = "idea_058239";
 ...
 */
@Slf4j
public class Idea58239Service {
    private static final int IDEA_ID = 58239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58239Service() {
        this(new Idea58239Config());
    }

    public Idea58239Service(Idea58239Config config) {
        this.config = config != null ? config : new Idea58239Config();
