...
@Data
public class Idea58148Config {
    private String name = "idea_058148";
 ...
 */
@Slf4j
public class Idea58148Service {
    private static final int IDEA_ID = 58148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58148Service() {
        this(new Idea58148Config());
    }

    public Idea58148Service(Idea58148Config config) {
        this.config = config != null ? config : new Idea58148Config();
