...
@Data
public class Idea58002Config {
    private String name = "idea_058002";
 ...
 */
@Slf4j
public class Idea58002Service {
    private static final int IDEA_ID = 58002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58002Service() {
        this(new Idea58002Config());
    }

    public Idea58002Service(Idea58002Config config) {
        this.config = config != null ? config : new Idea58002Config();
