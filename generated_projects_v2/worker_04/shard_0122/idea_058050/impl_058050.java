...
@Data
public class Idea58050Config {
    private String name = "idea_058050";
 ...
 */
@Slf4j
public class Idea58050Service {
    private static final int IDEA_ID = 58050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58050Service() {
        this(new Idea58050Config());
    }

    public Idea58050Service(Idea58050Config config) {
        this.config = config != null ? config : new Idea58050Config();
