...
@Data
public class Idea58099Config {
    private String name = "idea_058099";
 ...
 */
@Slf4j
public class Idea58099Service {
    private static final int IDEA_ID = 58099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58099Service() {
        this(new Idea58099Config());
    }

    public Idea58099Service(Idea58099Config config) {
        this.config = config != null ? config : new Idea58099Config();
