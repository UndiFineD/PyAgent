...
@Data
public class Idea57981Config {
    private String name = "idea_057981";
 ...
 */
@Slf4j
public class Idea57981Service {
    private static final int IDEA_ID = 57981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57981Service() {
        this(new Idea57981Config());
    }

    public Idea57981Service(Idea57981Config config) {
        this.config = config != null ? config : new Idea57981Config();
