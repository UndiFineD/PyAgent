...
@Data
public class Idea58221Config {
    private String name = "idea_058221";
 ...
 */
@Slf4j
public class Idea58221Service {
    private static final int IDEA_ID = 58221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58221Service() {
        this(new Idea58221Config());
    }

    public Idea58221Service(Idea58221Config config) {
        this.config = config != null ? config : new Idea58221Config();
