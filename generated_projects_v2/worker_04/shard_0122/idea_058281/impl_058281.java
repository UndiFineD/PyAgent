...
@Data
public class Idea58281Config {
    private String name = "idea_058281";
 ...
 */
@Slf4j
public class Idea58281Service {
    private static final int IDEA_ID = 58281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58281Service() {
        this(new Idea58281Config());
    }

    public Idea58281Service(Idea58281Config config) {
        this.config = config != null ? config : new Idea58281Config();
