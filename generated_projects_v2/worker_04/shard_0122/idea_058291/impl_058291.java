...
@Data
public class Idea58291Config {
    private String name = "idea_058291";
 ...
 */
@Slf4j
public class Idea58291Service {
    private static final int IDEA_ID = 58291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58291Service() {
        this(new Idea58291Config());
    }

    public Idea58291Service(Idea58291Config config) {
        this.config = config != null ? config : new Idea58291Config();
