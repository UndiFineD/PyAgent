...
@Data
public class Idea58108Config {
    private String name = "idea_058108";
 ...
 */
@Slf4j
public class Idea58108Service {
    private static final int IDEA_ID = 58108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58108Service() {
        this(new Idea58108Config());
    }

    public Idea58108Service(Idea58108Config config) {
        this.config = config != null ? config : new Idea58108Config();
