...
@Data
public class Idea58352Config {
    private String name = "idea_058352";
 ...
 */
@Slf4j
public class Idea58352Service {
    private static final int IDEA_ID = 58352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58352Service() {
        this(new Idea58352Config());
    }

    public Idea58352Service(Idea58352Config config) {
        this.config = config != null ? config : new Idea58352Config();
