...
@Data
public class Idea58204Config {
    private String name = "idea_058204";
 ...
 */
@Slf4j
public class Idea58204Service {
    private static final int IDEA_ID = 58204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58204Service() {
        this(new Idea58204Config());
    }

    public Idea58204Service(Idea58204Config config) {
        this.config = config != null ? config : new Idea58204Config();
