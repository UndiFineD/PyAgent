...
@Data
public class Idea58370Config {
    private String name = "idea_058370";
 ...
 */
@Slf4j
public class Idea58370Service {
    private static final int IDEA_ID = 58370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58370Service() {
        this(new Idea58370Config());
    }

    public Idea58370Service(Idea58370Config config) {
        this.config = config != null ? config : new Idea58370Config();
