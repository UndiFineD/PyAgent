...
@Data
public class Idea58211Config {
    private String name = "idea_058211";
 ...
 */
@Slf4j
public class Idea58211Service {
    private static final int IDEA_ID = 58211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58211Service() {
        this(new Idea58211Config());
    }

    public Idea58211Service(Idea58211Config config) {
        this.config = config != null ? config : new Idea58211Config();
