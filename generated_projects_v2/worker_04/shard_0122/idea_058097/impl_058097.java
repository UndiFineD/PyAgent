...
@Data
public class Idea58097Config {
    private String name = "idea_058097";
 ...
 */
@Slf4j
public class Idea58097Service {
    private static final int IDEA_ID = 58097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58097Service() {
        this(new Idea58097Config());
    }

    public Idea58097Service(Idea58097Config config) {
        this.config = config != null ? config : new Idea58097Config();
