...
@Data
public class Idea58014Config {
    private String name = "idea_058014";
 ...
 */
@Slf4j
public class Idea58014Service {
    private static final int IDEA_ID = 58014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58014Service() {
        this(new Idea58014Config());
    }

    public Idea58014Service(Idea58014Config config) {
        this.config = config != null ? config : new Idea58014Config();
