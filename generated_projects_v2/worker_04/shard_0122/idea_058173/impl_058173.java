...
@Data
public class Idea58173Config {
    private String name = "idea_058173";
 ...
 */
@Slf4j
public class Idea58173Service {
    private static final int IDEA_ID = 58173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58173Service() {
        this(new Idea58173Config());
    }

    public Idea58173Service(Idea58173Config config) {
        this.config = config != null ? config : new Idea58173Config();
