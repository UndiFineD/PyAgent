...
@Data
public class Idea58212Config {
    private String name = "idea_058212";
 ...
 */
@Slf4j
public class Idea58212Service {
    private static final int IDEA_ID = 58212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58212Service() {
        this(new Idea58212Config());
    }

    public Idea58212Service(Idea58212Config config) {
        this.config = config != null ? config : new Idea58212Config();
