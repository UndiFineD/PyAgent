...
@Data
public class Idea58008Config {
    private String name = "idea_058008";
 ...
 */
@Slf4j
public class Idea58008Service {
    private static final int IDEA_ID = 58008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58008Service() {
        this(new Idea58008Config());
    }

    public Idea58008Service(Idea58008Config config) {
        this.config = config != null ? config : new Idea58008Config();
