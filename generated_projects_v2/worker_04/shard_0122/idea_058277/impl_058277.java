...
@Data
public class Idea58277Config {
    private String name = "idea_058277";
 ...
 */
@Slf4j
public class Idea58277Service {
    private static final int IDEA_ID = 58277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58277Service() {
        this(new Idea58277Config());
    }

    public Idea58277Service(Idea58277Config config) {
        this.config = config != null ? config : new Idea58277Config();
