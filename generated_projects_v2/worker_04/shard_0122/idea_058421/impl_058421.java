...
@Data
public class Idea58421Config {
    private String name = "idea_058421";
 ...
 */
@Slf4j
public class Idea58421Service {
    private static final int IDEA_ID = 58421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58421Service() {
        this(new Idea58421Config());
    }

    public Idea58421Service(Idea58421Config config) {
        this.config = config != null ? config : new Idea58421Config();
