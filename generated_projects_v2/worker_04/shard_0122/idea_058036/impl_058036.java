...
@Data
public class Idea58036Config {
    private String name = "idea_058036";
 ...
 */
@Slf4j
public class Idea58036Service {
    private static final int IDEA_ID = 58036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58036Service() {
        this(new Idea58036Config());
    }

    public Idea58036Service(Idea58036Config config) {
        this.config = config != null ? config : new Idea58036Config();
