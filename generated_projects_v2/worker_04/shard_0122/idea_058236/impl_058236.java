...
@Data
public class Idea58236Config {
    private String name = "idea_058236";
 ...
 */
@Slf4j
public class Idea58236Service {
    private static final int IDEA_ID = 58236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58236Service() {
        this(new Idea58236Config());
    }

    public Idea58236Service(Idea58236Config config) {
        this.config = config != null ? config : new Idea58236Config();
