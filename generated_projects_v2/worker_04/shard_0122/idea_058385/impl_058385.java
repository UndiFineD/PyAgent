...
@Data
public class Idea58385Config {
    private String name = "idea_058385";
 ...
 */
@Slf4j
public class Idea58385Service {
    private static final int IDEA_ID = 58385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58385Service() {
        this(new Idea58385Config());
    }

    public Idea58385Service(Idea58385Config config) {
        this.config = config != null ? config : new Idea58385Config();
