...
@Data
public class Idea57989Config {
    private String name = "idea_057989";
 ...
 */
@Slf4j
public class Idea57989Service {
    private static final int IDEA_ID = 57989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57989Service() {
        this(new Idea57989Config());
    }

    public Idea57989Service(Idea57989Config config) {
        this.config = config != null ? config : new Idea57989Config();
