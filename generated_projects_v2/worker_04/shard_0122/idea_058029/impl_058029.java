...
@Data
public class Idea58029Config {
    private String name = "idea_058029";
 ...
 */
@Slf4j
public class Idea58029Service {
    private static final int IDEA_ID = 58029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58029Service() {
        this(new Idea58029Config());
    }

    public Idea58029Service(Idea58029Config config) {
        this.config = config != null ? config : new Idea58029Config();
