...
@Data
public class Idea58307Config {
    private String name = "idea_058307";
 ...
 */
@Slf4j
public class Idea58307Service {
    private static final int IDEA_ID = 58307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58307Service() {
        this(new Idea58307Config());
    }

    public Idea58307Service(Idea58307Config config) {
        this.config = config != null ? config : new Idea58307Config();
