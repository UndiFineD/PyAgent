...
@Data
public class Idea57964Config {
    private String name = "idea_057964";
 ...
 */
@Slf4j
public class Idea57964Service {
    private static final int IDEA_ID = 57964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57964Service() {
        this(new Idea57964Config());
    }

    public Idea57964Service(Idea57964Config config) {
        this.config = config != null ? config : new Idea57964Config();
