...
@Data
public class Idea58151Config {
    private String name = "idea_058151";
 ...
 */
@Slf4j
public class Idea58151Service {
    private static final int IDEA_ID = 58151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58151Service() {
        this(new Idea58151Config());
    }

    public Idea58151Service(Idea58151Config config) {
        this.config = config != null ? config : new Idea58151Config();
