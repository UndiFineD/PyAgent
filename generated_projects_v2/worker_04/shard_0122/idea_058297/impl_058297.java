...
@Data
public class Idea58297Config {
    private String name = "idea_058297";
 ...
 */
@Slf4j
public class Idea58297Service {
    private static final int IDEA_ID = 58297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58297Service() {
        this(new Idea58297Config());
    }

    public Idea58297Service(Idea58297Config config) {
        this.config = config != null ? config : new Idea58297Config();
