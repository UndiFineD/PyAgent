...
@Data
public class Idea58117Config {
    private String name = "idea_058117";
 ...
 */
@Slf4j
public class Idea58117Service {
    private static final int IDEA_ID = 58117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58117Service() {
        this(new Idea58117Config());
    }

    public Idea58117Service(Idea58117Config config) {
        this.config = config != null ? config : new Idea58117Config();
