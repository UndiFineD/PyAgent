...
@Data
public class Idea58165Config {
    private String name = "idea_058165";
 ...
 */
@Slf4j
public class Idea58165Service {
    private static final int IDEA_ID = 58165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58165Service() {
        this(new Idea58165Config());
    }

    public Idea58165Service(Idea58165Config config) {
        this.config = config != null ? config : new Idea58165Config();
