...
@Data
public class Idea58387Config {
    private String name = "idea_058387";
 ...
 */
@Slf4j
public class Idea58387Service {
    private static final int IDEA_ID = 58387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58387Service() {
        this(new Idea58387Config());
    }

    public Idea58387Service(Idea58387Config config) {
        this.config = config != null ? config : new Idea58387Config();
