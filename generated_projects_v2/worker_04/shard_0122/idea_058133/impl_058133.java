...
@Data
public class Idea58133Config {
    private String name = "idea_058133";
 ...
 */
@Slf4j
public class Idea58133Service {
    private static final int IDEA_ID = 58133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea58133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea58133Service() {
        this(new Idea58133Config());
    }

    public Idea58133Service(Idea58133Config config) {
        this.config = config != null ? config : new Idea58133Config();
