...
@Data
public class Idea68378Config {
    private String name = "idea_068378";
 ...
 */
@Slf4j
public class Idea68378Service {
    private static final int IDEA_ID = 68378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68378Service() {
        this(new Idea68378Config());
    }

    public Idea68378Service(Idea68378Config config) {
        this.config = config != null ? config : new Idea68378Config();
