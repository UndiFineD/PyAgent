...
@Data
public class Idea67939Config {
    private String name = "idea_067939";
 ...
 */
@Slf4j
public class Idea67939Service {
    private static final int IDEA_ID = 67939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67939Service() {
        this(new Idea67939Config());
    }

    public Idea67939Service(Idea67939Config config) {
        this.config = config != null ? config : new Idea67939Config();
