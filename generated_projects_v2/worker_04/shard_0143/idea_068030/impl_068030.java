...
@Data
public class Idea68030Config {
    private String name = "idea_068030";
 ...
 */
@Slf4j
public class Idea68030Service {
    private static final int IDEA_ID = 68030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68030Service() {
        this(new Idea68030Config());
    }

    public Idea68030Service(Idea68030Config config) {
        this.config = config != null ? config : new Idea68030Config();
