...
@Data
public class Idea68033Config {
    private String name = "idea_068033";
 ...
 */
@Slf4j
public class Idea68033Service {
    private static final int IDEA_ID = 68033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68033Service() {
        this(new Idea68033Config());
    }

    public Idea68033Service(Idea68033Config config) {
        this.config = config != null ? config : new Idea68033Config();
