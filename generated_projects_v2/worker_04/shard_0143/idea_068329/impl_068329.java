...
@Data
public class Idea68329Config {
    private String name = "idea_068329";
 ...
 */
@Slf4j
public class Idea68329Service {
    private static final int IDEA_ID = 68329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68329Service() {
        this(new Idea68329Config());
    }

    public Idea68329Service(Idea68329Config config) {
        this.config = config != null ? config : new Idea68329Config();
