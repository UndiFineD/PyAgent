...
@Data
public class Idea68036Config {
    private String name = "idea_068036";
 ...
 */
@Slf4j
public class Idea68036Service {
    private static final int IDEA_ID = 68036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68036Service() {
        this(new Idea68036Config());
    }

    public Idea68036Service(Idea68036Config config) {
        this.config = config != null ? config : new Idea68036Config();
