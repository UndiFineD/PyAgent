...
@Data
public class Idea68104Config {
    private String name = "idea_068104";
 ...
 */
@Slf4j
public class Idea68104Service {
    private static final int IDEA_ID = 68104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68104Service() {
        this(new Idea68104Config());
    }

    public Idea68104Service(Idea68104Config config) {
        this.config = config != null ? config : new Idea68104Config();
