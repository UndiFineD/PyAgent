...
@Data
public class Idea68086Config {
    private String name = "idea_068086";
 ...
 */
@Slf4j
public class Idea68086Service {
    private static final int IDEA_ID = 68086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68086Service() {
        this(new Idea68086Config());
    }

    public Idea68086Service(Idea68086Config config) {
        this.config = config != null ? config : new Idea68086Config();
