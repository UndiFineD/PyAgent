...
@Data
public class Idea68025Config {
    private String name = "idea_068025";
 ...
 */
@Slf4j
public class Idea68025Service {
    private static final int IDEA_ID = 68025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68025Service() {
        this(new Idea68025Config());
    }

    public Idea68025Service(Idea68025Config config) {
        this.config = config != null ? config : new Idea68025Config();
