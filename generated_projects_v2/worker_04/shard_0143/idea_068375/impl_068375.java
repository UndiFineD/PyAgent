...
@Data
public class Idea68375Config {
    private String name = "idea_068375";
 ...
 */
@Slf4j
public class Idea68375Service {
    private static final int IDEA_ID = 68375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68375Service() {
        this(new Idea68375Config());
    }

    public Idea68375Service(Idea68375Config config) {
        this.config = config != null ? config : new Idea68375Config();
