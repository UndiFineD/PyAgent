...
@Data
public class Idea68007Config {
    private String name = "idea_068007";
 ...
 */
@Slf4j
public class Idea68007Service {
    private static final int IDEA_ID = 68007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68007Service() {
        this(new Idea68007Config());
    }

    public Idea68007Service(Idea68007Config config) {
        this.config = config != null ? config : new Idea68007Config();
