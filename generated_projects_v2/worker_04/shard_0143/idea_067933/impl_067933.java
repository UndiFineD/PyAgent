...
@Data
public class Idea67933Config {
    private String name = "idea_067933";
 ...
 */
@Slf4j
public class Idea67933Service {
    private static final int IDEA_ID = 67933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67933Service() {
        this(new Idea67933Config());
    }

    public Idea67933Service(Idea67933Config config) {
        this.config = config != null ? config : new Idea67933Config();
