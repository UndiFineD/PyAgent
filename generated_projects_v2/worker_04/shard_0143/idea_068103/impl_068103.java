...
@Data
public class Idea68103Config {
    private String name = "idea_068103";
 ...
 */
@Slf4j
public class Idea68103Service {
    private static final int IDEA_ID = 68103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68103Service() {
        this(new Idea68103Config());
    }

    public Idea68103Service(Idea68103Config config) {
        this.config = config != null ? config : new Idea68103Config();
