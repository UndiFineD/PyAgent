...
@Data
public class Idea68037Config {
    private String name = "idea_068037";
 ...
 */
@Slf4j
public class Idea68037Service {
    private static final int IDEA_ID = 68037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68037Service() {
        this(new Idea68037Config());
    }

    public Idea68037Service(Idea68037Config config) {
        this.config = config != null ? config : new Idea68037Config();
