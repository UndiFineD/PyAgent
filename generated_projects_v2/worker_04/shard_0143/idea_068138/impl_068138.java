...
@Data
public class Idea68138Config {
    private String name = "idea_068138";
 ...
 */
@Slf4j
public class Idea68138Service {
    private static final int IDEA_ID = 68138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68138Service() {
        this(new Idea68138Config());
    }

    public Idea68138Service(Idea68138Config config) {
        this.config = config != null ? config : new Idea68138Config();
