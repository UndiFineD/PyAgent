...
@Data
public class Idea68178Config {
    private String name = "idea_068178";
 ...
 */
@Slf4j
public class Idea68178Service {
    private static final int IDEA_ID = 68178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68178Service() {
        this(new Idea68178Config());
    }

    public Idea68178Service(Idea68178Config config) {
        this.config = config != null ? config : new Idea68178Config();
