...
@Data
public class Idea68100Config {
    private String name = "idea_068100";
 ...
 */
@Slf4j
public class Idea68100Service {
    private static final int IDEA_ID = 68100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68100Service() {
        this(new Idea68100Config());
    }

    public Idea68100Service(Idea68100Config config) {
        this.config = config != null ? config : new Idea68100Config();
