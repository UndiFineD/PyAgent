...
@Data
public class Idea68220Config {
    private String name = "idea_068220";
 ...
 */
@Slf4j
public class Idea68220Service {
    private static final int IDEA_ID = 68220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68220Service() {
        this(new Idea68220Config());
    }

    public Idea68220Service(Idea68220Config config) {
        this.config = config != null ? config : new Idea68220Config();
