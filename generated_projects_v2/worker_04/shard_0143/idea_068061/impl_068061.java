...
@Data
public class Idea68061Config {
    private String name = "idea_068061";
 ...
 */
@Slf4j
public class Idea68061Service {
    private static final int IDEA_ID = 68061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68061Service() {
        this(new Idea68061Config());
    }

    public Idea68061Service(Idea68061Config config) {
        this.config = config != null ? config : new Idea68061Config();
