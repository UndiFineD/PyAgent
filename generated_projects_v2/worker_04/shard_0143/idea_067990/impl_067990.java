...
@Data
public class Idea67990Config {
    private String name = "idea_067990";
 ...
 */
@Slf4j
public class Idea67990Service {
    private static final int IDEA_ID = 67990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67990Service() {
        this(new Idea67990Config());
    }

    public Idea67990Service(Idea67990Config config) {
        this.config = config != null ? config : new Idea67990Config();
