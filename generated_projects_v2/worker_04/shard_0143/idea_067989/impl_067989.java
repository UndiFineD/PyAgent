...
@Data
public class Idea67989Config {
    private String name = "idea_067989";
 ...
 */
@Slf4j
public class Idea67989Service {
    private static final int IDEA_ID = 67989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67989Service() {
        this(new Idea67989Config());
    }

    public Idea67989Service(Idea67989Config config) {
        this.config = config != null ? config : new Idea67989Config();
