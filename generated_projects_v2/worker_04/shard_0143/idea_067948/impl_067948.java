...
@Data
public class Idea67948Config {
    private String name = "idea_067948";
 ...
 */
@Slf4j
public class Idea67948Service {
    private static final int IDEA_ID = 67948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67948Service() {
        this(new Idea67948Config());
    }

    public Idea67948Service(Idea67948Config config) {
        this.config = config != null ? config : new Idea67948Config();
