...
@Data
public class Idea68389Config {
    private String name = "idea_068389";
 ...
 */
@Slf4j
public class Idea68389Service {
    private static final int IDEA_ID = 68389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68389Service() {
        this(new Idea68389Config());
    }

    public Idea68389Service(Idea68389Config config) {
        this.config = config != null ? config : new Idea68389Config();
