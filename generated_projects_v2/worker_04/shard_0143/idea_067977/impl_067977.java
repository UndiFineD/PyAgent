...
@Data
public class Idea67977Config {
    private String name = "idea_067977";
 ...
 */
@Slf4j
public class Idea67977Service {
    private static final int IDEA_ID = 67977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67977Service() {
        this(new Idea67977Config());
    }

    public Idea67977Service(Idea67977Config config) {
        this.config = config != null ? config : new Idea67977Config();
