...
@Data
public class Idea67973Config {
    private String name = "idea_067973";
 ...
 */
@Slf4j
public class Idea67973Service {
    private static final int IDEA_ID = 67973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67973Service() {
        this(new Idea67973Config());
    }

    public Idea67973Service(Idea67973Config config) {
        this.config = config != null ? config : new Idea67973Config();
