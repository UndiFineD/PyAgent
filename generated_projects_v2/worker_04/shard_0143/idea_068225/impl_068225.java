...
@Data
public class Idea68225Config {
    private String name = "idea_068225";
 ...
 */
@Slf4j
public class Idea68225Service {
    private static final int IDEA_ID = 68225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68225Service() {
        this(new Idea68225Config());
    }

    public Idea68225Service(Idea68225Config config) {
        this.config = config != null ? config : new Idea68225Config();
