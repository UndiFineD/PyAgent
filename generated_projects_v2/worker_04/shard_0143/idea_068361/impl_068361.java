...
@Data
public class Idea68361Config {
    private String name = "idea_068361";
 ...
 */
@Slf4j
public class Idea68361Service {
    private static final int IDEA_ID = 68361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68361Service() {
        this(new Idea68361Config());
    }

    public Idea68361Service(Idea68361Config config) {
        this.config = config != null ? config : new Idea68361Config();
