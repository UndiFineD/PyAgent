...
@Data
public class Idea67971Config {
    private String name = "idea_067971";
 ...
 */
@Slf4j
public class Idea67971Service {
    private static final int IDEA_ID = 67971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67971Service() {
        this(new Idea67971Config());
    }

    public Idea67971Service(Idea67971Config config) {
        this.config = config != null ? config : new Idea67971Config();
