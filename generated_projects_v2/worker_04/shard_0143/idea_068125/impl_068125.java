...
@Data
public class Idea68125Config {
    private String name = "idea_068125";
 ...
 */
@Slf4j
public class Idea68125Service {
    private static final int IDEA_ID = 68125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68125Service() {
        this(new Idea68125Config());
    }

    public Idea68125Service(Idea68125Config config) {
        this.config = config != null ? config : new Idea68125Config();
