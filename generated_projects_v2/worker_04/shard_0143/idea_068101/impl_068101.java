...
@Data
public class Idea68101Config {
    private String name = "idea_068101";
 ...
 */
@Slf4j
public class Idea68101Service {
    private static final int IDEA_ID = 68101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68101Service() {
        this(new Idea68101Config());
    }

    public Idea68101Service(Idea68101Config config) {
        this.config = config != null ? config : new Idea68101Config();
