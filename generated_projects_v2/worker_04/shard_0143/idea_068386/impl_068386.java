...
@Data
public class Idea68386Config {
    private String name = "idea_068386";
 ...
 */
@Slf4j
public class Idea68386Service {
    private static final int IDEA_ID = 68386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68386Service() {
        this(new Idea68386Config());
    }

    public Idea68386Service(Idea68386Config config) {
        this.config = config != null ? config : new Idea68386Config();
