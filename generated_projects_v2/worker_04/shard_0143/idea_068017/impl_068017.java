...
@Data
public class Idea68017Config {
    private String name = "idea_068017";
 ...
 */
@Slf4j
public class Idea68017Service {
    private static final int IDEA_ID = 68017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68017Service() {
        this(new Idea68017Config());
    }

    public Idea68017Service(Idea68017Config config) {
        this.config = config != null ? config : new Idea68017Config();
