...
@Data
public class Idea68370Config {
    private String name = "idea_068370";
 ...
 */
@Slf4j
public class Idea68370Service {
    private static final int IDEA_ID = 68370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68370Service() {
        this(new Idea68370Config());
    }

    public Idea68370Service(Idea68370Config config) {
        this.config = config != null ? config : new Idea68370Config();
