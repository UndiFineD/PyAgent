...
@Data
public class Idea68203Config {
    private String name = "idea_068203";
 ...
 */
@Slf4j
public class Idea68203Service {
    private static final int IDEA_ID = 68203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68203Service() {
        this(new Idea68203Config());
    }

    public Idea68203Service(Idea68203Config config) {
        this.config = config != null ? config : new Idea68203Config();
