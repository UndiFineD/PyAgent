...
@Data
public class Idea68027Config {
    private String name = "idea_068027";
 ...
 */
@Slf4j
public class Idea68027Service {
    private static final int IDEA_ID = 68027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68027Service() {
        this(new Idea68027Config());
    }

    public Idea68027Service(Idea68027Config config) {
        this.config = config != null ? config : new Idea68027Config();
