...
@Data
public class Idea67964Config {
    private String name = "idea_067964";
 ...
 */
@Slf4j
public class Idea67964Service {
    private static final int IDEA_ID = 67964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67964Service() {
        this(new Idea67964Config());
    }

    public Idea67964Service(Idea67964Config config) {
        this.config = config != null ? config : new Idea67964Config();
