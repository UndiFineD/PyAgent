...
@Data
public class Idea68384Config {
    private String name = "idea_068384";
 ...
 */
@Slf4j
public class Idea68384Service {
    private static final int IDEA_ID = 68384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68384Service() {
        this(new Idea68384Config());
    }

    public Idea68384Service(Idea68384Config config) {
        this.config = config != null ? config : new Idea68384Config();
