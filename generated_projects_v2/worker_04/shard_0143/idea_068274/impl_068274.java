...
@Data
public class Idea68274Config {
    private String name = "idea_068274";
 ...
 */
@Slf4j
public class Idea68274Service {
    private static final int IDEA_ID = 68274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68274Service() {
        this(new Idea68274Config());
    }

    public Idea68274Service(Idea68274Config config) {
        this.config = config != null ? config : new Idea68274Config();
