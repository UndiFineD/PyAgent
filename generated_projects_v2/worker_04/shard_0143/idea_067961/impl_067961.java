...
@Data
public class Idea67961Config {
    private String name = "idea_067961";
 ...
 */
@Slf4j
public class Idea67961Service {
    private static final int IDEA_ID = 67961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67961Service() {
        this(new Idea67961Config());
    }

    public Idea67961Service(Idea67961Config config) {
        this.config = config != null ? config : new Idea67961Config();
