...
@Data
public class Idea67936Config {
    private String name = "idea_067936";
 ...
 */
@Slf4j
public class Idea67936Service {
    private static final int IDEA_ID = 67936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67936Service() {
        this(new Idea67936Config());
    }

    public Idea67936Service(Idea67936Config config) {
        this.config = config != null ? config : new Idea67936Config();
