...
@Data
public class Idea67976Config {
    private String name = "idea_067976";
 ...
 */
@Slf4j
public class Idea67976Service {
    private static final int IDEA_ID = 67976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67976Service() {
        this(new Idea67976Config());
    }

    public Idea67976Service(Idea67976Config config) {
        this.config = config != null ? config : new Idea67976Config();
