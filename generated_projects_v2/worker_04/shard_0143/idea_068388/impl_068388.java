...
@Data
public class Idea68388Config {
    private String name = "idea_068388";
 ...
 */
@Slf4j
public class Idea68388Service {
    private static final int IDEA_ID = 68388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68388Service() {
        this(new Idea68388Config());
    }

    public Idea68388Service(Idea68388Config config) {
        this.config = config != null ? config : new Idea68388Config();
