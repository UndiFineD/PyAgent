...
@Data
public class Idea67962Config {
    private String name = "idea_067962";
 ...
 */
@Slf4j
public class Idea67962Service {
    private static final int IDEA_ID = 67962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67962Service() {
        this(new Idea67962Config());
    }

    public Idea67962Service(Idea67962Config config) {
        this.config = config != null ? config : new Idea67962Config();
