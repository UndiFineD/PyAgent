...
@Data
public class Idea67967Config {
    private String name = "idea_067967";
 ...
 */
@Slf4j
public class Idea67967Service {
    private static final int IDEA_ID = 67967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67967Service() {
        this(new Idea67967Config());
    }

    public Idea67967Service(Idea67967Config config) {
        this.config = config != null ? config : new Idea67967Config();
