...
@Data
public class Idea67935Config {
    private String name = "idea_067935";
 ...
 */
@Slf4j
public class Idea67935Service {
    private static final int IDEA_ID = 67935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67935Service() {
        this(new Idea67935Config());
    }

    public Idea67935Service(Idea67935Config config) {
        this.config = config != null ? config : new Idea67935Config();
