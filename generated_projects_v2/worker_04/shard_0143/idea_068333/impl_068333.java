...
@Data
public class Idea68333Config {
    private String name = "idea_068333";
 ...
 */
@Slf4j
public class Idea68333Service {
    private static final int IDEA_ID = 68333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68333Service() {
        this(new Idea68333Config());
    }

    public Idea68333Service(Idea68333Config config) {
        this.config = config != null ? config : new Idea68333Config();
