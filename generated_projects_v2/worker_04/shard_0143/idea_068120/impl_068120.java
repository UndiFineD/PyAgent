...
@Data
public class Idea68120Config {
    private String name = "idea_068120";
 ...
 */
@Slf4j
public class Idea68120Service {
    private static final int IDEA_ID = 68120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68120Service() {
        this(new Idea68120Config());
    }

    public Idea68120Service(Idea68120Config config) {
        this.config = config != null ? config : new Idea68120Config();
