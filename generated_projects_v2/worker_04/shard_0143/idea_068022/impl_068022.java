...
@Data
public class Idea68022Config {
    private String name = "idea_068022";
 ...
 */
@Slf4j
public class Idea68022Service {
    private static final int IDEA_ID = 68022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68022Service() {
        this(new Idea68022Config());
    }

    public Idea68022Service(Idea68022Config config) {
        this.config = config != null ? config : new Idea68022Config();
