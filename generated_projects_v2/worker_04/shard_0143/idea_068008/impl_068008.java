...
@Data
public class Idea68008Config {
    private String name = "idea_068008";
 ...
 */
@Slf4j
public class Idea68008Service {
    private static final int IDEA_ID = 68008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68008Service() {
        this(new Idea68008Config());
    }

    public Idea68008Service(Idea68008Config config) {
        this.config = config != null ? config : new Idea68008Config();
