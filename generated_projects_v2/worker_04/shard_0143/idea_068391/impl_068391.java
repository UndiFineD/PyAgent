...
@Data
public class Idea68391Config {
    private String name = "idea_068391";
 ...
 */
@Slf4j
public class Idea68391Service {
    private static final int IDEA_ID = 68391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68391Service() {
        this(new Idea68391Config());
    }

    public Idea68391Service(Idea68391Config config) {
        this.config = config != null ? config : new Idea68391Config();
