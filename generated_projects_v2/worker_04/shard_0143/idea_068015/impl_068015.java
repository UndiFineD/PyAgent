...
@Data
public class Idea68015Config {
    private String name = "idea_068015";
 ...
 */
@Slf4j
public class Idea68015Service {
    private static final int IDEA_ID = 68015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68015Service() {
        this(new Idea68015Config());
    }

    public Idea68015Service(Idea68015Config config) {
        this.config = config != null ? config : new Idea68015Config();
