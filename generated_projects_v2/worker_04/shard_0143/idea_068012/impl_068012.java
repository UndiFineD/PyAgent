...
@Data
public class Idea68012Config {
    private String name = "idea_068012";
 ...
 */
@Slf4j
public class Idea68012Service {
    private static final int IDEA_ID = 68012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68012Service() {
        this(new Idea68012Config());
    }

    public Idea68012Service(Idea68012Config config) {
        this.config = config != null ? config : new Idea68012Config();
