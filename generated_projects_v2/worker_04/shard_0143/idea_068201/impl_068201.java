...
@Data
public class Idea68201Config {
    private String name = "idea_068201";
 ...
 */
@Slf4j
public class Idea68201Service {
    private static final int IDEA_ID = 68201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68201Service() {
        this(new Idea68201Config());
    }

    public Idea68201Service(Idea68201Config config) {
        this.config = config != null ? config : new Idea68201Config();
