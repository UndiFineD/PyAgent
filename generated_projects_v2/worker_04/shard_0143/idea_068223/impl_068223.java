...
@Data
public class Idea68223Config {
    private String name = "idea_068223";
 ...
 */
@Slf4j
public class Idea68223Service {
    private static final int IDEA_ID = 68223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68223Service() {
        this(new Idea68223Config());
    }

    public Idea68223Service(Idea68223Config config) {
        this.config = config != null ? config : new Idea68223Config();
