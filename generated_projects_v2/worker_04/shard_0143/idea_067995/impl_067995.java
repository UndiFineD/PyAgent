...
@Data
public class Idea67995Config {
    private String name = "idea_067995";
 ...
 */
@Slf4j
public class Idea67995Service {
    private static final int IDEA_ID = 67995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67995Service() {
        this(new Idea67995Config());
    }

    public Idea67995Service(Idea67995Config config) {
        this.config = config != null ? config : new Idea67995Config();
