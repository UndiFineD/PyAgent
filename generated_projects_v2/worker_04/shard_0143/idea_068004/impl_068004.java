...
@Data
public class Idea68004Config {
    private String name = "idea_068004";
 ...
 */
@Slf4j
public class Idea68004Service {
    private static final int IDEA_ID = 68004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68004Service() {
        this(new Idea68004Config());
    }

    public Idea68004Service(Idea68004Config config) {
        this.config = config != null ? config : new Idea68004Config();
