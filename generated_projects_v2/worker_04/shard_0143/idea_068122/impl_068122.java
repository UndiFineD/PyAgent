...
@Data
public class Idea68122Config {
    private String name = "idea_068122";
 ...
 */
@Slf4j
public class Idea68122Service {
    private static final int IDEA_ID = 68122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68122Service() {
        this(new Idea68122Config());
    }

    public Idea68122Service(Idea68122Config config) {
        this.config = config != null ? config : new Idea68122Config();
