...
@Data
public class Idea68221Config {
    private String name = "idea_068221";
 ...
 */
@Slf4j
public class Idea68221Service {
    private static final int IDEA_ID = 68221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68221Service() {
        this(new Idea68221Config());
    }

    public Idea68221Service(Idea68221Config config) {
        this.config = config != null ? config : new Idea68221Config();
