...
@Data
public class Idea67950Config {
    private String name = "idea_067950";
 ...
 */
@Slf4j
public class Idea67950Service {
    private static final int IDEA_ID = 67950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67950Service() {
        this(new Idea67950Config());
    }

    public Idea67950Service(Idea67950Config config) {
        this.config = config != null ? config : new Idea67950Config();
