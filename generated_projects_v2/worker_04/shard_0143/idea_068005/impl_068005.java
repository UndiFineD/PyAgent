...
@Data
public class Idea68005Config {
    private String name = "idea_068005";
 ...
 */
@Slf4j
public class Idea68005Service {
    private static final int IDEA_ID = 68005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68005Service() {
        this(new Idea68005Config());
    }

    public Idea68005Service(Idea68005Config config) {
        this.config = config != null ? config : new Idea68005Config();
