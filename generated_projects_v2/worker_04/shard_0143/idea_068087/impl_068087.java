...
@Data
public class Idea68087Config {
    private String name = "idea_068087";
 ...
 */
@Slf4j
public class Idea68087Service {
    private static final int IDEA_ID = 68087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68087Service() {
        this(new Idea68087Config());
    }

    public Idea68087Service(Idea68087Config config) {
        this.config = config != null ? config : new Idea68087Config();
