...
@Data
public class Idea68303Config {
    private String name = "idea_068303";
 ...
 */
@Slf4j
public class Idea68303Service {
    private static final int IDEA_ID = 68303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68303Service() {
        this(new Idea68303Config());
    }

    public Idea68303Service(Idea68303Config config) {
        this.config = config != null ? config : new Idea68303Config();
