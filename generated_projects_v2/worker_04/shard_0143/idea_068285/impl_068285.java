...
@Data
public class Idea68285Config {
    private String name = "idea_068285";
 ...
 */
@Slf4j
public class Idea68285Service {
    private static final int IDEA_ID = 68285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68285Service() {
        this(new Idea68285Config());
    }

    public Idea68285Service(Idea68285Config config) {
        this.config = config != null ? config : new Idea68285Config();
