...
@Data
public class Idea68273Config {
    private String name = "idea_068273";
 ...
 */
@Slf4j
public class Idea68273Service {
    private static final int IDEA_ID = 68273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68273Service() {
        this(new Idea68273Config());
    }

    public Idea68273Service(Idea68273Config config) {
        this.config = config != null ? config : new Idea68273Config();
