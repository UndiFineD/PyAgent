...
@Data
public class Idea68106Config {
    private String name = "idea_068106";
 ...
 */
@Slf4j
public class Idea68106Service {
    private static final int IDEA_ID = 68106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68106Service() {
        this(new Idea68106Config());
    }

    public Idea68106Service(Idea68106Config config) {
        this.config = config != null ? config : new Idea68106Config();
