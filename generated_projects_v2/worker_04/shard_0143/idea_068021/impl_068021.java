...
@Data
public class Idea68021Config {
    private String name = "idea_068021";
 ...
 */
@Slf4j
public class Idea68021Service {
    private static final int IDEA_ID = 68021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68021Service() {
        this(new Idea68021Config());
    }

    public Idea68021Service(Idea68021Config config) {
        this.config = config != null ? config : new Idea68021Config();
