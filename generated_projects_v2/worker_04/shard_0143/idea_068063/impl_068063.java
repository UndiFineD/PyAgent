...
@Data
public class Idea68063Config {
    private String name = "idea_068063";
 ...
 */
@Slf4j
public class Idea68063Service {
    private static final int IDEA_ID = 68063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68063Service() {
        this(new Idea68063Config());
    }

    public Idea68063Service(Idea68063Config config) {
        this.config = config != null ? config : new Idea68063Config();
