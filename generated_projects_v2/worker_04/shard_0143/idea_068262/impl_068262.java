...
@Data
public class Idea68262Config {
    private String name = "idea_068262";
 ...
 */
@Slf4j
public class Idea68262Service {
    private static final int IDEA_ID = 68262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68262Service() {
        this(new Idea68262Config());
    }

    public Idea68262Service(Idea68262Config config) {
        this.config = config != null ? config : new Idea68262Config();
