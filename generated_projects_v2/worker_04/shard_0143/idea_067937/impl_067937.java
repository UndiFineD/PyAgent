...
@Data
public class Idea67937Config {
    private String name = "idea_067937";
 ...
 */
@Slf4j
public class Idea67937Service {
    private static final int IDEA_ID = 67937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea67937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea67937Service() {
        this(new Idea67937Config());
    }

    public Idea67937Service(Idea67937Config config) {
        this.config = config != null ? config : new Idea67937Config();
