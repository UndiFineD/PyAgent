...
@Data
public class Idea68000Config {
    private String name = "idea_068000";
 ...
 */
@Slf4j
public class Idea68000Service {
    private static final int IDEA_ID = 68000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea68000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea68000Service() {
        this(new Idea68000Config());
    }

    public Idea68000Service(Idea68000Config config) {
        this.config = config != null ? config : new Idea68000Config();
