...
@Data
public class Idea57597Config {
    private String name = "idea_057597";
 ...
 */
@Slf4j
public class Idea57597Service {
    private static final int IDEA_ID = 57597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57597Service() {
        this(new Idea57597Config());
    }

    public Idea57597Service(Idea57597Config config) {
        this.config = config != null ? config : new Idea57597Config();
