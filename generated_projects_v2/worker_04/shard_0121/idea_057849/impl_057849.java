...
@Data
public class Idea57849Config {
    private String name = "idea_057849";
 ...
 */
@Slf4j
public class Idea57849Service {
    private static final int IDEA_ID = 57849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57849Service() {
        this(new Idea57849Config());
    }

    public Idea57849Service(Idea57849Config config) {
        this.config = config != null ? config : new Idea57849Config();
