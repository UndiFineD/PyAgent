...
@Data
public class Idea57737Config {
    private String name = "idea_057737";
 ...
 */
@Slf4j
public class Idea57737Service {
    private static final int IDEA_ID = 57737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57737Service() {
        this(new Idea57737Config());
    }

    public Idea57737Service(Idea57737Config config) {
        this.config = config != null ? config : new Idea57737Config();
