...
@Data
public class Idea57897Config {
    private String name = "idea_057897";
 ...
 */
@Slf4j
public class Idea57897Service {
    private static final int IDEA_ID = 57897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57897Service() {
        this(new Idea57897Config());
    }

    public Idea57897Service(Idea57897Config config) {
        this.config = config != null ? config : new Idea57897Config();
