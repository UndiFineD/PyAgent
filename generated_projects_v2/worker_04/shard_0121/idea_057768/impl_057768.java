...
@Data
public class Idea57768Config {
    private String name = "idea_057768";
 ...
 */
@Slf4j
public class Idea57768Service {
    private static final int IDEA_ID = 57768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57768Service() {
        this(new Idea57768Config());
    }

    public Idea57768Service(Idea57768Config config) {
        this.config = config != null ? config : new Idea57768Config();
