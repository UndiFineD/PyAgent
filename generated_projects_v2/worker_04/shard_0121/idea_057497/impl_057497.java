...
@Data
public class Idea57497Config {
    private String name = "idea_057497";
 ...
 */
@Slf4j
public class Idea57497Service {
    private static final int IDEA_ID = 57497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57497Service() {
        this(new Idea57497Config());
    }

    public Idea57497Service(Idea57497Config config) {
        this.config = config != null ? config : new Idea57497Config();
