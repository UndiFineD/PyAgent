...
@Data
public class Idea57478Config {
    private String name = "idea_057478";
 ...
 */
@Slf4j
public class Idea57478Service {
    private static final int IDEA_ID = 57478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57478Service() {
        this(new Idea57478Config());
    }

    public Idea57478Service(Idea57478Config config) {
        this.config = config != null ? config : new Idea57478Config();
