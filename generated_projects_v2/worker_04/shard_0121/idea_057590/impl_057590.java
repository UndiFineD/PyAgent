...
@Data
public class Idea57590Config {
    private String name = "idea_057590";
 ...
 */
@Slf4j
public class Idea57590Service {
    private static final int IDEA_ID = 57590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57590Service() {
        this(new Idea57590Config());
    }

    public Idea57590Service(Idea57590Config config) {
        this.config = config != null ? config : new Idea57590Config();
