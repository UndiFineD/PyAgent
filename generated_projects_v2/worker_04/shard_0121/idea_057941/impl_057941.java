...
@Data
public class Idea57941Config {
    private String name = "idea_057941";
 ...
 */
@Slf4j
public class Idea57941Service {
    private static final int IDEA_ID = 57941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57941Service() {
        this(new Idea57941Config());
    }

    public Idea57941Service(Idea57941Config config) {
        this.config = config != null ? config : new Idea57941Config();
