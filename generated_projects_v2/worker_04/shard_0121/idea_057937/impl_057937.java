...
@Data
public class Idea57937Config {
    private String name = "idea_057937";
 ...
 */
@Slf4j
public class Idea57937Service {
    private static final int IDEA_ID = 57937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57937Service() {
        this(new Idea57937Config());
    }

    public Idea57937Service(Idea57937Config config) {
        this.config = config != null ? config : new Idea57937Config();
