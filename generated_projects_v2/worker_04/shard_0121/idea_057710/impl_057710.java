...
@Data
public class Idea57710Config {
    private String name = "idea_057710";
 ...
 */
@Slf4j
public class Idea57710Service {
    private static final int IDEA_ID = 57710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57710Service() {
        this(new Idea57710Config());
    }

    public Idea57710Service(Idea57710Config config) {
        this.config = config != null ? config : new Idea57710Config();
