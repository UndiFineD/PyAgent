...
@Data
public class Idea57857Config {
    private String name = "idea_057857";
 ...
 */
@Slf4j
public class Idea57857Service {
    private static final int IDEA_ID = 57857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57857Service() {
        this(new Idea57857Config());
    }

    public Idea57857Service(Idea57857Config config) {
        this.config = config != null ? config : new Idea57857Config();
