...
@Data
public class Idea57790Config {
    private String name = "idea_057790";
 ...
 */
@Slf4j
public class Idea57790Service {
    private static final int IDEA_ID = 57790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57790Service() {
        this(new Idea57790Config());
    }

    public Idea57790Service(Idea57790Config config) {
        this.config = config != null ? config : new Idea57790Config();
