...
@Data
public class Idea57757Config {
    private String name = "idea_057757";
 ...
 */
@Slf4j
public class Idea57757Service {
    private static final int IDEA_ID = 57757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57757Service() {
        this(new Idea57757Config());
    }

    public Idea57757Service(Idea57757Config config) {
        this.config = config != null ? config : new Idea57757Config();
