...
@Data
public class Idea57505Config {
    private String name = "idea_057505";
 ...
 */
@Slf4j
public class Idea57505Service {
    private static final int IDEA_ID = 57505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57505Service() {
        this(new Idea57505Config());
    }

    public Idea57505Service(Idea57505Config config) {
        this.config = config != null ? config : new Idea57505Config();
