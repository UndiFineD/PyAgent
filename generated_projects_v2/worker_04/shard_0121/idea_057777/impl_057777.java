...
@Data
public class Idea57777Config {
    private String name = "idea_057777";
 ...
 */
@Slf4j
public class Idea57777Service {
    private static final int IDEA_ID = 57777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57777Service() {
        this(new Idea57777Config());
    }

    public Idea57777Service(Idea57777Config config) {
        this.config = config != null ? config : new Idea57777Config();
