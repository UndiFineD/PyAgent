...
@Data
public class Idea57821Config {
    private String name = "idea_057821";
 ...
 */
@Slf4j
public class Idea57821Service {
    private static final int IDEA_ID = 57821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57821Service() {
        this(new Idea57821Config());
    }

    public Idea57821Service(Idea57821Config config) {
        this.config = config != null ? config : new Idea57821Config();
