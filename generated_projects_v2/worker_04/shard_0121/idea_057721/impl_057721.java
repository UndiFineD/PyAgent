...
@Data
public class Idea57721Config {
    private String name = "idea_057721";
 ...
 */
@Slf4j
public class Idea57721Service {
    private static final int IDEA_ID = 57721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57721Service() {
        this(new Idea57721Config());
    }

    public Idea57721Service(Idea57721Config config) {
        this.config = config != null ? config : new Idea57721Config();
