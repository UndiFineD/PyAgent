...
@Data
public class Idea57637Config {
    private String name = "idea_057637";
 ...
 */
@Slf4j
public class Idea57637Service {
    private static final int IDEA_ID = 57637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57637Service() {
        this(new Idea57637Config());
    }

    public Idea57637Service(Idea57637Config config) {
        this.config = config != null ? config : new Idea57637Config();
