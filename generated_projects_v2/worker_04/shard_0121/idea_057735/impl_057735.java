...
@Data
public class Idea57735Config {
    private String name = "idea_057735";
 ...
 */
@Slf4j
public class Idea57735Service {
    private static final int IDEA_ID = 57735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57735Service() {
        this(new Idea57735Config());
    }

    public Idea57735Service(Idea57735Config config) {
        this.config = config != null ? config : new Idea57735Config();
