...
@Data
public class Idea57662Config {
    private String name = "idea_057662";
 ...
 */
@Slf4j
public class Idea57662Service {
    private static final int IDEA_ID = 57662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57662Service() {
        this(new Idea57662Config());
    }

    public Idea57662Service(Idea57662Config config) {
        this.config = config != null ? config : new Idea57662Config();
