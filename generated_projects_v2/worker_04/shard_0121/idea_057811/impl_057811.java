...
@Data
public class Idea57811Config {
    private String name = "idea_057811";
 ...
 */
@Slf4j
public class Idea57811Service {
    private static final int IDEA_ID = 57811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57811Service() {
        this(new Idea57811Config());
    }

    public Idea57811Service(Idea57811Config config) {
        this.config = config != null ? config : new Idea57811Config();
