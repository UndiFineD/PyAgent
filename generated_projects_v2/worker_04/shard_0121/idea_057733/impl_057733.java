...
@Data
public class Idea57733Config {
    private String name = "idea_057733";
 ...
 */
@Slf4j
public class Idea57733Service {
    private static final int IDEA_ID = 57733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57733Service() {
        this(new Idea57733Config());
    }

    public Idea57733Service(Idea57733Config config) {
        this.config = config != null ? config : new Idea57733Config();
