...
@Data
public class Idea57610Config {
    private String name = "idea_057610";
 ...
 */
@Slf4j
public class Idea57610Service {
    private static final int IDEA_ID = 57610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57610Service() {
        this(new Idea57610Config());
    }

    public Idea57610Service(Idea57610Config config) {
        this.config = config != null ? config : new Idea57610Config();
