...
@Data
public class Idea57565Config {
    private String name = "idea_057565";
 ...
 */
@Slf4j
public class Idea57565Service {
    private static final int IDEA_ID = 57565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57565Service() {
        this(new Idea57565Config());
    }

    public Idea57565Service(Idea57565Config config) {
        this.config = config != null ? config : new Idea57565Config();
