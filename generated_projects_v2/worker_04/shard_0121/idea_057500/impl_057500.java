...
@Data
public class Idea57500Config {
    private String name = "idea_057500";
 ...
 */
@Slf4j
public class Idea57500Service {
    private static final int IDEA_ID = 57500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57500Service() {
        this(new Idea57500Config());
    }

    public Idea57500Service(Idea57500Config config) {
        this.config = config != null ? config : new Idea57500Config();
