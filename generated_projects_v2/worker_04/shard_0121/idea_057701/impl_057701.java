...
@Data
public class Idea57701Config {
    private String name = "idea_057701";
 ...
 */
@Slf4j
public class Idea57701Service {
    private static final int IDEA_ID = 57701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57701Service() {
        this(new Idea57701Config());
    }

    public Idea57701Service(Idea57701Config config) {
        this.config = config != null ? config : new Idea57701Config();
