...
@Data
public class Idea57601Config {
    private String name = "idea_057601";
 ...
 */
@Slf4j
public class Idea57601Service {
    private static final int IDEA_ID = 57601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57601Service() {
        this(new Idea57601Config());
    }

    public Idea57601Service(Idea57601Config config) {
        this.config = config != null ? config : new Idea57601Config();
