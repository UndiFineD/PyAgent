...
@Data
public class Idea57883Config {
    private String name = "idea_057883";
 ...
 */
@Slf4j
public class Idea57883Service {
    private static final int IDEA_ID = 57883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57883Service() {
        this(new Idea57883Config());
    }

    public Idea57883Service(Idea57883Config config) {
        this.config = config != null ? config : new Idea57883Config();
