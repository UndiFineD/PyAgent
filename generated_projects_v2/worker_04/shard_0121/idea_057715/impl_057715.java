...
@Data
public class Idea57715Config {
    private String name = "idea_057715";
 ...
 */
@Slf4j
public class Idea57715Service {
    private static final int IDEA_ID = 57715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57715Service() {
        this(new Idea57715Config());
    }

    public Idea57715Service(Idea57715Config config) {
        this.config = config != null ? config : new Idea57715Config();
