...
@Data
public class Idea57764Config {
    private String name = "idea_057764";
 ...
 */
@Slf4j
public class Idea57764Service {
    private static final int IDEA_ID = 57764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57764Service() {
        this(new Idea57764Config());
    }

    public Idea57764Service(Idea57764Config config) {
        this.config = config != null ? config : new Idea57764Config();
