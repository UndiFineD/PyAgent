...
@Data
public class Idea57675Config {
    private String name = "idea_057675";
 ...
 */
@Slf4j
public class Idea57675Service {
    private static final int IDEA_ID = 57675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57675Service() {
        this(new Idea57675Config());
    }

    public Idea57675Service(Idea57675Config config) {
        this.config = config != null ? config : new Idea57675Config();
