...
@Data
public class Idea57636Config {
    private String name = "idea_057636";
 ...
 */
@Slf4j
public class Idea57636Service {
    private static final int IDEA_ID = 57636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57636Service() {
        this(new Idea57636Config());
    }

    public Idea57636Service(Idea57636Config config) {
        this.config = config != null ? config : new Idea57636Config();
