...
@Data
public class Idea57756Config {
    private String name = "idea_057756";
 ...
 */
@Slf4j
public class Idea57756Service {
    private static final int IDEA_ID = 57756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57756Service() {
        this(new Idea57756Config());
    }

    public Idea57756Service(Idea57756Config config) {
        this.config = config != null ? config : new Idea57756Config();
