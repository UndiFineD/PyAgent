...
@Data
public class Idea57911Config {
    private String name = "idea_057911";
 ...
 */
@Slf4j
public class Idea57911Service {
    private static final int IDEA_ID = 57911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57911Service() {
        this(new Idea57911Config());
    }

    public Idea57911Service(Idea57911Config config) {
        this.config = config != null ? config : new Idea57911Config();
