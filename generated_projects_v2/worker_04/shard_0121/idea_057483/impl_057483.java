...
@Data
public class Idea57483Config {
    private String name = "idea_057483";
 ...
 */
@Slf4j
public class Idea57483Service {
    private static final int IDEA_ID = 57483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57483Service() {
        this(new Idea57483Config());
    }

    public Idea57483Service(Idea57483Config config) {
        this.config = config != null ? config : new Idea57483Config();
