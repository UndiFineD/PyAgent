...
@Data
public class Idea57789Config {
    private String name = "idea_057789";
 ...
 */
@Slf4j
public class Idea57789Service {
    private static final int IDEA_ID = 57789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57789Service() {
        this(new Idea57789Config());
    }

    public Idea57789Service(Idea57789Config config) {
        this.config = config != null ? config : new Idea57789Config();
