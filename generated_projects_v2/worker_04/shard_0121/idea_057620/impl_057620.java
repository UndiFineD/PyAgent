...
@Data
public class Idea57620Config {
    private String name = "idea_057620";
 ...
 */
@Slf4j
public class Idea57620Service {
    private static final int IDEA_ID = 57620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57620Service() {
        this(new Idea57620Config());
    }

    public Idea57620Service(Idea57620Config config) {
        this.config = config != null ? config : new Idea57620Config();
