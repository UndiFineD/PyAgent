...
@Data
public class Idea57877Config {
    private String name = "idea_057877";
 ...
 */
@Slf4j
public class Idea57877Service {
    private static final int IDEA_ID = 57877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57877Service() {
        this(new Idea57877Config());
    }

    public Idea57877Service(Idea57877Config config) {
        this.config = config != null ? config : new Idea57877Config();
