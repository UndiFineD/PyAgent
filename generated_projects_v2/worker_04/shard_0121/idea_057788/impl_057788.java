...
@Data
public class Idea57788Config {
    private String name = "idea_057788";
 ...
 */
@Slf4j
public class Idea57788Service {
    private static final int IDEA_ID = 57788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57788Service() {
        this(new Idea57788Config());
    }

    public Idea57788Service(Idea57788Config config) {
        this.config = config != null ? config : new Idea57788Config();
