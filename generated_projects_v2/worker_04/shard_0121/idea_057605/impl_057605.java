...
@Data
public class Idea57605Config {
    private String name = "idea_057605";
 ...
 */
@Slf4j
public class Idea57605Service {
    private static final int IDEA_ID = 57605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57605Service() {
        this(new Idea57605Config());
    }

    public Idea57605Service(Idea57605Config config) {
        this.config = config != null ? config : new Idea57605Config();
