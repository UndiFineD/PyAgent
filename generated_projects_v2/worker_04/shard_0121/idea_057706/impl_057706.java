...
@Data
public class Idea57706Config {
    private String name = "idea_057706";
 ...
 */
@Slf4j
public class Idea57706Service {
    private static final int IDEA_ID = 57706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57706Service() {
        this(new Idea57706Config());
    }

    public Idea57706Service(Idea57706Config config) {
        this.config = config != null ? config : new Idea57706Config();
