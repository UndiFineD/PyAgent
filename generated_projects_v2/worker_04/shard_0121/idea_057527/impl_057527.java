...
@Data
public class Idea57527Config {
    private String name = "idea_057527";
 ...
 */
@Slf4j
public class Idea57527Service {
    private static final int IDEA_ID = 57527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57527Service() {
        this(new Idea57527Config());
    }

    public Idea57527Service(Idea57527Config config) {
        this.config = config != null ? config : new Idea57527Config();
