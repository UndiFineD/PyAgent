...
@Data
public class Idea57651Config {
    private String name = "idea_057651";
 ...
 */
@Slf4j
public class Idea57651Service {
    private static final int IDEA_ID = 57651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57651Service() {
        this(new Idea57651Config());
    }

    public Idea57651Service(Idea57651Config config) {
        this.config = config != null ? config : new Idea57651Config();
