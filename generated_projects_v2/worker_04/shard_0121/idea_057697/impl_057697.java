...
@Data
public class Idea57697Config {
    private String name = "idea_057697";
 ...
 */
@Slf4j
public class Idea57697Service {
    private static final int IDEA_ID = 57697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57697Service() {
        this(new Idea57697Config());
    }

    public Idea57697Service(Idea57697Config config) {
        this.config = config != null ? config : new Idea57697Config();
