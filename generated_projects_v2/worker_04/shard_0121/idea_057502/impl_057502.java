...
@Data
public class Idea57502Config {
    private String name = "idea_057502";
 ...
 */
@Slf4j
public class Idea57502Service {
    private static final int IDEA_ID = 57502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57502Service() {
        this(new Idea57502Config());
    }

    public Idea57502Service(Idea57502Config config) {
        this.config = config != null ? config : new Idea57502Config();
