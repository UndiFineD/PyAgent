...
@Data
public class Idea57631Config {
    private String name = "idea_057631";
 ...
 */
@Slf4j
public class Idea57631Service {
    private static final int IDEA_ID = 57631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57631Service() {
        this(new Idea57631Config());
    }

    public Idea57631Service(Idea57631Config config) {
        this.config = config != null ? config : new Idea57631Config();
