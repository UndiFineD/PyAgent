...
@Data
public class Idea57730Config {
    private String name = "idea_057730";
 ...
 */
@Slf4j
public class Idea57730Service {
    private static final int IDEA_ID = 57730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57730Service() {
        this(new Idea57730Config());
    }

    public Idea57730Service(Idea57730Config config) {
        this.config = config != null ? config : new Idea57730Config();
