...
@Data
public class Idea57560Config {
    private String name = "idea_057560";
 ...
 */
@Slf4j
public class Idea57560Service {
    private static final int IDEA_ID = 57560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57560Service() {
        this(new Idea57560Config());
    }

    public Idea57560Service(Idea57560Config config) {
        this.config = config != null ? config : new Idea57560Config();
