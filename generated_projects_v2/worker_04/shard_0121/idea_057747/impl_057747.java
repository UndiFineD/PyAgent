...
@Data
public class Idea57747Config {
    private String name = "idea_057747";
 ...
 */
@Slf4j
public class Idea57747Service {
    private static final int IDEA_ID = 57747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57747Service() {
        this(new Idea57747Config());
    }

    public Idea57747Service(Idea57747Config config) {
        this.config = config != null ? config : new Idea57747Config();
