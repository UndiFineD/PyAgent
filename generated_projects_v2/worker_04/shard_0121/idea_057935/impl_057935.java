...
@Data
public class Idea57935Config {
    private String name = "idea_057935";
 ...
 */
@Slf4j
public class Idea57935Service {
    private static final int IDEA_ID = 57935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57935Service() {
        this(new Idea57935Config());
    }

    public Idea57935Service(Idea57935Config config) {
        this.config = config != null ? config : new Idea57935Config();
