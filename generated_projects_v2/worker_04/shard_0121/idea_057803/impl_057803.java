...
@Data
public class Idea57803Config {
    private String name = "idea_057803";
 ...
 */
@Slf4j
public class Idea57803Service {
    private static final int IDEA_ID = 57803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57803Service() {
        this(new Idea57803Config());
    }

    public Idea57803Service(Idea57803Config config) {
        this.config = config != null ? config : new Idea57803Config();
