...
@Data
public class Idea57567Config {
    private String name = "idea_057567";
 ...
 */
@Slf4j
public class Idea57567Service {
    private static final int IDEA_ID = 57567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57567Service() {
        this(new Idea57567Config());
    }

    public Idea57567Service(Idea57567Config config) {
        this.config = config != null ? config : new Idea57567Config();
