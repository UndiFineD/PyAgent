...
@Data
public class Idea57822Config {
    private String name = "idea_057822";
 ...
 */
@Slf4j
public class Idea57822Service {
    private static final int IDEA_ID = 57822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57822Service() {
        this(new Idea57822Config());
    }

    public Idea57822Service(Idea57822Config config) {
        this.config = config != null ? config : new Idea57822Config();
