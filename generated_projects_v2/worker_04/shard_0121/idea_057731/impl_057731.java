...
@Data
public class Idea57731Config {
    private String name = "idea_057731";
 ...
 */
@Slf4j
public class Idea57731Service {
    private static final int IDEA_ID = 57731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57731Service() {
        this(new Idea57731Config());
    }

    public Idea57731Service(Idea57731Config config) {
        this.config = config != null ? config : new Idea57731Config();
