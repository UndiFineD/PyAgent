...
@Data
public class Idea57633Config {
    private String name = "idea_057633";
 ...
 */
@Slf4j
public class Idea57633Service {
    private static final int IDEA_ID = 57633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57633Service() {
        this(new Idea57633Config());
    }

    public Idea57633Service(Idea57633Config config) {
        this.config = config != null ? config : new Idea57633Config();
