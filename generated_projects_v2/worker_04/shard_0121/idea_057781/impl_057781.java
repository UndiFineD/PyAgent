...
@Data
public class Idea57781Config {
    private String name = "idea_057781";
 ...
 */
@Slf4j
public class Idea57781Service {
    private static final int IDEA_ID = 57781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57781Service() {
        this(new Idea57781Config());
    }

    public Idea57781Service(Idea57781Config config) {
        this.config = config != null ? config : new Idea57781Config();
