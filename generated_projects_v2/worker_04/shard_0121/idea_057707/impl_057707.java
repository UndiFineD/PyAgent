...
@Data
public class Idea57707Config {
    private String name = "idea_057707";
 ...
 */
@Slf4j
public class Idea57707Service {
    private static final int IDEA_ID = 57707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57707Service() {
        this(new Idea57707Config());
    }

    public Idea57707Service(Idea57707Config config) {
        this.config = config != null ? config : new Idea57707Config();
