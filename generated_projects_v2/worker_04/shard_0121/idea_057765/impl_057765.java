...
@Data
public class Idea57765Config {
    private String name = "idea_057765";
 ...
 */
@Slf4j
public class Idea57765Service {
    private static final int IDEA_ID = 57765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57765Service() {
        this(new Idea57765Config());
    }

    public Idea57765Service(Idea57765Config config) {
        this.config = config != null ? config : new Idea57765Config();
