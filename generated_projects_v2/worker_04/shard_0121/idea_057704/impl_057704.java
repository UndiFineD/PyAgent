...
@Data
public class Idea57704Config {
    private String name = "idea_057704";
 ...
 */
@Slf4j
public class Idea57704Service {
    private static final int IDEA_ID = 57704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57704Service() {
        this(new Idea57704Config());
    }

    public Idea57704Service(Idea57704Config config) {
        this.config = config != null ? config : new Idea57704Config();
