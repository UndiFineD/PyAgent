...
@Data
public class Idea57770Config {
    private String name = "idea_057770";
 ...
 */
@Slf4j
public class Idea57770Service {
    private static final int IDEA_ID = 57770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57770Service() {
        this(new Idea57770Config());
    }

    public Idea57770Service(Idea57770Config config) {
        this.config = config != null ? config : new Idea57770Config();
