...
@Data
public class Idea57893Config {
    private String name = "idea_057893";
 ...
 */
@Slf4j
public class Idea57893Service {
    private static final int IDEA_ID = 57893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57893Service() {
        this(new Idea57893Config());
    }

    public Idea57893Service(Idea57893Config config) {
        this.config = config != null ? config : new Idea57893Config();
