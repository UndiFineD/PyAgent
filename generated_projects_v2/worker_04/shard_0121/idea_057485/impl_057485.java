...
@Data
public class Idea57485Config {
    private String name = "idea_057485";
 ...
 */
@Slf4j
public class Idea57485Service {
    private static final int IDEA_ID = 57485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57485Service() {
        this(new Idea57485Config());
    }

    public Idea57485Service(Idea57485Config config) {
        this.config = config != null ? config : new Idea57485Config();
