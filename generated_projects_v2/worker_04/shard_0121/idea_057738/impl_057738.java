...
@Data
public class Idea57738Config {
    private String name = "idea_057738";
 ...
 */
@Slf4j
public class Idea57738Service {
    private static final int IDEA_ID = 57738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57738Service() {
        this(new Idea57738Config());
    }

    public Idea57738Service(Idea57738Config config) {
        this.config = config != null ? config : new Idea57738Config();
