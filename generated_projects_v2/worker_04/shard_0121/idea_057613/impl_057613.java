...
@Data
public class Idea57613Config {
    private String name = "idea_057613";
 ...
 */
@Slf4j
public class Idea57613Service {
    private static final int IDEA_ID = 57613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57613Service() {
        this(new Idea57613Config());
    }

    public Idea57613Service(Idea57613Config config) {
        this.config = config != null ? config : new Idea57613Config();
