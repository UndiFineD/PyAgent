...
@Data
public class Idea57778Config {
    private String name = "idea_057778";
 ...
 */
@Slf4j
public class Idea57778Service {
    private static final int IDEA_ID = 57778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57778Service() {
        this(new Idea57778Config());
    }

    public Idea57778Service(Idea57778Config config) {
        this.config = config != null ? config : new Idea57778Config();
