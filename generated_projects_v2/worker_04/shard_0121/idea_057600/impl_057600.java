...
@Data
public class Idea57600Config {
    private String name = "idea_057600";
 ...
 */
@Slf4j
public class Idea57600Service {
    private static final int IDEA_ID = 57600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57600Service() {
        this(new Idea57600Config());
    }

    public Idea57600Service(Idea57600Config config) {
        this.config = config != null ? config : new Idea57600Config();
