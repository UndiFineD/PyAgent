...
@Data
public class Idea57594Config {
    private String name = "idea_057594";
 ...
 */
@Slf4j
public class Idea57594Service {
    private static final int IDEA_ID = 57594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57594Service() {
        this(new Idea57594Config());
    }

    public Idea57594Service(Idea57594Config config) {
        this.config = config != null ? config : new Idea57594Config();
