...
@Data
public class Idea57939Config {
    private String name = "idea_057939";
 ...
 */
@Slf4j
public class Idea57939Service {
    private static final int IDEA_ID = 57939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57939Service() {
        this(new Idea57939Config());
    }

    public Idea57939Service(Idea57939Config config) {
        this.config = config != null ? config : new Idea57939Config();
