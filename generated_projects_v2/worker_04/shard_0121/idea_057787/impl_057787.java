...
@Data
public class Idea57787Config {
    private String name = "idea_057787";
 ...
 */
@Slf4j
public class Idea57787Service {
    private static final int IDEA_ID = 57787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57787Service() {
        this(new Idea57787Config());
    }

    public Idea57787Service(Idea57787Config config) {
        this.config = config != null ? config : new Idea57787Config();
