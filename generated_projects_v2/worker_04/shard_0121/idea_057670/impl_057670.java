...
@Data
public class Idea57670Config {
    private String name = "idea_057670";
 ...
 */
@Slf4j
public class Idea57670Service {
    private static final int IDEA_ID = 57670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57670Service() {
        this(new Idea57670Config());
    }

    public Idea57670Service(Idea57670Config config) {
        this.config = config != null ? config : new Idea57670Config();
