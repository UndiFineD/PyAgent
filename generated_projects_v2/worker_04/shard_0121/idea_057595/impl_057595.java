...
@Data
public class Idea57595Config {
    private String name = "idea_057595";
 ...
 */
@Slf4j
public class Idea57595Service {
    private static final int IDEA_ID = 57595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57595Service() {
        this(new Idea57595Config());
    }

    public Idea57595Service(Idea57595Config config) {
        this.config = config != null ? config : new Idea57595Config();
