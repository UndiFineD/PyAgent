...
@Data
public class Idea57946Config {
    private String name = "idea_057946";
 ...
 */
@Slf4j
public class Idea57946Service {
    private static final int IDEA_ID = 57946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57946Service() {
        this(new Idea57946Config());
    }

    public Idea57946Service(Idea57946Config config) {
        this.config = config != null ? config : new Idea57946Config();
