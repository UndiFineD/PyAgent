...
@Data
public class Idea57751Config {
    private String name = "idea_057751";
 ...
 */
@Slf4j
public class Idea57751Service {
    private static final int IDEA_ID = 57751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57751Service() {
        this(new Idea57751Config());
    }

    public Idea57751Service(Idea57751Config config) {
        this.config = config != null ? config : new Idea57751Config();
