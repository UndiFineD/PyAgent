...
@Data
public class Idea57713Config {
    private String name = "idea_057713";
 ...
 */
@Slf4j
public class Idea57713Service {
    private static final int IDEA_ID = 57713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57713Service() {
        this(new Idea57713Config());
    }

    public Idea57713Service(Idea57713Config config) {
        this.config = config != null ? config : new Idea57713Config();
