...
@Data
public class Idea57915Config {
    private String name = "idea_057915";
 ...
 */
@Slf4j
public class Idea57915Service {
    private static final int IDEA_ID = 57915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57915Service() {
        this(new Idea57915Config());
    }

    public Idea57915Service(Idea57915Config config) {
        this.config = config != null ? config : new Idea57915Config();
