...
@Data
public class Idea57802Config {
    private String name = "idea_057802";
 ...
 */
@Slf4j
public class Idea57802Service {
    private static final int IDEA_ID = 57802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57802Service() {
        this(new Idea57802Config());
    }

    public Idea57802Service(Idea57802Config config) {
        this.config = config != null ? config : new Idea57802Config();
