...
@Data
public class Idea57585Config {
    private String name = "idea_057585";
 ...
 */
@Slf4j
public class Idea57585Service {
    private static final int IDEA_ID = 57585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57585Service() {
        this(new Idea57585Config());
    }

    public Idea57585Service(Idea57585Config config) {
        this.config = config != null ? config : new Idea57585Config();
