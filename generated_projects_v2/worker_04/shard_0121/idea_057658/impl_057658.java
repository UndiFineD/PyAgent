...
@Data
public class Idea57658Config {
    private String name = "idea_057658";
 ...
 */
@Slf4j
public class Idea57658Service {
    private static final int IDEA_ID = 57658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57658Service() {
        this(new Idea57658Config());
    }

    public Idea57658Service(Idea57658Config config) {
        this.config = config != null ? config : new Idea57658Config();
