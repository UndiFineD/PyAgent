...
@Data
public class Idea57627Config {
    private String name = "idea_057627";
 ...
 */
@Slf4j
public class Idea57627Service {
    private static final int IDEA_ID = 57627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57627Service() {
        this(new Idea57627Config());
    }

    public Idea57627Service(Idea57627Config config) {
        this.config = config != null ? config : new Idea57627Config();
