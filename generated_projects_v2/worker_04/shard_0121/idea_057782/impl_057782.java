...
@Data
public class Idea57782Config {
    private String name = "idea_057782";
 ...
 */
@Slf4j
public class Idea57782Service {
    private static final int IDEA_ID = 57782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57782Service() {
        this(new Idea57782Config());
    }

    public Idea57782Service(Idea57782Config config) {
        this.config = config != null ? config : new Idea57782Config();
