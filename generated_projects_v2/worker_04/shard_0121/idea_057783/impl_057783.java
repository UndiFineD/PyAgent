...
@Data
public class Idea57783Config {
    private String name = "idea_057783";
 ...
 */
@Slf4j
public class Idea57783Service {
    private static final int IDEA_ID = 57783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57783Service() {
        this(new Idea57783Config());
    }

    public Idea57783Service(Idea57783Config config) {
        this.config = config != null ? config : new Idea57783Config();
