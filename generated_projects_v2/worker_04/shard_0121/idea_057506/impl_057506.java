...
@Data
public class Idea57506Config {
    private String name = "idea_057506";
 ...
 */
@Slf4j
public class Idea57506Service {
    private static final int IDEA_ID = 57506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57506Service() {
        this(new Idea57506Config());
    }

    public Idea57506Service(Idea57506Config config) {
        this.config = config != null ? config : new Idea57506Config();
