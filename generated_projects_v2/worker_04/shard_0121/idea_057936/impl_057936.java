...
@Data
public class Idea57936Config {
    private String name = "idea_057936";
 ...
 */
@Slf4j
public class Idea57936Service {
    private static final int IDEA_ID = 57936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57936Service() {
        this(new Idea57936Config());
    }

    public Idea57936Service(Idea57936Config config) {
        this.config = config != null ? config : new Idea57936Config();
