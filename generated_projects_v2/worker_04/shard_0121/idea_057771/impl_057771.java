...
@Data
public class Idea57771Config {
    private String name = "idea_057771";
 ...
 */
@Slf4j
public class Idea57771Service {
    private static final int IDEA_ID = 57771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57771Service() {
        this(new Idea57771Config());
    }

    public Idea57771Service(Idea57771Config config) {
        this.config = config != null ? config : new Idea57771Config();
