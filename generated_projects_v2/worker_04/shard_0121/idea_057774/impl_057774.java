...
@Data
public class Idea57774Config {
    private String name = "idea_057774";
 ...
 */
@Slf4j
public class Idea57774Service {
    private static final int IDEA_ID = 57774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57774Service() {
        this(new Idea57774Config());
    }

    public Idea57774Service(Idea57774Config config) {
        this.config = config != null ? config : new Idea57774Config();
