...
@Data
public class Idea57622Config {
    private String name = "idea_057622";
 ...
 */
@Slf4j
public class Idea57622Service {
    private static final int IDEA_ID = 57622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57622Service() {
        this(new Idea57622Config());
    }

    public Idea57622Service(Idea57622Config config) {
        this.config = config != null ? config : new Idea57622Config();
