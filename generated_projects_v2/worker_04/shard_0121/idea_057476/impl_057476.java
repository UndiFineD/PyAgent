...
@Data
public class Idea57476Config {
    private String name = "idea_057476";
 ...
 */
@Slf4j
public class Idea57476Service {
    private static final int IDEA_ID = 57476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57476Service() {
        this(new Idea57476Config());
    }

    public Idea57476Service(Idea57476Config config) {
        this.config = config != null ? config : new Idea57476Config();
