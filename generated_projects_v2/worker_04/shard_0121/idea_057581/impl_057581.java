...
@Data
public class Idea57581Config {
    private String name = "idea_057581";
 ...
 */
@Slf4j
public class Idea57581Service {
    private static final int IDEA_ID = 57581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57581Service() {
        this(new Idea57581Config());
    }

    public Idea57581Service(Idea57581Config config) {
        this.config = config != null ? config : new Idea57581Config();
