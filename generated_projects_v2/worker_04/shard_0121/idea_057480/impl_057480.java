...
@Data
public class Idea57480Config {
    private String name = "idea_057480";
 ...
 */
@Slf4j
public class Idea57480Service {
    private static final int IDEA_ID = 57480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57480Service() {
        this(new Idea57480Config());
    }

    public Idea57480Service(Idea57480Config config) {
        this.config = config != null ? config : new Idea57480Config();
