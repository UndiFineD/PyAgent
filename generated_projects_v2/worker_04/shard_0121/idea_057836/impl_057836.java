...
@Data
public class Idea57836Config {
    private String name = "idea_057836";
 ...
 */
@Slf4j
public class Idea57836Service {
    private static final int IDEA_ID = 57836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57836Service() {
        this(new Idea57836Config());
    }

    public Idea57836Service(Idea57836Config config) {
        this.config = config != null ? config : new Idea57836Config();
