...
@Data
public class Idea57708Config {
    private String name = "idea_057708";
 ...
 */
@Slf4j
public class Idea57708Service {
    private static final int IDEA_ID = 57708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57708Service() {
        this(new Idea57708Config());
    }

    public Idea57708Service(Idea57708Config config) {
        this.config = config != null ? config : new Idea57708Config();
