...
@Data
public class Idea57825Config {
    private String name = "idea_057825";
 ...
 */
@Slf4j
public class Idea57825Service {
    private static final int IDEA_ID = 57825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57825Service() {
        this(new Idea57825Config());
    }

    public Idea57825Service(Idea57825Config config) {
        this.config = config != null ? config : new Idea57825Config();
