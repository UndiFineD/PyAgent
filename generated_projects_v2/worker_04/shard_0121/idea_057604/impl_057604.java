...
@Data
public class Idea57604Config {
    private String name = "idea_057604";
 ...
 */
@Slf4j
public class Idea57604Service {
    private static final int IDEA_ID = 57604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57604Service() {
        this(new Idea57604Config());
    }

    public Idea57604Service(Idea57604Config config) {
        this.config = config != null ? config : new Idea57604Config();
