...
@Data
public class Idea57703Config {
    private String name = "idea_057703";
 ...
 */
@Slf4j
public class Idea57703Service {
    private static final int IDEA_ID = 57703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57703Service() {
        this(new Idea57703Config());
    }

    public Idea57703Service(Idea57703Config config) {
        this.config = config != null ? config : new Idea57703Config();
