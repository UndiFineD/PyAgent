...
@Data
public class Idea57898Config {
    private String name = "idea_057898";
 ...
 */
@Slf4j
public class Idea57898Service {
    private static final int IDEA_ID = 57898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57898Service() {
        this(new Idea57898Config());
    }

    public Idea57898Service(Idea57898Config config) {
        this.config = config != null ? config : new Idea57898Config();
