...
@Data
public class Idea57657Config {
    private String name = "idea_057657";
 ...
 */
@Slf4j
public class Idea57657Service {
    private static final int IDEA_ID = 57657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57657Service() {
        this(new Idea57657Config());
    }

    public Idea57657Service(Idea57657Config config) {
        this.config = config != null ? config : new Idea57657Config();
