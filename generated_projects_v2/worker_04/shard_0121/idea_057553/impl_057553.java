...
@Data
public class Idea57553Config {
    private String name = "idea_057553";
 ...
 */
@Slf4j
public class Idea57553Service {
    private static final int IDEA_ID = 57553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57553Service() {
        this(new Idea57553Config());
    }

    public Idea57553Service(Idea57553Config config) {
        this.config = config != null ? config : new Idea57553Config();
