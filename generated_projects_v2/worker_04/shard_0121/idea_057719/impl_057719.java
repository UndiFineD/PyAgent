...
@Data
public class Idea57719Config {
    private String name = "idea_057719";
 ...
 */
@Slf4j
public class Idea57719Service {
    private static final int IDEA_ID = 57719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57719Service() {
        this(new Idea57719Config());
    }

    public Idea57719Service(Idea57719Config config) {
        this.config = config != null ? config : new Idea57719Config();
