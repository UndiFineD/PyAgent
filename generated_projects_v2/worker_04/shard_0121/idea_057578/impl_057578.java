...
@Data
public class Idea57578Config {
    private String name = "idea_057578";
 ...
 */
@Slf4j
public class Idea57578Service {
    private static final int IDEA_ID = 57578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57578Service() {
        this(new Idea57578Config());
    }

    public Idea57578Service(Idea57578Config config) {
        this.config = config != null ? config : new Idea57578Config();
