...
@Data
public class Idea57791Config {
    private String name = "idea_057791";
 ...
 */
@Slf4j
public class Idea57791Service {
    private static final int IDEA_ID = 57791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57791Service() {
        this(new Idea57791Config());
    }

    public Idea57791Service(Idea57791Config config) {
        this.config = config != null ? config : new Idea57791Config();
