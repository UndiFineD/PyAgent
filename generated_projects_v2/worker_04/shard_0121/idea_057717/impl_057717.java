...
@Data
public class Idea57717Config {
    private String name = "idea_057717";
 ...
 */
@Slf4j
public class Idea57717Service {
    private static final int IDEA_ID = 57717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57717Service() {
        this(new Idea57717Config());
    }

    public Idea57717Service(Idea57717Config config) {
        this.config = config != null ? config : new Idea57717Config();
