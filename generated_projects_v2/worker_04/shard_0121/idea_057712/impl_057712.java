...
@Data
public class Idea57712Config {
    private String name = "idea_057712";
 ...
 */
@Slf4j
public class Idea57712Service {
    private static final int IDEA_ID = 57712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57712Service() {
        this(new Idea57712Config());
    }

    public Idea57712Service(Idea57712Config config) {
        this.config = config != null ? config : new Idea57712Config();
