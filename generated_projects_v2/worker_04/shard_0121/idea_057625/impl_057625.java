...
@Data
public class Idea57625Config {
    private String name = "idea_057625";
 ...
 */
@Slf4j
public class Idea57625Service {
    private static final int IDEA_ID = 57625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57625Service() {
        this(new Idea57625Config());
    }

    public Idea57625Service(Idea57625Config config) {
        this.config = config != null ? config : new Idea57625Config();
