...
@Data
public class Idea57837Config {
    private String name = "idea_057837";
 ...
 */
@Slf4j
public class Idea57837Service {
    private static final int IDEA_ID = 57837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57837Service() {
        this(new Idea57837Config());
    }

    public Idea57837Service(Idea57837Config config) {
        this.config = config != null ? config : new Idea57837Config();
