...
@Data
public class Idea57661Config {
    private String name = "idea_057661";
 ...
 */
@Slf4j
public class Idea57661Service {
    private static final int IDEA_ID = 57661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57661Service() {
        this(new Idea57661Config());
    }

    public Idea57661Service(Idea57661Config config) {
        this.config = config != null ? config : new Idea57661Config();
