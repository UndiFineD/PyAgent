...
@Data
public class Idea57806Config {
    private String name = "idea_057806";
 ...
 */
@Slf4j
public class Idea57806Service {
    private static final int IDEA_ID = 57806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57806Service() {
        this(new Idea57806Config());
    }

    public Idea57806Service(Idea57806Config config) {
        this.config = config != null ? config : new Idea57806Config();
