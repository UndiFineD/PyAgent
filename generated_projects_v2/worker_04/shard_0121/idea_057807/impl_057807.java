...
@Data
public class Idea57807Config {
    private String name = "idea_057807";
 ...
 */
@Slf4j
public class Idea57807Service {
    private static final int IDEA_ID = 57807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57807Service() {
        this(new Idea57807Config());
    }

    public Idea57807Service(Idea57807Config config) {
        this.config = config != null ? config : new Idea57807Config();
