...
@Data
public class Idea57775Config {
    private String name = "idea_057775";
 ...
 */
@Slf4j
public class Idea57775Service {
    private static final int IDEA_ID = 57775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57775Service() {
        this(new Idea57775Config());
    }

    public Idea57775Service(Idea57775Config config) {
        this.config = config != null ? config : new Idea57775Config();
