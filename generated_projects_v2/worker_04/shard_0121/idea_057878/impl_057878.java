...
@Data
public class Idea57878Config {
    private String name = "idea_057878";
 ...
 */
@Slf4j
public class Idea57878Service {
    private static final int IDEA_ID = 57878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57878Service() {
        this(new Idea57878Config());
    }

    public Idea57878Service(Idea57878Config config) {
        this.config = config != null ? config : new Idea57878Config();
