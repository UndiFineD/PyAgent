...
@Data
public class Idea57517Config {
    private String name = "idea_057517";
 ...
 */
@Slf4j
public class Idea57517Service {
    private static final int IDEA_ID = 57517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57517Service() {
        this(new Idea57517Config());
    }

    public Idea57517Service(Idea57517Config config) {
        this.config = config != null ? config : new Idea57517Config();
