...
@Data
public class Idea57823Config {
    private String name = "idea_057823";
 ...
 */
@Slf4j
public class Idea57823Service {
    private static final int IDEA_ID = 57823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57823Service() {
        this(new Idea57823Config());
    }

    public Idea57823Service(Idea57823Config config) {
        this.config = config != null ? config : new Idea57823Config();
