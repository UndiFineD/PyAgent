...
@Data
public class Idea57638Config {
    private String name = "idea_057638";
 ...
 */
@Slf4j
public class Idea57638Service {
    private static final int IDEA_ID = 57638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57638Service() {
        this(new Idea57638Config());
    }

    public Idea57638Service(Idea57638Config config) {
        this.config = config != null ? config : new Idea57638Config();
