...
@Data
public class Idea57805Config {
    private String name = "idea_057805";
 ...
 */
@Slf4j
public class Idea57805Service {
    private static final int IDEA_ID = 57805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea57805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea57805Service() {
        this(new Idea57805Config());
    }

    public Idea57805Service(Idea57805Config config) {
        this.config = config != null ? config : new Idea57805Config();
