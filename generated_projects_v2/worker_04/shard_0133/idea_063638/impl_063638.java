...
@Data
public class Idea63638Config {
    private String name = "idea_063638";
 ...
 */
@Slf4j
public class Idea63638Service {
    private static final int IDEA_ID = 63638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63638Service() {
        this(new Idea63638Config());
    }

    public Idea63638Service(Idea63638Config config) {
        this.config = config != null ? config : new Idea63638Config();
