...
@Data
public class Idea63555Config {
    private String name = "idea_063555";
 ...
 */
@Slf4j
public class Idea63555Service {
    private static final int IDEA_ID = 63555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63555Service() {
        this(new Idea63555Config());
    }

    public Idea63555Service(Idea63555Config config) {
        this.config = config != null ? config : new Idea63555Config();
