...
@Data
public class Idea63246Config {
    private String name = "idea_063246";
 ...
 */
@Slf4j
public class Idea63246Service {
    private static final int IDEA_ID = 63246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63246Service() {
        this(new Idea63246Config());
    }

    public Idea63246Service(Idea63246Config config) {
        this.config = config != null ? config : new Idea63246Config();
