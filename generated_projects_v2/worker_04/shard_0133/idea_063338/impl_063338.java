...
@Data
public class Idea63338Config {
    private String name = "idea_063338";
 ...
 */
@Slf4j
public class Idea63338Service {
    private static final int IDEA_ID = 63338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63338Service() {
        this(new Idea63338Config());
    }

    public Idea63338Service(Idea63338Config config) {
        this.config = config != null ? config : new Idea63338Config();
