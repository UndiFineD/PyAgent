...
@Data
public class Idea63579Config {
    private String name = "idea_063579";
 ...
 */
@Slf4j
public class Idea63579Service {
    private static final int IDEA_ID = 63579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63579Service() {
        this(new Idea63579Config());
    }

    public Idea63579Service(Idea63579Config config) {
        this.config = config != null ? config : new Idea63579Config();
