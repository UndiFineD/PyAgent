...
@Data
public class Idea63385Config {
    private String name = "idea_063385";
 ...
 */
@Slf4j
public class Idea63385Service {
    private static final int IDEA_ID = 63385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63385Service() {
        this(new Idea63385Config());
    }

    public Idea63385Service(Idea63385Config config) {
        this.config = config != null ? config : new Idea63385Config();
