...
@Data
public class Idea63481Config {
    private String name = "idea_063481";
 ...
 */
@Slf4j
public class Idea63481Service {
    private static final int IDEA_ID = 63481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63481Service() {
        this(new Idea63481Config());
    }

    public Idea63481Service(Idea63481Config config) {
        this.config = config != null ? config : new Idea63481Config();
