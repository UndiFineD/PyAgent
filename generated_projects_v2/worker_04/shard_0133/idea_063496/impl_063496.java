...
@Data
public class Idea63496Config {
    private String name = "idea_063496";
 ...
 */
@Slf4j
public class Idea63496Service {
    private static final int IDEA_ID = 63496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63496Service() {
        this(new Idea63496Config());
    }

    public Idea63496Service(Idea63496Config config) {
        this.config = config != null ? config : new Idea63496Config();
