...
@Data
public class Idea63575Config {
    private String name = "idea_063575";
 ...
 */
@Slf4j
public class Idea63575Service {
    private static final int IDEA_ID = 63575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63575Service() {
        this(new Idea63575Config());
    }

    public Idea63575Service(Idea63575Config config) {
        this.config = config != null ? config : new Idea63575Config();
