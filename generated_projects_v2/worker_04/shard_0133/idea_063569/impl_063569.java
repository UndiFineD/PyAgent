...
@Data
public class Idea63569Config {
    private String name = "idea_063569";
 ...
 */
@Slf4j
public class Idea63569Service {
    private static final int IDEA_ID = 63569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63569Service() {
        this(new Idea63569Config());
    }

    public Idea63569Service(Idea63569Config config) {
        this.config = config != null ? config : new Idea63569Config();
