...
@Data
public class Idea63552Config {
    private String name = "idea_063552";
 ...
 */
@Slf4j
public class Idea63552Service {
    private static final int IDEA_ID = 63552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63552Service() {
        this(new Idea63552Config());
    }

    public Idea63552Service(Idea63552Config config) {
        this.config = config != null ? config : new Idea63552Config();
