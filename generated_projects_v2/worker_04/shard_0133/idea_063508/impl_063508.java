...
@Data
public class Idea63508Config {
    private String name = "idea_063508";
 ...
 */
@Slf4j
public class Idea63508Service {
    private static final int IDEA_ID = 63508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63508Service() {
        this(new Idea63508Config());
    }

    public Idea63508Service(Idea63508Config config) {
        this.config = config != null ? config : new Idea63508Config();
