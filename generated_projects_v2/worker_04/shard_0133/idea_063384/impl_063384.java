...
@Data
public class Idea63384Config {
    private String name = "idea_063384";
 ...
 */
@Slf4j
public class Idea63384Service {
    private static final int IDEA_ID = 63384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63384Service() {
        this(new Idea63384Config());
    }

    public Idea63384Service(Idea63384Config config) {
        this.config = config != null ? config : new Idea63384Config();
