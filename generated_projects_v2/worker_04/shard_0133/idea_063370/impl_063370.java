...
@Data
public class Idea63370Config {
    private String name = "idea_063370";
 ...
 */
@Slf4j
public class Idea63370Service {
    private static final int IDEA_ID = 63370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63370Service() {
        this(new Idea63370Config());
    }

    public Idea63370Service(Idea63370Config config) {
        this.config = config != null ? config : new Idea63370Config();
