...
@Data
public class Idea63299Config {
    private String name = "idea_063299";
 ...
 */
@Slf4j
public class Idea63299Service {
    private static final int IDEA_ID = 63299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63299Service() {
        this(new Idea63299Config());
    }

    public Idea63299Service(Idea63299Config config) {
        this.config = config != null ? config : new Idea63299Config();
