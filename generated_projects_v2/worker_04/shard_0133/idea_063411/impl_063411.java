...
@Data
public class Idea63411Config {
    private String name = "idea_063411";
 ...
 */
@Slf4j
public class Idea63411Service {
    private static final int IDEA_ID = 63411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63411Service() {
        this(new Idea63411Config());
    }

    public Idea63411Service(Idea63411Config config) {
        this.config = config != null ? config : new Idea63411Config();
