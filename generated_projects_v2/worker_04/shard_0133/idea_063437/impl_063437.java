...
@Data
public class Idea63437Config {
    private String name = "idea_063437";
 ...
 */
@Slf4j
public class Idea63437Service {
    private static final int IDEA_ID = 63437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63437Service() {
        this(new Idea63437Config());
    }

    public Idea63437Service(Idea63437Config config) {
        this.config = config != null ? config : new Idea63437Config();
