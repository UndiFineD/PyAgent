...
@Data
public class Idea63582Config {
    private String name = "idea_063582";
 ...
 */
@Slf4j
public class Idea63582Service {
    private static final int IDEA_ID = 63582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63582Service() {
        this(new Idea63582Config());
    }

    public Idea63582Service(Idea63582Config config) {
        this.config = config != null ? config : new Idea63582Config();
