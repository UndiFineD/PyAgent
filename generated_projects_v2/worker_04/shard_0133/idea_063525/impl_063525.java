...
@Data
public class Idea63525Config {
    private String name = "idea_063525";
 ...
 */
@Slf4j
public class Idea63525Service {
    private static final int IDEA_ID = 63525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63525Service() {
        this(new Idea63525Config());
    }

    public Idea63525Service(Idea63525Config config) {
        this.config = config != null ? config : new Idea63525Config();
