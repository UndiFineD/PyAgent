...
@Data
public class Idea63629Config {
    private String name = "idea_063629";
 ...
 */
@Slf4j
public class Idea63629Service {
    private static final int IDEA_ID = 63629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63629Service() {
        this(new Idea63629Config());
    }

    public Idea63629Service(Idea63629Config config) {
        this.config = config != null ? config : new Idea63629Config();
