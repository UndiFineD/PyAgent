...
@Data
public class Idea63461Config {
    private String name = "idea_063461";
 ...
 */
@Slf4j
public class Idea63461Service {
    private static final int IDEA_ID = 63461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63461Service() {
        this(new Idea63461Config());
    }

    public Idea63461Service(Idea63461Config config) {
        this.config = config != null ? config : new Idea63461Config();
