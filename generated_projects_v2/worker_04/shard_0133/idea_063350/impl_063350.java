...
@Data
public class Idea63350Config {
    private String name = "idea_063350";
 ...
 */
@Slf4j
public class Idea63350Service {
    private static final int IDEA_ID = 63350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63350Service() {
        this(new Idea63350Config());
    }

    public Idea63350Service(Idea63350Config config) {
        this.config = config != null ? config : new Idea63350Config();
