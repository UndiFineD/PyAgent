...
@Data
public class Idea63536Config {
    private String name = "idea_063536";
 ...
 */
@Slf4j
public class Idea63536Service {
    private static final int IDEA_ID = 63536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63536Service() {
        this(new Idea63536Config());
    }

    public Idea63536Service(Idea63536Config config) {
        this.config = config != null ? config : new Idea63536Config();
