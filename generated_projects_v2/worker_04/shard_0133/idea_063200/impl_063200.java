...
@Data
public class Idea63200Config {
    private String name = "idea_063200";
 ...
 */
@Slf4j
public class Idea63200Service {
    private static final int IDEA_ID = 63200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63200Service() {
        this(new Idea63200Config());
    }

    public Idea63200Service(Idea63200Config config) {
        this.config = config != null ? config : new Idea63200Config();
