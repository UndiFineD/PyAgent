...
@Data
public class Idea63273Config {
    private String name = "idea_063273";
 ...
 */
@Slf4j
public class Idea63273Service {
    private static final int IDEA_ID = 63273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63273Service() {
        this(new Idea63273Config());
    }

    public Idea63273Service(Idea63273Config config) {
        this.config = config != null ? config : new Idea63273Config();
