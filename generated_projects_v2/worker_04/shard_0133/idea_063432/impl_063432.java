...
@Data
public class Idea63432Config {
    private String name = "idea_063432";
 ...
 */
@Slf4j
public class Idea63432Service {
    private static final int IDEA_ID = 63432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63432Service() {
        this(new Idea63432Config());
    }

    public Idea63432Service(Idea63432Config config) {
        this.config = config != null ? config : new Idea63432Config();
