...
@Data
public class Idea63327Config {
    private String name = "idea_063327";
 ...
 */
@Slf4j
public class Idea63327Service {
    private static final int IDEA_ID = 63327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63327Service() {
        this(new Idea63327Config());
    }

    public Idea63327Service(Idea63327Config config) {
        this.config = config != null ? config : new Idea63327Config();
