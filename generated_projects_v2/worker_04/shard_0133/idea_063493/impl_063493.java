...
@Data
public class Idea63493Config {
    private String name = "idea_063493";
 ...
 */
@Slf4j
public class Idea63493Service {
    private static final int IDEA_ID = 63493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63493Service() {
        this(new Idea63493Config());
    }

    public Idea63493Service(Idea63493Config config) {
        this.config = config != null ? config : new Idea63493Config();
