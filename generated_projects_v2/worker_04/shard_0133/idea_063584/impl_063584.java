...
@Data
public class Idea63584Config {
    private String name = "idea_063584";
 ...
 */
@Slf4j
public class Idea63584Service {
    private static final int IDEA_ID = 63584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63584Service() {
        this(new Idea63584Config());
    }

    public Idea63584Service(Idea63584Config config) {
        this.config = config != null ? config : new Idea63584Config();
