...
@Data
public class Idea63463Config {
    private String name = "idea_063463";
 ...
 */
@Slf4j
public class Idea63463Service {
    private static final int IDEA_ID = 63463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63463Service() {
        this(new Idea63463Config());
    }

    public Idea63463Service(Idea63463Config config) {
        this.config = config != null ? config : new Idea63463Config();
