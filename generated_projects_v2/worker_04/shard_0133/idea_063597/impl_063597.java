...
@Data
public class Idea63597Config {
    private String name = "idea_063597";
 ...
 */
@Slf4j
public class Idea63597Service {
    private static final int IDEA_ID = 63597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63597Service() {
        this(new Idea63597Config());
    }

    public Idea63597Service(Idea63597Config config) {
        this.config = config != null ? config : new Idea63597Config();
