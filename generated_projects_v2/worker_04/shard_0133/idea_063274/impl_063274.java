...
@Data
public class Idea63274Config {
    private String name = "idea_063274";
 ...
 */
@Slf4j
public class Idea63274Service {
    private static final int IDEA_ID = 63274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63274Service() {
        this(new Idea63274Config());
    }

    public Idea63274Service(Idea63274Config config) {
        this.config = config != null ? config : new Idea63274Config();
