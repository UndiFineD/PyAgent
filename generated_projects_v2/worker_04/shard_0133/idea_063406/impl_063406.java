...
@Data
public class Idea63406Config {
    private String name = "idea_063406";
 ...
 */
@Slf4j
public class Idea63406Service {
    private static final int IDEA_ID = 63406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63406Service() {
        this(new Idea63406Config());
    }

    public Idea63406Service(Idea63406Config config) {
        this.config = config != null ? config : new Idea63406Config();
