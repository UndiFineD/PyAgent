...
@Data
public class Idea63643Config {
    private String name = "idea_063643";
 ...
 */
@Slf4j
public class Idea63643Service {
    private static final int IDEA_ID = 63643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63643Service() {
        this(new Idea63643Config());
    }

    public Idea63643Service(Idea63643Config config) {
        this.config = config != null ? config : new Idea63643Config();
