...
@Data
public class Idea63475Config {
    private String name = "idea_063475";
 ...
 */
@Slf4j
public class Idea63475Service {
    private static final int IDEA_ID = 63475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63475Service() {
        this(new Idea63475Config());
    }

    public Idea63475Service(Idea63475Config config) {
        this.config = config != null ? config : new Idea63475Config();
