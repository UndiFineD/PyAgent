...
@Data
public class Idea63642Config {
    private String name = "idea_063642";
 ...
 */
@Slf4j
public class Idea63642Service {
    private static final int IDEA_ID = 63642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63642Service() {
        this(new Idea63642Config());
    }

    public Idea63642Service(Idea63642Config config) {
        this.config = config != null ? config : new Idea63642Config();
