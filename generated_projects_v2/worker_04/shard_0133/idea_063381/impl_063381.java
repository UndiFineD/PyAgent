...
@Data
public class Idea63381Config {
    private String name = "idea_063381";
 ...
 */
@Slf4j
public class Idea63381Service {
    private static final int IDEA_ID = 63381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63381Service() {
        this(new Idea63381Config());
    }

    public Idea63381Service(Idea63381Config config) {
        this.config = config != null ? config : new Idea63381Config();
