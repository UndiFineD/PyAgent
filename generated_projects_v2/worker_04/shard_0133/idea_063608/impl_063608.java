...
@Data
public class Idea63608Config {
    private String name = "idea_063608";
 ...
 */
@Slf4j
public class Idea63608Service {
    private static final int IDEA_ID = 63608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63608Service() {
        this(new Idea63608Config());
    }

    public Idea63608Service(Idea63608Config config) {
        this.config = config != null ? config : new Idea63608Config();
