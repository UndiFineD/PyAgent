...
@Data
public class Idea63363Config {
    private String name = "idea_063363";
 ...
 */
@Slf4j
public class Idea63363Service {
    private static final int IDEA_ID = 63363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63363Service() {
        this(new Idea63363Config());
    }

    public Idea63363Service(Idea63363Config config) {
        this.config = config != null ? config : new Idea63363Config();
