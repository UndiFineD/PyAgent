...
@Data
public class Idea63271Config {
    private String name = "idea_063271";
 ...
 */
@Slf4j
public class Idea63271Service {
    private static final int IDEA_ID = 63271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63271Service() {
        this(new Idea63271Config());
    }

    public Idea63271Service(Idea63271Config config) {
        this.config = config != null ? config : new Idea63271Config();
