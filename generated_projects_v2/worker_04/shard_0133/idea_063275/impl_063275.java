...
@Data
public class Idea63275Config {
    private String name = "idea_063275";
 ...
 */
@Slf4j
public class Idea63275Service {
    private static final int IDEA_ID = 63275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63275Service() {
        this(new Idea63275Config());
    }

    public Idea63275Service(Idea63275Config config) {
        this.config = config != null ? config : new Idea63275Config();
