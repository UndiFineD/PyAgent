...
@Data
public class Idea63635Config {
    private String name = "idea_063635";
 ...
 */
@Slf4j
public class Idea63635Service {
    private static final int IDEA_ID = 63635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63635Service() {
        this(new Idea63635Config());
    }

    public Idea63635Service(Idea63635Config config) {
        this.config = config != null ? config : new Idea63635Config();
