...
@Data
public class Idea63379Config {
    private String name = "idea_063379";
 ...
 */
@Slf4j
public class Idea63379Service {
    private static final int IDEA_ID = 63379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63379Service() {
        this(new Idea63379Config());
    }

    public Idea63379Service(Idea63379Config config) {
        this.config = config != null ? config : new Idea63379Config();
