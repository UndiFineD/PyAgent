...
@Data
public class Idea63255Config {
    private String name = "idea_063255";
 ...
 */
@Slf4j
public class Idea63255Service {
    private static final int IDEA_ID = 63255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63255Service() {
        this(new Idea63255Config());
    }

    public Idea63255Service(Idea63255Config config) {
        this.config = config != null ? config : new Idea63255Config();
