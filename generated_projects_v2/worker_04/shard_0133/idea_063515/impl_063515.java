...
@Data
public class Idea63515Config {
    private String name = "idea_063515";
 ...
 */
@Slf4j
public class Idea63515Service {
    private static final int IDEA_ID = 63515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63515Service() {
        this(new Idea63515Config());
    }

    public Idea63515Service(Idea63515Config config) {
        this.config = config != null ? config : new Idea63515Config();
