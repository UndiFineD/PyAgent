...
@Data
public class Idea63452Config {
    private String name = "idea_063452";
 ...
 */
@Slf4j
public class Idea63452Service {
    private static final int IDEA_ID = 63452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63452Service() {
        this(new Idea63452Config());
    }

    public Idea63452Service(Idea63452Config config) {
        this.config = config != null ? config : new Idea63452Config();
