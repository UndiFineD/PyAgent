...
@Data
public class Idea63240Config {
    private String name = "idea_063240";
 ...
 */
@Slf4j
public class Idea63240Service {
    private static final int IDEA_ID = 63240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63240Service() {
        this(new Idea63240Config());
    }

    public Idea63240Service(Idea63240Config config) {
        this.config = config != null ? config : new Idea63240Config();
