...
@Data
public class Idea63277Config {
    private String name = "idea_063277";
 ...
 */
@Slf4j
public class Idea63277Service {
    private static final int IDEA_ID = 63277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63277Service() {
        this(new Idea63277Config());
    }

    public Idea63277Service(Idea63277Config config) {
        this.config = config != null ? config : new Idea63277Config();
