...
@Data
public class Idea63550Config {
    private String name = "idea_063550";
 ...
 */
@Slf4j
public class Idea63550Service {
    private static final int IDEA_ID = 63550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63550Service() {
        this(new Idea63550Config());
    }

    public Idea63550Service(Idea63550Config config) {
        this.config = config != null ? config : new Idea63550Config();
