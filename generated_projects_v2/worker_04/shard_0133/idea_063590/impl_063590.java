...
@Data
public class Idea63590Config {
    private String name = "idea_063590";
 ...
 */
@Slf4j
public class Idea63590Service {
    private static final int IDEA_ID = 63590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63590Service() {
        this(new Idea63590Config());
    }

    public Idea63590Service(Idea63590Config config) {
        this.config = config != null ? config : new Idea63590Config();
