...
@Data
public class Idea63320Config {
    private String name = "idea_063320";
 ...
 */
@Slf4j
public class Idea63320Service {
    private static final int IDEA_ID = 63320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63320Service() {
        this(new Idea63320Config());
    }

    public Idea63320Service(Idea63320Config config) {
        this.config = config != null ? config : new Idea63320Config();
