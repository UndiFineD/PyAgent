...
@Data
public class Idea63580Config {
    private String name = "idea_063580";
 ...
 */
@Slf4j
public class Idea63580Service {
    private static final int IDEA_ID = 63580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63580Service() {
        this(new Idea63580Config());
    }

    public Idea63580Service(Idea63580Config config) {
        this.config = config != null ? config : new Idea63580Config();
