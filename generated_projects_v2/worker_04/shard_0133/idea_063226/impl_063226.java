...
@Data
public class Idea63226Config {
    private String name = "idea_063226";
 ...
 */
@Slf4j
public class Idea63226Service {
    private static final int IDEA_ID = 63226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63226Service() {
        this(new Idea63226Config());
    }

    public Idea63226Service(Idea63226Config config) {
        this.config = config != null ? config : new Idea63226Config();
