...
@Data
public class Idea63237Config {
    private String name = "idea_063237";
 ...
 */
@Slf4j
public class Idea63237Service {
    private static final int IDEA_ID = 63237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63237Service() {
        this(new Idea63237Config());
    }

    public Idea63237Service(Idea63237Config config) {
        this.config = config != null ? config : new Idea63237Config();
