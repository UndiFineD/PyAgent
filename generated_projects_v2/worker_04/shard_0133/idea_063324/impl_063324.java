...
@Data
public class Idea63324Config {
    private String name = "idea_063324";
 ...
 */
@Slf4j
public class Idea63324Service {
    private static final int IDEA_ID = 63324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63324Service() {
        this(new Idea63324Config());
    }

    public Idea63324Service(Idea63324Config config) {
        this.config = config != null ? config : new Idea63324Config();
