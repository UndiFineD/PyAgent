...
@Data
public class Idea63417Config {
    private String name = "idea_063417";
 ...
 */
@Slf4j
public class Idea63417Service {
    private static final int IDEA_ID = 63417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63417Service() {
        this(new Idea63417Config());
    }

    public Idea63417Service(Idea63417Config config) {
        this.config = config != null ? config : new Idea63417Config();
