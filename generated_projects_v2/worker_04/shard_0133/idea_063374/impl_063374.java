...
@Data
public class Idea63374Config {
    private String name = "idea_063374";
 ...
 */
@Slf4j
public class Idea63374Service {
    private static final int IDEA_ID = 63374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63374Service() {
        this(new Idea63374Config());
    }

    public Idea63374Service(Idea63374Config config) {
        this.config = config != null ? config : new Idea63374Config();
