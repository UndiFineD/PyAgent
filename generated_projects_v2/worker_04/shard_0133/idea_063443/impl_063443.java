...
@Data
public class Idea63443Config {
    private String name = "idea_063443";
 ...
 */
@Slf4j
public class Idea63443Service {
    private static final int IDEA_ID = 63443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63443Service() {
        this(new Idea63443Config());
    }

    public Idea63443Service(Idea63443Config config) {
        this.config = config != null ? config : new Idea63443Config();
