...
@Data
public class Idea63617Config {
    private String name = "idea_063617";
 ...
 */
@Slf4j
public class Idea63617Service {
    private static final int IDEA_ID = 63617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63617Service() {
        this(new Idea63617Config());
    }

    public Idea63617Service(Idea63617Config config) {
        this.config = config != null ? config : new Idea63617Config();
