...
@Data
public class Idea63222Config {
    private String name = "idea_063222";
 ...
 */
@Slf4j
public class Idea63222Service {
    private static final int IDEA_ID = 63222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63222Service() {
        this(new Idea63222Config());
    }

    public Idea63222Service(Idea63222Config config) {
        this.config = config != null ? config : new Idea63222Config();
