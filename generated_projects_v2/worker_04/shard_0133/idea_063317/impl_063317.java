...
@Data
public class Idea63317Config {
    private String name = "idea_063317";
 ...
 */
@Slf4j
public class Idea63317Service {
    private static final int IDEA_ID = 63317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63317Service() {
        this(new Idea63317Config());
    }

    public Idea63317Service(Idea63317Config config) {
        this.config = config != null ? config : new Idea63317Config();
