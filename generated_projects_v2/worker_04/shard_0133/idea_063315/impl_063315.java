...
@Data
public class Idea63315Config {
    private String name = "idea_063315";
 ...
 */
@Slf4j
public class Idea63315Service {
    private static final int IDEA_ID = 63315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63315Service() {
        this(new Idea63315Config());
    }

    public Idea63315Service(Idea63315Config config) {
        this.config = config != null ? config : new Idea63315Config();
