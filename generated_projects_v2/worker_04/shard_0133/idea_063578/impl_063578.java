...
@Data
public class Idea63578Config {
    private String name = "idea_063578";
 ...
 */
@Slf4j
public class Idea63578Service {
    private static final int IDEA_ID = 63578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63578Service() {
        this(new Idea63578Config());
    }

    public Idea63578Service(Idea63578Config config) {
        this.config = config != null ? config : new Idea63578Config();
