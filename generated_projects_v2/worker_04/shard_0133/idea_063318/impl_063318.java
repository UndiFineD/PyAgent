...
@Data
public class Idea63318Config {
    private String name = "idea_063318";
 ...
 */
@Slf4j
public class Idea63318Service {
    private static final int IDEA_ID = 63318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63318Service() {
        this(new Idea63318Config());
    }

    public Idea63318Service(Idea63318Config config) {
        this.config = config != null ? config : new Idea63318Config();
