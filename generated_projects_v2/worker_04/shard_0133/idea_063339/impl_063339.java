...
@Data
public class Idea63339Config {
    private String name = "idea_063339";
 ...
 */
@Slf4j
public class Idea63339Service {
    private static final int IDEA_ID = 63339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63339Service() {
        this(new Idea63339Config());
    }

    public Idea63339Service(Idea63339Config config) {
        this.config = config != null ? config : new Idea63339Config();
