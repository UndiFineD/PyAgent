...
@Data
public class Idea63402Config {
    private String name = "idea_063402";
 ...
 */
@Slf4j
public class Idea63402Service {
    private static final int IDEA_ID = 63402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63402Service() {
        this(new Idea63402Config());
    }

    public Idea63402Service(Idea63402Config config) {
        this.config = config != null ? config : new Idea63402Config();
