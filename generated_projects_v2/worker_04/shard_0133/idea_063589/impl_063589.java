...
@Data
public class Idea63589Config {
    private String name = "idea_063589";
 ...
 */
@Slf4j
public class Idea63589Service {
    private static final int IDEA_ID = 63589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63589Service() {
        this(new Idea63589Config());
    }

    public Idea63589Service(Idea63589Config config) {
        this.config = config != null ? config : new Idea63589Config();
