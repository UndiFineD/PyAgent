...
@Data
public class Idea63632Config {
    private String name = "idea_063632";
 ...
 */
@Slf4j
public class Idea63632Service {
    private static final int IDEA_ID = 63632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63632Service() {
        this(new Idea63632Config());
    }

    public Idea63632Service(Idea63632Config config) {
        this.config = config != null ? config : new Idea63632Config();
