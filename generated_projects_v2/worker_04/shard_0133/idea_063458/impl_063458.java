...
@Data
public class Idea63458Config {
    private String name = "idea_063458";
 ...
 */
@Slf4j
public class Idea63458Service {
    private static final int IDEA_ID = 63458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63458Service() {
        this(new Idea63458Config());
    }

    public Idea63458Service(Idea63458Config config) {
        this.config = config != null ? config : new Idea63458Config();
