...
@Data
public class Idea63309Config {
    private String name = "idea_063309";
 ...
 */
@Slf4j
public class Idea63309Service {
    private static final int IDEA_ID = 63309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63309Service() {
        this(new Idea63309Config());
    }

    public Idea63309Service(Idea63309Config config) {
        this.config = config != null ? config : new Idea63309Config();
