...
@Data
public class Idea63618Config {
    private String name = "idea_063618";
 ...
 */
@Slf4j
public class Idea63618Service {
    private static final int IDEA_ID = 63618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63618Service() {
        this(new Idea63618Config());
    }

    public Idea63618Service(Idea63618Config config) {
        this.config = config != null ? config : new Idea63618Config();
