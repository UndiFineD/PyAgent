...
@Data
public class Idea63186Config {
    private String name = "idea_063186";
 ...
 */
@Slf4j
public class Idea63186Service {
    private static final int IDEA_ID = 63186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63186Service() {
        this(new Idea63186Config());
    }

    public Idea63186Service(Idea63186Config config) {
        this.config = config != null ? config : new Idea63186Config();
