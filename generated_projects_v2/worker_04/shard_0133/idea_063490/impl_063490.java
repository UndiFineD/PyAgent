...
@Data
public class Idea63490Config {
    private String name = "idea_063490";
 ...
 */
@Slf4j
public class Idea63490Service {
    private static final int IDEA_ID = 63490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63490Service() {
        this(new Idea63490Config());
    }

    public Idea63490Service(Idea63490Config config) {
        this.config = config != null ? config : new Idea63490Config();
