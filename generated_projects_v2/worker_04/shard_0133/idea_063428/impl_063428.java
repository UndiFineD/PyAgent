...
@Data
public class Idea63428Config {
    private String name = "idea_063428";
 ...
 */
@Slf4j
public class Idea63428Service {
    private static final int IDEA_ID = 63428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63428Service() {
        this(new Idea63428Config());
    }

    public Idea63428Service(Idea63428Config config) {
        this.config = config != null ? config : new Idea63428Config();
