...
@Data
public class Idea63342Config {
    private String name = "idea_063342";
 ...
 */
@Slf4j
public class Idea63342Service {
    private static final int IDEA_ID = 63342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63342Service() {
        this(new Idea63342Config());
    }

    public Idea63342Service(Idea63342Config config) {
        this.config = config != null ? config : new Idea63342Config();
