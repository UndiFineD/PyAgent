...
@Data
public class Idea63233Config {
    private String name = "idea_063233";
 ...
 */
@Slf4j
public class Idea63233Service {
    private static final int IDEA_ID = 63233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63233Service() {
        this(new Idea63233Config());
    }

    public Idea63233Service(Idea63233Config config) {
        this.config = config != null ? config : new Idea63233Config();
