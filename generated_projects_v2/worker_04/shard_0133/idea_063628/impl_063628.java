...
@Data
public class Idea63628Config {
    private String name = "idea_063628";
 ...
 */
@Slf4j
public class Idea63628Service {
    private static final int IDEA_ID = 63628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63628Service() {
        this(new Idea63628Config());
    }

    public Idea63628Service(Idea63628Config config) {
        this.config = config != null ? config : new Idea63628Config();
