...
@Data
public class Idea63559Config {
    private String name = "idea_063559";
 ...
 */
@Slf4j
public class Idea63559Service {
    private static final int IDEA_ID = 63559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63559Service() {
        this(new Idea63559Config());
    }

    public Idea63559Service(Idea63559Config config) {
        this.config = config != null ? config : new Idea63559Config();
