...
@Data
public class Idea63456Config {
    private String name = "idea_063456";
 ...
 */
@Slf4j
public class Idea63456Service {
    private static final int IDEA_ID = 63456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63456Service() {
        this(new Idea63456Config());
    }

    public Idea63456Service(Idea63456Config config) {
        this.config = config != null ? config : new Idea63456Config();
