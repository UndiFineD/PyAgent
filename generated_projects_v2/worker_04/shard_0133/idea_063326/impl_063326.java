...
@Data
public class Idea63326Config {
    private String name = "idea_063326";
 ...
 */
@Slf4j
public class Idea63326Service {
    private static final int IDEA_ID = 63326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63326Service() {
        this(new Idea63326Config());
    }

    public Idea63326Service(Idea63326Config config) {
        this.config = config != null ? config : new Idea63326Config();
