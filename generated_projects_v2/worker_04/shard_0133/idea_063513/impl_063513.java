...
@Data
public class Idea63513Config {
    private String name = "idea_063513";
 ...
 */
@Slf4j
public class Idea63513Service {
    private static final int IDEA_ID = 63513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63513Service() {
        this(new Idea63513Config());
    }

    public Idea63513Service(Idea63513Config config) {
        this.config = config != null ? config : new Idea63513Config();
