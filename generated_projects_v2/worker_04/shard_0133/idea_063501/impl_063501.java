...
@Data
public class Idea63501Config {
    private String name = "idea_063501";
 ...
 */
@Slf4j
public class Idea63501Service {
    private static final int IDEA_ID = 63501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63501Service() {
        this(new Idea63501Config());
    }

    public Idea63501Service(Idea63501Config config) {
        this.config = config != null ? config : new Idea63501Config();
