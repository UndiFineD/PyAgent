...
@Data
public class Idea63351Config {
    private String name = "idea_063351";
 ...
 */
@Slf4j
public class Idea63351Service {
    private static final int IDEA_ID = 63351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63351Service() {
        this(new Idea63351Config());
    }

    public Idea63351Service(Idea63351Config config) {
        this.config = config != null ? config : new Idea63351Config();
