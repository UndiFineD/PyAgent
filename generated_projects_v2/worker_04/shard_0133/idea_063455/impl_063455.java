...
@Data
public class Idea63455Config {
    private String name = "idea_063455";
 ...
 */
@Slf4j
public class Idea63455Service {
    private static final int IDEA_ID = 63455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63455Service() {
        this(new Idea63455Config());
    }

    public Idea63455Service(Idea63455Config config) {
        this.config = config != null ? config : new Idea63455Config();
