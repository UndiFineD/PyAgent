...
@Data
public class Idea63529Config {
    private String name = "idea_063529";
 ...
 */
@Slf4j
public class Idea63529Service {
    private static final int IDEA_ID = 63529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63529Service() {
        this(new Idea63529Config());
    }

    public Idea63529Service(Idea63529Config config) {
        this.config = config != null ? config : new Idea63529Config();
