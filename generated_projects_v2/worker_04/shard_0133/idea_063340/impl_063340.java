...
@Data
public class Idea63340Config {
    private String name = "idea_063340";
 ...
 */
@Slf4j
public class Idea63340Service {
    private static final int IDEA_ID = 63340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63340Service() {
        this(new Idea63340Config());
    }

    public Idea63340Service(Idea63340Config config) {
        this.config = config != null ? config : new Idea63340Config();
