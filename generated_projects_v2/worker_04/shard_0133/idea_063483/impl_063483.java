...
@Data
public class Idea63483Config {
    private String name = "idea_063483";
 ...
 */
@Slf4j
public class Idea63483Service {
    private static final int IDEA_ID = 63483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63483Service() {
        this(new Idea63483Config());
    }

    public Idea63483Service(Idea63483Config config) {
        this.config = config != null ? config : new Idea63483Config();
