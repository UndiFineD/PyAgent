...
@Data
public class Idea63462Config {
    private String name = "idea_063462";
 ...
 */
@Slf4j
public class Idea63462Service {
    private static final int IDEA_ID = 63462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63462Service() {
        this(new Idea63462Config());
    }

    public Idea63462Service(Idea63462Config config) {
        this.config = config != null ? config : new Idea63462Config();
