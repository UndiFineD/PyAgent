...
@Data
public class Idea63332Config {
    private String name = "idea_063332";
 ...
 */
@Slf4j
public class Idea63332Service {
    private static final int IDEA_ID = 63332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63332Service() {
        this(new Idea63332Config());
    }

    public Idea63332Service(Idea63332Config config) {
        this.config = config != null ? config : new Idea63332Config();
