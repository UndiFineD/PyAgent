...
@Data
public class Idea63253Config {
    private String name = "idea_063253";
 ...
 */
@Slf4j
public class Idea63253Service {
    private static final int IDEA_ID = 63253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63253Service() {
        this(new Idea63253Config());
    }

    public Idea63253Service(Idea63253Config config) {
        this.config = config != null ? config : new Idea63253Config();
