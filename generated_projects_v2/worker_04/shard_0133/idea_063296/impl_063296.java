...
@Data
public class Idea63296Config {
    private String name = "idea_063296";
 ...
 */
@Slf4j
public class Idea63296Service {
    private static final int IDEA_ID = 63296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63296Service() {
        this(new Idea63296Config());
    }

    public Idea63296Service(Idea63296Config config) {
        this.config = config != null ? config : new Idea63296Config();
