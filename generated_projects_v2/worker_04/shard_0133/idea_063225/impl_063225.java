...
@Data
public class Idea63225Config {
    private String name = "idea_063225";
 ...
 */
@Slf4j
public class Idea63225Service {
    private static final int IDEA_ID = 63225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63225Service() {
        this(new Idea63225Config());
    }

    public Idea63225Service(Idea63225Config config) {
        this.config = config != null ? config : new Idea63225Config();
