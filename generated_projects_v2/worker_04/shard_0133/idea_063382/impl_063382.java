...
@Data
public class Idea63382Config {
    private String name = "idea_063382";
 ...
 */
@Slf4j
public class Idea63382Service {
    private static final int IDEA_ID = 63382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63382Service() {
        this(new Idea63382Config());
    }

    public Idea63382Service(Idea63382Config config) {
        this.config = config != null ? config : new Idea63382Config();
