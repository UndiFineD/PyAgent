...
@Data
public class Idea63486Config {
    private String name = "idea_063486";
 ...
 */
@Slf4j
public class Idea63486Service {
    private static final int IDEA_ID = 63486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63486Service() {
        this(new Idea63486Config());
    }

    public Idea63486Service(Idea63486Config config) {
        this.config = config != null ? config : new Idea63486Config();
