...
@Data
public class Idea63191Config {
    private String name = "idea_063191";
 ...
 */
@Slf4j
public class Idea63191Service {
    private static final int IDEA_ID = 63191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63191Service() {
        this(new Idea63191Config());
    }

    public Idea63191Service(Idea63191Config config) {
        this.config = config != null ? config : new Idea63191Config();
