...
@Data
public class Idea63446Config {
    private String name = "idea_063446";
 ...
 */
@Slf4j
public class Idea63446Service {
    private static final int IDEA_ID = 63446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63446Service() {
        this(new Idea63446Config());
    }

    public Idea63446Service(Idea63446Config config) {
        this.config = config != null ? config : new Idea63446Config();
