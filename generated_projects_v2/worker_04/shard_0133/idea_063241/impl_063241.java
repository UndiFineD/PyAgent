...
@Data
public class Idea63241Config {
    private String name = "idea_063241";
 ...
 */
@Slf4j
public class Idea63241Service {
    private static final int IDEA_ID = 63241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63241Service() {
        this(new Idea63241Config());
    }

    public Idea63241Service(Idea63241Config config) {
        this.config = config != null ? config : new Idea63241Config();
