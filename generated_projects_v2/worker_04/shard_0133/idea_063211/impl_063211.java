...
@Data
public class Idea63211Config {
    private String name = "idea_063211";
 ...
 */
@Slf4j
public class Idea63211Service {
    private static final int IDEA_ID = 63211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63211Service() {
        this(new Idea63211Config());
    }

    public Idea63211Service(Idea63211Config config) {
        this.config = config != null ? config : new Idea63211Config();
