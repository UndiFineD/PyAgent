...
@Data
public class Idea63504Config {
    private String name = "idea_063504";
 ...
 */
@Slf4j
public class Idea63504Service {
    private static final int IDEA_ID = 63504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63504Service() {
        this(new Idea63504Config());
    }

    public Idea63504Service(Idea63504Config config) {
        this.config = config != null ? config : new Idea63504Config();
