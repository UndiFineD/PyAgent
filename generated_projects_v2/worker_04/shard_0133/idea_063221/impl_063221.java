...
@Data
public class Idea63221Config {
    private String name = "idea_063221";
 ...
 */
@Slf4j
public class Idea63221Service {
    private static final int IDEA_ID = 63221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63221Service() {
        this(new Idea63221Config());
    }

    public Idea63221Service(Idea63221Config config) {
        this.config = config != null ? config : new Idea63221Config();
