...
@Data
public class Idea63600Config {
    private String name = "idea_063600";
 ...
 */
@Slf4j
public class Idea63600Service {
    private static final int IDEA_ID = 63600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63600Service() {
        this(new Idea63600Config());
    }

    public Idea63600Service(Idea63600Config config) {
        this.config = config != null ? config : new Idea63600Config();
