...
@Data
public class Idea63213Config {
    private String name = "idea_063213";
 ...
 */
@Slf4j
public class Idea63213Service {
    private static final int IDEA_ID = 63213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63213Service() {
        this(new Idea63213Config());
    }

    public Idea63213Service(Idea63213Config config) {
        this.config = config != null ? config : new Idea63213Config();
