...
@Data
public class Idea63248Config {
    private String name = "idea_063248";
 ...
 */
@Slf4j
public class Idea63248Service {
    private static final int IDEA_ID = 63248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63248Service() {
        this(new Idea63248Config());
    }

    public Idea63248Service(Idea63248Config config) {
        this.config = config != null ? config : new Idea63248Config();
