...
@Data
public class Idea63553Config {
    private String name = "idea_063553";
 ...
 */
@Slf4j
public class Idea63553Service {
    private static final int IDEA_ID = 63553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63553Service() {
        this(new Idea63553Config());
    }

    public Idea63553Service(Idea63553Config config) {
        this.config = config != null ? config : new Idea63553Config();
