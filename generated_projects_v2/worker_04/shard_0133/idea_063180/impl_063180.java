...
@Data
public class Idea63180Config {
    private String name = "idea_063180";
 ...
 */
@Slf4j
public class Idea63180Service {
    private static final int IDEA_ID = 63180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63180Service() {
        this(new Idea63180Config());
    }

    public Idea63180Service(Idea63180Config config) {
        this.config = config != null ? config : new Idea63180Config();
