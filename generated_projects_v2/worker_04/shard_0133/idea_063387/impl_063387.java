...
@Data
public class Idea63387Config {
    private String name = "idea_063387";
 ...
 */
@Slf4j
public class Idea63387Service {
    private static final int IDEA_ID = 63387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63387Service() {
        this(new Idea63387Config());
    }

    public Idea63387Service(Idea63387Config config) {
        this.config = config != null ? config : new Idea63387Config();
