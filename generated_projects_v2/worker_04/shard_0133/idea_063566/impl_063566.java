...
@Data
public class Idea63566Config {
    private String name = "idea_063566";
 ...
 */
@Slf4j
public class Idea63566Service {
    private static final int IDEA_ID = 63566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63566Service() {
        this(new Idea63566Config());
    }

    public Idea63566Service(Idea63566Config config) {
        this.config = config != null ? config : new Idea63566Config();
