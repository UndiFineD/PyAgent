...
@Data
public class Idea63287Config {
    private String name = "idea_063287";
 ...
 */
@Slf4j
public class Idea63287Service {
    private static final int IDEA_ID = 63287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63287Service() {
        this(new Idea63287Config());
    }

    public Idea63287Service(Idea63287Config config) {
        this.config = config != null ? config : new Idea63287Config();
