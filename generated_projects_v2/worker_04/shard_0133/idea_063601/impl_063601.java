...
@Data
public class Idea63601Config {
    private String name = "idea_063601";
 ...
 */
@Slf4j
public class Idea63601Service {
    private static final int IDEA_ID = 63601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63601Service() {
        this(new Idea63601Config());
    }

    public Idea63601Service(Idea63601Config config) {
        this.config = config != null ? config : new Idea63601Config();
