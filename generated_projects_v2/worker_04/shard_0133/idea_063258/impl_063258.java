...
@Data
public class Idea63258Config {
    private String name = "idea_063258";
 ...
 */
@Slf4j
public class Idea63258Service {
    private static final int IDEA_ID = 63258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63258Service() {
        this(new Idea63258Config());
    }

    public Idea63258Service(Idea63258Config config) {
        this.config = config != null ? config : new Idea63258Config();
