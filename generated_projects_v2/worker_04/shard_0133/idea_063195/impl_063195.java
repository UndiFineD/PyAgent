...
@Data
public class Idea63195Config {
    private String name = "idea_063195";
 ...
 */
@Slf4j
public class Idea63195Service {
    private static final int IDEA_ID = 63195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63195Service() {
        this(new Idea63195Config());
    }

    public Idea63195Service(Idea63195Config config) {
        this.config = config != null ? config : new Idea63195Config();
