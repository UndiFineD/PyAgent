...
@Data
public class Idea63215Config {
    private String name = "idea_063215";
 ...
 */
@Slf4j
public class Idea63215Service {
    private static final int IDEA_ID = 63215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63215Service() {
        this(new Idea63215Config());
    }

    public Idea63215Service(Idea63215Config config) {
        this.config = config != null ? config : new Idea63215Config();
