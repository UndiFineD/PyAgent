...
@Data
public class Idea63495Config {
    private String name = "idea_063495";
 ...
 */
@Slf4j
public class Idea63495Service {
    private static final int IDEA_ID = 63495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63495Service() {
        this(new Idea63495Config());
    }

    public Idea63495Service(Idea63495Config config) {
        this.config = config != null ? config : new Idea63495Config();
