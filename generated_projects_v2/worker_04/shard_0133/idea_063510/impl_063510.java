...
@Data
public class Idea63510Config {
    private String name = "idea_063510";
 ...
 */
@Slf4j
public class Idea63510Service {
    private static final int IDEA_ID = 63510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63510Service() {
        this(new Idea63510Config());
    }

    public Idea63510Service(Idea63510Config config) {
        this.config = config != null ? config : new Idea63510Config();
