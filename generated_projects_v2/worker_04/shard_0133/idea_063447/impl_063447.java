...
@Data
public class Idea63447Config {
    private String name = "idea_063447";
 ...
 */
@Slf4j
public class Idea63447Service {
    private static final int IDEA_ID = 63447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63447Service() {
        this(new Idea63447Config());
    }

    public Idea63447Service(Idea63447Config config) {
        this.config = config != null ? config : new Idea63447Config();
