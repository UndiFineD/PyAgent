...
@Data
public class Idea63538Config {
    private String name = "idea_063538";
 ...
 */
@Slf4j
public class Idea63538Service {
    private static final int IDEA_ID = 63538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63538Service() {
        this(new Idea63538Config());
    }

    public Idea63538Service(Idea63538Config config) {
        this.config = config != null ? config : new Idea63538Config();
