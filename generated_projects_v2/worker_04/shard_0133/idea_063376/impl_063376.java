...
@Data
public class Idea63376Config {
    private String name = "idea_063376";
 ...
 */
@Slf4j
public class Idea63376Service {
    private static final int IDEA_ID = 63376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63376Service() {
        this(new Idea63376Config());
    }

    public Idea63376Service(Idea63376Config config) {
        this.config = config != null ? config : new Idea63376Config();
