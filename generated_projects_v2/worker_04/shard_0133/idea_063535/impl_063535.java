...
@Data
public class Idea63535Config {
    private String name = "idea_063535";
 ...
 */
@Slf4j
public class Idea63535Service {
    private static final int IDEA_ID = 63535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63535Service() {
        this(new Idea63535Config());
    }

    public Idea63535Service(Idea63535Config config) {
        this.config = config != null ? config : new Idea63535Config();
