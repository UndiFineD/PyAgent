...
@Data
public class Idea63605Config {
    private String name = "idea_063605";
 ...
 */
@Slf4j
public class Idea63605Service {
    private static final int IDEA_ID = 63605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63605Service() {
        this(new Idea63605Config());
    }

    public Idea63605Service(Idea63605Config config) {
        this.config = config != null ? config : new Idea63605Config();
