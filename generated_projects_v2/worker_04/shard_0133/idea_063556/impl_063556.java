...
@Data
public class Idea63556Config {
    private String name = "idea_063556";
 ...
 */
@Slf4j
public class Idea63556Service {
    private static final int IDEA_ID = 63556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63556Service() {
        this(new Idea63556Config());
    }

    public Idea63556Service(Idea63556Config config) {
        this.config = config != null ? config : new Idea63556Config();
