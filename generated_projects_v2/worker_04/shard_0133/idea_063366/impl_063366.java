...
@Data
public class Idea63366Config {
    private String name = "idea_063366";
 ...
 */
@Slf4j
public class Idea63366Service {
    private static final int IDEA_ID = 63366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63366Service() {
        this(new Idea63366Config());
    }

    public Idea63366Service(Idea63366Config config) {
        this.config = config != null ? config : new Idea63366Config();
