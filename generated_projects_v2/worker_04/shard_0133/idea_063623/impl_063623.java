...
@Data
public class Idea63623Config {
    private String name = "idea_063623";
 ...
 */
@Slf4j
public class Idea63623Service {
    private static final int IDEA_ID = 63623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63623Service() {
        this(new Idea63623Config());
    }

    public Idea63623Service(Idea63623Config config) {
        this.config = config != null ? config : new Idea63623Config();
