...
@Data
public class Idea63344Config {
    private String name = "idea_063344";
 ...
 */
@Slf4j
public class Idea63344Service {
    private static final int IDEA_ID = 63344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63344Service() {
        this(new Idea63344Config());
    }

    public Idea63344Service(Idea63344Config config) {
        this.config = config != null ? config : new Idea63344Config();
