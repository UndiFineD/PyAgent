...
@Data
public class Idea63357Config {
    private String name = "idea_063357";
 ...
 */
@Slf4j
public class Idea63357Service {
    private static final int IDEA_ID = 63357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63357Service() {
        this(new Idea63357Config());
    }

    public Idea63357Service(Idea63357Config config) {
        this.config = config != null ? config : new Idea63357Config();
