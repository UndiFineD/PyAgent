...
@Data
public class Idea63325Config {
    private String name = "idea_063325";
 ...
 */
@Slf4j
public class Idea63325Service {
    private static final int IDEA_ID = 63325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63325Service() {
        this(new Idea63325Config());
    }

    public Idea63325Service(Idea63325Config config) {
        this.config = config != null ? config : new Idea63325Config();
