...
@Data
public class Idea63565Config {
    private String name = "idea_063565";
 ...
 */
@Slf4j
public class Idea63565Service {
    private static final int IDEA_ID = 63565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63565Service() {
        this(new Idea63565Config());
    }

    public Idea63565Service(Idea63565Config config) {
        this.config = config != null ? config : new Idea63565Config();
