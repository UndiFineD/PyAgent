...
@Data
public class Idea63210Config {
    private String name = "idea_063210";
 ...
 */
@Slf4j
public class Idea63210Service {
    private static final int IDEA_ID = 63210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63210Service() {
        this(new Idea63210Config());
    }

    public Idea63210Service(Idea63210Config config) {
        this.config = config != null ? config : new Idea63210Config();
