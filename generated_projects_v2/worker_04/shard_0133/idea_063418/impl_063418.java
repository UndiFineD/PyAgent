...
@Data
public class Idea63418Config {
    private String name = "idea_063418";
 ...
 */
@Slf4j
public class Idea63418Service {
    private static final int IDEA_ID = 63418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63418Service() {
        this(new Idea63418Config());
    }

    public Idea63418Service(Idea63418Config config) {
        this.config = config != null ? config : new Idea63418Config();
