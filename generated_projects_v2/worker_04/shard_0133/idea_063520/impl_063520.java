...
@Data
public class Idea63520Config {
    private String name = "idea_063520";
 ...
 */
@Slf4j
public class Idea63520Service {
    private static final int IDEA_ID = 63520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63520Service() {
        this(new Idea63520Config());
    }

    public Idea63520Service(Idea63520Config config) {
        this.config = config != null ? config : new Idea63520Config();
