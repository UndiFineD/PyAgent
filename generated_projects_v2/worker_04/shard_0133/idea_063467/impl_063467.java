...
@Data
public class Idea63467Config {
    private String name = "idea_063467";
 ...
 */
@Slf4j
public class Idea63467Service {
    private static final int IDEA_ID = 63467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63467Service() {
        this(new Idea63467Config());
    }

    public Idea63467Service(Idea63467Config config) {
        this.config = config != null ? config : new Idea63467Config();
