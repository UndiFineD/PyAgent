...
@Data
public class Idea63560Config {
    private String name = "idea_063560";
 ...
 */
@Slf4j
public class Idea63560Service {
    private static final int IDEA_ID = 63560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63560Service() {
        this(new Idea63560Config());
    }

    public Idea63560Service(Idea63560Config config) {
        this.config = config != null ? config : new Idea63560Config();
