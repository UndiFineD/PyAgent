...
@Data
public class Idea63352Config {
    private String name = "idea_063352";
 ...
 */
@Slf4j
public class Idea63352Service {
    private static final int IDEA_ID = 63352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63352Service() {
        this(new Idea63352Config());
    }

    public Idea63352Service(Idea63352Config config) {
        this.config = config != null ? config : new Idea63352Config();
