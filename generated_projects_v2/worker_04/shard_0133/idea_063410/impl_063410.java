...
@Data
public class Idea63410Config {
    private String name = "idea_063410";
 ...
 */
@Slf4j
public class Idea63410Service {
    private static final int IDEA_ID = 63410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63410Service() {
        this(new Idea63410Config());
    }

    public Idea63410Service(Idea63410Config config) {
        this.config = config != null ? config : new Idea63410Config();
