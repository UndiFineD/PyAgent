...
@Data
public class Idea63307Config {
    private String name = "idea_063307";
 ...
 */
@Slf4j
public class Idea63307Service {
    private static final int IDEA_ID = 63307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63307Service() {
        this(new Idea63307Config());
    }

    public Idea63307Service(Idea63307Config config) {
        this.config = config != null ? config : new Idea63307Config();
