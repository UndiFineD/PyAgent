...
@Data
public class Idea63634Config {
    private String name = "idea_063634";
 ...
 */
@Slf4j
public class Idea63634Service {
    private static final int IDEA_ID = 63634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63634Service() {
        this(new Idea63634Config());
    }

    public Idea63634Service(Idea63634Config config) {
        this.config = config != null ? config : new Idea63634Config();
