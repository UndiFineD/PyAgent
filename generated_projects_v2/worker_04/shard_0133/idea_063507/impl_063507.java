...
@Data
public class Idea63507Config {
    private String name = "idea_063507";
 ...
 */
@Slf4j
public class Idea63507Service {
    private static final int IDEA_ID = 63507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63507Service() {
        this(new Idea63507Config());
    }

    public Idea63507Service(Idea63507Config config) {
        this.config = config != null ? config : new Idea63507Config();
