...
@Data
public class Idea63359Config {
    private String name = "idea_063359";
 ...
 */
@Slf4j
public class Idea63359Service {
    private static final int IDEA_ID = 63359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63359Service() {
        this(new Idea63359Config());
    }

    public Idea63359Service(Idea63359Config config) {
        this.config = config != null ? config : new Idea63359Config();
