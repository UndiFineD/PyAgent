...
@Data
public class Idea63624Config {
    private String name = "idea_063624";
 ...
 */
@Slf4j
public class Idea63624Service {
    private static final int IDEA_ID = 63624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63624Service() {
        this(new Idea63624Config());
    }

    public Idea63624Service(Idea63624Config config) {
        this.config = config != null ? config : new Idea63624Config();
