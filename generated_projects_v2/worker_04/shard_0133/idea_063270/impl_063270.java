...
@Data
public class Idea63270Config {
    private String name = "idea_063270";
 ...
 */
@Slf4j
public class Idea63270Service {
    private static final int IDEA_ID = 63270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63270Service() {
        this(new Idea63270Config());
    }

    public Idea63270Service(Idea63270Config config) {
        this.config = config != null ? config : new Idea63270Config();
