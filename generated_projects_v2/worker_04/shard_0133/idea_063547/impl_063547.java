...
@Data
public class Idea63547Config {
    private String name = "idea_063547";
 ...
 */
@Slf4j
public class Idea63547Service {
    private static final int IDEA_ID = 63547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63547Service() {
        this(new Idea63547Config());
    }

    public Idea63547Service(Idea63547Config config) {
        this.config = config != null ? config : new Idea63547Config();
