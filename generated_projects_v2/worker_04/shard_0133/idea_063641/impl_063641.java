...
@Data
public class Idea63641Config {
    private String name = "idea_063641";
 ...
 */
@Slf4j
public class Idea63641Service {
    private static final int IDEA_ID = 63641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63641Service() {
        this(new Idea63641Config());
    }

    public Idea63641Service(Idea63641Config config) {
        this.config = config != null ? config : new Idea63641Config();
