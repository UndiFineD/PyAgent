...
@Data
public class Idea63278Config {
    private String name = "idea_063278";
 ...
 */
@Slf4j
public class Idea63278Service {
    private static final int IDEA_ID = 63278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63278Service() {
        this(new Idea63278Config());
    }

    public Idea63278Service(Idea63278Config config) {
        this.config = config != null ? config : new Idea63278Config();
