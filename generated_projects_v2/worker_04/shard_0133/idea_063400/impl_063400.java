...
@Data
public class Idea63400Config {
    private String name = "idea_063400";
 ...
 */
@Slf4j
public class Idea63400Service {
    private static final int IDEA_ID = 63400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63400Service() {
        this(new Idea63400Config());
    }

    public Idea63400Service(Idea63400Config config) {
        this.config = config != null ? config : new Idea63400Config();
