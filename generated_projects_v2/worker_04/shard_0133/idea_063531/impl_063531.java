...
@Data
public class Idea63531Config {
    private String name = "idea_063531";
 ...
 */
@Slf4j
public class Idea63531Service {
    private static final int IDEA_ID = 63531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63531Service() {
        this(new Idea63531Config());
    }

    public Idea63531Service(Idea63531Config config) {
        this.config = config != null ? config : new Idea63531Config();
