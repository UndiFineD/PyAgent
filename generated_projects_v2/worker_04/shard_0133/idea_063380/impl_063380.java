...
@Data
public class Idea63380Config {
    private String name = "idea_063380";
 ...
 */
@Slf4j
public class Idea63380Service {
    private static final int IDEA_ID = 63380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63380Service() {
        this(new Idea63380Config());
    }

    public Idea63380Service(Idea63380Config config) {
        this.config = config != null ? config : new Idea63380Config();
