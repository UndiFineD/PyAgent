...
@Data
public class Idea63477Config {
    private String name = "idea_063477";
 ...
 */
@Slf4j
public class Idea63477Service {
    private static final int IDEA_ID = 63477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63477Service() {
        this(new Idea63477Config());
    }

    public Idea63477Service(Idea63477Config config) {
        this.config = config != null ? config : new Idea63477Config();
