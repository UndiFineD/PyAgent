...
@Data
public class Idea63534Config {
    private String name = "idea_063534";
 ...
 */
@Slf4j
public class Idea63534Service {
    private static final int IDEA_ID = 63534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63534Service() {
        this(new Idea63534Config());
    }

    public Idea63534Service(Idea63534Config config) {
        this.config = config != null ? config : new Idea63534Config();
