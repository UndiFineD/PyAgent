...
@Data
public class Idea63230Config {
    private String name = "idea_063230";
 ...
 */
@Slf4j
public class Idea63230Service {
    private static final int IDEA_ID = 63230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63230Service() {
        this(new Idea63230Config());
    }

    public Idea63230Service(Idea63230Config config) {
        this.config = config != null ? config : new Idea63230Config();
