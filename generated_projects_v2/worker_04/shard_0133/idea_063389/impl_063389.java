...
@Data
public class Idea63389Config {
    private String name = "idea_063389";
 ...
 */
@Slf4j
public class Idea63389Service {
    private static final int IDEA_ID = 63389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63389Service() {
        this(new Idea63389Config());
    }

    public Idea63389Service(Idea63389Config config) {
        this.config = config != null ? config : new Idea63389Config();
