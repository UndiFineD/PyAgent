...
@Data
public class Idea63611Config {
    private String name = "idea_063611";
 ...
 */
@Slf4j
public class Idea63611Service {
    private static final int IDEA_ID = 63611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63611Service() {
        this(new Idea63611Config());
    }

    public Idea63611Service(Idea63611Config config) {
        this.config = config != null ? config : new Idea63611Config();
