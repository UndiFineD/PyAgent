...
@Data
public class Idea63607Config {
    private String name = "idea_063607";
 ...
 */
@Slf4j
public class Idea63607Service {
    private static final int IDEA_ID = 63607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63607Service() {
        this(new Idea63607Config());
    }

    public Idea63607Service(Idea63607Config config) {
        this.config = config != null ? config : new Idea63607Config();
