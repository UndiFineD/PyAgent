...
@Data
public class Idea63336Config {
    private String name = "idea_063336";
 ...
 */
@Slf4j
public class Idea63336Service {
    private static final int IDEA_ID = 63336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63336Service() {
        this(new Idea63336Config());
    }

    public Idea63336Service(Idea63336Config config) {
        this.config = config != null ? config : new Idea63336Config();
