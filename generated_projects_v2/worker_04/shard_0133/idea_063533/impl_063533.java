...
@Data
public class Idea63533Config {
    private String name = "idea_063533";
 ...
 */
@Slf4j
public class Idea63533Service {
    private static final int IDEA_ID = 63533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63533Service() {
        this(new Idea63533Config());
    }

    public Idea63533Service(Idea63533Config config) {
        this.config = config != null ? config : new Idea63533Config();
