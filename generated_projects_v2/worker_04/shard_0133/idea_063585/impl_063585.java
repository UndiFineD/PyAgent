...
@Data
public class Idea63585Config {
    private String name = "idea_063585";
 ...
 */
@Slf4j
public class Idea63585Service {
    private static final int IDEA_ID = 63585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63585Service() {
        this(new Idea63585Config());
    }

    public Idea63585Service(Idea63585Config config) {
        this.config = config != null ? config : new Idea63585Config();
