...
@Data
public class Idea63392Config {
    private String name = "idea_063392";
 ...
 */
@Slf4j
public class Idea63392Service {
    private static final int IDEA_ID = 63392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63392Service() {
        this(new Idea63392Config());
    }

    public Idea63392Service(Idea63392Config config) {
        this.config = config != null ? config : new Idea63392Config();
