...
@Data
public class Idea63460Config {
    private String name = "idea_063460";
 ...
 */
@Slf4j
public class Idea63460Service {
    private static final int IDEA_ID = 63460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63460Service() {
        this(new Idea63460Config());
    }

    public Idea63460Service(Idea63460Config config) {
        this.config = config != null ? config : new Idea63460Config();
