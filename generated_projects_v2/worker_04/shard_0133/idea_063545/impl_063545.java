...
@Data
public class Idea63545Config {
    private String name = "idea_063545";
 ...
 */
@Slf4j
public class Idea63545Service {
    private static final int IDEA_ID = 63545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63545Service() {
        this(new Idea63545Config());
    }

    public Idea63545Service(Idea63545Config config) {
        this.config = config != null ? config : new Idea63545Config();
