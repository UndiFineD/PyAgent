...
@Data
public class Idea63232Config {
    private String name = "idea_063232";
 ...
 */
@Slf4j
public class Idea63232Service {
    private static final int IDEA_ID = 63232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63232Service() {
        this(new Idea63232Config());
    }

    public Idea63232Service(Idea63232Config config) {
        this.config = config != null ? config : new Idea63232Config();
