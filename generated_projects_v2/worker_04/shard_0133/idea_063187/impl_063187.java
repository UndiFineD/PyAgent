...
@Data
public class Idea63187Config {
    private String name = "idea_063187";
 ...
 */
@Slf4j
public class Idea63187Service {
    private static final int IDEA_ID = 63187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63187Service() {
        this(new Idea63187Config());
    }

    public Idea63187Service(Idea63187Config config) {
        this.config = config != null ? config : new Idea63187Config();
