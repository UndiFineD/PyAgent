...
@Data
public class Idea63283Config {
    private String name = "idea_063283";
 ...
 */
@Slf4j
public class Idea63283Service {
    private static final int IDEA_ID = 63283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63283Service() {
        this(new Idea63283Config());
    }

    public Idea63283Service(Idea63283Config config) {
        this.config = config != null ? config : new Idea63283Config();
