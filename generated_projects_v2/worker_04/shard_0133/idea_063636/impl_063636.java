...
@Data
public class Idea63636Config {
    private String name = "idea_063636";
 ...
 */
@Slf4j
public class Idea63636Service {
    private static final int IDEA_ID = 63636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63636Service() {
        this(new Idea63636Config());
    }

    public Idea63636Service(Idea63636Config config) {
        this.config = config != null ? config : new Idea63636Config();
