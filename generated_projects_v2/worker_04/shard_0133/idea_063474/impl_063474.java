...
@Data
public class Idea63474Config {
    private String name = "idea_063474";
 ...
 */
@Slf4j
public class Idea63474Service {
    private static final int IDEA_ID = 63474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63474Service() {
        this(new Idea63474Config());
    }

    public Idea63474Service(Idea63474Config config) {
        this.config = config != null ? config : new Idea63474Config();
