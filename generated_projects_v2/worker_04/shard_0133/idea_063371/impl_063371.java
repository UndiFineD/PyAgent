...
@Data
public class Idea63371Config {
    private String name = "idea_063371";
 ...
 */
@Slf4j
public class Idea63371Service {
    private static final int IDEA_ID = 63371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63371Service() {
        this(new Idea63371Config());
    }

    public Idea63371Service(Idea63371Config config) {
        this.config = config != null ? config : new Idea63371Config();
