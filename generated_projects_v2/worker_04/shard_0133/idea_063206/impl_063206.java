...
@Data
public class Idea63206Config {
    private String name = "idea_063206";
 ...
 */
@Slf4j
public class Idea63206Service {
    private static final int IDEA_ID = 63206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63206Service() {
        this(new Idea63206Config());
    }

    public Idea63206Service(Idea63206Config config) {
        this.config = config != null ? config : new Idea63206Config();
