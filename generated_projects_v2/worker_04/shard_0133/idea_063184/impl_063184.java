...
@Data
public class Idea63184Config {
    private String name = "idea_063184";
 ...
 */
@Slf4j
public class Idea63184Service {
    private static final int IDEA_ID = 63184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63184Service() {
        this(new Idea63184Config());
    }

    public Idea63184Service(Idea63184Config config) {
        this.config = config != null ? config : new Idea63184Config();
