...
@Data
public class Idea63420Config {
    private String name = "idea_063420";
 ...
 */
@Slf4j
public class Idea63420Service {
    private static final int IDEA_ID = 63420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63420Service() {
        this(new Idea63420Config());
    }

    public Idea63420Service(Idea63420Config config) {
        this.config = config != null ? config : new Idea63420Config();
