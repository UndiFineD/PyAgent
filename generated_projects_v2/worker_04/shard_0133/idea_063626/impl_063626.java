...
@Data
public class Idea63626Config {
    private String name = "idea_063626";
 ...
 */
@Slf4j
public class Idea63626Service {
    private static final int IDEA_ID = 63626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63626Service() {
        this(new Idea63626Config());
    }

    public Idea63626Service(Idea63626Config config) {
        this.config = config != null ? config : new Idea63626Config();
