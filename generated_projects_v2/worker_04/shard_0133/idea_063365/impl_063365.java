...
@Data
public class Idea63365Config {
    private String name = "idea_063365";
 ...
 */
@Slf4j
public class Idea63365Service {
    private static final int IDEA_ID = 63365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63365Service() {
        this(new Idea63365Config());
    }

    public Idea63365Service(Idea63365Config config) {
        this.config = config != null ? config : new Idea63365Config();
