...
@Data
public class Idea63301Config {
    private String name = "idea_063301";
 ...
 */
@Slf4j
public class Idea63301Service {
    private static final int IDEA_ID = 63301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63301Service() {
        this(new Idea63301Config());
    }

    public Idea63301Service(Idea63301Config config) {
        this.config = config != null ? config : new Idea63301Config();
