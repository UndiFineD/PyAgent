...
@Data
public class Idea63396Config {
    private String name = "idea_063396";
 ...
 */
@Slf4j
public class Idea63396Service {
    private static final int IDEA_ID = 63396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63396Service() {
        this(new Idea63396Config());
    }

    public Idea63396Service(Idea63396Config config) {
        this.config = config != null ? config : new Idea63396Config();
