...
@Data
public class Idea63568Config {
    private String name = "idea_063568";
 ...
 */
@Slf4j
public class Idea63568Service {
    private static final int IDEA_ID = 63568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63568Service() {
        this(new Idea63568Config());
    }

    public Idea63568Service(Idea63568Config config) {
        this.config = config != null ? config : new Idea63568Config();
