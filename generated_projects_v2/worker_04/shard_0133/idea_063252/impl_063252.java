...
@Data
public class Idea63252Config {
    private String name = "idea_063252";
 ...
 */
@Slf4j
public class Idea63252Service {
    private static final int IDEA_ID = 63252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63252Service() {
        this(new Idea63252Config());
    }

    public Idea63252Service(Idea63252Config config) {
        this.config = config != null ? config : new Idea63252Config();
