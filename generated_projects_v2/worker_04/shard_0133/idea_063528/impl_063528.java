...
@Data
public class Idea63528Config {
    private String name = "idea_063528";
 ...
 */
@Slf4j
public class Idea63528Service {
    private static final int IDEA_ID = 63528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63528Service() {
        this(new Idea63528Config());
    }

    public Idea63528Service(Idea63528Config config) {
        this.config = config != null ? config : new Idea63528Config();
