...
@Data
public class Idea63564Config {
    private String name = "idea_063564";
 ...
 */
@Slf4j
public class Idea63564Service {
    private static final int IDEA_ID = 63564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63564Service() {
        this(new Idea63564Config());
    }

    public Idea63564Service(Idea63564Config config) {
        this.config = config != null ? config : new Idea63564Config();
