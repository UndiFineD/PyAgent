...
@Data
public class Idea63201Config {
    private String name = "idea_063201";
 ...
 */
@Slf4j
public class Idea63201Service {
    private static final int IDEA_ID = 63201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63201Service() {
        this(new Idea63201Config());
    }

    public Idea63201Service(Idea63201Config config) {
        this.config = config != null ? config : new Idea63201Config();
