...
@Data
public class Idea63592Config {
    private String name = "idea_063592";
 ...
 */
@Slf4j
public class Idea63592Service {
    private static final int IDEA_ID = 63592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63592Service() {
        this(new Idea63592Config());
    }

    public Idea63592Service(Idea63592Config config) {
        this.config = config != null ? config : new Idea63592Config();
