...
@Data
public class Idea63506Config {
    private String name = "idea_063506";
 ...
 */
@Slf4j
public class Idea63506Service {
    private static final int IDEA_ID = 63506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63506Service() {
        this(new Idea63506Config());
    }

    public Idea63506Service(Idea63506Config config) {
        this.config = config != null ? config : new Idea63506Config();
