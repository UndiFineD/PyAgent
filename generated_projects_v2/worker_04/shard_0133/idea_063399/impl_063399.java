...
@Data
public class Idea63399Config {
    private String name = "idea_063399";
 ...
 */
@Slf4j
public class Idea63399Service {
    private static final int IDEA_ID = 63399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63399Service() {
        this(new Idea63399Config());
    }

    public Idea63399Service(Idea63399Config config) {
        this.config = config != null ? config : new Idea63399Config();
