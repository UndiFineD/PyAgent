...
@Data
public class Idea63298Config {
    private String name = "idea_063298";
 ...
 */
@Slf4j
public class Idea63298Service {
    private static final int IDEA_ID = 63298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63298Service() {
        this(new Idea63298Config());
    }

    public Idea63298Service(Idea63298Config config) {
        this.config = config != null ? config : new Idea63298Config();
