...
@Data
public class Idea63591Config {
    private String name = "idea_063591";
 ...
 */
@Slf4j
public class Idea63591Service {
    private static final int IDEA_ID = 63591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63591Service() {
        this(new Idea63591Config());
    }

    public Idea63591Service(Idea63591Config config) {
        this.config = config != null ? config : new Idea63591Config();
