...
@Data
public class Idea63295Config {
    private String name = "idea_063295";
 ...
 */
@Slf4j
public class Idea63295Service {
    private static final int IDEA_ID = 63295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63295Service() {
        this(new Idea63295Config());
    }

    public Idea63295Service(Idea63295Config config) {
        this.config = config != null ? config : new Idea63295Config();
