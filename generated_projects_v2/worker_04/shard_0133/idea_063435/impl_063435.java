...
@Data
public class Idea63435Config {
    private String name = "idea_063435";
 ...
 */
@Slf4j
public class Idea63435Service {
    private static final int IDEA_ID = 63435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63435Service() {
        this(new Idea63435Config());
    }

    public Idea63435Service(Idea63435Config config) {
        this.config = config != null ? config : new Idea63435Config();
