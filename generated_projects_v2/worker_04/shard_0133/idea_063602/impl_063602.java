...
@Data
public class Idea63602Config {
    private String name = "idea_063602";
 ...
 */
@Slf4j
public class Idea63602Service {
    private static final int IDEA_ID = 63602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63602Service() {
        this(new Idea63602Config());
    }

    public Idea63602Service(Idea63602Config config) {
        this.config = config != null ? config : new Idea63602Config();
