...
@Data
public class Idea63470Config {
    private String name = "idea_063470";
 ...
 */
@Slf4j
public class Idea63470Service {
    private static final int IDEA_ID = 63470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63470Service() {
        this(new Idea63470Config());
    }

    public Idea63470Service(Idea63470Config config) {
        this.config = config != null ? config : new Idea63470Config();
