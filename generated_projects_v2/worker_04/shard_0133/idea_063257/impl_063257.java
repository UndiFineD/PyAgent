...
@Data
public class Idea63257Config {
    private String name = "idea_063257";
 ...
 */
@Slf4j
public class Idea63257Service {
    private static final int IDEA_ID = 63257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63257Service() {
        this(new Idea63257Config());
    }

    public Idea63257Service(Idea63257Config config) {
        this.config = config != null ? config : new Idea63257Config();
