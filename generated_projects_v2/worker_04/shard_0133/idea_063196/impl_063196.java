...
@Data
public class Idea63196Config {
    private String name = "idea_063196";
 ...
 */
@Slf4j
public class Idea63196Service {
    private static final int IDEA_ID = 63196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63196Service() {
        this(new Idea63196Config());
    }

    public Idea63196Service(Idea63196Config config) {
        this.config = config != null ? config : new Idea63196Config();
