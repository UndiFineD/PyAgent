...
@Data
public class Idea63431Config {
    private String name = "idea_063431";
 ...
 */
@Slf4j
public class Idea63431Service {
    private static final int IDEA_ID = 63431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63431Service() {
        this(new Idea63431Config());
    }

    public Idea63431Service(Idea63431Config config) {
        this.config = config != null ? config : new Idea63431Config();
