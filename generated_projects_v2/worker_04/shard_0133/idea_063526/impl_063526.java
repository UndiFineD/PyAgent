...
@Data
public class Idea63526Config {
    private String name = "idea_063526";
 ...
 */
@Slf4j
public class Idea63526Service {
    private static final int IDEA_ID = 63526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63526Service() {
        this(new Idea63526Config());
    }

    public Idea63526Service(Idea63526Config config) {
        this.config = config != null ? config : new Idea63526Config();
