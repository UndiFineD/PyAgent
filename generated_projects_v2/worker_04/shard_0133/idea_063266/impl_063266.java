...
@Data
public class Idea63266Config {
    private String name = "idea_063266";
 ...
 */
@Slf4j
public class Idea63266Service {
    private static final int IDEA_ID = 63266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63266Service() {
        this(new Idea63266Config());
    }

    public Idea63266Service(Idea63266Config config) {
        this.config = config != null ? config : new Idea63266Config();
