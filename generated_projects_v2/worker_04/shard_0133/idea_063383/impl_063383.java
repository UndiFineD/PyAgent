...
@Data
public class Idea63383Config {
    private String name = "idea_063383";
 ...
 */
@Slf4j
public class Idea63383Service {
    private static final int IDEA_ID = 63383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63383Service() {
        this(new Idea63383Config());
    }

    public Idea63383Service(Idea63383Config config) {
        this.config = config != null ? config : new Idea63383Config();
