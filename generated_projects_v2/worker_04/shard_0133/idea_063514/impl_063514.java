...
@Data
public class Idea63514Config {
    private String name = "idea_063514";
 ...
 */
@Slf4j
public class Idea63514Service {
    private static final int IDEA_ID = 63514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63514Service() {
        this(new Idea63514Config());
    }

    public Idea63514Service(Idea63514Config config) {
        this.config = config != null ? config : new Idea63514Config();
