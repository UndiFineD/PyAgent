...
@Data
public class Idea63426Config {
    private String name = "idea_063426";
 ...
 */
@Slf4j
public class Idea63426Service {
    private static final int IDEA_ID = 63426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63426Service() {
        this(new Idea63426Config());
    }

    public Idea63426Service(Idea63426Config config) {
        this.config = config != null ? config : new Idea63426Config();
