...
@Data
public class Idea63523Config {
    private String name = "idea_063523";
 ...
 */
@Slf4j
public class Idea63523Service {
    private static final int IDEA_ID = 63523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63523Service() {
        this(new Idea63523Config());
    }

    public Idea63523Service(Idea63523Config config) {
        this.config = config != null ? config : new Idea63523Config();
