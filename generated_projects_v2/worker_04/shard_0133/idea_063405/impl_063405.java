...
@Data
public class Idea63405Config {
    private String name = "idea_063405";
 ...
 */
@Slf4j
public class Idea63405Service {
    private static final int IDEA_ID = 63405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63405Service() {
        this(new Idea63405Config());
    }

    public Idea63405Service(Idea63405Config config) {
        this.config = config != null ? config : new Idea63405Config();
