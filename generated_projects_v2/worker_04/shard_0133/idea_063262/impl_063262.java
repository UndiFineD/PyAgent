...
@Data
public class Idea63262Config {
    private String name = "idea_063262";
 ...
 */
@Slf4j
public class Idea63262Service {
    private static final int IDEA_ID = 63262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63262Service() {
        this(new Idea63262Config());
    }

    public Idea63262Service(Idea63262Config config) {
        this.config = config != null ? config : new Idea63262Config();
