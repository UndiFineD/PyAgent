...
@Data
public class Idea63491Config {
    private String name = "idea_063491";
 ...
 */
@Slf4j
public class Idea63491Service {
    private static final int IDEA_ID = 63491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63491Service() {
        this(new Idea63491Config());
    }

    public Idea63491Service(Idea63491Config config) {
        this.config = config != null ? config : new Idea63491Config();
