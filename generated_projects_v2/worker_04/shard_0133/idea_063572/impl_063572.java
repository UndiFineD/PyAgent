...
@Data
public class Idea63572Config {
    private String name = "idea_063572";
 ...
 */
@Slf4j
public class Idea63572Service {
    private static final int IDEA_ID = 63572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63572Service() {
        this(new Idea63572Config());
    }

    public Idea63572Service(Idea63572Config config) {
        this.config = config != null ? config : new Idea63572Config();
