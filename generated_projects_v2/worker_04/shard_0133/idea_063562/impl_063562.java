...
@Data
public class Idea63562Config {
    private String name = "idea_063562";
 ...
 */
@Slf4j
public class Idea63562Service {
    private static final int IDEA_ID = 63562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63562Service() {
        this(new Idea63562Config());
    }

    public Idea63562Service(Idea63562Config config) {
        this.config = config != null ? config : new Idea63562Config();
