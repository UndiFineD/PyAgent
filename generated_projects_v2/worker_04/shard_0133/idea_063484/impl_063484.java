...
@Data
public class Idea63484Config {
    private String name = "idea_063484";
 ...
 */
@Slf4j
public class Idea63484Service {
    private static final int IDEA_ID = 63484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63484Service() {
        this(new Idea63484Config());
    }

    public Idea63484Service(Idea63484Config config) {
        this.config = config != null ? config : new Idea63484Config();
