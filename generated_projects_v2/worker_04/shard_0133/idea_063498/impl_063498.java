...
@Data
public class Idea63498Config {
    private String name = "idea_063498";
 ...
 */
@Slf4j
public class Idea63498Service {
    private static final int IDEA_ID = 63498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63498Service() {
        this(new Idea63498Config());
    }

    public Idea63498Service(Idea63498Config config) {
        this.config = config != null ? config : new Idea63498Config();
