...
@Data
public class Idea63185Config {
    private String name = "idea_063185";
 ...
 */
@Slf4j
public class Idea63185Service {
    private static final int IDEA_ID = 63185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63185Service() {
        this(new Idea63185Config());
    }

    public Idea63185Service(Idea63185Config config) {
        this.config = config != null ? config : new Idea63185Config();
