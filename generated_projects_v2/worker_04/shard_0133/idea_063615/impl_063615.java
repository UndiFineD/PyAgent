...
@Data
public class Idea63615Config {
    private String name = "idea_063615";
 ...
 */
@Slf4j
public class Idea63615Service {
    private static final int IDEA_ID = 63615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63615Service() {
        this(new Idea63615Config());
    }

    public Idea63615Service(Idea63615Config config) {
        this.config = config != null ? config : new Idea63615Config();
