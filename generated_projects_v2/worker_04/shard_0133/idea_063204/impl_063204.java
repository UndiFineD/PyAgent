...
@Data
public class Idea63204Config {
    private String name = "idea_063204";
 ...
 */
@Slf4j
public class Idea63204Service {
    private static final int IDEA_ID = 63204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63204Service() {
        this(new Idea63204Config());
    }

    public Idea63204Service(Idea63204Config config) {
        this.config = config != null ? config : new Idea63204Config();
