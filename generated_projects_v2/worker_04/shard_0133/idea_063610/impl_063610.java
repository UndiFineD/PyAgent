...
@Data
public class Idea63610Config {
    private String name = "idea_063610";
 ...
 */
@Slf4j
public class Idea63610Service {
    private static final int IDEA_ID = 63610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63610Service() {
        this(new Idea63610Config());
    }

    public Idea63610Service(Idea63610Config config) {
        this.config = config != null ? config : new Idea63610Config();
