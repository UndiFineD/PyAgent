...
@Data
public class Idea63540Config {
    private String name = "idea_063540";
 ...
 */
@Slf4j
public class Idea63540Service {
    private static final int IDEA_ID = 63540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63540Service() {
        this(new Idea63540Config());
    }

    public Idea63540Service(Idea63540Config config) {
        this.config = config != null ? config : new Idea63540Config();
