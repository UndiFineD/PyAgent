...
@Data
public class Idea63444Config {
    private String name = "idea_063444";
 ...
 */
@Slf4j
public class Idea63444Service {
    private static final int IDEA_ID = 63444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63444Service() {
        this(new Idea63444Config());
    }

    public Idea63444Service(Idea63444Config config) {
        this.config = config != null ? config : new Idea63444Config();
