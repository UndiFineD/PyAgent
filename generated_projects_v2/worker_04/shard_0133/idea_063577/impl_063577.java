...
@Data
public class Idea63577Config {
    private String name = "idea_063577";
 ...
 */
@Slf4j
public class Idea63577Service {
    private static final int IDEA_ID = 63577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63577Service() {
        this(new Idea63577Config());
    }

    public Idea63577Service(Idea63577Config config) {
        this.config = config != null ? config : new Idea63577Config();
