...
@Data
public class Idea63265Config {
    private String name = "idea_063265";
 ...
 */
@Slf4j
public class Idea63265Service {
    private static final int IDEA_ID = 63265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63265Service() {
        this(new Idea63265Config());
    }

    public Idea63265Service(Idea63265Config config) {
        this.config = config != null ? config : new Idea63265Config();
