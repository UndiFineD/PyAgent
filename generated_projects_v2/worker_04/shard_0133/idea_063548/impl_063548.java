...
@Data
public class Idea63548Config {
    private String name = "idea_063548";
 ...
 */
@Slf4j
public class Idea63548Service {
    private static final int IDEA_ID = 63548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63548Service() {
        this(new Idea63548Config());
    }

    public Idea63548Service(Idea63548Config config) {
        this.config = config != null ? config : new Idea63548Config();
