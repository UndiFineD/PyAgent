...
@Data
public class Idea63433Config {
    private String name = "idea_063433";
 ...
 */
@Slf4j
public class Idea63433Service {
    private static final int IDEA_ID = 63433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63433Service() {
        this(new Idea63433Config());
    }

    public Idea63433Service(Idea63433Config config) {
        this.config = config != null ? config : new Idea63433Config();
