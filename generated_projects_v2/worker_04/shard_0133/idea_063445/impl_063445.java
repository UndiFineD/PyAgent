...
@Data
public class Idea63445Config {
    private String name = "idea_063445";
 ...
 */
@Slf4j
public class Idea63445Service {
    private static final int IDEA_ID = 63445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63445Service() {
        this(new Idea63445Config());
    }

    public Idea63445Service(Idea63445Config config) {
        this.config = config != null ? config : new Idea63445Config();
