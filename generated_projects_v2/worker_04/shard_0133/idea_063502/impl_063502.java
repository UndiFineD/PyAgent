...
@Data
public class Idea63502Config {
    private String name = "idea_063502";
 ...
 */
@Slf4j
public class Idea63502Service {
    private static final int IDEA_ID = 63502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63502Service() {
        this(new Idea63502Config());
    }

    public Idea63502Service(Idea63502Config config) {
        this.config = config != null ? config : new Idea63502Config();
