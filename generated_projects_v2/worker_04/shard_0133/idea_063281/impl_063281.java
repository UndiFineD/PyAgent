...
@Data
public class Idea63281Config {
    private String name = "idea_063281";
 ...
 */
@Slf4j
public class Idea63281Service {
    private static final int IDEA_ID = 63281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63281Service() {
        this(new Idea63281Config());
    }

    public Idea63281Service(Idea63281Config config) {
        this.config = config != null ? config : new Idea63281Config();
