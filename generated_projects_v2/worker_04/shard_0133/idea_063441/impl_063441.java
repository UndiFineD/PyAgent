...
@Data
public class Idea63441Config {
    private String name = "idea_063441";
 ...
 */
@Slf4j
public class Idea63441Service {
    private static final int IDEA_ID = 63441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63441Service() {
        this(new Idea63441Config());
    }

    public Idea63441Service(Idea63441Config config) {
        this.config = config != null ? config : new Idea63441Config();
