...
@Data
public class Idea63308Config {
    private String name = "idea_063308";
 ...
 */
@Slf4j
public class Idea63308Service {
    private static final int IDEA_ID = 63308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63308Service() {
        this(new Idea63308Config());
    }

    public Idea63308Service(Idea63308Config config) {
        this.config = config != null ? config : new Idea63308Config();
