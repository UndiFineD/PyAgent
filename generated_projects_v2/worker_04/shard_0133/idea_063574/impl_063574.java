...
@Data
public class Idea63574Config {
    private String name = "idea_063574";
 ...
 */
@Slf4j
public class Idea63574Service {
    private static final int IDEA_ID = 63574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63574Service() {
        this(new Idea63574Config());
    }

    public Idea63574Service(Idea63574Config config) {
        this.config = config != null ? config : new Idea63574Config();
