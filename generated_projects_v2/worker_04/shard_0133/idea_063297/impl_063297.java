...
@Data
public class Idea63297Config {
    private String name = "idea_063297";
 ...
 */
@Slf4j
public class Idea63297Service {
    private static final int IDEA_ID = 63297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63297Service() {
        this(new Idea63297Config());
    }

    public Idea63297Service(Idea63297Config config) {
        this.config = config != null ? config : new Idea63297Config();
