...
@Data
public class Idea63218Config {
    private String name = "idea_063218";
 ...
 */
@Slf4j
public class Idea63218Service {
    private static final int IDEA_ID = 63218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63218Service() {
        this(new Idea63218Config());
    }

    public Idea63218Service(Idea63218Config config) {
        this.config = config != null ? config : new Idea63218Config();
