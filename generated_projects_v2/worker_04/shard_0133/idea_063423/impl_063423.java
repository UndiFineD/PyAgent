...
@Data
public class Idea63423Config {
    private String name = "idea_063423";
 ...
 */
@Slf4j
public class Idea63423Service {
    private static final int IDEA_ID = 63423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63423Service() {
        this(new Idea63423Config());
    }

    public Idea63423Service(Idea63423Config config) {
        this.config = config != null ? config : new Idea63423Config();
