...
@Data
public class Idea69963Config {
    private String name = "idea_069963";
 ...
 */
@Slf4j
public class Idea69963Service {
    private static final int IDEA_ID = 69963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69963Service() {
        this(new Idea69963Config());
    }

    public Idea69963Service(Idea69963Config config) {
        this.config = config != null ? config : new Idea69963Config();
