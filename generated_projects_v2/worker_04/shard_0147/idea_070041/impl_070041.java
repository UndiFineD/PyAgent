...
@Data
public class Idea70041Config {
    private String name = "idea_070041";
 ...
 */
@Slf4j
public class Idea70041Service {
    private static final int IDEA_ID = 70041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70041Service() {
        this(new Idea70041Config());
    }

    public Idea70041Service(Idea70041Config config) {
        this.config = config != null ? config : new Idea70041Config();
