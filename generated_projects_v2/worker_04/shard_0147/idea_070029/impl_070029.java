...
@Data
public class Idea70029Config {
    private String name = "idea_070029";
 ...
 */
@Slf4j
public class Idea70029Service {
    private static final int IDEA_ID = 70029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70029Service() {
        this(new Idea70029Config());
    }

    public Idea70029Service(Idea70029Config config) {
        this.config = config != null ? config : new Idea70029Config();
