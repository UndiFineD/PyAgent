...
@Data
public class Idea70260Config {
    private String name = "idea_070260";
 ...
 */
@Slf4j
public class Idea70260Service {
    private static final int IDEA_ID = 70260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70260Service() {
        this(new Idea70260Config());
    }

    public Idea70260Service(Idea70260Config config) {
        this.config = config != null ? config : new Idea70260Config();
