...
@Data
public class Idea70229Config {
    private String name = "idea_070229";
 ...
 */
@Slf4j
public class Idea70229Service {
    private static final int IDEA_ID = 70229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70229Service() {
        this(new Idea70229Config());
    }

    public Idea70229Service(Idea70229Config config) {
        this.config = config != null ? config : new Idea70229Config();
