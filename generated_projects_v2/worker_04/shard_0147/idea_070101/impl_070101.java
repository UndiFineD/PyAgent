...
@Data
public class Idea70101Config {
    private String name = "idea_070101";
 ...
 */
@Slf4j
public class Idea70101Service {
    private static final int IDEA_ID = 70101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70101Service() {
        this(new Idea70101Config());
    }

    public Idea70101Service(Idea70101Config config) {
        this.config = config != null ? config : new Idea70101Config();
