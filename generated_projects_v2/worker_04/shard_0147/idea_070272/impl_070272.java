...
@Data
public class Idea70272Config {
    private String name = "idea_070272";
 ...
 */
@Slf4j
public class Idea70272Service {
    private static final int IDEA_ID = 70272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70272Service() {
        this(new Idea70272Config());
    }

    public Idea70272Service(Idea70272Config config) {
        this.config = config != null ? config : new Idea70272Config();
