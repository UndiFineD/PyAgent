...
@Data
public class Idea69926Config {
    private String name = "idea_069926";
 ...
 */
@Slf4j
public class Idea69926Service {
    private static final int IDEA_ID = 69926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69926Service() {
        this(new Idea69926Config());
    }

    public Idea69926Service(Idea69926Config config) {
        this.config = config != null ? config : new Idea69926Config();
