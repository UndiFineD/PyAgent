...
@Data
public class Idea70079Config {
    private String name = "idea_070079";
 ...
 */
@Slf4j
public class Idea70079Service {
    private static final int IDEA_ID = 70079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70079Service() {
        this(new Idea70079Config());
    }

    public Idea70079Service(Idea70079Config config) {
        this.config = config != null ? config : new Idea70079Config();
