...
@Data
public class Idea70080Config {
    private String name = "idea_070080";
 ...
 */
@Slf4j
public class Idea70080Service {
    private static final int IDEA_ID = 70080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70080Service() {
        this(new Idea70080Config());
    }

    public Idea70080Service(Idea70080Config config) {
        this.config = config != null ? config : new Idea70080Config();
