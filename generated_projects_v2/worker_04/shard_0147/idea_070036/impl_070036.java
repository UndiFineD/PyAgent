...
@Data
public class Idea70036Config {
    private String name = "idea_070036";
 ...
 */
@Slf4j
public class Idea70036Service {
    private static final int IDEA_ID = 70036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70036Service() {
        this(new Idea70036Config());
    }

    public Idea70036Service(Idea70036Config config) {
        this.config = config != null ? config : new Idea70036Config();
