...
@Data
public class Idea70271Config {
    private String name = "idea_070271";
 ...
 */
@Slf4j
public class Idea70271Service {
    private static final int IDEA_ID = 70271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70271Service() {
        this(new Idea70271Config());
    }

    public Idea70271Service(Idea70271Config config) {
        this.config = config != null ? config : new Idea70271Config();
