...
@Data
public class Idea70186Config {
    private String name = "idea_070186";
 ...
 */
@Slf4j
public class Idea70186Service {
    private static final int IDEA_ID = 70186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70186Service() {
        this(new Idea70186Config());
    }

    public Idea70186Service(Idea70186Config config) {
        this.config = config != null ? config : new Idea70186Config();
