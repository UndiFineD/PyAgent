...
@Data
public class Idea70148Config {
    private String name = "idea_070148";
 ...
 */
@Slf4j
public class Idea70148Service {
    private static final int IDEA_ID = 70148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70148Service() {
        this(new Idea70148Config());
    }

    public Idea70148Service(Idea70148Config config) {
        this.config = config != null ? config : new Idea70148Config();
