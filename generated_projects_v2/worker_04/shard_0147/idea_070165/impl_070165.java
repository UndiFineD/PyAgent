...
@Data
public class Idea70165Config {
    private String name = "idea_070165";
 ...
 */
@Slf4j
public class Idea70165Service {
    private static final int IDEA_ID = 70165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70165Service() {
        this(new Idea70165Config());
    }

    public Idea70165Service(Idea70165Config config) {
        this.config = config != null ? config : new Idea70165Config();
