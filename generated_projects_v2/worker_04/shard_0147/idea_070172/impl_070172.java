...
@Data
public class Idea70172Config {
    private String name = "idea_070172";
 ...
 */
@Slf4j
public class Idea70172Service {
    private static final int IDEA_ID = 70172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70172Service() {
        this(new Idea70172Config());
    }

    public Idea70172Service(Idea70172Config config) {
        this.config = config != null ? config : new Idea70172Config();
