...
@Data
public class Idea70099Config {
    private String name = "idea_070099";
 ...
 */
@Slf4j
public class Idea70099Service {
    private static final int IDEA_ID = 70099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70099Service() {
        this(new Idea70099Config());
    }

    public Idea70099Service(Idea70099Config config) {
        this.config = config != null ? config : new Idea70099Config();
