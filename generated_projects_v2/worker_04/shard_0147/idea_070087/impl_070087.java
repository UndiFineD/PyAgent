...
@Data
public class Idea70087Config {
    private String name = "idea_070087";
 ...
 */
@Slf4j
public class Idea70087Service {
    private static final int IDEA_ID = 70087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70087Service() {
        this(new Idea70087Config());
    }

    public Idea70087Service(Idea70087Config config) {
        this.config = config != null ? config : new Idea70087Config();
