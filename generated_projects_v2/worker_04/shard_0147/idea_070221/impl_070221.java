...
@Data
public class Idea70221Config {
    private String name = "idea_070221";
 ...
 */
@Slf4j
public class Idea70221Service {
    private static final int IDEA_ID = 70221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70221Service() {
        this(new Idea70221Config());
    }

    public Idea70221Service(Idea70221Config config) {
        this.config = config != null ? config : new Idea70221Config();
