...
@Data
public class Idea70189Config {
    private String name = "idea_070189";
 ...
 */
@Slf4j
public class Idea70189Service {
    private static final int IDEA_ID = 70189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70189Service() {
        this(new Idea70189Config());
    }

    public Idea70189Service(Idea70189Config config) {
        this.config = config != null ? config : new Idea70189Config();
