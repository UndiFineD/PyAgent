...
@Data
public class Idea70104Config {
    private String name = "idea_070104";
 ...
 */
@Slf4j
public class Idea70104Service {
    private static final int IDEA_ID = 70104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70104Service() {
        this(new Idea70104Config());
    }

    public Idea70104Service(Idea70104Config config) {
        this.config = config != null ? config : new Idea70104Config();
