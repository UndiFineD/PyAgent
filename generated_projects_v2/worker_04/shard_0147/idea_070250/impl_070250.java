...
@Data
public class Idea70250Config {
    private String name = "idea_070250";
 ...
 */
@Slf4j
public class Idea70250Service {
    private static final int IDEA_ID = 70250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70250Service() {
        this(new Idea70250Config());
    }

    public Idea70250Service(Idea70250Config config) {
        this.config = config != null ? config : new Idea70250Config();
