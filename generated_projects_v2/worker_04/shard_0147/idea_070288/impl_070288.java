...
@Data
public class Idea70288Config {
    private String name = "idea_070288";
 ...
 */
@Slf4j
public class Idea70288Service {
    private static final int IDEA_ID = 70288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70288Service() {
        this(new Idea70288Config());
    }

    public Idea70288Service(Idea70288Config config) {
        this.config = config != null ? config : new Idea70288Config();
