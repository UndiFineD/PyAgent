...
@Data
public class Idea70287Config {
    private String name = "idea_070287";
 ...
 */
@Slf4j
public class Idea70287Service {
    private static final int IDEA_ID = 70287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70287Service() {
        this(new Idea70287Config());
    }

    public Idea70287Service(Idea70287Config config) {
        this.config = config != null ? config : new Idea70287Config();
