...
@Data
public class Idea70211Config {
    private String name = "idea_070211";
 ...
 */
@Slf4j
public class Idea70211Service {
    private static final int IDEA_ID = 70211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70211Service() {
        this(new Idea70211Config());
    }

    public Idea70211Service(Idea70211Config config) {
        this.config = config != null ? config : new Idea70211Config();
