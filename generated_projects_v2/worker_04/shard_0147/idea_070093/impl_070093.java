...
@Data
public class Idea70093Config {
    private String name = "idea_070093";
 ...
 */
@Slf4j
public class Idea70093Service {
    private static final int IDEA_ID = 70093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70093Service() {
        this(new Idea70093Config());
    }

    public Idea70093Service(Idea70093Config config) {
        this.config = config != null ? config : new Idea70093Config();
