...
@Data
public class Idea70107Config {
    private String name = "idea_070107";
 ...
 */
@Slf4j
public class Idea70107Service {
    private static final int IDEA_ID = 70107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70107Service() {
        this(new Idea70107Config());
    }

    public Idea70107Service(Idea70107Config config) {
        this.config = config != null ? config : new Idea70107Config();
