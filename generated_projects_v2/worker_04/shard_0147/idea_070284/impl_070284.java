...
@Data
public class Idea70284Config {
    private String name = "idea_070284";
 ...
 */
@Slf4j
public class Idea70284Service {
    private static final int IDEA_ID = 70284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70284Service() {
        this(new Idea70284Config());
    }

    public Idea70284Service(Idea70284Config config) {
        this.config = config != null ? config : new Idea70284Config();
