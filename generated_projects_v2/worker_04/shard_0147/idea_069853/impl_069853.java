...
@Data
public class Idea69853Config {
    private String name = "idea_069853";
 ...
 */
@Slf4j
public class Idea69853Service {
    private static final int IDEA_ID = 69853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69853Service() {
        this(new Idea69853Config());
    }

    public Idea69853Service(Idea69853Config config) {
        this.config = config != null ? config : new Idea69853Config();
