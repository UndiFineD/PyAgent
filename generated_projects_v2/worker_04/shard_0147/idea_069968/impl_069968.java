...
@Data
public class Idea69968Config {
    private String name = "idea_069968";
 ...
 */
@Slf4j
public class Idea69968Service {
    private static final int IDEA_ID = 69968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69968Service() {
        this(new Idea69968Config());
    }

    public Idea69968Service(Idea69968Config config) {
        this.config = config != null ? config : new Idea69968Config();
