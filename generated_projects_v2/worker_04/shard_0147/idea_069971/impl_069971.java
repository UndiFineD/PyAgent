...
@Data
public class Idea69971Config {
    private String name = "idea_069971";
 ...
 */
@Slf4j
public class Idea69971Service {
    private static final int IDEA_ID = 69971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69971Service() {
        this(new Idea69971Config());
    }

    public Idea69971Service(Idea69971Config config) {
        this.config = config != null ? config : new Idea69971Config();
