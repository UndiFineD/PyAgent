...
@Data
public class Idea70167Config {
    private String name = "idea_070167";
 ...
 */
@Slf4j
public class Idea70167Service {
    private static final int IDEA_ID = 70167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70167Service() {
        this(new Idea70167Config());
    }

    public Idea70167Service(Idea70167Config config) {
        this.config = config != null ? config : new Idea70167Config();
