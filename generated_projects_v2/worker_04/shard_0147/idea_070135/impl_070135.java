...
@Data
public class Idea70135Config {
    private String name = "idea_070135";
 ...
 */
@Slf4j
public class Idea70135Service {
    private static final int IDEA_ID = 70135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70135Service() {
        this(new Idea70135Config());
    }

    public Idea70135Service(Idea70135Config config) {
        this.config = config != null ? config : new Idea70135Config();
