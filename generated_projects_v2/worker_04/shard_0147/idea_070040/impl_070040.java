...
@Data
public class Idea70040Config {
    private String name = "idea_070040";
 ...
 */
@Slf4j
public class Idea70040Service {
    private static final int IDEA_ID = 70040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70040Service() {
        this(new Idea70040Config());
    }

    public Idea70040Service(Idea70040Config config) {
        this.config = config != null ? config : new Idea70040Config();
