...
@Data
public class Idea70077Config {
    private String name = "idea_070077";
 ...
 */
@Slf4j
public class Idea70077Service {
    private static final int IDEA_ID = 70077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70077Service() {
        this(new Idea70077Config());
    }

    public Idea70077Service(Idea70077Config config) {
        this.config = config != null ? config : new Idea70077Config();
