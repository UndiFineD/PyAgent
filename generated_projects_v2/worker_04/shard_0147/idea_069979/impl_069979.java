...
@Data
public class Idea69979Config {
    private String name = "idea_069979";
 ...
 */
@Slf4j
public class Idea69979Service {
    private static final int IDEA_ID = 69979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69979Service() {
        this(new Idea69979Config());
    }

    public Idea69979Service(Idea69979Config config) {
        this.config = config != null ? config : new Idea69979Config();
