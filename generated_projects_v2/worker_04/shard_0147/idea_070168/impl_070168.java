...
@Data
public class Idea70168Config {
    private String name = "idea_070168";
 ...
 */
@Slf4j
public class Idea70168Service {
    private static final int IDEA_ID = 70168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70168Service() {
        this(new Idea70168Config());
    }

    public Idea70168Service(Idea70168Config config) {
        this.config = config != null ? config : new Idea70168Config();
