...
@Data
public class Idea70103Config {
    private String name = "idea_070103";
 ...
 */
@Slf4j
public class Idea70103Service {
    private static final int IDEA_ID = 70103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70103Service() {
        this(new Idea70103Config());
    }

    public Idea70103Service(Idea70103Config config) {
        this.config = config != null ? config : new Idea70103Config();
