...
@Data
public class Idea70170Config {
    private String name = "idea_070170";
 ...
 */
@Slf4j
public class Idea70170Service {
    private static final int IDEA_ID = 70170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70170Service() {
        this(new Idea70170Config());
    }

    public Idea70170Service(Idea70170Config config) {
        this.config = config != null ? config : new Idea70170Config();
