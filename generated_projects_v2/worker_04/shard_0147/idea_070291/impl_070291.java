...
@Data
public class Idea70291Config {
    private String name = "idea_070291";
 ...
 */
@Slf4j
public class Idea70291Service {
    private static final int IDEA_ID = 70291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70291Service() {
        this(new Idea70291Config());
    }

    public Idea70291Service(Idea70291Config config) {
        this.config = config != null ? config : new Idea70291Config();
