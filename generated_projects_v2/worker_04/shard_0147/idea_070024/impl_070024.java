...
@Data
public class Idea70024Config {
    private String name = "idea_070024";
 ...
 */
@Slf4j
public class Idea70024Service {
    private static final int IDEA_ID = 70024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70024Service() {
        this(new Idea70024Config());
    }

    public Idea70024Service(Idea70024Config config) {
        this.config = config != null ? config : new Idea70024Config();
