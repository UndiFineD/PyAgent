...
@Data
public class Idea70245Config {
    private String name = "idea_070245";
 ...
 */
@Slf4j
public class Idea70245Service {
    private static final int IDEA_ID = 70245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70245Service() {
        this(new Idea70245Config());
    }

    public Idea70245Service(Idea70245Config config) {
        this.config = config != null ? config : new Idea70245Config();
