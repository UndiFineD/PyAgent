...
@Data
public class Idea70240Config {
    private String name = "idea_070240";
 ...
 */
@Slf4j
public class Idea70240Service {
    private static final int IDEA_ID = 70240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70240Service() {
        this(new Idea70240Config());
    }

    public Idea70240Service(Idea70240Config config) {
        this.config = config != null ? config : new Idea70240Config();
