...
@Data
public class Idea70010Config {
    private String name = "idea_070010";
 ...
 */
@Slf4j
public class Idea70010Service {
    private static final int IDEA_ID = 70010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70010Service() {
        this(new Idea70010Config());
    }

    public Idea70010Service(Idea70010Config config) {
        this.config = config != null ? config : new Idea70010Config();
