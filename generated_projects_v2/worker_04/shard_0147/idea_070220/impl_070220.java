...
@Data
public class Idea70220Config {
    private String name = "idea_070220";
 ...
 */
@Slf4j
public class Idea70220Service {
    private static final int IDEA_ID = 70220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70220Service() {
        this(new Idea70220Config());
    }

    public Idea70220Service(Idea70220Config config) {
        this.config = config != null ? config : new Idea70220Config();
