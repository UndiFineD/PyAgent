...
@Data
public class Idea70205Config {
    private String name = "idea_070205";
 ...
 */
@Slf4j
public class Idea70205Service {
    private static final int IDEA_ID = 70205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70205Service() {
        this(new Idea70205Config());
    }

    public Idea70205Service(Idea70205Config config) {
        this.config = config != null ? config : new Idea70205Config();
