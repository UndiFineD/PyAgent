...
@Data
public class Idea70215Config {
    private String name = "idea_070215";
 ...
 */
@Slf4j
public class Idea70215Service {
    private static final int IDEA_ID = 70215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70215Service() {
        this(new Idea70215Config());
    }

    public Idea70215Service(Idea70215Config config) {
        this.config = config != null ? config : new Idea70215Config();
