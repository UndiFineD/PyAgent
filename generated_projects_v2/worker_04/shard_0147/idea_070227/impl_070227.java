...
@Data
public class Idea70227Config {
    private String name = "idea_070227";
 ...
 */
@Slf4j
public class Idea70227Service {
    private static final int IDEA_ID = 70227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70227Service() {
        this(new Idea70227Config());
    }

    public Idea70227Service(Idea70227Config config) {
        this.config = config != null ? config : new Idea70227Config();
