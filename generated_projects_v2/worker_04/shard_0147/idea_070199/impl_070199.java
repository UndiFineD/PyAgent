...
@Data
public class Idea70199Config {
    private String name = "idea_070199";
 ...
 */
@Slf4j
public class Idea70199Service {
    private static final int IDEA_ID = 70199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70199Service() {
        this(new Idea70199Config());
    }

    public Idea70199Service(Idea70199Config config) {
        this.config = config != null ? config : new Idea70199Config();
