...
@Data
public class Idea70214Config {
    private String name = "idea_070214";
 ...
 */
@Slf4j
public class Idea70214Service {
    private static final int IDEA_ID = 70214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70214Service() {
        this(new Idea70214Config());
    }

    public Idea70214Service(Idea70214Config config) {
        this.config = config != null ? config : new Idea70214Config();
