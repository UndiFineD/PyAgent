...
@Data
public class Idea70021Config {
    private String name = "idea_070021";
 ...
 */
@Slf4j
public class Idea70021Service {
    private static final int IDEA_ID = 70021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70021Service() {
        this(new Idea70021Config());
    }

    public Idea70021Service(Idea70021Config config) {
        this.config = config != null ? config : new Idea70021Config();
