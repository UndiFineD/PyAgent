...
@Data
public class Idea69966Config {
    private String name = "idea_069966";
 ...
 */
@Slf4j
public class Idea69966Service {
    private static final int IDEA_ID = 69966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69966Service() {
        this(new Idea69966Config());
    }

    public Idea69966Service(Idea69966Config config) {
        this.config = config != null ? config : new Idea69966Config();
