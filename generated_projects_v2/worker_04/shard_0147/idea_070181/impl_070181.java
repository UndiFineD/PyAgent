...
@Data
public class Idea70181Config {
    private String name = "idea_070181";
 ...
 */
@Slf4j
public class Idea70181Service {
    private static final int IDEA_ID = 70181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70181Service() {
        this(new Idea70181Config());
    }

    public Idea70181Service(Idea70181Config config) {
        this.config = config != null ? config : new Idea70181Config();
