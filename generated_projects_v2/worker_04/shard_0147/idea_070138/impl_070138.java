...
@Data
public class Idea70138Config {
    private String name = "idea_070138";
 ...
 */
@Slf4j
public class Idea70138Service {
    private static final int IDEA_ID = 70138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70138Service() {
        this(new Idea70138Config());
    }

    public Idea70138Service(Idea70138Config config) {
        this.config = config != null ? config : new Idea70138Config();
