...
@Data
public class Idea70008Config {
    private String name = "idea_070008";
 ...
 */
@Slf4j
public class Idea70008Service {
    private static final int IDEA_ID = 70008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70008Service() {
        this(new Idea70008Config());
    }

    public Idea70008Service(Idea70008Config config) {
        this.config = config != null ? config : new Idea70008Config();
