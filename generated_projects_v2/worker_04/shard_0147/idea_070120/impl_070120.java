...
@Data
public class Idea70120Config {
    private String name = "idea_070120";
 ...
 */
@Slf4j
public class Idea70120Service {
    private static final int IDEA_ID = 70120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70120Service() {
        this(new Idea70120Config());
    }

    public Idea70120Service(Idea70120Config config) {
        this.config = config != null ? config : new Idea70120Config();
