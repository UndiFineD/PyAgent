...
@Data
public class Idea70018Config {
    private String name = "idea_070018";
 ...
 */
@Slf4j
public class Idea70018Service {
    private static final int IDEA_ID = 70018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70018Service() {
        this(new Idea70018Config());
    }

    public Idea70018Service(Idea70018Config config) {
        this.config = config != null ? config : new Idea70018Config();
