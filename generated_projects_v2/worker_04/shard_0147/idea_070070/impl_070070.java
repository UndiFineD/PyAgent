...
@Data
public class Idea70070Config {
    private String name = "idea_070070";
 ...
 */
@Slf4j
public class Idea70070Service {
    private static final int IDEA_ID = 70070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70070Service() {
        this(new Idea70070Config());
    }

    public Idea70070Service(Idea70070Config config) {
        this.config = config != null ? config : new Idea70070Config();
