...
@Data
public class Idea70267Config {
    private String name = "idea_070267";
 ...
 */
@Slf4j
public class Idea70267Service {
    private static final int IDEA_ID = 70267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70267Service() {
        this(new Idea70267Config());
    }

    public Idea70267Service(Idea70267Config config) {
        this.config = config != null ? config : new Idea70267Config();
