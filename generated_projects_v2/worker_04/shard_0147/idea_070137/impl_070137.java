...
@Data
public class Idea70137Config {
    private String name = "idea_070137";
 ...
 */
@Slf4j
public class Idea70137Service {
    private static final int IDEA_ID = 70137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70137Service() {
        this(new Idea70137Config());
    }

    public Idea70137Service(Idea70137Config config) {
        this.config = config != null ? config : new Idea70137Config();
