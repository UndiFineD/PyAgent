...
@Data
public class Idea70184Config {
    private String name = "idea_070184";
 ...
 */
@Slf4j
public class Idea70184Service {
    private static final int IDEA_ID = 70184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70184Service() {
        this(new Idea70184Config());
    }

    public Idea70184Service(Idea70184Config config) {
        this.config = config != null ? config : new Idea70184Config();
