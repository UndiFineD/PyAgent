...
@Data
public class Idea70276Config {
    private String name = "idea_070276";
 ...
 */
@Slf4j
public class Idea70276Service {
    private static final int IDEA_ID = 70276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70276Service() {
        this(new Idea70276Config());
    }

    public Idea70276Service(Idea70276Config config) {
        this.config = config != null ? config : new Idea70276Config();
