...
@Data
public class Idea70083Config {
    private String name = "idea_070083";
 ...
 */
@Slf4j
public class Idea70083Service {
    private static final int IDEA_ID = 70083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70083Service() {
        this(new Idea70083Config());
    }

    public Idea70083Service(Idea70083Config config) {
        this.config = config != null ? config : new Idea70083Config();
