...
@Data
public class Idea70028Config {
    private String name = "idea_070028";
 ...
 */
@Slf4j
public class Idea70028Service {
    private static final int IDEA_ID = 70028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70028Service() {
        this(new Idea70028Config());
    }

    public Idea70028Service(Idea70028Config config) {
        this.config = config != null ? config : new Idea70028Config();
