...
@Data
public class Idea70141Config {
    private String name = "idea_070141";
 ...
 */
@Slf4j
public class Idea70141Service {
    private static final int IDEA_ID = 70141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70141Service() {
        this(new Idea70141Config());
    }

    public Idea70141Service(Idea70141Config config) {
        this.config = config != null ? config : new Idea70141Config();
