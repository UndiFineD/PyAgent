...
@Data
public class Idea70129Config {
    private String name = "idea_070129";
 ...
 */
@Slf4j
public class Idea70129Service {
    private static final int IDEA_ID = 70129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70129Service() {
        this(new Idea70129Config());
    }

    public Idea70129Service(Idea70129Config config) {
        this.config = config != null ? config : new Idea70129Config();
