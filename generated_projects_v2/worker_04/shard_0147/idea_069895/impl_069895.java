...
@Data
public class Idea69895Config {
    private String name = "idea_069895";
 ...
 */
@Slf4j
public class Idea69895Service {
    private static final int IDEA_ID = 69895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69895Service() {
        this(new Idea69895Config());
    }

    public Idea69895Service(Idea69895Config config) {
        this.config = config != null ? config : new Idea69895Config();
