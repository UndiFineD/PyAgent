...
@Data
public class Idea70198Config {
    private String name = "idea_070198";
 ...
 */
@Slf4j
public class Idea70198Service {
    private static final int IDEA_ID = 70198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70198Service() {
        this(new Idea70198Config());
    }

    public Idea70198Service(Idea70198Config config) {
        this.config = config != null ? config : new Idea70198Config();
