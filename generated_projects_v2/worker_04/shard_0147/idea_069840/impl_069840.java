...
@Data
public class Idea69840Config {
    private String name = "idea_069840";
 ...
 */
@Slf4j
public class Idea69840Service {
    private static final int IDEA_ID = 69840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69840Service() {
        this(new Idea69840Config());
    }

    public Idea69840Service(Idea69840Config config) {
        this.config = config != null ? config : new Idea69840Config();
