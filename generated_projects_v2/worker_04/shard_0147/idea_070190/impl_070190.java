...
@Data
public class Idea70190Config {
    private String name = "idea_070190";
 ...
 */
@Slf4j
public class Idea70190Service {
    private static final int IDEA_ID = 70190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70190Service() {
        this(new Idea70190Config());
    }

    public Idea70190Service(Idea70190Config config) {
        this.config = config != null ? config : new Idea70190Config();
