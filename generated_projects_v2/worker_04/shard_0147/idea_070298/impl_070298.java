...
@Data
public class Idea70298Config {
    private String name = "idea_070298";
 ...
 */
@Slf4j
public class Idea70298Service {
    private static final int IDEA_ID = 70298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70298Service() {
        this(new Idea70298Config());
    }

    public Idea70298Service(Idea70298Config config) {
        this.config = config != null ? config : new Idea70298Config();
