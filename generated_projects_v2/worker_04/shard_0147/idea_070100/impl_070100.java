...
@Data
public class Idea70100Config {
    private String name = "idea_070100";
 ...
 */
@Slf4j
public class Idea70100Service {
    private static final int IDEA_ID = 70100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70100Service() {
        this(new Idea70100Config());
    }

    public Idea70100Service(Idea70100Config config) {
        this.config = config != null ? config : new Idea70100Config();
