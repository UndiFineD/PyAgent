...
@Data
public class Idea70016Config {
    private String name = "idea_070016";
 ...
 */
@Slf4j
public class Idea70016Service {
    private static final int IDEA_ID = 70016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70016Service() {
        this(new Idea70016Config());
    }

    public Idea70016Service(Idea70016Config config) {
        this.config = config != null ? config : new Idea70016Config();
