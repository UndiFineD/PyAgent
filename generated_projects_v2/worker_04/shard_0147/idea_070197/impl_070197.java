...
@Data
public class Idea70197Config {
    private String name = "idea_070197";
 ...
 */
@Slf4j
public class Idea70197Service {
    private static final int IDEA_ID = 70197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70197Service() {
        this(new Idea70197Config());
    }

    public Idea70197Service(Idea70197Config config) {
        this.config = config != null ? config : new Idea70197Config();
