...
@Data
public class Idea70014Config {
    private String name = "idea_070014";
 ...
 */
@Slf4j
public class Idea70014Service {
    private static final int IDEA_ID = 70014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70014Service() {
        this(new Idea70014Config());
    }

    public Idea70014Service(Idea70014Config config) {
        this.config = config != null ? config : new Idea70014Config();
