...
@Data
public class Idea70236Config {
    private String name = "idea_070236";
 ...
 */
@Slf4j
public class Idea70236Service {
    private static final int IDEA_ID = 70236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70236Service() {
        this(new Idea70236Config());
    }

    public Idea70236Service(Idea70236Config config) {
        this.config = config != null ? config : new Idea70236Config();
