...
@Data
public class Idea70204Config {
    private String name = "idea_070204";
 ...
 */
@Slf4j
public class Idea70204Service {
    private static final int IDEA_ID = 70204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70204Service() {
        this(new Idea70204Config());
    }

    public Idea70204Service(Idea70204Config config) {
        this.config = config != null ? config : new Idea70204Config();
