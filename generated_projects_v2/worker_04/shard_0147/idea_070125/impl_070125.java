...
@Data
public class Idea70125Config {
    private String name = "idea_070125";
 ...
 */
@Slf4j
public class Idea70125Service {
    private static final int IDEA_ID = 70125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70125Service() {
        this(new Idea70125Config());
    }

    public Idea70125Service(Idea70125Config config) {
        this.config = config != null ? config : new Idea70125Config();
