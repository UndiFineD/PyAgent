...
@Data
public class Idea69983Config {
    private String name = "idea_069983";
 ...
 */
@Slf4j
public class Idea69983Service {
    private static final int IDEA_ID = 69983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69983Service() {
        this(new Idea69983Config());
    }

    public Idea69983Service(Idea69983Config config) {
        this.config = config != null ? config : new Idea69983Config();
