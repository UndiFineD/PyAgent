...
@Data
public class Idea70106Config {
    private String name = "idea_070106";
 ...
 */
@Slf4j
public class Idea70106Service {
    private static final int IDEA_ID = 70106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70106Service() {
        this(new Idea70106Config());
    }

    public Idea70106Service(Idea70106Config config) {
        this.config = config != null ? config : new Idea70106Config();
