...
@Data
public class Idea70289Config {
    private String name = "idea_070289";
 ...
 */
@Slf4j
public class Idea70289Service {
    private static final int IDEA_ID = 70289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70289Service() {
        this(new Idea70289Config());
    }

    public Idea70289Service(Idea70289Config config) {
        this.config = config != null ? config : new Idea70289Config();
