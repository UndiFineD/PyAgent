...
@Data
public class Idea70293Config {
    private String name = "idea_070293";
 ...
 */
@Slf4j
public class Idea70293Service {
    private static final int IDEA_ID = 70293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70293Service() {
        this(new Idea70293Config());
    }

    public Idea70293Service(Idea70293Config config) {
        this.config = config != null ? config : new Idea70293Config();
