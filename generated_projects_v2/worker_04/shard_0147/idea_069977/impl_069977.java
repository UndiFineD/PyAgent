...
@Data
public class Idea69977Config {
    private String name = "idea_069977";
 ...
 */
@Slf4j
public class Idea69977Service {
    private static final int IDEA_ID = 69977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69977Service() {
        this(new Idea69977Config());
    }

    public Idea69977Service(Idea69977Config config) {
        this.config = config != null ? config : new Idea69977Config();
