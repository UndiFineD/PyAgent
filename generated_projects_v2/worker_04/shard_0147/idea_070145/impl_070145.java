...
@Data
public class Idea70145Config {
    private String name = "idea_070145";
 ...
 */
@Slf4j
public class Idea70145Service {
    private static final int IDEA_ID = 70145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70145Service() {
        this(new Idea70145Config());
    }

    public Idea70145Service(Idea70145Config config) {
        this.config = config != null ? config : new Idea70145Config();
