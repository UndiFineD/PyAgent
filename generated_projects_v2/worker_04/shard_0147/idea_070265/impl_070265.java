...
@Data
public class Idea70265Config {
    private String name = "idea_070265";
 ...
 */
@Slf4j
public class Idea70265Service {
    private static final int IDEA_ID = 70265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70265Service() {
        this(new Idea70265Config());
    }

    public Idea70265Service(Idea70265Config config) {
        this.config = config != null ? config : new Idea70265Config();
