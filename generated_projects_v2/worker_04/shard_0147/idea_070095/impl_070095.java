...
@Data
public class Idea70095Config {
    private String name = "idea_070095";
 ...
 */
@Slf4j
public class Idea70095Service {
    private static final int IDEA_ID = 70095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70095Service() {
        this(new Idea70095Config());
    }

    public Idea70095Service(Idea70095Config config) {
        this.config = config != null ? config : new Idea70095Config();
