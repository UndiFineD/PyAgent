...
@Data
public class Idea70136Config {
    private String name = "idea_070136";
 ...
 */
@Slf4j
public class Idea70136Service {
    private static final int IDEA_ID = 70136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70136Service() {
        this(new Idea70136Config());
    }

    public Idea70136Service(Idea70136Config config) {
        this.config = config != null ? config : new Idea70136Config();
