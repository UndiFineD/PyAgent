...
@Data
public class Idea70233Config {
    private String name = "idea_070233";
 ...
 */
@Slf4j
public class Idea70233Service {
    private static final int IDEA_ID = 70233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70233Service() {
        this(new Idea70233Config());
    }

    public Idea70233Service(Idea70233Config config) {
        this.config = config != null ? config : new Idea70233Config();
