...
@Data
public class Idea70066Config {
    private String name = "idea_070066";
 ...
 */
@Slf4j
public class Idea70066Service {
    private static final int IDEA_ID = 70066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70066Service() {
        this(new Idea70066Config());
    }

    public Idea70066Service(Idea70066Config config) {
        this.config = config != null ? config : new Idea70066Config();
