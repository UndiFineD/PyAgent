...
@Data
public class Idea70194Config {
    private String name = "idea_070194";
 ...
 */
@Slf4j
public class Idea70194Service {
    private static final int IDEA_ID = 70194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70194Service() {
        this(new Idea70194Config());
    }

    public Idea70194Service(Idea70194Config config) {
        this.config = config != null ? config : new Idea70194Config();
