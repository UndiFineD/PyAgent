...
@Data
public class Idea69833Config {
    private String name = "idea_069833";
 ...
 */
@Slf4j
public class Idea69833Service {
    private static final int IDEA_ID = 69833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69833Service() {
        this(new Idea69833Config());
    }

    public Idea69833Service(Idea69833Config config) {
        this.config = config != null ? config : new Idea69833Config();
