...
@Data
public class Idea70178Config {
    private String name = "idea_070178";
 ...
 */
@Slf4j
public class Idea70178Service {
    private static final int IDEA_ID = 70178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70178Service() {
        this(new Idea70178Config());
    }

    public Idea70178Service(Idea70178Config config) {
        this.config = config != null ? config : new Idea70178Config();
