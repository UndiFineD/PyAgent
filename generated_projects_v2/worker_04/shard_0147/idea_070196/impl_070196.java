...
@Data
public class Idea70196Config {
    private String name = "idea_070196";
 ...
 */
@Slf4j
public class Idea70196Service {
    private static final int IDEA_ID = 70196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70196Service() {
        this(new Idea70196Config());
    }

    public Idea70196Service(Idea70196Config config) {
        this.config = config != null ? config : new Idea70196Config();
