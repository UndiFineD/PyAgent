...
@Data
public class Idea70200Config {
    private String name = "idea_070200";
 ...
 */
@Slf4j
public class Idea70200Service {
    private static final int IDEA_ID = 70200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70200Service() {
        this(new Idea70200Config());
    }

    public Idea70200Service(Idea70200Config config) {
        this.config = config != null ? config : new Idea70200Config();
