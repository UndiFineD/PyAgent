...
@Data
public class Idea69970Config {
    private String name = "idea_069970";
 ...
 */
@Slf4j
public class Idea69970Service {
    private static final int IDEA_ID = 69970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69970Service() {
        this(new Idea69970Config());
    }

    public Idea69970Service(Idea69970Config config) {
        this.config = config != null ? config : new Idea69970Config();
