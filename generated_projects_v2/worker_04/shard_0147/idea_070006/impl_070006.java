...
@Data
public class Idea70006Config {
    private String name = "idea_070006";
 ...
 */
@Slf4j
public class Idea70006Service {
    private static final int IDEA_ID = 70006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70006Service() {
        this(new Idea70006Config());
    }

    public Idea70006Service(Idea70006Config config) {
        this.config = config != null ? config : new Idea70006Config();
