...
@Data
public class Idea69825Config {
    private String name = "idea_069825";
 ...
 */
@Slf4j
public class Idea69825Service {
    private static final int IDEA_ID = 69825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69825Service() {
        this(new Idea69825Config());
    }

    public Idea69825Service(Idea69825Config config) {
        this.config = config != null ? config : new Idea69825Config();
