...
@Data
public class Idea70218Config {
    private String name = "idea_070218";
 ...
 */
@Slf4j
public class Idea70218Service {
    private static final int IDEA_ID = 70218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70218Service() {
        this(new Idea70218Config());
    }

    public Idea70218Service(Idea70218Config config) {
        this.config = config != null ? config : new Idea70218Config();
