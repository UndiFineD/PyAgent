...
@Data
public class Idea69836Config {
    private String name = "idea_069836";
 ...
 */
@Slf4j
public class Idea69836Service {
    private static final int IDEA_ID = 69836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69836Service() {
        this(new Idea69836Config());
    }

    public Idea69836Service(Idea69836Config config) {
        this.config = config != null ? config : new Idea69836Config();
