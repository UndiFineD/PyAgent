...
@Data
public class Idea70180Config {
    private String name = "idea_070180";
 ...
 */
@Slf4j
public class Idea70180Service {
    private static final int IDEA_ID = 70180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70180Service() {
        this(new Idea70180Config());
    }

    public Idea70180Service(Idea70180Config config) {
        this.config = config != null ? config : new Idea70180Config();
