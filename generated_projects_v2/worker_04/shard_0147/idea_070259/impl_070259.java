...
@Data
public class Idea70259Config {
    private String name = "idea_070259";
 ...
 */
@Slf4j
public class Idea70259Service {
    private static final int IDEA_ID = 70259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70259Service() {
        this(new Idea70259Config());
    }

    public Idea70259Service(Idea70259Config config) {
        this.config = config != null ? config : new Idea70259Config();
