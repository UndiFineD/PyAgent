...
@Data
public class Idea69972Config {
    private String name = "idea_069972";
 ...
 */
@Slf4j
public class Idea69972Service {
    private static final int IDEA_ID = 69972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69972Service() {
        this(new Idea69972Config());
    }

    public Idea69972Service(Idea69972Config config) {
        this.config = config != null ? config : new Idea69972Config();
