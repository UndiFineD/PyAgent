...
@Data
public class Idea70116Config {
    private String name = "idea_070116";
 ...
 */
@Slf4j
public class Idea70116Service {
    private static final int IDEA_ID = 70116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70116Service() {
        this(new Idea70116Config());
    }

    public Idea70116Service(Idea70116Config config) {
        this.config = config != null ? config : new Idea70116Config();
