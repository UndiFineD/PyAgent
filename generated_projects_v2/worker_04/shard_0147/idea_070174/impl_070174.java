...
@Data
public class Idea70174Config {
    private String name = "idea_070174";
 ...
 */
@Slf4j
public class Idea70174Service {
    private static final int IDEA_ID = 70174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70174Service() {
        this(new Idea70174Config());
    }

    public Idea70174Service(Idea70174Config config) {
        this.config = config != null ? config : new Idea70174Config();
