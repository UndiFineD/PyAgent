...
@Data
public class Idea70046Config {
    private String name = "idea_070046";
 ...
 */
@Slf4j
public class Idea70046Service {
    private static final int IDEA_ID = 70046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70046Service() {
        this(new Idea70046Config());
    }

    public Idea70046Service(Idea70046Config config) {
        this.config = config != null ? config : new Idea70046Config();
