...
@Data
public class Idea69961Config {
    private String name = "idea_069961";
 ...
 */
@Slf4j
public class Idea69961Service {
    private static final int IDEA_ID = 69961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69961Service() {
        this(new Idea69961Config());
    }

    public Idea69961Service(Idea69961Config config) {
        this.config = config != null ? config : new Idea69961Config();
