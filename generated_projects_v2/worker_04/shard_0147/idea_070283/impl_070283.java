...
@Data
public class Idea70283Config {
    private String name = "idea_070283";
 ...
 */
@Slf4j
public class Idea70283Service {
    private static final int IDEA_ID = 70283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70283Service() {
        this(new Idea70283Config());
    }

    public Idea70283Service(Idea70283Config config) {
        this.config = config != null ? config : new Idea70283Config();
