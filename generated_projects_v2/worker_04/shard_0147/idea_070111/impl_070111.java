...
@Data
public class Idea70111Config {
    private String name = "idea_070111";
 ...
 */
@Slf4j
public class Idea70111Service {
    private static final int IDEA_ID = 70111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70111Service() {
        this(new Idea70111Config());
    }

    public Idea70111Service(Idea70111Config config) {
        this.config = config != null ? config : new Idea70111Config();
