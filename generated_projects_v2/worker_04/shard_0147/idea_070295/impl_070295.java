...
@Data
public class Idea70295Config {
    private String name = "idea_070295";
 ...
 */
@Slf4j
public class Idea70295Service {
    private static final int IDEA_ID = 70295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70295Service() {
        this(new Idea70295Config());
    }

    public Idea70295Service(Idea70295Config config) {
        this.config = config != null ? config : new Idea70295Config();
