...
@Data
public class Idea69893Config {
    private String name = "idea_069893";
 ...
 */
@Slf4j
public class Idea69893Service {
    private static final int IDEA_ID = 69893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69893Service() {
        this(new Idea69893Config());
    }

    public Idea69893Service(Idea69893Config config) {
        this.config = config != null ? config : new Idea69893Config();
