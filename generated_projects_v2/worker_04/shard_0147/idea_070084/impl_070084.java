...
@Data
public class Idea70084Config {
    private String name = "idea_070084";
 ...
 */
@Slf4j
public class Idea70084Service {
    private static final int IDEA_ID = 70084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70084Service() {
        this(new Idea70084Config());
    }

    public Idea70084Service(Idea70084Config config) {
        this.config = config != null ? config : new Idea70084Config();
