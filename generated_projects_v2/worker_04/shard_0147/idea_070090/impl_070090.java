...
@Data
public class Idea70090Config {
    private String name = "idea_070090";
 ...
 */
@Slf4j
public class Idea70090Service {
    private static final int IDEA_ID = 70090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70090Service() {
        this(new Idea70090Config());
    }

    public Idea70090Service(Idea70090Config config) {
        this.config = config != null ? config : new Idea70090Config();
