...
@Data
public class Idea70297Config {
    private String name = "idea_070297";
 ...
 */
@Slf4j
public class Idea70297Service {
    private static final int IDEA_ID = 70297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70297Service() {
        this(new Idea70297Config());
    }

    public Idea70297Service(Idea70297Config config) {
        this.config = config != null ? config : new Idea70297Config();
