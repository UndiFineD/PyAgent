...
@Data
public class Idea70133Config {
    private String name = "idea_070133";
 ...
 */
@Slf4j
public class Idea70133Service {
    private static final int IDEA_ID = 70133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70133Service() {
        this(new Idea70133Config());
    }

    public Idea70133Service(Idea70133Config config) {
        this.config = config != null ? config : new Idea70133Config();
