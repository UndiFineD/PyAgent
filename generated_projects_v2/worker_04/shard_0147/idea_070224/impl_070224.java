...
@Data
public class Idea70224Config {
    private String name = "idea_070224";
 ...
 */
@Slf4j
public class Idea70224Service {
    private static final int IDEA_ID = 70224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70224Service() {
        this(new Idea70224Config());
    }

    public Idea70224Service(Idea70224Config config) {
        this.config = config != null ? config : new Idea70224Config();
