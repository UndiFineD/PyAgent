...
@Data
public class Idea70262Config {
    private String name = "idea_070262";
 ...
 */
@Slf4j
public class Idea70262Service {
    private static final int IDEA_ID = 70262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70262Service() {
        this(new Idea70262Config());
    }

    public Idea70262Service(Idea70262Config config) {
        this.config = config != null ? config : new Idea70262Config();
