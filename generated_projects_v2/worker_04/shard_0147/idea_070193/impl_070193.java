...
@Data
public class Idea70193Config {
    private String name = "idea_070193";
 ...
 */
@Slf4j
public class Idea70193Service {
    private static final int IDEA_ID = 70193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70193Service() {
        this(new Idea70193Config());
    }

    public Idea70193Service(Idea70193Config config) {
        this.config = config != null ? config : new Idea70193Config();
