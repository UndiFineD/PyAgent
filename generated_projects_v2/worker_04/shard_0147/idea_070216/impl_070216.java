...
@Data
public class Idea70216Config {
    private String name = "idea_070216";
 ...
 */
@Slf4j
public class Idea70216Service {
    private static final int IDEA_ID = 70216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70216Service() {
        this(new Idea70216Config());
    }

    public Idea70216Service(Idea70216Config config) {
        this.config = config != null ? config : new Idea70216Config();
