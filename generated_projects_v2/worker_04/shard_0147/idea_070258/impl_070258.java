...
@Data
public class Idea70258Config {
    private String name = "idea_070258";
 ...
 */
@Slf4j
public class Idea70258Service {
    private static final int IDEA_ID = 70258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70258Service() {
        this(new Idea70258Config());
    }

    public Idea70258Service(Idea70258Config config) {
        this.config = config != null ? config : new Idea70258Config();
