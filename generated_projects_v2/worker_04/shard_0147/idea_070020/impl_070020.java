...
@Data
public class Idea70020Config {
    private String name = "idea_070020";
 ...
 */
@Slf4j
public class Idea70020Service {
    private static final int IDEA_ID = 70020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70020Service() {
        this(new Idea70020Config());
    }

    public Idea70020Service(Idea70020Config config) {
        this.config = config != null ? config : new Idea70020Config();
