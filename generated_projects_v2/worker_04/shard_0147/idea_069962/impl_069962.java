...
@Data
public class Idea69962Config {
    private String name = "idea_069962";
 ...
 */
@Slf4j
public class Idea69962Service {
    private static final int IDEA_ID = 69962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69962Service() {
        this(new Idea69962Config());
    }

    public Idea69962Service(Idea69962Config config) {
        this.config = config != null ? config : new Idea69962Config();
