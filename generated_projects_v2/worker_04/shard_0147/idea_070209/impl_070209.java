...
@Data
public class Idea70209Config {
    private String name = "idea_070209";
 ...
 */
@Slf4j
public class Idea70209Service {
    private static final int IDEA_ID = 70209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70209Service() {
        this(new Idea70209Config());
    }

    public Idea70209Service(Idea70209Config config) {
        this.config = config != null ? config : new Idea70209Config();
