...
@Data
public class Idea70127Config {
    private String name = "idea_070127";
 ...
 */
@Slf4j
public class Idea70127Service {
    private static final int IDEA_ID = 70127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70127Service() {
        this(new Idea70127Config());
    }

    public Idea70127Service(Idea70127Config config) {
        this.config = config != null ? config : new Idea70127Config();
