...
@Data
public class Idea70246Config {
    private String name = "idea_070246";
 ...
 */
@Slf4j
public class Idea70246Service {
    private static final int IDEA_ID = 70246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70246Service() {
        this(new Idea70246Config());
    }

    public Idea70246Service(Idea70246Config config) {
        this.config = config != null ? config : new Idea70246Config();
