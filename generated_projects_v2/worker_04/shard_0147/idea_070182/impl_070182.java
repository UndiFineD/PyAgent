...
@Data
public class Idea70182Config {
    private String name = "idea_070182";
 ...
 */
@Slf4j
public class Idea70182Service {
    private static final int IDEA_ID = 70182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70182Service() {
        this(new Idea70182Config());
    }

    public Idea70182Service(Idea70182Config config) {
        this.config = config != null ? config : new Idea70182Config();
