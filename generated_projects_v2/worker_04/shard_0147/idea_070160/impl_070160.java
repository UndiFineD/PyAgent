...
@Data
public class Idea70160Config {
    private String name = "idea_070160";
 ...
 */
@Slf4j
public class Idea70160Service {
    private static final int IDEA_ID = 70160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70160Service() {
        this(new Idea70160Config());
    }

    public Idea70160Service(Idea70160Config config) {
        this.config = config != null ? config : new Idea70160Config();
