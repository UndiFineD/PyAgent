...
@Data
public class Idea70089Config {
    private String name = "idea_070089";
 ...
 */
@Slf4j
public class Idea70089Service {
    private static final int IDEA_ID = 70089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70089Service() {
        this(new Idea70089Config());
    }

    public Idea70089Service(Idea70089Config config) {
        this.config = config != null ? config : new Idea70089Config();
