...
@Data
public class Idea70226Config {
    private String name = "idea_070226";
 ...
 */
@Slf4j
public class Idea70226Service {
    private static final int IDEA_ID = 70226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70226Service() {
        this(new Idea70226Config());
    }

    public Idea70226Service(Idea70226Config config) {
        this.config = config != null ? config : new Idea70226Config();
