...
@Data
public class Idea70255Config {
    private String name = "idea_070255";
 ...
 */
@Slf4j
public class Idea70255Service {
    private static final int IDEA_ID = 70255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70255Service() {
        this(new Idea70255Config());
    }

    public Idea70255Service(Idea70255Config config) {
        this.config = config != null ? config : new Idea70255Config();
