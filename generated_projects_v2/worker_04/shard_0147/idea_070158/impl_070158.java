...
@Data
public class Idea70158Config {
    private String name = "idea_070158";
 ...
 */
@Slf4j
public class Idea70158Service {
    private static final int IDEA_ID = 70158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70158Service() {
        this(new Idea70158Config());
    }

    public Idea70158Service(Idea70158Config config) {
        this.config = config != null ? config : new Idea70158Config();
