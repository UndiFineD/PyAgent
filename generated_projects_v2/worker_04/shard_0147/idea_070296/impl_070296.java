...
@Data
public class Idea70296Config {
    private String name = "idea_070296";
 ...
 */
@Slf4j
public class Idea70296Service {
    private static final int IDEA_ID = 70296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70296Service() {
        this(new Idea70296Config());
    }

    public Idea70296Service(Idea70296Config config) {
        this.config = config != null ? config : new Idea70296Config();
