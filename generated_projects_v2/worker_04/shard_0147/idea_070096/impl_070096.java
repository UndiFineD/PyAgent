...
@Data
public class Idea70096Config {
    private String name = "idea_070096";
 ...
 */
@Slf4j
public class Idea70096Service {
    private static final int IDEA_ID = 70096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70096Service() {
        this(new Idea70096Config());
    }

    public Idea70096Service(Idea70096Config config) {
        this.config = config != null ? config : new Idea70096Config();
