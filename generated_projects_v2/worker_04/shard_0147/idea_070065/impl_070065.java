...
@Data
public class Idea70065Config {
    private String name = "idea_070065";
 ...
 */
@Slf4j
public class Idea70065Service {
    private static final int IDEA_ID = 70065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70065Service() {
        this(new Idea70065Config());
    }

    public Idea70065Service(Idea70065Config config) {
        this.config = config != null ? config : new Idea70065Config();
