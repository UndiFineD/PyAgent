...
@Data
public class Idea70114Config {
    private String name = "idea_070114";
 ...
 */
@Slf4j
public class Idea70114Service {
    private static final int IDEA_ID = 70114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70114Service() {
        this(new Idea70114Config());
    }

    public Idea70114Service(Idea70114Config config) {
        this.config = config != null ? config : new Idea70114Config();
