...
@Data
public class Idea70234Config {
    private String name = "idea_070234";
 ...
 */
@Slf4j
public class Idea70234Service {
    private static final int IDEA_ID = 70234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70234Service() {
        this(new Idea70234Config());
    }

    public Idea70234Service(Idea70234Config config) {
        this.config = config != null ? config : new Idea70234Config();
