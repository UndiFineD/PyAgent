...
@Data
public class Idea70261Config {
    private String name = "idea_070261";
 ...
 */
@Slf4j
public class Idea70261Service {
    private static final int IDEA_ID = 70261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70261Service() {
        this(new Idea70261Config());
    }

    public Idea70261Service(Idea70261Config config) {
        this.config = config != null ? config : new Idea70261Config();
