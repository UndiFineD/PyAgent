...
@Data
public class Idea70251Config {
    private String name = "idea_070251";
 ...
 */
@Slf4j
public class Idea70251Service {
    private static final int IDEA_ID = 70251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70251Service() {
        this(new Idea70251Config());
    }

    public Idea70251Service(Idea70251Config config) {
        this.config = config != null ? config : new Idea70251Config();
