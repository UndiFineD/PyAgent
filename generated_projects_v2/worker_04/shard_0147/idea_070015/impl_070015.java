...
@Data
public class Idea70015Config {
    private String name = "idea_070015";
 ...
 */
@Slf4j
public class Idea70015Service {
    private static final int IDEA_ID = 70015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70015Service() {
        this(new Idea70015Config());
    }

    public Idea70015Service(Idea70015Config config) {
        this.config = config != null ? config : new Idea70015Config();
