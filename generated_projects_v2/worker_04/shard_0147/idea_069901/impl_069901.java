...
@Data
public class Idea69901Config {
    private String name = "idea_069901";
 ...
 */
@Slf4j
public class Idea69901Service {
    private static final int IDEA_ID = 69901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69901Service() {
        this(new Idea69901Config());
    }

    public Idea69901Service(Idea69901Config config) {
        this.config = config != null ? config : new Idea69901Config();
