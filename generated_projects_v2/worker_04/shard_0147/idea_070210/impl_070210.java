...
@Data
public class Idea70210Config {
    private String name = "idea_070210";
 ...
 */
@Slf4j
public class Idea70210Service {
    private static final int IDEA_ID = 70210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70210Service() {
        this(new Idea70210Config());
    }

    public Idea70210Service(Idea70210Config config) {
        this.config = config != null ? config : new Idea70210Config();
