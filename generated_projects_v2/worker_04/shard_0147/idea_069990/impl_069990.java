...
@Data
public class Idea69990Config {
    private String name = "idea_069990";
 ...
 */
@Slf4j
public class Idea69990Service {
    private static final int IDEA_ID = 69990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69990Service() {
        this(new Idea69990Config());
    }

    public Idea69990Service(Idea69990Config config) {
        this.config = config != null ? config : new Idea69990Config();
