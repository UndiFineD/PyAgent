...
@Data
public class Idea70017Config {
    private String name = "idea_070017";
 ...
 */
@Slf4j
public class Idea70017Service {
    private static final int IDEA_ID = 70017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70017Service() {
        this(new Idea70017Config());
    }

    public Idea70017Service(Idea70017Config config) {
        this.config = config != null ? config : new Idea70017Config();
