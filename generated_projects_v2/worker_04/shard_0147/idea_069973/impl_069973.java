...
@Data
public class Idea69973Config {
    private String name = "idea_069973";
 ...
 */
@Slf4j
public class Idea69973Service {
    private static final int IDEA_ID = 69973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea69973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea69973Service() {
        this(new Idea69973Config());
    }

    public Idea69973Service(Idea69973Config config) {
        this.config = config != null ? config : new Idea69973Config();
