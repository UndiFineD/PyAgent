...
@Data
public class Idea70022Config {
    private String name = "idea_070022";
 ...
 */
@Slf4j
public class Idea70022Service {
    private static final int IDEA_ID = 70022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70022Service() {
        this(new Idea70022Config());
    }

    public Idea70022Service(Idea70022Config config) {
        this.config = config != null ? config : new Idea70022Config();
