...
@Data
public class Idea70004Config {
    private String name = "idea_070004";
 ...
 */
@Slf4j
public class Idea70004Service {
    private static final int IDEA_ID = 70004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70004Service() {
        this(new Idea70004Config());
    }

    public Idea70004Service(Idea70004Config config) {
        this.config = config != null ? config : new Idea70004Config();
