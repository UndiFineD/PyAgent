...
@Data
public class Idea70124Config {
    private String name = "idea_070124";
 ...
 */
@Slf4j
public class Idea70124Service {
    private static final int IDEA_ID = 70124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70124Service() {
        this(new Idea70124Config());
    }

    public Idea70124Service(Idea70124Config config) {
        this.config = config != null ? config : new Idea70124Config();
