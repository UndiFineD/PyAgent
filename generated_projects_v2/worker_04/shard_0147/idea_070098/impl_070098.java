...
@Data
public class Idea70098Config {
    private String name = "idea_070098";
 ...
 */
@Slf4j
public class Idea70098Service {
    private static final int IDEA_ID = 70098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70098Service() {
        this(new Idea70098Config());
    }

    public Idea70098Service(Idea70098Config config) {
        this.config = config != null ? config : new Idea70098Config();
