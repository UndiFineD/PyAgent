...
@Data
public class Idea70147Config {
    private String name = "idea_070147";
 ...
 */
@Slf4j
public class Idea70147Service {
    private static final int IDEA_ID = 70147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70147Service() {
        this(new Idea70147Config());
    }

    public Idea70147Service(Idea70147Config config) {
        this.config = config != null ? config : new Idea70147Config();
