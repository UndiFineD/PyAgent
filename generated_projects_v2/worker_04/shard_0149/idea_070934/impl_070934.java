...
@Data
public class Idea70934Config {
    private String name = "idea_070934";
 ...
 */
@Slf4j
public class Idea70934Service {
    private static final int IDEA_ID = 70934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70934Service() {
        this(new Idea70934Config());
    }

    public Idea70934Service(Idea70934Config config) {
        this.config = config != null ? config : new Idea70934Config();
