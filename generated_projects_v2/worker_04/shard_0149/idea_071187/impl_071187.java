...
@Data
public class Idea71187Config {
    private String name = "idea_071187";
 ...
 */
@Slf4j
public class Idea71187Service {
    private static final int IDEA_ID = 71187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71187Service() {
        this(new Idea71187Config());
    }

    public Idea71187Service(Idea71187Config config) {
        this.config = config != null ? config : new Idea71187Config();
