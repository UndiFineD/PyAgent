...
@Data
public class Idea71085Config {
    private String name = "idea_071085";
 ...
 */
@Slf4j
public class Idea71085Service {
    private static final int IDEA_ID = 71085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71085Service() {
        this(new Idea71085Config());
    }

    public Idea71085Service(Idea71085Config config) {
        this.config = config != null ? config : new Idea71085Config();
