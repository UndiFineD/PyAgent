...
@Data
public class Idea70892Config {
    private String name = "idea_070892";
 ...
 */
@Slf4j
public class Idea70892Service {
    private static final int IDEA_ID = 70892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70892Service() {
        this(new Idea70892Config());
    }

    public Idea70892Service(Idea70892Config config) {
        this.config = config != null ? config : new Idea70892Config();
