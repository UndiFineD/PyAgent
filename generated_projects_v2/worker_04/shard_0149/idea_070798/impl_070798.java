...
@Data
public class Idea70798Config {
    private String name = "idea_070798";
 ...
 */
@Slf4j
public class Idea70798Service {
    private static final int IDEA_ID = 70798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70798Service() {
        this(new Idea70798Config());
    }

    public Idea70798Service(Idea70798Config config) {
        this.config = config != null ? config : new Idea70798Config();
