...
@Data
public class Idea70880Config {
    private String name = "idea_070880";
 ...
 */
@Slf4j
public class Idea70880Service {
    private static final int IDEA_ID = 70880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70880Service() {
        this(new Idea70880Config());
    }

    public Idea70880Service(Idea70880Config config) {
        this.config = config != null ? config : new Idea70880Config();
