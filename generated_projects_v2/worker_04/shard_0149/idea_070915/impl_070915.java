...
@Data
public class Idea70915Config {
    private String name = "idea_070915";
 ...
 */
@Slf4j
public class Idea70915Service {
    private static final int IDEA_ID = 70915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70915Service() {
        this(new Idea70915Config());
    }

    public Idea70915Service(Idea70915Config config) {
        this.config = config != null ? config : new Idea70915Config();
