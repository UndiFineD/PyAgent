...
@Data
public class Idea70924Config {
    private String name = "idea_070924";
 ...
 */
@Slf4j
public class Idea70924Service {
    private static final int IDEA_ID = 70924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70924Service() {
        this(new Idea70924Config());
    }

    public Idea70924Service(Idea70924Config config) {
        this.config = config != null ? config : new Idea70924Config();
