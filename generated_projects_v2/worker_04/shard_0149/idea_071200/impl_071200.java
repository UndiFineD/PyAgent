...
@Data
public class Idea71200Config {
    private String name = "idea_071200";
 ...
 */
@Slf4j
public class Idea71200Service {
    private static final int IDEA_ID = 71200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71200Service() {
        this(new Idea71200Config());
    }

    public Idea71200Service(Idea71200Config config) {
        this.config = config != null ? config : new Idea71200Config();
