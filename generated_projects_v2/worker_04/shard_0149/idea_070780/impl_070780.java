...
@Data
public class Idea70780Config {
    private String name = "idea_070780";
 ...
 */
@Slf4j
public class Idea70780Service {
    private static final int IDEA_ID = 70780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70780Service() {
        this(new Idea70780Config());
    }

    public Idea70780Service(Idea70780Config config) {
        this.config = config != null ? config : new Idea70780Config();
