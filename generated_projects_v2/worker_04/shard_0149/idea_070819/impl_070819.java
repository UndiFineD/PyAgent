...
@Data
public class Idea70819Config {
    private String name = "idea_070819";
 ...
 */
@Slf4j
public class Idea70819Service {
    private static final int IDEA_ID = 70819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70819Service() {
        this(new Idea70819Config());
    }

    public Idea70819Service(Idea70819Config config) {
        this.config = config != null ? config : new Idea70819Config();
