...
@Data
public class Idea71210Config {
    private String name = "idea_071210";
 ...
 */
@Slf4j
public class Idea71210Service {
    private static final int IDEA_ID = 71210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71210Service() {
        this(new Idea71210Config());
    }

    public Idea71210Service(Idea71210Config config) {
        this.config = config != null ? config : new Idea71210Config();
