...
@Data
public class Idea70910Config {
    private String name = "idea_070910";
 ...
 */
@Slf4j
public class Idea70910Service {
    private static final int IDEA_ID = 70910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70910Service() {
        this(new Idea70910Config());
    }

    public Idea70910Service(Idea70910Config config) {
        this.config = config != null ? config : new Idea70910Config();
