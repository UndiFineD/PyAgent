...
@Data
public class Idea71225Config {
    private String name = "idea_071225";
 ...
 */
@Slf4j
public class Idea71225Service {
    private static final int IDEA_ID = 71225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71225Service() {
        this(new Idea71225Config());
    }

    public Idea71225Service(Idea71225Config config) {
        this.config = config != null ? config : new Idea71225Config();
