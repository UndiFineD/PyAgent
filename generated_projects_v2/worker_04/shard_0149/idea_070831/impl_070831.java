...
@Data
public class Idea70831Config {
    private String name = "idea_070831";
 ...
 */
@Slf4j
public class Idea70831Service {
    private static final int IDEA_ID = 70831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70831Service() {
        this(new Idea70831Config());
    }

    public Idea70831Service(Idea70831Config config) {
        this.config = config != null ? config : new Idea70831Config();
