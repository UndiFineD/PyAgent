...
@Data
public class Idea71101Config {
    private String name = "idea_071101";
 ...
 */
@Slf4j
public class Idea71101Service {
    private static final int IDEA_ID = 71101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71101Service() {
        this(new Idea71101Config());
    }

    public Idea71101Service(Idea71101Config config) {
        this.config = config != null ? config : new Idea71101Config();
