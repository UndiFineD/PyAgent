...
@Data
public class Idea70820Config {
    private String name = "idea_070820";
 ...
 */
@Slf4j
public class Idea70820Service {
    private static final int IDEA_ID = 70820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70820Service() {
        this(new Idea70820Config());
    }

    public Idea70820Service(Idea70820Config config) {
        this.config = config != null ? config : new Idea70820Config();
