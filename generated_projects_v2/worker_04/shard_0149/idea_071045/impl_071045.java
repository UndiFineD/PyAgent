...
@Data
public class Idea71045Config {
    private String name = "idea_071045";
 ...
 */
@Slf4j
public class Idea71045Service {
    private static final int IDEA_ID = 71045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71045Service() {
        this(new Idea71045Config());
    }

    public Idea71045Service(Idea71045Config config) {
        this.config = config != null ? config : new Idea71045Config();
