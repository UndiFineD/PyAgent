...
@Data
public class Idea71017Config {
    private String name = "idea_071017";
 ...
 */
@Slf4j
public class Idea71017Service {
    private static final int IDEA_ID = 71017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71017Service() {
        this(new Idea71017Config());
    }

    public Idea71017Service(Idea71017Config config) {
        this.config = config != null ? config : new Idea71017Config();
