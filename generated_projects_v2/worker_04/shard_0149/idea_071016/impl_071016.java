...
@Data
public class Idea71016Config {
    private String name = "idea_071016";
 ...
 */
@Slf4j
public class Idea71016Service {
    private static final int IDEA_ID = 71016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71016Service() {
        this(new Idea71016Config());
    }

    public Idea71016Service(Idea71016Config config) {
        this.config = config != null ? config : new Idea71016Config();
