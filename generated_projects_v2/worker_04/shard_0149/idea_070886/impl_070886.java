...
@Data
public class Idea70886Config {
    private String name = "idea_070886";
 ...
 */
@Slf4j
public class Idea70886Service {
    private static final int IDEA_ID = 70886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70886Service() {
        this(new Idea70886Config());
    }

    public Idea70886Service(Idea70886Config config) {
        this.config = config != null ? config : new Idea70886Config();
