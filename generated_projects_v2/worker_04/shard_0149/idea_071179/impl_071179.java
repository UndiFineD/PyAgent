...
@Data
public class Idea71179Config {
    private String name = "idea_071179";
 ...
 */
@Slf4j
public class Idea71179Service {
    private static final int IDEA_ID = 71179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71179Service() {
        this(new Idea71179Config());
    }

    public Idea71179Service(Idea71179Config config) {
        this.config = config != null ? config : new Idea71179Config();
