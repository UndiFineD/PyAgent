...
@Data
public class Idea71077Config {
    private String name = "idea_071077";
 ...
 */
@Slf4j
public class Idea71077Service {
    private static final int IDEA_ID = 71077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71077Service() {
        this(new Idea71077Config());
    }

    public Idea71077Service(Idea71077Config config) {
        this.config = config != null ? config : new Idea71077Config();
