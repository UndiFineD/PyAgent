...
@Data
public class Idea70797Config {
    private String name = "idea_070797";
 ...
 */
@Slf4j
public class Idea70797Service {
    private static final int IDEA_ID = 70797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70797Service() {
        this(new Idea70797Config());
    }

    public Idea70797Service(Idea70797Config config) {
        this.config = config != null ? config : new Idea70797Config();
