...
@Data
public class Idea71204Config {
    private String name = "idea_071204";
 ...
 */
@Slf4j
public class Idea71204Service {
    private static final int IDEA_ID = 71204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71204Service() {
        this(new Idea71204Config());
    }

    public Idea71204Service(Idea71204Config config) {
        this.config = config != null ? config : new Idea71204Config();
