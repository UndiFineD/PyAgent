...
@Data
public class Idea70947Config {
    private String name = "idea_070947";
 ...
 */
@Slf4j
public class Idea70947Service {
    private static final int IDEA_ID = 70947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70947Service() {
        this(new Idea70947Config());
    }

    public Idea70947Service(Idea70947Config config) {
        this.config = config != null ? config : new Idea70947Config();
