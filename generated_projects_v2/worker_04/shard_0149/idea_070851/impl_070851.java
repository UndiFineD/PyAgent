...
@Data
public class Idea70851Config {
    private String name = "idea_070851";
 ...
 */
@Slf4j
public class Idea70851Service {
    private static final int IDEA_ID = 70851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70851Service() {
        this(new Idea70851Config());
    }

    public Idea70851Service(Idea70851Config config) {
        this.config = config != null ? config : new Idea70851Config();
