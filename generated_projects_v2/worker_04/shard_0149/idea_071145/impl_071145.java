...
@Data
public class Idea71145Config {
    private String name = "idea_071145";
 ...
 */
@Slf4j
public class Idea71145Service {
    private static final int IDEA_ID = 71145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71145Service() {
        this(new Idea71145Config());
    }

    public Idea71145Service(Idea71145Config config) {
        this.config = config != null ? config : new Idea71145Config();
