...
@Data
public class Idea70883Config {
    private String name = "idea_070883";
 ...
 */
@Slf4j
public class Idea70883Service {
    private static final int IDEA_ID = 70883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70883Service() {
        this(new Idea70883Config());
    }

    public Idea70883Service(Idea70883Config config) {
        this.config = config != null ? config : new Idea70883Config();
