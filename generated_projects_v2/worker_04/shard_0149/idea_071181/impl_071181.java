...
@Data
public class Idea71181Config {
    private String name = "idea_071181";
 ...
 */
@Slf4j
public class Idea71181Service {
    private static final int IDEA_ID = 71181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71181Service() {
        this(new Idea71181Config());
    }

    public Idea71181Service(Idea71181Config config) {
        this.config = config != null ? config : new Idea71181Config();
