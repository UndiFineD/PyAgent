...
@Data
public class Idea70933Config {
    private String name = "idea_070933";
 ...
 */
@Slf4j
public class Idea70933Service {
    private static final int IDEA_ID = 70933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70933Service() {
        this(new Idea70933Config());
    }

    public Idea70933Service(Idea70933Config config) {
        this.config = config != null ? config : new Idea70933Config();
