...
@Data
public class Idea70779Config {
    private String name = "idea_070779";
 ...
 */
@Slf4j
public class Idea70779Service {
    private static final int IDEA_ID = 70779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70779Service() {
        this(new Idea70779Config());
    }

    public Idea70779Service(Idea70779Config config) {
        this.config = config != null ? config : new Idea70779Config();
