...
@Data
public class Idea71003Config {
    private String name = "idea_071003";
 ...
 */
@Slf4j
public class Idea71003Service {
    private static final int IDEA_ID = 71003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71003Service() {
        this(new Idea71003Config());
    }

    public Idea71003Service(Idea71003Config config) {
        this.config = config != null ? config : new Idea71003Config();
