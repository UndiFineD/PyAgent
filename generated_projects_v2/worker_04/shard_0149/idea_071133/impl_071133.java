...
@Data
public class Idea71133Config {
    private String name = "idea_071133";
 ...
 */
@Slf4j
public class Idea71133Service {
    private static final int IDEA_ID = 71133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71133Service() {
        this(new Idea71133Config());
    }

    public Idea71133Service(Idea71133Config config) {
        this.config = config != null ? config : new Idea71133Config();
