...
@Data
public class Idea70803Config {
    private String name = "idea_070803";
 ...
 */
@Slf4j
public class Idea70803Service {
    private static final int IDEA_ID = 70803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70803Service() {
        this(new Idea70803Config());
    }

    public Idea70803Service(Idea70803Config config) {
        this.config = config != null ? config : new Idea70803Config();
