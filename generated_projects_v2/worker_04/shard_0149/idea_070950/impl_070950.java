...
@Data
public class Idea70950Config {
    private String name = "idea_070950";
 ...
 */
@Slf4j
public class Idea70950Service {
    private static final int IDEA_ID = 70950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70950Service() {
        this(new Idea70950Config());
    }

    public Idea70950Service(Idea70950Config config) {
        this.config = config != null ? config : new Idea70950Config();
