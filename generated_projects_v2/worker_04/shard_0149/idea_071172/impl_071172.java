...
@Data
public class Idea71172Config {
    private String name = "idea_071172";
 ...
 */
@Slf4j
public class Idea71172Service {
    private static final int IDEA_ID = 71172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71172Service() {
        this(new Idea71172Config());
    }

    public Idea71172Service(Idea71172Config config) {
        this.config = config != null ? config : new Idea71172Config();
