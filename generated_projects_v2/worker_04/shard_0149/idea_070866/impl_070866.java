...
@Data
public class Idea70866Config {
    private String name = "idea_070866";
 ...
 */
@Slf4j
public class Idea70866Service {
    private static final int IDEA_ID = 70866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70866Service() {
        this(new Idea70866Config());
    }

    public Idea70866Service(Idea70866Config config) {
        this.config = config != null ? config : new Idea70866Config();
