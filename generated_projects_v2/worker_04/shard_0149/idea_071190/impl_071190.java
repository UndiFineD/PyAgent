...
@Data
public class Idea71190Config {
    private String name = "idea_071190";
 ...
 */
@Slf4j
public class Idea71190Service {
    private static final int IDEA_ID = 71190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71190Service() {
        this(new Idea71190Config());
    }

    public Idea71190Service(Idea71190Config config) {
        this.config = config != null ? config : new Idea71190Config();
