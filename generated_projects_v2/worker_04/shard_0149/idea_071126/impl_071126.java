...
@Data
public class Idea71126Config {
    private String name = "idea_071126";
 ...
 */
@Slf4j
public class Idea71126Service {
    private static final int IDEA_ID = 71126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71126Service() {
        this(new Idea71126Config());
    }

    public Idea71126Service(Idea71126Config config) {
        this.config = config != null ? config : new Idea71126Config();
