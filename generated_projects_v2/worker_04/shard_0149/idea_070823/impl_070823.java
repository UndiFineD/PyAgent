...
@Data
public class Idea70823Config {
    private String name = "idea_070823";
 ...
 */
@Slf4j
public class Idea70823Service {
    private static final int IDEA_ID = 70823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70823Service() {
        this(new Idea70823Config());
    }

    public Idea70823Service(Idea70823Config config) {
        this.config = config != null ? config : new Idea70823Config();
