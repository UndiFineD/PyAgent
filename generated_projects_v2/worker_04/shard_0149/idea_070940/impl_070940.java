...
@Data
public class Idea70940Config {
    private String name = "idea_070940";
 ...
 */
@Slf4j
public class Idea70940Service {
    private static final int IDEA_ID = 70940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70940Service() {
        this(new Idea70940Config());
    }

    public Idea70940Service(Idea70940Config config) {
        this.config = config != null ? config : new Idea70940Config();
