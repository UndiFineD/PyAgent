...
@Data
public class Idea70778Config {
    private String name = "idea_070778";
 ...
 */
@Slf4j
public class Idea70778Service {
    private static final int IDEA_ID = 70778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70778Service() {
        this(new Idea70778Config());
    }

    public Idea70778Service(Idea70778Config config) {
        this.config = config != null ? config : new Idea70778Config();
