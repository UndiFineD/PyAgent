...
@Data
public class Idea71232Config {
    private String name = "idea_071232";
 ...
 */
@Slf4j
public class Idea71232Service {
    private static final int IDEA_ID = 71232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71232Service() {
        this(new Idea71232Config());
    }

    public Idea71232Service(Idea71232Config config) {
        this.config = config != null ? config : new Idea71232Config();
