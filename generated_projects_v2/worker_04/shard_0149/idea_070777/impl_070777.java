...
@Data
public class Idea70777Config {
    private String name = "idea_070777";
 ...
 */
@Slf4j
public class Idea70777Service {
    private static final int IDEA_ID = 70777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70777Service() {
        this(new Idea70777Config());
    }

    public Idea70777Service(Idea70777Config config) {
        this.config = config != null ? config : new Idea70777Config();
