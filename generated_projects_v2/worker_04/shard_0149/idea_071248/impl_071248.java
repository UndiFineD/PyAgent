...
@Data
public class Idea71248Config {
    private String name = "idea_071248";
 ...
 */
@Slf4j
public class Idea71248Service {
    private static final int IDEA_ID = 71248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71248Service() {
        this(new Idea71248Config());
    }

    public Idea71248Service(Idea71248Config config) {
        this.config = config != null ? config : new Idea71248Config();
