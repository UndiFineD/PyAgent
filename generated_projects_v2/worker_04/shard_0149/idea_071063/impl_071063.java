...
@Data
public class Idea71063Config {
    private String name = "idea_071063";
 ...
 */
@Slf4j
public class Idea71063Service {
    private static final int IDEA_ID = 71063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71063Service() {
        this(new Idea71063Config());
    }

    public Idea71063Service(Idea71063Config config) {
        this.config = config != null ? config : new Idea71063Config();
