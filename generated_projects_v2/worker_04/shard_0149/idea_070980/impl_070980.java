...
@Data
public class Idea70980Config {
    private String name = "idea_070980";
 ...
 */
@Slf4j
public class Idea70980Service {
    private static final int IDEA_ID = 70980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70980Service() {
        this(new Idea70980Config());
    }

    public Idea70980Service(Idea70980Config config) {
        this.config = config != null ? config : new Idea70980Config();
