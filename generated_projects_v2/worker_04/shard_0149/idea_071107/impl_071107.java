...
@Data
public class Idea71107Config {
    private String name = "idea_071107";
 ...
 */
@Slf4j
public class Idea71107Service {
    private static final int IDEA_ID = 71107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71107Service() {
        this(new Idea71107Config());
    }

    public Idea71107Service(Idea71107Config config) {
        this.config = config != null ? config : new Idea71107Config();
