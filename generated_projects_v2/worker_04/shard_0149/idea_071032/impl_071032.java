...
@Data
public class Idea71032Config {
    private String name = "idea_071032";
 ...
 */
@Slf4j
public class Idea71032Service {
    private static final int IDEA_ID = 71032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71032Service() {
        this(new Idea71032Config());
    }

    public Idea71032Service(Idea71032Config config) {
        this.config = config != null ? config : new Idea71032Config();
