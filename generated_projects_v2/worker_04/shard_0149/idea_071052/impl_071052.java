...
@Data
public class Idea71052Config {
    private String name = "idea_071052";
 ...
 */
@Slf4j
public class Idea71052Service {
    private static final int IDEA_ID = 71052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71052Service() {
        this(new Idea71052Config());
    }

    public Idea71052Service(Idea71052Config config) {
        this.config = config != null ? config : new Idea71052Config();
