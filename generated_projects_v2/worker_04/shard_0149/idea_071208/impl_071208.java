...
@Data
public class Idea71208Config {
    private String name = "idea_071208";
 ...
 */
@Slf4j
public class Idea71208Service {
    private static final int IDEA_ID = 71208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71208Service() {
        this(new Idea71208Config());
    }

    public Idea71208Service(Idea71208Config config) {
        this.config = config != null ? config : new Idea71208Config();
