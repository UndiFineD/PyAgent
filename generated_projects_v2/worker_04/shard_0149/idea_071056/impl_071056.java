...
@Data
public class Idea71056Config {
    private String name = "idea_071056";
 ...
 */
@Slf4j
public class Idea71056Service {
    private static final int IDEA_ID = 71056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71056Service() {
        this(new Idea71056Config());
    }

    public Idea71056Service(Idea71056Config config) {
        this.config = config != null ? config : new Idea71056Config();
