...
@Data
public class Idea70873Config {
    private String name = "idea_070873";
 ...
 */
@Slf4j
public class Idea70873Service {
    private static final int IDEA_ID = 70873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70873Service() {
        this(new Idea70873Config());
    }

    public Idea70873Service(Idea70873Config config) {
        this.config = config != null ? config : new Idea70873Config();
