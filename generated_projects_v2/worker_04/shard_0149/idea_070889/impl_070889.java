...
@Data
public class Idea70889Config {
    private String name = "idea_070889";
 ...
 */
@Slf4j
public class Idea70889Service {
    private static final int IDEA_ID = 70889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70889Service() {
        this(new Idea70889Config());
    }

    public Idea70889Service(Idea70889Config config) {
        this.config = config != null ? config : new Idea70889Config();
