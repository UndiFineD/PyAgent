...
@Data
public class Idea71241Config {
    private String name = "idea_071241";
 ...
 */
@Slf4j
public class Idea71241Service {
    private static final int IDEA_ID = 71241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71241Service() {
        this(new Idea71241Config());
    }

    public Idea71241Service(Idea71241Config config) {
        this.config = config != null ? config : new Idea71241Config();
