...
@Data
public class Idea70876Config {
    private String name = "idea_070876";
 ...
 */
@Slf4j
public class Idea70876Service {
    private static final int IDEA_ID = 70876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70876Service() {
        this(new Idea70876Config());
    }

    public Idea70876Service(Idea70876Config config) {
        this.config = config != null ? config : new Idea70876Config();
