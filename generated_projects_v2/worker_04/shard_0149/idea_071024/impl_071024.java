...
@Data
public class Idea71024Config {
    private String name = "idea_071024";
 ...
 */
@Slf4j
public class Idea71024Service {
    private static final int IDEA_ID = 71024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71024Service() {
        this(new Idea71024Config());
    }

    public Idea71024Service(Idea71024Config config) {
        this.config = config != null ? config : new Idea71024Config();
