...
@Data
public class Idea70923Config {
    private String name = "idea_070923";
 ...
 */
@Slf4j
public class Idea70923Service {
    private static final int IDEA_ID = 70923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70923Service() {
        this(new Idea70923Config());
    }

    public Idea70923Service(Idea70923Config config) {
        this.config = config != null ? config : new Idea70923Config();
