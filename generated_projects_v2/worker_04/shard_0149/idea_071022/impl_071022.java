...
@Data
public class Idea71022Config {
    private String name = "idea_071022";
 ...
 */
@Slf4j
public class Idea71022Service {
    private static final int IDEA_ID = 71022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71022Service() {
        this(new Idea71022Config());
    }

    public Idea71022Service(Idea71022Config config) {
        this.config = config != null ? config : new Idea71022Config();
