...
@Data
public class Idea71042Config {
    private String name = "idea_071042";
 ...
 */
@Slf4j
public class Idea71042Service {
    private static final int IDEA_ID = 71042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71042Service() {
        this(new Idea71042Config());
    }

    public Idea71042Service(Idea71042Config config) {
        this.config = config != null ? config : new Idea71042Config();
