...
@Data
public class Idea71079Config {
    private String name = "idea_071079";
 ...
 */
@Slf4j
public class Idea71079Service {
    private static final int IDEA_ID = 71079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71079Service() {
        this(new Idea71079Config());
    }

    public Idea71079Service(Idea71079Config config) {
        this.config = config != null ? config : new Idea71079Config();
