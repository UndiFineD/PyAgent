...
@Data
public class Idea71180Config {
    private String name = "idea_071180";
 ...
 */
@Slf4j
public class Idea71180Service {
    private static final int IDEA_ID = 71180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71180Service() {
        this(new Idea71180Config());
    }

    public Idea71180Service(Idea71180Config config) {
        this.config = config != null ? config : new Idea71180Config();
