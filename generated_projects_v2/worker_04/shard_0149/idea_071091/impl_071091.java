...
@Data
public class Idea71091Config {
    private String name = "idea_071091";
 ...
 */
@Slf4j
public class Idea71091Service {
    private static final int IDEA_ID = 71091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71091Service() {
        this(new Idea71091Config());
    }

    public Idea71091Service(Idea71091Config config) {
        this.config = config != null ? config : new Idea71091Config();
