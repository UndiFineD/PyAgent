...
@Data
public class Idea70897Config {
    private String name = "idea_070897";
 ...
 */
@Slf4j
public class Idea70897Service {
    private static final int IDEA_ID = 70897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70897Service() {
        this(new Idea70897Config());
    }

    public Idea70897Service(Idea70897Config config) {
        this.config = config != null ? config : new Idea70897Config();
