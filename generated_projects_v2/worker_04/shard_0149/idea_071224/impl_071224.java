...
@Data
public class Idea71224Config {
    private String name = "idea_071224";
 ...
 */
@Slf4j
public class Idea71224Service {
    private static final int IDEA_ID = 71224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71224Service() {
        this(new Idea71224Config());
    }

    public Idea71224Service(Idea71224Config config) {
        this.config = config != null ? config : new Idea71224Config();
