...
@Data
public class Idea70801Config {
    private String name = "idea_070801";
 ...
 */
@Slf4j
public class Idea70801Service {
    private static final int IDEA_ID = 70801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70801Service() {
        this(new Idea70801Config());
    }

    public Idea70801Service(Idea70801Config config) {
        this.config = config != null ? config : new Idea70801Config();
