...
@Data
public class Idea70833Config {
    private String name = "idea_070833";
 ...
 */
@Slf4j
public class Idea70833Service {
    private static final int IDEA_ID = 70833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70833Service() {
        this(new Idea70833Config());
    }

    public Idea70833Service(Idea70833Config config) {
        this.config = config != null ? config : new Idea70833Config();
