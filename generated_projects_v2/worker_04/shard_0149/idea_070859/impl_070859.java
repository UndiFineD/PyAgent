...
@Data
public class Idea70859Config {
    private String name = "idea_070859";
 ...
 */
@Slf4j
public class Idea70859Service {
    private static final int IDEA_ID = 70859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70859Service() {
        this(new Idea70859Config());
    }

    public Idea70859Service(Idea70859Config config) {
        this.config = config != null ? config : new Idea70859Config();
