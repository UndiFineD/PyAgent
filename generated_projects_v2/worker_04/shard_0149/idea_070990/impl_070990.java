...
@Data
public class Idea70990Config {
    private String name = "idea_070990";
 ...
 */
@Slf4j
public class Idea70990Service {
    private static final int IDEA_ID = 70990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70990Service() {
        this(new Idea70990Config());
    }

    public Idea70990Service(Idea70990Config config) {
        this.config = config != null ? config : new Idea70990Config();
