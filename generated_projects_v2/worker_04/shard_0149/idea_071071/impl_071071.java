...
@Data
public class Idea71071Config {
    private String name = "idea_071071";
 ...
 */
@Slf4j
public class Idea71071Service {
    private static final int IDEA_ID = 71071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71071Service() {
        this(new Idea71071Config());
    }

    public Idea71071Service(Idea71071Config config) {
        this.config = config != null ? config : new Idea71071Config();
