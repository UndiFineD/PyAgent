...
@Data
public class Idea70972Config {
    private String name = "idea_070972";
 ...
 */
@Slf4j
public class Idea70972Service {
    private static final int IDEA_ID = 70972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70972Service() {
        this(new Idea70972Config());
    }

    public Idea70972Service(Idea70972Config config) {
        this.config = config != null ? config : new Idea70972Config();
