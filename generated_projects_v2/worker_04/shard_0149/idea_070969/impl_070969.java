...
@Data
public class Idea70969Config {
    private String name = "idea_070969";
 ...
 */
@Slf4j
public class Idea70969Service {
    private static final int IDEA_ID = 70969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70969Service() {
        this(new Idea70969Config());
    }

    public Idea70969Service(Idea70969Config config) {
        this.config = config != null ? config : new Idea70969Config();
