...
@Data
public class Idea71067Config {
    private String name = "idea_071067";
 ...
 */
@Slf4j
public class Idea71067Service {
    private static final int IDEA_ID = 71067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71067Service() {
        this(new Idea71067Config());
    }

    public Idea71067Service(Idea71067Config config) {
        this.config = config != null ? config : new Idea71067Config();
