...
@Data
public class Idea70998Config {
    private String name = "idea_070998";
 ...
 */
@Slf4j
public class Idea70998Service {
    private static final int IDEA_ID = 70998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70998Service() {
        this(new Idea70998Config());
    }

    public Idea70998Service(Idea70998Config config) {
        this.config = config != null ? config : new Idea70998Config();
