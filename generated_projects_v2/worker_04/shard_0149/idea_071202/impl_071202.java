...
@Data
public class Idea71202Config {
    private String name = "idea_071202";
 ...
 */
@Slf4j
public class Idea71202Service {
    private static final int IDEA_ID = 71202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71202Service() {
        this(new Idea71202Config());
    }

    public Idea71202Service(Idea71202Config config) {
        this.config = config != null ? config : new Idea71202Config();
