...
@Data
public class Idea70826Config {
    private String name = "idea_070826";
 ...
 */
@Slf4j
public class Idea70826Service {
    private static final int IDEA_ID = 70826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70826Service() {
        this(new Idea70826Config());
    }

    public Idea70826Service(Idea70826Config config) {
        this.config = config != null ? config : new Idea70826Config();
