...
@Data
public class Idea70912Config {
    private String name = "idea_070912";
 ...
 */
@Slf4j
public class Idea70912Service {
    private static final int IDEA_ID = 70912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70912Service() {
        this(new Idea70912Config());
    }

    public Idea70912Service(Idea70912Config config) {
        this.config = config != null ? config : new Idea70912Config();
