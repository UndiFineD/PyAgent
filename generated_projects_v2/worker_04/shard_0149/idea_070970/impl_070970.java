...
@Data
public class Idea70970Config {
    private String name = "idea_070970";
 ...
 */
@Slf4j
public class Idea70970Service {
    private static final int IDEA_ID = 70970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70970Service() {
        this(new Idea70970Config());
    }

    public Idea70970Service(Idea70970Config config) {
        this.config = config != null ? config : new Idea70970Config();
