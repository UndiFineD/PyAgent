...
@Data
public class Idea71221Config {
    private String name = "idea_071221";
 ...
 */
@Slf4j
public class Idea71221Service {
    private static final int IDEA_ID = 71221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71221Service() {
        this(new Idea71221Config());
    }

    public Idea71221Service(Idea71221Config config) {
        this.config = config != null ? config : new Idea71221Config();
