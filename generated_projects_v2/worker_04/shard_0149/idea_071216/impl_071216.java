...
@Data
public class Idea71216Config {
    private String name = "idea_071216";
 ...
 */
@Slf4j
public class Idea71216Service {
    private static final int IDEA_ID = 71216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71216Service() {
        this(new Idea71216Config());
    }

    public Idea71216Service(Idea71216Config config) {
        this.config = config != null ? config : new Idea71216Config();
