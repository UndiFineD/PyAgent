...
@Data
public class Idea71013Config {
    private String name = "idea_071013";
 ...
 */
@Slf4j
public class Idea71013Service {
    private static final int IDEA_ID = 71013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71013Service() {
        this(new Idea71013Config());
    }

    public Idea71013Service(Idea71013Config config) {
        this.config = config != null ? config : new Idea71013Config();
