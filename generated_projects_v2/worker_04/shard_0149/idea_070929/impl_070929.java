...
@Data
public class Idea70929Config {
    private String name = "idea_070929";
 ...
 */
@Slf4j
public class Idea70929Service {
    private static final int IDEA_ID = 70929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70929Service() {
        this(new Idea70929Config());
    }

    public Idea70929Service(Idea70929Config config) {
        this.config = config != null ? config : new Idea70929Config();
