...
@Data
public class Idea71095Config {
    private String name = "idea_071095";
 ...
 */
@Slf4j
public class Idea71095Service {
    private static final int IDEA_ID = 71095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71095Service() {
        this(new Idea71095Config());
    }

    public Idea71095Service(Idea71095Config config) {
        this.config = config != null ? config : new Idea71095Config();
