...
@Data
public class Idea71230Config {
    private String name = "idea_071230";
 ...
 */
@Slf4j
public class Idea71230Service {
    private static final int IDEA_ID = 71230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71230Service() {
        this(new Idea71230Config());
    }

    public Idea71230Service(Idea71230Config config) {
        this.config = config != null ? config : new Idea71230Config();
