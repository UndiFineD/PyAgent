...
@Data
public class Idea70939Config {
    private String name = "idea_070939";
 ...
 */
@Slf4j
public class Idea70939Service {
    private static final int IDEA_ID = 70939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70939Service() {
        this(new Idea70939Config());
    }

    public Idea70939Service(Idea70939Config config) {
        this.config = config != null ? config : new Idea70939Config();
