...
@Data
public class Idea71206Config {
    private String name = "idea_071206";
 ...
 */
@Slf4j
public class Idea71206Service {
    private static final int IDEA_ID = 71206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71206Service() {
        this(new Idea71206Config());
    }

    public Idea71206Service(Idea71206Config config) {
        this.config = config != null ? config : new Idea71206Config();
