...
@Data
public class Idea70839Config {
    private String name = "idea_070839";
 ...
 */
@Slf4j
public class Idea70839Service {
    private static final int IDEA_ID = 70839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70839Service() {
        this(new Idea70839Config());
    }

    public Idea70839Service(Idea70839Config config) {
        this.config = config != null ? config : new Idea70839Config();
