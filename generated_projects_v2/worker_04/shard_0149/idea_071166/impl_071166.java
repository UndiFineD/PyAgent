...
@Data
public class Idea71166Config {
    private String name = "idea_071166";
 ...
 */
@Slf4j
public class Idea71166Service {
    private static final int IDEA_ID = 71166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71166Service() {
        this(new Idea71166Config());
    }

    public Idea71166Service(Idea71166Config config) {
        this.config = config != null ? config : new Idea71166Config();
