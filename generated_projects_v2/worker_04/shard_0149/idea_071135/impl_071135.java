...
@Data
public class Idea71135Config {
    private String name = "idea_071135";
 ...
 */
@Slf4j
public class Idea71135Service {
    private static final int IDEA_ID = 71135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71135Service() {
        this(new Idea71135Config());
    }

    public Idea71135Service(Idea71135Config config) {
        this.config = config != null ? config : new Idea71135Config();
