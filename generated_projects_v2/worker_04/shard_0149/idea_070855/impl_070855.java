...
@Data
public class Idea70855Config {
    private String name = "idea_070855";
 ...
 */
@Slf4j
public class Idea70855Service {
    private static final int IDEA_ID = 70855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70855Service() {
        this(new Idea70855Config());
    }

    public Idea70855Service(Idea70855Config config) {
        this.config = config != null ? config : new Idea70855Config();
