...
@Data
public class Idea70996Config {
    private String name = "idea_070996";
 ...
 */
@Slf4j
public class Idea70996Service {
    private static final int IDEA_ID = 70996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70996Service() {
        this(new Idea70996Config());
    }

    public Idea70996Service(Idea70996Config config) {
        this.config = config != null ? config : new Idea70996Config();
