...
@Data
public class Idea71222Config {
    private String name = "idea_071222";
 ...
 */
@Slf4j
public class Idea71222Service {
    private static final int IDEA_ID = 71222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71222Service() {
        this(new Idea71222Config());
    }

    public Idea71222Service(Idea71222Config config) {
        this.config = config != null ? config : new Idea71222Config();
