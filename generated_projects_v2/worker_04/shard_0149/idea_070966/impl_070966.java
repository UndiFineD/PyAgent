...
@Data
public class Idea70966Config {
    private String name = "idea_070966";
 ...
 */
@Slf4j
public class Idea70966Service {
    private static final int IDEA_ID = 70966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70966Service() {
        this(new Idea70966Config());
    }

    public Idea70966Service(Idea70966Config config) {
        this.config = config != null ? config : new Idea70966Config();
