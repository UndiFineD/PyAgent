...
@Data
public class Idea70862Config {
    private String name = "idea_070862";
 ...
 */
@Slf4j
public class Idea70862Service {
    private static final int IDEA_ID = 70862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70862Service() {
        this(new Idea70862Config());
    }

    public Idea70862Service(Idea70862Config config) {
        this.config = config != null ? config : new Idea70862Config();
