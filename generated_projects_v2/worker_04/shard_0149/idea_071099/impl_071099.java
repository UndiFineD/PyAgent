...
@Data
public class Idea71099Config {
    private String name = "idea_071099";
 ...
 */
@Slf4j
public class Idea71099Service {
    private static final int IDEA_ID = 71099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71099Service() {
        this(new Idea71099Config());
    }

    public Idea71099Service(Idea71099Config config) {
        this.config = config != null ? config : new Idea71099Config();
