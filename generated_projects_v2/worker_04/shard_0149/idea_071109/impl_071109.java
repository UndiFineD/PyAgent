...
@Data
public class Idea71109Config {
    private String name = "idea_071109";
 ...
 */
@Slf4j
public class Idea71109Service {
    private static final int IDEA_ID = 71109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71109Service() {
        this(new Idea71109Config());
    }

    public Idea71109Service(Idea71109Config config) {
        this.config = config != null ? config : new Idea71109Config();
