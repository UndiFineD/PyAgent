...
@Data
public class Idea70890Config {
    private String name = "idea_070890";
 ...
 */
@Slf4j
public class Idea70890Service {
    private static final int IDEA_ID = 70890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70890Service() {
        this(new Idea70890Config());
    }

    public Idea70890Service(Idea70890Config config) {
        this.config = config != null ? config : new Idea70890Config();
