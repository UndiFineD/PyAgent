...
@Data
public class Idea70992Config {
    private String name = "idea_070992";
 ...
 */
@Slf4j
public class Idea70992Service {
    private static final int IDEA_ID = 70992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70992Service() {
        this(new Idea70992Config());
    }

    public Idea70992Service(Idea70992Config config) {
        this.config = config != null ? config : new Idea70992Config();
