...
@Data
public class Idea70829Config {
    private String name = "idea_070829";
 ...
 */
@Slf4j
public class Idea70829Service {
    private static final int IDEA_ID = 70829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70829Service() {
        this(new Idea70829Config());
    }

    public Idea70829Service(Idea70829Config config) {
        this.config = config != null ? config : new Idea70829Config();
