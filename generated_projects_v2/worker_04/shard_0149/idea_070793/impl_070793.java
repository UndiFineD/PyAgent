...
@Data
public class Idea70793Config {
    private String name = "idea_070793";
 ...
 */
@Slf4j
public class Idea70793Service {
    private static final int IDEA_ID = 70793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70793Service() {
        this(new Idea70793Config());
    }

    public Idea70793Service(Idea70793Config config) {
        this.config = config != null ? config : new Idea70793Config();
