...
@Data
public class Idea71002Config {
    private String name = "idea_071002";
 ...
 */
@Slf4j
public class Idea71002Service {
    private static final int IDEA_ID = 71002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71002Service() {
        this(new Idea71002Config());
    }

    public Idea71002Service(Idea71002Config config) {
        this.config = config != null ? config : new Idea71002Config();
