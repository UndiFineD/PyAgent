...
@Data
public class Idea71104Config {
    private String name = "idea_071104";
 ...
 */
@Slf4j
public class Idea71104Service {
    private static final int IDEA_ID = 71104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71104Service() {
        this(new Idea71104Config());
    }

    public Idea71104Service(Idea71104Config config) {
        this.config = config != null ? config : new Idea71104Config();
