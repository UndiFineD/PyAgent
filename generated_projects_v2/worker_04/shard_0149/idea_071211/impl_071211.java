...
@Data
public class Idea71211Config {
    private String name = "idea_071211";
 ...
 */
@Slf4j
public class Idea71211Service {
    private static final int IDEA_ID = 71211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71211Service() {
        this(new Idea71211Config());
    }

    public Idea71211Service(Idea71211Config config) {
        this.config = config != null ? config : new Idea71211Config();
