...
@Data
public class Idea70806Config {
    private String name = "idea_070806";
 ...
 */
@Slf4j
public class Idea70806Service {
    private static final int IDEA_ID = 70806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70806Service() {
        this(new Idea70806Config());
    }

    public Idea70806Service(Idea70806Config config) {
        this.config = config != null ? config : new Idea70806Config();
