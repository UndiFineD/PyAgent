...
@Data
public class Idea70881Config {
    private String name = "idea_070881";
 ...
 */
@Slf4j
public class Idea70881Service {
    private static final int IDEA_ID = 70881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70881Service() {
        this(new Idea70881Config());
    }

    public Idea70881Service(Idea70881Config config) {
        this.config = config != null ? config : new Idea70881Config();
