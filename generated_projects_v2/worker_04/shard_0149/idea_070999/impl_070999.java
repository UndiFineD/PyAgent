...
@Data
public class Idea70999Config {
    private String name = "idea_070999";
 ...
 */
@Slf4j
public class Idea70999Service {
    private static final int IDEA_ID = 70999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70999Service() {
        this(new Idea70999Config());
    }

    public Idea70999Service(Idea70999Config config) {
        this.config = config != null ? config : new Idea70999Config();
