...
@Data
public class Idea70965Config {
    private String name = "idea_070965";
 ...
 */
@Slf4j
public class Idea70965Service {
    private static final int IDEA_ID = 70965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70965Service() {
        this(new Idea70965Config());
    }

    public Idea70965Service(Idea70965Config config) {
        this.config = config != null ? config : new Idea70965Config();
