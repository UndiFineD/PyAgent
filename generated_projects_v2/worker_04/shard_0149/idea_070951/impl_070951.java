...
@Data
public class Idea70951Config {
    private String name = "idea_070951";
 ...
 */
@Slf4j
public class Idea70951Service {
    private static final int IDEA_ID = 70951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70951Service() {
        this(new Idea70951Config());
    }

    public Idea70951Service(Idea70951Config config) {
        this.config = config != null ? config : new Idea70951Config();
