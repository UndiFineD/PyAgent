...
@Data
public class Idea71019Config {
    private String name = "idea_071019";
 ...
 */
@Slf4j
public class Idea71019Service {
    private static final int IDEA_ID = 71019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71019Service() {
        this(new Idea71019Config());
    }

    public Idea71019Service(Idea71019Config config) {
        this.config = config != null ? config : new Idea71019Config();
