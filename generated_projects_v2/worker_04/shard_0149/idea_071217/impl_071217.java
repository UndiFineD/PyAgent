...
@Data
public class Idea71217Config {
    private String name = "idea_071217";
 ...
 */
@Slf4j
public class Idea71217Service {
    private static final int IDEA_ID = 71217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71217Service() {
        this(new Idea71217Config());
    }

    public Idea71217Service(Idea71217Config config) {
        this.config = config != null ? config : new Idea71217Config();
