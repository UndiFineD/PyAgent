...
@Data
public class Idea71127Config {
    private String name = "idea_071127";
 ...
 */
@Slf4j
public class Idea71127Service {
    private static final int IDEA_ID = 71127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71127Service() {
        this(new Idea71127Config());
    }

    public Idea71127Service(Idea71127Config config) {
        this.config = config != null ? config : new Idea71127Config();
