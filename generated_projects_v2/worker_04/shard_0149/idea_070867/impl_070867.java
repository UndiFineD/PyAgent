...
@Data
public class Idea70867Config {
    private String name = "idea_070867";
 ...
 */
@Slf4j
public class Idea70867Service {
    private static final int IDEA_ID = 70867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70867Service() {
        this(new Idea70867Config());
    }

    public Idea70867Service(Idea70867Config config) {
        this.config = config != null ? config : new Idea70867Config();
