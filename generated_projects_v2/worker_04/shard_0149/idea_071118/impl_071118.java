...
@Data
public class Idea71118Config {
    private String name = "idea_071118";
 ...
 */
@Slf4j
public class Idea71118Service {
    private static final int IDEA_ID = 71118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71118Service() {
        this(new Idea71118Config());
    }

    public Idea71118Service(Idea71118Config config) {
        this.config = config != null ? config : new Idea71118Config();
