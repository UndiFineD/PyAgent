...
@Data
public class Idea70944Config {
    private String name = "idea_070944";
 ...
 */
@Slf4j
public class Idea70944Service {
    private static final int IDEA_ID = 70944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70944Service() {
        this(new Idea70944Config());
    }

    public Idea70944Service(Idea70944Config config) {
        this.config = config != null ? config : new Idea70944Config();
