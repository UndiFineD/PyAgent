...
@Data
public class Idea70918Config {
    private String name = "idea_070918";
 ...
 */
@Slf4j
public class Idea70918Service {
    private static final int IDEA_ID = 70918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70918Service() {
        this(new Idea70918Config());
    }

    public Idea70918Service(Idea70918Config config) {
        this.config = config != null ? config : new Idea70918Config();
