...
@Data
public class Idea71112Config {
    private String name = "idea_071112";
 ...
 */
@Slf4j
public class Idea71112Service {
    private static final int IDEA_ID = 71112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71112Service() {
        this(new Idea71112Config());
    }

    public Idea71112Service(Idea71112Config config) {
        this.config = config != null ? config : new Idea71112Config();
