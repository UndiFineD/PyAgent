...
@Data
public class Idea71219Config {
    private String name = "idea_071219";
 ...
 */
@Slf4j
public class Idea71219Service {
    private static final int IDEA_ID = 71219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71219Service() {
        this(new Idea71219Config());
    }

    public Idea71219Service(Idea71219Config config) {
        this.config = config != null ? config : new Idea71219Config();
