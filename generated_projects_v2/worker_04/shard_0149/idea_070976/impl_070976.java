...
@Data
public class Idea70976Config {
    private String name = "idea_070976";
 ...
 */
@Slf4j
public class Idea70976Service {
    private static final int IDEA_ID = 70976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70976Service() {
        this(new Idea70976Config());
    }

    public Idea70976Service(Idea70976Config config) {
        this.config = config != null ? config : new Idea70976Config();
