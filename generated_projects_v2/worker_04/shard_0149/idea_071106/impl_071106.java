...
@Data
public class Idea71106Config {
    private String name = "idea_071106";
 ...
 */
@Slf4j
public class Idea71106Service {
    private static final int IDEA_ID = 71106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71106Service() {
        this(new Idea71106Config());
    }

    public Idea71106Service(Idea71106Config config) {
        this.config = config != null ? config : new Idea71106Config();
