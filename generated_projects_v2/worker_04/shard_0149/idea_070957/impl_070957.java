...
@Data
public class Idea70957Config {
    private String name = "idea_070957";
 ...
 */
@Slf4j
public class Idea70957Service {
    private static final int IDEA_ID = 70957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70957Service() {
        this(new Idea70957Config());
    }

    public Idea70957Service(Idea70957Config config) {
        this.config = config != null ? config : new Idea70957Config();
