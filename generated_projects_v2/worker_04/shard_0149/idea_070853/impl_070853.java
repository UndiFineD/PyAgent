...
@Data
public class Idea70853Config {
    private String name = "idea_070853";
 ...
 */
@Slf4j
public class Idea70853Service {
    private static final int IDEA_ID = 70853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70853Service() {
        this(new Idea70853Config());
    }

    public Idea70853Service(Idea70853Config config) {
        this.config = config != null ? config : new Idea70853Config();
