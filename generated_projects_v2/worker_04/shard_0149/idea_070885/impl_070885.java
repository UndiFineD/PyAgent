...
@Data
public class Idea70885Config {
    private String name = "idea_070885";
 ...
 */
@Slf4j
public class Idea70885Service {
    private static final int IDEA_ID = 70885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70885Service() {
        this(new Idea70885Config());
    }

    public Idea70885Service(Idea70885Config config) {
        this.config = config != null ? config : new Idea70885Config();
