...
@Data
public class Idea70800Config {
    private String name = "idea_070800";
 ...
 */
@Slf4j
public class Idea70800Service {
    private static final int IDEA_ID = 70800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70800Service() {
        this(new Idea70800Config());
    }

    public Idea70800Service(Idea70800Config config) {
        this.config = config != null ? config : new Idea70800Config();
