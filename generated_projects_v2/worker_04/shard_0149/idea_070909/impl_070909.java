...
@Data
public class Idea70909Config {
    private String name = "idea_070909";
 ...
 */
@Slf4j
public class Idea70909Service {
    private static final int IDEA_ID = 70909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70909Service() {
        this(new Idea70909Config());
    }

    public Idea70909Service(Idea70909Config config) {
        this.config = config != null ? config : new Idea70909Config();
