...
@Data
public class Idea70935Config {
    private String name = "idea_070935";
 ...
 */
@Slf4j
public class Idea70935Service {
    private static final int IDEA_ID = 70935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70935Service() {
        this(new Idea70935Config());
    }

    public Idea70935Service(Idea70935Config config) {
        this.config = config != null ? config : new Idea70935Config();
