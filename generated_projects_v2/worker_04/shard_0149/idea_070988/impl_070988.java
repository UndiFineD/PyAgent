...
@Data
public class Idea70988Config {
    private String name = "idea_070988";
 ...
 */
@Slf4j
public class Idea70988Service {
    private static final int IDEA_ID = 70988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70988Service() {
        this(new Idea70988Config());
    }

    public Idea70988Service(Idea70988Config config) {
        this.config = config != null ? config : new Idea70988Config();
