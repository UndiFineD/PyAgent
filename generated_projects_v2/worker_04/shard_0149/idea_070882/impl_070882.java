...
@Data
public class Idea70882Config {
    private String name = "idea_070882";
 ...
 */
@Slf4j
public class Idea70882Service {
    private static final int IDEA_ID = 70882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70882Service() {
        this(new Idea70882Config());
    }

    public Idea70882Service(Idea70882Config config) {
        this.config = config != null ? config : new Idea70882Config();
