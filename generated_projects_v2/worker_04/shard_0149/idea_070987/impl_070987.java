...
@Data
public class Idea70987Config {
    private String name = "idea_070987";
 ...
 */
@Slf4j
public class Idea70987Service {
    private static final int IDEA_ID = 70987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70987Service() {
        this(new Idea70987Config());
    }

    public Idea70987Service(Idea70987Config config) {
        this.config = config != null ? config : new Idea70987Config();
