...
@Data
public class Idea71012Config {
    private String name = "idea_071012";
 ...
 */
@Slf4j
public class Idea71012Service {
    private static final int IDEA_ID = 71012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71012Service() {
        this(new Idea71012Config());
    }

    public Idea71012Service(Idea71012Config config) {
        this.config = config != null ? config : new Idea71012Config();
