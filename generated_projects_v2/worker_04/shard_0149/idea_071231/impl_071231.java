...
@Data
public class Idea71231Config {
    private String name = "idea_071231";
 ...
 */
@Slf4j
public class Idea71231Service {
    private static final int IDEA_ID = 71231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71231Service() {
        this(new Idea71231Config());
    }

    public Idea71231Service(Idea71231Config config) {
        this.config = config != null ? config : new Idea71231Config();
