...
@Data
public class Idea71229Config {
    private String name = "idea_071229";
 ...
 */
@Slf4j
public class Idea71229Service {
    private static final int IDEA_ID = 71229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71229Service() {
        this(new Idea71229Config());
    }

    public Idea71229Service(Idea71229Config config) {
        this.config = config != null ? config : new Idea71229Config();
