...
@Data
public class Idea70927Config {
    private String name = "idea_070927";
 ...
 */
@Slf4j
public class Idea70927Service {
    private static final int IDEA_ID = 70927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70927Service() {
        this(new Idea70927Config());
    }

    public Idea70927Service(Idea70927Config config) {
        this.config = config != null ? config : new Idea70927Config();
