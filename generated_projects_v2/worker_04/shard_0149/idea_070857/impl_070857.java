...
@Data
public class Idea70857Config {
    private String name = "idea_070857";
 ...
 */
@Slf4j
public class Idea70857Service {
    private static final int IDEA_ID = 70857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70857Service() {
        this(new Idea70857Config());
    }

    public Idea70857Service(Idea70857Config config) {
        this.config = config != null ? config : new Idea70857Config();
