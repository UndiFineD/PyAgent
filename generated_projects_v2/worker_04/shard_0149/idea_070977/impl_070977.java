...
@Data
public class Idea70977Config {
    private String name = "idea_070977";
 ...
 */
@Slf4j
public class Idea70977Service {
    private static final int IDEA_ID = 70977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70977Service() {
        this(new Idea70977Config());
    }

    public Idea70977Service(Idea70977Config config) {
        this.config = config != null ? config : new Idea70977Config();
