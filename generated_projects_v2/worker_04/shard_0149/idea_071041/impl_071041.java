...
@Data
public class Idea71041Config {
    private String name = "idea_071041";
 ...
 */
@Slf4j
public class Idea71041Service {
    private static final int IDEA_ID = 71041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71041Service() {
        this(new Idea71041Config());
    }

    public Idea71041Service(Idea71041Config config) {
        this.config = config != null ? config : new Idea71041Config();
