...
@Data
public class Idea71183Config {
    private String name = "idea_071183";
 ...
 */
@Slf4j
public class Idea71183Service {
    private static final int IDEA_ID = 71183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71183Service() {
        this(new Idea71183Config());
    }

    public Idea71183Service(Idea71183Config config) {
        this.config = config != null ? config : new Idea71183Config();
