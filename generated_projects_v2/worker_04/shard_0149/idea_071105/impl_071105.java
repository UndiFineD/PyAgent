...
@Data
public class Idea71105Config {
    private String name = "idea_071105";
 ...
 */
@Slf4j
public class Idea71105Service {
    private static final int IDEA_ID = 71105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71105Service() {
        this(new Idea71105Config());
    }

    public Idea71105Service(Idea71105Config config) {
        this.config = config != null ? config : new Idea71105Config();
