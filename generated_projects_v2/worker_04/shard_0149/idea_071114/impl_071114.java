...
@Data
public class Idea71114Config {
    private String name = "idea_071114";
 ...
 */
@Slf4j
public class Idea71114Service {
    private static final int IDEA_ID = 71114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71114Service() {
        this(new Idea71114Config());
    }

    public Idea71114Service(Idea71114Config config) {
        this.config = config != null ? config : new Idea71114Config();
