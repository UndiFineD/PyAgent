...
@Data
public class Idea70907Config {
    private String name = "idea_070907";
 ...
 */
@Slf4j
public class Idea70907Service {
    private static final int IDEA_ID = 70907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70907Service() {
        this(new Idea70907Config());
    }

    public Idea70907Service(Idea70907Config config) {
        this.config = config != null ? config : new Idea70907Config();
