...
@Data
public class Idea70979Config {
    private String name = "idea_070979";
 ...
 */
@Slf4j
public class Idea70979Service {
    private static final int IDEA_ID = 70979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70979Service() {
        this(new Idea70979Config());
    }

    public Idea70979Service(Idea70979Config config) {
        this.config = config != null ? config : new Idea70979Config();
