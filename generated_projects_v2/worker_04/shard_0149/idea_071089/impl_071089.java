...
@Data
public class Idea71089Config {
    private String name = "idea_071089";
 ...
 */
@Slf4j
public class Idea71089Service {
    private static final int IDEA_ID = 71089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71089Service() {
        this(new Idea71089Config());
    }

    public Idea71089Service(Idea71089Config config) {
        this.config = config != null ? config : new Idea71089Config();
