...
@Data
public class Idea71188Config {
    private String name = "idea_071188";
 ...
 */
@Slf4j
public class Idea71188Service {
    private static final int IDEA_ID = 71188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71188Service() {
        this(new Idea71188Config());
    }

    public Idea71188Service(Idea71188Config config) {
        this.config = config != null ? config : new Idea71188Config();
