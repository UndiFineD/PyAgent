...
@Data
public class Idea71163Config {
    private String name = "idea_071163";
 ...
 */
@Slf4j
public class Idea71163Service {
    private static final int IDEA_ID = 71163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71163Service() {
        this(new Idea71163Config());
    }

    public Idea71163Service(Idea71163Config config) {
        this.config = config != null ? config : new Idea71163Config();
