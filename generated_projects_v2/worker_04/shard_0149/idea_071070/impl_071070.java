...
@Data
public class Idea71070Config {
    private String name = "idea_071070";
 ...
 */
@Slf4j
public class Idea71070Service {
    private static final int IDEA_ID = 71070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71070Service() {
        this(new Idea71070Config());
    }

    public Idea71070Service(Idea71070Config config) {
        this.config = config != null ? config : new Idea71070Config();
