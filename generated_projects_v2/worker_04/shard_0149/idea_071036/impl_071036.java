...
@Data
public class Idea71036Config {
    private String name = "idea_071036";
 ...
 */
@Slf4j
public class Idea71036Service {
    private static final int IDEA_ID = 71036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71036Service() {
        this(new Idea71036Config());
    }

    public Idea71036Service(Idea71036Config config) {
        this.config = config != null ? config : new Idea71036Config();
