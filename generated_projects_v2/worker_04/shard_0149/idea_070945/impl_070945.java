...
@Data
public class Idea70945Config {
    private String name = "idea_070945";
 ...
 */
@Slf4j
public class Idea70945Service {
    private static final int IDEA_ID = 70945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70945Service() {
        this(new Idea70945Config());
    }

    public Idea70945Service(Idea70945Config config) {
        this.config = config != null ? config : new Idea70945Config();
