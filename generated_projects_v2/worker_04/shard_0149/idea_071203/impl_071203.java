...
@Data
public class Idea71203Config {
    private String name = "idea_071203";
 ...
 */
@Slf4j
public class Idea71203Service {
    private static final int IDEA_ID = 71203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71203Service() {
        this(new Idea71203Config());
    }

    public Idea71203Service(Idea71203Config config) {
        this.config = config != null ? config : new Idea71203Config();
