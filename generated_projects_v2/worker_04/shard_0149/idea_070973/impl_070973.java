...
@Data
public class Idea70973Config {
    private String name = "idea_070973";
 ...
 */
@Slf4j
public class Idea70973Service {
    private static final int IDEA_ID = 70973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70973Service() {
        this(new Idea70973Config());
    }

    public Idea70973Service(Idea70973Config config) {
        this.config = config != null ? config : new Idea70973Config();
