...
@Data
public class Idea71020Config {
    private String name = "idea_071020";
 ...
 */
@Slf4j
public class Idea71020Service {
    private static final int IDEA_ID = 71020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71020Service() {
        this(new Idea71020Config());
    }

    public Idea71020Service(Idea71020Config config) {
        this.config = config != null ? config : new Idea71020Config();
