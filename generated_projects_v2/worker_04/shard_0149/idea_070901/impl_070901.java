...
@Data
public class Idea70901Config {
    private String name = "idea_070901";
 ...
 */
@Slf4j
public class Idea70901Service {
    private static final int IDEA_ID = 70901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70901Service() {
        this(new Idea70901Config());
    }

    public Idea70901Service(Idea70901Config config) {
        this.config = config != null ? config : new Idea70901Config();
