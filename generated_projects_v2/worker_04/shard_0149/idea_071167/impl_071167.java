...
@Data
public class Idea71167Config {
    private String name = "idea_071167";
 ...
 */
@Slf4j
public class Idea71167Service {
    private static final int IDEA_ID = 71167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71167Service() {
        this(new Idea71167Config());
    }

    public Idea71167Service(Idea71167Config config) {
        this.config = config != null ? config : new Idea71167Config();
