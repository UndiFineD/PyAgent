...
@Data
public class Idea70870Config {
    private String name = "idea_070870";
 ...
 */
@Slf4j
public class Idea70870Service {
    private static final int IDEA_ID = 70870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70870Service() {
        this(new Idea70870Config());
    }

    public Idea70870Service(Idea70870Config config) {
        this.config = config != null ? config : new Idea70870Config();
