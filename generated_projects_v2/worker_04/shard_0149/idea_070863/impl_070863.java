...
@Data
public class Idea70863Config {
    private String name = "idea_070863";
 ...
 */
@Slf4j
public class Idea70863Service {
    private static final int IDEA_ID = 70863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70863Service() {
        this(new Idea70863Config());
    }

    public Idea70863Service(Idea70863Config config) {
        this.config = config != null ? config : new Idea70863Config();
