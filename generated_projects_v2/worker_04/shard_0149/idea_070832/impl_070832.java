...
@Data
public class Idea70832Config {
    private String name = "idea_070832";
 ...
 */
@Slf4j
public class Idea70832Service {
    private static final int IDEA_ID = 70832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70832Service() {
        this(new Idea70832Config());
    }

    public Idea70832Service(Idea70832Config config) {
        this.config = config != null ? config : new Idea70832Config();
