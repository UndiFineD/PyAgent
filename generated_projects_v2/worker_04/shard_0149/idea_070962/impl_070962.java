...
@Data
public class Idea70962Config {
    private String name = "idea_070962";
 ...
 */
@Slf4j
public class Idea70962Service {
    private static final int IDEA_ID = 70962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70962Service() {
        this(new Idea70962Config());
    }

    public Idea70962Service(Idea70962Config config) {
        this.config = config != null ? config : new Idea70962Config();
