...
@Data
public class Idea70847Config {
    private String name = "idea_070847";
 ...
 */
@Slf4j
public class Idea70847Service {
    private static final int IDEA_ID = 70847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70847Service() {
        this(new Idea70847Config());
    }

    public Idea70847Service(Idea70847Config config) {
        this.config = config != null ? config : new Idea70847Config();
