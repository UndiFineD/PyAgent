...
@Data
public class Idea71155Config {
    private String name = "idea_071155";
 ...
 */
@Slf4j
public class Idea71155Service {
    private static final int IDEA_ID = 71155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71155Service() {
        this(new Idea71155Config());
    }

    public Idea71155Service(Idea71155Config config) {
        this.config = config != null ? config : new Idea71155Config();
