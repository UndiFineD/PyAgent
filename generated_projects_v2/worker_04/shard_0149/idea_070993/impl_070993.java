...
@Data
public class Idea70993Config {
    private String name = "idea_070993";
 ...
 */
@Slf4j
public class Idea70993Service {
    private static final int IDEA_ID = 70993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70993Service() {
        this(new Idea70993Config());
    }

    public Idea70993Service(Idea70993Config config) {
        this.config = config != null ? config : new Idea70993Config();
