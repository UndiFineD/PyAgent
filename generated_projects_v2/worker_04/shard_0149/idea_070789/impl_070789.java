...
@Data
public class Idea70789Config {
    private String name = "idea_070789";
 ...
 */
@Slf4j
public class Idea70789Service {
    private static final int IDEA_ID = 70789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70789Service() {
        this(new Idea70789Config());
    }

    public Idea70789Service(Idea70789Config config) {
        this.config = config != null ? config : new Idea70789Config();
