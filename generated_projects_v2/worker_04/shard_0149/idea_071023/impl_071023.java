...
@Data
public class Idea71023Config {
    private String name = "idea_071023";
 ...
 */
@Slf4j
public class Idea71023Service {
    private static final int IDEA_ID = 71023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71023Service() {
        this(new Idea71023Config());
    }

    public Idea71023Service(Idea71023Config config) {
        this.config = config != null ? config : new Idea71023Config();
