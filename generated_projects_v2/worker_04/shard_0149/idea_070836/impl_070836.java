...
@Data
public class Idea70836Config {
    private String name = "idea_070836";
 ...
 */
@Slf4j
public class Idea70836Service {
    private static final int IDEA_ID = 70836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70836Service() {
        this(new Idea70836Config());
    }

    public Idea70836Service(Idea70836Config config) {
        this.config = config != null ? config : new Idea70836Config();
