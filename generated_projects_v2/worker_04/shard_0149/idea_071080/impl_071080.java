...
@Data
public class Idea71080Config {
    private String name = "idea_071080";
 ...
 */
@Slf4j
public class Idea71080Service {
    private static final int IDEA_ID = 71080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71080Service() {
        this(new Idea71080Config());
    }

    public Idea71080Service(Idea71080Config config) {
        this.config = config != null ? config : new Idea71080Config();
