...
@Data
public class Idea71037Config {
    private String name = "idea_071037";
 ...
 */
@Slf4j
public class Idea71037Service {
    private static final int IDEA_ID = 71037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71037Service() {
        this(new Idea71037Config());
    }

    public Idea71037Service(Idea71037Config config) {
        this.config = config != null ? config : new Idea71037Config();
