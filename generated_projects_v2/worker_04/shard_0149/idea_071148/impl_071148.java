...
@Data
public class Idea71148Config {
    private String name = "idea_071148";
 ...
 */
@Slf4j
public class Idea71148Service {
    private static final int IDEA_ID = 71148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71148Service() {
        this(new Idea71148Config());
    }

    public Idea71148Service(Idea71148Config config) {
        this.config = config != null ? config : new Idea71148Config();
