...
@Data
public class Idea71008Config {
    private String name = "idea_071008";
 ...
 */
@Slf4j
public class Idea71008Service {
    private static final int IDEA_ID = 71008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71008Service() {
        this(new Idea71008Config());
    }

    public Idea71008Service(Idea71008Config config) {
        this.config = config != null ? config : new Idea71008Config();
