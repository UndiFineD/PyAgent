...
@Data
public class Idea70938Config {
    private String name = "idea_070938";
 ...
 */
@Slf4j
public class Idea70938Service {
    private static final int IDEA_ID = 70938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70938Service() {
        this(new Idea70938Config());
    }

    public Idea70938Service(Idea70938Config config) {
        this.config = config != null ? config : new Idea70938Config();
