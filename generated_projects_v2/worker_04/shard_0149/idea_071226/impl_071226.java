...
@Data
public class Idea71226Config {
    private String name = "idea_071226";
 ...
 */
@Slf4j
public class Idea71226Service {
    private static final int IDEA_ID = 71226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71226Service() {
        this(new Idea71226Config());
    }

    public Idea71226Service(Idea71226Config config) {
        this.config = config != null ? config : new Idea71226Config();
