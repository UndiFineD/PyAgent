...
@Data
public class Idea71043Config {
    private String name = "idea_071043";
 ...
 */
@Slf4j
public class Idea71043Service {
    private static final int IDEA_ID = 71043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71043Service() {
        this(new Idea71043Config());
    }

    public Idea71043Service(Idea71043Config config) {
        this.config = config != null ? config : new Idea71043Config();
