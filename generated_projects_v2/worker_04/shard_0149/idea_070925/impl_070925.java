...
@Data
public class Idea70925Config {
    private String name = "idea_070925";
 ...
 */
@Slf4j
public class Idea70925Service {
    private static final int IDEA_ID = 70925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70925Service() {
        this(new Idea70925Config());
    }

    public Idea70925Service(Idea70925Config config) {
        this.config = config != null ? config : new Idea70925Config();
