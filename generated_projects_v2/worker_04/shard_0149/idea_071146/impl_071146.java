...
@Data
public class Idea71146Config {
    private String name = "idea_071146";
 ...
 */
@Slf4j
public class Idea71146Service {
    private static final int IDEA_ID = 71146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71146Service() {
        this(new Idea71146Config());
    }

    public Idea71146Service(Idea71146Config config) {
        this.config = config != null ? config : new Idea71146Config();
