...
@Data
public class Idea70845Config {
    private String name = "idea_070845";
 ...
 */
@Slf4j
public class Idea70845Service {
    private static final int IDEA_ID = 70845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70845Service() {
        this(new Idea70845Config());
    }

    public Idea70845Service(Idea70845Config config) {
        this.config = config != null ? config : new Idea70845Config();
