...
@Data
public class Idea70838Config {
    private String name = "idea_070838";
 ...
 */
@Slf4j
public class Idea70838Service {
    private static final int IDEA_ID = 70838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70838Service() {
        this(new Idea70838Config());
    }

    public Idea70838Service(Idea70838Config config) {
        this.config = config != null ? config : new Idea70838Config();
