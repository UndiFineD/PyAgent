...
@Data
public class Idea70888Config {
    private String name = "idea_070888";
 ...
 */
@Slf4j
public class Idea70888Service {
    private static final int IDEA_ID = 70888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70888Service() {
        this(new Idea70888Config());
    }

    public Idea70888Service(Idea70888Config config) {
        this.config = config != null ? config : new Idea70888Config();
