...
@Data
public class Idea70964Config {
    private String name = "idea_070964";
 ...
 */
@Slf4j
public class Idea70964Service {
    private static final int IDEA_ID = 70964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70964Service() {
        this(new Idea70964Config());
    }

    public Idea70964Service(Idea70964Config config) {
        this.config = config != null ? config : new Idea70964Config();
