...
@Data
public class Idea70974Config {
    private String name = "idea_070974";
 ...
 */
@Slf4j
public class Idea70974Service {
    private static final int IDEA_ID = 70974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70974Service() {
        this(new Idea70974Config());
    }

    public Idea70974Service(Idea70974Config config) {
        this.config = config != null ? config : new Idea70974Config();
