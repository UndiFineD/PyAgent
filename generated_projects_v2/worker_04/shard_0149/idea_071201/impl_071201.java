...
@Data
public class Idea71201Config {
    private String name = "idea_071201";
 ...
 */
@Slf4j
public class Idea71201Service {
    private static final int IDEA_ID = 71201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71201Service() {
        this(new Idea71201Config());
    }

    public Idea71201Service(Idea71201Config config) {
        this.config = config != null ? config : new Idea71201Config();
