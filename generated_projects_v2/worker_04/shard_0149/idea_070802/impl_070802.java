...
@Data
public class Idea70802Config {
    private String name = "idea_070802";
 ...
 */
@Slf4j
public class Idea70802Service {
    private static final int IDEA_ID = 70802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70802Service() {
        this(new Idea70802Config());
    }

    public Idea70802Service(Idea70802Config config) {
        this.config = config != null ? config : new Idea70802Config();
