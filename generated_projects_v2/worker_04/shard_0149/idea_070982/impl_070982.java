...
@Data
public class Idea70982Config {
    private String name = "idea_070982";
 ...
 */
@Slf4j
public class Idea70982Service {
    private static final int IDEA_ID = 70982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70982Service() {
        this(new Idea70982Config());
    }

    public Idea70982Service(Idea70982Config config) {
        this.config = config != null ? config : new Idea70982Config();
