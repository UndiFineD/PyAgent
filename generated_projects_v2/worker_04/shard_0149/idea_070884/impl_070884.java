...
@Data
public class Idea70884Config {
    private String name = "idea_070884";
 ...
 */
@Slf4j
public class Idea70884Service {
    private static final int IDEA_ID = 70884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70884Service() {
        this(new Idea70884Config());
    }

    public Idea70884Service(Idea70884Config config) {
        this.config = config != null ? config : new Idea70884Config();
