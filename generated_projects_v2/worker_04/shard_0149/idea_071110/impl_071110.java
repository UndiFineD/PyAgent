...
@Data
public class Idea71110Config {
    private String name = "idea_071110";
 ...
 */
@Slf4j
public class Idea71110Service {
    private static final int IDEA_ID = 71110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71110Service() {
        this(new Idea71110Config());
    }

    public Idea71110Service(Idea71110Config config) {
        this.config = config != null ? config : new Idea71110Config();
