...
@Data
public class Idea70961Config {
    private String name = "idea_070961";
 ...
 */
@Slf4j
public class Idea70961Service {
    private static final int IDEA_ID = 70961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70961Service() {
        this(new Idea70961Config());
    }

    public Idea70961Service(Idea70961Config config) {
        this.config = config != null ? config : new Idea70961Config();
