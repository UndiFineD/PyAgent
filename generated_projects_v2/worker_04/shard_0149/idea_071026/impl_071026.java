...
@Data
public class Idea71026Config {
    private String name = "idea_071026";
 ...
 */
@Slf4j
public class Idea71026Service {
    private static final int IDEA_ID = 71026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71026Service() {
        this(new Idea71026Config());
    }

    public Idea71026Service(Idea71026Config config) {
        this.config = config != null ? config : new Idea71026Config();
