...
@Data
public class Idea70848Config {
    private String name = "idea_070848";
 ...
 */
@Slf4j
public class Idea70848Service {
    private static final int IDEA_ID = 70848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70848Service() {
        this(new Idea70848Config());
    }

    public Idea70848Service(Idea70848Config config) {
        this.config = config != null ? config : new Idea70848Config();
