...
@Data
public class Idea70813Config {
    private String name = "idea_070813";
 ...
 */
@Slf4j
public class Idea70813Service {
    private static final int IDEA_ID = 70813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70813Service() {
        this(new Idea70813Config());
    }

    public Idea70813Service(Idea70813Config config) {
        this.config = config != null ? config : new Idea70813Config();
