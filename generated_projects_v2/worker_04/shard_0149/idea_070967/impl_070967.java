...
@Data
public class Idea70967Config {
    private String name = "idea_070967";
 ...
 */
@Slf4j
public class Idea70967Service {
    private static final int IDEA_ID = 70967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70967Service() {
        this(new Idea70967Config());
    }

    public Idea70967Service(Idea70967Config config) {
        this.config = config != null ? config : new Idea70967Config();
