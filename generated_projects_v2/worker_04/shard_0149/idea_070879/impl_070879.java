...
@Data
public class Idea70879Config {
    private String name = "idea_070879";
 ...
 */
@Slf4j
public class Idea70879Service {
    private static final int IDEA_ID = 70879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70879Service() {
        this(new Idea70879Config());
    }

    public Idea70879Service(Idea70879Config config) {
        this.config = config != null ? config : new Idea70879Config();
