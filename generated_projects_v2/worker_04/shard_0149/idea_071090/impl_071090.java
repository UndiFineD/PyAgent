...
@Data
public class Idea71090Config {
    private String name = "idea_071090";
 ...
 */
@Slf4j
public class Idea71090Service {
    private static final int IDEA_ID = 71090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71090Service() {
        this(new Idea71090Config());
    }

    public Idea71090Service(Idea71090Config config) {
        this.config = config != null ? config : new Idea71090Config();
