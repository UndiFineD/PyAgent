...
@Data
public class Idea70781Config {
    private String name = "idea_070781";
 ...
 */
@Slf4j
public class Idea70781Service {
    private static final int IDEA_ID = 70781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70781Service() {
        this(new Idea70781Config());
    }

    public Idea70781Service(Idea70781Config config) {
        this.config = config != null ? config : new Idea70781Config();
