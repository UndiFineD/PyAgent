...
@Data
public class Idea71152Config {
    private String name = "idea_071152";
 ...
 */
@Slf4j
public class Idea71152Service {
    private static final int IDEA_ID = 71152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71152Service() {
        this(new Idea71152Config());
    }

    public Idea71152Service(Idea71152Config config) {
        this.config = config != null ? config : new Idea71152Config();
