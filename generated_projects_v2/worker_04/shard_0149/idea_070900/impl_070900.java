...
@Data
public class Idea70900Config {
    private String name = "idea_070900";
 ...
 */
@Slf4j
public class Idea70900Service {
    private static final int IDEA_ID = 70900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70900Service() {
        this(new Idea70900Config());
    }

    public Idea70900Service(Idea70900Config config) {
        this.config = config != null ? config : new Idea70900Config();
