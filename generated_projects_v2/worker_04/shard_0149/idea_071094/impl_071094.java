...
@Data
public class Idea71094Config {
    private String name = "idea_071094";
 ...
 */
@Slf4j
public class Idea71094Service {
    private static final int IDEA_ID = 71094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71094Service() {
        this(new Idea71094Config());
    }

    public Idea71094Service(Idea71094Config config) {
        this.config = config != null ? config : new Idea71094Config();
