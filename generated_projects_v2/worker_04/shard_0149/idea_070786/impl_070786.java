...
@Data
public class Idea70786Config {
    private String name = "idea_070786";
 ...
 */
@Slf4j
public class Idea70786Service {
    private static final int IDEA_ID = 70786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70786Service() {
        this(new Idea70786Config());
    }

    public Idea70786Service(Idea70786Config config) {
        this.config = config != null ? config : new Idea70786Config();
