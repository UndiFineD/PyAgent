...
@Data
public class Idea71083Config {
    private String name = "idea_071083";
 ...
 */
@Slf4j
public class Idea71083Service {
    private static final int IDEA_ID = 71083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71083Service() {
        this(new Idea71083Config());
    }

    public Idea71083Service(Idea71083Config config) {
        this.config = config != null ? config : new Idea71083Config();
