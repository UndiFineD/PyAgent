...
@Data
public class Idea71175Config {
    private String name = "idea_071175";
 ...
 */
@Slf4j
public class Idea71175Service {
    private static final int IDEA_ID = 71175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71175Service() {
        this(new Idea71175Config());
    }

    public Idea71175Service(Idea71175Config config) {
        this.config = config != null ? config : new Idea71175Config();
