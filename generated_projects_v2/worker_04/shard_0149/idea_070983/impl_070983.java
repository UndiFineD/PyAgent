...
@Data
public class Idea70983Config {
    private String name = "idea_070983";
 ...
 */
@Slf4j
public class Idea70983Service {
    private static final int IDEA_ID = 70983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70983Service() {
        this(new Idea70983Config());
    }

    public Idea70983Service(Idea70983Config config) {
        this.config = config != null ? config : new Idea70983Config();
