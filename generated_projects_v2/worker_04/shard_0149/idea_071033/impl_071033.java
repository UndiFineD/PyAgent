...
@Data
public class Idea71033Config {
    private String name = "idea_071033";
 ...
 */
@Slf4j
public class Idea71033Service {
    private static final int IDEA_ID = 71033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71033Service() {
        this(new Idea71033Config());
    }

    public Idea71033Service(Idea71033Config config) {
        this.config = config != null ? config : new Idea71033Config();
