...
@Data
public class Idea70981Config {
    private String name = "idea_070981";
 ...
 */
@Slf4j
public class Idea70981Service {
    private static final int IDEA_ID = 70981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70981Service() {
        this(new Idea70981Config());
    }

    public Idea70981Service(Idea70981Config config) {
        this.config = config != null ? config : new Idea70981Config();
