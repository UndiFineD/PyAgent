...
@Data
public class Idea70799Config {
    private String name = "idea_070799";
 ...
 */
@Slf4j
public class Idea70799Service {
    private static final int IDEA_ID = 70799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70799Service() {
        this(new Idea70799Config());
    }

    public Idea70799Service(Idea70799Config config) {
        this.config = config != null ? config : new Idea70799Config();
