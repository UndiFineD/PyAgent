...
@Data
public class Idea70808Config {
    private String name = "idea_070808";
 ...
 */
@Slf4j
public class Idea70808Service {
    private static final int IDEA_ID = 70808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70808Service() {
        this(new Idea70808Config());
    }

    public Idea70808Service(Idea70808Config config) {
        this.config = config != null ? config : new Idea70808Config();
