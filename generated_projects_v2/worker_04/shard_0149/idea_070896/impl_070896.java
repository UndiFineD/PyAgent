...
@Data
public class Idea70896Config {
    private String name = "idea_070896";
 ...
 */
@Slf4j
public class Idea70896Service {
    private static final int IDEA_ID = 70896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70896Service() {
        this(new Idea70896Config());
    }

    public Idea70896Service(Idea70896Config config) {
        this.config = config != null ? config : new Idea70896Config();
