...
@Data
public class Idea71018Config {
    private String name = "idea_071018";
 ...
 */
@Slf4j
public class Idea71018Service {
    private static final int IDEA_ID = 71018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71018Service() {
        this(new Idea71018Config());
    }

    public Idea71018Service(Idea71018Config config) {
        this.config = config != null ? config : new Idea71018Config();
