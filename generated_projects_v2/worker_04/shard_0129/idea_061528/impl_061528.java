...
@Data
public class Idea61528Config {
    private String name = "idea_061528";
 ...
 */
@Slf4j
public class Idea61528Service {
    private static final int IDEA_ID = 61528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61528Service() {
        this(new Idea61528Config());
    }

    public Idea61528Service(Idea61528Config config) {
        this.config = config != null ? config : new Idea61528Config();
