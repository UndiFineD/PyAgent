...
@Data
public class Idea61338Config {
    private String name = "idea_061338";
 ...
 */
@Slf4j
public class Idea61338Service {
    private static final int IDEA_ID = 61338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61338Service() {
        this(new Idea61338Config());
    }

    public Idea61338Service(Idea61338Config config) {
        this.config = config != null ? config : new Idea61338Config();
