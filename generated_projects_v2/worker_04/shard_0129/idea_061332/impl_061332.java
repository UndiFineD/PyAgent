...
@Data
public class Idea61332Config {
    private String name = "idea_061332";
 ...
 */
@Slf4j
public class Idea61332Service {
    private static final int IDEA_ID = 61332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61332Service() {
        this(new Idea61332Config());
    }

    public Idea61332Service(Idea61332Config config) {
        this.config = config != null ? config : new Idea61332Config();
