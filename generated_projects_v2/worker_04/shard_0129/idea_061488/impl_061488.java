...
@Data
public class Idea61488Config {
    private String name = "idea_061488";
 ...
 */
@Slf4j
public class Idea61488Service {
    private static final int IDEA_ID = 61488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61488Service() {
        this(new Idea61488Config());
    }

    public Idea61488Service(Idea61488Config config) {
        this.config = config != null ? config : new Idea61488Config();
