...
@Data
public class Idea61730Config {
    private String name = "idea_061730";
 ...
 */
@Slf4j
public class Idea61730Service {
    private static final int IDEA_ID = 61730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61730Service() {
        this(new Idea61730Config());
    }

    public Idea61730Service(Idea61730Config config) {
        this.config = config != null ? config : new Idea61730Config();
