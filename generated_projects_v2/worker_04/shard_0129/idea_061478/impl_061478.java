...
@Data
public class Idea61478Config {
    private String name = "idea_061478";
 ...
 */
@Slf4j
public class Idea61478Service {
    private static final int IDEA_ID = 61478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61478Service() {
        this(new Idea61478Config());
    }

    public Idea61478Service(Idea61478Config config) {
        this.config = config != null ? config : new Idea61478Config();
