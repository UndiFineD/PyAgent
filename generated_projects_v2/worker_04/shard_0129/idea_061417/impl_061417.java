...
@Data
public class Idea61417Config {
    private String name = "idea_061417";
 ...
 */
@Slf4j
public class Idea61417Service {
    private static final int IDEA_ID = 61417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61417Service() {
        this(new Idea61417Config());
    }

    public Idea61417Service(Idea61417Config config) {
        this.config = config != null ? config : new Idea61417Config();
