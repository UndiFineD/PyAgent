...
@Data
public class Idea61314Config {
    private String name = "idea_061314";
 ...
 */
@Slf4j
public class Idea61314Service {
    private static final int IDEA_ID = 61314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61314Service() {
        this(new Idea61314Config());
    }

    public Idea61314Service(Idea61314Config config) {
        this.config = config != null ? config : new Idea61314Config();
