...
@Data
public class Idea61555Config {
    private String name = "idea_061555";
 ...
 */
@Slf4j
public class Idea61555Service {
    private static final int IDEA_ID = 61555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61555Service() {
        this(new Idea61555Config());
    }

    public Idea61555Service(Idea61555Config config) {
        this.config = config != null ? config : new Idea61555Config();
