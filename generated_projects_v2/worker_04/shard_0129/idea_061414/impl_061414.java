...
@Data
public class Idea61414Config {
    private String name = "idea_061414";
 ...
 */
@Slf4j
public class Idea61414Service {
    private static final int IDEA_ID = 61414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61414Service() {
        this(new Idea61414Config());
    }

    public Idea61414Service(Idea61414Config config) {
        this.config = config != null ? config : new Idea61414Config();
