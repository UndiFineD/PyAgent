...
@Data
public class Idea61515Config {
    private String name = "idea_061515";
 ...
 */
@Slf4j
public class Idea61515Service {
    private static final int IDEA_ID = 61515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61515Service() {
        this(new Idea61515Config());
    }

    public Idea61515Service(Idea61515Config config) {
        this.config = config != null ? config : new Idea61515Config();
