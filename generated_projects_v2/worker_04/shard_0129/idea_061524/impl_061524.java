...
@Data
public class Idea61524Config {
    private String name = "idea_061524";
 ...
 */
@Slf4j
public class Idea61524Service {
    private static final int IDEA_ID = 61524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61524Service() {
        this(new Idea61524Config());
    }

    public Idea61524Service(Idea61524Config config) {
        this.config = config != null ? config : new Idea61524Config();
