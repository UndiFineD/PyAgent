...
@Data
public class Idea61322Config {
    private String name = "idea_061322";
 ...
 */
@Slf4j
public class Idea61322Service {
    private static final int IDEA_ID = 61322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61322Service() {
        this(new Idea61322Config());
    }

    public Idea61322Service(Idea61322Config config) {
        this.config = config != null ? config : new Idea61322Config();
