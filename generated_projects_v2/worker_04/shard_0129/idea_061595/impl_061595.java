...
@Data
public class Idea61595Config {
    private String name = "idea_061595";
 ...
 */
@Slf4j
public class Idea61595Service {
    private static final int IDEA_ID = 61595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61595Service() {
        this(new Idea61595Config());
    }

    public Idea61595Service(Idea61595Config config) {
        this.config = config != null ? config : new Idea61595Config();
