...
@Data
public class Idea61378Config {
    private String name = "idea_061378";
 ...
 */
@Slf4j
public class Idea61378Service {
    private static final int IDEA_ID = 61378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61378Service() {
        this(new Idea61378Config());
    }

    public Idea61378Service(Idea61378Config config) {
        this.config = config != null ? config : new Idea61378Config();
