...
@Data
public class Idea61435Config {
    private String name = "idea_061435";
 ...
 */
@Slf4j
public class Idea61435Service {
    private static final int IDEA_ID = 61435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61435Service() {
        this(new Idea61435Config());
    }

    public Idea61435Service(Idea61435Config config) {
        this.config = config != null ? config : new Idea61435Config();
