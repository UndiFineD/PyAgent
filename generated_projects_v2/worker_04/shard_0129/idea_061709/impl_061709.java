...
@Data
public class Idea61709Config {
    private String name = "idea_061709";
 ...
 */
@Slf4j
public class Idea61709Service {
    private static final int IDEA_ID = 61709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61709Service() {
        this(new Idea61709Config());
    }

    public Idea61709Service(Idea61709Config config) {
        this.config = config != null ? config : new Idea61709Config();
