...
@Data
public class Idea61684Config {
    private String name = "idea_061684";
 ...
 */
@Slf4j
public class Idea61684Service {
    private static final int IDEA_ID = 61684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61684Service() {
        this(new Idea61684Config());
    }

    public Idea61684Service(Idea61684Config config) {
        this.config = config != null ? config : new Idea61684Config();
