...
@Data
public class Idea61519Config {
    private String name = "idea_061519";
 ...
 */
@Slf4j
public class Idea61519Service {
    private static final int IDEA_ID = 61519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61519Service() {
        this(new Idea61519Config());
    }

    public Idea61519Service(Idea61519Config config) {
        this.config = config != null ? config : new Idea61519Config();
