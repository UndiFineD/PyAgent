...
@Data
public class Idea61307Config {
    private String name = "idea_061307";
 ...
 */
@Slf4j
public class Idea61307Service {
    private static final int IDEA_ID = 61307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61307Service() {
        this(new Idea61307Config());
    }

    public Idea61307Service(Idea61307Config config) {
        this.config = config != null ? config : new Idea61307Config();
