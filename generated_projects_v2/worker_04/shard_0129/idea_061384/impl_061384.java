...
@Data
public class Idea61384Config {
    private String name = "idea_061384";
 ...
 */
@Slf4j
public class Idea61384Service {
    private static final int IDEA_ID = 61384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61384Service() {
        this(new Idea61384Config());
    }

    public Idea61384Service(Idea61384Config config) {
        this.config = config != null ? config : new Idea61384Config();
