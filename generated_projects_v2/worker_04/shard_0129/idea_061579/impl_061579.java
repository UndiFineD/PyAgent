...
@Data
public class Idea61579Config {
    private String name = "idea_061579";
 ...
 */
@Slf4j
public class Idea61579Service {
    private static final int IDEA_ID = 61579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61579Service() {
        this(new Idea61579Config());
    }

    public Idea61579Service(Idea61579Config config) {
        this.config = config != null ? config : new Idea61579Config();
