...
@Data
public class Idea61311Config {
    private String name = "idea_061311";
 ...
 */
@Slf4j
public class Idea61311Service {
    private static final int IDEA_ID = 61311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61311Service() {
        this(new Idea61311Config());
    }

    public Idea61311Service(Idea61311Config config) {
        this.config = config != null ? config : new Idea61311Config();
