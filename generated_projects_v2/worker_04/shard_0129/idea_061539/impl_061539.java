...
@Data
public class Idea61539Config {
    private String name = "idea_061539";
 ...
 */
@Slf4j
public class Idea61539Service {
    private static final int IDEA_ID = 61539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61539Service() {
        this(new Idea61539Config());
    }

    public Idea61539Service(Idea61539Config config) {
        this.config = config != null ? config : new Idea61539Config();
