...
@Data
public class Idea61280Config {
    private String name = "idea_061280";
 ...
 */
@Slf4j
public class Idea61280Service {
    private static final int IDEA_ID = 61280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61280Service() {
        this(new Idea61280Config());
    }

    public Idea61280Service(Idea61280Config config) {
        this.config = config != null ? config : new Idea61280Config();
