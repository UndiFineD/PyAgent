...
@Data
public class Idea61455Config {
    private String name = "idea_061455";
 ...
 */
@Slf4j
public class Idea61455Service {
    private static final int IDEA_ID = 61455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61455Service() {
        this(new Idea61455Config());
    }

    public Idea61455Service(Idea61455Config config) {
        this.config = config != null ? config : new Idea61455Config();
