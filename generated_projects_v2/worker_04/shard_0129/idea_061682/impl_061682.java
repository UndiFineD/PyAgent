...
@Data
public class Idea61682Config {
    private String name = "idea_061682";
 ...
 */
@Slf4j
public class Idea61682Service {
    private static final int IDEA_ID = 61682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61682Service() {
        this(new Idea61682Config());
    }

    public Idea61682Service(Idea61682Config config) {
        this.config = config != null ? config : new Idea61682Config();
