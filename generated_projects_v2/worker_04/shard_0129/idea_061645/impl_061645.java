...
@Data
public class Idea61645Config {
    private String name = "idea_061645";
 ...
 */
@Slf4j
public class Idea61645Service {
    private static final int IDEA_ID = 61645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61645Service() {
        this(new Idea61645Config());
    }

    public Idea61645Service(Idea61645Config config) {
        this.config = config != null ? config : new Idea61645Config();
