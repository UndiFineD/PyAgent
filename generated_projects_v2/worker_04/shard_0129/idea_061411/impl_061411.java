...
@Data
public class Idea61411Config {
    private String name = "idea_061411";
 ...
 */
@Slf4j
public class Idea61411Service {
    private static final int IDEA_ID = 61411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61411Service() {
        this(new Idea61411Config());
    }

    public Idea61411Service(Idea61411Config config) {
        this.config = config != null ? config : new Idea61411Config();
