...
@Data
public class Idea61402Config {
    private String name = "idea_061402";
 ...
 */
@Slf4j
public class Idea61402Service {
    private static final int IDEA_ID = 61402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61402Service() {
        this(new Idea61402Config());
    }

    public Idea61402Service(Idea61402Config config) {
        this.config = config != null ? config : new Idea61402Config();
