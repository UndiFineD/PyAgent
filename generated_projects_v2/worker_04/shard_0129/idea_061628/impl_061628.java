...
@Data
public class Idea61628Config {
    private String name = "idea_061628";
 ...
 */
@Slf4j
public class Idea61628Service {
    private static final int IDEA_ID = 61628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61628Service() {
        this(new Idea61628Config());
    }

    public Idea61628Service(Idea61628Config config) {
        this.config = config != null ? config : new Idea61628Config();
