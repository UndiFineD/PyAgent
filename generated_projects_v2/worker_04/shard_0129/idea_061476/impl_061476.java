...
@Data
public class Idea61476Config {
    private String name = "idea_061476";
 ...
 */
@Slf4j
public class Idea61476Service {
    private static final int IDEA_ID = 61476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61476Service() {
        this(new Idea61476Config());
    }

    public Idea61476Service(Idea61476Config config) {
        this.config = config != null ? config : new Idea61476Config();
