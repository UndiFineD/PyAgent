...
@Data
public class Idea61391Config {
    private String name = "idea_061391";
 ...
 */
@Slf4j
public class Idea61391Service {
    private static final int IDEA_ID = 61391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61391Service() {
        this(new Idea61391Config());
    }

    public Idea61391Service(Idea61391Config config) {
        this.config = config != null ? config : new Idea61391Config();
