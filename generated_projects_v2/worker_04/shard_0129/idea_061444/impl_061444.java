...
@Data
public class Idea61444Config {
    private String name = "idea_061444";
 ...
 */
@Slf4j
public class Idea61444Service {
    private static final int IDEA_ID = 61444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61444Service() {
        this(new Idea61444Config());
    }

    public Idea61444Service(Idea61444Config config) {
        this.config = config != null ? config : new Idea61444Config();
