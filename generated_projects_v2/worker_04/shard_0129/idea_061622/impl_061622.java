...
@Data
public class Idea61622Config {
    private String name = "idea_061622";
 ...
 */
@Slf4j
public class Idea61622Service {
    private static final int IDEA_ID = 61622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61622Service() {
        this(new Idea61622Config());
    }

    public Idea61622Service(Idea61622Config config) {
        this.config = config != null ? config : new Idea61622Config();
