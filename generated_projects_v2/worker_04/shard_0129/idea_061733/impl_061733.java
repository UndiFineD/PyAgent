...
@Data
public class Idea61733Config {
    private String name = "idea_061733";
 ...
 */
@Slf4j
public class Idea61733Service {
    private static final int IDEA_ID = 61733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61733Service() {
        this(new Idea61733Config());
    }

    public Idea61733Service(Idea61733Config config) {
        this.config = config != null ? config : new Idea61733Config();
