...
@Data
public class Idea61632Config {
    private String name = "idea_061632";
 ...
 */
@Slf4j
public class Idea61632Service {
    private static final int IDEA_ID = 61632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61632Service() {
        this(new Idea61632Config());
    }

    public Idea61632Service(Idea61632Config config) {
        this.config = config != null ? config : new Idea61632Config();
