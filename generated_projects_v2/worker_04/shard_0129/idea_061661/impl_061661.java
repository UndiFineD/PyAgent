...
@Data
public class Idea61661Config {
    private String name = "idea_061661";
 ...
 */
@Slf4j
public class Idea61661Service {
    private static final int IDEA_ID = 61661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61661Service() {
        this(new Idea61661Config());
    }

    public Idea61661Service(Idea61661Config config) {
        this.config = config != null ? config : new Idea61661Config();
