...
@Data
public class Idea61352Config {
    private String name = "idea_061352";
 ...
 */
@Slf4j
public class Idea61352Service {
    private static final int IDEA_ID = 61352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61352Service() {
        this(new Idea61352Config());
    }

    public Idea61352Service(Idea61352Config config) {
        this.config = config != null ? config : new Idea61352Config();
