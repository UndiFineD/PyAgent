...
@Data
public class Idea61527Config {
    private String name = "idea_061527";
 ...
 */
@Slf4j
public class Idea61527Service {
    private static final int IDEA_ID = 61527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61527Service() {
        this(new Idea61527Config());
    }

    public Idea61527Service(Idea61527Config config) {
        this.config = config != null ? config : new Idea61527Config();
