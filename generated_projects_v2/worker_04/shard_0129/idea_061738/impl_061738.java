...
@Data
public class Idea61738Config {
    private String name = "idea_061738";
 ...
 */
@Slf4j
public class Idea61738Service {
    private static final int IDEA_ID = 61738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61738Service() {
        this(new Idea61738Config());
    }

    public Idea61738Service(Idea61738Config config) {
        this.config = config != null ? config : new Idea61738Config();
