...
@Data
public class Idea61312Config {
    private String name = "idea_061312";
 ...
 */
@Slf4j
public class Idea61312Service {
    private static final int IDEA_ID = 61312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61312Service() {
        this(new Idea61312Config());
    }

    public Idea61312Service(Idea61312Config config) {
        this.config = config != null ? config : new Idea61312Config();
