...
@Data
public class Idea61552Config {
    private String name = "idea_061552";
 ...
 */
@Slf4j
public class Idea61552Service {
    private static final int IDEA_ID = 61552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61552Service() {
        this(new Idea61552Config());
    }

    public Idea61552Service(Idea61552Config config) {
        this.config = config != null ? config : new Idea61552Config();
