...
@Data
public class Idea61464Config {
    private String name = "idea_061464";
 ...
 */
@Slf4j
public class Idea61464Service {
    private static final int IDEA_ID = 61464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61464Service() {
        this(new Idea61464Config());
    }

    public Idea61464Service(Idea61464Config config) {
        this.config = config != null ? config : new Idea61464Config();
