...
@Data
public class Idea61304Config {
    private String name = "idea_061304";
 ...
 */
@Slf4j
public class Idea61304Service {
    private static final int IDEA_ID = 61304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61304Service() {
        this(new Idea61304Config());
    }

    public Idea61304Service(Idea61304Config config) {
        this.config = config != null ? config : new Idea61304Config();
