...
@Data
public class Idea61677Config {
    private String name = "idea_061677";
 ...
 */
@Slf4j
public class Idea61677Service {
    private static final int IDEA_ID = 61677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61677Service() {
        this(new Idea61677Config());
    }

    public Idea61677Service(Idea61677Config config) {
        this.config = config != null ? config : new Idea61677Config();
