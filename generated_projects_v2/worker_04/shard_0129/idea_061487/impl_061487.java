...
@Data
public class Idea61487Config {
    private String name = "idea_061487";
 ...
 */
@Slf4j
public class Idea61487Service {
    private static final int IDEA_ID = 61487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61487Service() {
        this(new Idea61487Config());
    }

    public Idea61487Service(Idea61487Config config) {
        this.config = config != null ? config : new Idea61487Config();
