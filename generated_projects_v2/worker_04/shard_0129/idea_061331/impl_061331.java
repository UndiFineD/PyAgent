...
@Data
public class Idea61331Config {
    private String name = "idea_061331";
 ...
 */
@Slf4j
public class Idea61331Service {
    private static final int IDEA_ID = 61331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61331Service() {
        this(new Idea61331Config());
    }

    public Idea61331Service(Idea61331Config config) {
        this.config = config != null ? config : new Idea61331Config();
