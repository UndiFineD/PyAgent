...
@Data
public class Idea61601Config {
    private String name = "idea_061601";
 ...
 */
@Slf4j
public class Idea61601Service {
    private static final int IDEA_ID = 61601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61601Service() {
        this(new Idea61601Config());
    }

    public Idea61601Service(Idea61601Config config) {
        this.config = config != null ? config : new Idea61601Config();
