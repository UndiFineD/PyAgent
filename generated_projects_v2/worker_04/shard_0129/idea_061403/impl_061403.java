...
@Data
public class Idea61403Config {
    private String name = "idea_061403";
 ...
 */
@Slf4j
public class Idea61403Service {
    private static final int IDEA_ID = 61403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61403Service() {
        this(new Idea61403Config());
    }

    public Idea61403Service(Idea61403Config config) {
        this.config = config != null ? config : new Idea61403Config();
