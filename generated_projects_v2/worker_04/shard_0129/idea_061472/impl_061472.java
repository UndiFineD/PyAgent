...
@Data
public class Idea61472Config {
    private String name = "idea_061472";
 ...
 */
@Slf4j
public class Idea61472Service {
    private static final int IDEA_ID = 61472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61472Service() {
        this(new Idea61472Config());
    }

    public Idea61472Service(Idea61472Config config) {
        this.config = config != null ? config : new Idea61472Config();
