...
@Data
public class Idea61741Config {
    private String name = "idea_061741";
 ...
 */
@Slf4j
public class Idea61741Service {
    private static final int IDEA_ID = 61741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61741Service() {
        this(new Idea61741Config());
    }

    public Idea61741Service(Idea61741Config config) {
        this.config = config != null ? config : new Idea61741Config();
