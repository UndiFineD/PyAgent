...
@Data
public class Idea61592Config {
    private String name = "idea_061592";
 ...
 */
@Slf4j
public class Idea61592Service {
    private static final int IDEA_ID = 61592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61592Service() {
        this(new Idea61592Config());
    }

    public Idea61592Service(Idea61592Config config) {
        this.config = config != null ? config : new Idea61592Config();
