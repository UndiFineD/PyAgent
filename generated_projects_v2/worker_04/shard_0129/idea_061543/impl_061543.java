...
@Data
public class Idea61543Config {
    private String name = "idea_061543";
 ...
 */
@Slf4j
public class Idea61543Service {
    private static final int IDEA_ID = 61543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61543Service() {
        this(new Idea61543Config());
    }

    public Idea61543Service(Idea61543Config config) {
        this.config = config != null ? config : new Idea61543Config();
