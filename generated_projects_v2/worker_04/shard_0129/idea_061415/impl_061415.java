...
@Data
public class Idea61415Config {
    private String name = "idea_061415";
 ...
 */
@Slf4j
public class Idea61415Service {
    private static final int IDEA_ID = 61415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61415Service() {
        this(new Idea61415Config());
    }

    public Idea61415Service(Idea61415Config config) {
        this.config = config != null ? config : new Idea61415Config();
