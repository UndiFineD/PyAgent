...
@Data
public class Idea61316Config {
    private String name = "idea_061316";
 ...
 */
@Slf4j
public class Idea61316Service {
    private static final int IDEA_ID = 61316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61316Service() {
        this(new Idea61316Config());
    }

    public Idea61316Service(Idea61316Config config) {
        this.config = config != null ? config : new Idea61316Config();
