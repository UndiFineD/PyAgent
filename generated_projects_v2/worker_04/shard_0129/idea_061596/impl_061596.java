...
@Data
public class Idea61596Config {
    private String name = "idea_061596";
 ...
 */
@Slf4j
public class Idea61596Service {
    private static final int IDEA_ID = 61596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61596Service() {
        this(new Idea61596Config());
    }

    public Idea61596Service(Idea61596Config config) {
        this.config = config != null ? config : new Idea61596Config();
