...
@Data
public class Idea61580Config {
    private String name = "idea_061580";
 ...
 */
@Slf4j
public class Idea61580Service {
    private static final int IDEA_ID = 61580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61580Service() {
        this(new Idea61580Config());
    }

    public Idea61580Service(Idea61580Config config) {
        this.config = config != null ? config : new Idea61580Config();
