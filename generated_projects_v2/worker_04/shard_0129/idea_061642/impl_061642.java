...
@Data
public class Idea61642Config {
    private String name = "idea_061642";
 ...
 */
@Slf4j
public class Idea61642Service {
    private static final int IDEA_ID = 61642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61642Service() {
        this(new Idea61642Config());
    }

    public Idea61642Service(Idea61642Config config) {
        this.config = config != null ? config : new Idea61642Config();
