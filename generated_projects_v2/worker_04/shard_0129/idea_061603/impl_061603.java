...
@Data
public class Idea61603Config {
    private String name = "idea_061603";
 ...
 */
@Slf4j
public class Idea61603Service {
    private static final int IDEA_ID = 61603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61603Service() {
        this(new Idea61603Config());
    }

    public Idea61603Service(Idea61603Config config) {
        this.config = config != null ? config : new Idea61603Config();
