...
@Data
public class Idea61315Config {
    private String name = "idea_061315";
 ...
 */
@Slf4j
public class Idea61315Service {
    private static final int IDEA_ID = 61315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61315Service() {
        this(new Idea61315Config());
    }

    public Idea61315Service(Idea61315Config config) {
        this.config = config != null ? config : new Idea61315Config();
