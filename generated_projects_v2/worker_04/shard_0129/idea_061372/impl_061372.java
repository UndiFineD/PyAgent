...
@Data
public class Idea61372Config {
    private String name = "idea_061372";
 ...
 */
@Slf4j
public class Idea61372Service {
    private static final int IDEA_ID = 61372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61372Service() {
        this(new Idea61372Config());
    }

    public Idea61372Service(Idea61372Config config) {
        this.config = config != null ? config : new Idea61372Config();
