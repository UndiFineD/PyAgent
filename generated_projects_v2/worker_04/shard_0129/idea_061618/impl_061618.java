...
@Data
public class Idea61618Config {
    private String name = "idea_061618";
 ...
 */
@Slf4j
public class Idea61618Service {
    private static final int IDEA_ID = 61618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61618Service() {
        this(new Idea61618Config());
    }

    public Idea61618Service(Idea61618Config config) {
        this.config = config != null ? config : new Idea61618Config();
