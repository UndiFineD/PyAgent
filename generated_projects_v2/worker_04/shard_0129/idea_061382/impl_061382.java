...
@Data
public class Idea61382Config {
    private String name = "idea_061382";
 ...
 */
@Slf4j
public class Idea61382Service {
    private static final int IDEA_ID = 61382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61382Service() {
        this(new Idea61382Config());
    }

    public Idea61382Service(Idea61382Config config) {
        this.config = config != null ? config : new Idea61382Config();
