...
@Data
public class Idea61449Config {
    private String name = "idea_061449";
 ...
 */
@Slf4j
public class Idea61449Service {
    private static final int IDEA_ID = 61449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61449Service() {
        this(new Idea61449Config());
    }

    public Idea61449Service(Idea61449Config config) {
        this.config = config != null ? config : new Idea61449Config();
