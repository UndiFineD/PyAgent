...
@Data
public class Idea61491Config {
    private String name = "idea_061491";
 ...
 */
@Slf4j
public class Idea61491Service {
    private static final int IDEA_ID = 61491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61491Service() {
        this(new Idea61491Config());
    }

    public Idea61491Service(Idea61491Config config) {
        this.config = config != null ? config : new Idea61491Config();
