...
@Data
public class Idea61657Config {
    private String name = "idea_061657";
 ...
 */
@Slf4j
public class Idea61657Service {
    private static final int IDEA_ID = 61657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61657Service() {
        this(new Idea61657Config());
    }

    public Idea61657Service(Idea61657Config config) {
        this.config = config != null ? config : new Idea61657Config();
