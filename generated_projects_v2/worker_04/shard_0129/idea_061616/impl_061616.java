...
@Data
public class Idea61616Config {
    private String name = "idea_061616";
 ...
 */
@Slf4j
public class Idea61616Service {
    private static final int IDEA_ID = 61616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61616Service() {
        this(new Idea61616Config());
    }

    public Idea61616Service(Idea61616Config config) {
        this.config = config != null ? config : new Idea61616Config();
