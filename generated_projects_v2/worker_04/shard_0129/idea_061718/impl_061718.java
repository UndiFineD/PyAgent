...
@Data
public class Idea61718Config {
    private String name = "idea_061718";
 ...
 */
@Slf4j
public class Idea61718Service {
    private static final int IDEA_ID = 61718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61718Service() {
        this(new Idea61718Config());
    }

    public Idea61718Service(Idea61718Config config) {
        this.config = config != null ? config : new Idea61718Config();
