...
@Data
public class Idea61302Config {
    private String name = "idea_061302";
 ...
 */
@Slf4j
public class Idea61302Service {
    private static final int IDEA_ID = 61302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61302Service() {
        this(new Idea61302Config());
    }

    public Idea61302Service(Idea61302Config config) {
        this.config = config != null ? config : new Idea61302Config();
