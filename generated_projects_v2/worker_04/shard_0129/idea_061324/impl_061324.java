...
@Data
public class Idea61324Config {
    private String name = "idea_061324";
 ...
 */
@Slf4j
public class Idea61324Service {
    private static final int IDEA_ID = 61324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61324Service() {
        this(new Idea61324Config());
    }

    public Idea61324Service(Idea61324Config config) {
        this.config = config != null ? config : new Idea61324Config();
