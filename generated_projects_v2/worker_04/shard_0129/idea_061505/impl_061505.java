...
@Data
public class Idea61505Config {
    private String name = "idea_061505";
 ...
 */
@Slf4j
public class Idea61505Service {
    private static final int IDEA_ID = 61505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61505Service() {
        this(new Idea61505Config());
    }

    public Idea61505Service(Idea61505Config config) {
        this.config = config != null ? config : new Idea61505Config();
