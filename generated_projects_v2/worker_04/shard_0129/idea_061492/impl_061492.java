...
@Data
public class Idea61492Config {
    private String name = "idea_061492";
 ...
 */
@Slf4j
public class Idea61492Service {
    private static final int IDEA_ID = 61492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61492Service() {
        this(new Idea61492Config());
    }

    public Idea61492Service(Idea61492Config config) {
        this.config = config != null ? config : new Idea61492Config();
