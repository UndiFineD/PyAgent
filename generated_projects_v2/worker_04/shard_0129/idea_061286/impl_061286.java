...
@Data
public class Idea61286Config {
    private String name = "idea_061286";
 ...
 */
@Slf4j
public class Idea61286Service {
    private static final int IDEA_ID = 61286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61286Service() {
        this(new Idea61286Config());
    }

    public Idea61286Service(Idea61286Config config) {
        this.config = config != null ? config : new Idea61286Config();
