...
@Data
public class Idea61355Config {
    private String name = "idea_061355";
 ...
 */
@Slf4j
public class Idea61355Service {
    private static final int IDEA_ID = 61355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61355Service() {
        this(new Idea61355Config());
    }

    public Idea61355Service(Idea61355Config config) {
        this.config = config != null ? config : new Idea61355Config();
