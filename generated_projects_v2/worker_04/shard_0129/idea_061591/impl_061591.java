...
@Data
public class Idea61591Config {
    private String name = "idea_061591";
 ...
 */
@Slf4j
public class Idea61591Service {
    private static final int IDEA_ID = 61591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61591Service() {
        this(new Idea61591Config());
    }

    public Idea61591Service(Idea61591Config config) {
        this.config = config != null ? config : new Idea61591Config();
