...
@Data
public class Idea61703Config {
    private String name = "idea_061703";
 ...
 */
@Slf4j
public class Idea61703Service {
    private static final int IDEA_ID = 61703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61703Service() {
        this(new Idea61703Config());
    }

    public Idea61703Service(Idea61703Config config) {
        this.config = config != null ? config : new Idea61703Config();
