...
@Data
public class Idea61530Config {
    private String name = "idea_061530";
 ...
 */
@Slf4j
public class Idea61530Service {
    private static final int IDEA_ID = 61530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61530Service() {
        this(new Idea61530Config());
    }

    public Idea61530Service(Idea61530Config config) {
        this.config = config != null ? config : new Idea61530Config();
