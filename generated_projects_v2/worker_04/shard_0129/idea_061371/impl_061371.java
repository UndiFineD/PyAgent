...
@Data
public class Idea61371Config {
    private String name = "idea_061371";
 ...
 */
@Slf4j
public class Idea61371Service {
    private static final int IDEA_ID = 61371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61371Service() {
        this(new Idea61371Config());
    }

    public Idea61371Service(Idea61371Config config) {
        this.config = config != null ? config : new Idea61371Config();
