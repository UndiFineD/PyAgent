...
@Data
public class Idea61448Config {
    private String name = "idea_061448";
 ...
 */
@Slf4j
public class Idea61448Service {
    private static final int IDEA_ID = 61448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61448Service() {
        this(new Idea61448Config());
    }

    public Idea61448Service(Idea61448Config config) {
        this.config = config != null ? config : new Idea61448Config();
