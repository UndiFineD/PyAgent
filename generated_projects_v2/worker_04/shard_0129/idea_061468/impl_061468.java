...
@Data
public class Idea61468Config {
    private String name = "idea_061468";
 ...
 */
@Slf4j
public class Idea61468Service {
    private static final int IDEA_ID = 61468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61468Service() {
        this(new Idea61468Config());
    }

    public Idea61468Service(Idea61468Config config) {
        this.config = config != null ? config : new Idea61468Config();
