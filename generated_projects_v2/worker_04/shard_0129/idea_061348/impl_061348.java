...
@Data
public class Idea61348Config {
    private String name = "idea_061348";
 ...
 */
@Slf4j
public class Idea61348Service {
    private static final int IDEA_ID = 61348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61348Service() {
        this(new Idea61348Config());
    }

    public Idea61348Service(Idea61348Config config) {
        this.config = config != null ? config : new Idea61348Config();
