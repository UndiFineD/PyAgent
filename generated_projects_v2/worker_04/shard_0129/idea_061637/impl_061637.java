...
@Data
public class Idea61637Config {
    private String name = "idea_061637";
 ...
 */
@Slf4j
public class Idea61637Service {
    private static final int IDEA_ID = 61637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61637Service() {
        this(new Idea61637Config());
    }

    public Idea61637Service(Idea61637Config config) {
        this.config = config != null ? config : new Idea61637Config();
