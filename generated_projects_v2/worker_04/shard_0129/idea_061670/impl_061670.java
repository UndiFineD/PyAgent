...
@Data
public class Idea61670Config {
    private String name = "idea_061670";
 ...
 */
@Slf4j
public class Idea61670Service {
    private static final int IDEA_ID = 61670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61670Service() {
        this(new Idea61670Config());
    }

    public Idea61670Service(Idea61670Config config) {
        this.config = config != null ? config : new Idea61670Config();
