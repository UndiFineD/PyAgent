...
@Data
public class Idea61526Config {
    private String name = "idea_061526";
 ...
 */
@Slf4j
public class Idea61526Service {
    private static final int IDEA_ID = 61526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61526Service() {
        this(new Idea61526Config());
    }

    public Idea61526Service(Idea61526Config config) {
        this.config = config != null ? config : new Idea61526Config();
