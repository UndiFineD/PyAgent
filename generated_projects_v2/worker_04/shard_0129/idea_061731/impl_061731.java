...
@Data
public class Idea61731Config {
    private String name = "idea_061731";
 ...
 */
@Slf4j
public class Idea61731Service {
    private static final int IDEA_ID = 61731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61731Service() {
        this(new Idea61731Config());
    }

    public Idea61731Service(Idea61731Config config) {
        this.config = config != null ? config : new Idea61731Config();
