...
@Data
public class Idea61634Config {
    private String name = "idea_061634";
 ...
 */
@Slf4j
public class Idea61634Service {
    private static final int IDEA_ID = 61634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61634Service() {
        this(new Idea61634Config());
    }

    public Idea61634Service(Idea61634Config config) {
        this.config = config != null ? config : new Idea61634Config();
