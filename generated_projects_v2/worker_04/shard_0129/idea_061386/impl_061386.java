...
@Data
public class Idea61386Config {
    private String name = "idea_061386";
 ...
 */
@Slf4j
public class Idea61386Service {
    private static final int IDEA_ID = 61386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61386Service() {
        this(new Idea61386Config());
    }

    public Idea61386Service(Idea61386Config config) {
        this.config = config != null ? config : new Idea61386Config();
