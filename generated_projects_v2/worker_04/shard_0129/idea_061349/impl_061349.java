...
@Data
public class Idea61349Config {
    private String name = "idea_061349";
 ...
 */
@Slf4j
public class Idea61349Service {
    private static final int IDEA_ID = 61349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61349Service() {
        this(new Idea61349Config());
    }

    public Idea61349Service(Idea61349Config config) {
        this.config = config != null ? config : new Idea61349Config();
