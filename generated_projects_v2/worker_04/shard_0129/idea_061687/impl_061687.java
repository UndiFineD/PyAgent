...
@Data
public class Idea61687Config {
    private String name = "idea_061687";
 ...
 */
@Slf4j
public class Idea61687Service {
    private static final int IDEA_ID = 61687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61687Service() {
        this(new Idea61687Config());
    }

    public Idea61687Service(Idea61687Config config) {
        this.config = config != null ? config : new Idea61687Config();
