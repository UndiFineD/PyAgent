...
@Data
public class Idea61405Config {
    private String name = "idea_061405";
 ...
 */
@Slf4j
public class Idea61405Service {
    private static final int IDEA_ID = 61405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61405Service() {
        this(new Idea61405Config());
    }

    public Idea61405Service(Idea61405Config config) {
        this.config = config != null ? config : new Idea61405Config();
