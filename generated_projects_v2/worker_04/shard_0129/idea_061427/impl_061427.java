...
@Data
public class Idea61427Config {
    private String name = "idea_061427";
 ...
 */
@Slf4j
public class Idea61427Service {
    private static final int IDEA_ID = 61427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61427Service() {
        this(new Idea61427Config());
    }

    public Idea61427Service(Idea61427Config config) {
        this.config = config != null ? config : new Idea61427Config();
