...
@Data
public class Idea61367Config {
    private String name = "idea_061367";
 ...
 */
@Slf4j
public class Idea61367Service {
    private static final int IDEA_ID = 61367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61367Service() {
        this(new Idea61367Config());
    }

    public Idea61367Service(Idea61367Config config) {
        this.config = config != null ? config : new Idea61367Config();
