...
@Data
public class Idea61620Config {
    private String name = "idea_061620";
 ...
 */
@Slf4j
public class Idea61620Service {
    private static final int IDEA_ID = 61620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61620Service() {
        this(new Idea61620Config());
    }

    public Idea61620Service(Idea61620Config config) {
        this.config = config != null ? config : new Idea61620Config();
