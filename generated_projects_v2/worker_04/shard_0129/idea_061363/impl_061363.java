...
@Data
public class Idea61363Config {
    private String name = "idea_061363";
 ...
 */
@Slf4j
public class Idea61363Service {
    private static final int IDEA_ID = 61363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61363Service() {
        this(new Idea61363Config());
    }

    public Idea61363Service(Idea61363Config config) {
        this.config = config != null ? config : new Idea61363Config();
