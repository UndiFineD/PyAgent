...
@Data
public class Idea61319Config {
    private String name = "idea_061319";
 ...
 */
@Slf4j
public class Idea61319Service {
    private static final int IDEA_ID = 61319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61319Service() {
        this(new Idea61319Config());
    }

    public Idea61319Service(Idea61319Config config) {
        this.config = config != null ? config : new Idea61319Config();
