...
@Data
public class Idea61301Config {
    private String name = "idea_061301";
 ...
 */
@Slf4j
public class Idea61301Service {
    private static final int IDEA_ID = 61301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61301Service() {
        this(new Idea61301Config());
    }

    public Idea61301Service(Idea61301Config config) {
        this.config = config != null ? config : new Idea61301Config();
