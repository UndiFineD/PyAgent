...
@Data
public class Idea61436Config {
    private String name = "idea_061436";
 ...
 */
@Slf4j
public class Idea61436Service {
    private static final int IDEA_ID = 61436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61436Service() {
        this(new Idea61436Config());
    }

    public Idea61436Service(Idea61436Config config) {
        this.config = config != null ? config : new Idea61436Config();
