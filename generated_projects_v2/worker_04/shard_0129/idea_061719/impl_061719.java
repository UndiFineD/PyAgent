...
@Data
public class Idea61719Config {
    private String name = "idea_061719";
 ...
 */
@Slf4j
public class Idea61719Service {
    private static final int IDEA_ID = 61719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61719Service() {
        this(new Idea61719Config());
    }

    public Idea61719Service(Idea61719Config config) {
        this.config = config != null ? config : new Idea61719Config();
