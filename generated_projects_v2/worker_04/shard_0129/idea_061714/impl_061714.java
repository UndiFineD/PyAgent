...
@Data
public class Idea61714Config {
    private String name = "idea_061714";
 ...
 */
@Slf4j
public class Idea61714Service {
    private static final int IDEA_ID = 61714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61714Service() {
        this(new Idea61714Config());
    }

    public Idea61714Service(Idea61714Config config) {
        this.config = config != null ? config : new Idea61714Config();
