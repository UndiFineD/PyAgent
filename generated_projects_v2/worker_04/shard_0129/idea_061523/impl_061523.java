...
@Data
public class Idea61523Config {
    private String name = "idea_061523";
 ...
 */
@Slf4j
public class Idea61523Service {
    private static final int IDEA_ID = 61523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61523Service() {
        this(new Idea61523Config());
    }

    public Idea61523Service(Idea61523Config config) {
        this.config = config != null ? config : new Idea61523Config();
