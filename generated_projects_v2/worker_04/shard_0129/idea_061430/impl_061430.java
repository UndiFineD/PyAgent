...
@Data
public class Idea61430Config {
    private String name = "idea_061430";
 ...
 */
@Slf4j
public class Idea61430Service {
    private static final int IDEA_ID = 61430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61430Service() {
        this(new Idea61430Config());
    }

    public Idea61430Service(Idea61430Config config) {
        this.config = config != null ? config : new Idea61430Config();
