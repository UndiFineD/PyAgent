...
@Data
public class Idea61393Config {
    private String name = "idea_061393";
 ...
 */
@Slf4j
public class Idea61393Service {
    private static final int IDEA_ID = 61393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61393Service() {
        this(new Idea61393Config());
    }

    public Idea61393Service(Idea61393Config config) {
        this.config = config != null ? config : new Idea61393Config();
