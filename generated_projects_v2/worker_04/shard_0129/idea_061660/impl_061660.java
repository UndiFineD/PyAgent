...
@Data
public class Idea61660Config {
    private String name = "idea_061660";
 ...
 */
@Slf4j
public class Idea61660Service {
    private static final int IDEA_ID = 61660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61660Service() {
        this(new Idea61660Config());
    }

    public Idea61660Service(Idea61660Config config) {
        this.config = config != null ? config : new Idea61660Config();
