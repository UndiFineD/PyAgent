...
@Data
public class Idea61356Config {
    private String name = "idea_061356";
 ...
 */
@Slf4j
public class Idea61356Service {
    private static final int IDEA_ID = 61356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61356Service() {
        this(new Idea61356Config());
    }

    public Idea61356Service(Idea61356Config config) {
        this.config = config != null ? config : new Idea61356Config();
