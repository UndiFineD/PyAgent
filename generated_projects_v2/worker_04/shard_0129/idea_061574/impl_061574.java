...
@Data
public class Idea61574Config {
    private String name = "idea_061574";
 ...
 */
@Slf4j
public class Idea61574Service {
    private static final int IDEA_ID = 61574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61574Service() {
        this(new Idea61574Config());
    }

    public Idea61574Service(Idea61574Config config) {
        this.config = config != null ? config : new Idea61574Config();
