...
@Data
public class Idea61456Config {
    private String name = "idea_061456";
 ...
 */
@Slf4j
public class Idea61456Service {
    private static final int IDEA_ID = 61456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61456Service() {
        this(new Idea61456Config());
    }

    public Idea61456Service(Idea61456Config config) {
        this.config = config != null ? config : new Idea61456Config();
