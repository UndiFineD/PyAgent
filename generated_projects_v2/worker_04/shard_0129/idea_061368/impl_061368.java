...
@Data
public class Idea61368Config {
    private String name = "idea_061368";
 ...
 */
@Slf4j
public class Idea61368Service {
    private static final int IDEA_ID = 61368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61368Service() {
        this(new Idea61368Config());
    }

    public Idea61368Service(Idea61368Config config) {
        this.config = config != null ? config : new Idea61368Config();
