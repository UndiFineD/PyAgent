...
@Data
public class Idea61532Config {
    private String name = "idea_061532";
 ...
 */
@Slf4j
public class Idea61532Service {
    private static final int IDEA_ID = 61532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61532Service() {
        this(new Idea61532Config());
    }

    public Idea61532Service(Idea61532Config config) {
        this.config = config != null ? config : new Idea61532Config();
