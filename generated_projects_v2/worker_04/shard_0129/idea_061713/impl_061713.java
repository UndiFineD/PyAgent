...
@Data
public class Idea61713Config {
    private String name = "idea_061713";
 ...
 */
@Slf4j
public class Idea61713Service {
    private static final int IDEA_ID = 61713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61713Service() {
        this(new Idea61713Config());
    }

    public Idea61713Service(Idea61713Config config) {
        this.config = config != null ? config : new Idea61713Config();
