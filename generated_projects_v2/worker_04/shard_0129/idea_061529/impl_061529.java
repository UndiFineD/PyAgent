...
@Data
public class Idea61529Config {
    private String name = "idea_061529";
 ...
 */
@Slf4j
public class Idea61529Service {
    private static final int IDEA_ID = 61529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61529Service() {
        this(new Idea61529Config());
    }

    public Idea61529Service(Idea61529Config config) {
        this.config = config != null ? config : new Idea61529Config();
