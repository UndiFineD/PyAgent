...
@Data
public class Idea61551Config {
    private String name = "idea_061551";
 ...
 */
@Slf4j
public class Idea61551Service {
    private static final int IDEA_ID = 61551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61551Service() {
        this(new Idea61551Config());
    }

    public Idea61551Service(Idea61551Config config) {
        this.config = config != null ? config : new Idea61551Config();
