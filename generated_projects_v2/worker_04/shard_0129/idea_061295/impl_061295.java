...
@Data
public class Idea61295Config {
    private String name = "idea_061295";
 ...
 */
@Slf4j
public class Idea61295Service {
    private static final int IDEA_ID = 61295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61295Service() {
        this(new Idea61295Config());
    }

    public Idea61295Service(Idea61295Config config) {
        this.config = config != null ? config : new Idea61295Config();
