...
@Data
public class Idea61374Config {
    private String name = "idea_061374";
 ...
 */
@Slf4j
public class Idea61374Service {
    private static final int IDEA_ID = 61374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61374Service() {
        this(new Idea61374Config());
    }

    public Idea61374Service(Idea61374Config config) {
        this.config = config != null ? config : new Idea61374Config();
