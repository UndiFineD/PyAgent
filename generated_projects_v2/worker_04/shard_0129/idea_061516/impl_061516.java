...
@Data
public class Idea61516Config {
    private String name = "idea_061516";
 ...
 */
@Slf4j
public class Idea61516Service {
    private static final int IDEA_ID = 61516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61516Service() {
        this(new Idea61516Config());
    }

    public Idea61516Service(Idea61516Config config) {
        this.config = config != null ? config : new Idea61516Config();
