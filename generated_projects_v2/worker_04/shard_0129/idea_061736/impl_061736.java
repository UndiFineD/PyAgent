...
@Data
public class Idea61736Config {
    private String name = "idea_061736";
 ...
 */
@Slf4j
public class Idea61736Service {
    private static final int IDEA_ID = 61736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61736Service() {
        this(new Idea61736Config());
    }

    public Idea61736Service(Idea61736Config config) {
        this.config = config != null ? config : new Idea61736Config();
