...
@Data
public class Idea61611Config {
    private String name = "idea_061611";
 ...
 */
@Slf4j
public class Idea61611Service {
    private static final int IDEA_ID = 61611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61611Service() {
        this(new Idea61611Config());
    }

    public Idea61611Service(Idea61611Config config) {
        this.config = config != null ? config : new Idea61611Config();
