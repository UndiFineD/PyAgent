...
@Data
public class Idea61282Config {
    private String name = "idea_061282";
 ...
 */
@Slf4j
public class Idea61282Service {
    private static final int IDEA_ID = 61282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61282Service() {
        this(new Idea61282Config());
    }

    public Idea61282Service(Idea61282Config config) {
        this.config = config != null ? config : new Idea61282Config();
