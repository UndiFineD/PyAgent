...
@Data
public class Idea61623Config {
    private String name = "idea_061623";
 ...
 */
@Slf4j
public class Idea61623Service {
    private static final int IDEA_ID = 61623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61623Service() {
        this(new Idea61623Config());
    }

    public Idea61623Service(Idea61623Config config) {
        this.config = config != null ? config : new Idea61623Config();
