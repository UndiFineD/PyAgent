...
@Data
public class Idea61573Config {
    private String name = "idea_061573";
 ...
 */
@Slf4j
public class Idea61573Service {
    private static final int IDEA_ID = 61573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61573Service() {
        this(new Idea61573Config());
    }

    public Idea61573Service(Idea61573Config config) {
        this.config = config != null ? config : new Idea61573Config();
