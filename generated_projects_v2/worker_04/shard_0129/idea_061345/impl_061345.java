...
@Data
public class Idea61345Config {
    private String name = "idea_061345";
 ...
 */
@Slf4j
public class Idea61345Service {
    private static final int IDEA_ID = 61345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61345Service() {
        this(new Idea61345Config());
    }

    public Idea61345Service(Idea61345Config config) {
        this.config = config != null ? config : new Idea61345Config();
