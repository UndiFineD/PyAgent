...
@Data
public class Idea61693Config {
    private String name = "idea_061693";
 ...
 */
@Slf4j
public class Idea61693Service {
    private static final int IDEA_ID = 61693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61693Service() {
        this(new Idea61693Config());
    }

    public Idea61693Service(Idea61693Config config) {
        this.config = config != null ? config : new Idea61693Config();
