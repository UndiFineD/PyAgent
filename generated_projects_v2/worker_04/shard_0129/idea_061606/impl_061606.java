...
@Data
public class Idea61606Config {
    private String name = "idea_061606";
 ...
 */
@Slf4j
public class Idea61606Service {
    private static final int IDEA_ID = 61606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61606Service() {
        this(new Idea61606Config());
    }

    public Idea61606Service(Idea61606Config config) {
        this.config = config != null ? config : new Idea61606Config();
