...
@Data
public class Idea61512Config {
    private String name = "idea_061512";
 ...
 */
@Slf4j
public class Idea61512Service {
    private static final int IDEA_ID = 61512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61512Service() {
        this(new Idea61512Config());
    }

    public Idea61512Service(Idea61512Config config) {
        this.config = config != null ? config : new Idea61512Config();
