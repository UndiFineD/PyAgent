...
@Data
public class Idea61556Config {
    private String name = "idea_061556";
 ...
 */
@Slf4j
public class Idea61556Service {
    private static final int IDEA_ID = 61556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61556Service() {
        this(new Idea61556Config());
    }

    public Idea61556Service(Idea61556Config config) {
        this.config = config != null ? config : new Idea61556Config();
