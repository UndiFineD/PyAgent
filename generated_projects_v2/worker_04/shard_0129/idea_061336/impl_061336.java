...
@Data
public class Idea61336Config {
    private String name = "idea_061336";
 ...
 */
@Slf4j
public class Idea61336Service {
    private static final int IDEA_ID = 61336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61336Service() {
        this(new Idea61336Config());
    }

    public Idea61336Service(Idea61336Config config) {
        this.config = config != null ? config : new Idea61336Config();
