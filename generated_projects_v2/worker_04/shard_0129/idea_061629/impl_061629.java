...
@Data
public class Idea61629Config {
    private String name = "idea_061629";
 ...
 */
@Slf4j
public class Idea61629Service {
    private static final int IDEA_ID = 61629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61629Service() {
        this(new Idea61629Config());
    }

    public Idea61629Service(Idea61629Config config) {
        this.config = config != null ? config : new Idea61629Config();
