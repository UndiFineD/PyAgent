...
@Data
public class Idea61699Config {
    private String name = "idea_061699";
 ...
 */
@Slf4j
public class Idea61699Service {
    private static final int IDEA_ID = 61699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61699Service() {
        this(new Idea61699Config());
    }

    public Idea61699Service(Idea61699Config config) {
        this.config = config != null ? config : new Idea61699Config();
