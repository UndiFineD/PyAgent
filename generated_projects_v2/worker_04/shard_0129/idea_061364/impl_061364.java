...
@Data
public class Idea61364Config {
    private String name = "idea_061364";
 ...
 */
@Slf4j
public class Idea61364Service {
    private static final int IDEA_ID = 61364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61364Service() {
        this(new Idea61364Config());
    }

    public Idea61364Service(Idea61364Config config) {
        this.config = config != null ? config : new Idea61364Config();
