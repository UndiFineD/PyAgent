...
@Data
public class Idea61313Config {
    private String name = "idea_061313";
 ...
 */
@Slf4j
public class Idea61313Service {
    private static final int IDEA_ID = 61313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61313Service() {
        this(new Idea61313Config());
    }

    public Idea61313Service(Idea61313Config config) {
        this.config = config != null ? config : new Idea61313Config();
