...
@Data
public class Idea61538Config {
    private String name = "idea_061538";
 ...
 */
@Slf4j
public class Idea61538Service {
    private static final int IDEA_ID = 61538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61538Service() {
        this(new Idea61538Config());
    }

    public Idea61538Service(Idea61538Config config) {
        this.config = config != null ? config : new Idea61538Config();
