...
@Data
public class Idea61547Config {
    private String name = "idea_061547";
 ...
 */
@Slf4j
public class Idea61547Service {
    private static final int IDEA_ID = 61547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61547Service() {
        this(new Idea61547Config());
    }

    public Idea61547Service(Idea61547Config config) {
        this.config = config != null ? config : new Idea61547Config();
