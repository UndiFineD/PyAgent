...
@Data
public class Idea61553Config {
    private String name = "idea_061553";
 ...
 */
@Slf4j
public class Idea61553Service {
    private static final int IDEA_ID = 61553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61553Service() {
        this(new Idea61553Config());
    }

    public Idea61553Service(Idea61553Config config) {
        this.config = config != null ? config : new Idea61553Config();
