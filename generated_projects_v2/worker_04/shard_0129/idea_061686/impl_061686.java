...
@Data
public class Idea61686Config {
    private String name = "idea_061686";
 ...
 */
@Slf4j
public class Idea61686Service {
    private static final int IDEA_ID = 61686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61686Service() {
        this(new Idea61686Config());
    }

    public Idea61686Service(Idea61686Config config) {
        this.config = config != null ? config : new Idea61686Config();
