...
@Data
public class Idea61439Config {
    private String name = "idea_061439";
 ...
 */
@Slf4j
public class Idea61439Service {
    private static final int IDEA_ID = 61439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61439Service() {
        this(new Idea61439Config());
    }

    public Idea61439Service(Idea61439Config config) {
        this.config = config != null ? config : new Idea61439Config();
