...
@Data
public class Idea61291Config {
    private String name = "idea_061291";
 ...
 */
@Slf4j
public class Idea61291Service {
    private static final int IDEA_ID = 61291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61291Service() {
        this(new Idea61291Config());
    }

    public Idea61291Service(Idea61291Config config) {
        this.config = config != null ? config : new Idea61291Config();
