...
@Data
public class Idea61284Config {
    private String name = "idea_061284";
 ...
 */
@Slf4j
public class Idea61284Service {
    private static final int IDEA_ID = 61284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61284Service() {
        this(new Idea61284Config());
    }

    public Idea61284Service(Idea61284Config config) {
        this.config = config != null ? config : new Idea61284Config();
