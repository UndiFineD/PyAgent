...
@Data
public class Idea61419Config {
    private String name = "idea_061419";
 ...
 */
@Slf4j
public class Idea61419Service {
    private static final int IDEA_ID = 61419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61419Service() {
        this(new Idea61419Config());
    }

    public Idea61419Service(Idea61419Config config) {
        this.config = config != null ? config : new Idea61419Config();
