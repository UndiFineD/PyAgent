...
@Data
public class Idea61575Config {
    private String name = "idea_061575";
 ...
 */
@Slf4j
public class Idea61575Service {
    private static final int IDEA_ID = 61575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61575Service() {
        this(new Idea61575Config());
    }

    public Idea61575Service(Idea61575Config config) {
        this.config = config != null ? config : new Idea61575Config();
