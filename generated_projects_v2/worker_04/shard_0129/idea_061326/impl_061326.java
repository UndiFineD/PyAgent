...
@Data
public class Idea61326Config {
    private String name = "idea_061326";
 ...
 */
@Slf4j
public class Idea61326Service {
    private static final int IDEA_ID = 61326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61326Service() {
        this(new Idea61326Config());
    }

    public Idea61326Service(Idea61326Config config) {
        this.config = config != null ? config : new Idea61326Config();
