...
@Data
public class Idea61540Config {
    private String name = "idea_061540";
 ...
 */
@Slf4j
public class Idea61540Service {
    private static final int IDEA_ID = 61540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61540Service() {
        this(new Idea61540Config());
    }

    public Idea61540Service(Idea61540Config config) {
        this.config = config != null ? config : new Idea61540Config();
