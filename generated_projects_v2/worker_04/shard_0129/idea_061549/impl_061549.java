...
@Data
public class Idea61549Config {
    private String name = "idea_061549";
 ...
 */
@Slf4j
public class Idea61549Service {
    private static final int IDEA_ID = 61549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61549Service() {
        this(new Idea61549Config());
    }

    public Idea61549Service(Idea61549Config config) {
        this.config = config != null ? config : new Idea61549Config();
