...
@Data
public class Idea61590Config {
    private String name = "idea_061590";
 ...
 */
@Slf4j
public class Idea61590Service {
    private static final int IDEA_ID = 61590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61590Service() {
        this(new Idea61590Config());
    }

    public Idea61590Service(Idea61590Config config) {
        this.config = config != null ? config : new Idea61590Config();
