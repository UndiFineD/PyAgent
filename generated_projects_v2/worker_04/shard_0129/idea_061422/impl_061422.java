...
@Data
public class Idea61422Config {
    private String name = "idea_061422";
 ...
 */
@Slf4j
public class Idea61422Service {
    private static final int IDEA_ID = 61422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61422Service() {
        this(new Idea61422Config());
    }

    public Idea61422Service(Idea61422Config config) {
        this.config = config != null ? config : new Idea61422Config();
