...
@Data
public class Idea61635Config {
    private String name = "idea_061635";
 ...
 */
@Slf4j
public class Idea61635Service {
    private static final int IDEA_ID = 61635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61635Service() {
        this(new Idea61635Config());
    }

    public Idea61635Service(Idea61635Config config) {
        this.config = config != null ? config : new Idea61635Config();
