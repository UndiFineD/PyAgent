...
@Data
public class Idea61619Config {
    private String name = "idea_061619";
 ...
 */
@Slf4j
public class Idea61619Service {
    private static final int IDEA_ID = 61619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61619Service() {
        this(new Idea61619Config());
    }

    public Idea61619Service(Idea61619Config config) {
        this.config = config != null ? config : new Idea61619Config();
