...
@Data
public class Idea61568Config {
    private String name = "idea_061568";
 ...
 */
@Slf4j
public class Idea61568Service {
    private static final int IDEA_ID = 61568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61568Service() {
        this(new Idea61568Config());
    }

    public Idea61568Service(Idea61568Config config) {
        this.config = config != null ? config : new Idea61568Config();
