...
@Data
public class Idea61707Config {
    private String name = "idea_061707";
 ...
 */
@Slf4j
public class Idea61707Service {
    private static final int IDEA_ID = 61707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61707Service() {
        this(new Idea61707Config());
    }

    public Idea61707Service(Idea61707Config config) {
        this.config = config != null ? config : new Idea61707Config();
