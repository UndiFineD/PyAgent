...
@Data
public class Idea61507Config {
    private String name = "idea_061507";
 ...
 */
@Slf4j
public class Idea61507Service {
    private static final int IDEA_ID = 61507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61507Service() {
        this(new Idea61507Config());
    }

    public Idea61507Service(Idea61507Config config) {
        this.config = config != null ? config : new Idea61507Config();
