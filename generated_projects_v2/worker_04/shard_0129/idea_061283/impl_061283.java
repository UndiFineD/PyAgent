...
@Data
public class Idea61283Config {
    private String name = "idea_061283";
 ...
 */
@Slf4j
public class Idea61283Service {
    private static final int IDEA_ID = 61283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61283Service() {
        this(new Idea61283Config());
    }

    public Idea61283Service(Idea61283Config config) {
        this.config = config != null ? config : new Idea61283Config();
