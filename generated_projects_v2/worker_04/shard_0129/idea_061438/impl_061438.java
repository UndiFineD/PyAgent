...
@Data
public class Idea61438Config {
    private String name = "idea_061438";
 ...
 */
@Slf4j
public class Idea61438Service {
    private static final int IDEA_ID = 61438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61438Service() {
        this(new Idea61438Config());
    }

    public Idea61438Service(Idea61438Config config) {
        this.config = config != null ? config : new Idea61438Config();
