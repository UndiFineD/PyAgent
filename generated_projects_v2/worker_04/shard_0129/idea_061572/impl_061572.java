...
@Data
public class Idea61572Config {
    private String name = "idea_061572";
 ...
 */
@Slf4j
public class Idea61572Service {
    private static final int IDEA_ID = 61572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61572Service() {
        this(new Idea61572Config());
    }

    public Idea61572Service(Idea61572Config config) {
        this.config = config != null ? config : new Idea61572Config();
