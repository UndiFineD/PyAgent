...
@Data
public class Idea61659Config {
    private String name = "idea_061659";
 ...
 */
@Slf4j
public class Idea61659Service {
    private static final int IDEA_ID = 61659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61659Service() {
        this(new Idea61659Config());
    }

    public Idea61659Service(Idea61659Config config) {
        this.config = config != null ? config : new Idea61659Config();
