...
@Data
public class Idea61739Config {
    private String name = "idea_061739";
 ...
 */
@Slf4j
public class Idea61739Service {
    private static final int IDEA_ID = 61739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61739Service() {
        this(new Idea61739Config());
    }

    public Idea61739Service(Idea61739Config config) {
        this.config = config != null ? config : new Idea61739Config();
