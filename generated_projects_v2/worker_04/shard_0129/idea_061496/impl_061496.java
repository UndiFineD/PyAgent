...
@Data
public class Idea61496Config {
    private String name = "idea_061496";
 ...
 */
@Slf4j
public class Idea61496Service {
    private static final int IDEA_ID = 61496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61496Service() {
        this(new Idea61496Config());
    }

    public Idea61496Service(Idea61496Config config) {
        this.config = config != null ? config : new Idea61496Config();
