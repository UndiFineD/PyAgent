...
@Data
public class Idea61564Config {
    private String name = "idea_061564";
 ...
 */
@Slf4j
public class Idea61564Service {
    private static final int IDEA_ID = 61564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61564Service() {
        this(new Idea61564Config());
    }

    public Idea61564Service(Idea61564Config config) {
        this.config = config != null ? config : new Idea61564Config();
