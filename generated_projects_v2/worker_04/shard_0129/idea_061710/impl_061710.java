...
@Data
public class Idea61710Config {
    private String name = "idea_061710";
 ...
 */
@Slf4j
public class Idea61710Service {
    private static final int IDEA_ID = 61710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61710Service() {
        this(new Idea61710Config());
    }

    public Idea61710Service(Idea61710Config config) {
        this.config = config != null ? config : new Idea61710Config();
