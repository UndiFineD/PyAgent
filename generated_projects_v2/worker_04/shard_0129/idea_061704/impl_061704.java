...
@Data
public class Idea61704Config {
    private String name = "idea_061704";
 ...
 */
@Slf4j
public class Idea61704Service {
    private static final int IDEA_ID = 61704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61704Service() {
        this(new Idea61704Config());
    }

    public Idea61704Service(Idea61704Config config) {
        this.config = config != null ? config : new Idea61704Config();
