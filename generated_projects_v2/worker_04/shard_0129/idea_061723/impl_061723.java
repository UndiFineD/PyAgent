...
@Data
public class Idea61723Config {
    private String name = "idea_061723";
 ...
 */
@Slf4j
public class Idea61723Service {
    private static final int IDEA_ID = 61723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61723Service() {
        this(new Idea61723Config());
    }

    public Idea61723Service(Idea61723Config config) {
        this.config = config != null ? config : new Idea61723Config();
