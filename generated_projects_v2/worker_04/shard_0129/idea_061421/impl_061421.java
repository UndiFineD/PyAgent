...
@Data
public class Idea61421Config {
    private String name = "idea_061421";
 ...
 */
@Slf4j
public class Idea61421Service {
    private static final int IDEA_ID = 61421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61421Service() {
        this(new Idea61421Config());
    }

    public Idea61421Service(Idea61421Config config) {
        this.config = config != null ? config : new Idea61421Config();
