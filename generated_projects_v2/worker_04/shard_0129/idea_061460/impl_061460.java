...
@Data
public class Idea61460Config {
    private String name = "idea_061460";
 ...
 */
@Slf4j
public class Idea61460Service {
    private static final int IDEA_ID = 61460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61460Service() {
        this(new Idea61460Config());
    }

    public Idea61460Service(Idea61460Config config) {
        this.config = config != null ? config : new Idea61460Config();
