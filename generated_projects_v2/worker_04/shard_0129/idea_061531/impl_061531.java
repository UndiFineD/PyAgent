...
@Data
public class Idea61531Config {
    private String name = "idea_061531";
 ...
 */
@Slf4j
public class Idea61531Service {
    private static final int IDEA_ID = 61531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61531Service() {
        this(new Idea61531Config());
    }

    public Idea61531Service(Idea61531Config config) {
        this.config = config != null ? config : new Idea61531Config();
