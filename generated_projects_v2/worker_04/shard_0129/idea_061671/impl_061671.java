...
@Data
public class Idea61671Config {
    private String name = "idea_061671";
 ...
 */
@Slf4j
public class Idea61671Service {
    private static final int IDEA_ID = 61671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61671Service() {
        this(new Idea61671Config());
    }

    public Idea61671Service(Idea61671Config config) {
        this.config = config != null ? config : new Idea61671Config();
