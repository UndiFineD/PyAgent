...
@Data
public class Idea61559Config {
    private String name = "idea_061559";
 ...
 */
@Slf4j
public class Idea61559Service {
    private static final int IDEA_ID = 61559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61559Service() {
        this(new Idea61559Config());
    }

    public Idea61559Service(Idea61559Config config) {
        this.config = config != null ? config : new Idea61559Config();
