...
@Data
public class Idea61394Config {
    private String name = "idea_061394";
 ...
 */
@Slf4j
public class Idea61394Service {
    private static final int IDEA_ID = 61394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61394Service() {
        this(new Idea61394Config());
    }

    public Idea61394Service(Idea61394Config config) {
        this.config = config != null ? config : new Idea61394Config();
