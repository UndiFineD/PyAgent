...
@Data
public class Idea61365Config {
    private String name = "idea_061365";
 ...
 */
@Slf4j
public class Idea61365Service {
    private static final int IDEA_ID = 61365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61365Service() {
        this(new Idea61365Config());
    }

    public Idea61365Service(Idea61365Config config) {
        this.config = config != null ? config : new Idea61365Config();
