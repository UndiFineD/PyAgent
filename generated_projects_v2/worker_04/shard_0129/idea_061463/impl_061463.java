...
@Data
public class Idea61463Config {
    private String name = "idea_061463";
 ...
 */
@Slf4j
public class Idea61463Service {
    private static final int IDEA_ID = 61463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61463Service() {
        this(new Idea61463Config());
    }

    public Idea61463Service(Idea61463Config config) {
        this.config = config != null ? config : new Idea61463Config();
