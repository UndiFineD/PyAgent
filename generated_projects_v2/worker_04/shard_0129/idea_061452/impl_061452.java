...
@Data
public class Idea61452Config {
    private String name = "idea_061452";
 ...
 */
@Slf4j
public class Idea61452Service {
    private static final int IDEA_ID = 61452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61452Service() {
        this(new Idea61452Config());
    }

    public Idea61452Service(Idea61452Config config) {
        this.config = config != null ? config : new Idea61452Config();
