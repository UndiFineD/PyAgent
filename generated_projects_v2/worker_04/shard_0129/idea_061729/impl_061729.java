...
@Data
public class Idea61729Config {
    private String name = "idea_061729";
 ...
 */
@Slf4j
public class Idea61729Service {
    private static final int IDEA_ID = 61729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61729Service() {
        this(new Idea61729Config());
    }

    public Idea61729Service(Idea61729Config config) {
        this.config = config != null ? config : new Idea61729Config();
