...
@Data
public class Idea61681Config {
    private String name = "idea_061681";
 ...
 */
@Slf4j
public class Idea61681Service {
    private static final int IDEA_ID = 61681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61681Service() {
        this(new Idea61681Config());
    }

    public Idea61681Service(Idea61681Config config) {
        this.config = config != null ? config : new Idea61681Config();
