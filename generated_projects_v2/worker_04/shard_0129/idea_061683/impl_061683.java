...
@Data
public class Idea61683Config {
    private String name = "idea_061683";
 ...
 */
@Slf4j
public class Idea61683Service {
    private static final int IDEA_ID = 61683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61683Service() {
        this(new Idea61683Config());
    }

    public Idea61683Service(Idea61683Config config) {
        this.config = config != null ? config : new Idea61683Config();
