...
@Data
public class Idea61554Config {
    private String name = "idea_061554";
 ...
 */
@Slf4j
public class Idea61554Service {
    private static final int IDEA_ID = 61554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61554Service() {
        this(new Idea61554Config());
    }

    public Idea61554Service(Idea61554Config config) {
        this.config = config != null ? config : new Idea61554Config();
