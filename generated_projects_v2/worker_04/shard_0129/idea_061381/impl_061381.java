...
@Data
public class Idea61381Config {
    private String name = "idea_061381";
 ...
 */
@Slf4j
public class Idea61381Service {
    private static final int IDEA_ID = 61381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61381Service() {
        this(new Idea61381Config());
    }

    public Idea61381Service(Idea61381Config config) {
        this.config = config != null ? config : new Idea61381Config();
