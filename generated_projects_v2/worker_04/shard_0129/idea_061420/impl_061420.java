...
@Data
public class Idea61420Config {
    private String name = "idea_061420";
 ...
 */
@Slf4j
public class Idea61420Service {
    private static final int IDEA_ID = 61420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61420Service() {
        this(new Idea61420Config());
    }

    public Idea61420Service(Idea61420Config config) {
        this.config = config != null ? config : new Idea61420Config();
