...
@Data
public class Idea61309Config {
    private String name = "idea_061309";
 ...
 */
@Slf4j
public class Idea61309Service {
    private static final int IDEA_ID = 61309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61309Service() {
        this(new Idea61309Config());
    }

    public Idea61309Service(Idea61309Config config) {
        this.config = config != null ? config : new Idea61309Config();
