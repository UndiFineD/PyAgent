...
@Data
public class Idea61605Config {
    private String name = "idea_061605";
 ...
 */
@Slf4j
public class Idea61605Service {
    private static final int IDEA_ID = 61605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61605Service() {
        this(new Idea61605Config());
    }

    public Idea61605Service(Idea61605Config config) {
        this.config = config != null ? config : new Idea61605Config();
