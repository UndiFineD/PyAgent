...
@Data
public class Idea61652Config {
    private String name = "idea_061652";
 ...
 */
@Slf4j
public class Idea61652Service {
    private static final int IDEA_ID = 61652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61652Service() {
        this(new Idea61652Config());
    }

    public Idea61652Service(Idea61652Config config) {
        this.config = config != null ? config : new Idea61652Config();
