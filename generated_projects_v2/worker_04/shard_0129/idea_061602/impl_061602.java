...
@Data
public class Idea61602Config {
    private String name = "idea_061602";
 ...
 */
@Slf4j
public class Idea61602Service {
    private static final int IDEA_ID = 61602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61602Service() {
        this(new Idea61602Config());
    }

    public Idea61602Service(Idea61602Config config) {
        this.config = config != null ? config : new Idea61602Config();
