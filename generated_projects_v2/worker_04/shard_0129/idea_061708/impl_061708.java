...
@Data
public class Idea61708Config {
    private String name = "idea_061708";
 ...
 */
@Slf4j
public class Idea61708Service {
    private static final int IDEA_ID = 61708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61708Service() {
        this(new Idea61708Config());
    }

    public Idea61708Service(Idea61708Config config) {
        this.config = config != null ? config : new Idea61708Config();
