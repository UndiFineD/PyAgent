...
@Data
public class Idea61454Config {
    private String name = "idea_061454";
 ...
 */
@Slf4j
public class Idea61454Service {
    private static final int IDEA_ID = 61454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61454Service() {
        this(new Idea61454Config());
    }

    public Idea61454Service(Idea61454Config config) {
        this.config = config != null ? config : new Idea61454Config();
