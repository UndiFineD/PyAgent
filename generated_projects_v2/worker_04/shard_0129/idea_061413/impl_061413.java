...
@Data
public class Idea61413Config {
    private String name = "idea_061413";
 ...
 */
@Slf4j
public class Idea61413Service {
    private static final int IDEA_ID = 61413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61413Service() {
        this(new Idea61413Config());
    }

    public Idea61413Service(Idea61413Config config) {
        this.config = config != null ? config : new Idea61413Config();
