...
@Data
public class Idea61583Config {
    private String name = "idea_061583";
 ...
 */
@Slf4j
public class Idea61583Service {
    private static final int IDEA_ID = 61583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61583Service() {
        this(new Idea61583Config());
    }

    public Idea61583Service(Idea61583Config config) {
        this.config = config != null ? config : new Idea61583Config();
