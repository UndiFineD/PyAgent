...
@Data
public class Idea61377Config {
    private String name = "idea_061377";
 ...
 */
@Slf4j
public class Idea61377Service {
    private static final int IDEA_ID = 61377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61377Service() {
        this(new Idea61377Config());
    }

    public Idea61377Service(Idea61377Config config) {
        this.config = config != null ? config : new Idea61377Config();
