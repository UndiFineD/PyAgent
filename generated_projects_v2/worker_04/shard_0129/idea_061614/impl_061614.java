...
@Data
public class Idea61614Config {
    private String name = "idea_061614";
 ...
 */
@Slf4j
public class Idea61614Service {
    private static final int IDEA_ID = 61614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61614Service() {
        this(new Idea61614Config());
    }

    public Idea61614Service(Idea61614Config config) {
        this.config = config != null ? config : new Idea61614Config();
