...
@Data
public class Idea61426Config {
    private String name = "idea_061426";
 ...
 */
@Slf4j
public class Idea61426Service {
    private static final int IDEA_ID = 61426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61426Service() {
        this(new Idea61426Config());
    }

    public Idea61426Service(Idea61426Config config) {
        this.config = config != null ? config : new Idea61426Config();
