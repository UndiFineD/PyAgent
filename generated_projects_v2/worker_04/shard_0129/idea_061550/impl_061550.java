...
@Data
public class Idea61550Config {
    private String name = "idea_061550";
 ...
 */
@Slf4j
public class Idea61550Service {
    private static final int IDEA_ID = 61550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61550Service() {
        this(new Idea61550Config());
    }

    public Idea61550Service(Idea61550Config config) {
        this.config = config != null ? config : new Idea61550Config();
