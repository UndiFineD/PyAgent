...
@Data
public class Idea61310Config {
    private String name = "idea_061310";
 ...
 */
@Slf4j
public class Idea61310Service {
    private static final int IDEA_ID = 61310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61310Service() {
        this(new Idea61310Config());
    }

    public Idea61310Service(Idea61310Config config) {
        this.config = config != null ? config : new Idea61310Config();
