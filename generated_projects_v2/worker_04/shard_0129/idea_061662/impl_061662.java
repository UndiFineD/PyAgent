...
@Data
public class Idea61662Config {
    private String name = "idea_061662";
 ...
 */
@Slf4j
public class Idea61662Service {
    private static final int IDEA_ID = 61662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61662Service() {
        this(new Idea61662Config());
    }

    public Idea61662Service(Idea61662Config config) {
        this.config = config != null ? config : new Idea61662Config();
