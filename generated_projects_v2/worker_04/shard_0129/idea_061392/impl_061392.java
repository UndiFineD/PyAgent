...
@Data
public class Idea61392Config {
    private String name = "idea_061392";
 ...
 */
@Slf4j
public class Idea61392Service {
    private static final int IDEA_ID = 61392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61392Service() {
        this(new Idea61392Config());
    }

    public Idea61392Service(Idea61392Config config) {
        this.config = config != null ? config : new Idea61392Config();
