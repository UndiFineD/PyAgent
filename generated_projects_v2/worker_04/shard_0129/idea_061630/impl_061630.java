...
@Data
public class Idea61630Config {
    private String name = "idea_061630";
 ...
 */
@Slf4j
public class Idea61630Service {
    private static final int IDEA_ID = 61630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61630Service() {
        this(new Idea61630Config());
    }

    public Idea61630Service(Idea61630Config config) {
        this.config = config != null ? config : new Idea61630Config();
