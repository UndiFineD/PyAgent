...
@Data
public class Idea61432Config {
    private String name = "idea_061432";
 ...
 */
@Slf4j
public class Idea61432Service {
    private static final int IDEA_ID = 61432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61432Service() {
        this(new Idea61432Config());
    }

    public Idea61432Service(Idea61432Config config) {
        this.config = config != null ? config : new Idea61432Config();
