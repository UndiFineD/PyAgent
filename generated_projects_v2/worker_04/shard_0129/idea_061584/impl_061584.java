...
@Data
public class Idea61584Config {
    private String name = "idea_061584";
 ...
 */
@Slf4j
public class Idea61584Service {
    private static final int IDEA_ID = 61584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61584Service() {
        this(new Idea61584Config());
    }

    public Idea61584Service(Idea61584Config config) {
        this.config = config != null ? config : new Idea61584Config();
