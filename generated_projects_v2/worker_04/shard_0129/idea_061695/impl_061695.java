...
@Data
public class Idea61695Config {
    private String name = "idea_061695";
 ...
 */
@Slf4j
public class Idea61695Service {
    private static final int IDEA_ID = 61695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61695Service() {
        this(new Idea61695Config());
    }

    public Idea61695Service(Idea61695Config config) {
        this.config = config != null ? config : new Idea61695Config();
