...
@Data
public class Idea61404Config {
    private String name = "idea_061404";
 ...
 */
@Slf4j
public class Idea61404Service {
    private static final int IDEA_ID = 61404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61404Service() {
        this(new Idea61404Config());
    }

    public Idea61404Service(Idea61404Config config) {
        this.config = config != null ? config : new Idea61404Config();
