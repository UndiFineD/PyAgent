...
@Data
public class Idea61305Config {
    private String name = "idea_061305";
 ...
 */
@Slf4j
public class Idea61305Service {
    private static final int IDEA_ID = 61305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61305Service() {
        this(new Idea61305Config());
    }

    public Idea61305Service(Idea61305Config config) {
        this.config = config != null ? config : new Idea61305Config();
