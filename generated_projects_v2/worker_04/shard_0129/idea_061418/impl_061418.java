...
@Data
public class Idea61418Config {
    private String name = "idea_061418";
 ...
 */
@Slf4j
public class Idea61418Service {
    private static final int IDEA_ID = 61418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61418Service() {
        this(new Idea61418Config());
    }

    public Idea61418Service(Idea61418Config config) {
        this.config = config != null ? config : new Idea61418Config();
