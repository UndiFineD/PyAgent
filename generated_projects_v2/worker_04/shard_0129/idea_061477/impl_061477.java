...
@Data
public class Idea61477Config {
    private String name = "idea_061477";
 ...
 */
@Slf4j
public class Idea61477Service {
    private static final int IDEA_ID = 61477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61477Service() {
        this(new Idea61477Config());
    }

    public Idea61477Service(Idea61477Config config) {
        this.config = config != null ? config : new Idea61477Config();
