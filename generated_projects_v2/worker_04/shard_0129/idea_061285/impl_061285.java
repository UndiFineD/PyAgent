...
@Data
public class Idea61285Config {
    private String name = "idea_061285";
 ...
 */
@Slf4j
public class Idea61285Service {
    private static final int IDEA_ID = 61285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61285Service() {
        this(new Idea61285Config());
    }

    public Idea61285Service(Idea61285Config config) {
        this.config = config != null ? config : new Idea61285Config();
