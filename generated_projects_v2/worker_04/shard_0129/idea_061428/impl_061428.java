...
@Data
public class Idea61428Config {
    private String name = "idea_061428";
 ...
 */
@Slf4j
public class Idea61428Service {
    private static final int IDEA_ID = 61428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61428Service() {
        this(new Idea61428Config());
    }

    public Idea61428Service(Idea61428Config config) {
        this.config = config != null ? config : new Idea61428Config();
