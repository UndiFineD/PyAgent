...
@Data
public class Idea61520Config {
    private String name = "idea_061520";
 ...
 */
@Slf4j
public class Idea61520Service {
    private static final int IDEA_ID = 61520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61520Service() {
        this(new Idea61520Config());
    }

    public Idea61520Service(Idea61520Config config) {
        this.config = config != null ? config : new Idea61520Config();
