...
@Data
public class Idea61395Config {
    private String name = "idea_061395";
 ...
 */
@Slf4j
public class Idea61395Service {
    private static final int IDEA_ID = 61395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61395Service() {
        this(new Idea61395Config());
    }

    public Idea61395Service(Idea61395Config config) {
        this.config = config != null ? config : new Idea61395Config();
