...
@Data
public class Idea61358Config {
    private String name = "idea_061358";
 ...
 */
@Slf4j
public class Idea61358Service {
    private static final int IDEA_ID = 61358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61358Service() {
        this(new Idea61358Config());
    }

    public Idea61358Service(Idea61358Config config) {
        this.config = config != null ? config : new Idea61358Config();
