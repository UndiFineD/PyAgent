...
@Data
public class Idea61373Config {
    private String name = "idea_061373";
 ...
 */
@Slf4j
public class Idea61373Service {
    private static final int IDEA_ID = 61373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61373Service() {
        this(new Idea61373Config());
    }

    public Idea61373Service(Idea61373Config config) {
        this.config = config != null ? config : new Idea61373Config();
