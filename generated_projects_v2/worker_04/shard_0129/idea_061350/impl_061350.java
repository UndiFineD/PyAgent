...
@Data
public class Idea61350Config {
    private String name = "idea_061350";
 ...
 */
@Slf4j
public class Idea61350Service {
    private static final int IDEA_ID = 61350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61350Service() {
        this(new Idea61350Config());
    }

    public Idea61350Service(Idea61350Config config) {
        this.config = config != null ? config : new Idea61350Config();
