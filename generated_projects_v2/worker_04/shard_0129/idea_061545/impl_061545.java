...
@Data
public class Idea61545Config {
    private String name = "idea_061545";
 ...
 */
@Slf4j
public class Idea61545Service {
    private static final int IDEA_ID = 61545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61545Service() {
        this(new Idea61545Config());
    }

    public Idea61545Service(Idea61545Config config) {
        this.config = config != null ? config : new Idea61545Config();
