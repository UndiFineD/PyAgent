...
@Data
public class Idea61276Config {
    private String name = "idea_061276";
 ...
 */
@Slf4j
public class Idea61276Service {
    private static final int IDEA_ID = 61276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61276Service() {
        this(new Idea61276Config());
    }

    public Idea61276Service(Idea61276Config config) {
        this.config = config != null ? config : new Idea61276Config();
