...
@Data
public class Idea61353Config {
    private String name = "idea_061353";
 ...
 */
@Slf4j
public class Idea61353Service {
    private static final int IDEA_ID = 61353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61353Service() {
        this(new Idea61353Config());
    }

    public Idea61353Service(Idea61353Config config) {
        this.config = config != null ? config : new Idea61353Config();
