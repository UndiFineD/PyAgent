...
@Data
public class Idea61431Config {
    private String name = "idea_061431";
 ...
 */
@Slf4j
public class Idea61431Service {
    private static final int IDEA_ID = 61431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61431Service() {
        this(new Idea61431Config());
    }

    public Idea61431Service(Idea61431Config config) {
        this.config = config != null ? config : new Idea61431Config();
