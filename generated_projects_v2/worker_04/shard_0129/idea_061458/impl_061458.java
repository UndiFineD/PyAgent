...
@Data
public class Idea61458Config {
    private String name = "idea_061458";
 ...
 */
@Slf4j
public class Idea61458Service {
    private static final int IDEA_ID = 61458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61458Service() {
        this(new Idea61458Config());
    }

    public Idea61458Service(Idea61458Config config) {
        this.config = config != null ? config : new Idea61458Config();
