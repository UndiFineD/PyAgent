...
@Data
public class Idea61502Config {
    private String name = "idea_061502";
 ...
 */
@Slf4j
public class Idea61502Service {
    private static final int IDEA_ID = 61502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61502Service() {
        this(new Idea61502Config());
    }

    public Idea61502Service(Idea61502Config config) {
        this.config = config != null ? config : new Idea61502Config();
