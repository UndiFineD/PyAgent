...
@Data
public class Idea61744Config {
    private String name = "idea_061744";
 ...
 */
@Slf4j
public class Idea61744Service {
    private static final int IDEA_ID = 61744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61744Service() {
        this(new Idea61744Config());
    }

    public Idea61744Service(Idea61744Config config) {
        this.config = config != null ? config : new Idea61744Config();
