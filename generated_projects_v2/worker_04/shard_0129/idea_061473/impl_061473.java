...
@Data
public class Idea61473Config {
    private String name = "idea_061473";
 ...
 */
@Slf4j
public class Idea61473Service {
    private static final int IDEA_ID = 61473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61473Service() {
        this(new Idea61473Config());
    }

    public Idea61473Service(Idea61473Config config) {
        this.config = config != null ? config : new Idea61473Config();
