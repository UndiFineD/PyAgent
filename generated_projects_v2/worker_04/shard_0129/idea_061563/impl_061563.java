...
@Data
public class Idea61563Config {
    private String name = "idea_061563";
 ...
 */
@Slf4j
public class Idea61563Service {
    private static final int IDEA_ID = 61563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61563Service() {
        this(new Idea61563Config());
    }

    public Idea61563Service(Idea61563Config config) {
        this.config = config != null ? config : new Idea61563Config();
