...
@Data
public class Idea61734Config {
    private String name = "idea_061734";
 ...
 */
@Slf4j
public class Idea61734Service {
    private static final int IDEA_ID = 61734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61734Service() {
        this(new Idea61734Config());
    }

    public Idea61734Service(Idea61734Config config) {
        this.config = config != null ? config : new Idea61734Config();
