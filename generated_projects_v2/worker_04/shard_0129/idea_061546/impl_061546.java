...
@Data
public class Idea61546Config {
    private String name = "idea_061546";
 ...
 */
@Slf4j
public class Idea61546Service {
    private static final int IDEA_ID = 61546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61546Service() {
        this(new Idea61546Config());
    }

    public Idea61546Service(Idea61546Config config) {
        this.config = config != null ? config : new Idea61546Config();
