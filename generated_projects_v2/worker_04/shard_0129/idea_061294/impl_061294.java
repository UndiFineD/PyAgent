...
@Data
public class Idea61294Config {
    private String name = "idea_061294";
 ...
 */
@Slf4j
public class Idea61294Service {
    private static final int IDEA_ID = 61294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61294Service() {
        this(new Idea61294Config());
    }

    public Idea61294Service(Idea61294Config config) {
        this.config = config != null ? config : new Idea61294Config();
