...
@Data
public class Idea61379Config {
    private String name = "idea_061379";
 ...
 */
@Slf4j
public class Idea61379Service {
    private static final int IDEA_ID = 61379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61379Service() {
        this(new Idea61379Config());
    }

    public Idea61379Service(Idea61379Config config) {
        this.config = config != null ? config : new Idea61379Config();
