...
@Data
public class Idea61638Config {
    private String name = "idea_061638";
 ...
 */
@Slf4j
public class Idea61638Service {
    private static final int IDEA_ID = 61638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61638Service() {
        this(new Idea61638Config());
    }

    public Idea61638Service(Idea61638Config config) {
        this.config = config != null ? config : new Idea61638Config();
