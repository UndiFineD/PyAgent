...
@Data
public class Idea61385Config {
    private String name = "idea_061385";
 ...
 */
@Slf4j
public class Idea61385Service {
    private static final int IDEA_ID = 61385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61385Service() {
        this(new Idea61385Config());
    }

    public Idea61385Service(Idea61385Config config) {
        this.config = config != null ? config : new Idea61385Config();
