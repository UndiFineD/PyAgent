...
@Data
public class Idea61509Config {
    private String name = "idea_061509";
 ...
 */
@Slf4j
public class Idea61509Service {
    private static final int IDEA_ID = 61509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61509Service() {
        this(new Idea61509Config());
    }

    public Idea61509Service(Idea61509Config config) {
        this.config = config != null ? config : new Idea61509Config();
