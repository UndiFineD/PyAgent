...
@Data
public class Idea61510Config {
    private String name = "idea_061510";
 ...
 */
@Slf4j
public class Idea61510Service {
    private static final int IDEA_ID = 61510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61510Service() {
        this(new Idea61510Config());
    }

    public Idea61510Service(Idea61510Config config) {
        this.config = config != null ? config : new Idea61510Config();
