...
@Data
public class Idea61406Config {
    private String name = "idea_061406";
 ...
 */
@Slf4j
public class Idea61406Service {
    private static final int IDEA_ID = 61406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61406Service() {
        this(new Idea61406Config());
    }

    public Idea61406Service(Idea61406Config config) {
        this.config = config != null ? config : new Idea61406Config();
