...
@Data
public class Idea61328Config {
    private String name = "idea_061328";
 ...
 */
@Slf4j
public class Idea61328Service {
    private static final int IDEA_ID = 61328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61328Service() {
        this(new Idea61328Config());
    }

    public Idea61328Service(Idea61328Config config) {
        this.config = config != null ? config : new Idea61328Config();
