...
@Data
public class Idea61354Config {
    private String name = "idea_061354";
 ...
 */
@Slf4j
public class Idea61354Service {
    private static final int IDEA_ID = 61354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61354Service() {
        this(new Idea61354Config());
    }

    public Idea61354Service(Idea61354Config config) {
        this.config = config != null ? config : new Idea61354Config();
