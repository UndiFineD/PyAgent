...
@Data
public class Idea61653Config {
    private String name = "idea_061653";
 ...
 */
@Slf4j
public class Idea61653Service {
    private static final int IDEA_ID = 61653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61653Service() {
        this(new Idea61653Config());
    }

    public Idea61653Service(Idea61653Config config) {
        this.config = config != null ? config : new Idea61653Config();
