...
@Data
public class Idea61497Config {
    private String name = "idea_061497";
 ...
 */
@Slf4j
public class Idea61497Service {
    private static final int IDEA_ID = 61497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61497Service() {
        this(new Idea61497Config());
    }

    public Idea61497Service(Idea61497Config config) {
        this.config = config != null ? config : new Idea61497Config();
