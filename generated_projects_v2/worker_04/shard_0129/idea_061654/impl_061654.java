...
@Data
public class Idea61654Config {
    private String name = "idea_061654";
 ...
 */
@Slf4j
public class Idea61654Service {
    private static final int IDEA_ID = 61654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61654Service() {
        this(new Idea61654Config());
    }

    public Idea61654Service(Idea61654Config config) {
        this.config = config != null ? config : new Idea61654Config();
