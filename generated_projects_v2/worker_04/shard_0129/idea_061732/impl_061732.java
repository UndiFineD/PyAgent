...
@Data
public class Idea61732Config {
    private String name = "idea_061732";
 ...
 */
@Slf4j
public class Idea61732Service {
    private static final int IDEA_ID = 61732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61732Service() {
        this(new Idea61732Config());
    }

    public Idea61732Service(Idea61732Config config) {
        this.config = config != null ? config : new Idea61732Config();
