...
@Data
public class Idea61437Config {
    private String name = "idea_061437";
 ...
 */
@Slf4j
public class Idea61437Service {
    private static final int IDEA_ID = 61437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61437Service() {
        this(new Idea61437Config());
    }

    public Idea61437Service(Idea61437Config config) {
        this.config = config != null ? config : new Idea61437Config();
