...
@Data
public class Idea61495Config {
    private String name = "idea_061495";
 ...
 */
@Slf4j
public class Idea61495Service {
    private static final int IDEA_ID = 61495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61495Service() {
        this(new Idea61495Config());
    }

    public Idea61495Service(Idea61495Config config) {
        this.config = config != null ? config : new Idea61495Config();
