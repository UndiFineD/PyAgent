...
@Data
public class Idea61321Config {
    private String name = "idea_061321";
 ...
 */
@Slf4j
public class Idea61321Service {
    private static final int IDEA_ID = 61321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61321Service() {
        this(new Idea61321Config());
    }

    public Idea61321Service(Idea61321Config config) {
        this.config = config != null ? config : new Idea61321Config();
