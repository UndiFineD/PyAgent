...
@Data
public class Idea61486Config {
    private String name = "idea_061486";
 ...
 */
@Slf4j
public class Idea61486Service {
    private static final int IDEA_ID = 61486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea61486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea61486Service() {
        this(new Idea61486Config());
    }

    public Idea61486Service(Idea61486Config config) {
        this.config = config != null ? config : new Idea61486Config();
