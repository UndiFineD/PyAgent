...
@Data
public class Idea64268Config {
    private String name = "idea_064268";
 ...
 */
@Slf4j
public class Idea64268Service {
    private static final int IDEA_ID = 64268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64268Service() {
        this(new Idea64268Config());
    }

    public Idea64268Service(Idea64268Config config) {
        this.config = config != null ? config : new Idea64268Config();
