...
@Data
public class Idea64244Config {
    private String name = "idea_064244";
 ...
 */
@Slf4j
public class Idea64244Service {
    private static final int IDEA_ID = 64244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64244Service() {
        this(new Idea64244Config());
    }

    public Idea64244Service(Idea64244Config config) {
        this.config = config != null ? config : new Idea64244Config();
