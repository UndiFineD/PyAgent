...
@Data
public class Idea64595Config {
    private String name = "idea_064595";
 ...
 */
@Slf4j
public class Idea64595Service {
    private static final int IDEA_ID = 64595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64595Service() {
        this(new Idea64595Config());
    }

    public Idea64595Service(Idea64595Config config) {
        this.config = config != null ? config : new Idea64595Config();
