...
@Data
public class Idea64333Config {
    private String name = "idea_064333";
 ...
 */
@Slf4j
public class Idea64333Service {
    private static final int IDEA_ID = 64333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64333Service() {
        this(new Idea64333Config());
    }

    public Idea64333Service(Idea64333Config config) {
        this.config = config != null ? config : new Idea64333Config();
