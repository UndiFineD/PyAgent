...
@Data
public class Idea64571Config {
    private String name = "idea_064571";
 ...
 */
@Slf4j
public class Idea64571Service {
    private static final int IDEA_ID = 64571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64571Service() {
        this(new Idea64571Config());
    }

    public Idea64571Service(Idea64571Config config) {
        this.config = config != null ? config : new Idea64571Config();
