...
@Data
public class Idea64377Config {
    private String name = "idea_064377";
 ...
 */
@Slf4j
public class Idea64377Service {
    private static final int IDEA_ID = 64377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64377Service() {
        this(new Idea64377Config());
    }

    public Idea64377Service(Idea64377Config config) {
        this.config = config != null ? config : new Idea64377Config();
