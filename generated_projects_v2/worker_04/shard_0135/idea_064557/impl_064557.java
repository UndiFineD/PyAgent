...
@Data
public class Idea64557Config {
    private String name = "idea_064557";
 ...
 */
@Slf4j
public class Idea64557Service {
    private static final int IDEA_ID = 64557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64557Service() {
        this(new Idea64557Config());
    }

    public Idea64557Service(Idea64557Config config) {
        this.config = config != null ? config : new Idea64557Config();
