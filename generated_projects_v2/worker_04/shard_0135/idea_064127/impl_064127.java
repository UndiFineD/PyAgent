...
@Data
public class Idea64127Config {
    private String name = "idea_064127";
 ...
 */
@Slf4j
public class Idea64127Service {
    private static final int IDEA_ID = 64127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64127Service() {
        this(new Idea64127Config());
    }

    public Idea64127Service(Idea64127Config config) {
        this.config = config != null ? config : new Idea64127Config();
