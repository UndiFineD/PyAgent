...
@Data
public class Idea64544Config {
    private String name = "idea_064544";
 ...
 */
@Slf4j
public class Idea64544Service {
    private static final int IDEA_ID = 64544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64544Service() {
        this(new Idea64544Config());
    }

    public Idea64544Service(Idea64544Config config) {
        this.config = config != null ? config : new Idea64544Config();
