...
@Data
public class Idea64400Config {
    private String name = "idea_064400";
 ...
 */
@Slf4j
public class Idea64400Service {
    private static final int IDEA_ID = 64400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64400Service() {
        this(new Idea64400Config());
    }

    public Idea64400Service(Idea64400Config config) {
        this.config = config != null ? config : new Idea64400Config();
