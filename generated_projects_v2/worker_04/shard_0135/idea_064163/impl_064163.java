...
@Data
public class Idea64163Config {
    private String name = "idea_064163";
 ...
 */
@Slf4j
public class Idea64163Service {
    private static final int IDEA_ID = 64163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64163Service() {
        this(new Idea64163Config());
    }

    public Idea64163Service(Idea64163Config config) {
        this.config = config != null ? config : new Idea64163Config();
