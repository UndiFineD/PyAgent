...
@Data
public class Idea64592Config {
    private String name = "idea_064592";
 ...
 */
@Slf4j
public class Idea64592Service {
    private static final int IDEA_ID = 64592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64592Service() {
        this(new Idea64592Config());
    }

    public Idea64592Service(Idea64592Config config) {
        this.config = config != null ? config : new Idea64592Config();
