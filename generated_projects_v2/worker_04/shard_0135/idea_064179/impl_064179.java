...
@Data
public class Idea64179Config {
    private String name = "idea_064179";
 ...
 */
@Slf4j
public class Idea64179Service {
    private static final int IDEA_ID = 64179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64179Service() {
        this(new Idea64179Config());
    }

    public Idea64179Service(Idea64179Config config) {
        this.config = config != null ? config : new Idea64179Config();
