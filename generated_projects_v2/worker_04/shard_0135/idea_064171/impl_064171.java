...
@Data
public class Idea64171Config {
    private String name = "idea_064171";
 ...
 */
@Slf4j
public class Idea64171Service {
    private static final int IDEA_ID = 64171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64171Service() {
        this(new Idea64171Config());
    }

    public Idea64171Service(Idea64171Config config) {
        this.config = config != null ? config : new Idea64171Config();
