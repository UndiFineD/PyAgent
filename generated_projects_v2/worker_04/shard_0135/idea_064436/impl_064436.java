...
@Data
public class Idea64436Config {
    private String name = "idea_064436";
 ...
 */
@Slf4j
public class Idea64436Service {
    private static final int IDEA_ID = 64436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64436Service() {
        this(new Idea64436Config());
    }

    public Idea64436Service(Idea64436Config config) {
        this.config = config != null ? config : new Idea64436Config();
