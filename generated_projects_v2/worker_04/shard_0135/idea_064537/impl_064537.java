...
@Data
public class Idea64537Config {
    private String name = "idea_064537";
 ...
 */
@Slf4j
public class Idea64537Service {
    private static final int IDEA_ID = 64537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64537Service() {
        this(new Idea64537Config());
    }

    public Idea64537Service(Idea64537Config config) {
        this.config = config != null ? config : new Idea64537Config();
