...
@Data
public class Idea64465Config {
    private String name = "idea_064465";
 ...
 */
@Slf4j
public class Idea64465Service {
    private static final int IDEA_ID = 64465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64465Service() {
        this(new Idea64465Config());
    }

    public Idea64465Service(Idea64465Config config) {
        this.config = config != null ? config : new Idea64465Config();
