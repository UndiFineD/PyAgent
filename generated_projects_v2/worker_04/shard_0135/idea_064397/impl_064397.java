...
@Data
public class Idea64397Config {
    private String name = "idea_064397";
 ...
 */
@Slf4j
public class Idea64397Service {
    private static final int IDEA_ID = 64397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64397Service() {
        this(new Idea64397Config());
    }

    public Idea64397Service(Idea64397Config config) {
        this.config = config != null ? config : new Idea64397Config();
