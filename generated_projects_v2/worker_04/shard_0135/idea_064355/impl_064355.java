...
@Data
public class Idea64355Config {
    private String name = "idea_064355";
 ...
 */
@Slf4j
public class Idea64355Service {
    private static final int IDEA_ID = 64355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64355Service() {
        this(new Idea64355Config());
    }

    public Idea64355Service(Idea64355Config config) {
        this.config = config != null ? config : new Idea64355Config();
