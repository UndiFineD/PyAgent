...
@Data
public class Idea64293Config {
    private String name = "idea_064293";
 ...
 */
@Slf4j
public class Idea64293Service {
    private static final int IDEA_ID = 64293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64293Service() {
        this(new Idea64293Config());
    }

    public Idea64293Service(Idea64293Config config) {
        this.config = config != null ? config : new Idea64293Config();
