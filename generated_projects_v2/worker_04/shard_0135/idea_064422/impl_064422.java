...
@Data
public class Idea64422Config {
    private String name = "idea_064422";
 ...
 */
@Slf4j
public class Idea64422Service {
    private static final int IDEA_ID = 64422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64422Service() {
        this(new Idea64422Config());
    }

    public Idea64422Service(Idea64422Config config) {
        this.config = config != null ? config : new Idea64422Config();
