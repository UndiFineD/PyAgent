...
@Data
public class Idea64252Config {
    private String name = "idea_064252";
 ...
 */
@Slf4j
public class Idea64252Service {
    private static final int IDEA_ID = 64252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64252Service() {
        this(new Idea64252Config());
    }

    public Idea64252Service(Idea64252Config config) {
        this.config = config != null ? config : new Idea64252Config();
