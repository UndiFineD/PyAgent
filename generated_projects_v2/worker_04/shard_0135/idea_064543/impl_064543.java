...
@Data
public class Idea64543Config {
    private String name = "idea_064543";
 ...
 */
@Slf4j
public class Idea64543Service {
    private static final int IDEA_ID = 64543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64543Service() {
        this(new Idea64543Config());
    }

    public Idea64543Service(Idea64543Config config) {
        this.config = config != null ? config : new Idea64543Config();
