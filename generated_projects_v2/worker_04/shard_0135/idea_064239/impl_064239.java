...
@Data
public class Idea64239Config {
    private String name = "idea_064239";
 ...
 */
@Slf4j
public class Idea64239Service {
    private static final int IDEA_ID = 64239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64239Service() {
        this(new Idea64239Config());
    }

    public Idea64239Service(Idea64239Config config) {
        this.config = config != null ? config : new Idea64239Config();
