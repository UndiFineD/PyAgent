...
@Data
public class Idea64151Config {
    private String name = "idea_064151";
 ...
 */
@Slf4j
public class Idea64151Service {
    private static final int IDEA_ID = 64151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64151Service() {
        this(new Idea64151Config());
    }

    public Idea64151Service(Idea64151Config config) {
        this.config = config != null ? config : new Idea64151Config();
