...
@Data
public class Idea64593Config {
    private String name = "idea_064593";
 ...
 */
@Slf4j
public class Idea64593Service {
    private static final int IDEA_ID = 64593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64593Service() {
        this(new Idea64593Config());
    }

    public Idea64593Service(Idea64593Config config) {
        this.config = config != null ? config : new Idea64593Config();
