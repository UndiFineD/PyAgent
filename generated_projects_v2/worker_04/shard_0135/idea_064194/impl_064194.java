...
@Data
public class Idea64194Config {
    private String name = "idea_064194";
 ...
 */
@Slf4j
public class Idea64194Service {
    private static final int IDEA_ID = 64194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64194Service() {
        this(new Idea64194Config());
    }

    public Idea64194Service(Idea64194Config config) {
        this.config = config != null ? config : new Idea64194Config();
