...
@Data
public class Idea64481Config {
    private String name = "idea_064481";
 ...
 */
@Slf4j
public class Idea64481Service {
    private static final int IDEA_ID = 64481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64481Service() {
        this(new Idea64481Config());
    }

    public Idea64481Service(Idea64481Config config) {
        this.config = config != null ? config : new Idea64481Config();
