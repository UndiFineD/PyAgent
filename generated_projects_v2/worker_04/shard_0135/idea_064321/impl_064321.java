...
@Data
public class Idea64321Config {
    private String name = "idea_064321";
 ...
 */
@Slf4j
public class Idea64321Service {
    private static final int IDEA_ID = 64321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64321Service() {
        this(new Idea64321Config());
    }

    public Idea64321Service(Idea64321Config config) {
        this.config = config != null ? config : new Idea64321Config();
