...
@Data
public class Idea64459Config {
    private String name = "idea_064459";
 ...
 */
@Slf4j
public class Idea64459Service {
    private static final int IDEA_ID = 64459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64459Service() {
        this(new Idea64459Config());
    }

    public Idea64459Service(Idea64459Config config) {
        this.config = config != null ? config : new Idea64459Config();
