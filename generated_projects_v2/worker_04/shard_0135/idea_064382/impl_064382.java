...
@Data
public class Idea64382Config {
    private String name = "idea_064382";
 ...
 */
@Slf4j
public class Idea64382Service {
    private static final int IDEA_ID = 64382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64382Service() {
        this(new Idea64382Config());
    }

    public Idea64382Service(Idea64382Config config) {
        this.config = config != null ? config : new Idea64382Config();
