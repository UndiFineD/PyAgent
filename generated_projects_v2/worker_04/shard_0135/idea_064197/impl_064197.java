...
@Data
public class Idea64197Config {
    private String name = "idea_064197";
 ...
 */
@Slf4j
public class Idea64197Service {
    private static final int IDEA_ID = 64197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64197Service() {
        this(new Idea64197Config());
    }

    public Idea64197Service(Idea64197Config config) {
        this.config = config != null ? config : new Idea64197Config();
