...
@Data
public class Idea64332Config {
    private String name = "idea_064332";
 ...
 */
@Slf4j
public class Idea64332Service {
    private static final int IDEA_ID = 64332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64332Service() {
        this(new Idea64332Config());
    }

    public Idea64332Service(Idea64332Config config) {
        this.config = config != null ? config : new Idea64332Config();
