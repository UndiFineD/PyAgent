...
@Data
public class Idea64256Config {
    private String name = "idea_064256";
 ...
 */
@Slf4j
public class Idea64256Service {
    private static final int IDEA_ID = 64256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64256Service() {
        this(new Idea64256Config());
    }

    public Idea64256Service(Idea64256Config config) {
        this.config = config != null ? config : new Idea64256Config();
