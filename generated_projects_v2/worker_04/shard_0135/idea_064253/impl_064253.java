...
@Data
public class Idea64253Config {
    private String name = "idea_064253";
 ...
 */
@Slf4j
public class Idea64253Service {
    private static final int IDEA_ID = 64253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64253Service() {
        this(new Idea64253Config());
    }

    public Idea64253Service(Idea64253Config config) {
        this.config = config != null ? config : new Idea64253Config();
