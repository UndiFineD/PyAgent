...
@Data
public class Idea64350Config {
    private String name = "idea_064350";
 ...
 */
@Slf4j
public class Idea64350Service {
    private static final int IDEA_ID = 64350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64350Service() {
        this(new Idea64350Config());
    }

    public Idea64350Service(Idea64350Config config) {
        this.config = config != null ? config : new Idea64350Config();
