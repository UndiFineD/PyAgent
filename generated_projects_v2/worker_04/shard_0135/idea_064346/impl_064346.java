...
@Data
public class Idea64346Config {
    private String name = "idea_064346";
 ...
 */
@Slf4j
public class Idea64346Service {
    private static final int IDEA_ID = 64346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64346Service() {
        this(new Idea64346Config());
    }

    public Idea64346Service(Idea64346Config config) {
        this.config = config != null ? config : new Idea64346Config();
