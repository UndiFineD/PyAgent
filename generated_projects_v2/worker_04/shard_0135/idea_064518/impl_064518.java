...
@Data
public class Idea64518Config {
    private String name = "idea_064518";
 ...
 */
@Slf4j
public class Idea64518Service {
    private static final int IDEA_ID = 64518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64518Service() {
        this(new Idea64518Config());
    }

    public Idea64518Service(Idea64518Config config) {
        this.config = config != null ? config : new Idea64518Config();
