...
@Data
public class Idea64135Config {
    private String name = "idea_064135";
 ...
 */
@Slf4j
public class Idea64135Service {
    private static final int IDEA_ID = 64135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64135Service() {
        this(new Idea64135Config());
    }

    public Idea64135Service(Idea64135Config config) {
        this.config = config != null ? config : new Idea64135Config();
