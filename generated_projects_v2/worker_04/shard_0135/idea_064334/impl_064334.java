...
@Data
public class Idea64334Config {
    private String name = "idea_064334";
 ...
 */
@Slf4j
public class Idea64334Service {
    private static final int IDEA_ID = 64334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64334Service() {
        this(new Idea64334Config());
    }

    public Idea64334Service(Idea64334Config config) {
        this.config = config != null ? config : new Idea64334Config();
