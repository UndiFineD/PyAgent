...
@Data
public class Idea64373Config {
    private String name = "idea_064373";
 ...
 */
@Slf4j
public class Idea64373Service {
    private static final int IDEA_ID = 64373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64373Service() {
        this(new Idea64373Config());
    }

    public Idea64373Service(Idea64373Config config) {
        this.config = config != null ? config : new Idea64373Config();
