...
@Data
public class Idea64561Config {
    private String name = "idea_064561";
 ...
 */
@Slf4j
public class Idea64561Service {
    private static final int IDEA_ID = 64561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64561Service() {
        this(new Idea64561Config());
    }

    public Idea64561Service(Idea64561Config config) {
        this.config = config != null ? config : new Idea64561Config();
