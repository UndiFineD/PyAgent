...
@Data
public class Idea64306Config {
    private String name = "idea_064306";
 ...
 */
@Slf4j
public class Idea64306Service {
    private static final int IDEA_ID = 64306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64306Service() {
        this(new Idea64306Config());
    }

    public Idea64306Service(Idea64306Config config) {
        this.config = config != null ? config : new Idea64306Config();
