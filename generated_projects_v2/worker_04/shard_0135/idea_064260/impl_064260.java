...
@Data
public class Idea64260Config {
    private String name = "idea_064260";
 ...
 */
@Slf4j
public class Idea64260Service {
    private static final int IDEA_ID = 64260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64260Service() {
        this(new Idea64260Config());
    }

    public Idea64260Service(Idea64260Config config) {
        this.config = config != null ? config : new Idea64260Config();
