...
@Data
public class Idea64213Config {
    private String name = "idea_064213";
 ...
 */
@Slf4j
public class Idea64213Service {
    private static final int IDEA_ID = 64213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64213Service() {
        this(new Idea64213Config());
    }

    public Idea64213Service(Idea64213Config config) {
        this.config = config != null ? config : new Idea64213Config();
