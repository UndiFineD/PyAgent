...
@Data
public class Idea64572Config {
    private String name = "idea_064572";
 ...
 */
@Slf4j
public class Idea64572Service {
    private static final int IDEA_ID = 64572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64572Service() {
        this(new Idea64572Config());
    }

    public Idea64572Service(Idea64572Config config) {
        this.config = config != null ? config : new Idea64572Config();
