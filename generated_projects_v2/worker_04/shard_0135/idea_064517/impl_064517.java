...
@Data
public class Idea64517Config {
    private String name = "idea_064517";
 ...
 */
@Slf4j
public class Idea64517Service {
    private static final int IDEA_ID = 64517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64517Service() {
        this(new Idea64517Config());
    }

    public Idea64517Service(Idea64517Config config) {
        this.config = config != null ? config : new Idea64517Config();
