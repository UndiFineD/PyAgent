...
@Data
public class Idea64302Config {
    private String name = "idea_064302";
 ...
 */
@Slf4j
public class Idea64302Service {
    private static final int IDEA_ID = 64302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64302Service() {
        this(new Idea64302Config());
    }

    public Idea64302Service(Idea64302Config config) {
        this.config = config != null ? config : new Idea64302Config();
