...
@Data
public class Idea64317Config {
    private String name = "idea_064317";
 ...
 */
@Slf4j
public class Idea64317Service {
    private static final int IDEA_ID = 64317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64317Service() {
        this(new Idea64317Config());
    }

    public Idea64317Service(Idea64317Config config) {
        this.config = config != null ? config : new Idea64317Config();
