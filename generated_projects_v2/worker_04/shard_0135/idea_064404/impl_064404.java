...
@Data
public class Idea64404Config {
    private String name = "idea_064404";
 ...
 */
@Slf4j
public class Idea64404Service {
    private static final int IDEA_ID = 64404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64404Service() {
        this(new Idea64404Config());
    }

    public Idea64404Service(Idea64404Config config) {
        this.config = config != null ? config : new Idea64404Config();
