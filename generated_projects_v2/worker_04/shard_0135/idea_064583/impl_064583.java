...
@Data
public class Idea64583Config {
    private String name = "idea_064583";
 ...
 */
@Slf4j
public class Idea64583Service {
    private static final int IDEA_ID = 64583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64583Service() {
        this(new Idea64583Config());
    }

    public Idea64583Service(Idea64583Config config) {
        this.config = config != null ? config : new Idea64583Config();
