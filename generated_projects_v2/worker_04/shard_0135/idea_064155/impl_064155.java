...
@Data
public class Idea64155Config {
    private String name = "idea_064155";
 ...
 */
@Slf4j
public class Idea64155Service {
    private static final int IDEA_ID = 64155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64155Service() {
        this(new Idea64155Config());
    }

    public Idea64155Service(Idea64155Config config) {
        this.config = config != null ? config : new Idea64155Config();
