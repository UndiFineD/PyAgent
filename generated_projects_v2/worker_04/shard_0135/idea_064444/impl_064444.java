...
@Data
public class Idea64444Config {
    private String name = "idea_064444";
 ...
 */
@Slf4j
public class Idea64444Service {
    private static final int IDEA_ID = 64444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64444Service() {
        this(new Idea64444Config());
    }

    public Idea64444Service(Idea64444Config config) {
        this.config = config != null ? config : new Idea64444Config();
