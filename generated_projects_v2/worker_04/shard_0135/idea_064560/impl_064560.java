...
@Data
public class Idea64560Config {
    private String name = "idea_064560";
 ...
 */
@Slf4j
public class Idea64560Service {
    private static final int IDEA_ID = 64560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64560Service() {
        this(new Idea64560Config());
    }

    public Idea64560Service(Idea64560Config config) {
        this.config = config != null ? config : new Idea64560Config();
