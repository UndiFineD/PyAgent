...
@Data
public class Idea64356Config {
    private String name = "idea_064356";
 ...
 */
@Slf4j
public class Idea64356Service {
    private static final int IDEA_ID = 64356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64356Service() {
        this(new Idea64356Config());
    }

    public Idea64356Service(Idea64356Config config) {
        this.config = config != null ? config : new Idea64356Config();
