...
@Data
public class Idea64491Config {
    private String name = "idea_064491";
 ...
 */
@Slf4j
public class Idea64491Service {
    private static final int IDEA_ID = 64491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64491Service() {
        this(new Idea64491Config());
    }

    public Idea64491Service(Idea64491Config config) {
        this.config = config != null ? config : new Idea64491Config();
