...
@Data
public class Idea64282Config {
    private String name = "idea_064282";
 ...
 */
@Slf4j
public class Idea64282Service {
    private static final int IDEA_ID = 64282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64282Service() {
        this(new Idea64282Config());
    }

    public Idea64282Service(Idea64282Config config) {
        this.config = config != null ? config : new Idea64282Config();
