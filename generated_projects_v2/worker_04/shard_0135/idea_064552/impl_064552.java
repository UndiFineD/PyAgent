...
@Data
public class Idea64552Config {
    private String name = "idea_064552";
 ...
 */
@Slf4j
public class Idea64552Service {
    private static final int IDEA_ID = 64552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64552Service() {
        this(new Idea64552Config());
    }

    public Idea64552Service(Idea64552Config config) {
        this.config = config != null ? config : new Idea64552Config();
