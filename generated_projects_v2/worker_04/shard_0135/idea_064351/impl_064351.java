...
@Data
public class Idea64351Config {
    private String name = "idea_064351";
 ...
 */
@Slf4j
public class Idea64351Service {
    private static final int IDEA_ID = 64351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64351Service() {
        this(new Idea64351Config());
    }

    public Idea64351Service(Idea64351Config config) {
        this.config = config != null ? config : new Idea64351Config();
