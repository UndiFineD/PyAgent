...
@Data
public class Idea64161Config {
    private String name = "idea_064161";
 ...
 */
@Slf4j
public class Idea64161Service {
    private static final int IDEA_ID = 64161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64161Service() {
        this(new Idea64161Config());
    }

    public Idea64161Service(Idea64161Config config) {
        this.config = config != null ? config : new Idea64161Config();
