...
@Data
public class Idea64147Config {
    private String name = "idea_064147";
 ...
 */
@Slf4j
public class Idea64147Service {
    private static final int IDEA_ID = 64147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64147Service() {
        this(new Idea64147Config());
    }

    public Idea64147Service(Idea64147Config config) {
        this.config = config != null ? config : new Idea64147Config();
