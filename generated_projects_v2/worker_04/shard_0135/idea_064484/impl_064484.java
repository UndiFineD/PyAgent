...
@Data
public class Idea64484Config {
    private String name = "idea_064484";
 ...
 */
@Slf4j
public class Idea64484Service {
    private static final int IDEA_ID = 64484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64484Service() {
        this(new Idea64484Config());
    }

    public Idea64484Service(Idea64484Config config) {
        this.config = config != null ? config : new Idea64484Config();
