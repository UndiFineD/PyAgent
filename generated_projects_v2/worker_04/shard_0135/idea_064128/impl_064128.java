...
@Data
public class Idea64128Config {
    private String name = "idea_064128";
 ...
 */
@Slf4j
public class Idea64128Service {
    private static final int IDEA_ID = 64128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64128Service() {
        this(new Idea64128Config());
    }

    public Idea64128Service(Idea64128Config config) {
        this.config = config != null ? config : new Idea64128Config();
