...
@Data
public class Idea64344Config {
    private String name = "idea_064344";
 ...
 */
@Slf4j
public class Idea64344Service {
    private static final int IDEA_ID = 64344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64344Service() {
        this(new Idea64344Config());
    }

    public Idea64344Service(Idea64344Config config) {
        this.config = config != null ? config : new Idea64344Config();
