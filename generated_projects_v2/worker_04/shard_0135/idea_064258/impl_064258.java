...
@Data
public class Idea64258Config {
    private String name = "idea_064258";
 ...
 */
@Slf4j
public class Idea64258Service {
    private static final int IDEA_ID = 64258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64258Service() {
        this(new Idea64258Config());
    }

    public Idea64258Service(Idea64258Config config) {
        this.config = config != null ? config : new Idea64258Config();
