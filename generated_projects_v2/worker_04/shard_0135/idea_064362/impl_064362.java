...
@Data
public class Idea64362Config {
    private String name = "idea_064362";
 ...
 */
@Slf4j
public class Idea64362Service {
    private static final int IDEA_ID = 64362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64362Service() {
        this(new Idea64362Config());
    }

    public Idea64362Service(Idea64362Config config) {
        this.config = config != null ? config : new Idea64362Config();
