...
@Data
public class Idea64479Config {
    private String name = "idea_064479";
 ...
 */
@Slf4j
public class Idea64479Service {
    private static final int IDEA_ID = 64479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64479Service() {
        this(new Idea64479Config());
    }

    public Idea64479Service(Idea64479Config config) {
        this.config = config != null ? config : new Idea64479Config();
