...
@Data
public class Idea64255Config {
    private String name = "idea_064255";
 ...
 */
@Slf4j
public class Idea64255Service {
    private static final int IDEA_ID = 64255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64255Service() {
        this(new Idea64255Config());
    }

    public Idea64255Service(Idea64255Config config) {
        this.config = config != null ? config : new Idea64255Config();
