...
@Data
public class Idea64512Config {
    private String name = "idea_064512";
 ...
 */
@Slf4j
public class Idea64512Service {
    private static final int IDEA_ID = 64512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64512Service() {
        this(new Idea64512Config());
    }

    public Idea64512Service(Idea64512Config config) {
        this.config = config != null ? config : new Idea64512Config();
