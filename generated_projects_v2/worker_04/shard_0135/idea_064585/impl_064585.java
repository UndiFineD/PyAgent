...
@Data
public class Idea64585Config {
    private String name = "idea_064585";
 ...
 */
@Slf4j
public class Idea64585Service {
    private static final int IDEA_ID = 64585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64585Service() {
        this(new Idea64585Config());
    }

    public Idea64585Service(Idea64585Config config) {
        this.config = config != null ? config : new Idea64585Config();
