...
@Data
public class Idea64318Config {
    private String name = "idea_064318";
 ...
 */
@Slf4j
public class Idea64318Service {
    private static final int IDEA_ID = 64318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64318Service() {
        this(new Idea64318Config());
    }

    public Idea64318Service(Idea64318Config config) {
        this.config = config != null ? config : new Idea64318Config();
