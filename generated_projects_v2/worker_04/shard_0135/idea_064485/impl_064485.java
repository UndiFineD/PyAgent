...
@Data
public class Idea64485Config {
    private String name = "idea_064485";
 ...
 */
@Slf4j
public class Idea64485Service {
    private static final int IDEA_ID = 64485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64485Service() {
        this(new Idea64485Config());
    }

    public Idea64485Service(Idea64485Config config) {
        this.config = config != null ? config : new Idea64485Config();
