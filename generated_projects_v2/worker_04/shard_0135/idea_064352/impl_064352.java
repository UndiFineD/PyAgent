...
@Data
public class Idea64352Config {
    private String name = "idea_064352";
 ...
 */
@Slf4j
public class Idea64352Service {
    private static final int IDEA_ID = 64352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64352Service() {
        this(new Idea64352Config());
    }

    public Idea64352Service(Idea64352Config config) {
        this.config = config != null ? config : new Idea64352Config();
