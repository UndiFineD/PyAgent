...
@Data
public class Idea64359Config {
    private String name = "idea_064359";
 ...
 */
@Slf4j
public class Idea64359Service {
    private static final int IDEA_ID = 64359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64359Service() {
        this(new Idea64359Config());
    }

    public Idea64359Service(Idea64359Config config) {
        this.config = config != null ? config : new Idea64359Config();
