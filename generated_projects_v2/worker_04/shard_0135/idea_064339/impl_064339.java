...
@Data
public class Idea64339Config {
    private String name = "idea_064339";
 ...
 */
@Slf4j
public class Idea64339Service {
    private static final int IDEA_ID = 64339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64339Service() {
        this(new Idea64339Config());
    }

    public Idea64339Service(Idea64339Config config) {
        this.config = config != null ? config : new Idea64339Config();
