...
@Data
public class Idea64412Config {
    private String name = "idea_064412";
 ...
 */
@Slf4j
public class Idea64412Service {
    private static final int IDEA_ID = 64412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64412Service() {
        this(new Idea64412Config());
    }

    public Idea64412Service(Idea64412Config config) {
        this.config = config != null ? config : new Idea64412Config();
