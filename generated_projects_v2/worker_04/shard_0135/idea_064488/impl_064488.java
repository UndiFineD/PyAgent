...
@Data
public class Idea64488Config {
    private String name = "idea_064488";
 ...
 */
@Slf4j
public class Idea64488Service {
    private static final int IDEA_ID = 64488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64488Service() {
        this(new Idea64488Config());
    }

    public Idea64488Service(Idea64488Config config) {
        this.config = config != null ? config : new Idea64488Config();
