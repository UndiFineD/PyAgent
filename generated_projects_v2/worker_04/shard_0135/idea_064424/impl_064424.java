...
@Data
public class Idea64424Config {
    private String name = "idea_064424";
 ...
 */
@Slf4j
public class Idea64424Service {
    private static final int IDEA_ID = 64424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64424Service() {
        this(new Idea64424Config());
    }

    public Idea64424Service(Idea64424Config config) {
        this.config = config != null ? config : new Idea64424Config();
