...
@Data
public class Idea64296Config {
    private String name = "idea_064296";
 ...
 */
@Slf4j
public class Idea64296Service {
    private static final int IDEA_ID = 64296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64296Service() {
        this(new Idea64296Config());
    }

    public Idea64296Service(Idea64296Config config) {
        this.config = config != null ? config : new Idea64296Config();
