...
@Data
public class Idea64401Config {
    private String name = "idea_064401";
 ...
 */
@Slf4j
public class Idea64401Service {
    private static final int IDEA_ID = 64401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64401Service() {
        this(new Idea64401Config());
    }

    public Idea64401Service(Idea64401Config config) {
        this.config = config != null ? config : new Idea64401Config();
