...
@Data
public class Idea64323Config {
    private String name = "idea_064323";
 ...
 */
@Slf4j
public class Idea64323Service {
    private static final int IDEA_ID = 64323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64323Service() {
        this(new Idea64323Config());
    }

    public Idea64323Service(Idea64323Config config) {
        this.config = config != null ? config : new Idea64323Config();
