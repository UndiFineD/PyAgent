...
@Data
public class Idea64291Config {
    private String name = "idea_064291";
 ...
 */
@Slf4j
public class Idea64291Service {
    private static final int IDEA_ID = 64291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64291Service() {
        this(new Idea64291Config());
    }

    public Idea64291Service(Idea64291Config config) {
        this.config = config != null ? config : new Idea64291Config();
