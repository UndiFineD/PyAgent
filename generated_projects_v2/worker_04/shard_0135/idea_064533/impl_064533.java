...
@Data
public class Idea64533Config {
    private String name = "idea_064533";
 ...
 */
@Slf4j
public class Idea64533Service {
    private static final int IDEA_ID = 64533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64533Service() {
        this(new Idea64533Config());
    }

    public Idea64533Service(Idea64533Config config) {
        this.config = config != null ? config : new Idea64533Config();
