...
@Data
public class Idea64274Config {
    private String name = "idea_064274";
 ...
 */
@Slf4j
public class Idea64274Service {
    private static final int IDEA_ID = 64274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64274Service() {
        this(new Idea64274Config());
    }

    public Idea64274Service(Idea64274Config config) {
        this.config = config != null ? config : new Idea64274Config();
