...
@Data
public class Idea64435Config {
    private String name = "idea_064435";
 ...
 */
@Slf4j
public class Idea64435Service {
    private static final int IDEA_ID = 64435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64435Service() {
        this(new Idea64435Config());
    }

    public Idea64435Service(Idea64435Config config) {
        this.config = config != null ? config : new Idea64435Config();
