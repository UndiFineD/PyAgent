...
@Data
public class Idea64548Config {
    private String name = "idea_064548";
 ...
 */
@Slf4j
public class Idea64548Service {
    private static final int IDEA_ID = 64548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64548Service() {
        this(new Idea64548Config());
    }

    public Idea64548Service(Idea64548Config config) {
        this.config = config != null ? config : new Idea64548Config();
