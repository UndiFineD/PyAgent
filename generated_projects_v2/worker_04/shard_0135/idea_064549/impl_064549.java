...
@Data
public class Idea64549Config {
    private String name = "idea_064549";
 ...
 */
@Slf4j
public class Idea64549Service {
    private static final int IDEA_ID = 64549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64549Service() {
        this(new Idea64549Config());
    }

    public Idea64549Service(Idea64549Config config) {
        this.config = config != null ? config : new Idea64549Config();
