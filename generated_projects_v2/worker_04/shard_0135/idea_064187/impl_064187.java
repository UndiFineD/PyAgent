...
@Data
public class Idea64187Config {
    private String name = "idea_064187";
 ...
 */
@Slf4j
public class Idea64187Service {
    private static final int IDEA_ID = 64187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64187Service() {
        this(new Idea64187Config());
    }

    public Idea64187Service(Idea64187Config config) {
        this.config = config != null ? config : new Idea64187Config();
