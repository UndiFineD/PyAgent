...
@Data
public class Idea64553Config {
    private String name = "idea_064553";
 ...
 */
@Slf4j
public class Idea64553Service {
    private static final int IDEA_ID = 64553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64553Service() {
        this(new Idea64553Config());
    }

    public Idea64553Service(Idea64553Config config) {
        this.config = config != null ? config : new Idea64553Config();
