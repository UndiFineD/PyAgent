...
@Data
public class Idea64423Config {
    private String name = "idea_064423";
 ...
 */
@Slf4j
public class Idea64423Service {
    private static final int IDEA_ID = 64423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64423Service() {
        this(new Idea64423Config());
    }

    public Idea64423Service(Idea64423Config config) {
        this.config = config != null ? config : new Idea64423Config();
