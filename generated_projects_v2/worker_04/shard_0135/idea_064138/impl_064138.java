...
@Data
public class Idea64138Config {
    private String name = "idea_064138";
 ...
 */
@Slf4j
public class Idea64138Service {
    private static final int IDEA_ID = 64138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64138Service() {
        this(new Idea64138Config());
    }

    public Idea64138Service(Idea64138Config config) {
        this.config = config != null ? config : new Idea64138Config();
