...
@Data
public class Idea64226Config {
    private String name = "idea_064226";
 ...
 */
@Slf4j
public class Idea64226Service {
    private static final int IDEA_ID = 64226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64226Service() {
        this(new Idea64226Config());
    }

    public Idea64226Service(Idea64226Config config) {
        this.config = config != null ? config : new Idea64226Config();
