...
@Data
public class Idea64149Config {
    private String name = "idea_064149";
 ...
 */
@Slf4j
public class Idea64149Service {
    private static final int IDEA_ID = 64149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64149Service() {
        this(new Idea64149Config());
    }

    public Idea64149Service(Idea64149Config config) {
        this.config = config != null ? config : new Idea64149Config();
