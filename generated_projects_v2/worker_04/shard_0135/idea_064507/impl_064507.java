...
@Data
public class Idea64507Config {
    private String name = "idea_064507";
 ...
 */
@Slf4j
public class Idea64507Service {
    private static final int IDEA_ID = 64507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64507Service() {
        this(new Idea64507Config());
    }

    public Idea64507Service(Idea64507Config config) {
        this.config = config != null ? config : new Idea64507Config();
