...
@Data
public class Idea64294Config {
    private String name = "idea_064294";
 ...
 */
@Slf4j
public class Idea64294Service {
    private static final int IDEA_ID = 64294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64294Service() {
        this(new Idea64294Config());
    }

    public Idea64294Service(Idea64294Config config) {
        this.config = config != null ? config : new Idea64294Config();
