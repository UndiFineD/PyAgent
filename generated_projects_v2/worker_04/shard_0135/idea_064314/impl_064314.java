...
@Data
public class Idea64314Config {
    private String name = "idea_064314";
 ...
 */
@Slf4j
public class Idea64314Service {
    private static final int IDEA_ID = 64314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64314Service() {
        this(new Idea64314Config());
    }

    public Idea64314Service(Idea64314Config config) {
        this.config = config != null ? config : new Idea64314Config();
