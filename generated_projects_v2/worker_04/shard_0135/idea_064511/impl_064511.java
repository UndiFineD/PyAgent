...
@Data
public class Idea64511Config {
    private String name = "idea_064511";
 ...
 */
@Slf4j
public class Idea64511Service {
    private static final int IDEA_ID = 64511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64511Service() {
        this(new Idea64511Config());
    }

    public Idea64511Service(Idea64511Config config) {
        this.config = config != null ? config : new Idea64511Config();
