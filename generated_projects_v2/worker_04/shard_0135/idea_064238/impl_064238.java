...
@Data
public class Idea64238Config {
    private String name = "idea_064238";
 ...
 */
@Slf4j
public class Idea64238Service {
    private static final int IDEA_ID = 64238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64238Service() {
        this(new Idea64238Config());
    }

    public Idea64238Service(Idea64238Config config) {
        this.config = config != null ? config : new Idea64238Config();
