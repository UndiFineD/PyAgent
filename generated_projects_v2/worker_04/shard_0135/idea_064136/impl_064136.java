...
@Data
public class Idea64136Config {
    private String name = "idea_064136";
 ...
 */
@Slf4j
public class Idea64136Service {
    private static final int IDEA_ID = 64136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64136Service() {
        this(new Idea64136Config());
    }

    public Idea64136Service(Idea64136Config config) {
        this.config = config != null ? config : new Idea64136Config();
