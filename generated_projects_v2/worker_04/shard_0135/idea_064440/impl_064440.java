...
@Data
public class Idea64440Config {
    private String name = "idea_064440";
 ...
 */
@Slf4j
public class Idea64440Service {
    private static final int IDEA_ID = 64440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64440Service() {
        this(new Idea64440Config());
    }

    public Idea64440Service(Idea64440Config config) {
        this.config = config != null ? config : new Idea64440Config();
