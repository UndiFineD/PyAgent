...
@Data
public class Idea64309Config {
    private String name = "idea_064309";
 ...
 */
@Slf4j
public class Idea64309Service {
    private static final int IDEA_ID = 64309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64309Service() {
        this(new Idea64309Config());
    }

    public Idea64309Service(Idea64309Config config) {
        this.config = config != null ? config : new Idea64309Config();
