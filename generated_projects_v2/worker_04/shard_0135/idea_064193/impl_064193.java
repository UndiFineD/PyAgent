...
@Data
public class Idea64193Config {
    private String name = "idea_064193";
 ...
 */
@Slf4j
public class Idea64193Service {
    private static final int IDEA_ID = 64193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64193Service() {
        this(new Idea64193Config());
    }

    public Idea64193Service(Idea64193Config config) {
        this.config = config != null ? config : new Idea64193Config();
