...
@Data
public class Idea64133Config {
    private String name = "idea_064133";
 ...
 */
@Slf4j
public class Idea64133Service {
    private static final int IDEA_ID = 64133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64133Service() {
        this(new Idea64133Config());
    }

    public Idea64133Service(Idea64133Config config) {
        this.config = config != null ? config : new Idea64133Config();
