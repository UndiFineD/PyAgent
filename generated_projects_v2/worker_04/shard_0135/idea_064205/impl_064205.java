...
@Data
public class Idea64205Config {
    private String name = "idea_064205";
 ...
 */
@Slf4j
public class Idea64205Service {
    private static final int IDEA_ID = 64205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64205Service() {
        this(new Idea64205Config());
    }

    public Idea64205Service(Idea64205Config config) {
        this.config = config != null ? config : new Idea64205Config();
