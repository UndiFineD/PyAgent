...
@Data
public class Idea64233Config {
    private String name = "idea_064233";
 ...
 */
@Slf4j
public class Idea64233Service {
    private static final int IDEA_ID = 64233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64233Service() {
        this(new Idea64233Config());
    }

    public Idea64233Service(Idea64233Config config) {
        this.config = config != null ? config : new Idea64233Config();
