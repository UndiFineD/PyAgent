...
@Data
public class Idea64581Config {
    private String name = "idea_064581";
 ...
 */
@Slf4j
public class Idea64581Service {
    private static final int IDEA_ID = 64581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64581Service() {
        this(new Idea64581Config());
    }

    public Idea64581Service(Idea64581Config config) {
        this.config = config != null ? config : new Idea64581Config();
