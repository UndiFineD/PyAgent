...
@Data
public class Idea64499Config {
    private String name = "idea_064499";
 ...
 */
@Slf4j
public class Idea64499Service {
    private static final int IDEA_ID = 64499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64499Service() {
        this(new Idea64499Config());
    }

    public Idea64499Service(Idea64499Config config) {
        this.config = config != null ? config : new Idea64499Config();
