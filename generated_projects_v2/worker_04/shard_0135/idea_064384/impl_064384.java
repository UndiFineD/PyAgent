...
@Data
public class Idea64384Config {
    private String name = "idea_064384";
 ...
 */
@Slf4j
public class Idea64384Service {
    private static final int IDEA_ID = 64384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64384Service() {
        this(new Idea64384Config());
    }

    public Idea64384Service(Idea64384Config config) {
        this.config = config != null ? config : new Idea64384Config();
