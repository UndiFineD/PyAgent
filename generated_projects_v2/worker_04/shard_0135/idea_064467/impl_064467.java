...
@Data
public class Idea64467Config {
    private String name = "idea_064467";
 ...
 */
@Slf4j
public class Idea64467Service {
    private static final int IDEA_ID = 64467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64467Service() {
        this(new Idea64467Config());
    }

    public Idea64467Service(Idea64467Config config) {
        this.config = config != null ? config : new Idea64467Config();
