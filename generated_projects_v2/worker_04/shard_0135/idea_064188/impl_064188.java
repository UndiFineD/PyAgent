...
@Data
public class Idea64188Config {
    private String name = "idea_064188";
 ...
 */
@Slf4j
public class Idea64188Service {
    private static final int IDEA_ID = 64188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64188Service() {
        this(new Idea64188Config());
    }

    public Idea64188Service(Idea64188Config config) {
        this.config = config != null ? config : new Idea64188Config();
