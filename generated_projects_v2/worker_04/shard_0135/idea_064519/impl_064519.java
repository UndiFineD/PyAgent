...
@Data
public class Idea64519Config {
    private String name = "idea_064519";
 ...
 */
@Slf4j
public class Idea64519Service {
    private static final int IDEA_ID = 64519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64519Service() {
        this(new Idea64519Config());
    }

    public Idea64519Service(Idea64519Config config) {
        this.config = config != null ? config : new Idea64519Config();
