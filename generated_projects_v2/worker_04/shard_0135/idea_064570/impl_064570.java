...
@Data
public class Idea64570Config {
    private String name = "idea_064570";
 ...
 */
@Slf4j
public class Idea64570Service {
    private static final int IDEA_ID = 64570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64570Service() {
        this(new Idea64570Config());
    }

    public Idea64570Service(Idea64570Config config) {
        this.config = config != null ? config : new Idea64570Config();
