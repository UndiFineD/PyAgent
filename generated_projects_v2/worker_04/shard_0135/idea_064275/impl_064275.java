...
@Data
public class Idea64275Config {
    private String name = "idea_064275";
 ...
 */
@Slf4j
public class Idea64275Service {
    private static final int IDEA_ID = 64275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64275Service() {
        this(new Idea64275Config());
    }

    public Idea64275Service(Idea64275Config config) {
        this.config = config != null ? config : new Idea64275Config();
