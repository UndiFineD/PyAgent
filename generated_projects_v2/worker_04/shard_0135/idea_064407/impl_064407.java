...
@Data
public class Idea64407Config {
    private String name = "idea_064407";
 ...
 */
@Slf4j
public class Idea64407Service {
    private static final int IDEA_ID = 64407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64407Service() {
        this(new Idea64407Config());
    }

    public Idea64407Service(Idea64407Config config) {
        this.config = config != null ? config : new Idea64407Config();
