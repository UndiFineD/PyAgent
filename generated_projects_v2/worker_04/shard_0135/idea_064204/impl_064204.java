...
@Data
public class Idea64204Config {
    private String name = "idea_064204";
 ...
 */
@Slf4j
public class Idea64204Service {
    private static final int IDEA_ID = 64204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64204Service() {
        this(new Idea64204Config());
    }

    public Idea64204Service(Idea64204Config config) {
        this.config = config != null ? config : new Idea64204Config();
