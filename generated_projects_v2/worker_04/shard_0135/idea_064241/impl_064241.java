...
@Data
public class Idea64241Config {
    private String name = "idea_064241";
 ...
 */
@Slf4j
public class Idea64241Service {
    private static final int IDEA_ID = 64241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64241Service() {
        this(new Idea64241Config());
    }

    public Idea64241Service(Idea64241Config config) {
        this.config = config != null ? config : new Idea64241Config();
