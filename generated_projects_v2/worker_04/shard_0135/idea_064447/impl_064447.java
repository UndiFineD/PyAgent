...
@Data
public class Idea64447Config {
    private String name = "idea_064447";
 ...
 */
@Slf4j
public class Idea64447Service {
    private static final int IDEA_ID = 64447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64447Service() {
        this(new Idea64447Config());
    }

    public Idea64447Service(Idea64447Config config) {
        this.config = config != null ? config : new Idea64447Config();
