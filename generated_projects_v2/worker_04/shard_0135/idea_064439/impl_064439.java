...
@Data
public class Idea64439Config {
    private String name = "idea_064439";
 ...
 */
@Slf4j
public class Idea64439Service {
    private static final int IDEA_ID = 64439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64439Service() {
        this(new Idea64439Config());
    }

    public Idea64439Service(Idea64439Config config) {
        this.config = config != null ? config : new Idea64439Config();
