...
@Data
public class Idea64295Config {
    private String name = "idea_064295";
 ...
 */
@Slf4j
public class Idea64295Service {
    private static final int IDEA_ID = 64295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64295Service() {
        this(new Idea64295Config());
    }

    public Idea64295Service(Idea64295Config config) {
        this.config = config != null ? config : new Idea64295Config();
