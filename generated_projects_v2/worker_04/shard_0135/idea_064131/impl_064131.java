...
@Data
public class Idea64131Config {
    private String name = "idea_064131";
 ...
 */
@Slf4j
public class Idea64131Service {
    private static final int IDEA_ID = 64131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64131Service() {
        this(new Idea64131Config());
    }

    public Idea64131Service(Idea64131Config config) {
        this.config = config != null ? config : new Idea64131Config();
