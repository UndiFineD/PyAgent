...
@Data
public class Idea64371Config {
    private String name = "idea_064371";
 ...
 */
@Slf4j
public class Idea64371Service {
    private static final int IDEA_ID = 64371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64371Service() {
        this(new Idea64371Config());
    }

    public Idea64371Service(Idea64371Config config) {
        this.config = config != null ? config : new Idea64371Config();
