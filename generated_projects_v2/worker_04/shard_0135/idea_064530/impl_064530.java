...
@Data
public class Idea64530Config {
    private String name = "idea_064530";
 ...
 */
@Slf4j
public class Idea64530Service {
    private static final int IDEA_ID = 64530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64530Service() {
        this(new Idea64530Config());
    }

    public Idea64530Service(Idea64530Config config) {
        this.config = config != null ? config : new Idea64530Config();
