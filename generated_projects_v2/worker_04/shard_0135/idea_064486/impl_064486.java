...
@Data
public class Idea64486Config {
    private String name = "idea_064486";
 ...
 */
@Slf4j
public class Idea64486Service {
    private static final int IDEA_ID = 64486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64486Service() {
        this(new Idea64486Config());
    }

    public Idea64486Service(Idea64486Config config) {
        this.config = config != null ? config : new Idea64486Config();
