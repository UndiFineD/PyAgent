...
@Data
public class Idea64463Config {
    private String name = "idea_064463";
 ...
 */
@Slf4j
public class Idea64463Service {
    private static final int IDEA_ID = 64463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64463Service() {
        this(new Idea64463Config());
    }

    public Idea64463Service(Idea64463Config config) {
        this.config = config != null ? config : new Idea64463Config();
