...
@Data
public class Idea64504Config {
    private String name = "idea_064504";
 ...
 */
@Slf4j
public class Idea64504Service {
    private static final int IDEA_ID = 64504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64504Service() {
        this(new Idea64504Config());
    }

    public Idea64504Service(Idea64504Config config) {
        this.config = config != null ? config : new Idea64504Config();
