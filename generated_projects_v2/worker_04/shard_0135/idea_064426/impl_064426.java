...
@Data
public class Idea64426Config {
    private String name = "idea_064426";
 ...
 */
@Slf4j
public class Idea64426Service {
    private static final int IDEA_ID = 64426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64426Service() {
        this(new Idea64426Config());
    }

    public Idea64426Service(Idea64426Config config) {
        this.config = config != null ? config : new Idea64426Config();
