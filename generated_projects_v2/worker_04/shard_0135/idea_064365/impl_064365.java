...
@Data
public class Idea64365Config {
    private String name = "idea_064365";
 ...
 */
@Slf4j
public class Idea64365Service {
    private static final int IDEA_ID = 64365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64365Service() {
        this(new Idea64365Config());
    }

    public Idea64365Service(Idea64365Config config) {
        this.config = config != null ? config : new Idea64365Config();
