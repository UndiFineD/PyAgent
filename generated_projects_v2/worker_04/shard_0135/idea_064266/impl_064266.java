...
@Data
public class Idea64266Config {
    private String name = "idea_064266";
 ...
 */
@Slf4j
public class Idea64266Service {
    private static final int IDEA_ID = 64266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64266Service() {
        this(new Idea64266Config());
    }

    public Idea64266Service(Idea64266Config config) {
        this.config = config != null ? config : new Idea64266Config();
