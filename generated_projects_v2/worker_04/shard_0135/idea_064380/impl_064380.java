...
@Data
public class Idea64380Config {
    private String name = "idea_064380";
 ...
 */
@Slf4j
public class Idea64380Service {
    private static final int IDEA_ID = 64380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64380Service() {
        this(new Idea64380Config());
    }

    public Idea64380Service(Idea64380Config config) {
        this.config = config != null ? config : new Idea64380Config();
