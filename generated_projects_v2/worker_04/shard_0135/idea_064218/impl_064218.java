...
@Data
public class Idea64218Config {
    private String name = "idea_064218";
 ...
 */
@Slf4j
public class Idea64218Service {
    private static final int IDEA_ID = 64218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64218Service() {
        this(new Idea64218Config());
    }

    public Idea64218Service(Idea64218Config config) {
        this.config = config != null ? config : new Idea64218Config();
