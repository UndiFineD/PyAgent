...
@Data
public class Idea64297Config {
    private String name = "idea_064297";
 ...
 */
@Slf4j
public class Idea64297Service {
    private static final int IDEA_ID = 64297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64297Service() {
        this(new Idea64297Config());
    }

    public Idea64297Service(Idea64297Config config) {
        this.config = config != null ? config : new Idea64297Config();
