...
@Data
public class Idea64176Config {
    private String name = "idea_064176";
 ...
 */
@Slf4j
public class Idea64176Service {
    private static final int IDEA_ID = 64176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64176Service() {
        this(new Idea64176Config());
    }

    public Idea64176Service(Idea64176Config config) {
        this.config = config != null ? config : new Idea64176Config();
