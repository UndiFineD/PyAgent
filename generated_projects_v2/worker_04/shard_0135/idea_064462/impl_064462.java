...
@Data
public class Idea64462Config {
    private String name = "idea_064462";
 ...
 */
@Slf4j
public class Idea64462Service {
    private static final int IDEA_ID = 64462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64462Service() {
        this(new Idea64462Config());
    }

    public Idea64462Service(Idea64462Config config) {
        this.config = config != null ? config : new Idea64462Config();
