...
@Data
public class Idea64379Config {
    private String name = "idea_064379";
 ...
 */
@Slf4j
public class Idea64379Service {
    private static final int IDEA_ID = 64379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64379Service() {
        this(new Idea64379Config());
    }

    public Idea64379Service(Idea64379Config config) {
        this.config = config != null ? config : new Idea64379Config();
