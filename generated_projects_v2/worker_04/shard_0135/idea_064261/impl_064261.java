...
@Data
public class Idea64261Config {
    private String name = "idea_064261";
 ...
 */
@Slf4j
public class Idea64261Service {
    private static final int IDEA_ID = 64261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64261Service() {
        this(new Idea64261Config());
    }

    public Idea64261Service(Idea64261Config config) {
        this.config = config != null ? config : new Idea64261Config();
