...
@Data
public class Idea64368Config {
    private String name = "idea_064368";
 ...
 */
@Slf4j
public class Idea64368Service {
    private static final int IDEA_ID = 64368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64368Service() {
        this(new Idea64368Config());
    }

    public Idea64368Service(Idea64368Config config) {
        this.config = config != null ? config : new Idea64368Config();
