...
@Data
public class Idea64271Config {
    private String name = "idea_064271";
 ...
 */
@Slf4j
public class Idea64271Service {
    private static final int IDEA_ID = 64271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64271Service() {
        this(new Idea64271Config());
    }

    public Idea64271Service(Idea64271Config config) {
        this.config = config != null ? config : new Idea64271Config();
