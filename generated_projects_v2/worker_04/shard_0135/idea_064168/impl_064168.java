...
@Data
public class Idea64168Config {
    private String name = "idea_064168";
 ...
 */
@Slf4j
public class Idea64168Service {
    private static final int IDEA_ID = 64168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64168Service() {
        this(new Idea64168Config());
    }

    public Idea64168Service(Idea64168Config config) {
        this.config = config != null ? config : new Idea64168Config();
