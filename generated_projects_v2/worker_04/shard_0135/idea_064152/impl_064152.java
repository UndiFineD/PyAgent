...
@Data
public class Idea64152Config {
    private String name = "idea_064152";
 ...
 */
@Slf4j
public class Idea64152Service {
    private static final int IDEA_ID = 64152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64152Service() {
        this(new Idea64152Config());
    }

    public Idea64152Service(Idea64152Config config) {
        this.config = config != null ? config : new Idea64152Config();
