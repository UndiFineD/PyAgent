...
@Data
public class Idea64575Config {
    private String name = "idea_064575";
 ...
 */
@Slf4j
public class Idea64575Service {
    private static final int IDEA_ID = 64575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64575Service() {
        this(new Idea64575Config());
    }

    public Idea64575Service(Idea64575Config config) {
        this.config = config != null ? config : new Idea64575Config();
