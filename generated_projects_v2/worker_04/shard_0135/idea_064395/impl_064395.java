...
@Data
public class Idea64395Config {
    private String name = "idea_064395";
 ...
 */
@Slf4j
public class Idea64395Service {
    private static final int IDEA_ID = 64395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64395Service() {
        this(new Idea64395Config());
    }

    public Idea64395Service(Idea64395Config config) {
        this.config = config != null ? config : new Idea64395Config();
