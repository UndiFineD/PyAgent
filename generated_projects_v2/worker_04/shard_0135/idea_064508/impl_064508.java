...
@Data
public class Idea64508Config {
    private String name = "idea_064508";
 ...
 */
@Slf4j
public class Idea64508Service {
    private static final int IDEA_ID = 64508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64508Service() {
        this(new Idea64508Config());
    }

    public Idea64508Service(Idea64508Config config) {
        this.config = config != null ? config : new Idea64508Config();
