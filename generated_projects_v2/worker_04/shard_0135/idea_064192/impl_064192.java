...
@Data
public class Idea64192Config {
    private String name = "idea_064192";
 ...
 */
@Slf4j
public class Idea64192Service {
    private static final int IDEA_ID = 64192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64192Service() {
        this(new Idea64192Config());
    }

    public Idea64192Service(Idea64192Config config) {
        this.config = config != null ? config : new Idea64192Config();
