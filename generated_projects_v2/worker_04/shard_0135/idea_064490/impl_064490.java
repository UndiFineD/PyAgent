...
@Data
public class Idea64490Config {
    private String name = "idea_064490";
 ...
 */
@Slf4j
public class Idea64490Service {
    private static final int IDEA_ID = 64490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64490Service() {
        this(new Idea64490Config());
    }

    public Idea64490Service(Idea64490Config config) {
        this.config = config != null ? config : new Idea64490Config();
