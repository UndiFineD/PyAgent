...
@Data
public class Idea64212Config {
    private String name = "idea_064212";
 ...
 */
@Slf4j
public class Idea64212Service {
    private static final int IDEA_ID = 64212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64212Service() {
        this(new Idea64212Config());
    }

    public Idea64212Service(Idea64212Config config) {
        this.config = config != null ? config : new Idea64212Config();
