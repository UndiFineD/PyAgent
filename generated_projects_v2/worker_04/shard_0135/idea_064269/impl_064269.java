...
@Data
public class Idea64269Config {
    private String name = "idea_064269";
 ...
 */
@Slf4j
public class Idea64269Service {
    private static final int IDEA_ID = 64269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64269Service() {
        this(new Idea64269Config());
    }

    public Idea64269Service(Idea64269Config config) {
        this.config = config != null ? config : new Idea64269Config();
