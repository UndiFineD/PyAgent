...
@Data
public class Idea64476Config {
    private String name = "idea_064476";
 ...
 */
@Slf4j
public class Idea64476Service {
    private static final int IDEA_ID = 64476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64476Service() {
        this(new Idea64476Config());
    }

    public Idea64476Service(Idea64476Config config) {
        this.config = config != null ? config : new Idea64476Config();
