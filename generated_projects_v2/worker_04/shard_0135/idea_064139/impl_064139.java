...
@Data
public class Idea64139Config {
    private String name = "idea_064139";
 ...
 */
@Slf4j
public class Idea64139Service {
    private static final int IDEA_ID = 64139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64139Service() {
        this(new Idea64139Config());
    }

    public Idea64139Service(Idea64139Config config) {
        this.config = config != null ? config : new Idea64139Config();
