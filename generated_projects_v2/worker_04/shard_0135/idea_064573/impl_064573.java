...
@Data
public class Idea64573Config {
    private String name = "idea_064573";
 ...
 */
@Slf4j
public class Idea64573Service {
    private static final int IDEA_ID = 64573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64573Service() {
        this(new Idea64573Config());
    }

    public Idea64573Service(Idea64573Config config) {
        this.config = config != null ? config : new Idea64573Config();
