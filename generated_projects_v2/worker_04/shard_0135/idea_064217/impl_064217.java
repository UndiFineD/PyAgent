...
@Data
public class Idea64217Config {
    private String name = "idea_064217";
 ...
 */
@Slf4j
public class Idea64217Service {
    private static final int IDEA_ID = 64217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64217Service() {
        this(new Idea64217Config());
    }

    public Idea64217Service(Idea64217Config config) {
        this.config = config != null ? config : new Idea64217Config();
