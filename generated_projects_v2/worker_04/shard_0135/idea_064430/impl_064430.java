...
@Data
public class Idea64430Config {
    private String name = "idea_064430";
 ...
 */
@Slf4j
public class Idea64430Service {
    private static final int IDEA_ID = 64430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64430Service() {
        this(new Idea64430Config());
    }

    public Idea64430Service(Idea64430Config config) {
        this.config = config != null ? config : new Idea64430Config();
