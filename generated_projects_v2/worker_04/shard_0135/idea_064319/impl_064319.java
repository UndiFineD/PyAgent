...
@Data
public class Idea64319Config {
    private String name = "idea_064319";
 ...
 */
@Slf4j
public class Idea64319Service {
    private static final int IDEA_ID = 64319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64319Service() {
        this(new Idea64319Config());
    }

    public Idea64319Service(Idea64319Config config) {
        this.config = config != null ? config : new Idea64319Config();
