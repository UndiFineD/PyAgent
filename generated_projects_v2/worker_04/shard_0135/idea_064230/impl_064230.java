...
@Data
public class Idea64230Config {
    private String name = "idea_064230";
 ...
 */
@Slf4j
public class Idea64230Service {
    private static final int IDEA_ID = 64230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64230Service() {
        this(new Idea64230Config());
    }

    public Idea64230Service(Idea64230Config config) {
        this.config = config != null ? config : new Idea64230Config();
