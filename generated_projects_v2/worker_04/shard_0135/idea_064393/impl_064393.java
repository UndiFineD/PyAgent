...
@Data
public class Idea64393Config {
    private String name = "idea_064393";
 ...
 */
@Slf4j
public class Idea64393Service {
    private static final int IDEA_ID = 64393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64393Service() {
        this(new Idea64393Config());
    }

    public Idea64393Service(Idea64393Config config) {
        this.config = config != null ? config : new Idea64393Config();
