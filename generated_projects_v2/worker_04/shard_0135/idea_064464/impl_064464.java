...
@Data
public class Idea64464Config {
    private String name = "idea_064464";
 ...
 */
@Slf4j
public class Idea64464Service {
    private static final int IDEA_ID = 64464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64464Service() {
        this(new Idea64464Config());
    }

    public Idea64464Service(Idea64464Config config) {
        this.config = config != null ? config : new Idea64464Config();
