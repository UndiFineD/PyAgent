...
@Data
public class Idea64358Config {
    private String name = "idea_064358";
 ...
 */
@Slf4j
public class Idea64358Service {
    private static final int IDEA_ID = 64358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64358Service() {
        this(new Idea64358Config());
    }

    public Idea64358Service(Idea64358Config config) {
        this.config = config != null ? config : new Idea64358Config();
