...
@Data
public class Idea64558Config {
    private String name = "idea_064558";
 ...
 */
@Slf4j
public class Idea64558Service {
    private static final int IDEA_ID = 64558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64558Service() {
        this(new Idea64558Config());
    }

    public Idea64558Service(Idea64558Config config) {
        this.config = config != null ? config : new Idea64558Config();
