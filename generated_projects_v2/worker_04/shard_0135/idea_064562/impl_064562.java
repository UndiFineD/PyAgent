...
@Data
public class Idea64562Config {
    private String name = "idea_064562";
 ...
 */
@Slf4j
public class Idea64562Service {
    private static final int IDEA_ID = 64562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64562Service() {
        this(new Idea64562Config());
    }

    public Idea64562Service(Idea64562Config config) {
        this.config = config != null ? config : new Idea64562Config();
