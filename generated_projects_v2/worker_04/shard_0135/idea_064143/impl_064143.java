...
@Data
public class Idea64143Config {
    private String name = "idea_064143";
 ...
 */
@Slf4j
public class Idea64143Service {
    private static final int IDEA_ID = 64143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64143Service() {
        this(new Idea64143Config());
    }

    public Idea64143Service(Idea64143Config config) {
        this.config = config != null ? config : new Idea64143Config();
