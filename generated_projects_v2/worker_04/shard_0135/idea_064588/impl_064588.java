...
@Data
public class Idea64588Config {
    private String name = "idea_064588";
 ...
 */
@Slf4j
public class Idea64588Service {
    private static final int IDEA_ID = 64588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64588Service() {
        this(new Idea64588Config());
    }

    public Idea64588Service(Idea64588Config config) {
        this.config = config != null ? config : new Idea64588Config();
