...
@Data
public class Idea64598Config {
    private String name = "idea_064598";
 ...
 */
@Slf4j
public class Idea64598Service {
    private static final int IDEA_ID = 64598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64598Service() {
        this(new Idea64598Config());
    }

    public Idea64598Service(Idea64598Config config) {
        this.config = config != null ? config : new Idea64598Config();
