...
@Data
public class Idea64546Config {
    private String name = "idea_064546";
 ...
 */
@Slf4j
public class Idea64546Service {
    private static final int IDEA_ID = 64546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64546Service() {
        this(new Idea64546Config());
    }

    public Idea64546Service(Idea64546Config config) {
        this.config = config != null ? config : new Idea64546Config();
