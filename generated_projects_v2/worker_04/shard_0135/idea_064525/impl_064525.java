...
@Data
public class Idea64525Config {
    private String name = "idea_064525";
 ...
 */
@Slf4j
public class Idea64525Service {
    private static final int IDEA_ID = 64525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64525Service() {
        this(new Idea64525Config());
    }

    public Idea64525Service(Idea64525Config config) {
        this.config = config != null ? config : new Idea64525Config();
