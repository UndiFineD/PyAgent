...
@Data
public class Idea64586Config {
    private String name = "idea_064586";
 ...
 */
@Slf4j
public class Idea64586Service {
    private static final int IDEA_ID = 64586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64586Service() {
        this(new Idea64586Config());
    }

    public Idea64586Service(Idea64586Config config) {
        this.config = config != null ? config : new Idea64586Config();
