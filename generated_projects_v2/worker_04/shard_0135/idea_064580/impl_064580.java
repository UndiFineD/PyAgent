...
@Data
public class Idea64580Config {
    private String name = "idea_064580";
 ...
 */
@Slf4j
public class Idea64580Service {
    private static final int IDEA_ID = 64580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64580Service() {
        this(new Idea64580Config());
    }

    public Idea64580Service(Idea64580Config config) {
        this.config = config != null ? config : new Idea64580Config();
