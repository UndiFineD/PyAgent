...
@Data
public class Idea64162Config {
    private String name = "idea_064162";
 ...
 */
@Slf4j
public class Idea64162Service {
    private static final int IDEA_ID = 64162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64162Service() {
        this(new Idea64162Config());
    }

    public Idea64162Service(Idea64162Config config) {
        this.config = config != null ? config : new Idea64162Config();
