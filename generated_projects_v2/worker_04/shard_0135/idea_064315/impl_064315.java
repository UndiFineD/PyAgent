...
@Data
public class Idea64315Config {
    private String name = "idea_064315";
 ...
 */
@Slf4j
public class Idea64315Service {
    private static final int IDEA_ID = 64315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64315Service() {
        this(new Idea64315Config());
    }

    public Idea64315Service(Idea64315Config config) {
        this.config = config != null ? config : new Idea64315Config();
