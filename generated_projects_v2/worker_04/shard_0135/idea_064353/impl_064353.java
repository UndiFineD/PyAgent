...
@Data
public class Idea64353Config {
    private String name = "idea_064353";
 ...
 */
@Slf4j
public class Idea64353Service {
    private static final int IDEA_ID = 64353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64353Service() {
        this(new Idea64353Config());
    }

    public Idea64353Service(Idea64353Config config) {
        this.config = config != null ? config : new Idea64353Config();
