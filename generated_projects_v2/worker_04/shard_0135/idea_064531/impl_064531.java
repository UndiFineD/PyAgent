...
@Data
public class Idea64531Config {
    private String name = "idea_064531";
 ...
 */
@Slf4j
public class Idea64531Service {
    private static final int IDEA_ID = 64531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64531Service() {
        this(new Idea64531Config());
    }

    public Idea64531Service(Idea64531Config config) {
        this.config = config != null ? config : new Idea64531Config();
