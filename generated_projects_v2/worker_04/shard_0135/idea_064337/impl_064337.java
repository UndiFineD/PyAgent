...
@Data
public class Idea64337Config {
    private String name = "idea_064337";
 ...
 */
@Slf4j
public class Idea64337Service {
    private static final int IDEA_ID = 64337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64337Service() {
        this(new Idea64337Config());
    }

    public Idea64337Service(Idea64337Config config) {
        this.config = config != null ? config : new Idea64337Config();
