...
@Data
public class Idea64203Config {
    private String name = "idea_064203";
 ...
 */
@Slf4j
public class Idea64203Service {
    private static final int IDEA_ID = 64203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64203Service() {
        this(new Idea64203Config());
    }

    public Idea64203Service(Idea64203Config config) {
        this.config = config != null ? config : new Idea64203Config();
