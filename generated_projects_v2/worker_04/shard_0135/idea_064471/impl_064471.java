...
@Data
public class Idea64471Config {
    private String name = "idea_064471";
 ...
 */
@Slf4j
public class Idea64471Service {
    private static final int IDEA_ID = 64471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64471Service() {
        this(new Idea64471Config());
    }

    public Idea64471Service(Idea64471Config config) {
        this.config = config != null ? config : new Idea64471Config();
