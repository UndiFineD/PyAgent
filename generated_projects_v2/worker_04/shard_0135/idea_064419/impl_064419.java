...
@Data
public class Idea64419Config {
    private String name = "idea_064419";
 ...
 */
@Slf4j
public class Idea64419Service {
    private static final int IDEA_ID = 64419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64419Service() {
        this(new Idea64419Config());
    }

    public Idea64419Service(Idea64419Config config) {
        this.config = config != null ? config : new Idea64419Config();
