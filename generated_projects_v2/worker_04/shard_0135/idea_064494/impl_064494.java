...
@Data
public class Idea64494Config {
    private String name = "idea_064494";
 ...
 */
@Slf4j
public class Idea64494Service {
    private static final int IDEA_ID = 64494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64494Service() {
        this(new Idea64494Config());
    }

    public Idea64494Service(Idea64494Config config) {
        this.config = config != null ? config : new Idea64494Config();
