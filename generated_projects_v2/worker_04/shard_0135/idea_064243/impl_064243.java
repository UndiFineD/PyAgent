...
@Data
public class Idea64243Config {
    private String name = "idea_064243";
 ...
 */
@Slf4j
public class Idea64243Service {
    private static final int IDEA_ID = 64243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64243Service() {
        this(new Idea64243Config());
    }

    public Idea64243Service(Idea64243Config config) {
        this.config = config != null ? config : new Idea64243Config();
