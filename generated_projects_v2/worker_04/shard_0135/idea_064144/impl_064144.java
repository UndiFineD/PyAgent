...
@Data
public class Idea64144Config {
    private String name = "idea_064144";
 ...
 */
@Slf4j
public class Idea64144Service {
    private static final int IDEA_ID = 64144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64144Service() {
        this(new Idea64144Config());
    }

    public Idea64144Service(Idea64144Config config) {
        this.config = config != null ? config : new Idea64144Config();
