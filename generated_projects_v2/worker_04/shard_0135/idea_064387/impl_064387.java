...
@Data
public class Idea64387Config {
    private String name = "idea_064387";
 ...
 */
@Slf4j
public class Idea64387Service {
    private static final int IDEA_ID = 64387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64387Service() {
        this(new Idea64387Config());
    }

    public Idea64387Service(Idea64387Config config) {
        this.config = config != null ? config : new Idea64387Config();
