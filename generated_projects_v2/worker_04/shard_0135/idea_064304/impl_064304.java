...
@Data
public class Idea64304Config {
    private String name = "idea_064304";
 ...
 */
@Slf4j
public class Idea64304Service {
    private static final int IDEA_ID = 64304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64304Service() {
        this(new Idea64304Config());
    }

    public Idea64304Service(Idea64304Config config) {
        this.config = config != null ? config : new Idea64304Config();
