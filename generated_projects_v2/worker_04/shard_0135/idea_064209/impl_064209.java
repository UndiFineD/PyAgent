...
@Data
public class Idea64209Config {
    private String name = "idea_064209";
 ...
 */
@Slf4j
public class Idea64209Service {
    private static final int IDEA_ID = 64209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64209Service() {
        this(new Idea64209Config());
    }

    public Idea64209Service(Idea64209Config config) {
        this.config = config != null ? config : new Idea64209Config();
