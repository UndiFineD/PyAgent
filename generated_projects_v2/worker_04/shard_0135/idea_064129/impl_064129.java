...
@Data
public class Idea64129Config {
    private String name = "idea_064129";
 ...
 */
@Slf4j
public class Idea64129Service {
    private static final int IDEA_ID = 64129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64129Service() {
        this(new Idea64129Config());
    }

    public Idea64129Service(Idea64129Config config) {
        this.config = config != null ? config : new Idea64129Config();
