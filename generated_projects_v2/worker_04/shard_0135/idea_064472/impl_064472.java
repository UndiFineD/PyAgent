...
@Data
public class Idea64472Config {
    private String name = "idea_064472";
 ...
 */
@Slf4j
public class Idea64472Service {
    private static final int IDEA_ID = 64472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64472Service() {
        this(new Idea64472Config());
    }

    public Idea64472Service(Idea64472Config config) {
        this.config = config != null ? config : new Idea64472Config();
