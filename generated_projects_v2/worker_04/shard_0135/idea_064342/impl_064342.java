...
@Data
public class Idea64342Config {
    private String name = "idea_064342";
 ...
 */
@Slf4j
public class Idea64342Service {
    private static final int IDEA_ID = 64342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64342Service() {
        this(new Idea64342Config());
    }

    public Idea64342Service(Idea64342Config config) {
        this.config = config != null ? config : new Idea64342Config();
