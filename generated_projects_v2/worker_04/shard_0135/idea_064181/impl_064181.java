...
@Data
public class Idea64181Config {
    private String name = "idea_064181";
 ...
 */
@Slf4j
public class Idea64181Service {
    private static final int IDEA_ID = 64181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64181Service() {
        this(new Idea64181Config());
    }

    public Idea64181Service(Idea64181Config config) {
        this.config = config != null ? config : new Idea64181Config();
