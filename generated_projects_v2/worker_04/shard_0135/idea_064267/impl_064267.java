...
@Data
public class Idea64267Config {
    private String name = "idea_064267";
 ...
 */
@Slf4j
public class Idea64267Service {
    private static final int IDEA_ID = 64267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64267Service() {
        this(new Idea64267Config());
    }

    public Idea64267Service(Idea64267Config config) {
        this.config = config != null ? config : new Idea64267Config();
