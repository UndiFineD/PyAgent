...
@Data
public class Idea64386Config {
    private String name = "idea_064386";
 ...
 */
@Slf4j
public class Idea64386Service {
    private static final int IDEA_ID = 64386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64386Service() {
        this(new Idea64386Config());
    }

    public Idea64386Service(Idea64386Config config) {
        this.config = config != null ? config : new Idea64386Config();
