...
@Data
public class Idea64378Config {
    private String name = "idea_064378";
 ...
 */
@Slf4j
public class Idea64378Service {
    private static final int IDEA_ID = 64378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64378Service() {
        this(new Idea64378Config());
    }

    public Idea64378Service(Idea64378Config config) {
        this.config = config != null ? config : new Idea64378Config();
