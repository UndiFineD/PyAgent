...
@Data
public class Idea64207Config {
    private String name = "idea_064207";
 ...
 */
@Slf4j
public class Idea64207Service {
    private static final int IDEA_ID = 64207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64207Service() {
        this(new Idea64207Config());
    }

    public Idea64207Service(Idea64207Config config) {
        this.config = config != null ? config : new Idea64207Config();
