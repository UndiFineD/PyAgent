...
@Data
public class Idea64498Config {
    private String name = "idea_064498";
 ...
 */
@Slf4j
public class Idea64498Service {
    private static final int IDEA_ID = 64498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64498Service() {
        this(new Idea64498Config());
    }

    public Idea64498Service(Idea64498Config config) {
        this.config = config != null ? config : new Idea64498Config();
