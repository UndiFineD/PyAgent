...
@Data
public class Idea64473Config {
    private String name = "idea_064473";
 ...
 */
@Slf4j
public class Idea64473Service {
    private static final int IDEA_ID = 64473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64473Service() {
        this(new Idea64473Config());
    }

    public Idea64473Service(Idea64473Config config) {
        this.config = config != null ? config : new Idea64473Config();
