...
@Data
public class Idea64428Config {
    private String name = "idea_064428";
 ...
 */
@Slf4j
public class Idea64428Service {
    private static final int IDEA_ID = 64428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64428Service() {
        this(new Idea64428Config());
    }

    public Idea64428Service(Idea64428Config config) {
        this.config = config != null ? config : new Idea64428Config();
