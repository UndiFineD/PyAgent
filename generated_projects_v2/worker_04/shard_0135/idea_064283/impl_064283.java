...
@Data
public class Idea64283Config {
    private String name = "idea_064283";
 ...
 */
@Slf4j
public class Idea64283Service {
    private static final int IDEA_ID = 64283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64283Service() {
        this(new Idea64283Config());
    }

    public Idea64283Service(Idea64283Config config) {
        this.config = config != null ? config : new Idea64283Config();
