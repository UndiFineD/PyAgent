...
@Data
public class Idea64146Config {
    private String name = "idea_064146";
 ...
 */
@Slf4j
public class Idea64146Service {
    private static final int IDEA_ID = 64146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64146Service() {
        this(new Idea64146Config());
    }

    public Idea64146Service(Idea64146Config config) {
        this.config = config != null ? config : new Idea64146Config();
