...
@Data
public class Idea64234Config {
    private String name = "idea_064234";
 ...
 */
@Slf4j
public class Idea64234Service {
    private static final int IDEA_ID = 64234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64234Service() {
        this(new Idea64234Config());
    }

    public Idea64234Service(Idea64234Config config) {
        this.config = config != null ? config : new Idea64234Config();
