...
@Data
public class Idea64482Config {
    private String name = "idea_064482";
 ...
 */
@Slf4j
public class Idea64482Service {
    private static final int IDEA_ID = 64482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64482Service() {
        this(new Idea64482Config());
    }

    public Idea64482Service(Idea64482Config config) {
        this.config = config != null ? config : new Idea64482Config();
