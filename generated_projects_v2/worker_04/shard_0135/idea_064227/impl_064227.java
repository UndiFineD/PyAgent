...
@Data
public class Idea64227Config {
    private String name = "idea_064227";
 ...
 */
@Slf4j
public class Idea64227Service {
    private static final int IDEA_ID = 64227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64227Service() {
        this(new Idea64227Config());
    }

    public Idea64227Service(Idea64227Config config) {
        this.config = config != null ? config : new Idea64227Config();
