...
@Data
public class Idea64536Config {
    private String name = "idea_064536";
 ...
 */
@Slf4j
public class Idea64536Service {
    private static final int IDEA_ID = 64536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64536Service() {
        this(new Idea64536Config());
    }

    public Idea64536Service(Idea64536Config config) {
        this.config = config != null ? config : new Idea64536Config();
