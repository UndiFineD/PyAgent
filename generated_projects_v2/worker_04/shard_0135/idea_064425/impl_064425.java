...
@Data
public class Idea64425Config {
    private String name = "idea_064425";
 ...
 */
@Slf4j
public class Idea64425Service {
    private static final int IDEA_ID = 64425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64425Service() {
        this(new Idea64425Config());
    }

    public Idea64425Service(Idea64425Config config) {
        this.config = config != null ? config : new Idea64425Config();
