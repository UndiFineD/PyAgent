...
@Data
public class Idea64496Config {
    private String name = "idea_064496";
 ...
 */
@Slf4j
public class Idea64496Service {
    private static final int IDEA_ID = 64496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64496Service() {
        this(new Idea64496Config());
    }

    public Idea64496Service(Idea64496Config config) {
        this.config = config != null ? config : new Idea64496Config();
