...
@Data
public class Idea64224Config {
    private String name = "idea_064224";
 ...
 */
@Slf4j
public class Idea64224Service {
    private static final int IDEA_ID = 64224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64224Service() {
        this(new Idea64224Config());
    }

    public Idea64224Service(Idea64224Config config) {
        this.config = config != null ? config : new Idea64224Config();
