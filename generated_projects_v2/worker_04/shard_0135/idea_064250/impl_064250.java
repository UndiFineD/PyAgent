...
@Data
public class Idea64250Config {
    private String name = "idea_064250";
 ...
 */
@Slf4j
public class Idea64250Service {
    private static final int IDEA_ID = 64250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64250Service() {
        this(new Idea64250Config());
    }

    public Idea64250Service(Idea64250Config config) {
        this.config = config != null ? config : new Idea64250Config();
