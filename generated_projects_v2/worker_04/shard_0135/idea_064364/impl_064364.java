...
@Data
public class Idea64364Config {
    private String name = "idea_064364";
 ...
 */
@Slf4j
public class Idea64364Service {
    private static final int IDEA_ID = 64364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64364Service() {
        this(new Idea64364Config());
    }

    public Idea64364Service(Idea64364Config config) {
        this.config = config != null ? config : new Idea64364Config();
