...
@Data
public class Idea64195Config {
    private String name = "idea_064195";
 ...
 */
@Slf4j
public class Idea64195Service {
    private static final int IDEA_ID = 64195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64195Service() {
        this(new Idea64195Config());
    }

    public Idea64195Service(Idea64195Config config) {
        this.config = config != null ? config : new Idea64195Config();
