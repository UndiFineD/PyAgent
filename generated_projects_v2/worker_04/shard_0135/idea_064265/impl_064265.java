...
@Data
public class Idea64265Config {
    private String name = "idea_064265";
 ...
 */
@Slf4j
public class Idea64265Service {
    private static final int IDEA_ID = 64265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64265Service() {
        this(new Idea64265Config());
    }

    public Idea64265Service(Idea64265Config config) {
        this.config = config != null ? config : new Idea64265Config();
