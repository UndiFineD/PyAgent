...
@Data
public class Idea64336Config {
    private String name = "idea_064336";
 ...
 */
@Slf4j
public class Idea64336Service {
    private static final int IDEA_ID = 64336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64336Service() {
        this(new Idea64336Config());
    }

    public Idea64336Service(Idea64336Config config) {
        this.config = config != null ? config : new Idea64336Config();
