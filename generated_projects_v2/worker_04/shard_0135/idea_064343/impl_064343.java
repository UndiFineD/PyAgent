...
@Data
public class Idea64343Config {
    private String name = "idea_064343";
 ...
 */
@Slf4j
public class Idea64343Service {
    private static final int IDEA_ID = 64343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64343Service() {
        this(new Idea64343Config());
    }

    public Idea64343Service(Idea64343Config config) {
        this.config = config != null ? config : new Idea64343Config();
