...
@Data
public class Idea64363Config {
    private String name = "idea_064363";
 ...
 */
@Slf4j
public class Idea64363Service {
    private static final int IDEA_ID = 64363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64363Service() {
        this(new Idea64363Config());
    }

    public Idea64363Service(Idea64363Config config) {
        this.config = config != null ? config : new Idea64363Config();
