...
@Data
public class Idea64388Config {
    private String name = "idea_064388";
 ...
 */
@Slf4j
public class Idea64388Service {
    private static final int IDEA_ID = 64388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64388Service() {
        this(new Idea64388Config());
    }

    public Idea64388Service(Idea64388Config config) {
        this.config = config != null ? config : new Idea64388Config();
