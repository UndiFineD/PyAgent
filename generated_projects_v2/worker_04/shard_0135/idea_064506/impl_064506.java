...
@Data
public class Idea64506Config {
    private String name = "idea_064506";
 ...
 */
@Slf4j
public class Idea64506Service {
    private static final int IDEA_ID = 64506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64506Service() {
        this(new Idea64506Config());
    }

    public Idea64506Service(Idea64506Config config) {
        this.config = config != null ? config : new Idea64506Config();
