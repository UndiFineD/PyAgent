...
@Data
public class Idea64159Config {
    private String name = "idea_064159";
 ...
 */
@Slf4j
public class Idea64159Service {
    private static final int IDEA_ID = 64159;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64159Service() {
        this(new Idea64159Config());
    }

    public Idea64159Service(Idea64159Config config) {
        this.config = config != null ? config : new Idea64159Config();
