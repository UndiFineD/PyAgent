...
@Data
public class Idea64568Config {
    private String name = "idea_064568";
 ...
 */
@Slf4j
public class Idea64568Service {
    private static final int IDEA_ID = 64568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64568Service() {
        this(new Idea64568Config());
    }

    public Idea64568Service(Idea64568Config config) {
        this.config = config != null ? config : new Idea64568Config();
