...
@Data
public class Idea64325Config {
    private String name = "idea_064325";
 ...
 */
@Slf4j
public class Idea64325Service {
    private static final int IDEA_ID = 64325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64325Service() {
        this(new Idea64325Config());
    }

    public Idea64325Service(Idea64325Config config) {
        this.config = config != null ? config : new Idea64325Config();
