...
@Data
public class Idea64177Config {
    private String name = "idea_064177";
 ...
 */
@Slf4j
public class Idea64177Service {
    private static final int IDEA_ID = 64177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64177Service() {
        this(new Idea64177Config());
    }

    public Idea64177Service(Idea64177Config config) {
        this.config = config != null ? config : new Idea64177Config();
