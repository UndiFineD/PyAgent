...
@Data
public class Idea64450Config {
    private String name = "idea_064450";
 ...
 */
@Slf4j
public class Idea64450Service {
    private static final int IDEA_ID = 64450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64450Service() {
        this(new Idea64450Config());
    }

    public Idea64450Service(Idea64450Config config) {
        this.config = config != null ? config : new Idea64450Config();
