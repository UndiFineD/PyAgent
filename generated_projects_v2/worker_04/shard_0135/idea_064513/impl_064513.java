...
@Data
public class Idea64513Config {
    private String name = "idea_064513";
 ...
 */
@Slf4j
public class Idea64513Service {
    private static final int IDEA_ID = 64513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64513Service() {
        this(new Idea64513Config());
    }

    public Idea64513Service(Idea64513Config config) {
        this.config = config != null ? config : new Idea64513Config();
