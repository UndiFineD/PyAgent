...
@Data
public class Idea59520Config {
    private String name = "idea_059520";
 ...
 */
@Slf4j
public class Idea59520Service {
    private static final int IDEA_ID = 59520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59520Service() {
        this(new Idea59520Config());
    }

    public Idea59520Service(Idea59520Config config) {
        this.config = config != null ? config : new Idea59520Config();
