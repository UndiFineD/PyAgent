...
@Data
public class Idea59808Config {
    private String name = "idea_059808";
 ...
 */
@Slf4j
public class Idea59808Service {
    private static final int IDEA_ID = 59808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59808Service() {
        this(new Idea59808Config());
    }

    public Idea59808Service(Idea59808Config config) {
        this.config = config != null ? config : new Idea59808Config();
