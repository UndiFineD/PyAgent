...
@Data
public class Idea59733Config {
    private String name = "idea_059733";
 ...
 */
@Slf4j
public class Idea59733Service {
    private static final int IDEA_ID = 59733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59733Service() {
        this(new Idea59733Config());
    }

    public Idea59733Service(Idea59733Config config) {
        this.config = config != null ? config : new Idea59733Config();
