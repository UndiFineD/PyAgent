...
@Data
public class Idea59523Config {
    private String name = "idea_059523";
 ...
 */
@Slf4j
public class Idea59523Service {
    private static final int IDEA_ID = 59523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59523Service() {
        this(new Idea59523Config());
    }

    public Idea59523Service(Idea59523Config config) {
        this.config = config != null ? config : new Idea59523Config();
