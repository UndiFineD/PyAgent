...
@Data
public class Idea59721Config {
    private String name = "idea_059721";
 ...
 */
@Slf4j
public class Idea59721Service {
    private static final int IDEA_ID = 59721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59721Service() {
        this(new Idea59721Config());
    }

    public Idea59721Service(Idea59721Config config) {
        this.config = config != null ? config : new Idea59721Config();
