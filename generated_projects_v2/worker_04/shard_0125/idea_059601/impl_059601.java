...
@Data
public class Idea59601Config {
    private String name = "idea_059601";
 ...
 */
@Slf4j
public class Idea59601Service {
    private static final int IDEA_ID = 59601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59601Service() {
        this(new Idea59601Config());
    }

    public Idea59601Service(Idea59601Config config) {
        this.config = config != null ? config : new Idea59601Config();
