...
@Data
public class Idea59639Config {
    private String name = "idea_059639";
 ...
 */
@Slf4j
public class Idea59639Service {
    private static final int IDEA_ID = 59639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59639Service() {
        this(new Idea59639Config());
    }

    public Idea59639Service(Idea59639Config config) {
        this.config = config != null ? config : new Idea59639Config();
