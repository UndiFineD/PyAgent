...
@Data
public class Idea59625Config {
    private String name = "idea_059625";
 ...
 */
@Slf4j
public class Idea59625Service {
    private static final int IDEA_ID = 59625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59625Service() {
        this(new Idea59625Config());
    }

    public Idea59625Service(Idea59625Config config) {
        this.config = config != null ? config : new Idea59625Config();
