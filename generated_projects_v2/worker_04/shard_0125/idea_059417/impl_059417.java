...
@Data
public class Idea59417Config {
    private String name = "idea_059417";
 ...
 */
@Slf4j
public class Idea59417Service {
    private static final int IDEA_ID = 59417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59417Service() {
        this(new Idea59417Config());
    }

    public Idea59417Service(Idea59417Config config) {
        this.config = config != null ? config : new Idea59417Config();
