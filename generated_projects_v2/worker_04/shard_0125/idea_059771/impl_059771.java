...
@Data
public class Idea59771Config {
    private String name = "idea_059771";
 ...
 */
@Slf4j
public class Idea59771Service {
    private static final int IDEA_ID = 59771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59771Service() {
        this(new Idea59771Config());
    }

    public Idea59771Service(Idea59771Config config) {
        this.config = config != null ? config : new Idea59771Config();
