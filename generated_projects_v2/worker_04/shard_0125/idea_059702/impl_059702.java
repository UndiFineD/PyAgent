...
@Data
public class Idea59702Config {
    private String name = "idea_059702";
 ...
 */
@Slf4j
public class Idea59702Service {
    private static final int IDEA_ID = 59702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59702Service() {
        this(new Idea59702Config());
    }

    public Idea59702Service(Idea59702Config config) {
        this.config = config != null ? config : new Idea59702Config();
