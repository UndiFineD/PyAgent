...
@Data
public class Idea59525Config {
    private String name = "idea_059525";
 ...
 */
@Slf4j
public class Idea59525Service {
    private static final int IDEA_ID = 59525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59525Service() {
        this(new Idea59525Config());
    }

    public Idea59525Service(Idea59525Config config) {
        this.config = config != null ? config : new Idea59525Config();
