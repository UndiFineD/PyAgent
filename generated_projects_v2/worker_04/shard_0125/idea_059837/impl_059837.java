...
@Data
public class Idea59837Config {
    private String name = "idea_059837";
 ...
 */
@Slf4j
public class Idea59837Service {
    private static final int IDEA_ID = 59837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59837Service() {
        this(new Idea59837Config());
    }

    public Idea59837Service(Idea59837Config config) {
        this.config = config != null ? config : new Idea59837Config();
