...
@Data
public class Idea59758Config {
    private String name = "idea_059758";
 ...
 */
@Slf4j
public class Idea59758Service {
    private static final int IDEA_ID = 59758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59758Service() {
        this(new Idea59758Config());
    }

    public Idea59758Service(Idea59758Config config) {
        this.config = config != null ? config : new Idea59758Config();
