...
@Data
public class Idea59821Config {
    private String name = "idea_059821";
 ...
 */
@Slf4j
public class Idea59821Service {
    private static final int IDEA_ID = 59821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59821Service() {
        this(new Idea59821Config());
    }

    public Idea59821Service(Idea59821Config config) {
        this.config = config != null ? config : new Idea59821Config();
