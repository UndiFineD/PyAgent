...
@Data
public class Idea59597Config {
    private String name = "idea_059597";
 ...
 */
@Slf4j
public class Idea59597Service {
    private static final int IDEA_ID = 59597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59597Service() {
        this(new Idea59597Config());
    }

    public Idea59597Service(Idea59597Config config) {
        this.config = config != null ? config : new Idea59597Config();
