...
@Data
public class Idea59380Config {
    private String name = "idea_059380";
 ...
 */
@Slf4j
public class Idea59380Service {
    private static final int IDEA_ID = 59380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59380Service() {
        this(new Idea59380Config());
    }

    public Idea59380Service(Idea59380Config config) {
        this.config = config != null ? config : new Idea59380Config();
