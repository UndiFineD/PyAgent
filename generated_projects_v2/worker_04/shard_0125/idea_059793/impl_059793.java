...
@Data
public class Idea59793Config {
    private String name = "idea_059793";
 ...
 */
@Slf4j
public class Idea59793Service {
    private static final int IDEA_ID = 59793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59793Service() {
        this(new Idea59793Config());
    }

    public Idea59793Service(Idea59793Config config) {
        this.config = config != null ? config : new Idea59793Config();
