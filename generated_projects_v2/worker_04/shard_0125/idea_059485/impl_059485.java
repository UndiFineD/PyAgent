...
@Data
public class Idea59485Config {
    private String name = "idea_059485";
 ...
 */
@Slf4j
public class Idea59485Service {
    private static final int IDEA_ID = 59485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59485Service() {
        this(new Idea59485Config());
    }

    public Idea59485Service(Idea59485Config config) {
        this.config = config != null ? config : new Idea59485Config();
