...
@Data
public class Idea59591Config {
    private String name = "idea_059591";
 ...
 */
@Slf4j
public class Idea59591Service {
    private static final int IDEA_ID = 59591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59591Service() {
        this(new Idea59591Config());
    }

    public Idea59591Service(Idea59591Config config) {
        this.config = config != null ? config : new Idea59591Config();
