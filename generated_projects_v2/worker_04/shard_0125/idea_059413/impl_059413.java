...
@Data
public class Idea59413Config {
    private String name = "idea_059413";
 ...
 */
@Slf4j
public class Idea59413Service {
    private static final int IDEA_ID = 59413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59413Service() {
        this(new Idea59413Config());
    }

    public Idea59413Service(Idea59413Config config) {
        this.config = config != null ? config : new Idea59413Config();
