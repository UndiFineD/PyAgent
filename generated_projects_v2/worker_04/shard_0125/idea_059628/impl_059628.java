...
@Data
public class Idea59628Config {
    private String name = "idea_059628";
 ...
 */
@Slf4j
public class Idea59628Service {
    private static final int IDEA_ID = 59628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59628Service() {
        this(new Idea59628Config());
    }

    public Idea59628Service(Idea59628Config config) {
        this.config = config != null ? config : new Idea59628Config();
