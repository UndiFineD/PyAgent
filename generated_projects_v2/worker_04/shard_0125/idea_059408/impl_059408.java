...
@Data
public class Idea59408Config {
    private String name = "idea_059408";
 ...
 */
@Slf4j
public class Idea59408Service {
    private static final int IDEA_ID = 59408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59408Service() {
        this(new Idea59408Config());
    }

    public Idea59408Service(Idea59408Config config) {
        this.config = config != null ? config : new Idea59408Config();
