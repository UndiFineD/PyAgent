...
@Data
public class Idea59397Config {
    private String name = "idea_059397";
 ...
 */
@Slf4j
public class Idea59397Service {
    private static final int IDEA_ID = 59397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59397Service() {
        this(new Idea59397Config());
    }

    public Idea59397Service(Idea59397Config config) {
        this.config = config != null ? config : new Idea59397Config();
