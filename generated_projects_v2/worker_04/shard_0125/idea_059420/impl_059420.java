...
@Data
public class Idea59420Config {
    private String name = "idea_059420";
 ...
 */
@Slf4j
public class Idea59420Service {
    private static final int IDEA_ID = 59420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59420Service() {
        this(new Idea59420Config());
    }

    public Idea59420Service(Idea59420Config config) {
        this.config = config != null ? config : new Idea59420Config();
