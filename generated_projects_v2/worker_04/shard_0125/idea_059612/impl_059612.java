...
@Data
public class Idea59612Config {
    private String name = "idea_059612";
 ...
 */
@Slf4j
public class Idea59612Service {
    private static final int IDEA_ID = 59612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59612Service() {
        this(new Idea59612Config());
    }

    public Idea59612Service(Idea59612Config config) {
        this.config = config != null ? config : new Idea59612Config();
