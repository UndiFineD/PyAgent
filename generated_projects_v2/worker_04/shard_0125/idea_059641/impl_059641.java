...
@Data
public class Idea59641Config {
    private String name = "idea_059641";
 ...
 */
@Slf4j
public class Idea59641Service {
    private static final int IDEA_ID = 59641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59641Service() {
        this(new Idea59641Config());
    }

    public Idea59641Service(Idea59641Config config) {
        this.config = config != null ? config : new Idea59641Config();
