...
@Data
public class Idea59425Config {
    private String name = "idea_059425";
 ...
 */
@Slf4j
public class Idea59425Service {
    private static final int IDEA_ID = 59425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59425Service() {
        this(new Idea59425Config());
    }

    public Idea59425Service(Idea59425Config config) {
        this.config = config != null ? config : new Idea59425Config();
