...
@Data
public class Idea59802Config {
    private String name = "idea_059802";
 ...
 */
@Slf4j
public class Idea59802Service {
    private static final int IDEA_ID = 59802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59802Service() {
        this(new Idea59802Config());
    }

    public Idea59802Service(Idea59802Config config) {
        this.config = config != null ? config : new Idea59802Config();
