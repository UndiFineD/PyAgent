...
@Data
public class Idea59391Config {
    private String name = "idea_059391";
 ...
 */
@Slf4j
public class Idea59391Service {
    private static final int IDEA_ID = 59391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59391Service() {
        this(new Idea59391Config());
    }

    public Idea59391Service(Idea59391Config config) {
        this.config = config != null ? config : new Idea59391Config();
