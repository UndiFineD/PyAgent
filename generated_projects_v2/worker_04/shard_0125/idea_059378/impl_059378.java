...
@Data
public class Idea59378Config {
    private String name = "idea_059378";
 ...
 */
@Slf4j
public class Idea59378Service {
    private static final int IDEA_ID = 59378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59378Service() {
        this(new Idea59378Config());
    }

    public Idea59378Service(Idea59378Config config) {
        this.config = config != null ? config : new Idea59378Config();
