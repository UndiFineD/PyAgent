...
@Data
public class Idea59583Config {
    private String name = "idea_059583";
 ...
 */
@Slf4j
public class Idea59583Service {
    private static final int IDEA_ID = 59583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59583Service() {
        this(new Idea59583Config());
    }

    public Idea59583Service(Idea59583Config config) {
        this.config = config != null ? config : new Idea59583Config();
