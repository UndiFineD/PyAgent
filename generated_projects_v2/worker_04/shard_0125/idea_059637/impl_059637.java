...
@Data
public class Idea59637Config {
    private String name = "idea_059637";
 ...
 */
@Slf4j
public class Idea59637Service {
    private static final int IDEA_ID = 59637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59637Service() {
        this(new Idea59637Config());
    }

    public Idea59637Service(Idea59637Config config) {
        this.config = config != null ? config : new Idea59637Config();
