...
@Data
public class Idea59611Config {
    private String name = "idea_059611";
 ...
 */
@Slf4j
public class Idea59611Service {
    private static final int IDEA_ID = 59611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59611Service() {
        this(new Idea59611Config());
    }

    public Idea59611Service(Idea59611Config config) {
        this.config = config != null ? config : new Idea59611Config();
