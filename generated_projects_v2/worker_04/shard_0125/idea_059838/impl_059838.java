...
@Data
public class Idea59838Config {
    private String name = "idea_059838";
 ...
 */
@Slf4j
public class Idea59838Service {
    private static final int IDEA_ID = 59838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59838Service() {
        this(new Idea59838Config());
    }

    public Idea59838Service(Idea59838Config config) {
        this.config = config != null ? config : new Idea59838Config();
