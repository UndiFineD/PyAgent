...
@Data
public class Idea59547Config {
    private String name = "idea_059547";
 ...
 */
@Slf4j
public class Idea59547Service {
    private static final int IDEA_ID = 59547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59547Service() {
        this(new Idea59547Config());
    }

    public Idea59547Service(Idea59547Config config) {
        this.config = config != null ? config : new Idea59547Config();
