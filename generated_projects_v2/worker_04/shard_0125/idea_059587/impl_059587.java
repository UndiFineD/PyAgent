...
@Data
public class Idea59587Config {
    private String name = "idea_059587";
 ...
 */
@Slf4j
public class Idea59587Service {
    private static final int IDEA_ID = 59587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59587Service() {
        this(new Idea59587Config());
    }

    public Idea59587Service(Idea59587Config config) {
        this.config = config != null ? config : new Idea59587Config();
