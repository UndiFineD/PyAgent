...
@Data
public class Idea59823Config {
    private String name = "idea_059823";
 ...
 */
@Slf4j
public class Idea59823Service {
    private static final int IDEA_ID = 59823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59823Service() {
        this(new Idea59823Config());
    }

    public Idea59823Service(Idea59823Config config) {
        this.config = config != null ? config : new Idea59823Config();
