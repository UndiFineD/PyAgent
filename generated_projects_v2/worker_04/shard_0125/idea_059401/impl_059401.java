...
@Data
public class Idea59401Config {
    private String name = "idea_059401";
 ...
 */
@Slf4j
public class Idea59401Service {
    private static final int IDEA_ID = 59401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59401Service() {
        this(new Idea59401Config());
    }

    public Idea59401Service(Idea59401Config config) {
        this.config = config != null ? config : new Idea59401Config();
