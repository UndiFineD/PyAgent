...
@Data
public class Idea59406Config {
    private String name = "idea_059406";
 ...
 */
@Slf4j
public class Idea59406Service {
    private static final int IDEA_ID = 59406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59406Service() {
        this(new Idea59406Config());
    }

    public Idea59406Service(Idea59406Config config) {
        this.config = config != null ? config : new Idea59406Config();
