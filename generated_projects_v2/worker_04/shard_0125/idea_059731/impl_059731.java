...
@Data
public class Idea59731Config {
    private String name = "idea_059731";
 ...
 */
@Slf4j
public class Idea59731Service {
    private static final int IDEA_ID = 59731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59731Service() {
        this(new Idea59731Config());
    }

    public Idea59731Service(Idea59731Config config) {
        this.config = config != null ? config : new Idea59731Config();
