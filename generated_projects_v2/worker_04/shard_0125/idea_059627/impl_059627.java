...
@Data
public class Idea59627Config {
    private String name = "idea_059627";
 ...
 */
@Slf4j
public class Idea59627Service {
    private static final int IDEA_ID = 59627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59627Service() {
        this(new Idea59627Config());
    }

    public Idea59627Service(Idea59627Config config) {
        this.config = config != null ? config : new Idea59627Config();
