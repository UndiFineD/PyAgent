...
@Data
public class Idea59411Config {
    private String name = "idea_059411";
 ...
 */
@Slf4j
public class Idea59411Service {
    private static final int IDEA_ID = 59411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59411Service() {
        this(new Idea59411Config());
    }

    public Idea59411Service(Idea59411Config config) {
        this.config = config != null ? config : new Idea59411Config();
