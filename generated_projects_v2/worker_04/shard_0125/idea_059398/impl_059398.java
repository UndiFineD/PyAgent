...
@Data
public class Idea59398Config {
    private String name = "idea_059398";
 ...
 */
@Slf4j
public class Idea59398Service {
    private static final int IDEA_ID = 59398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59398Service() {
        this(new Idea59398Config());
    }

    public Idea59398Service(Idea59398Config config) {
        this.config = config != null ? config : new Idea59398Config();
