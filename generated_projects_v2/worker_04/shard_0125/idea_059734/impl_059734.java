...
@Data
public class Idea59734Config {
    private String name = "idea_059734";
 ...
 */
@Slf4j
public class Idea59734Service {
    private static final int IDEA_ID = 59734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59734Service() {
        this(new Idea59734Config());
    }

    public Idea59734Service(Idea59734Config config) {
        this.config = config != null ? config : new Idea59734Config();
