...
@Data
public class Idea59603Config {
    private String name = "idea_059603";
 ...
 */
@Slf4j
public class Idea59603Service {
    private static final int IDEA_ID = 59603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59603Service() {
        this(new Idea59603Config());
    }

    public Idea59603Service(Idea59603Config config) {
        this.config = config != null ? config : new Idea59603Config();
