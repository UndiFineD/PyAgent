...
@Data
public class Idea59825Config {
    private String name = "idea_059825";
 ...
 */
@Slf4j
public class Idea59825Service {
    private static final int IDEA_ID = 59825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59825Service() {
        this(new Idea59825Config());
    }

    public Idea59825Service(Idea59825Config config) {
        this.config = config != null ? config : new Idea59825Config();
