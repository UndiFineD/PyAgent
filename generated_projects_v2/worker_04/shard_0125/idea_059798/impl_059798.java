...
@Data
public class Idea59798Config {
    private String name = "idea_059798";
 ...
 */
@Slf4j
public class Idea59798Service {
    private static final int IDEA_ID = 59798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59798Service() {
        this(new Idea59798Config());
    }

    public Idea59798Service(Idea59798Config config) {
        this.config = config != null ? config : new Idea59798Config();
