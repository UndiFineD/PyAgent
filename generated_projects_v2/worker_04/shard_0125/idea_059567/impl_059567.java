...
@Data
public class Idea59567Config {
    private String name = "idea_059567";
 ...
 */
@Slf4j
public class Idea59567Service {
    private static final int IDEA_ID = 59567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59567Service() {
        this(new Idea59567Config());
    }

    public Idea59567Service(Idea59567Config config) {
        this.config = config != null ? config : new Idea59567Config();
