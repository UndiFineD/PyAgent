...
@Data
public class Idea59636Config {
    private String name = "idea_059636";
 ...
 */
@Slf4j
public class Idea59636Service {
    private static final int IDEA_ID = 59636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59636Service() {
        this(new Idea59636Config());
    }

    public Idea59636Service(Idea59636Config config) {
        this.config = config != null ? config : new Idea59636Config();
