...
@Data
public class Idea59469Config {
    private String name = "idea_059469";
 ...
 */
@Slf4j
public class Idea59469Service {
    private static final int IDEA_ID = 59469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59469Service() {
        this(new Idea59469Config());
    }

    public Idea59469Service(Idea59469Config config) {
        this.config = config != null ? config : new Idea59469Config();
