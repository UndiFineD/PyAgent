...
@Data
public class Idea59710Config {
    private String name = "idea_059710";
 ...
 */
@Slf4j
public class Idea59710Service {
    private static final int IDEA_ID = 59710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59710Service() {
        this(new Idea59710Config());
    }

    public Idea59710Service(Idea59710Config config) {
        this.config = config != null ? config : new Idea59710Config();
