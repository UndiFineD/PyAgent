...
@Data
public class Idea59801Config {
    private String name = "idea_059801";
 ...
 */
@Slf4j
public class Idea59801Service {
    private static final int IDEA_ID = 59801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59801Service() {
        this(new Idea59801Config());
    }

    public Idea59801Service(Idea59801Config config) {
        this.config = config != null ? config : new Idea59801Config();
