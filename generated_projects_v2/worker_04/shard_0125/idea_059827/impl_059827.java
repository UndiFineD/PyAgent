...
@Data
public class Idea59827Config {
    private String name = "idea_059827";
 ...
 */
@Slf4j
public class Idea59827Service {
    private static final int IDEA_ID = 59827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59827Service() {
        this(new Idea59827Config());
    }

    public Idea59827Service(Idea59827Config config) {
        this.config = config != null ? config : new Idea59827Config();
