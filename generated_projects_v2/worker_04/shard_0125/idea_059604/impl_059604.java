...
@Data
public class Idea59604Config {
    private String name = "idea_059604";
 ...
 */
@Slf4j
public class Idea59604Service {
    private static final int IDEA_ID = 59604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59604Service() {
        this(new Idea59604Config());
    }

    public Idea59604Service(Idea59604Config config) {
        this.config = config != null ? config : new Idea59604Config();
