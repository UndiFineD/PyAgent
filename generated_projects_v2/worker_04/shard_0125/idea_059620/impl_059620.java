...
@Data
public class Idea59620Config {
    private String name = "idea_059620";
 ...
 */
@Slf4j
public class Idea59620Service {
    private static final int IDEA_ID = 59620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59620Service() {
        this(new Idea59620Config());
    }

    public Idea59620Service(Idea59620Config config) {
        this.config = config != null ? config : new Idea59620Config();
