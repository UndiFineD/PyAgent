...
@Data
public class Idea59736Config {
    private String name = "idea_059736";
 ...
 */
@Slf4j
public class Idea59736Service {
    private static final int IDEA_ID = 59736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59736Service() {
        this(new Idea59736Config());
    }

    public Idea59736Service(Idea59736Config config) {
        this.config = config != null ? config : new Idea59736Config();
