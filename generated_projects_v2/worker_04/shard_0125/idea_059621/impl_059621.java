...
@Data
public class Idea59621Config {
    private String name = "idea_059621";
 ...
 */
@Slf4j
public class Idea59621Service {
    private static final int IDEA_ID = 59621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59621Service() {
        this(new Idea59621Config());
    }

    public Idea59621Service(Idea59621Config config) {
        this.config = config != null ? config : new Idea59621Config();
