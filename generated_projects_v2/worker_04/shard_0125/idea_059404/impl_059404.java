...
@Data
public class Idea59404Config {
    private String name = "idea_059404";
 ...
 */
@Slf4j
public class Idea59404Service {
    private static final int IDEA_ID = 59404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59404Service() {
        this(new Idea59404Config());
    }

    public Idea59404Service(Idea59404Config config) {
        this.config = config != null ? config : new Idea59404Config();
