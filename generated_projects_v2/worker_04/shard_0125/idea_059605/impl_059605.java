...
@Data
public class Idea59605Config {
    private String name = "idea_059605";
 ...
 */
@Slf4j
public class Idea59605Service {
    private static final int IDEA_ID = 59605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea59605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea59605Service() {
        this(new Idea59605Config());
    }

    public Idea59605Service(Idea59605Config config) {
        this.config = config != null ? config : new Idea59605Config();
