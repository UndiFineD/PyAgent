...
@Data
public class Idea65297Config {
    private String name = "idea_065297";
 ...
 */
@Slf4j
public class Idea65297Service {
    private static final int IDEA_ID = 65297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65297Service() {
        this(new Idea65297Config());
    }

    public Idea65297Service(Idea65297Config config) {
        this.config = config != null ? config : new Idea65297Config();
