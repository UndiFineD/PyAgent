...
@Data
public class Idea65423Config {
    private String name = "idea_065423";
 ...
 */
@Slf4j
public class Idea65423Service {
    private static final int IDEA_ID = 65423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65423Service() {
        this(new Idea65423Config());
    }

    public Idea65423Service(Idea65423Config config) {
        this.config = config != null ? config : new Idea65423Config();
