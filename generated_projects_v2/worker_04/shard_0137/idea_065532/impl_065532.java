...
@Data
public class Idea65532Config {
    private String name = "idea_065532";
 ...
 */
@Slf4j
public class Idea65532Service {
    private static final int IDEA_ID = 65532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65532Service() {
        this(new Idea65532Config());
    }

    public Idea65532Service(Idea65532Config config) {
        this.config = config != null ? config : new Idea65532Config();
