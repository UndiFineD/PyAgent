...
@Data
public class Idea65155Config {
    private String name = "idea_065155";
 ...
 */
@Slf4j
public class Idea65155Service {
    private static final int IDEA_ID = 65155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65155Service() {
        this(new Idea65155Config());
    }

    public Idea65155Service(Idea65155Config config) {
        this.config = config != null ? config : new Idea65155Config();
