...
@Data
public class Idea65485Config {
    private String name = "idea_065485";
 ...
 */
@Slf4j
public class Idea65485Service {
    private static final int IDEA_ID = 65485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65485Service() {
        this(new Idea65485Config());
    }

    public Idea65485Service(Idea65485Config config) {
        this.config = config != null ? config : new Idea65485Config();
