...
@Data
public class Idea65187Config {
    private String name = "idea_065187";
 ...
 */
@Slf4j
public class Idea65187Service {
    private static final int IDEA_ID = 65187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65187Service() {
        this(new Idea65187Config());
    }

    public Idea65187Service(Idea65187Config config) {
        this.config = config != null ? config : new Idea65187Config();
