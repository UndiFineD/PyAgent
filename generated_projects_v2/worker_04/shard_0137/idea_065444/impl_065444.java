...
@Data
public class Idea65444Config {
    private String name = "idea_065444";
 ...
 */
@Slf4j
public class Idea65444Service {
    private static final int IDEA_ID = 65444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65444Service() {
        this(new Idea65444Config());
    }

    public Idea65444Service(Idea65444Config config) {
        this.config = config != null ? config : new Idea65444Config();
