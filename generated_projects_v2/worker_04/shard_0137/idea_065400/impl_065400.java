...
@Data
public class Idea65400Config {
    private String name = "idea_065400";
 ...
 */
@Slf4j
public class Idea65400Service {
    private static final int IDEA_ID = 65400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65400Service() {
        this(new Idea65400Config());
    }

    public Idea65400Service(Idea65400Config config) {
        this.config = config != null ? config : new Idea65400Config();
