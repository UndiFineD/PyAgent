...
@Data
public class Idea65207Config {
    private String name = "idea_065207";
 ...
 */
@Slf4j
public class Idea65207Service {
    private static final int IDEA_ID = 65207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65207Service() {
        this(new Idea65207Config());
    }

    public Idea65207Service(Idea65207Config config) {
        this.config = config != null ? config : new Idea65207Config();
