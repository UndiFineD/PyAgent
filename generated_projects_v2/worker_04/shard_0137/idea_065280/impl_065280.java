...
@Data
public class Idea65280Config {
    private String name = "idea_065280";
 ...
 */
@Slf4j
public class Idea65280Service {
    private static final int IDEA_ID = 65280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65280Service() {
        this(new Idea65280Config());
    }

    public Idea65280Service(Idea65280Config config) {
        this.config = config != null ? config : new Idea65280Config();
