...
@Data
public class Idea65309Config {
    private String name = "idea_065309";
 ...
 */
@Slf4j
public class Idea65309Service {
    private static final int IDEA_ID = 65309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65309Service() {
        this(new Idea65309Config());
    }

    public Idea65309Service(Idea65309Config config) {
        this.config = config != null ? config : new Idea65309Config();
