...
@Data
public class Idea65308Config {
    private String name = "idea_065308";
 ...
 */
@Slf4j
public class Idea65308Service {
    private static final int IDEA_ID = 65308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65308Service() {
        this(new Idea65308Config());
    }

    public Idea65308Service(Idea65308Config config) {
        this.config = config != null ? config : new Idea65308Config();
