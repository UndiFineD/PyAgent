...
@Data
public class Idea65360Config {
    private String name = "idea_065360";
 ...
 */
@Slf4j
public class Idea65360Service {
    private static final int IDEA_ID = 65360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65360Service() {
        this(new Idea65360Config());
    }

    public Idea65360Service(Idea65360Config config) {
        this.config = config != null ? config : new Idea65360Config();
