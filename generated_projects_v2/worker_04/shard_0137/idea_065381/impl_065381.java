...
@Data
public class Idea65381Config {
    private String name = "idea_065381";
 ...
 */
@Slf4j
public class Idea65381Service {
    private static final int IDEA_ID = 65381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65381Service() {
        this(new Idea65381Config());
    }

    public Idea65381Service(Idea65381Config config) {
        this.config = config != null ? config : new Idea65381Config();
