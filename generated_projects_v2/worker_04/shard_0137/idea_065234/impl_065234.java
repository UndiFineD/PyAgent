...
@Data
public class Idea65234Config {
    private String name = "idea_065234";
 ...
 */
@Slf4j
public class Idea65234Service {
    private static final int IDEA_ID = 65234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65234Service() {
        this(new Idea65234Config());
    }

    public Idea65234Service(Idea65234Config config) {
        this.config = config != null ? config : new Idea65234Config();
