...
@Data
public class Idea65397Config {
    private String name = "idea_065397";
 ...
 */
@Slf4j
public class Idea65397Service {
    private static final int IDEA_ID = 65397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65397Service() {
        this(new Idea65397Config());
    }

    public Idea65397Service(Idea65397Config config) {
        this.config = config != null ? config : new Idea65397Config();
