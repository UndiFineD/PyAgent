...
@Data
public class Idea65265Config {
    private String name = "idea_065265";
 ...
 */
@Slf4j
public class Idea65265Service {
    private static final int IDEA_ID = 65265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65265Service() {
        this(new Idea65265Config());
    }

    public Idea65265Service(Idea65265Config config) {
        this.config = config != null ? config : new Idea65265Config();
