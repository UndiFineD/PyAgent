...
@Data
public class Idea65473Config {
    private String name = "idea_065473";
 ...
 */
@Slf4j
public class Idea65473Service {
    private static final int IDEA_ID = 65473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65473Service() {
        this(new Idea65473Config());
    }

    public Idea65473Service(Idea65473Config config) {
        this.config = config != null ? config : new Idea65473Config();
