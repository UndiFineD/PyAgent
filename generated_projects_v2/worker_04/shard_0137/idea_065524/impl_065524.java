...
@Data
public class Idea65524Config {
    private String name = "idea_065524";
 ...
 */
@Slf4j
public class Idea65524Service {
    private static final int IDEA_ID = 65524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65524Service() {
        this(new Idea65524Config());
    }

    public Idea65524Service(Idea65524Config config) {
        this.config = config != null ? config : new Idea65524Config();
