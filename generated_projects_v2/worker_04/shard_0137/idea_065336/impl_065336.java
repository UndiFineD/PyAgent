...
@Data
public class Idea65336Config {
    private String name = "idea_065336";
 ...
 */
@Slf4j
public class Idea65336Service {
    private static final int IDEA_ID = 65336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65336Service() {
        this(new Idea65336Config());
    }

    public Idea65336Service(Idea65336Config config) {
        this.config = config != null ? config : new Idea65336Config();
