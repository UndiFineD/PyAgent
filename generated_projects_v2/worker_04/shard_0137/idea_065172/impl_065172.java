...
@Data
public class Idea65172Config {
    private String name = "idea_065172";
 ...
 */
@Slf4j
public class Idea65172Service {
    private static final int IDEA_ID = 65172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65172Service() {
        this(new Idea65172Config());
    }

    public Idea65172Service(Idea65172Config config) {
        this.config = config != null ? config : new Idea65172Config();
