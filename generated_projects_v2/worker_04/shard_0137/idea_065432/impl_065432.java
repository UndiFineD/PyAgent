...
@Data
public class Idea65432Config {
    private String name = "idea_065432";
 ...
 */
@Slf4j
public class Idea65432Service {
    private static final int IDEA_ID = 65432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65432Service() {
        this(new Idea65432Config());
    }

    public Idea65432Service(Idea65432Config config) {
        this.config = config != null ? config : new Idea65432Config();
