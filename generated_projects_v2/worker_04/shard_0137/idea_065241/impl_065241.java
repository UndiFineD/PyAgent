...
@Data
public class Idea65241Config {
    private String name = "idea_065241";
 ...
 */
@Slf4j
public class Idea65241Service {
    private static final int IDEA_ID = 65241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65241Service() {
        this(new Idea65241Config());
    }

    public Idea65241Service(Idea65241Config config) {
        this.config = config != null ? config : new Idea65241Config();
