...
@Data
public class Idea65075Config {
    private String name = "idea_065075";
 ...
 */
@Slf4j
public class Idea65075Service {
    private static final int IDEA_ID = 65075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65075Service() {
        this(new Idea65075Config());
    }

    public Idea65075Service(Idea65075Config config) {
        this.config = config != null ? config : new Idea65075Config();
