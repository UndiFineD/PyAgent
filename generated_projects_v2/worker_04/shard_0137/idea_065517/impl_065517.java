...
@Data
public class Idea65517Config {
    private String name = "idea_065517";
 ...
 */
@Slf4j
public class Idea65517Service {
    private static final int IDEA_ID = 65517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65517Service() {
        this(new Idea65517Config());
    }

    public Idea65517Service(Idea65517Config config) {
        this.config = config != null ? config : new Idea65517Config();
