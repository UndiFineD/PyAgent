...
@Data
public class Idea65525Config {
    private String name = "idea_065525";
 ...
 */
@Slf4j
public class Idea65525Service {
    private static final int IDEA_ID = 65525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65525Service() {
        this(new Idea65525Config());
    }

    public Idea65525Service(Idea65525Config config) {
        this.config = config != null ? config : new Idea65525Config();
