...
@Data
public class Idea65276Config {
    private String name = "idea_065276";
 ...
 */
@Slf4j
public class Idea65276Service {
    private static final int IDEA_ID = 65276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65276Service() {
        this(new Idea65276Config());
    }

    public Idea65276Service(Idea65276Config config) {
        this.config = config != null ? config : new Idea65276Config();
