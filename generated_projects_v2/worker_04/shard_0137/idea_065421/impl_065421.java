...
@Data
public class Idea65421Config {
    private String name = "idea_065421";
 ...
 */
@Slf4j
public class Idea65421Service {
    private static final int IDEA_ID = 65421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65421Service() {
        this(new Idea65421Config());
    }

    public Idea65421Service(Idea65421Config config) {
        this.config = config != null ? config : new Idea65421Config();
