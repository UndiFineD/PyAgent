...
@Data
public class Idea65387Config {
    private String name = "idea_065387";
 ...
 */
@Slf4j
public class Idea65387Service {
    private static final int IDEA_ID = 65387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65387Service() {
        this(new Idea65387Config());
    }

    public Idea65387Service(Idea65387Config config) {
        this.config = config != null ? config : new Idea65387Config();
