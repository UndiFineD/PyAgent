...
@Data
public class Idea65362Config {
    private String name = "idea_065362";
 ...
 */
@Slf4j
public class Idea65362Service {
    private static final int IDEA_ID = 65362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65362Service() {
        this(new Idea65362Config());
    }

    public Idea65362Service(Idea65362Config config) {
        this.config = config != null ? config : new Idea65362Config();
