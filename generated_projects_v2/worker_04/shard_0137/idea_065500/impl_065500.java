...
@Data
public class Idea65500Config {
    private String name = "idea_065500";
 ...
 */
@Slf4j
public class Idea65500Service {
    private static final int IDEA_ID = 65500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65500Service() {
        this(new Idea65500Config());
    }

    public Idea65500Service(Idea65500Config config) {
        this.config = config != null ? config : new Idea65500Config();
