...
@Data
public class Idea65267Config {
    private String name = "idea_065267";
 ...
 */
@Slf4j
public class Idea65267Service {
    private static final int IDEA_ID = 65267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65267Service() {
        this(new Idea65267Config());
    }

    public Idea65267Service(Idea65267Config config) {
        this.config = config != null ? config : new Idea65267Config();
