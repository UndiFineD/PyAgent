...
@Data
public class Idea65216Config {
    private String name = "idea_065216";
 ...
 */
@Slf4j
public class Idea65216Service {
    private static final int IDEA_ID = 65216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65216Service() {
        this(new Idea65216Config());
    }

    public Idea65216Service(Idea65216Config config) {
        this.config = config != null ? config : new Idea65216Config();
