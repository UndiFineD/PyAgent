...
@Data
public class Idea65446Config {
    private String name = "idea_065446";
 ...
 */
@Slf4j
public class Idea65446Service {
    private static final int IDEA_ID = 65446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65446Service() {
        this(new Idea65446Config());
    }

    public Idea65446Service(Idea65446Config config) {
        this.config = config != null ? config : new Idea65446Config();
