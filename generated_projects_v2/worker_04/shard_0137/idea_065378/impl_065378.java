...
@Data
public class Idea65378Config {
    private String name = "idea_065378";
 ...
 */
@Slf4j
public class Idea65378Service {
    private static final int IDEA_ID = 65378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65378Service() {
        this(new Idea65378Config());
    }

    public Idea65378Service(Idea65378Config config) {
        this.config = config != null ? config : new Idea65378Config();
