...
@Data
public class Idea65527Config {
    private String name = "idea_065527";
 ...
 */
@Slf4j
public class Idea65527Service {
    private static final int IDEA_ID = 65527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65527Service() {
        this(new Idea65527Config());
    }

    public Idea65527Service(Idea65527Config config) {
        this.config = config != null ? config : new Idea65527Config();
