...
@Data
public class Idea65101Config {
    private String name = "idea_065101";
 ...
 */
@Slf4j
public class Idea65101Service {
    private static final int IDEA_ID = 65101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65101Service() {
        this(new Idea65101Config());
    }

    public Idea65101Service(Idea65101Config config) {
        this.config = config != null ? config : new Idea65101Config();
