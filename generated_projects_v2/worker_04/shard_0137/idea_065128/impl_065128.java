...
@Data
public class Idea65128Config {
    private String name = "idea_065128";
 ...
 */
@Slf4j
public class Idea65128Service {
    private static final int IDEA_ID = 65128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65128Service() {
        this(new Idea65128Config());
    }

    public Idea65128Service(Idea65128Config config) {
        this.config = config != null ? config : new Idea65128Config();
