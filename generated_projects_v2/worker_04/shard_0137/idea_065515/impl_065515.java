...
@Data
public class Idea65515Config {
    private String name = "idea_065515";
 ...
 */
@Slf4j
public class Idea65515Service {
    private static final int IDEA_ID = 65515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65515Service() {
        this(new Idea65515Config());
    }

    public Idea65515Service(Idea65515Config config) {
        this.config = config != null ? config : new Idea65515Config();
