...
@Data
public class Idea65508Config {
    private String name = "idea_065508";
 ...
 */
@Slf4j
public class Idea65508Service {
    private static final int IDEA_ID = 65508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65508Service() {
        this(new Idea65508Config());
    }

    public Idea65508Service(Idea65508Config config) {
        this.config = config != null ? config : new Idea65508Config();
