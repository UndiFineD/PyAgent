...
@Data
public class Idea65373Config {
    private String name = "idea_065373";
 ...
 */
@Slf4j
public class Idea65373Service {
    private static final int IDEA_ID = 65373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65373Service() {
        this(new Idea65373Config());
    }

    public Idea65373Service(Idea65373Config config) {
        this.config = config != null ? config : new Idea65373Config();
