...
@Data
public class Idea65293Config {
    private String name = "idea_065293";
 ...
 */
@Slf4j
public class Idea65293Service {
    private static final int IDEA_ID = 65293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65293Service() {
        this(new Idea65293Config());
    }

    public Idea65293Service(Idea65293Config config) {
        this.config = config != null ? config : new Idea65293Config();
