...
@Data
public class Idea65208Config {
    private String name = "idea_065208";
 ...
 */
@Slf4j
public class Idea65208Service {
    private static final int IDEA_ID = 65208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65208Service() {
        this(new Idea65208Config());
    }

    public Idea65208Service(Idea65208Config config) {
        this.config = config != null ? config : new Idea65208Config();
