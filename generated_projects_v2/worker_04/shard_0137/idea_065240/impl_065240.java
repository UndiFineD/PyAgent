...
@Data
public class Idea65240Config {
    private String name = "idea_065240";
 ...
 */
@Slf4j
public class Idea65240Service {
    private static final int IDEA_ID = 65240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65240Service() {
        this(new Idea65240Config());
    }

    public Idea65240Service(Idea65240Config config) {
        this.config = config != null ? config : new Idea65240Config();
