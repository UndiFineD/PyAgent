...
@Data
public class Idea65220Config {
    private String name = "idea_065220";
 ...
 */
@Slf4j
public class Idea65220Service {
    private static final int IDEA_ID = 65220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65220Service() {
        this(new Idea65220Config());
    }

    public Idea65220Service(Idea65220Config config) {
        this.config = config != null ? config : new Idea65220Config();
