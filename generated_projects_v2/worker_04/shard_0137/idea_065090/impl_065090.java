...
@Data
public class Idea65090Config {
    private String name = "idea_065090";
 ...
 */
@Slf4j
public class Idea65090Service {
    private static final int IDEA_ID = 65090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65090Service() {
        this(new Idea65090Config());
    }

    public Idea65090Service(Idea65090Config config) {
        this.config = config != null ? config : new Idea65090Config();
