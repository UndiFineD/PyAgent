...
@Data
public class Idea65396Config {
    private String name = "idea_065396";
 ...
 */
@Slf4j
public class Idea65396Service {
    private static final int IDEA_ID = 65396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65396Service() {
        this(new Idea65396Config());
    }

    public Idea65396Service(Idea65396Config config) {
        this.config = config != null ? config : new Idea65396Config();
