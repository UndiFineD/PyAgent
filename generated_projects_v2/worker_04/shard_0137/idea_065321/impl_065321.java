...
@Data
public class Idea65321Config {
    private String name = "idea_065321";
 ...
 */
@Slf4j
public class Idea65321Service {
    private static final int IDEA_ID = 65321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65321Service() {
        this(new Idea65321Config());
    }

    public Idea65321Service(Idea65321Config config) {
        this.config = config != null ? config : new Idea65321Config();
