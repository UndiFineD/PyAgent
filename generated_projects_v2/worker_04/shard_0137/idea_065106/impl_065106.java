...
@Data
public class Idea65106Config {
    private String name = "idea_065106";
 ...
 */
@Slf4j
public class Idea65106Service {
    private static final int IDEA_ID = 65106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65106Service() {
        this(new Idea65106Config());
    }

    public Idea65106Service(Idea65106Config config) {
        this.config = config != null ? config : new Idea65106Config();
