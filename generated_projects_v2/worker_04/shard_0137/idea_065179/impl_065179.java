...
@Data
public class Idea65179Config {
    private String name = "idea_065179";
 ...
 */
@Slf4j
public class Idea65179Service {
    private static final int IDEA_ID = 65179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65179Service() {
        this(new Idea65179Config());
    }

    public Idea65179Service(Idea65179Config config) {
        this.config = config != null ? config : new Idea65179Config();
