...
@Data
public class Idea65228Config {
    private String name = "idea_065228";
 ...
 */
@Slf4j
public class Idea65228Service {
    private static final int IDEA_ID = 65228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65228Service() {
        this(new Idea65228Config());
    }

    public Idea65228Service(Idea65228Config config) {
        this.config = config != null ? config : new Idea65228Config();
