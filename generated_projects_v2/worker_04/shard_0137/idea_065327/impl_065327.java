...
@Data
public class Idea65327Config {
    private String name = "idea_065327";
 ...
 */
@Slf4j
public class Idea65327Service {
    private static final int IDEA_ID = 65327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65327Service() {
        this(new Idea65327Config());
    }

    public Idea65327Service(Idea65327Config config) {
        this.config = config != null ? config : new Idea65327Config();
