...
@Data
public class Idea65224Config {
    private String name = "idea_065224";
 ...
 */
@Slf4j
public class Idea65224Service {
    private static final int IDEA_ID = 65224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65224Service() {
        this(new Idea65224Config());
    }

    public Idea65224Service(Idea65224Config config) {
        this.config = config != null ? config : new Idea65224Config();
