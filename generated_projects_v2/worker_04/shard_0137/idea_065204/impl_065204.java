...
@Data
public class Idea65204Config {
    private String name = "idea_065204";
 ...
 */
@Slf4j
public class Idea65204Service {
    private static final int IDEA_ID = 65204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65204Service() {
        this(new Idea65204Config());
    }

    public Idea65204Service(Idea65204Config config) {
        this.config = config != null ? config : new Idea65204Config();
