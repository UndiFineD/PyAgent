...
@Data
public class Idea65252Config {
    private String name = "idea_065252";
 ...
 */
@Slf4j
public class Idea65252Service {
    private static final int IDEA_ID = 65252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65252Service() {
        this(new Idea65252Config());
    }

    public Idea65252Service(Idea65252Config config) {
        this.config = config != null ? config : new Idea65252Config();
