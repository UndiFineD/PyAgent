...
@Data
public class Idea65418Config {
    private String name = "idea_065418";
 ...
 */
@Slf4j
public class Idea65418Service {
    private static final int IDEA_ID = 65418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65418Service() {
        this(new Idea65418Config());
    }

    public Idea65418Service(Idea65418Config config) {
        this.config = config != null ? config : new Idea65418Config();
