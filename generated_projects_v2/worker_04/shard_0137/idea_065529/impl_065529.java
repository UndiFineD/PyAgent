...
@Data
public class Idea65529Config {
    private String name = "idea_065529";
 ...
 */
@Slf4j
public class Idea65529Service {
    private static final int IDEA_ID = 65529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65529Service() {
        this(new Idea65529Config());
    }

    public Idea65529Service(Idea65529Config config) {
        this.config = config != null ? config : new Idea65529Config();
