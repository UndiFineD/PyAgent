...
@Data
public class Idea65232Config {
    private String name = "idea_065232";
 ...
 */
@Slf4j
public class Idea65232Service {
    private static final int IDEA_ID = 65232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65232Service() {
        this(new Idea65232Config());
    }

    public Idea65232Service(Idea65232Config config) {
        this.config = config != null ? config : new Idea65232Config();
