...
@Data
public class Idea65225Config {
    private String name = "idea_065225";
 ...
 */
@Slf4j
public class Idea65225Service {
    private static final int IDEA_ID = 65225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65225Service() {
        this(new Idea65225Config());
    }

    public Idea65225Service(Idea65225Config config) {
        this.config = config != null ? config : new Idea65225Config();
