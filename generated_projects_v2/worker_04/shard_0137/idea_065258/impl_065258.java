...
@Data
public class Idea65258Config {
    private String name = "idea_065258";
 ...
 */
@Slf4j
public class Idea65258Service {
    private static final int IDEA_ID = 65258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65258Service() {
        this(new Idea65258Config());
    }

    public Idea65258Service(Idea65258Config config) {
        this.config = config != null ? config : new Idea65258Config();
