...
@Data
public class Idea65098Config {
    private String name = "idea_065098";
 ...
 */
@Slf4j
public class Idea65098Service {
    private static final int IDEA_ID = 65098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65098Service() {
        this(new Idea65098Config());
    }

    public Idea65098Service(Idea65098Config config) {
        this.config = config != null ? config : new Idea65098Config();
