...
@Data
public class Idea65255Config {
    private String name = "idea_065255";
 ...
 */
@Slf4j
public class Idea65255Service {
    private static final int IDEA_ID = 65255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65255Service() {
        this(new Idea65255Config());
    }

    public Idea65255Service(Idea65255Config config) {
        this.config = config != null ? config : new Idea65255Config();
