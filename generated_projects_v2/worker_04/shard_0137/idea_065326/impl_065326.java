...
@Data
public class Idea65326Config {
    private String name = "idea_065326";
 ...
 */
@Slf4j
public class Idea65326Service {
    private static final int IDEA_ID = 65326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65326Service() {
        this(new Idea65326Config());
    }

    public Idea65326Service(Idea65326Config config) {
        this.config = config != null ? config : new Idea65326Config();
