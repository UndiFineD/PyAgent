...
@Data
public class Idea65170Config {
    private String name = "idea_065170";
 ...
 */
@Slf4j
public class Idea65170Service {
    private static final int IDEA_ID = 65170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65170Service() {
        this(new Idea65170Config());
    }

    public Idea65170Service(Idea65170Config config) {
        this.config = config != null ? config : new Idea65170Config();
