...
@Data
public class Idea65451Config {
    private String name = "idea_065451";
 ...
 */
@Slf4j
public class Idea65451Service {
    private static final int IDEA_ID = 65451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65451Service() {
        this(new Idea65451Config());
    }

    public Idea65451Service(Idea65451Config config) {
        this.config = config != null ? config : new Idea65451Config();
