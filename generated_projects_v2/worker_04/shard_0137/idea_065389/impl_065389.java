...
@Data
public class Idea65389Config {
    private String name = "idea_065389";
 ...
 */
@Slf4j
public class Idea65389Service {
    private static final int IDEA_ID = 65389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65389Service() {
        this(new Idea65389Config());
    }

    public Idea65389Service(Idea65389Config config) {
        this.config = config != null ? config : new Idea65389Config();
