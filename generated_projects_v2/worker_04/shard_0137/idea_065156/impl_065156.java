...
@Data
public class Idea65156Config {
    private String name = "idea_065156";
 ...
 */
@Slf4j
public class Idea65156Service {
    private static final int IDEA_ID = 65156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65156Service() {
        this(new Idea65156Config());
    }

    public Idea65156Service(Idea65156Config config) {
        this.config = config != null ? config : new Idea65156Config();
