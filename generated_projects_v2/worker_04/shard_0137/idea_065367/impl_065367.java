...
@Data
public class Idea65367Config {
    private String name = "idea_065367";
 ...
 */
@Slf4j
public class Idea65367Service {
    private static final int IDEA_ID = 65367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65367Service() {
        this(new Idea65367Config());
    }

    public Idea65367Service(Idea65367Config config) {
        this.config = config != null ? config : new Idea65367Config();
