...
@Data
public class Idea65221Config {
    private String name = "idea_065221";
 ...
 */
@Slf4j
public class Idea65221Service {
    private static final int IDEA_ID = 65221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65221Service() {
        this(new Idea65221Config());
    }

    public Idea65221Service(Idea65221Config config) {
        this.config = config != null ? config : new Idea65221Config();
