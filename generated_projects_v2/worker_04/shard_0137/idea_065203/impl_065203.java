...
@Data
public class Idea65203Config {
    private String name = "idea_065203";
 ...
 */
@Slf4j
public class Idea65203Service {
    private static final int IDEA_ID = 65203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65203Service() {
        this(new Idea65203Config());
    }

    public Idea65203Service(Idea65203Config config) {
        this.config = config != null ? config : new Idea65203Config();
