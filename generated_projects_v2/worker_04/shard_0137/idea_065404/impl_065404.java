...
@Data
public class Idea65404Config {
    private String name = "idea_065404";
 ...
 */
@Slf4j
public class Idea65404Service {
    private static final int IDEA_ID = 65404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65404Service() {
        this(new Idea65404Config());
    }

    public Idea65404Service(Idea65404Config config) {
        this.config = config != null ? config : new Idea65404Config();
