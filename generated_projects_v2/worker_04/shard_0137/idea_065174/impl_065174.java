...
@Data
public class Idea65174Config {
    private String name = "idea_065174";
 ...
 */
@Slf4j
public class Idea65174Service {
    private static final int IDEA_ID = 65174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65174Service() {
        this(new Idea65174Config());
    }

    public Idea65174Service(Idea65174Config config) {
        this.config = config != null ? config : new Idea65174Config();
