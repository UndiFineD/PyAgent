...
@Data
public class Idea65133Config {
    private String name = "idea_065133";
 ...
 */
@Slf4j
public class Idea65133Service {
    private static final int IDEA_ID = 65133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65133Service() {
        this(new Idea65133Config());
    }

    public Idea65133Service(Idea65133Config config) {
        this.config = config != null ? config : new Idea65133Config();
