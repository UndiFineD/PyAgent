...
@Data
public class Idea65120Config {
    private String name = "idea_065120";
 ...
 */
@Slf4j
public class Idea65120Service {
    private static final int IDEA_ID = 65120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65120Service() {
        this(new Idea65120Config());
    }

    public Idea65120Service(Idea65120Config config) {
        this.config = config != null ? config : new Idea65120Config();
