...
@Data
public class Idea65458Config {
    private String name = "idea_065458";
 ...
 */
@Slf4j
public class Idea65458Service {
    private static final int IDEA_ID = 65458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65458Service() {
        this(new Idea65458Config());
    }

    public Idea65458Service(Idea65458Config config) {
        this.config = config != null ? config : new Idea65458Config();
