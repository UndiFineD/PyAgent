...
@Data
public class Idea65338Config {
    private String name = "idea_065338";
 ...
 */
@Slf4j
public class Idea65338Service {
    private static final int IDEA_ID = 65338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65338Service() {
        this(new Idea65338Config());
    }

    public Idea65338Service(Idea65338Config config) {
        this.config = config != null ? config : new Idea65338Config();
