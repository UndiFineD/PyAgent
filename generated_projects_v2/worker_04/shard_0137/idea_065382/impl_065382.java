...
@Data
public class Idea65382Config {
    private String name = "idea_065382";
 ...
 */
@Slf4j
public class Idea65382Service {
    private static final int IDEA_ID = 65382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65382Service() {
        this(new Idea65382Config());
    }

    public Idea65382Service(Idea65382Config config) {
        this.config = config != null ? config : new Idea65382Config();
