...
@Data
public class Idea65406Config {
    private String name = "idea_065406";
 ...
 */
@Slf4j
public class Idea65406Service {
    private static final int IDEA_ID = 65406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65406Service() {
        this(new Idea65406Config());
    }

    public Idea65406Service(Idea65406Config config) {
        this.config = config != null ? config : new Idea65406Config();
