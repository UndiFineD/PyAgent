...
@Data
public class Idea65080Config {
    private String name = "idea_065080";
 ...
 */
@Slf4j
public class Idea65080Service {
    private static final int IDEA_ID = 65080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65080Service() {
        this(new Idea65080Config());
    }

    public Idea65080Service(Idea65080Config config) {
        this.config = config != null ? config : new Idea65080Config();
