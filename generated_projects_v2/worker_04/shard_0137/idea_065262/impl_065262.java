...
@Data
public class Idea65262Config {
    private String name = "idea_065262";
 ...
 */
@Slf4j
public class Idea65262Service {
    private static final int IDEA_ID = 65262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65262Service() {
        this(new Idea65262Config());
    }

    public Idea65262Service(Idea65262Config config) {
        this.config = config != null ? config : new Idea65262Config();
