...
@Data
public class Idea65393Config {
    private String name = "idea_065393";
 ...
 */
@Slf4j
public class Idea65393Service {
    private static final int IDEA_ID = 65393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65393Service() {
        this(new Idea65393Config());
    }

    public Idea65393Service(Idea65393Config config) {
        this.config = config != null ? config : new Idea65393Config();
