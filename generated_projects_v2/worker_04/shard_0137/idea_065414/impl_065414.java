...
@Data
public class Idea65414Config {
    private String name = "idea_065414";
 ...
 */
@Slf4j
public class Idea65414Service {
    private static final int IDEA_ID = 65414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65414Service() {
        this(new Idea65414Config());
    }

    public Idea65414Service(Idea65414Config config) {
        this.config = config != null ? config : new Idea65414Config();
