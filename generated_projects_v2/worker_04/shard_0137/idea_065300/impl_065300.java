...
@Data
public class Idea65300Config {
    private String name = "idea_065300";
 ...
 */
@Slf4j
public class Idea65300Service {
    private static final int IDEA_ID = 65300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65300Service() {
        this(new Idea65300Config());
    }

    public Idea65300Service(Idea65300Config config) {
        this.config = config != null ? config : new Idea65300Config();
