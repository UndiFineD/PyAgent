...
@Data
public class Idea65311Config {
    private String name = "idea_065311";
 ...
 */
@Slf4j
public class Idea65311Service {
    private static final int IDEA_ID = 65311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65311Service() {
        this(new Idea65311Config());
    }

    public Idea65311Service(Idea65311Config config) {
        this.config = config != null ? config : new Idea65311Config();
