...
@Data
public class Idea65316Config {
    private String name = "idea_065316";
 ...
 */
@Slf4j
public class Idea65316Service {
    private static final int IDEA_ID = 65316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65316Service() {
        this(new Idea65316Config());
    }

    public Idea65316Service(Idea65316Config config) {
        this.config = config != null ? config : new Idea65316Config();
