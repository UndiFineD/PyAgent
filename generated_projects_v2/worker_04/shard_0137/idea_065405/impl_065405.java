...
@Data
public class Idea65405Config {
    private String name = "idea_065405";
 ...
 */
@Slf4j
public class Idea65405Service {
    private static final int IDEA_ID = 65405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65405Service() {
        this(new Idea65405Config());
    }

    public Idea65405Service(Idea65405Config config) {
        this.config = config != null ? config : new Idea65405Config();
