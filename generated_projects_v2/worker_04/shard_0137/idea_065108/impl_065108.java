...
@Data
public class Idea65108Config {
    private String name = "idea_065108";
 ...
 */
@Slf4j
public class Idea65108Service {
    private static final int IDEA_ID = 65108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65108Service() {
        this(new Idea65108Config());
    }

    public Idea65108Service(Idea65108Config config) {
        this.config = config != null ? config : new Idea65108Config();
