...
@Data
public class Idea65142Config {
    private String name = "idea_065142";
 ...
 */
@Slf4j
public class Idea65142Service {
    private static final int IDEA_ID = 65142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65142Service() {
        this(new Idea65142Config());
    }

    public Idea65142Service(Idea65142Config config) {
        this.config = config != null ? config : new Idea65142Config();
