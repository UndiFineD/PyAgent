...
@Data
public class Idea65275Config {
    private String name = "idea_065275";
 ...
 */
@Slf4j
public class Idea65275Service {
    private static final int IDEA_ID = 65275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65275Service() {
        this(new Idea65275Config());
    }

    public Idea65275Service(Idea65275Config config) {
        this.config = config != null ? config : new Idea65275Config();
