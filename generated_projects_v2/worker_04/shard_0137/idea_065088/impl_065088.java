...
@Data
public class Idea65088Config {
    private String name = "idea_065088";
 ...
 */
@Slf4j
public class Idea65088Service {
    private static final int IDEA_ID = 65088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65088Service() {
        this(new Idea65088Config());
    }

    public Idea65088Service(Idea65088Config config) {
        this.config = config != null ? config : new Idea65088Config();
