...
@Data
public class Idea65173Config {
    private String name = "idea_065173";
 ...
 */
@Slf4j
public class Idea65173Service {
    private static final int IDEA_ID = 65173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65173Service() {
        this(new Idea65173Config());
    }

    public Idea65173Service(Idea65173Config config) {
        this.config = config != null ? config : new Idea65173Config();
