...
@Data
public class Idea65465Config {
    private String name = "idea_065465";
 ...
 */
@Slf4j
public class Idea65465Service {
    private static final int IDEA_ID = 65465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65465Service() {
        this(new Idea65465Config());
    }

    public Idea65465Service(Idea65465Config config) {
        this.config = config != null ? config : new Idea65465Config();
