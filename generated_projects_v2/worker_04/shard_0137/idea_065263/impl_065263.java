...
@Data
public class Idea65263Config {
    private String name = "idea_065263";
 ...
 */
@Slf4j
public class Idea65263Service {
    private static final int IDEA_ID = 65263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65263Service() {
        this(new Idea65263Config());
    }

    public Idea65263Service(Idea65263Config config) {
        this.config = config != null ? config : new Idea65263Config();
