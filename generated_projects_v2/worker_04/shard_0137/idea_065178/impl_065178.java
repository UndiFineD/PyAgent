...
@Data
public class Idea65178Config {
    private String name = "idea_065178";
 ...
 */
@Slf4j
public class Idea65178Service {
    private static final int IDEA_ID = 65178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65178Service() {
        this(new Idea65178Config());
    }

    public Idea65178Service(Idea65178Config config) {
        this.config = config != null ? config : new Idea65178Config();
