...
@Data
public class Idea65371Config {
    private String name = "idea_065371";
 ...
 */
@Slf4j
public class Idea65371Service {
    private static final int IDEA_ID = 65371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65371Service() {
        this(new Idea65371Config());
    }

    public Idea65371Service(Idea65371Config config) {
        this.config = config != null ? config : new Idea65371Config();
