...
@Data
public class Idea65210Config {
    private String name = "idea_065210";
 ...
 */
@Slf4j
public class Idea65210Service {
    private static final int IDEA_ID = 65210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65210Service() {
        this(new Idea65210Config());
    }

    public Idea65210Service(Idea65210Config config) {
        this.config = config != null ? config : new Idea65210Config();
