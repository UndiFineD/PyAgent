...
@Data
public class Idea65427Config {
    private String name = "idea_065427";
 ...
 */
@Slf4j
public class Idea65427Service {
    private static final int IDEA_ID = 65427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65427Service() {
        this(new Idea65427Config());
    }

    public Idea65427Service(Idea65427Config config) {
        this.config = config != null ? config : new Idea65427Config();
