...
@Data
public class Idea65193Config {
    private String name = "idea_065193";
 ...
 */
@Slf4j
public class Idea65193Service {
    private static final int IDEA_ID = 65193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65193Service() {
        this(new Idea65193Config());
    }

    public Idea65193Service(Idea65193Config config) {
        this.config = config != null ? config : new Idea65193Config();
