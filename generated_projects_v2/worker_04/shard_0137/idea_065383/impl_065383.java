...
@Data
public class Idea65383Config {
    private String name = "idea_065383";
 ...
 */
@Slf4j
public class Idea65383Service {
    private static final int IDEA_ID = 65383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65383Service() {
        this(new Idea65383Config());
    }

    public Idea65383Service(Idea65383Config config) {
        this.config = config != null ? config : new Idea65383Config();
