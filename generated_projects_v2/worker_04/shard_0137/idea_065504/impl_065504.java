...
@Data
public class Idea65504Config {
    private String name = "idea_065504";
 ...
 */
@Slf4j
public class Idea65504Service {
    private static final int IDEA_ID = 65504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65504Service() {
        this(new Idea65504Config());
    }

    public Idea65504Service(Idea65504Config config) {
        this.config = config != null ? config : new Idea65504Config();
