...
@Data
public class Idea65237Config {
    private String name = "idea_065237";
 ...
 */
@Slf4j
public class Idea65237Service {
    private static final int IDEA_ID = 65237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65237Service() {
        this(new Idea65237Config());
    }

    public Idea65237Service(Idea65237Config config) {
        this.config = config != null ? config : new Idea65237Config();
