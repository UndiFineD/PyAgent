...
@Data
public class Idea65411Config {
    private String name = "idea_065411";
 ...
 */
@Slf4j
public class Idea65411Service {
    private static final int IDEA_ID = 65411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65411Service() {
        this(new Idea65411Config());
    }

    public Idea65411Service(Idea65411Config config) {
        this.config = config != null ? config : new Idea65411Config();
