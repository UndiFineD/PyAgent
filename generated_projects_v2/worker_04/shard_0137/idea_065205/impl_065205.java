...
@Data
public class Idea65205Config {
    private String name = "idea_065205";
 ...
 */
@Slf4j
public class Idea65205Service {
    private static final int IDEA_ID = 65205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65205Service() {
        this(new Idea65205Config());
    }

    public Idea65205Service(Idea65205Config config) {
        this.config = config != null ? config : new Idea65205Config();
