...
@Data
public class Idea65390Config {
    private String name = "idea_065390";
 ...
 */
@Slf4j
public class Idea65390Service {
    private static final int IDEA_ID = 65390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65390Service() {
        this(new Idea65390Config());
    }

    public Idea65390Service(Idea65390Config config) {
        this.config = config != null ? config : new Idea65390Config();
