...
@Data
public class Idea65306Config {
    private String name = "idea_065306";
 ...
 */
@Slf4j
public class Idea65306Service {
    private static final int IDEA_ID = 65306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65306Service() {
        this(new Idea65306Config());
    }

    public Idea65306Service(Idea65306Config config) {
        this.config = config != null ? config : new Idea65306Config();
