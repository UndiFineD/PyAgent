...
@Data
public class Idea65491Config {
    private String name = "idea_065491";
 ...
 */
@Slf4j
public class Idea65491Service {
    private static final int IDEA_ID = 65491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65491Service() {
        this(new Idea65491Config());
    }

    public Idea65491Service(Idea65491Config config) {
        this.config = config != null ? config : new Idea65491Config();
