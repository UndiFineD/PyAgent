...
@Data
public class Idea65537Config {
    private String name = "idea_065537";
 ...
 */
@Slf4j
public class Idea65537Service {
    private static final int IDEA_ID = 65537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65537Service() {
        this(new Idea65537Config());
    }

    public Idea65537Service(Idea65537Config config) {
        this.config = config != null ? config : new Idea65537Config();
