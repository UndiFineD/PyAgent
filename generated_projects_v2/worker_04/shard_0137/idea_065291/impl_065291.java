...
@Data
public class Idea65291Config {
    private String name = "idea_065291";
 ...
 */
@Slf4j
public class Idea65291Service {
    private static final int IDEA_ID = 65291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65291Service() {
        this(new Idea65291Config());
    }

    public Idea65291Service(Idea65291Config config) {
        this.config = config != null ? config : new Idea65291Config();
