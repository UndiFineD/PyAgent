...
@Data
public class Idea65445Config {
    private String name = "idea_065445";
 ...
 */
@Slf4j
public class Idea65445Service {
    private static final int IDEA_ID = 65445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65445Service() {
        this(new Idea65445Config());
    }

    public Idea65445Service(Idea65445Config config) {
        this.config = config != null ? config : new Idea65445Config();
