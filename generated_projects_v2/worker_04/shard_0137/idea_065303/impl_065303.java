...
@Data
public class Idea65303Config {
    private String name = "idea_065303";
 ...
 */
@Slf4j
public class Idea65303Service {
    private static final int IDEA_ID = 65303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65303Service() {
        this(new Idea65303Config());
    }

    public Idea65303Service(Idea65303Config config) {
        this.config = config != null ? config : new Idea65303Config();
