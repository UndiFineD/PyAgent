...
@Data
public class Idea65295Config {
    private String name = "idea_065295";
 ...
 */
@Slf4j
public class Idea65295Service {
    private static final int IDEA_ID = 65295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65295Service() {
        this(new Idea65295Config());
    }

    public Idea65295Service(Idea65295Config config) {
        this.config = config != null ? config : new Idea65295Config();
