...
@Data
public class Idea65424Config {
    private String name = "idea_065424";
 ...
 */
@Slf4j
public class Idea65424Service {
    private static final int IDEA_ID = 65424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65424Service() {
        this(new Idea65424Config());
    }

    public Idea65424Service(Idea65424Config config) {
        this.config = config != null ? config : new Idea65424Config();
