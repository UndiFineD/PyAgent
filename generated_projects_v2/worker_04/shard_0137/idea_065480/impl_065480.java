...
@Data
public class Idea65480Config {
    private String name = "idea_065480";
 ...
 */
@Slf4j
public class Idea65480Service {
    private static final int IDEA_ID = 65480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65480Service() {
        this(new Idea65480Config());
    }

    public Idea65480Service(Idea65480Config config) {
        this.config = config != null ? config : new Idea65480Config();
