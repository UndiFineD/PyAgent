...
@Data
public class Idea65086Config {
    private String name = "idea_065086";
 ...
 */
@Slf4j
public class Idea65086Service {
    private static final int IDEA_ID = 65086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65086Service() {
        this(new Idea65086Config());
    }

    public Idea65086Service(Idea65086Config config) {
        this.config = config != null ? config : new Idea65086Config();
