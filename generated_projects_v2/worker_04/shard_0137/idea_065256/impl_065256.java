...
@Data
public class Idea65256Config {
    private String name = "idea_065256";
 ...
 */
@Slf4j
public class Idea65256Service {
    private static final int IDEA_ID = 65256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65256Service() {
        this(new Idea65256Config());
    }

    public Idea65256Service(Idea65256Config config) {
        this.config = config != null ? config : new Idea65256Config();
