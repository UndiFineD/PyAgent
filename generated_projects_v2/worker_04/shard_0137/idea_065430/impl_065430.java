...
@Data
public class Idea65430Config {
    private String name = "idea_065430";
 ...
 */
@Slf4j
public class Idea65430Service {
    private static final int IDEA_ID = 65430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65430Service() {
        this(new Idea65430Config());
    }

    public Idea65430Service(Idea65430Config config) {
        this.config = config != null ? config : new Idea65430Config();
