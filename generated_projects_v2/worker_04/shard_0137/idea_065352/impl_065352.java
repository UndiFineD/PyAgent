...
@Data
public class Idea65352Config {
    private String name = "idea_065352";
 ...
 */
@Slf4j
public class Idea65352Service {
    private static final int IDEA_ID = 65352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65352Service() {
        this(new Idea65352Config());
    }

    public Idea65352Service(Idea65352Config config) {
        this.config = config != null ? config : new Idea65352Config();
