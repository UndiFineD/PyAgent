...
@Data
public class Idea65102Config {
    private String name = "idea_065102";
 ...
 */
@Slf4j
public class Idea65102Service {
    private static final int IDEA_ID = 65102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65102Service() {
        this(new Idea65102Config());
    }

    public Idea65102Service(Idea65102Config config) {
        this.config = config != null ? config : new Idea65102Config();
