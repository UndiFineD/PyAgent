...
@Data
public class Idea65455Config {
    private String name = "idea_065455";
 ...
 */
@Slf4j
public class Idea65455Service {
    private static final int IDEA_ID = 65455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65455Service() {
        this(new Idea65455Config());
    }

    public Idea65455Service(Idea65455Config config) {
        this.config = config != null ? config : new Idea65455Config();
