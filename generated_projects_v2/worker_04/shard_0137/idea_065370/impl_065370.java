...
@Data
public class Idea65370Config {
    private String name = "idea_065370";
 ...
 */
@Slf4j
public class Idea65370Service {
    private static final int IDEA_ID = 65370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65370Service() {
        this(new Idea65370Config());
    }

    public Idea65370Service(Idea65370Config config) {
        this.config = config != null ? config : new Idea65370Config();
