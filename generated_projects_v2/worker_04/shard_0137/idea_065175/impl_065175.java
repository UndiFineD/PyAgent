...
@Data
public class Idea65175Config {
    private String name = "idea_065175";
 ...
 */
@Slf4j
public class Idea65175Service {
    private static final int IDEA_ID = 65175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65175Service() {
        this(new Idea65175Config());
    }

    public Idea65175Service(Idea65175Config config) {
        this.config = config != null ? config : new Idea65175Config();
