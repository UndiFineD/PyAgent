...
@Data
public class Idea65212Config {
    private String name = "idea_065212";
 ...
 */
@Slf4j
public class Idea65212Service {
    private static final int IDEA_ID = 65212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65212Service() {
        this(new Idea65212Config());
    }

    public Idea65212Service(Idea65212Config config) {
        this.config = config != null ? config : new Idea65212Config();
