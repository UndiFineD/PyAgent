...
@Data
public class Idea65167Config {
    private String name = "idea_065167";
 ...
 */
@Slf4j
public class Idea65167Service {
    private static final int IDEA_ID = 65167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65167Service() {
        this(new Idea65167Config());
    }

    public Idea65167Service(Idea65167Config config) {
        this.config = config != null ? config : new Idea65167Config();
