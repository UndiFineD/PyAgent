...
@Data
public class Idea65259Config {
    private String name = "idea_065259";
 ...
 */
@Slf4j
public class Idea65259Service {
    private static final int IDEA_ID = 65259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65259Service() {
        this(new Idea65259Config());
    }

    public Idea65259Service(Idea65259Config config) {
        this.config = config != null ? config : new Idea65259Config();
