...
@Data
public class Idea65325Config {
    private String name = "idea_065325";
 ...
 */
@Slf4j
public class Idea65325Service {
    private static final int IDEA_ID = 65325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65325Service() {
        this(new Idea65325Config());
    }

    public Idea65325Service(Idea65325Config config) {
        this.config = config != null ? config : new Idea65325Config();
