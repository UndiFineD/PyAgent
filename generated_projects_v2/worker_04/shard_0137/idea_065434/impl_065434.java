...
@Data
public class Idea65434Config {
    private String name = "idea_065434";
 ...
 */
@Slf4j
public class Idea65434Service {
    private static final int IDEA_ID = 65434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65434Service() {
        this(new Idea65434Config());
    }

    public Idea65434Service(Idea65434Config config) {
        this.config = config != null ? config : new Idea65434Config();
