...
@Data
public class Idea65081Config {
    private String name = "idea_065081";
 ...
 */
@Slf4j
public class Idea65081Service {
    private static final int IDEA_ID = 65081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65081Service() {
        this(new Idea65081Config());
    }

    public Idea65081Service(Idea65081Config config) {
        this.config = config != null ? config : new Idea65081Config();
