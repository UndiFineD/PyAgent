...
@Data
public class Idea65394Config {
    private String name = "idea_065394";
 ...
 */
@Slf4j
public class Idea65394Service {
    private static final int IDEA_ID = 65394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65394Service() {
        this(new Idea65394Config());
    }

    public Idea65394Service(Idea65394Config config) {
        this.config = config != null ? config : new Idea65394Config();
