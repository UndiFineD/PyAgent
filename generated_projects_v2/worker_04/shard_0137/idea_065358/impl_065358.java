...
@Data
public class Idea65358Config {
    private String name = "idea_065358";
 ...
 */
@Slf4j
public class Idea65358Service {
    private static final int IDEA_ID = 65358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65358Service() {
        this(new Idea65358Config());
    }

    public Idea65358Service(Idea65358Config config) {
        this.config = config != null ? config : new Idea65358Config();
