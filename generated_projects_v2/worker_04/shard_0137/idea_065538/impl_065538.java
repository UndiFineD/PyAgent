...
@Data
public class Idea65538Config {
    private String name = "idea_065538";
 ...
 */
@Slf4j
public class Idea65538Service {
    private static final int IDEA_ID = 65538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65538Service() {
        this(new Idea65538Config());
    }

    public Idea65538Service(Idea65538Config config) {
        this.config = config != null ? config : new Idea65538Config();
