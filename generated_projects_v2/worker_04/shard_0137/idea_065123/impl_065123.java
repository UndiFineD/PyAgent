...
@Data
public class Idea65123Config {
    private String name = "idea_065123";
 ...
 */
@Slf4j
public class Idea65123Service {
    private static final int IDEA_ID = 65123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65123Service() {
        this(new Idea65123Config());
    }

    public Idea65123Service(Idea65123Config config) {
        this.config = config != null ? config : new Idea65123Config();
