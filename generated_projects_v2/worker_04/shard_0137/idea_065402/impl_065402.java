...
@Data
public class Idea65402Config {
    private String name = "idea_065402";
 ...
 */
@Slf4j
public class Idea65402Service {
    private static final int IDEA_ID = 65402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65402Service() {
        this(new Idea65402Config());
    }

    public Idea65402Service(Idea65402Config config) {
        this.config = config != null ? config : new Idea65402Config();
