...
@Data
public class Idea65222Config {
    private String name = "idea_065222";
 ...
 */
@Slf4j
public class Idea65222Service {
    private static final int IDEA_ID = 65222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65222Service() {
        this(new Idea65222Config());
    }

    public Idea65222Service(Idea65222Config config) {
        this.config = config != null ? config : new Idea65222Config();
