...
@Data
public class Idea65413Config {
    private String name = "idea_065413";
 ...
 */
@Slf4j
public class Idea65413Service {
    private static final int IDEA_ID = 65413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65413Service() {
        this(new Idea65413Config());
    }

    public Idea65413Service(Idea65413Config config) {
        this.config = config != null ? config : new Idea65413Config();
