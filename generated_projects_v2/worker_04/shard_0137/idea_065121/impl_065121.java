...
@Data
public class Idea65121Config {
    private String name = "idea_065121";
 ...
 */
@Slf4j
public class Idea65121Service {
    private static final int IDEA_ID = 65121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65121Service() {
        this(new Idea65121Config());
    }

    public Idea65121Service(Idea65121Config config) {
        this.config = config != null ? config : new Idea65121Config();
