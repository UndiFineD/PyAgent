...
@Data
public class Idea65391Config {
    private String name = "idea_065391";
 ...
 */
@Slf4j
public class Idea65391Service {
    private static final int IDEA_ID = 65391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65391Service() {
        this(new Idea65391Config());
    }

    public Idea65391Service(Idea65391Config config) {
        this.config = config != null ? config : new Idea65391Config();
