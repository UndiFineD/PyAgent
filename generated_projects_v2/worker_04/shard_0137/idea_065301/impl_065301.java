...
@Data
public class Idea65301Config {
    private String name = "idea_065301";
 ...
 */
@Slf4j
public class Idea65301Service {
    private static final int IDEA_ID = 65301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65301Service() {
        this(new Idea65301Config());
    }

    public Idea65301Service(Idea65301Config config) {
        this.config = config != null ? config : new Idea65301Config();
