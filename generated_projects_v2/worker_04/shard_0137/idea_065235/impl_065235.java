...
@Data
public class Idea65235Config {
    private String name = "idea_065235";
 ...
 */
@Slf4j
public class Idea65235Service {
    private static final int IDEA_ID = 65235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65235Service() {
        this(new Idea65235Config());
    }

    public Idea65235Service(Idea65235Config config) {
        this.config = config != null ? config : new Idea65235Config();
