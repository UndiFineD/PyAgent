...
@Data
public class Idea65372Config {
    private String name = "idea_065372";
 ...
 */
@Slf4j
public class Idea65372Service {
    private static final int IDEA_ID = 65372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65372Service() {
        this(new Idea65372Config());
    }

    public Idea65372Service(Idea65372Config config) {
        this.config = config != null ? config : new Idea65372Config();
