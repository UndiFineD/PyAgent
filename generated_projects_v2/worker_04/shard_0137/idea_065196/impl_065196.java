...
@Data
public class Idea65196Config {
    private String name = "idea_065196";
 ...
 */
@Slf4j
public class Idea65196Service {
    private static final int IDEA_ID = 65196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65196Service() {
        this(new Idea65196Config());
    }

    public Idea65196Service(Idea65196Config config) {
        this.config = config != null ? config : new Idea65196Config();
