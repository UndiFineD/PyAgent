...
@Data
public class Idea65526Config {
    private String name = "idea_065526";
 ...
 */
@Slf4j
public class Idea65526Service {
    private static final int IDEA_ID = 65526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65526Service() {
        this(new Idea65526Config());
    }

    public Idea65526Service(Idea65526Config config) {
        this.config = config != null ? config : new Idea65526Config();
