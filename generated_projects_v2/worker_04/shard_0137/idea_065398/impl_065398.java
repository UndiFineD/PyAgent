...
@Data
public class Idea65398Config {
    private String name = "idea_065398";
 ...
 */
@Slf4j
public class Idea65398Service {
    private static final int IDEA_ID = 65398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65398Service() {
        this(new Idea65398Config());
    }

    public Idea65398Service(Idea65398Config config) {
        this.config = config != null ? config : new Idea65398Config();
