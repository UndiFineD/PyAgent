...
@Data
public class Idea65416Config {
    private String name = "idea_065416";
 ...
 */
@Slf4j
public class Idea65416Service {
    private static final int IDEA_ID = 65416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65416Service() {
        this(new Idea65416Config());
    }

    public Idea65416Service(Idea65416Config config) {
        this.config = config != null ? config : new Idea65416Config();
