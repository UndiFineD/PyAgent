...
@Data
public class Idea65226Config {
    private String name = "idea_065226";
 ...
 */
@Slf4j
public class Idea65226Service {
    private static final int IDEA_ID = 65226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65226Service() {
        this(new Idea65226Config());
    }

    public Idea65226Service(Idea65226Config config) {
        this.config = config != null ? config : new Idea65226Config();
