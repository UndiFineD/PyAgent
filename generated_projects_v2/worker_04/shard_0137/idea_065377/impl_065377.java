...
@Data
public class Idea65377Config {
    private String name = "idea_065377";
 ...
 */
@Slf4j
public class Idea65377Service {
    private static final int IDEA_ID = 65377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65377Service() {
        this(new Idea65377Config());
    }

    public Idea65377Service(Idea65377Config config) {
        this.config = config != null ? config : new Idea65377Config();
