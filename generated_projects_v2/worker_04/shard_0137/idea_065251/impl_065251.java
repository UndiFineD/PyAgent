...
@Data
public class Idea65251Config {
    private String name = "idea_065251";
 ...
 */
@Slf4j
public class Idea65251Service {
    private static final int IDEA_ID = 65251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65251Service() {
        this(new Idea65251Config());
    }

    public Idea65251Service(Idea65251Config config) {
        this.config = config != null ? config : new Idea65251Config();
