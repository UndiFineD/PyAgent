...
@Data
public class Idea65350Config {
    private String name = "idea_065350";
 ...
 */
@Slf4j
public class Idea65350Service {
    private static final int IDEA_ID = 65350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65350Service() {
        this(new Idea65350Config());
    }

    public Idea65350Service(Idea65350Config config) {
        this.config = config != null ? config : new Idea65350Config();
