...
@Data
public class Idea65304Config {
    private String name = "idea_065304";
 ...
 */
@Slf4j
public class Idea65304Service {
    private static final int IDEA_ID = 65304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65304Service() {
        this(new Idea65304Config());
    }

    public Idea65304Service(Idea65304Config config) {
        this.config = config != null ? config : new Idea65304Config();
