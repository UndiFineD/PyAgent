...
@Data
public class Idea65136Config {
    private String name = "idea_065136";
 ...
 */
@Slf4j
public class Idea65136Service {
    private static final int IDEA_ID = 65136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65136Service() {
        this(new Idea65136Config());
    }

    public Idea65136Service(Idea65136Config config) {
        this.config = config != null ? config : new Idea65136Config();
