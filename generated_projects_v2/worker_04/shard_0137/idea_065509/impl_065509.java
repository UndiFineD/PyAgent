...
@Data
public class Idea65509Config {
    private String name = "idea_065509";
 ...
 */
@Slf4j
public class Idea65509Service {
    private static final int IDEA_ID = 65509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65509Service() {
        this(new Idea65509Config());
    }

    public Idea65509Service(Idea65509Config config) {
        this.config = config != null ? config : new Idea65509Config();
