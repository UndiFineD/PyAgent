...
@Data
public class Idea65186Config {
    private String name = "idea_065186";
 ...
 */
@Slf4j
public class Idea65186Service {
    private static final int IDEA_ID = 65186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65186Service() {
        this(new Idea65186Config());
    }

    public Idea65186Service(Idea65186Config config) {
        this.config = config != null ? config : new Idea65186Config();
