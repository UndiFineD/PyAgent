...
@Data
public class Idea65307Config {
    private String name = "idea_065307";
 ...
 */
@Slf4j
public class Idea65307Service {
    private static final int IDEA_ID = 65307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65307Service() {
        this(new Idea65307Config());
    }

    public Idea65307Service(Idea65307Config config) {
        this.config = config != null ? config : new Idea65307Config();
