...
@Data
public class Idea65127Config {
    private String name = "idea_065127";
 ...
 */
@Slf4j
public class Idea65127Service {
    private static final int IDEA_ID = 65127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65127Service() {
        this(new Idea65127Config());
    }

    public Idea65127Service(Idea65127Config config) {
        this.config = config != null ? config : new Idea65127Config();
