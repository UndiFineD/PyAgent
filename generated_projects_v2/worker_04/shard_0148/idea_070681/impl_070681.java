...
@Data
public class Idea70681Config {
    private String name = "idea_070681";
 ...
 */
@Slf4j
public class Idea70681Service {
    private static final int IDEA_ID = 70681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70681Service() {
        this(new Idea70681Config());
    }

    public Idea70681Service(Idea70681Config config) {
        this.config = config != null ? config : new Idea70681Config();
