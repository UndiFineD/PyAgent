...
@Data
public class Idea70697Config {
    private String name = "idea_070697";
 ...
 */
@Slf4j
public class Idea70697Service {
    private static final int IDEA_ID = 70697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70697Service() {
        this(new Idea70697Config());
    }

    public Idea70697Service(Idea70697Config config) {
        this.config = config != null ? config : new Idea70697Config();
