...
@Data
public class Idea70703Config {
    private String name = "idea_070703";
 ...
 */
@Slf4j
public class Idea70703Service {
    private static final int IDEA_ID = 70703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70703Service() {
        this(new Idea70703Config());
    }

    public Idea70703Service(Idea70703Config config) {
        this.config = config != null ? config : new Idea70703Config();
