...
@Data
public class Idea70747Config {
    private String name = "idea_070747";
 ...
 */
@Slf4j
public class Idea70747Service {
    private static final int IDEA_ID = 70747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70747Service() {
        this(new Idea70747Config());
    }

    public Idea70747Service(Idea70747Config config) {
        this.config = config != null ? config : new Idea70747Config();
