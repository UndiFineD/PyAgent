...
@Data
public class Idea70643Config {
    private String name = "idea_070643";
 ...
 */
@Slf4j
public class Idea70643Service {
    private static final int IDEA_ID = 70643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70643Service() {
        this(new Idea70643Config());
    }

    public Idea70643Service(Idea70643Config config) {
        this.config = config != null ? config : new Idea70643Config();
