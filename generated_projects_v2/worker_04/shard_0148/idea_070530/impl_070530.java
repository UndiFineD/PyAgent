...
@Data
public class Idea70530Config {
    private String name = "idea_070530";
 ...
 */
@Slf4j
public class Idea70530Service {
    private static final int IDEA_ID = 70530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70530Service() {
        this(new Idea70530Config());
    }

    public Idea70530Service(Idea70530Config config) {
        this.config = config != null ? config : new Idea70530Config();
