...
@Data
public class Idea70728Config {
    private String name = "idea_070728";
 ...
 */
@Slf4j
public class Idea70728Service {
    private static final int IDEA_ID = 70728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70728Service() {
        this(new Idea70728Config());
    }

    public Idea70728Service(Idea70728Config config) {
        this.config = config != null ? config : new Idea70728Config();
