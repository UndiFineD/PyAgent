...
@Data
public class Idea70592Config {
    private String name = "idea_070592";
 ...
 */
@Slf4j
public class Idea70592Service {
    private static final int IDEA_ID = 70592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70592Service() {
        this(new Idea70592Config());
    }

    public Idea70592Service(Idea70592Config config) {
        this.config = config != null ? config : new Idea70592Config();
