...
@Data
public class Idea70359Config {
    private String name = "idea_070359";
 ...
 */
@Slf4j
public class Idea70359Service {
    private static final int IDEA_ID = 70359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70359Service() {
        this(new Idea70359Config());
    }

    public Idea70359Service(Idea70359Config config) {
        this.config = config != null ? config : new Idea70359Config();
