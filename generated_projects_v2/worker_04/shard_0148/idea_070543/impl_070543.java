...
@Data
public class Idea70543Config {
    private String name = "idea_070543";
 ...
 */
@Slf4j
public class Idea70543Service {
    private static final int IDEA_ID = 70543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70543Service() {
        this(new Idea70543Config());
    }

    public Idea70543Service(Idea70543Config config) {
        this.config = config != null ? config : new Idea70543Config();
