...
@Data
public class Idea70724Config {
    private String name = "idea_070724";
 ...
 */
@Slf4j
public class Idea70724Service {
    private static final int IDEA_ID = 70724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70724Service() {
        this(new Idea70724Config());
    }

    public Idea70724Service(Idea70724Config config) {
        this.config = config != null ? config : new Idea70724Config();
