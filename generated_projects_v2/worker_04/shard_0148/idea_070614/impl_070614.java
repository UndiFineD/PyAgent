...
@Data
public class Idea70614Config {
    private String name = "idea_070614";
 ...
 */
@Slf4j
public class Idea70614Service {
    private static final int IDEA_ID = 70614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70614Service() {
        this(new Idea70614Config());
    }

    public Idea70614Service(Idea70614Config config) {
        this.config = config != null ? config : new Idea70614Config();
