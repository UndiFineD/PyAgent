...
@Data
public class Idea70585Config {
    private String name = "idea_070585";
 ...
 */
@Slf4j
public class Idea70585Service {
    private static final int IDEA_ID = 70585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70585Service() {
        this(new Idea70585Config());
    }

    public Idea70585Service(Idea70585Config config) {
        this.config = config != null ? config : new Idea70585Config();
