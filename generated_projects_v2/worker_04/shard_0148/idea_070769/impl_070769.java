...
@Data
public class Idea70769Config {
    private String name = "idea_070769";
 ...
 */
@Slf4j
public class Idea70769Service {
    private static final int IDEA_ID = 70769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70769Service() {
        this(new Idea70769Config());
    }

    public Idea70769Service(Idea70769Config config) {
        this.config = config != null ? config : new Idea70769Config();
