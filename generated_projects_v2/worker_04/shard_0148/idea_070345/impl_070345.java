...
@Data
public class Idea70345Config {
    private String name = "idea_070345";
 ...
 */
@Slf4j
public class Idea70345Service {
    private static final int IDEA_ID = 70345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70345Service() {
        this(new Idea70345Config());
    }

    public Idea70345Service(Idea70345Config config) {
        this.config = config != null ? config : new Idea70345Config();
