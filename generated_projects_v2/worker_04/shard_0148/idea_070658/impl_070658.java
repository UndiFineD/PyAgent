...
@Data
public class Idea70658Config {
    private String name = "idea_070658";
 ...
 */
@Slf4j
public class Idea70658Service {
    private static final int IDEA_ID = 70658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70658Service() {
        this(new Idea70658Config());
    }

    public Idea70658Service(Idea70658Config config) {
        this.config = config != null ? config : new Idea70658Config();
