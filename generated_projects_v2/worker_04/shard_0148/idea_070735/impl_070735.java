...
@Data
public class Idea70735Config {
    private String name = "idea_070735";
 ...
 */
@Slf4j
public class Idea70735Service {
    private static final int IDEA_ID = 70735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70735Service() {
        this(new Idea70735Config());
    }

    public Idea70735Service(Idea70735Config config) {
        this.config = config != null ? config : new Idea70735Config();
