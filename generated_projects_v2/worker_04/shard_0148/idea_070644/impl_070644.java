...
@Data
public class Idea70644Config {
    private String name = "idea_070644";
 ...
 */
@Slf4j
public class Idea70644Service {
    private static final int IDEA_ID = 70644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70644Service() {
        this(new Idea70644Config());
    }

    public Idea70644Service(Idea70644Config config) {
        this.config = config != null ? config : new Idea70644Config();
