...
@Data
public class Idea70450Config {
    private String name = "idea_070450";
 ...
 */
@Slf4j
public class Idea70450Service {
    private static final int IDEA_ID = 70450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70450Service() {
        this(new Idea70450Config());
    }

    public Idea70450Service(Idea70450Config config) {
        this.config = config != null ? config : new Idea70450Config();
