...
@Data
public class Idea70553Config {
    private String name = "idea_070553";
 ...
 */
@Slf4j
public class Idea70553Service {
    private static final int IDEA_ID = 70553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70553Service() {
        this(new Idea70553Config());
    }

    public Idea70553Service(Idea70553Config config) {
        this.config = config != null ? config : new Idea70553Config();
