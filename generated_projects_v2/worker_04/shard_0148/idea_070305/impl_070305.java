...
@Data
public class Idea70305Config {
    private String name = "idea_070305";
 ...
 */
@Slf4j
public class Idea70305Service {
    private static final int IDEA_ID = 70305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70305Service() {
        this(new Idea70305Config());
    }

    public Idea70305Service(Idea70305Config config) {
        this.config = config != null ? config : new Idea70305Config();
