...
@Data
public class Idea70361Config {
    private String name = "idea_070361";
 ...
 */
@Slf4j
public class Idea70361Service {
    private static final int IDEA_ID = 70361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70361Service() {
        this(new Idea70361Config());
    }

    public Idea70361Service(Idea70361Config config) {
        this.config = config != null ? config : new Idea70361Config();
