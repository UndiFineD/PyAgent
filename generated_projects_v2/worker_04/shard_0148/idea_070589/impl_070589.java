...
@Data
public class Idea70589Config {
    private String name = "idea_070589";
 ...
 */
@Slf4j
public class Idea70589Service {
    private static final int IDEA_ID = 70589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70589Service() {
        this(new Idea70589Config());
    }

    public Idea70589Service(Idea70589Config config) {
        this.config = config != null ? config : new Idea70589Config();
