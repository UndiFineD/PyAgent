...
@Data
public class Idea70555Config {
    private String name = "idea_070555";
 ...
 */
@Slf4j
public class Idea70555Service {
    private static final int IDEA_ID = 70555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70555Service() {
        this(new Idea70555Config());
    }

    public Idea70555Service(Idea70555Config config) {
        this.config = config != null ? config : new Idea70555Config();
