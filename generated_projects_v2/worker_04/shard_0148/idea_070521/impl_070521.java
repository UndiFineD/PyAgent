...
@Data
public class Idea70521Config {
    private String name = "idea_070521";
 ...
 */
@Slf4j
public class Idea70521Service {
    private static final int IDEA_ID = 70521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70521Service() {
        this(new Idea70521Config());
    }

    public Idea70521Service(Idea70521Config config) {
        this.config = config != null ? config : new Idea70521Config();
