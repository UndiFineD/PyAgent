...
@Data
public class Idea70755Config {
    private String name = "idea_070755";
 ...
 */
@Slf4j
public class Idea70755Service {
    private static final int IDEA_ID = 70755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70755Service() {
        this(new Idea70755Config());
    }

    public Idea70755Service(Idea70755Config config) {
        this.config = config != null ? config : new Idea70755Config();
