...
@Data
public class Idea70745Config {
    private String name = "idea_070745";
 ...
 */
@Slf4j
public class Idea70745Service {
    private static final int IDEA_ID = 70745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70745Service() {
        this(new Idea70745Config());
    }

    public Idea70745Service(Idea70745Config config) {
        this.config = config != null ? config : new Idea70745Config();
