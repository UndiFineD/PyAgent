...
@Data
public class Idea70616Config {
    private String name = "idea_070616";
 ...
 */
@Slf4j
public class Idea70616Service {
    private static final int IDEA_ID = 70616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70616Service() {
        this(new Idea70616Config());
    }

    public Idea70616Service(Idea70616Config config) {
        this.config = config != null ? config : new Idea70616Config();
