...
@Data
public class Idea70481Config {
    private String name = "idea_070481";
 ...
 */
@Slf4j
public class Idea70481Service {
    private static final int IDEA_ID = 70481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70481Service() {
        this(new Idea70481Config());
    }

    public Idea70481Service(Idea70481Config config) {
        this.config = config != null ? config : new Idea70481Config();
