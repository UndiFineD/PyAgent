...
@Data
public class Idea70674Config {
    private String name = "idea_070674";
 ...
 */
@Slf4j
public class Idea70674Service {
    private static final int IDEA_ID = 70674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70674Service() {
        this(new Idea70674Config());
    }

    public Idea70674Service(Idea70674Config config) {
        this.config = config != null ? config : new Idea70674Config();
