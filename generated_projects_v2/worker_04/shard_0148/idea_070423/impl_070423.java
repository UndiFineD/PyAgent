...
@Data
public class Idea70423Config {
    private String name = "idea_070423";
 ...
 */
@Slf4j
public class Idea70423Service {
    private static final int IDEA_ID = 70423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70423Service() {
        this(new Idea70423Config());
    }

    public Idea70423Service(Idea70423Config config) {
        this.config = config != null ? config : new Idea70423Config();
