...
@Data
public class Idea70373Config {
    private String name = "idea_070373";
 ...
 */
@Slf4j
public class Idea70373Service {
    private static final int IDEA_ID = 70373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70373Service() {
        this(new Idea70373Config());
    }

    public Idea70373Service(Idea70373Config config) {
        this.config = config != null ? config : new Idea70373Config();
