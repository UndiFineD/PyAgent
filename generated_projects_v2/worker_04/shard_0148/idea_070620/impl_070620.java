...
@Data
public class Idea70620Config {
    private String name = "idea_070620";
 ...
 */
@Slf4j
public class Idea70620Service {
    private static final int IDEA_ID = 70620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70620Service() {
        this(new Idea70620Config());
    }

    public Idea70620Service(Idea70620Config config) {
        this.config = config != null ? config : new Idea70620Config();
