...
@Data
public class Idea70766Config {
    private String name = "idea_070766";
 ...
 */
@Slf4j
public class Idea70766Service {
    private static final int IDEA_ID = 70766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70766Service() {
        this(new Idea70766Config());
    }

    public Idea70766Service(Idea70766Config config) {
        this.config = config != null ? config : new Idea70766Config();
