...
@Data
public class Idea70406Config {
    private String name = "idea_070406";
 ...
 */
@Slf4j
public class Idea70406Service {
    private static final int IDEA_ID = 70406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70406Service() {
        this(new Idea70406Config());
    }

    public Idea70406Service(Idea70406Config config) {
        this.config = config != null ? config : new Idea70406Config();
