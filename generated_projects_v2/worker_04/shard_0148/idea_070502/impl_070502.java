...
@Data
public class Idea70502Config {
    private String name = "idea_070502";
 ...
 */
@Slf4j
public class Idea70502Service {
    private static final int IDEA_ID = 70502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70502Service() {
        this(new Idea70502Config());
    }

    public Idea70502Service(Idea70502Config config) {
        this.config = config != null ? config : new Idea70502Config();
