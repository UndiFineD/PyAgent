...
@Data
public class Idea70461Config {
    private String name = "idea_070461";
 ...
 */
@Slf4j
public class Idea70461Service {
    private static final int IDEA_ID = 70461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70461Service() {
        this(new Idea70461Config());
    }

    public Idea70461Service(Idea70461Config config) {
        this.config = config != null ? config : new Idea70461Config();
