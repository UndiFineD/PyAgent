...
@Data
public class Idea70717Config {
    private String name = "idea_070717";
 ...
 */
@Slf4j
public class Idea70717Service {
    private static final int IDEA_ID = 70717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70717Service() {
        this(new Idea70717Config());
    }

    public Idea70717Service(Idea70717Config config) {
        this.config = config != null ? config : new Idea70717Config();
