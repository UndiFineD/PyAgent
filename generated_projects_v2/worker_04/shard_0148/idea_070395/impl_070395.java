...
@Data
public class Idea70395Config {
    private String name = "idea_070395";
 ...
 */
@Slf4j
public class Idea70395Service {
    private static final int IDEA_ID = 70395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70395Service() {
        this(new Idea70395Config());
    }

    public Idea70395Service(Idea70395Config config) {
        this.config = config != null ? config : new Idea70395Config();
