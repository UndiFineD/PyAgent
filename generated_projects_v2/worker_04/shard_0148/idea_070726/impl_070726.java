...
@Data
public class Idea70726Config {
    private String name = "idea_070726";
 ...
 */
@Slf4j
public class Idea70726Service {
    private static final int IDEA_ID = 70726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70726Service() {
        this(new Idea70726Config());
    }

    public Idea70726Service(Idea70726Config config) {
        this.config = config != null ? config : new Idea70726Config();
