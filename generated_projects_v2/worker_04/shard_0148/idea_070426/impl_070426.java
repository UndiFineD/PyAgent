...
@Data
public class Idea70426Config {
    private String name = "idea_070426";
 ...
 */
@Slf4j
public class Idea70426Service {
    private static final int IDEA_ID = 70426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70426Service() {
        this(new Idea70426Config());
    }

    public Idea70426Service(Idea70426Config config) {
        this.config = config != null ? config : new Idea70426Config();
