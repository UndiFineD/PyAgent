...
@Data
public class Idea70731Config {
    private String name = "idea_070731";
 ...
 */
@Slf4j
public class Idea70731Service {
    private static final int IDEA_ID = 70731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70731Service() {
        this(new Idea70731Config());
    }

    public Idea70731Service(Idea70731Config config) {
        this.config = config != null ? config : new Idea70731Config();
