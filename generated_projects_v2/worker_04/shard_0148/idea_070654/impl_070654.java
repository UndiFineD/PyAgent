...
@Data
public class Idea70654Config {
    private String name = "idea_070654";
 ...
 */
@Slf4j
public class Idea70654Service {
    private static final int IDEA_ID = 70654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70654Service() {
        this(new Idea70654Config());
    }

    public Idea70654Service(Idea70654Config config) {
        this.config = config != null ? config : new Idea70654Config();
