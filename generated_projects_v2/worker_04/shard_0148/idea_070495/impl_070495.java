...
@Data
public class Idea70495Config {
    private String name = "idea_070495";
 ...
 */
@Slf4j
public class Idea70495Service {
    private static final int IDEA_ID = 70495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70495Service() {
        this(new Idea70495Config());
    }

    public Idea70495Service(Idea70495Config config) {
        this.config = config != null ? config : new Idea70495Config();
