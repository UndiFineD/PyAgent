...
@Data
public class Idea70613Config {
    private String name = "idea_070613";
 ...
 */
@Slf4j
public class Idea70613Service {
    private static final int IDEA_ID = 70613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70613Service() {
        this(new Idea70613Config());
    }

    public Idea70613Service(Idea70613Config config) {
        this.config = config != null ? config : new Idea70613Config();
