...
@Data
public class Idea70380Config {
    private String name = "idea_070380";
 ...
 */
@Slf4j
public class Idea70380Service {
    private static final int IDEA_ID = 70380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70380Service() {
        this(new Idea70380Config());
    }

    public Idea70380Service(Idea70380Config config) {
        this.config = config != null ? config : new Idea70380Config();
