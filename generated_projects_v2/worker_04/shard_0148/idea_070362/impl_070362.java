...
@Data
public class Idea70362Config {
    private String name = "idea_070362";
 ...
 */
@Slf4j
public class Idea70362Service {
    private static final int IDEA_ID = 70362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70362Service() {
        this(new Idea70362Config());
    }

    public Idea70362Service(Idea70362Config config) {
        this.config = config != null ? config : new Idea70362Config();
