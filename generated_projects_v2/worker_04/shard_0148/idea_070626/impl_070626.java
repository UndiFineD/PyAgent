...
@Data
public class Idea70626Config {
    private String name = "idea_070626";
 ...
 */
@Slf4j
public class Idea70626Service {
    private static final int IDEA_ID = 70626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70626Service() {
        this(new Idea70626Config());
    }

    public Idea70626Service(Idea70626Config config) {
        this.config = config != null ? config : new Idea70626Config();
