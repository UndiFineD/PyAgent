...
@Data
public class Idea70338Config {
    private String name = "idea_070338";
 ...
 */
@Slf4j
public class Idea70338Service {
    private static final int IDEA_ID = 70338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70338Service() {
        this(new Idea70338Config());
    }

    public Idea70338Service(Idea70338Config config) {
        this.config = config != null ? config : new Idea70338Config();
