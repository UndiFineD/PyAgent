...
@Data
public class Idea70513Config {
    private String name = "idea_070513";
 ...
 */
@Slf4j
public class Idea70513Service {
    private static final int IDEA_ID = 70513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70513Service() {
        this(new Idea70513Config());
    }

    public Idea70513Service(Idea70513Config config) {
        this.config = config != null ? config : new Idea70513Config();
