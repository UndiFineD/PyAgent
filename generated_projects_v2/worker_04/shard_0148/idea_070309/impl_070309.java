...
@Data
public class Idea70309Config {
    private String name = "idea_070309";
 ...
 */
@Slf4j
public class Idea70309Service {
    private static final int IDEA_ID = 70309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70309Service() {
        this(new Idea70309Config());
    }

    public Idea70309Service(Idea70309Config config) {
        this.config = config != null ? config : new Idea70309Config();
