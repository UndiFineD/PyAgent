...
@Data
public class Idea70337Config {
    private String name = "idea_070337";
 ...
 */
@Slf4j
public class Idea70337Service {
    private static final int IDEA_ID = 70337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70337Service() {
        this(new Idea70337Config());
    }

    public Idea70337Service(Idea70337Config config) {
        this.config = config != null ? config : new Idea70337Config();
