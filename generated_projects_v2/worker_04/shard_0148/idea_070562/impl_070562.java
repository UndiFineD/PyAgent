...
@Data
public class Idea70562Config {
    private String name = "idea_070562";
 ...
 */
@Slf4j
public class Idea70562Service {
    private static final int IDEA_ID = 70562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70562Service() {
        this(new Idea70562Config());
    }

    public Idea70562Service(Idea70562Config config) {
        this.config = config != null ? config : new Idea70562Config();
