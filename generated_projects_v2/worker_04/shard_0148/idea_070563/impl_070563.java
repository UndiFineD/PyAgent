...
@Data
public class Idea70563Config {
    private String name = "idea_070563";
 ...
 */
@Slf4j
public class Idea70563Service {
    private static final int IDEA_ID = 70563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70563Service() {
        this(new Idea70563Config());
    }

    public Idea70563Service(Idea70563Config config) {
        this.config = config != null ? config : new Idea70563Config();
