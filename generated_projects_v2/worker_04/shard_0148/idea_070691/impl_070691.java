...
@Data
public class Idea70691Config {
    private String name = "idea_070691";
 ...
 */
@Slf4j
public class Idea70691Service {
    private static final int IDEA_ID = 70691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70691Service() {
        this(new Idea70691Config());
    }

    public Idea70691Service(Idea70691Config config) {
        this.config = config != null ? config : new Idea70691Config();
