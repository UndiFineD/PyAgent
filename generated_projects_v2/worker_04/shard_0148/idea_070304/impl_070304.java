...
@Data
public class Idea70304Config {
    private String name = "idea_070304";
 ...
 */
@Slf4j
public class Idea70304Service {
    private static final int IDEA_ID = 70304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70304Service() {
        this(new Idea70304Config());
    }

    public Idea70304Service(Idea70304Config config) {
        this.config = config != null ? config : new Idea70304Config();
