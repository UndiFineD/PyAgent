...
@Data
public class Idea70319Config {
    private String name = "idea_070319";
 ...
 */
@Slf4j
public class Idea70319Service {
    private static final int IDEA_ID = 70319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70319Service() {
        this(new Idea70319Config());
    }

    public Idea70319Service(Idea70319Config config) {
        this.config = config != null ? config : new Idea70319Config();
