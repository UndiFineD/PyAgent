...
@Data
public class Idea70407Config {
    private String name = "idea_070407";
 ...
 */
@Slf4j
public class Idea70407Service {
    private static final int IDEA_ID = 70407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70407Service() {
        this(new Idea70407Config());
    }

    public Idea70407Service(Idea70407Config config) {
        this.config = config != null ? config : new Idea70407Config();
