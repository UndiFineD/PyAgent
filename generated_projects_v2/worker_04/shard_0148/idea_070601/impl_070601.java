...
@Data
public class Idea70601Config {
    private String name = "idea_070601";
 ...
 */
@Slf4j
public class Idea70601Service {
    private static final int IDEA_ID = 70601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70601Service() {
        this(new Idea70601Config());
    }

    public Idea70601Service(Idea70601Config config) {
        this.config = config != null ? config : new Idea70601Config();
