...
@Data
public class Idea70414Config {
    private String name = "idea_070414";
 ...
 */
@Slf4j
public class Idea70414Service {
    private static final int IDEA_ID = 70414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70414Service() {
        this(new Idea70414Config());
    }

    public Idea70414Service(Idea70414Config config) {
        this.config = config != null ? config : new Idea70414Config();
