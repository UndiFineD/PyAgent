...
@Data
public class Idea70377Config {
    private String name = "idea_070377";
 ...
 */
@Slf4j
public class Idea70377Service {
    private static final int IDEA_ID = 70377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70377Service() {
        this(new Idea70377Config());
    }

    public Idea70377Service(Idea70377Config config) {
        this.config = config != null ? config : new Idea70377Config();
