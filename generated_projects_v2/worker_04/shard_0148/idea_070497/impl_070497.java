...
@Data
public class Idea70497Config {
    private String name = "idea_070497";
 ...
 */
@Slf4j
public class Idea70497Service {
    private static final int IDEA_ID = 70497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70497Service() {
        this(new Idea70497Config());
    }

    public Idea70497Service(Idea70497Config config) {
        this.config = config != null ? config : new Idea70497Config();
