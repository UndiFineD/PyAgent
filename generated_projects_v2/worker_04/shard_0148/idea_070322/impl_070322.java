...
@Data
public class Idea70322Config {
    private String name = "idea_070322";
 ...
 */
@Slf4j
public class Idea70322Service {
    private static final int IDEA_ID = 70322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70322Service() {
        this(new Idea70322Config());
    }

    public Idea70322Service(Idea70322Config config) {
        this.config = config != null ? config : new Idea70322Config();
