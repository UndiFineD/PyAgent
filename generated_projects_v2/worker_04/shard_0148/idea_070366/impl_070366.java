...
@Data
public class Idea70366Config {
    private String name = "idea_070366";
 ...
 */
@Slf4j
public class Idea70366Service {
    private static final int IDEA_ID = 70366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70366Service() {
        this(new Idea70366Config());
    }

    public Idea70366Service(Idea70366Config config) {
        this.config = config != null ? config : new Idea70366Config();
