...
@Data
public class Idea70314Config {
    private String name = "idea_070314";
 ...
 */
@Slf4j
public class Idea70314Service {
    private static final int IDEA_ID = 70314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70314Service() {
        this(new Idea70314Config());
    }

    public Idea70314Service(Idea70314Config config) {
        this.config = config != null ? config : new Idea70314Config();
