...
@Data
public class Idea70564Config {
    private String name = "idea_070564";
 ...
 */
@Slf4j
public class Idea70564Service {
    private static final int IDEA_ID = 70564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70564Service() {
        this(new Idea70564Config());
    }

    public Idea70564Service(Idea70564Config config) {
        this.config = config != null ? config : new Idea70564Config();
