...
@Data
public class Idea70349Config {
    private String name = "idea_070349";
 ...
 */
@Slf4j
public class Idea70349Service {
    private static final int IDEA_ID = 70349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70349Service() {
        this(new Idea70349Config());
    }

    public Idea70349Service(Idea70349Config config) {
        this.config = config != null ? config : new Idea70349Config();
