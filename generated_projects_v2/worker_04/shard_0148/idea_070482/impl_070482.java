...
@Data
public class Idea70482Config {
    private String name = "idea_070482";
 ...
 */
@Slf4j
public class Idea70482Service {
    private static final int IDEA_ID = 70482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70482Service() {
        this(new Idea70482Config());
    }

    public Idea70482Service(Idea70482Config config) {
        this.config = config != null ? config : new Idea70482Config();
