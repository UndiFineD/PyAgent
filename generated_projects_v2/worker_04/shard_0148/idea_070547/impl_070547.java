...
@Data
public class Idea70547Config {
    private String name = "idea_070547";
 ...
 */
@Slf4j
public class Idea70547Service {
    private static final int IDEA_ID = 70547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70547Service() {
        this(new Idea70547Config());
    }

    public Idea70547Service(Idea70547Config config) {
        this.config = config != null ? config : new Idea70547Config();
