...
@Data
public class Idea70558Config {
    private String name = "idea_070558";
 ...
 */
@Slf4j
public class Idea70558Service {
    private static final int IDEA_ID = 70558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70558Service() {
        this(new Idea70558Config());
    }

    public Idea70558Service(Idea70558Config config) {
        this.config = config != null ? config : new Idea70558Config();
