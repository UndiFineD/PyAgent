...
@Data
public class Idea70320Config {
    private String name = "idea_070320";
 ...
 */
@Slf4j
public class Idea70320Service {
    private static final int IDEA_ID = 70320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70320Service() {
        this(new Idea70320Config());
    }

    public Idea70320Service(Idea70320Config config) {
        this.config = config != null ? config : new Idea70320Config();
