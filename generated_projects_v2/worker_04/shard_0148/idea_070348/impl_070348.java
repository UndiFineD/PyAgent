...
@Data
public class Idea70348Config {
    private String name = "idea_070348";
 ...
 */
@Slf4j
public class Idea70348Service {
    private static final int IDEA_ID = 70348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70348Service() {
        this(new Idea70348Config());
    }

    public Idea70348Service(Idea70348Config config) {
        this.config = config != null ? config : new Idea70348Config();
