...
@Data
public class Idea70574Config {
    private String name = "idea_070574";
 ...
 */
@Slf4j
public class Idea70574Service {
    private static final int IDEA_ID = 70574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70574Service() {
        this(new Idea70574Config());
    }

    public Idea70574Service(Idea70574Config config) {
        this.config = config != null ? config : new Idea70574Config();
