...
@Data
public class Idea70665Config {
    private String name = "idea_070665";
 ...
 */
@Slf4j
public class Idea70665Service {
    private static final int IDEA_ID = 70665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70665Service() {
        this(new Idea70665Config());
    }

    public Idea70665Service(Idea70665Config config) {
        this.config = config != null ? config : new Idea70665Config();
