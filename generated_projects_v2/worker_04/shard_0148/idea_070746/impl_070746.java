...
@Data
public class Idea70746Config {
    private String name = "idea_070746";
 ...
 */
@Slf4j
public class Idea70746Service {
    private static final int IDEA_ID = 70746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70746Service() {
        this(new Idea70746Config());
    }

    public Idea70746Service(Idea70746Config config) {
        this.config = config != null ? config : new Idea70746Config();
