...
@Data
public class Idea70399Config {
    private String name = "idea_070399";
 ...
 */
@Slf4j
public class Idea70399Service {
    private static final int IDEA_ID = 70399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70399Service() {
        this(new Idea70399Config());
    }

    public Idea70399Service(Idea70399Config config) {
        this.config = config != null ? config : new Idea70399Config();
