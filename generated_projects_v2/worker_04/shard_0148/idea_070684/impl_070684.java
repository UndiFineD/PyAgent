...
@Data
public class Idea70684Config {
    private String name = "idea_070684";
 ...
 */
@Slf4j
public class Idea70684Service {
    private static final int IDEA_ID = 70684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70684Service() {
        this(new Idea70684Config());
    }

    public Idea70684Service(Idea70684Config config) {
        this.config = config != null ? config : new Idea70684Config();
