...
@Data
public class Idea70646Config {
    private String name = "idea_070646";
 ...
 */
@Slf4j
public class Idea70646Service {
    private static final int IDEA_ID = 70646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70646Service() {
        this(new Idea70646Config());
    }

    public Idea70646Service(Idea70646Config config) {
        this.config = config != null ? config : new Idea70646Config();
