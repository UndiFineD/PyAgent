...
@Data
public class Idea70329Config {
    private String name = "idea_070329";
 ...
 */
@Slf4j
public class Idea70329Service {
    private static final int IDEA_ID = 70329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70329Service() {
        this(new Idea70329Config());
    }

    public Idea70329Service(Idea70329Config config) {
        this.config = config != null ? config : new Idea70329Config();
