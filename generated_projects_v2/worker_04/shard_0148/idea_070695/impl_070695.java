...
@Data
public class Idea70695Config {
    private String name = "idea_070695";
 ...
 */
@Slf4j
public class Idea70695Service {
    private static final int IDEA_ID = 70695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70695Service() {
        this(new Idea70695Config());
    }

    public Idea70695Service(Idea70695Config config) {
        this.config = config != null ? config : new Idea70695Config();
