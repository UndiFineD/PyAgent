...
@Data
public class Idea70693Config {
    private String name = "idea_070693";
 ...
 */
@Slf4j
public class Idea70693Service {
    private static final int IDEA_ID = 70693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70693Service() {
        this(new Idea70693Config());
    }

    public Idea70693Service(Idea70693Config config) {
        this.config = config != null ? config : new Idea70693Config();
