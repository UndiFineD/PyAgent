...
@Data
public class Idea70351Config {
    private String name = "idea_070351";
 ...
 */
@Slf4j
public class Idea70351Service {
    private static final int IDEA_ID = 70351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70351Service() {
        this(new Idea70351Config());
    }

    public Idea70351Service(Idea70351Config config) {
        this.config = config != null ? config : new Idea70351Config();
