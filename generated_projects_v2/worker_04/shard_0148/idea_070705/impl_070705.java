...
@Data
public class Idea70705Config {
    private String name = "idea_070705";
 ...
 */
@Slf4j
public class Idea70705Service {
    private static final int IDEA_ID = 70705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70705Service() {
        this(new Idea70705Config());
    }

    public Idea70705Service(Idea70705Config config) {
        this.config = config != null ? config : new Idea70705Config();
