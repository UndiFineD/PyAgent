...
@Data
public class Idea70721Config {
    private String name = "idea_070721";
 ...
 */
@Slf4j
public class Idea70721Service {
    private static final int IDEA_ID = 70721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70721Service() {
        this(new Idea70721Config());
    }

    public Idea70721Service(Idea70721Config config) {
        this.config = config != null ? config : new Idea70721Config();
