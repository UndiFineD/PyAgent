...
@Data
public class Idea70771Config {
    private String name = "idea_070771";
 ...
 */
@Slf4j
public class Idea70771Service {
    private static final int IDEA_ID = 70771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70771Service() {
        this(new Idea70771Config());
    }

    public Idea70771Service(Idea70771Config config) {
        this.config = config != null ? config : new Idea70771Config();
