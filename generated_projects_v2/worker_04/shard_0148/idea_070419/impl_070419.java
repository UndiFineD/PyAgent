...
@Data
public class Idea70419Config {
    private String name = "idea_070419";
 ...
 */
@Slf4j
public class Idea70419Service {
    private static final int IDEA_ID = 70419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70419Service() {
        this(new Idea70419Config());
    }

    public Idea70419Service(Idea70419Config config) {
        this.config = config != null ? config : new Idea70419Config();
