...
@Data
public class Idea70533Config {
    private String name = "idea_070533";
 ...
 */
@Slf4j
public class Idea70533Service {
    private static final int IDEA_ID = 70533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70533Service() {
        this(new Idea70533Config());
    }

    public Idea70533Service(Idea70533Config config) {
        this.config = config != null ? config : new Idea70533Config();
