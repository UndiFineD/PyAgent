...
@Data
public class Idea70364Config {
    private String name = "idea_070364";
 ...
 */
@Slf4j
public class Idea70364Service {
    private static final int IDEA_ID = 70364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70364Service() {
        this(new Idea70364Config());
    }

    public Idea70364Service(Idea70364Config config) {
        this.config = config != null ? config : new Idea70364Config();
