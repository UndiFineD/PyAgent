...
@Data
public class Idea70758Config {
    private String name = "idea_070758";
 ...
 */
@Slf4j
public class Idea70758Service {
    private static final int IDEA_ID = 70758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70758Service() {
        this(new Idea70758Config());
    }

    public Idea70758Service(Idea70758Config config) {
        this.config = config != null ? config : new Idea70758Config();
