...
@Data
public class Idea70487Config {
    private String name = "idea_070487";
 ...
 */
@Slf4j
public class Idea70487Service {
    private static final int IDEA_ID = 70487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70487Service() {
        this(new Idea70487Config());
    }

    public Idea70487Service(Idea70487Config config) {
        this.config = config != null ? config : new Idea70487Config();
