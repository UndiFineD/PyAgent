...
@Data
public class Idea70628Config {
    private String name = "idea_070628";
 ...
 */
@Slf4j
public class Idea70628Service {
    private static final int IDEA_ID = 70628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70628Service() {
        this(new Idea70628Config());
    }

    public Idea70628Service(Idea70628Config config) {
        this.config = config != null ? config : new Idea70628Config();
