...
@Data
public class Idea70433Config {
    private String name = "idea_070433";
 ...
 */
@Slf4j
public class Idea70433Service {
    private static final int IDEA_ID = 70433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70433Service() {
        this(new Idea70433Config());
    }

    public Idea70433Service(Idea70433Config config) {
        this.config = config != null ? config : new Idea70433Config();
