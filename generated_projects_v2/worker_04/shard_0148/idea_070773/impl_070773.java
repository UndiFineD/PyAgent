...
@Data
public class Idea70773Config {
    private String name = "idea_070773";
 ...
 */
@Slf4j
public class Idea70773Service {
    private static final int IDEA_ID = 70773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70773Service() {
        this(new Idea70773Config());
    }

    public Idea70773Service(Idea70773Config config) {
        this.config = config != null ? config : new Idea70773Config();
