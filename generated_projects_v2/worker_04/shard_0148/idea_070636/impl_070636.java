...
@Data
public class Idea70636Config {
    private String name = "idea_070636";
 ...
 */
@Slf4j
public class Idea70636Service {
    private static final int IDEA_ID = 70636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70636Service() {
        this(new Idea70636Config());
    }

    public Idea70636Service(Idea70636Config config) {
        this.config = config != null ? config : new Idea70636Config();
