...
@Data
public class Idea70443Config {
    private String name = "idea_070443";
 ...
 */
@Slf4j
public class Idea70443Service {
    private static final int IDEA_ID = 70443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70443Service() {
        this(new Idea70443Config());
    }

    public Idea70443Service(Idea70443Config config) {
        this.config = config != null ? config : new Idea70443Config();
