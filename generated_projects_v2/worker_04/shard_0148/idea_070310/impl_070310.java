...
@Data
public class Idea70310Config {
    private String name = "idea_070310";
 ...
 */
@Slf4j
public class Idea70310Service {
    private static final int IDEA_ID = 70310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70310Service() {
        this(new Idea70310Config());
    }

    public Idea70310Service(Idea70310Config config) {
        this.config = config != null ? config : new Idea70310Config();
