...
@Data
public class Idea70529Config {
    private String name = "idea_070529";
 ...
 */
@Slf4j
public class Idea70529Service {
    private static final int IDEA_ID = 70529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70529Service() {
        this(new Idea70529Config());
    }

    public Idea70529Service(Idea70529Config config) {
        this.config = config != null ? config : new Idea70529Config();
