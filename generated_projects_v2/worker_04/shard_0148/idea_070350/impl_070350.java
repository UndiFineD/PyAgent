...
@Data
public class Idea70350Config {
    private String name = "idea_070350";
 ...
 */
@Slf4j
public class Idea70350Service {
    private static final int IDEA_ID = 70350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70350Service() {
        this(new Idea70350Config());
    }

    public Idea70350Service(Idea70350Config config) {
        this.config = config != null ? config : new Idea70350Config();
