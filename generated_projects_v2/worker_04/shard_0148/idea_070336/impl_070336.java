...
@Data
public class Idea70336Config {
    private String name = "idea_070336";
 ...
 */
@Slf4j
public class Idea70336Service {
    private static final int IDEA_ID = 70336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70336Service() {
        this(new Idea70336Config());
    }

    public Idea70336Service(Idea70336Config config) {
        this.config = config != null ? config : new Idea70336Config();
