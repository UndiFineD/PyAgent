...
@Data
public class Idea70441Config {
    private String name = "idea_070441";
 ...
 */
@Slf4j
public class Idea70441Service {
    private static final int IDEA_ID = 70441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70441Service() {
        this(new Idea70441Config());
    }

    public Idea70441Service(Idea70441Config config) {
        this.config = config != null ? config : new Idea70441Config();
