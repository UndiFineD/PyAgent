...
@Data
public class Idea70732Config {
    private String name = "idea_070732";
 ...
 */
@Slf4j
public class Idea70732Service {
    private static final int IDEA_ID = 70732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70732Service() {
        this(new Idea70732Config());
    }

    public Idea70732Service(Idea70732Config config) {
        this.config = config != null ? config : new Idea70732Config();
