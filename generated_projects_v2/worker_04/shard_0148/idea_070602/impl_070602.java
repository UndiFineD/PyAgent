...
@Data
public class Idea70602Config {
    private String name = "idea_070602";
 ...
 */
@Slf4j
public class Idea70602Service {
    private static final int IDEA_ID = 70602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70602Service() {
        this(new Idea70602Config());
    }

    public Idea70602Service(Idea70602Config config) {
        this.config = config != null ? config : new Idea70602Config();
