...
@Data
public class Idea70580Config {
    private String name = "idea_070580";
 ...
 */
@Slf4j
public class Idea70580Service {
    private static final int IDEA_ID = 70580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70580Service() {
        this(new Idea70580Config());
    }

    public Idea70580Service(Idea70580Config config) {
        this.config = config != null ? config : new Idea70580Config();
