...
@Data
public class Idea70490Config {
    private String name = "idea_070490";
 ...
 */
@Slf4j
public class Idea70490Service {
    private static final int IDEA_ID = 70490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70490Service() {
        this(new Idea70490Config());
    }

    public Idea70490Service(Idea70490Config config) {
        this.config = config != null ? config : new Idea70490Config();
