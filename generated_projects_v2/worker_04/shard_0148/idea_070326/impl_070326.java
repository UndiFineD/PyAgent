...
@Data
public class Idea70326Config {
    private String name = "idea_070326";
 ...
 */
@Slf4j
public class Idea70326Service {
    private static final int IDEA_ID = 70326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70326Service() {
        this(new Idea70326Config());
    }

    public Idea70326Service(Idea70326Config config) {
        this.config = config != null ? config : new Idea70326Config();
