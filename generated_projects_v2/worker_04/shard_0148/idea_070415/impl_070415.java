...
@Data
public class Idea70415Config {
    private String name = "idea_070415";
 ...
 */
@Slf4j
public class Idea70415Service {
    private static final int IDEA_ID = 70415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70415Service() {
        this(new Idea70415Config());
    }

    public Idea70415Service(Idea70415Config config) {
        this.config = config != null ? config : new Idea70415Config();
