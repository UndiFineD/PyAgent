...
@Data
public class Idea70704Config {
    private String name = "idea_070704";
 ...
 */
@Slf4j
public class Idea70704Service {
    private static final int IDEA_ID = 70704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70704Service() {
        this(new Idea70704Config());
    }

    public Idea70704Service(Idea70704Config config) {
        this.config = config != null ? config : new Idea70704Config();
