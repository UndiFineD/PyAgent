...
@Data
public class Idea70608Config {
    private String name = "idea_070608";
 ...
 */
@Slf4j
public class Idea70608Service {
    private static final int IDEA_ID = 70608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70608Service() {
        this(new Idea70608Config());
    }

    public Idea70608Service(Idea70608Config config) {
        this.config = config != null ? config : new Idea70608Config();
