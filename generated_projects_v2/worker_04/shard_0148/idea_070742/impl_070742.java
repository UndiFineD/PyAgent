...
@Data
public class Idea70742Config {
    private String name = "idea_070742";
 ...
 */
@Slf4j
public class Idea70742Service {
    private static final int IDEA_ID = 70742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70742Service() {
        this(new Idea70742Config());
    }

    public Idea70742Service(Idea70742Config config) {
        this.config = config != null ? config : new Idea70742Config();
