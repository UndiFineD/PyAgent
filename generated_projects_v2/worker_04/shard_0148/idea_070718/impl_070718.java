...
@Data
public class Idea70718Config {
    private String name = "idea_070718";
 ...
 */
@Slf4j
public class Idea70718Service {
    private static final int IDEA_ID = 70718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70718Service() {
        this(new Idea70718Config());
    }

    public Idea70718Service(Idea70718Config config) {
        this.config = config != null ? config : new Idea70718Config();
