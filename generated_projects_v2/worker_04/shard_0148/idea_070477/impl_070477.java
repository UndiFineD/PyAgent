...
@Data
public class Idea70477Config {
    private String name = "idea_070477";
 ...
 */
@Slf4j
public class Idea70477Service {
    private static final int IDEA_ID = 70477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70477Service() {
        this(new Idea70477Config());
    }

    public Idea70477Service(Idea70477Config config) {
        this.config = config != null ? config : new Idea70477Config();
