...
@Data
public class Idea70683Config {
    private String name = "idea_070683";
 ...
 */
@Slf4j
public class Idea70683Service {
    private static final int IDEA_ID = 70683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70683Service() {
        this(new Idea70683Config());
    }

    public Idea70683Service(Idea70683Config config) {
        this.config = config != null ? config : new Idea70683Config();
