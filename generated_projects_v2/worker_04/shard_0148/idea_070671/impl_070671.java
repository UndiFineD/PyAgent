...
@Data
public class Idea70671Config {
    private String name = "idea_070671";
 ...
 */
@Slf4j
public class Idea70671Service {
    private static final int IDEA_ID = 70671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70671Service() {
        this(new Idea70671Config());
    }

    public Idea70671Service(Idea70671Config config) {
        this.config = config != null ? config : new Idea70671Config();
