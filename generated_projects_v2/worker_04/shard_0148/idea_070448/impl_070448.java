...
@Data
public class Idea70448Config {
    private String name = "idea_070448";
 ...
 */
@Slf4j
public class Idea70448Service {
    private static final int IDEA_ID = 70448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70448Service() {
        this(new Idea70448Config());
    }

    public Idea70448Service(Idea70448Config config) {
        this.config = config != null ? config : new Idea70448Config();
