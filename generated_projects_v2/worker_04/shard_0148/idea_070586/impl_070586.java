...
@Data
public class Idea70586Config {
    private String name = "idea_070586";
 ...
 */
@Slf4j
public class Idea70586Service {
    private static final int IDEA_ID = 70586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70586Service() {
        this(new Idea70586Config());
    }

    public Idea70586Service(Idea70586Config config) {
        this.config = config != null ? config : new Idea70586Config();
