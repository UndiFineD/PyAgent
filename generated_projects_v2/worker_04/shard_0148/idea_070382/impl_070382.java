...
@Data
public class Idea70382Config {
    private String name = "idea_070382";
 ...
 */
@Slf4j
public class Idea70382Service {
    private static final int IDEA_ID = 70382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70382Service() {
        this(new Idea70382Config());
    }

    public Idea70382Service(Idea70382Config config) {
        this.config = config != null ? config : new Idea70382Config();
