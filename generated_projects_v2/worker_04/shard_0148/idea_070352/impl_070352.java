...
@Data
public class Idea70352Config {
    private String name = "idea_070352";
 ...
 */
@Slf4j
public class Idea70352Service {
    private static final int IDEA_ID = 70352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70352Service() {
        this(new Idea70352Config());
    }

    public Idea70352Service(Idea70352Config config) {
        this.config = config != null ? config : new Idea70352Config();
