...
@Data
public class Idea70651Config {
    private String name = "idea_070651";
 ...
 */
@Slf4j
public class Idea70651Service {
    private static final int IDEA_ID = 70651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70651Service() {
        this(new Idea70651Config());
    }

    public Idea70651Service(Idea70651Config config) {
        this.config = config != null ? config : new Idea70651Config();
