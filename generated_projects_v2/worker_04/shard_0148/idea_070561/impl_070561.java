...
@Data
public class Idea70561Config {
    private String name = "idea_070561";
 ...
 */
@Slf4j
public class Idea70561Service {
    private static final int IDEA_ID = 70561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70561Service() {
        this(new Idea70561Config());
    }

    public Idea70561Service(Idea70561Config config) {
        this.config = config != null ? config : new Idea70561Config();
