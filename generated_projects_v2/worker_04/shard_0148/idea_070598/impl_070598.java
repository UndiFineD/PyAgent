...
@Data
public class Idea70598Config {
    private String name = "idea_070598";
 ...
 */
@Slf4j
public class Idea70598Service {
    private static final int IDEA_ID = 70598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70598Service() {
        this(new Idea70598Config());
    }

    public Idea70598Service(Idea70598Config config) {
        this.config = config != null ? config : new Idea70598Config();
