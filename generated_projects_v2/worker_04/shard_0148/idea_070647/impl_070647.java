...
@Data
public class Idea70647Config {
    private String name = "idea_070647";
 ...
 */
@Slf4j
public class Idea70647Service {
    private static final int IDEA_ID = 70647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70647Service() {
        this(new Idea70647Config());
    }

    public Idea70647Service(Idea70647Config config) {
        this.config = config != null ? config : new Idea70647Config();
