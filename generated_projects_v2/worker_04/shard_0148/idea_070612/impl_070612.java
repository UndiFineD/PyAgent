...
@Data
public class Idea70612Config {
    private String name = "idea_070612";
 ...
 */
@Slf4j
public class Idea70612Service {
    private static final int IDEA_ID = 70612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70612Service() {
        this(new Idea70612Config());
    }

    public Idea70612Service(Idea70612Config config) {
        this.config = config != null ? config : new Idea70612Config();
