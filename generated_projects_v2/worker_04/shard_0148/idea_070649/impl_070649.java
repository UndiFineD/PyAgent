...
@Data
public class Idea70649Config {
    private String name = "idea_070649";
 ...
 */
@Slf4j
public class Idea70649Service {
    private static final int IDEA_ID = 70649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70649Service() {
        this(new Idea70649Config());
    }

    public Idea70649Service(Idea70649Config config) {
        this.config = config != null ? config : new Idea70649Config();
