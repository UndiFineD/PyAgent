...
@Data
public class Idea70627Config {
    private String name = "idea_070627";
 ...
 */
@Slf4j
public class Idea70627Service {
    private static final int IDEA_ID = 70627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70627Service() {
        this(new Idea70627Config());
    }

    public Idea70627Service(Idea70627Config config) {
        this.config = config != null ? config : new Idea70627Config();
