...
@Data
public class Idea70699Config {
    private String name = "idea_070699";
 ...
 */
@Slf4j
public class Idea70699Service {
    private static final int IDEA_ID = 70699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70699Service() {
        this(new Idea70699Config());
    }

    public Idea70699Service(Idea70699Config config) {
        this.config = config != null ? config : new Idea70699Config();
