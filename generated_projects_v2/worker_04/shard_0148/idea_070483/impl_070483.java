...
@Data
public class Idea70483Config {
    private String name = "idea_070483";
 ...
 */
@Slf4j
public class Idea70483Service {
    private static final int IDEA_ID = 70483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70483Service() {
        this(new Idea70483Config());
    }

    public Idea70483Service(Idea70483Config config) {
        this.config = config != null ? config : new Idea70483Config();
