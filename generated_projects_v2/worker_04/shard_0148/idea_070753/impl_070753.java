...
@Data
public class Idea70753Config {
    private String name = "idea_070753";
 ...
 */
@Slf4j
public class Idea70753Service {
    private static final int IDEA_ID = 70753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70753Service() {
        this(new Idea70753Config());
    }

    public Idea70753Service(Idea70753Config config) {
        this.config = config != null ? config : new Idea70753Config();
