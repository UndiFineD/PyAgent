...
@Data
public class Idea70677Config {
    private String name = "idea_070677";
 ...
 */
@Slf4j
public class Idea70677Service {
    private static final int IDEA_ID = 70677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70677Service() {
        this(new Idea70677Config());
    }

    public Idea70677Service(Idea70677Config config) {
        this.config = config != null ? config : new Idea70677Config();
