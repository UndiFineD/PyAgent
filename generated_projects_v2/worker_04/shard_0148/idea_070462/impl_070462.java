...
@Data
public class Idea70462Config {
    private String name = "idea_070462";
 ...
 */
@Slf4j
public class Idea70462Service {
    private static final int IDEA_ID = 70462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70462Service() {
        this(new Idea70462Config());
    }

    public Idea70462Service(Idea70462Config config) {
        this.config = config != null ? config : new Idea70462Config();
