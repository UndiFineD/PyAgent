...
@Data
public class Idea70541Config {
    private String name = "idea_070541";
 ...
 */
@Slf4j
public class Idea70541Service {
    private static final int IDEA_ID = 70541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70541Service() {
        this(new Idea70541Config());
    }

    public Idea70541Service(Idea70541Config config) {
        this.config = config != null ? config : new Idea70541Config();
