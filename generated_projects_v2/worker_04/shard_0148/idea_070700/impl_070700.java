...
@Data
public class Idea70700Config {
    private String name = "idea_070700";
 ...
 */
@Slf4j
public class Idea70700Service {
    private static final int IDEA_ID = 70700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70700Service() {
        this(new Idea70700Config());
    }

    public Idea70700Service(Idea70700Config config) {
        this.config = config != null ? config : new Idea70700Config();
