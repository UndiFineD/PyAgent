...
@Data
public class Idea70604Config {
    private String name = "idea_070604";
 ...
 */
@Slf4j
public class Idea70604Service {
    private static final int IDEA_ID = 70604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70604Service() {
        this(new Idea70604Config());
    }

    public Idea70604Service(Idea70604Config config) {
        this.config = config != null ? config : new Idea70604Config();
