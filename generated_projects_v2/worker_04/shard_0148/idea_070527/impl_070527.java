...
@Data
public class Idea70527Config {
    private String name = "idea_070527";
 ...
 */
@Slf4j
public class Idea70527Service {
    private static final int IDEA_ID = 70527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70527Service() {
        this(new Idea70527Config());
    }

    public Idea70527Service(Idea70527Config config) {
        this.config = config != null ? config : new Idea70527Config();
