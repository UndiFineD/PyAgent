...
@Data
public class Idea70748Config {
    private String name = "idea_070748";
 ...
 */
@Slf4j
public class Idea70748Service {
    private static final int IDEA_ID = 70748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70748Service() {
        this(new Idea70748Config());
    }

    public Idea70748Service(Idea70748Config config) {
        this.config = config != null ? config : new Idea70748Config();
