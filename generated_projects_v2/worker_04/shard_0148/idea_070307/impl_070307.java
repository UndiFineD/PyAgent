...
@Data
public class Idea70307Config {
    private String name = "idea_070307";
 ...
 */
@Slf4j
public class Idea70307Service {
    private static final int IDEA_ID = 70307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70307Service() {
        this(new Idea70307Config());
    }

    public Idea70307Service(Idea70307Config config) {
        this.config = config != null ? config : new Idea70307Config();
