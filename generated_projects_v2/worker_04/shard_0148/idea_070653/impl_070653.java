...
@Data
public class Idea70653Config {
    private String name = "idea_070653";
 ...
 */
@Slf4j
public class Idea70653Service {
    private static final int IDEA_ID = 70653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70653Service() {
        this(new Idea70653Config());
    }

    public Idea70653Service(Idea70653Config config) {
        this.config = config != null ? config : new Idea70653Config();
