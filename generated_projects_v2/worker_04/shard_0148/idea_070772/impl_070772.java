...
@Data
public class Idea70772Config {
    private String name = "idea_070772";
 ...
 */
@Slf4j
public class Idea70772Service {
    private static final int IDEA_ID = 70772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70772Service() {
        this(new Idea70772Config());
    }

    public Idea70772Service(Idea70772Config config) {
        this.config = config != null ? config : new Idea70772Config();
