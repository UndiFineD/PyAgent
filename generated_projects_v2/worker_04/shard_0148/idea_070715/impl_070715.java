...
@Data
public class Idea70715Config {
    private String name = "idea_070715";
 ...
 */
@Slf4j
public class Idea70715Service {
    private static final int IDEA_ID = 70715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70715Service() {
        this(new Idea70715Config());
    }

    public Idea70715Service(Idea70715Config config) {
        this.config = config != null ? config : new Idea70715Config();
