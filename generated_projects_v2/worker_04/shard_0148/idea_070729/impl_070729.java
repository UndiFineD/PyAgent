...
@Data
public class Idea70729Config {
    private String name = "idea_070729";
 ...
 */
@Slf4j
public class Idea70729Service {
    private static final int IDEA_ID = 70729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70729Service() {
        this(new Idea70729Config());
    }

    public Idea70729Service(Idea70729Config config) {
        this.config = config != null ? config : new Idea70729Config();
