...
@Data
public class Idea70451Config {
    private String name = "idea_070451";
 ...
 */
@Slf4j
public class Idea70451Service {
    private static final int IDEA_ID = 70451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70451Service() {
        this(new Idea70451Config());
    }

    public Idea70451Service(Idea70451Config config) {
        this.config = config != null ? config : new Idea70451Config();
