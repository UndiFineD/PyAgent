...
@Data
public class Idea70417Config {
    private String name = "idea_070417";
 ...
 */
@Slf4j
public class Idea70417Service {
    private static final int IDEA_ID = 70417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70417Service() {
        this(new Idea70417Config());
    }

    public Idea70417Service(Idea70417Config config) {
        this.config = config != null ? config : new Idea70417Config();
