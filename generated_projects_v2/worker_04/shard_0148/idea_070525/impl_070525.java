...
@Data
public class Idea70525Config {
    private String name = "idea_070525";
 ...
 */
@Slf4j
public class Idea70525Service {
    private static final int IDEA_ID = 70525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70525Service() {
        this(new Idea70525Config());
    }

    public Idea70525Service(Idea70525Config config) {
        this.config = config != null ? config : new Idea70525Config();
