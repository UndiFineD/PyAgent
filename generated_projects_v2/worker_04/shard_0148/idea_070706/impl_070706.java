...
@Data
public class Idea70706Config {
    private String name = "idea_070706";
 ...
 */
@Slf4j
public class Idea70706Service {
    private static final int IDEA_ID = 70706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70706Service() {
        this(new Idea70706Config());
    }

    public Idea70706Service(Idea70706Config config) {
        this.config = config != null ? config : new Idea70706Config();
