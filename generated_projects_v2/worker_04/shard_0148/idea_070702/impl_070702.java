...
@Data
public class Idea70702Config {
    private String name = "idea_070702";
 ...
 */
@Slf4j
public class Idea70702Service {
    private static final int IDEA_ID = 70702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70702Service() {
        this(new Idea70702Config());
    }

    public Idea70702Service(Idea70702Config config) {
        this.config = config != null ? config : new Idea70702Config();
