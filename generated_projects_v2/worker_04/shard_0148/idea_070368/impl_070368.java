...
@Data
public class Idea70368Config {
    private String name = "idea_070368";
 ...
 */
@Slf4j
public class Idea70368Service {
    private static final int IDEA_ID = 70368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70368Service() {
        this(new Idea70368Config());
    }

    public Idea70368Service(Idea70368Config config) {
        this.config = config != null ? config : new Idea70368Config();
