...
@Data
public class Idea70678Config {
    private String name = "idea_070678";
 ...
 */
@Slf4j
public class Idea70678Service {
    private static final int IDEA_ID = 70678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70678Service() {
        this(new Idea70678Config());
    }

    public Idea70678Service(Idea70678Config config) {
        this.config = config != null ? config : new Idea70678Config();
