...
@Data
public class Idea70365Config {
    private String name = "idea_070365";
 ...
 */
@Slf4j
public class Idea70365Service {
    private static final int IDEA_ID = 70365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70365Service() {
        this(new Idea70365Config());
    }

    public Idea70365Service(Idea70365Config config) {
        this.config = config != null ? config : new Idea70365Config();
