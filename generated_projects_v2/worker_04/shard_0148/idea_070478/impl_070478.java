...
@Data
public class Idea70478Config {
    private String name = "idea_070478";
 ...
 */
@Slf4j
public class Idea70478Service {
    private static final int IDEA_ID = 70478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70478Service() {
        this(new Idea70478Config());
    }

    public Idea70478Service(Idea70478Config config) {
        this.config = config != null ? config : new Idea70478Config();
