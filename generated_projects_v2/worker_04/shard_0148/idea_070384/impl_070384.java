...
@Data
public class Idea70384Config {
    private String name = "idea_070384";
 ...
 */
@Slf4j
public class Idea70384Service {
    private static final int IDEA_ID = 70384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70384Service() {
        this(new Idea70384Config());
    }

    public Idea70384Service(Idea70384Config config) {
        this.config = config != null ? config : new Idea70384Config();
