...
@Data
public class Idea70582Config {
    private String name = "idea_070582";
 ...
 */
@Slf4j
public class Idea70582Service {
    private static final int IDEA_ID = 70582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70582Service() {
        this(new Idea70582Config());
    }

    public Idea70582Service(Idea70582Config config) {
        this.config = config != null ? config : new Idea70582Config();
