...
@Data
public class Idea70673Config {
    private String name = "idea_070673";
 ...
 */
@Slf4j
public class Idea70673Service {
    private static final int IDEA_ID = 70673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70673Service() {
        this(new Idea70673Config());
    }

    public Idea70673Service(Idea70673Config config) {
        this.config = config != null ? config : new Idea70673Config();
