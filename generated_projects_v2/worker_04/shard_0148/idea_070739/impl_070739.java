...
@Data
public class Idea70739Config {
    private String name = "idea_070739";
 ...
 */
@Slf4j
public class Idea70739Service {
    private static final int IDEA_ID = 70739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70739Service() {
        this(new Idea70739Config());
    }

    public Idea70739Service(Idea70739Config config) {
        this.config = config != null ? config : new Idea70739Config();
