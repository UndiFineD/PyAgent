...
@Data
public class Idea70403Config {
    private String name = "idea_070403";
 ...
 */
@Slf4j
public class Idea70403Service {
    private static final int IDEA_ID = 70403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70403Service() {
        this(new Idea70403Config());
    }

    public Idea70403Service(Idea70403Config config) {
        this.config = config != null ? config : new Idea70403Config();
