...
@Data
public class Idea70619Config {
    private String name = "idea_070619";
 ...
 */
@Slf4j
public class Idea70619Service {
    private static final int IDEA_ID = 70619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70619Service() {
        this(new Idea70619Config());
    }

    public Idea70619Service(Idea70619Config config) {
        this.config = config != null ? config : new Idea70619Config();
