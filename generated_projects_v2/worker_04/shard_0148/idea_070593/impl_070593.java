...
@Data
public class Idea70593Config {
    private String name = "idea_070593";
 ...
 */
@Slf4j
public class Idea70593Service {
    private static final int IDEA_ID = 70593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70593Service() {
        this(new Idea70593Config());
    }

    public Idea70593Service(Idea70593Config config) {
        this.config = config != null ? config : new Idea70593Config();
