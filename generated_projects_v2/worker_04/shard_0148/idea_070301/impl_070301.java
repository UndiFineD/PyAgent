...
@Data
public class Idea70301Config {
    private String name = "idea_070301";
 ...
 */
@Slf4j
public class Idea70301Service {
    private static final int IDEA_ID = 70301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70301Service() {
        this(new Idea70301Config());
    }

    public Idea70301Service(Idea70301Config config) {
        this.config = config != null ? config : new Idea70301Config();
