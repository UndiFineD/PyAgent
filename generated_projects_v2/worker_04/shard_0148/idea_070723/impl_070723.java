...
@Data
public class Idea70723Config {
    private String name = "idea_070723";
 ...
 */
@Slf4j
public class Idea70723Service {
    private static final int IDEA_ID = 70723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70723Service() {
        this(new Idea70723Config());
    }

    public Idea70723Service(Idea70723Config config) {
        this.config = config != null ? config : new Idea70723Config();
