...
@Data
public class Idea70518Config {
    private String name = "idea_070518";
 ...
 */
@Slf4j
public class Idea70518Service {
    private static final int IDEA_ID = 70518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70518Service() {
        this(new Idea70518Config());
    }

    public Idea70518Service(Idea70518Config config) {
        this.config = config != null ? config : new Idea70518Config();
