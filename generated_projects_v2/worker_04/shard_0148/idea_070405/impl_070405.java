...
@Data
public class Idea70405Config {
    private String name = "idea_070405";
 ...
 */
@Slf4j
public class Idea70405Service {
    private static final int IDEA_ID = 70405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70405Service() {
        this(new Idea70405Config());
    }

    public Idea70405Service(Idea70405Config config) {
        this.config = config != null ? config : new Idea70405Config();
