...
@Data
public class Idea70622Config {
    private String name = "idea_070622";
 ...
 */
@Slf4j
public class Idea70622Service {
    private static final int IDEA_ID = 70622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70622Service() {
        this(new Idea70622Config());
    }

    public Idea70622Service(Idea70622Config config) {
        this.config = config != null ? config : new Idea70622Config();
