...
@Data
public class Idea70599Config {
    private String name = "idea_070599";
 ...
 */
@Slf4j
public class Idea70599Service {
    private static final int IDEA_ID = 70599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70599Service() {
        this(new Idea70599Config());
    }

    public Idea70599Service(Idea70599Config config) {
        this.config = config != null ? config : new Idea70599Config();
