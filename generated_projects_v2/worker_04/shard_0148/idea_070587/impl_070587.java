...
@Data
public class Idea70587Config {
    private String name = "idea_070587";
 ...
 */
@Slf4j
public class Idea70587Service {
    private static final int IDEA_ID = 70587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70587Service() {
        this(new Idea70587Config());
    }

    public Idea70587Service(Idea70587Config config) {
        this.config = config != null ? config : new Idea70587Config();
