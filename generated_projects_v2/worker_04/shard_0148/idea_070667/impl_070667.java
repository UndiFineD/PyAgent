...
@Data
public class Idea70667Config {
    private String name = "idea_070667";
 ...
 */
@Slf4j
public class Idea70667Service {
    private static final int IDEA_ID = 70667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70667Service() {
        this(new Idea70667Config());
    }

    public Idea70667Service(Idea70667Config config) {
        this.config = config != null ? config : new Idea70667Config();
