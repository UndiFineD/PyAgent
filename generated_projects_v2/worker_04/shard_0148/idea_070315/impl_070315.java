...
@Data
public class Idea70315Config {
    private String name = "idea_070315";
 ...
 */
@Slf4j
public class Idea70315Service {
    private static final int IDEA_ID = 70315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70315Service() {
        this(new Idea70315Config());
    }

    public Idea70315Service(Idea70315Config config) {
        this.config = config != null ? config : new Idea70315Config();
