...
@Data
public class Idea70517Config {
    private String name = "idea_070517";
 ...
 */
@Slf4j
public class Idea70517Service {
    private static final int IDEA_ID = 70517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70517Service() {
        this(new Idea70517Config());
    }

    public Idea70517Service(Idea70517Config config) {
        this.config = config != null ? config : new Idea70517Config();
