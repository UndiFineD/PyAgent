...
@Data
public class Idea70774Config {
    private String name = "idea_070774";
 ...
 */
@Slf4j
public class Idea70774Service {
    private static final int IDEA_ID = 70774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70774Service() {
        this(new Idea70774Config());
    }

    public Idea70774Service(Idea70774Config config) {
        this.config = config != null ? config : new Idea70774Config();
