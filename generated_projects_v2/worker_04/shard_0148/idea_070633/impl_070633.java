...
@Data
public class Idea70633Config {
    private String name = "idea_070633";
 ...
 */
@Slf4j
public class Idea70633Service {
    private static final int IDEA_ID = 70633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70633Service() {
        this(new Idea70633Config());
    }

    public Idea70633Service(Idea70633Config config) {
        this.config = config != null ? config : new Idea70633Config();
