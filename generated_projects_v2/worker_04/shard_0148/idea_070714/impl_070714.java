...
@Data
public class Idea70714Config {
    private String name = "idea_070714";
 ...
 */
@Slf4j
public class Idea70714Service {
    private static final int IDEA_ID = 70714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70714Service() {
        this(new Idea70714Config());
    }

    public Idea70714Service(Idea70714Config config) {
        this.config = config != null ? config : new Idea70714Config();
