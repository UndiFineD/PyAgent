...
@Data
public class Idea70312Config {
    private String name = "idea_070312";
 ...
 */
@Slf4j
public class Idea70312Service {
    private static final int IDEA_ID = 70312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70312Service() {
        this(new Idea70312Config());
    }

    public Idea70312Service(Idea70312Config config) {
        this.config = config != null ? config : new Idea70312Config();
