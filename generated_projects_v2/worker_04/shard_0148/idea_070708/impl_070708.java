...
@Data
public class Idea70708Config {
    private String name = "idea_070708";
 ...
 */
@Slf4j
public class Idea70708Service {
    private static final int IDEA_ID = 70708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70708Service() {
        this(new Idea70708Config());
    }

    public Idea70708Service(Idea70708Config config) {
        this.config = config != null ? config : new Idea70708Config();
