...
@Data
public class Idea70437Config {
    private String name = "idea_070437";
 ...
 */
@Slf4j
public class Idea70437Service {
    private static final int IDEA_ID = 70437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70437Service() {
        this(new Idea70437Config());
    }

    public Idea70437Service(Idea70437Config config) {
        this.config = config != null ? config : new Idea70437Config();
