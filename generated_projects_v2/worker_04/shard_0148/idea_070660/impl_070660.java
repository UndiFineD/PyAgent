...
@Data
public class Idea70660Config {
    private String name = "idea_070660";
 ...
 */
@Slf4j
public class Idea70660Service {
    private static final int IDEA_ID = 70660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70660Service() {
        this(new Idea70660Config());
    }

    public Idea70660Service(Idea70660Config config) {
        this.config = config != null ? config : new Idea70660Config();
