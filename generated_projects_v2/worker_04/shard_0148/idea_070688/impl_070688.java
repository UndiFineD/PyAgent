...
@Data
public class Idea70688Config {
    private String name = "idea_070688";
 ...
 */
@Slf4j
public class Idea70688Service {
    private static final int IDEA_ID = 70688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70688Service() {
        this(new Idea70688Config());
    }

    public Idea70688Service(Idea70688Config config) {
        this.config = config != null ? config : new Idea70688Config();
