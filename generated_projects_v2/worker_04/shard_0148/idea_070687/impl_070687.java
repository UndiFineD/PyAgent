...
@Data
public class Idea70687Config {
    private String name = "idea_070687";
 ...
 */
@Slf4j
public class Idea70687Service {
    private static final int IDEA_ID = 70687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70687Service() {
        this(new Idea70687Config());
    }

    public Idea70687Service(Idea70687Config config) {
        this.config = config != null ? config : new Idea70687Config();
