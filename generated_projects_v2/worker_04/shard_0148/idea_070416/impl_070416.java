...
@Data
public class Idea70416Config {
    private String name = "idea_070416";
 ...
 */
@Slf4j
public class Idea70416Service {
    private static final int IDEA_ID = 70416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70416Service() {
        this(new Idea70416Config());
    }

    public Idea70416Service(Idea70416Config config) {
        this.config = config != null ? config : new Idea70416Config();
