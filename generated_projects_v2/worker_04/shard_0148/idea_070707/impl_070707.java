...
@Data
public class Idea70707Config {
    private String name = "idea_070707";
 ...
 */
@Slf4j
public class Idea70707Service {
    private static final int IDEA_ID = 70707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70707Service() {
        this(new Idea70707Config());
    }

    public Idea70707Service(Idea70707Config config) {
        this.config = config != null ? config : new Idea70707Config();
