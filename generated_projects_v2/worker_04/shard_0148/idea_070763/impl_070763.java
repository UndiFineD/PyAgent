...
@Data
public class Idea70763Config {
    private String name = "idea_070763";
 ...
 */
@Slf4j
public class Idea70763Service {
    private static final int IDEA_ID = 70763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70763Service() {
        this(new Idea70763Config());
    }

    public Idea70763Service(Idea70763Config config) {
        this.config = config != null ? config : new Idea70763Config();
