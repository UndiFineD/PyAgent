...
@Data
public class Idea70328Config {
    private String name = "idea_070328";
 ...
 */
@Slf4j
public class Idea70328Service {
    private static final int IDEA_ID = 70328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70328Service() {
        this(new Idea70328Config());
    }

    public Idea70328Service(Idea70328Config config) {
        this.config = config != null ? config : new Idea70328Config();
