...
@Data
public class Idea70680Config {
    private String name = "idea_070680";
 ...
 */
@Slf4j
public class Idea70680Service {
    private static final int IDEA_ID = 70680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70680Service() {
        this(new Idea70680Config());
    }

    public Idea70680Service(Idea70680Config config) {
        this.config = config != null ? config : new Idea70680Config();
