...
@Data
public class Idea70713Config {
    private String name = "idea_070713";
 ...
 */
@Slf4j
public class Idea70713Service {
    private static final int IDEA_ID = 70713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70713Service() {
        this(new Idea70713Config());
    }

    public Idea70713Service(Idea70713Config config) {
        this.config = config != null ? config : new Idea70713Config();
