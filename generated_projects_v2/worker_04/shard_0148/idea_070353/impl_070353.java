...
@Data
public class Idea70353Config {
    private String name = "idea_070353";
 ...
 */
@Slf4j
public class Idea70353Service {
    private static final int IDEA_ID = 70353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70353Service() {
        this(new Idea70353Config());
    }

    public Idea70353Service(Idea70353Config config) {
        this.config = config != null ? config : new Idea70353Config();
