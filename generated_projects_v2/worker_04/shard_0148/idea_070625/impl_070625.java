...
@Data
public class Idea70625Config {
    private String name = "idea_070625";
 ...
 */
@Slf4j
public class Idea70625Service {
    private static final int IDEA_ID = 70625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70625Service() {
        this(new Idea70625Config());
    }

    public Idea70625Service(Idea70625Config config) {
        this.config = config != null ? config : new Idea70625Config();
