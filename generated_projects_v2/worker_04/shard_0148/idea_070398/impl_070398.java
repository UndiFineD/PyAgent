...
@Data
public class Idea70398Config {
    private String name = "idea_070398";
 ...
 */
@Slf4j
public class Idea70398Service {
    private static final int IDEA_ID = 70398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70398Service() {
        this(new Idea70398Config());
    }

    public Idea70398Service(Idea70398Config config) {
        this.config = config != null ? config : new Idea70398Config();
