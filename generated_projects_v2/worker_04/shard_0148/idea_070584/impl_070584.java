...
@Data
public class Idea70584Config {
    private String name = "idea_070584";
 ...
 */
@Slf4j
public class Idea70584Service {
    private static final int IDEA_ID = 70584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70584Service() {
        this(new Idea70584Config());
    }

    public Idea70584Service(Idea70584Config config) {
        this.config = config != null ? config : new Idea70584Config();
