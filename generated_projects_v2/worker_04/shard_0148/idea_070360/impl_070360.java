...
@Data
public class Idea70360Config {
    private String name = "idea_070360";
 ...
 */
@Slf4j
public class Idea70360Service {
    private static final int IDEA_ID = 70360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70360Service() {
        this(new Idea70360Config());
    }

    public Idea70360Service(Idea70360Config config) {
        this.config = config != null ? config : new Idea70360Config();
