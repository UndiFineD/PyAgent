...
@Data
public class Idea70648Config {
    private String name = "idea_070648";
 ...
 */
@Slf4j
public class Idea70648Service {
    private static final int IDEA_ID = 70648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70648Service() {
        this(new Idea70648Config());
    }

    public Idea70648Service(Idea70648Config config) {
        this.config = config != null ? config : new Idea70648Config();
