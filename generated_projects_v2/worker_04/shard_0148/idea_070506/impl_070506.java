...
@Data
public class Idea70506Config {
    private String name = "idea_070506";
 ...
 */
@Slf4j
public class Idea70506Service {
    private static final int IDEA_ID = 70506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70506Service() {
        this(new Idea70506Config());
    }

    public Idea70506Service(Idea70506Config config) {
        this.config = config != null ? config : new Idea70506Config();
