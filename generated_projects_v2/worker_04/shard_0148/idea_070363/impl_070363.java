...
@Data
public class Idea70363Config {
    private String name = "idea_070363";
 ...
 */
@Slf4j
public class Idea70363Service {
    private static final int IDEA_ID = 70363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70363Service() {
        this(new Idea70363Config());
    }

    public Idea70363Service(Idea70363Config config) {
        this.config = config != null ? config : new Idea70363Config();
