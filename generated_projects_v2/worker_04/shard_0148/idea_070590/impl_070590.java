...
@Data
public class Idea70590Config {
    private String name = "idea_070590";
 ...
 */
@Slf4j
public class Idea70590Service {
    private static final int IDEA_ID = 70590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70590Service() {
        this(new Idea70590Config());
    }

    public Idea70590Service(Idea70590Config config) {
        this.config = config != null ? config : new Idea70590Config();
