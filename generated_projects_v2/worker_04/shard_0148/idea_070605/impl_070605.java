...
@Data
public class Idea70605Config {
    private String name = "idea_070605";
 ...
 */
@Slf4j
public class Idea70605Service {
    private static final int IDEA_ID = 70605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70605Service() {
        this(new Idea70605Config());
    }

    public Idea70605Service(Idea70605Config config) {
        this.config = config != null ? config : new Idea70605Config();
