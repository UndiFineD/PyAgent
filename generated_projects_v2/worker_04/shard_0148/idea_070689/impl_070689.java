...
@Data
public class Idea70689Config {
    private String name = "idea_070689";
 ...
 */
@Slf4j
public class Idea70689Service {
    private static final int IDEA_ID = 70689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70689Service() {
        this(new Idea70689Config());
    }

    public Idea70689Service(Idea70689Config config) {
        this.config = config != null ? config : new Idea70689Config();
