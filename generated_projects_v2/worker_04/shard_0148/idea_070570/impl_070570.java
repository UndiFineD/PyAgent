...
@Data
public class Idea70570Config {
    private String name = "idea_070570";
 ...
 */
@Slf4j
public class Idea70570Service {
    private static final int IDEA_ID = 70570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70570Service() {
        this(new Idea70570Config());
    }

    public Idea70570Service(Idea70570Config config) {
        this.config = config != null ? config : new Idea70570Config();
