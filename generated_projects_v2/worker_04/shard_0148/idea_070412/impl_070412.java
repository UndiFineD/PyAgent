...
@Data
public class Idea70412Config {
    private String name = "idea_070412";
 ...
 */
@Slf4j
public class Idea70412Service {
    private static final int IDEA_ID = 70412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70412Service() {
        this(new Idea70412Config());
    }

    public Idea70412Service(Idea70412Config config) {
        this.config = config != null ? config : new Idea70412Config();
