...
@Data
public class Idea70470Config {
    private String name = "idea_070470";
 ...
 */
@Slf4j
public class Idea70470Service {
    private static final int IDEA_ID = 70470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70470Service() {
        this(new Idea70470Config());
    }

    public Idea70470Service(Idea70470Config config) {
        this.config = config != null ? config : new Idea70470Config();
