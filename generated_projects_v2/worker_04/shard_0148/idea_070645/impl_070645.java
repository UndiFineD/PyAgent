...
@Data
public class Idea70645Config {
    private String name = "idea_070645";
 ...
 */
@Slf4j
public class Idea70645Service {
    private static final int IDEA_ID = 70645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70645Service() {
        this(new Idea70645Config());
    }

    public Idea70645Service(Idea70645Config config) {
        this.config = config != null ? config : new Idea70645Config();
