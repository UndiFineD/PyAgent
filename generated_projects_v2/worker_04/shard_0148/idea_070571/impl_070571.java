...
@Data
public class Idea70571Config {
    private String name = "idea_070571";
 ...
 */
@Slf4j
public class Idea70571Service {
    private static final int IDEA_ID = 70571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70571Service() {
        this(new Idea70571Config());
    }

    public Idea70571Service(Idea70571Config config) {
        this.config = config != null ? config : new Idea70571Config();
