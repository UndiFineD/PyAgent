...
@Data
public class Idea70663Config {
    private String name = "idea_070663";
 ...
 */
@Slf4j
public class Idea70663Service {
    private static final int IDEA_ID = 70663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70663Service() {
        this(new Idea70663Config());
    }

    public Idea70663Service(Idea70663Config config) {
        this.config = config != null ? config : new Idea70663Config();
