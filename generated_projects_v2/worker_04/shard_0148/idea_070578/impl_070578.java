...
@Data
public class Idea70578Config {
    private String name = "idea_070578";
 ...
 */
@Slf4j
public class Idea70578Service {
    private static final int IDEA_ID = 70578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70578Service() {
        this(new Idea70578Config());
    }

    public Idea70578Service(Idea70578Config config) {
        this.config = config != null ? config : new Idea70578Config();
