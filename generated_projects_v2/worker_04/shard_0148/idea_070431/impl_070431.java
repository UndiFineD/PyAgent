...
@Data
public class Idea70431Config {
    private String name = "idea_070431";
 ...
 */
@Slf4j
public class Idea70431Service {
    private static final int IDEA_ID = 70431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70431Service() {
        this(new Idea70431Config());
    }

    public Idea70431Service(Idea70431Config config) {
        this.config = config != null ? config : new Idea70431Config();
