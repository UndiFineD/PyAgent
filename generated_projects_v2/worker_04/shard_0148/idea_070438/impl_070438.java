...
@Data
public class Idea70438Config {
    private String name = "idea_070438";
 ...
 */
@Slf4j
public class Idea70438Service {
    private static final int IDEA_ID = 70438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70438Service() {
        this(new Idea70438Config());
    }

    public Idea70438Service(Idea70438Config config) {
        this.config = config != null ? config : new Idea70438Config();
