...
@Data
public class Idea70611Config {
    private String name = "idea_070611";
 ...
 */
@Slf4j
public class Idea70611Service {
    private static final int IDEA_ID = 70611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70611Service() {
        this(new Idea70611Config());
    }

    public Idea70611Service(Idea70611Config config) {
        this.config = config != null ? config : new Idea70611Config();
