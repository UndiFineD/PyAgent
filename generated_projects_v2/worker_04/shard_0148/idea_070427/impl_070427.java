...
@Data
public class Idea70427Config {
    private String name = "idea_070427";
 ...
 */
@Slf4j
public class Idea70427Service {
    private static final int IDEA_ID = 70427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70427Service() {
        this(new Idea70427Config());
    }

    public Idea70427Service(Idea70427Config config) {
        this.config = config != null ? config : new Idea70427Config();
