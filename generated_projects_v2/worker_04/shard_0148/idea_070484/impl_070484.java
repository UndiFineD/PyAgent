...
@Data
public class Idea70484Config {
    private String name = "idea_070484";
 ...
 */
@Slf4j
public class Idea70484Service {
    private static final int IDEA_ID = 70484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70484Service() {
        this(new Idea70484Config());
    }

    public Idea70484Service(Idea70484Config config) {
        this.config = config != null ? config : new Idea70484Config();
