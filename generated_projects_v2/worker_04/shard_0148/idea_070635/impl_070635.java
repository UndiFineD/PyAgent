...
@Data
public class Idea70635Config {
    private String name = "idea_070635";
 ...
 */
@Slf4j
public class Idea70635Service {
    private static final int IDEA_ID = 70635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70635Service() {
        this(new Idea70635Config());
    }

    public Idea70635Service(Idea70635Config config) {
        this.config = config != null ? config : new Idea70635Config();
