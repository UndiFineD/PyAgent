...
@Data
public class Idea70369Config {
    private String name = "idea_070369";
 ...
 */
@Slf4j
public class Idea70369Service {
    private static final int IDEA_ID = 70369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70369Service() {
        this(new Idea70369Config());
    }

    public Idea70369Service(Idea70369Config config) {
        this.config = config != null ? config : new Idea70369Config();
