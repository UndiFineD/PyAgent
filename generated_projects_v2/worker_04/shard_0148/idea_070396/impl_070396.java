...
@Data
public class Idea70396Config {
    private String name = "idea_070396";
 ...
 */
@Slf4j
public class Idea70396Service {
    private static final int IDEA_ID = 70396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70396Service() {
        this(new Idea70396Config());
    }

    public Idea70396Service(Idea70396Config config) {
        this.config = config != null ? config : new Idea70396Config();
