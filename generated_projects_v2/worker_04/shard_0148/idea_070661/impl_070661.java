...
@Data
public class Idea70661Config {
    private String name = "idea_070661";
 ...
 */
@Slf4j
public class Idea70661Service {
    private static final int IDEA_ID = 70661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70661Service() {
        this(new Idea70661Config());
    }

    public Idea70661Service(Idea70661Config config) {
        this.config = config != null ? config : new Idea70661Config();
