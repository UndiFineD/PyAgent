...
@Data
public class Idea70682Config {
    private String name = "idea_070682";
 ...
 */
@Slf4j
public class Idea70682Service {
    private static final int IDEA_ID = 70682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70682Service() {
        this(new Idea70682Config());
    }

    public Idea70682Service(Idea70682Config config) {
        this.config = config != null ? config : new Idea70682Config();
