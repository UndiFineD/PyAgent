...
@Data
public class Idea70615Config {
    private String name = "idea_070615";
 ...
 */
@Slf4j
public class Idea70615Service {
    private static final int IDEA_ID = 70615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70615Service() {
        this(new Idea70615Config());
    }

    public Idea70615Service(Idea70615Config config) {
        this.config = config != null ? config : new Idea70615Config();
