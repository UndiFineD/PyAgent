...
@Data
public class Idea70400Config {
    private String name = "idea_070400";
 ...
 */
@Slf4j
public class Idea70400Service {
    private static final int IDEA_ID = 70400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70400Service() {
        this(new Idea70400Config());
    }

    public Idea70400Service(Idea70400Config config) {
        this.config = config != null ? config : new Idea70400Config();
