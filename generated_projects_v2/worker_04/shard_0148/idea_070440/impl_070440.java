...
@Data
public class Idea70440Config {
    private String name = "idea_070440";
 ...
 */
@Slf4j
public class Idea70440Service {
    private static final int IDEA_ID = 70440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70440Service() {
        this(new Idea70440Config());
    }

    public Idea70440Service(Idea70440Config config) {
        this.config = config != null ? config : new Idea70440Config();
