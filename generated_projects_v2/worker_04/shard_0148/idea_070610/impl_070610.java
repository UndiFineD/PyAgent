...
@Data
public class Idea70610Config {
    private String name = "idea_070610";
 ...
 */
@Slf4j
public class Idea70610Service {
    private static final int IDEA_ID = 70610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70610Service() {
        this(new Idea70610Config());
    }

    public Idea70610Service(Idea70610Config config) {
        this.config = config != null ? config : new Idea70610Config();
