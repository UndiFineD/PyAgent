...
@Data
public class Idea70341Config {
    private String name = "idea_070341";
 ...
 */
@Slf4j
public class Idea70341Service {
    private static final int IDEA_ID = 70341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70341Service() {
        this(new Idea70341Config());
    }

    public Idea70341Service(Idea70341Config config) {
        this.config = config != null ? config : new Idea70341Config();
