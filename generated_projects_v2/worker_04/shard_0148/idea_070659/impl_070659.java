...
@Data
public class Idea70659Config {
    private String name = "idea_070659";
 ...
 */
@Slf4j
public class Idea70659Service {
    private static final int IDEA_ID = 70659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70659Service() {
        this(new Idea70659Config());
    }

    public Idea70659Service(Idea70659Config config) {
        this.config = config != null ? config : new Idea70659Config();
