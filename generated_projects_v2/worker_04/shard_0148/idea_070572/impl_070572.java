...
@Data
public class Idea70572Config {
    private String name = "idea_070572";
 ...
 */
@Slf4j
public class Idea70572Service {
    private static final int IDEA_ID = 70572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70572Service() {
        this(new Idea70572Config());
    }

    public Idea70572Service(Idea70572Config config) {
        this.config = config != null ? config : new Idea70572Config();
