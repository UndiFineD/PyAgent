...
@Data
public class Idea70463Config {
    private String name = "idea_070463";
 ...
 */
@Slf4j
public class Idea70463Service {
    private static final int IDEA_ID = 70463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70463Service() {
        this(new Idea70463Config());
    }

    public Idea70463Service(Idea70463Config config) {
        this.config = config != null ? config : new Idea70463Config();
