...
@Data
public class Idea70551Config {
    private String name = "idea_070551";
 ...
 */
@Slf4j
public class Idea70551Service {
    private static final int IDEA_ID = 70551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70551Service() {
        this(new Idea70551Config());
    }

    public Idea70551Service(Idea70551Config config) {
        this.config = config != null ? config : new Idea70551Config();
