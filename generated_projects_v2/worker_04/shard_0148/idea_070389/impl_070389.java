...
@Data
public class Idea70389Config {
    private String name = "idea_070389";
 ...
 */
@Slf4j
public class Idea70389Service {
    private static final int IDEA_ID = 70389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70389Service() {
        this(new Idea70389Config());
    }

    public Idea70389Service(Idea70389Config config) {
        this.config = config != null ? config : new Idea70389Config();
