...
@Data
public class Idea70594Config {
    private String name = "idea_070594";
 ...
 */
@Slf4j
public class Idea70594Service {
    private static final int IDEA_ID = 70594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70594Service() {
        this(new Idea70594Config());
    }

    public Idea70594Service(Idea70594Config config) {
        this.config = config != null ? config : new Idea70594Config();
