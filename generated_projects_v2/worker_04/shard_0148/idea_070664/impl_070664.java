...
@Data
public class Idea70664Config {
    private String name = "idea_070664";
 ...
 */
@Slf4j
public class Idea70664Service {
    private static final int IDEA_ID = 70664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70664Service() {
        this(new Idea70664Config());
    }

    public Idea70664Service(Idea70664Config config) {
        this.config = config != null ? config : new Idea70664Config();
