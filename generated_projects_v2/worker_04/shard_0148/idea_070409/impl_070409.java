...
@Data
public class Idea70409Config {
    private String name = "idea_070409";
 ...
 */
@Slf4j
public class Idea70409Service {
    private static final int IDEA_ID = 70409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70409Service() {
        this(new Idea70409Config());
    }

    public Idea70409Service(Idea70409Config config) {
        this.config = config != null ? config : new Idea70409Config();
