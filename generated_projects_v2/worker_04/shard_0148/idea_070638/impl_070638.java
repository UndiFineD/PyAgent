...
@Data
public class Idea70638Config {
    private String name = "idea_070638";
 ...
 */
@Slf4j
public class Idea70638Service {
    private static final int IDEA_ID = 70638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70638Service() {
        this(new Idea70638Config());
    }

    public Idea70638Service(Idea70638Config config) {
        this.config = config != null ? config : new Idea70638Config();
