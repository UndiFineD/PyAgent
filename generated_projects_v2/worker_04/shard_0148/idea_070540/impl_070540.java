...
@Data
public class Idea70540Config {
    private String name = "idea_070540";
 ...
 */
@Slf4j
public class Idea70540Service {
    private static final int IDEA_ID = 70540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70540Service() {
        this(new Idea70540Config());
    }

    public Idea70540Service(Idea70540Config config) {
        this.config = config != null ? config : new Idea70540Config();
