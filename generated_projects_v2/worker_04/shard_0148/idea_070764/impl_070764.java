...
@Data
public class Idea70764Config {
    private String name = "idea_070764";
 ...
 */
@Slf4j
public class Idea70764Service {
    private static final int IDEA_ID = 70764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70764Service() {
        this(new Idea70764Config());
    }

    public Idea70764Service(Idea70764Config config) {
        this.config = config != null ? config : new Idea70764Config();
