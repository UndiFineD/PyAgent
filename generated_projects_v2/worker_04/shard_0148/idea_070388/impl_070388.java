...
@Data
public class Idea70388Config {
    private String name = "idea_070388";
 ...
 */
@Slf4j
public class Idea70388Service {
    private static final int IDEA_ID = 70388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70388Service() {
        this(new Idea70388Config());
    }

    public Idea70388Service(Idea70388Config config) {
        this.config = config != null ? config : new Idea70388Config();
