...
@Data
public class Idea70538Config {
    private String name = "idea_070538";
 ...
 */
@Slf4j
public class Idea70538Service {
    private static final int IDEA_ID = 70538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70538Service() {
        this(new Idea70538Config());
    }

    public Idea70538Service(Idea70538Config config) {
        this.config = config != null ? config : new Idea70538Config();
