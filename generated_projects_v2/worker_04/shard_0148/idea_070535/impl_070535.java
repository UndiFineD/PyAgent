...
@Data
public class Idea70535Config {
    private String name = "idea_070535";
 ...
 */
@Slf4j
public class Idea70535Service {
    private static final int IDEA_ID = 70535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70535Service() {
        this(new Idea70535Config());
    }

    public Idea70535Service(Idea70535Config config) {
        this.config = config != null ? config : new Idea70535Config();
