...
@Data
public class Idea70357Config {
    private String name = "idea_070357";
 ...
 */
@Slf4j
public class Idea70357Service {
    private static final int IDEA_ID = 70357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70357Service() {
        this(new Idea70357Config());
    }

    public Idea70357Service(Idea70357Config config) {
        this.config = config != null ? config : new Idea70357Config();
