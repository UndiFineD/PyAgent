...
@Data
public class Idea70756Config {
    private String name = "idea_070756";
 ...
 */
@Slf4j
public class Idea70756Service {
    private static final int IDEA_ID = 70756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70756Service() {
        this(new Idea70756Config());
    }

    public Idea70756Service(Idea70756Config config) {
        this.config = config != null ? config : new Idea70756Config();
