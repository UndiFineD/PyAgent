...
@Data
public class Idea70421Config {
    private String name = "idea_070421";
 ...
 */
@Slf4j
public class Idea70421Service {
    private static final int IDEA_ID = 70421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea70421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea70421Service() {
        this(new Idea70421Config());
    }

    public Idea70421Service(Idea70421Config config) {
        this.config = config != null ? config : new Idea70421Config();
