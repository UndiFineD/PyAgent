...
@Data
public class Idea63959Config {
    private String name = "idea_063959";
 ...
 */
@Slf4j
public class Idea63959Service {
    private static final int IDEA_ID = 63959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63959Service() {
        this(new Idea63959Config());
    }

    public Idea63959Service(Idea63959Config config) {
        this.config = config != null ? config : new Idea63959Config();
