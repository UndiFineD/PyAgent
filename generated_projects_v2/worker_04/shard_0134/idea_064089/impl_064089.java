...
@Data
public class Idea64089Config {
    private String name = "idea_064089";
 ...
 */
@Slf4j
public class Idea64089Service {
    private static final int IDEA_ID = 64089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64089Service() {
        this(new Idea64089Config());
    }

    public Idea64089Service(Idea64089Config config) {
        this.config = config != null ? config : new Idea64089Config();
