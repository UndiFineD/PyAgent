...
@Data
public class Idea63902Config {
    private String name = "idea_063902";
 ...
 */
@Slf4j
public class Idea63902Service {
    private static final int IDEA_ID = 63902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63902Service() {
        this(new Idea63902Config());
    }

    public Idea63902Service(Idea63902Config config) {
        this.config = config != null ? config : new Idea63902Config();
