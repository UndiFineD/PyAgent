...
@Data
public class Idea64103Config {
    private String name = "idea_064103";
 ...
 */
@Slf4j
public class Idea64103Service {
    private static final int IDEA_ID = 64103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64103Service() {
        this(new Idea64103Config());
    }

    public Idea64103Service(Idea64103Config config) {
        this.config = config != null ? config : new Idea64103Config();
