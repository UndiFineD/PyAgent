...
@Data
public class Idea63899Config {
    private String name = "idea_063899";
 ...
 */
@Slf4j
public class Idea63899Service {
    private static final int IDEA_ID = 63899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63899Service() {
        this(new Idea63899Config());
    }

    public Idea63899Service(Idea63899Config config) {
        this.config = config != null ? config : new Idea63899Config();
