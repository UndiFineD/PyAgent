...
@Data
public class Idea63775Config {
    private String name = "idea_063775";
 ...
 */
@Slf4j
public class Idea63775Service {
    private static final int IDEA_ID = 63775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63775Service() {
        this(new Idea63775Config());
    }

    public Idea63775Service(Idea63775Config config) {
        this.config = config != null ? config : new Idea63775Config();
