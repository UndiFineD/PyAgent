...
@Data
public class Idea63888Config {
    private String name = "idea_063888";
 ...
 */
@Slf4j
public class Idea63888Service {
    private static final int IDEA_ID = 63888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63888Service() {
        this(new Idea63888Config());
    }

    public Idea63888Service(Idea63888Config config) {
        this.config = config != null ? config : new Idea63888Config();
