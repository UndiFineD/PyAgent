...
@Data
public class Idea63733Config {
    private String name = "idea_063733";
 ...
 */
@Slf4j
public class Idea63733Service {
    private static final int IDEA_ID = 63733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63733Service() {
        this(new Idea63733Config());
    }

    public Idea63733Service(Idea63733Config config) {
        this.config = config != null ? config : new Idea63733Config();
