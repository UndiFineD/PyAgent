...
@Data
public class Idea64032Config {
    private String name = "idea_064032";
 ...
 */
@Slf4j
public class Idea64032Service {
    private static final int IDEA_ID = 64032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64032Service() {
        this(new Idea64032Config());
    }

    public Idea64032Service(Idea64032Config config) {
        this.config = config != null ? config : new Idea64032Config();
