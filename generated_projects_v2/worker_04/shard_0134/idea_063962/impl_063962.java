...
@Data
public class Idea63962Config {
    private String name = "idea_063962";
 ...
 */
@Slf4j
public class Idea63962Service {
    private static final int IDEA_ID = 63962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63962Service() {
        this(new Idea63962Config());
    }

    public Idea63962Service(Idea63962Config config) {
        this.config = config != null ? config : new Idea63962Config();
