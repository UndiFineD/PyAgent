...
@Data
public class Idea64015Config {
    private String name = "idea_064015";
 ...
 */
@Slf4j
public class Idea64015Service {
    private static final int IDEA_ID = 64015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64015Service() {
        this(new Idea64015Config());
    }

    public Idea64015Service(Idea64015Config config) {
        this.config = config != null ? config : new Idea64015Config();
