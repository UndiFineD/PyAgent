...
@Data
public class Idea63665Config {
    private String name = "idea_063665";
 ...
 */
@Slf4j
public class Idea63665Service {
    private static final int IDEA_ID = 63665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63665Service() {
        this(new Idea63665Config());
    }

    public Idea63665Service(Idea63665Config config) {
        this.config = config != null ? config : new Idea63665Config();
