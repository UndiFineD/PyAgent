...
@Data
public class Idea63894Config {
    private String name = "idea_063894";
 ...
 */
@Slf4j
public class Idea63894Service {
    private static final int IDEA_ID = 63894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63894Service() {
        this(new Idea63894Config());
    }

    public Idea63894Service(Idea63894Config config) {
        this.config = config != null ? config : new Idea63894Config();
