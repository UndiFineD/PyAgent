...
@Data
public class Idea63993Config {
    private String name = "idea_063993";
 ...
 */
@Slf4j
public class Idea63993Service {
    private static final int IDEA_ID = 63993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63993Service() {
        this(new Idea63993Config());
    }

    public Idea63993Service(Idea63993Config config) {
        this.config = config != null ? config : new Idea63993Config();
