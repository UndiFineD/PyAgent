...
@Data
public class Idea64046Config {
    private String name = "idea_064046";
 ...
 */
@Slf4j
public class Idea64046Service {
    private static final int IDEA_ID = 64046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64046Service() {
        this(new Idea64046Config());
    }

    public Idea64046Service(Idea64046Config config) {
        this.config = config != null ? config : new Idea64046Config();
