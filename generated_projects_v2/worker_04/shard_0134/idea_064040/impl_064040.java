...
@Data
public class Idea64040Config {
    private String name = "idea_064040";
 ...
 */
@Slf4j
public class Idea64040Service {
    private static final int IDEA_ID = 64040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64040Service() {
        this(new Idea64040Config());
    }

    public Idea64040Service(Idea64040Config config) {
        this.config = config != null ? config : new Idea64040Config();
