...
@Data
public class Idea64078Config {
    private String name = "idea_064078";
 ...
 */
@Slf4j
public class Idea64078Service {
    private static final int IDEA_ID = 64078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64078Service() {
        this(new Idea64078Config());
    }

    public Idea64078Service(Idea64078Config config) {
        this.config = config != null ? config : new Idea64078Config();
