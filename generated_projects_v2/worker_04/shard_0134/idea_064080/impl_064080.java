...
@Data
public class Idea64080Config {
    private String name = "idea_064080";
 ...
 */
@Slf4j
public class Idea64080Service {
    private static final int IDEA_ID = 64080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64080Service() {
        this(new Idea64080Config());
    }

    public Idea64080Service(Idea64080Config config) {
        this.config = config != null ? config : new Idea64080Config();
