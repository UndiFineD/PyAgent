...
@Data
public class Idea64076Config {
    private String name = "idea_064076";
 ...
 */
@Slf4j
public class Idea64076Service {
    private static final int IDEA_ID = 64076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64076Service() {
        this(new Idea64076Config());
    }

    public Idea64076Service(Idea64076Config config) {
        this.config = config != null ? config : new Idea64076Config();
