...
@Data
public class Idea63942Config {
    private String name = "idea_063942";
 ...
 */
@Slf4j
public class Idea63942Service {
    private static final int IDEA_ID = 63942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63942Service() {
        this(new Idea63942Config());
    }

    public Idea63942Service(Idea63942Config config) {
        this.config = config != null ? config : new Idea63942Config();
