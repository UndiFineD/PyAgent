...
@Data
public class Idea63698Config {
    private String name = "idea_063698";
 ...
 */
@Slf4j
public class Idea63698Service {
    private static final int IDEA_ID = 63698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63698Service() {
        this(new Idea63698Config());
    }

    public Idea63698Service(Idea63698Config config) {
        this.config = config != null ? config : new Idea63698Config();
