...
@Data
public class Idea63978Config {
    private String name = "idea_063978";
 ...
 */
@Slf4j
public class Idea63978Service {
    private static final int IDEA_ID = 63978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63978Service() {
        this(new Idea63978Config());
    }

    public Idea63978Service(Idea63978Config config) {
        this.config = config != null ? config : new Idea63978Config();
