...
@Data
public class Idea63657Config {
    private String name = "idea_063657";
 ...
 */
@Slf4j
public class Idea63657Service {
    private static final int IDEA_ID = 63657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63657Service() {
        this(new Idea63657Config());
    }

    public Idea63657Service(Idea63657Config config) {
        this.config = config != null ? config : new Idea63657Config();
