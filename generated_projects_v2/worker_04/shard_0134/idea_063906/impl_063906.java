...
@Data
public class Idea63906Config {
    private String name = "idea_063906";
 ...
 */
@Slf4j
public class Idea63906Service {
    private static final int IDEA_ID = 63906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63906Service() {
        this(new Idea63906Config());
    }

    public Idea63906Service(Idea63906Config config) {
        this.config = config != null ? config : new Idea63906Config();
