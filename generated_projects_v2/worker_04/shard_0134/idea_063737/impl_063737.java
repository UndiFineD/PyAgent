...
@Data
public class Idea63737Config {
    private String name = "idea_063737";
 ...
 */
@Slf4j
public class Idea63737Service {
    private static final int IDEA_ID = 63737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63737Service() {
        this(new Idea63737Config());
    }

    public Idea63737Service(Idea63737Config config) {
        this.config = config != null ? config : new Idea63737Config();
