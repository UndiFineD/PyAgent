...
@Data
public class Idea64107Config {
    private String name = "idea_064107";
 ...
 */
@Slf4j
public class Idea64107Service {
    private static final int IDEA_ID = 64107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64107Service() {
        this(new Idea64107Config());
    }

    public Idea64107Service(Idea64107Config config) {
        this.config = config != null ? config : new Idea64107Config();
