...
@Data
public class Idea63714Config {
    private String name = "idea_063714";
 ...
 */
@Slf4j
public class Idea63714Service {
    private static final int IDEA_ID = 63714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63714Service() {
        this(new Idea63714Config());
    }

    public Idea63714Service(Idea63714Config config) {
        this.config = config != null ? config : new Idea63714Config();
