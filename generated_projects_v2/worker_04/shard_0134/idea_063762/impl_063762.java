...
@Data
public class Idea63762Config {
    private String name = "idea_063762";
 ...
 */
@Slf4j
public class Idea63762Service {
    private static final int IDEA_ID = 63762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63762Service() {
        this(new Idea63762Config());
    }

    public Idea63762Service(Idea63762Config config) {
        this.config = config != null ? config : new Idea63762Config();
