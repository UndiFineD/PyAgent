...
@Data
public class Idea63860Config {
    private String name = "idea_063860";
 ...
 */
@Slf4j
public class Idea63860Service {
    private static final int IDEA_ID = 63860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63860Service() {
        this(new Idea63860Config());
    }

    public Idea63860Service(Idea63860Config config) {
        this.config = config != null ? config : new Idea63860Config();
