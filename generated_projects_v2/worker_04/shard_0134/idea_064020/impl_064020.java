...
@Data
public class Idea64020Config {
    private String name = "idea_064020";
 ...
 */
@Slf4j
public class Idea64020Service {
    private static final int IDEA_ID = 64020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64020Service() {
        this(new Idea64020Config());
    }

    public Idea64020Service(Idea64020Config config) {
        this.config = config != null ? config : new Idea64020Config();
