...
@Data
public class Idea63826Config {
    private String name = "idea_063826";
 ...
 */
@Slf4j
public class Idea63826Service {
    private static final int IDEA_ID = 63826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63826Service() {
        this(new Idea63826Config());
    }

    public Idea63826Service(Idea63826Config config) {
        this.config = config != null ? config : new Idea63826Config();
