...
@Data
public class Idea63921Config {
    private String name = "idea_063921";
 ...
 */
@Slf4j
public class Idea63921Service {
    private static final int IDEA_ID = 63921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63921Service() {
        this(new Idea63921Config());
    }

    public Idea63921Service(Idea63921Config config) {
        this.config = config != null ? config : new Idea63921Config();
