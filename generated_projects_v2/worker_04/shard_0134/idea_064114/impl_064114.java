...
@Data
public class Idea64114Config {
    private String name = "idea_064114";
 ...
 */
@Slf4j
public class Idea64114Service {
    private static final int IDEA_ID = 64114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64114Service() {
        this(new Idea64114Config());
    }

    public Idea64114Service(Idea64114Config config) {
        this.config = config != null ? config : new Idea64114Config();
