...
@Data
public class Idea64117Config {
    private String name = "idea_064117";
 ...
 */
@Slf4j
public class Idea64117Service {
    private static final int IDEA_ID = 64117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64117Service() {
        this(new Idea64117Config());
    }

    public Idea64117Service(Idea64117Config config) {
        this.config = config != null ? config : new Idea64117Config();
