...
@Data
public class Idea63907Config {
    private String name = "idea_063907";
 ...
 */
@Slf4j
public class Idea63907Service {
    private static final int IDEA_ID = 63907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63907Service() {
        this(new Idea63907Config());
    }

    public Idea63907Service(Idea63907Config config) {
        this.config = config != null ? config : new Idea63907Config();
