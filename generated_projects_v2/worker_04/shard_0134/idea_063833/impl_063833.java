...
@Data
public class Idea63833Config {
    private String name = "idea_063833";
 ...
 */
@Slf4j
public class Idea63833Service {
    private static final int IDEA_ID = 63833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63833Service() {
        this(new Idea63833Config());
    }

    public Idea63833Service(Idea63833Config config) {
        this.config = config != null ? config : new Idea63833Config();
