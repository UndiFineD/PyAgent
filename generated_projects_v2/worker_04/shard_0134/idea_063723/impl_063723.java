...
@Data
public class Idea63723Config {
    private String name = "idea_063723";
 ...
 */
@Slf4j
public class Idea63723Service {
    private static final int IDEA_ID = 63723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63723Service() {
        this(new Idea63723Config());
    }

    public Idea63723Service(Idea63723Config config) {
        this.config = config != null ? config : new Idea63723Config();
