...
@Data
public class Idea63658Config {
    private String name = "idea_063658";
 ...
 */
@Slf4j
public class Idea63658Service {
    private static final int IDEA_ID = 63658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63658Service() {
        this(new Idea63658Config());
    }

    public Idea63658Service(Idea63658Config config) {
        this.config = config != null ? config : new Idea63658Config();
