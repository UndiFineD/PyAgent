...
@Data
public class Idea63987Config {
    private String name = "idea_063987";
 ...
 */
@Slf4j
public class Idea63987Service {
    private static final int IDEA_ID = 63987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63987Service() {
        this(new Idea63987Config());
    }

    public Idea63987Service(Idea63987Config config) {
        this.config = config != null ? config : new Idea63987Config();
