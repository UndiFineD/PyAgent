...
@Data
public class Idea63741Config {
    private String name = "idea_063741";
 ...
 */
@Slf4j
public class Idea63741Service {
    private static final int IDEA_ID = 63741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63741Service() {
        this(new Idea63741Config());
    }

    public Idea63741Service(Idea63741Config config) {
        this.config = config != null ? config : new Idea63741Config();
