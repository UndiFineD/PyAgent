...
@Data
public class Idea63869Config {
    private String name = "idea_063869";
 ...
 */
@Slf4j
public class Idea63869Service {
    private static final int IDEA_ID = 63869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63869Service() {
        this(new Idea63869Config());
    }

    public Idea63869Service(Idea63869Config config) {
        this.config = config != null ? config : new Idea63869Config();
