...
@Data
public class Idea64102Config {
    private String name = "idea_064102";
 ...
 */
@Slf4j
public class Idea64102Service {
    private static final int IDEA_ID = 64102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64102Service() {
        this(new Idea64102Config());
    }

    public Idea64102Service(Idea64102Config config) {
        this.config = config != null ? config : new Idea64102Config();
