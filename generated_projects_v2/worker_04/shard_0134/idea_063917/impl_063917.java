...
@Data
public class Idea63917Config {
    private String name = "idea_063917";
 ...
 */
@Slf4j
public class Idea63917Service {
    private static final int IDEA_ID = 63917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63917Service() {
        this(new Idea63917Config());
    }

    public Idea63917Service(Idea63917Config config) {
        this.config = config != null ? config : new Idea63917Config();
