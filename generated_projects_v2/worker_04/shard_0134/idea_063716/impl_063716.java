...
@Data
public class Idea63716Config {
    private String name = "idea_063716";
 ...
 */
@Slf4j
public class Idea63716Service {
    private static final int IDEA_ID = 63716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63716Service() {
        this(new Idea63716Config());
    }

    public Idea63716Service(Idea63716Config config) {
        this.config = config != null ? config : new Idea63716Config();
