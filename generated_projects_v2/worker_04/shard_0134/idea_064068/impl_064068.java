...
@Data
public class Idea64068Config {
    private String name = "idea_064068";
 ...
 */
@Slf4j
public class Idea64068Service {
    private static final int IDEA_ID = 64068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64068Service() {
        this(new Idea64068Config());
    }

    public Idea64068Service(Idea64068Config config) {
        this.config = config != null ? config : new Idea64068Config();
