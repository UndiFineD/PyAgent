...
@Data
public class Idea63944Config {
    private String name = "idea_063944";
 ...
 */
@Slf4j
public class Idea63944Service {
    private static final int IDEA_ID = 63944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63944Service() {
        this(new Idea63944Config());
    }

    public Idea63944Service(Idea63944Config config) {
        this.config = config != null ? config : new Idea63944Config();
