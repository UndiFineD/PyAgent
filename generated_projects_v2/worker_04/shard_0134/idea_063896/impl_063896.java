...
@Data
public class Idea63896Config {
    private String name = "idea_063896";
 ...
 */
@Slf4j
public class Idea63896Service {
    private static final int IDEA_ID = 63896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63896Service() {
        this(new Idea63896Config());
    }

    public Idea63896Service(Idea63896Config config) {
        this.config = config != null ? config : new Idea63896Config();
