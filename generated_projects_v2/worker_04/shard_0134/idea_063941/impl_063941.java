...
@Data
public class Idea63941Config {
    private String name = "idea_063941";
 ...
 */
@Slf4j
public class Idea63941Service {
    private static final int IDEA_ID = 63941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63941Service() {
        this(new Idea63941Config());
    }

    public Idea63941Service(Idea63941Config config) {
        this.config = config != null ? config : new Idea63941Config();
