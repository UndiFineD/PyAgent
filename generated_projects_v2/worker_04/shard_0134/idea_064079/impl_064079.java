...
@Data
public class Idea64079Config {
    private String name = "idea_064079";
 ...
 */
@Slf4j
public class Idea64079Service {
    private static final int IDEA_ID = 64079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64079Service() {
        this(new Idea64079Config());
    }

    public Idea64079Service(Idea64079Config config) {
        this.config = config != null ? config : new Idea64079Config();
