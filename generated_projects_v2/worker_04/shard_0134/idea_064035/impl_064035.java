...
@Data
public class Idea64035Config {
    private String name = "idea_064035";
 ...
 */
@Slf4j
public class Idea64035Service {
    private static final int IDEA_ID = 64035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64035Service() {
        this(new Idea64035Config());
    }

    public Idea64035Service(Idea64035Config config) {
        this.config = config != null ? config : new Idea64035Config();
