...
@Data
public class Idea63844Config {
    private String name = "idea_063844";
 ...
 */
@Slf4j
public class Idea63844Service {
    private static final int IDEA_ID = 63844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63844Service() {
        this(new Idea63844Config());
    }

    public Idea63844Service(Idea63844Config config) {
        this.config = config != null ? config : new Idea63844Config();
