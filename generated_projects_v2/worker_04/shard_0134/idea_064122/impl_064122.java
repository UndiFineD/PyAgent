...
@Data
public class Idea64122Config {
    private String name = "idea_064122";
 ...
 */
@Slf4j
public class Idea64122Service {
    private static final int IDEA_ID = 64122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64122Service() {
        this(new Idea64122Config());
    }

    public Idea64122Service(Idea64122Config config) {
        this.config = config != null ? config : new Idea64122Config();
