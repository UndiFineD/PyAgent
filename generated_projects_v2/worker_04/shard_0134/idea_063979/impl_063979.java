...
@Data
public class Idea63979Config {
    private String name = "idea_063979";
 ...
 */
@Slf4j
public class Idea63979Service {
    private static final int IDEA_ID = 63979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63979Service() {
        this(new Idea63979Config());
    }

    public Idea63979Service(Idea63979Config config) {
        this.config = config != null ? config : new Idea63979Config();
