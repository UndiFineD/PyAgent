...
@Data
public class Idea63674Config {
    private String name = "idea_063674";
 ...
 */
@Slf4j
public class Idea63674Service {
    private static final int IDEA_ID = 63674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63674Service() {
        this(new Idea63674Config());
    }

    public Idea63674Service(Idea63674Config config) {
        this.config = config != null ? config : new Idea63674Config();
