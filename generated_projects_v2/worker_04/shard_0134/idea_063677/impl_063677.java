...
@Data
public class Idea63677Config {
    private String name = "idea_063677";
 ...
 */
@Slf4j
public class Idea63677Service {
    private static final int IDEA_ID = 63677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63677Service() {
        this(new Idea63677Config());
    }

    public Idea63677Service(Idea63677Config config) {
        this.config = config != null ? config : new Idea63677Config();
