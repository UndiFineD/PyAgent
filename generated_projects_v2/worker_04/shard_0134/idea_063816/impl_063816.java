...
@Data
public class Idea63816Config {
    private String name = "idea_063816";
 ...
 */
@Slf4j
public class Idea63816Service {
    private static final int IDEA_ID = 63816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63816Service() {
        this(new Idea63816Config());
    }

    public Idea63816Service(Idea63816Config config) {
        this.config = config != null ? config : new Idea63816Config();
