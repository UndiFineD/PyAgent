...
@Data
public class Idea63997Config {
    private String name = "idea_063997";
 ...
 */
@Slf4j
public class Idea63997Service {
    private static final int IDEA_ID = 63997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63997Service() {
        this(new Idea63997Config());
    }

    public Idea63997Service(Idea63997Config config) {
        this.config = config != null ? config : new Idea63997Config();
