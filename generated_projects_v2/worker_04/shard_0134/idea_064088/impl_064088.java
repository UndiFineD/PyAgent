...
@Data
public class Idea64088Config {
    private String name = "idea_064088";
 ...
 */
@Slf4j
public class Idea64088Service {
    private static final int IDEA_ID = 64088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64088Service() {
        this(new Idea64088Config());
    }

    public Idea64088Service(Idea64088Config config) {
        this.config = config != null ? config : new Idea64088Config();
