...
@Data
public class Idea63742Config {
    private String name = "idea_063742";
 ...
 */
@Slf4j
public class Idea63742Service {
    private static final int IDEA_ID = 63742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63742Service() {
        this(new Idea63742Config());
    }

    public Idea63742Service(Idea63742Config config) {
        this.config = config != null ? config : new Idea63742Config();
