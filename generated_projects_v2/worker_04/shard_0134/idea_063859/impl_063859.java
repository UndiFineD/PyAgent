...
@Data
public class Idea63859Config {
    private String name = "idea_063859";
 ...
 */
@Slf4j
public class Idea63859Service {
    private static final int IDEA_ID = 63859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63859Service() {
        this(new Idea63859Config());
    }

    public Idea63859Service(Idea63859Config config) {
        this.config = config != null ? config : new Idea63859Config();
