...
@Data
public class Idea63983Config {
    private String name = "idea_063983";
 ...
 */
@Slf4j
public class Idea63983Service {
    private static final int IDEA_ID = 63983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63983Service() {
        this(new Idea63983Config());
    }

    public Idea63983Service(Idea63983Config config) {
        this.config = config != null ? config : new Idea63983Config();
