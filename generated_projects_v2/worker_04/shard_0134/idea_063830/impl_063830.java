...
@Data
public class Idea63830Config {
    private String name = "idea_063830";
 ...
 */
@Slf4j
public class Idea63830Service {
    private static final int IDEA_ID = 63830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63830Service() {
        this(new Idea63830Config());
    }

    public Idea63830Service(Idea63830Config config) {
        this.config = config != null ? config : new Idea63830Config();
