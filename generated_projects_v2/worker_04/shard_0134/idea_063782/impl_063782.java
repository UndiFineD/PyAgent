...
@Data
public class Idea63782Config {
    private String name = "idea_063782";
 ...
 */
@Slf4j
public class Idea63782Service {
    private static final int IDEA_ID = 63782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63782Service() {
        this(new Idea63782Config());
    }

    public Idea63782Service(Idea63782Config config) {
        this.config = config != null ? config : new Idea63782Config();
