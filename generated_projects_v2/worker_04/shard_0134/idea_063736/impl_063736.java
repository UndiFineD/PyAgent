...
@Data
public class Idea63736Config {
    private String name = "idea_063736";
 ...
 */
@Slf4j
public class Idea63736Service {
    private static final int IDEA_ID = 63736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63736Service() {
        this(new Idea63736Config());
    }

    public Idea63736Service(Idea63736Config config) {
        this.config = config != null ? config : new Idea63736Config();
