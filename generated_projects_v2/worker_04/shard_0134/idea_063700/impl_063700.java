...
@Data
public class Idea63700Config {
    private String name = "idea_063700";
 ...
 */
@Slf4j
public class Idea63700Service {
    private static final int IDEA_ID = 63700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63700Service() {
        this(new Idea63700Config());
    }

    public Idea63700Service(Idea63700Config config) {
        this.config = config != null ? config : new Idea63700Config();
