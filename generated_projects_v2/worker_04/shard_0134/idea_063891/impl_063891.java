...
@Data
public class Idea63891Config {
    private String name = "idea_063891";
 ...
 */
@Slf4j
public class Idea63891Service {
    private static final int IDEA_ID = 63891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63891Service() {
        this(new Idea63891Config());
    }

    public Idea63891Service(Idea63891Config config) {
        this.config = config != null ? config : new Idea63891Config();
