...
@Data
public class Idea64001Config {
    private String name = "idea_064001";
 ...
 */
@Slf4j
public class Idea64001Service {
    private static final int IDEA_ID = 64001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64001Service() {
        this(new Idea64001Config());
    }

    public Idea64001Service(Idea64001Config config) {
        this.config = config != null ? config : new Idea64001Config();
