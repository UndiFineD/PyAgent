...
@Data
public class Idea63650Config {
    private String name = "idea_063650";
 ...
 */
@Slf4j
public class Idea63650Service {
    private static final int IDEA_ID = 63650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63650Service() {
        this(new Idea63650Config());
    }

    public Idea63650Service(Idea63650Config config) {
        this.config = config != null ? config : new Idea63650Config();
