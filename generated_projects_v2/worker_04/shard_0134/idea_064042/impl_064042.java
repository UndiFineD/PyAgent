...
@Data
public class Idea64042Config {
    private String name = "idea_064042";
 ...
 */
@Slf4j
public class Idea64042Service {
    private static final int IDEA_ID = 64042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64042Service() {
        this(new Idea64042Config());
    }

    public Idea64042Service(Idea64042Config config) {
        this.config = config != null ? config : new Idea64042Config();
