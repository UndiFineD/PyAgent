...
@Data
public class Idea64118Config {
    private String name = "idea_064118";
 ...
 */
@Slf4j
public class Idea64118Service {
    private static final int IDEA_ID = 64118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64118Service() {
        this(new Idea64118Config());
    }

    public Idea64118Service(Idea64118Config config) {
        this.config = config != null ? config : new Idea64118Config();
