...
@Data
public class Idea63936Config {
    private String name = "idea_063936";
 ...
 */
@Slf4j
public class Idea63936Service {
    private static final int IDEA_ID = 63936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63936Service() {
        this(new Idea63936Config());
    }

    public Idea63936Service(Idea63936Config config) {
        this.config = config != null ? config : new Idea63936Config();
