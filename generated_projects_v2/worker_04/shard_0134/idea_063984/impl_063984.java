...
@Data
public class Idea63984Config {
    private String name = "idea_063984";
 ...
 */
@Slf4j
public class Idea63984Service {
    private static final int IDEA_ID = 63984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63984Service() {
        this(new Idea63984Config());
    }

    public Idea63984Service(Idea63984Config config) {
        this.config = config != null ? config : new Idea63984Config();
