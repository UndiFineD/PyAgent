...
@Data
public class Idea63915Config {
    private String name = "idea_063915";
 ...
 */
@Slf4j
public class Idea63915Service {
    private static final int IDEA_ID = 63915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63915Service() {
        this(new Idea63915Config());
    }

    public Idea63915Service(Idea63915Config config) {
        this.config = config != null ? config : new Idea63915Config();
