...
@Data
public class Idea63743Config {
    private String name = "idea_063743";
 ...
 */
@Slf4j
public class Idea63743Service {
    private static final int IDEA_ID = 63743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63743Service() {
        this(new Idea63743Config());
    }

    public Idea63743Service(Idea63743Config config) {
        this.config = config != null ? config : new Idea63743Config();
