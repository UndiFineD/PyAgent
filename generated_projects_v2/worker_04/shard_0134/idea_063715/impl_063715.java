...
@Data
public class Idea63715Config {
    private String name = "idea_063715";
 ...
 */
@Slf4j
public class Idea63715Service {
    private static final int IDEA_ID = 63715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63715Service() {
        this(new Idea63715Config());
    }

    public Idea63715Service(Idea63715Config config) {
        this.config = config != null ? config : new Idea63715Config();
