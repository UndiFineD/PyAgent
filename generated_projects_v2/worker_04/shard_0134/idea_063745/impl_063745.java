...
@Data
public class Idea63745Config {
    private String name = "idea_063745";
 ...
 */
@Slf4j
public class Idea63745Service {
    private static final int IDEA_ID = 63745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63745Service() {
        this(new Idea63745Config());
    }

    public Idea63745Service(Idea63745Config config) {
        this.config = config != null ? config : new Idea63745Config();
