...
@Data
public class Idea63798Config {
    private String name = "idea_063798";
 ...
 */
@Slf4j
public class Idea63798Service {
    private static final int IDEA_ID = 63798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63798Service() {
        this(new Idea63798Config());
    }

    public Idea63798Service(Idea63798Config config) {
        this.config = config != null ? config : new Idea63798Config();
