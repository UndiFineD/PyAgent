...
@Data
public class Idea63721Config {
    private String name = "idea_063721";
 ...
 */
@Slf4j
public class Idea63721Service {
    private static final int IDEA_ID = 63721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63721Service() {
        this(new Idea63721Config());
    }

    public Idea63721Service(Idea63721Config config) {
        this.config = config != null ? config : new Idea63721Config();
