...
@Data
public class Idea64024Config {
    private String name = "idea_064024";
 ...
 */
@Slf4j
public class Idea64024Service {
    private static final int IDEA_ID = 64024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64024Service() {
        this(new Idea64024Config());
    }

    public Idea64024Service(Idea64024Config config) {
        this.config = config != null ? config : new Idea64024Config();
