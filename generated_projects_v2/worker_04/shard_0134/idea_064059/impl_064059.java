...
@Data
public class Idea64059Config {
    private String name = "idea_064059";
 ...
 */
@Slf4j
public class Idea64059Service {
    private static final int IDEA_ID = 64059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64059Service() {
        this(new Idea64059Config());
    }

    public Idea64059Service(Idea64059Config config) {
        this.config = config != null ? config : new Idea64059Config();
