...
@Data
public class Idea63828Config {
    private String name = "idea_063828";
 ...
 */
@Slf4j
public class Idea63828Service {
    private static final int IDEA_ID = 63828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63828Service() {
        this(new Idea63828Config());
    }

    public Idea63828Service(Idea63828Config config) {
        this.config = config != null ? config : new Idea63828Config();
