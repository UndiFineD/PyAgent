...
@Data
public class Idea63923Config {
    private String name = "idea_063923";
 ...
 */
@Slf4j
public class Idea63923Service {
    private static final int IDEA_ID = 63923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63923Service() {
        this(new Idea63923Config());
    }

    public Idea63923Service(Idea63923Config config) {
        this.config = config != null ? config : new Idea63923Config();
