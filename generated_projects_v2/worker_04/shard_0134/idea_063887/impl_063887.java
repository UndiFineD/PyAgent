...
@Data
public class Idea63887Config {
    private String name = "idea_063887";
 ...
 */
@Slf4j
public class Idea63887Service {
    private static final int IDEA_ID = 63887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63887Service() {
        this(new Idea63887Config());
    }

    public Idea63887Service(Idea63887Config config) {
        this.config = config != null ? config : new Idea63887Config();
