...
@Data
public class Idea63705Config {
    private String name = "idea_063705";
 ...
 */
@Slf4j
public class Idea63705Service {
    private static final int IDEA_ID = 63705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63705Service() {
        this(new Idea63705Config());
    }

    public Idea63705Service(Idea63705Config config) {
        this.config = config != null ? config : new Idea63705Config();
