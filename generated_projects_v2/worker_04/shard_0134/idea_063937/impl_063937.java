...
@Data
public class Idea63937Config {
    private String name = "idea_063937";
 ...
 */
@Slf4j
public class Idea63937Service {
    private static final int IDEA_ID = 63937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63937Service() {
        this(new Idea63937Config());
    }

    public Idea63937Service(Idea63937Config config) {
        this.config = config != null ? config : new Idea63937Config();
