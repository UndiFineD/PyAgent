...
@Data
public class Idea63881Config {
    private String name = "idea_063881";
 ...
 */
@Slf4j
public class Idea63881Service {
    private static final int IDEA_ID = 63881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63881Service() {
        this(new Idea63881Config());
    }

    public Idea63881Service(Idea63881Config config) {
        this.config = config != null ? config : new Idea63881Config();
