...
@Data
public class Idea63739Config {
    private String name = "idea_063739";
 ...
 */
@Slf4j
public class Idea63739Service {
    private static final int IDEA_ID = 63739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63739Service() {
        this(new Idea63739Config());
    }

    public Idea63739Service(Idea63739Config config) {
        this.config = config != null ? config : new Idea63739Config();
