...
@Data
public class Idea63975Config {
    private String name = "idea_063975";
 ...
 */
@Slf4j
public class Idea63975Service {
    private static final int IDEA_ID = 63975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63975Service() {
        this(new Idea63975Config());
    }

    public Idea63975Service(Idea63975Config config) {
        this.config = config != null ? config : new Idea63975Config();
