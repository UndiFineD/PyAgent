...
@Data
public class Idea63922Config {
    private String name = "idea_063922";
 ...
 */
@Slf4j
public class Idea63922Service {
    private static final int IDEA_ID = 63922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63922Service() {
        this(new Idea63922Config());
    }

    public Idea63922Service(Idea63922Config config) {
        this.config = config != null ? config : new Idea63922Config();
