...
@Data
public class Idea63974Config {
    private String name = "idea_063974";
 ...
 */
@Slf4j
public class Idea63974Service {
    private static final int IDEA_ID = 63974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63974Service() {
        this(new Idea63974Config());
    }

    public Idea63974Service(Idea63974Config config) {
        this.config = config != null ? config : new Idea63974Config();
