...
@Data
public class Idea64027Config {
    private String name = "idea_064027";
 ...
 */
@Slf4j
public class Idea64027Service {
    private static final int IDEA_ID = 64027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64027Service() {
        this(new Idea64027Config());
    }

    public Idea64027Service(Idea64027Config config) {
        this.config = config != null ? config : new Idea64027Config();
