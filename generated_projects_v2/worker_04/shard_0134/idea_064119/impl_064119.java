...
@Data
public class Idea64119Config {
    private String name = "idea_064119";
 ...
 */
@Slf4j
public class Idea64119Service {
    private static final int IDEA_ID = 64119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64119Service() {
        this(new Idea64119Config());
    }

    public Idea64119Service(Idea64119Config config) {
        this.config = config != null ? config : new Idea64119Config();
