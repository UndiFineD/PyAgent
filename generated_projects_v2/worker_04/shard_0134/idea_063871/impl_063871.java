...
@Data
public class Idea63871Config {
    private String name = "idea_063871";
 ...
 */
@Slf4j
public class Idea63871Service {
    private static final int IDEA_ID = 63871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63871Service() {
        this(new Idea63871Config());
    }

    public Idea63871Service(Idea63871Config config) {
        this.config = config != null ? config : new Idea63871Config();
