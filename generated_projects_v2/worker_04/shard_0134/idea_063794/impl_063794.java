...
@Data
public class Idea63794Config {
    private String name = "idea_063794";
 ...
 */
@Slf4j
public class Idea63794Service {
    private static final int IDEA_ID = 63794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63794Service() {
        this(new Idea63794Config());
    }

    public Idea63794Service(Idea63794Config config) {
        this.config = config != null ? config : new Idea63794Config();
