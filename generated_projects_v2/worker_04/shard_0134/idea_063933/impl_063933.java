...
@Data
public class Idea63933Config {
    private String name = "idea_063933";
 ...
 */
@Slf4j
public class Idea63933Service {
    private static final int IDEA_ID = 63933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63933Service() {
        this(new Idea63933Config());
    }

    public Idea63933Service(Idea63933Config config) {
        this.config = config != null ? config : new Idea63933Config();
