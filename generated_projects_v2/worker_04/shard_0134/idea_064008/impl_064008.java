...
@Data
public class Idea64008Config {
    private String name = "idea_064008";
 ...
 */
@Slf4j
public class Idea64008Service {
    private static final int IDEA_ID = 64008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64008Service() {
        this(new Idea64008Config());
    }

    public Idea64008Service(Idea64008Config config) {
        this.config = config != null ? config : new Idea64008Config();
