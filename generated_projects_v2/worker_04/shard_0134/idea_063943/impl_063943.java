...
@Data
public class Idea63943Config {
    private String name = "idea_063943";
 ...
 */
@Slf4j
public class Idea63943Service {
    private static final int IDEA_ID = 63943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63943Service() {
        this(new Idea63943Config());
    }

    public Idea63943Service(Idea63943Config config) {
        this.config = config != null ? config : new Idea63943Config();
