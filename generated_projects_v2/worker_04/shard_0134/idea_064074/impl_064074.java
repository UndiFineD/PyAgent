...
@Data
public class Idea64074Config {
    private String name = "idea_064074";
 ...
 */
@Slf4j
public class Idea64074Service {
    private static final int IDEA_ID = 64074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64074Service() {
        this(new Idea64074Config());
    }

    public Idea64074Service(Idea64074Config config) {
        this.config = config != null ? config : new Idea64074Config();
