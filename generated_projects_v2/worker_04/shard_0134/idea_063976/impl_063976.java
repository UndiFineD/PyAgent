...
@Data
public class Idea63976Config {
    private String name = "idea_063976";
 ...
 */
@Slf4j
public class Idea63976Service {
    private static final int IDEA_ID = 63976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63976Service() {
        this(new Idea63976Config());
    }

    public Idea63976Service(Idea63976Config config) {
        this.config = config != null ? config : new Idea63976Config();
