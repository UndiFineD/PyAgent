...
@Data
public class Idea63695Config {
    private String name = "idea_063695";
 ...
 */
@Slf4j
public class Idea63695Service {
    private static final int IDEA_ID = 63695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63695Service() {
        this(new Idea63695Config());
    }

    public Idea63695Service(Idea63695Config config) {
        this.config = config != null ? config : new Idea63695Config();
