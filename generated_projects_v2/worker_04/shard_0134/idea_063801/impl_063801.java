...
@Data
public class Idea63801Config {
    private String name = "idea_063801";
 ...
 */
@Slf4j
public class Idea63801Service {
    private static final int IDEA_ID = 63801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63801Service() {
        this(new Idea63801Config());
    }

    public Idea63801Service(Idea63801Config config) {
        this.config = config != null ? config : new Idea63801Config();
