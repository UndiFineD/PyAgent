...
@Data
public class Idea63889Config {
    private String name = "idea_063889";
 ...
 */
@Slf4j
public class Idea63889Service {
    private static final int IDEA_ID = 63889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63889Service() {
        this(new Idea63889Config());
    }

    public Idea63889Service(Idea63889Config config) {
        this.config = config != null ? config : new Idea63889Config();
