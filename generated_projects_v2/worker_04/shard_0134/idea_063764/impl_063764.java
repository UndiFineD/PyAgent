...
@Data
public class Idea63764Config {
    private String name = "idea_063764";
 ...
 */
@Slf4j
public class Idea63764Service {
    private static final int IDEA_ID = 63764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63764Service() {
        this(new Idea63764Config());
    }

    public Idea63764Service(Idea63764Config config) {
        this.config = config != null ? config : new Idea63764Config();
