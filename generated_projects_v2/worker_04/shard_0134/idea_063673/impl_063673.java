...
@Data
public class Idea63673Config {
    private String name = "idea_063673";
 ...
 */
@Slf4j
public class Idea63673Service {
    private static final int IDEA_ID = 63673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63673Service() {
        this(new Idea63673Config());
    }

    public Idea63673Service(Idea63673Config config) {
        this.config = config != null ? config : new Idea63673Config();
