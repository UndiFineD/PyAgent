...
@Data
public class Idea63766Config {
    private String name = "idea_063766";
 ...
 */
@Slf4j
public class Idea63766Service {
    private static final int IDEA_ID = 63766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63766Service() {
        this(new Idea63766Config());
    }

    public Idea63766Service(Idea63766Config config) {
        this.config = config != null ? config : new Idea63766Config();
