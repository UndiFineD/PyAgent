...
@Data
public class Idea63763Config {
    private String name = "idea_063763";
 ...
 */
@Slf4j
public class Idea63763Service {
    private static final int IDEA_ID = 63763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63763Service() {
        this(new Idea63763Config());
    }

    public Idea63763Service(Idea63763Config config) {
        this.config = config != null ? config : new Idea63763Config();
