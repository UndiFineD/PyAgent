...
@Data
public class Idea63730Config {
    private String name = "idea_063730";
 ...
 */
@Slf4j
public class Idea63730Service {
    private static final int IDEA_ID = 63730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63730Service() {
        this(new Idea63730Config());
    }

    public Idea63730Service(Idea63730Config config) {
        this.config = config != null ? config : new Idea63730Config();
