...
@Data
public class Idea63886Config {
    private String name = "idea_063886";
 ...
 */
@Slf4j
public class Idea63886Service {
    private static final int IDEA_ID = 63886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63886Service() {
        this(new Idea63886Config());
    }

    public Idea63886Service(Idea63886Config config) {
        this.config = config != null ? config : new Idea63886Config();
