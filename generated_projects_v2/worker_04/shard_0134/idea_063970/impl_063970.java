...
@Data
public class Idea63970Config {
    private String name = "idea_063970";
 ...
 */
@Slf4j
public class Idea63970Service {
    private static final int IDEA_ID = 63970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63970Service() {
        this(new Idea63970Config());
    }

    public Idea63970Service(Idea63970Config config) {
        this.config = config != null ? config : new Idea63970Config();
