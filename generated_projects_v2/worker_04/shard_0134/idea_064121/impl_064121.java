...
@Data
public class Idea64121Config {
    private String name = "idea_064121";
 ...
 */
@Slf4j
public class Idea64121Service {
    private static final int IDEA_ID = 64121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64121Service() {
        this(new Idea64121Config());
    }

    public Idea64121Service(Idea64121Config config) {
        this.config = config != null ? config : new Idea64121Config();
