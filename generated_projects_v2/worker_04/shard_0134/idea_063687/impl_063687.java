...
@Data
public class Idea63687Config {
    private String name = "idea_063687";
 ...
 */
@Slf4j
public class Idea63687Service {
    private static final int IDEA_ID = 63687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63687Service() {
        this(new Idea63687Config());
    }

    public Idea63687Service(Idea63687Config config) {
        this.config = config != null ? config : new Idea63687Config();
