...
@Data
public class Idea63964Config {
    private String name = "idea_063964";
 ...
 */
@Slf4j
public class Idea63964Service {
    private static final int IDEA_ID = 63964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63964Service() {
        this(new Idea63964Config());
    }

    public Idea63964Service(Idea63964Config config) {
        this.config = config != null ? config : new Idea63964Config();
