...
@Data
public class Idea64071Config {
    private String name = "idea_064071";
 ...
 */
@Slf4j
public class Idea64071Service {
    private static final int IDEA_ID = 64071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64071Service() {
        this(new Idea64071Config());
    }

    public Idea64071Service(Idea64071Config config) {
        this.config = config != null ? config : new Idea64071Config();
