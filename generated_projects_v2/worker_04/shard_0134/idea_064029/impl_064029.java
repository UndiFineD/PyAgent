...
@Data
public class Idea64029Config {
    private String name = "idea_064029";
 ...
 */
@Slf4j
public class Idea64029Service {
    private static final int IDEA_ID = 64029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64029Service() {
        this(new Idea64029Config());
    }

    public Idea64029Service(Idea64029Config config) {
        this.config = config != null ? config : new Idea64029Config();
