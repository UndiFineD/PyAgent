...
@Data
public class Idea64017Config {
    private String name = "idea_064017";
 ...
 */
@Slf4j
public class Idea64017Service {
    private static final int IDEA_ID = 64017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64017Service() {
        this(new Idea64017Config());
    }

    public Idea64017Service(Idea64017Config config) {
        this.config = config != null ? config : new Idea64017Config();
