...
@Data
public class Idea63701Config {
    private String name = "idea_063701";
 ...
 */
@Slf4j
public class Idea63701Service {
    private static final int IDEA_ID = 63701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63701Service() {
        this(new Idea63701Config());
    }

    public Idea63701Service(Idea63701Config config) {
        this.config = config != null ? config : new Idea63701Config();
