...
@Data
public class Idea63756Config {
    private String name = "idea_063756";
 ...
 */
@Slf4j
public class Idea63756Service {
    private static final int IDEA_ID = 63756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63756Service() {
        this(new Idea63756Config());
    }

    public Idea63756Service(Idea63756Config config) {
        this.config = config != null ? config : new Idea63756Config();
