...
@Data
public class Idea63659Config {
    private String name = "idea_063659";
 ...
 */
@Slf4j
public class Idea63659Service {
    private static final int IDEA_ID = 63659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63659Service() {
        this(new Idea63659Config());
    }

    public Idea63659Service(Idea63659Config config) {
        this.config = config != null ? config : new Idea63659Config();
