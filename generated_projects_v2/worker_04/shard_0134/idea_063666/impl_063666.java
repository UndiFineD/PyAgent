...
@Data
public class Idea63666Config {
    private String name = "idea_063666";
 ...
 */
@Slf4j
public class Idea63666Service {
    private static final int IDEA_ID = 63666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63666Service() {
        this(new Idea63666Config());
    }

    public Idea63666Service(Idea63666Config config) {
        this.config = config != null ? config : new Idea63666Config();
