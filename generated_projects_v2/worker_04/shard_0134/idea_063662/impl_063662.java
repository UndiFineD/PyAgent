...
@Data
public class Idea63662Config {
    private String name = "idea_063662";
 ...
 */
@Slf4j
public class Idea63662Service {
    private static final int IDEA_ID = 63662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63662Service() {
        this(new Idea63662Config());
    }

    public Idea63662Service(Idea63662Config config) {
        this.config = config != null ? config : new Idea63662Config();
