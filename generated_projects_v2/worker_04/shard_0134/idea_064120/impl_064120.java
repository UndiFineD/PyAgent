...
@Data
public class Idea64120Config {
    private String name = "idea_064120";
 ...
 */
@Slf4j
public class Idea64120Service {
    private static final int IDEA_ID = 64120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64120Service() {
        this(new Idea64120Config());
    }

    public Idea64120Service(Idea64120Config config) {
        this.config = config != null ? config : new Idea64120Config();
