...
@Data
public class Idea63813Config {
    private String name = "idea_063813";
 ...
 */
@Slf4j
public class Idea63813Service {
    private static final int IDEA_ID = 63813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63813Service() {
        this(new Idea63813Config());
    }

    public Idea63813Service(Idea63813Config config) {
        this.config = config != null ? config : new Idea63813Config();
