...
@Data
public class Idea63670Config {
    private String name = "idea_063670";
 ...
 */
@Slf4j
public class Idea63670Service {
    private static final int IDEA_ID = 63670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63670Service() {
        this(new Idea63670Config());
    }

    public Idea63670Service(Idea63670Config config) {
        this.config = config != null ? config : new Idea63670Config();
