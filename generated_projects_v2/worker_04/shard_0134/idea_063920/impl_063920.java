...
@Data
public class Idea63920Config {
    private String name = "idea_063920";
 ...
 */
@Slf4j
public class Idea63920Service {
    private static final int IDEA_ID = 63920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63920Service() {
        this(new Idea63920Config());
    }

    public Idea63920Service(Idea63920Config config) {
        this.config = config != null ? config : new Idea63920Config();
