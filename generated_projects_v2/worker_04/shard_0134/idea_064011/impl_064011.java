...
@Data
public class Idea64011Config {
    private String name = "idea_064011";
 ...
 */
@Slf4j
public class Idea64011Service {
    private static final int IDEA_ID = 64011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64011Service() {
        this(new Idea64011Config());
    }

    public Idea64011Service(Idea64011Config config) {
        this.config = config != null ? config : new Idea64011Config();
