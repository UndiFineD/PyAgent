...
@Data
public class Idea63706Config {
    private String name = "idea_063706";
 ...
 */
@Slf4j
public class Idea63706Service {
    private static final int IDEA_ID = 63706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63706Service() {
        this(new Idea63706Config());
    }

    public Idea63706Service(Idea63706Config config) {
        this.config = config != null ? config : new Idea63706Config();
