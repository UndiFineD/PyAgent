...
@Data
public class Idea64082Config {
    private String name = "idea_064082";
 ...
 */
@Slf4j
public class Idea64082Service {
    private static final int IDEA_ID = 64082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64082Service() {
        this(new Idea64082Config());
    }

    public Idea64082Service(Idea64082Config config) {
        this.config = config != null ? config : new Idea64082Config();
