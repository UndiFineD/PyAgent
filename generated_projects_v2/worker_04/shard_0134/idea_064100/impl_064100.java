...
@Data
public class Idea64100Config {
    private String name = "idea_064100";
 ...
 */
@Slf4j
public class Idea64100Service {
    private static final int IDEA_ID = 64100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64100Service() {
        this(new Idea64100Config());
    }

    public Idea64100Service(Idea64100Config config) {
        this.config = config != null ? config : new Idea64100Config();
