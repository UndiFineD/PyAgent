...
@Data
public class Idea63998Config {
    private String name = "idea_063998";
 ...
 */
@Slf4j
public class Idea63998Service {
    private static final int IDEA_ID = 63998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63998Service() {
        this(new Idea63998Config());
    }

    public Idea63998Service(Idea63998Config config) {
        this.config = config != null ? config : new Idea63998Config();
