...
@Data
public class Idea63840Config {
    private String name = "idea_063840";
 ...
 */
@Slf4j
public class Idea63840Service {
    private static final int IDEA_ID = 63840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63840Service() {
        this(new Idea63840Config());
    }

    public Idea63840Service(Idea63840Config config) {
        this.config = config != null ? config : new Idea63840Config();
