...
@Data
public class Idea63852Config {
    private String name = "idea_063852";
 ...
 */
@Slf4j
public class Idea63852Service {
    private static final int IDEA_ID = 63852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63852Service() {
        this(new Idea63852Config());
    }

    public Idea63852Service(Idea63852Config config) {
        this.config = config != null ? config : new Idea63852Config();
