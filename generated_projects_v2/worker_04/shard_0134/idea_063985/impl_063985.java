...
@Data
public class Idea63985Config {
    private String name = "idea_063985";
 ...
 */
@Slf4j
public class Idea63985Service {
    private static final int IDEA_ID = 63985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63985Service() {
        this(new Idea63985Config());
    }

    public Idea63985Service(Idea63985Config config) {
        this.config = config != null ? config : new Idea63985Config();
