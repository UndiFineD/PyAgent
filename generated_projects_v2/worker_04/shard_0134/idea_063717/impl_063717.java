...
@Data
public class Idea63717Config {
    private String name = "idea_063717";
 ...
 */
@Slf4j
public class Idea63717Service {
    private static final int IDEA_ID = 63717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63717Service() {
        this(new Idea63717Config());
    }

    public Idea63717Service(Idea63717Config config) {
        this.config = config != null ? config : new Idea63717Config();
