...
@Data
public class Idea63988Config {
    private String name = "idea_063988";
 ...
 */
@Slf4j
public class Idea63988Service {
    private static final int IDEA_ID = 63988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63988Service() {
        this(new Idea63988Config());
    }

    public Idea63988Service(Idea63988Config config) {
        this.config = config != null ? config : new Idea63988Config();
