...
@Data
public class Idea63956Config {
    private String name = "idea_063956";
 ...
 */
@Slf4j
public class Idea63956Service {
    private static final int IDEA_ID = 63956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63956Service() {
        this(new Idea63956Config());
    }

    public Idea63956Service(Idea63956Config config) {
        this.config = config != null ? config : new Idea63956Config();
