...
@Data
public class Idea64065Config {
    private String name = "idea_064065";
 ...
 */
@Slf4j
public class Idea64065Service {
    private static final int IDEA_ID = 64065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64065Service() {
        this(new Idea64065Config());
    }

    public Idea64065Service(Idea64065Config config) {
        this.config = config != null ? config : new Idea64065Config();
