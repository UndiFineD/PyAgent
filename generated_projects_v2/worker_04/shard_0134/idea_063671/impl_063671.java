...
@Data
public class Idea63671Config {
    private String name = "idea_063671";
 ...
 */
@Slf4j
public class Idea63671Service {
    private static final int IDEA_ID = 63671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63671Service() {
        this(new Idea63671Config());
    }

    public Idea63671Service(Idea63671Config config) {
        this.config = config != null ? config : new Idea63671Config();
