...
@Data
public class Idea63702Config {
    private String name = "idea_063702";
 ...
 */
@Slf4j
public class Idea63702Service {
    private static final int IDEA_ID = 63702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63702Service() {
        this(new Idea63702Config());
    }

    public Idea63702Service(Idea63702Config config) {
        this.config = config != null ? config : new Idea63702Config();
