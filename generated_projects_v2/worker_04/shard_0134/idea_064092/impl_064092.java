...
@Data
public class Idea64092Config {
    private String name = "idea_064092";
 ...
 */
@Slf4j
public class Idea64092Service {
    private static final int IDEA_ID = 64092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64092Service() {
        this(new Idea64092Config());
    }

    public Idea64092Service(Idea64092Config config) {
        this.config = config != null ? config : new Idea64092Config();
