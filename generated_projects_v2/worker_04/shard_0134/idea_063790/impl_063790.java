...
@Data
public class Idea63790Config {
    private String name = "idea_063790";
 ...
 */
@Slf4j
public class Idea63790Service {
    private static final int IDEA_ID = 63790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63790Service() {
        this(new Idea63790Config());
    }

    public Idea63790Service(Idea63790Config config) {
        this.config = config != null ? config : new Idea63790Config();
