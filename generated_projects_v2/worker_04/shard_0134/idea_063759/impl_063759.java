...
@Data
public class Idea63759Config {
    private String name = "idea_063759";
 ...
 */
@Slf4j
public class Idea63759Service {
    private static final int IDEA_ID = 63759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63759Service() {
        this(new Idea63759Config());
    }

    public Idea63759Service(Idea63759Config config) {
        this.config = config != null ? config : new Idea63759Config();
