...
@Data
public class Idea63864Config {
    private String name = "idea_063864";
 ...
 */
@Slf4j
public class Idea63864Service {
    private static final int IDEA_ID = 63864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63864Service() {
        this(new Idea63864Config());
    }

    public Idea63864Service(Idea63864Config config) {
        this.config = config != null ? config : new Idea63864Config();
