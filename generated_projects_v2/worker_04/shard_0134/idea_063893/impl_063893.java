...
@Data
public class Idea63893Config {
    private String name = "idea_063893";
 ...
 */
@Slf4j
public class Idea63893Service {
    private static final int IDEA_ID = 63893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63893Service() {
        this(new Idea63893Config());
    }

    public Idea63893Service(Idea63893Config config) {
        this.config = config != null ? config : new Idea63893Config();
