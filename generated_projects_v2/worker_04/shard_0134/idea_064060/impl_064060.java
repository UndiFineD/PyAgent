...
@Data
public class Idea64060Config {
    private String name = "idea_064060";
 ...
 */
@Slf4j
public class Idea64060Service {
    private static final int IDEA_ID = 64060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64060Service() {
        this(new Idea64060Config());
    }

    public Idea64060Service(Idea64060Config config) {
        this.config = config != null ? config : new Idea64060Config();
