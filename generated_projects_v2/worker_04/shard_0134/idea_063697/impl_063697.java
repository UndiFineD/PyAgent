...
@Data
public class Idea63697Config {
    private String name = "idea_063697";
 ...
 */
@Slf4j
public class Idea63697Service {
    private static final int IDEA_ID = 63697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63697Service() {
        this(new Idea63697Config());
    }

    public Idea63697Service(Idea63697Config config) {
        this.config = config != null ? config : new Idea63697Config();
