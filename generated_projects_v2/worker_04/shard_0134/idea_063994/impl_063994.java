...
@Data
public class Idea63994Config {
    private String name = "idea_063994";
 ...
 */
@Slf4j
public class Idea63994Service {
    private static final int IDEA_ID = 63994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63994Service() {
        this(new Idea63994Config());
    }

    public Idea63994Service(Idea63994Config config) {
        this.config = config != null ? config : new Idea63994Config();
