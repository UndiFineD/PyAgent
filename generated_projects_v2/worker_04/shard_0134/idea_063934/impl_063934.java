...
@Data
public class Idea63934Config {
    private String name = "idea_063934";
 ...
 */
@Slf4j
public class Idea63934Service {
    private static final int IDEA_ID = 63934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63934Service() {
        this(new Idea63934Config());
    }

    public Idea63934Service(Idea63934Config config) {
        this.config = config != null ? config : new Idea63934Config();
