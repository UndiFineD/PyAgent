...
@Data
public class Idea64026Config {
    private String name = "idea_064026";
 ...
 */
@Slf4j
public class Idea64026Service {
    private static final int IDEA_ID = 64026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64026Service() {
        this(new Idea64026Config());
    }

    public Idea64026Service(Idea64026Config config) {
        this.config = config != null ? config : new Idea64026Config();
