...
@Data
public class Idea63916Config {
    private String name = "idea_063916";
 ...
 */
@Slf4j
public class Idea63916Service {
    private static final int IDEA_ID = 63916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63916Service() {
        this(new Idea63916Config());
    }

    public Idea63916Service(Idea63916Config config) {
        this.config = config != null ? config : new Idea63916Config();
