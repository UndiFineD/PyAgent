...
@Data
public class Idea63679Config {
    private String name = "idea_063679";
 ...
 */
@Slf4j
public class Idea63679Service {
    private static final int IDEA_ID = 63679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63679Service() {
        this(new Idea63679Config());
    }

    public Idea63679Service(Idea63679Config config) {
        this.config = config != null ? config : new Idea63679Config();
