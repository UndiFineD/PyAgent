...
@Data
public class Idea63688Config {
    private String name = "idea_063688";
 ...
 */
@Slf4j
public class Idea63688Service {
    private static final int IDEA_ID = 63688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63688Service() {
        this(new Idea63688Config());
    }

    public Idea63688Service(Idea63688Config config) {
        this.config = config != null ? config : new Idea63688Config();
