...
@Data
public class Idea64061Config {
    private String name = "idea_064061";
 ...
 */
@Slf4j
public class Idea64061Service {
    private static final int IDEA_ID = 64061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64061Service() {
        this(new Idea64061Config());
    }

    public Idea64061Service(Idea64061Config config) {
        this.config = config != null ? config : new Idea64061Config();
