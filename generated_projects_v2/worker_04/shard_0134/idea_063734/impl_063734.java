...
@Data
public class Idea63734Config {
    private String name = "idea_063734";
 ...
 */
@Slf4j
public class Idea63734Service {
    private static final int IDEA_ID = 63734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63734Service() {
        this(new Idea63734Config());
    }

    public Idea63734Service(Idea63734Config config) {
        this.config = config != null ? config : new Idea63734Config();
