...
@Data
public class Idea63927Config {
    private String name = "idea_063927";
 ...
 */
@Slf4j
public class Idea63927Service {
    private static final int IDEA_ID = 63927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63927Service() {
        this(new Idea63927Config());
    }

    public Idea63927Service(Idea63927Config config) {
        this.config = config != null ? config : new Idea63927Config();
