...
@Data
public class Idea63664Config {
    private String name = "idea_063664";
 ...
 */
@Slf4j
public class Idea63664Service {
    private static final int IDEA_ID = 63664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63664Service() {
        this(new Idea63664Config());
    }

    public Idea63664Service(Idea63664Config config) {
        this.config = config != null ? config : new Idea63664Config();
