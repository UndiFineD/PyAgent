...
@Data
public class Idea63958Config {
    private String name = "idea_063958";
 ...
 */
@Slf4j
public class Idea63958Service {
    private static final int IDEA_ID = 63958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63958Service() {
        this(new Idea63958Config());
    }

    public Idea63958Service(Idea63958Config config) {
        this.config = config != null ? config : new Idea63958Config();
