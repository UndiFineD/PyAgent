...
@Data
public class Idea64069Config {
    private String name = "idea_064069";
 ...
 */
@Slf4j
public class Idea64069Service {
    private static final int IDEA_ID = 64069;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64069Service() {
        this(new Idea64069Config());
    }

    public Idea64069Service(Idea64069Config config) {
        this.config = config != null ? config : new Idea64069Config();
