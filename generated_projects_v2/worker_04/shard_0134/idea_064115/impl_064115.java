...
@Data
public class Idea64115Config {
    private String name = "idea_064115";
 ...
 */
@Slf4j
public class Idea64115Service {
    private static final int IDEA_ID = 64115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64115Service() {
        this(new Idea64115Config());
    }

    public Idea64115Service(Idea64115Config config) {
        this.config = config != null ? config : new Idea64115Config();
