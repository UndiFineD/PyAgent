...
@Data
public class Idea63939Config {
    private String name = "idea_063939";
 ...
 */
@Slf4j
public class Idea63939Service {
    private static final int IDEA_ID = 63939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63939Service() {
        this(new Idea63939Config());
    }

    public Idea63939Service(Idea63939Config config) {
        this.config = config != null ? config : new Idea63939Config();
