...
@Data
public class Idea64063Config {
    private String name = "idea_064063";
 ...
 */
@Slf4j
public class Idea64063Service {
    private static final int IDEA_ID = 64063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64063Service() {
        this(new Idea64063Config());
    }

    public Idea64063Service(Idea64063Config config) {
        this.config = config != null ? config : new Idea64063Config();
