...
@Data
public class Idea63928Config {
    private String name = "idea_063928";
 ...
 */
@Slf4j
public class Idea63928Service {
    private static final int IDEA_ID = 63928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63928Service() {
        this(new Idea63928Config());
    }

    public Idea63928Service(Idea63928Config config) {
        this.config = config != null ? config : new Idea63928Config();
