...
@Data
public class Idea63729Config {
    private String name = "idea_063729";
 ...
 */
@Slf4j
public class Idea63729Service {
    private static final int IDEA_ID = 63729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63729Service() {
        this(new Idea63729Config());
    }

    public Idea63729Service(Idea63729Config config) {
        this.config = config != null ? config : new Idea63729Config();
