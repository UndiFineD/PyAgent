...
@Data
public class Idea63704Config {
    private String name = "idea_063704";
 ...
 */
@Slf4j
public class Idea63704Service {
    private static final int IDEA_ID = 63704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63704Service() {
        this(new Idea63704Config());
    }

    public Idea63704Service(Idea63704Config config) {
        this.config = config != null ? config : new Idea63704Config();
