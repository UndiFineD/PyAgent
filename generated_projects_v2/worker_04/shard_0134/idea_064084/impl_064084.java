...
@Data
public class Idea64084Config {
    private String name = "idea_064084";
 ...
 */
@Slf4j
public class Idea64084Service {
    private static final int IDEA_ID = 64084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64084Service() {
        this(new Idea64084Config());
    }

    public Idea64084Service(Idea64084Config config) {
        this.config = config != null ? config : new Idea64084Config();
