...
@Data
public class Idea63660Config {
    private String name = "idea_063660";
 ...
 */
@Slf4j
public class Idea63660Service {
    private static final int IDEA_ID = 63660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63660Service() {
        this(new Idea63660Config());
    }

    public Idea63660Service(Idea63660Config config) {
        this.config = config != null ? config : new Idea63660Config();
