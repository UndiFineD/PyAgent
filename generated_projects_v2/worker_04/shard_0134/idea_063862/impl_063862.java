...
@Data
public class Idea63862Config {
    private String name = "idea_063862";
 ...
 */
@Slf4j
public class Idea63862Service {
    private static final int IDEA_ID = 63862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63862Service() {
        this(new Idea63862Config());
    }

    public Idea63862Service(Idea63862Config config) {
        this.config = config != null ? config : new Idea63862Config();
