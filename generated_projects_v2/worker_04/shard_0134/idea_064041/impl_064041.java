...
@Data
public class Idea64041Config {
    private String name = "idea_064041";
 ...
 */
@Slf4j
public class Idea64041Service {
    private static final int IDEA_ID = 64041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64041Service() {
        this(new Idea64041Config());
    }

    public Idea64041Service(Idea64041Config config) {
        this.config = config != null ? config : new Idea64041Config();
