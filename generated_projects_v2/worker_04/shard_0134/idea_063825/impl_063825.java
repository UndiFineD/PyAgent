...
@Data
public class Idea63825Config {
    private String name = "idea_063825";
 ...
 */
@Slf4j
public class Idea63825Service {
    private static final int IDEA_ID = 63825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63825Service() {
        this(new Idea63825Config());
    }

    public Idea63825Service(Idea63825Config config) {
        this.config = config != null ? config : new Idea63825Config();
