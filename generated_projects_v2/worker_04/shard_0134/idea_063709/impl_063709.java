...
@Data
public class Idea63709Config {
    private String name = "idea_063709";
 ...
 */
@Slf4j
public class Idea63709Service {
    private static final int IDEA_ID = 63709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63709Service() {
        this(new Idea63709Config());
    }

    public Idea63709Service(Idea63709Config config) {
        this.config = config != null ? config : new Idea63709Config();
