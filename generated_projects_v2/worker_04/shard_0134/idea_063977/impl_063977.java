...
@Data
public class Idea63977Config {
    private String name = "idea_063977";
 ...
 */
@Slf4j
public class Idea63977Service {
    private static final int IDEA_ID = 63977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63977Service() {
        this(new Idea63977Config());
    }

    public Idea63977Service(Idea63977Config config) {
        this.config = config != null ? config : new Idea63977Config();
