...
@Data
public class Idea63656Config {
    private String name = "idea_063656";
 ...
 */
@Slf4j
public class Idea63656Service {
    private static final int IDEA_ID = 63656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63656Service() {
        this(new Idea63656Config());
    }

    public Idea63656Service(Idea63656Config config) {
        this.config = config != null ? config : new Idea63656Config();
