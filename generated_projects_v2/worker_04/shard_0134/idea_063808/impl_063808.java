...
@Data
public class Idea63808Config {
    private String name = "idea_063808";
 ...
 */
@Slf4j
public class Idea63808Service {
    private static final int IDEA_ID = 63808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63808Service() {
        this(new Idea63808Config());
    }

    public Idea63808Service(Idea63808Config config) {
        this.config = config != null ? config : new Idea63808Config();
