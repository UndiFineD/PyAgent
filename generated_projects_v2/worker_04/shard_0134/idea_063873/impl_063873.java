...
@Data
public class Idea63873Config {
    private String name = "idea_063873";
 ...
 */
@Slf4j
public class Idea63873Service {
    private static final int IDEA_ID = 63873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63873Service() {
        this(new Idea63873Config());
    }

    public Idea63873Service(Idea63873Config config) {
        this.config = config != null ? config : new Idea63873Config();
