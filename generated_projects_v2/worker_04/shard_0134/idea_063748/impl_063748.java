...
@Data
public class Idea63748Config {
    private String name = "idea_063748";
 ...
 */
@Slf4j
public class Idea63748Service {
    private static final int IDEA_ID = 63748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63748Service() {
        this(new Idea63748Config());
    }

    public Idea63748Service(Idea63748Config config) {
        this.config = config != null ? config : new Idea63748Config();
