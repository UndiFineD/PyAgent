...
@Data
public class Idea63853Config {
    private String name = "idea_063853";
 ...
 */
@Slf4j
public class Idea63853Service {
    private static final int IDEA_ID = 63853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63853Service() {
        this(new Idea63853Config());
    }

    public Idea63853Service(Idea63853Config config) {
        this.config = config != null ? config : new Idea63853Config();
