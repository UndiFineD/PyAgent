...
@Data
public class Idea63913Config {
    private String name = "idea_063913";
 ...
 */
@Slf4j
public class Idea63913Service {
    private static final int IDEA_ID = 63913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63913Service() {
        this(new Idea63913Config());
    }

    public Idea63913Service(Idea63913Config config) {
        this.config = config != null ? config : new Idea63913Config();
