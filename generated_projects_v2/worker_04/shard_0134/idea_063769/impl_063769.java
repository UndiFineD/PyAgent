...
@Data
public class Idea63769Config {
    private String name = "idea_063769";
 ...
 */
@Slf4j
public class Idea63769Service {
    private static final int IDEA_ID = 63769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63769Service() {
        this(new Idea63769Config());
    }

    public Idea63769Service(Idea63769Config config) {
        this.config = config != null ? config : new Idea63769Config();
