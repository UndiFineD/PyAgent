...
@Data
public class Idea63663Config {
    private String name = "idea_063663";
 ...
 */
@Slf4j
public class Idea63663Service {
    private static final int IDEA_ID = 63663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63663Service() {
        this(new Idea63663Config());
    }

    public Idea63663Service(Idea63663Config config) {
        this.config = config != null ? config : new Idea63663Config();
