...
@Data
public class Idea63866Config {
    private String name = "idea_063866";
 ...
 */
@Slf4j
public class Idea63866Service {
    private static final int IDEA_ID = 63866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63866Service() {
        this(new Idea63866Config());
    }

    public Idea63866Service(Idea63866Config config) {
        this.config = config != null ? config : new Idea63866Config();
