...
@Data
public class Idea63781Config {
    private String name = "idea_063781";
 ...
 */
@Slf4j
public class Idea63781Service {
    private static final int IDEA_ID = 63781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63781Service() {
        this(new Idea63781Config());
    }

    public Idea63781Service(Idea63781Config config) {
        this.config = config != null ? config : new Idea63781Config();
