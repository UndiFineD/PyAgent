...
@Data
public class Idea63829Config {
    private String name = "idea_063829";
 ...
 */
@Slf4j
public class Idea63829Service {
    private static final int IDEA_ID = 63829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63829Service() {
        this(new Idea63829Config());
    }

    public Idea63829Service(Idea63829Config config) {
        this.config = config != null ? config : new Idea63829Config();
