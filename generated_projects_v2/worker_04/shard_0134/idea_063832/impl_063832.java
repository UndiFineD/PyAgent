...
@Data
public class Idea63832Config {
    private String name = "idea_063832";
 ...
 */
@Slf4j
public class Idea63832Service {
    private static final int IDEA_ID = 63832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63832Service() {
        this(new Idea63832Config());
    }

    public Idea63832Service(Idea63832Config config) {
        this.config = config != null ? config : new Idea63832Config();
