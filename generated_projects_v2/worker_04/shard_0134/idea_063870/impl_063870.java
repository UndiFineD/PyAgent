...
@Data
public class Idea63870Config {
    private String name = "idea_063870";
 ...
 */
@Slf4j
public class Idea63870Service {
    private static final int IDEA_ID = 63870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63870Service() {
        this(new Idea63870Config());
    }

    public Idea63870Service(Idea63870Config config) {
        this.config = config != null ? config : new Idea63870Config();
