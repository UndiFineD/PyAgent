...
@Data
public class Idea63930Config {
    private String name = "idea_063930";
 ...
 */
@Slf4j
public class Idea63930Service {
    private static final int IDEA_ID = 63930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63930Service() {
        this(new Idea63930Config());
    }

    public Idea63930Service(Idea63930Config config) {
        this.config = config != null ? config : new Idea63930Config();
