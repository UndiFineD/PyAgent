...
@Data
public class Idea64077Config {
    private String name = "idea_064077";
 ...
 */
@Slf4j
public class Idea64077Service {
    private static final int IDEA_ID = 64077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64077Service() {
        this(new Idea64077Config());
    }

    public Idea64077Service(Idea64077Config config) {
        this.config = config != null ? config : new Idea64077Config();
