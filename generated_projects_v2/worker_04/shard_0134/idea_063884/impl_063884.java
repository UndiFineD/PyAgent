...
@Data
public class Idea63884Config {
    private String name = "idea_063884";
 ...
 */
@Slf4j
public class Idea63884Service {
    private static final int IDEA_ID = 63884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63884Service() {
        this(new Idea63884Config());
    }

    public Idea63884Service(Idea63884Config config) {
        this.config = config != null ? config : new Idea63884Config();
