...
@Data
public class Idea63803Config {
    private String name = "idea_063803";
 ...
 */
@Slf4j
public class Idea63803Service {
    private static final int IDEA_ID = 63803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63803Service() {
        this(new Idea63803Config());
    }

    public Idea63803Service(Idea63803Config config) {
        this.config = config != null ? config : new Idea63803Config();
