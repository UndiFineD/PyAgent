...
@Data
public class Idea63771Config {
    private String name = "idea_063771";
 ...
 */
@Slf4j
public class Idea63771Service {
    private static final int IDEA_ID = 63771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63771Service() {
        this(new Idea63771Config());
    }

    public Idea63771Service(Idea63771Config config) {
        this.config = config != null ? config : new Idea63771Config();
