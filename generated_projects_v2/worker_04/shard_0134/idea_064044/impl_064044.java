...
@Data
public class Idea64044Config {
    private String name = "idea_064044";
 ...
 */
@Slf4j
public class Idea64044Service {
    private static final int IDEA_ID = 64044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64044Service() {
        this(new Idea64044Config());
    }

    public Idea64044Service(Idea64044Config config) {
        this.config = config != null ? config : new Idea64044Config();
