...
@Data
public class Idea63744Config {
    private String name = "idea_063744";
 ...
 */
@Slf4j
public class Idea63744Service {
    private static final int IDEA_ID = 63744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63744Service() {
        this(new Idea63744Config());
    }

    public Idea63744Service(Idea63744Config config) {
        this.config = config != null ? config : new Idea63744Config();
