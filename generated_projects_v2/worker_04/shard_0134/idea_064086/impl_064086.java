...
@Data
public class Idea64086Config {
    private String name = "idea_064086";
 ...
 */
@Slf4j
public class Idea64086Service {
    private static final int IDEA_ID = 64086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64086Service() {
        this(new Idea64086Config());
    }

    public Idea64086Service(Idea64086Config config) {
        this.config = config != null ? config : new Idea64086Config();
