...
@Data
public class Idea63969Config {
    private String name = "idea_063969";
 ...
 */
@Slf4j
public class Idea63969Service {
    private static final int IDEA_ID = 63969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63969Service() {
        this(new Idea63969Config());
    }

    public Idea63969Service(Idea63969Config config) {
        this.config = config != null ? config : new Idea63969Config();
