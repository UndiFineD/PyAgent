...
@Data
public class Idea64087Config {
    private String name = "idea_064087";
 ...
 */
@Slf4j
public class Idea64087Service {
    private static final int IDEA_ID = 64087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64087Service() {
        this(new Idea64087Config());
    }

    public Idea64087Service(Idea64087Config config) {
        this.config = config != null ? config : new Idea64087Config();
