...
@Data
public class Idea63919Config {
    private String name = "idea_063919";
 ...
 */
@Slf4j
public class Idea63919Service {
    private static final int IDEA_ID = 63919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63919Service() {
        this(new Idea63919Config());
    }

    public Idea63919Service(Idea63919Config config) {
        this.config = config != null ? config : new Idea63919Config();
