...
@Data
public class Idea63973Config {
    private String name = "idea_063973";
 ...
 */
@Slf4j
public class Idea63973Service {
    private static final int IDEA_ID = 63973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63973Service() {
        this(new Idea63973Config());
    }

    public Idea63973Service(Idea63973Config config) {
        this.config = config != null ? config : new Idea63973Config();
