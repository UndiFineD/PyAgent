...
@Data
public class Idea64101Config {
    private String name = "idea_064101";
 ...
 */
@Slf4j
public class Idea64101Service {
    private static final int IDEA_ID = 64101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64101Service() {
        this(new Idea64101Config());
    }

    public Idea64101Service(Idea64101Config config) {
        this.config = config != null ? config : new Idea64101Config();
