...
@Data
public class Idea64023Config {
    private String name = "idea_064023";
 ...
 */
@Slf4j
public class Idea64023Service {
    private static final int IDEA_ID = 64023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64023Service() {
        this(new Idea64023Config());
    }

    public Idea64023Service(Idea64023Config config) {
        this.config = config != null ? config : new Idea64023Config();
