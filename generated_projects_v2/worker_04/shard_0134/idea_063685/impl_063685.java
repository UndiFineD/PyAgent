...
@Data
public class Idea63685Config {
    private String name = "idea_063685";
 ...
 */
@Slf4j
public class Idea63685Service {
    private static final int IDEA_ID = 63685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63685Service() {
        this(new Idea63685Config());
    }

    public Idea63685Service(Idea63685Config config) {
        this.config = config != null ? config : new Idea63685Config();
