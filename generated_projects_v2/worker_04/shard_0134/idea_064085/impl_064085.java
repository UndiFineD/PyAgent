...
@Data
public class Idea64085Config {
    private String name = "idea_064085";
 ...
 */
@Slf4j
public class Idea64085Service {
    private static final int IDEA_ID = 64085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64085Service() {
        this(new Idea64085Config());
    }

    public Idea64085Service(Idea64085Config config) {
        this.config = config != null ? config : new Idea64085Config();
