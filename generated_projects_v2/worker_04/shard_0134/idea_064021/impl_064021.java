...
@Data
public class Idea64021Config {
    private String name = "idea_064021";
 ...
 */
@Slf4j
public class Idea64021Service {
    private static final int IDEA_ID = 64021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64021Service() {
        this(new Idea64021Config());
    }

    public Idea64021Service(Idea64021Config config) {
        this.config = config != null ? config : new Idea64021Config();
