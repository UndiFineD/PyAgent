...
@Data
public class Idea63770Config {
    private String name = "idea_063770";
 ...
 */
@Slf4j
public class Idea63770Service {
    private static final int IDEA_ID = 63770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63770Service() {
        this(new Idea63770Config());
    }

    public Idea63770Service(Idea63770Config config) {
        this.config = config != null ? config : new Idea63770Config();
