...
@Data
public class Idea63772Config {
    private String name = "idea_063772";
 ...
 */
@Slf4j
public class Idea63772Service {
    private static final int IDEA_ID = 63772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63772Service() {
        this(new Idea63772Config());
    }

    public Idea63772Service(Idea63772Config config) {
        this.config = config != null ? config : new Idea63772Config();
