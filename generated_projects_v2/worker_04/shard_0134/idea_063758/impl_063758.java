...
@Data
public class Idea63758Config {
    private String name = "idea_063758";
 ...
 */
@Slf4j
public class Idea63758Service {
    private static final int IDEA_ID = 63758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63758Service() {
        this(new Idea63758Config());
    }

    public Idea63758Service(Idea63758Config config) {
        this.config = config != null ? config : new Idea63758Config();
