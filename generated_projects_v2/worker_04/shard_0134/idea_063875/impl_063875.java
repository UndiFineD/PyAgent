...
@Data
public class Idea63875Config {
    private String name = "idea_063875";
 ...
 */
@Slf4j
public class Idea63875Service {
    private static final int IDEA_ID = 63875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63875Service() {
        this(new Idea63875Config());
    }

    public Idea63875Service(Idea63875Config config) {
        this.config = config != null ? config : new Idea63875Config();
