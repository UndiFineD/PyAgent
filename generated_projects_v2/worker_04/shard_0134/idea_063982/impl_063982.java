...
@Data
public class Idea63982Config {
    private String name = "idea_063982";
 ...
 */
@Slf4j
public class Idea63982Service {
    private static final int IDEA_ID = 63982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63982Service() {
        this(new Idea63982Config());
    }

    public Idea63982Service(Idea63982Config config) {
        this.config = config != null ? config : new Idea63982Config();
