...
@Data
public class Idea64091Config {
    private String name = "idea_064091";
 ...
 */
@Slf4j
public class Idea64091Service {
    private static final int IDEA_ID = 64091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64091Service() {
        this(new Idea64091Config());
    }

    public Idea64091Service(Idea64091Config config) {
        this.config = config != null ? config : new Idea64091Config();
