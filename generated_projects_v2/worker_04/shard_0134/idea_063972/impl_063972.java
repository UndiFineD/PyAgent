...
@Data
public class Idea63972Config {
    private String name = "idea_063972";
 ...
 */
@Slf4j
public class Idea63972Service {
    private static final int IDEA_ID = 63972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63972Service() {
        this(new Idea63972Config());
    }

    public Idea63972Service(Idea63972Config config) {
        this.config = config != null ? config : new Idea63972Config();
