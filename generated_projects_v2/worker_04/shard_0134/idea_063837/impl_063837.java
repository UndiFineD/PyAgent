...
@Data
public class Idea63837Config {
    private String name = "idea_063837";
 ...
 */
@Slf4j
public class Idea63837Service {
    private static final int IDEA_ID = 63837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63837Service() {
        this(new Idea63837Config());
    }

    public Idea63837Service(Idea63837Config config) {
        this.config = config != null ? config : new Idea63837Config();
