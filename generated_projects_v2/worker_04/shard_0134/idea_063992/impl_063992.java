...
@Data
public class Idea63992Config {
    private String name = "idea_063992";
 ...
 */
@Slf4j
public class Idea63992Service {
    private static final int IDEA_ID = 63992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63992Service() {
        this(new Idea63992Config());
    }

    public Idea63992Service(Idea63992Config config) {
        this.config = config != null ? config : new Idea63992Config();
