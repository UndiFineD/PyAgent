...
@Data
public class Idea63817Config {
    private String name = "idea_063817";
 ...
 */
@Slf4j
public class Idea63817Service {
    private static final int IDEA_ID = 63817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63817Service() {
        this(new Idea63817Config());
    }

    public Idea63817Service(Idea63817Config config) {
        this.config = config != null ? config : new Idea63817Config();
