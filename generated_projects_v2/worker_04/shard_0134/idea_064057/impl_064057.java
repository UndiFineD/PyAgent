...
@Data
public class Idea64057Config {
    private String name = "idea_064057";
 ...
 */
@Slf4j
public class Idea64057Service {
    private static final int IDEA_ID = 64057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64057Service() {
        this(new Idea64057Config());
    }

    public Idea64057Service(Idea64057Config config) {
        this.config = config != null ? config : new Idea64057Config();
