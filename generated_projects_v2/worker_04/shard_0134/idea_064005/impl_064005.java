...
@Data
public class Idea64005Config {
    private String name = "idea_064005";
 ...
 */
@Slf4j
public class Idea64005Service {
    private static final int IDEA_ID = 64005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64005Service() {
        this(new Idea64005Config());
    }

    public Idea64005Service(Idea64005Config config) {
        this.config = config != null ? config : new Idea64005Config();
