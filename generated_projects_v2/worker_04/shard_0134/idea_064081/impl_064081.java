...
@Data
public class Idea64081Config {
    private String name = "idea_064081";
 ...
 */
@Slf4j
public class Idea64081Service {
    private static final int IDEA_ID = 64081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64081Service() {
        this(new Idea64081Config());
    }

    public Idea64081Service(Idea64081Config config) {
        this.config = config != null ? config : new Idea64081Config();
