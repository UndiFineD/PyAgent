...
@Data
public class Idea63652Config {
    private String name = "idea_063652";
 ...
 */
@Slf4j
public class Idea63652Service {
    private static final int IDEA_ID = 63652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63652Service() {
        this(new Idea63652Config());
    }

    public Idea63652Service(Idea63652Config config) {
        this.config = config != null ? config : new Idea63652Config();
