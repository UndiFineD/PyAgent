...
@Data
public class Idea63904Config {
    private String name = "idea_063904";
 ...
 */
@Slf4j
public class Idea63904Service {
    private static final int IDEA_ID = 63904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63904Service() {
        this(new Idea63904Config());
    }

    public Idea63904Service(Idea63904Config config) {
        this.config = config != null ? config : new Idea63904Config();
