...
@Data
public class Idea63703Config {
    private String name = "idea_063703";
 ...
 */
@Slf4j
public class Idea63703Service {
    private static final int IDEA_ID = 63703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63703Service() {
        this(new Idea63703Config());
    }

    public Idea63703Service(Idea63703Config config) {
        this.config = config != null ? config : new Idea63703Config();
