...
@Data
public class Idea64064Config {
    private String name = "idea_064064";
 ...
 */
@Slf4j
public class Idea64064Service {
    private static final int IDEA_ID = 64064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64064Service() {
        this(new Idea64064Config());
    }

    public Idea64064Service(Idea64064Config config) {
        this.config = config != null ? config : new Idea64064Config();
