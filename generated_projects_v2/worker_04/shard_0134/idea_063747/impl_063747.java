...
@Data
public class Idea63747Config {
    private String name = "idea_063747";
 ...
 */
@Slf4j
public class Idea63747Service {
    private static final int IDEA_ID = 63747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63747Service() {
        this(new Idea63747Config());
    }

    public Idea63747Service(Idea63747Config config) {
        this.config = config != null ? config : new Idea63747Config();
