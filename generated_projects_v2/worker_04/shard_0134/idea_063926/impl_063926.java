...
@Data
public class Idea63926Config {
    private String name = "idea_063926";
 ...
 */
@Slf4j
public class Idea63926Service {
    private static final int IDEA_ID = 63926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63926Service() {
        this(new Idea63926Config());
    }

    public Idea63926Service(Idea63926Config config) {
        this.config = config != null ? config : new Idea63926Config();
