...
@Data
public class Idea64016Config {
    private String name = "idea_064016";
 ...
 */
@Slf4j
public class Idea64016Service {
    private static final int IDEA_ID = 64016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64016Service() {
        this(new Idea64016Config());
    }

    public Idea64016Service(Idea64016Config config) {
        this.config = config != null ? config : new Idea64016Config();
