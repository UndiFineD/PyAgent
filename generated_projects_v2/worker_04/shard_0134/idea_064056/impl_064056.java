...
@Data
public class Idea64056Config {
    private String name = "idea_064056";
 ...
 */
@Slf4j
public class Idea64056Service {
    private static final int IDEA_ID = 64056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64056Service() {
        this(new Idea64056Config());
    }

    public Idea64056Service(Idea64056Config config) {
        this.config = config != null ? config : new Idea64056Config();
