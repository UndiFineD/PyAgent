...
@Data
public class Idea64050Config {
    private String name = "idea_064050";
 ...
 */
@Slf4j
public class Idea64050Service {
    private static final int IDEA_ID = 64050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64050Service() {
        this(new Idea64050Config());
    }

    public Idea64050Service(Idea64050Config config) {
        this.config = config != null ? config : new Idea64050Config();
