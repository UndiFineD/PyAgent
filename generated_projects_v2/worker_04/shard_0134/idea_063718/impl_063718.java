...
@Data
public class Idea63718Config {
    private String name = "idea_063718";
 ...
 */
@Slf4j
public class Idea63718Service {
    private static final int IDEA_ID = 63718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63718Service() {
        this(new Idea63718Config());
    }

    public Idea63718Service(Idea63718Config config) {
        this.config = config != null ? config : new Idea63718Config();
