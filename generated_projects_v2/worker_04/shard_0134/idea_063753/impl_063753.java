...
@Data
public class Idea63753Config {
    private String name = "idea_063753";
 ...
 */
@Slf4j
public class Idea63753Service {
    private static final int IDEA_ID = 63753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63753Service() {
        this(new Idea63753Config());
    }

    public Idea63753Service(Idea63753Config config) {
        this.config = config != null ? config : new Idea63753Config();
