...
@Data
public class Idea63783Config {
    private String name = "idea_063783";
 ...
 */
@Slf4j
public class Idea63783Service {
    private static final int IDEA_ID = 63783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63783Service() {
        this(new Idea63783Config());
    }

    public Idea63783Service(Idea63783Config config) {
        this.config = config != null ? config : new Idea63783Config();
