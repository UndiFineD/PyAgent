...
@Data
public class Idea63955Config {
    private String name = "idea_063955";
 ...
 */
@Slf4j
public class Idea63955Service {
    private static final int IDEA_ID = 63955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63955Service() {
        this(new Idea63955Config());
    }

    public Idea63955Service(Idea63955Config config) {
        this.config = config != null ? config : new Idea63955Config();
