...
@Data
public class Idea63802Config {
    private String name = "idea_063802";
 ...
 */
@Slf4j
public class Idea63802Service {
    private static final int IDEA_ID = 63802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63802Service() {
        this(new Idea63802Config());
    }

    public Idea63802Service(Idea63802Config config) {
        this.config = config != null ? config : new Idea63802Config();
