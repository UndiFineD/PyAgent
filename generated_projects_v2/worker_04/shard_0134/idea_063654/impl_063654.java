...
@Data
public class Idea63654Config {
    private String name = "idea_063654";
 ...
 */
@Slf4j
public class Idea63654Service {
    private static final int IDEA_ID = 63654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63654Service() {
        this(new Idea63654Config());
    }

    public Idea63654Service(Idea63654Config config) {
        this.config = config != null ? config : new Idea63654Config();
