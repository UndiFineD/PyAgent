...
@Data
public class Idea63967Config {
    private String name = "idea_063967";
 ...
 */
@Slf4j
public class Idea63967Service {
    private static final int IDEA_ID = 63967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63967Service() {
        this(new Idea63967Config());
    }

    public Idea63967Service(Idea63967Config config) {
        this.config = config != null ? config : new Idea63967Config();
