...
@Data
public class Idea64034Config {
    private String name = "idea_064034";
 ...
 */
@Slf4j
public class Idea64034Service {
    private static final int IDEA_ID = 64034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64034Service() {
        this(new Idea64034Config());
    }

    public Idea64034Service(Idea64034Config config) {
        this.config = config != null ? config : new Idea64034Config();
