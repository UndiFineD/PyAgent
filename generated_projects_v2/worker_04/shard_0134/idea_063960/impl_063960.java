...
@Data
public class Idea63960Config {
    private String name = "idea_063960";
 ...
 */
@Slf4j
public class Idea63960Service {
    private static final int IDEA_ID = 63960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63960Service() {
        this(new Idea63960Config());
    }

    public Idea63960Service(Idea63960Config config) {
        this.config = config != null ? config : new Idea63960Config();
