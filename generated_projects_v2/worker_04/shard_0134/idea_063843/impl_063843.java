...
@Data
public class Idea63843Config {
    private String name = "idea_063843";
 ...
 */
@Slf4j
public class Idea63843Service {
    private static final int IDEA_ID = 63843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63843Service() {
        this(new Idea63843Config());
    }

    public Idea63843Service(Idea63843Config config) {
        this.config = config != null ? config : new Idea63843Config();
