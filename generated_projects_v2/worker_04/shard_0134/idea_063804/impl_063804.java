...
@Data
public class Idea63804Config {
    private String name = "idea_063804";
 ...
 */
@Slf4j
public class Idea63804Service {
    private static final int IDEA_ID = 63804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63804Service() {
        this(new Idea63804Config());
    }

    public Idea63804Service(Idea63804Config config) {
        this.config = config != null ? config : new Idea63804Config();
