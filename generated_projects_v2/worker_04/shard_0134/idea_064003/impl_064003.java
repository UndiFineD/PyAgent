...
@Data
public class Idea64003Config {
    private String name = "idea_064003";
 ...
 */
@Slf4j
public class Idea64003Service {
    private static final int IDEA_ID = 64003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64003Service() {
        this(new Idea64003Config());
    }

    public Idea64003Service(Idea64003Config config) {
        this.config = config != null ? config : new Idea64003Config();
