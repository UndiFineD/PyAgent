...
@Data
public class Idea63961Config {
    private String name = "idea_063961";
 ...
 */
@Slf4j
public class Idea63961Service {
    private static final int IDEA_ID = 63961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63961Service() {
        this(new Idea63961Config());
    }

    public Idea63961Service(Idea63961Config config) {
        this.config = config != null ? config : new Idea63961Config();
