...
@Data
public class Idea63971Config {
    private String name = "idea_063971";
 ...
 */
@Slf4j
public class Idea63971Service {
    private static final int IDEA_ID = 63971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63971Service() {
        this(new Idea63971Config());
    }

    public Idea63971Service(Idea63971Config config) {
        this.config = config != null ? config : new Idea63971Config();
