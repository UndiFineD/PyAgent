...
@Data
public class Idea63838Config {
    private String name = "idea_063838";
 ...
 */
@Slf4j
public class Idea63838Service {
    private static final int IDEA_ID = 63838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63838Service() {
        this(new Idea63838Config());
    }

    public Idea63838Service(Idea63838Config config) {
        this.config = config != null ? config : new Idea63838Config();
