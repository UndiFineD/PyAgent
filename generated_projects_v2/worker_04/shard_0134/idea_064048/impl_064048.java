...
@Data
public class Idea64048Config {
    private String name = "idea_064048";
 ...
 */
@Slf4j
public class Idea64048Service {
    private static final int IDEA_ID = 64048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64048Service() {
        this(new Idea64048Config());
    }

    public Idea64048Service(Idea64048Config config) {
        this.config = config != null ? config : new Idea64048Config();
