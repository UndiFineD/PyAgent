...
@Data
public class Idea63931Config {
    private String name = "idea_063931";
 ...
 */
@Slf4j
public class Idea63931Service {
    private static final int IDEA_ID = 63931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63931Service() {
        this(new Idea63931Config());
    }

    public Idea63931Service(Idea63931Config config) {
        this.config = config != null ? config : new Idea63931Config();
