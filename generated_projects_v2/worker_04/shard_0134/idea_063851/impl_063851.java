...
@Data
public class Idea63851Config {
    private String name = "idea_063851";
 ...
 */
@Slf4j
public class Idea63851Service {
    private static final int IDEA_ID = 63851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63851Service() {
        this(new Idea63851Config());
    }

    public Idea63851Service(Idea63851Config config) {
        this.config = config != null ? config : new Idea63851Config();
