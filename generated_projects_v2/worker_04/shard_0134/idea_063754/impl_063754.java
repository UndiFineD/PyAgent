...
@Data
public class Idea63754Config {
    private String name = "idea_063754";
 ...
 */
@Slf4j
public class Idea63754Service {
    private static final int IDEA_ID = 63754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63754Service() {
        this(new Idea63754Config());
    }

    public Idea63754Service(Idea63754Config config) {
        this.config = config != null ? config : new Idea63754Config();
