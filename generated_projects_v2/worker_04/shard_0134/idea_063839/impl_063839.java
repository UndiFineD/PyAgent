...
@Data
public class Idea63839Config {
    private String name = "idea_063839";
 ...
 */
@Slf4j
public class Idea63839Service {
    private static final int IDEA_ID = 63839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63839Service() {
        this(new Idea63839Config());
    }

    public Idea63839Service(Idea63839Config config) {
        this.config = config != null ? config : new Idea63839Config();
