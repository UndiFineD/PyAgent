...
@Data
public class Idea64075Config {
    private String name = "idea_064075";
 ...
 */
@Slf4j
public class Idea64075Service {
    private static final int IDEA_ID = 64075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64075Service() {
        this(new Idea64075Config());
    }

    public Idea64075Service(Idea64075Config config) {
        this.config = config != null ? config : new Idea64075Config();
