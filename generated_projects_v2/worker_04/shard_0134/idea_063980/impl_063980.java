...
@Data
public class Idea63980Config {
    private String name = "idea_063980";
 ...
 */
@Slf4j
public class Idea63980Service {
    private static final int IDEA_ID = 63980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea63980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea63980Service() {
        this(new Idea63980Config());
    }

    public Idea63980Service(Idea63980Config config) {
        this.config = config != null ? config : new Idea63980Config();
