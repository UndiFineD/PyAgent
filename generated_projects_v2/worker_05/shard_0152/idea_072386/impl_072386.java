...
@Data
public class Idea72386Config {
    private String name = "idea_072386";
 ...
 */
@Slf4j
public class Idea72386Service {
    private static final int IDEA_ID = 72386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72386Service() {
        this(new Idea72386Config());
    }

    public Idea72386Service(Idea72386Config config) {
        this.config = config != null ? config : new Idea72386Config();
