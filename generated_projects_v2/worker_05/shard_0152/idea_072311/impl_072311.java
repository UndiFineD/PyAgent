...
@Data
public class Idea72311Config {
    private String name = "idea_072311";
 ...
 */
@Slf4j
public class Idea72311Service {
    private static final int IDEA_ID = 72311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72311Service() {
        this(new Idea72311Config());
    }

    public Idea72311Service(Idea72311Config config) {
        this.config = config != null ? config : new Idea72311Config();
