...
@Data
public class Idea72655Config {
    private String name = "idea_072655";
 ...
 */
@Slf4j
public class Idea72655Service {
    private static final int IDEA_ID = 72655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72655Service() {
        this(new Idea72655Config());
    }

    public Idea72655Service(Idea72655Config config) {
        this.config = config != null ? config : new Idea72655Config();
