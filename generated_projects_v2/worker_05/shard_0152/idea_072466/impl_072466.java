...
@Data
public class Idea72466Config {
    private String name = "idea_072466";
 ...
 */
@Slf4j
public class Idea72466Service {
    private static final int IDEA_ID = 72466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72466Service() {
        this(new Idea72466Config());
    }

    public Idea72466Service(Idea72466Config config) {
        this.config = config != null ? config : new Idea72466Config();
