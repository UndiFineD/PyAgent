...
@Data
public class Idea72673Config {
    private String name = "idea_072673";
 ...
 */
@Slf4j
public class Idea72673Service {
    private static final int IDEA_ID = 72673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72673Service() {
        this(new Idea72673Config());
    }

    public Idea72673Service(Idea72673Config config) {
        this.config = config != null ? config : new Idea72673Config();
