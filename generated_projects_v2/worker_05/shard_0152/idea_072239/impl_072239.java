...
@Data
public class Idea72239Config {
    private String name = "idea_072239";
 ...
 */
@Slf4j
public class Idea72239Service {
    private static final int IDEA_ID = 72239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72239Service() {
        this(new Idea72239Config());
    }

    public Idea72239Service(Idea72239Config config) {
        this.config = config != null ? config : new Idea72239Config();
