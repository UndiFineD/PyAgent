...
@Data
public class Idea72590Config {
    private String name = "idea_072590";
 ...
 */
@Slf4j
public class Idea72590Service {
    private static final int IDEA_ID = 72590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72590Service() {
        this(new Idea72590Config());
    }

    public Idea72590Service(Idea72590Config config) {
        this.config = config != null ? config : new Idea72590Config();
