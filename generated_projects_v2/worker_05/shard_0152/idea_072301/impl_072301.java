...
@Data
public class Idea72301Config {
    private String name = "idea_072301";
 ...
 */
@Slf4j
public class Idea72301Service {
    private static final int IDEA_ID = 72301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72301Service() {
        this(new Idea72301Config());
    }

    public Idea72301Service(Idea72301Config config) {
        this.config = config != null ? config : new Idea72301Config();
