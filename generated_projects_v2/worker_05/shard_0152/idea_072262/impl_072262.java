...
@Data
public class Idea72262Config {
    private String name = "idea_072262";
 ...
 */
@Slf4j
public class Idea72262Service {
    private static final int IDEA_ID = 72262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72262Service() {
        this(new Idea72262Config());
    }

    public Idea72262Service(Idea72262Config config) {
        this.config = config != null ? config : new Idea72262Config();
