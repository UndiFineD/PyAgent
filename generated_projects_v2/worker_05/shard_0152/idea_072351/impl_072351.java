...
@Data
public class Idea72351Config {
    private String name = "idea_072351";
 ...
 */
@Slf4j
public class Idea72351Service {
    private static final int IDEA_ID = 72351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72351Service() {
        this(new Idea72351Config());
    }

    public Idea72351Service(Idea72351Config config) {
        this.config = config != null ? config : new Idea72351Config();
