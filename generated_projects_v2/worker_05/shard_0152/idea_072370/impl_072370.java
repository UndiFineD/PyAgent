...
@Data
public class Idea72370Config {
    private String name = "idea_072370";
 ...
 */
@Slf4j
public class Idea72370Service {
    private static final int IDEA_ID = 72370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72370Service() {
        this(new Idea72370Config());
    }

    public Idea72370Service(Idea72370Config config) {
        this.config = config != null ? config : new Idea72370Config();
