...
@Data
public class Idea72580Config {
    private String name = "idea_072580";
 ...
 */
@Slf4j
public class Idea72580Service {
    private static final int IDEA_ID = 72580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72580Service() {
        this(new Idea72580Config());
    }

    public Idea72580Service(Idea72580Config config) {
        this.config = config != null ? config : new Idea72580Config();
