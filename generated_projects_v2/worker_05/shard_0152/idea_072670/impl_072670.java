...
@Data
public class Idea72670Config {
    private String name = "idea_072670";
 ...
 */
@Slf4j
public class Idea72670Service {
    private static final int IDEA_ID = 72670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72670Service() {
        this(new Idea72670Config());
    }

    public Idea72670Service(Idea72670Config config) {
        this.config = config != null ? config : new Idea72670Config();
