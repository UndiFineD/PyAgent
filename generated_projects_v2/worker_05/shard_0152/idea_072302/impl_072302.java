...
@Data
public class Idea72302Config {
    private String name = "idea_072302";
 ...
 */
@Slf4j
public class Idea72302Service {
    private static final int IDEA_ID = 72302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72302Service() {
        this(new Idea72302Config());
    }

    public Idea72302Service(Idea72302Config config) {
        this.config = config != null ? config : new Idea72302Config();
