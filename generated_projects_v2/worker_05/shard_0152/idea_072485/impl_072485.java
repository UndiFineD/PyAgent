...
@Data
public class Idea72485Config {
    private String name = "idea_072485";
 ...
 */
@Slf4j
public class Idea72485Service {
    private static final int IDEA_ID = 72485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72485Service() {
        this(new Idea72485Config());
    }

    public Idea72485Service(Idea72485Config config) {
        this.config = config != null ? config : new Idea72485Config();
