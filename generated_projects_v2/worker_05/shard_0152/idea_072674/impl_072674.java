...
@Data
public class Idea72674Config {
    private String name = "idea_072674";
 ...
 */
@Slf4j
public class Idea72674Service {
    private static final int IDEA_ID = 72674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72674Service() {
        this(new Idea72674Config());
    }

    public Idea72674Service(Idea72674Config config) {
        this.config = config != null ? config : new Idea72674Config();
