...
@Data
public class Idea72203Config {
    private String name = "idea_072203";
 ...
 */
@Slf4j
public class Idea72203Service {
    private static final int IDEA_ID = 72203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72203Service() {
        this(new Idea72203Config());
    }

    public Idea72203Service(Idea72203Config config) {
        this.config = config != null ? config : new Idea72203Config();
