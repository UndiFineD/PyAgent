...
@Data
public class Idea72263Config {
    private String name = "idea_072263";
 ...
 */
@Slf4j
public class Idea72263Service {
    private static final int IDEA_ID = 72263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72263Service() {
        this(new Idea72263Config());
    }

    public Idea72263Service(Idea72263Config config) {
        this.config = config != null ? config : new Idea72263Config();
