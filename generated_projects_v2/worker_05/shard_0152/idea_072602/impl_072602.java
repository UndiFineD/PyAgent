...
@Data
public class Idea72602Config {
    private String name = "idea_072602";
 ...
 */
@Slf4j
public class Idea72602Service {
    private static final int IDEA_ID = 72602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72602Service() {
        this(new Idea72602Config());
    }

    public Idea72602Service(Idea72602Config config) {
        this.config = config != null ? config : new Idea72602Config();
