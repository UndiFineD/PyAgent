...
@Data
public class Idea72507Config {
    private String name = "idea_072507";
 ...
 */
@Slf4j
public class Idea72507Service {
    private static final int IDEA_ID = 72507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72507Service() {
        this(new Idea72507Config());
    }

    public Idea72507Service(Idea72507Config config) {
        this.config = config != null ? config : new Idea72507Config();
