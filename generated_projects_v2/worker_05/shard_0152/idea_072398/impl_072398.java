...
@Data
public class Idea72398Config {
    private String name = "idea_072398";
 ...
 */
@Slf4j
public class Idea72398Service {
    private static final int IDEA_ID = 72398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72398Service() {
        this(new Idea72398Config());
    }

    public Idea72398Service(Idea72398Config config) {
        this.config = config != null ? config : new Idea72398Config();
