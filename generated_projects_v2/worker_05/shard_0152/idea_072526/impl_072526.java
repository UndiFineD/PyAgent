...
@Data
public class Idea72526Config {
    private String name = "idea_072526";
 ...
 */
@Slf4j
public class Idea72526Service {
    private static final int IDEA_ID = 72526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72526Service() {
        this(new Idea72526Config());
    }

    public Idea72526Service(Idea72526Config config) {
        this.config = config != null ? config : new Idea72526Config();
