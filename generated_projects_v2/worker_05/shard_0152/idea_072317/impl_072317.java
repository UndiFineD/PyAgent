...
@Data
public class Idea72317Config {
    private String name = "idea_072317";
 ...
 */
@Slf4j
public class Idea72317Service {
    private static final int IDEA_ID = 72317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72317Service() {
        this(new Idea72317Config());
    }

    public Idea72317Service(Idea72317Config config) {
        this.config = config != null ? config : new Idea72317Config();
