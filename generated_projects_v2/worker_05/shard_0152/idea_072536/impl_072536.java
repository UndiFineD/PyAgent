...
@Data
public class Idea72536Config {
    private String name = "idea_072536";
 ...
 */
@Slf4j
public class Idea72536Service {
    private static final int IDEA_ID = 72536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72536Service() {
        this(new Idea72536Config());
    }

    public Idea72536Service(Idea72536Config config) {
        this.config = config != null ? config : new Idea72536Config();
