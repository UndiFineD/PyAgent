...
@Data
public class Idea72632Config {
    private String name = "idea_072632";
 ...
 */
@Slf4j
public class Idea72632Service {
    private static final int IDEA_ID = 72632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72632Service() {
        this(new Idea72632Config());
    }

    public Idea72632Service(Idea72632Config config) {
        this.config = config != null ? config : new Idea72632Config();
