...
@Data
public class Idea72651Config {
    private String name = "idea_072651";
 ...
 */
@Slf4j
public class Idea72651Service {
    private static final int IDEA_ID = 72651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72651Service() {
        this(new Idea72651Config());
    }

    public Idea72651Service(Idea72651Config config) {
        this.config = config != null ? config : new Idea72651Config();
