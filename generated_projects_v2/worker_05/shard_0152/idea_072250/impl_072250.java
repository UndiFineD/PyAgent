...
@Data
public class Idea72250Config {
    private String name = "idea_072250";
 ...
 */
@Slf4j
public class Idea72250Service {
    private static final int IDEA_ID = 72250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72250Service() {
        this(new Idea72250Config());
    }

    public Idea72250Service(Idea72250Config config) {
        this.config = config != null ? config : new Idea72250Config();
