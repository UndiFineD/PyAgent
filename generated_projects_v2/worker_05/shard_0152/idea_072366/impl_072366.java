...
@Data
public class Idea72366Config {
    private String name = "idea_072366";
 ...
 */
@Slf4j
public class Idea72366Service {
    private static final int IDEA_ID = 72366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72366Service() {
        this(new Idea72366Config());
    }

    public Idea72366Service(Idea72366Config config) {
        this.config = config != null ? config : new Idea72366Config();
