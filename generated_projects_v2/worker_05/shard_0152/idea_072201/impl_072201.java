...
@Data
public class Idea72201Config {
    private String name = "idea_072201";
 ...
 */
@Slf4j
public class Idea72201Service {
    private static final int IDEA_ID = 72201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72201Service() {
        this(new Idea72201Config());
    }

    public Idea72201Service(Idea72201Config config) {
        this.config = config != null ? config : new Idea72201Config();
