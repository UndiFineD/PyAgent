...
@Data
public class Idea72334Config {
    private String name = "idea_072334";
 ...
 */
@Slf4j
public class Idea72334Service {
    private static final int IDEA_ID = 72334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72334Service() {
        this(new Idea72334Config());
    }

    public Idea72334Service(Idea72334Config config) {
        this.config = config != null ? config : new Idea72334Config();
