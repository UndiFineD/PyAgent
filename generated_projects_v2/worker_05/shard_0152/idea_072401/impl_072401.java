...
@Data
public class Idea72401Config {
    private String name = "idea_072401";
 ...
 */
@Slf4j
public class Idea72401Service {
    private static final int IDEA_ID = 72401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72401Service() {
        this(new Idea72401Config());
    }

    public Idea72401Service(Idea72401Config config) {
        this.config = config != null ? config : new Idea72401Config();
