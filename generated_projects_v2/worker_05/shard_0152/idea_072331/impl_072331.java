...
@Data
public class Idea72331Config {
    private String name = "idea_072331";
 ...
 */
@Slf4j
public class Idea72331Service {
    private static final int IDEA_ID = 72331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72331Service() {
        this(new Idea72331Config());
    }

    public Idea72331Service(Idea72331Config config) {
        this.config = config != null ? config : new Idea72331Config();
