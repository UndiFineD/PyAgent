...
@Data
public class Idea72330Config {
    private String name = "idea_072330";
 ...
 */
@Slf4j
public class Idea72330Service {
    private static final int IDEA_ID = 72330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72330Service() {
        this(new Idea72330Config());
    }

    public Idea72330Service(Idea72330Config config) {
        this.config = config != null ? config : new Idea72330Config();
