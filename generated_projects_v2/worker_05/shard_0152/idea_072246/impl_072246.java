...
@Data
public class Idea72246Config {
    private String name = "idea_072246";
 ...
 */
@Slf4j
public class Idea72246Service {
    private static final int IDEA_ID = 72246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72246Service() {
        this(new Idea72246Config());
    }

    public Idea72246Service(Idea72246Config config) {
        this.config = config != null ? config : new Idea72246Config();
