...
@Data
public class Idea72535Config {
    private String name = "idea_072535";
 ...
 */
@Slf4j
public class Idea72535Service {
    private static final int IDEA_ID = 72535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72535Service() {
        this(new Idea72535Config());
    }

    public Idea72535Service(Idea72535Config config) {
        this.config = config != null ? config : new Idea72535Config();
