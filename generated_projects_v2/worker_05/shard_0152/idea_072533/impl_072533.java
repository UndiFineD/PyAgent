...
@Data
public class Idea72533Config {
    private String name = "idea_072533";
 ...
 */
@Slf4j
public class Idea72533Service {
    private static final int IDEA_ID = 72533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72533Service() {
        this(new Idea72533Config());
    }

    public Idea72533Service(Idea72533Config config) {
        this.config = config != null ? config : new Idea72533Config();
