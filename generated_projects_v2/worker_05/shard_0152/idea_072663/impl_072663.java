...
@Data
public class Idea72663Config {
    private String name = "idea_072663";
 ...
 */
@Slf4j
public class Idea72663Service {
    private static final int IDEA_ID = 72663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72663Service() {
        this(new Idea72663Config());
    }

    public Idea72663Service(Idea72663Config config) {
        this.config = config != null ? config : new Idea72663Config();
