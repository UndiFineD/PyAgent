...
@Data
public class Idea72411Config {
    private String name = "idea_072411";
 ...
 */
@Slf4j
public class Idea72411Service {
    private static final int IDEA_ID = 72411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72411Service() {
        this(new Idea72411Config());
    }

    public Idea72411Service(Idea72411Config config) {
        this.config = config != null ? config : new Idea72411Config();
