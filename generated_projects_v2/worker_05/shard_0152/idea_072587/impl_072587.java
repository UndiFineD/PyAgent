...
@Data
public class Idea72587Config {
    private String name = "idea_072587";
 ...
 */
@Slf4j
public class Idea72587Service {
    private static final int IDEA_ID = 72587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72587Service() {
        this(new Idea72587Config());
    }

    public Idea72587Service(Idea72587Config config) {
        this.config = config != null ? config : new Idea72587Config();
