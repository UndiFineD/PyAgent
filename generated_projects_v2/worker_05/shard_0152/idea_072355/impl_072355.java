...
@Data
public class Idea72355Config {
    private String name = "idea_072355";
 ...
 */
@Slf4j
public class Idea72355Service {
    private static final int IDEA_ID = 72355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72355Service() {
        this(new Idea72355Config());
    }

    public Idea72355Service(Idea72355Config config) {
        this.config = config != null ? config : new Idea72355Config();
