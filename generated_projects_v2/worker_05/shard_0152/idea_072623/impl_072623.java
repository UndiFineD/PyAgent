...
@Data
public class Idea72623Config {
    private String name = "idea_072623";
 ...
 */
@Slf4j
public class Idea72623Service {
    private static final int IDEA_ID = 72623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72623Service() {
        this(new Idea72623Config());
    }

    public Idea72623Service(Idea72623Config config) {
        this.config = config != null ? config : new Idea72623Config();
