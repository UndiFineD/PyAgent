...
@Data
public class Idea72571Config {
    private String name = "idea_072571";
 ...
 */
@Slf4j
public class Idea72571Service {
    private static final int IDEA_ID = 72571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72571Service() {
        this(new Idea72571Config());
    }

    public Idea72571Service(Idea72571Config config) {
        this.config = config != null ? config : new Idea72571Config();
