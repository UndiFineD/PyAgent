...
@Data
public class Idea72537Config {
    private String name = "idea_072537";
 ...
 */
@Slf4j
public class Idea72537Service {
    private static final int IDEA_ID = 72537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72537Service() {
        this(new Idea72537Config());
    }

    public Idea72537Service(Idea72537Config config) {
        this.config = config != null ? config : new Idea72537Config();
