...
@Data
public class Idea72599Config {
    private String name = "idea_072599";
 ...
 */
@Slf4j
public class Idea72599Service {
    private static final int IDEA_ID = 72599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72599Service() {
        this(new Idea72599Config());
    }

    public Idea72599Service(Idea72599Config config) {
        this.config = config != null ? config : new Idea72599Config();
