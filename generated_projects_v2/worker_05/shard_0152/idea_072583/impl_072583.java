...
@Data
public class Idea72583Config {
    private String name = "idea_072583";
 ...
 */
@Slf4j
public class Idea72583Service {
    private static final int IDEA_ID = 72583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72583Service() {
        this(new Idea72583Config());
    }

    public Idea72583Service(Idea72583Config config) {
        this.config = config != null ? config : new Idea72583Config();
