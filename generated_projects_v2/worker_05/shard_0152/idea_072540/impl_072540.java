...
@Data
public class Idea72540Config {
    private String name = "idea_072540";
 ...
 */
@Slf4j
public class Idea72540Service {
    private static final int IDEA_ID = 72540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72540Service() {
        this(new Idea72540Config());
    }

    public Idea72540Service(Idea72540Config config) {
        this.config = config != null ? config : new Idea72540Config();
