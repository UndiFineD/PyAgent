...
@Data
public class Idea72481Config {
    private String name = "idea_072481";
 ...
 */
@Slf4j
public class Idea72481Service {
    private static final int IDEA_ID = 72481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72481Service() {
        this(new Idea72481Config());
    }

    public Idea72481Service(Idea72481Config config) {
        this.config = config != null ? config : new Idea72481Config();
