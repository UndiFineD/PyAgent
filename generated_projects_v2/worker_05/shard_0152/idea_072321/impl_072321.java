...
@Data
public class Idea72321Config {
    private String name = "idea_072321";
 ...
 */
@Slf4j
public class Idea72321Service {
    private static final int IDEA_ID = 72321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72321Service() {
        this(new Idea72321Config());
    }

    public Idea72321Service(Idea72321Config config) {
        this.config = config != null ? config : new Idea72321Config();
