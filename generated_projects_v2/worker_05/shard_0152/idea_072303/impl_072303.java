...
@Data
public class Idea72303Config {
    private String name = "idea_072303";
 ...
 */
@Slf4j
public class Idea72303Service {
    private static final int IDEA_ID = 72303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72303Service() {
        this(new Idea72303Config());
    }

    public Idea72303Service(Idea72303Config config) {
        this.config = config != null ? config : new Idea72303Config();
