...
@Data
public class Idea72388Config {
    private String name = "idea_072388";
 ...
 */
@Slf4j
public class Idea72388Service {
    private static final int IDEA_ID = 72388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72388Service() {
        this(new Idea72388Config());
    }

    public Idea72388Service(Idea72388Config config) {
        this.config = config != null ? config : new Idea72388Config();
