...
@Data
public class Idea72653Config {
    private String name = "idea_072653";
 ...
 */
@Slf4j
public class Idea72653Service {
    private static final int IDEA_ID = 72653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72653Service() {
        this(new Idea72653Config());
    }

    public Idea72653Service(Idea72653Config config) {
        this.config = config != null ? config : new Idea72653Config();
