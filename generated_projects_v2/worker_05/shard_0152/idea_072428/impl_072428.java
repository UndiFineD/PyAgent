...
@Data
public class Idea72428Config {
    private String name = "idea_072428";
 ...
 */
@Slf4j
public class Idea72428Service {
    private static final int IDEA_ID = 72428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72428Service() {
        this(new Idea72428Config());
    }

    public Idea72428Service(Idea72428Config config) {
        this.config = config != null ? config : new Idea72428Config();
