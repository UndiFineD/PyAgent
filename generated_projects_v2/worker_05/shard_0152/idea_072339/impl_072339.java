...
@Data
public class Idea72339Config {
    private String name = "idea_072339";
 ...
 */
@Slf4j
public class Idea72339Service {
    private static final int IDEA_ID = 72339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72339Service() {
        this(new Idea72339Config());
    }

    public Idea72339Service(Idea72339Config config) {
        this.config = config != null ? config : new Idea72339Config();
