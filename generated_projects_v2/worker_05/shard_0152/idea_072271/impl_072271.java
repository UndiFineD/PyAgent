...
@Data
public class Idea72271Config {
    private String name = "idea_072271";
 ...
 */
@Slf4j
public class Idea72271Service {
    private static final int IDEA_ID = 72271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72271Service() {
        this(new Idea72271Config());
    }

    public Idea72271Service(Idea72271Config config) {
        this.config = config != null ? config : new Idea72271Config();
