...
@Data
public class Idea72667Config {
    private String name = "idea_072667";
 ...
 */
@Slf4j
public class Idea72667Service {
    private static final int IDEA_ID = 72667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72667Service() {
        this(new Idea72667Config());
    }

    public Idea72667Service(Idea72667Config config) {
        this.config = config != null ? config : new Idea72667Config();
