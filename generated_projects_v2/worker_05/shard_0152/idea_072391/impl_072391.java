...
@Data
public class Idea72391Config {
    private String name = "idea_072391";
 ...
 */
@Slf4j
public class Idea72391Service {
    private static final int IDEA_ID = 72391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72391Service() {
        this(new Idea72391Config());
    }

    public Idea72391Service(Idea72391Config config) {
        this.config = config != null ? config : new Idea72391Config();
