...
@Data
public class Idea72323Config {
    private String name = "idea_072323";
 ...
 */
@Slf4j
public class Idea72323Service {
    private static final int IDEA_ID = 72323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72323Service() {
        this(new Idea72323Config());
    }

    public Idea72323Service(Idea72323Config config) {
        this.config = config != null ? config : new Idea72323Config();
