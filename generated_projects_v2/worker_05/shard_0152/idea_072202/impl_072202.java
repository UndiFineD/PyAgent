...
@Data
public class Idea72202Config {
    private String name = "idea_072202";
 ...
 */
@Slf4j
public class Idea72202Service {
    private static final int IDEA_ID = 72202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72202Service() {
        this(new Idea72202Config());
    }

    public Idea72202Service(Idea72202Config config) {
        this.config = config != null ? config : new Idea72202Config();
