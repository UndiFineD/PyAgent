...
@Data
public class Idea72371Config {
    private String name = "idea_072371";
 ...
 */
@Slf4j
public class Idea72371Service {
    private static final int IDEA_ID = 72371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72371Service() {
        this(new Idea72371Config());
    }

    public Idea72371Service(Idea72371Config config) {
        this.config = config != null ? config : new Idea72371Config();
