...
@Data
public class Idea72356Config {
    private String name = "idea_072356";
 ...
 */
@Slf4j
public class Idea72356Service {
    private static final int IDEA_ID = 72356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72356Service() {
        this(new Idea72356Config());
    }

    public Idea72356Service(Idea72356Config config) {
        this.config = config != null ? config : new Idea72356Config();
