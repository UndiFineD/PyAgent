...
@Data
public class Idea72639Config {
    private String name = "idea_072639";
 ...
 */
@Slf4j
public class Idea72639Service {
    private static final int IDEA_ID = 72639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72639Service() {
        this(new Idea72639Config());
    }

    public Idea72639Service(Idea72639Config config) {
        this.config = config != null ? config : new Idea72639Config();
