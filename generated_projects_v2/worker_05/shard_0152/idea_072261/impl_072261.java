...
@Data
public class Idea72261Config {
    private String name = "idea_072261";
 ...
 */
@Slf4j
public class Idea72261Service {
    private static final int IDEA_ID = 72261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72261Service() {
        this(new Idea72261Config());
    }

    public Idea72261Service(Idea72261Config config) {
        this.config = config != null ? config : new Idea72261Config();
