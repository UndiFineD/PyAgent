...
@Data
public class Idea72582Config {
    private String name = "idea_072582";
 ...
 */
@Slf4j
public class Idea72582Service {
    private static final int IDEA_ID = 72582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72582Service() {
        this(new Idea72582Config());
    }

    public Idea72582Service(Idea72582Config config) {
        this.config = config != null ? config : new Idea72582Config();
