...
@Data
public class Idea72591Config {
    private String name = "idea_072591";
 ...
 */
@Slf4j
public class Idea72591Service {
    private static final int IDEA_ID = 72591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72591Service() {
        this(new Idea72591Config());
    }

    public Idea72591Service(Idea72591Config config) {
        this.config = config != null ? config : new Idea72591Config();
