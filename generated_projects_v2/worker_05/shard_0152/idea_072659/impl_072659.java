...
@Data
public class Idea72659Config {
    private String name = "idea_072659";
 ...
 */
@Slf4j
public class Idea72659Service {
    private static final int IDEA_ID = 72659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72659Service() {
        this(new Idea72659Config());
    }

    public Idea72659Service(Idea72659Config config) {
        this.config = config != null ? config : new Idea72659Config();
