...
@Data
public class Idea72258Config {
    private String name = "idea_072258";
 ...
 */
@Slf4j
public class Idea72258Service {
    private static final int IDEA_ID = 72258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72258Service() {
        this(new Idea72258Config());
    }

    public Idea72258Service(Idea72258Config config) {
        this.config = config != null ? config : new Idea72258Config();
