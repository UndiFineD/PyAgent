...
@Data
public class Idea72488Config {
    private String name = "idea_072488";
 ...
 */
@Slf4j
public class Idea72488Service {
    private static final int IDEA_ID = 72488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72488Service() {
        this(new Idea72488Config());
    }

    public Idea72488Service(Idea72488Config config) {
        this.config = config != null ? config : new Idea72488Config();
