...
@Data
public class Idea72483Config {
    private String name = "idea_072483";
 ...
 */
@Slf4j
public class Idea72483Service {
    private static final int IDEA_ID = 72483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72483Service() {
        this(new Idea72483Config());
    }

    public Idea72483Service(Idea72483Config config) {
        this.config = config != null ? config : new Idea72483Config();
