...
@Data
public class Idea72245Config {
    private String name = "idea_072245";
 ...
 */
@Slf4j
public class Idea72245Service {
    private static final int IDEA_ID = 72245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72245Service() {
        this(new Idea72245Config());
    }

    public Idea72245Service(Idea72245Config config) {
        this.config = config != null ? config : new Idea72245Config();
