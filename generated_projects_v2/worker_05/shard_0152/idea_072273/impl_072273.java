...
@Data
public class Idea72273Config {
    private String name = "idea_072273";
 ...
 */
@Slf4j
public class Idea72273Service {
    private static final int IDEA_ID = 72273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72273Service() {
        this(new Idea72273Config());
    }

    public Idea72273Service(Idea72273Config config) {
        this.config = config != null ? config : new Idea72273Config();
