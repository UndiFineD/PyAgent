...
@Data
public class Idea72254Config {
    private String name = "idea_072254";
 ...
 */
@Slf4j
public class Idea72254Service {
    private static final int IDEA_ID = 72254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72254Service() {
        this(new Idea72254Config());
    }

    public Idea72254Service(Idea72254Config config) {
        this.config = config != null ? config : new Idea72254Config();
