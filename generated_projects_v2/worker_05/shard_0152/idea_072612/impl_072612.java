...
@Data
public class Idea72612Config {
    private String name = "idea_072612";
 ...
 */
@Slf4j
public class Idea72612Service {
    private static final int IDEA_ID = 72612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72612Service() {
        this(new Idea72612Config());
    }

    public Idea72612Service(Idea72612Config config) {
        this.config = config != null ? config : new Idea72612Config();
