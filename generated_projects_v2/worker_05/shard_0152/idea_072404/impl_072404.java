...
@Data
public class Idea72404Config {
    private String name = "idea_072404";
 ...
 */
@Slf4j
public class Idea72404Service {
    private static final int IDEA_ID = 72404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72404Service() {
        this(new Idea72404Config());
    }

    public Idea72404Service(Idea72404Config config) {
        this.config = config != null ? config : new Idea72404Config();
