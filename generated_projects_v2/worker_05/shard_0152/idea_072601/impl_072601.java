...
@Data
public class Idea72601Config {
    private String name = "idea_072601";
 ...
 */
@Slf4j
public class Idea72601Service {
    private static final int IDEA_ID = 72601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72601Service() {
        this(new Idea72601Config());
    }

    public Idea72601Service(Idea72601Config config) {
        this.config = config != null ? config : new Idea72601Config();
