...
@Data
public class Idea72452Config {
    private String name = "idea_072452";
 ...
 */
@Slf4j
public class Idea72452Service {
    private static final int IDEA_ID = 72452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72452Service() {
        this(new Idea72452Config());
    }

    public Idea72452Service(Idea72452Config config) {
        this.config = config != null ? config : new Idea72452Config();
