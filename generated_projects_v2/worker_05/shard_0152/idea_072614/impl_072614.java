...
@Data
public class Idea72614Config {
    private String name = "idea_072614";
 ...
 */
@Slf4j
public class Idea72614Service {
    private static final int IDEA_ID = 72614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72614Service() {
        this(new Idea72614Config());
    }

    public Idea72614Service(Idea72614Config config) {
        this.config = config != null ? config : new Idea72614Config();
