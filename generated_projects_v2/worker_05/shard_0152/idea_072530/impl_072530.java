...
@Data
public class Idea72530Config {
    private String name = "idea_072530";
 ...
 */
@Slf4j
public class Idea72530Service {
    private static final int IDEA_ID = 72530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72530Service() {
        this(new Idea72530Config());
    }

    public Idea72530Service(Idea72530Config config) {
        this.config = config != null ? config : new Idea72530Config();
