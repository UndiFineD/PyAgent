...
@Data
public class Idea72445Config {
    private String name = "idea_072445";
 ...
 */
@Slf4j
public class Idea72445Service {
    private static final int IDEA_ID = 72445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72445Service() {
        this(new Idea72445Config());
    }

    public Idea72445Service(Idea72445Config config) {
        this.config = config != null ? config : new Idea72445Config();
