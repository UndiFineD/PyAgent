...
@Data
public class Idea72205Config {
    private String name = "idea_072205";
 ...
 */
@Slf4j
public class Idea72205Service {
    private static final int IDEA_ID = 72205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72205Service() {
        this(new Idea72205Config());
    }

    public Idea72205Service(Idea72205Config config) {
        this.config = config != null ? config : new Idea72205Config();
