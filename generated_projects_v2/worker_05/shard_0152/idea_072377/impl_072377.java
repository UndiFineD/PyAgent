...
@Data
public class Idea72377Config {
    private String name = "idea_072377";
 ...
 */
@Slf4j
public class Idea72377Service {
    private static final int IDEA_ID = 72377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72377Service() {
        this(new Idea72377Config());
    }

    public Idea72377Service(Idea72377Config config) {
        this.config = config != null ? config : new Idea72377Config();
