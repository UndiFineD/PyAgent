...
@Data
public class Idea72293Config {
    private String name = "idea_072293";
 ...
 */
@Slf4j
public class Idea72293Service {
    private static final int IDEA_ID = 72293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72293Service() {
        this(new Idea72293Config());
    }

    public Idea72293Service(Idea72293Config config) {
        this.config = config != null ? config : new Idea72293Config();
