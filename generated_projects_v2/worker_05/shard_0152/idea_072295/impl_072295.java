...
@Data
public class Idea72295Config {
    private String name = "idea_072295";
 ...
 */
@Slf4j
public class Idea72295Service {
    private static final int IDEA_ID = 72295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72295Service() {
        this(new Idea72295Config());
    }

    public Idea72295Service(Idea72295Config config) {
        this.config = config != null ? config : new Idea72295Config();
