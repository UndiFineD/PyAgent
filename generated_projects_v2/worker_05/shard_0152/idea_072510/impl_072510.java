...
@Data
public class Idea72510Config {
    private String name = "idea_072510";
 ...
 */
@Slf4j
public class Idea72510Service {
    private static final int IDEA_ID = 72510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72510Service() {
        this(new Idea72510Config());
    }

    public Idea72510Service(Idea72510Config config) {
        this.config = config != null ? config : new Idea72510Config();
