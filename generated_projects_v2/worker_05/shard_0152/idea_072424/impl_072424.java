...
@Data
public class Idea72424Config {
    private String name = "idea_072424";
 ...
 */
@Slf4j
public class Idea72424Service {
    private static final int IDEA_ID = 72424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72424Service() {
        this(new Idea72424Config());
    }

    public Idea72424Service(Idea72424Config config) {
        this.config = config != null ? config : new Idea72424Config();
