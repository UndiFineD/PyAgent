...
@Data
public class Idea72638Config {
    private String name = "idea_072638";
 ...
 */
@Slf4j
public class Idea72638Service {
    private static final int IDEA_ID = 72638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72638Service() {
        this(new Idea72638Config());
    }

    public Idea72638Service(Idea72638Config config) {
        this.config = config != null ? config : new Idea72638Config();
