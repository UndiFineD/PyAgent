...
@Data
public class Idea72482Config {
    private String name = "idea_072482";
 ...
 */
@Slf4j
public class Idea72482Service {
    private static final int IDEA_ID = 72482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72482Service() {
        this(new Idea72482Config());
    }

    public Idea72482Service(Idea72482Config config) {
        this.config = config != null ? config : new Idea72482Config();
