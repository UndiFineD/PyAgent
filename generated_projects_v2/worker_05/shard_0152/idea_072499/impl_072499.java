...
@Data
public class Idea72499Config {
    private String name = "idea_072499";
 ...
 */
@Slf4j
public class Idea72499Service {
    private static final int IDEA_ID = 72499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72499Service() {
        this(new Idea72499Config());
    }

    public Idea72499Service(Idea72499Config config) {
        this.config = config != null ? config : new Idea72499Config();
