...
@Data
public class Idea72572Config {
    private String name = "idea_072572";
 ...
 */
@Slf4j
public class Idea72572Service {
    private static final int IDEA_ID = 72572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72572Service() {
        this(new Idea72572Config());
    }

    public Idea72572Service(Idea72572Config config) {
        this.config = config != null ? config : new Idea72572Config();
