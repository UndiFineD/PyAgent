...
@Data
public class Idea72222Config {
    private String name = "idea_072222";
 ...
 */
@Slf4j
public class Idea72222Service {
    private static final int IDEA_ID = 72222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72222Service() {
        this(new Idea72222Config());
    }

    public Idea72222Service(Idea72222Config config) {
        this.config = config != null ? config : new Idea72222Config();
