...
@Data
public class Idea72517Config {
    private String name = "idea_072517";
 ...
 */
@Slf4j
public class Idea72517Service {
    private static final int IDEA_ID = 72517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72517Service() {
        this(new Idea72517Config());
    }

    public Idea72517Service(Idea72517Config config) {
        this.config = config != null ? config : new Idea72517Config();
