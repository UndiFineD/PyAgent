...
@Data
public class Idea72545Config {
    private String name = "idea_072545";
 ...
 */
@Slf4j
public class Idea72545Service {
    private static final int IDEA_ID = 72545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72545Service() {
        this(new Idea72545Config());
    }

    public Idea72545Service(Idea72545Config config) {
        this.config = config != null ? config : new Idea72545Config();
