...
@Data
public class Idea72588Config {
    private String name = "idea_072588";
 ...
 */
@Slf4j
public class Idea72588Service {
    private static final int IDEA_ID = 72588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72588Service() {
        this(new Idea72588Config());
    }

    public Idea72588Service(Idea72588Config config) {
        this.config = config != null ? config : new Idea72588Config();
