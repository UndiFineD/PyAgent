...
@Data
public class Idea72415Config {
    private String name = "idea_072415";
 ...
 */
@Slf4j
public class Idea72415Service {
    private static final int IDEA_ID = 72415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72415Service() {
        this(new Idea72415Config());
    }

    public Idea72415Service(Idea72415Config config) {
        this.config = config != null ? config : new Idea72415Config();
