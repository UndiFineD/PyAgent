...
@Data
public class Idea72645Config {
    private String name = "idea_072645";
 ...
 */
@Slf4j
public class Idea72645Service {
    private static final int IDEA_ID = 72645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72645Service() {
        this(new Idea72645Config());
    }

    public Idea72645Service(Idea72645Config config) {
        this.config = config != null ? config : new Idea72645Config();
