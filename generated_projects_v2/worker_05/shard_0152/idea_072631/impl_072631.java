...
@Data
public class Idea72631Config {
    private String name = "idea_072631";
 ...
 */
@Slf4j
public class Idea72631Service {
    private static final int IDEA_ID = 72631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72631Service() {
        this(new Idea72631Config());
    }

    public Idea72631Service(Idea72631Config config) {
        this.config = config != null ? config : new Idea72631Config();
