...
@Data
public class Idea72286Config {
    private String name = "idea_072286";
 ...
 */
@Slf4j
public class Idea72286Service {
    private static final int IDEA_ID = 72286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72286Service() {
        this(new Idea72286Config());
    }

    public Idea72286Service(Idea72286Config config) {
        this.config = config != null ? config : new Idea72286Config();
