...
@Data
public class Idea72389Config {
    private String name = "idea_072389";
 ...
 */
@Slf4j
public class Idea72389Service {
    private static final int IDEA_ID = 72389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72389Service() {
        this(new Idea72389Config());
    }

    public Idea72389Service(Idea72389Config config) {
        this.config = config != null ? config : new Idea72389Config();
