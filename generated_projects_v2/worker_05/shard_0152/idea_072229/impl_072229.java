...
@Data
public class Idea72229Config {
    private String name = "idea_072229";
 ...
 */
@Slf4j
public class Idea72229Service {
    private static final int IDEA_ID = 72229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72229Service() {
        this(new Idea72229Config());
    }

    public Idea72229Service(Idea72229Config config) {
        this.config = config != null ? config : new Idea72229Config();
