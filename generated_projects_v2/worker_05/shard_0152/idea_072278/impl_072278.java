...
@Data
public class Idea72278Config {
    private String name = "idea_072278";
 ...
 */
@Slf4j
public class Idea72278Service {
    private static final int IDEA_ID = 72278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72278Service() {
        this(new Idea72278Config());
    }

    public Idea72278Service(Idea72278Config config) {
        this.config = config != null ? config : new Idea72278Config();
