...
@Data
public class Idea72299Config {
    private String name = "idea_072299";
 ...
 */
@Slf4j
public class Idea72299Service {
    private static final int IDEA_ID = 72299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72299Service() {
        this(new Idea72299Config());
    }

    public Idea72299Service(Idea72299Config config) {
        this.config = config != null ? config : new Idea72299Config();
