...
@Data
public class Idea72267Config {
    private String name = "idea_072267";
 ...
 */
@Slf4j
public class Idea72267Service {
    private static final int IDEA_ID = 72267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72267Service() {
        this(new Idea72267Config());
    }

    public Idea72267Service(Idea72267Config config) {
        this.config = config != null ? config : new Idea72267Config();
