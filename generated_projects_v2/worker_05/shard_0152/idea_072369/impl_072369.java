...
@Data
public class Idea72369Config {
    private String name = "idea_072369";
 ...
 */
@Slf4j
public class Idea72369Service {
    private static final int IDEA_ID = 72369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72369Service() {
        this(new Idea72369Config());
    }

    public Idea72369Service(Idea72369Config config) {
        this.config = config != null ? config : new Idea72369Config();
