...
@Data
public class Idea72413Config {
    private String name = "idea_072413";
 ...
 */
@Slf4j
public class Idea72413Service {
    private static final int IDEA_ID = 72413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72413Service() {
        this(new Idea72413Config());
    }

    public Idea72413Service(Idea72413Config config) {
        this.config = config != null ? config : new Idea72413Config();
