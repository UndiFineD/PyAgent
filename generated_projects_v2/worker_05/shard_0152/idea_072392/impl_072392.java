...
@Data
public class Idea72392Config {
    private String name = "idea_072392";
 ...
 */
@Slf4j
public class Idea72392Service {
    private static final int IDEA_ID = 72392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72392Service() {
        this(new Idea72392Config());
    }

    public Idea72392Service(Idea72392Config config) {
        this.config = config != null ? config : new Idea72392Config();
