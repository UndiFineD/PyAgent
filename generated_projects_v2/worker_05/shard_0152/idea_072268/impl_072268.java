...
@Data
public class Idea72268Config {
    private String name = "idea_072268";
 ...
 */
@Slf4j
public class Idea72268Service {
    private static final int IDEA_ID = 72268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72268Service() {
        this(new Idea72268Config());
    }

    public Idea72268Service(Idea72268Config config) {
        this.config = config != null ? config : new Idea72268Config();
