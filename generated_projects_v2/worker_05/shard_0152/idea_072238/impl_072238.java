...
@Data
public class Idea72238Config {
    private String name = "idea_072238";
 ...
 */
@Slf4j
public class Idea72238Service {
    private static final int IDEA_ID = 72238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72238Service() {
        this(new Idea72238Config());
    }

    public Idea72238Service(Idea72238Config config) {
        this.config = config != null ? config : new Idea72238Config();
