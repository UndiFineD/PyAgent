...
@Data
public class Idea72365Config {
    private String name = "idea_072365";
 ...
 */
@Slf4j
public class Idea72365Service {
    private static final int IDEA_ID = 72365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72365Service() {
        this(new Idea72365Config());
    }

    public Idea72365Service(Idea72365Config config) {
        this.config = config != null ? config : new Idea72365Config();
