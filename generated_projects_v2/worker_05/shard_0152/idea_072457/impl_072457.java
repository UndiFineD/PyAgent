...
@Data
public class Idea72457Config {
    private String name = "idea_072457";
 ...
 */
@Slf4j
public class Idea72457Service {
    private static final int IDEA_ID = 72457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72457Service() {
        this(new Idea72457Config());
    }

    public Idea72457Service(Idea72457Config config) {
        this.config = config != null ? config : new Idea72457Config();
