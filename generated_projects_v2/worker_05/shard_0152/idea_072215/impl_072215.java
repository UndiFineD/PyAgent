...
@Data
public class Idea72215Config {
    private String name = "idea_072215";
 ...
 */
@Slf4j
public class Idea72215Service {
    private static final int IDEA_ID = 72215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72215Service() {
        this(new Idea72215Config());
    }

    public Idea72215Service(Idea72215Config config) {
        this.config = config != null ? config : new Idea72215Config();
