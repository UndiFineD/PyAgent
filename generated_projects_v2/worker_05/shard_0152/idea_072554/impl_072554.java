...
@Data
public class Idea72554Config {
    private String name = "idea_072554";
 ...
 */
@Slf4j
public class Idea72554Service {
    private static final int IDEA_ID = 72554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72554Service() {
        this(new Idea72554Config());
    }

    public Idea72554Service(Idea72554Config config) {
        this.config = config != null ? config : new Idea72554Config();
