...
@Data
public class Idea72420Config {
    private String name = "idea_072420";
 ...
 */
@Slf4j
public class Idea72420Service {
    private static final int IDEA_ID = 72420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72420Service() {
        this(new Idea72420Config());
    }

    public Idea72420Service(Idea72420Config config) {
        this.config = config != null ? config : new Idea72420Config();
