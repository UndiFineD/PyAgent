...
@Data
public class Idea72244Config {
    private String name = "idea_072244";
 ...
 */
@Slf4j
public class Idea72244Service {
    private static final int IDEA_ID = 72244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72244Service() {
        this(new Idea72244Config());
    }

    public Idea72244Service(Idea72244Config config) {
        this.config = config != null ? config : new Idea72244Config();
