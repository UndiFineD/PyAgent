...
@Data
public class Idea72552Config {
    private String name = "idea_072552";
 ...
 */
@Slf4j
public class Idea72552Service {
    private static final int IDEA_ID = 72552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72552Service() {
        this(new Idea72552Config());
    }

    public Idea72552Service(Idea72552Config config) {
        this.config = config != null ? config : new Idea72552Config();
