...
@Data
public class Idea72456Config {
    private String name = "idea_072456";
 ...
 */
@Slf4j
public class Idea72456Service {
    private static final int IDEA_ID = 72456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72456Service() {
        this(new Idea72456Config());
    }

    public Idea72456Service(Idea72456Config config) {
        this.config = config != null ? config : new Idea72456Config();
