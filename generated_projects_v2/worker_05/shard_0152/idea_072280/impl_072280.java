...
@Data
public class Idea72280Config {
    private String name = "idea_072280";
 ...
 */
@Slf4j
public class Idea72280Service {
    private static final int IDEA_ID = 72280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72280Service() {
        this(new Idea72280Config());
    }

    public Idea72280Service(Idea72280Config config) {
        this.config = config != null ? config : new Idea72280Config();
