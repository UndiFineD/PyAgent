...
@Data
public class Idea72440Config {
    private String name = "idea_072440";
 ...
 */
@Slf4j
public class Idea72440Service {
    private static final int IDEA_ID = 72440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72440Service() {
        this(new Idea72440Config());
    }

    public Idea72440Service(Idea72440Config config) {
        this.config = config != null ? config : new Idea72440Config();
