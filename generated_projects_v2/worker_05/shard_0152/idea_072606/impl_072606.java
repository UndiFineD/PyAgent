...
@Data
public class Idea72606Config {
    private String name = "idea_072606";
 ...
 */
@Slf4j
public class Idea72606Service {
    private static final int IDEA_ID = 72606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72606Service() {
        this(new Idea72606Config());
    }

    public Idea72606Service(Idea72606Config config) {
        this.config = config != null ? config : new Idea72606Config();
