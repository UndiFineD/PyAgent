...
@Data
public class Idea72368Config {
    private String name = "idea_072368";
 ...
 */
@Slf4j
public class Idea72368Service {
    private static final int IDEA_ID = 72368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72368Service() {
        this(new Idea72368Config());
    }

    public Idea72368Service(Idea72368Config config) {
        this.config = config != null ? config : new Idea72368Config();
