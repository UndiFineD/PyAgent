...
@Data
public class Idea72259Config {
    private String name = "idea_072259";
 ...
 */
@Slf4j
public class Idea72259Service {
    private static final int IDEA_ID = 72259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72259Service() {
        this(new Idea72259Config());
    }

    public Idea72259Service(Idea72259Config config) {
        this.config = config != null ? config : new Idea72259Config();
