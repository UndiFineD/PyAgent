...
@Data
public class Idea72373Config {
    private String name = "idea_072373";
 ...
 */
@Slf4j
public class Idea72373Service {
    private static final int IDEA_ID = 72373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72373Service() {
        this(new Idea72373Config());
    }

    public Idea72373Service(Idea72373Config config) {
        this.config = config != null ? config : new Idea72373Config();
