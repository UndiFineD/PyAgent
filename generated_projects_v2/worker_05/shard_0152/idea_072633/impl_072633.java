...
@Data
public class Idea72633Config {
    private String name = "idea_072633";
 ...
 */
@Slf4j
public class Idea72633Service {
    private static final int IDEA_ID = 72633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72633Service() {
        this(new Idea72633Config());
    }

    public Idea72633Service(Idea72633Config config) {
        this.config = config != null ? config : new Idea72633Config();
