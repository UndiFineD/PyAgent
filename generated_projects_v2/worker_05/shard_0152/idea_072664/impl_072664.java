...
@Data
public class Idea72664Config {
    private String name = "idea_072664";
 ...
 */
@Slf4j
public class Idea72664Service {
    private static final int IDEA_ID = 72664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72664Service() {
        this(new Idea72664Config());
    }

    public Idea72664Service(Idea72664Config config) {
        this.config = config != null ? config : new Idea72664Config();
