...
@Data
public class Idea72598Config {
    private String name = "idea_072598";
 ...
 */
@Slf4j
public class Idea72598Service {
    private static final int IDEA_ID = 72598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72598Service() {
        this(new Idea72598Config());
    }

    public Idea72598Service(Idea72598Config config) {
        this.config = config != null ? config : new Idea72598Config();
