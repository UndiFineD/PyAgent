...
@Data
public class Idea72390Config {
    private String name = "idea_072390";
 ...
 */
@Slf4j
public class Idea72390Service {
    private static final int IDEA_ID = 72390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72390Service() {
        this(new Idea72390Config());
    }

    public Idea72390Service(Idea72390Config config) {
        this.config = config != null ? config : new Idea72390Config();
