...
@Data
public class Idea72527Config {
    private String name = "idea_072527";
 ...
 */
@Slf4j
public class Idea72527Service {
    private static final int IDEA_ID = 72527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72527Service() {
        this(new Idea72527Config());
    }

    public Idea72527Service(Idea72527Config config) {
        this.config = config != null ? config : new Idea72527Config();
