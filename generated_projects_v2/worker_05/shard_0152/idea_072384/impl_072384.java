...
@Data
public class Idea72384Config {
    private String name = "idea_072384";
 ...
 */
@Slf4j
public class Idea72384Service {
    private static final int IDEA_ID = 72384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72384Service() {
        this(new Idea72384Config());
    }

    public Idea72384Service(Idea72384Config config) {
        this.config = config != null ? config : new Idea72384Config();
