...
@Data
public class Idea72491Config {
    private String name = "idea_072491";
 ...
 */
@Slf4j
public class Idea72491Service {
    private static final int IDEA_ID = 72491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72491Service() {
        this(new Idea72491Config());
    }

    public Idea72491Service(Idea72491Config config) {
        this.config = config != null ? config : new Idea72491Config();
