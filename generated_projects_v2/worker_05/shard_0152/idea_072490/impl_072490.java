...
@Data
public class Idea72490Config {
    private String name = "idea_072490";
 ...
 */
@Slf4j
public class Idea72490Service {
    private static final int IDEA_ID = 72490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72490Service() {
        this(new Idea72490Config());
    }

    public Idea72490Service(Idea72490Config config) {
        this.config = config != null ? config : new Idea72490Config();
