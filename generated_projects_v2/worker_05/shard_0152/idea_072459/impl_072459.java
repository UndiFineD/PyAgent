...
@Data
public class Idea72459Config {
    private String name = "idea_072459";
 ...
 */
@Slf4j
public class Idea72459Service {
    private static final int IDEA_ID = 72459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72459Service() {
        this(new Idea72459Config());
    }

    public Idea72459Service(Idea72459Config config) {
        this.config = config != null ? config : new Idea72459Config();
