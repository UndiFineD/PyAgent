...
@Data
public class Idea72547Config {
    private String name = "idea_072547";
 ...
 */
@Slf4j
public class Idea72547Service {
    private static final int IDEA_ID = 72547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72547Service() {
        this(new Idea72547Config());
    }

    public Idea72547Service(Idea72547Config config) {
        this.config = config != null ? config : new Idea72547Config();
