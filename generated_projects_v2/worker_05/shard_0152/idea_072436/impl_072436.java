...
@Data
public class Idea72436Config {
    private String name = "idea_072436";
 ...
 */
@Slf4j
public class Idea72436Service {
    private static final int IDEA_ID = 72436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72436Service() {
        this(new Idea72436Config());
    }

    public Idea72436Service(Idea72436Config config) {
        this.config = config != null ? config : new Idea72436Config();
