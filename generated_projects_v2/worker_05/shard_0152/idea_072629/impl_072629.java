...
@Data
public class Idea72629Config {
    private String name = "idea_072629";
 ...
 */
@Slf4j
public class Idea72629Service {
    private static final int IDEA_ID = 72629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72629Service() {
        this(new Idea72629Config());
    }

    public Idea72629Service(Idea72629Config config) {
        this.config = config != null ? config : new Idea72629Config();
