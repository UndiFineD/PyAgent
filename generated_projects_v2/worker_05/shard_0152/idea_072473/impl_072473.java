...
@Data
public class Idea72473Config {
    private String name = "idea_072473";
 ...
 */
@Slf4j
public class Idea72473Service {
    private static final int IDEA_ID = 72473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72473Service() {
        this(new Idea72473Config());
    }

    public Idea72473Service(Idea72473Config config) {
        this.config = config != null ? config : new Idea72473Config();
