...
@Data
public class Idea72328Config {
    private String name = "idea_072328";
 ...
 */
@Slf4j
public class Idea72328Service {
    private static final int IDEA_ID = 72328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72328Service() {
        this(new Idea72328Config());
    }

    public Idea72328Service(Idea72328Config config) {
        this.config = config != null ? config : new Idea72328Config();
