...
@Data
public class Idea72306Config {
    private String name = "idea_072306";
 ...
 */
@Slf4j
public class Idea72306Service {
    private static final int IDEA_ID = 72306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72306Service() {
        this(new Idea72306Config());
    }

    public Idea72306Service(Idea72306Config config) {
        this.config = config != null ? config : new Idea72306Config();
