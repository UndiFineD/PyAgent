...
@Data
public class Idea72565Config {
    private String name = "idea_072565";
 ...
 */
@Slf4j
public class Idea72565Service {
    private static final int IDEA_ID = 72565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72565Service() {
        this(new Idea72565Config());
    }

    public Idea72565Service(Idea72565Config config) {
        this.config = config != null ? config : new Idea72565Config();
