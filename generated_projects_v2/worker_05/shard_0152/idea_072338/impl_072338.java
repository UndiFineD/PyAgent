...
@Data
public class Idea72338Config {
    private String name = "idea_072338";
 ...
 */
@Slf4j
public class Idea72338Service {
    private static final int IDEA_ID = 72338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72338Service() {
        this(new Idea72338Config());
    }

    public Idea72338Service(Idea72338Config config) {
        this.config = config != null ? config : new Idea72338Config();
