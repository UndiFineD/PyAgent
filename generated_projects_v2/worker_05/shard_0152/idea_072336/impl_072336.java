...
@Data
public class Idea72336Config {
    private String name = "idea_072336";
 ...
 */
@Slf4j
public class Idea72336Service {
    private static final int IDEA_ID = 72336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72336Service() {
        this(new Idea72336Config());
    }

    public Idea72336Service(Idea72336Config config) {
        this.config = config != null ? config : new Idea72336Config();
