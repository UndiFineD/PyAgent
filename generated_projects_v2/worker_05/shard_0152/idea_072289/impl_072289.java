...
@Data
public class Idea72289Config {
    private String name = "idea_072289";
 ...
 */
@Slf4j
public class Idea72289Service {
    private static final int IDEA_ID = 72289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72289Service() {
        this(new Idea72289Config());
    }

    public Idea72289Service(Idea72289Config config) {
        this.config = config != null ? config : new Idea72289Config();
