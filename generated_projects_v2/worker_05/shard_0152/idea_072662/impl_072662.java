...
@Data
public class Idea72662Config {
    private String name = "idea_072662";
 ...
 */
@Slf4j
public class Idea72662Service {
    private static final int IDEA_ID = 72662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72662Service() {
        this(new Idea72662Config());
    }

    public Idea72662Service(Idea72662Config config) {
        this.config = config != null ? config : new Idea72662Config();
