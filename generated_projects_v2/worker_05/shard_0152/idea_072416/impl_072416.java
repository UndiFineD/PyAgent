...
@Data
public class Idea72416Config {
    private String name = "idea_072416";
 ...
 */
@Slf4j
public class Idea72416Service {
    private static final int IDEA_ID = 72416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72416Service() {
        this(new Idea72416Config());
    }

    public Idea72416Service(Idea72416Config config) {
        this.config = config != null ? config : new Idea72416Config();
