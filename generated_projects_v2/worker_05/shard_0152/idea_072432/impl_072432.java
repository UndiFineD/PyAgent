...
@Data
public class Idea72432Config {
    private String name = "idea_072432";
 ...
 */
@Slf4j
public class Idea72432Service {
    private static final int IDEA_ID = 72432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72432Service() {
        this(new Idea72432Config());
    }

    public Idea72432Service(Idea72432Config config) {
        this.config = config != null ? config : new Idea72432Config();
