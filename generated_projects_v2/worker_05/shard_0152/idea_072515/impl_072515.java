...
@Data
public class Idea72515Config {
    private String name = "idea_072515";
 ...
 */
@Slf4j
public class Idea72515Service {
    private static final int IDEA_ID = 72515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72515Service() {
        this(new Idea72515Config());
    }

    public Idea72515Service(Idea72515Config config) {
        this.config = config != null ? config : new Idea72515Config();
