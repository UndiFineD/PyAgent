...
@Data
public class Idea72609Config {
    private String name = "idea_072609";
 ...
 */
@Slf4j
public class Idea72609Service {
    private static final int IDEA_ID = 72609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72609Service() {
        this(new Idea72609Config());
    }

    public Idea72609Service(Idea72609Config config) {
        this.config = config != null ? config : new Idea72609Config();
