...
@Data
public class Idea72550Config {
    private String name = "idea_072550";
 ...
 */
@Slf4j
public class Idea72550Service {
    private static final int IDEA_ID = 72550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72550Service() {
        this(new Idea72550Config());
    }

    public Idea72550Service(Idea72550Config config) {
        this.config = config != null ? config : new Idea72550Config();
