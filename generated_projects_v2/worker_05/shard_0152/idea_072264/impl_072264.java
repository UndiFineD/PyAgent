...
@Data
public class Idea72264Config {
    private String name = "idea_072264";
 ...
 */
@Slf4j
public class Idea72264Service {
    private static final int IDEA_ID = 72264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72264Service() {
        this(new Idea72264Config());
    }

    public Idea72264Service(Idea72264Config config) {
        this.config = config != null ? config : new Idea72264Config();
