...
@Data
public class Idea72435Config {
    private String name = "idea_072435";
 ...
 */
@Slf4j
public class Idea72435Service {
    private static final int IDEA_ID = 72435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72435Service() {
        this(new Idea72435Config());
    }

    public Idea72435Service(Idea72435Config config) {
        this.config = config != null ? config : new Idea72435Config();
