...
@Data
public class Idea72581Config {
    private String name = "idea_072581";
 ...
 */
@Slf4j
public class Idea72581Service {
    private static final int IDEA_ID = 72581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72581Service() {
        this(new Idea72581Config());
    }

    public Idea72581Service(Idea72581Config config) {
        this.config = config != null ? config : new Idea72581Config();
