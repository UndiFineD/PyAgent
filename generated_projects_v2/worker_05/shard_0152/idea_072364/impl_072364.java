...
@Data
public class Idea72364Config {
    private String name = "idea_072364";
 ...
 */
@Slf4j
public class Idea72364Service {
    private static final int IDEA_ID = 72364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72364Service() {
        this(new Idea72364Config());
    }

    public Idea72364Service(Idea72364Config config) {
        this.config = config != null ? config : new Idea72364Config();
