...
@Data
public class Idea72624Config {
    private String name = "idea_072624";
 ...
 */
@Slf4j
public class Idea72624Service {
    private static final int IDEA_ID = 72624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72624Service() {
        this(new Idea72624Config());
    }

    public Idea72624Service(Idea72624Config config) {
        this.config = config != null ? config : new Idea72624Config();
