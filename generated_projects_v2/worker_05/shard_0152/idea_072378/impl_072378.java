...
@Data
public class Idea72378Config {
    private String name = "idea_072378";
 ...
 */
@Slf4j
public class Idea72378Service {
    private static final int IDEA_ID = 72378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72378Service() {
        this(new Idea72378Config());
    }

    public Idea72378Service(Idea72378Config config) {
        this.config = config != null ? config : new Idea72378Config();
