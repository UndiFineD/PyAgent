...
@Data
public class Idea72348Config {
    private String name = "idea_072348";
 ...
 */
@Slf4j
public class Idea72348Service {
    private static final int IDEA_ID = 72348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72348Service() {
        this(new Idea72348Config());
    }

    public Idea72348Service(Idea72348Config config) {
        this.config = config != null ? config : new Idea72348Config();
