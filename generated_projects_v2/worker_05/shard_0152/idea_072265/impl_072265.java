...
@Data
public class Idea72265Config {
    private String name = "idea_072265";
 ...
 */
@Slf4j
public class Idea72265Service {
    private static final int IDEA_ID = 72265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72265Service() {
        this(new Idea72265Config());
    }

    public Idea72265Service(Idea72265Config config) {
        this.config = config != null ? config : new Idea72265Config();
