...
@Data
public class Idea72451Config {
    private String name = "idea_072451";
 ...
 */
@Slf4j
public class Idea72451Service {
    private static final int IDEA_ID = 72451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72451Service() {
        this(new Idea72451Config());
    }

    public Idea72451Service(Idea72451Config config) {
        this.config = config != null ? config : new Idea72451Config();
