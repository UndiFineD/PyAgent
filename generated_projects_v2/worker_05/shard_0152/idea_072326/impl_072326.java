...
@Data
public class Idea72326Config {
    private String name = "idea_072326";
 ...
 */
@Slf4j
public class Idea72326Service {
    private static final int IDEA_ID = 72326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72326Service() {
        this(new Idea72326Config());
    }

    public Idea72326Service(Idea72326Config config) {
        this.config = config != null ? config : new Idea72326Config();
