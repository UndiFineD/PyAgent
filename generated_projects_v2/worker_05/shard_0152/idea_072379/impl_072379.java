...
@Data
public class Idea72379Config {
    private String name = "idea_072379";
 ...
 */
@Slf4j
public class Idea72379Service {
    private static final int IDEA_ID = 72379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72379Service() {
        this(new Idea72379Config());
    }

    public Idea72379Service(Idea72379Config config) {
        this.config = config != null ? config : new Idea72379Config();
