...
@Data
public class Idea72417Config {
    private String name = "idea_072417";
 ...
 */
@Slf4j
public class Idea72417Service {
    private static final int IDEA_ID = 72417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72417Service() {
        this(new Idea72417Config());
    }

    public Idea72417Service(Idea72417Config config) {
        this.config = config != null ? config : new Idea72417Config();
