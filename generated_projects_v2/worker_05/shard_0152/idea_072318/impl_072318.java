...
@Data
public class Idea72318Config {
    private String name = "idea_072318";
 ...
 */
@Slf4j
public class Idea72318Service {
    private static final int IDEA_ID = 72318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72318Service() {
        this(new Idea72318Config());
    }

    public Idea72318Service(Idea72318Config config) {
        this.config = config != null ? config : new Idea72318Config();
