...
@Data
public class Idea72276Config {
    private String name = "idea_072276";
 ...
 */
@Slf4j
public class Idea72276Service {
    private static final int IDEA_ID = 72276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72276Service() {
        this(new Idea72276Config());
    }

    public Idea72276Service(Idea72276Config config) {
        this.config = config != null ? config : new Idea72276Config();
