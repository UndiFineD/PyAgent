...
@Data
public class Idea72531Config {
    private String name = "idea_072531";
 ...
 */
@Slf4j
public class Idea72531Service {
    private static final int IDEA_ID = 72531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72531Service() {
        this(new Idea72531Config());
    }

    public Idea72531Service(Idea72531Config config) {
        this.config = config != null ? config : new Idea72531Config();
