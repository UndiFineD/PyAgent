...
@Data
public class Idea72367Config {
    private String name = "idea_072367";
 ...
 */
@Slf4j
public class Idea72367Service {
    private static final int IDEA_ID = 72367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72367Service() {
        this(new Idea72367Config());
    }

    public Idea72367Service(Idea72367Config config) {
        this.config = config != null ? config : new Idea72367Config();
