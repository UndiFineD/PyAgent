...
@Data
public class Idea72260Config {
    private String name = "idea_072260";
 ...
 */
@Slf4j
public class Idea72260Service {
    private static final int IDEA_ID = 72260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72260Service() {
        this(new Idea72260Config());
    }

    public Idea72260Service(Idea72260Config config) {
        this.config = config != null ? config : new Idea72260Config();
