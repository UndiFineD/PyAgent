...
@Data
public class Idea72235Config {
    private String name = "idea_072235";
 ...
 */
@Slf4j
public class Idea72235Service {
    private static final int IDEA_ID = 72235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72235Service() {
        this(new Idea72235Config());
    }

    public Idea72235Service(Idea72235Config config) {
        this.config = config != null ? config : new Idea72235Config();
