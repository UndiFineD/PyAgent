...
@Data
public class Idea72402Config {
    private String name = "idea_072402";
 ...
 */
@Slf4j
public class Idea72402Service {
    private static final int IDEA_ID = 72402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72402Service() {
        this(new Idea72402Config());
    }

    public Idea72402Service(Idea72402Config config) {
        this.config = config != null ? config : new Idea72402Config();
