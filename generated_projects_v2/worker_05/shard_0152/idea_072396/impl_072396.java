...
@Data
public class Idea72396Config {
    private String name = "idea_072396";
 ...
 */
@Slf4j
public class Idea72396Service {
    private static final int IDEA_ID = 72396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72396Service() {
        this(new Idea72396Config());
    }

    public Idea72396Service(Idea72396Config config) {
        this.config = config != null ? config : new Idea72396Config();
