...
@Data
public class Idea72620Config {
    private String name = "idea_072620";
 ...
 */
@Slf4j
public class Idea72620Service {
    private static final int IDEA_ID = 72620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72620Service() {
        this(new Idea72620Config());
    }

    public Idea72620Service(Idea72620Config config) {
        this.config = config != null ? config : new Idea72620Config();
