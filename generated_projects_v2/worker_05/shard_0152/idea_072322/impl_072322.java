...
@Data
public class Idea72322Config {
    private String name = "idea_072322";
 ...
 */
@Slf4j
public class Idea72322Service {
    private static final int IDEA_ID = 72322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72322Service() {
        this(new Idea72322Config());
    }

    public Idea72322Service(Idea72322Config config) {
        this.config = config != null ? config : new Idea72322Config();
