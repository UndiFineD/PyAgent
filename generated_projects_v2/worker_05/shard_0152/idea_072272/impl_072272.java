...
@Data
public class Idea72272Config {
    private String name = "idea_072272";
 ...
 */
@Slf4j
public class Idea72272Service {
    private static final int IDEA_ID = 72272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72272Service() {
        this(new Idea72272Config());
    }

    public Idea72272Service(Idea72272Config config) {
        this.config = config != null ? config : new Idea72272Config();
