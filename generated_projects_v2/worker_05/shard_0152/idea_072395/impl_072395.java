...
@Data
public class Idea72395Config {
    private String name = "idea_072395";
 ...
 */
@Slf4j
public class Idea72395Service {
    private static final int IDEA_ID = 72395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72395Service() {
        this(new Idea72395Config());
    }

    public Idea72395Service(Idea72395Config config) {
        this.config = config != null ? config : new Idea72395Config();
