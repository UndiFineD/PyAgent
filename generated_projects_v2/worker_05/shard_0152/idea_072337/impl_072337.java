...
@Data
public class Idea72337Config {
    private String name = "idea_072337";
 ...
 */
@Slf4j
public class Idea72337Service {
    private static final int IDEA_ID = 72337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72337Service() {
        this(new Idea72337Config());
    }

    public Idea72337Service(Idea72337Config config) {
        this.config = config != null ? config : new Idea72337Config();
