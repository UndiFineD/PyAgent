...
@Data
public class Idea72221Config {
    private String name = "idea_072221";
 ...
 */
@Slf4j
public class Idea72221Service {
    private static final int IDEA_ID = 72221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72221Service() {
        this(new Idea72221Config());
    }

    public Idea72221Service(Idea72221Config config) {
        this.config = config != null ? config : new Idea72221Config();
