...
@Data
public class Idea72514Config {
    private String name = "idea_072514";
 ...
 */
@Slf4j
public class Idea72514Service {
    private static final int IDEA_ID = 72514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72514Service() {
        this(new Idea72514Config());
    }

    public Idea72514Service(Idea72514Config config) {
        this.config = config != null ? config : new Idea72514Config();
