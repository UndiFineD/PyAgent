...
@Data
public class Idea72218Config {
    private String name = "idea_072218";
 ...
 */
@Slf4j
public class Idea72218Service {
    private static final int IDEA_ID = 72218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72218Service() {
        this(new Idea72218Config());
    }

    public Idea72218Service(Idea72218Config config) {
        this.config = config != null ? config : new Idea72218Config();
