...
@Data
public class Idea72210Config {
    private String name = "idea_072210";
 ...
 */
@Slf4j
public class Idea72210Service {
    private static final int IDEA_ID = 72210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72210Service() {
        this(new Idea72210Config());
    }

    public Idea72210Service(Idea72210Config config) {
        this.config = config != null ? config : new Idea72210Config();
