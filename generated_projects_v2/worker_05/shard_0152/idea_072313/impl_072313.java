...
@Data
public class Idea72313Config {
    private String name = "idea_072313";
 ...
 */
@Slf4j
public class Idea72313Service {
    private static final int IDEA_ID = 72313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72313Service() {
        this(new Idea72313Config());
    }

    public Idea72313Service(Idea72313Config config) {
        this.config = config != null ? config : new Idea72313Config();
