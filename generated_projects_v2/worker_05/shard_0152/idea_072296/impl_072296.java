...
@Data
public class Idea72296Config {
    private String name = "idea_072296";
 ...
 */
@Slf4j
public class Idea72296Service {
    private static final int IDEA_ID = 72296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72296Service() {
        this(new Idea72296Config());
    }

    public Idea72296Service(Idea72296Config config) {
        this.config = config != null ? config : new Idea72296Config();
