...
@Data
public class Idea72475Config {
    private String name = "idea_072475";
 ...
 */
@Slf4j
public class Idea72475Service {
    private static final int IDEA_ID = 72475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72475Service() {
        this(new Idea72475Config());
    }

    public Idea72475Service(Idea72475Config config) {
        this.config = config != null ? config : new Idea72475Config();
