...
@Data
public class Idea72312Config {
    private String name = "idea_072312";
 ...
 */
@Slf4j
public class Idea72312Service {
    private static final int IDEA_ID = 72312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72312Service() {
        this(new Idea72312Config());
    }

    public Idea72312Service(Idea72312Config config) {
        this.config = config != null ? config : new Idea72312Config();
