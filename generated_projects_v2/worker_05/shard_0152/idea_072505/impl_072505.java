...
@Data
public class Idea72505Config {
    private String name = "idea_072505";
 ...
 */
@Slf4j
public class Idea72505Service {
    private static final int IDEA_ID = 72505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72505Service() {
        this(new Idea72505Config());
    }

    public Idea72505Service(Idea72505Config config) {
        this.config = config != null ? config : new Idea72505Config();
