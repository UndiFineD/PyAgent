...
@Data
public class Idea72617Config {
    private String name = "idea_072617";
 ...
 */
@Slf4j
public class Idea72617Service {
    private static final int IDEA_ID = 72617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72617Service() {
        this(new Idea72617Config());
    }

    public Idea72617Service(Idea72617Config config) {
        this.config = config != null ? config : new Idea72617Config();
