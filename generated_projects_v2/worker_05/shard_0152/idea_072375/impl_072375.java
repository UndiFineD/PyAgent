...
@Data
public class Idea72375Config {
    private String name = "idea_072375";
 ...
 */
@Slf4j
public class Idea72375Service {
    private static final int IDEA_ID = 72375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72375Service() {
        this(new Idea72375Config());
    }

    public Idea72375Service(Idea72375Config config) {
        this.config = config != null ? config : new Idea72375Config();
