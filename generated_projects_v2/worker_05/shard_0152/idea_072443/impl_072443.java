...
@Data
public class Idea72443Config {
    private String name = "idea_072443";
 ...
 */
@Slf4j
public class Idea72443Service {
    private static final int IDEA_ID = 72443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72443Service() {
        this(new Idea72443Config());
    }

    public Idea72443Service(Idea72443Config config) {
        this.config = config != null ? config : new Idea72443Config();
