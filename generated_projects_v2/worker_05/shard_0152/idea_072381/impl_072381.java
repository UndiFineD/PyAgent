...
@Data
public class Idea72381Config {
    private String name = "idea_072381";
 ...
 */
@Slf4j
public class Idea72381Service {
    private static final int IDEA_ID = 72381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72381Service() {
        this(new Idea72381Config());
    }

    public Idea72381Service(Idea72381Config config) {
        this.config = config != null ? config : new Idea72381Config();
