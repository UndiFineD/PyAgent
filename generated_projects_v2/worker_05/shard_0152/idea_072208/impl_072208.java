...
@Data
public class Idea72208Config {
    private String name = "idea_072208";
 ...
 */
@Slf4j
public class Idea72208Service {
    private static final int IDEA_ID = 72208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72208Service() {
        this(new Idea72208Config());
    }

    public Idea72208Service(Idea72208Config config) {
        this.config = config != null ? config : new Idea72208Config();
