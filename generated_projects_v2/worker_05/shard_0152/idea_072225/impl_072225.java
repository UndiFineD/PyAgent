...
@Data
public class Idea72225Config {
    private String name = "idea_072225";
 ...
 */
@Slf4j
public class Idea72225Service {
    private static final int IDEA_ID = 72225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72225Service() {
        this(new Idea72225Config());
    }

    public Idea72225Service(Idea72225Config config) {
        this.config = config != null ? config : new Idea72225Config();
