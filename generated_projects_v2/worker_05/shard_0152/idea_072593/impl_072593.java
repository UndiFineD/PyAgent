...
@Data
public class Idea72593Config {
    private String name = "idea_072593";
 ...
 */
@Slf4j
public class Idea72593Service {
    private static final int IDEA_ID = 72593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72593Service() {
        this(new Idea72593Config());
    }

    public Idea72593Service(Idea72593Config config) {
        this.config = config != null ? config : new Idea72593Config();
