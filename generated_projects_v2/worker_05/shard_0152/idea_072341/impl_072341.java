...
@Data
public class Idea72341Config {
    private String name = "idea_072341";
 ...
 */
@Slf4j
public class Idea72341Service {
    private static final int IDEA_ID = 72341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72341Service() {
        this(new Idea72341Config());
    }

    public Idea72341Service(Idea72341Config config) {
        this.config = config != null ? config : new Idea72341Config();
