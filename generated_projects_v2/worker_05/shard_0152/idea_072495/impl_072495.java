...
@Data
public class Idea72495Config {
    private String name = "idea_072495";
 ...
 */
@Slf4j
public class Idea72495Service {
    private static final int IDEA_ID = 72495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72495Service() {
        this(new Idea72495Config());
    }

    public Idea72495Service(Idea72495Config config) {
        this.config = config != null ? config : new Idea72495Config();
