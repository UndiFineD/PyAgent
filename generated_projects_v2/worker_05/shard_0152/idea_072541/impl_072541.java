...
@Data
public class Idea72541Config {
    private String name = "idea_072541";
 ...
 */
@Slf4j
public class Idea72541Service {
    private static final int IDEA_ID = 72541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72541Service() {
        this(new Idea72541Config());
    }

    public Idea72541Service(Idea72541Config config) {
        this.config = config != null ? config : new Idea72541Config();
