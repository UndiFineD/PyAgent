...
@Data
public class Idea72575Config {
    private String name = "idea_072575";
 ...
 */
@Slf4j
public class Idea72575Service {
    private static final int IDEA_ID = 72575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72575Service() {
        this(new Idea72575Config());
    }

    public Idea72575Service(Idea72575Config config) {
        this.config = config != null ? config : new Idea72575Config();
