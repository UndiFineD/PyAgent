...
@Data
public class Idea72465Config {
    private String name = "idea_072465";
 ...
 */
@Slf4j
public class Idea72465Service {
    private static final int IDEA_ID = 72465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72465Service() {
        this(new Idea72465Config());
    }

    public Idea72465Service(Idea72465Config config) {
        this.config = config != null ? config : new Idea72465Config();
