...
@Data
public class Idea72636Config {
    private String name = "idea_072636";
 ...
 */
@Slf4j
public class Idea72636Service {
    private static final int IDEA_ID = 72636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72636Service() {
        this(new Idea72636Config());
    }

    public Idea72636Service(Idea72636Config config) {
        this.config = config != null ? config : new Idea72636Config();
