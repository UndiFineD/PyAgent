...
@Data
public class Idea72559Config {
    private String name = "idea_072559";
 ...
 */
@Slf4j
public class Idea72559Service {
    private static final int IDEA_ID = 72559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72559Service() {
        this(new Idea72559Config());
    }

    public Idea72559Service(Idea72559Config config) {
        this.config = config != null ? config : new Idea72559Config();
