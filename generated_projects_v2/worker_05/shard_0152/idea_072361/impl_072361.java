...
@Data
public class Idea72361Config {
    private String name = "idea_072361";
 ...
 */
@Slf4j
public class Idea72361Service {
    private static final int IDEA_ID = 72361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72361Service() {
        this(new Idea72361Config());
    }

    public Idea72361Service(Idea72361Config config) {
        this.config = config != null ? config : new Idea72361Config();
