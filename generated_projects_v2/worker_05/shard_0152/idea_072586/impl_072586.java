...
@Data
public class Idea72586Config {
    private String name = "idea_072586";
 ...
 */
@Slf4j
public class Idea72586Service {
    private static final int IDEA_ID = 72586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72586Service() {
        this(new Idea72586Config());
    }

    public Idea72586Service(Idea72586Config config) {
        this.config = config != null ? config : new Idea72586Config();
