...
@Data
public class Idea72257Config {
    private String name = "idea_072257";
 ...
 */
@Slf4j
public class Idea72257Service {
    private static final int IDEA_ID = 72257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72257Service() {
        this(new Idea72257Config());
    }

    public Idea72257Service(Idea72257Config config) {
        this.config = config != null ? config : new Idea72257Config();
