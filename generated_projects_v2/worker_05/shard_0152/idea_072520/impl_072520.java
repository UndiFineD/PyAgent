...
@Data
public class Idea72520Config {
    private String name = "idea_072520";
 ...
 */
@Slf4j
public class Idea72520Service {
    private static final int IDEA_ID = 72520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72520Service() {
        this(new Idea72520Config());
    }

    public Idea72520Service(Idea72520Config config) {
        this.config = config != null ? config : new Idea72520Config();
