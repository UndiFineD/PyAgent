...
@Data
public class Idea72504Config {
    private String name = "idea_072504";
 ...
 */
@Slf4j
public class Idea72504Service {
    private static final int IDEA_ID = 72504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72504Service() {
        this(new Idea72504Config());
    }

    public Idea72504Service(Idea72504Config config) {
        this.config = config != null ? config : new Idea72504Config();
