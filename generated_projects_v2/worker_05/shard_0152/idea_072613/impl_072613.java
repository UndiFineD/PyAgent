...
@Data
public class Idea72613Config {
    private String name = "idea_072613";
 ...
 */
@Slf4j
public class Idea72613Service {
    private static final int IDEA_ID = 72613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72613Service() {
        this(new Idea72613Config());
    }

    public Idea72613Service(Idea72613Config config) {
        this.config = config != null ? config : new Idea72613Config();
