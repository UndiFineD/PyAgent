...
@Data
public class Idea72350Config {
    private String name = "idea_072350";
 ...
 */
@Slf4j
public class Idea72350Service {
    private static final int IDEA_ID = 72350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72350Service() {
        this(new Idea72350Config());
    }

    public Idea72350Service(Idea72350Config config) {
        this.config = config != null ? config : new Idea72350Config();
