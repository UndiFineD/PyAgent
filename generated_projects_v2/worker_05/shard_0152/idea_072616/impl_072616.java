...
@Data
public class Idea72616Config {
    private String name = "idea_072616";
 ...
 */
@Slf4j
public class Idea72616Service {
    private static final int IDEA_ID = 72616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72616Service() {
        this(new Idea72616Config());
    }

    public Idea72616Service(Idea72616Config config) {
        this.config = config != null ? config : new Idea72616Config();
