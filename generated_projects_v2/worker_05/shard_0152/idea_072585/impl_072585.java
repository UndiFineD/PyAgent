...
@Data
public class Idea72585Config {
    private String name = "idea_072585";
 ...
 */
@Slf4j
public class Idea72585Service {
    private static final int IDEA_ID = 72585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72585Service() {
        this(new Idea72585Config());
    }

    public Idea72585Service(Idea72585Config config) {
        this.config = config != null ? config : new Idea72585Config();
