...
@Data
public class Idea72353Config {
    private String name = "idea_072353";
 ...
 */
@Slf4j
public class Idea72353Service {
    private static final int IDEA_ID = 72353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72353Service() {
        this(new Idea72353Config());
    }

    public Idea72353Service(Idea72353Config config) {
        this.config = config != null ? config : new Idea72353Config();
