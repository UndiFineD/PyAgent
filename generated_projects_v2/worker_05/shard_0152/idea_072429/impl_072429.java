...
@Data
public class Idea72429Config {
    private String name = "idea_072429";
 ...
 */
@Slf4j
public class Idea72429Service {
    private static final int IDEA_ID = 72429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72429Service() {
        this(new Idea72429Config());
    }

    public Idea72429Service(Idea72429Config config) {
        this.config = config != null ? config : new Idea72429Config();
