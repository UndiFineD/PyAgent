...
@Data
public class Idea72553Config {
    private String name = "idea_072553";
 ...
 */
@Slf4j
public class Idea72553Service {
    private static final int IDEA_ID = 72553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72553Service() {
        this(new Idea72553Config());
    }

    public Idea72553Service(Idea72553Config config) {
        this.config = config != null ? config : new Idea72553Config();
