...
@Data
public class Idea72532Config {
    private String name = "idea_072532";
 ...
 */
@Slf4j
public class Idea72532Service {
    private static final int IDEA_ID = 72532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72532Service() {
        this(new Idea72532Config());
    }

    public Idea72532Service(Idea72532Config config) {
        this.config = config != null ? config : new Idea72532Config();
