...
@Data
public class Idea72626Config {
    private String name = "idea_072626";
 ...
 */
@Slf4j
public class Idea72626Service {
    private static final int IDEA_ID = 72626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72626Service() {
        this(new Idea72626Config());
    }

    public Idea72626Service(Idea72626Config config) {
        this.config = config != null ? config : new Idea72626Config();
