...
@Data
public class Idea72363Config {
    private String name = "idea_072363";
 ...
 */
@Slf4j
public class Idea72363Service {
    private static final int IDEA_ID = 72363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72363Service() {
        this(new Idea72363Config());
    }

    public Idea72363Service(Idea72363Config config) {
        this.config = config != null ? config : new Idea72363Config();
