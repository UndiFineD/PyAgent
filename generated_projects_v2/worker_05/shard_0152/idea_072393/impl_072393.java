...
@Data
public class Idea72393Config {
    private String name = "idea_072393";
 ...
 */
@Slf4j
public class Idea72393Service {
    private static final int IDEA_ID = 72393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72393Service() {
        this(new Idea72393Config());
    }

    public Idea72393Service(Idea72393Config config) {
        this.config = config != null ? config : new Idea72393Config();
