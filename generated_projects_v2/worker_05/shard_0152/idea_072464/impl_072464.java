...
@Data
public class Idea72464Config {
    private String name = "idea_072464";
 ...
 */
@Slf4j
public class Idea72464Service {
    private static final int IDEA_ID = 72464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72464Service() {
        this(new Idea72464Config());
    }

    public Idea72464Service(Idea72464Config config) {
        this.config = config != null ? config : new Idea72464Config();
