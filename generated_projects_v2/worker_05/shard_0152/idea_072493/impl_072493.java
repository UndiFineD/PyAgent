...
@Data
public class Idea72493Config {
    private String name = "idea_072493";
 ...
 */
@Slf4j
public class Idea72493Service {
    private static final int IDEA_ID = 72493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72493Service() {
        this(new Idea72493Config());
    }

    public Idea72493Service(Idea72493Config config) {
        this.config = config != null ? config : new Idea72493Config();
