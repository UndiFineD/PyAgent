...
@Data
public class Idea72486Config {
    private String name = "idea_072486";
 ...
 */
@Slf4j
public class Idea72486Service {
    private static final int IDEA_ID = 72486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72486Service() {
        this(new Idea72486Config());
    }

    public Idea72486Service(Idea72486Config config) {
        this.config = config != null ? config : new Idea72486Config();
