...
@Data
public class Idea72297Config {
    private String name = "idea_072297";
 ...
 */
@Slf4j
public class Idea72297Service {
    private static final int IDEA_ID = 72297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72297Service() {
        this(new Idea72297Config());
    }

    public Idea72297Service(Idea72297Config config) {
        this.config = config != null ? config : new Idea72297Config();
