...
@Data
public class Idea72566Config {
    private String name = "idea_072566";
 ...
 */
@Slf4j
public class Idea72566Service {
    private static final int IDEA_ID = 72566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72566Service() {
        this(new Idea72566Config());
    }

    public Idea72566Service(Idea72566Config config) {
        this.config = config != null ? config : new Idea72566Config();
