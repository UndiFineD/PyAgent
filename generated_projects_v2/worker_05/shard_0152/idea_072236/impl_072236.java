...
@Data
public class Idea72236Config {
    private String name = "idea_072236";
 ...
 */
@Slf4j
public class Idea72236Service {
    private static final int IDEA_ID = 72236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72236Service() {
        this(new Idea72236Config());
    }

    public Idea72236Service(Idea72236Config config) {
        this.config = config != null ? config : new Idea72236Config();
