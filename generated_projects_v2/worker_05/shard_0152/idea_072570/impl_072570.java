...
@Data
public class Idea72570Config {
    private String name = "idea_072570";
 ...
 */
@Slf4j
public class Idea72570Service {
    private static final int IDEA_ID = 72570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72570Service() {
        this(new Idea72570Config());
    }

    public Idea72570Service(Idea72570Config config) {
        this.config = config != null ? config : new Idea72570Config();
