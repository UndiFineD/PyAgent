...
@Data
public class Idea72621Config {
    private String name = "idea_072621";
 ...
 */
@Slf4j
public class Idea72621Service {
    private static final int IDEA_ID = 72621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72621Service() {
        this(new Idea72621Config());
    }

    public Idea72621Service(Idea72621Config config) {
        this.config = config != null ? config : new Idea72621Config();
