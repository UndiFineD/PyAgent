...
@Data
public class Idea72385Config {
    private String name = "idea_072385";
 ...
 */
@Slf4j
public class Idea72385Service {
    private static final int IDEA_ID = 72385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72385Service() {
        this(new Idea72385Config());
    }

    public Idea72385Service(Idea72385Config config) {
        this.config = config != null ? config : new Idea72385Config();
