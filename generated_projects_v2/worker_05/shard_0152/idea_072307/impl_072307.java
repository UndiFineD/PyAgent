...
@Data
public class Idea72307Config {
    private String name = "idea_072307";
 ...
 */
@Slf4j
public class Idea72307Service {
    private static final int IDEA_ID = 72307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72307Service() {
        this(new Idea72307Config());
    }

    public Idea72307Service(Idea72307Config config) {
        this.config = config != null ? config : new Idea72307Config();
