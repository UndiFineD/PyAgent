...
@Data
public class Idea72578Config {
    private String name = "idea_072578";
 ...
 */
@Slf4j
public class Idea72578Service {
    private static final int IDEA_ID = 72578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72578Service() {
        this(new Idea72578Config());
    }

    public Idea72578Service(Idea72578Config config) {
        this.config = config != null ? config : new Idea72578Config();
