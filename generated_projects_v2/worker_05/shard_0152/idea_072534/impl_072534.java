...
@Data
public class Idea72534Config {
    private String name = "idea_072534";
 ...
 */
@Slf4j
public class Idea72534Service {
    private static final int IDEA_ID = 72534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72534Service() {
        this(new Idea72534Config());
    }

    public Idea72534Service(Idea72534Config config) {
        this.config = config != null ? config : new Idea72534Config();
