...
@Data
public class Idea73275Config {
    private String name = "idea_073275";
 ...
 */
@Slf4j
public class Idea73275Service {
    private static final int IDEA_ID = 73275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73275Service() {
        this(new Idea73275Config());
    }

    public Idea73275Service(Idea73275Config config) {
        this.config = config != null ? config : new Idea73275Config();
