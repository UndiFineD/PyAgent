...
@Data
public class Idea73328Config {
    private String name = "idea_073328";
 ...
 */
@Slf4j
public class Idea73328Service {
    private static final int IDEA_ID = 73328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73328Service() {
        this(new Idea73328Config());
    }

    public Idea73328Service(Idea73328Config config) {
        this.config = config != null ? config : new Idea73328Config();
