...
@Data
public class Idea73257Config {
    private String name = "idea_073257";
 ...
 */
@Slf4j
public class Idea73257Service {
    private static final int IDEA_ID = 73257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73257Service() {
        this(new Idea73257Config());
    }

    public Idea73257Service(Idea73257Config config) {
        this.config = config != null ? config : new Idea73257Config();
