...
@Data
public class Idea73178Config {
    private String name = "idea_073178";
 ...
 */
@Slf4j
public class Idea73178Service {
    private static final int IDEA_ID = 73178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73178Service() {
        this(new Idea73178Config());
    }

    public Idea73178Service(Idea73178Config config) {
        this.config = config != null ? config : new Idea73178Config();
