...
@Data
public class Idea73412Config {
    private String name = "idea_073412";
 ...
 */
@Slf4j
public class Idea73412Service {
    private static final int IDEA_ID = 73412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73412Service() {
        this(new Idea73412Config());
    }

    public Idea73412Service(Idea73412Config config) {
        this.config = config != null ? config : new Idea73412Config();
