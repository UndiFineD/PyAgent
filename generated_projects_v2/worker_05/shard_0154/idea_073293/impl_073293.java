...
@Data
public class Idea73293Config {
    private String name = "idea_073293";
 ...
 */
@Slf4j
public class Idea73293Service {
    private static final int IDEA_ID = 73293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73293Service() {
        this(new Idea73293Config());
    }

    public Idea73293Service(Idea73293Config config) {
        this.config = config != null ? config : new Idea73293Config();
