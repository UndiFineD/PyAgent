...
@Data
public class Idea73447Config {
    private String name = "idea_073447";
 ...
 */
@Slf4j
public class Idea73447Service {
    private static final int IDEA_ID = 73447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73447Service() {
        this(new Idea73447Config());
    }

    public Idea73447Service(Idea73447Config config) {
        this.config = config != null ? config : new Idea73447Config();
