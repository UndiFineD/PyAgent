...
@Data
public class Idea73353Config {
    private String name = "idea_073353";
 ...
 */
@Slf4j
public class Idea73353Service {
    private static final int IDEA_ID = 73353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73353Service() {
        this(new Idea73353Config());
    }

    public Idea73353Service(Idea73353Config config) {
        this.config = config != null ? config : new Idea73353Config();
