...
@Data
public class Idea73477Config {
    private String name = "idea_073477";
 ...
 */
@Slf4j
public class Idea73477Service {
    private static final int IDEA_ID = 73477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73477Service() {
        this(new Idea73477Config());
    }

    public Idea73477Service(Idea73477Config config) {
        this.config = config != null ? config : new Idea73477Config();
