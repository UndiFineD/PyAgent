...
@Data
public class Idea73591Config {
    private String name = "idea_073591";
 ...
 */
@Slf4j
public class Idea73591Service {
    private static final int IDEA_ID = 73591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73591Service() {
        this(new Idea73591Config());
    }

    public Idea73591Service(Idea73591Config config) {
        this.config = config != null ? config : new Idea73591Config();
