...
@Data
public class Idea73397Config {
    private String name = "idea_073397";
 ...
 */
@Slf4j
public class Idea73397Service {
    private static final int IDEA_ID = 73397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73397Service() {
        this(new Idea73397Config());
    }

    public Idea73397Service(Idea73397Config config) {
        this.config = config != null ? config : new Idea73397Config();
