...
@Data
public class Idea73342Config {
    private String name = "idea_073342";
 ...
 */
@Slf4j
public class Idea73342Service {
    private static final int IDEA_ID = 73342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73342Service() {
        this(new Idea73342Config());
    }

    public Idea73342Service(Idea73342Config config) {
        this.config = config != null ? config : new Idea73342Config();
