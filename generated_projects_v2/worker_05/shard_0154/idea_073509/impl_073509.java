...
@Data
public class Idea73509Config {
    private String name = "idea_073509";
 ...
 */
@Slf4j
public class Idea73509Service {
    private static final int IDEA_ID = 73509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73509Service() {
        this(new Idea73509Config());
    }

    public Idea73509Service(Idea73509Config config) {
        this.config = config != null ? config : new Idea73509Config();
