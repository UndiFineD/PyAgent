...
@Data
public class Idea73623Config {
    private String name = "idea_073623";
 ...
 */
@Slf4j
public class Idea73623Service {
    private static final int IDEA_ID = 73623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73623Service() {
        this(new Idea73623Config());
    }

    public Idea73623Service(Idea73623Config config) {
        this.config = config != null ? config : new Idea73623Config();
