...
@Data
public class Idea73170Config {
    private String name = "idea_073170";
 ...
 */
@Slf4j
public class Idea73170Service {
    private static final int IDEA_ID = 73170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73170Service() {
        this(new Idea73170Config());
    }

    public Idea73170Service(Idea73170Config config) {
        this.config = config != null ? config : new Idea73170Config();
