...
@Data
public class Idea73560Config {
    private String name = "idea_073560";
 ...
 */
@Slf4j
public class Idea73560Service {
    private static final int IDEA_ID = 73560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73560Service() {
        this(new Idea73560Config());
    }

    public Idea73560Service(Idea73560Config config) {
        this.config = config != null ? config : new Idea73560Config();
