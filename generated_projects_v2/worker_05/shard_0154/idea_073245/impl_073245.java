...
@Data
public class Idea73245Config {
    private String name = "idea_073245";
 ...
 */
@Slf4j
public class Idea73245Service {
    private static final int IDEA_ID = 73245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73245Service() {
        this(new Idea73245Config());
    }

    public Idea73245Service(Idea73245Config config) {
        this.config = config != null ? config : new Idea73245Config();
