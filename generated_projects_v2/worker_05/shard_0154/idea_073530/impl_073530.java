...
@Data
public class Idea73530Config {
    private String name = "idea_073530";
 ...
 */
@Slf4j
public class Idea73530Service {
    private static final int IDEA_ID = 73530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73530Service() {
        this(new Idea73530Config());
    }

    public Idea73530Service(Idea73530Config config) {
        this.config = config != null ? config : new Idea73530Config();
