...
@Data
public class Idea73545Config {
    private String name = "idea_073545";
 ...
 */
@Slf4j
public class Idea73545Service {
    private static final int IDEA_ID = 73545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73545Service() {
        this(new Idea73545Config());
    }

    public Idea73545Service(Idea73545Config config) {
        this.config = config != null ? config : new Idea73545Config();
