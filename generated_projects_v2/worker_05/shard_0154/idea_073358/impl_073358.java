...
@Data
public class Idea73358Config {
    private String name = "idea_073358";
 ...
 */
@Slf4j
public class Idea73358Service {
    private static final int IDEA_ID = 73358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73358Service() {
        this(new Idea73358Config());
    }

    public Idea73358Service(Idea73358Config config) {
        this.config = config != null ? config : new Idea73358Config();
