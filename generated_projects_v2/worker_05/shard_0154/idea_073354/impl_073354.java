...
@Data
public class Idea73354Config {
    private String name = "idea_073354";
 ...
 */
@Slf4j
public class Idea73354Service {
    private static final int IDEA_ID = 73354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73354Service() {
        this(new Idea73354Config());
    }

    public Idea73354Service(Idea73354Config config) {
        this.config = config != null ? config : new Idea73354Config();
