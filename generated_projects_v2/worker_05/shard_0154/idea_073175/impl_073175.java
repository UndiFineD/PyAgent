...
@Data
public class Idea73175Config {
    private String name = "idea_073175";
 ...
 */
@Slf4j
public class Idea73175Service {
    private static final int IDEA_ID = 73175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73175Service() {
        this(new Idea73175Config());
    }

    public Idea73175Service(Idea73175Config config) {
        this.config = config != null ? config : new Idea73175Config();
