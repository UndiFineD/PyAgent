...
@Data
public class Idea73301Config {
    private String name = "idea_073301";
 ...
 */
@Slf4j
public class Idea73301Service {
    private static final int IDEA_ID = 73301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73301Service() {
        this(new Idea73301Config());
    }

    public Idea73301Service(Idea73301Config config) {
        this.config = config != null ? config : new Idea73301Config();
