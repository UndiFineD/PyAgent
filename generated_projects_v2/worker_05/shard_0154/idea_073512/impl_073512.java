...
@Data
public class Idea73512Config {
    private String name = "idea_073512";
 ...
 */
@Slf4j
public class Idea73512Service {
    private static final int IDEA_ID = 73512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73512Service() {
        this(new Idea73512Config());
    }

    public Idea73512Service(Idea73512Config config) {
        this.config = config != null ? config : new Idea73512Config();
