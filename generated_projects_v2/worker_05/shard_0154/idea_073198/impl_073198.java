...
@Data
public class Idea73198Config {
    private String name = "idea_073198";
 ...
 */
@Slf4j
public class Idea73198Service {
    private static final int IDEA_ID = 73198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73198Service() {
        this(new Idea73198Config());
    }

    public Idea73198Service(Idea73198Config config) {
        this.config = config != null ? config : new Idea73198Config();
