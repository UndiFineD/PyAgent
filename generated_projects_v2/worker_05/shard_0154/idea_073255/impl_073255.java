...
@Data
public class Idea73255Config {
    private String name = "idea_073255";
 ...
 */
@Slf4j
public class Idea73255Service {
    private static final int IDEA_ID = 73255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73255Service() {
        this(new Idea73255Config());
    }

    public Idea73255Service(Idea73255Config config) {
        this.config = config != null ? config : new Idea73255Config();
