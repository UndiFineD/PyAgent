...
@Data
public class Idea73158Config {
    private String name = "idea_073158";
 ...
 */
@Slf4j
public class Idea73158Service {
    private static final int IDEA_ID = 73158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73158Service() {
        this(new Idea73158Config());
    }

    public Idea73158Service(Idea73158Config config) {
        this.config = config != null ? config : new Idea73158Config();
