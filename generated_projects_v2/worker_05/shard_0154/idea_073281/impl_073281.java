...
@Data
public class Idea73281Config {
    private String name = "idea_073281";
 ...
 */
@Slf4j
public class Idea73281Service {
    private static final int IDEA_ID = 73281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73281Service() {
        this(new Idea73281Config());
    }

    public Idea73281Service(Idea73281Config config) {
        this.config = config != null ? config : new Idea73281Config();
