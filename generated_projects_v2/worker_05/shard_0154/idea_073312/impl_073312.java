...
@Data
public class Idea73312Config {
    private String name = "idea_073312";
 ...
 */
@Slf4j
public class Idea73312Service {
    private static final int IDEA_ID = 73312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73312Service() {
        this(new Idea73312Config());
    }

    public Idea73312Service(Idea73312Config config) {
        this.config = config != null ? config : new Idea73312Config();
