...
@Data
public class Idea73491Config {
    private String name = "idea_073491";
 ...
 */
@Slf4j
public class Idea73491Service {
    private static final int IDEA_ID = 73491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73491Service() {
        this(new Idea73491Config());
    }

    public Idea73491Service(Idea73491Config config) {
        this.config = config != null ? config : new Idea73491Config();
