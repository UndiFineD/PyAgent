...
@Data
public class Idea73487Config {
    private String name = "idea_073487";
 ...
 */
@Slf4j
public class Idea73487Service {
    private static final int IDEA_ID = 73487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73487Service() {
        this(new Idea73487Config());
    }

    public Idea73487Service(Idea73487Config config) {
        this.config = config != null ? config : new Idea73487Config();
