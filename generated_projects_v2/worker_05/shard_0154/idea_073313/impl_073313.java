...
@Data
public class Idea73313Config {
    private String name = "idea_073313";
 ...
 */
@Slf4j
public class Idea73313Service {
    private static final int IDEA_ID = 73313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73313Service() {
        this(new Idea73313Config());
    }

    public Idea73313Service(Idea73313Config config) {
        this.config = config != null ? config : new Idea73313Config();
