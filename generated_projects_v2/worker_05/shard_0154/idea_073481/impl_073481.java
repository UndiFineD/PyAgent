...
@Data
public class Idea73481Config {
    private String name = "idea_073481";
 ...
 */
@Slf4j
public class Idea73481Service {
    private static final int IDEA_ID = 73481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73481Service() {
        this(new Idea73481Config());
    }

    public Idea73481Service(Idea73481Config config) {
        this.config = config != null ? config : new Idea73481Config();
