...
@Data
public class Idea73577Config {
    private String name = "idea_073577";
 ...
 */
@Slf4j
public class Idea73577Service {
    private static final int IDEA_ID = 73577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73577Service() {
        this(new Idea73577Config());
    }

    public Idea73577Service(Idea73577Config config) {
        this.config = config != null ? config : new Idea73577Config();
