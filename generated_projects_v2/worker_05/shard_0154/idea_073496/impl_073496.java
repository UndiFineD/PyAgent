...
@Data
public class Idea73496Config {
    private String name = "idea_073496";
 ...
 */
@Slf4j
public class Idea73496Service {
    private static final int IDEA_ID = 73496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73496Service() {
        this(new Idea73496Config());
    }

    public Idea73496Service(Idea73496Config config) {
        this.config = config != null ? config : new Idea73496Config();
