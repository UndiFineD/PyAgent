...
@Data
public class Idea73266Config {
    private String name = "idea_073266";
 ...
 */
@Slf4j
public class Idea73266Service {
    private static final int IDEA_ID = 73266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73266Service() {
        this(new Idea73266Config());
    }

    public Idea73266Service(Idea73266Config config) {
        this.config = config != null ? config : new Idea73266Config();
