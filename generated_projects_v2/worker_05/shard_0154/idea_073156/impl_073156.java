...
@Data
public class Idea73156Config {
    private String name = "idea_073156";
 ...
 */
@Slf4j
public class Idea73156Service {
    private static final int IDEA_ID = 73156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73156Service() {
        this(new Idea73156Config());
    }

    public Idea73156Service(Idea73156Config config) {
        this.config = config != null ? config : new Idea73156Config();
