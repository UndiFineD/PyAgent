...
@Data
public class Idea73236Config {
    private String name = "idea_073236";
 ...
 */
@Slf4j
public class Idea73236Service {
    private static final int IDEA_ID = 73236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73236Service() {
        this(new Idea73236Config());
    }

    public Idea73236Service(Idea73236Config config) {
        this.config = config != null ? config : new Idea73236Config();
