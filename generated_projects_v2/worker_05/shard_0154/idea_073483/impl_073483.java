...
@Data
public class Idea73483Config {
    private String name = "idea_073483";
 ...
 */
@Slf4j
public class Idea73483Service {
    private static final int IDEA_ID = 73483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73483Service() {
        this(new Idea73483Config());
    }

    public Idea73483Service(Idea73483Config config) {
        this.config = config != null ? config : new Idea73483Config();
