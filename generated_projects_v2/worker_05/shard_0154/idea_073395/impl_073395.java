...
@Data
public class Idea73395Config {
    private String name = "idea_073395";
 ...
 */
@Slf4j
public class Idea73395Service {
    private static final int IDEA_ID = 73395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73395Service() {
        this(new Idea73395Config());
    }

    public Idea73395Service(Idea73395Config config) {
        this.config = config != null ? config : new Idea73395Config();
