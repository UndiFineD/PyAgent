...
@Data
public class Idea73343Config {
    private String name = "idea_073343";
 ...
 */
@Slf4j
public class Idea73343Service {
    private static final int IDEA_ID = 73343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73343Service() {
        this(new Idea73343Config());
    }

    public Idea73343Service(Idea73343Config config) {
        this.config = config != null ? config : new Idea73343Config();
