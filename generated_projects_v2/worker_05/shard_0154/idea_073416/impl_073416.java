...
@Data
public class Idea73416Config {
    private String name = "idea_073416";
 ...
 */
@Slf4j
public class Idea73416Service {
    private static final int IDEA_ID = 73416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73416Service() {
        this(new Idea73416Config());
    }

    public Idea73416Service(Idea73416Config config) {
        this.config = config != null ? config : new Idea73416Config();
