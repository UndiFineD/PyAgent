...
@Data
public class Idea73246Config {
    private String name = "idea_073246";
 ...
 */
@Slf4j
public class Idea73246Service {
    private static final int IDEA_ID = 73246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73246Service() {
        this(new Idea73246Config());
    }

    public Idea73246Service(Idea73246Config config) {
        this.config = config != null ? config : new Idea73246Config();
