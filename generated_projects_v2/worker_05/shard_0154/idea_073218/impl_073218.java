...
@Data
public class Idea73218Config {
    private String name = "idea_073218";
 ...
 */
@Slf4j
public class Idea73218Service {
    private static final int IDEA_ID = 73218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73218Service() {
        this(new Idea73218Config());
    }

    public Idea73218Service(Idea73218Config config) {
        this.config = config != null ? config : new Idea73218Config();
