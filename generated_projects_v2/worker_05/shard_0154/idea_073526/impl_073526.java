...
@Data
public class Idea73526Config {
    private String name = "idea_073526";
 ...
 */
@Slf4j
public class Idea73526Service {
    private static final int IDEA_ID = 73526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73526Service() {
        this(new Idea73526Config());
    }

    public Idea73526Service(Idea73526Config config) {
        this.config = config != null ? config : new Idea73526Config();
