...
@Data
public class Idea73461Config {
    private String name = "idea_073461";
 ...
 */
@Slf4j
public class Idea73461Service {
    private static final int IDEA_ID = 73461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73461Service() {
        this(new Idea73461Config());
    }

    public Idea73461Service(Idea73461Config config) {
        this.config = config != null ? config : new Idea73461Config();
