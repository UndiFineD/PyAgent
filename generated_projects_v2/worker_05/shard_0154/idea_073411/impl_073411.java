...
@Data
public class Idea73411Config {
    private String name = "idea_073411";
 ...
 */
@Slf4j
public class Idea73411Service {
    private static final int IDEA_ID = 73411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73411Service() {
        this(new Idea73411Config());
    }

    public Idea73411Service(Idea73411Config config) {
        this.config = config != null ? config : new Idea73411Config();
