...
@Data
public class Idea73574Config {
    private String name = "idea_073574";
 ...
 */
@Slf4j
public class Idea73574Service {
    private static final int IDEA_ID = 73574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73574Service() {
        this(new Idea73574Config());
    }

    public Idea73574Service(Idea73574Config config) {
        this.config = config != null ? config : new Idea73574Config();
