...
@Data
public class Idea73325Config {
    private String name = "idea_073325";
 ...
 */
@Slf4j
public class Idea73325Service {
    private static final int IDEA_ID = 73325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73325Service() {
        this(new Idea73325Config());
    }

    public Idea73325Service(Idea73325Config config) {
        this.config = config != null ? config : new Idea73325Config();
