...
@Data
public class Idea73169Config {
    private String name = "idea_073169";
 ...
 */
@Slf4j
public class Idea73169Service {
    private static final int IDEA_ID = 73169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73169Service() {
        this(new Idea73169Config());
    }

    public Idea73169Service(Idea73169Config config) {
        this.config = config != null ? config : new Idea73169Config();
