...
@Data
public class Idea73394Config {
    private String name = "idea_073394";
 ...
 */
@Slf4j
public class Idea73394Service {
    private static final int IDEA_ID = 73394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73394Service() {
        this(new Idea73394Config());
    }

    public Idea73394Service(Idea73394Config config) {
        this.config = config != null ? config : new Idea73394Config();
