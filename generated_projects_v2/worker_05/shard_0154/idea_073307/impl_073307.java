...
@Data
public class Idea73307Config {
    private String name = "idea_073307";
 ...
 */
@Slf4j
public class Idea73307Service {
    private static final int IDEA_ID = 73307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73307Service() {
        this(new Idea73307Config());
    }

    public Idea73307Service(Idea73307Config config) {
        this.config = config != null ? config : new Idea73307Config();
