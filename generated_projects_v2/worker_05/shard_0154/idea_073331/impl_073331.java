...
@Data
public class Idea73331Config {
    private String name = "idea_073331";
 ...
 */
@Slf4j
public class Idea73331Service {
    private static final int IDEA_ID = 73331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73331Service() {
        this(new Idea73331Config());
    }

    public Idea73331Service(Idea73331Config config) {
        this.config = config != null ? config : new Idea73331Config();
