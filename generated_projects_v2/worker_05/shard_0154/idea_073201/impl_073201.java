...
@Data
public class Idea73201Config {
    private String name = "idea_073201";
 ...
 */
@Slf4j
public class Idea73201Service {
    private static final int IDEA_ID = 73201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73201Service() {
        this(new Idea73201Config());
    }

    public Idea73201Service(Idea73201Config config) {
        this.config = config != null ? config : new Idea73201Config();
