...
@Data
public class Idea73165Config {
    private String name = "idea_073165";
 ...
 */
@Slf4j
public class Idea73165Service {
    private static final int IDEA_ID = 73165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73165Service() {
        this(new Idea73165Config());
    }

    public Idea73165Service(Idea73165Config config) {
        this.config = config != null ? config : new Idea73165Config();
