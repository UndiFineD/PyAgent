...
@Data
public class Idea73407Config {
    private String name = "idea_073407";
 ...
 */
@Slf4j
public class Idea73407Service {
    private static final int IDEA_ID = 73407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73407Service() {
        this(new Idea73407Config());
    }

    public Idea73407Service(Idea73407Config config) {
        this.config = config != null ? config : new Idea73407Config();
