...
@Data
public class Idea73371Config {
    private String name = "idea_073371";
 ...
 */
@Slf4j
public class Idea73371Service {
    private static final int IDEA_ID = 73371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73371Service() {
        this(new Idea73371Config());
    }

    public Idea73371Service(Idea73371Config config) {
        this.config = config != null ? config : new Idea73371Config();
