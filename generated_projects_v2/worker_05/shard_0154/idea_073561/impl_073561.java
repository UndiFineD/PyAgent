...
@Data
public class Idea73561Config {
    private String name = "idea_073561";
 ...
 */
@Slf4j
public class Idea73561Service {
    private static final int IDEA_ID = 73561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73561Service() {
        this(new Idea73561Config());
    }

    public Idea73561Service(Idea73561Config config) {
        this.config = config != null ? config : new Idea73561Config();
