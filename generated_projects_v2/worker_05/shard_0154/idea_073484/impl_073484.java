...
@Data
public class Idea73484Config {
    private String name = "idea_073484";
 ...
 */
@Slf4j
public class Idea73484Service {
    private static final int IDEA_ID = 73484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73484Service() {
        this(new Idea73484Config());
    }

    public Idea73484Service(Idea73484Config config) {
        this.config = config != null ? config : new Idea73484Config();
