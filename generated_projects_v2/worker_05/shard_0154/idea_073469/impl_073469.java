...
@Data
public class Idea73469Config {
    private String name = "idea_073469";
 ...
 */
@Slf4j
public class Idea73469Service {
    private static final int IDEA_ID = 73469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73469Service() {
        this(new Idea73469Config());
    }

    public Idea73469Service(Idea73469Config config) {
        this.config = config != null ? config : new Idea73469Config();
