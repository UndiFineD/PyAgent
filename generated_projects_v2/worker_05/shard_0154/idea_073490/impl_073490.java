...
@Data
public class Idea73490Config {
    private String name = "idea_073490";
 ...
 */
@Slf4j
public class Idea73490Service {
    private static final int IDEA_ID = 73490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73490Service() {
        this(new Idea73490Config());
    }

    public Idea73490Service(Idea73490Config config) {
        this.config = config != null ? config : new Idea73490Config();
