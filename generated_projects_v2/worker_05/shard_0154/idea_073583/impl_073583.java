...
@Data
public class Idea73583Config {
    private String name = "idea_073583";
 ...
 */
@Slf4j
public class Idea73583Service {
    private static final int IDEA_ID = 73583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73583Service() {
        this(new Idea73583Config());
    }

    public Idea73583Service(Idea73583Config config) {
        this.config = config != null ? config : new Idea73583Config();
