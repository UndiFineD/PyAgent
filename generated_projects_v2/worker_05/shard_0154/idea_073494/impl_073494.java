...
@Data
public class Idea73494Config {
    private String name = "idea_073494";
 ...
 */
@Slf4j
public class Idea73494Service {
    private static final int IDEA_ID = 73494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73494Service() {
        this(new Idea73494Config());
    }

    public Idea73494Service(Idea73494Config config) {
        this.config = config != null ? config : new Idea73494Config();
