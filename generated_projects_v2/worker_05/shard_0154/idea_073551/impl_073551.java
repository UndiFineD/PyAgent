...
@Data
public class Idea73551Config {
    private String name = "idea_073551";
 ...
 */
@Slf4j
public class Idea73551Service {
    private static final int IDEA_ID = 73551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73551Service() {
        this(new Idea73551Config());
    }

    public Idea73551Service(Idea73551Config config) {
        this.config = config != null ? config : new Idea73551Config();
