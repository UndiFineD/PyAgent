...
@Data
public class Idea73164Config {
    private String name = "idea_073164";
 ...
 */
@Slf4j
public class Idea73164Service {
    private static final int IDEA_ID = 73164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73164Service() {
        this(new Idea73164Config());
    }

    public Idea73164Service(Idea73164Config config) {
        this.config = config != null ? config : new Idea73164Config();
