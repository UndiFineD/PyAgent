...
@Data
public class Idea73376Config {
    private String name = "idea_073376";
 ...
 */
@Slf4j
public class Idea73376Service {
    private static final int IDEA_ID = 73376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73376Service() {
        this(new Idea73376Config());
    }

    public Idea73376Service(Idea73376Config config) {
        this.config = config != null ? config : new Idea73376Config();
