...
@Data
public class Idea73188Config {
    private String name = "idea_073188";
 ...
 */
@Slf4j
public class Idea73188Service {
    private static final int IDEA_ID = 73188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73188Service() {
        this(new Idea73188Config());
    }

    public Idea73188Service(Idea73188Config config) {
        this.config = config != null ? config : new Idea73188Config();
