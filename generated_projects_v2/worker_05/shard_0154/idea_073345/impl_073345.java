...
@Data
public class Idea73345Config {
    private String name = "idea_073345";
 ...
 */
@Slf4j
public class Idea73345Service {
    private static final int IDEA_ID = 73345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73345Service() {
        this(new Idea73345Config());
    }

    public Idea73345Service(Idea73345Config config) {
        this.config = config != null ? config : new Idea73345Config();
