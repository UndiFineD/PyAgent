...
@Data
public class Idea73317Config {
    private String name = "idea_073317";
 ...
 */
@Slf4j
public class Idea73317Service {
    private static final int IDEA_ID = 73317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73317Service() {
        this(new Idea73317Config());
    }

    public Idea73317Service(Idea73317Config config) {
        this.config = config != null ? config : new Idea73317Config();
