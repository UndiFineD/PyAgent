...
@Data
public class Idea73258Config {
    private String name = "idea_073258";
 ...
 */
@Slf4j
public class Idea73258Service {
    private static final int IDEA_ID = 73258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73258Service() {
        this(new Idea73258Config());
    }

    public Idea73258Service(Idea73258Config config) {
        this.config = config != null ? config : new Idea73258Config();
