...
@Data
public class Idea73295Config {
    private String name = "idea_073295";
 ...
 */
@Slf4j
public class Idea73295Service {
    private static final int IDEA_ID = 73295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73295Service() {
        this(new Idea73295Config());
    }

    public Idea73295Service(Idea73295Config config) {
        this.config = config != null ? config : new Idea73295Config();
