...
@Data
public class Idea73501Config {
    private String name = "idea_073501";
 ...
 */
@Slf4j
public class Idea73501Service {
    private static final int IDEA_ID = 73501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73501Service() {
        this(new Idea73501Config());
    }

    public Idea73501Service(Idea73501Config config) {
        this.config = config != null ? config : new Idea73501Config();
