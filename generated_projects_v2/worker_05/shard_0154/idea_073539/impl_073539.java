...
@Data
public class Idea73539Config {
    private String name = "idea_073539";
 ...
 */
@Slf4j
public class Idea73539Service {
    private static final int IDEA_ID = 73539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73539Service() {
        this(new Idea73539Config());
    }

    public Idea73539Service(Idea73539Config config) {
        this.config = config != null ? config : new Idea73539Config();
