...
@Data
public class Idea73558Config {
    private String name = "idea_073558";
 ...
 */
@Slf4j
public class Idea73558Service {
    private static final int IDEA_ID = 73558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73558Service() {
        this(new Idea73558Config());
    }

    public Idea73558Service(Idea73558Config config) {
        this.config = config != null ? config : new Idea73558Config();
