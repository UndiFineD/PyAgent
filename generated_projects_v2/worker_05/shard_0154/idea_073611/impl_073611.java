...
@Data
public class Idea73611Config {
    private String name = "idea_073611";
 ...
 */
@Slf4j
public class Idea73611Service {
    private static final int IDEA_ID = 73611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73611Service() {
        this(new Idea73611Config());
    }

    public Idea73611Service(Idea73611Config config) {
        this.config = config != null ? config : new Idea73611Config();
