...
@Data
public class Idea73508Config {
    private String name = "idea_073508";
 ...
 */
@Slf4j
public class Idea73508Service {
    private static final int IDEA_ID = 73508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73508Service() {
        this(new Idea73508Config());
    }

    public Idea73508Service(Idea73508Config config) {
        this.config = config != null ? config : new Idea73508Config();
