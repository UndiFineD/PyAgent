...
@Data
public class Idea73174Config {
    private String name = "idea_073174";
 ...
 */
@Slf4j
public class Idea73174Service {
    private static final int IDEA_ID = 73174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73174Service() {
        this(new Idea73174Config());
    }

    public Idea73174Service(Idea73174Config config) {
        this.config = config != null ? config : new Idea73174Config();
