...
@Data
public class Idea73488Config {
    private String name = "idea_073488";
 ...
 */
@Slf4j
public class Idea73488Service {
    private static final int IDEA_ID = 73488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73488Service() {
        this(new Idea73488Config());
    }

    public Idea73488Service(Idea73488Config config) {
        this.config = config != null ? config : new Idea73488Config();
