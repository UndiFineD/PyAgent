...
@Data
public class Idea73589Config {
    private String name = "idea_073589";
 ...
 */
@Slf4j
public class Idea73589Service {
    private static final int IDEA_ID = 73589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73589Service() {
        this(new Idea73589Config());
    }

    public Idea73589Service(Idea73589Config config) {
        this.config = config != null ? config : new Idea73589Config();
