...
@Data
public class Idea73529Config {
    private String name = "idea_073529";
 ...
 */
@Slf4j
public class Idea73529Service {
    private static final int IDEA_ID = 73529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73529Service() {
        this(new Idea73529Config());
    }

    public Idea73529Service(Idea73529Config config) {
        this.config = config != null ? config : new Idea73529Config();
