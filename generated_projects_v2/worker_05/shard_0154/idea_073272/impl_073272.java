...
@Data
public class Idea73272Config {
    private String name = "idea_073272";
 ...
 */
@Slf4j
public class Idea73272Service {
    private static final int IDEA_ID = 73272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73272Service() {
        this(new Idea73272Config());
    }

    public Idea73272Service(Idea73272Config config) {
        this.config = config != null ? config : new Idea73272Config();
