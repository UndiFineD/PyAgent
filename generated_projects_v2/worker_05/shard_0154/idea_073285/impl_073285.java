...
@Data
public class Idea73285Config {
    private String name = "idea_073285";
 ...
 */
@Slf4j
public class Idea73285Service {
    private static final int IDEA_ID = 73285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73285Service() {
        this(new Idea73285Config());
    }

    public Idea73285Service(Idea73285Config config) {
        this.config = config != null ? config : new Idea73285Config();
