...
@Data
public class Idea73440Config {
    private String name = "idea_073440";
 ...
 */
@Slf4j
public class Idea73440Service {
    private static final int IDEA_ID = 73440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73440Service() {
        this(new Idea73440Config());
    }

    public Idea73440Service(Idea73440Config config) {
        this.config = config != null ? config : new Idea73440Config();
