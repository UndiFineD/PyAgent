...
@Data
public class Idea73434Config {
    private String name = "idea_073434";
 ...
 */
@Slf4j
public class Idea73434Service {
    private static final int IDEA_ID = 73434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73434Service() {
        this(new Idea73434Config());
    }

    public Idea73434Service(Idea73434Config config) {
        this.config = config != null ? config : new Idea73434Config();
