...
@Data
public class Idea73471Config {
    private String name = "idea_073471";
 ...
 */
@Slf4j
public class Idea73471Service {
    private static final int IDEA_ID = 73471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73471Service() {
        this(new Idea73471Config());
    }

    public Idea73471Service(Idea73471Config config) {
        this.config = config != null ? config : new Idea73471Config();
