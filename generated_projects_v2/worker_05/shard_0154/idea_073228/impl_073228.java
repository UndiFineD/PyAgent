...
@Data
public class Idea73228Config {
    private String name = "idea_073228";
 ...
 */
@Slf4j
public class Idea73228Service {
    private static final int IDEA_ID = 73228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73228Service() {
        this(new Idea73228Config());
    }

    public Idea73228Service(Idea73228Config config) {
        this.config = config != null ? config : new Idea73228Config();
