...
@Data
public class Idea73263Config {
    private String name = "idea_073263";
 ...
 */
@Slf4j
public class Idea73263Service {
    private static final int IDEA_ID = 73263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73263Service() {
        this(new Idea73263Config());
    }

    public Idea73263Service(Idea73263Config config) {
        this.config = config != null ? config : new Idea73263Config();
