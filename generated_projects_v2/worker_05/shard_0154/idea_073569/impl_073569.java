...
@Data
public class Idea73569Config {
    private String name = "idea_073569";
 ...
 */
@Slf4j
public class Idea73569Service {
    private static final int IDEA_ID = 73569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73569Service() {
        this(new Idea73569Config());
    }

    public Idea73569Service(Idea73569Config config) {
        this.config = config != null ? config : new Idea73569Config();
