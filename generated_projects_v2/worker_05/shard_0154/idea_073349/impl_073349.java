...
@Data
public class Idea73349Config {
    private String name = "idea_073349";
 ...
 */
@Slf4j
public class Idea73349Service {
    private static final int IDEA_ID = 73349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73349Service() {
        this(new Idea73349Config());
    }

    public Idea73349Service(Idea73349Config config) {
        this.config = config != null ? config : new Idea73349Config();
