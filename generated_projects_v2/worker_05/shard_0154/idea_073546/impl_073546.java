...
@Data
public class Idea73546Config {
    private String name = "idea_073546";
 ...
 */
@Slf4j
public class Idea73546Service {
    private static final int IDEA_ID = 73546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73546Service() {
        this(new Idea73546Config());
    }

    public Idea73546Service(Idea73546Config config) {
        this.config = config != null ? config : new Idea73546Config();
