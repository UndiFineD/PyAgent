...
@Data
public class Idea73615Config {
    private String name = "idea_073615";
 ...
 */
@Slf4j
public class Idea73615Service {
    private static final int IDEA_ID = 73615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73615Service() {
        this(new Idea73615Config());
    }

    public Idea73615Service(Idea73615Config config) {
        this.config = config != null ? config : new Idea73615Config();
