...
@Data
public class Idea73168Config {
    private String name = "idea_073168";
 ...
 */
@Slf4j
public class Idea73168Service {
    private static final int IDEA_ID = 73168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73168Service() {
        this(new Idea73168Config());
    }

    public Idea73168Service(Idea73168Config config) {
        this.config = config != null ? config : new Idea73168Config();
