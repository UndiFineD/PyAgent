...
@Data
public class Idea73348Config {
    private String name = "idea_073348";
 ...
 */
@Slf4j
public class Idea73348Service {
    private static final int IDEA_ID = 73348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73348Service() {
        this(new Idea73348Config());
    }

    public Idea73348Service(Idea73348Config config) {
        this.config = config != null ? config : new Idea73348Config();
