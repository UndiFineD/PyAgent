...
@Data
public class Idea73279Config {
    private String name = "idea_073279";
 ...
 */
@Slf4j
public class Idea73279Service {
    private static final int IDEA_ID = 73279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73279Service() {
        this(new Idea73279Config());
    }

    public Idea73279Service(Idea73279Config config) {
        this.config = config != null ? config : new Idea73279Config();
