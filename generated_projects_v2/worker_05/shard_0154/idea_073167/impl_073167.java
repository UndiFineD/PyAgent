...
@Data
public class Idea73167Config {
    private String name = "idea_073167";
 ...
 */
@Slf4j
public class Idea73167Service {
    private static final int IDEA_ID = 73167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73167Service() {
        this(new Idea73167Config());
    }

    public Idea73167Service(Idea73167Config config) {
        this.config = config != null ? config : new Idea73167Config();
