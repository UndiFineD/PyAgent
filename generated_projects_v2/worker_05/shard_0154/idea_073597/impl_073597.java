...
@Data
public class Idea73597Config {
    private String name = "idea_073597";
 ...
 */
@Slf4j
public class Idea73597Service {
    private static final int IDEA_ID = 73597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73597Service() {
        this(new Idea73597Config());
    }

    public Idea73597Service(Idea73597Config config) {
        this.config = config != null ? config : new Idea73597Config();
