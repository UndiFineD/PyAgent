...
@Data
public class Idea73450Config {
    private String name = "idea_073450";
 ...
 */
@Slf4j
public class Idea73450Service {
    private static final int IDEA_ID = 73450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73450Service() {
        this(new Idea73450Config());
    }

    public Idea73450Service(Idea73450Config config) {
        this.config = config != null ? config : new Idea73450Config();
