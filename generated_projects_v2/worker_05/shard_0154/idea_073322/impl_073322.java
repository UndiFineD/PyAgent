...
@Data
public class Idea73322Config {
    private String name = "idea_073322";
 ...
 */
@Slf4j
public class Idea73322Service {
    private static final int IDEA_ID = 73322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73322Service() {
        this(new Idea73322Config());
    }

    public Idea73322Service(Idea73322Config config) {
        this.config = config != null ? config : new Idea73322Config();
