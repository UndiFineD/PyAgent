...
@Data
public class Idea73540Config {
    private String name = "idea_073540";
 ...
 */
@Slf4j
public class Idea73540Service {
    private static final int IDEA_ID = 73540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73540Service() {
        this(new Idea73540Config());
    }

    public Idea73540Service(Idea73540Config config) {
        this.config = config != null ? config : new Idea73540Config();
