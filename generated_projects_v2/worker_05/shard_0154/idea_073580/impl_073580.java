...
@Data
public class Idea73580Config {
    private String name = "idea_073580";
 ...
 */
@Slf4j
public class Idea73580Service {
    private static final int IDEA_ID = 73580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73580Service() {
        this(new Idea73580Config());
    }

    public Idea73580Service(Idea73580Config config) {
        this.config = config != null ? config : new Idea73580Config();
