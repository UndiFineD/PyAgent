...
@Data
public class Idea73231Config {
    private String name = "idea_073231";
 ...
 */
@Slf4j
public class Idea73231Service {
    private static final int IDEA_ID = 73231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73231Service() {
        this(new Idea73231Config());
    }

    public Idea73231Service(Idea73231Config config) {
        this.config = config != null ? config : new Idea73231Config();
