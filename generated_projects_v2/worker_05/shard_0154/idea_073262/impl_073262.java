...
@Data
public class Idea73262Config {
    private String name = "idea_073262";
 ...
 */
@Slf4j
public class Idea73262Service {
    private static final int IDEA_ID = 73262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73262Service() {
        this(new Idea73262Config());
    }

    public Idea73262Service(Idea73262Config config) {
        this.config = config != null ? config : new Idea73262Config();
