...
@Data
public class Idea73282Config {
    private String name = "idea_073282";
 ...
 */
@Slf4j
public class Idea73282Service {
    private static final int IDEA_ID = 73282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73282Service() {
        this(new Idea73282Config());
    }

    public Idea73282Service(Idea73282Config config) {
        this.config = config != null ? config : new Idea73282Config();
