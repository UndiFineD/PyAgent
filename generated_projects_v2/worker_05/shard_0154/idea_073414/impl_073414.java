...
@Data
public class Idea73414Config {
    private String name = "idea_073414";
 ...
 */
@Slf4j
public class Idea73414Service {
    private static final int IDEA_ID = 73414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73414Service() {
        this(new Idea73414Config());
    }

    public Idea73414Service(Idea73414Config config) {
        this.config = config != null ? config : new Idea73414Config();
