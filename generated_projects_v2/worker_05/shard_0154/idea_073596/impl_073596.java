...
@Data
public class Idea73596Config {
    private String name = "idea_073596";
 ...
 */
@Slf4j
public class Idea73596Service {
    private static final int IDEA_ID = 73596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73596Service() {
        this(new Idea73596Config());
    }

    public Idea73596Service(Idea73596Config config) {
        this.config = config != null ? config : new Idea73596Config();
