...
@Data
public class Idea73418Config {
    private String name = "idea_073418";
 ...
 */
@Slf4j
public class Idea73418Service {
    private static final int IDEA_ID = 73418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73418Service() {
        this(new Idea73418Config());
    }

    public Idea73418Service(Idea73418Config config) {
        this.config = config != null ? config : new Idea73418Config();
