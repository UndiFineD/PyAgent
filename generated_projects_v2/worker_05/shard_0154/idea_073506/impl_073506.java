...
@Data
public class Idea73506Config {
    private String name = "idea_073506";
 ...
 */
@Slf4j
public class Idea73506Service {
    private static final int IDEA_ID = 73506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73506Service() {
        this(new Idea73506Config());
    }

    public Idea73506Service(Idea73506Config config) {
        this.config = config != null ? config : new Idea73506Config();
