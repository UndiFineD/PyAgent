...
@Data
public class Idea73329Config {
    private String name = "idea_073329";
 ...
 */
@Slf4j
public class Idea73329Service {
    private static final int IDEA_ID = 73329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73329Service() {
        this(new Idea73329Config());
    }

    public Idea73329Service(Idea73329Config config) {
        this.config = config != null ? config : new Idea73329Config();
