...
@Data
public class Idea73206Config {
    private String name = "idea_073206";
 ...
 */
@Slf4j
public class Idea73206Service {
    private static final int IDEA_ID = 73206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73206Service() {
        this(new Idea73206Config());
    }

    public Idea73206Service(Idea73206Config config) {
        this.config = config != null ? config : new Idea73206Config();
