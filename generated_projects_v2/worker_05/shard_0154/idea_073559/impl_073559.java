...
@Data
public class Idea73559Config {
    private String name = "idea_073559";
 ...
 */
@Slf4j
public class Idea73559Service {
    private static final int IDEA_ID = 73559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73559Service() {
        this(new Idea73559Config());
    }

    public Idea73559Service(Idea73559Config config) {
        this.config = config != null ? config : new Idea73559Config();
