...
@Data
public class Idea73335Config {
    private String name = "idea_073335";
 ...
 */
@Slf4j
public class Idea73335Service {
    private static final int IDEA_ID = 73335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73335Service() {
        this(new Idea73335Config());
    }

    public Idea73335Service(Idea73335Config config) {
        this.config = config != null ? config : new Idea73335Config();
