...
@Data
public class Idea73595Config {
    private String name = "idea_073595";
 ...
 */
@Slf4j
public class Idea73595Service {
    private static final int IDEA_ID = 73595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73595Service() {
        this(new Idea73595Config());
    }

    public Idea73595Service(Idea73595Config config) {
        this.config = config != null ? config : new Idea73595Config();
