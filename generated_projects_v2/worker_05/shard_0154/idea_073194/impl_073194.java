...
@Data
public class Idea73194Config {
    private String name = "idea_073194";
 ...
 */
@Slf4j
public class Idea73194Service {
    private static final int IDEA_ID = 73194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73194Service() {
        this(new Idea73194Config());
    }

    public Idea73194Service(Idea73194Config config) {
        this.config = config != null ? config : new Idea73194Config();
