...
@Data
public class Idea73289Config {
    private String name = "idea_073289";
 ...
 */
@Slf4j
public class Idea73289Service {
    private static final int IDEA_ID = 73289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73289Service() {
        this(new Idea73289Config());
    }

    public Idea73289Service(Idea73289Config config) {
        this.config = config != null ? config : new Idea73289Config();
