...
@Data
public class Idea73533Config {
    private String name = "idea_073533";
 ...
 */
@Slf4j
public class Idea73533Service {
    private static final int IDEA_ID = 73533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73533Service() {
        this(new Idea73533Config());
    }

    public Idea73533Service(Idea73533Config config) {
        this.config = config != null ? config : new Idea73533Config();
