...
@Data
public class Idea73224Config {
    private String name = "idea_073224";
 ...
 */
@Slf4j
public class Idea73224Service {
    private static final int IDEA_ID = 73224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73224Service() {
        this(new Idea73224Config());
    }

    public Idea73224Service(Idea73224Config config) {
        this.config = config != null ? config : new Idea73224Config();
