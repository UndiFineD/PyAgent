...
@Data
public class Idea73173Config {
    private String name = "idea_073173";
 ...
 */
@Slf4j
public class Idea73173Service {
    private static final int IDEA_ID = 73173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73173Service() {
        this(new Idea73173Config());
    }

    public Idea73173Service(Idea73173Config config) {
        this.config = config != null ? config : new Idea73173Config();
