...
@Data
public class Idea73582Config {
    private String name = "idea_073582";
 ...
 */
@Slf4j
public class Idea73582Service {
    private static final int IDEA_ID = 73582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73582Service() {
        this(new Idea73582Config());
    }

    public Idea73582Service(Idea73582Config config) {
        this.config = config != null ? config : new Idea73582Config();
