...
@Data
public class Idea73543Config {
    private String name = "idea_073543";
 ...
 */
@Slf4j
public class Idea73543Service {
    private static final int IDEA_ID = 73543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73543Service() {
        this(new Idea73543Config());
    }

    public Idea73543Service(Idea73543Config config) {
        this.config = config != null ? config : new Idea73543Config();
