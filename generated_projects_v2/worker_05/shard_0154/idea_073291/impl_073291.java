...
@Data
public class Idea73291Config {
    private String name = "idea_073291";
 ...
 */
@Slf4j
public class Idea73291Service {
    private static final int IDEA_ID = 73291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73291Service() {
        this(new Idea73291Config());
    }

    public Idea73291Service(Idea73291Config config) {
        this.config = config != null ? config : new Idea73291Config();
