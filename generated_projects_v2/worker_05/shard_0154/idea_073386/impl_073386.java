...
@Data
public class Idea73386Config {
    private String name = "idea_073386";
 ...
 */
@Slf4j
public class Idea73386Service {
    private static final int IDEA_ID = 73386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73386Service() {
        this(new Idea73386Config());
    }

    public Idea73386Service(Idea73386Config config) {
        this.config = config != null ? config : new Idea73386Config();
