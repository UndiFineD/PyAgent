...
@Data
public class Idea73510Config {
    private String name = "idea_073510";
 ...
 */
@Slf4j
public class Idea73510Service {
    private static final int IDEA_ID = 73510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73510Service() {
        this(new Idea73510Config());
    }

    public Idea73510Service(Idea73510Config config) {
        this.config = config != null ? config : new Idea73510Config();
