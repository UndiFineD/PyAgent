...
@Data
public class Idea73327Config {
    private String name = "idea_073327";
 ...
 */
@Slf4j
public class Idea73327Service {
    private static final int IDEA_ID = 73327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73327Service() {
        this(new Idea73327Config());
    }

    public Idea73327Service(Idea73327Config config) {
        this.config = config != null ? config : new Idea73327Config();
