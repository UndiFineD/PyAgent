...
@Data
public class Idea73527Config {
    private String name = "idea_073527";
 ...
 */
@Slf4j
public class Idea73527Service {
    private static final int IDEA_ID = 73527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73527Service() {
        this(new Idea73527Config());
    }

    public Idea73527Service(Idea73527Config config) {
        this.config = config != null ? config : new Idea73527Config();
