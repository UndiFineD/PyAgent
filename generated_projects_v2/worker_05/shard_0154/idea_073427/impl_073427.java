...
@Data
public class Idea73427Config {
    private String name = "idea_073427";
 ...
 */
@Slf4j
public class Idea73427Service {
    private static final int IDEA_ID = 73427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73427Service() {
        this(new Idea73427Config());
    }

    public Idea73427Service(Idea73427Config config) {
        this.config = config != null ? config : new Idea73427Config();
