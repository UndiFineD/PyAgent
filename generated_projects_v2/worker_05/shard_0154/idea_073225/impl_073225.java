...
@Data
public class Idea73225Config {
    private String name = "idea_073225";
 ...
 */
@Slf4j
public class Idea73225Service {
    private static final int IDEA_ID = 73225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73225Service() {
        this(new Idea73225Config());
    }

    public Idea73225Service(Idea73225Config config) {
        this.config = config != null ? config : new Idea73225Config();
