...
@Data
public class Idea73365Config {
    private String name = "idea_073365";
 ...
 */
@Slf4j
public class Idea73365Service {
    private static final int IDEA_ID = 73365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73365Service() {
        this(new Idea73365Config());
    }

    public Idea73365Service(Idea73365Config config) {
        this.config = config != null ? config : new Idea73365Config();
