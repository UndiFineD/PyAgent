...
@Data
public class Idea73334Config {
    private String name = "idea_073334";
 ...
 */
@Slf4j
public class Idea73334Service {
    private static final int IDEA_ID = 73334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73334Service() {
        this(new Idea73334Config());
    }

    public Idea73334Service(Idea73334Config config) {
        this.config = config != null ? config : new Idea73334Config();
