...
@Data
public class Idea73498Config {
    private String name = "idea_073498";
 ...
 */
@Slf4j
public class Idea73498Service {
    private static final int IDEA_ID = 73498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73498Service() {
        this(new Idea73498Config());
    }

    public Idea73498Service(Idea73498Config config) {
        this.config = config != null ? config : new Idea73498Config();
