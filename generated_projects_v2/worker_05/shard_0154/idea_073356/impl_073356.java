...
@Data
public class Idea73356Config {
    private String name = "idea_073356";
 ...
 */
@Slf4j
public class Idea73356Service {
    private static final int IDEA_ID = 73356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73356Service() {
        this(new Idea73356Config());
    }

    public Idea73356Service(Idea73356Config config) {
        this.config = config != null ? config : new Idea73356Config();
