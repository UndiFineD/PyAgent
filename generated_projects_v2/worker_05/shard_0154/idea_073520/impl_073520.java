...
@Data
public class Idea73520Config {
    private String name = "idea_073520";
 ...
 */
@Slf4j
public class Idea73520Service {
    private static final int IDEA_ID = 73520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73520Service() {
        this(new Idea73520Config());
    }

    public Idea73520Service(Idea73520Config config) {
        this.config = config != null ? config : new Idea73520Config();
