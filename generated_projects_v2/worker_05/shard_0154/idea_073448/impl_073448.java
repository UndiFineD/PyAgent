...
@Data
public class Idea73448Config {
    private String name = "idea_073448";
 ...
 */
@Slf4j
public class Idea73448Service {
    private static final int IDEA_ID = 73448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73448Service() {
        this(new Idea73448Config());
    }

    public Idea73448Service(Idea73448Config config) {
        this.config = config != null ? config : new Idea73448Config();
