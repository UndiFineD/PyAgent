...
@Data
public class Idea73528Config {
    private String name = "idea_073528";
 ...
 */
@Slf4j
public class Idea73528Service {
    private static final int IDEA_ID = 73528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73528Service() {
        this(new Idea73528Config());
    }

    public Idea73528Service(Idea73528Config config) {
        this.config = config != null ? config : new Idea73528Config();
