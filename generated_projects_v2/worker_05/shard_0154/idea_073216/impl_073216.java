...
@Data
public class Idea73216Config {
    private String name = "idea_073216";
 ...
 */
@Slf4j
public class Idea73216Service {
    private static final int IDEA_ID = 73216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73216Service() {
        this(new Idea73216Config());
    }

    public Idea73216Service(Idea73216Config config) {
        this.config = config != null ? config : new Idea73216Config();
