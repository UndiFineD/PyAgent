...
@Data
public class Idea73622Config {
    private String name = "idea_073622";
 ...
 */
@Slf4j
public class Idea73622Service {
    private static final int IDEA_ID = 73622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73622Service() {
        this(new Idea73622Config());
    }

    public Idea73622Service(Idea73622Config config) {
        this.config = config != null ? config : new Idea73622Config();
