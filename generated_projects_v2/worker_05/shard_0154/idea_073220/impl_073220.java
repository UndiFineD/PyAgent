...
@Data
public class Idea73220Config {
    private String name = "idea_073220";
 ...
 */
@Slf4j
public class Idea73220Service {
    private static final int IDEA_ID = 73220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73220Service() {
        this(new Idea73220Config());
    }

    public Idea73220Service(Idea73220Config config) {
        this.config = config != null ? config : new Idea73220Config();
