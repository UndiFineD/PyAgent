...
@Data
public class Idea73223Config {
    private String name = "idea_073223";
 ...
 */
@Slf4j
public class Idea73223Service {
    private static final int IDEA_ID = 73223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73223Service() {
        this(new Idea73223Config());
    }

    public Idea73223Service(Idea73223Config config) {
        this.config = config != null ? config : new Idea73223Config();
