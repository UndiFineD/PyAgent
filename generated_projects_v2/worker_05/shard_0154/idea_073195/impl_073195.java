...
@Data
public class Idea73195Config {
    private String name = "idea_073195";
 ...
 */
@Slf4j
public class Idea73195Service {
    private static final int IDEA_ID = 73195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73195Service() {
        this(new Idea73195Config());
    }

    public Idea73195Service(Idea73195Config config) {
        this.config = config != null ? config : new Idea73195Config();
