...
@Data
public class Idea73480Config {
    private String name = "idea_073480";
 ...
 */
@Slf4j
public class Idea73480Service {
    private static final int IDEA_ID = 73480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73480Service() {
        this(new Idea73480Config());
    }

    public Idea73480Service(Idea73480Config config) {
        this.config = config != null ? config : new Idea73480Config();
