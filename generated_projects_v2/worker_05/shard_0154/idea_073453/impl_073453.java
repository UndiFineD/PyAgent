...
@Data
public class Idea73453Config {
    private String name = "idea_073453";
 ...
 */
@Slf4j
public class Idea73453Service {
    private static final int IDEA_ID = 73453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73453Service() {
        this(new Idea73453Config());
    }

    public Idea73453Service(Idea73453Config config) {
        this.config = config != null ? config : new Idea73453Config();
