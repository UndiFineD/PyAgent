...
@Data
public class Idea73233Config {
    private String name = "idea_073233";
 ...
 */
@Slf4j
public class Idea73233Service {
    private static final int IDEA_ID = 73233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73233Service() {
        this(new Idea73233Config());
    }

    public Idea73233Service(Idea73233Config config) {
        this.config = config != null ? config : new Idea73233Config();
