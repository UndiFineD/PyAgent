...
@Data
public class Idea73406Config {
    private String name = "idea_073406";
 ...
 */
@Slf4j
public class Idea73406Service {
    private static final int IDEA_ID = 73406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73406Service() {
        this(new Idea73406Config());
    }

    public Idea73406Service(Idea73406Config config) {
        this.config = config != null ? config : new Idea73406Config();
