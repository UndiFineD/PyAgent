...
@Data
public class Idea73373Config {
    private String name = "idea_073373";
 ...
 */
@Slf4j
public class Idea73373Service {
    private static final int IDEA_ID = 73373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73373Service() {
        this(new Idea73373Config());
    }

    public Idea73373Service(Idea73373Config config) {
        this.config = config != null ? config : new Idea73373Config();
