...
@Data
public class Idea73290Config {
    private String name = "idea_073290";
 ...
 */
@Slf4j
public class Idea73290Service {
    private static final int IDEA_ID = 73290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73290Service() {
        this(new Idea73290Config());
    }

    public Idea73290Service(Idea73290Config config) {
        this.config = config != null ? config : new Idea73290Config();
