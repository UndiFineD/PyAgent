...
@Data
public class Idea73336Config {
    private String name = "idea_073336";
 ...
 */
@Slf4j
public class Idea73336Service {
    private static final int IDEA_ID = 73336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73336Service() {
        this(new Idea73336Config());
    }

    public Idea73336Service(Idea73336Config config) {
        this.config = config != null ? config : new Idea73336Config();
