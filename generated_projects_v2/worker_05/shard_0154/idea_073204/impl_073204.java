...
@Data
public class Idea73204Config {
    private String name = "idea_073204";
 ...
 */
@Slf4j
public class Idea73204Service {
    private static final int IDEA_ID = 73204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73204Service() {
        this(new Idea73204Config());
    }

    public Idea73204Service(Idea73204Config config) {
        this.config = config != null ? config : new Idea73204Config();
