...
@Data
public class Idea73237Config {
    private String name = "idea_073237";
 ...
 */
@Slf4j
public class Idea73237Service {
    private static final int IDEA_ID = 73237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73237Service() {
        this(new Idea73237Config());
    }

    public Idea73237Service(Idea73237Config config) {
        this.config = config != null ? config : new Idea73237Config();
