...
@Data
public class Idea73351Config {
    private String name = "idea_073351";
 ...
 */
@Slf4j
public class Idea73351Service {
    private static final int IDEA_ID = 73351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73351Service() {
        this(new Idea73351Config());
    }

    public Idea73351Service(Idea73351Config config) {
        this.config = config != null ? config : new Idea73351Config();
