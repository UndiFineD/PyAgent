...
@Data
public class Idea73465Config {
    private String name = "idea_073465";
 ...
 */
@Slf4j
public class Idea73465Service {
    private static final int IDEA_ID = 73465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73465Service() {
        this(new Idea73465Config());
    }

    public Idea73465Service(Idea73465Config config) {
        this.config = config != null ? config : new Idea73465Config();
