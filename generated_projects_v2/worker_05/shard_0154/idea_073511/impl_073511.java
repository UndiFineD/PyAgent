...
@Data
public class Idea73511Config {
    private String name = "idea_073511";
 ...
 */
@Slf4j
public class Idea73511Service {
    private static final int IDEA_ID = 73511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73511Service() {
        this(new Idea73511Config());
    }

    public Idea73511Service(Idea73511Config config) {
        this.config = config != null ? config : new Idea73511Config();
