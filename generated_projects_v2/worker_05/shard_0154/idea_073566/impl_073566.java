...
@Data
public class Idea73566Config {
    private String name = "idea_073566";
 ...
 */
@Slf4j
public class Idea73566Service {
    private static final int IDEA_ID = 73566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73566Service() {
        this(new Idea73566Config());
    }

    public Idea73566Service(Idea73566Config config) {
        this.config = config != null ? config : new Idea73566Config();
