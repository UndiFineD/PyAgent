...
@Data
public class Idea73380Config {
    private String name = "idea_073380";
 ...
 */
@Slf4j
public class Idea73380Service {
    private static final int IDEA_ID = 73380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73380Service() {
        this(new Idea73380Config());
    }

    public Idea73380Service(Idea73380Config config) {
        this.config = config != null ? config : new Idea73380Config();
