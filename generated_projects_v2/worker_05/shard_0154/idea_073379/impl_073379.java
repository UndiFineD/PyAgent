...
@Data
public class Idea73379Config {
    private String name = "idea_073379";
 ...
 */
@Slf4j
public class Idea73379Service {
    private static final int IDEA_ID = 73379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73379Service() {
        this(new Idea73379Config());
    }

    public Idea73379Service(Idea73379Config config) {
        this.config = config != null ? config : new Idea73379Config();
