...
@Data
public class Idea73516Config {
    private String name = "idea_073516";
 ...
 */
@Slf4j
public class Idea73516Service {
    private static final int IDEA_ID = 73516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73516Service() {
        this(new Idea73516Config());
    }

    public Idea73516Service(Idea73516Config config) {
        this.config = config != null ? config : new Idea73516Config();
