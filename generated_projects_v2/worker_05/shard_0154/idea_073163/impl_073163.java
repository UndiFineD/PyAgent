...
@Data
public class Idea73163Config {
    private String name = "idea_073163";
 ...
 */
@Slf4j
public class Idea73163Service {
    private static final int IDEA_ID = 73163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73163Service() {
        this(new Idea73163Config());
    }

    public Idea73163Service(Idea73163Config config) {
        this.config = config != null ? config : new Idea73163Config();
