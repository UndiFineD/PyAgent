...
@Data
public class Idea73555Config {
    private String name = "idea_073555";
 ...
 */
@Slf4j
public class Idea73555Service {
    private static final int IDEA_ID = 73555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73555Service() {
        this(new Idea73555Config());
    }

    public Idea73555Service(Idea73555Config config) {
        this.config = config != null ? config : new Idea73555Config();
