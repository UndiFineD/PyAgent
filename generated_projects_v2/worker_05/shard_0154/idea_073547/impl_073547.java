...
@Data
public class Idea73547Config {
    private String name = "idea_073547";
 ...
 */
@Slf4j
public class Idea73547Service {
    private static final int IDEA_ID = 73547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73547Service() {
        this(new Idea73547Config());
    }

    public Idea73547Service(Idea73547Config config) {
        this.config = config != null ? config : new Idea73547Config();
