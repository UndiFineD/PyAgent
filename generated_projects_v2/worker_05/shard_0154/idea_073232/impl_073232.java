...
@Data
public class Idea73232Config {
    private String name = "idea_073232";
 ...
 */
@Slf4j
public class Idea73232Service {
    private static final int IDEA_ID = 73232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73232Service() {
        this(new Idea73232Config());
    }

    public Idea73232Service(Idea73232Config config) {
        this.config = config != null ? config : new Idea73232Config();
