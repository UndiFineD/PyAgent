...
@Data
public class Idea73599Config {
    private String name = "idea_073599";
 ...
 */
@Slf4j
public class Idea73599Service {
    private static final int IDEA_ID = 73599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73599Service() {
        this(new Idea73599Config());
    }

    public Idea73599Service(Idea73599Config config) {
        this.config = config != null ? config : new Idea73599Config();
