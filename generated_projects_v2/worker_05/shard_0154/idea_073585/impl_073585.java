...
@Data
public class Idea73585Config {
    private String name = "idea_073585";
 ...
 */
@Slf4j
public class Idea73585Service {
    private static final int IDEA_ID = 73585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73585Service() {
        this(new Idea73585Config());
    }

    public Idea73585Service(Idea73585Config config) {
        this.config = config != null ? config : new Idea73585Config();
