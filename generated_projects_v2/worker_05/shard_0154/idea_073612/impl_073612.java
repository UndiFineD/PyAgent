...
@Data
public class Idea73612Config {
    private String name = "idea_073612";
 ...
 */
@Slf4j
public class Idea73612Service {
    private static final int IDEA_ID = 73612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73612Service() {
        this(new Idea73612Config());
    }

    public Idea73612Service(Idea73612Config config) {
        this.config = config != null ? config : new Idea73612Config();
