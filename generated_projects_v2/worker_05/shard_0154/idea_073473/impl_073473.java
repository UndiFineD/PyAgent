...
@Data
public class Idea73473Config {
    private String name = "idea_073473";
 ...
 */
@Slf4j
public class Idea73473Service {
    private static final int IDEA_ID = 73473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73473Service() {
        this(new Idea73473Config());
    }

    public Idea73473Service(Idea73473Config config) {
        this.config = config != null ? config : new Idea73473Config();
