...
@Data
public class Idea73517Config {
    private String name = "idea_073517";
 ...
 */
@Slf4j
public class Idea73517Service {
    private static final int IDEA_ID = 73517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73517Service() {
        this(new Idea73517Config());
    }

    public Idea73517Service(Idea73517Config config) {
        this.config = config != null ? config : new Idea73517Config();
