...
@Data
public class Idea73594Config {
    private String name = "idea_073594";
 ...
 */
@Slf4j
public class Idea73594Service {
    private static final int IDEA_ID = 73594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73594Service() {
        this(new Idea73594Config());
    }

    public Idea73594Service(Idea73594Config config) {
        this.config = config != null ? config : new Idea73594Config();
