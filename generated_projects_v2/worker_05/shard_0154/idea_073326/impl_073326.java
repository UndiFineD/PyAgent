...
@Data
public class Idea73326Config {
    private String name = "idea_073326";
 ...
 */
@Slf4j
public class Idea73326Service {
    private static final int IDEA_ID = 73326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73326Service() {
        this(new Idea73326Config());
    }

    public Idea73326Service(Idea73326Config config) {
        this.config = config != null ? config : new Idea73326Config();
