...
@Data
public class Idea73300Config {
    private String name = "idea_073300";
 ...
 */
@Slf4j
public class Idea73300Service {
    private static final int IDEA_ID = 73300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73300Service() {
        this(new Idea73300Config());
    }

    public Idea73300Service(Idea73300Config config) {
        this.config = config != null ? config : new Idea73300Config();
