...
@Data
public class Idea73323Config {
    private String name = "idea_073323";
 ...
 */
@Slf4j
public class Idea73323Service {
    private static final int IDEA_ID = 73323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73323Service() {
        this(new Idea73323Config());
    }

    public Idea73323Service(Idea73323Config config) {
        this.config = config != null ? config : new Idea73323Config();
