...
@Data
public class Idea73565Config {
    private String name = "idea_073565";
 ...
 */
@Slf4j
public class Idea73565Service {
    private static final int IDEA_ID = 73565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73565Service() {
        this(new Idea73565Config());
    }

    public Idea73565Service(Idea73565Config config) {
        this.config = config != null ? config : new Idea73565Config();
