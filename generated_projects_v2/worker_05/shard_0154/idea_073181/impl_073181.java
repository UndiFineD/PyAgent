...
@Data
public class Idea73181Config {
    private String name = "idea_073181";
 ...
 */
@Slf4j
public class Idea73181Service {
    private static final int IDEA_ID = 73181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73181Service() {
        this(new Idea73181Config());
    }

    public Idea73181Service(Idea73181Config config) {
        this.config = config != null ? config : new Idea73181Config();
