...
@Data
public class Idea73337Config {
    private String name = "idea_073337";
 ...
 */
@Slf4j
public class Idea73337Service {
    private static final int IDEA_ID = 73337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73337Service() {
        this(new Idea73337Config());
    }

    public Idea73337Service(Idea73337Config config) {
        this.config = config != null ? config : new Idea73337Config();
