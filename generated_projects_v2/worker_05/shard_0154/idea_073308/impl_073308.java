...
@Data
public class Idea73308Config {
    private String name = "idea_073308";
 ...
 */
@Slf4j
public class Idea73308Service {
    private static final int IDEA_ID = 73308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73308Service() {
        this(new Idea73308Config());
    }

    public Idea73308Service(Idea73308Config config) {
        this.config = config != null ? config : new Idea73308Config();
