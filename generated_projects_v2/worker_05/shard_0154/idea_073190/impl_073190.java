...
@Data
public class Idea73190Config {
    private String name = "idea_073190";
 ...
 */
@Slf4j
public class Idea73190Service {
    private static final int IDEA_ID = 73190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73190Service() {
        this(new Idea73190Config());
    }

    public Idea73190Service(Idea73190Config config) {
        this.config = config != null ? config : new Idea73190Config();
