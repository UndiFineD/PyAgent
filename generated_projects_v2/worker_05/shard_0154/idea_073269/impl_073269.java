...
@Data
public class Idea73269Config {
    private String name = "idea_073269";
 ...
 */
@Slf4j
public class Idea73269Service {
    private static final int IDEA_ID = 73269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73269Service() {
        this(new Idea73269Config());
    }

    public Idea73269Service(Idea73269Config config) {
        this.config = config != null ? config : new Idea73269Config();
