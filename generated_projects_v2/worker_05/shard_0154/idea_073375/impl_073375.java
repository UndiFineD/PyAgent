...
@Data
public class Idea73375Config {
    private String name = "idea_073375";
 ...
 */
@Slf4j
public class Idea73375Service {
    private static final int IDEA_ID = 73375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73375Service() {
        this(new Idea73375Config());
    }

    public Idea73375Service(Idea73375Config config) {
        this.config = config != null ? config : new Idea73375Config();
