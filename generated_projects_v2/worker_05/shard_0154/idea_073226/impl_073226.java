...
@Data
public class Idea73226Config {
    private String name = "idea_073226";
 ...
 */
@Slf4j
public class Idea73226Service {
    private static final int IDEA_ID = 73226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73226Service() {
        this(new Idea73226Config());
    }

    public Idea73226Service(Idea73226Config config) {
        this.config = config != null ? config : new Idea73226Config();
