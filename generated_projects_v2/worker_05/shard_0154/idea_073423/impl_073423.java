...
@Data
public class Idea73423Config {
    private String name = "idea_073423";
 ...
 */
@Slf4j
public class Idea73423Service {
    private static final int IDEA_ID = 73423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73423Service() {
        this(new Idea73423Config());
    }

    public Idea73423Service(Idea73423Config config) {
        this.config = config != null ? config : new Idea73423Config();
