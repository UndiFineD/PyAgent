...
@Data
public class Idea73535Config {
    private String name = "idea_073535";
 ...
 */
@Slf4j
public class Idea73535Service {
    private static final int IDEA_ID = 73535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73535Service() {
        this(new Idea73535Config());
    }

    public Idea73535Service(Idea73535Config config) {
        this.config = config != null ? config : new Idea73535Config();
