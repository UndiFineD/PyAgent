...
@Data
public class Idea73410Config {
    private String name = "idea_073410";
 ...
 */
@Slf4j
public class Idea73410Service {
    private static final int IDEA_ID = 73410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73410Service() {
        this(new Idea73410Config());
    }

    public Idea73410Service(Idea73410Config config) {
        this.config = config != null ? config : new Idea73410Config();
