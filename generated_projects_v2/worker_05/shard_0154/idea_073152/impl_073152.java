...
@Data
public class Idea73152Config {
    private String name = "idea_073152";
 ...
 */
@Slf4j
public class Idea73152Service {
    private static final int IDEA_ID = 73152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73152Service() {
        this(new Idea73152Config());
    }

    public Idea73152Service(Idea73152Config config) {
        this.config = config != null ? config : new Idea73152Config();
