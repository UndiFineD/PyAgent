...
@Data
public class Idea73568Config {
    private String name = "idea_073568";
 ...
 */
@Slf4j
public class Idea73568Service {
    private static final int IDEA_ID = 73568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73568Service() {
        this(new Idea73568Config());
    }

    public Idea73568Service(Idea73568Config config) {
        this.config = config != null ? config : new Idea73568Config();
