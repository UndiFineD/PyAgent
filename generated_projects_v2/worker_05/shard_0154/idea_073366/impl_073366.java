...
@Data
public class Idea73366Config {
    private String name = "idea_073366";
 ...
 */
@Slf4j
public class Idea73366Service {
    private static final int IDEA_ID = 73366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73366Service() {
        this(new Idea73366Config());
    }

    public Idea73366Service(Idea73366Config config) {
        this.config = config != null ? config : new Idea73366Config();
