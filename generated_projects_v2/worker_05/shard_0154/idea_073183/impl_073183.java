...
@Data
public class Idea73183Config {
    private String name = "idea_073183";
 ...
 */
@Slf4j
public class Idea73183Service {
    private static final int IDEA_ID = 73183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73183Service() {
        this(new Idea73183Config());
    }

    public Idea73183Service(Idea73183Config config) {
        this.config = config != null ? config : new Idea73183Config();
