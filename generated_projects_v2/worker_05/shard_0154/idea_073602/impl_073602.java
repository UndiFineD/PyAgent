...
@Data
public class Idea73602Config {
    private String name = "idea_073602";
 ...
 */
@Slf4j
public class Idea73602Service {
    private static final int IDEA_ID = 73602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73602Service() {
        this(new Idea73602Config());
    }

    public Idea73602Service(Idea73602Config config) {
        this.config = config != null ? config : new Idea73602Config();
