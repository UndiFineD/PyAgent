...
@Data
public class Idea73463Config {
    private String name = "idea_073463";
 ...
 */
@Slf4j
public class Idea73463Service {
    private static final int IDEA_ID = 73463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73463Service() {
        this(new Idea73463Config());
    }

    public Idea73463Service(Idea73463Config config) {
        this.config = config != null ? config : new Idea73463Config();
