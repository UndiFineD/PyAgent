...
@Data
public class Idea73296Config {
    private String name = "idea_073296";
 ...
 */
@Slf4j
public class Idea73296Service {
    private static final int IDEA_ID = 73296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73296Service() {
        this(new Idea73296Config());
    }

    public Idea73296Service(Idea73296Config config) {
        this.config = config != null ? config : new Idea73296Config();
