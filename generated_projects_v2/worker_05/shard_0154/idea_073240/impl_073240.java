...
@Data
public class Idea73240Config {
    private String name = "idea_073240";
 ...
 */
@Slf4j
public class Idea73240Service {
    private static final int IDEA_ID = 73240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73240Service() {
        this(new Idea73240Config());
    }

    public Idea73240Service(Idea73240Config config) {
        this.config = config != null ? config : new Idea73240Config();
