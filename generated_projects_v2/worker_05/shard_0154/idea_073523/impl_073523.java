...
@Data
public class Idea73523Config {
    private String name = "idea_073523";
 ...
 */
@Slf4j
public class Idea73523Service {
    private static final int IDEA_ID = 73523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73523Service() {
        this(new Idea73523Config());
    }

    public Idea73523Service(Idea73523Config config) {
        this.config = config != null ? config : new Idea73523Config();
