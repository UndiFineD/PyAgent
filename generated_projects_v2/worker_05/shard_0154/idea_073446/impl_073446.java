...
@Data
public class Idea73446Config {
    private String name = "idea_073446";
 ...
 */
@Slf4j
public class Idea73446Service {
    private static final int IDEA_ID = 73446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73446Service() {
        this(new Idea73446Config());
    }

    public Idea73446Service(Idea73446Config config) {
        this.config = config != null ? config : new Idea73446Config();
