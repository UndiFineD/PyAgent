...
@Data
public class Idea73605Config {
    private String name = "idea_073605";
 ...
 */
@Slf4j
public class Idea73605Service {
    private static final int IDEA_ID = 73605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73605Service() {
        this(new Idea73605Config());
    }

    public Idea73605Service(Idea73605Config config) {
        this.config = config != null ? config : new Idea73605Config();
