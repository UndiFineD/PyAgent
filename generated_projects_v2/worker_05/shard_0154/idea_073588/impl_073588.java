...
@Data
public class Idea73588Config {
    private String name = "idea_073588";
 ...
 */
@Slf4j
public class Idea73588Service {
    private static final int IDEA_ID = 73588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73588Service() {
        this(new Idea73588Config());
    }

    public Idea73588Service(Idea73588Config config) {
        this.config = config != null ? config : new Idea73588Config();
