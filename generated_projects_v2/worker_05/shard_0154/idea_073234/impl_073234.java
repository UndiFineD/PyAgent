...
@Data
public class Idea73234Config {
    private String name = "idea_073234";
 ...
 */
@Slf4j
public class Idea73234Service {
    private static final int IDEA_ID = 73234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73234Service() {
        this(new Idea73234Config());
    }

    public Idea73234Service(Idea73234Config config) {
        this.config = config != null ? config : new Idea73234Config();
