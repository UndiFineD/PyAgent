...
@Data
public class Idea73259Config {
    private String name = "idea_073259";
 ...
 */
@Slf4j
public class Idea73259Service {
    private static final int IDEA_ID = 73259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73259Service() {
        this(new Idea73259Config());
    }

    public Idea73259Service(Idea73259Config config) {
        this.config = config != null ? config : new Idea73259Config();
