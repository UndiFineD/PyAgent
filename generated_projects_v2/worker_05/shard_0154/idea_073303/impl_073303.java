...
@Data
public class Idea73303Config {
    private String name = "idea_073303";
 ...
 */
@Slf4j
public class Idea73303Service {
    private static final int IDEA_ID = 73303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73303Service() {
        this(new Idea73303Config());
    }

    public Idea73303Service(Idea73303Config config) {
        this.config = config != null ? config : new Idea73303Config();
