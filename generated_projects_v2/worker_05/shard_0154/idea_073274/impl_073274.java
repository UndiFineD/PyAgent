...
@Data
public class Idea73274Config {
    private String name = "idea_073274";
 ...
 */
@Slf4j
public class Idea73274Service {
    private static final int IDEA_ID = 73274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73274Service() {
        this(new Idea73274Config());
    }

    public Idea73274Service(Idea73274Config config) {
        this.config = config != null ? config : new Idea73274Config();
