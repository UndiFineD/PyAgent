...
@Data
public class Idea73215Config {
    private String name = "idea_073215";
 ...
 */
@Slf4j
public class Idea73215Service {
    private static final int IDEA_ID = 73215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73215Service() {
        this(new Idea73215Config());
    }

    public Idea73215Service(Idea73215Config config) {
        this.config = config != null ? config : new Idea73215Config();
