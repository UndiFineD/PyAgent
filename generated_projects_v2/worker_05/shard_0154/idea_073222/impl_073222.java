...
@Data
public class Idea73222Config {
    private String name = "idea_073222";
 ...
 */
@Slf4j
public class Idea73222Service {
    private static final int IDEA_ID = 73222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73222Service() {
        this(new Idea73222Config());
    }

    public Idea73222Service(Idea73222Config config) {
        this.config = config != null ? config : new Idea73222Config();
