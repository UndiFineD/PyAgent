...
@Data
public class Idea73200Config {
    private String name = "idea_073200";
 ...
 */
@Slf4j
public class Idea73200Service {
    private static final int IDEA_ID = 73200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73200Service() {
        this(new Idea73200Config());
    }

    public Idea73200Service(Idea73200Config config) {
        this.config = config != null ? config : new Idea73200Config();
