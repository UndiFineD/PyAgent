...
@Data
public class Idea73443Config {
    private String name = "idea_073443";
 ...
 */
@Slf4j
public class Idea73443Service {
    private static final int IDEA_ID = 73443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73443Service() {
        this(new Idea73443Config());
    }

    public Idea73443Service(Idea73443Config config) {
        this.config = config != null ? config : new Idea73443Config();
