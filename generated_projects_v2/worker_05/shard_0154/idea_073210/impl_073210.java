...
@Data
public class Idea73210Config {
    private String name = "idea_073210";
 ...
 */
@Slf4j
public class Idea73210Service {
    private static final int IDEA_ID = 73210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73210Service() {
        this(new Idea73210Config());
    }

    public Idea73210Service(Idea73210Config config) {
        this.config = config != null ? config : new Idea73210Config();
