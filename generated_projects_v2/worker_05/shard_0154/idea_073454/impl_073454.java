...
@Data
public class Idea73454Config {
    private String name = "idea_073454";
 ...
 */
@Slf4j
public class Idea73454Service {
    private static final int IDEA_ID = 73454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73454Service() {
        this(new Idea73454Config());
    }

    public Idea73454Service(Idea73454Config config) {
        this.config = config != null ? config : new Idea73454Config();
