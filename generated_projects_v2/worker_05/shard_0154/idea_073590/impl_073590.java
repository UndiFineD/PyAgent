...
@Data
public class Idea73590Config {
    private String name = "idea_073590";
 ...
 */
@Slf4j
public class Idea73590Service {
    private static final int IDEA_ID = 73590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73590Service() {
        this(new Idea73590Config());
    }

    public Idea73590Service(Idea73590Config config) {
        this.config = config != null ? config : new Idea73590Config();
