...
@Data
public class Idea73286Config {
    private String name = "idea_073286";
 ...
 */
@Slf4j
public class Idea73286Service {
    private static final int IDEA_ID = 73286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73286Service() {
        this(new Idea73286Config());
    }

    public Idea73286Service(Idea73286Config config) {
        this.config = config != null ? config : new Idea73286Config();
