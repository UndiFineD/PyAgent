...
@Data
public class Idea73392Config {
    private String name = "idea_073392";
 ...
 */
@Slf4j
public class Idea73392Service {
    private static final int IDEA_ID = 73392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73392Service() {
        this(new Idea73392Config());
    }

    public Idea73392Service(Idea73392Config config) {
        this.config = config != null ? config : new Idea73392Config();
