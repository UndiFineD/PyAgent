...
@Data
public class Idea73320Config {
    private String name = "idea_073320";
 ...
 */
@Slf4j
public class Idea73320Service {
    private static final int IDEA_ID = 73320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73320Service() {
        this(new Idea73320Config());
    }

    public Idea73320Service(Idea73320Config config) {
        this.config = config != null ? config : new Idea73320Config();
