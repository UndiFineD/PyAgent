...
@Data
public class Idea73305Config {
    private String name = "idea_073305";
 ...
 */
@Slf4j
public class Idea73305Service {
    private static final int IDEA_ID = 73305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73305Service() {
        this(new Idea73305Config());
    }

    public Idea73305Service(Idea73305Config config) {
        this.config = config != null ? config : new Idea73305Config();
