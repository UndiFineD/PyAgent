...
@Data
public class Idea73352Config {
    private String name = "idea_073352";
 ...
 */
@Slf4j
public class Idea73352Service {
    private static final int IDEA_ID = 73352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73352Service() {
        this(new Idea73352Config());
    }

    public Idea73352Service(Idea73352Config config) {
        this.config = config != null ? config : new Idea73352Config();
