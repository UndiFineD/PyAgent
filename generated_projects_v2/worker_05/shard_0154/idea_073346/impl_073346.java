...
@Data
public class Idea73346Config {
    private String name = "idea_073346";
 ...
 */
@Slf4j
public class Idea73346Service {
    private static final int IDEA_ID = 73346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73346Service() {
        this(new Idea73346Config());
    }

    public Idea73346Service(Idea73346Config config) {
        this.config = config != null ? config : new Idea73346Config();
