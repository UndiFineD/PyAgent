...
@Data
public class Idea73176Config {
    private String name = "idea_073176";
 ...
 */
@Slf4j
public class Idea73176Service {
    private static final int IDEA_ID = 73176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73176Service() {
        this(new Idea73176Config());
    }

    public Idea73176Service(Idea73176Config config) {
        this.config = config != null ? config : new Idea73176Config();
