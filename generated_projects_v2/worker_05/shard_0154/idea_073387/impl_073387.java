...
@Data
public class Idea73387Config {
    private String name = "idea_073387";
 ...
 */
@Slf4j
public class Idea73387Service {
    private static final int IDEA_ID = 73387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73387Service() {
        this(new Idea73387Config());
    }

    public Idea73387Service(Idea73387Config config) {
        this.config = config != null ? config : new Idea73387Config();
