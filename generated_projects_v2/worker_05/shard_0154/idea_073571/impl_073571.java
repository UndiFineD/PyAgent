...
@Data
public class Idea73571Config {
    private String name = "idea_073571";
 ...
 */
@Slf4j
public class Idea73571Service {
    private static final int IDEA_ID = 73571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73571Service() {
        this(new Idea73571Config());
    }

    public Idea73571Service(Idea73571Config config) {
        this.config = config != null ? config : new Idea73571Config();
