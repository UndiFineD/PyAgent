...
@Data
public class Idea73593Config {
    private String name = "idea_073593";
 ...
 */
@Slf4j
public class Idea73593Service {
    private static final int IDEA_ID = 73593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73593Service() {
        this(new Idea73593Config());
    }

    public Idea73593Service(Idea73593Config config) {
        this.config = config != null ? config : new Idea73593Config();
