...
@Data
public class Idea73525Config {
    private String name = "idea_073525";
 ...
 */
@Slf4j
public class Idea73525Service {
    private static final int IDEA_ID = 73525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73525Service() {
        this(new Idea73525Config());
    }

    public Idea73525Service(Idea73525Config config) {
        this.config = config != null ? config : new Idea73525Config();
