...
@Data
public class Idea73563Config {
    private String name = "idea_073563";
 ...
 */
@Slf4j
public class Idea73563Service {
    private static final int IDEA_ID = 73563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73563Service() {
        this(new Idea73563Config());
    }

    public Idea73563Service(Idea73563Config config) {
        this.config = config != null ? config : new Idea73563Config();
