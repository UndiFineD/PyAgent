...
@Data
public class Idea73614Config {
    private String name = "idea_073614";
 ...
 */
@Slf4j
public class Idea73614Service {
    private static final int IDEA_ID = 73614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73614Service() {
        this(new Idea73614Config());
    }

    public Idea73614Service(Idea73614Config config) {
        this.config = config != null ? config : new Idea73614Config();
