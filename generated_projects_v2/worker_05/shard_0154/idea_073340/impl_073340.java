...
@Data
public class Idea73340Config {
    private String name = "idea_073340";
 ...
 */
@Slf4j
public class Idea73340Service {
    private static final int IDEA_ID = 73340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73340Service() {
        this(new Idea73340Config());
    }

    public Idea73340Service(Idea73340Config config) {
        this.config = config != null ? config : new Idea73340Config();
