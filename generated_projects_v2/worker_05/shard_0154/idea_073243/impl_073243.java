...
@Data
public class Idea73243Config {
    private String name = "idea_073243";
 ...
 */
@Slf4j
public class Idea73243Service {
    private static final int IDEA_ID = 73243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73243Service() {
        this(new Idea73243Config());
    }

    public Idea73243Service(Idea73243Config config) {
        this.config = config != null ? config : new Idea73243Config();
