...
@Data
public class Idea73497Config {
    private String name = "idea_073497";
 ...
 */
@Slf4j
public class Idea73497Service {
    private static final int IDEA_ID = 73497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73497Service() {
        this(new Idea73497Config());
    }

    public Idea73497Service(Idea73497Config config) {
        this.config = config != null ? config : new Idea73497Config();
