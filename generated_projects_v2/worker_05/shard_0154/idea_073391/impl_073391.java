...
@Data
public class Idea73391Config {
    private String name = "idea_073391";
 ...
 */
@Slf4j
public class Idea73391Service {
    private static final int IDEA_ID = 73391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73391Service() {
        this(new Idea73391Config());
    }

    public Idea73391Service(Idea73391Config config) {
        this.config = config != null ? config : new Idea73391Config();
