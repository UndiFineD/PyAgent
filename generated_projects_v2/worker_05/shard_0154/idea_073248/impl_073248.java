...
@Data
public class Idea73248Config {
    private String name = "idea_073248";
 ...
 */
@Slf4j
public class Idea73248Service {
    private static final int IDEA_ID = 73248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73248Service() {
        this(new Idea73248Config());
    }

    public Idea73248Service(Idea73248Config config) {
        this.config = config != null ? config : new Idea73248Config();
