...
@Data
public class Idea73505Config {
    private String name = "idea_073505";
 ...
 */
@Slf4j
public class Idea73505Service {
    private static final int IDEA_ID = 73505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73505Service() {
        this(new Idea73505Config());
    }

    public Idea73505Service(Idea73505Config config) {
        this.config = config != null ? config : new Idea73505Config();
