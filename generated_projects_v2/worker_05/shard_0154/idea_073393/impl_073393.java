...
@Data
public class Idea73393Config {
    private String name = "idea_073393";
 ...
 */
@Slf4j
public class Idea73393Service {
    private static final int IDEA_ID = 73393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73393Service() {
        this(new Idea73393Config());
    }

    public Idea73393Service(Idea73393Config config) {
        this.config = config != null ? config : new Idea73393Config();
