...
@Data
public class Idea73409Config {
    private String name = "idea_073409";
 ...
 */
@Slf4j
public class Idea73409Service {
    private static final int IDEA_ID = 73409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73409Service() {
        this(new Idea73409Config());
    }

    public Idea73409Service(Idea73409Config config) {
        this.config = config != null ? config : new Idea73409Config();
