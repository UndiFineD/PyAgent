...
@Data
public class Idea73404Config {
    private String name = "idea_073404";
 ...
 */
@Slf4j
public class Idea73404Service {
    private static final int IDEA_ID = 73404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73404Service() {
        this(new Idea73404Config());
    }

    public Idea73404Service(Idea73404Config config) {
        this.config = config != null ? config : new Idea73404Config();
