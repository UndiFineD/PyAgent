...
@Data
public class Idea73341Config {
    private String name = "idea_073341";
 ...
 */
@Slf4j
public class Idea73341Service {
    private static final int IDEA_ID = 73341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73341Service() {
        this(new Idea73341Config());
    }

    public Idea73341Service(Idea73341Config config) {
        this.config = config != null ? config : new Idea73341Config();
