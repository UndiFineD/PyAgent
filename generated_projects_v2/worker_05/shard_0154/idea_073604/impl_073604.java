...
@Data
public class Idea73604Config {
    private String name = "idea_073604";
 ...
 */
@Slf4j
public class Idea73604Service {
    private static final int IDEA_ID = 73604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73604Service() {
        this(new Idea73604Config());
    }

    public Idea73604Service(Idea73604Config config) {
        this.config = config != null ? config : new Idea73604Config();
