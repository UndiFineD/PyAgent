...
@Data
public class Idea73438Config {
    private String name = "idea_073438";
 ...
 */
@Slf4j
public class Idea73438Service {
    private static final int IDEA_ID = 73438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73438Service() {
        this(new Idea73438Config());
    }

    public Idea73438Service(Idea73438Config config) {
        this.config = config != null ? config : new Idea73438Config();
