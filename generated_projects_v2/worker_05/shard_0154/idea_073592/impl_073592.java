...
@Data
public class Idea73592Config {
    private String name = "idea_073592";
 ...
 */
@Slf4j
public class Idea73592Service {
    private static final int IDEA_ID = 73592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73592Service() {
        this(new Idea73592Config());
    }

    public Idea73592Service(Idea73592Config config) {
        this.config = config != null ? config : new Idea73592Config();
