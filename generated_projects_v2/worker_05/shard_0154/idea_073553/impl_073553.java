...
@Data
public class Idea73553Config {
    private String name = "idea_073553";
 ...
 */
@Slf4j
public class Idea73553Service {
    private static final int IDEA_ID = 73553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73553Service() {
        this(new Idea73553Config());
    }

    public Idea73553Service(Idea73553Config config) {
        this.config = config != null ? config : new Idea73553Config();
