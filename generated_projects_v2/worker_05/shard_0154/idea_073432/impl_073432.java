...
@Data
public class Idea73432Config {
    private String name = "idea_073432";
 ...
 */
@Slf4j
public class Idea73432Service {
    private static final int IDEA_ID = 73432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73432Service() {
        this(new Idea73432Config());
    }

    public Idea73432Service(Idea73432Config config) {
        this.config = config != null ? config : new Idea73432Config();
