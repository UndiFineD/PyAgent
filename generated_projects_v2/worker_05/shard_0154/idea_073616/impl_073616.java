...
@Data
public class Idea73616Config {
    private String name = "idea_073616";
 ...
 */
@Slf4j
public class Idea73616Service {
    private static final int IDEA_ID = 73616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73616Service() {
        this(new Idea73616Config());
    }

    public Idea73616Service(Idea73616Config config) {
        this.config = config != null ? config : new Idea73616Config();
