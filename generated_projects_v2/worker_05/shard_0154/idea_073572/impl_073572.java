...
@Data
public class Idea73572Config {
    private String name = "idea_073572";
 ...
 */
@Slf4j
public class Idea73572Service {
    private static final int IDEA_ID = 73572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73572Service() {
        this(new Idea73572Config());
    }

    public Idea73572Service(Idea73572Config config) {
        this.config = config != null ? config : new Idea73572Config();
