...
@Data
public class Idea73251Config {
    private String name = "idea_073251";
 ...
 */
@Slf4j
public class Idea73251Service {
    private static final int IDEA_ID = 73251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73251Service() {
        this(new Idea73251Config());
    }

    public Idea73251Service(Idea73251Config config) {
        this.config = config != null ? config : new Idea73251Config();
