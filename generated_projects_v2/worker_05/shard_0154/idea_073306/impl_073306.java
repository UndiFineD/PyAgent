...
@Data
public class Idea73306Config {
    private String name = "idea_073306";
 ...
 */
@Slf4j
public class Idea73306Service {
    private static final int IDEA_ID = 73306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73306Service() {
        this(new Idea73306Config());
    }

    public Idea73306Service(Idea73306Config config) {
        this.config = config != null ? config : new Idea73306Config();
