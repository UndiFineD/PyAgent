...
@Data
public class Idea73339Config {
    private String name = "idea_073339";
 ...
 */
@Slf4j
public class Idea73339Service {
    private static final int IDEA_ID = 73339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73339Service() {
        this(new Idea73339Config());
    }

    public Idea73339Service(Idea73339Config config) {
        this.config = config != null ? config : new Idea73339Config();
