...
@Data
public class Idea73203Config {
    private String name = "idea_073203";
 ...
 */
@Slf4j
public class Idea73203Service {
    private static final int IDEA_ID = 73203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73203Service() {
        this(new Idea73203Config());
    }

    public Idea73203Service(Idea73203Config config) {
        this.config = config != null ? config : new Idea73203Config();
