...
@Data
public class Idea73390Config {
    private String name = "idea_073390";
 ...
 */
@Slf4j
public class Idea73390Service {
    private static final int IDEA_ID = 73390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73390Service() {
        this(new Idea73390Config());
    }

    public Idea73390Service(Idea73390Config config) {
        this.config = config != null ? config : new Idea73390Config();
