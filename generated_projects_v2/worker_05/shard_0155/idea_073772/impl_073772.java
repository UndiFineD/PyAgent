...
@Data
public class Idea73772Config {
    private String name = "idea_073772";
 ...
 */
@Slf4j
public class Idea73772Service {
    private static final int IDEA_ID = 73772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73772Service() {
        this(new Idea73772Config());
    }

    public Idea73772Service(Idea73772Config config) {
        this.config = config != null ? config : new Idea73772Config();
