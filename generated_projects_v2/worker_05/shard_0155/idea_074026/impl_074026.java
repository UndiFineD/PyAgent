...
@Data
public class Idea74026Config {
    private String name = "idea_074026";
 ...
 */
@Slf4j
public class Idea74026Service {
    private static final int IDEA_ID = 74026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74026Service() {
        this(new Idea74026Config());
    }

    public Idea74026Service(Idea74026Config config) {
        this.config = config != null ? config : new Idea74026Config();
