...
@Data
public class Idea74008Config {
    private String name = "idea_074008";
 ...
 */
@Slf4j
public class Idea74008Service {
    private static final int IDEA_ID = 74008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74008Service() {
        this(new Idea74008Config());
    }

    public Idea74008Service(Idea74008Config config) {
        this.config = config != null ? config : new Idea74008Config();
