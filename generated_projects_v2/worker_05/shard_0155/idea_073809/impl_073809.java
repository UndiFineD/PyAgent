...
@Data
public class Idea73809Config {
    private String name = "idea_073809";
 ...
 */
@Slf4j
public class Idea73809Service {
    private static final int IDEA_ID = 73809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73809Service() {
        this(new Idea73809Config());
    }

    public Idea73809Service(Idea73809Config config) {
        this.config = config != null ? config : new Idea73809Config();
