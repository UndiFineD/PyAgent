...
@Data
public class Idea73818Config {
    private String name = "idea_073818";
 ...
 */
@Slf4j
public class Idea73818Service {
    private static final int IDEA_ID = 73818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73818Service() {
        this(new Idea73818Config());
    }

    public Idea73818Service(Idea73818Config config) {
        this.config = config != null ? config : new Idea73818Config();
