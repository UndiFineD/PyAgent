...
@Data
public class Idea74090Config {
    private String name = "idea_074090";
 ...
 */
@Slf4j
public class Idea74090Service {
    private static final int IDEA_ID = 74090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74090Service() {
        this(new Idea74090Config());
    }

    public Idea74090Service(Idea74090Config config) {
        this.config = config != null ? config : new Idea74090Config();
