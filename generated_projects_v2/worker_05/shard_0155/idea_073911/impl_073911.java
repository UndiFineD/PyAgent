...
@Data
public class Idea73911Config {
    private String name = "idea_073911";
 ...
 */
@Slf4j
public class Idea73911Service {
    private static final int IDEA_ID = 73911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73911Service() {
        this(new Idea73911Config());
    }

    public Idea73911Service(Idea73911Config config) {
        this.config = config != null ? config : new Idea73911Config();
