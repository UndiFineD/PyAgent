...
@Data
public class Idea73699Config {
    private String name = "idea_073699";
 ...
 */
@Slf4j
public class Idea73699Service {
    private static final int IDEA_ID = 73699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73699Service() {
        this(new Idea73699Config());
    }

    public Idea73699Service(Idea73699Config config) {
        this.config = config != null ? config : new Idea73699Config();
