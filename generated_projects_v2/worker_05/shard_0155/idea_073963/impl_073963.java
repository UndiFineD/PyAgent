...
@Data
public class Idea73963Config {
    private String name = "idea_073963";
 ...
 */
@Slf4j
public class Idea73963Service {
    private static final int IDEA_ID = 73963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73963Service() {
        this(new Idea73963Config());
    }

    public Idea73963Service(Idea73963Config config) {
        this.config = config != null ? config : new Idea73963Config();
