...
@Data
public class Idea73834Config {
    private String name = "idea_073834";
 ...
 */
@Slf4j
public class Idea73834Service {
    private static final int IDEA_ID = 73834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73834Service() {
        this(new Idea73834Config());
    }

    public Idea73834Service(Idea73834Config config) {
        this.config = config != null ? config : new Idea73834Config();
