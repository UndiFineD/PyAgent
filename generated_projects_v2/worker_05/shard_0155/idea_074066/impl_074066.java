...
@Data
public class Idea74066Config {
    private String name = "idea_074066";
 ...
 */
@Slf4j
public class Idea74066Service {
    private static final int IDEA_ID = 74066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74066Service() {
        this(new Idea74066Config());
    }

    public Idea74066Service(Idea74066Config config) {
        this.config = config != null ? config : new Idea74066Config();
