...
@Data
public class Idea73800Config {
    private String name = "idea_073800";
 ...
 */
@Slf4j
public class Idea73800Service {
    private static final int IDEA_ID = 73800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73800Service() {
        this(new Idea73800Config());
    }

    public Idea73800Service(Idea73800Config config) {
        this.config = config != null ? config : new Idea73800Config();
