...
@Data
public class Idea73698Config {
    private String name = "idea_073698";
 ...
 */
@Slf4j
public class Idea73698Service {
    private static final int IDEA_ID = 73698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73698Service() {
        this(new Idea73698Config());
    }

    public Idea73698Service(Idea73698Config config) {
        this.config = config != null ? config : new Idea73698Config();
