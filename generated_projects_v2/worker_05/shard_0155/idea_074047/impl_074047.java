...
@Data
public class Idea74047Config {
    private String name = "idea_074047";
 ...
 */
@Slf4j
public class Idea74047Service {
    private static final int IDEA_ID = 74047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74047Service() {
        this(new Idea74047Config());
    }

    public Idea74047Service(Idea74047Config config) {
        this.config = config != null ? config : new Idea74047Config();
