...
@Data
public class Idea74099Config {
    private String name = "idea_074099";
 ...
 */
@Slf4j
public class Idea74099Service {
    private static final int IDEA_ID = 74099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74099Service() {
        this(new Idea74099Config());
    }

    public Idea74099Service(Idea74099Config config) {
        this.config = config != null ? config : new Idea74099Config();
