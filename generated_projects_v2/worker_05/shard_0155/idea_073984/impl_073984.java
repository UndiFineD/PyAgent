...
@Data
public class Idea73984Config {
    private String name = "idea_073984";
 ...
 */
@Slf4j
public class Idea73984Service {
    private static final int IDEA_ID = 73984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73984Service() {
        this(new Idea73984Config());
    }

    public Idea73984Service(Idea73984Config config) {
        this.config = config != null ? config : new Idea73984Config();
