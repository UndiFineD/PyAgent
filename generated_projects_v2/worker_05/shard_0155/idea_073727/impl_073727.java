...
@Data
public class Idea73727Config {
    private String name = "idea_073727";
 ...
 */
@Slf4j
public class Idea73727Service {
    private static final int IDEA_ID = 73727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73727Service() {
        this(new Idea73727Config());
    }

    public Idea73727Service(Idea73727Config config) {
        this.config = config != null ? config : new Idea73727Config();
