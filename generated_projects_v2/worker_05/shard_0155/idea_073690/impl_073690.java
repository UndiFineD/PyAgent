...
@Data
public class Idea73690Config {
    private String name = "idea_073690";
 ...
 */
@Slf4j
public class Idea73690Service {
    private static final int IDEA_ID = 73690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73690Service() {
        this(new Idea73690Config());
    }

    public Idea73690Service(Idea73690Config config) {
        this.config = config != null ? config : new Idea73690Config();
