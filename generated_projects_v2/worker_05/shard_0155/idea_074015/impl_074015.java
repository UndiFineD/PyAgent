...
@Data
public class Idea74015Config {
    private String name = "idea_074015";
 ...
 */
@Slf4j
public class Idea74015Service {
    private static final int IDEA_ID = 74015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74015Service() {
        this(new Idea74015Config());
    }

    public Idea74015Service(Idea74015Config config) {
        this.config = config != null ? config : new Idea74015Config();
