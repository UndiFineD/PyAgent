...
@Data
public class Idea74037Config {
    private String name = "idea_074037";
 ...
 */
@Slf4j
public class Idea74037Service {
    private static final int IDEA_ID = 74037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74037Service() {
        this(new Idea74037Config());
    }

    public Idea74037Service(Idea74037Config config) {
        this.config = config != null ? config : new Idea74037Config();
