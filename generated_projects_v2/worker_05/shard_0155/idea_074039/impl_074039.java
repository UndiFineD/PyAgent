...
@Data
public class Idea74039Config {
    private String name = "idea_074039";
 ...
 */
@Slf4j
public class Idea74039Service {
    private static final int IDEA_ID = 74039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74039Service() {
        this(new Idea74039Config());
    }

    public Idea74039Service(Idea74039Config config) {
        this.config = config != null ? config : new Idea74039Config();
