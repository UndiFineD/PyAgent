...
@Data
public class Idea73947Config {
    private String name = "idea_073947";
 ...
 */
@Slf4j
public class Idea73947Service {
    private static final int IDEA_ID = 73947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73947Service() {
        this(new Idea73947Config());
    }

    public Idea73947Service(Idea73947Config config) {
        this.config = config != null ? config : new Idea73947Config();
