...
@Data
public class Idea73897Config {
    private String name = "idea_073897";
 ...
 */
@Slf4j
public class Idea73897Service {
    private static final int IDEA_ID = 73897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73897Service() {
        this(new Idea73897Config());
    }

    public Idea73897Service(Idea73897Config config) {
        this.config = config != null ? config : new Idea73897Config();
