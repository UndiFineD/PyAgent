...
@Data
public class Idea74007Config {
    private String name = "idea_074007";
 ...
 */
@Slf4j
public class Idea74007Service {
    private static final int IDEA_ID = 74007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74007Service() {
        this(new Idea74007Config());
    }

    public Idea74007Service(Idea74007Config config) {
        this.config = config != null ? config : new Idea74007Config();
