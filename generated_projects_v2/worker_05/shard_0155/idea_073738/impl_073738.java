...
@Data
public class Idea73738Config {
    private String name = "idea_073738";
 ...
 */
@Slf4j
public class Idea73738Service {
    private static final int IDEA_ID = 73738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73738Service() {
        this(new Idea73738Config());
    }

    public Idea73738Service(Idea73738Config config) {
        this.config = config != null ? config : new Idea73738Config();
