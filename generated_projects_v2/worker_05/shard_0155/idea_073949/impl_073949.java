...
@Data
public class Idea73949Config {
    private String name = "idea_073949";
 ...
 */
@Slf4j
public class Idea73949Service {
    private static final int IDEA_ID = 73949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73949Service() {
        this(new Idea73949Config());
    }

    public Idea73949Service(Idea73949Config config) {
        this.config = config != null ? config : new Idea73949Config();
