...
@Data
public class Idea73943Config {
    private String name = "idea_073943";
 ...
 */
@Slf4j
public class Idea73943Service {
    private static final int IDEA_ID = 73943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73943Service() {
        this(new Idea73943Config());
    }

    public Idea73943Service(Idea73943Config config) {
        this.config = config != null ? config : new Idea73943Config();
