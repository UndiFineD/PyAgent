...
@Data
public class Idea74002Config {
    private String name = "idea_074002";
 ...
 */
@Slf4j
public class Idea74002Service {
    private static final int IDEA_ID = 74002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74002Service() {
        this(new Idea74002Config());
    }

    public Idea74002Service(Idea74002Config config) {
        this.config = config != null ? config : new Idea74002Config();
