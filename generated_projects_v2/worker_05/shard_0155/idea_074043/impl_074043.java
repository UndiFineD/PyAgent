...
@Data
public class Idea74043Config {
    private String name = "idea_074043";
 ...
 */
@Slf4j
public class Idea74043Service {
    private static final int IDEA_ID = 74043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74043Service() {
        this(new Idea74043Config());
    }

    public Idea74043Service(Idea74043Config config) {
        this.config = config != null ? config : new Idea74043Config();
