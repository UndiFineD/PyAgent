...
@Data
public class Idea74005Config {
    private String name = "idea_074005";
 ...
 */
@Slf4j
public class Idea74005Service {
    private static final int IDEA_ID = 74005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74005Service() {
        this(new Idea74005Config());
    }

    public Idea74005Service(Idea74005Config config) {
        this.config = config != null ? config : new Idea74005Config();
