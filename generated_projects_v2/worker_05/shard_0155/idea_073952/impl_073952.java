...
@Data
public class Idea73952Config {
    private String name = "idea_073952";
 ...
 */
@Slf4j
public class Idea73952Service {
    private static final int IDEA_ID = 73952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73952Service() {
        this(new Idea73952Config());
    }

    public Idea73952Service(Idea73952Config config) {
        this.config = config != null ? config : new Idea73952Config();
