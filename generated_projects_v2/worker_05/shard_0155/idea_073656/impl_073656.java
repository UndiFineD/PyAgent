...
@Data
public class Idea73656Config {
    private String name = "idea_073656";
 ...
 */
@Slf4j
public class Idea73656Service {
    private static final int IDEA_ID = 73656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73656Service() {
        this(new Idea73656Config());
    }

    public Idea73656Service(Idea73656Config config) {
        this.config = config != null ? config : new Idea73656Config();
