...
@Data
public class Idea73677Config {
    private String name = "idea_073677";
 ...
 */
@Slf4j
public class Idea73677Service {
    private static final int IDEA_ID = 73677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73677Service() {
        this(new Idea73677Config());
    }

    public Idea73677Service(Idea73677Config config) {
        this.config = config != null ? config : new Idea73677Config();
