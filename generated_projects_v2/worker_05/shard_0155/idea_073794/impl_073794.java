...
@Data
public class Idea73794Config {
    private String name = "idea_073794";
 ...
 */
@Slf4j
public class Idea73794Service {
    private static final int IDEA_ID = 73794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73794Service() {
        this(new Idea73794Config());
    }

    public Idea73794Service(Idea73794Config config) {
        this.config = config != null ? config : new Idea73794Config();
