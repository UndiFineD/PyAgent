...
@Data
public class Idea74034Config {
    private String name = "idea_074034";
 ...
 */
@Slf4j
public class Idea74034Service {
    private static final int IDEA_ID = 74034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74034Service() {
        this(new Idea74034Config());
    }

    public Idea74034Service(Idea74034Config config) {
        this.config = config != null ? config : new Idea74034Config();
