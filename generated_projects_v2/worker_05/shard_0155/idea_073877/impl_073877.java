...
@Data
public class Idea73877Config {
    private String name = "idea_073877";
 ...
 */
@Slf4j
public class Idea73877Service {
    private static final int IDEA_ID = 73877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73877Service() {
        this(new Idea73877Config());
    }

    public Idea73877Service(Idea73877Config config) {
        this.config = config != null ? config : new Idea73877Config();
