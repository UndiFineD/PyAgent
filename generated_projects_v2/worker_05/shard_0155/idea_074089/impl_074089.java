...
@Data
public class Idea74089Config {
    private String name = "idea_074089";
 ...
 */
@Slf4j
public class Idea74089Service {
    private static final int IDEA_ID = 74089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74089Service() {
        this(new Idea74089Config());
    }

    public Idea74089Service(Idea74089Config config) {
        this.config = config != null ? config : new Idea74089Config();
