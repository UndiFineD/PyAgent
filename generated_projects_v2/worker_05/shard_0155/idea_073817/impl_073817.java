...
@Data
public class Idea73817Config {
    private String name = "idea_073817";
 ...
 */
@Slf4j
public class Idea73817Service {
    private static final int IDEA_ID = 73817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73817Service() {
        this(new Idea73817Config());
    }

    public Idea73817Service(Idea73817Config config) {
        this.config = config != null ? config : new Idea73817Config();
