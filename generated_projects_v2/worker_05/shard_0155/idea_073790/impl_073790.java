...
@Data
public class Idea73790Config {
    private String name = "idea_073790";
 ...
 */
@Slf4j
public class Idea73790Service {
    private static final int IDEA_ID = 73790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73790Service() {
        this(new Idea73790Config());
    }

    public Idea73790Service(Idea73790Config config) {
        this.config = config != null ? config : new Idea73790Config();
