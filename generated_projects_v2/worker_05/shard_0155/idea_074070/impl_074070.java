...
@Data
public class Idea74070Config {
    private String name = "idea_074070";
 ...
 */
@Slf4j
public class Idea74070Service {
    private static final int IDEA_ID = 74070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74070Service() {
        this(new Idea74070Config());
    }

    public Idea74070Service(Idea74070Config config) {
        this.config = config != null ? config : new Idea74070Config();
