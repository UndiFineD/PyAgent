...
@Data
public class Idea73755Config {
    private String name = "idea_073755";
 ...
 */
@Slf4j
public class Idea73755Service {
    private static final int IDEA_ID = 73755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73755Service() {
        this(new Idea73755Config());
    }

    public Idea73755Service(Idea73755Config config) {
        this.config = config != null ? config : new Idea73755Config();
