...
@Data
public class Idea73929Config {
    private String name = "idea_073929";
 ...
 */
@Slf4j
public class Idea73929Service {
    private static final int IDEA_ID = 73929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73929Service() {
        this(new Idea73929Config());
    }

    public Idea73929Service(Idea73929Config config) {
        this.config = config != null ? config : new Idea73929Config();
