...
@Data
public class Idea74018Config {
    private String name = "idea_074018";
 ...
 */
@Slf4j
public class Idea74018Service {
    private static final int IDEA_ID = 74018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74018Service() {
        this(new Idea74018Config());
    }

    public Idea74018Service(Idea74018Config config) {
        this.config = config != null ? config : new Idea74018Config();
