...
@Data
public class Idea73742Config {
    private String name = "idea_073742";
 ...
 */
@Slf4j
public class Idea73742Service {
    private static final int IDEA_ID = 73742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73742Service() {
        this(new Idea73742Config());
    }

    public Idea73742Service(Idea73742Config config) {
        this.config = config != null ? config : new Idea73742Config();
