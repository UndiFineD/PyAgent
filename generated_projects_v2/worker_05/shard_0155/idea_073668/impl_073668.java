...
@Data
public class Idea73668Config {
    private String name = "idea_073668";
 ...
 */
@Slf4j
public class Idea73668Service {
    private static final int IDEA_ID = 73668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73668Service() {
        this(new Idea73668Config());
    }

    public Idea73668Service(Idea73668Config config) {
        this.config = config != null ? config : new Idea73668Config();
