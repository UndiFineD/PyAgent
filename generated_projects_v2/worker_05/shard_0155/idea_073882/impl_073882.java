...
@Data
public class Idea73882Config {
    private String name = "idea_073882";
 ...
 */
@Slf4j
public class Idea73882Service {
    private static final int IDEA_ID = 73882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73882Service() {
        this(new Idea73882Config());
    }

    public Idea73882Service(Idea73882Config config) {
        this.config = config != null ? config : new Idea73882Config();
