...
@Data
public class Idea73673Config {
    private String name = "idea_073673";
 ...
 */
@Slf4j
public class Idea73673Service {
    private static final int IDEA_ID = 73673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73673Service() {
        this(new Idea73673Config());
    }

    public Idea73673Service(Idea73673Config config) {
        this.config = config != null ? config : new Idea73673Config();
