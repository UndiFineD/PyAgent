...
@Data
public class Idea74011Config {
    private String name = "idea_074011";
 ...
 */
@Slf4j
public class Idea74011Service {
    private static final int IDEA_ID = 74011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74011Service() {
        this(new Idea74011Config());
    }

    public Idea74011Service(Idea74011Config config) {
        this.config = config != null ? config : new Idea74011Config();
