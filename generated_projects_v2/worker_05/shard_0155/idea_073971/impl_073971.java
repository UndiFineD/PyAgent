...
@Data
public class Idea73971Config {
    private String name = "idea_073971";
 ...
 */
@Slf4j
public class Idea73971Service {
    private static final int IDEA_ID = 73971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73971Service() {
        this(new Idea73971Config());
    }

    public Idea73971Service(Idea73971Config config) {
        this.config = config != null ? config : new Idea73971Config();
