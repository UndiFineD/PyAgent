...
@Data
public class Idea73828Config {
    private String name = "idea_073828";
 ...
 */
@Slf4j
public class Idea73828Service {
    private static final int IDEA_ID = 73828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73828Service() {
        this(new Idea73828Config());
    }

    public Idea73828Service(Idea73828Config config) {
        this.config = config != null ? config : new Idea73828Config();
