...
@Data
public class Idea73717Config {
    private String name = "idea_073717";
 ...
 */
@Slf4j
public class Idea73717Service {
    private static final int IDEA_ID = 73717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73717Service() {
        this(new Idea73717Config());
    }

    public Idea73717Service(Idea73717Config config) {
        this.config = config != null ? config : new Idea73717Config();
