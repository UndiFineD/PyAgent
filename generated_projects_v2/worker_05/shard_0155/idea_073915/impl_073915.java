...
@Data
public class Idea73915Config {
    private String name = "idea_073915";
 ...
 */
@Slf4j
public class Idea73915Service {
    private static final int IDEA_ID = 73915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73915Service() {
        this(new Idea73915Config());
    }

    public Idea73915Service(Idea73915Config config) {
        this.config = config != null ? config : new Idea73915Config();
