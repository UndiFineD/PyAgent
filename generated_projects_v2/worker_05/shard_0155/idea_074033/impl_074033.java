...
@Data
public class Idea74033Config {
    private String name = "idea_074033";
 ...
 */
@Slf4j
public class Idea74033Service {
    private static final int IDEA_ID = 74033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74033Service() {
        this(new Idea74033Config());
    }

    public Idea74033Service(Idea74033Config config) {
        this.config = config != null ? config : new Idea74033Config();
