...
@Data
public class Idea74057Config {
    private String name = "idea_074057";
 ...
 */
@Slf4j
public class Idea74057Service {
    private static final int IDEA_ID = 74057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74057Service() {
        this(new Idea74057Config());
    }

    public Idea74057Service(Idea74057Config config) {
        this.config = config != null ? config : new Idea74057Config();
