...
@Data
public class Idea73783Config {
    private String name = "idea_073783";
 ...
 */
@Slf4j
public class Idea73783Service {
    private static final int IDEA_ID = 73783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73783Service() {
        this(new Idea73783Config());
    }

    public Idea73783Service(Idea73783Config config) {
        this.config = config != null ? config : new Idea73783Config();
