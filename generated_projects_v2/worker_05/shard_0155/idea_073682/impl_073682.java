...
@Data
public class Idea73682Config {
    private String name = "idea_073682";
 ...
 */
@Slf4j
public class Idea73682Service {
    private static final int IDEA_ID = 73682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73682Service() {
        this(new Idea73682Config());
    }

    public Idea73682Service(Idea73682Config config) {
        this.config = config != null ? config : new Idea73682Config();
