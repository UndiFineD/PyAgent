...
@Data
public class Idea73684Config {
    private String name = "idea_073684";
 ...
 */
@Slf4j
public class Idea73684Service {
    private static final int IDEA_ID = 73684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73684Service() {
        this(new Idea73684Config());
    }

    public Idea73684Service(Idea73684Config config) {
        this.config = config != null ? config : new Idea73684Config();
