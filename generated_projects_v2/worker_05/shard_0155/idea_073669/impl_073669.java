...
@Data
public class Idea73669Config {
    private String name = "idea_073669";
 ...
 */
@Slf4j
public class Idea73669Service {
    private static final int IDEA_ID = 73669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73669Service() {
        this(new Idea73669Config());
    }

    public Idea73669Service(Idea73669Config config) {
        this.config = config != null ? config : new Idea73669Config();
