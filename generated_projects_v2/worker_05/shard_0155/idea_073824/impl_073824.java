...
@Data
public class Idea73824Config {
    private String name = "idea_073824";
 ...
 */
@Slf4j
public class Idea73824Service {
    private static final int IDEA_ID = 73824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73824Service() {
        this(new Idea73824Config());
    }

    public Idea73824Service(Idea73824Config config) {
        this.config = config != null ? config : new Idea73824Config();
