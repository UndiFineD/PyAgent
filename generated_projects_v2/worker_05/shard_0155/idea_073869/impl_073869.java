...
@Data
public class Idea73869Config {
    private String name = "idea_073869";
 ...
 */
@Slf4j
public class Idea73869Service {
    private static final int IDEA_ID = 73869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73869Service() {
        this(new Idea73869Config());
    }

    public Idea73869Service(Idea73869Config config) {
        this.config = config != null ? config : new Idea73869Config();
