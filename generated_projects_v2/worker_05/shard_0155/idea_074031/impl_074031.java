...
@Data
public class Idea74031Config {
    private String name = "idea_074031";
 ...
 */
@Slf4j
public class Idea74031Service {
    private static final int IDEA_ID = 74031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74031Service() {
        this(new Idea74031Config());
    }

    public Idea74031Service(Idea74031Config config) {
        this.config = config != null ? config : new Idea74031Config();
