...
@Data
public class Idea73670Config {
    private String name = "idea_073670";
 ...
 */
@Slf4j
public class Idea73670Service {
    private static final int IDEA_ID = 73670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73670Service() {
        this(new Idea73670Config());
    }

    public Idea73670Service(Idea73670Config config) {
        this.config = config != null ? config : new Idea73670Config();
