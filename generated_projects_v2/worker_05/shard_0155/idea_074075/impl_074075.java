...
@Data
public class Idea74075Config {
    private String name = "idea_074075";
 ...
 */
@Slf4j
public class Idea74075Service {
    private static final int IDEA_ID = 74075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74075Service() {
        this(new Idea74075Config());
    }

    public Idea74075Service(Idea74075Config config) {
        this.config = config != null ? config : new Idea74075Config();
