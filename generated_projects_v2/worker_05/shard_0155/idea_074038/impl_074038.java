...
@Data
public class Idea74038Config {
    private String name = "idea_074038";
 ...
 */
@Slf4j
public class Idea74038Service {
    private static final int IDEA_ID = 74038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74038Service() {
        this(new Idea74038Config());
    }

    public Idea74038Service(Idea74038Config config) {
        this.config = config != null ? config : new Idea74038Config();
