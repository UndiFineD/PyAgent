...
@Data
public class Idea74083Config {
    private String name = "idea_074083";
 ...
 */
@Slf4j
public class Idea74083Service {
    private static final int IDEA_ID = 74083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74083Service() {
        this(new Idea74083Config());
    }

    public Idea74083Service(Idea74083Config config) {
        this.config = config != null ? config : new Idea74083Config();
