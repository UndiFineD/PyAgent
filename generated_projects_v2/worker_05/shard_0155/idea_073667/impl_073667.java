...
@Data
public class Idea73667Config {
    private String name = "idea_073667";
 ...
 */
@Slf4j
public class Idea73667Service {
    private static final int IDEA_ID = 73667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73667Service() {
        this(new Idea73667Config());
    }

    public Idea73667Service(Idea73667Config config) {
        this.config = config != null ? config : new Idea73667Config();
