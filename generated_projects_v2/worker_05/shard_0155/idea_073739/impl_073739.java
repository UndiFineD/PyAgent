...
@Data
public class Idea73739Config {
    private String name = "idea_073739";
 ...
 */
@Slf4j
public class Idea73739Service {
    private static final int IDEA_ID = 73739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73739Service() {
        this(new Idea73739Config());
    }

    public Idea73739Service(Idea73739Config config) {
        this.config = config != null ? config : new Idea73739Config();
