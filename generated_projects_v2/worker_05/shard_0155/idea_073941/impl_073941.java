...
@Data
public class Idea73941Config {
    private String name = "idea_073941";
 ...
 */
@Slf4j
public class Idea73941Service {
    private static final int IDEA_ID = 73941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73941Service() {
        this(new Idea73941Config());
    }

    public Idea73941Service(Idea73941Config config) {
        this.config = config != null ? config : new Idea73941Config();
