...
@Data
public class Idea73676Config {
    private String name = "idea_073676";
 ...
 */
@Slf4j
public class Idea73676Service {
    private static final int IDEA_ID = 73676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73676Service() {
        this(new Idea73676Config());
    }

    public Idea73676Service(Idea73676Config config) {
        this.config = config != null ? config : new Idea73676Config();
