...
@Data
public class Idea73966Config {
    private String name = "idea_073966";
 ...
 */
@Slf4j
public class Idea73966Service {
    private static final int IDEA_ID = 73966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73966Service() {
        this(new Idea73966Config());
    }

    public Idea73966Service(Idea73966Config config) {
        this.config = config != null ? config : new Idea73966Config();
