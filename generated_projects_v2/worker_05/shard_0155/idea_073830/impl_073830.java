...
@Data
public class Idea73830Config {
    private String name = "idea_073830";
 ...
 */
@Slf4j
public class Idea73830Service {
    private static final int IDEA_ID = 73830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73830Service() {
        this(new Idea73830Config());
    }

    public Idea73830Service(Idea73830Config config) {
        this.config = config != null ? config : new Idea73830Config();
