...
@Data
public class Idea73822Config {
    private String name = "idea_073822";
 ...
 */
@Slf4j
public class Idea73822Service {
    private static final int IDEA_ID = 73822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73822Service() {
        this(new Idea73822Config());
    }

    public Idea73822Service(Idea73822Config config) {
        this.config = config != null ? config : new Idea73822Config();
