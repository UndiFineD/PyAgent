...
@Data
public class Idea73976Config {
    private String name = "idea_073976";
 ...
 */
@Slf4j
public class Idea73976Service {
    private static final int IDEA_ID = 73976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73976Service() {
        this(new Idea73976Config());
    }

    public Idea73976Service(Idea73976Config config) {
        this.config = config != null ? config : new Idea73976Config();
