...
@Data
public class Idea73940Config {
    private String name = "idea_073940";
 ...
 */
@Slf4j
public class Idea73940Service {
    private static final int IDEA_ID = 73940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73940Service() {
        this(new Idea73940Config());
    }

    public Idea73940Service(Idea73940Config config) {
        this.config = config != null ? config : new Idea73940Config();
