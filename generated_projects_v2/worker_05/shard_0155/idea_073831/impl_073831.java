...
@Data
public class Idea73831Config {
    private String name = "idea_073831";
 ...
 */
@Slf4j
public class Idea73831Service {
    private static final int IDEA_ID = 73831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73831Service() {
        this(new Idea73831Config());
    }

    public Idea73831Service(Idea73831Config config) {
        this.config = config != null ? config : new Idea73831Config();
