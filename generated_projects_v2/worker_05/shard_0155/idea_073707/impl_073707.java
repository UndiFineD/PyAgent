...
@Data
public class Idea73707Config {
    private String name = "idea_073707";
 ...
 */
@Slf4j
public class Idea73707Service {
    private static final int IDEA_ID = 73707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73707Service() {
        this(new Idea73707Config());
    }

    public Idea73707Service(Idea73707Config config) {
        this.config = config != null ? config : new Idea73707Config();
