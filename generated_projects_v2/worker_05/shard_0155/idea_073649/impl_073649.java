...
@Data
public class Idea73649Config {
    private String name = "idea_073649";
 ...
 */
@Slf4j
public class Idea73649Service {
    private static final int IDEA_ID = 73649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73649Service() {
        this(new Idea73649Config());
    }

    public Idea73649Service(Idea73649Config config) {
        this.config = config != null ? config : new Idea73649Config();
