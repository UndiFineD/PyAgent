...
@Data
public class Idea73792Config {
    private String name = "idea_073792";
 ...
 */
@Slf4j
public class Idea73792Service {
    private static final int IDEA_ID = 73792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73792Service() {
        this(new Idea73792Config());
    }

    public Idea73792Service(Idea73792Config config) {
        this.config = config != null ? config : new Idea73792Config();
