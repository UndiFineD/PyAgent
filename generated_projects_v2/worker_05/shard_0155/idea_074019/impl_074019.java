...
@Data
public class Idea74019Config {
    private String name = "idea_074019";
 ...
 */
@Slf4j
public class Idea74019Service {
    private static final int IDEA_ID = 74019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74019Service() {
        this(new Idea74019Config());
    }

    public Idea74019Service(Idea74019Config config) {
        this.config = config != null ? config : new Idea74019Config();
