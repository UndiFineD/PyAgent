...
@Data
public class Idea73974Config {
    private String name = "idea_073974";
 ...
 */
@Slf4j
public class Idea73974Service {
    private static final int IDEA_ID = 73974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73974Service() {
        this(new Idea73974Config());
    }

    public Idea73974Service(Idea73974Config config) {
        this.config = config != null ? config : new Idea73974Config();
