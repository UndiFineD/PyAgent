...
@Data
public class Idea73841Config {
    private String name = "idea_073841";
 ...
 */
@Slf4j
public class Idea73841Service {
    private static final int IDEA_ID = 73841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73841Service() {
        this(new Idea73841Config());
    }

    public Idea73841Service(Idea73841Config config) {
        this.config = config != null ? config : new Idea73841Config();
