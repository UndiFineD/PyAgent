...
@Data
public class Idea73964Config {
    private String name = "idea_073964";
 ...
 */
@Slf4j
public class Idea73964Service {
    private static final int IDEA_ID = 73964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73964Service() {
        this(new Idea73964Config());
    }

    public Idea73964Service(Idea73964Config config) {
        this.config = config != null ? config : new Idea73964Config();
