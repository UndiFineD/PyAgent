...
@Data
public class Idea73912Config {
    private String name = "idea_073912";
 ...
 */
@Slf4j
public class Idea73912Service {
    private static final int IDEA_ID = 73912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73912Service() {
        this(new Idea73912Config());
    }

    public Idea73912Service(Idea73912Config config) {
        this.config = config != null ? config : new Idea73912Config();
