...
@Data
public class Idea73980Config {
    private String name = "idea_073980";
 ...
 */
@Slf4j
public class Idea73980Service {
    private static final int IDEA_ID = 73980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73980Service() {
        this(new Idea73980Config());
    }

    public Idea73980Service(Idea73980Config config) {
        this.config = config != null ? config : new Idea73980Config();
