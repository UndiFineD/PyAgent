...
@Data
public class Idea73740Config {
    private String name = "idea_073740";
 ...
 */
@Slf4j
public class Idea73740Service {
    private static final int IDEA_ID = 73740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73740Service() {
        this(new Idea73740Config());
    }

    public Idea73740Service(Idea73740Config config) {
        this.config = config != null ? config : new Idea73740Config();
