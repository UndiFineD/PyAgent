...
@Data
public class Idea73660Config {
    private String name = "idea_073660";
 ...
 */
@Slf4j
public class Idea73660Service {
    private static final int IDEA_ID = 73660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73660Service() {
        this(new Idea73660Config());
    }

    public Idea73660Service(Idea73660Config config) {
        this.config = config != null ? config : new Idea73660Config();
