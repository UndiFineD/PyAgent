...
@Data
public class Idea73956Config {
    private String name = "idea_073956";
 ...
 */
@Slf4j
public class Idea73956Service {
    private static final int IDEA_ID = 73956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73956Service() {
        this(new Idea73956Config());
    }

    public Idea73956Service(Idea73956Config config) {
        this.config = config != null ? config : new Idea73956Config();
