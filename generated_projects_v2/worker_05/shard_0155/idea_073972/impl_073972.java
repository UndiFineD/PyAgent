...
@Data
public class Idea73972Config {
    private String name = "idea_073972";
 ...
 */
@Slf4j
public class Idea73972Service {
    private static final int IDEA_ID = 73972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73972Service() {
        this(new Idea73972Config());
    }

    public Idea73972Service(Idea73972Config config) {
        this.config = config != null ? config : new Idea73972Config();
