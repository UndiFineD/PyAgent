...
@Data
public class Idea73902Config {
    private String name = "idea_073902";
 ...
 */
@Slf4j
public class Idea73902Service {
    private static final int IDEA_ID = 73902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73902Service() {
        this(new Idea73902Config());
    }

    public Idea73902Service(Idea73902Config config) {
        this.config = config != null ? config : new Idea73902Config();
