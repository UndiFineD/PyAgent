...
@Data
public class Idea73861Config {
    private String name = "idea_073861";
 ...
 */
@Slf4j
public class Idea73861Service {
    private static final int IDEA_ID = 73861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73861Service() {
        this(new Idea73861Config());
    }

    public Idea73861Service(Idea73861Config config) {
        this.config = config != null ? config : new Idea73861Config();
