...
@Data
public class Idea73996Config {
    private String name = "idea_073996";
 ...
 */
@Slf4j
public class Idea73996Service {
    private static final int IDEA_ID = 73996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73996Service() {
        this(new Idea73996Config());
    }

    public Idea73996Service(Idea73996Config config) {
        this.config = config != null ? config : new Idea73996Config();
