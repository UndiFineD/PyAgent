...
@Data
public class Idea73687Config {
    private String name = "idea_073687";
 ...
 */
@Slf4j
public class Idea73687Service {
    private static final int IDEA_ID = 73687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73687Service() {
        this(new Idea73687Config());
    }

    public Idea73687Service(Idea73687Config config) {
        this.config = config != null ? config : new Idea73687Config();
