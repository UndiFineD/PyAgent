...
@Data
public class Idea73992Config {
    private String name = "idea_073992";
 ...
 */
@Slf4j
public class Idea73992Service {
    private static final int IDEA_ID = 73992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73992Service() {
        this(new Idea73992Config());
    }

    public Idea73992Service(Idea73992Config config) {
        this.config = config != null ? config : new Idea73992Config();
