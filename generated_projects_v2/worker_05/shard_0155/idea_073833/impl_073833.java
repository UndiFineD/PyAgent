...
@Data
public class Idea73833Config {
    private String name = "idea_073833";
 ...
 */
@Slf4j
public class Idea73833Service {
    private static final int IDEA_ID = 73833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73833Service() {
        this(new Idea73833Config());
    }

    public Idea73833Service(Idea73833Config config) {
        this.config = config != null ? config : new Idea73833Config();
