...
@Data
public class Idea73730Config {
    private String name = "idea_073730";
 ...
 */
@Slf4j
public class Idea73730Service {
    private static final int IDEA_ID = 73730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73730Service() {
        this(new Idea73730Config());
    }

    public Idea73730Service(Idea73730Config config) {
        this.config = config != null ? config : new Idea73730Config();
