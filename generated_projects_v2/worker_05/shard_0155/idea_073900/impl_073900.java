...
@Data
public class Idea73900Config {
    private String name = "idea_073900";
 ...
 */
@Slf4j
public class Idea73900Service {
    private static final int IDEA_ID = 73900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73900Service() {
        this(new Idea73900Config());
    }

    public Idea73900Service(Idea73900Config config) {
        this.config = config != null ? config : new Idea73900Config();
