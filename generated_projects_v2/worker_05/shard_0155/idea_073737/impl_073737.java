...
@Data
public class Idea73737Config {
    private String name = "idea_073737";
 ...
 */
@Slf4j
public class Idea73737Service {
    private static final int IDEA_ID = 73737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73737Service() {
        this(new Idea73737Config());
    }

    public Idea73737Service(Idea73737Config config) {
        this.config = config != null ? config : new Idea73737Config();
