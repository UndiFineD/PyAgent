...
@Data
public class Idea73995Config {
    private String name = "idea_073995";
 ...
 */
@Slf4j
public class Idea73995Service {
    private static final int IDEA_ID = 73995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73995Service() {
        this(new Idea73995Config());
    }

    public Idea73995Service(Idea73995Config config) {
        this.config = config != null ? config : new Idea73995Config();
