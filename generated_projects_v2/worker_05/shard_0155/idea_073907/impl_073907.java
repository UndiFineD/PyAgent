...
@Data
public class Idea73907Config {
    private String name = "idea_073907";
 ...
 */
@Slf4j
public class Idea73907Service {
    private static final int IDEA_ID = 73907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73907Service() {
        this(new Idea73907Config());
    }

    public Idea73907Service(Idea73907Config config) {
        this.config = config != null ? config : new Idea73907Config();
