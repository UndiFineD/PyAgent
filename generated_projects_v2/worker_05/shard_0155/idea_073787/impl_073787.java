...
@Data
public class Idea73787Config {
    private String name = "idea_073787";
 ...
 */
@Slf4j
public class Idea73787Service {
    private static final int IDEA_ID = 73787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73787Service() {
        this(new Idea73787Config());
    }

    public Idea73787Service(Idea73787Config config) {
        this.config = config != null ? config : new Idea73787Config();
