...
@Data
public class Idea73962Config {
    private String name = "idea_073962";
 ...
 */
@Slf4j
public class Idea73962Service {
    private static final int IDEA_ID = 73962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73962Service() {
        this(new Idea73962Config());
    }

    public Idea73962Service(Idea73962Config config) {
        this.config = config != null ? config : new Idea73962Config();
