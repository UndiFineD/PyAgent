...
@Data
public class Idea73697Config {
    private String name = "idea_073697";
 ...
 */
@Slf4j
public class Idea73697Service {
    private static final int IDEA_ID = 73697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73697Service() {
        this(new Idea73697Config());
    }

    public Idea73697Service(Idea73697Config config) {
        this.config = config != null ? config : new Idea73697Config();
