...
@Data
public class Idea73842Config {
    private String name = "idea_073842";
 ...
 */
@Slf4j
public class Idea73842Service {
    private static final int IDEA_ID = 73842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73842Service() {
        this(new Idea73842Config());
    }

    public Idea73842Service(Idea73842Config config) {
        this.config = config != null ? config : new Idea73842Config();
