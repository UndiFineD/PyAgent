...
@Data
public class Idea73987Config {
    private String name = "idea_073987";
 ...
 */
@Slf4j
public class Idea73987Service {
    private static final int IDEA_ID = 73987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73987Service() {
        this(new Idea73987Config());
    }

    public Idea73987Service(Idea73987Config config) {
        this.config = config != null ? config : new Idea73987Config();
