...
@Data
public class Idea73934Config {
    private String name = "idea_073934";
 ...
 */
@Slf4j
public class Idea73934Service {
    private static final int IDEA_ID = 73934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73934Service() {
        this(new Idea73934Config());
    }

    public Idea73934Service(Idea73934Config config) {
        this.config = config != null ? config : new Idea73934Config();
