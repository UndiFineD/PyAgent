...
@Data
public class Idea73757Config {
    private String name = "idea_073757";
 ...
 */
@Slf4j
public class Idea73757Service {
    private static final int IDEA_ID = 73757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73757Service() {
        this(new Idea73757Config());
    }

    public Idea73757Service(Idea73757Config config) {
        this.config = config != null ? config : new Idea73757Config();
