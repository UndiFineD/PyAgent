...
@Data
public class Idea74003Config {
    private String name = "idea_074003";
 ...
 */
@Slf4j
public class Idea74003Service {
    private static final int IDEA_ID = 74003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74003Service() {
        this(new Idea74003Config());
    }

    public Idea74003Service(Idea74003Config config) {
        this.config = config != null ? config : new Idea74003Config();
