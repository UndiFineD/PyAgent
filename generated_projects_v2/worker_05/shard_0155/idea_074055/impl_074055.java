...
@Data
public class Idea74055Config {
    private String name = "idea_074055";
 ...
 */
@Slf4j
public class Idea74055Service {
    private static final int IDEA_ID = 74055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74055Service() {
        this(new Idea74055Config());
    }

    public Idea74055Service(Idea74055Config config) {
        this.config = config != null ? config : new Idea74055Config();
