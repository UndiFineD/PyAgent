...
@Data
public class Idea73909Config {
    private String name = "idea_073909";
 ...
 */
@Slf4j
public class Idea73909Service {
    private static final int IDEA_ID = 73909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73909Service() {
        this(new Idea73909Config());
    }

    public Idea73909Service(Idea73909Config config) {
        this.config = config != null ? config : new Idea73909Config();
