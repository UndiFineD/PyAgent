...
@Data
public class Idea74096Config {
    private String name = "idea_074096";
 ...
 */
@Slf4j
public class Idea74096Service {
    private static final int IDEA_ID = 74096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74096Service() {
        this(new Idea74096Config());
    }

    public Idea74096Service(Idea74096Config config) {
        this.config = config != null ? config : new Idea74096Config();
