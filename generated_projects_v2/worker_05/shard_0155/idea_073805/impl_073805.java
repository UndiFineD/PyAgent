...
@Data
public class Idea73805Config {
    private String name = "idea_073805";
 ...
 */
@Slf4j
public class Idea73805Service {
    private static final int IDEA_ID = 73805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73805Service() {
        this(new Idea73805Config());
    }

    public Idea73805Service(Idea73805Config config) {
        this.config = config != null ? config : new Idea73805Config();
