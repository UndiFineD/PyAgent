...
@Data
public class Idea73714Config {
    private String name = "idea_073714";
 ...
 */
@Slf4j
public class Idea73714Service {
    private static final int IDEA_ID = 73714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73714Service() {
        this(new Idea73714Config());
    }

    public Idea73714Service(Idea73714Config config) {
        this.config = config != null ? config : new Idea73714Config();
