...
@Data
public class Idea73846Config {
    private String name = "idea_073846";
 ...
 */
@Slf4j
public class Idea73846Service {
    private static final int IDEA_ID = 73846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73846Service() {
        this(new Idea73846Config());
    }

    public Idea73846Service(Idea73846Config config) {
        this.config = config != null ? config : new Idea73846Config();
