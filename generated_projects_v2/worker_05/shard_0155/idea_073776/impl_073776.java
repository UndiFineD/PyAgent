...
@Data
public class Idea73776Config {
    private String name = "idea_073776";
 ...
 */
@Slf4j
public class Idea73776Service {
    private static final int IDEA_ID = 73776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73776Service() {
        this(new Idea73776Config());
    }

    public Idea73776Service(Idea73776Config config) {
        this.config = config != null ? config : new Idea73776Config();
