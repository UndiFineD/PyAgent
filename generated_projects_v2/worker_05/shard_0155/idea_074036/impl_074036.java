...
@Data
public class Idea74036Config {
    private String name = "idea_074036";
 ...
 */
@Slf4j
public class Idea74036Service {
    private static final int IDEA_ID = 74036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74036Service() {
        this(new Idea74036Config());
    }

    public Idea74036Service(Idea74036Config config) {
        this.config = config != null ? config : new Idea74036Config();
