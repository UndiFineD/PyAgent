...
@Data
public class Idea73827Config {
    private String name = "idea_073827";
 ...
 */
@Slf4j
public class Idea73827Service {
    private static final int IDEA_ID = 73827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73827Service() {
        this(new Idea73827Config());
    }

    public Idea73827Service(Idea73827Config config) {
        this.config = config != null ? config : new Idea73827Config();
