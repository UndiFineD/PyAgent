...
@Data
public class Idea73664Config {
    private String name = "idea_073664";
 ...
 */
@Slf4j
public class Idea73664Service {
    private static final int IDEA_ID = 73664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73664Service() {
        this(new Idea73664Config());
    }

    public Idea73664Service(Idea73664Config config) {
        this.config = config != null ? config : new Idea73664Config();
