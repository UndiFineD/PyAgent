...
@Data
public class Idea73777Config {
    private String name = "idea_073777";
 ...
 */
@Slf4j
public class Idea73777Service {
    private static final int IDEA_ID = 73777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73777Service() {
        this(new Idea73777Config());
    }

    public Idea73777Service(Idea73777Config config) {
        this.config = config != null ? config : new Idea73777Config();
