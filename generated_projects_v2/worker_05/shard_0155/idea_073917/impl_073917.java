...
@Data
public class Idea73917Config {
    private String name = "idea_073917";
 ...
 */
@Slf4j
public class Idea73917Service {
    private static final int IDEA_ID = 73917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73917Service() {
        this(new Idea73917Config());
    }

    public Idea73917Service(Idea73917Config config) {
        this.config = config != null ? config : new Idea73917Config();
