...
@Data
public class Idea73891Config {
    private String name = "idea_073891";
 ...
 */
@Slf4j
public class Idea73891Service {
    private static final int IDEA_ID = 73891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73891Service() {
        this(new Idea73891Config());
    }

    public Idea73891Service(Idea73891Config config) {
        this.config = config != null ? config : new Idea73891Config();
