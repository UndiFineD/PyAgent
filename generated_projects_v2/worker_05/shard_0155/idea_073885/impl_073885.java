...
@Data
public class Idea73885Config {
    private String name = "idea_073885";
 ...
 */
@Slf4j
public class Idea73885Service {
    private static final int IDEA_ID = 73885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73885Service() {
        this(new Idea73885Config());
    }

    public Idea73885Service(Idea73885Config config) {
        this.config = config != null ? config : new Idea73885Config();
