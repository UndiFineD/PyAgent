...
@Data
public class Idea74006Config {
    private String name = "idea_074006";
 ...
 */
@Slf4j
public class Idea74006Service {
    private static final int IDEA_ID = 74006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74006Service() {
        this(new Idea74006Config());
    }

    public Idea74006Service(Idea74006Config config) {
        this.config = config != null ? config : new Idea74006Config();
