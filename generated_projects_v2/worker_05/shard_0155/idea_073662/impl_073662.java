...
@Data
public class Idea73662Config {
    private String name = "idea_073662";
 ...
 */
@Slf4j
public class Idea73662Service {
    private static final int IDEA_ID = 73662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73662Service() {
        this(new Idea73662Config());
    }

    public Idea73662Service(Idea73662Config config) {
        this.config = config != null ? config : new Idea73662Config();
