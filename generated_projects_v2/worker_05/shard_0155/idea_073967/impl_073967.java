...
@Data
public class Idea73967Config {
    private String name = "idea_073967";
 ...
 */
@Slf4j
public class Idea73967Service {
    private static final int IDEA_ID = 73967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73967Service() {
        this(new Idea73967Config());
    }

    public Idea73967Service(Idea73967Config config) {
        this.config = config != null ? config : new Idea73967Config();
