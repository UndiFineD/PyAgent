...
@Data
public class Idea74076Config {
    private String name = "idea_074076";
 ...
 */
@Slf4j
public class Idea74076Service {
    private static final int IDEA_ID = 74076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74076Service() {
        this(new Idea74076Config());
    }

    public Idea74076Service(Idea74076Config config) {
        this.config = config != null ? config : new Idea74076Config();
