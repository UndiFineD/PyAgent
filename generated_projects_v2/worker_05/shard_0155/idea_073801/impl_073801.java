...
@Data
public class Idea73801Config {
    private String name = "idea_073801";
 ...
 */
@Slf4j
public class Idea73801Service {
    private static final int IDEA_ID = 73801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73801Service() {
        this(new Idea73801Config());
    }

    public Idea73801Service(Idea73801Config config) {
        this.config = config != null ? config : new Idea73801Config();
