...
@Data
public class Idea73958Config {
    private String name = "idea_073958";
 ...
 */
@Slf4j
public class Idea73958Service {
    private static final int IDEA_ID = 73958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73958Service() {
        this(new Idea73958Config());
    }

    public Idea73958Service(Idea73958Config config) {
        this.config = config != null ? config : new Idea73958Config();
