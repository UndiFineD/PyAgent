...
@Data
public class Idea73679Config {
    private String name = "idea_073679";
 ...
 */
@Slf4j
public class Idea73679Service {
    private static final int IDEA_ID = 73679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73679Service() {
        this(new Idea73679Config());
    }

    public Idea73679Service(Idea73679Config config) {
        this.config = config != null ? config : new Idea73679Config();
