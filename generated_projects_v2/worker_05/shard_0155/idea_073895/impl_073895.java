...
@Data
public class Idea73895Config {
    private String name = "idea_073895";
 ...
 */
@Slf4j
public class Idea73895Service {
    private static final int IDEA_ID = 73895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73895Service() {
        this(new Idea73895Config());
    }

    public Idea73895Service(Idea73895Config config) {
        this.config = config != null ? config : new Idea73895Config();
