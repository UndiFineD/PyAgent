...
@Data
public class Idea73860Config {
    private String name = "idea_073860";
 ...
 */
@Slf4j
public class Idea73860Service {
    private static final int IDEA_ID = 73860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73860Service() {
        this(new Idea73860Config());
    }

    public Idea73860Service(Idea73860Config config) {
        this.config = config != null ? config : new Idea73860Config();
