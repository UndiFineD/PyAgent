...
@Data
public class Idea73858Config {
    private String name = "idea_073858";
 ...
 */
@Slf4j
public class Idea73858Service {
    private static final int IDEA_ID = 73858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73858Service() {
        this(new Idea73858Config());
    }

    public Idea73858Service(Idea73858Config config) {
        this.config = config != null ? config : new Idea73858Config();
