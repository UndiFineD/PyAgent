...
@Data
public class Idea73774Config {
    private String name = "idea_073774";
 ...
 */
@Slf4j
public class Idea73774Service {
    private static final int IDEA_ID = 73774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73774Service() {
        this(new Idea73774Config());
    }

    public Idea73774Service(Idea73774Config config) {
        this.config = config != null ? config : new Idea73774Config();
