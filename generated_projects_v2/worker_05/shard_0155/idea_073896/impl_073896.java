...
@Data
public class Idea73896Config {
    private String name = "idea_073896";
 ...
 */
@Slf4j
public class Idea73896Service {
    private static final int IDEA_ID = 73896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73896Service() {
        this(new Idea73896Config());
    }

    public Idea73896Service(Idea73896Config config) {
        this.config = config != null ? config : new Idea73896Config();
