...
@Data
public class Idea73753Config {
    private String name = "idea_073753";
 ...
 */
@Slf4j
public class Idea73753Service {
    private static final int IDEA_ID = 73753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73753Service() {
        this(new Idea73753Config());
    }

    public Idea73753Service(Idea73753Config config) {
        this.config = config != null ? config : new Idea73753Config();
