...
@Data
public class Idea73875Config {
    private String name = "idea_073875";
 ...
 */
@Slf4j
public class Idea73875Service {
    private static final int IDEA_ID = 73875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73875Service() {
        this(new Idea73875Config());
    }

    public Idea73875Service(Idea73875Config config) {
        this.config = config != null ? config : new Idea73875Config();
