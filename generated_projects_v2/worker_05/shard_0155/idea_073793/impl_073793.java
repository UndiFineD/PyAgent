...
@Data
public class Idea73793Config {
    private String name = "idea_073793";
 ...
 */
@Slf4j
public class Idea73793Service {
    private static final int IDEA_ID = 73793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73793Service() {
        this(new Idea73793Config());
    }

    public Idea73793Service(Idea73793Config config) {
        this.config = config != null ? config : new Idea73793Config();
