...
@Data
public class Idea74082Config {
    private String name = "idea_074082";
 ...
 */
@Slf4j
public class Idea74082Service {
    private static final int IDEA_ID = 74082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74082Service() {
        this(new Idea74082Config());
    }

    public Idea74082Service(Idea74082Config config) {
        this.config = config != null ? config : new Idea74082Config();
