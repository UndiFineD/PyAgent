...
@Data
public class Idea73954Config {
    private String name = "idea_073954";
 ...
 */
@Slf4j
public class Idea73954Service {
    private static final int IDEA_ID = 73954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73954Service() {
        this(new Idea73954Config());
    }

    public Idea73954Service(Idea73954Config config) {
        this.config = config != null ? config : new Idea73954Config();
