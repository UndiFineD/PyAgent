...
@Data
public class Idea73748Config {
    private String name = "idea_073748";
 ...
 */
@Slf4j
public class Idea73748Service {
    private static final int IDEA_ID = 73748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73748Service() {
        this(new Idea73748Config());
    }

    public Idea73748Service(Idea73748Config config) {
        this.config = config != null ? config : new Idea73748Config();
