...
@Data
public class Idea73745Config {
    private String name = "idea_073745";
 ...
 */
@Slf4j
public class Idea73745Service {
    private static final int IDEA_ID = 73745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73745Service() {
        this(new Idea73745Config());
    }

    public Idea73745Service(Idea73745Config config) {
        this.config = config != null ? config : new Idea73745Config();
