...
@Data
public class Idea73653Config {
    private String name = "idea_073653";
 ...
 */
@Slf4j
public class Idea73653Service {
    private static final int IDEA_ID = 73653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73653Service() {
        this(new Idea73653Config());
    }

    public Idea73653Service(Idea73653Config config) {
        this.config = config != null ? config : new Idea73653Config();
