...
@Data
public class Idea73840Config {
    private String name = "idea_073840";
 ...
 */
@Slf4j
public class Idea73840Service {
    private static final int IDEA_ID = 73840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73840Service() {
        this(new Idea73840Config());
    }

    public Idea73840Service(Idea73840Config config) {
        this.config = config != null ? config : new Idea73840Config();
