...
@Data
public class Idea74013Config {
    private String name = "idea_074013";
 ...
 */
@Slf4j
public class Idea74013Service {
    private static final int IDEA_ID = 74013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74013Service() {
        this(new Idea74013Config());
    }

    public Idea74013Service(Idea74013Config config) {
        this.config = config != null ? config : new Idea74013Config();
