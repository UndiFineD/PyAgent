...
@Data
public class Idea73666Config {
    private String name = "idea_073666";
 ...
 */
@Slf4j
public class Idea73666Service {
    private static final int IDEA_ID = 73666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73666Service() {
        this(new Idea73666Config());
    }

    public Idea73666Service(Idea73666Config config) {
        this.config = config != null ? config : new Idea73666Config();
