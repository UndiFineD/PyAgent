...
@Data
public class Idea73910Config {
    private String name = "idea_073910";
 ...
 */
@Slf4j
public class Idea73910Service {
    private static final int IDEA_ID = 73910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73910Service() {
        this(new Idea73910Config());
    }

    public Idea73910Service(Idea73910Config config) {
        this.config = config != null ? config : new Idea73910Config();
