...
@Data
public class Idea73935Config {
    private String name = "idea_073935";
 ...
 */
@Slf4j
public class Idea73935Service {
    private static final int IDEA_ID = 73935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73935Service() {
        this(new Idea73935Config());
    }

    public Idea73935Service(Idea73935Config config) {
        this.config = config != null ? config : new Idea73935Config();
