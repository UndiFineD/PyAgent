...
@Data
public class Idea74042Config {
    private String name = "idea_074042";
 ...
 */
@Slf4j
public class Idea74042Service {
    private static final int IDEA_ID = 74042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74042Service() {
        this(new Idea74042Config());
    }

    public Idea74042Service(Idea74042Config config) {
        this.config = config != null ? config : new Idea74042Config();
