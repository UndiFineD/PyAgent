...
@Data
public class Idea73718Config {
    private String name = "idea_073718";
 ...
 */
@Slf4j
public class Idea73718Service {
    private static final int IDEA_ID = 73718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73718Service() {
        this(new Idea73718Config());
    }

    public Idea73718Service(Idea73718Config config) {
        this.config = config != null ? config : new Idea73718Config();
