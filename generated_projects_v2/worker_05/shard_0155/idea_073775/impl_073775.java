...
@Data
public class Idea73775Config {
    private String name = "idea_073775";
 ...
 */
@Slf4j
public class Idea73775Service {
    private static final int IDEA_ID = 73775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73775Service() {
        this(new Idea73775Config());
    }

    public Idea73775Service(Idea73775Config config) {
        this.config = config != null ? config : new Idea73775Config();
