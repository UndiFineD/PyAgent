...
@Data
public class Idea73719Config {
    private String name = "idea_073719";
 ...
 */
@Slf4j
public class Idea73719Service {
    private static final int IDEA_ID = 73719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73719Service() {
        this(new Idea73719Config());
    }

    public Idea73719Service(Idea73719Config config) {
        this.config = config != null ? config : new Idea73719Config();
