...
@Data
public class Idea73945Config {
    private String name = "idea_073945";
 ...
 */
@Slf4j
public class Idea73945Service {
    private static final int IDEA_ID = 73945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73945Service() {
        this(new Idea73945Config());
    }

    public Idea73945Service(Idea73945Config config) {
        this.config = config != null ? config : new Idea73945Config();
