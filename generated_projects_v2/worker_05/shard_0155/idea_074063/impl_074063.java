...
@Data
public class Idea74063Config {
    private String name = "idea_074063";
 ...
 */
@Slf4j
public class Idea74063Service {
    private static final int IDEA_ID = 74063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74063Service() {
        this(new Idea74063Config());
    }

    public Idea74063Service(Idea74063Config config) {
        this.config = config != null ? config : new Idea74063Config();
