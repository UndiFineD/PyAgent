...
@Data
public class Idea73821Config {
    private String name = "idea_073821";
 ...
 */
@Slf4j
public class Idea73821Service {
    private static final int IDEA_ID = 73821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73821Service() {
        this(new Idea73821Config());
    }

    public Idea73821Service(Idea73821Config config) {
        this.config = config != null ? config : new Idea73821Config();
