...
@Data
public class Idea73888Config {
    private String name = "idea_073888";
 ...
 */
@Slf4j
public class Idea73888Service {
    private static final int IDEA_ID = 73888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73888Service() {
        this(new Idea73888Config());
    }

    public Idea73888Service(Idea73888Config config) {
        this.config = config != null ? config : new Idea73888Config();
