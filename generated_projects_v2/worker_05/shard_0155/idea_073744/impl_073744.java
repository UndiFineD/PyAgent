...
@Data
public class Idea73744Config {
    private String name = "idea_073744";
 ...
 */
@Slf4j
public class Idea73744Service {
    private static final int IDEA_ID = 73744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73744Service() {
        this(new Idea73744Config());
    }

    public Idea73744Service(Idea73744Config config) {
        this.config = config != null ? config : new Idea73744Config();
