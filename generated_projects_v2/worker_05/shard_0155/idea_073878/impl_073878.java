...
@Data
public class Idea73878Config {
    private String name = "idea_073878";
 ...
 */
@Slf4j
public class Idea73878Service {
    private static final int IDEA_ID = 73878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73878Service() {
        this(new Idea73878Config());
    }

    public Idea73878Service(Idea73878Config config) {
        this.config = config != null ? config : new Idea73878Config();
