...
@Data
public class Idea73728Config {
    private String name = "idea_073728";
 ...
 */
@Slf4j
public class Idea73728Service {
    private static final int IDEA_ID = 73728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73728Service() {
        this(new Idea73728Config());
    }

    public Idea73728Service(Idea73728Config config) {
        this.config = config != null ? config : new Idea73728Config();
