...
@Data
public class Idea73806Config {
    private String name = "idea_073806";
 ...
 */
@Slf4j
public class Idea73806Service {
    private static final int IDEA_ID = 73806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73806Service() {
        this(new Idea73806Config());
    }

    public Idea73806Service(Idea73806Config config) {
        this.config = config != null ? config : new Idea73806Config();
