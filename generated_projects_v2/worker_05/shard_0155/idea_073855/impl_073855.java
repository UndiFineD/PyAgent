...
@Data
public class Idea73855Config {
    private String name = "idea_073855";
 ...
 */
@Slf4j
public class Idea73855Service {
    private static final int IDEA_ID = 73855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73855Service() {
        this(new Idea73855Config());
    }

    public Idea73855Service(Idea73855Config config) {
        this.config = config != null ? config : new Idea73855Config();
