...
@Data
public class Idea73914Config {
    private String name = "idea_073914";
 ...
 */
@Slf4j
public class Idea73914Service {
    private static final int IDEA_ID = 73914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73914Service() {
        this(new Idea73914Config());
    }

    public Idea73914Service(Idea73914Config config) {
        this.config = config != null ? config : new Idea73914Config();
