...
@Data
public class Idea73639Config {
    private String name = "idea_073639";
 ...
 */
@Slf4j
public class Idea73639Service {
    private static final int IDEA_ID = 73639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73639Service() {
        this(new Idea73639Config());
    }

    public Idea73639Service(Idea73639Config config) {
        this.config = config != null ? config : new Idea73639Config();
