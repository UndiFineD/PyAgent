...
@Data
public class Idea73701Config {
    private String name = "idea_073701";
 ...
 */
@Slf4j
public class Idea73701Service {
    private static final int IDEA_ID = 73701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73701Service() {
        this(new Idea73701Config());
    }

    public Idea73701Service(Idea73701Config config) {
        this.config = config != null ? config : new Idea73701Config();
