...
@Data
public class Idea73982Config {
    private String name = "idea_073982";
 ...
 */
@Slf4j
public class Idea73982Service {
    private static final int IDEA_ID = 73982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73982Service() {
        this(new Idea73982Config());
    }

    public Idea73982Service(Idea73982Config config) {
        this.config = config != null ? config : new Idea73982Config();
