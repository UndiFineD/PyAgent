...
@Data
public class Idea74027Config {
    private String name = "idea_074027";
 ...
 */
@Slf4j
public class Idea74027Service {
    private static final int IDEA_ID = 74027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74027Service() {
        this(new Idea74027Config());
    }

    public Idea74027Service(Idea74027Config config) {
        this.config = config != null ? config : new Idea74027Config();
