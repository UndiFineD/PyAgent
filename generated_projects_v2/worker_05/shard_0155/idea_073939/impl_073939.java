...
@Data
public class Idea73939Config {
    private String name = "idea_073939";
 ...
 */
@Slf4j
public class Idea73939Service {
    private static final int IDEA_ID = 73939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73939Service() {
        this(new Idea73939Config());
    }

    public Idea73939Service(Idea73939Config config) {
        this.config = config != null ? config : new Idea73939Config();
