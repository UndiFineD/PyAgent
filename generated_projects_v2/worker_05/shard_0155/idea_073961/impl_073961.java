...
@Data
public class Idea73961Config {
    private String name = "idea_073961";
 ...
 */
@Slf4j
public class Idea73961Service {
    private static final int IDEA_ID = 73961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73961Service() {
        this(new Idea73961Config());
    }

    public Idea73961Service(Idea73961Config config) {
        this.config = config != null ? config : new Idea73961Config();
