...
@Data
public class Idea73854Config {
    private String name = "idea_073854";
 ...
 */
@Slf4j
public class Idea73854Service {
    private static final int IDEA_ID = 73854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73854Service() {
        this(new Idea73854Config());
    }

    public Idea73854Service(Idea73854Config config) {
        this.config = config != null ? config : new Idea73854Config();
