...
@Data
public class Idea74044Config {
    private String name = "idea_074044";
 ...
 */
@Slf4j
public class Idea74044Service {
    private static final int IDEA_ID = 74044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74044Service() {
        this(new Idea74044Config());
    }

    public Idea74044Service(Idea74044Config config) {
        this.config = config != null ? config : new Idea74044Config();
