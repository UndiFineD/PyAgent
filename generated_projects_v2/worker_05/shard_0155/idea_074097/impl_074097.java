...
@Data
public class Idea74097Config {
    private String name = "idea_074097";
 ...
 */
@Slf4j
public class Idea74097Service {
    private static final int IDEA_ID = 74097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74097Service() {
        this(new Idea74097Config());
    }

    public Idea74097Service(Idea74097Config config) {
        this.config = config != null ? config : new Idea74097Config();
