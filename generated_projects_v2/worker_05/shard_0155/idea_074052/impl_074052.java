...
@Data
public class Idea74052Config {
    private String name = "idea_074052";
 ...
 */
@Slf4j
public class Idea74052Service {
    private static final int IDEA_ID = 74052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74052Service() {
        this(new Idea74052Config());
    }

    public Idea74052Service(Idea74052Config config) {
        this.config = config != null ? config : new Idea74052Config();
