...
@Data
public class Idea73866Config {
    private String name = "idea_073866";
 ...
 */
@Slf4j
public class Idea73866Service {
    private static final int IDEA_ID = 73866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73866Service() {
        this(new Idea73866Config());
    }

    public Idea73866Service(Idea73866Config config) {
        this.config = config != null ? config : new Idea73866Config();
