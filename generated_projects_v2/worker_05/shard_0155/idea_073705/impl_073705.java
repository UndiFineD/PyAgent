...
@Data
public class Idea73705Config {
    private String name = "idea_073705";
 ...
 */
@Slf4j
public class Idea73705Service {
    private static final int IDEA_ID = 73705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73705Service() {
        this(new Idea73705Config());
    }

    public Idea73705Service(Idea73705Config config) {
        this.config = config != null ? config : new Idea73705Config();
