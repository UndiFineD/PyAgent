...
@Data
public class Idea73876Config {
    private String name = "idea_073876";
 ...
 */
@Slf4j
public class Idea73876Service {
    private static final int IDEA_ID = 73876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73876Service() {
        this(new Idea73876Config());
    }

    public Idea73876Service(Idea73876Config config) {
        this.config = config != null ? config : new Idea73876Config();
