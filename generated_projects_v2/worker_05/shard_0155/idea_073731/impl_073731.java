...
@Data
public class Idea73731Config {
    private String name = "idea_073731";
 ...
 */
@Slf4j
public class Idea73731Service {
    private static final int IDEA_ID = 73731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73731Service() {
        this(new Idea73731Config());
    }

    public Idea73731Service(Idea73731Config config) {
        this.config = config != null ? config : new Idea73731Config();
