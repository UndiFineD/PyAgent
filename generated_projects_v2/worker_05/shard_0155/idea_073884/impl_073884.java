...
@Data
public class Idea73884Config {
    private String name = "idea_073884";
 ...
 */
@Slf4j
public class Idea73884Service {
    private static final int IDEA_ID = 73884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73884Service() {
        this(new Idea73884Config());
    }

    public Idea73884Service(Idea73884Config config) {
        this.config = config != null ? config : new Idea73884Config();
