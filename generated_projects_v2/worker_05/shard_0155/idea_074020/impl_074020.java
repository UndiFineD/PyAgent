...
@Data
public class Idea74020Config {
    private String name = "idea_074020";
 ...
 */
@Slf4j
public class Idea74020Service {
    private static final int IDEA_ID = 74020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74020Service() {
        this(new Idea74020Config());
    }

    public Idea74020Service(Idea74020Config config) {
        this.config = config != null ? config : new Idea74020Config();
