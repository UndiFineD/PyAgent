...
@Data
public class Idea74081Config {
    private String name = "idea_074081";
 ...
 */
@Slf4j
public class Idea74081Service {
    private static final int IDEA_ID = 74081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74081Service() {
        this(new Idea74081Config());
    }

    public Idea74081Service(Idea74081Config config) {
        this.config = config != null ? config : new Idea74081Config();
