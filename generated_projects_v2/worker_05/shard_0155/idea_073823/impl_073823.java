...
@Data
public class Idea73823Config {
    private String name = "idea_073823";
 ...
 */
@Slf4j
public class Idea73823Service {
    private static final int IDEA_ID = 73823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73823Service() {
        this(new Idea73823Config());
    }

    public Idea73823Service(Idea73823Config config) {
        this.config = config != null ? config : new Idea73823Config();
