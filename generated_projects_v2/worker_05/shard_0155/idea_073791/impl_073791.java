...
@Data
public class Idea73791Config {
    private String name = "idea_073791";
 ...
 */
@Slf4j
public class Idea73791Service {
    private static final int IDEA_ID = 73791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73791Service() {
        this(new Idea73791Config());
    }

    public Idea73791Service(Idea73791Config config) {
        this.config = config != null ? config : new Idea73791Config();
