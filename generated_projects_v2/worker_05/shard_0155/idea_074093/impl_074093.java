...
@Data
public class Idea74093Config {
    private String name = "idea_074093";
 ...
 */
@Slf4j
public class Idea74093Service {
    private static final int IDEA_ID = 74093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74093Service() {
        this(new Idea74093Config());
    }

    public Idea74093Service(Idea74093Config config) {
        this.config = config != null ? config : new Idea74093Config();
