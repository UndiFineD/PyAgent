...
@Data
public class Idea73946Config {
    private String name = "idea_073946";
 ...
 */
@Slf4j
public class Idea73946Service {
    private static final int IDEA_ID = 73946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73946Service() {
        this(new Idea73946Config());
    }

    public Idea73946Service(Idea73946Config config) {
        this.config = config != null ? config : new Idea73946Config();
