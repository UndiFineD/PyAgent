...
@Data
public class Idea73626Config {
    private String name = "idea_073626";
 ...
 */
@Slf4j
public class Idea73626Service {
    private static final int IDEA_ID = 73626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73626Service() {
        this(new Idea73626Config());
    }

    public Idea73626Service(Idea73626Config config) {
        this.config = config != null ? config : new Idea73626Config();
