...
@Data
public class Idea73704Config {
    private String name = "idea_073704";
 ...
 */
@Slf4j
public class Idea73704Service {
    private static final int IDEA_ID = 73704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73704Service() {
        this(new Idea73704Config());
    }

    public Idea73704Service(Idea73704Config config) {
        this.config = config != null ? config : new Idea73704Config();
