...
@Data
public class Idea73959Config {
    private String name = "idea_073959";
 ...
 */
@Slf4j
public class Idea73959Service {
    private static final int IDEA_ID = 73959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73959Service() {
        this(new Idea73959Config());
    }

    public Idea73959Service(Idea73959Config config) {
        this.config = config != null ? config : new Idea73959Config();
