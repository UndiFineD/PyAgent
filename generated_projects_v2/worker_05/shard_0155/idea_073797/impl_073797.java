...
@Data
public class Idea73797Config {
    private String name = "idea_073797";
 ...
 */
@Slf4j
public class Idea73797Service {
    private static final int IDEA_ID = 73797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73797Service() {
        this(new Idea73797Config());
    }

    public Idea73797Service(Idea73797Config config) {
        this.config = config != null ? config : new Idea73797Config();
