...
@Data
public class Idea73711Config {
    private String name = "idea_073711";
 ...
 */
@Slf4j
public class Idea73711Service {
    private static final int IDEA_ID = 73711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73711Service() {
        this(new Idea73711Config());
    }

    public Idea73711Service(Idea73711Config config) {
        this.config = config != null ? config : new Idea73711Config();
