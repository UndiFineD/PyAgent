...
@Data
public class Idea74023Config {
    private String name = "idea_074023";
 ...
 */
@Slf4j
public class Idea74023Service {
    private static final int IDEA_ID = 74023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74023Service() {
        this(new Idea74023Config());
    }

    public Idea74023Service(Idea74023Config config) {
        this.config = config != null ? config : new Idea74023Config();
