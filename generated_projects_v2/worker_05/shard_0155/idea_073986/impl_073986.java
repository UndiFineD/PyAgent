...
@Data
public class Idea73986Config {
    private String name = "idea_073986";
 ...
 */
@Slf4j
public class Idea73986Service {
    private static final int IDEA_ID = 73986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73986Service() {
        this(new Idea73986Config());
    }

    public Idea73986Service(Idea73986Config config) {
        this.config = config != null ? config : new Idea73986Config();
