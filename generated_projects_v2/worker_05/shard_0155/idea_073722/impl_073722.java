...
@Data
public class Idea73722Config {
    private String name = "idea_073722";
 ...
 */
@Slf4j
public class Idea73722Service {
    private static final int IDEA_ID = 73722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73722Service() {
        this(new Idea73722Config());
    }

    public Idea73722Service(Idea73722Config config) {
        this.config = config != null ? config : new Idea73722Config();
