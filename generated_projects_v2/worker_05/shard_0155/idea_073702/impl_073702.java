...
@Data
public class Idea73702Config {
    private String name = "idea_073702";
 ...
 */
@Slf4j
public class Idea73702Service {
    private static final int IDEA_ID = 73702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73702Service() {
        this(new Idea73702Config());
    }

    public Idea73702Service(Idea73702Config config) {
        this.config = config != null ? config : new Idea73702Config();
