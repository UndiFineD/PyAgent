...
@Data
public class Idea74025Config {
    private String name = "idea_074025";
 ...
 */
@Slf4j
public class Idea74025Service {
    private static final int IDEA_ID = 74025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74025Service() {
        this(new Idea74025Config());
    }

    public Idea74025Service(Idea74025Config config) {
        this.config = config != null ? config : new Idea74025Config();
