...
@Data
public class Idea74071Config {
    private String name = "idea_074071";
 ...
 */
@Slf4j
public class Idea74071Service {
    private static final int IDEA_ID = 74071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74071Service() {
        this(new Idea74071Config());
    }

    public Idea74071Service(Idea74071Config config) {
        this.config = config != null ? config : new Idea74071Config();
