...
@Data
public class Idea74051Config {
    private String name = "idea_074051";
 ...
 */
@Slf4j
public class Idea74051Service {
    private static final int IDEA_ID = 74051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74051Service() {
        this(new Idea74051Config());
    }

    public Idea74051Service(Idea74051Config config) {
        this.config = config != null ? config : new Idea74051Config();
