...
@Data
public class Idea73695Config {
    private String name = "idea_073695";
 ...
 */
@Slf4j
public class Idea73695Service {
    private static final int IDEA_ID = 73695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73695Service() {
        this(new Idea73695Config());
    }

    public Idea73695Service(Idea73695Config config) {
        this.config = config != null ? config : new Idea73695Config();
