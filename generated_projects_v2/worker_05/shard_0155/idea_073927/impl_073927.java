...
@Data
public class Idea73927Config {
    private String name = "idea_073927";
 ...
 */
@Slf4j
public class Idea73927Service {
    private static final int IDEA_ID = 73927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73927Service() {
        this(new Idea73927Config());
    }

    public Idea73927Service(Idea73927Config config) {
        this.config = config != null ? config : new Idea73927Config();
