...
@Data
public class Idea73924Config {
    private String name = "idea_073924";
 ...
 */
@Slf4j
public class Idea73924Service {
    private static final int IDEA_ID = 73924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73924Service() {
        this(new Idea73924Config());
    }

    public Idea73924Service(Idea73924Config config) {
        this.config = config != null ? config : new Idea73924Config();
