...
@Data
public class Idea73960Config {
    private String name = "idea_073960";
 ...
 */
@Slf4j
public class Idea73960Service {
    private static final int IDEA_ID = 73960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73960Service() {
        this(new Idea73960Config());
    }

    public Idea73960Service(Idea73960Config config) {
        this.config = config != null ? config : new Idea73960Config();
