...
@Data
public class Idea73782Config {
    private String name = "idea_073782";
 ...
 */
@Slf4j
public class Idea73782Service {
    private static final int IDEA_ID = 73782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73782Service() {
        this(new Idea73782Config());
    }

    public Idea73782Service(Idea73782Config config) {
        this.config = config != null ? config : new Idea73782Config();
