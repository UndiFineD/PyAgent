...
@Data
public class Idea73756Config {
    private String name = "idea_073756";
 ...
 */
@Slf4j
public class Idea73756Service {
    private static final int IDEA_ID = 73756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73756Service() {
        this(new Idea73756Config());
    }

    public Idea73756Service(Idea73756Config config) {
        this.config = config != null ? config : new Idea73756Config();
