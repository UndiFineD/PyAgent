...
@Data
public class Idea73985Config {
    private String name = "idea_073985";
 ...
 */
@Slf4j
public class Idea73985Service {
    private static final int IDEA_ID = 73985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73985Service() {
        this(new Idea73985Config());
    }

    public Idea73985Service(Idea73985Config config) {
        this.config = config != null ? config : new Idea73985Config();
