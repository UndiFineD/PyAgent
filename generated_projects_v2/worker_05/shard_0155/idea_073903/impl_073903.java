...
@Data
public class Idea73903Config {
    private String name = "idea_073903";
 ...
 */
@Slf4j
public class Idea73903Service {
    private static final int IDEA_ID = 73903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73903Service() {
        this(new Idea73903Config());
    }

    public Idea73903Service(Idea73903Config config) {
        this.config = config != null ? config : new Idea73903Config();
