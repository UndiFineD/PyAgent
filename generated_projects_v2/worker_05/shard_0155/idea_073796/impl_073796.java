...
@Data
public class Idea73796Config {
    private String name = "idea_073796";
 ...
 */
@Slf4j
public class Idea73796Service {
    private static final int IDEA_ID = 73796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73796Service() {
        this(new Idea73796Config());
    }

    public Idea73796Service(Idea73796Config config) {
        this.config = config != null ? config : new Idea73796Config();
