...
@Data
public class Idea73918Config {
    private String name = "idea_073918";
 ...
 */
@Slf4j
public class Idea73918Service {
    private static final int IDEA_ID = 73918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73918Service() {
        this(new Idea73918Config());
    }

    public Idea73918Service(Idea73918Config config) {
        this.config = config != null ? config : new Idea73918Config();
