...
@Data
public class Idea73973Config {
    private String name = "idea_073973";
 ...
 */
@Slf4j
public class Idea73973Service {
    private static final int IDEA_ID = 73973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73973Service() {
        this(new Idea73973Config());
    }

    public Idea73973Service(Idea73973Config config) {
        this.config = config != null ? config : new Idea73973Config();
