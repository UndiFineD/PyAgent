...
@Data
public class Idea73629Config {
    private String name = "idea_073629";
 ...
 */
@Slf4j
public class Idea73629Service {
    private static final int IDEA_ID = 73629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73629Service() {
        this(new Idea73629Config());
    }

    public Idea73629Service(Idea73629Config config) {
        this.config = config != null ? config : new Idea73629Config();
