...
@Data
public class Idea73988Config {
    private String name = "idea_073988";
 ...
 */
@Slf4j
public class Idea73988Service {
    private static final int IDEA_ID = 73988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73988Service() {
        this(new Idea73988Config());
    }

    public Idea73988Service(Idea73988Config config) {
        this.config = config != null ? config : new Idea73988Config();
