...
@Data
public class Idea73965Config {
    private String name = "idea_073965";
 ...
 */
@Slf4j
public class Idea73965Service {
    private static final int IDEA_ID = 73965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73965Service() {
        this(new Idea73965Config());
    }

    public Idea73965Service(Idea73965Config config) {
        this.config = config != null ? config : new Idea73965Config();
