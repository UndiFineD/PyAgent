...
@Data
public class Idea74053Config {
    private String name = "idea_074053";
 ...
 */
@Slf4j
public class Idea74053Service {
    private static final int IDEA_ID = 74053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74053Service() {
        this(new Idea74053Config());
    }

    public Idea74053Service(Idea74053Config config) {
        this.config = config != null ? config : new Idea74053Config();
