...
@Data
public class Idea74049Config {
    private String name = "idea_074049";
 ...
 */
@Slf4j
public class Idea74049Service {
    private static final int IDEA_ID = 74049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74049Service() {
        this(new Idea74049Config());
    }

    public Idea74049Service(Idea74049Config config) {
        this.config = config != null ? config : new Idea74049Config();
