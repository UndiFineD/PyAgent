...
@Data
public class Idea73849Config {
    private String name = "idea_073849";
 ...
 */
@Slf4j
public class Idea73849Service {
    private static final int IDEA_ID = 73849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73849Service() {
        this(new Idea73849Config());
    }

    public Idea73849Service(Idea73849Config config) {
        this.config = config != null ? config : new Idea73849Config();
