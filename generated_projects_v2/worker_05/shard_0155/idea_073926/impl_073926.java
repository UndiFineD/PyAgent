...
@Data
public class Idea73926Config {
    private String name = "idea_073926";
 ...
 */
@Slf4j
public class Idea73926Service {
    private static final int IDEA_ID = 73926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73926Service() {
        this(new Idea73926Config());
    }

    public Idea73926Service(Idea73926Config config) {
        this.config = config != null ? config : new Idea73926Config();
