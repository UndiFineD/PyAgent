...
@Data
public class Idea73816Config {
    private String name = "idea_073816";
 ...
 */
@Slf4j
public class Idea73816Service {
    private static final int IDEA_ID = 73816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73816Service() {
        this(new Idea73816Config());
    }

    public Idea73816Service(Idea73816Config config) {
        this.config = config != null ? config : new Idea73816Config();
