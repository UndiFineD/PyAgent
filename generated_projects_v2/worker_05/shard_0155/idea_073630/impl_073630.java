...
@Data
public class Idea73630Config {
    private String name = "idea_073630";
 ...
 */
@Slf4j
public class Idea73630Service {
    private static final int IDEA_ID = 73630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73630Service() {
        this(new Idea73630Config());
    }

    public Idea73630Service(Idea73630Config config) {
        this.config = config != null ? config : new Idea73630Config();
