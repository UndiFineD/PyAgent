...
@Data
public class Idea73115Config {
    private String name = "idea_073115";
 ...
 */
@Slf4j
public class Idea73115Service {
    private static final int IDEA_ID = 73115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73115Service() {
        this(new Idea73115Config());
    }

    public Idea73115Service(Idea73115Config config) {
        this.config = config != null ? config : new Idea73115Config();
