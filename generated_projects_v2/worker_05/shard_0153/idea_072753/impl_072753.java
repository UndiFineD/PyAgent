...
@Data
public class Idea72753Config {
    private String name = "idea_072753";
 ...
 */
@Slf4j
public class Idea72753Service {
    private static final int IDEA_ID = 72753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72753Service() {
        this(new Idea72753Config());
    }

    public Idea72753Service(Idea72753Config config) {
        this.config = config != null ? config : new Idea72753Config();
