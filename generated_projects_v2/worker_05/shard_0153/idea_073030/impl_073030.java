...
@Data
public class Idea73030Config {
    private String name = "idea_073030";
 ...
 */
@Slf4j
public class Idea73030Service {
    private static final int IDEA_ID = 73030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73030Service() {
        this(new Idea73030Config());
    }

    public Idea73030Service(Idea73030Config config) {
        this.config = config != null ? config : new Idea73030Config();
