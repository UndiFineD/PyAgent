...
@Data
public class Idea73095Config {
    private String name = "idea_073095";
 ...
 */
@Slf4j
public class Idea73095Service {
    private static final int IDEA_ID = 73095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73095Service() {
        this(new Idea73095Config());
    }

    public Idea73095Service(Idea73095Config config) {
        this.config = config != null ? config : new Idea73095Config();
