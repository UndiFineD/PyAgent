...
@Data
public class Idea72933Config {
    private String name = "idea_072933";
 ...
 */
@Slf4j
public class Idea72933Service {
    private static final int IDEA_ID = 72933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72933Service() {
        this(new Idea72933Config());
    }

    public Idea72933Service(Idea72933Config config) {
        this.config = config != null ? config : new Idea72933Config();
