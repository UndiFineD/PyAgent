...
@Data
public class Idea73036Config {
    private String name = "idea_073036";
 ...
 */
@Slf4j
public class Idea73036Service {
    private static final int IDEA_ID = 73036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73036Service() {
        this(new Idea73036Config());
    }

    public Idea73036Service(Idea73036Config config) {
        this.config = config != null ? config : new Idea73036Config();
