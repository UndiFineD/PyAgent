...
@Data
public class Idea72763Config {
    private String name = "idea_072763";
 ...
 */
@Slf4j
public class Idea72763Service {
    private static final int IDEA_ID = 72763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72763Service() {
        this(new Idea72763Config());
    }

    public Idea72763Service(Idea72763Config config) {
        this.config = config != null ? config : new Idea72763Config();
