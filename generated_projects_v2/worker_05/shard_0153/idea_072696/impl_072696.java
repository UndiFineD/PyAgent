...
@Data
public class Idea72696Config {
    private String name = "idea_072696";
 ...
 */
@Slf4j
public class Idea72696Service {
    private static final int IDEA_ID = 72696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72696Service() {
        this(new Idea72696Config());
    }

    public Idea72696Service(Idea72696Config config) {
        this.config = config != null ? config : new Idea72696Config();
