...
@Data
public class Idea73066Config {
    private String name = "idea_073066";
 ...
 */
@Slf4j
public class Idea73066Service {
    private static final int IDEA_ID = 73066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73066Service() {
        this(new Idea73066Config());
    }

    public Idea73066Service(Idea73066Config config) {
        this.config = config != null ? config : new Idea73066Config();
