...
@Data
public class Idea72977Config {
    private String name = "idea_072977";
 ...
 */
@Slf4j
public class Idea72977Service {
    private static final int IDEA_ID = 72977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72977Service() {
        this(new Idea72977Config());
    }

    public Idea72977Service(Idea72977Config config) {
        this.config = config != null ? config : new Idea72977Config();
