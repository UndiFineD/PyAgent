...
@Data
public class Idea72725Config {
    private String name = "idea_072725";
 ...
 */
@Slf4j
public class Idea72725Service {
    private static final int IDEA_ID = 72725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72725Service() {
        this(new Idea72725Config());
    }

    public Idea72725Service(Idea72725Config config) {
        this.config = config != null ? config : new Idea72725Config();
