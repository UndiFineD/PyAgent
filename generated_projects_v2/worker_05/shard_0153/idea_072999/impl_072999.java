...
@Data
public class Idea72999Config {
    private String name = "idea_072999";
 ...
 */
@Slf4j
public class Idea72999Service {
    private static final int IDEA_ID = 72999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72999Service() {
        this(new Idea72999Config());
    }

    public Idea72999Service(Idea72999Config config) {
        this.config = config != null ? config : new Idea72999Config();
