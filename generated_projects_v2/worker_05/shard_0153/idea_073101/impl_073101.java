...
@Data
public class Idea73101Config {
    private String name = "idea_073101";
 ...
 */
@Slf4j
public class Idea73101Service {
    private static final int IDEA_ID = 73101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73101Service() {
        this(new Idea73101Config());
    }

    public Idea73101Service(Idea73101Config config) {
        this.config = config != null ? config : new Idea73101Config();
