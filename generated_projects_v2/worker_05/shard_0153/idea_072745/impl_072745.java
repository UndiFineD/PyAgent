...
@Data
public class Idea72745Config {
    private String name = "idea_072745";
 ...
 */
@Slf4j
public class Idea72745Service {
    private static final int IDEA_ID = 72745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72745Service() {
        this(new Idea72745Config());
    }

    public Idea72745Service(Idea72745Config config) {
        this.config = config != null ? config : new Idea72745Config();
