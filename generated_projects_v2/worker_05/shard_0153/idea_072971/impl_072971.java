...
@Data
public class Idea72971Config {
    private String name = "idea_072971";
 ...
 */
@Slf4j
public class Idea72971Service {
    private static final int IDEA_ID = 72971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72971Service() {
        this(new Idea72971Config());
    }

    public Idea72971Service(Idea72971Config config) {
        this.config = config != null ? config : new Idea72971Config();
