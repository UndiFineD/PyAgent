...
@Data
public class Idea73051Config {
    private String name = "idea_073051";
 ...
 */
@Slf4j
public class Idea73051Service {
    private static final int IDEA_ID = 73051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73051Service() {
        this(new Idea73051Config());
    }

    public Idea73051Service(Idea73051Config config) {
        this.config = config != null ? config : new Idea73051Config();
