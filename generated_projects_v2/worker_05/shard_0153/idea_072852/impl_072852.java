...
@Data
public class Idea72852Config {
    private String name = "idea_072852";
 ...
 */
@Slf4j
public class Idea72852Service {
    private static final int IDEA_ID = 72852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72852Service() {
        this(new Idea72852Config());
    }

    public Idea72852Service(Idea72852Config config) {
        this.config = config != null ? config : new Idea72852Config();
