...
@Data
public class Idea72837Config {
    private String name = "idea_072837";
 ...
 */
@Slf4j
public class Idea72837Service {
    private static final int IDEA_ID = 72837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72837Service() {
        this(new Idea72837Config());
    }

    public Idea72837Service(Idea72837Config config) {
        this.config = config != null ? config : new Idea72837Config();
