...
@Data
public class Idea72803Config {
    private String name = "idea_072803";
 ...
 */
@Slf4j
public class Idea72803Service {
    private static final int IDEA_ID = 72803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72803Service() {
        this(new Idea72803Config());
    }

    public Idea72803Service(Idea72803Config config) {
        this.config = config != null ? config : new Idea72803Config();
