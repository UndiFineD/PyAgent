...
@Data
public class Idea73093Config {
    private String name = "idea_073093";
 ...
 */
@Slf4j
public class Idea73093Service {
    private static final int IDEA_ID = 73093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73093Service() {
        this(new Idea73093Config());
    }

    public Idea73093Service(Idea73093Config config) {
        this.config = config != null ? config : new Idea73093Config();
