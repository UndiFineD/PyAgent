...
@Data
public class Idea72677Config {
    private String name = "idea_072677";
 ...
 */
@Slf4j
public class Idea72677Service {
    private static final int IDEA_ID = 72677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72677Service() {
        this(new Idea72677Config());
    }

    public Idea72677Service(Idea72677Config config) {
        this.config = config != null ? config : new Idea72677Config();
