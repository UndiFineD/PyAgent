...
@Data
public class Idea72897Config {
    private String name = "idea_072897";
 ...
 */
@Slf4j
public class Idea72897Service {
    private static final int IDEA_ID = 72897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72897Service() {
        this(new Idea72897Config());
    }

    public Idea72897Service(Idea72897Config config) {
        this.config = config != null ? config : new Idea72897Config();
