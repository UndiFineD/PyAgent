...
@Data
public class Idea73079Config {
    private String name = "idea_073079";
 ...
 */
@Slf4j
public class Idea73079Service {
    private static final int IDEA_ID = 73079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73079Service() {
        this(new Idea73079Config());
    }

    public Idea73079Service(Idea73079Config config) {
        this.config = config != null ? config : new Idea73079Config();
