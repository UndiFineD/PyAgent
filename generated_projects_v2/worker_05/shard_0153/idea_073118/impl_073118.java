...
@Data
public class Idea73118Config {
    private String name = "idea_073118";
 ...
 */
@Slf4j
public class Idea73118Service {
    private static final int IDEA_ID = 73118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73118Service() {
        this(new Idea73118Config());
    }

    public Idea73118Service(Idea73118Config config) {
        this.config = config != null ? config : new Idea73118Config();
