...
@Data
public class Idea72931Config {
    private String name = "idea_072931";
 ...
 */
@Slf4j
public class Idea72931Service {
    private static final int IDEA_ID = 72931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72931Service() {
        this(new Idea72931Config());
    }

    public Idea72931Service(Idea72931Config config) {
        this.config = config != null ? config : new Idea72931Config();
