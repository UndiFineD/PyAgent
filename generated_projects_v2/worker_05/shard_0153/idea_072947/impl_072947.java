...
@Data
public class Idea72947Config {
    private String name = "idea_072947";
 ...
 */
@Slf4j
public class Idea72947Service {
    private static final int IDEA_ID = 72947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72947Service() {
        this(new Idea72947Config());
    }

    public Idea72947Service(Idea72947Config config) {
        this.config = config != null ? config : new Idea72947Config();
