...
@Data
public class Idea73025Config {
    private String name = "idea_073025";
 ...
 */
@Slf4j
public class Idea73025Service {
    private static final int IDEA_ID = 73025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73025Service() {
        this(new Idea73025Config());
    }

    public Idea73025Service(Idea73025Config config) {
        this.config = config != null ? config : new Idea73025Config();
