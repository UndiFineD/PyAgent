...
@Data
public class Idea72794Config {
    private String name = "idea_072794";
 ...
 */
@Slf4j
public class Idea72794Service {
    private static final int IDEA_ID = 72794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72794Service() {
        this(new Idea72794Config());
    }

    public Idea72794Service(Idea72794Config config) {
        this.config = config != null ? config : new Idea72794Config();
