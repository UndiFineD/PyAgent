...
@Data
public class Idea72783Config {
    private String name = "idea_072783";
 ...
 */
@Slf4j
public class Idea72783Service {
    private static final int IDEA_ID = 72783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72783Service() {
        this(new Idea72783Config());
    }

    public Idea72783Service(Idea72783Config config) {
        this.config = config != null ? config : new Idea72783Config();
