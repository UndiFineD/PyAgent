...
@Data
public class Idea72895Config {
    private String name = "idea_072895";
 ...
 */
@Slf4j
public class Idea72895Service {
    private static final int IDEA_ID = 72895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72895Service() {
        this(new Idea72895Config());
    }

    public Idea72895Service(Idea72895Config config) {
        this.config = config != null ? config : new Idea72895Config();
