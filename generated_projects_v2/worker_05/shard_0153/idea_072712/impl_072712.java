...
@Data
public class Idea72712Config {
    private String name = "idea_072712";
 ...
 */
@Slf4j
public class Idea72712Service {
    private static final int IDEA_ID = 72712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72712Service() {
        this(new Idea72712Config());
    }

    public Idea72712Service(Idea72712Config config) {
        this.config = config != null ? config : new Idea72712Config();
