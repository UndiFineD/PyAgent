...
@Data
public class Idea72877Config {
    private String name = "idea_072877";
 ...
 */
@Slf4j
public class Idea72877Service {
    private static final int IDEA_ID = 72877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72877Service() {
        this(new Idea72877Config());
    }

    public Idea72877Service(Idea72877Config config) {
        this.config = config != null ? config : new Idea72877Config();
