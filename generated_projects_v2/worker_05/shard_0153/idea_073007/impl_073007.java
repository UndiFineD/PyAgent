...
@Data
public class Idea73007Config {
    private String name = "idea_073007";
 ...
 */
@Slf4j
public class Idea73007Service {
    private static final int IDEA_ID = 73007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73007Service() {
        this(new Idea73007Config());
    }

    public Idea73007Service(Idea73007Config config) {
        this.config = config != null ? config : new Idea73007Config();
