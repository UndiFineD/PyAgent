...
@Data
public class Idea72899Config {
    private String name = "idea_072899";
 ...
 */
@Slf4j
public class Idea72899Service {
    private static final int IDEA_ID = 72899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72899Service() {
        this(new Idea72899Config());
    }

    public Idea72899Service(Idea72899Config config) {
        this.config = config != null ? config : new Idea72899Config();
