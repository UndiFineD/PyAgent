...
@Data
public class Idea72956Config {
    private String name = "idea_072956";
 ...
 */
@Slf4j
public class Idea72956Service {
    private static final int IDEA_ID = 72956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72956Service() {
        this(new Idea72956Config());
    }

    public Idea72956Service(Idea72956Config config) {
        this.config = config != null ? config : new Idea72956Config();
