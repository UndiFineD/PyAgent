...
@Data
public class Idea73140Config {
    private String name = "idea_073140";
 ...
 */
@Slf4j
public class Idea73140Service {
    private static final int IDEA_ID = 73140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73140Service() {
        this(new Idea73140Config());
    }

    public Idea73140Service(Idea73140Config config) {
        this.config = config != null ? config : new Idea73140Config();
