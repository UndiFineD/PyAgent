...
@Data
public class Idea72949Config {
    private String name = "idea_072949";
 ...
 */
@Slf4j
public class Idea72949Service {
    private static final int IDEA_ID = 72949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72949Service() {
        this(new Idea72949Config());
    }

    public Idea72949Service(Idea72949Config config) {
        this.config = config != null ? config : new Idea72949Config();
