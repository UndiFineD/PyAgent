...
@Data
public class Idea72840Config {
    private String name = "idea_072840";
 ...
 */
@Slf4j
public class Idea72840Service {
    private static final int IDEA_ID = 72840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72840Service() {
        this(new Idea72840Config());
    }

    public Idea72840Service(Idea72840Config config) {
        this.config = config != null ? config : new Idea72840Config();
