...
@Data
public class Idea72912Config {
    private String name = "idea_072912";
 ...
 */
@Slf4j
public class Idea72912Service {
    private static final int IDEA_ID = 72912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72912Service() {
        this(new Idea72912Config());
    }

    public Idea72912Service(Idea72912Config config) {
        this.config = config != null ? config : new Idea72912Config();
