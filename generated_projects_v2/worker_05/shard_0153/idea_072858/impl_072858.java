...
@Data
public class Idea72858Config {
    private String name = "idea_072858";
 ...
 */
@Slf4j
public class Idea72858Service {
    private static final int IDEA_ID = 72858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72858Service() {
        this(new Idea72858Config());
    }

    public Idea72858Service(Idea72858Config config) {
        this.config = config != null ? config : new Idea72858Config();
