...
@Data
public class Idea72829Config {
    private String name = "idea_072829";
 ...
 */
@Slf4j
public class Idea72829Service {
    private static final int IDEA_ID = 72829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72829Service() {
        this(new Idea72829Config());
    }

    public Idea72829Service(Idea72829Config config) {
        this.config = config != null ? config : new Idea72829Config();
