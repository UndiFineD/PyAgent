...
@Data
public class Idea72703Config {
    private String name = "idea_072703";
 ...
 */
@Slf4j
public class Idea72703Service {
    private static final int IDEA_ID = 72703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72703Service() {
        this(new Idea72703Config());
    }

    public Idea72703Service(Idea72703Config config) {
        this.config = config != null ? config : new Idea72703Config();
