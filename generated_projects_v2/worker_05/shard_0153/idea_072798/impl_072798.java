...
@Data
public class Idea72798Config {
    private String name = "idea_072798";
 ...
 */
@Slf4j
public class Idea72798Service {
    private static final int IDEA_ID = 72798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72798Service() {
        this(new Idea72798Config());
    }

    public Idea72798Service(Idea72798Config config) {
        this.config = config != null ? config : new Idea72798Config();
