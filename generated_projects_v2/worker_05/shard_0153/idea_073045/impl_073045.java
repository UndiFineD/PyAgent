...
@Data
public class Idea73045Config {
    private String name = "idea_073045";
 ...
 */
@Slf4j
public class Idea73045Service {
    private static final int IDEA_ID = 73045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73045Service() {
        this(new Idea73045Config());
    }

    public Idea73045Service(Idea73045Config config) {
        this.config = config != null ? config : new Idea73045Config();
