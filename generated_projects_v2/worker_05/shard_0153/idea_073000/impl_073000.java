...
@Data
public class Idea73000Config {
    private String name = "idea_073000";
 ...
 */
@Slf4j
public class Idea73000Service {
    private static final int IDEA_ID = 73000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73000Service() {
        this(new Idea73000Config());
    }

    public Idea73000Service(Idea73000Config config) {
        this.config = config != null ? config : new Idea73000Config();
