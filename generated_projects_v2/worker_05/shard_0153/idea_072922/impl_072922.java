...
@Data
public class Idea72922Config {
    private String name = "idea_072922";
 ...
 */
@Slf4j
public class Idea72922Service {
    private static final int IDEA_ID = 72922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72922Service() {
        this(new Idea72922Config());
    }

    public Idea72922Service(Idea72922Config config) {
        this.config = config != null ? config : new Idea72922Config();
