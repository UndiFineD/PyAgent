...
@Data
public class Idea72857Config {
    private String name = "idea_072857";
 ...
 */
@Slf4j
public class Idea72857Service {
    private static final int IDEA_ID = 72857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72857Service() {
        this(new Idea72857Config());
    }

    public Idea72857Service(Idea72857Config config) {
        this.config = config != null ? config : new Idea72857Config();
