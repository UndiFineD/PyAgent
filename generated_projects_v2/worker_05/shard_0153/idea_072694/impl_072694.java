...
@Data
public class Idea72694Config {
    private String name = "idea_072694";
 ...
 */
@Slf4j
public class Idea72694Service {
    private static final int IDEA_ID = 72694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72694Service() {
        this(new Idea72694Config());
    }

    public Idea72694Service(Idea72694Config config) {
        this.config = config != null ? config : new Idea72694Config();
