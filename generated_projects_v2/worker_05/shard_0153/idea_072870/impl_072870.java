...
@Data
public class Idea72870Config {
    private String name = "idea_072870";
 ...
 */
@Slf4j
public class Idea72870Service {
    private static final int IDEA_ID = 72870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72870Service() {
        this(new Idea72870Config());
    }

    public Idea72870Service(Idea72870Config config) {
        this.config = config != null ? config : new Idea72870Config();
