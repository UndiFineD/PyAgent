...
@Data
public class Idea72983Config {
    private String name = "idea_072983";
 ...
 */
@Slf4j
public class Idea72983Service {
    private static final int IDEA_ID = 72983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72983Service() {
        this(new Idea72983Config());
    }

    public Idea72983Service(Idea72983Config config) {
        this.config = config != null ? config : new Idea72983Config();
