...
@Data
public class Idea72675Config {
    private String name = "idea_072675";
 ...
 */
@Slf4j
public class Idea72675Service {
    private static final int IDEA_ID = 72675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72675Service() {
        this(new Idea72675Config());
    }

    public Idea72675Service(Idea72675Config config) {
        this.config = config != null ? config : new Idea72675Config();
