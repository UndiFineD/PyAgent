...
@Data
public class Idea72789Config {
    private String name = "idea_072789";
 ...
 */
@Slf4j
public class Idea72789Service {
    private static final int IDEA_ID = 72789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72789Service() {
        this(new Idea72789Config());
    }

    public Idea72789Service(Idea72789Config config) {
        this.config = config != null ? config : new Idea72789Config();
