...
@Data
public class Idea73094Config {
    private String name = "idea_073094";
 ...
 */
@Slf4j
public class Idea73094Service {
    private static final int IDEA_ID = 73094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73094Service() {
        this(new Idea73094Config());
    }

    public Idea73094Service(Idea73094Config config) {
        this.config = config != null ? config : new Idea73094Config();
