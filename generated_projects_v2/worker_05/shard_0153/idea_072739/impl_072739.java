...
@Data
public class Idea72739Config {
    private String name = "idea_072739";
 ...
 */
@Slf4j
public class Idea72739Service {
    private static final int IDEA_ID = 72739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72739Service() {
        this(new Idea72739Config());
    }

    public Idea72739Service(Idea72739Config config) {
        this.config = config != null ? config : new Idea72739Config();
