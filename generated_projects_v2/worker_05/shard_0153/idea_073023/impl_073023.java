...
@Data
public class Idea73023Config {
    private String name = "idea_073023";
 ...
 */
@Slf4j
public class Idea73023Service {
    private static final int IDEA_ID = 73023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73023Service() {
        this(new Idea73023Config());
    }

    public Idea73023Service(Idea73023Config config) {
        this.config = config != null ? config : new Idea73023Config();
