...
@Data
public class Idea73128Config {
    private String name = "idea_073128";
 ...
 */
@Slf4j
public class Idea73128Service {
    private static final int IDEA_ID = 73128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73128Service() {
        this(new Idea73128Config());
    }

    public Idea73128Service(Idea73128Config config) {
        this.config = config != null ? config : new Idea73128Config();
