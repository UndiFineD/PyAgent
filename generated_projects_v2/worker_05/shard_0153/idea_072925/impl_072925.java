...
@Data
public class Idea72925Config {
    private String name = "idea_072925";
 ...
 */
@Slf4j
public class Idea72925Service {
    private static final int IDEA_ID = 72925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72925Service() {
        this(new Idea72925Config());
    }

    public Idea72925Service(Idea72925Config config) {
        this.config = config != null ? config : new Idea72925Config();
