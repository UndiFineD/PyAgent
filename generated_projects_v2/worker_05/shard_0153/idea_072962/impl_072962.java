...
@Data
public class Idea72962Config {
    private String name = "idea_072962";
 ...
 */
@Slf4j
public class Idea72962Service {
    private static final int IDEA_ID = 72962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72962Service() {
        this(new Idea72962Config());
    }

    public Idea72962Service(Idea72962Config config) {
        this.config = config != null ? config : new Idea72962Config();
