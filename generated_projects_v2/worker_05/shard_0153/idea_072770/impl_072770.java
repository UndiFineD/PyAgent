...
@Data
public class Idea72770Config {
    private String name = "idea_072770";
 ...
 */
@Slf4j
public class Idea72770Service {
    private static final int IDEA_ID = 72770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72770Service() {
        this(new Idea72770Config());
    }

    public Idea72770Service(Idea72770Config config) {
        this.config = config != null ? config : new Idea72770Config();
