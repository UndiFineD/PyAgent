...
@Data
public class Idea72850Config {
    private String name = "idea_072850";
 ...
 */
@Slf4j
public class Idea72850Service {
    private static final int IDEA_ID = 72850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72850Service() {
        this(new Idea72850Config());
    }

    public Idea72850Service(Idea72850Config config) {
        this.config = config != null ? config : new Idea72850Config();
