...
@Data
public class Idea72988Config {
    private String name = "idea_072988";
 ...
 */
@Slf4j
public class Idea72988Service {
    private static final int IDEA_ID = 72988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72988Service() {
        this(new Idea72988Config());
    }

    public Idea72988Service(Idea72988Config config) {
        this.config = config != null ? config : new Idea72988Config();
