...
@Data
public class Idea72782Config {
    private String name = "idea_072782";
 ...
 */
@Slf4j
public class Idea72782Service {
    private static final int IDEA_ID = 72782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72782Service() {
        this(new Idea72782Config());
    }

    public Idea72782Service(Idea72782Config config) {
        this.config = config != null ? config : new Idea72782Config();
