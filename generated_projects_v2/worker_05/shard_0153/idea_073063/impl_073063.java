...
@Data
public class Idea73063Config {
    private String name = "idea_073063";
 ...
 */
@Slf4j
public class Idea73063Service {
    private static final int IDEA_ID = 73063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73063Service() {
        this(new Idea73063Config());
    }

    public Idea73063Service(Idea73063Config config) {
        this.config = config != null ? config : new Idea73063Config();
