...
@Data
public class Idea72737Config {
    private String name = "idea_072737";
 ...
 */
@Slf4j
public class Idea72737Service {
    private static final int IDEA_ID = 72737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72737Service() {
        this(new Idea72737Config());
    }

    public Idea72737Service(Idea72737Config config) {
        this.config = config != null ? config : new Idea72737Config();
