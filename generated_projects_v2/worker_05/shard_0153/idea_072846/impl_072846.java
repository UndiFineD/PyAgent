...
@Data
public class Idea72846Config {
    private String name = "idea_072846";
 ...
 */
@Slf4j
public class Idea72846Service {
    private static final int IDEA_ID = 72846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72846Service() {
        this(new Idea72846Config());
    }

    public Idea72846Service(Idea72846Config config) {
        this.config = config != null ? config : new Idea72846Config();
