...
@Data
public class Idea72736Config {
    private String name = "idea_072736";
 ...
 */
@Slf4j
public class Idea72736Service {
    private static final int IDEA_ID = 72736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72736Service() {
        this(new Idea72736Config());
    }

    public Idea72736Service(Idea72736Config config) {
        this.config = config != null ? config : new Idea72736Config();
