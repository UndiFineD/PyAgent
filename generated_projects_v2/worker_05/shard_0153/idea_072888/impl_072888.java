...
@Data
public class Idea72888Config {
    private String name = "idea_072888";
 ...
 */
@Slf4j
public class Idea72888Service {
    private static final int IDEA_ID = 72888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72888Service() {
        this(new Idea72888Config());
    }

    public Idea72888Service(Idea72888Config config) {
        this.config = config != null ? config : new Idea72888Config();
