...
@Data
public class Idea73145Config {
    private String name = "idea_073145";
 ...
 */
@Slf4j
public class Idea73145Service {
    private static final int IDEA_ID = 73145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73145Service() {
        this(new Idea73145Config());
    }

    public Idea73145Service(Idea73145Config config) {
        this.config = config != null ? config : new Idea73145Config();
