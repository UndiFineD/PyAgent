...
@Data
public class Idea72814Config {
    private String name = "idea_072814";
 ...
 */
@Slf4j
public class Idea72814Service {
    private static final int IDEA_ID = 72814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72814Service() {
        this(new Idea72814Config());
    }

    public Idea72814Service(Idea72814Config config) {
        this.config = config != null ? config : new Idea72814Config();
