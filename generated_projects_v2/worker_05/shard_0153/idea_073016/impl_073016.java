...
@Data
public class Idea73016Config {
    private String name = "idea_073016";
 ...
 */
@Slf4j
public class Idea73016Service {
    private static final int IDEA_ID = 73016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73016Service() {
        this(new Idea73016Config());
    }

    public Idea73016Service(Idea73016Config config) {
        this.config = config != null ? config : new Idea73016Config();
