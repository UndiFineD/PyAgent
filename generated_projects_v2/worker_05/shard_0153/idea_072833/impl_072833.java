...
@Data
public class Idea72833Config {
    private String name = "idea_072833";
 ...
 */
@Slf4j
public class Idea72833Service {
    private static final int IDEA_ID = 72833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72833Service() {
        this(new Idea72833Config());
    }

    public Idea72833Service(Idea72833Config config) {
        this.config = config != null ? config : new Idea72833Config();
