...
@Data
public class Idea73058Config {
    private String name = "idea_073058";
 ...
 */
@Slf4j
public class Idea73058Service {
    private static final int IDEA_ID = 73058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73058Service() {
        this(new Idea73058Config());
    }

    public Idea73058Service(Idea73058Config config) {
        this.config = config != null ? config : new Idea73058Config();
