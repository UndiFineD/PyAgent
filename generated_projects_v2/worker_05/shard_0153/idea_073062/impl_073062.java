...
@Data
public class Idea73062Config {
    private String name = "idea_073062";
 ...
 */
@Slf4j
public class Idea73062Service {
    private static final int IDEA_ID = 73062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73062Service() {
        this(new Idea73062Config());
    }

    public Idea73062Service(Idea73062Config config) {
        this.config = config != null ? config : new Idea73062Config();
