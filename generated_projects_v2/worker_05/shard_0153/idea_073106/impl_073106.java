...
@Data
public class Idea73106Config {
    private String name = "idea_073106";
 ...
 */
@Slf4j
public class Idea73106Service {
    private static final int IDEA_ID = 73106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73106Service() {
        this(new Idea73106Config());
    }

    public Idea73106Service(Idea73106Config config) {
        this.config = config != null ? config : new Idea73106Config();
