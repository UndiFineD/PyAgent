...
@Data
public class Idea72938Config {
    private String name = "idea_072938";
 ...
 */
@Slf4j
public class Idea72938Service {
    private static final int IDEA_ID = 72938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72938Service() {
        this(new Idea72938Config());
    }

    public Idea72938Service(Idea72938Config config) {
        this.config = config != null ? config : new Idea72938Config();
