...
@Data
public class Idea73090Config {
    private String name = "idea_073090";
 ...
 */
@Slf4j
public class Idea73090Service {
    private static final int IDEA_ID = 73090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73090Service() {
        this(new Idea73090Config());
    }

    public Idea73090Service(Idea73090Config config) {
        this.config = config != null ? config : new Idea73090Config();
