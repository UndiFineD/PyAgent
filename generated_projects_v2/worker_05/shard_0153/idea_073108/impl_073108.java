...
@Data
public class Idea73108Config {
    private String name = "idea_073108";
 ...
 */
@Slf4j
public class Idea73108Service {
    private static final int IDEA_ID = 73108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73108Service() {
        this(new Idea73108Config());
    }

    public Idea73108Service(Idea73108Config config) {
        this.config = config != null ? config : new Idea73108Config();
