...
@Data
public class Idea72802Config {
    private String name = "idea_072802";
 ...
 */
@Slf4j
public class Idea72802Service {
    private static final int IDEA_ID = 72802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72802Service() {
        this(new Idea72802Config());
    }

    public Idea72802Service(Idea72802Config config) {
        this.config = config != null ? config : new Idea72802Config();
