...
@Data
public class Idea72715Config {
    private String name = "idea_072715";
 ...
 */
@Slf4j
public class Idea72715Service {
    private static final int IDEA_ID = 72715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72715Service() {
        this(new Idea72715Config());
    }

    public Idea72715Service(Idea72715Config config) {
        this.config = config != null ? config : new Idea72715Config();
