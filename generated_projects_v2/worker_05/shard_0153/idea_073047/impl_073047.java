...
@Data
public class Idea73047Config {
    private String name = "idea_073047";
 ...
 */
@Slf4j
public class Idea73047Service {
    private static final int IDEA_ID = 73047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73047Service() {
        this(new Idea73047Config());
    }

    public Idea73047Service(Idea73047Config config) {
        this.config = config != null ? config : new Idea73047Config();
