...
@Data
public class Idea72793Config {
    private String name = "idea_072793";
 ...
 */
@Slf4j
public class Idea72793Service {
    private static final int IDEA_ID = 72793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72793Service() {
        this(new Idea72793Config());
    }

    public Idea72793Service(Idea72793Config config) {
        this.config = config != null ? config : new Idea72793Config();
