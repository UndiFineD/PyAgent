...
@Data
public class Idea72680Config {
    private String name = "idea_072680";
 ...
 */
@Slf4j
public class Idea72680Service {
    private static final int IDEA_ID = 72680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72680Service() {
        this(new Idea72680Config());
    }

    public Idea72680Service(Idea72680Config config) {
        this.config = config != null ? config : new Idea72680Config();
