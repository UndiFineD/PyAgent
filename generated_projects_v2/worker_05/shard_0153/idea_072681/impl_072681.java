...
@Data
public class Idea72681Config {
    private String name = "idea_072681";
 ...
 */
@Slf4j
public class Idea72681Service {
    private static final int IDEA_ID = 72681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72681Service() {
        this(new Idea72681Config());
    }

    public Idea72681Service(Idea72681Config config) {
        this.config = config != null ? config : new Idea72681Config();
