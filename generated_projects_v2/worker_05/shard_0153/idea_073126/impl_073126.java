...
@Data
public class Idea73126Config {
    private String name = "idea_073126";
 ...
 */
@Slf4j
public class Idea73126Service {
    private static final int IDEA_ID = 73126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73126Service() {
        this(new Idea73126Config());
    }

    public Idea73126Service(Idea73126Config config) {
        this.config = config != null ? config : new Idea73126Config();
