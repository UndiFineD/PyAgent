...
@Data
public class Idea72683Config {
    private String name = "idea_072683";
 ...
 */
@Slf4j
public class Idea72683Service {
    private static final int IDEA_ID = 72683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72683Service() {
        this(new Idea72683Config());
    }

    public Idea72683Service(Idea72683Config config) {
        this.config = config != null ? config : new Idea72683Config();
