...
@Data
public class Idea73081Config {
    private String name = "idea_073081";
 ...
 */
@Slf4j
public class Idea73081Service {
    private static final int IDEA_ID = 73081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73081Service() {
        this(new Idea73081Config());
    }

    public Idea73081Service(Idea73081Config config) {
        this.config = config != null ? config : new Idea73081Config();
