...
@Data
public class Idea73024Config {
    private String name = "idea_073024";
 ...
 */
@Slf4j
public class Idea73024Service {
    private static final int IDEA_ID = 73024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73024Service() {
        this(new Idea73024Config());
    }

    public Idea73024Service(Idea73024Config config) {
        this.config = config != null ? config : new Idea73024Config();
