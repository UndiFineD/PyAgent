...
@Data
public class Idea72801Config {
    private String name = "idea_072801";
 ...
 */
@Slf4j
public class Idea72801Service {
    private static final int IDEA_ID = 72801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72801Service() {
        this(new Idea72801Config());
    }

    public Idea72801Service(Idea72801Config config) {
        this.config = config != null ? config : new Idea72801Config();
