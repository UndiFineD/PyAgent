...
@Data
public class Idea72913Config {
    private String name = "idea_072913";
 ...
 */
@Slf4j
public class Idea72913Service {
    private static final int IDEA_ID = 72913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72913Service() {
        this(new Idea72913Config());
    }

    public Idea72913Service(Idea72913Config config) {
        this.config = config != null ? config : new Idea72913Config();
