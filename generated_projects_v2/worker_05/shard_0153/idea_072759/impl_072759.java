...
@Data
public class Idea72759Config {
    private String name = "idea_072759";
 ...
 */
@Slf4j
public class Idea72759Service {
    private static final int IDEA_ID = 72759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72759Service() {
        this(new Idea72759Config());
    }

    public Idea72759Service(Idea72759Config config) {
        this.config = config != null ? config : new Idea72759Config();
