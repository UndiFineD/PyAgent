...
@Data
public class Idea72845Config {
    private String name = "idea_072845";
 ...
 */
@Slf4j
public class Idea72845Service {
    private static final int IDEA_ID = 72845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72845Service() {
        this(new Idea72845Config());
    }

    public Idea72845Service(Idea72845Config config) {
        this.config = config != null ? config : new Idea72845Config();
