...
@Data
public class Idea72815Config {
    private String name = "idea_072815";
 ...
 */
@Slf4j
public class Idea72815Service {
    private static final int IDEA_ID = 72815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72815Service() {
        this(new Idea72815Config());
    }

    public Idea72815Service(Idea72815Config config) {
        this.config = config != null ? config : new Idea72815Config();
