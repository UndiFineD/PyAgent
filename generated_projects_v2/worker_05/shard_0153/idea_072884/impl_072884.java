...
@Data
public class Idea72884Config {
    private String name = "idea_072884";
 ...
 */
@Slf4j
public class Idea72884Service {
    private static final int IDEA_ID = 72884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72884Service() {
        this(new Idea72884Config());
    }

    public Idea72884Service(Idea72884Config config) {
        this.config = config != null ? config : new Idea72884Config();
