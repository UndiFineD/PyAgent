...
@Data
public class Idea73018Config {
    private String name = "idea_073018";
 ...
 */
@Slf4j
public class Idea73018Service {
    private static final int IDEA_ID = 73018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73018Service() {
        this(new Idea73018Config());
    }

    public Idea73018Service(Idea73018Config config) {
        this.config = config != null ? config : new Idea73018Config();
