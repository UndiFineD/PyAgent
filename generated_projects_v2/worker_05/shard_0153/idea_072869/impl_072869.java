...
@Data
public class Idea72869Config {
    private String name = "idea_072869";
 ...
 */
@Slf4j
public class Idea72869Service {
    private static final int IDEA_ID = 72869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72869Service() {
        this(new Idea72869Config());
    }

    public Idea72869Service(Idea72869Config config) {
        this.config = config != null ? config : new Idea72869Config();
