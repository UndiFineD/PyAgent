...
@Data
public class Idea73060Config {
    private String name = "idea_073060";
 ...
 */
@Slf4j
public class Idea73060Service {
    private static final int IDEA_ID = 73060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73060Service() {
        this(new Idea73060Config());
    }

    public Idea73060Service(Idea73060Config config) {
        this.config = config != null ? config : new Idea73060Config();
