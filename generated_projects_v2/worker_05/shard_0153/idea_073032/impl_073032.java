...
@Data
public class Idea73032Config {
    private String name = "idea_073032";
 ...
 */
@Slf4j
public class Idea73032Service {
    private static final int IDEA_ID = 73032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73032Service() {
        this(new Idea73032Config());
    }

    public Idea73032Service(Idea73032Config config) {
        this.config = config != null ? config : new Idea73032Config();
