...
@Data
public class Idea72742Config {
    private String name = "idea_072742";
 ...
 */
@Slf4j
public class Idea72742Service {
    private static final int IDEA_ID = 72742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72742Service() {
        this(new Idea72742Config());
    }

    public Idea72742Service(Idea72742Config config) {
        this.config = config != null ? config : new Idea72742Config();
