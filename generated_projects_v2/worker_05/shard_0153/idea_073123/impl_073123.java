...
@Data
public class Idea73123Config {
    private String name = "idea_073123";
 ...
 */
@Slf4j
public class Idea73123Service {
    private static final int IDEA_ID = 73123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73123Service() {
        this(new Idea73123Config());
    }

    public Idea73123Service(Idea73123Config config) {
        this.config = config != null ? config : new Idea73123Config();
