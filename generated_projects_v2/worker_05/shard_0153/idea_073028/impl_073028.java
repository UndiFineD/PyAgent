...
@Data
public class Idea73028Config {
    private String name = "idea_073028";
 ...
 */
@Slf4j
public class Idea73028Service {
    private static final int IDEA_ID = 73028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73028Service() {
        this(new Idea73028Config());
    }

    public Idea73028Service(Idea73028Config config) {
        this.config = config != null ? config : new Idea73028Config();
