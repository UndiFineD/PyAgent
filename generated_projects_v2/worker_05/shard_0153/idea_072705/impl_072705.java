...
@Data
public class Idea72705Config {
    private String name = "idea_072705";
 ...
 */
@Slf4j
public class Idea72705Service {
    private static final int IDEA_ID = 72705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72705Service() {
        this(new Idea72705Config());
    }

    public Idea72705Service(Idea72705Config config) {
        this.config = config != null ? config : new Idea72705Config();
