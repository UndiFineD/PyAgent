...
@Data
public class Idea73105Config {
    private String name = "idea_073105";
 ...
 */
@Slf4j
public class Idea73105Service {
    private static final int IDEA_ID = 73105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73105Service() {
        this(new Idea73105Config());
    }

    public Idea73105Service(Idea73105Config config) {
        this.config = config != null ? config : new Idea73105Config();
