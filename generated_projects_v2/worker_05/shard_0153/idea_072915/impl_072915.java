...
@Data
public class Idea72915Config {
    private String name = "idea_072915";
 ...
 */
@Slf4j
public class Idea72915Service {
    private static final int IDEA_ID = 72915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72915Service() {
        this(new Idea72915Config());
    }

    public Idea72915Service(Idea72915Config config) {
        this.config = config != null ? config : new Idea72915Config();
