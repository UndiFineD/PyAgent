...
@Data
public class Idea72721Config {
    private String name = "idea_072721";
 ...
 */
@Slf4j
public class Idea72721Service {
    private static final int IDEA_ID = 72721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72721Service() {
        this(new Idea72721Config());
    }

    public Idea72721Service(Idea72721Config config) {
        this.config = config != null ? config : new Idea72721Config();
