...
@Data
public class Idea72958Config {
    private String name = "idea_072958";
 ...
 */
@Slf4j
public class Idea72958Service {
    private static final int IDEA_ID = 72958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72958Service() {
        this(new Idea72958Config());
    }

    public Idea72958Service(Idea72958Config config) {
        this.config = config != null ? config : new Idea72958Config();
