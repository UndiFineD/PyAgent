...
@Data
public class Idea72975Config {
    private String name = "idea_072975";
 ...
 */
@Slf4j
public class Idea72975Service {
    private static final int IDEA_ID = 72975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72975Service() {
        this(new Idea72975Config());
    }

    public Idea72975Service(Idea72975Config config) {
        this.config = config != null ? config : new Idea72975Config();
