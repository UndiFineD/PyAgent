...
@Data
public class Idea72875Config {
    private String name = "idea_072875";
 ...
 */
@Slf4j
public class Idea72875Service {
    private static final int IDEA_ID = 72875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72875Service() {
        this(new Idea72875Config());
    }

    public Idea72875Service(Idea72875Config config) {
        this.config = config != null ? config : new Idea72875Config();
