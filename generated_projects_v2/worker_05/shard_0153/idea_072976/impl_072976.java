...
@Data
public class Idea72976Config {
    private String name = "idea_072976";
 ...
 */
@Slf4j
public class Idea72976Service {
    private static final int IDEA_ID = 72976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72976Service() {
        this(new Idea72976Config());
    }

    public Idea72976Service(Idea72976Config config) {
        this.config = config != null ? config : new Idea72976Config();
