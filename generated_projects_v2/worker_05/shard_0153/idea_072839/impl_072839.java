...
@Data
public class Idea72839Config {
    private String name = "idea_072839";
 ...
 */
@Slf4j
public class Idea72839Service {
    private static final int IDEA_ID = 72839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72839Service() {
        this(new Idea72839Config());
    }

    public Idea72839Service(Idea72839Config config) {
        this.config = config != null ? config : new Idea72839Config();
