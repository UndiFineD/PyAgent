...
@Data
public class Idea72980Config {
    private String name = "idea_072980";
 ...
 */
@Slf4j
public class Idea72980Service {
    private static final int IDEA_ID = 72980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72980Service() {
        this(new Idea72980Config());
    }

    public Idea72980Service(Idea72980Config config) {
        this.config = config != null ? config : new Idea72980Config();
