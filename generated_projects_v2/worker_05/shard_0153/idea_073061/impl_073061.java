...
@Data
public class Idea73061Config {
    private String name = "idea_073061";
 ...
 */
@Slf4j
public class Idea73061Service {
    private static final int IDEA_ID = 73061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73061Service() {
        this(new Idea73061Config());
    }

    public Idea73061Service(Idea73061Config config) {
        this.config = config != null ? config : new Idea73061Config();
