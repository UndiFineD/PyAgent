...
@Data
public class Idea72728Config {
    private String name = "idea_072728";
 ...
 */
@Slf4j
public class Idea72728Service {
    private static final int IDEA_ID = 72728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72728Service() {
        this(new Idea72728Config());
    }

    public Idea72728Service(Idea72728Config config) {
        this.config = config != null ? config : new Idea72728Config();
