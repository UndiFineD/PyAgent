...
@Data
public class Idea72969Config {
    private String name = "idea_072969";
 ...
 */
@Slf4j
public class Idea72969Service {
    private static final int IDEA_ID = 72969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72969Service() {
        this(new Idea72969Config());
    }

    public Idea72969Service(Idea72969Config config) {
        this.config = config != null ? config : new Idea72969Config();
