...
@Data
public class Idea72790Config {
    private String name = "idea_072790";
 ...
 */
@Slf4j
public class Idea72790Service {
    private static final int IDEA_ID = 72790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72790Service() {
        this(new Idea72790Config());
    }

    public Idea72790Service(Idea72790Config config) {
        this.config = config != null ? config : new Idea72790Config();
