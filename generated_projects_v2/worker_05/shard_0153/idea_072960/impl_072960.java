...
@Data
public class Idea72960Config {
    private String name = "idea_072960";
 ...
 */
@Slf4j
public class Idea72960Service {
    private static final int IDEA_ID = 72960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72960Service() {
        this(new Idea72960Config());
    }

    public Idea72960Service(Idea72960Config config) {
        this.config = config != null ? config : new Idea72960Config();
