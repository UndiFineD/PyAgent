...
@Data
public class Idea73008Config {
    private String name = "idea_073008";
 ...
 */
@Slf4j
public class Idea73008Service {
    private static final int IDEA_ID = 73008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73008Service() {
        this(new Idea73008Config());
    }

    public Idea73008Service(Idea73008Config config) {
        this.config = config != null ? config : new Idea73008Config();
