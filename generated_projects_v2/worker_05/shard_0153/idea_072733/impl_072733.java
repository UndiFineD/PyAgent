...
@Data
public class Idea72733Config {
    private String name = "idea_072733";
 ...
 */
@Slf4j
public class Idea72733Service {
    private static final int IDEA_ID = 72733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72733Service() {
        this(new Idea72733Config());
    }

    public Idea72733Service(Idea72733Config config) {
        this.config = config != null ? config : new Idea72733Config();
