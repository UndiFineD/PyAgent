...
@Data
public class Idea73040Config {
    private String name = "idea_073040";
 ...
 */
@Slf4j
public class Idea73040Service {
    private static final int IDEA_ID = 73040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73040Service() {
        this(new Idea73040Config());
    }

    public Idea73040Service(Idea73040Config config) {
        this.config = config != null ? config : new Idea73040Config();
