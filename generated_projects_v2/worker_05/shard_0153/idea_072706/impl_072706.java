...
@Data
public class Idea72706Config {
    private String name = "idea_072706";
 ...
 */
@Slf4j
public class Idea72706Service {
    private static final int IDEA_ID = 72706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72706Service() {
        this(new Idea72706Config());
    }

    public Idea72706Service(Idea72706Config config) {
        this.config = config != null ? config : new Idea72706Config();
