...
@Data
public class Idea73129Config {
    private String name = "idea_073129";
 ...
 */
@Slf4j
public class Idea73129Service {
    private static final int IDEA_ID = 73129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73129Service() {
        this(new Idea73129Config());
    }

    public Idea73129Service(Idea73129Config config) {
        this.config = config != null ? config : new Idea73129Config();
