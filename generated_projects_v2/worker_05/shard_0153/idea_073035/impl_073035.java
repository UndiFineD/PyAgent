...
@Data
public class Idea73035Config {
    private String name = "idea_073035";
 ...
 */
@Slf4j
public class Idea73035Service {
    private static final int IDEA_ID = 73035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73035Service() {
        this(new Idea73035Config());
    }

    public Idea73035Service(Idea73035Config config) {
        this.config = config != null ? config : new Idea73035Config();
