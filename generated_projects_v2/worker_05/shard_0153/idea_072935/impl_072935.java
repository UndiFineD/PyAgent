...
@Data
public class Idea72935Config {
    private String name = "idea_072935";
 ...
 */
@Slf4j
public class Idea72935Service {
    private static final int IDEA_ID = 72935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72935Service() {
        this(new Idea72935Config());
    }

    public Idea72935Service(Idea72935Config config) {
        this.config = config != null ? config : new Idea72935Config();
