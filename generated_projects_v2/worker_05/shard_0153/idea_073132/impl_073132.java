...
@Data
public class Idea73132Config {
    private String name = "idea_073132";
 ...
 */
@Slf4j
public class Idea73132Service {
    private static final int IDEA_ID = 73132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73132Service() {
        this(new Idea73132Config());
    }

    public Idea73132Service(Idea73132Config config) {
        this.config = config != null ? config : new Idea73132Config();
