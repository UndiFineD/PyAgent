...
@Data
public class Idea72847Config {
    private String name = "idea_072847";
 ...
 */
@Slf4j
public class Idea72847Service {
    private static final int IDEA_ID = 72847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72847Service() {
        this(new Idea72847Config());
    }

    public Idea72847Service(Idea72847Config config) {
        this.config = config != null ? config : new Idea72847Config();
