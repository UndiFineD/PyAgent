...
@Data
public class Idea72738Config {
    private String name = "idea_072738";
 ...
 */
@Slf4j
public class Idea72738Service {
    private static final int IDEA_ID = 72738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72738Service() {
        this(new Idea72738Config());
    }

    public Idea72738Service(Idea72738Config config) {
        this.config = config != null ? config : new Idea72738Config();
