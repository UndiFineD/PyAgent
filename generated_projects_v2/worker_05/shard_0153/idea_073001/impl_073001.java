...
@Data
public class Idea73001Config {
    private String name = "idea_073001";
 ...
 */
@Slf4j
public class Idea73001Service {
    private static final int IDEA_ID = 73001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73001Service() {
        this(new Idea73001Config());
    }

    public Idea73001Service(Idea73001Config config) {
        this.config = config != null ? config : new Idea73001Config();
