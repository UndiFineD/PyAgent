...
@Data
public class Idea73082Config {
    private String name = "idea_073082";
 ...
 */
@Slf4j
public class Idea73082Service {
    private static final int IDEA_ID = 73082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73082Service() {
        this(new Idea73082Config());
    }

    public Idea73082Service(Idea73082Config config) {
        this.config = config != null ? config : new Idea73082Config();
