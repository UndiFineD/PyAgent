...
@Data
public class Idea72981Config {
    private String name = "idea_072981";
 ...
 */
@Slf4j
public class Idea72981Service {
    private static final int IDEA_ID = 72981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72981Service() {
        this(new Idea72981Config());
    }

    public Idea72981Service(Idea72981Config config) {
        this.config = config != null ? config : new Idea72981Config();
