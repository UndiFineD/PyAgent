...
@Data
public class Idea72727Config {
    private String name = "idea_072727";
 ...
 */
@Slf4j
public class Idea72727Service {
    private static final int IDEA_ID = 72727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72727Service() {
        this(new Idea72727Config());
    }

    public Idea72727Service(Idea72727Config config) {
        this.config = config != null ? config : new Idea72727Config();
