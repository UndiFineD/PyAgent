...
@Data
public class Idea73120Config {
    private String name = "idea_073120";
 ...
 */
@Slf4j
public class Idea73120Service {
    private static final int IDEA_ID = 73120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73120Service() {
        this(new Idea73120Config());
    }

    public Idea73120Service(Idea73120Config config) {
        this.config = config != null ? config : new Idea73120Config();
