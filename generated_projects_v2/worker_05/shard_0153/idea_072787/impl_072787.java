...
@Data
public class Idea72787Config {
    private String name = "idea_072787";
 ...
 */
@Slf4j
public class Idea72787Service {
    private static final int IDEA_ID = 72787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72787Service() {
        this(new Idea72787Config());
    }

    public Idea72787Service(Idea72787Config config) {
        this.config = config != null ? config : new Idea72787Config();
