...
@Data
public class Idea72831Config {
    private String name = "idea_072831";
 ...
 */
@Slf4j
public class Idea72831Service {
    private static final int IDEA_ID = 72831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72831Service() {
        this(new Idea72831Config());
    }

    public Idea72831Service(Idea72831Config config) {
        this.config = config != null ? config : new Idea72831Config();
