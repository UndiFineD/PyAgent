...
@Data
public class Idea72864Config {
    private String name = "idea_072864";
 ...
 */
@Slf4j
public class Idea72864Service {
    private static final int IDEA_ID = 72864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72864Service() {
        this(new Idea72864Config());
    }

    public Idea72864Service(Idea72864Config config) {
        this.config = config != null ? config : new Idea72864Config();
