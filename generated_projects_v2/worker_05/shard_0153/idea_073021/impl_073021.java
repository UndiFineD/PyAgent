...
@Data
public class Idea73021Config {
    private String name = "idea_073021";
 ...
 */
@Slf4j
public class Idea73021Service {
    private static final int IDEA_ID = 73021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73021Service() {
        this(new Idea73021Config());
    }

    public Idea73021Service(Idea73021Config config) {
        this.config = config != null ? config : new Idea73021Config();
