...
@Data
public class Idea73113Config {
    private String name = "idea_073113";
 ...
 */
@Slf4j
public class Idea73113Service {
    private static final int IDEA_ID = 73113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73113Service() {
        this(new Idea73113Config());
    }

    public Idea73113Service(Idea73113Config config) {
        this.config = config != null ? config : new Idea73113Config();
