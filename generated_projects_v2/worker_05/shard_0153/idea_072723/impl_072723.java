...
@Data
public class Idea72723Config {
    private String name = "idea_072723";
 ...
 */
@Slf4j
public class Idea72723Service {
    private static final int IDEA_ID = 72723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72723Service() {
        this(new Idea72723Config());
    }

    public Idea72723Service(Idea72723Config config) {
        this.config = config != null ? config : new Idea72723Config();
