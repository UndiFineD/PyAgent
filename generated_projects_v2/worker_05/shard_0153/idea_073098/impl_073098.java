...
@Data
public class Idea73098Config {
    private String name = "idea_073098";
 ...
 */
@Slf4j
public class Idea73098Service {
    private static final int IDEA_ID = 73098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73098Service() {
        this(new Idea73098Config());
    }

    public Idea73098Service(Idea73098Config config) {
        this.config = config != null ? config : new Idea73098Config();
