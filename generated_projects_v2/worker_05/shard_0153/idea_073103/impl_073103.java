...
@Data
public class Idea73103Config {
    private String name = "idea_073103";
 ...
 */
@Slf4j
public class Idea73103Service {
    private static final int IDEA_ID = 73103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73103Service() {
        this(new Idea73103Config());
    }

    public Idea73103Service(Idea73103Config config) {
        this.config = config != null ? config : new Idea73103Config();
