...
@Data
public class Idea72883Config {
    private String name = "idea_072883";
 ...
 */
@Slf4j
public class Idea72883Service {
    private static final int IDEA_ID = 72883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72883Service() {
        this(new Idea72883Config());
    }

    public Idea72883Service(Idea72883Config config) {
        this.config = config != null ? config : new Idea72883Config();
