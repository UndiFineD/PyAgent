...
@Data
public class Idea72979Config {
    private String name = "idea_072979";
 ...
 */
@Slf4j
public class Idea72979Service {
    private static final int IDEA_ID = 72979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72979Service() {
        this(new Idea72979Config());
    }

    public Idea72979Service(Idea72979Config config) {
        this.config = config != null ? config : new Idea72979Config();
