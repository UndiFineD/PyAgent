...
@Data
public class Idea73014Config {
    private String name = "idea_073014";
 ...
 */
@Slf4j
public class Idea73014Service {
    private static final int IDEA_ID = 73014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73014Service() {
        this(new Idea73014Config());
    }

    public Idea73014Service(Idea73014Config config) {
        this.config = config != null ? config : new Idea73014Config();
