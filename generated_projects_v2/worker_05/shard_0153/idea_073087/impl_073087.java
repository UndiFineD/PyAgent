...
@Data
public class Idea73087Config {
    private String name = "idea_073087";
 ...
 */
@Slf4j
public class Idea73087Service {
    private static final int IDEA_ID = 73087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73087Service() {
        this(new Idea73087Config());
    }

    public Idea73087Service(Idea73087Config config) {
        this.config = config != null ? config : new Idea73087Config();
