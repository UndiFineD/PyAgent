...
@Data
public class Idea73146Config {
    private String name = "idea_073146";
 ...
 */
@Slf4j
public class Idea73146Service {
    private static final int IDEA_ID = 73146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73146Service() {
        this(new Idea73146Config());
    }

    public Idea73146Service(Idea73146Config config) {
        this.config = config != null ? config : new Idea73146Config();
