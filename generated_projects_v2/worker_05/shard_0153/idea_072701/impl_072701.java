...
@Data
public class Idea72701Config {
    private String name = "idea_072701";
 ...
 */
@Slf4j
public class Idea72701Service {
    private static final int IDEA_ID = 72701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72701Service() {
        this(new Idea72701Config());
    }

    public Idea72701Service(Idea72701Config config) {
        this.config = config != null ? config : new Idea72701Config();
