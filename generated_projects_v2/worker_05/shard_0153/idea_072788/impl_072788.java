...
@Data
public class Idea72788Config {
    private String name = "idea_072788";
 ...
 */
@Slf4j
public class Idea72788Service {
    private static final int IDEA_ID = 72788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72788Service() {
        this(new Idea72788Config());
    }

    public Idea72788Service(Idea72788Config config) {
        this.config = config != null ? config : new Idea72788Config();
