...
@Data
public class Idea72891Config {
    private String name = "idea_072891";
 ...
 */
@Slf4j
public class Idea72891Service {
    private static final int IDEA_ID = 72891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72891Service() {
        this(new Idea72891Config());
    }

    public Idea72891Service(Idea72891Config config) {
        this.config = config != null ? config : new Idea72891Config();
