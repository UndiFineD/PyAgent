...
@Data
public class Idea72946Config {
    private String name = "idea_072946";
 ...
 */
@Slf4j
public class Idea72946Service {
    private static final int IDEA_ID = 72946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72946Service() {
        this(new Idea72946Config());
    }

    public Idea72946Service(Idea72946Config config) {
        this.config = config != null ? config : new Idea72946Config();
