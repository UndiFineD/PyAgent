...
@Data
public class Idea73085Config {
    private String name = "idea_073085";
 ...
 */
@Slf4j
public class Idea73085Service {
    private static final int IDEA_ID = 73085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73085Service() {
        this(new Idea73085Config());
    }

    public Idea73085Service(Idea73085Config config) {
        this.config = config != null ? config : new Idea73085Config();
