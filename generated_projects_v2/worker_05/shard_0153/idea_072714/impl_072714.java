...
@Data
public class Idea72714Config {
    private String name = "idea_072714";
 ...
 */
@Slf4j
public class Idea72714Service {
    private static final int IDEA_ID = 72714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72714Service() {
        this(new Idea72714Config());
    }

    public Idea72714Service(Idea72714Config config) {
        this.config = config != null ? config : new Idea72714Config();
