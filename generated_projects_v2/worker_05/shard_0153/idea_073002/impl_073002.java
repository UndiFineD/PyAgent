...
@Data
public class Idea73002Config {
    private String name = "idea_073002";
 ...
 */
@Slf4j
public class Idea73002Service {
    private static final int IDEA_ID = 73002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73002Service() {
        this(new Idea73002Config());
    }

    public Idea73002Service(Idea73002Config config) {
        this.config = config != null ? config : new Idea73002Config();
