...
@Data
public class Idea72920Config {
    private String name = "idea_072920";
 ...
 */
@Slf4j
public class Idea72920Service {
    private static final int IDEA_ID = 72920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72920Service() {
        this(new Idea72920Config());
    }

    public Idea72920Service(Idea72920Config config) {
        this.config = config != null ? config : new Idea72920Config();
