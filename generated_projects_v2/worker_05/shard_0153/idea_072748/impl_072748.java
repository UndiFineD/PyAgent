...
@Data
public class Idea72748Config {
    private String name = "idea_072748";
 ...
 */
@Slf4j
public class Idea72748Service {
    private static final int IDEA_ID = 72748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72748Service() {
        this(new Idea72748Config());
    }

    public Idea72748Service(Idea72748Config config) {
        this.config = config != null ? config : new Idea72748Config();
