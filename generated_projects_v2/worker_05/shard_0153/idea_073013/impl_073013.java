...
@Data
public class Idea73013Config {
    private String name = "idea_073013";
 ...
 */
@Slf4j
public class Idea73013Service {
    private static final int IDEA_ID = 73013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73013Service() {
        this(new Idea73013Config());
    }

    public Idea73013Service(Idea73013Config config) {
        this.config = config != null ? config : new Idea73013Config();
