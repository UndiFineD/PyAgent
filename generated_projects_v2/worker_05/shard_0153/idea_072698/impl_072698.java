...
@Data
public class Idea72698Config {
    private String name = "idea_072698";
 ...
 */
@Slf4j
public class Idea72698Service {
    private static final int IDEA_ID = 72698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72698Service() {
        this(new Idea72698Config());
    }

    public Idea72698Service(Idea72698Config config) {
        this.config = config != null ? config : new Idea72698Config();
