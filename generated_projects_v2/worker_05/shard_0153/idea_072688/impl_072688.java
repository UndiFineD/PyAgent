...
@Data
public class Idea72688Config {
    private String name = "idea_072688";
 ...
 */
@Slf4j
public class Idea72688Service {
    private static final int IDEA_ID = 72688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72688Service() {
        this(new Idea72688Config());
    }

    public Idea72688Service(Idea72688Config config) {
        this.config = config != null ? config : new Idea72688Config();
