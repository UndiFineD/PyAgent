...
@Data
public class Idea73143Config {
    private String name = "idea_073143";
 ...
 */
@Slf4j
public class Idea73143Service {
    private static final int IDEA_ID = 73143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73143Service() {
        this(new Idea73143Config());
    }

    public Idea73143Service(Idea73143Config config) {
        this.config = config != null ? config : new Idea73143Config();
