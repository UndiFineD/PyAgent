...
@Data
public class Idea73026Config {
    private String name = "idea_073026";
 ...
 */
@Slf4j
public class Idea73026Service {
    private static final int IDEA_ID = 73026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73026Service() {
        this(new Idea73026Config());
    }

    public Idea73026Service(Idea73026Config config) {
        this.config = config != null ? config : new Idea73026Config();
