...
@Data
public class Idea72766Config {
    private String name = "idea_072766";
 ...
 */
@Slf4j
public class Idea72766Service {
    private static final int IDEA_ID = 72766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72766Service() {
        this(new Idea72766Config());
    }

    public Idea72766Service(Idea72766Config config) {
        this.config = config != null ? config : new Idea72766Config();
