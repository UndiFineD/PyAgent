...
@Data
public class Idea73131Config {
    private String name = "idea_073131";
 ...
 */
@Slf4j
public class Idea73131Service {
    private static final int IDEA_ID = 73131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73131Service() {
        this(new Idea73131Config());
    }

    public Idea73131Service(Idea73131Config config) {
        this.config = config != null ? config : new Idea73131Config();
