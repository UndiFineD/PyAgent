...
@Data
public class Idea72871Config {
    private String name = "idea_072871";
 ...
 */
@Slf4j
public class Idea72871Service {
    private static final int IDEA_ID = 72871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72871Service() {
        this(new Idea72871Config());
    }

    public Idea72871Service(Idea72871Config config) {
        this.config = config != null ? config : new Idea72871Config();
