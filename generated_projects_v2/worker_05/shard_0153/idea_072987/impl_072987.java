...
@Data
public class Idea72987Config {
    private String name = "idea_072987";
 ...
 */
@Slf4j
public class Idea72987Service {
    private static final int IDEA_ID = 72987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72987Service() {
        this(new Idea72987Config());
    }

    public Idea72987Service(Idea72987Config config) {
        this.config = config != null ? config : new Idea72987Config();
