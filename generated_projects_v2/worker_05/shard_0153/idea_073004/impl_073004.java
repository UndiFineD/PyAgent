...
@Data
public class Idea73004Config {
    private String name = "idea_073004";
 ...
 */
@Slf4j
public class Idea73004Service {
    private static final int IDEA_ID = 73004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73004Service() {
        this(new Idea73004Config());
    }

    public Idea73004Service(Idea73004Config config) {
        this.config = config != null ? config : new Idea73004Config();
