...
@Data
public class Idea73012Config {
    private String name = "idea_073012";
 ...
 */
@Slf4j
public class Idea73012Service {
    private static final int IDEA_ID = 73012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73012Service() {
        this(new Idea73012Config());
    }

    public Idea73012Service(Idea73012Config config) {
        this.config = config != null ? config : new Idea73012Config();
