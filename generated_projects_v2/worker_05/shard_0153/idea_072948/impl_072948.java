...
@Data
public class Idea72948Config {
    private String name = "idea_072948";
 ...
 */
@Slf4j
public class Idea72948Service {
    private static final int IDEA_ID = 72948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72948Service() {
        this(new Idea72948Config());
    }

    public Idea72948Service(Idea72948Config config) {
        this.config = config != null ? config : new Idea72948Config();
