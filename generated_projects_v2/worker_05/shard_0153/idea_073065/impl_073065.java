...
@Data
public class Idea73065Config {
    private String name = "idea_073065";
 ...
 */
@Slf4j
public class Idea73065Service {
    private static final int IDEA_ID = 73065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73065Service() {
        this(new Idea73065Config());
    }

    public Idea73065Service(Idea73065Config config) {
        this.config = config != null ? config : new Idea73065Config();
