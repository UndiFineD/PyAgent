...
@Data
public class Idea72685Config {
    private String name = "idea_072685";
 ...
 */
@Slf4j
public class Idea72685Service {
    private static final int IDEA_ID = 72685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72685Service() {
        this(new Idea72685Config());
    }

    public Idea72685Service(Idea72685Config config) {
        this.config = config != null ? config : new Idea72685Config();
