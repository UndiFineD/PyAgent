...
@Data
public class Idea72832Config {
    private String name = "idea_072832";
 ...
 */
@Slf4j
public class Idea72832Service {
    private static final int IDEA_ID = 72832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72832Service() {
        this(new Idea72832Config());
    }

    public Idea72832Service(Idea72832Config config) {
        this.config = config != null ? config : new Idea72832Config();
