...
@Data
public class Idea73009Config {
    private String name = "idea_073009";
 ...
 */
@Slf4j
public class Idea73009Service {
    private static final int IDEA_ID = 73009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73009Service() {
        this(new Idea73009Config());
    }

    public Idea73009Service(Idea73009Config config) {
        this.config = config != null ? config : new Idea73009Config();
