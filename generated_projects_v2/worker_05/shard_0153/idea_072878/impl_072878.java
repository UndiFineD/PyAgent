...
@Data
public class Idea72878Config {
    private String name = "idea_072878";
 ...
 */
@Slf4j
public class Idea72878Service {
    private static final int IDEA_ID = 72878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72878Service() {
        this(new Idea72878Config());
    }

    public Idea72878Service(Idea72878Config config) {
        this.config = config != null ? config : new Idea72878Config();
