...
@Data
public class Idea72838Config {
    private String name = "idea_072838";
 ...
 */
@Slf4j
public class Idea72838Service {
    private static final int IDEA_ID = 72838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72838Service() {
        this(new Idea72838Config());
    }

    public Idea72838Service(Idea72838Config config) {
        this.config = config != null ? config : new Idea72838Config();
