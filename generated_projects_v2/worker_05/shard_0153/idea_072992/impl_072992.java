...
@Data
public class Idea72992Config {
    private String name = "idea_072992";
 ...
 */
@Slf4j
public class Idea72992Service {
    private static final int IDEA_ID = 72992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72992Service() {
        this(new Idea72992Config());
    }

    public Idea72992Service(Idea72992Config config) {
        this.config = config != null ? config : new Idea72992Config();
