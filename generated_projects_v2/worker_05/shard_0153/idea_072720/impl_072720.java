...
@Data
public class Idea72720Config {
    private String name = "idea_072720";
 ...
 */
@Slf4j
public class Idea72720Service {
    private static final int IDEA_ID = 72720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72720Service() {
        this(new Idea72720Config());
    }

    public Idea72720Service(Idea72720Config config) {
        this.config = config != null ? config : new Idea72720Config();
