...
@Data
public class Idea72786Config {
    private String name = "idea_072786";
 ...
 */
@Slf4j
public class Idea72786Service {
    private static final int IDEA_ID = 72786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72786Service() {
        this(new Idea72786Config());
    }

    public Idea72786Service(Idea72786Config config) {
        this.config = config != null ? config : new Idea72786Config();
