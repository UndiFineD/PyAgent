...
@Data
public class Idea73137Config {
    private String name = "idea_073137";
 ...
 */
@Slf4j
public class Idea73137Service {
    private static final int IDEA_ID = 73137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73137Service() {
        this(new Idea73137Config());
    }

    public Idea73137Service(Idea73137Config config) {
        this.config = config != null ? config : new Idea73137Config();
