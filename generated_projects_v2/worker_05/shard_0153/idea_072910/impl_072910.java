...
@Data
public class Idea72910Config {
    private String name = "idea_072910";
 ...
 */
@Slf4j
public class Idea72910Service {
    private static final int IDEA_ID = 72910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72910Service() {
        this(new Idea72910Config());
    }

    public Idea72910Service(Idea72910Config config) {
        this.config = config != null ? config : new Idea72910Config();
