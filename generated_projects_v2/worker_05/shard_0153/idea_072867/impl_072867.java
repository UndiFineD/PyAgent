...
@Data
public class Idea72867Config {
    private String name = "idea_072867";
 ...
 */
@Slf4j
public class Idea72867Service {
    private static final int IDEA_ID = 72867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72867Service() {
        this(new Idea72867Config());
    }

    public Idea72867Service(Idea72867Config config) {
        this.config = config != null ? config : new Idea72867Config();
