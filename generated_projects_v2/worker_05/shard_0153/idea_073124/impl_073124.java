...
@Data
public class Idea73124Config {
    private String name = "idea_073124";
 ...
 */
@Slf4j
public class Idea73124Service {
    private static final int IDEA_ID = 73124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73124Service() {
        this(new Idea73124Config());
    }

    public Idea73124Service(Idea73124Config config) {
        this.config = config != null ? config : new Idea73124Config();
