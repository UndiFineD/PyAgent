...
@Data
public class Idea73005Config {
    private String name = "idea_073005";
 ...
 */
@Slf4j
public class Idea73005Service {
    private static final int IDEA_ID = 73005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73005Service() {
        this(new Idea73005Config());
    }

    public Idea73005Service(Idea73005Config config) {
        this.config = config != null ? config : new Idea73005Config();
