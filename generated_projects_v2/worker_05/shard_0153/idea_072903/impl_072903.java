...
@Data
public class Idea72903Config {
    private String name = "idea_072903";
 ...
 */
@Slf4j
public class Idea72903Service {
    private static final int IDEA_ID = 72903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72903Service() {
        this(new Idea72903Config());
    }

    public Idea72903Service(Idea72903Config config) {
        this.config = config != null ? config : new Idea72903Config();
