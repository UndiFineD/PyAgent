...
@Data
public class Idea72740Config {
    private String name = "idea_072740";
 ...
 */
@Slf4j
public class Idea72740Service {
    private static final int IDEA_ID = 72740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72740Service() {
        this(new Idea72740Config());
    }

    public Idea72740Service(Idea72740Config config) {
        this.config = config != null ? config : new Idea72740Config();
