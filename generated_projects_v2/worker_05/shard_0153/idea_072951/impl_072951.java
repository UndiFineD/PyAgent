...
@Data
public class Idea72951Config {
    private String name = "idea_072951";
 ...
 */
@Slf4j
public class Idea72951Service {
    private static final int IDEA_ID = 72951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72951Service() {
        this(new Idea72951Config());
    }

    public Idea72951Service(Idea72951Config config) {
        this.config = config != null ? config : new Idea72951Config();
