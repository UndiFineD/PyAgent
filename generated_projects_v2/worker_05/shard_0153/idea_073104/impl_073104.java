...
@Data
public class Idea73104Config {
    private String name = "idea_073104";
 ...
 */
@Slf4j
public class Idea73104Service {
    private static final int IDEA_ID = 73104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73104Service() {
        this(new Idea73104Config());
    }

    public Idea73104Service(Idea73104Config config) {
        this.config = config != null ? config : new Idea73104Config();
