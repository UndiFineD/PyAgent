...
@Data
public class Idea72968Config {
    private String name = "idea_072968";
 ...
 */
@Slf4j
public class Idea72968Service {
    private static final int IDEA_ID = 72968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72968Service() {
        this(new Idea72968Config());
    }

    public Idea72968Service(Idea72968Config config) {
        this.config = config != null ? config : new Idea72968Config();
