...
@Data
public class Idea72929Config {
    private String name = "idea_072929";
 ...
 */
@Slf4j
public class Idea72929Service {
    private static final int IDEA_ID = 72929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72929Service() {
        this(new Idea72929Config());
    }

    public Idea72929Service(Idea72929Config config) {
        this.config = config != null ? config : new Idea72929Config();
