...
@Data
public class Idea73006Config {
    private String name = "idea_073006";
 ...
 */
@Slf4j
public class Idea73006Service {
    private static final int IDEA_ID = 73006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73006Service() {
        this(new Idea73006Config());
    }

    public Idea73006Service(Idea73006Config config) {
        this.config = config != null ? config : new Idea73006Config();
