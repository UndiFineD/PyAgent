...
@Data
public class Idea72970Config {
    private String name = "idea_072970";
 ...
 */
@Slf4j
public class Idea72970Service {
    private static final int IDEA_ID = 72970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72970Service() {
        this(new Idea72970Config());
    }

    public Idea72970Service(Idea72970Config config) {
        this.config = config != null ? config : new Idea72970Config();
