...
@Data
public class Idea72769Config {
    private String name = "idea_072769";
 ...
 */
@Slf4j
public class Idea72769Service {
    private static final int IDEA_ID = 72769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72769Service() {
        this(new Idea72769Config());
    }

    public Idea72769Service(Idea72769Config config) {
        this.config = config != null ? config : new Idea72769Config();
