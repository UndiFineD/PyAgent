...
@Data
public class Idea72974Config {
    private String name = "idea_072974";
 ...
 */
@Slf4j
public class Idea72974Service {
    private static final int IDEA_ID = 72974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72974Service() {
        this(new Idea72974Config());
    }

    public Idea72974Service(Idea72974Config config) {
        this.config = config != null ? config : new Idea72974Config();
