...
@Data
public class Idea72830Config {
    private String name = "idea_072830";
 ...
 */
@Slf4j
public class Idea72830Service {
    private static final int IDEA_ID = 72830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72830Service() {
        this(new Idea72830Config());
    }

    public Idea72830Service(Idea72830Config config) {
        this.config = config != null ? config : new Idea72830Config();
