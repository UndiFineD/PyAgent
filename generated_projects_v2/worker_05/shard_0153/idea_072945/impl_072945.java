...
@Data
public class Idea72945Config {
    private String name = "idea_072945";
 ...
 */
@Slf4j
public class Idea72945Service {
    private static final int IDEA_ID = 72945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72945Service() {
        this(new Idea72945Config());
    }

    public Idea72945Service(Idea72945Config config) {
        this.config = config != null ? config : new Idea72945Config();
