...
@Data
public class Idea72917Config {
    private String name = "idea_072917";
 ...
 */
@Slf4j
public class Idea72917Service {
    private static final int IDEA_ID = 72917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72917Service() {
        this(new Idea72917Config());
    }

    public Idea72917Service(Idea72917Config config) {
        this.config = config != null ? config : new Idea72917Config();
