...
@Data
public class Idea73037Config {
    private String name = "idea_073037";
 ...
 */
@Slf4j
public class Idea73037Service {
    private static final int IDEA_ID = 73037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73037Service() {
        this(new Idea73037Config());
    }

    public Idea73037Service(Idea73037Config config) {
        this.config = config != null ? config : new Idea73037Config();
