...
@Data
public class Idea72691Config {
    private String name = "idea_072691";
 ...
 */
@Slf4j
public class Idea72691Service {
    private static final int IDEA_ID = 72691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72691Service() {
        this(new Idea72691Config());
    }

    public Idea72691Service(Idea72691Config config) {
        this.config = config != null ? config : new Idea72691Config();
