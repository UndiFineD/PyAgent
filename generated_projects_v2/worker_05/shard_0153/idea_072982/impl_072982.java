...
@Data
public class Idea72982Config {
    private String name = "idea_072982";
 ...
 */
@Slf4j
public class Idea72982Service {
    private static final int IDEA_ID = 72982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72982Service() {
        this(new Idea72982Config());
    }

    public Idea72982Service(Idea72982Config config) {
        this.config = config != null ? config : new Idea72982Config();
