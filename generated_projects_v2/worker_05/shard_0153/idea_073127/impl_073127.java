...
@Data
public class Idea73127Config {
    private String name = "idea_073127";
 ...
 */
@Slf4j
public class Idea73127Service {
    private static final int IDEA_ID = 73127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea73127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea73127Service() {
        this(new Idea73127Config());
    }

    public Idea73127Service(Idea73127Config config) {
        this.config = config != null ? config : new Idea73127Config();
