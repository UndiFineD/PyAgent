...
@Data
public class Idea72901Config {
    private String name = "idea_072901";
 ...
 */
@Slf4j
public class Idea72901Service {
    private static final int IDEA_ID = 72901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72901Service() {
        this(new Idea72901Config());
    }

    public Idea72901Service(Idea72901Config config) {
        this.config = config != null ? config : new Idea72901Config();
