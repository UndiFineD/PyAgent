...
@Data
public class Idea72885Config {
    private String name = "idea_072885";
 ...
 */
@Slf4j
public class Idea72885Service {
    private static final int IDEA_ID = 72885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72885Service() {
        this(new Idea72885Config());
    }

    public Idea72885Service(Idea72885Config config) {
        this.config = config != null ? config : new Idea72885Config();
