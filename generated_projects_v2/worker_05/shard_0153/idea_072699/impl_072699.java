...
@Data
public class Idea72699Config {
    private String name = "idea_072699";
 ...
 */
@Slf4j
public class Idea72699Service {
    private static final int IDEA_ID = 72699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72699Service() {
        this(new Idea72699Config());
    }

    public Idea72699Service(Idea72699Config config) {
        this.config = config != null ? config : new Idea72699Config();
