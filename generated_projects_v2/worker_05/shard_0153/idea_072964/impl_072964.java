...
@Data
public class Idea72964Config {
    private String name = "idea_072964";
 ...
 */
@Slf4j
public class Idea72964Service {
    private static final int IDEA_ID = 72964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72964Service() {
        this(new Idea72964Config());
    }

    public Idea72964Service(Idea72964Config config) {
        this.config = config != null ? config : new Idea72964Config();
