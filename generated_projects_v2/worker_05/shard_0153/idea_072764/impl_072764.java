...
@Data
public class Idea72764Config {
    private String name = "idea_072764";
 ...
 */
@Slf4j
public class Idea72764Service {
    private static final int IDEA_ID = 72764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72764Service() {
        this(new Idea72764Config());
    }

    public Idea72764Service(Idea72764Config config) {
        this.config = config != null ? config : new Idea72764Config();
