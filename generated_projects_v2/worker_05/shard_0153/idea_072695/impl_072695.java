...
@Data
public class Idea72695Config {
    private String name = "idea_072695";
 ...
 */
@Slf4j
public class Idea72695Service {
    private static final int IDEA_ID = 72695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72695Service() {
        this(new Idea72695Config());
    }

    public Idea72695Service(Idea72695Config config) {
        this.config = config != null ? config : new Idea72695Config();
