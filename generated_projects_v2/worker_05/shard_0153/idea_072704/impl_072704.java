...
@Data
public class Idea72704Config {
    private String name = "idea_072704";
 ...
 */
@Slf4j
public class Idea72704Service {
    private static final int IDEA_ID = 72704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72704Service() {
        this(new Idea72704Config());
    }

    public Idea72704Service(Idea72704Config config) {
        this.config = config != null ? config : new Idea72704Config();
