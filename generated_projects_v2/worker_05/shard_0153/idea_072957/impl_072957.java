...
@Data
public class Idea72957Config {
    private String name = "idea_072957";
 ...
 */
@Slf4j
public class Idea72957Service {
    private static final int IDEA_ID = 72957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72957Service() {
        this(new Idea72957Config());
    }

    public Idea72957Service(Idea72957Config config) {
        this.config = config != null ? config : new Idea72957Config();
