...
@Data
public class Idea72777Config {
    private String name = "idea_072777";
 ...
 */
@Slf4j
public class Idea72777Service {
    private static final int IDEA_ID = 72777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72777Service() {
        this(new Idea72777Config());
    }

    public Idea72777Service(Idea72777Config config) {
        this.config = config != null ? config : new Idea72777Config();
