...
@Data
public class Idea72939Config {
    private String name = "idea_072939";
 ...
 */
@Slf4j
public class Idea72939Service {
    private static final int IDEA_ID = 72939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72939Service() {
        this(new Idea72939Config());
    }

    public Idea72939Service(Idea72939Config config) {
        this.config = config != null ? config : new Idea72939Config();
