...
@Data
public class Idea72750Config {
    private String name = "idea_072750";
 ...
 */
@Slf4j
public class Idea72750Service {
    private static final int IDEA_ID = 72750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72750Service() {
        this(new Idea72750Config());
    }

    public Idea72750Service(Idea72750Config config) {
        this.config = config != null ? config : new Idea72750Config();
