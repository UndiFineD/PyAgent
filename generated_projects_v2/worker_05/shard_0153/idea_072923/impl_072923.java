...
@Data
public class Idea72923Config {
    private String name = "idea_072923";
 ...
 */
@Slf4j
public class Idea72923Service {
    private static final int IDEA_ID = 72923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72923Service() {
        this(new Idea72923Config());
    }

    public Idea72923Service(Idea72923Config config) {
        this.config = config != null ? config : new Idea72923Config();
