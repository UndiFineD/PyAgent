...
@Data
public class Idea72959Config {
    private String name = "idea_072959";
 ...
 */
@Slf4j
public class Idea72959Service {
    private static final int IDEA_ID = 72959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72959Service() {
        this(new Idea72959Config());
    }

    public Idea72959Service(Idea72959Config config) {
        this.config = config != null ? config : new Idea72959Config();
