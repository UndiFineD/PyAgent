...
@Data
public class Idea71299Config {
    private String name = "idea_071299";
 ...
 */
@Slf4j
public class Idea71299Service {
    private static final int IDEA_ID = 71299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71299Service() {
        this(new Idea71299Config());
    }

    public Idea71299Service(Idea71299Config config) {
        this.config = config != null ? config : new Idea71299Config();
