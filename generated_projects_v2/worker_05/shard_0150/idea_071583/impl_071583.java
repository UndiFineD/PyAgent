...
@Data
public class Idea71583Config {
    private String name = "idea_071583";
 ...
 */
@Slf4j
public class Idea71583Service {
    private static final int IDEA_ID = 71583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71583Service() {
        this(new Idea71583Config());
    }

    public Idea71583Service(Idea71583Config config) {
        this.config = config != null ? config : new Idea71583Config();
