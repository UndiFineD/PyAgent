...
@Data
public class Idea71335Config {
    private String name = "idea_071335";
 ...
 */
@Slf4j
public class Idea71335Service {
    private static final int IDEA_ID = 71335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71335Service() {
        this(new Idea71335Config());
    }

    public Idea71335Service(Idea71335Config config) {
        this.config = config != null ? config : new Idea71335Config();
