...
@Data
public class Idea71598Config {
    private String name = "idea_071598";
 ...
 */
@Slf4j
public class Idea71598Service {
    private static final int IDEA_ID = 71598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71598Service() {
        this(new Idea71598Config());
    }

    public Idea71598Service(Idea71598Config config) {
        this.config = config != null ? config : new Idea71598Config();
