...
@Data
public class Idea71337Config {
    private String name = "idea_071337";
 ...
 */
@Slf4j
public class Idea71337Service {
    private static final int IDEA_ID = 71337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71337Service() {
        this(new Idea71337Config());
    }

    public Idea71337Service(Idea71337Config config) {
        this.config = config != null ? config : new Idea71337Config();
