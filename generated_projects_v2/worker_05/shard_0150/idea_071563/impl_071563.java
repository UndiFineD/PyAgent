...
@Data
public class Idea71563Config {
    private String name = "idea_071563";
 ...
 */
@Slf4j
public class Idea71563Service {
    private static final int IDEA_ID = 71563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71563Service() {
        this(new Idea71563Config());
    }

    public Idea71563Service(Idea71563Config config) {
        this.config = config != null ? config : new Idea71563Config();
