...
@Data
public class Idea71266Config {
    private String name = "idea_071266";
 ...
 */
@Slf4j
public class Idea71266Service {
    private static final int IDEA_ID = 71266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71266Service() {
        this(new Idea71266Config());
    }

    public Idea71266Service(Idea71266Config config) {
        this.config = config != null ? config : new Idea71266Config();
