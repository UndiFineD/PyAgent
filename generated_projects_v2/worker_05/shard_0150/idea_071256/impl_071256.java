...
@Data
public class Idea71256Config {
    private String name = "idea_071256";
 ...
 */
@Slf4j
public class Idea71256Service {
    private static final int IDEA_ID = 71256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71256Service() {
        this(new Idea71256Config());
    }

    public Idea71256Service(Idea71256Config config) {
        this.config = config != null ? config : new Idea71256Config();
