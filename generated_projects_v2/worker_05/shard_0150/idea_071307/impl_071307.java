...
@Data
public class Idea71307Config {
    private String name = "idea_071307";
 ...
 */
@Slf4j
public class Idea71307Service {
    private static final int IDEA_ID = 71307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71307Service() {
        this(new Idea71307Config());
    }

    public Idea71307Service(Idea71307Config config) {
        this.config = config != null ? config : new Idea71307Config();
