...
@Data
public class Idea71704Config {
    private String name = "idea_071704";
 ...
 */
@Slf4j
public class Idea71704Service {
    private static final int IDEA_ID = 71704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71704Service() {
        this(new Idea71704Config());
    }

    public Idea71704Service(Idea71704Config config) {
        this.config = config != null ? config : new Idea71704Config();
