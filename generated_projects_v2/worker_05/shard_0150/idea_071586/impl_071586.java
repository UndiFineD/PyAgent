...
@Data
public class Idea71586Config {
    private String name = "idea_071586";
 ...
 */
@Slf4j
public class Idea71586Service {
    private static final int IDEA_ID = 71586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71586Service() {
        this(new Idea71586Config());
    }

    public Idea71586Service(Idea71586Config config) {
        this.config = config != null ? config : new Idea71586Config();
