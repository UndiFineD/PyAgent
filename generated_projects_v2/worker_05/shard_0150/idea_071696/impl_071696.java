...
@Data
public class Idea71696Config {
    private String name = "idea_071696";
 ...
 */
@Slf4j
public class Idea71696Service {
    private static final int IDEA_ID = 71696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71696Service() {
        this(new Idea71696Config());
    }

    public Idea71696Service(Idea71696Config config) {
        this.config = config != null ? config : new Idea71696Config();
