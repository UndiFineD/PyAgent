...
@Data
public class Idea71472Config {
    private String name = "idea_071472";
 ...
 */
@Slf4j
public class Idea71472Service {
    private static final int IDEA_ID = 71472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71472Service() {
        this(new Idea71472Config());
    }

    public Idea71472Service(Idea71472Config config) {
        this.config = config != null ? config : new Idea71472Config();
