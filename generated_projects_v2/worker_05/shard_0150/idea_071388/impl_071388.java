...
@Data
public class Idea71388Config {
    private String name = "idea_071388";
 ...
 */
@Slf4j
public class Idea71388Service {
    private static final int IDEA_ID = 71388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71388Service() {
        this(new Idea71388Config());
    }

    public Idea71388Service(Idea71388Config config) {
        this.config = config != null ? config : new Idea71388Config();
