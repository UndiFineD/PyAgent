...
@Data
public class Idea71711Config {
    private String name = "idea_071711";
 ...
 */
@Slf4j
public class Idea71711Service {
    private static final int IDEA_ID = 71711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71711Service() {
        this(new Idea71711Config());
    }

    public Idea71711Service(Idea71711Config config) {
        this.config = config != null ? config : new Idea71711Config();
