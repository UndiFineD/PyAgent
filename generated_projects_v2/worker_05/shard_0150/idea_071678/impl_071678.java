...
@Data
public class Idea71678Config {
    private String name = "idea_071678";
 ...
 */
@Slf4j
public class Idea71678Service {
    private static final int IDEA_ID = 71678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71678Service() {
        this(new Idea71678Config());
    }

    public Idea71678Service(Idea71678Config config) {
        this.config = config != null ? config : new Idea71678Config();
