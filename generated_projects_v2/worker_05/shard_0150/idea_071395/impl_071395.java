...
@Data
public class Idea71395Config {
    private String name = "idea_071395";
 ...
 */
@Slf4j
public class Idea71395Service {
    private static final int IDEA_ID = 71395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71395Service() {
        this(new Idea71395Config());
    }

    public Idea71395Service(Idea71395Config config) {
        this.config = config != null ? config : new Idea71395Config();
