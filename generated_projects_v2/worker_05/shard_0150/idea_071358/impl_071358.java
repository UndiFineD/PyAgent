...
@Data
public class Idea71358Config {
    private String name = "idea_071358";
 ...
 */
@Slf4j
public class Idea71358Service {
    private static final int IDEA_ID = 71358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71358Service() {
        this(new Idea71358Config());
    }

    public Idea71358Service(Idea71358Config config) {
        this.config = config != null ? config : new Idea71358Config();
