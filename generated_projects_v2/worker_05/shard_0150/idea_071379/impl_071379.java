...
@Data
public class Idea71379Config {
    private String name = "idea_071379";
 ...
 */
@Slf4j
public class Idea71379Service {
    private static final int IDEA_ID = 71379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71379Service() {
        this(new Idea71379Config());
    }

    public Idea71379Service(Idea71379Config config) {
        this.config = config != null ? config : new Idea71379Config();
