...
@Data
public class Idea71422Config {
    private String name = "idea_071422";
 ...
 */
@Slf4j
public class Idea71422Service {
    private static final int IDEA_ID = 71422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71422Service() {
        this(new Idea71422Config());
    }

    public Idea71422Service(Idea71422Config config) {
        this.config = config != null ? config : new Idea71422Config();
