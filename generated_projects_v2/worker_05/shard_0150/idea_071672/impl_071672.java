...
@Data
public class Idea71672Config {
    private String name = "idea_071672";
 ...
 */
@Slf4j
public class Idea71672Service {
    private static final int IDEA_ID = 71672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71672Service() {
        this(new Idea71672Config());
    }

    public Idea71672Service(Idea71672Config config) {
        this.config = config != null ? config : new Idea71672Config();
