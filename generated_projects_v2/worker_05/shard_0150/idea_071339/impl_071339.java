...
@Data
public class Idea71339Config {
    private String name = "idea_071339";
 ...
 */
@Slf4j
public class Idea71339Service {
    private static final int IDEA_ID = 71339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71339Service() {
        this(new Idea71339Config());
    }

    public Idea71339Service(Idea71339Config config) {
        this.config = config != null ? config : new Idea71339Config();
