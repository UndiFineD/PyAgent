...
@Data
public class Idea71707Config {
    private String name = "idea_071707";
 ...
 */
@Slf4j
public class Idea71707Service {
    private static final int IDEA_ID = 71707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71707Service() {
        this(new Idea71707Config());
    }

    public Idea71707Service(Idea71707Config config) {
        this.config = config != null ? config : new Idea71707Config();
