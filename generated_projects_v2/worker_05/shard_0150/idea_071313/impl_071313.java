...
@Data
public class Idea71313Config {
    private String name = "idea_071313";
 ...
 */
@Slf4j
public class Idea71313Service {
    private static final int IDEA_ID = 71313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71313Service() {
        this(new Idea71313Config());
    }

    public Idea71313Service(Idea71313Config config) {
        this.config = config != null ? config : new Idea71313Config();
