...
@Data
public class Idea71591Config {
    private String name = "idea_071591";
 ...
 */
@Slf4j
public class Idea71591Service {
    private static final int IDEA_ID = 71591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71591Service() {
        this(new Idea71591Config());
    }

    public Idea71591Service(Idea71591Config config) {
        this.config = config != null ? config : new Idea71591Config();
