...
@Data
public class Idea71632Config {
    private String name = "idea_071632";
 ...
 */
@Slf4j
public class Idea71632Service {
    private static final int IDEA_ID = 71632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71632Service() {
        this(new Idea71632Config());
    }

    public Idea71632Service(Idea71632Config config) {
        this.config = config != null ? config : new Idea71632Config();
