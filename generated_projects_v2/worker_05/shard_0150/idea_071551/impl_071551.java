...
@Data
public class Idea71551Config {
    private String name = "idea_071551";
 ...
 */
@Slf4j
public class Idea71551Service {
    private static final int IDEA_ID = 71551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71551Service() {
        this(new Idea71551Config());
    }

    public Idea71551Service(Idea71551Config config) {
        this.config = config != null ? config : new Idea71551Config();
