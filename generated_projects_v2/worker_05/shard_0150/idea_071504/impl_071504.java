...
@Data
public class Idea71504Config {
    private String name = "idea_071504";
 ...
 */
@Slf4j
public class Idea71504Service {
    private static final int IDEA_ID = 71504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71504Service() {
        this(new Idea71504Config());
    }

    public Idea71504Service(Idea71504Config config) {
        this.config = config != null ? config : new Idea71504Config();
