...
@Data
public class Idea71610Config {
    private String name = "idea_071610";
 ...
 */
@Slf4j
public class Idea71610Service {
    private static final int IDEA_ID = 71610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71610Service() {
        this(new Idea71610Config());
    }

    public Idea71610Service(Idea71610Config config) {
        this.config = config != null ? config : new Idea71610Config();
