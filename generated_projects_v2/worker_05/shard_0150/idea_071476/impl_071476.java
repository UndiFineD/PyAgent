...
@Data
public class Idea71476Config {
    private String name = "idea_071476";
 ...
 */
@Slf4j
public class Idea71476Service {
    private static final int IDEA_ID = 71476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71476Service() {
        this(new Idea71476Config());
    }

    public Idea71476Service(Idea71476Config config) {
        this.config = config != null ? config : new Idea71476Config();
