...
@Data
public class Idea71600Config {
    private String name = "idea_071600";
 ...
 */
@Slf4j
public class Idea71600Service {
    private static final int IDEA_ID = 71600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71600Service() {
        this(new Idea71600Config());
    }

    public Idea71600Service(Idea71600Config config) {
        this.config = config != null ? config : new Idea71600Config();
