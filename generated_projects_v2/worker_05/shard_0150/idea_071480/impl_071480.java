...
@Data
public class Idea71480Config {
    private String name = "idea_071480";
 ...
 */
@Slf4j
public class Idea71480Service {
    private static final int IDEA_ID = 71480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71480Service() {
        this(new Idea71480Config());
    }

    public Idea71480Service(Idea71480Config config) {
        this.config = config != null ? config : new Idea71480Config();
