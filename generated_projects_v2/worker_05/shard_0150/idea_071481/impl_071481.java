...
@Data
public class Idea71481Config {
    private String name = "idea_071481";
 ...
 */
@Slf4j
public class Idea71481Service {
    private static final int IDEA_ID = 71481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71481Service() {
        this(new Idea71481Config());
    }

    public Idea71481Service(Idea71481Config config) {
        this.config = config != null ? config : new Idea71481Config();
