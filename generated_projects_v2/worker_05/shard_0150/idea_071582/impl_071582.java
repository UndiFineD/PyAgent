...
@Data
public class Idea71582Config {
    private String name = "idea_071582";
 ...
 */
@Slf4j
public class Idea71582Service {
    private static final int IDEA_ID = 71582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71582Service() {
        this(new Idea71582Config());
    }

    public Idea71582Service(Idea71582Config config) {
        this.config = config != null ? config : new Idea71582Config();
