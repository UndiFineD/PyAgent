...
@Data
public class Idea71561Config {
    private String name = "idea_071561";
 ...
 */
@Slf4j
public class Idea71561Service {
    private static final int IDEA_ID = 71561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71561Service() {
        this(new Idea71561Config());
    }

    public Idea71561Service(Idea71561Config config) {
        this.config = config != null ? config : new Idea71561Config();
