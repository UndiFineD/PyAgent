...
@Data
public class Idea71574Config {
    private String name = "idea_071574";
 ...
 */
@Slf4j
public class Idea71574Service {
    private static final int IDEA_ID = 71574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71574Service() {
        this(new Idea71574Config());
    }

    public Idea71574Service(Idea71574Config config) {
        this.config = config != null ? config : new Idea71574Config();
