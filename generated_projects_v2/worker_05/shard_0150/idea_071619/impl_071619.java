...
@Data
public class Idea71619Config {
    private String name = "idea_071619";
 ...
 */
@Slf4j
public class Idea71619Service {
    private static final int IDEA_ID = 71619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71619Service() {
        this(new Idea71619Config());
    }

    public Idea71619Service(Idea71619Config config) {
        this.config = config != null ? config : new Idea71619Config();
