...
@Data
public class Idea71487Config {
    private String name = "idea_071487";
 ...
 */
@Slf4j
public class Idea71487Service {
    private static final int IDEA_ID = 71487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71487Service() {
        this(new Idea71487Config());
    }

    public Idea71487Service(Idea71487Config config) {
        this.config = config != null ? config : new Idea71487Config();
