...
@Data
public class Idea71702Config {
    private String name = "idea_071702";
 ...
 */
@Slf4j
public class Idea71702Service {
    private static final int IDEA_ID = 71702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71702Service() {
        this(new Idea71702Config());
    }

    public Idea71702Service(Idea71702Config config) {
        this.config = config != null ? config : new Idea71702Config();
