...
@Data
public class Idea71547Config {
    private String name = "idea_071547";
 ...
 */
@Slf4j
public class Idea71547Service {
    private static final int IDEA_ID = 71547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71547Service() {
        this(new Idea71547Config());
    }

    public Idea71547Service(Idea71547Config config) {
        this.config = config != null ? config : new Idea71547Config();
