...
@Data
public class Idea71336Config {
    private String name = "idea_071336";
 ...
 */
@Slf4j
public class Idea71336Service {
    private static final int IDEA_ID = 71336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71336Service() {
        this(new Idea71336Config());
    }

    public Idea71336Service(Idea71336Config config) {
        this.config = config != null ? config : new Idea71336Config();
