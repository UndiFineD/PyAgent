...
@Data
public class Idea71317Config {
    private String name = "idea_071317";
 ...
 */
@Slf4j
public class Idea71317Service {
    private static final int IDEA_ID = 71317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71317Service() {
        this(new Idea71317Config());
    }

    public Idea71317Service(Idea71317Config config) {
        this.config = config != null ? config : new Idea71317Config();
