...
@Data
public class Idea71321Config {
    private String name = "idea_071321";
 ...
 */
@Slf4j
public class Idea71321Service {
    private static final int IDEA_ID = 71321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71321Service() {
        this(new Idea71321Config());
    }

    public Idea71321Service(Idea71321Config config) {
        this.config = config != null ? config : new Idea71321Config();
