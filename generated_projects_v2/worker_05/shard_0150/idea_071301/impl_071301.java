...
@Data
public class Idea71301Config {
    private String name = "idea_071301";
 ...
 */
@Slf4j
public class Idea71301Service {
    private static final int IDEA_ID = 71301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71301Service() {
        this(new Idea71301Config());
    }

    public Idea71301Service(Idea71301Config config) {
        this.config = config != null ? config : new Idea71301Config();
