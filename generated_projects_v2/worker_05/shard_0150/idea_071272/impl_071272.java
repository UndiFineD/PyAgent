...
@Data
public class Idea71272Config {
    private String name = "idea_071272";
 ...
 */
@Slf4j
public class Idea71272Service {
    private static final int IDEA_ID = 71272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71272Service() {
        this(new Idea71272Config());
    }

    public Idea71272Service(Idea71272Config config) {
        this.config = config != null ? config : new Idea71272Config();
