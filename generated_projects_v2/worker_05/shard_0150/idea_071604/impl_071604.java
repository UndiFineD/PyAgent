...
@Data
public class Idea71604Config {
    private String name = "idea_071604";
 ...
 */
@Slf4j
public class Idea71604Service {
    private static final int IDEA_ID = 71604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71604Service() {
        this(new Idea71604Config());
    }

    public Idea71604Service(Idea71604Config config) {
        this.config = config != null ? config : new Idea71604Config();
