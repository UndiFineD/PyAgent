...
@Data
public class Idea71325Config {
    private String name = "idea_071325";
 ...
 */
@Slf4j
public class Idea71325Service {
    private static final int IDEA_ID = 71325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71325Service() {
        this(new Idea71325Config());
    }

    public Idea71325Service(Idea71325Config config) {
        this.config = config != null ? config : new Idea71325Config();
