...
@Data
public class Idea71257Config {
    private String name = "idea_071257";
 ...
 */
@Slf4j
public class Idea71257Service {
    private static final int IDEA_ID = 71257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71257Service() {
        this(new Idea71257Config());
    }

    public Idea71257Service(Idea71257Config config) {
        this.config = config != null ? config : new Idea71257Config();
