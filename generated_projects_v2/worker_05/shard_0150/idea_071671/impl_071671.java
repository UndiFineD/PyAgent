...
@Data
public class Idea71671Config {
    private String name = "idea_071671";
 ...
 */
@Slf4j
public class Idea71671Service {
    private static final int IDEA_ID = 71671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71671Service() {
        this(new Idea71671Config());
    }

    public Idea71671Service(Idea71671Config config) {
        this.config = config != null ? config : new Idea71671Config();
