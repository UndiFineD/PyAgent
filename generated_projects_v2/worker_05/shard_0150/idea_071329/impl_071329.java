...
@Data
public class Idea71329Config {
    private String name = "idea_071329";
 ...
 */
@Slf4j
public class Idea71329Service {
    private static final int IDEA_ID = 71329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71329Service() {
        this(new Idea71329Config());
    }

    public Idea71329Service(Idea71329Config config) {
        this.config = config != null ? config : new Idea71329Config();
