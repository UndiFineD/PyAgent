...
@Data
public class Idea71316Config {
    private String name = "idea_071316";
 ...
 */
@Slf4j
public class Idea71316Service {
    private static final int IDEA_ID = 71316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71316Service() {
        this(new Idea71316Config());
    }

    public Idea71316Service(Idea71316Config config) {
        this.config = config != null ? config : new Idea71316Config();
