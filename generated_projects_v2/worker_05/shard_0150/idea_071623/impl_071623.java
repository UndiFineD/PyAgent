...
@Data
public class Idea71623Config {
    private String name = "idea_071623";
 ...
 */
@Slf4j
public class Idea71623Service {
    private static final int IDEA_ID = 71623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71623Service() {
        this(new Idea71623Config());
    }

    public Idea71623Service(Idea71623Config config) {
        this.config = config != null ? config : new Idea71623Config();
