...
@Data
public class Idea71297Config {
    private String name = "idea_071297";
 ...
 */
@Slf4j
public class Idea71297Service {
    private static final int IDEA_ID = 71297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71297Service() {
        this(new Idea71297Config());
    }

    public Idea71297Service(Idea71297Config config) {
        this.config = config != null ? config : new Idea71297Config();
