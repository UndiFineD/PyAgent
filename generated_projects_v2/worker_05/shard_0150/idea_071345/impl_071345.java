...
@Data
public class Idea71345Config {
    private String name = "idea_071345";
 ...
 */
@Slf4j
public class Idea71345Service {
    private static final int IDEA_ID = 71345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71345Service() {
        this(new Idea71345Config());
    }

    public Idea71345Service(Idea71345Config config) {
        this.config = config != null ? config : new Idea71345Config();
