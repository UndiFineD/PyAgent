...
@Data
public class Idea71412Config {
    private String name = "idea_071412";
 ...
 */
@Slf4j
public class Idea71412Service {
    private static final int IDEA_ID = 71412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71412Service() {
        this(new Idea71412Config());
    }

    public Idea71412Service(Idea71412Config config) {
        this.config = config != null ? config : new Idea71412Config();
