...
@Data
public class Idea71680Config {
    private String name = "idea_071680";
 ...
 */
@Slf4j
public class Idea71680Service {
    private static final int IDEA_ID = 71680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71680Service() {
        this(new Idea71680Config());
    }

    public Idea71680Service(Idea71680Config config) {
        this.config = config != null ? config : new Idea71680Config();
