...
@Data
public class Idea71541Config {
    private String name = "idea_071541";
 ...
 */
@Slf4j
public class Idea71541Service {
    private static final int IDEA_ID = 71541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71541Service() {
        this(new Idea71541Config());
    }

    public Idea71541Service(Idea71541Config config) {
        this.config = config != null ? config : new Idea71541Config();
