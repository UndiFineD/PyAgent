...
@Data
public class Idea71408Config {
    private String name = "idea_071408";
 ...
 */
@Slf4j
public class Idea71408Service {
    private static final int IDEA_ID = 71408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71408Service() {
        this(new Idea71408Config());
    }

    public Idea71408Service(Idea71408Config config) {
        this.config = config != null ? config : new Idea71408Config();
