...
@Data
public class Idea71286Config {
    private String name = "idea_071286";
 ...
 */
@Slf4j
public class Idea71286Service {
    private static final int IDEA_ID = 71286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71286Service() {
        this(new Idea71286Config());
    }

    public Idea71286Service(Idea71286Config config) {
        this.config = config != null ? config : new Idea71286Config();
