...
@Data
public class Idea71470Config {
    private String name = "idea_071470";
 ...
 */
@Slf4j
public class Idea71470Service {
    private static final int IDEA_ID = 71470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71470Service() {
        this(new Idea71470Config());
    }

    public Idea71470Service(Idea71470Config config) {
        this.config = config != null ? config : new Idea71470Config();
