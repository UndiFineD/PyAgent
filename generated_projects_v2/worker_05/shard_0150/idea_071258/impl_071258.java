...
@Data
public class Idea71258Config {
    private String name = "idea_071258";
 ...
 */
@Slf4j
public class Idea71258Service {
    private static final int IDEA_ID = 71258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71258Service() {
        this(new Idea71258Config());
    }

    public Idea71258Service(Idea71258Config config) {
        this.config = config != null ? config : new Idea71258Config();
