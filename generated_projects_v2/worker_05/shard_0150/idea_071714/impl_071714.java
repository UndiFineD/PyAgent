...
@Data
public class Idea71714Config {
    private String name = "idea_071714";
 ...
 */
@Slf4j
public class Idea71714Service {
    private static final int IDEA_ID = 71714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71714Service() {
        this(new Idea71714Config());
    }

    public Idea71714Service(Idea71714Config config) {
        this.config = config != null ? config : new Idea71714Config();
