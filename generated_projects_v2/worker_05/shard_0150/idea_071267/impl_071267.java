...
@Data
public class Idea71267Config {
    private String name = "idea_071267";
 ...
 */
@Slf4j
public class Idea71267Service {
    private static final int IDEA_ID = 71267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71267Service() {
        this(new Idea71267Config());
    }

    public Idea71267Service(Idea71267Config config) {
        this.config = config != null ? config : new Idea71267Config();
