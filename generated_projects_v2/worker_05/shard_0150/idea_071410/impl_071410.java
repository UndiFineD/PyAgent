...
@Data
public class Idea71410Config {
    private String name = "idea_071410";
 ...
 */
@Slf4j
public class Idea71410Service {
    private static final int IDEA_ID = 71410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71410Service() {
        this(new Idea71410Config());
    }

    public Idea71410Service(Idea71410Config config) {
        this.config = config != null ? config : new Idea71410Config();
