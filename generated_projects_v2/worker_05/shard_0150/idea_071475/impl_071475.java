...
@Data
public class Idea71475Config {
    private String name = "idea_071475";
 ...
 */
@Slf4j
public class Idea71475Service {
    private static final int IDEA_ID = 71475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71475Service() {
        this(new Idea71475Config());
    }

    public Idea71475Service(Idea71475Config config) {
        this.config = config != null ? config : new Idea71475Config();
