...
@Data
public class Idea71508Config {
    private String name = "idea_071508";
 ...
 */
@Slf4j
public class Idea71508Service {
    private static final int IDEA_ID = 71508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71508Service() {
        this(new Idea71508Config());
    }

    public Idea71508Service(Idea71508Config config) {
        this.config = config != null ? config : new Idea71508Config();
