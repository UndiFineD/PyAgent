...
@Data
public class Idea71662Config {
    private String name = "idea_071662";
 ...
 */
@Slf4j
public class Idea71662Service {
    private static final int IDEA_ID = 71662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71662Service() {
        this(new Idea71662Config());
    }

    public Idea71662Service(Idea71662Config config) {
        this.config = config != null ? config : new Idea71662Config();
