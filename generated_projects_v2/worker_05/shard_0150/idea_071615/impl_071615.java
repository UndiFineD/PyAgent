...
@Data
public class Idea71615Config {
    private String name = "idea_071615";
 ...
 */
@Slf4j
public class Idea71615Service {
    private static final int IDEA_ID = 71615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71615Service() {
        this(new Idea71615Config());
    }

    public Idea71615Service(Idea71615Config config) {
        this.config = config != null ? config : new Idea71615Config();
