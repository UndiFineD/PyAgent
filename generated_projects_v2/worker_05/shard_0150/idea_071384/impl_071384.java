...
@Data
public class Idea71384Config {
    private String name = "idea_071384";
 ...
 */
@Slf4j
public class Idea71384Service {
    private static final int IDEA_ID = 71384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71384Service() {
        this(new Idea71384Config());
    }

    public Idea71384Service(Idea71384Config config) {
        this.config = config != null ? config : new Idea71384Config();
