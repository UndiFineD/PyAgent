...
@Data
public class Idea71585Config {
    private String name = "idea_071585";
 ...
 */
@Slf4j
public class Idea71585Service {
    private static final int IDEA_ID = 71585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71585Service() {
        this(new Idea71585Config());
    }

    public Idea71585Service(Idea71585Config config) {
        this.config = config != null ? config : new Idea71585Config();
