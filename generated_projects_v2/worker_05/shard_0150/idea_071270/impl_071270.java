...
@Data
public class Idea71270Config {
    private String name = "idea_071270";
 ...
 */
@Slf4j
public class Idea71270Service {
    private static final int IDEA_ID = 71270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71270Service() {
        this(new Idea71270Config());
    }

    public Idea71270Service(Idea71270Config config) {
        this.config = config != null ? config : new Idea71270Config();
