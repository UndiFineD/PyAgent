...
@Data
public class Idea71419Config {
    private String name = "idea_071419";
 ...
 */
@Slf4j
public class Idea71419Service {
    private static final int IDEA_ID = 71419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71419Service() {
        this(new Idea71419Config());
    }

    public Idea71419Service(Idea71419Config config) {
        this.config = config != null ? config : new Idea71419Config();
