...
@Data
public class Idea71713Config {
    private String name = "idea_071713";
 ...
 */
@Slf4j
public class Idea71713Service {
    private static final int IDEA_ID = 71713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71713Service() {
        this(new Idea71713Config());
    }

    public Idea71713Service(Idea71713Config config) {
        this.config = config != null ? config : new Idea71713Config();
