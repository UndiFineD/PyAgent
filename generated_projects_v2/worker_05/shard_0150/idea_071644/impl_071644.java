...
@Data
public class Idea71644Config {
    private String name = "idea_071644";
 ...
 */
@Slf4j
public class Idea71644Service {
    private static final int IDEA_ID = 71644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71644Service() {
        this(new Idea71644Config());
    }

    public Idea71644Service(Idea71644Config config) {
        this.config = config != null ? config : new Idea71644Config();
