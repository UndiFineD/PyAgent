...
@Data
public class Idea71575Config {
    private String name = "idea_071575";
 ...
 */
@Slf4j
public class Idea71575Service {
    private static final int IDEA_ID = 71575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71575Service() {
        this(new Idea71575Config());
    }

    public Idea71575Service(Idea71575Config config) {
        this.config = config != null ? config : new Idea71575Config();
