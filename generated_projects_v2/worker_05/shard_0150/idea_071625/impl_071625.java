...
@Data
public class Idea71625Config {
    private String name = "idea_071625";
 ...
 */
@Slf4j
public class Idea71625Service {
    private static final int IDEA_ID = 71625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71625Service() {
        this(new Idea71625Config());
    }

    public Idea71625Service(Idea71625Config config) {
        this.config = config != null ? config : new Idea71625Config();
