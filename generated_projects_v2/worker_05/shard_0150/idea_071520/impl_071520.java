...
@Data
public class Idea71520Config {
    private String name = "idea_071520";
 ...
 */
@Slf4j
public class Idea71520Service {
    private static final int IDEA_ID = 71520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71520Service() {
        this(new Idea71520Config());
    }

    public Idea71520Service(Idea71520Config config) {
        this.config = config != null ? config : new Idea71520Config();
