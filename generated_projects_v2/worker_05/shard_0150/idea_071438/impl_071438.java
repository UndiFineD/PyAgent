...
@Data
public class Idea71438Config {
    private String name = "idea_071438";
 ...
 */
@Slf4j
public class Idea71438Service {
    private static final int IDEA_ID = 71438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71438Service() {
        this(new Idea71438Config());
    }

    public Idea71438Service(Idea71438Config config) {
        this.config = config != null ? config : new Idea71438Config();
