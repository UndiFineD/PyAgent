...
@Data
public class Idea71390Config {
    private String name = "idea_071390";
 ...
 */
@Slf4j
public class Idea71390Service {
    private static final int IDEA_ID = 71390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71390Service() {
        this(new Idea71390Config());
    }

    public Idea71390Service(Idea71390Config config) {
        this.config = config != null ? config : new Idea71390Config();
