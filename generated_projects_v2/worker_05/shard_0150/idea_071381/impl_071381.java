...
@Data
public class Idea71381Config {
    private String name = "idea_071381";
 ...
 */
@Slf4j
public class Idea71381Service {
    private static final int IDEA_ID = 71381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71381Service() {
        this(new Idea71381Config());
    }

    public Idea71381Service(Idea71381Config config) {
        this.config = config != null ? config : new Idea71381Config();
