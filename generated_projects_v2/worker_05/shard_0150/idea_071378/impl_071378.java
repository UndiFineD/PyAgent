...
@Data
public class Idea71378Config {
    private String name = "idea_071378";
 ...
 */
@Slf4j
public class Idea71378Service {
    private static final int IDEA_ID = 71378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71378Service() {
        this(new Idea71378Config());
    }

    public Idea71378Service(Idea71378Config config) {
        this.config = config != null ? config : new Idea71378Config();
