...
@Data
public class Idea71284Config {
    private String name = "idea_071284";
 ...
 */
@Slf4j
public class Idea71284Service {
    private static final int IDEA_ID = 71284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71284Service() {
        this(new Idea71284Config());
    }

    public Idea71284Service(Idea71284Config config) {
        this.config = config != null ? config : new Idea71284Config();
