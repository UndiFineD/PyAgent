...
@Data
public class Idea71323Config {
    private String name = "idea_071323";
 ...
 */
@Slf4j
public class Idea71323Service {
    private static final int IDEA_ID = 71323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71323Service() {
        this(new Idea71323Config());
    }

    public Idea71323Service(Idea71323Config config) {
        this.config = config != null ? config : new Idea71323Config();
