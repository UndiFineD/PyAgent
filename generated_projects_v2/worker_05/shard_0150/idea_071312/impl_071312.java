...
@Data
public class Idea71312Config {
    private String name = "idea_071312";
 ...
 */
@Slf4j
public class Idea71312Service {
    private static final int IDEA_ID = 71312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71312Service() {
        this(new Idea71312Config());
    }

    public Idea71312Service(Idea71312Config config) {
        this.config = config != null ? config : new Idea71312Config();
