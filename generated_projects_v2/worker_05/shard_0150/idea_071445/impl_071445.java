...
@Data
public class Idea71445Config {
    private String name = "idea_071445";
 ...
 */
@Slf4j
public class Idea71445Service {
    private static final int IDEA_ID = 71445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71445Service() {
        this(new Idea71445Config());
    }

    public Idea71445Service(Idea71445Config config) {
        this.config = config != null ? config : new Idea71445Config();
