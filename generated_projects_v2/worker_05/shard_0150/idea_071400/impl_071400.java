...
@Data
public class Idea71400Config {
    private String name = "idea_071400";
 ...
 */
@Slf4j
public class Idea71400Service {
    private static final int IDEA_ID = 71400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71400Service() {
        this(new Idea71400Config());
    }

    public Idea71400Service(Idea71400Config config) {
        this.config = config != null ? config : new Idea71400Config();
