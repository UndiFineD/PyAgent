...
@Data
public class Idea71326Config {
    private String name = "idea_071326";
 ...
 */
@Slf4j
public class Idea71326Service {
    private static final int IDEA_ID = 71326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71326Service() {
        this(new Idea71326Config());
    }

    public Idea71326Service(Idea71326Config config) {
        this.config = config != null ? config : new Idea71326Config();
