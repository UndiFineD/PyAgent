...
@Data
public class Idea71330Config {
    private String name = "idea_071330";
 ...
 */
@Slf4j
public class Idea71330Service {
    private static final int IDEA_ID = 71330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71330Service() {
        this(new Idea71330Config());
    }

    public Idea71330Service(Idea71330Config config) {
        this.config = config != null ? config : new Idea71330Config();
