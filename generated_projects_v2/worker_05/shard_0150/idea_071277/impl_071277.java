...
@Data
public class Idea71277Config {
    private String name = "idea_071277";
 ...
 */
@Slf4j
public class Idea71277Service {
    private static final int IDEA_ID = 71277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71277Service() {
        this(new Idea71277Config());
    }

    public Idea71277Service(Idea71277Config config) {
        this.config = config != null ? config : new Idea71277Config();
