...
@Data
public class Idea71462Config {
    private String name = "idea_071462";
 ...
 */
@Slf4j
public class Idea71462Service {
    private static final int IDEA_ID = 71462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71462Service() {
        this(new Idea71462Config());
    }

    public Idea71462Service(Idea71462Config config) {
        this.config = config != null ? config : new Idea71462Config();
