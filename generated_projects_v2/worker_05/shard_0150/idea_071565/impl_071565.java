...
@Data
public class Idea71565Config {
    private String name = "idea_071565";
 ...
 */
@Slf4j
public class Idea71565Service {
    private static final int IDEA_ID = 71565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71565Service() {
        this(new Idea71565Config());
    }

    public Idea71565Service(Idea71565Config config) {
        this.config = config != null ? config : new Idea71565Config();
