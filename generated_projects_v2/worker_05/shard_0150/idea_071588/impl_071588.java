...
@Data
public class Idea71588Config {
    private String name = "idea_071588";
 ...
 */
@Slf4j
public class Idea71588Service {
    private static final int IDEA_ID = 71588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71588Service() {
        this(new Idea71588Config());
    }

    public Idea71588Service(Idea71588Config config) {
        this.config = config != null ? config : new Idea71588Config();
