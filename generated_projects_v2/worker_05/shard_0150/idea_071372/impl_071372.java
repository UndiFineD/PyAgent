...
@Data
public class Idea71372Config {
    private String name = "idea_071372";
 ...
 */
@Slf4j
public class Idea71372Service {
    private static final int IDEA_ID = 71372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71372Service() {
        this(new Idea71372Config());
    }

    public Idea71372Service(Idea71372Config config) {
        this.config = config != null ? config : new Idea71372Config();
