...
@Data
public class Idea71592Config {
    private String name = "idea_071592";
 ...
 */
@Slf4j
public class Idea71592Service {
    private static final int IDEA_ID = 71592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71592Service() {
        this(new Idea71592Config());
    }

    public Idea71592Service(Idea71592Config config) {
        this.config = config != null ? config : new Idea71592Config();
