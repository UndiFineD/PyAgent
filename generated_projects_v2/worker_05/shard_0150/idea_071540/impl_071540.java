...
@Data
public class Idea71540Config {
    private String name = "idea_071540";
 ...
 */
@Slf4j
public class Idea71540Service {
    private static final int IDEA_ID = 71540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71540Service() {
        this(new Idea71540Config());
    }

    public Idea71540Service(Idea71540Config config) {
        this.config = config != null ? config : new Idea71540Config();
