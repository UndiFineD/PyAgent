...
@Data
public class Idea71513Config {
    private String name = "idea_071513";
 ...
 */
@Slf4j
public class Idea71513Service {
    private static final int IDEA_ID = 71513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71513Service() {
        this(new Idea71513Config());
    }

    public Idea71513Service(Idea71513Config config) {
        this.config = config != null ? config : new Idea71513Config();
