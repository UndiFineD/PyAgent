...
@Data
public class Idea71611Config {
    private String name = "idea_071611";
 ...
 */
@Slf4j
public class Idea71611Service {
    private static final int IDEA_ID = 71611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71611Service() {
        this(new Idea71611Config());
    }

    public Idea71611Service(Idea71611Config config) {
        this.config = config != null ? config : new Idea71611Config();
