...
@Data
public class Idea71571Config {
    private String name = "idea_071571";
 ...
 */
@Slf4j
public class Idea71571Service {
    private static final int IDEA_ID = 71571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71571Service() {
        this(new Idea71571Config());
    }

    public Idea71571Service(Idea71571Config config) {
        this.config = config != null ? config : new Idea71571Config();
