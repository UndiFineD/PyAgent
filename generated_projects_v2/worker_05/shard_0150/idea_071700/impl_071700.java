...
@Data
public class Idea71700Config {
    private String name = "idea_071700";
 ...
 */
@Slf4j
public class Idea71700Service {
    private static final int IDEA_ID = 71700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71700Service() {
        this(new Idea71700Config());
    }

    public Idea71700Service(Idea71700Config config) {
        this.config = config != null ? config : new Idea71700Config();
