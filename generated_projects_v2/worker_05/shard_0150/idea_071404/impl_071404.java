...
@Data
public class Idea71404Config {
    private String name = "idea_071404";
 ...
 */
@Slf4j
public class Idea71404Service {
    private static final int IDEA_ID = 71404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71404Service() {
        this(new Idea71404Config());
    }

    public Idea71404Service(Idea71404Config config) {
        this.config = config != null ? config : new Idea71404Config();
