...
@Data
public class Idea71695Config {
    private String name = "idea_071695";
 ...
 */
@Slf4j
public class Idea71695Service {
    private static final int IDEA_ID = 71695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71695Service() {
        this(new Idea71695Config());
    }

    public Idea71695Service(Idea71695Config config) {
        this.config = config != null ? config : new Idea71695Config();
