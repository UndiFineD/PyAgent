...
@Data
public class Idea71348Config {
    private String name = "idea_071348";
 ...
 */
@Slf4j
public class Idea71348Service {
    private static final int IDEA_ID = 71348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71348Service() {
        this(new Idea71348Config());
    }

    public Idea71348Service(Idea71348Config config) {
        this.config = config != null ? config : new Idea71348Config();
