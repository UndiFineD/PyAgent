...
@Data
public class Idea71698Config {
    private String name = "idea_071698";
 ...
 */
@Slf4j
public class Idea71698Service {
    private static final int IDEA_ID = 71698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71698Service() {
        this(new Idea71698Config());
    }

    public Idea71698Service(Idea71698Config config) {
        this.config = config != null ? config : new Idea71698Config();
