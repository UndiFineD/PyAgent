...
@Data
public class Idea71314Config {
    private String name = "idea_071314";
 ...
 */
@Slf4j
public class Idea71314Service {
    private static final int IDEA_ID = 71314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71314Service() {
        this(new Idea71314Config());
    }

    public Idea71314Service(Idea71314Config config) {
        this.config = config != null ? config : new Idea71314Config();
