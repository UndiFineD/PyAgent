...
@Data
public class Idea71630Config {
    private String name = "idea_071630";
 ...
 */
@Slf4j
public class Idea71630Service {
    private static final int IDEA_ID = 71630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71630Service() {
        this(new Idea71630Config());
    }

    public Idea71630Service(Idea71630Config config) {
        this.config = config != null ? config : new Idea71630Config();
