...
@Data
public class Idea71617Config {
    private String name = "idea_071617";
 ...
 */
@Slf4j
public class Idea71617Service {
    private static final int IDEA_ID = 71617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71617Service() {
        this(new Idea71617Config());
    }

    public Idea71617Service(Idea71617Config config) {
        this.config = config != null ? config : new Idea71617Config();
