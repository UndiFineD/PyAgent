...
@Data
public class Idea71686Config {
    private String name = "idea_071686";
 ...
 */
@Slf4j
public class Idea71686Service {
    private static final int IDEA_ID = 71686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71686Service() {
        this(new Idea71686Config());
    }

    public Idea71686Service(Idea71686Config config) {
        this.config = config != null ? config : new Idea71686Config();
