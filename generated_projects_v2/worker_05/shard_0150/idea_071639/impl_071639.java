...
@Data
public class Idea71639Config {
    private String name = "idea_071639";
 ...
 */
@Slf4j
public class Idea71639Service {
    private static final int IDEA_ID = 71639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71639Service() {
        this(new Idea71639Config());
    }

    public Idea71639Service(Idea71639Config config) {
        this.config = config != null ? config : new Idea71639Config();
