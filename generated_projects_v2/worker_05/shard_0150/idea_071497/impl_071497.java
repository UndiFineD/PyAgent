...
@Data
public class Idea71497Config {
    private String name = "idea_071497";
 ...
 */
@Slf4j
public class Idea71497Service {
    private static final int IDEA_ID = 71497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71497Service() {
        this(new Idea71497Config());
    }

    public Idea71497Service(Idea71497Config config) {
        this.config = config != null ? config : new Idea71497Config();
