...
@Data
public class Idea71328Config {
    private String name = "idea_071328";
 ...
 */
@Slf4j
public class Idea71328Service {
    private static final int IDEA_ID = 71328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71328Service() {
        this(new Idea71328Config());
    }

    public Idea71328Service(Idea71328Config config) {
        this.config = config != null ? config : new Idea71328Config();
