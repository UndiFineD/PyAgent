...
@Data
public class Idea71403Config {
    private String name = "idea_071403";
 ...
 */
@Slf4j
public class Idea71403Service {
    private static final int IDEA_ID = 71403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71403Service() {
        this(new Idea71403Config());
    }

    public Idea71403Service(Idea71403Config config) {
        this.config = config != null ? config : new Idea71403Config();
