...
@Data
public class Idea71524Config {
    private String name = "idea_071524";
 ...
 */
@Slf4j
public class Idea71524Service {
    private static final int IDEA_ID = 71524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71524Service() {
        this(new Idea71524Config());
    }

    public Idea71524Service(Idea71524Config config) {
        this.config = config != null ? config : new Idea71524Config();
