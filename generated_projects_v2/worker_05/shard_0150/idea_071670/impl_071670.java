...
@Data
public class Idea71670Config {
    private String name = "idea_071670";
 ...
 */
@Slf4j
public class Idea71670Service {
    private static final int IDEA_ID = 71670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71670Service() {
        this(new Idea71670Config());
    }

    public Idea71670Service(Idea71670Config config) {
        this.config = config != null ? config : new Idea71670Config();
