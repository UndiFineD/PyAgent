...
@Data
public class Idea71281Config {
    private String name = "idea_071281";
 ...
 */
@Slf4j
public class Idea71281Service {
    private static final int IDEA_ID = 71281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71281Service() {
        this(new Idea71281Config());
    }

    public Idea71281Service(Idea71281Config config) {
        this.config = config != null ? config : new Idea71281Config();
