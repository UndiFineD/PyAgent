...
@Data
public class Idea71441Config {
    private String name = "idea_071441";
 ...
 */
@Slf4j
public class Idea71441Service {
    private static final int IDEA_ID = 71441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71441Service() {
        this(new Idea71441Config());
    }

    public Idea71441Service(Idea71441Config config) {
        this.config = config != null ? config : new Idea71441Config();
