...
@Data
public class Idea71638Config {
    private String name = "idea_071638";
 ...
 */
@Slf4j
public class Idea71638Service {
    private static final int IDEA_ID = 71638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71638Service() {
        this(new Idea71638Config());
    }

    public Idea71638Service(Idea71638Config config) {
        this.config = config != null ? config : new Idea71638Config();
