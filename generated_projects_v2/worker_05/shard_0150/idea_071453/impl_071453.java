...
@Data
public class Idea71453Config {
    private String name = "idea_071453";
 ...
 */
@Slf4j
public class Idea71453Service {
    private static final int IDEA_ID = 71453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71453Service() {
        this(new Idea71453Config());
    }

    public Idea71453Service(Idea71453Config config) {
        this.config = config != null ? config : new Idea71453Config();
