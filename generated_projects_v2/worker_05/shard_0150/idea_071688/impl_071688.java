...
@Data
public class Idea71688Config {
    private String name = "idea_071688";
 ...
 */
@Slf4j
public class Idea71688Service {
    private static final int IDEA_ID = 71688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71688Service() {
        this(new Idea71688Config());
    }

    public Idea71688Service(Idea71688Config config) {
        this.config = config != null ? config : new Idea71688Config();
