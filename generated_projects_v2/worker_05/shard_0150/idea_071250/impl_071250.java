...
@Data
public class Idea71250Config {
    private String name = "idea_071250";
 ...
 */
@Slf4j
public class Idea71250Service {
    private static final int IDEA_ID = 71250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71250Service() {
        this(new Idea71250Config());
    }

    public Idea71250Service(Idea71250Config config) {
        this.config = config != null ? config : new Idea71250Config();
