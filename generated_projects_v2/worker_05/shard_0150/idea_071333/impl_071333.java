...
@Data
public class Idea71333Config {
    private String name = "idea_071333";
 ...
 */
@Slf4j
public class Idea71333Service {
    private static final int IDEA_ID = 71333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71333Service() {
        this(new Idea71333Config());
    }

    public Idea71333Service(Idea71333Config config) {
        this.config = config != null ? config : new Idea71333Config();
