...
@Data
public class Idea71570Config {
    private String name = "idea_071570";
 ...
 */
@Slf4j
public class Idea71570Service {
    private static final int IDEA_ID = 71570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71570Service() {
        this(new Idea71570Config());
    }

    public Idea71570Service(Idea71570Config config) {
        this.config = config != null ? config : new Idea71570Config();
