...
@Data
public class Idea71467Config {
    private String name = "idea_071467";
 ...
 */
@Slf4j
public class Idea71467Service {
    private static final int IDEA_ID = 71467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71467Service() {
        this(new Idea71467Config());
    }

    public Idea71467Service(Idea71467Config config) {
        this.config = config != null ? config : new Idea71467Config();
