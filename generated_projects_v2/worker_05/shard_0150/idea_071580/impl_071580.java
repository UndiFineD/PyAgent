...
@Data
public class Idea71580Config {
    private String name = "idea_071580";
 ...
 */
@Slf4j
public class Idea71580Service {
    private static final int IDEA_ID = 71580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71580Service() {
        this(new Idea71580Config());
    }

    public Idea71580Service(Idea71580Config config) {
        this.config = config != null ? config : new Idea71580Config();
