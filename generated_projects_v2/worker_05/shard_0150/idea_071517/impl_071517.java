...
@Data
public class Idea71517Config {
    private String name = "idea_071517";
 ...
 */
@Slf4j
public class Idea71517Service {
    private static final int IDEA_ID = 71517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71517Service() {
        this(new Idea71517Config());
    }

    public Idea71517Service(Idea71517Config config) {
        this.config = config != null ? config : new Idea71517Config();
