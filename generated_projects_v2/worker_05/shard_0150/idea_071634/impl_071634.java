...
@Data
public class Idea71634Config {
    private String name = "idea_071634";
 ...
 */
@Slf4j
public class Idea71634Service {
    private static final int IDEA_ID = 71634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71634Service() {
        this(new Idea71634Config());
    }

    public Idea71634Service(Idea71634Config config) {
        this.config = config != null ? config : new Idea71634Config();
