...
@Data
public class Idea71451Config {
    private String name = "idea_071451";
 ...
 */
@Slf4j
public class Idea71451Service {
    private static final int IDEA_ID = 71451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71451Service() {
        this(new Idea71451Config());
    }

    public Idea71451Service(Idea71451Config config) {
        this.config = config != null ? config : new Idea71451Config();
