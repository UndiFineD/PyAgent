...
@Data
public class Idea71421Config {
    private String name = "idea_071421";
 ...
 */
@Slf4j
public class Idea71421Service {
    private static final int IDEA_ID = 71421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71421Service() {
        this(new Idea71421Config());
    }

    public Idea71421Service(Idea71421Config config) {
        this.config = config != null ? config : new Idea71421Config();
