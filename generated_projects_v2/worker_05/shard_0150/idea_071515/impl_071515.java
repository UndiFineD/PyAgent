...
@Data
public class Idea71515Config {
    private String name = "idea_071515";
 ...
 */
@Slf4j
public class Idea71515Service {
    private static final int IDEA_ID = 71515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71515Service() {
        this(new Idea71515Config());
    }

    public Idea71515Service(Idea71515Config config) {
        this.config = config != null ? config : new Idea71515Config();
