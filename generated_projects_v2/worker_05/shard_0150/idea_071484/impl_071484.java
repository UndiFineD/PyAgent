...
@Data
public class Idea71484Config {
    private String name = "idea_071484";
 ...
 */
@Slf4j
public class Idea71484Service {
    private static final int IDEA_ID = 71484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71484Service() {
        this(new Idea71484Config());
    }

    public Idea71484Service(Idea71484Config config) {
        this.config = config != null ? config : new Idea71484Config();
