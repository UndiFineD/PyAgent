...
@Data
public class Idea71360Config {
    private String name = "idea_071360";
 ...
 */
@Slf4j
public class Idea71360Service {
    private static final int IDEA_ID = 71360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71360Service() {
        this(new Idea71360Config());
    }

    public Idea71360Service(Idea71360Config config) {
        this.config = config != null ? config : new Idea71360Config();
