...
@Data
public class Idea71545Config {
    private String name = "idea_071545";
 ...
 */
@Slf4j
public class Idea71545Service {
    private static final int IDEA_ID = 71545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71545Service() {
        this(new Idea71545Config());
    }

    public Idea71545Service(Idea71545Config config) {
        this.config = config != null ? config : new Idea71545Config();
