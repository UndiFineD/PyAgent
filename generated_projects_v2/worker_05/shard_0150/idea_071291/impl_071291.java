...
@Data
public class Idea71291Config {
    private String name = "idea_071291";
 ...
 */
@Slf4j
public class Idea71291Service {
    private static final int IDEA_ID = 71291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71291Service() {
        this(new Idea71291Config());
    }

    public Idea71291Service(Idea71291Config config) {
        this.config = config != null ? config : new Idea71291Config();
