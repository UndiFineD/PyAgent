...
@Data
public class Idea71478Config {
    private String name = "idea_071478";
 ...
 */
@Slf4j
public class Idea71478Service {
    private static final int IDEA_ID = 71478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71478Service() {
        this(new Idea71478Config());
    }

    public Idea71478Service(Idea71478Config config) {
        this.config = config != null ? config : new Idea71478Config();
