...
@Data
public class Idea71295Config {
    private String name = "idea_071295";
 ...
 */
@Slf4j
public class Idea71295Service {
    private static final int IDEA_ID = 71295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71295Service() {
        this(new Idea71295Config());
    }

    public Idea71295Service(Idea71295Config config) {
        this.config = config != null ? config : new Idea71295Config();
