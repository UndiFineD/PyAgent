...
@Data
public class Idea71589Config {
    private String name = "idea_071589";
 ...
 */
@Slf4j
public class Idea71589Service {
    private static final int IDEA_ID = 71589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71589Service() {
        this(new Idea71589Config());
    }

    public Idea71589Service(Idea71589Config config) {
        this.config = config != null ? config : new Idea71589Config();
