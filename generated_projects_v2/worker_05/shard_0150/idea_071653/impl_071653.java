...
@Data
public class Idea71653Config {
    private String name = "idea_071653";
 ...
 */
@Slf4j
public class Idea71653Service {
    private static final int IDEA_ID = 71653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71653Service() {
        this(new Idea71653Config());
    }

    public Idea71653Service(Idea71653Config config) {
        this.config = config != null ? config : new Idea71653Config();
