...
@Data
public class Idea71447Config {
    private String name = "idea_071447";
 ...
 */
@Slf4j
public class Idea71447Service {
    private static final int IDEA_ID = 71447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71447Service() {
        this(new Idea71447Config());
    }

    public Idea71447Service(Idea71447Config config) {
        this.config = config != null ? config : new Idea71447Config();
