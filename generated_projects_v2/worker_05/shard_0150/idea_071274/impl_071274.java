...
@Data
public class Idea71274Config {
    private String name = "idea_071274";
 ...
 */
@Slf4j
public class Idea71274Service {
    private static final int IDEA_ID = 71274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71274Service() {
        this(new Idea71274Config());
    }

    public Idea71274Service(Idea71274Config config) {
        this.config = config != null ? config : new Idea71274Config();
