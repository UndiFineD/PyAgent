...
@Data
public class Idea71302Config {
    private String name = "idea_071302";
 ...
 */
@Slf4j
public class Idea71302Service {
    private static final int IDEA_ID = 71302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71302Service() {
        this(new Idea71302Config());
    }

    public Idea71302Service(Idea71302Config config) {
        this.config = config != null ? config : new Idea71302Config();
