...
@Data
public class Idea71532Config {
    private String name = "idea_071532";
 ...
 */
@Slf4j
public class Idea71532Service {
    private static final int IDEA_ID = 71532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71532Service() {
        this(new Idea71532Config());
    }

    public Idea71532Service(Idea71532Config config) {
        this.config = config != null ? config : new Idea71532Config();
