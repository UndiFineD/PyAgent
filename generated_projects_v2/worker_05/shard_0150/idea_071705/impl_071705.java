...
@Data
public class Idea71705Config {
    private String name = "idea_071705";
 ...
 */
@Slf4j
public class Idea71705Service {
    private static final int IDEA_ID = 71705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71705Service() {
        this(new Idea71705Config());
    }

    public Idea71705Service(Idea71705Config config) {
        this.config = config != null ? config : new Idea71705Config();
