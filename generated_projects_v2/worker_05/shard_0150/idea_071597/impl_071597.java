...
@Data
public class Idea71597Config {
    private String name = "idea_071597";
 ...
 */
@Slf4j
public class Idea71597Service {
    private static final int IDEA_ID = 71597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71597Service() {
        this(new Idea71597Config());
    }

    public Idea71597Service(Idea71597Config config) {
        this.config = config != null ? config : new Idea71597Config();
