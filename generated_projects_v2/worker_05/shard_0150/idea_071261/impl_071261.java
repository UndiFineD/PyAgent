...
@Data
public class Idea71261Config {
    private String name = "idea_071261";
 ...
 */
@Slf4j
public class Idea71261Service {
    private static final int IDEA_ID = 71261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71261Service() {
        this(new Idea71261Config());
    }

    public Idea71261Service(Idea71261Config config) {
        this.config = config != null ? config : new Idea71261Config();
