...
@Data
public class Idea71603Config {
    private String name = "idea_071603";
 ...
 */
@Slf4j
public class Idea71603Service {
    private static final int IDEA_ID = 71603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71603Service() {
        this(new Idea71603Config());
    }

    public Idea71603Service(Idea71603Config config) {
        this.config = config != null ? config : new Idea71603Config();
