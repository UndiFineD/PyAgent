...
@Data
public class Idea71507Config {
    private String name = "idea_071507";
 ...
 */
@Slf4j
public class Idea71507Service {
    private static final int IDEA_ID = 71507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71507Service() {
        this(new Idea71507Config());
    }

    public Idea71507Service(Idea71507Config config) {
        this.config = config != null ? config : new Idea71507Config();
