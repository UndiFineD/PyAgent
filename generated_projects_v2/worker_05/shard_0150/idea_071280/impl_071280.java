...
@Data
public class Idea71280Config {
    private String name = "idea_071280";
 ...
 */
@Slf4j
public class Idea71280Service {
    private static final int IDEA_ID = 71280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71280Service() {
        this(new Idea71280Config());
    }

    public Idea71280Service(Idea71280Config config) {
        this.config = config != null ? config : new Idea71280Config();
