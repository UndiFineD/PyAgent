...
@Data
public class Idea71511Config {
    private String name = "idea_071511";
 ...
 */
@Slf4j
public class Idea71511Service {
    private static final int IDEA_ID = 71511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71511Service() {
        this(new Idea71511Config());
    }

    public Idea71511Service(Idea71511Config config) {
        this.config = config != null ? config : new Idea71511Config();
