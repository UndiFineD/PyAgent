...
@Data
public class Idea71673Config {
    private String name = "idea_071673";
 ...
 */
@Slf4j
public class Idea71673Service {
    private static final int IDEA_ID = 71673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71673Service() {
        this(new Idea71673Config());
    }

    public Idea71673Service(Idea71673Config config) {
        this.config = config != null ? config : new Idea71673Config();
