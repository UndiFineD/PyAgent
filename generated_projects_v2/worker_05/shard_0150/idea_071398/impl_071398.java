...
@Data
public class Idea71398Config {
    private String name = "idea_071398";
 ...
 */
@Slf4j
public class Idea71398Service {
    private static final int IDEA_ID = 71398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71398Service() {
        this(new Idea71398Config());
    }

    public Idea71398Service(Idea71398Config config) {
        this.config = config != null ? config : new Idea71398Config();
