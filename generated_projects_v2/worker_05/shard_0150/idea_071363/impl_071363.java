...
@Data
public class Idea71363Config {
    private String name = "idea_071363";
 ...
 */
@Slf4j
public class Idea71363Service {
    private static final int IDEA_ID = 71363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71363Service() {
        this(new Idea71363Config());
    }

    public Idea71363Service(Idea71363Config config) {
        this.config = config != null ? config : new Idea71363Config();
