...
@Data
public class Idea71428Config {
    private String name = "idea_071428";
 ...
 */
@Slf4j
public class Idea71428Service {
    private static final int IDEA_ID = 71428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71428Service() {
        this(new Idea71428Config());
    }

    public Idea71428Service(Idea71428Config config) {
        this.config = config != null ? config : new Idea71428Config();
