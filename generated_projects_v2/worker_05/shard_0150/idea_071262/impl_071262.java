...
@Data
public class Idea71262Config {
    private String name = "idea_071262";
 ...
 */
@Slf4j
public class Idea71262Service {
    private static final int IDEA_ID = 71262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71262Service() {
        this(new Idea71262Config());
    }

    public Idea71262Service(Idea71262Config config) {
        this.config = config != null ? config : new Idea71262Config();
