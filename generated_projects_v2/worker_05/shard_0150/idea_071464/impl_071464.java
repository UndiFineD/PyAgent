...
@Data
public class Idea71464Config {
    private String name = "idea_071464";
 ...
 */
@Slf4j
public class Idea71464Service {
    private static final int IDEA_ID = 71464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71464Service() {
        this(new Idea71464Config());
    }

    public Idea71464Service(Idea71464Config config) {
        this.config = config != null ? config : new Idea71464Config();
