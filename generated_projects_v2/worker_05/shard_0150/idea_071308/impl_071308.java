...
@Data
public class Idea71308Config {
    private String name = "idea_071308";
 ...
 */
@Slf4j
public class Idea71308Service {
    private static final int IDEA_ID = 71308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71308Service() {
        this(new Idea71308Config());
    }

    public Idea71308Service(Idea71308Config config) {
        this.config = config != null ? config : new Idea71308Config();
