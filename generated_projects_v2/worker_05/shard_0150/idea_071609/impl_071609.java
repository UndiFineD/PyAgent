...
@Data
public class Idea71609Config {
    private String name = "idea_071609";
 ...
 */
@Slf4j
public class Idea71609Service {
    private static final int IDEA_ID = 71609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71609Service() {
        this(new Idea71609Config());
    }

    public Idea71609Service(Idea71609Config config) {
        this.config = config != null ? config : new Idea71609Config();
