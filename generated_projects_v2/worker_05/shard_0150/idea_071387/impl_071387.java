...
@Data
public class Idea71387Config {
    private String name = "idea_071387";
 ...
 */
@Slf4j
public class Idea71387Service {
    private static final int IDEA_ID = 71387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71387Service() {
        this(new Idea71387Config());
    }

    public Idea71387Service(Idea71387Config config) {
        this.config = config != null ? config : new Idea71387Config();
