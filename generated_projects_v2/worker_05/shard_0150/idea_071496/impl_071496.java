...
@Data
public class Idea71496Config {
    private String name = "idea_071496";
 ...
 */
@Slf4j
public class Idea71496Service {
    private static final int IDEA_ID = 71496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71496Service() {
        this(new Idea71496Config());
    }

    public Idea71496Service(Idea71496Config config) {
        this.config = config != null ? config : new Idea71496Config();
