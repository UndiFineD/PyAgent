...
@Data
public class Idea71386Config {
    private String name = "idea_071386";
 ...
 */
@Slf4j
public class Idea71386Service {
    private static final int IDEA_ID = 71386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71386Service() {
        this(new Idea71386Config());
    }

    public Idea71386Service(Idea71386Config config) {
        this.config = config != null ? config : new Idea71386Config();
