...
@Data
public class Idea71423Config {
    private String name = "idea_071423";
 ...
 */
@Slf4j
public class Idea71423Service {
    private static final int IDEA_ID = 71423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71423Service() {
        this(new Idea71423Config());
    }

    public Idea71423Service(Idea71423Config config) {
        this.config = config != null ? config : new Idea71423Config();
