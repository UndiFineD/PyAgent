...
@Data
public class Idea71602Config {
    private String name = "idea_071602";
 ...
 */
@Slf4j
public class Idea71602Service {
    private static final int IDEA_ID = 71602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71602Service() {
        this(new Idea71602Config());
    }

    public Idea71602Service(Idea71602Config config) {
        this.config = config != null ? config : new Idea71602Config();
