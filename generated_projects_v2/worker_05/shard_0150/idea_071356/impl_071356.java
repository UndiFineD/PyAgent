...
@Data
public class Idea71356Config {
    private String name = "idea_071356";
 ...
 */
@Slf4j
public class Idea71356Service {
    private static final int IDEA_ID = 71356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71356Service() {
        this(new Idea71356Config());
    }

    public Idea71356Service(Idea71356Config config) {
        this.config = config != null ? config : new Idea71356Config();
