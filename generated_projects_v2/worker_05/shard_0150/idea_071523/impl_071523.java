...
@Data
public class Idea71523Config {
    private String name = "idea_071523";
 ...
 */
@Slf4j
public class Idea71523Service {
    private static final int IDEA_ID = 71523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71523Service() {
        this(new Idea71523Config());
    }

    public Idea71523Service(Idea71523Config config) {
        this.config = config != null ? config : new Idea71523Config();
