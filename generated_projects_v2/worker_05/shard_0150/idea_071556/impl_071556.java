...
@Data
public class Idea71556Config {
    private String name = "idea_071556";
 ...
 */
@Slf4j
public class Idea71556Service {
    private static final int IDEA_ID = 71556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71556Service() {
        this(new Idea71556Config());
    }

    public Idea71556Service(Idea71556Config config) {
        this.config = config != null ? config : new Idea71556Config();
