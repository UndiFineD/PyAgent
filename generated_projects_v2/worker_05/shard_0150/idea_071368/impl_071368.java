...
@Data
public class Idea71368Config {
    private String name = "idea_071368";
 ...
 */
@Slf4j
public class Idea71368Service {
    private static final int IDEA_ID = 71368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71368Service() {
        this(new Idea71368Config());
    }

    public Idea71368Service(Idea71368Config config) {
        this.config = config != null ? config : new Idea71368Config();
