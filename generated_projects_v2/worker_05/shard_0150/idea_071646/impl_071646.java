...
@Data
public class Idea71646Config {
    private String name = "idea_071646";
 ...
 */
@Slf4j
public class Idea71646Service {
    private static final int IDEA_ID = 71646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71646Service() {
        this(new Idea71646Config());
    }

    public Idea71646Service(Idea71646Config config) {
        this.config = config != null ? config : new Idea71646Config();
