...
@Data
public class Idea71703Config {
    private String name = "idea_071703";
 ...
 */
@Slf4j
public class Idea71703Service {
    private static final int IDEA_ID = 71703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71703Service() {
        this(new Idea71703Config());
    }

    public Idea71703Service(Idea71703Config config) {
        this.config = config != null ? config : new Idea71703Config();
