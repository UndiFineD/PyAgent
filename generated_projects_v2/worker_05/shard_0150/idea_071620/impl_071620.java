...
@Data
public class Idea71620Config {
    private String name = "idea_071620";
 ...
 */
@Slf4j
public class Idea71620Service {
    private static final int IDEA_ID = 71620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71620Service() {
        this(new Idea71620Config());
    }

    public Idea71620Service(Idea71620Config config) {
        this.config = config != null ? config : new Idea71620Config();
