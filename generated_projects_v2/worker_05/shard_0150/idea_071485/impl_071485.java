...
@Data
public class Idea71485Config {
    private String name = "idea_071485";
 ...
 */
@Slf4j
public class Idea71485Service {
    private static final int IDEA_ID = 71485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71485Service() {
        this(new Idea71485Config());
    }

    public Idea71485Service(Idea71485Config config) {
        this.config = config != null ? config : new Idea71485Config();
