...
@Data
public class Idea71334Config {
    private String name = "idea_071334";
 ...
 */
@Slf4j
public class Idea71334Service {
    private static final int IDEA_ID = 71334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71334Service() {
        this(new Idea71334Config());
    }

    public Idea71334Service(Idea71334Config config) {
        this.config = config != null ? config : new Idea71334Config();
