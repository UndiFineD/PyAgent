...
@Data
public class Idea71596Config {
    private String name = "idea_071596";
 ...
 */
@Slf4j
public class Idea71596Service {
    private static final int IDEA_ID = 71596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71596Service() {
        this(new Idea71596Config());
    }

    public Idea71596Service(Idea71596Config config) {
        this.config = config != null ? config : new Idea71596Config();
