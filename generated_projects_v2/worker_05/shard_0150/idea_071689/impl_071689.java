...
@Data
public class Idea71689Config {
    private String name = "idea_071689";
 ...
 */
@Slf4j
public class Idea71689Service {
    private static final int IDEA_ID = 71689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71689Service() {
        this(new Idea71689Config());
    }

    public Idea71689Service(Idea71689Config config) {
        this.config = config != null ? config : new Idea71689Config();
