...
@Data
public class Idea71691Config {
    private String name = "idea_071691";
 ...
 */
@Slf4j
public class Idea71691Service {
    private static final int IDEA_ID = 71691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71691Service() {
        this(new Idea71691Config());
    }

    public Idea71691Service(Idea71691Config config) {
        this.config = config != null ? config : new Idea71691Config();
