...
@Data
public class Idea71641Config {
    private String name = "idea_071641";
 ...
 */
@Slf4j
public class Idea71641Service {
    private static final int IDEA_ID = 71641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71641Service() {
        this(new Idea71641Config());
    }

    public Idea71641Service(Idea71641Config config) {
        this.config = config != null ? config : new Idea71641Config();
