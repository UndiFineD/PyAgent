...
@Data
public class Idea71366Config {
    private String name = "idea_071366";
 ...
 */
@Slf4j
public class Idea71366Service {
    private static final int IDEA_ID = 71366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71366Service() {
        this(new Idea71366Config());
    }

    public Idea71366Service(Idea71366Config config) {
        this.config = config != null ? config : new Idea71366Config();
