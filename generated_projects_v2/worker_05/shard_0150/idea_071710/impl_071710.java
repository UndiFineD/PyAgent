...
@Data
public class Idea71710Config {
    private String name = "idea_071710";
 ...
 */
@Slf4j
public class Idea71710Service {
    private static final int IDEA_ID = 71710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71710Service() {
        this(new Idea71710Config());
    }

    public Idea71710Service(Idea71710Config config) {
        this.config = config != null ? config : new Idea71710Config();
