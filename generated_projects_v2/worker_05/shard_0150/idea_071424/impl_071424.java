...
@Data
public class Idea71424Config {
    private String name = "idea_071424";
 ...
 */
@Slf4j
public class Idea71424Service {
    private static final int IDEA_ID = 71424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71424Service() {
        this(new Idea71424Config());
    }

    public Idea71424Service(Idea71424Config config) {
        this.config = config != null ? config : new Idea71424Config();
