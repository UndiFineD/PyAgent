...
@Data
public class Idea71675Config {
    private String name = "idea_071675";
 ...
 */
@Slf4j
public class Idea71675Service {
    private static final int IDEA_ID = 71675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71675Service() {
        this(new Idea71675Config());
    }

    public Idea71675Service(Idea71675Config config) {
        this.config = config != null ? config : new Idea71675Config();
