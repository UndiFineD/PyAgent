...
@Data
public class Idea71622Config {
    private String name = "idea_071622";
 ...
 */
@Slf4j
public class Idea71622Service {
    private static final int IDEA_ID = 71622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71622Service() {
        this(new Idea71622Config());
    }

    public Idea71622Service(Idea71622Config config) {
        this.config = config != null ? config : new Idea71622Config();
