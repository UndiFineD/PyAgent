...
@Data
public class Idea71652Config {
    private String name = "idea_071652";
 ...
 */
@Slf4j
public class Idea71652Service {
    private static final int IDEA_ID = 71652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71652Service() {
        this(new Idea71652Config());
    }

    public Idea71652Service(Idea71652Config config) {
        this.config = config != null ? config : new Idea71652Config();
