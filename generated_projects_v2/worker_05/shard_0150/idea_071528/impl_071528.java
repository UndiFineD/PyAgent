...
@Data
public class Idea71528Config {
    private String name = "idea_071528";
 ...
 */
@Slf4j
public class Idea71528Service {
    private static final int IDEA_ID = 71528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71528Service() {
        this(new Idea71528Config());
    }

    public Idea71528Service(Idea71528Config config) {
        this.config = config != null ? config : new Idea71528Config();
