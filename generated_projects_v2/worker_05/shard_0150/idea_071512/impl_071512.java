...
@Data
public class Idea71512Config {
    private String name = "idea_071512";
 ...
 */
@Slf4j
public class Idea71512Service {
    private static final int IDEA_ID = 71512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71512Service() {
        this(new Idea71512Config());
    }

    public Idea71512Service(Idea71512Config config) {
        this.config = config != null ? config : new Idea71512Config();
