...
@Data
public class Idea71252Config {
    private String name = "idea_071252";
 ...
 */
@Slf4j
public class Idea71252Service {
    private static final int IDEA_ID = 71252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71252Service() {
        this(new Idea71252Config());
    }

    public Idea71252Service(Idea71252Config config) {
        this.config = config != null ? config : new Idea71252Config();
