...
@Data
public class Idea71352Config {
    private String name = "idea_071352";
 ...
 */
@Slf4j
public class Idea71352Service {
    private static final int IDEA_ID = 71352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71352Service() {
        this(new Idea71352Config());
    }

    public Idea71352Service(Idea71352Config config) {
        this.config = config != null ? config : new Idea71352Config();
