...
@Data
public class Idea71722Config {
    private String name = "idea_071722";
 ...
 */
@Slf4j
public class Idea71722Service {
    private static final int IDEA_ID = 71722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71722Service() {
        this(new Idea71722Config());
    }

    public Idea71722Service(Idea71722Config config) {
        this.config = config != null ? config : new Idea71722Config();
