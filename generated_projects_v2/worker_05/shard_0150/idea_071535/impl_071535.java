...
@Data
public class Idea71535Config {
    private String name = "idea_071535";
 ...
 */
@Slf4j
public class Idea71535Service {
    private static final int IDEA_ID = 71535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71535Service() {
        this(new Idea71535Config());
    }

    public Idea71535Service(Idea71535Config config) {
        this.config = config != null ? config : new Idea71535Config();
