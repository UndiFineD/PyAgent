...
@Data
public class Idea71614Config {
    private String name = "idea_071614";
 ...
 */
@Slf4j
public class Idea71614Service {
    private static final int IDEA_ID = 71614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71614Service() {
        this(new Idea71614Config());
    }

    public Idea71614Service(Idea71614Config config) {
        this.config = config != null ? config : new Idea71614Config();
