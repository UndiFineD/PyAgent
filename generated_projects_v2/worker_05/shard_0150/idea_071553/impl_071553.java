...
@Data
public class Idea71553Config {
    private String name = "idea_071553";
 ...
 */
@Slf4j
public class Idea71553Service {
    private static final int IDEA_ID = 71553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71553Service() {
        this(new Idea71553Config());
    }

    public Idea71553Service(Idea71553Config config) {
        this.config = config != null ? config : new Idea71553Config();
