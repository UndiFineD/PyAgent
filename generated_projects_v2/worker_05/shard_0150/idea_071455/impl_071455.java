...
@Data
public class Idea71455Config {
    private String name = "idea_071455";
 ...
 */
@Slf4j
public class Idea71455Service {
    private static final int IDEA_ID = 71455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71455Service() {
        this(new Idea71455Config());
    }

    public Idea71455Service(Idea71455Config config) {
        this.config = config != null ? config : new Idea71455Config();
