...
@Data
public class Idea71674Config {
    private String name = "idea_071674";
 ...
 */
@Slf4j
public class Idea71674Service {
    private static final int IDEA_ID = 71674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71674Service() {
        this(new Idea71674Config());
    }

    public Idea71674Service(Idea71674Config config) {
        this.config = config != null ? config : new Idea71674Config();
