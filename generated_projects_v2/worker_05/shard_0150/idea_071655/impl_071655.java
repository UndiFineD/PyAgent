...
@Data
public class Idea71655Config {
    private String name = "idea_071655";
 ...
 */
@Slf4j
public class Idea71655Service {
    private static final int IDEA_ID = 71655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71655Service() {
        this(new Idea71655Config());
    }

    public Idea71655Service(Idea71655Config config) {
        this.config = config != null ? config : new Idea71655Config();
