...
@Data
public class Idea71607Config {
    private String name = "idea_071607";
 ...
 */
@Slf4j
public class Idea71607Service {
    private static final int IDEA_ID = 71607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71607Service() {
        this(new Idea71607Config());
    }

    public Idea71607Service(Idea71607Config config) {
        this.config = config != null ? config : new Idea71607Config();
