...
@Data
public class Idea71529Config {
    private String name = "idea_071529";
 ...
 */
@Slf4j
public class Idea71529Service {
    private static final int IDEA_ID = 71529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71529Service() {
        this(new Idea71529Config());
    }

    public Idea71529Service(Idea71529Config config) {
        this.config = config != null ? config : new Idea71529Config();
