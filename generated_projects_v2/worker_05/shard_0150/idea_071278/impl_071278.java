...
@Data
public class Idea71278Config {
    private String name = "idea_071278";
 ...
 */
@Slf4j
public class Idea71278Service {
    private static final int IDEA_ID = 71278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71278Service() {
        this(new Idea71278Config());
    }

    public Idea71278Service(Idea71278Config config) {
        this.config = config != null ? config : new Idea71278Config();
