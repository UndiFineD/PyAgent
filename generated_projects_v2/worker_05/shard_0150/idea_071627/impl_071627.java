...
@Data
public class Idea71627Config {
    private String name = "idea_071627";
 ...
 */
@Slf4j
public class Idea71627Service {
    private static final int IDEA_ID = 71627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71627Service() {
        this(new Idea71627Config());
    }

    public Idea71627Service(Idea71627Config config) {
        this.config = config != null ? config : new Idea71627Config();
