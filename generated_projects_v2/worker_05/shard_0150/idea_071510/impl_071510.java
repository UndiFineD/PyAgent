...
@Data
public class Idea71510Config {
    private String name = "idea_071510";
 ...
 */
@Slf4j
public class Idea71510Service {
    private static final int IDEA_ID = 71510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71510Service() {
        this(new Idea71510Config());
    }

    public Idea71510Service(Idea71510Config config) {
        this.config = config != null ? config : new Idea71510Config();
