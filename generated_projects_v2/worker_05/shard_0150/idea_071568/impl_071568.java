...
@Data
public class Idea71568Config {
    private String name = "idea_071568";
 ...
 */
@Slf4j
public class Idea71568Service {
    private static final int IDEA_ID = 71568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71568Service() {
        this(new Idea71568Config());
    }

    public Idea71568Service(Idea71568Config config) {
        this.config = config != null ? config : new Idea71568Config();
