...
@Data
public class Idea71616Config {
    private String name = "idea_071616";
 ...
 */
@Slf4j
public class Idea71616Service {
    private static final int IDEA_ID = 71616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71616Service() {
        this(new Idea71616Config());
    }

    public Idea71616Service(Idea71616Config config) {
        this.config = config != null ? config : new Idea71616Config();
