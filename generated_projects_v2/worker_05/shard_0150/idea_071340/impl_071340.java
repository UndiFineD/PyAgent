...
@Data
public class Idea71340Config {
    private String name = "idea_071340";
 ...
 */
@Slf4j
public class Idea71340Service {
    private static final int IDEA_ID = 71340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71340Service() {
        this(new Idea71340Config());
    }

    public Idea71340Service(Idea71340Config config) {
        this.config = config != null ? config : new Idea71340Config();
