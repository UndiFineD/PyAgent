...
@Data
public class Idea71415Config {
    private String name = "idea_071415";
 ...
 */
@Slf4j
public class Idea71415Service {
    private static final int IDEA_ID = 71415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71415Service() {
        this(new Idea71415Config());
    }

    public Idea71415Service(Idea71415Config config) {
        this.config = config != null ? config : new Idea71415Config();
