...
@Data
public class Idea71531Config {
    private String name = "idea_071531";
 ...
 */
@Slf4j
public class Idea71531Service {
    private static final int IDEA_ID = 71531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71531Service() {
        this(new Idea71531Config());
    }

    public Idea71531Service(Idea71531Config config) {
        this.config = config != null ? config : new Idea71531Config();
