...
@Data
public class Idea71690Config {
    private String name = "idea_071690";
 ...
 */
@Slf4j
public class Idea71690Service {
    private static final int IDEA_ID = 71690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71690Service() {
        this(new Idea71690Config());
    }

    public Idea71690Service(Idea71690Config config) {
        this.config = config != null ? config : new Idea71690Config();
