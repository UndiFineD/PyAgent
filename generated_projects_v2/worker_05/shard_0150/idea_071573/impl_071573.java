...
@Data
public class Idea71573Config {
    private String name = "idea_071573";
 ...
 */
@Slf4j
public class Idea71573Service {
    private static final int IDEA_ID = 71573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71573Service() {
        this(new Idea71573Config());
    }

    public Idea71573Service(Idea71573Config config) {
        this.config = config != null ? config : new Idea71573Config();
