...
@Data
public class Idea71666Config {
    private String name = "idea_071666";
 ...
 */
@Slf4j
public class Idea71666Service {
    private static final int IDEA_ID = 71666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71666Service() {
        this(new Idea71666Config());
    }

    public Idea71666Service(Idea71666Config config) {
        this.config = config != null ? config : new Idea71666Config();
