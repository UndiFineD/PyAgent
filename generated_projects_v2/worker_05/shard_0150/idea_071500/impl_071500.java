...
@Data
public class Idea71500Config {
    private String name = "idea_071500";
 ...
 */
@Slf4j
public class Idea71500Service {
    private static final int IDEA_ID = 71500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71500Service() {
        this(new Idea71500Config());
    }

    public Idea71500Service(Idea71500Config config) {
        this.config = config != null ? config : new Idea71500Config();
