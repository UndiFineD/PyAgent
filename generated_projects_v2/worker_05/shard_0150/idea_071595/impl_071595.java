...
@Data
public class Idea71595Config {
    private String name = "idea_071595";
 ...
 */
@Slf4j
public class Idea71595Service {
    private static final int IDEA_ID = 71595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71595Service() {
        this(new Idea71595Config());
    }

    public Idea71595Service(Idea71595Config config) {
        this.config = config != null ? config : new Idea71595Config();
