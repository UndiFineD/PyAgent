...
@Data
public class Idea71608Config {
    private String name = "idea_071608";
 ...
 */
@Slf4j
public class Idea71608Service {
    private static final int IDEA_ID = 71608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71608Service() {
        this(new Idea71608Config());
    }

    public Idea71608Service(Idea71608Config config) {
        this.config = config != null ? config : new Idea71608Config();
