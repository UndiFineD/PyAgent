...
@Data
public class Idea71396Config {
    private String name = "idea_071396";
 ...
 */
@Slf4j
public class Idea71396Service {
    private static final int IDEA_ID = 71396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71396Service() {
        this(new Idea71396Config());
    }

    public Idea71396Service(Idea71396Config config) {
        this.config = config != null ? config : new Idea71396Config();
