...
@Data
public class Idea71635Config {
    private String name = "idea_071635";
 ...
 */
@Slf4j
public class Idea71635Service {
    private static final int IDEA_ID = 71635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71635Service() {
        this(new Idea71635Config());
    }

    public Idea71635Service(Idea71635Config config) {
        this.config = config != null ? config : new Idea71635Config();
