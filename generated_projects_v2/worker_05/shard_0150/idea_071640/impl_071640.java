...
@Data
public class Idea71640Config {
    private String name = "idea_071640";
 ...
 */
@Slf4j
public class Idea71640Service {
    private static final int IDEA_ID = 71640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71640Service() {
        this(new Idea71640Config());
    }

    public Idea71640Service(Idea71640Config config) {
        this.config = config != null ? config : new Idea71640Config();
