...
@Data
public class Idea71411Config {
    private String name = "idea_071411";
 ...
 */
@Slf4j
public class Idea71411Service {
    private static final int IDEA_ID = 71411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71411Service() {
        this(new Idea71411Config());
    }

    public Idea71411Service(Idea71411Config config) {
        this.config = config != null ? config : new Idea71411Config();
