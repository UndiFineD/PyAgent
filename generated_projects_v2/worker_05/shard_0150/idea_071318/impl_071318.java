...
@Data
public class Idea71318Config {
    private String name = "idea_071318";
 ...
 */
@Slf4j
public class Idea71318Service {
    private static final int IDEA_ID = 71318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71318Service() {
        this(new Idea71318Config());
    }

    public Idea71318Service(Idea71318Config config) {
        this.config = config != null ? config : new Idea71318Config();
