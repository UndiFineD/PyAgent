...
@Data
public class Idea71685Config {
    private String name = "idea_071685";
 ...
 */
@Slf4j
public class Idea71685Service {
    private static final int IDEA_ID = 71685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71685Service() {
        this(new Idea71685Config());
    }

    public Idea71685Service(Idea71685Config config) {
        this.config = config != null ? config : new Idea71685Config();
