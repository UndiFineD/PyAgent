...
@Data
public class Idea71370Config {
    private String name = "idea_071370";
 ...
 */
@Slf4j
public class Idea71370Service {
    private static final int IDEA_ID = 71370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71370Service() {
        this(new Idea71370Config());
    }

    public Idea71370Service(Idea71370Config config) {
        this.config = config != null ? config : new Idea71370Config();
