...
@Data
public class Idea71628Config {
    private String name = "idea_071628";
 ...
 */
@Slf4j
public class Idea71628Service {
    private static final int IDEA_ID = 71628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71628Service() {
        this(new Idea71628Config());
    }

    public Idea71628Service(Idea71628Config config) {
        this.config = config != null ? config : new Idea71628Config();
