...
@Data
public class Idea71968Config {
    private String name = "idea_071968";
 ...
 */
@Slf4j
public class Idea71968Service {
    private static final int IDEA_ID = 71968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71968Service() {
        this(new Idea71968Config());
    }

    public Idea71968Service(Idea71968Config config) {
        this.config = config != null ? config : new Idea71968Config();
