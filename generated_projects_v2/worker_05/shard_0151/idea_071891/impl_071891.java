...
@Data
public class Idea71891Config {
    private String name = "idea_071891";
 ...
 */
@Slf4j
public class Idea71891Service {
    private static final int IDEA_ID = 71891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71891Service() {
        this(new Idea71891Config());
    }

    public Idea71891Service(Idea71891Config config) {
        this.config = config != null ? config : new Idea71891Config();
