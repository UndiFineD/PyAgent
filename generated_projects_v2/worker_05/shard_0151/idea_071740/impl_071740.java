...
@Data
public class Idea71740Config {
    private String name = "idea_071740";
 ...
 */
@Slf4j
public class Idea71740Service {
    private static final int IDEA_ID = 71740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71740Service() {
        this(new Idea71740Config());
    }

    public Idea71740Service(Idea71740Config config) {
        this.config = config != null ? config : new Idea71740Config();
