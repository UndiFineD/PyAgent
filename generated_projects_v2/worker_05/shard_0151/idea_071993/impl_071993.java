...
@Data
public class Idea71993Config {
    private String name = "idea_071993";
 ...
 */
@Slf4j
public class Idea71993Service {
    private static final int IDEA_ID = 71993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71993Service() {
        this(new Idea71993Config());
    }

    public Idea71993Service(Idea71993Config config) {
        this.config = config != null ? config : new Idea71993Config();
