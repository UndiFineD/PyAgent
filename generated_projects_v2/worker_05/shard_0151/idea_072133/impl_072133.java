...
@Data
public class Idea72133Config {
    private String name = "idea_072133";
 ...
 */
@Slf4j
public class Idea72133Service {
    private static final int IDEA_ID = 72133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72133Service() {
        this(new Idea72133Config());
    }

    public Idea72133Service(Idea72133Config config) {
        this.config = config != null ? config : new Idea72133Config();
