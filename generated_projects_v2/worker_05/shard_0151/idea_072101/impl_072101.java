...
@Data
public class Idea72101Config {
    private String name = "idea_072101";
 ...
 */
@Slf4j
public class Idea72101Service {
    private static final int IDEA_ID = 72101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72101Service() {
        this(new Idea72101Config());
    }

    public Idea72101Service(Idea72101Config config) {
        this.config = config != null ? config : new Idea72101Config();
