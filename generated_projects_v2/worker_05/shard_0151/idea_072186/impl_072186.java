...
@Data
public class Idea72186Config {
    private String name = "idea_072186";
 ...
 */
@Slf4j
public class Idea72186Service {
    private static final int IDEA_ID = 72186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72186Service() {
        this(new Idea72186Config());
    }

    public Idea72186Service(Idea72186Config config) {
        this.config = config != null ? config : new Idea72186Config();
