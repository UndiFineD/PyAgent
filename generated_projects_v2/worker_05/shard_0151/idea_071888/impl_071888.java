...
@Data
public class Idea71888Config {
    private String name = "idea_071888";
 ...
 */
@Slf4j
public class Idea71888Service {
    private static final int IDEA_ID = 71888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71888Service() {
        this(new Idea71888Config());
    }

    public Idea71888Service(Idea71888Config config) {
        this.config = config != null ? config : new Idea71888Config();
