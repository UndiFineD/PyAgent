...
@Data
public class Idea71953Config {
    private String name = "idea_071953";
 ...
 */
@Slf4j
public class Idea71953Service {
    private static final int IDEA_ID = 71953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71953Service() {
        this(new Idea71953Config());
    }

    public Idea71953Service(Idea71953Config config) {
        this.config = config != null ? config : new Idea71953Config();
