...
@Data
public class Idea71739Config {
    private String name = "idea_071739";
 ...
 */
@Slf4j
public class Idea71739Service {
    private static final int IDEA_ID = 71739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71739Service() {
        this(new Idea71739Config());
    }

    public Idea71739Service(Idea71739Config config) {
        this.config = config != null ? config : new Idea71739Config();
