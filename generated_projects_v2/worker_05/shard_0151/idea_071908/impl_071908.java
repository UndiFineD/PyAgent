...
@Data
public class Idea71908Config {
    private String name = "idea_071908";
 ...
 */
@Slf4j
public class Idea71908Service {
    private static final int IDEA_ID = 71908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71908Service() {
        this(new Idea71908Config());
    }

    public Idea71908Service(Idea71908Config config) {
        this.config = config != null ? config : new Idea71908Config();
