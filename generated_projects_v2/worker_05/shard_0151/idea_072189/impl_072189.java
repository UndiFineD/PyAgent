...
@Data
public class Idea72189Config {
    private String name = "idea_072189";
 ...
 */
@Slf4j
public class Idea72189Service {
    private static final int IDEA_ID = 72189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72189Service() {
        this(new Idea72189Config());
    }

    public Idea72189Service(Idea72189Config config) {
        this.config = config != null ? config : new Idea72189Config();
