...
@Data
public class Idea71837Config {
    private String name = "idea_071837";
 ...
 */
@Slf4j
public class Idea71837Service {
    private static final int IDEA_ID = 71837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71837Service() {
        this(new Idea71837Config());
    }

    public Idea71837Service(Idea71837Config config) {
        this.config = config != null ? config : new Idea71837Config();
