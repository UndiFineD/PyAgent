...
@Data
public class Idea72015Config {
    private String name = "idea_072015";
 ...
 */
@Slf4j
public class Idea72015Service {
    private static final int IDEA_ID = 72015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72015Service() {
        this(new Idea72015Config());
    }

    public Idea72015Service(Idea72015Config config) {
        this.config = config != null ? config : new Idea72015Config();
