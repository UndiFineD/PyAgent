...
@Data
public class Idea72194Config {
    private String name = "idea_072194";
 ...
 */
@Slf4j
public class Idea72194Service {
    private static final int IDEA_ID = 72194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72194Service() {
        this(new Idea72194Config());
    }

    public Idea72194Service(Idea72194Config config) {
        this.config = config != null ? config : new Idea72194Config();
