...
@Data
public class Idea72018Config {
    private String name = "idea_072018";
 ...
 */
@Slf4j
public class Idea72018Service {
    private static final int IDEA_ID = 72018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72018Service() {
        this(new Idea72018Config());
    }

    public Idea72018Service(Idea72018Config config) {
        this.config = config != null ? config : new Idea72018Config();
