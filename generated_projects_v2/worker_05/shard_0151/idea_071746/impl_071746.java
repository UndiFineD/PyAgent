...
@Data
public class Idea71746Config {
    private String name = "idea_071746";
 ...
 */
@Slf4j
public class Idea71746Service {
    private static final int IDEA_ID = 71746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71746Service() {
        this(new Idea71746Config());
    }

    public Idea71746Service(Idea71746Config config) {
        this.config = config != null ? config : new Idea71746Config();
