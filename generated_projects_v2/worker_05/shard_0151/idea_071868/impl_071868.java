...
@Data
public class Idea71868Config {
    private String name = "idea_071868";
 ...
 */
@Slf4j
public class Idea71868Service {
    private static final int IDEA_ID = 71868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71868Service() {
        this(new Idea71868Config());
    }

    public Idea71868Service(Idea71868Config config) {
        this.config = config != null ? config : new Idea71868Config();
