...
@Data
public class Idea71912Config {
    private String name = "idea_071912";
 ...
 */
@Slf4j
public class Idea71912Service {
    private static final int IDEA_ID = 71912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71912Service() {
        this(new Idea71912Config());
    }

    public Idea71912Service(Idea71912Config config) {
        this.config = config != null ? config : new Idea71912Config();
