...
@Data
public class Idea72116Config {
    private String name = "idea_072116";
 ...
 */
@Slf4j
public class Idea72116Service {
    private static final int IDEA_ID = 72116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72116Service() {
        this(new Idea72116Config());
    }

    public Idea72116Service(Idea72116Config config) {
        this.config = config != null ? config : new Idea72116Config();
