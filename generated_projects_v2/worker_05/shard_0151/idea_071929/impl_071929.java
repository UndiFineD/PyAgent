...
@Data
public class Idea71929Config {
    private String name = "idea_071929";
 ...
 */
@Slf4j
public class Idea71929Service {
    private static final int IDEA_ID = 71929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71929Service() {
        this(new Idea71929Config());
    }

    public Idea71929Service(Idea71929Config config) {
        this.config = config != null ? config : new Idea71929Config();
