...
@Data
public class Idea72115Config {
    private String name = "idea_072115";
 ...
 */
@Slf4j
public class Idea72115Service {
    private static final int IDEA_ID = 72115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72115Service() {
        this(new Idea72115Config());
    }

    public Idea72115Service(Idea72115Config config) {
        this.config = config != null ? config : new Idea72115Config();
