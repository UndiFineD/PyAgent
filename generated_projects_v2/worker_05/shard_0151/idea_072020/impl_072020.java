...
@Data
public class Idea72020Config {
    private String name = "idea_072020";
 ...
 */
@Slf4j
public class Idea72020Service {
    private static final int IDEA_ID = 72020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72020Service() {
        this(new Idea72020Config());
    }

    public Idea72020Service(Idea72020Config config) {
        this.config = config != null ? config : new Idea72020Config();
