...
@Data
public class Idea71894Config {
    private String name = "idea_071894";
 ...
 */
@Slf4j
public class Idea71894Service {
    private static final int IDEA_ID = 71894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71894Service() {
        this(new Idea71894Config());
    }

    public Idea71894Service(Idea71894Config config) {
        this.config = config != null ? config : new Idea71894Config();
