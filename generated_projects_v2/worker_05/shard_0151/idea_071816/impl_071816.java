...
@Data
public class Idea71816Config {
    private String name = "idea_071816";
 ...
 */
@Slf4j
public class Idea71816Service {
    private static final int IDEA_ID = 71816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71816Service() {
        this(new Idea71816Config());
    }

    public Idea71816Service(Idea71816Config config) {
        this.config = config != null ? config : new Idea71816Config();
