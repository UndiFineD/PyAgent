...
@Data
public class Idea71784Config {
    private String name = "idea_071784";
 ...
 */
@Slf4j
public class Idea71784Service {
    private static final int IDEA_ID = 71784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71784Service() {
        this(new Idea71784Config());
    }

    public Idea71784Service(Idea71784Config config) {
        this.config = config != null ? config : new Idea71784Config();
