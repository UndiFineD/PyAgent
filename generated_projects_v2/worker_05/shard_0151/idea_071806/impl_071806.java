...
@Data
public class Idea71806Config {
    private String name = "idea_071806";
 ...
 */
@Slf4j
public class Idea71806Service {
    private static final int IDEA_ID = 71806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71806Service() {
        this(new Idea71806Config());
    }

    public Idea71806Service(Idea71806Config config) {
        this.config = config != null ? config : new Idea71806Config();
