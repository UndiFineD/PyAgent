...
@Data
public class Idea72141Config {
    private String name = "idea_072141";
 ...
 */
@Slf4j
public class Idea72141Service {
    private static final int IDEA_ID = 72141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72141Service() {
        this(new Idea72141Config());
    }

    public Idea72141Service(Idea72141Config config) {
        this.config = config != null ? config : new Idea72141Config();
