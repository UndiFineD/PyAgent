...
@Data
public class Idea72135Config {
    private String name = "idea_072135";
 ...
 */
@Slf4j
public class Idea72135Service {
    private static final int IDEA_ID = 72135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72135Service() {
        this(new Idea72135Config());
    }

    public Idea72135Service(Idea72135Config config) {
        this.config = config != null ? config : new Idea72135Config();
