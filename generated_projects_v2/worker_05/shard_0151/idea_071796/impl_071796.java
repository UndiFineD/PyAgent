...
@Data
public class Idea71796Config {
    private String name = "idea_071796";
 ...
 */
@Slf4j
public class Idea71796Service {
    private static final int IDEA_ID = 71796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71796Service() {
        this(new Idea71796Config());
    }

    public Idea71796Service(Idea71796Config config) {
        this.config = config != null ? config : new Idea71796Config();
