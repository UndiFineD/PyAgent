...
@Data
public class Idea72008Config {
    private String name = "idea_072008";
 ...
 */
@Slf4j
public class Idea72008Service {
    private static final int IDEA_ID = 72008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72008Service() {
        this(new Idea72008Config());
    }

    public Idea72008Service(Idea72008Config config) {
        this.config = config != null ? config : new Idea72008Config();
