...
@Data
public class Idea72090Config {
    private String name = "idea_072090";
 ...
 */
@Slf4j
public class Idea72090Service {
    private static final int IDEA_ID = 72090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72090Service() {
        this(new Idea72090Config());
    }

    public Idea72090Service(Idea72090Config config) {
        this.config = config != null ? config : new Idea72090Config();
