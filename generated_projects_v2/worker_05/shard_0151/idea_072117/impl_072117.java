...
@Data
public class Idea72117Config {
    private String name = "idea_072117";
 ...
 */
@Slf4j
public class Idea72117Service {
    private static final int IDEA_ID = 72117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72117Service() {
        this(new Idea72117Config());
    }

    public Idea72117Service(Idea72117Config config) {
        this.config = config != null ? config : new Idea72117Config();
