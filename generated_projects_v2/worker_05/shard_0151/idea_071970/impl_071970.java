...
@Data
public class Idea71970Config {
    private String name = "idea_071970";
 ...
 */
@Slf4j
public class Idea71970Service {
    private static final int IDEA_ID = 71970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71970Service() {
        this(new Idea71970Config());
    }

    public Idea71970Service(Idea71970Config config) {
        this.config = config != null ? config : new Idea71970Config();
