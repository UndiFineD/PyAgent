...
@Data
public class Idea71939Config {
    private String name = "idea_071939";
 ...
 */
@Slf4j
public class Idea71939Service {
    private static final int IDEA_ID = 71939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71939Service() {
        this(new Idea71939Config());
    }

    public Idea71939Service(Idea71939Config config) {
        this.config = config != null ? config : new Idea71939Config();
