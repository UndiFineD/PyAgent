...
@Data
public class Idea71926Config {
    private String name = "idea_071926";
 ...
 */
@Slf4j
public class Idea71926Service {
    private static final int IDEA_ID = 71926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71926Service() {
        this(new Idea71926Config());
    }

    public Idea71926Service(Idea71926Config config) {
        this.config = config != null ? config : new Idea71926Config();
