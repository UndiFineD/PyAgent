...
@Data
public class Idea71860Config {
    private String name = "idea_071860";
 ...
 */
@Slf4j
public class Idea71860Service {
    private static final int IDEA_ID = 71860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71860Service() {
        this(new Idea71860Config());
    }

    public Idea71860Service(Idea71860Config config) {
        this.config = config != null ? config : new Idea71860Config();
