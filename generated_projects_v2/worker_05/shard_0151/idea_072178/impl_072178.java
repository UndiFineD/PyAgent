...
@Data
public class Idea72178Config {
    private String name = "idea_072178";
 ...
 */
@Slf4j
public class Idea72178Service {
    private static final int IDEA_ID = 72178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72178Service() {
        this(new Idea72178Config());
    }

    public Idea72178Service(Idea72178Config config) {
        this.config = config != null ? config : new Idea72178Config();
