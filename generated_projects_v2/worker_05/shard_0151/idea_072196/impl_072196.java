...
@Data
public class Idea72196Config {
    private String name = "idea_072196";
 ...
 */
@Slf4j
public class Idea72196Service {
    private static final int IDEA_ID = 72196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72196Service() {
        this(new Idea72196Config());
    }

    public Idea72196Service(Idea72196Config config) {
        this.config = config != null ? config : new Idea72196Config();
