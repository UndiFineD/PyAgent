...
@Data
public class Idea71881Config {
    private String name = "idea_071881";
 ...
 */
@Slf4j
public class Idea71881Service {
    private static final int IDEA_ID = 71881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71881Service() {
        this(new Idea71881Config());
    }

    public Idea71881Service(Idea71881Config config) {
        this.config = config != null ? config : new Idea71881Config();
