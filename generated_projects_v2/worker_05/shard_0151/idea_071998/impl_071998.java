...
@Data
public class Idea71998Config {
    private String name = "idea_071998";
 ...
 */
@Slf4j
public class Idea71998Service {
    private static final int IDEA_ID = 71998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71998Service() {
        this(new Idea71998Config());
    }

    public Idea71998Service(Idea71998Config config) {
        this.config = config != null ? config : new Idea71998Config();
