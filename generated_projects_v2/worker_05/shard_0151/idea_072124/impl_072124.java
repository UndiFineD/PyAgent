...
@Data
public class Idea72124Config {
    private String name = "idea_072124";
 ...
 */
@Slf4j
public class Idea72124Service {
    private static final int IDEA_ID = 72124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72124Service() {
        this(new Idea72124Config());
    }

    public Idea72124Service(Idea72124Config config) {
        this.config = config != null ? config : new Idea72124Config();
