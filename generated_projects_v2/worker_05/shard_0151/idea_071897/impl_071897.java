...
@Data
public class Idea71897Config {
    private String name = "idea_071897";
 ...
 */
@Slf4j
public class Idea71897Service {
    private static final int IDEA_ID = 71897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71897Service() {
        this(new Idea71897Config());
    }

    public Idea71897Service(Idea71897Config config) {
        this.config = config != null ? config : new Idea71897Config();
