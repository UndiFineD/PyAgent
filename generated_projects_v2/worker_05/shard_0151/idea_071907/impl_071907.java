...
@Data
public class Idea71907Config {
    private String name = "idea_071907";
 ...
 */
@Slf4j
public class Idea71907Service {
    private static final int IDEA_ID = 71907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71907Service() {
        this(new Idea71907Config());
    }

    public Idea71907Service(Idea71907Config config) {
        this.config = config != null ? config : new Idea71907Config();
