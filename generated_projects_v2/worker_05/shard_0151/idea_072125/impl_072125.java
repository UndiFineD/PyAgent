...
@Data
public class Idea72125Config {
    private String name = "idea_072125";
 ...
 */
@Slf4j
public class Idea72125Service {
    private static final int IDEA_ID = 72125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72125Service() {
        this(new Idea72125Config());
    }

    public Idea72125Service(Idea72125Config config) {
        this.config = config != null ? config : new Idea72125Config();
