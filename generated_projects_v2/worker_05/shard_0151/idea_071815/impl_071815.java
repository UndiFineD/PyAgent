...
@Data
public class Idea71815Config {
    private String name = "idea_071815";
 ...
 */
@Slf4j
public class Idea71815Service {
    private static final int IDEA_ID = 71815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71815Service() {
        this(new Idea71815Config());
    }

    public Idea71815Service(Idea71815Config config) {
        this.config = config != null ? config : new Idea71815Config();
