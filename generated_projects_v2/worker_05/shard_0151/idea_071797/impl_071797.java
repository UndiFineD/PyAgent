...
@Data
public class Idea71797Config {
    private String name = "idea_071797";
 ...
 */
@Slf4j
public class Idea71797Service {
    private static final int IDEA_ID = 71797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71797Service() {
        this(new Idea71797Config());
    }

    public Idea71797Service(Idea71797Config config) {
        this.config = config != null ? config : new Idea71797Config();
