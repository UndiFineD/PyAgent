...
@Data
public class Idea72099Config {
    private String name = "idea_072099";
 ...
 */
@Slf4j
public class Idea72099Service {
    private static final int IDEA_ID = 72099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72099Service() {
        this(new Idea72099Config());
    }

    public Idea72099Service(Idea72099Config config) {
        this.config = config != null ? config : new Idea72099Config();
