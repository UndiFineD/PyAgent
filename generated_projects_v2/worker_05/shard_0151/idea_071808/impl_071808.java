...
@Data
public class Idea71808Config {
    private String name = "idea_071808";
 ...
 */
@Slf4j
public class Idea71808Service {
    private static final int IDEA_ID = 71808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71808Service() {
        this(new Idea71808Config());
    }

    public Idea71808Service(Idea71808Config config) {
        this.config = config != null ? config : new Idea71808Config();
