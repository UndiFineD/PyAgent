...
@Data
public class Idea71745Config {
    private String name = "idea_071745";
 ...
 */
@Slf4j
public class Idea71745Service {
    private static final int IDEA_ID = 71745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71745Service() {
        this(new Idea71745Config());
    }

    public Idea71745Service(Idea71745Config config) {
        this.config = config != null ? config : new Idea71745Config();
