...
@Data
public class Idea72128Config {
    private String name = "idea_072128";
 ...
 */
@Slf4j
public class Idea72128Service {
    private static final int IDEA_ID = 72128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72128Service() {
        this(new Idea72128Config());
    }

    public Idea72128Service(Idea72128Config config) {
        this.config = config != null ? config : new Idea72128Config();
