...
@Data
public class Idea71991Config {
    private String name = "idea_071991";
 ...
 */
@Slf4j
public class Idea71991Service {
    private static final int IDEA_ID = 71991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71991Service() {
        this(new Idea71991Config());
    }

    public Idea71991Service(Idea71991Config config) {
        this.config = config != null ? config : new Idea71991Config();
