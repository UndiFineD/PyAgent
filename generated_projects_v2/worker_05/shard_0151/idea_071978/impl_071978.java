...
@Data
public class Idea71978Config {
    private String name = "idea_071978";
 ...
 */
@Slf4j
public class Idea71978Service {
    private static final int IDEA_ID = 71978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71978Service() {
        this(new Idea71978Config());
    }

    public Idea71978Service(Idea71978Config config) {
        this.config = config != null ? config : new Idea71978Config();
