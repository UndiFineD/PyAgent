...
@Data
public class Idea71946Config {
    private String name = "idea_071946";
 ...
 */
@Slf4j
public class Idea71946Service {
    private static final int IDEA_ID = 71946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71946Service() {
        this(new Idea71946Config());
    }

    public Idea71946Service(Idea71946Config config) {
        this.config = config != null ? config : new Idea71946Config();
