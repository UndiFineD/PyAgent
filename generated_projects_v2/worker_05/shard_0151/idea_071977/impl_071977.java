...
@Data
public class Idea71977Config {
    private String name = "idea_071977";
 ...
 */
@Slf4j
public class Idea71977Service {
    private static final int IDEA_ID = 71977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71977Service() {
        this(new Idea71977Config());
    }

    public Idea71977Service(Idea71977Config config) {
        this.config = config != null ? config : new Idea71977Config();
