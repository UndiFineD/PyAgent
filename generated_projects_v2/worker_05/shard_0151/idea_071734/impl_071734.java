...
@Data
public class Idea71734Config {
    private String name = "idea_071734";
 ...
 */
@Slf4j
public class Idea71734Service {
    private static final int IDEA_ID = 71734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71734Service() {
        this(new Idea71734Config());
    }

    public Idea71734Service(Idea71734Config config) {
        this.config = config != null ? config : new Idea71734Config();
