...
@Data
public class Idea71726Config {
    private String name = "idea_071726";
 ...
 */
@Slf4j
public class Idea71726Service {
    private static final int IDEA_ID = 71726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71726Service() {
        this(new Idea71726Config());
    }

    public Idea71726Service(Idea71726Config config) {
        this.config = config != null ? config : new Idea71726Config();
