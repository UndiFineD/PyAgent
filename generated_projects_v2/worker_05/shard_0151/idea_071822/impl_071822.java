...
@Data
public class Idea71822Config {
    private String name = "idea_071822";
 ...
 */
@Slf4j
public class Idea71822Service {
    private static final int IDEA_ID = 71822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71822Service() {
        this(new Idea71822Config());
    }

    public Idea71822Service(Idea71822Config config) {
        this.config = config != null ? config : new Idea71822Config();
