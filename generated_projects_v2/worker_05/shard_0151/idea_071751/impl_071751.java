...
@Data
public class Idea71751Config {
    private String name = "idea_071751";
 ...
 */
@Slf4j
public class Idea71751Service {
    private static final int IDEA_ID = 71751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71751Service() {
        this(new Idea71751Config());
    }

    public Idea71751Service(Idea71751Config config) {
        this.config = config != null ? config : new Idea71751Config();
