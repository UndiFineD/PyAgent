...
@Data
public class Idea71845Config {
    private String name = "idea_071845";
 ...
 */
@Slf4j
public class Idea71845Service {
    private static final int IDEA_ID = 71845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71845Service() {
        this(new Idea71845Config());
    }

    public Idea71845Service(Idea71845Config config) {
        this.config = config != null ? config : new Idea71845Config();
