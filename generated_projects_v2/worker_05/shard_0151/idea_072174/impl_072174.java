...
@Data
public class Idea72174Config {
    private String name = "idea_072174";
 ...
 */
@Slf4j
public class Idea72174Service {
    private static final int IDEA_ID = 72174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72174Service() {
        this(new Idea72174Config());
    }

    public Idea72174Service(Idea72174Config config) {
        this.config = config != null ? config : new Idea72174Config();
