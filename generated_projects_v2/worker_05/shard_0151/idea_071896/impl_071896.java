...
@Data
public class Idea71896Config {
    private String name = "idea_071896";
 ...
 */
@Slf4j
public class Idea71896Service {
    private static final int IDEA_ID = 71896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71896Service() {
        this(new Idea71896Config());
    }

    public Idea71896Service(Idea71896Config config) {
        this.config = config != null ? config : new Idea71896Config();
