...
@Data
public class Idea72161Config {
    private String name = "idea_072161";
 ...
 */
@Slf4j
public class Idea72161Service {
    private static final int IDEA_ID = 72161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72161Service() {
        this(new Idea72161Config());
    }

    public Idea72161Service(Idea72161Config config) {
        this.config = config != null ? config : new Idea72161Config();
