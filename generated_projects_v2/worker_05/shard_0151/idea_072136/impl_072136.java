...
@Data
public class Idea72136Config {
    private String name = "idea_072136";
 ...
 */
@Slf4j
public class Idea72136Service {
    private static final int IDEA_ID = 72136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72136Service() {
        this(new Idea72136Config());
    }

    public Idea72136Service(Idea72136Config config) {
        this.config = config != null ? config : new Idea72136Config();
