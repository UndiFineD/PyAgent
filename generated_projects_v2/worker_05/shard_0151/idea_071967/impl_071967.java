...
@Data
public class Idea71967Config {
    private String name = "idea_071967";
 ...
 */
@Slf4j
public class Idea71967Service {
    private static final int IDEA_ID = 71967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71967Service() {
        this(new Idea71967Config());
    }

    public Idea71967Service(Idea71967Config config) {
        this.config = config != null ? config : new Idea71967Config();
