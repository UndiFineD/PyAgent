...
@Data
public class Idea72023Config {
    private String name = "idea_072023";
 ...
 */
@Slf4j
public class Idea72023Service {
    private static final int IDEA_ID = 72023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72023Service() {
        this(new Idea72023Config());
    }

    public Idea72023Service(Idea72023Config config) {
        this.config = config != null ? config : new Idea72023Config();
