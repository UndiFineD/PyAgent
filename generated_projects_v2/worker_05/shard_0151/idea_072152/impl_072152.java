...
@Data
public class Idea72152Config {
    private String name = "idea_072152";
 ...
 */
@Slf4j
public class Idea72152Service {
    private static final int IDEA_ID = 72152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72152Service() {
        this(new Idea72152Config());
    }

    public Idea72152Service(Idea72152Config config) {
        this.config = config != null ? config : new Idea72152Config();
