...
@Data
public class Idea71972Config {
    private String name = "idea_071972";
 ...
 */
@Slf4j
public class Idea71972Service {
    private static final int IDEA_ID = 71972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71972Service() {
        this(new Idea71972Config());
    }

    public Idea71972Service(Idea71972Config config) {
        this.config = config != null ? config : new Idea71972Config();
