...
@Data
public class Idea71847Config {
    private String name = "idea_071847";
 ...
 */
@Slf4j
public class Idea71847Service {
    private static final int IDEA_ID = 71847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71847Service() {
        this(new Idea71847Config());
    }

    public Idea71847Service(Idea71847Config config) {
        this.config = config != null ? config : new Idea71847Config();
