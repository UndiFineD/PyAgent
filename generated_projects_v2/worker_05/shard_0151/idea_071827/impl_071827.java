...
@Data
public class Idea71827Config {
    private String name = "idea_071827";
 ...
 */
@Slf4j
public class Idea71827Service {
    private static final int IDEA_ID = 71827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71827Service() {
        this(new Idea71827Config());
    }

    public Idea71827Service(Idea71827Config config) {
        this.config = config != null ? config : new Idea71827Config();
