...
@Data
public class Idea71880Config {
    private String name = "idea_071880";
 ...
 */
@Slf4j
public class Idea71880Service {
    private static final int IDEA_ID = 71880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71880Service() {
        this(new Idea71880Config());
    }

    public Idea71880Service(Idea71880Config config) {
        this.config = config != null ? config : new Idea71880Config();
