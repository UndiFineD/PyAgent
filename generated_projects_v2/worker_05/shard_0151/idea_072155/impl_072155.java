...
@Data
public class Idea72155Config {
    private String name = "idea_072155";
 ...
 */
@Slf4j
public class Idea72155Service {
    private static final int IDEA_ID = 72155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72155Service() {
        this(new Idea72155Config());
    }

    public Idea72155Service(Idea72155Config config) {
        this.config = config != null ? config : new Idea72155Config();
