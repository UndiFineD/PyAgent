...
@Data
public class Idea71987Config {
    private String name = "idea_071987";
 ...
 */
@Slf4j
public class Idea71987Service {
    private static final int IDEA_ID = 71987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71987Service() {
        this(new Idea71987Config());
    }

    public Idea71987Service(Idea71987Config config) {
        this.config = config != null ? config : new Idea71987Config();
