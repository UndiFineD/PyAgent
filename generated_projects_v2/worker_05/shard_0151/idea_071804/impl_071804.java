...
@Data
public class Idea71804Config {
    private String name = "idea_071804";
 ...
 */
@Slf4j
public class Idea71804Service {
    private static final int IDEA_ID = 71804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71804Service() {
        this(new Idea71804Config());
    }

    public Idea71804Service(Idea71804Config config) {
        this.config = config != null ? config : new Idea71804Config();
