...
@Data
public class Idea72037Config {
    private String name = "idea_072037";
 ...
 */
@Slf4j
public class Idea72037Service {
    private static final int IDEA_ID = 72037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72037Service() {
        this(new Idea72037Config());
    }

    public Idea72037Service(Idea72037Config config) {
        this.config = config != null ? config : new Idea72037Config();
