...
@Data
public class Idea71976Config {
    private String name = "idea_071976";
 ...
 */
@Slf4j
public class Idea71976Service {
    private static final int IDEA_ID = 71976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71976Service() {
        this(new Idea71976Config());
    }

    public Idea71976Service(Idea71976Config config) {
        this.config = config != null ? config : new Idea71976Config();
