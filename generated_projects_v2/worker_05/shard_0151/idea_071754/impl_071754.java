...
@Data
public class Idea71754Config {
    private String name = "idea_071754";
 ...
 */
@Slf4j
public class Idea71754Service {
    private static final int IDEA_ID = 71754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71754Service() {
        this(new Idea71754Config());
    }

    public Idea71754Service(Idea71754Config config) {
        this.config = config != null ? config : new Idea71754Config();
