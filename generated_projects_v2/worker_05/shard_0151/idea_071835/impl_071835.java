...
@Data
public class Idea71835Config {
    private String name = "idea_071835";
 ...
 */
@Slf4j
public class Idea71835Service {
    private static final int IDEA_ID = 71835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71835Service() {
        this(new Idea71835Config());
    }

    public Idea71835Service(Idea71835Config config) {
        this.config = config != null ? config : new Idea71835Config();
