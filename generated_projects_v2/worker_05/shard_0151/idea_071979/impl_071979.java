...
@Data
public class Idea71979Config {
    private String name = "idea_071979";
 ...
 */
@Slf4j
public class Idea71979Service {
    private static final int IDEA_ID = 71979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71979Service() {
        this(new Idea71979Config());
    }

    public Idea71979Service(Idea71979Config config) {
        this.config = config != null ? config : new Idea71979Config();
