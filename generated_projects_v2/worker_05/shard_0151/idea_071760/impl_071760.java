...
@Data
public class Idea71760Config {
    private String name = "idea_071760";
 ...
 */
@Slf4j
public class Idea71760Service {
    private static final int IDEA_ID = 71760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71760Service() {
        this(new Idea71760Config());
    }

    public Idea71760Service(Idea71760Config config) {
        this.config = config != null ? config : new Idea71760Config();
