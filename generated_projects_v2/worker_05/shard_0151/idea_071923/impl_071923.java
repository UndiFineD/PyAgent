...
@Data
public class Idea71923Config {
    private String name = "idea_071923";
 ...
 */
@Slf4j
public class Idea71923Service {
    private static final int IDEA_ID = 71923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71923Service() {
        this(new Idea71923Config());
    }

    public Idea71923Service(Idea71923Config config) {
        this.config = config != null ? config : new Idea71923Config();
