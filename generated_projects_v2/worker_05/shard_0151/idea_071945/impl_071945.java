...
@Data
public class Idea71945Config {
    private String name = "idea_071945";
 ...
 */
@Slf4j
public class Idea71945Service {
    private static final int IDEA_ID = 71945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71945Service() {
        this(new Idea71945Config());
    }

    public Idea71945Service(Idea71945Config config) {
        this.config = config != null ? config : new Idea71945Config();
