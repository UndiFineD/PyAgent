...
@Data
public class Idea72192Config {
    private String name = "idea_072192";
 ...
 */
@Slf4j
public class Idea72192Service {
    private static final int IDEA_ID = 72192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72192Service() {
        this(new Idea72192Config());
    }

    public Idea72192Service(Idea72192Config config) {
        this.config = config != null ? config : new Idea72192Config();
