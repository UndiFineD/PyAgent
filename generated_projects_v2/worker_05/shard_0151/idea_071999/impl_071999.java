...
@Data
public class Idea71999Config {
    private String name = "idea_071999";
 ...
 */
@Slf4j
public class Idea71999Service {
    private static final int IDEA_ID = 71999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71999Service() {
        this(new Idea71999Config());
    }

    public Idea71999Service(Idea71999Config config) {
        this.config = config != null ? config : new Idea71999Config();
