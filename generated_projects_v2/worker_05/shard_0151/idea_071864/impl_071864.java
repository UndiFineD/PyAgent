...
@Data
public class Idea71864Config {
    private String name = "idea_071864";
 ...
 */
@Slf4j
public class Idea71864Service {
    private static final int IDEA_ID = 71864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71864Service() {
        this(new Idea71864Config());
    }

    public Idea71864Service(Idea71864Config config) {
        this.config = config != null ? config : new Idea71864Config();
