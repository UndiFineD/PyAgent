...
@Data
public class Idea71798Config {
    private String name = "idea_071798";
 ...
 */
@Slf4j
public class Idea71798Service {
    private static final int IDEA_ID = 71798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71798Service() {
        this(new Idea71798Config());
    }

    public Idea71798Service(Idea71798Config config) {
        this.config = config != null ? config : new Idea71798Config();
