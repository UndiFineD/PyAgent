...
@Data
public class Idea71871Config {
    private String name = "idea_071871";
 ...
 */
@Slf4j
public class Idea71871Service {
    private static final int IDEA_ID = 71871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71871Service() {
        this(new Idea71871Config());
    }

    public Idea71871Service(Idea71871Config config) {
        this.config = config != null ? config : new Idea71871Config();
