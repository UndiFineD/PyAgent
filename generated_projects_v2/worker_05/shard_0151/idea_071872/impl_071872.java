...
@Data
public class Idea71872Config {
    private String name = "idea_071872";
 ...
 */
@Slf4j
public class Idea71872Service {
    private static final int IDEA_ID = 71872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71872Service() {
        this(new Idea71872Config());
    }

    public Idea71872Service(Idea71872Config config) {
        this.config = config != null ? config : new Idea71872Config();
