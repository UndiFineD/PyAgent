...
@Data
public class Idea72188Config {
    private String name = "idea_072188";
 ...
 */
@Slf4j
public class Idea72188Service {
    private static final int IDEA_ID = 72188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72188Service() {
        this(new Idea72188Config());
    }

    public Idea72188Service(Idea72188Config config) {
        this.config = config != null ? config : new Idea72188Config();
