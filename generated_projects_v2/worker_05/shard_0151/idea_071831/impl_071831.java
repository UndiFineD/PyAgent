...
@Data
public class Idea71831Config {
    private String name = "idea_071831";
 ...
 */
@Slf4j
public class Idea71831Service {
    private static final int IDEA_ID = 71831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71831Service() {
        this(new Idea71831Config());
    }

    public Idea71831Service(Idea71831Config config) {
        this.config = config != null ? config : new Idea71831Config();
