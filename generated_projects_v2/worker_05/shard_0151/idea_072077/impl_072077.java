...
@Data
public class Idea72077Config {
    private String name = "idea_072077";
 ...
 */
@Slf4j
public class Idea72077Service {
    private static final int IDEA_ID = 72077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72077Service() {
        this(new Idea72077Config());
    }

    public Idea72077Service(Idea72077Config config) {
        this.config = config != null ? config : new Idea72077Config();
