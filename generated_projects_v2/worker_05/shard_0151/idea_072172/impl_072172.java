...
@Data
public class Idea72172Config {
    private String name = "idea_072172";
 ...
 */
@Slf4j
public class Idea72172Service {
    private static final int IDEA_ID = 72172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72172Service() {
        this(new Idea72172Config());
    }

    public Idea72172Service(Idea72172Config config) {
        this.config = config != null ? config : new Idea72172Config();
