...
@Data
public class Idea71794Config {
    private String name = "idea_071794";
 ...
 */
@Slf4j
public class Idea71794Service {
    private static final int IDEA_ID = 71794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71794Service() {
        this(new Idea71794Config());
    }

    public Idea71794Service(Idea71794Config config) {
        this.config = config != null ? config : new Idea71794Config();
