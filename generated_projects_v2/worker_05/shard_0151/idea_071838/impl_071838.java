...
@Data
public class Idea71838Config {
    private String name = "idea_071838";
 ...
 */
@Slf4j
public class Idea71838Service {
    private static final int IDEA_ID = 71838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71838Service() {
        this(new Idea71838Config());
    }

    public Idea71838Service(Idea71838Config config) {
        this.config = config != null ? config : new Idea71838Config();
