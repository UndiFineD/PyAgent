...
@Data
public class Idea71776Config {
    private String name = "idea_071776";
 ...
 */
@Slf4j
public class Idea71776Service {
    private static final int IDEA_ID = 71776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71776Service() {
        this(new Idea71776Config());
    }

    public Idea71776Service(Idea71776Config config) {
        this.config = config != null ? config : new Idea71776Config();
