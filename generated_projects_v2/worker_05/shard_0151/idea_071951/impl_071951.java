...
@Data
public class Idea71951Config {
    private String name = "idea_071951";
 ...
 */
@Slf4j
public class Idea71951Service {
    private static final int IDEA_ID = 71951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71951Service() {
        this(new Idea71951Config());
    }

    public Idea71951Service(Idea71951Config config) {
        this.config = config != null ? config : new Idea71951Config();
