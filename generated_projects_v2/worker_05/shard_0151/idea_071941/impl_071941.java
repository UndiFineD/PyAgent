...
@Data
public class Idea71941Config {
    private String name = "idea_071941";
 ...
 */
@Slf4j
public class Idea71941Service {
    private static final int IDEA_ID = 71941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71941Service() {
        this(new Idea71941Config());
    }

    public Idea71941Service(Idea71941Config config) {
        this.config = config != null ? config : new Idea71941Config();
