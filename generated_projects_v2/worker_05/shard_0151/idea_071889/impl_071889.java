...
@Data
public class Idea71889Config {
    private String name = "idea_071889";
 ...
 */
@Slf4j
public class Idea71889Service {
    private static final int IDEA_ID = 71889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71889Service() {
        this(new Idea71889Config());
    }

    public Idea71889Service(Idea71889Config config) {
        this.config = config != null ? config : new Idea71889Config();
