...
@Data
public class Idea72195Config {
    private String name = "idea_072195";
 ...
 */
@Slf4j
public class Idea72195Service {
    private static final int IDEA_ID = 72195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72195Service() {
        this(new Idea72195Config());
    }

    public Idea72195Service(Idea72195Config config) {
        this.config = config != null ? config : new Idea72195Config();
