...
@Data
public class Idea71779Config {
    private String name = "idea_071779";
 ...
 */
@Slf4j
public class Idea71779Service {
    private static final int IDEA_ID = 71779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71779Service() {
        this(new Idea71779Config());
    }

    public Idea71779Service(Idea71779Config config) {
        this.config = config != null ? config : new Idea71779Config();
