...
@Data
public class Idea72120Config {
    private String name = "idea_072120";
 ...
 */
@Slf4j
public class Idea72120Service {
    private static final int IDEA_ID = 72120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72120Service() {
        this(new Idea72120Config());
    }

    public Idea72120Service(Idea72120Config config) {
        this.config = config != null ? config : new Idea72120Config();
