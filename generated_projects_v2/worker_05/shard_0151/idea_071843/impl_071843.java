...
@Data
public class Idea71843Config {
    private String name = "idea_071843";
 ...
 */
@Slf4j
public class Idea71843Service {
    private static final int IDEA_ID = 71843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71843Service() {
        this(new Idea71843Config());
    }

    public Idea71843Service(Idea71843Config config) {
        this.config = config != null ? config : new Idea71843Config();
