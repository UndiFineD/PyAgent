...
@Data
public class Idea72087Config {
    private String name = "idea_072087";
 ...
 */
@Slf4j
public class Idea72087Service {
    private static final int IDEA_ID = 72087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72087Service() {
        this(new Idea72087Config());
    }

    public Idea72087Service(Idea72087Config config) {
        this.config = config != null ? config : new Idea72087Config();
