...
@Data
public class Idea72084Config {
    private String name = "idea_072084";
 ...
 */
@Slf4j
public class Idea72084Service {
    private static final int IDEA_ID = 72084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72084Service() {
        this(new Idea72084Config());
    }

    public Idea72084Service(Idea72084Config config) {
        this.config = config != null ? config : new Idea72084Config();
