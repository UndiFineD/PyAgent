...
@Data
public class Idea71996Config {
    private String name = "idea_071996";
 ...
 */
@Slf4j
public class Idea71996Service {
    private static final int IDEA_ID = 71996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71996Service() {
        this(new Idea71996Config());
    }

    public Idea71996Service(Idea71996Config config) {
        this.config = config != null ? config : new Idea71996Config();
