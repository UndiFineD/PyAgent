...
@Data
public class Idea71867Config {
    private String name = "idea_071867";
 ...
 */
@Slf4j
public class Idea71867Service {
    private static final int IDEA_ID = 71867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71867Service() {
        this(new Idea71867Config());
    }

    public Idea71867Service(Idea71867Config config) {
        this.config = config != null ? config : new Idea71867Config();
