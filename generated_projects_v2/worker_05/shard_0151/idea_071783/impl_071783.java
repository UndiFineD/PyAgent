...
@Data
public class Idea71783Config {
    private String name = "idea_071783";
 ...
 */
@Slf4j
public class Idea71783Service {
    private static final int IDEA_ID = 71783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71783Service() {
        this(new Idea71783Config());
    }

    public Idea71783Service(Idea71783Config config) {
        this.config = config != null ? config : new Idea71783Config();
