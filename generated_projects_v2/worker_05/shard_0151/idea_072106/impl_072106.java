...
@Data
public class Idea72106Config {
    private String name = "idea_072106";
 ...
 */
@Slf4j
public class Idea72106Service {
    private static final int IDEA_ID = 72106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72106Service() {
        this(new Idea72106Config());
    }

    public Idea72106Service(Idea72106Config config) {
        this.config = config != null ? config : new Idea72106Config();
