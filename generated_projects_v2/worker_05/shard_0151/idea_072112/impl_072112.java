...
@Data
public class Idea72112Config {
    private String name = "idea_072112";
 ...
 */
@Slf4j
public class Idea72112Service {
    private static final int IDEA_ID = 72112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72112Service() {
        this(new Idea72112Config());
    }

    public Idea72112Service(Idea72112Config config) {
        this.config = config != null ? config : new Idea72112Config();
