...
@Data
public class Idea71764Config {
    private String name = "idea_071764";
 ...
 */
@Slf4j
public class Idea71764Service {
    private static final int IDEA_ID = 71764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71764Service() {
        this(new Idea71764Config());
    }

    public Idea71764Service(Idea71764Config config) {
        this.config = config != null ? config : new Idea71764Config();
