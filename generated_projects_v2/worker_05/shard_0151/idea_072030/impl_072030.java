...
@Data
public class Idea72030Config {
    private String name = "idea_072030";
 ...
 */
@Slf4j
public class Idea72030Service {
    private static final int IDEA_ID = 72030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72030Service() {
        this(new Idea72030Config());
    }

    public Idea72030Service(Idea72030Config config) {
        this.config = config != null ? config : new Idea72030Config();
