...
@Data
public class Idea72080Config {
    private String name = "idea_072080";
 ...
 */
@Slf4j
public class Idea72080Service {
    private static final int IDEA_ID = 72080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72080Service() {
        this(new Idea72080Config());
    }

    public Idea72080Service(Idea72080Config config) {
        this.config = config != null ? config : new Idea72080Config();
