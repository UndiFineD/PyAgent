...
@Data
public class Idea71731Config {
    private String name = "idea_071731";
 ...
 */
@Slf4j
public class Idea71731Service {
    private static final int IDEA_ID = 71731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71731Service() {
        this(new Idea71731Config());
    }

    public Idea71731Service(Idea71731Config config) {
        this.config = config != null ? config : new Idea71731Config();
