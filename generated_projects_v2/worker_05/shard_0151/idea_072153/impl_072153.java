...
@Data
public class Idea72153Config {
    private String name = "idea_072153";
 ...
 */
@Slf4j
public class Idea72153Service {
    private static final int IDEA_ID = 72153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72153Service() {
        this(new Idea72153Config());
    }

    public Idea72153Service(Idea72153Config config) {
        this.config = config != null ? config : new Idea72153Config();
