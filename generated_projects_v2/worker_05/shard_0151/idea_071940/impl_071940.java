...
@Data
public class Idea71940Config {
    private String name = "idea_071940";
 ...
 */
@Slf4j
public class Idea71940Service {
    private static final int IDEA_ID = 71940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71940Service() {
        this(new Idea71940Config());
    }

    public Idea71940Service(Idea71940Config config) {
        this.config = config != null ? config : new Idea71940Config();
