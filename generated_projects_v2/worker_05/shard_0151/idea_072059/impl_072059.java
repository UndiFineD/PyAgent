...
@Data
public class Idea72059Config {
    private String name = "idea_072059";
 ...
 */
@Slf4j
public class Idea72059Service {
    private static final int IDEA_ID = 72059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72059Service() {
        this(new Idea72059Config());
    }

    public Idea72059Service(Idea72059Config config) {
        this.config = config != null ? config : new Idea72059Config();
