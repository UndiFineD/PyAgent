...
@Data
public class Idea71812Config {
    private String name = "idea_071812";
 ...
 */
@Slf4j
public class Idea71812Service {
    private static final int IDEA_ID = 71812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71812Service() {
        this(new Idea71812Config());
    }

    public Idea71812Service(Idea71812Config config) {
        this.config = config != null ? config : new Idea71812Config();
