...
@Data
public class Idea72119Config {
    private String name = "idea_072119";
 ...
 */
@Slf4j
public class Idea72119Service {
    private static final int IDEA_ID = 72119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72119Service() {
        this(new Idea72119Config());
    }

    public Idea72119Service(Idea72119Config config) {
        this.config = config != null ? config : new Idea72119Config();
