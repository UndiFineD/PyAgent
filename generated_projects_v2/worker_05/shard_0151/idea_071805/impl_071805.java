...
@Data
public class Idea71805Config {
    private String name = "idea_071805";
 ...
 */
@Slf4j
public class Idea71805Service {
    private static final int IDEA_ID = 71805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71805Service() {
        this(new Idea71805Config());
    }

    public Idea71805Service(Idea71805Config config) {
        this.config = config != null ? config : new Idea71805Config();
