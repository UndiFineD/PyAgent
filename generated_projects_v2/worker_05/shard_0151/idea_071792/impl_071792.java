...
@Data
public class Idea71792Config {
    private String name = "idea_071792";
 ...
 */
@Slf4j
public class Idea71792Service {
    private static final int IDEA_ID = 71792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71792Service() {
        this(new Idea71792Config());
    }

    public Idea71792Service(Idea71792Config config) {
        this.config = config != null ? config : new Idea71792Config();
