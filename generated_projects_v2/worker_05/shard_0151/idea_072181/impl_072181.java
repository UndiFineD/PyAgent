...
@Data
public class Idea72181Config {
    private String name = "idea_072181";
 ...
 */
@Slf4j
public class Idea72181Service {
    private static final int IDEA_ID = 72181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72181Service() {
        this(new Idea72181Config());
    }

    public Idea72181Service(Idea72181Config config) {
        this.config = config != null ? config : new Idea72181Config();
