...
@Data
public class Idea71928Config {
    private String name = "idea_071928";
 ...
 */
@Slf4j
public class Idea71928Service {
    private static final int IDEA_ID = 71928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71928Service() {
        this(new Idea71928Config());
    }

    public Idea71928Service(Idea71928Config config) {
        this.config = config != null ? config : new Idea71928Config();
