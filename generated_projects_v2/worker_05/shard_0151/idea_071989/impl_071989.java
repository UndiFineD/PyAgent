...
@Data
public class Idea71989Config {
    private String name = "idea_071989";
 ...
 */
@Slf4j
public class Idea71989Service {
    private static final int IDEA_ID = 71989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71989Service() {
        this(new Idea71989Config());
    }

    public Idea71989Service(Idea71989Config config) {
        this.config = config != null ? config : new Idea71989Config();
