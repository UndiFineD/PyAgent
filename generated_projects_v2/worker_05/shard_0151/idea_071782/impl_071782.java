...
@Data
public class Idea71782Config {
    private String name = "idea_071782";
 ...
 */
@Slf4j
public class Idea71782Service {
    private static final int IDEA_ID = 71782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71782Service() {
        this(new Idea71782Config());
    }

    public Idea71782Service(Idea71782Config config) {
        this.config = config != null ? config : new Idea71782Config();
