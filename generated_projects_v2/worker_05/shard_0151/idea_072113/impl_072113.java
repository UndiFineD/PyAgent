...
@Data
public class Idea72113Config {
    private String name = "idea_072113";
 ...
 */
@Slf4j
public class Idea72113Service {
    private static final int IDEA_ID = 72113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72113Service() {
        this(new Idea72113Config());
    }

    public Idea72113Service(Idea72113Config config) {
        this.config = config != null ? config : new Idea72113Config();
