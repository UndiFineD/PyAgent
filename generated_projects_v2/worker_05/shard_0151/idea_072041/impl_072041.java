...
@Data
public class Idea72041Config {
    private String name = "idea_072041";
 ...
 */
@Slf4j
public class Idea72041Service {
    private static final int IDEA_ID = 72041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72041Service() {
        this(new Idea72041Config());
    }

    public Idea72041Service(Idea72041Config config) {
        this.config = config != null ? config : new Idea72041Config();
