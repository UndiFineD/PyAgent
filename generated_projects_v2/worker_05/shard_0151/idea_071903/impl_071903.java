...
@Data
public class Idea71903Config {
    private String name = "idea_071903";
 ...
 */
@Slf4j
public class Idea71903Service {
    private static final int IDEA_ID = 71903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71903Service() {
        this(new Idea71903Config());
    }

    public Idea71903Service(Idea71903Config config) {
        this.config = config != null ? config : new Idea71903Config();
