...
@Data
public class Idea71884Config {
    private String name = "idea_071884";
 ...
 */
@Slf4j
public class Idea71884Service {
    private static final int IDEA_ID = 71884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71884Service() {
        this(new Idea71884Config());
    }

    public Idea71884Service(Idea71884Config config) {
        this.config = config != null ? config : new Idea71884Config();
