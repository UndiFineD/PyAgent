...
@Data
public class Idea71980Config {
    private String name = "idea_071980";
 ...
 */
@Slf4j
public class Idea71980Service {
    private static final int IDEA_ID = 71980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71980Service() {
        this(new Idea71980Config());
    }

    public Idea71980Service(Idea71980Config config) {
        this.config = config != null ? config : new Idea71980Config();
