...
@Data
public class Idea72190Config {
    private String name = "idea_072190";
 ...
 */
@Slf4j
public class Idea72190Service {
    private static final int IDEA_ID = 72190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72190Service() {
        this(new Idea72190Config());
    }

    public Idea72190Service(Idea72190Config config) {
        this.config = config != null ? config : new Idea72190Config();
