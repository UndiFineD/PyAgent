...
@Data
public class Idea72004Config {
    private String name = "idea_072004";
 ...
 */
@Slf4j
public class Idea72004Service {
    private static final int IDEA_ID = 72004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72004Service() {
        this(new Idea72004Config());
    }

    public Idea72004Service(Idea72004Config config) {
        this.config = config != null ? config : new Idea72004Config();
