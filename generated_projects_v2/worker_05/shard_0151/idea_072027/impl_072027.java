...
@Data
public class Idea72027Config {
    private String name = "idea_072027";
 ...
 */
@Slf4j
public class Idea72027Service {
    private static final int IDEA_ID = 72027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72027Service() {
        this(new Idea72027Config());
    }

    public Idea72027Service(Idea72027Config config) {
        this.config = config != null ? config : new Idea72027Config();
