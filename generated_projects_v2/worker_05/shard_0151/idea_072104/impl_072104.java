...
@Data
public class Idea72104Config {
    private String name = "idea_072104";
 ...
 */
@Slf4j
public class Idea72104Service {
    private static final int IDEA_ID = 72104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72104Service() {
        this(new Idea72104Config());
    }

    public Idea72104Service(Idea72104Config config) {
        this.config = config != null ? config : new Idea72104Config();
