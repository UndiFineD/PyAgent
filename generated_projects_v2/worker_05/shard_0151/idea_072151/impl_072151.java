...
@Data
public class Idea72151Config {
    private String name = "idea_072151";
 ...
 */
@Slf4j
public class Idea72151Service {
    private static final int IDEA_ID = 72151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72151Service() {
        this(new Idea72151Config());
    }

    public Idea72151Service(Idea72151Config config) {
        this.config = config != null ? config : new Idea72151Config();
