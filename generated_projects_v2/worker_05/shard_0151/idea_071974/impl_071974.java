...
@Data
public class Idea71974Config {
    private String name = "idea_071974";
 ...
 */
@Slf4j
public class Idea71974Service {
    private static final int IDEA_ID = 71974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71974Service() {
        this(new Idea71974Config());
    }

    public Idea71974Service(Idea71974Config config) {
        this.config = config != null ? config : new Idea71974Config();
