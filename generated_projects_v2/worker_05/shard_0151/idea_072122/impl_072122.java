...
@Data
public class Idea72122Config {
    private String name = "idea_072122";
 ...
 */
@Slf4j
public class Idea72122Service {
    private static final int IDEA_ID = 72122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72122Service() {
        this(new Idea72122Config());
    }

    public Idea72122Service(Idea72122Config config) {
        this.config = config != null ? config : new Idea72122Config();
