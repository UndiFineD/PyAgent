...
@Data
public class Idea71902Config {
    private String name = "idea_071902";
 ...
 */
@Slf4j
public class Idea71902Service {
    private static final int IDEA_ID = 71902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71902Service() {
        this(new Idea71902Config());
    }

    public Idea71902Service(Idea71902Config config) {
        this.config = config != null ? config : new Idea71902Config();
