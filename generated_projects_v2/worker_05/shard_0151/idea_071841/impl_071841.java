...
@Data
public class Idea71841Config {
    private String name = "idea_071841";
 ...
 */
@Slf4j
public class Idea71841Service {
    private static final int IDEA_ID = 71841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71841Service() {
        this(new Idea71841Config());
    }

    public Idea71841Service(Idea71841Config config) {
        this.config = config != null ? config : new Idea71841Config();
