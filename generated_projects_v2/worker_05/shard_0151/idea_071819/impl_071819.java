...
@Data
public class Idea71819Config {
    private String name = "idea_071819";
 ...
 */
@Slf4j
public class Idea71819Service {
    private static final int IDEA_ID = 71819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71819Service() {
        this(new Idea71819Config());
    }

    public Idea71819Service(Idea71819Config config) {
        this.config = config != null ? config : new Idea71819Config();
