...
@Data
public class Idea72096Config {
    private String name = "idea_072096";
 ...
 */
@Slf4j
public class Idea72096Service {
    private static final int IDEA_ID = 72096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72096Service() {
        this(new Idea72096Config());
    }

    public Idea72096Service(Idea72096Config config) {
        this.config = config != null ? config : new Idea72096Config();
