...
@Data
public class Idea71818Config {
    private String name = "idea_071818";
 ...
 */
@Slf4j
public class Idea71818Service {
    private static final int IDEA_ID = 71818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71818Service() {
        this(new Idea71818Config());
    }

    public Idea71818Service(Idea71818Config config) {
        this.config = config != null ? config : new Idea71818Config();
