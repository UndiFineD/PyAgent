...
@Data
public class Idea72070Config {
    private String name = "idea_072070";
 ...
 */
@Slf4j
public class Idea72070Service {
    private static final int IDEA_ID = 72070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72070Service() {
        this(new Idea72070Config());
    }

    public Idea72070Service(Idea72070Config config) {
        this.config = config != null ? config : new Idea72070Config();
