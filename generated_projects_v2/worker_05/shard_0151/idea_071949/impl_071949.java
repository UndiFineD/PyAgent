...
@Data
public class Idea71949Config {
    private String name = "idea_071949";
 ...
 */
@Slf4j
public class Idea71949Service {
    private static final int IDEA_ID = 71949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71949Service() {
        this(new Idea71949Config());
    }

    public Idea71949Service(Idea71949Config config) {
        this.config = config != null ? config : new Idea71949Config();
