...
@Data
public class Idea71950Config {
    private String name = "idea_071950";
 ...
 */
@Slf4j
public class Idea71950Service {
    private static final int IDEA_ID = 71950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71950Service() {
        this(new Idea71950Config());
    }

    public Idea71950Service(Idea71950Config config) {
        this.config = config != null ? config : new Idea71950Config();
