...
@Data
public class Idea71747Config {
    private String name = "idea_071747";
 ...
 */
@Slf4j
public class Idea71747Service {
    private static final int IDEA_ID = 71747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71747Service() {
        this(new Idea71747Config());
    }

    public Idea71747Service(Idea71747Config config) {
        this.config = config != null ? config : new Idea71747Config();
