...
@Data
public class Idea71750Config {
    private String name = "idea_071750";
 ...
 */
@Slf4j
public class Idea71750Service {
    private static final int IDEA_ID = 71750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71750Service() {
        this(new Idea71750Config());
    }

    public Idea71750Service(Idea71750Config config) {
        this.config = config != null ? config : new Idea71750Config();
