...
@Data
public class Idea72193Config {
    private String name = "idea_072193";
 ...
 */
@Slf4j
public class Idea72193Service {
    private static final int IDEA_ID = 72193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72193Service() {
        this(new Idea72193Config());
    }

    public Idea72193Service(Idea72193Config config) {
        this.config = config != null ? config : new Idea72193Config();
