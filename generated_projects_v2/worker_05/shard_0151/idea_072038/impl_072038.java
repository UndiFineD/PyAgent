...
@Data
public class Idea72038Config {
    private String name = "idea_072038";
 ...
 */
@Slf4j
public class Idea72038Service {
    private static final int IDEA_ID = 72038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72038Service() {
        this(new Idea72038Config());
    }

    public Idea72038Service(Idea72038Config config) {
        this.config = config != null ? config : new Idea72038Config();
