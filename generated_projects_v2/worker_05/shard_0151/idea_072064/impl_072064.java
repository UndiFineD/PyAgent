...
@Data
public class Idea72064Config {
    private String name = "idea_072064";
 ...
 */
@Slf4j
public class Idea72064Service {
    private static final int IDEA_ID = 72064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72064Service() {
        this(new Idea72064Config());
    }

    public Idea72064Service(Idea72064Config config) {
        this.config = config != null ? config : new Idea72064Config();
