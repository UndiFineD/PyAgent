...
@Data
public class Idea72062Config {
    private String name = "idea_072062";
 ...
 */
@Slf4j
public class Idea72062Service {
    private static final int IDEA_ID = 72062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72062Service() {
        this(new Idea72062Config());
    }

    public Idea72062Service(Idea72062Config config) {
        this.config = config != null ? config : new Idea72062Config();
