...
@Data
public class Idea72003Config {
    private String name = "idea_072003";
 ...
 */
@Slf4j
public class Idea72003Service {
    private static final int IDEA_ID = 72003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72003Service() {
        this(new Idea72003Config());
    }

    public Idea72003Service(Idea72003Config config) {
        this.config = config != null ? config : new Idea72003Config();
