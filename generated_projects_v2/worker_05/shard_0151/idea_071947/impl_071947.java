...
@Data
public class Idea71947Config {
    private String name = "idea_071947";
 ...
 */
@Slf4j
public class Idea71947Service {
    private static final int IDEA_ID = 71947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71947Service() {
        this(new Idea71947Config());
    }

    public Idea71947Service(Idea71947Config config) {
        this.config = config != null ? config : new Idea71947Config();
