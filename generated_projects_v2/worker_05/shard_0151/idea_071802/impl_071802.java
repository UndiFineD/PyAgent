...
@Data
public class Idea71802Config {
    private String name = "idea_071802";
 ...
 */
@Slf4j
public class Idea71802Service {
    private static final int IDEA_ID = 71802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71802Service() {
        this(new Idea71802Config());
    }

    public Idea71802Service(Idea71802Config config) {
        this.config = config != null ? config : new Idea71802Config();
