...
@Data
public class Idea71755Config {
    private String name = "idea_071755";
 ...
 */
@Slf4j
public class Idea71755Service {
    private static final int IDEA_ID = 71755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71755Service() {
        this(new Idea71755Config());
    }

    public Idea71755Service(Idea71755Config config) {
        this.config = config != null ? config : new Idea71755Config();
