...
@Data
public class Idea71879Config {
    private String name = "idea_071879";
 ...
 */
@Slf4j
public class Idea71879Service {
    private static final int IDEA_ID = 71879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71879Service() {
        this(new Idea71879Config());
    }

    public Idea71879Service(Idea71879Config config) {
        this.config = config != null ? config : new Idea71879Config();
