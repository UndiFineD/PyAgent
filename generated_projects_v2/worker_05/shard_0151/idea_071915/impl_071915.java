...
@Data
public class Idea71915Config {
    private String name = "idea_071915";
 ...
 */
@Slf4j
public class Idea71915Service {
    private static final int IDEA_ID = 71915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71915Service() {
        this(new Idea71915Config());
    }

    public Idea71915Service(Idea71915Config config) {
        this.config = config != null ? config : new Idea71915Config();
