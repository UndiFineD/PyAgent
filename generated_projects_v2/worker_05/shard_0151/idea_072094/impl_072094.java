...
@Data
public class Idea72094Config {
    private String name = "idea_072094";
 ...
 */
@Slf4j
public class Idea72094Service {
    private static final int IDEA_ID = 72094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72094Service() {
        this(new Idea72094Config());
    }

    public Idea72094Service(Idea72094Config config) {
        this.config = config != null ? config : new Idea72094Config();
