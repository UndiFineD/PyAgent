...
@Data
public class Idea71995Config {
    private String name = "idea_071995";
 ...
 */
@Slf4j
public class Idea71995Service {
    private static final int IDEA_ID = 71995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71995Service() {
        this(new Idea71995Config());
    }

    public Idea71995Service(Idea71995Config config) {
        this.config = config != null ? config : new Idea71995Config();
