...
@Data
public class Idea71810Config {
    private String name = "idea_071810";
 ...
 */
@Slf4j
public class Idea71810Service {
    private static final int IDEA_ID = 71810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71810Service() {
        this(new Idea71810Config());
    }

    public Idea71810Service(Idea71810Config config) {
        this.config = config != null ? config : new Idea71810Config();
