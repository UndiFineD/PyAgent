...
@Data
public class Idea72111Config {
    private String name = "idea_072111";
 ...
 */
@Slf4j
public class Idea72111Service {
    private static final int IDEA_ID = 72111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72111Service() {
        this(new Idea72111Config());
    }

    public Idea72111Service(Idea72111Config config) {
        this.config = config != null ? config : new Idea72111Config();
