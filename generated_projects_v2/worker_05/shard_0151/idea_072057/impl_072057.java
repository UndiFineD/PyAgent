...
@Data
public class Idea72057Config {
    private String name = "idea_072057";
 ...
 */
@Slf4j
public class Idea72057Service {
    private static final int IDEA_ID = 72057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72057Service() {
        this(new Idea72057Config());
    }

    public Idea72057Service(Idea72057Config config) {
        this.config = config != null ? config : new Idea72057Config();
