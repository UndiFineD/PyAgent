...
@Data
public class Idea72175Config {
    private String name = "idea_072175";
 ...
 */
@Slf4j
public class Idea72175Service {
    private static final int IDEA_ID = 72175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72175Service() {
        this(new Idea72175Config());
    }

    public Idea72175Service(Idea72175Config config) {
        this.config = config != null ? config : new Idea72175Config();
