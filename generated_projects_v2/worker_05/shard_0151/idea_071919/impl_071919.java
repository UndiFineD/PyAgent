...
@Data
public class Idea71919Config {
    private String name = "idea_071919";
 ...
 */
@Slf4j
public class Idea71919Service {
    private static final int IDEA_ID = 71919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71919Service() {
        this(new Idea71919Config());
    }

    public Idea71919Service(Idea71919Config config) {
        this.config = config != null ? config : new Idea71919Config();
