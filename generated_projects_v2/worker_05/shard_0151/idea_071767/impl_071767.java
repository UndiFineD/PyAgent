...
@Data
public class Idea71767Config {
    private String name = "idea_071767";
 ...
 */
@Slf4j
public class Idea71767Service {
    private static final int IDEA_ID = 71767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71767Service() {
        this(new Idea71767Config());
    }

    public Idea71767Service(Idea71767Config config) {
        this.config = config != null ? config : new Idea71767Config();
