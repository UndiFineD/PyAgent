...
@Data
public class Idea71890Config {
    private String name = "idea_071890";
 ...
 */
@Slf4j
public class Idea71890Service {
    private static final int IDEA_ID = 71890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71890Service() {
        this(new Idea71890Config());
    }

    public Idea71890Service(Idea71890Config config) {
        this.config = config != null ? config : new Idea71890Config();
