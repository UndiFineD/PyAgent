...
@Data
public class Idea71994Config {
    private String name = "idea_071994";
 ...
 */
@Slf4j
public class Idea71994Service {
    private static final int IDEA_ID = 71994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71994Service() {
        this(new Idea71994Config());
    }

    public Idea71994Service(Idea71994Config config) {
        this.config = config != null ? config : new Idea71994Config();
