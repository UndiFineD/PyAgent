...
@Data
public class Idea71738Config {
    private String name = "idea_071738";
 ...
 */
@Slf4j
public class Idea71738Service {
    private static final int IDEA_ID = 71738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71738Service() {
        this(new Idea71738Config());
    }

    public Idea71738Service(Idea71738Config config) {
        this.config = config != null ? config : new Idea71738Config();
