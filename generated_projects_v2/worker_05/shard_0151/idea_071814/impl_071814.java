...
@Data
public class Idea71814Config {
    private String name = "idea_071814";
 ...
 */
@Slf4j
public class Idea71814Service {
    private static final int IDEA_ID = 71814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71814Service() {
        this(new Idea71814Config());
    }

    public Idea71814Service(Idea71814Config config) {
        this.config = config != null ? config : new Idea71814Config();
