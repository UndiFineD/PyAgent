...
@Data
public class Idea71766Config {
    private String name = "idea_071766";
 ...
 */
@Slf4j
public class Idea71766Service {
    private static final int IDEA_ID = 71766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71766Service() {
        this(new Idea71766Config());
    }

    public Idea71766Service(Idea71766Config config) {
        this.config = config != null ? config : new Idea71766Config();
