...
@Data
public class Idea71725Config {
    private String name = "idea_071725";
 ...
 */
@Slf4j
public class Idea71725Service {
    private static final int IDEA_ID = 71725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71725Service() {
        this(new Idea71725Config());
    }

    public Idea71725Service(Idea71725Config config) {
        this.config = config != null ? config : new Idea71725Config();
