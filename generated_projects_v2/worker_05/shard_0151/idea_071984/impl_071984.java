...
@Data
public class Idea71984Config {
    private String name = "idea_071984";
 ...
 */
@Slf4j
public class Idea71984Service {
    private static final int IDEA_ID = 71984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71984Service() {
        this(new Idea71984Config());
    }

    public Idea71984Service(Idea71984Config config) {
        this.config = config != null ? config : new Idea71984Config();
