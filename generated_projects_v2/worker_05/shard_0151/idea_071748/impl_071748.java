...
@Data
public class Idea71748Config {
    private String name = "idea_071748";
 ...
 */
@Slf4j
public class Idea71748Service {
    private static final int IDEA_ID = 71748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71748Service() {
        this(new Idea71748Config());
    }

    public Idea71748Service(Idea71748Config config) {
        this.config = config != null ? config : new Idea71748Config();
