...
@Data
public class Idea72019Config {
    private String name = "idea_072019";
 ...
 */
@Slf4j
public class Idea72019Service {
    private static final int IDEA_ID = 72019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72019Service() {
        this(new Idea72019Config());
    }

    public Idea72019Service(Idea72019Config config) {
        this.config = config != null ? config : new Idea72019Config();
