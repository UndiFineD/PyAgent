...
@Data
public class Idea71727Config {
    private String name = "idea_071727";
 ...
 */
@Slf4j
public class Idea71727Service {
    private static final int IDEA_ID = 71727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71727Service() {
        this(new Idea71727Config());
    }

    public Idea71727Service(Idea71727Config config) {
        this.config = config != null ? config : new Idea71727Config();
