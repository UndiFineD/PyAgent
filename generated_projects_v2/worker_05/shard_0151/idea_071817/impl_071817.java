...
@Data
public class Idea71817Config {
    private String name = "idea_071817";
 ...
 */
@Slf4j
public class Idea71817Service {
    private static final int IDEA_ID = 71817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71817Service() {
        this(new Idea71817Config());
    }

    public Idea71817Service(Idea71817Config config) {
        this.config = config != null ? config : new Idea71817Config();
