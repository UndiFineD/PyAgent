...
@Data
public class Idea71965Config {
    private String name = "idea_071965";
 ...
 */
@Slf4j
public class Idea71965Service {
    private static final int IDEA_ID = 71965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71965Service() {
        this(new Idea71965Config());
    }

    public Idea71965Service(Idea71965Config config) {
        this.config = config != null ? config : new Idea71965Config();
