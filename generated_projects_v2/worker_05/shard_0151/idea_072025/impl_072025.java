...
@Data
public class Idea72025Config {
    private String name = "idea_072025";
 ...
 */
@Slf4j
public class Idea72025Service {
    private static final int IDEA_ID = 72025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72025Service() {
        this(new Idea72025Config());
    }

    public Idea72025Service(Idea72025Config config) {
        this.config = config != null ? config : new Idea72025Config();
