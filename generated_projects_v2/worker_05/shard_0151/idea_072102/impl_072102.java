...
@Data
public class Idea72102Config {
    private String name = "idea_072102";
 ...
 */
@Slf4j
public class Idea72102Service {
    private static final int IDEA_ID = 72102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72102Service() {
        this(new Idea72102Config());
    }

    public Idea72102Service(Idea72102Config config) {
        this.config = config != null ? config : new Idea72102Config();
