...
@Data
public class Idea71793Config {
    private String name = "idea_071793";
 ...
 */
@Slf4j
public class Idea71793Service {
    private static final int IDEA_ID = 71793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71793Service() {
        this(new Idea71793Config());
    }

    public Idea71793Service(Idea71793Config config) {
        this.config = config != null ? config : new Idea71793Config();
