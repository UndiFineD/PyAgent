...
@Data
public class Idea72042Config {
    private String name = "idea_072042";
 ...
 */
@Slf4j
public class Idea72042Service {
    private static final int IDEA_ID = 72042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72042Service() {
        this(new Idea72042Config());
    }

    public Idea72042Service(Idea72042Config config) {
        this.config = config != null ? config : new Idea72042Config();
