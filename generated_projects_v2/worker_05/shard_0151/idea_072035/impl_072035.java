...
@Data
public class Idea72035Config {
    private String name = "idea_072035";
 ...
 */
@Slf4j
public class Idea72035Service {
    private static final int IDEA_ID = 72035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72035Service() {
        this(new Idea72035Config());
    }

    public Idea72035Service(Idea72035Config config) {
        this.config = config != null ? config : new Idea72035Config();
