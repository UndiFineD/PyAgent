...
@Data
public class Idea72167Config {
    private String name = "idea_072167";
 ...
 */
@Slf4j
public class Idea72167Service {
    private static final int IDEA_ID = 72167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72167Service() {
        this(new Idea72167Config());
    }

    public Idea72167Service(Idea72167Config config) {
        this.config = config != null ? config : new Idea72167Config();
