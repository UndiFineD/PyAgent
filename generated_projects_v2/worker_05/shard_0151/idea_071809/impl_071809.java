...
@Data
public class Idea71809Config {
    private String name = "idea_071809";
 ...
 */
@Slf4j
public class Idea71809Service {
    private static final int IDEA_ID = 71809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71809Service() {
        this(new Idea71809Config());
    }

    public Idea71809Service(Idea71809Config config) {
        this.config = config != null ? config : new Idea71809Config();
