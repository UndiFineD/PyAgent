...
@Data
public class Idea71829Config {
    private String name = "idea_071829";
 ...
 */
@Slf4j
public class Idea71829Service {
    private static final int IDEA_ID = 71829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71829Service() {
        this(new Idea71829Config());
    }

    public Idea71829Service(Idea71829Config config) {
        this.config = config != null ? config : new Idea71829Config();
