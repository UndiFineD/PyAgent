...
@Data
public class Idea71931Config {
    private String name = "idea_071931";
 ...
 */
@Slf4j
public class Idea71931Service {
    private static final int IDEA_ID = 71931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71931Service() {
        this(new Idea71931Config());
    }

    public Idea71931Service(Idea71931Config config) {
        this.config = config != null ? config : new Idea71931Config();
