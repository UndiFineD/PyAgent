...
@Data
public class Idea72011Config {
    private String name = "idea_072011";
 ...
 */
@Slf4j
public class Idea72011Service {
    private static final int IDEA_ID = 72011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72011Service() {
        this(new Idea72011Config());
    }

    public Idea72011Service(Idea72011Config config) {
        this.config = config != null ? config : new Idea72011Config();
