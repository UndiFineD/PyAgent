...
@Data
public class Idea71732Config {
    private String name = "idea_071732";
 ...
 */
@Slf4j
public class Idea71732Service {
    private static final int IDEA_ID = 71732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71732Service() {
        this(new Idea71732Config());
    }

    public Idea71732Service(Idea71732Config config) {
        this.config = config != null ? config : new Idea71732Config();
