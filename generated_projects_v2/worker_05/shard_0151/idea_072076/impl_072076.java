...
@Data
public class Idea72076Config {
    private String name = "idea_072076";
 ...
 */
@Slf4j
public class Idea72076Service {
    private static final int IDEA_ID = 72076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72076Service() {
        this(new Idea72076Config());
    }

    public Idea72076Service(Idea72076Config config) {
        this.config = config != null ? config : new Idea72076Config();
