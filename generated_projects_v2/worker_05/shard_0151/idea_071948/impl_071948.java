...
@Data
public class Idea71948Config {
    private String name = "idea_071948";
 ...
 */
@Slf4j
public class Idea71948Service {
    private static final int IDEA_ID = 71948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71948Service() {
        this(new Idea71948Config());
    }

    public Idea71948Service(Idea71948Config config) {
        this.config = config != null ? config : new Idea71948Config();
