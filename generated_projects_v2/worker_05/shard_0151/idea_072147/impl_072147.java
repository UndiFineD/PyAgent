...
@Data
public class Idea72147Config {
    private String name = "idea_072147";
 ...
 */
@Slf4j
public class Idea72147Service {
    private static final int IDEA_ID = 72147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72147Service() {
        this(new Idea72147Config());
    }

    public Idea72147Service(Idea72147Config config) {
        this.config = config != null ? config : new Idea72147Config();
