...
@Data
public class Idea72173Config {
    private String name = "idea_072173";
 ...
 */
@Slf4j
public class Idea72173Service {
    private static final int IDEA_ID = 72173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72173Service() {
        this(new Idea72173Config());
    }

    public Idea72173Service(Idea72173Config config) {
        this.config = config != null ? config : new Idea72173Config();
