...
@Data
public class Idea71893Config {
    private String name = "idea_071893";
 ...
 */
@Slf4j
public class Idea71893Service {
    private static final int IDEA_ID = 71893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71893Service() {
        this(new Idea71893Config());
    }

    public Idea71893Service(Idea71893Config config) {
        this.config = config != null ? config : new Idea71893Config();
