...
@Data
public class Idea71956Config {
    private String name = "idea_071956";
 ...
 */
@Slf4j
public class Idea71956Service {
    private static final int IDEA_ID = 71956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71956Service() {
        this(new Idea71956Config());
    }

    public Idea71956Service(Idea71956Config config) {
        this.config = config != null ? config : new Idea71956Config();
