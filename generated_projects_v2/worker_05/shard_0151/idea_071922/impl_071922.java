...
@Data
public class Idea71922Config {
    private String name = "idea_071922";
 ...
 */
@Slf4j
public class Idea71922Service {
    private static final int IDEA_ID = 71922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71922Service() {
        this(new Idea71922Config());
    }

    public Idea71922Service(Idea71922Config config) {
        this.config = config != null ? config : new Idea71922Config();
