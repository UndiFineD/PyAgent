...
@Data
public class Idea71781Config {
    private String name = "idea_071781";
 ...
 */
@Slf4j
public class Idea71781Service {
    private static final int IDEA_ID = 71781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71781Service() {
        this(new Idea71781Config());
    }

    public Idea71781Service(Idea71781Config config) {
        this.config = config != null ? config : new Idea71781Config();
