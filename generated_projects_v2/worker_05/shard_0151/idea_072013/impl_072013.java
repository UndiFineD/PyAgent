...
@Data
public class Idea72013Config {
    private String name = "idea_072013";
 ...
 */
@Slf4j
public class Idea72013Service {
    private static final int IDEA_ID = 72013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72013Service() {
        this(new Idea72013Config());
    }

    public Idea72013Service(Idea72013Config config) {
        this.config = config != null ? config : new Idea72013Config();
