...
@Data
public class Idea71901Config {
    private String name = "idea_071901";
 ...
 */
@Slf4j
public class Idea71901Service {
    private static final int IDEA_ID = 71901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71901Service() {
        this(new Idea71901Config());
    }

    public Idea71901Service(Idea71901Config config) {
        this.config = config != null ? config : new Idea71901Config();
