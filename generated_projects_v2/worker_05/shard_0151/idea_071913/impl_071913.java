...
@Data
public class Idea71913Config {
    private String name = "idea_071913";
 ...
 */
@Slf4j
public class Idea71913Service {
    private static final int IDEA_ID = 71913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71913Service() {
        this(new Idea71913Config());
    }

    public Idea71913Service(Idea71913Config config) {
        this.config = config != null ? config : new Idea71913Config();
