...
@Data
public class Idea71917Config {
    private String name = "idea_071917";
 ...
 */
@Slf4j
public class Idea71917Service {
    private static final int IDEA_ID = 71917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71917Service() {
        this(new Idea71917Config());
    }

    public Idea71917Service(Idea71917Config config) {
        this.config = config != null ? config : new Idea71917Config();
