...
@Data
public class Idea71914Config {
    private String name = "idea_071914";
 ...
 */
@Slf4j
public class Idea71914Service {
    private static final int IDEA_ID = 71914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71914Service() {
        this(new Idea71914Config());
    }

    public Idea71914Service(Idea71914Config config) {
        this.config = config != null ? config : new Idea71914Config();
