...
@Data
public class Idea71937Config {
    private String name = "idea_071937";
 ...
 */
@Slf4j
public class Idea71937Service {
    private static final int IDEA_ID = 71937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71937Service() {
        this(new Idea71937Config());
    }

    public Idea71937Service(Idea71937Config config) {
        this.config = config != null ? config : new Idea71937Config();
