...
@Data
public class Idea71933Config {
    private String name = "idea_071933";
 ...
 */
@Slf4j
public class Idea71933Service {
    private static final int IDEA_ID = 71933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71933Service() {
        this(new Idea71933Config());
    }

    public Idea71933Service(Idea71933Config config) {
        this.config = config != null ? config : new Idea71933Config();
