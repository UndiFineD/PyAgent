...
@Data
public class Idea72088Config {
    private String name = "idea_072088";
 ...
 */
@Slf4j
public class Idea72088Service {
    private static final int IDEA_ID = 72088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72088Service() {
        this(new Idea72088Config());
    }

    public Idea72088Service(Idea72088Config config) {
        this.config = config != null ? config : new Idea72088Config();
