...
@Data
public class Idea72121Config {
    private String name = "idea_072121";
 ...
 */
@Slf4j
public class Idea72121Service {
    private static final int IDEA_ID = 72121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72121Service() {
        this(new Idea72121Config());
    }

    public Idea72121Service(Idea72121Config config) {
        this.config = config != null ? config : new Idea72121Config();
