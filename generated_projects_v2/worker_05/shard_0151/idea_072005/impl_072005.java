...
@Data
public class Idea72005Config {
    private String name = "idea_072005";
 ...
 */
@Slf4j
public class Idea72005Service {
    private static final int IDEA_ID = 72005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72005Service() {
        this(new Idea72005Config());
    }

    public Idea72005Service(Idea72005Config config) {
        this.config = config != null ? config : new Idea72005Config();
