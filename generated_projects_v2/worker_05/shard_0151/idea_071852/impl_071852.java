...
@Data
public class Idea71852Config {
    private String name = "idea_071852";
 ...
 */
@Slf4j
public class Idea71852Service {
    private static final int IDEA_ID = 71852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71852Service() {
        this(new Idea71852Config());
    }

    public Idea71852Service(Idea71852Config config) {
        this.config = config != null ? config : new Idea71852Config();
