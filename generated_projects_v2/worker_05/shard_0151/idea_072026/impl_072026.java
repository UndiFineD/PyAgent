...
@Data
public class Idea72026Config {
    private String name = "idea_072026";
 ...
 */
@Slf4j
public class Idea72026Service {
    private static final int IDEA_ID = 72026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72026Service() {
        this(new Idea72026Config());
    }

    public Idea72026Service(Idea72026Config config) {
        this.config = config != null ? config : new Idea72026Config();
