...
@Data
public class Idea71773Config {
    private String name = "idea_071773";
 ...
 */
@Slf4j
public class Idea71773Service {
    private static final int IDEA_ID = 71773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71773Service() {
        this(new Idea71773Config());
    }

    public Idea71773Service(Idea71773Config config) {
        this.config = config != null ? config : new Idea71773Config();
