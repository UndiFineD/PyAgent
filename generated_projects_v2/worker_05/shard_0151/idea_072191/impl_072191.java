...
@Data
public class Idea72191Config {
    private String name = "idea_072191";
 ...
 */
@Slf4j
public class Idea72191Service {
    private static final int IDEA_ID = 72191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea72191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea72191Service() {
        this(new Idea72191Config());
    }

    public Idea72191Service(Idea72191Config config) {
        this.config = config != null ? config : new Idea72191Config();
