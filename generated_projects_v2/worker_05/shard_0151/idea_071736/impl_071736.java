...
@Data
public class Idea71736Config {
    private String name = "idea_071736";
 ...
 */
@Slf4j
public class Idea71736Service {
    private static final int IDEA_ID = 71736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71736Service() {
        this(new Idea71736Config());
    }

    public Idea71736Service(Idea71736Config config) {
        this.config = config != null ? config : new Idea71736Config();
