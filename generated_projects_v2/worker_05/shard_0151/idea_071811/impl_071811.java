...
@Data
public class Idea71811Config {
    private String name = "idea_071811";
 ...
 */
@Slf4j
public class Idea71811Service {
    private static final int IDEA_ID = 71811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea71811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea71811Service() {
        this(new Idea71811Config());
    }

    public Idea71811Service(Idea71811Config config) {
        this.config = config != null ? config : new Idea71811Config();
