...
@Data
public class Idea74543Config {
    private String name = "idea_074543";
 ...
 */
@Slf4j
public class Idea74543Service {
    private static final int IDEA_ID = 74543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74543Service() {
        this(new Idea74543Config());
    }

    public Idea74543Service(Idea74543Config config) {
        this.config = config != null ? config : new Idea74543Config();
