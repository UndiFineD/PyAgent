...
@Data
public class Idea74542Config {
    private String name = "idea_074542";
 ...
 */
@Slf4j
public class Idea74542Service {
    private static final int IDEA_ID = 74542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74542Service() {
        this(new Idea74542Config());
    }

    public Idea74542Service(Idea74542Config config) {
        this.config = config != null ? config : new Idea74542Config();
