...
@Data
public class Idea74306Config {
    private String name = "idea_074306";
 ...
 */
@Slf4j
public class Idea74306Service {
    private static final int IDEA_ID = 74306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74306Service() {
        this(new Idea74306Config());
    }

    public Idea74306Service(Idea74306Config config) {
        this.config = config != null ? config : new Idea74306Config();
