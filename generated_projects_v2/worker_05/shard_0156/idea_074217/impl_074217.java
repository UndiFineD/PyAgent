...
@Data
public class Idea74217Config {
    private String name = "idea_074217";
 ...
 */
@Slf4j
public class Idea74217Service {
    private static final int IDEA_ID = 74217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74217Service() {
        this(new Idea74217Config());
    }

    public Idea74217Service(Idea74217Config config) {
        this.config = config != null ? config : new Idea74217Config();
