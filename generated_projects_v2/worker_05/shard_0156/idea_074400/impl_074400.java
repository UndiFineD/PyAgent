...
@Data
public class Idea74400Config {
    private String name = "idea_074400";
 ...
 */
@Slf4j
public class Idea74400Service {
    private static final int IDEA_ID = 74400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74400Service() {
        this(new Idea74400Config());
    }

    public Idea74400Service(Idea74400Config config) {
        this.config = config != null ? config : new Idea74400Config();
