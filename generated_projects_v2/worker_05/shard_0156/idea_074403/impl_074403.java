...
@Data
public class Idea74403Config {
    private String name = "idea_074403";
 ...
 */
@Slf4j
public class Idea74403Service {
    private static final int IDEA_ID = 74403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74403Service() {
        this(new Idea74403Config());
    }

    public Idea74403Service(Idea74403Config config) {
        this.config = config != null ? config : new Idea74403Config();
