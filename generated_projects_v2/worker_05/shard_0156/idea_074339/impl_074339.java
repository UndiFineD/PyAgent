...
@Data
public class Idea74339Config {
    private String name = "idea_074339";
 ...
 */
@Slf4j
public class Idea74339Service {
    private static final int IDEA_ID = 74339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74339Service() {
        this(new Idea74339Config());
    }

    public Idea74339Service(Idea74339Config config) {
        this.config = config != null ? config : new Idea74339Config();
