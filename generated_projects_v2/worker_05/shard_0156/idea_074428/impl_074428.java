...
@Data
public class Idea74428Config {
    private String name = "idea_074428";
 ...
 */
@Slf4j
public class Idea74428Service {
    private static final int IDEA_ID = 74428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74428Service() {
        this(new Idea74428Config());
    }

    public Idea74428Service(Idea74428Config config) {
        this.config = config != null ? config : new Idea74428Config();
