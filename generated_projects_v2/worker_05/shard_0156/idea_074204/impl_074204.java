...
@Data
public class Idea74204Config {
    private String name = "idea_074204";
 ...
 */
@Slf4j
public class Idea74204Service {
    private static final int IDEA_ID = 74204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74204Service() {
        this(new Idea74204Config());
    }

    public Idea74204Service(Idea74204Config config) {
        this.config = config != null ? config : new Idea74204Config();
