...
@Data
public class Idea74421Config {
    private String name = "idea_074421";
 ...
 */
@Slf4j
public class Idea74421Service {
    private static final int IDEA_ID = 74421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74421Service() {
        this(new Idea74421Config());
    }

    public Idea74421Service(Idea74421Config config) {
        this.config = config != null ? config : new Idea74421Config();
