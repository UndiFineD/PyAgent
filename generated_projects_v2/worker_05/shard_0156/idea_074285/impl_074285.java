...
@Data
public class Idea74285Config {
    private String name = "idea_074285";
 ...
 */
@Slf4j
public class Idea74285Service {
    private static final int IDEA_ID = 74285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74285Service() {
        this(new Idea74285Config());
    }

    public Idea74285Service(Idea74285Config config) {
        this.config = config != null ? config : new Idea74285Config();
