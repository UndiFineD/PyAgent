...
@Data
public class Idea74527Config {
    private String name = "idea_074527";
 ...
 */
@Slf4j
public class Idea74527Service {
    private static final int IDEA_ID = 74527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74527Service() {
        this(new Idea74527Config());
    }

    public Idea74527Service(Idea74527Config config) {
        this.config = config != null ? config : new Idea74527Config();
