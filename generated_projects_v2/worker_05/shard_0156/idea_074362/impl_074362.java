...
@Data
public class Idea74362Config {
    private String name = "idea_074362";
 ...
 */
@Slf4j
public class Idea74362Service {
    private static final int IDEA_ID = 74362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74362Service() {
        this(new Idea74362Config());
    }

    public Idea74362Service(Idea74362Config config) {
        this.config = config != null ? config : new Idea74362Config();
