...
@Data
public class Idea74301Config {
    private String name = "idea_074301";
 ...
 */
@Slf4j
public class Idea74301Service {
    private static final int IDEA_ID = 74301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74301Service() {
        this(new Idea74301Config());
    }

    public Idea74301Service(Idea74301Config config) {
        this.config = config != null ? config : new Idea74301Config();
