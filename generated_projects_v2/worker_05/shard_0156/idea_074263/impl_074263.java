...
@Data
public class Idea74263Config {
    private String name = "idea_074263";
 ...
 */
@Slf4j
public class Idea74263Service {
    private static final int IDEA_ID = 74263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74263Service() {
        this(new Idea74263Config());
    }

    public Idea74263Service(Idea74263Config config) {
        this.config = config != null ? config : new Idea74263Config();
