...
@Data
public class Idea74288Config {
    private String name = "idea_074288";
 ...
 */
@Slf4j
public class Idea74288Service {
    private static final int IDEA_ID = 74288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74288Service() {
        this(new Idea74288Config());
    }

    public Idea74288Service(Idea74288Config config) {
        this.config = config != null ? config : new Idea74288Config();
