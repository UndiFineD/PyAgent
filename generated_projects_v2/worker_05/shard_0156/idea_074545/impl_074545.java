...
@Data
public class Idea74545Config {
    private String name = "idea_074545";
 ...
 */
@Slf4j
public class Idea74545Service {
    private static final int IDEA_ID = 74545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74545Service() {
        this(new Idea74545Config());
    }

    public Idea74545Service(Idea74545Config config) {
        this.config = config != null ? config : new Idea74545Config();
