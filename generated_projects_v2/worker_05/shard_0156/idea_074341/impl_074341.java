...
@Data
public class Idea74341Config {
    private String name = "idea_074341";
 ...
 */
@Slf4j
public class Idea74341Service {
    private static final int IDEA_ID = 74341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74341Service() {
        this(new Idea74341Config());
    }

    public Idea74341Service(Idea74341Config config) {
        this.config = config != null ? config : new Idea74341Config();
