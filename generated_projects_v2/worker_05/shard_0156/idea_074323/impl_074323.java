...
@Data
public class Idea74323Config {
    private String name = "idea_074323";
 ...
 */
@Slf4j
public class Idea74323Service {
    private static final int IDEA_ID = 74323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74323Service() {
        this(new Idea74323Config());
    }

    public Idea74323Service(Idea74323Config config) {
        this.config = config != null ? config : new Idea74323Config();
