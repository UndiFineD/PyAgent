...
@Data
public class Idea74370Config {
    private String name = "idea_074370";
 ...
 */
@Slf4j
public class Idea74370Service {
    private static final int IDEA_ID = 74370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74370Service() {
        this(new Idea74370Config());
    }

    public Idea74370Service(Idea74370Config config) {
        this.config = config != null ? config : new Idea74370Config();
