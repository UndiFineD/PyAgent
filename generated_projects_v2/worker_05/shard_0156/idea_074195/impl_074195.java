...
@Data
public class Idea74195Config {
    private String name = "idea_074195";
 ...
 */
@Slf4j
public class Idea74195Service {
    private static final int IDEA_ID = 74195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74195Service() {
        this(new Idea74195Config());
    }

    public Idea74195Service(Idea74195Config config) {
        this.config = config != null ? config : new Idea74195Config();
