...
@Data
public class Idea74240Config {
    private String name = "idea_074240";
 ...
 */
@Slf4j
public class Idea74240Service {
    private static final int IDEA_ID = 74240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74240Service() {
        this(new Idea74240Config());
    }

    public Idea74240Service(Idea74240Config config) {
        this.config = config != null ? config : new Idea74240Config();
