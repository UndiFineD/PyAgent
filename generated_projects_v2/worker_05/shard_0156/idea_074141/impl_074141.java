...
@Data
public class Idea74141Config {
    private String name = "idea_074141";
 ...
 */
@Slf4j
public class Idea74141Service {
    private static final int IDEA_ID = 74141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74141Service() {
        this(new Idea74141Config());
    }

    public Idea74141Service(Idea74141Config config) {
        this.config = config != null ? config : new Idea74141Config();
