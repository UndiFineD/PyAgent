...
@Data
public class Idea74490Config {
    private String name = "idea_074490";
 ...
 */
@Slf4j
public class Idea74490Service {
    private static final int IDEA_ID = 74490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74490Service() {
        this(new Idea74490Config());
    }

    public Idea74490Service(Idea74490Config config) {
        this.config = config != null ? config : new Idea74490Config();
