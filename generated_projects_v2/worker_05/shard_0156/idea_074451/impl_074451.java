...
@Data
public class Idea74451Config {
    private String name = "idea_074451";
 ...
 */
@Slf4j
public class Idea74451Service {
    private static final int IDEA_ID = 74451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74451Service() {
        this(new Idea74451Config());
    }

    public Idea74451Service(Idea74451Config config) {
        this.config = config != null ? config : new Idea74451Config();
