...
@Data
public class Idea74241Config {
    private String name = "idea_074241";
 ...
 */
@Slf4j
public class Idea74241Service {
    private static final int IDEA_ID = 74241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74241Service() {
        this(new Idea74241Config());
    }

    public Idea74241Service(Idea74241Config config) {
        this.config = config != null ? config : new Idea74241Config();
