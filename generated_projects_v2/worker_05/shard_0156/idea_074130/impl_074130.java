...
@Data
public class Idea74130Config {
    private String name = "idea_074130";
 ...
 */
@Slf4j
public class Idea74130Service {
    private static final int IDEA_ID = 74130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74130Service() {
        this(new Idea74130Config());
    }

    public Idea74130Service(Idea74130Config config) {
        this.config = config != null ? config : new Idea74130Config();
