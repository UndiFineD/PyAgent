...
@Data
public class Idea74111Config {
    private String name = "idea_074111";
 ...
 */
@Slf4j
public class Idea74111Service {
    private static final int IDEA_ID = 74111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74111Service() {
        this(new Idea74111Config());
    }

    public Idea74111Service(Idea74111Config config) {
        this.config = config != null ? config : new Idea74111Config();
