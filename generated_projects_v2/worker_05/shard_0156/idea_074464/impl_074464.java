...
@Data
public class Idea74464Config {
    private String name = "idea_074464";
 ...
 */
@Slf4j
public class Idea74464Service {
    private static final int IDEA_ID = 74464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74464Service() {
        this(new Idea74464Config());
    }

    public Idea74464Service(Idea74464Config config) {
        this.config = config != null ? config : new Idea74464Config();
