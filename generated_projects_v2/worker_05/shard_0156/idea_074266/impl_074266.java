...
@Data
public class Idea74266Config {
    private String name = "idea_074266";
 ...
 */
@Slf4j
public class Idea74266Service {
    private static final int IDEA_ID = 74266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74266Service() {
        this(new Idea74266Config());
    }

    public Idea74266Service(Idea74266Config config) {
        this.config = config != null ? config : new Idea74266Config();
