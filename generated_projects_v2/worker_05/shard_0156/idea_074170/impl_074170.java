...
@Data
public class Idea74170Config {
    private String name = "idea_074170";
 ...
 */
@Slf4j
public class Idea74170Service {
    private static final int IDEA_ID = 74170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74170Service() {
        this(new Idea74170Config());
    }

    public Idea74170Service(Idea74170Config config) {
        this.config = config != null ? config : new Idea74170Config();
