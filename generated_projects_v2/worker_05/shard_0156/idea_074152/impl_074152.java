...
@Data
public class Idea74152Config {
    private String name = "idea_074152";
 ...
 */
@Slf4j
public class Idea74152Service {
    private static final int IDEA_ID = 74152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74152Service() {
        this(new Idea74152Config());
    }

    public Idea74152Service(Idea74152Config config) {
        this.config = config != null ? config : new Idea74152Config();
