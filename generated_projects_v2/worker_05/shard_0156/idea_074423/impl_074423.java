...
@Data
public class Idea74423Config {
    private String name = "idea_074423";
 ...
 */
@Slf4j
public class Idea74423Service {
    private static final int IDEA_ID = 74423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74423Service() {
        this(new Idea74423Config());
    }

    public Idea74423Service(Idea74423Config config) {
        this.config = config != null ? config : new Idea74423Config();
