...
@Data
public class Idea74250Config {
    private String name = "idea_074250";
 ...
 */
@Slf4j
public class Idea74250Service {
    private static final int IDEA_ID = 74250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74250Service() {
        this(new Idea74250Config());
    }

    public Idea74250Service(Idea74250Config config) {
        this.config = config != null ? config : new Idea74250Config();
