...
@Data
public class Idea74118Config {
    private String name = "idea_074118";
 ...
 */
@Slf4j
public class Idea74118Service {
    private static final int IDEA_ID = 74118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74118Service() {
        this(new Idea74118Config());
    }

    public Idea74118Service(Idea74118Config config) {
        this.config = config != null ? config : new Idea74118Config();
