...
@Data
public class Idea74252Config {
    private String name = "idea_074252";
 ...
 */
@Slf4j
public class Idea74252Service {
    private static final int IDEA_ID = 74252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74252Service() {
        this(new Idea74252Config());
    }

    public Idea74252Service(Idea74252Config config) {
        this.config = config != null ? config : new Idea74252Config();
