...
@Data
public class Idea74232Config {
    private String name = "idea_074232";
 ...
 */
@Slf4j
public class Idea74232Service {
    private static final int IDEA_ID = 74232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74232Service() {
        this(new Idea74232Config());
    }

    public Idea74232Service(Idea74232Config config) {
        this.config = config != null ? config : new Idea74232Config();
