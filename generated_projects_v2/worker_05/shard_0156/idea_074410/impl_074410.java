...
@Data
public class Idea74410Config {
    private String name = "idea_074410";
 ...
 */
@Slf4j
public class Idea74410Service {
    private static final int IDEA_ID = 74410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74410Service() {
        this(new Idea74410Config());
    }

    public Idea74410Service(Idea74410Config config) {
        this.config = config != null ? config : new Idea74410Config();
