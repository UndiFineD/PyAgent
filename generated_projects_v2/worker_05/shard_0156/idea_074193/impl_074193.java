...
@Data
public class Idea74193Config {
    private String name = "idea_074193";
 ...
 */
@Slf4j
public class Idea74193Service {
    private static final int IDEA_ID = 74193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74193Service() {
        this(new Idea74193Config());
    }

    public Idea74193Service(Idea74193Config config) {
        this.config = config != null ? config : new Idea74193Config();
