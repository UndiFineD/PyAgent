...
@Data
public class Idea74165Config {
    private String name = "idea_074165";
 ...
 */
@Slf4j
public class Idea74165Service {
    private static final int IDEA_ID = 74165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74165Service() {
        this(new Idea74165Config());
    }

    public Idea74165Service(Idea74165Config config) {
        this.config = config != null ? config : new Idea74165Config();
