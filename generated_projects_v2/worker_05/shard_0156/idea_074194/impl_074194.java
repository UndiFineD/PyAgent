...
@Data
public class Idea74194Config {
    private String name = "idea_074194";
 ...
 */
@Slf4j
public class Idea74194Service {
    private static final int IDEA_ID = 74194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74194Service() {
        this(new Idea74194Config());
    }

    public Idea74194Service(Idea74194Config config) {
        this.config = config != null ? config : new Idea74194Config();
