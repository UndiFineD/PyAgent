...
@Data
public class Idea74371Config {
    private String name = "idea_074371";
 ...
 */
@Slf4j
public class Idea74371Service {
    private static final int IDEA_ID = 74371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74371Service() {
        this(new Idea74371Config());
    }

    public Idea74371Service(Idea74371Config config) {
        this.config = config != null ? config : new Idea74371Config();
