...
@Data
public class Idea74290Config {
    private String name = "idea_074290";
 ...
 */
@Slf4j
public class Idea74290Service {
    private static final int IDEA_ID = 74290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74290Service() {
        this(new Idea74290Config());
    }

    public Idea74290Service(Idea74290Config config) {
        this.config = config != null ? config : new Idea74290Config();
