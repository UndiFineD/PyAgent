...
@Data
public class Idea74564Config {
    private String name = "idea_074564";
 ...
 */
@Slf4j
public class Idea74564Service {
    private static final int IDEA_ID = 74564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74564Service() {
        this(new Idea74564Config());
    }

    public Idea74564Service(Idea74564Config config) {
        this.config = config != null ? config : new Idea74564Config();
