...
@Data
public class Idea74437Config {
    private String name = "idea_074437";
 ...
 */
@Slf4j
public class Idea74437Service {
    private static final int IDEA_ID = 74437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74437Service() {
        this(new Idea74437Config());
    }

    public Idea74437Service(Idea74437Config config) {
        this.config = config != null ? config : new Idea74437Config();
