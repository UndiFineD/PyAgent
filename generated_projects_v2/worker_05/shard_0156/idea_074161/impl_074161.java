...
@Data
public class Idea74161Config {
    private String name = "idea_074161";
 ...
 */
@Slf4j
public class Idea74161Service {
    private static final int IDEA_ID = 74161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74161Service() {
        this(new Idea74161Config());
    }

    public Idea74161Service(Idea74161Config config) {
        this.config = config != null ? config : new Idea74161Config();
