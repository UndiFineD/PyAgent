...
@Data
public class Idea74313Config {
    private String name = "idea_074313";
 ...
 */
@Slf4j
public class Idea74313Service {
    private static final int IDEA_ID = 74313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74313Service() {
        this(new Idea74313Config());
    }

    public Idea74313Service(Idea74313Config config) {
        this.config = config != null ? config : new Idea74313Config();
