...
@Data
public class Idea74207Config {
    private String name = "idea_074207";
 ...
 */
@Slf4j
public class Idea74207Service {
    private static final int IDEA_ID = 74207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74207Service() {
        this(new Idea74207Config());
    }

    public Idea74207Service(Idea74207Config config) {
        this.config = config != null ? config : new Idea74207Config();
