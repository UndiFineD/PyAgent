...
@Data
public class Idea74113Config {
    private String name = "idea_074113";
 ...
 */
@Slf4j
public class Idea74113Service {
    private static final int IDEA_ID = 74113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74113Service() {
        this(new Idea74113Config());
    }

    public Idea74113Service(Idea74113Config config) {
        this.config = config != null ? config : new Idea74113Config();
