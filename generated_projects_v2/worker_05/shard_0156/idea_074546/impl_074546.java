...
@Data
public class Idea74546Config {
    private String name = "idea_074546";
 ...
 */
@Slf4j
public class Idea74546Service {
    private static final int IDEA_ID = 74546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74546Service() {
        this(new Idea74546Config());
    }

    public Idea74546Service(Idea74546Config config) {
        this.config = config != null ? config : new Idea74546Config();
