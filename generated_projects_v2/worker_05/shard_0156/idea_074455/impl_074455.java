...
@Data
public class Idea74455Config {
    private String name = "idea_074455";
 ...
 */
@Slf4j
public class Idea74455Service {
    private static final int IDEA_ID = 74455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74455Service() {
        this(new Idea74455Config());
    }

    public Idea74455Service(Idea74455Config config) {
        this.config = config != null ? config : new Idea74455Config();
