...
@Data
public class Idea74128Config {
    private String name = "idea_074128";
 ...
 */
@Slf4j
public class Idea74128Service {
    private static final int IDEA_ID = 74128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74128Service() {
        this(new Idea74128Config());
    }

    public Idea74128Service(Idea74128Config config) {
        this.config = config != null ? config : new Idea74128Config();
