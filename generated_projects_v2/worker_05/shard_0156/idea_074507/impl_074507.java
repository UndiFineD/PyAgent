...
@Data
public class Idea74507Config {
    private String name = "idea_074507";
 ...
 */
@Slf4j
public class Idea74507Service {
    private static final int IDEA_ID = 74507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74507Service() {
        this(new Idea74507Config());
    }

    public Idea74507Service(Idea74507Config config) {
        this.config = config != null ? config : new Idea74507Config();
