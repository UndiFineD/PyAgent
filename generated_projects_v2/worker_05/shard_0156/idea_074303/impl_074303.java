...
@Data
public class Idea74303Config {
    private String name = "idea_074303";
 ...
 */
@Slf4j
public class Idea74303Service {
    private static final int IDEA_ID = 74303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74303Service() {
        this(new Idea74303Config());
    }

    public Idea74303Service(Idea74303Config config) {
        this.config = config != null ? config : new Idea74303Config();
