...
@Data
public class Idea74338Config {
    private String name = "idea_074338";
 ...
 */
@Slf4j
public class Idea74338Service {
    private static final int IDEA_ID = 74338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74338Service() {
        this(new Idea74338Config());
    }

    public Idea74338Service(Idea74338Config config) {
        this.config = config != null ? config : new Idea74338Config();
