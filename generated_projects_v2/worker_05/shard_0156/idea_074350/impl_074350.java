...
@Data
public class Idea74350Config {
    private String name = "idea_074350";
 ...
 */
@Slf4j
public class Idea74350Service {
    private static final int IDEA_ID = 74350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74350Service() {
        this(new Idea74350Config());
    }

    public Idea74350Service(Idea74350Config config) {
        this.config = config != null ? config : new Idea74350Config();
