...
@Data
public class Idea74497Config {
    private String name = "idea_074497";
 ...
 */
@Slf4j
public class Idea74497Service {
    private static final int IDEA_ID = 74497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74497Service() {
        this(new Idea74497Config());
    }

    public Idea74497Service(Idea74497Config config) {
        this.config = config != null ? config : new Idea74497Config();
