...
@Data
public class Idea74211Config {
    private String name = "idea_074211";
 ...
 */
@Slf4j
public class Idea74211Service {
    private static final int IDEA_ID = 74211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74211Service() {
        this(new Idea74211Config());
    }

    public Idea74211Service(Idea74211Config config) {
        this.config = config != null ? config : new Idea74211Config();
