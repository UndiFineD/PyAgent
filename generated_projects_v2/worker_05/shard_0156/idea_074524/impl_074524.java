...
@Data
public class Idea74524Config {
    private String name = "idea_074524";
 ...
 */
@Slf4j
public class Idea74524Service {
    private static final int IDEA_ID = 74524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74524Service() {
        this(new Idea74524Config());
    }

    public Idea74524Service(Idea74524Config config) {
        this.config = config != null ? config : new Idea74524Config();
