...
@Data
public class Idea74569Config {
    private String name = "idea_074569";
 ...
 */
@Slf4j
public class Idea74569Service {
    private static final int IDEA_ID = 74569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74569Service() {
        this(new Idea74569Config());
    }

    public Idea74569Service(Idea74569Config config) {
        this.config = config != null ? config : new Idea74569Config();
