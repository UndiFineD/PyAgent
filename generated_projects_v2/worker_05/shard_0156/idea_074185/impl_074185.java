...
@Data
public class Idea74185Config {
    private String name = "idea_074185";
 ...
 */
@Slf4j
public class Idea74185Service {
    private static final int IDEA_ID = 74185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74185Service() {
        this(new Idea74185Config());
    }

    public Idea74185Service(Idea74185Config config) {
        this.config = config != null ? config : new Idea74185Config();
