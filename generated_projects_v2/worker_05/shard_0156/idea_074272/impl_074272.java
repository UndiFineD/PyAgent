...
@Data
public class Idea74272Config {
    private String name = "idea_074272";
 ...
 */
@Slf4j
public class Idea74272Service {
    private static final int IDEA_ID = 74272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74272Service() {
        this(new Idea74272Config());
    }

    public Idea74272Service(Idea74272Config config) {
        this.config = config != null ? config : new Idea74272Config();
