...
@Data
public class Idea74255Config {
    private String name = "idea_074255";
 ...
 */
@Slf4j
public class Idea74255Service {
    private static final int IDEA_ID = 74255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74255Service() {
        this(new Idea74255Config());
    }

    public Idea74255Service(Idea74255Config config) {
        this.config = config != null ? config : new Idea74255Config();
