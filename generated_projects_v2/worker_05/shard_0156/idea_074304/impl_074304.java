...
@Data
public class Idea74304Config {
    private String name = "idea_074304";
 ...
 */
@Slf4j
public class Idea74304Service {
    private static final int IDEA_ID = 74304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74304Service() {
        this(new Idea74304Config());
    }

    public Idea74304Service(Idea74304Config config) {
        this.config = config != null ? config : new Idea74304Config();
