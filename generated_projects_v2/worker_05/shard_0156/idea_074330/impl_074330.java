...
@Data
public class Idea74330Config {
    private String name = "idea_074330";
 ...
 */
@Slf4j
public class Idea74330Service {
    private static final int IDEA_ID = 74330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74330Service() {
        this(new Idea74330Config());
    }

    public Idea74330Service(Idea74330Config config) {
        this.config = config != null ? config : new Idea74330Config();
