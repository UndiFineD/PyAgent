...
@Data
public class Idea74560Config {
    private String name = "idea_074560";
 ...
 */
@Slf4j
public class Idea74560Service {
    private static final int IDEA_ID = 74560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74560Service() {
        this(new Idea74560Config());
    }

    public Idea74560Service(Idea74560Config config) {
        this.config = config != null ? config : new Idea74560Config();
