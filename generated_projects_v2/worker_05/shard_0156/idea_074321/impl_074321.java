...
@Data
public class Idea74321Config {
    private String name = "idea_074321";
 ...
 */
@Slf4j
public class Idea74321Service {
    private static final int IDEA_ID = 74321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74321Service() {
        this(new Idea74321Config());
    }

    public Idea74321Service(Idea74321Config config) {
        this.config = config != null ? config : new Idea74321Config();
