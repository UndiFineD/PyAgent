...
@Data
public class Idea74172Config {
    private String name = "idea_074172";
 ...
 */
@Slf4j
public class Idea74172Service {
    private static final int IDEA_ID = 74172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74172Service() {
        this(new Idea74172Config());
    }

    public Idea74172Service(Idea74172Config config) {
        this.config = config != null ? config : new Idea74172Config();
