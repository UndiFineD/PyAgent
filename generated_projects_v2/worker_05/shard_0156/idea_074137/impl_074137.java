...
@Data
public class Idea74137Config {
    private String name = "idea_074137";
 ...
 */
@Slf4j
public class Idea74137Service {
    private static final int IDEA_ID = 74137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74137Service() {
        this(new Idea74137Config());
    }

    public Idea74137Service(Idea74137Config config) {
        this.config = config != null ? config : new Idea74137Config();
