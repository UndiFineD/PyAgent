...
@Data
public class Idea74293Config {
    private String name = "idea_074293";
 ...
 */
@Slf4j
public class Idea74293Service {
    private static final int IDEA_ID = 74293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74293Service() {
        this(new Idea74293Config());
    }

    public Idea74293Service(Idea74293Config config) {
        this.config = config != null ? config : new Idea74293Config();
