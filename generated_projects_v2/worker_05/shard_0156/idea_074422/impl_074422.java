...
@Data
public class Idea74422Config {
    private String name = "idea_074422";
 ...
 */
@Slf4j
public class Idea74422Service {
    private static final int IDEA_ID = 74422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74422Service() {
        this(new Idea74422Config());
    }

    public Idea74422Service(Idea74422Config config) {
        this.config = config != null ? config : new Idea74422Config();
