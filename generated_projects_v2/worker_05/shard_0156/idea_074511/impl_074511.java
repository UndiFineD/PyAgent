...
@Data
public class Idea74511Config {
    private String name = "idea_074511";
 ...
 */
@Slf4j
public class Idea74511Service {
    private static final int IDEA_ID = 74511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74511Service() {
        this(new Idea74511Config());
    }

    public Idea74511Service(Idea74511Config config) {
        this.config = config != null ? config : new Idea74511Config();
