...
@Data
public class Idea74551Config {
    private String name = "idea_074551";
 ...
 */
@Slf4j
public class Idea74551Service {
    private static final int IDEA_ID = 74551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74551Service() {
        this(new Idea74551Config());
    }

    public Idea74551Service(Idea74551Config config) {
        this.config = config != null ? config : new Idea74551Config();
