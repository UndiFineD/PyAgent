...
@Data
public class Idea74506Config {
    private String name = "idea_074506";
 ...
 */
@Slf4j
public class Idea74506Service {
    private static final int IDEA_ID = 74506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74506Service() {
        this(new Idea74506Config());
    }

    public Idea74506Service(Idea74506Config config) {
        this.config = config != null ? config : new Idea74506Config();
