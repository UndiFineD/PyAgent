...
@Data
public class Idea74393Config {
    private String name = "idea_074393";
 ...
 */
@Slf4j
public class Idea74393Service {
    private static final int IDEA_ID = 74393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74393Service() {
        this(new Idea74393Config());
    }

    public Idea74393Service(Idea74393Config config) {
        this.config = config != null ? config : new Idea74393Config();
