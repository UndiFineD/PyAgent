...
@Data
public class Idea74355Config {
    private String name = "idea_074355";
 ...
 */
@Slf4j
public class Idea74355Service {
    private static final int IDEA_ID = 74355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74355Service() {
        this(new Idea74355Config());
    }

    public Idea74355Service(Idea74355Config config) {
        this.config = config != null ? config : new Idea74355Config();
