...
@Data
public class Idea74465Config {
    private String name = "idea_074465";
 ...
 */
@Slf4j
public class Idea74465Service {
    private static final int IDEA_ID = 74465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74465Service() {
        this(new Idea74465Config());
    }

    public Idea74465Service(Idea74465Config config) {
        this.config = config != null ? config : new Idea74465Config();
