...
@Data
public class Idea74145Config {
    private String name = "idea_074145";
 ...
 */
@Slf4j
public class Idea74145Service {
    private static final int IDEA_ID = 74145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74145Service() {
        this(new Idea74145Config());
    }

    public Idea74145Service(Idea74145Config config) {
        this.config = config != null ? config : new Idea74145Config();
