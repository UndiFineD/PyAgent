...
@Data
public class Idea74368Config {
    private String name = "idea_074368";
 ...
 */
@Slf4j
public class Idea74368Service {
    private static final int IDEA_ID = 74368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74368Service() {
        this(new Idea74368Config());
    }

    public Idea74368Service(Idea74368Config config) {
        this.config = config != null ? config : new Idea74368Config();
