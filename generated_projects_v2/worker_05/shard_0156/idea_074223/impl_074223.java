...
@Data
public class Idea74223Config {
    private String name = "idea_074223";
 ...
 */
@Slf4j
public class Idea74223Service {
    private static final int IDEA_ID = 74223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74223Service() {
        this(new Idea74223Config());
    }

    public Idea74223Service(Idea74223Config config) {
        this.config = config != null ? config : new Idea74223Config();
