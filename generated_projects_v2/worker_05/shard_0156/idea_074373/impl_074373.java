...
@Data
public class Idea74373Config {
    private String name = "idea_074373";
 ...
 */
@Slf4j
public class Idea74373Service {
    private static final int IDEA_ID = 74373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74373Service() {
        this(new Idea74373Config());
    }

    public Idea74373Service(Idea74373Config config) {
        this.config = config != null ? config : new Idea74373Config();
