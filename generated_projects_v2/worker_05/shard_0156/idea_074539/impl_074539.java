...
@Data
public class Idea74539Config {
    private String name = "idea_074539";
 ...
 */
@Slf4j
public class Idea74539Service {
    private static final int IDEA_ID = 74539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74539Service() {
        this(new Idea74539Config());
    }

    public Idea74539Service(Idea74539Config config) {
        this.config = config != null ? config : new Idea74539Config();
