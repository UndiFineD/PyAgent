...
@Data
public class Idea74233Config {
    private String name = "idea_074233";
 ...
 */
@Slf4j
public class Idea74233Service {
    private static final int IDEA_ID = 74233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74233Service() {
        this(new Idea74233Config());
    }

    public Idea74233Service(Idea74233Config config) {
        this.config = config != null ? config : new Idea74233Config();
