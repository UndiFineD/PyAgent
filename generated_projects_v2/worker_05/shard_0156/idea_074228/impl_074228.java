...
@Data
public class Idea74228Config {
    private String name = "idea_074228";
 ...
 */
@Slf4j
public class Idea74228Service {
    private static final int IDEA_ID = 74228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74228Service() {
        this(new Idea74228Config());
    }

    public Idea74228Service(Idea74228Config config) {
        this.config = config != null ? config : new Idea74228Config();
