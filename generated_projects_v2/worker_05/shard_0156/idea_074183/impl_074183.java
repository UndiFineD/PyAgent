...
@Data
public class Idea74183Config {
    private String name = "idea_074183";
 ...
 */
@Slf4j
public class Idea74183Service {
    private static final int IDEA_ID = 74183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74183Service() {
        this(new Idea74183Config());
    }

    public Idea74183Service(Idea74183Config config) {
        this.config = config != null ? config : new Idea74183Config();
