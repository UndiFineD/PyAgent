...
@Data
public class Idea74122Config {
    private String name = "idea_074122";
 ...
 */
@Slf4j
public class Idea74122Service {
    private static final int IDEA_ID = 74122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74122Service() {
        this(new Idea74122Config());
    }

    public Idea74122Service(Idea74122Config config) {
        this.config = config != null ? config : new Idea74122Config();
