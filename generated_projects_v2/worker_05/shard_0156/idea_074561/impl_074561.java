...
@Data
public class Idea74561Config {
    private String name = "idea_074561";
 ...
 */
@Slf4j
public class Idea74561Service {
    private static final int IDEA_ID = 74561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74561Service() {
        this(new Idea74561Config());
    }

    public Idea74561Service(Idea74561Config config) {
        this.config = config != null ? config : new Idea74561Config();
