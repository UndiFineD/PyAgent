...
@Data
public class Idea74462Config {
    private String name = "idea_074462";
 ...
 */
@Slf4j
public class Idea74462Service {
    private static final int IDEA_ID = 74462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74462Service() {
        this(new Idea74462Config());
    }

    public Idea74462Service(Idea74462Config config) {
        this.config = config != null ? config : new Idea74462Config();
