...
@Data
public class Idea74493Config {
    private String name = "idea_074493";
 ...
 */
@Slf4j
public class Idea74493Service {
    private static final int IDEA_ID = 74493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74493Service() {
        this(new Idea74493Config());
    }

    public Idea74493Service(Idea74493Config config) {
        this.config = config != null ? config : new Idea74493Config();
