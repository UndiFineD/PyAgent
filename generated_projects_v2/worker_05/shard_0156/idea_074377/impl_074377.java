...
@Data
public class Idea74377Config {
    private String name = "idea_074377";
 ...
 */
@Slf4j
public class Idea74377Service {
    private static final int IDEA_ID = 74377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74377Service() {
        this(new Idea74377Config());
    }

    public Idea74377Service(Idea74377Config config) {
        this.config = config != null ? config : new Idea74377Config();
