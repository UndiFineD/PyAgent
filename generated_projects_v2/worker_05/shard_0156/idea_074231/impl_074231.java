...
@Data
public class Idea74231Config {
    private String name = "idea_074231";
 ...
 */
@Slf4j
public class Idea74231Service {
    private static final int IDEA_ID = 74231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74231Service() {
        this(new Idea74231Config());
    }

    public Idea74231Service(Idea74231Config config) {
        this.config = config != null ? config : new Idea74231Config();
