...
@Data
public class Idea74106Config {
    private String name = "idea_074106";
 ...
 */
@Slf4j
public class Idea74106Service {
    private static final int IDEA_ID = 74106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74106Service() {
        this(new Idea74106Config());
    }

    public Idea74106Service(Idea74106Config config) {
        this.config = config != null ? config : new Idea74106Config();
