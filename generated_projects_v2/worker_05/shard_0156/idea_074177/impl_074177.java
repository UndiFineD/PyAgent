...
@Data
public class Idea74177Config {
    private String name = "idea_074177";
 ...
 */
@Slf4j
public class Idea74177Service {
    private static final int IDEA_ID = 74177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74177Service() {
        this(new Idea74177Config());
    }

    public Idea74177Service(Idea74177Config config) {
        this.config = config != null ? config : new Idea74177Config();
