...
@Data
public class Idea74417Config {
    private String name = "idea_074417";
 ...
 */
@Slf4j
public class Idea74417Service {
    private static final int IDEA_ID = 74417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74417Service() {
        this(new Idea74417Config());
    }

    public Idea74417Service(Idea74417Config config) {
        this.config = config != null ? config : new Idea74417Config();
