...
@Data
public class Idea74531Config {
    private String name = "idea_074531";
 ...
 */
@Slf4j
public class Idea74531Service {
    private static final int IDEA_ID = 74531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74531Service() {
        this(new Idea74531Config());
    }

    public Idea74531Service(Idea74531Config config) {
        this.config = config != null ? config : new Idea74531Config();
