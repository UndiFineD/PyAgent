...
@Data
public class Idea74537Config {
    private String name = "idea_074537";
 ...
 */
@Slf4j
public class Idea74537Service {
    private static final int IDEA_ID = 74537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74537Service() {
        this(new Idea74537Config());
    }

    public Idea74537Service(Idea74537Config config) {
        this.config = config != null ? config : new Idea74537Config();
