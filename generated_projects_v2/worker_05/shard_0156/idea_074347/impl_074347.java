...
@Data
public class Idea74347Config {
    private String name = "idea_074347";
 ...
 */
@Slf4j
public class Idea74347Service {
    private static final int IDEA_ID = 74347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74347Service() {
        this(new Idea74347Config());
    }

    public Idea74347Service(Idea74347Config config) {
        this.config = config != null ? config : new Idea74347Config();
