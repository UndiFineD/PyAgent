...
@Data
public class Idea74173Config {
    private String name = "idea_074173";
 ...
 */
@Slf4j
public class Idea74173Service {
    private static final int IDEA_ID = 74173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74173Service() {
        this(new Idea74173Config());
    }

    public Idea74173Service(Idea74173Config config) {
        this.config = config != null ? config : new Idea74173Config();
