...
@Data
public class Idea74367Config {
    private String name = "idea_074367";
 ...
 */
@Slf4j
public class Idea74367Service {
    private static final int IDEA_ID = 74367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74367Service() {
        this(new Idea74367Config());
    }

    public Idea74367Service(Idea74367Config config) {
        this.config = config != null ? config : new Idea74367Config();
