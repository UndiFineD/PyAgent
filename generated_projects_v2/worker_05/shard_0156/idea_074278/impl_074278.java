...
@Data
public class Idea74278Config {
    private String name = "idea_074278";
 ...
 */
@Slf4j
public class Idea74278Service {
    private static final int IDEA_ID = 74278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74278Service() {
        this(new Idea74278Config());
    }

    public Idea74278Service(Idea74278Config config) {
        this.config = config != null ? config : new Idea74278Config();
