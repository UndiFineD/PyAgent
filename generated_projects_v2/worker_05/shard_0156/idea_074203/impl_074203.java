...
@Data
public class Idea74203Config {
    private String name = "idea_074203";
 ...
 */
@Slf4j
public class Idea74203Service {
    private static final int IDEA_ID = 74203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74203Service() {
        this(new Idea74203Config());
    }

    public Idea74203Service(Idea74203Config config) {
        this.config = config != null ? config : new Idea74203Config();
