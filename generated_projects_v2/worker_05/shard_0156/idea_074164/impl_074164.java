...
@Data
public class Idea74164Config {
    private String name = "idea_074164";
 ...
 */
@Slf4j
public class Idea74164Service {
    private static final int IDEA_ID = 74164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74164Service() {
        this(new Idea74164Config());
    }

    public Idea74164Service(Idea74164Config config) {
        this.config = config != null ? config : new Idea74164Config();
