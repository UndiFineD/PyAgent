...
@Data
public class Idea74346Config {
    private String name = "idea_074346";
 ...
 */
@Slf4j
public class Idea74346Service {
    private static final int IDEA_ID = 74346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74346Service() {
        this(new Idea74346Config());
    }

    public Idea74346Service(Idea74346Config config) {
        this.config = config != null ? config : new Idea74346Config();
