...
@Data
public class Idea74565Config {
    private String name = "idea_074565";
 ...
 */
@Slf4j
public class Idea74565Service {
    private static final int IDEA_ID = 74565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74565Service() {
        this(new Idea74565Config());
    }

    public Idea74565Service(Idea74565Config config) {
        this.config = config != null ? config : new Idea74565Config();
