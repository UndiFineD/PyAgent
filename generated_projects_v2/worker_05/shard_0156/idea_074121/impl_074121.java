...
@Data
public class Idea74121Config {
    private String name = "idea_074121";
 ...
 */
@Slf4j
public class Idea74121Service {
    private static final int IDEA_ID = 74121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74121Service() {
        this(new Idea74121Config());
    }

    public Idea74121Service(Idea74121Config config) {
        this.config = config != null ? config : new Idea74121Config();
