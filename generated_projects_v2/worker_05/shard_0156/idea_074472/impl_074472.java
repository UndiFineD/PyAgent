...
@Data
public class Idea74472Config {
    private String name = "idea_074472";
 ...
 */
@Slf4j
public class Idea74472Service {
    private static final int IDEA_ID = 74472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74472Service() {
        this(new Idea74472Config());
    }

    public Idea74472Service(Idea74472Config config) {
        this.config = config != null ? config : new Idea74472Config();
