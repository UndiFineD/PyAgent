...
@Data
public class Idea74271Config {
    private String name = "idea_074271";
 ...
 */
@Slf4j
public class Idea74271Service {
    private static final int IDEA_ID = 74271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74271Service() {
        this(new Idea74271Config());
    }

    public Idea74271Service(Idea74271Config config) {
        this.config = config != null ? config : new Idea74271Config();
