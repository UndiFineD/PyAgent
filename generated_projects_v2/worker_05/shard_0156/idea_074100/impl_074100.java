...
@Data
public class Idea74100Config {
    private String name = "idea_074100";
 ...
 */
@Slf4j
public class Idea74100Service {
    private static final int IDEA_ID = 74100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74100Service() {
        this(new Idea74100Config());
    }

    public Idea74100Service(Idea74100Config config) {
        this.config = config != null ? config : new Idea74100Config();
