...
@Data
public class Idea74133Config {
    private String name = "idea_074133";
 ...
 */
@Slf4j
public class Idea74133Service {
    private static final int IDEA_ID = 74133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74133Service() {
        this(new Idea74133Config());
    }

    public Idea74133Service(Idea74133Config config) {
        this.config = config != null ? config : new Idea74133Config();
