...
@Data
public class Idea74510Config {
    private String name = "idea_074510";
 ...
 */
@Slf4j
public class Idea74510Service {
    private static final int IDEA_ID = 74510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74510Service() {
        this(new Idea74510Config());
    }

    public Idea74510Service(Idea74510Config config) {
        this.config = config != null ? config : new Idea74510Config();
