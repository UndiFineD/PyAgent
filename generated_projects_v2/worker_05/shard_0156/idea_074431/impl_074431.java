...
@Data
public class Idea74431Config {
    private String name = "idea_074431";
 ...
 */
@Slf4j
public class Idea74431Service {
    private static final int IDEA_ID = 74431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74431Service() {
        this(new Idea74431Config());
    }

    public Idea74431Service(Idea74431Config config) {
        this.config = config != null ? config : new Idea74431Config();
