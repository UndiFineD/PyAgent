...
@Data
public class Idea74357Config {
    private String name = "idea_074357";
 ...
 */
@Slf4j
public class Idea74357Service {
    private static final int IDEA_ID = 74357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74357Service() {
        this(new Idea74357Config());
    }

    public Idea74357Service(Idea74357Config config) {
        this.config = config != null ? config : new Idea74357Config();
