...
@Data
public class Idea74213Config {
    private String name = "idea_074213";
 ...
 */
@Slf4j
public class Idea74213Service {
    private static final int IDEA_ID = 74213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74213Service() {
        this(new Idea74213Config());
    }

    public Idea74213Service(Idea74213Config config) {
        this.config = config != null ? config : new Idea74213Config();
