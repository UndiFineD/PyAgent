...
@Data
public class Idea74149Config {
    private String name = "idea_074149";
 ...
 */
@Slf4j
public class Idea74149Service {
    private static final int IDEA_ID = 74149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74149Service() {
        this(new Idea74149Config());
    }

    public Idea74149Service(Idea74149Config config) {
        this.config = config != null ? config : new Idea74149Config();
