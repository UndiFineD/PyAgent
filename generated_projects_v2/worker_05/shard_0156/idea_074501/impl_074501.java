...
@Data
public class Idea74501Config {
    private String name = "idea_074501";
 ...
 */
@Slf4j
public class Idea74501Service {
    private static final int IDEA_ID = 74501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74501Service() {
        this(new Idea74501Config());
    }

    public Idea74501Service(Idea74501Config config) {
        this.config = config != null ? config : new Idea74501Config();
