...
@Data
public class Idea74414Config {
    private String name = "idea_074414";
 ...
 */
@Slf4j
public class Idea74414Service {
    private static final int IDEA_ID = 74414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74414Service() {
        this(new Idea74414Config());
    }

    public Idea74414Service(Idea74414Config config) {
        this.config = config != null ? config : new Idea74414Config();
