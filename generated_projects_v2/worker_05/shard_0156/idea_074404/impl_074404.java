...
@Data
public class Idea74404Config {
    private String name = "idea_074404";
 ...
 */
@Slf4j
public class Idea74404Service {
    private static final int IDEA_ID = 74404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74404Service() {
        this(new Idea74404Config());
    }

    public Idea74404Service(Idea74404Config config) {
        this.config = config != null ? config : new Idea74404Config();
