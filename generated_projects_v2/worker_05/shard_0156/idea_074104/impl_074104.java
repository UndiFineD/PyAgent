...
@Data
public class Idea74104Config {
    private String name = "idea_074104";
 ...
 */
@Slf4j
public class Idea74104Service {
    private static final int IDEA_ID = 74104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74104Service() {
        this(new Idea74104Config());
    }

    public Idea74104Service(Idea74104Config config) {
        this.config = config != null ? config : new Idea74104Config();
