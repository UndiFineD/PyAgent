...
@Data
public class Idea74142Config {
    private String name = "idea_074142";
 ...
 */
@Slf4j
public class Idea74142Service {
    private static final int IDEA_ID = 74142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74142Service() {
        this(new Idea74142Config());
    }

    public Idea74142Service(Idea74142Config config) {
        this.config = config != null ? config : new Idea74142Config();
