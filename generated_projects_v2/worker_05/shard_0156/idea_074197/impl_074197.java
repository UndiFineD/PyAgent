...
@Data
public class Idea74197Config {
    private String name = "idea_074197";
 ...
 */
@Slf4j
public class Idea74197Service {
    private static final int IDEA_ID = 74197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74197Service() {
        this(new Idea74197Config());
    }

    public Idea74197Service(Idea74197Config config) {
        this.config = config != null ? config : new Idea74197Config();
