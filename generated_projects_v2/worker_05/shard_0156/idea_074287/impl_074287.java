...
@Data
public class Idea74287Config {
    private String name = "idea_074287";
 ...
 */
@Slf4j
public class Idea74287Service {
    private static final int IDEA_ID = 74287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74287Service() {
        this(new Idea74287Config());
    }

    public Idea74287Service(Idea74287Config config) {
        this.config = config != null ? config : new Idea74287Config();
