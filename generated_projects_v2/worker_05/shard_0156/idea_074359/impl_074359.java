...
@Data
public class Idea74359Config {
    private String name = "idea_074359";
 ...
 */
@Slf4j
public class Idea74359Service {
    private static final int IDEA_ID = 74359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74359Service() {
        this(new Idea74359Config());
    }

    public Idea74359Service(Idea74359Config config) {
        this.config = config != null ? config : new Idea74359Config();
