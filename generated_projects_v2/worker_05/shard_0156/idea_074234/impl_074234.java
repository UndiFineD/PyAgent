...
@Data
public class Idea74234Config {
    private String name = "idea_074234";
 ...
 */
@Slf4j
public class Idea74234Service {
    private static final int IDEA_ID = 74234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74234Service() {
        this(new Idea74234Config());
    }

    public Idea74234Service(Idea74234Config config) {
        this.config = config != null ? config : new Idea74234Config();
