...
@Data
public class Idea74116Config {
    private String name = "idea_074116";
 ...
 */
@Slf4j
public class Idea74116Service {
    private static final int IDEA_ID = 74116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74116Service() {
        this(new Idea74116Config());
    }

    public Idea74116Service(Idea74116Config config) {
        this.config = config != null ? config : new Idea74116Config();
