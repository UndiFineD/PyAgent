...
@Data
public class Idea74383Config {
    private String name = "idea_074383";
 ...
 */
@Slf4j
public class Idea74383Service {
    private static final int IDEA_ID = 74383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74383Service() {
        this(new Idea74383Config());
    }

    public Idea74383Service(Idea74383Config config) {
        this.config = config != null ? config : new Idea74383Config();
