...
@Data
public class Idea74291Config {
    private String name = "idea_074291";
 ...
 */
@Slf4j
public class Idea74291Service {
    private static final int IDEA_ID = 74291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74291Service() {
        this(new Idea74291Config());
    }

    public Idea74291Service(Idea74291Config config) {
        this.config = config != null ? config : new Idea74291Config();
