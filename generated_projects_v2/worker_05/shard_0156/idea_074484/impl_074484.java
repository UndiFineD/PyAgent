...
@Data
public class Idea74484Config {
    private String name = "idea_074484";
 ...
 */
@Slf4j
public class Idea74484Service {
    private static final int IDEA_ID = 74484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74484Service() {
        this(new Idea74484Config());
    }

    public Idea74484Service(Idea74484Config config) {
        this.config = config != null ? config : new Idea74484Config();
