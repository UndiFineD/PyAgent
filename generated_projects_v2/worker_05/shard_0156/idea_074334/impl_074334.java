...
@Data
public class Idea74334Config {
    private String name = "idea_074334";
 ...
 */
@Slf4j
public class Idea74334Service {
    private static final int IDEA_ID = 74334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74334Service() {
        this(new Idea74334Config());
    }

    public Idea74334Service(Idea74334Config config) {
        this.config = config != null ? config : new Idea74334Config();
