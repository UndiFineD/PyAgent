...
@Data
public class Idea74210Config {
    private String name = "idea_074210";
 ...
 */
@Slf4j
public class Idea74210Service {
    private static final int IDEA_ID = 74210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74210Service() {
        this(new Idea74210Config());
    }

    public Idea74210Service(Idea74210Config config) {
        this.config = config != null ? config : new Idea74210Config();
