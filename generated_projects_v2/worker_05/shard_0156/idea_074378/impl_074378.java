...
@Data
public class Idea74378Config {
    private String name = "idea_074378";
 ...
 */
@Slf4j
public class Idea74378Service {
    private static final int IDEA_ID = 74378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74378Service() {
        this(new Idea74378Config());
    }

    public Idea74378Service(Idea74378Config config) {
        this.config = config != null ? config : new Idea74378Config();
