...
@Data
public class Idea74562Config {
    private String name = "idea_074562";
 ...
 */
@Slf4j
public class Idea74562Service {
    private static final int IDEA_ID = 74562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74562Service() {
        this(new Idea74562Config());
    }

    public Idea74562Service(Idea74562Config config) {
        this.config = config != null ? config : new Idea74562Config();
