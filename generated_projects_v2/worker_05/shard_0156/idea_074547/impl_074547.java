...
@Data
public class Idea74547Config {
    private String name = "idea_074547";
 ...
 */
@Slf4j
public class Idea74547Service {
    private static final int IDEA_ID = 74547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74547Service() {
        this(new Idea74547Config());
    }

    public Idea74547Service(Idea74547Config config) {
        this.config = config != null ? config : new Idea74547Config();
