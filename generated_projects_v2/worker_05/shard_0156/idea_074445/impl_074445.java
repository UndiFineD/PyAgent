...
@Data
public class Idea74445Config {
    private String name = "idea_074445";
 ...
 */
@Slf4j
public class Idea74445Service {
    private static final int IDEA_ID = 74445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74445Service() {
        this(new Idea74445Config());
    }

    public Idea74445Service(Idea74445Config config) {
        this.config = config != null ? config : new Idea74445Config();
