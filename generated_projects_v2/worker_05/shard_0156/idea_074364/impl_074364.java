...
@Data
public class Idea74364Config {
    private String name = "idea_074364";
 ...
 */
@Slf4j
public class Idea74364Service {
    private static final int IDEA_ID = 74364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74364Service() {
        this(new Idea74364Config());
    }

    public Idea74364Service(Idea74364Config config) {
        this.config = config != null ? config : new Idea74364Config();
