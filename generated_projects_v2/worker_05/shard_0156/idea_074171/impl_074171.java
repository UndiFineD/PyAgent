...
@Data
public class Idea74171Config {
    private String name = "idea_074171";
 ...
 */
@Slf4j
public class Idea74171Service {
    private static final int IDEA_ID = 74171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74171Service() {
        this(new Idea74171Config());
    }

    public Idea74171Service(Idea74171Config config) {
        this.config = config != null ? config : new Idea74171Config();
