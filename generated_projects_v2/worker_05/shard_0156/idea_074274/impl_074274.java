...
@Data
public class Idea74274Config {
    private String name = "idea_074274";
 ...
 */
@Slf4j
public class Idea74274Service {
    private static final int IDEA_ID = 74274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74274Service() {
        this(new Idea74274Config());
    }

    public Idea74274Service(Idea74274Config config) {
        this.config = config != null ? config : new Idea74274Config();
