...
@Data
public class Idea74253Config {
    private String name = "idea_074253";
 ...
 */
@Slf4j
public class Idea74253Service {
    private static final int IDEA_ID = 74253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74253Service() {
        this(new Idea74253Config());
    }

    public Idea74253Service(Idea74253Config config) {
        this.config = config != null ? config : new Idea74253Config();
