...
@Data
public class Idea74360Config {
    private String name = "idea_074360";
 ...
 */
@Slf4j
public class Idea74360Service {
    private static final int IDEA_ID = 74360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74360Service() {
        this(new Idea74360Config());
    }

    public Idea74360Service(Idea74360Config config) {
        this.config = config != null ? config : new Idea74360Config();
