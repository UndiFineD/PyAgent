...
@Data
public class Idea74426Config {
    private String name = "idea_074426";
 ...
 */
@Slf4j
public class Idea74426Service {
    private static final int IDEA_ID = 74426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74426Service() {
        this(new Idea74426Config());
    }

    public Idea74426Service(Idea74426Config config) {
        this.config = config != null ? config : new Idea74426Config();
