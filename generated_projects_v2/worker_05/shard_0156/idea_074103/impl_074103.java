...
@Data
public class Idea74103Config {
    private String name = "idea_074103";
 ...
 */
@Slf4j
public class Idea74103Service {
    private static final int IDEA_ID = 74103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74103Service() {
        this(new Idea74103Config());
    }

    public Idea74103Service(Idea74103Config config) {
        this.config = config != null ? config : new Idea74103Config();
