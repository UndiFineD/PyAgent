...
@Data
public class Idea74491Config {
    private String name = "idea_074491";
 ...
 */
@Slf4j
public class Idea74491Service {
    private static final int IDEA_ID = 74491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74491Service() {
        this(new Idea74491Config());
    }

    public Idea74491Service(Idea74491Config config) {
        this.config = config != null ? config : new Idea74491Config();
