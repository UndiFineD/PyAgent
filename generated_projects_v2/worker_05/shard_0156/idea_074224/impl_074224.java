...
@Data
public class Idea74224Config {
    private String name = "idea_074224";
 ...
 */
@Slf4j
public class Idea74224Service {
    private static final int IDEA_ID = 74224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74224Service() {
        this(new Idea74224Config());
    }

    public Idea74224Service(Idea74224Config config) {
        this.config = config != null ? config : new Idea74224Config();
