...
@Data
public class Idea74369Config {
    private String name = "idea_074369";
 ...
 */
@Slf4j
public class Idea74369Service {
    private static final int IDEA_ID = 74369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74369Service() {
        this(new Idea74369Config());
    }

    public Idea74369Service(Idea74369Config config) {
        this.config = config != null ? config : new Idea74369Config();
