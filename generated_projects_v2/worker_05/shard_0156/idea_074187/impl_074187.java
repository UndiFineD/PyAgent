...
@Data
public class Idea74187Config {
    private String name = "idea_074187";
 ...
 */
@Slf4j
public class Idea74187Service {
    private static final int IDEA_ID = 74187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74187Service() {
        this(new Idea74187Config());
    }

    public Idea74187Service(Idea74187Config config) {
        this.config = config != null ? config : new Idea74187Config();
