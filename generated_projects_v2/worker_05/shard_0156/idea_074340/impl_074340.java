...
@Data
public class Idea74340Config {
    private String name = "idea_074340";
 ...
 */
@Slf4j
public class Idea74340Service {
    private static final int IDEA_ID = 74340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74340Service() {
        this(new Idea74340Config());
    }

    public Idea74340Service(Idea74340Config config) {
        this.config = config != null ? config : new Idea74340Config();
