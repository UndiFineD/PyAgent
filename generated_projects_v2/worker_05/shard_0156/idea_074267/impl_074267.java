...
@Data
public class Idea74267Config {
    private String name = "idea_074267";
 ...
 */
@Slf4j
public class Idea74267Service {
    private static final int IDEA_ID = 74267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74267Service() {
        this(new Idea74267Config());
    }

    public Idea74267Service(Idea74267Config config) {
        this.config = config != null ? config : new Idea74267Config();
