...
@Data
public class Idea74129Config {
    private String name = "idea_074129";
 ...
 */
@Slf4j
public class Idea74129Service {
    private static final int IDEA_ID = 74129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74129Service() {
        this(new Idea74129Config());
    }

    public Idea74129Service(Idea74129Config config) {
        this.config = config != null ? config : new Idea74129Config();
