...
@Data
public class Idea74436Config {
    private String name = "idea_074436";
 ...
 */
@Slf4j
public class Idea74436Service {
    private static final int IDEA_ID = 74436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74436Service() {
        this(new Idea74436Config());
    }

    public Idea74436Service(Idea74436Config config) {
        this.config = config != null ? config : new Idea74436Config();
