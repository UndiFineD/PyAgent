...
@Data
public class Idea74372Config {
    private String name = "idea_074372";
 ...
 */
@Slf4j
public class Idea74372Service {
    private static final int IDEA_ID = 74372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74372Service() {
        this(new Idea74372Config());
    }

    public Idea74372Service(Idea74372Config config) {
        this.config = config != null ? config : new Idea74372Config();
