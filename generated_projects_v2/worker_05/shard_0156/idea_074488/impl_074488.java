...
@Data
public class Idea74488Config {
    private String name = "idea_074488";
 ...
 */
@Slf4j
public class Idea74488Service {
    private static final int IDEA_ID = 74488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74488Service() {
        this(new Idea74488Config());
    }

    public Idea74488Service(Idea74488Config config) {
        this.config = config != null ? config : new Idea74488Config();
