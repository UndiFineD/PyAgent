...
@Data
public class Idea74411Config {
    private String name = "idea_074411";
 ...
 */
@Slf4j
public class Idea74411Service {
    private static final int IDEA_ID = 74411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74411Service() {
        this(new Idea74411Config());
    }

    public Idea74411Service(Idea74411Config config) {
        this.config = config != null ? config : new Idea74411Config();
