...
@Data
public class Idea74297Config {
    private String name = "idea_074297";
 ...
 */
@Slf4j
public class Idea74297Service {
    private static final int IDEA_ID = 74297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74297Service() {
        this(new Idea74297Config());
    }

    public Idea74297Service(Idea74297Config config) {
        this.config = config != null ? config : new Idea74297Config();
