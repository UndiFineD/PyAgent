...
@Data
public class Idea74419Config {
    private String name = "idea_074419";
 ...
 */
@Slf4j
public class Idea74419Service {
    private static final int IDEA_ID = 74419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74419Service() {
        this(new Idea74419Config());
    }

    public Idea74419Service(Idea74419Config config) {
        this.config = config != null ? config : new Idea74419Config();
