...
@Data
public class Idea74324Config {
    private String name = "idea_074324";
 ...
 */
@Slf4j
public class Idea74324Service {
    private static final int IDEA_ID = 74324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74324Service() {
        this(new Idea74324Config());
    }

    public Idea74324Service(Idea74324Config config) {
        this.config = config != null ? config : new Idea74324Config();
