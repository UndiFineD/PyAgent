...
@Data
public class Idea74315Config {
    private String name = "idea_074315";
 ...
 */
@Slf4j
public class Idea74315Service {
    private static final int IDEA_ID = 74315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74315Service() {
        this(new Idea74315Config());
    }

    public Idea74315Service(Idea74315Config config) {
        this.config = config != null ? config : new Idea74315Config();
