...
@Data
public class Idea74541Config {
    private String name = "idea_074541";
 ...
 */
@Slf4j
public class Idea74541Service {
    private static final int IDEA_ID = 74541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74541Service() {
        this(new Idea74541Config());
    }

    public Idea74541Service(Idea74541Config config) {
        this.config = config != null ? config : new Idea74541Config();
