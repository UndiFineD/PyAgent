...
@Data
public class Idea74280Config {
    private String name = "idea_074280";
 ...
 */
@Slf4j
public class Idea74280Service {
    private static final int IDEA_ID = 74280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74280Service() {
        this(new Idea74280Config());
    }

    public Idea74280Service(Idea74280Config config) {
        this.config = config != null ? config : new Idea74280Config();
