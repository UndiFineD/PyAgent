...
@Data
public class Idea74151Config {
    private String name = "idea_074151";
 ...
 */
@Slf4j
public class Idea74151Service {
    private static final int IDEA_ID = 74151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74151Service() {
        this(new Idea74151Config());
    }

    public Idea74151Service(Idea74151Config config) {
        this.config = config != null ? config : new Idea74151Config();
