...
@Data
public class Idea74264Config {
    private String name = "idea_074264";
 ...
 */
@Slf4j
public class Idea74264Service {
    private static final int IDEA_ID = 74264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74264Service() {
        this(new Idea74264Config());
    }

    public Idea74264Service(Idea74264Config config) {
        this.config = config != null ? config : new Idea74264Config();
