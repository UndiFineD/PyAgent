...
@Data
public class Idea74110Config {
    private String name = "idea_074110";
 ...
 */
@Slf4j
public class Idea74110Service {
    private static final int IDEA_ID = 74110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74110Service() {
        this(new Idea74110Config());
    }

    public Idea74110Service(Idea74110Config config) {
        this.config = config != null ? config : new Idea74110Config();
