...
@Data
public class Idea74567Config {
    private String name = "idea_074567";
 ...
 */
@Slf4j
public class Idea74567Service {
    private static final int IDEA_ID = 74567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74567Service() {
        this(new Idea74567Config());
    }

    public Idea74567Service(Idea74567Config config) {
        this.config = config != null ? config : new Idea74567Config();
