...
@Data
public class Idea74425Config {
    private String name = "idea_074425";
 ...
 */
@Slf4j
public class Idea74425Service {
    private static final int IDEA_ID = 74425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74425Service() {
        this(new Idea74425Config());
    }

    public Idea74425Service(Idea74425Config config) {
        this.config = config != null ? config : new Idea74425Config();
