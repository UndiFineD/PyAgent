...
@Data
public class Idea74284Config {
    private String name = "idea_074284";
 ...
 */
@Slf4j
public class Idea74284Service {
    private static final int IDEA_ID = 74284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74284Service() {
        this(new Idea74284Config());
    }

    public Idea74284Service(Idea74284Config config) {
        this.config = config != null ? config : new Idea74284Config();
