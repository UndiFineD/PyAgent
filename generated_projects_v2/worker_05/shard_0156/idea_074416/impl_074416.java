...
@Data
public class Idea74416Config {
    private String name = "idea_074416";
 ...
 */
@Slf4j
public class Idea74416Service {
    private static final int IDEA_ID = 74416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74416Service() {
        this(new Idea74416Config());
    }

    public Idea74416Service(Idea74416Config config) {
        this.config = config != null ? config : new Idea74416Config();
