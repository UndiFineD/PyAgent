...
@Data
public class Idea74182Config {
    private String name = "idea_074182";
 ...
 */
@Slf4j
public class Idea74182Service {
    private static final int IDEA_ID = 74182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74182Service() {
        this(new Idea74182Config());
    }

    public Idea74182Service(Idea74182Config config) {
        this.config = config != null ? config : new Idea74182Config();
