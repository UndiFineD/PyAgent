...
@Data
public class Idea74385Config {
    private String name = "idea_074385";
 ...
 */
@Slf4j
public class Idea74385Service {
    private static final int IDEA_ID = 74385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74385Service() {
        this(new Idea74385Config());
    }

    public Idea74385Service(Idea74385Config config) {
        this.config = config != null ? config : new Idea74385Config();
