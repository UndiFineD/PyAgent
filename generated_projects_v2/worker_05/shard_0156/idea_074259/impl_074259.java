...
@Data
public class Idea74259Config {
    private String name = "idea_074259";
 ...
 */
@Slf4j
public class Idea74259Service {
    private static final int IDEA_ID = 74259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74259Service() {
        this(new Idea74259Config());
    }

    public Idea74259Service(Idea74259Config config) {
        this.config = config != null ? config : new Idea74259Config();
