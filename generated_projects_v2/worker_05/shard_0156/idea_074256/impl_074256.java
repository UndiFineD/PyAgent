...
@Data
public class Idea74256Config {
    private String name = "idea_074256";
 ...
 */
@Slf4j
public class Idea74256Service {
    private static final int IDEA_ID = 74256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74256Service() {
        this(new Idea74256Config());
    }

    public Idea74256Service(Idea74256Config config) {
        this.config = config != null ? config : new Idea74256Config();
