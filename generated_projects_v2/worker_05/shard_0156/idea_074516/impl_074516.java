...
@Data
public class Idea74516Config {
    private String name = "idea_074516";
 ...
 */
@Slf4j
public class Idea74516Service {
    private static final int IDEA_ID = 74516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74516Service() {
        this(new Idea74516Config());
    }

    public Idea74516Service(Idea74516Config config) {
        this.config = config != null ? config : new Idea74516Config();
