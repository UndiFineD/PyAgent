...
@Data
public class Idea74146Config {
    private String name = "idea_074146";
 ...
 */
@Slf4j
public class Idea74146Service {
    private static final int IDEA_ID = 74146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74146Service() {
        this(new Idea74146Config());
    }

    public Idea74146Service(Idea74146Config config) {
        this.config = config != null ? config : new Idea74146Config();
