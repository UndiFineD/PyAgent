...
@Data
public class Idea74487Config {
    private String name = "idea_074487";
 ...
 */
@Slf4j
public class Idea74487Service {
    private static final int IDEA_ID = 74487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74487Service() {
        this(new Idea74487Config());
    }

    public Idea74487Service(Idea74487Config config) {
        this.config = config != null ? config : new Idea74487Config();
