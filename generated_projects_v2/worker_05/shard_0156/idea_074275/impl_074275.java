...
@Data
public class Idea74275Config {
    private String name = "idea_074275";
 ...
 */
@Slf4j
public class Idea74275Service {
    private static final int IDEA_ID = 74275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74275Service() {
        this(new Idea74275Config());
    }

    public Idea74275Service(Idea74275Config config) {
        this.config = config != null ? config : new Idea74275Config();
