...
@Data
public class Idea74305Config {
    private String name = "idea_074305";
 ...
 */
@Slf4j
public class Idea74305Service {
    private static final int IDEA_ID = 74305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74305Service() {
        this(new Idea74305Config());
    }

    public Idea74305Service(Idea74305Config config) {
        this.config = config != null ? config : new Idea74305Config();
