...
@Data
public class Idea74563Config {
    private String name = "idea_074563";
 ...
 */
@Slf4j
public class Idea74563Service {
    private static final int IDEA_ID = 74563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74563Service() {
        this(new Idea74563Config());
    }

    public Idea74563Service(Idea74563Config config) {
        this.config = config != null ? config : new Idea74563Config();
