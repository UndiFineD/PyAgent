...
@Data
public class Idea74335Config {
    private String name = "idea_074335";
 ...
 */
@Slf4j
public class Idea74335Service {
    private static final int IDEA_ID = 74335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74335Service() {
        this(new Idea74335Config());
    }

    public Idea74335Service(Idea74335Config config) {
        this.config = config != null ? config : new Idea74335Config();
