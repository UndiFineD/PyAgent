...
@Data
public class Idea74261Config {
    private String name = "idea_074261";
 ...
 */
@Slf4j
public class Idea74261Service {
    private static final int IDEA_ID = 74261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74261Service() {
        this(new Idea74261Config());
    }

    public Idea74261Service(Idea74261Config config) {
        this.config = config != null ? config : new Idea74261Config();
