...
@Data
public class Idea74353Config {
    private String name = "idea_074353";
 ...
 */
@Slf4j
public class Idea74353Service {
    private static final int IDEA_ID = 74353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74353Service() {
        this(new Idea74353Config());
    }

    public Idea74353Service(Idea74353Config config) {
        this.config = config != null ? config : new Idea74353Config();
