...
@Data
public class Idea74109Config {
    private String name = "idea_074109";
 ...
 */
@Slf4j
public class Idea74109Service {
    private static final int IDEA_ID = 74109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74109Service() {
        this(new Idea74109Config());
    }

    public Idea74109Service(Idea74109Config config) {
        this.config = config != null ? config : new Idea74109Config();
