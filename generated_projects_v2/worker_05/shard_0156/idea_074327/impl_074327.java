...
@Data
public class Idea74327Config {
    private String name = "idea_074327";
 ...
 */
@Slf4j
public class Idea74327Service {
    private static final int IDEA_ID = 74327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74327Service() {
        this(new Idea74327Config());
    }

    public Idea74327Service(Idea74327Config config) {
        this.config = config != null ? config : new Idea74327Config();
