...
@Data
public class Idea74509Config {
    private String name = "idea_074509";
 ...
 */
@Slf4j
public class Idea74509Service {
    private static final int IDEA_ID = 74509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74509Service() {
        this(new Idea74509Config());
    }

    public Idea74509Service(Idea74509Config config) {
        this.config = config != null ? config : new Idea74509Config();
