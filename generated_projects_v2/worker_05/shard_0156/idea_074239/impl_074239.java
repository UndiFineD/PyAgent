...
@Data
public class Idea74239Config {
    private String name = "idea_074239";
 ...
 */
@Slf4j
public class Idea74239Service {
    private static final int IDEA_ID = 74239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74239Service() {
        this(new Idea74239Config());
    }

    public Idea74239Service(Idea74239Config config) {
        this.config = config != null ? config : new Idea74239Config();
