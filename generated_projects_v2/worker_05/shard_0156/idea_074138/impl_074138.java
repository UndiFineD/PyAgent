...
@Data
public class Idea74138Config {
    private String name = "idea_074138";
 ...
 */
@Slf4j
public class Idea74138Service {
    private static final int IDEA_ID = 74138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74138Service() {
        this(new Idea74138Config());
    }

    public Idea74138Service(Idea74138Config config) {
        this.config = config != null ? config : new Idea74138Config();
