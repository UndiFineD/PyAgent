...
@Data
public class Idea74485Config {
    private String name = "idea_074485";
 ...
 */
@Slf4j
public class Idea74485Service {
    private static final int IDEA_ID = 74485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74485Service() {
        this(new Idea74485Config());
    }

    public Idea74485Service(Idea74485Config config) {
        this.config = config != null ? config : new Idea74485Config();
