...
@Data
public class Idea74483Config {
    private String name = "idea_074483";
 ...
 */
@Slf4j
public class Idea74483Service {
    private static final int IDEA_ID = 74483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74483Service() {
        this(new Idea74483Config());
    }

    public Idea74483Service(Idea74483Config config) {
        this.config = config != null ? config : new Idea74483Config();
