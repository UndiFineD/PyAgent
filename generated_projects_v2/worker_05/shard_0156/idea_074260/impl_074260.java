...
@Data
public class Idea74260Config {
    private String name = "idea_074260";
 ...
 */
@Slf4j
public class Idea74260Service {
    private static final int IDEA_ID = 74260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74260Service() {
        this(new Idea74260Config());
    }

    public Idea74260Service(Idea74260Config config) {
        this.config = config != null ? config : new Idea74260Config();
