...
@Data
public class Idea74208Config {
    private String name = "idea_074208";
 ...
 */
@Slf4j
public class Idea74208Service {
    private static final int IDEA_ID = 74208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74208Service() {
        this(new Idea74208Config());
    }

    public Idea74208Service(Idea74208Config config) {
        this.config = config != null ? config : new Idea74208Config();
