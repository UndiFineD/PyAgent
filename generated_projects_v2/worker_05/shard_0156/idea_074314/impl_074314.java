...
@Data
public class Idea74314Config {
    private String name = "idea_074314";
 ...
 */
@Slf4j
public class Idea74314Service {
    private static final int IDEA_ID = 74314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74314Service() {
        this(new Idea74314Config());
    }

    public Idea74314Service(Idea74314Config config) {
        this.config = config != null ? config : new Idea74314Config();
