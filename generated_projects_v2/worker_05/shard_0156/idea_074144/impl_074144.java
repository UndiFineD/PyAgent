...
@Data
public class Idea74144Config {
    private String name = "idea_074144";
 ...
 */
@Slf4j
public class Idea74144Service {
    private static final int IDEA_ID = 74144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74144Service() {
        this(new Idea74144Config());
    }

    public Idea74144Service(Idea74144Config config) {
        this.config = config != null ? config : new Idea74144Config();
