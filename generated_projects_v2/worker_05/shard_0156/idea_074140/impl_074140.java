...
@Data
public class Idea74140Config {
    private String name = "idea_074140";
 ...
 */
@Slf4j
public class Idea74140Service {
    private static final int IDEA_ID = 74140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74140Service() {
        this(new Idea74140Config());
    }

    public Idea74140Service(Idea74140Config config) {
        this.config = config != null ? config : new Idea74140Config();
