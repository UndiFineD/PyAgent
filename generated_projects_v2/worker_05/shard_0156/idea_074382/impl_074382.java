...
@Data
public class Idea74382Config {
    private String name = "idea_074382";
 ...
 */
@Slf4j
public class Idea74382Service {
    private static final int IDEA_ID = 74382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74382Service() {
        this(new Idea74382Config());
    }

    public Idea74382Service(Idea74382Config config) {
        this.config = config != null ? config : new Idea74382Config();
