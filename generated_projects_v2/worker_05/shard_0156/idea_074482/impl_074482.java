...
@Data
public class Idea74482Config {
    private String name = "idea_074482";
 ...
 */
@Slf4j
public class Idea74482Service {
    private static final int IDEA_ID = 74482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74482Service() {
        this(new Idea74482Config());
    }

    public Idea74482Service(Idea74482Config config) {
        this.config = config != null ? config : new Idea74482Config();
