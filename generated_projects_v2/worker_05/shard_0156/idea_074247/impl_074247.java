...
@Data
public class Idea74247Config {
    private String name = "idea_074247";
 ...
 */
@Slf4j
public class Idea74247Service {
    private static final int IDEA_ID = 74247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74247Service() {
        this(new Idea74247Config());
    }

    public Idea74247Service(Idea74247Config config) {
        this.config = config != null ? config : new Idea74247Config();
