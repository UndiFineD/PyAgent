...
@Data
public class Idea74558Config {
    private String name = "idea_074558";
 ...
 */
@Slf4j
public class Idea74558Service {
    private static final int IDEA_ID = 74558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74558Service() {
        this(new Idea74558Config());
    }

    public Idea74558Service(Idea74558Config config) {
        this.config = config != null ? config : new Idea74558Config();
