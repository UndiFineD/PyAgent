...
@Data
public class Idea74394Config {
    private String name = "idea_074394";
 ...
 */
@Slf4j
public class Idea74394Service {
    private static final int IDEA_ID = 74394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74394Service() {
        this(new Idea74394Config());
    }

    public Idea74394Service(Idea74394Config config) {
        this.config = config != null ? config : new Idea74394Config();
