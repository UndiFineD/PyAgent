...
@Data
public class Idea74366Config {
    private String name = "idea_074366";
 ...
 */
@Slf4j
public class Idea74366Service {
    private static final int IDEA_ID = 74366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74366Service() {
        this(new Idea74366Config());
    }

    public Idea74366Service(Idea74366Config config) {
        this.config = config != null ? config : new Idea74366Config();
