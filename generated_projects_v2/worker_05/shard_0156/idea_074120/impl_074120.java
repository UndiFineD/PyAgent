...
@Data
public class Idea74120Config {
    private String name = "idea_074120";
 ...
 */
@Slf4j
public class Idea74120Service {
    private static final int IDEA_ID = 74120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74120Service() {
        this(new Idea74120Config());
    }

    public Idea74120Service(Idea74120Config config) {
        this.config = config != null ? config : new Idea74120Config();
