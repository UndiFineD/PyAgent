...
@Data
public class Idea74452Config {
    private String name = "idea_074452";
 ...
 */
@Slf4j
public class Idea74452Service {
    private static final int IDEA_ID = 74452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74452Service() {
        this(new Idea74452Config());
    }

    public Idea74452Service(Idea74452Config config) {
        this.config = config != null ? config : new Idea74452Config();
