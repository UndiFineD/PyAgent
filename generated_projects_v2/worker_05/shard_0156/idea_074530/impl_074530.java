...
@Data
public class Idea74530Config {
    private String name = "idea_074530";
 ...
 */
@Slf4j
public class Idea74530Service {
    private static final int IDEA_ID = 74530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74530Service() {
        this(new Idea74530Config());
    }

    public Idea74530Service(Idea74530Config config) {
        this.config = config != null ? config : new Idea74530Config();
