...
@Data
public class Idea74333Config {
    private String name = "idea_074333";
 ...
 */
@Slf4j
public class Idea74333Service {
    private static final int IDEA_ID = 74333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74333Service() {
        this(new Idea74333Config());
    }

    public Idea74333Service(Idea74333Config config) {
        this.config = config != null ? config : new Idea74333Config();
