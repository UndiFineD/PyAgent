...
@Data
public class Idea74345Config {
    private String name = "idea_074345";
 ...
 */
@Slf4j
public class Idea74345Service {
    private static final int IDEA_ID = 74345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74345Service() {
        this(new Idea74345Config());
    }

    public Idea74345Service(Idea74345Config config) {
        this.config = config != null ? config : new Idea74345Config();
