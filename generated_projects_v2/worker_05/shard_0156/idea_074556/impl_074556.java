...
@Data
public class Idea74556Config {
    private String name = "idea_074556";
 ...
 */
@Slf4j
public class Idea74556Service {
    private static final int IDEA_ID = 74556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74556Service() {
        this(new Idea74556Config());
    }

    public Idea74556Service(Idea74556Config config) {
        this.config = config != null ? config : new Idea74556Config();
