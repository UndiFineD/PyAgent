...
@Data
public class Idea74180Config {
    private String name = "idea_074180";
 ...
 */
@Slf4j
public class Idea74180Service {
    private static final int IDEA_ID = 74180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74180Service() {
        this(new Idea74180Config());
    }

    public Idea74180Service(Idea74180Config config) {
        this.config = config != null ? config : new Idea74180Config();
