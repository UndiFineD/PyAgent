...
@Data
public class Idea74257Config {
    private String name = "idea_074257";
 ...
 */
@Slf4j
public class Idea74257Service {
    private static final int IDEA_ID = 74257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74257Service() {
        this(new Idea74257Config());
    }

    public Idea74257Service(Idea74257Config config) {
        this.config = config != null ? config : new Idea74257Config();
