...
@Data
public class Idea74157Config {
    private String name = "idea_074157";
 ...
 */
@Slf4j
public class Idea74157Service {
    private static final int IDEA_ID = 74157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74157Service() {
        this(new Idea74157Config());
    }

    public Idea74157Service(Idea74157Config config) {
        this.config = config != null ? config : new Idea74157Config();
