...
@Data
public class Idea74381Config {
    private String name = "idea_074381";
 ...
 */
@Slf4j
public class Idea74381Service {
    private static final int IDEA_ID = 74381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74381Service() {
        this(new Idea74381Config());
    }

    public Idea74381Service(Idea74381Config config) {
        this.config = config != null ? config : new Idea74381Config();
