...
@Data
public class Idea74235Config {
    private String name = "idea_074235";
 ...
 */
@Slf4j
public class Idea74235Service {
    private static final int IDEA_ID = 74235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74235Service() {
        this(new Idea74235Config());
    }

    public Idea74235Service(Idea74235Config config) {
        this.config = config != null ? config : new Idea74235Config();
