...
@Data
public class Idea74388Config {
    private String name = "idea_074388";
 ...
 */
@Slf4j
public class Idea74388Service {
    private static final int IDEA_ID = 74388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74388Service() {
        this(new Idea74388Config());
    }

    public Idea74388Service(Idea74388Config config) {
        this.config = config != null ? config : new Idea74388Config();
