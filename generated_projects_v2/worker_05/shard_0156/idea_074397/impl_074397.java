...
@Data
public class Idea74397Config {
    private String name = "idea_074397";
 ...
 */
@Slf4j
public class Idea74397Service {
    private static final int IDEA_ID = 74397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74397Service() {
        this(new Idea74397Config());
    }

    public Idea74397Service(Idea74397Config config) {
        this.config = config != null ? config : new Idea74397Config();
