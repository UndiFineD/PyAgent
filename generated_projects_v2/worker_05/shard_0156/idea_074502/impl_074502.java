...
@Data
public class Idea74502Config {
    private String name = "idea_074502";
 ...
 */
@Slf4j
public class Idea74502Service {
    private static final int IDEA_ID = 74502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74502Service() {
        this(new Idea74502Config());
    }

    public Idea74502Service(Idea74502Config config) {
        this.config = config != null ? config : new Idea74502Config();
