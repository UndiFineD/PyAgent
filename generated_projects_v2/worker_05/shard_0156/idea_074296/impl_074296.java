...
@Data
public class Idea74296Config {
    private String name = "idea_074296";
 ...
 */
@Slf4j
public class Idea74296Service {
    private static final int IDEA_ID = 74296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74296Service() {
        this(new Idea74296Config());
    }

    public Idea74296Service(Idea74296Config config) {
        this.config = config != null ? config : new Idea74296Config();
