...
@Data
public class Idea74365Config {
    private String name = "idea_074365";
 ...
 */
@Slf4j
public class Idea74365Service {
    private static final int IDEA_ID = 74365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74365Service() {
        this(new Idea74365Config());
    }

    public Idea74365Service(Idea74365Config config) {
        this.config = config != null ? config : new Idea74365Config();
