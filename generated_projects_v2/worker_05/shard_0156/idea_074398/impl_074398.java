...
@Data
public class Idea74398Config {
    private String name = "idea_074398";
 ...
 */
@Slf4j
public class Idea74398Service {
    private static final int IDEA_ID = 74398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74398Service() {
        this(new Idea74398Config());
    }

    public Idea74398Service(Idea74398Config config) {
        this.config = config != null ? config : new Idea74398Config();
