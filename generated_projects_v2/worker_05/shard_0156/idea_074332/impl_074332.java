...
@Data
public class Idea74332Config {
    private String name = "idea_074332";
 ...
 */
@Slf4j
public class Idea74332Service {
    private static final int IDEA_ID = 74332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74332Service() {
        this(new Idea74332Config());
    }

    public Idea74332Service(Idea74332Config config) {
        this.config = config != null ? config : new Idea74332Config();
