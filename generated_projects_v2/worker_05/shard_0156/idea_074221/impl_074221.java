...
@Data
public class Idea74221Config {
    private String name = "idea_074221";
 ...
 */
@Slf4j
public class Idea74221Service {
    private static final int IDEA_ID = 74221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74221Service() {
        this(new Idea74221Config());
    }

    public Idea74221Service(Idea74221Config config) {
        this.config = config != null ? config : new Idea74221Config();
