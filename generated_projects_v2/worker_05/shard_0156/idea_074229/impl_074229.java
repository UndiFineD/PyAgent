...
@Data
public class Idea74229Config {
    private String name = "idea_074229";
 ...
 */
@Slf4j
public class Idea74229Service {
    private static final int IDEA_ID = 74229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74229Service() {
        this(new Idea74229Config());
    }

    public Idea74229Service(Idea74229Config config) {
        this.config = config != null ? config : new Idea74229Config();
