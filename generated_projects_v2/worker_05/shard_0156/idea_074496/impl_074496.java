...
@Data
public class Idea74496Config {
    private String name = "idea_074496";
 ...
 */
@Slf4j
public class Idea74496Service {
    private static final int IDEA_ID = 74496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74496Service() {
        this(new Idea74496Config());
    }

    public Idea74496Service(Idea74496Config config) {
        this.config = config != null ? config : new Idea74496Config();
