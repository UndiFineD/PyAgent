...
@Data
public class Idea74548Config {
    private String name = "idea_074548";
 ...
 */
@Slf4j
public class Idea74548Service {
    private static final int IDEA_ID = 74548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74548Service() {
        this(new Idea74548Config());
    }

    public Idea74548Service(Idea74548Config config) {
        this.config = config != null ? config : new Idea74548Config();
