...
@Data
public class Idea74474Config {
    private String name = "idea_074474";
 ...
 */
@Slf4j
public class Idea74474Service {
    private static final int IDEA_ID = 74474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74474Service() {
        this(new Idea74474Config());
    }

    public Idea74474Service(Idea74474Config config) {
        this.config = config != null ? config : new Idea74474Config();
