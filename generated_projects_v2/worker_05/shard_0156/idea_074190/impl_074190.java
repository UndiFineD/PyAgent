...
@Data
public class Idea74190Config {
    private String name = "idea_074190";
 ...
 */
@Slf4j
public class Idea74190Service {
    private static final int IDEA_ID = 74190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74190Service() {
        this(new Idea74190Config());
    }

    public Idea74190Service(Idea74190Config config) {
        this.config = config != null ? config : new Idea74190Config();
