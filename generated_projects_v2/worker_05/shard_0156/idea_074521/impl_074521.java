...
@Data
public class Idea74521Config {
    private String name = "idea_074521";
 ...
 */
@Slf4j
public class Idea74521Service {
    private static final int IDEA_ID = 74521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74521Service() {
        this(new Idea74521Config());
    }

    public Idea74521Service(Idea74521Config config) {
        this.config = config != null ? config : new Idea74521Config();
