...
@Data
public class Idea74504Config {
    private String name = "idea_074504";
 ...
 */
@Slf4j
public class Idea74504Service {
    private static final int IDEA_ID = 74504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74504Service() {
        this(new Idea74504Config());
    }

    public Idea74504Service(Idea74504Config config) {
        this.config = config != null ? config : new Idea74504Config();
