...
@Data
public class Idea74532Config {
    private String name = "idea_074532";
 ...
 */
@Slf4j
public class Idea74532Service {
    private static final int IDEA_ID = 74532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74532Service() {
        this(new Idea74532Config());
    }

    public Idea74532Service(Idea74532Config config) {
        this.config = config != null ? config : new Idea74532Config();
