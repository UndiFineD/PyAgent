...
@Data
public class Idea74196Config {
    private String name = "idea_074196";
 ...
 */
@Slf4j
public class Idea74196Service {
    private static final int IDEA_ID = 74196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74196Service() {
        this(new Idea74196Config());
    }

    public Idea74196Service(Idea74196Config config) {
        this.config = config != null ? config : new Idea74196Config();
