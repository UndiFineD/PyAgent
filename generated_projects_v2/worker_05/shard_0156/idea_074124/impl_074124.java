...
@Data
public class Idea74124Config {
    private String name = "idea_074124";
 ...
 */
@Slf4j
public class Idea74124Service {
    private static final int IDEA_ID = 74124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74124Service() {
        this(new Idea74124Config());
    }

    public Idea74124Service(Idea74124Config config) {
        this.config = config != null ? config : new Idea74124Config();
