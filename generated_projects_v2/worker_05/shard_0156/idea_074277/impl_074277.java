...
@Data
public class Idea74277Config {
    private String name = "idea_074277";
 ...
 */
@Slf4j
public class Idea74277Service {
    private static final int IDEA_ID = 74277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74277Service() {
        this(new Idea74277Config());
    }

    public Idea74277Service(Idea74277Config config) {
        this.config = config != null ? config : new Idea74277Config();
