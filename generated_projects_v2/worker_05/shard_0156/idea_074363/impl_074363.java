...
@Data
public class Idea74363Config {
    private String name = "idea_074363";
 ...
 */
@Slf4j
public class Idea74363Service {
    private static final int IDEA_ID = 74363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74363Service() {
        this(new Idea74363Config());
    }

    public Idea74363Service(Idea74363Config config) {
        this.config = config != null ? config : new Idea74363Config();
