...
@Data
public class Idea74441Config {
    private String name = "idea_074441";
 ...
 */
@Slf4j
public class Idea74441Service {
    private static final int IDEA_ID = 74441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74441Service() {
        this(new Idea74441Config());
    }

    public Idea74441Service(Idea74441Config config) {
        this.config = config != null ? config : new Idea74441Config();
