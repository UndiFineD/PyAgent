...
@Data
public class Idea74262Config {
    private String name = "idea_074262";
 ...
 */
@Slf4j
public class Idea74262Service {
    private static final int IDEA_ID = 74262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74262Service() {
        this(new Idea74262Config());
    }

    public Idea74262Service(Idea74262Config config) {
        this.config = config != null ? config : new Idea74262Config();
