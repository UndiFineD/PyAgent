...
@Data
public class Idea74813Config {
    private String name = "idea_074813";
 ...
 */
@Slf4j
public class Idea74813Service {
    private static final int IDEA_ID = 74813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74813Service() {
        this(new Idea74813Config());
    }

    public Idea74813Service(Idea74813Config config) {
        this.config = config != null ? config : new Idea74813Config();
