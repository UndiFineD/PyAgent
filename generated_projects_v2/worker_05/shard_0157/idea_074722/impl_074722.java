...
@Data
public class Idea74722Config {
    private String name = "idea_074722";
 ...
 */
@Slf4j
public class Idea74722Service {
    private static final int IDEA_ID = 74722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74722Service() {
        this(new Idea74722Config());
    }

    public Idea74722Service(Idea74722Config config) {
        this.config = config != null ? config : new Idea74722Config();
