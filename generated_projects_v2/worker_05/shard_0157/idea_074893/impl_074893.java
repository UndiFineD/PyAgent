...
@Data
public class Idea74893Config {
    private String name = "idea_074893";
 ...
 */
@Slf4j
public class Idea74893Service {
    private static final int IDEA_ID = 74893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74893Service() {
        this(new Idea74893Config());
    }

    public Idea74893Service(Idea74893Config config) {
        this.config = config != null ? config : new Idea74893Config();
