...
@Data
public class Idea74994Config {
    private String name = "idea_074994";
 ...
 */
@Slf4j
public class Idea74994Service {
    private static final int IDEA_ID = 74994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74994Service() {
        this(new Idea74994Config());
    }

    public Idea74994Service(Idea74994Config config) {
        this.config = config != null ? config : new Idea74994Config();
