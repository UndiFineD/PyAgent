...
@Data
public class Idea74847Config {
    private String name = "idea_074847";
 ...
 */
@Slf4j
public class Idea74847Service {
    private static final int IDEA_ID = 74847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74847Service() {
        this(new Idea74847Config());
    }

    public Idea74847Service(Idea74847Config config) {
        this.config = config != null ? config : new Idea74847Config();
