...
@Data
public class Idea74626Config {
    private String name = "idea_074626";
 ...
 */
@Slf4j
public class Idea74626Service {
    private static final int IDEA_ID = 74626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74626Service() {
        this(new Idea74626Config());
    }

    public Idea74626Service(Idea74626Config config) {
        this.config = config != null ? config : new Idea74626Config();
