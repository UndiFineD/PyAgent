...
@Data
public class Idea74894Config {
    private String name = "idea_074894";
 ...
 */
@Slf4j
public class Idea74894Service {
    private static final int IDEA_ID = 74894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74894Service() {
        this(new Idea74894Config());
    }

    public Idea74894Service(Idea74894Config config) {
        this.config = config != null ? config : new Idea74894Config();
