...
@Data
public class Idea74575Config {
    private String name = "idea_074575";
 ...
 */
@Slf4j
public class Idea74575Service {
    private static final int IDEA_ID = 74575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74575Service() {
        this(new Idea74575Config());
    }

    public Idea74575Service(Idea74575Config config) {
        this.config = config != null ? config : new Idea74575Config();
