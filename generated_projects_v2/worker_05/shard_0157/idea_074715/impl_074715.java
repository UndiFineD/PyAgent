...
@Data
public class Idea74715Config {
    private String name = "idea_074715";
 ...
 */
@Slf4j
public class Idea74715Service {
    private static final int IDEA_ID = 74715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74715Service() {
        this(new Idea74715Config());
    }

    public Idea74715Service(Idea74715Config config) {
        this.config = config != null ? config : new Idea74715Config();
