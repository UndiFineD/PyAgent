...
@Data
public class Idea74579Config {
    private String name = "idea_074579";
 ...
 */
@Slf4j
public class Idea74579Service {
    private static final int IDEA_ID = 74579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74579Service() {
        this(new Idea74579Config());
    }

    public Idea74579Service(Idea74579Config config) {
        this.config = config != null ? config : new Idea74579Config();
