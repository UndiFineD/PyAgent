...
@Data
public class Idea74902Config {
    private String name = "idea_074902";
 ...
 */
@Slf4j
public class Idea74902Service {
    private static final int IDEA_ID = 74902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74902Service() {
        this(new Idea74902Config());
    }

    public Idea74902Service(Idea74902Config config) {
        this.config = config != null ? config : new Idea74902Config();
