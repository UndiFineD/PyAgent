...
@Data
public class Idea74577Config {
    private String name = "idea_074577";
 ...
 */
@Slf4j
public class Idea74577Service {
    private static final int IDEA_ID = 74577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74577Service() {
        this(new Idea74577Config());
    }

    public Idea74577Service(Idea74577Config config) {
        this.config = config != null ? config : new Idea74577Config();
