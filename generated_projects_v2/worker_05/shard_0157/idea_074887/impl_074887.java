...
@Data
public class Idea74887Config {
    private String name = "idea_074887";
 ...
 */
@Slf4j
public class Idea74887Service {
    private static final int IDEA_ID = 74887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74887Service() {
        this(new Idea74887Config());
    }

    public Idea74887Service(Idea74887Config config) {
        this.config = config != null ? config : new Idea74887Config();
