...
@Data
public class Idea74648Config {
    private String name = "idea_074648";
 ...
 */
@Slf4j
public class Idea74648Service {
    private static final int IDEA_ID = 74648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74648Service() {
        this(new Idea74648Config());
    }

    public Idea74648Service(Idea74648Config config) {
        this.config = config != null ? config : new Idea74648Config();
