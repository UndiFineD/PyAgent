...
@Data
public class Idea74912Config {
    private String name = "idea_074912";
 ...
 */
@Slf4j
public class Idea74912Service {
    private static final int IDEA_ID = 74912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74912Service() {
        this(new Idea74912Config());
    }

    public Idea74912Service(Idea74912Config config) {
        this.config = config != null ? config : new Idea74912Config();
