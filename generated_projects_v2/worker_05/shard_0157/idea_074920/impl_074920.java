...
@Data
public class Idea74920Config {
    private String name = "idea_074920";
 ...
 */
@Slf4j
public class Idea74920Service {
    private static final int IDEA_ID = 74920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74920Service() {
        this(new Idea74920Config());
    }

    public Idea74920Service(Idea74920Config config) {
        this.config = config != null ? config : new Idea74920Config();
