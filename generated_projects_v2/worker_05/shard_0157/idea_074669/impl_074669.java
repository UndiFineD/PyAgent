...
@Data
public class Idea74669Config {
    private String name = "idea_074669";
 ...
 */
@Slf4j
public class Idea74669Service {
    private static final int IDEA_ID = 74669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74669Service() {
        this(new Idea74669Config());
    }

    public Idea74669Service(Idea74669Config config) {
        this.config = config != null ? config : new Idea74669Config();
