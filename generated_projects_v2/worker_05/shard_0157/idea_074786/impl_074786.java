...
@Data
public class Idea74786Config {
    private String name = "idea_074786";
 ...
 */
@Slf4j
public class Idea74786Service {
    private static final int IDEA_ID = 74786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74786Service() {
        this(new Idea74786Config());
    }

    public Idea74786Service(Idea74786Config config) {
        this.config = config != null ? config : new Idea74786Config();
