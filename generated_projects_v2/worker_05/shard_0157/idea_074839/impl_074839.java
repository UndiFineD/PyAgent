...
@Data
public class Idea74839Config {
    private String name = "idea_074839";
 ...
 */
@Slf4j
public class Idea74839Service {
    private static final int IDEA_ID = 74839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74839Service() {
        this(new Idea74839Config());
    }

    public Idea74839Service(Idea74839Config config) {
        this.config = config != null ? config : new Idea74839Config();
