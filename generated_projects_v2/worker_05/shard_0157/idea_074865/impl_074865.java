...
@Data
public class Idea74865Config {
    private String name = "idea_074865";
 ...
 */
@Slf4j
public class Idea74865Service {
    private static final int IDEA_ID = 74865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74865Service() {
        this(new Idea74865Config());
    }

    public Idea74865Service(Idea74865Config config) {
        this.config = config != null ? config : new Idea74865Config();
