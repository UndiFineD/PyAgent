...
@Data
public class Idea74636Config {
    private String name = "idea_074636";
 ...
 */
@Slf4j
public class Idea74636Service {
    private static final int IDEA_ID = 74636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74636Service() {
        this(new Idea74636Config());
    }

    public Idea74636Service(Idea74636Config config) {
        this.config = config != null ? config : new Idea74636Config();
