...
@Data
public class Idea74708Config {
    private String name = "idea_074708";
 ...
 */
@Slf4j
public class Idea74708Service {
    private static final int IDEA_ID = 74708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74708Service() {
        this(new Idea74708Config());
    }

    public Idea74708Service(Idea74708Config config) {
        this.config = config != null ? config : new Idea74708Config();
