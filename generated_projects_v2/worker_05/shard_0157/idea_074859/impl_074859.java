...
@Data
public class Idea74859Config {
    private String name = "idea_074859";
 ...
 */
@Slf4j
public class Idea74859Service {
    private static final int IDEA_ID = 74859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74859Service() {
        this(new Idea74859Config());
    }

    public Idea74859Service(Idea74859Config config) {
        this.config = config != null ? config : new Idea74859Config();
