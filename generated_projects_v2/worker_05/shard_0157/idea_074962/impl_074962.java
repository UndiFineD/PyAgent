...
@Data
public class Idea74962Config {
    private String name = "idea_074962";
 ...
 */
@Slf4j
public class Idea74962Service {
    private static final int IDEA_ID = 74962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74962Service() {
        this(new Idea74962Config());
    }

    public Idea74962Service(Idea74962Config config) {
        this.config = config != null ? config : new Idea74962Config();
