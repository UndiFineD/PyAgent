...
@Data
public class Idea74808Config {
    private String name = "idea_074808";
 ...
 */
@Slf4j
public class Idea74808Service {
    private static final int IDEA_ID = 74808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74808Service() {
        this(new Idea74808Config());
    }

    public Idea74808Service(Idea74808Config config) {
        this.config = config != null ? config : new Idea74808Config();
