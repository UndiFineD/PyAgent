...
@Data
public class Idea74703Config {
    private String name = "idea_074703";
 ...
 */
@Slf4j
public class Idea74703Service {
    private static final int IDEA_ID = 74703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74703Service() {
        this(new Idea74703Config());
    }

    public Idea74703Service(Idea74703Config config) {
        this.config = config != null ? config : new Idea74703Config();
