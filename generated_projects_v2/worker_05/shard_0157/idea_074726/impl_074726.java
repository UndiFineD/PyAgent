...
@Data
public class Idea74726Config {
    private String name = "idea_074726";
 ...
 */
@Slf4j
public class Idea74726Service {
    private static final int IDEA_ID = 74726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74726Service() {
        this(new Idea74726Config());
    }

    public Idea74726Service(Idea74726Config config) {
        this.config = config != null ? config : new Idea74726Config();
