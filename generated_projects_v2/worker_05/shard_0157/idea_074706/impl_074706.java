...
@Data
public class Idea74706Config {
    private String name = "idea_074706";
 ...
 */
@Slf4j
public class Idea74706Service {
    private static final int IDEA_ID = 74706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74706Service() {
        this(new Idea74706Config());
    }

    public Idea74706Service(Idea74706Config config) {
        this.config = config != null ? config : new Idea74706Config();
