...
@Data
public class Idea74938Config {
    private String name = "idea_074938";
 ...
 */
@Slf4j
public class Idea74938Service {
    private static final int IDEA_ID = 74938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74938Service() {
        this(new Idea74938Config());
    }

    public Idea74938Service(Idea74938Config config) {
        this.config = config != null ? config : new Idea74938Config();
