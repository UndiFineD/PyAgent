...
@Data
public class Idea74817Config {
    private String name = "idea_074817";
 ...
 */
@Slf4j
public class Idea74817Service {
    private static final int IDEA_ID = 74817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74817Service() {
        this(new Idea74817Config());
    }

    public Idea74817Service(Idea74817Config config) {
        this.config = config != null ? config : new Idea74817Config();
