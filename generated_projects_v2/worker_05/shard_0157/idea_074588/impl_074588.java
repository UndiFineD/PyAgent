...
@Data
public class Idea74588Config {
    private String name = "idea_074588";
 ...
 */
@Slf4j
public class Idea74588Service {
    private static final int IDEA_ID = 74588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74588Service() {
        this(new Idea74588Config());
    }

    public Idea74588Service(Idea74588Config config) {
        this.config = config != null ? config : new Idea74588Config();
