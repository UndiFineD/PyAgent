...
@Data
public class Idea74634Config {
    private String name = "idea_074634";
 ...
 */
@Slf4j
public class Idea74634Service {
    private static final int IDEA_ID = 74634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74634Service() {
        this(new Idea74634Config());
    }

    public Idea74634Service(Idea74634Config config) {
        this.config = config != null ? config : new Idea74634Config();
