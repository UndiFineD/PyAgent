...
@Data
public class Idea74720Config {
    private String name = "idea_074720";
 ...
 */
@Slf4j
public class Idea74720Service {
    private static final int IDEA_ID = 74720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74720Service() {
        this(new Idea74720Config());
    }

    public Idea74720Service(Idea74720Config config) {
        this.config = config != null ? config : new Idea74720Config();
