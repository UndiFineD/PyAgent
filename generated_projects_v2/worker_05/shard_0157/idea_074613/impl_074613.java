...
@Data
public class Idea74613Config {
    private String name = "idea_074613";
 ...
 */
@Slf4j
public class Idea74613Service {
    private static final int IDEA_ID = 74613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74613Service() {
        this(new Idea74613Config());
    }

    public Idea74613Service(Idea74613Config config) {
        this.config = config != null ? config : new Idea74613Config();
