...
@Data
public class Idea74796Config {
    private String name = "idea_074796";
 ...
 */
@Slf4j
public class Idea74796Service {
    private static final int IDEA_ID = 74796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74796Service() {
        this(new Idea74796Config());
    }

    public Idea74796Service(Idea74796Config config) {
        this.config = config != null ? config : new Idea74796Config();
