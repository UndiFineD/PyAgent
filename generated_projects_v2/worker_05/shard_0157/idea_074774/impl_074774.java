...
@Data
public class Idea74774Config {
    private String name = "idea_074774";
 ...
 */
@Slf4j
public class Idea74774Service {
    private static final int IDEA_ID = 74774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74774Service() {
        this(new Idea74774Config());
    }

    public Idea74774Service(Idea74774Config config) {
        this.config = config != null ? config : new Idea74774Config();
