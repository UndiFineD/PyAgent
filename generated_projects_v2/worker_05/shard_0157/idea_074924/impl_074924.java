...
@Data
public class Idea74924Config {
    private String name = "idea_074924";
 ...
 */
@Slf4j
public class Idea74924Service {
    private static final int IDEA_ID = 74924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74924Service() {
        this(new Idea74924Config());
    }

    public Idea74924Service(Idea74924Config config) {
        this.config = config != null ? config : new Idea74924Config();
