...
@Data
public class Idea74838Config {
    private String name = "idea_074838";
 ...
 */
@Slf4j
public class Idea74838Service {
    private static final int IDEA_ID = 74838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74838Service() {
        this(new Idea74838Config());
    }

    public Idea74838Service(Idea74838Config config) {
        this.config = config != null ? config : new Idea74838Config();
