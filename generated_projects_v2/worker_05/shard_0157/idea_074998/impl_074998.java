...
@Data
public class Idea74998Config {
    private String name = "idea_074998";
 ...
 */
@Slf4j
public class Idea74998Service {
    private static final int IDEA_ID = 74998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74998Service() {
        this(new Idea74998Config());
    }

    public Idea74998Service(Idea74998Config config) {
        this.config = config != null ? config : new Idea74998Config();
