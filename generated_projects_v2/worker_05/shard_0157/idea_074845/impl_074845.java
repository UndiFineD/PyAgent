...
@Data
public class Idea74845Config {
    private String name = "idea_074845";
 ...
 */
@Slf4j
public class Idea74845Service {
    private static final int IDEA_ID = 74845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74845Service() {
        this(new Idea74845Config());
    }

    public Idea74845Service(Idea74845Config config) {
        this.config = config != null ? config : new Idea74845Config();
