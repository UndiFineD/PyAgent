...
@Data
public class Idea74620Config {
    private String name = "idea_074620";
 ...
 */
@Slf4j
public class Idea74620Service {
    private static final int IDEA_ID = 74620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74620Service() {
        this(new Idea74620Config());
    }

    public Idea74620Service(Idea74620Config config) {
        this.config = config != null ? config : new Idea74620Config();
