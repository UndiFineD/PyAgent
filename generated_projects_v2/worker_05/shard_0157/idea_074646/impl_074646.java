...
@Data
public class Idea74646Config {
    private String name = "idea_074646";
 ...
 */
@Slf4j
public class Idea74646Service {
    private static final int IDEA_ID = 74646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74646Service() {
        this(new Idea74646Config());
    }

    public Idea74646Service(Idea74646Config config) {
        this.config = config != null ? config : new Idea74646Config();
