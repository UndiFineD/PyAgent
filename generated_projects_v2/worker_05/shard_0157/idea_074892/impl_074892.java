...
@Data
public class Idea74892Config {
    private String name = "idea_074892";
 ...
 */
@Slf4j
public class Idea74892Service {
    private static final int IDEA_ID = 74892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74892Service() {
        this(new Idea74892Config());
    }

    public Idea74892Service(Idea74892Config config) {
        this.config = config != null ? config : new Idea74892Config();
