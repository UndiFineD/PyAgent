...
@Data
public class Idea74758Config {
    private String name = "idea_074758";
 ...
 */
@Slf4j
public class Idea74758Service {
    private static final int IDEA_ID = 74758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74758Service() {
        this(new Idea74758Config());
    }

    public Idea74758Service(Idea74758Config config) {
        this.config = config != null ? config : new Idea74758Config();
