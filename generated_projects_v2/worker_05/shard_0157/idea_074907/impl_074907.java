...
@Data
public class Idea74907Config {
    private String name = "idea_074907";
 ...
 */
@Slf4j
public class Idea74907Service {
    private static final int IDEA_ID = 74907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74907Service() {
        this(new Idea74907Config());
    }

    public Idea74907Service(Idea74907Config config) {
        this.config = config != null ? config : new Idea74907Config();
