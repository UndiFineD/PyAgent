...
@Data
public class Idea74701Config {
    private String name = "idea_074701";
 ...
 */
@Slf4j
public class Idea74701Service {
    private static final int IDEA_ID = 74701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74701Service() {
        this(new Idea74701Config());
    }

    public Idea74701Service(Idea74701Config config) {
        this.config = config != null ? config : new Idea74701Config();
