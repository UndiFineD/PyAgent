...
@Data
public class Idea74585Config {
    private String name = "idea_074585";
 ...
 */
@Slf4j
public class Idea74585Service {
    private static final int IDEA_ID = 74585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74585Service() {
        this(new Idea74585Config());
    }

    public Idea74585Service(Idea74585Config config) {
        this.config = config != null ? config : new Idea74585Config();
