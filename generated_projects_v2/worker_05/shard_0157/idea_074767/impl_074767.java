...
@Data
public class Idea74767Config {
    private String name = "idea_074767";
 ...
 */
@Slf4j
public class Idea74767Service {
    private static final int IDEA_ID = 74767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74767Service() {
        this(new Idea74767Config());
    }

    public Idea74767Service(Idea74767Config config) {
        this.config = config != null ? config : new Idea74767Config();
