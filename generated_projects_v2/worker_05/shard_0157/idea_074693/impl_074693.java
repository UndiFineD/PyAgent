...
@Data
public class Idea74693Config {
    private String name = "idea_074693";
 ...
 */
@Slf4j
public class Idea74693Service {
    private static final int IDEA_ID = 74693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74693Service() {
        this(new Idea74693Config());
    }

    public Idea74693Service(Idea74693Config config) {
        this.config = config != null ? config : new Idea74693Config();
