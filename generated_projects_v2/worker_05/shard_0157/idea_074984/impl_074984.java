...
@Data
public class Idea74984Config {
    private String name = "idea_074984";
 ...
 */
@Slf4j
public class Idea74984Service {
    private static final int IDEA_ID = 74984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74984Service() {
        this(new Idea74984Config());
    }

    public Idea74984Service(Idea74984Config config) {
        this.config = config != null ? config : new Idea74984Config();
