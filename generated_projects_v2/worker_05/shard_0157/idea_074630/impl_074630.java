...
@Data
public class Idea74630Config {
    private String name = "idea_074630";
 ...
 */
@Slf4j
public class Idea74630Service {
    private static final int IDEA_ID = 74630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74630Service() {
        this(new Idea74630Config());
    }

    public Idea74630Service(Idea74630Config config) {
        this.config = config != null ? config : new Idea74630Config();
