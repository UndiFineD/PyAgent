...
@Data
public class Idea74602Config {
    private String name = "idea_074602";
 ...
 */
@Slf4j
public class Idea74602Service {
    private static final int IDEA_ID = 74602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74602Service() {
        this(new Idea74602Config());
    }

    public Idea74602Service(Idea74602Config config) {
        this.config = config != null ? config : new Idea74602Config();
