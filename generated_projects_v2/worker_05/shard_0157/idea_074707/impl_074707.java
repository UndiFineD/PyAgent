...
@Data
public class Idea74707Config {
    private String name = "idea_074707";
 ...
 */
@Slf4j
public class Idea74707Service {
    private static final int IDEA_ID = 74707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74707Service() {
        this(new Idea74707Config());
    }

    public Idea74707Service(Idea74707Config config) {
        this.config = config != null ? config : new Idea74707Config();
