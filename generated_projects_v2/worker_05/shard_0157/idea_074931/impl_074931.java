...
@Data
public class Idea74931Config {
    private String name = "idea_074931";
 ...
 */
@Slf4j
public class Idea74931Service {
    private static final int IDEA_ID = 74931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74931Service() {
        this(new Idea74931Config());
    }

    public Idea74931Service(Idea74931Config config) {
        this.config = config != null ? config : new Idea74931Config();
