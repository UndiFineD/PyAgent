...
@Data
public class Idea74997Config {
    private String name = "idea_074997";
 ...
 */
@Slf4j
public class Idea74997Service {
    private static final int IDEA_ID = 74997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74997Service() {
        this(new Idea74997Config());
    }

    public Idea74997Service(Idea74997Config config) {
        this.config = config != null ? config : new Idea74997Config();
