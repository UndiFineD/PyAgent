...
@Data
public class Idea74595Config {
    private String name = "idea_074595";
 ...
 */
@Slf4j
public class Idea74595Service {
    private static final int IDEA_ID = 74595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74595Service() {
        this(new Idea74595Config());
    }

    public Idea74595Service(Idea74595Config config) {
        this.config = config != null ? config : new Idea74595Config();
