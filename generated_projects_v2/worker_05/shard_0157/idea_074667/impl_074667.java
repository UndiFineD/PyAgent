...
@Data
public class Idea74667Config {
    private String name = "idea_074667";
 ...
 */
@Slf4j
public class Idea74667Service {
    private static final int IDEA_ID = 74667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74667Service() {
        this(new Idea74667Config());
    }

    public Idea74667Service(Idea74667Config config) {
        this.config = config != null ? config : new Idea74667Config();
