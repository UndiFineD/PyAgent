...
@Data
public class Idea74591Config {
    private String name = "idea_074591";
 ...
 */
@Slf4j
public class Idea74591Service {
    private static final int IDEA_ID = 74591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74591Service() {
        this(new Idea74591Config());
    }

    public Idea74591Service(Idea74591Config config) {
        this.config = config != null ? config : new Idea74591Config();
