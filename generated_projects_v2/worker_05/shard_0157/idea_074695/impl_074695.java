...
@Data
public class Idea74695Config {
    private String name = "idea_074695";
 ...
 */
@Slf4j
public class Idea74695Service {
    private static final int IDEA_ID = 74695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74695Service() {
        this(new Idea74695Config());
    }

    public Idea74695Service(Idea74695Config config) {
        this.config = config != null ? config : new Idea74695Config();
