...
@Data
public class Idea74889Config {
    private String name = "idea_074889";
 ...
 */
@Slf4j
public class Idea74889Service {
    private static final int IDEA_ID = 74889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74889Service() {
        this(new Idea74889Config());
    }

    public Idea74889Service(Idea74889Config config) {
        this.config = config != null ? config : new Idea74889Config();
