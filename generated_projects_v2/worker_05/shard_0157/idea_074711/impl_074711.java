...
@Data
public class Idea74711Config {
    private String name = "idea_074711";
 ...
 */
@Slf4j
public class Idea74711Service {
    private static final int IDEA_ID = 74711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74711Service() {
        this(new Idea74711Config());
    }

    public Idea74711Service(Idea74711Config config) {
        this.config = config != null ? config : new Idea74711Config();
