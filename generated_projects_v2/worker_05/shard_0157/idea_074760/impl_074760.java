...
@Data
public class Idea74760Config {
    private String name = "idea_074760";
 ...
 */
@Slf4j
public class Idea74760Service {
    private static final int IDEA_ID = 74760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74760Service() {
        this(new Idea74760Config());
    }

    public Idea74760Service(Idea74760Config config) {
        this.config = config != null ? config : new Idea74760Config();
