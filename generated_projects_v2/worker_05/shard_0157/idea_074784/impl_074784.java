...
@Data
public class Idea74784Config {
    private String name = "idea_074784";
 ...
 */
@Slf4j
public class Idea74784Service {
    private static final int IDEA_ID = 74784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74784Service() {
        this(new Idea74784Config());
    }

    public Idea74784Service(Idea74784Config config) {
        this.config = config != null ? config : new Idea74784Config();
