...
@Data
public class Idea74607Config {
    private String name = "idea_074607";
 ...
 */
@Slf4j
public class Idea74607Service {
    private static final int IDEA_ID = 74607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74607Service() {
        this(new Idea74607Config());
    }

    public Idea74607Service(Idea74607Config config) {
        this.config = config != null ? config : new Idea74607Config();
