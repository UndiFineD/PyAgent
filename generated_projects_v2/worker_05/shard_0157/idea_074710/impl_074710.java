...
@Data
public class Idea74710Config {
    private String name = "idea_074710";
 ...
 */
@Slf4j
public class Idea74710Service {
    private static final int IDEA_ID = 74710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74710Service() {
        this(new Idea74710Config());
    }

    public Idea74710Service(Idea74710Config config) {
        this.config = config != null ? config : new Idea74710Config();
