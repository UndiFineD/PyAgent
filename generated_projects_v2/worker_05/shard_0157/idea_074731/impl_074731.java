...
@Data
public class Idea74731Config {
    private String name = "idea_074731";
 ...
 */
@Slf4j
public class Idea74731Service {
    private static final int IDEA_ID = 74731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74731Service() {
        this(new Idea74731Config());
    }

    public Idea74731Service(Idea74731Config config) {
        this.config = config != null ? config : new Idea74731Config();
