...
@Data
public class Idea74747Config {
    private String name = "idea_074747";
 ...
 */
@Slf4j
public class Idea74747Service {
    private static final int IDEA_ID = 74747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74747Service() {
        this(new Idea74747Config());
    }

    public Idea74747Service(Idea74747Config config) {
        this.config = config != null ? config : new Idea74747Config();
