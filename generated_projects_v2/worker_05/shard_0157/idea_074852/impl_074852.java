...
@Data
public class Idea74852Config {
    private String name = "idea_074852";
 ...
 */
@Slf4j
public class Idea74852Service {
    private static final int IDEA_ID = 74852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74852Service() {
        this(new Idea74852Config());
    }

    public Idea74852Service(Idea74852Config config) {
        this.config = config != null ? config : new Idea74852Config();
