...
@Data
public class Idea74844Config {
    private String name = "idea_074844";
 ...
 */
@Slf4j
public class Idea74844Service {
    private static final int IDEA_ID = 74844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74844Service() {
        this(new Idea74844Config());
    }

    public Idea74844Service(Idea74844Config config) {
        this.config = config != null ? config : new Idea74844Config();
