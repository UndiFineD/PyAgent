...
@Data
public class Idea74783Config {
    private String name = "idea_074783";
 ...
 */
@Slf4j
public class Idea74783Service {
    private static final int IDEA_ID = 74783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74783Service() {
        this(new Idea74783Config());
    }

    public Idea74783Service(Idea74783Config config) {
        this.config = config != null ? config : new Idea74783Config();
