...
@Data
public class Idea74681Config {
    private String name = "idea_074681";
 ...
 */
@Slf4j
public class Idea74681Service {
    private static final int IDEA_ID = 74681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74681Service() {
        this(new Idea74681Config());
    }

    public Idea74681Service(Idea74681Config config) {
        this.config = config != null ? config : new Idea74681Config();
