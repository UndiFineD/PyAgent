...
@Data
public class Idea74843Config {
    private String name = "idea_074843";
 ...
 */
@Slf4j
public class Idea74843Service {
    private static final int IDEA_ID = 74843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74843Service() {
        this(new Idea74843Config());
    }

    public Idea74843Service(Idea74843Config config) {
        this.config = config != null ? config : new Idea74843Config();
