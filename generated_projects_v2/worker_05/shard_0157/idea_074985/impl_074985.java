...
@Data
public class Idea74985Config {
    private String name = "idea_074985";
 ...
 */
@Slf4j
public class Idea74985Service {
    private static final int IDEA_ID = 74985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74985Service() {
        this(new Idea74985Config());
    }

    public Idea74985Service(Idea74985Config config) {
        this.config = config != null ? config : new Idea74985Config();
