...
@Data
public class Idea74688Config {
    private String name = "idea_074688";
 ...
 */
@Slf4j
public class Idea74688Service {
    private static final int IDEA_ID = 74688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74688Service() {
        this(new Idea74688Config());
    }

    public Idea74688Service(Idea74688Config config) {
        this.config = config != null ? config : new Idea74688Config();
