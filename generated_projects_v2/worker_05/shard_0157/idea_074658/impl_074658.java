...
@Data
public class Idea74658Config {
    private String name = "idea_074658";
 ...
 */
@Slf4j
public class Idea74658Service {
    private static final int IDEA_ID = 74658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74658Service() {
        this(new Idea74658Config());
    }

    public Idea74658Service(Idea74658Config config) {
        this.config = config != null ? config : new Idea74658Config();
