...
@Data
public class Idea74915Config {
    private String name = "idea_074915";
 ...
 */
@Slf4j
public class Idea74915Service {
    private static final int IDEA_ID = 74915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74915Service() {
        this(new Idea74915Config());
    }

    public Idea74915Service(Idea74915Config config) {
        this.config = config != null ? config : new Idea74915Config();
