...
@Data
public class Idea74995Config {
    private String name = "idea_074995";
 ...
 */
@Slf4j
public class Idea74995Service {
    private static final int IDEA_ID = 74995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74995Service() {
        this(new Idea74995Config());
    }

    public Idea74995Service(Idea74995Config config) {
        this.config = config != null ? config : new Idea74995Config();
