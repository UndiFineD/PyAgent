...
@Data
public class Idea74771Config {
    private String name = "idea_074771";
 ...
 */
@Slf4j
public class Idea74771Service {
    private static final int IDEA_ID = 74771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74771Service() {
        this(new Idea74771Config());
    }

    public Idea74771Service(Idea74771Config config) {
        this.config = config != null ? config : new Idea74771Config();
