...
@Data
public class Idea74897Config {
    private String name = "idea_074897";
 ...
 */
@Slf4j
public class Idea74897Service {
    private static final int IDEA_ID = 74897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74897Service() {
        this(new Idea74897Config());
    }

    public Idea74897Service(Idea74897Config config) {
        this.config = config != null ? config : new Idea74897Config();
