...
@Data
public class Idea74679Config {
    private String name = "idea_074679";
 ...
 */
@Slf4j
public class Idea74679Service {
    private static final int IDEA_ID = 74679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74679Service() {
        this(new Idea74679Config());
    }

    public Idea74679Service(Idea74679Config config) {
        this.config = config != null ? config : new Idea74679Config();
