...
@Data
public class Idea74880Config {
    private String name = "idea_074880";
 ...
 */
@Slf4j
public class Idea74880Service {
    private static final int IDEA_ID = 74880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74880Service() {
        this(new Idea74880Config());
    }

    public Idea74880Service(Idea74880Config config) {
        this.config = config != null ? config : new Idea74880Config();
