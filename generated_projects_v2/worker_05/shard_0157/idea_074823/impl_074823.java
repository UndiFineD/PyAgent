...
@Data
public class Idea74823Config {
    private String name = "idea_074823";
 ...
 */
@Slf4j
public class Idea74823Service {
    private static final int IDEA_ID = 74823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74823Service() {
        this(new Idea74823Config());
    }

    public Idea74823Service(Idea74823Config config) {
        this.config = config != null ? config : new Idea74823Config();
