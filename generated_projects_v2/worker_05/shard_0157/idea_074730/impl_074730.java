...
@Data
public class Idea74730Config {
    private String name = "idea_074730";
 ...
 */
@Slf4j
public class Idea74730Service {
    private static final int IDEA_ID = 74730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74730Service() {
        this(new Idea74730Config());
    }

    public Idea74730Service(Idea74730Config config) {
        this.config = config != null ? config : new Idea74730Config();
