...
@Data
public class Idea74791Config {
    private String name = "idea_074791";
 ...
 */
@Slf4j
public class Idea74791Service {
    private static final int IDEA_ID = 74791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74791Service() {
        this(new Idea74791Config());
    }

    public Idea74791Service(Idea74791Config config) {
        this.config = config != null ? config : new Idea74791Config();
