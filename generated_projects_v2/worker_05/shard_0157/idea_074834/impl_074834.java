...
@Data
public class Idea74834Config {
    private String name = "idea_074834";
 ...
 */
@Slf4j
public class Idea74834Service {
    private static final int IDEA_ID = 74834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74834Service() {
        this(new Idea74834Config());
    }

    public Idea74834Service(Idea74834Config config) {
        this.config = config != null ? config : new Idea74834Config();
