...
@Data
public class Idea74623Config {
    private String name = "idea_074623";
 ...
 */
@Slf4j
public class Idea74623Service {
    private static final int IDEA_ID = 74623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74623Service() {
        this(new Idea74623Config());
    }

    public Idea74623Service(Idea74623Config config) {
        this.config = config != null ? config : new Idea74623Config();
