...
@Data
public class Idea74886Config {
    private String name = "idea_074886";
 ...
 */
@Slf4j
public class Idea74886Service {
    private static final int IDEA_ID = 74886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74886Service() {
        this(new Idea74886Config());
    }

    public Idea74886Service(Idea74886Config config) {
        this.config = config != null ? config : new Idea74886Config();
