...
@Data
public class Idea74921Config {
    private String name = "idea_074921";
 ...
 */
@Slf4j
public class Idea74921Service {
    private static final int IDEA_ID = 74921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74921Service() {
        this(new Idea74921Config());
    }

    public Idea74921Service(Idea74921Config config) {
        this.config = config != null ? config : new Idea74921Config();
