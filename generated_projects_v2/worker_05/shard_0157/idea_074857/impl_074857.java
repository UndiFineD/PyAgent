...
@Data
public class Idea74857Config {
    private String name = "idea_074857";
 ...
 */
@Slf4j
public class Idea74857Service {
    private static final int IDEA_ID = 74857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74857Service() {
        this(new Idea74857Config());
    }

    public Idea74857Service(Idea74857Config config) {
        this.config = config != null ? config : new Idea74857Config();
