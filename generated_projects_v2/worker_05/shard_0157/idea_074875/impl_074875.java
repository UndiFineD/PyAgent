...
@Data
public class Idea74875Config {
    private String name = "idea_074875";
 ...
 */
@Slf4j
public class Idea74875Service {
    private static final int IDEA_ID = 74875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74875Service() {
        this(new Idea74875Config());
    }

    public Idea74875Service(Idea74875Config config) {
        this.config = config != null ? config : new Idea74875Config();
