...
@Data
public class Idea74916Config {
    private String name = "idea_074916";
 ...
 */
@Slf4j
public class Idea74916Service {
    private static final int IDEA_ID = 74916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74916Service() {
        this(new Idea74916Config());
    }

    public Idea74916Service(Idea74916Config config) {
        this.config = config != null ? config : new Idea74916Config();
