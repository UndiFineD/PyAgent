...
@Data
public class Idea74980Config {
    private String name = "idea_074980";
 ...
 */
@Slf4j
public class Idea74980Service {
    private static final int IDEA_ID = 74980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74980Service() {
        this(new Idea74980Config());
    }

    public Idea74980Service(Idea74980Config config) {
        this.config = config != null ? config : new Idea74980Config();
