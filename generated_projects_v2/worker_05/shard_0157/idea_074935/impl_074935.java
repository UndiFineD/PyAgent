...
@Data
public class Idea74935Config {
    private String name = "idea_074935";
 ...
 */
@Slf4j
public class Idea74935Service {
    private static final int IDEA_ID = 74935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74935Service() {
        this(new Idea74935Config());
    }

    public Idea74935Service(Idea74935Config config) {
        this.config = config != null ? config : new Idea74935Config();
