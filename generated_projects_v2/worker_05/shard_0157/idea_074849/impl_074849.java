...
@Data
public class Idea74849Config {
    private String name = "idea_074849";
 ...
 */
@Slf4j
public class Idea74849Service {
    private static final int IDEA_ID = 74849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74849Service() {
        this(new Idea74849Config());
    }

    public Idea74849Service(Idea74849Config config) {
        this.config = config != null ? config : new Idea74849Config();
