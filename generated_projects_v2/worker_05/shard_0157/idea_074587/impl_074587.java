...
@Data
public class Idea74587Config {
    private String name = "idea_074587";
 ...
 */
@Slf4j
public class Idea74587Service {
    private static final int IDEA_ID = 74587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74587Service() {
        this(new Idea74587Config());
    }

    public Idea74587Service(Idea74587Config config) {
        this.config = config != null ? config : new Idea74587Config();
