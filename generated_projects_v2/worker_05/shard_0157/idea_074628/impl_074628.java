...
@Data
public class Idea74628Config {
    private String name = "idea_074628";
 ...
 */
@Slf4j
public class Idea74628Service {
    private static final int IDEA_ID = 74628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74628Service() {
        this(new Idea74628Config());
    }

    public Idea74628Service(Idea74628Config config) {
        this.config = config != null ? config : new Idea74628Config();
