...
@Data
public class Idea74877Config {
    private String name = "idea_074877";
 ...
 */
@Slf4j
public class Idea74877Service {
    private static final int IDEA_ID = 74877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74877Service() {
        this(new Idea74877Config());
    }

    public Idea74877Service(Idea74877Config config) {
        this.config = config != null ? config : new Idea74877Config();
