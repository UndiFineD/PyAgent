...
@Data
public class Idea74874Config {
    private String name = "idea_074874";
 ...
 */
@Slf4j
public class Idea74874Service {
    private static final int IDEA_ID = 74874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74874Service() {
        this(new Idea74874Config());
    }

    public Idea74874Service(Idea74874Config config) {
        this.config = config != null ? config : new Idea74874Config();
