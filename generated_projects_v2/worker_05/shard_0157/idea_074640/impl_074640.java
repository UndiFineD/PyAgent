...
@Data
public class Idea74640Config {
    private String name = "idea_074640";
 ...
 */
@Slf4j
public class Idea74640Service {
    private static final int IDEA_ID = 74640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74640Service() {
        this(new Idea74640Config());
    }

    public Idea74640Service(Idea74640Config config) {
        this.config = config != null ? config : new Idea74640Config();
