...
@Data
public class Idea74940Config {
    private String name = "idea_074940";
 ...
 */
@Slf4j
public class Idea74940Service {
    private static final int IDEA_ID = 74940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74940Service() {
        this(new Idea74940Config());
    }

    public Idea74940Service(Idea74940Config config) {
        this.config = config != null ? config : new Idea74940Config();
