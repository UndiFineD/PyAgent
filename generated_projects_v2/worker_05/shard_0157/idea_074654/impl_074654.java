...
@Data
public class Idea74654Config {
    private String name = "idea_074654";
 ...
 */
@Slf4j
public class Idea74654Service {
    private static final int IDEA_ID = 74654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74654Service() {
        this(new Idea74654Config());
    }

    public Idea74654Service(Idea74654Config config) {
        this.config = config != null ? config : new Idea74654Config();
