...
@Data
public class Idea74803Config {
    private String name = "idea_074803";
 ...
 */
@Slf4j
public class Idea74803Service {
    private static final int IDEA_ID = 74803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74803Service() {
        this(new Idea74803Config());
    }

    public Idea74803Service(Idea74803Config config) {
        this.config = config != null ? config : new Idea74803Config();
