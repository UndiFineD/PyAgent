...
@Data
public class Idea74629Config {
    private String name = "idea_074629";
 ...
 */
@Slf4j
public class Idea74629Service {
    private static final int IDEA_ID = 74629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74629Service() {
        this(new Idea74629Config());
    }

    public Idea74629Service(Idea74629Config config) {
        this.config = config != null ? config : new Idea74629Config();
