...
@Data
public class Idea74599Config {
    private String name = "idea_074599";
 ...
 */
@Slf4j
public class Idea74599Service {
    private static final int IDEA_ID = 74599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74599Service() {
        this(new Idea74599Config());
    }

    public Idea74599Service(Idea74599Config config) {
        this.config = config != null ? config : new Idea74599Config();
