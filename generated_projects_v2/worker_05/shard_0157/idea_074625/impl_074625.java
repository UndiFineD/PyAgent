...
@Data
public class Idea74625Config {
    private String name = "idea_074625";
 ...
 */
@Slf4j
public class Idea74625Service {
    private static final int IDEA_ID = 74625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74625Service() {
        this(new Idea74625Config());
    }

    public Idea74625Service(Idea74625Config config) {
        this.config = config != null ? config : new Idea74625Config();
