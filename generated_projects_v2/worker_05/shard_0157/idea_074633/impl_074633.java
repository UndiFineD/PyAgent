...
@Data
public class Idea74633Config {
    private String name = "idea_074633";
 ...
 */
@Slf4j
public class Idea74633Service {
    private static final int IDEA_ID = 74633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74633Service() {
        this(new Idea74633Config());
    }

    public Idea74633Service(Idea74633Config config) {
        this.config = config != null ? config : new Idea74633Config();
