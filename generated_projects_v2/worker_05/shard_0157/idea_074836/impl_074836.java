...
@Data
public class Idea74836Config {
    private String name = "idea_074836";
 ...
 */
@Slf4j
public class Idea74836Service {
    private static final int IDEA_ID = 74836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74836Service() {
        this(new Idea74836Config());
    }

    public Idea74836Service(Idea74836Config config) {
        this.config = config != null ? config : new Idea74836Config();
