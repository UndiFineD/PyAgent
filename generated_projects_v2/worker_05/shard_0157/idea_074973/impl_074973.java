...
@Data
public class Idea74973Config {
    private String name = "idea_074973";
 ...
 */
@Slf4j
public class Idea74973Service {
    private static final int IDEA_ID = 74973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74973Service() {
        this(new Idea74973Config());
    }

    public Idea74973Service(Idea74973Config config) {
        this.config = config != null ? config : new Idea74973Config();
