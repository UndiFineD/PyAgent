...
@Data
public class Idea74826Config {
    private String name = "idea_074826";
 ...
 */
@Slf4j
public class Idea74826Service {
    private static final int IDEA_ID = 74826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74826Service() {
        this(new Idea74826Config());
    }

    public Idea74826Service(Idea74826Config config) {
        this.config = config != null ? config : new Idea74826Config();
