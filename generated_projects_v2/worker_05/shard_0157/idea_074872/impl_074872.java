...
@Data
public class Idea74872Config {
    private String name = "idea_074872";
 ...
 */
@Slf4j
public class Idea74872Service {
    private static final int IDEA_ID = 74872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74872Service() {
        this(new Idea74872Config());
    }

    public Idea74872Service(Idea74872Config config) {
        this.config = config != null ? config : new Idea74872Config();
