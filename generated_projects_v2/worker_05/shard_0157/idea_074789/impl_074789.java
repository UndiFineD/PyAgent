...
@Data
public class Idea74789Config {
    private String name = "idea_074789";
 ...
 */
@Slf4j
public class Idea74789Service {
    private static final int IDEA_ID = 74789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74789Service() {
        this(new Idea74789Config());
    }

    public Idea74789Service(Idea74789Config config) {
        this.config = config != null ? config : new Idea74789Config();
