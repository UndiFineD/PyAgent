...
@Data
public class Idea74660Config {
    private String name = "idea_074660";
 ...
 */
@Slf4j
public class Idea74660Service {
    private static final int IDEA_ID = 74660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74660Service() {
        this(new Idea74660Config());
    }

    public Idea74660Service(Idea74660Config config) {
        this.config = config != null ? config : new Idea74660Config();
