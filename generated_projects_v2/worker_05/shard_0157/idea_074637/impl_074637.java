...
@Data
public class Idea74637Config {
    private String name = "idea_074637";
 ...
 */
@Slf4j
public class Idea74637Service {
    private static final int IDEA_ID = 74637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74637Service() {
        this(new Idea74637Config());
    }

    public Idea74637Service(Idea74637Config config) {
        this.config = config != null ? config : new Idea74637Config();
