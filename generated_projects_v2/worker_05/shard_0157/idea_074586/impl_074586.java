...
@Data
public class Idea74586Config {
    private String name = "idea_074586";
 ...
 */
@Slf4j
public class Idea74586Service {
    private static final int IDEA_ID = 74586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74586Service() {
        this(new Idea74586Config());
    }

    public Idea74586Service(Idea74586Config config) {
        this.config = config != null ? config : new Idea74586Config();
