...
@Data
public class Idea74824Config {
    private String name = "idea_074824";
 ...
 */
@Slf4j
public class Idea74824Service {
    private static final int IDEA_ID = 74824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74824Service() {
        this(new Idea74824Config());
    }

    public Idea74824Service(Idea74824Config config) {
        this.config = config != null ? config : new Idea74824Config();
