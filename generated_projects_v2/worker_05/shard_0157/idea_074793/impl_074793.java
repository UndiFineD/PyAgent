...
@Data
public class Idea74793Config {
    private String name = "idea_074793";
 ...
 */
@Slf4j
public class Idea74793Service {
    private static final int IDEA_ID = 74793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74793Service() {
        this(new Idea74793Config());
    }

    public Idea74793Service(Idea74793Config config) {
        this.config = config != null ? config : new Idea74793Config();
