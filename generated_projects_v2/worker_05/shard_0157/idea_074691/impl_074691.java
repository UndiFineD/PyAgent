...
@Data
public class Idea74691Config {
    private String name = "idea_074691";
 ...
 */
@Slf4j
public class Idea74691Service {
    private static final int IDEA_ID = 74691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74691Service() {
        this(new Idea74691Config());
    }

    public Idea74691Service(Idea74691Config config) {
        this.config = config != null ? config : new Idea74691Config();
