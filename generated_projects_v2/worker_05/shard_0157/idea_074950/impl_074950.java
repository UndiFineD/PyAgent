...
@Data
public class Idea74950Config {
    private String name = "idea_074950";
 ...
 */
@Slf4j
public class Idea74950Service {
    private static final int IDEA_ID = 74950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74950Service() {
        this(new Idea74950Config());
    }

    public Idea74950Service(Idea74950Config config) {
        this.config = config != null ? config : new Idea74950Config();
