...
@Data
public class Idea74858Config {
    private String name = "idea_074858";
 ...
 */
@Slf4j
public class Idea74858Service {
    private static final int IDEA_ID = 74858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74858Service() {
        this(new Idea74858Config());
    }

    public Idea74858Service(Idea74858Config config) {
        this.config = config != null ? config : new Idea74858Config();
