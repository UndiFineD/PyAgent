...
@Data
public class Idea74725Config {
    private String name = "idea_074725";
 ...
 */
@Slf4j
public class Idea74725Service {
    private static final int IDEA_ID = 74725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74725Service() {
        this(new Idea74725Config());
    }

    public Idea74725Service(Idea74725Config config) {
        this.config = config != null ? config : new Idea74725Config();
