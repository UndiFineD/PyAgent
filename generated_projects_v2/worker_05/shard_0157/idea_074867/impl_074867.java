...
@Data
public class Idea74867Config {
    private String name = "idea_074867";
 ...
 */
@Slf4j
public class Idea74867Service {
    private static final int IDEA_ID = 74867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74867Service() {
        this(new Idea74867Config());
    }

    public Idea74867Service(Idea74867Config config) {
        this.config = config != null ? config : new Idea74867Config();
