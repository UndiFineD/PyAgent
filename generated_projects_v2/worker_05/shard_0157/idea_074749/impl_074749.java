...
@Data
public class Idea74749Config {
    private String name = "idea_074749";
 ...
 */
@Slf4j
public class Idea74749Service {
    private static final int IDEA_ID = 74749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74749Service() {
        this(new Idea74749Config());
    }

    public Idea74749Service(Idea74749Config config) {
        this.config = config != null ? config : new Idea74749Config();
