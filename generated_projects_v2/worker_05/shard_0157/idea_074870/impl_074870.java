...
@Data
public class Idea74870Config {
    private String name = "idea_074870";
 ...
 */
@Slf4j
public class Idea74870Service {
    private static final int IDEA_ID = 74870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74870Service() {
        this(new Idea74870Config());
    }

    public Idea74870Service(Idea74870Config config) {
        this.config = config != null ? config : new Idea74870Config();
