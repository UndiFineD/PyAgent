...
@Data
public class Idea74674Config {
    private String name = "idea_074674";
 ...
 */
@Slf4j
public class Idea74674Service {
    private static final int IDEA_ID = 74674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74674Service() {
        this(new Idea74674Config());
    }

    public Idea74674Service(Idea74674Config config) {
        this.config = config != null ? config : new Idea74674Config();
