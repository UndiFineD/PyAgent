...
@Data
public class Idea74652Config {
    private String name = "idea_074652";
 ...
 */
@Slf4j
public class Idea74652Service {
    private static final int IDEA_ID = 74652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74652Service() {
        this(new Idea74652Config());
    }

    public Idea74652Service(Idea74652Config config) {
        this.config = config != null ? config : new Idea74652Config();
