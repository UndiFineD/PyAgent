...
@Data
public class Idea74981Config {
    private String name = "idea_074981";
 ...
 */
@Slf4j
public class Idea74981Service {
    private static final int IDEA_ID = 74981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74981Service() {
        this(new Idea74981Config());
    }

    public Idea74981Service(Idea74981Config config) {
        this.config = config != null ? config : new Idea74981Config();
