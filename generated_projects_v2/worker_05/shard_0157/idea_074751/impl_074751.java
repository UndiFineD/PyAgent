...
@Data
public class Idea74751Config {
    private String name = "idea_074751";
 ...
 */
@Slf4j
public class Idea74751Service {
    private static final int IDEA_ID = 74751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74751Service() {
        this(new Idea74751Config());
    }

    public Idea74751Service(Idea74751Config config) {
        this.config = config != null ? config : new Idea74751Config();
