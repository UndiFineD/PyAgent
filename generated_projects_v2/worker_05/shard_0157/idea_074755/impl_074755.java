...
@Data
public class Idea74755Config {
    private String name = "idea_074755";
 ...
 */
@Slf4j
public class Idea74755Service {
    private static final int IDEA_ID = 74755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74755Service() {
        this(new Idea74755Config());
    }

    public Idea74755Service(Idea74755Config config) {
        this.config = config != null ? config : new Idea74755Config();
