...
@Data
public class Idea74644Config {
    private String name = "idea_074644";
 ...
 */
@Slf4j
public class Idea74644Service {
    private static final int IDEA_ID = 74644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74644Service() {
        this(new Idea74644Config());
    }

    public Idea74644Service(Idea74644Config config) {
        this.config = config != null ? config : new Idea74644Config();
