...
@Data
public class Idea74855Config {
    private String name = "idea_074855";
 ...
 */
@Slf4j
public class Idea74855Service {
    private static final int IDEA_ID = 74855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74855Service() {
        this(new Idea74855Config());
    }

    public Idea74855Service(Idea74855Config config) {
        this.config = config != null ? config : new Idea74855Config();
