...
@Data
public class Idea74609Config {
    private String name = "idea_074609";
 ...
 */
@Slf4j
public class Idea74609Service {
    private static final int IDEA_ID = 74609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74609Service() {
        this(new Idea74609Config());
    }

    public Idea74609Service(Idea74609Config config) {
        this.config = config != null ? config : new Idea74609Config();
