...
@Data
public class Idea74883Config {
    private String name = "idea_074883";
 ...
 */
@Slf4j
public class Idea74883Service {
    private static final int IDEA_ID = 74883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74883Service() {
        this(new Idea74883Config());
    }

    public Idea74883Service(Idea74883Config config) {
        this.config = config != null ? config : new Idea74883Config();
