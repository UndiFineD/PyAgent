...
@Data
public class Idea74795Config {
    private String name = "idea_074795";
 ...
 */
@Slf4j
public class Idea74795Service {
    private static final int IDEA_ID = 74795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74795Service() {
        this(new Idea74795Config());
    }

    public Idea74795Service(Idea74795Config config) {
        this.config = config != null ? config : new Idea74795Config();
