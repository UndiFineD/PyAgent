...
@Data
public class Idea74655Config {
    private String name = "idea_074655";
 ...
 */
@Slf4j
public class Idea74655Service {
    private static final int IDEA_ID = 74655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74655Service() {
        this(new Idea74655Config());
    }

    public Idea74655Service(Idea74655Config config) {
        this.config = config != null ? config : new Idea74655Config();
