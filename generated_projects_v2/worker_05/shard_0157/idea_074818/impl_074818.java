...
@Data
public class Idea74818Config {
    private String name = "idea_074818";
 ...
 */
@Slf4j
public class Idea74818Service {
    private static final int IDEA_ID = 74818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74818Service() {
        this(new Idea74818Config());
    }

    public Idea74818Service(Idea74818Config config) {
        this.config = config != null ? config : new Idea74818Config();
