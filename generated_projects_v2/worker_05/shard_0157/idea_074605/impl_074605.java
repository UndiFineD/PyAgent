...
@Data
public class Idea74605Config {
    private String name = "idea_074605";
 ...
 */
@Slf4j
public class Idea74605Service {
    private static final int IDEA_ID = 74605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74605Service() {
        this(new Idea74605Config());
    }

    public Idea74605Service(Idea74605Config config) {
        this.config = config != null ? config : new Idea74605Config();
