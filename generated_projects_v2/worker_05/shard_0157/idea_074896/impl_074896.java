...
@Data
public class Idea74896Config {
    private String name = "idea_074896";
 ...
 */
@Slf4j
public class Idea74896Service {
    private static final int IDEA_ID = 74896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74896Service() {
        this(new Idea74896Config());
    }

    public Idea74896Service(Idea74896Config config) {
        this.config = config != null ? config : new Idea74896Config();
