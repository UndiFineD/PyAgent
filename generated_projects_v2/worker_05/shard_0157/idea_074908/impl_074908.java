...
@Data
public class Idea74908Config {
    private String name = "idea_074908";
 ...
 */
@Slf4j
public class Idea74908Service {
    private static final int IDEA_ID = 74908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74908Service() {
        this(new Idea74908Config());
    }

    public Idea74908Service(Idea74908Config config) {
        this.config = config != null ? config : new Idea74908Config();
