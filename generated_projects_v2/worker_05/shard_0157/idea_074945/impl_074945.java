...
@Data
public class Idea74945Config {
    private String name = "idea_074945";
 ...
 */
@Slf4j
public class Idea74945Service {
    private static final int IDEA_ID = 74945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74945Service() {
        this(new Idea74945Config());
    }

    public Idea74945Service(Idea74945Config config) {
        this.config = config != null ? config : new Idea74945Config();
