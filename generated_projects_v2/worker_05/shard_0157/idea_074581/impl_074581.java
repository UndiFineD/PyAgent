...
@Data
public class Idea74581Config {
    private String name = "idea_074581";
 ...
 */
@Slf4j
public class Idea74581Service {
    private static final int IDEA_ID = 74581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74581Service() {
        this(new Idea74581Config());
    }

    public Idea74581Service(Idea74581Config config) {
        this.config = config != null ? config : new Idea74581Config();
