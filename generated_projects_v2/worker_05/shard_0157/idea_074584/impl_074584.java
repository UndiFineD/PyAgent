...
@Data
public class Idea74584Config {
    private String name = "idea_074584";
 ...
 */
@Slf4j
public class Idea74584Service {
    private static final int IDEA_ID = 74584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74584Service() {
        this(new Idea74584Config());
    }

    public Idea74584Service(Idea74584Config config) {
        this.config = config != null ? config : new Idea74584Config();
