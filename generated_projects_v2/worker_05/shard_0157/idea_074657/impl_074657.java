...
@Data
public class Idea74657Config {
    private String name = "idea_074657";
 ...
 */
@Slf4j
public class Idea74657Service {
    private static final int IDEA_ID = 74657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74657Service() {
        this(new Idea74657Config());
    }

    public Idea74657Service(Idea74657Config config) {
        this.config = config != null ? config : new Idea74657Config();
