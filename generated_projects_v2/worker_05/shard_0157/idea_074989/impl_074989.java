...
@Data
public class Idea74989Config {
    private String name = "idea_074989";
 ...
 */
@Slf4j
public class Idea74989Service {
    private static final int IDEA_ID = 74989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74989Service() {
        this(new Idea74989Config());
    }

    public Idea74989Service(Idea74989Config config) {
        this.config = config != null ? config : new Idea74989Config();
