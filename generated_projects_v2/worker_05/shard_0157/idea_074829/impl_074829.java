...
@Data
public class Idea74829Config {
    private String name = "idea_074829";
 ...
 */
@Slf4j
public class Idea74829Service {
    private static final int IDEA_ID = 74829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74829Service() {
        this(new Idea74829Config());
    }

    public Idea74829Service(Idea74829Config config) {
        this.config = config != null ? config : new Idea74829Config();
