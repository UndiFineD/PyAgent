...
@Data
public class Idea74762Config {
    private String name = "idea_074762";
 ...
 */
@Slf4j
public class Idea74762Service {
    private static final int IDEA_ID = 74762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74762Service() {
        this(new Idea74762Config());
    }

    public Idea74762Service(Idea74762Config config) {
        this.config = config != null ? config : new Idea74762Config();
