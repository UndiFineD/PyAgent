...
@Data
public class Idea74878Config {
    private String name = "idea_074878";
 ...
 */
@Slf4j
public class Idea74878Service {
    private static final int IDEA_ID = 74878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74878Service() {
        this(new Idea74878Config());
    }

    public Idea74878Service(Idea74878Config config) {
        this.config = config != null ? config : new Idea74878Config();
