...
@Data
public class Idea74969Config {
    private String name = "idea_074969";
 ...
 */
@Slf4j
public class Idea74969Service {
    private static final int IDEA_ID = 74969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74969Service() {
        this(new Idea74969Config());
    }

    public Idea74969Service(Idea74969Config config) {
        this.config = config != null ? config : new Idea74969Config();
