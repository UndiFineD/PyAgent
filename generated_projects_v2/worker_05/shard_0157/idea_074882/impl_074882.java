...
@Data
public class Idea74882Config {
    private String name = "idea_074882";
 ...
 */
@Slf4j
public class Idea74882Service {
    private static final int IDEA_ID = 74882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74882Service() {
        this(new Idea74882Config());
    }

    public Idea74882Service(Idea74882Config config) {
        this.config = config != null ? config : new Idea74882Config();
