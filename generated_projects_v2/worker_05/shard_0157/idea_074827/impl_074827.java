...
@Data
public class Idea74827Config {
    private String name = "idea_074827";
 ...
 */
@Slf4j
public class Idea74827Service {
    private static final int IDEA_ID = 74827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74827Service() {
        this(new Idea74827Config());
    }

    public Idea74827Service(Idea74827Config config) {
        this.config = config != null ? config : new Idea74827Config();
