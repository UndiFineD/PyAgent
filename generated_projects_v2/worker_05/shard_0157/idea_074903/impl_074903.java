...
@Data
public class Idea74903Config {
    private String name = "idea_074903";
 ...
 */
@Slf4j
public class Idea74903Service {
    private static final int IDEA_ID = 74903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74903Service() {
        this(new Idea74903Config());
    }

    public Idea74903Service(Idea74903Config config) {
        this.config = config != null ? config : new Idea74903Config();
