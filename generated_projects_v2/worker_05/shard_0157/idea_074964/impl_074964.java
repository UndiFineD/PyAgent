...
@Data
public class Idea74964Config {
    private String name = "idea_074964";
 ...
 */
@Slf4j
public class Idea74964Service {
    private static final int IDEA_ID = 74964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74964Service() {
        this(new Idea74964Config());
    }

    public Idea74964Service(Idea74964Config config) {
        this.config = config != null ? config : new Idea74964Config();
