...
@Data
public class Idea74702Config {
    private String name = "idea_074702";
 ...
 */
@Slf4j
public class Idea74702Service {
    private static final int IDEA_ID = 74702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74702Service() {
        this(new Idea74702Config());
    }

    public Idea74702Service(Idea74702Config config) {
        this.config = config != null ? config : new Idea74702Config();
