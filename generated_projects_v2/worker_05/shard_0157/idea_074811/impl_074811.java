...
@Data
public class Idea74811Config {
    private String name = "idea_074811";
 ...
 */
@Slf4j
public class Idea74811Service {
    private static final int IDEA_ID = 74811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74811Service() {
        this(new Idea74811Config());
    }

    public Idea74811Service(Idea74811Config config) {
        this.config = config != null ? config : new Idea74811Config();
