...
@Data
public class Idea74670Config {
    private String name = "idea_074670";
 ...
 */
@Slf4j
public class Idea74670Service {
    private static final int IDEA_ID = 74670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74670Service() {
        this(new Idea74670Config());
    }

    public Idea74670Service(Idea74670Config config) {
        this.config = config != null ? config : new Idea74670Config();
