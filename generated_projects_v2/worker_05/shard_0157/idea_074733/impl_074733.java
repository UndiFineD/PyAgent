...
@Data
public class Idea74733Config {
    private String name = "idea_074733";
 ...
 */
@Slf4j
public class Idea74733Service {
    private static final int IDEA_ID = 74733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74733Service() {
        this(new Idea74733Config());
    }

    public Idea74733Service(Idea74733Config config) {
        this.config = config != null ? config : new Idea74733Config();
