...
@Data
public class Idea74949Config {
    private String name = "idea_074949";
 ...
 */
@Slf4j
public class Idea74949Service {
    private static final int IDEA_ID = 74949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74949Service() {
        this(new Idea74949Config());
    }

    public Idea74949Service(Idea74949Config config) {
        this.config = config != null ? config : new Idea74949Config();
