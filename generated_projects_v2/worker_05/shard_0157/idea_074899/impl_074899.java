...
@Data
public class Idea74899Config {
    private String name = "idea_074899";
 ...
 */
@Slf4j
public class Idea74899Service {
    private static final int IDEA_ID = 74899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74899Service() {
        this(new Idea74899Config());
    }

    public Idea74899Service(Idea74899Config config) {
        this.config = config != null ? config : new Idea74899Config();
