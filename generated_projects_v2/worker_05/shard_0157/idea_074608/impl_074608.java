...
@Data
public class Idea74608Config {
    private String name = "idea_074608";
 ...
 */
@Slf4j
public class Idea74608Service {
    private static final int IDEA_ID = 74608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74608Service() {
        this(new Idea74608Config());
    }

    public Idea74608Service(Idea74608Config config) {
        this.config = config != null ? config : new Idea74608Config();
