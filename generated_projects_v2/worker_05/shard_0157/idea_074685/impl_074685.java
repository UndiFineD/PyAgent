...
@Data
public class Idea74685Config {
    private String name = "idea_074685";
 ...
 */
@Slf4j
public class Idea74685Service {
    private static final int IDEA_ID = 74685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74685Service() {
        this(new Idea74685Config());
    }

    public Idea74685Service(Idea74685Config config) {
        this.config = config != null ? config : new Idea74685Config();
