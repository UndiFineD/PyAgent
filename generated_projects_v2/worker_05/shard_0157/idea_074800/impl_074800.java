...
@Data
public class Idea74800Config {
    private String name = "idea_074800";
 ...
 */
@Slf4j
public class Idea74800Service {
    private static final int IDEA_ID = 74800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74800Service() {
        this(new Idea74800Config());
    }

    public Idea74800Service(Idea74800Config config) {
        this.config = config != null ? config : new Idea74800Config();
