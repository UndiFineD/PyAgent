...
@Data
public class Idea74740Config {
    private String name = "idea_074740";
 ...
 */
@Slf4j
public class Idea74740Service {
    private static final int IDEA_ID = 74740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74740Service() {
        this(new Idea74740Config());
    }

    public Idea74740Service(Idea74740Config config) {
        this.config = config != null ? config : new Idea74740Config();
