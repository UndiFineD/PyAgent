...
@Data
public class Idea74835Config {
    private String name = "idea_074835";
 ...
 */
@Slf4j
public class Idea74835Service {
    private static final int IDEA_ID = 74835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74835Service() {
        this(new Idea74835Config());
    }

    public Idea74835Service(Idea74835Config config) {
        this.config = config != null ? config : new Idea74835Config();
