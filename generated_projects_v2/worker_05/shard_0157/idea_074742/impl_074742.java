...
@Data
public class Idea74742Config {
    private String name = "idea_074742";
 ...
 */
@Slf4j
public class Idea74742Service {
    private static final int IDEA_ID = 74742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74742Service() {
        this(new Idea74742Config());
    }

    public Idea74742Service(Idea74742Config config) {
        this.config = config != null ? config : new Idea74742Config();
