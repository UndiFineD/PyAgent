...
@Data
public class Idea74904Config {
    private String name = "idea_074904";
 ...
 */
@Slf4j
public class Idea74904Service {
    private static final int IDEA_ID = 74904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74904Service() {
        this(new Idea74904Config());
    }

    public Idea74904Service(Idea74904Config config) {
        this.config = config != null ? config : new Idea74904Config();
