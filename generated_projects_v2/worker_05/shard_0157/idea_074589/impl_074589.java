...
@Data
public class Idea74589Config {
    private String name = "idea_074589";
 ...
 */
@Slf4j
public class Idea74589Service {
    private static final int IDEA_ID = 74589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74589Service() {
        this(new Idea74589Config());
    }

    public Idea74589Service(Idea74589Config config) {
        this.config = config != null ? config : new Idea74589Config();
