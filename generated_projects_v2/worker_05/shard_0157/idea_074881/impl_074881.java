...
@Data
public class Idea74881Config {
    private String name = "idea_074881";
 ...
 */
@Slf4j
public class Idea74881Service {
    private static final int IDEA_ID = 74881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74881Service() {
        this(new Idea74881Config());
    }

    public Idea74881Service(Idea74881Config config) {
        this.config = config != null ? config : new Idea74881Config();
