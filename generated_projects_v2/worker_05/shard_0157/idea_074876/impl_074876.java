...
@Data
public class Idea74876Config {
    private String name = "idea_074876";
 ...
 */
@Slf4j
public class Idea74876Service {
    private static final int IDEA_ID = 74876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74876Service() {
        this(new Idea74876Config());
    }

    public Idea74876Service(Idea74876Config config) {
        this.config = config != null ? config : new Idea74876Config();
