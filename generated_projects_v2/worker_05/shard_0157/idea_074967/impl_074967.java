...
@Data
public class Idea74967Config {
    private String name = "idea_074967";
 ...
 */
@Slf4j
public class Idea74967Service {
    private static final int IDEA_ID = 74967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74967Service() {
        this(new Idea74967Config());
    }

    public Idea74967Service(Idea74967Config config) {
        this.config = config != null ? config : new Idea74967Config();
