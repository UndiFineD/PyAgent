...
@Data
public class Idea74971Config {
    private String name = "idea_074971";
 ...
 */
@Slf4j
public class Idea74971Service {
    private static final int IDEA_ID = 74971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74971Service() {
        this(new Idea74971Config());
    }

    public Idea74971Service(Idea74971Config config) {
        this.config = config != null ? config : new Idea74971Config();
