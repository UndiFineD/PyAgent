...
@Data
public class Idea74965Config {
    private String name = "idea_074965";
 ...
 */
@Slf4j
public class Idea74965Service {
    private static final int IDEA_ID = 74965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74965Service() {
        this(new Idea74965Config());
    }

    public Idea74965Service(Idea74965Config config) {
        this.config = config != null ? config : new Idea74965Config();
