...
@Data
public class Idea74592Config {
    private String name = "idea_074592";
 ...
 */
@Slf4j
public class Idea74592Service {
    private static final int IDEA_ID = 74592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74592Service() {
        this(new Idea74592Config());
    }

    public Idea74592Service(Idea74592Config config) {
        this.config = config != null ? config : new Idea74592Config();
