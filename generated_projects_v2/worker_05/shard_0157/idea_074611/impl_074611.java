...
@Data
public class Idea74611Config {
    private String name = "idea_074611";
 ...
 */
@Slf4j
public class Idea74611Service {
    private static final int IDEA_ID = 74611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74611Service() {
        this(new Idea74611Config());
    }

    public Idea74611Service(Idea74611Config config) {
        this.config = config != null ? config : new Idea74611Config();
