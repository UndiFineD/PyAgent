...
@Data
public class Idea74678Config {
    private String name = "idea_074678";
 ...
 */
@Slf4j
public class Idea74678Service {
    private static final int IDEA_ID = 74678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74678Service() {
        this(new Idea74678Config());
    }

    public Idea74678Service(Idea74678Config config) {
        this.config = config != null ? config : new Idea74678Config();
