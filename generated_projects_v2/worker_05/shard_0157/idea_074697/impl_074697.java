...
@Data
public class Idea74697Config {
    private String name = "idea_074697";
 ...
 */
@Slf4j
public class Idea74697Service {
    private static final int IDEA_ID = 74697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74697Service() {
        this(new Idea74697Config());
    }

    public Idea74697Service(Idea74697Config config) {
        this.config = config != null ? config : new Idea74697Config();
