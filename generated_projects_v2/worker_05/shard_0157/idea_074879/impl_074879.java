...
@Data
public class Idea74879Config {
    private String name = "idea_074879";
 ...
 */
@Slf4j
public class Idea74879Service {
    private static final int IDEA_ID = 74879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74879Service() {
        this(new Idea74879Config());
    }

    public Idea74879Service(Idea74879Config config) {
        this.config = config != null ? config : new Idea74879Config();
