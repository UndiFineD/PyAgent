...
@Data
public class Idea74632Config {
    private String name = "idea_074632";
 ...
 */
@Slf4j
public class Idea74632Service {
    private static final int IDEA_ID = 74632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74632Service() {
        this(new Idea74632Config());
    }

    public Idea74632Service(Idea74632Config config) {
        this.config = config != null ? config : new Idea74632Config();
