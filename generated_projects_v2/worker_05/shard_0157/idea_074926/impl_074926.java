...
@Data
public class Idea74926Config {
    private String name = "idea_074926";
 ...
 */
@Slf4j
public class Idea74926Service {
    private static final int IDEA_ID = 74926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74926Service() {
        this(new Idea74926Config());
    }

    public Idea74926Service(Idea74926Config config) {
        this.config = config != null ? config : new Idea74926Config();
