...
@Data
public class Idea74856Config {
    private String name = "idea_074856";
 ...
 */
@Slf4j
public class Idea74856Service {
    private static final int IDEA_ID = 74856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74856Service() {
        this(new Idea74856Config());
    }

    public Idea74856Service(Idea74856Config config) {
        this.config = config != null ? config : new Idea74856Config();
