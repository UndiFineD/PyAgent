...
@Data
public class Idea74988Config {
    private String name = "idea_074988";
 ...
 */
@Slf4j
public class Idea74988Service {
    private static final int IDEA_ID = 74988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74988Service() {
        this(new Idea74988Config());
    }

    public Idea74988Service(Idea74988Config config) {
        this.config = config != null ? config : new Idea74988Config();
