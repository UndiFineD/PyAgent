...
@Data
public class Idea74583Config {
    private String name = "idea_074583";
 ...
 */
@Slf4j
public class Idea74583Service {
    private static final int IDEA_ID = 74583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74583Service() {
        this(new Idea74583Config());
    }

    public Idea74583Service(Idea74583Config config) {
        this.config = config != null ? config : new Idea74583Config();
