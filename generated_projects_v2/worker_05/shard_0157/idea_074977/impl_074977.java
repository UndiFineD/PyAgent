...
@Data
public class Idea74977Config {
    private String name = "idea_074977";
 ...
 */
@Slf4j
public class Idea74977Service {
    private static final int IDEA_ID = 74977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74977Service() {
        this(new Idea74977Config());
    }

    public Idea74977Service(Idea74977Config config) {
        this.config = config != null ? config : new Idea74977Config();
