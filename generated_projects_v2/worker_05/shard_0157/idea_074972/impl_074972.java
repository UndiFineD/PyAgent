...
@Data
public class Idea74972Config {
    private String name = "idea_074972";
 ...
 */
@Slf4j
public class Idea74972Service {
    private static final int IDEA_ID = 74972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74972Service() {
        this(new Idea74972Config());
    }

    public Idea74972Service(Idea74972Config config) {
        this.config = config != null ? config : new Idea74972Config();
