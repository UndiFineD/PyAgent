...
@Data
public class Idea74999Config {
    private String name = "idea_074999";
 ...
 */
@Slf4j
public class Idea74999Service {
    private static final int IDEA_ID = 74999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74999Service() {
        this(new Idea74999Config());
    }

    public Idea74999Service(Idea74999Config config) {
        this.config = config != null ? config : new Idea74999Config();
