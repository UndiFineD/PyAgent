...
@Data
public class Idea74809Config {
    private String name = "idea_074809";
 ...
 */
@Slf4j
public class Idea74809Service {
    private static final int IDEA_ID = 74809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74809Service() {
        this(new Idea74809Config());
    }

    public Idea74809Service(Idea74809Config config) {
        this.config = config != null ? config : new Idea74809Config();
