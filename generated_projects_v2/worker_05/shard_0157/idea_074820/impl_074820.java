...
@Data
public class Idea74820Config {
    private String name = "idea_074820";
 ...
 */
@Slf4j
public class Idea74820Service {
    private static final int IDEA_ID = 74820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74820Service() {
        this(new Idea74820Config());
    }

    public Idea74820Service(Idea74820Config config) {
        this.config = config != null ? config : new Idea74820Config();
