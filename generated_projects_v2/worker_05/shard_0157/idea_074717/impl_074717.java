...
@Data
public class Idea74717Config {
    private String name = "idea_074717";
 ...
 */
@Slf4j
public class Idea74717Service {
    private static final int IDEA_ID = 74717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74717Service() {
        this(new Idea74717Config());
    }

    public Idea74717Service(Idea74717Config config) {
        this.config = config != null ? config : new Idea74717Config();
