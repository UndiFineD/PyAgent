...
@Data
public class Idea74705Config {
    private String name = "idea_074705";
 ...
 */
@Slf4j
public class Idea74705Service {
    private static final int IDEA_ID = 74705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74705Service() {
        this(new Idea74705Config());
    }

    public Idea74705Service(Idea74705Config config) {
        this.config = config != null ? config : new Idea74705Config();
