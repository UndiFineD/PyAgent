...
@Data
public class Idea74990Config {
    private String name = "idea_074990";
 ...
 */
@Slf4j
public class Idea74990Service {
    private static final int IDEA_ID = 74990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74990Service() {
        this(new Idea74990Config());
    }

    public Idea74990Service(Idea74990Config config) {
        this.config = config != null ? config : new Idea74990Config();
