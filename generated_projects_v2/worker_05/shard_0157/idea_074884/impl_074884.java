...
@Data
public class Idea74884Config {
    private String name = "idea_074884";
 ...
 */
@Slf4j
public class Idea74884Service {
    private static final int IDEA_ID = 74884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74884Service() {
        this(new Idea74884Config());
    }

    public Idea74884Service(Idea74884Config config) {
        this.config = config != null ? config : new Idea74884Config();
