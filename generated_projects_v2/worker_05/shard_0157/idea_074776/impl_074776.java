...
@Data
public class Idea74776Config {
    private String name = "idea_074776";
 ...
 */
@Slf4j
public class Idea74776Service {
    private static final int IDEA_ID = 74776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74776Service() {
        this(new Idea74776Config());
    }

    public Idea74776Service(Idea74776Config config) {
        this.config = config != null ? config : new Idea74776Config();
