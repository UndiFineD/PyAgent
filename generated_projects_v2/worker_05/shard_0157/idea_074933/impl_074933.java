...
@Data
public class Idea74933Config {
    private String name = "idea_074933";
 ...
 */
@Slf4j
public class Idea74933Service {
    private static final int IDEA_ID = 74933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74933Service() {
        this(new Idea74933Config());
    }

    public Idea74933Service(Idea74933Config config) {
        this.config = config != null ? config : new Idea74933Config();
