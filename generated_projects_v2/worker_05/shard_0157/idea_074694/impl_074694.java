...
@Data
public class Idea74694Config {
    private String name = "idea_074694";
 ...
 */
@Slf4j
public class Idea74694Service {
    private static final int IDEA_ID = 74694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74694Service() {
        this(new Idea74694Config());
    }

    public Idea74694Service(Idea74694Config config) {
        this.config = config != null ? config : new Idea74694Config();
