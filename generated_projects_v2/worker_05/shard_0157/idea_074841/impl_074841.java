...
@Data
public class Idea74841Config {
    private String name = "idea_074841";
 ...
 */
@Slf4j
public class Idea74841Service {
    private static final int IDEA_ID = 74841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74841Service() {
        this(new Idea74841Config());
    }

    public Idea74841Service(Idea74841Config config) {
        this.config = config != null ? config : new Idea74841Config();
