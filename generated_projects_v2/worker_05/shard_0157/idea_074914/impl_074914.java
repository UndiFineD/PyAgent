...
@Data
public class Idea74914Config {
    private String name = "idea_074914";
 ...
 */
@Slf4j
public class Idea74914Service {
    private static final int IDEA_ID = 74914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74914Service() {
        this(new Idea74914Config());
    }

    public Idea74914Service(Idea74914Config config) {
        this.config = config != null ? config : new Idea74914Config();
