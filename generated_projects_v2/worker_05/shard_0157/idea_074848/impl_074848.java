...
@Data
public class Idea74848Config {
    private String name = "idea_074848";
 ...
 */
@Slf4j
public class Idea74848Service {
    private static final int IDEA_ID = 74848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74848Service() {
        this(new Idea74848Config());
    }

    public Idea74848Service(Idea74848Config config) {
        this.config = config != null ? config : new Idea74848Config();
