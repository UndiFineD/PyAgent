...
@Data
public class Idea74684Config {
    private String name = "idea_074684";
 ...
 */
@Slf4j
public class Idea74684Service {
    private static final int IDEA_ID = 74684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea74684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea74684Service() {
        this(new Idea74684Config());
    }

    public Idea74684Service(Idea74684Config config) {
        this.config = config != null ? config : new Idea74684Config();
