...
service = Idea123456Service()


def create_service(config: Optional[Idea123456Config] = None) -> Idea123456Service:
    """Factory function"""
    return Idea123456Service(config)
