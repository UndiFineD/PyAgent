...
class TestCachedRequestState:
    ...
    def test_create_cached_request_state(self):
        ...
        from src.infrastructure.execution.InputBatchOrchestrator import CachedRequestState
...
class TestInputBuffers:
    ...
    def test_create_input_buffers(self):
        ...
        from src.infrastructure.execution.InputBatchOrchestrator import InputBuffers
...
class TestBatchUpdateBuilder:
    ...
    def test_batch_update_builder_record_swap(self):
        ...
        from src.infrastructure.execution.InputBatchOrchestrator import BatchUpdateBuilder
...
class TestInputBatchOrchestrator:
    ...
    def test_create_orchestrator(self):
        ...
        from src.infrastructure.execution.InputBatchOrchestrator import InputBatchOrchestrator
...
class TestBatchDescriptor:
    ...
    def test_create_batch_descriptor(self):
        ...
        from src.infrastructure.execution.CUDAGraphManager import BatchDescriptor
...
class TestCUDAGraphRegistry:
    ...
    def test_create_registry(self):
        ...
        from src.infrastructure.execution.CUDAGraphManager import CUDAGraphRegistry
    ...
    def test_registry_put_and_get(self):
        ...
        from src.infrastructure.execution.CUDAGraphManager import (
            CUDAGraphRegistry,
            CUDAGraphEntry,
        )
...
class TestCUDAGraphManager:
    ...
    def test_graph_mode_enum(self):
        ...
        from src.infrastructure.execution.CUDAGraphManager import CUDAGraphMode
...
class TestBatchInvariantOps:
    ...
    def test_softmax_batch_invariant(self):
        ...
        from src.core.base.math.BatchInvariantOps import softmax_batch_invariant
    ...
    def test_mean_batch_invariant(self):
        ...
        from src.core.base.math.BatchInvariantOps import mean_batch_invariant
    ...
    def test_mm_batch_invariant(self):
        ...
        from src.core.base.math.BatchInvariantOps import mm_batch_invariant
    ...
    def test_layer_norm_batch_invariant(self):
        ...
        from src.core.base.math.BatchInvariantOps import layer_norm_batch_invariant
    ...
    def test_gelu_batch_invariant(self):
        ...
        from src.core.base.math.BatchInvariantOps import gelu_batch_invariant
...
class TestParallelConfig:
    ...
    def test_create_parallel_config(self):
        ...
        from src.infrastructure.distributed.TensorParallelGroup import ParallelConfig
...
class TestRankInfo:
    ...
    def test_create_rank_info(self):
        ...
        from src.infrastructure.distributed.TensorParallelGroup import RankInfo
...
class TestGroupCoordinator:
    ...
    def test_create_group_coordinator(self):
        ...
        from src.infrastructure.distributed.TensorParallelGroup import (
            GroupCoordinator,
            ParallelConfig,
            RankInfo,
        )
...
class TestNCCLConfig:
    ...
    def test_create_nccl_config(self):
        ...
        from src.infrastructure.distributed.NCCLCommunicator import NCCLConfig
...
class TestNCCLCommunicator:
    ...
    def test_create_communicator(self):
        ...
        from src.infrastructure.distributed.NCCLCommunicator import NCCLCommunicator
...
class TestReduceOp:
    ...
    def test_reduce_ops(self):
        ...
        from src.infrastructure.distributed.NCCLCommunicator import ReduceOp
...
class TestAttentionBackendEnum:
    ...
    def test_backend_enum_values(self):
        ...
        from src.infrastructure.attention.AttentionBackendRegistry import AttentionBackendEnum
...
class TestAttentionCapabilities:
    ...
    def test_create_capabilities(self):
        ...
        from src.infrastructure.attention.AttentionBackendRegistry import AttentionCapabilities
...
class TestNaiveAttentionBackend:
    ...
    def test_naive_backend_name(self):
        ...
        from src.infrastructure.attention.AttentionBackendRegistry import NaiveAttentionBackend
...
class TestAttentionBackendRegistry:
    ...
    def test_singleton_pattern(self):
        ...
        from src.infrastructure.attention.AttentionBackendRegistry import AttentionBackendRegistry
    ...
    def test_list_backends(self):
        ...
        from src.infrastructure.attention.AttentionBackendRegistry import get_attention_registry
...
class TestPhase33Integration:
    ...
    def test_input_batch_to_attention(self):
        ...
        from src.infrastructure.execution.InputBatchOrchestrator import (
            CachedRequestState,
            BatchUpdateBuilder,
        )
        from src.infrastructure.attention.AttentionBackendRegistry import (
