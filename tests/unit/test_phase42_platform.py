...
class TestPlatformEnums:
    ...
    def test_platform_type_values(self):
        ...
        from src.infrastructure.platform.PlatformInterface import PlatformType
    ...
    def test_cpu_architecture_values(self):
        ...
        from src.infrastructure.platform.PlatformInterface import CpuArchitecture
    ...
    def test_quantization_type_values(self):
        ...
        from src.infrastructure.platform.PlatformInterface import QuantizationType
    ...
    def test_attention_backend_values(self):
        ...
        from src.infrastructure.platform.PlatformInterface import AttentionBackend
    ...
    def test_device_feature_flags(self):
        ...
        from src.infrastructure.platform.PlatformInterface import DeviceFeature
...
class TestDeviceCapability:
    ...
    def test_capability_creation(self):
        ...
        from src.infrastructure.platform.PlatformInterface import DeviceCapability
...
class TestMemoryInfo:
    ...
    def test_memory_info_creation(self):
        ...
        from src.infrastructure.platform.PlatformInterface import MemoryInfo
...
class TestDeviceInfo:
    ...
    def test_device_info_creation(self):
        ...
        from src.infrastructure.platform.PlatformInterface import (
            DeviceInfo,
            DeviceCapability,
            MemoryInfo,
            PlatformType,
...
class TestCpuPlatform:
    ...
    def test_cpu_always_available(self):
        ...
        from src.infrastructure.platform.PlatformInterface import CpuPlatform
...
class TestPlatformRegistry:
    ...
    def test_registry_singleton(self):
        ...
        from src.infrastructure.platform.PlatformInterface import PlatformRegistry
...
class TestConvenienceFunctions:
    ...
    def test_get_device_count(self):
        ...
        from src.infrastructure.platform.PlatformInterface import get_device_count
...
class TestMockCudaPlatform:
    ...
    def test_cuda_platform_with_mock(self, mock_torch):
        ...
        from src.infrastructure.platform.PlatformInterface import CudaPlatform
