...
class TestPerformanceMetrics(unittest.TestCase):
    ...
    def test_track_cpu_metrics(self) -> None:
...
class TestBenchmarking(unittest.TestCase):
    ...
    def test_aggregate_benchmark_results(self) -> None:
        ...
        total_time: int = sum(b["time_ms"] for b in benchmarks)
        avg_time: float = total_time / len(benchmarks)
