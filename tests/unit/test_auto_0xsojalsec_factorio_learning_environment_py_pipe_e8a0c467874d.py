...
p = Path(r"C:\DEV\PyAgent\src\external_candidates\auto\0xsojalsec_factorio_learning_environment_py_pipe_e8a0c467874d.py")
...
assert hasattr(mod, 'is_pipe'), 'missing is_pipe'
