...
class TestDnsSecurityCore:
    ...
    async def test_check_domain_filter_blocked(self):
        """Test domain filtering for blocked domains."""
    ...
    async def test_check_domain_filter_allowed(self):
        """Test domain filtering for allowed domains."""
    ...
    async def test_process_dns_query_allowed(self):
        """Test processing an allowed DNS query."""
    ...
    async def test_get_dns_statistics(self):
        ...
        await core.process_dns_query("ads.example.com", DnsRecordType.A, "192.168.1.100")  # Should be blocked
