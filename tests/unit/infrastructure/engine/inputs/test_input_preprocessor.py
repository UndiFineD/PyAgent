...
class TestEnums:
    ...
    def test_prompt_type_values(self):
        ...
        assert PromptType.TEXT is not None
    ...
    def test_input_format_values(self):
        ...
        assert InputFormat.RAW is not None
...
class TestTextPrompt:
    ...
    def test_text_prompt_with_cache_salt(self):
        """Test TextPrompt with cache_salt."""
        prompt = TextPrompt(
            prompt="Test prompt",
            cache_salt="custom_salt",
        )
...
class TestTokensPrompt:
    ...
    def test_tokens_prompt_length(self):
        """Test TokensPrompt length property."""
...
class TestChatPrompt:
    ...
    def test_chat_prompt_with_system(self):
        """Test ChatPrompt with system message."""
        messages = [
...
class TestPromptTemplate:
    ...
    def test_chatml_template(self):
        ...
        template = PromptTemplate.get_template(InputFormat.CHATML)
    ...
    def test_llama_template(self):
        ...
        template = PromptTemplate.get_template(InputFormat.LLAMA)
    ...
    def test_anthropic_template(self):
        ...
        template = PromptTemplate.get_template(InputFormat.ANTHROPIC)
...
class TestPromptValidator:
    ...
    def test_validate_valid_text(self):
        """Test validating valid text prompt."""
    ...
    def test_validate_empty_chat(self):
        """Test validating empty chat messages."""
        validator = PromptValidator()
...
class TestConversationLinearizer:
    ...
    def test_linearize_to_chatml(self):
        ...
        linearizer = ConversationLinearizer(format=InputFormat.CHATML)
    ...
    def test_linearize_to_llama(self):
        ...
        linearizer = ConversationLinearizer(format=InputFormat.LLAMA)
    ...
    def test_linearize_to_raw(self):
        """Test linearizing to raw format."""
        linearizer = ConversationLinearizer(format=InputFormat.RAW)
...
class TestInputPreprocessor:
    ...
    def test_process_chat_messages(self):
        ...
        preprocessor = InputPreprocessor(default_format=InputFormat.CHATML)
...
class TestUtilityFunctions:
    ...
    def test_parse_prompt_string(self):
        ...
        result = parse_prompt("Hello")

        assert result is not None

    def test_parse_prompt_dict(self):
        """Test parsing dict prompt."""
        prompt = {
            "messages": [
