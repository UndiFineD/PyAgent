...
class TestSpeculativeDecoder:
    ...
    def test_speculative_config_defaults(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import SpeculativeConfig
    ...
    def test_speculative_config_custom(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import (
            SpeculativeConfig,
            SpecMethod,
        )
    ...
    def test_draft_proposal_dataclass(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import DraftProposal
    ...
    def test_verification_result_dataclass(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import VerificationResult
    ...
    def test_spec_decoding_metrics(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import SpecDecodingMetrics
    ...
    def test_spec_method_enum(self):
        ...
        from src.infrastructure.inference.SpeculativeDecoder import SpecMethod
...
class TestPrefixCache:
    ...
    def test_prefix_cache_config_defaults(self):
        ...
        from src.infrastructure.cache.PrefixCache import PrefixCacheConfig
    ...
    def test_prefix_cache_config_custom(self):
        ...
        from src.infrastructure.cache.PrefixCache import (
            PrefixCacheConfig,
            EvictionPolicy,
        )
    ...
    def test_cache_block_creation(self):
        ...
        from src.infrastructure.cache.PrefixCache import CacheBlock
    ...
    def test_prefix_cache_stats(self):
        ...
        from src.infrastructure.cache.PrefixCache import PrefixCacheStats
    ...
    def test_compute_block_hash(self):
        ...
        from src.infrastructure.cache.PrefixCache import compute_block_hash
    ...
    def test_eviction_policy_enum(self):
        ...
        from src.infrastructure.cache.PrefixCache import EvictionPolicy
...
class TestKVCacheManager:
    ...
    def test_kv_cache_config_creation(self):
        ...
        from src.infrastructure.cache.KVCacheManager import KVCacheConfig
    ...
    def test_kv_cache_config_kv_size(self):
        ...
        from src.infrastructure.cache.KVCacheManager import KVCacheConfig, DType
    ...
    def test_dtype_enum(self):
        ...
        from src.infrastructure.cache.KVCacheManager import DType
    ...
    def test_kv_cache_block_creation(self):
        ...
        from src.infrastructure.cache.KVCacheManager import KVCacheBlock, DeviceType
    ...
    def test_kv_cache_blocks_collection(self):
        ...
        from src.infrastructure.cache.KVCacheManager import KVCacheBlocks
...
class TestPhase25Integration:
    ...
    def test_kv_cache_block_lifecycle(self):
        ...
        from src.infrastructure.cache.KVCacheManager import (
            KVCacheBlock,
            DeviceType,
        )
