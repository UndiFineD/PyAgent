...
class TestChatDecoratorCommands:
    ...
    def test_human_command(self):
        """Test /human command formats user message."""
        ...
        assert "👤" in result.output  # Avatar
    
    def test_human_command_no_args(self):
        """Test /human fails without text."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("human")
        assert result.success is False
    
    def test_ai_command(self):
        """Test /ai command formats assistant message."""
        from src.interface.slash_commands import execute_command
        ...
        assert "🤖" in result.output  # Avatar
        assert "I can help you" in result.data["text"]
    
    def test_ai_command_no_args(self):
        """Test /ai fails without text."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("ai")
        assert result.success is False
    
    def test_sysmsg_command(self):
        """Test /sysmsg command formats system message."""
        from src.interface.slash_commands import execute_command
        ...
        assert "Session started" in result.data["text"]
    
    def test_thinking_command(self):
        """Test /thinking command formats reasoning block."""
        from src.interface.slash_commands import execute_command
    ...
    def test_codeblock_command(self):
        """Test /codeblock command formats code."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("codeblock", ["python", "print('hello')"])
        
        assert result.success is True
        assert result.data["role"] == "code"
        assert result.data["language"] == "python"
        assert "print" in result.data["code"]
    
    def test_codeblock_without_language(self):
        """Test /codeblock without language specified."""
        from src.interface.slash_commands import execute_command
    ...
    def test_codeblock_no_args(self):
        """Test /codeblock fails without code."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("codeblock")
        assert result.success is False
    
    def test_chat_command(self):
        """Test /chat command formats exchange."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("chat", ["Hello!", "|||", "Hi", "there!"])
        
        assert result.success is True
        assert result.data["exchanges"] == 1
        assert "html" in result.data
    
    def test_chat_command_multiple_exchanges(self):
        """Test /chat with multiple exchanges."""
        from src.interface.slash_commands import execute_command
        
        args = ["Q1", "|||", "A1", "|||", "Q2", "|||", "A2"]
        result = execute_command("chat", args)
        
        assert result.success is True
        assert result.data["exchanges"] == 2
    
    def test_chat_command_no_separator(self):
        """Test /chat fails without separator."""
        from src.interface.slash_commands import execute_command
    ...
    def test_chattheme_light(self):
        """Test /chattheme generates light theme CSS."""
        from src.interface.slash_commands import execute_command
        ...
        assert ".chat-human" in result.data["css"]
    
    def test_chattheme_dark(self):
        """Test /chattheme generates dark theme CSS."""
        from src.interface.slash_commands import execute_command
    ...
    def test_chatpreview_command(self):
        """Test /chatpreview generates sample conversation."""
        from src.interface.slash_commands import execute_command
...
class TestChatAliases:
    ...
    def test_assistant_alias(self):
        ...
        result = execute_command("assistant", ["test"])
        assert result.success is True
        assert result.data["role"] == "ai"
    
    def test_bot_alias(self):
        """Test /bot alias for /ai."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("bot", ["test"])
        assert result.success is True
        assert result.data["role"] == "ai"
    
    def test_reasoning_alias(self):
        """Test /reasoning alias for /thinking."""
        from src.interface.slash_commands import execute_command
        
        result = execute_command("reasoning", ["test"])
        assert result.success is True
        assert result.data["role"] == "thinking"
...
class TestHTMLSafety:
    ...
    def test_html_escaped_in_human(self):
        """Test HTML is escaped in human messages."""
        from src.interface.slash_commands import execute_command
    ...
    def test_html_escaped_in_ai(self):
        """Test HTML is escaped in AI messages."""
        from src.interface.slash_commands import execute_command
...
class TestChatIntegration:
    ...
    def test_process_multiple_chat_commands(self):
        """Test processing multiple chat commands in prompt."""
        from src.interface.slash_commands import process_prompt
        
        prompt = "/human Hello! /ai Hi there!"
    ...
    def test_chat_in_help(self):
        """Test chat commands appear in help."""
        from src.interface.slash_commands import execute_command
