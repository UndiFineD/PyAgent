...
<<<<<<<< HEAD:tests/test_phases59_61.py
class TestPhases59_61(unittest.TestCase):
========

@unittest.skip('WIP migration')
class TestPhases59_61(IsolatedAsyncioTestCase):
>>>>>>>> 6b596bef0 (Refactor: Massive test suite migration and reorganization. Legacy tests verified and moved to tests/unit/phases and tests/unit/features. Deleted tests-old.):tests/unit/phases/test_phases59_61.py
    def setUp(self):
