...
<<<<<<<< HEAD:tests/test_phases56_58.py
class TestPhases56_58(unittest.TestCase):
========

@unittest.skip('WIP migration')
class TestPhases56_58(IsolatedAsyncioTestCase):
>>>>>>>> 6b596bef0 (Refactor: Massive test suite migration and reorganization. Legacy tests verified and moved to tests/unit/phases and tests/unit/features. Deleted tests-old.):tests/unit/phases/test_phases56_58.py
    def setUp(self):
