...
@pytest.fixture(name="rust_core")
def fixture_rust_core_alias(rust_core_module):
    """Alias for rust_core_module to support tests requesting rust_core."""
    return rust_core_module
