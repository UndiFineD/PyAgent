...
class TestSSRFDetectorMixin:
    ...
    def test_token_generation(self):
        ...
        token1 = self.mixin.get_ssrf_token()
    ...
    def test_callback_url_generation(self):
        ...
        url = self.mixin.get_ssrf_callback_url('example.com', 8080)
        assert 'http://example.com:8080/' in url
        assert len(self.mixin.get_ssrf_token()) == 16
    ...
    def test_data_collection(self):
        ...
        try:
            ...
            # Check data
            data = self.mixin.check_ssrf_triggered('test', timeout=0)
    ...
    def test_async_check(self):
        ...
        async def run():
            ...
            try:
                ...
                # Check async
                data = await self.mixin.async_check_ssrf_triggered('async_test', timeout=0)
                assert 'async_value' in data
