...
class TestMathUtils:
    ...
    def test_cdiv(self):
        from src.core.base.common.utils.math_utils import cdiv
        assert cdiv(7, 3) == 3
        assert cdiv(6, 3) == 2
        assert cdiv(1, 3) == 1
        assert cdiv(0, 3) == 0
    ...
    def test_next_power_of_2(self):
        from src.core.base.common.utils.math_utils import next_power_of_2
    ...
    def test_prev_power_of_2(self):
        from src.core.base.common.utils.math_utils import prev_power_of_2
        assert prev_power_of_2(7) == 4
        assert prev_power_of_2(8) == 8
        assert prev_power_of_2(1) == 1
    
    def test_round_up(self):
        from src.core.base.common.utils.math_utils import round_up
        assert round_up(7, 4) == 8
        assert round_up(8, 4) == 8
        assert round_up(1, 4) == 4
    
    def test_round_down(self):
        from src.core.base.common.utils.math_utils import round_down
...
class TestAtomicCounter:
    ...
    def test_counter_basic(self):
        from src.core.base.common.utils.atomic_counter import Counter
        c = Counter(10)
        assert c.value == 10
        assert c.inc() == 11
        assert c.dec() == 10
    ...
    def test_atomic_counter(self):
        from src.core.base.common.utils.atomic_counter import AtomicCounter
        c = AtomicCounter(0)
        c.inc(5)
        c.inc(3)
        assert c.value == 8
    ...
    def test_atomic_flag(self):
        from src.core.base.common.utils.atomic_counter import AtomicFlag
        f = AtomicFlag(False)
        assert not f.value
        f.set()
        assert f.value
    ...
    def test_atomic_gauge(self):
        from src.core.base.common.utils.atomic_counter import AtomicGauge
        g = AtomicGauge(0)
        g.inc(10)
        g.dec(3)
        snap = g.snapshot()
