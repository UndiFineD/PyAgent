...
class TestTensorShape:
    ...
    def test_basic_shape(self):
        ...
        from src.core.base.validation.tensor_schema import TensorShape
    ...
    def test_dynamic_dimension(self):
        ...
        from src.core.base.validation.tensor_schema import TensorShape, DynamicDim
...
class TestTensorSchema:
    ...
    def test_schema_creation(self):
        ...
        from src.core.base.validation.tensor_schema import TensorSchema, TensorShape
    ...
    def test_schema_from_tuples(self):
        ...
        from src.core.base.validation.tensor_schema import TensorSchema
...
class TestConstantList:
    ...
    def test_read_access(self):
        ...
        from src.core.base.structures.immutable_collections import ConstantList
...
class TestConstantDict:
    ...
    def test_read_access(self):
        """Test read operations."""
        from src.core.base.structures.immutable_collections import ConstantDict
...
class TestFrozenDict:
    ...
    def test_hashable(self):
        ...
        from src.core.base.structures.immutable_collections import FrozenDict
...
class TestAsConstant:
    ...
    def test_wrap_list(self):
        """Test wrapping list."""
        from src.core.base.structures.immutable_collections import as_constant, ConstantList
    ...
    def test_wrap_dict(self):
        """Test wrapping dict."""
        from src.core.base.structures.immutable_collections import as_constant, ConstantDict
    ...
    def test_wrap_invalid(self):
        ...
        from src.core.base.structures.immutable_collections import as_constant
...
class TestLogitsProcessorList:
    ...
    def test_empty_list(self):
        ...
        from src.core.base.processing.logits_processor import LogitsProcessorList
    ...
    def test_append(self):
        ...
        from src.core.base.processing.logits_processor import (
...
class TestTemperatureProcessor:
    ...
    def test_temperature_scaling(self):
        ...
        import torch
        from src.core.base.processing.logits_processor import TemperatureProcessor
...
class TestTopKProcessor:
    ...
    def test_top_k_filtering(self):
        ...
        pytest.importorskip("torch")
        import torch
        from src.core.base.processing.logits_processor import TopKProcessor
...
class TestTopPProcessor:
    ...
    def test_top_p_filtering(self):
        ...
        pytest.importorskip("torch")
        import torch
        from src.core.base.processing.logits_processor import TopPProcessor
...
class TestRepetitionPenaltyProcessor:
    ...
    def test_repetition_penalty(self):
        ...
        pytest.importorskip("torch")
        import torch
        from src.core.base.processing.logits_processor import RepetitionPenaltyProcessor
...
class TestNoBadWordsProcessor:
    ...
    def test_single_token_blocking(self):
        ...
        pytest.importorskip("torch")
        import torch
        from src.core.base.processing.logits_processor import NoBadWordsProcessor
...
class TestMinLengthProcessor:
    ...
    def test_blocks_eos_before_min_length(self):
        ...
        pytest.importorskip("torch")
        import torch
        from src.core.base.processing.logits_processor import MinLengthProcessor
...
class TestCreateProcessorChain:
    ...
    def test_empty_chain(self):
        ...
        from src.core.base.processing.logits_processor import create_processor_chain
...
class TestZeroCopySerializer:
    ...
    def test_msgspec_available_check(self):
        ...
        from src.infrastructure.serialization.zero_copy_serializer import MSGSPEC_AVAILABLE
    ...
    def test_encode_simple_dict(self):
        ...
        from src.infrastructure.serialization.zero_copy_serializer import ZeroCopyEncoder
    ...
    def test_encode_decode_roundtrip(self):
        ...
        msgspec = pytest.importorskip("msgspec")
        from src.infrastructure.serialization.zero_copy_serializer import (
