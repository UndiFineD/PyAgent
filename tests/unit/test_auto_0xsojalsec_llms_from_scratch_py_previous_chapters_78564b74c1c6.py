...
p = Path(r"C:\DEV\PyAgent\src\external_candidates\auto\0xsojalsec_llms_from_scratch_py_previous_chapters_78564b74c1c6.py")
...
assert hasattr(mod, 'assign'), 'missing assign'
assert hasattr(mod, 'load_weights_into_gpt'), 'missing load_weights_into_gpt'
