...
class TestAgentCard:
    ...
    def test_valid_agent_card(self):
        """Test creating a valid agent card."""
        card = AgentCard(
            name="test_agent",
...
class TestA2ACommunicationMixin:
    ...
    @pytest.fixture
    def agent(self):
        """Create a test agent with mixin."""
...
class TestSimpleA2AAgent:
    ...
    def test_handle_compute_add(self, agent):
        """Test compute handler for addition."""
        message = A2AMessage(
            type=MessageType.REQUEST,
            from_agent="sender",
            to_agent="simple_agent",
