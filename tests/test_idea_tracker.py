...
def test_build_tracker_payload_verbose_logs_to_stderr(tmp_path: Path, capsys) -> None:
...
def test_build_tracker_payload_batch_size_default_no_stderr(tmp_path: Path, capsys) -> None:
