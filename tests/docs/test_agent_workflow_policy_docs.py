...
def test_0master_documents_project_numbering_ownership_and_continuity() -> None:
    ...
    master_memory = _normalize(_read(".github/agents/0master.memory.md"))
...
def test_0master_enforces_delegation_preflight_branch_gate() -> None:
    ...
    assert "mark the task blocked in .github/agents/0master.memory.md" in master_agent
...
_AGENT_BRANCH_POLICY_REQUIREMENTS: dict[str, dict[str, list[str]]] = {
    ...
    ".github/agents/1project.agent.md": {
        "normalized": [
            ...
            "record blocked status in <project>.project.md and .github/agents/1project.memory.md",
    ...
    ".github/agents/2think.agent.md": {
        "normalized": [
            ...
            "record blocked status in <project>.think.md and .github/agents/2think.memory.md",
    ...
    ".github/agents/3design.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.design.md and .github/agents/3design.memory.md",
    ...
    ".github/agents/4plan.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.plan.md and .github/agents/4plan.memory.md",
    ...
    ".github/agents/5test.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.test.md and .github/agents/5test.memory.md",
    ...
    ".github/agents/6code.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.code.md and .github/agents/6code.memory.md",
    ...
    ".github/agents/7exec.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.exec.md and .github/agents/7exec.memory.md",
    ...
    ".github/agents/8ql.agent.md": {
        "normalized": [
            "branch gate (mandatory",
            "if observed branch != expected branch, stop work immediately",
            "record blocked status in <project>.ql.md and .github/agents/8ql.memory.md",
