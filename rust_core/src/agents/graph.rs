...
pub fn generate_mermaid_graph(
    ...
    for edge in edges {
        let u_raw = edge
            .get("from")
            .ok_or_else(|| PyErr::new::<pyo3::exceptions::PyKeyError, _>("edge missing 'from'"))?;
        let v_raw = edge
            .get("to")
            .ok_or_else(|| PyErr::new::<pyo3::exceptions::PyKeyError, _>("edge missing 'to'"))?;
...
#[pyfunction]
pub fn filter_active_topology_relationships(
