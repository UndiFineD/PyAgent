...
pub fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(pyo3::wrap_pyfunction!(
        attention::attention_softmax_rust,
        m
    )?)?;
    ...
    // Lifecycle
    m.add_function(pyo3::wrap_pyfunction!(
        lifecycle::request_status_transition_rust,
        m
    )?)?;
    ...
    // Quantization
    m.add_function(pyo3::wrap_pyfunction!(
        quantization::quantize_symmetric_rust,
        m
    )?)?;
    m.add_function(pyo3::wrap_pyfunction!(
        quantization::quantize_asymmetric_rust,
        m
    )?)?;
    m.add_function(pyo3::wrap_pyfunction!(
        quantization::dequantize_int4_rust,
        m
    )?)?;
    m.add_function(pyo3::wrap_pyfunction!(quantization::pack_int4_rust, m)?)?;
    m.add_function(pyo3::wrap_pyfunction!(
        quantization::compute_scales_rust,
        m
    )?)?;
    m.add_function(pyo3::wrap_pyfunction!(
        quantization::batch_dequantize_rust,
        m
    )?)?;
