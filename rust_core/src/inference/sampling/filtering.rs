...
#[pyfunction]
pub fn apply_whitelist_mask_rust(mut logits: Vec<f64>, allowed_token_ids: Vec<usize>) -> Vec<f64> {
...
#[pyfunction]
pub fn bad_words_trie_build_rust(bad_words: Vec<Vec<i32>>) -> HashMap<i32, Vec<(Vec<i32>, bool)>> {
