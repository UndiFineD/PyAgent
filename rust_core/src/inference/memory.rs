...
pub fn blocks_to_free_rust(pressure: f64, total_blocks: usize, min_free: f64) -> usize {
    if pressure <= 0.0 {
        return 0;
    }
...
#[pyfunction]
pub fn batch_write_indices_rust(indices: Vec<usize>, block_size: usize) -> Vec<usize> {
