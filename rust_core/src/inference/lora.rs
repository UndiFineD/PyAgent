...
#[pyfunction]
pub fn lora_scaling_rust(rank: usize, alpha: f64, use_rslora: bool) -> f64 {
    if use_rslora {
...
#[pyfunction]
pub fn lora_latency_percentile_rust(latencies: Vec<f64>, percentile: f64) -> f64 {
...
#[pyfunction]
pub fn apply_ia3_scaling_rust(activations: Vec<f32>, scaling_vector: Vec<f32>) -> Vec<f32> {
