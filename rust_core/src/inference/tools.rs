...
#[pyfunction]
pub fn extract_json_positions_rust(text: String) -> Vec<(usize, usize)> {
...
#[pyfunction]
pub fn detect_tool_format_rust(text: String) -> String {
...
#[pyfunction]
pub fn parse_tool_arguments_rust(json_str: String) -> HashMap<String, String> {
...
#[pyfunction]
pub fn validate_partial_json_rust(partial_text: String) -> bool {
...
#[pyfunction]
pub fn parse_mcp_tool_call_rust(json_str: String) -> PyResult<HashMap<String, String>> {
...
#[pyfunction]
pub fn validate_mcp_schema_rust(schema_json: String) -> (bool, String) {
