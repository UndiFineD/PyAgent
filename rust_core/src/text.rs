...
pub fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(analyze_security_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(analyze_tech_debt_rust, m)?)?;
    m.add_function(wrap_pyfunction!(apply_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(apply_simple_fixes_rust, m)?)?;
    m.add_function(wrap_pyfunction!(batch_cosine_similarity_rust, m)?)?;
    m.add_function(wrap_pyfunction!(batch_scan_files_rust, m)?)?;
    m.add_function(wrap_pyfunction!(build_graph_edges_rust, m)?)?;
    m.add_function(wrap_pyfunction!(bulk_match_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(bulk_replace_files_rust, m)?)?;
    m.add_function(wrap_pyfunction!(bulk_replace_rust, m)?)?;
    m.add_function(wrap_pyfunction!(bulk_tokenize_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_avg_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_coupling_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_jaccard_set_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_max_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_median_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_min_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_p95_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_p99_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_pearson_correlation_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_shard_id_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_stddev_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_sum_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_text_similarity_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_variance_rust, m)?)?;
    m.add_function(wrap_pyfunction!(calculate_weighted_load_rust, m)?)?;
    m.add_function(wrap_pyfunction!(check_style_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(check_suppression_rust, m)?)?;
    m.add_function(wrap_pyfunction!(cosine_similarity_rust, m)?)?;
    m.add_function(wrap_pyfunction!(count_untyped_functions_rust, m)?)?;
    m.add_function(wrap_pyfunction!(deduplicate_strings_rust, m)?)?;
    m.add_function(wrap_pyfunction!(detect_failed_agents_rust, m)?)?;
    m.add_function(wrap_pyfunction!(extract_versions_rust, m)?)?;
    m.add_function(wrap_pyfunction!(fast_cache_key_rust, m)?)?;
    m.add_function(wrap_pyfunction!(fast_prefix_key_rust, m)?)?;
    m.add_function(wrap_pyfunction!(filter_memory_by_query_rust, m)?)?;
    m.add_function(wrap_pyfunction!(filter_stable_knowledge_rust, m)?)?;
    m.add_function(wrap_pyfunction!(find_dependents_rust, m)?)?;
    m.add_function(wrap_pyfunction!(find_duplicate_code_rust, m)?)?;
    m.add_function(wrap_pyfunction!(find_similar_pairs_rust, m)?)?;
    m.add_function(wrap_pyfunction!(find_strong_correlations_rust, m)?)?;
    m.add_function(wrap_pyfunction!(generate_unified_diff_rust, m)?)?;
    m.add_function(wrap_pyfunction!(linear_forecast_rust, m)?)?;
    m.add_function(wrap_pyfunction!(match_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(match_policies_rust, m)?)?;
    m.add_function(wrap_pyfunction!(merge_knowledge_rust, m)?)?;
    m.add_function(wrap_pyfunction!(normalize_and_hash_rust, m)?)?;
    m.add_function(wrap_pyfunction!(partition_to_shards_rust, m)?)?;
    m.add_function(wrap_pyfunction!(prepare_debt_records_rust, m)?)?;
    m.add_function(wrap_pyfunction!(scan_compliance_patterns_rust, m)?)?;
    m.add_function(wrap_pyfunction!(scan_lines_multi_pattern_rust, m)?)?;
    m.add_function(wrap_pyfunction!(scan_workspace_quality_rust, m)?)?;
    m.add_function(wrap_pyfunction!(search_blocks_rust, m)?)?;
    m.add_function(wrap_pyfunction!(search_content_scored_rust, m)?)?;
    m.add_function(wrap_pyfunction!(search_with_tags_rust, m)?)?;
    m.add_function(wrap_pyfunction!(select_best_agent_rust, m)?)?;
    m.add_function(wrap_pyfunction!(tokenize_and_index_rust, m)?)?;
    m.add_function(wrap_pyfunction!(tokenize_query_rust, m)?)?;
    m.add_function(wrap_pyfunction!(topological_sort_rust, m)?)?;
    m.add_function(wrap_pyfunction!(validate_semver_rust, m)?)?;
    m.add_function(wrap_pyfunction!(word_frequencies_rust, m)?)?;
    Ok(())
}
