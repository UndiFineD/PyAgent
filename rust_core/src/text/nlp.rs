...
pub fn tokenize_and_index_rust(
    ...
    for (line_num, line) in content.lines().enumerate() {
        ...
        for mat in word_regex.find_iter(&line_lower) {
            ...
            index.entry(word).or_default().push((
                file_path.to_string(),
...
#[pyfunction]
pub fn deduplicate_strings_rust(items: Vec<String>, threshold: f64) -> PyResult<Vec<usize>> {
...
#[pyfunction]
pub fn calculate_jaccard_set_rust(set_a: Vec<String>, set_b: Vec<String>) -> PyResult<f64> {
