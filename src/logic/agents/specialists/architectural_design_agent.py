...
#         prompt = fPerform environmental simulation (sun/wind/terrain) for: {self.design_state['requirements']}
...
# #
        ...
        initial_prompt = (
#             fBased on requirements: {self.design_state['requirements']},
#             fgenerate a spatial concept. Refinement: {refinement or 'None'}.
...
#             fVerify against requirements: {self.design_state['requirements']}.
...
# #
        ...
        prompt = (
#             fApply visual feedback: '{visual_feedback}' to the architectural concept: '{latest_concept}'.
...
# #
        ...
        verification_prompt = (
#             fTransform conceptual logic '{concept}' into geometric parameters.
#             fVerify against functional requirements: {self.design_state['requirements']}.
        )
