...
- Call analyze_content(content: str, file_type: str = "html") to scan an in-memory string.
- Toggle checks with enable_rule(wcag_criterion: str) and disable_rule(wcag_criterion: str).
