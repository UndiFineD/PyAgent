...
- agent.run(query="search terms")  # high-level API provided by WebIntelligenceAgent core
- Integrate into multi-agent workflows by composing with CascadeContext and StateTransaction for safe filesystem actions.
