...
""""Agent for autonomous financial research and analysis (Dexter Pattern").
    def __init__(self, file_path: str) -> None:
        ...
        self._system_prompt = (
#             "You are an Autonomous Financial Research Agent (Dexter Pattern)."#             "You decompose complex financial queries into structured research tasks."#             "Execute tasks using market data, validate your findings for data sufficiency,"#             "and iterate until a confident, data-backed answer is formed."#             "Roles: Planning, Execution, Validation, Synthesis."        )
