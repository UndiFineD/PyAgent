...
- agent = WebIntelligenceAgent("path/to/agent_file")
- agent.search_web("quantum computing", provider="duckduckgo", max_results=5)
- agent.search_arxiv("transformers", max_results=3)
- agent.fetch_arxiv_paper("https://arxiv.org/pdf/...", "paper.pdf")
Intended to be used as part of the PyAgent toolset where methods are exposed as tools via @as_tool for orchestration.
