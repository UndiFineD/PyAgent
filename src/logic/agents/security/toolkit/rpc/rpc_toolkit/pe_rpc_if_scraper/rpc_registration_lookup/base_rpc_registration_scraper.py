...
# # UNKNOWN_ADDRESS = "unknown_address"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # PARSING_ERROR = "argument_parsing_error"  # [BATCHFIX] closed string

# [BATCHFIX] Commented metadata/non-Python
# # INTERFACE_FLAGS = "flags"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # INTERFACE_SECURITY_CALLBACK = "security_callback_addr"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # INTERFACE_HAS_DESCRIPTOR = "has_security_descriptor"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
