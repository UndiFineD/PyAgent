...
# #     rpc_reg_imports = []
    ...
    for imp in imports:
# [BATCHFIX] Commented metadata/non-Python
#         if imp.get("name", ").startswith("RpcServerRegisterIf"):"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
...
# #     xref_eas = []
# [BATCHFIX] Commented metadata/non-Python
#     for xref in r2.cmdj(faxtj @{func_ea}"):"  # [BATCHFIX] closed string
        if "from" not in xref:
            continue
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
#     for opcode_dism in reversed(r2.cmdj(fpDj{arg_ea - func_start_ea} @{func_start_ea}")):"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
...
#     return (
        (reg.startswith("r") or reg.startswith("e")) and (reg.endswith("x") or reg.endswith("p") or reg.endswith("i"))
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
...
# # def parse_argument(arg_ea: int):  # -> Union[str, int]
    if arg_ea != BADADDR:
# [BATCHFIX] Commented metadata/non-Python
#         opcode_dism = r2.cmdj(fpdj1 @{arg_ea}")[0]["disasm"]"  # [BATCHFIX] closed string
...
# # def get_call_args_manually(call_ea: int, max_look_behind: int = 20, max_args: int = 8) -> List[int]:
    ...
    rcx = rdx = r8 = r9 = None
# [BATCHFIX] Commented metadata/non-Python
#     for opcode_dism in reversed(r2.cmdj(fpdj-{max_look_behind} @{call_ea}")):"  # [BATCHFIX] closed string
        if all((rcx, rdx, r8, r9)) and len(stack_params) == max_args - 4:
            break
        if opcode_dism["fcn_addr"] != func_start_ea:  # We've went outside the scope of the function call"  # [BATCHFIX] closed string"  # [BATCHFIX] closed string
            break
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
