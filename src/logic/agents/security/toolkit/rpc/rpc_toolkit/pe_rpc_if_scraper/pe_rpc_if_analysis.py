...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #     def _get_interface_data(self, pe: PE, interface_off: int) -> Dict[str, Union[int, str]]:
...
# #                 res_dict["function_names"] = [self._sym_helper.sym_from_addr(addr) for addr in func_ptrs if addr]
            ...
            # For clients, the marshalling is done inline, so it's not in the struct."  # [BATCHFIX] closed string"  # [BATCHFIX] closed string
