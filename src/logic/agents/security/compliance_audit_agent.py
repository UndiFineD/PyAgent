...
simulation, add configurable severity/risk scoring, surface recorder failures (don't silently swallow them),
and include richer telemetry and remediation tracking.
"""
