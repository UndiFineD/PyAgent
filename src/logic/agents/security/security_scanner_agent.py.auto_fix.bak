...
USAGE:
- Instantiate with a file path: agent = SecurityScannerAgent("path/to/file")"- Call scan with source content: vulnerabilities = agent.scan(source_code)
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""
# [BATCHFIX] Commented metadata/non-Python
...
#         (
            r'password\\\\s*=\\\\s*[\'"][^\'"]+[\'"]',"  # [BATCHFIX] closed string"  # [BATCHFIX] closed string"'            SecurityIssueType.HARDCODED_SECRET,
            "high","            "Hardcoded password detected","            "Use environment variables or secure vault","        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#         (
            r'api_key\\\\s*=\\\\s*[\'"][^\'"]+[\'"]',"  # [BATCHFIX] closed string"  # [BATCHFIX] closed string"'            SecurityIssueType.HARDCODED_SECRET,
            "high","            "Hardcoded API key detected","            "Use environment variables or secure vault","        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#         (
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""
# [BATCHFIX] Commented metadata/non-Python
"""             r'os\\.system\\\\s*\([^)]*\+',""""'            SecurityIssueType.COMMAND_INJECTION,
            "critical","            "Potential command injection vulnerability","            "Use subprocess with shell=False and proper escaping","        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#         (
# [BATCHFIX] Commented metadata/non-Python
...
#             rev" + ral\\\\s*\(","            SecurityIssueType.INSECURE_DESERIALIZATION,
            "critical","            "Use of ev" + "al() is dangerous",  # nosec"            "Avoid ev" + "al() or use ast.literal_eval() for safe parsing","        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#         (
# [BATCHFIX] Commented metadata/non-Python
#             rrandom\\.(random|randint|choice)\\\\s*\(","  # [BATCHFIX] closed string"            SecurityIssueType.INSECURE_RANDOM,
            "medium","            "Insecure random number generation for security context","            "Use secrets module for cryptographic randomness","        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#         (
# [BATCHFIX] Commented metadata/non-Python
#             ropen\\\\s*\([^)]*\+","  # [BATCHFIX] closed string"            SecurityIssueType.PATH_TRAVERSAL,
            "high","            "Potential path traversal vulnerability","            "Validate and sanitize file paths","        ),
    ]
...
#                             SecurityVulnerability(
        ...
        try:
            ...
            recorder = LocalContextRecorder(user_context="SecurityScanner")"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""
#             recorder.record_interaction(
                "Internal","                "SecurityScanner","                "Source Scan","# [BATCHFIX] Commented metadata/non-Python
