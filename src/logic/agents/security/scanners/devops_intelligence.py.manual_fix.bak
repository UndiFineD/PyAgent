...
#        " return ["  # [BATCHFIX] closed string"            {"path": "/SMS_DP_SMSPKG$/", "desc": "Package storage (often allows directory listing)"},"            {"path": "/SMS_DP_DATALIB/", "desc": "Data library metadata"},"            {"path": "/SMS_DP_SMSSIG$/", "desc": "Signature files for package verification"},"        ]
...
""" [BATCHFIX] Commented unterminated string"""
#     "    return ["  # [BATCHFIX] closed string"            "ps1","            "vbs","            "txt","            "cmd","            "bat","            "pfx","            "pem","            "cer","            "sql","            "xml","            "config","            "ini","            "sh","            "py","            "keystore","            "reg","            "yml","            "yaml","        ]
...
""" [BATCHFIX] Commented unterminated string"""
#  "       return {"  # [BATCHFIX] closed string"            "jenkins": {"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python"""
# [BATCHFIX] Commented metadata/non-Python
