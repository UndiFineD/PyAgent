...
"""     ANDROID_VULN_PATTERNS: Dict[str, Union[str, Dict[str, str]]] = {""""# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#         "firebase_url": rhttps://.*\\.firebaseio\\.com","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""         "cleartext_traffic": r'android:usesCleartextTraffic=["\']true["\']',"'# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""         "debuggable": r'android:debuggable=["\']true["\']',"'# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""         "export_activity": r'android:exported=["\']true["\']',"'        "network_security_config": {"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""             "user_certs": r'<certificates.*src=["\']user["\'].*>',"'# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""             "raw_certs": r'<certificates.*src=["\']@raw/.*["\'].*>',"'# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     IOS_VULN_PATTERNS: Dict[str, str] = {""""# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#         "allow_arbitrary_loads": ("# [BATCHFIX] Commented metadata/non-Python
"""             r"<key>NSAppTransportSecurity</key>\\\\s*<dict>\\\\s*"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
"""             r"<key>NSAllowsArbitraryLoads</key>\\\\s*<true/>"  # [BATCHFIX] closed string"        ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#         "backup_excluded": rNSURLIsExcludedFromBackupKey","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#         "biometric_usage": rNSFaceIDUsageDescription","  # [BATCHFIX] closed string"    }
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""             "jailbreak_check": "Hooking -[NSFileManager fileExistsAtPath:] for jailbreak-specific paths","            "debugger_detection": "Hooking ptrace and sysctl to hide debugger presence","        }
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""             "cryptography_interception": ["javax.crypto.Cipher.doFinal", "javax.crypto.Cipher.init"],"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
...
"""                     "CertificatePinner.check.overload('java.lang.String', 'java.util.List')"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     ".implementation = function() { return; };"  # [BATCHFIX] closed string"                ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "trustkit": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "var TrustKit = Java.use('com.datatheorem.android.trustkit.pinning.OkHttp3Helper');"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "TrustKit.getCertificatePinner.implementation = function() { return null; };"  # [BATCHFIX] closed string"                ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "flutter": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "Interceptor.attach(Module.findExportByName('libflutter.so',"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "'ssl_crypto_x509_session_verify_cert_chain'),"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "{ onLeave: function(retval) { retval.replace(0x1); } });"  # [BATCHFIX] closed string"                ),
            },
            "root_check": {"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "rootbeer": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "var RootBeer = Java.use('com.scottyab.rootbeer.RootBeer');"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "RootBeer.isRooted.implementation = function() { return false; };"  # [BATCHFIX] closed string"                ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "generic_su": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "var File = Java.use('java.io.File'); File.exists.implementation = function() {"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "var name = this.getName(); if (name === 'su' || name === 'magisk') return false;"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "return this.exists(); };"  # [BATCHFIX] closed string"                ),
            },
            "biometrics": {"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "android_biometric": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "var BiometricPrompt = Java.use('androidx.biometric.BiometricPrompt');"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "BiometricPrompt.authenticate.overload('androidx.biometric.BiometricPrompt$PromptInfo',"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "'androidx.biometric.BiometricPrompt$CryptoObject').implementation = function(info, crypto) {"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
"""                     "this.onAuthenticationSucceeded(null); };"  # [BATCHFIX] closed string"                )
            },
            "ios_protection": {"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 "security_suite": ("# [BATCHFIX] Commented metadata/non-Python
"""                     "var SecuritySuite = ObjC.classes.SecuritySuite;"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
"""                     "SecuritySuite['- amIProxyfied'].implementation = function() { return false; };"  # [BATCHFIX] closed string"'# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""             "jailbreak_detection_bypass_ios": "Hooking -[NSFileManager fileExistsAtPath:] for /Applications/Cydia.app","            "biometric_bypass": "Hooking BiometricPrompt.Authenticate to simulate successful user verification","# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#             "method_tracing_all": ("# [BATCHFIX] Commented metadata/non-Python
...
""" [BATCHFIX] Commented unmatched parenthesis""""#             (
                r'<intent-filter>.*<action\\\\s+android:name="android.intent.action.VIEW"'"'# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""         pattern = self.ANDROID_VULN_PATTERNS["firebase_url"]"        if isinstance(pattern, str):
            firebase = re.findall(pattern, content)
            for fb in firebase:
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#                 findings.append(
                    {
                        "type": "firebase_vulnerability","                        "value": fb,"                        "info": "Check if .json suffix is publicly accessible","                    }
                )
