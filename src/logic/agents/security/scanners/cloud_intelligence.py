...
#         rs3.amazonaws.com/{target}","  # [BATCHFIX] closed string"        r"{target}.storage.googleapis.com","        r"{target}.blob.core.windows.net","        r"{target}.azureedge.net","        r"{target}.digitaloceanspaces.com","    ]

    S3_SEARCH_PATTERNS = [
        r".*\\.bak$","        r".*\\.sql$","        r".*\\.env$","        r".*\\.config$","# [BATCHFIX] Commented metadata/non-Python
#         rcredentials","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
#         rsecret","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
#         rpassword","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
#         rkey","  # [BATCHFIX] closed string"        r".*\\.p12$","        r".*\\.pfx$","        r".*\\.pem$","# [BATCHFIX] Commented metadata/non-Python
#         rdatabase","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
#         rbackup","  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def check_bucket_accessibility(self, bucket_url: str) -> Dict[str, Any]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def list_public_files(self, _bucket_url: str) -> List[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def audit_target_on_cloud(self, target: str) -> List[Dict[str, Any]]:""""# [BATCHFIX] Commented metadata/non-Python
"""         "Scans for common bucket names based on target name."  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#         "results = []"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""         tasks = []""""        for pattern in self.BUCKET_PATTERNS:
...
"""     def get_cspm_misconfigurations() -> Dict[str, Dict[str, Any]]:"Common cloud misconfigurations across AWS, Azure, and GCP (Ported from fixinventory)".        return {
            ...
            "mfa_disabled_admins": {"                "desc": "Privileged IAM users without Multi-Factor Authentication","                "severity": "CRITICAL","            },
            "root_account_usage": {"                "desc": "Recent activity detected using the cloud root account credentials","                "severity": "MEDIUM","            },
        }
