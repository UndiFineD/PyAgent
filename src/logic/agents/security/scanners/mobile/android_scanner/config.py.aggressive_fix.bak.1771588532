...
"""     "9. Respond with all vulnerabilities in one go (even if it spans multiple messages) and do not ask for"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
"""     "input to proceed.\\n"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
...
"""     "Your output should be structured in Markdown format, with each issue clearly listed and easily understood"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
