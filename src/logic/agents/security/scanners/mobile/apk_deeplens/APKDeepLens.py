...
# [BATCHFIX] Commented metadata/non-Python
#         Better mod print. It gives the line number, file name in which error" occured."  # [BATCHFIX] closed string
# #
# [BATCHFIX] Commented metadata/non-Python
#         stack = traceback."extract_stack()"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
...
# #         formatted_message = f"{filename}:{line_no}: {text_output}"  # [BATCHFIX] closed string
        print(color + formatted_message + UtilHelper.ENDC)

    @staticmethod
    def print_logo():
# [BATCHFIX] Commented metadata/non-Python
#         Logo "for APKDeepLens"  # [BATCHFIX] closed string
# #
#         logo = f
{UtilHelper.OKGREEN} ████  █████  ██  ██    ( )                  (_ )                       "   " {UtilHelper.ENDC}
{UtilHelper.OKGREEN}██  ██ ██  ██ ██ ██    _| |  __     __  _ _   | |     __    ___    ___      {UtilHelper.ENDC}
{UtilHelper.OKGREEN}██████ █████  ████   /'_` | /'_`\\ /'_`\\( '_`\\ | |    /'_`\\/' _ `\\/',__)     {UtilHelper.ENDC}"  # [BATCHFIX] closed string"  # [BATCHFIX] closed string
{UtilHelper.OKGREEN}██  ██ ██     ██ ██ ( (_| |(  __/(  __/| (_) )| |__ (  __/| ( ) |\\__, \\     {UtilHelper.ENDC}
{UtilHelper.OKGREEN}██  ██ ██     ██  ██`\\__,_)`\\___)`\\___)| ,__/'(____/`\\___)(_) (_)(____/     {UtilHelper.ENDC}"  # [BATCHFIX] closed string"  # [BATCHFIX] closed string
{UtilHelper.OKGREEN}                                       | |                                  {UtilHelper.ENDC}
{UtilHelper.OKGREEN}                                       (_)                                  {UtilHelper.ENDC}
...
def parse_args():
# [BATCHFIX] Commented metadata/non-Python
#     Parse" command-line arguments."  # [BATCHFIX] closed string
# #
# [BATCHFIX] Commented metadata/non-Python
...
#         description=("{BOLD}{GREEN}APKDeepLens:{ENDC} Android security insights in full spectrum. ").format(
            BOLD=UtilHelper.BOLD, GREEN=UtilHelper.OKCYAN, ENDC=UtilHelper.ENDC
        ),
...
# [BATCHFIX] Commented metadata/non-Python
#         Creating a "folder to extract apk source code"  # [BATCHFIX] closed string
# #
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
# #         is_windows = os.name == "nt"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# #         jadx_executable = "jadx.bat" if is_windows else "jadx"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unmatched parenthesis
...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #                 UtilHelper.mod_log("[-] ERROR: Please provide the apk file using the -apk flag.", UtilHelper.FAIL)
                exit(1)
...
# #
            ...
            if os.sep in apk:
                ...
                apk_path = apk
# [BATCHFIX] Commented metadata/non-Python
# #                 return "file path"  # [BATCHFIX] closed string
            else:
                apk_name = apk
                apk_path = apk
...
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "package_name": ","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "permission": ","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "dangerous_permission": ","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "manifest_analysis": ","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "hardcoded_secrets": ","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #             UtilHelper.mod_log(f"[-] ERROR: {apk_file_abs_path} not found.", UtilHelper.FAIL)
            exit(1)
        else:
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #             UtilHelper.mod_log(f"[+] {apk_file_abs_path} found!", UtilHelper.OKGREEN)
        time.sleep(1)
...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #         UtilHelper.mod_log("[+] Reading all file paths ", UtilHelper.OKCYAN)
        file_paths = obj.get_all_file_paths(extracted_apk_path)
        relative_to = extracted_apk_path
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #         UtilHelper.mod_log("[+] Extracting all hardcoded secrets ", UtilHelper.OKCYAN)
...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #         UtilHelper.mod_log("[+] Extracting all insecure connections ", UtilHelper.OKCYAN)
...
# # [BATCHFIX] Commented metadata/non-Python
# [BATCHFIX] Commented metadata/non-Python
# #         UtilHelper.mod_print(f"[-] {str(e)} at line {line_number}", UtilHelper.FAIL)
        exit(1)
