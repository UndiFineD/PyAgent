...
#             "shortest_path_to_da": (
# [BATCHFIX] Commented metadata/non-Python
"""                 "MATCH (u:User {name: '{username}'}), (da:Group {name: 'DOMAIN ADMINS'}),"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
"""                 "p = shortestPath((u)-[*..]->(da))"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
"""                 "MATCH (u:User)-[r:WriteDacl|WriteOwner|AllExtendedRights]->(target)"  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
