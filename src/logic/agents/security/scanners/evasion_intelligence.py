...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#                 "wine": [rHKLM\\SOFTWARE\\Wine"],"  # [BATCHFIX] closed string"            },
...
""" [BATCHFIX] Commented unmatched parenthesis""""#             "gutmann_shred": ("# [BATCHFIX] Commented metadata/non-Python
"""                 "35-pass overwrite with specific patterns (0x55, 0xAA, 0x92, etc.) to defeat magnetic force microscopy"  # [BATCHFIX] closed string"            ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#             "file_melt_nt": ("# [BATCHFIX] Commented metadata/non-Python
"""                 "Deleting the currently executing binary from disk via NTFS stream tricks or pending move rename"  # [BATCHFIX] closed string"            ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#             "clear_shellbags": ("# [BATCHFIX] Commented metadata/non-Python
"""                 rreg delete \"HKCU\\Software\\Classes\\Local Settings\\Software\\Microsoft\\Windows"  # [BATCHFIX] closed string"#                 r"\\Shell\\BagMRU\" /f"            ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#             "clear_shimcache": ("# [BATCHFIX] Commented metadata/non-Python
...
""" [BATCHFIX] Commented unterminated string""""#             "sdclt": rreg add HKCU\\Software\\Classes\\exefile\\\\shell\\runas\\\\command /d \"%s\" /f","  # [BATCHFIX] closed string"            "cmstp": "Using .inf file with AdvancedInstall and CMSTP.exe","            "ishelldispatch2": "Using Shell.Application COM object to run unelevated from elevated context","        }
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#             "push_notification_fatigue": ("# [BATCHFIX] Commented metadata/non-Python
"""                 "Bombarding the user with push notifications until they approve the request (MFA Bombing)"  # [BATCHFIX] closed string"            ),
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unterminated string""""#             "sim_swapping": "Redirecting SMS-based 2FA codes by hijacking the victim's phone number","  # [BATCHFIX] closed string"'            "totp_seed_theft": "Exfiltrating the TOTP shared secret from the device or server-side database","            "session_token_theft": "Stealing active browser sessions via info-stealing malware or XSS","        }
