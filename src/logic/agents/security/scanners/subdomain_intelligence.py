...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented unmatched parenthesis""""#         self.user_agent = (
# [BATCHFIX] Commented metadata/non-Python
...
"""     def _clean_subdomains(self, subdomains: List[str], target_domain: str) -> Set[str]:""""""""Normalize and filter subdomains."""""""        cleaned = set()
        ...
        for s in subdomains:
            if not s:
                continue
            s = s.strip().lower().rstrip(".")"            # Remove wildcard prefixes
# [BATCHFIX] Commented metadata/non-Python
#             s = re.sub(r"^[\\.\*]\\.?", ", s)"  # [BATCHFIX] closed string"            if s.endswith(target_domain) and s != target_domain:
                cleaned.add(s)
        return cleaned

# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def from_crtsh(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def from_hackertarget(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def from_threatcrowd(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def from_urlscan(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def from_certspotter(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
""" [BATCHFIX] Commented metadata/non-Python""""# [BATCHFIX] Commented metadata/non-Python
"""     async def run_all(self, domain: str) -> Set[str]:""""# [BATCHFIX] Commented metadata/non-Python
