...
"""Consolidates Google, Shodan, and GitHub dorks for reconnaissance.#     Ported logic from OneDorkForAll, Shodan-Dorks, and Github-Dorks.
    ...
    GOOGLE_DORKS = {
        ...
        "bug_bounty": ["            'site:github.com "target.com"',"'            'site:s3.amazonaws.com "target.com"',"'            'site:atlassian.net "target.com"',"'        ],
    }

    # High-value Shodan Dorks
    SHODAN_DORKS = [
        'product:"Elastic" port:9200',"'        'product:"Redis"',"'        'product:"MongoDB"',"'        '"X-OWA-Version"',"'        '"X-Powered-By: PHP/"',"'        'title:"index of /"',"'    ]
