...
USAGE:
Used as a specialized BaseAgent plugin to analyze snippets for structural fragility and to apply an "evolutionary" refactor that hardens code by adding safeguards, type hints, and error handling; call analyze_fragility for quick diagnostics and apply_genetic_refactor to produce refactored code (awaitable)."WHAT IT DOES:
...
"""             "You identify fragile patterns like missing error handling,"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
"""             "loose type definitions, and lack of input validation,"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
...
# [BATCHFIX] Commented metadata/non-Python
"""             "Evolutionary Request: Refactor this code to be significantly more robust"  # [BATCHFIX] closed string"# [BATCHFIX] Commented metadata/non-Python
