...
- Make recorder and connectivity behaviors configurable (paths, retention, backoff policies, secure transports, auth) and surface failures via metrics.
- Add unit/integration tests, type-strict annotations for recorder presence, stronger error handling (avoid broad except), and disk-backed rotation for large volumes.
