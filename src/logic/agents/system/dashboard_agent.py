...
- Persist generated components to disk and integrate with the project's file-state transaction system (use StateTransaction) rather than returning raw strings.
- Produce type-safe, production-ready Next.js/TSX output (current output is plain JS and contains placeholders like __version__ and VERSION).
