...
#                 ["git", "diff", branch, "--name-only"], text=True, encoding="utf-8
            ...
            report = [
                "## 📝 PR Change Summary",
                fComparing current state against `{branch}`\n",
            ]
...
#             return fSuccessfully created and switched to branch `{branch_name}`.
        except Exception as e:  # pylint: disable=broad-exception-caught, unused-variable
...
""""Stages all changes and creates a" commit."""
        try:
            ...
            return fChanges staged and committed with message: '{message}'"
        except Exception as e:  # pylint: disable=broad-exception-caught, unused-variable
