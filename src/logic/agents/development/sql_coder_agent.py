...
- Sets the working language to "sql" and configures a SQL-focused system prompt that emphasizes query performance, indexing, security (injection prevention), and adherence to SQL dialects (PostgreSQL, MySQL, T-SQL).
- Supplies a minimal default SQL content template and exposes a simple CLI entrypoint via create_main_function for one-off file processing.
