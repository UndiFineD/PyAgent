...
- Sets language="yaml", supplies a system prompt tailored to YAML, anchors/aliases, and common infrastructure schemas (Kubernetes, Docker Compose, CI/CD).
- Provides a minimal default YAML template and a CLI entrypoint via create_main_function for quick use.
