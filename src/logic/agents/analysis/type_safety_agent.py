...
- Use improve_content(prompt, target_file) (async) to request AI-assisted improvements for flagged locations
...
- Infer richer suggested types (context-aware) rather than only flagging 'Any' — integrate AST-based type inference or runtime sampling.
- Respect and parse typing.TYPE_CHECKING, forward refs, and aliases to avoid false positives.
                            ...
                            issues.append(
                                {
                                    ...
                                    "item": fParameter '{arg.arg}' in '{node.name}'",
                                    "severity": "MEDIUM",
                                }
                            )
