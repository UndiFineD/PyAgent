...
WHAT IT SHOULD DO BETTER:
    - Resolve package/module name normalization (handle relative imports, subpackages
      and aliasing) to avoid fragmented keys like "package" vs "package.module".
    - Capture imported names from "from X import a, b" individually and map them to
      their originating module when useful.
...
#                 module = node.module or
    ...
    def filter_external_deps(nodes: dict[str, DependencyNode], stdlib_list: set[str]) -> list[str]:
        ...
        Args:
            ...
            stdlib_list: Set of standard library module names.
