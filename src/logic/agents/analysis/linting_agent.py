...
- Designed to be wired into PyAgent's create_main_function for CLI usage.
...
- Records flake8 results (partial stdout and return code) through the agent's _record hook and returns human-readable summaries indicating success or listing raw issues.
- Provides a minimal default content/template and a system prompt tailored to linting responsibilities.
