...
METHOD SUMMARIES:
- enable_graceful_shutdown: instantiate GracefulShutdown with repo_root and install handlers
- resume_from_shutdown: load resume state and return list of pending Path objects or None
- run_health_checks: create HealthChecker and return a dict of AgentHealthCheck results
- is_healthy: return boolean whether all checks are HEALTHY
- print_health_report: run checks and delegate printing to HealthChecker
"""
# Licensed under the Apache License, Version 2.0 (the "License");
