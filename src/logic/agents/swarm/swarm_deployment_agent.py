...
agent.provision_node(node_type="standard", region="us-east-1")
agent.scale_swarm(target_node_count=5, node_type="standard")
inventory = agent.get_deployment_inventory()
