...
def secure_agent_workflow():
    """A secure agent workflow with proper validation."""
...
'''
        analysis = self.analyzer.analyze_workflow_code(code, "secure_workflow")

        assert analysis.workflow_name == "secure_workflow"
        assert analysis.security_score > 50  # Should have decent score
...
def vulnerable_agent():
    """Vulnerable agent with prompt injection."""
...
'''
    ...
    def test_detect_data_exposure_risk(self):
        """Test detection of data exposure risks."""
        code = '''
def data_handler_agent():
    """Agent that handles sensitive data."""
    api_key = get_api_key()
    secret_token = retrieve_secret()
    return "Using key: " + api_key + " and token: " + secret_token
'''
    ...
    def test_generate_security_report(self):
        ...
        analysis = WorkflowAnalysis("test_workflow")
        analysis.security_score = 75.5
        analysis.risk_assessment = "medium"
        analysis.agents_identified = [{"name": "test_agent", "type": "function"}]
        analysis.recommendations = ["Add input validation", "Implement logging"]
...
class TestSecurityAnalysisMixin:
    ...
    def test_mixin_initialization(self):
        ...
        assert hasattr(self.orchestrator, 'security_analyzer')
        assert isinstance(self.orchestrator.security_analyzer, WorkflowSecurityAnalyzer)

    def test_analyze_workflow_security(self):
        """Test workflow security analysis through mixin."""
        code = '''
def test_workflow():
    return "test"
'''
    ...
    def test_get_security_score(self):
        """Test getting security score through mixin."""
        code = '''
def secure_workflow():
    return "secure"
'''
    ...
    def test_check_security_threshold(self):
        """Test security threshold checking."""
        secure_code = '''
def secure_workflow():
    return "secure"
'''
...
'''
    ...
    def test_generate_security_report(self):
        """Test report generation through mixin."""
        code = '''
def test_workflow():
    return "test"
'''
