...
""""Handles voice interactions and audio processing with paralinguistic support."""""""
    def __init__(self, file_path: str) -> None:
        ...
        self._system_prompt = (
#             "You are the Voice Agent."#             "You translate spoken intent into fleet commands and handle audio transcription."#             "When generating speech, you support paralinguistic tags like [laugh], [chuckle], and [cough]"#             "to ensure natural, human-like interaction."        )
...
#             fVoiceAgent: Synthesizing speech in {language_code} with tags. Text: {text}
        ...
        if any(tag in text for tag in ["[laugh]", "[chuckle]", "[sigh]"]):"            logging.info(
