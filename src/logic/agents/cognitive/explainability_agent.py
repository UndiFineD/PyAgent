...
""""Heuristic-based justification for common agent actions."""
        ...
        justifications = {
            "PrivacyGuard": (
#                 "PII scrubbing is required before cross-fleet data sharing
...
#                 "to maintain GDPR compliance.
            ...
            "SecurityAudit": "Scanning for secrets prevents catastrophic leaks in public repositories.",
            "CodeQuality": "Formatting consistency reduces merge conflicts and improves cognitive load.",
            "StrategicPlanner": (
#                 "Aligning current tasks with long-term milestones ensures swarm
#                 "convergence on core goals.
            ),
            "MultiCloudBridge": (
#                 "State synchronization ensures high availability across
#                 "provider-specific failure domains.
            ),
        }
