...
WHAT IT DOES:
- Encapsulates RAG shard routing logic so agents can map a query (and the agent's active file path) to a subset of vector shards.
- Delegates routing to rag_core.route_query_to_shards and logs the routing decision for observability.
