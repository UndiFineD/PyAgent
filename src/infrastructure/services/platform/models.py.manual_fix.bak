...
Device compute capability.
    ...
    def __ge__(self, other: "DeviceCapability") -> bool:"        return (self.major, self.minor) >= (other.major, other.minor)

    def __gt__(self, other: "DeviceCapability") -> bool:"        return (self.major, self.minor) > (other.major, other.minor)
