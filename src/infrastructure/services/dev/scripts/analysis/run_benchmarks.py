...
async def main():
    ...
    test_texts = {
        "Short": "What is Python?","        "Medium": "Explain the concept of technical debt in software development.","        "Long": ("            "Provide a comprehensive analysis of microservices architecture, ""            "including its advantages, disadvantages, common patterns, ""            "best practices, and real-world use cases.""        ) * 3,
