...
def fix_file(filepath: str) -> bool:
    ...
    nodes = [
        ...
        if isinstance(n, ast.FunctionDef) and n.name == "__init__" and n.returns is None
    ]
                ...
                if in_string:
                    if char == string_char:
                        ...
                        if (
                            char_idx > 0
                            and line[char_idx - 1] == "\\"
                            and not (char_idx > 1 and line[char_idx - 2] == "\\")
                        ):
                            pass
                        else:
                            in_string = False
                    ...
                    if char in ["'", '"']:
                        ...
                        if (
                            char_idx + 2 < len(line)
                            and line[char_idx : char_idx + 3] == char * 3
                        ):
...
def main():
    ...
    count = 0
    print(f"Fixing missing __init__ hints in {root_dir}...")
