...
def test_encode_with_buffers_exists():
    """Test that encode_with_buffers function exists."""
    assert callable(encode_with_buffers)


def test_decode_with_buffers_exists():
    """Test that decode_with_buffers function exists."""
