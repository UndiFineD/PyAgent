...
try:
    ...
    # Provide lightweight placeholders for collection-time imports
    def _mk_placeholder(name):
        class _P:
            pass
    ...
    ABTestVariant = _mk_placeholder("ABTestVariant")
    ABTester = _mk_placeholder("ABTester")
    AuditLogger = _mk_placeholder("AuditLogger")
    SystemAnalytics = _mk_placeholder("SystemAnalytics")
    SystemCapability = _mk_placeholder("SystemCapability")
    SystemConfig = _mk_placeholder("SystemConfig")
    SystemHealthMonitor = _mk_placeholder("SystemHealthMonitor")
    SystemHealthStatus = _mk_placeholder("SystemHealthStatus")
    SystemResponse = _mk_placeholder("SystemResponse")
    SystemState = _mk_placeholder("SystemState")
    ProviderType = _mk_placeholder("ProviderType")
    SystemVersion = _mk_placeholder("SystemVersion")
    BatchRequest = _mk_placeholder("BatchRequest")
    CachedResponse = _mk_placeholder("CachedResponse")
    CapabilityDiscovery = _mk_placeholder("CapabilityDiscovery")
    CircuitBreaker = _mk_placeholder("CircuitBreaker")
    CircuitState = _mk_placeholder("CircuitState")
    ConfigHotReloader = _mk_placeholder("ConfigHotReloader")
    ConnectionPool = _mk_placeholder("ConnectionPool")
    ExtractCodeTransformer = _mk_placeholder("ExtractCodeTransformer")
    ExtractJsonTransformer = _mk_placeholder("ExtractJsonTransformer")
    LoadBalanceStrategy = _mk_placeholder("LoadBalanceStrategy")
    LoadBalancer = _mk_placeholder("LoadBalancer")
    QueuedRequest = _mk_placeholder("QueuedRequest")
    RecordedRequest = _mk_placeholder("RecordedRequest")
    RequestBatcher = _mk_placeholder("RequestBatcher")
    RequestCompressor = _mk_placeholder("RequestCompressor")
    RequestContext = _mk_placeholder("RequestContext")
    RequestDeduplicator = _mk_placeholder("RequestDeduplicator")
    RequestPriority = _mk_placeholder("RequestPriority")
    RequestQueue = _mk_placeholder("RequestQueue")
    RequestRecorder = _mk_placeholder("RequestRecorder")
    RequestSigner = _mk_placeholder("RequestSigner")
    RequestThrottler = _mk_placeholder("RequestThrottler")
    RequestTracer = _mk_placeholder("RequestTracer")
    ResponseTransform = _mk_placeholder("ResponseTransform")
    ResponseTransformerBase = _mk_placeholder("ResponseTransformerBase")
    StripWhitespaceTransformer = _mk_placeholder("StripWhitespaceTransformer")
    SubagentRunner = _mk_placeholder("SubagentRunner")
    TTLCache = _mk_placeholder("TTLCache")
    UsageQuota = _mk_placeholder("UsageQuota")
    UsageQuotaManager = _mk_placeholder("UsageQuotaManager")
