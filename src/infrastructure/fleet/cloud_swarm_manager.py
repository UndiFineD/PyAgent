...
class CloudSwarmManager:
    ...
    def deploy_agent_to_cloud(self, agent_name: str, resource_id: str) -> str:
        """Deploys a PyAgent instance to a previously provisioned cloud resource."""
...
if __name__ == "__main__":
    ...
    print(manager.provision_resource("aws", "vm", {"instance_type": "t3.medium"}))
    print(manager.deploy_agent_to_cloud("ResearchAgent", "aws-vm-1"))
    print(manager.list_cloud_resources())
