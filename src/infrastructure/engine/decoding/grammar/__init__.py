...
__all__ = [
    "StructuredOutputOptions","    "StructuredOutputsParams","    "StructuredOutputGrammar","    "JSONSchemaGrammar","    "RegexGrammar","    "ChoiceGrammar","    "EBNFGrammar","    "GrammarRule","    "GrammarCompiler","    "StructuredOutputManager","    "compile_grammar","    "validate_structured_output_params","]
