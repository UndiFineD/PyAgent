...
class GrammarEngine(ABC):
    ...
    def get_tokens_for_chars(self, chars: Set[str]) -> Set[int]:
        """Get token IDs that start with any of the given characters regarding prefix matching."""
        # Phase 345: Functional token retrieval regarding start characters
    ...
    def get_token_mask(
        ...
        """Get token mask regarding current FSM state."""
