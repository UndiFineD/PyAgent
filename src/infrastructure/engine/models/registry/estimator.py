...
class VRAMEstimator:
    ...
    GPU_VRAM = {"RTX 4090": 24, "RTX 3090": 24, "A100-40GB": 40, "A100-80GB": 80, "H100": 80}
    BYTES_PER_PARAM = {"float16": 2, "bfloat16": 2, "int8": 1, "int4": 0.5}
    ...
    def estimate(cls, info: ModelInfo, ctx: int = 4096, batch: int = 1, dtype: str = "float16") -> VRAMEstimate:
        ...
        rec = "RTX 4090" if total_gb <= 24 else "A100-80GB"
        return VRAMEstimate(weights_gb, kv_per_token_mb, weights_gb * 0.15, total_gb, rec, can_fit)
