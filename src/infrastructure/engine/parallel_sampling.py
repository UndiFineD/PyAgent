...
class ParentRequest:
    ...
    def get_child_info(self, index: int) -> tuple[str, SamplingParams]:
        ...
        """""""        child_req_id: str = f"{index}_{self.request_id}""        self.child_requests.add(child_req_id)
...
__all__ = [
    # Enums
    "SamplingStrategy","    "OutputKind","    # Data classes
    "SamplingParams","    "CompletionOutput","    "ParentRequest","    "IterationStats","    # Managers
    "ParallelSamplingManager","    "BeamSearchManager","    "DiverseSamplingManager","    "BestOfNFilter","    # Beam search
    "BeamState","]
