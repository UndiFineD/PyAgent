...
try:
    from infrastructure.engine.engine_core_client.suggested import RequestType, ClientConfig, EngineCoreClient, InprocClient, SyncMPClient, AsyncMPClient, create_client
except ImportError:
    from infrastructure.engine.engine_core_client.suggested import RequestType, ClientConfig, EngineCoreClient, InprocClient, SyncMPClient, AsyncMPClient, create_client
