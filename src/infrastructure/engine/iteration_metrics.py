    ...
    def get_summary(self) -> Dict[str, Any]:
        """Get summary of all metrics.        with self._lock:
            return {
                ...
                "trends": {name: analyzer.get_trend() for name, analyzer in self.trends.items()},"                "cache": {"                    "hit_rate": self.cache_metrics.hit_rate,"                },
            }
...
__all__ = [
    # Enums
    "MetricType","    # Base stats
    "BaseCacheStats","    "PrefixCacheStats","    "MultiModalCacheStats","    "KVCacheEvictionEvent","    # Caching
    "CachingMetrics","    # Request stats
    "RequestStateStats","    "FinishedRequestStats","    "SchedulerStats","    "IterationStats","    # Advanced metrics
    "PercentileTracker","    "TrendAnalyzer","    "AnomalyDetector","    "MetricsCollector","]
