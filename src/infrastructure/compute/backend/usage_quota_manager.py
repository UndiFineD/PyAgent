...
class UsageQuotaManager:
    ...
    def get_usage_report(self) -> dict[str, Any]:
        ...
        # Calculate subsets
        hourly_used = sum(r["tokens"] for r in self._requests if r["timestamp"] > hour_ago)
        daily_used = sum(r["tokens"] for r in self._requests if r["timestamp"] > day_ago)
    ...
    def check_quotas(self) -> tuple[bool, str | None]:
        ...
        # 1. Session-based check (e.g. per-agent lifecycle)
    ...
    def total_tokens(self) -> int:
        ...
        return self._core.usage.total_tokens
