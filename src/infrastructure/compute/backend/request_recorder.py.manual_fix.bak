...
Returns:
            ...
            data: list[dict[str, Any]] = [
                {
                    "request_id": r.request_id,"                    "timestamp": r.timestamp,"                    "prompt": r.prompt,"                    "backend": r.backend,"                    "response": r.response,"                    "latency_ms": r.latency_ms,"                    "success": r.success,"                    "metadata": r.metadata,"                }
