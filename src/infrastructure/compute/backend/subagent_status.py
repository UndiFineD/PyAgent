...
class SubagentStatus:
    ...
    def get_backend_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "warnings": warnings,
            "commands": {
                "codex": self.runner._command_available("codex"),
                "copilot": self.runner._command_available("copilot"),
                "gh": self.runner._command_available("gh"),
            },
            "github_models": {
                "requests_installed": self.runner.requests is not None,
