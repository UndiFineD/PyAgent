...
class ChatHandler:
    ...
    def _build_prediction_config(self, sdk_available: bool, **kwargs) -> Optional[Any]:
        ...
        try:
            import lmstudio
            return lmstudio.PredictionConfig(
            ...
            logger.error("lmstudio SDK not installed; cannot build prediction config")
            return None


    def _extract_chat_from_lmstudio(self, system_prompt: str) -> Optional[Any]:
        ...
        Returns:
            lmstudio.Chat instance, or None if SDK not available.
        """
        try:
            import lmstudio
            return lmstudio.Chat(system_prompt)
        except (ImportError, AttributeError):
            logger.error("lmstudio SDK not installed or Chat not available; cannot create chat object")
            return None
    ...
    def _sdk_chat(
        ...
        **kwargs,
        ...
        try:
            ...
            logger.error("lmstudio SDK not installed; cannot execute SDK chat")
            return ""
    ...
    def _http_fallback_chat(
        ...
        **kwargs,
        ...
        try:
            ...
            if resp is None:
                logger.error("[LMStudio] HTTP fallback chat: request returned None")
                return ""
