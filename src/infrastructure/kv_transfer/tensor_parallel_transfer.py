...
class TensorParallelTransfer:
    ...
    def _aggregate_tp_metadata_rust(self, metadata_shards: List[bytes]) -> bytes:
        ...
        # return RustBridge.aggregate_tp_metadata_rust(metadata_shards)
...
_orchestrator = LazyLoader("src.infrastructure.kv_transfer.tensor_parallel_transfer", "TensorParallelTransfer")
