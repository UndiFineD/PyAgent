...
try:
    from infrastructure.loading.kv_offload.managers import *
...
def test_compute_lru_eviction_rust_exists():
    """Test that compute_lru_eviction_rust function exists."""
    assert callable(compute_lru_eviction_rust)


def test_compute_arc_target_rust_exists():
    """Test that compute_arc_target_rust function exists."""
