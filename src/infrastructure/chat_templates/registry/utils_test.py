...
try:
    from infrastructure.chat_templates.registry.utils import *
except ImportError as e:
    pytest.skip(f"Cannot import module: {e}", allow_module_level=True)


def test_register_template_exists():
    """Test that register_template function exists."""
...
def test_render_template_exists():
    """Test that render_template function exists."""
    assert callable(render_template)


def test_detect_template_type_exists():
    """Test that detect_template_type function exists."""
