...
from src.infrastructure.orchestration.core.self_improvement_core import (
    SelfImprovementCore,
)

if TYPE_CHECKING:
    from src.infrastructure.fleet.fleet_manager import FleetManager
    from src.infrastructure.orchestration.intel.self_improvement_analysis import (
        SelfImprovementAnalysis,
    )
    from src.infrastructure.orchestration.intel.self_improvement_fixer import (
