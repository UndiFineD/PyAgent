...
class CloudStorageConnector(BaseConnector):
    ...
    def upload_file(self, filename: str, bucket: str, provider: str = "aws_s3") -> Dict[str, Any]:"        """Upload file with failover support.        return self._retry_operation(self._upload_with_failover, filename, bucket, provider)
