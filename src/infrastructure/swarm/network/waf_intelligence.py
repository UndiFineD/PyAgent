...
class WAFSignature:
    ...
    def matches(self, headers: Dict[str, str], content: str = "") -> bool:
        """
        Check if the signature matches the given headers or content.
        """
        # Check headers
...
class WAFIntelligence:
    ...
    def detect_waf(self, headers: Dict[str, str], content: str = "") -> List[str]:
        """
        Detect WAFs based on headers and content.
