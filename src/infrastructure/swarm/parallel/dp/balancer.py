...
class P2CLoadBalancer:
    ...
    def __init__(self, workers: list[WorkerState], sample_size: int = 2, enable_locality: bool = True):
    ...
    def select_worker(self, locality_group: Optional[int] = None) -> WorkerState:
        ...
        with self._lock:
            ...
            healthy = [w for w in self._workers if w.health in (WorkerHealth.HEALTHY, WorkerHealth.DEGRADED)]
