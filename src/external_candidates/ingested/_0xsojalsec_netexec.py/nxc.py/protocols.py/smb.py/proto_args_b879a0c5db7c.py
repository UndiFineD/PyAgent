...
def proto_args(parser, parents):
    ...
    cred_gathering_group = smb_parser.add_argument_group(
    ...
    mapping_enum_group = smb_parser.add_argument_group(
    ...
    mapping_enum_group.add_argument(
        "--qwinsta", action="store_true", help="Enumerate RDP connections"
    )
    mapping_enum_group.add_argument(
        "--tasklist", action="store_true", help="Enumerate running processes"
    )
    ...
    spidering_group = smb_parser.add_argument_group(
    ...
    files_group = smb_parser.add_argument_group(
        "Files", "Options for remote file interaction"
    )
    ...
    cmd_exec_group = smb_parser.add_argument_group(
    ...
    posh_group = smb_parser.add_argument_group(
