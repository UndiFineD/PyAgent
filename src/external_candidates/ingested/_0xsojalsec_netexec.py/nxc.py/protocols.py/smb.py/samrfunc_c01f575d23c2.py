...
from impacket.dcerpc.v5 import lsad, lsat, samr, transport
...
class SamrFunc:
    ...
    def get_custom_groups(self, group=None):
        ...
        for domain in domains:
            ...
            custom_groups.update(
                self.samr_query.get_domain_aliases(domain_handle, group)
            )
            if group:
    ...
    def get_local_groups(self, group=None):
        ...
        return {
            **builtin_groups,
            **custom_groups,
        }, builtin_groups_members | custom_groups_members
...
class SAMRQuery:
    ...
    def get_domains(self):
        ...
        domains = samr.hSamrEnumerateDomainsInSamServer(self.dce, self.server_handle)[
            "Buffer"
        ]["Buffer"]
    ...
    def get_domain_aliases(self, domain_handle, group=None):
        ...
        """
        aliases = {
            alias["Name"]: alias["RelativeId"]
            for alias in samr.hSamrEnumerateAliasesInDomain(self.dce, domain_handle)[
                "Buffer"
            ]["Buffer"]
        }
        if group:
    ...
    def get_alias_members(self, domain_handle, alias_id):
        ...
        return [
            ...
            for member in samr.hSamrGetMembersInAlias(self.dce, alias_handle)[
                "Members"
            ]["Sids"]
        ]
...
class LSAQuery:
    ...
    def lookup_sids(self, sids):
        ...
        return [
            ...
            for translated_names in lsat.hLsarLookupSids(
                self.dce,
                self.policy_handle,
                sids,
