...
class mssql(connection):
    ...
    def enum_host_info(self):
        ...
        try:
            ...
            login["OptionFlags2"] = (
                tds.TDS_INIT_LANG_FATAL
                | tds.TDS_ODBC_ON
                | tds.TDS_INTEGRATED_SECURITY_ON
            )
    ...
    def rid_brute(self, max_rid=None):
        ...
        try:
            ...
            domain_sid = SID(bytes.fromhex(raw_domain_sid.decode())).formatCanonical()[
                :-4
            ]
        except Exception as e:
        ...
        for _j in range(max_rid // simultaneous + 1):
            ...
            sid_queries = [
                f"SELECT SUSER_SNAME(SID_BINARY(N'{domain_sid}-{i:d}'))"
