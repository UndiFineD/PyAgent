...
class ConfigCheck:
    ...
    def run(self):
        for checker, args, kwargs in zip(
            self.checkers, self.checker_args, self.checker_kwargs, strict=True
        ):
            if checker is None:
    ...
    def log(self, context):
        ...
        self.module.wcc_logger.info(
            f'{self.connection.host}: Check "{self.name}" {result} because: {reasons}'
        )
        ...
        status = (
            ...
            if self.ok
            else colored("KO", "red", attrs=["bold"])
        )
        reasons = ": " + ", ".join(self.reasons)
...
class HostChecker:
    ...
    def init_checks(self):
        ...
        self.checks = [
            ConfigCheck(
                ...
                "Checks how old is the last successful update",
            ...
            ConfigCheck(
                ...
                "Checks if Administror user name has been changed",
                checkers=[self.check_administrator_name],
            ),
            ConfigCheck(
                "UAC configuration",
                "Checks if UAC configuration is secure",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if storing  hashes in LM format is disabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if AlwaysInstallElevated is disabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if IPv4 is preferred over IPv6",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Spooler service disabled",
                "Checks if the spooler service is disabled",
                checkers=[self.check_spooler_service],
            ),
            ConfigCheck(
                "WDigest authentication disabled",
                "Checks if WDigest authentication is disabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "WSUS configuration",
                "Checks if WSUS configuration uses HTTPS",
            ...
            ConfigCheck(
                "Small LSA cache",
                "Checks how many logons are kept in the LSA cache",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "AppLocker rules defined",
                "Checks if there are AppLocker rules defined",
                checkers=[self.check_applocker],
            ),
            ConfigCheck(
                "RDP expiration time",
                "Checks RDP session timeout",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if CredentialGuard is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Lsass run as PPL",
                "Checks if lsass runs as a protected process",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "No Powershell v2",
                "Checks if powershell v2 is available",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if LmCompatibilityLevel is set to 5",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "NBTNS disabled",
                "Checks if NBTNS is disabled on all interfaces",
                checkers=[self.check_nbtns],
            ),
            ConfigCheck(
                "mDNS disabled",
                "Checks if mDNS is disabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "SMB signing enabled",
                "Checks if SMB signing is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if LDAP signing is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if SMB encryption is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if the guest account is disabled",
                checkers=[self.check_guest_account_disabled],
            ),
            ConfigCheck(
                "Automatic session lock enabled",
            ...
            ConfigCheck(
                ...
                'Checks if the Powershell execution policy is set to "Restricted"',
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                ...
                "Checks if defender service is enabled",
            ...
            ConfigCheck(
                "Defender RealTime Monitoring enabled",
                "Check if Defender RealTime Monitoring is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Defender IOAV Protection enabled",
                "Check if Defender IOAV Protection is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Defender Behaviour Monitoring enabled",
                "Check if Defender Behaviour Monitoring is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Defender Script Scanning enabled",
                "Check if Defender Script Scanning is enabled",
                checker_args=[
                    [
                        self,
                        (
            ...
            ConfigCheck(
                "Defender no path exlusions",
                "Checks Defender path exlusion",
            ...
            ConfigCheck(
                "Defender no extension exclusions",
                "Checks Defender extension exlusion",
                checkers=[self.check_defender_exclusion],
                checker_args=[
                    (
    ...
    def check_config(self):
        ...
        for host in hosts:
            host = host._asdict()
            if (
                host["ip"] == self.connection.host
                and host["hostname"] == self.connection.hostname
                and host["domain"] == self.connection.domain
            ):
                host_id = host["id"]
                break
        ...
        for check in self.checks:
            try:
                ...
                self.context.log.error(
                    f"HostChecker.check_config(): Error while performing check {check.name}: {e}"
                )
            check.log(self.context)
            self.module.add_result(self.connection.host, check)
            if host_id is not None:
                self.connection.db.add_check_result(
                    host_id,
                    check.check_id,
                    check.ok,
                    ", ".join(check.reasons).replace("\x00", ""),
                )
        ...
        for spec in specs:
            try:
                if len(spec) == 3:
                    ...
                    ok = False
                    reasons = [
                        "Check could not be performed (invalid specification provided)"
                    ]
                    return ok, reasons
            except Exception as e:
                self.context.log.error(
            ...
            if type(value) == DCERPCSessionError:
                ...
                if value.error_code in (ERROR_NO_MORE_ITEMS, ERROR_FILE_NOT_FOUND):
                    ...
                    ok = False
                    reasons.append(
                        f"Error while retrieving value of {key}\\{value_name}: {value}"
                    )
                if stop_on_error:
                    ok = None
                    return ok, reasons
            ...
            if op(value, expected_value):
                ...
                reasons.append(
                    opstring.format(
                        left=f"{key}\\{value_name} ({value})", right=expected_value
                    )
                )
            else:
                reasons.append(
    ...
    def check_laps(self):
        ...
        for subkey in subkeys:
            value = self.reg_query_value(
                self.dce, self.connection, lapsv1_key_name + "\\" + subkey, "DllName"
            )
    ...
    def check_last_successful_update(self):
        ...
        if days_since_last_update <= OUTDATED_THRESHOLD:
            return True, [
                f"Last update was {days_since_last_update} <= {OUTDATED_THRESHOLD} days ago"
            ]
        else:
            return False, [
                f"Last update was {days_since_last_update} > {OUTDATED_THRESHOLD} days ago"
    ...
    def check_administrator_name(self):
        ...
        reasons = [
            (
                f"Administrator name changed to {name}"
                if ok
                else "Administrator name unchanged"
            )
        ]
        return ok, reasons
    ...
    def check_nbtns(self):
        ...
        for subkey in subkeys:
            value = self.reg_query_value(
                self.dce, self.connection, key_name + "\\" + subkey, "NetbiosOptions"
            )
            if type(value) == DCERPCSessionError:
        ...
        if nbtns_enabled > 0:
            reasons.append(
                f"NBTNS enabled on {nbtns_enabled} interfaces out of {len(subkeys)}"
            )
    ...
    def get_exclusions(self, key_name):
        exclusions = []
        try:
            values = self.reg_query_value(
                self.dce, self.connection, key_name, valueName=None, all_value=True
            )
    ...
    def check_defender_exclusion(self, *spec, options=None):
        try:
            ...
            self.context.log.error(
                f"Check could not be performed. Details: spec={spec}, dce={self.dce}, error: {e}"
            )
            return ok, reasons
    ...
    def check_defender_service(self):
        ...
        reasons = []
        try:
            service_config, service_status = self.get_service(
                "windefend", self.connection
            )
            if service_status == scmr.SERVICE_RUNNING:
    ...
    def reg_get_subkeys(self, dce, connection, key_name):
        ...
        try:
            ...
            if e.error_code != ERROR_FILE_NOT_FOUND:
                self.context.log.error(
                    f"HostChecker.reg_get_subkeys(): Could not retrieve subkey {subkey}: {e}\n"
                )
            return subkeys
        except Exception as e:
            self.context.log.error(
    ...
    def reg_query_value(
        self, dce, connection, keyName, valueName=None, all_value=False
    ):
        ...
        def subkey_values(subkey_handle):
            ...
            while True:
                try:
                    value_type, value_name, value_data = get_value(
                        subkey_handle, dw_index
                    )
        ...
        try:
            ...
            self.context.log.error(
                f"HostChecker.reg_query_value(): Could not split keyname {keyName}"
            )
    ...
    def get_service(self, service_name, connection):
        ...
        service_handle = scmr.hROpenServiceW(dce, scm_handle, service_name)[
            "lpServiceHandle"
        ]
        service_config = scmr.hRQueryServiceConfigW(dce, service_handle)[
            "lpServiceConfig"
        ]
        service_status = scmr.hRQueryServiceStatus(dce, service_handle)[
            "lpServiceStatus"
        ]["dwCurrentState"]
        remoteOps.finish()
