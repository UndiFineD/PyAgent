...
class NXCModule:
    ...
    def on_login(self, context, connection):
        ...
        context.log.debug(
            f"Detecting installed services on {target} using LsarLookupNames()..."
        )
    ...
    def _get_target(self, connection):
        return (
            ...
            else f"{connection.hostname}.{connection.domain}"
        )
            ...
            for product in conf["products"]:
                for service in product["services"]:
                    try:
                        ...
                        results.setdefault(product["name"], {"services": []})[
                            "services"
                        ].append(service)
                    except Exception:
                        pass
    ...
    "products": [
        {
            ...
            "services": [
                {
                    "name": "AcronisActiveProtectionService",
                    "description": "Acronis Active Protection Service",
                }
            ],
            "pipes": [],
        },
        {
            ...
            "services": [
                ...
                {
                    "name": "EPRedline",
                    "description": "Bitdefender Endpoint Redline Service",
                },
                {
                    "name": "EPUpdateService",
                    "description": "Bitdefender Endpoint Update Service",
                },
                {
                    "name": "EPSecurityService",
                    "description": "Bitdefender Endpoint Security Service",
                },
                {
                    "name": "EPProtectedService",
                    "description": "Bitdefender Endpoint Protected Service",
                },
                {
                    "name": "EPIntegrationService",
                    "description": "Bitdefender Endpoint Integration Service",
                },
            ],
            "pipes": [
                {
        ...
        },
        {
            ...
            "services": [
                ...
                {
                    "name": "efwd",
                    "description": "ESET Communication Forwarding Service",
                },
        ...
        },
        {
            ...
            "pipes": [{"name": "Exploit_Blocker", "processes": ["kavfswh.exe"]}],
        },
        {
        ...
        },
        {
            ...
            "services": [
                {
                    "name": "McAfee Endpoint Security Platform Service",
                    "description": "Trellix Core Service",
                },
                ...
                {
                    "name": "mfetp",
                    "description": "Trellix Endpoint Threat Prevention Service",
                },
                {
                    "name": "mfewc",
                    "description": "Trellix Endpoint Security Web Control Service",
                },
