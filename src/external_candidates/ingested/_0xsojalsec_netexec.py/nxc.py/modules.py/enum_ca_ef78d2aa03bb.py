...
class NXCModule:
    ...
    def on_login(self, context, connection):
        ...
        self.__stringbinding = (
            self.KNOWN_PROTOCOLS[self.__port]["bindstr"] % connection.host
        )
                ...
                if exename == "certsrv.exe":
                    ...
                    try:
                        ...
                        if (
                            ...
                            and "ntlm" in response.headers["WWW-Authenticate"].lower()
                        ):
                            context.log.highlight(
                                "Web enrollment found on HTTP (ESC8)."
                            )
