# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\api\v1\endpoints\team_invitation.py
import time
...
async def join_team(
    ...
    new_users.append(
        schemas.team.TeamMember(
            user_id=user.user_id, name="", role=schemas.team.TeamMemberRole.USER
        )
    )
