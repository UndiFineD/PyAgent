# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\schemas\user.py
from enum import Enum
from uuid import UUID

from pydantic import BaseModel, Field

from .team import TeamMember, TeamMemberRole
...
class RespMe(DoUser):
    ...
    teams: list[TeamMember] | None = Field(
        description="teams that user joined", default=None
    )
