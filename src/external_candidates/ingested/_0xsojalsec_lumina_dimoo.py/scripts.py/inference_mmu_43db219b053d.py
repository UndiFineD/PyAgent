# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Lumina-DiMOO\scripts\inference_mmu.py
# -*- coding: utf-8 -*-
"""
...
def main():
    ...
    parser.add_argument(
        "--gen_length", type=int, default=1024, help="Generation length"
    )
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="outputs_text_understanding",
    ...
    img_token = add_break_line(
        input_img_token, token_grid_height, token_grid_width, new_number=NEW_LINE
    )
