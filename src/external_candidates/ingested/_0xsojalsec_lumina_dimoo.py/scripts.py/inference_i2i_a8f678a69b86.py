# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Lumina-DiMOO\scripts\inference_i2i.py
# -*- coding: utf-8 -*-
"""
...
from utils.prompt_utils import create_prompt_templates, generate_image_to_image_prompt
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Input image path for image-reference style transfer",
    )
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="results_image_to_image",
    ...
    if "image_ref_transfer" in edit_type:
        con_input = (
            prompt_ids[:-1] + img_token_input + input_img_token + prompt_ids[-1:]
        )
        uncon_input_text = (
            uncon_text_ids[:-1]
            + img_token_input
