# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMTalker\renderer\vgg19_mask.py
import numpy as np
import torch
        ...
        for scale in self.scales:
            ...
            for i, weight in enumerate(self.weights):
                ...
                mask_i = F.interpolate(
                    mask_at_scale, size=feat_real.shape[2:], mode="nearest"
                )
