...
class FeatResBlock(nn.Module):
    def __init__(
        self, channels, dropout_rate=0, activation=nn.LeakyReLU, norm_type="batch"
    ):
        super().__init__()
        self.conv1 = ConvBlock(
            channels, channels, activation=activation, norm_type=norm_type
        )
...
class ConvResBlock(nn.Module):
    def __init__(
        ...
        self.feat_res_block1 = FeatResBlock(
            out_channels, dropout_rate, activation, norm_type
        )
        self.feat_res_block2 = FeatResBlock(
            out_channels, dropout_rate, activation, norm_type
        )
