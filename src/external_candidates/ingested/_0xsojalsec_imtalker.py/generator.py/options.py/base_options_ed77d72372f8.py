# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMTalker\generator\options\base_options.py
import argparse
import json
import os
...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # video
        parser.add_argument(
            "--input_size", type=int, default=256, help="input image size"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--wav2vec_model_path", default="./checkpoints/wav2vec2-base-960h"
        )
        parser.add_argument(
            "--attention_window",
            default=5,
        ...
        parser.add_argument(
            "--window_size", type=int, default=8, help="Window size for Swin Attention."
        )
