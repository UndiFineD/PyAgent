# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\google_adk\agents\personalized-shopping\personalized_shopping\shared_libraries\search_engine\convert_product_file_format.py
