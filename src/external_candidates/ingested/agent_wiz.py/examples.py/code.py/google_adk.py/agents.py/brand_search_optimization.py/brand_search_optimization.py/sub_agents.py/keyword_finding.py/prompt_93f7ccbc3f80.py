# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\google_adk\agents\brand-search-optimization\brand_search_optimization\sub_agents\keyword_finding\prompt.py
