# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\google_adk\agents\personalized-shopping\personalized_shopping\shared_libraries\web_agent_site\engine\goal.py
