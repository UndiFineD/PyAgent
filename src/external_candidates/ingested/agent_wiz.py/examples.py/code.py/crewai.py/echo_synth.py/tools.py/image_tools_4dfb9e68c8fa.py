# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\crewai\echo_synth\tools\image_tools.py
import os
...
class DallEImageGenerationInput(BaseModel):
    ...
    style: str = Field(
        "vivid", description="Image style. Options: 'vivid' or 'natural'"
    )
    save_path: Optional[str] = Field(
        None, description="Optional path to save the generated image."
    )
