...
class AutoEncoder(nn.Module):
    def __init__(self, params: AutoEncoderParams):
        ...
        self.quant_conv = (
            nn.Conv2d(2 * params.z_channels, 2 * params.z_channels, 1)
            if params.use_quant_conv
            else None
        )
        self.post_quant_conv = (
            nn.Conv2d(params.z_channels, params.z_channels, 1)
            if params.use_post_quant_conv
            else None
        )
