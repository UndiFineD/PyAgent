...
class ModernLoadingScreen(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i in range(num_dots):
            ...
            painter.drawEllipse(
                QRectF(dot_x - dot_size / 2, dot_y - dot_size / 2, dot_size, dot_size)
            )
        ...
        painter.drawLine(
            int(center_x), int(center_y + 12), int(center_x), int(center_y + 18)
        )
        painter.drawLine(
            int(center_x - 8), int(center_y + 18), int(center_x + 8), int(center_y + 18)
        )
        ...
        painter.drawText(
            QRectF(0, h - 90, w, 30), Qt.AlignmentFlag.AlignCenter, "OpenWhisper"
        )
        ...
        painter.drawText(
            QRectF(0, h - 55, w, 20), Qt.AlignmentFlag.AlignCenter, self.status_text
        )
        ...
        painter.drawText(
            QRectF(0, h - 35, w, 20), Qt.AlignmentFlag.AlignCenter, self.progress_text
        )
