...
class SettingsDialog(QDialog):
    ...
    def _create_general_tab(self):
        ...
        self.streaming_enabled_check.stateChanged.connect(
        ...
        layout.addSpacing(8)
        self.streaming_paste_check = QCheckBox(
            "Show streaming overlay and auto-paste result"
        )
        self.streaming_paste_check.setStyleSheet("color: #e0e0ff;")
        self.streaming_paste_check.stateChanged.connect(
            self._on_streaming_paste_changed
        )
    ...
    def _create_audio_tab(self):
        ...
        device_info.setStyleSheet(
            "color: #808090; font-size: 10px; font-style: italic;"
        )
    ...
    def _load_settings(self):
        ...
        try:
            ...
            self.streaming_paste_check.setChecked(
                settings.get("streaming_paste_enabled", False)
            )
            self.streaming_paste_check.setEnabled(streaming_enabled)
    ...
    def _save_settings(self):
        ...
        try:
            ...
            old_whisper_model = settings.get(
            ...
            whisper_settings_changed = (
                old_whisper_model != new_whisper_model
                or old_device != new_device
