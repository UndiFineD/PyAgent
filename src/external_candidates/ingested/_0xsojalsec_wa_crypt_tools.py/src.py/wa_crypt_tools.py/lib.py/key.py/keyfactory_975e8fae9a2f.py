# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wa-crypt-tools\src\wa_crypt_tools\lib\key\keyfactory.py
import logging
        ...
        try:
            ...
            try:
                ...
                l.critical(
                    ...
                    "64 characters long and not {} characters long.".format(
                        len(str(file))
                    )
                )
