# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wa-crypt-tools\tests\test_encrypt.py
import os
import zlib
...
class TestEncryption:
    def test_encryption15(self):
        ...
        props = Props(
            wa_version="2.22.5.13",
            jid="67",
            features=[5, 7, 8, 13, 14, 19, 22, 25, 28, 30, 31, 32, 36, 37],
            max_feature=37,
        )
