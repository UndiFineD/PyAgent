# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\seo-optimizer\scripts\generate_sitemap.py
#!/usr/bin/env python3
"""
...
def estimate_changefreq(file_path):
    ...
    # Main pages change occasionally
        ...
        keyword in path_lower for keyword in ["index", "home", "about", "contact"]
    ):
        return "monthly"
...
def generate_sitemap_xml(
    html_files, base_url, include_priority=True, include_changefreq=True
):
    """
...
def main():
    ...
    sitemap_xml = generate_sitemap_xml(
        html_files, base_url, include_priority, include_changefreq
    )
