...
class PositionSizer:
    ...
    def __init__(
        ...
        logger.info(
            f"Initialized PositionSizer: max_risk={max_risk_percent:.1%}, max_pos={max_position_percent:.1%}"
        )
        ...
        try:
            ...
            result = {
                **standard_sizing,
                ...
                "trading_fees_est": round(
                    standard_sizing["standard_value_usd"] * self.trading_fee_percent, 2
                ),
            }
    ...
    def _calculate_standard_sizing(
        ...
        if standard_value_usd > max_position:
            ...
            logger.warning(
                f"Position capped at {self.max_position_percent:.1%} of balance"
            )
    ...
    def validate_position_size(
        self, position_value_usd: float, balance: float
    ) -> tuple[bool, str]:
        """
