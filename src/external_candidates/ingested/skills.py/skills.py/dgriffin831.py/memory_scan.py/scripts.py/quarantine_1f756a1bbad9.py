# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dgriffin831\memory-scan\scripts\quarantine.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="?",
        help="Line number (optional, omit to quarantine entire file)",
    )
