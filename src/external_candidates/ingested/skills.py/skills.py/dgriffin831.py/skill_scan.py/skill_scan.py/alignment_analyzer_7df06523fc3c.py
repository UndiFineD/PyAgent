# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dgriffin831\skill-scan\skill_scan\alignment_analyzer.py
...
class AlignmentAnalyzer:
    ...
    async def _analyze_async(
        ...
        user_prompt = self._build_user_prompt(
            delimiter, metadata, skill_md_content, file_contents
        )
