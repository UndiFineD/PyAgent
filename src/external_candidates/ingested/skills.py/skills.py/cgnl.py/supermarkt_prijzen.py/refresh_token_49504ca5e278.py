# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cgnl\supermarkt-prijzen\refresh-token.py
#!/usr/bin/env python3
"""
...
payload = {"clientId": "appie", "refreshToken": refresh_token}
...
r = requests.post(
    url, json=payload, headers=headers, impersonate="chrome120", timeout=10
)
...
if r.status_code == 200:
    ...
    print(
        f"Expires in: {new_tokens['expires_in']} sec ({new_tokens['expires_in']//3600}h)"
    )
