# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cgnl\supermarkt-prijzen\test-product-search-graphql.py
#!/usr/bin/env python3
import json
...
for i, query in enumerate(queries_to_test, 1):
    ...
    response = requests.post(
        ...
        json={"query": query, "variables": {"query": "melk", "limit": 5}},
