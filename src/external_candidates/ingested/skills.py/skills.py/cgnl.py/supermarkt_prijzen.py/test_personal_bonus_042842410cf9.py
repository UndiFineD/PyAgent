# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cgnl\supermarkt-prijzen\test-personal-bonus.py
#!/usr/bin/env python3
"""
...
variables = {"periodStart": period_start, "periodEnd": period_end}
