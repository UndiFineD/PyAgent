# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cgnl\supermarkt-prijzen\test-products-graphql2.py
#!/usr/bin/env python3
import json
...
response = requests.post(
    ...
    json={
        ...
        "query": query,
        "variables": {"periodStart": "2026-02-02", "periodEnd": "2026-02-09"},
    },
