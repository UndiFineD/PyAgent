# Extracted from: C:\DEV\PyAgent\.external\skills\skills\purch-agent\agentic-commerce\scripts\search.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    if has_more:
        print(
            f"📄 More results available. Use --page {args.page + 1} to see next page."
        )
