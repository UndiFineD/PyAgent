# Extracted from: C:\DEV\PyAgent\.external\skills\skills\valeraolexienko\whoop-integration\scripts\test_behavior.py
#!/usr/bin/env python3
"""
...
def test_sleep_scenarios():
    ...
    for scenario in scenarios:
        ...
        print(f"\n📊 {scenario['name']}:")
        print(
            f"Sleep Performance: {summary['sleep_performance']}% ({summary['status'].upper()})"
        )
