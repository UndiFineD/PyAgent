# Extracted from: C:\DEV\PyAgent\.external\skills\skills\matrixy\agent-registry\scripts\get_agent.py
#!/usr/bin/env python3
"""
Get Agent Script
...
def load_registry() -> Optional[Dict]:
    ...
    if not registry_path.exists():
        print(
            "Error: Registry not found. Run 'python scripts/init_registry.py' first.",
            file=sys.stderr,
        )
        return None
