# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mkoslacz\claw-face\scripts\api.py
#!/usr/bin/env python3
"""
...
Examples:
  ...
  avatar_api.py thinking searching "Looking..." -e radar
    ...
    parser.add_argument(
        "--progress", type=int, metavar="N", help="Progress bar (0-100)"
    )
    ...
    parser.add_argument(
        "--analyze", metavar="MSG", help="Analyzing code (matrix effect)"
    )
    ...
    parser.add_argument("message", nargs="?", default="", help="Message to display")
    parser.add_argument(
        "--effect",
        "-e",
        default="none",
    ...
    parser.add_argument(
        "--sub-success", type=int, default=0, help="Successful subagents"
    )
    parser.add_argument(
        "--sub-error", type=int, default=0, help="Failed subagents (error)"
    )
    parser.add_argument(
        "--sub-timeout", type=int, default=0, help="Timed out subagents"
    )
    parser.add_argument(
        "--sub-unknown", type=int, default=0, help="Unknown status subagents"
    )
