...
class SkillComposer:
    ...
    def compose(
        self, skills: List, intent: "ParsedIntent", name: Optional[str] = None
    ) -> ComposedSkill:
        """
        ...
        output_path = self._generate_skill_code(
            name=name, skills=ordered_skills, intent=intent
        )

        return ComposedSkill(
            name=name,
            description=intent.description
            or f"Composed flow for: {intent.primary_action}",
    ...
    def _generate_skill_code(
        self, name: str, skills: List, intent: "ParsedIntent"
    ) -> str:
        """
    ...
    def compose_from_templates(
        self, intent: "ParsedIntent", templates: List[Dict]
    ) -> ComposedSkill:
        """
    ...
    def _generate_from_templates(
        self, name: str, intent: "ParsedIntent", templates: List[Dict]
    ) -> str:
        """
