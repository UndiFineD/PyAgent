# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hqman\mijia\scripts\lamp_cli.py
#!/usr/bin/env python3
...
def cmd_mode(args, api):
    ...
    if args.value in modes:
        ...
        try:
            ...
            print(
                "Available modes: reading, computer, night, antiblue, work, candle, twinkle (0-6)"
            )
            sys.exit(1)
...
def main():
    ...
    p_mode.add_argument(
        "value", help="Mode: reading/computer/night/antiblue/work/candle/twinkle or 0-6"
    )
