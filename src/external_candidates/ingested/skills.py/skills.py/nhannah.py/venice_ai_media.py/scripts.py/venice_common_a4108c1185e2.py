...
def require_api_key() -> str:
    ...
    if not api_key:
        ...
        print(
            "Set VENICE_API_KEY env var or configure in ~/.clawdbot/clawdbot.json",
            file=sys.stderr,
        )
...
def validate_model(
    api_key: str, model: str, model_type: str = "image"
) -> tuple[bool, list[str]]:
