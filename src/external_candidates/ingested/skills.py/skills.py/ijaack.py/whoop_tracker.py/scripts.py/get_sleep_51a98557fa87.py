...
def main():
    ...
    for record in records:
        ...
        print(
            f"    REM: {f['rem']}  |  Deep: {f['deep']}  |  Light: {f['light']}  |  Awake: {f['awake']}"
        )
        print(f"  Performance:   {f['performance']}%")
        if f["efficiency"]:
            print(
                f"  Efficiency:    {f['efficiency']}%  |  Consistency: {f['consistency']}%"
            )
