...
def main() -> int:
    ...
    if args.help or not args.cmd:
        print(
            "Deprecated. Use scripts/auth.py, scripts/vehicles.py, scripts/vehicle_data.py, scripts/command.py"
        )
        print()
        ...
        print("Notes:")
        print(
            "  VEHICLE can be VIN or display name; omitted if you only have one vehicle."
        )
        return 0
