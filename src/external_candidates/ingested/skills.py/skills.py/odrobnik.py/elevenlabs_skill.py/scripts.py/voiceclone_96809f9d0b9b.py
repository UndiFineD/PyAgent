# Extracted from: C:\DEV\PyAgent\.external\skills\skills\odrobnik\elevenlabs-skill\scripts\voiceclone.py
#!/usr/bin/env python3
"""
...
""",
    ...
    parser.add_argument(
        "--files", "-f", nargs="+", required=True, help="Audio file(s) for cloning"
    )
    ...
    parser.add_argument(
        "--denoise", action="store_true", help="Remove background noise from samples"
    )
