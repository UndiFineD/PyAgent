# Extracted from: C:\DEV\PyAgent\.external\skills\skills\merend\openai-tts-python\openai_tts.py
#!/usr/bin/env python3
"""
...
def generate_tts(
    ...
    if verbose:
        ...
        print(
            f"Voice: {voice}, Model: {model}, Format: {response_format}, Speed: {speed}x"
        )
...
Voices:
  ...
  shimmer - Female, clear, professional
    ...
    parser.add_argument(
        "--format", default="mp3", choices=FORMATS, help="Output format"
    )
    parser.add_argument(
        "--speed",
        type=float,
