# Extracted from: C:\DEV\PyAgent\.external\skills\skills\worflor\working-with-lockdownd\scripts\wifi_lockdown.py
#!/usr/bin/env python3
...
def list_pairing_records() -> list[dict]:
    ...
    """
    lockdown_dir = (
        Path(os.environ.get("ALLUSERSPROFILE", "C:/ProgramData")) / "Apple" / "Lockdown"
    )
    out: list[dict] = []
...
def get_pairing_record(
    udid: str | None = None, pairing_path: str | None = None
) -> dict:
