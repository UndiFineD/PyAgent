# Extracted from: C:\DEV\PyAgent\.external\skills\skills\worflor\working-with-lockdownd\scripts\lockdownd_probe.py
#!/usr/bin/env python3
...
def redact(v: Any, *, bytes_mode: str = "len", depth: int = 0) -> Any:
    ...
    if isinstance(v, dict):
        return {
            k: redact(val, bytes_mode=bytes_mode, depth=depth + 1)
