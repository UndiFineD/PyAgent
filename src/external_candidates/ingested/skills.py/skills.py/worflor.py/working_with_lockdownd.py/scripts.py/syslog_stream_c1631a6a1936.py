# Extracted from: C:\DEV\PyAgent\.external\skills\skills\worflor\working-with-lockdownd\scripts\syslog_stream.py
#!/usr/bin/env python3
...
def main():
    ...
    ap = argparse.ArgumentParser(
        description="Stream iOS syslog_relay over WiFi lockdownd"
    )
