# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adamkristopher\seo-dataforseo\scripts\core\storage.py
...
def list_results(
    category: Optional[str] = None, operation: Optional[str] = None, limit: int = 50
) -> List[Path]:
    """
