...
def rainbow_wave(duration: int = 8):
    ...
    while time.time() - start < duration:
        ...
        for row in range(height):
            ...
            for col in range(width):
                # Wave function
                wave = math.sin((col * 0.2) + (t * 0.3)) * math.sin(
                    (row * 0.3) + (t * 0.2)
                )
...
JOKES = [
    ...
    (
        ...
        "They're constantly told they're not Java.",
    ),
...
def fortune_cookie():
    ...
    print(
        f"  {Colors.GOLD}│{Colors.RESET}            🥠 FORTUNE COOKIE 🥠          {Colors.GOLD}│{Colors.RESET}"
    )
    print(f"  {Colors.GOLD}├─────────────────────────────────────────┤{Colors.RESET}")
    print(
        f"  {Colors.GOLD}│{Colors.RESET}                                         {Colors.GOLD}│{Colors.RESET}"
    )
    ...
    for line in lines:
        ...
        print(
            f"  {Colors.GOLD}│{Colors.RESET} {' ' * padding}{Colors.WHITE}{line}{Colors.RESET}{' ' * (39 - padding - len(line))} {Colors.GOLD}│{Colors.RESET}"
        )
    ...
    print(
        f"  {Colors.GOLD}│{Colors.RESET} {' ' * padding}{Colors.SILVER}{lucky_str}{Colors.RESET}{' ' * (39 - padding - len(lucky_str))} {Colors.GOLD}│{Colors.RESET}"
    )
...
def art_gallery():
    ...
    print(f"  {Colors.GOLD}╔══════════════════════════════════════════╗{Colors.RESET}")
    print(
        f"  {Colors.GOLD}║{Colors.RESET}        🎨 ASCII ART GALLERY 🎨           {Colors.GOLD}║{Colors.RESET}"
    )
    print(f"  {Colors.GOLD}╚══════════════════════════════════════════╝{Colors.RESET}")
...
def main():
    ...
    try:
        while True:
            ...
            try:
                choice = (
                    input(f"  {Colors.CYAN}What do you want to play? {Colors.RESET}")
                    .strip()
                    .lower()
                )
            except EOFError:
            ...
            if choice == "q" or choice == "quit":
                ...
                print(
                    f"  {Colors.SILVER}Remember: productivity is a scam. Joy is real.{Colors.RESET}"
                )
                print()
                break
                ...
                print()
                print(
                    f"  {Colors.random()}That's not on the menu, but I respect the chaos.{Colors.RESET}"
                )
