...
class DiscordIntegration:
    ...
    def __init__(self, config_path: str = None):
        ...
        mapping_file = self.config.get(
            "channel_mapping_file", "channel-workspace-map.json"
        )
    ...
    def detect_context(
        self, channel_id: str = None, channel_name: str = None, project_name: str = None
    ) -> Dict:
        """
...
def detect_discord_context(
    channel_id: str = None, channel_name: str = None, project_name: str = None
) -> Dict:
    """
