# Extracted from: C:\DEV\PyAgent\.external\skills\skills\johnsonfarmsus\claw-conductor\scripts\test_decomposer.py
#!/usr/bin/env python3
"""
    ...
    test_config = {
        ...
        "agents": {
            "mistral-devstral-2512": {
                ...
                "provider": "mistral",
                "enabled": True,
                "user_cost": {"type": "free-tier"},
                "capabilities": {
                    "code-generation-new-features": {"rating": 5, "max_complexity": 5},
                    "frontend-development": {"rating": 5, "max_complexity": 5},
                    "codebase-exploration": {"rating": 4, "max_complexity": 4},
                },
            },
            "llama-3.3-70b": {
                ...
                "user_cost": {"type": "free"},
                "capabilities": {
                    "code-generation-new-features": {"rating": 4, "max_complexity": 4},
                    "unit-test-generation": {"rating": 5, "max_complexity": 5},
                    "documentation-generation": {"rating": 3, "max_complexity": 3},
                },
            },
            "perplexity-sonar": {
                ...
                "provider": "perplexity",
                "enabled": True,
                "user_cost": {"type": "pay-per-use"},
                "capabilities": {
                    "documentation-generation": {"rating": 5, "max_complexity": 5},
                    "codebase-exploration": {"rating": 5, "max_complexity": 5},
                },
            },
        },
    }
...
def test_response_parsing():
    ...
    try:
        ...
        checks = [
            ...
            (
                "complexity values",
                all(isinstance(t.get("complexity"), int) for t in tasks),
            ),
