# Extracted from: C:\DEV\PyAgent\.external\skills\skills\abe238\adversarial-prompting\scripts\export_analysis.py
#!/usr/bin/env python3
"""
...
def export_analysis(content: str, problem_summary: str = "analysis") -> str:
    ...
    safe_summary = "".join(
        c for c in problem_summary if c.isalnum() or c in (" ", "-", "_")
    ).strip()
