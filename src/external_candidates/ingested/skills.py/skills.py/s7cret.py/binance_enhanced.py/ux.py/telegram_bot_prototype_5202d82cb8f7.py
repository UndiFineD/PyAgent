# Extracted from: C:\DEV\PyAgent\.external\skills\skills\s7cret\binance-enhanced\ux\telegram_bot_prototype.py
#!/usr/bin/env python3
"""
...
class TelegramBotPrototype:
    ...
    def on_callback(self, chat_id, callback_data, state):
        ...
        if callback_data.startswith("edit"):
            ...
            return {
                "chat_id": chat_id,
                "text": "Что хотели бы изменить? (Например: количество, цену)",
            }
