# Extracted from: C:\DEV\PyAgent\.external\skills\skills\s7cret\binance-enhanced\security\keys_crypto.py
#!/usr/bin/env python3
"""
...
def derive_key(password: str, salt: bytes) -> bytes:
    return PBKDF2(
        password, salt, dkLen=KEY_LEN, count=ITERATIONS, hmac_hash_module=sha256
    )
