# Extracted from: C:\DEV\PyAgent\.external\skills\skills\abhinavjp\ms-outlook-teams-assistant\scripts\draft_reply.py
...
def main() -> int:
    ...
    if not target:
        print(
            f"No message found in last {args.days} days for subject containing: {args.subject}",
            file=sys.stderr,
        )
        return 2
