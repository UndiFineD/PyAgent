# Extracted from: C:\DEV\PyAgent\.external\skills\skills\abhinavjp\ms-outlook-teams-assistant\scripts\scan_outlook.py
...
from state import is_snoozed, load_state
...
def main() -> int:
    ...
    max_items = (
        args.max_items if args.max_items is not None else int(o.get("maxItems", 200))
    )
