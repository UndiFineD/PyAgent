# Extracted from: C:\DEV\PyAgent\.external\skills\skills\g0head\tokenguard\scripts\tokenguard.py
#!/usr/bin/env python3
"""
...
def get_session() -> dict:
    ...
    default = {"date": today, "total_spent": 0.0, "entries": []}
...
def cmd_reset(args):
    ...
    session = {"date": date.today().isoformat(), "total_spent": 0.0, "entries": []}
    save_json(SESSION_FILE, session)
...
def cmd_export(args):
    ...
    export_data = {
        ...
        "pct_used": (
            (session["total_spent"] / limit_config["limit"] * 100)
