# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\tests\test_undo_ops.py
#!/usr/bin/env python3
...
class TestFindLastUndoable(unittest.TestCase):
    ...
    def test_exits_when_all_too_old(self):
        ...
        test_data = {
            "changes": [{"id": "chg_001", "timestamp": old_time, "can_undo": True}]
        }
        with open(self.changelog_file, "w") as f:
            json.dump(test_data, f)
