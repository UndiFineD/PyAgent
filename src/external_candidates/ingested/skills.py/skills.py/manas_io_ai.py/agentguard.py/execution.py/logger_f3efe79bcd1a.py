...
class AgentLogger:
    ...
    def log_file_access(
        self, path: str, event_type: str, size: Optional[int] = None
    ) -> LogEntry:
    ...
    def log_communication(
        ...
        return self.log(
            ...
            comm_type,
            {
                ...
                or SensitiveDataSanitizer.hash_sensitive(destination),
                "size": size,
            },
        )
    ...
    def get_logs(
        self, category: LogCategory, date: Optional[str] = None, limit: int = 100
    ) -> List[Dict]:
