# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ivaavimusic\x402-layer\scripts\manage_endpoint.py
#!/usr/bin/env python3
"""
...
def update_endpoint(
    slug: str, price: float = None, name: str = None, origin_url: str = None
) -> dict:
...
def main():
    ...
    if args.command == "list":
        ...
        result = update_endpoint(
            args.slug, args.price, args.name, getattr(args, "origin_url", None)
        )
    else:
        parser.print_help()
        return
