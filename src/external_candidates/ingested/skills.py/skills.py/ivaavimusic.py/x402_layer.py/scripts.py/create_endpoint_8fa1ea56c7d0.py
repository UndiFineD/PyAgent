...
def create_endpoint(
    slug: str, name: str, origin_url: str, price: float, chain: str = "base"
) -> dict:
    """
    ...
    response = requests.post(
        url, json=data, headers={"X-Payment": x_payment, "x-wallet-address": wallet}
    )
...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        ...
        print(
            'Example: python create_endpoint.py my-api "My API" https://api.example.com 0.01'
        )
        sys.exit(1)
