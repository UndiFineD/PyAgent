# Extracted from: C:\DEV\PyAgent\.external\skills\skills\zbruceli\unifai-trading-suite\src\toolkits\trading_toolkit.py
...
async def create_trading_toolkit():
    ...
    async def get_portfolio(
        ctx: unifai.ActionContext, payload: dict = {}
    ):  # noqa: ARG001
    ...
    print(
        "Registered actions: get_market_info, analyze_sentiment, execute_trade, get_portfolio"
    )
    await toolkit.run()
