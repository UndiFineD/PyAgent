...
class PolymarketClient:
    ...
    async def get_events_by_category(
        ...
        result = await self._call_tool(
            "polymarket--127--getEventsByCategory", {"category": category}
        )
    ...
    async def get_markets(
        ...
        result = await self._call_tool(
            "polymarket--127--searchPolymarketMarkets", params
        )
        return result if isinstance(result, list) else []
    ...
    async def get_prices(
        ...
        result = await self._call_tool(
            "polymarket--127--getPrices", {"tokenIds": token_ids, "sides": sides}
        )
        return result if isinstance(result, list) else []
    ...
    async def get_orderbooks(
        ...
        result = await self._call_tool(
            "polymarket--127--getOrderBooks", {"tokenIds": token_ids, "sides": sides}
        )
        return result if isinstance(result, list) else []
