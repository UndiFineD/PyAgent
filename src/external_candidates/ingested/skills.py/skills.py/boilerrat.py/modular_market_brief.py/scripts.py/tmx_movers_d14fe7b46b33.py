# Extracted from: C:\DEV\PyAgent\.external\skills\skills\boilerrat\modular-market-brief\scripts\tmx_movers.py
#!/usr/bin/env python3
"""tmx_movers.py
            ...
            json.dumps(
                {
                    ...
                    "hint": "Use browser snapshot/eval to read the table.",
                }
            )
        )
        return
