...
def find_opportunities(
    min_certainty: float = 0.85, min_return: float = 0.10, min_volume: int = 100
) -> list:
    """
...
def main():
    ...
    # opportunities
    p_opps = subparsers.add_parser(
        "opportunities", help="Find high-value opportunities"
    )
    p_opps.add_argument(
        "-c",
        "--certainty",
    ...
    p_opps.add_argument(
        "-m", "--min-volume", type=int, default=100, help="Min volume (default: 100)"
    )
