# Extracted from: C:\DEV\PyAgent\.external\skills\skills\bsinriclawd\hvac-estimate-takeoff\pymupdf-pdf-parser-clawdbot-skill\scripts\pymupdf_parse.py
#!/usr/bin/env python3
...
def main():
    ...
    parser.add_argument(
        "--format", default="md", choices=["md", "json", "both"], help="Output format"
    )
    parser.add_argument("--images", action="store_true", help="Extract images")
    parser.add_argument(
        "--tables", action="store_true", help="Extract simple tables (lines)"
    )
