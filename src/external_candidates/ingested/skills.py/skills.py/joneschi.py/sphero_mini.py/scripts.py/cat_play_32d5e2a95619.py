# Extracted from: C:\DEV\PyAgent\.external\skills\skills\joneschi\sphero-mini\scripts\cat_play.py
#!/usr/bin/env python3
"""
...
async def cat_play_mode():
    ...
    try:
        ...
        while (asyncio.get_event_loop().time() - start_time) < duration:
            ...
            print(
                f"[{elapsed}s] Move {move_count}: speed={speed}, heading={heading}°, color=RGB({r},{g},{b})"
            )
