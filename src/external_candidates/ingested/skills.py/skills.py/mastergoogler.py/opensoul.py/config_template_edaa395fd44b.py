# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mastergoogler\opensoul\config_template.py
"""
...
def validate_config():
    ...
    if PGP_ENABLED:
        ...
        if not PGP_PASSPHRASE:
            issues.append(
                "PGP_PASSPHRASE not set (set PGP_PASSPHRASE environment variable)"
            )
