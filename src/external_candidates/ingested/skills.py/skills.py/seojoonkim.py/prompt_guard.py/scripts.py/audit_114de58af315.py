# Extracted from: C:\DEV\PyAgent\.external\skills\skills\seojoonkim\prompt-guard\scripts\audit.py
#!/usr/bin/env python3
"""
...
class SecurityAudit:
    ...
    def check_file_permissions(
        self, path: str, expected_mode: int, description: str
    ) -> bool:
    ...
    def run_audit(self, quick: bool = False) -> Tuple[int, int, int]:
        ...
        self.check_dir_permissions(
            "~/.clawdbot", 0o700, "Clawdbot directory permissions"
        )
        self.check_file_permissions(
            "~/.clawdbot/clawdbot.json", 0o600, "Config file permissions"
        )
...
def main():
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Quick audit (skip slow checks)"
    )
    parser.add_argument("--fix", action="store_true", help="Attempt to auto-fix issues")
    parser.add_argument("--json", action="store_true", help="Output as JSON")
    parser.add_argument(
        "--verbose", "-v", action="store_true", help="Show passed checks"
    )
