    ...
    for dir_path, files in template["structure"].items():
        ...
        for filename in files:
            ...
            content = get_file_content(
                template_name, str(dir_path / filename), project_name
            )
...
def main():
    ...
    parser.add_argument(
        "--list-templates", "-l", action="store_true", help="List templates"
    )
    ...
    result = create_project(
        args.template, args.project_name, Path(args.output).resolve()
    )
