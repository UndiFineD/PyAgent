# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\tdd-guide\scripts\output_formatter.py
"""
...
class OutputFormatter:
    ...
    def format_coverage_summary(
        self, summary: Dict[str, Any], detailed: bool = False
    ) -> str:
        """
    ...
    def _format_coverage_markdown(self, summary: Dict[str, Any], detailed: bool) -> str:
        ...
        lines.append(
            f"- **Function Coverage**: {summary.get('function_coverage', 0):.1f}%\n"
        )
        ...
        if detailed:
            ...
            lines.append(
                f"- Covered Functions: {summary.get('covered_functions', 0)}\n"
            )
    ...
    def _format_recommendations_json(
    ...
    def format_test_results(
        self, results: Dict[str, Any], show_details: bool = False
    ) -> str:
        """
    ...
    def _format_results_markdown(
        self, results: Dict[str, Any], show_details: bool
    ) -> str:
    ...
    def create_summary_report(
        ...
        if p0_count > 0:
            ...
            top_rec = next(
                (r for r in recommendations if r.get("priority") == "P0"), None
            )
            if top_rec:
