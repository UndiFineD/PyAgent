# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\tdd-guide\scripts\metrics_calculator.py
"""
        ...
        if "test_quality" in self.metrics:
            ...
            if qual["test_smells"]:
                ...
                for smell in qual["test_smells"]:
                    lines.append(
                        f"- {smell['description']} (severity: {smell['severity']})"
                    )
                lines.append("")
