...
def interactive_mode():
    ...
    effective_date = (
        input("Effective Date (YYYY-MM-DD, or Enter to skip): ").strip() or None
    )
    review_date = (
        input("Next Review Date (YYYY-MM-DD, or Enter to skip): ").strip() or None
    )
...
def main():
    ...
    parser.add_argument(
        "--sample", action="store_true", help="Generate sample document JSON"
    )
