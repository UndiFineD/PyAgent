...
"""
    ...
    def generate_license_assignment_recommendations(
        ...
        if any(
            ...
            keyword in user_role.lower()
            for keyword in ["admin", "it", "security", "compliance"]
        ):
            return {
                "recommended_license": "Microsoft 365 E5",
            ...
            keyword in user_role.lower()
            for keyword in ["manager", "lead", "supervisor"]
        ):
            return {
    ...
    def generate_group_membership_recommendations(
