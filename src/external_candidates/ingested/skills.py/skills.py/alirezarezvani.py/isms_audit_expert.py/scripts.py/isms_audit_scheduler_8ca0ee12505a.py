# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\isms-audit-expert\scripts\isms_audit_scheduler.py
#!/usr/bin/env python3
"""
...
def generate_audit_plan(
    year: int, controls: Optional[Dict[str, Dict]] = None
) -> Dict[str, Any]:
    ...
    plan["summary"] = {
        ...
        "audits_per_quarter": {
            q: len(plan["schedule"][q]["audits"]) for q in plan["schedule"]
        },
    }
