# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xdrshjr\doubao-api-open-tts\scripts\test_tts.py
#!/usr/bin/env python3
"""
火山引擎TTS测试脚本 - 测试多种配置
"""
...
def test_tts_configs():
    ...
    try:
        ...
        print("\n[初始化] 创建TTS客户端...")
        tts = VolcanoTTS(
            app_id=app_id, access_token=access_token, secret_key=secret_key
        )
        print("  ✓ 初始化成功")
