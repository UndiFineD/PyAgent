...
def parse_session_file(
    filepath: Path, target_date: Optional[str] = None
) -> List[Dict[str, Any]]:
    """
...
def aggregate_by_hour(
    records: List[Dict[str, Any]], session_key: str, channel: str
...
def export_to_csv(
    all_aggregates: Dict[str, Dict[str, Any]], export_dir: Path, date_str: str
):
    """
...
def main():
    ...
    export_dir = (
        ...
        if args.export_dir
        else Path(os.environ.get("USAGE_EXPORT_DIR", DEFAULT_EXPORT_DIR))
    )
