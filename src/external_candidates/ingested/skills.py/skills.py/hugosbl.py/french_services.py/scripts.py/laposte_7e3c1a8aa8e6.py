# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hugosbl\french-services\scripts\laposte.py
#!/usr/bin/env python3
...
def get_api_key():
    ...
    if not key:
        print(
            "❌ Variable d'environnement LAPOSTE_API_KEY non définie.", file=sys.stderr
        )
        print(
            "   Inscris-toi gratuitement sur https://developer.laposte.fr",
            file=sys.stderr,
        )
