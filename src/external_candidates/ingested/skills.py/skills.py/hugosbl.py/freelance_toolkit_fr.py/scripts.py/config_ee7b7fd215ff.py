# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hugosbl\freelance-toolkit-fr\scripts\config.py
#!/usr/bin/env python3
...
def main():
    ...
    p_set.add_argument(
        "--rate", type=float, default=None, help="Taux horaire par défaut"
    )
