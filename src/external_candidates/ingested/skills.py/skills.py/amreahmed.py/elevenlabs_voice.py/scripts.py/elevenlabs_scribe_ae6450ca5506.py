# Extracted from: C:\DEV\PyAgent\.external\skills\skills\amreahmed\elevenlabs-voice\scripts\elevenlabs_scribe.py
import os
...
def main():
    ...
    result = client.transcribe(
        args.audio_file, language_code=args.language, num_speakers=args.speakers
    )
    print(result)
