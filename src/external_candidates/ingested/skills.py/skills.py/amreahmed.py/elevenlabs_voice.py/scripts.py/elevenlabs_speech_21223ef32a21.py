# Extracted from: C:\DEV\PyAgent\.external\skills\skills\amreahmed\elevenlabs-voice\scripts\elevenlabs_speech.py
import base64
import os
...
def main():
    ...
    parser.add_argument(
        "action", choices=["tts", "voices"], help="Action: tts or voices"
    )
    ...
    parser.add_argument(
        "--voice", "-v", default="21m00Tcm4TlvDq8ikWAM", help="Voice ID"
    )
    ...
    if args.action == "tts":
        ...
        result = client.text_to_speech(
            args.text, voice_id=args.voice, output_path=args.output
        )
