# Extracted from: C:\DEV\PyAgent\.external\skills\skills\paki81\qwen-tts\scripts\tts-voicedesign.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        "-v", "--voice", default=DEFAULT_VOICE, help="Voice description"
    )
    parser.add_argument(
        "-l", "--language", default="Italian", help="Language (default: Italian)"
    )
    parser.add_argument("-i", "--instruct", default="", help="Additional instructions")
    parser.add_argument(
        "--remote",
    ...
    if not args.remote:
        ...
        print(
            "   Or set: export QWEN_TTS_REMOTE=http://192.168.188.177:8765",
            file=sys.stderr,
        )
        sys.exit(1)
