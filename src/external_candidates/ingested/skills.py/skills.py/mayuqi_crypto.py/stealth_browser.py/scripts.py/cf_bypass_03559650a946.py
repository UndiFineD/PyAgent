...
def bypass_cloudflare_flaresolverr(
    url: str, flaresolverr_url: str = "http://localhost:8191/v1", timeout: int = 60
):
    """
...
def test_cf_protection(url: str) -> dict:
    ...
    try:
        ...
        cf_headers = {
            k: v for k, v in resp.headers.items() if k.lower().startswith("cf-")
        }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test", "-t", action="store_true", help="Test if URL has CF protection"
    )
