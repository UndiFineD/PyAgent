...
def main():
    ...
    parser.add_argument(
        "--rotate-proxy", action="store_true", help="Use rotating proxy from config"
    )
    parser.add_argument(
        "--save", action="store_true", help="Save session after operation"
    )
    ...
    parser.add_argument(
        "--wait", type=int, default=5, help="Wait seconds after page load"
    )
    parser.add_argument(
        "--test-stealth",
        action="store_true",
