...
def make_request(
    url: str, method: str = "GET", data: dict = None, token: str = None
) -> dict:
...
def list_accessories(
    base_url: str, token: str, room: str = None, acc_type: str = None
) -> list:
...
def set_characteristic(
    base_url: str, token: str, accessory_id: str, characteristic: str, value
) -> dict:
...
def main():
    ...
    set_parser.add_argument(
        "characteristic", help="Characteristic type (e.g., On, Brightness)"
    )
    ...
    if args.command == "list":
        ...
        result = set_characteristic(
            base_url, token, args.accessory_id, args.characteristic, args.value
        )
