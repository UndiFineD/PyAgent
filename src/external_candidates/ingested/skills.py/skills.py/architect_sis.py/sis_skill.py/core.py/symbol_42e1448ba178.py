# Extracted from: C:\DEV\PyAgent\.external\skills\skills\architect-sis\sis-skill\core\symbol.py
"""
═══════════════════════════════════════════════════════════════════════════════
...
class SISSymbol:
    ...
    def lock_to(
        self, other: "SISSymbol", lock_type: str = "bidirectional"
    ) -> "SISSymbol":
        """
    ...
    def _compute_hash(self) -> str:
        ...
        content = (
            f"{self.glyph}:{self.value}:{self.delta_contribution}:{self.created_at}"
        )
