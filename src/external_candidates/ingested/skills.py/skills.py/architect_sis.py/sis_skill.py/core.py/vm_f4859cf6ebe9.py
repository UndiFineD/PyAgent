# Extracted from: C:\DEV\PyAgent\.external\skills\skills\architect-sis\sis-skill\core\vm.py
"""
═══════════════════════════════════════════════════════════════════════════════
...
from .validator import EquilibriumValidator, SISValidator, ValidationResult
...
class SISVM:
    ...
    def execute_sequence(
        ...
        if require_balance:
            ...
            if not validation.valid:
                ...
                return [
                    ExecutionResult(
                        success=False, equilibrium_delta=validation.equilibrium_delta
                    )
                    for _ in symbols
                ]
    ...
    def execute_parallel(self, symbols: List[SISSymbol]) -> List[ExecutionResult]:
        """
    ...
    def equilibrium_loop(
        ...
        return {
            ...
            "converged": abs(sum(s.delta_contribution for s in current_symbols))
