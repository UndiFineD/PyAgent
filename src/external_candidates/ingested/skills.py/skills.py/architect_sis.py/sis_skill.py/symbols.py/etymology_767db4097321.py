# Extracted from: C:\DEV\PyAgent\.external\skills\skills\architect-sis\sis-skill\symbols\etymology.py
"""
═══════════════════════════════════════════════════════════════════════════════
...
def print_inevitability_proof():
    ...
    for glyph, etym in ETYMOLOGY_REGISTRY.items():
        ...
        print(f"   Form: {etym.geometry.form}")
        print(
            f"   Proof: {etym.geometry.inevitability.strip().split(chr(10))[-2].strip()}"
        )
