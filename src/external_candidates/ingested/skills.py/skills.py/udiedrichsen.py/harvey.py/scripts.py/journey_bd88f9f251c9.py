# Extracted from: C:\DEV\PyAgent\.external\skills\skills\udiedrichsen\harvey\scripts\journey.py
#!/usr/bin/env python3
# /// script
...
def get_context() -> dict:
    ...
    if journey.get("current_location") and journey["current_location"] != journey.get(
        "start_location"
    ):
