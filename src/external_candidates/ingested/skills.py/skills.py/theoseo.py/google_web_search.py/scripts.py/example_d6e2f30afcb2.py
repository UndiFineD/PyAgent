# Extracted from: C:\DEV\PyAgent\.external\skills\skills\theoseo\google-web-search\scripts\example.py
#!/usr/bin/env python3
"""
...
def get_grounded_response(prompt: str, model: str = None) -> str:
    ...
    if not api_key:
        return (
            "ERROR: GEMINI_API_KEY environment variable not set. Cannot ground search."
        )
