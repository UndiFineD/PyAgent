# Extracted from: C:\DEV\PyAgent\.external\skills\skills\arc-claw-bot\fulcra-morning-briefing\authorize_fulcra.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    token_data = {
        ...
        "expiration": (
            api.fulcra_cached_access_token_expiration.isoformat()
            if api.fulcra_cached_access_token_expiration
            else None
        ),
    ...
    print()
    print(
        "You're all set! Run collect_briefing_data.py to get your morning briefing data."
    )
