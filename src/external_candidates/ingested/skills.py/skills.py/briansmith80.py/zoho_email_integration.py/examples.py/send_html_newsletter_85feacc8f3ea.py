# Extracted from: C:\DEV\PyAgent\.external\skills\skills\briansmith80\zoho-email-integration\examples\send-html-newsletter.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    result = zoho.send_html_email(
        to=test_email, subject="Test: Simple HTML Email", html_body=simple_html
    )
