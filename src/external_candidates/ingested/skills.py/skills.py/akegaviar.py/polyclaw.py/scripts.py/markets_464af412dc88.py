    ...
    if args.json:
        ...
        for m in markets:
            question = (
                m.question
                if args.full
                else (m.question[:60] + "..." if len(m.question) > 60 else m.question)
            )
            print(
            ...
            for m in e.markets[:3]:
                question = (
                    ...
                    if args.full
                        ...
                        m.question[:70] + "..." if len(m.question) > 70 else m.question
                    )
                )
...
def main():
    ...
    trending_parser.add_argument(
        "--limit", type=int, default=20, help="Number of markets"
    )
    trending_parser.add_argument(
        "--full", action="store_true", help="Show full question text"
    )
    ...
    search_parser.add_argument(
        "--limit", type=int, default=20, help="Number of results"
    )
    search_parser.add_argument(
        "--full", action="store_true", help="Show full question text"
    )
