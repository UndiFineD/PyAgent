# Extracted from: C:\DEV\PyAgent\.external\skills\skills\crazypeace\menstrual-cycle-tracking\menstrual_tracker.py
"""
...
class MenstrualTracker:
    ...
    def get_analysis(self):
        ...
        pain_values = [
            entry["structured_data"]["pain_level"]
            for entry in self.data
    ...
    def generate_visualization(self, output_file="menstrual_analysis.png"):
        ...
        for item in self.data:
            ...
            bleeding_val = bleeding_map.get(
                item["structured_data"]["bleeding_level"], 0
            )
        ...
        if unique_moods:
            ...
            # Show top moods
            mood_counts = [
                (mood, sum(row)) for mood, row in zip(unique_moods, mood_matrix)
            ]
            ...
            if top_mood_names:
                ...
                im = axes[2].imshow(
                    top_mood_matrix, aspect="auto", cmap="YlOrRd", interpolation="none"
                )
