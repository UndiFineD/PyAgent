# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xenofex7\milkee\scripts\milkee.py
#!/usr/bin/env python3
"""
...
def update_project(args):
    """Update project"""
    data = {"name": args.name, "budget": args.budget, "customer_id": args.customer_id}
...
def create_product(args):
    """Create product"""
    data = {"name": args.name, "price": args.price, "description": args.description}
