...
class AssociativeMemory:
    ...
    def __init__(
        self, store_path: Optional[str | Path] = None, collection: str = "default"
    ) -> None:
        ...
        self._summarization_provider: SummarizationProvider = (
            registry.create_summarization(
    ...
    def find(
        self, query: str, *, limit: int = 10, collection: Optional[str] = None
    ) -> list[Item]:
        """
