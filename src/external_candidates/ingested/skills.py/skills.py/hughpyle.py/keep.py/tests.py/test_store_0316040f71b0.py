...
class TestEmbeddingQueries:
    ...
    def test_query_embedding_returns_similar(self, store):
        ...
        store.upsert(
            "test", "doc:2", [0.9, 0.1, 0.0, 0.0], "Second", {}
        )  # Similar to first
...
class TestMetadataQueries:
    ...
    def test_query_metadata_multiple_conditions(self, store, sample_embedding):
        ...
        store.upsert(
            "test", "doc:1", sample_embedding, "A", {"type": "doc", "lang": "en"}
        )
        store.upsert(
            "test", "doc:2", sample_embedding, "B", {"type": "doc", "lang": "es"}
        )
        store.upsert(
            "test", "doc:3", sample_embedding, "C", {"type": "code", "lang": "en"}
        )
...
class TestFulltextQueries:
    ...
    def test_query_fulltext_substring(self, store, sample_embedding):
        ...
        store.upsert(
            "test", "doc:1", sample_embedding, "Installation guide for Python", {}
        )
        store.upsert(
            "test", "doc:2", sample_embedding, "API reference documentation", {}
        )
