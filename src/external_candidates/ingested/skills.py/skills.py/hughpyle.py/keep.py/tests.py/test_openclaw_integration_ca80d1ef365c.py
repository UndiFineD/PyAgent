# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\tests\test_openclaw_integration.py
"""
...
class TestReadOpenclawConfig:
    ...
    def test_returns_none_when_no_config(self):
        ...
        with patch.dict(
            os.environ, {"OPENCLAW_CONFIG": "/nonexistent/path.json"}, clear=False
        ):
    ...
    def test_uses_gemini_when_configured(self):
        ...
        try:
            ...
            with patch.dict(os.environ, env, clear=False):
                ...
                assert (
                    providers["embedding"].params.get("model") == "text-embedding-004"
                )
        finally:
            os.unlink(temp_path)
    ...
    def test_uses_openai_when_configured(self):
        ...
        try:
            ...
            with patch.dict(os.environ, env, clear=False):
                ...
                assert (
                    providers["embedding"].params.get("model")
...
class TestGeminiEmbeddingProvider:
    ...
    def test_gemini_requires_api_key(self):
        ...
        env_clear = {
            k: "" for k in ["GEMINI_API_KEY", "GOOGLE_API_KEY", "GOOGLE_GENAI_API_KEY"]
        }
