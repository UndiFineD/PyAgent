...
class SalesReporter:
    ...
    def process_data(self, sales, expenses):
        ...
        for s in sales:
            ...
            customer_revenue[partner_name] = (
                customer_revenue.get(partner_name, 0) + amount
            )
...
if __name__ == "__main__":
    ...
    print(
        f"Processing {len(sales)} sales records and {len(expenses)} expense records..."
    )
