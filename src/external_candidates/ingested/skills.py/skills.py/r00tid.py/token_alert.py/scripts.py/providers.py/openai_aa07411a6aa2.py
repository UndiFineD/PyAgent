# Extracted from: C:\DEV\PyAgent\.external\skills\skills\r00tid\token-alert\scripts\providers\openai.py
"""
OpenAI Provider
    ...
    def get_usage(self) -> Dict:
        ...
        try:
            ...
            response = requests.get(
                "https://api.openai.com/v1/usage", headers=headers, timeout=10
            )
