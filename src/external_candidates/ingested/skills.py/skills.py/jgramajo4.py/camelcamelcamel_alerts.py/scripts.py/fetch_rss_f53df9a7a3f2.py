# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jgramajo4\camelcamelcamel-alerts\scripts\fetch_rss.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    if new_alerts:
        ...
        print(
            json.dumps(
                {"timestamp": datetime.utcnow().isoformat(), "alerts": [], "count": 0}
            )
        )
