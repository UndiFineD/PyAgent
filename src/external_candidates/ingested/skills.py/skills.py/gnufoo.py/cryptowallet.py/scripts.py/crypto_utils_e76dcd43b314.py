# Extracted from: C:\DEV\PyAgent\.external\skills\skills\gnufoo\cryptowallet\scripts\crypto_utils.py
#!/usr/bin/env python3
"""
...
def encrypt_private_key(private_key: str, password: str) -> dict:
    ...
    return {"salt": salt.hex(), "nonce": nonce.hex(), "ciphertext": ciphertext.hex()}
