# Extracted from: C:\DEV\PyAgent\.external\skills\skills\leonardsellem\plaud-unofficial\plaud_client.py
#!/usr/bin/env python3
"""
...
""",
    ...
    list_parser.add_argument(
        "--include-trash", action="store_true", help="Include trashed files"
    )
    ...
    download_all_parser = subparsers.add_parser(
        "download-all", help="Download all audio files"
    )
    download_all_parser.add_argument(
        "--output", "-o", default="./plaud_downloads", help="Output directory"
    )
    download_all_parser.add_argument(
        "--include-trash", action="store_true", help="Include trashed files"
    )
