...
def get_top_artists(token_data, time_range="medium_term", limit=20):
    return api_request(
        "/me/top/artists", token_data, {"time_range": time_range, "limit": limit}
    )


def get_top_tracks(token_data, time_range="medium_term", limit=20):
    return api_request(
        "/me/top/tracks", token_data, {"time_range": time_range, "limit": limit}
    )


def get_recommendations(
    token_data, seed_artists=None, seed_tracks=None, seed_genres=None, limit=20
):
    params = {"limit": limit}
    if seed_artists:
