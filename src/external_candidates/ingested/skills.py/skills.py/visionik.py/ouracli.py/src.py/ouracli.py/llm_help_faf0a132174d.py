# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\src\ouracli\llm_help.py
        ...
        "commands": [
            {
                ...
                "examples": [
                    ...
                    {
                        "command": 'ouracli activity "7 days" --json',
            ...
            },
            {
                ...
                "examples": [
                    {
                        "command": "ouracli sleep today --json",
                        "description": "Today's sleep",
                    },
                    {
                        "command": 'ouracli sleep "30 days" --json',
            ...
            },
            {
                ...
                "examples": [
                    {
                        "command": 'ouracli readiness "7 days" --json',
            ...
            },
            {
                ...
                "examples": [
                    {
                        "command": 'ouracli spo2 "7 days" --json',
                        "description": "Last week SpO2",
                    }
                ],
            },
            {
                ...
                "examples": [
                    {
                        "command": 'ouracli stress "7 days" --json',
                        "description": "Last week stress",
                    }
                ],
            },
            {
            ...
            },
            {
                ...
                "examples": [
                    {
                        "command": 'ouracli tag "7 days" --json',
                        "description": "Last week tags",
                    }
                ],
            },
            {
            ...
            },
            {
                ...
                "examples": [
                    {
                        "command": "ouracli personal_info --json",
...
"""
    ...
    body.extend(
        [
            ...
            "- "
            + "\n- ".join(
                [f"{t['error']}: {t['solution']}" for t in spec["troubleshooting"]]
            ),
            "",
            "## Related Tools",
            "- "
