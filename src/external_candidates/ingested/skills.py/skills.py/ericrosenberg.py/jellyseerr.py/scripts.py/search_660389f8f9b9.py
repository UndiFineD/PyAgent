# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ericrosenberg\jellyseerr\scripts\search.py
#!/usr/bin/env python3
"""
...
def format_result(item):
    ...
    year = (
        ...
        else item.get("firstAirDate", "")[:4] if item.get("firstAirDate") else ""
    )
