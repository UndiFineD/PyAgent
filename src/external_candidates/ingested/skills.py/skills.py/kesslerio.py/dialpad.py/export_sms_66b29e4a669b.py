# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\dialpad\export_sms.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        "--start-date", dest="start_date", help="Start date (YYYY-MM-DD)"
    )
    parser.add_argument("--end-date", dest="end_date", help="End date (YYYY-MM-DD)")
    parser.add_argument(
        "--office-id", dest="office_id", help="Office ID to filter (optional)"
    )
