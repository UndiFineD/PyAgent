# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\oura-analytics\scripts\timezone_utils.py
#!/usr/bin/env python3
"""
...
def get_canonical_day(
    utc_timestamp: str, user_tz: Optional[str] = None
...
def get_canonical_day_from_date_str(
    date_str: str, user_tz: Optional[str] = None
) -> Optional[date]:
    """
...
def is_travel_day(
    sleep_records: list, threshold_hours: float = 3.0, user_tz: Optional[str] = None
) -> List[date]:
    """
...
def get_sleep_for_canonical_day(
    sleep_data: list, target_date: date, user_tz: Optional[str] = None
) -> list:
    """
...
def group_by_canonical_day(
    data: list, timestamp_field: str = "day", user_tz: Optional[str] = None
) -> dict:
    """
...
def format_localized_datetime(
    utc_timestamp: str, fmt: str = "%Y-%m-%d %H:%M", user_tz: Optional[str] = None
) -> str:
    """
