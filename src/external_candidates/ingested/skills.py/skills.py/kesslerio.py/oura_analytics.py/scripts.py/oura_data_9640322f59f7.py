# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\oura-analytics\scripts\oura_data.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    # Common args
    parser.add_argument(
        "--data-dir", type=Path, help="Data directory (default: ~/.oura-analytics)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--endpoint",
        choices=["sleep", "daily_readiness", "daily_activity"],
        help="Specific endpoint to clear",
    )

    # Cleanup args
    parser.add_argument(
        "--days", type=int, default=90, help="Delete cache older than N days"
    )
