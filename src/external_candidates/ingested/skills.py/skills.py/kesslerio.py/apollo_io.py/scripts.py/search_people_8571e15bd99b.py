# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\apollo-io\scripts\search_people.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        "--per-page", type=int, default=10, help="Results per page (max 100)"
    )
    ...
    try:
        ...
        print(
            f"Found {len(people)} people (page {pagination.get('page', 1)} of {pagination.get('total_pages', 1)}):\n"
        )
