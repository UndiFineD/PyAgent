...
class FitbitClient:
    ...
    def __init__(
        ...
        self.client_secret = client_secret or self._load_env_from_secrets(
            "FITBIT_CLIENT_SECRET"
        )
        self._access_token = access_token or self._load_env_from_secrets(
            "FITBIT_ACCESS_TOKEN"
        )
        self._refresh_token = refresh_token or self._load_env_from_secrets(
...
class FitbitAnalyzer:
    ...
    def __init__(
        self, steps_data=None, hr_data=None, sleep_data=None, activity_data=None
    ):
    ...
    def summary(self):
        ...
        avg_rhr = (
            sum([r for r in resting_hrs if r]) / len([r for r in resting_hrs if r])
            if resting_hrs
            else None
        )
