# Extracted from: C:\DEV\PyAgent\.external\skills\skills\bbdyno\email-summary\scripts\fetch_emails.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        "--count", type=int, default=10, help="Number of emails to fetch (default: 10)"
    )
    parser.add_argument("--all", action="store_true", help="Fetch all unread emails")
