...
def list_tasks(
    tasks: List[Dict[str, Any]], status: str | None, owner: str | None
) -> None:
    filtered = tasks
    if status:
...
def main() -> int:
    ...
    list_parser.add_argument(
        "--status", choices=["open", "in-progress", "done"], help="Filter by status."
    )
    ...
    complete_parser.add_argument(
        "id", type=int, help="Numeric ID of the task to complete."
    )
