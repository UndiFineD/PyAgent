# Extracted from: C:\DEV\PyAgent\.external\skills\skills\red777777\inkedin-automation-that-really-works\scripts\lib\like_monitor.py
#!/usr/bin/env python3
...
STATE_FILE = os.environ.get(
    "LINKEDIN_LIKES_STATE", os.path.expanduser("~/.linkedin-likes-state.json")
)
...
def scan_recent_likes(max_items=15):
    ...
    with browser_session() as (ctx, page):
        ...
        page.goto(
            f"https://www.linkedin.com/in/{slug}/recent-activity/reactions/",
            wait_until="domcontentloaded",
            timeout=30000,
        )
        time.sleep(5)
