# Extracted from: C:\DEV\PyAgent\.external\skills\skills\red777777\inkedin-automation-that-really-works\scripts\lib\browser.py
#!/usr/bin/env python3
...
VENV_PW = os.environ.get(
    "LINKEDIN_VENV_PACKAGES",
    os.path.expanduser("~/linkedin-venv/lib/python3.12/site-packages"),
)
...
PROFILE_DIR = os.environ.get(
    "LINKEDIN_BROWSER_PROFILE", os.path.expanduser("~/.linkedin-browser")
)
HEADLESS = True
...
def is_logged_in(page):
    ...
    page.goto(
        "https://www.linkedin.com/feed/", wait_until="domcontentloaded", timeout=30000
    )
    time.sleep(3)
    url = page.url
