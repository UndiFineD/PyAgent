# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dbhurley\excel\scripts\excel.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
        ...
        for col in range(start_col, end_col + 1):
            ...
            if (
                ...
                cell.font = Font(
                    ...
                    italic=(
                        args.italic if args.italic is not None else current_font.italic
                    ),
                    color=(
                        parse_color(args.font_color)
                        if args.font_color
            ...
            if args.align or args.valign or args.wrap:
                ...
                cell.alignment = Alignment(
                    ...
                    wrap_text=(
                        args.wrap if args.wrap is not None else current_align.wrap_text
                    ),
                )
...
def main():
    ...
    p.add_argument(
        "--format", "-f", choices=["json", "csv", "markdown"], default="json"
    )
