# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dbhurley\pptx-creator\scripts\use_template.py
#!/usr/bin/env python3
# /// script
...
def main():
    ...
    parser.add_argument(
        "--template", "-t", required=True, help="Template PPTX path or name"
    )
    parser.add_argument(
        "--slides", "-s", required=True, help="JSON file with slide definitions"
    )
