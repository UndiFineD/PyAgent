# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ajmwagar\find-stl\scripts\find_stl.py
#!/usr/bin/env python3
"""find-stl
...
def printables_search(
    query_text: str, limit: int = 10, offset: int = 0
) -> Dict[str, Any]:
    q = (
    ...
    return gql(q, {"q": query_text, "limit": int(limit), "offset": int(offset)})[
        "searchPrints2"
    ]
