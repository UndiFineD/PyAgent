# Extracted from: C:\DEV\PyAgent\.external\skills\skills\raulsimpetru\pdf-form-filler\pdf_form_filler\fill_pdf_form.py
#!/usr/bin/env python3
"""
                ...
                for annotation in page.Annots:
                    if annotation.Subtype == "/Widget" and annotation.T:
                        ...
                        if annotation.AS:  # Appearance state = checkbox/radio
                            field_type = (
                                "checkbox" if "Check" in str(annotation.T) else "radio"
                            )
...
def fill_pdf_form(
    ...
    if checkboxes is None:
        checkboxes = [
            name for name, ftype in list_pdf_fields(input_pdf) if ftype == "checkbox"
        ]
