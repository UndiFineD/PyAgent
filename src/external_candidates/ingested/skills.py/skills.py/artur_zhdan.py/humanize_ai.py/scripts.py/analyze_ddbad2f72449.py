# Extracted from: C:\DEV\PyAgent\.external\skills\skills\artur-zhdan\humanize-ai\scripts\analyze.py
#!/usr/bin/env python3
...
def print_report(results: dict):
    ...
    if results["curly_quotes"]:
        print(
            f"CURLY QUOTES: {results['curly_quotes']} (replace with straight quotes)\n"
        )
