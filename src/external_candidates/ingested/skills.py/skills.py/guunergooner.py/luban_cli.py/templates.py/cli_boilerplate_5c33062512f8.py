# Extracted from: C:\DEV\PyAgent\.external\skills\skills\guunergooner\luban-cli\templates\cli_boilerplate.py
import argparse
import sys
...
def main():
    ...
    print(
        f"Executing {args.command} {args.action if hasattr(args, 'action') else ''}..."
    )
