# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jdrhyne\gsc\scripts\gsc_auth.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    if not client_id or not client_secret:
        ...
        print(
            "Either pass --client-id and --client-secret, or set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET"
        )
        sys.exit(1)
