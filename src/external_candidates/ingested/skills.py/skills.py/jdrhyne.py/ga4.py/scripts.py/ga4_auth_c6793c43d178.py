# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jdrhyne\ga4\scripts\ga4_auth.py
#!/usr/bin/env python3
"""
...
def exchange_code(
    client_id, client_secret, code, redirect_uri="http://localhost:8080/"
):
...
def main():
    ...
    url_parser.add_argument(
        "--redirect-uri", default="http://localhost:8080/", help="Redirect URI"
    )
    ...
    if args.command == "url":
        ...
        print(
            "4. Run: ga4_auth.py exchange --client-id ... --client-secret ... --code ..."
        )
