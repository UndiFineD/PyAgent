...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "command",
        choices=["merge", "delete", "restore", "status"],
        help="Command to run",
    )
    ...
    if args.command == "status":
        ...
        upstream = [
            ...
            if v.get("source") == "upstream" and not v.get("deleted")
        ]
        ...
        updated_reg, stats = merge_registries(
            local_reg, upstream_reg, local_lib_path, upstream_lib_path
        )
