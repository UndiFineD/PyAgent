# Extracted from: C:\DEV\PyAgent\.external\skills\skills\robbyczgw-cla\proactive-research\scripts\manage_topics.py
#!/usr/bin/env python3
"""
...
from config import get_topic, load_config, save_config
from monitor import get_settings, load_state, monitor_topic, search_topic
...
def main():
    ...
    add_parser.add_argument(
        "--id", help="Custom topic ID (auto-generated if not provided)"
    )
    ...
    edit_parser.add_argument(
        "--alert-on", help="New alert conditions (comma-separated)"
    )
