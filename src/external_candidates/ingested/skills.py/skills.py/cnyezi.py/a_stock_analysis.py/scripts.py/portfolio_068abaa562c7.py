# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cnyezi\a-stock-analysis\scripts\portfolio.py
#!/usr/bin/env python3
# /// script
...
PORTFOLIO_FILE = (
    Path.home() / ".clawdbot" / "skills" / "a-stock-analysis" / "portfolio.json"
)
