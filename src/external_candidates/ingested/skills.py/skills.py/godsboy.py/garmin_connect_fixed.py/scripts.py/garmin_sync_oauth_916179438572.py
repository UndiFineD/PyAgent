# Extracted from: C:\DEV\PyAgent\.external\skills\skills\godsboy\garmin-connect-fixed\scripts\garmin-sync-oauth.py
#!/usr/bin/env python3
"""
        ...
        try:
            ...
            if sleep_data:
                data["sleep"] = {
                    ...
                    "deep_sleep": round(
                        sleep_data.get("deepSleepSeconds", 0) / 3600, 1
                    ),
                    "rem_sleep": round(sleep_data.get("remSleepSeconds", 0) / 3600, 1),
                    "light_sleep": round(
                        sleep_data.get("lightSleepSeconds", 0) / 3600, 1
                    ),
                }
            else:
