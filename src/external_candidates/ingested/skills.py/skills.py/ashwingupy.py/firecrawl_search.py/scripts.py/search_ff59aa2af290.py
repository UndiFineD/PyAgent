# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ashwingupy\firecrawl-search\scripts\search.py
#!/usr/bin/env python3
...
def search(query: str, limit: int = 10):
    ...
    data = json.dumps(
        {"query": query, "limit": limit, "lang": "en", "country": "us"}
    ).encode()
