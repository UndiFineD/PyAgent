# Extracted from: C:\DEV\PyAgent\.external\skills\skills\howieyoung\protico-agent-social-skill\examples\python\basic_interaction.py
"""
...
def get_community_feed(room_url: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        response = requests.get(
            f"{PROTICO_API_BASE}/live-community-feed/", params={"roomUrl": room_url}
        )
