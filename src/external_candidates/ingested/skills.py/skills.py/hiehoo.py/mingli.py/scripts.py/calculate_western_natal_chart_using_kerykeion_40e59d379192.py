# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hiehoo\mingli\scripts\calculate-western-natal-chart-using-kerykeion.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    result = calculate_natal_chart(
        args.date, args.time, args.tz, args.lat, args.lon, args.name
    )
