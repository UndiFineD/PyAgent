# Extracted from: C:\DEV\PyAgent\.external\skills\skills\spendit-ai\solana-skills\scripts\initialize.py
#!/usr/bin/env python3
"""
    ...
    if env_path.exists():
        with open(env_path, "r") as f:
            ...
            if "SOLANA_PRIVATE_KEY=" in content:
                ...
                response = input(
                    "Do you want to create a new wallet? This will overwrite the existing key. (y/N): "
                )
                if response.lower() != "y":
                    print("Aborted.")
                    sys.exit(0)
