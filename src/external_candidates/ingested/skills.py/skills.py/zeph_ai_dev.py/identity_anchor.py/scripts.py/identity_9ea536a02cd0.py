...
try:
    ...
    print(
        "Error: cryptography library required. Install with: pip3 install cryptography"
    )
    sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(
        description="Identity Anchor - Cryptographic identity for AI agents"
    )
    parser.add_argument(
        "command",
    ...
    parser.add_argument(
        "--files", type=str, help="Comma-separated list of files to hash"
    )
