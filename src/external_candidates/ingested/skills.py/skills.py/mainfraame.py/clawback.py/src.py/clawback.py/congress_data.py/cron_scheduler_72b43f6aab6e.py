# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\clawback\src\clawback\congress_data\cron_scheduler.py
"""
...
class CongressCronScheduler:
    ...
    def run_collection_job(self):
        ...
        try:
            ...
            logger.info(
                f"Collected {len(trades)} trades, sent {len(alerts_sent)} alerts"
            )
    ...
    def cleanup_old_data(self):
        ...
        try:
            ...
            logger.info(
                f"Cleaned up {files_deleted} old data files (older than {max_days} days)"
            )
