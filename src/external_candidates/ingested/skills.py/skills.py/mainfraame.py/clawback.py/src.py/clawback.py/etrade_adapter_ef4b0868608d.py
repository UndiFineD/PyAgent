# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\clawback\src\clawback\etrade_adapter.py
"""
...
class ETradeAdapter(BrokerAdapter):
    ...
    def get_account_balance(
        ...
        try:
            ...
            self._notify_error(
                "Get Account Balance", str(e), {"account_id": account_id}
            )
            return None
