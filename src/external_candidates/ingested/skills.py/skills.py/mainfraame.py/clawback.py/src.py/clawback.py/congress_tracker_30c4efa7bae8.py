# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\clawback\src\clawback\congress_tracker.py
"""
...
class CongressTracker:
    ...
    def __init__(self, config):
        ...
        self.target_politicians = congress_config.get(
            ...
            for table in tables:
                ...
                for i, h in enumerate(headers):
                    if "asset" in h or "description" in h:
                        col_map["asset"] = i
                    elif ("type" in h and "transaction" not in h) or (
                        "transaction" in h and "type" in h
                    ):
                        col_map["tx_type"] = i
