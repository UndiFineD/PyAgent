# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\test_telegram_setup.py
#!/usr/bin/env python3
"""
...
def test_telegram():
    ...
    if not notifier.enabled:
        ...
        print(
            "Please enable it in config/config.json and add your bot token and chat ID"
        )
        return False
    ...
    if notifier.send_error_alert(
        "Connection Error", "Failed to connect to E*TRADE API", "During authentication"
    ):
