# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\add_trade.py
#!/usr/bin/env python3
...
def list_trades():
    ...
    for t in trades[:10]:
        print(
            f"{t['transaction_date']} | {t['ticker']:6} | {t['transaction_type']:8} | {t['amount_range']}"
        )
