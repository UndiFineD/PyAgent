...
class TestTradeEngine:
    ...
    def test_calculate_scaled_trade_quantity(
        self, trade_engine, sample_congressional_trade
    ):
    ...
    def test_calculate_scaled_trade_uses_current_price(
        self, trade_engine, sample_congressional_trade
    ):
...
class TestTradeEngineIntegration:
    ...
    def test_full_trade_flow(
        self, mock_broker, sample_config, sample_congressional_trade
    ):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            can_trade = engine.check_position_limits(
                scaled["symbol"], scaled["quantity"], scaled["action"], 50000
            )
            assert can_trade is True
