# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\tests\test_database.py
"""
...
import pytest
from database import SEED_DATA_PATH, TradingDatabase, get_database
...
class TestTradingDatabase:
    ...
    def test_add_congressional_trade(self, temp_db_path, sample_congressional_trade):
        ...
        # Find our trade
        our_trade = next((t for t in trades if t["ticker"] == "NVDA"), None)
