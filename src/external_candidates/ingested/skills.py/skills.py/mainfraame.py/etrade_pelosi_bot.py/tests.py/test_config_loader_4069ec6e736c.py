# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\tests\test_config_loader.py
"""
...
class TestEnvVarSubstitution:
    ...
    def test_substitute_in_dict(self):
        ...
        with patch.dict(os.environ, {"API_KEY": "secret123"}):
            config = {"key": "${API_KEY}", "static": "unchanged"}
...
class TestLoadSecrets:
    ...
    def test_load_secrets_from_file(self):
        ...
        secrets = {"API_KEY": "secret_key", "API_SECRET": "secret_secret"}
...
class TestLoadConfig:
    ...
    def test_load_config_with_env_substitution(self):
        ...
        try:
            with patch.dict(
                os.environ,
                {"TEST_API_KEY": "loaded_key", "TEST_API_SECRET": "loaded_secret"},
            ):
                loaded = load_config(config_path)
    ...
    def test_load_config_removes_comments(self):
        ...
        config = {
            ...
            "broker": {"_note": "Another comment", "adapter": "etrade"},
        }
