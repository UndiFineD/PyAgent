# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\test_system.py
#!/usr/bin/env python3
"""
...
def test_config():
    ...
    try:
        ...
        print(
            f"   Strategy: {config['strategy'].get('entryDelayDays', 0)}-day delay, {config['strategy'].get('holdingPeriodDays', 0)}-day hold"
        )
        return True
