# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\src\congress_data\main.py
"""
...
class CongressDataApp:
    ...
    def show_stats(self):
        ...
        try:
            ...
            print(
                f"    - E*TRADE Integration: {'✅' if alert_stats['channels']['etrade_integration'] else '❌'}"
            )
