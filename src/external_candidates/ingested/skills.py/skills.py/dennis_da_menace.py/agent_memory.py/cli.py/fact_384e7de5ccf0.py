# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dennis-da-menace\agent-memory\cli\fact.py
#!/usr/bin/env python3
...
def main():
    ...
    add_p.add_argument(
        "--confidence", "-c", type=float, default=0.9, help="Confidence 0-1"
    )
    ...
    forget_p.add_argument(
        "--days", "-d", type=int, default=30, help="Forget facts older than N days"
    )
