# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dennis-da-menace\agent-memory\examples\basic_usage.py
"""
...
mem.remember("Weekly standup is every Monday at 9am EST", tags=["schedule", "meeting"])
