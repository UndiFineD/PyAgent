# Extracted from: C:\DEV\PyAgent\.external\skills\skills\spliff7777\windows-control\scripts\find_text.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
            ...
            for ctrl in window.descendants():
                try:
                    ...
                    if text and search_text.lower() in text.lower():
                        ...
                        print(
                            f"Bounds: left={rect.left}, top={rect.top}, right={rect.right}, bottom={rect.bottom}"
                        )
                        sys.exit(0)
                except:
                    pass
