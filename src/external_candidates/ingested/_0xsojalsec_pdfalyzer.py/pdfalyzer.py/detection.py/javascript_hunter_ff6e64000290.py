# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\detection\javascript_hunter.py
"""
...
from pdfalyzer.detection.constants.javascript_reserved_keywords import (
    JAVASCRIPT_RESERVED_KEYWORDS,
)
from pdfalyzer.helpers.string_helper import count_regex_matches_in_text

JS_KEYWORDS_3_OR_MORE_LETTERS = [
    kw for kw in JAVASCRIPT_RESERVED_KEYWORDS if len(kw) > 2
]
