# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\helpers\string_helper.py
"""
...
# Pretty Printer
pp = PrettyPrinter(indent=INDENT_DEPTH, width=PRETTY_PRINT_WIDTH, sort_dicts=True)
