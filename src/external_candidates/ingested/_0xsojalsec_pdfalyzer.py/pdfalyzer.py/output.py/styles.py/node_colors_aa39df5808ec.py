# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\output\styles\node_colors.py
"""
...
def get_label_style(label: str) -> str:
    ...
    return next(
        (ls[1] for ls in LABEL_STYLES if ls[0].search(label)), DEFAULT_LABEL_STYLE
    )
