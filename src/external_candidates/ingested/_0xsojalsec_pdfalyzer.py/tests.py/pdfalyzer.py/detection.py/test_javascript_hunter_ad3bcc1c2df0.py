# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\tests\pdfalyzer\detection\test_javascript_hunter.py
...
def test_js_keyword_matches():
    assert JavascriptHunter.js_keyword_matches(TEST_STRING) == [
        "export",
        "for",
        "final",
    ]
