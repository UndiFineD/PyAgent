# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\tests\pdfalyzer\binary\test_binary_scanner.py
import pytest
...
def test_quote_extraction_methods(font_info):
    _check_matches(
        font_info.binary_scanner.extract_backtick_quoted_bytes, 163, 52840, 2, 7_000
    )
...
def test_front_slash_quoted_bytes_extraction(font_info):
    _check_matches(
        font_info.binary_scanner.extract_front_slash_quoted_bytes,
        756,
        167814,
        2,
        62_000,
