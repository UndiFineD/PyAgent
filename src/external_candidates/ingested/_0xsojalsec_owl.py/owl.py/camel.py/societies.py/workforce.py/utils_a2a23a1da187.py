# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\societies\workforce\utils.py
...
class WorkerConf(BaseModel):
    ...
    sys_msg: str = Field(
        description="The system message that will be sent to the agent in " "the node."
    )
