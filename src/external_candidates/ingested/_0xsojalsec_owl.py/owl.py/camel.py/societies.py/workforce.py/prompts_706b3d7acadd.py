# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\societies\workforce\prompts.py
...
ASSIGN_TASK_PROMPT = TextPrompt("""You need to assign the task to a worker node.
...
PROCESS_TASK_PROMPT = TextPrompt("""You need to process one given task.
