# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\deepseek_model.py
...
class DeepSeekModel(BaseModelBackend):
    ...
    @retry(
        (ValueError, TypeError, json.decoder.JSONDecodeError), delay=10, logger=logger
    )
    def run(
        self,
