# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\sympy_toolkit.py
...
class SymPyToolkit(BaseToolkit):
    ...
    def solve_equation(
        ...
        try:
            variable = (
                sp.symbols(variable) if variable else sp.symbols(self.default_variable)
            )
