# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\agents\chat_agent.py
...
class ChatAgent(BaseAgent):
    ...
    def _step_tool_call_and_update(
        ...
        func_assistant_msg, func_result_msg, tool_call_record = self.step_tool_call(
            response
        )
