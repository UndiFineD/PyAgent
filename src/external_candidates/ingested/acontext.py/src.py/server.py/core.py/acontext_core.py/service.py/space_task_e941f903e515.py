# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\service\space_task.py
from ..env import LOG
from ..infra.async_mq import MQ_CLIENT, ConsumerConfigData, Message, register_consumer
