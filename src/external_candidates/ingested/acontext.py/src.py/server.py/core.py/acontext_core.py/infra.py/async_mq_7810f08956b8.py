# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\infra\async_mq.py
...
from ..env import DEFAULT_CORE_CONFIG, LOG, bound_logging_vars
