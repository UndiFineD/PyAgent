...
class BlocksAPI:
    ...
    def list(
        ...
        *,
        ...
        data = self._requester.request(
            "GET", f"/space/{space_id}/block", params=params or None
        )
    ...
    def create(
        ...
        *,
        ...
        if props is not None:
            payload["props"] = props
        data = self._requester.request(
            "POST", f"/space/{space_id}/block", json_data=payload
        )
    ...
    def get_properties(self, space_id: str, block_id: str) -> Block:
        ...
        """
        data = self._requester.request(
            "GET", f"/space/{space_id}/block/{block_id}/properties"
        )
    ...
    def update_properties(
        ...
        *,
        ...
        self._requester.request(
            "PUT", f"/space/{space_id}/block/{block_id}/properties", json_data=payload
        )
    ...
    def move(
        ...
        *,
        ...
        self._requester.request(
            "PUT", f"/space/{space_id}/block/{block_id}/move", json_data=payload
        )
