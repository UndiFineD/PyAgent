# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\client\acontext-py\src\acontext\types\block.py
...
class Block(BaseModel):
    ...
    type: str = Field(
        ..., description="Block type: 'page', 'folder', 'text', 'sop', etc."
    )
    ...
    children: list["Block"] | None = Field(
        None, description="List of child blocks, optional"
    )
