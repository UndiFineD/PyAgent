# Extracted from: C:\DEV\PyAgent\.external\agentcloud\agent-backend\src\lang_models\cohere.py
from typing import AsyncIterator, Dict

import cohere
import httpx
from cohere import AsyncClient, Client, ClientEnvironment, StreamedChatResponse
...
class CustomAsyncClient(AsyncClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.base_url = _get_base_url(
            base_url=kwargs["base_url"], environment=self.environment
        )
    ...
    async def chat_stream(self, *args, **kwargs) -> AsyncIterator[StreamedChatResponse]:
        ...
        self._client_wrapper = AsyncClientWrapper(
            ...
            httpx_client=httpx.AsyncClient(
                ...
                follow_redirects=(
                    self.follow_redirects if self.follow_redirects else False
                ),
            ),
            timeout=_defaulted_timeout,
        )
