# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infinity\dataset\webdataset.py
import io
...
def WDSEditDataset(
    ...
    dataset = (
        ...
        .with_length(overall_length)
        .shuffle(100)
        .to_tuple("src.jpg", "tgt.jpg", "txt")
        .map(preprocess)
