# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infinity\utils\load.py
#!/usr/bin/python3
import gc
import os
...
def build_vae_gpt(
    args: arg_util.Args, vae_st: dict, skip_gpt: bool, force_flash=False, device="cuda"
):
    ...
    gpt_kw = dict(
        ...
        drop_rate=args.drop,
        cross_attn_layer_scale=args.ca_gamma,
        nm0=args.nm0,
        tau=args.tau,
        cos_attn=args.cos,
        swiglu=args.swi,
        ...
        top_p=args.tp,
        top_k=args.tk,
        customized_flash_attn=args.flash,
        fused_mlp=args.fuse,
    ...
    if args.dp >= 0:
        gpt_kw["drop_path_rate"] = args.dp
    if args.hd > 0:
        gpt_kw["num_heads"] = args.hd
