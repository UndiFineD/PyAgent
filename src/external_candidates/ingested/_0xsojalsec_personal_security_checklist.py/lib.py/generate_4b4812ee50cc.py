# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-personal-security-checklist\lib\generate.py
import logging
import os
...
def generate_markdown_section(section):
    ...
    if "softwareLinks" in section:
        software_links = [
            software
            for software in section["softwareLinks"]
            if "title" in software and "url" in software
        ]
        if software_links:
