# Extracted from: C:\DEV\PyAgent\.external\cache\work\copilot_tmp\chunk_0_encryption.py
# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ics-forensics-tools\src\forensic\plugins\CodeSysV3\codesysv3_protocol\encryption.py
...
class CodeSysV3Encryption:
    ...
    def hash_password(challenge: int, password: str):
        ...
        while loop_index < full_password_len:
            ...
            current_crypto_hash_char = CodeSysV3Encryption.ENC_ARRAY[
                crypto_password_char_index
            ]
            ...
            challenge_char = (
                challenge_array[loop_index % 4] + current_crypto_hash_char
            ) & 0xFF
