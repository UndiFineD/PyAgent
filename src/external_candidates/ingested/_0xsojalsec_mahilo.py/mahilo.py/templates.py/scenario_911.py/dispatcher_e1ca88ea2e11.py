# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\mahilo\templates\scenario_911\dispatcher.py
...
EMERGENCY_DISPATCHER_SHORT_DESCRIPTION = (
    "This is a dispatcher agent that has a direct line to the distressed user."
)
