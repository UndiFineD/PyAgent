# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\mahilo\templates\scenario_911\medic.py
...
MEDICAL_PROXY_SHORT_DESCRIPTION = (
    "This is a proxy agent that communicates with real medical professionals."
)
