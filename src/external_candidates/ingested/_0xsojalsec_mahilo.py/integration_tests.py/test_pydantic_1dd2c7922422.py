# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\integration_tests\test_pydantic.py
...
mahilo_pydantic_agent.activate(
    dependencies=SupportDependencies(customer_id=123, db=DatabaseConn())
)
