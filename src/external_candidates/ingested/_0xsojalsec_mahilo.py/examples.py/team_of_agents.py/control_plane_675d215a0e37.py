# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\team_of_agents\control_plane.py
import os

from langgraph_marketing_agent import graph_builder
from mahilo import AgentManager, BaseAgent, ServerManager
...
def main():
    ...
    prod_agent.activate(
        dependencies=ProductDependencies(product_name="Mahilo", db=DatabaseConn())
    )
