# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\real_estate_management\buyer_agent.py
from typing import List

from mahilo import BaseAgent

from tools import get_available_dates, search_properties
...
class BuyerAgent(BaseAgent):
    def __init__(
        self, buyer_preferences: str, name: str = None, can_contact: List[str] = []
    ):
        super().__init__(
            name=name,
            type="buyer_agent",
