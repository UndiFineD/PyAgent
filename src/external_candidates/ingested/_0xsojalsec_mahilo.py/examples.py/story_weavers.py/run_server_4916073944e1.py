# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\story_weavers\run_server.py
import argparse
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run story weaver server with specified agents"
    )
    parser.add_argument(
        "agent_names",
        nargs="*",
        default=["jayesh", "arunjoy", "ritvi"],
