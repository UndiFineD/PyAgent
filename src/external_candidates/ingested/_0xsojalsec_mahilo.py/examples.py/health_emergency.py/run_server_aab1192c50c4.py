# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\health_emergency\run_server.py
...
from mahilo.templates.peer2peer.public_communications_director import (
    PublicCommunicationsDirector,
)
