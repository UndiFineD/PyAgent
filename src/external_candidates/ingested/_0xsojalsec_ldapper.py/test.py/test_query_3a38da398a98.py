...
class TestQ:
    ...
    def test_complex_conditions(self):
        ...
        assert (
            qset.compile(Person) == "(&(|(givenName=Alice)(givenName=Bob))(uid=liam))"
        )

    def test_complex_conditions2(self):
        qset = (Q(firstname="Alice") | Q(firstname="Bob")) & (
            Q(uid="liam") | Q(uid="derek")
        )
        assert (
            qset.compile(Person)
            == "(&(|(givenName=Alice)(givenName=Bob))(|(uid=liam)(uid=derek)))"
        )
    ...
    def test_complex_conditions3(self):
        ...
        assert (
            qset.compile(Person)
            == "(&(sn=Lennon)(sn=McCartney)(sn=Harrison)(sn=Starr))"
        )
    ...
    def test_complex_conditions4(self):
        qset = (Q(lastname="Lennon") & Q(lastname="McCartney")) & Q(
            firstname="Ringo", lastname="Starr"
        )
        assert (
            qset.compile(Person)
            == "(&(sn=Lennon)(sn=McCartney)(givenName=Ringo)(sn=Starr))"
        )
    ...
    def test_deeply_nested(self):
        qset = Q(firstname="Liam") & (
            Q(lastname="Smith") | (Q(uid="liam") & Q(lastname="Monahan"))
        )
        assert (
            qset.compile(Person)
