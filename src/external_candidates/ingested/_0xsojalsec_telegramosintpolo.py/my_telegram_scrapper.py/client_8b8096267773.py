...
class SimpleScraperClient:
    ...
    def get_channel_page(
        self, channel_username: str, before_token: Optional[str] = None
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Error: Received unexpected status code {response.status_code} for {url}"
                )
                return None
            ...
            print(
                f"An unexpected error occurred processing channel '{channel_username}': {e}"
            )
            return None
