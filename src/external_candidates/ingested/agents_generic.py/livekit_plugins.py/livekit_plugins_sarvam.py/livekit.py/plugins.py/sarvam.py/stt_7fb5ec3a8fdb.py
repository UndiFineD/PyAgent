# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-sarvam\livekit\plugins\sarvam\stt.py
                ...
                if start_time == 0.0 and end_time == 0.0:
                    ...
                    try:
                        if isinstance(buffer, list):
                            ...
                            total_samples = sum(
                                frame.samples_per_channel for frame in buffer
                            )
