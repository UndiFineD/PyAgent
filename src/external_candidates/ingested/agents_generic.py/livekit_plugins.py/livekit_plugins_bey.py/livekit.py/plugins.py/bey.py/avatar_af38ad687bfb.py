# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-bey\livekit\plugins\bey\avatar.py
        ...
        for i in range(self._conn_options.max_retry):
            try:
                ...
                if isinstance(e, APIConnectionError):
                    logger.warning(
                        "failed to call bey presence api", extra={"error": str(e)}
                    )
                else:
