# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-cartesia\livekit\plugins\cartesia\stt.py
    ...
    def _process_stream_event(self, data: dict) -> None:
        ...
        if message_type == "transcript":
            ...
            speech_data = stt.SpeechData(
                ...
                end_time=data.get(
                    "duration", 0
                ),  # This is the duration transcribed so far
            ...
            logger.debug(
                "Received done acknowledgment from Cartesia STT - session closing"
            )
