...
class LLMStream(llm.LLMStream):
    ...
    async def _run(self) -> None:
        ...
        try:
            ...
            async_response = await self._client.chat.stream_async(
                messages=cast(
                    list[ChatCompletionStreamRequestMessagesTypedDict], messages
                ),
    ...
    def _parse_choice(
        self, id: str, choice: CompletionResponseStreamChoice
    ) -> ChatChunk | None:
        ...
        if choice.delta.content and isinstance(choice.delta.content, str):
            ...
            chunk.delta = llm.ChoiceDelta(
                content=choice.delta.content, role="assistant"
            )
