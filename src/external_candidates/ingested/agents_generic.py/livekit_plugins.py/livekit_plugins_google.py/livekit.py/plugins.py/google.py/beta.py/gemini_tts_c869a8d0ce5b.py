# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-google\livekit\plugins\google\beta\gemini_tts.py
    ...
    def __init__(
        ...
        *,
        ...
        self._opts = _TTSOptions(
            ...
            instructions=(
                instructions if is_given(instructions) else DEFAULT_INSTRUCTIONS
            ),
        )
