# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-rime\livekit\plugins\rime\tts.py
...
class TTS(tts.TTS):
    def __init__(
        ...
        *,
        ...
        self._total_timeout = (
            ARCANA_MODEL_TIMEOUT if model == "arcana" else MISTV2_MODEL_TIMEOUT
        )
    ...
    async def _run(self, output_emitter: tts.AudioEmitter) -> None:
        ...
        if self._opts.model == "arcana":
            ...
            if is_given(mistv2_opts.phonemize_between_brackets):
                payload["phonemizeBetweenBrackets"] = (
                    mistv2_opts.phonemize_between_brackets
                )
