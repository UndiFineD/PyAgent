# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-aws\livekit\plugins\aws\llm.py
    ...
    def __init__(
        ...
        *,
        ...
        bedrock_model = (
            model
            if is_given(model)
            else os.environ.get("BEDROCK_INFERENCE_PROFILE_ARN")
        )
