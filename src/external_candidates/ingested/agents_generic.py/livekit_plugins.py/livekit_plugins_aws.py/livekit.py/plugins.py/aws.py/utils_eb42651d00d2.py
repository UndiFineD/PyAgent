# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-aws\livekit\plugins\aws\utils.py
            ...
            "toolSpec": _strip_nones(
                {
                    ...
                    "inputSchema": {
                        "json": fnc["parameters"] if fnc["parameters"] else {}
                    },
                }
            )
        }
