# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-turn-detector\livekit\plugins\turn_detector\multilingual.py
    ...
    async def unlikely_threshold(self, language: str | None) -> float | None:
        ...
        if threshold is None:
            try:
                ...
                logger.warning(
                    "Error fetching threshold for language %s", language, exc_info=e
                )
    ...
    async def predict_end_of_turn(
        ...
        *,
        ...
        request = messages.to_dict(
            exclude_image=True, exclude_audio=True, exclude_timestamp=True
        )
