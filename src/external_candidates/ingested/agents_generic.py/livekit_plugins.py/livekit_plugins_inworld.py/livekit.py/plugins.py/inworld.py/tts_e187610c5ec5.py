# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-inworld\livekit\plugins\inworld\tts.py
    ...
    def __init__(
        ...
        *,
        ...
        self._opts = _TTSOptions(
            ...
            sample_rate=(
                sample_rate if utils.is_given(sample_rate) else DEFAULT_SAMPLE_RATE
            ),
            pitch=pitch,
