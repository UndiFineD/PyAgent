# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-simli\livekit\plugins\simli\avatar.py
    ...
    async def start(
        ...
        *,
        ...
        simli_session_token = await self._ensure_http_session().post(
            f"{self.api_url}/startAudioToVideoSession",
        ...
        (
            await self._ensure_http_session().post(
                ...
                json={
                    "session_token": (await simli_session_token.json())[
                        "session_token"
                    ],
