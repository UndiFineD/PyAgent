# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-speechify\livekit\plugins\speechify\tts.py
...
class TTS(tts.TTS):
    def __init__(
        ...
        *,
        ...
        speechify_token = (
            api_key if is_given(api_key) else os.environ.get("SPEECHIFY_API_KEY")
        )
        ...
        data = {
            ...
            "options": {
                "loudness_normalization": (
                    self._opts.loudness_normalization
        ...
        try:
            async with self._tts._ensure_session().post(
                ...
                timeout=aiohttp.ClientTimeout(
                    connect=self._conn_options.timeout, total=30
                ),
            ) as resp:
                ...
                if not resp.content_type.startswith("audio/"):
                    ...
                    raise APIError(
                        message="Speechify returned non-audio data", body=content
                    )
