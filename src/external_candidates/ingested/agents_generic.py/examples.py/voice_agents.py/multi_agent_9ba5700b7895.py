# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\multi_agent.py
import logging
...
class StoryAgent(Agent):
    def __init__(
        self, name: str, location: str, *, chat_ctx: Optional[ChatContext] = None
    ) -> None:
        super().__init__(
