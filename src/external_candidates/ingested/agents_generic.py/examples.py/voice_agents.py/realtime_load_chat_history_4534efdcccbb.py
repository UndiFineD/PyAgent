# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\realtime_load_chat_history.py
import logging
...
async def entrypoint(ctx: JobContext):
    ...
    agent = Agent(
        ...
        llm=openai.realtime.RealtimeModel(
            voice="alloy", model="gpt-4o-mini-realtime-preview"
        ),
