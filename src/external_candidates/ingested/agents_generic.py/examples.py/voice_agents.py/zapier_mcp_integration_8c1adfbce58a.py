# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\zapier_mcp_integration.py
import logging
import os
...
async def entrypoint(ctx: JobContext):
    ...
    if zapier_mcp_server:
        ...
        logger.warning(
            "ZAPIER_MCP_SERVER environment variable not set. MCP integration disabled."
        )
