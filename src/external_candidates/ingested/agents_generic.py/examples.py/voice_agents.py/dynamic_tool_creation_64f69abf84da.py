# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\dynamic_tool_creation.py
import logging
import random
...
async def entrypoint(ctx: JobContext):
    ...
    await agent.update_tools(
        ...
        + [
            function_tool(
                _random_number, name="random_number", description="Get a random number"
            )
        ]
    )
