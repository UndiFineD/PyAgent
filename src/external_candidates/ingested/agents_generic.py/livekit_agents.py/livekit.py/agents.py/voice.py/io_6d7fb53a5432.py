# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\voice\io.py
...
LLMNode = Callable[
    [
        llm.ChatContext,
        list[Union[llm.FunctionTool, llm.RawFunctionTool]],
        ModelSettings,
    ],
    Union[
        ...
        Awaitable[
            Optional[
                Union[AsyncIterable[Union[llm.ChatChunk, str]], str, llm.ChatChunk]
            ]
        ],
    ],
]
