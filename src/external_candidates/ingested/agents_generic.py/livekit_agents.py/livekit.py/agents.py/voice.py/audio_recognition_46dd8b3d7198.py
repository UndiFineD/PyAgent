# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\voice\audio_recognition.py
...
class AudioRecognition:
    ...
    def commit_user_turn(
        self, *, audio_detached: bool, transcript_timeout: float
    ) -> None:
                    ...
                    with (
                        ...
                        try:
                            end_of_turn_probability = (
                                await turn_detector.predict_end_of_turn(chat_ctx)
                            )
                        ...
                        eou_detection_span.set_attributes(
                            {
                                ...
                                trace_types.ATTR_EOU_UNLIKELY_THRESHOLD: unlikely_threshold
                                or 0,
                                trace_types.ATTR_EOU_DELAY: endpointing_delay,
                                trace_types.ATTR_EOU_LANGUAGE: self._last_language
                                or "",
                            }
                        )
