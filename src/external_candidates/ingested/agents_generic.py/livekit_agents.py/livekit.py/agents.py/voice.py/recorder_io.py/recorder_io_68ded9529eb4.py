            ...
            while True:
                ...
                if len_left != len_right:
                    ...
                    if len_left < len_right:
                        ...
                        stereo_buf[1, diff : diff + len_right] = stereo_buf[
                            1, :len_right
                        ]
...
class RecorderAudioOutput(io.AudioOutput):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            label="RecorderIO", next_in_chain=audio_output, sample_rate=None
        )
        self.__recording_io = recording_io
        ...
        *,
        ...
        for frame in self.__acc_frames:
            if frame.duration + acc_dur > playback_position:
                ...
                samples_needed = (
                    int(duration_needed * frame.sample_rate) * frame.num_channels
                )
