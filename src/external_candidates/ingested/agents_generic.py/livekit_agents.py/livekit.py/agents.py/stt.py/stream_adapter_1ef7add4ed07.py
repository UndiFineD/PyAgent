# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\stt\stream_adapter.py
...
class StreamAdapterWrapper(RecognizeStream):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            stt=stt, conn_options=DEFAULT_STREAM_ADAPTER_API_CONNECT_OPTIONS
        )
        self._vad = vad
