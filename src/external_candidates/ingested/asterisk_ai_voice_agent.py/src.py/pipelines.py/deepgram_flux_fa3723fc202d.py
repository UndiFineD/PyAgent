# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\src\pipelines\deepgram_flux.py
"""
...
class DeepgramFluxSTTAdapter(STTComponent):
    ...
    def _compose_options(
        ...
        merged = {
            "base_url": runtime_options.get(
                ...
                self._pipeline_defaults.get(
                    "base_url", self._provider_defaults.base_url
                ),
            ),
            "language": runtime_options.get(
                "language",
                self._pipeline_defaults.get(
                    "language", self._provider_defaults.stt_language
                ),
            ),
        ...
        if "eager_eot_threshold" in runtime_options:
            ...
            merged["eager_eot_threshold"] = self._pipeline_defaults[
                "eager_eot_threshold"
            ]
