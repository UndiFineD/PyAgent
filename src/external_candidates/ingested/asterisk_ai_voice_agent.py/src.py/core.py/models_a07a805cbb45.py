...
class CallSession:
    ...
    context_name: Optional[str] = (
        None  # AI_CONTEXT from dialplan (for pipeline greeting/prompt resolution)
    )
    ...
    transport_profile: Optional[Any] = (
        None  # OrchestratorTransportProfile from transport_orchestrator.py
    )
    ...
    transfer_context: Optional[Dict[str, Any]] = (
        None  # Context to pass to transfer target
    )
