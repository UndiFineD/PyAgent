# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\tools\telephony\test_cancel_transfer_tool.py
"""
...
class TestCancelTransferTool:
    ...
    async def test_cancel_with_different_action_type(
        ...
        sample_call_session.current_action = {"type": "hangup", "status": "pending"}
    ...
    async def test_cancel_multiple_times(
        ...
        result2 = await cancel_tool.execute(parameters={}, context=tool_context)
