...
def launch_training_task(
    ...
    dataloader = torch.utils.data.DataLoader(
        dataset, shuffle=True, num_workers=1, collate_fn=lambda x: x[0]
    )
...
def launch_data_process_task(
    ...
    dataloader = torch.utils.data.DataLoader(
        dataset, shuffle=False, num_workers=1, collate_fn=lambda x: x[0]
    )
    accelerator = Accelerator()
...
def wan_parser():
    ...
    parser.add_argument(
        "--use_shot_embedding", type=bool, default=False, help="Use shot embedding."
    )
    parser.add_argument(
        "--shot_embedding_init",
        type=str,
    ...
    parser.add_argument(
        "--mixed_precision", type=str, default="bf16", help="Mixed precision."
    )
