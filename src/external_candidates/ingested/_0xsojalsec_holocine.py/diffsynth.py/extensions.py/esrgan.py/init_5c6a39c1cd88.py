# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\extensions\ESRGAN\__init__.py
import numpy as np
import torch
...
class RRDBNet(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.body = torch.torch.nn.Sequential(
            *[
...
class ESRGAN(torch.nn.Module):
    ...
    def decode_images(self, images):
        images = (
            (images.permute(0, 2, 3, 1) * 255).clip(0, 255).numpy().astype(np.uint8)
        )
