# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\extensions\ImageQualityMetric\open_clip\factory.py
import json
import logging
import os
import pathlib
...
def get_tokenizer(model_name, open_clip_bpe_path=None):
    if model_name.startswith(HF_HUB_PREFIX):
        ...
        tokenizer = (
            ...
            else SimpleTokenizer(open_clip_bpe_path)
        )
    return tokenizer
