# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\extensions\ImageQualityMetric\trainer\models\clip_model.py
import json
import os
...
class ClipModelConfig(BaseModelConfig):
    _target_: str = (
        "diffsynth.extensions.QualityMetric.trainer.models.clip_model.CLIPModel"
    )
