...
class CogVideoPipeline(BasePipeline):
    ...
    def __init__(self, device="cuda", torch_dtype=torch.float16):
        ...
        self.scheduler = EnhancedDDIMScheduler(
            rescale_zero_terminal_snr=True, prediction_type="v_prediction"
        )
    ...
    def __call__(
        ...
        if denoising_strength == 1.0:
            ...
            latents = self.vae_encoder.encode_video(
                input_video, **tiler_kwargs, progress_bar=progress_bar_cmd
        ...
        # Decode image
        video = self.vae_decoder.decode_video(
            latents.to("cpu"), **tiler_kwargs, progress_bar=progress_bar_cmd
        )
