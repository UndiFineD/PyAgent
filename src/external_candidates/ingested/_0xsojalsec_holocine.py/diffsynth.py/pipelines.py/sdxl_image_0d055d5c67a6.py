# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\pipelines\sdxl_image.py
...
from ..prompters import KolorsPrompter, SDXLPrompter
...
class SDXLImagePipeline(BasePipeline):
    ...
    def fetch_models(
        ...
        if self.text_encoder_kolors is not None:
            ...
            self.scheduler = EnhancedDDIMScheduler(
                beta_end=0.014, num_train_timesteps=1100
            )
        else:
    ...
    def prepare_extra_input(self, latents=None):
        ...
        add_time_id = torch.tensor(
            [height, width, 0, 0, height, width], device=self.device
    ...
    def __call__(
        ...
        self.load_models_to_device(
            ["text_encoder", "text_encoder_2", "text_encoder_kolors"]
        )
