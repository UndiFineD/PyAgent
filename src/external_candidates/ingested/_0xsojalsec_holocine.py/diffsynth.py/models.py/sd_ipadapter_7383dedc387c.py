# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\models\sd_ipadapter.py
import torch
from transformers import CLIPImageProcessor

from .sdxl_ipadapter import (
    IpAdapterImageProjModel,
    IpAdapterModule,
...
class SDIpAdapter(torch.nn.Module):
    def __init__(self):
        ...
        self.ipadapter_modules = torch.nn.ModuleList(
            [IpAdapterModule(*shape) for shape in shape_list]
        )
