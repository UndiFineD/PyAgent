# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\models\sd3_vae_decoder.py
import torch

from .sd_unet import ResnetBlock, UpSampler
from .sd_vae_decoder import SDVAEDecoderStateDictConverter, VAEAttentionBlock
...
class SD3VAEDecoder(torch.nn.Module):
    def __init__(self):
        ...
        self.conv_in = torch.nn.Conv2d(
            16, 512, kernel_size=3, padding=1
        )  # Different from SD 1.x
        ...
        self.conv_norm_out = torch.nn.GroupNorm(
            num_channels=128, num_groups=32, eps=1e-6
        )
