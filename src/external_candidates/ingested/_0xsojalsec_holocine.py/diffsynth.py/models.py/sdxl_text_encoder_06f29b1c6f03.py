# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\models\sdxl_text_encoder.py
import torch
...
class SDXLTextEncoder2(torch.nn.Module):
    ...
    def forward(self, input_ids, clip_skip=2):
        ...
        pooled_embeds = embeds[
            torch.arange(embeds.shape[0]), input_ids.to(dtype=torch.int).argmax(dim=-1)
        ]
    ...
    def from_diffusers(self, state_dict):
        ...
        for name in state_dict:
            if name in rename_dict:
                ...
                name_ = ".".join(
                    ["encoders", layer_id, attn_rename_dict[layer_type], tail]
                )
    ...
    def from_civitai(self, state_dict):
        rename_dict = {
            ...
            "conditioner.embedders.1.model.transformer.resblocks.0.attn.in_proj_bias": [
                "encoders.0.attn.to_q.bias",
                "encoders.0.attn.to_k.bias",
                "encoders.0.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.0.attn.in_proj_weight": [
                "encoders.0.attn.to_q.weight",
                "encoders.0.attn.to_k.weight",
                "encoders.0.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.1.attn.in_proj_bias": [
                "encoders.1.attn.to_q.bias",
                "encoders.1.attn.to_k.bias",
                "encoders.1.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.1.attn.in_proj_weight": [
                "encoders.1.attn.to_q.weight",
                "encoders.1.attn.to_k.weight",
                "encoders.1.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.10.attn.in_proj_bias": [
                "encoders.10.attn.to_q.bias",
                "encoders.10.attn.to_k.bias",
                "encoders.10.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.10.attn.in_proj_weight": [
                "encoders.10.attn.to_q.weight",
                "encoders.10.attn.to_k.weight",
                "encoders.10.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.11.attn.in_proj_bias": [
                "encoders.11.attn.to_q.bias",
                "encoders.11.attn.to_k.bias",
                "encoders.11.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.11.attn.in_proj_weight": [
                "encoders.11.attn.to_q.weight",
                "encoders.11.attn.to_k.weight",
                "encoders.11.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.12.attn.in_proj_bias": [
                "encoders.12.attn.to_q.bias",
                "encoders.12.attn.to_k.bias",
                "encoders.12.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.12.attn.in_proj_weight": [
                "encoders.12.attn.to_q.weight",
                "encoders.12.attn.to_k.weight",
                "encoders.12.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.13.attn.in_proj_bias": [
                "encoders.13.attn.to_q.bias",
                "encoders.13.attn.to_k.bias",
                "encoders.13.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.13.attn.in_proj_weight": [
                "encoders.13.attn.to_q.weight",
                "encoders.13.attn.to_k.weight",
                "encoders.13.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.14.attn.in_proj_bias": [
                "encoders.14.attn.to_q.bias",
                "encoders.14.attn.to_k.bias",
                "encoders.14.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.14.attn.in_proj_weight": [
                "encoders.14.attn.to_q.weight",
                "encoders.14.attn.to_k.weight",
                "encoders.14.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.15.attn.in_proj_bias": [
                "encoders.15.attn.to_q.bias",
                "encoders.15.attn.to_k.bias",
                "encoders.15.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.15.attn.in_proj_weight": [
                "encoders.15.attn.to_q.weight",
                "encoders.15.attn.to_k.weight",
                "encoders.15.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.16.attn.in_proj_bias": [
                "encoders.16.attn.to_q.bias",
                "encoders.16.attn.to_k.bias",
                "encoders.16.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.16.attn.in_proj_weight": [
                "encoders.16.attn.to_q.weight",
                "encoders.16.attn.to_k.weight",
                "encoders.16.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.17.attn.in_proj_bias": [
                "encoders.17.attn.to_q.bias",
                "encoders.17.attn.to_k.bias",
                "encoders.17.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.17.attn.in_proj_weight": [
                "encoders.17.attn.to_q.weight",
                "encoders.17.attn.to_k.weight",
                "encoders.17.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.18.attn.in_proj_bias": [
                "encoders.18.attn.to_q.bias",
                "encoders.18.attn.to_k.bias",
                "encoders.18.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.18.attn.in_proj_weight": [
                "encoders.18.attn.to_q.weight",
                "encoders.18.attn.to_k.weight",
                "encoders.18.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.19.attn.in_proj_bias": [
                "encoders.19.attn.to_q.bias",
                "encoders.19.attn.to_k.bias",
                "encoders.19.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.19.attn.in_proj_weight": [
                "encoders.19.attn.to_q.weight",
                "encoders.19.attn.to_k.weight",
                "encoders.19.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.2.attn.in_proj_bias": [
                "encoders.2.attn.to_q.bias",
                "encoders.2.attn.to_k.bias",
                "encoders.2.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.2.attn.in_proj_weight": [
                "encoders.2.attn.to_q.weight",
                "encoders.2.attn.to_k.weight",
                "encoders.2.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.20.attn.in_proj_bias": [
                "encoders.20.attn.to_q.bias",
                "encoders.20.attn.to_k.bias",
                "encoders.20.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.20.attn.in_proj_weight": [
                "encoders.20.attn.to_q.weight",
                "encoders.20.attn.to_k.weight",
                "encoders.20.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.21.attn.in_proj_bias": [
                "encoders.21.attn.to_q.bias",
                "encoders.21.attn.to_k.bias",
                "encoders.21.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.21.attn.in_proj_weight": [
                "encoders.21.attn.to_q.weight",
                "encoders.21.attn.to_k.weight",
                "encoders.21.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.22.attn.in_proj_bias": [
                "encoders.22.attn.to_q.bias",
                "encoders.22.attn.to_k.bias",
                "encoders.22.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.22.attn.in_proj_weight": [
                "encoders.22.attn.to_q.weight",
                "encoders.22.attn.to_k.weight",
                "encoders.22.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.23.attn.in_proj_bias": [
                "encoders.23.attn.to_q.bias",
                "encoders.23.attn.to_k.bias",
                "encoders.23.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.23.attn.in_proj_weight": [
                "encoders.23.attn.to_q.weight",
                "encoders.23.attn.to_k.weight",
                "encoders.23.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.24.attn.in_proj_bias": [
                "encoders.24.attn.to_q.bias",
                "encoders.24.attn.to_k.bias",
                "encoders.24.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.24.attn.in_proj_weight": [
                "encoders.24.attn.to_q.weight",
                "encoders.24.attn.to_k.weight",
                "encoders.24.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.25.attn.in_proj_bias": [
                "encoders.25.attn.to_q.bias",
                "encoders.25.attn.to_k.bias",
                "encoders.25.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.25.attn.in_proj_weight": [
                "encoders.25.attn.to_q.weight",
                "encoders.25.attn.to_k.weight",
                "encoders.25.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.26.attn.in_proj_bias": [
                "encoders.26.attn.to_q.bias",
                "encoders.26.attn.to_k.bias",
                "encoders.26.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.26.attn.in_proj_weight": [
                "encoders.26.attn.to_q.weight",
                "encoders.26.attn.to_k.weight",
                "encoders.26.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.27.attn.in_proj_bias": [
                "encoders.27.attn.to_q.bias",
                "encoders.27.attn.to_k.bias",
                "encoders.27.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.27.attn.in_proj_weight": [
                "encoders.27.attn.to_q.weight",
                "encoders.27.attn.to_k.weight",
                "encoders.27.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.28.attn.in_proj_bias": [
                "encoders.28.attn.to_q.bias",
                "encoders.28.attn.to_k.bias",
                "encoders.28.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.28.attn.in_proj_weight": [
                "encoders.28.attn.to_q.weight",
                "encoders.28.attn.to_k.weight",
                "encoders.28.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.29.attn.in_proj_bias": [
                "encoders.29.attn.to_q.bias",
                "encoders.29.attn.to_k.bias",
                "encoders.29.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.29.attn.in_proj_weight": [
                "encoders.29.attn.to_q.weight",
                "encoders.29.attn.to_k.weight",
                "encoders.29.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.3.attn.in_proj_bias": [
                "encoders.3.attn.to_q.bias",
                "encoders.3.attn.to_k.bias",
                "encoders.3.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.3.attn.in_proj_weight": [
                "encoders.3.attn.to_q.weight",
                "encoders.3.attn.to_k.weight",
                "encoders.3.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.30.attn.in_proj_bias": [
                "encoders.30.attn.to_q.bias",
                "encoders.30.attn.to_k.bias",
                "encoders.30.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.30.attn.in_proj_weight": [
                "encoders.30.attn.to_q.weight",
                "encoders.30.attn.to_k.weight",
                "encoders.30.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.31.attn.in_proj_bias": [
                "encoders.31.attn.to_q.bias",
                "encoders.31.attn.to_k.bias",
                "encoders.31.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.31.attn.in_proj_weight": [
                "encoders.31.attn.to_q.weight",
                "encoders.31.attn.to_k.weight",
                "encoders.31.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.4.attn.in_proj_bias": [
                "encoders.4.attn.to_q.bias",
                "encoders.4.attn.to_k.bias",
                "encoders.4.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.4.attn.in_proj_weight": [
                "encoders.4.attn.to_q.weight",
                "encoders.4.attn.to_k.weight",
                "encoders.4.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.5.attn.in_proj_bias": [
                "encoders.5.attn.to_q.bias",
                "encoders.5.attn.to_k.bias",
                "encoders.5.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.5.attn.in_proj_weight": [
                "encoders.5.attn.to_q.weight",
                "encoders.5.attn.to_k.weight",
                "encoders.5.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.6.attn.in_proj_bias": [
                "encoders.6.attn.to_q.bias",
                "encoders.6.attn.to_k.bias",
                "encoders.6.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.6.attn.in_proj_weight": [
                "encoders.6.attn.to_q.weight",
                "encoders.6.attn.to_k.weight",
                "encoders.6.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.7.attn.in_proj_bias": [
                "encoders.7.attn.to_q.bias",
                "encoders.7.attn.to_k.bias",
                "encoders.7.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.7.attn.in_proj_weight": [
                "encoders.7.attn.to_q.weight",
                "encoders.7.attn.to_k.weight",
                "encoders.7.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.8.attn.in_proj_bias": [
                "encoders.8.attn.to_q.bias",
                "encoders.8.attn.to_k.bias",
                "encoders.8.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.8.attn.in_proj_weight": [
                "encoders.8.attn.to_q.weight",
                "encoders.8.attn.to_k.weight",
                "encoders.8.attn.to_v.weight",
            ],
            ...
            "conditioner.embedders.1.model.transformer.resblocks.9.attn.in_proj_bias": [
                "encoders.9.attn.to_q.bias",
                "encoders.9.attn.to_k.bias",
                "encoders.9.attn.to_v.bias",
            ],
            "conditioner.embedders.1.model.transformer.resblocks.9.attn.in_proj_weight": [
                "encoders.9.attn.to_q.weight",
                "encoders.9.attn.to_k.weight",
                "encoders.9.attn.to_v.weight",
            ],
