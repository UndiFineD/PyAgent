# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\configs\model_config.py
...
from ..models.cog_vae import CogVAEDecoder, CogVAEEncoder
...
from ..models.hunyuan_dit_text_encoder import (
...
from ..models.sd_ipadapter import IpAdapterCLIPImageEmbedder, SDIpAdapter
...
from ..models.sdxl_ipadapter import IpAdapterXLCLIPImageEmbedder, SDXLIpAdapter
...
model_loader_configs = [
    ...
    (
        None,
        "091b0e30e77c76626b3ba62acdf95343",
        ["sd_controlnet"],
        [SDControlNet],
        "civitai",
    ),
    (
        None,
        "4a6c8306a27d916dea81263c8c88f450",
        ["hunyuan_dit_clip_text_encoder"],
        [HunyuanDiTCLIPTextEncoder],
        "civitai",
    ),
    (
        None,
        "f4aec400fe394297961218c768004521",
        ["hunyuan_dit"],
        [HunyuanDiT],
        "civitai",
    ),
    (
        None,
        "9e6e58043a5a2e332803ed42f6ee7181",
        ["hunyuan_dit_t5_text_encoder"],
        [HunyuanDiTT5TextEncoder],
        "civitai",
    ),
    (
        None,
        "13115dd45a6e1c39860f91ab073b8a78",
        ["sdxl_vae_encoder", "sdxl_vae_decoder"],
        [SDXLVAEEncoder, SDXLVAEDecoder],
        "diffusers",
    ),
    (
        None,
        "d78aa6797382a6d455362358a3295ea9",
        ["sd_ipadapter_clip_image_encoder"],
        [IpAdapterCLIPImageEmbedder],
        "diffusers",
    ),
    (
        None,
        "e291636cc15e803186b47404262ef812",
        ["sd_ipadapter"],
        [SDIpAdapter],
        "civitai",
    ),
    (
        None,
        "399c81f2f8de8d1843d0127a00f3c224",
        ["sdxl_ipadapter_clip_image_encoder"],
        [IpAdapterXLCLIPImageEmbedder],
        "diffusers",
    ),
    (
        None,
        "a64eac9aa0db4b9602213bc0131281c7",
        ["sdxl_ipadapter"],
        [SDXLIpAdapter],
        "civitai",
    ),
    ...
    (
        None,
        "03343c606f16d834d6411d0902b53636",
        ["sd_text_encoder", "sd_unet", "sd_vae_decoder", "sd_vae_encoder"],
        [SDTextEncoder, SDUNet, SDVAEDecoder, SDVAEEncoder],
        "civitai",
    ),
    (
        None,
        "d4ba77a7ece070679b4a987f58f201e9",
        ["sd_text_encoder"],
        [SDTextEncoder],
        "civitai",
    ),
    (
        None,
        "d0c89e55c5a57cf3981def0cb1c9e65a",
        ["sd_vae_decoder", "sd_vae_encoder"],
        [SDVAEDecoder, SDVAEEncoder],
        "civitai",
    ),
    (None, "3926bf373b39a67eeafd7901478a47a7", ["sd_unet"], [SDUNet], "civitai"),
    (
        None,
        "1e0c39ec176b9007c05f76d52b554a4d",
        [
            "sd3_text_encoder_1",
            "sd3_text_encoder_2",
            "sd3_dit",
        ...
        [SD3TextEncoder1, SD3TextEncoder2, SD3DiT, SD3VAEEncoder, SD3VAEDecoder],
        "civitai",
    ),
    (
        None,
        "d9e0290829ba8d98e28e1a2b1407db4a",
        [
            "sd3_text_encoder_1",
            "sd3_text_encoder_2",
            "sd3_text_encoder_3",
    ...
    (
        None,
        "5072d0b24e406b49507abe861cf97691",
        ["sd3_text_encoder_3"],
        [SD3TextEncoder3],
        "civitai",
    ),
    (
        None,
        "4cf64a799d04260df438c6f33c9a047e",
        [
            "sdxl_text_encoder",
            "sdxl_text_encoder_2",
            "sdxl_unet",
        ...
        [SDXLTextEncoder, SDXLTextEncoder2, SDXLUNet, SDXLVAEDecoder, SDXLVAEEncoder],
        "civitai",
    ),
    (
        None,
        "d9b008a867c498ab12ad24042eff8e3f",
        [
            "sdxl_text_encoder",
            "sdxl_text_encoder_2",
            "sdxl_unet",
    ...
    (
        None,
        "025bb7452e531a3853d951d77c63f032",
        ["sdxl_text_encoder", "sdxl_text_encoder_2"],
        [SDXLTextEncoder, SDXLTextEncoder2],
        "civitai",
    ),
    (None, "298997b403a4245c04102c9f36aac348", ["sdxl_unet"], [SDXLUNet], "civitai"),
    (
        None,
        "2a07abce74b4bdc696b76254ab474da6",
    ...
    (
        None,
        "c96a285a6888465f87de22a984d049fb",
        ["sd_motion_modules"],
        [SDMotionModel],
        "civitai",
    ),
    (
        None,
        "72907b92caed19bdb2adb89aa4063fe2",
        ["sdxl_motion_modules"],
        [SDXLMotionModel],
        "civitai",
    ),
    (
        None,
        "31d2d9614fba60511fc9bf2604aa01f7",
        ["sdxl_controlnet"],
        [SDXLControlNetUnion],
        "diffusers",
    ),
    (
        None,
        "94eefa3dac9cec93cb1ebaf1747d7b78",
        ["sd3_text_encoder_1"],
        [SD3TextEncoder1],
        "diffusers",
    ),
    (
        None,
        "1aafa3cc91716fb6b300cc1cd51b85a3",
        ["flux_vae_encoder", "flux_vae_decoder"],
        [FluxVAEEncoder, FluxVAEDecoder],
        "diffusers",
    ),
    (
        None,
        "21ea55f476dfc4fd135587abb59dfe5d",
        ["flux_vae_encoder", "flux_vae_decoder"],
        [FluxVAEEncoder, FluxVAEDecoder],
        "civitai",
    ),
    ...
    (
        None,
        "0629116fce1472503a66992f96f3eb1a",
        ["flux_value_controller"],
        [SingleValueEncoder],
        "civitai",
    ),
    (
        None,
        "280189ee084bca10f70907bf6ce1649d",
        ["cog_vae_encoder", "cog_vae_decoder"],
        [CogVAEEncoder, CogVAEDecoder],
        "diffusers",
    ),
    ...
    (
        None,
        "78d18b9101345ff695f312e7e62538c0",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "b001c89139b5f053c715fe772362dd2a",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "52357cb26250681367488a8954c271e8",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "0cfd1740758423a2a854d67c136d1e8c",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "7f9583eb8ba86642abb9a21a4b2c9e16",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "43ad5aaa27dd4ee01b832ed16773fa52",
        ["flux_controlnet"],
        [FluxControlNet],
        "diffusers",
    ),
    (
        None,
        "c07c0f04f5ff55e86b4e937c7a40d481",
        ["infiniteyou_image_projector"],
        [InfiniteYouImageProjector],
        "diffusers",
    ),
    (
        None,
        "4daaa66cc656a8fe369908693dad0a35",
        ["flux_ipadapter"],
        [FluxIpAdapter],
        "diffusers",
    ),
    (
        None,
        "51aed3d27d482fceb5e0739b03060e8f",
        ["sd3_dit", "sd3_vae_encoder", "sd3_vae_decoder"],
        [SD3DiT, SD3VAEEncoder, SD3VAEDecoder],
        "civitai",
    ),
    (
        None,
        "98cc34ccc5b54ae0e56bdea8688dcd5a",
        ["sd3_text_encoder_2"],
        [SD3TextEncoder2],
        "civitai",
    ),
    (
        None,
        "77ff18050dbc23f50382e45d51a779fe",
        ["sd3_dit", "sd3_vae_encoder", "sd3_vae_decoder"],
        [SD3DiT, SD3VAEEncoder, SD3VAEDecoder],
        "civitai",
    ),
    (
        None,
        "5da81baee73198a7c19e6d2fe8b5148e",
        ["sd3_text_encoder_1"],
        [SD3TextEncoder1],
        "diffusers",
    ),
    (
        None,
        "aeb82dce778a03dcb4d726cb03f3c43f",
    ...
    (
        None,
        "b9588f02e78f5ccafc9d7c0294e46308",
        ["hunyuan_video_dit"],
        [HunyuanVideoDiT],
        "civitai",
    ),
    (
        None,
        "84ef4bd4757f60e906b54aa6a7815dc6",
        ["hunyuan_video_dit"],
        [HunyuanVideoDiT],
        "civitai",
    ),
    (
        None,
        "68beaf8429b7c11aa8ca05b1bd0058bd",
        ["stepvideo_vae"],
        [StepVideoVAE],
        "civitai",
    ),
    (
        None,
        "5c0216a2132b082c10cb7a0e0377e681",
        ["stepvideo_dit"],
        [StepVideoModel],
        "civitai",
    ),
    ...
    (
        None,
        "d30fb9e02b1dbf4e509142f05cf7dd50",
        ["flux_dit", "step1x_connector"],
        [FluxDiT, Qwen2Connector],
        "civitai",
    ),
    (
        None,
        "30143afb2dea73d1ac580e0787628f8c",
        ["flux_lora_patcher"],
        [FluxLoraPatcher],
        "civitai",
    ),
    (
        None,
        "77c2e4dd2440269eb33bfaa0d004f6ab",
        ["flux_lora_encoder"],
        [FluxLoRAEncoder],
        "civitai",
    ),
...
patch_model_loader_configs = [
    ...
    (
        "9a4ab6869ac9b7d6e31f9854e397c867",
        ["svd_unet"],
        [SVDUNet],
