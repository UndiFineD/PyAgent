# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\utils\config_loader.py
# -*- coding: utf-8 -*-
import logging
...
def get_tool_config(
    ...
    config_values["prompt_inputs"] = [
        PromptInput(**item) for item in config_values.get("prompt_inputs", [])
    ]
    match tool_name:
        case "sql_tool":
