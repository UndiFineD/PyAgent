# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\api\v1\endpoints\sql.py
# -*- coding: utf-8 -*-
...
@cache(
    expire=600
)  # -> Bug on POST requests https://github.com/long2ice/fastapi-cache/issues/113
