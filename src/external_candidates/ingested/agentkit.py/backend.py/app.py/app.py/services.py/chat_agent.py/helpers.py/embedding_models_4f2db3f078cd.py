# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\services\chat_agent\helpers\embedding_models.py
# -*- coding: utf-8 -*-
...
def get_embedding_model(emb_model: Optional[str]) -> CacheBackedEmbeddings:
    ...
    match emb_model:
        ...
        case _:
            logger.warning(
                f"embedding model {emb_model} not found, using default emb_model"
            )
            underlying_embeddings = OpenAIEmbeddings()
