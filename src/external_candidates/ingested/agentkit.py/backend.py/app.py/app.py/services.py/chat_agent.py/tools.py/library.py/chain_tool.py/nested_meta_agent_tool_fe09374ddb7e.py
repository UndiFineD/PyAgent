# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\services\chat_agent\tools\library\chain_tool\nested_meta_agent_tool.py
# -*- coding: utf-8 -*-
    ...
    def from_config(
        ...
        **kwargs: Any,
        ...
        fast_llm_token_limit = kwargs.get(
            "fast_llm_token_limit", common_config.fast_llm_token_limit
        )
        ...
        agent_config = load_agent_config_override(
            {
                ...
                "action_plans": ActionPlans(
                    action_plans={
                        k: ActionPlan(**v)
                        for k, v in config.additional.action_plans.items()
                    }
                ),
                "prompt_message": config.prompt_message,
                "system_context": config.system_context,
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if run_manager is not None:
                ...
                await run_manager.on_text(
                    response["output"], data_type=StreamingDataTypeEnum.LLM
                )
