# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\services\chat_agent\tools\library\image_generation_tool\image_generation_tool.py
# -*- coding: utf-8 -*-
...
class ImageGenerationTool(ExtendedBaseTool):
    ...
    def generate_image(
        ...
        try:
            ...
            return (
                "ERROR: could not generate the image based on the description: "
                + description
            )
