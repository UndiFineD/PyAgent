# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\alembic\versions\2023-06-02-15-48_adbe2344fb23.py
# -*- coding: utf-8 -*-
"""
empty message.
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "providerAccountId", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_VerificationToken_id"), "VerificationToken", ["id"], unique=False
    )
