# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-nof1.ai-alpha-arena\src\gui\app.py
"""
    ...
    with ui.column().classes("w-full h-screen"):
        ...
        with ui.row().classes("w-full flex-grow"):
            ...
            with ui.column().classes("w-64 bg-gray-800 p-4 gap-2 h-full"):
                ...
                menu_items = [
                    ...
                    (
                        "Recommendations",
                        "🤖 AI Recommendations",
                        "Review and approve AI trade proposals",
                    ),
                ...
                with ui.column().classes("mt-auto gap-1"):
                    ...
                    ui.label("Powered by NiceGUI").classes(
            ...
            content_container = ui.column().classes(
                "flex-grow p-6 overflow-auto items-start"
            )
