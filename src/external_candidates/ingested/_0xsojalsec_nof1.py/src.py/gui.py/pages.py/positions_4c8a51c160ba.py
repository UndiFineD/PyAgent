...
def create_positions(bot_service: BotService, state_manager: StateManager):
    ...
    with ui.row().classes("w-full gap-4 mb-6"):
        ...
        with ui.card().classes(
            "flex-1 p-4 bg-gradient-to-br from-blue-600 to-blue-800"
        ):
        ...
        # Total Exposure
        with ui.card().classes(
            "flex-1 p-4 bg-gradient-to-br from-indigo-600 to-indigo-800"
        ):
    ...
    with ui.card().classes("w-full p-4"):
        ...
        with chart_dialog, ui.card().classes("w-96"):
            ...
            dialog_content = ui.label("Chart functionality coming soon...").classes(
                "text-gray-400"
            )
        ...
        with close_dialog, ui.card().classes("w-96"):
            ...
            with ui.row().classes("w-full justify-end gap-2"):
                ...
                close_confirm_btn = ui.button(
                    "Close Position", on_click=lambda: None
                ).classes("bg-red-600")
        ...
        async def confirm_close():
            ...
            if symbol:
                try:
                    ...
                    if success:
                        ui.notify(
                            f"Successfully closed {symbol} position!", type="positive"
                        )
                    else:
    ...
    # Empty state message
    empty_message = ui.label("No active positions").classes(
