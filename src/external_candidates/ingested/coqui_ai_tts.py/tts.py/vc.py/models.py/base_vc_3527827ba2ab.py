# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\vc\models\base_vc.py
import logging
import os
import random
...
class BaseVC(BaseTrainerModel):
    ...
    def get_aux_input_from_test_sentences(
        self, sentence_info: str | list[str]
    ) -> dict[str, Any]:
        ...
        if (
            ...
            and config.use_language_embedding
    ...
    def get_data_loader(
        ...
        if is_eval and not config.run_eval:
            ...
            if self.language_manager is not None:
                language_id_mapping = (
                    self.language_manager.name_to_id
            ...
            loader = DataLoader(
                ...
                shuffle=(
                    config.shuffle if sampler is None else False
                ),  # if there is no other sampler
