...
class GAN(BaseVocoder):
    ...
    def _log(
        self, name: str, ap: AudioProcessor, batch: dict, outputs: dict
    ) -> tuple[dict, dict]:
    ...
    def eval_step(
        ...
        self.train_disc = (
            True  # Avoid a bug in the Training with the missing discriminator loss
        )
