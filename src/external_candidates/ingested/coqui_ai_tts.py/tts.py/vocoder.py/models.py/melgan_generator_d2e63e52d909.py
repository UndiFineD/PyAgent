# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\vocoder\models\melgan_generator.py
import torch
...
class MelganGenerator(nn.Module):
    def __init__(
        ...
        layers += [
            ...
            weight_norm(
                nn.Conv1d(
                    layer_out_channels, out_channels, proj_kernel, stride=1, bias=True
                )
            ),
            nn.Tanh(),
        ]
