# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\vocoder\configs\wavernn_config.py
...
class WavernnConfig(BaseVocoderConfig):
    ...
    lr_scheduler: str = (
        "MultiStepLR"  # one of the schedulers from https:#pytorch.org/docs/stable/optim.html
    )
    lr_scheduler_params: dict = field(
        default_factory=lambda: {"gamma": 0.5, "milestones": [200000, 400000, 600000]}
    )
