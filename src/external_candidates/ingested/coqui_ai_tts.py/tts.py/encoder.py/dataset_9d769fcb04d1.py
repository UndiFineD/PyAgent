...
class EncoderDataset(Dataset):
    def __init__(
        ...
        if augmentation_config:
            ...
            if self.data_augmentation_p and (
                "additive" in augmentation_config or "rir" in augmentation_config
            ):
    ...
    def __parse_items(self):
        ...
        for item in self.items:
            ...
            class_name = (
                item["emotion_name"]
                if self.config.model == "emotion_encoder"
                else item["speaker_name"]
            )
