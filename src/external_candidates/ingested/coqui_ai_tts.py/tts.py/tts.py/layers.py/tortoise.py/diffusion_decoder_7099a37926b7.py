# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\layers\tortoise\diffusion_decoder.py
import math
import random
...
class DiffusionLayer(TimestepBlock):
    def __init__(self, model_channels, dropout, num_heads):
        ...
        self.attn = AttentionBlock(
            model_channels, num_heads, relative_pos_embeddings=True, tortoise_norm=True
        )
