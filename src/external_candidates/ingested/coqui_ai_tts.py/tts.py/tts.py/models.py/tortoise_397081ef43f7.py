...
class Tortoise(BaseTTS):
    ...
    def _clone_voice(
        ...
        **generate_kwargs: Any,
        ...
        auto_conditioning, diffusion_conditioning = self.get_conditioning_latents(
            voice_samples, **generate_kwargs
        )
        voice = {
    ...
    def synthesize(
        ...
        **kwargs,
        ...
        outputs = self.inference_with_config(
            text, conditioning_latents=conditioning_latents, **kwargs
        )
    ...
    def load_checkpoint(
        ...
        **kwargs,
        ...
        ar_path = ar_checkpoint_path or os.path.join(
            checkpoint_dir, "autoregressive.pth"
        )
        diff_path = diff_checkpoint_path or os.path.join(
            checkpoint_dir, "diffusion_decoder.pth"
        )
        clvp_path = clvp_checkpoint_path or os.path.join(checkpoint_dir, "clvp2.pth")
        vocoder_checkpoint_path = vocoder_checkpoint_path or os.path.join(
            checkpoint_dir, "vocoder.pth"
        )
