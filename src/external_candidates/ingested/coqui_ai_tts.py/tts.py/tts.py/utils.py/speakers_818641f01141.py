# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\utils\speakers.py
import logging
import os
...
class SpeakerManager(EmbeddingManager):
    ...
    def init_from_config(
        ...
        if get_from_config_or_model_args_with_default(
            ...
            if speaker_file := get_from_config_or_model_args_with_default(
                config, "speaker_file", None
            ):
                speaker_manager = SpeakerManager(speaker_id_file_path=speaker_file)
            if speakers_file := get_from_config_or_model_args_with_default(
        ...
        if get_from_config_or_model_args_with_default(
            ...
            if d_vector_file := get_from_config_or_model_args_with_default(
