# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\utils\text\phonemizers\ko_kr_phonemizer.py
...
class KO_KR_Phonemizer(BasePhonemizer):
    ...
    def __init__(
        self, punctuations=_DEF_KO_PUNCS, keep_puncs=True, **kwargs
    ...
    def _phonemize(
        self, text: str, separator: str = "", character: str = "hangeul"
    ) -> str:
    ...
    def phonemize(
        self, text: str, separator: str = "", character: str = "hangeul", language=None
    ) -> str:
