# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\utils\text\phonemizers\zh_cn_phonemizer.py
...
class ZH_CN_Phonemizer(BasePhonemizer):
    ...
    def __init__(
        self, punctuations=_DEF_ZH_PUNCS, keep_puncs=False, **kwargs
