# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\utils\text\characters.py
import logging
...
class BaseVocabulary:
    ...
    def init_from_config(
        config: BaseTTSConfig, **kwargs
    ) -> tuple["BaseVocabulary", BaseTTSConfig]:
...
class BaseCharacters:
    ...
    ) -> tuple["BaseCharacters", BaseTTSConfig]:
