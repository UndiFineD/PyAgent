# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\utils\text\phonemizers\ja_jp_phonemizer.py
...
class JA_JP_Phonemizer(BasePhonemizer):
    ...
    def __init__(
        self, punctuations=_DEF_JA_PUNCS, keep_puncs=True, **kwargs
