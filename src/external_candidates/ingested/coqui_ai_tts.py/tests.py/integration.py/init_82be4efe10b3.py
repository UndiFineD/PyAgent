# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\tests\integration\__init__.py
import json
import shutil
...
def create_config(config_class: type[Config], **overrides: Any) -> Config:
    base_config = (
        TEST_TTS_CONFIG if issubclass(config_class, BaseTTSConfig) else TEST_VC_CONFIG
    )
