...
class SynthesizerTest(unittest.TestCase):
    ...
    def _create_random_model(self):
        ...
        config = load_config(
            os.path.join(get_tests_input_path(), "dummy_model_config.json")
        )
    ...
    def test_in_out(self):
        ...
        synthesizer = Synthesizer(
            tts_checkpoint=tts_checkpoint, tts_config_path=tts_config
        )
    ...
    def test_split_into_sentences(self):
        ...
        assert sis(
            self, "He went to meet the adviser from Scott, Waltman & Co. next morning."
        ) == ["He went to meet the adviser from Scott, Waltman & Co. next morning."]
        assert sis(
            self, "Let's run it past Sarah and co. They'll want to see this."
        ) == [
        ...
        assert sis(
            self, "paging dr. green, please come to theatre four immediately."
        ...
        assert sis(
            self, "a. The first item b. The second item c. The third list item"
        ) == [
            "a. The first item",
            "b. The second item",
