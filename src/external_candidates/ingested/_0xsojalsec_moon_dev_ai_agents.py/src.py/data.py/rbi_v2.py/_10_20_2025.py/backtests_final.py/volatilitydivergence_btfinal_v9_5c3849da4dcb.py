# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\10_20_2025\backtests_final\VolatilityDivergence_BTFinal_v9.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if (
            ...
            if sl_distance > 0:
                ...
                self.bars_in_trade = 0
                print(
                    f"🌙 Moon Dev: Entering LONG at {entry_price:.2f}, size {size:.4f}, SL {sl_price:.2f}, TP {tp_price:.2f} 🚀"
                )
            else:
                print(
            ...
            if sl_distance > 0:
                ...
                self.bars_in_trade = 0
                print(
                    f"🌙 Moon Dev: Entering SHORT at {entry_price:.2f}, size {size:.4f}, SL {sl_price:.2f}, TP {tp_price:.2f} ✨"
                )
            else:
                print(
