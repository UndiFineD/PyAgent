# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\10_20_2025\backtests_final\VolCliffArbitrage_BTFinal_v3.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if self.position:
            ...
            if len(self.trades) > 0:
                ...
                entry_price = current_close  # fallback, though shouldn't happen
