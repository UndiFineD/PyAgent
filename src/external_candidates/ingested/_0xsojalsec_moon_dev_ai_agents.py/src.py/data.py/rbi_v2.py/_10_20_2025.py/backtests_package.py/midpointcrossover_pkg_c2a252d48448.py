# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\10_20_2025\backtests_package\MidpointCrossover_PKG.py
import pandas as pd
import talib
...
class MidpointCrossover(Strategy):
    ...
    def init(self):
        ...
        self.stddev = self.I(
            lambda x: x.rolling(self.bbmp_period).std(), self.data.Close
        )
