# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\10_20_2025\backtests_final\VolatilityDivergence_BTFinal_v3.py
import numpy as np
import pandas as pd
import talib
...
class VolatilityDivergence(Strategy):
    ...
    def adjust_trade(self, trade):
        ...
        if trade.is_long:
            if (
                self.data.Close[-1]
                > trade.entry_price + self.trail_profit_atr * atr_val
            ):
