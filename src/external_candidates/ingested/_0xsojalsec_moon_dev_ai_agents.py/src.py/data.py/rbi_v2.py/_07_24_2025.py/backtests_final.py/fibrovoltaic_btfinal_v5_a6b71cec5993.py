# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\FibroVoltaic_BTFinal_v5.py
import numpy as np
import pandas as pd
import talib
...
bt = Backtest(data, FibroVoltaic, commission=0.002, exclusive_orders=True, cash=100000)
stats = bt.run()
print(stats)
