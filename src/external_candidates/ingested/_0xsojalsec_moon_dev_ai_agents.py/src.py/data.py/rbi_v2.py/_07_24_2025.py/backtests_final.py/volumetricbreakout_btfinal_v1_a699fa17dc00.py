# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\VolumetricBreakout_BTFinal_v1.py
import pandas as pd
import talib
...
class VolumetricBreakout(Strategy):
    ...
    def next(self):
        ...
        if (
            ...
            print(
                f"📈 Price: {entry_price:.2f}, SL: {stop_loss:.2f}, TP: {take_profit:.2f}"
            )
