# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\BandedRSI_Trend_BTFinal_WORKING.py
import pandas as pd
import talib
...
if __name__ == "__main__":
    ...
    bt = Backtest(
        data, BandedRSITrend, commission=0.002, exclusive_orders=True, cash=100000
    )
    stats = bt.run()
    print(stats)
