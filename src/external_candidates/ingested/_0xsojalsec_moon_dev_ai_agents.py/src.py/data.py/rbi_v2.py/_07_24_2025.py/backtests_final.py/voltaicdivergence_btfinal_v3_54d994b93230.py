# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\VoltaicDivergence_BTFinal_v3.py
import pandas as pd
import talib
            ...
            if (
                ...
                if position_size > 0:
                    ...
                    tp_price = current_close - (
                        self.rr_ratio * (stop_loss - current_close)
                    )
