# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_package\FractalFibonacci_PKG.py
import numpy as np
import pandas as pd
import talib
...
class FractalFibonacci(Strategy):
    def init(self):
        ...
        self.data.df = self.data.df.rename(
            columns={
                "open": "Open",
                "high": "High",
                "low": "Low",
...
# Run backtest
bt = Backtest(data, FractalFibonacci, commission=0.002, exclusive_orders=True)
stats = bt.run()
print(stats)
