# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests\GannSMAConvergence_BT.py
import numpy as np
import pandas as pd
import talib
...
class GannSMAConvergence(Strategy):
    ...
    def next(self):
        ...
        if self.position.is_short:
            if crossover(self.sma5, self.data.Close):
...
# Run backtest
bt = Backtest(
    data, GannSMAConvergence, commission=0.002, margin=1.0, trade_on_close=True
)
stats = bt.run()
print(stats)
