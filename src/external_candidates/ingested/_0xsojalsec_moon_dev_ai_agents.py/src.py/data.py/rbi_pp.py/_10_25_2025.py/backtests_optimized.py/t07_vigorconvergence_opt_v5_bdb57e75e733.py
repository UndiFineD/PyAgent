    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and current_close
                > current_ema50  # 🌙 Moon Dev: Trend filter - only long above EMA50
                ...
                equity = (
                    self._broker.get_cash() + self._broker.get_value()
                )  # 🌙 Moon Dev: Accurate equity calculation
                ...
                and current_close
                < current_ema50  # 🌙 Moon Dev: Trend filter - only short below EMA50
