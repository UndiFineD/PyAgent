    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and current_close
                > current_ema200  # 🌙 Moon Dev: Trend filter - only long in bullish regime
                and current_volume
                > current_vol_sma  # 🌙 Moon Dev: Volume filter for confirmation
                and current_rsi < 60
                ...
                and current_close
                < current_ema200  # 🌙 Moon Dev: Trend filter - only short in bearish regime
                and current_volume
                > current_vol_sma  # 🌙 Moon Dev: Volume filter for confirmation
                and current_rsi > 40
