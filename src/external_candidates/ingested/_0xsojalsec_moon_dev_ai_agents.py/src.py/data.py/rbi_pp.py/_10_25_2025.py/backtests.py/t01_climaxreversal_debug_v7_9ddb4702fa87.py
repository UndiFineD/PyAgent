# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests\T01_ClimaxReversal_DEBUG_v7.py
import numpy as np
import pandas as pd
import talib
...
class ClimaxReversal(Strategy):
    ...
    def next(self):
        ...
        if gap_size_pct > 0.0005:  # 0.05% threshold for debug
            ...
            print(
                f"🌙 Moon Dev Debug: Bar {i}, Gap%: {gap_size_pct*100:.3f}, Down?: {is_gap_down}, Consec down: {self.get_consec_down()}, up: {self.get_consec_up()}, "
