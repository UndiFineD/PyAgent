# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests\T03_SqueezeBreakout_DEBUG_v2.py
import numpy as np
import pandas as pd
import talib
...
class SqueezeBreakout(Strategy):
    ...
    def next(self):
        ...
        prev_squeeze_val = self.squeeze[-2] if len(self.squeeze) > 1 else np.nan
        prev_squeeze = (
        ...
        if not self.position:
            ...
            if (
                ...
                and current_price > self.bb_middle[-1]
            ):
