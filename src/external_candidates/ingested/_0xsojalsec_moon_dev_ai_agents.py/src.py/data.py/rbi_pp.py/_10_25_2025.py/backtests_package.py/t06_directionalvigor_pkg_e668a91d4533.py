# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_package\T06_DirectionalVigor_PKG.py
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if entry_signal and not self.position:
            ...
            if risk_per_unit > 0:
                ...
                print(
                    f"🌙 Moon Dev: Entering LONG at {current_close:.2f} | Size: {position_size} | SL: {sl_price:.2f} | ADX: {current_adx:.2f} 🚀✨"
                )
