...
class DirectionalVigor(Strategy):
    ...
    def next(self):
        if (
            len(self.data) < 201
        ):  # 🌙 Moon Dev: Kept buffer for EMA200 and added indicators initialization safety ✨
            return
        ...
        if long_signal and not self.position:
            ...
            if risk_per_unit > 0:
                ...
                ) * 0.95  # 🌙 Moon Dev: Cap size to 95% of available equity to prevent over-leveraging in spot trading 💰
