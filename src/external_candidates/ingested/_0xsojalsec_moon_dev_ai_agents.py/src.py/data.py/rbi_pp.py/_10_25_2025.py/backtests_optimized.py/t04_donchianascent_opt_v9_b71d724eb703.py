# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T04_DonchianAscent_OPT_v9.py
import numpy as np
import pandas as pd
import talib
...
class DonchianAscent(Strategy):
    ...
    def init(self):
        ...
        )  # Renamed for clarity on new period
        ...
        print(
            "🌙 Moon Dev Backtest Initialized: Further Optimized DonchianAscent Strategy Loaded for 50% Target! ✨"
        )
    ...
    def next(self):
        ...
        if self.position:
            ...
            )  # Retained for uptrend alignment
            ...
            if (
                ...
                if risk_per_share > 0:
                    ...
                    print(
                        f"🌙 Moon Dev Long Entry: Enhanced Breakout at {current_close}, size={position_size}, SL={sl_price}, TP={tp_price} (RSI={current_rsi:.1f}, ADX={current_adx:.1f}, Trend=Up, Ascending=Yes) ✨🚀"
                    )
