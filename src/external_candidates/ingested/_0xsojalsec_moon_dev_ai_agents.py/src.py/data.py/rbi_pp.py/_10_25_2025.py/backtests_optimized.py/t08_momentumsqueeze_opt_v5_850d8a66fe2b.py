# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T08_MomentumSqueeze_OPT_v5.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if (
            ...
            if risk > 0:
                ...
                atr_factor = (
                    2 * self.atr[-1] / entry
                )  # Normalize ATR to price for sizing cap
                pos_size = min(
                    risk_amount / risk, self.equity * 0.1 / entry
                )  # Cap at 10% equity exposure
