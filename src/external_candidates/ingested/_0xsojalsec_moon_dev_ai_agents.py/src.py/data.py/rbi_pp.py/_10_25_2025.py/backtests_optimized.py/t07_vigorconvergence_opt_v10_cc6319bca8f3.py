# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T07_VigorConvergence_OPT_v10.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                and current_volume > current_volume_sma
                and current_rsi > 50
            ):
                # Long entry
                ...
                )  # 🌙 Moon Dev: Simplified sizing formula, allows float for fractional BTC units
