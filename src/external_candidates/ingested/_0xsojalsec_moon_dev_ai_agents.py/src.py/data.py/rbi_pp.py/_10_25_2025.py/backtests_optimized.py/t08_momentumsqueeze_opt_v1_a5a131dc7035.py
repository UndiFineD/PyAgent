# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T08_MomentumSqueeze_OPT_v1.py
import numpy as np
import pandas as pd
import talib
...
class MomentumSqueeze(Strategy):
    def init(self):
        ...
        self.bb_upper, self.bb_middle, self.bb_lower = self.I(
            talib.BBANDS, self.data.Close, timeperiod=21, nbdevup=2, nbdevdn=2, matype=0
        )
