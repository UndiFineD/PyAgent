...
class FibonacciCrossover(Strategy):
    ...
    def next(self):
        ...
        if (
            ...
            and current_rsi
            > self.rsi_long_threshold  # 🌙 Moon Dev: Loosened RSI to >52 for more bullish setups
            ...
            * self.volume_ma[
            ...
            and current_adx
            > self.adx_threshold  # 🌙 Moon Dev: Loosened ADX to 22 to include more trending conditions
            and harmonic_long
        ):
        ...
        # Short Entry - Enhanced with loosened ADX (22), RSI (<48), volume (1.5x), confluence (0.007), and retained trend filters
            ...
            and current_rsi
            < self.rsi_short_threshold  # 🌙 Moon Dev: Loosened RSI to <48 for more bearish setups
            and current_close < self.sma200[-1]
            and current_volume
            > self.volume_multiplier
            * self.volume_ma[
