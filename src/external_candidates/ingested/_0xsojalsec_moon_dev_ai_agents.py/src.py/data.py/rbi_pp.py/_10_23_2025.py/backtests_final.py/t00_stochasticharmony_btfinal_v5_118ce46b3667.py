# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_23_2025\backtests_final\T00_StochasticHarmony_BTFinal_v5.py
import pandas as pd
import talib
                        ...
                        if (
                            ...
                            if bull_cross and oversold and not self.position:
                                ...
                                if risk > 0:
                                    ...
                                    print(
                                        f"🌙 Moon Dev: Bullish Gartley Detected! LONG entry at {entry:.2f}, SL: {sl:.2f}, TP: {tp:.2f}, Size: {size:.4f} 🚀✨"
                                    )
                        ...
                        if (
                            ...
                            if bear_cross and overbought and not self.position:
                                ...
                                if risk > 0:
                                    ...
                                    print(
                                        f"🌙 Moon Dev: Bearish Gartley Detected! SHORT entry at {entry:.2f}, SL: {sl:.2f}, TP: {tp:.2f}, Size: {size:.4f} 🚀✨"
                                    )
