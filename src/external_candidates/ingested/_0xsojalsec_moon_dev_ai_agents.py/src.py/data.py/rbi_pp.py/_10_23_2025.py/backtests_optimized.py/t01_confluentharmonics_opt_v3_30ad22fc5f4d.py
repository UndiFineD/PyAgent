...
class ConfluentHarmonics(Strategy):
    ...
    rr_ratio = 3
    risk_per_trade = (
        0.015  # Slightly increased risk for higher returns while maintaining management
    )
            ...
            if self.position.is_long:
                if adx_val < 20:
                    ...
                    if trail_sl > self.position.sl:
                        ...
                        print(
                            f"🌙 Trailing SL Updated Long at {self.data.index[-1]} 🌙 New SL: {trail_sl}"
                        )
                ...
                if adx_val < 20:
                    ...
                    if trail_sl < self.position.sl:
                        self.position.sl = trail_sl
                        print(
                            f"🌙 Trailing SL Updated Short at {self.data.index[-1]} 🌙 New SL: {trail_sl}"
                        )
