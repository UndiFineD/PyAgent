# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_23_2025\backtests_optimized\FractalCascade_OPT_v10.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                and self.data.Volume[-1] > vol_threshold
                ...
                if sl < entry_price:
                    ...
                    if size > 0:
                        ...
                        self.current_sl = sl
                        print(
                            f"🌙 Moon Dev: Long entry at {entry_price:.2f}, Size: {size:.4f}, SL: {sl:.2f}, TP: {tp:.2f} 🚀"
                        )
            ...
            # Short entry
                ...
                if sl > entry_price:
                    ...
                    if size > 0:
                        ...
                        self.current_sl = sl
                        print(
                            f"🌙 Moon Dev: Short entry at {entry_price:.2f}, Size: {size:.4f}, SL: {sl:.2f}, TP: {tp:.2f} 📉"
                        )
        ...
        if self.position:
            if self.position.is_long:
                ...
                if potential_sl > current_sl:
                    ...
                    print(
                        f"🌙 Moon Dev: Trailing SL long to {potential_sl:.2f}, new TP: {new_tp:.2f} ✨"
                    )
                ...
                if potential_sl < current_sl:
                    ...
                    self.current_sl = potential_sl
                    print(
                        f"🌙 Moon Dev: Trailing SL short to {potential_sl:.2f}, new TP: {new_tp:.2f} ✨"
                    )
