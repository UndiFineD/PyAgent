# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_23_2025\backtests_optimized\FractalCascade_OPT_v2.py
import numpy as np
import pandas as pd
import talib
...
class FractalCascade(Strategy):
    ...
    def next(self):
        ...
        atr_buffer = (
            0.5 * self.atr[-1]
        )  # 🌙 Moon Dev: Tightened initial SL buffer to 0.5 ATR for larger position sizes and better R:R potential ✨
