    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                * self.volume_ma[
                    -1
                ]  # 🌙 Moon Dev: Tightened volume filter to 1.2x MA for higher quality breakouts
                ...
                if sl < entry_price:
                    ...
                    tp = (
                        entry_price + 2.5 * risk_dist
                    )  # 🌙 Moon Dev: Added 2.5:1 RR take profit to capture larger wins
            ...
            if self.position.is_long:
                ...
                if not np.isnan(self.down_fractal[-1]):
                    ...
                    if new_sl > current_sl:
                        ...
                        print(
                            f"🌙 Moon Dev: Fractal trailing SL long to {new_sl:.2f} ✨"
                        )
                ...
                if len(self.data.Low) >= 5:
                    ...
                    if new_trail_sl > self.current_sl:
                        ...
                        print(
                            f"🌙 Moon Dev: Dynamic trail SL long to {new_trail_sl:.2f} ✨"
                        )
                ...
                if not np.isnan(self.up_fractal[-1]):
                    ...
                    if new_sl < current_sl:
                        ...
                        self.current_sl = new_sl
                        print(
                            f"🌙 Moon Dev: Fractal trailing SL short to {new_sl:.2f} ✨"
                        )
                ...
                if len(self.data.High) >= 5:
                    ...
                    if new_trail_sl < self.current_sl:
                        ...
                        self.current_sl = new_trail_sl
                        print(
                            f"🌙 Moon Dev: Dynamic trail SL short to {new_trail_sl:.2f} ✨"
                        )
