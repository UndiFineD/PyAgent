# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_23_2025\backtests_package\VolatilityEngulfing_PKG.py
import numpy as np
import pandas as pd
import talib
...
class VolatilityEngulfing(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            print(
                f"🌙 Moon Dev Position Update: PL: {self.position.pl:.2f}, Size: {self.position.size}, Entry: {self.position.entry_price:.2f} 📊"
            )
