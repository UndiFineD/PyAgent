# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_20_2025\backtests_optimized\DivergentReversion_OPT_v11.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if (
            ...
            if (self.rsi[-1] < self.rsi_sma[-1]) and (
                ...
                equity = self._broker.get_cash() + self._broker.get_value(
                    self.data.Close[-1]
                )  # 🌙 Moon Dev: Use total equity for accurate sizing
