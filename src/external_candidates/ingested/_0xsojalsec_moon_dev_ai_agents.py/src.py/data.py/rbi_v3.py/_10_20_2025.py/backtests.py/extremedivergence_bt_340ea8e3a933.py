# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_20_2025\backtests\ExtremeDivergence_BT.py
import numpy as np
import pandas as pd
import talib
...
class ExtremeDivergence(Strategy):
    ...
    def next(self):
        ...
        if self._i >= 10:  # Ensure enough data
            ...
            low_indices = argrelextrema(price_slice_low.values, np.less_equal, order=5)[
                0
            ]
        ...
        if self._i >= 10:
            ...
            high_indices = argrelextrema(
                price_slice_high.values, np.greater_equal, order=5
            )[0]
