...
class InverseMomentum(Strategy):
    ...
    vol_period = (
        14  # 🌙 Optimized: Reduced to 14 for more responsive volume averaging on 15m
    )
    ...
    def init(self):
        ...
        self.long_trend_sma = self.I(
            talib.SMA, close, timeperiod=self.long_trend_period
        )
        ...
        # Debug print on init
        print(
            "🌙 Moon Dev Backtest Initialized: Optimized InverseMomentum Strategy on 15m Loaded! ✨"
        )
    ...
    def next(self):
        ...
        if self.position:
            ...
            if (
                ...
                > self.long_trend_sma[-1]  # New: Bull regime filter
                and self.rsi[-1] > 50
...
bt = Backtest(
    raw_data, InverseMomentum, cash=1000000, commission=0.002, exclusive_orders=True
)
