# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_18_2025\backtests_package\VolumetricCross_PKG.py
    ...
    def next(self):
                ...
                if current_volume > self.volume_spike * avg_volume and avg_volume > 0:
                    ...
                    if risk_per_share > 0:
                        ...
                        if position_size > 0:
                            ...
                            print(
                                f"🚀🌕 MOON DEV ENTRY! | Size: {position_size} | Entry: {entry_price:.2f} | SL: {stop_loss:.2f}"
                            )
        ...
        # Cosmic Exit Logic 🌠
            ...
            if self.rsi[-1] >= 70:
                self.position.close()
                print(
                    f"🌑✨ MOON DEV EXIT! | Price: {self.data.Close[-1]:.2f} | RSI: {self.rsi[-1]:.2f}"
                )
