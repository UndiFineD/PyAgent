# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\MomentumBreakout_AI5.py
...
class MomentumBreakout(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                current_close > high_20
                and strong_uptrend
                and volume_confirmation
                and momentum_oversold
            ):
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🚀🌙 MOMENTUM BREAKOUT! Entry: {current_close:.2f}, Size: {position_size}"
                        )
            ...
            if self.position.is_long:
                ...
                if current_close > self.position.entry_price * 1.1:  # If up 10%+
                    ...
                    if ema21 < ema50 or rsi_val < 25:
                        print(
                            f"🌕 MOMENTUM EXIT at {current_close:.2f} - Trend weakening"
                        )
                        self.position.close()
