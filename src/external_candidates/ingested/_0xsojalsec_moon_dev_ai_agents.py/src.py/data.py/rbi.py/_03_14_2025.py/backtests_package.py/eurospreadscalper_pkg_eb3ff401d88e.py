# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\backtests_package\EuroSpreadScalper_PKG.py
...
class EuroSpreadScalper(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            sl_price = price * (1 + self.sl_factor)
