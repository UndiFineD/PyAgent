# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\backtests\VolatilityMomentum_BT.py
...
class VolatilityMomentum(Strategy):
    ...
    def init(self):
        ...
        # RSI (50-period)
        self.rsi = self.I(
            talib.RSI, self.data.Close, timeperiod=self.rsi_period, name="RSI"
        )
