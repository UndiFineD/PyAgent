# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\CoTrendalNeutral_AI5.py
...
class CoTrendalNeutral(Strategy):
    ...
    def init(self):
        ...
        self.swing_high = self.I(
            talib.MAX, self.data.High, timeperiod=20, name="Swing_High"
        )
        self.swing_low = self.I(
            talib.MIN, self.data.Low, timeperiod=20, name="Swing_Low"
        )
