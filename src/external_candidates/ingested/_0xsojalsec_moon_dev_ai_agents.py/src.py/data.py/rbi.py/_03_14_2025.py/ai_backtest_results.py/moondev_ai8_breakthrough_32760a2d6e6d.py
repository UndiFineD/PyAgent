# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\MoonDev_AI8_BREAKTHROUGH.py
#!/usr/bin/env python3
        ...
        if not self.position and self.trade_count < 10:
            ...
            if price_above_sma20 and sma20_above_sma50 and rsi_healthy:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"   📊 SMA20: {self.sma20[-1]:.0f}, SMA50: {self.sma50[-1]:.0f}"
                    )
...
if __name__ == "__main__":
    ...
    bt = Backtest(data, MoonDevBreakthrough, cash=1_000_000, commission=0.002)
    stats = bt.run()
