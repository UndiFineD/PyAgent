# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\DeltaSentiment_AI5.py
        ...
        if not self.position:
            ...
            if high_liquidity and spread_narrowing:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"Entry: {current_close:.2f}, Size: {position_size}, SL: {sl_price:.2f}, TP: {tp_price:.2f}"
                    )
