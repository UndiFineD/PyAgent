# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\research\GPT-5\BandReversalEdge_BT.py
import pandas as pd
import talib
...
class BandReversalEdge(Strategy):
    def init(self):
        ...
        self.atr = self.I(
            talib.ATR, self.data.High, self.data.Low, self.close, timeperiod=14
        )
