# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\SimpleTrend_AI5.py
        ...
        if not self.position:
            ...
            if sma20_val > sma50_val and self.sma20[-2] <= self.sma50[-2]:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀🌙 GOLDEN CROSS BUY! Entry: {current_close:.2f}, Size: {position_size}"
                    )
