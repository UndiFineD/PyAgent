# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\backtests_package\InverseMidpoint_PKG.py
# -*- coding: utf-8 -*-
import numpy as np
import pandas as pd
import talib as ta
...
class InverseMidpoint(Strategy):
    ...
    def init(self):
        ...
        self.prev_open = self.I(
            ta.SMA, self.data.Open, timeperiod=1, name="PrevOpen"
        )  # Shifted open
        self.prev_high = self.I(
            ta.SMA, self.data.High, timeperiod=1, name="PrevHigh"
        )  # Shifted high
