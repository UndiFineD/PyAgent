    ...
    def next(self):
        ...
        if not self.position:
            ...
            # Signal 2: Strong bullish momentum in uptrend
                ...
                bullish_trend and strong_momentum_up and rsi_ok_for_long and high_volume
            ):
                long_signal = True
            ...
            if long_signal:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀 {signal_type}: {price:.2f} | SL: {sl_price:.2f} | TP: {tp_price:.2f}"
                    )
            ...
            # Signal 2: Strong bearish momentum in downtrend
                ...
                bearish_trend
                and strong_momentum_down
                and rsi_ok_for_short
                and high_volume
            ):
                short_signal = True
