# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\backtests\LiquidityArbitrage_BT.py
# -*- coding: utf-8 -*-
import pandas as pd
import talib
...
class LiquidityArbitrage(Strategy):
    ...
    def init(self):
        ...
        self.avg_spread = self.I(talib.SMA, self.spread, 20, name="Avg Spread")
        self.avg_volume = self.I(talib.SMA, self.data.Volume, 20, name="Avg Volume")
        self.price_sma = self.I(talib.SMA, self.data.Close, 20, name="Price SMA")
