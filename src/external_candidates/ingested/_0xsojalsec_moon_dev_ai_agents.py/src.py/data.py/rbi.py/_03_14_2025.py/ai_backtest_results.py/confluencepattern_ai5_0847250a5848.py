# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\ConfluencePattern_AI5.py
            ...
            if all(long_conditions):
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🌙📉✨ BEARISH CONFLUENCE! Short {position_size} shares"
                        )
                        print(
                            f"Entry: {entry_price:.2f}, SL: {stop_loss:.2f}, TP: {take_profit:.2f}"
                        )
