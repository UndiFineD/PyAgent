...
class WinningStrategy(Strategy):
    ...
    def next(self):
        ...
        strong_uptrend = (
            sma10_val > sma100_val * 1.05
        )  # SMA10 significantly above SMA100
        ...
        if not self.position:
            ...
            if strong_uptrend and oversold_bounce and volume_confirmation:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀🌙 MAJOR BUY SIGNAL! Entry: {current_close:.2f}, Size: {position_size}"
                    )
                    print(
                        f"RSI: {rsi_val:.1f}, Volume: {current_volume/volume_ma_val:.1f}x"
                    )
            ...
            if (
                ...
                print(
                    f"P&L: {((current_close - self.position.entry_price) / self.position.entry_price * 100):.2f}%"
                )
                self.position.close()
