# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\MoonChampion_AI2.py
import numpy as np
import pandas as pd
...
class MoonChampion(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            if (
                price > sma_short and price > sma_long and sma_short > sma_long * 1.001
            ):  # Ensure uptrend
                ...
                if max_shares > 0:
                    ...
                    print(
                        f"🌙🚀 CHAMPION ENTRY! ALL-IN {max_shares} shares @ {price:.2f}"
                    )
        ...
        # 📉 Conservative Exit: Hold through minor pullbacks
            ...
            if (
                price < sma_long * 0.95  # 5% below long-term trend
                or sma_short < sma_long * 0.98
            ):  # Short MA drops below long MA
