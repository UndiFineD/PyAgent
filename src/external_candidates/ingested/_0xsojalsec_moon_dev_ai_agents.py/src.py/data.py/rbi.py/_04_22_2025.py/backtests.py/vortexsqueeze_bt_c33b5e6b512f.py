# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_22_2025\backtests\VortexSqueeze_BT.py
import numpy as np
import pandas as pd
    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and crossover(self.vi_plus, self.vi_minus)
