# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\7_12_25_sonnet\BandSyncMomentum_strategy_bt.py
import pandas as pd
import talib
...
class BandSyncMomentumStrategy(Strategy):
    def init(self):
        ...
        self.bb_midpoint = self.I(
            lambda u, l: (u + l) / 2, self.upper_bb, self.lower_bb
        )
        ...
        if self.position:
            ...
            if self.position.is_long:
                if (
                    ...
                    or self.bb_midpoint[-1] < self.bb_midpoint[-2]
                ):
