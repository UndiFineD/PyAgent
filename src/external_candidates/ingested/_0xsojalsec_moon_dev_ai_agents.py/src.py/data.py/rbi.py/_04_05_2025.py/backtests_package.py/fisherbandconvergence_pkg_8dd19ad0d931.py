# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_05_2025\backtests_package\FisherBandConvergence_PKG.py
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if fisher_above and cmf_valid and bb_contraction:
                ...
                if position_size > 0:
                    print(
                        f"🌙✨🚀 MOON DEV BUY SIGNAL! Size: {position_size} @ {entry_price:.2f}"
                    )
...
# 🚀 Launch Backtest
bt = Backtest(data, FisherBandConvergence, cash=1_000_000, commission=0.002)
stats = bt.run()
