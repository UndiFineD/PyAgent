# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_06_2025\backtests\VortexFlow_BT.py
import pandas as pd
        ...
        if not self.position:
            if long_cond:
                ...
                if risk > 0:
                    ...
                    print(
                        f"🚀🌕 MOON ROCKET LONG! Size: {size} | Entry: {self.data.Close[-1]:.2f} | SL: {sl_price:.2f}"
                    )
                ...
                if risk > 0:
                    ...
                    print(
                        f"🌑🌗 MOON ECLIPSE SHORT! Size: {size} | Entry: {self.data.Close[-1]:.2f} | SL: {sl_price:.2f}"
                    )
