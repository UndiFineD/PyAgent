# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_18_2025\backtests\VolumetricBreakout_BT.py
...
class VolumetricBreakout(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            if crossover(self.rsi, 70) or self.data.Close[-1] < self.bb_middle[-1]:
