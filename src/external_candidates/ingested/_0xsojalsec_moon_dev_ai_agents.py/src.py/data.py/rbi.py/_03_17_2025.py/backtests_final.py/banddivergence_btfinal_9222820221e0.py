# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_17_2025\backtests_final\BandDivergence_BTFinal.py
# -*- coding: utf-8 -*-
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position and cross_above and bullish_div:
            ...
            if position_size > 0:
                ...
                print(
                    f"Entry: {entry_price:.2f} | SL: {stop_price:.2f} | TP: {take_profit:.2f}"
                )
...
bt = Backtest(data, BandDivergence, cash=1_000_000, commission=0.002)
stats = bt.run()
