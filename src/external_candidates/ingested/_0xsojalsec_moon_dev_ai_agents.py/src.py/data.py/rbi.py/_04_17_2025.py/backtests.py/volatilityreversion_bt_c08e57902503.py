# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_17_2025\backtests\VolatilityReversion_BT.py
...
class VolatilityReversion(Strategy):
    ...
    def init(self):
        ...
        self.hv_10 = self.I(
            talib.STDDEV, self.log_ret, timeperiod=10, nbdev=1, name="HV_10"
        )
        self.hv_10_ma20 = self.I(
            talib.SMA, self.hv_10, timeperiod=20, name="HV_10_MA20"
        )
    ...
    def next(self):
        ...
        # 💸 EXIT TO PRESERVE COSMIC BALANCE
            ...
            self.position.close()
            print(
                f"🌑💸 RSI OVERHEAT: Closing position at {self.data.Close[-1]:.2f} | Profit: {self.position.pl_pct:.2f}% 🌗"
            )


# 🚀 LAUNCH BACKTEST
bt = Backtest(
    data, VolatilityReversion, cash=1_000_000, commission=0.002, exclusive_orders=True
)
