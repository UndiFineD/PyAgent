# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_02_2025\backtests_package\DeltaDonchianBreakout_PKG.py
...
class DeltaDonchianBreakout(Strategy):
    ...
    def init(self):
        ...
        self.donchian_high = self.I(
            talib.MAX, high, timeperiod=20, name="Donchian_Upper"
        )
            ...
            if bearish_break and volume_divergence:
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🌑🚀 BEARISH BREAKOUT! Short {position_size} @ {price:.2f} | SL: {stop_price:.2f}"
                        )
