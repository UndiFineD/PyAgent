# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_02_2025\backtests\VolatilityThreshold_BT.py
import pandas as pd
import talib
...
class VolatilityThreshold(Strategy):
    ...
    def init(self):
        ...
        self.sma200 = self.I(
            talib.SMA, self.data.Close, 19200
