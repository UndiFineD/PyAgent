# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_01_2025\backtests_final\VoltaicAccumulation_BTFinal.py
import pandas as pd
...
class VoltaicAccumulation(Strategy):
    ...
    def next(self):
        ...
        twap_cross = (self.twap[-2] < self.bb_upper[-2]) and (
            self.twap[-1] > self.bb_upper[-1]
        )
