# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\7_12_25_gemini\BandSyncMomentum_strategy_bt.py
import numpy as np
import pandas as pd
import talib
...
if __name__ == "__main__":
    ...
    bt = Backtest(
        data, BandSyncMomentumStrategy, cash=1000000, margin=1, commission=0.001
    )
    stats = bt.run()
    print(stats)
