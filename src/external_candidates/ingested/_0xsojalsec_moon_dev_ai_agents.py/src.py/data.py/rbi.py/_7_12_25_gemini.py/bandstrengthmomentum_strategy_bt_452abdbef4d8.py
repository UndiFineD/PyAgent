# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\7_12_25_gemini\BandStrengthMomentum_strategy_bt.py
import pandas as pd
import talib
...
class BandStrengthMomentumStrategy(Strategy):
    ...
    def next(self):
        ...
        # Short Entry: Fall from upper band with bearish RSI
        ...
        if is_bearish_momentum and was_overbought and is_reversing:
...
if __name__ == "__main__":
    ...
    bt = Backtest(
        data, BandStrengthMomentumStrategy, cash=1000000, margin=1, commission=0.001
    )
    stats = bt.run()
    print(stats)
