# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_15_2025\backtests\YieldCurveReversal_BT.py
...
class YieldCurveReversal(Strategy):
    ...
    def init(self):
        ...
        self.vix_curve = self.I(
            lambda x: x, self.data.df["vix_futures_30d"], name="VIX_CURVE"
        )
        self.treasury_3m = self.I(
            lambda x: x, self.data.df["treasury_3m"], name="TREASURY_3M"
        )
