# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_15_2025\backtests_package\FibroVolatility_PKG.py
                ...
                for level in fib_levels:
                    if abs(current_price - level) < threshold:
                        ...
                        if current_price > level:
                            ...
                            print(
                                f"🌕 MOON SHOT! LONG {position_size} @ {current_price:.2f} ✨"
                            )
                        else:
                            ...
                            print(
                                f"🌒 DARK SIDE ENTERED! SHORT {position_size} @ {current_price:.2f} 🌗"
                            )
                        break
