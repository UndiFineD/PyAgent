# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\BearishBreakout_PKG.py
            ...
            if (
                ...
                if risk_per_unit > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🚀🌒 SHORT ENTRY | Size: {position_size} | Entry: {entry_price:.2f} | SL: {stop_loss:.2f} | TP: {entry_price-2*risk_per_unit:.2f}"
                        )
