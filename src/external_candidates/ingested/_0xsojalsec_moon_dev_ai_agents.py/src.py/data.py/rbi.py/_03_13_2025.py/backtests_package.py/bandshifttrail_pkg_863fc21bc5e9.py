# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\BandShiftTrail_PKG.py
import pandas as pd
import talib
...
class BandShiftTrail(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                self.bbmp[-2] < self.sma[-2] and self.bbmp[-1] > self.sma[-1]
