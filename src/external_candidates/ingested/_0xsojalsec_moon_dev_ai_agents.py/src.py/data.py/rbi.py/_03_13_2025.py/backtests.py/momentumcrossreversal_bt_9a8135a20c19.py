# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests\MomentumCrossReversal_BT.py
...
class MomentumCrossReversal(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            if crossover(ma_diff, ema20_val) and price > ema20_val and ma_diff > 0:
