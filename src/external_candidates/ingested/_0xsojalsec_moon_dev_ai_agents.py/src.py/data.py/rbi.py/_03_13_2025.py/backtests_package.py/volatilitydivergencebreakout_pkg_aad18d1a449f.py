# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\VolatilityDivergenceBreakout_PKG.py
...
class VolatilityDivergenceBreakout(Strategy):
    ...
    def init(self):
        ...
        self.hv = self.I(
            lambda close: ta.hv(close=close, length=20), self.data.Close, name="HV_20"
        )
        self.av = self.I(
            talib.ATR,
            self.data.High,
