# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_08_2025\backtests_package\SqueezeFlowBreakout_PKG.py
...
class SqueezeFlowBreakout(Strategy):
    ...
    def init(self):
        ...
        self.middle_band = self.I(
            talib.BBANDS, self.data.Close, timeperiod=20, nbdevup=2, nbdevdn=2, matype=1
        )
        self.lower_band = self.I(
            talib.BBANDS, self.data.Close, timeperiod=20, nbdevup=2, nbdevdn=2, matype=2
        )
