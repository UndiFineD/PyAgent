# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_20_2025\backtests\VolatilitySurgeBreakout_BT.py
import numpy as np
import pandas as pd
import talib
...
class VolatilitySurgeBreakout(Strategy):
    def init(self):
        self.atr_5m = self.I(
            talib.ATR, self.data.High, self.data.Low, self.data.Close, 14, name="ATR_5m"
        )
