# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_20_2025\backtests\ChannelFlowBreakout_BT.py
import numpy as np
import pandas as pd
import talib
            ...
            if prev_close > prev_upper and prev_cmf > 0 and prev_cmf_2 <= 0:
                ...
                if risk_per_share > 0:
                    ...
                    if size > 0:
                        ...
                        print(
                            f"🌙🚀 MOON DEV LONG! Entry: {entry_price}, Size: {size} | Risk: {risk_per_share:.2f} | 1-2-3 LIFT OFF!"
                        )
            ...
            # Short entry logic
                ...
                if risk_per_share > 0:
                    ...
                    if size > 0:
                        ...
                        print(
                            f"🌙🌌 MOON DEV SHORT! Entry: {entry_price}, Size: {size} | Risk: {risk_per_share:.2f} | TO THE DARK SIDE!"
                        )
