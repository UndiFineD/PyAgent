# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_11_2025\backtests\LiquidationContraction_BT.py
...
class LiquidationContraction(Strategy):
    def init(self):
        ...
        self.liquidation_ma = self.I(
            talib.SMA, self.data.Liquidation, 2880, name="LIQ_30D_MA"
        )
