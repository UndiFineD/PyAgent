# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests_package\DonchianADX_Breakout_PKG.py
import pandas as pd
import talib
            ...
            if self.data.Close[-1] > du and adx > 25 and adx > prev_adx:
                ...
                if risk_per_share > 0:
                    ...
                    if size > 0:
                        ...
                        print(
                            f"🚀🌙 MOON SHOT! LONG ENTRY: {self.data.Close[-1]:.2f} | Size: {size} | SL: {dl:.2f} | TP: {tp:.2f}"
                        )
            ...
            # Short entry logic
                ...
                if risk_per_share > 0:
                    ...
                    if size > 0:
                        ...
                        print(
                            f"📉🌙 CRATER DIVE! SHORT ENTRY: {self.data.Close[-1]:.2f} | Size: {size} | SL: {du:.2f} | TP: {tp:.2f}"
                        )
