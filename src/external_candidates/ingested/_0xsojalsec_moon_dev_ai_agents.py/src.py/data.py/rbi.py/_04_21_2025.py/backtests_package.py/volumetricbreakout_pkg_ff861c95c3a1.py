# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests_package\VolumetricBreakout_PKG.py
import pandas as pd
import talib
        ...
        if not self.position:
            if (
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀🌙 MOON ENTRY! Price: {entry_price}, Size: {position_size}, Cosmic SL: {sl_price}"
                    )
