# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests_final\ChaikinBreakout_BTFinal.py
import pandas as pd
import pandas_ta
import talib
        ...
        if current_close > high_20 and cmf > 0:
            ...
            if risk > 0:
                ...
                if size > 0:
                    ...
                    print(
                        f"🌙🚀 MOON DEV LONG SIGNAL! Entry: {current_close:.2f} | Size: {size} | Risk: {risk:.2f} | TP: {tp:.2f} | SL: {sl:.2f}"
                    )
            ...
            if risk > 0:
                ...
                if size > 0:
                    ...
                    print(
                        f"🌙📉 MOON DEV SHORT SIGNAL! Entry: {current_close:.2f} | Size: {size} | Risk: {risk:.2f} | TP: {tp:.2f} | SL: {sl:.2f}"
                    )


# 🌙✨ MOON DEV DATA LOADING SYSTEM ✨🌙
data = pd.read_csv(
...
# 🌙🚀 MOON DEV BACKTEST ENGINE INITIALIZED 🚀🌙
