# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests_package\ChannelFlipMACD_PKG.py
import pandas as pd
import talib
...
class ChannelFlipMACD(Strategy):
    def init(self):
        ...
        self.macd, _, self.macd_hist = self.I(
