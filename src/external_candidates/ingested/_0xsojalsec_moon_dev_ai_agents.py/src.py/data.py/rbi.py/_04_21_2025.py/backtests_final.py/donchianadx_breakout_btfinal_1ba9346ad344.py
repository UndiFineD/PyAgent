# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests_final\DonchianADX_Breakout_BTFinal.py
import pandas as pd
import talib
...
bt = Backtest(
    data, DonchianADXBreakout, cash=1_000_000, commission=0.002, trade_on_close=True
)
stats = bt.run()
print(stats)
