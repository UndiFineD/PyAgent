# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_16_2025\backtests_final\FlowReversal_BTFinal.py
...
class FlowReversal(Strategy):
    ...
    def init(self):
        ...
        self.cum_delta = self.I(
            lambda: ta.cdv(self.data.Close, self.data.Volume), name="CumulativeDelta"
        )
        ...
        if not self.position:
            ...
            if macd_bullish and delta_bullish:
                ...
                if risk_per_share > 0:
                    ...
                    print(
                        f"🌙✨🚀 BULLISH REVERSAL! Long {size} @ {price:.2f} | SL: {sl:.2f} TP: {tp:.2f}"
                    )
            ...
            # 🧨 Short entry logic
                ...
                if risk_per_share > 0:
                    ...
                    print(
                        f"🌙✨🚀 BEARISH REVERSAL! Short {size} @ {price:.2f} | SL: {sl:.2f} TP: {tp:.2f}"
                    )
        else:
