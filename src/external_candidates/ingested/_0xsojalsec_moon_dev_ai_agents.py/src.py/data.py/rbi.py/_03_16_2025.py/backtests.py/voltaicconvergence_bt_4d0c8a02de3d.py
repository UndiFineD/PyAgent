# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_16_2025\backtests\VoltaicConvergence_BT.py
import pandas as pd
        ...
        if not self.position:
            ...
            if (price >= high_zone) and (atr_val < kst_val):
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🌙✨🚀 MOON DEV ENTRY: {price:.2f} | ATR: {atr_val:.2f} | Size: {position_size} ✨"
                    )
        else:
            # Exit conditions
