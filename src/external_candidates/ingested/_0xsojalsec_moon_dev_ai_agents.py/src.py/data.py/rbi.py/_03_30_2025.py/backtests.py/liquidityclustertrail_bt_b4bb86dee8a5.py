# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_30_2025\backtests\LiquidityClusterTrail_BT.py
import pandas as pd
import talib
                ...
                if price <= self.swing_low[-1] * 1.01:
                    ...
                    if risk_distance > 0:
                        ...
                        if size > 0:
                            ...
                            print(
                                f"Size: {size} | Entry: {price} | SL: {stop_price} 🚀"
                            )
        else:
