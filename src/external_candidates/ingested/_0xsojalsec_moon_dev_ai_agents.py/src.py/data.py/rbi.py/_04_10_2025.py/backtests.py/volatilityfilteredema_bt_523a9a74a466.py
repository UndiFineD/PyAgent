# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_10_2025\backtests\VolatilityFilteredEMA_BT.py
...
class VolatilityFilteredEMA(Strategy):
    ...
    def init(self):
        ...
        print(
            "🌙✨ Moon Dev System Initialized! Tracking EMA Crosses with Volatility Filtering..."
        )
    ...
    def next(self):
        ...
        if not self.position:
            if golden_cross and current_vix < self.vix_entry_threshold:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🌙✨🚀 MOON DEV ALERT: LONG {position_size} @ {price:.2f} | EMA Cross + Calm Markets! 🌤️"
                    )
        ...
        # 🌧️ Exit Logic: Death Cross or Volatility Spike
            ...
            if death_cross or current_vix > self.vix_exit_threshold:
                ...
                print(
                    f"🌙✨🚨 MOON DEV EXIT: Closing @ {price:.2f} | {exit_reason}! 🌩️"
                )
