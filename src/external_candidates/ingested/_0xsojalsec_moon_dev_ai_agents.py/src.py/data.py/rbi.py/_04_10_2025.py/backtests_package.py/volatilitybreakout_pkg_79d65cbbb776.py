# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_10_2025\backtests_package\VolatilityBreakout_PKG.py
import pandas as pd
import talib
...
class VolatilityBreakout(Strategy):
    def init(self):
        ...
        self.donchian_high = self.I(
            talib.MAX, self.data.High, timeperiod=20, name="DONCHIAN_HIGH"
        )
        self.volume_ma50 = self.I(
            talib.SMA, self.data.Volume, timeperiod=50, name="VOLUME_MA50"
        )
        ...
        if not self.position:
            ...
            if volatility_contraction and price_breakout and volume_surge:
                ...
                if position_size > 0:
                    ...
                    print(
                        "✨ Lunar Entry Conditions Met: Volatility Contraction + Breakout + Volume Surge ✨"
                    )
