# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_10_2025\backtests_package\VolmaCross_PKG.py
# -*- coding: utf-8 -*-
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀 LONG ENTRY | Size: {position_size} | Price: {current_close:.2f} | SL: {stop_loss:.2f}"
                    )
        ...
        # 🌙 EXIT CONDITIONS 🌙
            ...
            if (self.rsi[-1] > 70) or (self.bb_width[-1] > 2):
                self.position.close()
                print(
                    f"🛑 EXIT SIGNAL | RSI: {self.rsi[-1]:.2f} | BB Width: {self.bb_width[-1]:.2f}"
                )
...
if __name__ == "__main__":
    ...
    bt = Backtest(data, VolmaCross, cash=1_000_000, exclusive_orders=True)
