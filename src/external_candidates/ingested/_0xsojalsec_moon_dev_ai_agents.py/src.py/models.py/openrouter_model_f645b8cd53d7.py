# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\models\openrouter_model.py
"""
...
class OpenRouterModel(BaseModel):
    ...
    def __init__(
        self, api_key: str, model_name: str = "google/gemini-2.5-flash", **kwargs
    ):
        # Validate API key
