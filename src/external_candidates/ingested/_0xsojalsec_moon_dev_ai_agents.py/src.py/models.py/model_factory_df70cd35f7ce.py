# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\models\model_factory.py
"""
...
from .openrouter_model import (
    OpenRouterModel,  # 🌙 Moon Dev: OpenRouter - access to 200+ models!
)
