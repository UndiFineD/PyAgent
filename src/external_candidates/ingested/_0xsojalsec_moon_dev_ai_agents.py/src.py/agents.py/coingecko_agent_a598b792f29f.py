...
AGENT_TWO_MODEL = (
    MODEL_OVERRIDE if MODEL_OVERRIDE != "0" else "claude-3-sonnet-20240229"
)
TOKEN_EXTRACTOR_MODEL = (
    MODEL_OVERRIDE if MODEL_OVERRIDE != "0" else "claude-3-haiku-20240307"
)
...
class CoinGeckoAPI:
    ...
    def get_price(
        self, ids: Union[str, List[str]], vs_currencies: Union[str, List[str]]
    ) -> Dict:
