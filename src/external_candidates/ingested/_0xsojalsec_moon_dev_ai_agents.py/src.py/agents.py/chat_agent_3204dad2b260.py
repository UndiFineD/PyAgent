...
MAX_777_PER_DAY = int(
    MAX_777_POINTS_PER_DAY / POINTS_PER_777
)  # Auto-calculate max 777s per day
            ...
            try:
                ...
                try:
                    ...
                    for class_name in ["message-sender", "chat-author", "username"]:
                        try:
                            username_elem = latest_msg.find_element(
                    ...
                    for class_name in [
                        ...
                        try:
                            text_elem = latest_msg.find_element(
                                By.CLASS_NAME, class_name
                            )
                            if text_elem:
...
class ChatAgent:
    def __init__(self):
        ...
        self.daily_777_counts = (
            {}
        )  # Format: {username: {'count': int, 'last_reset': datetime}}
