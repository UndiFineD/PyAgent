# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\config.py
"""
...
REALTIME_CLIPS_AI_MODEL = (
    "groq"  # Model type: groq, openai, claude, deepseek, xai, ollama
)
