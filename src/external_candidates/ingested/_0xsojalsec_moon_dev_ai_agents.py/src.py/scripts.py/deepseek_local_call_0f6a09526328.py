# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\scripts\deepseek_local_call.py
"""
...
if __name__ == "__main__":
    ...
    client = OpenAI(api_key="not-needed", base_url=f"http://{LAMBDA_IP}:8000/v1")
