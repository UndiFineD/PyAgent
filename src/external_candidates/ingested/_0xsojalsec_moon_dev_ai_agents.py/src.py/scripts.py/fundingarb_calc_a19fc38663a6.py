...
def print_calculator_results(results):
    ...
    print(
        f"Slippage (decimal)           : {results['slippage_decimal']:.4f} "
        f"({results['slippage_decimal']*100:.2f}%)"
    )
    print(
        f"Fees (decimal)               : {results['fees_decimal']:.4f} "
    ...
    print(
        f"Days to Break Even           : {results['hours_to_break_even']/24:.2f} days"
    )
    print(
    ...
    print(
        f"Hours to achieve desired profit: {results['hours_for_desired_profit']:.2f} hours"
    )
    print(
        f"Days to achieve desired profit : {results['hours_for_desired_profit']/24:.2f} days"
    )
    print("--- END ---\n")
