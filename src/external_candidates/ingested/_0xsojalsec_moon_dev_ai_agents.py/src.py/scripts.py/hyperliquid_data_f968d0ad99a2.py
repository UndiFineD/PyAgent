# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\scripts\hyperliquid_data.py
            ...
            if response.status_code == 200:
                ...
                if snapshot_data:
                    ...
                    if timestamp_offset is None:
                        latest_api_timestamp = datetime.utcfromtimestamp(
...
if not all_data.empty:
    ...
    print(f"📊 Columns: {', '.join(all_data.columns)}")
    print("=" * 80 + "\n")
else:
