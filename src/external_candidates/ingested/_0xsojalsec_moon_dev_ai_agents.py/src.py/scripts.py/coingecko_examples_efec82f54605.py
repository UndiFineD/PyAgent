# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\scripts\coingecko_examples.py
"""
...
class CoinGeckoExamples:
    ...
    def test_coin_tickers(self):
        ...
        if not ENABLED_TESTS["coin_tickers"]:
            return
        params = {"exchange_ids": "binance,coinbase", "include_exchange_logo": True}
    ...
    def test_coin_history(self):
        ...
        if not ENABLED_TESTS["coin_history"]:
            return
        params = {"date": "30-12-2023", "localization": False}
