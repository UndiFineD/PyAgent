# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\scripts\backtest_adx_vwap.py
"""
...
if not hype_files:
    raise FileNotFoundError(
        "No HYPE 1d data files found! Run hyperliquid_data.py first."
    )
