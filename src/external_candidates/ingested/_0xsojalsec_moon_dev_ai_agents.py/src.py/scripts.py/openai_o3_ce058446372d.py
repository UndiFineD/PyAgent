# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\scripts\openai_o3.py
"""
...
def test_o3_mini():
    ...
    if not api_key:
        cprint(
            "❌ No OpenAI API key found! Make sure OPENAI_KEY is set in your .env file",
            "red",
        )
        return
