# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava\train\llava_trainer.py
import datetime
import os
...
class LLaVATrainer(Trainer):
    ...
    def _save_mezo_state(self, output_dir: str):
        ...
        mezo_state = {
            ...
            "trainable_params_sizes": {
                name: param.size() for name, param in self.trainable_params
            },
    ...
    def create_optimizer(self):
        ...
        if self.trainer_mode == "zo":
            ...
            self.optimizer = torch.optim.AdamW(
                [dummy_param], lr=self.args.learning_rate
            )
