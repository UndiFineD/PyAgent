# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava\eval\evaluate_interleave.py
import argparse
import json
import os
import re
...
if __name__ == "__main__":
    ...
    image_choice_dataset_list = [
        "recipeqa-RecipeQA_VisualCloze",
        "RecipeQA_ImageCoherence",
        "COMICS_Panel",
    ]
    E = Eval()
