# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava\model\multimodal_encoder\mlcd_encoder.py
import torch
...
class MLCDVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.vision_tower = MLCDVisionModel.from_pretrained(
