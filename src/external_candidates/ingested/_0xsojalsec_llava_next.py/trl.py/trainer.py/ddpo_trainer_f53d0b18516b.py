# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\trl\trainer\ddpo_trainer.py
...
class DDPOTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        if self.accelerator.is_main_process:
            self.accelerator.init_trackers(
                ...
                config=(
                    dict(ddpo_trainer_config=config.to_dict())
    ...
    def create_model_card(
        self, path: str, model_name: Optional[str] = "TRL DDPO Model"
    ) -> None:
