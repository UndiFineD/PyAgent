# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava-critic-r1\EasyR1\verl\workers\rollout\vllm_rollout_spmd.py
...
class vLLMRollout(BaseRollout):
    def __init__(
        ...
        if (
            ...
            raise ValueError(
                "max_num_batched_tokens should be greater than prompt_length + response_length. {config.prompt_length + config.response_length}"
            )
