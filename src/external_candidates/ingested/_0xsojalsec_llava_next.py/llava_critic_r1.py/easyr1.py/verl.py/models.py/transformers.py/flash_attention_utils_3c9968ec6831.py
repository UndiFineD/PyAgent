# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava-critic-r1\EasyR1\verl\models\transformers\flash_attention_utils.py
    ...
    **kwargs,
    ...
    if _flash_supports_deterministic:
        flash_kwargs["deterministic"] = (
            deterministic if deterministic is not None else _flash_deterministic_enabled
        )
