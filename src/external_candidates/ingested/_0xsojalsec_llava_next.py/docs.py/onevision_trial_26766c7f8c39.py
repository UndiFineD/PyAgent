# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\docs\onevision_trial.py
import copy
import sys
import warnings
...
num_image_tokens = (
    question.count(DEFAULT_IMAGE_TOKEN) * model.get_vision_tower().num_patches
)
