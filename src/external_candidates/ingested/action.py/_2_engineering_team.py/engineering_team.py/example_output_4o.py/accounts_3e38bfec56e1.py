# Extracted from: C:\DEV\PyAgent\.external\action\2_engineering_team\engineering_team\example_output_4o\accounts.py
...
class Account:
    ...
    def sell_shares(
        self, symbol: str, quantity: int, get_share_price: callable
    ) -> bool:
        """
