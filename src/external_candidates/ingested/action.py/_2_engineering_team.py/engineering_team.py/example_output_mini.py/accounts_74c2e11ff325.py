# Extracted from: C:\DEV\PyAgent\.external\action\2_engineering_team\engineering_team\example_output_mini\accounts.py
# accounts.py
...
class Account:
    ...
    def sell_shares(self, symbol: str, quantity: int) -> None:
        ...
        self.transactions.append(
            f"Sold: {quantity} shares of {symbol} at ${share_price:.2f} each"
        )
