# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\CosyVoice\cosyvoice\cli\cosyvoice.py
...
class CosyVoice:
    def __init__(
        self, model_dir, load_jit=True, load_onnx=False, fp16=True, device="cuda"
    ):
        ...
        self.model = CosyVoiceModel(
            configs["llm"], configs["flow"], configs["hift"], fp16, device
        )
        self.model.load(
