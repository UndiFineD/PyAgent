# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\CosyVoice\examples\magicdata-read\cosyvoice\tools\extract_speech_token.py
#!/usr/bin/env python3
...
def single_job(utt):
    ...
    if sample_rate != 16000:
        audio = torchaudio.transforms.Resample(orig_freq=sample_rate, new_freq=16000)(
            audio
        )
