# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\dashboard.py
"""
                                    ...
                                    if agent_state:
                                        ...
                                        if agent_state.action_count > last_action_count:
                                            ...
                                            if task.name in state.task_history:
                                                ...
                                                task_info["last_agent_action_count"] = (
                                                    agent_state.action_count
                                                )
                                                task_info["last_search_count"] = (
                                                    agent_state.search_count
                                                )
                                                task_info["last_think_count"] = (
                                                    agent_state.think_count
                                                )
                                                task_info["last_summary_count"] = (
                                                    agent_state.summary_count
                                                )
                                                task_info["last_checkpoint_count"] = (
                                                    agent_state.checkpoint_count
                                                )
                except Exception:
