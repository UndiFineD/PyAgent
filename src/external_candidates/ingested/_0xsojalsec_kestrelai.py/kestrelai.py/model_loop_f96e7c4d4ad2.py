# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\model_loop.py
"""
...
try:
    ...
    from KestrelAI.shared.models import Subtask as SharedSubtask
    from KestrelAI.shared.models import (
        Task,
        TaskMetrics,
        TaskStatus,
...
class KestrelAgentWorker:
    ...
    def __init__(self):
        ...
        self.task_reports: dict[str, list[str]] = (
            {}
