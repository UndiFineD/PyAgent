# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\examples\mcp_research_example.py
#!/usr/bin/env python3
"""
...
async def main():
    ...
    async with mcp_manager:
        ...
        if mcp_initialized:
            ...
            print(
                f"Connected servers: {health_status['connected_servers']}/{health_status['total_servers']}"
            )
            ...
            orchestrator = ResearchOrchestrator(
                [task], llm, profile="kestrel", mcp_manager=mcp_manager, use_mcp=True
            )
