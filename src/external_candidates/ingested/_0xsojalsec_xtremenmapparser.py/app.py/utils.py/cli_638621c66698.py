# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-XtremeNmapParser\app\utils\cli.py
import argparse
import sys
...
parser.add_argument(
    "-oN", "--outputname", help="Output file name.", nargs="?", type=str
)
parser.add_argument("-v", "--verbose", help="Verbose", action="store_true")
parser.add_argument(
    "-M", "--merger", help="Merge XML files from directory", action="store_true"
)
parser.add_argument(
    "-R",
    "--recursive",
