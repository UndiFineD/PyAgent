# Extracted from: C:\DEV\PyAgent\.external\LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\indexing\chunker.py
"""
    ...
    def chunk_text(self, text: str, file_path: str = "") -> List[TextChunk]:
        ...
        try:
            ...
            for chunk_text in text_chunks:
                ...
                search_start = chunk_start + max(
                    1, len(chunk_text) - self.chunk_overlap
                )
