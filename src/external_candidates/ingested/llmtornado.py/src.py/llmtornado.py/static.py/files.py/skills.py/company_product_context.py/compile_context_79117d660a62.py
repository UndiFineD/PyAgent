    ...
    context = {
        "metadata": {
            ...
            "sources": {
                ...
                "analysis_files": [
                    k for k in json_data.keys() if "_extracted" not in k
                ],
...
"""
    ...
    if technologies:
        ...
        report += (
            "*Technology information to be populated from technical documentation.*\n"
        )
...
def main():
    ...
    print(
        f"✓ Sources processed: {len(context['metadata']['sources']['pdf_documents'])}"
    )
    print("\n💡 Next steps:")
