# Extracted from: C:\DEV\PyAgent\.external\LLMTornado\src\LlmTornado.Tests\Static\Files\Skills\company-product-context\extract_pdfs.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    if extracted_data:
        ...
        print(
            f"  • Technologies mentioned: {len(analysis['entities']['technologies'])}"
        )
