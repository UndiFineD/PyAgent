# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Jobs_Applier_AI_Agent_AIHawk\src\libs\resume_and_cover_builder\cover_letter_prompt\strings_feder-cr.py
