...
def main():
    parser = argparse.ArgumentParser(
        description="Apply patches and removals to task files"
    )
    parser.add_argument(
        "--input",
    ...
    parser.add_argument(
        "--patches", default="patches.json", help="Patches file (default: patches.json)"
    )
    parser.add_argument(
        "--removals-output", help="Optional: Output file for removed task IDs"
    )
    ...
    print(
        f"Loaded {len(update_patches)} update patches and {len(removal_ids)} removals"
    )
