# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\examples\fabric\dcgan\train_fabric.py
"""
...
def main():
    ...
    for epoch in range(num_epochs):
        for i, data in enumerate(dataloader, 0):
            ...
            b_size = real.size(0)
            label = torch.full(
                (b_size,), real_label, dtype=torch.float, device=fabric.device
            )
