# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\examples\pytorch\domain_templates\reinforce_learn_ppo.py
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lr_actor", type=float, default=3e-4, help="learning rate of actor network"
    )
    parser.add_argument(
        "--lr_critic", type=float, default=1e-3, help="learning rate of critic network"
    )
    parser.add_argument(
        "--max_episode_len",
        type=int,
    ...
    parser.add_argument(
        "--batch_size", type=int, default=512, help="batch_size when training network"
    )
    parser.add_argument(
        "--steps_per_epoch",
        type=int,
