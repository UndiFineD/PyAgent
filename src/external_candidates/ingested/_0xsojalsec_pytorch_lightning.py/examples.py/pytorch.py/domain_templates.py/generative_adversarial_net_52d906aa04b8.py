# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\examples\pytorch\domain_templates\generative_adversarial_net.py
...
class GAN(LightningModule):
    ...
    def __init__(
        ...
        self.generator = Generator(
            latent_dim=self.hparams.latent_dim, img_shape=img_shape
        )
