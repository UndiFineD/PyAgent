# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\examples\pytorch\basics\autoencoder.py
...
class LitAutoEncoder(LightningModule):
    ...
    def __init__(self, hidden_dim: int = 64, learning_rate=10e-3):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(28 * 28, hidden_dim), nn.ReLU(), nn.Linear(hidden_dim, 3)
        )
        self.decoder = nn.Sequential(
            nn.Linear(3, hidden_dim), nn.ReLU(), nn.Linear(hidden_dim, 28 * 28)
        )
