# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\examples\pytorch\fp8_distributed_transformer\train.py
...
class LanguageModel(L.LightningModule):
    ...
    def configure_model(self):
        ...
        convert_to_float8_training(
            model, config=float8_config, module_filter_fn=module_filter_fn
        )
