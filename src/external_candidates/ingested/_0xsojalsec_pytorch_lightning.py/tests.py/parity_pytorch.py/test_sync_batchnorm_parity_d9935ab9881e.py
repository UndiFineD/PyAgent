# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\parity_pytorch\test_sync_batchnorm_parity.py
...
def test_sync_batchnorm_parity(tmpdir):
    ...
    bn_outputs_multi_device = trainer.strategy.all_gather(
        bn_outputs
    ).cpu()  # 2 x 2 x 4 x 1
    ...
    if trainer.global_rank == 0:
        ...
        bn_outputs_single_device = _train_single_process_sync_batchnorm(
