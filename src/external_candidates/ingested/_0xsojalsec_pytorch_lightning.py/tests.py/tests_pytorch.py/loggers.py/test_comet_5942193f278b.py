# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\loggers\test_comet.py
...
def test_comet_logger_experiment_name(comet_mock):
    ...
    assert (
        call(experiment_name=experiment_name)
        not in comet_mock.ExperimentConfig.call_args_list
    )
