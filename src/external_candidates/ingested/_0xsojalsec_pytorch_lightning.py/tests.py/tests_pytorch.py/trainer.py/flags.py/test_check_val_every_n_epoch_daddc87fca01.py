# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\flags\test_check_val_every_n_epoch.py
...
def test_check_val_every_n_epoch(
    tmp_path, max_epochs, expected_val_loop_calls, expected_val_batches
):
