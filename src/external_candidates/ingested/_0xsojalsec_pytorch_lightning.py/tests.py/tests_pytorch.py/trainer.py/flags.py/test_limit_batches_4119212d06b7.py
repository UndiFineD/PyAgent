# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\flags\test_limit_batches.py
...
def test_eval_limit_batches(mode, limit_batches):
    ...
    expected_batches = (
        int(limit_batches * len(eval_loader))
