# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\flags\test_inference_mode.py
...
def test_eval_inference_mode(tmp_path, trainer_fn):
    ...
    trainer = Trainer(
        default_root_dir=tmp_path, logger=False, inference_mode=False, fast_dev_run=True
    )
