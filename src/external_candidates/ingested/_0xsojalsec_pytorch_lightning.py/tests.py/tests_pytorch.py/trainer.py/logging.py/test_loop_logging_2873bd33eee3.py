# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\logging_\test_loop_logging.py
...
def test_default_level_for_hooks_that_support_logging():
    ...
    with mock.patch(
        "lightning.pytorch.trainer.connectors.logger_connector.result._ResultCollection.log",
        return_value=None,
    ) as result_mock:
