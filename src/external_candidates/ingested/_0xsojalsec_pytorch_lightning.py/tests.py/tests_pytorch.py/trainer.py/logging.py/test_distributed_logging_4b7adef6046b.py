# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\logging_\test_distributed_logging.py
...
class TestModel(BoringModel):
    ...
    def on_train_end(self):
        assert (
            self.log_name.format(rank=self.local_rank) in self.logger.logs
        ), "Expected rank to be logged"
