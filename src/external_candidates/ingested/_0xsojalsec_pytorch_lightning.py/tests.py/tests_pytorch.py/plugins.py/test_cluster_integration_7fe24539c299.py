# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\plugins\test_cluster_integration.py
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            {"strategy": "ddp", "accelerator": "gpu", "devices": [1, 2]},
            marks=RunIf(mps=False),
        ),
        pytest.param(
            {"strategy": "ddp_spawn", "accelerator": "gpu", "devices": [1, 2]},
            marks=RunIf(mps=False),
        ),
    ],
)
