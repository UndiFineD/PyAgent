# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\plugins\test_async_checkpoint.py
import time
...
class _CaptureCheckpointIO(CheckpointIO):
    ...
    def load_checkpoint(
        self, path: str, map_location: Optional[Any] = None
    ) -> dict[str, Any]:
