# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\callbacks\test_lambda_function.py
        ...
        def on_train_epoch_start(self):
            if self.current_epoch > 1:
                raise CustomException(
                    "Custom exception to trigger `on_exception` hooks"
                )
