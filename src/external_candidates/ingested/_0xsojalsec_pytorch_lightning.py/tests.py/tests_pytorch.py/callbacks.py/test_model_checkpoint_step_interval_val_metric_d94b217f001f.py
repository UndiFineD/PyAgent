# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\callbacks\test_model_checkpoint_step_interval_val_metric.py
import math
...
def test_model_checkpoint_every_n_train_steps_with_val_metric_saves_after_val(
    tmp_path, val_scores
):
