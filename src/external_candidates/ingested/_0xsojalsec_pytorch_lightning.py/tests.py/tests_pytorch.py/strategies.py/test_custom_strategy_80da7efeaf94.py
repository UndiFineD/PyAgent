# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\strategies\test_custom_strategy.py
...
def test_strategy_lightning_restore_optimizer_and_schedulers(
    tmp_path, restore_optimizer_and_schedulers
):
