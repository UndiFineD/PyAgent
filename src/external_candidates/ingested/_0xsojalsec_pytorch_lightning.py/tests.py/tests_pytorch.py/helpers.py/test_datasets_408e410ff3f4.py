# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\helpers\test_datasets.py
...
def test_mnist(tmp_path):
    ...
    assert torch.bincount(dataset.targets).tolist() == [
        5923,
        6742,
        5958,
        6131,
