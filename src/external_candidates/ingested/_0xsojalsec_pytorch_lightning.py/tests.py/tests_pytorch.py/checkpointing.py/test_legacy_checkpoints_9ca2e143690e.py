# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\checkpointing\test_legacy_checkpoints.py
...
def test_load_legacy_checkpoints(tmp_path, pl_version: str):
    ...
    with patch("sys.path", [PATH_LEGACY] + sys.path):
        ...
        model = ClassificationModel.load_from_checkpoint(
            path_ckpt, num_features=24, weights_only=weights_only
        )
