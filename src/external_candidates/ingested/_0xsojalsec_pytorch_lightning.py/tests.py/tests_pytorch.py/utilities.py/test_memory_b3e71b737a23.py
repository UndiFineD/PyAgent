# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\utilities\test_memory.py
...
def test_recursive_detach():
    ...
    x = {
        "foo": torch.tensor(0, device=device),
        "bar": {"baz": torch.tensor(1.0, device=device, requires_grad=True)},
    }
