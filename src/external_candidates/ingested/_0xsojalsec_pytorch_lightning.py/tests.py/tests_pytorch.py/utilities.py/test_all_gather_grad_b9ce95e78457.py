# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\utilities\test_all_gather_grad.py
...
def test_all_gather_collection(tmp_path):
    class TestModel(BoringModel):
        ...
        def on_train_epoch_end(self):
            ...
            assert torch.stack(gathered_loss["losses_tensor_list"]).shape == (
                2,
                2,
                2,
                2,
