# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\utilities\test_parameter_tying.py
...
@pytest.mark.parametrize(
    ...
    [
        (BoringModel, []),
        (ParameterSharingModule, [["layer_1.weight", "layer_3.weight"]]),
    ],
)
