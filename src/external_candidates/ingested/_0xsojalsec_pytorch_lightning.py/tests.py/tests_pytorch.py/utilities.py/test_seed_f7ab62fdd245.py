# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\utilities\test_seed.py
import random
...
@pytest.mark.parametrize(
    "with_torch_cuda", [False, pytest.param(True, marks=RunIf(min_cuda_gpus=1))]
)
