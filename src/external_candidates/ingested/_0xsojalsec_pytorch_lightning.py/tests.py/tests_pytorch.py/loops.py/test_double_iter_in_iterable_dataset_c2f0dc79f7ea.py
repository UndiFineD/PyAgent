# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\loops\test_double_iter_in_iterable_dataset.py
...
@pytest.mark.skipif(
    sys.platform == "darwin", reason="Skip on macOS due to multiprocessing issues"
)
