# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\loops\test_training_loop_flow_dict.py
...
def test__training_step__epoch_end__flow_dict(tmp_path):
    ...
    class TestModel(DeterministicModel):
        def training_step(self, batch, batch_idx):
            ...
            return {
                "loss": acc,
                "random_things": [1, "a", torch.tensor(2)],
                "batch_idx": batch_idx,
            }
