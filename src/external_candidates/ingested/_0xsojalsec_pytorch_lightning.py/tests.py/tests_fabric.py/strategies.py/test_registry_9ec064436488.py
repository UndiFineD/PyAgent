# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\strategies\test_registry.py
...
def test_strategy_registry_with_new_strategy():
    ...
    assert STRATEGY_REGISTRY[strategy_name]["init_params"] == {
        "param1": "abc",
        "param2": 123,
    }
