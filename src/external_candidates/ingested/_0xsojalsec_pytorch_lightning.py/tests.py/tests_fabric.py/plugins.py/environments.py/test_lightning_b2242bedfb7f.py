# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\plugins\environments\test_lightning.py
...
@pytest.mark.parametrize(
    ("environ", "creates_processes_externally"),
    [({}, False), ({"LOCAL_RANK": "2"}, True), ({"NODE_RANK": "1"}, False)],
)
