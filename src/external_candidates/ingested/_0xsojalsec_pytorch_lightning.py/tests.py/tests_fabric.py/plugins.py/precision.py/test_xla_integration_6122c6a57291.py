# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\plugins\precision\test_xla_integration.py
...
@pytest.mark.parametrize(
    ...
    [("16-true", torch.float16), ("bf16-true", torch.bfloat16)],
)
