# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\plugins\precision\test_double_integration.py
...
class BoringDoubleModule(nn.Module):
    def __init__(self):
        ...
        self.register_buffer(
            "complex_buffer", torch.complex(torch.rand(10), torch.rand(10)), False
        )
