# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\utilities\test_device_dtype_mixin.py
import pytest
import torch
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "mps:0", torch.float, marks=RunIf(mps=True)
        ),  # double and half are not yet supported.
    ],
)
