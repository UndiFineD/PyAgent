# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\utilities\test_seed.py
import os
import random
import warnings
...
@mock.patch(
    "lightning.fabric.utilities.seed.torch.cuda.is_available", Mock(return_value=False)
)
...
def test_collect_rng_states_if_cuda_init_fails(get_rng_state_all_mock):
    ...
    get_rng_state_all_mock.side_effect = RuntimeError(
