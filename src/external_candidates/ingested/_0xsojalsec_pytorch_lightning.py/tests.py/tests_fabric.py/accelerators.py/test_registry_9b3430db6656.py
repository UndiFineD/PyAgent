...
def test_accelerator_registry_with_new_accelerator():
    ...
    assert (
        ACCELERATOR_REGISTRY[accelerator_name]["description"] == accelerator_description
    )
    ...
    assert (
        ACCELERATOR_REGISTRY[accelerator_name]["accelerator_name"] == accelerator_name
    )
...
def test_registry_as_decorator():
    ...
    assert (
        test_registry["test_decorator"]["description"] == "Test decorator accelerator"
    )
...
def test_registry_as_static_method():
    ...
    assert (
        test_registry["test_static"]["description"] == "Test static method accelerator"
    )
...
def test_registry_without_parameters():
    ...
    test_registry.register(
        "simple", SimpleAccelerator, description="Simple accelerator"
    )
