# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\accelerators\__init__.py
...
_register_classes(
    ACCELERATOR_REGISTRY, "register_accelerators", sys.modules[__name__], Accelerator
)
