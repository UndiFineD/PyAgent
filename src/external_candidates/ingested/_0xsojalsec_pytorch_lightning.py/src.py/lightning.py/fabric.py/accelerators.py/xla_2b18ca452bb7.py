# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\accelerators\xla.py
...
class XLAAccelerator(Accelerator):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from pytorch_lightning_enterprise.accelerators.xla import (
            XLAAccelerator as EnterpriseXLAAccelerator,
        )
