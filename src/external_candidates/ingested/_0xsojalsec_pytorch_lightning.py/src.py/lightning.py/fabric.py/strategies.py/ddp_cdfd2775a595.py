# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\strategies\ddp.py
...
class DDPStrategy(ParallelStrategy):
    ...
    def setup_module(self, module: Module) -> DistributedDataParallel:
        ...
        with ctx:
            return DistributedDataParallel(
                module=module, device_ids=device_ids, **self._ddp_kwargs
            )
    ...
    def load_module_state_dict(
        ...
        if isinstance(module, DistributedDataParallel):
            module = module.module
        super().load_module_state_dict(
            module=module, state_dict=state_dict, strict=strict
        )
