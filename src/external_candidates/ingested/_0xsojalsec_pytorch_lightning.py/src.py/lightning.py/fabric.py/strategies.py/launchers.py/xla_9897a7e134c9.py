# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\strategies\launchers\xla.py
...
class _XLALauncher(_Launcher):
    ...
    def __init__(self, strategy: Union["XLAStrategy", "XLAFSDPStrategy"]) -> None:
        ...
        from pytorch_lightning_enterprise.strategies.xla.launcher import (
            XLALauncherFabric as EnterpriseXLALauncher,
        )
