# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\strategies\deepspeed.py
...
class DeepSpeedStrategy(DDPStrategy, _Sharded):
    ...
    def load_checkpoint(
        ...
        """
        return self.deepspeed_impl.load_checkpoint(
            path=path, state=state, strict=strict
        )
    ...
    def clip_gradients_value(
        ...
        return self.deepspeed_impl.clip_gradients_value(
