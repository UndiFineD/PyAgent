# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\plugins\precision\bitsandbytes.py
...
class BitsandbytesPrecision(Precision):
    ...
    def __init__(
        ...
        self.bitsandbytes_impl = EnterpriseBitsandbytesPrecision(
            mode=mode, dtype=dtype, ignore_modules=ignore_modules
        )
