# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\utilities\spike.py
import json
import os
import warnings
...
class SpikeDetection:
    ...
    def on_train_batch_end(
        self, fabric: "Fabric", loss: torch.Tensor, batch: Any, batch_idx: int
    ) -> None:
    ...
    def _check_atol(
        self, val_a: Union[float, torch.Tensor], val_b: Union[float, torch.Tensor]
    ) -> bool:
