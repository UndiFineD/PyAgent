# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\utilities\seed.py
import logging
import os
import random
    ...
    if seed is None:
        ...
        if env_seed is None:
            ...
            try:
                ...
                raise ValueError(
                    f"Invalid seed specified via PL_GLOBAL_SEED: {repr(env_seed)}"
                )
