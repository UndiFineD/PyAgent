...
class _AcceleratorConnector:
    ...
    def _check_config_and_set_final_flags(
        ...
        if plugins:
            ...
            if (
                ...
                and precision_flag is not None
            ):
                raise ValueError(
    ...
    def _check_strategy_and_fallback(self) -> None:
        ...
        if (
            ...
            or type(self._strategy_flag) is FSDPStrategy
        ) and not (
            self._accelerator_flag in ("cuda", "gpu")
            or isinstance(self._accelerator_flag, CUDAAccelerator)
        ):
            raise ValueError(
    ...
    def _validate_precision_choice(self) -> None:
        ...
        if isinstance(
            self._precision_plugin_flag, BitsandbytesPrecision
