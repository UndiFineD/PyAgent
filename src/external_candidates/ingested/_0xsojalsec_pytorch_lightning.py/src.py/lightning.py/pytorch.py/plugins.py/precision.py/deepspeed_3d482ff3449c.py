# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\plugins\precision\deepspeed.py
...
import torch
from lightning.fabric.plugins.precision.deepspeed import (
    _PRECISION_INPUT,
...
class DeepSpeedPrecision(Precision):
    ...
    def __init__(self, precision: _PRECISION_INPUT) -> None:
        ...
        self.deepspeed_precision_impl = EnterpriseDeepSpeedPrecision(
            outer_object=self, precision=precision
        )
    ...
    def backward(  # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        """
        return self.deepspeed_precision_impl.backward(
            tensor=tensor, model=model, optimizer=optimizer, *args, **kwargs
        )
    ...
    def optimizer_step(  # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        return self.deepspeed_precision_impl.optimizer_step(
            optimizer=optimizer, model=model, closure=closure, **kwargs
        )
