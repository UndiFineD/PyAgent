# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\plugins\precision\xla.py
...
import torch
from lightning.fabric.plugins.precision.xla import (
    _PRECISION_INPUT,
...
class XLAPrecision(Precision):
    ...
    def __init__(self, precision: _PRECISION_INPUT = "32-true") -> None:
        ...
        from pytorch_lightning_enterprise.plugins.precision.xla import (
            XLAPrecision as EnterpriseXLAPrecision,
        )
