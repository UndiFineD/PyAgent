# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\loops\optimization\manual.py
...
class ManualResult(OutputResult):
    ...
    def from_training_step_output(
        cls, training_step_output: STEP_OUTPUT
    ) -> "ManualResult":
        extra = {}
