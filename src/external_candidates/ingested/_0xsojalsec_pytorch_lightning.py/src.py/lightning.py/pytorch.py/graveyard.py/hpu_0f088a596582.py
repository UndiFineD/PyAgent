...
class HPUAccelerator:
    ...
    def __init__(self, *_: Any, **__: Any) -> None:
        raise NotImplementedError(
            "The `HPUAccelerator` class has been removed. Please contact developer@lightning.ai"
        )
...
class HPUCheckpointIO:
    def __init__(self, *_: Any, **__: Any) -> None:
        raise NotImplementedError(
            "The `HPUCheckpointIO` class has been removed. Please contact developer@lightning.ai"
        )
