# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\loggers\neptune.py
    ...
    **Details about Neptune run structure**
    ...
    def __init__(
        ...
        **neptune_run_kwargs: Any,
        ...
        super().__init__()
        from pytorch_lightning_enterprise.loggers.neptune import (
            NeptuneLogger as EnterpriseNeptuneLogger,
        )
