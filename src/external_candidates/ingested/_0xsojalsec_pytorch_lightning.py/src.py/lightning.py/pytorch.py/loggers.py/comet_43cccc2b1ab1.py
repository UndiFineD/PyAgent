# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\loggers\comet.py
    ...
    **Access the Comet Experiment object:**
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from pytorch_lightning_enterprise.loggers.comet import (
            CometLogger as EnterpriseCometLogger,
        )
    ...
    @rank_zero_only
    def log_metrics(
        self, metrics: Mapping[str, Union[Tensor, float]], step: Optional[int] = None
    ) -> None:
