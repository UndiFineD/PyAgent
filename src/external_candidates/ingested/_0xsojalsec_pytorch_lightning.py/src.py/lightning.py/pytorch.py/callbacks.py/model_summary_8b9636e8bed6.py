# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\callbacks\model_summary.py
...
class ModelSummary(Callback):
    ...
    def on_fit_start(
        ...
        total_flops = (
            model_summary.total_flops if hasattr(model_summary, "total_flops") else 0
        )
    ...
    def _summary(
        self, trainer: "pl.Trainer", pl_module: "pl.LightningModule"
    ) -> Union[DeepSpeedSummary, Summary]:
