# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\callbacks\__init__.py
...
from lightning.pytorch.callbacks.weight_averaging import (
    EMAWeightAveraging,
    WeightAveraging,
)
