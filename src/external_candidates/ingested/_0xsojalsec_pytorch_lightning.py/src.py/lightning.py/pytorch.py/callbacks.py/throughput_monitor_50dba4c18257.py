# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\callbacks\throughput_monitor.py
...
class ThroughputMonitor(Callback):
    ...
    def _start(self, trainer: "Trainer") -> None:
        ...
        reset_needed = (
            trainer.state.fn == TrainerFn.FITTING or stage not in self._samples
        )
