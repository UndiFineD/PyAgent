    ...
    class CustomTimeColumn(ProgressColumn):
        ...
        def render(self, task: "Task") -> Text:
            ...
            remaining_delta = (
                ...
                else str(timedelta(seconds=int(remaining)))
            )
        ...
        def render(self, task: "Task") -> Text:
            ...
            if self._trainer.training and task.id not in self._tasks:
                ...
                if (
                    ...
                    and self._current_task_id in self._renderable_cache
                ):
...
class RichProgressBar(ProgressBar):
    ...
    def on_sanity_check_end(
        ...
        if self.progress is not None and self.val_sanity_progress_bar_id is not None:
            self.progress.update(
                self.val_sanity_progress_bar_id, advance=0, visible=False
            )
        self.refresh()
    ...
    def _update(
        ...
        if (
            ...
            and self.is_enabled
            and progress_bar_id is not None
        ):
