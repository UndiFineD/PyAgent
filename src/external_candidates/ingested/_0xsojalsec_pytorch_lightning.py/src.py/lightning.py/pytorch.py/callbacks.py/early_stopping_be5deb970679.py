# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\callbacks\early_stopping.py
...
class EarlyStopping(Callback):
    ...
    def load_state_dict(self, state_dict: dict[str, Any]) -> None:
        ...
        stopping_reason_value = state_dict.get(
            "stopping_reason", EarlyStoppingReason.NOT_STOPPED.value
        )
