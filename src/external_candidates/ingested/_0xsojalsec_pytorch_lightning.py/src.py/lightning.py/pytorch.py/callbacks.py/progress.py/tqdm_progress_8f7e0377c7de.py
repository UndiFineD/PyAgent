...
class TQDMProgressBar(ProgressBar):
    ...
    def __getstate__(self) -> dict:
        ...
        return {
            k: v if not isinstance(v, _tqdm) else None for k, v in vars(self).items()
        }
    ...
    def on_train_batch_end(
        ...
        n = batch_idx + 1
        if self.train_progress_bar is not None and self._should_update(
            n, self.train_progress_bar.total
        ):
    ...
    def on_validation_batch_start(
        ...
        desc = (
            ...
            else self.validation_description
        )
    ...
    def on_validation_batch_end(
        ...
        n = batch_idx + 1
        if self.val_progress_bar is not None and self._should_update(
            n, self.val_progress_bar.total
        ):
    ...
    def on_test_batch_start(
        ...
        self.test_progress_bar.set_description(
            f"{self.test_description} DataLoader {dataloader_idx}"
        )
    ...
    def on_test_batch_end(
        ...
        n = batch_idx + 1
        if self.test_progress_bar is not None and self._should_update(
            n, self.test_progress_bar.total
        ):
    ...
    def on_predict_batch_start(
        ...
        self.predict_progress_bar.set_description(
            f"{self.predict_description} DataLoader {dataloader_idx}"
        )
    ...
    def on_predict_batch_end(
        ...
        n = batch_idx + 1
        if self.predict_progress_bar is not None and self._should_update(
            n, self.predict_progress_bar.total
        ):
