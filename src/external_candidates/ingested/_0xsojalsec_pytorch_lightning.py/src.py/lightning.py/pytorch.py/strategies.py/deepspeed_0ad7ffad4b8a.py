# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\strategies\deepspeed.py
...
class DeepSpeedStrategy(DDPStrategy):
    ...
    def _setup_model_and_optimizers(
        ...
        """
        return self.deepspeed_strategy_impl._setup_model_and_optimizers(
    ...
    @override
    def save_checkpoint(
        self, checkpoint: dict, filepath: _PATH, storage_options: Optional[Any] = None
    ) -> None:
    ...
    @override
    def load_checkpoint(
        self, checkpoint_path: _PATH, weights_only: Optional[bool] = None
    ) -> dict[str, Any]:
        return self.deepspeed_strategy_impl.load_checkpoint(
    ...
    def load_model_state_dict(
        ...
        return self.deepspeed_strategy_impl.load_model_state_dict(
            checkpoint=checkpoint, strict=strict
        )

    @override
    def load_optimizer_state_dict(self, checkpoint: Mapping[str, Any]) -> None:
        return self.deepspeed_strategy_impl.load_optimizer_state_dict(
    ...
    def register_strategies(cls, strategy_registry: _StrategyRegistry) -> None:
        strategy_registry.register(
            "deepspeed", cls, description="Default DeepSpeed Strategy"
        )
        strategy_registry.register(
            "deepspeed_stage_1",
            cls,
        ...
        strategy_registry.register(
            "deepspeed_stage_3", cls, description="DeepSpeed ZeRO Stage 3", stage=3
        )
        strategy_registry.register(
