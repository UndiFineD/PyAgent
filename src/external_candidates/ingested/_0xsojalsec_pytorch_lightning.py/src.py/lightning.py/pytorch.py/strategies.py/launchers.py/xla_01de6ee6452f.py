# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\strategies\launchers\xla.py
...
class _XLALauncher(_MultiProcessingLauncher):
    ...
    def __init__(self, strategy: "pl.strategies.XLAStrategy") -> None:
        ...
        from pytorch_lightning_enterprise.strategies.xla.launcher import (
            _XLALauncherTrainer as EnterpriseXLALauncher,
        )
