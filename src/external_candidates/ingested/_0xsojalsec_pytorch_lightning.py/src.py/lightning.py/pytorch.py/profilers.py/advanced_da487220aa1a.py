# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\profilers\advanced.py
...
class AdvancedProfiler(Profiler):
    ...
    def __init__(
        ...
        self.profiled_actions: dict[str, cProfile.Profile] = defaultdict(
            cProfile.Profile
        )
    ...
    def _dump_stats(self, action_name: str, profile: cProfile.Profile) -> None:
        ...
        dst_filepath = os.path.join(
            self.dirpath,
            self._prepare_filename(action_name=action_name, extension=".prof"),
        )
