# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\utilities\testing\_runif.py
...
from lightning.pytorch.core.module import (
    _ONNX_AVAILABLE,
    _ONNXSCRIPT_AVAILABLE,
    _TORCH_TRT_AVAILABLE,
)
