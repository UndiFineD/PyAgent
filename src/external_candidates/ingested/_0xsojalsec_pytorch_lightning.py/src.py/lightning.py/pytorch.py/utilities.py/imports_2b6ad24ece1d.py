# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\utilities\imports.py
...
_PYTHON_GREATER_EQUAL_3_11_0 = (sys.version_info.major, sys.version_info.minor) >= (
    3,
    11,
)
...
_TORCHMETRICS_GREATER_EQUAL_0_11 = RequirementCache(
    "torchmetrics>=0.11.0"
...
def _try_import_module(module_name: str) -> bool:
    ...
    # Also on AttributeError for failed imports like pl.LightningModule
        ...
        rank_zero_warn(
            f"Import of {module_name} package failed for some compatibility issues:\n{err}"
        )
        return False
