# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\utilities\types.py
...
OptimizerLRScheduler = Optional[
    Union[
        ...
        tuple[
            Sequence[Optimizer],
            Sequence[Union[LRSchedulerTypeUnion, LRSchedulerConfig]],
        ],
        OptimizerConfig,
