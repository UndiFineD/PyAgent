# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\PC-Agent\run.py
import argparse
import ast
import concurrent
import copy
...
parser.add_argument(
    "--font_path",
    type=str,
    default="/System/Library/Fonts/Supplemental/Times New Roman.ttf",
)
parser.add_argument(
    "--add_info",
    type=str,
...
if args.mac == 1:
    ...
    from pywin import UIElement, WindowsACI
