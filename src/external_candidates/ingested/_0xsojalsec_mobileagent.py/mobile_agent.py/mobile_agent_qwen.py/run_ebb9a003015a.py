# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent\Mobile-Agent-qwen\run_深色模式.py
import requests
...
query_data = {
    "screenshot": image,
    "query": "",
    "session_id": response_query.json()["session_id"],
    "tutorial": tutorial,
}
response_query = requests.post("http://127.0.0.1:5000/a", json=query_data)
print(response_query.json())
