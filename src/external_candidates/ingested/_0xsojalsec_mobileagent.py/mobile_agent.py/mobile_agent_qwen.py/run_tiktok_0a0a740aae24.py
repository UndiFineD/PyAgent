# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent\Mobile-Agent-qwen\run_tiktok.py
import requests
...
query_data = {
    "screenshot": image,
    "query": "Find a video about cat in TikTok and tap a like for this video",
    "session_id": "",
    "tutorial": tutorial,
}
