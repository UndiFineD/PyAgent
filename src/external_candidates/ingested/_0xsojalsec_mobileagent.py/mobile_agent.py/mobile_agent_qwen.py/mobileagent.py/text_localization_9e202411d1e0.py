# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent\Mobile-Agent-qwen\MobileAgent\text_localization.py
import cv2
import numpy as np
from MobileAgent.crop import calculate_size, crop_image
