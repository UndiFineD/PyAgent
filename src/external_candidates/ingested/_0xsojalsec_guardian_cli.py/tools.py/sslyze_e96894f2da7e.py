        ...
        try:
            ...
            if "certificate_info" in scan_commands:
                ...
                if cert_deployments:
                    ...
                    verified_chain = cert_deployment.get(
                    ...
                    if verified_chain:
                        ...
                        results["certificate"] = {
                            ...
                            "signature_algorithm": leaf_cert.get(
            ...
            for protocol_key in protocol_checks:
                if protocol_key in scan_commands:
                    ...
                    is_supported = protocol_result.get(
                        ...
                        results["vulnerabilities"].append(
                            {
                                ...
                                "severity": (
                                    "high" if "ssl" in protocol_key else "medium"
                                ),
                            }
                        )
            ...
            if "http_headers" in scan_commands:
                ...
                strict_transport_security = headers_result.get(
