# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-guardian-cli\utils\logger.py
"""
...
class AuditLogger:
    ...
    def log_ai_decision(
        self, agent: str, decision: str, reasoning: str, context: Dict[str, Any]
    ):
    ...
    def log_tool_execution(
        self, tool: str, args: Dict[str, Any], result: Optional[str] = None
    ):
