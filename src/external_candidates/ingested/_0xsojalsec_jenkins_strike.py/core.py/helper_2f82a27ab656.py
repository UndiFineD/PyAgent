# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-jenkins-strike\core\helper.py
...
class dynamic:
    ...
    def getNops():
        nops = [
            ...
            [
                ...
                "00",
                "00",
            ],  # 5 bytes, 66 NOP DWORD ptr [EAX + EAX*1 + 00H
            [
                "66",
                "0f",
                "1f",
                ...
                "00",
                "00",
            ],  # 6 bytes, NOP DWORD ptr [EAX + EAX*1 + 00H
            [
                "0f",
                "1f",
                "80",
                ...
                "00",
                "00",
            ],  # 7 bytes, NOP DWORD ptr [EAX + EAX*1 + 00000000H
            [
                "0f",
                "1f",
                "84",
                ...
                "00",
                "00",
            ],  # 8 bytes, NOP DWORD ptr [EAX + EAX*1 + 00000000H
            [
                "66",
                "0f",
                "1f",
                ...
                "00",
                "00",
            ],  # 9 bytes, 66 NOP DWORD ptr [EAX + EAX*1 00000000H
        ]
    ...
    def getHttpClientMetadataCookie():
        cookie_prefixes = [
            ...
            format.getRandomAlphanum(random.randint(2, 4))
            + "_"
            + format.getRandomAlphanum(32),
        ]
