# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-online\src\second_brain_online\application\agents\tools\summarizer.py
...
"""
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        assert (
            settings.HUGGINGFACE_DEDICATED_ENDPOINT is not None
