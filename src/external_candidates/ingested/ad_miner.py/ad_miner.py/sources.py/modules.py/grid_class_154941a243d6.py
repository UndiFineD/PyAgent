# Extracted from: C:\DEV\PyAgent\.external\AD_Miner\ad_miner\sources\modules\grid_class.py
...
class Grid:
    ...
    def render(self, page_f):
        with open(
            self.template_base_path / (self.template + "_template.html"), "r"
        ) as grid_template:
            ...
            new_contents = template_contents.replace(
                "// DATA PLACEHOLDER", textToInsert
            )
