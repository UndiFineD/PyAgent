    ...
    def generatePathToUnconstrainedDelegation(self):
        ...
        for domain in self.domains:
            ...
            tmp_data["Users"] = {
                ...
                "link": "%s_users_to_unconstrained_delegation.html"
                % quote(str(domain)),
            }
            tmp_data["Computers"] = {
                "value": len(self.computers_to_unconstrained_delegation[domain]),
                "link": "%s_computers_to_unconstrained_delegation.html"
                % quote(str(domain)),
            }
            tmp_data["Groups"] = {
                "value": len(self.groups_to_unconstrained_delegation[domain]),
                "link": "%s_groups_to_unconstrained_delegation.html"
                % quote(str(domain)),
            }
            tmp_data["Ou"] = {
    ...
    def generatePathToUnconstrainedDelegation_2(self):
        ...
        for domain in self.domains:
            ...
            tmp_data["Users"] = {
                ...
                "link": "%s_users_to_unconstrained_delegation_users.html"
                % quote(str(domain)),
            }
            tmp_data["Computers"] = {
                "value": len(self.computers_to_unconstrained_delegation_2[domain]),
                "link": "%s_computers_to_unconstrained_delegation_users.html"
                % quote(str(domain)),
            }
            tmp_data["Groups"] = {
                "value": len(self.groups_to_unconstrained_delegation_2[domain]),
                "link": "%s_groups_to_unconstrained_delegation_users.html"
                % quote(str(domain)),
            }
            tmp_data["Ou"] = {
                "value": len(self.ou_to_unconstrained_delegation_2[domain]),
                "link": "%s_OU_to_unconstrained_delegation_users.html"
                % quote(str(domain)),
            }
            tmp_data["GPO"] = {
                "value": len(self.gpo_to_unconstrained_delegation_2[domain]),
                "link": "%s_GPO_to_unconstrained_delegation_users.html"
                % quote(str(domain)),
            }
            grid_data.append(tmp_data)
        headers = ["Domain", "Users", "Computers", "Groups", "Ou", "GPO"]
