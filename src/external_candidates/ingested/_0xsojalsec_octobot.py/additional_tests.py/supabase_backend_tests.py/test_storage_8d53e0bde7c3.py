# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\additional_tests\supabase_backend_tests\test_storage.py
...
async def test_upload_asset(admin_client):
    ...
    uploaded_asset_path = await admin_client.upload_asset(
        asset_bucket, asset_name, asset_content
    )
