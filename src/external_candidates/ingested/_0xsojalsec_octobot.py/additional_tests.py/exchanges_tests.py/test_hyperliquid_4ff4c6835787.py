# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\additional_tests\exchanges_tests\test_hyperliquid.py
...
class TestHyperliquidAuthenticatedExchange(
    ...
    CONVERTS_MARKET_INTO_LIMIT_ORDERS = (
        True  # when market orders are always converted into limit order by the exchange
    )
