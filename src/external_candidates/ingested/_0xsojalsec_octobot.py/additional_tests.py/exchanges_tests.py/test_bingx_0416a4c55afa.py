# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\additional_tests\exchanges_tests\test_bingx.py
...
class TestBingxAuthenticatedExchange(
    ...
    SPECIAL_ORDER_TYPES_BY_EXCHANGE_ID: dict[
        ...
        "1877004220704391168": (
            ...
            "type",
            "TAKE_STOP_LIMIT",
            octobot_trading.enums.TradeOrderType.UNSUPPORTED.value,
            octobot_trading.enums.TradeOrderSide.SELL.value,
            None,
        ),
        "1877004292053696512": (
