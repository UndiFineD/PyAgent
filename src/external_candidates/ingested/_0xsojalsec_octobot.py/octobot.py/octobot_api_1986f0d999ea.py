# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\octobot_api.py
...
class OctoBotAPI:
    ...
    def get_startup_config(self, dict_only=True):
        return self._octobot.get_startup_config(
            constants.CONFIG_KEY, dict_only=dict_only
        )

    def get_edited_config(self, dict_only=True):
        return self._octobot.get_edited_config(
            constants.CONFIG_KEY, dict_only=dict_only
        )
