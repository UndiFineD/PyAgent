# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\producers\service_feed_producer.py
        ...
        for feed in self.service_feeds:
            await self.send(
                ...
                data={
                    ...
                    service_channel_consumer.OctoBotChannelServiceDataKeys.EDITED_CONFIG.value: self.octobot.get_edited_config(
                        constants.CONFIG_KEY, dict_only=False
                    ),
                },
            )
    ...
    async def create_feed(self, service_feed_factory, feed, in_backtesting):
        await self.send(
            ...
            data={
                ...
                service_channel_consumer.OctoBotChannelServiceDataKeys.BACKTESTING_ENABLED.value: in_backtesting,
