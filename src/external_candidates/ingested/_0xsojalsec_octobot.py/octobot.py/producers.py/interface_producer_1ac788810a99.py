...
class InterfaceProducer(octobot_channels.OctoBotChannelProducer):
    ...
    async def start_interfaces(self):
        ...
        started_interfaces = await service_managers.start_interfaces(
            to_start_interfaces
        )
    ...
    def _is_interface_relevant(self, interface_class, backtesting_enabled):
        return (
            ...
            and all(
                service.get_is_enabled(self.octobot.config)
            ...
            and (
                ...
                or (
                    backtesting_enabled
                    and service_api.is_enabled_in_backtesting(interface_class)
                )
            )
        )
