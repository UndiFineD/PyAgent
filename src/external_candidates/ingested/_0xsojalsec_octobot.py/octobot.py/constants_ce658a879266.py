# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\constants.py
...
OCTOBOT_DOCS_URL = os.getenv(
    "DOCS_OCTOBOT_ONLINE_URL", "https://www.octobot.cloud/en/guides"
)
EXCHANGES_DOCS_URL = os.getenv(
    "DOCS_OCTOBOT_ONLINE_URL", "https://www.octobot.cloud/en/guides/exchanges/"
)
DEVELOPER_DOCS_URL = os.getenv(
    "DOCS_OCTOBOT_ONLINE_URL", "https://www.octobot.cloud/en/guides/developers/"
)
OCTOBOT_ONLINE = os.getenv("TENTACLES_OCTOBOT_ONLINE_URL", "octobot.online")
OCTOBOT_FEEDBACK = os.getenv(
    "FEEDBACK_OCTOBOT_ONLINE_URL", "https://feedback.octobot.cloud/"
)
...
COMMUNITY_TRADINGVIEW_WEBHOOK_BASE_URL = os.getenv(
    "COMMUNITY_TRADINGVIEW_WEBHOOK_BASE_URL",
    "https://webhook.octobot.cloud/tradingview",
)
DISABLE_COMMUNITY_EXTENSIONS_CHECK = os_util.parse_boolean_environment_var(
    "DISABLE_COMMUNITY_EXTENSIONS_CHECK", "false"
)
...
OCTOBOT_COMMUNITY_API_URL = os.getenv(
    "COMMUNITY_SERVER_URL", f"{OCTOBOT_COMMUNITY_URL}/api/community"
)
OCTOBOT_COMMUNITY_RECOVER_PASSWORD_URL = f"{OCTOBOT_COMMUNITY_URL}/login"
# default env
COMMUNITY_BACKEND_URL = os.getenv(
    "COMMUNITY_BACKEND_URL", "https://nwhpvrguwcihhizrnyoe.supabase.co"
)
COMMUNITY_BACKEND_KEY = os.getenv(
    "COMMUNITY_BACKEND_KEY",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im53aHB2cmd1d2NpaGhpenJueW9lIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTU2NDQxMDcsImV4cCI6MjAxMTIyMDEwN30.AILcgv0l6hl_0IUEPlWh1wiu9RIpgrkGZGERM5uXftE",
)

# staging env SHOULD ONLY BE USED THROUGH CommunityIdentifiersProvider
STAGING_OCTOBOT_COMMUNITY_URL = os.getenv(
    "COMMUNITY_SERVER_URL", "https://beta.octobot.cloud"
)
STAGING_OCTOBOT_COMMUNITY_API_URL = os.getenv(
    "COMMUNITY_SERVER_URL", f"{STAGING_OCTOBOT_COMMUNITY_URL}/api/community"
)
STAGING_COMMUNITY_RECOVER_PASSWORD_URL = f"{STAGING_OCTOBOT_COMMUNITY_URL}/login"
STAGING_COMMUNITY_BACKEND_URL = os.getenv(
    "COMMUNITY_BACKEND_URL", "https://wmfkgvgzokyzhvxowbyg.supabase.co"
)
STAGING_COMMUNITY_BACKEND_KEY = os.getenv(
    "COMMUNITY_BACKEND_KEY",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndtZmtndmd6b2t5emh2eG93YnlnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTE0NDA1MTEsImV4cCI6MjAwNzAxNjUxMX0.YZQl7LYgvnzO_Jizs0UKfPEaqPoV2EwhjunH8gime8o",
)

# production env, ignored by CommunityIdentifiersProvider
COMMUNITY_PRODUCTION_BACKEND_URL = os.getenv(
    "COMMUNITY_PRODUCTION_BACKEND_URL", COMMUNITY_BACKEND_URL
)
COMMUNITY_PRODUCTION_BACKEND_KEY = os.getenv(
    "COMMUNITY_PRODUCTION_BACKEND_KEY", COMMUNITY_BACKEND_KEY
)
...
OCTOBOT_MARKET_MAKING_URL = os.getenv(
    "OCTOBOT_MARKET_MAKING_URL", "https://market-making.octobot.cloud"
)
...
USE_FETCHED_BOT_CONFIG = os_util.parse_boolean_environment_var(
    "USE_FETCHED_BOT_CONFIG", "false"
)
CAN_INSTALL_TENTACLES = os_util.parse_boolean_environment_var(
    "CAN_INSTALL_TENTACLES", str(not IS_CLOUD_ENV)
)
PH_TRACKING_ID = os.getenv(
    "PH_TRACKING_ID", "phc_QSuFy6zqOXXKT7zAYboYS4nJShfKovpB172aa8X9nXf"
)
...
MAX_ALLOWED_TIME_FRAMES = int(
    os.getenv("MAX_ALLOWED_TIME_FRAMES", str(UNLIMITED_ALLOWED))
)
MAX_ALLOWED_BACKTESTING_CANDLES_HISTORY = int(
    os.getenv("MAX_ALLOWED_BACKTESTING_CANDLES_HISTORY", str(UNLIMITED_ALLOWED))
)
...
ENABLE_ADVANCED_INTERFACE = os_util.parse_boolean_environment_var(
    "ENABLE_ADVANCED_INTERFACE", "True"
)
ENABLE_STRATEGY_OPTIMIZER = os_util.parse_boolean_environment_var(
...
ENV_TRADING_ENABLE_DEBUG_LOGS = os_util.parse_boolean_environment_var(
    "ENV_TRADING_ENABLE_DEBUG_LOGS", "False"
)

# system
ENABLE_CLOCK_SYNCH = os_util.parse_boolean_environment_var("ENABLE_CLOCK_SYNCH", "True")
ENABLE_SYSTEM_WATCHER = os_util.parse_boolean_environment_var(
    "ENABLE_SYSTEM_WATCHER", "True"
)
WATCH_RAM = os_util.parse_boolean_environment_var("WATCH_RAM", "False")
DUMP_USED_RESOURCES = os_util.parse_boolean_environment_var(
    "DUMP_USED_RESOURCES", "False"
)
...
CLOUD_FIRST_METRICS_UPDATE_TIME = float(os.getenv("CLOUD_FIRST_METRICS_UPDATE_TIME", 5))
...
EXIT_BEFORE_TENTACLES_AUTO_REINSTALL = os_util.parse_boolean_environment_var(
    "EXIT_BEFORE_TENTACLES_AUTO_REINSTALL", "False"
)
...
OPTIMIZER_DATA_FILES_FOLDER = (
    f"{OCTOBOT_FOLDER}/strategy_optimizer/optimizer_data_files"
)
...
ENABLE_RUN_DATABASE_LIMIT = os_util.parse_boolean_environment_var(
    "ENABLE_RUN_DATABASE_LIMIT", "True"
)
MAX_TOTAL_RUN_DATABASES_SIZE = int(
    os.getenv("MAX_TOTAL_RUN_DATABASES_SIZE", DEFAULT_MAX_TOTAL_RUN_DATABASES_SIZE)
)
