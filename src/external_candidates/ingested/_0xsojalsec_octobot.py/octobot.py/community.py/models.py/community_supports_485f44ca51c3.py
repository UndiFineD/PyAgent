# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\models\community_supports.py
...
import octobot.community.models.community_donation as community_donation
...
class CommunitySupports(support.Support):
    ...
    def from_community_dict(data):
        return CommunitySupports(
            data["data"]["attributes"].get(
                "support_role", CommunitySupports.DEFAULT_SUPPORT_ROLE
            ),
            [
