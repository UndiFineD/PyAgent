# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\models\community_tentacles_package.py
...
class CommunityTentaclesPackage:
    ...
    def get_latest_compatible_version(self):
        ...
        available_versions = sorted(
            [packaging.version.parse(version) for version in self.versions],
            reverse=True,
        )
