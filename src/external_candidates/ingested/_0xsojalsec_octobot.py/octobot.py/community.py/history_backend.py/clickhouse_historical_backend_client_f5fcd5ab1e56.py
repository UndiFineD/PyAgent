# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\history_backend\clickhouse_historical_backend_client.py
...
class ClickhouseHistoricalBackendClient(
    historical_backend_client.HistoricalBackendClient
):
