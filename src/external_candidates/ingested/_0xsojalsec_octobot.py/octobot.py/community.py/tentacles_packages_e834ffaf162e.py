...
async def has_tentacles_to_install_and_uninstall_tentacles_if_necessary(community_auth):
    ...
    to_install, to_remove_tentacles, force_refresh_tentacles_setup_config = (
        get_to_install_and_remove_tentacles(
...
def get_to_install_and_remove_tentacles(
    ...
    was_connected_with_remote_packages = (
        community_auth.was_connected_with_remote_packages()
    )
    ...
    for to_remove_url in to_remove_urls:
        ...
        for installed_package in installed_packages:
            to_remove_tentacles += (
                tentacles_manager_api.get_tentacles_from_package_name(installed_package)
            )
