# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\graphql_requests.py
...
def update_bot_config_and_stats_query(
    bot_id, profile_name, profitability
) -> (str, dict, str):
    return (
        """
...
def update_bot_portfolio_query(
    bot_id, current_value, initial_value, unit, content, history
) -> (str, dict, str):
    return (
        """
...
def upsert_historical_bot_portfolio_query(
    bot_id, current_value, content, history
) -> (str, dict, str):
    return (
        """
