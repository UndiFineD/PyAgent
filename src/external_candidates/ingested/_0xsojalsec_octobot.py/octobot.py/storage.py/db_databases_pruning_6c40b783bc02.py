# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\storage\db_databases_pruning.py
...
async def enforce_total_databases_max_size():
    if constants.ENABLE_RUN_DATABASE_LIMIT:
        run_databases_identifier = (
            databases.RunDatabasesProvider.instance().get_any_run_databases_identifier()
        )
