# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\strategy_optimizer\optimizer_constraint.py
...
class OptimizerConstraint:
    ...
    def __init__(
        self, name, min_val, max_val, min_step, max_step, stay_within_boundaries
    ):
        self.name = name
