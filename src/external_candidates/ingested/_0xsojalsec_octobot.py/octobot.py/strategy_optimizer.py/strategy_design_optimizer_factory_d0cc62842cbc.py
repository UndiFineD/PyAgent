# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\strategy_optimizer\strategy_design_optimizer_factory.py
...
def create_most_advanced_strategy_design_optimizer(
    ...
    optimizer_classes = [
        optimizer_class
        for optimizer_class in class_inspector.get_all_classes_from_parent(
            advanced_class
        )
