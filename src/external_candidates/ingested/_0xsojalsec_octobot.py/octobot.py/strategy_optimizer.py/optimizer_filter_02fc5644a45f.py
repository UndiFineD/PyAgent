# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\strategy_optimizer\optimizer_filter.py
...
class OptimizerFilter:
    ...
    def is_filtered(self):
        ...
        return logical_operators.evaluate_condition(
            left_operand, right_operand, self.operator
        )
