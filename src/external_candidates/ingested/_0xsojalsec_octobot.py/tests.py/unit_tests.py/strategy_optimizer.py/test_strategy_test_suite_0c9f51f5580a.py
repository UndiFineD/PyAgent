# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\tests\unit_tests\strategy_optimizer\test_strategy_test_suite.py
...
async def test_run_test_suite():
    ...
    with mock.patch.object(builtins, "print", mock.Mock()) as print_mock:
        ...
        calls = (
            test_suite.test_slow_downtrend,
            test_suite.test_sharp_downtrend,
            test_suite.test_flat_markets,
            test_suite.test_slow_uptrend,
            test_suite.test_sharp_uptrend,
            test_suite.test_up_then_down,
        )
        for call in calls:
