# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\tests\test_utils\bot_management.py
...
async def run_independent_backtesting(
    data_files,
    timeout=10,
    use_loggers=True,
    ...
    try:
        ...
        get_logger().exception(
            e, True, f"Timeout after waiting for backtesting for {timeout} seconds."
        )
