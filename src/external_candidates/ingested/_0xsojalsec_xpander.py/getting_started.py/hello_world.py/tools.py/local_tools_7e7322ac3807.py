# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-xpander.ai\Getting-Started\hello-world\tools\local_tools.py
"""
...
local_tools_by_name = {
    tool["declaration"]["function"]["name"]: tool["fn"] for tool in local_tools
}
