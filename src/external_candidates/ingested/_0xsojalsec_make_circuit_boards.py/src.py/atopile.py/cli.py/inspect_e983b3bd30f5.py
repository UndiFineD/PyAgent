# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\cli\inspect.py
...
def inspect(
    build_ctxs: list[BuildContext], inspect: Optional[str], context: Optional[str]
):
    """
