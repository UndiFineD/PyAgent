# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\parser\AtopileParser.py
...
class AtopileParser(AtopileParserBase):
    ...
    class AssignableContext(ParserRuleContext):
        ...
        def arithmetic_expression(self):
            return self.getTypedRuleContext(
                AtopileParser.Arithmetic_expressionContext, 0
            )
    ...
    def comparison(self):
        ...
        try:
            ...
            while True:
                ...
                _la = self._input.LA(1)
                if not (
                    (((_la) & ~0x3F) == 0 and ((1 << _la) & 432345564227829760) != 0)
                ):
                    break
    ...
    def arithmetic_expression(self, _p: int = 0):
        ...
        localctx = AtopileParser.Arithmetic_expressionContext(
