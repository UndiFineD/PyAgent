# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\parser\AtopileParserVisitor.py
...
class AtopileParserVisitor(ParseTreeVisitor):
    ...
    def visitArithmetic_expression(
        self, ctx: AtopileParser.Arithmetic_expressionContext
    ):
        return self.visitChildren(ctx)
