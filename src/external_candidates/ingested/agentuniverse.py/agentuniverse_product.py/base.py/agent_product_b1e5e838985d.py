# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_product\base\agent_product.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class AgentProduct(Product):
    ...
    def initialize_by_component_configer(
        self, product_configer: ProductConfiger
    ) -> "Product":
        ...
        if (
            hasattr(product_configer, "opening_speech")
            and product_configer.opening_speech
        ):
