# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_product\base\util\common_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def is_component_id_unique(component_id: str, component_type: str) -> bool:
    ...
    instance: ComponentBase = component_manager_clz().get_instance_obj(
        component_id, new_instance=False
    )
