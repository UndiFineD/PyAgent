# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_product\base\product.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class Product(ComponentBase):
    ...
    def init_instance(self):
        ...
        if self._instance is None:
            raise ValueError(
                f"The aU instance corresponding to the product id does not exist,"
