# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_product\service\message_service\message_service.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
    ...
    def add_message(session_id: str, content: str, add_time: datetime) -> int:
        ...
        return MessageLibrary().add_message(
            MessageDO(
                ...
                content=content,
                gmt_created=add_time,
                gmt_modified=add_time,
            )
        )
