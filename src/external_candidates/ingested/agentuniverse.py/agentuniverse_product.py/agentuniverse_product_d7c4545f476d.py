...
class AgentUniverseProduct(object):
    ...
    def __scan_and_register_product(self, app_configer: AppConfiger):
        ...
        core_product_package_list = (
            app_configer.core_product_package_list
    ...
    def __register(self, product_configer_list: list[ComponentConfiger]):
        ...
        for product_configer in product_configer_list:
            configer_instance: ProductConfiger = ProductConfiger().load_by_configer(
                product_configer.configer
            )
            component_clz = (
            ...
            ProductManager().register(
                product_instance.get_instance_code(), product_instance
            )
