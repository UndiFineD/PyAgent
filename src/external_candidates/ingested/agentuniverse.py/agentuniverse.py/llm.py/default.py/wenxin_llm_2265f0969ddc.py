...
TokenModelList = [
    "ernie-4.5-turbo-32k" "ernie-4.5-8k-preview" "ernie-4.0-8k",
    "ernie-3.5-8k",
    "ernie-speed-8k",
    "ernie-speed-128k",
    "ernie-lite-8k",
...
class WenXinLLM(LLM):
    ...
    def get_num_tokens(self, text: str) -> int:
        ...
        token_cnt = tokenizer.Tokenizer().count_tokens(
            text=text, mode="remote", model=model_name
        )
        return token_cnt
    ...
    async def agenerate_stream_result(
        self, chat_completion: AsyncIterator
    ...
    def initialize_by_component_configer(
        ...
        if "secret_key" in component_configer.configer.value:
            ...
            self.secret_key = process_yaml_func(
                secret_key, component_configer.yaml_func_instance
            )
        return self
