# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\llm\default\qwen_openai_style_llm.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class QWenOpenAIStyleLLM(OpenAIStyleLLM):
    ...
    proxy: Optional[str] = Field(
        default_factory=lambda: get_from_env("DASHSCOPE_PROXY")
    )
    organization: Optional[str] = Field(
        default_factory=lambda: get_from_env("DASHSCOPE_ORGANIZATION")
    )
