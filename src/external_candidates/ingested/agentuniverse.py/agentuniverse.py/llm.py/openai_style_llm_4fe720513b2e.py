...
class OpenAIStyleLLM(LLM):
    ...
    def _call(
        ...
        self.client.base_url = (
            kwargs.pop("api_base") if kwargs.get("api_base") else self.api_base
        )
        client = self.client
    ...
    def initialize_by_component_configer(
        ...
        if "api_base" in component_configer.configer.value:
            ...
            self.api_base = process_yaml_func(
                api_base, component_configer.yaml_func_instance
            )
        ...
        if "organization" in component_configer.configer.value:
            ...
            self.organization = process_yaml_func(
                organization, component_configer.yaml_func_instance
            )
