# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\component\component_manager_base.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class ComponentManagerBase(Generic[ComponentTypeVar]):
    ...
    def register(
        self, component_instance_name: str, component_instance_obj: ComponentTypeVar
    ):
