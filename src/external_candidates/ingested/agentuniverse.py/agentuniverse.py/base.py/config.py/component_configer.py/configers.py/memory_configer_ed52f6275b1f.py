# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\config\component_configer\configers\memory_configer.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class MemoryConfiger(ComponentConfiger):
    ...
    def load_by_configer(self, configer: Configer) -> "MemoryConfiger":
        ...
        try:
            ...
            self.__memory_retrieval_storage = configer.value.get(
