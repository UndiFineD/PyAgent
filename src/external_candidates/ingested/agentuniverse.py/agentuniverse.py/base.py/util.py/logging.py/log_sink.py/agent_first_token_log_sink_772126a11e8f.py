# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\util\logging\log_sink\agent_first_token_log_sink.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class AgentFirstTokenLogSink(BaseFileLogSink):
    ...
    def generate_log(self, cost_time) -> str:
        return (
            ...
            + f" Agent first token cost {cost_time:.2f} seconds."
        )
