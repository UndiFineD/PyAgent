# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\util\logging\log_sink\base_file_log_sink.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class BaseFileLogSink(LogSink):
    ...
    def _initialize_by_component_configer(
        self, log_sink_configer: ComponentConfiger
    ) -> "LogSink":
