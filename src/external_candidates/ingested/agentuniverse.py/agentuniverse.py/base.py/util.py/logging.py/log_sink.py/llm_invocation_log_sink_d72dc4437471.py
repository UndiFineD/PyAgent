# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\util\logging\log_sink\llm_invocation_log_sink.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class LLMInvocationLogSink(BaseFileLogSink):
    ...
    def generate_log(
        self, used_token: int, cost_time: float, llm_output: Union[str, dict]
    ) -> str:
