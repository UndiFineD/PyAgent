# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\util\agent_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def assemble_memory_input(
    memory: Memory, agent_input: dict, query_params: dict = None
) -> list[Message]:
...
def process_agent_llm_config(
    agent_id: str, agent_profile: dict, default_llm_configer: DefaultLLMConfiger
) -> dict:
    """
