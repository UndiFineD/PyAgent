# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\util\async_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def run_async_from_sync(
    ...
    worker_thread = threading.Thread(
        target=_async_runner_thread_target, args=(coro, result_queue), daemon=True
    )
    worker_thread.start()
