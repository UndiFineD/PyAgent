# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\au_trace_context.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
import asyncio
import threading
...
class AuTraceContext:
    ...
    def from_trace_context(
        cls, trace_id: str, span_id: str, session_id: Optional[str] = None
    ):
    ...
    def add_current_token_usage_to_parent(self, token_usage=None, parent_span_id=None):
        ...
        if (
            ...
            and parent_ctx.span_id
            and parent_ctx.span_id in self._token_count_dict
        ):
