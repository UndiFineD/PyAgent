# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\otel\telemetry_manager.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TelemetryManager:
    ...
    def _build_tracer_provider(
        ...
        provider_cls = self._import_class(
            otel_conf.get("provider_class", "opentelemetry.sdk.trace.TracerProvider")
        )
