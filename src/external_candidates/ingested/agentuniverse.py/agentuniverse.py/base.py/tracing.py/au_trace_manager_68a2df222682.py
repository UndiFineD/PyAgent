# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\au_trace_manager.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def add_current_token_usage_to_parent(token_usage=None, parent_span_id=None):
    return AuTraceManager().trace_context.add_current_token_usage_to_parent(
        token_usage, parent_span_id
    )
