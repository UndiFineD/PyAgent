# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\database\sqldb_wrapper.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
from ..base.config.component_configer.configers.sqldb_wrapper_config import (
...
class SQLDBWrapper(ComponentBase):
    ...
    def initialize_by_component_configer(
        self, db_wrapper_configer: SQLDBWrapperConfiger
    ) -> "SQLDBWrapper":
