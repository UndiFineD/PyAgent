...
class ExecutingAgentTemplate(AgentTemplate):
    ...
    def parse_input(self, input_object: InputObject, agent_input: dict) -> dict:
        ...
        agent_input["framework"] = input_object.get_data("planning_result").get_data(
            "framework"
        )
    ...
    async def customized_async_execute(
        ...
        **kwargs,
        ...
        return await loop.run_in_executor(
            None, self._execute_tasks, input_object, agent_input, memory, llm, prompt
        )
    ...
    def _execute_subtask(
        self, subtask, input_object, agent_input, index, memory, llm, prompt, **kwargs
    ) -> dict:
        context_tokens = {}
        ...
        try:
            ...
            agent_input_copy["background"] = (
                f"knowledge result: {knowledge_res} \n\n tools result: {tools_res}"
            )
            agent_input_copy["input"] = subtask

            process_llm_token(
                llm, prompt.as_langchain(), self.agent_model.profile, agent_input_copy
            )
