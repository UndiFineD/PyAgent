# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\plan\planner\reviewing_planner\reviewing_planner.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class ReviewingPlanner(Planner):
    ...
    def invoke(
        ...
        chain = (
            prompt.as_langchain()
            | llm.as_langchain_runnable(agent_model.llm_params())
            | StrOutputParser()
        )
