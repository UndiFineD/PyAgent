# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\plan\planner\react_planner\stream_callback.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
    ...
    def on_llm_new_token(
        ...
        **kwargs: Any,
        ...
        self.queueStream.put_nowait(
            {
                "type": "token",
                "data": {"chunk": chunk.text, "agent_info": self.agent_info},
            }
        )
...
class InvokeCallbackHandler(BaseCallbackHandler):
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        ConversationMemoryModule().add_llm_input_info(
            start_info, self.llm_name, prompt, f"llm_{run_id.hex}"
        )
