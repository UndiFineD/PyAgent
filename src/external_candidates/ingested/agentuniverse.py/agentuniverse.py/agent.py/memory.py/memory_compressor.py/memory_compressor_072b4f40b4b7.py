...
class MemoryCompressor(ComponentBase):
    ...
    def compress_memory(
        ...
        **kwargs,
        ...
        """
        prompt: Prompt = PromptManager().get_instance_obj(
            self.compressor_prompt_version
        )
    ...
    def _initialize_by_component_configer(
        self, memory_compressor_config: ComponentConfiger
    ) -> "MemoryCompressor":
        ...
        if getattr(memory_compressor_config, "compressor_prompt_version", None):
            self.compressor_prompt_version = (
                memory_compressor_config.compressor_prompt_version
            )
