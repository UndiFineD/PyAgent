...
class ElasticsearchMemoryStorage(MemoryStorage):
    ...
    es_url: Optional[str] = (
        "http://localhost:9200"  # The base URL of your Elasticsearch instance
    )
    ...
    def add(
        ...
        **kwargs,
        ...
        for message in message_list:
            action = self.memory_converter.to_es_action(
                message, session_id=session_id, agent_id=agent_id, **kwargs
            )
        ...
        return ConversationMessage.from_dict(
            {
                ...
                "metadata": {
                    ...
                    "timestamp": datetime.datetime.fromisoformat(
                        es_hit["_source"]["timestamp"]
                    ),
                    "params": es_hit["_source"].get("params"),
                    "pair_id": es_hit["_source"].get("pair_id"),
                    "gmt_created": datetime.datetime.fromisoformat(
                        es_hit["_source"]["timestamp"]
                    ).isoformat(),
                },
    ...
    def to_es_action(
        ...
        **kwargs,
        ...
        document = {
            ...
            "timestamp": message.metadata.get(
