# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\memory\memory_storage\ram_memory_storage.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class RamMemoryStorage(MemoryStorage):
    ...
    def get(
        self, session_id: str = "", agent_id: str = "", top_k=10, **kwargs
    ) -> List[Message]:
