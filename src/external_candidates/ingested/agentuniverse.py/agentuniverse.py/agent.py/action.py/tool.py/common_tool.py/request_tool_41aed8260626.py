# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\tool\common_tool\request_tool.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class RequestTool(Tool):
    ...
    def initialize_by_component_configer(
        ...
        self.response_content_type = component_configer.configer.value.get(
