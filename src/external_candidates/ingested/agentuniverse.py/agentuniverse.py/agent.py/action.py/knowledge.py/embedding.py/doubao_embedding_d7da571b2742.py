# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\embedding\doubao_embedding.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
    ...
    def get_embeddings(self, texts: List[str], **kwargs) -> List[List[float]]:
        ...
        try:
            response = self.client.embeddings.create(
                model=self.endpoint_id, input=texts
            )
