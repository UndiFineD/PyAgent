# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\doc_processor\recursive_character_text_splitter.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class RecursiveCharacterTextSplitter(DocProcessor):
    ...
    def _process_docs(
        ...
        """
        lc_doc_list = self.splitter.split_documents(
            Document.as_langchain_list(origin_docs)
        )
