# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\reader\cloud_file_reader\feishu_reader.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class PublicFeishuReader:
    ...
    def _parse_content(self, soup: BeautifulSoup) -> str:
        ...
        content_div = soup.find(
            "div", class_="doc-content"
        )  # Update class name as needed
        if content_div:
            ...
            for tag in content_div.find_all(["p", "div", "span"], recursive=True):
                ...
                if (
                    ...
                    and not any(
                        ...
                        for keyword in ["login", "sign up", "comment", "help"]
                    )
                ):
                    content.append(text)
        else:
