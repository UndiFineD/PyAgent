# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\reader\file\rar_reader.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
            ...
            with rarfile.RarFile(str(rar_path), "r") as rar:
                ...
                for entry in entries:
                    ...
                    try:
                        ...
                        full_path = (
                            os.path.join(parent_path, entry.filename)
                            if parent_path
                            else entry.filename
                        )

                        if (
                            extracted_path.suffix.lower() == ".rar"
