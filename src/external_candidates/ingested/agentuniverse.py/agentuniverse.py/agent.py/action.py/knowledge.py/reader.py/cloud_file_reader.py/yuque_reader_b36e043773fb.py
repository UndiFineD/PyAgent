# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\reader\cloud_file_reader\yuque_reader.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class YuqueReader(Reader):
    ...
    def _fetch_page_markdown(self, book_id: str, slug: str) -> str:
        ...
        if resp.status_code != 200:
            print(
                "The document download failed. The page may have been deleted.",
                book_id,
                slug,
            )
            return ""
