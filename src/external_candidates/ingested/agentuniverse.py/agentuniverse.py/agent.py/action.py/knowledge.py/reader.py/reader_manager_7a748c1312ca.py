# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\reader\reader_manager.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class ReaderManager(ComponentManagerBase[Reader]):
    ...
    def get_file_default_reader(
        self, file_type: str, new_instance: bool = False
    ) -> Reader | None:
