# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\toolkit\toolkit_manager.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
import importlib
    ...
    def get_instance_obj(
        ...
        if instance_obj is None:
            ...
            if (
                ...
                and component_instance_name in toolkit_configer_map.keys()
            ):
                ...
                if toolkit_configer:
                    ...
                    instance_obj: (
                        Toolkit
                    ) = component_clz().initialize_by_component_configer(
                        toolkit_configer
                    )
                    if instance_obj:
                        instance_obj.component_config_path = (
                            toolkit_configer.configer.path
                        )
