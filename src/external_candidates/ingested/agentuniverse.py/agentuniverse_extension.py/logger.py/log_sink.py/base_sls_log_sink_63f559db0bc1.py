# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_extension\logger\log_sink\base_sls_log_sink.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
import asyncio
...
from agentuniverse.base.util.logging.logging_util import is_in_coroutine_context
...
class BaseSLSLogSink(LogSink):
    ...
    def register_sink(self):
        if LoggingConfig.log_extend_module_switch["sls_log"]:
            print(f"biz_logger_is_in_coroutine_context={is_in_coroutine_context()}")
