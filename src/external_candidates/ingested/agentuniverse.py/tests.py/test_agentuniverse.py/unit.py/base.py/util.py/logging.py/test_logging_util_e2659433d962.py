# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\base\util\logging\test_logging_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
test_context = {
    "LOG_CONTEXT": {"REQUEST_ID": "1111-2222-3333", "AGENT_ID": "TEST_AGENT"}
}
...
def test_logging_util():
    ...
    with FrameworkContext(test_context):
        ...
        time.sleep(0.01)
        with open(
            os.path.join(test_log_path, LOG_FILE_PREFIX + "_all.log"), "r"
        ) as file:
        ...
        with open(
            os.path.join(test_log_path, LOG_FILE_PREFIX + "_error.log"), "r"
        ) as file:
            first_line = file.readline().strip()
