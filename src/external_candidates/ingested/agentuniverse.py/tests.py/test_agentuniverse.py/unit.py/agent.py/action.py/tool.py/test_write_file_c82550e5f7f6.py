# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\tool\test_write_file.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class WriteFileToolTest(unittest.TestCase):
    ...
    def test_write_new_file(self):
        ...
        tool_input = ToolInput({"file_path": file_path, "content": content})
    ...
    def test_append_to_file(self):
        ...
        tool_input = ToolInput({"file_path": file_path, "content": initial_content})
