# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\reader\file\test_epub_reader.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TestEpubReader(unittest.TestCase):
    ...
    def create_test_epub(self):
        ...
        chapter = epub.EpubHtml(
            title="Test Chapter", file_name="test_chap.xhtml", lang="en"
        )
        chapter.content = """
        <html>
    ...
    def test_load_data_with_custom_metadata(self):
        ...
        documents = self.reader._load_data(
            self.test_epub_path, ext_info=custom_metadata
        )
