# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\doc_processor\test_jina_reranker.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
from agentuniverse.agent.action.knowledge.doc_processor.jina_reranker import (
    JinaReranker,
)
