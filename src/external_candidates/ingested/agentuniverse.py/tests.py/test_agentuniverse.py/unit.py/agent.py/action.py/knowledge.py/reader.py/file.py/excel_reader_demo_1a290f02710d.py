# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\reader\file\excel_reader_demo.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def demo_excel_reader():
    ...
    try:
        ...
        for i, doc in enumerate(documents, 1):
            ...
            print(
                f"   行数: {doc.metadata['max_row']}, 列数: {doc.metadata['max_col']}"
            )
            print(f"   内容预览:")
            # 显示前200个字符
            content_preview = (
