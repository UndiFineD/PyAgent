# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\reader\file\test_code_reader.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
impl Config {
    ...
    pub fn get_value(&self) -> i32 {
        ...
        with open(
            os.path.join(self.temp_dir.name, "test.rs"), "w", encoding="utf-8"
        ) as f:
