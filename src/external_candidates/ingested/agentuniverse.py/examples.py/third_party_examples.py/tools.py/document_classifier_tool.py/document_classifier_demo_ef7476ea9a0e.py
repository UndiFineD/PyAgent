# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\tools\document_classifier_tool\document_classifier_demo.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def demo_chinese_classifier():
    ...
    # 添加中文关键词规则
    classifier.add_chinese_keyword_rule(
        "技术文档",
        [
            "Python",
            "编程",
