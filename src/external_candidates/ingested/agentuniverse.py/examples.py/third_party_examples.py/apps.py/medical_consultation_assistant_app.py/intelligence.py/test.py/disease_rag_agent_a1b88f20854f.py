# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\medical_consultation_assistant_app\intelligence\test\disease_rag_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
if __name__ == "__main__":
    chat(
        "小明最近出现了发热表现，伴有畏寒现象，精神状态萎靡，注意力难以集中，时常感到头晕目眩，"
