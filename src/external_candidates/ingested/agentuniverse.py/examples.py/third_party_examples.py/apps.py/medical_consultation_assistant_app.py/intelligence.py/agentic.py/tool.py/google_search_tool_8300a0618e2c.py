# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\medical_consultation_assistant_app\intelligence\agentic\tool\google_search_tool.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class GoogleSearchTool(Tool):
    ...
    def execute(self, input: str):
        ...
        search = GoogleSerperAPIWrapper(
            serper_api_key=self.serper_api_key, k=10, gl="us", hl="en", type="search"
        )
