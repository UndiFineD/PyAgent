# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\medical_consultation_assistant_app\intelligence\utils\common\jsonl_file_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class JsonFileWriter(object):
    ...
    def write_json_query_answer_list(self, query_answer_list: list):
        for i in range(0, len(query_answer_list)):
            self.write_json_query_answer(
                query_answer_list[i][0], query_answer_list[i][1]
            )
