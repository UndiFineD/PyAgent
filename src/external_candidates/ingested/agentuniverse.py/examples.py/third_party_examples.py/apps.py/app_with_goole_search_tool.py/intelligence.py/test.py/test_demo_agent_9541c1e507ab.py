# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\app_with_goole_search_tool\intelligence\test\test_demo_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
import datetime
import queue
...
class DemoAgentTest(unittest.TestCase):
    ...
    def test_demo_agent_stream(self):
        ...
        result = instance.run(
            input="你来自哪里，名字是什么,请详细介绍一下数据库",
            output_stream=output_stream,
            scene_code="billing_center_test",
        )
        print(result)
