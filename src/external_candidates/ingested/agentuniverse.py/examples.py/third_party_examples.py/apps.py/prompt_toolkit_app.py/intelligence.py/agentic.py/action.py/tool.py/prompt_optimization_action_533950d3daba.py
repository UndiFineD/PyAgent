...
class PromptOptimizationAction(Tool):
    ...
    def run(
        self, introduction: str, target: str, instruction: str, **kwargs
    ) -> Dict[str, Any]:
            ...
            response = {
                ...
                "optimized_prompt": {
                    "introduction": self._extract_section(
                        result.optimized_prompt, "介绍："
                    ),
                    "target": self._extract_section(result.optimized_prompt, "目标："),
                    "instruction": self._extract_section(
                        result.optimized_prompt, "指令："
                    ),
                },
                "optimization_result": {
                    ...
                    "strategies_used": [
                        s.value for s in result.optimization_strategies
                    ],
                },
                "quality_analysis": {
