...
class PromptToolkit:
    ...
    def generate_prompt_from_request(
        ...
        metadata = {
            ...
            "strategies_used": (
                [s.value for s in self.config.optimization_strategies]
                if self.config.enable_auto_optimization
                else []
            ),
        }
    ...
    def optimize_existing_prompt(
        ...
        return self.optimizer.optimize_prompt(
            prompt, strategies or self.config.optimization_strategies
        )
    ...
    def analyze_prompt_quality(self, prompt: AgentPromptModel) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_score": sum(score.score for score in quality_scores)
            / len(quality_scores),
    ...
    def compare_prompts(
        self, prompt1: AgentPromptModel, prompt2: AgentPromptModel
    ) -> Dict[str, Any]:
        """Compare two prompts.
        ...
        comparison = {
            ...
            "score_difference": abs(
                analysis1["overall_score"] - analysis2["overall_score"]
            ),
    ...
    def export_prompt_config(
        self, prompt: AgentPromptModel, format_type: str = "yaml"
    ) -> str:
