# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\primary_chinese_teacher_agent\bootstrap\intelligence\mcp_application.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
