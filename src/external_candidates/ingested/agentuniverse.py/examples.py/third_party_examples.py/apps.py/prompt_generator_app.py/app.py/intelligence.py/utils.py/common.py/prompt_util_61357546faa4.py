# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_generator_app\app\intelligence\utils\common\prompt_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class PromptUtil:
    ...
    def validate_prompt_format(prompt_text: str) -> Dict[str, Any]:
        ...
        """
        result = {"is_valid": True, "errors": [], "warnings": [], "statistics": {}}
    ...
    def analyze_prompt_complexity(prompt_text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "readability": (
                ...
                else "medium" if complexity_score < 0.7 else "low"
            ),
        }
    ...
    def generate_prompt_preview(
        prompt_text: str, sample_variables: Optional[Dict[str, str]] = None
    ) -> str:
    ...
    def compare_prompts(prompt1: str, prompt2: str) -> Dict[str, Any]:
        ...
        similarity_score = (
            len(common_words) / len(words1 | words2) if (words1 | words2) else 0
        )
