# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_generator_app\scripts\generate_prompt.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
Usage Examples:
  ...
  python scripts/generate_prompt.py --list-types
    ...
    parser.add_argument(
        "--requirements", "-r", help="Specific requirements description"
    )
    parser.add_argument("--version", "-v", help="Version name")
    parser.add_argument("--output", "-o", help="Output file path")
    parser.add_argument(
        "--list-types", action="store_true", help="List supported agent types"
    )
    ...
    if args.list_types:
        ...
        for (
            agent_type,
            name,
        ) in PromptTemplateHelper.get_supported_agent_types().items():
    ...
    try:
        ...
        print("\nUsage instructions:")
        print(
            "1. Place the generated YAML file in intelligence/agentic/prompt/ directory"
        )
