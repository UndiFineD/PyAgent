# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\openai_protocol_app\intelligence\agentic\agent\agent_template\openai_protocol_executing_agent.py
...
class ExecutingOpenAIAgentTemplate(OpenAIProtocolTemplate, ExecutingAgentTemplate):
    ...
    def customized_execute(
        ...
        **kwargs,
        ...
        return ExecutingAgentTemplate.customized_execute(
            self, input_object, agent_input, memory, llm, prompt, **kwargs
        )
    ...
    def parse_input(self, input_object: InputObject, agent_input: dict) -> dict:
        self.add_output_stream(
            input_object.get_data("output_stream", None), "## Executing  \n\n"
        )
