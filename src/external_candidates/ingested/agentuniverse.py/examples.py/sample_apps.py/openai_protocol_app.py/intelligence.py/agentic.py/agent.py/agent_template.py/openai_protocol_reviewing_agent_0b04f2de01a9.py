# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\openai_protocol_app\intelligence\agentic\agent\agent_template\openai_protocol_reviewing_agent.py
...
class ReviewingOpenAIAgentTemplate(OpenAIProtocolTemplate, ReviewingAgentTemplate):
    ...
    def parse_input(self, input_object: InputObject, agent_input: dict) -> dict:
        self.add_output_stream(
            input_object.get_data("output_stream", None), "## Reviewing \n\n"
        )
