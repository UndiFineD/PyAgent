# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\discussion_group_app\intelligence\agentic\agent\agent_instance\discussion_agent_case\participant_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
