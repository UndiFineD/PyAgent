# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\toolkit_demo_app\intelligence\test\run_demo_agent_with_mcp_toolkit.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
if __name__ == "__main__":
    ...
    chat(
        f"查看{absolute_path}中的内容，并找到用户goldenhawk15的密码，然后也在同样的路径下创建一个新的docx文件把密码写进去"
    )
