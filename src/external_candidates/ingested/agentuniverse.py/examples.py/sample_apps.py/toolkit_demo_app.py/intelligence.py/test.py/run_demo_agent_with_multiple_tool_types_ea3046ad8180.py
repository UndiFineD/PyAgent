# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\toolkit_demo_app\intelligence\test\run_demo_agent_with_multiple_tool_types.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def chat(question: str):
    instance: Agent = AgentManager().get_instance_obj(
        "demo_agent_with_multiple_tool_types"
    )
...
if __name__ == "__main__":
    ...
    chat(
        f"帮我查一查五一假期适合游玩的城市或景点（不少于10个），分别给出对应城市或景点的详细介绍（100字左右）、推荐理由、参考资料地址，"
