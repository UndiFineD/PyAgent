# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\rag_app\intelligence\test\legal_advice_rag_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
if __name__ == "__main__":
    chat(
        "张三在景区拍摄景区风景，李四闯入了镜头并被拍下。李四能否起诉张三侵犯肖像权，能否要求删除照片"
    )
