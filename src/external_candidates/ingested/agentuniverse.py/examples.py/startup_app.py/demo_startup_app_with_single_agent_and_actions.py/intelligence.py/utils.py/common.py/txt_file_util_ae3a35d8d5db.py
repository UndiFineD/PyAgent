# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\startup_app\demo_startup_app_with_single_agent_and_actions\intelligence\utils\common\txt_file_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
