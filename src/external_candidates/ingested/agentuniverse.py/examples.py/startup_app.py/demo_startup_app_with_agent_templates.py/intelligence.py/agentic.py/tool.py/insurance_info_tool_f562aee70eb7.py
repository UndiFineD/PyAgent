# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\startup_app\demo_startup_app_with_agent_templates\intelligence\agentic\tool\insurance_info_tool.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
