# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\startup_app\demo_startup_app_with_agent_templates\intelligence\agentic\agent\agent_instance\insurance_executing_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class InsuranceExecutingAgent(Agent):
    ...
    def execute(self, input_object: InputObject, agent_input: dict, **kwargs) -> dict:
        search_tool: Tool = ToolManager().get_instance_obj(
