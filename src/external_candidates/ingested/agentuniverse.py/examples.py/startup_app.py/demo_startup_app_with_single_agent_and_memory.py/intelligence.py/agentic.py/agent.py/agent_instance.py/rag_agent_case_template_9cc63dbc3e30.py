# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\startup_app\demo_startup_app_with_single_agent_and_memory\intelligence\agentic\agent\agent_instance\rag_agent_case_template.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class RagAgentCaseTemplate(RagAgentTemplate):
    def execute_query(self, input: str):
        ...
        agent_instance: AgentTemplate = AgentManager().get_instance_obj(
            "question_agent_case"
        )
