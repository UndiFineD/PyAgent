# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\animal\2d_kpt_sview_rgb_img\topdown_heatmap\macaque\res152_macaque_256x192.py
_base_ = [
