# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\animal\2d_kpt_sview_rgb_img\topdown_heatmap\atrw\hrnet_w48_atrw_256x256.py
_base_ = [
