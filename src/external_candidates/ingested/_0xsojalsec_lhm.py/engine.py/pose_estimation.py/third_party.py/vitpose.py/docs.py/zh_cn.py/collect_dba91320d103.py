# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\docs\zh_cn\collect.py
#!/usr/bin/env python
    ...
    for dataset, keywords in datasets.items():
        ...
        for keyword, info in keywords.items():
            ...
            lines += [
                "<br/>",
                "",
                (f'### {" + ".join(keyword_strs)}' f" on {titlecase(dataset)}"),
                "",
                info,
                "",
            ]
