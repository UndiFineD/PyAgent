# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\coco\vitPose+_huge_coco+aic+mpii+ap10k+apt36k+wholebody_256x192_udp.py
_base_ = [
