# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\backbones\shufflenet_v1.py
...
class ShuffleNetV1(BaseBackbone):
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            ...
            raise TypeError(
                "pretrained must be a str or None. But received " f"{type(pretrained)}"
            )
