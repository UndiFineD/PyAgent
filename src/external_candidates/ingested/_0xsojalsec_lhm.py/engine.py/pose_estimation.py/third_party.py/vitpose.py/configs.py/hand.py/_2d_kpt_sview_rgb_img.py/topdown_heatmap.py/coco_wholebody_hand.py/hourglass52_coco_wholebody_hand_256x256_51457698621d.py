# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\hand\2d_kpt_sview_rgb_img\topdown_heatmap\coco_wholebody_hand\hourglass52_coco_wholebody_hand_256x256.py
_base_ = [
