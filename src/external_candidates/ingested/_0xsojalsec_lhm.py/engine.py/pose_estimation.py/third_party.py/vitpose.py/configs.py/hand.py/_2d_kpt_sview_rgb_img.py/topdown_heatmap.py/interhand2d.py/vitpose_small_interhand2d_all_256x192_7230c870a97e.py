# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\hand\2d_kpt_sview_rgb_img\topdown_heatmap\interhand2d\ViTPose_small_interhand2d_all_256x192.py
_base_ = [
