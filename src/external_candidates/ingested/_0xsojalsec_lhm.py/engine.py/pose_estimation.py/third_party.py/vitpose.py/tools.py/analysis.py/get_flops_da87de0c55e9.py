# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\analysis\get_flops.py
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "-n",
        action="store_true",
        help="Whether to print complexity information" "for each layer in a model",
    )
