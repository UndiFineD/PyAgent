# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_backward_compatibility\test_dataset_info_compatibility\test_bottom_up_dataset_compatibility.py
