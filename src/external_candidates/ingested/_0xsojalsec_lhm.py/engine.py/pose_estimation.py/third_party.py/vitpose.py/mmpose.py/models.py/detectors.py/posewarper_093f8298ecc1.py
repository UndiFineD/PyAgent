# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\detectors\posewarper.py
...
class PoseWarper(TopDown):
    ...
    def forward_dummy(self, img):
        ...
        assert batch_size > 1, (
            "Input batch size to PoseWarper " "should be larger than 1."
        )
        if batch_size == 2:
            warnings.warn(
