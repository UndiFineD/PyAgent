# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\heads\ae_multi_stage_head.py
        ...
        for i in range(self.num_stages):
            if identity_final_layer:
                ...
                final_layer = build_conv_layer(
                    ...
                    in_channels=(
                        num_deconv_filters[-1] if num_deconv_layers > 0 else in_channels
                    ),
