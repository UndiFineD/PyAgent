# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\blocks\dinov2.py
# Multi-HMR
...
class Dinov2Backbone(nn.Module):
    ...
    def forward(self, x):
        ...
        y = self.encoder.get_intermediate_layers(x)[
            0
