# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\encoders\dino_wrapper.py
...
class DinoWrapper(nn.Module):
    ...
    def __init__(
        self, model_name: str, freeze: bool = True, encoder_feat_dim: int = 384
    ):
        super().__init__()
    ...
    def _build_dino(
        ...
        try:
            ...
            if proxy_error_retries > 0:
                print(
                    f"Huggingface ProxyError: Retrying ({proxy_error_retries}) in {proxy_error_cooldown} seconds..."
                )
                import time
