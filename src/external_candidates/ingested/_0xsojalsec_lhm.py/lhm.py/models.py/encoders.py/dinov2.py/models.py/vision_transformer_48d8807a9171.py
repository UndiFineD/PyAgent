# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\encoders\dinov2\models\vision_transformer.py
    ...
    def forward_features(self, x, masks=None, mod=None):
        if isinstance(x, list):
            raise DeprecationWarning(
                "forward_features_list is deprecated, use forward_features"
            )
