# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\encoders\dinov2\hub\backbones.py
...
def _make_dinov2_model(
    ...
    **kwargs,
    ...
    if pretrained:
        ...
        state_dict = {
            k: v for k, v in state_dict.items() if "mask_token" not in k
        }  # DDP concern
