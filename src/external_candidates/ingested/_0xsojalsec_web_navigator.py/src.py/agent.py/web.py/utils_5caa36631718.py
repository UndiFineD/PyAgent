# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Web-Navigator\src\agent\web\utils.py
import ast
import re
...
def extract_agent_data(text):
    ...
    if action_input_match:
        ...
        try:
            ...
            result["Action Input"] = ast.literal_eval(
                action_input_str.replace("null", "None")
                .replace("true", "True")
                .replace("false", "False")
            )
