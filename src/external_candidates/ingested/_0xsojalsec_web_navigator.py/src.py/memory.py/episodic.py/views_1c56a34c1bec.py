...
class Memory(BaseModel):
    ...
    summary: str = Field(
        ..., description="Describes what the conversation accomplished."
    )
    what_worked: str = Field(
        ..., description="Highlights the most effective strategy used."
    )
    what_to_avoid: str = Field(
        ..., description="Describes the important pitfalls to avoid."
    )
...
class Memories(BaseModel):
    memories: list[Memory] = Field(
        description="The list of memories", default_factory=list
    )
