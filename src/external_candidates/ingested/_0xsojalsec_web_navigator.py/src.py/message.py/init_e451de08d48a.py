# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Web-Navigator\src\message\__init__.py
import base64
import re
from abc import ABC
...
class ImageMessage(BaseMessage):
    def __init__(self, text: str = None, image_path: str = None, image_obj: str = None):
        ...
        if image_obj is not None or image_path is None:
            ...
            raise Exception(
                "image_path and image_base_64 cannot be both None or both not None"
            )
