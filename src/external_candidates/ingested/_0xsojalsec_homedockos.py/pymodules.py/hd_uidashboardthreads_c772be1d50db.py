...
download_data_thread = Thread(
    target=update_download_data_thread, args=(interface_name,), daemon=True
)
...
upload_data_thread = Thread(
    target=update_upload_data_thread, args=(interface_name,), daemon=True
)
