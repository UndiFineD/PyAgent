...
def is_internal_volume_path(volume_path, container_name):
    ...
    app_data_container_path = os.path.normpath(
        os.path.join(app_data_path, container_name)
    )

    if volume_path.startswith(app_data_container_path):
        return True

    app_folders_container_path = os.path.normpath(
        os.path.join(app_folders_path, container_name)
    )
