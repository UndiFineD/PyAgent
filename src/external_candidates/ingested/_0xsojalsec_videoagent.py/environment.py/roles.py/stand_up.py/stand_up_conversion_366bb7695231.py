# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\environment\roles\stand_up\stand_up_conversion.py
import json
import os
...
class StandUpConversion(BaseTool):
    """
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        ...
        metadata_path: str = Field(
            ..., description="Path to the metadata of the stand-up comedy script"
        )
