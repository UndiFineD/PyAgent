...
class SVCConversion(BaseTool):
    ...
    def execute(self, **kwargs):
        ...
        # 解析原始文本
        original_segments, ap_time_ranges = self.parse_text_to_segments(
            original_text, durations
        )
        ...
        # 生成文本段落 chunks
        text_chunks = [
            {"timestamp": seg["end"], "content": seg["text"]}
        ...
        # 生成最终格式
        chunks = [
            {"id": idx, "timestamp": ts, "content": content}
