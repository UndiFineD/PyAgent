# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\DiffSinger\data_gen\tts\txt_processors\zh_g2pM.py
import re
...
class TxtProcessor(zh.TxtProcessor):
    ...
    def process(cls, txt, pre_align_args):
        ...
        assert len(ph_list) == len([s for s in seg_list if s != "#"]), (
            ph_list,
            seg_list,
        )
