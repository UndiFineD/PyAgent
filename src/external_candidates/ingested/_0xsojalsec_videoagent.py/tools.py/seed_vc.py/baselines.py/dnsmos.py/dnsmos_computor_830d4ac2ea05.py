# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\seed-vc\baselines\dnsmos\dnsmos_computor.py
import glob
...
class DNSMOSComputer:
    def __init__(
        ...
        self.mel_transform = torchaudio.transforms.MelSpectrogram(**kwargs).to(
            f"cuda:{device_id}"
        )
