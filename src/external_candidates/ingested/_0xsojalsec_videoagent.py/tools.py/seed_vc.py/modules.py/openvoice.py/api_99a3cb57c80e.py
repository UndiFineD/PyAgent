# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\seed-vc\modules\openvoice\api.py
import os
import re
...
class ToneColorConverter(OpenVoiceBaseClass):
    ...
    def convert(
        self, src_waves, src_wave_lengths, src_se, tgt_se, tau=0.3, message="default"
    ):
        hps = self.hps
        # load audio
        with torch.no_grad():
