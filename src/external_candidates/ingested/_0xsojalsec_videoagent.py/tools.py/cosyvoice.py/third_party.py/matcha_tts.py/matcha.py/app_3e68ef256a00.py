# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\CosyVoice\third_party\Matcha-TTS\matcha\app.py
import tempfile
...
assert_model_downloaded(
    MATCHA_TTS_LOC("matcha_ljspeech"), MATCHA_URLS["matcha_ljspeech"]
)
    ...
    * Is very fast to synthesise from
    ...
    with gr.Blocks(
        ...
        with gr.Box():
            ...
            with gr.Row():
                text = gr.Textbox(
                    value="", lines=2, label="Text to synthesise", scale=3
                )
        ...
        with gr.Box():
            with gr.Row():
                ...
                phonetised_text = gr.Textbox(
                    interactive=False, scale=10, label="Phonetised text"
                )
