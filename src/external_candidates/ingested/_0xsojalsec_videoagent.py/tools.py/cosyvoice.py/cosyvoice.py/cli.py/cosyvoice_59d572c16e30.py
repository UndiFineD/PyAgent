# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\CosyVoice\cosyvoice\cli\cosyvoice.py
...
class CosyVoice:
    ...
    def inference_cross_lingual(
        self, tts_text, prompt_speech_16k, stream=False, speed=1.0, text_frontend=True
    ):
        for i in tqdm(
            self.frontend.text_normalize(
                tts_text, split=True, text_frontend=text_frontend
