# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhisperLiveKit\whisperlivekit\diarization\diart_backend.py
import asyncio
import logging
import re
import threading
            ...
            if punctuation_token.start > segment["end"]:
                ...
                if before_length > after_length:
                    ...
                    if i < len(punctuation_tokens) - 1 and ind - 1 >= 0:
                        segments_concatenated[ind - 1]["begin"] = punctuation_tokens[
                            i - 1
                        ].end
                break
