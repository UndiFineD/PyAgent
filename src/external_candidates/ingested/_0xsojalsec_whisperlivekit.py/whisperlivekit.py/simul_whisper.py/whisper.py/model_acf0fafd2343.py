# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhisperLiveKit\whisperlivekit\simul_whisper\whisper\model.py
import base64
import gzip
...
class ResidualAttentionBlock(nn.Module):
    def __init__(
        ...
        self.attn = MultiHeadAttention(
            n_state, n_head, cache_id=f"{cache_id}_self_attn"
        )
