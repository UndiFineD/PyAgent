# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IC9600\train.py
...
if __name__ == "__main__":
    ...
    Scheduler = optim.lr_scheduler.MultiStepLR(
        Opmimizer, milestones=args.milestone, gamma=args.lr_decay_rate
    )
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        torch.save(
            model.state_dict(),
            os.path.join(args.ck_save_dir, "ck_{}.pth".format(epoch)),
        )
