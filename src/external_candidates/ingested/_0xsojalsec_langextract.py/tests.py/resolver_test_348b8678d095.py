# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\resolver_test.py
...
class ParserTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        dict(
            ...
            expected_exception=resolver_lib.ResolverParsingError,
            expected_regex=(
                ".*Content must be a mapping with an" f" '{data.EXTRACTIONS_KEY}' key.*"
            ),
        ),
    )
    ...
    @parameterized.named_parameters(
        ...
        (
            ...
            [
                ...
                [data.Extraction(extraction_class="word", extraction_text="en–dashes")],
            ],
