# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KFDtool\fw\KFDtool\driverlib\MSP430F5xx_6xx\yacctab.py
...
_lr_productions = [
    ...
    (
        ...
        "specifier_qualifier_list_opt",
        1,
        "p_specifier_qualifier_list_opt",
        "plyparser.py",
        42,
    ),
    (
