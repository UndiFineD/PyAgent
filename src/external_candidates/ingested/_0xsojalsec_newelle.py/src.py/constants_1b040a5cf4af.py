# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\constants.py
...
from .handlers.memory import MemoripyHandler, SummaryMemoripyHanlder, UserSummaryHandler
from .handlers.rag import LlamaIndexHanlder
from .handlers.stt import (
    CustomSRHandler,
    GoogleSRHandler,
    GroqSRHandler,
    OpenAISRHandler,
...
from .handlers.websearch import DDGSeachHandler, SearXNGHandler, TavilyHandler
...
AVAILABLE_LLMS = {
    ...
    "local": {
        ...
        "title": _("Local Model"),
        "description": _(
            "NO GPU SUPPORT, USE OLLAMA INSTEAD. Run a LLM model locally, more privacy but slower"
        ),
    ...
    "openai": {
        ...
        "title": _("OpenAI API"),
        "description": _(
            "OpenAI API. Custom endpoints supported. Use this for custom providers"
        ),
        "class": OpenAIHandler,
    },
    "claude": {
        ...
        "description": _(
            "Official APIs for Anthropic Claude's models, with image and file support, requires an API key"
        ),
        "class": ClaudeHandler,
        "secondary": True,
    },
...
AVAILABLE_STT = {
    "whispercpp": {
        ...
        "title": _("Whisper C++"),
        "description": _(
            "Works offline. Optimized Whisper impelementation written in C++"
        ),
    ...
    "witai": {
        ...
        "title": _("Wit AI"),
        "description": _(
            "wit.ai speech recognition free API (language chosen on the website)"
        ),
...
AVAILABLE_TTS = {
    ...
    "custom_command": {
        ...
        "title": _("Custom Command"),
        "description": _(
            "Use a custom command as TTS, {0} will be replaced with the text"
        ),
...
AVAILABLE_EMBEDDINGS = {
    "wordllama": {
        ...
        "title": _("WordLlama"),
        "description": _(
            "Light local embedding model based on llama. Works offline, very low resources usage"
        ),
...
AVAILABLE_MEMORIES = {
    ...
    "memoripy": {
        ...
        "title": _("Memoripy"),
        "description": _(
            "Extract messages from previous conversations using contextual memory retrivial, memory decay, concept extraction and other advanced techniques. Does 1 llm call per message."
        ),
...
AVAILABLE_RAGS = {
    "llamaindex": {
        ...
        "description": _(
            "Classic RAG approach - chunk documents and embed them, then compare them to the query and return the most relevant documents"
        ),
...
AVAILABLE_PROMPTS = [
    {
        ...
        "description": _(
            "General purpose prompt to enhance the LLM answers and give more context"
        ),
        "editable": True,
...
SETTINGS_GROUPS = {
    ...
    "general": {
        ...
        "description": _(
            "General settings, virtualization, offers, memory length, automatically generate chat name, current folder..."
        ),
    },
    "prompts": {
        "title": _("Prompts"),
