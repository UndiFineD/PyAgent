...
def get_settings_dict_by_groups(
    settings, groups: list, settings_groups: dict, blacklisted_keys: list = []
):
    """
...
def restore_settings_from_dict_by_groups(
    settings, settings_dict, groups: list, settings_groups: dict
):
    """
