# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\shortcuts.py
...
class Shortcuts(Gtk.Window):
    def __init__(self, app, *args, **kwargs):
        ...
        gr.append(
            Gtk.ShortcutsShortcut(title=_("Reload folder"), accelerator="<primary>r")
        )
        gr.append(Gtk.ShortcutsShortcut(title=_("New tab"), accelerator="<primary>t"))
        gr.append(
            Gtk.ShortcutsShortcut(title=_("Paste Image"), accelerator="<primary>v")
        )
        gr.append(
            Gtk.ShortcutsShortcut(
                title=_("Focus message box"), accelerator="<primary>l"
            )
        )
        gr.append(
            Gtk.ShortcutsShortcut(
                title=_("Start/stop recording"), accelerator="<primary>g"
            )
        )
        ...
        gr.append(
            Gtk.ShortcutsShortcut(title=_("Zoom in"), accelerator="<primary>plus")
        )
        gr.append(
            Gtk.ShortcutsShortcut(title=_("Zoom out"), accelerator="<primary>minus")
        )
