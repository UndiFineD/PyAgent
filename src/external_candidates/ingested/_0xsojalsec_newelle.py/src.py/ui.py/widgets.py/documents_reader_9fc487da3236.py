# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\documents_reader.py
import os
...
class DocumentReaderWidget(Gtk.Box):
    def __init__(self, **kwargs):
        ...
        self._document_widgets = (
            {}
        )  # Store revealer, spinner, spinner_revealer per file_path
    ...
    def finish_reading(self, final_message="Finished reading documents."):
        ...
        for file_path, (
            ...
            spinner,
            spinner_revealer,
        ) in self._document_widgets.items():
