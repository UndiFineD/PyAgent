# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\thinking.py
...
class ThinkingWidget(Gtk.Box):
    ...
    def __init__(self, **kwargs):
        ...
        self.spinner = Gtk.Spinner(spinning=False, visible=False)  # Hide initially

        # Icon to show when thinking is finished
        self.finished_icon = Gtk.Image(
            icon_name="brain-augemnted-symbolic", visible=True
        )
    ...
    def _update_ui_start_thinking(self, initial_message):
        ...
        self.expander.set_subtitle(
            _("The LLM is thinking... Expand to see thought process")
        )
