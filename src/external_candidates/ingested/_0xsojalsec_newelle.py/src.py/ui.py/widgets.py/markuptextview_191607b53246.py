# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\markuptextview.py
...
class MarkupTextView(Gtk.TextView):
    def __init__(self, **kwargs):
        ...
        apply_css_to_widget(self, ".scroll { background-color: rgba(0,0,0,0);}")
