# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\profilerow.py
...
class ProfileRow(Adw.ActionRow):
    def __init__(
        ...
        super().__init__(
            height_request=50, width_request=250, use_markup=False, activatable=False
        )
        ...
        if selected:
            checkmark = Gtk.Image(
                focusable=False, halign=Gtk.Align.END, valign=Gtk.Align.END
            )
