# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\terminal_dialog.py
import sys
...
class TerminalDialog(Adw.Dialog):
    ...
    def closing_terminal(self, *args):
        ...
        dialog = Adw.AlertDialog(
            body="Do you want to send the output of the terminal to the LLM to get a response?\nNote: Only the visible text will be sent as response",
            title="Send output?",
        )
