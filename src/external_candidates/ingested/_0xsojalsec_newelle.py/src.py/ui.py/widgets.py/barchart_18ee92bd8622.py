# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\widgets\barchart.py
...
class BarChartBox(Gtk.Box):
    def __init__(self, data_dict, percentages):
        ...
        for label, value in self.data_dict.items():
            ...
            label = Gtk.Label(
                label=label, wrap=True, wrap_mode=Pango.WrapMode.WORD_CHAR
            )
