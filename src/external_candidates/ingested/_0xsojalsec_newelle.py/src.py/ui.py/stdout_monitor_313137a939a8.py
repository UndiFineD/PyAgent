# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\ui\stdout_monitor.py
import gettext
...
class StdoutMonitorDialog:
    ...
    def show_window(self):
        ...
        clear_button = Gtk.Button(
            icon_name="edit-clear-all-symbolic", css_classes=["flat"]
        )
