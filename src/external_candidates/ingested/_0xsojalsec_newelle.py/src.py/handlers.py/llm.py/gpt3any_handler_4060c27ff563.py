# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\llm\gpt3any_handler.py
    ...
    def init_client(self):
        ...
        self.client = g4f.client.Client(
            provider=RetryProvider(
                [
                    RetryProvider(good_providers),
                    RetryProvider(good_nongpt_providers),
                    RetryProvider(acceptable_providers),
                ],
                shuffle=False,
            )
        )
