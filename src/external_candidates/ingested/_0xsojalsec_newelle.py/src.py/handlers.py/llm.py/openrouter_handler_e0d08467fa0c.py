# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\llm\openrouter_handler.py
    ...
    def get_extra_settings(self) -> list:
        ...
        r += [
            ExtraSettings.ComboSetting(
                "sorting",
                _("Provider Sorting"),
                _("Choose providers based on pricing/throughput or latency"),
                (
                    (_("Price"), "price"),
            ...
            ExtraSettings.ToggleSetting(
                "fallback",
                _("Allow Fallbacks"),
                _("Allow fallbacks to other providers"),
                True,
            ),
        ]
        return r
