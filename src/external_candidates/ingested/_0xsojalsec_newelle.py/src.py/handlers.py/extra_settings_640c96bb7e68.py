# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\extra_settings.py
...
class ExtraSettings:
    ...
    def DownloadSetting(
        ...
        is_installed: bool,
        callback: Callable,
        download_percentage: Callable,
        download_icon: str | None = None,
        folder: str | None = None,
        website: str | None = None,
        update_settings: bool = False,
        refresh: Callable | None = None,
