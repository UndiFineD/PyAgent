# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\websearch\duckduckgo_handler.py
    ...
    def get_extra_settings(self) -> list:
        return [
            ...
            ExtraSettings.EntrySetting(
                "region", _("Region"), _("Region for the search results"), "us-en"
            ),
        ]
