# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\stt\googlesr_handler.py
        ...
        return [
            {
                ...
                "title": _("API Key"),
                "description": _(
                    "API Key for Google SR, write 'default' to use the default one"
                ),
                "type": "entry",
                "default": "default",
                "password": True,
