# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-openpose\examples\tutorial_api_python\08_heatmaps_from_image.py
# From Python
...
try:
    ...
    outputImageF = (outputImageF * 255.0).astype(dtype="uint8")
