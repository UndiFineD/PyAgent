# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\src\rlm\__init__.py
"""Recursive Language Models for unbounded context processing."""

from typing import Any, Optional

from .config import SandboxType, get_settings
from .core_dspy import MaxDepthError, MaxIterationsError, RLMDSPy, RLMError
from .graph import GraphNode, REPLStep, RLMGraphTracker
from .repl import REPLError

__version__ = "0.2.0"


def create_rlm(model: str, sandbox: SandboxType = "auto", **kwargs: Any):
    """
...
class RLM:
    ...
    def __new__(cls, model: str, sandbox: SandboxType = "auto", **kwargs: Any):
        """
