# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\src\rlm\config.py
...
class RLMSettings:
    ...
    def from_env(cls) -> "RLMSettings":
        ...
        return cls(sandbox=sandbox, e2b_api_key=e2b_api_key)  # type: ignore
