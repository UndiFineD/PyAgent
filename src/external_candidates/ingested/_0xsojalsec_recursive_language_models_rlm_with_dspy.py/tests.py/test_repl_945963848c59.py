# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\tests\test_repl.py
"""Tests for REPL executor."""

import re

import pytest
from rlm.repl import REPLError, REPLExecutor
...
def test_augmented_assignment(repl):
    """Test that augmented assignment operators work."""
    code = """
total = 0
for i in range(5):
    total += i
