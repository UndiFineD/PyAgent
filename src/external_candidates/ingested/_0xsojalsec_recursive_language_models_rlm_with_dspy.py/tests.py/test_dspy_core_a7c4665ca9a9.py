# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\tests\test_dspy_core.py
"""Tests for DSPy-based RLM core."""

from unittest.mock import Mock, patch

import pytest
from rlm.core_dspy import MaxDepthError, RLMDSPy, RLMError
...
class TestRLMDSPy:
    ...
    def test_initialization(self):
        ...
        try:
            rlm = RLMDSPy(model="gpt-4o-mini", max_depth=3, max_iterations=10)
    ...
    def test_max_depth_check(self):
        ...
        try:
            rlm = RLMDSPy(model="gpt-4o-mini", max_depth=1, _current_depth=1)
    ...
    def test_recursive_model(self):
        ...
        try:
            rlm = RLMDSPy(model="gpt-4o", recursive_model="gpt-4o-mini")
