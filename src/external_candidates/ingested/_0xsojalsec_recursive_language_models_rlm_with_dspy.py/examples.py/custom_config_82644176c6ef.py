# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\examples\custom_config.py
...
def error_handling_example():
    ...
    rlm = RLM(
        model="gpt-5-mini", max_iterations=3, max_depth=2  # Very low to trigger timeout
    )

    from rlm import MaxDepthError, MaxIterationsError

    try:
        # This might exceed iterations
        result = rlm.completion("Perform detailed analysis of all servers", context)
        print(f"Result: {result}")
