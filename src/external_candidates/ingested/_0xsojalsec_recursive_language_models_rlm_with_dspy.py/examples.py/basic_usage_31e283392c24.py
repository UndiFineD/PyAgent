# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\examples\basic_usage.py
...
def main():
    ...
    rlm = RLM(
        model="openrouter/anthropic/claude-haiku-4.5",  # Use mini for cheaper testing
        max_iterations=15,
        temperature=0.7,
        max_tokens=16000,
        enable_logging=True,
    ...
    query = " What were the key milestones in AI development according to this document?  what is the author of the chatgpt paper?"
    ...
    try:
        ...
        # print("\n" + "=" * 80)
        # print("LLM CALL HISTORY:")
        # print("=" * 80)
        # rlm.print_history(detailed=True)  # Set detailed=True for full prompts/responses
        ...
        # Still print history even if there's an error (useful for debugging)
        print("\n" + "=" * 80)
        print("LLM CALL HISTORY (Error occurred):")
        print("=" * 80)
