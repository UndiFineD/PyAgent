# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\examples\history_debug.py
...
def demo_detailed_history():
    ...
    rlm = RLM(model="gpt-4o-mini", enable_history=True, max_iterations=5)

    # Simple query
    result = rlm.completion(query="Count the numbers", context="Numbers: 1, 2, 3, 4, 5")
...
def demo_programmatic_access():
    ...
    result = rlm.completion(query="What is 2+2?", context="Math problem")
