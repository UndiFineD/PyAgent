# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\docker\ctfd\update_challenges.py
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Update all the challenges that are currently on the server."
    )
    parser.add_argument(
        "path", type=str, help="Path to the json file containing the challenges."
    )
