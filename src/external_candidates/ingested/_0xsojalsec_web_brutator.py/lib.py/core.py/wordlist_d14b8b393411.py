# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\core\Wordlist.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import queue
import threading
...
class Wordlist:
    ...
    def __init__(
        self, username=None, userfile=None, password=None, passfile=None, combofile=None
    ):
            ...
            with open(userfile, "r") as fu:
                for u in fu:
                    if password is not None:
                        ...
                        raise Exception(
                            "Unexpected error while building wordlist queue"
                        )
