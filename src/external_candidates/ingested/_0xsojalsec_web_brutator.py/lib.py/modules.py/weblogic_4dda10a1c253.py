# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Weblogic.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import re
...
class Weblogic:
    ...
    def check(self):
        ...
        if 'name="j_password"' in r.text:
            ...
            logger.info(
                "Weblogic administration console detected: {}".format(
                    self.interface_url
                )
            )
            logger.warning(
                "Warning: By default, Weblogic has an account lockout "
