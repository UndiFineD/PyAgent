    ...
    def check(self):
        ...
        if r.status_code == 200 and 'type="password"' in r.text.lower():
            ...
            # Versions 7/8/9
                ...
                logger.info(
                    "Coldfusion 7/8/9 administration console detected: {}".format(
                        self.interface_url
                    )
                )
                return True
            ...
            # Versions 10/11
                ...
                logger.info(
                    "Coldfusion 10/11 administration console detected: {}".format(
                        self.interface_url
                    )
                )
                return True
        ...
        if r.status_code == 200 and 'type="password"' in r.text.lower():
            ...
            # Version 5
            if (
                'name="PasswordProvided_required"' in r.text
