# Extracted from: C:\DEV\PyAgent\.external\abdarwish23-Advanced_SQL_Agent\app\config.py
# app/config.py
import os
...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv(
        "DATABASE_URL", f"sqlite:///{os.path.join(BASE_DIR, 'sql_agent_sessions.db')}"
    )
    ...
    )  # This can serve as a fallback model if needed
