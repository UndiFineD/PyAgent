# Extracted from: C:\DEV\PyAgent\.external\abdarwish23-Advanced_SQL_Agent\app\services\query_analyzer_service.py
...
from app.models import AgentState, AnalyzedQuery
...
def query_analyzer_table_selector(state: AgentState) -> AgentState:
    ...
    relevant_memories = "\n".join(
        [
            ...
            for i, memory in enumerate(state.get("relevant_memories", []))
        ]
    )
