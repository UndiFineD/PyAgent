# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMs-from-scratch\ch05\03_bonus_pretraining_on_gutenberg\prepare_dataset.py
...
if __name__ == "__main__":
    ...
    all_files = [
        ...
        for name in files
        if name.endswith((".txt", ".txt.utf8")) and "raw" not in path
    ]
