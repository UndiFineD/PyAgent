# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mast1c0re\scripts\gadgets\gadgets.py
#!/usr/bin/env python3
import argparse
import re
    ...
    with open(args.input, "r") as i:
        ...
        with open(args.output, "w") as o:
            ...
            for line in i:
                ...
                o.write(
                    f"#define {convertGadgetToDefine(gadget)} {address} // {gadget}\n"
                )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate an EBOOT gadgets header definition file."
    )
