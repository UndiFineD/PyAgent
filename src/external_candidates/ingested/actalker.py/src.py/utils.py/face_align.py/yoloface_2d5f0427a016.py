# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\utils\face_align\yoloface.py
# -*- coding: UTF-8 -*-
import os
...
class YoloFace:
    def __init__(
        self,
        pt_path="checkpoints/yolov5m-face.pt",
        confThreshold=0.5,
        nmsThreshold=0.45,
        device="cuda",
    ):
    ...
    def detect(self, srcimg):
        ...
        # t4 = time.time()
        # print('pre:{}'.format(t1-t0))
        # print('pred:{}'.format(t2-t1))
        # print('nms:{}'.format(t3-t2))
        # print('post:{}'.format(t4-t3))
...
if __name__ == "__main__":
    ...
    # cv2.imshow('111', cv2.resize(srcimg, dsize=None, fx=0.5, fy=0.5))
    # cv2.waitKey(0)
