# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\pipelines\pipeline_svd_audio_adapter_motionexp_idembed.py
import inspect
...
from src.models.audio_adapter.audio_proj import IDProjModel
