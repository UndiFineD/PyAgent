# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\pipelines\pipeline_svd_audio_adapter_motionexp_idembed_exp.py
import inspect
...
from src.models.audio_adapter.audio_proj import ExpProjModel, IDProjModel
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                for batch, index_start in enumerate(
                    ...
                    exp_embeddings_input = indice_slice(exp_embeddings, idx_list)
