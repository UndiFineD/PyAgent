# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\pipelines\pipeline_svd_audio_adapter_motionexp_idembed_auto.py
import inspect
...
from src.models.audio_adapter.audio_proj import IDProjModel, MotionControlProjModel
...
class Pose2VideoLongSVDPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        unet: UNetSpatioTemporalConditionModel,
        motion_control_proj_model: MotionControlProjModel,
        ...
        self.register_modules(
            ...
            scheduler=scheduler,
            motion_control_proj_model=motion_control_proj_model,
            ...
            for i, t in enumerate(timesteps):
                ...
                for batch, index_start in enumerate(
                    ...
                    pose_cond_fea = pose_cond_fea.repeat(
                        3 if do_classifier_free_guidance else 1, 1, 1, 1, 1
                    )
