# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\models\base\unet_spatio_temporal_condition_mambaID_v5.py
import os
...
from .TransformerSTmodel import (
    TransformerSpatioTemporalModel_mambaID_v5 as TransformerSpatioTemporalModel,
)
