# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\models\base\unet_spatio_temporal_condition_mambav1.py
import os
...
from .TransformerSTmodel import (
    TransformerSpatioTemporalModel_mambav1 as TransformerSpatioTemporalModel,
)
