# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\models\base\unet_spatio_temporal_condition_mambaID_v8_two_ip.py
import os
...
from .TransformerSTmodel import (
    TransformerSpatioTemporalModel_new_mambaID_v8_two_ip as TransformerSpatioTemporalModel,
)
