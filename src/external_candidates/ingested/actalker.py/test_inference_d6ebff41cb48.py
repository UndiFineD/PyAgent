# Extracted from: C:\DEV\PyAgent\.external\ACTalker\test_inference.py
#!/usr/bin/env python
"""
...
def main():
    ...
    if passed == total:
        ...
        print("\n📝 Next step:")
        print(
            "Run: CUDA_VISIBLE_DEVICES=7 python Inference.py --config config/inference.yaml --ref assets/ref.jpg --audio assets/audio.mp3 --video assets/video.mp4 --mode 2"
        )
        return True
    else:
