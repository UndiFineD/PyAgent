# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_messaging_init.py
...
class TestMessagingPackageExports:
    ...
    def test_expected_export_count(self):
        ...
        assert legacy_exports.issubset(
            set(messaging_package.__all__)
