# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VyvoTTS\vyvotts\train\finetune\lora.py
...
model = AutoModelForCausalLM.from_pretrained(
    model_name, attn_implementation="kernels-community/flash-attn3"
)
...
lora_config = LoraConfig(
    ...
    modules_to_save=[
        "lm_head",
        "embed_tokens",
    ],  # Optional to train the embeddings and lm head
    task_type="CAUSAL_LM",
    use_rslora=True,
)
