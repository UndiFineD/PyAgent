# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\UReader\pipeline\train.py
import argparse
...
from pipeline.utils import add_config_args, batchify, set_args
...
parser.add_argument(
    "--pretrained-ckpt",
    type=str,
    default="MAGAer13/mplug-owl-llama-7b-pt",
    help="Path to the pretrained checkpoint.",
)
parser.add_argument(
    "--inference_mode", type=bool, default=False, help="The inference mode."
)
parser.add_argument(
    "--seq-length", type=int, default=1024, help="Maximum sequence length to process."
)
...
parser.add_argument(
    "--language-training-method", type=str, default="lora", help="LORA."
)
parser.add_argument("--lora-r", type=int, default=8, help="curvature.")
parser.add_argument(
    "--lora-alpha",
    type=int,
    default=32,
...
parser.add_argument(
    "--bf16", action="store_true", default=False, help="Run model in bfloat16 mode."
)
...
parser.add_argument(
    "--mm-config",
    type=str,
    default="configs/sft/release.yaml",
    help="Multimodal Config.",
)
parser.add_argument(
    "--image-root", type=str, default="ureader_images", help="Image folder."
)
parser.add_argument(
    "--num-workers", type=int, default=8, help="Dataloader number of workers."
)
...
parser.add_argument(
    "--num-warmup-steps", type=int, default=50, help="The number of warmup steps."
)
...
# Other
parser.add_argument(
    "--gradient-checkpointing", action="store_true", help="The gradient checkpointing."
)
parser.add_argument(
    "--logging-nan-inf-filter", action="store_true", help="The logging nan inf filter."
)
parser.add_argument(
...
parser.add_argument(
    "--do-train", action="store_true", default=True, help="Whether to do training."
)
...
def main():
    ...
    if args.gradient_checkpointing:
        ...
        model.language_model.get_input_embeddings().register_forward_hook(
