# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl1.5\docowl_infer.py
import os
import time
...
from mplug_docowl.conversation import SeparatorStyle, conv_templates
