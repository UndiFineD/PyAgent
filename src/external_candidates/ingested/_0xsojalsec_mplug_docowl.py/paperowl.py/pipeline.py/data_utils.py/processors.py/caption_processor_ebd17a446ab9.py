# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\pipeline\data_utils\processors\caption_processor.py
import random
            ...
            self.image_transform = transforms.Compose(
                [
                    transforms.RandomResizedCrop(
                        image_size, scale=(min_scale, 1.0), interpolation=Image.BICUBIC
                    ),
