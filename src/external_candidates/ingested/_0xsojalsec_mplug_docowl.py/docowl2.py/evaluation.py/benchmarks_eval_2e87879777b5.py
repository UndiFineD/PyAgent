# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl2\evaluation\benchmarks_eval.py
import json
import sys
...
sys.path.append("/nas-alinlp/anwenhu/code/mPLUG_github/mPLUG-DocOwl2/evaluation")
print(sys.path)
import os
import random
import re
