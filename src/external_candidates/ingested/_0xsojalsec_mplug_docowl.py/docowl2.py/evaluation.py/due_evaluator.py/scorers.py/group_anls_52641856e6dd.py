# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl2\evaluation\due_evaluator\scorers\group_anls.py
import itertools
            ...
            for value in annotation["values"]:
                flatten_items.append(
                    FuzzyAnnotation(
                        ...
                        value=value["value"],
                        value_variants=(
                            value["value_variants"] if "value_variants" in value else []
                        ),
                    )
                )
