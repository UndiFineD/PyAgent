# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\TinyChart\tinychart\data\process.py
import importlib
import os
...
def preprocess(
    ...
    return PreprocessSelect(conversation_lib.default_conversation.version)(
        sources, tokenizer, has_image
    )
