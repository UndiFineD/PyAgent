# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\TinyChart\tinychart\train\train.py
...
def train():
    ...
    data_module = make_supervised_data_module_with_eval(
