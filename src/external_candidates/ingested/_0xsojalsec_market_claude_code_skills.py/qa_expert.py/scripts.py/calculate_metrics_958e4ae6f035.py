# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\qa-expert\scripts\calculate_metrics.py
#!/usr/bin/env python3
"""
...
def calculate_metrics(csv_path):
    ...
    gates = {
        ...
        "P0 Bugs = 0": len(
            [t for t in tests if t["Bug ID"].startswith("BUG") and "P0" in t["Notes"]]
        )
        == 0,
    }
