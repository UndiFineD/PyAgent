# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\markdown-tools\scripts\convert_path.py
#!/usr/bin/env python3
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print(
            'Example: python convert_path.py "C:\\Users\\username\\Downloads\\file.doc"'
        )
        sys.exit(1)
