...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    # Setup commands
    parser.add_argument(
        "--init", action="store_true", help="Initialize ~/.transcript-fixer/"
    )
    ...
    # Learning commands
    parser.add_argument(
        "--review-learned", action="store_true", help="Review learned suggestions"
    )
    parser.add_argument(
        "--approve", nargs=2, metavar=("FROM", "TO"), help="Approve suggestion"
    )

    # Utility commands
    parser.add_argument(
        "--validate", action="store_true", help="Validate configuration and JSON files"
    )
    parser.add_argument(
        "--health", action="store_true", help="Perform system health check (P1-4 fix)"
    )
    parser.add_argument(
        "--health-level",
        dest="health_level",
    ...
    parser.add_argument(
        "--metrics", action="store_true", help="Display collected metrics (P1-7 fix)"
    )
    parser.add_argument(
        "--metrics-format",
        dest="metrics_format",
    ...
    parser.add_argument(
        "--config-path", dest="config_path", help="Path for config file operations"
    )
    parser.add_argument(
        "--env",
        dest="config_env",
