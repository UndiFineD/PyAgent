# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\tests\test_path_validator.py
#!/usr/bin/env python3
"""
...
class TestSymlinkAttacks:
    ...
    def test_symlink_allowed_when_configured(self, tmp_path):
        ...
        validator = PathValidator(allowed_base_dirs={tmp_path}, allow_symlinks=True)
...
class TestOutputPathValidation:
    ...
    def test_output_path_no_create_parent(self, tmp_path):
        ...
        with pytest.raises(
            PathValidationError, match="Parent directory does not exist"
        ):
