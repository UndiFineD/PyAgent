# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\migrations.py
#!/usr/bin/env python3
"""
...
# Latest version
LATEST_VERSION = max(
    MIGRATION_REGISTRY.keys(), key=lambda v: tuple(map(int, v.split(".")))
)
