...
def generate_full_report(
    original_file: str, stage1_file: str, stage2_file: str, output_dir: str = None
):
    """
    ...
    md_report = generate_markdown_report(
        original_file, stage1_file, stage2_file, original, stage1, stage2
    )
...
def main():
    ...
    if len(sys.argv) < 4:
        print(
            "用法: python generate_diff_report.py <原始文件> <阶段1文件> <阶段2文件> [输出目录]"
        )
        print()
        print("示例:")
