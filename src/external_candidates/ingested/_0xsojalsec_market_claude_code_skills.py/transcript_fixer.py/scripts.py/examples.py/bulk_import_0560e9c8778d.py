# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\examples\bulk_import.py
#!/usr/bin/env python3
"""
...
def import_from_dict():
    ...
    inserted, updated, skipped = service.import_corrections(
        corrections=corrections_list, merge=True
    )
...
if __name__ == "__main__":
    ...
    print("\nVerify with:")
    print(
        "  sqlite3 ~/.transcript-fixer/corrections.db 'SELECT COUNT(*) FROM active_corrections;'"
    )
