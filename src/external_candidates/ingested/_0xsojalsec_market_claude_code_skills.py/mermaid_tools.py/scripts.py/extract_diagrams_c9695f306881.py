# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\mermaid-tools\scripts\extract_diagrams.py
#!/usr/bin/env python3
"""
...
def extract_mermaid_diagrams(markdown_file, output_dir):
    ...
    for i, match in enumerate(matches, 1):
        ...
        diagrams.append({"number": i, "name": diagram_name, "content": match.strip()})
