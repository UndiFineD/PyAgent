# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\repomix-unmixer\scripts\unmix_repomix.py
#!/usr/bin/env python3
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Arguments:")
        print(
            "  repomix_file       Path to the repomix output file (XML, Markdown, or JSON)"
        )
        print(
            "  output_directory   Optional: Directory to extract files to (default: ./extracted)"
        )
        print()
        print("Examples:")
