# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\claude-code-history-files-finder\scripts\recover_content.py
#!/usr/bin/env python3
"""
...
class SessionContentRecovery:
    ...
    def generate_report(self, saved_files: List[Dict[str, Any]]) -> str:
        ...
        if saved_files:
            ...
            report_lines.append(
                "No files recovered (no matches or no Write calls found)"
            )
            report_lines.append("")
