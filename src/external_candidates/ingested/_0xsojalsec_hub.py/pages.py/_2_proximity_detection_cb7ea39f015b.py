# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-hub\pages\2_Proximity_Detection.py
import json
...
if check_password():
    ...
    st.sidebar.markdown(
        "Configure proximity detection, detect all persons in close proximity to a machine or vehicle."
    )
