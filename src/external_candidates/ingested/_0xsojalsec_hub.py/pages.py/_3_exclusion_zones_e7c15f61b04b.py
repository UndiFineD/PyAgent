# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-hub\pages\3_Exclusion_Zones.py
import functools
import json
...
if check_password():
    ...
    st.sidebar.markdown(
        "Configure exclusion zones, detect all persons, machines or vehicles in an exclusion zone."
    )
    ...
    if predictions:
        ...
        color_image = yolov7_detector.detect_zone(
            img, poly, persons, machines, vehicles, inclusion, max_number_allowed
        )
