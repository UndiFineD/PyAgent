# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Open-Source-Face-Recognition-SDK\face_feature\irn50_pytorch.py
import math
...
class irn50_pytorch(nn.Module):
    def __init__(self, weight_file):
        ...
        self.BatchNorm1 = self.__batch_normalization(
            2, "BatchNorm1", num_features=32, eps=9.999999747378752e-06, momentum=0.0
        )
        self.Convolution2 = self.__conv(
            2,
            name="Convolution2",
            in_channels=32,
            out_channels=32,
        ...
        self.BatchNorm2 = self.__batch_normalization(
            2, "BatchNorm2", num_features=32, eps=9.999999747378752e-06, momentum=0.0
        )
        self.Convolution3 = self.__conv(
            2,
            name="Convolution3",
            in_channels=32,
            out_channels=64,
        ...
        self.BatchNorm3 = self.__batch_normalization(
            2, "BatchNorm3", num_features=64, eps=9.999999747378752e-06, momentum=0.0
        )
        self.Convolution4 = self.__conv(
            2,
            name="Convolution4",
            in_channels=64,
            out_channels=80,
        ...
        self.BatchNorm4 = self.__batch_normalization(
            2, "BatchNorm4", num_features=80, eps=9.999999747378752e-06, momentum=0.0
        )
        self.Convolution5 = self.__conv(
            2,
            name="Convolution5",
            in_channels=80,
            out_channels=192,
        ...
        self.BatchNorm5 = self.__batch_normalization(
            2, "BatchNorm5", num_features=192, eps=9.999999747378752e-06, momentum=0.0
        )
        self.Convolution6 = self.__conv(
            2,
            name="Convolution6",
            in_channels=192,
            out_channels=256,
        ...
        self.BatchNorm6 = self.__batch_normalization(
            2, "BatchNorm6", num_features=256, eps=9.999999747378752e-06, momentum=0.0
        )
        self.conv2_res1_proj = self.__conv(
            2,
        ...
        self.conv2_res1_conv1 = self.__conv(
            2,
        ...
        self.conv2_res1_conv1_bn = self.__batch_normalization(
            2,
            "conv2_res1_conv1_bn",
            num_features=64,
        ...
        self.conv2_res1_conv2 = self.__conv(
            2,
        ...
        self.conv2_res1_conv2_bn = self.__batch_normalization(
            2,
            "conv2_res1_conv2_bn",
            num_features=64,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res1_conv3 = self.__conv(
            2,
        ...
        self.conv2_res2_pre_bn = self.__batch_normalization(
            2,
            "conv2_res2_pre_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res2_conv1 = self.__conv(
            2,
        ...
        self.conv2_res2_conv1_bn = self.__batch_normalization(
            2,
            "conv2_res2_conv1_bn",
            num_features=64,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res2_conv2 = self.__conv(
            2,
        ...
        self.conv2_res2_conv2_bn = self.__batch_normalization(
            2,
            "conv2_res2_conv2_bn",
            num_features=64,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res2_conv3 = self.__conv(
            2,
        ...
        self.conv2_res3_pre_bn = self.__batch_normalization(
            2,
            "conv2_res3_pre_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res3_conv1 = self.__conv(
            2,
        ...
        self.conv2_res3_conv1_bn = self.__batch_normalization(
            2,
            "conv2_res3_conv1_bn",
            num_features=64,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res3_conv2 = self.__conv(
            2,
        ...
        self.conv2_res3_conv2_bn = self.__batch_normalization(
            2,
            "conv2_res3_conv2_bn",
            num_features=64,
            eps=9.999999747378752e-06,
        ...
        self.conv2_res3_conv3 = self.__conv(
            2,
        ...
        self.conv3_res1_pre_bn = self.__batch_normalization(
            2,
            "conv3_res1_pre_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res1_proj = self.__conv(
            2,
        ...
        self.conv3_res1_conv1 = self.__conv(
            2,
        ...
        self.conv3_res1_conv1_bn = self.__batch_normalization(
            2,
            "conv3_res1_conv1_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res1_conv2 = self.__conv(
            2,
        ...
        self.conv3_res1_conv2_bn = self.__batch_normalization(
            2,
            "conv3_res1_conv2_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res1_conv3 = self.__conv(
            2,
        ...
        self.conv3_res2_pre_bn = self.__batch_normalization(
            2,
            "conv3_res2_pre_bn",
            num_features=512,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res2_conv1 = self.__conv(
            2,
        ...
        self.conv3_res2_conv1_bn = self.__batch_normalization(
            2,
            "conv3_res2_conv1_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res2_conv2 = self.__conv(
            2,
        ...
        self.conv3_res2_conv2_bn = self.__batch_normalization(
            2,
            "conv3_res2_conv2_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res2_conv3 = self.__conv(
            2,
        ...
        self.conv3_res3_pre_bn = self.__batch_normalization(
            2,
            "conv3_res3_pre_bn",
            num_features=512,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res3_conv1 = self.__conv(
            2,
        ...
        self.conv3_res3_conv1_bn = self.__batch_normalization(
            2,
            "conv3_res3_conv1_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res3_conv2 = self.__conv(
            2,
        ...
        self.conv3_res3_conv2_bn = self.__batch_normalization(
            2,
            "conv3_res3_conv2_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res3_conv3 = self.__conv(
            2,
        ...
        self.conv3_res4_pre_bn = self.__batch_normalization(
            2,
            "conv3_res4_pre_bn",
            num_features=512,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res4_conv1 = self.__conv(
            2,
        ...
        self.conv3_res4_conv1_bn = self.__batch_normalization(
            2,
            "conv3_res4_conv1_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res4_conv2 = self.__conv(
            2,
        ...
        self.conv3_res4_conv2_bn = self.__batch_normalization(
            2,
            "conv3_res4_conv2_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv3_res4_conv3 = self.__conv(
            2,
        ...
        self.conv4_res1_pre_bn = self.__batch_normalization(
            2,
            "conv4_res1_pre_bn",
            num_features=512,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res1_proj = self.__conv(
            2,
        ...
        self.conv4_res1_conv1 = self.__conv(
            2,
        ...
        self.conv4_res1_conv1_bn = self.__batch_normalization(
            2,
            "conv4_res1_conv1_bn",
            num_features=128,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res1_conv2 = self.__conv(
            2,
        ...
        self.conv4_res2_pre_bn = self.__batch_normalization(
            2,
            "conv4_res2_pre_bn",
            num_features=512,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res2_conv1_proj = self.__conv(
            2,
            name="conv4_res2_conv1_proj",
            in_channels=512,
            out_channels=1024,
            kernel_size=(1, 1),
            stride=(1, 1),
        ...
        self.conv4_res2_conv1 = self.__conv(
            2,
        ...
        self.conv4_res2_conv1_bn = self.__batch_normalization(
            2,
            "conv4_res2_conv1_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res2_conv2 = self.__conv(
            2,
        ...
        self.conv4_res2_conv2_bn = self.__batch_normalization(
            2,
            "conv4_res2_conv2_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res2_conv3 = self.__conv(
            2,
        ...
        self.conv4_res3_pre_bn = self.__batch_normalization(
            2,
            "conv4_res3_pre_bn",
            num_features=1024,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res3_conv1 = self.__conv(
            2,
        ...
        self.conv4_res3_conv1_bn = self.__batch_normalization(
            2,
            "conv4_res3_conv1_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res3_conv2 = self.__conv(
            2,
        ...
        self.conv4_res3_conv2_bn = self.__batch_normalization(
            2,
            "conv4_res3_conv2_bn",
            num_features=256,
            eps=9.999999747378752e-06,
        ...
        self.conv4_res3_conv3 = self.__conv(
            2,
        ...
        self.conv5_bn = self.__batch_normalization(
            2, "conv5_bn", num_features=1024, eps=9.999999747378752e-06, momentum=0.0
        )
        self.fc1_1 = self.__dense(
            name="fc1_1", in_features=16384, out_features=512, bias=False
        )
        self.bn_fc1 = self.__batch_normalization(
            1, "bn_fc1", num_features=512, eps=9.999999747378752e-06, momentum=0.0
        )
    ...
    def forward(self, x):
        ...
        Pooling1, Pooling1_idx = F.max_pool2d(
            Pooling1_pad,
            kernel_size=(3, 3),
            stride=(2, 2),
            padding=0,
    ...
    def __batch_normalization(dim, name, **kwargs):
        ...
        if "scale" in _weights_dict[name]:
            layer.state_dict()["weight"].copy_(
                torch.from_numpy(_weights_dict[name]["scale"])
            )
        else:
