# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Open-Source-Face-Recognition-SDK\face_detect\detect_imgs.py
"""
...
from face_detect.vision.ssd.mb_tiny_fd import (
    create_mb_tiny_fd,
    create_mb_tiny_fd_predictor,
)
from face_detect.vision.ssd.mb_tiny_RFB_fd import (
...
def get_face_boundingbox(orig_image):
    ...
    boxes, labels, probs = predictor.predict(
        cv2.cvtColor(orig_image, cv2.COLOR_BGR2RGB), candidate_size / 2, threshold
    )
