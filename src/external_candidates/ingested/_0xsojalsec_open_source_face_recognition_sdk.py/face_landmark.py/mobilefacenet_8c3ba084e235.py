# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Open-Source-Face-Recognition-SDK\face_landmark\MobileFaceNet.py
import math
import pdb
...
class GDC(Module):
    def __init__(self, embedding_size):
        ...
        self.conv_6_dw = Linear_block(
            512, 512, groups=512, kernel=(4, 4), stride=(1, 1), padding=(0, 0)
        )
...
class MobileFaceNet(Module):
    def __init__(self, input_size, embedding_size=512):
        ...
        self.conv2_dw = Conv_block(
            32, 32, kernel=(3, 3), stride=(1, 1), padding=(1, 1), groups=32
        )
        self.conv_23 = Depth_Wise(
            32, 32, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=64
        )
        self.conv_3 = Residual(
            32, num_block=3, groups=64, kernel=(3, 3), stride=(1, 1), padding=(1, 1)
        )
        self.conv_34 = Depth_Wise(
            32, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=128
        )
        self.conv_4 = Residual(
            64, num_block=4, groups=128, kernel=(3, 3), stride=(1, 1), padding=(1, 1)
        )
        self.conv_45 = Depth_Wise(
            64, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=256
        )
        self.conv_5 = Residual(
            64, num_block=2, groups=128, kernel=(3, 3), stride=(1, 1), padding=(1, 1)
        )
        self.conv_6_sep = Conv_block(
            64, 512, kernel=(1, 1), stride=(1, 1), padding=(0, 0)
        )
