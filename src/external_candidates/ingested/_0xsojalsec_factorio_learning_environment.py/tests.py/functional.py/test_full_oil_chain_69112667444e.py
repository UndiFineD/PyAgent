# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\functional\test_full_oil_chain.py
import pytest
from fle.env.entities import BuildingBox, Position
