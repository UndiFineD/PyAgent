# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\functional\test_multi_drill_multi_furnace.py
import pytest
from fle.env import BuildingBox, Direction, Position
