# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\multiagent\test_actions_multiagent.py
import pytest
...
""",
    ...
    assert (
        len(trajectory_runner.agent_messages[1]) == 2
    ), "Agent 1 should have received 2 messages"
    assert (
        len(trajectory_runner.agent_messages[0]) == 2
