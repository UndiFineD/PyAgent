            ...
            "price_list": (
                {
                    ...
                    for item in flows_dict.get("price_list", [])
                }
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "research": {
                ...
                "current_research": (
                    self.research.current_research
            ...
            "task_info": {
                "goal_description": (
                    self.task_info.goal_description if self.task_info else ""
                ),
                "agent_instructions": (
                ...
                "trajectory_length": (
                    self.task_info.trajectory_length if self.task_info else 0
                ),
