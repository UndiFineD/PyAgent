# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\agent\get_resource_patch\client.py
from typing import Optional

from fle.env.entities import BoundingBox, Position, ResourcePatch
