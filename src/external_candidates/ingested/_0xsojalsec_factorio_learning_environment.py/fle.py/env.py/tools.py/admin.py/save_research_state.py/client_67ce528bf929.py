    ...
    def __call__(self) -> ResearchState:
        ...
        try:
            ...
            return ResearchState(
                ...
                current_research=(
                    state["current_research"] if "current_research" in state else None
                ),
                research_progress=(
                    state["research_progress"] if "research_progress" in state else None
                ),
                research_queue=(
                    [x for x in state["research_queue"].values()]
