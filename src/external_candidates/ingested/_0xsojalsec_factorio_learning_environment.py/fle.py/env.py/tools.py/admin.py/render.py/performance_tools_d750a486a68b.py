# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\performance_tools.py
...
class PerformanceAnalyzer:
    ...
    def get_image_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_time_per_call": (
                total_image_time / total_image_calls if total_image_calls > 0 else 0
            ),
