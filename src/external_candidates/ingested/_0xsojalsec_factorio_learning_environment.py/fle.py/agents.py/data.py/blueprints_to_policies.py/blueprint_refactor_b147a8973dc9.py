# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\data\blueprints_to_policies\blueprint_refactor.py
import json
import logging
import os
import queue
...
from fle.env import FactorioInstance, Position
...
""".strip()
    ...
    def _worker_process(self, worker_id: int):
        ...
        try:
            ...
            assert (
                expanded_copper_ore_patch.size != copper_ore_patch.size
