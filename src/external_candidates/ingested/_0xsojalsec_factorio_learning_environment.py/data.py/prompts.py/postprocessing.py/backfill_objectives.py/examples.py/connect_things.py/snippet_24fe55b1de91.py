# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\data\prompts\postprocessing\backfill_objectives\examples\connect_things\snippet.py
