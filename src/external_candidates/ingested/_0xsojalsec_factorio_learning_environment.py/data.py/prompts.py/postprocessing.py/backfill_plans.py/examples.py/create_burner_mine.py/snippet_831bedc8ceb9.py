# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\data\prompts\postprocessing\backfill_plans\examples\create_burner_mine\snippet.py
