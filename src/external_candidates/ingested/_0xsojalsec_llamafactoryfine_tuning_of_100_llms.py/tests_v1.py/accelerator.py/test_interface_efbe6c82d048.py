# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\tests_v1\accelerator\test_interface.py
...
def test_all_device():
    ...
    assert DistributedInterface().get_local_world_size() == int(
