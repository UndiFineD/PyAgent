# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\scripts\megatron_merge.py
...
import fire
import torch
from mcore_adapter.models.converter.post_converter import (
