# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\tests\check_license.py
...
def main():
    ...
    for path in path_list:
        with open(path.absolute(), encoding="utf-8") as f:
            ...
            assert all(
                keyword in file_content[0] for keyword in KEYWORDS
