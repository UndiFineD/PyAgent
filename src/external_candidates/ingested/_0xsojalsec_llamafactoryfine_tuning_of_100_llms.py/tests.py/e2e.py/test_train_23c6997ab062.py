# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\tests\e2e\test_train.py
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "rm",
            "dpo_en_demo",
            marks=pytest.mark.xfail(OS_NAME.startswith("windows"), reason="OS error."),
        ),
    ],
)
def test_run_exp(stage: str, dataset: str):
    ...
    run_exp(
        {"stage": stage, "dataset": dataset, "output_dir": output_dir, **TRAIN_ARGS}
    )
