# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\core\model_engine.py
    ...
    def _init_model(self) -> HFModel:
        ...
        if self.args.peft_config is None:
            ...
            model = PeftPlugin(self.args.peft_config.name)(
                model, self.args.peft_config, self.is_train
            )
