# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\core\utils\inference_engine.py
...
class HuggingFaceEngine(BaseEngine):
    ...
    async def generate(
        ...
        async with self.semaphore:
            model_inputs = self.renderer.render_messages(
                messages, tools, is_generate=True
            )
            ...
            kwargs = {
                ...
                "attention_mask": torch.tensor([model_inputs["attention_mask"]]).to(
                    device
                ),
