# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\plugins\model_plugins\kernels\base.py
...
class BaseKernel(ABC):
    ...
    def apply(cls, **kwargs) -> HFModel:
        ...
        if not cls.check_deps():
            raise RuntimeError(
                f"{cls.__name__} is not available but {cls.__name__} kernel was called."
            )
