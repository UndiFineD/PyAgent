# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\plugins\trainer_plugins\batching.py
...
class BatchingPlugin(BasePlugin):
    ...
    def generate_batch(
        self, buffer: StatefulBuffer, batch_info: BatchInfo
