# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\plugins\model_plugins\kernels\interface.py
...
def scan_all_kernels():
    ...
    for file_path in ops_path.rglob("*.py"):
        ...
        try:
            ...
            logger.warning(
                f"[Kernel Registry] Failed to import {full_module_name} when loading kernels: {e}"
            )
