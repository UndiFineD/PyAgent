# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\api\app.py
    ...
    async def create_chat_completion(request: ChatCompletionRequest):
        ...
        if request.stream:
            ...
            return EventSourceResponse(
                generate, media_type="text/event-stream", sep="\n"
            )
        else:
