# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\webui\components\infer.py
...
def create_infer_tab(engine: "Engine") -> dict[str, "Component"]:
    ...
    with gr.Row():
        infer_backend = gr.Dropdown(
            choices=["huggingface", "vllm", "sglang"], value="huggingface"
        )
