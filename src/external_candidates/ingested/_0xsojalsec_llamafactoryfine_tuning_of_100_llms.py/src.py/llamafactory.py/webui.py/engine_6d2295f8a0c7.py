# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\webui\engine.py
...
class Engine:
    ...
    def resume(self):
        ...
        user_config = (
            load_config() if not self.demo_mode else {}
