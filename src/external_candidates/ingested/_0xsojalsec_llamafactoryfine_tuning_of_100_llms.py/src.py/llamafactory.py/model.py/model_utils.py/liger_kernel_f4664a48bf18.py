# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\model\model_utils\liger_kernel.py
...
def apply_liger_kernel(
    ...
    if model_type == "gemma":
        ...
        from liger_kernel.transformers import (
            apply_liger_kernel_to_gemma3 as apply_liger_kernel,
        )
        ...
        from liger_kernel.transformers import (
            apply_liger_kernel_to_glm4 as apply_liger_kernel,
        )
    elif model_type == "glm4v":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_glm4v as apply_liger_kernel,
        )
    elif model_type == "granite":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_granite as apply_liger_kernel,
        )
        ...
        from liger_kernel.transformers import (
            apply_liger_kernel_to_llava as apply_liger_kernel,
        )
        ...
        from liger_kernel.transformers import (
            apply_liger_kernel_to_mllama as apply_liger_kernel,
        )
    elif model_type == "olmo2":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_olmo2 as apply_liger_kernel,
        )
    elif model_type == "paligemma":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_paligemma as apply_liger_kernel,
        )
        ...
        from liger_kernel.transformers import (
            apply_liger_kernel_to_qwen2_5_vl as apply_liger_kernel,
        )
    elif model_type == "qwen3":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_qwen3 as apply_liger_kernel,
        )
    elif model_type == "qwen3_moe":
        from liger_kernel.transformers import (
            apply_liger_kernel_to_qwen3_moe as apply_liger_kernel,
        )
