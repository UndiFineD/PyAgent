# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\model\model_utils\attention.py
...
def configure_attn_implementation(
    ...
    if getattr(config, "model_type", None) == "gemma2":
        if (
            model_args.flash_attn == AttentionFunction.AUTO
            or model_args.flash_attn == AttentionFunction.FA2
        ):
