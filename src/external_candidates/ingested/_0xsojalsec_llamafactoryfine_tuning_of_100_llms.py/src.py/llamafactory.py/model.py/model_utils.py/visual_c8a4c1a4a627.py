# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\model\model_utils\visual.py
...
def get_forbidden_modules(
    ...
    if model_type in COMPOSITE_MODELS:
        ...
        if finetuning_args.freeze_multi_modal_projector:
            ...
            logger.info_rank0(
                f"Set multi model projector not trainable: {projector_key}."
            )
        ...
        if finetuning_args.freeze_language_model:
            ...
            logger.info_rank0(
                f"Set language model not trainable: {language_model_keys}."
            )
