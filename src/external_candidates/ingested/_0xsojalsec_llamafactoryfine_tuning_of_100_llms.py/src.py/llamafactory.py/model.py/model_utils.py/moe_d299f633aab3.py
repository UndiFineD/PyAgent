# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\model\model_utils\moe.py
...
class Qwen3OmniMoeThinkerTextSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        for expert_idx in range(self.num_experts):
            ...
            expert_weights = full_routing_weights[
                :, expert_idx, None
            ]  # shape: (batch*seq, 1)
