# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\train\ppo\trainer.py
...
class CustomPPOTrainer(PPOTrainer, Trainer):
            ...
            for idx in range(0, self.config.batch_size, self.config.mini_batch_size):
                mini_batch = {
                    "input_ids": batch["input_ids"][
                        idx : idx + self.config.mini_batch_size
                    ],
    ...
    def get_rewards(
        ...
        with (
            unwrap_model_for_generation(reward_model, self.accelerator),
            self.amp_context,
        ):  # support bf16
