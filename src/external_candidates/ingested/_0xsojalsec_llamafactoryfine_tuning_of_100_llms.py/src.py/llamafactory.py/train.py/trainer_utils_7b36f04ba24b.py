# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\train\trainer_utils.py
...
if is_galore_available():
    from galore_torch import (  # type: ignore
        GaLoreAdafactor,
        GaLoreAdamW,
        GaLoreAdamW8bit,
    )
...
def get_batch_logps(
    ...
    if ld_alpha is not None:
        ...
        position_ids = torch.arange(seq_len, device=per_token_logps.device).expand_as(
            per_token_logps
        )
