# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\data\processor\supervised.py
    ...
    def _encode_data_example(
        ...
        for turn_idx, (source_ids, target_ids) in enumerate(encoded_pairs):
            ...
            if self.data_args.train_on_prompt:
                ...
                source_label = [self.tokenizer.eos_token_id] + [IGNORE_INDEX] * (
                    source_len - 1
                )
            else:
            ...
            if (
                self.data_args.mask_history and turn_idx != 0
...
class PackedSupervisedDatasetProcessor(SupervisedDatasetProcessor):
    def preprocess_dataset(
        ...
        for knapsack in knapsacks:
            ...
            if (
                len(packed_input_ids) < self.data_args.cutoff_len + 1
