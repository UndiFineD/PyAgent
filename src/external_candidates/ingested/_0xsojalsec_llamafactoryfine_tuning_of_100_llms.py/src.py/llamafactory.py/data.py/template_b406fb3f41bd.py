# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\data\template.py
...
register_template(
    name="hunyuan_small",
    format_user=StringFormatter(
        slots=["<｜hy_User｜>{{content}}<｜hy_place▁holder▁no▁8｜>"]
    ),
