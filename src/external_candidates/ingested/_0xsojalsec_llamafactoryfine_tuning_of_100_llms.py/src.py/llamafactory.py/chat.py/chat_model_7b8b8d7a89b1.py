# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\chat\chat_model.py
    ...
    def __init__(self, args: Optional[dict[str, Any]] = None) -> None:
        ...
        if model_args.infer_backend == EngineName.HF:
            ...
            try:
                ...
                self.engine: BaseEngine = SGLangEngine(
                    model_args, data_args, finetuning_args, generating_args
                )
            except ImportError as e:
                raise ImportError(
            ...
            try:
                ...
                self.engine: BaseEngine = KTransformersEngine(
                    model_args, data_args, finetuning_args, generating_args
                )
            except ImportError as e:
                raise ImportError(
    ...
    def chat(
        ...
        **input_kwargs,
        ...
        task = asyncio.run_coroutine_threadsafe(
            self.achat(messages, system, tools, images, videos, audios, **input_kwargs),
            self._loop,
        )
        return task.result()
