# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\chat\hf_engine.py
...
class HuggingfaceEngine(BaseEngine):
    ...
    def _process_args(
        ...
        prompt_ids, _ = template.encode_oneturn(
            tokenizer, paired_messages, system, tools
        )
        ...
        mm_inputs = template.mm_plugin.get_mm_inputs(
            **mm_input_dict, batch_ids=[prompt_ids], processor=processor
        )
    ...
    def _chat(
        ...
        response = tokenizer.batch_decode(
            ...
            skip_special_tokens=getattr(
                gen_kwargs["generation_config"], "skip_special_tokens", True
            ),
