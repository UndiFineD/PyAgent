# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\hparams\finetuning_args.py
...
class BAdamArgument:
    ...
    badam_switch_mode: Literal["ascending", "descending", "random", "fixed"] | None = (
        field(
            default="ascending",
            metadata={
...
class FinetuningArguments(
    ...
    eaft_alpha: float = field(
        default=1.0,
        metadata={
            "help": "The alpha parameter for EAFT loss to control the power of adaptive weight."
        },
    )
    ...
    def __post_init__(self):
        ...
        self.freeze_extra_modules: list[str] | None = split_arg(
