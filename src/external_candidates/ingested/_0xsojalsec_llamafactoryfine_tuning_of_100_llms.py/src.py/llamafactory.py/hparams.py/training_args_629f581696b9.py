# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\hparams\training_args.py
...
class RayArguments:
    ...
    ray_storage_filesystem: Literal["s3", "gs", "gcs"] | None = field(
        default=None,
        metadata={
            "help": "The storage filesystem to use. If None specified, local filesystem will be used."
        },
    )
    ...
    ray_init_kwargs: dict | str | None = field(
        default=None,
        metadata={
            "help": "The arguments to pass to ray.init for Ray training. Default is None."
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.ray_storage_filesystem is not None:
            ...
            if self.ray_storage_filesystem == "s3":
                ...
                self.ray_storage_filesystem == "gs"
                or self.ray_storage_filesystem == "gcs"
            ):
