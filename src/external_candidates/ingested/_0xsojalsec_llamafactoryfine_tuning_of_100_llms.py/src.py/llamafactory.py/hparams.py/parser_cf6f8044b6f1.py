# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\hparams\parser.py
...
def get_train_args(args: dict[str, Any] | list[str] | None = None) -> _TRAIN_CLS:
    ...
    ) and (data_args.eval_dataset is None and data_args.val_size < 1e-6):
