    ...
    try:
        ...
        if not exists:
            h_obj = SharpEdrChecker(
                ...
                currentProcessModules=helpers.b64decode(
                    json_obj["currentProcessModules"]
                ),
                launchCheckDirectories=helpers.b64decode(
                    json_obj["launchCheckDirectories"]
                ),
                launchServiceChecker=helpers.b64decode(
                    json_obj["launchServiceChecker"]
                ),
        ...
        log_error.error(
            "insert_sharpedrchecker <executionId: " + executionId + "> - " + str(e)
        )
...
def get_sharpedrchecker_helper(execution_id=None):
    ...
    try:
        if execution_id == None:
            ...
            sharp_obj = SharpEdrChecker.objects.filter(
        ...
        for elem in sharp_obj:
            ...
            launchCheckDirectories = helpers.remove_empty_elements(
                launchCheckDirectories
            )
