# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-homoglyph\generator\data_file_parser.py
import os
import os.path
...
class DataFileLine:
    ...
    def get_chars(self):
        return self._get_char_from_code(self.parts[0]), self._get_char_from_code(
            self.parts[1]
        )
