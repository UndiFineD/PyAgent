# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\initialaccess\azuread_device_code_phish.py
import base64
import binascii
import datetime
import json
        ...
        if token_request.status_code == 400:
            ...
            try:
                ...
                database_dict = {
                    ...
                    "azure_expiration_date": datetime.datetime.fromtimestamp(
                        int(returned_request["expires_on"])
                    ).isoformat(),
                ...
                try:
                    ...
                    if "AWSUsers matching query does not exist" in e:
                        return {
                            "error": "AWSUsers matching query does not exist".format(
                                str(e)
                            )
                        }, 500
                    else:
                ...
                return {"error": "No Privs to check user's info"}

            return {"azure_creds_name": me}
