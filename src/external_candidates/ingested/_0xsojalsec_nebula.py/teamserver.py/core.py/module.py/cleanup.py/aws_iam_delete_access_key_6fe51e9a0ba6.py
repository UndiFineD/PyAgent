# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\cleanup\aws_iam_delete_access_key.py
import sys
...
def exploit(profile, workspace):
    ...
    try:
        profile.delete_access_key(UserName=user, AccessKeyId=access_key)
    ...
    return {"User": {"User": user, "AccessKey": access_key, "Status": status}}
