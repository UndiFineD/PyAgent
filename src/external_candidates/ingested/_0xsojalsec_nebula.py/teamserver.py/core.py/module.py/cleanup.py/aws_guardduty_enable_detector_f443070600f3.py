# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\cleanup\aws_guardduty_enable_detector.py
import sys
...
def exploit(profile, workspace):
    ...
    try:
        profile.update_detector(DetectorId=detectorID, Enable=True)
