# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\detectionbypass\aws_s3_empty_log_bucket.py
import sys
...
def exploit(profile, workspace):
    ...
    try:
        ...
        status = (
            f"CloudTrail Bucket {bucket} was not emptied with error code: {str(e)}."
        )
