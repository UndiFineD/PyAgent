# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\aws_s3_list_bucket_objects.py
import sys
...
def exploit(profile, workspace):
    ...
    for bucket in buckets:
        ...
        try:
            ...
            allbuckets.append(
                {"Bucket": bucket, "error": f"Error from module: {str(e)}"}
            )

    return {"Bucket": allbuckets}, 200
