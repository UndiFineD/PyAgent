# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\aws_enum_bruteforce_read_permissions.py
import json
import sys
...
description = (
    "Bruteforce all list_*, get_* and describe_* calls for each service dynamically."
)
