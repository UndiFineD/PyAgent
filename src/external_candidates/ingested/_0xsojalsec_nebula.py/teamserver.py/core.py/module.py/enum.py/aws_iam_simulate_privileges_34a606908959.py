# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\aws_iam_simulate_privileges.py
...
aws_command = (
    "aws iam get-user --user-name <user>  --region <region> --profile <profile>"
)
...
def exploit(all_sessions, cred_prof, useragent, web_proxies, workspace):
    try:
        ...
        iamProfile = giveMeClient(
            all_sessions, cred_prof, useragent, web_proxies, "iam"
        )
