# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\reconnaissance\misc_dns_fuzzing.py
import sys
...
variables = {
    ...
    "DOMAIN": {"value": "", "required": "true", "description": "The domain to check"},
    "WORDLIST": {
        "value": "",
        "required": "true",
...
def exploit(workspace):
    ...
    try:
        try:
            ...
            return {
                "error": "File {} not found. Try adding the full path.".format(
                    variables["WORDLIST"]["value"]
                )
            }, 500
        ...
        return {
            "wordlist": {"wordlist": variables["WORDLIST"]["value"], "output": objects}
        }, 200
