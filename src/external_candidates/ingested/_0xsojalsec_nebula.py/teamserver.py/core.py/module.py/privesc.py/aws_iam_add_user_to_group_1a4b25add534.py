# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\privesc\aws_iam_add_user_to_group.py
import random
import string
import sys
...
def exploit(profile, workspace):
    ...
    try:
        ...
        profile.add_user_to_group(GroupName=user, UserName=group)
        return {"AdditionStatus": f"User {user} added to group {group}"}
