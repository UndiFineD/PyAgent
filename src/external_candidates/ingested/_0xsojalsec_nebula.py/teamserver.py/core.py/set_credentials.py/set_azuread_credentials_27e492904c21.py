# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\set_credentials\set_azuread_credentials.py
import json
import sys
...
>>> """)
            ...
            if (
                ...
                and not int(connectiontype.strip()) == 4
            ):
                print(
                    colored(
            ...
            try:
                ...
                if int(connectiontype.strip()) == 1:
                    ...
                    creds = auth_refresh_token(
                        refresh_token, sess_test["client_id"], RESOURCE, authority
                    )
                    print(creds)
