# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\enum_user_privs\getuid_aws_ssmrole.py
import json
import sys
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                all_info["AmazonEC2RoleforRCEUsed"] = (
                    "AmazonEC2RoleforRCE seems to be used for this role. Use aws_misc_amazonec2roleforssm_permissions to enumerate the services allowed by the role."
                )
