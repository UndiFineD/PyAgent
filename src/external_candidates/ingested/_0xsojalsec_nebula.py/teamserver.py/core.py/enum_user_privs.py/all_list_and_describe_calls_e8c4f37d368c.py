# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\enum_user_privs\all_list_and_describe_calls.py
all_list_and_describe_calls_dict = {
    ...
    "ecr": {
        "List": ["list_images", "list_tags_for_resource"],
        "Describe": [
    ...
    "acm": {
        "List": ["list_certificates", "list_tags_for_certificate"],
        "Describe": ["describe_certificate"],
    },
    "acm-pca": {
        "List": ["list_certificate_authorities", "list_permissions", "list_tags"],
        "Describe": [
    ...
    "amplifybackend": {"List": ["list_backend_jobs"], "Describe": []},
    "apigateway": {"List": [], "Describe": []},
    "apigatewaymanagementapi": {"List": [], "Describe": []},
    "apigatewayv2": {"List": [], "Describe": []},
    "appconfig": {
        "List": [
            "list_applications",
    ...
    "appflow": {
        "List": ["list_connector_entities", "list_flows", "list_tags_for_resource"],
        "Describe": [
    ...
    "applicationcostprofiler": {"List": ["list_report_definitions"], "Describe": []},
    "appmesh": {
        "List": [
            "list_gateway_routes",
            "list_meshes",
    ...
    "autoscaling-plans": {
        "List": [],
        "Describe": ["describe_scaling_plan_resources", "describe_scaling_plans"],
    },
    "backup": {
        "List": [
            "list_backup_jobs",
    ...
    "batch": {
        "List": ["list_jobs", "list_tags_for_resource"],
        "Describe": [
    ...
    "braket": {"List": ["list_tags_for_resource"], "Describe": []},
    "budgets": {
        "List": [],
        "Describe": [
            "describe_budget",
    ...
    "ce": {
        "List": ["list_cost_category_definitions"],
        "Describe": ["describe_cost_category_definition"],
    },
    "chime": {
        "List": [
            "list_accounts",
    ...
    "cloud9": {
        "List": ["list_environments", "list_tags_for_resource"],
        "Describe": [
    ...
    "cloudhsm": {
        ...
        "Describe": ["describe_hapg", "describe_hsm", "describe_luna_client"],
    },
    "cloudhsmv2": {
        "List": ["list_tags"],
        "Describe": ["describe_backups", "describe_clusters"],
    },
    "cloudsearch": {
    ...
    "cloudsearchdomain": {"List": [], "Describe": []},
    "cloudtrail": {
        "List": ["list_public_keys", "list_tags", "list_trails"],
        "Describe": ["describe_trails"],
    },
    "cloudwatch": {
        "List": [
            "list_dashboards",
    ...
    "codebuild": {
        ...
        "Describe": ["describe_code_coverages", "describe_test_cases"],
    },
    "codecommit": {
        "List": [
        ...
        "Describe": ["describe_merge_conflicts", "describe_pull_request_events"],
    },
    "codedeploy": {
        "List": [
    ...
    "codeguruprofiler": {
        ...
        "Describe": ["describe_profiling_group"],
    },
    "codepipeline": {
        "List": [
    ...
    "codestar": {
        ...
        "Describe": ["describe_project", "describe_user_profile"],
    },
    "codestar-connections": {
        "List": ["list_connections", "list_hosts", "list_tags_for_resource"],
        "Describe": [],
    },
    "codestar-notifications": {
        ...
        "Describe": ["describe_notification_rule"],
    },
    "cognito-identity": {
        "List": ["list_identities", "list_identity_pools", "list_tags_for_resource"],
        "Describe": ["describe_identity", "describe_identity_pool"],
    },
    "cognito-idp": {
        "List": [
            "list_devices",
    ...
    "cognito-sync": {
        "List": ["list_datasets", "list_identity_pool_usage", "list_records"],
        "Describe": [
            "describe_dataset",
    ...
    "compute-optimizer": {
        "List": [],
        "Describe": ["describe_recommendation_export_jobs"],
    },
    "config": {
        "List": [
    ...
    "connect-contact-lens": {
        "List": ["list_realtime_contact_analysis_segments"],
        "Describe": [],
    },
    "connectparticipant": {"List": [], "Describe": []},
    "cur": {"List": [], "Describe": ["describe_report_definitions"]},
    "customer-profiles": {
        "List": [
    ...
    "datapipeline": {
        "List": ["list_pipelines"],
        "Describe": ["describe_objects", "describe_pipelines"],
    },
    "datasync": {
        "List": [
            "list_agents",
    ...
    "directconnect": {
        "List": ["list_virtual_interface_test_history"],
        "Describe": [
    ...
    "discovery": {
        "List": ["list_configurations", "list_server_neighbors"],
        "Describe": [
            "describe_agents",
    ...
    "dlm": {"List": ["list_tags_for_resource"], "Describe": []},
    "dms": {
        "List": ["list_tags_for_resource"],
        "Describe": [
            "describe_account_attributes",
    ...
    "dynamodbstreams": {"List": ["list_streams"], "Describe": ["describe_stream"]},
    "ebs": {"List": ["list_changed_blocks", "list_snapshot_blocks"], "Describe": []},
    "ec2-instance-connect": {"List": [], "Describe": []},
    "ecr-public": {
        "List": ["list_tags_for_resource"],
        "Describe": [
            "describe_image_tags",
    ...
    "elasticache": {
        "List": ["list_allowed_node_type_modifications", "list_tags_for_resource"],
        "Describe": [
    ...
    "finspace-data": {"List": [], "Describe": []},
    "firehose": {
        "List": ["list_delivery_streams", "list_tags_for_delivery_stream"],
        "Describe": ["describe_delivery_stream"],
    },
    "fis": {
        "List": [
            "list_actions",
    ...
    "forecastquery": {"List": [], "Describe": []},
    "frauddetector": {
        "List": ["list_tags_for_resource"],
        "Describe": ["describe_detector", "describe_model_versions"],
    },
    "fsx": {
        "List": ["list_tags_for_resource"],
        "Describe": [
    ...
    "glacier": {
        ...
        "Describe": ["describe_job", "describe_vault"],
    },
    "globalaccelerator": {
        "List": [
            "list_accelerators",
    ...
    "honeycode": {
        "List": ["list_table_columns", "list_table_rows", "list_tables"],
        "Describe": ["describe_table_data_import_job"],
    },
    "identitystore": {
        "List": ["list_groups", "list_users"],
        "Describe": ["describe_group", "describe_user"],
    },
    "imagebuilder": {
        "List": [
    ...
    "importexport": {"List": ["list_jobs"], "Describe": []},
    "inspector": {
        "List": [
    ...
    "iot-data": {
        "List": ["list_named_shadows_for_thing", "list_retained_messages"],
        "Describe": [],
    },
    "iot-jobs-data": {"List": [], "Describe": ["describe_job_execution"]},
    "iot1click-devices": {
        "List": ["list_device_events", "list_devices", "list_tags_for_resource"],
        "Describe": ["describe_device"],
    },
    "iot1click-projects": {
        "List": ["list_placements", "list_projects", "list_tags_for_resource"],
        "Describe": ["describe_placement", "describe_project"],
    },
    "iotanalytics": {
        "List": [
            "list_channels",
    ...
    "iotdeviceadvisor": {
        "List": ["list_suite_definitions", "list_suite_runs", "list_tags_for_resource"],
        "Describe": [],
    },
    "iotevents": {
        "List": [
    ...
    "iotevents-data": {
        "List": ["list_alarms", "list_detectors"],
        "Describe": ["describe_alarm", "describe_detector"],
    },
    "iotfleethub": {
        "List": ["list_applications", "list_tags_for_resource"],
        "Describe": ["describe_application"],
    },
    "iotsecuretunneling": {
        "List": ["list_tags_for_resource", "list_tunnels"],
        "Describe": ["describe_tunnel"],
    },
    "iotsitewise": {
        "List": [
    ...
    "iotthingsgraph": {
        "List": ["list_flow_execution_messages", "list_tags_for_resource"],
    ...
    "kinesis-video-archived-media": {"List": ["list_fragments"], "Describe": []},
    "kinesis-video-media": {"List": [], "Describe": []},
    "kinesis-video-signaling": {"List": [], "Describe": []},
    "kinesisanalytics": {
        "List": ["list_applications", "list_tags_for_resource"],
        "Describe": ["describe_application"],
    },
    ...
    "kinesisvideo": {
        ...
        "Describe": ["describe_signaling_channel", "describe_stream"],
    },
    "kms": {
        "List": [
            "list_aliases",
        ...
        "Describe": ["describe_custom_key_stores", "describe_key"],
    },
    "lakeformation": {
        "List": ["list_lf_tags", "list_permissions", "list_resources"],
        "Describe": ["describe_resource"],
    },
    "lex-models": {"List": ["list_tags_for_resource"], "Describe": []},
    "lex-runtime": {"List": [], "Describe": []},
    "lexv2-models": {
        "List": [
    ...
    "lookoutvision": {
        ...
        "Describe": ["describe_dataset", "describe_model", "describe_project"],
    },
    "machinelearning": {
        "List": [],
        "Describe": [
    ...
    "macie": {"List": ["list_member_accounts", "list_s3_resources"], "Describe": []},
    "macie2": {
        "List": [
    ...
    "marketplace-catalog": {
        "List": ["list_change_sets", "list_entities"],
        "Describe": ["describe_change_set", "describe_entity"],
    },
    "marketplace-entitlement": {"List": [], "Describe": []},
    "marketplacecommerceanalytics": {"List": [], "Describe": []},
    "mediaconnect": {
        "List": [
            "list_entitlements",
            "list_flows",
        ...
        "Describe": ["describe_flow", "describe_offering", "describe_reservation"],
    },
    "mediaconvert": {
        "List": [
            "list_job_templates",
    ...
    "mediastore": {
        "List": ["list_containers", "list_tags_for_resource"],
        "Describe": ["describe_container"],
    },
    "mediastore-data": {"List": ["list_items"], "Describe": ["describe_object"]},
    "mediatailor": {
        "List": [
            "list_alerts",
            "list_channels",
    ...
    "meteringmarketplace": {"List": [], "Describe": []},
    "mgh": {
        "List": [
        ...
        "Describe": ["describe_application_state", "describe_migration_task"],
    },
    "mgn": {
        "List": ["list_tags_for_resource"],
        "Describe": [
    ...
    "migrationhub-config": {"List": [], "Describe": ["describe_home_region_controls"]},
    "mobile": {
        "List": ["list_bundles", "list_projects"],
        "Describe": ["describe_bundle", "describe_project"],
    },
    "mq": {
        "List": [
            "list_brokers",
    ...
    "mwaa": {"List": ["list_environments", "list_tags_for_resource"], "Describe": []},
    "neptune": {
        "List": ["list_tags_for_resource"],
        "Describe": [
    ...
    "networkmanager": {
        "List": ["list_tags_for_resource"],
        "Describe": ["describe_global_networks"],
    },
    "nimble": {
        "List": [
    ...
    "outposts": {
        "List": ["list_outposts", "list_sites", "list_tags_for_resource"],
        "Describe": [],
    },
    "personalize": {
        "List": [
    ...
    "personalize-events": {"List": [], "Describe": []},
    "personalize-runtime": {"List": [], "Describe": []},
    "pi": {"List": [], "Describe": ["describe_dimension_keys"]},
    "pinpoint": {
        "List": [
            "list_journeys",
            "list_tags_for_resource",
    ...
    "pinpoint-sms-voice": {"List": [], "Describe": []},
    "polly": {
        "List": ["list_lexicons", "list_speech_synthesis_tasks"],
        "Describe": ["describe_voices"],
    },
    "pricing": {"List": [], "Describe": ["describe_services"]},
    "qldb": {
        "List": [
    ...
    "redshift-data": {
        "List": ["list_databases", "list_schemas", "list_statements", "list_tables"],
        "Describe": ["describe_statement", "describe_table"],
    },
    "rekognition": {
        "List": [
            "list_collections",
    ...
    "resource-groups": {
        "List": ["list_group_resources", "list_groups"],
        "Describe": [],
    },
    "resourcegroupstaggingapi": {"List": [], "Describe": ["describe_report_creation"]},
    "robomaker": {
        "List": [
    ...
    "route53domains": {
        "List": ["list_domains", "list_operations", "list_tags_for_domain"],
        "Describe": [],
    },
    "route53resolver": {
        "List": [
    ...
    "s3control": {
        ...
        "Describe": ["describe_job", "describe_multi_region_access_point_operation"],
    },
    "s3outposts": {"List": ["list_endpoints"], "Describe": []},
    "sagemaker": {
        "List": [
            "list_actions",
            "list_algorithms",
    ...
    "sagemaker-a2i-runtime": {
        "List": ["list_human_loops"],
        "Describe": ["describe_human_loop"],
    },
    "sagemaker-edge": {"List": [], "Describe": []},
    "sagemaker-featurestore-runtime": {"List": [], "Describe": []},
    "sagemaker-runtime": {"List": [], "Describe": []},
    "savingsplans": {
        "List": ["list_tags_for_resource"],
        "Describe": [
    ...
    "sdb": {"List": ["list_domains"], "Describe": []},
    "secretsmanager": {
        "List": ["list_secret_version_ids", "list_secrets"],
        "Describe": ["describe_secret"],
    },
    "securityhub": {
        "List": [
    ...
    "signer": {
        ...
        "Describe": ["describe_signing_job"],
    },
    "sms": {"List": ["list_apps"], "Describe": []},
    "sms-voice": {"List": ["list_configuration_sets"], "Describe": []},
    "snowball": {
        "List": [
            "list_cluster_jobs",
            "list_clusters",
    ...
    "sqs": {
        "List": ["list_dead_letter_source_queues", "list_queue_tags", "list_queues"],
        "Describe": [],
    },
    "ssm": {
        "List": [
    ...
    "ssm-contacts": {
        ...
        "Describe": ["describe_engagement", "describe_page"],
    },
    "ssm-incidents": {
        "List": [
    ...
    "sso": {"List": ["list_account_roles", "list_accounts"], "Describe": []},
    "sso-admin": {
        "List": [
    ...
    "textract": {"List": [], "Describe": []},
    "timestream-query": {"List": [], "Describe": ["describe_endpoints"]},
    "timestream-write": {
        "List": ["list_databases", "list_tables", "list_tags_for_resource"],
        "Describe": ["describe_database", "describe_endpoints", "describe_table"],
    },
    "transcribe": {
        "List": [
        ...
        "Describe": ["describe_language_model"],
    },
    "transfer": {
        "List": [
            "list_accesses",
    ...
    "translate": {
        ...
        "Describe": ["describe_text_translation_job"],
    },
    "waf": {
        "List": [
    ...
    "wafv2": {
        ...
        "Describe": ["describe_managed_rule_group"],
    },
    "wellarchitected": {
        "List": [
            "list_answers",
    ...
    "workmailmessageflow": {"List": [], "Describe": []},
    "workspaces": {
        "List": ["list_available_management_cidr_ranges"],
        "Describe": [
            "describe_account",
    ...
    "xray": {"List": ["list_tags_for_resource"], "Describe": []},
}
