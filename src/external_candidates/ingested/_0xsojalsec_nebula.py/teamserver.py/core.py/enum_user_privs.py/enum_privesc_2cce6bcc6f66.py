# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\enum_user_privs\enum_privesc.py
import json
import sys
...
def get_user_and_user_policies(username, accesskey, secretkey, region, session_token):
    ...
    try:
        ...
        get_user_policies = iamcli.list_user_policies(UserName=username.split("/")[-1])
...
def enum_privesc(profile_dict):
    ...
    user_policies = get_user_and_user_policies(
        username, access_key_id, secret_key, region, session_token
    )
