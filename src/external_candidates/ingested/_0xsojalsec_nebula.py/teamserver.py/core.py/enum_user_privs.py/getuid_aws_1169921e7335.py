            ...
            while response["IsTruncated"]:
                response.update(
                    client.list_role_policies(
                        RoleName=rolename, Marker=response["Marker"]
                    )
                )
            ...
            while response["IsTruncated"]:
                response.update(
                    client.list_user_policies(
                        UserName=username, Marker=response["Marker"]
                    )
                )
        ...
        try:
            ...
            while groups_for_users["IsTruncated"]:
                groups_for_users = client.list_groups_for_user(
                    UserName=username, Marker=groups_for_users["Marker"]
                )
            ...
            for group in all_info["UserGroups"]:
                ...
                try:
                    ...
                    while group_response["IsTruncated"]:
                        ...
                        (group["AttachedPolicies"]).extend(
                            group_response["AttachedPolicies"]
                        )
                except:
