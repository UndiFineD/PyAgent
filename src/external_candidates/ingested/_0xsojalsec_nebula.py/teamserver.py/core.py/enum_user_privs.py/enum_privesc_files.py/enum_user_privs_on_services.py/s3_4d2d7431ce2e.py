# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\enum_user_privs\enum_privesc_files\enum_user_privs_on_services\s3.py
import sys
...
def enum_privs(profile_dict, workspace):
    ...
    try:
        ...
        for bucket in all_buckets:
            try:
                bucket_objects = s3client.list_objects_v2(Bucket=bucket, MaxKeys=50000)[
                    "Contents"
                ]
