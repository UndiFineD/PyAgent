# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\models\AWSCredentials.py
...
def getuid_aws_creds():
    ...
    try:
        ...
        awscredentials = AWSCredentials.objects.get(
...
@awscredentials_blueprint.route(
    "/api/latest/awscredentials/getuid/ssmrole", methods=["POST"]
)
@jwt_required()
def getuid_aws_creds_ssmrole():
    ...
    try:
        ...
        return {
            "UserName": getuidssmrole(all_sessions, cred_prof, useragent, web_proxies)
        }, 200
    except flask_mongoengine.DoesNotExist:
        return {"error": "Credentials do not exist"}, 404
