# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\models\ClientCommands.py
import boto3
import botocore
...
@clientcommands_blueprint.route(
    "/api/latest/clientcommands/get_user_id", methods=["GET"]
)
@jwt_required()
def aws_get_user_id():
