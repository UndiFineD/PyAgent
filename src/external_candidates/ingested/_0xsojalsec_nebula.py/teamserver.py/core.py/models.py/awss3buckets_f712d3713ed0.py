# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\models\AWSS3Buckets.py
import sys
...
def get_awsbuckets():
    ...
    try:
        awsbuckets = AWSS3Bucket.objects.get(
            aws_s3_bucket_name=body.get("aws_s3_bucket_name")
        )
