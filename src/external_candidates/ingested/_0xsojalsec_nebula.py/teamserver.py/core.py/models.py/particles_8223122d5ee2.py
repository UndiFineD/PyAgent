# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\models\Particles.py
...
particle_args.add_argument(
    "host", type=str, help="You need to add the host", required=True
)
particle_args.add_argument(
    "port", type=int, help="You need to add the port", required=True
)
particle_args.add_argument(
    "module", type=str, help="You need to add the module", required=True
)
...
def list_particles(id):
    ...
    listener = Particles(id=id, host=host, port=port, module=module)
