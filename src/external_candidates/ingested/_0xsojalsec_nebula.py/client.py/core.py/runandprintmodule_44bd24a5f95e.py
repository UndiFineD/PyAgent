# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\client\core\RunAndPrintModule.py
import json
import os
import sys
...
def RunModule(
    ...
    return json.loads(
        requests.post(
            "{}/api/latest/modules/run".format(apihost),
        ...
        if title == "error":
            ...
            if isinstance(json_data, list):
                for data in json_data:
                    ...
                    output += highlight(raw_json, JsonLexer(), TerminalFormatter())
