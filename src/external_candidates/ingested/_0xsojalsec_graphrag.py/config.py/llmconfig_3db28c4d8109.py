# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Config\LLMConfig.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
from Core.Common.Constants import CONFIG_ROOT, GRAPHRAG_ROOT, LLM_API_TIMEOUT
