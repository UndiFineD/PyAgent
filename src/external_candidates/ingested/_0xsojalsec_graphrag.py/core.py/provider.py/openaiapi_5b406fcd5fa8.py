# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Provider\OpenaiApi.py
...
class OpenAILLM(BaseLLM):
    ...
    async def _achat_completion_stream(
        self, messages: list[dict], timeout=USE_CONFIG_TIMEOUT, max_tokens=None
    ) -> str:
        ...
        **extra_kwargs,
        ...
        kwargs = {
            ...
            "stop": [
                "[/INST]",
                "<<SYS>>",
            ],  # default it's None and gpt4-v can't have this one
