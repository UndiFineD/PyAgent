# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Provider\BaseLLM.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
...
class BaseLLM(ABC):
    ...
    async def acompletion(
        self, messages: list[dict], timeout=USE_CONFIG_TIMEOUT, max_tokens: int = None
    ):
