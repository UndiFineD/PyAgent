# Extracted from: C:\DEV\PyAgent\.external\Androset\setup.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
setup(
    ...
    zip_safe=False,
    install_requires=["pyOpenSSL==23.1.1", "termcolor==2.3.0"],
    classifiers=[
    ...
    python_requires=">=3.6",
    entry_points={"console_scripts": ["androset = androset:main"]},
