# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-porch-pirate\examples\get_request.py
import json
import sys
...
def main():
    p = porchpirate()
    request = json.loads(p.request("2052387-24db9f10-04ba-4354-a1f6-7a84046110a3"))[
        "data"
    ]
