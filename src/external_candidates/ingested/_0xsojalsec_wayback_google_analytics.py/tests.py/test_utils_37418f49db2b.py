# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wayback-google-analytics\tests\test_utils.py
...
class UtilsTestCase(TestCase):
    ...
    def test_get_limit_from_frequency(self):
        ...
        self.assertEqual(
            get_limit_from_frequency(
                frequency="monthly",
                start_date="19990801000000",
                end_date="20150617000000",
            ),
            191,
        )
    ...
    def test_get_limit_from_frequency_invalid(self):
        ...
        with self.assertRaises(ValueError):
            get_limit_from_frequency(
                frequency="yearly", start_date=None, end_date="20130101000000"
            )

        """Raises ValueError without valid frequency"""
        with self.assertRaises(ValueError):
            get_limit_from_frequency(
                frequency=None, start_date="20120101000000", end_date="20130101000000"
            )
        with self.assertRaises(ValueError):
            get_limit_from_frequency(
                frequency="weekly",
    ...
    def test_validate_dates(self):
        ...
        self.assertTrue(
            validate_dates(start_date="01/01/2012:12:00", end_date="02/01/2012:12:00")
        )
        self.assertTrue(
            validate_dates(start_date="01/10/2023:12:00", end_date="03/11/2023:12:00")
        )
        ...
        self.assertTrue(
            validate_dates(start_date="01/01/2012:12:30", end_date="02/01/2012")
        )
        self.assertTrue(
            validate_dates(start_date="01/01/2012", end_date="02/01/2012:01:00")
        )
    ...
    def test_validate_dates_invalid(self):
        ...
        self.assertFalse(
            validate_dates(start_date="01/01/2012:12:00", end_date="01/01/2012:12:00")
        )
        self.assertFalse(
            validate_dates(start_date="01/01/2012:12:00", end_date="01/01/2010:11:00")
        )
        self.assertFalse(
            validate_dates(start_date="01/02/2012", end_date="01/01/2012:11:00")
        )
        self.assertFalse(
            validate_dates(start_date="01/01/2012:12:30", end_date="02/01/2010")
        )
