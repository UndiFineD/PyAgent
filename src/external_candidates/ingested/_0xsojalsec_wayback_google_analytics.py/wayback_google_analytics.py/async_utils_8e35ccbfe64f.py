...
async def get_codes_from_snapshots(
    session, url, timestamps, semaphore=asyncio.Semaphore(10)
):
    ...
    tasks = [
        get_codes_from_single_timestamp(
            session, base_url, timestamp, results, semaphore
        )
...
async def get_codes_from_single_timestamp(
    session, base_url, timestamp, results, semaphore=asyncio.Semaphore(10)
):
