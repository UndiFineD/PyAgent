# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\optimization\evoprompt\bestprompt_eval.py
"""
...
async def main():
    ...
    for model_name in model_list:
        ...
        async def evaluate_example_concurrently(example: Dict) -> float:
            ...
            """
            prediction, meta = await asyncio.to_thread(program, input=example["input"])
