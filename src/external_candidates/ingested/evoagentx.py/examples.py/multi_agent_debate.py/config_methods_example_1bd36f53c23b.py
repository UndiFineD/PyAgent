# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\multi_agent_debate\config_methods_example.py
#!/usr/bin/env python3
"""
...
def demo_save_and_load():
    ...
    try:
        ...
        save_path = graph.save_module(
            os.path.join(files_dir, "demo_debate_config.json")
        )
    ...
    print(
        f"Loaded instance agent count: {len(new_graph_from_file.debater_agents or [])}"
    )
