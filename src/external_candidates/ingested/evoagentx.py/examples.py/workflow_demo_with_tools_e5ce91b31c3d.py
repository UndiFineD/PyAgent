# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\workflow_demo_with_tools.py
#!/usr/bin/env python3
"""
...
def load_api_key():
    ...
    if not api_key:
        raise ValueError(
            "OpenAI API key not found. Please set OPENAI_API_KEY environment variable or create openai_api_key.txt file"
        )
