# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\image_tools\openai_image_tools\image_generation.py
...
class OpenAIImageGenerationTool(Tool):
    ...
    description: str = (
        "OpenAI image generation supporting dall-e-2, dall-e-3, gpt-image-1 (with validation)."
    )
    ...
    inputs: Dict[str, Dict[str, str]] = {
        ...
        "quality": {
            "type": "string",
            "description": "quality for gpt-image-1/dall-e-3",
        },
        ...
        "output_compression": {
            "type": "integer",
            "description": "gpt-image-1 jpeg/webp",
        },
        "output_format": {"type": "string", "description": "gpt-image-1 png/jpeg/webp"},
        "partial_images": {
            "type": "integer",
            "description": "gpt-image-1 streaming partials",
        },
        "response_format": {
            "type": "string",
            "description": "url | b64_json for dalle-2/3",
        },
    ...
    def __call__(
        ...
        try:
            ...
            validation_result = validate_parameters(
                actual_model, params_to_validate, "generation"
            )
            ...
            for i, image_data in enumerate(response.data):
                try:
                    ...
                    if result["success"]:
                        ...
                        results.append(
                            f"Error saving image {i+1}: {result.get('error', 'Unknown error')}"
                        )
