...
class OpenRouterImageToolkit(Toolkit):
    def __init__(
        ...
        generation = OpenRouterImageGenerationEditTool(
            api_key=api_key, storage_handler=storage_handler
        )
...
class ImageAnalysisToolkit(Toolkit):
    def __init__(
        ...
        analysis = ImageAnalysisTool(
            api_key=api_key, model=model, storage_handler=storage_handler
        )
