# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\file_tool.py
import os
...
class ReadFileTool(Tool):
    name: str = "read_file"
    description: str = (
        "Read content from a file with special handling for different file types like PDFs"
    )
...
class WriteFileTool(Tool):
    name: str = "write_file"
    description: str = (
        "Write content to a file with special handling for different file types like PDFs"
    )
    inputs: Dict[str, Dict[str, str]] = {
...
class AppendFileTool(Tool):
    ...
    description: str = (
        "Append content to a file with special handling for different file types like PDFs"
    )
    inputs: Dict[str, Dict[str, str]] = {
