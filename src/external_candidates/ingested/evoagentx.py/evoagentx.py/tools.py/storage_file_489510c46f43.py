...
class SaveTool(Tool):
    name: str = "save"
    description: str = (
        "Save content to a file with automatic format detection and support for various file types including documents, data files, images, videos, and sound files"
    )
...
class ReadTool(Tool):
    name: str = "read"
    description: str = (
        "Read content from a file with automatic format detection and support for various file types including documents, data files, images, videos, and sound files"
    )
    inputs: Dict[str, Dict[str, str]] = {
...
class AppendTool(Tool):
    name: str = "append"
    description: str = (
        "Append content to a file (only for supported formats: txt, json, csv, yaml, pickle, xlsx)"
    )
    inputs: Dict[str, Dict[str, str]] = {
...
class ListFileTool(Tool):
    name: str = "list_files"
    description: str = (
        "List files and directories in a path with structured information"
    )
    inputs: Dict[str, Dict[str, str]] = {
        "path": {
            "type": "string",
    ...
    def __call__(
        ...
        """
        try:
            result = self.storage_handler.list(
