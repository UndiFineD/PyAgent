# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\database_base.py
...
class DatabaseBase(ABC):
    ...
    def __init__(
        self, connection_string: str = None, database_name: str = None, **kwargs
    ):
        """
    ...
    @abstractmethod
    def execute_query(
        self, query: Union[str, Dict, List], query_type: QueryType = None, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def validate_query(self, query: Union[str, Dict, List]) -> Dict[str, Any]:
        ...
        try:
            ...
            if isinstance(query, str):
                ...
                return {
                    "valid": False,
                    "error": f"Unsupported query type: {type(query)}",
                }
    ...
    def format_query_result(
        self, data: Any, query_type: QueryType, execution_time: float = None, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def format_error_result(
        self, error: str, query_type: QueryType = None, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supported_query_types": [
                qt.value for qt in self.get_supported_query_types()
            ],
            "connection_info": {
