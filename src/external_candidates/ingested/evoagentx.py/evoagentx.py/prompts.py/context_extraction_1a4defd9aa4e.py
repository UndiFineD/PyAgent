# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\prompts\context_extraction.py
...
CONTEXT_EXTRACTION_SYSTEM_PROMPT = (
    "You are an expert in extracting data required to perform an action. \
