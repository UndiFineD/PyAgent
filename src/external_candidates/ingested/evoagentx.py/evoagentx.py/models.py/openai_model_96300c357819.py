# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\models\openai_model.py
import asyncio
...
class OpenAILLM(BaseLLM):
    ...
    def single_generate(self, messages: List[dict], **kwargs) -> str:
        ...
        output_response = (
            ...
            if "output_response" in kwargs
            else self.config.output_response
        )
    ...
    async def single_generate_async(self, messages: List[dict], **kwargs) -> str:
        ...
        try:
            ...
            raise RuntimeError(
                f"Error during single_generate_async of OpenAILLM: {str(e)}"
            )
