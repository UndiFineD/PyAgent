# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\transforms\query\HyDE.py
...
if __name__ == "__main__":
    ...
    os.environ["SSL_CERT_FILE"] = (
        r"D:\miniconda3\envs\envoagentx\Library\ssl\cacert.pem"
    )
    ...
    output_query = hyde_trans(
        Query(query_str="Were Scott Derrickson and Ed Wood of the same nationality?")
    )
    print(output_query)
