# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\chunkers\semantic_chunker.py
import asyncio
...
class SemanticChunker(BaseChunker):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.parser = SemanticSplitterNodeParser(
            embed_model=self.embed_model, similarity_threshold=similarity_threshold
        )
    ...
    def chunk(self, documents: List[Document], **kwargs) -> Corpus:
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            future_to_doc = {
                executor.submit(self._process_document, doc): doc for doc in documents
            }
