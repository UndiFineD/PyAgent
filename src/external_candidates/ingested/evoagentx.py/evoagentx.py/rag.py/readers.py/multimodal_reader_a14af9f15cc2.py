# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\readers\multimodal_reader.py
    ...
    def load(
        ...
        try:
            ...
            if filter_file_by_suffix:
                all_files = [
                    f for f in all_files if f.suffix.lower() in filter_file_by_suffix
                ]
