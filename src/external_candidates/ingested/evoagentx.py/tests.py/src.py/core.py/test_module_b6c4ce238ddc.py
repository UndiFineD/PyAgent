    ...
    def validate_k4(cls, value):
        if value == "k4_value":
            raise NotImplementedError(
                'the method for "k4=k4_value" is not implemented!'
            )
        return value
...
class TestModule(unittest.TestCase):
    ...
    def test_subclass(self):
        ...
        self.assertTrue(
            isinstance(module.k10[0], ToyModule)
            and module.k10[0].class_name == "ToyModule"
        )
        self.assertTrue(
        ...
        self.assertTrue(
            isinstance(module.k12["key"], ToyModule3)
            and module.k12["key"].class_name == "ToyModule3"
        )
        self.assertTrue(
            isinstance(module.k12["key"].k7, ToyModule)
            and module.k12["key"].k7.class_name == "ToyModule"
        )
        self.assertTrue(
            isinstance(module.k12["key"].k9, ToyModule2)
            and module.k12["key"].k9.class_name == "ToyModule2"
        )
