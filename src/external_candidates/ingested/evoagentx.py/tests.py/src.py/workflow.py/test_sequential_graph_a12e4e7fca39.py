# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\src\workflow\test_sequential_graph.py
import json
import os
import unittest
...
class TestModule(unittest.TestCase):
    ...
    def test_sequential_workflow_graph_creation(self):
        ...
        self.assertEqual(
            2, len(graph.edges)
        )  # There should be 2 edges connecting 3 nodes
    ...
    def test_sequential_workflow_save_and_load(self):
        ...
        loaded_graph: SequentialWorkFlowGraph = SequentialWorkFlowGraph.from_file(
            save_path
        )
        ...
        self.assertEqual(
            "custom_parse_func", loaded_graph.get_node("Task3").agents[0]["parse_func"]
        )
