# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\src\benchmark\test_hotpotqa.py
import json
import os
import tempfile
import unittest
...
from evoagentx.benchmark.hotpotqa import AFlowHotPotQA, HotPotQA
...
class TestHotPotQA(unittest.TestCase):
    ...
    def test_load_data(self, mock_download):
        ...
        )  # Should not download as file exists
