...
class TestModule(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        agent.set_prompt(
            "test_action_name", "new_test_action_prompt", "new_system_prompt"
        )
        self.assertTrue(agent.system_prompt, "new_system_prompt")
        self.assertEqual(
            agent.get_action("test_action_name").prompt, "new_test_action_prompt"
        )
        ...
        self.assertEqual(
            agent.get_action("test_action_name").prompt, "new_test_action_prompt_v2"
        )
