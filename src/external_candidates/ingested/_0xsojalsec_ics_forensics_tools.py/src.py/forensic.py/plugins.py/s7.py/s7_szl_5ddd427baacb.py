# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ics-forensics-tools\src\forensic\plugins\s7\s7_szl.py
...
SZL_INDEX_NAMES = {
    "szl_0011": {1: "module_identification", 7: "basic_firmware_identification"},
    "szl_001C": {
    ...
    "szl_0032": {4: "object_management_system_status", 3: "operator_interface_O_I"},
    "szl_0424": {-1: "current_mode_transition"},
}
