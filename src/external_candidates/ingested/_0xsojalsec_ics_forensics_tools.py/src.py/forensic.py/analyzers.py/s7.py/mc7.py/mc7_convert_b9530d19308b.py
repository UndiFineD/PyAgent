# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ics-forensics-tools\src\forensic\analyzers\s7\mc7\mc7_convert.py
import binascii
            ...
            try:
                ...
                if op_value in ops:
                    ...
                    commands_255 = {
                        ...
                        0x1B: f"T MD {op2_int}",
                        0x1C: f"SE T {op2_int}",
                        0x1D: f"CC FC {op2_int}",
                        0x20: f"OPN DB{op2_int}",
                        0x24: f"SD T {op2_int}",
                        0x28: f"L B#16#{op2_int}",
                        0x2C: f"SS T {op2_int}",
                        0x34: f"SP T {op2_int}",
                        0x3C: f"R T {op2_int}",
                        0x3D: f"UC FC {op2_int}",
                        0x42: f"L C {op2_int}",
                        0x44: f"FR C {op2_int}",
                        0x4C: f"LC C {op2_int}",
                        0x54: f"CD C {op2_int}",
                        0x55: f"CC FB {op2_int}",
                        0x5C: f"S {op2_int}",
                        0x6C: f"CU C {op2_int}",
                        0x75: f"UC FB {op2_int}",
                        0x7C: f"R {op2_int}",
                        0x80: f"A M {op2_int}.0",
                        0x81: f"A M {op2_int}.1",
                        0x82: f"A M {op2_int}.2",
                        0x83: f"A M {op2_int}.3",
                        0x84: f"A M {op2_int}.4",
                        0x85: f"A M {op2_int}.5",
                        0x86: f"A M {op2_int}.6",
                        0x87: f"A M {op2_int}.7",
                        0x88: f"O M {op2_int}.0",
                        0x89: f"O M {op2_int}.1",
                        0x8A: f"O M {op2_int}.2",
                        0x8B: f"O M {op2_int}.3",
                        0x8C: f"O M {op2_int}.4",
                        0x8D: f"O M {op2_int}.5",
                        0x8E: f"O M {op2_int}.6",
                        0x8F: f"O M {op2_int}.7",
                        0x90: f"S M {op2_int}.0",
                        0x91: f"S M {op2_int}.1",
                        0x92: f"S M {op2_int}.2",
                        0x93: f"S M {op2_int}.3",
                        0x94: f"S M {op2_int}.4",
                        0x95: f"S M {op2_int}.5",
                        0x96: f"S M {op2_int}.6",
                        0x97: f"S M {op2_int}.7",
                        0x98: f"= M {op2_int}.0",
                        0x99: f"= M {op2_int}.1",
                        0x9A: f"= M {op2_int}.2",
                        0x9B: f"= M {op2_int}.3",
                        ...
                        0x9E: f"= M {op2_int}.6",
                        0x9F: f"= M {op2_int}.7",
                        0xA0: f"AN M {op2_int}.0",
                        0xA1: f"AN M {op2_int}.1",
                        0xA2: f"AN M {op2_int}.2",
                        0xA3: f"AN M {op2_int}.3",
                        0xA4: f"AN M {op2_int}.4",
                        0xA5: f"AN M {op2_int}.5",
                        0xA6: f"AN M {op2_int}.6",
                        0xA7: f"AN M {op2_int}.7",
                        0xA8: f"ON M {op2_int}.0",
                        0xA9: f"ON M {op2_int}.1",
                        0xAA: f"ON M {op2_int}.2",
                        0xAB: f"ON M {op2_int}.3",
                        0xAC: f"ON M {op2_int}.4",
                        0xAD: f"ON M {op2_int}.5",
                        0xAE: f"ON M {op2_int}.6",
                        0xAF: f"ON M {op2_int}.7",
                        0xB0: f"R M {op2_int}.0",
                        0xB1: f"R M {op2_int}.1",
                        0xB2: f"R M {op2_int}.2",
                        0xB3: f"R M {op2_int}.3",
                        0xB4: f"R M {op2_int}.4",
                        0xB5: f"R M {op2_int}.5",
                        0xB6: f"R M {op2_int}.6",
                        0xB7: f"R M {op2_int}.7",
                        0xB8: f"A C {op2_int}",
                        0xB9: f"O C {op2_int}",
                        0xBC: f"AN {op2_int}",
                        0xBD: f"ON {op2_int}",
                    ...
                    if op1_int in commands_16:
                        ...
                        if op1_int == 0x3D:
                            ...
                            for x in range(param_length):
                                ...
                                if param_data[0] in pv:
                                    param_value = (
                                        param_data[2] * 0x100 + param_data[3]
                                    ) >> 3
                                    ...
                                    commands.append(
                                        f"P#{(param_value >> 3)}.{(param_value & 0x7)}"
                                    )
                    elif op1_int == 0:
                        ...
                        if (
                            op2_v in [1, 2, 9, 0xA] and value < 128 and point_v <= 7
                        ...
                        if op1_int == 1:
                            ...
                            value = br.read(uint16be)
                            commands.append(
                                f'L {value.decode("utf-16")}'
                            )  # decode into unicode
                        elif op2_int == 6:
                            commands.append(
                                f"L B#({br.read(char())},{br.read(char())})"
                            )
                        elif op2_int == 7:
                            value = br.read(uint16be)
                        ...
                        if (op2_v in [1, 2] and value < 128) or (
                            op2_v in [0x3] and value < 256
                        ):
                            msg = "_!!ERR_out_of_allowed_range!!"
                        if op2_v in op2_value_dict:
                            commands.append(f"{op2_value_dict[op2_v]}{msg}")
                        ...
                        if op2_v in [5, 0xD]:
                            ...
                            op2_vvd[0xE] = "LD"
                        commands.append(
                            f"{op2_o} {op2_vvd[point_v]} [{op2_vd[op2_v]} {value}]"
                        )
                    elif op1_int == 0x52:
                        if op2_int < 0x7F:
                        ...
                        commands.append(
                            f"{op2_vd[point_v]} {op2_vvd[op2_v]} [AR{arv},P#{value}]"
                        )
                    elif op1_int == 0x7E:
                        value = br.read(uint16be)
                        op2_str = op2.hex().upper()
                        ...
                        commands.append(
                            f"{op2_o} {op2_vd[op2_v]}{op2_vvd[point_v]} {value}"
                        )
                    elif op1_int == 0xBA:
                        value = br.read(uint16be)
                        op2_str = op2.hex().upper()
                        ...
                        op2_vd = {1: "I", 2: "Q", 3: "M", 4: "DB", 5: "DI", 6: "L"}
                        op2_vvd = {
                            1: "B",
                            2: "W",
                            3: "D",
                        ...
                        arv = 1 if point_v <= 6 else 2
                        commands.append(
                            f"{op2_o[point_v]} {op2_vd[op2_v]}{op2_vvd[point_v]} [AR{arv},P#{value}]"
                        )
                    elif op1_int == 0xBF:
                        value = br.read(uint16be)
                        op2_str = op2.hex().upper()
                        ...
                        commands.append(
                            f"{op2_vd[point_v]} {op2_vdd} [{op2_vvd[op2_v]} {value}]"
                        )
                    elif op1_int == 0xC0:
                        if op2_int < 0x7F:
                        ...
                        if op2_v == 0:
                            ...
                            commands.append(
                                f"{op2_o[point_v]} {op2_vvd[point_v]} [AR{arv}, P#{value}]"
                            )
                        elif op2_v == 1:
                            op2_vd = {
                                0: "A",
                            ...
                            commands.append(
                                f"{op2_vd[point_v]} [{op2_vvd[op2_v]} {value}]"
                            )
                        elif op2_v == 7:
                            op2_vd = {
                                0: "UC FC",
                        ...
                        if op2_v == 0:
                            ...
                            commands.append(
                                f"{op2_o[point_v]}AR{arv} {op2_vvd[op2_v]} {value}"
                            )
                    elif op1_int == 0x70:
                        value = br.read(uint16be)
