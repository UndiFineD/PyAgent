# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ics-forensics-tools\src\forensic\analyzers\CodeSysV3\file_format.py
import inspect
...
class CodesysV3FileFormat(CodesysV3FileFormatAbstract):
    ...
    def _find_classes(self):
        ...
        return {
            cls.tid: cls for name, cls in classes if issubclass(cls, CodesysBaseTag)
        }
