# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2023\optics_puzzles\wave_machine.py
    ...
    def construct(self):
        ...
        plane = NumberPlane(
            ...
            faded_line_style=dict(
                stroke_color=BLUE_D, stroke_width=0.5, stroke_opacity=0.25
            ),
        )
        ...
        self.play(
            frame.animate.reorient(0, 78, 0)
            .move_to([-0.0, 0.01, 0.02])
            .set_height(9.5),
        ...
        self.play(
            frame.animate.reorient(-80, 88, 0)
            .move_to([0.21, -0.56, 0.39])
            .set_height(11.11),
            run_time=2,
        )
        self.play(
            *(
                Transform(
                    arm1,
                    arm2,
                    path_arc=arm2.angle - arm1.angle,
                    path_arc_axis=RIGHT,
                    run_time=3,
                )
        ...
        self.play(
            *(
                Transform(
                    arm1, arm3, path_arc=arm3.angle - arm2.angle, path_arc_axis=RIGHT
                )
