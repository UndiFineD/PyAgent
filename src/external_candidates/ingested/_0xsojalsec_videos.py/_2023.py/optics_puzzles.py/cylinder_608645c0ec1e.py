# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2023\optics_puzzles\cylinder.py
...
class SimpleLightBeam(InteractiveScene):
    ...
    oscillating_field_config = dict(
        stroke_opacity=0.5, stroke_width=2, tip_width_ratio=1
    )
...
class TwistingLightBeam(SimpleLightBeam):
    ...
    def construct(self):
        ...
        self.play(
            ...
            twist_rate_tracker.animate.set_value(self.twist_rate).set_anim_args(
                time_span=(0, 3)
            ),
            self.frame.animate.reorient(-47, 80, 0)
            .move_to([0.06, -0.05, 0.05])
            .set_height(8.84),
            run_time=6,
        )
        self.wait(2)
        ...
        self.wait(5)
        self.play(
            self.frame.animate.reorient(-87, 88, 0)
            .move_to([0.63, 0.47, -0.25])
            .set_height(10.51),
            run_time=5,
        )
        self.wait(3)
        self.play(
            self.frame.animate.reorient(-43, 78, 0)
            .move_to([0.63, 0.47, -0.25])
            .set_height(10.51),
            run_time=5,
        )
        self.play(
            self.frame.animate.reorient(-34, 80, 0)
            .move_to([1.61, -0.05, 0.3])
            .set_height(10.30),
            run_time=15,
        )
        self.wait(10)
    ...
    def get_polarization_rod(
        self, axes, wave, get_x, stroke_color=None, length_mult=2.0, stroke_width=3
    ):
        rod = Line(IN, OUT)
        rod.set_stroke(
    ...
    def construct(self):
        ...
        waves = VGroup(
            *(
                ...
                for line, wave_len in zip(lines, np.linspace(2.0, 0.5, len(lines)))
            )
        )
        ...
        self.play(
            *(TransformFromCopy(superposition, wave, run_time=2) for wave in waves)
        )
        ...
        self.play(
            *(
            ...
            frame.animate.reorient(-55, 76, 0)
            .move_to([-0.09, 0.13, -0.17])
            .set_height(7.5),
            run_time=3,
        )
        ...
        plane.set_stroke(width=0)
        plane.add(
            Circle(radius=0.5 * cylinder.get_depth(), n_components=100).set_stroke(
                BLACK, 1
            )
        )
        plane.rotate(PI / 2, UP)
        ...
        self.play(
            ...
            frame.animate.reorient(-61, 83, 0)
            .move_to([0.03, -0.16, -0.28])
            .set_height(7)
        ...
        # Add wave trails
        trails = VGroup(*(self.get_wave_trail(line) for line in lines))
        continuous_trails = Group(
            *(self.get_continuous_wave_trail(axes, line) for line in lines)
        )
        ...
        if self.pause_down_the_tube:
            # Test
            self.play(
                self.frame.animate.reorient(-42, 76, 0)
                .move_to([0.03, -0.16, -0.28])
                .set_height(7.00),
            ...
            self.play(
                self.frame.animate.reorient(67, 77, 0)
                .move_to([-0.31, 0.48, -0.33])
                .set_height(4.05),
                run_time=3,
            )
            self.wait(2)
            ...
            self.play(
                ...
                self.frame.animate.reorient(-36, 79, 0)
                .move_to([-0.07, 0.06, 0.06])
                .set_height(7.42),
                run_time=6,
                rate_func=linear,
            )
            ...
            self.play(
                self.frame.animate.reorient(-10, 77, 0)
                .move_to([0.42, -0.16, -0.03])
                .set_height(5.20),
                trails.animate.set_stroke(width=3, opacity=0.25).set_anim_args(
                    time_span=(0, 3)
                ),
                run_time=10,
            )
            ...
            self.play(
                self.frame.animate.reorient(-63, 84, 0)
                .move_to([1.04, -1.86, 0.55])
                .set_height(1.39),
                distance_tracker.animate.set_value(axes.x_axis.x_max),
                run_time=15,
                rate_func=linear,
            ...
            self.play(
                self.frame.animate.reorient(64, 81, 0)
                .move_to([3.15, 0.46, -0.03])
                .set_height(5),
                run_time=3,
            )
            self.wait()
        ...
        self.play(
            ...
            FadeOut(plane),
            self.frame.animate.reorient(54, 78, 0)
            .move_to([3.15, 0.46, -0.03])
            .set_height(5.00)
        ...
        for index in range(len(lines)):
            ...
            dashed_lines = VGroup(
                *(
                    DashedLine(
                        axes.c2p(x, y_min, u * z),
                        axes.c2p(x, y_max, u * z),
                        dash_length=0.02,
                    )
                    for u in [1, -1]
                )
            ...
            self.play(
                ...
                FadeIn(dashed_lines),
                FadeIn(vcomp),
                self.frame.animate.reorient(77, 87, 0)
                .move_to([3.1, 0.4, 0])
                .set_height(5),
            )
            self.play(
        ...
        # Final color
        def get_final_color():
            rgbs = np.array([line.data["stroke_rgba"][0, :3] for line in lines])
        ...
        self.play(
            ...
            self.frame.animate.reorient(43, 73, 0)
            .move_to([3.3, 0.66, -0.38])
            .set_height(5.68),
            run_time=4,
        )
        self.play(
...
class InducedWiggleInCylinder(TwistingLightBeam):
    ...
    def construct(self):
        ...
        x_tracker, plane, rod, ball, x_label = slice_group = self.get_slice_group(
            axes, wave
        )
        rod = self.get_polarization_rod(
            axes, wave, x_tracker.get_value, length_mult=5.0
        )
        ...
        self.play(
            self.frame.animate.reorient(-86, 70, 0)
            .move_to([1.01, -2.98, -0.79])
            .set_height(11.33),
        ...
        self.play(
            self.frame.animate.reorient(-73, 78, 0)
            .move_to([0.8, -2.22, -0.83])
            .set_height(10.64),
        ...
        self.play(
            self.frame.animate.reorient(-60, 79, 0)
            .move_to([0.73, -0.59, -0.39])
            .set_height(9.63),
        ...
        self.wait()
        self.play(
            self.frame.animate.reorient(8, 77, 0)
            .move_to([2.01, -0.91, -0.58])
            .set_height(5.55),
            FadeOut(randy),
            run_time=2,
        )
        ...
        self.wait(4)
        self.play(
            self.frame.animate.reorient(-61, 78, 0)
            .move_to([0.7, 0.05, -0.69])
            .set_height(9.68),
            FadeIn(randy),
            run_time=3,
        )
        self.play(
            LaggedStartMap(FadeOut, Group(line_of_sight, plane, rod, ball, x_label))
        )
        ...
        waves = VGroup(
            *(
                OscillatingWave(
                    axes, offset=axes.c2p(0, 0, z)[2] * OUT, **small_wave_config
                )
                for z in zs
            )
        )
        ...
        self.play(
            self.frame.animate.reorient(-90, 83, 0)
            .move_to([0.17, -0.37, -0.63])
            .set_height(7.35)
            ...
            FadeIn(rods),
            FadeIn(x_label),
            waves.animate.set_stroke(width=0.5, opacity=0.5).set_anim_args(
                time_span=(1, 2), suspend_mobject_updating=False
            ),
            cylinder.animate.set_opacity(0.05).set_anim_args(time_span=(1, 2)),
        )
        self.wait(4)
        self.play(
            self.frame.animate.reorient(-91, 90, 0)
            .move_to([-0.01, -1.39, 0.21])
            .set_height(3.70),
        ...
        lines_of_sight = VGroup(
            *(self.get_line_of_sign(rod, randy, stroke_width=0.5) for rod in rods)
        )
        ...
        self.wait(8)
        self.play(
            self.frame.animate.reorient(-91, 89, 0)
            .move_to([-0.05, -3.75, 0.07])
            .set_height(8.92),
    ...
    def get_line_of_sign(self, rod, observer, stroke_color=WHITE, stroke_width=1):
        ...
        line.add_updater(
            lambda l: l.put_start_and_end_on(observer.eyes.get_top(), rod.get_center())
        )
        line.set_flat_stroke(False)
        return line
...
class VectorFieldWigglingNew(InteractiveScene):
    ...
    def construct(self):
        ...
        wave.add_updater(
            lambda m: m.set_stroke(opacity=wave_opacity_tracker.get_value())
        )
        vector_wave.add_updater(
            lambda m: m.set_stroke(opacity=vector_opacity_tracker.get_value())
        )
        ...
        self.play(
            self.frame.animate.reorient(-33, 83, 0)
            .move_to([-0.75, -1.84, 0.38])
            .set_height(8.00),
            run_time=10,
        )
        self.play(
            self.frame.animate.reorient(-27, 80, 0)
            .move_to([-0.09, -0.42, -0.1])
            .set_height(9.03),
            wave_opacity_tracker.animate.set_value(1).set_anim_args(time_span=(1, 2)),
            vector_opacity_tracker.animate.set_value(0.5).set_anim_args(
                time_span=(1, 2)
            ),
            run_time=4,
        )
        ...
        self.play(
            self.frame.animate.reorient(22, 69, 0)
            .move_to([0.41, -0.67, -0.1])
            .set_height(10.31),
            run_time=8,
        )
        self.play(
...
class ClockwiseCircularLight(InteractiveScene):
    ...
    def construct(self):
        self.play(self.frame.animate.reorient(73, 82, 0), run_time=5)
    ...
    def construct(self):
        ...
        def update_vect(vect):
            ...
            vect.put_start_and_end_on(
                base, base + wave.xt_to_point(x_max, wave.time) * [0, 1, 1]
            )
        ...
        self.play(
            ...
            wave_opacity_tracker.animate.set_value(0.35).set_anim_args(
                time_span=(2, 3)
            ),
            run_time=5,
        )
...
class LinearAsASuperpositionOfCircular(InteractiveScene):
    ...
    def construct(self):
        ...
        plane_config = dict(
            ...
            faded_line_style=dict(
                stroke_color=GREY, stroke_width=0.5, stroke_opacity=0.5
            ),
        )
        planes = VGroup(
        ...
        planes[:2].arrange(DOWN, buff=2.0).set_height(FRAME_HEIGHT - 1.5).next_to(
            ORIGIN, LEFT, 1.0
        )
        ...
        def get_z1():
            return (
                0.5
                * self.amplitude
                * np.exp((PI / 2 + phase1_tracker.get_value()) * 1j)
            )
        ...
        def get_z2():
            return (
                0.5
                * self.amplitude
                * np.exp((PI / 2 - phase2_tracker.get_value()) * 1j)
            )
        ...
        rot_labels = VGroup(*(TexText("Total rotation: 0.00") for _ in range(2)))
    ...
    def get_vector(self, plane, get_z, get_base=lambda: 0, color=BLUE):
        ...
        vect.add_updater(
            lambda m: m.put_start_and_end_on(plane.n2p(get_base()), plane.n2p(get_z()))
        )
        return vect
