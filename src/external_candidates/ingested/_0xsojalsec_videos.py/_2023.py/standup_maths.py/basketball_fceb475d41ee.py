# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2023\standup_maths\basketball.py
import pandas as pd
...
def get_bars(axes, coords, resolution=(50, 94)):
    ...
    int_coords = (
        ((coords - [x_min, y_min]) / [x_max - x_min, y_max - y_min]) * resolution
    ).astype(int)
...
class ShotHistory(InteractiveScene, ThreeDScene):
    def construct(self):
        ...
        self.play(frame.animate.reorient(-65), run_time=10)
        ...
        self.play(
            ...
            self.frame.animate.reorient(-117, 69, 0)
            .move_to([-0.54, -2.5, 0.31])
            .set_height(5.50),
            run_time=3,
        )
        self.wait(2)
        self.play(
            self.frame.animate.reorient(42, 98, 0)
            .move_to([-0.54, -2.5, 0.31])
            .set_height(5.50),
            run_time=3,
        )
        self.wait()
        self.play(
            self.frame.animate.reorient(-29, 95, 0)
            .move_to([-0.57, -2.46, 0.52])
            .set_height(6.10),
            run_time=3,
        )
        ...
        self.play(
            ...
            self.frame.animate.reorient(-159, 84, 0)
            .move_to([-0.41, -2.56, 0.76])
            .set_height(6.73),
            run_time=4,
        )
        self.play(
            self.frame.animate.reorient(-232, 84, 0)
            .move_to([-0.41, -2.56, 0.76])
            .set_height(6.73),
            run_time=15,
        )
        ...
        self.play(
            ...
            self.frame.animate.reorient(0, 31, 0)
            .move_to([-0.37, -2.11, 0.71])
            .set_height(7.26),
            run_time=4,
        )
        self.wait()
        ...
        self.play(
            self.frame.animate.reorient(29, 70, 0)
            .move_to([0.43, -1.87, 0.95])
            .set_height(7.49),
            run_time=25,
        )
        self.wait()
