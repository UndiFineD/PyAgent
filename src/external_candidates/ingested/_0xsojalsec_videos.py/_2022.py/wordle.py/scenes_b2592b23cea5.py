...
class IntroduceDistribution(WordleDistributions):
    ...
    def construct(self):
        ...
        eqs = VGroup(
            ...
            OldTex(
                "E[I] = \\log_2\\left({1 \\over 1 / 16}\\right) = \\log_2(16) = 4.00"
            ),
            OldTex(
                "E[I] = \\log_2\\left({1 \\over 1 / 64}\\right) = \\log_2(64) = 6.00"
            ),
        )
        eqs.scale(0.7)
        for eq in eqs:
...
class KeyIdea(Scene):
    def construct(self):
        ...
        idea = OldTexText(
            "Informative", " $\\Leftrightarrow$", " Unlikely", font_size=72
        )
        self.add(title)
        idea[0].save_state()
        idea[0].center()
...
class HowLookTwoAheadWorks(Scene):
    ...
    def construct(self):
        ...
        # Reminder on entropy
        H_eq = OldTex(
            "E[I] = \\sum_{x} p(x) \\cdot \\log_2\\big((1 / p(x)\\big)", font_size=36
        )
...
class Thumbnail(Scene):
    def construct(self):
        ...
        # Title
        title = Text(
            "Best opener: CRANE", font_size=100, font="Consolas", t2c={"crane": GREEN}
        )
