# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\tweets\sudanese_band.py
...
class SudaneseBandToKleinBottle(ThreeDScene):
    def construct(self):
        ...
        self.add(s_band)
        self.play(Rotate(sb_copy, PI, axis=RIGHT, about_point=ORIGIN), run_time=4)
