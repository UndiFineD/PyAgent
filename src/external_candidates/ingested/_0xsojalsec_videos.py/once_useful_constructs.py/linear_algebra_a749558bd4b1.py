# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\once_useful_constructs\linear_algebra.py
...
import numpy as np
from manimlib.constants import DEFAULT_MOBJECT_TO_MOBJECT_BUFF, LEFT, RIGHT, WHITE
...
if TYPE_CHECKING:
    ...
    from manimlib.typing import ManimColor, Self, VectNArray
