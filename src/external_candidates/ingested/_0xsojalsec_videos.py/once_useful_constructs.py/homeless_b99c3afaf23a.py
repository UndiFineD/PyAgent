...
class Cycloidify(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(
            Transform(lines, cycloids, run_time=3, path_func=path_along_arc(np.pi / 2))
        )
        self.wait()
        self.play(
            Transform(lines, polar, run_time=3, path_func=path_along_arc(-np.pi / 2))
        )
        self.wait()
...
class PythagoreanTransformation(Scene):
    def construct(self):
        ...
        self.play(
            Transform(
                mover, arrangment2, run_time=3, path_func=path_along_arc(np.pi / 2)
            )
        )
        self.remove(c_region)
        ...
        self.play(
            Transform(
                mover, arrangment1, run_time=3, path_func=path_along_arc(-np.pi / 2)
            )
        )
        self.wait()
...
class PullCurveStraight(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(
            Transform(parabola, line, path_func=path_along_arc(np.pi / 2), run_time=2)
        )
...
class StraghtenCircle(Scene):
    def construct(self):
        ...
        line = Line(
            np.pi * radius * LEFT, np.pi * radius * RIGHT, color=circle.get_color()
        )
...
class ShowSumOfSquaresPattern(Scene):
    def construct(self):
        dots = VGroup(
            *[
                VGroup(*[Dot() for x in range(2 * n + 1)]).arrange(
