    ...
    def interpolate_mobject(self, alpha):
        ...
        points = [
            ...
            (
                ...
                * np.sqrt(np.tan(theta) ** 2 - np.sin(theta) ** 2)
                + np.cos(theta)
            )
            * RIGHT
            + self.center,
...
class TwoThreeEightExample(Scene):
    def construct(self):
        ...
        self.play(
            Write(eq), Write(eight), GrowFromCenter(brace), Write(three), run_time=1
        )
        self.wait()
        ...
        rad_three, rad1, rad2, rad_eight, rad_eq, rad_two = OldTex(
            "\\sqrt[3]{8} = 2"
        ).split()
        self.play(
            *[
        ...
        l, o, g, log_two, p1, log_eight, p2, log_eq, log_three = OldTex(
            "\\log_2(8) = 3"
        ).split()
        self.clear()
        self.play(
        ...
        self.play(
            ApplyMethod(
                VMobject(l, o, g).set_color, RED, rate_func=there_and_back, run_time=2
            )
        )
        self.wait()
...
class WhatTheHell(Scene):
    def construct(self):
        ...
        for mob in arrow1, rad, arrow2, log:
            ...
            last = mob
        q_marks = VMobject(
            *[OldTex("?!").next_to(arrow, RIGHT) for arrow in (arrow1, arrow2)]
        )
