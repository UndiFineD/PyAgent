...
class LinearCombinationScene(LinearTransformationScene):
    ...
    def show_linear_combination(
        ...
        for coord, basis, scalar in zip(coord_mobs, basis_vectors, numerical_coords):
            ...
            new_label.move_to(
                basis.label, aligned_edge=basis.get_center() - basis.label.get_center()
            )
...
class IntroduceJennifer(JenniferScene):
    ...
    def how_we_label_her_basis(self):
        ...
        self.play(
            ShowCreation(you.bubble), Write(b1_coords), you.change_mode, "speaking"
        )
        self.play(
...
class TranslateFromJenny(JenniferScene):
    ...
    def ask_question(self):
        ...
        self.play(
            Transform(self.jenny_plane, self.plane), *list(map(Animation, everything))
        )
        self.play(
            self.you.change_mode,
            "confused",
...
class TalkThroughChangeOfBasisMatrix(JenniferScene):
    def construct(self):
        ...
        self.add_foreground_mobject(
            self.jenny, self.you, self.you.bubble, basis_coords_pair, matrix
        )
        ...
        self.apply_transposed_matrix(
            ...
            added_anims=[
                ...
                Transform(
                    VGroup(*matrix_copy.get_mob_matrix()[:, 0]), b1_coords.get_entries()
                ),
            ],
        )
        ...
        self.apply_transposed_matrix(
            ...
            added_anims=[
                ...
                Transform(
                    VGroup(*matrix_copy.get_mob_matrix()[:, 1]), b2_coords.get_entries()
                ),
            ],
        )
        self.remove(matrix_copy)
...
class SummarizeTranslationProcess(Scene):
    ...
    def show_translation(self):
        ...
        our_arrow = Arrow(
            our_words.get_top(), our_vector.get_bottom(), color=our_vector.get_color()
        )
