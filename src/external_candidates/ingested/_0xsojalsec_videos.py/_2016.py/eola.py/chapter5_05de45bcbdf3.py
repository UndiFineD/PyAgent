...
class NameDeterminant(LinearTransformationScene):
    ...
    def construct(self):
        ...
        self.add_title(
            ["The", "``determinant''", "of a transformation"], scale_factor=1
        )
...
class FlipSpaceOver(Scene):
    def construct(self):
        ...
        plane2 = NumberPlane(
            y_radius=FRAME_X_RADIUS, color=RED_D, secondary_color=RED_E
        )
        axis = UP
...
class RightHandRule(Scene):
    ...
    def construct(self):
        ...
        v1_label, v2_label, v3_label = [
            OldTex(label_tex).scale(1.5) for label_tex in self.labels_tex
        ]
