# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2015\ka_playgrounds\parametric_curves.py
#!/usr/bin/env python
...
class VectorDraw(Animation):
    ...
    def __init__(self, func, **kwargs):
        ...
        self.curve = ParametricCurve(
            func, t_min=self.t_min, t_max=self.t_max, color=self.line_color
        )
        self.vector = Vector(func(self.t_min), color=self.vector_color)
