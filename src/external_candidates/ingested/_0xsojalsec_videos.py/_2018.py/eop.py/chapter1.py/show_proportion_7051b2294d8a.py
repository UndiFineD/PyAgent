...
class ProbabilityRect(VMobject):
    ...
    def __init__(self, p0, **kwargs):
        ...
        self.unit_rect = Rectangle(
            width=self.unit_width, height=self.unit_height, stroke_color=self.color
        )
        self.p = p0
...
class ShowProbAsProportion(Scene):
    ...
    def construct(self):
        ...
        prob_mob = ProbabilityRect(
            p0, unit_width=4, unit_height=2, use_percent=False, num_decimal_places=2
        )
