# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\various_intro_visuals.py
    ...
    def construct(self):
        ...
        cloud = VGroup(
            *[
                ...
                for x, y in zip(
                    np.random.normal(0, 1, n_points), np.random.normal(0, 1, n_points)
                )
            ]
        )
        ...
        random_pairs = [(p1, p2) for (p1, p2) in it.combinations(cloud, 2)]
...
class BinaryChoices(Scene):
    ...
    def construct(self):
        ...
        self.play(LaggedStartMap(FadeIn, all))
