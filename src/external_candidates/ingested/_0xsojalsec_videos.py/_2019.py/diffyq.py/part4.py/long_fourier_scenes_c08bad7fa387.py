# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2019\diffyq\part4\long_fourier_scenes.py
...
class ZoomedInFourierSeriesExample(
    FourierSeriesExampleWithRectForZoom, MovingCameraScene
):
    CONFIG = {
        "vector_config": {
...
class SigmaZoomedInFourierSeriesExample(
    SigmaFourierSeriesExampleWithRectForZoom, ZoomedInFourierSeriesExample
):
    pass
...
class FourierOfHilbert(FourierSeriesExampleWithRectForZoom):
    ...
    def get_path(self):
        ...
        points = [interpolate(end, start, alpha) for alpha in np.linspace(0, 1, 10)]
        for point in points:
