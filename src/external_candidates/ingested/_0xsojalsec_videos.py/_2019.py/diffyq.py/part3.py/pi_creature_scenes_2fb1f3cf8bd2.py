# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2019\diffyq\part3\pi_creature_scenes.py
...
class InFouriersShoes(PiCreatureScene, WriteHeatEquationTemplate):
    def construct(self):
        ...
        self.play(
            Animation(triangle),
            ApplyMethod(
                time_line.shift, time_line.n2p(2019) - time_line.n2p(1822), run_time=5
            ),
        )
        self.wait()
...
class SineCurveIsUnrealistic(TeacherStudentsScene):
    def construct(self):
        ...
        self.play_student_changes(
            "guilty", "angry", "hesitant", added_anims=[self.teacher.change, "tease"]
        )
        self.wait(3)
        self.play(
