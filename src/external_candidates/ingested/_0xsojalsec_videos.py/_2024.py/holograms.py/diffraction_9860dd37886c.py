...
class LightIntensity(LightWaveSlice):
    def __init__(
        self, *args, color: ManimColor = BLUE, show_intensity: bool = True, **kwargs
    ):
...
class LightFieldAroundScene(InteractiveScene):
    def construct(self):
        ...
        n_perp_waves = 10
        perp_waves = Group(
            wave.copy().rotate(PI / 2, RIGHT).shift(z * OUT)
            for z in np.linspace(-1, 1, n_perp_waves)
        )
        ...
        self.wait(3)
        self.play(
            eye_dot.animate.move_to(1.5 * LEFT + 2 * DOWN).set_anim_args(
                path_arc=45 * DEGREES
            ),
            run_time=12,
...
class DiffractionGratingScene(InteractiveScene):
    ...
    def get_wall_with_slits(
        ...
        edge_piece_width = (
            0.5 * (total_width - parts.get_width()) + parts[0].get_width()
        )
...
class LightExposingFilm(DiffractionGratingScene):
    def construct(self):
        ...
        graph.add_updater(
            lambda m: m.stretch(wave_amp_tracker.get_value() / initial_wave_amp, dim=1)
        )
        ...
        linear_field = VectorField(
            field_func, sample_points=wave_line.get_points()[::4], max_vect_len=2.0
        )
        ...
        phase_vect = Arrow(
            phase_circle.get_center(), phase_circle.get_right(), buff=0, thickness=2
        )
        ...
        self.play(
            ...
            phase_arrow.animate.put_start_and_end_on(
                phase_arrow.get_start(), phase_line.get_end()
            ),
            run_time=3,
        )
        self.play(
            Rotate(phase_vect, TAU, axis=LEFT, about_point=phase_vect.get_start()),
            phase_arrow.animate.put_start_and_end_on(
                phase_arrow.get_start(), phase_line.get_start()
            ),
            run_time=3,
        )
        self.wait(2)
        ...
        phase_vect.add_updater(
            lambda m: m.put_start_and_end_on(
                ...
                phase_circle.pfp(
                    (wave.uniforms["frequency"] * wave.uniforms["time"]) % 1
                ),
            )
        )
        ...
        self.play(
            LaggedStart(
                ...
                TransformFromCopy(
                    amp_label.copy().clear_updaters(), exp_expr[R"\text{Amplitude}"][0]
                ),
        ...
        self.play(
            wave.animate.set_uniform(time_rate=-0.5).set_anim_args(
                rate_func=there_and_back
            ),
        ...
        linear_field2 = VectorField(
            field_func2, sample_points=line2.get_points()[::4], max_vect_len=2.0
        )
        ...
        # Zoom in
        self.play(
            frame.animate.reorient(-58, -18, 0, (3.29, 0.39, 0.55), 10.68), run_time=4
        )
...
class TwoInterferingWaves(DiffractionGratingScene):
    def construct(self):
        ...
        self.play(
            frame.animate.reorient(17, -24, 0, (-5.5, -0.82, -0.67), 15.86), run_time=30
        )
...
class SinglePointOnFilm(DiffractionGratingScene):
    def construct(self):
        ...
        # Spherical waves
        wave_stack = Group(
            obj_wave.copy().rotate(PI / 2, OUT).set_opacity(0.1) for x in range(30)
        )
        ...
        source_arrow = Arrow(
            source_label["Object"].get_bottom(), source_point.get_center(), buff=0.1
        )
        ...
        self.play(
            ...
            frame.animate.reorient(
                0, -90, 0, source_point.get_center(), 4
...
class ExplainWaveVisualization(DiffractionGratingScene):
    def construct(self):
        ...
        self.play(
            ...
            frame.animate.reorient(81, 84, 0, (-0.5, 0.69, 0.23), 1.65).set_anim_args(
                run_time=3
            ),
        )
        self.wait()
        ...
        self.play(
            ...
            linear_field.animate.set_stroke(opacity=0.75).set_anim_args(
                time_span=(0, 2)
            ),
            wave.animate.set_uniform(time_rate=0.5).set_anim_args(
                suspend_mobject_updating=False
        ...
        self.play(
            ...
            frame.animate.reorient(48, 79, 0, (-0.42, 1.07, 0.35), 4.18).set_anim_args(
                run_time=8
            ),
        )
        wave.save_state()
...
class CreateZonePlate(DiffractionGratingScene):
    ...
    def construct(self):
        ...
        for front in wave_fronts:
            front.add_updater(
                lambda m, dt: m.shift(dt * (frequency / wave_number) * IN)
            )
        ...
        self.play(
            ...
            frame.animate.reorient(0, -40, 0, (-0.16, 0.01, -0.24), 7.08).set_anim_args(
                run_time=4
            ),
        )
        self.play(
        ...
        ref_source.move_to(
            source_point.get_center() + ((1000 // wave_number) * wave_number) * OUT
        )
        ...
        obj_graph, ref_graph = graphs = VGroup(
            self.get_graph_over_wave(
                line, wave, scale_factor=sf, direction=UP, color=color
            )
            for line, color, wave, sf in zip(
                lines, colors, [obj_wave, ref_wave], [0.15, 0.1]
            )
        )
        ...
        obj_line.add_updater(
            lambda m: m.put_start_and_end_on(
                source_point.get_center(), trg_point.get_center()
            )
        )
        ref_line.add_updater(
            lambda m: m.move_to(trg_point.get_center() + 0.02 * RIGHT, IN)
        )
        ...
        self.play(
            ...
            frame.animate.reorient(0, -23, 0, (-0.14, 0.01, -2.23), 6.52).set_anim_args(
                run_time=8
            ),
        )
        ...
        time0 = self.time
        frame.add_updater(
            lambda m, t0=time0, sc=self: m.set_theta(
                math.sin(0.1 * (sc.time - t0)) * 30 * DEGREES
            )
        )
        ...
        self.play(
            frame.animate.reorient(-85, -9, 0, (0.65, -0.24, -0.14), 6.52), run_time=4
        )
        ...
        mid_line.add_updater(
            lambda m: m.set_points_as_corners(
                [source_point.get_center(), get_film_point()]
            )
        )
    ...
    def get_round_exposure(self, exposure, radius=1.0, n_pieces=128):
        ...
        vects = [
            rotate_vector(RIGHT, theta) for theta in np.linspace(0, TAU, n_pieces + 1)
        ]
        result = Group(
...
class DoubleSlit(DiffractionGratingScene):
    def construct(self):
        ...
        self.play(
            ...
            UpdateFromAlphaFunc(
                ...
                lambda m, a: m.set_stroke(
                    width=3 * clip(there_and_back_with_pause(2 * a, 0.7), 0, 1)
                ),
            ),
        ...
        # Change spacing
        wall = n_slit_wall
        wall.target = self.get_wall_with_slits(
            16, spacing=2 + 0.2 * PI, total_width=2 * full_width
        )
        ...
        start_arrows, end_arrows = [
            VGroup(
                ...
                .set_width(0.7 * block.get_width(), stretch=True)
                .next_to(block, OUT)
        ...
        self.play(
            frame.animate.reorient(0, 52, 0, (0.91, 35.42, 33.91), 102.49), run_time=16
        )
        ...
        self.play(
            frame.animate.reorient(11, 65, 0, (-0.03, 0.06, 0.14), 8.66), run_time=3
        )
        ...
        self.play(
            ...
            FadeIn(single_slit_wall),
            in_wave.animate.set_opacity(0.85)
            .set_time_rate(1.0)
            .set_anim_args(suspend_mobject_updating=False),
            radial_wave.animate.set_time_rate(1.0).set_anim_args(
                suspend_mobject_updating=False
            ),
        ...
        self.play(
            radial_wave.animate.set_decay_factor(1.0)
            .set_max_amp(0.75)
            .set_anim_args(suspend_mobject_updating=False),
            run_time=2,
        )
        ...
        two_slit_wall = self.get_wall_with_slits(
            2, spacing=3.0, depth=single_slit_wall.get_depth()
        )
        ...
        self.wait(4)
        self.play(
            frame.animate.reorient(-25, 48, 0, (0.23, 4.15, -0.03), 9.80), run_time=8
        )
        self.play(
            frame.animate.reorient(28, 50, 0, (0.23, 4.15, -0.03), 9.80), run_time=8
        )
        ...
        self.play(
            frame.animate.reorient(0, 68, 0, (0.23, 4.15, -0.03), 9.80), run_time=4
        )
        ...
        lines[0].f_always.put_start_and_end_on(
            source1.get_center, exposure_point.get_center
        )
        lines[1].f_always.put_start_and_end_on(
            source2.get_center, exposure_point.get_center
        )
        ...
        self.wait()
        self.play(
            ShowCreation(graphs, lag_ratio=0, run_time=3, suspend_mobject_updating=True)
        )

        # Show combination from a side angle
        self.play(
            frame.animate.reorient(-80, 83, 0, (-0.09, 4.1, -0.16), 7.52), run_time=3
        )
        ...
        self.play(
            exposure_point.animate.shift(0.9 * RIGHT).set_opacity(0.25), run_time=2
        )
        self.wait()
        self.play(
        ...
        self.play(
            *(
                wave.animate.set_wave_number(2).set_anim_args(
                    suspend_mobject_updating=False
                )
            ...
            UpdateFromAlphaFunc(
                Point(),
                lambda m, a: exposure.set_color(
                    interpolate_color_by_hsl(GREEN_SCREEN, trg_color, a)
                ),
                remover=True,
            ),
        ...
        self.play(
            frame.animate.reorient(-80, 68, 0, (-0.22, 2.44, 0.8), 6.42), run_time=3
        )
        self.play(
...
class FullDiffractionGrating(DiffractionGratingScene):
    def construct(self):
        ...
        wall = self.get_wall_with_slits(
            32, spacing=slit_dist, depth=2.0, total_width=full_width
        )
        ...
        self.play(
            ...
            frame.animate.reorient(
                11, 72, 0, (-1.12, 5.34, -0.64), 11.13
            ).set_anim_args(run_time=8),
        )
        ...
        self.play(
            ...
            out_wave.animate.set_opacity(1).set_anim_args(
                suspend_mobject_updating=False
            ),
            in_wave.animate.set_opacity(0.25).set_anim_args(
                suspend_mobject_updating=False
            ),
            run_time=8,
        )
        ...
        self.play(
            out_wave.animate.set_opacity(0.2).set_anim_args(
                suspend_mobject_updating=False
            ),
            FadeOut(dist_label),
        ...
        self.play(
            ...
            ShowCreation(
                graphs, lag_ratio=0.01, suspend_mobject_updating=False, time_span=(0, 2)
            ),
        ...
        self.play(
            ...
            out_wave.animate.set_opacity(0.85).set_anim_args(
                suspend_mobject_updating=False
            ),
        ...
        self.play(
            ...
            out_wave.animate.set_max_amp(1).set_anim_args(
                suspend_mobject_updating=False
            ),
            run_time=20,
        )
        ...
        beam_outlines[0].f_always.put_start_and_end_on(
            sources.get_left, beam_point.get_center
        )
        beam_outlines[1].f_always.put_start_and_end_on(
            sources.get_right, beam_point.get_center
        )
        center_beam_line.f_always.put_start_and_end_on(
            sources.get_center, beam_point.get_center
        )
        ...
        self.play(
            FadeIn(point_tracker),
            out_wave.animate.set_opacity(0.5).set_anim_args(
                suspend_mobject_updating=False
            ),
        )
        self.play(
        ...
        self.play(
            LaggedStartMap(ShowCreationThenFadeOut, lines, lag_ratio=0.25, run_time=8)
        )
        ...
        self.play(
            TransformFromCopy(d_line, v_line), ShowCreation(arc), Write(theta_sym)
        )
        self.wait(2)
        self.play(
            ShowCreation(
                lines, lag_ratio=0.01, run_time=2, suspend_mobject_updating=True
            ),
            FadeOut(VGroup(v_line, d_line, arc, theta_sym)),
        )
        self.wait(4)
        self.play(
            point_tracker.animate.move_to(1.15 * point_tracker.get_center()), run_time=2
        )
        ...
        self.play(
            ...
            out_wave.animate.set_opacity(0.1).set_anim_args(
                suspend_mobject_updating=False
            ),
            in_wave.animate.set_opacity(0.1).set_anim_args(
                suspend_mobject_updating=False
            ),
        ...
        self.wait()
        self.play(
            TransformFromCopy(line2, matched_segment), line1.animate.set_stroke(width=1)
        )
        self.wait()
        self.play(
            LaggedStart(
        ...
        self.play(
            d_sine_theta.animate.scale(0.75)
            .next_to(lambda_label, LEFT, buff=0.05)
            .shift(0.025 * DOWN),
            FadeIn(lambda_label, 0.25 * RIGHT),
            FadeOut(line2),
            FadeOut(matched_segment),
            diff_segment.animate.set_stroke(width=2),
            frame.animate.reorient(0, 0, 0, (0.14, 0.48, 0.0), 3.17).set_anim_args(
                run_time=2
            ),
        )
        ...
        shift_value = p2 - p1
        other_sines = VGroup(
            sine.copy().shift(x * shift_value) for x in range(-2, 4) if x != 0
        )
        ...
        for scale_factor in scale_factors:
            arrows = VGroup(
                Vector(0.3 * RIGHT, thickness=1), Vector(0.3 * LEFT, thickness=1)
            )
        ...
        if False:  # This was just a temporary insert, not to be run in general
            ...
            self.play(
                d_sine_theta.animate.next_to(new_rhs, LEFT, buff=0.05).shift(
                    0.02 * DOWN
                ),
        ...
        # Write conclusion
        conclusion = VGroup(
            Text("Difference in distance:", font_size=36), Tex(R"d \cdot \sin(\theta)")
        )
        ...
        self.play(
            ...
            out_wave.animate.set_opacity(0.85).set_anim_args(
                suspend_mobject_updating=False, time_span=(0, 2)
            ),
            frame.animate.reorient(0, 0, 0, (0, 200, 0.0), 400),
            sources.animate.set_radius(0.75),
            lines.animate.set_stroke(width=20).set_anim_args(
                suspend_mobject_updating=False
            ),
            point_tracker.animate.scale(2.0, about_point=ORIGIN).set_anim_args(
                time_span=(0, 8)
            ),
            run_time=20,
        ...
        d_line.add_updater(
            lambda m, pt=point_tracker: m.put_start_and_end_on(
                ORIGIN, 5 * pt.get_center()
            )
        )
        self.play(
            ShowCreation(v_line),
        ...
        for n in [1, 2]:
            d_angle = angle_of_vector(
                get_dist_point(n / wave_number)
            ) - angle_of_vector(get_dist_point((n + 1) / wave_number))
            self.play(
...
class PlaneWaveThroughZonePlate(DiffractionGratingScene):
    def construct(self):
        ...
        annotations = VGroup(
            Text(
                "The distances between adjacent fringes and\nthe object should differ by one wavelength"
            ),
        ...
        brace_texts = VGroup(
            TexText(R"Dist. to fringe\\at height $(x + d)$", font_size=24).next_to(
                braces[0], UP, SMALL_BUFF
            ),
            TexText(R"Dist. to fringe\\at height $x$", font_size=24).next_to(
                braces[1], UP, SMALL_BUFF
            ),
        )
        ...
        self.play(
            ...
            frame.animate.reorient(0, 0, 0, (-2, 2.5, 0.0), 9).set_anim_args(
                run_time=3
            ),
        )
        self.wait()
        ...
        self.play(
            ...
            FadeOut(braces),
            FadeOut(brace_texts),
            frame.animate.reorient(0, 0, 0, (0, 1, 0), 6).set_anim_args(
                time_span=(1, 3.5)
            ),
        )
        ...
        self.play(
            ...
            arrow.animate.put_start_and_end_on(
                arrow.get_start(), arrow.get_end() + 0.05 * LEFT + 0.05 * DOWN
            ),
        ...
        self.play(
            GrowFromPoint(
                ref_wave, film_point + 8 * RIGHT, run_time=2, rate_func=linear
            )
        )
        self.play(
            *(
        ...
        arc.add_updater(
            lambda m: m.become(Arc(PI, line.get_angle()).shift(obj_dot.get_center()))
        )
        upper_arc.add_updater(
            lambda m: m.match_points(arc).shift(
                film_dot.get_center() - obj_dot.get_center()
            )
        )
        theta_prime_sym.add_updater(
            lambda m: m.set_height(min(0.8 * arc.get_height(), 0.35)).next_to(
                arc.pfp(0.6), LEFT, SMALL_BUFF
            )
        )
        theta_sym.add_updater(
            lambda m: m.replace(theta_prime_sym[0]).shift(
                film_dot.get_center() - obj_dot.get_center()
            )
        )
        ...
        self.play(
            FadeOut(d_group, time_span=(0, 1)), film_dot.animate.set_y(1), run_time=3
        )
        ...
        self.play(
            FadeIn(big_ref_wave),
            FadeOut(ref_wave),
            frame.animate.reorient(-40, 67, 0, (-2.43, 0.5, -0.12), 9.60).set_anim_args(
                run_time=3
            ),
        )
        self.wait(2)
        ...
        self.play(
            ...
            frame.animate.reorient(-93, 62, 0, (-2.43, 0.5, -0.12), 9.60).set_anim_args(
                run_time=5
            ),
        )
        self.play(
        ...
        conj_lines = VGroup(
            Line(point, obj_dot.get_center()) for point in mid_line_points.get_points()
        )
        ...
        self.play(
            ...
            frame.animate.reorient(0, 0, 0, (-0.1, 1.85, 0.0), 11.08).set_anim_args(
                run_time=4
            ),
        )
        self.wait(4)

    def get_radiating_lines(
        self, point_cloud, obj_dot, length=20, stroke_color=YELLOW, stroke_width=1
    ):
        lines = VGroup()
    ...
    def get_ghost_lines(
        self, point_cloud, obj_dot, dash_length=0.15, stroke_color=WHITE, stroke_width=1
    ):
        lines = VGroup(
    ...
    def get_triple_beam(self, film_point, obj_point, **kwargs):
        ...
        beams = Group(
            self.get_beam(angle=angle, **kwargs) for angle in [-theta, 0, theta]
        )
...
class SuperpositionOfPoints(InteractiveScene):
    def construct(self):
        ...
        for point_set in point_sets:
            self.play(
                dot_cloud.animate.set_points([*point_set, dist_point]), run_time=3
            )
            self.wait(2)
        ...
        plate.set_max_amp(4)
        self.play(
            frame.animate.reorient(61, -7, 0, (0.61, -0.11, -2.44), 8.66), run_time=5
        )
        ...
        self.play(
            ...
            UpdateFromFunc(
                plate, lambda m: m.set_max_amp(2 * np.sqrt(dot_cloud.get_num_points()))
            ),
            run_time=10,
        )
        self.wait(2)
        ...
        self.play(
            UpdateFromAlphaFunc(
                plate, lambda m, a: m.set_opacity(1 - there_and_back_with_pause(a, 0.6))
            ),
        ...
        self.play(
            frame.animate.reorient(3, 0, 0, (0.14, -0.02, 0.03), 0.22), run_time=8
        )
        ...
        sheet_dots = self.create_dot_sheet(
            plate.get_width(), plate.get_height(), radius=0.025, z=plate.get_z()
        )
        self.color_sheet_by_exposure(
            sheet_dots, dot_cloud.get_points()[:1000], wave_number=32
        )
        self.add(sheet_dots)
        ...
        self.play(
            ...
            UpdateFromFunc(
                sheet_dots,
                lambda m: self.color_sheet_by_exposure(
                    m, dot_cloud.get_points()[:1000], wave_number=32
                ),
            ),
            run_time=3,
        )
    ...
    def color_sheet_by_exposure(
        self, sheet_dots, point_sources, wave_number=16, opacity=0.5
    ):
...
class ComplexWaves(InteractiveScene):
    def construct(self):
        ...
        def get_z():
            return amplitude * np.exp(
                complex(0, TAU * frequency * time_tracker.get_value())
            )
        ...
        comb_arrow.put_start_and_end_on(
        ...
        R_arrow.add_updater(
            lambda m: m.put_start_and_end_on(plane.get_origin(), plane.n2p(get_R()))
        )
        O_arrow.add_updater(
            lambda m: m.put_start_and_end_on(
                plane.n2p(get_R()),
    ...
    def get_arrow_label(self, arrow, symbol, font_size=24, buff=0.25):
        ...
        result.add_updater(
            lambda m: m.move_to(
                arrow.get_center()
                + buff * normalize(rotate_vector(arrow.get_vector(), PI / 2))
            )
        )
        return result
...
class StateOnA2DScreen(InteractiveScene):
    def construct(self):
        ...
        self.play(
            ...
            frame.animate.reorient(25, -6, 0, (0.18, 0.29, 0.15), 9.15).set_anim_args(
                time_span=(1, 4)
            ),
            run_time=4,
        )
