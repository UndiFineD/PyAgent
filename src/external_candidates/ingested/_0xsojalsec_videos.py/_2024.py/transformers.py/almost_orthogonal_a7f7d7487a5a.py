# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2024\transformers\almost_orthogonal.py
...
plt.hist(
    angles_degrees[self_orthogonality_mask].numpy().ravel(), bins=1000, range=(80, 100)
)
plt.grid(1)
plt.show()
