# Extracted from: C:\DEV\PyAgent\.external\agentkit_prompting\examples\crafter\tests.py
import json

prompts = [str(i) for i in range(11)]
...
def query_model_test(msg, shrink_idx, max_gen=512, temp=0.0):
    return "Answer to:\n\n{}".format(msg)
