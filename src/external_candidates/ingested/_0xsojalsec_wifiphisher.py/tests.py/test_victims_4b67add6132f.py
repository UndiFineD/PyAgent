...
class TestVictim(unittest.TestCase):
    ...
    def test_victims_inserted_to_dic_and_vendor(self):
        ...
        self.assertTrue(
            "10.0.0.5" == victims_instance.victims_dic["68:CC:6E:23:44:53"].ip_address
        )
        self.assertTrue("5C:BA:37:23:44:53" in victims_instance.victims_dic)
        self.assertTrue(
            "10.0.0.6" == victims_instance.victims_dic["5C:BA:37:23:44:53"].ip_address
        )
        ...
        self.assertTrue(
            "Microsoft" == victims_instance.victims_dic["5C:BA:37:23:44:53"].vendor
        )
    ...
    def test_victim_changed_ipaddr(self):
        ...
        self.assertTrue(
            "10.0.0.10" == victims_instance.victims_dic["5C:BA:37:23:44:53"].ip_address
        )
