# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Imperva_gzip_WAF_Bypass\imperva_gzip.py
#!/usr/bin/env python3
"""
...
if success == False:
    print(
        "[!] Can't POST. Expected HTTP 200 but received HTTP %d. Use -r to allow HTTP 2xx and 3xx."
        % status
    )
    exit(5)
