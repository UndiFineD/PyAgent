# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-liquid-audio\src\liquid_audio\moshi\modules\seanet_test.py
import functools
...
@pytest.mark.parametrize(
    "batch_size, dim, res_layer_index, seq_len, kernel_size", SEANET_RESNET_DATA
)
def test_resnet(batch_size, dim, res_layer_index, seq_len, kernel_size):
    ...
    dilation_base = 2
    layer = SEANetResnetBlock(
        dim=dim,
        dilations=[dilation_base**res_layer_index, 1],
        pad_mode="constant",
        causal=True,
    )
