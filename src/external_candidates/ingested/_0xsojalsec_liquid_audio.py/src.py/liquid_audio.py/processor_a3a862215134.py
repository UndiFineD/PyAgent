...
class LFM2AudioProcessor:
    ...
    def __init__(
        ...
        self.audio_processor = AudioToMelSpectrogramPreprocessor(
            **asdict(audio_processor_config)
        ).eval()
    ...
    def from_pretrained(
        ...
        *,
        ...
        return cls(
            ...
            mimi_weights_path=str(
                cache_path / "tokenizer-e351c8d8-checkpoint125.safetensors"
            ),
        ).to(device)
...
class ChatState(Mapping):
    ...
    def __init__(
        ...
        *,
        ...
        self.text = self.proc.text.encode(
    ...
    def add_text(self, text: str) -> None:
        new_text = self.proc.text.encode(
    ...
    def append(
        self, text: torch.Tensor, audio_out: torch.Tensor, modality_flag: torch.Tensor
    ):
        ...
        self.modality_flag = torch.cat(
            [self.modality_flag, modality_flag.to(self.device)], 1
        )
