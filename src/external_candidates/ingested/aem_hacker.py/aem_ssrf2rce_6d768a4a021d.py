# Extracted from: C:\DEV\PyAgent\.external\aem-hacker\aem_ssrf2rce.py
import argparse
import sys
import uuid
...
def parse_args():
    ...
    parser.add_argument(
        "--url",
        help="URL for SitecatalystServlet or AutoprovisioningServlet, including path, without query part",
    )
