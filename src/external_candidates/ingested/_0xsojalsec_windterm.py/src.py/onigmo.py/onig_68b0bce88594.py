# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WindTerm\src\Onigmo\onig.py
# -*- coding: utf-8 -*-
...
libonig.onig_error_code_to_str.argtypes = [
    ctypes.c_char_p,
    ctypes.c_int,
...
# onig_new
libonig.onig_new.argtypes = [
    ctypes.POINTER(OnigRegex),
    ctypes.c_void_p,
    ctypes.c_void_p,
    OnigOptionType,
    OnigEncoding,
...
# onig_copy_syntax
libonig.onig_copy_syntax.argtypes = [
    ctypes.POINTER(OnigSyntaxType),
    ctypes.POINTER(OnigSyntaxType),
]
