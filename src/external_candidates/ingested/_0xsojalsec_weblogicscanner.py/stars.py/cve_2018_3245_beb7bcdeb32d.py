# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-weblogicScanner\stars\cve_2018_3245.py
#!/usr/bin/env python3
...
class CVE_2018_3245(Star):
    info = {"NAME": "", "CVE": "CVE-2018-3245", "TAG": []}
    type = target_type.VULNERABILITY

    def light_up(
        self, dip, dport, force_ssl=None, delay=0.5, timeout=5, *args, **kwargs
    ) -> (bool, dict):
