# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-weblogicScanner\stars\cve_2020_2551.py
#!/usr/bin/env python3
...
class CVE_2020_2551(Star):
    info = {"NAME": "", "CVE": "CVE-2020-2551", "TAG": []}
    type = target_type.MODULE

    def light_up(
        self, dip, dport, force_ssl=None, timeout=5, *args, **kwargs
    ) -> (bool, dict):
        # t3 handshake
        dport = int(dport)
