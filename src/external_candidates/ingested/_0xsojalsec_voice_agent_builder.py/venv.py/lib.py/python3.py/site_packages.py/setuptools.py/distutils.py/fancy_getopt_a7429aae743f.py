# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\_distutils\fancy_getopt.py
...
import string
import sys
from distutils.errors import DistutilsArgError, DistutilsGetoptError
