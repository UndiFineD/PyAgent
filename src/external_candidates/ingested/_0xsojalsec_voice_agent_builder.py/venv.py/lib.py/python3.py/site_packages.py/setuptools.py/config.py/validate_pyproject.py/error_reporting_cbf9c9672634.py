# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\config\_validate_pyproject\error_reporting.py
import io
import json
import logging
import os
