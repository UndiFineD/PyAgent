# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdf-airgapped-offline-Rag\app\rag.py
...
def retrieve_context(query, top_k=3):
    ...
    try:
        ...
        logger.info(
            f"Number of documents in vectorstore: {vectorstore._collection.count()}"
        )
