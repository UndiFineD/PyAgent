# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IDOR-Forge\core\interactive.py
import logging
import sys
        ...
        try:
            ...
            if self.multi_threaded:
                ...
                with ThreadPoolExecutor(max_workers=10) as executor:
                    future_results = [
                        executor.submit(self.test_payload, checker, payload)
                    ...
                    for future in future_results:
                        ...
                        self.progress_update.emit(
                            int((len(results)) * 100 / total_payloads)
                        )
            else:
    ...
    def show_preferences(self):
        ...
        if preferences_dialog.exec_():
            ...
            self.settings.setValue(
                "multi_threaded", preferences_dialog.is_multi_threaded()
            )
            self.load_settings()
