# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanImage-2.1\hyimage\diffusion\pipelines\hunyuanimage_refiner_pipeline.py
...
class HunYuanImageRefinerPipeline(HunyuanImagePipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents = self._prepare_latents(
            width, height, generator=generator, vae_downsampling_factor=16
        )
    ...
    def from_config(
        cls,
        config: Union[HunYuanImageRefinerPipelineConfig, HunyuanImagePipelineConfig],
    ):
...
def RefinerPipeline(
    ...
    **kwargs,
    ...
    Returns:
        Initialized refiner pipeline instance
    """
    return HunYuanImageRefinerPipeline.from_pretrained(model_name, **kwargs)
