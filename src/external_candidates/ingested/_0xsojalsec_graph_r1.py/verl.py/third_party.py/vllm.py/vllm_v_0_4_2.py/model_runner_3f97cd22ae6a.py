# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\third_party\vllm\vllm_v_0_4_2\model_runner.py
...
from vllm.worker.model_runner import CUDAGraphRunner, ModelRunner
