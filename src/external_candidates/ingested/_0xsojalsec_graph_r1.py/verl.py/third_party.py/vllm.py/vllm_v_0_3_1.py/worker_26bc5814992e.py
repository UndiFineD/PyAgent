# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\third_party\vllm\vllm_v_0_3_1\worker.py
...
class Worker:
    ...
    def profile_num_available_blocks(
        ...
        num_gpu_blocks = int(
            (free_gpu_memory * gpu_memory_utilization) // cache_block_size
        )
