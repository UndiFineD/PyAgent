# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\trainer\main_ppo.py
...
class RewardManager:
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            sequences_str = sequences_str.split(self.tokenizer.decode([pad_token_id]))[
                0
            ]
            ...
            answer_f1_score = _default_compute_score_answer_f1(
                data_source=data_source,
                solution_str=sequences_str,
                ground_truth=ground_truth,
            )
            answer_em_score = _default_compute_score_answer_em(
                data_source=data_source,
                solution_str=sequences_str,
                ground_truth=ground_truth,
            )
            format_score = _default_compute_score_format(
                data_source=data_source, solution_str=sequences_str
            )
