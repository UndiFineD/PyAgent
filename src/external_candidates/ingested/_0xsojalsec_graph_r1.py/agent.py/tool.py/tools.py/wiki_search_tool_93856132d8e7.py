    ...
    def __init__(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"[WARNING] Wiki Search API health check failed: {response.status_code}"
                )
    ...
    def execute(self, args: Dict) -> str:
        ...
        try:
            ...
            response = requests.get(
                f"{self.api_url}/search", params={"query": query, "top_k": limit}
            )
    ...
    def batch_execute(self, args_list: List[Dict]) -> List[str]:
        ...
        try:
            ...
            response = requests.post(
                f"{self.api_url}/search", json={"queries": queries, "top_k": max_limit}
            )
