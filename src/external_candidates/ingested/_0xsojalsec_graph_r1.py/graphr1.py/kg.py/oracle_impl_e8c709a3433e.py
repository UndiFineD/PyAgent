...
TABLES = {
    "HYPERGRAPHRAG_DOC_FULL": {"ddl": """CREATE TABLE HYPERGRAPHRAG_DOC_FULL (
    ...
    "HYPERGRAPHRAG_DOC_CHUNKS": {"ddl": """CREATE TABLE HYPERGRAPHRAG_DOC_CHUNKS (
                    id varchar(256) PRIMARY KEY,
                    workspace varchar(1024),
    ...
    "HYPERGRAPHRAG_GRAPH_NODES": {"ddl": """CREATE TABLE HYPERGRAPHRAG_GRAPH_NODES (
    ...
    "HYPERGRAPHRAG_GRAPH_EDGES": {"ddl": """CREATE TABLE HYPERGRAPHRAG_GRAPH_EDGES (
                    id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    workspace varchar(1024),
    ...
    "HYPERGRAPHRAG_LLM_CACHE": {"ddl": """CREATE TABLE HYPERGRAPHRAG_LLM_CACHE (
                    id varchar(256) PRIMARY KEY,
                    send clob,
                    return clob,
                    model varchar(1024),
    ...
    "HYPERGRAPHRAG_GRAPH": {"ddl": """CREATE OR REPLACE PROPERTY GRAPH graphr1_graph
                VERTEX TABLES (
