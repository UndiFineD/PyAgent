# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KernelSU\scripts\bin2c.py
#!/usr/bin/python3
...
def main():
    ...
    parser.add_argument("filename", help="filename to convert to C array")
    parser.add_argument("varname", nargs="?", help="variable name", default="data")
