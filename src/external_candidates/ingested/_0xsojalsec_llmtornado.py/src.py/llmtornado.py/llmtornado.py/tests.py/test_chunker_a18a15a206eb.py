# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\tests\test_chunker.py
...
def test_chunk_overlap(chunker):
    ...
    if len(chunks) > 1:
        ...
        for i in range(len(chunks) - 1):
            ...
            assert (
                chunk1.char_end > chunk2.char_start
                or chunk1.char_end == chunk2.char_start
            )
