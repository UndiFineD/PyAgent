# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\utils\gitignore_parser.py
"""
...
def _parse_gitignore_lines(
    lines, full_path: str, base_dir: Union[str, Path]
) -> Callable[[Union[str, Path]], bool]:
