# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\utils\ignore_patterns.py
"""
...
class IgnorePatternMatcher:
    ...
    def __init__(
        self, root_path: Path, use_gitignore: bool = True, use_fskbignore: bool = True
    ):
...
""".strip()
        ...
        logger.debug(
            f"Loaded {len(self._matchers)} matcher functions for {self.root_path}"
        )
