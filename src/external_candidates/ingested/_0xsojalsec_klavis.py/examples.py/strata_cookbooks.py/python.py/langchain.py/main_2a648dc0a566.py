# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\examples\strata-cookbooks\python\langchain\main.py
import asyncio
import os
import webbrowser
    ...
    result = await agent.ainvoke(
        {
            "messages": [
                {
                    "role": "user",
                    "content": f"summarize this video - https://youtu.be/yebNIHKAC4A?si=1Rz_ZsiVRz0YfOR7 and send the summary to my email {my_email}",
                }
            ],
        }
    )
