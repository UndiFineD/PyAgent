# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\examples\strata-cookbooks\python\llamaindex\main.py
import asyncio
import os
import webbrowser
...
async def main():
    ...
    tools = await aget_tools_from_mcp_url(
        response.strata_server_url, client=BasicMCPClient(response.strata_server_url)
    )
