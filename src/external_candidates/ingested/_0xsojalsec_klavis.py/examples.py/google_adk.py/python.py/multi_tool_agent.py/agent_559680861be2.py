# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\examples\google_adk\python\multi_tool_agent\agent.py
"""
...
if gmail_mcp_server.oauth_url:
    ...
    try:
        ...
        logger.warning(
            "⚠️ Could not open browser automatically. Please visit: %s",
            gmail_mcp_server.oauth_url,
        )
else:
