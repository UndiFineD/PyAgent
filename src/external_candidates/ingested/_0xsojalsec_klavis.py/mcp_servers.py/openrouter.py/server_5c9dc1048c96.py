# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\openrouter\server.py
import base64
import contextlib
import json
import logging
...
@click.command()
@click.option(
    "--port", default=OPENROUTER_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
        ...
        return [
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(
                    **{"category": "OPENROUTER_CHAT_COMPLETION"}
                ),
            ),
            types.Tool(
