    ...
    if "sectionBreak" in element or "tableOfContents" in element:
        ...
        table = [
            [
                "".join(
                    [
                        convert_structural_element(
                            element=cell_element, wrap_paragraphs=False
                        )
...
def get_paragraph_style_tags(
    style: dict, wrap_paragraphs: bool = True
) -> tuple[str, str]:
...
def convert_structural_element(element: dict) -> str:
    if "sectionBreak" in element or "tableOfContents" in element:
        ...
        md = ""
        prepend = get_paragraph_style_prepend_str(
