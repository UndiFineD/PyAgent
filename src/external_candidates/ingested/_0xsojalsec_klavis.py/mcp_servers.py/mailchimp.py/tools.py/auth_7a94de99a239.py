# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\mailchimp\tools\auth.py
import logging
...
async def get_account_info() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": "Failed to retrieve account information", "exception": str(e)}
