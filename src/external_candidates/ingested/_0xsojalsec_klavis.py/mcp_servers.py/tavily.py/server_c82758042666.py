# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\tavily\server.py
import base64
import contextlib
import json
import logging
...
@click.command()
@click.option(
    "--port", default=TAVILY_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "days": {
                            "type": "integer",
                            "description": "Look-back window in days for freshness.",
                            "default": 3,
                        },
                        "time_range": {
                            "type": "string",
                        ...
                        "start_date": {
                            "type": "string",
                            "description": "Filter results after YYYY-MM-DD.",
                        },
                        "end_date": {
                            "type": "string",
                            "description": "Filter results before YYYY-MM-DD.",
                        },
                        "max_results": {
                            "type": "integer",
                            "minimum": 5,
                        ...
                        "country": {
                            "type": "string",
                            "description": "Country code to bias results (e.g., 'us').",
                        },
                        "include_favicon": {
                            "type": "boolean",
                            "description": "Include site favicon URLs.",
                            "default": False,
                        },
                ...
                annotations=types.ToolAnnotations(**{"category": "TAVILY_WEB_SEARCH"}),
            ),
            types.Tool(
                name="tavily_extract",
                description=(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "urls": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "List of absolute URLs.",
                        },
                        "extract_depth": {
                            "type": "string",
                            "enum": ["basic", "advanced"],
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "url": {
                            "type": "string",
                            "description": "Root absolute URL to crawl.",
                        },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "url": {
                            "type": "string",
                            "description": "Root absolute URL to map.",
                        },
                        "max_depth": {"type": "integer", "minimum": 1, "default": 1},
                        "max_breadth": {"type": "integer", "minimum": 1, "default": 20},
                        "limit": {"type": "integer", "minimum": 1, "default": 50},
