    ...
    **kwargs,
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "POST", "/tickets", data=ticket_data, options=options
        )
        return response
...
async def update_ticket(
    ...
    **kwargs,
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "PUT", f"/tickets/{ticket_id}", data=update_data, options=options
        )
        return response
...
async def list_tickets(
    ...
    **filters,
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "GET", "/tickets", options={"query_params": params}
        )
...
async def add_note_to_ticket(
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "POST", f"/tickets/{ticket_id}/notes", data=note_data, options=options
        )
        return response
...
async def reply_to_a_ticket(
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "POST", f"/tickets/{ticket_id}/reply", data=data, options=options
        )
        return response
...
async def update_note(
    note_id: int, body: str, attachments: Optional[List[Dict[str, Any]]] = None
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "PUT", f"/conversations/{note_id}", data=note_data, options=options
        )
        return response
...
async def filter_tickets(
    ...
    try:
        ...
        response = await make_freshdesk_request(
            "GET", "/search/tickets", options={"query_params": params}
        )
