    ...
    **kwargs,
    ...
    try:
        ...
        response = await make_freshdesk_request(
            method="POST", endpoint="/collaboration/threads", data=thread_data
        )
...
async def get_thread_by_id(thread_id: int) -> Dict[str, Any]:
    ...
    try:
        ...
        response = await make_freshdesk_request(
            method="GET", endpoint=f"/collaboration/threads/{thread_id}"
        )
...
async def delete_thread(thread_id: int) -> Dict[str, Any]:
    ...
    try:
        ...
        response = await make_freshdesk_request(
            method="DELETE", endpoint=f"/collaboration/threads/{thread_id}"
        )
...
async def create_thread_message(
    ...
    **kwargs,
    ...
    try:
        ...
        logger.info(
            f"Creating message for thread {thread_id} with data: {message_data}"
        )

        response = await make_freshdesk_request(
            method="POST", endpoint="/collaboration/messages", data=message_data
        )
...
async def get_thread_message_by_id(message_id: int) -> Dict[str, Any]:
    ...
    try:
        ...
        response = await make_freshdesk_request(
            method="GET", endpoint=f"/collaboration/messages/{message_id}"
        )
...
async def delete_thread_message(message_id: int) -> Dict[str, Any]:
    ...
    try:
        ...
        response = await make_freshdesk_request(
            method="DELETE", endpoint=f"/collaboration/messages/{message_id}"
        )
