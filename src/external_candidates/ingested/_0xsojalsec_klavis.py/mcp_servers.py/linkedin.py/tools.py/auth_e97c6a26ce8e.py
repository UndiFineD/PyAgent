# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\linkedin\tools\auth.py
import logging
...
async def get_profile_info(person_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        if person_id:
            ...
            return {
                "error": "Getting other users' profile information requires elevated LinkedIn API permissions"
            }
        else:
