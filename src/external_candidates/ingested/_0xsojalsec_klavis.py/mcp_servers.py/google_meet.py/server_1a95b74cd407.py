# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\google_meet\server.py
import contextlib
import json
import logging
import os
...
@click.command()
@click.option(
    "--port", default=GOOGLE_MEET_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "start_time": {
                            "type": "string",
                            "description": "ISO RFC3339 datetime",
                        },
                        "end_time": {
                            "type": "string",
                            "description": "ISO RFC3339 datetime",
                        ...
                        "notify_attendees": {
                            "type": "boolean",
                            "description": "Send calendar invitations to attendees (default true)",
                            "default": True,
                        },
                    },
                },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "start_after": {
                            "type": "string",
                            "description": "Only meetings starting after this RFC3339 UTC time",
                        },
                        "end_before": {
                            "type": "string",
                            "description": "Only meetings starting before this RFC3339 UTC time",
                        },
                    },
                },
            ),
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "max_results": {
                            "type": "integer",
                            "description": "Maximum number of past meetings to return (1-100)",
                            "default": 10,
                        },
                        "since": {
                            "type": "string",
                            "description": "Only include meetings starting after this RFC3339 UTC time",
                        },
                    },
                },
            ),
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "event_id": {
                            "type": "string",
                            "description": "The calendar event ID of the meeting",
                        },
                    },
                },
            ),
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "start_time": {
                            "type": "string",
                            "description": "New start time (ISO RFC3339)",
                        },
                        "end_time": {
                            "type": "string",
                            "description": "New end time (ISO RFC3339)",
                        },
                        "attendees": {
                            "type": "array",
                            "items": {"type": "string"},
                        ...
                        "notify_attendees": {
                            "type": "boolean",
                            "description": "Send updated invitations / notifications (default true)",
                            "default": True,
                        },
                    },
                },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "event_id": {
                            "type": "string",
                            "description": "The calendar event ID of the meeting to delete",
                        },
                    },
                },
            ),
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "event_id": {
                            "type": "string",
                            "description": "The calendar event ID of the past meeting",
                        },
                    },
                },
            ),
                ...
                types.Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "space_id": {
                                "type": "string",
                                "description": "Space ID or spaces/<id>",
                            }
                        },
                    },
                ),
    ...
    async def call_tool(name: str, arguments: dict) -> list[types.TextContent]:
        if name == "google_meet_create_meet":
            ...
            result = await create_meet(
                summary, start_time, end_time, attendees, description, notify_attendees
            )
            ...
            if not event_id:
                return [
                    types.TextContent(
                        type="text",
                        text=json.dumps(failure("event_id parameter is required")),
                    )
                ]
        ...
        # ----------------Meet API v2 tools-----------------
            ...
            if not space_id:
                return [
                    types.TextContent(
                        type="text",
                        text=json.dumps(failure("space_id parameter is required")),
                    )
                ]
            try:
