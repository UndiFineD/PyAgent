...
async def get_channel_history(
    channel_id: str, limit: Optional[int] = None
) -> Dict[str, Any]:
    ...
    try:
        return await make_slack_user_request(
...
async def invite_users_to_channel(
    channel_id: str, user_ids: list[str]
) -> Dict[str, Any]:
    ...
    """
    logger.info(
        f"Executing tool: slack_invite_users_to_channel for channel {channel_id}"
    )
