# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\slack\user_tools\base.py
import logging
...
class SlackUserClient:
    ...
    async def make_request(
        ...
        if not api_token:
            raise RuntimeError(
                "No user API token provided. Please set the authentication header."
            )
