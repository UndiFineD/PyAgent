# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\slack\bot_tools\base.py
import logging
...
class SlackBotClient:
    ...
    async def make_request(
        ...
        if not api_token:
            raise RuntimeError(
                "No bot API token provided. Please set the authentication header."
            )
