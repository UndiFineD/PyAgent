# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\linear\tools\issues.py
import logging
...
async def get_issues(
    ...
    logger.info(
        f"Executing tool: get_issues with team_id: {team_id}, limit: {limit}, filter: {filter}"
    )
    try:
...
async def search_issues(
    query_text: str, team_id: str = None, limit: int = 20
) -> Dict[str, Any]:
