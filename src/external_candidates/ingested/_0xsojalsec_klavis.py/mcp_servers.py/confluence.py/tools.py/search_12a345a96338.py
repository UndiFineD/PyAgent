# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\confluence\tools\search.py
...
async def search_content(
    ...
    limit: Annotated[
        int, "Maximum number of results to return (1-100). Defaults to 25"
    ] = 25,
    ...
    response = await client.get(
        "search", params={"cql": cql, "limit": max(1, min(limit, 100))}
    )
