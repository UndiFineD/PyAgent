# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\confluence\tools\page.py
...
async def create_page(
    space_identifier: Annotated[
        str, "The ID or title of the space to create the page in"
    ],
...
async def update_page_content(
    page_identifier: Annotated[
        str,
        "The ID or title of the page to update. Numerical titles are NOT supported.",
    ],
    content: Annotated[str, "The content of the page. Only plain text is supported"],
    ...
    if not page.get("page"):
        raise ToolExecutionError(
            message=f"No page found with identifier: '{page_identifier}'"
        )
...
async def rename_page(
    page_identifier: Annotated[
        str,
        "The ID or title of the page to rename. Numerical titles are NOT supported.",
    ],
    title: Annotated[str, "The title of the page"],
) -> Annotated[dict, "The page"]:
...
async def get_pages_by_id(
    ...
    pages = await client.get(
        "pages",
        params={"id": page_ids, "body-format": BodyFormat.STORAGE.to_api_value()},
    )
...
async def list_pages(
    ...
    limit: Annotated[
        int, "The maximum number of pages to return. Defaults to 25. Max is 250"
    ] = 25,
