# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\confluence\errors.py
...
class TokenExpiredError(AuthenticationError):
    def __init__(
        self, message: str = "OAuth token has expired", developer_message: str = ""
    ):
        super().__init__(message, developer_message)
...
class InvalidTokenError(AuthenticationError):
    def __init__(
        self, message: str = "OAuth token is invalid", developer_message: str = ""
    ):
        super().__init__(message, developer_message)
