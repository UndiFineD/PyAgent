# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\spotify\tools\playlists.py
...
def get_playlist_by_id(
    playlist_id: str, sp: Spotify = None, market: str = None
) -> dict:
    """
...
def get_user_owned_playlists(
    user_id: str, sp: Spotify = None, limit: int = 20, offset: int = 0
) -> list:
    """
    ...
    try:
        ...
        playlists = sp.user_playlists(user=user_id, limit=limit, offset=offset).get(
            "items", []
        )
...
def get_current_user_playlists(
    sp: Spotify = None, limit: int = 20, offset: int = 0
) -> List[Dict]:
    """
...
def remove_items_from_playlist(
    playlist_id: str, item_uris: List[str], sp: Spotify = None, snapshot_id: str = None
) -> Dict:
    """
    ...
    try:
        ...
        return sp.playlist_remove_all_occurrences_of_items(
            playlist_id=playlist_id, items=item_uris, snapshot_id=snapshot_id
        )
    except Exception as e:
