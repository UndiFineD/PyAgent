# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\quickbooks\session_manager.py
"""
...
class QuickBooksSession:
    ...
    def __init__(
        self, access_token: str = None, realm_id: str = None, environment: str = None
    ):
        self.client = QuickBooksHTTPClient(
            access_token=access_token, company_id=realm_id, environment=environment
        )
...
class SessionManager:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning(
                "No default QuickBooks session available. Clients must provide credentials."
            )
