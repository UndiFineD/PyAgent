# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\quickbooks\tools\vendors.py
...
vendor_properties_user_define = {
    **vendor_properties_minimal,
    ...
    "WebAddr": {"type": "string", "description": "Website address."},
    "BusinessNumber": {
        "type": "string",
    ...
    "CostRate": {"type": "number", "description": "Pay rate of the vendor"},
    "BillRate": {
        "type": "number",
...
vendor_properties = {
    **vendor_properties_user_define,
    "Id": {"type": "string", "description": "The unique QuickBooks vendor ID"},
}
...
list_vendors_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "ActiveOnly": {
                "type": "boolean",
                "description": "Return only active vendors",
                "default": True,
            },
            "MaxResults": {
                "type": "integer",
...
search_vendors_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "DisplayName": {
                "type": "string",
                "description": "Search by vendor display name (partial match)",
            },
            "CompanyName": {
                "type": "string",
            ...
            "Vendor1099": {
                "type": "boolean",
                "description": "Filter by 1099 vendor status",
            },
            "GSTIN": {"type": "string", "description": "Search by GSTIN"},
            "BusinessNumber": {
                "type": "string",
                "description": "Search by business number",
            },
            "AcctNum": {"type": "string", "description": "Search by account number"},
            "GSTRegistrationType": {
                "type": "string",
                "description": "Filter by GST registration type",
            },
            "MaxResults": {
                "type": "integer",
                "description": "Maximum number of results to return",
...
activate_vendor_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "Id": {
                "type": "string",
                "description": "The QuickBooks vendor ID to activate",
            }
        },
        "required": ["Id"],
    },
...
deactivate_vendor_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "Id": {
                "type": "string",
                "description": "The QuickBooks vendor ID to deactivate",
            }
        },
        "required": ["Id"],
    },
...
def mcp_object_to_vendor_data(**kwargs) -> Dict[str, Any]:
    ...
    if "PrimaryEmailAddr" in kwargs:
        vendor_data["PrimaryEmailAddr"] = {"Address": kwargs["PrimaryEmailAddr"]}
...
def vendor_data_to_mcp_object(vendor_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Email address
    if "PrimaryEmailAddr" in vendor_data and isinstance(
        vendor_data["PrimaryEmailAddr"], dict
    ):
    ...
    # Vendor Payment Bank Detail
    if "VendorPaymentBankDetail" in vendor_data and isinstance(
        vendor_data["VendorPaymentBankDetail"], dict
    ):
...
class VendorManager:
    ...
    async def list_vendors(
        self, ActiveOnly: bool = True, MaxResults: int = 100
    ) -> List[Dict[str, Any]]:
    ...
    async def search_vendors(self, **kwargs) -> List[Dict[str, Any]]:
        ...
        for param, field in name_filters.items():
            if kwargs.get(param):
                value = kwargs[param].replace("'", "''")  # Escape single quotes
...
tools = [
    ...
    search_vendors_tool,
    update_vendor_tool,
    activate_vendor_tool,
    deactivate_vendor_tool,
]
