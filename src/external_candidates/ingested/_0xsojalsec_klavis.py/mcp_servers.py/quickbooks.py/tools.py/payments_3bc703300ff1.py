# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\quickbooks\tools\payments.py
...
payment_properties = {
    **payment_properties_user_define,
    "Id": {"type": "string", "description": "The unique QuickBooks payment ID"},
}
...
search_payments_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "PaymentRefNum": {
                "type": "string",
                "description": "Search by payment reference number",
            },
            # Date filters
            "TransactionDateFrom": {
                "type": "string",
                "description": "Search payments from this transaction date (YYYY-MM-DD format)",
            },
            "TransactionDateTo": {
                "type": "string",
                "description": "Search payments to this transaction date (YYYY-MM-DD format)",
            },
            # Amount filters
            ...
            "MinUnappliedAmt": {
                "type": "number",
                "description": "Minimum unapplied amount",
            },
            "MaxUnappliedAmt": {
                "type": "number",
                "description": "Maximum unapplied amount",
            },
            # Reference filters
            "PaymentMethodRefValue": {
                "type": "string",
                "description": "Search by payment method ID",
            },
            "DepositToAccountRefValue": {
                "type": "string",
                "description": "Search by deposit account ID",
            },
            # Pagination
            "MaxResults": {
                "type": "integer",
...
delete_payment_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "Id": {
                "type": "string",
                "description": "The QuickBooks payment ID to delete",
            }
        },
        "required": ["Id"],
    },
...
void_payment_tool = Tool(
    ...
    inputSchema={
        "type": "object",
        "properties": {
            "Id": {"type": "string", "description": "The QuickBooks payment ID to void"}
        },
        "required": ["Id"],
    },
    annotations=types.ToolAnnotations(**{"category": "QUICKBOOKS_PAYMENT"}),
...
def payment_data_to_mcp_object(payment_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for field in ["Id", "TotalAmt", "PaymentRefNum", "ExchangeRate", "UnappliedAmt"]:
            ...
            if "CreditChargeResponse" in cc_payment:
                ...
                if isinstance(charge_response, dict):
                    ...
                    if "TxnAuthorizationTime" in charge_response:
                        ...
                        if (
                            isinstance(txn_auth_time, dict)
                            and "dateTime" in txn_auth_time
                        ):
                            mcp_object[
                                "CreditCardPaymentTransactionAuthorizationTime"
                            ] = txn_auth_time["dateTime"]
...
class PaymentManager:
    ...
    async def delete_payment(self, Id: str) -> Dict[str, Any]:
        ...
        return await self.client._post(
            "payment", delete_data, params={"operation": "delete"}
        )
    ...
    async def void_payment(self, Id: str) -> Dict[str, Any]:
        ...
        response = await self.client._post(
            "payment", void_data, params={"operation": "void"}
        )
