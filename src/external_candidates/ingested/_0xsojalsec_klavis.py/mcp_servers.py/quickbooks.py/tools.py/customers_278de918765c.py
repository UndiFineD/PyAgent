...
class CustomerManager:
    ...
    async def list_customers(
        self, MaxResults: int = 100, ActiveOnly: bool = True
    ) -> List[Dict[str, Any]]:
            ...
            for customer in customers:
                ...
                for field, search_value in partial_match_filters.items():
                    if field in [
                        ...
                        if (
                            field in customer
                            and search_value not in customer[field].lower()
                        ):
                        ...
                        field == "BillAddrLine1"
                        and "BillAddr" in customer
                        and isinstance(customer["BillAddr"], dict)
                    ):
                        ...
                        and isinstance(customer["ShipAddr"], dict)
                    ):
                        ...
                        method_name = (
                            customer["PaymentMethodRef"].get("name", "").lower()
                        )
