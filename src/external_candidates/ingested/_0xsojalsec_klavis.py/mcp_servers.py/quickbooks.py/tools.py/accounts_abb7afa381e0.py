# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\quickbooks\tools\accounts.py
...
account_properties = {
    **account_properties_user_define,
    "Id": {"type": "string", "description": "The unique QuickBooks account ID"},
}
...
list_accounts_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "AccountType": {
                "type": "string",
                "description": "Filter by account type: Asset, Liability, Income, Expense, Equity",
            },
            "ActiveOnly": {
                "type": "boolean",
...
search_accounts_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "Name": {
                "type": "string",
                "description": "Search by account name (partial match)",
            },
            "AccountType": {
                "type": "string",
                "description": "Filter by account type: Bank, Other Current Asset, Fixed Asset, Other Asset, Accounts Receivable, Equity, Expense, Other Expense, Cost of Goods Sold, Accounts Payable, Credit Card, Long Term Liability, Other Current Liability, Income, Other Income",
            },
            "Classification": {
                "type": "string",
                "description": "Filter by classification: Asset, Liability, Income, Expense, Equity",
            },
            "Active": {"type": "boolean", "description": "Filter by active status"},
            "FullyQualifiedName": {
                "type": "string",
                "description": "Search by fully qualified name (partial match)",
            },
            "Description": {
                "type": "string",
            ...
            "CreateTimeFrom": {
                "type": "string",
                "description": "Search accounts created from this date (YYYY-MM-DD format)",
            },
            "CreateTimeTo": {
                "type": "string",
                "description": "Search accounts created to this date (YYYY-MM-DD format)",
            },
            "LastUpdatedTimeFrom": {
                "type": "string",
                "description": "Search accounts last updated from this date (YYYY-MM-DD format)",
            },
            "LastUpdatedTimeTo": {
                "type": "string",
                "description": "Search accounts last updated to this date (YYYY-MM-DD format)",
            },
            # Pagination
            "MaxResults": {
                "type": "integer",
...
class AccountManager:
    ...
    async def list_accounts(
        self, MaxResults: int = 100, AccountType: str = None, ActiveOnly: bool = True
    ) -> List[Dict[str, Any]]:
    ...
    async def update_account(self, **kwargs) -> Dict[str, Any]:
        ...
        sync_token = current_account_response.get("Account", {}).get("SyncToken", "0")
    ...
    async def search_accounts(self, **kwargs) -> List[Dict[str, Any]]:
        ...
        if kwargs.get("FullyQualifiedName"):
            partial_match_filters["FullyQualifiedName"] = kwargs[
                "FullyQualifiedName"
            ].lower()
            ...
            for account in accounts:
                ...
                for field, search_value in partial_match_filters.items():
                    if field == "Name" and "Name" in account:
                        ...
                        and "FullyQualifiedName" in account
                    ):
                        ...
                        and "CurrencyRef" in account
                        and isinstance(account["CurrencyRef"], dict)
                    ):
