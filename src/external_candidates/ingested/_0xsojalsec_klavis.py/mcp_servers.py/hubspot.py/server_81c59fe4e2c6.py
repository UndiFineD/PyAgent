...
@click.command()
@click.option(
    "--port", default=HUBSPOT_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
        ...
        # Companies
            ...
            try:
                result = await hubspot_update_company_by_id(
                    company_id=company_id, updates=updates
                )
                return [
                    types.TextContent(
                        type="text",
        ...
        # Deals
            ...
            try:
                result = await hubspot_update_deal_by_id(
                    deal_id=deal_id, updates=updates
                )
                return [
                    types.TextContent(
                        type="text",
        ...
        # Tickets
            ...
            try:
                result = await hubspot_update_ticket_by_id(
                    ticket_id=ticket_id, updates=updates
                )
                return [
                    types.TextContent(
                        type="text",
