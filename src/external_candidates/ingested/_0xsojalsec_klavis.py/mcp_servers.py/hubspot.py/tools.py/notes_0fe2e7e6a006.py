# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\hubspot\tools\notes.py
import json
import logging
...
async def hubspot_create_note(
    ...
    try:
        ...
        note_input = SimplePublicObjectInputForCreate(
            properties=properties, associations=associations if associations else None
        )
