# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\hubspot\tools\base.py
import logging
import os
...
def get_auth_token() -> str:
    ...
    try:
        ...
        if not token:
            raise RuntimeError(
                "Authentication token not found in request context or environment"
            )
        return token
