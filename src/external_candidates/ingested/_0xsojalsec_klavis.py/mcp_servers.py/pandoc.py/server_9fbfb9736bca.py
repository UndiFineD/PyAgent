# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\pandoc\server.py
import contextlib
import datetime
import logging
import os
...
@click.command()
@click.option(
    "--port", default=PANDOC_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
