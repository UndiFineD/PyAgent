# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\moneybird\tools\financial.py
import logging
...
async def moneybird_list_financial_accounts(administration_id: str) -> Dict[str, Any]:
