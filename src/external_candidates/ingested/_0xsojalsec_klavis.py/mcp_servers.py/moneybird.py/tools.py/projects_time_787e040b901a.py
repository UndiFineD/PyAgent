# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\moneybird\tools\projects_time.py
import logging
...
async def moneybird_list_projects(
    administration_id: str, state: Optional[str] = None, page: Optional[int] = None
) -> Dict[str, Any]:
...
async def moneybird_list_time_entries(
    ...
    try:
        return await make_request(
            "GET", administration_id, "/time_entries", params=params
        )
    except Exception as e:
