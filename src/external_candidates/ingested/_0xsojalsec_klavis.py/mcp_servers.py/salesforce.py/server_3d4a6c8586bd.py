# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\salesforce\server.py
import base64
import contextlib
import json
import logging
...
from tools import (  # Accounts; Contacts; Opportunities; Leads; Cases; Campaigns; Metadata & Queries
...
@click.command()
@click.option(
    "--port", default=SALESFORCE_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "name_contains": {
                            "type": "string",
                            "description": "Filter accounts by name containing this text (case-insensitive)",
                        },
                        "industry": {
                            "type": "string",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "account_data": {
                            "type": "object",
                            "description": "Account data including Name (required) and other fields",
                        }
                    },
                },
                annotations=types.ToolAnnotations(**{"category": "SALESFORCE_ACCOUNT"}),
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "name_contains": {
                            "type": "string",
                            "description": "Filter contacts by first or last name containing this text (case-insensitive)",
                        },
                        "email_contains": {
                            "type": "string",
                            "description": "Filter contacts by email containing this text (case-insensitive)",
                        },
                        "title_contains": {
                            "type": "string",
                            "description": "Filter contacts by title containing this text (case-insensitive)",
                        },
                    },
                },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "contact_data": {
                            "type": "object",
                            "description": "Contact data including LastName (required) and other fields",
                        }
                    },
                },
                annotations=types.ToolAnnotations(**{"category": "SALESFORCE_CONTACT"}),
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "name_contains": {
                            "type": "string",
                            "description": "Filter opportunities by name containing this text",
                        },
                        "account_name_contains": {
                            "type": "string",
                            "description": "Filter opportunities by account name containing this text",
                        },
                        "limit": {
                            "type": "integer",
                ...
                annotations=types.ToolAnnotations(
                    **{"category": "SALESFORCE_OPPORTUNITY"}
                ),
            ),
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "opportunity_data": {
                            "type": "object",
                            "description": "Opportunity data including Name, StageName, and CloseDate (required)",
                        }
                    },
                },
                annotations=types.ToolAnnotations(
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "stage": {
                            "type": "string",
                            "description": "The stage the opportunity is in",
                        },
                        "amount": {
                            "type": "number",
                        ...
                        "next_step": {
                            "type": "string",
                            "description": "The next step for the opportunity",
                        },
                        "description": {
                            "type": "string",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "name_contains": {
                            "type": "string",
                            "description": "Filter leads by first or last name containing this text (case-insensitive)",
                        },
                        "company_contains": {
                            "type": "string",
                            "description": "Filter leads by company name containing this text (case-insensitive)",
                        },
                        "email_contains": {
                            "type": "string",
                            "description": "Filter leads by email containing this text (case-insensitive)",
                        },
                        "industry": {
                            "type": "string",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "lead_data": {
                            "type": "object",
                            "description": "Lead data including LastName and Company (required)",
                        }
                    },
                },
                annotations=types.ToolAnnotations(**{"category": "SALESFORCE_LEAD"}),
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "limit": {
                            "type": "integer",
                            "description": "Maximum number of cases to return (default: 50)",
                            "default": 50,
                        },
                        "fields": {
                            "type": "array",
                        ...
                        "subject_contains": {
                            "type": "string",
                            "description": "Filter cases by subject containing this text (case-insensitive)",
                        },
                        "case_type": {
                            "type": "string",
                            "description": "Filter cases by type",
                        },
                    },
                },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "case_data": {
                            "type": "object",
                            "description": "Case data including Subject (required)",
                        }
                    },
                },
                annotations=types.ToolAnnotations(**{"category": "SALESFORCE_CASE"}),
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "campaign_data": {
                            "type": "object",
                            "description": "Campaign data including Name (required)",
                        }
                    },
                },
                annotations=types.ToolAnnotations(
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "detailed": {
                            "type": "boolean",
                            "description": "Whether to return additional metadata for custom objects",
                            "default": False,
                        },
                    },
                },
                annotations=types.ToolAnnotations(
                    **{"category": "SALESFORCE_METADATA"}
                ),
            ),
        ]
        ...
        try:
            ...
            if name == "salesforce_get_accounts":
                ...
                result = await update_account(
                    arguments["account_id"], arguments["account_data"]
                )
            ...
            # Contact tools
                ...
                result = await update_contact(
                    arguments["contact_id"], arguments["contact_data"]
                )
            ...
            # Lead tools
                ...
                result = await convert_lead(
                    arguments["lead_id"], arguments.get("conversion_data")
                )
            ...
            # Campaign tools
                ...
                result = await update_campaign(
                    arguments["campaign_id"], arguments["campaign_data"]
                )
            ...
            # Query and metadata tools
                ...
                result = await describe_object(
                    arguments["object_name"], arguments.get("detailed", False)
                )
