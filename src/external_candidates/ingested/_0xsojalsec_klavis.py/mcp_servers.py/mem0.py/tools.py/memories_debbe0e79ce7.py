# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\mem0\tools\memories.py
import logging
...
async def get_all_memories(
    user_id: str = None, page: int = 1, page_size: int = 50
) -> Dict[str, Any]:
...
async def search_memories(
    query: str, user_id: str = None, limit: int = 20
) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            f"Found {len(formatted_memories)} matching memories for user {user_id}"
        )
        return {
            "success": True,
            "memories": formatted_memories,
...
async def update_memory(
    memory_id: str, data: str, user_id: str = None
) -> Dict[str, Any]:
...
async def delete_memory(
    memory_id: str = None, user_id: str = None, delete_all: bool = False
) -> Dict[str, Any]:
