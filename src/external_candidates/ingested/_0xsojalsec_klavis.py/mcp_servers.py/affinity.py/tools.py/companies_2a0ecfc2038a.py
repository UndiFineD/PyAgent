...
async def get_company_lists(
    ...
    try:
        ...
        return await make_v2_request(
            "GET", f"/companies/{company_id}/lists", params=params
        )
    except Exception as e:
...
async def get_company_list_entries(
    ...
    """
    logger.info(
        f"Executing tool: get_company_list_entries with company_id: {company_id}"
    )
    try:
        params = {}
        if cursor:
        ...
        return await make_v2_request(
            "GET", f"/companies/{company_id}/list-entries", params=params
        )
    except Exception as e:
