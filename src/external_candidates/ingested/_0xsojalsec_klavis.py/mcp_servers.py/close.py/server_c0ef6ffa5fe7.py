# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\server.py
import base64
import contextlib
import json
import logging
...
@click.command()
@click.option(
    "--port", default=CLOSE_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLOSE_LEAD"}),
            ),
            types.Tool(
                name="close_get_lead",
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLOSE_CONTACT"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLOSE_OPPORTUNITY"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLOSE_TASK"}),
            ),
            types.Tool(
                name="close_get_task",
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLOSE_USER"}),
            ),
            types.Tool(
