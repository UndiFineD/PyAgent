# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\tools\tasks.py
import logging
...
async def search_tasks(
    query: str, limit: Optional[int] = None, task_type: Optional[str] = None, **kwargs
) -> ToolResponse:
