# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\asana\server.py
import base64
import contextlib
import json
import logging
...
@click.command()
@click.option(
    "--port", default=ASANA_MCP_SERVER_PORT, help="Port to listen on for HTTP"
)
@click.option(
    "--log-level",
    default="INFO",
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_TASK"}),
            ),
            types.Tool(
                name="asana_get_task",
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_PROJECT"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_WORKSPACE"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_USER"}),
            ),
            types.Tool(
                name="asana_get_user",
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_TEAM"}),
            ),
            types.Tool(
                name="asana_get_team",
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "ASANA_TAG"}),
            ),
            types.Tool(
                name="asana_get_tag",
    ...
    async def call_tool(
        ...
        try:
            if name == "asana_create_task":
                ...
                arguments["sort_order"] = sort_order_map.get(
                ...
                result = await team_tools.list_teams_the_current_user_is_a_member_of(
                    **arguments
                )
