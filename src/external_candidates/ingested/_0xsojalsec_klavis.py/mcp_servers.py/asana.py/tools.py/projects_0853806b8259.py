# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\asana\tools\projects.py
import logging
...
async def list_projects(
    ...
    try:
        ...
        return {
            ...
            "count": len(projects),
            "next_page": (
                get_next_page(response) if not filter else None
            ),  # Pagination is complex with filtering
        }
