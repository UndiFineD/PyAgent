# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\clickup\tools\tasks.py
import logging
...
async def create_task(
    ...
    try:
        ...
        result = await make_clickup_request(
            f"list/{list_id}/task", "POST", data, params
        )
        return result
    except Exception as e:
...
async def search_tasks(
    team_id: str, query: str, start: int = 0, limit: int = 20
) -> Dict[str, Any]:
