# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\clickup\tools\comments.py
import logging
...
async def get_comments(
    task_id: str, custom_task_ids: bool = False, team_id: Optional[str] = None
) -> Dict[str, Any]:
...
async def create_comment(
    ...
    try:
        ...
        result = await make_clickup_request(
            f"task/{task_id}/comment", "POST", data, params
        )
        return result
    except Exception as e:
