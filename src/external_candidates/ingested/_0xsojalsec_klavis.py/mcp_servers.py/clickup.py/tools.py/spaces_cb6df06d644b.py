# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\clickup\tools\spaces.py
import logging
...
async def create_space(
    team_id: str, name: str, color: Optional[str] = None, private: bool = False
) -> Dict[str, Any]:
