# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\mixpanel\tools\base.py
import base64
import json
import logging
import os
...
MIXPANEL_EXPORT_ENDPOINT = (
    "https://data.mixpanel.com/api/2.0/export"  # Raw Data Export API
)
MIXPANEL_QUERY_ENDPOINT = "https://mixpanel.com/api"  # Query API
MIXPANEL_APP_ENDPOINT = (
    "https://mixpanel.com/api/app"  # App Management APIs (projects, GDPR, etc.)
)
    ...
    async def make_request(
        ...
        if "application/json" in content_type:
            ...
            try:
                ...
                return {
                    "success": True,
                    "message": response.text or "Import successful",
                }
