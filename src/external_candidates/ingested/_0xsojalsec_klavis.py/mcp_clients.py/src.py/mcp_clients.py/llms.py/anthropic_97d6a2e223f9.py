...
class Anthropic(BaseLLM):
    ...
    def __init__(self, model: Optional[str] = None):
        ...
        self._extracted_system_message = (
            ""  # Store system messages extracted from chat history
        )
    ...
    async def create_streaming_generator(
        ...
        if self._extracted_system_message:
            ...
            hasattr(Anthropic, "_last_extracted_system_message")
            and Anthropic._last_extracted_system_message
        ):
