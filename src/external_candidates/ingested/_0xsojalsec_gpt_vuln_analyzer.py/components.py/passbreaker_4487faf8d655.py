# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\components\passbreaker.py
import argparse
import hashlib
import itertools
...
def main():
    ...
    parser.add_argument(
        "-c", "--complexity", action="store_true", help="Check for password complexity"
    )
    parser.add_argument(
        "-b", "--brute-force", action="store_true", help="Perform a brute force attack"
    )
    parser.add_argument(
        "--min-length",
        type=int,
