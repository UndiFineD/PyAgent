...
def parse_arguments():
    ...
    parser.add_argument(
        "--profile", type=int, default=1, help="Enter Profile of scan 1-13 (Default: 1)"
    )
    parser.add_argument(
        "--attack", type=str, help="Attack type: nmap, dns, sub, jwt, pcap, passcracker"
    )
    parser.add_argument(
        "--sub_list",
        type=str,
    ...
    parser.add_argument(
        "--rich_menu", type=str, help="Shows a clean help menu using rich"
    )
    parser.add_argument(
        "--menu", action="store_true", default=False, help="Terminal Interactive Menu"
    )
    parser.add_argument(
        "--ai",
        type=str,
    ...
    parser.add_argument(
        "--algorithm", choices=hashlib.algorithms_guaranteed, help="Hash algorithm"
    )
    ...
    parser.add_argument(
        "--complexity", action="store_true", help="Check for password complexity"
    )
    parser.add_argument(
        "--brute_force", action="store_true", help="Perform a brute force attack"
    )
    parser.add_argument(
        "--min_length",
        type=int,
...
def handle_attack(attack_type, target, ai, api_keys, additional_params=None):
    ...
    if attack_type == "geo":
        ...
        if brute_force:
            Cracker.crack_passwords_with_brute_force(
