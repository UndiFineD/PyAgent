# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-introtodeeplearning\setup.py
...
tf_ver = "2.0.0a"
if (
    get_dist("tensorflow>=" + tf_ver) is None
    and get_dist("tensorflow_gpu>=" + tf_ver) is None
):
