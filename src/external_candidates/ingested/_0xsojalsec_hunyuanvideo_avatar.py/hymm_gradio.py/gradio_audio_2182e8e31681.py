# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_gradio\gradio_audio.py
import datetime
import glob
import json
import os
...
if __name__ == "__main__":
    ...
    demo = create_demo()
    demo.launch(
        server_name="0.0.0.0", server_port=8080, share=True, allowed_paths=allowed_paths
    )
