# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\modules\parallel_states.py
import datetime
import os
...
def parallel_attention(
    ...
    query, key, value = [
        x.view(x.shape[0] * x.shape[1], *x.shape[2:]) for x in [query, key, value]
    ]
