# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\data_kits\face_align\align.py
import os
import sys
...
class AlignImage(object):
    def __init__(self, device="cuda", det_path=""):
        self.facedet = DetFace(
            pt_path=det_path, confThreshold=0.5, nmsThreshold=0.45, device=device
        )
