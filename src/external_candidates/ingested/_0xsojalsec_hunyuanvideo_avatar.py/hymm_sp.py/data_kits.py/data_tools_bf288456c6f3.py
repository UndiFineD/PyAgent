# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\data_kits\data_tools.py
import os
...
def save_videos_grid(
    videos: torch.Tensor, path: str, rescale=False, n_rows=6, fps=8, quality=8
):
