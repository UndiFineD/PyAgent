# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\vae\unet_causal_3d_blocks.py
...
class ResnetBlockCausal3D(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if self.up:
            self.upsample = UpsampleCausal3D(
                in_channels, use_conv=False, disable_causal=disable_causal
            )
        elif self.down:
            self.downsample = DownsampleCausal3D(
                in_channels, use_conv=False, disable_causal=disable_causal, name="op"
            )
