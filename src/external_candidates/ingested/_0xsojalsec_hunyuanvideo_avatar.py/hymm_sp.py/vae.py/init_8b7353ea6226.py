# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\vae\__init__.py
...
def load_vae(
    ...
    if length == 3:
        ...
        raise ValueError(
            f"Invalid VAE model: {vae_type}. Must be 3D VAE in the format of '???-*'."
        )
