# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_sp\vae\vae.py
    ...
    def __init__(
        ...
        for i, up_block_type in enumerate(up_block_types):
            ...
            if time_compression_ratio == 4:
                ...
                add_spatial_upsample = bool(
                    i >= len(block_out_channels) - num_spatial_upsample_layers
                )
                add_time_upsample = bool(
                    i >= len(block_out_channels) - num_time_upsample_layers
                )
            else:
                raise ValueError(
                    f"Unsupported time_compression_ratio: {time_compression_ratio}"
