# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Kimi-Audio\finetune_codes\extract_semantic_codes.py
import argparse
import json
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name_or_path", type=str, default="moonshotai/Kimi-Audio-7B"
    )
