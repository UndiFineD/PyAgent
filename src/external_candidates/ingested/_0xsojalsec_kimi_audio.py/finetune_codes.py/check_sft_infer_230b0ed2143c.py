# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Kimi-Audio\finetune_codes\check_sft_infer.py
from kimia_infer.api.kimia import KimiAudio

model = KimiAudio(
    model_path="output/finetuned_hf_for_inference", load_detokenizer=False
)
