# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Preprocessing\Codec\encodec.py
import math
import random

import numpy as np
import torch.nn as nn
from Preprocessing.Codec.seanet import SEANetDecoder, SEANetEncoder
