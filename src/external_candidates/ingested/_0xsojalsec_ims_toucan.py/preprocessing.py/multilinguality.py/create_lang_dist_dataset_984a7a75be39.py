# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Preprocessing\multilinguality\create_lang_dist_dataset.py
import argparse
import os
import pickle
...
ISO_LOOKUP_PATH = hf_hub_download(
    cache_dir=MODEL_DIR, repo_id="Flux9665/ToucanTTS", filename="iso_lookup.json"
)
ISO_TO_FULLNAME_PATH = hf_hub_download(
    cache_dir=MODEL_DIR, repo_id="Flux9665/ToucanTTS", filename="iso_to_fullname.json"
)
LANG_PAIRS_MAP_PATH = hf_hub_download(
    cache_dir=MODEL_DIR,
    repo_id="Flux9665/ToucanTTS",
    filename="lang_1_to_lang_2_to_map_dist.json",
)
LANG_PAIRS_TREE_PATH = hf_hub_download(
    cache_dir=MODEL_DIR,
    repo_id="Flux9665/ToucanTTS",
    filename="lang_1_to_lang_2_to_tree_dist.json",
)
LANG_PAIRS_ASP_PATH = hf_hub_download(
    cache_dir=MODEL_DIR, repo_id="Flux9665/ToucanTTS", filename="asp_dict.pkl"
)
LANG_PAIRS_LEARNED_DIST_PATH = hf_hub_download(
    cache_dir=MODEL_DIR,
    repo_id="Flux9665/ToucanTTS",
    filename="lang_1_to_lang_2_to_learned_dist.json",
)
SUPVERVISED_LANGUAGES_PATH = hf_hub_download(
    cache_dir=MODEL_DIR,
    repo_id="Flux9665/ToucanTTS",
...
if __name__ == "__main__":
    default_model_path = hf_hub_download(
