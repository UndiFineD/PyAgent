# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Preprocessing\multilinguality\SimilaritySolver.py
import json
import pickle
import random
...
class SimilaritySolver:
    def __init__(
        ...
        iso_to_fullname_path = (
            ...
            if not iso_to_fullname_path
            else iso_to_fullname_path
        )
