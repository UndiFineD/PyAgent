# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\run_text_to_file_reader.py
import os
...
if __name__ == "__main__":
    ...
    merged_speaker_references = [
        "audios/speaker_references/" + ref
        for ref in os.listdir("audios/speaker_references/")
    ]
    ...
    all_test(
        ...
        speaker_reference=(
            merged_speaker_references if merged_speaker_references != [] else None
        ),
    )
