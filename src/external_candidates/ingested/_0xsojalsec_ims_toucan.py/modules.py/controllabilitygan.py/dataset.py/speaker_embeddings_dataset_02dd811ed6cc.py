# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\ControllabilityGAN\dataset\speaker_embeddings_dataset.py
import os
...
class SpeakerEmbeddingsDataset(torch.utils.data.Dataset):
    ...
    def _load_features(self, feature_path):
        ...
        if (
            feature_path / "utt2spk"
        ).exists():  # spk2idx contains utt_ids not speaker_ids
            utt2spk = {}
