# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\ToucanTTS\toucantts_train_loop.py
import os
import time
...
def train_loop(
    ...
    while True:
        ...
        for batch in tqdm(train_loader):
            ...
            regression_loss, stochastic_loss, duration_loss, pitch_loss, energy_loss = (
                net(
            ...
            if step_counter % steps_per_checkpoint == 0:
                ...
                if rank == 0:
                    ...
                    print(f"\nEpoch:                  {epoch}")
                    print(
                        f"Time elapsed:           {round((time.time() - start_time) / 60)} Minutes"
                    )
                    print(
                        ...
                        wandb.log(
                            {
                                ...
                                "duration_loss": round(
                                    sum(duration_losses_total)
                                    / len(duration_losses_total),
                                    5,
                                ),
                                "pitch_loss": round(
                                ...
                                "energy_loss": round(
                                    sum(energy_losses_total) / len(energy_losses_total),
                                    5,
                                ),
