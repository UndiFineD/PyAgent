# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\ToucanTTS\dit_wrapper.py
"""
...
class DitWrapper(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = ConvNeXtBlock(
            hidden_channels, out_channels, filter_channels, gin_channels
        )
        self.conv2 = ConvNeXtBlock(
            hidden_channels, out_channels, filter_channels, gin_channels
        )
        self.conv3 = ConvNeXtBlock(
            hidden_channels, out_channels, filter_channels, gin_channels
        )
...
class ConvNeXtBlock(nn.Module):
    def __init__(self, in_channels, out_channels, filter_channels, gin_channels):
        ...
        self.pwconv = nn.Sequential(
            nn.Linear(in_channels + out_channels, filter_channels),
            nn.GELU(),
