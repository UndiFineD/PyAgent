# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\ToucanTTS\LanguageEmbeddingSpaceStructureLoss.py
import os.path
        ...
        for language_id_1, language_embedding_1 in zip(
            ...
            for language_id_2, language_embedding_2 in zip(
                ...
                if language_id_1 != language_id_2:
                    ...
                    metric_distance = (
                        torch.tensor(tree_dist) + torch.tensor(map_dist)
                    ) / 2
                    losses.append(
