# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\Aligner\Aligner.py
"""
...
class BatchNormConv(torch.nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, kernel_size: int):
        ...
        self.bnorm = torch.nn.SyncBatchNorm.convert_sync_batchnorm(
...
if __name__ == "__main__":
    ...
    print(
        Aligner()(
            x=torch.randn(size=[3, 30, 128]), lens=torch.LongTensor([20, 30, 10])
        ).shape
    )
