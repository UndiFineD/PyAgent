# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\Aligner\Reconstructor.py
import torch
...
class Reconstructor(torch.nn.Module):
    ...
    def __init__(
        self, n_features=128, num_symbols=145, speaker_embedding_dim=192, hidden_dim=256
    ):
        super().__init__()
