# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_feature_name_validation.py
import os
import string
...
def test_feature_name_fails_on_punctuation_chars():
    for char in set(string.punctuation) - set("_"):
        with pytest.raises(
            Exception, match="only letters, numbers, and underscores are allowed"
        ):
