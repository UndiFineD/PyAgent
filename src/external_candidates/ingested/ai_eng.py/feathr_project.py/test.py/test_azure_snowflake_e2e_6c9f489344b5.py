# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_azure_snowflake_e2e.py
import os
...
from test_fixture import get_online_test_table_name, snowflake_test_setup
