...
def submit_spark_job(feature_names_funcs):
    ...
    if has_gen_config and has_join_config:
        raise RuntimeError(
            "Both FeatureGenConfig and FeatureJoinConfig are provided. "
        ...
        raise RuntimeError(
            "None of FeatureGenConfig and FeatureJoinConfig are provided. "
    ...
    py4j_feature_job.mainWithPreprocessedDataFrame(
        job_param_java_array, new_preprocessed_df_map
    )
    return None
