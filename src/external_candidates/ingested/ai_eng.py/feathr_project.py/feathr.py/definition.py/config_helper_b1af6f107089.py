# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\definition\config_helper.py
import importlib
import os
import sys
...
from feathr.definition.feature import Feature, FeatureBase, FeatureType
...
class FeathrConfigHelper(object):
    ...
    def _extract_features_from_context(
        self, anchor_list, derived_feature_list, result_path: Path
    ) -> RepoDefinitions:
    ...
    def save_to_feature_config_from_context(
        self, anchor_list, derived_feature_list, local_workspace_dir: Path
    ):
    ...
    def _save_request_feature_config(
...
""")
    ...
    @classmethod
    def _save_anchored_feature_config(
        self, repo_definitions: RepoDefinitions, local_workspace_dir="./"
    ):
...
""")
    ...
    @classmethod
    def _save_derived_feature_config(
        self, repo_definitions: RepoDefinitions, local_workspace_dir="./"
    ):
