# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\definition\dtype.py
import enum
...
class FloatVectorFeatureType(FeatureType):
    ...
    def __init__(self):
        FeatureType.__init__(
            self, val_type=ValueType.FLOAT, dimension_type=[ValueType.INT32]
        )
...
class Int32VectorFeatureType(FeatureType):
    ...
    def __init__(self):
        FeatureType.__init__(
            self, val_type=ValueType.INT32, dimension_type=[ValueType.INT32]
        )
...
class Int64VectorFeatureType(FeatureType):
    ...
    def __init__(self):
        FeatureType.__init__(
            self, val_type=ValueType.INT64, dimension_type=[ValueType.INT32]
        )
...
class DoubleVectorFeatureType(FeatureType):
    ...
    def __init__(self):
        FeatureType.__init__(
            self, val_type=ValueType.DOUBLE, dimension_type=[ValueType.INT32]
        )
