# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\constants.py
...
TYPEDEF_ARRAY_DERIVED_FEATURE = (
    f"array<feathr_derived_feature_{REGISTRY_TYPEDEF_VERSION}>"
)
TYPEDEF_ARRAY_ANCHOR_FEATURE = (
    f"array<feathr_anchor_feature_{REGISTRY_TYPEDEF_VERSION}>"
)
