# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\purview-registry\test\test_get.py
...
neighbors = registry.get_neighbors(
    "yihui_test_registry__anchor1", RelationshipType.Contains
)
assert len(neighbors) == 1

# source produces anchor feature and anchor group
neighbors = registry.get_neighbors(
    "yihui_test_registry__source1", RelationshipType.Produces
)
