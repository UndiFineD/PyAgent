# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\test\test_purview_registry.py
import os
import sys
...
from registry.purview_registry import ConflictError, PurviewRegistry
...
class PurviewRegistryTest(unittest.TestCase):
    ...
    def setup(self):
        ...
        if purview_name is None:
            raise RuntimeError(
                "Failed to run Purview registry test case. Cannot get environment variable: 'PURVIEW_NAME'"
            )
    ...
    def create_and_get_derived_feature(
        ...
        df_id = self.registry.create_project_derived_feature(
            ...
            DerivedFeatureDef(
                ...
                input_derived_features=input_derived_features,
            ),
        )
    ...
    def test_registry(self):
        ...
        df_id2 = self.create_and_get_derived_feature(
            project_id, project_name + "__df2", "df2", ft1, t2, [k], [af_id], [df_id]
        )
