# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-REST-Attacker\rest_attacker\checks\types.py
...
class TestCaseType(enum.Enum):
    ...
    SECURITY = "security"
    COMPARISON = (
        "comparison"  # unused; originally intended for comparing checks between runs
    )
    META = "meta"
...
class AuthType(enum.Enum):
    ...
    RECOMMENDED = (
        "recommended"  # access control data should be used but is not required
    )
