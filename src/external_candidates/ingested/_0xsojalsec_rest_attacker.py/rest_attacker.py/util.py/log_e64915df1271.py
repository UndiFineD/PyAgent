# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-REST-Attacker\rest_attacker\util\log.py
...
def setup_logging(
    cli_loglevel=logging.WARNING, file_loglevel=logging.DEBUG, logpath=None
):
    """
    Setup logging for the tool.
