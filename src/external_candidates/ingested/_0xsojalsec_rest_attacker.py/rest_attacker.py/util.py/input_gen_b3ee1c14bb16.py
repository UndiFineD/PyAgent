...
def replace_params(
    path: str, user_info: UserInfo, param_defs: dict[str, dict]
    ...
    header_params, query_params, cookie_params = replace_http_params(
        defined_params, param_defs
    )
...
def replace_http_params(
    defined_params: dict[str, list[str]], param_defs: dict[str, dict]
