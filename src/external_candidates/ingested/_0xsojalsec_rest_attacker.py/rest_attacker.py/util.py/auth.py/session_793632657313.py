...
class ROCookieSession(ROSession):
    ...
    def __init__(
        self, session_id: str, cookies: dict, test_url: str = None, expires: int = None
    ) -> None:
        """
...
class ROWebSession(ROSession):
    ...
    def __init__(
        self, session_id: str, login_url: str, login_data: dict, test_url: str = None
    ) -> None:
        """
...
class ROBrowserSession(ROSession):
    ...
    def __init__(
        self, session_id: str, executable: str, port: int, test_url: str = None
    ) -> None:
        """
