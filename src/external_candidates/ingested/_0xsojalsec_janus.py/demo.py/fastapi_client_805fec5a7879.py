# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Janus\demo\fastapi_client.py
import io
...
def understand_image_and_question(
...
def generate_images(prompt, seed=None, guidance=5.0):
    data = {"prompt": prompt, "seed": seed, "guidance": guidance}
