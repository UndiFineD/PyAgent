# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\utils\peinfo.py
import os
...
def listexports(fname):
    ...
    if (
        mype2.OPTIONAL_HEADER.DATA_DIRECTORY[
            pefile.DIRECTORY_ENTRY["IMAGE_DIRECTORY_ENTRY_EXPORT"]
        ].VirtualAddress
        != 0
    ):
        mype2.parse_data_directories(
