# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\inquest.py
import json
import os
import textwrap
...
class InQuestExtractor:
    ...
    def requestINQUESTAPI(self):
        if self.INQUESTAPI == "":
            print(
                ...
                + "\nTo be able to download samples from InQuest, you must create the .malwapi.conf file under your user home directory (on Linux is $HOME\\.malwapi.conf and on Windows is in C:\\Users\\[username]\\.malwapi.conf) and insert the InQuest API according to the format shown on the Github website."
                + mycolors.reset
                + "\n"
            )
            exit(1)
    ...
    def inquest_download(self, inquestx):
        ...
        try:
            ...
            inquestresponse = requestsession.get(
                inquest + "/download?sha256=" + inquestx
            )
            ...
            if inquestresponse.status_code == 400:
                ...
                if "error" in inquesttext:
                    if (
                        inquesttext["error"]
                        == "Supplied 'sha256' value is not a valid hash."
                    ):
                        if cv.bkg == 1:
                            print(
                                mycolors.foreground.lightred
    ...
    def inquest_hash(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/hash/sha256?hash=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
            ...
            if inquestresponse.status_code == 400 or inquestresponse.status_code == 500:
                ...
                if "error" in inquesttext:
                    if (
                        inquesttext["error"]
                        == "The 'source' parameter must be one of md5, sha1, sha256, sha512"
                    ):
                        if cv.bkg == 1:
                            print(
                                mycolors.foreground.lightred
    ...
    def inquest_hash_md5(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/hash/md5?hash=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
    ...
    def inquest_domain(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/ioc/domain?keyword=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
    ...
    def inquest_ip(self, inquestx):
        ...
        try:
            print("\n")
            print(
                (mycolors.reset + "INQUEST IP ADDRESS SEARCH REPORT".center(110)),
                end="",
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (110 * "-").center(55))
    ...
    def inquest_email(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/ioc/email?keyword=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
    ...
    def inquest_filename(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/ioc/filename?keyword=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
    ...
    def inquest_url(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search/ioc/url?keyword=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
    ...
    def inquest_ioc_search(self, inquestx):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": self.INQUESTAPI})
            inquestresponse = requestsession.get(
                inquest + "/search?keyword=" + inquestx
            )
            inquesttext = json.loads(inquestresponse.text)
            ...
            if inquestresponse.status_code == 400 or inquestresponse.status_code == 500:
                ...
                if "error" in inquesttext:
                    if (
                        inquesttext["error"]
                        == "The 'keyword' parameter must be at least 3 bytes long."
                    ):
                        if cv.bkg == 1:
                            print(
                                mycolors.foreground.lightred
                            ...
                            for d in inquesttext["data"]:
                                ...
                                for k in d:
                                    print(
                                        ...
                                        + (
                                            ("\n" + " ".ljust(0)).join(
                                                textwrap.wrap(str(d[k]), width=80)
                                            )
                                        ),
                                        end="\n",
                                    )
    ...
    def inquest_rep_search(self, inquestx):
        ...
        try:
            ...
            print("\n")
            print(
                (mycolors.reset + "INQUEST REPUTATION SEARCH REPORT".center(110)),
                end="",
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (110 * "-").center(55), end="\n")
    ...
    def inquest_rep_list(self, inquestx):
        ...
        try:
            ...
            print("\n")
            print(
                (mycolors.reset + "INQUEST REPUTATION LIST REPORT".center(110)), end=""
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (110 * "-").center(55))
