    ...
    def vt_url_ip_domain_report_dark(self, vttext):
        ...
        if "last_analysis_results" in attrs:
            ...
            if "Comodo Valkyrie Verdict" in attrs["last_analysis_results"]:
                result = attrs["last_analysis_results"]["Comodo Valkyrie Verdict"][
                    "result"
                ]
                if result:
                    print(
            ...
            if "Forcepoint ThreatSeeker" in attrs["last_analysis_results"]:
                result = attrs["last_analysis_results"]["Forcepoint ThreatSeeker"][
                    "result"
                ]
                if result:
                    print(
                ...
                if cv.bkg == 1:
                    ...
                    if "whois" in attrs:
                        ...
                        print(
                            ...
                            + mycolors.reset
                            + (mycolors.reset + "\n".ljust(26)).join(
                                textwrap.wrap(" ".join(whois.split()), width=80)
                            ),
                            end=" ",
                        )
        ...
        try:
            ...
            if response.status_code == 400:
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.yellow
                        + "\tThere was an issue while uploading the file."
                    )
                if cv.bkg == 0:
                    print(
        ...
        try:
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    ...
                    if "last_analysis_results" in attrs:
                        if "BitDefender" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["BitDefender"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "Emsisoft" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["Emsisoft"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "ESET-NOD32" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["ESET-NOD32"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "F-Secure" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["F-Secure"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "Fortinet" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["Fortinet"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "Kaspersky" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["Kaspersky"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "Microsoft" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["Microsoft"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "Symantec" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["Symantec"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "TrendMicro" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["TrendMicro"][
                                "result"
                            ]
                            if result:
                                print(
                    ...
                    if "last_analysis_results" in attrs:
                        if "ZoneAlarm" in attrs["last_analysis_results"]:
                            result = attrs["last_analysis_results"]["ZoneAlarm"][
                                "result"
                            ]
                            if result:
                                print(
                ...
                if cv.bkg == 1:
                    ...
                    if "popular_threat_classification" in attrs:
                        ...
                        if (
                            ...
                            in attrs["popular_threat_classification"]
                        ):
                            threat_label = attrs["popular_threat_classification"][
                                "suggested_threat_label"
                            ]
                        else:
                        ...
                        if (
                            ...
                            for popular in attrs["popular_threat_classification"][
                                "popular_threat_category"
                            ]:
                                count = popular["count"]
                                value = popular["value"]
                    ...
                    if "androguard" in attrs:
                        ...
                        if "certificate" in attrs["androguard"]:
                            ...
                            if "Issuer" in attrs["androguard"]["certificate"]:
                                ...
                                if "DN" in attrs["androguard"]["certificate"]["Issuer"]:
                                    dn = attrs["androguard"]["certificate"]["Issuer"][
                                        "DN"
                                    ]
                            ...
                            if "Subject" in attrs["androguard"]["certificate"]:
                                ...
                                if (
                                    "DN"
                                    in attrs["androguard"]["certificate"]["Subject"]
                                ):
                                    dn = attrs["androguard"]["certificate"]["Subject"][
                                        "DN"
                                    ]
                                    print(mycolors.reset + "DN: " + dn, end="")
                            if "serialnumber" in attrs["androguard"]["certificate"]:
                                print(
                                    mycolors.foreground.lightcyan
                                    + "\n".ljust(37)
                                    + "SerialNumber: ".ljust(15),
                                    end=" ",
                                )
                                serialnumber = attrs["androguard"]["certificate"][
                                    "serialnumber"
                                ]
                            ...
                            if "validfrom" in attrs["androguard"]["certificate"]:
                                ...
                                validfrom = attrs["androguard"]["certificate"][
                                    "validfrom"
                                ]
                            ...
                            if "thumbprint" in attrs["androguard"]["certificate"]:
                                ...
                                thumbprint = attrs["androguard"]["certificate"][
                                    "thumbprint"
                                ]
                        ...
                        if "intent_filters" in attrs["androguard"]:
                            ...
                            if "Activities" in attrs["androguard"]["intent_filters"]:
                                ...
                                for key, value in (
                                    attrs["androguard"]["intent_filters"]["Activities"]
                                ).items():
                                    print(
                                        mycolors.reset
                                        + "\n\n".ljust(54)
                            ...
                            if "Receivers" in attrs["androguard"]["intent_filters"]:
                                ...
                                for key, value in (
                                    attrs["androguard"]["intent_filters"]["Receivers"]
                                ).items():
                                    print(
                                        mycolors.reset
                                        + "\n\n".ljust(54)
                            ...
                            if "Services" in attrs["androguard"]["intent_filters"]:
                                ...
                                for key, value in (
                                    attrs["androguard"]["intent_filters"]["Services"]
                                ).items():
                                    print(
                                        mycolors.reset
                                        + "\n\n".ljust(54)
                        ...
                        if "permission_details" in attrs["androguard"]:
                            ...
                            for key, value in (
                                attrs["androguard"]["permission_details"]
                            ).items():
                                print(
                                    mycolors.reset
                                    + "\n\n".ljust(54)
                                ...
                                if "short_description" in value:
                                    print(
                                        ...
                                        + (
                                            ...
                                            + mycolors.reset
                                            + (
                                                "\n" + mycolors.reset + "".ljust(63)
                                            ).join(
                                                textwrap.wrap(
                                                    value["short_description"], width=80
                                                )
                                            )
                                        ),
                                        end=" ",
        ...
        try:
            ...
            if response.status_code == 404:
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.yellow
                        + "\tThere was an issue while getting a URL for uploading the file."
                    )
                if cv.bkg == 0:
                    print(
                        mycolors.foreground.blue
        ...
        try:
            ...
            if response.status_code == 404:
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.yellow
                        + "\tReport not found for the provided hash!"
                    )
                if cv.bkg == 0:
                    print(
                        mycolors.foreground.blue
                ...
                if cv.bkg == 1:
                        ...
                        for injected in vttext["data"]["processes_injected"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(injected, width=120)
                                    )
                                ),
                                end=" ",
                            )
                        ...
                        for process in vttext["data"]["processes_tree"]:
                            ...
                            print(
                                ...
                                + (
                                    ...
                                    + (mycolors.reset + "\n".ljust(39)).join(
                                        textwrap.wrap(
                                            " ".join(process["name"].split()), width=80
                                        )
                                    )
                                ),
                                end=" ",
                    ...
                    if "processes_terminated" in vttext["data"]:
                        ...
                        for process_term in vttext["data"]["processes_terminated"]:
                            print(
                                mycolors.reset + "".ljust(23) + process_term, end="\n"
                            )
                    if "processes_killed" in vttext["data"]:
                        ...
                        for process_kill in vttext["data"]["processes_killed"]:
                            print(
                                mycolors.reset + "".ljust(23) + process_kill, end="\n"
                            )
                        ...
                        for module in vttext["data"]["modules_loaded"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(module, width=120)
                                    )
                                ),
                                end=" ",
                            )
                        ...
                        for filename in vttext["data"]["files_opened"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(filename, width=120)
                                    )
                                ),
                                end=" ",
                            )
                        ...
                        for filewritten in vttext["data"]["files_written"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(filewritten, width=120)
                                    )
                                ),
                                end=" ",
                            )
                        ...
                        for filedeleted in vttext["data"]["files_deleted"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(filedeleted, width=120)
                                    )
                                ),
                                end=" ",
                            )
                        ...
                        for command in vttext["data"]["command_executions"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(24)
                                    + ("\n" + "".ljust(24)).join(
                                        textwrap.wrap(command, width=120)
                                    )
                                ),
                                end=" ",
                            )
                    ...
                    if "windows_hidden" in vttext["data"]:
                        ...
                        for windows_hidden in vttext["data"]["windows_hidden"]:
                            print(
                                mycolors.reset + "".ljust(23) + windows_hidden, end="\n"
                            )
            ...
            for filen in os.listdir(directory):
                try:
                    ...
                    if cv.bkg == 1:
                        print(
                            mycolors.foreground.lightred
                            + "\nAn error has occured while reading the %s file."
                            % filename
                        )
                    else:
                        print(
