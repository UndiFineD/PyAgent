...
class AlienVaultExtractor:
    ...
    def alien_subscribed(self, arg1):
        ...
        try:
            ...
            haresponse = requestsession.post(
                url=finalurl, headers=headers, params=search_params
            )
            ...
            if cv.bkg == 1:
                print(
                    (
                        ...
                        + "Error while connecting to Alien Vault!\n"
                    )
                )
            else:
                print(
                                ...
                                while i < len(hatext["pulse_info"][key]):
                                    if isinstance(hatext["pulse_info"][key][i], dict):
                                        if (
                                            ...
                                            for z in hatext["pulse_info"][key][i][
                                                "malware_families"
                                            ]:
                                            ...
                                            if hatext["pulse_info"][key][i]["tags"]:
                                                ...
                                                for z in hatext["pulse_info"][key][i][
                                                    ...
                                                    if (b % 5) == 0:
                                                        ...
                                                        print(
                                                            mycolors.reset + z, end=" "
                                                        )
                                                    if b == (
                                                        len(
                                                            hatext["pulse_info"][key][
                                                                i
                                                            ]["tags"]
                                                        )
                                                    ):
                        ...
                        if hatext["pulse_info"]["pulses"]:
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                ...
                                if (
                                    ...
                                    for z in hatext["pulse_info"]["pulses"][i][
                                        "malware_families"
                                    ]:
                                        print(
                                            mycolors.reset + z["display_name"], end=" "
                                        )
                                if (
                                    "targeted_countries"
                                    in hatext["pulse_info"]["pulses"][i]
                                ...
                                if "attack_ids" in hatext["pulse_info"]["pulses"][i]:
                                    if hatext["pulse_info"]["pulses"][i]["attack_ids"]:
                                        for k in hatext["pulse_info"]["pulses"][i][
                                            "attack_ids"
                                        ]:
                                            print(
                                                mycolors.foreground.yellow
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                if "tags" in (hatext["pulse_info"]["pulses"][i]):
                                    if hatext["pulse_info"]["pulses"][i]["tags"]:
                                        ...
                                        b = 0
                                        for j in hatext["pulse_info"]["pulses"][i][
                                            "tags"
                                        ]:
                                            b = b + 1
                                            if (b % 5) == 0:
                    ...
                    if hatext["pulse_info"]:
                        ...
                        if "pulses" in (hatext["pulse_info"]):
                            ...
                            while j < len(hatext["pulse_info"]["pulses"]):
                                if "tags" in (hatext["pulse_info"]["pulses"][i]):
                                    if hatext["pulse_info"]["pulses"][j]["tags"]:
                                        ...
                                        for z in hatext["pulse_info"]["pulses"][j][
                                            "tags"
                                        ]:
                                            print(mycolors.reset + z, end=" ")
                                j = j + 1
                            ...
                            while t < len(hatext["pulse_info"]["pulses"]):
                                if (
                                    "malware_families"
                                    in hatext["pulse_info"]["pulses"][t]
                                ):
                                    if hatext["pulse_info"]["pulses"][t][
                                        "malware_families"
                                    ]:
                                        print(
                                            mycolors.foreground.lightred
                                        ...
                                        for w in hatext["pulse_info"]["pulses"][t][
                                            "malware_families"
                                        ]:
                                            print(
