    ...
    def malpedia_actors(self):
        ...
        try:
            ...
            requestsession.headers.update(
                {"Authorization": "apitoken " + self.MALPEDIAAPI}
            )
            ...
            if cv.bkg == 1:
                print(
                    (
                        mycolors.foreground.lightred
                        + "Error while connecting to Malpedia!\n"
                    )
                )
            else:
                print(
                    (mycolors.foreground.red + "Error while connecting to Malpedia!\n")
                )
            printr()
            ...
            if cv.bkg == 1:
                ...
                if hatext["description"]:
                    print(
                        ...
                        + mycolors.reset
                        + ("\n".ljust(11)).join(
                            textwrap.wrap(str(hatext["description"]), width=100)
                        ),
                        end=" ",
                    )
                for key, value in hatext.items():
                            ...
                            if "description" in value3.keys():
                                if value3["description"]:
                                    print(
                                        ...
                                        + ("\n".ljust(11)).join(
                                            textwrap.wrap(
                                                str(value3["description"]), width=100
                                            )
                                        ),
                                        end=" ",
                                    )
            ...
            if cv.bkg == 1:
                ...
                if hatext["description"]:
                    print(
                        ...
                        + mycolors.reset
                        + ("\n".ljust(14)).join(
                            textwrap.wrap(hatext["description"], width=110)
                        ),
                        end="\n",
                    )
