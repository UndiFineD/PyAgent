...
class URLHausExtractor:
            ...
            if "query_status" in haustext:
                if cv.bkg == 1:
                    print(
                        ...
                        + "Is available?: \t"
                        + haustext.get("query_status").upper()
                    )
                else:
                    print(
                            ...
                            if w["url"]:
                                ...
                                if w["url"]:
                                    print(
                                        mycolors.foreground.yellow
                                        + ("\n" + "".ljust(51))
                                        .join(textwrap.wrap(w["url"], width=80))
                                        .ljust(80),
                                        end="\n",
                                    )
                                else:
    ...
    def haussample(self, hashx):
        ...
        try:
            ...
            if cv.bkg == 1:
                ...
                print(
                    (mycolors.foreground.red + "Error while connecting to URLhaus!\n")
                )
            printr()
    ...
    def hausgetbatch(self):
        ...
        try:
            print("\n")
            print(
                (mycolors.reset + "URLhaus Recent Malicious URLs".center(104)), end=""
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (126 * "-").center(59))
    ...
    def hauspayloadslist(self):
        ...
        try:
            ...
            print(
                (
                    mycolors.reset
                    + "Haus Downloadable Links to Recent Payloads".center(146)
                ),
                end="",
            )
            print((mycolors.reset + "".center(28)), end="")
                    ...
                    for i in range(0, npayloads):
                        if "sha256_hash" in haustext["payloads"][i]:
                            if cv.bkg == 1:
                                print(
                                    mycolors.foreground.lightred
                                    + "%-8s" % haustext["payloads"][i].get("file_type"),
                                    end=" ",
                                )
                                print(
                                    mycolors.foreground.lightcyan
                                    + haustext["payloads"][i].get("firstseen"),
                                    end=" ",
                                )
                                ...
                                print(
                                    mycolors.foreground.lightcyan
                                    + haustext["payloads"][i].get("urlhaus_download")
                                )
                            else:
                                print(
                                    mycolors.foreground.red
        ...
        try:
            ...
            if "blacklists" in haustext:
                ...
                if cv.bkg == 1:
                    ...
                    if "gsb" in (blacks):
                        print(
                            mycolors.foreground.red + "Google(gsb): \t" + blacks["gsb"]
                        )
                    if "surbl" in (blacks):
                        ...
                        if cv.bkg == 1:
                            ...
                            if "filename" in i:
                                if i["filename"] is not None:
                                    print(
                                        mycolors.foreground.yellow
                                        + "filename: %-30s" % i["filename"].ljust(40),
                                        end=" " + "",
                                    )
                            if "file_type" in i:
    ...
    def haushashsearch(self, hashx):
        ...
        try:
            ...
            if (haustext.get("md5_hash") is None) and (
                haustext.get("sha256_hash") is None
            ):
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.lightred
                    ...
                    print(
                        mycolors.foreground.red + "Hash not found!\n" + mycolors.reset
                    )
                exit(1)
                ...
                if haustext.get("virustotal") is not None:
                    if cv.bkg == 1:
                        print(
                            mycolors.foreground.lightred
                            + "Virus Total: \t"
                            + haustext["virustotal"].get("result")
                        )
                    else:
                        print(
                            mycolors.foreground.red
                    ...
                    for w in allurls:
                        if cv.bkg == 1:
                            ...
                            if w["url"]:
                                ...
                                print(
                                    mycolors.foreground.blue + w["url"] + mycolors.reset
                                )
                            else:
                                print(
                                    mycolors.foreground.lightcyan
