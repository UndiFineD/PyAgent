    ...
    def polymetasearch(self, poly, metainfo):
        ...
        try:
            ...
            try:
                ...
                if metainfo == 6:
                    metaresults = polyswarm.search_by_metadata(
                        "strings.domains:" + poly
                    )
                if metainfo == 7:
                    poly = r'"' + poly + r'"'
                ...
                if cv.bkg == 1:
                    ...
                    if (str(y.scan.get("detections", {}).get("malicious"))) != "None":
                        ...
                        print(
                            "/ "
                            + "%2s malicious"
                            % y.scan.get("detections", {}).get("total"),
                            end=" ",
                        )
                    else:
                        print(
    ...
    def polyfile(self, poly):
        ...
        try:
            ...
            if cv.bkg == 1:
                ...
                if extended:
                    print(
                        mycolors.foreground.lightred + "Extended Info: \t%s" % extended
                    )
                if firstseen:
