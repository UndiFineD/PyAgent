...
class TriageExtractor:
    ...
    def triage_summary(self, triagex):
        ...
        try:
            ...
            triageresponse = requestsession.get(
                triage + "samples/" + triagex + "/overview.json"
            )
            triagetext = json.loads(triageresponse.text)
                                ...
                                for m in triagetext["targets"][k]:
                                    ...
                                    if "iocs" == m:
                                        ...
                                        for j in triagetext["targets"][k][m]:
                                            if "ips" == j:
                                                for i in range(
                                                    len(triagetext["targets"][k][m][j])
                                                ):
                                                    print(
                                                        "\n".ljust(22)
                                                        + mycolors.reset
                                                        + str(
                                                            triagetext["targets"][k][m][
                                                                j
                                                            ][i]
                                                        ),
                                                        end=" ",
    ...
    def triage_url_sample_submit(self, triagex):
        ...
        try:
            print("\n")
            print(
                (mycolors.reset + "TRIAGE URL SAMPLE SUBMIT REPORT".center(80)), end=""
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (80 * "-").center(40))
            ...
            triageresponse = requestsession.post(
                triage + "samples", data=json.dumps(mydata)
            )
            triagetext = json.loads(triageresponse.text)
        ...
        try:
            ...
            if cv.bkg == 1:
                print(
                    "\n"
                    + mycolors.foreground.yellow
                    + f"Sample downloaded to: {outputpath}"
                    + mycolors.reset,
                    end=" ",
                )
            if cv.bkg == 0:
    ...
    def triage_download_pcap(self, triagex):
        ...
        try:
            ...
            requestsession.headers.update({"Authorization": "Bearer " + self.TRIAGEAPI})
            triageresponse = requestsession.get(
                triage + "samples/" + triagex + "/behavioral1/dump.pcapng"
            )
            if triageresponse.status_code == 404:
                triagetext = json.loads(triageresponse.text)
            ...
            if cv.bkg == 1:
                print(
                    "\n"
                    + mycolors.foreground.yellow
                    + f"PCAP downloaded to: {outputpath}"
                    + mycolors.reset,
                    end=" ",
                )
            if cv.bkg == 0:
    ...
    def triage_dynamic(self, triagex):
        ...
        try:
            ...
            triageresponse = requestsession.get(
                triage + "samples/" + triagex + "/behavioral1/report_triage.json"
            )
            triagetext = json.loads(triageresponse.text)
