# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhatsappMonitor\contacts.py
import re
import sys
import time
...
def select_contacts(browser):
    ...
    time.sleep(2)
    contacts = browser.find_elements_by_xpath(
        "/html/body/div[1]/div/div/div[3]/div/div[2]/div[1]/div/div/child::*"
    )
...
def is_not_group(browser):
    browser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div[4]/div/header/div[2]/div/div/span"
    ).click()
