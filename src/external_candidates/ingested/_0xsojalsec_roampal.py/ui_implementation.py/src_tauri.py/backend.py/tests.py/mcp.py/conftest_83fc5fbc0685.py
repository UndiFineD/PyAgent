# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\tests\mcp\conftest.py
"""
...
def mock_memory_system():
    ...
    memory.analyze_conversation_context = AsyncMock(
        return_value={"entities": [], "patterns": [], "context_type": "general"}
    )
...
def mock_mcp_caches():
    ...
    return {"search_cache": {}, "action_cache": {}, "first_tool_call": set()}
