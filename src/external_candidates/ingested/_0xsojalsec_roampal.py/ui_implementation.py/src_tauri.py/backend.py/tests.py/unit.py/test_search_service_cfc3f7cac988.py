# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\tests\unit\test_search_service.py
"""
            ...
            return [
                {
                    ...
                    "text": "test result 1",
                    "distance": 0.5,
                    "metadata": {"score": 0.7, "uses": 3},
                },
                {
                    "id": "doc_2",
                    "text": "test result 2",
                    "distance": 0.8,
                    "metadata": {"score": 0.5, "uses": 1},
                },
            ]
