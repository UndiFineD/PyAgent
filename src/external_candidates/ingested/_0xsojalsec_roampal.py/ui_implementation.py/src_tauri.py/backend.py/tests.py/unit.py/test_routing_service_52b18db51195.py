# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\tests\unit\test_routing_service.py
"""
...
from modules.memory.routing_service import ALL_COLLECTIONS, RoutingService
...
class TestQueryRouting:
    ...
    def test_high_confidence_phase(self, mock_kg_service):
        ...
        mock_kg_service.extract_concepts = MagicMock(
            return_value=["python", "django", "web"]
        )
        service = RoutingService(kg_service=mock_kg_service)
