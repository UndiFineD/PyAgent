# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\modules\memory\types.py
"""
...
class ActionOutcome:
    ...
    action_type: (
        str  # Tool name: "search_memory", "create_memory", "update_memory", etc.
    )
    context_type: (
        ContextType  # LLM-classified topic: "coding", "fitness", "finance", etc.
    )
