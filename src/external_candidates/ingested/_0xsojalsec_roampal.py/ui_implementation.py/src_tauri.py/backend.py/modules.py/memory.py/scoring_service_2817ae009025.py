...
class ScoringService:
    ...
    def calculate_wilson_score(
        self, successes: float, total: int, confidence: Optional[float] = None
    ) -> float:
        """
    ...
    def calculate_learned_score(
        self, raw_score: float, uses: int, outcome_history: str = ""
    ) -> Tuple[float, float]:
        """
    ...
    def calculate_final_score(
        self, metadata: Dict[str, Any], distance: float, collection: str
    ) -> Dict[str, float]:
        """
