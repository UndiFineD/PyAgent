# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\modules\memory\format_extractor\detector.py
"""
    ...
    try:
        ...
        try:
            ...
            with open(file_path, "r", encoding="utf-8", errors="replace") as f:
                ...
                encoding = "utf-8"
                warnings.append(
                    "Encoding detection unavailable, using UTF-8 with replacement"
                )
