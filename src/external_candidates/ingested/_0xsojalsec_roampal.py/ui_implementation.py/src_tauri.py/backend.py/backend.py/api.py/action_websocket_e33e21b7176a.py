# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\backend\api\action_websocket.py
"""
...
class ActionStatusManager:
    ...
    async def _auto_complete_action(
        self, session_id: str, action_id: str, delay: float = 2.0
    ):
    ...
    async def request_approval(
        self, session_id: str, operations: List[Dict], risk_level: str = "low"
    ):
