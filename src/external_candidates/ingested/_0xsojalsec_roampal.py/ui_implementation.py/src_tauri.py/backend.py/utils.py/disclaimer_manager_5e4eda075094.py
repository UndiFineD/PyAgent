# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\utils\disclaimer_manager.py
"""
...
class DisclaimerManager:
    ...
    def get_disclaimer(context: str = "chat_footer") -> str:
        ...
        return DisclaimerManager.DISCLAIMERS.get(
            context, DisclaimerManager.DISCLAIMERS["chat_footer"]
        )
    ...
    def add_disclaimer_to_response(
        response: Dict, user_input: str = "", is_first_message: bool = False
    ) -> Dict:
