# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\utils\correction_utils.py
import json
import logging
...
def log_correction(chunk_id: str, user_prompt: str, reason: str):
    entry = {"chunk_id": chunk_id, "user_prompt": user_prompt, "reason": reason}
