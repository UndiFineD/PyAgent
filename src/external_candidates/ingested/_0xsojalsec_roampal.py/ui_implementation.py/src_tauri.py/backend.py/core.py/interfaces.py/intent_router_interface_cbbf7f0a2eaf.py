# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\interfaces\intent_router_interface.py
# C:\RoampalAI\backend\core\interfaces\intent_router_interface.py
from abc import ABC, abstractmethod
from typing import Any, Dict, List, Optional

from core.types.common_types import (  # Updated to use correct relative path
    Action,
    Message,
)
