...
class InteractionType(Enum):
    ...
    RESPOND_WITH_STRUCTURED_SUMMARY = (
        ActionType.RESPOND_WITH_STRUCTURED_SUMMARY.value
    )  # <— NEW
    ...
    OG_RESPOND_WITH_STRUCTURED_SUMMARY = (
        f"OG_{ActionType.RESPOND_WITH_STRUCTURED_SUMMARY.name}"  # <— NEW
    )
    ...
    def from_action_type(
        cls, action_type: ActionType, is_og: bool = False
    ) -> "InteractionType":
