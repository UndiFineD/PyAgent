# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\interfaces\book_processor_interface.py
...
class BookProcessorInterface(ABC):
    ...
    async def retrieve_from_ingested_books(
        ...
        content_types_to_search: Optional[
            List[
                Literal["chunks", "chunk_summaries", "full_summary", "models", "quotes"]
            ]
        ] = None,
