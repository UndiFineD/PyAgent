# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\interfaces\memory_adapter_interface.py
...
class MemoryAdapterInterface(ABC):
    ...
    async def search_memories(
        ...
        Any
    ]:  # The 'Any' here could be a Pydantic model for a generic memory entry
        """
    ...
    @abstractmethod
    async def store_arbitrary_data(
