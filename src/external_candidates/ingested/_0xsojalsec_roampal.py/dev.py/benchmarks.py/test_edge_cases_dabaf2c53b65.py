...
class EdgeCaseTestSuite:
    ...
    async def setup(self):
        ...
        self.memory = UnifiedMemorySystem(
            data_dir=self.test_dir, use_server=False, llm_service=None
        )
    ...
    async def test_empty_string(self):
        ...
        try:
            result = await self.memory.store_memory_bank(
                text="", tags=["test"], importance=0.5, confidence=0.5
            )
            # If it stored, search should still work
            search = await self.memory.search(
                query="", collections=["memory_bank"], limit=5
            )
    ...
    async def test_very_long_text(self):
        ...
        try:
            ...
            search = await self.memory.search(
                query="test sentence", collections=["memory_bank"], limit=1
            )
            self.record(
                "Very long text (25KB)", len(search) > 0, f"Stored and retrieved"
            )
        except Exception as e:
    ...
    async def test_single_character(self):
        ...
        try:
            result = await self.memory.store_memory_bank(
                text="X", tags=["test"], importance=0.5, confidence=0.5
            )
    ...
    async def test_emoji_heavy(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text=emoji_text, tags=["emoji"], importance=0.8, confidence=0.8
            )
            search = await self.memory.search(
                query="favorite animals food", collections=["memory_bank"], limit=1
            )
    ...
    async def test_rtl_text(self):
        ...
        try:
            ...
            search = await self.memory.search(
                query="Arabic Hebrew languages", collections=["memory_bank"], limit=1
            )
    ...
    async def test_zero_width_chars(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text=zwc_text, tags=["test"], importance=0.5, confidence=0.5
            )
    ...
    async def test_mixed_scripts(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text=mixed, tags=["multilingual"], importance=0.7, confidence=0.7
            )
            search = await self.memory.search(
                query="user name languages", collections=["memory_bank"], limit=1
            )
    ...
    async def test_sql_injection_in_text(self):
        ...
        try:
            doc_id = await self.memory.store_memory_bank(
                text=sql_text, tags=["test"], importance=0.5, confidence=0.5
            )
            # Verify it was stored literally
            search = await self.memory.search(
                query="DROP TABLE", collections=["memory_bank"], limit=1
            )
            stored_correctly = len(search) > 0 and "DROP TABLE" in search[0].get(
                "text", ""
            )
    ...
    async def test_prompt_injection(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text=injection, tags=["test"], importance=0.5, confidence=0.5
            )
            search = await self.memory.search(
                query="IGNORE INSTRUCTIONS", collections=["memory_bank"], limit=1
            )
    ...
    async def test_json_injection_in_metadata(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text=json_text, tags=["json", "test"], importance=0.5, confidence=0.5
            )
            search = await self.memory.search(
                query="nested key value", collections=["memory_bank"], limit=1
            )
    ...
    async def test_empty_tags_list(self):
        ...
        try:
            await self.memory.store_memory_bank(
                text="Content with no tags", tags=[], importance=0.5, confidence=0.5
            )
    ...
    async def test_none_values(self):
        ...
        try:
            ...
            self.record(
                "None in tags list", True, f"Rejected safely: {type(e).__name__}"
            )
        ...
        async def search_loop():
            for _ in range(10):
                await self.memory.search(
                    query="existing item search", collections=["memory_bank"], limit=5
                )
    ...
    async def test_search_special_chars(self):
        ...
        for query in special_queries:
            try:
                await self.memory.search(
                    query=query, collections=["memory_bank"], limit=5
                )
                passed += 1
            except:
                pass
    ...
    async def test_search_limit_zero(self):
        ...
        try:
            results = await self.memory.search(
                query="test query", collections=["memory_bank"], limit=0
            )
    ...
    async def test_search_very_high_limit(self):
        ...
        try:
            results = await self.memory.search(
                query="test query", collections=["memory_bank"], limit=10000
            )
