# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\memory\advanced-graph-memory-integration.py
"""
...
memory_config = {
    ...
    "config": {
        "vector_store": {
            "provider": "chroma",
            "config": {"path": ".praison/graph_memory"},
        }
    },
}
