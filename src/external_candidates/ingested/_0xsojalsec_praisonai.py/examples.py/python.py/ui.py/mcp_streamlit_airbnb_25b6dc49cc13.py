# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\ui\mcp-streamlit-airbnb.py
import logging
import traceback
...
# Configure page
st.set_page_config(page_title="AI Airbnb Assistant", page_icon="🏠", layout="wide")
...
def initialize_agent():
    ...
    try:
        with st.spinner("🔄 Initializing AI agent and MCP tools..."):
            ...
            # Create MCP tools
            mcp_tools = MCP(mcp_command, timeout=60, debug=debug_mode)
