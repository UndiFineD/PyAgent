# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\general\memory_simple.py
...
fact_task = Task(
    description="Store the following facts in memory: "
    + fact1
    + ", "
    + fact2
    + ", "
...
research_task = Task(
    description="Research and document 2 key points about AI", agent=research_agent
)
...
blog_task = Task(description="Write a blog post about Jujuha", agent=blog_agent)
