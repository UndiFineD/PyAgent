# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\providers\ollama\ollama-base-url-example.py
...
agent2 = Agent(
    instructions="You are a helpful assistant",
    llm={"model": "ollama/llama3.2", "base_url": "http://remote-host:11434"},
)
