# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\providers\vertex\vertex_example.py
"""
Basic example of using Google Vertex AI with PraisonAI
"""
