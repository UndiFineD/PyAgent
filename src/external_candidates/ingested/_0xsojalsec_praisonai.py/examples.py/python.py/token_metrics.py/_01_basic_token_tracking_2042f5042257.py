# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\token-metrics\01_basic_token_tracking.py
"""
...
def main():
    ...
    agents = PraisonAIAgents(
        agents=[research_agent], tasks=[research_task], verbose=True
    )
