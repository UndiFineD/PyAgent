# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\mongodb\mongodb_memory_example.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    try:
        ...
        try:
            ...
            mongo_memories = memory_system.search_long_term(
                "MongoDB vector search", limit=3
            )
            ...
            print(
                "Memory features not available - install with: pip install 'praisonaiagents[memory]'"
            )
