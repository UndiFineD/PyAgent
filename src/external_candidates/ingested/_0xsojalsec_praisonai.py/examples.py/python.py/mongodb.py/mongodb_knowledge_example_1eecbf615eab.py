# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\mongodb\mongodb_knowledge_example.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    try:
        ...
        knowledge_system.store(
            sample_doc, metadata={"category": "database", "type": "overview"}
        )
