        ...
        models.append(
            {
                ...
                "air_quality_impact": (
                    "moderate" if "park" in location else "significant"
                ),
        ...
        predictions.append(
            {
                ...
                "health_impact": (
                    "high" if model["air_quality_impact"] == "significant" else "medium"
                ),
                "energy_consumption": {
                    "cooling_need": model["temperature_delta"] * 10,
                    "trend": (
                        "increasing" if model["temperature_delta"] > 2.5 else "stable"
                    ),
                },
