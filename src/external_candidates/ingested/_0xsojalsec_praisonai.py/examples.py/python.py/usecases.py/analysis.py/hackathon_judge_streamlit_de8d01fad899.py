# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\usecases\analysis\hackathon-judge-streamlit.py
import json
import os
import tempfile
...
# Set page config
st.set_page_config(
    page_title="Hackathon Project Evaluator", page_icon="🏆", layout="wide"
)
...
def evaluate_project(video_path: str) -> ProjectEvaluation:
    ...
    try:
        ...
        return ProjectEvaluation(
            ...
            scalability_assessment=str(
                evaluation_data.get("scalability_assessment", "")
            ),
        )
