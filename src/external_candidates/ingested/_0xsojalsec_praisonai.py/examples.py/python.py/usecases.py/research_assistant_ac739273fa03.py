# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\usecases\research-assistant.py
import asyncio
import time
...
workflow = PraisonAIAgents(
    ...
    tasks=[analysis_task, gap_task, design_task, validation_task, prediction_task],
    process="workflow",
    verbose=True,
)
