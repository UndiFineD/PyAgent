# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\custom_tools\latency_tracker_tool.py
"""
...
def latency_tracking_tool(
    ...
    if action == "start":
        ...
        return json.dumps(
            {"status": "started", "phase": phase, "request_id": request_id}
        )
