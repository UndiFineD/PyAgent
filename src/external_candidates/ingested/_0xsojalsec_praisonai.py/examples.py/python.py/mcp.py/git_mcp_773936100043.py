# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\mcp\git-mcp.py
import os
...
git_agent.start(
    "Clone and analyze the repository at https://github.com/modelcontextprotocol/servers"
)
