# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\concepts\routing-patterns.py
"""
...
def decision_tree_example():
    ...
    terminal_tasks = [
        ...
        Task(
            ...
            expected_output="Quick fix applied",
            agent=processor_agent,
        ),
        Task(
            name="standard_solution",
            description="Apply standard solution",
            expected_output="Standard solution applied",
            agent=processor_agent,
        ),
        Task(
            name="expert_consultation",
            description="Consult with expert",
            expected_output="Expert consultation result",
            agent=processor_agent,
        ),
        Task(
            name="executive_review",
            description="Send for executive review",
            expected_output="Executive decision",
            agent=processor_agent,
        ),
        Task(
            name="manager_approval",
            description="Send for manager approval",
            expected_output="Manager decision",
            agent=processor_agent,
        ),
        Task(
            name="auto_approve",
            description="Auto-approve request",
            expected_output="Auto-approved",
            agent=processor_agent,
        ),
    ]
