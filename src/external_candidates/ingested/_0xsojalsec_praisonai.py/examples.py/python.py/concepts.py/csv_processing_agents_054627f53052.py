# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\concepts\csv-processing-agents.py
"""
...
def method_2_manual_csv():
    ...
    # Initialize and run
    agents = PraisonAIAgents(agents=[csv_agent], tasks=[csv_task], process="sequential")
...
def method_3_url_processing():
    ...
    # Initialize and run
    agents = PraisonAIAgents(agents=[url_agent], tasks=[url_task], process="sequential")
