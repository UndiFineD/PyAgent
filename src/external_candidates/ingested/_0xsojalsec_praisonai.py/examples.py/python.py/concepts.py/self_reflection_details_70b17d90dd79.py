# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\concepts\self-reflection-details.py
"""
...
class ReflectionController:
    ...
    def should_continue_reflecting(self, current_output: str) -> bool:
        ...
        quality_indicators = [
            ...
            "." in current_output,
            any(
                word in current_output.lower()
                for word in ["innovative", "comprehensive", "detailed"]
            ),
        ]
...
if __name__ == "__main__":
    ...
    print(
        "1. Improved Quality: Reflection iterations allow agents to refine their outputs"
    )
    ...
    print(
        "5. Customization: Reflection parameters can be tuned for different use cases"
    )
