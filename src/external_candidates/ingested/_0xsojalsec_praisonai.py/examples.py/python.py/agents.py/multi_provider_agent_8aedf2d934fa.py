# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\agents\multi-provider-agent.py
"""
...
from praisonaiagents.llm.model_router import ModelProfile, ModelRouter, TaskComplexity
...
def example_cost_optimized_workflow():
    ...
    analyzer = RouterAgent(
        ...
        models={"gemini/gemini-1.5-flash": {}, "gpt-5-nano": {}, "deepseek-chat": {}},
    ...
    writer = RouterAgent(
        ...
        models={"claude-3-5-sonnet-20241022": {}, "gpt-5-nano": {}},
...
def example_custom_routing():
    ...
    # Run tasks
    agents = PraisonAIAgents(
        agents=[coder], tasks=tasks, process="sequential", verbose=True
    )
