# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\agents\router-agent-cost-optimization.py
"""
...
print("=" * 60)
moderate_result = router.start(
    "Write a brief analysis of renewable energy trends in 2024"
)
...
print("=" * 60)
complex_result = router.start(
    "Conduct a comprehensive strategic analysis of the impact of quantum computing on cybersecurity, including potential vulnerabilities and mitigation strategies"
)
...
print("=" * 60)
research_result = router.start(
    "Research and analyze the latest developments in artificial intelligence regulation globally"
)
...
print("=" * 80)
print(
    "The RouterAgent automatically selected appropriate models based on task complexity:"
)
