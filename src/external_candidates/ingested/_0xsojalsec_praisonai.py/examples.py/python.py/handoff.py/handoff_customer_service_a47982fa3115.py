# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\handoff\handoff_customer_service.py
"""
...
from praisonaiagents import RECOMMENDED_PROMPT_PREFIX, Agent, handoff
