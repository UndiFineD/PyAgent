# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\tools\exa-tool\github_repo_analyzer_agent.py
# # -*- coding: utf-8 -*-
...
def ask_agent(repo_url):
    ...
    return agent.start(
        f"Repo contains files: {files}. Analyze key components and structure."
    )
