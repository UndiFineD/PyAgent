# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\tools\exa-tool\Research_Knowledge_QA_Agents\Domain_Deep_Research_Agent.py
#!/usr/bin/env python
# coding: utf-8
...
if __name__ == "__main__":
    ...
    if not is_valid_key(OPENAI_API_KEY, "sk"):
        print(
            "API key not set or is a placeholder. Using dummy research report for CI/testing."
        )
        print(dummy_report)
    else:
        prompt = f"""
