# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\tools\exa-tool\personalized_learning_assistant.py
# ===============================
...
agent = Agent(
    instructions="You are a friendly tutor. Answer learner questions clearly and helpfully."
)
