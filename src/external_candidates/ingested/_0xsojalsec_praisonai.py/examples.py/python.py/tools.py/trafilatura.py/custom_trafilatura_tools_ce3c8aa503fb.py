# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\tools\trafilatura\custom_trafilatura_tools.py
#!/usr/bin/env python3
"""
...
class TrafilaturaTools:
    ...
    def extract_metadata(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not metadata:
                return {"url": url, "error": "No metadata found"}
    ...
    def extract_text_only(self, url: str, include_comments: bool = False) -> str:
        """
    ...
    def compare_extraction(
        self, url: str, include_newspaper: bool = True, include_spider: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    try:
        ...
        for unsafe_url in unsafe_urls:
            ...
            if (
                ...
                and "error" in result
                and "Invalid or unsafe URL" in result["error"]
            ):
