# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_digital_marketing_seo_optimization_agent.py
...
response = agent.start(
    "Hello! I'm your digital marketing and SEO optimization assistant. "
