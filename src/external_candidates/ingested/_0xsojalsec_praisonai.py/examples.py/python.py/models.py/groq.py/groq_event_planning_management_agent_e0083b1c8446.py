# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_event_planning_management_agent.py
...
response = agent.start(
    "Hello! I'm your event planning and management assistant. "
