# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_crisis_management_communication_agent.py
...
response = agent.start(
    "Hello! I'm your crisis management and communication assistant. "
