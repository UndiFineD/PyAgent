# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_personal_branding_pr_agent.py
"""
Personal Branding & PR Agent using Groq
Specialized agent for managing personal brand and public relations
"""
...
response = agent.start(
    "Hello! I'm your personal branding and PR assistant. "
