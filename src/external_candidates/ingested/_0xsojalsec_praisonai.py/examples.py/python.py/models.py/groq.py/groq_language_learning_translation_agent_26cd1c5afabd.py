# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_language_learning_translation_agent.py
...
response = agent.start(
    "Hello! I'm your language learning and translation assistant. "
