# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_supply_chain_optimization_agent.py
...
response = agent.start(
    "Hello! I'm your supply chain optimization assistant. "
