# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_environmental_impact_assessment_agent.py
...
response = agent.start(
    "Hello! I'm your environmental impact assessment assistant. "
