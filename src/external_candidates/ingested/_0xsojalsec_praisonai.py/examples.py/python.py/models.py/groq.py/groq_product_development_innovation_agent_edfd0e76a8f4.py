# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_product_development_innovation_agent.py
...
response = agent.start(
    "Hello! I'm your product development and innovation assistant. "
