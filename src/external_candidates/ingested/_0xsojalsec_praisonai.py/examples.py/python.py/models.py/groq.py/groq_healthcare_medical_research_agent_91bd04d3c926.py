# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_healthcare_medical_research_agent.py
...
response = agent.start(
    "Hello! I'm your healthcare and medical research assistant. "
