# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_blockchain_defi_agent.py
...
response = agent.start(
    "Hello! I'm your blockchain and DeFi assistant. "
