# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_nanotechnology_materials_agent.py
...
response = agent.start(
    "Hello! I'm your nanotechnology and materials assistant. "
