# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_system_architect_agent.py
...
response = agent.start(
    "Hello! I'm your system architecture assistant. "
