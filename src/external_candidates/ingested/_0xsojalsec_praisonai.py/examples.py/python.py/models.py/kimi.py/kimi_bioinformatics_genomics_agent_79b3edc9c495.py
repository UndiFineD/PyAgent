# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_bioinformatics_genomics_agent.py
...
response = agent.start(
    "Hello! I'm your bioinformatics and genomics assistant. "
