# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_aerospace_engineering_agent.py
...
response = agent.start(
    "Hello! I'm your aerospace engineering assistant. "
