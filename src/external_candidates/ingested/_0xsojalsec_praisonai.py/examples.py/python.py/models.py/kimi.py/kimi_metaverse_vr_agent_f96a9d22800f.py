# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_metaverse_vr_agent.py
...
response = agent.start(
    "Hello! I'm your metaverse and VR assistant. "
