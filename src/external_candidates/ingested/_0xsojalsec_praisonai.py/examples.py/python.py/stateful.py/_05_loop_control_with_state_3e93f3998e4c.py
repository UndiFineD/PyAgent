# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\05_loop_control_with_state.py
#!/usr/bin/env python3
"""
...
def process_batch() -> str:
    ...
    if success:
        ...
        workflow.increment_state(
            "total_records_processed", records_processed, default=0
        )
    else:
...
workflow = PraisonAIAgents(
    ...
    tasks=[
        batch_loop_task,
        retry_loop_task,
        pagination_loop_task,
        validation_loop_task,
        report_task,
    ],
    verbose=True,
    process="sequential",
