# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\04_session_state_persistence.py
#!/usr/bin/env python3
"""
...
def save_checkpoint() -> str:
    ...
    workflow.set_state(
        "checkpoint_number", workflow.get_state("checkpoint_number", 0) + 1
    )
...
print(
    f"Total customers processed: {workflow.get_state('total_customers_processed', 0)}"
)
