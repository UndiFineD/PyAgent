# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\03_conditional_task_execution.py
#!/usr/bin/env python3
"""
...
def reduce_costs() -> str:
    ...
    workflow.append_to_state(
        "actions_taken",
        {"action": "cost_reduction", "savings": savings, "new_spent": new_spent},
    )
...
def continue_development() -> str:
    ...
    workflow.append_to_state(
        "actions_taken",
        {"action": "continue_development", "features_added": new_features},
    )
