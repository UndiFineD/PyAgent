# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\02_state_in_tool_functions.py
#!/usr/bin/env python3
"""
...
def generate_report() -> str:
    ...
    if error_log:
        ...
        for error in error_log[-3:]:  # Last 3 errors
            report += (
                f"    - {error['type']}: {error['message']} at {error['timestamp']}\n"
            )
