# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\session-example.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    response1 = agent.chat(
        "Hi! I prefer brief, technical explanations. Please remember this."
    )
    ...
    print(
        "The agent maintained conversation context and user preferences across the session."
    )
