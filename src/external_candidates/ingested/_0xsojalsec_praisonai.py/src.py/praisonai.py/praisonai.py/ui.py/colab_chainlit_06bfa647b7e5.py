# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\praisonai\ui\colab_chainlit.py
import logging
import os
import sys
...
from praisonai.ui.colab import load_tools_from_tools_py, ui_run_praisonai
...
async def main(message: cl.Message):
    ...
    try:
        ...
        await cl.Message(
            content="Using Running PraisonAI Agents...", author="System"
        ).send()
...
if os.getenv("CHAINLIT_AUTH_SECRET"):
    ...
    def auth_callback(username: str, password: str) -> cl.User:
        ...
        ) and password == os.getenv("CHAINLIT_PASSWORD", "admin"):
