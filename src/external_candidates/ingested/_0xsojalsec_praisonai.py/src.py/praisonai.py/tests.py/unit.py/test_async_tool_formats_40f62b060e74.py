# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_async_tool_formats.py
#!/usr/bin/env python3
"""
...
def complex_tool(
    data: Dict[str, int], items: List[str], optional: Optional[str] = None
) -> Dict:
