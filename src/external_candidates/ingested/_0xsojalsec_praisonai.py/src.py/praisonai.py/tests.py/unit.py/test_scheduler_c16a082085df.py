# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_scheduler.py
#!/usr/bin/env python3
"""
...
def test_scheduler_creation():
    ...
    from praisonai.scheduler import DeploymentScheduler, create_scheduler
...
def test_config_file_parsing():
    ...
    config_data = {
        "deployment": {"schedule": "daily", "provider": "gcp", "max_retries": 5},
