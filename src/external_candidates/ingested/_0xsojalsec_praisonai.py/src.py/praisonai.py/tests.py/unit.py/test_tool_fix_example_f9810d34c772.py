# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_tool_fix_example.py
"""
...
def test_tool_usage():
    ...
    # Create workflow
    workflow = PraisonAIAgents(agents=[search_agent], tasks=[search_task], verbose=True)
