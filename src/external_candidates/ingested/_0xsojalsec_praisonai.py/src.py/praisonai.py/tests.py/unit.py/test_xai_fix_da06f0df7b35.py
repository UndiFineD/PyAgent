# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_xai_fix.py
#!/usr/bin/env python3
...
try:
    agent = Agent(instructions="You are a PhD-level mathematician.", llm="xai/grok-4")
