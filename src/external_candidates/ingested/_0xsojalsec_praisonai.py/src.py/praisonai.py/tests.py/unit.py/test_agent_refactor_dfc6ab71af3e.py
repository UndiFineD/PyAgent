# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_agent_refactor.py
#!/usr/bin/env python3
"""
...
class MockAgent:
    ...
    def _build_messages(
        self, prompt, temperature=0.2, output_json=None, output_pydantic=None
    ):
...
def test_format_tools():
    ...
    mixed_tools = ["string_tool", openai_tool, my_function]
    ...
    nested_tools = [[openai_tool, openai_tool], "another_tool"]
...
def test_backward_compatibility():
    ...
    test_cases = [
        ...
        (
            ...
            [
                "tool1",
                {"type": "function", "function": {"name": "t2", "description": "test"}},
            ],
            True,
        ),
    ]
