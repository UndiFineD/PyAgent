# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\integration\crewai\test_crewai_basic.py
"""
...
def mock_crewai_completion():
    ...
    mock_response.choices[0].message.content = (
        "Task completed successfully using CrewAI framework."
    )
...
"""
            ...
            try:
                ...
                praisonai = PraisonAI(agent_file=test_file, framework="crewai")
