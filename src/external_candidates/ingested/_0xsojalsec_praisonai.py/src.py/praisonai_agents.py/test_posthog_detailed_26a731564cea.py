# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_posthog_detailed.py
#!/usr/bin/env python3
"""
...
try:
    ...
    posthog_client.capture(
        ...
        properties={"test": True, "timestamp": time.time()},
    )
...
print("\n6. Debug information:")
print(
    f"  POSTHOG_AVAILABLE: {telemetry.logger.parent.manager.loggerDict.get('posthog', 'Not found')}"
)
