# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\mcp-sse-direct-client.py
...
async def main():
    if len(sys.argv) < 2:
        print(
            "Usage: python client.py <URL of SSE MCP server (i.e. http://localhost:8081/sse)>"
        )
        sys.exit(1)
