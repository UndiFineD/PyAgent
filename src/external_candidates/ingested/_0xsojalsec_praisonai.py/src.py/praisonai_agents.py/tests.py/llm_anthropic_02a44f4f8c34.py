# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\llm-anthropic.py
from praisonaiagents import Agent

agent = Agent(
    instructions="You are a Wikipedia Agent", llm="anthropic/claude-3-7-sonnet-20250219"
)
