# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\state_based_workflow_example.py
"""
...
def analyze_data_quality() -> Dict[str, Any]:
    ...
    return {
        ...
        "recommendation": (
            "clean_data" if has_errors or quality_score < 0.8 else "proceed"
        ),
    }
...
print(
    f"   Batches processed: {final_state.get('batch_current', 0)}/{final_state.get('batch_total', 0)}"
)
