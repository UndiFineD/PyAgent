# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\test_self_reflection_fix_simple.py
#!/usr/bin/env python3
...
def test_self_reflection_fix():
    ...
    try:
        response = agent.start(
            "What is 25 * 17? Show your work and double-check the answer."
        )
        print(f"\nResponse: {response}")
