# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\example_custom_tools.py
...
def wikipedia_search_tool(
    query: str, inspect: bool = False, max_chars: int = 4000, top_k: int = 3
):
    """
    ...
    w = WikipediaAPIWrapper(
        top_k_results=top_k, doc_content_chars_max=max_chars, lang="en"
    )
