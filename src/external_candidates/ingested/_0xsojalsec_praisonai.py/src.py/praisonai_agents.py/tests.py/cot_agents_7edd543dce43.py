# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\cot-agents.py
import os
...
""",
    ...
    task_type="decision",
    condition={"more": "generate_task", "done": "evaluate_total_questions"},
)
...
evaluate_total_questions_task = Task(
    ...
    condition={"more": "generate_task", "done": "generate_cot"},
)
...
agents = PraisonAIAgents(
    agents=[
        qa_generator,
        total_questions_evaluator,
        cot_generator,
        upload_to_huggingface,
    ],
    tasks=[
        generate_task,
        evaluate_total_questions_task,
        generate_cot_task,
        upload_to_huggingface_task,
    ],
    process="workflow",
    max_iter=30,
    verbose=False,
