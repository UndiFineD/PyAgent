# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\langchain_logs.py
...
def test_tools():
    ...
    wiki_fr = WikipediaAPIWrapper(lang="fr", top_k_results=1, doc_content_chars_max=300)
