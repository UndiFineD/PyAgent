# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\mcp-multiagents.py
import os
...
search_agent = Agent(
    ...
    llm="gpt-5-nano",
    tools=MCP(
        f'npx -y @smithery/cli@latest install @smithery-ai/brave-search --client claude --config "{{\\"braveApiKey\\":\\"{brave_api_key}\\"}}"'
    ),
)
