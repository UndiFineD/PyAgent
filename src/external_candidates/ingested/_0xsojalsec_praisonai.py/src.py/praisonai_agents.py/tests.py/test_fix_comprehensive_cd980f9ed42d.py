# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\test_fix_comprehensive.py
"""
...
print("=" * 60)
print(
    f"Gemini result contains '200': {'200' in str(result_gemini) if result_gemini else False}"
)
print(
    f"GPT-4 result contains '200': {'200' in str(result_gpt4) if result_gpt4 else False}"
)
