# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\tools_example.py
...
# Run agent
agents = PraisonAIAgents(agents=[news_agent], tasks=[news_task], process="sequential")
agents.start()
