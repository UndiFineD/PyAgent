# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\test_gemini_streaming_fix.py
#!/usr/bin/env python3
"""
...
def test_gemini_streaming_robustness():
    ...
    try:
        ...
        try:
            ...
            print(
                "🔄 This error should now be handled gracefully with fallback to non-streaming mode"
            )
            return False
        ...
        if chunk_count > 1:
            ...
            print(
                "⚠️  WARNING: Only received 1 chunk (may have fallen back to non-streaming)"
            )
