# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\multimodal.py
...
agents = PraisonAIAgents(
    agents=[vision_agent], tasks=[task1, task2, task3], process="sequential", verbose=1
)
