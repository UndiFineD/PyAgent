# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\knowledge-agents-task.py
import json
import logging
import os
...
knowledge_task = Task(
    ...
    context=[{"embedding_db_config": json.dumps(config["vector_store"])}],
)
