# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\orchestrator-workers.py
import time
...
router_task = Task(
    ...
    condition={"1": ["worker1_task"], "2": ["worker2_task"], "3": ["worker3_task"]},
)
