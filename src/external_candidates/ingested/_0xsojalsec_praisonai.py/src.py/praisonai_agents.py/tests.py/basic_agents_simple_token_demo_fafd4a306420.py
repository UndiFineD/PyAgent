# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\basic-agents-simple-token-demo.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    agents = PraisonAIAgents(agents=[question_agent], tasks=[answer_task], verbose=True)
