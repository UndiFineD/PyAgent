# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_debug_fixed.py
#!/usr/bin/env python3
import os
import sys
...
def test_debug_mode():
    ...
    try:
        ...
        return (
            not should_suppress
        )  # Should be False in debug mode (so we return True if it's correct)
