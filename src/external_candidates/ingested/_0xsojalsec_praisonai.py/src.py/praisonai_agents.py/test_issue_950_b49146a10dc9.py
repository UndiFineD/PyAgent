# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_issue_950.py
#!/usr/bin/env python3
"""
...
def test_issue_950_goal():
    ...
    try:
        ...
        from praisonai import PraisonAIAgents, Task
...
def test_package_name_case_sensitivity():
    ...
    try:
        ...
        print(
            "✅ SUCCESS: `from praisonai import Agent` works (lowercase package name)"
        )
        ...
        try:
            ...
            print(
                "✅ SUCCESS: `from PraisonAI import Agent` works (uppercase package name)"
            )
