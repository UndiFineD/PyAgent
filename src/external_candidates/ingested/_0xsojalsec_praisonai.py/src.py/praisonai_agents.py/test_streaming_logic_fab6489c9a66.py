# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_streaming_logic.py
#!/usr/bin/env python3
...
def test_streaming_logic():
    ...
    try:
        ...
        agent1 = Agent(instructions="You are a helpful assistant", llm="gpt-5-nano")
        ...
        agent2 = Agent(
            instructions="You are a helpful assistant", llm="gpt-5-nano", stream=False
        )
        ...
        agent3 = Agent(
            instructions="You are a helpful assistant", llm="gpt-5-nano", stream=True
        )
