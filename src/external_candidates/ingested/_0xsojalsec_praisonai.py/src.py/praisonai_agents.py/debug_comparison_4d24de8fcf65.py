# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\debug_comparison.py
#!/usr/bin/env python3
...
def test_agent_direct():
    ...
    try:
        ...
        print(
            f"✅ Agent using custom LLM: {getattr(agent, '_using_custom_llm', False)}"
        )
