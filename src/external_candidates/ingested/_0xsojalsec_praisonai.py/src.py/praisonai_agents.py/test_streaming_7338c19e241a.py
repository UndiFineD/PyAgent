# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_streaming.py
#!/usr/bin/env python3
"""
...
try:
    ...
    for chunk in agent.start(
        "Write a short paragraph about the benefits of real-time streaming in AI applications"
    ):
    ...
    if chunk_count > 1:
        ...
        print(
            "⚠️  WARNING: Only received 1 chunk - may still be using simulated streaming"
        )
