# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_performance_metrics.py
#!/usr/bin/env python3
"""
...
def test_performance_impact():
    ...
    try:
        ...
        if (
            hasattr(llm_with_metrics, "last_token_metrics")
            and llm_with_metrics.last_token_metrics
        ):
