# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\05_error_handling_monitoring.py
"""
    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                print(
                    f"💥 All {max_retries} attempts failed for operation {operation_id}"
                )
                raise
...
def main():
    ...
    for func_name, data in stats.items():
        ...
        error_rate = (
            data["error_count"] / data["call_count"] * 100
