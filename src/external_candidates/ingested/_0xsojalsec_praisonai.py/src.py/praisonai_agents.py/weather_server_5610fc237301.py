# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\weather_server.py
#!/usr/bin/env python
import datetime
import logging
...
def get_weather(location: Union[str, List[str]]) -> Dict:
    ...
    return {
        "error": "Invalid location format. Please provide a string or list of strings."
    }
