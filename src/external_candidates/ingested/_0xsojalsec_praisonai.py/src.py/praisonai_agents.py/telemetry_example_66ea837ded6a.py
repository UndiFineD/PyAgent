# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\telemetry_example.py
#!/usr/bin/env python3
"""
...
from praisonaiagents.telemetry import disable_telemetry, enable_telemetry, get_telemetry
