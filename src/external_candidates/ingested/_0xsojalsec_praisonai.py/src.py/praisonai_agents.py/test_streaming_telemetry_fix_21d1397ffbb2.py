# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_streaming_telemetry_fix.py
#!/usr/bin/env python3
"""
        ...
        try:
            ...
            if isinstance(result, types.GeneratorType):
                ...
                try:
                    ...
                    print(
                        "   This is normal - we're testing telemetry, not actual LLM calls"
                    )
...
def test_telemetry_integration():
    ...
    try:
        ...
        # Create agent
        agent = Agent(
            instructions="Test agent", llm="test/mock-model", stream=True, verbose=False
        )
