# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_telemetry_integration.py
#!/usr/bin/env python3
"""
...
workflow = PraisonAIAgents(agents=agents, tasks=tasks, process="sequential")
