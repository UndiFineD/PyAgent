...
if hasattr(agent, "execute"):
    ...
    print(
        f"Execute method name: {agent.execute.__name__ if hasattr(agent.execute, '__name__') else 'No name'}"
    )
    print(
...
if hasattr(workflow, "start"):
    ...
    print(
        f"Start method name: {workflow.start.__name__ if hasattr(workflow.start, '__name__') else 'No name'}"
    )
    print(
