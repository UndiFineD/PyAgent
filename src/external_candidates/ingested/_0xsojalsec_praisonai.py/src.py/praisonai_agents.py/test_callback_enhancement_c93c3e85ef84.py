# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_callback_enhancement.py
#!/usr/bin/env python3
...
def test_callback_enhancement():
    ...
    # Run the agents
    try:
        agents = PraisonAIAgents(agents=[agent], tasks=[task], verbose=True)
        result = agents.start()
