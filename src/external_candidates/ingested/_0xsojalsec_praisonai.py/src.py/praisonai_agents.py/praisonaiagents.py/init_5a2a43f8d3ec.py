# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\__init__.py
"""
...
from . import _logging, _warning_patch
...
if _telemetry_available:
    try:
        ...
        performance_mode = os.environ.get("PRAISONAI_PERFORMANCE_MODE", "").lower() in (
            "true",
            "1",
            "yes",
        )
        ...
        full_telemetry = os.environ.get("PRAISONAI_FULL_TELEMETRY", "").lower() in (
            "true",
            "1",
            "yes",
        )
        ...
        explicit_auto_instrument = os.environ.get(
            "PRAISONAI_AUTO_INSTRUMENT", ""
        ).lower() in ("true", "1", "yes")
        ...
        if not telemetry_disabled:
            ...
            if _telemetry and _telemetry.enabled:
                ...
                use_performance_mode = performance_mode and not (
                    full_telemetry or explicit_auto_instrument
                )
