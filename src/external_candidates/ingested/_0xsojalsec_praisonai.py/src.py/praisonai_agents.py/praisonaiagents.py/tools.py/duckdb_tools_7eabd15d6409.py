# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\duckdb_tools.py
...
class DuckDBTools:
            ...
            if not exists or if_exists == "replace":
                ...
                if schema:
                    ...
                    for col_name, col_type in schema.items():
                        ...
                        if not re.match(
                            r"^[A-Z][A-Z0-9_]*(\([0-9,]+\))?$", col_type.upper()
                        ):
    ...
    def export_csv(
        self, query: str, filepath: str, params: Optional[Union[tuple, dict]] = None
    ) -> bool:
