...
class XMLTools:
    ...
    def validate_xml(
        self, xml_file: str, schema_file: str
    ...
    def xml_to_dict(
        self, root: Union[str, ET.Element], preserve_attrs: bool = True
    ) -> Dict[str, Any]:
    ...
    def dict_to_xml(
        self, data: Dict[str, Any], root_tag: str = "root"
    ) -> Optional[ET.Element]:
...
<bookstore>
    ...
    <book category="non-fiction">
        ...
        print("XML structure:")
        print(
            minidom.parseString(ET.tostring(result, encoding="unicode")).toprettyxml(
                indent="  "
            )
        )
        print()
