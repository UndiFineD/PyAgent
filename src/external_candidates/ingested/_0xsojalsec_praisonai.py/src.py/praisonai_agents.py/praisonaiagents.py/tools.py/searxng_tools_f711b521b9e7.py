# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\searxng_tools.py
...
def searxng_search(
    query: str, max_results: int = 5, searxng_url: Optional[str] = None
) -> List[Dict]:
