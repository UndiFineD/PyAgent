# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\pandas_tools.py
...
class PandasTools:
    ...
    def _check_pandas(self):
        ...
        if util.find_spec("pandas") is None:
            raise ImportError(
                "pandas is not available. Please install it using: pip install pandas"
            )
        global pd, np
        import numpy as np
        import pandas as pd
