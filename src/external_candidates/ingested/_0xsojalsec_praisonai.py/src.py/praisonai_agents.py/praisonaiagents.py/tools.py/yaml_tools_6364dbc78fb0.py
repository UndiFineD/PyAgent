...
class YAMLTools:
    ...
    def validate_yaml(
        self, data: Union[Dict[str, Any], List[Any], str], schema: Dict[str, Any]
    ) -> bool:
    ...
    def analyze_yaml(
        ...
        try:
            ...
            result = {
                ...
                "stats": {
                    "total_keys": (
                        sum(1 for _ in self._walk_dict(data))
                        if isinstance(data, dict)
                        else len(data)
                    )
                },
            ...
            for op in operations:
                ...
                if parts:
                    ...
                    if isinstance(target, dict):
                        ...
                        elif op_type == "append" and isinstance(
                            target.get(last_part), list
                        ):
