# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_import_debug2.py
#!/usr/bin/env python3
import os
import sys
...
try:
    ...
    print(
        f"✓ Direct import from praisonai.praisonai works: PraisonAI={PraisonAI}, __version__={__version__}"
    )
except Exception as e:
