...
def test_stream_parameter():
    ...
    response1 = agent.chat(
        "Tell me a very short fact about Python in one sentence.", stream=False
    )
    ...
    response2 = agent.chat(
        "Tell me another very short fact about Python in one sentence.", stream=True
    )
    ...
    response3 = agent2.chat(
        "Tell me a very short fact about JavaScript in one sentence.", stream=True
    )
