# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_streaming_fix.py
#!/usr/bin/env python3
...
def test_backward_compatibility():
    ...
    print(
        f"Type of result with agent.stream=True but start(stream=False): {type(result2)}"
    )
