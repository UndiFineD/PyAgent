# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\mongodb_memory_basic.py
import pymongo
...
context_output = context_agent.start(
    "https://github.com/MervinPraison/PraisonAI/ Need to add Authentication"
)
...
try:
    ...
    client = pymongo.MongoClient(
        "mongodb+srv://username:password@cluster2.bofm7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster2"
    )
