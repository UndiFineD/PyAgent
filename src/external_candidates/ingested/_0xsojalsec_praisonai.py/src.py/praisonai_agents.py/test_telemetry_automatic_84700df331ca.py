# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_telemetry_automatic.py
#!/usr/bin/env python3
"""
...
# Create a task
task = Task(description="Calculate 5 + 5", expected_output="The sum", agent=agent)
