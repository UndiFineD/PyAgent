# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\debug_telemetry_double.py
#!/usr/bin/env python3
"""
...
task = Task(description="Single test task", expected_output="Test output", agent=agent)
...
print(
    f"  Agent executions: {metrics_after['metrics']['agent_executions']} (expected: 1)"
)
print(
    f"  Task completions: {metrics_after['metrics']['task_completions']} (expected: 1)"
)
