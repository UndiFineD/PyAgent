# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_agent_guardrails.py
#!/usr/bin/env python3
"""
...
def test_agent_guardrails():
    ...
    try:
        ...
        agent3 = Agent(name="TestAgent3", instructions="You are a test agent")
