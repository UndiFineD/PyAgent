...
def MyParser():
    ...
    parser.add_argument(
        "--val_max_num_tokens", type=int, default=None, help="FOR validation"
    )
    parser.add_argument(
        "--num_buckets",
        type=int,
    ...
    # path
    parser.add_argument(
        "--exp_dir", type=str, default=None, help="will be combined with dataset name"
    )
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument(
        "--manifest_name", type=str, default="manifest", help="metadata filename"
    )
    ...
    parser.add_argument(
        "--text_max_length", type=int, default=400, help="if too long, we crop or drop"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--mask_len_min", type=int, default=1, help="Minimum mask length"
    )
    parser.add_argument(
        "--mask_len_max", type=int, default=600, help="Maximum mask length"
    )
    parser.add_argument(
        "--eos",
        type=int,
    ...
    parser.add_argument(
        "--n_special", type=int, default=3, help="empty, eog, pad, (eos)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--text_vocab_size", type=int, default=100, help="Size of text vocabulary"
    )
    parser.add_argument(
        "--text_pad_token",
        type=int,
    ...
    parser.add_argument(
        "--audio_vocab_size", type=str, default="2048", help="Size of audio vocabulary"
    )
    parser.add_argument(
        "--empty_token",
        default=2048,
    ...
    parser.add_argument(
        "--num_decoder_layers", type=int, default=16, help="Number of decoder layers"
    )
    parser.add_argument(
        "--load_model_from",
        type=str,
