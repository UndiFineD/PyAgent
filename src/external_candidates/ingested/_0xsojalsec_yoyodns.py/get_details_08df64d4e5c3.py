# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-yoyoDNS\get_details.py
#!/usr/bin/env python3
...
def main():
    ...
    for entry in res.fetchall():
        ...
        to_update = "UPDATE queries SET query_asn = '{}', query_as_name = '{}', query_location = '{}' WHERE uuid == '{}' AND ip_address = '{}'".format(
            asn, as_name, location, entry[0], ip_address
        )
        print(to_update)
