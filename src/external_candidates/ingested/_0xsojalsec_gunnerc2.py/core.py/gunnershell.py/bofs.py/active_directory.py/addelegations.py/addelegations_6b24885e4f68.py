# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\bofs\Active_Directory\addelegations\addelegations.py
...
"""
    ...
    def args_inject(p):
        ...
        p.add_argument(
            ...
            action="store_true",
            default=False,
            help="Only unconstrained delegation",
        )
        p.add_argument(
            "--constrained",
            action="store_true",
            default=False,
            help="Only constrained / protocol transition",
        )
        p.add_argument(
            "--rbcd",
            action="store_true",
            default=False,
            help="Only resource-based constrained delegation (RBCD)",
        )
        p.add_argument(
            "--users-only", action="store_true", default=False, help="Users only"
        )
        p.add_argument(
            "--computers-only",
            action="store_true",
        ...
        p.add_argument(
            ...
            "--filter",
            default="",
            help="Custom LDAP filter (if set, used verbatim)",
        )
