# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\bofs\Active_Directory\adgroups\adgroups.py
# Register: adgroups
import argparse
...
def _is_ip(s: str) -> bool:
    ...
    if len(parts) == 4:
        try:
            return all(
                0 <= int(p) <= 255 and (p == "0" or not p.startswith("0") or p == "0")
                for p in parts
            )
        except ValueError:
            pass
...
class AdGroupsBof(Bof):
    base64bof: str = (
        ""
    )
    x86base64bof: str = (
        ""
    )
...
"""
    ...
    def args_inject(p):
        ...
        p.add_argument(
            "--group",
            default="*",
            help="Group name (sAMAccountName or CN), or '*' for all",
        )
        p.add_argument(
            "--names", action="store_true", default=False, help="List only group names"
        )
        p.add_argument(
            "--basedn", default="", help="Base DN (default: from --domain or RootDSE)"
        )
        p.add_argument(
            "--filter", default="", help="Custom LDAP filter (default: group filter)"
        )
        p.add_argument(
            "-a",
            "--attributes",
