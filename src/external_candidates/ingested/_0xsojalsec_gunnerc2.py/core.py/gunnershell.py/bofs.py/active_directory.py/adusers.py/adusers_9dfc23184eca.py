...
"""
    ...
    def args_inject(p):
        ...
        p.add_argument(
            "--filter", default="", help="LDAP filter (wide). Default: user filter"
        )
        p.add_argument(
            "-a",
            "--attributes",
        ...
        p.add_argument(
            "--user", default="", help="Simple bind user (UPN/DN); omit for Negotiate"
        )
