# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\filesystem\delete.py
    ...
    def logic(self, sid, os_type, path, op_id="console"):
        ...
        if transport in ("http", "https"):
            ...
            out = tcp_exec.run_command_tcp(
                sid, cmd, timeout=1.3, portscan_active=True, op_id=op_id
            )
