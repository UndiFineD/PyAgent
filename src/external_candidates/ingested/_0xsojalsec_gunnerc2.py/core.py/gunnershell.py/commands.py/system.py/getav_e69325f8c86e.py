# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\system\getav.py
import base64
...
"""
        ...
        if transport in ("http", "https"):
            ...
            out = tcp_exec.run_command_tcp(
                sid, ps, timeout=0.5, portscan_active=True, op_id=op_id
            )
