# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\system\resume.py
...
class ResumeCommand(Command):
    ...
    def execute(self, args):
        ...
        print(
            brightgreen + out if out else brightred + f"[!] Failed to resume {args[0]}"
        )
    ...
    def logic(self, sid, os_type, pid, op_id="console"):
        ...
        if sess.transport.lower() in ("http", "https"):
            ...
            out = tcp_exec.run_command_tcp(
                sid, ps_cmd, timeout=2.0, portscan_active=True, op_id=op_id
            )
