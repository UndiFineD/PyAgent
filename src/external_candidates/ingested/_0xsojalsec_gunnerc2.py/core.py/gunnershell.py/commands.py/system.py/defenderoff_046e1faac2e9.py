# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\system\defenderoff.py
import base64
...
"""
        ...
        if transport in ("http", "https"):
            ...
            out = tcp_exec.run_command_tcp(
                sid, ps_cmd, timeout=1.0, portscan_active=True, op_id=op_id
            )
