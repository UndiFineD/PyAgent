# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getdelegation.py
import argparse
import base64
import os
import sys
...
"""
        ...
        if out:
            if "Failed to resolve DC!" in out:
                ...
                return (
                    brightred + "[!] No constrained or unconstrained delegation found!"
                )
