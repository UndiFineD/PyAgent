# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\system\clearev.py
    ...
    def logic(self, sid, os_type, force=False, op_id="console"):
        ...
        if sess.transport.lower() in ("http", "https"):
            ...
            out = tcp_exec.run_command_tcp(
                sid, ps_cmd, timeout=3, portscan_active=True, op_id=op_id
            )
