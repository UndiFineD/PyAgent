# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getadmins.py
import argparse
import base64
import os
import sys
...
class GetAdminsCommand(Command):
    ...
    def execute(self, args):
        ...
        out = self.logic(
            sid=self.gs.sid, domain=opts.domain, dc_ip=opts.dc_ip, op_id=self.op_id
        )
...
"""
        ...
        one_liner = (
            '$ps=[System.Text.Encoding]::Unicode.GetString([Convert]::FromBase64String("'
            + b64
            + '"));'
