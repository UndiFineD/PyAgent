# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\kerbrute_userenum.py
import argparse
import base64
import os
import sys
...
class KerbruteUserenumCommand(Command):
    ...
    def help(self):
        return (
            "kerbrute userenum -u <user|userfile|user1,user2> "
            "-d <domain> --dc-ip <ip>"
        )
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="user",
            required=True,
            help="Single user, file, or comma-list of users",
        )
        parser.add_argument(
