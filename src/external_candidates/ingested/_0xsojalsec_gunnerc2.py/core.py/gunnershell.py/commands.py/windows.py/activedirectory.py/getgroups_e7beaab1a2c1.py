# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getgroups.py
import argparse
import base64
import os
import sys
...
class GetGroupsCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            "-g", "--group", dest="group", required=False, help="AD Group to enumerate"
        )
        parser.add_argument(
            "-m",
            "--members",
            action="store_true",
            dest="members",
            help="List members of the group (requires -g)",
        )
        parser.add_argument(
            "-d",
            "--domain",
    ...
    def logic(
        self, sid, group=None, domain=None, dc_ip=None, members=None, op_id="console"
    ):
        """
