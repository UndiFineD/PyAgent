# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getous.py
import argparse
import base64
import os
import sys
...
class GetOUsCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="ou",
            required=False,
            help="OU name to fetch AD properties for",
        )
        parser.add_argument(
            "-d",
            "--domain",
