# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\linux\filesystem\cp.py
import shlex
...
def _run(sid, cmd, op_id="console"):
    ...
    if transport in ("tcp", "tls"):
        return tcp_exec.run_command_tcp(
            sid, cmd, timeout=1.2, portscan_active=False, op_id=op_id
        )
