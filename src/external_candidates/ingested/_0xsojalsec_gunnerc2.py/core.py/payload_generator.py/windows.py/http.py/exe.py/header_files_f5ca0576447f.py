# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\payload_generator\windows\http\exe\header_files.py
typedef = f"""
...
#define PRINTA(STR, ...) \\
    do {{                                      \\
        LPSTR buf = (LPSTR)HeapAlloc(          \\
            GetProcessHeap(), HEAP_ZERO_MEMORY, 1024); \\
        if (buf) {{                            \\
