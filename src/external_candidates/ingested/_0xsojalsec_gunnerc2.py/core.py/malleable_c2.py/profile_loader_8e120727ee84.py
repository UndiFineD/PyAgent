# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\malleable_c2\profile_loader.py
import logging
...
def load_profile(
    ...
    mapping = out.get(
        "mapping",
        {"cmd": "{{payload}}", "DeviceTelemetry": {"Telemetry": "{{payload}}"}},
    )
