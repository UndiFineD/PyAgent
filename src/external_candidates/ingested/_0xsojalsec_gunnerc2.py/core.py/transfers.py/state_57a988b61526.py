# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\transfers\state.py
import logging
        ...
        with self.lock_for(st.tid):
            ...
            try:
                ...
                if getattr(e, "errno", None) == errno.EXDEV:
                    with (
                        open(st.tmp_local_path, "rb") as src,
                        tempfile.NamedTemporaryFile(dir=final_dir, delete=False) as dst,
                    ):
