...
class MCPTools(Toolkit):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.server_params: Optional[Union[StdioServerParameters, SSEClientParams]] = (
            server_params
        )
    ...
    def __init__(
        ...
        *,
        ...
        server_params_list: Optional[
            List[Union[SSEClientParams, StdioServerParameters]]
        ] = None,
        timeout_seconds: int = 5,
        client=None,
        include_tools: Optional[list[str]] = None,
        ...
        **kwargs,
        ...
        self.server_params_list: List[Union[SSEClientParams, StdioServerParameters]] = (
