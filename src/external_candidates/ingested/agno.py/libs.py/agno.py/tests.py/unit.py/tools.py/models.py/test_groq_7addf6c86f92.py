...
def mock_groq_client():
    ...
    with patch("agno.tools.models.groq.GroqClient") as mock_client_constructor:
        ...
        mock_client_instance.audio.translations.create.return_value = (
...
def test_transcribe_audio_error_url(
    mock_exists, mock_toolkit_init, mock_transcribe_create
):
...
def test_translate_audio_error_url(
    mock_exists, mock_toolkit_init, mock_translate_create
):
