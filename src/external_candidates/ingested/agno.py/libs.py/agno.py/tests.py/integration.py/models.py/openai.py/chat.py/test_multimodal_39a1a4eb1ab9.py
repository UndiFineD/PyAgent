# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\tests\integration\models\openai\chat\test_multimodal.py
...
def test_audio_tokens():
    ...
    assert (
        ...
        and input_audio_tokens is not None
        and output_audio_tokens is not None
    )
