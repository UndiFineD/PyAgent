# Extracted from: C:\DEV\PyAgent\.external\agno\libs\infra\agno_docker\agno\docker\app\base.py
...
class DockerApp(InfraApp):
    ...
    def get_container_volumes(
        ...
        if self.mount_agno_config:
            ...
            agno_config_container_path = (
                f"{self.workspace_dir_container_path}/.config/ag"
            )
