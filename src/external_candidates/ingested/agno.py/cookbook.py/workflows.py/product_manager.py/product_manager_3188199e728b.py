# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\workflows\product_manager\product_manager.py
import os
...
class ProductManagerWorkflow(Workflow):
    description: str = (
        "Generate linear tasks and send slack notifications to the team from meeting notes."
    )
