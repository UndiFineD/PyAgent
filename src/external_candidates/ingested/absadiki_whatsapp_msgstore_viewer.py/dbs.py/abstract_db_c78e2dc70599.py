# Extracted from: C:\DEV\PyAgent\.external\absadiki-whatsapp-msgstore-viewer\dbs\abstract_db.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
...
class AbstractDatabase(ABC):
    ...
    def __init__(self, msgstore, wa=None, schema=None):
        ...
        self.contacts = None
        self.schema: dict = (
            schema  # a simple map between the (tables, attributes) used in the code and their real
        )
    ...
    def check_database_schema(self):
        ...
        for table in self.schema:
            ...
            self.msgstore_cursor.execute(
                sql_query
            ).fetchone()  # this will fail if the table or the attributes do not
            # exist
