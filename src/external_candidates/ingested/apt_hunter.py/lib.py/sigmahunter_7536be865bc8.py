# Extracted from: C:\DEV\PyAgent\.external\APT-Hunter\lib\SigmaHunter.py
import glob
import json
...
mapping = {
    ...
    "ProcessID": [
        ...
        "Event_UserData_Operation_TemporaryEssStarted_Processid",
        "Event_EventData_processId",
    ],
    "ThreadID": ["Event_System_Execution_#attributes_ThreadID"],
    "Keywords": ["Event_System_Keywords"],
    ...
    "Name": [
        ...
        "Event_System_Provider_#attributes_Name",
    ...
    "Status": [
        "Event_UserData_ChangingDefaultPrinter_Status",
        "Event_EventData_Status",
        "Event_UserData_EventData_Status",
    ],
    "ActivityID": [
        "Event_System_Correlation_#attributes_ActivityID",
        "Event_EventData_ActivityId",
    ],
    "Context": [
        "Event_UserData_LoadPluginFailed_Context",
        "Event_UserData_CertNotificationData_#attributes_Context",
    ],
    "ErrorCode": [
        "Event_UserData_LoadPluginFailed_ErrorCode",
        "Event_EventData_ErrorCode",
        "Event_UserData_CbsUpdateChangeState_ErrorCode",
        "Event_UserData_CbsPackageChangeState_ErrorCode",
        "Event_ProcessingErrorData_ErrorCode",
        "Event_EventData_errorCode",
    ],
    "AppId": ["Event_EventData_AppId", "Event_EventData_AppID"],
    "DCName": ["Event_EventData_DCName"],
    "Binary": ["Event_EventData_Binary"],
    "Qualifiers": ["Event_System_EventID_#attributes_Qualifiers"],
    "Security": ["Event_System_Security"],
    "Path": ["Event_EventData_Path"],
    "ScriptBlockText": ["Event_EventData_ScriptBlockText"],
    "param1": [
        "Event_EventData_param1",
        "Event_UserData_EventXML_Param1",
        "Event_EventData_Param1",
    ],
    "param2": [
        "Event_EventData_param2",
        "Event_UserData_EventXML_Param2",
        "Event_EventData_Param2",
    ],
    "ContextInfo": ["Event_EventData_ContextInfo"],
    "Payload": ["Event_EventData_Payload"],
    "UserData": ["Event_EventData_UserData"],
    "State": ["Event_EventData_State"],
    "EventType": ["Event_UserData_InvalidCommitLimitExhaustion_EventType"],
    "AccountName": [
        "Event_UserData_CertNotificationData_#attributes_AccountName",
        "Event_EventData_AccountName",
    ],
    "ProcessName": [
        "Event_UserData_CertNotificationData_#attributes_ProcessName",
        "Event_EventData_ProcessName",
    ],
    "LogonType": ["Event_EventData_LogonType"],
    "TaskName": ["Event_EventData_TaskName"],
    "Message": [
        "Event_EventData_message",
        "Event_RenderingInfo_Message",
        "Event_EventData_Message",
    ],
    "Provider": ["Event_RenderingInfo_Provider"],
    "updateGuid": ["Event_EventData_updateGuid"],
    ...
    "PossibleCause": [
        "Event_UserData_Operation_ClientFailure_PossibleCause",
        "Event_UserData_Operation_TemporaryEssStarted_PossibleCause",
    ],
    "User": [
        "Event_UserData_Operation_ClientFailure_User",
        "Event_UserData_Operation_TemporaryEssStarted_User",
        "Event_EventData_User",
    ...
    "Origin": ["Event_EventData_Origin"],
    "Protocol": ["Event_EventData_Protocol", "Event_EventData_protocol"],
    "RuleName": ["Event_EventData_RuleName"],
    "SchemaVersion": ["Event_EventData_SchemaVersion"],
    "ServiceName": ["Event_EventData_ServiceName"],
    "Filename": [
        "Event_EventData_Filename",
        "Event_UserData_EventData_FileName",
        "Event_EventData_FileName",
    ],
    "PackagePath": ["Event_EventData_PackagePath"],
    "FileNameBuffer": ["Event_EventData_FileNameBuffer"],
    "UserName": [
        "Event_UserData_EventData_UserName",
    ...
    "NewTime": ["Event_EventData_NewTime"],
    "OldTime": ["Event_EventData_OldTime"],
    "HiveName": ["Event_EventData_HiveName"],
    "ErrorDescription": ["Event_EventData_ErrorDescription"],
    "Address": ["Event_EventData_Address", "Event_UserData_EventXML_Address"],
    "AddressLength": ["Event_EventData_AddressLength"],
    "QueryName": ["Event_EventData_QueryName"],
    "TSId": ["Event_EventData_TSId"],
    "UserSid": [
        "Event_EventData_UserSid",
        "Event_UserData_EventXML_UserSid",
        "Event_EventData_UserSID",
    ],
    ...
    "FinalStatus": ["Event_EventData_FinalStatus"],
    "ImagePath": ["Event_EventData_ImagePath"],
    "ServiceType": ["Event_EventData_ServiceType"],
    "StartType": ["Event_EventData_StartType"],
    "ExtensionId": ["Event_EventData_ExtensionId"],
    "ExtensionName": ["Event_EventData_ExtensionName"],
    "ShutdownActionType": ["Event_EventData_ShutdownActionType"],
    "ShutdownEventCode": ["Event_EventData_ShutdownEventCode"],
    "ShutdownReason": ["Event_EventData_ShutdownReason"],
    "Group": ["Event_EventData_Group"],
    "IdleStateCount": ["Event_EventData_IdleStateCount"],
    "Number": ["Event_EventData_Number", "Event_EventData_number"],
    "BootMode": ["Event_EventData_BootMode"],
    "BuildVersion": ["Event_EventData_BuildVersion"],
    "MajorVersion": ["Event_EventData_MajorVersion"],
    "MinorVersion": ["Event_EventData_MinorVersion"],
    "QfeVersion": ["Event_EventData_QfeVersion"],
    "ServiceVersion": ["Event_EventData_ServiceVersion"],
    "StartTime": [
        "Event_EventData_StartTime",
        "Event_UserData_CompatibilityFixEvent_StartTime",
    ],
    "StopTime": ["Event_EventData_StopTime"],
    "TimeSource": ["Event_EventData_TimeSource"],
    "Targetname": ["Event_EventData_Targetname"],
    "Caption": ["Event_EventData_Caption"],
    "ErrorMessage": ["Event_EventData_ErrorMessage"],
    "RetryMinutes": ["Event_EventData_RetryMinutes"],
    "Description": ["Event_EventData_Description"],
    "Type": ["Event_EventData_Type"],
    "OperationType": ["Event_EventData_OperationType"],
    "CommandLine": ["Event_EventData_CommandLine"],
    "PackageName": ["Event_EventData_PackageName"],
    "Data": ["Event_EventData_Data", "Event_EventData_Data_#text"],
    "LogonId": ["Event_EventData_LogonId"],
    "ServerName": ["Event_EventData_ServerName", "Event_EventData_serverName"],
    "ObjectName": ["Event_EventData_ObjectName"],
    "AccessList": ["Event_EventData_AccessList"],
    "AccessMask": ["Event_EventData_AccessMask"],
    "HandleId": ["Event_EventData_HandleId"],
    "ObjectServer": ["Event_EventData_ObjectServer"],
    "ObjectType": ["Event_EventData_ObjectType"],
    ...
    "SubjectUserSid": ["Event_EventData_SubjectUserSid"],
    "NewProcessId": ["Event_EventData_NewProcessId"],
    ...
    "TargetLogonId": ["Event_EventData_TargetLogonId"],
    "TargetUserName": ["Event_EventData_TargetUserName"],
    "TargetUserSid": ["Event_EventData_TargetUserSid"],
    "TokenElevationType": ["Event_EventData_TokenElevationType"],
    "NewValue": ["Event_EventData_NewValue"],
    "ObjectValueName": ["Event_EventData_ObjectValueName"],
    "OldValue": ["Event_EventData_OldValue"],
    "Properties": ["Event_EventData_Properties"],
    "PrivilegeList": ["Event_EventData_PrivilegeList"],
    "Service": ["Event_EventData_Service"],
    "AuthenticationPackageName": ["Event_EventData_AuthenticationPackageName"],
    "ImpersonationLevel": ["Event_EventData_ImpersonationLevel"],
    "IpPort": ["Event_EventData_IpPort"],
    "KeyLength": ["Event_EventData_KeyLength"],
    "LmPackageName": ["Event_EventData_LmPackageName"],
    "LogonGuid": ["Event_EventData_LogonGuid"],
    "LogonProcessName": ["Event_EventData_LogonProcessName"],
    "TransmittedServices": ["Event_EventData_TransmittedServices"],
    "WorkstationName": ["Event_EventData_WorkstationName"],
    "CallerProcessName": ["Event_EventData_CallerProcessName"],
    "TargetSid": ["Event_EventData_TargetSid"],
    ...
    "TransactionId": ["Event_EventData_TransactionId"],
    "TargetInfo": ["Event_EventData_TargetInfo"],
    "TargetLogonGuid": ["Event_EventData_TargetLogonGuid"],
    "TargetServerName": ["Event_EventData_TargetServerName"],
    "Details": ["Event_EventData_Details"],
    "PackageFullName": ["Event_EventData_PackageFullName"],
    "processPath": ["Event_EventData_processPath"],
    "Provider_Name": ["Event_System_Provider_#attributes_Name"],
    "Accesses": ["Event_EventData_Accesses"],
    "AccountDomain": ["Event_EventData_AccountDomain"],
    "AccountExpires": ["Event_EventData_AccountExpires"],
    ...
    "CallingProcessName": ["Event_EventData_CallingProcessName"],
    "CallTrace": ["Event_EventData_CallTrace"],
    "Company": ["Event_EventData_Company"],
    "CreationUtcTime": ["Event_EventData_CreationUtcTime"],
    ...
    "DestinationPortName": ["Event_EventData_DestinationPortName"],
    "DestPort": ["Event_EventData_DestPort"],
    "Detail": ["Event_EventData_Detail"],
    "DetectionSource": ["Event_EventData_DetectionSource"],
    "DeviceClassName": ["Event_EventData_DeviceClassName"],
    "DeviceDescription": ["Event_EventData_DeviceDescription"],
    "DisplayName": ["Event_EventData_DisplayName"],
    "EngineVersion": ["Event_EventData_EngineVersion"],
    "EventSourceId": ["Event_EventData_EventSourceId"],
    "ExtraInfo": ["Event_EventData_ExtraInfo"],
    "FailureCode": ["Event_EventData_FailureCode"],
    "FailureReason": ["Event_EventData_FailureReason"],
    "FileVersion": ["Event_EventData_FileVersion"],
    "FilterHostProcessID": ["Event_EventData_FilterHostProcessID"],
    "GrantedAccess": ["Event_EventData_GrantedAccess"],
    "GroupDomain": ["Event_EventData_GroupDomain"],
    "GroupName": ["Event_EventData_GroupName"],
    "GroupSid": ["Event_EventData_GroupSid"],
    "Hash": ["Event_EventData_Hash"],
    "Hashes": ["Event_EventData_Hashes"],
    "HomeDirectory": ["Event_EventData_HomeDirectory"],
    "HomePath": ["Event_EventData_HomePath"],
    "HostApplication": ["Event_EventData_HostApplication"],
    "HostVersion": ["Event_EventData_HostVersion"],
    "Image": ["Event_EventData_Image"],
    "ImageLoaded": ["Event_EventData_ImageLoaded"],
    "Initiated": ["Event_EventData_Initiated"],
    "IntegrityLevel": ["Event_EventData_IntegrityLevel"],
    "LayerRTID": ["Event_EventData_LayerRTID"],
    "LDAPDisplayName": ["Event_EventData_LDAPDisplayName"],
    "LogonHours": ["Event_EventData_LogonHours"],
    "NewName": ["Event_EventData_NewName"],
    "NewThreadId": ["Event_EventData_NewThreadId"],
    "NewUacValue": ["Event_EventData_NewUacValue"],
    "NotificationPackageName": ["Event_EventData_NotificationPackageName"],
    "ObjectClass": ["Event_EventData_ObjectClass"],
    "OldUacValue": ["Event_EventData_OldUacValue"],
    ...
    "PerfStateCount": ["Event_EventData_PerfStateCount"],
    "PipeName": ["Event_EventData_PipeName"],
    "PreviousTime": ["Event_EventData_PreviousTime"],
    "PrimaryGroupId": ["Event_EventData_PrimaryGroupId"],
    "ProcessCommandLine": ["Event_EventData_ProcessCommandLine"],
    "ProcessGuid": ["Event_EventData_ProcessGuid"],
    "Product": ["Event_EventData_Product"],
    "ProfilePath": ["Event_EventData_ProfilePath"],
    "ProtocolHostProcessID": ["Event_EventData_ProtocolHostProcessID"],
    "PuaCount": ["Event_EventData_PuaCount"],
    "PuaPolicyId": ["Event_EventData_PuaPolicyId"],
    "Publisher": ["Event_EventData_Publisher"],
    "QueryResults": ["Event_EventData_QueryResults"],
    ...
    "SAMAccountName": ["Event_EventData_SamAccountName"],
    "ScriptPath": ["Event_EventData_ScriptPath"],
    "SecurityPackageName": ["Event_EventData_SecurityPackageName"],
    "ServerID": ["Event_EventData_ServerID"],
    "ServerURL": ["Event_EventData_ServerURL"],
    "ServicePrincipalNames": ["Event_EventData_ServicePrincipalNames"],
    "ShareLocalPath": ["Event_EventData_ShareLocalPath"],
    "SidHistory": ["Event_EventData_SidHistory"],
    "Signature": ["Event_EventData_Signature"],
    "SignatureStatus": ["Event_EventData_SignatureStatus"],
    "Signed": ["Event_EventData_Signed"],
    "SourceAddress": ["Event_EventData_SourceAddress"],
    "SourceHostname": ["Event_EventData_SourceHostname"],
    "SourceImage": ["Event_EventData_SourceImage"],
    "SourceIp": ["Event_EventData_SourceIp"],
    "SourceNetworkAddress": ["Event_EventData_SourceNetworkAddress"],
    "SourceIsIpv6": ["Event_EventData_SourceIsIpv6"],
    "SourcePort": ["Event_EventData_SourcePort"],
    "SourcePortName": ["Event_EventData_SourcePortName"],
    "SourceProcessGuid": ["Event_EventData_SourceProcessGuid"],
    "StartAddress": ["Event_EventData_StartAddress"],
    "StartFunction": ["Event_EventData_StartFunction"],
    "StartModule": ["Event_EventData_StartModule"],
    "SubStatus": ["Event_EventData_SubStatus"],
    "TargetFileName": ["Event_EventData_TargetFilename"],
    "TargetImage": ["Event_EventData_TargetImage"],
    ...
    "UserWorkstations": ["Event_EventData_UserWorkstations"],
    "UtcTime": ["Event_EventData_UtcTime"],
...
def search_db(query, DB):
    ...
    try:
        ...
        cursor.execute(
            query.replace("Imphash", "Hashes")
            .replace("sha1", "Hashes")
            .replace("md5", "Hashes")
            .replace("sha256", "Hashes")
            .replace("*", "Original_Event_Log,SystemTime")
        )
...
def optimised_parse_mp(file):
    ...
    mapping = {
        ...
        "UserID": [
            "Event_System_Security_#attributes_UserID",
            "Event_EventData_UserId",
        ],
        "Task": [
            "Event_System_Task",
            "Event_EventData_Task",
            "Event_RenderingInfo_Task",
        ],
        "SystemTime": ["Event_System_TimeCreated_#attributes_SystemTime"],
        "Version": [
            "Event_System_Version",
        ...
        "value": ["Event_EventData_value", "Event_EventData_Value"],
        "Action": [
            "Event_EventData_Action",
            "Event_UserData_CertNotificationData_Action",
        ],
        "ApplicationPath": ["Event_EventData_ApplicationPath"],
        "ModifyingApplication": ["Event_EventData_ModifyingApplication"],
        "Origin": ["Event_EventData_Origin"],
        ...
        "ShareName": [
            "Event_UserData_EventData_ShareName",
            "Event_EventData_ShareName",
        ],
        "NewState": ["Event_EventData_NewState"],
        "Param3": ["Event_UserData_EventXML_Param3", "Event_EventData_param3"],
        "EventSourceName": ["Event_System_Provider_#attributes_EventSourceName"],
        ...
        "ProcessingMode": ["Event_EventData_ProcessingMode"],
        "ProcessingTimeInMilliseconds": [
            "Event_EventData_ProcessingTimeInMilliseconds"
        ],
        "HostName": ["Event_EventData_HostName"],
        "Ipaddress": ["Event_EventData_Ipaddress", "Event_EventData_IpAddress"],
        "NewTime": ["Event_EventData_NewTime"],
...
def Sigma_Analyze(Path, rules, output, DBName="Events.sqlite"):
    ...
    pool = multiprocessing.Pool(
        multiprocessing.cpu_count(), initializer=init, initargs=(l,)
    )
    ...
    toc_end = time.time()
    print(
        "Analysis results availble as CSV file with Name "
        + output
        + "_"
        + "Detections.csv"
    )
    print(
        "Analysis results availble as Excel file with statistics as "
        + output
        + "_"
        + "Detections.xlsx"
    )
