# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\config_parsers\config_client.py
import logging
import os
import sys
...
class ConfigProvider(object):
    ...
    def convert_yml_to_obj(yml_file_path):
        ...
        try:
            ...
            logging.error(
                "(convert_yml_to_obj) Error in reading yml file: {}, Reason: {}".format(
                    yml_file_path, e
                )
            )
            sys.exit(0)
