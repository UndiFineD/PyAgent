# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\modules\scan\Corsy.py
import json
            ...
            if "_id" in every_asset:
                ...
                for active_hosts in every_asset["active_hosts"][0]:
                    ...
                    command = self.base_command.format(
                        input_domain=active_hosts, output_file_path=outfile
                    )
    ...
    def parse_report(self, outfile):
        ...
        if report_dict:
            for key, value in report_dict.items():
                ...
                finding_dict["description"] = value.get("description") + value.get(
                    "exploitation"
                )
