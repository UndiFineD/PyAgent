# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\modules\secretscanner\submodules\secret_finder.py
import json
import logging
import os
import re
...
class SecretFinder:
    ...
    async def find_secrets_and_urls(self):
        ...
        if len(finding_dict_list):
            ...
            await CrudUtils.insert_findings(
                self, None, finding_dict_list, self.finding_type, "host"
            )
        else:
