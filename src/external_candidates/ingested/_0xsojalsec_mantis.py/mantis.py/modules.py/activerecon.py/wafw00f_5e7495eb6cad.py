# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\modules\activerecon\Wafw00f.py
import json
import logging

from mantis.constants import ASSET_TYPE_IP, ASSET_TYPE_SUBDOMAIN
