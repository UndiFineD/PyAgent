# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HExHTTP\modules\cpdos\basic_cpdos.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
from modules.utils import configure_logger, human_time, random, requests, sys
