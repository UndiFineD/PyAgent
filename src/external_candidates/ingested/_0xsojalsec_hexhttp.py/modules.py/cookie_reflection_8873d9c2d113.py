# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HExHTTP\modules\cookie_reflection.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
    ...
    try:
        ...
        if res_cookie:
            for rc in res_cookie:
                ...
                if rc.value in req.text:
                    print(
                        f"\033[36m --├ {rc.value}\033[0m value for the\033[36m {rc.name}\033[0m cookie seems to be reflected in text"
                    )
                    reflected = True
        ...
        try:
            ...
            if matching_forward in req_verif.text:
                print(
                    f"  \033[31m └── VULNERABILITY CONFIRMED\033[0m | COOKIE HEADER REFLECTION | \033[34m{url}\033[0m | PAYLOAD: Cookie: {payload}"
                )
