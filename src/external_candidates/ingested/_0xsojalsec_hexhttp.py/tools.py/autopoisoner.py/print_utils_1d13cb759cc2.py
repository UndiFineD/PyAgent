# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HExHTTP\tools\autopoisoner\print_utils.py
...
def behavior_or_confirmed_message(
    ...
    explicitCache = (
        f"\033[31m{explicitCache}\033[0m"
        if explicitCache == "FALSE"
        else f"\033[32m{explicitCache}\033[0m"
    )
