# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pipeless\models\tensorflow\src\pipeless_ai_tf_models\multi_pose_estimation\lightning.py
import math
import pdb
...
model_path = pkg_resources.resource_filename(
    "pipeless_ai_tf_models.multi_pose_estimation", "MultiPoseEstimationLightning.tflite"
)
...
class MultiPoseEstimationLightning(TfLiteModel):
    ...
    def process_output(self, output):
        ...
        boxes = keypoints_and_boxes[
            :, 51:
        ]  # Extract boxes [ymin, xmin, ymax, xmax, score]
        ...
        for i in range(len(keypoints)):
            ...
            instance_keypoints[:, :2] = instance_keypoints[:, :2] * np.array(
