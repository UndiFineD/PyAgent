# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pipeless\examples\yolo-world\post-process.py
import cv2
import numpy as np
...
def hook(frame_data, _):
    ...
    if len(model_output) > 0:
        ...
        boxes, scores, class_ids = postprocess_yolo_world(
            frame.shape, yolo_input_shape, model_output
        )
