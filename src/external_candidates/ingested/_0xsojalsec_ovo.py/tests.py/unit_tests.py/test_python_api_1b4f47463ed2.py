# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\tests\unit_tests\test_python_api.py
import pytest
from jsonschema import ValidationError
from ovo import db
from ovo.core.database import Design, Project
...
def test_create_project():
    ...
    project = db.Project(
        name="Unique Test Project Name", author="test_user", public=False
    )
    db.save(project)
