...
class MockScheduler(NextflowScheduler):
    ...
    def __init__(
        self, name: str, workdir: str, submission_args: dict = None, *args, **kwargs
    ):
        """
    ...
    def get_status_label(
        self, job_id: str, created_date_utc: datetime | None = None
    ) -> str:
        """
...
class MockClient:
    ...
    def get_object(
        self, Bucket: Any, Key: str, *args: Any, **kwargs: Any
    ) -> Dict[str, MockS3Object]:
        """
    ...
    def put_object(
        self, Body: Any, Bucket: Any, Key: str, *args: Any, **kwargs: Any
    ) -> None:
        """
    ...
    def list_objects_v2(
        self, Bucket: Any, Prefix: str, *args: Any, **kwargs: Any
    ) -> Dict[str, Any]:
        """
...
def mock_create_client(
    instance: Any, service_name: str, *args: Any, **kwargs: Any
) -> MockClient:
    """
