# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\ovo\core\database\descriptors_proteinqc.py
from ovo.core.database import descriptors_rfdiffusion
from ovo.core.database.descriptors_refolding import (
...
ESM_DESCRIPTORS = [
    ESM1V,
    ESMIF,
    ESM_IF_NATIVE_SEQ_AVG_LOGITS,
    ESM_IF_NATIVE_SEQ_SUM_LOGITS,
]
...
PEP_PATCH_HYDROPHOBICITY_DESCRIPTORS_BY_KEY = {
    d.key: d for d in PEP_PATCH_HYDROPHOBICITY_DESCRIPTORS
}
...
PEP_PATCH_DESCRIPTORS = (
    PEP_PATCH_HYDROPHOBICITY_DESCRIPTORS + PEP_PATCH_CHARGE_DESCRIPTORS
)
