# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\di\utils.py
# -*- coding: utf-8 -*-
"""
...
def print_container_info():
    ...
    from core.observation.logger import (  # Convenient usage, suitable for occasional calls
        info,
    )
