# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\prompts\en\episode_mem_prompts.py
...
# =============================================================================
# Retrieval-optimized prompts (_R suffix) - 用于评估系统的检索优化版本
# 这些 prompts 针对 LoCoMo 等评估场景进行了优化，不包含 summary 字段
# =============================================================================
