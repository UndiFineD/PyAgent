# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\profile_manager\discriminator.py
...
class ValueDiscriminator:
    ...
    async def is_high_value(
        self, latest_memcell: Any, recent_memcells: Optional[List[Any]] = None
    ...
    def _build_group_chat_prompt(self, latest: Any, recent: List[Any]) -> str:
...
{{
  ...
  "reasons": "Brief explanation of your judgment"
    ...
    def _build_assistant_prompt(self, latest: Any, recent: List[Any]) -> str:
