...
def parse_answer(action_str: str):
    ...
    if action_type == "Click":
        ...
        if p_x is not None and p_y is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown click params: {repr(params)}"
            )
        ...
        if p_x is not None and p_y is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown long press params: {repr(params)}"
            )
        ...
        if p_x is not None and p_y is not None and e_x is not None and e_y is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown drag params: {repr(params)}"
            )
        ...
        if p_x is not None and p_y is not None and e_x is not None and e_y is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown scroll params: {repr(params)}"
            )
        ...
        if type_text is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown type params: {repr(params)}"
            )
        ...
        if call_text is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown call user params: {repr(params)}"
            )
        ...
        if app is not None:
            ...
            raise ValueError(
                f"action {action_type} Unknown launch params: {repr(params)}"
            )
