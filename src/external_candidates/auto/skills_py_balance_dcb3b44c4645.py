# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\synthpolis.py\clawdcasino.py\script.py\balance_dcb3b44c4645.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synthpolis\clawdcasino\script\balance.py
...
def show_balance():
    ...
    if roulette_allowance >= usdc_balance:
        ...
        print(
            ...
            f"  Roulette:     ⚠ ${roulette_allowance:,.2f} approved (less than balance)"
