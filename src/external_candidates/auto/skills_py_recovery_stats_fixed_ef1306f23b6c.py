# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\valeraolexienko.py\whoop_integration.py\scripts.py\recovery_stats_fixed_ef1306f23b6c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\valeraolexienko\whoop-integration\scripts\recovery_stats_fixed.py
...
def main():
    ...
    for date_str in sorted_days:
        ...
        print(
            ...
            f"   Recovery: **{recovery:.0f}%** | HRV: {data['hrv']:.1f}ms | RHR: {data['rhr']:.0f} bpm"
    ...
    if daily_data:
        ...
        if len(daily_data) >= 2:
            ...
            print(
                ...
                f"Change: {trend_change:+.0f}% ({sorted_days[-1]} → {sorted_days[0]})"
        ...
        if avg_recovery >= 70:
            ...
            print(
                ...
                "🟡 **Moderate recovery.** Focus on sleep optimization and stress management"
            ...
            print(
                ...
                "🔴 **Low recovery detected.** Prioritize rest and reduce training intensity"
        ...
        if avg_hrv > 50:
            ...
            print(
                ...
                "💚 **Strong HRV baseline** — excellent autonomic nervous system health"
