# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\vedantsingh60.py\prompt_performance_tester.py\prompt_performance_tester_eb197ee33740.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\vedantsingh60\prompt-performance-tester\prompt_performance_tester.py
...
class PromptPerformanceTester:
    ...
    def test_prompt(
        ...
        best_model = (
            ...
            max(successful_results, key=lambda x: x.quality_score).model_id
        ...
        cheapest_model = (
            ...
            min(successful_results, key=lambda x: x.estimated_cost_cents).model_id
        ...
        fastest_model = (
            ...
            min(successful_results, key=lambda x: x.latency_ms).model_id
    ...
    def _test_single_model(
        ...
        self, model: str, prompt: str, system_prompt: str = None, max_tokens: int = 1000
    ...
    def _test_google(
        ...
        estimated_cost_cents = self._calculate_cost(
            ...
            model, int(tokens_input), int(tokens_output)
    ...
    def _generate_recommendations(self, results: list[PerformanceMetrics]) -> list[str]:
        ...
        if not successful:
            ...
            recommendations.append(
                ...
                "All tests failed. Check API keys and prompt validity."
        ...
        recommendations.append(
            ...
            f"Cost-optimized: Use {cheapest.model_id} (${cheapest.estimated_cost_cents/100:.4f})"
        ...
        recommendations.append(
            ...
            f"Best quality: {best_quality.model_id} ({best_quality.quality_score:.0f}/100)"
        ...
        recommendations.append(
            ...
            f"Fastest: {fastest.model_id} ({fastest.latency_ms:.0f}ms)"
        ...
        if len(by_provider) > 1:
            ...
            recommendations.append(
                ...
                f"Multi-provider comparison: {len(by_provider)} providers tested"
