# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\tonimelisma.py\email_to_calendar.py\scripts.py\tests.py\test_common_0ab2c60cdddd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\tests\test_common.py
