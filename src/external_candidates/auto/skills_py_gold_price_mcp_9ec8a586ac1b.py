# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\jjannet.py\gold_price_mcp.py\gold_price_mcp_9ec8a586ac1b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jjannet\gold-price-mcp\gold-price-mcp.py
...
async def list_tools() -> List[types.Tool]:
    return [
        types.Tool(
            ...
            description=(
                "Fetch the latest Thai gold prices including gold bar and gold ornament prices with last update time."
            ),
