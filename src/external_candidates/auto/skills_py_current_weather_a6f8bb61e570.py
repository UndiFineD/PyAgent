# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xenofex7.py\swissweather.py\scripts.py\current_weather_a6f8bb61e570.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xenofex7\swissweather\scripts\current_weather.py
...
try:
    ...
    print(
        ...
        "Error: requests library not found. Install with: pip3 install requests",
...
Popular stations:
  ...
  BAS - Basel, RAG - Rapperswil, SMA - Säntis, DAV - Davos
    ...
    parser.add_argument(
        ...
        "--list", "-l", action="store_true", help="List all available stations"
    ...
    if args.station:
        ...
        print(
            ...
            f"Error: Station '{station_code}' not found. Use --list to see available stations.",
