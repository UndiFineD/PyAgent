# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\decryption.py\dbs.py\whatsappcrypt14crypt15decrypter.py\utils.py\password_data_key_to_hashcat_f28e8fc1d65a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\decryption\dbs\WhatsAppCrypt14Crypt15Decrypter\utils\password_data_key_to_hashcat.py
...
def parsecmdline() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Gives a hashcat representation of the password data key"
