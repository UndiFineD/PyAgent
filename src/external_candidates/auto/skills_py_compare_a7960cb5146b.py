# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\moltbro.py\humanize_ai_text.py\scripts.py\compare_a7960cb5146b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\moltbro\humanize-ai-text\scripts\compare.py
...
def main():
    ...
    print(
        f"{'AI Probability':<25} {icons.get(before.ai_probability, '')} {before.ai_probability:<12} {icons.get(after.ai_probability, '')} {after.ai_probability:<12}"
    )
