# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\yakelb0815.py\changenow.py\scripts.py\swap_4aa5af9f6c9a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\yakelb0815\changenow\scripts\swap.py
...
def get_estimate(from_coin, to_coin, amount, api_key):
    ...
    url = (
        ...
        f"{API_BASE}/exchange-amount/{amount}/{from_coin}_{to_coin}/?api_key={api_key}"
...
def main():
    ...
    if args.estimate:
        ...
        data = create_transaction(
            ...
            args.from_coin, args.to_coin, args.amount, args.address, api_key
        ...
        if "payinAddress" in data:
            ...
            print(
                ...
                f"Please send {args.amount} {args.from_coin.upper()} to: {data['payinAddress']}"
