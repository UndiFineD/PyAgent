# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\virtaava.py\sona_security_audit.py\scripts.py\hostile_audit_2591b091e85c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\virtaava\sona-security-audit\scripts\hostile_audit.py
...
def audit_repo(root: Path, level: str) -> Dict[str, Any]:
                ...
                findings.append(
                    ...
                    Finding(
                        ...
                        severity=(
                            ...
                            if level in {"standard", "strict", "paranoid"}
                    ...
                    findings.append(
                        ...
                        Finding(
                            ...
                            severity=(
                                ...
                                "fail" if level in {"strict", "paranoid"} else "warn"
    ...
    return {
        ...
        "manifest": (
            ...
            {"present": bool(manifest), "path": manifest_path, "data": manifest}
...
def main() -> int:
    ...
    if not root.exists():
        ...
        print(
            ...
            json.dumps({"ok": False, "error": "target_not_found", "target": str(root)})
