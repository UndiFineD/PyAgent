# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xenofex7.py\flight_tracker.py\scripts.py\track_f3d65fc2c19d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xenofex7\flight-tracker\scripts\track.py
...
def print_flights(data, callsign_filter=None):
    ...
    if callsign_filter:
        ...
        states = [
            ...
            if s[1] and callsign_filter.upper() in s[1].strip().upper()
...
def main():
    ...
    parser.add_argument(
        ...
        "--region", choices=list(REGIONS.keys()), help="Track flights in a region"
    ...
    data = get_flights(region=args.region, icao24=args.icao)
