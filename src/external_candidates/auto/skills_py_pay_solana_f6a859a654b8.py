# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ivaavimusic.py\x402_layer.py\scripts.py\pay_solana_f6a859a654b8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ivaavimusic\x402-layer\scripts\pay_solana.py
...
def create_transfer_checked_ix(
    source: Pubkey,
    mint: Pubkey,
    dest: Pubkey,
    owner: Pubkey,
    ...
    for attempt in range(max_retries):
        try:
            ...
            message = MessageV0.try_compile(
                ...
                instructions,
                [],
                blockhash,  # Address lookup tables
            )
