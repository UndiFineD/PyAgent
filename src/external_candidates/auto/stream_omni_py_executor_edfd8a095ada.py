# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\cosyvoice.py\examples.py\magicdata_read.py\cosyvoice.py\cosyvoice.py\utils.py\executor_edfd8a095ada.py
