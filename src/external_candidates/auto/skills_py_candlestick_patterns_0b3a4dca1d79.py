    ...
    def __init__(self, doji_threshold: float = 0.1, wick_body_ratio: float = 2.0):
        ...
        if not isinstance(doji_threshold, (int, float)) or not (0 < doji_threshold < 1):
            ...
            raise ValueError(
                ...
                f"doji_threshold must be between 0 and 1, got {doji_threshold}"
            ...
            for idx, row in last_3.iterrows():
                ...
                if lower_wick > self.wick_body_ratio * body and upper_wick < body:
                    ...
                    logger.debug(
                        ...
                        f"Hammer detected: lower_wick_ratio={lower_wick/(body+1e-10):.2f}"
                ...
                if upper_wick > self.wick_body_ratio * body and lower_wick < body:
                    ...
                    logger.debug(
                        ...
                        f"Shooting Star detected: upper_wick_ratio={upper_wick/(body+1e-10):.2f}"
            ...
            if avg_volume > 0:
                ...
                if volume_ratio > 1.5:
                    ...
                    logger.debug(
                        ...
                        f"Volume confirmation: ratio={volume_ratio:.2f}, strength+0.1"
