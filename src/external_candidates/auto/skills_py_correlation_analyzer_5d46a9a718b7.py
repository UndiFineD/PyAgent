...
class CorrelationAnalyzer:
    ...
    def __init__(
        ...
        logger.info(
            ...
            f"Initialized CorrelationAnalyzer (lookback: {lookback_days}d, "
    ...
    def calculate_correlation_matrix(
        ...
        self, symbols: Optional[List[str]] = None, timeframe: str = "1d"
        ...
        for symbol in symbols:
            ...
            try:
                ...
                ohlcv = self.exchange.fetch_ohlcv(
                    ...
                    symbol, timeframe, limit=self.lookback_days
    ...
    def _analyze_correlation_matrix(
        ...
        self, correlation_matrix: pd.DataFrame, symbols: List[str]
        ...
        for i in range(len(symbols)):
            ...
            for j in range(i + 1, len(symbols)):
                ...
                if (
                    ...
                    symbol_i in correlation_matrix.index

                    and symbol_j in correlation_matrix.columns
    ...
    def analyze_symbol_correlation(
        ...
        for ref_symbol in reference_symbols:
            ...
            if (
                ...
                target_symbol in correlation_matrix.index

                and ref_symbol in correlation_matrix.columns

            ):

                target_correlations[ref_symbol] = correlation_matrix.loc[

                    target_symbol, ref_symbol
        ...
        interpretation = self._interpret_symbol_correlations(
            ...
            target_symbol, target_correlations
    ...
    def _interpret_symbol_correlations(
        ...
        if avg_corr > 0.8:
            ...
            interpretation["risk_assessment"] = (
                ...
                "HIGH - Very correlated, limited diversification benefit"
    ...
    def detect_correlation_regime_change(
        ...
        self, symbol: str, short_window: int = 7, long_window: int = 30
        ...
        try:
            ...
            target_data = self.exchange.fetch_ohlcv(

                symbol, "1d", limit=long_window + 10

            )

            btc_data = self.exchange.fetch_ohlcv(

                "BTC/USDT", "1d", limit=long_window + 10
    ...
    def _interpret_regime_change(
        ...
        self, short_corr: float, long_corr: float, change: float, regime_changed: bool
        ...
        for candidate in self.MAJOR_PAIRS:
            ...
            for holding in current_holdings:
                ...
                if (
                    ...
                    candidate in correlation_matrix.index

                    and holding in correlation_matrix.columns
...
def calculate_portfolio_correlation(
    ...
    symbols: List[str], exchange_name: str = "binance"
