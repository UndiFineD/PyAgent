# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\talvasconcelos.py\lnbits.py\scripts.py\lnbits_cli_16d976950cea.py
...
def main():
    ...
    p_create.add_argument(
        ...
        "--name", type=str, default="Moltbot Wallet", help="Name of the new wallet"
    ...
    p_invoice.add_argument(
        ...
        "--amount", type=int, required=True, help="Amount in satoshis"
