# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\oura_analytics.py\scripts.py\oura_api_89049a17f5b7.py
...
def main():
    ...
    try:
        ...
        if args.command == "sleep":
            ...
            endpoints = (
                ["sleep", "daily_readiness", "daily_activity"] if args.endpoint == "all" else [args.endpoint or "sleep"]
            )
