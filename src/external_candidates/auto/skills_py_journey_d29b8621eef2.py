# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xenofex7.py\swiss_transport.py\scripts.py\journey_d29b8621eef2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xenofex7\swiss-transport\scripts\journey.py
...
def get_connections(from_station, to_station, limit=3, time=None, date=None):
    ...
    url = (
        ...
        f"https://transport.opendata.ch/v1/connections?{urllib.parse.urlencode(params)}"
