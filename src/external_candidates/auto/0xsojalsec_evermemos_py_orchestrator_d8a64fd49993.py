# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\demo.py\chat.py\orchestrator_d8a64fd49993.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\demo\chat\orchestrator.py
...
class ChatOrchestrator:
    ...
    async def select_retrieval_mode(self, texts: I18nTexts) -> str:
        ...
        print(
            ...
            f"  [5] {texts.get('retrieval_mode_agentic')} - {texts.get('retrieval_mode_agentic_desc')}"
                ...
                if index in mode_map:
                    ...
                    if index == 5:
                        ...
                        ui.note(
                            ...
                            texts.get("retrieval_mode_agentic_cost_warning"), icon="💰"
                    ...
                    ui.success(
                        ...
                        f"✓ {texts.get('retrieval_mode_selected')}: {mode_desc[index]}"
