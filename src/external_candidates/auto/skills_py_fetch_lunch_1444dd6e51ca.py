# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\simskii.py\umea_lunch.py\scripts.py\fetch_lunch_1444dd6e51ca.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\simskii\umea-lunch\scripts\fetch_lunch.py
...
def fetch_lunch_data():
    ...
    req = urllib.request.Request(
        ...
        url, headers={"User-Agent": "Mozilla/5.0 (compatible; LunchBot/1.0)"}
    ...
    if menu_type == "simple":
        ...
        for course in courses:
            ...
            result.append(
                ...
                {"title": course, "description": None, "price": None, "tags": []}
...
def main():
    ...
    parser.add_argument(
        ...
        "--restaurant", "-r", help="Filter by restaurant name (partial match)"

    )

    parser.add_argument(

        "--list", "-l", action="store_true", help="List all restaurants"
    ...
    try:
        ...
        if args.list:
            ...
            result = get_lunches(
                ...
                data, date=args.date, restaurant_filter=args.restaurant
