# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\stream_omni.py\model.py\multimodal_encoder.py\open_clip_encoder_f9a5a34583f4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\stream_omni\model\multimodal_encoder\open_clip_encoder.py
...
class OpenCLIPVisionTower(nn.Module):
    ...
    def forward_visual(self, x, output_hidden_states=False):
        ...
        if hasattr(self.vision_tower, "trunk") and hasattr(

            self.vision_tower.trunk, "_intermediate_layers"
    ...
    def num_patches(self):
        ...
        image_size = (
            ...
            self.resize_transform_size

            if isinstance(self.resize_transform_size, int)

            else self.resize_transform_size[0]
