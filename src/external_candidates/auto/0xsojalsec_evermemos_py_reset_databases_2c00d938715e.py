# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\demo.py\tools.py\reset_databases_2c00d938715e.py
...
async def main():
    ...
    print(
        ...
        "✨ Reset complete! Please restart services immediately to rebuild index structures ✨"
