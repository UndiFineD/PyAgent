# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\clawback.py\src.py\clawback.py\notifications_6c72c3e885f1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\clawback\src\clawback\notifications.py
