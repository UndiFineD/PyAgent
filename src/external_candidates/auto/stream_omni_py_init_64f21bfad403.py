# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\cosyvoice.py\third_party.py\matcha_tts.py\matcha.py\utils.py\monotonic_align.py\init_64f21bfad403.py
