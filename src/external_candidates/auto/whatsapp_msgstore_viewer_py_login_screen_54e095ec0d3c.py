# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\controller.py\login_screen_54e095ec0d3c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\Controller\login_screen.py
    ...
    def check_files(self):
        ...
        if self.view.app.msgstore_file is None:
            ...
            self.view.show_dialog(
                ...
                "No msgstore provided!!", title="Error", auto_dismiss=True
        ...
        if not check_path(self.view.app.wa_file):
            ...
            self.view.show_dialog(
                ...
                f"Please recheck the provided wa.db path\n`{self.view.app.wa_file}`"
        ...
        if not check_path(self.view.app.wp_dir):
            ...
            self.view.show_dialog(
                ...
                f"Please recheck the provided Whatsapp directory path\n`{self.view.app.wp_dir}`"
...
Submit an issue on our Github page to help you add support to your database schema. 
            ...
            self.view.show_dialog(
                ...
                msg=msg, title="Database schema is not supported!", auto_dismiss=True
...
<https://github.com/ElDavoo/WhatsApp-Crypt14-Crypt15-Decrypter>
    ...
    def show_decryption_success(self, path):
        ...
        self.view.show_toast(
            ...
            f"Database decrypted successfully, the decrypted file is stored in {path}"
    ...
    def on_tap_button_login(self) -> NoReturn:
        ...
        self.view.app.msgstore_file = (
            ...
            if self.view.ids["msgstore_file_path"].text == ""

            else strip_quotes(self.view.ids["msgstore_file_path"].text)
        ...
        self.view.app.wa_file = (
            ...
            if self.view.ids["wa_file_path"].text == ""

            else strip_quotes(self.view.ids["wa_file_path"].text)
        ...
        self.view.app.wp_dir = (
            ...
            if self.view.ids["wp_dir"].text == ""

            else strip_quotes(self.view.ids["wp_dir"].text)
        ...
        if self.view.ids["enc_checkbox"].active:
            ...
            if key == "":
                ...
                self.view.show_dialog(
                    ...
                    "Encrypted database is selected but no key has been provided!",
                ...
                self.view.show_dialog(
                    ...
                    "Trying to decrypt ...", title="Please wait ...", auto_dismiss=False
