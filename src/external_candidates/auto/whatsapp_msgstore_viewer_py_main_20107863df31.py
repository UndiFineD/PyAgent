# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\main_20107863df31.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\main.py
...
class whatsappMsgstoreViewer(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        for dir_version in os.listdir(

            os.path.join(os.path.dirname(os.path.abspath(__file__)), "dbs")
