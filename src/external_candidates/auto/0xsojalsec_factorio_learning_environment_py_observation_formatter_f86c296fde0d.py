# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\gym_env.py\observation_formatter_f86c296fde0d.py
    ...
    def format(
        ...
        return FormattedObservation(
            ...
            flows_str=(
                ...
                self.format_flows(obs_dict.get("flows", {}))
            ...
            game_info_str=(
                ...
                self.format_game_info(obs_dict.get("game_info", {}))
