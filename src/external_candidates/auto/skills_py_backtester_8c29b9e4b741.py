# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\scripts.py\backtester_8c29b9e4b741.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\cryptocurrency-trader-skill\scripts\backtester.py
...
class Backtester:
    ...
    def open_position(
        ...
        logger.info(
            ...
            f"Opened {side} position: {position_size:.4f} @ ${executed_price:.2f} "
    ...
    def close_position(
        ...
        executed_price = self.apply_slippage(
            ...
            exit_price, "SHORT" if self.position.side == "LONG" else "LONG"
        ...
        logger.info(
            ...
            f"Closed {self.position.side} position: ${net_pnl:+.2f} ({pnl_pct:+.2f}%) - {exit_reason}"
        ...
        self.equity_history.append(

            {
                ...
                "unrealized_pnl": (
                    ...
                    self.position.calculate_pnl(current_price) if self.position else 0
    ...
    def run(self, data: pd.DataFrame, symbol: str = "BTC/USDT") -> BacktestResult:
        ...
        logger.info(
            ...
            f"Period: {data['timestamp'].iloc[0]} to {data['timestamp'].iloc[-1]}"
            ...
            if self.position:
                ...
                # Check take profit
                    ...
                    self.close_position(
                        ...
                        self.position.take_profit, "TAKE_PROFIT", timestamp
            ...
            if not self.position and idx >= 200:  # Need enough data for indicators
                ...
                try:
                    ...
                    if analysis and "recommendation" in analysis:
                        ...
                        entry_price = analysis["recommendation"].get(
