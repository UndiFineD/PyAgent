# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\skill_fe7bd4137351.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\cryptocurrency-trader-skill\skill.py
...
def analyze_symbol(
    ...
    symbol: str, balance: float, timeframes: Optional[list] = None
...
def scan_market(
    ...
    balance: float, top_n: int = 5, categories: Optional[list] = None
    ...
    try:
        ...
        opportunities = agent.market_scanner.scan_market(
            ...
            categories=categories, top_n=top_n
...
Examples:
  ...
  python skill.py analyze ETH/USDT
    ...
    analyze_parser = subparsers.add_parser(
        ...
        "analyze", help="Analyze a specific trading pair"

    )

    analyze_parser.add_argument(

        "symbol", type=str, help="Trading pair (e.g., BTC/USDT)"
    ...
    scan_parser.add_argument(
        ...
        "--top", type=int, default=5, help="Number of top opportunities (default: 5)"

    )

    scan_parser.add_argument(

        "--categories", nargs="+", help="Market categories to scan"
