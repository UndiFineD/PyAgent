# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\phone_agent.py\scripts.py\server_realtime_c28217ebf4fb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\phone-agent\scripts\server_realtime.py
        ...
        try:
            while not stop_event.is_set():
                ...
                if data["event"] == "connected":
                    ...
                    await openai_ws.send(json.dumps({"type": "input_audio_buffer.append", "audio": encoded}))
