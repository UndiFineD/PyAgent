# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\jaybna.py\dex_crm.py\scripts.py\dex_cleanup_aad2b5131b41.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jaybna\dex-crm\scripts\dex-cleanup.py
...
def main():
    ...
    for i, j in enumerate(junk):
        try:
            api_put(f"/contacts/{j['id']}", {"changes": {"is_archived": True}})
