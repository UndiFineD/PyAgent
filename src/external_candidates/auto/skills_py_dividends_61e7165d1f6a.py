# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\udiedrichsen.py\stock_analysis.py\scripts.py\dividends_61e7165d1f6a.py
...
def analyze_dividends(ticker: str, verbose: bool = False) -> DividendAnalysis | None:
    ...
    try:
        ...
        if ex_dividend_date:
            ...
            ex_dividend_date = datetime.fromtimestamp(ex_dividend_date).strftime(
        ...
        if payout_ratio:
            ...
            if payout_ratio < 40:
                ...
                safety_factors.append(
                    ...
                    f"Unsustainable payout ratio ({payout_ratio:.0f}%)"
        ...
        if dividend_growth_5y:
            ...
            if dividend_growth_5y > 10:
                ...
                safety_factors.append(
                    ...
                    f"Strong dividend growth ({dividend_growth_5y:.1f}% CAGR)"
                ...
                safety_factors.append(
                    ...
                    f"Good dividend growth ({dividend_growth_5y:.1f}% CAGR)"
                ...
                safety_factors.append(
                    ...
                    f"Positive dividend growth ({dividend_growth_5y:.1f}% CAGR)"
                ...
                safety_factors.append(
                    ...
                    f"Dividend declining ({dividend_growth_5y:.1f}% CAGR)"
        ...
        if consecutive_years:
            ...
            if consecutive_years >= 25:
                ...
                safety_factors.append(
                    ...
                    f"Dividend Aristocrat ({consecutive_years}+ years)"
                ...
                safety_factors.append(
                    ...
                    f"Long dividend history ({consecutive_years} years)"
                ...
                safety_factors.append(
                    ...
                    f"Consistent dividend ({consecutive_years} years)"
        ...
        if dividend_yield:
            ...
            if dividend_yield > 8:
                ...
                safety_factors.append(
                    ...
                    f"Very high yield ({dividend_yield:.1f}%) - verify sustainability"
        ...
        summary = (
            ...
            f"{ticker}: {', '.join(summary_parts)}. Rating: {income_rating.upper()}"
        ...
        return DividendAnalysis(
            ...
            dividend_growth_5y=(
                ...
                round(dividend_growth_5y, 2) if dividend_growth_5y else None
...
def format_text(analysis: DividendAnalysis) -> str:
    ...
    lines.append(
        ...
        f"Payout Ratio:     {analysis.payout_ratio:.1f}% ({analysis.payout_status})"
