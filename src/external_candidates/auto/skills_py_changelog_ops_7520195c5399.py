# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\tonimelisma.py\email_to_calendar.py\scripts.py\utils.py\changelog_ops_7520195c5399.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\utils\changelog_ops.py
...
from common import format_timestamp, generate_indexed_id, time_ago
...
def list_changes(last_n: int = 10) -> None:
    ...
    for change in recent:
        ...
        try:
            ...
            can_undo = (now - change_time) < undo_window and change.get(
        ...
        if action == "create":
            ...
            summary = change.get("after", {}).get("summary") or change.get(
