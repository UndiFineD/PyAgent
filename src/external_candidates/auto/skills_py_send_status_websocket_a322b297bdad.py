# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mightyprime1.py\task_status.py\scripts.py\send_status_websocket_a322b297bdad.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mightyprime1\task-status\scripts\send_status_websocket.py
...
STATUS_EMOJIS = {"progress": "🔄", "success": "✅", "error": "❌", "warning": "⚠️"}
