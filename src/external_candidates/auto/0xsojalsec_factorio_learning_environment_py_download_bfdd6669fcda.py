# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\agents.py\data.py\sprites.py\download_bfdd6669fcda.py
    ...
    try:
        ...
        if archive_name.endswith(".zip"):
            ...
            mode = (
                ...
                else "r:bz2" if archive_name.endswith(".bz2") else "r"
