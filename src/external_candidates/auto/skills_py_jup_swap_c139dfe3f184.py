    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with session.get(
                ...
                f"{JUPITER_ULTRA_API_URL}/order", params=params, headers=headers
...
async def execute_swap(
    ...
    signed_tx: VersionedTransaction, request_id: str
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with session.post(
                ...
                f"{JUPITER_ULTRA_API_URL}/execute", json=payload, headers=headers
