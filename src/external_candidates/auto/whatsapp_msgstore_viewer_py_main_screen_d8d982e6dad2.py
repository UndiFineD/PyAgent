# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\model.py\main_screen_d8d982e6dad2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\Model\main_screen.py
                ...
                if raw_jid in self.base.contacts:
                    ...
                    if display_name:
                        ...
                        contact_chat["user"] = (
                            ...
                            f"{display_name} <{contact_chat['user']}>"
            ...
            for call in calls:
                ...
                try:
                    ...
                    call["user"] = (
                        ...
                        self.base.contacts[call["raw_string"]]["display_name"]
