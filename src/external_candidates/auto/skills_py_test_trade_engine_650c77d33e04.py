# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\etrade_pelosi_bot.py\tests.py\test_trade_engine_650c77d33e04.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\tests\test_trade_engine.py
...
class TestTradeEngine:
    ...
    def test_scale_trade_respects_minimum(self, trade_engine):
        ...
        trade = {"ticker": "NVDA", "transaction_type": "purchase", "amount": 100000}
...
class TestTradeEngineIntegration:
    ...
    def test_full_trade_flow(self, mock_broker, sample_config, sample_congressional_trade):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            can_trade = engine.check_position_limits(scaled["symbol"], scaled["quantity"], scaled["action"], 50000)
