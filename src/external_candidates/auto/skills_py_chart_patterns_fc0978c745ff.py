# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\scripts.py\patterns.py\chart_patterns_fc0978c745ff.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\cryptocurrency-trader-skill\scripts\patterns\chart_patterns.py
...
class ChartPatternDetector:
    ...
    def __init__(
        ...
        self, min_pattern_length: int = 20, similarity_threshold: float = 0.02
        ...
        if not isinstance(min_pattern_length, int) or min_pattern_length < 10:
            ...
            raise ValueError(
                ...
                f"min_pattern_length must be >= 10, got {min_pattern_length}"
            ...
            if len(peaks) >= 2:
                ...
                for i in range(len(peaks) - 1):
                    ...
                    if (
                        ...
                        and abs(peak1_price - peak2_price) / peak1_price
                        ...
                        between_troughs = [
                            ...
                            t for t in troughs if peak1_idx < t < peak2_idx
                        ...
                        if between_troughs:
                            ...
                            decline_pct = (
                                ...
                                (peak1_price - trough_price) / peak1_price * 100
                                ...
                                patterns.append(

                                    {
                                        ...
                                        "target": round(
                                            ...
                                            neckline - decline_pct / 100 * peak1_price,
            ...
            if len(troughs) >= 2:
                ...
                for i in range(len(troughs) - 1):
                    ...
                    if (
                        ...
                        and abs(trough1_price - trough2_price) / trough1_price
                        ...
                        between_peaks = [
                            ...
                            p for p in peaks if trough1_idx < p < trough2_idx
                        ...
                        if between_peaks:
                            ...
                            rise_pct = (
                                ...
                                (peak_price - trough1_price) / trough1_price * 100
                                ...
                                patterns.append(

                                    {
                                        ...
                                        "target": round(
                                            ...
                                            neckline + rise_pct / 100 * trough1_price, 2
    ...
    def detect_head_and_shoulders(self, df: pd.DataFrame) -> List[Dict]:
        ...
        try:
            ...
            if len(peaks) >= 3:
                ...
                for i in range(len(peaks) - 2):
                    ...
                    if (
                        ...
                        and head_price > rs_price

                        and ls_price > 0

                        and abs(ls_price - rs_price) / ls_price < 0.03
            ...
            troughs, _ = signal.find_peaks(
                ...
                -prices, distance=10, prominence=prices.std()
            ...
            if abs(first_half_trend) > 0.05:
                ...
                if second_half_volatility < 0.01:
                    ...
                    pattern_type = (
                        ...
                        "Flag" if second_half_volatility < 0.005 else "Pennant"
                    ...
                    patterns.append(

                        {
                            ...
                            "consolidation_volatility": round(

                                second_half_volatility * 100, 2
        ...
        try:
            ...
            # Descending Triangle: Flat support, falling resistance (bearish)
                ...
                logger.debug(
                    ...
                    f"Descending Triangle detected: high_slope={high_slope:.4f}"
            ...
            # Symmetrical Triangle: Both converging (direction uncertain)
                ...
                abs(high_slope + low_slope) < 0.01 and high_slope < 0 and low_slope > 0
