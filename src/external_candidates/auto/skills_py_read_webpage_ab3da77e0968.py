# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\spliff7777.py\windows_control.py\scripts.py\read_webpage_ab3da77e0968.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\spliff7777\windows-control\scripts\read_webpage.py
...
def extract_webpage_content(
    ...
    window, include_buttons=False, include_links=False, full=False
                ...
                if ctrl_type in ["Text", "Static"]:
                    ...
                    try:
                        ...
                        elem["value"] = (
                            ...
                            ctrl.get_value() if hasattr(ctrl, "get_value") else ""
...
def main():
    ...
    parser.add_argument(
        ...
        "--full", "-f", action="store_true", help="Full extraction (all elements)"
    ...
    parser.add_argument(
        ...
        "--max-text", type=int, default=50, help="Max text items to show"
    ...
    content = extract_webpage_content(
        ...
        window, include_buttons=args.buttons, include_links=args.links, full=args.full
