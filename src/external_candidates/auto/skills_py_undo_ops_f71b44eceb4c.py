# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\tonimelisma.py\email_to_calendar.py\scripts.py\utils.py\undo_ops_f71b44eceb4c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\utils\undo_ops.py
...
def list_undoable() -> None:
    ...
    if not undoable:
        ...
        print(
            ...
            "No undoable changes (all changes are older than 24 hours or already undone)."
