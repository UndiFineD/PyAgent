# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\salen_project.py\finance_tracker.py\lib.py\reports_f9a708ddfc99.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\salen-project\finance-tracker\lib\reports.py
...
def generate_report(
    ...
    period: str = "month", storage: Optional[FinanceStorage] = None
    ...
    days_map = {"today": 1, "day": 1, "week": 7, "month": 30, "year": 365, "all": None}
    ...
    for category, data in stats["by_category"].items():
        ...
        lines.append(
            ...
            f"{emoji} {category.capitalize()}: {amount:,} {currency} ({pct:.1f}%)"
...
def list_recent(n: int = 5, storage: Optional[FinanceStorage] = None) -> str:
...
def search_transactions(query: str, storage: Optional[FinanceStorage] = None) -> str:
