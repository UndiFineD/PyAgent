                ...
                if isinstance(value, dict):
                    ...
                    if key == "met" and "items" in value:
                        ...
                        chart_configs.append(
                            ...
                            create_chartjs_config(value["items"], chart_id)
                        ...
                        interval_p = (
                            ...
                            f"<p><strong>Interval:</strong> {interval} seconds</p>"
                    ...
                    if (
                        ...
                        for day in sorted(by_day.keys()):
                            ...
                            chart_config = create_chartjs_heartrate_config(
                        ...
                        items_html = "".join(
                            ...
                            [format_html_item(item, level + 1) for item in value]

                        )

                        complex_items.append(

                            (f"<h{level}>{human_key}</h{level}>", items_html)
