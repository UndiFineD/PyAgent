# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\tests.py\test_trading_agent_bdade963e7c8.py
...
def test_with_simulated_data():
    ...
    if consensus["stop_loss"]:
        ...
        position = agent._calculate_position_size(
            ...
            consensus["entry_price"], consensus["stop_loss"], 10000
