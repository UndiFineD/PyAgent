# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\stream_omni.py\model.py\multimodal_encoder.py\dev_eva_clip.py\eva_clip.py\model_03612b725ddd.py
