# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\cosyvoice.py\examples.py\magicdata_read.py\cosyvoice.py\cosyvoice.py\transformer.py\encoder_ab438229a9ad.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\CosyVoice\examples\magicdata-read\cosyvoice\cosyvoice\transformer\encoder.py
