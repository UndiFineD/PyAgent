# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\valeraolexienko.py\whoop_integration.py\scripts.py\recovery_stats_correct_2fdd61e98597.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\valeraolexienko\whoop-integration\scripts\recovery_stats_correct.py
            ...
            if recovery_response and recovery_response.get("records"):
                ...
                if "score" in latest:
                    ...
                    recovery_emoji = (
                        ...
                        "🟢" if recovery >= 70 else "🟡" if recovery >= 50 else "🔴"
                    ...
                    print(
                        ...
                        f"   Recovery: **{recovery:.0f}%** | HRV: {hrv:.1f}ms | RHR: {rhr:.0f} bpm"
                    ...
                    daily_recovery.append(
                        ...
                        {"date": date_str, "recovery": recovery, "hrv": hrv, "rhr": rhr}
