# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\src.py\ouracli.py\cli_6176d1730fc0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\src\ouracli\cli.py
...
def activity(
    ...
    date_range: str = typer.Argument(
        ...
        "today", help="Date range (e.g., 'today', '7 days')"
    ...
    dataframe_flag: bool = typer.Option(

        False, "--dataframe", help="Output as dataframe"
...
def sleep(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_daily_sleep(s, e), output_format
...
def readiness(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_daily_readiness(s, e), output_format
...
def spo2(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_daily_spo2(s, e), output_format
...
def stress(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_daily_stress(s, e), output_format
...
def workout(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_workouts(s, e), output_format
...
def session(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_sessions(s, e), output_format
...
def rest_mode(
    ...
    execute_data_command(
        ...
        date_range, lambda c, s, e: c.get_rest_mode_periods(s, e), output_format
