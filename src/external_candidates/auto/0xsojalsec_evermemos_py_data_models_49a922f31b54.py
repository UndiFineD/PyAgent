# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\src.py\core.py\data_models_49a922f31b54.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\src\core\data_models.py
...
class Message:
    ...
    timestamp: Optional[datetime] = (
        ...
        None  # Optional, some datasets (e.g., PersonaMem) lack timestamps
