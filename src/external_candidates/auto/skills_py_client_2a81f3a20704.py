# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\src.py\ouracli.py\client_2a81f3a20704.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\src\ouracli\client.py
...
class OuraClient:
    ...
    def get_workouts(
        ...
        return self._get_date_range_data(
            ...
            "usercollection/workout", start_date, end_date, next_token
    ...
    def get_sessions(
        ...
        return self._get_date_range_data(
            ...
            "usercollection/session", start_date, end_date, next_token
    ...
    def get_tags(
        ...
        return self._get_date_range_data(
            ...
            "usercollection/tag", start_date, end_date, next_token
    ...
    def get_all_data(
        ...
        try:
            ...
            all_data["activity"] = self.get_daily_activity(start_date, end_date).get(
        ...
        try:
            ...
            all_data["sleep"] = self.get_daily_sleep(start_date, end_date).get(
        ...
        try:
            ...
            all_data["readiness"] = self.get_daily_readiness(start_date, end_date).get(
        ...
        try:
            ...
            all_data["stress"] = self.get_daily_stress(start_date, end_date).get(
        ...
        try:
            ...
            all_data["heartrate"] = self.get_heartrate(
        ...
        try:
            ...
            all_data["workouts"] = self.get_workouts(start_date, end_date).get(
        ...
        try:
            ...
            all_data["sessions"] = self.get_sessions(start_date, end_date).get(
        ...
        try:
            ...
            all_data["rest_mode"] = self.get_rest_mode_periods(
