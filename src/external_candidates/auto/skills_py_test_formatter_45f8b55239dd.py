# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\maddiedreese.py\substack_formatter.py\test_formatter_45f8b55239dd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\maddiedreese\substack-formatter\test_formatter.py
...
def test_all_formats():
    ...
    for test in test_cases:
        ...
        formatted = formatter.format_text(test["content"], test["structure"])
