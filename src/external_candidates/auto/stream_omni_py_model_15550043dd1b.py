# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\cosyvoice.py\examples.py\magicdata_read.py\cosyvoice.py\cosyvoice.py\cli.py\model_15550043dd1b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\CosyVoice\examples\magicdata-read\cosyvoice\cosyvoice\cli\model.py
...
class CosyVoiceModel:
    ...
    def load(self, llm_model, flow_model, hift_model):
        ...
        self.llm.load_state_dict(
            ...
            torch.load(llm_model, map_location=self.device), strict=False
        ...
        self.flow.load_state_dict(
            ...
            torch.load(flow_model, map_location=self.device), strict=False
