# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\spliff7777.py\windows_control.py\scripts.py\read_ui_elements_5bd472009926.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\spliff7777\windows-control\scripts\read_ui_elements.py
...
def main():
    ...
    parser.add_argument(
        ...
        "--buttons-only", action="store_true", help="Only return buttons"
    ...
    try:
        ...
        elements = get_ui_elements(
            ...
            matching_window, buttons_only=args.buttons_only, links_only=args.links_only
