# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\spliff7777.py\windows_control.py\scripts.py\handle_dialog_e7da98fde73c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\spliff7777\windows-control\scripts\handle_dialog.py
...
DIALOG_TYPES = ["Window", "Dialog", "Pane"]
    ...
    for window in desktop.windows():
        ...
        try:
            ...
            is_dialog = (
                ...
                ctrl_type in DIALOG_TYPES

                or any(dc in class_name for dc in DIALOG_CLASSES)

                or "dialog" in title.lower()

                or "save" in title.lower()

                or "open" in title.lower()

                or "confirm" in title.lower()

                or "warning" in title.lower()

                or "error" in title.lower()

                or "alert" in title.lower()
            ...
            try:
                ...
                elem = {
                    ...
                    "enabled": (
                        ...
                        ctrl.is_enabled() if hasattr(ctrl, "is_enabled") else True
                ...
                if ctrl_type == "Button" and name:
                    ...
                    try:
                        ...
                        elem["value"] = (
                            ...
                            ctrl.get_value() if hasattr(ctrl, "get_value") else name
...
def type_in_field(window, text, field_index=0):
    ...
    if field_index >= len(fields):
        ...
        return (
            ...
            f"Field index {field_index} out of range (found {len(fields)} fields)",
...
def main():
    ...
    parser.add_argument(
        ...
        choices=["list", "read", "click", "type", "dismiss", "wait"],
    ...
    parser.add_argument(
        ...
        "value", nargs="?", default="", help="Button name or text to type"
    ...
    parser.add_argument(
        ...
        "--field", "-f", type=int, default=0, help="Field index for typing"

    )

    parser.add_argument(

        "--timeout", "-t", type=int, default=10, help="Timeout for wait action"
