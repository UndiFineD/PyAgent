# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\src.py\adapters.py\mem0_adapter_13f08adf8b3f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\src\adapters\mem0_adapter.py
    ...
    def __init__(self, config: dict, output_dir: Path = None):
        ...
        if not custom_instructions:
            ...
            custom_instructions = (
                ...
                self._prompts.get("add_stage", {})

                .get("mem0", {})

                .get("custom_instructions", None)
    ...
    def _convert_timestamp_to_display_timezone(self, timestamp_str: str) -> str:
        ...
        try:
            ...
            self.console.print(
                ...
                f"⚠️  Failed to convert timestamp '{timestamp_str}': {e}",
        ...
        if self._custom_instructions:
            ...
            try:
                ...
                self.console.print(
                    ...
                    f"   ⚠️  Failed to set custom instructions: {e}", style="yellow"
