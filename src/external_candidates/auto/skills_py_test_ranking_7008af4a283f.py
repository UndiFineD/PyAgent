# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\finance_news.py\tests.py\test_ranking_7008af4a283f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\finance-news\tests\test_ranking.py
...
def test_rank_headlines_sorting():
    headlines = [
        {"title": "Local news", "source": "SmallBlog", "description": "Nothing much"},
        {
            ...
            "source": "Bloomberg",
            "description": "Huge market impact",
        },
        {
            "title": "Nvidia Earnings Surprise",
            "source": "Reuters",
            "description": "AI demand surges",
        },
    ]
...
def test_source_cap():
    ...
    headlines = [{"title": f"Story {i}", "source": "Reuters"} for i in range(10)]
