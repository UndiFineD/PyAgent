# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\synesthesia_wav.py\agentmail_integration.py\scripts.py\send_email_b60652aeeca3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synesthesia-wav\agentmail-integration\scripts\send_email.py
    ...
    if args.attachment:
        ...
        kwargs["attachments"] = [
            ...
            SendAttachment(
                ...
                filename=file_path.name, content=base64.b64encode(content).decode()
