# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\cli_0c7dac4cf07f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\cli.py
        ...
        if hasattr(adapter, "close") and callable(getattr(adapter, "close")):
            ...
            try:
                ...
                console.print(
                    ...
                    f"[dim]⚠️  Failed to cleanup adapter resources: {e}[/dim]"
