# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\oura_analytics.py\tests.py\test_analyzer_c32b65cc3f81.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\oura-analytics\tests\test_analyzer.py
...
class TestOuraAnalyzer:
    ...
    def test_average_metric_convert_to_hours(self, sample_sleep_data):
        ...
        avg_hours = analyzer.average_metric(sample_sleep_data, "total_sleep_duration", convert_to_hours=True)
    ...
    def test_summary_with_readiness(self, sample_sleep_data, sample_readiness_data):
        ...
        analyzer = OuraAnalyzer(sleep_data=sample_sleep_data, readiness_data=sample_readiness_data)
