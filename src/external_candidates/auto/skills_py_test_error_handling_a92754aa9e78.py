# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xqicxx.py\memory_baidu_embedding_db.py\test_error_handling_a92754aa9e78.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xqicxx\memory-baidu-embedding-db\test_error_handling.py
...
def test_invalid_inputs():
    ...
    os.environ["BAIDU_API_STRING"] = (

        "bce-v3/ALTAK-eg3coss9r9Ythu60cLxl8/d06e0ba81aa5e1de706143613e2816813aa38dac"
...
def test_normal_operation():
    ...
    try:
        ...
        success = mem_db.add_memory(
            ...
            "这是一个正常的记忆测试", tags=["test", "normal"], metadata={"test": True}
