# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\tests.py\test_cli_ef1b4eab5174.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\tests\test_cli.py
...
class TestCLI:
    ...
    def test_activity_command(self, mock_client: Mock) -> None:
        ...
        mock_instance.get_daily_activity.return_value = {

            "data": [{"id": "1", "steps": 10000}]
    ...
    def test_sleep_command(self, mock_client: Mock) -> None:
        ...
        mock_instance.get_daily_sleep.return_value = {
    ...
    def test_readiness_command(self, mock_client: Mock) -> None:
        ...
        mock_instance.get_daily_readiness.return_value = {
