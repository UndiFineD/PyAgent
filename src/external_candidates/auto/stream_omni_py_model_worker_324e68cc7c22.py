# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\llava.py\serve.py\model_worker_324e68cc7c22.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\llava\serve\model_worker.py
