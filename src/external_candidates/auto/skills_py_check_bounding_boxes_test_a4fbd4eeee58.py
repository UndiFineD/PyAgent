# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\seanphan.py\pdf_2.py\scripts.py\check_bounding_boxes_test_a4fbd4eeee58.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\seanphan\pdf-2\scripts\check_bounding_boxes_test.py
