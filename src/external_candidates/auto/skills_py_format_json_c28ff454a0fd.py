# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\src.py\ouracli.py\format_json_c28ff454a0fd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\src\ouracli\format_json.py
                ...
                for i, (k, v) in enumerate(obj.items()):
                    ...
                    if k == "items" and isinstance(v, list):
                        ...
                        lines.append(
                            ...
                            f'{next_indent}"{k}": {json.dumps(v, default=str)}{comma}'
