# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\spendit_ai.py\solana_skills.py\scripts.py\wallet_7558211fbaaf.py
    ...
    try:
        ...
        transfer_ix = transfer(
            ...
            TransferParams(
                ...
                from_pubkey=keypair.pubkey(), to_pubkey=recipient, lamports=lamports
        ...
        print(
            ...
            f"◎ Explorer: https://solscan.io/tx/{signature}"

            + ("?cluster=devnet" if args.network == "devnet" else "")
...
def cmd_send_token(args):
    ...
    try:
        ...
        mint_info = client.get_account_info_json_parsed(
        ...
        dest_ata = get_associated_token_address(
            ...
            recipient, mint_pubkey, token_program_id
...
Examples:
  ...
  wallet.py send-token <mint> <to> 10   Send 10 tokens
    ...
    bal_parser.add_argument(
        ...
        "address", nargs="?", help="Address to check (default: your wallet)"
    ...
    tok_parser.add_argument(
        ...
        "--owner", "-o", help="Owner address (default: your wallet)"
