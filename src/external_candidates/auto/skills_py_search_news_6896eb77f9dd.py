# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\steamb23.py\naver_news.py\scripts.py\search_news_6896eb77f9dd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\steamb23\naver-news\scripts\search_news.py
...
def filter_by_date(items: list, after: Optional[str] = None) -> list:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"Invalid datetime format for --after: {after}. Use ISO 8601 format (e.g., 2026-01-29T09:00:00+09:00)"
...
def main():
    ...
    parser.add_argument(
        ...
        "--display", type=int, default=10, help="Number of results per page (1-100)"
    ...
    parser.add_argument(
        ...
        "--sort", choices=["sim", "date"], default="date", help="Sort method"
    ...
    parser.add_argument(
        ...
        help="Only show news published after this time (ISO 8601 format, e.g., 2026-01-29T09:00:00+09:00)",
    ...
    parser.add_argument(
        ...
        help="Minimum number of results to fetch (auto-pagination if needed)",
    ...
    parser.add_argument(
        ...
        help="Maximum number of pages to try (default: 5)",
    ...
    try:
        ...
        if args.json:
            ...
            print(
                ...
                f"검색 결과: 총 {total:,}건 (표시: {len(all_items)}건, {page_count}페이지)\n"
