# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\src.py\adapters.py\evermemos.py\tools.py\agentic_utils_3c3d3344e3ab.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\src\adapters\evermemos\tools\agentic_utils.py
...
from evaluation.src.adapters.evermemos.prompts.multi_query_prompts import (

    MULTI_QUERY_GENERATION_PROMPT,

)

from evaluation.src.adapters.evermemos.prompts.refined_query_prompts import (
...
from evaluation.src.adapters.evermemos.prompts.sufficiency_check_prompts import (
...
def format_documents_for_llm(
    ...
    results: List[Tuple[dict, float]], max_docs: int = 10, use_episode: bool = True
...
async def check_sufficiency(
    ...
    try:
        ...
        retrieved_docs = format_documents_for_llm(
            ...
            results, max_docs=max_docs, use_episode=True
