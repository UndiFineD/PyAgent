# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\valeraolexienko.py\whoop_integration.py\scripts.py\recovery_stats_simple_9b583d2ef1f3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\valeraolexienko\whoop-integration\scripts\recovery_stats_simple.py
    ...
    if last_five:
        ...
        if avg_recovery >= 70:
            ...
            print(
                ...
                "🟡 **Moderate recovery.** Consider optimizing sleep and managing stress"
            ...
            print(
                ...
                "🔴 **Low recovery.** Focus on rest, sleep quality, and reduce training intensity"
