# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\llava.py\model.py\builder_67cea4a6e2cf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\llava\model\builder.py
