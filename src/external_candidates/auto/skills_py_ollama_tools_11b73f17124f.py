# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\timverhoogt.py\ollama_local.py\scripts.py\ollama_tools_11b73f17124f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\timverhoogt\ollama-local\scripts\ollama_tools.py
...
def chat_with_tools(model, message, tools=None, system=None):
    ...
    data = {"model": model, "messages": messages, "tools": tools, "stream": False}
...
def main():
    ...
    loop_parser.add_argument(
        ...
        "-n", "--max-iter", type=int, default=5, help="Max iterations"
