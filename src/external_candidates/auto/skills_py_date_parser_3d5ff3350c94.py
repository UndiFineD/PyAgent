# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\tonimelisma.py\email_to_calendar.py\scripts.py\utils.py\date_parser_3d5ff3350c94.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\utils\date_parser.py
