# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\valeraolexienko.py\whoop_integration.py\scripts.py\recovery_stats_889b4a793500.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\valeraolexienko\whoop-integration\scripts\recovery_stats.py
...
def analyze_recovery_trends(records):
    ...
    return {
        ...
        "averages": {"recovery": avg_recovery, "hrv": avg_hrv, "rhr": avg_rhr},
...
def format_recovery_report(analysis):
    ...
    for date, recovery, hrv, rhr in analysis["records"]:
        ...
        report.append(
            ...
            f"{recovery_emoji} **{date}** — Recovery: {recovery:.0f}% | HRV: {hrv:.1f}ms | RHR: {rhr:.0f} bpm"
    ...
    if avg_recovery >= 70:
        ...
        report.append(
            ...
            "🟡 **Moderate recovery.** Focus on sleep quality and stress management"
        ...
        report.append(
            ...
            "🔴 **Low recovery detected.** Consider rest, better sleep, or reviewing training load"
