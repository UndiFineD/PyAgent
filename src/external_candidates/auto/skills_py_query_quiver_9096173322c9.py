# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\stuhorsman.py\quiver.py\scripts.py\query_quiver_9096173322c9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\stuhorsman\quiver\scripts\query_quiver.py
...
def main():
    ...
    congress_parser = subparsers.add_parser(
        ...
        "congress", help="Get congress trading data"
    ...
    congress_parser.add_argument(
        ...
        "--house", choices=["senate", "house"], help="Filter by house (senate/house)"
    ...
    lobbying_parser = subparsers.add_parser(
        ...
        "lobbying", help="Get corporate lobbying data"
    ...
    contracts_parser = subparsers.add_parser(
        ...
        "contracts", help="Get government contracts"
    ...
    try:
        ...
        if args.command == "congress":
            ...
            if args.house and df is not None:
                ...
                ):  # Adjust column name based on actual API response

                    df = df[

                        df["House"] == args.house

                    ]  # Pseudo-code, need to verify exact column name
