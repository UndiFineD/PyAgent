# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\synesthesia_wav.py\agentmail_integration.py\scripts.py\agentmail_helper_d6ab3434775e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synesthesia-wav\agentmail-integration\scripts\agentmail-helper.py
...
class AgentMailHelper:
    ...
    def get_recent(self, inbox_id: str, limit: int = 10) -> List[dict]:
        ...
        messages = self.client.inboxes.messages.list(inbox_id=inbox_id, limit=limit)
