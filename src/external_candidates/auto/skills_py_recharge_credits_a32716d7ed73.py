# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ivaavimusic.py\x402_layer.py\scripts.py\recharge_credits_a32716d7ed73.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ivaavimusic\x402-layer\scripts\recharge_credits.py
...
def recharge_credits(endpoint_slug: str, pack_id: str) -> dict:
    ...
    data = {"endpoint": endpoint_slug, "packId": pack_id, "chain": "base"}
    ...
    response = requests.post(url, json=data, headers={"X-Payment": x_payment, "x-wallet-address": wallet})
