# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\scripts.py\market.py\multi_source_aggregator_a632332433fe.py
...
class MultiSourceDataAggregator:
    ...
    def __init__(
        ...
        logger.info(
            ...
            f"Initialized MultiSourceDataAggregator with {len(self.exchange_instances)} exchanges"
            ...
            try:
                ...
                if self._validate_data(df):
                    ...
                    logger.debug(
                        ...
                        f"Fetched {len(df)} candles from {exchange_name} ({latency:.0f}ms)"
    ...
    def cross_validate(self, results: Dict[str, DataSourceResult]) -> Dict:
        ...
        confidence = self._calculate_confidence(
            ...
            len(successful_results), len(anomalies), price_comparison
    ...
    def _calculate_confidence(
        ...
        self, sources_count: int, anomalies_count: int, prices: Dict[str, float]
    ...
    def get_best_source(
        ...
        if best_source:
            ...
            logger.info(
                ...
                f"Selected {best_source} as best data source (score: {best_score:.3f})"
    ...
    def fetch_validated_data(
        ...
        logger.info(
            ...
            f"Fetching {symbol} [{timeframe}] from {len(self.exchange_instances)} exchanges"
...
def create_multi_source_aggregator(
    ...
    exchanges: Optional[List[str]] = None, validator=None
