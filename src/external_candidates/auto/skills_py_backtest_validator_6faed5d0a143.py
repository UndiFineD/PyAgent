...
class BacktestValidator:
    ...
    def validate_strategy(
        ...
        self, historical_data: pd.DataFrame, signal_generator, current_signal: Dict
    ...
    def _run_backtest(
        ...
        self, data: pd.DataFrame, signal_generator
        ...
        try:
            ...
            for i in range(window_size, len(data)):
                ...
                if action in ["LONG", "SHORT"] and current_position is None:
                    ...
                    current_position["highest_price"] = max(
                        ...
                        current_position["highest_price"], data.iloc[i]["high"]

                    )

                    current_position["lowest_price"] = min(

                        current_position["lowest_price"], data.iloc[i]["low"]
                    ...
                    if should_exit:
                        ...
                        trade_result = self._create_trade_result(
                            ...
                            current_position, exit_price, current_time
            ...
            if len(trades) < self.min_trades:
                ...
                logger.warning(
                    ...
                    f"Insufficient trades in backtest: {len(trades)} < {self.min_trades}"
    ...
    def _validate_metrics(self, metrics: BacktestMetrics, current_signal: Dict) -> Dict:
        ...
        confidence_adjustment = self._calculate_confidence_adjustment(
            ...
            metrics, validation_checks, current_signal
    ...
    def _generate_recommendation(
        ...
        self, metrics: BacktestMetrics, validated: bool
...
def validate_with_backtest(
    ...
    return validator.validate_strategy(
        ...
        historical_data, signal_generator, current_signal
