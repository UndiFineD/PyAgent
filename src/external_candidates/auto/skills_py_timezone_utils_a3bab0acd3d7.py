# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\oura_analytics.py\scripts.py\timezone_utils_a3bab0acd3d7.py
...
def get_sleep_for_canonical_day(sleep_data: list, target_date: date, user_tz: Optional[str] = None) -> list:
    """
...
def group_by_canonical_day(data: list, timestamp_field: str = "day", user_tz: Optional[str] = None) -> dict:
    """
...
def format_localized_datetime(utc_timestamp: str, fmt: str = "%Y-%m-%d %H:%M", user_tz: Optional[str] = None) -> str:
    """
