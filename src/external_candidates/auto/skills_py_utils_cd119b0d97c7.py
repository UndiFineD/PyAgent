# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\finance_news.py\scripts.py\utils_cd119b0d97c7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\finance-news\scripts\utils.py
...
def ensure_venv() -> None:
    ...
    if not venv_python.exists():
        print(
            "⚠️ finance-news venv missing; run scripts from the repo venv to avoid dependency errors.",
            file=sys.stderr,
        )
