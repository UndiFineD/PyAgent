# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\tmustier.py\dyson_cli.py\src.py\dyson_cli.py\config_8d5bf2b24685.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tmustier\dyson-cli\src\dyson_cli\config.py
