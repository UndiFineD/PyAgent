# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\finance_news.py\tests.py\test_alerts_7266d9b56584.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\finance-news\tests\test_alerts.py
...
def test_check_alerts_trigger(mock_alerts_data, monkeypatch, tmp_path):
    ...
    mock_quotes = {"AAPL": {"price": 145.0}, "TSLA": {"price": 210.0}}
