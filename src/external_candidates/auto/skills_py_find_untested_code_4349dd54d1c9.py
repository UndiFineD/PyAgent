# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\test_specialist.py\scripts.py\find_untested_code_4349dd54d1c9.py
...
def print_report(
    ...
    source_files: Set[Path], test_files: Set[Path], untested: Set[Path], src_dir: str
    ...
    coverage_pct = (
        ...
        ((len(source_files) - len(untested)) / len(source_files) * 100)
