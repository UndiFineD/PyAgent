# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\synthpolis.py\clawdcasino.py\script.py\version_7c89a12893db.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synthpolis\clawdcasino\script\version.py
    ...
    try:
        ...
        if server_version == LOCAL_VERSION:
            ...
            print(
                ...
                f"Your version ({LOCAL_VERSION}) differs from server ({server_version})."
