# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\portfolio_manager.py\scripts.py\test_alpaca_connection_da2b7270b683.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\portfolio-manager\scripts\test_alpaca_connection.py
...
def test_market_data(api_key, secret_key):
    ...
    try:
        ...
        response = requests.get(
            ...
            f"{base_url}/v2/stocks/AAPL/quotes/latest", headers=headers
