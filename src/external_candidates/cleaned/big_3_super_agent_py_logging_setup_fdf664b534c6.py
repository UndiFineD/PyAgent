# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\big_3_super_agent.py\apps.py\content_gen.py\backend.py\src.py\content_gen_backend.py\utils.py\logging_setup_fdf664b534c6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\big-3-super-agent\apps\content-gen\backend\src\content_gen_backend\utils\logging_setup.py
