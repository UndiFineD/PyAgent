# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\leoyessi10_tech.py\context_engineering.py\scripts.py\compression_evaluator_f118adf286a1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\leoyessi10-tech\context-engineering\scripts\compression_evaluator.py
                    ...
                    files.append(
                        {
                            "path": match,
                            "operation": (
                                "modified" if "modif" in pattern else "created" if "creat" in pattern else "read"
                            ),
                        }
                    )
