# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\oxm.py\pg.py\audit_base_c51d7308b807.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\oxm\pg\audit_base.py
...
def get_auditable_model() -> SQLModel:
    ...
    class AuditableModel(SQLModel):
        ...
        deleted_by: Optional[str] = Field(default=None, description="Deleter (set during soft delete)")
