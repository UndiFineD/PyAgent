# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render.py\layers.py\resource_layer_renderer_8923cbd994e0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\layers\resource_layer_renderer.py
    ...
    def render(
        ...
        **kwargs,
        ...
        for resource in resources:
            ...
            adjusted_color = tuple(int(c * (0.6 + 0.4 * color_intensity)) for c in resource_color)
