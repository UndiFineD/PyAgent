# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gpt_vuln_analyzer.py\package.py\gva.py\scanner_bee1545c44a7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\package\GVA\scanner.py
