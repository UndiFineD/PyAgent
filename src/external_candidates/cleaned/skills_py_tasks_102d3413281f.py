# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\benoitjadinon.py\obsidian_plugin_tasknotes.py\scripts.py\tasks_102d3413281f.py
...
def api_request(method: str, endpoint: str, params: dict = None, data: dict = None):
    ...
    try:
        response = requests.request(method, url, headers=get_headers(), params=params, json=data, timeout=10)
