# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\tools.py\telegram_example_cd63a8fa25c5.py
...
def main():
    ...
    for content_type, description in content_tests:
        ...
        if read_result["success"]:
            ...
            content_preview = (
                read_result["content"][:200] + "..." if len(read_result["content"]) > 200 else read_result["content"]
            )
