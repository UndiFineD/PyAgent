# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\mcp.py\test_error_isolation_3acd5aabdc46.py
...
class TestMCPErrorIsolator:
    ...
    def setup_method(self):
        ...
        self.isolator = MCPErrorIsolator(quarantine_threshold=3, max_quarantine_minutes=30)
    ...
    async def test_isolated_call_sync_with_args(self):
        ...
        result = await self.isolator.isolated_call("server-1", mock_func, "arg1", "arg2", key="value")
    ...
    async def test_isolated_call_async_with_args(self):
        ...
        result = await self.isolator.isolated_call("server-2", mock_func, "arg1", key="value")
    ...
    async def test_concurrent_isolated_calls(self):
        ...
        tasks = [self.isolator.isolated_call(f"server-{i}", slow_func, 0.01) for i in range(5)]
