# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_plugins_init_coverage_752c17f22f92.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_plugins_init_coverage.py
...
class TestLoadBuiltinPlugins:
    ...
    def test_loads_shell_safety_when_safety_level_low(self, tmp_path):
        ...
        with (
            ...
            mock_import.assert_called_once_with("code_puppy.plugins.shell_safety.register_callbacks")
...
class TestLoadPluginCallbacks:
    ...
    def test_calls_load_functions(self, tmp_path):
        ...
        with (
            ...
            patch("code_puppy.plugins._load_user_plugins", return_value=["user_plugin"]) as mock_user,
        ):
            try:
                result = load_plugin_callbacks()
