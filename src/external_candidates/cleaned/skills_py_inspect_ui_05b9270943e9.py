# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dreamtraveler13.py\guicountrol.py\scripts.py\inspect_ui_05b9270943e9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dreamtraveler13\guicountrol\scripts\inspect_ui.py
