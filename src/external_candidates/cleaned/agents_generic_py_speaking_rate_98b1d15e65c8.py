# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_agents.py\livekit.py\agents.py\voice.py\transcription.py\speaking_rate_98b1d15e65c8.py
...
class SpeakingRateStream:
    ...
    def _compute_speaking_rate(self, audio: np.ndarray[tuple[int], np.dtype[np.float32]], sample_rate: int) -> float:
        """
    ...
    def _spectral_flux(self, audio: np.ndarray[tuple[int], np.dtype[np.float32]], sample_rate: int) -> float:
        """
