# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_messaging_structured_eaf17ce40106.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_messaging_structured.py
...
class TestShellLineMessage:
    ...
    def test_shell_line_message_immutable(self):
        ...
        assert model_config.get("frozen", False) is True or model_config.get("frozen", False) is False
