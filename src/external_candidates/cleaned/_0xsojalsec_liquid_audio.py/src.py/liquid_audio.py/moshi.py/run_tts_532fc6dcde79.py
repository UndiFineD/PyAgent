# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-liquid-audio\src\liquid_audio\moshi\run_tts.py
...
from .models.tts import DEFAULT_DSM_TTS_REPO, DEFAULT_DSM_TTS_VOICE_REPO, TTSModel
...
def main():
    ...
    parser.add_argument(
        "--out-folder",
        type=Path,
        help="Output folder for TTSed files.",
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Amount of padding after the last word, in steps.",
    )
    parser.add_argument(
        "--padding-bonus",
        type=float,
