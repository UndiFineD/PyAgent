...
class slam(nn.Module):
    def __init__(self, spatial_dim):
        ...
        self.linear = nn.Sequential(nn.Linear(spatial_dim**2, 512), nn.ReLU(), nn.Linear(512, 1), nn.Sigmoid())
...
class ICNet(nn.Module):
    def __init__(self, is_pretrain=True, size1=512, size2=256):
        ...
        self.head = nn.Sequential(nn.Linear(256 * 2, 512), nn.ReLU(), nn.Linear(512, 1), nn.Sigmoid())
