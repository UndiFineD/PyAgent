# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2019.py\diffyq.py\part3.py\pi_creature_scenes_2fb1f3cf8bd2.py
...
class InFouriersShoes(PiCreatureScene, WriteHeatEquationTemplate):
    def construct(self):
        ...
        self.play(
            Animation(triangle),
            ApplyMethod(time_line.shift, time_line.n2p(2019) - time_line.n2p(1822), run_time=5),
        )
