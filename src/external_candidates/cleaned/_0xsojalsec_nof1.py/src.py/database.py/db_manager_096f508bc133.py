# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-nof1.ai-alpha-arena\src\database\db_manager.py
"""
...
class DatabaseManager:
    ...
    def get_trade_stats(self) -> Dict[str, Any]:
        ...
        with self.session_scope() as session:
            ...
            profit_factor = (
                abs(sum(t.realized_pnl for t in winning_trades) / sum(t.realized_pnl for t in losing_trades))
                if losing_trades and sum(t.realized_pnl for t in losing_trades) != 0
                else 0
            )
