# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\api.py\routers.py\commands_5435be4ed510.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\api\routers\commands.py
...
async def execute_command(request: CommandExecuteRequest) -> CommandExecuteResponse:
    ...
    try:
        ...
        return CommandExecuteResponse(success=False, error=f"Command timed out after {COMMAND_TIMEOUT}s")
