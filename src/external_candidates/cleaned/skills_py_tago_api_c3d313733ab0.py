# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hsooooo.py\korea_metropolitan_bus_alerts.py\scripts.py\tago_api_c3d313733ab0.py
