# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\document.py\memory.py\core_memory_8ed415c673c4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\persistence\document\memory\core_memory.py
...
class CoreMemory(DocumentBase, AuditBase):
    ...
    version: Optional[str] = Field(default=None, description="Version number, used for version management")

    is_latest: Optional[bool] = Field(default=True, description="Whether it is the latest version, default is True")
    ...
    supervisor_user_id: Optional[str] = Field(default=None, description="Supervisor User ID")

    team_members: Optional[List[str]] = Field(default=None, description="Team members' User IDs")
    ...
    user_goal: Optional[List[Dict[str, Any]]] = Field(default=None, description="User goals, including evidences")
    ...
    group_importance_evidence: Optional[Dict[str, Any]] = Field(default=None, description="Group importance evidence")
