# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_x_anylabeling_server.py\app.py\models.py\yolo11_seg_932267decf80.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-X-AnyLabeling-Server\app\models\yolo11_seg.py
...
@register_model("yolo11n_seg", "yolo11s_seg", "yolo11m_seg", "yolo11l_seg", "yolo11x_seg")
class YOLO11Segmentation(BaseModel):
    """YOLO11 instance segmentation model."""

    @staticmethod
    def mask_to_polygon(mask: np.ndarray, epsilon_factor: float = 0.001) -> np.ndarray:
