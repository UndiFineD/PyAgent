# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\prompts.py\video_description_prompt_fcb839e09523.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\prompts\video_description_prompt.py
...
class VideoDescriptionPromptTemplateDict(TextPromptDict):
    ...
    ASSISTANT_PROMPT = TextPrompt("""You are a master of video analysis. 
