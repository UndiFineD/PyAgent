# Extracted from: C:\DEV\PyAgent\src\external_candidates\auto\0xSojalSec_NetExec_whoami.py
# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-NetExec\nxc\modules\whoami.py
...
class NXCModule:
    ...
    def on_login(self, context, connection):
        ...
        searchFilter = (
            f"(sAMAccountName={connection.username})"
            if self.username is None
            else f"(sAMAccountName={format(self.username)})"
        )
