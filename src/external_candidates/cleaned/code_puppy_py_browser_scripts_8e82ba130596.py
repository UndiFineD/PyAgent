# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\tools.py\browser.py\browser_scripts_8e82ba130596.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\browser\browser_scripts.py
...
async def highlight_element(
    ...
    group_id = generate_group_id("browser_highlight_element", f"{selector[:50]}_{color}")
