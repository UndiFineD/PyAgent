# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OpenBot\python\run.py
import argparse
import os
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Running the OpenBot Intel version via Python script")
    parser.add_argument("--policy_path", "-p", default=POLICY_PATH, help="Path to policy file.")
    parser.add_argument(
        "--dataset_path",
        "-d",
