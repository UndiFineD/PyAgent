# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OpenBot\policy\openbot\tfrecord.py
"""
...
def load_labels(data_dir, datasets, policy="autopilot"):
    ...
    for dataset in datasets:
        ...
        for folder in dataset_folders:
            ...
            with open(os.path.join(sensor_data_dir, processed_frames_file_name)) as f_input:
