# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OpenBot\policy\openbot\server\zeroconf.py
...
async def run_test(zc):
    ...
    name = os.getenv("OPENBOT_NAME", socket.gethostname()).replace(".local", "").replace(".", "-")
