...
Respond conversationally, educationally, and professionally."""
    ...
    def _get_llm_response(self, system_context: str = "") -> str:
        ...
        messages = [{"role": "system", "content": self.SYSTEM_PROMPT + system_context}] + self.conversation_history
...
Environment Variables:
  ...
  ANTHROPIC_API_KEY - Anthropic API key
    ...
    parser.add_argument("--analyze", "-a", type=str, help="Analyze specific symbol with explanation")
