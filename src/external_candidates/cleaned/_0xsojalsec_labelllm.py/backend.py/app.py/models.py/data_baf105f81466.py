# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\models\data.py
import time
...
class DataCreate(BaseModel):
    ...
    evaluation: schemas.evaluation.Evaluation = Field(default_factory=schemas.evaluation.Evaluation)
