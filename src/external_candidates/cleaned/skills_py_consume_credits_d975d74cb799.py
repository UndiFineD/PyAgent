# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ivaavimusic.py\x402_layer.py\scripts.py\consume_credits_d975d74cb799.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ivaavimusic\x402-layer\scripts\consume_credits.py
...
def consume_with_credits(endpoint_url: str) -> dict:
    ...
    response = requests.get(endpoint_url, headers={"x-wallet-address": wallet, "Accept": "application/json"})
