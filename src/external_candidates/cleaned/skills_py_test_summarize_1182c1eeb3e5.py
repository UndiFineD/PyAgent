# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\finance_news.py\tests.py\test_summarize_1182c1eeb3e5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\finance-news\tests\test_summarize.py
...
class TestGetIndexChange:
    def test_extracts_sp500_change(self):
        market_data = {"markets": {"us": {"indices": {"^GSPC": {"data": {"change_percent": -1.5}}}}}}
