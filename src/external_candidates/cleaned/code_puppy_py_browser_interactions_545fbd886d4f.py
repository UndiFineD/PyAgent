# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\tools.py\browser.py\browser_interactions_545fbd886d4f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\browser\browser_interactions.py
...
async def select_option(
    ...
    group_id = generate_group_id("browser_select_option", f"{selector[:50]}_{option_desc}")
