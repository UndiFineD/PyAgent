# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\later.py\api_full_3b78cc449ef8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\later\api_full.py
...
class AssociativeMemory:
    ...
    def __init__(self, store_path: Optional[str | Path] = None, collection: str = "default") -> None:
    ...
    def find(self, query: str, *, limit: int = 10, collection: Optional[str] = None) -> list[Item]:
        """
    ...
    def query_fulltext(self, query: str, *, limit: int = 10, collection: Optional[str] = None) -> list[Item]:
        """
...
from .context import RoutingContext, TopicSummary, WorkingContext
