# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Janus\demo\app_janusflow.py
import gradio as gr
import numpy as np
import torch
...
def generate_image(prompt, seed=None, guidance=5, num_inference_steps=30):
    ...
    with torch.no_grad():
        ...
        images = generate(input_ids, cfg_weight=guidance, num_inference_steps=num_inference_steps)
