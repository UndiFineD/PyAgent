# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chrisvoncsefalvay.py\wandb_monitor.py\scripts.py\run_details_2ff4335b2bf2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chrisvoncsefalvay\wandb-monitor\scripts\run_details.py
