# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter0.py\intro_95985482309d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter0\intro.py
...
class Introduction(TeacherStudentsScene):
    ...
    def show_series(self):
        ...
        words = OldTexText("Welcome to \\\\", "Essence of Probability")
        ...
        self.play(
            ...
            "raise_right_hand",
            *[ApplyMethod(pi.change_mode, "pondering") for pi in self.get_students()],
        )
