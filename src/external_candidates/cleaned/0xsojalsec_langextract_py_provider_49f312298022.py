# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\examples.py\custom_provider_plugin.py\langextract_provider_example.py\provider_49f312298022.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\examples\custom_provider_plugin\langextract_provider_example\provider.py
...
class CustomGeminiProvider(lx.inference.BaseLanguageModel):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not self.api_key:
            raise lx.exceptions.InferenceConfigError("API key required. Set GEMINI_API_KEY or pass api_key parameter.")
    ...
    def infer(self, batch_prompts: Sequence[str], **kwargs: Any) -> Iterator[Sequence[lx.inference.ScoredOutput]]:
