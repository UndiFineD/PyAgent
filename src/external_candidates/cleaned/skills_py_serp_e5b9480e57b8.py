# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ianpcook.py\serpapi.py\scripts.py\serp_e5b9480e57b8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ianpcook\serpapi\scripts\serp.py
...
def main():
    ...
    parser.add_argument("engine", choices=list(ENGINES.keys()), help="Search engine to use")
    ...
    parser.add_argument("--type", "-t", help="Search type for Google (shop, isch, nws, vid)")
