# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\repository.py\foresight_record_repository_732a70ae4c6e.py
...
class ForesightRecordRawRepository(BaseRepository[ForesightRecord]):
    ...
    async def get_by_parent_episode_id(
        ...
        try:
            ...
            logger.error("❌ Failed to retrieve foresights by parent episodic memory ID: %s", e)
    ...
    async def delete_by_id(self, memory_id: str, session: Optional[AsyncClientSession] = None) -> bool:
        """
        ...
        try:
            ...
            if success:
                ...
                logger.warning("⚠️  Personal foresight to delete not found: %s", memory_id)
    ...
    async def delete_by_parent_episode_id(
        ...
        try:
            ...
            logger.error("❌ Failed to delete foresights by parent episodic memory ID: %s", e)
