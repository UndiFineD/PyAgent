# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\client.py\acontext_py.py\src.py\acontext.py\resources.py\spaces_49907ffd1b0e.py
...
class SpacesAPI:
    ...
    def experience_search(
        ...
        *,
        ...
        data = self._requester.request("GET", f"/space/{space_id}/experience_search", params=params or None)
    ...
    def semantic_glob(
        ...
        *,
        ...
        data = self._requester.request("GET", f"/space/{space_id}/semantic_glob", params=params or None)
    ...
    def semantic_grep(
        ...
        *,
        ...
        data = self._requester.request("GET", f"/space/{space_id}/semantic_grep", params=params or None)
