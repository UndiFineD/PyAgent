# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\toolkits.py\google_maps_toolkit_ec815642750a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\google_maps_toolkit.py
...
class GoogleMapsToolkit(BaseToolkit):
    ...
    def get_address_description(
        ...
        if "error" in addressvalidation_result:
            ...
            return f"Address validation failed with error: {error_message} Status: {error_status}, Code: {error_code}"
