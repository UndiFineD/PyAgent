# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\prompters\flux_prompter.py
import os
...
class FluxPrompter(BasePrompter):
    def __init__(self, tokenizer_1_path=None, tokenizer_2_path=None):
    ...
    def fetch_models(
        ...
        text_encoder_2: FluxTextEncoder2 = None,
    ):
    ...
    def encode_prompt(
        ...
        # T5
        prompt_emb = self.encode_prompt_using_t5(
            prompt, self.text_encoder_2, self.tokenizer_2, t5_sequence_length, device
        )
