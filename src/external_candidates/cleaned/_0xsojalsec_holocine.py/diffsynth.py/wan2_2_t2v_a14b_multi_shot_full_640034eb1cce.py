# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\Wan2.2-T2V-A14B-multi-shot-full.py
import torch
...
pipe = WanVideoHoloCinePipeline.from_pretrained(
    ...
    model_configs=[
        ModelConfig(
            path="/robby/share/Editing/hf_weights/Wan-AI/Wan2.2-T2V-A14B/models_t5_umt5-xxl-enc-bf16.pth",
            offload_device="cpu",
        ),
        ModelConfig(
            path="/robby/share/Editing/yihao/outputs/multi_shot_wan/diffsynth/Wan2.2-T2V-A14B_15s_test_cross_attn_high_noise/step-3000/model_load.safetensors",
            offload_device="cpu",
        ),
        ModelConfig(
            path="/robby/share/Editing/yihao/outputs/multi_shot_wan/diffsynth/Wan2.2-T2V-A14B_15s_test_cross_attn_low_noise/step-3000/model_load.safetensors",
            offload_device="cpu",
        ),
        ModelConfig(
            path="/robby/share/Editing/hf_weights/Wan-AI/Wan2.2-T2V-A14B/Wan2.1_VAE.pth",
            offload_device="cpu",
        ),
    ],
)
