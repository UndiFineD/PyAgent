# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\models\wan_video_dit.py
import math
...
class DiTBlock(nn.Module):
    ...
    def forward(
        ...
        x = self.gate(
            x,
            gate_msa,
            self.self_attn(input_x, freqs, shot_latent_indices=shot_latent_indices, per_g=per_g),
        )
