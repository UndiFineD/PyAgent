...
class CogDiTBlock(torch.nn.Module):
    ...
    def forward(self, hidden_states, prompt_emb, time_emb, image_rotary_emb):
        # Attention
        norm_hidden_states, norm_encoder_hidden_states, gate_a, gate_b = self.norm1(hidden_states, prompt_emb, time_emb)
        ...
        # Feed forward
        norm_hidden_states, norm_encoder_hidden_states, gate_a, gate_b = self.norm2(hidden_states, prompt_emb, time_emb)
