# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\diffsynth\trainers\utils.py
import argparse
import glob
import json
import math
...
def wan_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a JSON file containing a list of validation configurations.",
    )
    parser.add_argument(
        "--resume_from_checkpoint",
        type=str,
        default=None,
        help="Path to a checkpoint folder to resume from. Set to 'latest' to automatically find the latest.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="normal",
        help="Shot embedding initialization method.",
    )
    parser.add_argument(
        "--enabled_deepspeed",
        default=False,
