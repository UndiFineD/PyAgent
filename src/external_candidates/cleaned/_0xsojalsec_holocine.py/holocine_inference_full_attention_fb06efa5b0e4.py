# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HoloCine\HoloCine_inference_full_attention.py
import math
...
pipe = WanVideoHoloCinePipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(
            path="./checkpoints/HoloCine_dit/full/full_high_noise.safetensors",
            offload_device="cpu",
        ),
        ModelConfig(
            path="./checkpoints/HoloCine_dit/full/full_low_noise.safetensors",
            offload_device="cpu",
        ),
        ModelConfig(
