# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhisperLiveKit\whisperlivekit\core.py
try:
...
class TranscriptionEngine:
    ...
    def __init__(self, **kwargs):
        ...
        if self.args.transcription:
            ...
            warmup_asr(
                self.asr, self.args.warmup_file
            )  # for simulstreaming, warmup should be done in the online class not here
