            ...
            with self.segment_lock:
                ...
                for idx, spk in enumerate(current_chunk_preds):
                    ...
                    if (
                        ...
                        and abs(self.speaker_segments[-1].end - start_time) < frame_duration * 0.5
                    ):
                        # Continue existing segment
                        self.speaker_segments[-1].end = end_time
                    else:
                        # Create new segment
                        self.speaker_segments.append(SpeakerSegment(speaker=spk, start=start_time, end=end_time))
