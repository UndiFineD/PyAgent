# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\actions.py\test_get_entity_c96c46d87a86.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\actions\test_get_entity.py
...
def test_get_assembling_machine(game):
    ...
    assert retrieved_machine.assembling_machine_output.get(Prototype.IronGearWheel, 0) == 5, (
        "Failed to get output inventory"
    )

    assert retrieved_machine.assembling_machine_input.get(Prototype.IronPlate, 0) == 5, (
