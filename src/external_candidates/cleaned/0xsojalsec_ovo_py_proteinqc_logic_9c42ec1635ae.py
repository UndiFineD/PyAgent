# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_ovo.py\ovo.py\core.py\logic.py\proteinqc_logic_9c42ec1635ae.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\ovo\core\logic\proteinqc_logic.py
...
def get_descriptor_plot_setting(
    ...
    if descriptor.comparison == "lower_is_better":
        thresholds = [
            ...
            descriptor.warning_value,
            descriptor.error_value,
