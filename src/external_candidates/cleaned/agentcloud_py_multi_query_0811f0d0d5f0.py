# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentcloud.py\agent_backend.py\src.py\tools.py\retrievers.py\multi_query_0811f0d0d5f0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentcloud\agent-backend\src\tools\retrievers\multi_query.py
...
from langchain.retrievers.multi_query import (
    MultiQueryRetriever as LC_MultiQueryRetriever,
)
