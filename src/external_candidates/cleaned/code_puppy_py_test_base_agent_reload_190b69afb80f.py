# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_base_agent_reload_190b69afb80f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_base_agent_reload.py
...
class TestBaseAgentReload:
    ...
    def test_reload_basic_functionality(self, agent):
        ...
        with (
            patch("code_puppy.model_factory.ModelFactory.load_config") as mock_load_config,
    ...
    def test_reload_with_claude_code_specific_instructions(self, agent):
        ...
        with (
            ...
            assert "You are Claude Code, Anthropic's official CLI for Claude." == instructions
    ...
    def test_reload_mcp_servers_calls_sync(self, agent):
        ...
        with patch("code_puppy.agents.base_agent.get_mcp_manager", return_value=mock_manager):
