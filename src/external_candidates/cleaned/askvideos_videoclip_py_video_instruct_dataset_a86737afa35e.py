# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\datasets.py\datasets.py\video_instruct_dataset_a86737afa35e.py
