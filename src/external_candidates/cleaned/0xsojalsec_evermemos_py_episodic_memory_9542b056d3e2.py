# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\document.py\memory.py\episodic_memory_9542b056d3e2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\persistence\document\memory\episodic_memory.py
...
class EpisodicMemory(DocumentBase, AuditBase):
    ...
    user_id: Optional[str] = Field(default=None, description="The individual involved, None indicates group memory")
    ...
    type: Optional[str] = Field(default=None, description="Episode type, such as Conversation")
    ...
    memcell_event_id_list: Optional[List[str]] = Field(default=None, description="Memory unit event ID")
    ...
    vector_model: Optional[str] = Field(default=None, description="Vectorization model used")
