# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2017.py\cba_3cc47c189fa4.py
...
class LayersOfAbstraction(EnumerableSaveScene):
    ...
    def get_layers(self):
        ...
        arrow_labels = VGroup(
            ...
            OldTex("m_2 \\circ m_1").rotate(-45 * DEGREES).move_to(arrows[2]).shift(MED_SMALL_BUFF * DL),
        )
...
class Lightbulbs(EnumerableSaveScene):
    def construct(self):
        ...
        lower_lines = VGroup(
            *[Line(d.get_center(), ld.get_center(), buff=dot_radius) for d, ld in it.product(dots, lower_dots[1:])]
        )
