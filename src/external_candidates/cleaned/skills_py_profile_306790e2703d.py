# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\red777777.py\inkedin_automation_that_really_works.py\scripts.py\lib.py\profile_306790e2703d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\red777777\inkedin-automation-that-really-works\scripts\lib\profile.py
        ...
        try:
            ...
            for item in items[:count]:
                try:
                    ...
                    try:
                        href = item.locator('a[href*="/feed/update/"], a[href*="activity"]').first.get_attribute(
                            "href", timeout=2000
                        )
