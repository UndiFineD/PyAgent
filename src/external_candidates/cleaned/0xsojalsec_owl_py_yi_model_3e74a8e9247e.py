# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\models.py\yi_model_3e74a8e9247e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\yi_model.py
...
class YiModel(BaseModelBackend):
    ...
    def __init__(
        ...
        url = url or os.environ.get("YI_API_BASE_URL", "https://api.lingyiwanwu.com/v1")
    ...
    def check_model_config(self):
        ...
        for param in self.model_config_dict:
            if param not in YI_API_PARAMS:
                raise ValueError(f"Unexpected argument `{param}` is input into Yi model backend.")
