# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render_simple.py\utils.py\entity_categoriser_7847e86f291e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render_simple\utils\entity_categoriser.py
...
class EntityCategoriser:
    ...
    def get_entity_category(entity) -> str:
        ...
        from fle.env import BeltGroup  # Belt category

        from fle.env import Boiler  # Fluid category

        from fle.env import BurnerInserter  # Inserter category

        from fle.env import Chest  # Logistics category

        from fle.env import ElectricityGroup  # Power category

        from fle.env import PumpJack  # Mining category

        from fle.env import RocketSilo  # Production category

        from fle.env import WallGroup  # Defense category
