# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\mcp_servers.py\spotify.py\tools.py\artists_d650341bc8ab.py
...
def get_artist_top_tracks(artist_id: str, sp: Spotify = None, country: str = None) -> List[Dict]:
    """
