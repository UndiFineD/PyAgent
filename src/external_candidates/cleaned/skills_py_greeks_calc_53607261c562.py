# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\benzema216.py\options_analyzer.py\scripts.py\greeks_calc_53607261c562.py
...
class BlackScholes:
    ...
    def __init__(
        ...
        self.d1 = (math.log(self.S / self.K) + (self.r + 0.5 * self.sigma**2) * self.T) / (
