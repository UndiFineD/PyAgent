# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\r00tid.py\token_alert.py\scripts.py\setup_provider_17aacf8a63b7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\r00tid\token-alert\scripts\setup_provider.py
...
def setup_openai():
    ...
    models = ["gpt-4-turbo", "gpt-4", "gpt-4-32k", "gpt-3.5-turbo"]
