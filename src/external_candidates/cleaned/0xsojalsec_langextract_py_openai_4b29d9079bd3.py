# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\langextract.py\providers.py\openai_4b29d9079bd3.py
        ...
        **kwargs,
        ...
        try:
            ...
            raise exceptions.InferenceConfigError(
                "OpenAI provider requires openai package. Install with: pip install langextract[openai]"
            ) from e
