...
if __name__ == "__main__":
    ...
    parser.add_argument("username", type=str, help="Username used to connect to Mythic API")
    parser.add_argument("password", type=str, help="Password used to connect to Mythic API")
