# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\rag.py\retrievers.py\vector_retriever_d0aee38e0aac.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\retrievers\vector_retriever.py

from evoagentx.core.logging import logger

from evoagentx.rag.schema import Corpus, Query, RagResult
