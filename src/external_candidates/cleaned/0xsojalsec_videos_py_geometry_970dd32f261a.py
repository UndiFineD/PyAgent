# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\geometry_970dd32f261a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\geometry.py
...
class FakeAreaManipulation(Scene):
    ...
    def construct(self):
        ...
        self.play(*[Transform(sm1, sm2, **kw) for i, sm1, sm2 in zip(it.count(), group1, group2)])
...
class LogarithmicSpiral(Scene):
    ...
    def get_group(self, n, n_spirals=50):
        ...
        lines = VGroup(*[VMobject().set_points_as_corners([ORIGIN, R * v]) for v in compass_directions(n)])
