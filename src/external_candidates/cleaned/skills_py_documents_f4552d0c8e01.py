# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\keep.py\providers.py\documents_f4552d0c8e01.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\keep\providers\documents.py
...
class FileDocumentProvider:
    ...
    def _extract_pdf_text(self, path: Path) -> str:
        ...
        try:
            ...
            raise IOError(
                f"PDF support requires 'pypdf' library. Install with: pip install pypdf\nCannot read PDF: {path}"
            )
