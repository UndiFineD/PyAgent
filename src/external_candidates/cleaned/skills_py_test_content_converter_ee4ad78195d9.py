# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\asif2bd.py\wordpress_publishing_skill_for_claude.py\tests.py\test_content_converter_ee4ad78195d9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\asif2bd\wordpress-publishing-skill-for-claude\tests\test_content_converter.py
...
class TestTableConversion:
    ...
    def test_create_table_block(self):
        ...
        result = create_table_block(headers=["Col A", "Col B"], rows=[["1", "2"], ["3", "4"]], striped=True)
    ...
    def test_create_table_with_caption(self):
        ...
        result = create_table_block(headers=["A"], rows=[["1"]], caption="Table Caption")
...
class TestHelperFunctions:
    ...
    def test_create_image_block_with_media_id(self):
        ...
        result = create_image_block(src="https://example.com/img.jpg", alt="Test", media_id=123)
    ...
    def test_create_button_block(self):
        ...
        result = create_button_block(text="Click Me", url="https://example.com", style="fill", align="center")
    ...
    def test_create_button_outline_style(self):
        ...
        result = create_button_block(text="Outline", url="#", style="outline")
