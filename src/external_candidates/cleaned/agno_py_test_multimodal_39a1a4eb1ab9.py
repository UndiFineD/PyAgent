# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\models.py\openai.py\chat.py\test_multimodal_39a1a4eb1ab9.py
