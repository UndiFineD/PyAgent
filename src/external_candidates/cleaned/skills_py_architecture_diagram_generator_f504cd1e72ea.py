# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\senior_architect.py\scripts.py\architecture_diagram_generator_f504cd1e72ea.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\senior-architect\scripts\architecture_diagram_generator.py
...
class ProjectScanner:
    ...
    def _analyze_directory(self, dir_path: Path) -> Dict:
        ...
        code_files = [
            f
            for f in files
            if f.is_file() and f.suffix in [".py", ".js", ".ts", ".jsx", ".tsx", ".go", ".rs", ".java", ".vue"]
        ]
...
Output formats:
  ...
  ascii       - ASCII art format
    ...
    parser.add_argument("--json", action="store_true", help="Output raw scan results as JSON")
