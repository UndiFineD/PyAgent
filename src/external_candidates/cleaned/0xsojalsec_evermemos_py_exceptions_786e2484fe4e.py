# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\constants.py\exceptions_786e2484fe4e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\constants\exceptions.py
...
class BaseException(Exception):
    ...
    def __repr__(self) -> str:
        ...
        original_str = f", original={self.original_exception}" if self.original_exception else ""
...
class ValidationException(BaseException):
    ...
    def __init__(
        ...
        super().__init__(code=ErrorCode.VALIDATION_ERROR.value, message=message, details=details)
...
class ResourceNotFoundException(BaseException):
    ...
    def __init__(
        ...
        super().__init__(code=ErrorCode.RESOURCE_NOT_FOUND.value, message=message, details=details)
...
class ConfigurationException(BaseException):
    ...
    def __init__(
        ...
        super().__init__(code=ErrorCode.CONFIGURATION_ERROR.value, message=message, details=details)
...
class LLMOutputParsingException(AgentException):
    ...
    def __init__(
        ...
        if llm_output:
            details["llm_output"] = llm_output[:500]  # Limit length to avoid being too long
