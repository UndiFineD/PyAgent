# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_terminal_screenshot_tools_72407d0ba9a3.py
    ...
    async def test_screenshot_success(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.terminal_screenshot_tools.emit_info"):
                with patch("code_puppy.tools.browser.terminal_screenshot_tools.emit_success"):
