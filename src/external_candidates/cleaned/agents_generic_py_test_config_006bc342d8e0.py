# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\test_config_006bc342d8e0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_config.py

from livekit.plugins.openai.realtime.realtime_model import process_base_url


def test_process_base_url():
    assert process_base_url("https://api.openai.com/v1", "gpt-4") == "wss://api.openai.com/v1/realtime?model=gpt-4"

    assert process_base_url("http://example.com", "gpt-4") == "ws://example.com/realtime?model=gpt-4"
