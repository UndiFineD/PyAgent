# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_wayback_google_analytics.py\tests.py\test_async_utils_31e8670e08ea.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wayback-google-analytics\tests\test_async_utils.py
...
class AsyncUtilsTestCase(asynctest.TestCase):
    ...
    async def test_get_codes_from_single_timestamp(self, mock_GTM, mock_GA, mock_UA, mock_get):
        ...
        expected_url = "https://web.archive.org/web/20120101000000/https://www.someurl.com"
    ...
    async def test_get_codes_from_snapshots(self):
        ...
        with asynctest.mock.patch(
            ...
            self.assertEqual(mock_get_codes_from_single_timestamp.call_count, len(timestamps))
