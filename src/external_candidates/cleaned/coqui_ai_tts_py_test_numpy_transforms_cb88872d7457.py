# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tests.py\aux_tests.py\test_numpy_transforms_cb88872d7457.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\tests\aux_tests\test_numpy_transforms.py
    ...
    def test_wav_to_spec(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                math.ceil(self.sample_wav.shape[0] / self.config.hop_length),
            ),
        )
