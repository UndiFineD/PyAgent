# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chocomintx.py\xiaohongshutools.py\scripts.py\request.py\web.py\encrypt.py\xhs_encrypt_c1e354fee57a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chocomintx\xiaohongshutools\scripts\request\web\encrypt\xhs_encrypt.py

from request.web.encrypt.cookie.a1_and_webId import XHS_A1_And_WebId_Encrypt

from request.web.encrypt.cookie.gid_webprofile_data import (
...
class XiaoHongShu_Encrypt(
    XHS_A1_And_WebId_Encrypt,
    XHS_Gid_Webprofile_Data_Encrypt,
