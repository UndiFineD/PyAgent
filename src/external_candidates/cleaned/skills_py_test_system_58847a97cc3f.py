# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xqicxx.py\memory_baidu_embedding_db.py\test_system_58847a97cc3f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xqicxx\memory-baidu-embedding-db\test_system.py
    ...
    try:
        ...
        for query in test_queries:
            ...
            for i, mem in enumerate(results, 1):
                ...
                content = (
                    mem.get("content", "")[:50] + "..." if len(mem.get("content", "")) > 50 else mem.get("content", "")
                )
