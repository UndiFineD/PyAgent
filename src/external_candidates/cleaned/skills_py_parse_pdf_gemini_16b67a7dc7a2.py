# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chndranndr.py\japanese_tutor.py\scripts.py\parse_pdf_gemini_16b67a7dc7a2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chndranndr\japanese-tutor\scripts\parse_pdf_gemini.py
