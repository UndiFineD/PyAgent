# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\morph_brick_row_into_histogram_51c4b1da4a95.py
    ...
    def construct(self):
        ...
        for i, rect in enumerate(covering_rects):
            ...
            self.play(
                ...
                ChangeDecimalToValue(area_decimal, cumulative_areas[i], rate_func=linear),
            )
