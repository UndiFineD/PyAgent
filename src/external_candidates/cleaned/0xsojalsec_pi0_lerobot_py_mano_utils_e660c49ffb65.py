# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pi0_lerobot.py\src.py\pi0_lerobot.py\mano_utils_e660c49ffb65.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pi0-lerobot\src\pi0_lerobot\mano_utils.py
...
class MANOLayer(Module):
    ...
    def __init__(self, side: Literal["left", "right"], betas: np.ndarray, mano_root_dir: Path):
        """
    ...
    def forward(self, p: torch.Tensor, t: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        """
