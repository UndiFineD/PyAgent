# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\langextract.py\providers.py\router_0326822c8555.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\langextract\providers\router.py
...
def resolve_provider(provider_name: str) -> type[base_model.BaseLanguageModel]:
    ...
    raise exceptions.InferenceConfigError(
        f"No provider found matching: {provider_name!r}. Available providers can be listed with list_providers()"
    )
