# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\plugins.py\oauth_puppy_html_29142713fade.py
...
def _build_artillery(projectile: str, *, shells_only: bool = False) -> str:
    ...
    cannons = "<span class='cannon left'>🐶🧨</span><span class='cannon right'>🐕‍🦺🔥</span>"
