# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\llava.py\model.py\multimodal_encoder.py\builder_f8d94ef0ac54.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\llava\model\multimodal_encoder\builder.py
