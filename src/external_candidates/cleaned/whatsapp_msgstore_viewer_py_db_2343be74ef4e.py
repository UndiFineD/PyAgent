# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\dbs.py\v3.py\db_2343be74ef4e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\dbs\v3\db.py
