# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\modules.py\axis2_97dc13c0c8ad.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Axis2.py
...
class Axis2:
    ...
    def check(self):
        ...
        if r.status_code == 200 and 'name="password"' in r.text:
            ...
            logger.info("Axis2 administration console detected: {}".format(self.interface_url))
