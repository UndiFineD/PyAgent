# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\storages.py\object_storages.py\google_cloud_ee4fe0384561.py
    ...
    def _prepare_and_check(self) -> None:
        ...
        try:
            ...
            if not exists and self.create_if_not_exists:
                ...
                warn(f"Bucket {self._client.name} not found. Automatically created.")
