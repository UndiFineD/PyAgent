# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\xenofex7.py\swiss_phone_directory.py\searchch_b9bae2a8aca5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\xenofex7\swiss-phone-directory\searchch.py
...
def search(
    ...
    params = {"was": query, "key": api_key, "lang": lang, "maxnum": min(limit, 200)}
...
Examples:
  ...
  %(prog)s search "Restaurant" -l "Bern" -t business -n 5
    ...
    search_parser.add_argument(
        "-t",
        "--type",
        choices=["business", "person", "all"],
        default="all",
        help="Entry type filter (default: all)",
    )
    ...
    search_parser.add_argument("-v", "--verbose", action="store_true", help="Show categories and extra details")
