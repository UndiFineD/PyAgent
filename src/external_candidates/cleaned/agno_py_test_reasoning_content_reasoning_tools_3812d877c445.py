# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\agent.py\test_reasoning_content_reasoning_tools_3812d877c445.py
