# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\dialpad.py\create_sms_webhook_0a8711e96f38.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\dialpad\create_sms_webhook.py
...
def main():
    ...
    create_parser.add_argument("--url", required=True, help="Webhook URL to receive events")

    create_parser.add_argument("--events", help="Comma-separated events (default: sms_sent,sms_received)")

    create_parser.add_argument("--office-id", dest="office_id", help="Optional office ID to filter events")
