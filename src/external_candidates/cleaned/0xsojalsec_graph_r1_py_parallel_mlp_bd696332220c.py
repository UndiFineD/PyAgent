# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\verl.py\models.py\llama.py\megatron.py\layers.py\parallel_mlp_bd696332220c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\models\llama\megatron\layers\parallel_mlp.py
