# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\togetherai_model.py
...
class TogetherAIModel(BaseModelBackend):
    ...
    def __init__(
        ...
        url = url or os.environ.get("TOGETHER_API_BASE_URL", "https://api.together.xyz/v1")
