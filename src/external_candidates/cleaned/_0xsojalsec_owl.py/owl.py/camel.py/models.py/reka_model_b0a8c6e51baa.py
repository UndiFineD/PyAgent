# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\reka_model.py
        ...
        openai_response = ChatCompletion.construct(
            ...
            choices=[
                dict(
                    ...
                    finish_reason=(
                        response.responses[0].finish_reason if response.responses[0].finish_reason else None
                    ),
                )
            ],
            created=None,
