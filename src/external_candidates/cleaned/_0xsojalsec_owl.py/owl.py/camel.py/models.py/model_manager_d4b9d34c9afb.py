# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\model_manager.py
...
class ModelManager:
    ...
    def __init__(
        ...
        try:
            ...
            logger.warning(f"Provided strategy: {scheduling_strategy} is not implemented.Using default 'round robin'")
    ...
    def run(self, messages: List[OpenAIMessage]) -> Union[ChatCompletion, Stream[ChatCompletionChunk]]:
        ...
        try:
            ...
            if self.scheduling_strategy == self.always_first:
                self.scheduling_strategy = self.round_robin
                logger.warning("The scheduling strategy has been changed to 'round_robin'")
