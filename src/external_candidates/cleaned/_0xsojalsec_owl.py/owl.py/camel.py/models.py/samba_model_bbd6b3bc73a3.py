# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\samba_model.py
...
class SambaModel(BaseModelBackend):
    ...
    def _run_streaming(self, messages: List[OpenAIMessage]) -> Stream[ChatCompletionChunk]:
