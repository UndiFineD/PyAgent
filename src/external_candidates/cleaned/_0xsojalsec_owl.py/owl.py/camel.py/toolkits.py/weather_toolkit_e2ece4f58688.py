# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\weather_toolkit.py
...
class WeatherToolkit(BaseToolkit):
    ...
    def get_weather_data(
        ...
        try:
            ...
            error_message = f"An error occurred while fetching weather data for {city}: {e!s}."
