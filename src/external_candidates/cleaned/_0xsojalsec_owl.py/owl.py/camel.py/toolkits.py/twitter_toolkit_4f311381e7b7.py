# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\twitter_toolkit.py
...
def _get_user_info(username: Optional[str] = None) -> str:
    ...
    verification_messages = {
        "blue": (
            "The user has a blue verification, typically reserved for public figures, celebrities, or global brands"
        ),
        "business": ("The user has a business verification, typically reserved for businesses and corporations"),
        "government": (
