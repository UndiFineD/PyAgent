# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\function_tool.py
    ...
    def __init__(
        ...
        if synthesize_schema:
            ...
            if schema:
                ...
                raise ValueError(f"Failed to synthesize a valid schema for {self.func.__name__}.")
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        if self.synthesize_output:
            ...
            try:
                ...
                raise ValueError(
                    f"Execution of function {self.func.__name__} failed with arguments {args} and {kwargs}. Error: {e}"
                )
