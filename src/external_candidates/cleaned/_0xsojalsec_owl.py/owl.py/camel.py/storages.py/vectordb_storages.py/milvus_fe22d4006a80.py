# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\storages\vectordb_storages\milvus.py
    ...
    def _create_collection(
        ...
        **kwargs: Any,
        ...
        schema.add_field(
            ...
            description=("Any additional metadata or information relatedto the vector"),
        )
