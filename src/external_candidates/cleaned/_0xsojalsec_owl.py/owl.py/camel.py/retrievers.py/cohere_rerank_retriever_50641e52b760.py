# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\retrievers\cohere_rerank_retriever.py
...
class CohereRerankRetriever(BaseRetriever):
    ...
    def __init__(
        ...
        try:
            ...
            raise ValueError("Must pass in cohere api key or specify via COHERE_API_KEY environment variable.") from e
