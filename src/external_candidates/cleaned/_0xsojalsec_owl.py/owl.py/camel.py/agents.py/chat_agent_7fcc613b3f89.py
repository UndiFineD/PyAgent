...
class ChatAgent(BaseAgent):
    ...
    def set_output_language(self, output_language: str) -> BaseMessage:
        ...
        language_prompt = f"\nRegardless of the input language, you must output text in {output_language}."
    ...
    def _step_model_response(
        ...
        for _ in range(len(self.model_backend.models)):
            try:
                ...
                continue
        if not response:
            raise ModelProcessingError("Unable to process messages: none of the provided models run succesfully.")
