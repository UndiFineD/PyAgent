# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\personas\persona_hub.py
...
"""  # noqa: E501
    ...
    def deduplicate(
        ...
        for persona_id, persona in self.personas.items():
            if not any(
                self._is_similar(persona, up, similarity_threshold, embedding_model) for up in unique_personas.values()
            ):
