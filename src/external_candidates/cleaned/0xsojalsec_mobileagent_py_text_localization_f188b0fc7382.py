# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\mobile_agent_v2.py\mobileagent.py\text_localization_f188b0fc7382.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent-v2\MobileAgent\text_localization.py
