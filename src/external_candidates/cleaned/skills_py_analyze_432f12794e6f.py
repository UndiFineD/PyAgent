# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dgriffin831.py\skill_scan.py\test_fixtures.py\behavioral_multi_file_exfil.py\analyze_432f12794e6f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dgriffin831\skill-scan\test-fixtures\behavioral-multi-file-exfil\analyze.py
