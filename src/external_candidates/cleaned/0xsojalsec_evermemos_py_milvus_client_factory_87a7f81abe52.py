# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\milvus_client_factory_87a7f81abe52.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\component\milvus_client_factory.py
...
class MilvusClientFactory:
    ...
    def get_client(self, uri: str, user: str = "", password: str = "", db_name: str = "", **kwargs) -> MilvusClient:
        """
        ...
        client = MilvusClient(uri=uri, user=user, password=password, db_name=db_name, **kwargs)
