# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\toolkits.py\search_toolkit_1702eecc5507.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\toolkits\search_toolkit.py
        ...
        for pod in result.get("pod", []):
            ...
            if isinstance(subpod_data, list):
                ...
                description, image_url = next(
                    ((data["plaintext"], data["img"]) for data in subpod_data if "plaintext" in data and "img" in data),
                    ("", ""),
                )
    ...
    def search_archived_webpage(self, url: str, date: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if "archived_snapshots" in response and "closest" in response["archived_snapshots"]:
                ...
                "archived_snapshots" in response_notimestamp and "closest" in response_notimestamp["archived_snapshots"]
            ):
                ...
                return (
                    False,
                    f"The url {url} was not archived on Wayback Machine, please try a different url.",
                )
