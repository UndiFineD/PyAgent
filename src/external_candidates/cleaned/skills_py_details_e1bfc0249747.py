# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\amadeus_hotels.py\scripts.py\details_e1bfc0249747.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\amadeus-hotels\scripts\details.py
...
def main():
    ...
    parser.add_argument("--ratings", action="store_true", help="Include ratings/sentiment data")
