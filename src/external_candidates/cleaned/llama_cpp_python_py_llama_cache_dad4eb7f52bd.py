# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llama_cpp_python.py\llama_cpp.py\llama_cache_dad4eb7f52bd.py
...
class LlamaRAMCache(BaseLlamaCache):
    ...
    def _find_longest_prefix_key(
        ...
        keys = ((k, llama_cpp.llama.Llama.longest_token_prefix(k, key)) for k in self.cache_state.keys())
