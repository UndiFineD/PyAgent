# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\societies.py\workforce.py\role_playing_worker_9a38bf04b5b6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\societies\workforce\role_playing_worker.py
    ...
    async def _process_task(self, task: Task, dependencies: List[Task]) -> TaskState:
        ...
        while n < self.chat_turn_limit:
            ...
            if assistant_response.terminated:
                ...
                print(f"{Fore.GREEN}AI Assistant terminated. Reason: {reason}.{Fore.RESET}")
            ...
            if user_response.terminated:
                ...
                print(f"{Fore.GREEN}AI User terminated. Reason: {reason}.{Fore.RESET}")

                break

            print_text_animated(
                f"{Fore.BLUE}AI User:\n\n{user_response.msg.content}{Fore.RESET}\n",
                delay=0.005,
            )
            ...
            print_text_animated(
                f"\n{Fore.GREEN}{assistant_response.msg.content}{Fore.RESET}\n",
                delay=0.005,
            )
