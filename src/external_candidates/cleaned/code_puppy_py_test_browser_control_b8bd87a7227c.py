# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_browser_control_b8bd87a7227c.py
...
class TestBrowserInitialization:
    ...
    async def test_initialize_browser_default_settings(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.browser_control.emit_info") as mock_emit_info:
    ...
    async def test_initialize_browser_initialization_error(self):
        ...
        mock_manager.async_initialize.side_effect = RuntimeError("Browser initialization failed")
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.browser_control.emit_info"):
                with patch("code_puppy.tools.browser.browser_control.emit_error") as mock_emit_error:
                    result = await initialize_browser()
...
class TestBrowserClosing:
    ...
    async def test_close_browser_success(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.browser_control.emit_info"):
                with patch("code_puppy.tools.browser.browser_control.emit_warning") as mock_emit_warning:
