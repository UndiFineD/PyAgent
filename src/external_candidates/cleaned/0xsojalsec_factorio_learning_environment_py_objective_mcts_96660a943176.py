# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\algorithms.py\mcts.py\objective_mcts_96660a943176.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\algorithms\mcts\objective_mcts.py
    ...
    def _create_program(
        ...
        program = Program(
            id=hash(
                (
                    code,
                    json.dumps([msg.__dict__ if isinstance(msg, Message) else msg for msg in messages]),
                )
            ),
            code=code,
            conversation=conversation,
