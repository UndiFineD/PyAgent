# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\image_tools.py\openrouter_image_tools.py\image_generation_4a2f349d84c9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\image_tools\openrouter_image_tools\image_generation.py
...
class OpenRouterImageGenerationEditTool(Tool):
    ...
    inputs: Dict[str, Dict] = {
        ...
        "image_paths": {
            "type": "array",
            "description": "Local image paths (optional).",
        },
        "model": {
            "type": "string",
        ...
        "api_key": {
            "type": "string",
            "description": "OpenRouter API key (fallback to env OPENROUTER_API_KEY).",
        },
        "save_path": {
            "type": "string",
            "description": "Directory to save images (when data URLs).",
            "default": "./openrouter_images",
        },
        "output_basename": {
            "type": "string",
            "description": "Base filename for outputs.",
            "default": "or_gen",
        },
    }
    ...
    def __call__(
        ...
        try:
            ...
            try:
                ...
                return {
                    "error": f"OpenRouter API error: {error_data}",
