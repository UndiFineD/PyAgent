# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentcloud.py\agent_backend.py\src.py\lang_models.py\factory_f0638ba25265.py
...
def _fastembed_standard_doc_name_swap(fastembed_model_name: str, from_standard_to_doc: bool):
    ...
    to_enum = (
        models.mongo.FastEmbedModelsDocFormat if from_standard_to_doc else models.mongo.FastEmbedModelsStandardFormat
    )
    ...
    if in_enums(enums=[to_enum], value=fastembed_model_name):
        ...
        return get_enum_value_from_str_key(to_enum, get_enum_key_from_value(from_enum, fastembed_model_name))
