# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_message_queue_883530ab2b8c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_message_queue.py
...
class TestQueueThreadSafety:
    ...
    def test_concurrent_emit(self):
        ...
        def insert_messages(thread_id):
            for i in range(10):
                msg = UIMessage(type=MessageType.INFO, content=f"thread-{thread_id}-msg-{i}")
