# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhatsappMonitor\whatsappmonitor.py
import traceback
...
def intro():
    ...
    print("\n")
    print(
        "Warning: Running this script will have side effects on your Whatsapp account. See "
