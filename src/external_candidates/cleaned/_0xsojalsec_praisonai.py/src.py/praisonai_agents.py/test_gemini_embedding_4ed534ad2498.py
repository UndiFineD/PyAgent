# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_gemini_embedding.py
#!/usr/bin/env python3
...
def test_gemini_embedding():
    ...
    agents_openai = PraisonAIAgents(agents=[agent], tasks=[task], verbose=5, memory=True)
    ...
    agents_gemini = PraisonAIAgents(
        ...
        embedder={
            "provider": "gemini",
            "config": {"model": "text-embedding-004"},  # Gemini embedding model
        },
    )
