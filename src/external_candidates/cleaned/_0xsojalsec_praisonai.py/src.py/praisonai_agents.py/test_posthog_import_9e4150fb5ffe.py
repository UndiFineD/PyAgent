# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_posthog_import.py
#!/usr/bin/env python3
"""
...
try:
    posthog_client.capture(distinct_id="test-user", event="test-event", properties={"test": True})
    print("✅ PostHog capture successful")
except Exception as e:
    print(f"❌ PostHog capture failed: {e}")

print("\n4. Testing telemetry module...")
from praisonaiagents.telemetry.telemetry import POSTHOG_AVAILABLE, MinimalTelemetry
