# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\telemetry\token_collector.py
"""
...
class SessionTokenMetrics:
    ...
    def get_summary(self) -> Dict:
        ...
        return {
            ...
            "by_model": {model: metrics.to_dict() for model, metrics in self.metrics_by_model.items()},
            "by_agent": {agent: metrics.to_dict() for agent, metrics in self.metrics_by_agent.items()},
        }
