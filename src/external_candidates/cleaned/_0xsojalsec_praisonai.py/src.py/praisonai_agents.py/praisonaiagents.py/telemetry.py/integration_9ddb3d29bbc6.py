...
def _get_telemetry_executor():
    ...
    if _telemetry_executor is None:
        ...
        _telemetry_executor = concurrent.futures.ThreadPoolExecutor(max_workers=2, thread_name_prefix="telemetry")
    ...
    try:
        ...
        for event in events:
            ...
            if event_type == "agent_execution":
                ...
                telemetry.track_task_completion(event.get("task_name"), success=event.get("success", True))
        ...
        def instrumented_chat(*args, **kwargs):
            try:
                ...
                if not performance_mode:
                    ...
                    _queue_telemetry_event({"type": "error", "error_type": type(e).__name__})
                raise
