...
class FunctionFlowAnalyzer:
    ...
    def _analyze_patterns(self, flow_data: List[Dict]) -> Dict[str, Any]:
        ...
        patterns["most_frequent_sequences"] = [
            {"sequence": f"{seq[0]} -> {seq[1]}", "count": count} for seq, count in frequent_sequences
        ]
    ...
    def _analyze_parallelism(self, flow_data: List[Dict]) -> Dict[str, Any]:
        ...
        return {
            ...
            "thread_utilization": {str(thread_id): len(events) for thread_id, events in thread_activities.items()},
        }
    ...
    def visualize_flow(self, flow_data: Optional[List[Dict]] = None, format: str = "text") -> str:
        """
...
class PerformanceAnalyzer:
    ...
    def _generate_recommendations(self, func_stats: Dict[str, Any], api_stats: Dict[str, Any]) -> List[str]:
