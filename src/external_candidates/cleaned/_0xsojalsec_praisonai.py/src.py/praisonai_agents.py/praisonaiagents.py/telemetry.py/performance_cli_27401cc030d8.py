...
Examples:
  ...
  python -m praisonaiagents.telemetry.performance_cli trends
    ...
    report_parser.add_argument("--detailed", action="store_true", help="Show detailed comprehensive report")
    ...
    slowest_func_parser = subparsers.add_parser("slowest-functions", help="Show slowest functions")
    slowest_func_parser.add_argument("limit", type=int, nargs="?", default=10, help="Number of functions to show")

    # Slowest APIs command
    slowest_api_parser = subparsers.add_parser("slowest-apis", help="Show slowest API calls")
    slowest_api_parser.add_argument("limit", type=int, nargs="?", default=10, help="Number of APIs to show")
    ...
    flow_parser.add_argument("--events", type=int, default=50, help="Number of recent events to show")
    ...
    export_parser.add_argument("--format", choices=["json", "dict"], default="json", help="Export format")
