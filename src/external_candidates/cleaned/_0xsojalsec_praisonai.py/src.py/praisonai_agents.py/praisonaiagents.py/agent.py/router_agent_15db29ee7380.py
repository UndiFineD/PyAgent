...
class RouterAgent(Agent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_usage_stats = {model: {"calls": 0, "tokens": 0, "cost": 0.0} for model in self.available_models}
        ...
        **kwargs,
        ...
        try:
            ...
            if model_name != self.fallback_model and self.fallback_model in self._llm_instances:
                ...
                return self._execute_with_model(self.fallback_model, prompt, context, tools, **kwargs)
