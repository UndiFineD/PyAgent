# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\excel_tools.py
    ...
    def read_excel(
        ...
        try:
            ...
            if isinstance(df, dict):
                return {name: df[name].to_dict("records") for name in df.keys()}
            else:
    ...
    with tempfile.NamedTemporaryFile(suffix=".xlsx", delete=False) as temp:
        ...
        with tempfile.NamedTemporaryFile(suffix=".xlsx", delete=False) as temp2:
            ...
            with tempfile.NamedTemporaryFile(suffix=".xlsx", delete=False) as temp3:
                ...
                result = merge_excel([temp_file, temp_file2], temp_file3, how="inner", on="name")
