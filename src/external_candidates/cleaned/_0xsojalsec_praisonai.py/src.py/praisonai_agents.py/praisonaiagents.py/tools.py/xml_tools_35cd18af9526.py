# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\xml_tools.py
...
class XMLTools:
    ...
    def transform_xml(
        ...
        try:
            ...
            # Write result
            result.write(output_file, pretty_print=True, xml_declaration=True, encoding="utf-8")
    ...
    def validate_xml(self, xml_file: str, schema_file: str) -> Tuple[bool, Optional[str]]:
    ...
    def xml_to_dict(self, root: Union[str, ET.Element], preserve_attrs: bool = True) -> Dict[str, Any]:
    ...
    def dict_to_xml(self, data: Dict[str, Any], root_tag: str = "root") -> Optional[ET.Element]:
        ...
        try:
            ...
            def _create_element(parent: ET.Element, key: str, value: Any):
    ...
    def xpath_query(
        ...
        try:
            ...
            if isinstance(root, str):
                ...
                tree = lxml_etree.fromstring(ET.tostring(root, encoding="unicode"))

            # Execute query
            results = tree.xpath(query, namespaces=namespaces or {})

            # Convert results to standard ElementTree elements
            return [ET.fromstring(lxml_etree.tostring(elem, encoding="unicode")) for elem in results]
        except Exception as e:
