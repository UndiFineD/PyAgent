...
class WikipediaTools:
    ...
    def wiki_search(self, query: str, results: int = 10, suggestion: bool = True) -> Union[List[str], Dict[str, str]]:
        """
    ...
    def wiki_summary(self, title: str, sentences: int = 5, auto_suggest: bool = True) -> Union[str, Dict[str, str]]:
        """
    ...
    def wiki_page(self, title: str, auto_suggest: bool = True) -> Union[Dict[str, Any], Dict[str, str]]:
        """
    ...
    def get_sections(self, page: Any) -> List[Dict[str, Any]]:
        ...
        for title, content in zip(section_titles, section_contents):
            ...
            sections.append({"title": clean_title, "level": level, "content": content.strip()})
