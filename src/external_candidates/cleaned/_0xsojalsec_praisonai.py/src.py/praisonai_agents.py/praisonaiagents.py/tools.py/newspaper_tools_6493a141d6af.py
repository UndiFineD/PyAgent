# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\praisonaiagents\tools\newspaper_tools.py
...
class NewspaperTools:
    ...
    def get_article(self, url: str, language: str = "en") -> Dict[str, Any]:
        """
    ...
    def get_articles_from_source(
        self, source_url: str, limit: int = 10, language: str = "en"
    ...
    def get_trending_topics(
        self, sources: Optional[List[str]] = None, limit: int = 10, language: str = "en"
