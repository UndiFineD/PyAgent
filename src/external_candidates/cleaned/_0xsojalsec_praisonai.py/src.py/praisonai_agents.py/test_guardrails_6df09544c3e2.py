# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_guardrails.py
#!/usr/bin/env python3
"""
...
def test_function_guardrail():
    ...
    bad_output = TaskOutput(description="Test task", raw="Error occurred", agent="Test Agent")
