# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_ollama_fix.py
#!/usr/bin/env python3
"""
...
def test_tool_summary_generation():
    ...
    try:
        ...
        tool_results = ["The stock price of Google is 100", 200]
        ...
        summary_substantial = ollama_llm._generate_ollama_tool_summary(
            tool_results, "This is a detailed response with more than 10 characters"
        )
...
def test_backward_compatibility():
    ...
    try:
        ...
        models_to_test = ["gpt-5-nano", "claude-3-sonnet", "gemini/gemini-2.5-pro"]
