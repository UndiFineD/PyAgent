# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_multi_provider.py
#!/usr/bin/env python3
"""
...
def test_model_router():
    ...
    test_tasks = [
        ...
        (
            "Design a comprehensive microservices architecture with detailed analysis",
...
def test_router_agent():
    ...
    # Test model selection
    selected = agent._select_model_for_task(task_description="Simple math problem", tools=None)
...
def test_integration():
    ...
    agents_system = PraisonAIAgents(agents=[agent], tasks=[task], process="sequential", verbose=False)
