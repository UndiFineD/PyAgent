# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\pdf_agents_example.py
...
agents = PraisonAIAgents(agents=[pdf_agent], tasks=[task1, task2], process="sequential", verbose=1)
