# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\test.py
...
outline_workflow = PraisonAIAgents(agents=[planner_agent], tasks=[outline_task], verbose=True, process="sequential")
...
chapter_workflow = PraisonAIAgents(agents=[writer_agent], tasks=chapter_tasks, verbose=True, process="sequential")
