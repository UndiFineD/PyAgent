# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\mcp-basic.py
import asyncio
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            if stock_tool:
                ...
                result = await session.call_tool(stock_tool.name, arguments={"ticker": symbol})
                return result
            else:
