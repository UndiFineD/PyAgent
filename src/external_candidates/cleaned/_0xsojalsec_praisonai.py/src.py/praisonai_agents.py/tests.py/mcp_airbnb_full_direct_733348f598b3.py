# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\mcp_airbnb_full_direct.py
import os
...
async def agent_loop(prompt: str, client: genai.Client, session: ClientSession):
    ...
    while response.function_calls and turn_count < max_tool_turns:
        ...
        for fc_part in response.function_calls:
            ...
            tool_response_parts.append(types.Part.from_function_response(name=tool_name, response=tool_response))
