# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\image-understanding-agent.py
...
agents = PraisonAIAgents(agents=[image_agent], tasks=[task1, task2], process="sequential", verbose=1)
