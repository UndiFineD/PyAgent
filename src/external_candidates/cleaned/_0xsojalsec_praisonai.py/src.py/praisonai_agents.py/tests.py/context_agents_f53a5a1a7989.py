# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\context-agents.py
import asyncio
import json
...
async def analyze_cv_async(cv_content):
    ...
    agents = PraisonAIAgents(agents=[cv_analyzer], tasks=[cv_analysis_task])
