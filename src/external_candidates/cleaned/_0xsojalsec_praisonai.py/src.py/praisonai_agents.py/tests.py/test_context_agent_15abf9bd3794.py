...
def test_basic_functionality():
    ...
    try:
        ...
        enhanced = context_agent.enhance_prompt_with_context(base_prompt="Test prompt", context_data={"test": "data"})
        ...
        # Test PRP generation
        prp = context_agent.generate_prp(feature_request="Test feature", context_analysis=analysis)
