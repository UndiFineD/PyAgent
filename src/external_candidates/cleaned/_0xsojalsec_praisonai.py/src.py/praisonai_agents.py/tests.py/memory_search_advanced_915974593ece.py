# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\memory-search-advanced.py
import json
import logging
import os
...
def main():
    try:
        ...
        search_results = searcher.search_memories(query="What are their hobbies?", user_id=example_user, limit=5)
