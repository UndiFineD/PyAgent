# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\memory_simple.py
...
research_task = Task(description="Research and document 2 key points about AI", agent=research_agent)
