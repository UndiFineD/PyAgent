# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\cot-agents-batch.py
...
qa_pairs = [
    {"question": "What is the sum of numbers from 1 to 10?", "answer": "55"},
...
for i in range(0, len(qa_pairs), batch_size):
    ...
    qa_text = "\n".join(f"- Q: {qa['question']}\n  A: {qa['answer']}" for qa in batch_qa)
