# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\tests\code-analysis-agents.py
...
if __name__ == "__main__":
    # Example usage
    code_source = (
        "https://github.com/openai/openai-python/tree/main/src/openai/cli/_api/chat"  # GitHub URL or local directory
    )
