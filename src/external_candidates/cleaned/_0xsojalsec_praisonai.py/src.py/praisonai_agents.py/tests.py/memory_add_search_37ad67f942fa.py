...
class MemoryManager:
    ...
    def add_memory(self, text: str, user_id: Optional[str] = None, metadata: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            result = self.memory.add(messages=messages, user_id=user_id, metadata=clean_metadata)
...
def main():
    try:
        ...
        search_results = manager.search_memories(query="What are Alice's hobbies?", user_id="alice", limit=5)
