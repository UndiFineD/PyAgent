# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai-agents\test_callback_fix_verification.py
#!/usr/bin/env python3
"""
...
def test_callback(message, response, **kwargs):
    ...
    callback_calls.append({"type": "interaction", "message": message, "response": response})
...
def test_self_reflection_callback(message, **kwargs):
    ...
    callback_calls.append({"type": "self_reflection", "message": message})
