...
def test_streaming_logic():
    ...
    try:
        ...
        agent2 = Agent(instructions="You are a helpful assistant", llm="gpt-5-nano", stream=False)
        ...
        agent3 = Agent(instructions="You are a helpful assistant", llm="gpt-5-nano", stream=True)
