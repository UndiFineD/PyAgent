# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\praisonai\ui\chat.py
...
AUTH_PASSWORD_ENABLED = (
    os.getenv("AUTH_PASSWORD_ENABLED", "true").lower() == "true"
)  # Password authentication enabled by default
AUTH_OAUTH_ENABLED = (
    os.getenv("AUTH_OAUTH_ENABLED", "false").lower() == "true"
...
async def send_count():
    await cl.Message(f"Create step counter: {create_step_counter}", disable_feedback=True).send()
