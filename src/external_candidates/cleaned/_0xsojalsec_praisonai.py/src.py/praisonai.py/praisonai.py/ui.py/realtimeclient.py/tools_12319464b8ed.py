# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\praisonai\ui\realtimeclient\tools.py
import asyncio
import base64
import json
import logging
            ...
            if url:
                try:
                    ...
                    full_content = (
                        ...
                        if crawl_result and hasattr(crawl_result, "markdown") and crawl_result.markdown
