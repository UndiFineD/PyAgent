# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_gemini_tool_choice.py
"""
...
for model in test_models:
    ...
    try:
        llm = LLM(model=model)
        params = llm._build_completion_params(messages=[{"role": "user", "content": "test"}], tools=mock_tools)
