# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_openai_refactor_2.py
#!/usr/bin/env python3
"""
...
def test_openai_client():
    ...
    try:
        ...
        messages, original = client.build_messages(prompt="Test prompt", system_prompt="You are a helpful assistant")
...
def test_agent_integration():
    ...
    try:
        ...
        messages, original = agent._build_messages(prompt="Test prompt", temperature=0.5)
