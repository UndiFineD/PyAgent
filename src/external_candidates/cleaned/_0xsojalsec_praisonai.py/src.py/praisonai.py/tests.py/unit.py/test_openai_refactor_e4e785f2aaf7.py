# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\unit\test_openai_refactor.py
#!/usr/bin/env python3
"""
...
def test_dataclasses():
    ...
    try:
        ...
        message = ChatCompletionMessage(content="Test message", role="assistant", tool_calls=[tool_call])
        ...
        # Test ChatCompletion
        completion = ChatCompletion(id="test_completion", choices=[choice], created=1234567890, model="gpt-4")
