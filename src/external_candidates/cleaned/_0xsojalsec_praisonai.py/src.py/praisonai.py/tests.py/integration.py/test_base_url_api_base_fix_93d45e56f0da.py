# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\integration\test_base_url_api_base_fix.py
"""
...
class TestBaseUrlApiBaseMapping:
    ...
    def test_llm_class_maps_base_url_to_api_base(self, mock_completion):
        ...
        llm = LLM(model="openai/mistral", base_url="http://localhost:4000", api_key="sk-test")
    ...
    def test_agent_with_llm_dict_base_url_parameter(self, mock_completion):
        ...
        agent = Agent(name="Test Agent", llm=llm_config)
    ...
    def test_image_agent_base_url_consistency(self, mock_image_generation):
        ...
        mock_image_generation.return_value = {"data": [{"url": "http://example.com/image.png"}]}

        image_agent = ImageAgent(api_base="http://localhost:4000", api_key="sk-test")
    ...
    def test_ollama_environment_variable_compatibility(self, mock_completion):
        ...
        with patch.dict(os.environ, {"OLLAMA_API_BASE": "http://localhost:11434"}):
            ...
            llm = LLM(model="ollama/llama2", api_key="not-needed-for-ollama")
