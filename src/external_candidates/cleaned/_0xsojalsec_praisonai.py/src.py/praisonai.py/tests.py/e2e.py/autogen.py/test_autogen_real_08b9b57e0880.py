# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\src\praisonai\tests\e2e\autogen\test_autogen_real.py
"""
...
"""
            ...
            try:
                ...
                praisonai = PraisonAI(agent_file=test_file, framework="autogen")
    ...
    @pytest.mark.skipif(
        not os.getenv("PRAISONAI_RUN_FULL_TESTS"),
