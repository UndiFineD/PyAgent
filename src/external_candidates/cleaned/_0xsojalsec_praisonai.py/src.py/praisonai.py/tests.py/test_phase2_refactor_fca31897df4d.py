...
def test_sync_methods():
    ...
    response = llm.get_response(prompt="What's my name?", chat_history=chat_history, verbose=False)
    print(f"   Response: {response}")
...
def test_edge_cases():
    ...
    response = llm_o1.response(prompt="Hello", system_prompt="This should be skipped", verbose=False)
    print(f"   Response: {response[:50]}...")
