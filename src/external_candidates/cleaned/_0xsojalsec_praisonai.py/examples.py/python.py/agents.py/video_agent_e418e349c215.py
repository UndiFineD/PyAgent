# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\agents\video-agent.py
...
agents = PraisonAIAgents(agents=[video_agent], tasks=[task1], process="sequential", verbose=1)
