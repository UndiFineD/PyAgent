...
def demonstrate_basic_context_generation():
    ...
    context_agent = create_context_agent(llm="gpt-5-nano", name="Basic Context Engineer", verbose=True)
    ...
    analysis = context_agent.analyze_codebase_patterns(project_path=project_path, file_patterns=["*.py"])
    ...
    enhanced_prompt = context_agent.enhance_prompt_with_context(base_prompt=basic_prompt, context_data=analysis)
...
def show_context_engineering_benefits():
    ...
    enhanced_prompt = context_agent.enhance_prompt_with_context(traditional_prompt, analysis)
