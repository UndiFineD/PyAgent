...
with col1:
    ...
    with st.expander("Advanced Options"):
        max_search_results = st.number_input("Max Search Results", min_value=1, max_value=20, value=5)

        output_format = st.selectbox("Output Format", ["Summary", "Detailed Report", "Bullet Points"], index=0)
        ...
        with progress_container:
            with st.spinner("🔄 Processing your request..."):
                try:
                    ...
                    # Run agents
                    agents = PraisonAIAgents(agents=[agent], tasks=[task], process=process_type)
