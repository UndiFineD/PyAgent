# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\memory\advanced-memory-search-optimization.py
"""
...
memory_config = {
    ...
    "config": {
        "vector_store": {
            "provider": "chroma",
            "config": {"path": ".praison/optimized_memory"},
        }
    },
}
