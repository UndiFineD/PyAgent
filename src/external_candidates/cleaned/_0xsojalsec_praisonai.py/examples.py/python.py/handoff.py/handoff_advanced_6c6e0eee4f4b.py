...
support_agent.instructions = prompt_with_handoff_instructions(support_agent.instructions, support_agent)
...
if __name__ == "__main__":
    ...
    response = support_agent.chat("How do I reset my password? I can't find the option in settings.")
    print(f"Response: {response}\n")
