...
class ContextEngineeringWorkflow:
    ...
    def setup_agents(self):
        ...
        self.context_engineer = create_context_agent(llm=self.llm, name="Context Engineering Specialist", verbose=True)
    ...
    def run_context_engineering_workflow(self, feature_request: str):
        ...
        codebase_analysis = self.context_engineer.analyze_codebase_patterns(project_path=self.project_path)
