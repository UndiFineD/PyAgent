# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\concepts\knowledge-reranker-example.py
"""
...
def main():
    ...
    basic_config = {
        "vector_store": {
            "provider": "chroma",
            "config": {"collection_name": "knowledge_basic", "path": ".praison_basic"},
        },
        "reranker": {"enabled": True, "default_rerank": False},  # Disabled by default
    }
    ...
    rerank_config = {
        ...
        "reranker": {"enabled": True, "default_rerank": True},  # Enabled by default
    }
    ...
    response = agent.run(
        "Explain the difference between machine learning and deep learning, and how they relate to AI."
    )
