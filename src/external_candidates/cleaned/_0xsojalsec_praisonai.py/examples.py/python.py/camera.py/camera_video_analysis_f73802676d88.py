# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\camera\camera-video-analysis.py
"""
...
class CameraVideoAnalyzer:
    ...
    def analyze_video(self, video_path):
        ...
        agents = PraisonAIAgents(agents=[self.video_agent], tasks=[task], process="sequential", verbose=1)
