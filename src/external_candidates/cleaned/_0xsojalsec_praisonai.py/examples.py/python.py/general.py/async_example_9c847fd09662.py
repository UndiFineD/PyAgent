# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\general\async_example.py
import asyncio
import time
...
def run_sync_example():
    ...
    agents = PraisonAIAgents(agents=[sync_agent], tasks=[sync_task], verbose=1, process="sequential")
    result = agents.start()
...
async def run_async_example():
    ...
    agents = PraisonAIAgents(agents=[async_agent], tasks=[async_task], verbose=1, process="sequential")
