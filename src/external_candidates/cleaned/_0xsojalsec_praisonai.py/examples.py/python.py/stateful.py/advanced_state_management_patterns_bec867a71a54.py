# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\stateful\advanced-state-management-patterns.py
"""
...
session_config = {"session_id": "state_demo_001", "persist": True}
