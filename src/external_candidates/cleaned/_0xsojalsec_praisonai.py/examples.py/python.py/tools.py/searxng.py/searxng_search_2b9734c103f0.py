# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\tools\searxng\searxng-search.py
#!/usr/bin/env python3
"""
...
def multi_agent_research_example():
    ...
    # Create process
    process = Process(agents=[tech_researcher, news_analyst], tasks=[tech_task, news_task])
