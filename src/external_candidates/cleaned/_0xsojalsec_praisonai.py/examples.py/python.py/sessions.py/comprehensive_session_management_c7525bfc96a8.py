# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\sessions\comprehensive-session-management.py
"""
...
agents_session1 = PraisonAIAgents(agents=[research_agent], tasks=[research_task1], session=session1, verbose=True)
...
agents_session2 = PraisonAIAgents(agents=[analysis_agent], tasks=[analysis_task], session=session2, verbose=True)
...
agents_reviewer = PraisonAIAgents(agents=[review_agent], tasks=[review_task], session=reviewer_session, verbose=True)
