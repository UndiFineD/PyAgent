# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\usecases\emergency-response.py
import time
...
monitor_task = Task(
    ...
    agent=monitor,
    task_type="decision",
    condition={"ongoing": ["coordinate_response"], "completed": ""},
)
...
def main():
    ...
    incident = {"type": "fire", "location": "123 Main St", "reported_time": time.time()}
