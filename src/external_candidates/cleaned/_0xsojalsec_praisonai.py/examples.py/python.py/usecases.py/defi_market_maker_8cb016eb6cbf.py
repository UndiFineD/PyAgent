# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\usecases\defi-market-maker.py
import asyncio
import time
...
workflow = PraisonAIAgents(
    ...
    tasks=[market_task, arbitrage_task, liquidity_task, risk_task, execution_task],
    process="workflow",
    verbose=True,
)
