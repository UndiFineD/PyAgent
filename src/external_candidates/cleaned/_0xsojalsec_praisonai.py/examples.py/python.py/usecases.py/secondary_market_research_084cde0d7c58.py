# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\usecases\secondary-market-research.py
"""
...
async def run_market_research(config: MarketResearchConfig) -> Dict[str, Any]:
    ...
    # Create workflow
    workflow = PraisonAIAgents(agents=list(agents.values()), tasks=tasks, process="workflow", verbose=True)
