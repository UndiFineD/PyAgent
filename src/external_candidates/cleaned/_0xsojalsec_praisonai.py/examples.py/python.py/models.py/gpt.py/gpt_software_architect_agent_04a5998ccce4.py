# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\gpt\gpt_software_architect_agent.py
...
response = agent.start(
    "Hello! I'm your software architect assistant. How can I help you design your software system today?"
)
