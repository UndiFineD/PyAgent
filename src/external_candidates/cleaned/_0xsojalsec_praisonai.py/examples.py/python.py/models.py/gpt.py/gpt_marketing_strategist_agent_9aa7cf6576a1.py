# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\gpt\gpt_marketing_strategist_agent.py
...
response = agent.start(
    "Hello! I'm your marketing strategist assistant. How can I help you with your marketing strategy today?"
)
