# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\gpt\gpt_product_manager_agent.py
...
response = agent.start(
    "Hello! I'm your product manager assistant. How can I help you with your product strategy today?"
)
