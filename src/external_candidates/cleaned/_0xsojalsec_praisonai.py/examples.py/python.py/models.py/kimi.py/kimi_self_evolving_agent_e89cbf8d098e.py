# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_self_evolving_agent.py
...
response = agent.start(
    "Hello! I'm your self-evolving AI assistant. "
