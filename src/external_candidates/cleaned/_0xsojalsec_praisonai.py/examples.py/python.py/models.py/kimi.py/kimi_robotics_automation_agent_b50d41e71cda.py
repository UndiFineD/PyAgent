# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_robotics_automation_agent.py
...
response = agent.start(
    "Hello! I'm your robotics and automation assistant. How can I help you with robotics and automation systems today?"
)
