# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_chess_agent.py
...
response = agent.start("Hello! I'm your chess assistant. How can I help you improve your chess game today?")
