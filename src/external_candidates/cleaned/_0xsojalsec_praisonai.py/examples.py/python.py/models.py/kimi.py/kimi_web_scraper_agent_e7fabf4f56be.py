# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\kimi\kimi_web_scraper_agent.py
...
response = agent.start("Hello! I'm your web scraping assistant. How can I help you extract and analyze web data today?")
