# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\llama\llama_code_review_agent.py
...
response = agent.start("Hello! I'm your code review assistant. How can I help you improve your code quality today?")
