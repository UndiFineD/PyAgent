# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\aws-bedrock.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    titan_agent = Agent(
        ...
        llm={"model": "bedrock/amazon.titan-text-express-v1", "temperature": 0.5},
    )
    ...
    writer = Agent(
        ...
        llm={"model": "bedrock/amazon.titan-text-express-v1", "temperature": 0.8},
    )
    ...
    # Writing phase
    writing_result = writer.ask(
        f"Write a compelling introduction paragraph about renewable energy based on this research: {research_result}"
    )
