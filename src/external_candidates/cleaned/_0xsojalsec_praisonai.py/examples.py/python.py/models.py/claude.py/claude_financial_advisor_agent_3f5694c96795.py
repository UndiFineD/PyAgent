# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\claude\claude_financial_advisor_agent.py
...
response = agent.start(
    "Hello! I'm your financial advisor assistant. How can I help you understand financial concepts today?"
)
