# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\claude\claude_medical_researcher_agent.py
...
response = agent.start(
    "Hello! I'm your medical research assistant. How can I help you understand medical concepts today?"
)
