# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\claude\claude_educational_tutor_agent.py
...
response = agent.start("Hello! I'm your educational tutor assistant. How can I help you learn today?")
