# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\claude\claude_creative_designer_agent.py
...
response = agent.start(
    "Hello! I'm your creative designer assistant. How can I help you with your design projects today?"
)
