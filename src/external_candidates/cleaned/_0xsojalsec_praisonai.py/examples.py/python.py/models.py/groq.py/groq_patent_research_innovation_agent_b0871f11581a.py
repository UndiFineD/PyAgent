# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\models\groq\groq_patent_research_innovation_agent.py
...
response = agent.start(
    "Hello! I'm your patent research and innovation assistant. "
