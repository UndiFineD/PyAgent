# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\mongodb\mongodb_comprehensive_example.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    try:
        ...
        print("\n🔧 Direct MongoDB operations...")
        mongo_client = mongodb_tools.connect_mongodb("mongodb://localhost:27017/", "praisonai_comprehensive")
