# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\mongodb\mongodb_tools_example.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    mongodb_system = PraisonAIAgents(agents=[db_agent, analysis_agent], tasks=mongodb_tasks, verbose=True)
    ...
    try:
        ...
        # Query documents
        print("\n🔍 Querying documents...")
        documents = mongo_client.find_documents("demo_collection", {"category": "database"}, limit=5)
