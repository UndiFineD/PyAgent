# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\custom_tools\mcp_server_latency_example.py
"""
...
from latency_tracker_tool import get_latency_metrics, tracker
