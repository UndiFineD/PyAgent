# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\custom_tools\minimal_latency_example.py
#!/usr/bin/env python3
"""
...
def handle_mcp_request(query: str, request_id: str = "mcp_1"):
    ...
    agent = Agent(name="Assistant", role="MCP Handler", goal="Process requests", llm="gpt-5-nano")
