# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-PraisonAI\examples\python\custom_tools\hosted_server.py
"""
...
try:
    ...
    raise ImportError(
        "MCP server dependencies not installed. Please install with: pip install praisonaiagents[mcp] starlette>=0.27.0"
    )
...
class HostedMCPServer:
    ...
    def handle_request(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        response = {"id": request_id, "jsonrpc": "2.0", "result": {}}
