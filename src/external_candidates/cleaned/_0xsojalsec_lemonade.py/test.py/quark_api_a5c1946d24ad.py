# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\test\quark_api.py
import os
import shutil
import unittest
...
if __name__ == "__main__":
    cache_dir, _ = common.create_test_dir("lemonade_quark_api", base_dir=os.path.abspath("."))
    unittest.main()
