# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\installer\add_to_path.py
import argparse
import winreg
...
def add_to_path(directory_to_add):
    ...
    try:
        ...
        path_items = [item for item in current_path.split(";") if item]  # Remove empty entries
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Add a directory to the beginning of the user Path")
