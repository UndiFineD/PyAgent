# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\examples\api_oga_cpu_streaming.py
"""
...
model, tokenizer = from_pretrained("amd/Qwen2.5-0.5B-Instruct-quantized_int4-float16-cpu-onnx", recipe="oga-cpu")
