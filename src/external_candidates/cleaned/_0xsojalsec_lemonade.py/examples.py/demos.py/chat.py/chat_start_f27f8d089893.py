# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\examples\demos\chat\chat_start.py
import sys
...
def generate_placeholder(streamer: TextStreamer, stopping_criteria: StoppingCriteriaList):
    """
