# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\examples\demos\search\search_hybrid.py
import sys
...
def main():
    ...
    while True:
        ...
        # to the main thread
        input_ids = tokenizer(system_prompt(user_message), return_tensors="pt").input_ids
