# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\examples\demos\search\search_start.py
import sys
...
def plain_text_search(question: str, streamer: TextStreamer, stopping_criteria: StoppingCriteriaList):
    """
    ...
    if result:
        response = f"This line of the employee handbook might be relevant to you: {result}"
    else:
        response = (
