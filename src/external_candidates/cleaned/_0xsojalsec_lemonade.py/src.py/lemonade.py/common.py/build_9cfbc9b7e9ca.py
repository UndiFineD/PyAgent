# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\src\lemonade\common\build.py
import hashlib
import logging
import os
import sys
...
def load_yaml(file_path) -> Dict:
    with open(file_path, "r", encoding="utf8") as stream:
        try:
            ...
            raise exp.IOError(f"Failed while trying to open {file_path}.The exception that triggered this was:\n{e}")
