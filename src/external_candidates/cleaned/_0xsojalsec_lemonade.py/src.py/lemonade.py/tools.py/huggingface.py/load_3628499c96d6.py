# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\src\lemonade\tools\huggingface\load.py
import argparse
import json
...
class HuggingfaceLoad(FirstTool):
    ...
    def parser(add_help: bool = True) -> argparse.ArgumentParser:
        ...
        parser.add_argument(
            ...
            default=None,
            choices=choices,
            help="Move the model and inputs to a device using the .to() method (default: don't call the .to() method)",
        )
        ...
        parser.add_argument(
            ...
            default=True,
            type=bool,
            help="Whether to format the model in memory using channels-last (default: True)",
        )
    ...
    def run(
        ...
        try:
            ...
            tokenizer = transformers.AutoTokenizer.from_pretrained(checkpoint, **tokenizer_kwargs)
