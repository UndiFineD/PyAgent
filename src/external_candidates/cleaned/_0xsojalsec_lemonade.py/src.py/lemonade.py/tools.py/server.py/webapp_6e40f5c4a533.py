# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\src\lemonade\tools\server\webapp.py
import json
...
def get_webapp_html(port=8000):
    ...
    server_models_js = f"<script>window.SERVER_MODELS = {json.dumps(filtered_models)};</script>"
