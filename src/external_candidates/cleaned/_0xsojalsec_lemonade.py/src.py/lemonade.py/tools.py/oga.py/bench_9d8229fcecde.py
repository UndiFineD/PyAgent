# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-lemonade\src\lemonade\tools\oga\bench.py
import argparse
import statistics
...
class OgaBench(Bench):
    ...
    def run_prompt(
        ...
        self.prefill_tokens_per_second_list.append(len(input_ids) / mean_time_to_first_token)
