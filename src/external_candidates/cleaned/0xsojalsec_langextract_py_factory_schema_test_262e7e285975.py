# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\tests.py\factory_schema_test_262e7e285975.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\factory_schema_test.py
...
class FactorySchemaIntegrationTest(absltest.TestCase):
    ...
    def test_gemini_with_schema_returns_false_fence(self):
        ...
        config = factory.ModelConfig(model_id="gemini-2.5-flash", provider_kwargs={"api_key": "test_key"})
    ...
    def test_no_schema_defaults_to_true_fence(self):
        ...
        with mock.patch("langextract.providers.registry.resolve", return_value=NoSchemaModel):
...
class SchemaApplicationTest(absltest.TestCase):
    ...
    def test_apply_schema_called_when_supported(self):
        ...
        with mock.patch("langextract.providers.registry.resolve", return_value=SchemaAwareModel):
