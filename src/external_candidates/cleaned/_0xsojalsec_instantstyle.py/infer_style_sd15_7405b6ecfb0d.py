# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-InstantStyle\infer_style_sd15.py
import torch
...
if neg_content is not None:
    ...
    text_encoder = CLIPTextModelWithProjection.from_pretrained("laion/CLIP-ViT-H-14-laion2B-s32B-b79K").to(
        pipe.device, dtype=pipe.dtype
    )
