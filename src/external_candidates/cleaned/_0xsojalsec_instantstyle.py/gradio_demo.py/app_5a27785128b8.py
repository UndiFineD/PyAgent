# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-InstantStyle\gradio_demo\app.py
import sys
...
controlnet = ControlNetModel.from_pretrained(controlnet_path, use_safetensors=False, torch_dtype=torch.float16).to(
    device
)
