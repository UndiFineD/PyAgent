# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\getcomputers_4da33a67bcc8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getcomputers.py
...
class GetComputersCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="computer",
            required=False,
            help="Computer SamAccountName to fetch properties for",
        )
