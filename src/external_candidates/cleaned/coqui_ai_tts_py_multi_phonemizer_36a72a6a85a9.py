# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tts.py\tts.py\utils.py\text.py\phonemizers.py\multi_phonemizer_36a72a6a85a9.py
