# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Ovis-Image\ovis_image\model\autoencoder.py
...
class AutoEncoder(nn.Module):
    def __init__(self, params: AutoEncoderParams):
        ...
        self.post_quant_conv = (
            nn.Conv2d(params.z_channels, params.z_channels, 1) if params.use_post_quant_conv else None
        )
...
def load_ae(
    ...
    if not os.path.exists(ckpt_path):
        raise ValueError(f"Autoencoder path {ckpt_path} does not exist. Please download it first.")
