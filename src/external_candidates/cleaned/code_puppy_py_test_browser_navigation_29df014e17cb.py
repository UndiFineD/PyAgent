# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_browser_navigation_29df014e17cb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_navigation.py
    ...
    async def test_navigate_to_url_success(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.browser_navigation.emit_info"):
                with patch("code_puppy.tools.browser.browser_navigation.emit_success") as mock_emit_success:
