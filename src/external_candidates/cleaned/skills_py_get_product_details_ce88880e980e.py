# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\cgnl.py\supermarkt_prijzen.py\get_product_details_ce88880e980e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cgnl\supermarkt-prijzen\get-product-details.py
