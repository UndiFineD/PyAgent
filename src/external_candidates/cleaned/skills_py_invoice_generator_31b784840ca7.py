# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\digisal.py\youtrack_digisal.py\scripts.py\invoice_generator_31b784840ca7.py
...
class InvoiceGenerator:
    ...
    def get_project_time_data(self, project_id: str, from_date: Optional[str] = None) -> Dict[str, Any]:
        ...
        for issue in issues:
            ...
            total_minutes = sum(wi.get("duration", {}).get("minutes", 0) for wi in work_items)
