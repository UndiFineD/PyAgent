# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2016.py\triangle_of_power.py\end_e92475e6c682.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2016\triangle_of_power\end.py

from _2016.triangle_of_power.triangle import OPERATION_COLORS, TOP
...
class NotationReflectsMath(Scene):
    def construct(self):
        ...
        self.play(
            ShowCreationPerSubmobject(arrow, rate_func=lambda t: min(smooth(3 * t), 1)),
