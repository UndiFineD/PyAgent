# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanImage-2.1\hyimage\models\vae\hunyuanimage_vae.py
...
class HunyuanVAE2D(ModelMixin, ConfigMixin):
    ...
    def enable_spatial_tiling(self, use_tiling: bool = True):
        ...
        raise NotImplementedError(
            "Spatial tiling will lead to severe reconstruction artifacts with the pretrained VAE checkpoint!"
        )
