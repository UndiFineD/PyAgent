...
def load_text_encoder(
    ...
    if text_encoder_type == "llm":
        text_encoder = AutoModelForVision2Seq.from_pretrained(text_encoder_path, torch_dtype="auto")
    else:
...
class TextEncoder(nn.Module):
    ...
    def encode(
        ...
        if self.infer_mode == "encoder":
            ...
            attention_mask = (
                outputs.sequences[:, -output_max_valid_tokens - 1 : -1] != self.tokenizer.eos_token_id
            ).long()
