# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\durchblick_nl.py\protonmail.py\daily_scan_b116d9ee7c8d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\durchblick-nl\protonmail\daily-scan.py
...
def decode_mime(header):
    ...
    try:
        ...
        return "".join(p.decode(e or "utf-8", errors="replace") if isinstance(p, bytes) else p for p, e in decoded)
