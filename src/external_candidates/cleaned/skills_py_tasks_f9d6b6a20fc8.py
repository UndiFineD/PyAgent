# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\task_tracker.py\scripts.py\tasks_f9d6b6a20fc8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\task-tracker\scripts\tasks.py
...
def archive_done(args):
    ...
    from utils import ARCHIVE_DIR, TASKS_FILE, get_current_quarter
