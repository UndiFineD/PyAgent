# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-honeypots\honeypots\qbsniffer.py
"""
//  -------------------------------------------------------------
//  author        Giga
...
class QBSniffer:
    ...
    def scapy_sniffer_main(self):
        ...
        def capture_logic(packet):
            _layers, hex_payloads, raw_payloads, _fields, _raw, _hex = (
                [],
                {},
                {},
                {},
            ...
            for layer in _layers:
                try:
                    ...
                    _q_s.logs.error(
                        [
                            "errors",
                            {"error": "capture_logic_1", "type": "error -> " + repr(e)},
                        ]
                    )
            ...
            try:
                ...
                _q_s.logs.error(
                    [
                        "errors",
                        {"error": "capture_logic_5", "type": "error -> " + repr(e)},
                    ]
                )
