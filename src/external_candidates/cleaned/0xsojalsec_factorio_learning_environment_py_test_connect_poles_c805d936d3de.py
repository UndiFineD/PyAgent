# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\connect.py\test_connect_poles_c805d936d3de.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\connect\test_connect_poles.py

import pytest

from fle.env.entities import BuildingBox, Direction, EntityStatus, Position
