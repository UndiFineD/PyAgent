# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_llms_from_scratch.py\ch05.py\_01_main_chapter_code.py\tests_6e19353ba59d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMs-from-scratch\ch05\01_main-chapter-code\tests.py
