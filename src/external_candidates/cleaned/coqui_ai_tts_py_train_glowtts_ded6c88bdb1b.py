# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\recipes.py\thorsten_de.py\glow_tts.py\train_glowtts_ded6c88bdb1b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\recipes\thorsten_DE\glow_tts\train_glowtts.py
