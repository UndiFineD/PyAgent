# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\database_session_provider_2503687ff17a.py
...
class DatabaseSessionProvider:
    ...
    def __init__(self):
        ...
        self.async_engine = create_async_engine(
            ...
            pool_size=int(os.getenv("DB_POOL_SIZE", "40")),  # 🔧 Increase connection pool size (default 5 → 10)
            max_overflow=int(
