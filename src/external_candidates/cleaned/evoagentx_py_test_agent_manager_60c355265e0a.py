# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\tests.py\src.py\agents.py\test_agent_manager_60c355265e0a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\src\agents\test_agent_manager.py
