# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render.py\renderers.py\heat_pipe_8cba73064b51.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\renderers\heat_pipe.py
...
def is_entity_in_direction(entity: Optional[Dict], target: str, direction: int) -> int:
    ...
    return 1 if entity["name"] == target and entity.get("direction", 0) == direction else 0
