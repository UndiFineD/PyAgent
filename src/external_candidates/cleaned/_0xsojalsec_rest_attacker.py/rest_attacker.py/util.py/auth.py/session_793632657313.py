# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-REST-Attacker\rest_attacker\util\auth\session.py
...
class ROCookieSession(ROSession):
    ...
    def __init__(self, session_id: str, cookies: dict, test_url: str = None, expires: int = None) -> None:
        """
...
class ROWebSession(ROSession):
    ...
    def __init__(self, session_id: str, login_url: str, login_data: dict, test_url: str = None) -> None:
        """
    ...
    def setup(self) -> None:
        self.session = requests.Session()
        login_response = self.session.post(self.login_url, data=self.login_data)
...
class ROBrowserSession(ROSession):
    ...
    def __init__(self, session_id: str, executable: str, port: int, test_url: str = None) -> None:
        """
