# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-REST-Attacker\rest_attacker\util\response_handler.py
...
class AccessLimitHandler:
    ...
    def __init__(self, test_request: RequestInfo, auth_info: AuthRequestInfo, interval: int = 10) -> None:
        """
