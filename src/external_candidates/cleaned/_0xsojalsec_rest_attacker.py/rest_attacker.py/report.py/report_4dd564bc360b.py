# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-REST-Attacker\rest_attacker\report\report.py
...
class Report:
    ...
    def dump(self) -> dict:
        ...
        """
        output = {"report_id": self.report_id}
    ...
    def dumps(self, outformat: str = "json") -> str:
        ...
        if outformat == "json":
            ...
            raise ValueError(f"Format '{outformat}' unknown: Cannot be used to generate reports.")
