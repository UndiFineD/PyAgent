# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\tests.py\src.py\models.py\mock_response_f4d792dcac73.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\src\models\mock_response.py
...
def get_openai_chat_completion_chunk(
    usage_as_dict: bool = False,
) -> ChatCompletionChunk:
    usage = CompletionUsage(completion_tokens=1, prompt_tokens=22, total_tokens=23)
