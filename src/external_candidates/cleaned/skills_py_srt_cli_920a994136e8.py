# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\khj809.py\srt.py\scripts.py\srt_cli_920a994136e8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\khj809\srt\scripts\srt_cli.py
...
def main():
    ...
    reserve_parser.add_argument("--wait-seconds", type=int, default=10, help="재시도 대기 시간 (초, 기본값: 10)")

    # List command

    list_parser = subparsers.add_parser("list", help="예약 목록 조회")

    list_parser.add_argument("--format", choices=["table", "json"], default="table", help="출력 형식")
    ...
    log_parser.add_argument("--lines", "-n", type=int, default=20, help="표시할 라인 수 (기본값: 20)")
