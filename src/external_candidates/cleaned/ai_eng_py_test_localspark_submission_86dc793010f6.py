# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\unit.py\spark_provider.py\test_localspark_submission_86dc793010f6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\unit\spark_provider\test_localspark_submission.py
...
def test__local_spark_job_launcher__submit_feathr_job(
    ...
    mocked_spark_proc = mocker.patch(

        "feathr.spark_provider._localspark_submission.Popen", return_value=mocked_proc
