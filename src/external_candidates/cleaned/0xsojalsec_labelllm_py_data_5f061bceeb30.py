# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_labelllm.py\backend.py\app.py\schemas.py\data_5f061bceeb30.py
...
class DoDataForUser(DoDataBase):
    ...
    reference_evaluation: LabelEvaluation | None = Field(description="参考评价", default=None)
