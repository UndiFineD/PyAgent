# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\messages.py\conversion.py\sharegpt.py\hermes.py\hermes_function_formatter_eb10644ac109.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\messages\conversion\sharegpt\hermes\hermes_function_formatter.py
