# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\cloakai_softwares.py\moltgov.py\scripts.py\join_faction_333ca7d8cf73.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cloakai-softwares\moltgov\scripts\join_faction.py
