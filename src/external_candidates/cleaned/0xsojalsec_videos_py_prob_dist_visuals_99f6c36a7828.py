# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\prob_dist_visuals_99f6c36a7828.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\prob_dist_visuals.py
...
class ProbabilityDistributions(PiCreatureScene):
    ...
    def construct(self):
        ...
        self.play(
            dice_table_grouped_cells.space_out_submobjects,
            {"factor": 1.5},
