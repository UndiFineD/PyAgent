# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\benchmark.py\hotpotqa_b93b3628793f.py
...
def download_raw_hotpotqa_data(name: str, save_folder: str):
    assert name in VALIDE_RAW_HOTPOTQA_FILES, (
