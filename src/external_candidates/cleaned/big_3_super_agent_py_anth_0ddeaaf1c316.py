# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\big_3_super_agent.py\claude.py\hooks.py\utils.py\llm.py\anth_0ddeaaf1c316.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\big-3-super-agent\.claude\hooks\utils\llm\anth.py
