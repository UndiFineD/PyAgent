# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\ms365_tenant_manager.py\scripts.py\user_management_eda7930a5b0a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\ms365-tenant-manager\scripts\user_management.py
