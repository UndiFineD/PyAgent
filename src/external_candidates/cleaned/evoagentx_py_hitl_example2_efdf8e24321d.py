# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\hitl.py\hitl_example2_efdf8e24321d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\hitl\hitl_example2.py
...
from evoagentx.hitl import HITLManager, HITLUserInputCollectorAgent
...
async def main():
        ...
        outputs=[
            {
                ...
                "type": "string",
                "description": "profile summary based on user's information",
            },
            {
                "name": "recommendations",
                "type": "string",
                "description": "Personalized recommendations based on user information",
            },
        ],
            ...
            outputs=[
                {
                    "name": "profile_summary",
                    "type": "string",
                    "description": "user's profile summary",
                },
                {
                    "name": "recommendations",
                    "type": "string",
    ...
    edges = [WorkFlowEdge(source="user_input_collection_node", target="profile_processing_node")]
    ...
    workflow = WorkFlow(graph=graph, llm=llm, agent_manager=agent_manager, hitl_manager=hitl_manager)
