# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\agents.py\pack.py\watchdog_d74054c11630.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\agents\pack\watchdog.py
...
class WatchdogAgent(BaseAgent):
    ...
    def description(self) -> str:
        return "QA critic - vigilant guardian that ensures tests pass and quality standards are met"
