# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\keep.py\providers.py\embedding_cache_b2a21c03f494.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\keep\providers\embedding_cache.py
...
class EmbeddingCache:
    ...
    def put(self, model_name: str, content: str, embedding: list[float]) -> None:
        """
...
class CachingEmbeddingProvider:
    ...
    def __init__(self, provider: EmbeddingProvider, cache_path: Path, max_entries: int = 50000):
