# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\client\banner.py
import os
...
def module_count(nr_of_cloud_modules, nr_of_modules, all_count):
    print(
        "\t\t\t\t{} aws\t\t{} gcp\t\t{} azure\t\t{} office365".format(
    ...
    print(
        "\t\t\t\t{} docker\t{} kubernetes\t{} misc\t\t{} azuread".format(
    ...
    print(
        "\t\t\t\t{} modules\t{} cleanup\t\t{} detection".format(
            all_count, nr_of_modules["cleanup"], nr_of_modules["detection"]
        )
    )
    print(
        "\t\t\t\t{} enum\t\t{} exploit\t\t{} persistence".format(
            nr_of_modules["enum"],
            nr_of_modules["exploit"],
            nr_of_modules["persistence"],
        )
    )
    print(
        "\t\t\t\t{} listeners\t{} lateral movement\t{} detection bypass".format(
    ...
    print(
        "\t\t\t\t{} privesc\t{} reconnaissance\t{} stager".format(
    ...
    print(
        f"\t\t\t\t{nr_of_modules['misc']} misc\t\t{nr_of_modules['initialaccess']} initialaccess\t\t{nr_of_modules['postexploitation']} postexploitation"
    )
...
def module_count_without_banner(nr_of_cloud_modules, nr_of_modules, all_count):
    ...
    print(colored("-------------------------------------------------------------", "green"))
    print(
        "{} modules\t{} cleanup\t\t{} detection".format(all_count, nr_of_modules["cleanup"], nr_of_modules["detection"])
    )
    print(
        "{} enum\t\t{} exploit\t\t{} persistence".format(
            nr_of_modules["enum"],
