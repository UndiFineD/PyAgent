# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\privesc\azuread_add_user_to_group.py
import datetime
import json
import random
import string
...
def exploit(profile, workspace):
    ...
    try:
        data = {"@odata.id": "https://graph.microsoft.com/v1.0/directoryObjects/{}".format(user_id_or_upn)}

        output = requests.post(
            "https://graph.microsoft.com/v1.0/groups/{}/members/$ref".format(group_id),
            headers={
