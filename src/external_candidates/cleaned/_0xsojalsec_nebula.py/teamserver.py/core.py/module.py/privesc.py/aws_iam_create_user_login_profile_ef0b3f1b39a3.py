# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\privesc\aws_iam_create_user_login_profile.py
import random
import string
...
description = (
    "If an IAM user is not allowed to access the Management Console, you can allow it using a password you want."
)
...
def exploit(profile, workspace):
    ...
    while True:
        ...
        try:
            response = profile.create_login_profile(UserName=username, Password=password, PasswordResetRequired=True)
