# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\azuread_get_user_list.py
import datetime
import json
import random
import string
...
def exploit(profile, workspace):
    ...
    return {"DataType": {"DataType": "Users", "UserList": allInfo}}
