# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\aws_cloudtrail_enum_using_lookup_events.py
import datetime
import json
import re
import sys
...
def exploit(profile, workspace):
    ...
    if (lookup_attribute == "" and lookup_value != "") or (lookup_attribute != "" and lookup_value == ""):
        ...
        try:
            args["LookupAttributes"] = [{"AttributeKey": lookup_attribute, "AttributeValue": lookup_value}]
