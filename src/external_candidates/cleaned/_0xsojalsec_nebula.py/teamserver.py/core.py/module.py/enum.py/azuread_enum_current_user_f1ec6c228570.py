# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\enum\azuread_enum_current_user.py
import datetime
import json
import random
import string
...
def exploit(profile, workspace):
    ...
    return {"userPrincipalName": all_return_dict}
