# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\reconnaissance\misc_crtsh.py
import sys
...
def exploit(workspace):
    try:
        ...
        return_data = {"Domain": {"Domain": domain, "Domain List": dns_list}}

        database_data = {"dn_name": domain, "service": "None", "subdomains": dns_list}
