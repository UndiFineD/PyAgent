    ...
    try:
        if variables["BASENAME"]["value"] == "" and variables["WORDLIST"]["value"] != "":
            try:
                ...
                return {
                    "error": "File {} not found. Try adding the full path.".format(variables["WORDLIST"]["value"])
                }, 500
            ...
            for basename in file.readlines():
                ...
                try:
                    models.AzureServices.objects().get(azure_services_base_name=basename).update(**all_services)
