# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\reconnaissance\aws_s3_bucket_name_fuzzer.py
import os
import sys
...
def exploit(workspace):
    ...
    if variables["BUCKET"]["value"] == "" and variables["WORDLIST"]["value"] != "":
        ...
        return {"error": "Please put either BUCKET or WORDLIST. Not both, not none"}
    ...
    try:
        ...
        for s3object in buckets:
            try:
                ...
                models.AWSS3Bucket.objects().get(aws_s3_bucket_name=s3object["aws_s3_bucket_name"]).update(**s3object)
