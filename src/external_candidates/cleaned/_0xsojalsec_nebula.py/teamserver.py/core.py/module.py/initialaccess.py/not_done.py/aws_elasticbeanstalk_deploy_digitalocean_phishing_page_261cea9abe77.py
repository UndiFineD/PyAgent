...
def createElasticBeanStalkApp(profile, codebucket, s3Profile, projectname, iamProfile, projectrole):
    try:
        ...
        try:
            ...
            rolearn = iamProfile.create_role(RoleName=projectrole, AssumeRolePolicyDocument=rolepolicy)["Role"]["Arn"]
        ...
        profile.create_application_version(ApplicationName=projectname, VersionLabel="v1", SourceBundle=s3_source)
        ...
        status = profile.describe_environments(EnvironmentNames=[projectname])["Environments"][0]["Status"]
