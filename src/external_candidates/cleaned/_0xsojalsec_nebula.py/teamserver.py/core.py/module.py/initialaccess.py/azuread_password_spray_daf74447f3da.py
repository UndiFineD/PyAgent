    ...
    if theemail == "" and userfile == "":
        ...
        if not password == "":
            ...
            if "error" in return_info_dict:
                ...
                return {"email": {"email": email, "result": return_info_dict["message"]}}, 200
        else:
            ...
            return {"Wordlist": {"Wordlist": password_wordlist, "output": all_output}}, 200
    elif not userfile == "":
                    ...
                    for passw in userPass:
                        ...
                        if not state in [-1, 0, 1, 8, 9]:
                            try:
                                ...
                                e = str(e)
                                if "Tried to save duplicate unique keys" in e:
                                    models.AzureUsers.objects().get(azure_user_email=usermail).update(
                                        **single_user_info
                                    )
                                else:
                                    return {"error": e}, 500
