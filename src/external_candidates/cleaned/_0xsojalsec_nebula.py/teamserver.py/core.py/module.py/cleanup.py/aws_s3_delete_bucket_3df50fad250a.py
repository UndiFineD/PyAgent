# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Nebula\teamserver\core\module\cleanup\aws_s3_delete_bucket.py
import os
import sys
...
def exploit(profile, workspace):
    ...
    try:
        ...
        if "BucketNotEmpty" in str(e):
            ...
            status = f"Not Deleted: {str(e)}"
    return {"Bucket": {"Bucket": bucket, "Status": status}}
