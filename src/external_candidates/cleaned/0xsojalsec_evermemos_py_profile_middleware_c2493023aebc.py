# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\middleware.py\profile_middleware_c2493023aebc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\middleware\profile_middleware.py
...
class ProfileMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp):
        ...
        profiling_env = os.getenv("PROFILING_ENABLED", os.getenv("PROFILING", "true")).lower()
        ...
        if self._profiling_enabled:
            try:
                ...
                logger.info("Tip: Add ?profile=true parameter to the request URL to enable profiling")

            except ImportError:
                logger.warning("⚠️ pyinstrument not installed, profiling feature will be disabled")
