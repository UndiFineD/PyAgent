# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\test_pyduf_preprocessing_e2e_b836bce6fbee.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_pyduf_preprocessing_e2e.py
...
def add_new_surcharge_amount_and_pickup_column(df: DataFrame) -> DataFrame:
    ...
    df = df.withColumn(
        ...
        "new_improvement_surcharge", col("improvement_surcharge") + 1000000
...
def test_feature_swa_feature_gen_with_preprocessing():
    ...
    agg_features = [
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="new_fare_amount", agg_func="AVG", window="90d"
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="new_fare_amount", agg_func="MAX", window="90d"
    ...
    online_test_table = get_online_test_table_name(
        ...
        "nycTaxiCITableSWAFeatureMaterialization"
    ...
    res = client.get_online_features(
        ...
        online_test_table, "265", ["f_location_avg_fare", "f_location_max_fare"]
...
def test_feathr_get_offline_features_hdfs_source():
    ...
    agg_features = [
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="new_fare_amount", agg_func="SUM", window="90d"
    ...
    feature_query = [
        ...
        FeatureQuery(
            ...
            feature_list=["f_is_long_trip_distance", "f_day_of_week"],
    ...
    agg_features2 = [
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="new_tip_amount", agg_func="SUM", window="90d"
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="new_improvement_surcharge", agg_func="SUM", window="90d"
    ...
    agg_features3 = [
        ...
        Feature(
            ...
            transform=WindowAggTransformation(
                ...
                agg_expr="cast_double(old_tip_amount)", agg_func="SUM", window="90d"
    ...
    feature_query = [
        ...
        FeatureQuery(
            ...
            feature_list=[
                ...
                "f_location_max_improvement_surcharge",
...
def snowflake_preprocessing(df: DataFrame) -> DataFrame:
    ...
    df = df.withColumn(
        ...
        "NEW_CC_DIVISION_NAME",

        concat(col("CC_DIVISION_NAME"), lit("0000"), col("CC_DIVISION_NAME")),
