# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\robbyczgw_cla.py\sports_ticker.py\scripts.py\schedule_1750b26d5190.py
...
def get_all_fixtures_json(days: int = 14, team_name: str = None) -> list:
    ...
    for team in teams:
        ...
        if team_name:
            ...
            if name_lower not in team.get("name", "").lower() and name_lower not in team.get("short_name", "").lower():
                continue
