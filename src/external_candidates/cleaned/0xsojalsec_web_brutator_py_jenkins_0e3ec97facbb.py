# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\modules.py\jenkins_0e3ec97facbb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Jenkins.py
...
class Jenkins:
    ...
    def check(self):
        ...
        if r.status_code == 200 and 'name="j_password"' in r.text:
            ...
            logger.info("Jenkins administration console detected: {}".format(self.interface_url))
