# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_volweb.py\evidences.py\views_27aba378f350.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VolWeb\evidences\views.py
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if evidence_instance:
                ...
                return Response({"status": "Analysis launched"}, status=status.HTTP_202_ACCEPTED)
