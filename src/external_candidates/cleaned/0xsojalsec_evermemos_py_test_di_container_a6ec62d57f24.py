# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\di.py\tests.py\test_di_container_a6ec62d57f24.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\di\tests\test_di_container.py
...
class TestBeanRegistrationAndRetrieval:
    ...
    def test_register_and_get_single_bean(self):
        ...
        self.container.register_bean(bean_type=MySQLUserRepository, bean_name="mysql_repo")
    ...
    def test_register_multiple_implementations(self):
        ...
        self.container.register_bean(bean_type=MySQLUserRepository, bean_name="mysql_repo", is_primary=True)

        self.container.register_bean(bean_type=PostgreSQLUserRepository, bean_name="postgres_repo")
...
class TestPrimaryBeanSelection:
    ...
    def test_no_primary_bean_returns_first(self):
        ...
        self.container.register_bean(bean_type=MySQLUserRepository, bean_name="mysql_repo", is_primary=False)
...
class TestFactoryBeans:
    ...
    def test_factory_with_priority(self):
        ...
        self.container.register_bean(bean_type=MemoryCacheService, bean_name="memory_cache", is_primary=False)
...
class TestBeanOrdering:
    ...
    def test_ordering_primary_over_non_primary(self):
        ...
        self.container.register_bean(bean_type=SMSNotificationService, bean_name="sms", is_primary=False)

        self.container.register_bean(bean_type=EmailNotificationService, bean_name="email", is_primary=True)

        self.container.register_bean(bean_type=PushNotificationService, bean_name="push", is_primary=False)
