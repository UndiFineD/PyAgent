# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\verl.py\models.py\qwen2.py\megatron.py\checkpoint_utils.py\qwen2_saver_a245038740d2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\models\qwen2\megatron\checkpoint_utils\qwen2_saver.py
