# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\timverhoogt.py\ollama_local.py\scripts.py\ollama_8c0580ceb173.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\timverhoogt\ollama-local\scripts\ollama.py
...
def embeddings(model_name, text):
    ...
    result = api_request("/api/embeddings", method="POST", data={"model": model_name, "prompt": text})
