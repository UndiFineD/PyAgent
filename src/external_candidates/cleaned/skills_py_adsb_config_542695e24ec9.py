# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\davestarling.py\moltbot_adsb_overhead.py\scripts.py\adsb_config_542695e24ec9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\davestarling\moltbot-adsb-overhead\scripts\adsb_config.py
