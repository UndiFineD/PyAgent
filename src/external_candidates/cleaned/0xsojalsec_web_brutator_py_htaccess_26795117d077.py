# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\modules.py\htaccess_26795117d077.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Htaccess.py
...
class Htaccess:
    ...
    def check(self):
        ...
        if auth_type is not AuthMode.UNKNOWN:
            ...
            logger.info("HTTP Authentication detected: {}".format(self.interface_url))
