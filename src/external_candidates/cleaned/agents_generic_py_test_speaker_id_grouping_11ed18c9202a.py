# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\test_speaker_id_grouping_11ed18c9202a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_speaker_id_grouping.py
...
class TestSpeakerIdGrouping:
    ...
    def test_numeric_and_string_speaker_ids(self):
        ...
        assert result == ("[1]One Two[/1] [SPEAKER_A]Three Four[/SPEAKER_A] [User 123]Five Six[/User 123]")
    ...
    def test_ignored_speaker_ids(self):
        ...
        assert result == ("[1]One Two[/1] [USER_123]Five Six[/USER_123] [__But_Not_Me__]Nine Ten[/__But_Not_Me__]")
