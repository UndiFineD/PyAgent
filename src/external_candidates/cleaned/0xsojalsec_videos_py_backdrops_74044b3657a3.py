# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\custom.py\backdrops_74044b3657a3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\custom\backdrops.py

from manimlib.animation.creation import Write

from manimlib.constants import BLACK, BLUE, DOWN, UP, WHITE
...
class VideoWrapper(Scene):
    ...
    title_config = dict(font_size=60)
