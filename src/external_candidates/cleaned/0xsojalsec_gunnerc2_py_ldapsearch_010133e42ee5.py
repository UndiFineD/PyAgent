# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\bofs.py\active_directory.py\ldapsearch.py\ldapsearch_010133e42ee5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\bofs\Active_Directory\ldapsearch\ldapsearch.py
...
"""
    ...
    def args_inject(p):
        ...
        p.add_argument(
            ...
            "--attributes",
            default="*",
            help="Comma-separated attributes (default: *)",
        )
        ...
        p.add_argument(
            ...
            choices=(1, 2, 3),
            default=3,
            help="1=BASE, 2=LEVEL, 3=SUBTREE (default: 3)",
        )
