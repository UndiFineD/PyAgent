# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Lumina-DiMOO\scripts\inference_t2i_ddp.py
# -*- coding: utf-8 -*-
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Prompt file path(.json/.jsonl/.txt)",
    )
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="results_text_to_image_ddp",
        help="Output directory",
    )
    parser.add_argument(
        "--output_json",
        type=str,
        default="results_text_to_image_ddp/results.json",
