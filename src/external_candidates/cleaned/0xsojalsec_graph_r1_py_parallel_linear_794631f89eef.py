# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\verl.py\models.py\qwen2.py\megatron.py\layers.py\parallel_linear_794631f89eef.py
