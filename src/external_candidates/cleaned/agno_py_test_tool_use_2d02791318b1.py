# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\models.py\azure.py\openai.py\test_tool_use_2d02791318b1.py
