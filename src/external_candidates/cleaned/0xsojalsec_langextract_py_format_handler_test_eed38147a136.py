# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\tests.py\format_handler_test_eed38147a136.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\format_handler_test.py
...
class FormatHandlerTest(parameterized.TestCase):
    ...
    """).strip()
        ...
        self.assertEqual(extractions[0].extraction_text, "Bob", "Extraction text should be 'Bob'")
