# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\tdd_guide.py\scripts.py\format_detector_713825216371.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\tdd-guide\scripts\format_detector.py
...
class FormatDetector:
    ...
    def extract_file_info(self, file_path: str) -> Dict[str, str]:
        ...
        is_test = any(pattern in file_name.lower() for pattern in ["test", "spec", "_test.", ".test."])
