# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\android_action_kernel.py\llm_providers_52c27d558ecf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\android-action-kernel\llm_providers.py
...
class OpenAIProvider(LLMProvider):
    ...
    def __init__(self):
        ...
        if Config.LLM_PROVIDER == "groq":
            self.client = OpenAI(api_key=Config.GROQ_API_KEY, base_url=GROQ_API_BASE_URL)
...
class BedrockProvider(LLMProvider):
    ...
    def __init__(self):
        ...
        self.client = boto3.client(service_name="bedrock-runtime", region_name=Config.AWS_REGION)
