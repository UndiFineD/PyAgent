# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\plugins.py\frontend_emitter.py\register_callbacks_5b84b32e3613.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\frontend_emitter\register_callbacks.py
...
async def on_pre_tool_call(tool_name: str, tool_args: Dict[str, Any], context: Any = None) -> None:
...
async def on_stream_event(event_type: str, event_data: Any, agent_session_id: Optional[str] = None) -> None:
