# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2022.py\quintic.py\cubic_abb198609aea.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2022\quintic\cubic.py
...
class CubicFormula(RootCoefScene):
    ...
    def add_lower_planes(self):
        ...
        sqrt_label = OldTex("\\delta_1, \\delta_2 = \\sqrt{ \\frac{q^2}{4} + \\frac{p^3}{27}}", **kw)
    ...
    def add_cf_dots(self):
        ...
        alt_root_dots.add_updater(lambda m: m.set_points(list(map(self.cf_plane.n2p, self.get_roots()))))
