# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\vocoder\models\wavegrad.py
import os
...
class Wavegrad(BaseVocoder):
    ...
    def __init__(self, config: Coqpit):
        ...
        for oc, df in zip(
            config.model_params.dblock_out_channels,
            reversed(config.model_params.upsample_factors),
        ):
        ...
        self.x_conv = Conv1d(
            ...
            config.model_params.x_conv_channels,
            3,
            padding=1,
        )
