# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\layers\xtts\trainer\gpt_trainer.py
import logging
...
class GPTTrainer(BaseTTS):
    def __init__(self, config: Coqpit):
        ...
        self.torch_mel_spectrogram_dvae = TorchMelSpectrogram(
            mel_norm_file=self.args.mel_norm_file,
            sampling_rate=config.audio.dvae_sample_rate,
        )
