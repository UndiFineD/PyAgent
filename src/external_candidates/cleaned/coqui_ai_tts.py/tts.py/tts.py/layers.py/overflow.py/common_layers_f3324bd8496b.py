# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\layers\overflow\common_layers.py
import logging
...
class ParameterModel(nn.Module):
    ...
    def __init__(
        ...
        self.flat_start_output_layer(
            flat_start_params["mean"],
            flat_start_params["std"],
            flat_start_params["transition_p"],
        )
