# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\santyr.py\skill_hexmem.py\embed_e9fa8612d216.py
...
def main():
    ...
    parser.add_argument("--init-vec", action="store_true", help="Initialize vec0 virtual tables")
    ...
    parser.add_argument("--source", type=str, help="Limit search to source table (events, lessons, etc)")

    parser.add_argument("--stats", action="store_true", help="Show embedding queue stats")
