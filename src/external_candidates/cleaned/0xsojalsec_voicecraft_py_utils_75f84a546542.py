# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_voicecraft.py\models.py\modules.py\utils_75f84a546542.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VoiceCraft\models\modules\utils.py
