# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\adamkristopher.py\seo_dataforseo.py\scripts.py\core.py\client_57bd3631176a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adamkristopher\seo-dataforseo\scripts\core\client.py
...
class DataForSEOClient:
    ...
    def _initialize(self):
        ...
        self._configuration = dfs_config.Configuration(
            username=settings.DATAFORSEO_LOGIN, password=settings.DATAFORSEO_PASSWORD
        )
