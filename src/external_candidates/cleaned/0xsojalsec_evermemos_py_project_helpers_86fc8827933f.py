# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\memory_layer.py\memory_extractor.py\profile_memory.py\project_helpers_86fc8827933f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\memory_extractor\profile_memory\project_helpers.py
...
def merge_projects_participated(
    ...
    for project in incoming_projects or []:
        ...
        if match:
            ...
            match.user_objective = merge_value_with_evidences_lists(match.user_objective, project.user_objective)

            match.contributions = merge_value_with_evidences_lists(match.contributions, project.contributions)

            match.user_concerns = merge_value_with_evidences_lists(match.user_concerns, project.user_concerns)
