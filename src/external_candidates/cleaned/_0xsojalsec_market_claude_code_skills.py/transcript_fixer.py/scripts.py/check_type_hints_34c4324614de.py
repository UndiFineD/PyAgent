    ...
    def visit_FunctionDef(self, node: ast.FunctionDef) -> None:
        ...
        if node.returns is not None:
            ...
            if has_return:
                ...
                self.stats.missing_hints.append(f"  Line {node.lineno}: Function '{context}' missing return type")
...
def main():
    ...
    overall_coverage = (
        ((total_functions_typed + total_parameters_typed) / (total_functions + total_parameters) * 100)
