...
class CorrectionRepository:
    ...
    def __init__(self, db_path: Path, max_connections: int = 5):
        ...
        self._pool = ConnectionPool(db_path=self.db_path, max_connections=max_connections)
    ...
    def add_correction(
        ...
        try:
            from_text, to_text, domain, source, notes, added_by = validate_correction_inputs(
