# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\health_check.py
#!/usr/bin/env python3
"""
    ...
    def _check_database_schema(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                duration_ms=(time.time() - start_time) * 1000,
                details={"tables": actual_tables, "count": len(actual_tables)},
            )
