# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\diff_generator.py
#!/usr/bin/env python3
"""
...
def generate_full_report(original_file: str, stage1_file: str, stage2_file: str, output_dir: str = None):
    """
    ...
    md_report = generate_markdown_report(original_file, stage1_file, stage2_file, original, stage1, stage2)
