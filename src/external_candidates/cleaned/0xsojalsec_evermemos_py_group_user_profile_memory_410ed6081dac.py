# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\document.py\memory.py\group_user_profile_memory_410ed6081dac.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\persistence\document\memory\group_user_profile_memory.py
...
class GroupUserProfileMemory(DocumentBase, AuditBase):
    ...
    output_reasoning: Optional[str] = Field(default=None, description="Reasoning explanation for this output")
