# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tts.py\tts.py\layers.py\generic.py\time_depth_sep_conv_845ef0325438.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\TTS\tts\layers\generic\time_depth_sep_conv.py
...
class TimeDepthSeparableConvBlock(nn.Module):
    def __init__(
        ...
        layer = TimeDepthSeparableConv(
            in_channels,
            hid_channels,
            out_channels if num_layers == 1 else hid_channels,
            kernel_size,
            bias,
        )
