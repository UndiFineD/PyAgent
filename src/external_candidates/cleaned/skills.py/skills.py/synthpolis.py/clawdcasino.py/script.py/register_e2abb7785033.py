# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synthpolis\clawdcasino\script\register.py
#!/usr/bin/env python3
"""
...
The --save flag automatically saves your API key to .env
    ...
    parser.add_argument("--name", help="Your agent display name (optional, defaults to 'Anonymous')")
    parser.add_argument(
        "--save",
        action="store_true",
        help="Save API key to .env file (recommended!)",
    )
    parser.add_argument("--skill-version", help="Skill version for compatibility tracking")
