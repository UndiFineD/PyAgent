# Extracted from: C:\DEV\PyAgent\.external\skills\skills\zeph-ai-dev\identity-anchor\scripts\identity.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument(
        "command",
        choices=["init", "sign", "verify", "sign-content", "history", "pubkey"],
    )
