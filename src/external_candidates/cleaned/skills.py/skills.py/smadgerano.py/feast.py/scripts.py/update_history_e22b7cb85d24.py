# Extracted from: C:\DEV\PyAgent\.external\skills\skills\smadgerano\feast\scripts\update-history.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    existing = [m for m in history["meals"] if m.get("date") == args.date and m.get("name") == args.name]
