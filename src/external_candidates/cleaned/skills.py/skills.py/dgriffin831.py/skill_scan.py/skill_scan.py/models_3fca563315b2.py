# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dgriffin831\skill-scan\skill_scan\models.py
...
def report_to_dict(report: dict) -> dict:
    ...
    out["behavioralSignatures"] = [
        s.to_dict() if isinstance(s, BehavioralSignature) else s for s in report.get("behavioralSignatures", [])
    ]
    return out
