# Extracted from: C:\DEV\PyAgent\.external\skills\skills\red777777\inkedin-automation-that-really-works\scripts\lib\analytics.py
#!/usr/bin/env python3
...
def get_post_analytics(count=10):
    ...
    with browser_session() as (ctx, page):
        ...
        page.goto(
            f"https://www.linkedin.com/in/{profile_slug}/recent-activity/all/",
            wait_until="domcontentloaded",
            timeout=30000,
        )
        time.sleep(5)
