# Extracted from: C:\DEV\PyAgent\.external\skills\skills\red777777\inkedin-automation-that-really-works\scripts\lib\selectors.py
#!/usr/bin/env python3
...
def insert_mention(page, textbox, full_name, max_retries=2):
    ...
    for attempt in range(max_retries + 1):
        ...
        return {
            "success": True,
            "method": "typeahead_chip" if chip_found else "typeahead_click",
            "name": full_name,
            "attempt": attempt + 1,
        }
