# Extracted from: C:\DEV\PyAgent\.external\skills\skills\totaleasy\crypto-self-learning\scripts\log_trade.py
#!/usr/bin/env python3
"""
...
def log_trade(args):
    ...
    print(
        f"{emoji} Trade logged: {trade['symbol']} {trade['direction']} | PnL: {trade['pnl_percent']:+.2f}% | ID: {trade['id']}"
    )
    return trade
