...
class OuraClient:
    ...
    def get_daily_activity(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get daily activity data."""
        return self._get_date_range_data("usercollection/daily_activity", start_date, end_date, next_token)

    def get_daily_sleep(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get daily sleep data."""
        return self._get_date_range_data("usercollection/daily_sleep", start_date, end_date, next_token)

    def get_daily_readiness(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get daily readiness data."""
        return self._get_date_range_data("usercollection/daily_readiness", start_date, end_date, next_token)

    def get_daily_spo2(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get daily SpO2 data."""
        return self._get_date_range_data("usercollection/daily_spo2", start_date, end_date, next_token)

    def get_daily_stress(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get daily stress data."""
        return self._get_date_range_data("usercollection/daily_stress", start_date, end_date, next_token)

    def get_heartrate(self, start_datetime: str, end_datetime: str, next_token: str | None = None) -> dict[str, Any]:
    ...
    def get_workouts(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get workout data."""
        return self._get_date_range_data("usercollection/workout", start_date, end_date, next_token)

    def get_sessions(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get session data."""
        return self._get_date_range_data("usercollection/session", start_date, end_date, next_token)

    def get_tags(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get tag data."""
        return self._get_date_range_data("usercollection/tag", start_date, end_date, next_token)

    def get_rest_mode_periods(self, start_date: str, end_date: str, next_token: str | None = None) -> dict[str, Any]:
        """Get rest mode periods."""
        return self._get_date_range_data("usercollection/rest_mode_period", start_date, end_date, next_token)
