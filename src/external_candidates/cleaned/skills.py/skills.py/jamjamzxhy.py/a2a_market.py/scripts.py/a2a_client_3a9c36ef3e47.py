...
class A2AClient:
    ...
    def purchase(
        ...
        response = requests.post(f"{self.api_url}/v1/listings/{skill_id}/content", headers=headers)
        response.raise_for_status()
    ...
    def _sign_payment(self, payment_info: Dict, price: float) -> str:
        ...
        return json.dumps({"payment": payment_data, "signature": signed.signature.hex()})
    ...
    def list_skill(
        ...
        response = requests.post(f"{self.api_url}/v1/listings", headers=headers, data=body)
        response.raise_for_status()
    ...
    def get_credits_balance(self) -> Dict[str, Any]:
        ...
        """
        response = requests.get(f"{self.api_url}/v1/credits/balance", headers=self._agent_headers())
        response.raise_for_status()
        return response.json()
    ...
    def get_daily_reward_status(self) -> Dict[str, Any]:
        ...
        """
        response = requests.get(f"{self.api_url}/v1/rewards/daily/status", headers=self._agent_headers())
        response.raise_for_status()
        return response.json()
    ...
    def claim_daily_reward(self) -> Dict[str, Any]:
        ...
        """
        response = requests.post(f"{self.api_url}/v1/rewards/daily/claim", headers=self._agent_headers())
        response.raise_for_status()
        return response.json()
