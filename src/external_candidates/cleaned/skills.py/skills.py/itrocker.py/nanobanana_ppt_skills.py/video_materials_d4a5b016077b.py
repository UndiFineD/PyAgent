            ...
            tasks.append(
                {
                    ...
                    "content_context": (
                        content_contexts[i] if content_contexts and i < len(content_contexts) else None
                    ),
                }
            )
        ...
        with ThreadPoolExecutor(max_workers=self.max_concurrent) as executor:
            ...
            for future in as_completed(future_to_task):
                ...
                if result["success"]:
                    ...
                    failed_count += 1
                    print(
                        f"  [{completed_count}/{num_transitions}] Transition {transition_key} failed: {result['error']}"
                    )
