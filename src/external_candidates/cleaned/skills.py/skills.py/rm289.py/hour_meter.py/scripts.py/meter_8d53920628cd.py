...
def generate_mailto_link(meter_name: str, paper_code: str, full_hash: str, description: str, lock_time: str) -> str:
...
def cmd_lock(args):
    ...
    witness_path = append_witness(args.name, paper_code, full_hash, lock_time.isoformat())
    print(f"       {witness_path}")
    print(f"       (Sync this folder to Dropbox/iCloud/Google Drive)")
    print()

    # Generate mailto link
    mailto_link = generate_mailto_link(args.name, paper_code, full_hash, meter.get("description", ""), lock_time_str)
