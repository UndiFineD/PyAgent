...
def create_competitor_table(competitors, styles):
    ...
    cell_style_bold = ParagraphStyle("TableCellBold", parent=cell_style, fontName="Helvetica-Bold")
...
def generate_pdf(data, output_path):
    ...
    if data.get("lead_gen"):
        ...
        if kw.get("primary"):
            ...
            story.append(
                Paragraph(
                    "  ".join([f'<font color="#3b82f6">[{k}]</font>' for k in kw["primary"]]),
                    styles["TagText"],
                )
            )
        ...
        if kw.get("vertical"):
            ...
            story.append(
                Paragraph(
                    "  ".join([f'<font color="#10b981">[{k}]</font>' for k in kw["vertical"]]),
                    styles["TagText"],
                )
            )
        ...
        if kw.get("technology"):
            ...
            story.append(
                Paragraph(
                    "  ".join([f'<font color="#8b5cf6">[{k}]</font>' for k in kw["technology"]]),
                    styles["TagText"],
                )
            )
        ...
        if kw.get("pain_point"):
            ...
            story.append(
                Paragraph(
                    "  ".join([f'<font color="#f59e0b">[{k}]</font>' for k in kw["pain_point"]]),
                    styles["TagText"],
                )
            )
