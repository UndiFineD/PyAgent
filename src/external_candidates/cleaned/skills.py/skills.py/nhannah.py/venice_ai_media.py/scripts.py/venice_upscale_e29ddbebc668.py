...
def upscale_image_from_file(
    ...
    if enhance_creativity is not None:
        parts.append(
            f'--{boundary}\r\nContent-Disposition: form-data; name="enhanceCreativity"\r\n\r\n{enhance_creativity}\r\n'
        )

    if replication is not None:
        parts.append(f'--{boundary}\r\nContent-Disposition: form-data; name="replication"\r\n\r\n{replication}\r\n')
...
def main() -> int:
    ...
    ap.add_argument("--enhance", action="store_true", help="Apply AI enhancement during upscale")
