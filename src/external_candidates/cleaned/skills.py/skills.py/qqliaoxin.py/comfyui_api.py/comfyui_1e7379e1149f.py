# Extracted from: C:\DEV\PyAgent\.external\skills\skills\qqliaoxin\comfyui-api\comfyui.py
"""
...
class ComfyUI:
    ...
    async def _build_workflow_async(
        self,
        user_prompt: str,
        width: int = 512,
        height: int = 512,
        ...
        return {
            ...
            "5": {
                "inputs": {"text": translated_prompt, "clip": ["3", 1]},
    ...
    def _build_workflow(
        ...
        return {
            ...
            "5": {
                "inputs": {"text": user_prompt, "clip": ["3", 1]},
                "class_type": "CLIPTextEncode",
            },
            "6": {
                "inputs": {
