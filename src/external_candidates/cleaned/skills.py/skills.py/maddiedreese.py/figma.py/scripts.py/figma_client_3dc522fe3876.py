# Extracted from: C:\DEV\PyAgent\.external\skills\skills\maddiedreese\figma\scripts\figma_client.py
#!/usr/bin/env python3
"""
...
class FigmaClient:
    ...
    def __init__(self, access_token: str = None):
        self.config = FigmaConfig(access_token=access_token or os.getenv("FIGMA_ACCESS_TOKEN"))
    ...
    def export_images(
        ...
        **params,
        ...
        params.update({"ids": node_ids, "format": format, "scale": scale})
...
def main():
    ...
    try:
        ...
        if args.command == "get-file":
            ...
            file_key = client.parse_file_url(args.file_key)
            result = client.export_images(file_key, args.node_ids.split(","), format=args.format, scale=args.scale)
