# Extracted from: C:\DEV\PyAgent\.external\skills\skills\maddiedreese\figma\scripts\export_manager.py
#!/usr/bin/env python3
"""
        ...
        for node in nodes:
            ...
            for format in self.config.formats:
                for scale in self.config.scales:
                    ...
                    try:
                        export_data = self.client.export_images(file_key, [node_id], format=format, scale=scale)
