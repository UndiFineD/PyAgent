    ...
    def _check_touch_targets(self, file_data: Dict[str, Any], results: Dict[str, Any]):
        ...
        def check_node_size(node):
            ...
            is_interactive = (
                ...
                and any(keyword in node_name for keyword in ["btn", "tap", "click", "interactive"])
            )
        ...
        def check_focus_states(node):
            ...
            if is_interactive:
                ...
                has_focus_indicator = any(
                    "focus" in str(effect).lower() or effect.get("type") == "DROP_SHADOW" for effect in effects
                )
                    ...
                    results["issues"].append(
                        {
                            ...
                            "details": {"suggestion": "Add visible focus state for keyboard navigation"},
                        }
                    )
