# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jiasenl\clawdbot-skill-homebridge\scripts\homebridge_api.py
#!/usr/bin/env python3
"""
...
def load_config() -> dict:
    ...
    if not config_path.exists():
        ...
        print(
            'Create it with: {"url": "...", "username": "...", "password": "..."}',
            file=sys.stderr,
        )
        sys.exit(1)
...
def set_characteristic(base_url: str, token: str, accessory_id: str, characteristic: str, value) -> dict:
    ...
    data = {"characteristicType": characteristic, "value": value}
...
def main():
    ...
    if args.command == "list":
        ...
        result = set_characteristic(base_url, token, args.accessory_id, args.characteristic, args.value)
