# Extracted from: C:\DEV\PyAgent\.external\skills\skills\bvinci1-design\skill-scanner\streamlit_ui.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    st.markdown(
        '<p class="sub-header">Security audit tool for Clawdbot/MCP skills - scans for malware, spyware, crypto-mining, and malicious patterns</p>',
        unsafe_allow_html=True,
    )
