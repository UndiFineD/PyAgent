...
def main():
    ...
    parser = argparse.ArgumentParser(description="Interpret code at multiple levels of meaning")
    ...
    parser.add_argument("--self", action="store_true", help="Interpret this very script")
