...
class Universe:
    ...
    def _generate_planet(self, star: Star, orbit_index: int) -> Planet:
        ...
        if (
            in_habitable_zone and planet.habitable_score() > 0.6 and self.constants.allows_life() and star.age > 1.0
    ...
    def _generate_star(self) -> Star:
        ...
        star = Star(name=self._generate_star_name(), star_type=star_type, mass=mass, age=age)
