...
def main():
    ...
    parser.add_argument("-o", "--output", default="qwen_output.wav", help="Output audio file path")
    parser.add_argument(
        "-s",
        "--speaker",
    ...
    parser.add_argument("-i", "--instruct", default="", help="Voice instruction (emotion, style)")
    parser.add_argument(
        "--remote",
