# Extracted from: C:\DEV\PyAgent\.external\skills\skills\briansmith80\zoho-email-integration\examples\batch-cleanup.py
#!/usr/bin/env python3
"""
...
Examples:
  ...
  python3 batch-cleanup.py --old-emails --days 30 --execute
    ...
    parser.add_argument("--newsletters", action="store_true", help="Clean up newsletter emails")
    parser.add_argument("--old-emails", action="store_true", help="Clean up old read emails")
    parser.add_argument(
        "--days",
        type=int,
        default=30,
