# Extracted from: C:\DEV\PyAgent\.external\skills\skills\administratorfung\news-aggregator-skill-3\scripts\fetch_news.py
import argparse
...
def main():
    ...
    parser.add_argument(
        "--deep",
        action="store_true",
        help="Download article content for detailed summarization",
    )
