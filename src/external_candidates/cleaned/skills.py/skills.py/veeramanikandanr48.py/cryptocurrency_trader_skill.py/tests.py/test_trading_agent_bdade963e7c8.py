# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\cryptocurrency-trader-skill\tests\test_trading_agent.py
#!/usr/bin/env python3
"""
...
def test_with_simulated_data():
    ...
    timeframe_data = {"1h": indicators, "4h": indicators}  # Using same for simplicity
    ...
    if consensus["stop_loss"]:
        ...
        position = agent._calculate_position_size(consensus["entry_price"], consensus["stop_loss"], 10000)
