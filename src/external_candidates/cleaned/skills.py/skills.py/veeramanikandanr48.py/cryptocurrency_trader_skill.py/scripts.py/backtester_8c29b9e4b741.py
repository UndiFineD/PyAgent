...
class Backtester:
    ...
    def calculate_position_size(self, entry_price: float, stop_loss: float, side: str) -> float:
        """
    ...
    def close_position(self, exit_price: float, exit_reason: str, timestamp: datetime) -> Optional[Trade]:
        """
        ...
        executed_price = self.apply_slippage(exit_price, "SHORT" if self.position.side == "LONG" else "LONG")
