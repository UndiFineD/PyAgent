# Extracted from: C:\DEV\PyAgent\.external\skills\skills\urosorozel\emporia-energy\scripts\emporia_esphome.py
#!/usr/bin/env python3
import asyncio
import base64
import sys
...
def main(argv):
    ...
    if command == "list":
        payload = {
            ...
            "mode": "esphome",
            "count": len(channels),
            "channels": [{"key": ch["key"], "name": ch["name"], "unit": ch["unit"]} for ch in channels],
        }
        print_json(payload)
        return
