# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jb-fliz\fliz-ai-video-generator\scripts\test_connection.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument("--api-key", "-k", help="Fliz API key (or set FLIZ_API_KEY env var)")
