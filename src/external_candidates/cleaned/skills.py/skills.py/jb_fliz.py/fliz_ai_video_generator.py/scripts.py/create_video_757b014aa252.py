# Extracted from: C:\DEV\PyAgent\.external\skills\skills\jb-fliz\fliz-ai-video-generator\scripts\create_video.py
#!/usr/bin/env python3
"""
...
def create_video(api_key: str, params: dict) -> dict:
    ...
    try:
        response = requests.post(f"{BASE_URL}/api/rest/video", headers=headers, json=body, timeout=TIMEOUT)
