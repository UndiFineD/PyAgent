# Extracted from: C:\DEV\PyAgent\.external\skills\skills\andrewdmwalker\phantombuster\pb.py
#!/usr/bin/env python3
...
def get_api_key():
    ...
    if not api_key:
        ...
        print(
            "Get your key at: https://phantombuster.com/workspace-settings",
            file=sys.stderr,
        )
        sys.exit(1)
    return api_key
...
def cmd_status(args):
    ...
    status_emoji = {"finished": "✅", "error": "❌", "running": "🔄"}.get(last_status, "❓")
