# Extracted from: C:\DEV\PyAgent\.external\skills\skills\andrewdmwalker\geo-optimization\scripts\geo-daily-report.py
#!/usr/bin/env python3
"""
...
**Status by Category:**"""
    ...
    # Top gaps
    critical_gaps = [
        r for r in results if r.get("priority") == "critical" and r.get("expected") and not r.get("actual_cited")
    ]
    if critical_gaps:
