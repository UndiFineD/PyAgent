...
"""
    ...
    def add_transaction(self, amount: int, description: str, category: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def search(self, query: str) -> List[Dict[str, Any]]:
        ...
        results = [tx for tx in data["transactions"] if query_lower in tx["description"].lower()]
