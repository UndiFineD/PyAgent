# Extracted from: C:\DEV\PyAgent\.external\skills\skills\araa47\ez-google\scripts\people.py
#!/usr/bin/env python3
# /// script
...
def search(query: str):
    ...
    service = get_service()
    results = service.people().searchContacts(query=query, readMask="names,emailAddresses,phoneNumbers").execute()
