# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ddrayne\bbc-news\scripts\bbc_news.py
#!/usr/bin/env python3
"""
...
Examples:
  ...
  %(prog)s --list                   # List all available sections
    ...
    parser.add_argument("section", nargs="?", default="top", help="News section (default: top)")
    parser.add_argument(
        "-l",
        "--limit",
        type=int,
