# Extracted from: C:\DEV\PyAgent\.external\skills\skills\heiheimaoya\xiaohongshu\scripts\xhs_tool.py
#!/usr/bin/env python3
"""
小红书工具 - 使用内置签名
"""
...
def cmd_publish(args):
    ...
    result = client.create_image_note(title=args.title[:20], desc=desc, files=images, is_private=args.private)
