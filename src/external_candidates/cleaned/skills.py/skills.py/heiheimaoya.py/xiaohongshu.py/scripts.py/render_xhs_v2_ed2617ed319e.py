# Extracted from: C:\DEV\PyAgent\.external\skills\skills\heiheimaoya\xiaohongshu\scripts\render_xhs_v2.py
#!/usr/bin/env python3
"""
小红书卡片渲染脚本 V2 - 智能分页版
...
def generate_card_html(content: str, page_number: int = 1, total_pages: int = 1, style_key: str = "purple") -> str:
    """生成正文卡片 HTML"""
    style = STYLES.get(style_key, STYLES["purple"])
...
async def process_and_render_cards(card_contents: List[str], output_dir: str, style_key: str) -> List[str]:
    """
