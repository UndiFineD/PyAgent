...
class WhoopClient:
    ...
    def _refresh_access_token(self):
        ...
        if not self.refresh_token:
            raise ValueError("No refresh token available. Re-run the authorization flow.")
    ...
    def iter_recovery(self, start: Optional[str] = None, end: Optional[str] = None) -> Iterator[Dict[str, Any]]:
    ...
    def iter_sleep(self, start: Optional[str] = None, end: Optional[str] = None) -> Iterator[Dict[str, Any]]:
    ...
    def iter_cycles(self, start: Optional[str] = None, end: Optional[str] = None) -> Iterator[Dict[str, Any]]:
    ...
    def iter_workouts(self, start: Optional[str] = None, end: Optional[str] = None) -> Iterator[Dict[str, Any]]:
