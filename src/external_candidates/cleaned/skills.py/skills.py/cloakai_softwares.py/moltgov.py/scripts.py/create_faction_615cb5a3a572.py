# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cloakai-softwares\moltgov\scripts\create_faction.py
#!/usr/bin/env python3
...
def main():
    ...
    parser.add_argument("--founding-members", required=True, help="Comma-separated citizen IDs (min 5)")
