# Extracted from: C:\DEV\PyAgent\.external\skills\skills\abhinavjp\ms-outlook-teams-assistant\scripts\teams_scan.py
            ...
            items.append(
                {
                    ...
                    "myReplyCreated": (
                        latest_my_reply_dt.isoformat(timespec="seconds") if latest_my_reply_dt else None
                    ),
