# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adamkristopher\seo-dataforseo\scripts\api\serp.py
...
def get_google_maps_serp(
    ...
    try:
        ...
        if save:
            save_result(result, category="serp", operation="google_maps", keyword=keyword)
...
def get_google_news_serp(
    ...
    try:
        ...
        if save:
            save_result(result, category="serp", operation="google_news", keyword=keyword)
...
def get_google_images_serp(
    ...
    try:
        ...
        if save:
            save_result(result, category="serp", operation="google_images", keyword=keyword)
...
def get_featured_snippet(
    ...
    try:
        ...
        if save:
            save_result(result, category="serp", operation="featured_snippet", keyword=keyword)
