# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ty-teo\xiaohongshu-scraper\scripts\legacy\login.py
#!/usr/bin/env python3
"""
小红书登录脚本
...
def login_xiaohongshu():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # 提取关键 cookie 用于 API
            cookie_str = "; ".join(
                [f"{c['name']}={c['value']}" for c in cookies if "xiaohongshu" in c.get("domain", "")]
            )
