# Extracted from: C:\DEV\PyAgent\.external\skills\skills\disi3r\openclaw-skill-manus\scripts\run_task.py
#!/usr/bin/env python3
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run a task with Manus AI")
    parser.add_argument("prompt", help="The task prompt")
    parser.add_argument("--title", "-t", help="Task title (optional)")
    parser.add_argument(
        "--timeout",
        type=int,
