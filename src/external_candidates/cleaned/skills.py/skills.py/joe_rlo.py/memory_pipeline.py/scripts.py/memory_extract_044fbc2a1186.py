# Extracted from: C:\DEV\PyAgent\.external\skills\skills\joe-rlo\memory-pipeline\scripts\memory-extract.py
#!/usr/bin/env python3
"""
...
def is_duplicate(new_fact: Dict, existing_facts: List[Dict]) -> bool:
    ...
    for existing in existing_facts:
        ...
        if (
            new_fact.get("subject", "").lower() == existing.get("subject", "").lower()
