...
Examples:
  ...
  python3 voice-design.py --options
    ...
    parser.add_argument("--gender", "-g", default="female", help=f"Gender ({', '.join(VALID_GENDERS)})")
    parser.add_argument("--age", "-a", default="middle_aged", help=f"Age ({', '.join(VALID_AGES)})")
    parser.add_argument(
        "--accent",
        "-c",
        default="american",
    ...
    # Save to library
    parser.add_argument("--save", metavar="NAME", help="Save voice to ElevenLabs library with this name")
