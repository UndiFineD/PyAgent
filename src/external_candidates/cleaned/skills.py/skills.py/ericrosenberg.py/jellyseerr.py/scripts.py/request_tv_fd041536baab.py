# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ericrosenberg\jellyseerr\scripts\request_tv.py
#!/usr/bin/env python3
"""
...
def request_tv(config, tmdb_id, seasons=None):
    ...
    data = {"mediaId": tmdb_id, "mediaType": "tv", "seasons": seasons or "all"}
