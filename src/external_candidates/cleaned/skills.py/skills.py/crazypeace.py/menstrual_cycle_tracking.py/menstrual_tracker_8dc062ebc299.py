...
class MenstrualTracker:
    ...
    def get_analysis(self):
        ...
        menstruation_starts = [
            entry for entry in self.data if entry["structured_data"]["cycle_event"] == "menstruation_start"
        ]
        ...
        if len(menstruation_starts) < 2:
            ...
            dates = [datetime.fromisoformat(entry["timestamp"].replace("Z", "+00:00")) for entry in menstruation_starts]
