...
class FileAccessMonitor:
    ...
    def get_hot_files(self, top_n: int = 10) -> List[tuple]:
        ...
        return sorted(self.access_counts.items(), key=lambda x: x[1], reverse=True)[:top_n]
...
class AgentGuardMonitor:
    ...
    def start(self):
        ...
        self.api_monitor = APICallMonitor(trusted_domains=api_config.get("trusted_domains", []))
