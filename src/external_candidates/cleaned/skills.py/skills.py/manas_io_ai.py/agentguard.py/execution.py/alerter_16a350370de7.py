...
def create_alert(severity: str, title: str, description: str, details: Dict, recommendation: str) -> Alert:
...
def main():
    ...
    parser.add_argument("command", choices=["send", "list", "ack", "stats"], help="Command to execute")
    parser.add_argument(
        "--severity",
