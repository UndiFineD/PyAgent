...
class OpenSoulAgent:
    ...
    async def start_session(self, task_description=None):
        ...
        self.logger = AuditLogger(priv_wif=os.getenv("BSV_PRIV_WIF"), config=opensoul_config)
    ...
    async def reflect_on_performance(self):
        ...
        try:
            ...
            total_tokens = sum(m.get("tokens_in", 0) + m.get("tokens_out", 0) for m in all_metrics)
