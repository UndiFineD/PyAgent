# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\task-tracker\scripts\standup.py
#!/usr/bin/env python3
"""
...
def generate_standup(date_str: str = None, json_output: bool = False) -> str | dict:
    ...
    # Other high priority
    output["high_priority"] = [t for t in tasks_data["high_priority"] if t not in tasks_data["blocking"]]
