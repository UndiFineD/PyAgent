# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\fitbit-analytics\scripts\fitbit_api.py
#!/usr/bin/env python3
"""
...
class FitbitClient:
    ...
    def _refresh_access_token(self):
        ...
        data = urllib.parse.urlencode({"grant_type": "refresh_token", "refresh_token": self._refresh_token}).encode()
...
class FitbitReporter:
    ...
    def generate_report(self, report_type="weekly", days=None):
        ...
        return {
            ...
            "summary": summary,
            "data": {"steps": steps, "heartrate": hr, "sleep": sleep},
        }
