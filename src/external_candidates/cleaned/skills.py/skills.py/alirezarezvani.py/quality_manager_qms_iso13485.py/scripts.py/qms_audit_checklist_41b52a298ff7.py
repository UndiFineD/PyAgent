# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\quality-manager-qms-iso13485\scripts\qms_audit_checklist.py
#!/usr/bin/env python3
"""
...
Examples:
  ...
  python qms_audit_checklist.py --interactive
    ...
    parser.add_argument("--clause", help="Generate checklist for specific clause (e.g., 7.3.1, 8.5.2)")
    parser.add_argument("--process", help="Generate checklist for process (e.g., design-control, capa)")
    parser.add_argument(
        "--audit-type",
    ...
    parser.add_argument("--list-processes", action="store_true", help="List available QMS processes")
