# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\aws-solution-architect\scripts\architecture_designer.py
"""
...
class ArchitectureDesigner:
    ...
    def generate_service_checklist(self) -> List[Dict[str, Any]]:
        ...
        checklist = [
            ...
            {
                "phase": "Core Services",
                "tasks": [f"Deploy {service['service']}" for service in architecture["services"].values()],
            },
            {
                "phase": "Security",
                "tasks": [
