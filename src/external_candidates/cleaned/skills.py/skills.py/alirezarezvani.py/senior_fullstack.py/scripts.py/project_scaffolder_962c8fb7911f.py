# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\senior-fullstack\scripts\project_scaffolder.py
#!/usr/bin/env python3
"""
...
def list_templates() -> Dict:
    ...
    return {
        "templates": [
            {"name": k, "display_name": v["name"], "description": v["description"]} for k, v in TEMPLATES.items()
        ]
    }
