# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\content-creator\scripts\seo_optimizer.py
#!/usr/bin/env python3
"""
...
class SEOOptimizer:
    ...
    def analyze(
        ...
        # Keyword analysis
        if target_keyword:
            analysis["keyword_analysis"] = self._analyze_keywords(content, target_keyword, secondary_keywords or [])

        # Generate meta suggestions
        analysis["meta_suggestions"] = self._generate_meta_suggestions(content, target_keyword)
    ...
    def _analyze_keywords(self, content: str, primary: str, secondary: List[str]) -> Dict:
        ...
        if word_count > 0:
            results["primary_keyword"]["density"] = results["primary_keyword"]["count"] / word_count

        # Check keyword placement
        first_para = content.split("\n\n")[0] if "\n\n" in content else content[:200]
        results["primary_keyword"]["in_first_paragraph"] = primary.lower() in first_para.lower()
    ...
    def _generate_recommendations(self, analysis: Dict) -> List[str]:
        ...
        if analysis["content_length"] < 300:
            ...
            recommendations.append("Consider breaking long content into multiple pages or adding a table of contents")
...
def optimize_content(content: str, keyword: str = None, secondary_keywords: List[str] = None) -> str:
