...
class RegulatoryTracker:
                ...
                for sub_id, sub_data in data.items():
                    ...
                    for date_field in [
                        ...
                        if sub_data.get(date_field):
                            sub_data[date_field] = datetime.datetime.strptime(sub_data[date_field], "%Y-%m-%d").date()
    ...
    def update_submission_status(self, submission_id: str, new_status: SubmissionStatus, notes: str = ""):
