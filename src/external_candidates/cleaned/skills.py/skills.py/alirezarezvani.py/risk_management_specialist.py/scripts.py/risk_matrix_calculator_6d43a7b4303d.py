# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\risk-management-specialist\scripts\risk_matrix_calculator.py
#!/usr/bin/env python3
"""
...
PROBABILITY_LEVELS = {
    ...
    3: {
        ...
        "frequency": "10^-4 to 10^-5",
    },
    4: {
        "name": "Probable",
        "description": "Likely to occur",
        "frequency": "10^-3 to 10^-4",
    },
...
Examples:
  ...
  python risk_matrix_calculator.py -p 4 -s 3 --output json
    ...
    parser.add_argument(
        ...
        "--severity",
        type=int,
        help="Severity rating (1-5 for risk, 1-10 for FMEA)",
    )
    ...
    parser.add_argument(
        "--list-criteria",
        action="store_true",
        help="Display probability and severity criteria",
    )
