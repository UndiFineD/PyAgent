# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tunaissacoding\twitter-bookmark-sync\scripts\learn.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    # Show top categories
    sorted_cats = sorted(criteria["value_categories"].items(), key=lambda x: x[1]["weight"], reverse=True)[:5]
