# Extracted from: C:\DEV\PyAgent\.external\skills\skills\samuelkahessay\code-mentor\scripts\analyze_code.py
#!/usr/bin/env python3
"""
...
class PythonAnalyzer:
    ...
    def analyze(self) -> List[CodeIssue]:
        ...
        try:
            ...
            self.issues.append(CodeIssue("bug", "critical", e.lineno, f"Syntax error: {e.msg}"))
            return self.issues
    ...
    def _check_style(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if line.endswith(" ") or line.endswith("\t"):
                self.issues.append(CodeIssue("style", "info", i, "Trailing whitespace"))
    ...
    def _check_best_practices(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if re.search(r"==\s*None|None\s*==", line):
                self.issues.append(CodeIssue("style", "info", i, "Use 'is None' instead of '== None'"))

            # Check for != None instead of is not None
            if re.search(r"!=\s*None|None\s*!=", line):
                self.issues.append(CodeIssue("style", "info", i, "Use 'is not None' instead of '!= None'"))
