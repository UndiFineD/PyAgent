# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alopez3006\snipara-mcp\src\snipara_mcp\rlm_tools.py
"""
...
def get_snipara_tools(
    ...
    try:
        ...
        raise ImportError("rlm-runtime is required to use Snipara tools. Install with: pip install rlm-runtime")
    ...
    if not project_slug:
        raise ValueError("Snipara project slug required. Set SNIPARA_PROJECT_SLUG or pass project_slug parameter.")
    ...
    return [
        ...
        Tool(
            name="search",
            description=(
                "Search documentation for a regex pattern. Returns matching lines with file paths and line numbers."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="read",
            description=(
                "Read specific lines from a documentation file. Use after search or sections to get full content."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="stats",
            description=("Get documentation statistics. Returns file count, line count, and section count."),
            parameters={
                "type": "object",
                "properties": {},
            },
        ...
        Tool(
            name="ask",
            description=("Basic documentation query. Ask a question and get an answer based on the documentation."),
            parameters={
                "type": "object",
                "properties": {
                    "question": {
        ...
        Tool(
            name="inject",
            description=("Inject context into the session. This context will be included in subsequent queries."),
            parameters={
                "type": "object",
                "properties": {
                    "context": {
        ...
        Tool(
            name="context",
            description=("Get the current session context. Returns any context that was previously injected."),
            parameters={
                "type": "object",
                "properties": {},
            },
        ...
        Tool(
            name="clear_context",
            description=("Clear the current session context. Removes any previously injected context."),
            parameters={
                "type": "object",
                "properties": {},
            },
        ...
        Tool(
            name="settings",
            description=("Get project settings. Returns configuration like max tokens, search mode, etc."),
            parameters={
                "type": "object",
                "properties": {},
            },
        ...
        Tool(
            name="store_summary",
            description=(
                "Store a summary for a document or section. Summaries are used to provide concise context in queries."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="recall",
            description=("Recall memories semantically. Search for relevant memories using natural language queries."),
            parameters={
                "type": "object",
                "properties": {
                    "query": {
        ...
        Tool(
            name="memories",
            description=(
                "List stored memories with filters. Browse memories by type, scope, category, or search text."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="swarm_create",
            description=("Create a new agent swarm. Swarms allow multiple agents to coordinate on a shared task."),
            parameters={
                "type": "object",
                "properties": {
                    "name": {
        ...
        Tool(
            name="swarm_join",
            description=("Join an existing swarm. Agents must join a swarm before claiming resources or tasks."),
            parameters={
                "type": "object",
                "properties": {
                    "swarm_id": {
        ...
        Tool(
            name="claim",
            description=(
                "Claim exclusive access to a resource. Prevents other agents from modifying the same file/function."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="state_set",
            description=(
                "Set shared swarm state. Store a value in the shared state store with optional optimistic locking."
            ),
            parameters={
                "type": "object",
                "properties": {
        ...
        Tool(
            name="broadcast",
            description=("Broadcast an event to the swarm. Notify other agents about changes or completions."),
            parameters={
                "type": "object",
                "properties": {
                    "swarm_id": {
        ...
        Tool(
            name="task_create",
            description=("Create a task in the swarm. Tasks can be claimed and completed by agents."),
            parameters={
                "type": "object",
                "properties": {
                    "swarm_id": {
        ...
        Tool(
            name="task_claim",
            description=("Claim a task from the swarm queue. Returns the next available task or a specific task."),
            parameters={
                "type": "object",
                "properties": {
                    "swarm_id": {
        ...
        Tool(
            name="task_complete",
            description=("Complete a task. Mark a claimed task as done with optional result or error."),
            parameters={
                "type": "object",
                "properties": {
                    "swarm_id": {
        ...
        Tool(
            ...
            description=("Upload a document to the project. Creates or updates a document in the documentation store."),
            parameters={
                "type": "object",
                "properties": {
                    "path": {
        ...
        Tool(
            name="sync_documents",
            description=("Sync multiple documents. Bulk create/update/delete documents to match provided list."),
            parameters={
                "type": "object",
                "properties": {
                    "documents": {
