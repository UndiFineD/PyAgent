# Extracted from: C:\DEV\PyAgent\.external\skills\skills\bobot-agent\usage-export\scripts\export.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    sessions_dir = (
        ...
        else Path(os.environ.get("USAGE_EXPORT_SESSIONS", DEFAULT_SESSIONS_DIR))
    )
    export_dir = (
        Path(args.export_dir) if args.export_dir else Path(os.environ.get("USAGE_EXPORT_DIR", DEFAULT_EXPORT_DIR))
    )
