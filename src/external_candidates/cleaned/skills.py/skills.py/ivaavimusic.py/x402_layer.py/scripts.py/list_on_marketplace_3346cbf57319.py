# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ivaavimusic\x402-layer\scripts\list_on_marketplace.py
#!/usr/bin/env python3
"""
...
def list_endpoint(slug: str, category: str, description: str, tags: list = None) -> dict:
    ...
    data = {"slug": slug, "category": category, "description": description}
...
def main():
    ...
    parser.add_argument(
        "--category",
        choices=["ai", "data", "finance", "utility", "social", "gaming"],
        required=True,
