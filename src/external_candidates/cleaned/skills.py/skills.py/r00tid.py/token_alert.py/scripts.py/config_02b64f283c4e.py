# Extracted from: C:\DEV\PyAgent\.external\skills\skills\r00tid\token-alert\scripts\config.py
"""
...
class Config:
    ...
    def _get_default_config(self) -> Dict:
        ...
        return {
            ...
            "notifications": {"enabled": True, "thresholds": [25, 50, 75, 90, 95]},
        }
    ...
    def add_provider(self, provider_type: str, config: Dict):
        ...
        """
        provider = {"type": provider_type, "config": config, "enabled": True}
    ...
    def remove_provider(self, provider_type: str):
        ...
        """
        self.data["providers"] = [p for p in self.data["providers"] if p["type"] != provider_type]
        self.save()
