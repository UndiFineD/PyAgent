...
def create_template(preset_name: str, output_path: Path) -> None:
    ...
    # Add accent bar
    shape = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(6.8), Inches(13.333), Inches(0.2))
    shape.fill.solid()
    ...
    img_placeholder = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(1), Inches(1.8), Inches(7), Inches(5))
