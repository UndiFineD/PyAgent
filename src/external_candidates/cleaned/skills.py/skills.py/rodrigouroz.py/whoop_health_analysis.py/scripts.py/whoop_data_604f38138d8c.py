...
def get_summary(days=7):
    ...
    # Recovery averages
    rec_scores = [
        r["score"]["recovery_score"] for r in recovery["records"] if r.get("score") and r["score"].get("recovery_score")
    ]
    rec_hrvs = [
    ...
    # Strain averages
    strains = [r["score"]["strain"] for r in cycles["records"] if r.get("score") and r["score"].get("strain")]
    if strains:
