...
def get_project_scope() -> dict[str, str] | None:
    ...
    project = AIProjectClient.from_connection_string(conn_str=conn_str, credential=DefaultAzureCredential())
    ...
    for name in evaluator_names:
        if name in quality_map:
            ...
            if not project_scope:
                print(f"Warning: Skipping {name} - requires AIPROJECT_CONNECTION_STRING")
                continue
...
def main():
    ...
    parser.add_argument("--safety", action="store_true", help="Include all safety evaluators")
    parser.add_argument("--output", "-o", help="Output file for results (JSON)")
    parser.add_argument("--log-to-foundry", action="store_true", help="Log results to Foundry project")
    parser.add_argument(
        "--query-column",
        default="query",
