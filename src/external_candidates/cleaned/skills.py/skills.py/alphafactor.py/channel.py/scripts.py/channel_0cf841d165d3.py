# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alphafactor\channel\scripts\channel.py
#!/usr/bin/env python3
"""
微信公众号草稿箱管理工具
...
def get_drafts(access_token: str, offset: int = 0, count: int = 20) -> List[Dict]:
    ...
    try:
        data = json.dumps({"offset": offset, "count": count, "no_content": 0}).encode("utf-8")
