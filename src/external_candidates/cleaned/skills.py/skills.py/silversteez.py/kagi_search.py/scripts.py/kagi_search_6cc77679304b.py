# Extracted from: C:\DEV\PyAgent\.external\skills\skills\silversteez\kagi-search\scripts\kagi-search.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    parser.add_argument("query", nargs="*", help="Search query (use quotes for multi-word searches)")
    parser.add_argument(
        "-n",
        "--limit",
        type=int,
    ...
    parser.add_argument("-s", "--offset", type=int, default=0, help="Offset for pagination (default: 0)")
    parser.add_argument("--json", action="store_true", help="Output raw JSON response")
    parser.add_argument("--no-related", action="store_true", help="Hide related searches")
