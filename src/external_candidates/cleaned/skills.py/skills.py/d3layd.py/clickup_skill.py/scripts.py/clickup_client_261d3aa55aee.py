...
class ClickUpClient:
    ...
    def delete_task(self, task_id: str, custom_task_ids: bool = False, team_id: Optional[str] = None) -> Dict:
        """Delete a task."""
        params = {}
        if custom_task_ids and team_id:
            params = {"custom_task_ids": "true", "team_id": team_id}
    ...
    def add_doc_mention_to_task(
        ...
        doc_url = (
            f"https://app.clickup.com/{team_id}/docs/{doc_id}" if team_id else f"https://app.clickup.com/docs/{doc_id}"
        )
    ...
    def get_task_dependencies(self, task_id: str, custom_task_ids: bool = False, team_id: Optional[str] = None) -> Dict:
