# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\clawback\src\clawback\integration.py
"""
        ...
        try:
            ...
            for trade in filtered_trades[:max_trades]:  # Limit to max_trades
                ...
                if analysis["should_execute"] and analysis["confidence"] >= 70:
                    ...
                    if success:
                        executed_trades.append({"trade": trade, "analysis": analysis, "executed": True})
    ...
    def run_demo_mode(self):
        ...
        for i, trade in enumerate(filtered_trades[:10], 1):  # Show first 10
            ...
            if analysis["should_execute"]:
                print(f"   Estimated: {analysis['estimated_quantity']} shares (${analysis['estimated_cost']:,.2f})")
