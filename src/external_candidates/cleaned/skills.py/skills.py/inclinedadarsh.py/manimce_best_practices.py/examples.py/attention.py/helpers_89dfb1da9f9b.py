# Extracted from: C:\DEV\PyAgent\.external\skills\skills\inclinedadarsh\manimce-best-practices\examples\attention\helpers.py
"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for n in layer_sizes:
            layer = VGroup(*[Circle(radius=neuron_radius, color=WHITE, fill_opacity=random.random()) for _ in range(n)])
...
class RandomizeMatrixEntries(Animation):
    ...
    def __init__(self, matrix, **kwargs):
        ...
        self.start_values = [entry.get_value() if hasattr(entry, "get_value") else 0 for entry in self.entries]
