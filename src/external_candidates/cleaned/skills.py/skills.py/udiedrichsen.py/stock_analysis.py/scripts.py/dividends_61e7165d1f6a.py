# Extracted from: C:\DEV\PyAgent\.external\skills\skills\udiedrichsen\stock-analysis\scripts\dividends.py
#!/usr/bin/env python3
# /// script
...
def format_text(analysis: DividendAnalysis) -> str:
    ...
    lines.append(
        f"5Y Div Growth:    {analysis.dividend_growth_5y:+.1f}%"
        if analysis.dividend_growth_5y
        else "5Y Div Growth:    N/A"
    )
