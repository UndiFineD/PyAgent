# Extracted from: C:\DEV\PyAgent\.external\skills\skills\orosha-ai\mcp-registry-manager\scripts\mcp-registry.py
#!/usr/bin/env python3
"""
...
class MCPRegistry:
    ...
    def semantic_search(self, query: str, top_k: int = 5) -> List[Dict]:
        ...
        for idx in top_indices:
            ...
            cursor.execute(
                "SELECT url, category, quality_score FROM servers WHERE id=?",
                (server_id,),
            )
