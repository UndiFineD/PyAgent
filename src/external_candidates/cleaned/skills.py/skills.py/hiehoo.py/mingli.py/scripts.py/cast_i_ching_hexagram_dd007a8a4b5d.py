# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hiehoo\mingli\scripts\cast-i-ching-hexagram.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    result = {
        ...
        "transformed": (
            {
                "number": transformed["num"],
                "name": transformed["name"],
                "viet": transformed["viet"],
                "meaning": transformed["meaning"],
                "upper_trigram": transformed["upper"],
                "lower_trigram": transformed["lower"],
