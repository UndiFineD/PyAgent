# Extracted from: C:\DEV\PyAgent\.external\skills\skills\seojoonkim\prompt-guard\scripts\detect.py
#!/usr/bin/env python3
"""
...
class PromptGuard:
    ...
    def analyze(self, message: str, context: Optional[Dict] = None) -> DetectionResult:
        ...
        fingerprint = hashlib.md5(f"{user_id}:{max_severity.name}:{sorted(reasons)}".encode()).hexdigest()[:12]
