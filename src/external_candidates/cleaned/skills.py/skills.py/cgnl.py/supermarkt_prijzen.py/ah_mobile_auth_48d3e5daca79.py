...
def authorize(code):
    ...
    response = requests.post(AUTH_URL, headers=headers, json=payload, impersonate="chrome120")
...
def refresh_token():
    ...
    response = requests.post(REFRESH_URL, headers=headers, json=payload, impersonate="chrome120")
...
def test_api():
    ...
    response = requests.post(GRAPHQL_URL, headers=headers, json={"query": query}, impersonate="chrome120")
