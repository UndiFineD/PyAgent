# Extracted from: C:\DEV\PyAgent\.external\skills\skills\huchengtw\vehicle-tracker\tracker.py
#!/usr/bin/env python3
import argparse
import datetime
import json
...
def main():
    ...
    parser.add_argument(
        "--save-default",
        action="store_true",
        help="Save quantity as default for this category",
    )
            ...
            if not os.path.exists(local_excel_path):
                if os.path.exists(TEMPLATE_PATH):
                    ...
                    print(
                        msg(
                            locale,
                            "success_excel_created_template",
