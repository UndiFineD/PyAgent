...
def main():
    ...
    result2 = orchestrator.handle_message(request=dev_request, project_name="calculator-app", github_user="jfasteroid")
    ...
    result3 = orchestrator.handle_message(request="!simple Build a calculator", channel_name="test-project")
