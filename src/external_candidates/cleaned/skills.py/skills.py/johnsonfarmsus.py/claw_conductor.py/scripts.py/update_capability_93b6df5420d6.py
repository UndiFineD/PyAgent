...
Examples:
  ...
  %(prog)s --list-categories
    ...
    parser.add_argument("--experience", type=int, help="Experience count (number of tasks)")
    parser.add_argument(
    ...
    parser.add_argument("--show", action="store_true", help="Show capabilities for an agent")
    parser.add_argument("--list-categories", action="store_true", help="List available task categories")
