# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adboio\agentmail\scripts\check_inbox.py
#!/usr/bin/env python3
"""
...
def main():
    ...
    if args.monitor:
        ...
        try:
            while True:
                try:
                    messages = client.inboxes.messages.list(inbox_id=args.inbox, limit=args.limit)
        ...
        # Get specific message
        try:
            message = client.inboxes.messages.get(inbox_id=args.inbox, message_id=args.message)
