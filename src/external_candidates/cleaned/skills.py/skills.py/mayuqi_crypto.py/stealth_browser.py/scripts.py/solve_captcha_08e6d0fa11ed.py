# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mayuqi-crypto\stealth-browser\scripts\solve_captcha.py
#!/usr/bin/env python3
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--type",
        "-t",
        choices=["recaptcha2", "recaptcha3", "hcaptcha", "turnstile"],
        required=True,
        help="CAPTCHA type",
    )
