# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mayuqi-crypto\stealth-browser\scripts\cf_bypass.py
#!/usr/bin/env python3
"""
...
def test_cf_protection(url: str) -> dict:
    ...
    try:
        ...
        return {"protected": None, "error": str(e)}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--method",
        "-m",
        choices=["auto", "drission", "flaresolverr", "cloudscraper"],
        default="auto",
        help="Bypass method",
    )
    ...
    if args.test:
        ...
        if result.get("success"):
            ...
            if args.save_cookies:
                Path(args.save_cookies).write_text(
                    json.dumps(
                        {
