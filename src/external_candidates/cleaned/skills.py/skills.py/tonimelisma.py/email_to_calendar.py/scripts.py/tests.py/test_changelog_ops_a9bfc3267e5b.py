...
class TestLogCreate(unittest.TestCase):
    ...
    def test_log_create_returns_change_id(self):
        ...
        change_id = changelog_ops.log_create(event_id="evt123", calendar_id="primary", summary="Test")
...
class TestLogDelete(unittest.TestCase):
    ...
    def test_log_delete_stores_before_state(self):
        ...
        change_id = changelog_ops.log_delete(event_id="evt123", calendar_id="primary", before_json=before)
