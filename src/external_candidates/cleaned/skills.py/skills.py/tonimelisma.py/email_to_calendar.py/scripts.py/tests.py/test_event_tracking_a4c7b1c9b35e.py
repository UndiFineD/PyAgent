# Extracted from: C:\DEV\PyAgent\.external\skills\skills\tonimelisma\email-to-calendar\scripts\tests\test_event_tracking.py
#!/usr/bin/env python3
...
class TestTrackEvent(unittest.TestCase):
    ...
    def test_track_updates_existing(self):
        ...
        # First track
        event_tracking.track_event(event_id="evt123", summary="Original Title", start="2026-02-11T14:00:00")
        # Track again with same event_id
        event_tracking.track_event(event_id="evt123", summary="Updated Title", start="2026-02-12T15:00:00")
...
class TestUpdateTrackedEvent(unittest.TestCase):
    ...
    def test_update_existing_event(self):
        ...
        event_tracking.track_event(event_id="evt123", summary="Original", start="2026-02-11T14:00:00")

        # Update it
        event_tracking.update_tracked_event(event_id="evt123", summary="Updated", start="2026-02-12T15:00:00")
