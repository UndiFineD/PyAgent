# Extracted from: C:\DEV\PyAgent\.external\skills\skills\voidcooks\clawd-presence\scripts\display.py
#!/usr/bin/env python3
"""
    ...
    while True:
        try:
            ...
            if message != last_message:
                ...
                if message:
                    msg = message[: w - 4]
                    safe_addstr(stdscr, msg_y, cx - len(msg) // 2, msg, curses.color_pair(5))
            ...
            if time_str != last_time_str:
                safe_addstr(stdscr, 1, cx - len(time_str) // 2, time_str, curses.color_pair(6))
