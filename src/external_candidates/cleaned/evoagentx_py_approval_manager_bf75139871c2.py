# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\hitl.py\approval_manager_bf75139871c2.py
                    ...
                    while True:
                        ...
                        try:
                            if field_type == "int":
                                ...
                                collected_inputs[field_name] = (
                                    user_input.lower() in ["true", "1", "yes", "y"] if user_input else None
                                )
