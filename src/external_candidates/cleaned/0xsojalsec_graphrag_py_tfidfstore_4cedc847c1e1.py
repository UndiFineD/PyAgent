# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graphrag.py\core.py\index.py\tfidfstore_4cedc847c1e1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Index\TFIDFStore.py
...
class TFIDFIndex(BaseIndex[IndexDict]):
    ...
    def persist(self, persist_dir: str) -> None:
        ...
        shutil.copytree(Path(self.index_path) / self.index_name, Path(persist_dir) / self.index_name)
