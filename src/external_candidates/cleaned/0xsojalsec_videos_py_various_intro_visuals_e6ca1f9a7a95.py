# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\various_intro_visuals_e6ca1f9a7a95.py
    ...
    def construct(self):
        ...
        cloud = VGroup(
            *[
                ...
                for x, y in zip(np.random.normal(0, 1, n_points), np.random.normal(0, 1, n_points))
            ]
        )
