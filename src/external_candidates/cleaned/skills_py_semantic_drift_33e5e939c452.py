...
class SemanticDrift:
    ...
    def _display_step(self, step: DriftStep, num: int, total: int, progress: float, animate: bool):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Watch meaning evolve through semantic drift")
    ...
    parser.add_argument("--random", "-r", action="store_true", help="Start from a random word")
