# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\search_ddgs_6aab2541d63d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\search_ddgs.py
...
class DDGSSearchToolkit(Toolkit):
    def __init__(
        ...
        **kwargs,
        ...
        tools = [DDGSSearchTool(search_ddgs=search_ddgs)]
