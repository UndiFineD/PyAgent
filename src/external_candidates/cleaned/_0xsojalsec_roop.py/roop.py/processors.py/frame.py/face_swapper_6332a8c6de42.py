# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roop\roop\processors\frame\face_swapper.py
import threading
...
def process_image(source_path: str, target_path: str, output_path: str) -> None:
    ...
    reference_face = (
        None if roop.globals.many_faces else get_one_face(target_frame, roop.globals.reference_face_position)
    )
