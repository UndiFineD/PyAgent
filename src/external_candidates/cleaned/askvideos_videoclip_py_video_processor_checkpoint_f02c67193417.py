# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\processors.py\ipynb_checkpoints.py\video_processor_checkpoint_f02c67193417.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AskVideos-VideoCLIP\video_llama\processors\.ipynb_checkpoints\video_processor-checkpoint.py
