# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\impkind.py\whisper_mlx_local.py\scripts.py\transcriber_cli_42b516587af5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\impkind\whisper-mlx-local\scripts\transcriber_cli.py
...
def main():
    ...
    parser.add_argument(
        ...
        "-b",
        default="auto",
        help="Backend: auto, mlx, openai, groq, local",
    )
