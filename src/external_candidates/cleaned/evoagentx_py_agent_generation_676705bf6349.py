# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\actions.py\agent_generation_676705bf6349.py
    ...
    def execute(
        ...
        **kwargs,
        ...
        if self.tools:
            tool_description = [
                {
                    tool.name: [s["function"]["description"] for s in tool.get_tool_schemas()],
                }
