# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-whisper-flow\tests\audio\test_audio.py
"""test chat room"""
...
def test_is_silent():
    ...
    assert not mic.is_silent(threshold_data), "Threshold-level data should not be detected as silent"
