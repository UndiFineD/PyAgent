# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-whisper-flow\tests\test_streaming.py
...
async def test_transcribe_streaming(chunk_size=4096):
    ...
    task = asyncio.create_task(st.transcribe(should_stop, queue, dummy_transcriber, dummy_segment_closed))
