# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-whisper-flow\tests\benchmark\test_benchmark.py
"""benchamrk"""
...
def test_send_chunks(url="ws://localhost:8181/ws", chunk_size=4096):
    ...
    chunks = [resource["audio"][i : i + chunk_size] for i in range(0, len(resource["audio"]), chunk_size)]
