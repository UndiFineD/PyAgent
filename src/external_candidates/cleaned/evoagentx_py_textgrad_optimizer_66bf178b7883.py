# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\optimizers.py\textgrad_optimizer_66bf178b7883.py
        ...
        for key, input_variable in inputs.items():
            if key in input_names:
                ...
                parsed_inputs: dict[str, str] = {
                    k: v for k, v in input_variable.parsed_outputs.items() if k in input_names
                }
