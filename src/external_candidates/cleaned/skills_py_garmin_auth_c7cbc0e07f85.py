# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\rayleigh3105.py\garmin_connect.py\scripts.py\garmin_auth_c7cbc0e07f85.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\rayleigh3105\garmin-connect\scripts\garmin-auth.py
