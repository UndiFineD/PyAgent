# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\godsboy.py\garmin_connect_fixed.py\scripts.py\garmin_auth_c7cbc0e07f85.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\godsboy\garmin-connect-fixed\scripts\garmin-auth.py
