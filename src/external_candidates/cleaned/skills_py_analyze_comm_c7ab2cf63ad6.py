# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\rjmoggach.py\communication_coach.py\scripts.py\analyze_comm_c7ab2cf63ad6.py
