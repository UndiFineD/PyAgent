# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\for_site_9199d9475eed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\for_site.py
...
class WhyPi(Scene):
    def construct(self):
        ...
        formula1 = OldTex("1 +\\frac{1}{4} +\\frac{1}{9} +\\frac{1}{16} +\\frac{1}{25} + \\cdots=\\frac{\\pi^2}{6}")
        ...
        formula2 = OldTex("1 -\\frac{1}{3} +\\frac{1}{5} -\\frac{1}{7} +\\frac{1}{9} - \\cdots=\\frac{\\pi}{4}")
...
class RantPage(Scene):
    ...
    def construct(self):
        ...
        words = OldTexText("What were you\\\\expecting to be here?")
        ...
        words = OldTexText("Go on!\\\\Give the rant!")
