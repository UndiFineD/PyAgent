# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\tasks.py\unbounded_throughput_task_01389142ac77.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\tasks\unbounded_throughput_task.py

from typing import Any, Dict, List, Optional

from fle.agents import TaskResponse

from fle.env import Entity, FactorioInstance

from fle.env.utils.achievements import eval_program_with_achievements

from fle.eval.tasks import LAB_PLAY_POPULATED_STARTING_INVENTORY, TaskABC
