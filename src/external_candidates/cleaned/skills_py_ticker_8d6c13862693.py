# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\robbyczgw_cla.py\sports_ticker.py\scripts.py\ticker_8d6c13862693.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\robbyczgw-cla\sports-ticker\scripts\ticker.py
...
from espn import FOOTBALL_LEAGUES, find_team_match, format_match, get_scoreboard
