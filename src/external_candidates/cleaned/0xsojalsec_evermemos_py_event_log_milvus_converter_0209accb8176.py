# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\search.py\milvus.py\converter.py\event_log_milvus_converter_0209accb8176.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\milvus\converter\event_log_milvus_converter.py
...
class EventLogMilvusConverter(BaseMilvusConverter[EventLogCollection]):
    ...
    def from_mongo(cls, source_doc: MongoEventLogRecord) -> Dict[str, Any]:
        ...
        try:
            ...
            timestamp = int(source_doc.timestamp.timestamp()) if source_doc.timestamp else 0
            ...
            logger.error("Failed to convert MongoDB EventLog document to Milvus entity: %s", e)
