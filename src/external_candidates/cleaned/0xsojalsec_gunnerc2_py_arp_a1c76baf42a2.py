# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\network.py\arp_a1c76baf42a2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\network\arp.py
...
class ArpCommand(Command):
    """Display ARP cache: arp"""

    @property
    def help(self):
        return "arp    Show remote ARP cache"
