# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wayback-google-analytics\wayback_google_analytics\scraper.py
import asyncio
...
async def process_url(session, url, start_date, end_date, frequency, limit, semaphore, skip_current):
