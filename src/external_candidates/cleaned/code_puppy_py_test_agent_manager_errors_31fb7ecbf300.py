# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_agent_manager_errors_31fb7ecbf300.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_agent_manager_errors.py
...
class TestAgentManagerErrors:
    ...
    def test_load_agent_invalid_name(self, mock_discover):
        ...
        with patch("code_puppy.agents.agent_manager._AGENT_REGISTRY", {}):
            with pytest.raises(ValueError, match="Agent 'nonexistent-agent-12345' not found"):
    ...
    def test_load_agent_corrupted_registry_entry(self, mock_discover):
        ...
        with patch("code_puppy.agents.agent_manager._AGENT_REGISTRY", {"bad-agent": 12345}):
    ...
    def test_set_current_agent_nonexistent(self, mock_save, mock_discover):
        ...
        with patch(
            ...
            with patch("code_puppy.agents.agent_manager.get_current_agent") as mock_current:
