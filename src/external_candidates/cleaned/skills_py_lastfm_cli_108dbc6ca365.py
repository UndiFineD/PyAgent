# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\poiley.py\whatisxlistening_to.py\skills.py\whatisxlistening_to.py\lastfm_cli_108dbc6ca365.py
