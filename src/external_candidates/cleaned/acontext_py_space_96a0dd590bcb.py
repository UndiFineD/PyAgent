# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\client.py\acontext_py.py\src.py\acontext.py\types.py\space_96a0dd590bcb.py
...
class SearchResultBlockItem(BaseModel):
    ...
    distance: float | None = Field(None, description="Cosine distance (0=identical, 2=opposite)")


class SpaceSearchResult(BaseModel):
    """Experience search result model."""

    cited_blocks: list[SearchResultBlockItem] = Field(..., description="List of cited blocks")
