# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\memory.py\memory_compressor.py\memory_compressor_072b4f40b4b7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\memory\memory_compressor\memory_compressor.py
...
from agentuniverse.base.component.component_base import ComponentBase, ComponentEnum
