# Extracted from: C:\DEV\PyAgent\.external\LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\search\query.py
"""
...
class SearchResult:
    ...
    def __repr__(self) -> str:
        return f"SearchResult(file={self.file_path}, lines={self.line_start}-{self.line_end}, score={self.score:.3f})"
