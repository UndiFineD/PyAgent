# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\officialpm.py\my_tesla.py\tests.py\test_cmd_windows_7924d6e45f7b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\officialpm\my-tesla\tests\test_cmd_windows.py
...
class CmdWindowsTests(unittest.TestCase):
    ...
    def test_windows_vent_calls_endpoint(self):
        ...
        self.assertEqual(
            vehicle.command_calls,
            [("WINDOW_CONTROL", {"command": "vent", "lat": 0, "lon": 0})],
        )
    ...
    def test_windows_close_calls_endpoint(self):
        ...
        self.assertEqual(
            vehicle.command_calls,
            [("WINDOW_CONTROL", {"command": "close", "lat": 0, "lon": 0})],
        )
