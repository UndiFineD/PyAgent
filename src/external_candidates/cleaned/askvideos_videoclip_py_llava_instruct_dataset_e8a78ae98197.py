# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\datasets.py\datasets.py\llava_instruct_dataset_e8a78ae98197.py
