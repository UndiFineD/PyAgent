# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\didelco.py\pvpc_spain.py\scripts.py\precio_referencia_154e3a5ea991.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\didelco\pvpc-spain\scripts\precio_referencia.py
...
def classify_price(price, stats):
    ...
    if price <= p30:
        ...
        return {"level": "MEDIO", "emoji": "🟡", "description": "Precio medio"}
...
def main():
    ...
    parser.add_argument("--price", type=float, help="Precio a clasificar (€/kWh)")

    parser.add_argument("--now", action="store_true", help="Clasifica precio actual")
