# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\merch_designs_cca9860c91bc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\merch_designs.py
    ...
    def construct(self):
        curves = VGroup(
            *[
                ...
                for order, scale_factor in zip(self.orders, np.linspace(1, 2, 3))
            ]
        )
