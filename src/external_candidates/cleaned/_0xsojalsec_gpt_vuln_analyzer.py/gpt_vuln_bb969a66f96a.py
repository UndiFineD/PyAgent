# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\gpt_vuln.py
import argparse
import hashlib
import os
...
def parse_arguments():
    ...
    parser.add_argument(
        "--sub_list",
        type=str,
        default=DEFAULT_LIST_LOC,
        help="Path to the subdomain list file (txt)",
    )
    parser.add_argument(
        "--output",
        type=str,
        default=DEFAULT_OUTPUT_LOC,
        help="Pcap analysis output file",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="openai",
        help="AI options: openai, bard, llama, llama-api",
    )
