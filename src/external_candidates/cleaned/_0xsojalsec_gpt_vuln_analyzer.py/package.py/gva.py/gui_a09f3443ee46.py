# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\package\GVA\gui.py
import json
import re
...
entry5 = customtkinter.CTkEntry(master=frame, placeholder_text="Attack (nmap/dns)")
...
button = customtkinter.CTkButton(master=frame, text="Run", command=application)
