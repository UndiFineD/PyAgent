# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\storages.py\graph_stores.py\neo4j_e41f8453eeaf.py
        ...
        try:
            ...
            for record in nodes_result:
                ...
                if "Chunk" in labels:
                    ...
                    node_dict["label"] = (
                        [label for label in labels if label not in [BASE_NODE_LABEL, BASE_ENTITY_LABEL]][0]
                        if any(label not in [BASE_NODE_LABEL, BASE_ENTITY_LABEL] for label in labels)
                        else "entity"
                    )
