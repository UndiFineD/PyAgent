# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\connect.py\test_connect_pipes_2fce825b6fba.py
...
def test_connect_steam_engine_battery(game):
    ...
    offshore_pump1 = game.place_entity(Prototype.OffshorePump, position=water_pos, direction=Direction.RIGHT)
