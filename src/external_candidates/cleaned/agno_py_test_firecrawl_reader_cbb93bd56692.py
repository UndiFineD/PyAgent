# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\unit.py\reader.py\test_firecrawl_reader_cbb93bd56692.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\tests\unit\reader\test_firecrawl_reader.py
...
def test_scrape_with_chunking(mock_scrape_response):
    ...
    with patch(
        ...
        reader.chunking_strategy = FixedSizeChunking(
...
async def test_async_scrape_basic(mock_scrape_response):
    ...
    with (
        ...
        patch("firecrawl.FirecrawlApp") as MockFirecrawlApp,
