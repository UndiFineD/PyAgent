# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\di.py\utils_6fef550f9f76.py
...
def register_singleton(bean_type: Type[T], instance: T = None, name: str = None) -> None:
    """
...
def list_all_beans() -> List[str]:
    ...
    for bean_info in beans_info:
        ...
        formatted_beans.append(f"   • {bean_info['name']} ({bean_info['type_name']}) [{bean_info['scope']}]{flag_str}")
