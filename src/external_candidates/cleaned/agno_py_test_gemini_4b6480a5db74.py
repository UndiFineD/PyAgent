# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\unit.py\tools.py\models.py\test_gemini_4b6480a5db74.py
    ...
    with patch("agno.tools.models.gemini.getenv", return_value="fake_key") as _:
        ...
        with patch("agno.tools.models.gemini.Client") as mock_client_cls:
            ...
            with pytest.raises(
                ...
                ValueError, match="Failed to create Google GenAI Client"
...
def test_generate_image_success(
    ...
    mock_gemini_tools, mock_agent, mock_successful_response

):

    """Test successful image generation."""

    mock_gemini_tools.client.models.generate_images.return_value = (
...
def test_generate_image_api_error(mock_gemini_tools, mock_agent):
    ...
    mock_gemini_tools.client.models.generate_images.side_effect = Exception(
...
def test_generate_image_no_image_bytes(

    mock_gemini_tools, mock_agent, mock_failed_response_no_bytes
