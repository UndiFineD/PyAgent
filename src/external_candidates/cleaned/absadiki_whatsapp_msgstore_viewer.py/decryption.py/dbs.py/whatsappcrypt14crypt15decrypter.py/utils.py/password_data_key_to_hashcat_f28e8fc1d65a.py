# Extracted from: C:\DEV\PyAgent\.external\absadiki-whatsapp-msgstore-viewer\decryption\dbs\WhatsAppCrypt14Crypt15Decrypter\utils\password_data_key_to_hashcat.py
#!/usr/bin/env python
"""
