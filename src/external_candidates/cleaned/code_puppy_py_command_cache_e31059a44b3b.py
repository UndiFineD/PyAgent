# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\plugins.py\shell_safety.py\command_cache_e31059a44b3b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\shell_safety\command_cache.py
...
class CommandSafetyCache:
    ...
    def __init__(self, max_size: int = MAX_CACHE_SIZE):
        self._cache: OrderedDict[Tuple[str, Optional[str]], CachedAssessment] = OrderedDict()
    ...
    def get(self, command: str, cwd: Optional[str] = None) -> Optional[CachedAssessment]:
    ...
    def put(self, command: str, cwd: Optional[str], assessment: CachedAssessment) -> None:
...
def get_cached_assessment(command: str, cwd: Optional[str] = None) -> Optional[CachedAssessment]:
...
def cache_assessment(command: str, cwd: Optional[str], risk: str, reasoning: str) -> None:
