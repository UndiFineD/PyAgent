# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ichigo\demo\app.py
import sys
import warnings
...
with gr.Blocks(title="Ichigo-ASR", theme="allenai/gradio-theme") as interface:
    ...
    gr.Markdown("NOTE: Different from the original Whisper model, Ichigo-ASR can support audio longer than 30 seconds.")
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            ichigo_btn.click(fn=transcribe_ichigo, inputs=audio_input, outputs=ichigo_output)
        ...
        with gr.Column():
            ...
            whisper_btn.click(fn=transcribe_whisper, inputs=audio_input, outputs=whisper_output)
        ...
        with gr.Column():
            ...
            phowhisper_btn.click(fn=transcribe_phowhisper, inputs=audio_input, outputs=phowhisper_output)
