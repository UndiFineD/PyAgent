# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ichigo\ichigo\asr\arch\r2t.py
import torch
...
class Rep2Text(nn.Module):
    def __init__(self, config):
        ...
        self.decoding_options = whisper.DecodingOptions(**self.config["decoding_options"])
