# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\examples\low_level_api\low_level_api_llama_cpp.py
import ctypes
...
tmp = [0, 1, 2, 3]
llama_cpp.llama_eval(ctx=ctx, tokens=(llama_cpp.c_int * len(tmp))(*tmp), n_tokens=len(tmp), n_past=0)  # Deprecated
