# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\docker\open_llama\hug_model.py
import argparse
import json
import os
import struct
...
def main():
    ...
    parser.add_argument("-a", "--author", type=str, default="TheBloke", help="HuggingFace author filter")
    ...
    params = {"author": args.author, "tags": args.tag, "search": args.search}
