# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\llama_cpp\server\app.py
    ...
    responses={
        "200": {
            ...
            "content": {
                "application/json": {
                    "schema": {
                        "anyOf": [{"$ref": "#/components/schemas/CreateCompletionResponse"}],
    ...
    responses={
        "200": {
            ...
            "content": {
                "application/json": {
                    "schema": {
                        "anyOf": [{"$ref": "#/components/schemas/CreateChatCompletionResponse"}],
                        "title": "Completion response, when stream=False",
                    }
                },
                "text/event-stream": {
