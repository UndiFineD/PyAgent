# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\llama_cpp\llama_types.py
...
class ChatCompletionStreamResponseDelta(TypedDict):
    ...
    function_call: NotRequired[Optional[ChatCompletionStreamResponseDeltaFunctionCall]]  # DEPRECATED
