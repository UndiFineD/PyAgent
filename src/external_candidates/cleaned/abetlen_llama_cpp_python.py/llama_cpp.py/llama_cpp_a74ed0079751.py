# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\llama_cpp\llama_cpp.py
...
def llama_init_from_model(model: llama_model_p, params: llama_context_params, /) -> Optional[llama_context_p]: ...
...
def llama_adapter_lora_init(model: llama_model_p, path_lora: bytes, /) -> Optional[llama_adapter_lora_p]: ...
...
def llama_set_adapter_lora(ctx: llama_context_p, adapter: llama_adapter_lora_p, scale: float, /) -> int:
    """Add a loaded LoRA adapter to given context
    This will not modify model's weight"""
    ...
...
def llama_rm_adapter_lora(ctx: llama_context_p, adapter: llama_adapter_lora_p, /) -> int:
    """Remove a specific LoRA adapter from given context
    Return -1 if the adapter is not present in the context"""
    ...
...
#         llama_memory_t mem,
#           llama_seq_id seq_id);
@ctypes_function("llama_memory_seq_pos_min", [llama_memory_t_ctypes, llama_seq_id], llama_pos)
def llama_memory_seq_pos_min(mem: llama_memory_t, seq_id: Union[llama_seq_id, int], /) -> int:
    """Returns the smallest position present in the memory for the specified sequence
    This is typically non-zero only for SWA caches
    Return -1 if the sequence is empty"""
    ...
...
#         llama_memory_t mem,
#           llama_seq_id seq_id);
@ctypes_function("llama_memory_seq_pos_max", [llama_memory_t_ctypes, llama_seq_id], llama_pos)
def llama_memory_seq_pos_max(mem: llama_memory_t, seq_id: Union[llama_seq_id, int], /) -> int:
    """Returns the largest position present in the memory for the specified sequence
    Return -1 if the sequence is empty"""
    ...
...
@ctypes_function("llama_kv_self_seq_pos_min", [llama_context_p_ctypes, llama_seq_id], llama_pos)
def llama_kv_self_seq_pos_min(ctx: llama_context_p, seq_id: Union[llama_seq_id, int], /) -> int:
...
@ctypes_function("llama_kv_self_seq_pos_max", [llama_context_p_ctypes, llama_seq_id], llama_pos)
def llama_kv_self_seq_pos_max(ctx: llama_context_p, seq_id: Union[llama_seq_id, int], /) -> int:
...
def llama_vocab_get_text(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> bytes: ...


# LLAMA_API float llama_vocab_get_score(const struct llama_vocab * vocab, llama_token token);
@ctypes_function("llama_vocab_get_score", [llama_vocab_p_ctypes, llama_token], ctypes.c_float)
def llama_vocab_get_score(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> float: ...


# LLAMA_API enum llama_token_attr llama_vocab_get_attr(const struct llama_vocab * vocab, llama_token token);
@ctypes_function("llama_vocab_get_attr", [llama_vocab_p_ctypes, llama_token], ctypes.c_int)
def llama_vocab_get_attr(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> int: ...


# // Check if the token is supposed to end generation (end-of-generation, eg. EOS, EOT, etc.)
# LLAMA_API bool llama_vocab_is_eog(const struct llama_vocab * vocab, llama_token token);
@ctypes_function("llama_vocab_is_eog", [llama_vocab_p_ctypes, llama_token], ctypes.c_bool)
...
@ctypes_function("llama_vocab_is_control", [llama_vocab_p_ctypes, llama_token], ctypes.c_bool)
def llama_vocab_is_control(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> bool:
    """Identify if Token Id is a control token or a render-able token"""
    ...
...
def llama_token_get_score(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> float: ...
...
def llama_token_get_attr(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> int: ...
...
def llama_token_is_control(vocab: llama_vocab_p, token: Union[llama_token, int], /) -> bool: ...
...
def llama_sampler_init(iface: ctypes.POINTER(llama_sampler_i), ctx: llama_sampler_context_t, /) -> llama_sampler_p: ...
...
def llama_sampler_init_grammar(vocab: llama_vocab_p, grammar_str: bytes, grammar_root: bytes, /) -> llama_sampler_p: ...
