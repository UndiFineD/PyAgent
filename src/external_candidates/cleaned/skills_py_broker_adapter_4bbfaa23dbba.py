# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\clawback.py\src.py\clawback.py\broker_adapter_4bbfaa23dbba.py
