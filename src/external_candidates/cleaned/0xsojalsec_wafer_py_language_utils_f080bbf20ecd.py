# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_wafer.py\language_utils_f080bbf20ecd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wafer\language_utils.py
