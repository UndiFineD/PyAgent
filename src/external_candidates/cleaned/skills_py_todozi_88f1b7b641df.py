# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\bgengs.py\todozi.py\scripts.py\todozi_88f1b7b641df.py
...
class TodoziClient:
    ...
    async def create_note(self, title: str, thread_id: Optional[str] = None, description: str = "") -> TodoziTask:
        """Create a new note."""
