# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\indexing\chunker.py
"""
...
class TextChunker:
    ...
    def chunk_text(self, text: str, file_path: str = "") -> List[TextChunk]:
        ...
        try:
            ...
            logger.debug(f"Chunked {file_path}: {len(text)} chars -> {len(chunks_with_metadata)} chunks")
