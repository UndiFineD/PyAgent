# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\prompts.py\prompt_templates_11f7eb1c3e72.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\prompts\prompt_templates.py
...
class PromptTemplateGenerator:
    ...
    def get_prompt_from_key(self, task_type: TaskType, key: Any) -> TextPrompt:
        ...
        try:
            ...
            raise KeyError(f"Failed to get generate prompt template for task: {task_type.value} from key: {key}.")
