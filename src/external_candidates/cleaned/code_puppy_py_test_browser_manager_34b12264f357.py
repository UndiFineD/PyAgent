# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_browser_manager_34b12264f357.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_manager.py
    ...
    def test_profile_dir_attribute_set(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert manager.profile_dir == Path(temp_dir) / "browser_profiles" / "test-session"
...
class TestBrowserManagerAsyncInit(TestBrowserManagerBase):
    ...
    async def test_async_initialize_exception_cleanup(self):
        ...
        with patch.object(manager, "_initialize_browser", side_effect=Exception("Init failed")):
