# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_volweb.py\main.py\stix_b02871c8d90e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VolWeb\main\stix.py
...
def create_indicator(indicator):
    ...
    if pattern_template:
        value = (
            ...
            if "path" in indicator.type or "cmdline" in indicator.type or "registry-key" in indicator.type
