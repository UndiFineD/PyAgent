# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\test_local_spark_e2e_d21e24f630e2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_local_spark_e2e.py
...
def _local_client_setup(local_workspace: str = None):
    ...
    client = FeathrClient(
        ...
        os.path.join(local_workspace, "feathr_config_local.yaml"),
...
def _feature_gen_test(client: FeathrClient = None):
    ...
    backfill_time = BackfillTime(
        ...
        start=datetime(2020, 4, 1), end=datetime(2020, 4, 2), step=timedelta(days=1)
    ...
    res = client.get_online_features(
        ...
        online_test_table, "243", ["f_location_avg_fare", "f_location_max_fare"]
