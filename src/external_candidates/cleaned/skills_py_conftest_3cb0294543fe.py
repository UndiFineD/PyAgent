# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\etrade_pelosi_bot.py\tests.py\conftest_3cb0294543fe.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mainfraame\etrade-pelosi-bot\tests\conftest.py
...
def sample_config():
    ...
    return {
        ...
        "congress": {
            ...
            "tradeTypes": ["purchase"],
            "includeSenate": True,
            "targetPoliticians": [{"name": "Nancy Pelosi", "chamber": "house", "priority": 1}],
        },
        "riskManagement": {
            "maxDrawdown": 0.15,
            "dailyLossLimit": 0.03,
