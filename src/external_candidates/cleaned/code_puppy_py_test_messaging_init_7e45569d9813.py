# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_messaging_init_7e45569d9813.py
...
class TestMessagingPackageExports:
    ...
    def test_all_exports_are_accessible(self):
        ...
        for export_name in messaging_package.__all__:
            assert hasattr(messaging_package, export_name), f"{export_name} in __all__ but not accessible"
