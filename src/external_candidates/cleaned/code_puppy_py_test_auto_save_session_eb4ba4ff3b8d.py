# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_auto_save_session_eb4ba4ff3b8d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_auto_save_session.py
...
class TestAutoSaveSessionFunctionality:
    ...
    def test_auto_save_session_if_enabled_success(
        ...
        metadata = SessionMetadata(
            ...
            metadata_path=Path(mock_config_paths.autosave_dir) / "auto_session_20240101_010101_meta.json",
        )
...
class TestFinalizeAutoSaveSession:
    ...
    def test_finalize_autosave_session_saves_and_rotates(self, mock_auto_save, mock_rotate):
    ...
    def test_finalize_autosave_session_rotates_even_without_save(self, mock_auto_save, mock_rotate):
        result = cp_config.finalize_autosave_session()
