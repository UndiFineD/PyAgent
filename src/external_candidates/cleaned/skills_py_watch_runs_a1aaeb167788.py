# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chrisvoncsefalvay.py\wandb_monitor.py\scripts.py\watch_runs_a1aaeb167788.py
...
def main():
    ...
    if args.json:
        ...
        output = {
            ...
            "recent_finished": [
                {"id": r.id, "name": r.name, "project": r.project} for r in recent if r.state == "finished"
            ],
        }
