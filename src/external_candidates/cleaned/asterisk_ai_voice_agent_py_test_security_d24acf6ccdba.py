# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\config.py\test_security_d24acf6ccdba.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\config\test_security.py
...
class TestInjectLlmConfig:
    ...
    def test_api_key_from_env_only(self, monkeypatch):
        ...
        config_data = {"llm": {"api_key": "sk-yaml-key"}}  # This should be ignored
    ...
    def test_expand_env_tokens_in_greeting(self, monkeypatch):
        ...
        config_data = {"llm": {"initial_greeting": "Welcome to ${COMPANY_NAME}!"}}
    ...
    def test_expand_env_tokens_in_prompt(self, monkeypatch):
        ...
        config_data = {"llm": {"prompt": "You are ${AGENT_NAME}, a helpful assistant."}}
...
class TestInjectProviderApiKeys:
    ...
    def test_inject_multiple_keys(self, monkeypatch):
        ...
        config_data = {"providers": {"openai": {}, "deepgram": {}, "google_live": {}}}
