# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2019.py\diffyq.py\part4.py\complex_functions_4fe36b35b727.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2019\diffyq\part4\complex_functions.py
...
class GeneralizeToComplexFunctions(Scene):
    CONFIG = {
        ...
        "complex_plane_config": {"axis_config": {"unit_size": 2}},
    }
    ...
    def show_cosine_wave(self):
        ...
        y_labels = y_axis.get_number_mobjects(*range(-2, 3), num_decimal_places=1)
        ...
        real_words = OldTexText("Real number\\\\output")
...
class ClarifyInputAndOutput(GeneralizeToComplexFunctions):
    ...
    def setup_input_trackers(self):
        ...
        output_vector.add_updater(lambda v: v.put_start_and_end_on(plane.n2p(0), get_output_point()))
    ...
    def describe_output(self):
        ...
        self.play(ShowCreation(real_line), FadeIn(real_words, DOWN))
        ...
        self.play(FadeIn(plane.sublabel, UP))
        ...
        real_function_word = OldTexText("Real-valued function")
...
class SimpleComplexExponentExample(ClarifyInputAndOutput):
    ...
    def setup_output_trackers(self):
        ...
        full_output_path = ParametricCurve(lambda t: plane.n2p(np.exp(complex(0, t))), t_min=0, t_max=t_max)
