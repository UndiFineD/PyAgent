# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\mcp.py\test_mcp_logs_fb14b7a195b2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_mcp_logs.py
...
def temp_logs_dir(tmp_path):
    ...
    with patch("code_puppy.mcp_.mcp_logs.get_mcp_logs_dir", return_value=logs_dir):
        ...
        with patch("code_puppy.mcp_.mcp_logs.get_log_file_path", patched_get_log_file_path):
            yield logs_dir
...
class TestMCPLogs:
    ...
    def test_get_log_file_path_sanitizes_name(self, temp_logs_dir):
        ...
        with patch("code_puppy.mcp_.mcp_logs.get_mcp_logs_dir", return_value=temp_logs_dir):
