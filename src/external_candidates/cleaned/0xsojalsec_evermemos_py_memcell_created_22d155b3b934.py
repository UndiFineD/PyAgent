# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\event.py\memcell_created_22d155b3b934.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\event\memcell_created.py
...
class MemCellCreatedEvent(BaseEvent):
    ...
    @classmethod
    def from_dict(cls: Type["MemCellCreatedEvent"], data: Dict[str, Any]) -> "MemCellCreatedEvent":
        """
