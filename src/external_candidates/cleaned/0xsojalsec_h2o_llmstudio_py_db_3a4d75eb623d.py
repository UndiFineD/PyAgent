# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_h2o_llmstudio.py\llm_studio.py\app_utils.py\db_3a4d75eb623d.py
...
class Dataset(Base):
    ...
    validation_rows: Mapped[int | None] = mapped_column("validation_rows", Integer, nullable=True)
...
class Database:
    ...
    def get_experiments_df(self) -> DataFrame:
        ...
        experiments = pd.read_sql(self._session.query(Experiment).statement, self.__engine__)
