# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\src\chat-score\webapi\worker\common\conf.py
...
celery.conf.beat_schedule = {"tick-every-5s": {"task": "common.tick5s", "schedule": 5.0, "args": ()}}
