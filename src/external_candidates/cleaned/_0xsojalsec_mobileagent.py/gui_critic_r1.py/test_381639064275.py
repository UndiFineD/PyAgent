# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\GUI-Critic-R1\test.py
import argparse
import json
import os
...
if __name__ == "__main__":
    ...
    model = Qwen2_5_VLForConditionalGeneration.from_pretrained(model_dir, torch_dtype="auto", device_map="cuda")
