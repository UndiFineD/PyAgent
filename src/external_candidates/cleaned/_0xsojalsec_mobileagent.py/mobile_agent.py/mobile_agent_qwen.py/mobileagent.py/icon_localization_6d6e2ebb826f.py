# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent\Mobile-Agent-qwen\MobileAgent\icon_localization.py
import torch
from MobileAgent.crop import calculate_iou, calculate_size
