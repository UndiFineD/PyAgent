# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\tweets.py\door_puzzle_df495a462f1b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\tweets\door_puzzle.py
...
class DoorPuzzle(InteractiveScene):
    def construct(self):
        ...
        labels = VGroup(*(Integer(n, font_size=24).move_to(square) for n, square in zip(it.count(1), squares)))
