# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_llmtornado.py\src.py\llmtornado.py\llmtornado.py\fskb.py\indexing.py\merkle_tree_fe322f593987.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\indexing\merkle_tree.py
...
class MerkleTree:
    ...
    def compare(self, other: "MerkleTree") -> Tuple[Set[Path], Set[Path], Set[Path]]:
        ...
        self._compare_nodes(self.root_node, other.root_node, added, modified, deleted)
