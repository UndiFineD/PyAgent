# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_red_teaming_playground_labs.py\src.py\picture_submission.py\webapi.py\server.py\controller.py\scoring_ec3c8bc6b558.py
...
class ScoringController:
    ...
    def set_score(self, id: str, passed: bool, message: str) -> Response:
        ...
        self.__logger.info(
            ...
            f"Setting score for submission {id} to {passed} with message: {message}"
    ...
    def send_scoring_request(self, id: str, picture: str) -> bool:
        ...
        challenge_title = self.__app.config[CONFIG_CHALLENGE_SETTINGS][

            CONFIG_CHALLENGE_NAME

        ]

        challenge_goal = self.__app.config[CONFIG_CHALLENGE_SETTINGS][
        ...
        scoring_endpoint = self.__app.config[CONFIG_SCORING_SETTINGS][
        ...
        submission_endpoint = self.__app.config[CONFIG_SCORING_SETTINGS][
        ...
        response = requests.post(
            ...
            url, json=request.to_dict(), headers={"x-scoring-key": api_key}
