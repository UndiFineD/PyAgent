# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\getdelegation_3dc2339cc3f4.py
...
class GetDelegationCommand(Command):
    ...
    def logic(self, sid, domain=None, dc_ip=None, op_id="console"):
        ...
        if target:
            ...
            const = (
                f'$con = (Get-ADObject -LDAPFilter "(msDS-AllowedToDelegateTo=*)" -Properties msDS-AllowedToDelegateTo)'
            )
