# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2015.py\inventing_math_images_057f0caf4449.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2015\inventing_math_images.py
...
class SimpleTex(Scene):
    ...
    args_list = [
        ...
        ("\\frac{9}{10}+\\frac{9}{100}+\\frac{9}{1000}+\\cdots = 1", "SumOf9s"),
