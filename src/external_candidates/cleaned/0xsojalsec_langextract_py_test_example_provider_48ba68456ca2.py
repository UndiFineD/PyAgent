# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\examples.py\custom_provider_plugin.py\test_example_provider_48ba68456ca2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\examples\custom_provider_plugin\test_example_provider.py
