# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render_simple.py\utils.py\shape_renderer_7035e9455679.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render_simple\utils\shape_renderer.py
...
class ShapeRenderer:
    ...
    def draw_origin_marker(self, draw: ImageDraw.ImageDraw, x: float, y: float, font) -> None:
        ...
        draw.text((x, y - marker_size - 5), "(0,0)", fill=marker_color, anchor="ms", font=font)
