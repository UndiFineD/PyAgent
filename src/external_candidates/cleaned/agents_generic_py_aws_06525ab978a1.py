# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_agents.py\livekit.py\agents.py\llm.py\provider_format.py\aws_06525ab978a1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\llm\_provider_format\aws.py
            ...
            current_content.append(
                {
                    "toolResult": {
                        "toolUseId": msg.call_id,
                        "content": [({"json": msg.output} if isinstance(msg.output, dict) else {"text": msg.output})],
                        "status": "success",
                    }
                }
            )
