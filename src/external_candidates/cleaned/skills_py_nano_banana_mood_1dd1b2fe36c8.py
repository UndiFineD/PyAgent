# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\cpojer.py\orf.py\scripts.py\nano_banana_mood_1dd1b2fe36c8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\cpojer\orf\scripts\nano_banana_mood.py
...
def load_gemini_key() -> Optional[str]:
    ...
    try:
        ...
        api_key = (cfg.get("skills", {}).get("entries", {}).get("nano-banana-pro", {}).get("apiKey") or "").strip()
