# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\test_tools_content_cce9809ef439.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_tools_content.py
...
class TestToolsContentUsageGuidance:
    ...
    def test_mentions_reasoning_before_operations(self):
        ...
        assert "reasoning" in tools_content.lower(), "Expected guidance on sharing reasoning"
