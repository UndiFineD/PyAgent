# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\am_will.py\context7_api.py\scripts.py\context7_4d772f70f8e2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\am-will\context7-api\scripts\context7.py
...
def get_context(library_id: str, query: str, output_type: str = "txt", tokens: int = None) -> str | dict:
    ...
    params = {"libraryId": library_id, "query": query, "type": output_type}
...
def main():
    ...
    context_parser.add_argument(
        ...
        default="txt",
        choices=["txt", "json"],
        help="Output format (txt returns markdown-formatted text)",
    )
