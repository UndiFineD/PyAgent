# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\gui.py\main_window_ef0511e4ab41.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\gui\main_window.py
...
class MainWindow(QMainWindow):
    def __init__(self, api):
        ...
        # Frameless + transparent so we can clip real rounded corners
