# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_plugins.py\livekit_plugins_anthropic.py\livekit.py\plugins.py\anthropic.py\llm_f844bbbb0e49.py
