# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\braydoncoyer.py\spotify_history.py\scripts.py\spotify_api_1c603b98cd4c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\braydoncoyer\spotify-history\scripts\spotify-api.py
...
def api_request(endpoint, token_data, params=None):
    ...
    req = urllib.request.Request(url, headers={"Authorization": f"Bearer {token_data['access_token']}"})
