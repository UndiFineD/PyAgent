# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_ovo.py\ovo.py\app.py\components.py\molstar_custom_component.py\color_picker_23fe0d8e9d5d.py
