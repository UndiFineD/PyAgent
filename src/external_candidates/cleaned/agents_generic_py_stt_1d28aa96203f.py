# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_plugins.py\livekit_plugins_assemblyai.py\livekit.py\plugins.py\assemblyai.py\stt_1d28aa96203f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-assemblyai\livekit\plugins\assemblyai\stt.py
    ...
    async def _connect_ws(self) -> aiohttp.ClientWebSocketResponse:
        live_config = {
            ...
            "min_end_of_turn_silence_when_confident": (
                self._opts.min_end_of_turn_silence_when_confident  # noqa: E501
