# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\keymap_a85259069ab1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\keymap.py
...
def validate_cancel_agent_key() -> None:
    ...
    if key not in VALID_CANCEL_KEYS:
        ...
        raise KeymapError(f"Invalid cancel_agent_key '{key}' in puppy.cfg. Valid options are: {valid_keys_str}")
