# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\abetlen_llama_cpp_python.py\tests.py\test_llama_speculative_4a6112b00bb6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\tests\test_llama_speculative.py
