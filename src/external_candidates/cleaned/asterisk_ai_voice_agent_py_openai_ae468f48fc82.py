# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\src.py\tools.py\adapters.py\openai_ae468f48fc82.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\src\tools\adapters\openai.py
...
class OpenAIToolAdapter:
    ...
    async def send_tool_result(self, result: Dict[str, Any], context: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.info(
                f"✅ Sent function output to OpenAI: {result.get('status')}",
                call_id=call_id,
            )
