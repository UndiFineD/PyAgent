# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\algorithms.py\independent.py\trajectory_runner_3d530672f6e1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\algorithms\independent\trajectory_runner.py
    ...
    def _log_trajectory_state(
        ...
        if self.wandb_logger and WANDB_ANALYSIS_AVAILABLE:
            try:
                ...
                if self.config.version_description and "type:" in self.config.version_description:
                    task_name = self.config.version_description.split("type:")[1].split("\n")[0].strip()
