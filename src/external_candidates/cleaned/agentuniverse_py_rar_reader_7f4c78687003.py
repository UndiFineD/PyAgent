# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\action.py\knowledge.py\reader.py\file.py\rar_reader_7f4c78687003.py
...
class RarReader(Reader):
    ...
    def _load_data(
        ...
        try:
            ...
            raise ImportError("rarfile is required to read RAR files: `pip install rarfile`")
                ...
                for entry in entries:
                    ...
                    if compressed_size > 0:
                        ...
                        if ratio > max_compression_ratio:
                            raise ValueError(f"Rar entry has suspicious compression ratio: {entry.filename}")
