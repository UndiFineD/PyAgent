# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\ovo\app\pages\designs\interface.py
...
from ovo.core.database import Descriptor, Design, DesignWorkflow, NumericDescriptor
...
def interface_fragment(pool_ids: List[str], design_ids: List[str] | None = None):
    ...
    descriptors_df = get_wide_descriptor_table(
        design_ids=design_ids,
        descriptor_keys=interface_descriptors_by_key.keys(),
        nested=False,
