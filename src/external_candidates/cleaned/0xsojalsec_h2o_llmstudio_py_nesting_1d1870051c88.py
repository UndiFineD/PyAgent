# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_h2o_llmstudio.py\llm_studio.py\src.py\nesting_1d1870051c88.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\src\nesting.py
...
class Dependency:
    ...
    def check(self, dependency_values: list[str]) -> bool:
        ...
        elif not self.is_set and len([v for v in dependency_values if v != self.value]) == 0:
            return False
