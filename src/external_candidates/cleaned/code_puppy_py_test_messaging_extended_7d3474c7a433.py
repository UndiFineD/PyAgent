# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_messaging_extended_7d3474c7a433.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_messaging_extended.py
...
class TestMessagingExtended:
    ...
    def test_message_rendering_helpers(self):
        ...
        self.queue.emit_simple(MessageType.TOOL_OUTPUT, "Tool output", tool_name="test_tool")

        self.queue.emit_simple(MessageType.COMMAND_OUTPUT, "Command output", command="ls -la")
