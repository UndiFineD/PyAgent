# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\mcp_servers.py\spotify.py\tools.py\albums_5e189e6625af.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\spotify\tools\albums.py
...
def get_album_tracks(album_id: str, sp: Spotify = None, limit: int = 50, offset: int = 0) -> List[Dict]:
    """
...
def get_user_saved_albums(sp: Spotify = None, limit: int = 20, offset: int = 0) -> List[Dict]:
    """
