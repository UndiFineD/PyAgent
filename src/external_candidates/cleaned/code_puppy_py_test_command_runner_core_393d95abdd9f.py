# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\test_command_runner_core_393d95abdd9f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_command_runner_core.py
...
class TestSetAwaitingUserInput:
    ...
    def test_set_awaiting_true_calls_pause_spinners(self, monkeypatch):
        ...
        with patch.dict("sys.modules", {"code_puppy.messaging.spinner": mock_spinner_module}):
...
class TestKillAllRunningShellProcesses:
    ...
    def test_kill_all_concurrent_access_thread_safety(self, monkeypatch):
        ...
        killed_pids = {call.args[0].pid for call in mock_kill.call_args_list if call.args}
