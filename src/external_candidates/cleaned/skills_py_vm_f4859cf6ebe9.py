# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\architect_sis.py\sis_skill.py\core.py\vm_f4859cf6ebe9.py
...
class SISVM:
    ...
    def execute_sequence(
        ...
        if require_balance:
            ...
            if not validation.valid:
                ...
                return [ExecutionResult(success=False, equilibrium_delta=validation.equilibrium_delta) for _ in symbols]
    ...
    def stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                (self.state.symbols_executed - self.state.symbols_failed) / max(1, self.state.symbols_executed)
            ),
