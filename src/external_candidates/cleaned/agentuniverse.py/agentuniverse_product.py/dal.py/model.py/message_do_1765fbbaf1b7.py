# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse_product\dal\model\message_do.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class MessageDO(BaseModel):
    ...
    gmt_created: Optional[datetime.datetime] = Field(description="Create time", default_factory=datetime.datetime.now)
