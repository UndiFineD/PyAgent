# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\sample_apps\translation_agent_app\intelligence\test\run_translation_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
def chat():
    ...
    output_object: OutputObject = instance.run(source_lang="英文", target_lang="中文", source_text=data)
