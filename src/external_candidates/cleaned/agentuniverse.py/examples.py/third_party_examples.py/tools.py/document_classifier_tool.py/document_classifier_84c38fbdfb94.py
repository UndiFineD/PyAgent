# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\tools\document_classifier_tool\document_classifier.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
"""
    ...
    def get_classification_summary(self, documents: List[Document]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "category_counts": {},
            "confidence_stats": {"average": 0.0, "min": 1.0, "max": 0.0},
