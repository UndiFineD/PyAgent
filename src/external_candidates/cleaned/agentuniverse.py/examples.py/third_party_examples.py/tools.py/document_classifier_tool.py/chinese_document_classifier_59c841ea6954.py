# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\tools\document_classifier_tool\chinese_document_classifier.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        for word in words:
            ...
            if (
                ...
                and not re.match(r"^[0-9\s\W]+$", word)
            ):  # 过滤纯数字和特殊字符
