# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\medical_consultation_assistant_app\intelligence\utils\common\txt_file_util.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
