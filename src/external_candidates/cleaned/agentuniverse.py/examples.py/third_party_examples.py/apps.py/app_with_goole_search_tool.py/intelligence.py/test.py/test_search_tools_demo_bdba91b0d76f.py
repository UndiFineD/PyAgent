# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\app_with_goole_search_tool\intelligence\test\test_search_tools_demo.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
