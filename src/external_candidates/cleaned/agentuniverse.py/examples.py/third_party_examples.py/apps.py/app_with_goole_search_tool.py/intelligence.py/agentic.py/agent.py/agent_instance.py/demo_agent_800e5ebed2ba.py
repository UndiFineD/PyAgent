# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\app_with_goole_search_tool\intelligence\agentic\agent\agent_instance\demo_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class DemoAgent(AgentTemplate):
    ...
    def customized_execute(
        ...
        **kwargs,
        ...
        chain = (
            prompt.as_langchain() | llm.as_langchain_runnable(self.agent_model.llm_params()) | ReasoningOutputParser()
        )
