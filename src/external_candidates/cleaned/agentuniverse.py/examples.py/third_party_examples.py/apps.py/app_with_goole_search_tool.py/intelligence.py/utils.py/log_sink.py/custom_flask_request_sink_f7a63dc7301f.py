# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\app_with_goole_search_tool\intelligence\utils\log_sink\custom_flask_request_sink.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class CustomFlaskRequestSink(FlaskRequestLogSink):
    def generate_log(self, flask_request) -> str:
        log_string = f"Request: {flask_request.method} {flask_request.path} Headers: {dict(flask_request.headers)}"
