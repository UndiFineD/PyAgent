# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_generator_app\app\intelligence\test\test_prompt_generator.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TestPromptGenerator(unittest.TestCase):
    ...
    def test_empty_task_description(self):
        ...
        with self.assertRaises(ValueError):
            generate_prompt_config(task_description="", agent_type="react", scenario=self.test_scenario)
    ...
    def test_prompt_generation_with_scenario(self):
        ...
        full_content = (result["introduction"] + " " + result["target"] + " " + result["instruction"]).lower()
