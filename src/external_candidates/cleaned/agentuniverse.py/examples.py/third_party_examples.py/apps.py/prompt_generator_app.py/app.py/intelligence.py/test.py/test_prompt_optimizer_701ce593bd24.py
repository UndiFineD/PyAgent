...
class PromptOptimizerTest(unittest.TestCase):
    ...
    def test_basic_prompt_optimization(self):
        ...
        result = optimize_existing_prompt(existing_prompt_text=original_prompt, optimization_goal=optimization_goal)
    ...
    def test_scenario_prompt_optimization(self):
        ...
        self.assertTrue(
            any(keyword in combined_content for keyword in ["分析", "数据", "专业", "智能", "助手", "服务", "业务"])
        )
...
"""
        ...
        result = optimize_existing_prompt(existing_prompt_text=yaml_prompt, optimization_goal="完善prompt结构")
    ...
    def test_optimization_error_handling(self):
        ...
        result = optimize_existing_prompt(existing_prompt_text="", optimization_goal="优化空prompt")
        self.assertIsNotNone(result)
    ...
    def test_multiple_optimizations_consistency(self):
        ...
        result1 = optimize_existing_prompt(existing_prompt_text=original_prompt, optimization_goal=optimization_goal)

        result2 = optimize_existing_prompt(existing_prompt_text=original_prompt, optimization_goal=optimization_goal)
