# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_generator_app\app\intelligence\service\agent_service\prompt_service.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class PromptGenerationService:
    ...
    def generate_agent_prompt(
        self, agent_type: str, task_description: str, scenario: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def batch_generate_prompts(self, tasks: List[Dict[str, str]]) -> Dict[str, Any]:
        ...
        for i, task in enumerate(tasks):
            try:
                ...
                results.append({"index": i, "task": task, "result": result})
            except Exception as e:
                results.append(
                    {
                        "index": i,
