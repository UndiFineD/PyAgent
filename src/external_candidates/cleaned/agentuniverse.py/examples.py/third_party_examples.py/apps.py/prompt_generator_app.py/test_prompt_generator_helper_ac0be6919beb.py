...
class TestPromptTemplateHelper(unittest.TestCase):
    ...
    def test_generate_yaml_config(self):
        ...
        prompt_model = PromptTemplateHelper.generate_prompt_template(task_description="Test agent", agent_type="react")

        yaml_config = PromptTemplateHelper.generate_yaml_config(prompt_model, version_name="test.cn")
