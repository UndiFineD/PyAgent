...
def optimize_existing_prompt(
    ...
    optimized_prompt = _apply_optimizations(analysis_result, improvement_suggestions, agent_type)
...
def _apply_optimizations(
    ...
    optimized_introduction = (
        "You are a professional intelligent assistant with rich professional knowledge and experience."
    )
    optimized_target = (
        "Your goal is to provide accurate, professional, and useful services to meet users' specific needs."
    )
