# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\primary_chinese_teacher_agent\intelligence\agentic\agent\agent_instance\primary_chinese_teacher_agent.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
