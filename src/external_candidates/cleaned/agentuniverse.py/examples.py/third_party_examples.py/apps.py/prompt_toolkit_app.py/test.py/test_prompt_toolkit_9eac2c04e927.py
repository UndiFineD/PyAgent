# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_toolkit_app\test\test_prompt_toolkit.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TestPromptToolkit(unittest.TestCase):
    ...
    def test_initialization_with_config(self):
        ...
        custom_config = PromptToolkitConfig(enable_auto_optimization=False, default_scenario=PromptScenario.CREATIVE)
    ...
    def test_batch_generate_prompts(self):
        ...
        requests = [
            PromptGenerationRequest(scenario_description="编程助手", domain="技术"),
            PromptGenerationRequest(scenario_description="客服助手", domain="商业"),
        ]
    ...
    def test_generate_recommendations(self):
        ...
        recommendations = self.toolkit._generate_recommendations(analysis_result, optimization_result, prompt)
    ...
    def test_calculate_overall_confidence(self):
        ...
        confidence = self.toolkit._calculate_overall_confidence(analysis_result, optimization_result)
    ...
    def test_calculate_overall_confidence_without_optimization(self):
        ...
        confidence = self.toolkit._calculate_overall_confidence(analysis_result, None)
