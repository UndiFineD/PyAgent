# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_toolkit_app\intelligence\agentic\action\tool\prompt_optimization_action.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class PromptOptimizationAction(Tool):
    ...
    def run(self, introduction: str, target: str, instruction: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = AgentPromptModel(introduction=introduction, target=target, instruction=instruction)

            # Get optimization strategies
            strategies = kwargs.get(
                "strategies",
                [OptimizationStrategy.CLARITY, OptimizationStrategy.STRUCTURE],
            )
