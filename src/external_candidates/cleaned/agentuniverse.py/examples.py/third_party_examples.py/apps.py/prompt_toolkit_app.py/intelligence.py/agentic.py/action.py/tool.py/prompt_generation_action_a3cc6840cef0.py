            ...
            response = {
                ...
                "analysis_result": {
                    "recommended_scenario": (
                        result.analysis_result.recommended_scenario.value if result.analysis_result else None
                    ),
                    "complexity_level": (
                        result.analysis_result.complexity_level.value if result.analysis_result else None
                    ),
                ...
                "optimization_result": {
                    ...
                    "confidence_score": (
                        result.optimization_result.confidence_score if result.optimization_result else 0.0
                    ),
                },
