...
class ScenarioAnalyzer:
    ...
    def extract_context_from_content(self, content: str) -> ScenarioContext:
        ...
        # Extract constraints
        constraints = [
            ctx.value for ctx in analysis_result.extracted_contexts if ctx.context_type == ContextType.CONSTRAINTS
        ]
    ...
    def _determine_scenario(self, content: str, extracted_contexts: List[ExtractedContext]) -> PromptScenario:
    ...
    def _determine_complexity(self, content: str, extracted_contexts: List[ExtractedContext]) -> PromptComplexity:
    ...
    def _generate_suggestions(self, extracted_contexts: List[ExtractedContext], confidence_score: float) -> List[str]:
    ...
    def _get_context_value(self, contexts: List[ExtractedContext], context_type: ContextType, default: str) -> str:
