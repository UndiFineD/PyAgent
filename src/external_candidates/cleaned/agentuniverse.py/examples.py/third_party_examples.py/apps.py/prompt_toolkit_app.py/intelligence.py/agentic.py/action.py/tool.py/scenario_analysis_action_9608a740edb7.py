# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_toolkit_app\intelligence\agentic\action\tool\scenario_analysis_action.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class ScenarioAnalysisAction(Tool):
    ...
    def run(self, scenario_description: str, content: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis_result = self.analyzer.analyze_scenario(
                scenario_description, additional_context if additional_context else None
            )
