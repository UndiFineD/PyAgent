# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_toolkit_app\test\test_prompt_generator.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TestPromptGenerator(unittest.TestCase):
    ...
    def test_generate_prompt_invalid_scenario(self):
        ...
        with self.assertRaises(ValueError):
            self.generator.generate_prompt(
                ...
                context=self.sample_context,  # type: ignore
            )
    ...
    def test_generate_prompt_different_scenarios(self):
        ...
        for scenario in scenarios:
            prompt = self.generator.generate_prompt(scenario=scenario, context=self.sample_context)
            self.assertIsInstance(prompt, AgentPromptModel)
            self.assertIsNotNone(prompt.introduction)
    ...
    def test_optimize_prompt(self):
        ...
        original_prompt = AgentPromptModel(introduction="你是一个助手", target="帮助用户", instruction="回答问题")
    ...
    def test_generate_introduction(self):
        ...
        introduction = self.generator._generate_introduction(
            PromptScenario.CODE_GENERATION, self.sample_context, PromptComplexity.MEDIUM
        )
    ...
    def test_calculate_confidence_score(self):
        ...
        original = AgentPromptModel(introduction="你是一个助手", target="帮助用户", instruction="回答问题")

        score = self.generator._calculate_confidence_score(original, "优化介绍", "优化目标", "优化指令")
    ...
    def test_format_optimized_prompt(self):
        ...
        formatted = self.generator._format_optimized_prompt("优化介绍", "优化目标", "优化指令")
