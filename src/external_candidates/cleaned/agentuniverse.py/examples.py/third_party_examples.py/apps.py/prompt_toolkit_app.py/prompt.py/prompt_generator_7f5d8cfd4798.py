...
class PromptGenerator:
    ...
    def generate_prompt(
        ...
        instruction = self._generate_instruction(scenario, context, complexity, base_template, custom_requirements)

        return AgentPromptModel(introduction=introduction, target=target, instruction=instruction)
    ...
    def _generate_introduction(
        ...
        return template.format(role=role, audience=context.target_audience, domain=context.domain)
    ...
    def _generate_instruction(
        ...
        # Format with context
        instruction = template.format(tone=context.tone, domain=context.domain, audience=context.target_audience)
