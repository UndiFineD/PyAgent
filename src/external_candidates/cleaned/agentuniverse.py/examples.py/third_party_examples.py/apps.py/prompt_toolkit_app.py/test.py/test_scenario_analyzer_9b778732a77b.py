# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\third_party_examples\apps\prompt_toolkit_app\test\test_scenario_analyzer.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class TestScenarioAnalyzer(unittest.TestCase):
    ...
    def test_analyze_scenario_with_additional_context(self):
        ...
        result = self.analyzer.analyze_scenario(self.sample_content, self.sample_additional_context)
    ...
    def test_get_context_value(self):
        ...
        value = self.analyzer._get_context_value(contexts, ContextType.DOMAIN, "默认")
        self.assertEqual(value, "技术")

        # Test non-existing context
        value = self.analyzer._get_context_value(contexts, ContextType.USER_ROLE, "默认")
