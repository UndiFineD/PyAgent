# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\examples\startup_app\demo_startup_app_with_agent_templates\intelligence\test\insurance_consult_pro_agent_test.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
