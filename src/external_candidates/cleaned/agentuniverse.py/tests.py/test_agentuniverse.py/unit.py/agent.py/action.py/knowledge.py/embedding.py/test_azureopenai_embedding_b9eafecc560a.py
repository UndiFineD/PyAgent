# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\embedding\test_azureopenai_embedding.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
#
...
from agentuniverse.agent.action.knowledge.embedding.azureopenai_embedding import (
