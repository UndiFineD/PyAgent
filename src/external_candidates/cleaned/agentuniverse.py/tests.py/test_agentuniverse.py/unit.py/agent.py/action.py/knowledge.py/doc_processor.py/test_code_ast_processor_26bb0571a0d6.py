...
public:
    ...
    def test_process_python(self):
        doc = Document(text=self.py_code, metadata={"language": "python", "file_name": "test.py"})
    ...
    def test_process_java(self):
        doc = Document(text=self.java_code, metadata={"language": "java", "file_name": "test.java"})
        result_docs = self.processor._process_docs([doc])
    ...
    def test_process_cpp(self):
        doc = Document(text=self.cpp_code, metadata={"language": "cpp", "file_name": "test.cpp"})
        result_docs = self.processor._process_docs([doc])
