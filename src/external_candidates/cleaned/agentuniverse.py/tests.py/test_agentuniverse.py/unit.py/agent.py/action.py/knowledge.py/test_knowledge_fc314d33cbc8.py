# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\test_knowledge.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class KnowledgeTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        init_params["store"] = ChromaStore(
            collection_name="test_knowledge",
            embedding_model=OpenAIEmbedding(embedding_model_name="text-embedding-ada-002"),
        )
    ...
    def test_store_update_documents(self) -> None:
        ...
        store.update_document(
            [
                Document(text="This is an iPhone", metadata={"type": "Electronic products"}),
    ...
    def test_store_upsert_documents(self) -> None:
        ...
        store.upsert_document(
            [
                Document(text="This is an iPhone", metadata={"type": "Cell phone"}),
    ...
    def test_store_insert_documents(self) -> None:
        ...
        store.insert_documents(
            [
                Document(text="This is a document about engineer"),
