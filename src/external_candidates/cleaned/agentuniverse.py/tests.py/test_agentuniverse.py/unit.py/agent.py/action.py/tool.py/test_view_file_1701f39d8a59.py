# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\tool\test_view_file.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class ViewFileToolTest(unittest.TestCase):
    ...
    def test_view_entire_file(self):
        tool_input = ToolInput({"file_path": self.temp_file_path})
    ...
    def test_view_specific_lines(self):
        tool_input = ToolInput({"file_path": self.temp_file_path, "start_line": 1, "end_line": 3})
    ...
    def test_invalid_file_path(self):
        tool_input = ToolInput({"file_path": "/path/to/nonexistent/file.txt"})
