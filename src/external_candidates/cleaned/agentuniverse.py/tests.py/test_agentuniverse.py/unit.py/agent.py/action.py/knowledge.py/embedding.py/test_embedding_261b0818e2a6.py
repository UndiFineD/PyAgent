# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent\action\knowledge\embedding\test_embedding.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class EmbeddingTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.embedding = OpenAIEmbedding(embedding_model_name="text-embedding-3-small", dimensions=1536)
