# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\tests\test_agentuniverse\unit\agent_serve\test_service_instance.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
import unittest
...
def test_service_instance():
    unittest.TestCase().assertRaises(Exception, ServiceInstance.__init__, "not_exist_service_code")
