# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\otel\instrumentation\llm\llm_instrumentor.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class LLMSpanAttributesSetter:
    ...
    def set_input_attributes(
        ...
        span.set_attribute(
            SpanAttributes.AU_LLM_INPUT,
            safe_json_dumps(input_params, ensure_ascii=False),
        )
        span.set_attribute(
            SpanAttributes.AU_LLM_LLM_PARAMS,
...
class StreamingResultProcessor:
    ...
    def _finalize_streaming_result(self, llm_output: list, usage: Optional[TokenUsage]) -> None:
        ...
        if pseudo_result.usage:
            ...
            add_current_token_usage(pseudo_result.usage, self.span.context.span_id)
