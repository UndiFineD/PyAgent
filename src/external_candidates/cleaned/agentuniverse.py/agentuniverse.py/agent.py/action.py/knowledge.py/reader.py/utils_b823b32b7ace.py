# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\knowledge\reader\utils.py
...
def _read_sample_bytes(source: Union[str, Path, BinaryIO, bytes, bytearray], sample_size: int) -> bytes:
...
def detect_file_encoding(
    source: Union[str, Path, BinaryIO, bytes, bytearray],
    sample_size: int = 32 * 1024,
    fallback_encodings: Iterable[str] = _FALLBACK_ENCODINGS,
) -> str:
