# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\memory\conversation_memory\conversation_memory_module.py
# !/usr/bin/env python3
# -*- coding:utf-8 -*-
