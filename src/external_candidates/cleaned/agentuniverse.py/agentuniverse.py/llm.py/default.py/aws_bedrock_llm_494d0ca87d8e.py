# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\llm\default\aws_bedrock_llm.py
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
class AWSBedrockLLM(LLM):
    ...
    def as_langchain(self):
        ...
        try:
            ...
            raise ImportError(
                "langchain-aws is required for LangChain integration. Install it with: pip install langchain-aws"
            )
