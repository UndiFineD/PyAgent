# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\base.py\tracing.py\otel.py\span_processor.py\span_json_exporter_c29979efcc48.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\otel\span_processor\span_json_exporter.py
