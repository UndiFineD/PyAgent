# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\decodingai_magazine_second_brain_ai_assistant_course.py\apps.py\second_brain_online.py\src.py\second_brain_online.py\application.py\agents.py\tools.py\summarizer_1f6967cdd405.py
...
class HuggingFaceEndpointSummarizerTool(Tool):
    ...
    description = (
        """Use this tool to summarize a piece of text. Especially useful when you need to summarize a document."""
    )
