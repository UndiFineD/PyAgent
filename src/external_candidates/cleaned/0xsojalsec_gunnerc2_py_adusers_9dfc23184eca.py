# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\bofs.py\active_directory.py\adusers.py\adusers_9dfc23184eca.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\bofs\Active_Directory\adusers\adusers.py
...
"""
    ...
    def args_inject(p):
        ...
        p.add_argument(
            "--dc",
            default="",
            help="Domain Controller hostname (no IPs). Empty => DC locator",
        )
        ...
        p.add_argument(
            ...
            default=False,
            action="store_true",
            help="Use LDAPS (default port 636)",
        )
