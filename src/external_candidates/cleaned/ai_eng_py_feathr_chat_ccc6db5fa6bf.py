# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\feathr.py\chat.py\feathr_chat_ccc6db5fa6bf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\chat\feathr_chat.py
...
class FeathrChat(object):
    ...
    def is_a_code_gen_question(self, question_with_prompt):
        ...
        return (
            ...
            "explain" not in question_with_prompt.lower()

            and "what" not in question_with_prompt.lower()
