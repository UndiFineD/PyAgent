# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_round_robin_model_1870bdee2706.py
...
class TestRoundRobinModel:
    ...
    def test_large_rotate_every_value(self):
        ...
        assert rrm._get_next_model().model_name == "m1"  # Still returns m1, but rotates after
