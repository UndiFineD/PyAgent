# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\itrocker.py\nanobanana_ppt_skills.py\simple_transition_prompt_generator_27e5a65a3d54.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\itrocker\nanobanana-ppt-skills\simple_transition_prompt_generator.py
