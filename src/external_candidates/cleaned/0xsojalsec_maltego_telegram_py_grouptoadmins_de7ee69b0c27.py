# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_maltego_telegram.py\transforms.py\grouptoadmins_de7ee69b0c27.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-maltego-telegram\transforms\GroupToAdmins.py
...
async def fetch_group_adminsistrators(username: str):
    ...
    async with app:
        async for m in app.get_chat_members(username, filter=enums.ChatMembersFilter.ADMINISTRATORS):
