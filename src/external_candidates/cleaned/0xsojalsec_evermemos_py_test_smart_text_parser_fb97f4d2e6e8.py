# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\tests.py\test_smart_text_parser_fb97f4d2e6e8.py
...
class TestToken:
    ...
    def test_token_creation(self):
        ...
        token = Token(type=TokenType.CJK_CHAR, content="你", start_pos=0, end_pos=1, score=1.0)
    ...
    def test_token_default_score(self):
        ...
        token = Token(type=TokenType.ENGLISH_WORD, content="hello", start_pos=0, end_pos=5)
...
class TestTokenConfig:
    ...
    def test_custom_config(self):
        ...
        config = TokenConfig(cjk_char_score=2.0, english_word_score=0.5, punctuation_score=0.0)
...
class TestSmartTextParser:
    ...
    def setup_method(self):
        ...
        self.custom_parser = SmartTextParser(
            TokenConfig(cjk_char_score=2.0, english_word_score=0.5, punctuation_score=0.0)
        )
