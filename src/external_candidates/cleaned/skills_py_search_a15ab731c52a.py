# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\lennertjansen.py\airweave.py\scripts.py\search_a15ab731c52a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\lennertjansen\airweave\scripts\search.py
