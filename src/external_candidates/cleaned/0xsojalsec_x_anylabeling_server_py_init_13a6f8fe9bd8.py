# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_x_anylabeling_server.py\app.py\models.py\init_13a6f8fe9bd8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-X-AnyLabeling-Server\app\models\__init__.py
