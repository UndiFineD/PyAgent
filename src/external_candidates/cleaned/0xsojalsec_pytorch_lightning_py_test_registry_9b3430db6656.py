# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pytorch_lightning.py\tests.py\tests_fabric.py\accelerators.py\test_registry_9b3430db6656.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\accelerators\test_registry.py
...
def test_accelerator_registry_with_new_accelerator():
    ...
    assert ACCELERATOR_REGISTRY[accelerator_name]["init_params"] == {
        "param1": "abc",
        "param2": 123,
    }
...
def test_registry_as_decorator():
    ...
    @test_registry.register(
        "test_decorator",
        description="Test decorator accelerator",
        param1="value1",
        param2=42,
    )
    ...
    assert test_registry["test_decorator"]["init_params"] == {
        "param1": "value1",
        "param2": 42,
    }
...
def test_registry_as_static_method():
    ...
    assert test_registry["test_static"]["init_params"] == {
        "param1": "static_value",
        "param2": 100,
    }
