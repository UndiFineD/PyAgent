# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\fraction12.py\canvas_os.py\canvas_inject_8a996262ccda.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\fraction12\canvas-os\canvas-inject.py
...
document.close();"""
    ...
    return {
        ...
        "step2_inject": {"action": "eval", "javaScript": js_code, "target": node_name},
    }
