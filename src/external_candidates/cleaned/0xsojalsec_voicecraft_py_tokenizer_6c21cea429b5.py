# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_voicecraft.py\data.py\tokenizer_6c21cea429b5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VoiceCraft\data\tokenizer.py
