# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_command_registry_160e4d0b583d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_command_registry.py
...
class TestCommandInfo:
    ...
    def test_command_info_minimal_parameters(self):
        ...
        cmd = CommandInfo(name="minimal", description="Minimal command", handler=lambda x: True)
    ...
    def test_command_info_empty_usage_gets_default(self):
        ...
        cmd = CommandInfo(name="test", description="Test", handler=lambda x: True, usage="")
...
class TestGetUniqueCommands:
    ...
    def test_get_unique_commands_no_duplicates(self):
        ...
        @register_command(name="test", description="Test", aliases=["t", "tst", "testing"])
        def handler(command: str) -> bool:
            return True
