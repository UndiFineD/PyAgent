# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ramonitor.py\silverbullet_skill.py\tests.py\test_server_d6f84de5d9c3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ramonitor\silverbullet-skill\tests\test_server.py
