# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\aenvironment.py\aenv.py\src.py\cli.py\cmds.py\list_ba102988d63f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\cli\cmds\list.py
