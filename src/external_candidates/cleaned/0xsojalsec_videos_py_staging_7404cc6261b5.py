# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2019.py\diffyq.py\part2.py\staging_7404cc6261b5.py
...
class PartTwoOfTour(TourOfDifferentialEquations):
    ...
    def zoom_in_to_one_thumbnail(self):
        ...
        self.play(
            ApplyMethod(frame.replace, thumbnails[1], path_arc=(-30 * DEGREES), run_time=3),
        )
