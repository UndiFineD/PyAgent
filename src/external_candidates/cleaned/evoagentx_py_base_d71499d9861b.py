# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\rag.py\readers.py\base_d71499d9861b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\readers\base.py
    ...
    def load(
        ...
        try:
            ...
            filter_file_by_suffix = (
                ...
                else ([filter_file_by_suffix] if isinstance(filter_file_by_suffix, str) else None)
            )
            ...
            llama_docs = (
                asyncio.run(reader.aload_data(show_progress=show_progress, num_workers=self.num_workers))
                if use_async
