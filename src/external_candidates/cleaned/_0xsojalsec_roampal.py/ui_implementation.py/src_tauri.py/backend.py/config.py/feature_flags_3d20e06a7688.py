# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\config\feature_flags.py
"""
    ...
    def save_flags(self):
        ...
        try:
            ...
            with open(self.config_path, "w") as f:
                ...
                config = {k: v for k, v in asdict(self.flags).items() if not k.startswith("_")}
