# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\interfaces\prompt_engine_interface.py
...
class PromptEngineInterface(ABC):
    ...
    @abstractmethod
    async def initialize(self, template_directory: str, config: Optional[Dict[str, Any]] = None) -> None:
        """
