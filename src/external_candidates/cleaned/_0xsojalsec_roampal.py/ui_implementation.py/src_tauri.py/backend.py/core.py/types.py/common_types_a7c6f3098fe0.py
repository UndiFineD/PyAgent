# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\types\common_types.py
import logging
    ...
    def from_action_type(cls, action_type: ActionType, is_og: bool = False) -> "InteractionType":
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Could not map ActionType '{action_type.name}' to InteractionType '{specific}'.")
