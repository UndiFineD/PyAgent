# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\core\interfaces\ingestion_manager_interface.py
...
class IngestionManagerInterface(ABC):
    ...
    async def initialize(
        self,
    ):  # Add settings, llm_client if directly needed by interface methods
