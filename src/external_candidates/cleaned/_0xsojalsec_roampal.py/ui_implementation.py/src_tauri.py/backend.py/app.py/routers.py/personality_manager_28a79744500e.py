...
async def get_current_template() -> PersonalityTemplate:
    ...
    try:
        ...
        return PersonalityTemplate(template_id=template_id, name=name, content=content, is_preset=is_preset)
...
async def get_template(template_id: str) -> PersonalityTemplate:
    ...
    try:
        ...
        if preset_file.exists():
            ...
            data = yaml.safe_load(content)
            name = _get_template_name(data)
            return PersonalityTemplate(template_id=template_id, name=name, content=content, is_preset=True)
        ...
        if custom_file.exists():
            ...
            data = yaml.safe_load(content)
            name = _get_template_name(data)
            return PersonalityTemplate(template_id=template_id, name=name, content=content, is_preset=False)
