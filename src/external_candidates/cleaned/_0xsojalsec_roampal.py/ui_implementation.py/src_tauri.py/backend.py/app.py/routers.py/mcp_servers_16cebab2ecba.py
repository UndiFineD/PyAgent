# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\app\routers\mcp_servers.py
"""
...
async def add_server(request: Request, body: AddServerRequest):
    ...
    success = await mcp_manager.add_server(name=body.name, command=body.command, args=body.args, env=body.env)
