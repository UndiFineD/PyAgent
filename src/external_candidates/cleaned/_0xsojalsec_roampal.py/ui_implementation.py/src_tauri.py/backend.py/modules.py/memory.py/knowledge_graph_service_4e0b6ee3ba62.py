...
class KnowledgeGraphService:
    ...
    def extract_concepts(self, text: str) -> List[str]:
        ...
        filtered_concepts = [c for c in concepts if not any(blocked in c for blocked in tool_blocklist)]
    ...
    async def track_problem_solution(self, doc_id: str, metadata: Dict[str, Any], context: Optional[Dict[str, Any]]):
    ...
    def add_solution_pattern_entry(self, pattern_hash: str, problem_text: str, solution_text: str, outcome: str):
