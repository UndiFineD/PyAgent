# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\modules\memory\outcome_tracker.py
"""
...
class OutcomeTracker:
        ...
        if result:
            ...
            """,
                (
                    ...
                    problem,
                    solution,
                    initial_counts["worked"],
                    initial_counts["failed"],
                    initial_counts["partial"],
                    json.dumps(contexts),
                    outcome,
                ),
            )
    ...
    async def infer_outcome_from_signals(self, session_id: str, lookback_messages: int = 5) -> Dict[str, Any]:
        """
    ...
    async def get_pattern_success_rate(self, problem: str, solution: str) -> Dict[str, Any]:
        """
    ...
    async def get_best_patterns(self, min_attempts: int = 3, min_success_rate: float = 0.7) -> List[Dict[str, Any]]:
        """
