...
class OllamaClient(LLMClientInterface):
    ...
    async def initialize(self, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            timeout_config = httpx.Timeout(self.request_timeout, connect=30, read=self.request_timeout, write=30)
    ...
    async def stream_response_with_tools(
        ...
        supports_native_tools = any(native_model in model_lower for native_model in NATIVE_TOOL_MODELS)
                        ...
                        try:
                            ...
                            if "error" in chunk:
                                ...
                                if "context" in error_msg.lower() and (
                                    "overflow" in error_msg.lower() or "length" in error_msg.lower()
                                ):
                                    user_msg = (
