# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\modules\embedding\embedding_service.py
    ...
    async def embed_text(self, text: str) -> List[float]:
        ...
        try:
            ...
            if len(embedding) != self._embedding_dim:
                logger.warning(
                    f"Dimension mismatch: expected {self._embedding_dim}, got {len(embedding)}. Padding/trimming."
                )
