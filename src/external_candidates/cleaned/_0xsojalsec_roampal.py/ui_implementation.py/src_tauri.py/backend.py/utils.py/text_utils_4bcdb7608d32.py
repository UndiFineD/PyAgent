# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\ui-implementation\src-tauri\backend\utils\text_utils.py
import re
...
def keyword_based_search(
    query_text: str, documents: List[Dict[str, Any]], text_key: str, top_k: int = 3
) -> List[Dict[str, Any]]:
