...
class TestDeletion:
    ...
    def mock_collections(self):
        working = MagicMock()
        working.get_fragment = MagicMock(return_value={"content": "test", "metadata": {"text": "test"}})
        working.delete_vectors = MagicMock()
...
class TestBatchPromotion:
    ...
    def mock_collections(self):
        working = MagicMock()
        working.list_all_ids = MagicMock(return_value=["working_high_score", "working_low_score", "working_old_item"])
