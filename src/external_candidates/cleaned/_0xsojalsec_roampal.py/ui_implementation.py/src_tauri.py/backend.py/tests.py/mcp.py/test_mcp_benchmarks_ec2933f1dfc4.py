...
class MCPBenchmarkSuite:
    ...
    async def initialize(self):
        ...
        self.memory_system = UnifiedMemorySystem(data_dir=str(self.test_data_dir), use_server=False)
...
async def test_cache_overhead():
    ...
    # Seed data
    for i in range(20):
        await suite.memory_system.store_memory_bank(text=f"Test fact {i}", tags=["test"])
