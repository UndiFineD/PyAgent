...
async def run_scenario_with_outcomes(scenario: Dict, data_dir: str, embedding_service) -> Dict:
    """
...
async def run_scenario_without_outcomes(scenario: Dict, data_dir: str, embedding_service) -> Dict:
    """
