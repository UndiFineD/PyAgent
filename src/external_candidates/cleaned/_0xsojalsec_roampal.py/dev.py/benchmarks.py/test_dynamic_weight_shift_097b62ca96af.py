...
async def main():
    ...
    worked_scenarios = [
        r for r in results if "worked" in str(TEST_SCENARIOS[results.index(r)]["proven_memory"]["outcome"])
    ]
    failed_scenarios = [
        r for r in results if "failed" in str(TEST_SCENARIOS[results.index(r)]["proven_memory"]["outcome"])
    ]
