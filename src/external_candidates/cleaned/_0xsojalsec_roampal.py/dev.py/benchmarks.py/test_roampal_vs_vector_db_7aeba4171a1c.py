# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\dev\benchmarks\test_roampal_vs_vector_db.py
"""
================================================================================
...
async def run_control_scenario(scenario: Dict, data_dir: str, embedding_service) -> Dict:
    ...
    collection = client.create_collection(name="control_test", metadata={"hnsw:space": "l2"})
