...
async def main():
    ...
    train_results = [
        r for r in all_results if r.condition == "full_roampal" and r.maturity == "mature" and r.domain in TRAIN_DOMAINS
    ]
    test_results = [
        r for r in all_results if r.condition == "full_roampal" and r.maturity == "mature" and r.domain in TEST_DOMAINS
    ]
                    ...
                    "by_condition": {
                        c: {
                            "top1": statistics.mean(
                                [1 if r.top1_correct else 0 for r in all_results if r.condition == c]
                            )
                            * 100,
                    ...
                    "learning_curve": [
                        {
                            ...
                            "top1": statistics.mean(
                                [
                                    ...
                                    if r.condition == "full_roampal" and r.maturity == m["name"]
                                ]
                            )
                            * 100,
                            "mrr": statistics.mean(
