# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-roampal\dev\benchmarks\test_latency_benchmark.py
import os
...
async def benchmark_search_latency():
    ...
    print("=" * 80)
    print("ROAMPAL MEMORY SYSTEM - LATENCY BENCHMARK")
    print("=" * 80)
    print()

    # Initialize system
    print("[1/5] Initializing memory system...")
    system = UnifiedMemorySystem(data_dir="./test_latency_data", use_server=False)
    ...
    for size in test_sizes:
        ...
        # Clean state
        try:
            await system.collections["memory_bank"].delete_all()
        except:
            pass
    ...
    # Cleanup
    shutil.rmtree("./test_latency_data", ignore_errors=True)
