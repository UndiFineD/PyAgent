...
async def test_at_maturity_level(scenario: Dict, maturity: Dict, data_dir: str, embedding_service) -> Dict:
    ...
    results = await system.search(scenario["query"], collections=["working", "history", "patterns"], limit=10)
...
async def main():
    ...
    for scenario in SCENARIOS:
        for maturity in MATURITY_LEVELS:
            ...
            result = await test_at_maturity_level(scenario, maturity, data_dir, embedding_service)
