...
async def test_stale_data():
    ...
    # Initialize system
    memory = UnifiedMemorySystem(data_dir="test_data_stale", use_server=False, llm_service=None)
    ...
    for test in test_cases:
        ...
        results = await memory.search(query=test["query"], collections=["memory_bank"], limit=3)
