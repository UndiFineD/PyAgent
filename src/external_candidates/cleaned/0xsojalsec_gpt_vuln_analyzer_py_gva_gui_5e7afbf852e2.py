# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gpt_vuln_analyzer.py\gva_gui_5e7afbf852e2.py
...
def select_frame_by_name(name):
    ...
    button = customtkinter.CTkButton(
        master=frame,
        text="Run",
        command=lambda: application(attack=name, entry2=entry2, entry3=entry3, entry_ai=entry_ai, entry5=entry5),
    )
