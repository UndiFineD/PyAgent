# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\robbyczgw_cla.py\sports_ticker.py\scripts.py\espn_a4e01d9defa0.py
...
def get_team_fixtures(team_id: str, days: int = 30, sport: str = "soccer", leagues: list = None) -> list:
