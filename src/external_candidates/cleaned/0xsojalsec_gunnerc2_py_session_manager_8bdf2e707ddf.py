# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\session_handlers.py\session_manager_8bdf2e707ddf.py
...
def resolve_sid(raw: str) -> str | None:
    ...
    try:
        if any(ch in raw for ch in "*?"):
            ...
            matches += [alias_map[alias] for alias in alias_map if fnmatch.fnmatch(alias, raw)]
