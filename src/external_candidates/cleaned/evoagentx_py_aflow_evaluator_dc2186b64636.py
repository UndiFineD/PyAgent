# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\evaluators.py\aflow_evaluator_dc2186b64636.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\evaluators\aflow_evaluator.py
...
class AFlowEvaluator:
    ...
    async def graph_evaluate_async(
        ...
        results = await tqdm_asyncio.gather(*tasks, desc=f"Evaluating {benchmark.name} problems", total=len(data))
