# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\stacking_coins_fa9aa6e42cbc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\stacking_coins.py
    ...
    def construct(self):
        ...
        for i in range(120):
            ...
            if flip == "H":
                ...
                self.play(Transform(heads_stack, new_heads_stack, run_time=0.2))
                ...
                self.play(Transform(tails_stack, new_tails_stack, run_time=0.2))
