# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_market_claude_code_skills.py\transcript_fixer.py\scripts.py\utils.py\diff_formats.py\inline_format_c043743a445d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\diff_formats\inline_format.py
