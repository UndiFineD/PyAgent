# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\document.py\memory.py\memcell_7d67ba23c9c4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\persistence\document\memory\memcell.py
...
class Message(BaseModel):
    ...
    extend: Optional[Dict[str, str]] = Field(default=None, description="Extended fields")
...
class MemCell(DocumentBase, AuditBase):
    ...
    group_id: Optional[Indexed(str)] = Field(default=None, description="Group ID, empty means private chat")

    original_data: Optional[List] = Field(default=None, description="Original information")

    participants: Optional[List[str]] = Field(default=None, description="Names of event participants")
    ...
    linked_entities: Optional[List[str]] = Field(default=None, description="Associated entity IDs")
    ...
    event_log: Optional[Dict] = Field(default=None, description="Event Log atomic facts")
    ...
    class Settings:
        ...
        indexes = [
            ...
            IndexModel([("participants", ASCENDING)], name="idx_participants", sparse=True),
