# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_red_teaming_playground_labs.py\src.py\picture_submission.py\webapi.py\app_b92c7a98e242.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\src\picture-submission\webapi\app.py
...
from server.settings import (
    ...
    CONFIG_AUTH_TYPE,
    CONFIG_CHALLENGE_DESCRIPTION,
    CONFIG_CHALLENGE_ID,
    CONFIG_CHALLENGE_NAME,
    CONFIG_CHALLENGE_SETTINGS,
    CONFIG_REDIS_URL,
    CONFIG_STORAGE_ACCOUNT_URL,
)
