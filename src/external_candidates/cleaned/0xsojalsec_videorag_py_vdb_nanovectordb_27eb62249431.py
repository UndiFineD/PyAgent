# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videorag.py\vimo_desktop.py\python_backend.py\videorag.py\storage.py\vdb_nanovectordb_27eb62249431.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoRAG\Vimo-desktop\python_backend\videorag\_storage\vdb_nanovectordb.py
...
from .._utils import get_best_device, get_imagebind_device, logger
