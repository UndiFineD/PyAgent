# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\stream_omni.py\model.py\multimodal_encoder.py\hf_vision_90dc4e8e111d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\stream_omni\model\multimodal_encoder\hf_vision.py
...
from transformers import AutoConfig, AutoImageProcessor, AutoModel, CLIPImageProcessor
...
class HFVisionTower(nn.Module):
    ...
    def load_model(self):
        ...
        self.vision_tower = AutoModel.from_pretrained(
            self.vision_tower_name, torch_dtype=torch.bfloat16, trust_remote_code=True
        ).to("cuda")
