# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\crocketc.py\ms_qwen_vl.py\scripts.py\ms_qwen_vl_2c8068adfab5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\crocketc\ms-qwen-vl\scripts\ms_qwen_vl.py
