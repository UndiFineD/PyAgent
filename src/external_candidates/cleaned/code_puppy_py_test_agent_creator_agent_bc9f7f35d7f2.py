# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_agent_creator_agent_bc9f7f35d7f2.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_agent_creator_agent.py
...
class TestAgentCreatorAgent:
    ...
    def test_get_system_prompt_injects_tools_list(self, monkeypatch):
        ...
        monkeypatch.setattr("code_puppy.agents.agent_creator_agent.ModelFactory.load_config", lambda: {})
