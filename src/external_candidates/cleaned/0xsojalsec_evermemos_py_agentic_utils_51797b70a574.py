# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\agentic_layer.py\agentic_utils_51797b70a574.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\agentic_layer\agentic_utils.py
...
def format_documents_for_llm(results: List[Tuple[Any, float]], max_docs: int = 10) -> str:
    """
