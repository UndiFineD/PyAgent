# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\mcp_servers.py\spotify.py\tools.py\playlists_cb870fc22652.py
...
def get_current_user_playlists(sp: Spotify = None, limit: int = 20, offset: int = 0) -> List[Dict]:
    """
...
def add_items_to_playlist(
    ...
    try:
        ...
        for i in range(0, len(item_uris), MAX_ITEMS_PER_REQUEST):
            ...
            results = sp.playlist_add_items(playlist_id=playlist_id, items=chunk, position=position)
