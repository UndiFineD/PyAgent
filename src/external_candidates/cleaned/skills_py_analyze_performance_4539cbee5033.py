# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\social_media_analyzer.py\scripts.py\analyze_performance_4539cbee5033.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\social-media-analyzer\scripts\analyze_performance.py
...
class PerformanceAnalyzer:
    ...
    def benchmark_performance(self) -> Dict[str, str]:
        ...
        engagement_status = (
            "excellent"
            if engagement_rate >= benchmark_engagement * 1.5
            else "good"
    ...
    def generate_insights(self) -> Dict[str, Any]:
        ...
        elif engagement_status in ["good", "excellent"] and ctr_status in [
            "good",
            "excellent",
        ]:
            overall_health = "good"
