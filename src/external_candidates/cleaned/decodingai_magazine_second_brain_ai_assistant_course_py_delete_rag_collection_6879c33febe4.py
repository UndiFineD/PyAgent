# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\decodingai_magazine_second_brain_ai_assistant_course.py\apps.py\second_brain_offline.py\tools.py\delete_rag_collection_6879c33febe4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\tools\delete_rag_collection.py
...
def delete_rag_collection(mongo_uri: str = settings.MONGODB_URI, db_name: str = settings.MONGODB_DATABASE_NAME) -> None:
    """
