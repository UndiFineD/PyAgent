# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-judgy\src\judgy\synthetic.py
"""
...
def generate_test_data(
    ...
    # Create true labels
    test_labels = np.concatenate([np.ones(n_positive, dtype=int), np.zeros(n_negative, dtype=int)])
...
def run_sensitivity_experiment(
    ...
    for accuracy_val in accuracy_values:
        ...
        # Generate test data
        test_labels, test_preds = generate_test_data(n_test_positive, n_test_negative, tpr, tnr)
