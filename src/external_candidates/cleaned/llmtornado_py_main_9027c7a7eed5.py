# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llmtornado.py\src.py\llmtornado.py\llmtornado.py\main_9027c7a7eed5.py
...
def parse_args():
    ...
    parser.add_argument("--mcp", action="store_true", help="Run as MCP server (stdio mode)")
