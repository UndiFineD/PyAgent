# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\urlhaus.py
import json
import os
import sys
import textwrap
...
class URLHausExtractor:
    ...
    def requestHAUSSUBMITAPI(self):
        if self.HAUSSUBMITAPI == "":
            print(
                ...
                + "\nTo be able to get/submit information from/to URLHaus, you must create the .malwapi.conf file under your user home directory (on Linux is $HOME\\.malwapi.conf and on Windows is in C:\\Users\\[username]\\.malwapi.conf) and insert the URLHaus API according to the format shown on the Github website."
                + mycolors.reset
                + "\n"
            )
            exit(1)
            ...
            if "urls" in haustext:
                if ("url_id" in haustext["urls"]) is not None:
                    print(
                        ...
                        + " " * 2
                        + "FType".ljust(7)
                        + " SHA256 Hash".center(64)
                        + " " * 4
                        + "Virus Total".ljust(14)
                        + " " * 2
                        + "URL to Payload".center(34)
                    )
                    print("-" * 140 + "\n")
                    for w in haustext["urls"]:
                        if cv.bkg == 1:
                            ...
                            if w["url_status"] == "offline":
                                print(
                                    mycolors.foreground.lightred + mycolors.reverse + w["url_status"] + mycolors.reset,
                                    end=" ",
                                )
                            if w["url_status"] == "":
                                print(
                                    mycolors.foreground.yellow + mycolors.reverse + "unknown" + mycolors.reset,
                                    end=" ",
                                )
                            if w["file_type"]:
                                print(
                                    mycolors.foreground.lightcyan + " " * 2 + "%-6s" % w["file_type"] + mycolors.reset,
                                    end=" ",
                                )
                            else:
                                print(
                                    mycolors.foreground.lightcyan + " " * 2 + "%-6s" % "data" + mycolors.reset,
                                    end=" ",
                                )
                            if w["sha256_hash"]:
                                print(
                                    mycolors.foreground.yellow + w["sha256_hash"] + mycolors.reset,
                                    end=" ",
                                )
                            if w["virustotal"]:
                                print(
                                    mycolors.foreground.lightcyan
                                    + " " * 2
                                    + "%-9s" % w["virustotal"].get("result")
                                    + mycolors.reset,
                                    end="\t  ",
                                )
                            else:
                                print(
                                    mycolors.foreground.lightcyan + " " * 2 + "%-9s" % "Not Found" + mycolors.reset,
                                    end="\t  ",
                                )
                            if w["url"]:
                                print(
                                    mycolors.foreground.lightred
                                    + (("\n" + " ".ljust(98)).join(textwrap.wrap(w["url"], width=35))),
                                    end="\n",
                                )
                            else:
                                print(
                            ...
                            if w["url_status"] == "offline":
                                print(
                                    mycolors.foreground.red + mycolors.reverse + w["url_status"] + mycolors.reset,
                                    end=" ",
                                )
                            if w["url_status"] == "":
                                print(
                                    mycolors.foreground.blue + mycolors.reverse + "unknown" + mycolors.reset,
                                    end=" ",
                                )
                            if w["file_type"]:
                                print(
                                    mycolors.foreground.purple + " " * 2 + "%-6s" % w["file_type"] + mycolors.reset,
                                    end=" ",
                                )
                            else:
                                print(
                                    mycolors.foreground.purple + " " * 2 + "%-6s" % "data" + mycolors.reset,
                                    end=" ",
                                )
                            if w["sha256_hash"]:
                                print(
                                    mycolors.foreground.red + w["sha256_hash"] + mycolors.reset,
                                    end=" ",
                                )
                            if w["virustotal"]:
                                print(
                                ...
                                print(
                                    mycolors.foreground.cyan + " " * 2 + "%-9s" % "Not Found" + mycolors.reset,
                                    end=" ",
                                )
                            if w["url"]:
                                print(
                                ...
                                print(
                                    mycolors.foreground.green + " " * 2 + "URL not provided".center(20) + mycolors.reset
                                )
                ...
                if ("url_id" in haustext["urls"]) is not None:
                    ...
                    for w in haustext["urls"]:
                        if cv.bkg == 1:
                            ...
                            if w["url"]:
                                if w["dateadded"]:
                                    ...
                                    print(
                                        mycolors.foreground.lightcyan
                                        + " " * 2
                                        + "not provided".center(17)
                                        + mycolors.reset,
                                        end=" ",
                                    )
                                if w["threat"]:
                                    print(
                                        mycolors.foreground.pink + (w["threat"]).ljust(17) + mycolors.reset,
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.pink + "not provided".center(22) + mycolors.reset,
                                        end=" ",
                                    )
                                if w["url"]:
                                    print(
                                        mycolors.foreground.yellow
                                        + ("\n" + "".ljust(51)).join(textwrap.wrap(w["url"], width=80)).ljust(80),
                                        end="\n",
                                    )
                                else:
                                    print(
                            ...
                            if w["url_status"] == "":
                                print(
                                    mycolors.foreground.cyan + mycolors.reverse + "unknown" + mycolors.reset,
                                    end=" ",
                                )
                            if w["url"]:
                                if w["dateadded"]:
                                ...
                                if w["threat"]:
                                    print(
                                        mycolors.foreground.blue + (w["threat"]).ljust(17) + mycolors.reset,
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.blue + "not provided".center(22) + mycolors.reset,
                                        end=" ",
                                    )
                                if w["url"]:
                                    print(
                        ...
                        if "url" in haustext["urls"][i]:
                            if cv.bkg == 1:
                                if haustext["urls"][i].get("url_status") == "online":
                                    print(
                                        mycolors.foreground.lightcyan
                                        + haustext["urls"][i].get("url_status")
                                        + " "
                                        + mycolors.reset,
                                        end=" ",
                                    )
                                ...
                                if haustext["urls"][i].get("url_status") == "":
                                    print(
                                        mycolors.foreground.yellow + "unknown" + mycolors.reset,
                                        end=" ",
                                    )
                                ...
                                print(
                                    ...
                                    + ("\n".ljust(55)).join(
                                        textwrap.wrap(
                                            (haustext["urls"][i].get("url")).ljust(14),
                                            width=75,
                                        )
                                    ),
                                    end="\n",
                                ...
                                if haustext["urls"][i].get("url_status") == "":
                                    print(
                                        mycolors.foreground.cyan + "unknown" + mycolors.reset,
                                        end=" ",
                                    )
                                if "tags" in haustext["urls"][i]:
    ...
    def hauspayloadslist(self):
        ...
        try:
            print("\n")
            print(
                (mycolors.reset + "Haus Downloadable Links to Recent Payloads".center(146)),
                end="",
            )
            print((mycolors.reset + "".center(28)), end="")
            print("\n" + (146 * "-").center(59))
                ...
                try:
                    for i in range(0, npayloads):
                        if "sha256_hash" in haustext["payloads"][i]:
                            if cv.bkg == 1:
                                print(
                                    mycolors.foreground.lightred + "%-8s" % haustext["payloads"][i].get("file_type"),
                                    end=" ",
                                )
                                print(
                                    mycolors.foreground.lightcyan + haustext["payloads"][i].get("firstseen"),
                                    end=" ",
                                )
                                results = haustext["payloads"][i]["virustotal"]
                                if (results) is not None:
                                    print(
                                        mycolors.foreground.yellow + (results["result"]).center(9),
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.yellow + "Not Found",
                                        end=" ",
                                    )
                                print(mycolors.foreground.lightcyan + haustext["payloads"][i].get("urlhaus_download"))
                            else:
                                print(
                                    mycolors.foreground.red + "%-8s" % haustext["payloads"][i].get("file_type"),
                                    end=" ",
                                )
                                print(
                                    mycolors.foreground.green + haustext["payloads"][i].get("firstseen"),
                                    end=" ",
                                )
                                results = haustext["payloads"][i]["virustotal"]
                                if (results) is not None:
                                    print(
                                        mycolors.foreground.purple + (results["result"]).center(9),
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.purple + "Not Found",
                                        end=" ",
                                    )
    ...
    def urlhauscheck(self, urlx):
        ...
        try:
            ...
            if "url" in haustext:
                ...
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.lightcyan + "URL: \t\t" + haustext.get("url") + "  (city: " + urlcity + ")"
                    )
                else:
                        ...
                        if cv.bkg == 1:
                            ...
                            if "firstseen" in i:
                                if i["firstseen"] is not None:
                                    print(
                                        mycolors.foreground.pink + "firstseen:%12s" % i["firstseen"],
                                        end="     ",
                                    )
                            if "filename" in i:
                                if i["filename"] is not None:
                                    print(
                                        mycolors.foreground.yellow + "filename: %-30s" % i["filename"].ljust(40),
                                        end=" " + "",
                                    )
                            if "file_type" in i:
                                if i["file_type"] is not None:
                                    print(
                                        mycolors.foreground.lightred
                                        + "filetype: %s" % i["file_type"].ljust(10)
                                        + Fore.WHITE,
                                        end=" " + "",
                                    )
                            ...
                            if "firstseen" in i:
                                if i["firstseen"] is not None:
                                    print(
                                        mycolors.foreground.purple + "firstseen:%12s" % i["firstseen"],
                                        end="     ",
                                    )
                            if "filename" in i:
                                if i["filename"] is not None:
                                    print(
                                        mycolors.foreground.green + "filename: %-30s" % i["filename"].ljust(40),
                                        end=" " + "",
                                    )
                            if "file_type" in i:
                                if i["file_type"] is not None:
                    ...
                    for w in allurls:
                        if cv.bkg == 1:
                            ...
                            if w["filename"] is not None:
                                print(
                                    mycolors.foreground.pink + "%-36s" % w["filename"] + mycolors.reset,
                                    end=" ",
                                )
                            else:
                                print(
                                    mycolors.foreground.pink + "%-36s" % "Filename not reported!" + mycolors.reset,
                                    end=" ",
                                )
                            if w["url"] is not None:
                                if validators.url(w["url"]):
                                    print(
                                        mycolors.foreground.lightcyan + urltoip((w["url"])).ljust(20) + mycolors.reset,
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.lightcyan + "Not located".center(20) + mycolors.reset,
                                        end=" ",
                                    )
                                ...
                                print(
                                    mycolors.foreground.lightcyan + "URL not provided".center(20) + mycolors.reset,
                                    end=" ",
                                )
                            ...
                            if w["url"]:
                                if validators.url(w["url"]):
                                    print(
                                        mycolors.foreground.green + (urltoip(w["url"])).ljust(20) + mycolors.reset,
                                        end=" ",
                                    )
                                else:
                                    print(
                                        mycolors.foreground.green + "Not located".center(20) + mycolors.reset,
                                        end=" ",
                                    )
