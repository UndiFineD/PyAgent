# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\alienvault.py
import json
import textwrap
    ...
    def requestALIENAPI(self):
        if self.ALIENAPI == "":
            print(
                ...
                + "\nTo be able to get information from AlienVault, you must create the .malwapi.conf file under your user home directory (on Linux is $HOME\\.malwapi.conf and on Windows is in C:\\Users\\[username]\\.malwapi.conf) and insert the Alien Vault API according to the format shown on the Github website."
                + mycolors.reset
                + "\n"
            )
            exit(1)
                    ...
                    for d in hatext["results"]:
                        ...
                        if d["description"]:
                            print(
                                ...
                                + ("\n".ljust(14)).join(
                                    textwrap.wrap(
                                        (hatext["results"][x]["description"]).ljust(14),
                                        width=90,
                                    )
                                ),
                                end="\n",
                        ...
                        if hatext["results"][x]["references"]:
                            for r in hatext["results"][x]["references"]:
                                print(
                                    ...
                                    + "\nReferences: ".ljust(14)
                                    + mycolors.reset
                                    + ("\n".ljust(14)).join(textwrap.wrap(r, width=100)),
                                    end="",
                                )
                        if hatext["results"][x]["tags"]:
                            if hatext["results"][x]["tags"]:
                                print(
                                    mycolors.foreground.yellow + "\nTags:".ljust(13) + mycolors.reset,
                                    end=" ",
                                )
                                b = 0
                            ...
                            for r in hatext["results"][x]["indicators"]:
                                if r["indicator"]:
                                    print(
                                        ...
                                        + "Indicator: ".ljust(13)
                                        + mycolors.reset
                                        + r["indicator"].ljust(64),
                                        end="\t",
                                    )
                                    print(
                                        mycolors.foreground.yellow + "Title: " + mycolors.reset + r["title"],
                                        end="\n",
                                    )
                                    limit = limit + 1
                                if limit > 9:
                        ...
                        if hatext["results"][x]["indicators"]:
                            ...
                            for r in hatext["results"][x]["indicators"]:
                                if r["indicator"]:
                                    ...
                                    print(
                                        mycolors.foreground.blue + "Title: " + mycolors.reset + r["title"],
                                        end="\n",
                                    )
                                    limit = limit + 1
                                if limit > 9:
        ...
        try:
            ...
            if cv.bkg == 1:
                if "sections" in hatext:
                    ...
                    if hatext["asn"]:
                        print(
                            mycolors.foreground.lightcyan + "ASN:".ljust(13) + mycolors.reset + hatext["asn"],
                            end="\n",
                        )
                    if hatext["city"]:
                        print(
                            mycolors.foreground.lightcyan + "City:".ljust(13) + mycolors.reset + hatext["city"],
                            end="\n",
                        )
                                ...
                                while i < len(hatext["pulse_info"][key]):
                                    if isinstance(hatext["pulse_info"][key][i], dict):
                                        ...
                                        if "tags" in hatext["pulse_info"][key][i]:
                                            print(
                                                mycolors.foreground.lightcyan + "Tags:".ljust(12) + mycolors.reset,
                                                end=" ",
                                            )
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                if "modified" in (hatext["pulse_info"]["pulses"][i]):
                                    print(
                                        ...
                                        + "\nModified:".ljust(14)
                                        + mycolors.reset
                                        + (hatext["pulse_info"]["pulses"][i]["modified"]),
                                        end="",
                                    )
                                if "name" in (hatext["pulse_info"]["pulses"][i]):
                                    print(
                                        ...
                                        + "\nNews:".ljust(14)
                                        + mycolors.reset
                                        + (hatext["pulse_info"]["pulses"][i]["name"]),
                                        end="",
                                    )
                                if "created" in (hatext["pulse_info"]["pulses"][i]):
                                    print(
                                        ...
                                        + "\nCreated:".ljust(14)
                                        + mycolors.reset
                                        + (hatext["pulse_info"]["pulses"][i]["created"]),
                                        end="",
                                    )
                                    break
                                else:
                                    ...
                                    if key == "description":
                                        if hatext["pulse_info"]["pulses"][k]["description"]:
                                            print(
                                                ...
                                                + ("\n".ljust(14)).join(
                                                    textwrap.wrap(
                                                        hatext["pulse_info"]["pulses"][k]["description"],
                                                        width=100,
                                                    )
                                                ),
                                                end="\n",
                ...
                if "sections" in hatext:
                    ...
                    if hatext["asn"]:
                        print(
                            mycolors.foreground.green + "ASN:".ljust(13) + mycolors.reset + hatext["asn"],
                            end="\n",
                        )
                    if hatext["city"]:
                        print(
                            mycolors.foreground.green + "City:".ljust(13) + mycolors.reset + hatext["city"],
                            end="\n",
                        )
                    if hatext["country_name"]:
                        print(
                            mycolors.foreground.green + "Country:".ljust(13) + mycolors.reset + hatext["country_name"],
                            end="\n",
                        )
                    if hatext["pulse_info"]:
                        if "count" in (hatext["pulse_info"]):
        ...
        try:
            ...
            if cv.bkg == 1:
                if "indicator" in hatext:
                    ...
                    if hatext["alexa"]:
                        print(
                            mycolors.foreground.yellow + "Alexa:".ljust(13) + mycolors.reset + hatext["alexa"],
                            end="\n",
                        )
                    if hatext["pulse_info"]:
                        if "count" in (hatext["pulse_info"]):
                        ...
                        if hatext["pulse_info"]["pulses"]:
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                if "tags" in (hatext["pulse_info"]["pulses"][i]):
                                    print(
                                        mycolors.foreground.yellow + "Tags:".ljust(13),
                                        end="",
                                    )
                                ...
                                if "malware_families" in hatext["pulse_info"]["pulses"][i]:
                                    print(
                                        mycolors.foreground.yellow + "\nMalware:".ljust(14) + mycolors.reset,
                                        end="",
                                    )
                                ...
                                for y in x:
                                    if "description" in y:
                                        if x["description"]:
                                            ...
                                            print(
                                                mycolors.reset
                                                + ("\n".ljust(14)).join(textwrap.wrap(x["description"], width=100)),
                                                end="\n",
                                            )
                    if hatext["pulse_info"]:
                        if hatext["pulse_info"]["references"]:
                ...
                if "indicator" in hatext:
                    ...
                    if hatext["alexa"]:
                        print(
                            mycolors.foreground.purple + "Alexa:".ljust(13) + mycolors.reset + hatext["alexa"],
                            end="\n",
                        )
                    if hatext["pulse_info"]:
                        if "count" in (hatext["pulse_info"]):
                        ...
                        if hatext["pulse_info"]["pulses"]:
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                if "tags" in (hatext["pulse_info"]["pulses"][i]):
                                    print(
                                        mycolors.foreground.purple + "Tags:".ljust(13),
                                        end="",
                                    )
                                    for j in hatext["pulse_info"]["pulses"][i]["tags"]:
                                        print(mycolors.reset + j, end=" ")
                            ...
                            while i < len(hatext["pulse_info"]["pulses"]):
                                ...
                                if "malware_families" in hatext["pulse_info"]["pulses"][i]:
                                    if hatext["pulse_info"]["pulses"][i]["malware_families"]:
                                        ...
                                        for z in hatext["pulse_info"]["pulses"][i]["malware_families"]:
                                            print(
                                                mycolors.reset + z["display_name"],
                                                end=" ",
                                            )
                                if "created" in hatext["pulse_info"]["pulses"][i]:
                                    if hatext["pulse_info"]["pulses"][i]["created"]:
                                        print(
                                            mycolors.foreground.lightcyan + "\nCreated:".ljust(13) + mycolors.reset,
                                            end="",
                                        )
                                        print(
                                            mycolors.reset + hatext["pulse_info"]["pulses"][i]["created"],
                                            end=" ",
                                        )
                                if "modified" in hatext["pulse_info"]["pulses"][i]:
                                    if hatext["pulse_info"]["pulses"][i]["modified"]:
                                        print(
                                            mycolors.foreground.lightcyan + "\nModified:".ljust(13) + mycolors.reset,
                                            end="",
                                        )
                                        print(
                                            mycolors.reset + hatext["pulse_info"]["pulses"][i]["modified"],
                                            end=" ",
                                        )
                                if "targeted_countries" in hatext["pulse_info"]["pulses"][i]:
                                ...
                                for y in x:
                                    if "description" in y:
                                        if x["description"]:
                                            ...
                                            print(
                                                mycolors.reset
                                                + ("\n".ljust(13)).join(textwrap.wrap(x["description"], width=100)),
                                                end="\n",
                                            )
                        ...
                        if "references" in (hatext["pulse_info"]):
                            for j in hatext["pulse_info"]["references"]:
                                print(
                                    ...
                                    + "\nReferences: ".ljust(13)
                                    + mycolors.reset
                                    + ("\n".ljust(13)).join(textwrap.wrap(j, width=100)),
                                    end="",
                                )
                        print("\n")
            else:
                                ...
                                if "malware_families" in hatext["pulse_info"]["pulses"][t]:
                                    if hatext["pulse_info"]["pulses"][t]["malware_families"]:
                                        ...
                                        for w in hatext["pulse_info"]["pulses"][t]["malware_families"]:
                                            print(
                                                mycolors.reset + w["display_name"],
                                                end=" ",
                                            )
                                t = t + 1
                    if hatext["alexa"]:
                        print(
                            mycolors.foreground.lightred + "\nAlexa:".ljust(13) + mycolors.reset + hatext["alexa"],
                            end="",
                        )
