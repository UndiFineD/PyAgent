# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\virustotal.py
import base64
import json
import os
import re
...
from malwoverview.utils.peinfo import (
    ftype,
    isoverlay,
        ...
        try:
            ...
            if showreport == 0:
                ...
                if re.match(r"^PE[0-9]{2}|^MS-DOS", magictype):
                    if cv.bkg == 1:
                        print(
                            mycolors.foreground.lightred + "Overlay: ".ljust(21) + mycolors.reset + ret_overlay,
                            end="\n",
                        )
                if re.match(r"^PE[0-9]{2}|^MS-DOS", magictype):
                    if cv.bkg == 0:
                        print(
                            mycolors.foreground.red + "Overlay: ".ljust(21) + mycolors.reset + ret_overlay,
                            end="\n",
                        )
            else:
        ...
        if "last_analysis_results" in attrs:
            ...
            if "AlienVault" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "AlienVault: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            ...
            if "Avira" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Avira: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Avira: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Comodo Valkyrie Verdict" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Comodo: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Comodo: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "CyRadar" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "CyRadar: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Dr.Web" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Dr.Web: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Dr.Web: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Emsisoft" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Emsisoft: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "ESET" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "ESET: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "ESET: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Forcepoint ThreatSeeker" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Forcepoint: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Fortinet" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Fortinet: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "G-Data" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "G-Data: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "G-Data: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Google Safebrowsing" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Google: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Google: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Kaspersky" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Kaspersky: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            ...
            if "OpenPhish" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "OpenPhish: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "PhishLabs" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "PhishLabs: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Phishtank" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Phishtank: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Spamhaus" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Spamhaus: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Sophos" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Sophos: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Sophos: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Sucuri SiteCheck" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Sucuri: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Sucuri: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Trustwave" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Trustwave: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "URLhaus" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "URLhaus: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "VX Vault" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "VX Vault: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Webroot" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.lightcyan + "\n".ljust(26) + "Webroot: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
    ...
    def vt_url_ip_domain_report_light(self, vttext):
        ...
        if "last_analysis_results" in attrs:
            ...
            if "AlienVault" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "AlienVault: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "BitDefender" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "BitDefender: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "BitDefender: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "Avira" in attrs["last_analysis_results"]:
                result = attrs["last_analysis_results"]["Avira"]["result"]
            ...
            if "CyRadar" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "CyRadar: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Emsisoft" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Emsisoft: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Forcepoint ThreatSeeker" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Forcepoint: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Fortinet" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Fortinet: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Kaspersky" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Kaspersky: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "MalwarePatrol" in attrs["last_analysis_results"]:
                ...
                if result:
                    ...
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "MalwarePatrol: ".ljust(15) + mycolors.reset + ok,
                        end="",
                    )
            if "OpenPhish" in attrs["last_analysis_results"]:
                result = attrs["last_analysis_results"]["OpenPhish"]["result"]
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "OpenPhish: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "PhishLabs" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "PhishLabs: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Phishtank" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Phishtank: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Spamhaus" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Spamhaus: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Trustwave" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Trustwave: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "URLhaus" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "URLhaus: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "VX Vault" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "VX Vault: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if "Webroot" in attrs["last_analysis_results"]:
                ...
                if result:
                    print(
                        mycolors.foreground.cyan + "\n".ljust(26) + "Webroot: ".ljust(15) + mycolors.reset + result,
                        end="",
                    )
                else:
                    print(
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    if "creation_date" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow
                            + "\nCreation Date: ".ljust(26)
                            + mycolors.reset
                            + str(datetime.fromtimestamp(create_date)),
                            end="",
                        )
                    if "last_update_date" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow
                            + "\nLast Update Date: ".ljust(26)
                            + mycolors.reset
                            + str(datetime.fromtimestamp(last_update_date)),
                            end="",
                        )
                    if "registrar" in attrs:
                        registrar = attrs["registrar"]
                        print(
                            mycolors.foreground.yellow + "\nRegistrar: ".ljust(26) + mycolors.reset + registrar,
                            end="",
                        )
                    if "reputation" in attrs:
                        reputation = attrs["reputation"]
                        print(
                            mycolors.foreground.yellow + "\nReputation: ".ljust(26) + mycolors.reset + str(reputation),
                            end="",
                        )
                    if "whois" in attrs:
                        whois = attrs["whois"]
                        print(
                            ...
                            + "\nWhois: ".ljust(26)
                            + mycolors.reset
                            + (mycolors.reset + "\n".ljust(26)).join(textwrap.wrap(" ".join(whois.split()), width=80)),
                            end=" ",
                        )
                    if "whois_date" in attrs:
                        ...
                        print(
                            ...
                            + "\nWhois Date: ".ljust(26)
                            + mycolors.reset
                            + str(datetime.fromtimestamp(whois_date)),
                            end="",
                        )
                    if "jarm" in attrs:
                        jarm = attrs["jarm"]
                        print(
                            mycolors.foreground.lightred + "\n\nJarm: ".ljust(27) + mycolors.reset + str(jarm),
                            end="",
                        )
                    if "last_analysis_stats" in attrs:
                ...
                if cv.bkg == 0:
                    ...
                    if "last_analysis_stats" in attrs:
                        if "harmless" in attrs["last_analysis_stats"]:
                            harmless = attrs["last_analysis_stats"]["harmless"]
                            print(
                                mycolors.foreground.red + "\nHarmless: ".ljust(26) + mycolors.reset + str(harmless),
                                end="",
                            )
                    if "last_analysis_stats" in attrs:
                        if "malicious" in attrs["last_analysis_stats"]:
                            malicious = attrs["last_analysis_stats"]["malicious"]
                            print(
                                mycolors.foreground.red + "\nMalicious: ".ljust(26) + mycolors.reset + str(malicious),
                                end="",
                            )
                    if "last_analysis_stats" in attrs:
                        if "undetected" in attrs["last_analysis_stats"]:
                            undetected = attrs["last_analysis_stats"]["undetected"]
                            print(
                                mycolors.foreground.red + "\nUndetected: ".ljust(26) + mycolors.reset + str(undetected),
                                end="",
                            )
                    if "last_analysis_stats" in attrs:
                        if "suspicious" in attrs["last_analysis_stats"]:
                            suspicious = attrs["last_analysis_stats"]["suspicious"]
                            print(
                                mycolors.foreground.red + "\nSuspicious: ".ljust(26) + mycolors.reset + str(suspicious),
                                end="",
                            )
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    if "as_owner" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow + "\nAS Owner: ".ljust(26) + mycolors.reset + as_owner,
                            end="",
                        )
                    if "asn" in attrs:
                        asn = attrs["asn"]
                        print(
                            mycolors.foreground.yellow + "\nASN: ".ljust(26) + mycolors.reset + str(asn),
                            end="",
                        )
                    if "whois_date" in attrs:
                        whois_date = attrs["whois_date"]
                    ...
                    if "country" in attrs:
                        ...
                        print(
                            mycolors.foreground.lightcyan + "\n\nCountry: ".ljust(27) + mycolors.reset + country,
                            end="",
                        )
                    if "jarm" in attrs:
                        jarm = attrs["jarm"]
                        print(
                            mycolors.foreground.lightcyan + "\nJARM: ".ljust(26) + mycolors.reset + str(jarm),
                            end="",
                        )
                    if "network" in attrs:
                        network = attrs["network"]
                        print(
                            mycolors.foreground.lightcyan + "\nNetwork: ".ljust(26) + mycolors.reset + str(network),
                            end="",
                        )
                    if "regional_internet_registry" in attrs:
                        rir = attrs["regional_internet_registry"]
                        print(
                            mycolors.foreground.lightcyan + "\nR.I.R: ".ljust(26) + mycolors.reset + str(rir),
                            end="",
                        )
                    if "reputation" in attrs:
                        reputation = attrs["reputation"]
                ...
                if cv.bkg == 0:
                    ...
                    if "reputation" in attrs:
                        reputation = attrs["reputation"]
                        print(
                            mycolors.foreground.red + "\n\nReputation: ".ljust(27) + mycolors.reset + str(reputation),
                            end="",
                        )
                    if "last_analysis_stats" in attrs:
                        if "harmless" in attrs["last_analysis_stats"]:
                    ...
                    print(
                        mycolors.foreground.red + "\nCity: ".ljust(26) + mycolors.reset + str(geocoder.ip(myip).city),
                        end="",
                    )
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    ...
                    if "last_http_response_code" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow
                            + "\nLast HTTP Response Code: ".ljust(26)
                            + mycolors.reset
                            + str(last_http_response),
                            end="",
                        )
                    if "last_analysis_date" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow
                            + "\nLast Analysis Date: ".ljust(26)
                            + mycolors.reset
                            + str(datetime.fromtimestamp(last_analysis_date)),
                            end="",
                        )
                ...
                if cv.bkg == 1:
                    if prolog == 1:
                        if "md5" in attrs:
                            md5hash = attrs["md5"]
                            print(
                                mycolors.foreground.lightcyan + "\nMD5 hash: ".ljust(22) + mycolors.reset + md5hash,
                                end="",
                            )
                        if "sha1" in attrs:
                            sha1hash = attrs["sha1"]
                            print(
                                mycolors.foreground.lightcyan + "\nSHA1 hash: ".ljust(22) + mycolors.reset + sha1hash,
                                end="",
                            )
                        if "sha256" in attrs:
                ...
                if cv.bkg == 0:
                    if prolog == 1:
                        ...
                        if "sha256" in attrs:
                            sha256hash = attrs["sha256"]
                            print(
                                mycolors.foreground.cyan + "\nSHA256 hash: ".ljust(22) + mycolors.reset + sha256hash,
                                end="",
                            )
                        if "last_analysis_stats" in attrs:
                            malicious = attrs["last_analysis_stats"]["malicious"]
                            undetected = attrs["last_analysis_stats"]["undetected"]
                            print(
                                mycolors.foreground.red + "\n\nMalicious: ".ljust(23) + mycolors.reset + str(malicious),
                                end="",
                            )
                            print(
                                mycolors.foreground.red + "\nUndetected: ".ljust(22) + mycolors.reset + str(undetected),
                                end="\n",
                            )
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    ...
                    if "size" in attrs:
                        size = attrs["size"]
                        print(
                            mycolors.foreground.yellow + "\nSize: ".ljust(22) + mycolors.reset + str(size),
                            end="",
                        )
                    if "last_analysis_date" in attrs:
                        last_analysis_date = attrs["last_analysis_date"]
                    ...
                    if "type_tag" in attrs:
                        ...
                        print(
                            mycolors.foreground.yellow + "\nType Tag: ".ljust(22) + mycolors.reset + type_tag,
                            end="",
                        )
                    if "times_submitted" in attrs:
                        times_submitted = attrs["times_submitted"]
                    ...
                    if "popular_threat_classification" in attrs:
                        ...
                        if "popular_threat_category" in attrs["popular_threat_classification"]:
                            ...
                            for popular in attrs["popular_threat_classification"]["popular_threat_category"]:
                                ...
                                value = popular["value"]
                                print(
                                    mycolors.reset + "\n".ljust(22) + "popular count: ".ljust(15) + str(count),
                                    end="",
                                )
                                print(
                                    mycolors.reset + "\n".ljust(22) + "label: ".ljust(15) + str(value),
                                    end="\n",
                                )
                    if "trid" in attrs:
                        print(mycolors.foreground.lightcyan + "\nTrid: ", end="")
                        for trid in attrs["trid"]:
                            ...
                            print(
                                mycolors.reset + "\n".ljust(22) + "file_type: ".ljust(15) + str(file_type),
                                end="",
                            )
                            print(
                                mycolors.reset + "\n".ljust(22) + "probability: ".ljust(15) + str(probability),
                                end="\n",
                            )
                    if "names" in attrs:
                        print(mycolors.foreground.lightcyan + "\nNames: ", end="")
                        for name in attrs["names"]:
                            print(
                                ...
                                + (
                                    "\n".ljust(22)
                                    + (mycolors.reset + "\n".ljust(22)).join(
                                        textwrap.wrap(" ".join(name.split()), width=80)
                                    )
                                ),
                                end=" ",
                            )
                    if "pe_info" in attrs:
                        ...
                        if "import_list" in attrs["pe_info"]:
                            print(
                                mycolors.foreground.yellow + "\n".ljust(22) + "Libraries: ".ljust(15),
                                end="",
                            )
                            for lib in attrs["pe_info"]["import_list"]:
                                print(
                                    mycolors.reset + "\n".ljust(37) + str(lib["library_name"]),
                                    end="",
                                )
                        if "sections" in attrs["pe_info"]:
                            ...
                            for section in attrs["pe_info"]["sections"]:
                                ...
                                if "entropy" in section:
                                    ...
                                    print(
                                        mycolors.reset + "\n".ljust(37) + "entropy: ".ljust(14) + str(entropy),
                                        end=" ",
                                    )
                                if "flags" in section:
                                    flags = section["flags"]
                                    print(
                                        mycolors.reset + "\n".ljust(37) + "flags: ".ljust(14) + str(flags),
                                        end=" ",
                                    )
                    if "androguard" in attrs:
                        ...
                        if "main_activity" in attrs["androguard"]:
                            print(
                                mycolors.foreground.lightred + "\n\n".ljust(23) + "MainActivity: ".ljust(15),
                                end="",
                            )
                        ...
                        if "certificate" in attrs["androguard"]:
                            print(
                                mycolors.foreground.lightred + "\n".ljust(22) + "Certificate: ",
                                end="",
                            )
                            if "Issuer" in attrs["androguard"]["certificate"]:
                                print(
                                    mycolors.foreground.lightcyan + "\n".ljust(37) + "Issuer: ".ljust(15),
                                    end=" ",
                                )
                            ...
                            if "serialnumber" in attrs["androguard"]["certificate"]:
                                print(
                                    mycolors.foreground.lightcyan + "\n".ljust(37) + "SerialNumber: ".ljust(15),
                                    end=" ",
                                )
                        ...
                        if "intent_filters" in attrs["androguard"]:
                            print(
                                mycolors.foreground.lightred + "\n".ljust(22) + "IntentFilters: ",
                                end="",
                            )
                            if "Activities" in attrs["androguard"]["intent_filters"]:
                                print(
                                    mycolors.foreground.lightcyan + "\n".ljust(37) + "Activities: ".ljust(15),
                                    end=" ",
                                )
                                ...
                                if "full_description" in value:
                                    print(
                                        ...
                                        + (
                                            ...
                                            + (mycolors.reset + "\n".ljust(64)).join(
                                                textwrap.wrap(
                                                    " ".join(value["full_description"].split()),
                                                    width=80,
                                                )
                                            )
                                        ),
                                ...
                                if "short_description" in value:
                                    print(
                                        ...
                                        + (
                                            ...
                                            + "info: ".ljust(11)
                                            + mycolors.reset
                                            + ("\n" + mycolors.reset + "".ljust(63)).join(
                                                textwrap.wrap(value["short_description"], width=80)
                                            )
                                        ),
                                        end=" ",
                                    )
    ...
    def vtlargefile(self, file_item):
        ...
        try:
            ...
            if response.status_code == 404:
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.yellow + "\tThere was an issue while getting a URL for uploading the file."
                    )
                if cv.bkg == 0:
    ...
    def vtbatchcheck(self, filename, apitype):
        ...
        try:
            print(
                ...
                + "Threat Label".center(26)
                + "AV Detection".center(24)
            )
            print("-" * 152, end="\n\n")
                ...
                if type_description == "NOT FOUND":
                    if cv.bkg == 1:
                        print(
                            ...
                            + "\t   "
                            + mycolors.reset
                            + (hashitem.strip()).ljust(79)
                            + mycolors.foreground.yellow
                            + (type_description).ljust(28)
                            + mycolors.foreground.lightcyan
                            + (threat_label).ljust(26)
                            + mycolors.foreground.lightred
                            + str(malicious)
                        )
                    if cv.bkg == 0:
                    ...
                    if cv.bkg == 1:
                        print(
                            ...
                            + "\t   "
                            + mycolors.reset
                            + (hashitem.strip()).ljust(68)
                            + mycolors.foreground.yellow
                            + (type_description).ljust(30)
                            + mycolors.foreground.lightcyan
                            + (threat_label).ljust(34)
                            + mycolors.foreground.lightred
                            + str(malicious)
                        )
                    if cv.bkg == 0:
            ...
            if response.status_code == 404:
                ...
                if cv.bkg == 1:
                    ...
                    if "verdicts" in vttext["data"]:
                        print(
                            mycolors.foreground.yellow + "Verdicts: ".ljust(22) + mycolors.reset,
                            end=" ",
                        )
                    ...
                    if "verdict_confidence" in vttext["data"]:
                        print(
                            mycolors.foreground.yellow
                            + "\nVerdict Confidence: ".ljust(24)
                            + mycolors.reset
                            + str(vttext["data"]["verdict_confidence"])
                            + mycolors.reset,
                            end=" ",
                        )
                    if "verdict_labels" in vttext["data"]:
                        print(
                            mycolors.foreground.yellow + "\nVerdict Labels: ".ljust(23) + mycolors.reset,
                            end=" ",
                        )
                    ...
                    if "processes_injected" in vttext["data"]:
                        ...
                        for injected in vttext["data"]["processes_injected"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(injected, width=120))),
                                end=" ",
                            )
                    if "calls_highlighted" in vttext["data"]:
                        ...
                        for calls in vttext["data"]["calls_highlighted"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(calls, width=120))),
                                end=" ",
                            )
                    if "processes_tree" in vttext["data"]:
                        ...
                        for process in vttext["data"]["processes_tree"]:
                            print("\n")
                            print(
                                mycolors.reset + " ".ljust(23) + "process_id: ".ljust(15) + process["process_id"],
                                end="",
                            )
                            print(
                                mycolors.reset
                                + (
                                    "\n".ljust(24)
                                    + "process_name: ".ljust(15)
                                    + mycolors.reset
                                    + (mycolors.reset + "\n".ljust(39)).join(
                                        textwrap.wrap(" ".join(process["name"].split()), width=80)
                                    )
                                ),
                                end=" ",
                            )
                    ...
                    if "services_created" in vttext["data"]:
                        ...
                        for services_created in vttext["data"]["services_created"]:
                            print(
                                mycolors.reset + "".ljust(23) + services_created,
                                end="\n",
                            )
                    if "services_deleted" in vttext["data"]:
                        ...
                        for services_deleted in vttext["data"]["services_deleted"]:
                            print(
                                mycolors.reset + "".ljust(23) + services_deleted,
                                end="\n",
                            )
                    if "services_started" in vttext["data"]:
                        ...
                        for services_started in vttext["data"]["services_started"]:
                            print(
                                mycolors.reset + "".ljust(23) + services_started,
                                end="\n",
                            )
                    if "services_stopped" in vttext["data"]:
                        ...
                        for services_stopped in vttext["data"]["services_stopped"]:
                            print(
                                mycolors.reset + "".ljust(23) + services_stopped,
                                end="\n",
                            )
                    if "dns_lookups" in vttext["data"]:
                        ...
                        for lookup in vttext["data"]["dns_lookups"]:
                            ...
                            if "hostname" in lookup:
                                print(
                                    mycolors.reset + "\n".ljust(24) + "hostname: ".ljust(14) + lookup["hostname"],
                                    end="\n",
                                )
                    ...
                    if "modules_loaded" in vttext["data"]:
                        ...
                        for module in vttext["data"]["modules_loaded"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(module, width=120))),
                                end=" ",
                            )
                    if "registry_keys_opened" in vttext["data"]:
                        ...
                        for key in vttext["data"]["registry_keys_opened"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(key, width=120))),
                                end=" ",
                            )
                    if "files_opened" in vttext["data"]:
                        ...
                        for filename in vttext["data"]["files_opened"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(filename, width=120))),
                                end=" ",
                            )
                    if "files_written" in vttext["data"]:
                        ...
                        for filewritten in vttext["data"]["files_written"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(filewritten, width=120))),
                                end=" ",
                            )
                    if "files_deleted" in vttext["data"]:
                        ...
                        for filedeleted in vttext["data"]["files_deleted"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(filedeleted, width=120))),
                                end=" ",
                            )
                    if "command_executions" in vttext["data"]:
                        ...
                        for command in vttext["data"]["command_executions"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(command, width=120))),
                                end=" ",
                            )
                    if "mutexes_created" in vttext["data"]:
                        ...
                        for mutex in vttext["data"]["mutexes_created"]:
                            print(
                                mycolors.reset
                                + ("\n".ljust(24) + ("\n" + "".ljust(24)).join(textwrap.wrap(mutex, width=120))),
                                end=" ",
                            )
                ...
                if cv.bkg == 0:
                    ...
                    if "verdicts" in vttext["data"]:
                        print(
                            mycolors.foreground.purple + "Verdicts: ".ljust(22) + mycolors.reset,
                            end=" ",
                        )
                        for verdict in vttext["data"]["verdicts"]:
                            print(mycolors.reset + (verdict), end=" | ")
    ...
    def vtdirchecking(self, repo2, apitype):
        ...
        try:
            ...
            print(
                "\nSample".center(10)
                + "Filename".center(72)
                + "Description".center(26)
                + "Threat Label".center(28)
                + "AV Detection".center(26)
            )
            print("-" * 154, end="\n\n")
