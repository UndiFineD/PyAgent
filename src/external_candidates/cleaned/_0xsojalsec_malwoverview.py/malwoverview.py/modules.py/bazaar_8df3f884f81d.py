# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\bazaar.py
import json
import os
                        ...
                        if bazaartext["data"] is not None:
                            for d in bazaartext["data"]:
                                ...
                                if "comment" in y:
                                    if d["comment"]:
                                        print(
                                            mycolors.foreground.lightcyan + "\ncomments: ".ljust(15) + mycolors.reset,
                                            end="",
                                        )
                                        s = d["comment"].split("\n")
                                ...
                                if "vendor_intel" in y:
                                    if d["vendor_intel"] is not None:
                                        ...
                                        if "ANY.RUN" in d["vendor_intel"]:
                                            print(
                                                mycolors.foreground.yellow + "\nAny.Run: ".ljust(15) + mycolors.reset,
                                                end=" ",
                                            )
                                            for j in d["vendor_intel"]["ANY.RUN"]:
                                                if "analysis_url" in j:
                                                    print(
                                                        "\n".ljust(15) + j["analysis_url"],
                                                        end=" ",
                                                    )
                                ...
                                if "vendor_intel" in y:
                                    if d["vendor_intel"] is not None:
                                        if "UnpacMe" in d["vendor_intel"]:
                                            if d["vendor_intel"]["UnpacMe"]:
                                                print(
                                                    mycolors.foreground.red + "\nUnpacMe: ".ljust(15) + mycolors.reset,
                                                    end=" ",
                                                )
                                                filtered_list = []
                                                for j in d["vendor_intel"]["UnpacMe"]:
