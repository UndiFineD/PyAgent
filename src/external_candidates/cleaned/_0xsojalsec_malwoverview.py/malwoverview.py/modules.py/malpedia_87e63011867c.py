# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\malpedia.py
import base64
import json
import os
import textwrap
    ...
    def requestMALPEDIAAPI(self):
        if self.MALPEDIAAPI == "":
            print(
                ...
                + "\nTo be able to get information from Malpedia, you must create the .malwapi.conf file under your user home directory (on Linux is $HOME\\.malwapi.conf and on Windows is in C:\\Users\\[username]\\.malwapi.conf) and insert the Malpedia API according to the format shown on the Github website."
                + mycolors.reset
                + "\n"
            )
            exit(1)
        ...
        try:
            ...
            if cv.bkg == 1:
                ...
                for i in hatext:
                    if j < 10:
                        print(
                            mycolors.foreground.lightred + "Actor_%s:    " % j + mycolors.reset + str(i),
                            end="\n".ljust(11),
                        )
                    if (j > 9) and (j < 100):
                        print(
            ...
            if cv.bkg == 0:
                ...
                for i in hatext:
                    if j < 10:
                        print(
                            mycolors.foreground.red + "Actor_%s:    " % j + mycolors.reset + str(i),
                            end="\n".ljust(11),
                        )
                    if (j > 9) and (j < 100):
                        print(
        ...
        try:
            ...
            if cv.bkg == 1:
                for key, value in hatext.items():
                    print(
                        mycolors.foreground.yellow + "Family:".ljust(11) + mycolors.reset + key,
                        end=" ",
                    )
                    for i in value:
                        for j in i.items():
            ...
            if cv.bkg == 0:
                for key, value in hatext.items():
                    print(
                        mycolors.foreground.red + "Family:".ljust(11) + mycolors.reset + key,
                        end=" ",
                    )
                    for i in value:
                        for j in i.items():
    ...
    def malpedia_get_actor(self, arg1):
        ...
        try:
            ...
            if cv.bkg == 1:
                if hatext["value"]:
                    print(
                        mycolors.foreground.yellow + "\nActor:".ljust(11) + mycolors.reset + hatext["value"],
                        end=" ",
                    )
                if hatext["description"]:
                    print(
                        ...
                        + "\n\nOverview: ".ljust(11)
                        + mycolors.reset
                        + ("\n".ljust(11)).join(textwrap.wrap(str(hatext["description"]), width=100)),
                        end=" ",
                    )
                for key, value in hatext.items():
                    if key == "meta":
                                ...
                                if value["refs"]:
                                    for x in value["refs"]:
                                        print(
                                            ...
                                            + "\nREFs:".ljust(11)
                                            + mycolors.reset
                                            + ("\n".ljust(11)).join(wrapper.wrap(str(x))).ljust(11),
                                            end=" ",
                                        )
                    if key == "families":
                        for key3, value3 in value.items():
                            ...
                            if "attribution" in value3.keys():
                                if len(value3["attribution"]) > 0:
                                    print(
                                        mycolors.foreground.lightcyan + "Attrib.: ".ljust(9),
                                        end=" ",
                                    )
                            ...
                            if "description" in value3.keys():
                                if value3["description"]:
                                    print(
                                        ...
                                        + "\nDescr.: ".ljust(11)
                                        + mycolors.reset
                                        + ("\n".ljust(11)).join(textwrap.wrap(str(value3["description"]), width=100)),
                                        end=" ",
                                    )
                                ...
                                if len(value3["urls"]) > 0:
                                    for y in value3["urls"]:
                                        print(
                                            ...
                                            + "\nURLs: ".ljust(11)
                                            + mycolors.reset
                                            + ("\n".ljust(11)).join(wrapper.wrap(str(y))).ljust(11),
                                            end=" ",
                                        )
                    ...
                    if key == "families":
                        for key3, value3 in value.items():
                            ...
                            if "attribution" in value3.keys():
                                if len(value3["attribution"]) > 0:
                                    print(
                                        mycolors.foreground.green + "Attrib.: ".ljust(9),
                                        end=" ",
                                    )
                                    for y in value3["attribution"]:
                                        print(mycolors.reset + y, end=" ")
        ...
        try:
            ...
            if cv.bkg == 1:
                ...
                for i in hatext:
                    if j < 10:
                        print(
                            mycolors.foreground.lightcyan + "Family_%s:     " % j + mycolors.reset + str(i),
                            end="\n".ljust(11),
                        )
                    if (j > 9) and (j < 100):
                        print(
            ...
            if cv.bkg == 0:
                ...
                for i in hatext:
                    if j < 10:
                        print(
                            mycolors.foreground.cyan + "Family_%s:     " % j + mycolors.reset + str(i),
                            end="\n".ljust(11),
                        )
                    if (j > 9) and (j < 100):
                        print(
    ...
    def malpedia_get_family(self, arg1):
        ...
        try:
            ...
            if cv.bkg == 1:
                ...
                print(
                    mycolors.foreground.yellow + "\nUpdated:".ljust(14) + mycolors.reset + hatext["updated"],
                    end=" ",
                )
                ...
                if hatext["description"]:
                    print(
                        mycolors.foreground.yellow
                        + "\nDescription: ".ljust(13)
                        + mycolors.reset
                        + ("\n".ljust(14)).join(textwrap.wrap(hatext["description"], width=110)),
                        end="\n",
                    )
                    ...
                    for i in hatext["urls"]:
                        if j < 10:
                            print(
                                ...
                                + "\nURL_%d:".ljust(15) % j
                                + mycolors.reset
                                + ("\n".ljust(14)).join(textwrap.wrap(i, width=110)),
                                end=" ",
                            )
                        if j > 9 and j < 100:
                            print(
            ...
            if cv.bkg == 0:
                ...
                if hatext["common_name"]:
                    print(
                        mycolors.foreground.cyan + "\nCommon Name: ".ljust(13) + mycolors.reset + hatext["common_name"],
                        end=" ",
                    )
                if hatext["description"]:
                    print(
    ...
    def malpedia_get_sample(self, arg1):
        ...
        try:
            ...
            if "200" in str(haresponse):
                ...
                if cv.bkg == 1:
                    print(
                        mycolors.foreground.lightcyan + f"\nSample downloaded to: {outputpath}\n",
                        mycolors.reset,
                    )
                else:
                    print(
