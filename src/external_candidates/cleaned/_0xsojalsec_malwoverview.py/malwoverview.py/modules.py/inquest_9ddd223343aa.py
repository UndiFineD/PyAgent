                                        ...
                                        for j in d["inquest_alerts"]:
                                            ...
                                            for k in j:
                                                print(
                                                    ...
                                                    + ":\t"
                                                    + mycolors.reset
                                                    + (("\n" + " ".ljust(32)).join(textwrap.wrap(str(j[k]), width=80))),
                                                    end="\n",
                                                )
                                print("\n")
                            ...
                            for d in inquesttext["data"]:
                                ...
                                for k in d:
                                    print(
                                        ...
                                        + ":\t"
                                        + mycolors.reset
                                        + (("\n" + " ".ljust(0)).join(textwrap.wrap(str(d[k]), width=80))),
                                        end="\n",
                                    )
                            ...
                            for d in inquesttext["data"]:
                                ...
                                for k in d:
                                    print(
                                        ...
                                        + ": "
                                        + mycolors.reset
                                        + (("\n" + " ".ljust(16)).join(textwrap.wrap(str(d[k]), width=80))),
                                        end="\n",
                                    )
                            ...
                            for d in inquesttext["data"]:
                                ...
                                for k in d:
                                    print(
                                        ...
                                        + ": "
                                        + mycolors.reset
                                        + (("\n" + " ".ljust(14)).join(textwrap.wrap(str(d[k]), width=80))),
                                        end="\n",
                                    )
