# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-malwoverview\malwoverview\modules\triage.py
import binascii
import json
import os
import textwrap
...
class TriageExtractor:
    ...
    def requestTRIAGEAPI(self):
        if self.TRIAGEAPI == "":
            print(
                ...
                + "\nTo be able to get/submit information from/to Triage, you must create the .malwapi.conf file under your user home directory (on Linux is $HOME\\.malwapi.conf and on Windows is in C:\\Users\\[username]\\.malwapi.conf) and insert the Triage API according to the format shown on the Github website."
                + mycolors.reset
                + "\n"
            )
            exit(1)
        ...
        try:
            ...
            if "error" in triagetext:
                ...
                if triagetext["error"] == "INVALID_QUERY":
                    if cv.bkg == 1:
                        print(
                            "\n" + mycolors.foreground.lightred + triagetext["message"] + mycolors.reset,
                            end="\n\n",
                        )
                    else:
                        print(
                            "\n" + mycolors.foreground.red + triagetext["message"] + mycolors.reset,
                            end="\n\n",
                        )
                    exit(1)
            ...
            if cv.bkg == 0:
                for i in triagetext.keys():
                        ...
                        if triagetext["data"] is not None:
                            for d in triagetext["data"]:
                                ...
                                if "id" in y:
                                    if d["id"]:
                                        print(
                                            mycolors.foreground.cyan + "\nid: ".ljust(12) + mycolors.reset + d["id"],
                                            end=" ",
                                        )
                    ...
                    if i == "next":
                        if triagetext["next"] is not None:
                            print(
                                mycolors.foreground.purple + "\nnext: ".ljust(12) + mycolors.reset + triagetext["next"],
                                end=" ",
                            )
                ...
                for i in triagetext.keys():
                        ...
                        if triagetext["sample"] is not None:
                            ...
                            if "target" in y:
                                print(
                                    ...
                                    + "\ntarget: ".ljust(12)
                                    + mycolors.reset
                                    + triagetext["sample"]["target"],
                                    end=" ",
                                )

                            if "size" in y:
                                print(
                                    (mycolors.foreground.lightcyan + "\nsize: ".ljust(12) + mycolors.reset + "%d")
                                    % int(triagetext["sample"]["size"]),
                                    end=" ",
                                )
                            ...
                            for d in triagetext[i].keys():
                                ...
                                if "platform" in triagetext[i][d]:
                                    print(
                                        ...
                                        + "platform: ".ljust(8)
                                        + mycolors.reset
                                        + triagetext[i][d]["platform"],
                                        end=" ",
                                    )

                                print(
                                    mycolors.foreground.yellow + "\n".ljust(12) + "tags: ".ljust(10) + mycolors.reset,
                                    end=" ",
                                )
                    ...
                    if i == "targets":
                        if triagetext["targets"] is not None:
                            print(
                                mycolors.foreground.lightcyan + "\ntargets: ".ljust(12) + mycolors.reset,
                                end=" ",
                            )
                                ...
                                for m in triagetext["targets"][k]:
                                    ...
                                    if "family" == m:
                                        ...
                                        for n in range(len(triagetext["targets"][k][m])):
                                            print(
                                                mycolors.reset + str(triagetext["targets"][k][m][n]),
                                                end=" ",
                                            )
                                    if "iocs" == m:
                                        print(
                                            ...
                                            if "ips" == j:
                                                for i in range(len(triagetext["targets"][k][m][j])):
                                                    print(
                                                        "\n".ljust(22)
                                                        + mycolors.reset
                                                        + str(triagetext["targets"][k][m][j][i]),
                                                        end=" ",
                                                    )
                                            if "domains" == j:
                                                for i in range(len(triagetext["targets"][k][m][j])):
                    ...
                    if i == "signatures":
                        if triagetext[i] is not None:
                            print(
                                mycolors.foreground.lightcyan + "\nsignatures: ".ljust(12) + mycolors.reset,
                                end=" ",
                            )
                    ...
                    if i == "extracted":
                        if triagetext["extracted"] is not None:
                            print(
                                mycolors.foreground.lightcyan + "\nextracted: ".ljust(12) + mycolors.reset,
                                end=" ",
                            )
                                ...
                                for m in triagetext["extracted"][k]:
                                    if "tasks" == m:
                                        ...
                                        for i in range(len(triagetext["extracted"][k][m])):
                                            print(
                                                str(triagetext["extracted"][k][m][i]),
                                                end=" ",
                                            )
                                    if "resource" == m:
                                        print(
                                        ...
                                        for x in (triagetext["extracted"][k][m]).keys():
                                            if "family" == x:
                                                print(
                                                    ...
                                                    + "family: ".ljust(10)
                                                    + mycolors.reset
                                                    + str(triagetext["extracted"][k][m][x]),
                                                    end=" ",
                                                )
                                            if "rule" == x:
                                                print(
                                            ...
                                            if "extracted_pe" == x:
                                                print(
                                                    mycolors.foreground.yellow
                                                    + "\n".ljust(12)
                                                    + "extracted_pe: ".ljust(9)
                                                    + mycolors.reset,
                                                    end=" ",
                                                )
                                                for i in range(len(triagetext["extracted"][k][m][x])):
                                                    print(
                                                        "\n".ljust(22) + str(triagetext["extracted"][k][m][x][i]),
                                                        end=" ",
                                                    )
                                            if "c2" == x:
                                                print(
                                                ...
                                                for z in range(len(triagetext["extracted"][k][m][x])):
                                                    print(
                                                        "\n".ljust(22)
                                                        + mycolors.reset
                                                        + str(triagetext["extracted"][k][m][x][z]),
                                                        end=" ",
                                                    )
                                            if "botnet" == x:
                                                print(
                                                    ...
                                                    for q in (triagetext["extracted"][k][m][x][p]).keys():
                                                        if "key" == q:
                                                            print(
                                                                ...
                                                                + "key: ".ljust(10)
                                                                + mycolors.reset
                                                                + str(triagetext["extracted"][k][m][x][p][q]),
                                                                end=" ",
                                                            )
                                                        if "value" == q:
                                                            print(
                                                            ...
                                                            print(
                                                                ...
                                                                + (
                                                                    ("\n" + "".ljust(21)).join(
                                                                        textwrap.wrap(
                                                                            (triagetext["extracted"][k][m][x][p][q]),
                                                                            width=80,
                                                                        )
                                                                    )
                                                                ),
    ...
    def triage_sample_submit(self, triagex):
                ...
                if isinstance(value, tuple):
                    ...
                    body.write(
                        '--{boundary}\r\nContent-Disposition: form-data; filename="{filename}"; name="{field}"\r\n\r\n'.format(
                            boundary=boundary, field=field, filename=filename
                        ).encode("utf-8")
                    )
                    b = file.read()
                    if isinstance(b, str):
                    ...
                    body.write(
                        '--{boundary}\r\nContent-Disposition: form-data; name="{field}"\r\n\r\n{value}\r\n'.format(
                            boundary=boundary, field=field, value=value
                        ).encode("utf-8")
                    )
        ...
        try:
            ...
            if "id" in triagetext:
                if cv.bkg == 1:
                    print(
                        "\n" + mycolors.foreground.yellow + "id: ".ljust(12) + mycolors.reset + triagetext["id"],
                        end=" ",
                    )
                    print(
                        "\n"
                    ...
                    print(
                        ...
                        + "submitted: ".ljust(12)
                        + mycolors.reset
                        + triagetext["submitted"],
                        end=" ",
                    )
                if cv.bkg == 0:
                    print(
                        "\n" + mycolors.foreground.blue + "id: ".ljust(12) + mycolors.reset + triagetext["id"],
                        end=" ",
                    )
                    print(
                        "\n" + mycolors.foreground.blue + "status: ".ljust(12) + mycolors.reset + triagetext["status"],
                        end=" ",
                    )
                    print(
                        "\n"
    ...
    def triage_download(self, triagex):
        ...
        try:
            ...
            if cv.bkg == 1:
                print(
                    "\n" + mycolors.foreground.yellow + f"Sample downloaded to: {outputpath}" + mycolors.reset,
                    end=" ",
                )
            if cv.bkg == 0:
                print(
                    "\n" + mycolors.foreground.blue + f"Sample downloaded to: {outputpath}" + mycolors.reset,
                    end=" ",
                )
    ...
    def triage_download_pcap(self, triagex):
        ...
        try:
            ...
            if cv.bkg == 1:
                print(
                    "\n" + mycolors.foreground.yellow + f"PCAP downloaded to: {outputpath}" + mycolors.reset,
                    end=" ",
                )
            if cv.bkg == 0:
                print(
                    "\n" + mycolors.foreground.blue + f"PCAP downloaded to: {outputpath}" + mycolors.reset,
                    end=" ",
                )
                ...
                for i in triagetext.keys():
                    if i == "sample":
                        if triagetext["sample"] is not None:
                            ...
                            print(
                                mycolors.foreground.lightcyan + "\nstatic_tags: ".ljust(12) + mycolors.reset,
                                end=" ",
                            )
                    ...
                    if i == "analysis":
                        if triagetext[i] is not None:
                            print(
                                mycolors.foreground.lightcyan + "\n\nanalysis: ".ljust(11) + mycolors.reset,
                                end=" ",
                            )
                            ...
                            if "max_time_network" in triagetext[i]:
                                print(
                                    ...
                                    + "time_net: ".ljust(8)
                                    + mycolors.reset
                                    + str(triagetext[i]["max_time_network"]),
                                    end=" ",
                                )
                            if "max_time_kernel" in triagetext[i]:
                                print(
                                    ...
                                    + "time_krn: ".ljust(8)
                                    + mycolors.reset
                                    + str(triagetext[i]["max_time_kernel"]),
                                    end=" ",
                                )
                            ...
                            print(
                                mycolors.foreground.lightred + "\n".ljust(12) + "ttps: ".ljust(10) + mycolors.reset,
                                end=" ",
                            )
                            ...
                            print(
                                mycolors.foreground.lightred + "\n".ljust(12) + "features: ".ljust(10) + mycolors.reset,
                                end=" ",
                            )
                    ...
                    if i == "processes":
                        if triagetext[i] is not None:
                            print(
                                mycolors.foreground.lightcyan + "\nprocesses: ".ljust(12) + mycolors.reset,
                                end=" ",
                            )
                    ...
                    if i == "signatures":
                        ...
                        if triagetext[i] is not None:
                            ...
                            set_1 = ()
                            print(
                                mycolors.foreground.lightcyan + "\n".ljust(12) + "iocs: ".ljust(10) + mycolors.reset,
                                end="",
                            )
                            for y in range(len(triagetext[i])):
                                for d in (triagetext[i][y]).keys():
                            ...
                            for w in final_list:
                                print(
                                    "\n".ljust(17)
                                    + mycolors.reset
                                    + (("\n".ljust(19)).join(textwrap.wrap("* " + w, width=90))),
                                    end=" ",
                                )
                    ...
                    if i == "network":
                        ...
                        set_1 = ()
                        print(
                            mycolors.foreground.lightcyan + "\nnetwork: ".ljust(12) + mycolors.reset,
                            end="",
                        )
                        for d in (triagetext[i]).keys():
                            if d == "flows":
                        ...
                        for w in final_list:
                            print(
                                "\n".ljust(12) + mycolors.reset + (("\n".ljust(12)).join(textwrap.wrap(w, width=90))),
                                end=" ",
                            )
