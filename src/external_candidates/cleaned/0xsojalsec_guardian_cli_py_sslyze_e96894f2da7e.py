# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_guardian_cli.py\tools.py\sslyze_e96894f2da7e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-guardian-cli\tools\sslyze.py
        ...
        try:
            ...
            for protocol_key in protocol_checks:
                if protocol_key in scan_commands:
                    ...
                    if is_supported and protocol_key in [
                        "ssl_2_0",
                        "ssl_3_0",
                        "tls_1_0",
                        "tls_1_1",
            ...
            for vuln_key, vuln_name in vuln_checks.items():
                if vuln_key in scan_commands:
                    ...
                    if is_vulnerable:
                        results["vulnerabilities"].append({"name": vuln_name, "severity": "critical"})
