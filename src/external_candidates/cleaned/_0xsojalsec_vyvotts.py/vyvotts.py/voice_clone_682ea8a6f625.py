...
class VyvoTTSVoiceClone:
    ...
    def prepare_voice_clone_inputs(
        ...
        for text in target_texts:
            ...
            full_input = torch.cat([reference_prompt, start_token, text_tokens, mid_tokens], dim=1)
...
def main():
    ...
    for audio_path, transcript in reference_pairs:
        ...
        output_paths = [str(output_dir / f"{audio_stem}_{i}.wav") for i in range(len(target_texts))]
