# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentcloud.py\agent_backend.py\src.py\crew.py\build_task_helpers_a8255f0ad416.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentcloud\agent-backend\src\crew\build_task_helpers.py
...
from models.mongo import PyObjectId, Session, Task, Tool
...
from utils.model_helper import keyset, search_subordinate_keys
...
def _assign_structured_output_fields_to_variables(
    task_output: TaskOutput,
    session: Session,
    mongo_client: MongoClientConnection,
