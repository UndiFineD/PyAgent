# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_antigravity_oauth_utils_3ac5a03a8cf7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_oauth_utils.py
...
class TestAddModelsToConfig:
    ...
    def test_add_models_to_config_with_thinking_budget(self, tmp_path):
        ...
        thinking_models = [m for m in saved_models.values() if "thinking" in m.get("name", "").lower()]
        ...
        with patch.dict(
            ...
            try:
                ...
                if "reload" in str(e).lower():
                    pytest.fail(f"reload_current_agent raised unexpected exception: {e}")
