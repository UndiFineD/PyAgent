# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\server.py\core.py\acontext_core.py\schema.py\config_0822429adb61.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\schema\config.py
...
class CoreConfig(BaseModel):
    ...
    mq_blocked_connection_timeout: int = 300  # Timeout for blocked connections in seconds
