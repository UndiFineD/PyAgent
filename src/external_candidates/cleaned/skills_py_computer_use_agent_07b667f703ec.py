# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\am_will.py\gemini_computer_use.py\scripts.py\computer_use_agent_07b667f703ec.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\am-will\gemini-computer-use\scripts\computer_use_agent.py
...
def run() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        context = browser.new_context(viewport={"width": args.screen_width, "height": args.screen_height})
        ...
        for turn in range(args.turn_limit):
            ...
            if not function_calls:
                text_output = " ".join(part.text for part in candidate.content.parts if part.text)
            ...
            for call in function_calls:
                ...
                result, should_stop = execute_function_call(call, page, args.screen_width, args.screen_height)
