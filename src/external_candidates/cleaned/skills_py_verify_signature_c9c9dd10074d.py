# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hodlxxi.py\hodlxxi_bitcoin_identity.py\scripts.py\verify_signature_c9c9dd10074d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hodlxxi\hodlxxi-bitcoin-identity\scripts\verify_signature.py
