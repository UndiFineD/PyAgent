# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\araa47.py\local_whisper.py\scripts.py\transcribe_d12ecd24ce4a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\araa47\local-whisper\scripts\transcribe.py
...
def main(audio_file, model, language, timestamps, as_json, quiet):
    ...
    try:
        result = whisper_model.transcribe(audio_file, language=language, word_timestamps=timestamps, verbose=False)
