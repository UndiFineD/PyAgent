# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pi0_lerobot.py\src.py\pi0_lerobot.py\video_io_9a5cab92a846.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pi0-lerobot\src\pi0_lerobot\video_io.py
...
class MultiVideoReader:
    def __init__(self, video_paths: list[Path]) -> None:
        ...
        self.video_readers: list[VideoReader] = [VideoReader(str(video_path)) for video_path in video_paths]
