# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\knowledge.py\test_text_knowledge_base_d4e500a563f7.py
