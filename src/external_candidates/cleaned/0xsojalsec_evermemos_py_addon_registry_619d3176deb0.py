# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\addons.py\addon_registry_619d3176deb0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\addons\addon_registry.py
...
class AddonRegistry:
    ...
    def register_asynctasks(self, registry: TaskScanDirectoriesRegistry) -> "AddonRegistry":
        """
