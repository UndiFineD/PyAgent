# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\udiedrichsen.py\stock_analysis.py\scripts.py\test_stock_analysis_a83064c0da62.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\udiedrichsen\stock-analysis\scripts\test_stock_analysis.py
...
class TestWatchlist:
    ...
    def test_remove_from_watchlist(self, mock_load, mock_save):
        ...
        mock_load.return_value = [WatchlistItem(ticker="AAPL", added_at="2024-01-01T00:00:00+00:00")]
