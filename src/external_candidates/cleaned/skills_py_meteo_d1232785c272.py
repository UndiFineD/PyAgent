# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hugosbl.py\french_services.py\scripts.py\meteo_d1232785c272.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hugosbl\french-services\scripts\meteo.py
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Nombre de jours de prévision (défaut: 3, max: 16)",
    )
    ...
    if args.lat is not None and args.lon is not None:
        ...
        if coords is None:
            ...
            print(
                "Utilise --lat et --lon pour spécifier les coordonnées.",
                file=sys.stderr,
            )
