# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gtfonow.py\gtfonow.py\tests.py\test_privesc_c1a113e79842.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GTFONow\gtfonow\tests\test_privesc.py
