# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\inclinedadarsh.py\manimce_best_practices.py\examples.py\math_visualization_0109edda8b9f.py
