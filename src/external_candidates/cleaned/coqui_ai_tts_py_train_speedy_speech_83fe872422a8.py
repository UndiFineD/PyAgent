# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\recipes.py\thorsten_de.py\speedy_speech.py\train_speedy_speech_83fe872422a8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\recipes\thorsten_DE\speedy_speech\train_speedy_speech.py
