# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\decodingai_magazine_second_brain_ai_assistant_course.py\apps.py\second_brain_offline.py\tools.py\call_huggingface_dedicated_endpoint_3bed108061e6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\tools\call_huggingface_dedicated_endpoint.py
...
def get_chat_completion(prompt: str) -> Generator[str, None, None]:
    ...
    assert settings.HUGGINGFACE_DEDICATED_ENDPOINT is not None, "HUGGINGFACE_DEDICATED_ENDPOINT is not set"

    assert settings.HUGGINGFACE_ACCESS_TOKEN is not None, "HUGGINGFACE_ACCESS_TOKEN is not set"
