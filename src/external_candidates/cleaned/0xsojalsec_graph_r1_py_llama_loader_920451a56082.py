# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\verl.py\models.py\llama.py\megatron.py\checkpoint_utils.py\llama_loader_920451a56082.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\models\llama\megatron\checkpoint_utils\llama_loader.py
