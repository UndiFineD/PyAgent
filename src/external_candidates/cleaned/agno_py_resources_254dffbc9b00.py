# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\infra.py\agno_docker.py\agno.py\docker.py\resources_254dffbc9b00.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agno\libs\infra\agno_docker\agno\docker\resources.py
...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from agno.docker.resource.types import (
            DockerContainer,
