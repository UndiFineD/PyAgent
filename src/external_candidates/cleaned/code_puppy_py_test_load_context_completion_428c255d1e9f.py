# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_load_context_completion_428c255d1e9f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_load_context_completion.py
...
class TestLoadContextCompleter:
    ...
    def test_session_name_completion(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("code_puppy.command_line.load_context_completion.CONFIG_DIR", temp_dir):
    ...
    def test_partial_session_name_completion(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("code_puppy.command_line.load_context_completion.CONFIG_DIR", temp_dir):
                ...
                assert "another_session" not in completion_texts  # Doesn't start with "sess"
