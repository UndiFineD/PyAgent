# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_praisonai.py\src.py\praisonai_agents.py\praisonaiagents.py\guardrails.py\llm_guardrail_2d04a665927e.py
