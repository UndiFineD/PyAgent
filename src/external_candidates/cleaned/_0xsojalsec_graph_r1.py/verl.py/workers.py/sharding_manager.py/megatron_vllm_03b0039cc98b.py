# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\workers\sharding_manager\megatron_vllm.py
...
class MegatronVLLMShardingManager(BaseShardingManager):
    def __init__(
        ...
        assert infer_tensor_parallel_size <= train_tensor_parallel_size, "Not implemented for infer_tp > train_tp"
