# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\third_party\vllm\vllm_v_0_3_1\llm_engine_sp.py
...
class LLMEngine:
    ...
    def _check_stop(self, seq: Sequence, sampling_params: SamplingParams) -> None:
        ...
        if (not sampling_params.ignore_eos) and seq.get_last_token_id() == self.get_tokenizer_for_seq(seq).eos_token_id:
            seq.status = SequenceStatus.FINISHED_STOPPED
            return
