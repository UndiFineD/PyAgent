# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\third_party\vllm\vllm_v_0_3_1\arg_utils.py
...
class AsyncEngineArgs(EngineArgs):
    ...
    def add_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument(
            "--engine-use-ray",
            action="store_true",
            help="use Ray to start the LLM engine in a separate process as the server process.",
        )
        parser.add_argument(
