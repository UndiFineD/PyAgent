# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\agents\copybot_agent.py
"""
...
class CopyBotAgent:
    ...
    def analyze_position(self, token):
        ...
        try:
            ...
            full_prompt = f"""
{PORTFOLIO_ANALYSIS_PROMPT.format(portfolio_data=position_data.to_string(), market_data=token_market_data)}
"""
