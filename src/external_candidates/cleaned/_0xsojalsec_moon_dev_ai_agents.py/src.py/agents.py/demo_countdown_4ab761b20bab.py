# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\agents\demo_countdown.py
#!/usr/bin/env python
"""
...
def demo_countdown(seconds=15):
    ...
    for i in range(seconds):
        ...
        remaining = seconds - i
        cprint(
            f"\r{left_emoji} Next idea in: {remaining} seconds {right_emoji}",
            text_color,
            bg_color,
            end="",
            flush=True,
