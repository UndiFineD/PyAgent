...
class MoonDevAPI:
                    ...
                    for col in df.columns:
                        try:
                            ...
                            if str(col).isdigit() and len(str(col)) == 13:  # Column name itself is 13-digit timestamp
                                ...
                                if (
                                    isinstance(sample_val, (int, float)) and sample_val > 1000000000000
                                ):  # Epoch milliseconds
                                    timestamp_col = col
                                    break
                        except:
    ...
    def get_copybot_follow_list(self):
        ...
        try:
            ...
            response = self.session.get(f"{self.base_url}/copybot/data/follow_list", headers=self.headers)
    ...
    def get_copybot_recent_transactions(self):
        ...
        try:
            ...
            response = self.session.get(f"{self.base_url}/copybot/data/recent_txs", headers=self.headers)
