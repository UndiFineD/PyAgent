# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\agents\strategy_agent.py
"""
    ...
    def __init__(self):
        ...
        if ENABLE_STRATEGIES:
            try:
                ...
                self.enabled_strategies.extend([ExampleStrategy(), MyStrategy()])
        ...
        try:
            ...
            message = self.client.messages.create(
                ...
                messages=[
                    {
                        "role": "user",
                        "content": STRATEGY_EVAL_PROMPT.format(strategy_signals=signals_str, market_data=market_data),
                    }
                ],
            )
