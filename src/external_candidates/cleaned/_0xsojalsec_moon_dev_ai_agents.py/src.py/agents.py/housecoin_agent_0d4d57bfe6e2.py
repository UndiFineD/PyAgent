...
class HousecoinAgent:
    def __init__(self):
        ...
        self.last_buy_time = (
            datetime.fromisoformat(self.state["last_buy_time"]) if self.state["last_buy_time"] else None
        )
            ...
            try:
                ...
                if below_sma:
                    ...
                    if self.state["daily_spent"] >= BELOW_SMA_DAILY_CAP:
                        ...
                        self.last_buy_time
                        and (datetime.now() - self.last_buy_time).seconds < BELOW_SMA_BUY_MINUTES * 60
                    ):
                ...
                if should_check_buy:
                    ...
                    # Get AI confirmation
                    ai_approved, ai_response = self.get_ai_confirmation(current_price, sma_20, buy_reason, df_5min)
