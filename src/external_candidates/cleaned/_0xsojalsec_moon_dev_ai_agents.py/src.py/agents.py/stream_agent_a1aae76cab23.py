# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\agents\stream_agent.py
"""
...
class StreamAgent:
    ...
    def record_audio(self):
        ...
        if frames:
            try:
                ...
                result = self.whisper_model.transcribe(temp_filename, language="en", fp16=False)
    ...
    def generate_titles(self, transcript):
        ...
        try:
            prompt = TITLE_MASTER_PROMPT.format(num_titles=NUM_TITLES, transcript=transcript)
