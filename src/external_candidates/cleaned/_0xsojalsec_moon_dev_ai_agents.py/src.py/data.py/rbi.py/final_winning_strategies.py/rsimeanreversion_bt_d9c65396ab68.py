...
class RSIMeanReversion(Strategy):
    ...
    def next(self):
        ...
        # Look for entry signals
            ...
            if current_rsi < self.rsi_oversold and current_price <= self.bb_lower[-1] * 1.005:  # Small tolerance
            ...
            elif current_rsi > self.rsi_overbought and current_price >= self.bb_upper[-1] * 0.995:  # Small tolerance
