# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\backtests_package\BandSqueezeTrend_PKG.py
import pandas as pd
import talib
...
class BandSqueezeTrend(Strategy):
    ...
    def init(self):
        ...
        self.upper_band, self.middle_band, _ = [
            self.I(lambda c: talib.BBANDS(c, 20, 2, 2, 0)[i], self.data.Close) for i in range(3)
        ]
