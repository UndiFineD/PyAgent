    ...
    def next(self):
        ...
        # HOLD LONG - Only exit on major reversals or massive profits 🌊
            ...
            if self.position:
                ...
                major_bear = self.sma10[-1] < self.sma30[-1] and current_price < self.sma30[-1] * 0.95  # 5% below SMA30
                ...
                if major_bear or massive_profit or time_exit:
                    self.position.close()
                    exit_reason = "MAJOR BEAR" if major_bear else ("MASSIVE PROFIT" if massive_profit else "TIME EXIT")
