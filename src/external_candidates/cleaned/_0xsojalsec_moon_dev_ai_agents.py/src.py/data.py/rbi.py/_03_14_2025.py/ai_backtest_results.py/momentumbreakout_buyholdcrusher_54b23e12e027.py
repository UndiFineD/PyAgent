...
class MomentumBreakoutCrusher(Strategy):
    ...
    def check_momentum_breakout(self):
        ...
        strong_signal = trend_alignment and momentum_surge and volume_surge and (breakout or ath_breakout)
    ...
    def execute_momentum_entry(self):
        ...
        if position_size > 0:
            ...
            # Track this entry
            self.pyramid_levels.append({"price": current_price, "size": position_size, "time": len(self.data)})
