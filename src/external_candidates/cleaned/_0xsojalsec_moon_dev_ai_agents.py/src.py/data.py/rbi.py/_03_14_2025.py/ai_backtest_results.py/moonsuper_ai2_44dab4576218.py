# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\MoonSuper_AI2.py
import numpy as np
import pandas as pd
...
class MoonSuper(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                price > sma_weekly and sma_fast > sma_slow  # Bull market filter
            ):  # Short-term uptrend
