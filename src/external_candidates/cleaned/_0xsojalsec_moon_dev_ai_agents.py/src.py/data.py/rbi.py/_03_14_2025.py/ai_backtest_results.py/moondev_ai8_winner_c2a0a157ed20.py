    ...
    def next(self):
        ...
        # Let winners run - exit logic 🌊
            ...
            if self.position:
                ...
                trend_broken = self.ema50[-1] < self.ema200[-1] and current_price < self.ema50[-1]
                ...
                if trend_broken or macd_bearish or huge_profit or big_loss:
                    ...
                    exit_reason = (
                        "TREND BROKEN"
                        if trend_broken
                        else ("MACD BEARISH" if macd_bearish else ("HUGE PROFIT" if huge_profit else "STOP LOSS"))
                    )
