...
class TrendMaster(Strategy):
    ...
    def next(self):
        ...
        # Trend analysis
        strong_uptrend = (
            self.ma_short_line[-1] > self.ma_medium_line[-1] > self.ma_long_line[-1] and price > self.ma_short_line[-1]
        )

        moderate_uptrend = price > self.ma_medium_line[-1] and self.ma_medium_line[-1] > self.ma_long_line[-1]

        downtrend = self.ma_short_line[-1] < self.ma_medium_line[-1] and price < self.ma_medium_line[-1]
