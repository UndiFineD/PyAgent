# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\research\GPT-5\BandSqueezeTrend_BT.py
import pandas as pd
import talib
...
# Run backtest
bt = Backtest(data, BandSqueezeTrend, cash=1_000_000, commission=0.002)
stats = bt.run()
print(stats)
