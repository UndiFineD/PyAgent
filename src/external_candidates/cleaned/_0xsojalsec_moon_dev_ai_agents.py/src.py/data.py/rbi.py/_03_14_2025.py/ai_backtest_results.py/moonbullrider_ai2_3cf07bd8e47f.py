# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\MoonBullRider_AI2.py
import numpy as np
import pandas as pd
...
class MoonBullRider(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                price > sma_trend * 1.01  # At least 1% above long-term trend
                and price > sma_entry
                ...
                if position_size > 0:
                    ...
                    print(f"🌙🚀 BULL RIDE! Long {position_size} @ {price:.2f} | Trend MA: {sma_trend:.2f}")
