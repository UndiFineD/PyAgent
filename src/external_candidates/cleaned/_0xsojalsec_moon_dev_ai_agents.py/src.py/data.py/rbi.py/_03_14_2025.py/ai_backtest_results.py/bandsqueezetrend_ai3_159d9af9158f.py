# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_14_2025\AI_BACKTEST_RESULTS\BandSqueezeTrend_AI3.py
import pandas as pd
import talib
...
class BandSqueezeTrend(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if current_close > self.upper_band[-1] and current_atr < self.atr_ma[-1]:
