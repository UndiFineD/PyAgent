# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_22_2025\backtests_final\VortexSqueeze_BTFinal.py
import numpy as np
import pandas as pd
    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and (self.vi_plus[-2] < self.vi_minus[-2] and self.vi_plus[-1] > self.vi_minus[-1])
