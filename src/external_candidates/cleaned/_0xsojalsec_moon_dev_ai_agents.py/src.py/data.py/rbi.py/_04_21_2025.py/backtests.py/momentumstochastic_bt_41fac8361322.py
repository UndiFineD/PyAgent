# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_21_2025\backtests\MomentumStochastic_BT.py
import pandas as pd
import talib
...
class MomentumStochastic(Strategy):
    def init(self):
        ...
        self.adx = self.I(talib.ADX, h, l, c, 14)
        self.atr = self.I(talib.ATR, h, l, c, 14)
        stoch_k, stoch_d = talib.STOCH(h, l, c, 14, 3, 0, 3, 0)
