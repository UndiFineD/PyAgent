# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_02_2025\backtests_final\VolatilityBreakout_BTFinal.py
...
class VolatilityBreakout(Strategy):
    ...
    def on_trade_end(self, trade):
        ...
        if trade.is_long:
            ...
            direction = "SHORT"
        print(
            f"🌙✨🚀 MOON DEV {direction} EXIT 🚀✨🌙 | Reason: {trade.exit_reason} | PnL: {trade.pl:.2f} | Equity: {self.equity:.2f}"
        )
