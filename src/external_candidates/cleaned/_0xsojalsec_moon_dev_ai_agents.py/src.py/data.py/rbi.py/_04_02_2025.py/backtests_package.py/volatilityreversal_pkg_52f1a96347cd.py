# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_02_2025\backtests_package\VolatilityReversal_PKG.py
...
class VolatilityReversal(Strategy):
    ...
    def next(self):
            ...
            if ema_crossover and adx_filter:
                ...
                if risk_per_share > 0:  # Validate positive risk
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🌙✨ GOLDEN CROSS! Long @ {current_close:.2f} "
        ...
        # ========================
            ...
            if current_adx > 30:
                self.position.close()
                print(f"🚀🌙 ADX BREAKOUT! Exit @ {current_close:.2f} | Profit: {self.position.pl_pct:.2f}%")
...
print("Moon Dev Trading Complete! 🚀🌙")
