# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_02_2025\backtests_package\VoltaSqueeze_PKG.py
# -*- coding: utf-8 -*-
import pandas as pd
import talib
...
class VoltaSqueeze(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            rsi_cross = (self.rsi[-2] <= 50) and (self.rsi[-1] > 50)  # Replaced crossover with direct comparison
