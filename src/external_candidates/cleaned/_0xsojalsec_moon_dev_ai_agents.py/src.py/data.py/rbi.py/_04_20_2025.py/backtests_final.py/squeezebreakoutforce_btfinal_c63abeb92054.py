...
class SqueezeBreakoutForce(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            efi_cross = (self.efi_13[-2] < self.efi_50[-2]) and (self.efi_13[-1] > self.efi_50[-1])
...
bt = Backtest(data, SqueezeBreakoutForce, cash=1_000_000, commission=0.002, exclusive_orders=True)
stats = bt.run()
print(stats)
