...
class MACDCrossover(Strategy):
    ...
    def next(self):
        ...
        if macd_prev <= signal_prev and macd_current > signal_current and not self.position:
        ...
        elif macd_prev >= signal_prev and macd_current < signal_current and not self.position:
            # Set stop loss and take profit
            stop_loss = price + atr
            take_profit = price - (1.5 * atr)  # 1:1.5 risk/reward
