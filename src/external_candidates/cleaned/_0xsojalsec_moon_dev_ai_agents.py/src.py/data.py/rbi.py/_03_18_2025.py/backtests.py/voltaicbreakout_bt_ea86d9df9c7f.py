# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_18_2025\backtests\VoltaicBreakout_BT.py
import pandas as pd
import talib
...
class VoltaicBreakout(Strategy):
    ...
    def init(self):
        ...
        self.min_bandwidth_30day = self.I(
            talib.MIN, self.bandwidth, 2880, name="30D Min BW"
        )  # 2880 bars = 30 days in 15m
