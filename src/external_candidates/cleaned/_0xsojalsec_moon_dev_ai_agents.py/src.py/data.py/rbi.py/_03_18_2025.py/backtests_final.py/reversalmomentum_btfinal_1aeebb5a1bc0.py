# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_18_2025\backtests_final\ReversalMomentum_BTFinal.py
...
class ReversalMomentum(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            ema50_below = (self.ema50[-2] > self.ema200[-2]) and (self.ema50[-1] < self.ema200[-1])
