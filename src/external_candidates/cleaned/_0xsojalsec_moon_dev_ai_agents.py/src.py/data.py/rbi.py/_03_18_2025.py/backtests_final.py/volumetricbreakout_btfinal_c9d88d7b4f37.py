# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_18_2025\backtests_final\VolumetricBreakout_BTFinal.py
...
class VolumetricBreakout(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            ...
            if (self.rsi[-2] < 70 and self.rsi[-1] > 70) or self.data.Close[-1] < self.bb_middle[-1]:
                self.position.close()
