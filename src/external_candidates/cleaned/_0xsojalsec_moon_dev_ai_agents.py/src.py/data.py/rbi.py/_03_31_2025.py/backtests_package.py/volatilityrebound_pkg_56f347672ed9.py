# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_31_2025\backtests_package\VolatilityRebound_PKG.py
...
class VolatilityRebound(Strategy):
    ...
    def init(self):
        ...
        self.bb_width_avg = self.I(talib.SMA, self.bb_width, self.exit_period, name="BBWidthAvg")
