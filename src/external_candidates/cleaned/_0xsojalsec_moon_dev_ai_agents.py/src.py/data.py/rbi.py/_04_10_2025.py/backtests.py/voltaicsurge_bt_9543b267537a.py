# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_10_2025\backtests\VoltaicSurge_BT.py
...
class VoltaicSurge(Strategy):
    ...
    def init(self):
        ...
        self.atr_daily_avg = self.I(talib.SMA, self.atr_short, self.atr_daily_period)
