# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_15_2025\backtests\VolatilityStrike_BT.py
...
class VolatilityStrike(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            # 🌙 ENTRY LOGIC
            if self.data.High[-1] == self.swing_high[-1] and (self.atr[-1] / self.data.Close[-1]) * 100 >= 2:
                # 🚀 RISK MANAGEMENT
