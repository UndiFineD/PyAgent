# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_17_2025\backtests_final\BandMACDRebound_BTFinal.py
...
class BandMACDRebound(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if current_close <= current_lower * 1.02 and macd_hist > 0 and self.macd_line[-1] > self.macd_signal[-1]:
