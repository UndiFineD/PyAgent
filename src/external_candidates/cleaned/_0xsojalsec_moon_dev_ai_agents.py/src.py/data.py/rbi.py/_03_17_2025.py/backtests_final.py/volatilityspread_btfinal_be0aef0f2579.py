# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_17_2025\backtests_final\VolatilitySpread_BTFinal.py
import pandas as pd
import talib
...
# Run backtest
bt = Backtest(data, VolatilitySpread, cash=1_000_000, commission=0.002)
stats = bt.run()
print(stats)
