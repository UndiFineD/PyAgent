...
class VolumeBreakoutConvergence(Strategy):
    ...
    def next(self):
        ...
        # Breakout detection
        resistance_breakout = prev_price <= resistance_level and current_price > resistance_level * (
            1 + self.breakout_threshold
        )
        support_breakout = prev_price >= support_level and current_price < support_level * (1 - self.breakout_threshold)
