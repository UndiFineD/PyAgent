...
class VolSurgeReversion(Strategy):
    ...
    def init(self):
        ...
        self.realized_vol = self.I(talib.STDDEV, self.log_returns, timeperiod=20, name="RealizedVol20")
        self.volume_sma20 = self.I(talib.SMA, self.data.Volume, timeperiod=20, name="VolumeSMA20")
        self.spread = self.I(lambda vix, rv: vix - rv, self.data.Vix, self.realized_vol, name="Spread")
        self.spread_mean = self.I(talib.SMA, self.spread, timeperiod=252, name="SpreadMean1yr")
