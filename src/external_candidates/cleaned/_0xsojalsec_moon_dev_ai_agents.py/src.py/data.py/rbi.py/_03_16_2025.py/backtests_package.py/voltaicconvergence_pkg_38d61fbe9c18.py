# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_16_2025\backtests_package\VoltaicConvergence_PKG.py
import pandas as pd
...
class VoltaicConvergence(Strategy):
    def init(self):
        ...
        self.recent_high = self.I(talib.MAX, self.data.High, timeperiod=20, name="Recent High")
