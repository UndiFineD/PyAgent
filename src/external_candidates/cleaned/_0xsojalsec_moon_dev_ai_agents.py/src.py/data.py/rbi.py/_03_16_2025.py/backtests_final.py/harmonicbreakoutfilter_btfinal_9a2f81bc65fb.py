# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_16_2025\backtests_final\HarmonicBreakoutFilter_BTFinal.py
import pandas as pd
import talib
...
class HarmonicBreakoutFilter(Strategy):
    ...
    def next(self):
        if not self.position:
            ...
            # Entry conditions
            price_action_cond = self.data.Close[-1] > current_high and self.data.Low[-2] < fib_618
