# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_07_2025\backtests_final\VolTerminus_BTFinal.py
...
# Launch Backtest 🚀
bt = Backtest(data, VolTerminus, cash=1_000_000, commission=0.002, exclusive_orders=True)
stats = bt.run()
