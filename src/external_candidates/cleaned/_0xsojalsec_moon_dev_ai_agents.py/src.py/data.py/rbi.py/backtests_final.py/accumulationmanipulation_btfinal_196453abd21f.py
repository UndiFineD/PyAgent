# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\backtests_final\AccumulationManipulation_BTFinal.py
#!/usr/bin/env python3
import warnings
...
class AccumulationManipulation(Strategy):
    ...
    def next(self):
        ...
        if (
            self.data.Volume[-1] > self.volume_ma[-1] * 1.5  # Volume spike
            and price > self.ema[-1]  # Price above EMA
