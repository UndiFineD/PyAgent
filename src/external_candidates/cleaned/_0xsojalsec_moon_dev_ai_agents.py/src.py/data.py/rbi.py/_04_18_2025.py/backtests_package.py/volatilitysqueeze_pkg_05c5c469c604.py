# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\04_18_2025\backtests_package\VolatilitySqueeze_PKG.py
...
class VolatilitySqueeze(Strategy):
    ...
    def init(self):
        ...
        self.bb_width_sma = self.I(talib.SMA, self.bb_width, timeperiod=20, name="bb_width_sma_20")
