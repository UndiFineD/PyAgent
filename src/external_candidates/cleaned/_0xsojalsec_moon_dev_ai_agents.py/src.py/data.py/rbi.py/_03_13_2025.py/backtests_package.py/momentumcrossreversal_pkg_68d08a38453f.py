# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\MomentumCrossReversal_PKG.py
...
class MomentumCrossReversal(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (ma_diff[-2] < ema20_val[-2] and ma_diff[-1] > ema20_val[-1]) and price > ema20_val and ma_diff > 0:
                ...
                if position_size > 0:
                    ...
                    print(
                        f"🚀 Moon Dev Signal: LONG {position_size} units | "
    ...
    def notify_trade(self, trade):
        if trade.is_closed:
            ...
            print(
                f"{emoji} Moon Dev Trade Closed | PL: ${trade.pl:.2f} "
