# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\VolatilityArbitrage_PKG.py
...
class VolatilityArbitrage(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (self.position.is_short and current_ratio < 1) or (self.position.is_long and current_ratio > 1):
                self.position.close()
