# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests_package\MeanReversalAlert_PKG.py
...
class MeanReversalAlert(Strategy):
    ...
    def init(self):
        ...
        def bollinger_bands(close):
            return (
                talib.BBANDS(close, 20, 2, 2, 0)[0],
                talib.BBANDS(close, 20, 2, 2, 0)[2],
            )
