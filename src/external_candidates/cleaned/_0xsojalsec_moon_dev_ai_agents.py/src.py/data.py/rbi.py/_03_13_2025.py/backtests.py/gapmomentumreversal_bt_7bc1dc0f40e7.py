...
class GapMomentumReversal(Strategy):
    ...
    def init(self):
        ...
        self.top_band = self.I(ta.percentile, self.daily_range, length=self.lookback_period, q=80)
        self.bottom_band = self.I(ta.percentile, self.daily_range, length=self.lookback_period, q=20)
