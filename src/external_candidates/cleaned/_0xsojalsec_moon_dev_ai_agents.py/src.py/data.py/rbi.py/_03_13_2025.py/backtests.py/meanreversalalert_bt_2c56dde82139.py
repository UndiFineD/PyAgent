# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi\03_13_2025\backtests\MeanReversalAlert_BT.py
            ...
            if price < self.lower_bb[-1]:
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🌕 MOON DEV ALERT: Long @ {entry_price:.2f} | "
