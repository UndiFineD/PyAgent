# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_20_2025\backtests_final\InverseMomentum_BTFinal_WORKING_-0.845397pct.py
import numpy as np
import pandas as pd
import talib
