...
class DivergentReversion(Strategy):
    adx_threshold = (
        20  # 🌙 Moon Dev: Tightened ADX threshold from 25 to 20 for stricter ranging market filter to avoid weak trends
    )
    risk_per_trade = 0.01  # 1% risk maintained for good risk management
    atr_multiplier_sl = 2
    atr_multiplier_tp = (
        6  # 🌙 Moon Dev: Increased TP multiplier from 4 to 6 for 1:3 RR to capture larger moves and boost returns
    )
