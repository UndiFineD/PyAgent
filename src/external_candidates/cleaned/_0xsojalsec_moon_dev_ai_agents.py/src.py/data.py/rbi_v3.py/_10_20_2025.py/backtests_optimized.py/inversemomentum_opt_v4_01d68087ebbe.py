...
class InverseMomentum(Strategy):
    ...
    long_trend_period = (
        200  # New: Long-term SMA filter to ensure entries only in overall uptrend, avoiding major bear markets
    )
    risk_pct = (
        0.02  # 🌙 Optimized: Increased from 0.015 to 0.02 for higher exposure and returns while keeping risk managed
    )
    ...
    vol_mult = (
        1.2  # 🌙 Optimized: Loosened from 1.5 to 1.2 for more qualifying volume spikes without sacrificing quality
    )
