...
class FibonacciDivergence(Strategy):
    ...
    fib_tolerance = (
        0.02  # Optimized: Tightened from 0.05 to 0.02 for more precise Fib level hits, reducing false entries
    )
                                    ...
                                    if high_start < high_end and high_end <= current_bar + 1:
                                        ...
                                        if fib_range > 0:
                                            ...
                                            if is_at_fib:
                                                ...
                                                volume_ok = (
                                                    self.data.Volume[current_bar] > self.vol_sma[current_bar] * 1.2
                                                )
