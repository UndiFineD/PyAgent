# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_20_2025\backtests_optimized\SynergisticConfluence_OPT_v2.py
import numpy as np
import pandas as pd
import talib
...
class SynergisticConfluence(Strategy):
    ...
    risk_per_trade = (
        0.02  # 🌙 Moon Dev: Increased risk per trade from 0.01 to 0.02 for higher exposure and potential returns
    )
    max_bars_held = (
        40  # 🌙 Moon Dev: Extended max hold time from 20 to 40 bars (10 hours on 15m) to allow more room for trends
    )
    ...
    def next(self):
        ...
        if long_rsi_cross and long_bb_touch and long_macd_cross and long_hist_expand and long_trend:
            ...
            if risk_distance > 0:
                ...
                )  # 🌙 Moon Dev: Improved RR from 2:1 to 3:1 for higher returns
