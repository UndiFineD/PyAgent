...
class DivergentReversion(Strategy):
    ...
    trail_atr = (
        2  # 🌙 Moon Dev: Trailing distance in ATR, dynamically adjusting SL to lock in profits as price moves favorably
    )
    ...
    def next(self):
        ...
        if (
            (not self.position) and (len(self.rsi) > 30) and (self.adx[-1] < self.adx_threshold)
