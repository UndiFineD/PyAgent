# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_20_2025\backtests_optimized\ExtremeDivergence_OPT_v2.py
import numpy as np
import pandas as pd
import talib
            ...
            if (
                ...
                if risk_dist > 0:
                    ...
                    if size > 0:
                        ...
                        self.tp = (
                            entry + 3 * risk_dist
                        )  # 🌙 Moon Dev Optimization: Set 3:1 RR TP for improved reward capture
                        self.trail_sl = sl
