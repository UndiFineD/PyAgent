...
class DivergentConvergence(Strategy):
    ...
    recent_period = (
        8  # 🌙 Moon Dev Optimization: Adjusted recent period to balance sensitivity and reduce noise in recent lows
    )
    ...
    def next(self):
        ...
        stoch_converge = (
            (k_now < 25) and (k_now > k_prev) and (gap_now < gap_prev) and (k_now < d_now)
