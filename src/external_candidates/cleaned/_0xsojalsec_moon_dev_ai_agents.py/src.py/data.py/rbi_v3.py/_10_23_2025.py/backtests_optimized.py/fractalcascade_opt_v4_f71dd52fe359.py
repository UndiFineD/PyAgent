    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                and self.lips[-1] > self.lips[-2]  # 🌙 Moon Dev: Added lips momentum for better trend confirmation
                and self.ao[-1] > 0
        ...
        if self.position:
            if self.position.is_long:
                ...
                if not np.isnan(potential_sl) and potential_sl > self.current_sl and potential_sl < self.data.Close[-1]:
