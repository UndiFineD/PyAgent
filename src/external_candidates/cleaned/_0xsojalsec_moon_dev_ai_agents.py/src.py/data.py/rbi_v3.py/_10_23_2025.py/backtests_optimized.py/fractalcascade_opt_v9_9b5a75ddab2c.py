    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                > 1.2 * self.volume_ma[-1]  # 🌙 Moon Dev: Stricter volume filter (1.2x) to avoid low-quality signals
                and self.rsi[-1] > 50  # 🌙 Moon Dev: RSI >50 for bullish momentum confirmation
            ...
            # Short entry
                ...
                and self.data.Volume[-1]
                > 1.2 * self.volume_ma[-1]  # 🌙 Moon Dev: Stricter volume filter (1.2x) to avoid low-quality signals
                and self.rsi[-1] < 50  # 🌙 Moon Dev: RSI <50 for bearish momentum confirmation
