# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v3\10_23_2025\backtests_optimized\FractalCascade_OPT_v6.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                ...
                > 1.2 * self.volume_ma[-1]  # 🌙 Moon Dev: Tightened volume filter to 1.2x for higher conviction setups
                and self.rsi[-1] > 50
