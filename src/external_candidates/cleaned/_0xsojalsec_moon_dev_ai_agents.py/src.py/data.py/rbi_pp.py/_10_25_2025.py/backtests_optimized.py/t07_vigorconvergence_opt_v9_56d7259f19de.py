...
class VigorConvergence(Strategy):
    ...
    atr_multiplier_sl = (
        2.0  # 🌙 Moon Dev: Widened SL multiplier from 1.5 to 2.0 to give trades more breathing room, improving win rate
    )
    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and current_close > current_ema20  # 🌙 Moon Dev: Trend filter - only long above EMA20
                ...
                and current_close < current_ema20  # 🌙 Moon Dev: Trend filter - only short below EMA20
