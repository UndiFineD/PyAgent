...
class DirectionalVigor(Strategy):
    ...
    adx_threshold = (
        20  # 🌙 Moon Dev: Lowered threshold to 20 to capture more trending opportunities without excessive noise ✨
    )
    ...
    atr_multiplier = (
        1.5  # 🌙 Moon Dev: Tightened SL multiplier to 1.5 ATR for better risk control and higher win rate potential ✨
    )
