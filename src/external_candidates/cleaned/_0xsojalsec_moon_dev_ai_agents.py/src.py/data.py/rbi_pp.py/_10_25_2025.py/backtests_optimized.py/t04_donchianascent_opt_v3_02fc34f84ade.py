...
class DonchianAscent(Strategy):
    period = 20
    risk_percent = (
        0.02  # 🌙 Increased from 0.01 to 0.02 for higher exposure and potential returns while keeping risk managed
    )
    ...
    min_channel_width_pct = (
        0.02  # 🌙 Increased from 0.01 to 0.02 to filter out narrower, lower-quality channels and avoid noise
    )
