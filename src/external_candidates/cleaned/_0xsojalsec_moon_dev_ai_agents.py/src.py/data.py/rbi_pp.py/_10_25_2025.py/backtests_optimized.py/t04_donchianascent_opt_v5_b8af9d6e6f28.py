...
class DonchianAscent(Strategy):
    ...
    min_channel_width_pct = (
        0.015  # ✨ Increased min width threshold from 0.01 to 0.015 to filter out more noise/low-volatility setups
    )
    extended_multiplier = (
        1.5  # 🌙 Tightened extended filter from 2 to 1.5 to avoid entries too far from channel equilibrium
    )
