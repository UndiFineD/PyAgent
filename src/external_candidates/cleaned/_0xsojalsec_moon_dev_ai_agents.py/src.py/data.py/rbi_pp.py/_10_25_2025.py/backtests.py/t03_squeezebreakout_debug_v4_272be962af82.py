# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests\T03_SqueezeBreakout_DEBUG_v4.py
import numpy as np
import pandas as pd
import talib
...
class SqueezeBreakout(Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (
                squeeze_ended
                and current_price > self.bb_upper[self.i]
                and current_vol_osc > 0
                and current_price > self.bb_middle[self.i]
            ):
            ...
            # Short entry
                ...
                squeeze_ended
                and current_price < self.bb_lower[self.i]
                and current_vol_osc < 0
                and current_price < self.bb_middle[self.i]
            ):
                entry_price = current_price
