# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests\T00_PulsarFlow_DEBUG_v9.py
import numpy as np
import pandas as pd
import talib
...
class PulsarFlow(Strategy):
    ...
    def get_bullish_div_info(self, current_i):
        ...
        recent_low_price = recent_lows[idx_rel]
        ...
        prev_low_price = prev_lows[idx_rel_prev]
    ...
    def get_bearish_div_info(self, current_i):
        ...
        recent_high_price = recent_highs[idx_rel]
        ...
        prev_high_price = prev_highs[idx_rel_prev]
