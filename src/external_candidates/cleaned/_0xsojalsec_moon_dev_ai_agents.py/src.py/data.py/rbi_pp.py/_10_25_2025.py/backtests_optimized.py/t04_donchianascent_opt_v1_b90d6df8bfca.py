# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T04_DonchianAscent_OPT_v1.py
import numpy as np
import pandas as pd
import talib
...
class DonchianAscent(Strategy):
    period = 20
    risk_percent = (
        0.015  # 🌙 Increased risk per trade slightly for higher potential returns while maintaining management
    )
    ...
    def init(self):
        ...
        print(
            "🌙 Moon Dev Backtest Initialized: Optimized DonchianAscent with RSI, SMA200, ATR filters, and improved trailing! ✨"
        )
