# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests_optimized\T07_VigorConvergence_OPT_v6.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position:
            if (
                ...
                and current_volume > current_avg_vol
                and current_rsi > 50
                and current_rsi < 80
            ):  # 🌙 Moon Dev: Added trend (EMA200), volume, and RSI filters for higher-quality long setups
                # Long entry
                ...
                )  # 🌙 Moon Dev: Simplified and corrected to direct formula, allowing float sizes for better precision
                ...
                and current_rsi < 50
                and current_rsi > 20
            ):  # 🌙 Moon Dev: Added trend (EMA200), volume, and RSI filters for higher-quality short setups
                # Short entry
                sl_price = current_close + self.atr_multiplier_sl * current_atr
