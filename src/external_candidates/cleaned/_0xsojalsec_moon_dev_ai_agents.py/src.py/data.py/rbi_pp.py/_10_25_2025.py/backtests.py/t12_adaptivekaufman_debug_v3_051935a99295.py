# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_25_2025\backtests\T12_AdaptiveKaufman_DEBUG_v3.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if self.position:
            if self.position.is_long:
                # Trailing stop
                profit = close - self.position.price
                ...
                # Trailing stop
                profit = self.position.price - close
                if profit > self.trail_start * atr:
