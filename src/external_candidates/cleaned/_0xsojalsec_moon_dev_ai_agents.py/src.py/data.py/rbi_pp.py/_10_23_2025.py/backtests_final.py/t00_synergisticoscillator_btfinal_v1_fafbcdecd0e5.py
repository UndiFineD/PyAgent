# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_23_2025\backtests_final\T00_SynergisticOscillator_BTFinal_v1.py
import numpy as np
import pandas as pd
import talib
...
class SynergisticOscillator(Strategy):
    ...
    def init(self):
        ...
        self.dummy, self.stoch_k, self.stoch_d = self.I(
            talib.STOCHRSI,
            self.data.Close,
            timeperiod=14,
            fastk_period=14,
