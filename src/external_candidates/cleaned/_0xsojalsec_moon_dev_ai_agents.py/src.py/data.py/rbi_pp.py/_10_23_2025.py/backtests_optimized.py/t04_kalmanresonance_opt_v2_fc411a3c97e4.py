    ...
    def next(self):
        ...
        if is_ranging:
            ...
            stoch_oversold_cross = (
                self.stoch_k[-2] <= self.stoch_d[-2] and self.stoch_k[-1] > self.stoch_d[-1] and self.stoch_k[-1] < 20
        ...
        if is_ranging:
            ...
            stoch_overbought_cross = (
                self.stoch_k[-2] >= self.stoch_d[-2] and self.stoch_k[-1] < self.stoch_d[-1] and self.stoch_k[-1] > 80
