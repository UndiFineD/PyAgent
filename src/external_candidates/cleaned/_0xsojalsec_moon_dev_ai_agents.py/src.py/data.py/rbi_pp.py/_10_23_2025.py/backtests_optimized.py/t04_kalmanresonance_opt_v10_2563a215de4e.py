...
class KalmanResonance(Strategy):
    ...
    fib_period = 50
    prz_tolerance = (
        0.005  # Increased from 0.003 to 0.5% for slightly more flexibility near Fib levels while keeping precision 🚀
    )
    ranging_threshold = (
        0.1  # Increased from 0.05 to 10% around EMA for broader ranging market detection and more trades 🌙
    )
    ...
    rr_mult = (
        3.0  # Increased RR from 2:1 to 3:1 to target larger reward potential per trade for higher overall returns 🚀
    )
