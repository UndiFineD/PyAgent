# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_23_2025\backtests_optimized\T01_VolatilityDirectional_OPT_v1.py
import numpy as np
import pandas as pd
import talib
    ...
    def next(self):
        ...
        if not self.position and long_momentum and adx_strong and plus_di_dir and trend_up and volume_confirm:
            ...
            if risk_dist > 0:
                ...
                )  # 🌙 Moon Dev: Allow fractional size, removed vol_adjust (ATR handles vol)
