...
class QuadrupleHarmonic(Strategy):
    ...
    def next(self):
        ...
        if (
            ...
            and self.adx[-1] > 25  # 🌙 Increased ADX threshold from 20 to 25 for stronger trend quality
            and self.rsi[-1] < 35  # 🌙 Tightened RSI oversold filter to <35 for deeper, higher-quality pullbacks
