# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_pp\10_23_2025\backtests_optimized\T01_ConfluentHarmonics_OPT_v5.py
import pandas as pd
import talib
...
class ConfluentHarmonics(Strategy):
    ...
    def next(self):
        ...
        squeeze = (
            bb_width < self.bb_squeeze_threshold or prev_bb_width < self.bb_squeeze_threshold
        )  # 🌙 Kept logic but with tighter threshold for better setups
        rsi_val = self.rsi[-1]
