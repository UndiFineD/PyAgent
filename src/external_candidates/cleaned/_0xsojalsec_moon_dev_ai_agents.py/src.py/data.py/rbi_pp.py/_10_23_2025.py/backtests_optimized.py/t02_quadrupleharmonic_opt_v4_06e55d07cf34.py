...
class QuadrupleHarmonic(Strategy):
    ...
    def next(self):
        ...
        if (
            ...
            and self.ema50[-1]
            > self.ema[-1]  # 🌙 Enhanced uptrend filter: above EMA50 and EMA50 > EMA200 for quality trends
            and self.adx[-1] > 22  # 🌙 Slightly raised ADX from 20 to 22 for stronger trend quality
            and self.rsi[-1]
