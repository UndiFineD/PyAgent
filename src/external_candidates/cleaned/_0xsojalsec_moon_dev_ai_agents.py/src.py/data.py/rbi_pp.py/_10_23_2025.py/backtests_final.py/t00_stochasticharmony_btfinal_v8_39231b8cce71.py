...
class StochasticHarmony(Strategy):
    ...
    def init(self):
        ...
        self.k = self.I(
            lambda close: talib.STOCHRSI(close, timeperiod=14, fastk_period=14, fastd_period=3)[0],
            self.data.Close,
        )
        self.d = self.I(
            lambda close: talib.STOCHRSI(close, timeperiod=14, fastk_period=14, fastd_period=3)[1],
            self.data.Close,
        )
                ...
                if X < A and B < A and B > X and C > B and D < C:
                    ...
                    if XA > 0 and AB > 0 and BC > 0 and CD > 0:
                        ...
                        if (
                            ...
                            print(f"🌙 Moon Dev: Bullish Gartley Pattern Detected at bar {n}! Checking Stoch RSI... 📈")
                ...
                if X > A and B > A and B < X and C < B and D > C:
                    ...
                    if XA > 0 and AB > 0 and BC > 0 and CD > 0:
                        ...
                        if (
                            ...
                            print(f"🌙 Moon Dev: Bearish Gartley Pattern Detected at bar {n}! Checking Stoch RSI... 📉")
                            # Stochastic RSI confirmation
                            curr_k = self.k[-1]
                            curr_d = self.d[-1]
                            prev_k = self.k[-2]
