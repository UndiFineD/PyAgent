# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\FibroVoltaic_BTFinal_v7.py
import numpy as np
import pandas as pd
import talib
...
class FibroVoltaic(Strategy):
    ...
    def next(self):
        ...
        # Entry conditions
        if not self.position and uptrend and in_golden_zone and volatility_ok and current_close > self.data.Open[-1]:
