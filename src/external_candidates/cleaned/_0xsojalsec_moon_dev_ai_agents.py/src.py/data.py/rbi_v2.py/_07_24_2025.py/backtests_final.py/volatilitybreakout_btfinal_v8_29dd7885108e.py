# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\VolatilityBreakout_BTFinal_v8.py
import pandas as pd
import talib
...
class VolatilityBreakout(Strategy):
    ...
    def next(self):
        if len(self.data.Close) < self.bb_period * 2:  # Need enough data for indicators
            return
...
# Run backtest
bt = Backtest(data, VolatilityBreakout, commission=0.002, margin=1.0, trade_on_close=True)
stats = bt.run()
print(stats)
