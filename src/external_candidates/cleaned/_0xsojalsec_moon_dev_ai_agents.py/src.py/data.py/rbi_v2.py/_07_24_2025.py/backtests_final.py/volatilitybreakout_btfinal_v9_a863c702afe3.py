# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_final\VolatilityBreakout_BTFinal_v9.py
import pandas as pd
import talib
            ...
            if low_volatility and breakout_signal and rsi_confirmation:
                ...
                if risk_per_unit > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(
                            f"🌙 MOON DEV LONG SIGNAL! ✨ Price: {price:.2f}, Size: {position_size}, RSI: {self.rsi[-1]:.2f}"
                        )
