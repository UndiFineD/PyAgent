# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-moon-dev-ai-agents\src\data\rbi_v2\07_24_2025\backtests_package\DynamicVWAPTrend_PKG.py
import pandas as pd
import talib
...
# Run backtest
bt = Backtest(data, DynamicVWAPTrend, commission=0.002, margin=1.0)
stats = bt.run()
print(stats)
