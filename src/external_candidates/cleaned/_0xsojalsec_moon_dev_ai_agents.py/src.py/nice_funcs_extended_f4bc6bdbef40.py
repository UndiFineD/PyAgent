...
class ExtendedExchangeAPI:
    ...
    def __init__(
        ...
        self.base_url = (
            "https://api.starknet.extended.exchange" if not USE_TESTNET else "https://api-testnet.extended.exchange"
        )
    ...
    def get_position(self, symbol: str) -> Dict:
        ...
        try:
            ...
            for pos in positions:
                # Get market name
                market_attr = (
                    getattr(pos, "market_name", None) or getattr(pos, "market", None) or getattr(pos, "symbol", None)
                )
    ...
    def set_leverage(self, symbol: str, leverage: int):
        ...
        async def set_lev():
            try:
                return await self.trading_client.account.update_leverage(market_name=symbol, leverage=leverage)
            except Exception as e:
