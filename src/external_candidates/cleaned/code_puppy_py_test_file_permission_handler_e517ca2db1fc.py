# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_file_permission_handler_e517ca2db1fc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_file_permission_handler.py
...
class TestPermissionPrompt:
    ...
    @patch("code_puppy.plugins.file_permission_handler.register_callbacks.get_yolo_mode")
    ...
    @patch("code_puppy.plugins.file_permission_handler.register_callbacks.get_user_approval")
    @patch("code_puppy.plugins.file_permission_handler.register_callbacks.get_yolo_mode")
    ...
    def test_prompt_with_preview(self, mock_yolo, mock_approval):
        ...
        confirmed, feedback = prompt_for_file_permission("/tmp/file.py", "edit", preview=preview)
...
class TestHandleEditFilePermission:
    ...
    def test_handle_write_operation(self, mock_prompt):
        ...
        confirmed = handle_edit_file_permission(context, file_path, "write", operation_data)
    ...
    def test_handle_replace_operation(self, mock_prompt):
        ...
        confirmed = handle_edit_file_permission(context, file_path, "replace", operation_data)
    ...
    def test_handle_delete_snippet_operation(self, mock_prompt):
        ...
        confirmed = handle_edit_file_permission(context, file_path, "delete_snippet", operation_data)
...
class TestHandleFilePermission:
    ...
    def test_handle_with_operation_data(self, mock_prompt):
        ...
        confirmed = handle_file_permission(context, file_path, "write", operation_data=operation_data)
...
class TestGeneratePreview:
    ...
    def test_generate_preview_write_operation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            preview = _generate_preview_from_operation_data(file_path, "write", operation_data)
