# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\data\sprites\download.py
#!/usr/bin/env python3
"""
...
def check_for_archive(repo_id: str) -> Optional[str]:
    ...
    try:
        ...
        sprite_archives = [
            a for a in archives if any(keyword in a.lower() for keyword in ["sprite", "image", "all", "complete"])
        ]
    ...
    try:
        ...
        with tqdm(total=len(image_files), desc="Downloading sprites") as pbar:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
                ...
                futures = {executor.submit(download_func, file_path): file_path for file_path in image_files}
