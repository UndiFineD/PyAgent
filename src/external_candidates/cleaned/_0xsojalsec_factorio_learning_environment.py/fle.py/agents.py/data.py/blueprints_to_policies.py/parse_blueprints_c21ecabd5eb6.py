# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\data\blueprints_to_policies\parse_blueprints.py
import json
...
def main():
    ...
    misc_blueprints = [
        bp for bp in index.blueprints if bp not in processed_blueprints and bp.label not in processed_names
    ]
