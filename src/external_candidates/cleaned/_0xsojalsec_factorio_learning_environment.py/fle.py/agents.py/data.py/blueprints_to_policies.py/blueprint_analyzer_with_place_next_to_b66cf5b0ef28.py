# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\data\blueprints_to_policies\blueprint_analyzer_with_place_next_to.py
import json
import os
...
from fle.env import Direction, EntityGroup, FactorioInstance
...
class BlueprintAnalyzerWithPlaceNextTo:
    ...
    def generate_placement_sequence(
        ...
        anchor = max(self.entities, key=lambda e: (len(graph[e.entity_number]), -e.position["x"]))
