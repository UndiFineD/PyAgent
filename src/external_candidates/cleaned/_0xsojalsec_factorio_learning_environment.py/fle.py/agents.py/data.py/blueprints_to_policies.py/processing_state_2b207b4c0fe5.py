# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\data\blueprints_to_policies\processing_state.py
import json
import os
            ...
            with open(state_file, "r") as f:
                ...
                return cls(
                    completed_blueprints=(
                        set(data["completed_blueprints"]) if "completed_blueprints" in data else set()
                    ),
