# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\overlay.py
#!/usr/bin/env python3
"""
...
class IconManager:
    ...
    def __init__(
        self,
        sprites_path: Path = Path("/Users/jackhopkins/PycharmProjects/PaperclipMaximiser/.fle/sprites"),
    ):
    ...
    def update_chart_display(self):
        ...
        try:
            ...
            chart_options = {
                ...
                "legend": {
                    "data": (
                        legend_data if isinstance(legend_data[0], str) else [item["name"] for item in legend_data]
                    ),
            ...
            with ui.column().classes("w-96 flex-shrink-0"):
                ...
                with ui.card().classes("w-full bg-gray-800 text-white"):
                    ...
                    with ui.row().classes("w-full items-center gap-2 mt-2"):
                        ...
                        ui.slider(min=0.1, max=2.0, step=0.1, value=0.5).bind_value(self, "camera_zoom_scale").classes(
                            "flex-1"
                        )
