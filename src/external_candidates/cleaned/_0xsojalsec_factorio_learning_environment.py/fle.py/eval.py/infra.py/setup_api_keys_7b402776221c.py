# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\infra\setup_api_keys.py
"""
...
async def test_api_keys(config_file: str):
    ...
    for provider in providers:
        ...
        available_count = len([key for key in manager._keys[provider] if key.is_available()])
