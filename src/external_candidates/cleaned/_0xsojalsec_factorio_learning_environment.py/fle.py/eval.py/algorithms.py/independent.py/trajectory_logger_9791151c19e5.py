# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\algorithms\independent\trajectory_logger.py
...
class TrajectoryLogger:
    ...
    def save_system_prompt(self, agent: GymAgent, agent_idx: int):
        ...
        """
        formatted_prompt = agent.system_prompt_formatter.format(agent.task, agent.system_prompt)
