# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\algorithms\mcts\mcts_factory.py
import argparse
import dataclasses
import json
...
class MCTSFactory:
    ...
    def _create_mcts(self, config: BaseConfig):
        from eval.algorithms.mcts import MCTS, ParallelMCTS, ParallelMCTSConfig
    ...
    def _create_objective_mcts(self, config: ObjectiveConfig):
        from eval.algorithms.mcts import ObjectiveMCTS, ParallelMCTS, ParallelMCTSConfig
        from fle.agents.formatters.conversation_formatter_abc import (
            StructurePreservingFormatter,
        )
    ...
    def _get_config_interactive(
        ...
        base_config = {
            ...
            "n_parallel": int(questionary.text("Number of parallel instances:", default="4").ask()),
