# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\analysis\database_analyzer.py
"""
...
class DatabaseAnalyzer:
    ...
    async def get_version_metadata(self, versions: List[int]) -> Dict[int, Dict[str, Any]]:
