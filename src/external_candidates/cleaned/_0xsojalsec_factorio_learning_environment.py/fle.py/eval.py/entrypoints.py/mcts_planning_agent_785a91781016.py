# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\entrypoints\mcts_planning_agent.py
import json
import os
...
async def main():
    ...
    objective_model_prompt_path = (
        r"../../../data/prompts/bottoms_up_prompts/finetuning_prompts/system_message_policy_self_gen.md"
    )
    version = 101
    version = 43
