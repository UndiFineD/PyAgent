# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render_simple\renderer.py
...
class Renderer:
    ...
    def __init__(self, style: Optional[Dict] = None):
        ...
        self.layer_renderers = {
            ...
            Layer.CONNECTIONS: ConnectionsLayerRenderer(self.config, self.color_manager, self.connection_renderer),
