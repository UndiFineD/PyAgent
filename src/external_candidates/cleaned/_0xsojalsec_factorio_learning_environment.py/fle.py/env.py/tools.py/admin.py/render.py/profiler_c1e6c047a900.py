# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\profiler.py
...
class PerformanceProfiler:
    ...
    def record_timing(self, operation: str, elapsed: float, metadata: Optional[Dict] = None):
