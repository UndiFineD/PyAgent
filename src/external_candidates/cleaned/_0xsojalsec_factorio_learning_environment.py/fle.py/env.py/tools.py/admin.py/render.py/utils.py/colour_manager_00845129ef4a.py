# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\utils\colour_manager.py
import colorsys
...
class ColourManager:
    ...
    def get_entities_by_category(
        ...
        for entity_name in self.entity_type_counts.keys():
            ...
            entities_by_category[category].append((entity_name, self.entity_type_counts[entity_name]))
