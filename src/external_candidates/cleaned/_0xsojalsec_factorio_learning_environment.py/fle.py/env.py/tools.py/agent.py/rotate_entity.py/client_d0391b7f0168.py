# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\agent\rotate_entity\client.py
from fle.env import DirectionInternal
from fle.env.entities import (
    AssemblingMachine,
)
from fle.env.entities import (
    Direction as DirectionA,  # We have 2 Direction objects to avoid circular deps
)
from fle.env.entities import (
    Entity,
)
