# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\agent\inspect_inventory\client.py
...
class InspectInventory(Tool):
    ...
    def __call__(self, entity=None, all_players: bool = False) -> Union[Inventory, List[Inventory]]:
        ...
        response, execution_time = self.execute(self.player_index, entity is None, x, y, entity.name if entity else "")
