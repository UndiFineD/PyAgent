# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\protocols\a2a\handler.py
import asyncio
import time
import uuid
...
class A2AProtocolHandler:
    ...
    async def negotiate_capabilities(self, agent_id: str, capabilities: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = await self._make_request("negotiate", {"agent_id": agent_id, "capabilities": capabilities})
        return result
    ...
    def load_messages(self, messages: List[Message]) -> None:
        ...
        self._make_sync_request("load_messages", {"agent_id": self.agent_id, "messages": server_messages})
