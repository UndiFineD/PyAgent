# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\data\vqa\blueprint_transforms.py
...
if __name__ == "__main__":
    ...
    for flip_type in FlipType:
        ...
        flipped = flip_blueprint(underground_belt_test, flip_type, DirectionSystem.OLD_SYSTEM)
    ...
    h_flipped = flip_blueprint(underground_belt_test_new, FlipType.HORIZONTAL, DirectionSystem.NEW_SYSTEM)
