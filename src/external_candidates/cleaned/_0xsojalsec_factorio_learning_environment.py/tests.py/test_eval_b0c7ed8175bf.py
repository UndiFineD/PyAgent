# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\test_eval.py
import unittest
...
def test_type_annotations_mixed_depth_prints():
    instance = FactorioInstance(address="localhost", bounding_box=200, tcp_port=27000, fast=True)
    # cache_scripts=False,
    test_string = """
