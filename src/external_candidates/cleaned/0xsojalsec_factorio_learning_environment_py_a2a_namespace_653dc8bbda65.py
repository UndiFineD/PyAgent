# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\a2a_namespace_653dc8bbda65.py
...
class A2AFactorioNamespace(FactorioNamespace):
    ...
    async def async_setup_default_a2a_handler(self, server_url: str, agent_card: Optional[AgentCard] = None):
        ...
        self.a2a_handler = A2AProtocolHandler(agent_id=agent_id_str, server_url=server_url, agent_card=agent_card)
