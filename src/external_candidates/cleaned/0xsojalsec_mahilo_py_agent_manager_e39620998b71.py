# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mahilo.py\mahilo.py\agent_manager_e39620998b71.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\mahilo\agent_manager.py
...
from .registry import AgentRegistry, GlobalRegistry
...
class AgentManager(AgentRegistry):
    ...
    def register_agent(self, agent: BaseAgent) -> None:
        ...
        self.telemetry.record_event(
            ...
            agent_id=agent.name,
            details={"type": agent.TYPE, "can_contact": agent.can_contact},
        )
    ...
    def unregister_agent(self, agent_name: str) -> None:
        ...
        if agent_name in self.agents:
            self.telemetry.record_event(event_type=EventType.AGENT_UNREGISTERED, agent_id=agent_name)
    ...
    def get_policy_violations(self, limit: int = 100, policy_name: Optional[str] = None) -> List[PolicyViolation]:
    ...
    def add_natural_language_policy(
        self,
        name: str,
        description: str,
        policy_text: str,
    ...
    def send_message_to_agent_sync(
        self,
        sender: str,
        recipient: str,
        message: str,
