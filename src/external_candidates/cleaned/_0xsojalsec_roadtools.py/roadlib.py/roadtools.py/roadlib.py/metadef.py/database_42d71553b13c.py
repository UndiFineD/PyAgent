# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ROADtools\roadlib\roadtools\roadlib\metadef\database.py
import datetime
import json
import os
...
from sqlalchemy import Boolean, Column, ForeignKey, Table, Text, create_engine
...
lnk_group_member_contact = Table(
...
lnk_group_member_serviceprincipal = Table(
...
lnk_application_owner_user = Table(
    "lnk_application_owner_user",
    Base.metadata,
    Column("Application", Text, ForeignKey("Applications.objectId")),
    Column("User", Text, ForeignKey("Users.objectId")),
)

lnk_application_owner_serviceprincipal = Table(
    "lnk_application_owner_serviceprincipal",
    Base.metadata,
    Column("Application", Text, ForeignKey("Applications.objectId")),
    Column("ServicePrincipal", Text, ForeignKey("ServicePrincipals.objectId")),
)

lnk_serviceprincipal_owner_user = Table(
    "lnk_serviceprincipal_owner_user",
    Base.metadata,
    Column("ServicePrincipal", Text, ForeignKey("ServicePrincipals.objectId")),
    Column("User", Text, ForeignKey("Users.objectId")),
)

lnk_serviceprincipal_owner_serviceprincipal = Table(
    "lnk_serviceprincipal_owner_serviceprincipal",
    Base.metadata,
    Column("ServicePrincipal", Text, ForeignKey("ServicePrincipals.objectId")),
    Column("childServicePrincipal", Text, ForeignKey("ServicePrincipals.objectId")),
)

lnk_role_member_user = Table(
...
lnk_role_member_serviceprincipal = Table(
    "lnk_role_member_serviceprincipal",
    Base.metadata,
    Column("DirectoryRole", Text, ForeignKey("DirectoryRoles.objectId")),
    Column("ServicePrincipal", Text, ForeignKey("ServicePrincipals.objectId")),
)

lnk_role_member_group = Table(
    "lnk_role_member_group",
    Base.metadata,
    Column("DirectoryRole", Text, ForeignKey("DirectoryRoles.objectId")),
    Column("Group", Text, ForeignKey("Groups.objectId")),
)

lnk_group_owner_user = Table(
...
lnk_group_owner_serviceprincipal = Table(
...
class User(Base, SerializeMixin):
    ...
    ownedServicePrincipals = relationship(
        "ServicePrincipal",
...
class ServicePrincipal(Base, SerializeMixin):
    ...
    ownerUsers = relationship(
        "User",
        secondary=lnk_serviceprincipal_owner_user,
        back_populates="ownedServicePrincipals",
    )

    ownerServicePrincipals = relationship(
        "ServicePrincipal",
    ...
    ownedApplications = relationship(
        "Application",
...
class Group(Base, SerializeMixin):
    ...
    memberServicePrincipals = relationship(
        "ServicePrincipal",
        secondary=lnk_group_member_serviceprincipal,
        back_populates="memberOf",
    )
