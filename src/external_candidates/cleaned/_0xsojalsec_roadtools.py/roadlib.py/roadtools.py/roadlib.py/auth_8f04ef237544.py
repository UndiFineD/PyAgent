...
class Authentication:
    ...
    def get_sub_argparse(auth_parser, for_rr=False):
        ...
        """
        auth_parser.add_argument("-u", "--username", action="store", help="Username for authentication")
        auth_parser.add_argument("-p", "--password", action="store", help="Password (leave empty to prompt)")
        ...
        auth_parser.add_argument("--access-token", action="store", help="Access token (JWT)")
        auth_parser.add_argument("--refresh-token", action="store", help="Refresh token (JWT)")
        auth_parser.add_argument(
            "--prt-cookie",
            action="store",
        ...
        auth_parser.add_argument("--debug", action="store_true", help="Enable debug logging to disk")
        return auth_parser
