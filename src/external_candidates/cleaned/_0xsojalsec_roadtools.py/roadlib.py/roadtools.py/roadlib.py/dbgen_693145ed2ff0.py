# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ROADtools\roadlib\roadtools\roadlib\dbgen.py
...
def gen_db_class(classdef, rels, rev_rels):
    ...
    for pname, pclass in props.items():
        ...
        if (
            pname == "objectId"
            or (classname == "Domain" and pname == "name")
            or (classname == "RoleAssignment" and pname == "id")
            or (classname == "ApplicationRef" and pname == "appId")
            or (classname == "AuthorizationPolicy" and pname == "id")
            or (classname == "DirectorySetting" and pname == "id")
        ):
...
relations = {
    ...
    "application_owner_user": (
        "Application",
        "User",
        "ownerUsers",
        "ownedApplications",
    ),
    "application_owner_serviceprincipal": (
        "Application",
        "ServicePrincipal",
        "ownerServicePrincipals",
        "ownedApplications",
    ),
    "serviceprincipal_owner_user": (
        "ServicePrincipal",
        "User",
        "ownerUsers",
        "ownedServicePrincipals",
    ),
    "serviceprincipal_owner_serviceprincipal": (
        "ServicePrincipal",
        "ServicePrincipal",
        "ownerServicePrincipals",
        "ownedServicePrincipals",
...
tables = [
    ...
    (
        ServicePrincipal,
        ["serviceprincipal_owner_user", "serviceprincipal_owner_serviceprincipal"],
        [
            "role_member_serviceprincipal",
            "serviceprincipal_owner_serviceprincipal",
            "application_owner_serviceprincipal",
    ...
    (
        ...
        ["group_member_group", "role_member_group"],
    ),
    ...
    (
        DirectoryRole,
        ["role_member_user", "role_member_serviceprincipal", "role_member_group"],
        [],
    ),
    (TenantDetail, [], []),
    (ApplicationRef, [], []),
