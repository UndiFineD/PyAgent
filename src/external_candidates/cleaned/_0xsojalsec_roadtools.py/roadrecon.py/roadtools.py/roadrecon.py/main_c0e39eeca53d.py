# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ROADtools\roadrecon\roadtools\roadrecon\main.py
import argparse
import importlib
import os
import sys
...
def main():
    ...
    gui_parser.add_argument("--debug", action="store_true", help="Enable flask debug")
    gui_parser.add_argument("--profile", action="store_true", help="Enable flask profiler")
