...
class RTModelConverter(ModelConverter):
    SQLA_TYPE_MAPPING = dict(list(ModelConverter.SQLA_TYPE_MAPPING.items()) + [(JSON, fields.Raw)])
...
def main(args=None):
    ...
    if not args:
        ...
        parser.add_argument("--profile", action="store_true", help="Enable flask profiler")
