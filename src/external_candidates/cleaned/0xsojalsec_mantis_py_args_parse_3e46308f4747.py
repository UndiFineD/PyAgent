# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mantis.py\mantis.py\utils.py\args_parse_3e46308f4747.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\utils\args_parse.py
...
class ArgsParse:
    ...
    def args_parse() -> ArgsModel:
        ...
        onboard_scan_group.add_argument("-t", "--host", dest="host", help="top level domain to scan")

        onboard_scan_group.add_argument(
            "-f",
            "--file_input",
            dest="file_name",
        ...
        onboard_parser.add_argument("-o", "--org", dest="org", required=True, help="name of the organisation")
        ...
        scan_parser.add_argument("-o", "--org", dest="org", required=True, help="name of the organisation")
