# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-HunyuanVideo-Avatar\hymm_gradio\flask_audio.py
import os
import threading
import traceback
import warnings
...
if __name__ == "__main__":
    ...
    hunyuan_sampler = HunyuanVideoSampler.from_pretrained(audio_args.ckpt, args=audio_args)
    ...
    wav2vec = WhisperModel.from_pretrained(f"{MODEL_OUTPUT_PATH}/ckpts/whisper-tiny/").to(
