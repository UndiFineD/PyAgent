# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\tasks.py\task_definitions.py\task_registry_ec370d38153f.py
