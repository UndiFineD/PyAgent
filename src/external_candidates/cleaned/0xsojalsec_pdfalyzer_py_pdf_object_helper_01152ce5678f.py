# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pdfalyzer.py\pdfalyzer.py\helpers.py\pdf_object_helper_01152ce5678f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\helpers\pdf_object_helper.py
...
def _sort_pdf_object_refs(
    refs: List[PdfObjectRelationship],
