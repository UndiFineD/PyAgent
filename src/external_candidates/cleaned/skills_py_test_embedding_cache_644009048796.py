# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\tests.py\test_embedding_cache_644009048796.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\tests\test_embedding_cache.py
...
class TestCachingEmbeddingProvider:
    ...
    @pytest.fixture
    def cached_provider(self, mock_provider: MockEmbeddingProvider, tmp_path: Path) -> CachingEmbeddingProvider:
        return CachingEmbeddingProvider(mock_provider, cache_path=tmp_path / "cache.db")
    ...
    def test_hit_rate_in_stats(self, cached_provider: CachingEmbeddingProvider) -> None:
