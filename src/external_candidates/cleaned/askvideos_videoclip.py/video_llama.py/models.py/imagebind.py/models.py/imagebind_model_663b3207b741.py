# Extracted from: C:\DEV\PyAgent\.external\AskVideos-VideoCLIP\video_llama\models\ImageBind\models\imagebind_model.py
#!/usr/bin/env python3
...
class ImageBindModel(nn.Module):
    ...
    def get_audio_feature(self, inputs, modality_type):
        ...
        if modality_value is not None:
            ...
            audio_feature = self.modality_heads[modality_key][:-1](modality_value, **head_inputs)
            modality_value = self.modality_heads[modality_key][-1:](audio_feature, **head_inputs)
            modality_value = self.modality_postprocessors[modality_key](modality_value)
