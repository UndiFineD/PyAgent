# Extracted from: C:\DEV\PyAgent\.external\AskVideos-VideoCLIP\video_llama\datasets\datasets\llava_instruct_dataset.py
import json
import os
import pathlib
import random
        ...
        for _ in range(num_retries):
            try:
                ...
                if self.model_type == "vicuna":
                    ...
                    data_dict = preprocess_for_llama_v2(sources, self.tokenizer)
                else:
                    print("not support")
                    raise ("not support")
                ...
                print(
                    f"Failed to load examples with image: {image_path}. "
