# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\prompts.py\translation_2693306255d6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\prompts\translation.py
...
class TranslationPromptTemplateDict(TextPromptDict):
    ...
    ASSISTANT_PROMPT = TextPrompt("""You are an expert English to {language} translator.
