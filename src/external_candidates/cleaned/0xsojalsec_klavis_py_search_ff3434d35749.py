# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\mcp_servers.py\spotify.py\tools.py\search_ff3434d35749.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\spotify\tools\search.py
...
def search_tracks(query: str, type: str = "track", limit: int = 10, sp: Optional[Spotify] = None) -> List[Dict]:
    """
