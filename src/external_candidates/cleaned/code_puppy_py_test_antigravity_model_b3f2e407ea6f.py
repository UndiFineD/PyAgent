# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_antigravity_model_b3f2e407ea6f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_model.py
...
class TestAntigravityModelInitialization:
    ...
    @pytest.mark.parametrize("model_name", ["gemini-1.5-pro", "claude-3-5-sonnet", "custom-model"])
    def test_various_model_names(self, model_name: str, monkeypatch: pytest.MonkeyPatch) -> None:
