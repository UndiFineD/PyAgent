# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\odrobnik.py\gemini_yt_video_transcript.py\scripts.py\youtube_transcript_4a1f879de6aa.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\odrobnik\gemini-yt-video-transcript\scripts\youtube_transcript.py
...
def main() -> int:
    ...
    ap.add_argument(
        "--out",
        help="Write transcript to this file (default: auto-named in workspace out/)",
    )
