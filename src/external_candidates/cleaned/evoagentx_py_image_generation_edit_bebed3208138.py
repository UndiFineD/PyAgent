# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\image_tools.py\flux_image_tools.py\image_generation_edit_bebed3208138.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\image_tools\flux_image_tools\image_generation_edit.py
...
class FluxImageGenerationEditTool(Tool):
    ...
    inputs: Dict[str, Dict] = {
        ...
        "aspect_ratio": {
            "type": "string",
            "description": "Aspect ratio, e.g. '1:1', optional.",
        },
        "output_format": {
            "type": "string",
            "description": "Image format, default is jpeg.",
            "default": "jpeg",
        },
        "prompt_upsampling": {
            "type": "boolean",
            "description": "Enable prompt upsampling, default is false.",
            "default": False,
        },
        "safety_tolerance": {
            "type": "integer",
            "description": "Safety tolerance level, default is 2.",
            "default": 2,
        },
    }
