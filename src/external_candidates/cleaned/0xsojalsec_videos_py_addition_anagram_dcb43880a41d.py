# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\tweets.py\addition_anagram_dcb43880a41d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\tweets\addition_anagram.py
...
class AdditionAnagram(Scene):
    def construct(self):
        ...
        for w1, w2, d1, d2 in [
            (words1, words2, dots1, dots2),
            (words2, words1, dots2, dots1),
        ]:
            self.clear()
