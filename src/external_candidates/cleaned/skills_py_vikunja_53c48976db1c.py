# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dbhurley.py\vikunja.py\scripts.py\vikunja_53c48976db1c.py
...
def cmd_create_task(args):
    ...
    task = client.create_task(args.project, args.title, args.description or "", args.due, args.priority or 0)
