# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\infra.py\agno_aws.py\agno.py\aws.py\resources_be506cf59f0a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agno\libs\infra\agno_aws\agno\aws\resources.py
...
class AwsResources(InfraResources):
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        if (
            ...
            and self.workspace_settings.aws_profile is not None
            ...
            try:
                ...
                if _resource_created:
                    ...
                    if (
                        ...
                        and not self.workspace_settings.continue_on_create_failure
            ...
            try:
                ...
                if _resource_deleted:
                    ...
                    if (
                        ...
                        and not self.workspace_settings.continue_on_delete_failure
            ...
            try:
                ...
                if _resource_updated:
                    ...
                    if (
                        ...
                        and not self.workspace_settings.continue_on_patch_failure
