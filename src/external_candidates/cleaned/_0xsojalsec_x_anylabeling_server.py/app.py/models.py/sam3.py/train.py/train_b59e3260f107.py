# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-X-AnyLabeling-Server\app\models\sam3\train\train.py
    ...
    if submitit_conf.use_cluster:
        ...
        if "job_array" in submitit_conf and submitit_conf.job_array.get("num_tasks", -1) > 0:
            ...
            for job, runner, job_cfg, job_cfg_resolved in jobs_runners_configs:
                ...
                job_array_config_file = os.path.join(job_array_config_dir, "{}.config.yaml".format(job.job_id))
