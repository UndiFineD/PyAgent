# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-X-AnyLabeling-Server\app\models\sam3\eval\coco_eval.py
...
class CocoEvaluator:
    ...
    def _lazy_init(self, coco_cls=COCO):
        ...
        self.coco_gts = [
            (coco_cls(g_pathmgr.get_local_path(gt)) if isinstance(gt, str) else gt) for gt in self.coco_gts
        ]
