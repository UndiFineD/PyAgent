# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-proxyhub\proxyhub\cli.py
"""CLI."""
...
def add_serve_args(group):
    ...
    group.add_argument("--port", type=int, default=8888, help="Port of local proxy server")
    group.add_argument(
        "--max-tries",
        type=int,
        dest="srv_max_tries",
