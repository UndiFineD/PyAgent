# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-proxyhub\docs\source\conf.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#
# proxyhub documentation build configuration file, created by
...
_path_to_init = os.path.abspath(os.path.join(_docs_path, "..", "proxyhub", "__init__.py"))
...
man_pages = [(master_doc, "proxyhub", "proxyhub Documentation", [author], 1)]
