# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\integrations\website_reader.py
import threading
...
class WebsiteReader(NewelleExtension):
    ...
    def get_article(self, button: WebsiteButton):
        ...
        load_image_with_callback(
            favicon,
            lambda pixbuf_loader: button.icon.set_from_pixbuf(pixbuf_loader.get_pixbuf()),
        )
