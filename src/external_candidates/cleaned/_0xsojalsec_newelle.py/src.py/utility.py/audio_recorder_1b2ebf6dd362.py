# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\utility\audio_recorder.py
import math
import os
import struct
import wave
...
class AudioRecorder:
    ...
    def __init__(
        ...
        stop_function: Callable = lambda _: (),
        silence_threshold_percent: float = 0.01,
