# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\llm\openai_handler.py
import json
import threading
...
class OpenAIHandler(LLMHandler):
    ...
    def build_extra_settings(
        ...
        endpoint_settings = [
            ExtraSettings.EntrySetting(
                "endpoint",
                _("API Endpoint"),
                _("API base url, change this to use interference APIs"),
        ...
        advanced_param_toggle = [
            ExtraSettings.ToggleSetting(
                ...
                _("Include parameters like Top-P, Temperature, etc."),
        ...
        models_settings = [
            ExtraSettings.EntrySetting(
                "model",
                _("Model"),
                _("Name of the LLM Model to use"),
                self.models[0][0],
            ),
        ]
        ...
        advanced_settings = [
            ExtraSettings.ScaleSetting(
                "top-p",
                _("Top-P"),
                _("An alternative to sampling with temperature, called nucleus sampling"),
                1,
                0,
                1,
                2,
            ...
            ExtraSettings.ScaleSetting(
                "temperature",
                _("Temperature"),
                _("What sampling temperature to use. Higher values will make the output more random"),
                1,
                0,
                2,
                1,
            ...
            ExtraSettings.ScaleSetting(
                ...
                _("Presence Penalty"),
                _(
                    "Number between -2.0 and 2.0. Positive values decrease the model's likelihood to talk about new topics"
                ),
                0,
                -2,
                2,
        ...
        custom_body = ExtraSettings.MultilineEntrySetting(
            "custom_body",
            _("Custom Options"),
            _("Provide a JSON containing the custom options"),
            "{}",
        )
        ...
        privacy_notice = [
            ExtraSettings.ButtonSetting(
                ...
                lambda button: open_website(privacy_notice_url),
                None,
                "internet-symbolic",
            )
        ]
    ...
    def generate_text(
        ...
        client = OpenAI(api_key=api, base_url=self.get_setting("endpoint"))
