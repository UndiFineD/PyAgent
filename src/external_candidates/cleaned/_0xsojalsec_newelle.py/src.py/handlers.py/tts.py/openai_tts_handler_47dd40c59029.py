# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Newelle\src\handlers\tts\openai_tts_handler.py
    ...
    def get_extra_settings(self) -> list:
        return [
            ...
            ExtraSettings.EntrySetting(
                "instructions",
                _("Instructions"),
                _("Instructions for the voice generation. Leave it blank to avoid this field"),
                "",
            ),
        ]
    ...
    def save_audio(self, message, file):
        ...
        try:
            ...
            response = client.audio.speech.create(
                ...
                response_format="mp3",
                instructions=(
                    self.get_setting("instructions") if self.get_setting("instructions") != "" else NOT_GIVEN
                ),
            )
