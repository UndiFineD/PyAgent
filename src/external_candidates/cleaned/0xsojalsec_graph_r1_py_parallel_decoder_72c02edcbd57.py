# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\verl.py\models.py\qwen2.py\megatron.py\layers.py\parallel_decoder_72c02edcbd57.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Graph-R1\verl\models\qwen2\megatron\layers\parallel_decoder.py
