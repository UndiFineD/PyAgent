# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\functional.py\test_factory_unit_4a88856fe7ed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\functional\test_factory_unit.py

import time

import pytest

from fle.env import BurnerMiningDrill, Direction, EntityStatus, FactorioInstance, Layer
...
def test_iron_smelting(game: FactorioInstance):
    ...
    try:
        ...
        game.connect_entities(belts, coal_to_drill_belt, connection_type=Prototype.TransportBelt)
