# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\search_google_02a9d90269c8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\search_google.py
...
class SearchGoogle(SearchBase):
    ...
    def search(self, query: str, num_search_pages: int = None, max_content_words: int = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Searching Google for: {query}, num_results={num_search_pages}, max_content_words={max_content_words}"
            )
...
class GoogleSearchToolkit(Toolkit):
    def __init__(
        ...
        **kwargs,
        ...
        tools = [GoogleSearchTool(search_google=search_google)]
