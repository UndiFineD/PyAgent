# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\custom.py\logo_7bdef7372a2b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\custom\logo.py
...
from manimlib.animation.composition import AnimationGroup, LaggedStartMap

from manimlib.animation.creation import Write

from manimlib.animation.transform import Restore, Transform

from manimlib.constants import *

from manimlib.mobject.geometry import AnnularSector, Circle, Polygon
...
class Logo(VMobject):
    ...
    def cut_pupil(self):
        ...
        new_pupil = VGroup(*[pupil.copy().pointwise_become_partial(pupil, a, b) for (a, b) in [(0.25, 1), (0, 0.25)]])

        for sector in new_pupil:
            sector.add_cubic_bezier_curve_to([sector.get_points()[-1], *[center] * 3, *[sector.get_points()[0]] * 2])
