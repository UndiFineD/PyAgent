# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\database_connection_provider_309f0161ea4b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\component\database_connection_provider.py
...
class DatabaseConnectionProvider:
    ...
    def __init__(self):
        ...
        if not self.database_url:
            raise ValueError("Database connection string DATABASE_URL is not configured")
    ...
    async def _ensure_initialized(self):
        ...
        logger.info("Database connection pool created successfully %s", self.database_url)
