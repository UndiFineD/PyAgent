# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\provider_schema_test.py
    ...
    def test_extract_with_ollama_passes_json_format(self):
        ...
        with mock.patch("requests.post", autospec=True) as mock_post:
            ...
            mock_response.json.return_value = {
                "response": ('{"extractions": [{"extraction_class": "test", "extraction_text": "example"}]}')
            }
            mock_post.return_value = mock_response
    ...
    def test_yaml_override_sets_fence_output_true(self):
        ...
        with mock.patch("requests.post", autospec=True) as mock_post:
            ...
            with mock.patch("langextract.providers.registry.resolve") as mock_resolve:
                ...
                self.assertTrue(model.requires_fence_output, msg="YAML format should require fences")
...
class SchemaShimTest(absltest.TestCase):
    ...
    def test_provider_schema_imports(self):
        ...
        self.assertTrue(
            ...
            msg=("GeminiSchema should be importable from schema module for backward compatibility"),
        )
