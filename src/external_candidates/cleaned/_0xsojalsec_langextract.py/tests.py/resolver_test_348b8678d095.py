...
class AlignEntitiesTest(parameterized.TestCase):
    ...
    _SOURCE_TEXT_THREE_CONDITIONS_AND_MEDS = (
        "Patient with arthritis, fever, and inflammation is prescribed Naprosyn, prednisone, and ibuprofen."
    )
...
class FlexibleSchemaTest(parameterized.TestCase):
    ...
    def test_strict_mode_rejects_list(self):
        ...
        with self.assertRaisesRegex(resolver_lib.ResolverParsingError, ".*must be a mapping.*"):
            resolver.string_to_extraction_data(test_input)
