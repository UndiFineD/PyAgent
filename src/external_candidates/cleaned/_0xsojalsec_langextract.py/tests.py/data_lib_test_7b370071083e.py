# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\data_lib_test.py
            ...
            annotated_doc=data.AnnotatedDocument(
                ...
                extractions=[
                    ...
                    data.Extraction(
                        ...
                        token_interval=tokenizer.TokenInterval(start_index=4, end_index=5),  # should be ignored
            ...
            annotated_doc=data.AnnotatedDocument(
                ...
                extractions=[
                    data.Extraction(
                        ...
                        token_interval=tokenizer.TokenInterval(start_index=3, end_index=5),  # should be ignored
                        alignment_status=data.AlignmentStatus.MATCH_EXACT,
                    ),
                    data.Extraction(
                        extraction_class="symptom",
