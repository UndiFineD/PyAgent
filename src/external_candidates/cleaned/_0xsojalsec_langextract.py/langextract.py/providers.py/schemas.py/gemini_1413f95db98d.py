# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\langextract\providers\schemas\gemini.py
...
class GeminiSchema(schema.BaseSchema):
    ...
    def from_examples(
        ...
        schema_dict = {
            "type": "object",
            "properties": {data.EXTRACTIONS_KEY: {"type": "array", "items": extraction_schema}},
