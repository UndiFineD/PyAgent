...
class TestGraphNode:
    ...
    def test_create_node(self):
        ...
        node = GraphNode(node_id="test-123", query="What is this?", context="Some context", depth=0)
...
class TestRLMGraphTracker:
    ...
    def test_create_node(self):
        ...
        node_id = tracker.create_node(query="Test query", context="Test context", depth=0)
    ...
    def test_create_child_node(self):
        ...
        parent_id = tracker.create_node(query="Parent query", context="Parent context", depth=0)

        child_id = tracker.create_node(query="Child query", context="Child context", depth=1, parent_id=parent_id)
    ...
    def test_create_code_execution_node(self):
        ...
        exec_node_id = tracker.create_code_execution_node(code="result = 2 + 2", output="4", iteration=1, depth=0)
    ...
    def test_update_node(self):
        ...
        tracker.update_node(node_id=node_id, answer="Test answer", iterations=5, llm_calls=3)
    ...
    def test_update_node_with_zero_values(self):
        ...
        tracker.update_node(node_id=node_id, answer="Quick answer", iterations=0, llm_calls=0)
    ...
    def test_get_stats(self):
        ...
        child_id = tracker.create_node(query="Child", context="", depth=1, parent_id=parent_id)
