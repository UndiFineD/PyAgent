# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\tests\test_core.py
"""Tests for core RLM using DSPy backend."""

from unittest.mock import MagicMock, Mock, patch

import pytest
from rlm import RLM, MaxDepthError, MaxIterationsError
...
def test_initialization(mock_dspy, mock_sandbox):
    ...
    rlm = RLM(model="gpt-4o-mini", max_depth=3, max_iterations=10)
