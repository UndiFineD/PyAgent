# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\tests\test_sandbox.py
...
class TestSandboxFactory:
    ...
    def test_max_output_chars(self):
        ...
        sandbox = SandboxFactory.create(sandbox_type="restricted", max_output_chars=1000)
