# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\tests\test_openrouter.py
    ...
    def test_openrouter_model_detection(self):
        ...
        try:
            ...
            with patch.dict(os.environ, {"OPENROUTER_API_KEY": "test-key"}):
                ...
                rlm = RLM(model="openrouter/anthropic/claude-3.5-sonnet", backend="dspy")
        ...
        try:
            ...
            with patch.dict(os.environ, {}, clear=True):
                with pytest.raises(ValueError) as exc_info:
                    RLM(model="openrouter/anthropic/claude-3.5-sonnet", backend="dspy")
...
class TestOpenRouterMocked:
    ...
    def test_openrouter_dspy_configuration(self, mock_dspy):
        ...
        try:
            ...
            with patch.dict(os.environ, {"OPENROUTER_API_KEY": "test-key"}):
                rlm = RLMDSPy(model="openrouter/anthropic/claude-3.5-sonnet")
