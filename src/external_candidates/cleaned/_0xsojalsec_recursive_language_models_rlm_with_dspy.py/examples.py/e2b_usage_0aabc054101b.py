# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Recursive-Language-Models-RLM-with-DSpy\examples\e2b_usage.py
...
def demo_e2b_vs_restricted():
    ...
    print("-" * 70)
    try:
        rlm_e2b = RLM(model="gpt-4o-mini", sandbox="e2b", max_iterations=10)
    ...
    print("-" * 70)
    try:
        rlm_restricted = RLM(model="gpt-4o-mini", sandbox="restricted", max_iterations=10)
