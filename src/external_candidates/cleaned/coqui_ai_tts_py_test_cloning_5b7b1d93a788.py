# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tests.py\integration.py\test_cloning_5b7b1d93a788.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\tests\integration\test_cloning.py
...
MARKED_VC_MODELS = [
    pytest.param(
        model,
        marks=pytest.mark.skipif(GITHUB_ACTIONS and "openvoice" not in model, reason="Model too big for CI"),
    )
