# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_lumina_dimoo.py\utils.py\image_utils_53d2ca36ffd5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Lumina-DiMOO\utils\image_utils.py
...
def encode_img_with_paint(
    ...
    *,
    ...
    assert mask_mode in (
        "inpainting",
        "outpainting",
    ), "mask_mode must be 'inpainting' or 'outpainting'"
