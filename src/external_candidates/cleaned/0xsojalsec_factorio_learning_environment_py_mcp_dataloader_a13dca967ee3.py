# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\mcp_dataloader_a13dca967ee3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\mcp_dataloader.py
    ...
    async def connect(self):
        ...
        try:
            ...
            server = StdioMCPServer(
                ...
                env={"PYTHONPATH": "/Users/jackhopkins/PycharmProjects/PaperclipMaximiser"},
                transport="stdio",
            )
...
class MCPDataBridge:
    ...
    def __init__(self, update_queue: Queue, mcp_server: str = "python -m fle.env.protocols._mcp"):
        """
    ...
    def _run_bridge(self):
        ...
        try:
            ...
            if self.update_queue:
                self.update_queue.put({"type": "error", "message": f"MCP Bridge error: {str(e)}"})
    ...
    async def _async_connect_and_poll(self):
        ...
        try:
            ...
            self.client = MCPReadOnlyClient(mcp_server=self.mcp_server, update_queue=self.update_queue)
