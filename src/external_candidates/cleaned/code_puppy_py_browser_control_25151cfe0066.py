# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\tools.py\browser.py\browser_control_25151cfe0066.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\browser\browser_control.py
    ...
    try:
        ...
        for i, page in enumerate(all_pages):
            try:
                ...
                pages_info.append({"index": i, "url": url, "title": title, "closed": is_closed})
