# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\absadiki_whatsapp_msgstore_viewer.py\dbs.py\v1.py\db_c84809f92edc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\absadiki-whatsapp-msgstore-viewer\dbs\v1\db.py
...
class Database(AbstractDatabase):
    def __init__(self, msgstore, wa):
        schema = {
            ...
            "message_quoted": {
                "name": "message_quoted",
                "attributes": ["message_row_id", "text_data", "from_me", "key_id"],
            },
        }
