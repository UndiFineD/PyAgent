# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\search.py\milvus.py\memory.py\foresight_collection_d180b13deb16.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\milvus\memory\foresight_collection.py
...
class ForesightCollection(TenantAwareMilvusCollectionWithSuffix):
    ...
    _SCHEMA = CollectionSchema(
        fields=[
            ...
            FieldSchema(name="updated_at", dtype=DataType.INT64, description="Update timestamp"),
        ],
