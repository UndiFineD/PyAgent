# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_ovo.py\ovo.py\app.py\components.py\descriptor_tiles_8f78fd45df55.py
            ...
            with st.container(border=True):
                ...
                if isinstance(descriptor, CategoricalResidueDescriptor):
                    ...
                    if design_id:
                        st.metric(
                            descriptor.name,
                            format_threshold_value(descriptor.name, descriptor_values.loc[design_id]),
                        )
