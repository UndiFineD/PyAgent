# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\pc_agent.py\pcagent_v1.py\icon_localization_f1a961cb3a0c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\PC-Agent\PCAgent_v1\icon_localization.py

import torch

from modelscope.pipelines import pipeline

from PCAgent.crop import calculate_iou, calculate_size
