# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_withoutbg.py\tests.py\fixtures.py\mock_responses_e81161b2bc2a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-withoutbg\tests\fixtures\mock_responses.py
...
def create_mock_response(response_type):
    ...
    if mock_response.status_code >= 400:
        mock_response.raise_for_status.side_effect = Exception(f"HTTP {response_data['status_code']}")
