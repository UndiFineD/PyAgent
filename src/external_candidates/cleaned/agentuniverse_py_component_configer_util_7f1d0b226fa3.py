# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\base.py\component.py\component_configer_util_7f1d0b226fa3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\component\component_configer_util.py
...
from agentuniverse.agent.action.knowledge.rag_router.rag_router_manager import (
    RagRouterManager,
)
