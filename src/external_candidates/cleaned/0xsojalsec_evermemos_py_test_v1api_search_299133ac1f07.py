# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\demo.py\tools.py\test_v1api_search_299133ac1f07.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\demo\tools\test_v1api_search.py
...
class V1APITester:
    ...
    async def test_fetch_memories(self, user_id: str, memory_type: str = "profile", limit: int = 5) -> Dict[str, Any]:
