# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_claude_code_oauth_callbacks_83743d013bfa.py
...
class TestHandleCustomCommand:
    ...
    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks._perform_authentication")
    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks.set_model_and_reload_agent")
    def test_handle_custom_command_auth(self, mock_set_model, mock_auth, mock_load_tokens):
    ...
    def test_handle_custom_command_status_not_authenticated(self, mock_load_tokens):
        ...
        with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_warning"):
            with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_info"):
                result = _handle_custom_command("/claude-code-status", "claude-code-status")

        assert result is True

    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks.load_stored_tokens")
    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks.load_claude_models_filtered")
    def test_handle_custom_command_status_authenticated(self, mock_load_models, mock_load_tokens):
        ...
        with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_success"):
            with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_info"):
                result = _handle_custom_command("/claude-code-status", "claude-code-status")

        assert result is True

    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks.get_token_storage_path")
    @patch("code_puppy.plugins.claude_code_oauth.register_callbacks.remove_claude_code_models")
    def test_handle_custom_command_logout(self, mock_remove_models, mock_token_path):
        ...
        with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_info"):
            with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.emit_success"):
                result = _handle_custom_command("/claude-code-logout", "claude-code-logout")
    ...
    def test_handle_custom_command_logout_no_tokens(self, mock_token_path):
        ...
        with patch("code_puppy.plugins.claude_code_oauth.register_callbacks.remove_claude_code_models") as mock_remove:
