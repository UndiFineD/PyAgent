...
class TestTransferCallTool:
    ...
    async def test_transfer_by_extension_number(
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "6000", "mode": "warm"}, context=tool_context
    ...
    async def test_transfer_by_department_alias(
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "support", "mode": "warm"}, context=tool_context
    ...
    async def test_transfer_multiple_aliases(self, transfer_tool, tool_context):
        ...
        for alias in aliases:
            ...
            result = await transfer_tool.execute(
                ...
                parameters={"target": alias, "mode": "warm"}, context=tool_context
    ...
    async def test_transfer_to_sales_department(
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "sales", "mode": "warm"}, context=tool_context
    ...
    async def test_transfer_to_technical_support(self, transfer_tool, tool_context):
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "tech", "mode": "warm"}, context=tool_context
    ...
    async def test_transfer_invalid_target(self, transfer_tool, tool_context):
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "9999", "mode": "warm"}, context=tool_context
        ...
        assert (
            ...
            "couldn't find" in result["message"].lower()
    ...
    async def test_transfer_empty_target(self, transfer_tool, tool_context):
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "", "mode": "warm"}, context=tool_context
    ...
    async def test_blind_transfer_mode(
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "7000"}, context=tool_context
    ...
    async def test_default_transfer_mode_is_warm(self, transfer_tool, tool_context):
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "6000"}, context=tool_context
    ...
    async def test_ari_originate_failure(
        ...
        mock_ari_client.send_command.side_effect = Exception(

            "Channel origination failed"
    ...
    async def test_transfer_timeout_from_config(self, transfer_tool, tool_context):
        ...
        result = await transfer_tool.execute(
            ...
            parameters={"target": "6002", "mode": "warm"}, context=tool_context
    ...
    async def test_missing_target_parameter(self, transfer_tool, tool_context):
        ...
        with pytest.raises(Exception):  # Should raise validation error
            ...
            await transfer_tool.execute(
                ...
                parameters={"mode": "warm"}, context=tool_context  # Missing target
    ...
    async def test_invalid_mode_parameter(self, transfer_tool, tool_context):
        ...
        with pytest.raises(ValueError, match="Invalid value for mode"):
            ...
            await transfer_tool.execute(
                ...
                parameters={"target": "6000", "mode": "invalid"}, context=tool_context
