# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\command_line.py\mcp_completion_b2ddbd44ab11.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp_completion.py
    ...
    def get_completions(self, document: Document, complete_event) -> Iterable[Completion]:
        ...
        if len(parts) >= 1:
            ...
            if subcommand in self.server_subcommands:
                ...
                elif len(parts) == 2 and cursor_position > (mcp_end + 1 + len(subcommand) + 1):
