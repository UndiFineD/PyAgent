# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\modules.py\glassfish_60f951ba62f9.py
...
class Glassfish:
    ...
    def check(self):
        ...
        if auth_type is not AuthMode.UNKNOWN:
            ...
            logger.info("Glassfish admin interface detected: {}".format(self.interface_url))
