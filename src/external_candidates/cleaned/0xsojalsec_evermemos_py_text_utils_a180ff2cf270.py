    ...
    def parse_tokens(self, text: str, max_score: float = None) -> List[Token]:
        ...
        while i < text_len:
            ...
            # Handle English words
                ...
                while word_end < text_len and (self._is_english_char(text[word_end]) or text[word_end] in "'-"):
                    word_end += 1
            ...
            # Handle continuous numbers
                ...
                while num_end < text_len and (text[num_end].isdigit() or text[num_end] in ".,"):
                    num_end += 1
        ...
        try:
            ...
            for token in tokens:
                if current_score + token.score > max_score:
                    ...
                    if (
                        token.type in [TokenType.ENGLISH_WORD, TokenType.CONTINUOUS_NUMBER]
                        and current_score + token.score <= max_score * 1.05  # Allow up to 5% overflow
                        and current_score > 0
