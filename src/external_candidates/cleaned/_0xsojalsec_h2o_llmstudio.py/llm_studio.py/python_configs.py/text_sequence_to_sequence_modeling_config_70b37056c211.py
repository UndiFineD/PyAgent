# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\python_configs\text_sequence_to_sequence_modeling_config.py
import os
...
class ConfigNLPSeq2SeqEnvironment(ConfigNLPCausalLMEnvironment):
    ...
    _summary_card_template: str = "text_sequence_to_sequence_modeling_experiment_summary_card_template.md"
...
class ConfigProblemBase(DefaultConfigProblemBase):
    ...
    architecture: ConfigNLPSeq2SeqArchitecture = field(default_factory=ConfigNLPSeq2SeqArchitecture)
    ...
    environment: ConfigNLPSeq2SeqEnvironment = field(default_factory=ConfigNLPSeq2SeqEnvironment)
