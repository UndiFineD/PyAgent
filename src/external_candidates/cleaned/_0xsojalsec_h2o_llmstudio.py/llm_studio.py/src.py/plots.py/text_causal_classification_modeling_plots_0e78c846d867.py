# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\src\plots\text_causal_classification_modeling_plots.py
import os
...
class Plots(TextCausalLanguageModelingPlots):
    ...
    def plot_batch(cls, batch, cfg) -> PlotData:
        ...
        df = create_batch_prediction_df(batch, tokenizer, ids_for_tokenized_text="prompt_input_ids")
