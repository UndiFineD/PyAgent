# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\src\order.py
...
class Order:
    ...
    def insert(self, *keys: str, before: str | None = None, after: str | None = None) -> None:
        """
