# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\src\models\text_sequence_to_sequence_modeling_model.py
import logging
...
class Model(nn.Module):
    ...
    def __init__(self, cfg: Any):
        ...
        self.cfg = cfg
        self.backbone, self.backbone_config = create_nlp_backbone(cfg, model_class=AutoModelForSeq2SeqLM)
