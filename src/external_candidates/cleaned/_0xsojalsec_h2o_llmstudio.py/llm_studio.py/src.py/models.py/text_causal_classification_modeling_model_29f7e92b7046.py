# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\src\models\text_causal_classification_modeling_model.py
import logging
...
class Model(nn.Module):
    ...
    def __init__(self, cfg: Any):
        ...
        self.classification_head = nn.Linear(self.backbone_config.vocab_size, cfg.dataset.num_classes, bias=False)
