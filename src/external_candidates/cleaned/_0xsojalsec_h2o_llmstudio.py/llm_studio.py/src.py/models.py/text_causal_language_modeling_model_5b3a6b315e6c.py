...
class Model(nn.Module):
    ...
    def init_deepspeed(self):
        ...
        if self.cfg.training.lora:
            self.backbone.base_model.model.config = self.backbone.base_model.model.module.config
            self.backbone.base_model.model.generation_config = self.backbone.base_model.model.module.generation_config
        else:
