# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\llm_studio\app_utils\sections\settings.py
            ...
            ui.inline(
                items=[
                    ...
                    ui.toggle(
                        ...
                        trigger=False,
                        tooltip=("Whether to show delete dialogs before deleting datasets or experiments."),
                    ),
                ]
            ),
            ui.inline(
            ...
            ui.inline(
                items=[
                    ...
                    ui.dropdown(
                        ...
                        choices=[ui.choice(name, name) for name in ExternalLoggers.names()],
                        trigger=False,
                        width="100px",
                    ),
                ]
            ...
            ui.inline(
                items=[
                    ...
                    ui.toggle(
                        ...
                        value=(True if q.client["default_hf_hub_enable_hf_transfer"] else False),
                        tooltip=(
                            "Toggle to enable \
                ...
                items=[
                    ...
                    ui.dropdown(
                        ...
                        choices=[
                            ...
                            for d in ["cpu", "cpu_shard"] + [f"cuda:{idx}" for idx in range(torch.cuda.device_count())]
                        ],
                        tooltip=(
        ...
        items=[
            ui.inline(
                items=[
                    ...
                    ui.button(name="load_settings", label="Load settings", primary=False),
                    ui.button(
