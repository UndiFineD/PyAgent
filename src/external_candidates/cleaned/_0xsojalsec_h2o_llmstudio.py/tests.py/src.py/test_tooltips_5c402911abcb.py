# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\tests\src\test_tooltips.py
import unittest
...
class TestTooltipFunctions(unittest.TestCase):
    ...
    def test_read_tooltip_file_real_file(self):
        ...
        result = read_tooltip_file("documentation/docs/tooltips/experiments/_add-eos-token-to-answer.mdx")
