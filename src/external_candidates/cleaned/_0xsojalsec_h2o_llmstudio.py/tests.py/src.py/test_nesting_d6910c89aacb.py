# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\tests\src\test_nesting.py
import unittest
...
class TestNesting(unittest.TestCase):
    ...
    def test_nesting_multiple_adds(self):
        ...
        self.nesting.add(["key1", "key2"], [Dependency("dep3", value=True, is_set=True)])
