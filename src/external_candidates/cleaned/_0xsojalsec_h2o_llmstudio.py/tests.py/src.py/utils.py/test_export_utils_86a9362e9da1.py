# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\tests\src\utils\test_export_utils.py
...
def test_get_size_str_dynamic():
    ...
    assert get_size_str(1500, sig_figs=3, input_unit="B", output_unit="dynamic") == "1.465 KB"
