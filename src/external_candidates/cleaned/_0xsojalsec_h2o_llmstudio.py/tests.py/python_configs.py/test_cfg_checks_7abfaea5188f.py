# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-h2o-llmstudio\tests\python_configs\test_cfg_checks.py
...
def test_check_config_for_errors(mock_config):
    with patch("llm_studio.python_configs.cfg_checks.check_for_common_errors") as mock_common_errors:
...
def test_check_for_common_errors_disk_space(mock_statvfs, mock_config):
    mock_statvfs.return_value = MagicMock(f_frsize=4096, f_bavail=1000)  # Small disk space
