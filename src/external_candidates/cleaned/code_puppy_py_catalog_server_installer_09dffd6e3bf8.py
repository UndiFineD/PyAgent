# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\command_line.py\mcp.py\catalog_server_installer_09dffd6e3bf8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp\catalog_server_installer.py
...
def install_catalog_server(manager, server, config: Dict) -> bool:
    ...
    success = install_server_from_catalog(manager, server, server_name, env_vars, cmd_args, group_id)
