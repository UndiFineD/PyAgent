# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\show_uncertainty_disease_637334f49653.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\show_uncertainty_disease.py
...
class OneIn200HasDisease(Scene):
    def construct(self):
        ...
        all_creatures = VGroup(
            *[VGroup(*[creature.copy() for y in range(20)]).arrange(DOWN, SMALL_BUFF) for x in range(10)]
