...
def main() -> int:
    ...
    ap.add_argument(
        ...
        "-p",
        required=True,
        help="Edit instructions (e.g., 'add sunglasses', 'change sky to sunset')",
    )
