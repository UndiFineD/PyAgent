# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wa-crypt-tools\tests\test_createkey.py
import os
import zlib
...
class TestCreatekey:
    def test_createkey(self):
        key: Key15 = Key15(key=bytes.fromhex("6730a595a1484d0c39c101dc0ac82ec5e401bb6f0e1b8ee2dc104a6b3687f017"))
        keyb: bytes = key.dump()
    ...
    def test_createkey14(self):
        key: Key14 = Key14(
            key=bytes.fromhex("3a146d9bbd8b6311d962c71619c0c2cce3ce694ea4a0f3f600e271380e1226c6"),
