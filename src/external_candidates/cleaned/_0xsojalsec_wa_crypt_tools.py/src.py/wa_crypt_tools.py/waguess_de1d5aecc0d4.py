# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wa-crypt-tools\src\wa_crypt_tools\waguess.py
# AES import party!
...
def parsecmdline() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="The default offset of the encrypted data in the encrypted file. Default: {}".format(
            C.DEFAULT_DATA_OFFSET
        ),
    )
