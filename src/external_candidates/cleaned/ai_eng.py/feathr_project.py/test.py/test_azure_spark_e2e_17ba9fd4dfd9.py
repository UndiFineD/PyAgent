# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_azure_spark_e2e.py
import os
...
def test_feathr_materialize_to_cosmosdb():
    ...
    container = "".join(
        [
            "feathrazure_cijob_materialize_",
            "_",
            str(now.minute),
            "_",
            str(now.second),
