# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\access_control\rbac\models.py
import re
...
class Access:
    def __init__(self, record_id: int, project_name: str, access_name: str) -> None:
        self.record_id = record_id
