# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\sql-registry\test\test_create.py
import registry
...
source1_id = r.create_project_datasource(
    project1_id,
    SourceDef(
        qualified_name="unit_test_project_1__source1",
        name="source1",
        path="hdfs://somewhere",
        type="hdfs",
    ),
...
anchor1_id = r.create_project_anchor(
    project1_id,
    AnchorDef(
        qualified_name="unit_test_project_1__anchor1",
        name="anchor1",
...
af1_id = r.create_project_anchor_feature(
    project1_id,
    anchor1_id,
    AnchorFeatureDef(
        qualified_name="unit_test_project_1__anchor1__af1",
        name="af1",
        feature_type=ft1,
        transformation=t1,
        key=[k],
...
df1_id = r.create_project_derived_feature(
    project1_id,
    DerivedFeatureDef(
        qualified_name="unit_test_project_1__df1",
        name="df1",
        feature_type=ft1,
        transformation=t1,
        key=[k],
        input_anchor_features=[af1_id],
