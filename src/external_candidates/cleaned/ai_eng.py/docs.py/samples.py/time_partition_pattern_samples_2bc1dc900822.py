# Extracted from: C:\DEV\PyAgent\.external\ai-eng\docs\samples\time_partition_pattern_samples.py
...
tpp_anchor = FeatureAnchor(name="tppFeatures", source=batch_source, features=tpp_features)
