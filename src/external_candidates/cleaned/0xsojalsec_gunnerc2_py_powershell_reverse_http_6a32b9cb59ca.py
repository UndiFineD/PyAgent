# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\payload_generator.py\windows.py\http.py\ps1.py\powershell_reverse_http_6a32b9cb59ca.py
