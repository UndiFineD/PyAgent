# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentkit.py\backend.py\app.py\app.py\services.py\chat_agent.py\tools.py\extendedbasetool_f2f13d412724.py
