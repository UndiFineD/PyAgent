# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\zbruceli.py\unifai_trading_suite.py\src.py\markets.py\kalshi_1f0f8a15e4ca.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\zbruceli\unifai-trading-suite\src\markets\kalshi.py
...
class KalshiClient:
    ...
    async def search_markets(
        ...
        matching = [m for m in markets if query_lower in m.title.lower() or query_lower in m.ticker.lower()]
