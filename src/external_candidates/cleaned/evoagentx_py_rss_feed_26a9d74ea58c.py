# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\rss_feed_26a9d74ea58c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\rss_feed.py
...
class RSSBase(RequestBase):
    ...
    def fetch_rss_feed(
        ...
        fetch_webpage_content: bool = True,
    ) -> Dict[str, Any]:
        """
...
class RSSFetchTool(Tool):
    ...
    inputs: Dict[str, Dict[str, str]] = {
        "feed_url": {"type": "string", "description": "URL of the RSS feed to fetch"},
        "max_entries": {
            "type": "integer",
...
class RSSToolkit(Toolkit):
    ...
    def __init__(self, name: str = "RSSToolkit"):
        ...
        tools = [RSSFetchTool(rss_base=rss_base), RSSValidateTool(rss_base=rss_base)]
