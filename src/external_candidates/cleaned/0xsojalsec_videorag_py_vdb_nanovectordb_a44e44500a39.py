# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videorag.py\videorag_algorithm.py\videorag.py\storage.py\vdb_nanovectordb_a44e44500a39.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoRAG\VideoRAG-algorithm\videorag\_storage\vdb_nanovectordb.py
