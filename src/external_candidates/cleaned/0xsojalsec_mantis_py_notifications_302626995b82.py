# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mantis.py\mantis.py\utils.py\notifications_302626995b82.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\utils\notifications.py
...
class Notifications:
    ...
    def send_slack_notifications(blocks, webhook):
        ...
        if blocks:
            response = webhook.send(text="Mantis notification", blocks=blocks)
