# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\common_utils.py\datetime_utils_de8730652b72.py
...
def to_iso_format(
    ...
    if value_type is str:
        ...
        raise TypeError(f"Unsupported type: {value_type.__name__}. Expected: datetime, int, float, str, or None.")
...
def from_iso_format(create_time, target_timezone: ZoneInfo = None, strict: bool = False) -> datetime.datetime:
    """
