# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\synthpolis.py\clawdcasino.py\script.py\roulette_5e702f4e6b29.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\synthpolis\clawdcasino\script\roulette.py
...
Examples:
  ...
  /roulette stat                           View your statistics
    ...
    spin_parser.add_argument("--amount", type=float, required=True, help="Bet amount in USDC")
    ...
    history_parser.add_argument("--limit", type=int, default=20, help="Number of results (default 20)")
