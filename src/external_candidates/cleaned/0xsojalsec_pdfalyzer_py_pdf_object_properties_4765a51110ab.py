# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pdfalyzer.py\pdfalyzer.py\decorators.py\pdf_object_properties_4765a51110ab.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\decorators\pdf_object_properties.py
...
class PdfObjectProperties:
    ...
    def __init__(
        ...
        log.debug(
            f"Node ID: {self.idnum}, type: {self.type}, subtype: {self.sub_type}, "
    ...
    @classmethod
    def to_table_row(
        cls, reference_key: str, obj: PdfObject, is_single_row_table: bool = False
    ) -> List[Union[Text, str]]:
        ...
        return [
            Text(
                f"{reference_key}",
                style="grey" if isinstance(reference_key, int) else "",
            ),
