# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_whisperlivekit.py\whisperlivekit.py\simul_whisper.py\token_buffer_d0641af76ff6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WhisperLiveKit\whisperlivekit\simul_whisper\token_buffer.py
