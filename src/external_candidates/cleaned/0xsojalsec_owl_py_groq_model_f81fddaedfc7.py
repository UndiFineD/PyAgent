# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\models.py\groq_model_f81fddaedfc7.py
...
class GroqModel(BaseModelBackend):
    ...
    def __init__(
        ...
        url = url or os.environ.get("GROQ_API_BASE_URL" or "https://api.groq.com/openai/v1")
