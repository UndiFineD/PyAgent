# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\tweets.py\image_manipulation_afaf231b7dc4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\outside_videos\tweets\image_manipulation.py
...
class ImagesMod256(Scene):
    ...
    def construct(self):
        ...
        expression = VGroup(OldTex("n \\rightarrow"), integer, OldTex("\\times n \\mod 256"))
