# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\mobile_agent.py\mobile_agent_qwen.py\mobileagent.py\crop_5faa68beaac9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent\Mobile-Agent-qwen\MobileAgent\crop.py
