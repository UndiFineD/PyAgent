# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\src.py\utils.py\audio_capture_29fb71a3026c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\src\utils\audio_capture.py
...
class AudioCaptureManager:
    ...
    def __init__(
        ...
        self, base_dir: str = "/tmp/ai-engine-captures", keep_files: bool = False
    ...
    def _open_handle(
        ...
        self, call_id: str, stream_name: str, sample_rate: int
    ...
    def append_pcm16(
        ...
        self, call_id: str, stream_name: str, pcm16: bytes, sample_rate: int
