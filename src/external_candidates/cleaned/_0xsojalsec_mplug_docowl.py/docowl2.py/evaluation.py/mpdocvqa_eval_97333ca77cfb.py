# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl2\evaluation\mpdocvqa_eval.py
"""
...
def evaluate_method(gtJson, submJson, anls_threshold=0.5):
    ...
    for gtObject in gtJson["data"]:
        ...
        if q_id in question_ids_to_exclude:
            ...
            question_result = get_NLS(gtObject["answers"], detObject["answers"], anls_threshold)
...
if __name__ == "__main__":
    postprocess_llm_vqa(
        ...
        split="val",
        llm_pred_path="/nas-alinlp/anwenhu/DocSFTv2/MP-DocVQA/val.jsonl",
        save_results=True,
    )
