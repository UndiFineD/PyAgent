# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\pipeline\train.py
import argparse
...
parser.add_argument("--inference_mode", type=bool, default=False, help="The inference mode.")
...
parser.add_argument("--num-workers", type=int, default=8, help="Dataloader number of workers.")
...
parser.add_argument("--num-warmup-steps", type=int, default=50, help="The number of warmup steps.")
...
# Other
parser.add_argument("--gradient-checkpointing", action="store_true", help="The gradient checkpointing.")
parser.add_argument("--logging-nan-inf-filter", action="store_true", help="The logging nan inf filter.")
parser.add_argument(
    "--ddp-find-unused-parameters",
    action="store_true",
    help="unused parameters finding.",
)
parser.add_argument("--do-train", action="store_true", default=True, help="Whether to do training.")
