# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\pipeline\eval_utils\due_evaluator\due_evaluator.py
import sys
        ...
        for item in document["annotations"]:
            for value_dict in item["values"]:
                ...
                if "children" in value_dict:
                    value_dict["children"] = self.uppercase_items({"annotations": value_dict["children"]})[
                        "annotations"
                    ]
        return document
