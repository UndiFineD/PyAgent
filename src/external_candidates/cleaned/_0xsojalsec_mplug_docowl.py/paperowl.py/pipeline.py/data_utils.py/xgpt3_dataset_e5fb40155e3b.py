# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\pipeline\data_utils\xgpt3_dataset.py
import json
import logging
import os
import random
...
class MultiModalDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        while True:
            try:
                image, text, patch_positions = self.process_data(data, self.processors[task_type])

                text_input = self._extract_text_token_from_conversation(text, self.max_length, index)
