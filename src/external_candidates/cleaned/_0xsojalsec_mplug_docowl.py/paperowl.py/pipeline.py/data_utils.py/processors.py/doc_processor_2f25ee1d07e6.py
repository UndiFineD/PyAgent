# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\pipeline\data_utils\processors\doc_processor.py
import random
    ...
    def _process_image(self, image):
        ...
        patch_position = torch.cat(
            [
                ...
                repeat(torch.arange(anchor[1]), "num_w -> num_h num_w 1", num_h=anchor[0]),
            ],
            dim=2,
        )
