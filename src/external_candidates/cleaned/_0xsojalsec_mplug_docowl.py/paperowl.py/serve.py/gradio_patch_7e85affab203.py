# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\PaperOwl\serve\gradio_patch.py
"""
...
class Chatbot(Changeable, IOComponent, JSONSerializable):
    ...
    def postprocess(
        ...
        for message_pair in y:
            assert isinstance(message_pair, (tuple, list)), (
            ...
            processed_messages.append(
                (
                    ...
                    '<pre style="font-family: var(--font)">' + message_pair[0] + "</pre>",
