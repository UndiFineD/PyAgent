# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl1.5\model_worker.py
"""
...
from mplug_docowl.utils import build_logger, pretty_print_semaphore, server_error_msg
...
class ModelWorker:
    def __init__(
        ...
        self.token_num_each_img = (
            (self.resolution / 14) * (self.resolution / 14) / self.model.get_model().vision2text.conv_patch
        )
