# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl1.5\app.py
import argparse
import datetime
import hashlib
import json
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-version", type=str, default="Omni", choices=["stage1", "Chat", "Omni"])
