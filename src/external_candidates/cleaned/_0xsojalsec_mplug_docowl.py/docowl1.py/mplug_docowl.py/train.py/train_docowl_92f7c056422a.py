# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\DocOwl1.5\mplug_docowl\train\train_docowl.py
...
from mplug_docowl.constants import DEFAULT_IMAGE_TOKEN, IGNORE_INDEX, IMAGE_TOKEN_INDEX
...
def docowl_text_preprocess_v1(source, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False) -> Dict:
    """
...
def train():
    ...
    trainer = MPLUGDocOwlTrainer(model=model, tokenizer=tokenizer, args=training_args, **data_module)
