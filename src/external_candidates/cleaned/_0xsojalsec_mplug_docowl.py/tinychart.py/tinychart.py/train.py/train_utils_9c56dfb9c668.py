# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\TinyChart\tinychart\train\train_utils.py
import logging
import os
...
def unlock_vit(training_args, model_args, vision_tower):
    lr_of_vit = (
        ...
        if training_args.vision_tower_lr is not None and training_args.vision_tower_lr != 0
