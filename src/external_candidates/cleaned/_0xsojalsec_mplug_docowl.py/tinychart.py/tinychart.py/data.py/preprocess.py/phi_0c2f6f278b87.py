# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\TinyChart\tinychart\data\preprocess\phi.py
import copy
...
def preprocess_phi(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False) -> Dict:
