# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mPLUG-DocOwl\TinyChart\tinychart\model\multimodal_projector\builder.py
import math
import re
...
class Resampler(nn.Module):
    def __init__(
        ...
        self.resampler_blocks = nn.ModuleList(
            [ResamplerBlock(hidden_size, image_hidden_size, num_heads, intermediate_size) for _ in range(num_layers)]
        )
