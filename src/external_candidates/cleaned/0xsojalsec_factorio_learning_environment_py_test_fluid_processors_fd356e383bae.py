# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\entities.py\test_fluid_processors_fd356e383bae.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\entities\test_fluid_processors.py

import pytest

from fle.env.entities import Direction, Entity, Position

from fle.env.game_types import Prototype, RecipeName, Resource, prototype_by_name
