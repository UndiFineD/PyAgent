# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\senior_architect.py\scripts.py\dependency_analyzer_deddd61d6e20.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\senior-architect\scripts\dependency_analyzer.py
...
class DependencyAnalyzer:
    ...
    def _parse_poetry(self):
        ...
        try:
            ...
            for line in content.split("\n"):
                ...
                elif line == "[tool.poetry.dev-dependencies]" or line == "[tool.poetry.group.dev.dependencies]":
                    in_deps = False
    ...
    def _generate_recommendations(self):
        ...
        if self.coupling_score > 70:
            self.recommendations.append(
                "High coupling detected. Consider applying SOLID principles and introducing abstraction layers"
            )
