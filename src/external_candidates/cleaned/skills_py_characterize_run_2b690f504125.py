# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chrisvoncsefalvay.py\wandb_monitor.py\scripts.py\characterize_run_2b690f504125.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chrisvoncsefalvay\wandb-monitor\scripts\characterize_run.py
