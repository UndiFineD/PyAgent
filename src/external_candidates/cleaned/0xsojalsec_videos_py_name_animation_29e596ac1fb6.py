# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\outside_videos.py\name_animation_29e596ac1fb6.py
...
class FlowNameAnimation(Scene):
    ...
    def construct(self):
        ...
        self.play(
            ...
            LaggedStartMap(ApplyMethod, name_strokes, lambda m: (m.restore,), lag_ratio=0.2),
            run_time=5,
        )
