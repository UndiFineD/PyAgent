# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\command_line.py\test_uc_menu_4028e78a77d0.py
...
class TestRenderSourcePanel:
    ...
    def test_renders_error_message(self, mock_tool_enabled):
        ...
        result = _render_source_panel(mock_tool_enabled, [], scroll_offset=0, error="File not found")
