# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\optimization.py\evoprompt.py\evoprompt_workflow_651fe779d955.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\optimization\evoprompt\evoprompt_workflow.py
...
async def main():
    ...
    eval_llm_config = OpenAILLMConfig(model="gpt-4.1-nano", openai_key=OPENAI_API_KEY, stream=False, temperature=0)
