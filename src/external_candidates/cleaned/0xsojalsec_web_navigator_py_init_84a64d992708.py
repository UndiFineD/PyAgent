# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_navigator.py\src.py\router.py\init_84a64d992708.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Web-Navigator\src\router\__init__.py
...
class LLMRouter:
    ...
    def invoke(self, query: str) -> str:
        ...
        messages = [
            SystemMessage(self.system_prompt.format(**parameters)),
            HumanMessage(query),
        ]
