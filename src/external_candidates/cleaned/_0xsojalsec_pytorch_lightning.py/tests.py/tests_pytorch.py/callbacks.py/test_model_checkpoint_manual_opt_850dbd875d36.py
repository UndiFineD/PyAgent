# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\callbacks\test_model_checkpoint_manual_opt.py
import shutil
import tempfile
import warnings
