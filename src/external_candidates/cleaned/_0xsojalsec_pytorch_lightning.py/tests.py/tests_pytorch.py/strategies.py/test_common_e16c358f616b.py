# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\strategies\test_common.py
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            {"strategy": "ddp_spawn", "accelerator": "gpu", "devices": 2},
