# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\trainer\connectors\test_signal_connector.py
...
@pytest.mark.parametrize(
    "requeue_signal",
    [signal.SIGUSR1, signal.SIGUSR2, signal.SIGHUP] if not _IS_WINDOWS else [],
)
...
def test_has_already_handler(handler, expected_return):
    ...
    with mock.patch(
        "lightning.pytorch.trainer.connectors.signal_connector.signal.getsignal",
