# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\checkpointing\test_checkpoint_callback_frequency.py
...
@pytest.mark.parametrize(
    ...
    [(1, 1, 1.0, 1), (2, 2, 1.0, 2), (2, 1, 0.25, 4), (2, 2, 0.3, 6)],
)
