# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\loops\test_fetchers.py
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            3,
            True,
        ),  # limit exceeds largest iterable
        ...
        (
            ...
            4,
            True,
        ),  # limit in all iterables needs to be reached
        (
            "sequential",
            [[1, 2], [1, 2, 3]],
            100,
        ...
        (
            ...
            3,
            False,
        ),  # not sized, no prefetching -> can't know if done
        ("min_size", [IterDataset()], 1, 1, True),
        ("min_size", [IterDataset(2), IterDataset(3)], None, 1, False),
        (
            "min_size",
            [IterDataset(2), IterDataset(3)],
            None,
            2,
            False,
        ),  # not sized, no prefetching -> can't know
        ...
        (
            ...
            2,
            True,
        ),  # smallest is sized -> done follows the limit
        ...
        (
            ...
            3,
            False,
        ),  # 1st iterable is unsized -> can't know max
