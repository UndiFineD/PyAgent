# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\models\test_gpu.py
...
def test_single_gpu_batch_parse():
    ...
    batch = (
        [torch.rand(2, 3) for _ in range(2)],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "bf16-true",
            torch.bfloat16,
            marks=RunIf(deepspeed=True, bf16_cuda=True),
        ),
    ],
)
