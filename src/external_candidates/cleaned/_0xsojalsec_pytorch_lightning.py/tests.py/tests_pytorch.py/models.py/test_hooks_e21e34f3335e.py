# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_pytorch\models\test_hooks.py
            ...
            out.extend(
                [
                    ...
                    *([{"name": "backward", "args": (ANY,)}] if not using_deepspeed else []),
                    ...
                    {
                        "name": "Callback.on_before_optimizer_step",
                        "args": (trainer, model, ANY),
                    },
                    ...
                    *(
                    ...
                    ),
                    {
                        ...
                        "args": (trainer, model, {"loss": ANY}, ANY, i),
                    },
        ...
        for i in range(batches):
            out.extend(
                [
                    ...
                    {"name": "on_after_batch_transfer", "args": (ANY, 0)},
                    {
                        "name": f"Callback.on_{fn}_batch_start",
                        "args": (trainer, model, ANY, i),
                    },
                    ...
                    {
                        "name": f"Callback.on_{fn}_batch_end",
                        "args": (trainer, model, outputs, ANY, i),
                    },
        ...
        for i in range(batches):
            out.extend(
                [
                    ...
                    {"name": "on_after_batch_transfer", "args": (ANY, 0)},
                    {
                        "name": "Callback.on_predict_batch_start",
                        "args": (trainer, model, ANY, i),
                    },
                    ...
                    {
                        "name": "Callback.on_predict_batch_end",
                        "args": (trainer, model, ANY, ANY, i),
                    },
...
@pytest.mark.parametrize(
    ("verb", "noun", "dataloader", "key"),
    [("validate", "validation", "val", "x"), ("test", "test", "test", "y")],
)
    ...
    expected_lm_called += [
        {
            ...
            "args": ({**saved_ckpt, "hyper_parameters": ANY},),
        }
    ]
