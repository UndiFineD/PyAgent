# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\plugins\environments\test_lsf.py
...
def test_manual_main_port_and_address(tmp_path):
    ...
    with (
        ...
        mock.patch("socket.gethostname", return_value="10.10.10.2"),
    ):
        env = LSFEnvironment()
