# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\strategies\__init__.py
...
from lightning.fabric.strategies.model_parallel import (  # noqa: F401
