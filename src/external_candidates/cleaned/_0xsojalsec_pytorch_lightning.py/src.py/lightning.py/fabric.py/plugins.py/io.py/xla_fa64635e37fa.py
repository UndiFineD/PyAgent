# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\plugins\io\xla.py
...
class XLACheckpointIO(TorchCheckpointIO):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from pytorch_lightning_enterprise.plugins.io.xla import (
            XLACheckpointIO as EnterpriseXLACheckpointIO,
        )
