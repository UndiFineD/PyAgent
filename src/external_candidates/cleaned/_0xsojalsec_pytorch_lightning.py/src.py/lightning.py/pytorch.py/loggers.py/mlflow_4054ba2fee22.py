# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\loggers\mlflow.py
...
class MLFlowLogger(Logger):
    ...
    def __init__(
        ...
        from pytorch_lightning_enterprise.loggers.mlflow import (
            MLFlowLogger as EnterpriseMLFlowLogger,
        )
