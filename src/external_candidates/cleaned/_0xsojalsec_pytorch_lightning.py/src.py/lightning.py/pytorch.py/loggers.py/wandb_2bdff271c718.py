# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\loggers\wandb.py
    ...
    **Downloading and Using Artifacts**
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__()
        from pytorch_lightning_enterprise.loggers.wandb import (
            WandbLogger as EnterpriseWandbLogger,
        )
