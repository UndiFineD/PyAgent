# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\utilities\model_summary\model_summary_deepspeed.py
...
class DeepSpeedSummary(ModelSummary):
    ...
    def _get_summary_data(self) -> list[tuple[str, list[str]]]:
        ...
        arrays = [
            ...
            (
                "Params per Device",
                list(map(get_human_readable_count, self.parameters_per_layer)),
            ),
