# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\strategies\launchers\multiprocessing.py
...
class _MultiProcessingLauncher(_Launcher):
    ...
    def __init__(
        self,
        strategy: "pl.strategies.ParallelStrategy",
...
class _GlobalStateSnapshot:
    ...
    def restore(self) -> None:
        ...
        torch.use_deterministic_algorithms(
            ...
            warn_only=self.use_deterministic_algorithms_warn_only,
        )
