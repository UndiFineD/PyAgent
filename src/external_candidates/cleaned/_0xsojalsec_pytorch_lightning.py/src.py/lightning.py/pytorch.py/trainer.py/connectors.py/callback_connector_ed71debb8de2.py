# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\pytorch\trainer\connectors\callback_connector.py
        ...
        if self.trainer.checkpoint_callbacks:
            ...
            if RequirementCache("litmodels >=0.1.7") and self.trainer._model_registry:
                ...
                if "pytorch_lightning" in trainer_source.__package__:
                    from litmodels.integrations.checkpoints import (
                        PytorchLightningModelCheckpoint as LitModelCheckpoint,
                    )
                else:
                    from litmodels.integrations.checkpoints import (
                        LightningModelCheckpoint as LitModelCheckpoint,
                    )
