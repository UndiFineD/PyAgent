# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\examples.py\agents.py\basic_agent_0757e7220173.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\examples\agents\basic_agent.py
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if agent_idx is not None and task.get_agent_instructions(agent_idx) is not None:
            ...
            instructions += (
                f"### Specific Instructions for Agent {player_idx}\n{task.get_agent_instructions(agent_idx)}\n\n"
            )
