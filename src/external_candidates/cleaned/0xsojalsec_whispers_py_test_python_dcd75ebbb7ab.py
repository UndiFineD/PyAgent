# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_whispers.py\tests.py\unit.py\plugins.py\test_python_dcd75ebbb7ab.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-whispers\tests\unit\plugins\test_python.py
