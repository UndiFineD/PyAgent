# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_agent_manager_basics_3f419d098cf5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_agent_manager_basics.py
...
class TestAgentManagerBasics:
    ...
    def test_discover_agents_python_classes(self, mock_import, mock_iter_modules, mock_json_agents):
    ...
    @patch("code_puppy.agents.agent_manager.discover_json_agents")
    @patch("pkgutil.iter_modules")
    def test_discover_agents_skips_internal_modules(self, mock_iter_modules, mock_json_agents):
    ...
    @patch("code_puppy.agents.agent_manager.discover_json_agents")
    @patch("pkgutil.iter_modules")
    def test_discover_agents_handles_import_errors(self, mock_iter_modules, mock_json_agents):
    ...
    @patch("pkgutil.iter_modules")
    @patch("importlib.import_module")
    def test_get_available_agents(self, mock_import, mock_iter_modules, mock_json_agents):
    ...
    @patch("pkgutil.iter_modules")
    @patch("importlib.import_module")
    def test_load_agent_python_class(self, mock_import, mock_iter_modules, mock_json_agents):
    ...
    @patch("pkgutil.iter_modules")
    @patch("importlib.import_module")
    def test_load_agent_fallback_to_code_puppy(self, mock_import, mock_iter_modules, mock_json_agents):
    ...
    def test_set_current_agent(self, mock_get_name, mock_load_agent, mock_load_data, mock_save_data):
