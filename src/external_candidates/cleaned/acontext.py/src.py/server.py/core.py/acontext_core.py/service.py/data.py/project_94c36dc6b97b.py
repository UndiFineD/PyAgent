# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\service\data\project.py
import asyncio
import json
...
async def get_project_config(db_session: AsyncSession, project_id: asUUID) -> Result[ProjectConfig]:
