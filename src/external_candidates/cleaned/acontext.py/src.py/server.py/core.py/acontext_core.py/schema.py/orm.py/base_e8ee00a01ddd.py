# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\schema\orm\base.py
import uuid
...
class TimestampMixin(BaseMixin):
    created_at: datetime = field(
        init=False,
        metadata={"db": Column(DateTime(timezone=True), server_default=func.now(), nullable=False)},
    )
