# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\llm\tool\space_tools.py
...
SPACE_TOOLS[_insert_candidate_data_as_content_tool.schema.function.name] = _insert_candidate_data_as_content_tool
