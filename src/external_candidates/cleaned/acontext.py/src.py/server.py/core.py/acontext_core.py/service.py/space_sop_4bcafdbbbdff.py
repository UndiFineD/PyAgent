# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\service\space_sop.py
...
async def space_sop_complete_task(body: SOPComplete, message: Message):
    ...
    try:
        ...
        await SSC.process_sop_complete(project_config, body.project_id, body.space_id, body.task_id, body.sop_data)
