# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\schema\orm\block.py
...
class Block(CommonMixin):
    ...
    tool_sops: List["ToolSOP"] = field(
        default_factory=list,
        metadata={"db": relationship("ToolSOP", back_populates="sop_block", cascade="all, delete-orphan")},
    )
