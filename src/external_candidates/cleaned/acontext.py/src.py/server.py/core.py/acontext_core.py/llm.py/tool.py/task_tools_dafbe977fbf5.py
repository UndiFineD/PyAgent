# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\llm\tool\task_tools.py
...
TASK_TOOLS[_append_messages_to_planning_section_tool.schema.function.name] = _append_messages_to_planning_section_tool
TASK_TOOLS[_append_messages_to_task_tool.schema.function.name] = _append_messages_to_task_tool
