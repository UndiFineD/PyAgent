...
class ToolReference(CommonMixin):
    ...
    description: Optional[str] = field(default=None, metadata={"db": Column(String, nullable=True)})
    arguments_schema: Optional[dict] = field(default=None, metadata={"db": Column(JSONB, nullable=True)})
    ...
    tool_sops: List["ToolSOP"] = field(
        ...
        metadata={"db": relationship("ToolSOP", back_populates="tool_reference", cascade="all, delete-orphan")},
    )
