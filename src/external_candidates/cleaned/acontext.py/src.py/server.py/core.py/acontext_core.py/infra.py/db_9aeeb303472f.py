# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\acontext_core\infra\db.py
import traceback
...
async def init_database() -> None:
    ...
    async with DB_CLIENT.get_session_context() as db_session:
        await check_legal_embedding_dim(BlockEmbedding, db_session, DEFAULT_CORE_CONFIG.block_embedding_dim)
