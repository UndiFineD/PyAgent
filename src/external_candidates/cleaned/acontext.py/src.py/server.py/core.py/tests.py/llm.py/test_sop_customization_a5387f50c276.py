# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\tests\llm\test_sop_customization.py
"""
...
class TestSOPPromptCustomization:
    ...
    def test_build_custom_scoring_section_normal(self):
        ...
        rule1 = CustomScoringRule(description="If the task involves database operations", level="normal")
        rule2 = CustomScoringRule(description="If the task requires file I/O", level="normal")
    ...
    def test_build_custom_scoring_section_critical(self):
        ...
        rule = CustomScoringRule(description="If the task requires external API calls", level="critical")
...
class TestTaskSOPPromptWithCustomization:
    ...
    def test_system_prompt_with_customization(self):
        ...
        rule1 = CustomScoringRule(description="If the task involves database operations", level="normal")
        rule2 = CustomScoringRule(description="If the task requires external API calls", level="critical")
        customization = SOPPromptCustomization(custom_scoring_rules=[rule1, rule2])
