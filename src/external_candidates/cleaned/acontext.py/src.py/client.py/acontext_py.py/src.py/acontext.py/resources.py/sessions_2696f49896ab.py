# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\client\acontext-py\src\acontext\resources\sessions.py
"""Sessions endpoints."""
...
class SessionsAPI:
    ...
    def get_messages(
        ...
        *,
        ...
        data = self._requester.request("GET", f"/session/{session_id}/messages", params=params or None)
    ...
    def get_learning_status(self, session_id: str) -> LearningStatus:
        ...
        """
        data = self._requester.request("GET", f"/session/{session_id}/get_learning_status")
