# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\client\acontext-py\tests\test_client.py
import json
...
@patch("acontext.client.AcontextClient.request")
def test_spaces_experience_search_with_fast_mode(mock_request, client: AcontextClient) -> None:
    mock_request.return_value = {
        "cited_blocks": [
            {
                "block_id": "block-1",
...
@patch("acontext.client.AcontextClient.request")
def test_spaces_experience_search_with_agentic_mode(mock_request, client: AcontextClient) -> None:
    mock_request.return_value = {
        "cited_blocks": [],
        "final_answer": None,
    }
