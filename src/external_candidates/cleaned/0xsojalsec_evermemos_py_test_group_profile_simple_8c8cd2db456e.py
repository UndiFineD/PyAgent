# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\tests.py\test_group_profile_simple_8c8cd2db456e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\tests\test_group_profile_simple.py
...
def test_group_profile_creation():
    ...
    minimal_profile = GroupProfile(group_id="test_group_002", timestamp=current_timestamp)
