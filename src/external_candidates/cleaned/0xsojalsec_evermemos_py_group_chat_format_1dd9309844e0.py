# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\data_format.py\group_chat.py\group_chat_format_1dd9309844e0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\data_format\group_chat\group_chat_format.py
...
class ConversationMeta(TypedDict, total=False):
    ...
    Attributes:
        ...
        scene_desc: Scene description information, such as company scene can contain bot_ids list to mark the AI assistant (optional)
...
def validate_group_chat_format(data: GroupChatFormat) -> bool:
    ...
    if "version" not in data or "conversation_meta" not in data or "conversation_list" not in data:
        return False
