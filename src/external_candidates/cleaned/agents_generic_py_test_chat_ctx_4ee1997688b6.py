# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\test_chat_ctx_4ee1997688b6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_chat_ctx.py
...
def test_dict():
    ...
    chat_ctx.add_message(
        role="user",
        content=[ImageContent(image=rtc.VideoFrame(64, 64, rtc.VideoBufferType.RGB24, b"0" * 64 * 64 * 3))],
    )
