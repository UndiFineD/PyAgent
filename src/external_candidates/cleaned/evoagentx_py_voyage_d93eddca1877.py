# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\rag.py\embeddings.py\voyage_d93eddca1877.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\rag\embeddings\voyage.py
    ...
    async def _async_embed_query(self, query: Union[str, Dict, List]) -> List[float]:
        ...
        try:
            ...
            result = await self.client.multimodal_embed(
                inputs=[formatted_query], model=self.model_name, input_type="query"
            )
