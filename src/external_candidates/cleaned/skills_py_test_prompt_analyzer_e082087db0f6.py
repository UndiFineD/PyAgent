# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dgriffin831.py\skill_scan.py\tests.py\test_prompt_analyzer_e082087db0f6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dgriffin831\skill-scan\tests\test_prompt_analyzer.py
...
class TestInvisibleCharacters:
    ...
    def test_rtl_override(self, analyzer):
        ...
        assert any(f["ruleId"] in ("INVISIBLE_CHARS", "RTL_OVERRIDE", "BIDI_ATTACK") for f in findings)
