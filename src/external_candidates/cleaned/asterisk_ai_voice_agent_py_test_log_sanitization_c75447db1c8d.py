# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\test_log_sanitization_c75447db1c8d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\test_log_sanitization.py
...
class TestLogSanitization:
    ...
    def test_no_false_positive_on_passthrough(self):
        ...
        assert result["passthrough_providers"] == [
