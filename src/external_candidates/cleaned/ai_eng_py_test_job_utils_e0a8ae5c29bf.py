# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\unit.py\utils.py\test_job_utils_e0a8ae5c29bf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\unit\utils\test_job_utils.py
...
def test__get_result_df__with_local_cache_path(
    ...
    mocked_load_files_to_pandas_df = mocker.patch(

        "feathr.utils.job_utils._load_files_to_pandas_df"
    ...
    mocker.patch(
        ...
        "feathr.utils.job_utils.TemporaryDirectory",

        return_value=mocked_named_temporary_dir,
