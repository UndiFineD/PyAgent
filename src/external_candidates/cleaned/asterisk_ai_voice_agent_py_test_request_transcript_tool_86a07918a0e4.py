# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\tools.py\business.py\test_request_transcript_tool_86a07918a0e4.py
...
class TestRequestTranscriptTool:
    ...
    async def test_parse_simple_email(self, mock_dns, mock_resend, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_parse_email_with_underscore(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_parse_email_with_dash(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_parse_email_with_subdomain(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_empty_email_address(self, transcript_tool, tool_context, enabled_config):
        """Test handling of empty email address."""

        result = await transcript_tool.execute(parameters={"caller_email": ""}, context=tool_context)
    ...
    @pytest.mark.asyncio
    async def test_invalid_email_format(self, transcript_tool, tool_context, enabled_config):
        """Test handling of invalid email format."""

        result = await transcript_tool.execute(parameters={"caller_email": "not an email"}, context=tool_context)
    ...
    @pytest.mark.asyncio
    async def test_email_missing_at_symbol(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_valid_domain_dns_check(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_invalid_domain_dns_check(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_domain_without_mx_record(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_prevent_duplicate_email_same_call(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_successful_email_send(self, transcript_tool, tool_context, enabled_config, sample_call_session):
    ...
    @pytest.mark.asyncio
    async def test_email_send_failure(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_empty_conversation_history(self, transcript_tool, tool_context, enabled_config, sample_call_session):
    ...
    @pytest.mark.asyncio
    async def test_missing_caller_email_parameter(self, transcript_tool, tool_context, enabled_config):
        """Test handling when caller_email parameter is missing."""

        result = await transcript_tool.execute(
            parameters={},
            context=tool_context,  # No caller_email
        )

        assert result["status"] == "error"

    @pytest.mark.asyncio
    async def test_whitespace_only_email(self, transcript_tool, tool_context, enabled_config):
    ...
    @pytest.mark.asyncio
    async def test_complete_workflow(self, transcript_tool, tool_context, enabled_config, sample_call_session):
