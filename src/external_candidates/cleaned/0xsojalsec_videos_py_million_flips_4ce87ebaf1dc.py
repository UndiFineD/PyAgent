# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\chapter1.py\million_flips_4ce87ebaf1dc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\million_flips.py
...
class MillionFlips(Scene):
    def construct(self):
        ...
        coins = VGroup(*[FlatHeads() if random.random() < 0.5 else FlatTails() for x in range(100)])
        ...
        self.play(
            ...
            hundred_boxes.set_stroke,
            {"width": 0},
            hundred_boxes.replace,
            ten_k_boxes[0],
        )
