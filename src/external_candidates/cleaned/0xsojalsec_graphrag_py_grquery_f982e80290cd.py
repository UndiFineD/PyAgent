# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graphrag.py\core.py\query.py\grquery_f982e80290cd.py
...
class GRQuery(BaseQuery):
    ...
    async def retrieval_via_pcst(
        ...
        if topk_e > 0:
            ...
            retrieve_relations, topk_e_values = await self._retriever.retrieve_relevant_content(
