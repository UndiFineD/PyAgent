# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\storages.py\schema_fb16bd0383d6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\storages\schema.py
...
class IndexStore(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(
        ...
        description="Additional metadata, e.g., vector store collection name",
    )
