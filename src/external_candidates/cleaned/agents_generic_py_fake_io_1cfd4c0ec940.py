# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\fake_io_1cfd4c0ec940.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\fake_io.py
...
class FakeAudioOutput(AudioOutput):
    def __init__(
        ...
        *,
        ...
        super().__init__(label="FakeIO", next_in_chain=next_in_chain, sample_rate=sample_rate)
