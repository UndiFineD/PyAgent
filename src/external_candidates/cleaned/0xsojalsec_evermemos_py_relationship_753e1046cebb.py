...
class Relationship(DocumentBase, AuditBase):
    ...
    source_entity_id: Indexed(str) = Field(..., description="Source entity ID, part of composite primary key")

    target_entity_id: Indexed(str) = Field(..., description="Target entity ID, part of composite primary key")
