# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\test_spark_sql_source_5b15097c8e4f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_spark_sql_source.py
    ...
    if client.spark_runtime == "databricks":
        ...
        output_path = "".join(
            ...
            [
                ...
                "dbfs:/feathrazure_cijob_materialize_offline_sparksql",
...
def _spark_sql_test_setup(config_path: str, sql_source: SparkSqlSource):
    ...
    agg_anchor = FeatureAnchor(
        ...
        name="aggregationFeatures", source=sql_source, features=agg_features
