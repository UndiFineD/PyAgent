# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Joomla.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import re
...
class Joomla:
    ...
    def check(self):
        ...
        if 'form action="/administrator/index.php"' in r.text:
            ...
            logger.info("Joomla administration page detected: {}".format(self.interface_url))
