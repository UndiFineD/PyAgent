# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Coldfusion.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import hashlib
import hmac
...
class Coldfusion:
    ...
    def check(self):
        ...
        if r.status_code == 200 and 'type="password"' in r.text.lower():
            ...
            # Version 6
            if (
                'name="cfadminPassword"' in r.text
                ...
                logger.info("Coldfusion 6 administration console detected: {}".format(self.interface_url))
                return True
            ...
            # Versions 7/8/9
                ...
                logger.info("Coldfusion 7/8/9 administration console detected: {}".format(self.interface_url))
                return True
            ...
            # Versions 10/11
                ...
                logger.info("Coldfusion 10/11 administration console detected: {}".format(self.interface_url))
                return True
        ...
        if r.status_code == 200 and 'type="password"' in r.text.lower():
            ...
            # Version 5
            if 'name="PasswordProvided_required"' in r.text and 'name="PasswordProvided"' in r.text:
                self.interface = "coldfusion-5-admin"
                logger.info("Coldfusion 5 administration console detected: {}".format(self.interface_url))
                return True
