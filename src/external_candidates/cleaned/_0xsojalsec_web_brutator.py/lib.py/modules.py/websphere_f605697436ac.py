# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\modules\Websphere.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import re
...
class Websphere:
    ...
    def check(self):
        ...
        if 'name="j_password"' in r.text:
            ...
            logger.info("Websphere administration console detected: {}".format(self.interface_url))
            return True
