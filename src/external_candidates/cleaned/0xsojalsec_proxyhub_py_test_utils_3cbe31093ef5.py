# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_proxyhub.py\tests.py\test_utils_3cbe31093ef5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-proxyhub\tests\test_utils.py
