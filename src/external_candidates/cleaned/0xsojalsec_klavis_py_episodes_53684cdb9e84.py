# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\mcp_servers.py\spotify.py\tools.py\episodes_53684cdb9e84.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\spotify\tools\episodes.py
...
def get_episodes_info(episode_ids: List[str], sp: Spotify = None, market: str = None) -> List[Dict]:
    """
...
def save_episodes_for_current_user(episode_ids: List[str], sp: Spotify = None) -> str:
    """
...
def get_user_saved_episodes(sp: Spotify = None, limit: int = 20, offset: int = 0) -> List[Dict]:
    """
...
def remove_episodes_for_current_user(episode_ids: List[str], sp: Spotify = None) -> str:
    """
...
def check_user_saved_episodes(episode_ids: List[str], sp: Spotify = None) -> List[bool] | dict:
    """
