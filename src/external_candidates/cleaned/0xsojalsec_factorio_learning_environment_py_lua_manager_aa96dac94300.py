# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\lua_manager_aa96dac94300.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\lua_manager.py
...
class LuaScriptManager:
    ...
    def load_tool_into_game(self, name):
        ...
        tool_scripts = [key for key in self.tool_scripts.keys() if os.path.dirname(key) in tool_dirs]
    ...
    def get_tools_to_load(self):
        ...
        for lua_file in lua_files:
            ...
            if self.cache_scripts:
                ...
                if script_key not in self.game_checksums or self.game_checksums[script_key] != checksum:
    ...
    def get_libs_to_load(self):
        ...
        for filename in _get_lib_names():
            ...
            if self.cache_scripts:
                ...
                if name not in self.game_checksums or self.game_checksums[name] != checksum:
    ...
    def setup_tools(self, instance):
        ...
        def create_hook_wrapper(tool_name, original_callable):
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    self.execute_pre_tool_hooks(instance, tool_name, original_callable, *args, **kwargs)
                ...
                try:
                    self.execute_post_tool_hooks(instance, tool_name, original_callable, result)
