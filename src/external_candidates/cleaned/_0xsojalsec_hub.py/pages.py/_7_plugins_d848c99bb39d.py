...
if check_password():
    ...
    # File uploader
    image = st.file_uploader("Upload an image", type=["jpg", "jpeg", "png"], key="plugin_image")
    ...
    def get_plugin_params(selected_plugin):
        ...
        # Add plugin-specific parameters
            ...
            col1, col2 = st.columns(2)
            with col1:
                plugin_kwargs["debug"] = st.checkbox("Enable Debug Mode", help="Save intermediate detection results")
            with col2:
