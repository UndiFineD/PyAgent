# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_market_claude_code_skills.py\transcript_fixer.py\scripts.py\utils.py\diff_formats.py\markdown_format_0a8749c0f5f9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\diff_formats\markdown_format.py
