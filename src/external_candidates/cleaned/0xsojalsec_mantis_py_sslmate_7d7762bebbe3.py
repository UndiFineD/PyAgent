# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mantis.py\mantis.py\modules.py\discovery.py\sslmate_7d7762bebbe3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mantis\mantis\modules\discovery\SSLMate.py

from mantis.constants import ASSET_TYPE_CERT, ASSET_TYPE_TLD
