# Extracted from: C:\DEV\PyAgent\.external\agentkit\backend\app\app\services\chat_agent\tools\ExtendedBaseTool.py
# -*- coding: utf-8 -*-
        ...
        **kwargs: Any,
        ...
        return cls(
            ...
            image_description_prompt=(
                config.image_description_prompt.format(**{e.name: e.content for e in config.prompt_inputs})
            ...
            system_context_refinement=(
                config.system_context_refinement.format(**{e.name: e.content for e in config.prompt_inputs})
