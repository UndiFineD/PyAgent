# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\sequential_workflow_48e0f1e76dee.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\sequential_workflow.py
            ...
            "outputs": [
                {
                    ...
                    "type": "str",
                    "required": True,
                    "description": "Detailed plan with steps, components, and architecture",
                }
            ],
        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "type": "str",
                    "required": True,
                    "description": "Detailed implementation plan from the Planning phase",
                },
            ],
            "outputs": [
                {
                    ...
                    "type": "str",
                    "required": True,
                    "description": "Implemented code with explanations",
                }
            ],
