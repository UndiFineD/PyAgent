# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\models.py\zhipuai_model_d962d0372cee.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\zhipuai_model.py
...
class ZhipuAIModel(BaseModelBackend):
    ...
    def __init__(
        ...
        url = url or os.environ.get("ZHIPUAI_API_BASE_URL", "https://open.bigmodel.cn/api/paas/v4/")
