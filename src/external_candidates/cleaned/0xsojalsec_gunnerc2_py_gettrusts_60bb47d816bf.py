# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\gettrusts_60bb47d816bf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\gettrusts.py
...
class GetTrustsCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="name",
            required=False,
            help="Name of a single trust to dump properties for",
        )
