# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\plan.py\planner.py\planning_planner.py\planning_planner_c823bfdf797b.py
