# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\decodingai_magazine_second_brain_ai_assistant_course.py\apps.py\second_brain_offline.py\tools.py\use_s3_fb72538e064d.py
...
def upload(local_path: str, bucket_name: str, s3_prefix: str) -> None:
    ...
    try:
        ...
        click.echo(f"Successfully uploaded '{local_path}' to 's3://{bucket_name}/{s3_prefix}'")
...
def download(bucket_name: str, s3_path: str, local_path: str, no_sign_request: bool) -> None:
    ...
    try:
        ...
        click.echo(f"Successfully downloaded 's3://{bucket_name}/{s3_path}' to '{local_path}'")
