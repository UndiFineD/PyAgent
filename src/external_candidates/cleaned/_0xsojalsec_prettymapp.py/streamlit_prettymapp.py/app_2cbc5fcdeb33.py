# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-prettymapp\streamlit-prettymapp\app.py
import copy
import json
...
st.set_page_config(page_title="prettymapp", page_icon="🖼️", initial_sidebar_state="collapsed")
...
st.markdown("More infos and :star: at [github.com/chrieke/prettymapp](https://github.com/chrieke/prettymapp)")
