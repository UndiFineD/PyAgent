# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\oxm.py\es.py\base_converter_f25b5f28c469.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\oxm\es\base_converter.py
...
class BaseEsConverter(ABC, Generic[EsDocType]):
    ...
    def get_es_model(cls) -> Type[EsDocType]:
        ...
        raise ValueError(f"Cannot obtain ES document type from generic information of {cls.__name__}")
