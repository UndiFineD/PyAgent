# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graphrag.py\core.py\index.py\colbertindex_95ea16056f31.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Index\ColBertIndex.py
...
from Core.Index.BaseIndex import BaseIndex, ColbertEdgeResult, ColbertNodeResult
