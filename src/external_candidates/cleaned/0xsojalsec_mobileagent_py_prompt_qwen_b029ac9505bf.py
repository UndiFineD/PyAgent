# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\pc_agent.py\pcagent.py\prompt_qwen_b029ac9505bf.py
...
def get_action_prompt(
    ...
    prompt += (
        "Open App (app name): If you want to open an app, you should use this action to open the app named 'app name'."
    )

    prompt += (
        "Right Tap (x, y): Right tap the position (x, y) in current page. This can be used to create a new file.\n"
    )
