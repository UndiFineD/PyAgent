# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\scripts\sqa_acc_speech.py
import argparse
import json
...
def main():
    ...
    with open(args.file, "r", encoding="utf-8") as f:
        for line in f:
            ...
            answer_list = (
                answer_list + [x.lower() for x in answer_list] + [english_normalizer(x.lower()) for x in answer_list]
            )
