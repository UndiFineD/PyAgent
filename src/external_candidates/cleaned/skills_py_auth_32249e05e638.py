# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ruslanlanket.py\pinterest_pub.py\scripts.py\auth_32249e05e638.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ruslanlanket\pinterest-pub\scripts\auth.py
...
class OAuthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if "code" in params:
            ...
            self.wfile.write(
                "Авторизация прошла успешно! Вы можете закрыть это окно и вернуться в терминал.".encode("utf-8")
            )
