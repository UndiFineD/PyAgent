...
class TestTransferToQueueTool:
    ...
    async def test_transfer_to_sales_queue(
        ...
        result = await queue_tool.execute(
            ...
            parameters={"queue": "sales"}, context=tool_context
    ...
    async def test_transfer_to_support_queue(
        ...
        result = await queue_tool.execute(
            ...
            parameters={"queue": "support"}, context=tool_context
    ...
    async def test_transfer_to_billing_queue(
        ...
        result = await queue_tool.execute(
            ...
            parameters={"queue": "billing"}, context=tool_context
    ...
    async def test_queue_name_case_insensitive(
        ...
        for queue_name in ["Sales", "SALES", "sAlEs"]:
            ...
            result = await queue_tool.execute(
                ...
                parameters={"queue": queue_name}, context=tool_context
    ...
    async def test_invalid_queue_name(
        ...
        result = await queue_tool.execute(
            ...
            parameters={"queue": "nonexistent"}, context=tool_context
    ...
    async def test_tool_not_configured(self, queue_tool, tool_context, mock_ari_client):
        ...
        if tool_context.config and "transfer_to_queue" in tool_context.config.get(
    ...
    def test_format_queue_message_basic(self, queue_tool):
        ...
        message = queue_tool._format_queue_message(
            ...
            description="Sales team", queue_status={}, max_wait_time=300
