# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\messaging.py\renderers_f03202b82dd0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\messaging\renderers.py
...
class InteractiveRenderer(MessageRenderer):
    ...
    async def render_message(self, message: UIMessage):
        ...
        if isinstance(message.content, str):
            if "Current version:" in message.content or "Latest version:" in message.content:
                style = "dim"
