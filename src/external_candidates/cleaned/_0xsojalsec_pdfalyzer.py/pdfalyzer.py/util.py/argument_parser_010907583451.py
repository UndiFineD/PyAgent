...
combine_pdfs_parser.add_argument("pdfs", help="two or more PDFs to combine", metavar="PDF_PATH", nargs="+")
...
combine_pdfs_parser.add_argument("-o", "--output-file", help="path to write the combined PDFs to", required=True)
