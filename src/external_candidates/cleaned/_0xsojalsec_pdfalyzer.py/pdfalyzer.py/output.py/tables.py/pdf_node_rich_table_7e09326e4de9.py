# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\output\tables\pdf_node_rich_table.py
"""
...
def build_pdf_node_table(node: "PdfTreeNode") -> Table:
    ...
    if node.label != node.known_to_parent_as:
        table.add_row(
            Text("AddressInParent", style="grey"),
            Text(str(node.known_to_parent_as), style="grey"),
            "",
        )
