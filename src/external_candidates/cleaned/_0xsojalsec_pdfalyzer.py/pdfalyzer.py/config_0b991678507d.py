# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdfalyzer\pdfalyzer\config.py
"""
...
from yaralyzer.config import (
    YaralyzerConfig,
    is_env_var_set_and_not_false,
    is_invoked_by_pytest,
)
