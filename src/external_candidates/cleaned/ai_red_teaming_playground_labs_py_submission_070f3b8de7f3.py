# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_red_teaming_playground_labs.py\src.py\picture_submission.py\webapi.py\server.py\models.py\submission_070f3b8de7f3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\src\picture-submission\webapi\server\models\submission.py
...
class SubmissionStatus(DataClassJsonMixin):
    ...
    def to_response(self):
        ...
        return SubmissionStatusResponse(
            ...
            self.picture_id, self.status, self.scoring_result
...
class SubmissionModel:
    ...
    def set_submission(self, user_id: str, status: SubmissionStatus):
        ...
        if status.status == ReviewStatus.REVIEWED:
            ...
            blob_client = self.__blob_service_client.get_blob_client(
                ...
                self.__container_name, self.__blob_key(user_id)
    ...
    def set_picture(self, user_id: str, picture: bytes, mime: str):
        ...
        blob_client.upload_blob(
            ...
            metadata={"challenge_id": str(self.__challenge_id)},
