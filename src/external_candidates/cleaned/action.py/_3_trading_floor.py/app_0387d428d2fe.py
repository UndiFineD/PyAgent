# Extracted from: C:\DEV\PyAgent\.external\action\3_trading_floor\app.py
import gradio as gr
import pandas as pd
...
class Trader:
    ...
    def get_holdings_df(self) -> pd.DataFrame:
        ...
        df = pd.DataFrame([{"Symbol": symbol, "Quantity": quantity} for symbol, quantity in reversed(holdings.items())])
        return df
