# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\authorize.py\decorators_897a99b1c03d.py
    ...
    **kwargs,
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            return await _execute_with_authorization(func, auth_context, *args, **kwargs)
...
async def _execute_with_authorization(func: Callable, auth_context: AuthorizationContext, *args, **kwargs) -> Any:
    """
    ...
    logger.debug("Authorization passed: user=%s, role=%s", user_info, auth_context.required_role)

    return await func(*args, **kwargs)


def _execute_with_authorization_sync(func: Callable, auth_context: AuthorizationContext, *args, **kwargs) -> Any:
    """
