# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VolWeb\windows_engine\models.py
import base64
import logging
...
class Info(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_info_evidence")
...
class PsTree(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_pstree_evidence")
    artefacts = models.JSONField(null=True)
...
class DeviceTree(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_devicetree_evidence")
    artefacts = models.JSONField(null=True)
...
class NetGraph(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_netgraph_evidence")
    artefacts = models.JSONField(null=True)


class TimeLineChart(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_timeline_evidence")
    artefacts = models.JSONField(null=True)


class PsScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_psscan_evidence")
    artefacts = models.JSONField(null=True)
...
class CmdLine(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_cmdline_evidence")
    artefacts = models.JSONField(null=True)
...
class Privs(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_privs_evidence")
    artefacts = models.JSONField(null=True)
...
class Sessions(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_sessions_evidence")
    artefacts = models.JSONField(null=True)
...
class GetSIDs(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_getsids_evidence")
    artefacts = models.JSONField(null=True)
...
class LdrModules(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_ldrmodules_evidence")
    artefacts = models.JSONField(null=True)
...
class Modules(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_modules_evidence")
    artefacts = models.JSONField(null=True)
...
class SvcScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_svcscan_evidence")
    artefacts = models.JSONField(null=True)
...
class Envars(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_envars_evidence")
    artefacts = models.JSONField(null=True)
...
class NetScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_netscan_evidence")
    artefacts = models.JSONField(null=True)
...
class NetStat(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_netstat_evidence")
    artefacts = models.JSONField(null=True)
...
class Hashdump(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_hashdump_evidence")
    artefacts = models.JSONField(null=True)
...
class Lsadump(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_lsadump_evidence")
    artefacts = models.JSONField(null=True)
...
class Cachedump(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_cachedump_evidence")
...
class HiveList(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_hivelist_evidence")
    artefacts = models.JSONField(null=True)
...
class Timeliner(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_timeliner_evidence")
...
class SkeletonKeyCheck(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_skc_evidence")
...
class Malfind(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_malfind_evidence")
...
class UserAssist(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_userassist_evidence")
...
class MFTScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_mftscan_evidence")
...
class ADS(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_ads_evidence")
...
class MBRScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_mbrscan_evidence")
...
class FileScan(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_filescan_evidence")
...
class DllList(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_dllist_evidence")
...
class Handles(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_handles_evidence")
...
class DriverModule(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_drivermodule_evidence")
...
class VadWalk(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_vadwalk_evidence")
...
class SSDT(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_ssdt_evidence")
...
class Loot(models.Model):
    evidence = models.ForeignKey(Evidence, on_delete=models.CASCADE, related_name="windows_loot")
