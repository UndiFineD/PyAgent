# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentkit.py\backend.py\app.py\app.py\services.py\chat_agent.py\tools.py\library.py\chain_tool.py\nested_meta_agent_tool_fe09374ddb7e.py
