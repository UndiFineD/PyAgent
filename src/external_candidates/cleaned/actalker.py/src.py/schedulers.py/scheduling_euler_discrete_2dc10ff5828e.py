# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\schedulers\scheduling_euler_discrete.py
...
class EulerDiscreteScheduler(DiffusersEulerDiscreteScheduler):
    ...
    def step(
        ...
        if noise_type == "random":
            ...
            noise = video_fusion_noise(model_output, w_ind_noise=w_ind_noise, generator=generator)
