# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\models\base\unet_spatio_temporal_condition_mambaID_exp.py
import os
...
from .TransformerSTmodel import (
    TransformerSpatioTemporalModel_mambaID as TransformerSpatioTemporalModel,
)
...
class UNetSpatioTemporalConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if isinstance(encoder_hidden_states, tuple):
            ...
            encoder_hidden_states, ip_hidden_states, expr_hidden_states = encoder_hidden_states
...
def add_ip_adapters(
    ...
    adapter_modules = torch.nn.ModuleList(
        [
            ...
            if isinstance(m, IPAdapterAttnProcessor) or isinstance(m, IPAdapterAttnProcessor2_0)
        ]
    )
