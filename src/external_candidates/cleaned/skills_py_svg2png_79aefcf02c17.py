# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\gumadeiras.py\office_quotes.py\scripts.py\svg2png_79aefcf02c17.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\gumadeiras\office-quotes\scripts\svg2png.py
