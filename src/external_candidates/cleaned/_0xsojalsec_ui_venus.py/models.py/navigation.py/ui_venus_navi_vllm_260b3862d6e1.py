...
class NaviVLLM:
    ...
    def _prepare_llm_inputs(self, messages_list: List[List[Dict]]) -> List[Dict]:
        ...
        """
        prompts = [
            self.processor.apply_chat_template(msg, tokenize=False, add_generation_prompt=True) for msg in messages_list
        ]
        ...
        for image_input, text in zip(image_inputs, prompts):
            ...
            llm_inputs.append({"prompt": text, "multi_modal_data": mm_data})
