...
class VenusNaviAgent:
    def __init__(self, model_config, logger: logging.Logger, history_length: int = 0) -> None:
    ...
    def export_history(self, include_screenshot=False):
        serialized_history = [step.to_dict(include_screenshot=include_screenshot) for step in self.history]
