# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\llm.py\llm_adapter.py\gemini_client_9b0f1c2d0e14.py
...
class GeminiClient:
    ...
    def __init__(self, config_provider: ConfigProvider):
        ...
        self._llm_config: Dict[str, Any] = self.config_provider.get_config("llm_backends")
        ...
        self.default_model = self._config.get("default_model") or self._config.get("model", "gemini-2.5-flash")
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt == self.max_retries - 1:
                    raise RuntimeError(f"An unexpected error occurred in GeminiClient: {e}") from e
    ...
    def _convert_messages_to_gemini_format(
        ...
        for msg in messages:
            ...
            if isinstance(msg, dict):
                ...
                contents.append(ContentDict(role=gemini_role, parts=[{"text": str(content)}]))
