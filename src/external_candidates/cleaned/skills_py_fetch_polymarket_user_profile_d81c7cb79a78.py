# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hiehoo.py\polymarket_analysis.py\scripts.py\fetch_polymarket_user_profile_d81c7cb79a78.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hiehoo\polymarket-analysis\scripts\fetch-polymarket-user-profile.py
