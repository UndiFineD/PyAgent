# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\am_will.py\get_you_some_britches.py\scripts.py\size_converter_1bce9e7da171.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\am-will\get-you-some-britches\scripts\size_converter.py
...
def main():
    ...
    parser.add_argument("--to", choices=["eu", "us", "uk"], required=True, help="Target sizing system")
    ...
    if args.from_system == "us" and args.to == "eu":
        ...
        print(
            f"Error: Conversion from {args.from_system} to {args.to} not fully supported",
            file=sys.stderr,
        )
