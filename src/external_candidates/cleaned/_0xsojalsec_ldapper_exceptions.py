# Extracted from: C:\DEV\PyAgent\src\external_candidates\auto\0xSojalSec_ldapper_exceptions.py
# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ldapper\ldapper\exceptions.py
...
class DuplicateValue(LdapperError):
    ...
    def __init__(self, attr, value):
        ...
        self.msg = 'Attribute "%s" has duplicate value(s): %s' % (attr, self.offending_values)
