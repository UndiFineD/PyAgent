# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pytorch_lightning.py\src.py\lightning.py\fabric.py\utilities.py\logger_afb6c87a13f9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\src\lightning\fabric\utilities\logger.py
    ...
    for k, v in params.items():
        ...
        # Also handle the case where v is a list of dictionaries
            ...
            for i, item in enumerate(v):
                result = {
                    **result,
                    **_flatten_dict(item, parent_key=f"{new_key}/{i}", delimiter=delimiter),
                }
