# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\android_action_kernel.py\config_9f98c324aa2a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\android-action-kernel\config.py
