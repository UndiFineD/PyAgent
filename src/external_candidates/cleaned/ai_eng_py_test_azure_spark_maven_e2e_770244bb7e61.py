# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\test_azure_spark_maven_e2e_770244bb7e61.py
...
def test_feathr_online_store_agg_features():
    ...
    client: FeathrClient = basic_test_setup(
        ...
        os.path.join(test_workspace_dir, "feathr_config_maven.yaml")
