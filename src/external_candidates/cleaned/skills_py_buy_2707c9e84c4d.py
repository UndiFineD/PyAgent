# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\purch_agent.py\agentic_commerce.py\scripts.py\buy_2707c9e84c4d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\purch-agent\agentic-commerce\scripts\buy.py
...
def main():
    ...
    parser.add_argument(
        "--address",
        required=True,
        help="Shipping address: Name,Line1,City,State,PostalCode,Country[,Line2][,Phone]",
    )
