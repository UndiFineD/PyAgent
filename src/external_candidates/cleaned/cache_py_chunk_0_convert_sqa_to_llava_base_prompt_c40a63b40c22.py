# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\cache.py\work.py\copilot_tmp.py\chunk_0_convert_sqa_to_llava_base_prompt_c40a63b40c22.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\cache\work\copilot_tmp\chunk_0_convert_sqa_to_llava_base_prompt.py

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\scripts\archived\convert_sqa_to_llava_base_prompt.py
...
def create_one_example_chatbot(
