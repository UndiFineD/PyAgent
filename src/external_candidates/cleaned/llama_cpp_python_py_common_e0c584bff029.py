# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llama_cpp_python.py\examples.py\low_level_api.py\common_e0c584bff029.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\llama-cpp-python\examples\low_level_api\common.py
