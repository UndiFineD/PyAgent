# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_volweb.py\windows_engine.py\tasks_cdfc4cee7999.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VolWeb\windows_engine\tasks.py
...
from windows_engine.models import FileScan, Handles, Loot, PsTree
