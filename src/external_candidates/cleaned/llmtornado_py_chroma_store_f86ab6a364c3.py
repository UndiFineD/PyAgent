# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llmtornado.py\src.py\llmtornado.py\llmtornado.py\fskb.py\storage.py\chroma_store_f86ab6a364c3.py
