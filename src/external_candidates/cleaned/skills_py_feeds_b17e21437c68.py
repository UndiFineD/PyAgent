...
from lists import FINANCE_FEEDS, GAMES_FEEDS, NEWS_FEEDS
...
def main():
    ...
    if not entries:
        print(
            json.dumps({"error": "No entries found", "category": args.category}),
            flush=True,
        )
