# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dennis_da_menace.py\agent_memory.py\cli.py\entity_132d34d0e806.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dennis-da-menace\agent-memory\cli\entity.py
