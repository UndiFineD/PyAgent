# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_navigator.py\src.py\agent.py\web.py\browser.py\init_502b7c4c04fc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Web-Navigator\src\agent\web\browser\__init__.py

from playwright.async_api import Browser as PlaywrightBrowser

from playwright.async_api import Playwright, async_playwright

from src.agent.web.browser.config import (
    BROWSER_ARGS,
    IGNORE_DEFAULT_ARGS,
    SECURITY_ARGS,
    BrowserConfig,
