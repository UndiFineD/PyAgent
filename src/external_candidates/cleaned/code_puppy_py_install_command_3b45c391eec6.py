# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\command_line.py\mcp.py\install_command_3b45c391eec6.py
...
class InstallCommand(MCPCommandBase):
    ...
    def _install_from_catalog(self, server_name_or_id: str, group_id: str) -> bool:
        ...
        try:
            ...
            return install_server_from_catalog(self.manager, selected_server, server_name, env_vars, cmd_args, group_id)
