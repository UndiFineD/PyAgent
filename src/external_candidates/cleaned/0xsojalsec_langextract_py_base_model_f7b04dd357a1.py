# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\langextract.py\core.py\base_model_f7b04dd357a1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\langextract\core\base_model.py
...
class BaseLanguageModel(abc.ABC):
    ...
    @abc.abstractmethod
    def infer(self, batch_prompts: Sequence[str], **kwargs) -> Iterator[Sequence[types.ScoredOutput]]:
    ...
    def parse_output(self, output: str) -> Any:
        ...
        try:
            ...
            raise ValueError(f"Failed to parse output as {format_type.name}: {str(e)}") from e
