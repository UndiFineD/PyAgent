# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\memory_layer.py\prompts.py\en.py\foresight_prompts_2b0e63f223d4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\prompts\en\foresight_prompts.py
...
def get_group_foresight_generation_prompt(memcell_summary: str, memcell_episode: str, user_ids: list = None) -> str:
    """
...
def get_foresight_generation_prompt(episode_memory: str, episode_content: str, user_id: str = None) -> str:
    """
