# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\fc1_427413738856.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\fc1.py
...
class CrossingOneMillion(TeacherStudentsScene):
    ...
    def increment_count(self):
        ...
        confetti_spirils = self.confetti_spirils = list(map(turn_animation_into_updater, get_confetti_animations(50)))
    ...
    def comment_on_real_milestone(self):
        ...
        self.student_says(
            ...
            added_anims=[
                ...
                self.change_students("sassy", "speaking", "happy"),
                number.scale,
                0.5,
                number.center,
                number.to_edge,
        ...
        self.play(
            ...
            "pondering",
            number,
            self.change_students(*["pondering"] * 3, look_at=number),
        )
    ...
    def reflect(self):
        ...
        self.play(
            ShowCreation(bubble, rate_func=squish_rate_func(smooth, 0, 0.3)),
            Write(q_marks),
            GrowArrow(arrow),
            MoveToTarget(number),
            run_time=3,
...
class ShareWithFriends(PiCreatureScene):
    def construct(self):
        ...
        self.pi_creature_says(
            randy,
            "Wanna see why \\\\" + "$1 - \\frac{1}{3} + \\frac{1}{5}" + "- \\frac{1}{7} + \\cdots = \\frac{\\pi}{4}$?",
            target_mode="tease",
...
class AllFeaturedCreators(MortyPiCreatureScene):
    def construct(self):
        ...
        self.play(LaggedStartMap(FadeIn, rects, lag_ratio=0.7), morty.change, "happy")
