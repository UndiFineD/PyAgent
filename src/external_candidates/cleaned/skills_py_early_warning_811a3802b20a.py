# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\oura_analytics.py\scripts.py\early_warning_811a3802b20a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\oura-analytics\scripts\early_warning.py
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="Temperature deviation threshold (°C)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Signals required to trigger alarm",
    )
