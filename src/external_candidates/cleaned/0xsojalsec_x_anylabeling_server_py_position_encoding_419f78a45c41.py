# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_x_anylabeling_server.py\app.py\models.py\sam2.py\modeling.py\position_encoding_419f78a45c41.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-X-AnyLabeling-Server\app\models\sam2\modeling\position_encoding.py
