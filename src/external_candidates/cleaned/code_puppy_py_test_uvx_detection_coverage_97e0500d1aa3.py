# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_uvx_detection_coverage_97e0500d1aa3.py
...
class TestGetParentProcessChainWindowsCtypesCoverage:
    ...
    def test_windows_ctypes_handles_exception(self, mock_platform):
        ...
        mock_ctypes.windll.kernel32.CreateToolhelp32Snapshot.side_effect = Exception("Ctypes error")
