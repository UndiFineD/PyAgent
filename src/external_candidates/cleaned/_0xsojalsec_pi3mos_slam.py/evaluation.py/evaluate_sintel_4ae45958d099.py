...
def evaluate_sintel(
    ...
    for scene in scenes:
        ...
        est_cam2w[:, :3, 3] = (scale * rot * est_cam2w[:, :3, 3].transpose(1, 0) + trans).transpose(1, 0)
        ...
        rpe_result = evaluate_trajectory(traj_gt_dict, traj_est_dict, param_fixed_delta=True, param_delta=1)
