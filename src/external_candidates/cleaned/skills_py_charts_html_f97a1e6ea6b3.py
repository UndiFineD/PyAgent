# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\src.py\ouracli.py\charts_html_f97a1e6ea6b3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\src\ouracli\charts_html.py

"""Chart.js configuration generation for HTML output."""

import json

from ouracli.chart_utils import (
    bucket_regular_data,
    bucket_timeseries_data,
    create_hour_labels,
)
...
def create_chartjs_heartrate_config(heartrate_data: list[dict], chart_id: str) -> str:
    ...
    bucket_averages = bucket_timeseries_data(heartrate_data, "timestamp", "bpm", bucket_minutes=5, buckets_per_day=288)
