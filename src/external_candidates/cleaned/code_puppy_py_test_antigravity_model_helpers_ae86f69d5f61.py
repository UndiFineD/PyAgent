# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_antigravity_model_helpers_ae86f69d5f61.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_model_helpers.py
...
class TestAntigravityContentModelResponse:
    ...
    def test_file_part_serialization(self) -> None:
        ...
        model_response = ModelResponse(parts=[FilePart(content=(image_data, "image/jpeg", "image.jpg", "inline"))])
