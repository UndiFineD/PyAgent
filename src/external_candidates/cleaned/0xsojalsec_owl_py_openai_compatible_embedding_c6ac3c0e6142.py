# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\embeddings.py\openai_compatible_embedding_c6ac3c0e6142.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\embeddings\openai_compatible_embedding.py
...
class OpenAICompatibleEmbedding(BaseEmbedding[str]):
    ...
    def get_output_dim(self) -> int:
        ...
        if self.output_dim is None:
            raise ValueError("Output dimension is not yet determined. Call 'embed_list' first.")
