# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\search_serperapi_b63e95331d4b.py
...
class SearchSerperAPI(SearchBase):
    ...
    def search(
        ...
        try:
            logger.info(
                f"Searching SerperAPI: {query}, num_results={num_search_pages}, max_content_words={max_content_words}"
            )
