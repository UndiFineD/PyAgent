# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\test_pipeline_deepgram_adapters_988002d4c8cc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\test_pipeline_deepgram_adapters.py
...
async def test_deepgram_stt_adapter_transcribes(monkeypatch):
    ...
    adapter = DeepgramSTTAdapter(
        ...
        "deepgram_stt", app_config, provider_config, {"language": "en-US"}
