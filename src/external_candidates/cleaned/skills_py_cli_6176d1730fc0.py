...
def get_output_format(
    ...
    if len(active_flags) > 1:
        raise typer.BadParameter(
            "Only one format flag can be specified at a time: --json, --tree, --markdown, --dataframe, or --html"
        )
...
def activity(
    ...
    output_format = get_output_format(json_flag, tree_flag, markdown_flag, dataframe_flag, html_flag)
