# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chengjiaxiongkf.py\aliyun_oss_upload.py\scripts.py\oss_upload_a971346d1d19.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chengjiaxiongkf\aliyun-oss-upload\scripts\oss-upload.py
