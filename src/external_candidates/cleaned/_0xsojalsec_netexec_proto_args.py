# Extracted from: C:\DEV\PyAgent\src\external_candidates\auto\0xSojalSec_NetExec_proto_args.py
...
def proto_args(parser, parents):
    ...
    wmi_parser.add_argument(
        "--rpc-timeout", help="RPC/DCOM(WMI) connection timeout, default is %(default)s seconds", type=int, default=2
    )
    # For domain options
