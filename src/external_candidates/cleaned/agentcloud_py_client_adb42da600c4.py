# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentcloud.py\agent_backend.py\src.py\messaging.py\client_adb42da600c4.py
...
async def consume_tasks():
    ...
    try:
        ...
        Worker("task_queue", process, {"connection": f"redis://{REDIS_HOST}:{REDIS_PORT}"})
