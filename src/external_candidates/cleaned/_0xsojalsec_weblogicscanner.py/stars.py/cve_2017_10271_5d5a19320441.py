# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-weblogicScanner\stars\cve_2017_10271.py
#!/usr/bin/env python3
...
headers = {"Content-Type": "text/xml;charset=UTF-8", "User-Agent": "TestUA/1.0"}


# @universe.groups()
class CVE_2017_10271(Star):
    info = {"NAME": "", "CVE": "CVE-2017-10271", "TAG": []}
