# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-weblogicScanner\stars\cve_2020_14883.py
#!/usr/bin/env python3
...
class CVE_2020_14883(Star):
    info = {"NAME": "webLogic rce", "CVE": "CVE-2020-14883", "TAG": []}
    ...
    def light_up(self, dip, dport, force_ssl=None, *args, **kwargs) -> (bool, dict):
        ...
        r, data = http(
            "http://{}:{}/console/framework/skins/wlsconsole/css/test.txt".format(dip, dport),
            ssl=force_ssl,
        )
