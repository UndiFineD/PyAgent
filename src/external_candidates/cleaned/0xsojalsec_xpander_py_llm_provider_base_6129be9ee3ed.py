# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_xpander.py\getting_started.py\hello_world.py\providers.py\llms.py\llm_provider_base_6129be9ee3ed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-xpander.ai\Getting-Started\hello-world\providers\llms\llm_provider_base.py
