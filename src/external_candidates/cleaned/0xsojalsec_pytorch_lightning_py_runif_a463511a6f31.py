# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pytorch_lightning.py\src.py\lightning.py\fabric.py\utilities.py\testing.py\runif_a463511a6f31.py
