# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_red_teaming_playground_labs.py\src.py\challenge_home.py\webapi.py\app_9409b0ba40ea.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\src\challenge-home\webapi\app.py
...
logger.info(
    "You can connect to the app with the url http://localhost:5000/login?auth=%s",
    app.config["AUTH_KEY"],
)
