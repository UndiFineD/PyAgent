# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\mcp.py\test_registry_comprehensive_f99b3cad6f84.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_registry_comprehensive.py
    ...
    def test_concurrent_register(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("code_puppy.mcp_.registry.config.DATA_DIR", tmpdir):
                ...
                threads = [threading.Thread(target=register_server, args=(i,)) for i in range(5)]
