# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\tdd_guide.py\scripts.py\coverage_analyzer_a6282c9afb54.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\tdd-guide\scripts\coverage_analyzer.py
...
class CoverageAnalyzer:
    ...
    def _calculate_priority(self, line_coverage: float, branch_coverage: float, threshold: float) -> str:
