# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hugosbl.py\ai_skill_scanner.py\scripts.py\scan_576d4696423b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hugosbl\ai-skill-scanner\scripts\scan.py
...
def scan_file(filepath: Path, findings: list, errors: list) -> bool:
    ...
    if ext not in SCANNABLE_EXTENSIONS and filepath.name not in (
        ".env",
        "Makefile",
        "Dockerfile",
    ):
