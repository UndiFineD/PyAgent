# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\config.py\test_normalization_b6b00c591057.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\config\test_normalization.py
...
class TestGenerateDefaultPipeline:
    ...
    def test_fills_missing_dict_fields(self):
        ...
        config_data = {
            ...
            "pipelines": {"default": {"stt": "custom_stt"}},
...
class TestNormalizePipelines:
    ...
    def test_dict_entry_with_provider_hint(self):
        ...
        config_data = {
            ...
            "pipelines": {"custom": {"provider": "deepgram", "stt": "custom_stt"}},
    ...
    def test_dict_entry_with_options(self):
        ...
        assert (
            ...
            config_data["pipelines"]["custom"]["options"]["stt"]["model"] == "vosk-en"

        )

        assert (

            config_data["pipelines"]["custom"]["options"]["llm"]["temperature"] == 0.7
    ...
    def test_invalid_options_type_raises_error(self):
        ...
        config_data = {
            ...
            "pipelines": {
                ...
                "custom": {"stt": "vosk_stt", "options": "not_a_dict"}  # Invalid
    ...
    def test_invalid_entry_type_raises_error(self):
        ...
        config_data = {
            ...
            "pipelines": {"custom": 123},  # Invalid type
...
class TestNormalizeProfiles:
    ...
    def test_preserves_existing_profiles(self):
        ...
        config_data = {"profiles": {"custom_profile": {"internal_rate_hz": 16000}}}
    ...
    def test_preserves_existing_default_selector(self):
        ...
        config_data = {"profiles": {"default": "custom_profile"}}
    ...
    def test_preserves_existing_contexts(self):
        ...
        config_data = {"contexts": {"sales": {"greeting": "Sales greeting"}}}
