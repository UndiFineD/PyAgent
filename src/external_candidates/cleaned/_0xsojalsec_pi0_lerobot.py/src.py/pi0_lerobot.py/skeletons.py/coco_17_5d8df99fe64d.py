# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pi0-lerobot\src\pi0_lerobot\skeletons\coco_17.py
...
COCO_ID2NAME: dict[int, str] = {id: kpt_info["name"] for id, kpt_info in coco17["keypoint_info"].items()}
