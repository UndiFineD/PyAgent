# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\src.py\models.py\audio_adapter.py\pose_guider_f351ea71f469.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\models\audio_adapter\pose_guider.py
