# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graphrag.py\core.py\utils.py\tokencounter_f12c471f5fc6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Utils\TokenCounter.py
...
async def get_openrouter_tokens(chunk: ChatCompletionChunk) -> CompletionUsage:
    ...
    usage = CompletionUsage(
        ...
        total_tokens=tokens_prompt + completion_tokens,
    )
