# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_json_agent_extended_204670a99254.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_json_agent_extended.py
...
class TestJsonAgentExtended:
    ...
    def test_validate_invalid_system_prompt_type(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="'system_prompt' must be a string or list"):
            JSONAgent(str(agent_file))
