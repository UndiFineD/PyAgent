# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\abetlen_llama_cpp_python.py\llama_cpp.py\llama_speculative_899c02f83e45.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\abetlen-llama-cpp-python\llama_cpp\llama_speculative.py
