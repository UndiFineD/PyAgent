# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llama_cpp_python.py\examples.py\low_level_api.py\quantize_3b243061ebec.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\llama-cpp-python\examples\low_level_api\quantize.py
