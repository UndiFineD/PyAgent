# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentkit_prompting.py\src.py\agentkit.py\llm_api.py\base_7dd580e13a63.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentkit_prompting\src\agentkit\llm_api\base.py
...
class BaseModel:
    ...
    def __init__(self, model_name, global_conter=None, model_type="chat"):
        ...
        assert model_type in [
            "chat",
            "completion",
        ], "type should be either 'chat' or 'completion'"
    ...
    def query_chat(self, messages, shrink_idx, model, max_gen=1024, temp=0.0):
        raise NotImplementedError

    def query_completion(self, messages, shrink_idx, model, max_gen=1024, temp=0.0):
        raise NotImplementedError
    ...
    def __call__(self, msg, shrink_idx, max_gen=None, temp=0.0):
        if max_gen is None:
