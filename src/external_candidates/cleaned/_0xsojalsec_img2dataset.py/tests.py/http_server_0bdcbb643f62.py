# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-img2dataset\tests\http_server.py
import os
...
app.mount(
    "/disallowed",
    StaticFilesXRobotsTagHeader(directory=test_folder),
    name="static_disallowed",
)
