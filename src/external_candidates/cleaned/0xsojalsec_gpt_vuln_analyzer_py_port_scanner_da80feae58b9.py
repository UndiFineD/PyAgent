# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gpt_vuln_analyzer.py\components.py\port_scanner_da80feae58b9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\components\port_scanner.py
