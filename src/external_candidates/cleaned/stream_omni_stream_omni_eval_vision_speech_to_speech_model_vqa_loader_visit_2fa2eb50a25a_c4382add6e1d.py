...
# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\stream_omni\eval\vision_speech_to_speech\model_vqa_loader_visit.py
import argparse
import json
import math
import os
...
def eval_model(args):
    ...
    for (input_ids, image_tensor, image_sizes), line in tqdm.tqdm(
