# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-introtodeeplearning\xtra_labs\llm_finetune\draft.py
"""
...
from utils import make_spider_plot, run_benchmark
    ...
    for name, child in module.named_children():
        if isinstance(child, nn.Linear):
            setattr(
                module,
                name,
                LoRALinear(child.in_features, child.out_features, child.weight, child.bias),
            )
        else:
