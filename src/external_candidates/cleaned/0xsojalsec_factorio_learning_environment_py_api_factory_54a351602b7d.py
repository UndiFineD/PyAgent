# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\agents.py\llm.py\api_factory_54a351602b7d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\agents\llm\api_factory.py
...
class APIFactory:
    ...
    PROVIDERS = {
        "open-router": {
            ...
            "model_transform": lambda m: (m.replace("open-router-", "") if m.startswith("open-router-") else m),
        },
        "claude": {
    ...
    def __init__(self, model: str, beam: int = 1, api_key_config_file: str = None):
        ...
        self.api_key_config_file = api_key_config_file  # Store for child process reinitialization
