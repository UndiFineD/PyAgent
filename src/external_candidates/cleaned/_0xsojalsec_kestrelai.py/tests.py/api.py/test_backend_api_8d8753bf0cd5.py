# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\tests\api\test_backend_api.py
...
class TestBackendAPI:
    ...
    def test_task_error_handling(self, api_base_url):
        ...
        response = requests.post(f"{api_base_url}/tasks", json=invalid_task_data, timeout=10)
