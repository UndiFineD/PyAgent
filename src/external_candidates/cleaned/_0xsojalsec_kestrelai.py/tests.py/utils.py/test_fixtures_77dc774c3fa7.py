# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\tests\utils\test_fixtures.py
"""
...
class TestDataFactory:
    ...
    @staticmethod
    def create_research_plan(restated_task: str = "Test restated task", subtasks: list | None = None) -> ResearchPlan:
