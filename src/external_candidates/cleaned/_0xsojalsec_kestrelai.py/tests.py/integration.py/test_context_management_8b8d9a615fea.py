# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\tests\integration\test_context_management.py
"""
...
class TestContextManagementIntegration:
    ...
    def token_counter(self):
        ...
        with patch("tiktoken.get_encoding") as mock_get_encoding:
            ...
            counter.truncate_to_tokens = Mock(side_effect=lambda x, max_t: " ".join(str(x).split()[:max_t]) + "...")
            return counter
    ...
    def test_full_context_building_flow(self, context_manager, token_counter, token_budget):
    ...
    def test_context_with_summarization(self, context_manager, summarizer, token_counter):
    ...
    def test_adaptive_retrieval_integration(self, summarizer, context_manager, token_counter):
    ...
    def test_fact_extraction_and_preservation(self, summarizer, mock_llm, token_counter):
