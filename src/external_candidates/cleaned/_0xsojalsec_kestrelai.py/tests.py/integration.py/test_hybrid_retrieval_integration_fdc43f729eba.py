# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\tests\integration\test_hybrid_retrieval_integration.py
"""
...
class TestHybridRetrievalIntegration:
    ...
    def test_retrieve_from_rag_uses_hybrid(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_retrieve_from_rag_fallback_to_vector(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_retrieve_from_rag_with_task_filtering(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_add_to_rag_invalidates_bm25_index(self, mock_llm, memory_store, sample_task):
        ...
        agent._add_to_rag(sample_task, "Initial document 1", "checkpoint", {"layer": "episodic"})
        agent._add_to_rag(sample_task, "Initial document 2", "checkpoint", {"layer": "episodic"})
        ...
        if agent.hybrid_retriever.bm25_index is not None:
            ...
            agent._add_to_rag(sample_task, "New document content", "checkpoint", {"layer": "episodic"})
    ...
    def test_retrieve_from_rag_with_empty_store(self, mock_llm, memory_store, sample_task):
    ...
    def test_retrieve_from_rag_respects_token_budget(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_hybrid_retrieval_improves_keyword_matching(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_retrieve_from_rag_with_current_focus(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_retrieve_from_rag_handles_errors_gracefully(self, mock_llm, memory_store, sample_task):
        ...
        with patch.object(agent.memory, "search", side_effect=Exception("Search error")):
    ...
    def test_score_to_distance_conversion_fix(self, mock_llm, populated_memory_store, sample_task):
    ...
    def test_bm25_index_uses_multiple_queries(self, mock_llm, memory_store, sample_task):
    ...
    def test_async_compression_error_handling(self, mock_llm, memory_store, sample_task):
        ...
        with patch.object(logging.getLogger("KestrelAI.agents.web_research_agent"), "error"):
