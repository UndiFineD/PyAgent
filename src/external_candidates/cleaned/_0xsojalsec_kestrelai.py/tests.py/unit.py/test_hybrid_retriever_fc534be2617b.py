...
class TestHybridRetriever:
    ...
    def test_initialization_with_bm25(self, memory_store):
        ...
        with patch.dict("sys.modules", {"rank_bm25": mock_rank_bm25}):
            ...
            assert retriever.enable_bm25 is True  # Should be True when BM25Okapi is available
    ...
    def test_initialization_bm25_not_available(self, mock_bm25, memory_store):
        ...
        with patch.dict("sys.modules", {"rank_bm25": None}):
            ...
            try:
                ...
                retriever = hybrid_retriever.HybridRetriever(memory_store, enable_bm25=True)
                assert retriever.enable_bm25 is False
            finally:
                # Restore original
                if original_bm25:
    ...
    def test_retrieve_hybrid(self, populated_memory_store):
        ...
        results = retriever.retrieve("NSF REU program deadline", k=3, task_name="test_task", use_hybrid=True)
    ...
    def test_retrieve_vector_only(self, populated_memory_store):
        ...
        results = retriever.retrieve("NSF REU program", k=3, task_name="test_task", use_hybrid=False)
    ...
    def test_retrieve_with_task_filter(self, populated_memory_store):
        ...
        results = retriever.retrieve("NSF program", k=10, task_name="test_task", use_hybrid=True)
