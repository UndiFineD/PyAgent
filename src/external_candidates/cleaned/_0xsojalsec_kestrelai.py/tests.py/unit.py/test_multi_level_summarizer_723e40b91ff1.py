# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\tests\unit\test_multi_level_summarizer.py
"""
...
class TestSummaryLevel:
    ...
    def test_summary_level_creation(self):
        ...
        level = SummaryLevel(name="test", compression_ratio=0.5, description="Test level")
...
class TestMultiLevelSummarizer:
    ...
    def test_summarize_error_handling(self, summarizer, mock_llm, token_counter):
        ...
        result = summarizer._summarize(content, target_tokens=50, level=SummaryLevel("test", 0.5, "Test"))
    ...
    def test_summarize_too_long_result(self, summarizer, mock_llm, token_counter):
        ...
        result = summarizer._summarize(content, target_tokens, SummaryLevel("test", 0.5, "Test"))
