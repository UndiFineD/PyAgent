# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\agents\base.py
import os
...
class LlmWrapper:
    def __init__(self, model: str = "gemma3:27b", temperature: float = 0.6, host: str = None):
        self.model = model
    ...
    def chat(self, messages: list[dict], stream: bool = False) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"LLM chat failed (model: {self.model}, host: {self.host}): {str(e)}") from e
