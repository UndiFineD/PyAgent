# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\agents\research_config.py
"""
...
class ResearchConfig:
    ...
    previous_reports: list[str] = field(default_factory=list)  # Previous reports to build upon
