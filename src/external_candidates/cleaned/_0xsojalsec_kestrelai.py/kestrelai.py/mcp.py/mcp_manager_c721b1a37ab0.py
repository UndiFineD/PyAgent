# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\mcp\mcp_manager.py
"""
...
class MCPManager:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"MCP Manager initialized successfully. Connected to {connected_count}/{len(connection_results)} servers."
            )
    ...
    async def call_tool(
        ...
        try:
            ...
            return MCPResult(success=False, data=None, error=str(e), tool_name=tool_name)
