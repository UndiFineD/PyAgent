# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-KestrelAI\KestrelAI\shared\redis_utils.py
"""
...
class SyncRedisClient:
    ...
    def __init__(self, config: RedisConfig):
        self.config = config
        self.redis = redis.Redis(host=config.host, port=config.port, db=config.db, decode_responses=True)
