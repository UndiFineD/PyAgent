# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\stperic.py\local_websearch.py\searxng_search_979445c21ee7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\stperic\local-websearch\searxng_search.py
...
def search(query: str, count: int = 5, lang: str = None) -> dict:
    ...
    req = urllib.request.Request(url, headers={"Accept": "application/json", "User-Agent": "Moltbot-SearXNG/1.0"})
...
def main():
    ...
    parser.add_argument("-l", "--lang", metavar="CODE", help="Language code (en, de, fr, etc.)")
