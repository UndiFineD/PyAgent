# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\template.py\expressing_agent_template_c2f52da29f58.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\template\expressing_agent_template.py
...
class ExpressingAgentTemplate(AgentTemplate):
    ...
    def add_output_stream(self, output_stream: Queue, agent_output: str) -> None:
        ...
        stream_output(
            output_stream,
            {
                "data": {"output": agent_output, "agent_info": self.agent_model.info},
                "type": "expressing",
            },
        )
