# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\mcp.py\retry_manager_97bf59c18986.py
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if not self.should_retry(e):
                    logger.info(f"Non-retryable error for server {server_id}: {type(e).__name__}: {e}")
