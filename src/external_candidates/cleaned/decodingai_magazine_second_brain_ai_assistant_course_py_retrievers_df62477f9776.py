# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\decodingai_magazine_second_brain_ai_assistant_course.py\workshops.py\rag.py\solution.py\src.py\rag_workshop.py\retrievers_df62477f9776.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\workshops\rag\solution\src\rag_workshop\retrievers.py
...
def get_retriever(
    ...
    logger.info(f"Getting retriever using '{embedding_model_id}' on '{device}' with {k} top results")
