# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\keep.py\providers.py\embeddings_5bd47f9317d3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\keep\providers\embeddings.py
...
class OpenAIEmbedding:
    ...
    def __init__(
        ...
        try:
            ...
            raise RuntimeError("OpenAIEmbedding requires 'openai' library. Install with: pip install openai")
        ...
        if not key:
            raise ValueError("OpenAI API key required. Set KEEP_OPENAI_API_KEY or OPENAI_API_KEY")
...
class GeminiEmbedding:
    ...
    def __init__(
        ...
        try:
            ...
            raise RuntimeError(
                "GeminiEmbedding requires 'google-genai' library. Install with: pip install google-genai"
            )
