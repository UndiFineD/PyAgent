# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dennis_da_menace.py\agent_memory.py\src.py\memory_094d40ee9a8b.py
...
class AgentMemory:
    ...
    def list_facts(self, tags: List[str] = None, limit: int = 50, include_superseded: bool = False) -> List[Fact]:
    ...
    def get_lessons(self, context: str = None, outcome: str = None, limit: int = 10) -> List[Lesson]:
        """
    ...
    def track_entity(self, name: str, entity_type: str, attributes: Dict[str, Any] = None) -> str:
        """
    ...
    def update_entity(self, name: str, entity_type: str, attributes: Dict[str, Any]) -> Optional[Entity]:
