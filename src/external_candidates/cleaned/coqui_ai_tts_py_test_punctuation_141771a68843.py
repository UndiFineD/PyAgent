# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tests.py\text_tests.py\test_punctuation_141771a68843.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\tests\text_tests\test_punctuation.py
...
class PunctuationTest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_texts = [
            (
                "This, is my text ... to be striped !! from text?",
                "This is my text to be striped from text",
            ),
            (
                "This, is my text ... to be striped !! from text",
