# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\stream_omni.py\model.py\multimodal_encoder.py\dev_eva_clip.py\eva_clip.py\hf_model_4f09da98a4ff.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\stream_omni\model\multimodal_encoder\dev_eva_clip\eva_clip\hf_model.py
