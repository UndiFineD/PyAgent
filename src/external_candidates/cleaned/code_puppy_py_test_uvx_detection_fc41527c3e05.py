# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_uvx_detection_fc41527c3e05.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_uvx_detection.py
...
class TestGetParentProcessChain:
    ...
    @patch("platform.system")
    def test_get_parent_process_chain_fallback_ctypes(self, mock_platform, mock_ctypes_chain):
