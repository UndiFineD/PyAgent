# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render.py\renderers.py\transport_belt_9c8d0054517c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render\renderers\transport_belt.py
...
def render_inventory(entity: Dict, grid, image_resolver: Callable) -> Optional[Image.Image]:
    ...
    from ..constants import EAST, NORTH, SOUTH, VERTICAL, WEST
