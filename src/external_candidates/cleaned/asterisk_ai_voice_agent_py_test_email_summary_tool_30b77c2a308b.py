# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\tools.py\business.py\test_email_summary_tool_30b77c2a308b.py
    ...
    async def test_tool_disabled(self, email_summary_tool, tool_context):
        ...
        with patch.object(tool_context, "get_config_value") as mock_config:
            ...
            result = await email_summary_tool.execute(
                ...
                parameters={}, context=tool_context
    ...
    async def test_email_sent_asynchronously(
        ...
        with patch("src.tools.business.email_summary.resend") as mock_resend:
            ...
            with patch(
                ...
                "src.tools.business.email_summary.asyncio.create_task"
                ...
                assert (
                    ...
                    "shortly" in result["message"].lower()

                    or "scheduled" in result["message"].lower()
