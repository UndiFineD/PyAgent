# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\aenvironment.py\aenv.py\src.py\cli.py\cmds.py\run_464acc4b8693.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\cli\cmds\run.py
...
@click.option("--work-dir", help="Specify aenv development root directory", default=os.getcwd())
