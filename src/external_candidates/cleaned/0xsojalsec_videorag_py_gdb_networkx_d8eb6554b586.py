# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videorag.py\vimo_desktop.py\python_backend.py\videorag.py\storage.py\gdb_networkx_d8eb6554b586.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoRAG\Vimo-desktop\python_backend\videorag\_storage\gdb_networkx.py
