# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\asif2bd.py\wordpress_publishing_skill_for_claude.py\tests.py\test_wp_publisher_e6539c8278a9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\asif2bd\wordpress-publishing-skill-for-claude\tests\test_wp_publisher.py
...
class TestWordPressPublisher:
    ...
    def test_init_normalizes_url(self):
        ...
        wp = WordPressPublisher(site_url="http://example.com/", username="user", password="pass")
...
class TestErrorHandling:
    ...
    @pytest.fixture
    def publisher(self):
        return WordPressPublisher(site_url="https://example.com", username="user", password="pass")
