# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\listeners.py\http_handler_4da76d97137a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\listeners\http_handler.py
...
from core.listeners.base import create_listener

from core.listeners.base import listeners as listener_registry

from core.listeners.base import socket_to_listener
