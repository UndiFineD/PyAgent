# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava\model\multimodal_encoder\dev_eva_clip\eva_clip\factory.py
import json
import logging
import os
import pathlib
...
def get_tokenizer(model_name):
    ...
    tokenizer = (
        HFTokenizer(config["text_cfg"]["hf_tokenizer_name"]) if "hf_tokenizer_name" in config["text_cfg"] else tokenize
    )
    return tokenizer
