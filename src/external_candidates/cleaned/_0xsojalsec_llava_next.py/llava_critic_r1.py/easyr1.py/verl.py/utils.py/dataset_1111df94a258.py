# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\llava-critic-r1\EasyR1\verl\utils\dataset.py
...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.image_key in example:
            ...
            images = [
                process_image(image, min_pixels=self.min_pixels, max_pixels=self.max_pixels) for image in raw_image_data
            ]
