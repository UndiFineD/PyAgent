# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLaVA-NeXT\playground\sgl_llava_inference_multinode.py
import argparse
import json
import os
import time
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--json_path",
        type=str,
        default="/mnt/bn/vl-research/data/llava_instruct/cc3m_recap_requery_363707.json",
    )
    ...
    parser.add_argument(
        "--result_file",
        type=str,
        default="/mnt/bn/vl-research/workspace/boli01/projects/LLaVA_Next/playground/sgl_llava_inference.json",
    )
