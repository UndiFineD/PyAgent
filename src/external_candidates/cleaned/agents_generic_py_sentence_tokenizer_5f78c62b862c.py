# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_plugins.py\livekit_plugins_nltk.py\livekit.py\plugins.py\nltk.py\sentence_tokenizer_5f78c62b862c.py
