# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\memory_layer.py\memory_extractor.py\profile_memory.py\types_91712db67248.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\memory_extractor\profile_memory\types.py
        ...
        base_dict.update(
            {
                ...
                "projects_participated": (
                    [p.to_dict() if hasattr(p, "to_dict") else p for p in (self.projects_participated or [])]
