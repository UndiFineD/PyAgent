# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llama_cpp_python.py\tests.py\test_llama_grammar_4e412cbe46d8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\llama-cpp-python\tests\test_llama_grammar.py
