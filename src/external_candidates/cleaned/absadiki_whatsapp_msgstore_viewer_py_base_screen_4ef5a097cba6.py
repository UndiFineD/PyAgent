# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\absadiki_whatsapp_msgstore_viewer.py\view.py\base_screen_4ef5a097cba6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\absadiki-whatsapp-msgstore-viewer\View\base_screen.py
