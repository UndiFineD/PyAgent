# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_wappalyzer_next.py\wappalyzer.py\parsers.py\js_2306b8ee3d5a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wappalyzer-next\wappalyzer\parsers\js.py
...
def split_into_statements(js_code: str) -> List[str]:
    ...
    while pos < length:
        ...
        if char == ";" and not in_single_quote and not in_double_quote and not in_template_literal:
            current_statement.append(char)
