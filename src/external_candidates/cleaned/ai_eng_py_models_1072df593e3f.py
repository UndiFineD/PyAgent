# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\registry.py\data_models.py\common.py\models_1072df593e3f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\data-models\common\models.py
