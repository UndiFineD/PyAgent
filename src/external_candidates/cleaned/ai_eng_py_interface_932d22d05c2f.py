# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\registry.py\sql_registry.py\registry.py\interface_932d22d05c2f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\registry\sql-registry\registry\interface.py
