# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hughpyle.py\keep.py\tests.py\test_pending_summaries_6d479b19daa3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hughpyle\keep\tests\test_pending_summaries.py
...
class TestLazySummarization:
    ...
    def test_update_lazy_uses_truncated_summary(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                patch("keep.api.get_registry") as mock_registry,
                ...
                mock_doc_provider.fetch.return_value = MagicMock(
                    content="A" * 1000,
                    content_type="text/plain",  # Long content
                )
                ...
                from keep.api import TRUNCATE_LENGTH, Keeper
    ...
    def test_process_pending_generates_summary(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                ...
                mock_doc_provider.fetch.return_value = MagicMock(
                    content="Test content for summarization", content_type="text/plain"
                )
