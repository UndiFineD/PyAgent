# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\eval.py\detectors.py\s3fd.py\nets_c942c590deba.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\eval\detectors\s3fd\nets.py
