# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ashrf_in.py\odoo_openclaw_skill.py\assets.py\autonomous_cfo.py\scripts.py\generate_yearly_report_c22e120e021a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ashrf-in\odoo-openclaw-skill\assets\autonomous-cfo\scripts\generate_yearly_report.py
...
class SalesReporter:
    ...
    def create_pdf(self, data, chart_path, output_pdf):
        ...
        pdf.cell(
            0,
            10,
            f"Peak Month: {peak_month} ({data['monthly_sales'][peak_month_num]:,.2f})",
            ln=True,
        )
        ...
        pdf.multi_cell(
            0,
            10,
            f"Average monthly revenue for 2025 was {avg_sales:,.2f}. The highest performing month was {peak_month}.",
        )
