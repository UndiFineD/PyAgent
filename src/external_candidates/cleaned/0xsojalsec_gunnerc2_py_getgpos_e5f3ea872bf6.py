# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\getgpos_e5f3ea872bf6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getgpos.py
...
class GetGPOsCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="name",
            required=False,
            help="GPO DisplayName to fetch AD properties for",
        )
