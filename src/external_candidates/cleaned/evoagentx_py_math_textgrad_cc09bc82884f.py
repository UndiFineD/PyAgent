# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\optimization.py\textgrad.py\math_textgrad_cc09bc82884f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\optimization\textgrad\math_textgrad.py
    ...
    "tasks": [
        {
            ...
            "prompt_template": StringTemplate(
                instruction="Answer the math question. The answer should be in box format, e.g., \\boxed{{123}}\n"
            ),
            "parse_mode": "str",
        }
    ],
