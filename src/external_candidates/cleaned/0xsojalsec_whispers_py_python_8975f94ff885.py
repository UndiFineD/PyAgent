# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_whispers.py\whispers.py\plugins.py\python_8975f94ff885.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-whispers\whispers\plugins\python.py
...
class Python:
    ...
    def is_value(node) -> bool:
        ...
        types = [
            astroid.node_classes.Const,
            astroid.node_classes.JoinedStr,
            astroid.node_classes.Call,
        ]
