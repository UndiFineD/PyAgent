# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\command_line.py\mcp.py\test_mcp_utils_c5824f2b8ea8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\command_line\mcp\test_mcp_utils.py
