# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\openclaw.py\skills.py\local_places.py\src.py\local_places.py\main_f5ebfd53e699.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\openclaw\skills\local-places\src\local_places\main.py
