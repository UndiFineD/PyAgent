# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hhhh124hhhh.py\tiktok_ai_model_generator.py\scripts.py\generate_claude_prompt_8f0cb71d7aea.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hhhh124hhhh\tiktok-ai-model-generator\scripts\generate_claude_prompt.py
...
def main():
    parser = argparse.ArgumentParser(description="Generate JSON prompt for Nano Banana Pro")
