# Extracted from: C:\DEV\PyAgent\.external\ACE_plus\inference\ace_plus_diffusers.py
# -*- coding: utf-8 -*-
...
class ACEPlusDiffuserInference:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        masked_image_latents = self.prepare_input(
            image, mask, batch_size=len(prompt), height=h, width=w, generator=generator
        )
