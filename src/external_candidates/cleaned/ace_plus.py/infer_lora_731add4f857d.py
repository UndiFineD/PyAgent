# Extracted from: C:\DEV\PyAgent\.external\ACE_plus\infer_lora.py
# -*- coding: utf-8 -*-
...
def run():
    ...
    parser.add_argument("--input_image", dest="input_image", help="The input image!", default=None)
    parser.add_argument("--input_mask", dest="input_mask", help="The input mask!", default=None)
    parser.add_argument(
        "--save_path",
        dest="save_path",
    ...
    parser.add_argument("--seed", dest="seed", help="The seed for generation!", type=int, default=-1)
