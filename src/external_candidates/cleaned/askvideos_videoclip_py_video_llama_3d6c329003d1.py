# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\models.py\video_llama_3d6c329003d1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AskVideos-VideoCLIP\video_llama\models\video_llama.py
...
class VideoLLAMA(Blip2Base):
    ...
    def __init__(
        ...
        self.video_Qformer, self.video_query_tokens = self.init_video_Qformer(
            ...
            num_hidden_layers=self.num_videoq_hidden_layers,
        )
    ...
    def encode_videoQformer_visual(self, image, output_for_itm=False, output_for_itg=False):
        ...
        with self.maybe_autocast():
            ...
            if output_for_itg:
                return (
                    video_query_tokens,
                    video_query_output.past_key_values,
                    frame_atts,
                )
