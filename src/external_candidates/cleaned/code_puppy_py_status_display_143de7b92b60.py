# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\status_display_143de7b92b60.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\status_display.py
...
class StatusDisplay:
    ...
    def stop(self) -> None:
        ...
        if self.is_active:
            ...
            emit_info(f"Completed: {self.token_count} tokens in {elapsed:.1f}s ({avg_rate:.1f} t/s avg)")
