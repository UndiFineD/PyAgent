# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\getusers_1f51aa78c40e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getusers.py
...
class GetUsersCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            dest="username",
            required=False,
            help="Username to fetch all AD properties for",
        )
