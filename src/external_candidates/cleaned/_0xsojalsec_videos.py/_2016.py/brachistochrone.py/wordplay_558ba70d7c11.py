...
class DisectBrachistochroneWord(Scene):
    def construct(self):
        ...
        chrono_arrow = Arrow(word.get_right(), chrono_example.get_bottom(), color=BLUE_D)
...
class CircleOfIdeas(Scene):
    ...
    def get_spinning_anims(self, words, angle=np.pi / 6):
        ...
        for word in words:
            ...
            anims.append(ApplyMethod(word.shift, vect, path_func=path_along_arc(angle), rate_func=linear))
        return anims
