...
class InfiniteResultsFiniteWorld(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(ShimmerIn(left_formula), ApplyMethod(left_words.next_to, left_formula, UP))
        self.wait()
...
class StatementRemovedFromReality(Scene):
    def construct(self):
        ...
        for bub, buddy in [(bubble, mathy), (morty_bubble, morty)]:
            ...
            self.play(ApplyMethod(buddy.blink, rate_func=squish_rate_func(there_and_back)))
