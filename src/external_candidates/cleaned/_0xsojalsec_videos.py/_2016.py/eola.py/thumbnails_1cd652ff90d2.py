# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2016\eola\thumbnails.py
...
class Chapter3(Chapter0):
    CONFIG = {"t_matrix": [[3, 0], [2, -1]]}


class Chapter4p1(Chapter0):
    CONFIG = {"t_matrix": [[1, 0], [1, 1]]}


class Chapter4p2(Chapter0):
    CONFIG = {"t_matrix": [[1, 2], [-1, 1]]}
...
class Chapter10(LinearTransformationScene):
    ...
    def construct(self):
        ...
        title = OldTexText("Eigen", "vectors \\\\", "Eigen", "values", arg_separator="")
        title.scale(2.5)
        title.to_edge(UP)
