...
class MoonOrbitCalculation(InteractiveScene):
    def construct(self):
        ...
        # Equation 2
        eq3 = Tex(R"\frac{1}{\pi} \left( " + new_ratio_tex + R"\right) R_\text{E} = D_M")
...
class OtherGreeks(InteractiveScene):
    def construct(self):
        ...
        sub_images = Group(
            ImageMobject(Path(folder, "stencil-luma-masks", f"figure-{n}-masked.png")) for n in range(1, 10)
        )
