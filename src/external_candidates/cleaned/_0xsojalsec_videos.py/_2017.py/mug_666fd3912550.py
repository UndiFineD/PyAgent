...
class IntroduceGraph(PiCreatureScene):
    def construct(self):
        ...
        self.play(
            ...
            LaggedStartMap(ApplyMethod, pi_creatures, lambda pi: (pi.change, "pondering", lines)),
        )
...
class IntroduceRegions(UtilitiesPuzzleScene):
    def construct(self):
        ...
        escape_lines = VGroup(
            *[
                Line(LEFT, RIGHT).set_points_smoothly([utilities[2].get_center()] + point_set)
...
class ShowRule(TeacherStudentsScene):
    def construct(self):
        ...
        arrows = VGroup(
            *[
                Arrow(new_edge.get_right(), mob.get_left(), color=WHITE, buff=SMALL_BUFF)
