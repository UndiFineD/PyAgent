# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2020\surface_play.py
...
class EarthMorph(Scene):
    ...
    def construct(self):
        ...
        earths = [
            TexturedSurface(surface, "EarthTextureMap", "NightEarthTextureMap") for surface in [sphere, torus1, torus2]
        ]
        for mob in earths:
        ...
        self.play(Transform(earth, earths[1]), run_time=3)
