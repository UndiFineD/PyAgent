...
class RemindOfWeightedCoin(Scene):
    def construct(self):
        ...
        numbers = VGroup(
            *[Integer(i + 1).set_height(0.2).next_to(coin, DOWN, SMALL_BUFF) for i, coin in enumerate(heads)]
        )
...
class VisualizeBayesRule(Scene):
    ...
    def show_continuum(self):
        ...
        self.play(
            ShowCreation(x_line),
            UpdateFromFunc(s_part, lambda m: m.next_to(m.tracked.get_end(), UR, SMALL_BUFF)),
