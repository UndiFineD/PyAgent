...
class ShowMomentumConservation(IntroduceVelocityVector):
    ...
    def show_rate_of_change_vector(self):
        ...
        d_array.scale(0.75)
        d_array.add_updater(
            lambda m: m.next_to(ps_vect.get_end(), np.sign(ps_vect.get_vector()[0]) * RIGHT, SMALL_BUFF)
        )
    ...
    def show_same_angles(self):
        ...
        self.play(
            ...
            UpdateFromAlphaFunc(line_pair, lambda m, a: m.set_stroke(width=there_and_back(a) ** 0.5)),
        )
