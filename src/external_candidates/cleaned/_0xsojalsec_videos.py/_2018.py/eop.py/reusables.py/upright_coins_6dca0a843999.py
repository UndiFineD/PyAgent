# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\reusables\upright_coins.py
...
class FlatCoin(UprightCoin):
    ...
    def __init__(self, **kwargs):
        ...
        edge.set_fill(color=self.fill_color, opacity=self.fill_opacity)
        ...
        ridge_positions = 0.5 * 2 * self.radius * np.array([np.cos(theta) for theta in ridge_angles])
