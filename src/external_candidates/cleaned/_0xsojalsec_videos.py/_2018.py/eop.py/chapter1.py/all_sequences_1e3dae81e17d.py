# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\all_sequences.py
...
class ShuffleThroughAllSequences(Scene):
    ...
    def construct(self):
        ...
        left_idle_part = CoinSequence(6 * ["H"], radius=self.coin_size * 0.5, spacing=self.coin_spacing)
        ...
        for i in range(2**nb_relevant_coins):
            ...
            coin_seq = CoinSequence(seq2, radius=self.coin_size * 0.5, spacing=self.coin_spacing)
