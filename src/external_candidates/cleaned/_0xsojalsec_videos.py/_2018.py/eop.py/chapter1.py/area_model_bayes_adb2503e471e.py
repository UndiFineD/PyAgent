# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\chapter1\area_model_bayes.py
...
class IllustrateAreaModelBayes(Scene):
    def construct(self):
        ...
        rect_A_and_B.target = (
            ...
            .align_to(rect_A_and_B, DOWN)
            .align_to(rect_A_and_B, LEFT)
        )
        ...
        self.play(
            label_B_knowing_A_copy.next_to,
            indep_formula.get_part_by_tex("\cdot"),
            RIGHT,
        )
        ...
        self.play(
            ...
            label_B_knowing_A_copy.move_to,
            rearranged_formula.get_part_by_tex("P(B\mid A)"),
            label_A_copy.move_to,
            rearranged_formula[-1][10],
            label_A_and_B_copy.move_to,
            rearranged_formula[-1][3],
            indep_formula.get_part_by_tex("=").move_to,
            rearranged_formula.get_part_by_tex("="),
