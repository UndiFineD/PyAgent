...
class PiCreature(SVGMobject):
    ...
    def is_flipped(self):
        return self.eyes.submobjects[0].get_center()[0] > self.eyes.submobjects[1].get_center()[0]
    ...
    def replace_bubble(self, content, mode="pondering", look_at=None, **kwargs) -> Animation | _AnimationBuilder:
        ...
        return AnimationGroup(ReplacementTransform(old_bubble, new_bubble), self.change(mode, look_at))
