...
class TextEncoder(nn.Module):
    ...
    def forward(self, text: Union[str, List[str]]) -> TextEncoderOutput:
        ...
        for encoder_config, tokenizer, model in zip(self.config.models, self.tokenizers, self.models):
            if encoder_config.type == "llm14b":
                ...
                masks.append(tokens.attention_mask.bool() if use_mask else tokens.attention_mask > -1)
