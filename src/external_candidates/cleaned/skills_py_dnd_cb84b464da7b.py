# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\andrewdmwalker.py\dnd.py\dnd_cb84b464da7b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\andrewdmwalker\dnd\dnd.py
...
def roll_dice(dice_str: str) -> Dict:
    ...
    if not match:
        print(
            f"Invalid dice format: {dice_str}. Use format like '2d6', '1d20+5', '3d8-2'",
            file=sys.stderr,
        )
    ...
    return {"dice": dice_str, "rolls": rolls, "modifier": modifier, "total": total}
