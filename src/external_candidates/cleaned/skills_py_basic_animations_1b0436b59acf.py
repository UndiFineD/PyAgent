# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\inclinedadarsh.py\manimce_best_practices.py\examples.py\basic_animations_1b0436b59acf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\inclinedadarsh\manimce-best-practices\examples\basic_animations.py
...
class ColorTransitions(Scene):
    ...
    def construct(self):
        ...
        squares = VGroup(*[Square(side_length=0.8, fill_opacity=0.8) for _ in range(7)]).arrange(RIGHT, buff=0.2)
        ...
        self.play(
            *[square.animate.set_fill(interpolate_color(BLUE, RED, i / 6)) for i, square in enumerate(squares)],
            run_time=2,
        )
