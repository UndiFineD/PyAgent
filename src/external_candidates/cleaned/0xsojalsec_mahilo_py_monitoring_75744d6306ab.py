# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mahilo.py\mahilo.py\monitoring_75744d6306ab.py
...
class MahiloTelemetry:
    ...
    def record_event(
        ...
        with self.tracer.start_as_current_span(f"mahilo.event.{event_type.value}", attributes=attributes) as span:
