# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\conversation.py\conversation_video_d8445c356a65.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AskVideos-VideoCLIP\video_llama\conversation_\conversation_video.py
    ...
    def ask(self, text, conv):
        ...
        if (
            ...
            and (
                ...
                "</Video>" in conv.messages[-1][1] or "</Image>" in conv.messages[-1][1]
    ...
    def upload_img(self, image, conv, img_list):
        ...
        if isinstance(image, str):  # is a image path
            ...
            image = (
                ...
                self.image_vis_processor(raw_image)
