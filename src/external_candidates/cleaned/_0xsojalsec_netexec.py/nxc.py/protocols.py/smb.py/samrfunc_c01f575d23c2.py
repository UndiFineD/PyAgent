...
class SAMRQuery:
    ...
    def get_domain_aliases(self, domain_handle, group=None):
        ...
        aliases = {
            ...
            for alias in samr.hSamrEnumerateAliasesInDomain(self.dce, domain_handle)["Buffer"]["Buffer"]
        }
        if group:
    ...
    def get_alias_members(self, domain_handle, alias_id):
        ...
        return [
            ...
            for member in samr.hSamrGetMembersInAlias(self.dce, alias_handle)["Members"]["Sids"]
        ]
