...
class connection:
    ...
    def call_modules(self):
        ...
        for module in self.modules:
            ...
            if (not hasattr(module, "on_request") and not hasattr(module, "has_response")) and hasattr(
                module, "on_shutdown"
            ):
                ...
                with open(user) as user_file:
                    for line in user_file:
                        if "\\" in line and len(line.split("\\")) == 2:
                            ...
                            domain_single = (
                                self.args.domain if hasattr(self.args, "domain") and self.args.domain else self.domain
                            )
