...
from impacket.dcerpc.v5.rprn import PBYTE_ARRAY, STRING_HANDLE, checkNullString
...
class DRIVER_INFO_2_BLOB(Structure):
    ...
    def fromString(self, data, offset=0):
        ...
        self["ConfigFile"] = data[self["ConfigFileOffset"] + offset : self["DataFileOffset"] + offset].decode(
            "utf-16-le"
        )
        self["DataFile"] = data[self["DataFileOffset"] + offset : self["DriverPathOffset"] + offset].decode("utf-16-le")
        self["DriverPath"] = data[self["DriverPathOffset"] + offset : self["EnvironmentOffset"] + offset].decode(
            "utf-16-le"
        )
