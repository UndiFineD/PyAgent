    ...
    async def run_ldaps_withEPA(self, context, connection, target, credential):
        try:
            ...
            try:
                ...
                with (
                    socket.create_connection((connection.host, 636)) as sock,
                    ssl_context.wrap_socket(sock, server_hostname=connection.host) as ssl_sock,
                ):
