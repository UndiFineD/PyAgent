# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_chatgpt_oauth_server_8df2302cb030.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_chatgpt_oauth_server.py
...
class TestOAuthFlow:
    ...
    @patch("requests.post")
    def test_exchange_code_for_tokens_success(self, mock_post, mock_oauth_context, sample_token_data):
    ...
    @patch("requests.post")
    def test_exchange_code_for_tokens_expired_context(self, mock_post, sample_token_data):
    ...
    @patch("requests.post")
    def test_exchange_code_for_tokens_network_error(self, mock_post, mock_oauth_context):
