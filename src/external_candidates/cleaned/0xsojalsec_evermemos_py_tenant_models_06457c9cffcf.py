# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\tenants.py\tenant_models_06457c9cffcf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\tenants\tenant_models.py
...
class TenantDetail:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TenantDetail":
        ...
        return cls(tenant_info=data.get("tenant_info"), storage_info=data.get("storage_info"))
