# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videorag.py\vimo_desktop.py\python_backend.py\videorag.py\videoutil.py\feature_6e819d57eef3.py
