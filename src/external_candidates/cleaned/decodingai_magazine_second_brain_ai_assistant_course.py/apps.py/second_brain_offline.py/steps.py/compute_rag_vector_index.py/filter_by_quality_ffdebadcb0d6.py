# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\steps\compute_rag_vector_index\filter_by_quality.py
...
def filter_by_quality(
    ...
    assert 0 <= content_quality_score_threshold <= 1, "Content quality score threshold must be between 0 and 1"

    valid_docs = [
        doc
        for doc in documents
        if not doc.content_quality_score or doc.content_quality_score > content_quality_score_threshold
    ]
