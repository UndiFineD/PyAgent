# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\steps\generate_dataset\create_histograms.py
...
def create_histograms(
    ...
    quality_scores = [doc.content_quality_score for doc in documents if doc.content_quality_score is not None]
