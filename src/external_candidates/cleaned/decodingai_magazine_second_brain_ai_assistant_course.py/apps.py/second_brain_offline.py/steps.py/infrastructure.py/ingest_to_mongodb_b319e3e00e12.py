# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\steps\infrastructure\ingest_to_mongodb.py
...
def ingest_to_mongodb(
    ...
    with MongoDBService(model=model_type, collection_name=collection_name) as service:
        ...
        logger.info(f"Successfully ingested {count} documents into MongoDB collection '{collection_name}'")
