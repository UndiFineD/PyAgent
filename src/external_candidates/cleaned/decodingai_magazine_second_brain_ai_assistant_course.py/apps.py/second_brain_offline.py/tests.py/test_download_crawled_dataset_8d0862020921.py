# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\tests\test_download_crawled_dataset.py
import json
...
class TestDownloadCrawledDataset:
    ...
    def test_json_files_in_crawled_dir(self, crawled_dir: Path) -> None:
        ...
        assert len(non_empty_json_files) > 0, "No non-empty JSON files found in crawled directory"
