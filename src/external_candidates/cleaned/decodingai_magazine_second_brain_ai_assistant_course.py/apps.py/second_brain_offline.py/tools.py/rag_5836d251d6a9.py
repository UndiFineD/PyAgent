# Extracted from: C:\DEV\PyAgent\.external\decodingai-magazine-second-brain-ai-assistant-course\apps\second-brain-offline\tools\rag.py
"""
...
def main(config_path: Path) -> None:
    ...
    docs = get_documents_for_query(config_path, "List some Python libraries to process and parse PDFs")
