# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_llmtornado.py\src.py\llmtornado.py\llmtornado.py\tests.py\test_resource_manager_155cf7ea3d31.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\tests\test_resource_manager.py
