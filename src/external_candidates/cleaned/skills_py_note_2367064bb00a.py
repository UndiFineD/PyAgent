# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chocomintx.py\xiaohongshutools.py\scripts.py\request.py\web.py\apis.py\note_2367064bb00a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chocomintx\xiaohongshutools\scripts\request\web\apis\note.py
...
class Note:
    ...
    async def enter_metrics_report(
        self,
        note_id: str,
        note_type: int,
        request_id: str,
        ...
        data = {
            ...
            "viewer": {"user_id": viewer_id, "followed_author": 0},
    ...
    async def exit_metrics_report(
        ...
        data = {
            ...
            "viewer": {"user_id": viewer_id, "followed_author": 0},
            "author": {"user_id": author_id},
            "interaction": {"like": 0, "collect": 0, "comment": 0, "comment_read": 1},
    ...
    async def add_note_readnum(self, note_id: str, xsec_token: str) -> aiohttp.ClientResponse:
        ...
        enter_note_res = await self.enter_metrics_report(
            note_id=note_id,
            note_type=note_type,
        ...
        exit_note_res = await self.exit_metrics_report(
            note_id=note_id,
            note_type=note_type,
            request_id=request_id,
            viewer_id=viewer_id,
