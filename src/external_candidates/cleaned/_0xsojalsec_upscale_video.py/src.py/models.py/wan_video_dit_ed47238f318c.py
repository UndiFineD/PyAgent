# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-upscale-video\src\models\wan_video_dit.py
import math
import os
import random
import time
...
def generate_draft_block_mask_sage(batch_size, nheads, seqlen, q_w, k_w, topk=10, local_attn_mask=None):
    ...
    assert scores.shape == local_attn_mask.shape, f"Scores shape {scores.shape} != Mask shape {local_attn_mask.shape}"
