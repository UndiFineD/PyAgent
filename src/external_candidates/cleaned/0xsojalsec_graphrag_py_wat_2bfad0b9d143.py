# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graphrag.py\core.py\utils.py\wat_2bfad0b9d143.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Utils\WAT.py
...
class WATAnnotation:
    ...
    def __init__(self, start, end, rho, explanation, spot, id, title):
        ...
        if self.explanation is not None:
            self.prior_prob = self.explanation["prior_explanation"]["entity_mention_probability"]
