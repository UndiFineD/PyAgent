# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gpt_vuln_analyzer.py\package.py\gva.py\jwt_8d8e5162cebf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GPT_Vuln-analyzer\package\GVA\jwt.py
...
class JWTAnalyzer:
    def analyze(
        ...
        bard_api_token: Optional[str],
        llama_api_token: Optional[str],
        llama_endpoint: Optional[str],
        AI: str,
    ) -> str:
        try:
            self.algorithm_used = ""
