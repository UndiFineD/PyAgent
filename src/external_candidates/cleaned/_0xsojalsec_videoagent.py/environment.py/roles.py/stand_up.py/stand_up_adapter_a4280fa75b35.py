...
class StandUpAdapter(BaseTool):
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        reqs: str = Field(..., description="User requirements for creating stand-up comedy script")
        ref_script_path: str = Field(..., description="File path to the reference script")
