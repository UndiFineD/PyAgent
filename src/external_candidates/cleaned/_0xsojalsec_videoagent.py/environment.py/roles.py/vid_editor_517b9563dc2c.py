...
class VideoEditor(BaseTool):
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        video_dir: str = Field(..., description="Directory containing source video files")
    ...
    def _process_video(
        ...
        try:
            ...
            time_periods.extend([(beat_timestamps[i], beat_timestamps[i + 1]) for i in range(len(beat_timestamps) - 1)])
            ...
            storyboard_sections = [section.strip() for section in storyboard_text.split("/////") if section.strip()]
