...
class RhythmDetector(BaseTool):
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        audio_path: str = Field(..., description="File path to the audio to be analyzed")
    ...
    def _detect_rhythm_points(
        ...
        times = librosa.frames_to_time(np.arange(len(rms_normalized)), sr=self.sr, hop_length=self.hop_length)
