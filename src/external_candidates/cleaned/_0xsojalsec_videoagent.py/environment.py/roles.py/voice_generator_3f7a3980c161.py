...
class VoiceGenerator(BaseTool):
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        video_scene_path: str = Field(..., description="Path to a custom scene JSON file")
        target_vocal_path: str = Field(..., description="Path to the target timbre for voice generation")
    ...
    def execute(self, **kwargs):
        ...
        try:
            ...
            (
                ...
                files_to_delete,
                total_duration,
            ) = self._generate_audio_for_segments(segments, output_dir=self.audio_analysis_dir, max_sentence_length=200)
