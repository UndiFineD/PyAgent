        ...
        for i in range(len(lyrics_parts)):
            ...
            while len(extract_parts[i]) != target_length and retry_count < 5:
                ...
                previous_lyrics_template = (
                    self.align_lyrics_template(previous_lyrics_context, previous_extract_context)
                ...
                next_lyrics_template = (
                    self.align_lyrics_template(next_lyrics_context, next_extract_context) if next_lyrics_context else ""
                )
