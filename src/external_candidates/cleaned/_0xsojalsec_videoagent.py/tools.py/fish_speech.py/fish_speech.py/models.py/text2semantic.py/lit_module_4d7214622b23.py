# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\fish_speech\models\text2semantic\lit_module.py
...
class TextToSemantic(L.LightningModule):
    ...
    def configure_optimizers(self) -> OptimizerLRScheduler:
        ...
        for i in optimizer.param_groups:
            log.info(f"Set weight decay: {i['weight_decay']} for {len(i['params'])} parameters")
