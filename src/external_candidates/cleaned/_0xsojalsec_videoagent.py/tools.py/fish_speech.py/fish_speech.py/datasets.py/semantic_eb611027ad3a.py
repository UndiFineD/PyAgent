# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\fish_speech\datasets\semantic.py
import random
...
class AutoTextSemanticInstructionIterableDataset(IterableDataset):
    ...
    def sample_data(self):
        ...
        if self.causal:
            ...
            samples = random.choices(group.sentences, k=min(num_samples, len(group.sentences)))
    ...
    def pack_sentences(
        ...
        num_codebooks = len(semantics[0]) if self.num_codebooks is None else self.num_codebooks
...
class TextDataCollator:
    ...
    def batchify(self, examples, tokens_key="tokens", labels_key="labels"):
        ...
        for example in examples:
            ...
            assert tokens_length == _labels.size(1), f"{tokens_length} != {_labels.size(1)}"
            ...
            if tokens_length < max_tokens_length:
                ...
                _labels = F.pad(_labels, (0, max_tokens_length - _labels.size(1)), value=-100)
