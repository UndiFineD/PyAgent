# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\fish_speech\utils\schema.py
import base64
import os
import queue
    ...
    def to_conversation_message(self):
        ...
        for part in self.parts:
            if isinstance(part, ServeTextPart):
                ...
                new_message.parts.append(VQPart(codes=torch.tensor(part.codes, dtype=torch.int)))
            else:
