...
class GradNormMonitor(Callback):
    ...
    def on_after_backward(self, trainer: Trainer, model: LightningModule) -> None:
        ...
        for sub_module in sub_modules:
            self.log_sub_module_grad_norm(lightning_model, getattr(model, sub_module), f"/{sub_module}")

    def log_sub_module_grad_norm(self, lightning_model: LightningModule, model: nn.Module, path: str) -> None:
