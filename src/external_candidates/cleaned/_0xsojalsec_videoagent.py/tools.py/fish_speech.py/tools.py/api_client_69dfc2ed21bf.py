# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\tools\api_client.py
import argparse
import base64
import wave
...
def parse_args():
    ...
    parser.add_argument("--chunk_length", type=int, default=200, help="Chunk length for synthesis")
    parser.add_argument("--top_p", type=float, default=0.7, help="Top-p sampling for synthesis")
    parser.add_argument(
        "--repetition_penalty",
        type=float,
        default=1.2,
