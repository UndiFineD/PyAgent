# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\tools\fish_e2e.py
import base64
import ctypes
import io
import json
...
class FishE2EAgent:
    ...
    async def get_codes(self, audio_data, sample_rate):
        ...
        encode_request_bytes = ormsgpack.packb(encode_request, option=ormsgpack.OPT_SERIALIZE_PYDANTIC)
