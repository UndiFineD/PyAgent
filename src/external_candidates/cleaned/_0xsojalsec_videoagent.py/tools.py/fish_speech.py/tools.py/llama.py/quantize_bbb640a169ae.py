# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\tools\llama\quantize.py
...
@click.option("--mode", type=str, default="int8", help="type of quantization to perform")
@click.option("--groupsize", type=int, default=128, help="Group size for int4 quantization.")
