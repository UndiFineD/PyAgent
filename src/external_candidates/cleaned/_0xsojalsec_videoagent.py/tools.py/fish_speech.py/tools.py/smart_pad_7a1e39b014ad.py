...
def process(file):
    ...
    loudness = librosa.feature.rms(y=waveform.numpy().squeeze(), frame_length=2048, hop_length=512, center=True)[0]
    ...
    if end_silent_time <= 0.3:
        ...
        waveform = F.pad(waveform, (0, int(random_time * sample_rate)), mode="constant", value=0)
