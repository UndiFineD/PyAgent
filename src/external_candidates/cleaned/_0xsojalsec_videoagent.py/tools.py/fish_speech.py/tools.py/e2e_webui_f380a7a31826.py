# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\fish-speech\tools\e2e_webui.py
import io
import re
import wave
...
async def process_audio_input(sys_audio_input, sys_text_input, audio_input, state: ChatState, text_input: str):
    ...
    def append_to_chat_ctx(part: ServeTextPart | ServeVQPart, role: str = "assistant") -> None:
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=3):
                ...
                audio_input = gr.Audio(sources=["microphone"], type="numpy", label="Speak your message")
