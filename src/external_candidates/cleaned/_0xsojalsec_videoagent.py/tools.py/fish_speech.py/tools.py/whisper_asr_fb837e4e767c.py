...
@click.option("--save-dir", required=True, help="Directory to save processed audio files")
@click.option(
    "--sample-rate",
    default=44100,
    type=int,
...
def main(
    ...
    audio_files = list_files(path=audio_dir, extensions=AUDIO_EXTENSIONS, recursive=True)
