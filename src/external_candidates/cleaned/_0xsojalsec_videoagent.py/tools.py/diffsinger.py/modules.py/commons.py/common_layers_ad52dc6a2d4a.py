# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\DiffSinger\modules\commons\common_layers.py
import math
    ...
    def forward(
        ...
        if attn_mask is not None:
            if len(attn_mask.shape) == 2:
                ...
                attn_mask = (
                    attn_mask[:, None].repeat([1, self.num_heads, 1, 1]).reshape(bsz * self.num_heads, tgt_len, src_len)
                )
