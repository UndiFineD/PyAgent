# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\DiffSinger\tasks\tts\fs2_utils.py
import matplotlib
...
class FastSpeechDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.hparams["pitch_type"] == "cwt":
            ...
            f0_phlevel_num = (
                torch.zeros_like(phone).float().scatter_add(0, mel2ph - 1, torch.ones_like(f0)).clamp_min(1)
            )
