# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\DiffSinger\data_gen\tts\txt_processors\zh.py
import re
...
class TxtProcessor(BaseTxtProcessor):
    table = {
        ord(f): ord(t) for f, t in zip("：，。！？【】（）％＃＠＆１２３４５６７８９０", ":,.!?[]()%#@&1234567890")
    }
    ...
    def process(cls, txt, pre_align_args):
        ...
        yunmu = (
            [[t[0] + "5"] if t[0] == f[0] else t for f, t in zip(yunmu_finals, yunmu_tone3)]
