# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\DiffSinger\inference\svs\gradio\infer.py
import importlib
import re
        ...
        iface = gr.Interface(
            ...
            inputs=[
                Textbox(
                    lines=2,
                    placeholder=None,
                    default=example_inputs[0][0],
                    label="input text",
                ),
                Textbox(
                    lines=2,
                    placeholder=None,
                    default=example_inputs[0][1],
                    label="input note",
                ),
                Textbox(
                    lines=2,
                    placeholder=None,
                    default=example_inputs[0][2],
