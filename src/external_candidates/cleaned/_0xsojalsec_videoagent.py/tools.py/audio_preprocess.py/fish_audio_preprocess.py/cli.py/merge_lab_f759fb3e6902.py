# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\audio-preprocess\fish_audio_preprocess\cli\merge_lab.py
import os
...
def merge_lab(
    ...
    for audio_file in tqdm(audio_files):
        ...
        try:
            ...
            continue
        results.append(template.replace("{TEXT}", lab_content).replace("{PATH}", audio_file))
