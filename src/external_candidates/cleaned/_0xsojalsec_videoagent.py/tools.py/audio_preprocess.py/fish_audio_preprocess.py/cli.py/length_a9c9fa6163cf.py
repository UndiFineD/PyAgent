...
@click.option("-l", "--long-threshold", default=None, type=float, help="Threshold for long files")
@click.option(
    "-s",
    "--short-threshold",
    default=None,
...
def length(
    ...
    infos = []
    process_one_partial = partial(process_one_accurate if accurate else process_one, input_dir=input_dir)
    ...
    plt.title(f"Distribution of audio lengths (Total: {len(infos)} files, {total_duration / 3600:.2f} hours)")
