# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\audio-preprocess\fish_audio_preprocess\cli\frequency.py
import os
...
@click.option("--visualize/--no-visualize", default=True, help="Visualize the distribution")
@click.option(
    "--num-workers",
