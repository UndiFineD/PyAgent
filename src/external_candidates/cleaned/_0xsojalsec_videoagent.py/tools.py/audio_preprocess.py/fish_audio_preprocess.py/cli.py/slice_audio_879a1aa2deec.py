# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\audio-preprocess\fish_audio_preprocess\cli\slice_audio.py
import os
...
@click.option(
    "--min-duration",
    help="Minimum duration of each example",
    default=6.0,
    show_default=True,
    type=float,
)
@click.option(
    "--max-duration",
    help="Maximum duration of each example",
    default=20.0,
    show_default=True,
    type=float,
)
@click.option(
    "--pad-silence",
    help="Pad silence between each non-silent example",
    default=0.5,
    show_default=True,
    type=float,
)
...
@click.option("--flat-layout/--no-flat-layout", default=False, help="Use flat directory structure")
@click.option(
