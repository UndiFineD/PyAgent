# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VideoAgent\tools\audio-preprocess\fish_audio_preprocess\utils\slice_audio.py
import math
...
def slice_audio(
    ...
    intervals = librosa.effects.split(audio.T, top_db=top_db, frame_length=frame_length, hop_length=hop_length)
