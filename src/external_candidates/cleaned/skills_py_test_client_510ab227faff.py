# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\tests.py\test_client_510ab227faff.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\tests\test_client.py
...
class TestOuraClient:
    ...
    def test_load_token_from_env(self, mock_path: Mock, mock_getenv: Mock, mock_load_dotenv: Mock) -> None:
