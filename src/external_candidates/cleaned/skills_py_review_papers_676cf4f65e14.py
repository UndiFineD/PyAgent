# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\sjf_ecnu.py\paper_recommendation.py\scripts.py\review_papers_676cf4f65e14.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\sjf-ecnu\paper-recommendation\scripts\review_papers.py
...
def generate_subagent_tasks(papers):
    ...
    for p in papers:
        ...
        tasks.append({"paper_id": p["id"], "task": task, "label": f"review-{p['id']}"})
