# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_browser_screenshot_88c596145e0a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_screenshot.py
...
class TestScreenshotCapture:
    ...
    async def test_capture_full_page_screenshot(self):
        ...
        result = await _capture_screenshot(mock_page, full_page=True, save_screenshot=False)
    ...
    async def test_capture_with_emit_messages(self):
        ...
        with patch("code_puppy.tools.browser.browser_screenshot.emit_success") as mock_emit:
    ...
    async def test_take_screenshot_success(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.browser_screenshot.emit_info"):
                ...
                binary_contents = [c for c in result.content if isinstance(c, BinaryContent)]
