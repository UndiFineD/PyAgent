# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\command_line.py\test_utils_coverage_023ef63bea70.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\command_line\test_utils_coverage.py
...
class TestSafeInput:
    ...
    def test_calls_reset_windows_console(self):
        ...
        with patch("code_puppy.command_line.utils._reset_windows_console") as mock_reset:
