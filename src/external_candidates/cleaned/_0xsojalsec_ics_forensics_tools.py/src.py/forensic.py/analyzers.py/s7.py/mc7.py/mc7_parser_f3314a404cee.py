...
class MC7Parser(object):
    ...
    def parse_block_header_metadata(self, br: BinaryReader):
        ...
        self._aggregated_buffer["last_interface_change"] = self.read_s7_datetime_from_bytes(
    ...
    def parse_tcon_params(self, br: BinaryReader):
        ...
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["connection_id"] = (
            tcon.connection_id
        )  # valid range 0x0001 - 0x0fff
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["connection_type"] = CONNECTION_TYPE.get(
        ...
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["local_device_id"] = (
            tcon.local_device_id
        )  # allowed values: 0 / 2 / 3 / 5
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["local_tsap_id_length"] = (
            tcon.local_tsap_id_length
        )  # used length of the "local_tsap_id" parameter
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["rem_subnet_id_length"] = (
            tcon.rem_subnet_id_length
        )  # unused
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["rem_staddr_length"] = (
            tcon.rem_staddr_length
        )  # 0 (unspecified) / 4 (valid IP address)
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["rem_tsap_id_length"] = (
            tcon.rem_tsap_id_length
        )  # used length of the "rem_tsap_id" parameter
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["next_staddr_length"] = (
            tcon.next_staddr_length
        )  # Used length of the "next_staddr" parameter. This parameter is not relevant for TCP.
        self._aggregated_buffer["db_ext_header"]["tcon_params"]["local_tsap_id"] = (
            tcon.local_tsap_id
        )  # local port number
