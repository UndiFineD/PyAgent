            ...
            try:
                ...
                if op_value in ops:
                    ...
                    if op1_int in commands_16:
                        ...
                        if (op2_v in [1, 2, 9, 0xA] and value < 128 and point_v <= 7) or (
                            op2_v in [0xB, 0x3] and value < 256 and point_v <= 7
                        ):
                            msg = "_!!ERR_out_of_allowed_range!!"
                        elif (op2_v in [1, 2, 9, 0xA] and value < 128 and point_v > 7) or (
                            op2_v in [0xB, 0x3] and value < 256 and point_v > 7
                        ):
