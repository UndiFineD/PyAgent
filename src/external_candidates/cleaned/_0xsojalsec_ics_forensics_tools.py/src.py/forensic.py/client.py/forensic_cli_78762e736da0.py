# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ics-forensics-tools\src\forensic\client\forensic_cli.py
import argparse
...
from forensic.interfaces.analyzer import AnalyzerCLI, AnalyzerConfig
from forensic.interfaces.plugin import PluginCLI, PluginConfig
...
class ForensicCLI(Application):
    ...
    def get_parameters(args: Dict[str, Any]):
        return {
            key: value for key, value in args.items() if key not in constants.ARGUMENTS and value is not None and value
        }
