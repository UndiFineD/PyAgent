# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\messaging.py\subagent_console_839952f20dbf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\messaging\subagent_console.py
...
class SubAgentConsoleManager:
    ...
    def unregister_agent(self, session_id: str, final_status: str = "completed") -> None:
    ...
    def _start_display(self) -> None:
        ...
        self._update_thread = threading.Thread(target=self._update_loop, daemon=True, name="SubAgentDisplayUpdater")
