# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\tests.py\src.py\core.py\test_module_b6c4ce238ddc.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\src\core\test_module.py
...
class TestModule(unittest.TestCase):
    ...
    def test_subclass(self):
        d1 = {
            "k10": [{"k1": "k1_value"}],
            "k11": [
                {"k4": "k4_valid_value1", "k5": "k5_value1"},
                {"k4": "k4_valid_value2", "k5": "k5_value2"},
            ],
            "k12": {
                "key": {
                    "k7": {"k1": "k1_value2"},
        ...
        self.assertTrue(
            isinstance(module.k11[0], ToyModule2)
            and isinstance(module.k11[1], ToyModule2)
            and module.k11[0].class_name == "ToyModule2"
            and module.k11[1].class_name == "ToyModule2"
        )
        ...
        self.assertTrue(
            isinstance(module.k12["key"].k9, ToyModule2) and module.k12["key"].k9.class_name == "ToyModule2"
        )
        ...
        self.assertTrue(
            isinstance(module.k11[0], ToyModule2SubClass)
            and isinstance(module.k11[1], ToyModule2)
            and module.k11[0].class_name == "ToyModule2SubClass"
            and module.k11[1].class_name == "ToyModule2"
        )
        ...
        self.assertTrue(
            isinstance(module.k12["key"].k7, ToyModuleSubClass)
            and module.k12["key"].k7.class_name == "ToyModuleSubClass"
        )
    ...
    def test_subclass_from_init(self):
        ...
        test4_instance = ToyModule4(
            ...
            k11=[
                test2_instance,
                {"k4": "k4_valid_value2", "k5": "k5_valid_value2"},
                {
                    "class_name": "ToyModule2SubClass",
                    "k4": "k4_valid_value3",
                    "k5": "k5_value3",
                    "test2_subclass_variable": 888,
                },
            ],
            k12={
                "key": {
