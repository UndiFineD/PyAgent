# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\avatar_agents\bithuman\agent_worker.py
import logging
import os
...
def prewarm(proc: JobProcess):
    ...
    runtime = AsyncBithuman(model_path=bithuman_model_path, api_secret=bithuman_api_secret, load_model=True)
