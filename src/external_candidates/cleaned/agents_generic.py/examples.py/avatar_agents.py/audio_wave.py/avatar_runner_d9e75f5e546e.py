# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\avatar_agents\audio_wave\avatar_runner.py
import asyncio
import logging
import sys
import time
    ...
    async def _video_generation_impl(
        ...
        while True:
            try:
                ...
                frame = await asyncio.wait_for(self._audio_queue.get(), timeout=0.5 / self._options.video_fps)
