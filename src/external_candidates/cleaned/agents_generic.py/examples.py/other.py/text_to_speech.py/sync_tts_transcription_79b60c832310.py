# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\other\text-to-speech\sync_tts_transcription.py
import asyncio
import logging
...
async def entrypoint(ctx: JobContext):
    ...
    tts_forwarder = transcription.TTSSegmentsForwarder(room=ctx.room, participant=ctx.room.local_participant)
