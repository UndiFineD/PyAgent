# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\drive-thru\drivethru_agent.py
import os
import sys
...
class DriveThruAgent(Agent):
    def __init__(self, *, userdata: Userdata) -> None:
        ...
        super().__init__(
            ...
            tools=[
                self.build_regular_order_tool(userdata.regular_items, userdata.drink_items, userdata.sauce_items),
                self.build_combo_order_tool(userdata.combo_items, userdata.drink_items, userdata.sauce_items),
                self.build_happy_order_tool(userdata.happy_items, userdata.drink_items, userdata.sauce_items),
            ],
        )
    ...
    def build_regular_order_tool(
        ...
        async def order_regular_item(
            ...
            size: Annotated[
                ...
                Field(description="Size of the item, if applicable (e.g., 'S', 'M', 'L'), otherwise 'null'. "),
            ] = "null",
        ) -> str:
            """
