# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\drive-thru\order.py
...
OrderedItem = Annotated[Union[OrderedCombo, OrderedHappy, OrderedRegular], Field(discriminator="type")]
