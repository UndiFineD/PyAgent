# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\drive-thru\database.py
...
def find_items_by_id(items: list[MenuItem], item_id: str, size: ItemSize | None = None) -> list[MenuItem]:
