# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\raw_function_description.py
import logging
            ...
            "parameters": {
                ...
                "properties": {
                    "gate_id": {
                        "type": "string",
                        "description": (
                            "Identifier of the gate to open. Must be one of the system's predefined access points."
                        ),
                        "enum": [
                            "main_entrance",
                            "north_parking",
