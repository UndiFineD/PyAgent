# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\fast-preresponse.py
import asyncio
import logging
...
class PreResponseAgent(Agent):
    ...
    async def on_user_turn_completed(self, turn_ctx: ChatContext, new_message: ChatMessage):
        ...
        fast_llm_ctx = turn_ctx.copy(exclude_instructions=True, exclude_function_call=True).truncate(max_items=3)
