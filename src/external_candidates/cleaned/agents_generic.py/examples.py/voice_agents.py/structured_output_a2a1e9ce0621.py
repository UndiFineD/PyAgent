# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\structured_output.py
import logging
...
class MyAgent(Agent):
    ...
    async def transcription_node(self, text: AsyncIterable[str], model_settings: ModelSettings):
        ...
        return Agent.default.transcription_node(self, process_structured_output(text), model_settings)
