# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\speaker_id_multi_speaker.py
"""
...
async def entrypoint(ctx: agents.JobContext) -> None:
    ...
    await session.generate_reply(instructions="Kick off with a friendly Hello and get the conversation started!")
