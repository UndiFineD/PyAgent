# Extracted from: C:\DEV\PyAgent\.external\agents_generic\examples\voice_agents\realtime_joke_teller.py
"""
...
async def entrypoint(ctx: agents.JobContext):
    ...
    try:
        ...
        while True:
            ...
            done, _ = await asyncio.wait([participant_task, shutdown_future], return_when=asyncio.FIRST_COMPLETED)
