# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\ipc\inference_proc_lazy_main.py
...
class _InferenceProc:
    ...
    async def _handle_inference_request(self, msg: proto.InferenceRequest) -> None:
        ...
        try:
            data = await loop.run_in_executor(self._executor, self._runners[msg.method].run, msg.data)
            ...
            await self._client.send(proto.InferenceResponse(request_id=msg.request_id, error=str(e)))
