...
class _ProcClient:
    ...
    def initialize(self) -> None:
        try:
            ...
            assert isinstance(first_req, InitializeRequest), "first message must be proto.InitializeRequest"
    ...
    async def _monitor_task(self) -> None:
        ...
        try:
            ...
            main_task = asyncio.create_task(self._main_task_fnc(ipc_ch), name="main_task_entrypoint")
