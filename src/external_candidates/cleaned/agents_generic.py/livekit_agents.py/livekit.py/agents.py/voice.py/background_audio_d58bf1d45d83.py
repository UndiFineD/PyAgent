# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\voice\background_audio.py
...
class BackgroundAudioPlayer:
        ...
        *,
        ...
        async with self._lock:
            ...
            if cli.CLI_ARGUMENTS is not None and cli.CLI_ARGUMENTS.console:
                logger.warning("Background audio is not supported in console mode. Audio will not be played.")
    ...
    async def _play_task(self, play_handle: PlayHandle, sound: AudioSource, volume: float, loop: bool) -> None:
