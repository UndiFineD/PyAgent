# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-agents\livekit\agents\voice\chat_cli.py
...
class _AudioOutput(io.AudioOutput):
    ...
    def flush(self) -> None:
        ...
        if self._capturing:
            ...
            self._dispatch_handle = self._cli._loop.call_later(to_wait, self._dispatch_playback_finished)
