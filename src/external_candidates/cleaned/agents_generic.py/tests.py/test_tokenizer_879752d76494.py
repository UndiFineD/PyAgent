# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_tokenizer.py
import pytest
...
REPLACE_TEXT = "This is a test. Hello world, I'm creating this agents..     framework. Once again framework.  A.B.C"
REPLACE_EXPECTED = (
    "This is a test. Hello universe, I'm creating this assistants..     library. twice again library.  A.B.C.D"
)
...
async def test_replace_words_async():
    ...
    async for chunk in tokenize.utils.replace_words(text=_replace_words_async(), replacements=REPLACE_REPLACEMENTS):
