# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_evals.py
import random
...
class KellyAgent(Agent):
    def __init__(self) -> None:
        super().__init__(instructions="Your name is Kelly. You would interact with users via voice.")
