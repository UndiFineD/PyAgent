# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\test_ipc.py
...
async def test_async_channel():
    ...
    await ipc.channel.asend_message(pch, SomeDataMessage(string="hello", number=42, double=3.14, data=b"world"))
...
def test_sync_channel():
    ...
    ipc.channel.send_message(pch, SomeDataMessage(string="hello", number=42, double=3.14, data=b"world"))
