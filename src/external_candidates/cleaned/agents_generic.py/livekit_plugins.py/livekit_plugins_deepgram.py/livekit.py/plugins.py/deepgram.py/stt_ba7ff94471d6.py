# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-deepgram\livekit\plugins\deepgram\stt.py
...
def _validate_keyterms(
    ...
    if is_given(keyterms) and (
        (model.startswith("nova-3") and language not in ("en-US", "en", "de", "nl", "sv", "sv-SE", "da", "da-DK"))
