# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-anam\livekit\plugins\anam\avatar.py
...
class AvatarSession:
    ...
    def __init__(
        ...
        *,
        ...
        api_url_val = api_url if utils.is_given(api_url) else os.getenv("ANAM_API_URL", DEFAULT_API_URL)
