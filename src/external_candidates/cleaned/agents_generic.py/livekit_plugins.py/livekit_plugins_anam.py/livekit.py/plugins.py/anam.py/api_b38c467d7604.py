# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-anam\livekit\plugins\anam\api.py
...
class AnamAPI:
    ...
    async def create_session_token(self, persona_config: PersonaConfig, livekit_url: str, livekit_token: str) -> str:
        """
