# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-turn-detector\livekit\plugins\turn_detector\base.py
...
class _EUORunnerBase(_InferenceRunner):
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            sess_options.intra_op_num_threads = max(1, min(math.ceil(hw.get_cpu_monitor().cpu_count()) // 2, 4))
