# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-openai\livekit\plugins\openai\utils.py
...
def to_fnc_ctx(
    ...
    for fnc in fnc_ctx:
        if is_raw_function_tool(fnc):
            ...
            schema = llm.utils.build_strict_openai_schema(fnc) if strict else llm.utils.build_legacy_openai_schema(fnc)
