# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-anthropic\livekit\plugins\anthropic\utils.py
...
def to_fnc_ctx(
    fncs: list[Union[FunctionTool, RawFunctionTool]],
