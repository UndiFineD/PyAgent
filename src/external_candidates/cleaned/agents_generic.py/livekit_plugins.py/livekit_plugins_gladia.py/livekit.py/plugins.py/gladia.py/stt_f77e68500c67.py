        ...
        *,
        ...
        if languages is not None or code_switching is not None:
            language_config = dataclasses.replace(
                ...
                code_switching=(
                    code_switching if code_switching is not None else self._opts.language_config.code_switching
                ),
            )
        ...
        if (
            ...
            translation_config = dataclasses.replace(
                ...
                enabled=(
                    translation_enabled if translation_enabled is not None else self._opts.translation_config.enabled
                ),
                target_languages=(
                ...
                lipsync=(
                    translation_lipsync if translation_lipsync is not None else self._opts.translation_config.lipsync
                ),
                context_adaptation=(
                ...
                context=(
                    translation_context if translation_context is not None else self._opts.translation_config.context
                ),
                informal=(
                    translation_informal if translation_informal is not None else self._opts.translation_config.informal
                ),
            )
