        ...
        data = {
            ...
            "options": {
                "loudness_normalization": (
                    self._opts.loudness_normalization if is_given(self._opts.loudness_normalization) else None
                ),
                "text_normalization": (
                    self._opts.text_normalization if is_given(self._opts.text_normalization) else None
                ),
            },
        }
