# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\Wonderful_workflow_corpus\invest\html_report_generator.py
#!/usr/bin/env python3
"""
        ...
        for row in rows:
            ...
            for i, cell in enumerate(row):
                ...
                # Handle news title links
                    ...
                    is_news_table
                    and has_link_column
                    and any(keyword in header_name for keyword in ["新闻标题", "标题", "title"])
                ):
                    ...
                    if link_index is not None and link_index < len(row):
                        ...
                        if (
                            ...
                            and ("http://" in link_url.lower() or "https://" in link_url.lower())
                        ):
                            cells_html.append(
