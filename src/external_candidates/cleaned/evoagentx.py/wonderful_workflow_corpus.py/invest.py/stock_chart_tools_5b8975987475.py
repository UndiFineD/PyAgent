# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\Wonderful_workflow_corpus\invest\stock_chart_tools.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
股票技术分析图表生成工具
...
def generate_stock_charts(
    symbol: str = "300750", output_dir: str = "output", chart_types: List[str] = None
