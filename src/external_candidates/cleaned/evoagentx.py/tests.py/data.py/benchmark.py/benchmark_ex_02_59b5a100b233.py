# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\tests\data\benchmark\benchmark_ex_02.py
import os
...
class MessageBenchmark(Benchmark):
    ...
    def evaluate(self, prediction, label):
        from evoagentx.benchmark.measures import acc_score, exact_match_score, f1_score
...
with suppress_logger_info():
    try:
        ...
        print(
            "benchmark.get_train_data(sample_k=1)[0]:",
            benchmark.get_train_data(sample_k=1)[0],
        )
        ...
        for idx, gold_item in enumerate(gold_50):
            ...
            if not item:
                ...
                try:
                    ...
                    traceback.print_exc()
                    nodes, edges = [], []
            pred_records.append({"id": gold_item["id"], "workflow": {"nodes": nodes, "edges": edges}})
