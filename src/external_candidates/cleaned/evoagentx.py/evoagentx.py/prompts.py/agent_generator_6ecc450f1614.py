# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\prompts\agent_generator.py
...
AGENT_GENERATION_ACTION_DESC = (
    "This action focuses on a single sub-task within a workflow. It analyzes the sub-task's requirements and objectives, \
