# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\image_tools\openai_image_tools\image_edit.py
...
class OpenAIImageEditTool(Tool):
    ...
    inputs: Dict[str, Dict[str, str]] = {
        ...
        "images": {
            "type": "array",
            "description": "Image path(s) png/webp/jpg <50MB. Required. Single string accepted and normalized to array.",
        },
        "mask_path": {
            "type": "string",
            "description": "Optional PNG mask path (same size as first image).",
        },
        "size": {
            "type": "string",
