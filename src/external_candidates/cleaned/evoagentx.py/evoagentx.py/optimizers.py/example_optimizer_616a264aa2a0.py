# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\optimizers\example_optimizer.py
import random
...
class ExampleOptimizer(BaseOptimizer):
    ...
    def optimize(self, program_entry: Optional[Callable] = None) -> Tuple[Dict[str, Any], List[Dict[str, Any]]]:
        ...
        for i in range(self.n_trials):
            ...
            cfg = {name: random.choice(choices) for name, choices in self.search_space.items()}
