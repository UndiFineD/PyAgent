# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\models\workflow_demo_lite_azure.py
"""
...
def build_workflow_from_plan(llm: LiteLLM, goal: str, plan, output_dir: str):
    ...
    print(
        f"Workflow graph construction completed, containing {len(workflow.nodes)} nodes and {len(workflow.edges)} edges"
    )
    return workflow
