# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\odrobnik.py\withings_family.py\scripts.py\withings_bc589b11cd2c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\odrobnik\withings-family\scripts\withings.py
...
def get_weight(user_id="default"):
    ...
    for grp in data["measuregrps"]:
        ...
        if meas:
            ...
            measures.append({"date": date, "weight": f"{weight:.2f} kg"})
...
def get_body(user_id="default", limit=None):
    ...
    data = post_request("/measure", {"action": "getmeas", "access_token": token, "category": 1})
