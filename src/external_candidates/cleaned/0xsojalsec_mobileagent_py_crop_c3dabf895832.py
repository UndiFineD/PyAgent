# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\mobile_agent_e.py\mobileagente.py\crop_c3dabf895832.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\Mobile-Agent-E\MobileAgentE\crop.py
