# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\test_common_coverage_d19125732a4f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_common_coverage.py
...
_format_diff_with_syntax_highlighting = common_module._format_diff_with_syntax_highlighting
...
class TestGetLexerForExtension:
    ...
    def test_extension_to_lexer_mapping(self):
        ...
        for ext, lexer_name in expected.items():
            assert EXTENSION_TO_LEXER_NAME.get(ext) == lexer_name, f"Expected {ext} -> {lexer_name}"
...
+new_line"""
        ...
        result = _format_diff_with_syntax_highlighting(diff, addition_color="#224422", deletion_color="#442222")
...
+added"""
    ...
    def test_handles_empty_diff(self):
        ...
        result = _format_diff_with_syntax_highlighting("", addition_color="#224422", deletion_color="#442222")
