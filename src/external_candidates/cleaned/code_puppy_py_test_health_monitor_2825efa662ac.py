# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\mcp.py\test_health_monitor_2825efa662ac.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_health_monitor.py
...
class TestHealthMonitor:
    ...
    async def test_check_health_success(self, health_monitor, mock_server):
        ...
        with patch.object(health_monitor, "perform_health_check") as mock_perform:
            mock_perform.return_value = HealthCheckResult(success=True, latency_ms=50.0, error=None)
    ...
    async def test_check_health_failure(self, health_monitor, mock_server):
        ...
        with patch.object(health_monitor, "perform_health_check") as mock_perform:
            mock_perform.return_value = HealthCheckResult(success=False, latency_ms=100.0, error="Connection failed")
    ...
    async def test_perform_health_check_boolean_result(self, health_monitor, mock_server):
    ...
    async def test_perform_health_check_result_object(self, health_monitor, mock_server):
    ...
    async def test_perform_health_check_invalid_result(self, health_monitor, mock_server):
    ...
    async def test_consecutive_failures_handling(self, health_monitor, mock_server):
        ...
        async def mock_perform_fail(server):
            return HealthCheckResult(success=False, latency_ms=100.0, error="Always fails")
    ...
    async def test_sse_health_check_fallback_to_base_url(self, health_monitor, sse_server):
    ...
    async def test_http_health_check(self, health_monitor, http_server):
        ...
        with patch.object(health_monitor, "_check_sse_health") as mock_sse_check:
            mock_sse_check.return_value = HealthCheckResult(success=True, latency_ms=0.0, error=None)
    ...
    async def test_stdio_health_check_command_not_found(self, health_monitor, stdio_server):
    ...
    async def test_stdio_health_check_exception(self, health_monitor, stdio_server):
        ...
        stdio_server.get_pydantic_server.side_effect = Exception("Server creation failed")
