# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\anton_roos.py\finance.py\scripts.py\market_series_06cc68d020ec.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\anton-roos\finance\scripts\market_series.py
