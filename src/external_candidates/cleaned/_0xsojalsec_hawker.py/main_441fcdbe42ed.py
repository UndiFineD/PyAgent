# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Hawker\main.py
    ...
    def search_tor66_all_links(self, address, timeout=10):
        try:
            ...
            for link in soup.find_all("a", href=True):
                ...
                description = parent.get_text(strip=True) if parent else "No Description"
    ...
    try:
        while True:
            ...
            if command == "01" or command == "1":
                ...
                start_time()
                haw.title()
                tor_proxies = {"http": f"socks5h://{proxy}", "https": f"socks5h://{proxy}"} if proxy else None
