# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\visionik.py\ouracli.py\tests.py\test_formatters_extended_2bcd1669bb80.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\visionik\ouracli\tests\test_formatters_extended.py
...
class TestFormatMarkdownExtended:
    ...
    def test_mermaid_chart_included(self) -> None:
        ...
        data = {"activity": [{"day": "2025-01-01", "met": {"interval": 60.0, "items": [1.5] * 1440}}]}
...
class TestIntegration:
    ...
    def test_multiple_days_by_day(self) -> None:
        ...
        data = {
            ...
            "sleep": [
                {"day": "2025-01-01", "score": 75},
                {"day": "2025-01-02", "score": 80},
            ],
        }
