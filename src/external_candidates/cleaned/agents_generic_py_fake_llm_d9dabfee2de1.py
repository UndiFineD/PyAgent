# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\fake_llm_d9dabfee2de1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\fake_llm.py
...
class FakeLLM(LLM):
    def __init__(self, *, fake_responses: list[FakeLLMResponse] | None = None) -> None:
        ...
        self._fake_response_map = {resp.input: resp for resp in fake_responses} if fake_responses else {}
