    ...
    def _compose_options(self, runtime_options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        merged = {
            ...
            "encoding": runtime_options.get(
                "encoding",
                self._pipeline_defaults.get("encoding", self._provider_defaults.input_encoding),
            ),
            "sample_rate": runtime_options.get(
                "sample_rate",
                self._pipeline_defaults.get("sample_rate", self._provider_defaults.input_sample_rate_hz),
            ),
