    ...
    def _compose_options(self, runtime_options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        merged = {
            ...
            "organization": runtime_options.get(
                "organization",
                self._pipeline_defaults.get("organization", self._provider_defaults.organization),
            ),
    ...
    def _compose_options(self, runtime_options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        merged = {
            ...
            "chunk_size_ms": runtime_options.get(
                "chunk_size_ms",
                self._pipeline_defaults.get("chunk_size_ms", self._provider_defaults.chunk_size_ms),
            ),
            "timeout_sec": float(
                runtime_options.get(
                    "timeout_sec",
                    self._pipeline_defaults.get("timeout_sec", self._provider_defaults.response_timeout_sec),
                )
            ),
