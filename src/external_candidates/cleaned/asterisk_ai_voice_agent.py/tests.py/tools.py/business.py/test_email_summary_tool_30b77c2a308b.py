# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\tools\business\test_email_summary_tool.py
"""
...
class TestEmailSummaryTool:
    ...
    async def test_tool_disabled(self, email_summary_tool, tool_context):
        ...
        with patch.object(tool_context, "get_config_value") as mock_config:
            ...
            result = await email_summary_tool.execute(parameters={}, context=tool_context)
    ...
    @pytest.mark.asyncio
    async def test_email_without_transcript_when_disabled(self, email_summary_tool, tool_context, sample_call_session):
    ...
    async def test_missing_session(self, email_summary_tool, enabled_email_config):
        ...
        result = await email_summary_tool.execute(parameters={}, context=mock_context)
    ...
    @pytest.mark.asyncio
    async def test_exception_during_execution(self, email_summary_tool, tool_context, enabled_email_config):
    ...
    @pytest.mark.asyncio
    async def test_custom_admin_email(self, email_summary_tool, tool_context, sample_call_session):
