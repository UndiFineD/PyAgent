# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wifiphisher\tests\test_deauth.py
# pylint: skip-file
...
class TestDeauth(unittest.TestCase):
    ...
    def setUp(self):
        ...
        custom_tuple = collections.namedtuple(
            "test",
            ("target_ap_bssid target_ap_channel rogue_ap_mac args target_ap_essid is_freq_hop_allowed"),
        )
