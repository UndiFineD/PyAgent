# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wifiphisher\wifiphisher\common\extensions.py
"""
...
class ExtensionManager(object):
    ...
    * each extension can define the backend method as follows:
    ...
    def init_extensions(self, shared_data):
        ...
        shared_data = collections.namedtuple("GenericDict", list(shared_data.keys()))(**shared_data)
