# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wifiphisher\wifiphisher\common\phishinghttp.py
import asyncio
import datetime
import json
import logging
    ...
    def post(self):
        ...
        try:
            ...
            if content_type.startswith(constants.VALID_POST_CONTENT_TYPE):
                ...
                if re.search(constants.REGEX_PWD, post_data, re.IGNORECASE) or re.search(
                    constants.REGEX_UNAME, post_data, re.IGNORECASE
                ):
