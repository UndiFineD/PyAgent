# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-wifiphisher\wifiphisher\extensions\deauth.py
"""
...
class Deauth(object):
    ...
    def _add_clients(self, sender, receiver, bssid):
        ...
        return (
            ...
            and (sender == bssid and (receiver, packets()) or receiver == bssid and (sender, packets()))
            or None
        )
