# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\rate_limit.py\rate_limiter_7c288ae6d25c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\rate_limit\rate_limiter.py
...
def rate_limit(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            limiter = _rate_limit_manager.get_limiter(limiter_key, max_rate, time_period)
