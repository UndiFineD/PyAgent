# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\workflow.py\invest.py\generate_report_2fae5d463af1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\workflow\invest\generate_report.py
...
def main():
    if len(sys.argv) != 5:
        ...
        print(
            "Example: python generate_report.py reports/300750_report.html 300750/reports/output_300750_20250725.md charts/technical.png charts/price_volume.png"
        )
