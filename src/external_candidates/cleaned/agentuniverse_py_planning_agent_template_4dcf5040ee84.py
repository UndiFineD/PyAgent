# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\template.py\planning_agent_template_4dcf5040ee84.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\template\planning_agent_template.py
...
class PlanningAgentTemplate(AgentTemplate):
    ...
    def add_output_stream(self, output_stream: Queue, agent_output: str) -> None:
        ...
        stream_output(
            output_stream,
            {
                "data": {"output": output, "agent_info": self.agent_model.info},
                "type": "planning",
            },
        )
