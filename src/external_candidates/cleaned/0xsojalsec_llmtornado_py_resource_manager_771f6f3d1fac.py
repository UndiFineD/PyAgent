# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_llmtornado.py\src.py\llmtornado.py\llmtornado.py\fskb.py\utils.py\resource_manager_771f6f3d1fac.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMTornado\src\LlmTornado.FsKb\LlmTornado.FsKb\fskb\utils\resource_manager.py
        ...
        while self._monitoring:
            try:
                ...
                self._should_throttle = (
                    self.current_cpu_percent > self.max_cpu_percent or self.current_memory_mb > self.max_memory_mb
                )
