...
class RecommendationEngine:
    ...
    def _calculate_confidence_adjustments(
        ...
        if (action == "LONG" and pattern_bias == "BULLISH") or (action == "SHORT" and pattern_bias == "BEARISH"):
            adjustments.append(("Pattern Confirmation", +10))

        elif (action == "LONG" and pattern_bias == "BEARISH") or (action == "SHORT" and pattern_bias == "BULLISH"):
    ...
    def _calculate_price_levels(self, action: str, entry_price: float, atr: float) -> Dict:
        """
