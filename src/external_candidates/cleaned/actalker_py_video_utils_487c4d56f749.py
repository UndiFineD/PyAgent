# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\utils.py\video_utils_487c4d56f749.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\utils\video_utils.py
