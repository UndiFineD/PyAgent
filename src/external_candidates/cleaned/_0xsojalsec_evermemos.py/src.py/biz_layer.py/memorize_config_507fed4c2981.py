# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\biz_layer\memorize_config.py
"""
...
class MemorizeConfig:
    ...
    def from_env(cls) -> "MemorizeConfig":
        ...
        return cls(
            cluster_similarity_threshold=float(os.getenv("CLUSTER_SIMILARITY_THRESHOLD", "0.3")),
            ...
            profile_enable_versioning=os.getenv("PROFILE_ENABLE_VERSIONING", "true").lower() == "true",
        )
