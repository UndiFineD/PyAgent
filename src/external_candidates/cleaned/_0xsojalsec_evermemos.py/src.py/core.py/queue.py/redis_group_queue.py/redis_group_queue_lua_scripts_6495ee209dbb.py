# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\queue\redis_group_queue\redis_group_queue_lua_scripts.py
"""
...
REBALANCE_PARTITIONS_SCRIPT = REBALANCE_PARTITIONS_SCRIPT.replace("__REBALANCE_FUNCTION__", REBALANCE_FUNCTION)
JOIN_CONSUMER_SCRIPT = JOIN_CONSUMER_SCRIPT.replace("__REBALANCE_FUNCTION__", REBALANCE_FUNCTION)
EXIT_CONSUMER_SCRIPT = EXIT_CONSUMER_SCRIPT.replace("__REBALANCE_FUNCTION__", REBALANCE_FUNCTION)
CLEANUP_INACTIVE_OWNERS_SCRIPT = CLEANUP_INACTIVE_OWNERS_SCRIPT.replace("__REBALANCE_FUNCTION__", REBALANCE_FUNCTION)
