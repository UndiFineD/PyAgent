# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\queue\redis_group_queue\redis_group_queue_item.py
"""
...
class SimpleQueueItem(RedisGroupQueueItem):
    ...
    def from_json_str(cls, json_str: str) -> "SimpleQueueItem":
        ...
        try:
            ...
            return cls(data=json_dict["data"], item_type=json_dict.get("item_type", "simple"))
