# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\tenants\tenant_contextvar.py
"""
...
current_tenant_contextvar: ContextVar[Optional[TenantInfo]] = ContextVar("current_tenant", default=None)
