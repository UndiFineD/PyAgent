# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\lifespan\milvus_lifespan.py
"""
    ...
    async def startup(self, app: FastAPI) -> Any:
        ...
        try:
            ...
            all_collection_classes = [
                ...
                if cls._COLLECTION_NAME is not None  # Classes with _COLLECTION_NAME are concrete
            ]
