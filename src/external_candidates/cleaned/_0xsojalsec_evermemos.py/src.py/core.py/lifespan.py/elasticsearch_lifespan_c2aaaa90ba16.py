# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\lifespan\elasticsearch_lifespan.py
"""
...
class ElasticsearchLifespanProvider(LifespanProvider):
    ...
    async def startup(self, app: FastAPI) -> Any:
        ...
        try:
            ...
            self._es_factory: ElasticsearchClientFactory = get_bean_by_type(ElasticsearchClientFactory)
