# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\oxm\milvus\async_collection.py
import asyncio
import contextvars
...
class AsyncCollection:
    ...
    async def insert(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.insert)(data, partition_name, timeout, **kwargs)
    ...
    async def query(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.query)(expr, output_fields, partition_names, timeout, **kwargs)
    ...
    async def delete(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.delete)(expr, partition_name, timeout, **kwargs)
    ...
    async def load(
        ...
        **kwargs,
        ...
        """Asynchronously load."""
        return await async_wrap(self._collection.load)(partition_names, replica_number, timeout, **kwargs)
    ...
    async def compact(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.compact)(is_clustering, timeout, **kwargs)
    ...
    async def get_compaction_state(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.get_compaction_state)(timeout, is_clustering, **kwargs)
    ...
    async def get_compaction_plans(
        ...
        **kwargs,
        ...
        return await async_wrap(self._collection.get_compaction_plans)(timeout, is_clustering, **kwargs)
