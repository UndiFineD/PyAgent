# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\di\tests\test_di_scanner.py
# -*- coding: utf-8 -*-
"""
...
class TestInterfaceImplementationScanning:
    ...
    def test_register_interface_implementations(self):
        ...
        self.container.register_bean(bean_type=MySQLUserRepository, bean_name="mysql_user_repo", is_primary=True)
    ...
    def test_multiple_implementations_of_interface(self):
        ...
        self.container.register_bean(bean_type=MockUserRepository, bean_name="mock_repo", is_mock=True)
...
class TestScanContextAndMetadata:
    ...
    def test_metadata_from_decorator(self):
        ...
        @component(name="test_metadata_comp_unique_1", metadata={"env": "test", "priority": 10})
...
class TestEdgeCases:
    ...
    def test_duplicate_bean_name(self):
        ...
        # Register first Bean
        self.container.register_bean(bean_type=MySQLUserRepository, bean_name="same_name")

        # Attempt to register Bean with same name should raise exception
        with pytest.raises(DuplicateBeanError):
            self.container.register_bean(bean_type=PostgreSQLUserRepository, bean_name="same_name")
