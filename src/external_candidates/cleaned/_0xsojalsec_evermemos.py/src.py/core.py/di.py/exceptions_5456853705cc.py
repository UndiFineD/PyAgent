# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\di\exceptions.py
# -*- coding: utf-8 -*-
"""
...
class DependencyResolutionError(DIException):
    ...
    def __init__(self, target_type: Type, missing_dependency: Type):
        ...
        super().__init__(f"Cannot resolve dependency '{missing_dependency.__name__}' for '{target_type.__name__}'")
