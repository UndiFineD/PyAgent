...
paths_registry.add_scan_path(os.path.join(get_base_scan_path(), "core/interface/controller/debug"))
...
task_directories_registry.add_scan_path(os.path.join(get_base_scan_path(), "core/asynctasks/examples"))
task_directories_registry.add_scan_path(os.path.join(get_base_scan_path(), "infra_layer/adapters/input/jobs"))
