# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\milvus\memory\episodic_memory_collection.py
"""
...
class EpisodicMemoryCollection(TenantAwareMilvusCollectionWithSuffix):
    ...
    _SCHEMA = CollectionSchema(
        fields=[
            ...
            FieldSchema(name="timestamp", dtype=DataType.INT64, description="Event timestamp"),
            FieldSchema(
                name="episode",
                dtype=DataType.VARCHAR,
                max_length=10000,
