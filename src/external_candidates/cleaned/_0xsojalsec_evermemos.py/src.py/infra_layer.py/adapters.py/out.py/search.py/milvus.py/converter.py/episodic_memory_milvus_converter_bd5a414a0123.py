# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\milvus\converter\episodic_memory_milvus_converter.py
"""
    ...
    def from_mongo(cls, source_doc: MongoEpisodicMemory) -> Dict[str, Any]:
        ...
        try:
            ...
            milvus_entity = {
                ...
                "participants": getattr(source_doc, "participants", []),  # Add participants
                ...
                "event_type": (str(source_doc.type) if hasattr(source_doc, "type") and source_doc.type else ""),
                ...
                "vector": (source_doc.vector if hasattr(source_doc, "vector") and source_doc.vector else []),
            }
