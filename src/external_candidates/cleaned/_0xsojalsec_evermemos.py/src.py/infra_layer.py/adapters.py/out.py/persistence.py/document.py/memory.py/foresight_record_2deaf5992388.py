# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\persistence\document\memory\foresight_record.py
"""
...
class ForesightRecord(DocumentBase, AuditBase):
    ...
    # Time range fields
    start_time: Optional[str] = Field(default=None, description="Foresight start time (date string, e.g., 2024-01-01)")
    end_time: Optional[str] = Field(default=None, description="Foresight end time (date string, e.g., 2024-12-31)")
    ...
    # Vector and model
    vector: Optional[List[float]] = Field(default=None, description="Text vector of the foresight")
    vector_model: Optional[str] = Field(default=None, description="Vectorization model used")

    # Evidence and extension information
    evidence: Optional[str] = Field(default=None, description="Evidence supporting this foresight")
