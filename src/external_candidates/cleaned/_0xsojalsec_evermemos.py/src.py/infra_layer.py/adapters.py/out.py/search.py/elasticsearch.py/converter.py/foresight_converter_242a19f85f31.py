# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\elasticsearch\converter\foresight_converter.py
"""
...
class ForesightConverter(BaseEsConverter[ForesightDoc]):
    ...
    def from_mongo(cls, source_doc: MongoForesightRecord) -> ForesightDoc:
        ...
        try:
            ...
            logger.error("Failed to convert MongoDB foresight document to ES document: %s", e)
            raise
