# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\repository\event_log_es_repository.py
"""
...
class EventLogEsRepository(BaseRepository[EventLogDoc]):
    ...
    async def create_and_save_event_log(
        ...
        try:
            ...
            eventlog_extend.update({"parent_episode_id": parent_episode_id, "atomic_fact": atomic_fact})
