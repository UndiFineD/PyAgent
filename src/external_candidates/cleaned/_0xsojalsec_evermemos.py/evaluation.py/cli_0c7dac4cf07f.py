...
async def main():
    ...
    parser.add_argument("--dataset", type=str, required=True, help="Dataset name (e.g., locomo)")
    parser.add_argument("--system", type=str, required=True, help="System name (e.g., evermemos)")
    parser.add_argument(
        "--stages",
        nargs="+",
        default=None,
    ...
    if "memory_language" in dataset_config:
        ...
        console.print(f"  🌐 Memory language: {dataset_config['memory_language']} (from dataset config)")
    ...
    # Create evaluator
    evaluator = create_evaluator(dataset_config["evaluation"]["type"], dataset_config["evaluation"])
