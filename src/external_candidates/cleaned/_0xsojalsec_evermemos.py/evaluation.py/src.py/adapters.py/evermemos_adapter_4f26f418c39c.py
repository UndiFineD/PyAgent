# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\src\adapters\evermemos_adapter.py
"""
...
class EverMemOSAdapter(BaseAdapter):
    ...
    def _check_missing_indexes(self, index_dir: Path, num_conv: int, index_type: str = "bm25") -> List[int]:
        """
    ...
    async def add(
        ...
        **kwargs,
        ...
        pending_conversations = [conv for conv in conversations if conv.conversation_id not in completed_convs]
...
"""
    ...
    def _convert_config_to_experiment_config(self):
        ...
        if "enable_foresight_extraction" in add_config:
            exp_config.enable_foresight_extraction = add_config["enable_foresight_extraction"]
