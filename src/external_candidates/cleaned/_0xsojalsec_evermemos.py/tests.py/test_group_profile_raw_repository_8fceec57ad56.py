# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\tests\test_group_profile_raw_repository.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
async def test_version_management():
    ...
    try:
        ...
        v2_by_range = await repo.get_by_group_id(group_id, version_range=("202502", "202502"))
        ...
        v_multi_range = await repo.get_by_group_id(group_id, version_range=("202501", "202502"))
        ...
        updated_v2 = await repo.update_by_group_id(group_id, update_v2, version="202502")
...
async def test_ensure_latest():
    ...
    try:
        ...
        for old_version in ["202501", "202502", "202503"]:
            ...
            old_doc = await repo.get_by_group_id(group_id, version_range=(old_version, old_version))
...
async def test_create_without_version_should_fail():
    ...
    try:
        ...
        try:
            await repo.upsert_by_group_id(group_id, data_without_version, current_timestamp)
