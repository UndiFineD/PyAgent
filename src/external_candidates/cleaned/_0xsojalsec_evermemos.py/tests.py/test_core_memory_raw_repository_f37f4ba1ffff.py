# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\tests\test_core_memory_raw_repository.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
async def test_version_management():
    ...
    try:
        ...
        v2_by_range = await repo.get_by_user_id(user_id, version_range=("202502", "202503"))
...
async def test_ensure_latest():
    ...
    try:
        ...
        for old_version in ["202501", "202502", "202503"]:
            old_doc = await repo.get_by_user_id(user_id, version_range=(old_version, str(int(old_version) + 1)))
