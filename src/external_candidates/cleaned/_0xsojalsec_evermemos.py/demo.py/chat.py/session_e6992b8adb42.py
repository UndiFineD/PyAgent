# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\demo\chat\session.py
...
class ChatSession:
    ...
    async def chat(self, user_input: str) -> str:
        ...
        # Call LLM
        try:
            if hasattr(self.llm_provider, "provider") and hasattr(self.llm_provider.provider, "chat_with_messages"):
