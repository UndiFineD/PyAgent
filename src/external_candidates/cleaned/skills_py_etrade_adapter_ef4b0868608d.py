# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\clawback.py\src.py\clawback.py\etrade_adapter_ef4b0868608d.py
    ...
    def get_auth_url(self) -> Optional[str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                auth_url = (
                    f"{self.OAUTH_URLS['authorize']}?key={self.api_key}&token={quote(self.request_token, safe='')}"
                )
