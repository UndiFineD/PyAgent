# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\eval.py\samplers.py\test_kld_mean_sampler_22922b29d234.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\eval\samplers\test_kld_mean_sampler.py
...
class TestKLDiversityAchievementSampler(unittest.TestCase):
    def setUp(self):
        ...
        self.sampler = KLDiversityAchievementSampler(db_client=self.db_client, window_size=3, temperature=1.0)
