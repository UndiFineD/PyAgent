# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentcloud.py\agent_backend.py\src.py\chat.py\mongo_db_saver_3c18c1db1544.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentcloud\agent-backend\src\chat\mongo_db_saver.py
...
class AsyncMongoDBSaver(BaseCheckpointSaver):
    ...
    async def aput(
        ...
        await self.db["checkpoints"].update_one(upsert_query, {"$set": doc}, upsert=True)
