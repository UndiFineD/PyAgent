# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dgriffin831.py\skill_scan.py\skill_scan.py\alignment_analyzer_7df06523fc3c.py
...
class AlignmentAnalyzer:
    ...
    def analyze(
        ...
        return asyncio.run(self._analyze_async(metadata, skill_md_content, file_contents, llm_analyzer))
