# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_graph_r1.py\agent.py\vllm_infer.py\run_9c5d7d9a5c7b.py
...
def parse_args():
    ...
    parser.add_argument("--top-p", type=float, default=1.0, help="Top-p for nucleus sampling")
    ...
    parser.add_argument("--max-turns", type=int, default=20, help="Maximum turns of search")
