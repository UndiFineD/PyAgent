# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\hugosbl.py\french_services.py\scripts.py\sncf_854e358b5a83.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\hugosbl\french-services\scripts\sncf.py
...
def parse_datetime(date_str, time_str=None):
    ...
    if date_str == "demain":
        ...
        try:
            ...
            try:
                ...
                print(
                    "   Formats acceptés : YYYY-MM-DD, DD/MM/YYYY, demain, après-demain",
                    file=sys.stderr,
                )
    ...
    if time_str:
        try:
            ...
            print(
                f"❌ Format d'heure invalide : {time_str} (attendu HH:MM)",
                file=sys.stderr,
            )
