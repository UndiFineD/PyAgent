# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\apollo_io.py\scripts.py\search_companies_7c484fb94f38.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\apollo-io\scripts\search_companies.py
...
def main():
    ...
    parser.add_argument(
        "--size",
        help="Employee range (e.g., '1-10', '11-50', '51-200', '201-500', '501-1000', '1001-5000', '5001-10000', '10001+')",
    )
    ...
    try:
        ...
        print(
            f"Found {len(companies)} companies (page {pagination.get('page', 1)} of {pagination.get('total_pages', 1)}):\n"
        )
