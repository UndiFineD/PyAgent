# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\models.py\openrouter_model_7c361a5981a0.py
    ...
    async def single_generate_async(self, messages: List[dict], **kwargs) -> str:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None,
                lambda: isolated_client.chat.completions.create(messages=messages, **completion_params),
            )
