# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\backtesting\abstract_backtesting_test.py
...
SYMBOLS = {
    "Bitcoin": {"pairs": ["BTC/USDT"]},
    "Neo": {"pairs": ["NEO/BTC"]},
    "Ethereum": {"pairs": ["ETH/USDT"]},
    "Icon": {"pairs": ["ICX/BTC"]},
    "VeChain": {"pairs": ["VEN/BTC"]},
    "Nano": {"pairs": ["XRB/BTC"]},
    "Cardano": {"pairs": ["ADA/BTC"]},
    "Ontology": {"pairs": ["ONT/BTC"]},
    "Stellar": {"pairs": ["XLM/BTC"]},
    "Power Ledger": {"pairs": ["POWR/BTC"]},
    "Ethereum Classic": {"pairs": ["ETC/BTC"]},
    "WAX": {"pairs": ["WAX/BTC"]},
    "XRP": {"pairs": ["XRP/BTC"]},
    "Verge": {"pairs": ["XVG/BTC"]},
}
...
DATA_FILES = {
    "ADA/BTC": path.join(
        constants.OPTIMIZER_DATA_FILES_FOLDER,
...
class AbstractBacktestingTest:
    ...
    async def run_test_slow_downtrend(
        self,
        profitability_1,
        profitability_2,
        profitability_3,
    ...
    async def run_test_flat_markets(
        self,
        profitability_1,
        profitability_2,
        profitability_3,
    ...
    def _register_only_strategy(self, strategy_evaluator_class):
        try:
            ...
            tentacles_activation[tentacles_manager_constants.TENTACLES_EVALUATOR_PATH][
                strategy_evaluator_class.get_name()
            ] = True
