# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\models\startup_info.py
...
class StartupInfo:
    ...
    def __str__(self):
        return (
            f"forced_profile_url: {self.forced_profile_url}, subscribed_products_urls: {self.subscribed_products_urls}"
        )
