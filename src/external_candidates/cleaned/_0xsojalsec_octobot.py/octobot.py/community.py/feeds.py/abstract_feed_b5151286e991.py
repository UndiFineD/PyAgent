# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\feeds\abstract_feed.py
...
class AbstractFeed:
    def __init__(self, feed_url, authenticator):
        self.logger: bot_logging.BotLogger = bot_logging.get_logger(self.__class__.__name__)
