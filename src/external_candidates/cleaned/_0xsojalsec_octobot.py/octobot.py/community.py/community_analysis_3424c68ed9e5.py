# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\octobot\community\community_analysis.py
...
async def _get_stats(endpoint_by_key):
    ...
    await asyncio.gather(*(get_stats(endpoint, key) for key, endpoint in endpoint_by_key.items()))
