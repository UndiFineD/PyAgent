# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\tests\unit_tests\test_configuration_manager.py
...
def test_init_config():
    ...
    init_config(
        ...
        from_config_file=os.path.join(TEST_CONFIG_FOLDER, CONFIG_FILE),
    )
