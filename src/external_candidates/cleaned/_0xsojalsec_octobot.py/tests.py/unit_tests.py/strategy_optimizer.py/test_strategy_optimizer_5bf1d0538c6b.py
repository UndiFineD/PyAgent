# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\tests\unit_tests\strategy_optimizer\test_strategy_optimizer.py
...
class StrategyTestSuiteMock(mock.Mock):
    ...
    def get_test_suite_result(self, *_, **__):
        ...
        return strategy_optimizer.TestSuiteResult(
            [(1, 0), (0, -1)], [1, 2], 1, ["tf1", "tf2"], [strategy_name], strategy_name
        )


def test_find_optimal_configuration():
    with (
        mock.patch.object(strategy_optimizer, "StrategyTestSuite", StrategyTestSuiteMock()) as test_suite_mock,
