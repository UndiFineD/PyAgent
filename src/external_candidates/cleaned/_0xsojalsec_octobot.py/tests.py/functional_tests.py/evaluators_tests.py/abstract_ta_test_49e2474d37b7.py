# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\tests\functional_tests\evaluators_tests\abstract_TA_test.py
...
class AbstractTATest:
        ...
        try:
            ...
            with (
                ...
                for symbol in self.data_bank.data_importer.symbols:
                    ...
                    for (
                    ...
                    ) in self.data_bank.origin_ohlcv_by_symbol[symbol].items():
                        if (
                            TimeFramesMinutes[time_frame] > TimeFramesMinutes[TimeFrames.THREE_DAYS]
                            and skip_long_time_frames
                        ):
                            continue
                        ...
                        if total_candles_count > start_point:
                            ...
                            assert (
                                not_neutral_evaluation_count / (total_candles_count - start_point)
    ...
    async def run_test_reactions_to_dump(
        self,
        pre_dump_eval,
    ...
    async def run_test_reactions_to_pump(
        self,
        pre_pump_eval,
    ...
    async def run_test_reactions_to_flat_trend(
        ...
        try:
            ...
            (
                ...
                micro_down9,
                back_up9,
            ) = self.data_bank.overall_flat_trend_mode()
