# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\additional_tests\exchanges_tests\test_bitmart.py
...
class TestBitMartAuthenticatedExchange(abstract_authenticated_exchange_tester.AbstractAuthenticatedExchangeTester):
    # enter exchange name as a class variable here
    EXCHANGE_NAME = "bitmart"
    EXCHANGE_TENTACLE_NAME = "BitMart"
    ORDER_CURRENCY = "BTC"
