# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-OctoBot\additional_tests\exchanges_tests\test_coinbase.py
...
class TestCoinbaseAuthenticatedExchange(abstract_authenticated_exchange_tester.AbstractAuthenticatedExchangeTester):
    ...
    SPECIAL_ORDER_TYPES_BY_EXCHANGE_ID: dict[
        ...
        "7e03c745-7340-49ef-8af1-b8f7fe431c8a": (
            "BTC/EUR",
            "order_type",
            "STOP_LIMIT",  # sell at a lower price
        ...
        "1e2f0918-5728-4c68-b8f4-6fd804396248": (
            "ETH/BTC",
            "order_type",
            "STOP_LIMIT",  # buy at a higher price
            octobot_trading.enums.TradeOrderType.STOP_LOSS.value,
        ...
        "f4016e50-1f0b-4caa-abe5-1ec00af18be9": (
            "ETH/BTC",
            "order_type",
            "STOP_LIMIT",  # buy at a lower price
