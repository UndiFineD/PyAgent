# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tts.py\vc.py\layers.py\freevc.py\speaker_encoder.py\speaker_encoder_ccd8ba106f03.py
...
class SpeakerEncoder(nn.Module):
    ...
    def embed_speaker(self, wavs: list[np.ndarray], **kwargs):
        ...
        raw_embed = torch.mean(
            torch.stack([self.embed_utterance(wav, return_partials=False, **kwargs) for wav in wavs]),
            dim=0,
        )
