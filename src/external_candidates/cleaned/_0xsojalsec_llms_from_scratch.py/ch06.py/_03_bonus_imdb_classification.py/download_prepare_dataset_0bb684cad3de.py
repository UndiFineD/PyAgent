# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LLMs-from-scratch\ch06\03_bonus_imdb-classification\download-prepare-dataset.py
...
def reporthook(count, block_size, total_size):
    ...
    if count == 0:
        ...
        sys.stdout.write(
            f"\r{int(percent)}% | {progress_size / (1024**2):.2f} MB | {speed:.2f} MB/s | {duration:.2f} sec elapsed"
        )
        sys.stdout.flush()
