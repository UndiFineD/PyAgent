...
def print_help_message() -> None:
    ...
    print("fanout")
    print("    Sends the payload to the selected servers, then shows each server's\n    interpretation of the payload.")
    print("raw_fanout")
    print(
            ...
            if command == ["help"]:
                ...
                for i in range(num_generations + 1):  # +1 because there's a zeroth generation: the seeds
                    try:
                        ...
                        print("Try running `reload` and it will probably work. This bug is being tracked here:")
