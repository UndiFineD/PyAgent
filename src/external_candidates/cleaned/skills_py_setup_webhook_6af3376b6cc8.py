# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\adboio.py\agentmail.py\scripts.py\setup_webhook_6af3376b6cc8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adboio\agentmail\scripts\setup_webhook.py
...
def main():
    ...
    parser.add_argument(
        ...
        help="Comma-separated event types (default: message.received)",
    )
