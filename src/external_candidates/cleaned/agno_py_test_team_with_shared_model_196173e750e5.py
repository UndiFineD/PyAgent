# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\teams.py\test_team_with_shared_model_196173e750e5.py
