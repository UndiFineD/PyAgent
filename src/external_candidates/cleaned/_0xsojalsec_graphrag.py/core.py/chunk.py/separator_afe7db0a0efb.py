# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Chunk\Separator.py
...
async def chunking_by_seperators(
    ...
    splitter = SeparatorSplitter(
        separators=[tiktoken_model.encode(sep) for sep in Default_text_separator],
