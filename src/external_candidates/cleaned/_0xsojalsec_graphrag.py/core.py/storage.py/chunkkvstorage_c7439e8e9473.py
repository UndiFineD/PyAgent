# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Storage\ChunkKVStorage.py
import os
import pickle
    ...
    async def load_chunk(self):
        ...
        if os.path.exists(self.dat_idx_pkl_file) and os.path.exists(self.dat_key_pkl_file):
            try:
                ...
                logger.info(f"Successfully loaded chunk data (idx and key) from: {self.dat_idx_pkl_file}")
                return True
