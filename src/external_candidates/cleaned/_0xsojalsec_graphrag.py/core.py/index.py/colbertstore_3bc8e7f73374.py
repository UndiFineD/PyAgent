# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GraphRAG\Core\Index\ColBertStore.py
import os
import shutil
...
class ColbertIndex(BaseIndex[IndexDict]):
    ...
    def load_from_disk(cls, persist_dir: str, index_name: str = "") -> "ColbertIndex":
        ...
        searcher = Searcher(index=index_name, index_root=persist_dir, config=colbert_config)
