# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\server.py\core.py\tests.py\service.py\test_block_search_c34a57790886.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\server\core\tests\service\test_block_search.py
...
class TestBlockSearch:
    ...
    async def test_search_path_blocks_basic(self, mock_block_search_get_embedding):
        ...
        async with db_client.get_session_context() as session:
            ...
            assert page1.id in result_ids or folder1.id in result_ids, "Should find ML-related content"
            ...
            if page2.id in result_ids:
                ...
                assert ml_distance < cooking_distance, "ML content should be more similar than cooking content"
