# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\utils.py\async_func_97ce3ede6232.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\utils\async_func.py
...
def sync_funcs_to_async(funcs: list[FunctionTool]) -> list[FunctionTool]:
    ...
    for func in funcs:
        ...
        async_funcs.append(FunctionTool(async_callable, deepcopy(func.openai_tool_schema)))
