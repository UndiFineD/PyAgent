# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\abrahamventura.py\roofing_knowledge_mentor.py\scripts.py\quick_validate_50c49fb99f27.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\abrahamventura\roofing-knowledge-mentor\scripts\quick_validate.py
...
def validate_skill_dir(root: Path) -> Tuple[List[str], List[str]]:
    ...
    if line_count > 500:
        warnings.append(f"SKILL.md is {line_count} lines (>500). Consider moving details into references/.")
