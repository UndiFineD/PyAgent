# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\browser.py\test_terminal_tools_0d1fdb9a909c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_terminal_tools.py
            ...
            with patch(
                ...
                with patch("code_puppy.tools.browser.terminal_tools.emit_info"):
                    with patch("code_puppy.tools.browser.terminal_tools.emit_success"):
                        ...
                        mock_page.goto.assert_called_once_with("http://localhost:8765/terminal")
            ...
            with patch(
                ...
                with patch("code_puppy.tools.browser.terminal_tools.emit_info"):
                    with patch("code_puppy.tools.browser.terminal_tools.emit_success"):
                        ...
                        mock_page.goto.assert_called_once_with("http://192.168.1.100:9000/terminal")
