# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\architect_sis.py\sis_skill.py\core.py\symbol_42e1448ba178.py
...
class SISSymbol:
    ...
    def get_partners(self) -> List["SISSymbol"]:
        ...
        return [
            SISSymbol._registry[r.partner_glyph] for r in self.relationships if r.partner_glyph in SISSymbol._registry
        ]
