# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\session_manager_2fe3dbc57ee9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\session_manager.py
    ...
    def detect_os(self, output: str):
        ...
        if "linux" in lower or "darwin" in lower:
            ...
            self.os_metadata_commands = [
                ...
                (
                    "os",
                    "((cmd.exe /c ver) | Select-String -Pattern 'Windows').Matches.Value",
                ),
                (
                    "arch",
                    'powershell.exe -Command "(Get-WmiObject Win32_OperatingSystem | Select-Object -ExpandProperty OSArchitecture)"',
                ),
            ]
