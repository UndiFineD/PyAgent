# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\open_strata.py\src.py\strata.py\utils.py\shared_search_c38bf6c69eca.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\src\strata\utils\shared_search.py
            ...
            for tool in tools:
                ...
                for param_type in ["path_params", "query_params"]:
                    ...
                    for param_name, param_info in params.items():
                        fields.append((f"{param_type}/{param_name}", param_name.lower(), 15))
                ...
                for param_name, param_info in response_schema.get("properties", {}).items():
                    fields.append((f"response_schema/{param_name}", param_name.lower(), 5))
