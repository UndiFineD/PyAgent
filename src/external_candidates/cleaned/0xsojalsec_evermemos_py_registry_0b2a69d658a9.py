# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\src.py\converters.py\registry_0b2a69d658a9.py
...
def _ensure_converter_loaded(name: str):
    ...
    if name not in _CONVERTER_MODULES:
        raise ValueError(f"Unknown converter: {name}. Available converters: {list(_CONVERTER_MODULES.keys())}")
