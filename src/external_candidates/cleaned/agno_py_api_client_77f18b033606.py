# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\infra.py\agno_docker.py\agno.py\docker.py\api_client_77f18b033606.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agno\libs\infra\agno_docker\agno\docker\api_client.py
    ...
    def create_api_client(self) -> Optional[Any]:
        ...
        try:
            ...
            logger.info(
                ...
                "- More info: https://docs.agno.com/faq/could-not-connect-to-docker"
