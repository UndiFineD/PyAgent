# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tts.py\tts.py\utils.py\text.py\phonemizers.py\belarusian_phonemizer_fdce3c7c5bdb.py
