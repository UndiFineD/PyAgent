# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2015.py\ka_playgrounds.py\jacobian_animations_0345eba055a8.py
...
class ExampleMultivariableFunctionWithZoom(ZoomedScene, ExampleMultivariableFunction):
    def construct(self):
        ...
        self.apply_nonlinear_transformation(
            example_function,
            added_anims=[ApplyMethod(self.little_rectangle.move_to, example_function(point), run_time=3)],
        )
