# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\tests.py\integration.py\agent.py\test_reasoning_content_default_cot_070369848858.py
