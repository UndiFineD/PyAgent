# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\agent.py\connect_entities.py\resolvers.py\fluid_connection_resolver_ab739ed61090.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\agent\connect_entities\resolvers\fluid_connection_resolver.py
        ...
        match source:
            ...
            case Boiler():
                ...
                source_water_positions = [
                    IndexedPosition(x=pos.x, y=pos.y, type="water") for pos in source.connection_points
                ]
            ...
            case PumpJack():
                source_positions = [
                    IndexedPosition(x=pos.x, y=pos.y, type="crude-oil") for pos in source.connection_points
                ]
            ...
            case FluidHandler():
                ...
                source_positions = [
                    IndexedPosition(x=pos.x, y=pos.y, type=source_liquid) for pos in source.connection_points
                ]
            ...
            case PipeGroup():
                ...
                underground_positions = set(
                    [pipe.position for pipe in source.pipes if pipe.prototype == Prototype.UndergroundPipe]
                )
        ...
        match target:
            ...
            case Boiler():
                ...
                target_water_positions = [
                    IndexedPosition(x=pos.x, y=pos.y, type="water") for pos in target.connection_points
                ]
            ...
            case PipeGroup():
                ...
                underground_positions = set(
                    [pipe.position for pipe in target.pipes if pipe.prototype == Prototype.UndergroundPipe]
                )
