# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chocomintx.py\xiaohongshutools.py\scripts.py\request.py\web.py\apis.py\comments_d609a282d1d6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chocomintx\xiaohongshutools\scripts\request\web\apis\comments.py
...
class Comments:
    ...
    async def create_comment(
        self, note_id: str, content: str, at_users: Optional[list] = None
    ) -> aiohttp.ClientResponse:
        """发表评论
        ...
        data = {"note_id": note_id, "content": content, "at_users": at_users or []}
