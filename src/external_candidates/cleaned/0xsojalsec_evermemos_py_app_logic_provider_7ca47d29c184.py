# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\request.py\app_logic_provider_7ca47d29c184.py
...
class AppLogicProvider(ABC):
    ...
    async def on_request_complete(self, request: Request, http_code: int, error_message: Optional[str] = None) -> None:
        """
