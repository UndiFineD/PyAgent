# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\search.py\elasticsearch.py\memory.py\foresight_943793a70f97.py
...
class ForesightDoc(TenantAwareAliasDoc("foresight", number_of_shards=3)):
    ...
    search_content = e_field.Text(
        ...
        required=True,
        analyzer="standard",
        fields={"original": e_field.Text(analyzer=lower_keyword_analyzer, search_analyzer=lower_keyword_analyzer)},
    )
