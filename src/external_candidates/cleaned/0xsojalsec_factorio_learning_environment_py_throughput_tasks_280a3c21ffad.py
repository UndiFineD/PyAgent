# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\tasks.py\task_definitions.py\lab_play.py\throughput_tasks_280a3c21ffad.py
