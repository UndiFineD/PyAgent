# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-llamafile\llama.cpp\llava\convert-image-encoder-to-gguf.py
import argparse
import json
import os
...
ap.add_argument(
    ...
    type=float,
    required=False,
    help="Override image mean values",
)
...
if has_vision_encoder:
    ...
    fout.add_uint32(
        ...
        v_hparams.get("projection_dim", config["projection_dim"]),
    )
