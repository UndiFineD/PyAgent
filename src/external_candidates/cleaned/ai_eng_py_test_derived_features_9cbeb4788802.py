# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\test.py\test_derived_features_9cbeb4788802.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\test\test_derived_features.py
...
def test_single_key_derived_feature_to_config():
    ...
    user_embedding = Feature(

        name="user_embedding", feature_type=FLOAT_VECTOR, key=user_key
...
def test_multikey_derived_feature_to_config():
    ...
    item_embedding = Feature(

        name="item_embedding", feature_type=FLOAT_VECTOR, key=item_key
    ...
    assert_config_equals(
        ...
        user_item_similarity.to_feature_config(), derived_feature_config
...
def test_derived_feature_to_config_with_alias():
    ...
    user_embedding = Feature(
        ...
        name="user_embedding", key=user_key, feature_type=FLOAT_VECTOR
    ...
    assert_config_equals(
        ...
        viewer_viewee_distance.to_feature_config(), expected_feature_config
...
def test_multi_key_derived_feature_to_config_with_alias():
    ...
    viewee_viewer_combined = DerivedFeature(
        ...
        input_features=[
            ...
            viewer_viewee_distance.with_key(["viewer", "viewee"]).as_feature(

                "viewer_viewee_distance"

            ),

            viewer_viewee_distance.with_key(["viewee", "viewer"]).as_feature(

                "viewee_viewer_distance"

            ),

        ],

        transform=ExpressionTransformation(

            "viewer_viewee_distance + viewee_viewer_distance"
    ...
    assert_config_equals(
        ...
        viewee_viewer_combined.to_feature_config(), expected_feature_config
...
def test_derived_feature_on_multikey_anchored_feature_to_config():
    ...
    user_embedding = Feature(
        ...
        name="user_embedding", feature_type=FLOAT_VECTOR, key=[user_key, user_key2]
