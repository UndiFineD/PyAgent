# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\mongodb_client_factory_b2e33e3e052c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\component\mongodb_client_factory.py
...
class MongoDBClientWrapper:
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.error("❌ MongoDB connection test failed: %s, error: %s", self.config, e)
        ...
        try:
            ...
            for collection_name in collections:
                try:
                    ...
                    logger.warning("Failed to get collection %s stats: %s", collection_name, e)
    ...
    async def get_client(self, config: Optional[MongoDBConfig] = None, **connection_kwargs) -> MongoDBClientWrapper:
        ...
        async with self._lock:
            ...
            try:
                ...
                logger.error("❌ Failed to create MongoDB client: %s, error: %s", config, e)
