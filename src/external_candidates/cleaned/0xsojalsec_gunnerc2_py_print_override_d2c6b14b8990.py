# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\print_override_d2c6b14b8990.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\print_override.py
...
def set_output_context(to_console: bool = True, to_op: str = None, world_wide: bool = False):
    ...
    logger.debug(
        "set_output_context: to_console=%r, to_op=%r, world_wide=%r",
        to_console,
        to_op,
        world_wide,
    )
...
def _print(*args, sep=" ", end="\n", color=None, **kwargs):
    ...
    logger.debug(
        "_print called: msg=%r, color=%r, to_console=%r, to_op=%r, world=%r, end=%r",
        msg,
        color,
        console,
        op,
