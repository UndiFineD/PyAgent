# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\feathr.py\registry.py\feathr_registry_client_2064ebec53a1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\registry\_feathr_registry_client.py
...
class _FeatureRegistry(FeathrRegistry):
    ...
    def register_features(
        ...
        logging.info(
            ...
            f"Check project lineage by this link: {url}/projects/{self.project_name}/lineage"
    ...
    def _create_anchor_feature(self, anchor_name: str, s: Feature) -> UUID:
        ...
        r = self._post(
            ...
            f"/projects/{self.project_id}/anchors/{anchor_name}/features",
    ...
    def _get(self, path: str) -> dict:
        ...
        return check(
            ...
            requests.get(f"{self.endpoint}{path}", headers=self._get_auth_header())
    ...
    def _delete(self, path: str) -> dict:
        ...
        return check(
            ...
            requests.delete(f"{self.endpoint}{path}", headers=self._get_auth_header())
    ...
    def _post(self, path: str, body: dict) -> dict:
        ...
        return check(
            ...
            requests.post(
                ...
                f"{self.endpoint}{path}", headers=self._get_auth_header(), json=body
...
def dict_to_project(v: dict) -> Tuple[List[FeatureAnchor], List[DerivedFeature]]:
    ...
    sources = dict(
        ...
        [
            ...
            (UUID(k), dict_to_source(entities[k]))

            for k in entities

            if entities[k]["typeName"] == "feathr_source_v1"
    ...
    anchors = dict(
        ...
        [
            ...
            (UUID(k), dict_to_anchor(entities[k]))

            for k in entities

            if entities[k]["typeName"] == "feathr_anchor_v1"
    ...
    for k in derived_features:
        ...
        input_derived_features = [
            ...
            derived_features[id] for id in df._input_derived_features
