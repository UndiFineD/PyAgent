# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\base.py\tracing.py\otel.py\propagator.py\au_session_propagator_62d490faf765.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\base\tracing\otel\propagator\au_session_propagator.py
...
from agentuniverse.base.tracing.au_trace_manager import get_session_id, set_session_id
