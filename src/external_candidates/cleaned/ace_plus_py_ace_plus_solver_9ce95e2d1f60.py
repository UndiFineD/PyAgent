# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ace_plus.py\modules.py\ace_plus_solver_9ce95e2d1f60.py
...
class FormalACEPlusSolver(LatentDiffusionSolver):
    ...
    def run_eval(self):
        ...
        self.register_probe({"eval_image": ProbeData(log_data, is_image=True, build_html=True, build_label=log_label)})
    ...
    def run_test(self):
        ...
        self.register_probe({"test_image": ProbeData(log_data, is_image=True, build_html=True, build_label=log_label)})
    ...
    def probe_data(self):
        ...
        if not we.debug and self.mode == "train":
            ...
            self.register_probe(
                {"train_image": ProbeData(log_data, is_image=True, build_html=True, build_label=log_label)}
            )
