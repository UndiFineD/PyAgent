# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\product_strategist.py\scripts.py\okr_cascade_generator_54c4be77e81b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\product-strategist\scripts\okr_cascade_generator.py
...
Examples:
  ...
  python okr_cascade_generator.py operational --teams "Core,Platform" --contribution 0.5 --json
    ...
    parser.add_argument("--json", "-j", action="store_true", help="Output as JSON instead of dashboard")
