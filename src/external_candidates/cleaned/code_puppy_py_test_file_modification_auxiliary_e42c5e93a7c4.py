# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_file_modification_auxiliary_e42c5e93a7c4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_file_modification_auxiliary.py
...
def test_write_to_file_binary_content(tmp_path):
    ...
    try:
        res = file_modifications._write_to_file(None, str(path), bin_content.decode(errors="ignore"), overwrite=False)
