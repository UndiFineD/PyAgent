...
class RoleChip(QStyledItemDelegate):
    ...
    def paint(self, p, opt, idx):
        ...
        bg = _qcolor(
            (theme_color("chip_operator_bg") if text == "operator" else theme_color("chip_admin_bg")),
            "#34425a" if text == "operator" else "#5a3434",
        )
        fg = _qcolor(
            (theme_color("chip_operator_fg") if text == "operator" else theme_color("chip_admin_fg")),
