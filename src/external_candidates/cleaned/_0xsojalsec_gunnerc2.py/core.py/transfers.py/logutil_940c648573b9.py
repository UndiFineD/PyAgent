# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\transfers\logutil.py
...
def setup_once():
    ...
    log_path = os.environ.get("GC2_TRANSFERS_LOG", os.path.join(os.getcwd(), "transfers.log"))
