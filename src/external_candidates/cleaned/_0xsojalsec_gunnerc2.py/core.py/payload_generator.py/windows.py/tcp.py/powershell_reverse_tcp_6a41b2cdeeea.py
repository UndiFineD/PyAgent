# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\payload_generator\windows\tcp\powershell_reverse_tcp.py
...
def generate_windows_powershell_tcp_obfuscate_level2(
    raw,
    ip,
    port,
    os_type,
