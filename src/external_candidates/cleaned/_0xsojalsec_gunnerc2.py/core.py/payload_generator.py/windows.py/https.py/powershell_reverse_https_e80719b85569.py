# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\payload_generator\windows\https\powershell_reverse_https.py
import base64
import random
import textwrap
...
def generate_windows_powershell_https(
    ip,
    port,
    obs,
    beacon_interval,
    ...
    if obs is None or obs == 0:
        ...
        payload = generate_windows_powershell_https_obfuscate_level1(
            ip,
            port,
            beacon_interval,
            headers,
...
def generate_windows_powershell_https_obfuscate_level1(
    ip,
    port,
    beacon_interval,
    headers,
