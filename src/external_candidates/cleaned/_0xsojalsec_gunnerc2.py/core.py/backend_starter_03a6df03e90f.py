# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\backend_starter.py
...
def ensure_backend_running(host: str | None = None, port: int | None = None) -> str:
    ...
    try:
        ...
        raise RuntimeError("uvicorn is not installed. Install with: pip install uvicorn fastapi")
