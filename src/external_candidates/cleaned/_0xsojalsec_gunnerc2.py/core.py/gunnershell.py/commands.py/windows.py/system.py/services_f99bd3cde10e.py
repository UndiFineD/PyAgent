# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\system\services.py
...
class ServicesCommand(Command):
    ...
    def logic(self, sid, os_type, action=None, svc_name=None, op_id="console"):
        ...
        out = (
            http_exec.run_command_http(sid, ps_cmd, op_id=op_id)
