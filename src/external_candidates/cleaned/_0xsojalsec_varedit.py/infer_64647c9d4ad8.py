# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infer.py
"""
...
def generate_image(
    ...
    assert image_size in [
        512,
        1024,
    ], f"Invalid image size: {image_size}, expected 512 or 1024"
    if image_size == 512:
        pn = "0.25M"
    elif image_size == 1024:
        pn = "1M"
...
def main():
    ...
    try:
        # Load model
        model_components = load_model("HiDream-ai/VAREdit", "HiDream-ai/VAREdit/8B-1024.pth", "8B", 1024)
