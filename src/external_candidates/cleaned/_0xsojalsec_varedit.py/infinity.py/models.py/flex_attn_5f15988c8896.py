# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infinity\models\flex_attn.py
"""
...
class FlexAttn(nn.Module):
    def __init__(self, block_scales: list, mask_type: str, B, H, L: int, auto_padding=False):
        """
        ...
        self.support_mask_type = [
            "var",
            "causal",
            "var_infer_mask_with_kv_cache",
            "var_edit_block",
        ]
        ...
        if mask_type == "var":
            ...
            self.block_mask = create_block_mask(
                self.mask_mod, B=B, H=H, Q_LEN=L, KV_LEN=L, device="cuda", _compile=True
            )
