# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infinity\models\bsq_vae\vae.py
import argparse
    ...
    for key in state_dict:
        if key.startswith(prefix):
            ...
            if _key in model.state_dict():
                ...
                if use_linear and (
                    ".q.weight" in key or ".k.weight" in key or ".v.weight" in key or ".proj_out.weight" in key
                ):
