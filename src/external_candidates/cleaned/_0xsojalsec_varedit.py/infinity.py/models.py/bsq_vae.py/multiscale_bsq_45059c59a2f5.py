# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-VAREdit\infinity\models\bsq_vae\multiscale_bsq.py
"""
...
class BSQ(Module):
    def __init__(
        ...
        *,
        ...
        self.project_out = (
            nn.Linear(codebook_dims, dim, bias=projection_has_bias) if has_projections else nn.Identity()
        )  # nn.Identity()
