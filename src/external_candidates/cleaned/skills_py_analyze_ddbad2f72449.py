# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\artur_zhdan.py\humanize_ai.py\scripts.py\analyze_ddbad2f72449.py
...
def analyze(text: str) -> dict:
    results = {
        ...
        "replaceable": [
            (k, text.lower().count(k.lower())) for k, v in PATTERNS["replacements"].items() if k.lower() in text.lower()
        ],
    }
