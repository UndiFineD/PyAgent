...
def main():
    ...
    mcp_instance = klavis_client.mcp_server.create_server_instance(server_name=McpServerName.NOTION, user_id="1234")
    print("--- mcp_instance --- \n", mcp_instance)
    ...
    mcp_tools = klavis_client.mcp_server.list_tools(server_url=mcp_instance.server_url, format=ToolFormat.GEMINI)
