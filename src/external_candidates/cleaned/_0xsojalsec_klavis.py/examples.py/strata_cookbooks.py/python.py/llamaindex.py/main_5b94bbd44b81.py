...
async def main():
    ...
    tools = await aget_tools_from_mcp_url(response.strata_server_url, client=BasicMCPClient(response.strata_server_url))
    ...
    youtube_video_url = (
        "https://youtu.be/yebNIHKAC4A?si=1Rz_ZsiVRz0YfOR7"  # TODO: Replace with your favorite youtube video URL
    )
