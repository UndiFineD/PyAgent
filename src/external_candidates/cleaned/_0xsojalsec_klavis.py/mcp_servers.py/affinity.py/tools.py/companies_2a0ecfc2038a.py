# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\affinity\tools\companies.py
import logging
...
async def get_company_fields_metadata(cursor: Optional[str] = None, limit: Optional[int] = None) -> Dict[str, Any]:
...
async def get_company_lists(
    company_id: int, cursor: Optional[str] = None, limit: Optional[int] = None
) -> Dict[str, Any]:
