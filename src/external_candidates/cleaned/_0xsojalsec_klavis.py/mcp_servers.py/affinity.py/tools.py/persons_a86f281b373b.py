# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\affinity\tools\persons.py
import logging
...
async def get_person_fields_metadata(cursor: Optional[str] = None, limit: Optional[int] = None) -> Dict[str, Any]:
...
async def get_person_lists(person_id: int, cursor: Optional[str] = None, limit: Optional[int] = None) -> Dict[str, Any]:
...
async def get_person_list_entries(
    person_id: int, cursor: Optional[str] = None, limit: Optional[int] = None
) -> Dict[str, Any]:
