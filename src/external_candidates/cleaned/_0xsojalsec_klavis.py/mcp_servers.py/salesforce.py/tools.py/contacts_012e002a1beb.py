# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\salesforce\tools\contacts.py
import logging
...
async def get_contacts(
    ...
    logger.info(
        f"Executing tool: get_contacts with account_id: {account_id}, limit: {limit}, name_contains: {name_contains}, email_contains: {email_contains}, title_contains: {title_contains}"
    )
    try:
