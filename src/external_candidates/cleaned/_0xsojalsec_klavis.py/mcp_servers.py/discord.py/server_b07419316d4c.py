# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\discord\server.py
import contextlib
import logging
import os
import urllib.parse
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "DISCORD_SERVER"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "DISCORD_MESSAGE"}),
            ),
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "DISCORD_REACTION"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "DISCORD_USER"}),
            ),
        ]
