# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\linear\server.py
import base64
import contextlib
import json
import logging
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "LINEAR_TEAM"}),
            ),
            types.Tool(
                            ...
                            "properties": {
                                ...
                                "updatedAt": {
                                    ...
                                    "properties": {
                                        "gte": {
                                            "type": "string",
                                            "description": "Greater than or equal to timestamp (ISO 8601)",
                                        },
                                        "gt": {
                                            "type": "string",
                                            "description": "Greater than timestamp (ISO 8601)",
                                        },
                                        "lte": {
                                            "type": "string",
                                            "description": "Less than or equal to timestamp (ISO 8601)",
                                        },
                                        "lt": {
                                            "type": "string",
                                            "description": "Less than timestamp (ISO 8601)",
                                        },
                                        "eq": {
                                            "type": "string",
                                            "description": "Equal to timestamp (ISO 8601)",
                                        },
                                    },
                                },
                                "createdAt": {
                ...
                annotations=types.ToolAnnotations(**{"category": "LINEAR_ISSUE"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "LINEAR_PROJECT"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "LINEAR_COMMENT"}),
            ),
            types.Tool(
