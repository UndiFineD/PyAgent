...
async def create_page(
    ...
    is_private: Annotated[
        bool,
        "If true, then only the user who creates this page will be able to see it. Defaults to False",
    ] = False,
    is_draft: Annotated[
        bool,
...
async def get_page(
    page_identifier: Annotated[str, "Can be a page's ID or title. Numerical titles are NOT supported."],
) -> Annotated[dict, "The page"]:
