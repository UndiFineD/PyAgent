# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\confluence\tools\attachment.py
...
async def get_attachments_for_page(
    ...
    limit: Annotated[int, "The maximum number of attachments to return. Defaults to 25. Max is 250"] = 25,
