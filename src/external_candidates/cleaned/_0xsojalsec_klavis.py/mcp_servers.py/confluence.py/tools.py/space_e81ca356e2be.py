# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\confluence\tools\space.py
import re
...
async def create_space(
    ...
    key: Annotated[
        str | None,
        "The key of the space. If not provided, one will be generated automatically",
    ] = None,
    ...
    if description:
        space_data["description"] = {"value": description, "representation": "plain"}
...
async def get_space(
    space_identifier: Annotated[str, "Can be a space's ID or key. Numerical keys are NOT supported"],
...
async def list_spaces(
    limit: Annotated[int, "The maximum number of spaces to return. Defaults to 25. Max is 250"] = 25,
    pagination_token: Annotated[str | None, "The pagination token to use for the next page of results"] = None,
