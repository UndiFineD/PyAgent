# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\markitdown\server.py
import contextlib
import logging
import os
import tempfile
...
async def convert_document_to_markdown(uri: str) -> str:
    ...
    if response.status_code == 200:
        ...
        with tempfile.NamedTemporaryFile(suffix=".pdf", delete=True, delete_on_close=True) as temp_file:
