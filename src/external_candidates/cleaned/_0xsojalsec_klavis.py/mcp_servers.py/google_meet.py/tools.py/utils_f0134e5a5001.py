# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\google_meet\tools\utils.py
...
def parse_rfc3339(value: str) -> _dt.datetime:
    if not is_rfc3339(value):
        raise ValidationError(f"Value '{value}' must be RFC3339 UTC (e.g. 2025-01-01T10:00:00Z)")
