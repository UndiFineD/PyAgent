# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\clickup\server.py
import base64
import contextlib
import json
import logging
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_TEAM"}),
            ),
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_WORKSPACE"}),
            ),
            # Space tools
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_SPACE"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_FOLDER"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_LIST"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_TASK"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_COMMENT"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "CLICKUP_USER"}),
            ),
            types.Tool(
            ...
            if name == "clickup_get_teams":
                ...
                if not team_id or not name:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: team_id and name parameters are required",
                        )
                    ]
                ...
                if not space_id or not name:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: space_id and name parameters are required",
                        )
                    ]
                ...
                if not folder_id or not name:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: folder_id and name parameters are required",
                        )
                    ]
                ...
                if not folder_id and not space_id:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: either folder_id or space_id parameter is required",
                        )
                    ]
                ...
                if not list_id or not name:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: list_id and name parameters are required",
                        )
                    ]
                ...
                if not team_id or not query:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: team_id and query parameters are required",
                        )
                    ]
                ...
                if not task_id or not comment_text:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: task_id and comment_text parameters are required",
                        )
                    ]
                ...
                if not comment_id or not comment_text:
                    return [
                        types.TextContent(
                            type="text",
                            text="Error: comment_id and comment_text parameters are required",
                        )
                    ]
