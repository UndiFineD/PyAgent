# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\tools\leads.py
import logging
...
async def search_leads(query: str, limit: Optional[int] = None, fields: Optional[str] = None, **kwargs) -> ToolResponse:
...
async def merge_leads(source_lead_id: str, destination_lead_id: str) -> ToolResponse:
    """Merge two leads."""
