# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\tools\opportunities.py
import logging
...
async def search_opportunities(query: str, limit: Optional[int] = None, **kwargs) -> ToolResponse:
