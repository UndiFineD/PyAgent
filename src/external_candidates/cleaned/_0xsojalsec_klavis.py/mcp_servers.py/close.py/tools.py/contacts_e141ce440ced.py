# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\tools\contacts.py
import logging
...
async def search_contacts(query: str, limit: Optional[int] = None, **kwargs) -> ToolResponse:
