# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\close\tools\users.py
import logging
...
async def list_users(limit: Optional[int] = None, skip: Optional[int] = None, **kwargs) -> ToolResponse:
...
async def search_users(query: str, limit: Optional[int] = None, **kwargs) -> ToolResponse:
