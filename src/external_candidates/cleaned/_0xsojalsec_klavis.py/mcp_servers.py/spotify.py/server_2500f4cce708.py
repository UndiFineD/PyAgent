# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\spotify\server.py
import contextlib
import json
import logging
import os
...
def main(
    ...
    async def call_tool(
        ...
        if name == "spotify_search_tracks":
            ...
            result = [types.TextContent(type="text", text=json.dumps(result, indent=2))]
