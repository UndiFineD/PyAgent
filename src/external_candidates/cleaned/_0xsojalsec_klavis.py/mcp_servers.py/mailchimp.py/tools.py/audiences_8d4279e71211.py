# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\mailchimp\tools\audiences.py
import logging
...
async def get_all_audiences(count: int = 10, offset: int = 0) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {"total_items": audiences_data.get("total_items"), "audiences": []}
        ...
        return {"error": "Failed to retrieve audiences", "exception": str(e)}
...
async def create_audience(
    ...
    try:
        ...
        return {"error": "Failed to create audience", "name": name, "exception": str(e)}
...
async def update_audience(
    ...
    try:
        ...
        if not payload:
            return {"error": "No update parameters provided", "list_id": list_id}
