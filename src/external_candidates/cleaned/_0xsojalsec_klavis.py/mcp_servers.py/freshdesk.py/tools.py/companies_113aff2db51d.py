...
async def list_companies(updated_since: Optional[str] = None, page: int = 1, per_page: int = 30) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        response = await make_freshdesk_request("GET", "/companies", options={"query_params": params})
        return response
...
async def filter_companies(query: str, page: int = 1, per_page: int = 30) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        response = await make_freshdesk_request("GET", "/search/companies", options={"query_params": params})
        return response
...
async def update_company(
    ...
    try:
        ...
        response = await make_freshdesk_request("PUT", f"/companies/{company_id}", data=update_data)
        return response
