# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\airtable\tools\fields.py
import logging
...
async def create_field(
    ...
    logger.info(f"Executing tool: create_field '{name}' of type '{type}' in table {table_id}, base {base_id}")
...
async def update_field(
    ...
    logger.info(f"Executing tool: update_field '{field_id}' in table {table_id}, base {base_id}")
