# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\report_generation\server.py
import contextlib
import logging
import os
...
async def generate_report_with_claude(article_content: str) -> str:
    ...
    try:
        ...
        logger.warning(f"No code block found in generated text: start_index: {start_index}, end_index: {end_index}")
...
@click.option(
    "--port",
    default=REPORT_GENERATION_MCP_SERVER_PORT,
