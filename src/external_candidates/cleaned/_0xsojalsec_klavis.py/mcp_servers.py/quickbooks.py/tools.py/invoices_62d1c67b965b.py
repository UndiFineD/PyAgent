# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\quickbooks\tools\invoices.py
    ...
    "LineItems": {
        ...
        "items": {
            ...
            "properties": {
                "LineId": {
                    "type": "string",
                    "description": "Unique ID for this line item. Required for updates, ignored for creates",
                },
                ...
                "DetailType": {
                    "type": "string",
                    "description": "Line detail type: SalesItemLineDetail, DescriptionOnlyLine, DiscountLine, SubTotalLine",
                    "default": "SalesItemLineDetail",
                },
                "LineNum": {
                    "type": "number",
                    "description": "Position of the line in the collection",
                },
                ...
                "DiscountRate": {
                    "type": "number",
                    "description": "Discount rate applied to this line as a percentage",
                },
                "DiscountAmount": {
                    "type": "number",
                ...
                "ServiceDate": {
                    "type": "string",
                    "description": "Date when the service is performed (YYYY-MM-DD format)",
                },
                # DescriptionOnlyLine fields
                "IsSubtotal": {
                    "type": "boolean",
                    "description": "Set to true for subtotal lines",
                },
                # DiscountLineDetail fields
                "DiscountPercent": {
                    "type": "number",
                    "description": "Percentage discount as a number (10 for 10%)",
                },
                "DiscountAccountId": {
                    "type": "string",
                    "description": "Income account used to track discounts",
                },
                "DiscountAccountName": {
                    "type": "string",
                    "description": "Name of the discount account",
                },
                "IsPercentBased": {
                    "type": "boolean",
                    "description": "True if the discount is a percentage",
                },
                "TaxCodeId": {
                    "type": "string",
                    "description": "Reference to the TaxCode for this item",
                },
...
invoice_properties_user_define = {
    **invoice_properties_minimal,
    ...
    "CurrencyRefName": {"type": "string", "description": "Full name of the currency"},
    "TrackingNum": {
        "type": "string",
...
invoice_properties = {
    **invoice_properties_user_define,
    "Id": {"type": "string", "description": "The unique QuickBooks invoice ID"},
}
...
get_invoice_tool = Tool(
    ...
    inputSchema={
        "type": "object",
        "properties": {"Id": {"type": "string", "description": "The QuickBooks invoice ID"}},
        "required": ["Id"],
    },
    annotations=types.ToolAnnotations(**{"category": "QUICKBOOKS_INVOICE"}),
)
...
search_invoices_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "DocNumber": {
                "type": "string",
                "description": "Search by document/invoice number",
            },
            "CustomerRefValue": {
                "type": "string",
            ...
            "TransactionDateFrom": {
                "type": "string",
                "description": "Search invoices from this transaction date (YYYY-MM-DD format)",
            },
            "TransactionDateTo": {
                "type": "string",
                "description": "Search invoices to this transaction date (YYYY-MM-DD format)",
            },
            "DueDateFrom": {
                "type": "string",
                "description": "Search invoices from this due date (YYYY-MM-DD format)",
            },
            "DueDateTo": {
                "type": "string",
                "description": "Search invoices to this due date (YYYY-MM-DD format)",
            },
            "ShipDateFrom": {
                "type": "string",
                "description": "Search invoices from this ship date (YYYY-MM-DD format)",
            },
            "ShipDateTo": {
                "type": "string",
                "description": "Search invoices to this ship date (YYYY-MM-DD format)",
            },
            # Amount filters
            ...
            "BillAddrCity": {
                "type": "string",
                "description": "Search by billing address city",
            },
            "BillAddrState": {
                "type": "string",
                "description": "Search by billing address state/province",
            },
            "BillAddrPostalCode": {
                "type": "string",
                "description": "Search by billing address postal code",
            },
            "BillAddrCountry": {
                "type": "string",
                "description": "Search by billing address country",
            },
            "BillAddrLine1": {
                "type": "string",
                "description": "Search by billing address line 1 (partial match)",
            },
            # Address filters - Shipping Address
            "ShipAddrCity": {
                "type": "string",
                "description": "Search by shipping address city",
            },
            "ShipAddrState": {
                "type": "string",
                "description": "Search by shipping address state/province",
            },
            "ShipAddrPostalCode": {
                "type": "string",
                "description": "Search by shipping address postal code",
            },
            "ShipAddrCountry": {
                "type": "string",
                "description": "Search by shipping address country",
            },
            "ShipAddrLine1": {
                "type": "string",
                "description": "Search by shipping address line 1 (partial match)",
            },
            # Address filters - Ship From Address
            "ShipFromAddrCity": {
                "type": "string",
                "description": "Search by ship from address city",
            },
            "ShipFromAddrState": {
                "type": "string",
                "description": "Search by ship from address state/province",
            },
            "ShipFromAddrPostalCode": {
                "type": "string",
                "description": "Search by ship from address postal code",
            },
            "ShipFromAddrCountry": {
                "type": "string",
                "description": "Search by ship from address country",
            },
            "ShipFromAddrLine1": {
                "type": "string",
                "description": "Search by ship from address line 1 (partial match)",
            },
            # Pagination
            "MaxResults": {
                "type": "integer",
...
delete_invoice_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "Id": {
                "type": "string",
                "description": "The QuickBooks invoice ID to delete",
            }
        },
        "required": ["Id"],
    },
...
void_invoice_tool = Tool(
    ...
    inputSchema={
        "type": "object",
        "properties": {"Id": {"type": "string", "description": "The QuickBooks invoice ID to void"}},
        "required": ["Id"],
    },
    annotations=types.ToolAnnotations(**{"category": "QUICKBOOKS_INVOICE"}),
)
        ...
        for item in kwargs["LineItems"]:
            ...
            if detail_type == "SalesItemLineDetail":
                ...
                if item.get("GroupItemId"):
                    group_detail["GroupItemRef"] = {"value": item["GroupItemId"]}
                ...
                if item.get("GroupLines") and isinstance(item["GroupLines"], list):
                    ...
                    for group_item in item["GroupLines"]:
                        ...
                        if group_item.get("ItemId"):
                            group_sales_detail["ItemRef"] = {"value": group_item["ItemId"]}
                        ...
                        if group_item.get("TaxCodeId"):
                            group_sales_detail["TaxCodeRef"] = {"value": group_item["TaxCodeId"]}
                ...
                if item.get("TaxCodeId"):
                    description_detail["TaxCodeRef"] = {"value": item["TaxCodeId"]}
                    if item.get("TaxCodeName"):
                ...
                if item.get("DiscountAccountId"):
                    discount_detail["DiscountAccountRef"] = {"value": item["DiscountAccountId"]}
...
def invoice_data_to_mcp_object(invoice_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for field in ["Id", "DocNumber", "ShipDate", "DueDate", "TrackingNum", "Deposit"]:
            ...
            if isinstance(line, dict) and "Amount" in line:
                ...
                if detail_type == "SalesItemLineDetail" and "SalesItemLineDetail" in line:
                    ...
                    if "TaxCodeRef" in detail:
                        ...
                        item["TaxCodeName"] = detail["TaxCodeRef"].get("name")

                elif detail_type == "GroupLineDetail" and "GroupLineDetail" in line:
                    detail = line["GroupLineDetail"]
                    if "GroupItemRef" in detail:
                        item["GroupItemId"] = detail["GroupItemRef"].get("value")
                        item["GroupItemName"] = detail["GroupItemRef"].get("name")
                    ...
                    if "DiscountAccountRef" in detail:
                        item["DiscountAccountId"] = detail["DiscountAccountRef"].get("value")
                        item["DiscountAccountName"] = detail["DiscountAccountRef"].get("name")
                    if "TaxCodeRef" in detail:
                        item["TaxCodeId"] = detail["TaxCodeRef"].get("value")
                        item["TaxCodeName"] = detail["TaxCodeRef"].get("name")
...
class InvoiceManager:
    ...
    async def search_invoices(self, **kwargs) -> List[Dict[str, Any]]:
        ...
        if kwargs.get("CustomerName"):
            ...
            conditions.append(f"CustomerRef IN (SELECT Id FROM Customer WHERE Name LIKE '%{customer_name}%')")
        ...
        for field in [
            ...
            if kwargs.get(field):
                ...
                qb_field = field.replace("BillAddr", "BillAddr.").replace("State", "CountrySubDivisionCode")
        ...
        for field in [
            ...
            if kwargs.get(field):
                qb_field = field.replace("ShipAddr", "ShipAddr.").replace("State", "CountrySubDivisionCode")
                if field.endswith("Line1"):
                    address_filters[field] = kwargs[field]
                else:
                    conditions.append(f"{qb_field} = '{kwargs[field]}'")
        ...
        for field in [
            ...
            if kwargs.get(field):
                qb_field = field.replace("ShipFromAddr", "ShipFromAddr.").replace("State", "CountrySubDivisionCode")
                if field.endswith("Line1"):
                    address_filters[field] = kwargs[field]
                else:
                    conditions.append(f"{qb_field} = '{kwargs[field]}'")
        ...
        if address_filters:
            ...
            for invoice in results:
                ...
                if address_filters.get("ShipFromAddrLine1"):
                    ship_from_line1 = invoice.get("ShipFromAddrLine1", "").lower()
    ...
    async def update_invoice(self, **kwargs) -> Dict[str, Any]:
        ...
        sync_token = current_invoice_response.get("Invoice", {}).get("SyncToken", "0")
