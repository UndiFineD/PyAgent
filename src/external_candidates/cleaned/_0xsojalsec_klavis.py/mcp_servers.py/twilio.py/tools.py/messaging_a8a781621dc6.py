# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\twilio\tools\messaging.py
import logging
...
async def twilio_send_sms(to: str, from_: str, body: str, status_callback: Optional[str] = None) -> dict:
    """
...
async def twilio_send_mms(
    ...
    try:
        ...
        message_params = {"from_": from_number, "to": to_number}
