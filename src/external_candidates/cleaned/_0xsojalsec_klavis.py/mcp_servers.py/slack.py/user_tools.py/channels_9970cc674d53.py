# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\slack\user_tools\channels.py
import logging
...
async def get_channel_history(channel_id: str, limit: Optional[int] = None) -> Dict[str, Any]:
...
async def invite_users_to_channel(channel_id: str, user_ids: list[str]) -> Dict[str, Any]:
