# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\slack\user_tools\users.py
import logging
...
# User tokens: users:read
async def user_get_info(user_id: str, include_locale: Optional[bool] = None) -> Dict[str, Any]:
