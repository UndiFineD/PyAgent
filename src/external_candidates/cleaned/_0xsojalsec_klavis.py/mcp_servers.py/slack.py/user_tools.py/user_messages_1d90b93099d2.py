...
# User tokens: chat:write, chat:write:user, chat:write:bot
async def user_reply_to_thread(channel_id: str, thread_ts: str, text: str) -> Dict[str, Any]:
...
async def user_add_reaction(channel_id: str, timestamp: str, reaction: str) -> Dict[str, Any]:
