# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\slack\bot_tools\bot_messages.py
import logging
...
async def bot_post_message(channel_id: str, text: str) -> Dict[str, Any]:
...
# Bot tokens: chat:write
async def bot_reply_to_thread(channel_id: str, thread_ts: str, text: str) -> Dict[str, Any]:
...
async def bot_add_reaction(channel_id: str, timestamp: str, reaction: str) -> Dict[str, Any]:
