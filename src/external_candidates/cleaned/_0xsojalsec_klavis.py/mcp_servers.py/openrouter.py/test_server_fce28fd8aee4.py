# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\openrouter\test_server.py
#!/usr/bin/env python3
"""
...
async def test_chat_completion_stream() -> Dict[str, Any]:
    ...
    try:
        messages = [
            {
                "role": "user",
                "content": "Write a short story about a robot in exactly 3 sentences.",
            }
        ]
