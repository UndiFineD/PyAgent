# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\heygen\tools\management.py
"""
...
async def heygen_list_videos(limit: Optional[int] = 20, offset: Optional[int] = 0) -> Dict[str, Any]:
    """
