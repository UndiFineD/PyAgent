# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\hubspot\tools\tasks.py
import json
import logging
...
async def hubspot_create_task(properties: str):
    ...
    try:
        ...
        result = client.crm.objects.tasks.basic_api.create(simple_public_object_input_for_create=data)
