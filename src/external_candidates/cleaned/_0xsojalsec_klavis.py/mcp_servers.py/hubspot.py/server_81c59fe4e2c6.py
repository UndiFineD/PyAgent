# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\hubspot\server.py
import base64
import contextlib
import json
import logging
...
from tools import (  # Properties; Contacts; Companies; Deals; Tickets; Notes; Tasks
    auth_token_context,
...
def main(
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_PROPERTY"}),
            ),
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_TASK"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_CONTACT"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_COMPANY"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_DEAL"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_TICKET"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "HUBSPOT_NOTE"}),
            ),
        ]
    ...
    async def call_tool(
        ...
        # Contacts
            ...
            try:
                result = await hubspot_update_contact_by_id(contact_id=contact_id, updates=updates)
                return [
                    types.TextContent(
                        type="text",
                        text=result,
        ...
        # Companies
            ...
            try:
                result = await hubspot_update_company_by_id(company_id=company_id, updates=updates)
                return [
                    types.TextContent(
                        type="text",
                        text=result,
        ...
        # Deals
            ...
            try:
                result = await hubspot_update_deal_by_id(deal_id=deal_id, updates=updates)
                return [
                    types.TextContent(
                        type="text",
                        text=result,
        ...
        # Tickets
            ...
            try:
                result = await hubspot_update_ticket_by_id(ticket_id=ticket_id, updates=updates)
                return [
                    types.TextContent(
                        type="text",
                        text=result,
        ...
        # Tasks
            ...
            try:
                result = await hubspot_update_task_by_id(task_id=task_id, updates=updates)
                return [
                    types.TextContent(
                        type="text",
                        text=result,
