# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\mcp_servers\google_sheets\server.py
import base64
import contextlib
import json
import logging
    ...
    async def list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "GOOGLE_SHEETS_SPREADSHEET"}),
            ),
            types.Tool(
            ...
            types.Tool(
                ...
                annotations=types.ToolAnnotations(**{"category": "GOOGLE_SHEETS_CELL"}),
            ),
            types.Tool(
