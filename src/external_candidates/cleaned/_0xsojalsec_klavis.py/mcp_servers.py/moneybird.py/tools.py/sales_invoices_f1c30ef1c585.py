...
async def moneybird_get_sales_invoice(administration_id: str, invoice_id: str) -> Dict[str, Any]:
...
async def moneybird_create_sales_invoice(administration_id: str, invoice_data: Dict[str, Any]) -> Dict[str, Any]:
