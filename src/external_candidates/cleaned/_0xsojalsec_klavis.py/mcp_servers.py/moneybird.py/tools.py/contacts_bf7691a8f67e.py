...
async def moneybird_get_contact(administration_id: str, contact_id: str) -> Dict[str, Any]:
...
async def moneybird_create_contact(administration_id: str, contact_data: Dict[str, Any]) -> Dict[str, Any]:
