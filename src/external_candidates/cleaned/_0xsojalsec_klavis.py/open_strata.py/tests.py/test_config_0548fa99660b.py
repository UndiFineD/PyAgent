# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\tests\test_config.py
...
class TestMCPServerList:
    ...
    def test_parse_mcp_config_format(self):
        ...
        try:
            ...
            assert github_server.env == {"GITHUB_PERSONAL_ACCESS_TOKEN": "${input:github_token}"}
