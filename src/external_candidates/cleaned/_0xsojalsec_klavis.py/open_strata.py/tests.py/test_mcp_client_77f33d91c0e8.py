# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\tests\test_mcp_client.py
...
class TestHTTPTransport:
    ...
    async def test_tool_call_search_code(self, http_client):
        ...
        result = await http_client.call_tool("search_code", {"query": "README repo:github/docs", "perPage": 3})
...
class TestStdioTransport:
    ...
    async def test_tool_call_search_code(self, stdio_client):
        ...
        result = await stdio_client.call_tool("search_code", {"query": "README repo:github/docs", "perPage": 3})
