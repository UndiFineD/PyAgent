# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\src\strata\config.py
...
class MCPServerList:
    ...
    def save(self) -> None:
        ...
        if self.use_mcp_format:
            ...
            data = {"servers": {name: server.to_dict() for name, server in self.servers.items()}}
