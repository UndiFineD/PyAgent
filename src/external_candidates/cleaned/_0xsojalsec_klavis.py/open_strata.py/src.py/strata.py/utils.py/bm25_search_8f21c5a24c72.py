# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\src\strata\utils\bm25_search.py
"""
...
class BM25SearchEngine:
    ...
    def search(self, query: str, top_k: int = 10) -> List[Tuple[float, str]]:
        ...
        doc_indices, scores = self.retriever.retrieve(query_tokens, k=search_k, show_progress=False)
