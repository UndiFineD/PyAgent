# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\src\strata\utils\field_search.py
"""
...
class FieldSearchEngine:
    ...
    def build_index(self, documents: List[Tuple[List[Tuple[str, str, int]], str]]):
        ...
        for fields, doc_id in documents:
            ...
            self.documents.append({"id": doc_id, "fields": doc_fields, "weights": field_weights})
            ...
            for field_type, field_values in doc["fields"].items():
                ...
                for token in query_tokens:
                    ...
                    for value in field_values:
                        if self._match_token(token, value) and token not in matched_tokens:
