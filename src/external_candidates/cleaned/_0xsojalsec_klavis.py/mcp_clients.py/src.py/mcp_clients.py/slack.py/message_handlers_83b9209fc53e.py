...
def register_message_handlers(app, bot):
    ...
    async def add_loading_reaction(client, channel_id, message_ts):
        ...
        try:
            await client.reactions_add(channel=channel_id, timestamp=message_ts, name="thinking_face")
    ...
    async def remove_loading_reaction(client, channel_id, message_ts):
        ...
        try:
            await client.reactions_remove(channel=channel_id, timestamp=message_ts, name="thinking_face")
        except Exception as e:
        ...
        try:
            async with asyncio.timeout(200), bot.user_locks[user_id]:
                ...
                if clean_text:
                    ...
                    try:
                        mcp_client = await bot.initialize_mcp_client(context=slack_context, server_urls=server_urls)
                        ...
                        await bot.process_query_with_streaming(mcp_client, messages_history, slack_context)
                    except Exception as e:
