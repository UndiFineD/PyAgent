# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\render_simple.py\layers.py\connection_layers_renderer_3074a8cc2773.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\render_simple\layers\connection_layers_renderer.py

from typing import Callable, Dict, List

from fle.env.entities import Entity, Pipe, UndergroundBelt
...
class ConnectionsLayerRenderer(LayerRenderer):
    ...
    def _draw_underground_belt_connections(
        ...
        for belt in underground_belts:
            ...
            self.connection_renderer.draw_underground_belt_connection(draw, belt, game_to_img_func, entity_color)
