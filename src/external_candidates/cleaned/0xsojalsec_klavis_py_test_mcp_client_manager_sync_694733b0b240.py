# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\open_strata.py\tests.py\test_mcp_client_manager_sync_694733b0b240.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\tests\test_mcp_client_manager_sync.py
...
class TestSyncWithConfig:
    ...
    async def test_sync_add_new_server(self, mock_transport, mock_client, manager_with_mocks):
        ...
        new_servers = {"test-server": MCPServerConfig(name="test-server", command="echo", args=["hello"], enabled=True)}
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_remove_server(self, mock_transport, mock_client, manager_with_mocks):
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_disable_server(self, mock_transport, mock_client, manager_with_mocks):
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_enable_server(self, mock_transport, mock_client, manager_with_mocks):
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_config_change_reconnects(self, mock_transport, mock_client, manager_with_mocks):
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_multiple_changes(self, mock_transport, mock_client, manager_with_mocks):
        ...
        new_servers = {
            "new-server-1": MCPServerConfig(name="new-server-1", command="python", args=["server1.py"], enabled=True),
            "new-server-2": MCPServerConfig(name="new-server-2", command="node", args=["server2.js"], enabled=True),
        }
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_with_http_server(self, mock_transport, mock_client, manager_with_mocks):
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_error_handling(self, mock_transport, mock_client, manager_with_mocks):
        ...
        mock_client_instance1.connect = AsyncMock(side_effect=Exception("Connection failed"))
        ...
        new_servers = {
            "failing-server": MCPServerConfig(name="failing-server", command="bad-command", args=[], enabled=True),
            "working-server": MCPServerConfig(name="working-server", command="echo", args=["hello"], enabled=True),
        }
    ...
    @patch("strata.mcp_client_manager.MCPClient")
    @patch("strata.mcp_client_manager.StdioTransport")
    async def test_sync_mutex_prevents_concurrent_operations(self, mock_transport, mock_client, manager_with_mocks):
        ...
        servers1 = {"server1": MCPServerConfig(name="server1", command="echo", args=["1"], enabled=True)}

        servers2 = {"server2": MCPServerConfig(name="server2", command="echo", args=["2"], enabled=True)}
