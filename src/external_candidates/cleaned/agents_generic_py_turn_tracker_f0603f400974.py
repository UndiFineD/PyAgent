# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_plugins.py\livekit_plugins_aws.py\livekit.py\plugins.py\aws.py\experimental.py\realtime.py\turn_tracker_f0603f400974.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-aws\livekit\plugins\aws\experimental\realtime\turn_tracker.py
