# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-UNO\uno\flux\util.py
...
def set_lora(
    ...
    single_blocks_indices = (
        list(range(model.params.depth_single_blocks)) if single_blocks_indices is None else single_blocks_indices
    )
