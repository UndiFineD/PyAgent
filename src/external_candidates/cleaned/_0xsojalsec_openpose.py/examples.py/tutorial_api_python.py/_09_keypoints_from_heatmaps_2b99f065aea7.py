# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-openpose\examples\tutorial_api_python\09_keypoints_from_heatmaps.py
# From Python
...
try:
    ...
    parser.add_argument(
        "--image_path",
        default="../../../examples/media/COCO_val2014_000000000294.jpg",
