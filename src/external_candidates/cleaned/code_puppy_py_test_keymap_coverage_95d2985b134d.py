# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_keymap_coverage_95d2985b134d.py
...
class TestGetCancelAgentKey:
    ...
    @patch("code_puppy.uvx_detection.should_use_alternate_cancel_key")
    @patch("code_puppy.config.get_value")
    def test_returns_default_when_config_is_none(self, mock_get_value, mock_should_use_alt):
    ...
    @patch("code_puppy.uvx_detection.should_use_alternate_cancel_key")
    @patch("code_puppy.config.get_value")
    def test_returns_default_when_config_is_empty(self, mock_get_value, mock_should_use_alt):
    ...
    @patch("code_puppy.uvx_detection.should_use_alternate_cancel_key")
    @patch("code_puppy.config.get_value")
    def test_returns_configured_key_normalized(self, mock_get_value, mock_should_use_alt):
