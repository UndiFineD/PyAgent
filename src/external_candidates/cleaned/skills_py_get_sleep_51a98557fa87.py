# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\ijaack.py\whoop_tracker.py\scripts.py\get_sleep_51a98557fa87.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\ijaack\whoop-tracker\scripts\get_sleep.py
...
def format_sleep(record):
    ...
    return {
        ...
        "efficiency": (
            round(score.get("sleep_efficiency_percentage", 0), 1) if score.get("sleep_efficiency_percentage") else None
        ),
