# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pi3mos_slam.py\dpvo.py\altcorr.py\correlation_c412a724da1e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Pi3MOS-SLAM\dpvo\altcorr\correlation.py
...
class CorrLayer(torch.autograd.Function):
    ...
    def backward(ctx, grad):
        ...
        fmap1_grad, fmap2_grad = cuda_corr.backward(fmap1, fmap2, coords, ii, jj, grad, ctx.radius)
