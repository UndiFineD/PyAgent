# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\test_normalizer_313e0f7f1332.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\test_normalizer.py
...
def _make_sine_pcm16(
    ...
    amplitude: int, samples: int, freq: float = 440.0, rate: int = 8000
