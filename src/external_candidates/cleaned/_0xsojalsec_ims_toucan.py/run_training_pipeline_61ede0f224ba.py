# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\run_training_pipeline.py
import argparse
import os
import random
import sys
...
from Recipes.finetuning_example_multilingual import (
...
if __name__ == "__main__":
    ...
    parser.add_argument("pipeline", choices=list(pipeline_dict.keys()), help="Select pipeline to train.")
