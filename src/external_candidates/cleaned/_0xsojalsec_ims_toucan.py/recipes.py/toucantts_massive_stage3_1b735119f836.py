# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Recipes\ToucanTTS_Massive_stage3.py
"""
...
def run(
    ...
    base_dir = os.path.join(MODEL_DIR, "ToucanTTS_MassiveDataBigModel_stage3_reworked_v10")
