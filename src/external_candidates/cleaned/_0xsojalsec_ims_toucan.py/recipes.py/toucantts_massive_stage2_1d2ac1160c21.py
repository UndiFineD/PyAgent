# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Recipes\ToucanTTS_Massive_stage2.py
"""
...
def run(
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_nancy,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_ryanspeech,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_ljspeech,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_libritts_all_clean,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_vctk,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_nvidia_hifitts,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_CREMA_D,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_EmoV_DB,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_RAVDESS,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_ESDS,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_blizzard_2013,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_jenny,
    ...
    lang_to_datasets["eng"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_ears,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_karlsson,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_eva,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_hokus,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_bernd,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_friedrich,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_hui_others,
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_thorsten_emotional(),
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_thorsten_neutral(),
    ...
    lang_to_datasets["deu"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_thorsten_2022_10(),
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10fr,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_french,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_blizzard2023_ad_silence_removed,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_blizzard2023_neb_silence_removed,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_blizzard2023_neb_e_silence_removed,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_synpaflex_norm_subset,
    ...
    lang_to_datasets["fra"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_siwis_subset,
    ...
    lang_to_datasets["spa"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_spanish,
    ...
    lang_to_datasets["spa"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10es,
    ...
    lang_to_datasets["spa"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_spanish_blizzard_train,
    ...
    lang_to_datasets["cmn"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10cmn,
    ...
    lang_to_datasets["cmn"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_aishell3,
    ...
    lang_to_datasets["por"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_portuguese,
    ...
    lang_to_datasets["pol"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_polish,
    ...
    lang_to_datasets["ita"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_italian,
    ...
    lang_to_datasets["nld"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_mls_dutch,
    ...
    lang_to_datasets["nld"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10nl,
    ...
    lang_to_datasets["ell"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10el,
    ...
    lang_to_datasets["fin"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10fi,
    ...
    lang_to_datasets["vie"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_VIVOS_viet,
    ...
    lang_to_datasets["jpn"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_captain_japanese,
    ...
    lang_to_datasets["jpn"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_jvs,
    ...
    lang_to_datasets["rus"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10ru,
    ...
    lang_to_datasets["hun"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_css10hu,
    ...
    lang_to_datasets["asm"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Assamese,
    ...
    lang_to_datasets["ben"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Bengali,
    ...
    lang_to_datasets["brx"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Bodo,
    ...
    lang_to_datasets["dgo"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Dogri,
    ...
    lang_to_datasets["guj"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Gujarati,
    ...
    lang_to_datasets["hin"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Hindi,
    ...
    lang_to_datasets["kan"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Kannada,
    ...
    lang_to_datasets["kas"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Kashmiri,
    ...
    lang_to_datasets["knn"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Konkani,
    ...
    lang_to_datasets["mai"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Maithili,
    ...
    lang_to_datasets["mal"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Malayalam,
    ...
    lang_to_datasets["mni"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Manipuri,
    ...
    lang_to_datasets["mar"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Marathi,
    ...
    lang_to_datasets["nep"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Nepali,
    ...
    lang_to_datasets["ory"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Odia,
    ...
    lang_to_datasets["pan"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Punjabi,
    ...
    lang_to_datasets["san"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Sanskrit,
    ...
    lang_to_datasets["sat"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Santali,
    ...
    lang_to_datasets["snd"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Sindhi,
    ...
    lang_to_datasets["tam"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Tamil,
    ...
    lang_to_datasets["tel"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Telugu,
    ...
    lang_to_datasets["urd"].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_indicvoices_Urdu,
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_bembaspeech(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_alffa_sw(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_alffa_am(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_alffa_wo(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_malayalam(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_msc(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_chuvash(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_iban(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_javanese_speech(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_fon_alf(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_hausa_cmv(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_ibibio_lst(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_kikuyu_opb(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_lingala_opb(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_ganda_cmv(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_luo_afv(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_luo_opb(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_swahili_llsti(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_suba_afv(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_wolof_alf(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_african_voices_yoruba_opb(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_zambezi_voice_nyanja(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_zambezi_voice_lozi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_zambezi_voice_tonga(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_afrikaans(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_amharic(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_arabic(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_assamese(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_asturian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_azerbaijani(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_belarusian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_bulgarian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_bengali(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_bosnian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_catalan(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_cebuano(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_sorani_kurdish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_mandarin(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_czech(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_welsh(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_danish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_german(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_greek(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_english(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_spanish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_estonian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_persian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_finnish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_filipino(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_french(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_irish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_galician(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_gujarati(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_hausa(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_hebrew(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_hindi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_croatian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_hungarian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_armenian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_indonesian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_igbo(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_icelandic(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_italian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_javanese(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_georgian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_kamba(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_kabuverdianu(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_kazakh(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_khmer(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_kannada(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_korean(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_luxembourgish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_ganda(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_lingala(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_lao(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_lithuanian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_luo(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_latvian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_maori(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_macedonian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_malayalam(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_mongolian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_marathi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_malay(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_maltese(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_dutch(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_nyanja(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_occitan(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_oriya(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_punjabi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_polish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_pashto(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_portuguese(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_romanian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_russian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_sindhi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_slovak(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_slovenian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_shona(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_somali(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_serbian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_swedish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_swahili(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_tamil(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_telugu(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_tajik(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_turkish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_ukrainian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_umbundu(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_urdu(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_uzbek(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_vietnamese(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_wolof(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_fleurs_yoruba(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_living_audio_dataset_irish(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_living_audio_dataset_dutch(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_living_audio_dataset_russian(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_romanian_db(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_shemo(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_cmu_arctic(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_clartts(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_bhadrawahi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_bilaspuri(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_dogri(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_gaddi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_haryanvi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_hindi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_kangri(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_kannada(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_kulvi(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_kulvi_outer_seraji(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_malayalam(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_mandeali(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_pahari_mahasui(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_tamil(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_snow_mountain_telugu(),
    ...
    lang_to_datasets[lang_id].append(
        prepare_tts_corpus(
            transcript_dict=build_path_to_transcript_ukrainian_lada(),
    ...
    for lang in [
        ...
        lang_to_datasets[lang].append(
            prepare_tts_corpus(
                transcript_dict=build_path_to_transcript_mms_template(lang=lang),
    ...
    if use_wandb:
        if rank == 0:
            wandb.init(
                name=(
                    f"{__name__.split('.')[-1]}_{time.strftime('%Y%m%d-%H%M%S')}" if wandb_resume_id is None else None
                ),
