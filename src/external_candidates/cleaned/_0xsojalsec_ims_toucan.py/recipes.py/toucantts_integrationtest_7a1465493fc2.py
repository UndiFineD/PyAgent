# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Recipes\ToucanTTS_IntegrationTest.py
"""
...
def run(
    ...
    train_set = prepare_tts_corpus(
        transcript_dict=build_path_to_transcript_integration_test(),
