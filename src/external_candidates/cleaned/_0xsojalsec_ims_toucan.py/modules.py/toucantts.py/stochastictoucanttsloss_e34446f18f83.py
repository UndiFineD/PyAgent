# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\ToucanTTS\StochasticToucanTTSLoss.py
"""
Taken from ESPNet
Adapted by Flux
"""
...
class StochasticToucanTTSLoss(torch.nn.Module):
    ...
    def forward(self, predicted_features, gold_features, features_lengths):
        ...
        out_masks = torch.nn.functional.pad(
            ...
            [0, gold_features.size(1) - out_masks.size(1), 0, 0, 0, 0],
            value=False,
        ).transpose(1, 2)
