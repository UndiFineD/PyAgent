# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-IMS-Toucan\Modules\Vocoder\HiFiGAN_E2E_Dataset.py
...
def get_matching_windows(
    spectrogram,
    waveform,
    window_size_wave=24576,
    hop_length_spec=256,
    sample_rate_wave=24000,
    sample_rate_spec=16000,
):
    """
