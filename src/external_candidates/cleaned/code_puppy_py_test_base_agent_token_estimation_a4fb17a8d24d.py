# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_base_agent_token_estimation_a4fb17a8d24d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_base_agent_token_estimation.py
...
class TestMCPToolCache:
    ...
    def test_mcp_cache_cleared_on_reload(self, agent):
        ...
        agent._mcp_tool_definitions_cache = [{"name": "test_tool", "description": "Test", "inputSchema": {}}]
...
class TestTokenEstimationIntegration:
    ...
    def test_token_count_formula_precision(self, agent):
        ...
        for length, expected in test_cases:
            ...
            assert token_count == expected, f"Length {length} should yield {expected} tokens, got {token_count}"
