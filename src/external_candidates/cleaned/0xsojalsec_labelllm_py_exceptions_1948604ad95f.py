# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_labelllm.py\backend.py\app.py\core.py\exceptions_1948604ad95f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\core\exceptions.py
...
USER_PERMISSION_DENIED = AppEx(COMMON + 2, "User permission denied", status_code=403)  # 用户权限不足
...
USER_NOT_ALLOWED_OPERATION = AppEx(USER + 2, "User not allowed to perform this operation")  # 用户禁止做此操作

USER_IS_OPERATOR_ALREADY_YET = AppEx(USER + 3, "User is operator already yet")  # 用户已经是运营
...
TEAM_CAN_NOT_KICK_FROM_DEFAULT_TEAM = AppEx(TEAM + 2, "Can not kick user out of default_team")
...
TEAM_USER_AT_LEAST_HAVE_ONE_SUPER_ADMIN = AppEx(TEAM + 6, "Team should have one super_admin at least")
