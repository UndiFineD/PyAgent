# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\core.py\bruteforcer_de07faf4d94a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-web-brutator\lib\core\Bruteforcer.py
            ...
            while not self.wordlist.queue.empty():
                ...
                try:
                    ...
                    if status is True:
                        ...
                        self.success_creds_callback(username, password, self.wordlist.index)

                    else:
                        self.wrong_creds_callback(username, password, self.wordlist.index)
