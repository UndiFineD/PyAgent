# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\client.py\acontext_py.py\src.py\acontext.py\resources.py\async_disks_c0a73abeb38e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\client\acontext-py\src\acontext\resources\async_disks.py
...
class AsyncDiskArtifactsAPI:
    ...
    async def upsert(
        ...
        disk_id: str,
        *,
        file: (FileUpload | tuple[str, BinaryIO | bytes] | tuple[str, BinaryIO | bytes, str]),
