# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\search.py\elasticsearch.py\converter.py\event_log_converter_790960b55658.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\elasticsearch\converter\event_log_converter.py
    ...
    def from_mongo(cls, source_doc: MongoEventLogRecord) -> EventLogDoc:
        ...
        try:
            ...
            es_doc = EventLogDoc(
                ...
                type=source_doc.event_type or RawDataType.CONVERSATION.value,  # Event type
                keywords=None,
            ...
            logger.error("Failed to convert MongoDB event log document to ES document: %s", e)
