# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\actions.py\test_harvest_resource_7e0462df282c.py
...
def test_harvest_resource_with_full_inventory(game):
    ...
    try:
        ...
        game.harvest_resource(nearest_coal, quantity=100)  # Assuming there is a coal resource at (10, 10)
