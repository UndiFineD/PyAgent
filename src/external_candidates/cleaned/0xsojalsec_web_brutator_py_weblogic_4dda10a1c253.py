# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_web_brutator.py\lib.py\modules.py\weblogic_4dda10a1c253.py
...
class Weblogic:
    ...
    def check(self):
        ...
        if 'name="j_password"' in r.text:
            ...
            logger.info("Weblogic administration console detected: {}".format(self.interface_url))
