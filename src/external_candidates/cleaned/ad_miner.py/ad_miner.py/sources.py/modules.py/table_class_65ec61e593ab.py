# Extracted from: C:\DEV\PyAgent\.external\AD_Miner\ad_miner\sources\modules\table_class.py
import random
import string
...
class Table:
    ...
    def render(self, page_f):
        ...
        with open(self.template_base_path / (self.template + "_col.html"), "r") as row_header_f:
