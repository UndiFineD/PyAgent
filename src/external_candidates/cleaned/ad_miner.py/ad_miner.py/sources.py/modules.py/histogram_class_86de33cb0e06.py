# Extracted from: C:\DEV\PyAgent\.external\AD_Miner\ad_miner\sources\modules\histogram_class.py
from ad_miner.sources.modules.utils import HTML_DIRECTORY


class Histogram:
    def __init__(self, title=None, template="histogram", icon=None, color="cardHeaderMazGrey"):
    ...
    def render(self, page_f):
        ...
        with open(
            self.template_base_path / (self.template + "_footer.html"),
            "r",
            encoding="utf-8",
        ) as footer_f:
