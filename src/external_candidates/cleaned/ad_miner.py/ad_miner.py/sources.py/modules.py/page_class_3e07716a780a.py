# Extracted from: C:\DEV\PyAgent\.external\AD_Miner\ad_miner\sources\modules\page_class.py
...
class Page:
    def __init__(
        ...
        try:
            ...
            print("[!] Warning : Add a description in description.json for the key '%s'." % (description))
        self.components = []
    ...
    def render(self):
        ...
        with open(
            ...
            with open(TEMPLATES_DIRECTORY / (self.template + "_footer.html"), "r") as footer_f:
