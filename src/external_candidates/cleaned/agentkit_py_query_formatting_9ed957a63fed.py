# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentkit.py\backend.py\app.py\app.py\services.py\chat_agent.py\helpers.py\query_formatting_9ed957a63fed.py
