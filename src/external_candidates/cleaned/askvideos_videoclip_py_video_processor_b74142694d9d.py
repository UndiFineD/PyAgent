# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\askvideos_videoclip.py\video_llama.py\processors.py\video_processor_b74142694d9d.py
    ...
    for i in range(num_clips):
        ...
        if len(frames_in_clip) == 0:
            ...
            sampled_frames_per_clip = (
                np.arange(start_frame, end_frame, len(frames_in_clip) / n_frms).astype(int).tolist()
            )
