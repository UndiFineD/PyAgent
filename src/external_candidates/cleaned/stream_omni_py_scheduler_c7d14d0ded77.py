# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\cosyvoice.py\examples.py\magicdata_read.py\cosyvoice.py\cosyvoice.py\utils.py\scheduler_c7d14d0ded77.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\CosyVoice\examples\magicdata-read\cosyvoice\cosyvoice\utils\scheduler.py
...
class SquareRootConstantPolicy(_LRScheduler):
    ...
    def __init__(
        ...
        *,
        ...
        assert not (constant_steps is not None and constant_ratio is not None), (
            "Either use particular number of step or ratio"
        )
