# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\messaging.py\message_queue_7643e149da6b.py
        ...
        while self._running:
            try:
                ...
                if self._event_loop is not None and self._async_queue is not None:
                    ...
                    try:
                        self._event_loop.call_soon_threadsafe(self._async_queue.put_nowait, message)
