# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\memory_layer.py\memory_extractor.py\episode_memory_extractor_16a0a153f120.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\memory_layer\memory_extractor\episode_memory_extractor.py
...
class EpisodeMemoryExtractor(MemoryExtractor):
    ...
    async def _extract_episode(
        ...
        logger.debug(f"📚 Starting Episode extraction, use_group_prompt={use_group_prompt}")
        ...
        participants_name_map.update(self._extract_participant_name_map(memcell.original_data))
