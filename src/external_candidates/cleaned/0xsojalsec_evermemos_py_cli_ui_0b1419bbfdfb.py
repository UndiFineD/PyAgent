# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\common_utils.py\cli_ui_0b1419bbfdfb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\common_utils\cli_ui.py
...
HEAVY_BOX = BoxStyle(tl="╔", tr="╗", bl="╚", br="╝", h="═", v="║", t="╦", b="╩", l="╠", r="╣", cross="╬")

LIGHT_BOX = BoxStyle(tl="┌", tr="┐", bl="└", br="┘", h="─", v="│", t="┬", b="┴", l="├", r="┤", cross="┼")

ASCII_BOX = BoxStyle(tl="+", tr="+", bl="+", br="+", h="-", v="|", t="+", b="+", l="+", r="+", cross="+")
...
class CLIUI:
    ...
    def table(
        ...
        if max_height is not None and total_count > max_height:
            ...
            self.text(self.styled(f"... {remaining} more rows not displayed", "subtitle"))
