# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mainfraame.py\clawback.py\src.py\clawback.py\backtester_09699e54d8aa.py
...
class CongressionalBacktester:
    ...
    def calculate_return(self, ticker: str, entry_date: datetime, exit_days: int, is_purchase: bool) -> Optional[float]:
