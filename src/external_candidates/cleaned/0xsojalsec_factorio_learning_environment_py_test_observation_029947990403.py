# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\gym_env.py\test_observation_029947990403.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\gym_env\test_observation.py
...
def test_messages_observation(instance):
    ...
    if observation["messages"]:
        assert any(
            "Test message" in m.get("content", "") or "Test message" in m.get("message", "")
