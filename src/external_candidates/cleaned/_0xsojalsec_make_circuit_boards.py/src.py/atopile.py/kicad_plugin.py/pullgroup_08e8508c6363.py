# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\kicad_plugin\pullgroup.py
import logging
from pathlib import Path

import pcbnew

from .common import flip_dict, get_layout_map, sync_footprints, sync_track
...
class PullGroup(pcbnew.ActionPlugin):
    ...
    def Run(self):
        ...
        for g in target_board.Groups():
            ...
            sync_footprints(source_board, target_board, flip_dict(known_layouts[g_name]["uuid_map"]))
