# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\kicad_plugin\pushgroup.py
import logging
...
class PushGroup(pcbnew.ActionPlugin):
    ...
    def Run(self):
        ...
        for g in source_board.Groups():
            ...
            # Push the layout
            sync_footprints(source_board, target_board, known_layouts[g_name]["uuid_map"])
