# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\datatypes.py
"""
...
class KeyOptMap(tuple[KeyOptItem[T]]):
    ...
    def map_items_by_type(self, types: Iterable[Type | Iterable[Type]]) -> Mapping[Type, "KeyOptMap[T]"]:
