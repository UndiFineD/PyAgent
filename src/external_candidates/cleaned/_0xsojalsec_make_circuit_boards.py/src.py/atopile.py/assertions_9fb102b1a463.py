# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-make-circuit-boards\src\atopile\assertions.py
"""
...
import rich
from atopile import address, config, datatypes, errors, instance_methods
from atopile.front_end import Instance, RangedValue, lofty
...
class _Context:
    ...
    def __getitem__(self, key: datatypes.Ref) -> Any:
        ...
        if assign_name not in parent_inst.assignments:
            raise errors.AtoKeyError(f"No attribute '{assign_name}' bound on '{parent_inst.addr}'")
