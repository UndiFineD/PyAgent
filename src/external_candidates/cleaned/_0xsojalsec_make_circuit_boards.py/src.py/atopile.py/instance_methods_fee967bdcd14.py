...
def find_matching_super(addr: AddrStr, candidate_supers: list[AddrStr]) -> Optional[AddrStr]:
    """
...
def get_instance(addr: AddrStr) -> Instance:
    ...
    for inst_name in inst_names:
        try:
            ...
            raise errors.AtoKeyError(f"Instance {address.add_instance(inst.addr, inst_name)} not found") from ex
    return inst
