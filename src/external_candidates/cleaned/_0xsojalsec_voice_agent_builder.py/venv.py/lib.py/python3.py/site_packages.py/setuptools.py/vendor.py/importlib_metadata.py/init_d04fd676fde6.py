# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\_vendor\importlib_metadata\__init__.py
import abc
import collections
import csv
import email
