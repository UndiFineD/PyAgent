# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\_vendor\typing_extensions.py
import abc
import collections
        ...
        def __init_subclass__(cls, *args, **kwargs):
            ...
            for base in cls.__bases__:
                if not (
                    ...
                    raise TypeError(f"Protocols can only inherit from other protocols, got {repr(base)}")
            ...
            if tvars is not None:
                ...
                if gvars is None:
                    ...
                    if not tvarset <= gvarset:
                        ...
                        raise TypeError(f"Some type variables ({s_vars}) are not listed in {cls_name}[{s_args}]")
                    tvars = gvars
