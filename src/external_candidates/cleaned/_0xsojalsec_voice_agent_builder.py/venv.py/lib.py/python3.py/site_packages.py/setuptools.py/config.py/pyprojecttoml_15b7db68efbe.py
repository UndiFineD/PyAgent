# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\config\pyprojecttoml.py
"""
...
def _skip_bad_config(project_cfg: dict, setuptools_cfg: dict, dist: Optional["Distribution"]) -> bool:
