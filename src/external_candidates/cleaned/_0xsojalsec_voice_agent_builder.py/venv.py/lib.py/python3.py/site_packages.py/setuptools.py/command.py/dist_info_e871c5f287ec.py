# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\command\dist_info.py
"""
...
class dist_info(Command):
    ...
    user_options = [
        ...
        (
            "output-dir=",
            "o",
            "directory inside of which the .dist-info will becreated (default: top of the source tree)",
        ),
