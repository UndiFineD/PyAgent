# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\pip\_vendor\pygments\formatters\html.py
"""
...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        if self.filename:
            filename_tr = (
                '<tr><th colspan="2" class="filename"><span class="filename">' + self.filename + "</span></th></tr>"
            )
