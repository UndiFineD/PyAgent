# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-voice-agent-builder\venv\lib\python3.11\site-packages\setuptools\config\_apply_pyprojecttoml.py
...
TOOL_TABLE_DEPRECATIONS = {"namespace_packages": "consider using implicit namespaces instead (PEP 420)."}
