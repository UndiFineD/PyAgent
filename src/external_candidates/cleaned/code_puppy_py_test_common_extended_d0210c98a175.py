# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\test_common_extended_d0210c98a175.py
...
class TestCommonExtended:
    ...
    def test_performance_with_long_paths(self):
        ...
        long_path_with_ignore = "/".join([f"dir{i}" for i in range(50)]) + "/node_modules/package/index.js"
