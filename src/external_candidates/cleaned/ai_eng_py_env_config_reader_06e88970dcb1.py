# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\feathr_project.py\feathr.py\utils.py\env_config_reader_06e88970dcb1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ai-eng\feathr_project\feathr\utils\_env_config_reader.py
    ...
    def get_from_env_or_akv(self, key: str) -> str:
        ...
        if val is not None:
            ...
            logger.warning(
                ...
                f"Config {key} is not found in the environment variable or the remote key value store."
