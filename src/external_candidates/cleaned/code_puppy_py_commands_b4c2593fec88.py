# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\messaging.py\commands_b4c2593fec88.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\messaging\commands.py
...
class UserInputResponse(BaseCommand):
    ...
    prompt_id: str = Field(description="ID of the prompt this responds to (must match request)")
...
class ConfirmationResponse(BaseCommand):
    ...
    confirmed: bool = Field(description="Whether the user confirmed (True) or denied (False)")
