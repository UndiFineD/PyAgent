# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\connect.py\test_connect_underground_pipes_08c4eda6ac9f.py
