# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\dodeja.py\anova_skill.py\scripts.py\anova_4ffcca2b2681.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\dodeja\anova-skill\scripts\anova.py
...
class AnovaDevice:
    ...
    async def start_cook(
        ...
        temp_bulbs = {
            "mode": "dry",
            "dry": {"setpoint": {"celsius": temp_c, "fahrenheit": temp_f}},
        }
        ...
        if probe_temp is not None:
            ...
            cook_stage["temperatureProbe"] = {"setpoint": {"celsius": probe_temp_c, "fahrenheit": probe_temp_f}}

        elif duration:
            cook_stage["timer"] = {"initial": duration * 60}
    ...
    async def stop_cook(self):
        command = {
            ...
            "payload": {"id": self.current_device["id"], "type": "CMD_APO_STOP"},
            "requestId": self.generate_uuid(),
        }
