# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\michaelwang11394.py\video_agent.py\scripts.py\generate_07af3ba98e22.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\michaelwang11394\video-agent\scripts\generate.py
...
def main():
    ...
    parser.add_argument("--out-dir", default="./heygen-output", help="Output directory for downloads")
