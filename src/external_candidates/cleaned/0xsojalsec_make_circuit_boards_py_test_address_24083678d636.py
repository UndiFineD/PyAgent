# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_make_circuit_boards.py\tests.py\test_address_24083678d636.py
...
def test_get_file():
    ...
    assert get_file("path/to/file-with-special-chars.txt") == "path/to/file-with-special-chars.txt"
    ...
    assert get_file("path/to/file-with-special-chars.txt:a:b.c") == "path/to/file-with-special-chars.txt"
