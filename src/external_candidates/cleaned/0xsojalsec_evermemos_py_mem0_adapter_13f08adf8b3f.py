...
class Mem0Adapter(OnlineAPIAdapter):
    ...
    def __init__(self, config: dict, output_dir: Path = None):
        ...
        try:
            ...
            raise ImportError("Mem0 client not installed. Please install: pip install mem0ai")
    ...
    async def prepare(self, conversations: List[Conversation], **kwargs) -> None:
        ...
        if self._custom_instructions:
            try:
                await self.client.update_project(custom_instructions=self._custom_instructions)
