# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_ovo.py\tests.py\integration_tests.py\test_full_proteinqc_dssp_proteinsol_esmif_28cc418e2fed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\tests\integration_tests\test_full_proteinqc_dssp_proteinsol_esmif.py
