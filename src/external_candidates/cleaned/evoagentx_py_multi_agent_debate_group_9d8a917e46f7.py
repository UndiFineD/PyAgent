# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\multi_agent_debate.py\multi_agent_debate_group_9d8a917e46f7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\multi_agent_debate\multi_agent_debate_group.py
                ...
                inputs=[
                    {
                        "name": "problem",
                        "type": "str",
                        "description": "The problem to debate",
                    },
                    {
                        "name": "transcript_text",
                        "type": "str",
                        "description": "Transcript of previous debate rounds",
                    },
                    {
                        "name": "role",
                        "type": "str",
                        "description": "Role of the debater",
                    },
                    {
                        "name": "agent_id",
                        "type": "str",
                    ...
                    },
                    {
                        "name": "total_rounds",
                        "type": "str",
                        "description": "Total number of debate rounds",
                    },
                ],
                outputs=[
                    {
                    ...
                    },
                    {
                        ...
                        "type": "str",
                        "required": True,
                        "description": "The agent's main argument",
                    },
                    {
                        "name": "answer",
                        "type": "str",
                        "required": False,
                        "description": "Optional final answer from the agent",
                    },
                ],
                parse_mode="xml",
            )
