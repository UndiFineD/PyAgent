# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\pc_agent.py\pcagent.py\text_localization_old_c9dd794d6eed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MobileAgent\PC-Agent\PCAgent\text_localization_old.py

import cv2

import numpy as np

from PCAgent.crop import calculate_size, crop_image
