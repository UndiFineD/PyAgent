# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_labelllm.py\backend.py\app.py\scheduler.py\task_a93b3dba9605.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\scheduler\task.py
...
async def label_task_scheduler_job(task_id: UUID):
    try:
        async with redis_session.lock(f"label_task_scheduler_job_{task_id}", blocking=False):
