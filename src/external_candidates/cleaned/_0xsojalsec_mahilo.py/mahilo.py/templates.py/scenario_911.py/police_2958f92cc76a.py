# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\mahilo\templates\scenario_911\police.py
...
POLICE_PROXY_SHORT_DESCRIPTION = (
    "This is a proxy agent that communicates with real police officers. Use it when you want to know about the police."
)
