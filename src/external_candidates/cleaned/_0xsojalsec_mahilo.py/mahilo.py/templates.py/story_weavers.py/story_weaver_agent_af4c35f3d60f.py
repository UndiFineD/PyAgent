# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\mahilo\templates\story_weavers\story_weaver_agent.py
...
STORY_WEAVER_SHORT_DESCRIPTION = (
    "An imaginative guide helping humans create wild stories that occasionally crash into each other."
)
