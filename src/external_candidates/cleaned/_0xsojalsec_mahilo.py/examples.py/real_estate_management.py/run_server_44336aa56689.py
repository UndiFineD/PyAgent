# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\real_estate_management\run_server.py
...
# create the agents
buyer_preferences = (
    "Buyer preferences: I am looking for a 2BHK in Koramangala or Indiranagar with good schools and hospitals nearby."
)
buyer_agent = BuyerAgent(
    buyer_preferences=buyer_preferences,
    name="buyer_agent",
    can_contact=["seller_agent_1", "seller_agent_2"],
)
...
seller_agent_1 = SellerAgent(
    seller_preferences=seller_preferences_1,
    name="seller_agent_1",
    can_contact=["buyer_agent"],
)

seller_preferences_2 = (
    "Seller preferences: I prefer to sell my property to bachelors. I don't care when they get home in the night."
)
seller_agent_2 = SellerAgent(
    seller_preferences=seller_preferences_2,
    name="seller_agent_2",
    can_contact=["buyer_agent"],
)
