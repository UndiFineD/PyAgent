# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-mahilo\examples\team_of_agents\pydanticai_product_agent.py
...
product_agent = Agent(
    ...
    system_prompt=(
        "You are a product manager in our company,you are responsible for the product roadmap and feature requests."
    ),
)
