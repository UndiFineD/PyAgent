# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\evaluation.py\src.py\core.py\stages.py\answer_stage_d476b0e94ef4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\evaluation\src\core\stages\answer_stage.py
...
from evaluation.src.core.data_models import AnswerResult, QAPair, SearchResult
                ...
                for attempt in range(max_retries):
                    try:
                        ...
                        if attempt < max_retries - 1:
                            tqdm.write(
                                f"  ⏱️  Timeout (180s) for {qa.question_id}, retry {attempt + 1}/{max_retries}..."
                            )
                            ...
                            tqdm.write(
                                f"  ❌ Timeout after {max_retries} attempts for {qa.question_id}: {qa.question[:50]}..."
                            )
