# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\open_strata.py\src.py\strata.py\server_a8137ed99180.py
...
async def config_watching_context():
    ...
    watch_task = asyncio.create_task(client_manager.server_list.watch_config(on_config_changed))
