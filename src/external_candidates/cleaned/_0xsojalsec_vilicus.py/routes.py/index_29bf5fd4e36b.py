# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-vilicus\routes\index.py
import logging
import os
import threading
...
from models import Domain, Subdomain, domains_collection, subdomains_collection
...
def add_domain():
    ...
    try:
        ...
        return (
            jsonify(
                {
                    "message": "Domain and its subdomains added successfully!",
        ...
        return (
            jsonify({"message": "Domain added, but failed to get its subdomains"}),
            201,
        )
