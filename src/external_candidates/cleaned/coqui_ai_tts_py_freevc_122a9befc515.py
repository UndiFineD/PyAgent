# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tts.py\vc.py\models.py\freevc_122a9befc515.py
...
class FreeVC(CloningMixin, BaseVC):
    ...
    def load_audio(
        self,
        wav: (str | os.PathLike[Any] | npt.NDArray[np.float32] | torch.Tensor | list[float]),
    ):
