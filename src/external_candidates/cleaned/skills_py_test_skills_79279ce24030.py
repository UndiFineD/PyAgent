# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\zbruceli.py\unifai_trading_suite.py\tests.py\test_skills_79279ce24030.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\zbruceli\unifai-trading-suite\tests\test_skills.py
...
requires_unifai = pytest.mark.skipif(not UNIFAI_KEY, reason="UNIFAI_AGENT_API_KEY not set")

requires_google = pytest.mark.skipif(not GOOGLE_KEY, reason="GOOGLE_API_KEY not set")
