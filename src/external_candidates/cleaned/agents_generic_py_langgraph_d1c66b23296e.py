# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\livekit_plugins.py\livekit_plugins_langchain.py\livekit.py\plugins.py\langchain.py\langgraph_d1c66b23296e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\livekit-plugins\livekit-plugins-langchain\livekit\plugins\langchain\langgraph.py
