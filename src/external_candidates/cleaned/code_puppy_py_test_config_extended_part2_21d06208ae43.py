# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_config_extended_part2_21d06208ae43.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_config_extended_part2.py
...
class TestConfigExtendedPart2:
    ...
    def test_load_mcp_server_configs(self):
        ...
        with (
            ...
            patch(
                "builtins.open",
                mock_open(read_data='{"mcp_servers": {"server1": "http://localhost:3001"}}'),
            ),
        ):
