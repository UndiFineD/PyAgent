# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\tools.py\tools_converters_a0b587bf2afd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\examples\tools\tools_converters.py
...
weather_api_spec = {
    ...
    "servers": [{"url": "https://open-weather13.p.rapidapi.com"}],
    "paths": {
        "/city": {
            "get": {
