# Extracted from: C:\DEV\PyAgent\.external\abdarwish23-Advanced_SQL_Agent\app\services\sql_validator_service.py
...
def sql_validator(state: AgentState) -> AgentState:
    ...
    selected_table_schemas = {
        name: state["db_info"][name].table_schema.dict() for name in state["analyzed_query"].selected_tables
    }
