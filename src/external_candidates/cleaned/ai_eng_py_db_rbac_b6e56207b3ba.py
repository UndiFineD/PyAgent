# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\registry.py\access_control.py\rbac.py\db_rbac_b6e56207b3ba.py
...
class DbRBAC(RBAC):
    ...
    def get_global_admin_users(self) -> list[str]:
        ...
        return [
            ...
            if (u.project_name == SUPER_ADMIN_SCOPE and u.role_name == RoleType.ADMIN.value)
        ]
    ...
    def add_userrole(
        ...
        for u in self.userroles:
            if u.project_name == project_name.lower() and u.user_name == user_name.lower() and u.role_name == role_name:
                logging.warning(f"User {user_name} already have {role_name} role of {project_name}.")
