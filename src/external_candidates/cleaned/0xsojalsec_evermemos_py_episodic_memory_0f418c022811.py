# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\search.py\elasticsearch.py\memory.py\episodic_memory_0f418c022811.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\infra_layer\adapters\out\search\elasticsearch\memory\episodic_memory.py
...
class EpisodicMemoryDoc(TenantAwareAliasDoc("episodic-memory", number_of_shards=3)):
    ...
    search_content = e_field.Text(
        ...
        fields={
            ...
            "original": e_field.Text(analyzer=lower_keyword_analyzer, search_analyzer=lower_keyword_analyzer),
