# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_red_teaming_playground_labs.py\src.py\picture_submission.py\webapi.py\server.py\service.py\cache_efe3d6aeb6c0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AI-Red-Teaming-Playground-Labs\src\picture-submission\webapi\server\service\cache.py
...
class CacheTTL:
    ...
    def __init__(self, ttl: int):
        ...
        self.__clean_expired = (

            time.time() + self.__ttl * 5

        )  # Clean every 5 cycles of the TTL
