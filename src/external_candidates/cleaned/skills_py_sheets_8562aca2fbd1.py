# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\araa47.py\ez_google.py\scripts.py\sheets_8562aca2fbd1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\araa47\ez-google\scripts\sheets.py
