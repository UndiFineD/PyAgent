# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\src.py\dwpose.py\onnxdet_bda014bff330.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\dwpose\onnxdet.py
