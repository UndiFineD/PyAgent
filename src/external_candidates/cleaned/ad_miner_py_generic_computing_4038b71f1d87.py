# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ad_miner.py\ad_miner.py\sources.py\modules.py\generic_computing_4038b71f1d87.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\AD_Miner\ad_miner\sources\modules\generic_computing.py
...
def getCountValueFromKey(data, interested_key, sortOrder=True):
    ...
    final_res = dict(sorted(final_res.items(), key=operator.itemgetter(1), reverse=sortOrder))
