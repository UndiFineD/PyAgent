# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\tests.py\complex.py\test_edge_cases_801cbe1b8b9c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\tests\complex\test_edge_cases.py

from time import sleep

import pytest

from fle.env.entities import Direction, Position, ResourcePatch
...
def test_entity_interactions(game):
    ...
    game.place_entity_next_to(Prototype.BurnerInserter, input_chest.position, Direction.RIGHT, spacing=0.5)

    game.place_entity_next_to(Prototype.BurnerInserter, output_chest.position, Direction.LEFT, spacing=0.5)
