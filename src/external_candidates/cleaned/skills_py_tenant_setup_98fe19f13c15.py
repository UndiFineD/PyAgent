# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\ms365_tenant_manager.py\scripts.py\tenant_setup_98fe19f13c15.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\ms365-tenant-manager\scripts\tenant_setup.py
