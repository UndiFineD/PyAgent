# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\whatsapp_msgstore_viewer.py\decryption.py\dbs.py\whatsappcrypt14crypt15decrypter.py\utils.py\hex_string_to_encrypted_backup_key_3076d56f934c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\whatsapp-msgstore-viewer\decryption\dbs\WhatsAppCrypt14Crypt15Decrypter\utils\hex_string_to_encrypted_backup_key.py
