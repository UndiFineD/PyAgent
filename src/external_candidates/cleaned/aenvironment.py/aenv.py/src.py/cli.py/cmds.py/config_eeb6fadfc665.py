# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\cli\cmds\config.py
# Copyright 2025.
#
...
def show(key, format):
    ...
    if key:
        ...
        if format == "json":
            ...
            table = Table(title="CLI Configuration", show_header=True, header_style="bold magenta")
