# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\tests\test_tool.py
# Copyright 2025.
#
...
class TestToolRegistry:
    ...
    def test_tool_schema_generation(self):
        ...
        @register_tool
        def complex_tool(query: str, limit: int = 10, include_metadata: bool = False) -> Dict[str, Any]:
