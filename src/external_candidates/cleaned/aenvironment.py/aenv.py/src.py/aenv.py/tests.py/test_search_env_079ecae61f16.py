# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\tests\test_search_env.py
# Copyright 2025.
#
...
async def main():
    ...
    print("env1:", env1.get_env_info())
    try:
        tools = await env1.list_tools()
        print("Successfully retrieved tool list:", tools)
        assert tools is not None
        result = await env1.call_tool("search@1.0.0/get_current_weather", {"location": "Beijing"})
