# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\tests\test_weather_env.py
# Copyright 2025.
#
...
async def main():
    ...
    try:
        ...
        result = await env1.call_tool("test@0.0.4/get_current_weather", {"location": "Beijing"})
