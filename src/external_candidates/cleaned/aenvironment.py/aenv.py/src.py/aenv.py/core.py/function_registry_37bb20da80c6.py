# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\core\function_registry.py
# Copyright 2025.
#
...
class FunctionRegistry(BaseRegistry):
    ...
    def register_function(self, func: Callable, endpoint: str = None, method: str = "POST") -> Callable:
        """
        ...
        logger.info(f"Registered function '{func_name}' at endpoint '{endpoint}' with {method}")
        return func
    ...
    def list_functions_simple(self) -> Dict[str, str]:
        ...
        return {
            name: self._function_metadata.get(name, {}).get("endpoint", f"/functions/{name}")
...
def register_function(func: Optional[Callable] = None, *, endpoint: str = None, method: str = "POST"):
    """
