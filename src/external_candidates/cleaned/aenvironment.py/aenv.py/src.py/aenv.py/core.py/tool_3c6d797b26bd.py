# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\core\tool.py
# Copyright 2025.
#
...
class Tool(BaseModel):
    ...
    outputSchema: Optional[Dict[str, Any]] = Field(None, description="JSON Schema for output structure")
...
class ToolRegistry:
    ...
    def list_mcp_tools(self) -> List[mcp_types.Tool]:
        ...
        return [tool.get_mcp_tool() for tool in self._tool_descriptors.values() if not tool.hidden]
