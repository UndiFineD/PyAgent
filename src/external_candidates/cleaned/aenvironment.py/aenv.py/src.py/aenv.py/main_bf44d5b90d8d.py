# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\main.py
#!/usr/bin/env python3
# Copyright 2025.
#
...
def run_cli():
    ...
    parser.add_argument("tools_path", type=str, help="Path to directory or Python file containing tools")
