# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\src\aenv\server\mcp_server.py
# Copyright 2025.
#
...
class AEnvMCPServer:
    ...
    def __init__(self, name: str = "aenv-server", version: str = "0.1.0"):
        ...
        self.mcp = FastMCP(name=name, version=version, host="0.0.0.0", port=8081, log_level="DEBUG")
