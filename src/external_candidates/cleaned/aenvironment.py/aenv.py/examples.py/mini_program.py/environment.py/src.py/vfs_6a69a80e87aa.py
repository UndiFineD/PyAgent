# Extracted from: C:\DEV\PyAgent\.external\AEnvironment\aenv\examples\mini-program\environment\src\vfs.py
# Copyright 2025.
#
...
class VirtualFileSystem:
    ...
    def list_files(self, directory: str = "/") -> List[str]:
        ...
        return [path for path in self.files.keys() if path.startswith(directory + "/") or path == directory]
