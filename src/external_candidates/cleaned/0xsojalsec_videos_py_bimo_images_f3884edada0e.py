# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2019.py\bimo_images_f3884edada0e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2019\bimo_images.py
...
class PrimePiEPttern(Scene):
    def construct(self):
        ...
        exp = OldTex("e^{\\left(", "0" * 30, "\\right)}", "= \\frac{\\pi^2}{6}")
