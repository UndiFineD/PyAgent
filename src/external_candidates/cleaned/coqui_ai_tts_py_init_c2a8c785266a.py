# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\tests.py\init_c2a8c785266a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\tests\__init__.py
...
def assertHasNotAttr(test_obj, obj, intendedAttr):
    ...
    test_obj.assertFalse(
        testBool,
        msg=f"obj should not have an attribute. obj: {obj}, intendedAttr: {intendedAttr}",
    )
