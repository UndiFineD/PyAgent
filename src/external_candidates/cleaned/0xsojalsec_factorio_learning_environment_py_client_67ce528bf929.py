# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\admin.py\save_research_state.py\client_67ce528bf929.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\admin\save_research_state\client.py
    ...
    def __call__(self) -> ResearchState:
        ...
        try:
            ...
            return ResearchState(
                ...
                research_progress=(state["research_progress"] if "research_progress" in state else None),
                research_queue=([x for x in state["research_queue"].values()] if "research_queue" in state else []),
