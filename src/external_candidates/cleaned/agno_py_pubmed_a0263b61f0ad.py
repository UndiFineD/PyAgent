# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agno.py\libs.py\agno.py\agno.py\tools.py\pubmed_a0263b61f0ad.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\agno\tools\pubmed.py
        ...
        for article in xml_root.findall(".//PubmedArticle"):
            ...
            if pmc_elem is not None:
                ...
                full_text_url = (
                    ...
                    f"https://www.ncbi.nlm.nih.gov/pmc/articles/{pmc_elem.text}/"
            ...
            articles.append(

                {
                    ...
                    "Publication_Type": (
                        ...
                        ", ".join(pub_types) if pub_types else "Not specified"
