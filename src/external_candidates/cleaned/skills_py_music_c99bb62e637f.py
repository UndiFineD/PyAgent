# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\odrobnik.py\elevenlabs_skill.py\scripts.py\music_c99bb62e637f.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\odrobnik\elevenlabs-skill\scripts\music.py
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=("ElevenLabs output format (default: mp3_22050_32). Examples: mp3_22050_32, mp3_44100_128"),
    )
