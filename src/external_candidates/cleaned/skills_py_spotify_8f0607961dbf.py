# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mvanhorn.py\spotify_web_api.py\scripts.py\spotify_8f0607961dbf.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mvanhorn\spotify-web-api\scripts\spotify.py
...
def get_spotify():
    ...
    if not client_id or not client_secret:
        ...
        print(
            "5. Set env vars: SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET",
            file=sys.stderr,
        )
...
def main():
    ...
    top_parser.add_argument("--period", "-p", default="month", choices=["week", "month", "year", "all"])
