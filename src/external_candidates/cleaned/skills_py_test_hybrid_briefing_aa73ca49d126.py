# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\oura_analytics.py\tests.py\test_hybrid_briefing_aa73ca49d126.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\oura-analytics\tests\test_hybrid_briefing.py
...
from schema import NightRecord, ReadinessRecord, SleepRecord
