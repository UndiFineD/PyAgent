# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\recipes.py\thorsten_de.py\vits_tts.py\train_vits_0e6b942c44a1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\recipes\thorsten_DE\vits_tts\train_vits.py
...
def main():
    dataset_config = BaseDatasetConfig(
        ...
        path=os.path.join(output_path, "../thorsten-de/"),
    )
