# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2015.py\generate_logo_3a764a9915b5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2015\generate_logo.py
...
class LogoGeneration(Scene):
    ...
    def construct(self):
        ...
        for mob, color in [(iris, self.sphere_brown), (circle, self.circle_brown)]:
            ...
            mob.set_color(
                "black",
                lambda point: get_norm(point) < self.inner_radius_ratio * self.radius,
            )
