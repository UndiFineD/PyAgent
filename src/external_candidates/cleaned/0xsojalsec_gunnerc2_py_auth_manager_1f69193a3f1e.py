# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\teamserver.py\auth_manager_1f69193a3f1e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\teamserver\auth_manager.py
    ...
    try:
        ...
        with write_lock:
            ...
            conn.execute(
                ...
                (oid, username, pw_h, role, now, username),
            )
            ...
            cur = conn.execute("SELECT 1 FROM operators WHERE username = ? LIMIT 1", (username,))
