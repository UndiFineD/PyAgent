# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\benzema216.py\options_analyzer.py\scripts.py\strategy_recommend_dc6f67a0cfb0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\benzema216\options-analyzer\scripts\strategy_recommend.py
...
def match_strategy(outlook: str, iv_env: str, risk: str) -> List[Dict]:
    ...
    for name, strategy in STRATEGIES.items():
        ...
        elif (strategy["iv_pref"] == "high" and iv_env == "low") or (strategy["iv_pref"] == "low" and iv_env == "high"):
            score -= 20
        ...
        matches.append({"name": name, "score": score, "reasons": reasons, **strategy})
...
def format_markdown(result: dict) -> str:
    ...
    if result["recommendations"]:
        ...
        lines.append(
            f'python scripts/strategy_analyzer.py --strategy {top["name"]} --spot {result["spot"] or 100} --legs "..." --dte 30'
        )
