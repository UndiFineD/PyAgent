# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\stream_omni.py\stream_omni.py\model.py\builder_e072cc1e477a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Stream-Omni\stream_omni\model\builder.py
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                ...
                if "audio" in model_name.lower() or "omni" in model_name.lower():
                    from stream_omni.model.language_model.stream_omni_llama import (
                        StreamOmniConfig,
                    )
                    ...
                    model = StreamOmniLlamaForCausalLM.from_pretrained(
                        model_base,
                        low_cpu_mem_usage=True,
                        attn_implementation=attn_implementation,
                        config=llava_cfg,
