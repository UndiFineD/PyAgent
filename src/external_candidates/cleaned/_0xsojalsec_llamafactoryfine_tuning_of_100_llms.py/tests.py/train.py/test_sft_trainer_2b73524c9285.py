# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\tests\train\test_sft_trainer.py
...
class DataCollatorWithVerbose(DataCollatorWithPadding):
    ...
    def __call__(self, features: list[dict[str, Any]]) -> dict[str, Any]:
        features = [
            {k: v for k, v in feature.items() if k in ["input_ids", "attention_mask", "labels"]} for feature in features
        ]
