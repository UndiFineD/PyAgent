# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\webui\chatter.py
    ...
    def append(
        ...
        return (
            ...
            + [
                {
                    "role": "user",
                    "content": _escape_html(query) if escape_html else query,
                }
            ],
