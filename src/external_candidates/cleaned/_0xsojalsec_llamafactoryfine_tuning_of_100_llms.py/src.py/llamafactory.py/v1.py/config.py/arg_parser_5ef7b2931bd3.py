# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\v1\config\arg_parser.py
...
def get_args(
    args: InputArgument = None,
) -> tuple[ModelArguments, DataArguments, TrainingArguments, SampleArguments]:
