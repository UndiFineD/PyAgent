# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LlamaFactoryFine-Tuning-of-100-LLMs\src\llamafactory\hparams\model_args.py
    ...
    def __post_init__(self):
        ...
        if self.new_special_tokens_config is not None:
            ...
            try:
                ...
                logger.error_rank0(f"Failed to load special tokens config from '{self.new_special_tokens_config}': {e}")
                raise
