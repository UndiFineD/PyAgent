# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\gui.py\sessions_tab_65fbaf1b53dd.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\gui\sessions_tab.py
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.ForegroundRole:
            if key == "last_checkin":
                ...
                if cls == "stale":
                    return QColor("#9aa3ad")

                if cls == "cool":
                    return QColor("#bdc6d1")

                if cls == "warm":
                    return QColor("#e9d27e")

                if cls == "live":
                    return QColor("#99e2b4")
