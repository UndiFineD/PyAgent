# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\models.py\qwen_model_b4135403a168.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\models\qwen_model.py
    ...
    def check_model_config(self):
        ...
        for param in self.model_config_dict:
            if param not in QWEN_API_PARAMS:
                raise ValueError(f"Unexpected argument `{param}` is input into Qwen model backend.")
