# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\rag.py\embeddings.py\openai_embedding_0e50a90c8732.py
...
class OpenAIEmbedding(BaseEmbedding):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        base_url = (
            base_url or os.getenv("OPENAI_API_BASE") or os.getenv("OPENAI_BASE_URL") or "https://api.openai.com/v1"
        )
