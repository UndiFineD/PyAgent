# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-XSS-Finder\blindserver.py
import logging
import smtplib
import ssl
...
httpd.socket = ssl.wrap_socket(httpd.socket, keyfile="newkey.key", certfile="newcert.crt", server_side=True)
