# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\agile_product_owner.py\scripts.py\user_story_generator_a1647f6eb209.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\agile-product-owner\scripts\user_story_generator.py
    ...
    def generate_epic_stories(self, epic: Dict) -> List[Dict]:
        ...
        for persona in personas:
            for i, scope_item in enumerate(scope):
                story = self.generate_story(persona=persona, feature=scope_item, epic=epic_name, index=i + 1)
