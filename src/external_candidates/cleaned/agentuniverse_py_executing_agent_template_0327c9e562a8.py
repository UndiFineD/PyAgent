# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\template.py\executing_agent_template_0327c9e562a8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\template\executing_agent_template.py
    ...
    def _execute_tasks(
        ...
        **kwargs,
        ...
        with ThreadPoolExecutor(
            max_workers=min(len(framework), 10),
            thread_name_prefix="executing_agent_template",
        ) as thread_executor:
            futures = []
