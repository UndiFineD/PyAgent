# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pytorch_lightning.py\tests.py\tests_fabric.py\plugins.py\environments.py\test_kubeflow_61e0a1e550eb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytorch-lightning\tests\tests_fabric\plugins\environments\test_kubeflow.py
...
def test_attributes_from_environment_variables(caplog):
    ...
    with caplog.at_level(
        logging.DEBUG,
        logger="pytorch_lightning_enterprise.plugins.environments.kubeflow",
    ):
