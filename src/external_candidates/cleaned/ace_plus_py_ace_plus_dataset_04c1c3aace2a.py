# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ace_plus.py\modules.py\ace_plus_dataset_04c1c3aace2a.py
...
class ACEPlusDataset(BaseDataset):
    ...
    def __init__(self, cfg, logger=None):
        ...
        self.items = self.read_data_list(delimiter, fields, prefix, edit_type_list, prompt_file)
