# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\officialpm.py\my_tesla.py\tests.py\test_cmd_seats_999eb7be8df7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\officialpm\my-tesla\tests\test_cmd_seats.py
...
class SeatsTests(unittest.TestCase):
    ...
    def test_seats_set_calls_endpoint(self):
        ...
        self.assertEqual(
            ...
            [("REMOTE_SEAT_HEATER_REQUEST", {"heater": 0, "level": 2})],
        )
