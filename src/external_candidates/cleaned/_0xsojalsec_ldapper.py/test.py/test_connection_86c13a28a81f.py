# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ldapper\test\test_connection.py
# -*- coding: utf-8 -*-
...
class TestConnection:
    ...
    def test_connnection_connect_failed_attempt(self, caplog):
        conn = Connection.connect(logindn="foo", password="wrong", retries=1, uri="ldap://localhost:389")
        assert conn is None
