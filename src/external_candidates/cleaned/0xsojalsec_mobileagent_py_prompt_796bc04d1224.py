# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_mobileagent.py\pc_agent.py\pcagent_v1.py\prompt_796bc04d1224.py
...
def get_action_prompt(
    ...
    prompt += (
        'Type (x, y), [text]: Tap the position (x, y) and type the "text" in the input box and press the enter key.\n'
    )
