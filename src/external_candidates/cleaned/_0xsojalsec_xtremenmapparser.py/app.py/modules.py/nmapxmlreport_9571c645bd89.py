    ...
    class Host:
        ...
        class OS:
            def __init__(self, element):
                ...
                self.osfingerprint = [
                    self.OSFingerprint(osfingerprint) for osfingerprint in element.findall("osfingerprint")
                ]
            ...
            class OSMatch:
                ...
                def __str__(self):
                    return (
                        f"OSMatch(name={self.name}, accuracy={self.accuracy}, line={self.line}, osclass={self.osclass})"
                    )
