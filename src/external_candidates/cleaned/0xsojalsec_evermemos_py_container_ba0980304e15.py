# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\di.py\container_ba0980304e15.py
        ...
        for registered_type in registered_types:
            try:
                ...
                for base in registered_type.__mro__[1:]:  # Skip self
                    ...
                    if base != abc.ABC and base != object and hasattr(base, "__abstractmethods__"):  # ABC type
