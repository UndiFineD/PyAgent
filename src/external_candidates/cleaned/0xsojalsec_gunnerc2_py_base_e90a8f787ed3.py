# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\base_e90a8f787ed3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\base.py
...
def load(os_type: str | None = None):
    ...
    for _, module_name, is_pkg in pkgutil.walk_packages(pkg.__path__, pkg.__name__ + "."):
        ...
        if (
            ".common." in module_name
            or ".windows." in module_name
            or ".linux." in module_name
            or module_name.count(".") >= 4
        ):
            pass  # allowed
