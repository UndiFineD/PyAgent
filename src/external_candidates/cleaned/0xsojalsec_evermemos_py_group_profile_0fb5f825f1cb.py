# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\infra_layer.py\adapters.py\out.py\persistence.py\document.py\memory.py\group_profile_0fb5f825f1cb.py
...
class TopicInfo(BaseModel):
    ...
    evidences: Optional[List[str]] = Field(default_factory=list, description="memcell_ids as evidence")

    confidence: Optional[str] = Field(default=None, description="'strong' | 'weak' - confidence level")
...
class RoleAssignment(BaseModel):
    ...
    confidence: Optional[str] = Field(default=None, description="Confidence level: 'strong' | 'weak'")
...
class GroupProfile(DocumentBase, AuditBase):
    ...
    group_name: Optional[str] = Field(default=None, description="Group name (not necessarily present)")
    ...
    summary: Optional[str] = Field(default=None, description="Summary of recent group topics")
