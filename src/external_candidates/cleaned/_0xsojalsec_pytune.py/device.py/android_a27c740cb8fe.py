# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytune\device\android.py
import base64
...
class Android(Device):
    def __init__(self, logger, os, device_name, deviceid, uid, tenant, prt, session_key):
        ...
        self.checkin_url = (
            "https://a.manage.microsoft.com/devicegatewayproxy/AndroidHandler.ashx?Platform=AndroidForWork"
        )
    ...
    def get_syncml_data(self, key):
        ...
        data = {
            ...
            f"./DevInfo/Man": {"Format": "chr", "Data": "Google"},
            ...
            f"./Device/DevInfo/DmI": {"Format": "chr", "Data": "com.android.vending"},
            f"./Device/DevInfo/Man": {"Format": "chr", "Data": "Google"},
            f"./Device/DevInfo/Mod": {
                "Format": "chr",
                "Data": "Android SDK built for x86",
            },
            f"./DevInfo/Mod": {"Format": "chr", "Data": "Android SDK built for x86"},
            ...
            f"./Device/DevDetail/FwV": {"Format": "chr", "Data": "unknown"},
            ...
            f"./Device/DevInfo/DmV": {"Format": "chr", "Data": "1.0"},
            f"./Device/DevDetail/HwV": {"Format": "chr", "Data": "ranchu"},
            f"./Device/DevDetail/DevTyp": {"Format": "chr", "Data": "sdk_gphone_x86"},
