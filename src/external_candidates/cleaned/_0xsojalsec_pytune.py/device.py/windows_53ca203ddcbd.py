# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pytune\device\windows.py
import base64
import gzip
import io
import json
...
from utils.utils import (
    ...
    extract_pfx,
    prtauth,
    save_encrypted_message_as_smime,
)
...
class Windows(Device):
    ...
    """
        ...
        binary_security_token = xml.find(
            ...
            syncml_data["SyncML"]["SyncBody"]["Alert"] = [
                {"CmdID": "2", "Data": "1201"},
                {
                    ...
                    "Item": {
                        ...
                        "Data": {"@xmlns": "SYNCML:SYNCML1.2", "#text": "others"},
                    },
                },
                {
                    "CmdID": "4",
                    ...
                    "Item": {
                        "Meta": {
                            "Type": {
                                "@xmlns": "syncml:metinf",
                                "#text": "com.microsoft/MDM/BootstrapSync",
                            }
                        },
                        "Data": {"@xmlns": "SYNCML:SYNCML1.2", "#text": "device"},
                    },
                },
                {
                    "CmdID": "5",
                    ...
                    "Item": {
                        "Meta": {
                            "Type": {
                                "@xmlns": "syncml:metinf",
                                "#text": "com.microsoft/MDM/OdjSync",
                            }
                        },
                        "Data": {"@xmlns": "SYNCML:SYNCML1.2", "#text": "device"},
                    },
    ...
    def get_syncml_data(self, key):
        ...
        data = {
            f"./DevInfo/DmV": {"Format": "int", "Data": "1.3"},
            ...
            f"./Device/DevDetail/SwV": {"Format": "chr", "Data": self.os_version},
            f"./DevDetail/SwV": {"Format": "chr", "Data": self.os_version},
            f"./Vendor/MSFT/WindowsLicensing/Edition": {"Format": "int", "Data": "4"},
            f"./Vendor/MSFT/Update/LastSuccessfulScanTime": {
                "Format": "chr",
                "Data": formatted_date,
            },
            f"./Vendor/MSFT/DeviceStatus/OS/Mode": {"Format": "int", "Data": "0"},
            f"./Vendor/MSFT/DMClient/Provider/MS%20DM%20Server/EntDMID": {
                "Format": "chr",
                "Data": self.deviceid,
            },
            f"./DevInfo/Man": {"Format": "chr", "Data": "Microsoft Corporation"},
            f"./Device/DevInfo/Lang": {"Format": "chr", "Data": "en-US"},
            f"./DevInfo/Lang": {"Format": "chr", "Data": "en-US"},
            ...
            f"./DevInfo/Mod": {"Format": "chr", "Data": "VMware7.1"},
            f"./Vendor/MSFT/DeviceStatus/OS/Edition": {"Format": "int", "Data": "4"},
            f"./DevDetail/FwV": {
                "Format": "chr",
            ...
            f"./Device/DevInfo/DmV": {"Format": "chr", "Data": "1.3"},
            f"./Device/DevDetail/HwV": {
                "Format": "chr",
                "Data": "Hyper-V UEFI Release v4.0",
            },
            f"./Device/DevDetail/DevTyp": {"Format": "chr", "Data": "VMware 7.1"},
