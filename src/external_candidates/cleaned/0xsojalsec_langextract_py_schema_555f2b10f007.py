# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\langextract.py\core.py\schema_555f2b10f007.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\langextract\core\schema.py
...
class FormatModeSchema(BaseSchema):
    ...
    def sync_with_provider_kwargs(self, kwargs: dict[str, Any]) -> None:
        ...
        if "format" in kwargs:
            ...
            self.format_type = types.FormatType.JSON if self._format == "json" else types.FormatType.YAML
