# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2016.py\hilbert.py\fractal_porn_17dedcb8eeff.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2016\hilbert\fractal_porn.py
...
class FromKochToSpaceFilling(Scene):
    ...
    def show_angles(self):
        ...
        arcs = [
            ...
            Arc(
                ...
                2 * (np.pi / 2 - curve.angle), radius=r, start_angle=np.pi + curve.angle
    ...
    def show_change_side_by_side(self):
        ...
        self.play(
            ...
            Transform(right_curve, SharperKoch(order=2).shift(3 * RIGHT)),
        ...
        for order in range(3, self.max_order):
            ...
            self.play(Transform(right_curve, SharperKoch(order=order).shift(3 * RIGHT)))
