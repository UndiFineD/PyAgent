# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\tests.py\prompting_test_aafd5546f80e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-langextract\tests\prompting_test.py
...
class QAPromptGeneratorTest(parameterized.TestCase):
    def test_generate_prompt(self):
        ...
        actual_prompt_text = prompt_generator.render("The patient reports chest pain and shortness of breath.")
