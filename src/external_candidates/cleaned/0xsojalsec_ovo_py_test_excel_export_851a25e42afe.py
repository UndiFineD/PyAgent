# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_ovo.py\tests.py\unit_tests.py\test_excel_export_851a25e42afe.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-ovo\tests\unit_tests\test_excel_export.py
...
def create_test_data():
    ...
    project = Project(
        id="test_proteinqc_excel_project",
    ...
    design = Design(
        id=f"ovo_{pool.id}_test_proteinqc_excel_design",
        pool_id=pool.id,
        accepted=True,
        spec=spec,
    )
