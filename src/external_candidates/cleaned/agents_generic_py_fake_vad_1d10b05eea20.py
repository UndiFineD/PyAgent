# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agents_generic.py\tests.py\fake_vad_1d10b05eea20.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agents_generic\tests\fake_vad.py
...
class FakeVADStream(VADStream):
    ...
    def _send_vad_event(self, type: VADEventType, fake_speech: FakeUserSpeech, curr_time: float) -> None:
