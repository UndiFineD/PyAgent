# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\pose_utils\tracker.py
import warnings
...
def track_by_area(humans, target_img_size, threshold=0.3):
    ...
    for human in humans:
        ...
        # compute bbox
        j2d_area = (j2d_coco[..., 0].max() - j2d_coco[..., 0].min()) * (j2d_coco[..., 1].max() - j2d_coco[..., 1].min())
