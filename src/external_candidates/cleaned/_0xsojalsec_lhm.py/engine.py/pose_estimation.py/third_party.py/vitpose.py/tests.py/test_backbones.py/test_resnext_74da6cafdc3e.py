# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_backbones\test_resnext.py
...
def test_bottleneck():
    ...
    block = BottleneckX(64, 256, groups=32, width_per_group=4, stride=2, style="pytorch")
