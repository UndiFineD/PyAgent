# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_losses\test_top_down_losses.py
...
def test_adaptive_wing_loss():
    ...
    assert torch.allclose(loss(fake_pred, fake_label, torch.ones([1, 3, 1])), torch.tensor(0.0))
