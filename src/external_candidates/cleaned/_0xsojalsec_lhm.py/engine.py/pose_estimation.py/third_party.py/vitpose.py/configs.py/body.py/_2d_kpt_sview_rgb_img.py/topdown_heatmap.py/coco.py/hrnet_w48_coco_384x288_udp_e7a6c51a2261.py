# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\coco\hrnet_w48_coco_384x288_udp.py
_base_ = [
...
train_pipeline = [
    ...
    dict(type="TopDownGenerateTarget", sigma=3, encoding="UDP", target_type=target_type),
    dict(
        type="Collect",
