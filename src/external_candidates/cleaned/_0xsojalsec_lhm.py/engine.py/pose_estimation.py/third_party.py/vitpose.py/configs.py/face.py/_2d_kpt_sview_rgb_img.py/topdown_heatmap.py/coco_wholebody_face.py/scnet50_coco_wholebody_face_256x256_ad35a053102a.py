# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\face\2d_kpt_sview_rgb_img\topdown_heatmap\coco_wholebody_face\scnet50_coco_wholebody_face_256x256.py
_base_ = [
...
model = dict(
    type="TopDown",
    pretrained="https://download.openmmlab.com/mmpose/pretrain_models/scnet50-7ef0a199.pth",
