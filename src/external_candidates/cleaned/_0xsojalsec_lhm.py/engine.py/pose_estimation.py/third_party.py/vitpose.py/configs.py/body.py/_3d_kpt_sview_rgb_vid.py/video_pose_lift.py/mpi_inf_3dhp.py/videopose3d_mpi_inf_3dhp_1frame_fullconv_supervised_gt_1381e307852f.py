# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\3d_kpt_sview_rgb_vid\video_pose_lift\mpi_inf_3dhp\videopose3d_mpi-inf-3dhp_1frame_fullconv_supervised_gt.py
_base_ = [
    "../../../../_base_/default_runtime.py",
    "../../../../_base_/datasets/mpi_inf_3dhp.py",
]
evaluation = dict(interval=10, metric=["mpjpe", "p-mpjpe", "3dpck", "3dauc"], key_indicator="MPJPE")
