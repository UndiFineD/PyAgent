# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\wholebody\2d_kpt_sview_rgb_img\topdown_heatmap\coco-wholebody\hrnet_w48_coco_wholebody_256x192.py
_base_ = [
