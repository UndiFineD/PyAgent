# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\3d_kpt_mview_rgb_img\voxelpose\panoptic\voxelpose_prn64x64x64_cpn80x80x20_panoptic_cam5.py
_base_ = [
...
# learning policy
lr_config = dict(policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[8, 9])
total_epochs = 15
log_config = dict(
    interval=50,
    hooks=[
