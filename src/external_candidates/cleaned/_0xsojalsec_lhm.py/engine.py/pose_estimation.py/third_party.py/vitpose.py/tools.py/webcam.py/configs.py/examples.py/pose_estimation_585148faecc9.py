# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\webcam\configs\examples\pose_estimation.py
...
runner = dict(
    ...
    nodes=[
        ...
        dict(
            ...
            content_lines=[
                "This is a demo for pose visualization and simple image effects. Have fun!",
                "",
                "Hot-keys:",
