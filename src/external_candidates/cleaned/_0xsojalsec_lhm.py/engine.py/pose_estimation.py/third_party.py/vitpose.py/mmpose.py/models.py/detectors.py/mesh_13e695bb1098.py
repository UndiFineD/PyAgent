# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\detectors\mesh.py
...
class ParametricMesh(BasePose):
    ...
    def forward_train(self, *args, **kwargs):
        ...
        raise NotImplementedError(
            "This interface should not be used in current training schedule. Please use `train_step` for training."
        )
