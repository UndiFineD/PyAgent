# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\_base_\datasets\jhmdb.py
dataset_info = dict(
    dataset_name="jhmdb",
    paper_info=dict(
    ...
    keypoint_info={
        ...
        5: dict(name="right_hip", id=5, color=[0, 255, 0], type="lower", swap="left_hip"),
        6: dict(name="left_hip", id=6, color=[51, 153, 255], type="lower", swap="right_hip"),
        7: dict(
            name="right_elbow",
            id=7,
            color=[51, 153, 255],
