# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\detectors\associative_embedding.py
...
try:
    ...
    warnings.warn("auto_fp16 from mmpose will be deprecated from v0.15.0Please install mmcv>=1.1.4")
...
class AssociativeEmbedding(BasePose):
    ...
    @deprecated_api_warning({"pose_limb_color": "pose_link_color"}, cls_name="AssociativeEmbedding")
    def show_result(
        self,
        img,
        result,
