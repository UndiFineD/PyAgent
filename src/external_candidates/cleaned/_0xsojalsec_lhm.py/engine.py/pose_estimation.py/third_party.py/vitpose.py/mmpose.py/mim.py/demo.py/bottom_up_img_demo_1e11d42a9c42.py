...
def main():
    ...
    parser.add_argument("--img-path", type=str, help="Path to an image file or a image folder.")
    ...
    if osp.isfile(args.img_path):
        ...
        raise ValueError(f"Image path should be an image or image folder.Got invalid image path: {args.img_path}")
