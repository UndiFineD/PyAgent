# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\dataset_info.py
...
class DatasetInfo:
    def __init__(self, dataset_info):
        ...
        self.joint_weights = np.array(self._dataset_info["joint_weights"], dtype=np.float32)[:, None]
    ...
    def _parse_skeleton_info(self):
        ...
        for skid in self.skeleton_info.keys():
            ...
            self.skeleton.append([self.keypoint_name2id[link[0]], self.keypoint_name2id[link[1]]])
    ...
    def _parse_keypoint_info(self):
        ...
        self.flip_pairs = [
            [self.keypoint_name2id[pair[0]], self.keypoint_name2id[pair[1]]] for pair in self.flip_pairs_name
        ]
