...
def _build_batch_data(model, imgs, bboxes, dataset="TopDownCocoDataset", dataset_info=None):
    """Inference human bounding boxes.
...
def inference_bottom_up_pose_model(
    ...
    with OutputHook(model, outputs=outputs, as_tensor=False) as h:
        ...
        keep = oks_nms(pose_results, pose_nms_thr, sigmas, score_per_joint=score_per_joint)
