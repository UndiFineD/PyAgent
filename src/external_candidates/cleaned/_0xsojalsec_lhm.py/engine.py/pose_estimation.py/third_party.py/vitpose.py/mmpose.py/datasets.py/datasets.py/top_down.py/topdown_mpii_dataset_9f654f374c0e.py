# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\top_down\topdown_mpii_dataset.py
        ...
        for a in anno:
            ...
            if not self.test_mode:
                ...
                assert len(joints) == self.ann_info["num_joints"], (
                    f"joint num diff: {len(joints)}" + f" vs {self.ann_info['num_joints']}"
                )
