# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\bottom_up\bottom_up_coco.py
...
class BottomUpCocoDataset(Kpt2dSviewRgbImgBottomUpDataset):
    ...
    def _get_joints(self, anno):
        ...
        if self.ann_info["scale_aware_sigma"]:
            joints = np.zeros((num_people, self.ann_info["num_joints"], 4), dtype=np.float32)
        else:
