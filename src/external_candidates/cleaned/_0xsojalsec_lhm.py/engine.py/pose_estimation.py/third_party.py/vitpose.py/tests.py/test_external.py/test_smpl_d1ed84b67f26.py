# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_external\test_smpl.py
...
def test_smpl():
    ...
    _ = smpl(betas=betas, body_pose=body_pose, global_orient=global_orient, transl=transl)
