# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\hand\interhand2d_dataset.py
        ...
        for img_id in self.img_ids:
            ...
            for hand in range(2):
                ...
                if np.sum(joint_valid[hand, :]) > 11:
                    ...
                    joints_3d_visible[:, :2] = np.minimum(1, joint_valid[hand, :].reshape(-1, 1))
