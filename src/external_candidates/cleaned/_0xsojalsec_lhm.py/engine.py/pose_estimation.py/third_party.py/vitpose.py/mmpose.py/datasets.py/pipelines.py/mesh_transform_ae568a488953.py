# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\pipelines\mesh_transform.py
...
def _flip_iuv(iuv, uv_type="BF"):
    ...
    if uv_type == "BF":
        ...
        raise NotImplementedError(f"The flip of {uv_type} UV map is not implemented yet.")
...
class MeshRandomFlip:
    ...
    def __call__(self, results):
        ...
        joints_3d, joints_3d_visible = _flip_joints_3d(joints_3d, joints_3d_visible, results["ann_info"]["flip_pairs"])
