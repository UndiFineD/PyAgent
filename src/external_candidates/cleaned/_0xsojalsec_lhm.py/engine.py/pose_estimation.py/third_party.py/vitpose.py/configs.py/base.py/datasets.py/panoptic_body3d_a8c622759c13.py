# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\_base_\datasets\panoptic_body3d.py
dataset_info = dict(
    ...
    paper_info=dict(
        ...
        title="Panoptic Studio: A Massively Multiview System for Interaction Motion Capture",
    ...
    keypoint_info={
        ...
        15: dict(name="left_eye", id=15, color=[51, 153, 255], type="upper", swap="right_eye"),
        16: dict(name="left_ear", id=16, color=[51, 153, 255], type="upper", swap="right_ear"),
        17: dict(name="right_eye", id=17, color=[51, 153, 255], type="upper", swap="left_eye"),
        18: dict(name="right_ear", id=18, color=[51, 153, 255], type="upper", swap="left_ear"),
    },
    skeleton_info={
