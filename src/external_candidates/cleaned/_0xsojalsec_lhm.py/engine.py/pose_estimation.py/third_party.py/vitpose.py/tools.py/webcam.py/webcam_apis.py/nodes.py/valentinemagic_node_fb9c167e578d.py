...
class ValentineMagicNode(FrameDrawingNode):
    def __init__(
        ...
        if hand_heart_img_path is None:
            hand_heart_img_path = (
                "https://user-images.githubusercontent.com/87690686/149731850-ea946766-a4e8-4efa-82f5-e2f0515db8ae.png"
            )
        if flying_heart_img_path is None:
            flying_heart_img_path = (
                "https://user-images.githubusercontent.com/87690686/153554948-937ce496-33dd-49ab-9829-0433fd7c13c4.png"
            )
    ...
    def _cal_angle(self, p1: np.ndarray, p2: np.ndarray, p3: np.ndarray, p4: np.ndarray) -> np.float64:
    ...
    def _check_heart(
        ...
        if both_hands_vis:
            ...
            hand_dis = self._cal_distance(kpts[hand_indices[20]][:2], kpts[hand_indices[41]][:2])
        ...
        right_mid_hand_pos = (kpts[hand_indices[30]][:2] + kpts[hand_indices[33]][:2]) / 2
    ...
    def _draw_heart(self, canvas: np.ndarray, heart_info: HeartInfo, t_pass: float) -> np.ndarray:
        ...
        for pose_result in pose_results:
            ...
            for i in range(self.num_persons):
                ...
                if id in self.heart_infos.copy():
                    ...
                    heart_type = self._check_heart(preds[i], hand_indices, mouth_index, eye_indices)
                    ...
                    if heart_type:
                        ...
                        self.heart_infos[id] = HeartInfo(heart_type, start_time, start_pos, end_pos)
