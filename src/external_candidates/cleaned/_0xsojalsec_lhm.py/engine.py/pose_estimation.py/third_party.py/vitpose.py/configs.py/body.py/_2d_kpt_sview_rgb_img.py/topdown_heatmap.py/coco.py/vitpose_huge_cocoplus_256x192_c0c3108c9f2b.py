# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\coco\ViTPose_huge_cocoplus_256x192.py
_base_ = [
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file="/mnt/workspace/data/coco/person_detection_results/COCO_val2017_detections_AP_H_56_person.json",
)
