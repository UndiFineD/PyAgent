# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\associative_embedding\aic\higherhrnet_w32_aic_512x512_udp.py
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=f"{data_root}/ai_challenger_keypoint_train_20170902/keypoint_train_images_20170902/",
        data_cfg=data_cfg,
    ...
    val=dict(
        ...
        img_prefix=f"{data_root}/ai_challenger_keypoint_validation_20170911/keypoint_validation_images_20170911/",
        data_cfg=data_cfg,
