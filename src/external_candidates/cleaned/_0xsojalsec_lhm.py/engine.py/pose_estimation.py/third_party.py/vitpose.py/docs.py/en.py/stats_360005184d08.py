# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\docs\en\stats.py
#!/usr/bin/env python
...
for f in files:
    ...
    for _, p in papers:
        ...
        paperlinks[p] = ", ".join(
            (
                (f"[{paperlink} ⇨](topics/{splitext(basename(f))[0]}.html#{anchor(paperlink)})")
