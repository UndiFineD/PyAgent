# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\backbones\regnet.py
...
class RegNet(ResNet):
    ...
    def __init__(
        ...
        if isinstance(arch, str):
            ...
            raise TypeError(f'Expect "arch" to be either a string or a dict, got {type(arch)}')
