# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\core\evaluation\eval_hooks.py
    ...
    def __init__(
        ...
        **eval_kwargs,
        ...
        if "gpu_collect" in eval_kwargs:
            warnings.warn(
                '"gpu_collect" will be deprecated in EvalHook.Please remove it from the config.',
                DeprecationWarning,
            )
