# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\face\2d_kpt_sview_rgb_img\topdown_heatmap\coco_wholebody_face\hrnetv2_w18_coco_wholebody_face_256x256_dark.py
_base_ = [
...
model = dict(
    ...
    train_cfg=dict(),
    test_cfg=dict(flip_test=True, post_process="unbiased", shift_heatmap=True, modulate_kernel=11),
)
