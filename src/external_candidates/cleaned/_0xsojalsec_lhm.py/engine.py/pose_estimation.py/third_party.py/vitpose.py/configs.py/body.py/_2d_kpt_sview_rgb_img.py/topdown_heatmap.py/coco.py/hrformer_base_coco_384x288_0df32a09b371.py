...
model = dict(
    type="TopDown",
    pretrained="https://download.openmmlab.com/mmpose/pretrain_models/hrformer_base-32815020_20220226.pth",
    backbone=dict(
        type="HRFormer",
        in_channels=3,
        norm_cfg=norm_cfg,
    ...
    train_cfg=dict(),
    test_cfg=dict(flip_test=True, post_process="default", shift_heatmap=True, modulate_kernel=17),
)
