# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\face\face_wflw_dataset.py
...
class FaceWFLWDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def _get_normalize_factor(self, gts, *args, **kwargs):
        ...
        interocular = np.linalg.norm(gts[:, 60, :] - gts[:, 72, :], axis=1, keepdims=True)
