# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\core\post_processing\post_transforms.py
# ------------------------------------------------------------------------------
...
def fliplr_regression(regression, flip_pairs, center_mode="static", center_x=0.5, center_index=0):
    ...
    assert center_mode in allowed_center_mode, (
        f"Get invalid center_mode {center_mode}, allowed choices are {allowed_center_mode}"
    )
