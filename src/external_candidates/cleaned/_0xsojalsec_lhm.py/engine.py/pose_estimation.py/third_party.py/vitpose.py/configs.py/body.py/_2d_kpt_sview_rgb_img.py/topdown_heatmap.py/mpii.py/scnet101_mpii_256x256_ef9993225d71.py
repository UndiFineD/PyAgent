# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\mpii\scnet101_mpii_256x256.py
_base_ = [
...
model = dict(
    type="TopDown",
    pretrained="https://download.openmmlab.com/mmpose/pretrain_models/scnet101-94250a77.pth",
