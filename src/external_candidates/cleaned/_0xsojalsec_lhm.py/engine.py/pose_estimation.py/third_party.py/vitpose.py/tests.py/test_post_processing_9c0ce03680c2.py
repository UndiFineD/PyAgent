# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_post_processing.py
...
def test_flip_regression():
    ...
    # static mode
    res_static = fliplr_regression(coords, flip_pairs, center_mode="static", center_x=root[0, 0])
