# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\3d_kpt_sview_rgb_vid\video_pose_lift\h36m\videopose3d_h36m_27frames_fullconv_semi-supervised.py
_base_ = [
    "../../../../_base_/default_runtime.py",
    "../../../../_base_/datasets/h36m.py",
]
checkpoint_config = dict(interval=20)
evaluation = dict(interval=10, metric=["mpjpe", "p-mpjpe", "n-mpjpe"], key_indicator="MPJPE")
