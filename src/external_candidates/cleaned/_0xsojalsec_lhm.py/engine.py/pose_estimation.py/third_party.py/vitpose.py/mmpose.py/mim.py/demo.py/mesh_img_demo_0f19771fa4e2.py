# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\.mim\demo\mesh_img_demo.py
...
def main():
    ...
    for i in range(len(img_keys)):
        ...
        vis_3d_mesh_result(pose_model, pose_results, image_name, show=args.show, out_file=out_file)
