# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\fashion\deepfashion_dataset.py
...
class DeepFashionDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(
        ...
        if dataset_info is None:
            ...
            if subset != "":
                warnings.warn(
                    "subset is deprecated.Check https://github.com/open-mmlab/mmpose/pull/663 for details.",
                    DeprecationWarning,
                )
            if subset == "upper":
