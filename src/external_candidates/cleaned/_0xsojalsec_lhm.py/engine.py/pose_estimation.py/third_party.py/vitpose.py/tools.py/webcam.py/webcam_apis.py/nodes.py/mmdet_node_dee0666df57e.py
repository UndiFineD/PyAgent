...
class DetectorNode(Node):
    def __init__(
        ...
        # Init model
        self.model = init_detector(self.model_config, self.model_checkpoint, device=self.device.lower())
    ...
    def _post_process(self, preds):
        ...
        for i, (cls_name, bboxes, masks) in enumerate(zip(self.model.CLASSES, dets, segms)):
            if masks is None:
