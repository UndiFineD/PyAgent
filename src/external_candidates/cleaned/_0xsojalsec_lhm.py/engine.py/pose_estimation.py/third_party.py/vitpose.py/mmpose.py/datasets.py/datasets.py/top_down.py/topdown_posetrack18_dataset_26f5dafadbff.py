# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\top_down\topdown_posetrack18_dataset.py
...
class TopDownPoseTrack18Dataset(TopDownCocoDataset):
    ...
    def _do_python_keypoint_eval(self, gt_folder, pred_folder):
        ...
        if not has_poseval:
            raise ImportError(
                "Please install poseval package for evaluationon PoseTrack dataset (see requirements/optional.txt)"
            )
