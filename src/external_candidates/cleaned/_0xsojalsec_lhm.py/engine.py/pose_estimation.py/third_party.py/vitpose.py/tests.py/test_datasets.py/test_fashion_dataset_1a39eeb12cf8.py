# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_datasets\test_fashion_dataset.py
...
def test_deepfashion_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/deepfashion_full.py").dataset_info
    # test JHMDB datasets
