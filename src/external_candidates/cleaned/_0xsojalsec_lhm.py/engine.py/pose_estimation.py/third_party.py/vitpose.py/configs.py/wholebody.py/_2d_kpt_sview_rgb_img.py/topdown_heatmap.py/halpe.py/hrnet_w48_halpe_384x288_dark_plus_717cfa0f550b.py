# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\wholebody\2d_kpt_sview_rgb_img\topdown_heatmap\halpe\hrnet_w48_halpe_384x288_dark_plus.py
_base_ = [
