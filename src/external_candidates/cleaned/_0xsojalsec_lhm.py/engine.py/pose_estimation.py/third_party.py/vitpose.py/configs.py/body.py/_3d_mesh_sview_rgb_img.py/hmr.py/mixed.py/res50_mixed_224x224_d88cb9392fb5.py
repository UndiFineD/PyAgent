# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\3d_mesh_sview_rgb_img\hmr\mixed\res50_mixed_224x224.py
_base_ = ["../../../../_base_/default_runtime.py"]
use_adversarial_train = True

optimizer = dict(generator=dict(type="Adam", lr=2.5e-4), discriminator=dict(type="Adam", lr=1e-4))
    ...
    train=dict(
        ...
        train_dataset=dict(
            ...
            configs=[
                ...
                dict(
                    ann_file="data/mesh_annotation_files/lsp_dataset_original_train.npz",
