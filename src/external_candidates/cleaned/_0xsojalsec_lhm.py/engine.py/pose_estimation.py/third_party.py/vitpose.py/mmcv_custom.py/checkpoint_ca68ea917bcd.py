# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmcv_custom\checkpoint.py
...
def load_checkpoint(
    ...
    if "pos_embed" in state_dict:
        ...
        pos_tokens = torch.nn.functional.interpolate(pos_tokens, size=(H, W), mode="bicubic", align_corners=False)
