# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\webcam\configs\meow_dwen_dwen\meow_dwen_dwen.py
# Copyright (c) OpenMMLab. All rights reserved.
runner = dict(
    # Basic configurations of the runner
    name="Little fans of 2022 Beijing Winter Olympics",
    # Cat image
    camera_id="https://user-images.githubusercontent.com/15977946/152932036-b5554cf8-24cf-40d6-a358-35a106013f11.jpeg",
    # Dog image
    ...
    nodes=[
        dict(
            type="DetectorNode",
            name="Detector",
            model_config="demo/mmdetection_cfg/ssdlite_mobilenetv2_scratch_600e_coco.py",
        ...
        dict(
            ...
            model_config="configs/animal/2d_kpt_sview_rgb_img/topdown_heatmap/ap10k/hrnet_w32_ap10k_256x256.py",
