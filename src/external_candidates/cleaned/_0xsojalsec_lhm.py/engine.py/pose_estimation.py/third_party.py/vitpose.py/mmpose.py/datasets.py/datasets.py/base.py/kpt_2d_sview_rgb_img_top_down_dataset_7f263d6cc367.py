...
class Kpt2dSviewRgbImgTopDownDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(
        ...
        self.ann_info["use_different_joint_weights"] = data_cfg.get("use_different_joint_weights", False)
    ...
    def _report_metric(self, res_file, metrics, pck_thr=0.2, pckh_thr=0.7, auc_nor=30):
        ...
        if "PCKh" in metrics:
            _, pckh, _ = keypoint_pck_accuracy(outputs, gts, masks, pckh_thr, threshold_head_box)
