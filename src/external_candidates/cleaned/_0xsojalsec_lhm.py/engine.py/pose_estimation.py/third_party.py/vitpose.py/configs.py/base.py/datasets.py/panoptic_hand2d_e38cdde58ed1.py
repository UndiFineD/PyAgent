# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\_base_\datasets\panoptic_hand2d.py
dataset_info = dict(
    dataset_name="panoptic_hand2d",
    paper_info=dict(
        author="Simon, Tomas and Joo, Hanbyul and Matthews, Iain and Sheikh, Yaser",
        title="Hand keypoint detection in single images using multiview bootstrapping",
        container="Proceedings of the IEEE conference on Computer Vision and Pattern Recognition",
        year="2017",
