    ...
    def process(self, input_msgs):
        ...
        if result_msg is not None:
            ...
            if self.last_result_msg is not None:
                self.result_fps.update(1.0 / (result_msg.timestamp - self.last_result_msg.timestamp))
        ...
        if self.last_output_msg is not None:
            ...
            self.frame_fps.update(1.0 / (output_msg.timestamp - self.last_output_msg.timestamp))
...
class MonitorNode(Node):
    ...
    def process(self, input_msgs):
        ...
        frame_msg.update_route_info(node_name="System Info", node_type="dummy", info=self._get_system_info())
    ...
    def _record(self):
        while True:
            ...
            if self.vwriter is None:
                ...
                self.vwriter = cv2.VideoWriter(self.out_video_file, fourcc, fps, frame_size)
