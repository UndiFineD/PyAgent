# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\webcam\webcam_apis\utils\event.py
...
class EventManager:
    ...
    @contextmanager
    def wait_and_handle(self, event_name: str = None, is_keyboard: Optional[bool] = False):
