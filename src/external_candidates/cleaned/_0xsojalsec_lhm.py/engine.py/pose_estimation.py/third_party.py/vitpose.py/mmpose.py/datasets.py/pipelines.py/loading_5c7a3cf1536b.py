# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\pipelines\loading.py
        ...
        if isinstance(image_file, (list, tuple)):
            ...
            if self.color_type == "color" and self.channel_order == "rgb":
                ...
                if results["img"].ndim == 3:
                    ...
                    raise ValueError(f'results["img"] has invalid shape {results["img"].shape}')
