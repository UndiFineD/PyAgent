# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_datasets\test_body3d_dataset.py
...
def test_body3d_mpi_inf_3dhp_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/mpi_inf_3dhp.py").dataset_info
...
def test_body3dmview_direct_panoptic_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/panoptic_body3d.py").dataset_info
