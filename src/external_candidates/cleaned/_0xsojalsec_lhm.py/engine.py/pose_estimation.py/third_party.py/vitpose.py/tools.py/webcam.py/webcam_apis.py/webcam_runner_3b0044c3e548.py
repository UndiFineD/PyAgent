# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\webcam\webcam_apis\webcam_runner.py
    ...
    def __init__(
        ...
        for node_cfg in nodes:
            ...
            for event_info in node.registered_events:
                self.event_manager.register_event(event_name=event_info.event_name, is_keyboard=event_info.is_keyboard)
