# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\models\backbones\mspn.py
...
class DownsampleModule(nn.Module):
    ...
    def __init__(
        ...
        for i in range(1, num_units):
            ...
            self.add_module(
                module_name,
                self._make_layer(block, in_channels * pow(2, i), num_blocks[i], stride=2),
            )
