# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\ochuman\ViTPose_large_ochuman_256x192.py
_base_ = [
...
data = dict(
    ...
    val=dict(
        ...
        ann_file=f"{data_root}/annotations/ochuman_coco_format_val_range_0.00_1.00.json",
    ...
    test=dict(
        type="TopDownOCHumanDataset",
        ann_file=f"{data_root}/annotations/ochuman_coco_format_test_range_0.00_1.00.json",
        img_prefix=f"{data_root}/images/",
        data_cfg=data_cfg,
        pipeline=val_pipeline,
        dataset_info={{_base_.dataset_info}},
