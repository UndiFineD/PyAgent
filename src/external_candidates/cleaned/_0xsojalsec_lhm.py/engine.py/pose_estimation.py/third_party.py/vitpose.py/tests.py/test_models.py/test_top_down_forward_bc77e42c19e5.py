# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_models\test_top_down_forward.py
...
def _demo_mm_inputs(input_shape=(1, 3, 256, 256), num_outputs=None, num_frames=1):
    ...
    if num_frames == 1:
        ...
        imgs = [torch.FloatTensor(rng.rand(*input_shape)).requires_grad_(True) for _ in range(num_frames)]
