# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\wholebody\2d_kpt_sview_rgb_img\associative_embedding\coco-wholebody\higherhrnet_w48_coco_wholebody_640x640.py
_base_ = [
...
model = dict(
    ...
    train_cfg=dict(num_joints=channel_cfg["dataset_joints"], img_size=data_cfg["image_size"]),
    test_cfg=dict(
        num_joints=channel_cfg["dataset_joints"],
        max_num_people=30,
        scale_factor=[1],
