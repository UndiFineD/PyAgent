# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\wholebody\2d_kpt_sview_rgb_img\deeppose\coco-wholebody\res50_coco_wholebody_256x192.py
_base_ = [
