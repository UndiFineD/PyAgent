# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\datasets\datasets\face\face_coco_wholebody_dataset.py
...
class FaceCocoWholeBodyDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def _get_normalize_factor(self, gts, *args, **kwargs):
        ...
        interocular = np.linalg.norm(gts[:, 36, :] - gts[:, 45, :], axis=1, keepdims=True)
