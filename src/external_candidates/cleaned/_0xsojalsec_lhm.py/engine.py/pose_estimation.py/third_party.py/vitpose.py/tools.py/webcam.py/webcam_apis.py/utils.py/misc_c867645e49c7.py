# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tools\webcam\webcam_apis\utils\misc.py
...
def get_cached_file_path(url, save_dir=None, progress=True, check_hash=False, file_name=None):
...
def copy_and_paste(
    ...
    if instance_w > min_size[0] and instance_h > min_size[1]:
        ...
        img_inst = cv2.resize(img_inst, (int(resize_rate * instance_w), int(resize_rate * instance_h)))
