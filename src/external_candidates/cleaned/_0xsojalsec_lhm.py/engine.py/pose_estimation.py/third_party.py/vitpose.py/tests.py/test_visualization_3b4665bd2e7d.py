# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\tests\test_visualization.py
...
def test_effects():
    ...
    # bug-eye
    _ = apply_bugeye_effect(img, pose_results, left_eye_index=1, right_eye_index=0, kpt_thr=0.5)
    _ = apply_bugeye_effect(img, pose_results, left_eye_index=1, right_eye_index=0, kpt_thr=0.9)
