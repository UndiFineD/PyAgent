...
class TopDownMoE(BasePose):
    ...
    def forward_train(self, img, target, target_weight, img_metas, **kwargs):
        ...
        keypoint_losses = self.keypoint_head.get_loss(output_select, target_select, target_weight_select)
        losses["main_stream_loss"] = keypoint_losses["heatmap_loss"]
        keypoint_accuracy = self.keypoint_head.get_accuracy(output_select, target_select, target_weight_select)
