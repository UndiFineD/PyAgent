# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\_base_\datasets\rhd2d.py
dataset_info = dict(
    dataset_name="rhd2d",
    paper_info=dict(
        ...
        container="arXiv",
        year="2017",
        homepage="https://lmb.informatik.uni-freiburg.de/resources/datasets/RenderedHandposeDataset.en.html",
    ),
    keypoint_info={
