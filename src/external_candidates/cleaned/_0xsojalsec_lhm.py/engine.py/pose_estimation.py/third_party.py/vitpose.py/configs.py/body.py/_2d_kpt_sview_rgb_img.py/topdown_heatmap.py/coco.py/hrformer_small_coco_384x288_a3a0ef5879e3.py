# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\coco\hrformer_small_coco_384x288.py
log_level = "INFO"
load_from = None
resume_from = None
...
optimizer = dict(
    ...
    betas=(0.9, 0.999),
    weight_decay=0.01,
    paramwise_cfg=dict(custom_keys={"relative_position_bias_table": dict(decay_mult=0.0)}),
)
...
model = dict(
    type="TopDown",
    pretrained="https://download.openmmlab.com/mmpose/pretrain_models/hrformer_small-09516375_20220226.pth",
    backbone=dict(
        type="HRFormer",
        in_channels=3,
        norm_cfg=norm_cfg,
