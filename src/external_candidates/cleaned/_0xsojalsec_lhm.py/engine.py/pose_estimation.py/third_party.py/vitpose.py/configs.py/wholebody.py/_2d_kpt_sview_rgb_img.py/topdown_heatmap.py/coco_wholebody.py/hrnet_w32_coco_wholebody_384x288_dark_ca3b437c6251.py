# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\wholebody\2d_kpt_sview_rgb_img\topdown_heatmap\coco-wholebody\hrnet_w32_coco_wholebody_384x288_dark.py
_base_ = [
...
model = dict(
    ...
    train_cfg=dict(),
    test_cfg=dict(flip_test=True, post_process="unbiased", shift_heatmap=True, modulate_kernel=17),
)
