# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\associative_embedding\coco\higherhrnet_w48_coco_512x512_udp.py
_base_ = [
