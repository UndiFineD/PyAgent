# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\fashion\2d_kpt_sview_rgb_img\deeppose\deepfashion\res101_deepfashion_lower_256x192.py
_base_ = [
