...
aic_info = dict(
    ...
    keypoint_info={
        ...
        6: dict(name="right_hip", id=6, color=[255, 128, 0], type="lower", swap="left_hip"),
        7: dict(name="right_knee", id=7, color=[255, 128, 0], type="lower", swap="left_knee"),
        8: dict(
            name="right_ankle",
            id=8,
            color=[255, 128, 0],
        ...
        9: dict(name="left_hip", id=9, color=[0, 255, 0], type="lower", swap="right_hip"),
        10: dict(name="left_knee", id=10, color=[0, 255, 0], type="lower", swap="right_knee"),
        11: dict(
            name="left_ankle",
            id=11,
            color=[0, 255, 0],
