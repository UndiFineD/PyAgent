# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\face\2d_kpt_sview_rgb_img\topdown_heatmap\coco_wholebody_face\hrnetv2_w18_coco_wholebody_face_256x256.py
_base_ = [
