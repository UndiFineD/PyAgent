# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\configs\body\2d_kpt_sview_rgb_img\topdown_heatmap\posetrack18\hrnet_w32_posetrack18_384x288.py
_base_ = [
...
# learning policy
lr_config = dict(policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[10, 15])
total_epochs = 20
channel_cfg = dict(
