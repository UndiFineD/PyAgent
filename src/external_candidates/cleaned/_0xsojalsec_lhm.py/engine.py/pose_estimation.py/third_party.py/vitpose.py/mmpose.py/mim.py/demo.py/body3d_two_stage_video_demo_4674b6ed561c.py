# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\engine\pose_estimation\third-party\ViTPose\mmpose\.mim\demo\body3d_two_stage_video_demo.py
...
def covert_keypoint_definition(keypoints, pose_det_dataset, pose_lift_dataset):
    ...
    """
    if pose_det_dataset == "TopDownH36MDataset" and pose_lift_dataset == "Body3DH36MDataset":
        return keypoints
    elif pose_det_dataset == "TopDownCocoDataset" and pose_lift_dataset == "Body3DH36MDataset":
...
def main():
    ...
    parser.add_argument("pose_lifter_config", help="Config file for the 2nd stage pose lifter model")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Root of the output video file. Default not saving the visualization video.",
    )
    ...
    parser.add_argument("--use-oks-tracking", action="store_true", help="Using OKS tracking")
    parser.add_argument("--tracking-thr", type=float, default=0.3, help="Tracking threshold")
    parser.add_argument("--euro", action="store_true", help="Using One_Euro_Filter for smoothing")
    parser.add_argument("--radius", type=int, default=8, help="Keypoint radius for visualization")
    ...
    pose_lift_model = init_pose_model(args.pose_lifter_config, args.pose_lifter_checkpoint, device=args.device.lower())
    ...
    for pose_det_results in pose_det_results_list:
        for res in pose_det_results:
            ...
            res["keypoints"] = covert_keypoint_definition(keypoints, pose_det_dataset, pose_lift_dataset)
