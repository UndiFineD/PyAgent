# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\losses\ball_loss.py
# -*- coding: utf-8 -*-
...
class ASAP_Loss(nn.Module):
    def forward(self, scaling, r=1, **params):
        ...
        raise NotImplementedError("ASAP_Loss is not implemented yet in Inference version")
