# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\rendering\mesh_utils.py
"""Mesh Define"""
    ...
    def write_glb(self, path):
        ...
        if self.vt is not None:
            ...
            if self.metallicRoughness is not None:
                ...
                gltf.materials[0].pbrMetallicRoughness.metallicRoughnessTexture = pygltflib.TextureInfo(
                    index=1, texCoord=0
                )
