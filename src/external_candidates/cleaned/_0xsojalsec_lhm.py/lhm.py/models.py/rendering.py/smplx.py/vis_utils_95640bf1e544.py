# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\rendering\smplx\vis_utils.py
import os
import sys
...
def render_mesh(mesh, face, cam_param, bkg, blend_ratio=1.0, return_bg_mask=False):
    ...
    materials = Materials(device="cuda", specular_color=[[0.0, 0.0, 0.0]], shininess=0.0)
