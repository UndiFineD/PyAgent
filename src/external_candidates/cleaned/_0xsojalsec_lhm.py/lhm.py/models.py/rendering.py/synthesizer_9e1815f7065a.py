# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LHM\LHM\models\rendering\synthesizer.py
# ORIGINAL LICENSE
...
class TriplaneSynthesizer(nn.Module):
    ...
    def forward_points(self, planes, points: torch.Tensor, chunk_size: int = 2**20):
        ...
        point_features = {k: torch.cat([out[k] for out in outs], dim=1) for k in outs[0].keys()}
