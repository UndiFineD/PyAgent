...
class DINODPT(nn.Module):
    def __init__(self, model_name="vitb", out_dim=384, use_bn=False, use_clstoken=False):
        ...
        self.dino_normlize = torchvision.transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
