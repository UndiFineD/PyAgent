# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\billyutw.py\web_search.py\scripts.py\search_8f5b3c99d4a9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\billyutw\web-search\scripts\search.py
...
Time range filters (--time-range):
  ...
  y = past year
    ...
    image_group.add_argument("--image-layout", choices=["Square", "Tall", "Wide"], help="Image layout filter")
    ...
    output_group.add_argument("-o", "--output", help="Output file path (prints to stdout if not specified)")
