# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\chrisvoncsefalvay.py\wandb_monitor.py\scripts.py\check_runs_c5cbf652b384.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\chrisvoncsefalvay\wandb-monitor\scripts\check_runs.py
...
def main():
    ...
    parser.add_argument(
        "--status",
        choices=["running", "finished", "failed", "crashed", "canceled"],
