# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\lifespan.py\lifespan_factory_30b65013004a.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\core\lifespan\lifespan_factory.py
        ...
        try:
            ...
            for provider in reversed(sorted_providers):
                try:
                    ...
                    logger.info("Lifecycle provider shutdown completed: %s", provider.name)
