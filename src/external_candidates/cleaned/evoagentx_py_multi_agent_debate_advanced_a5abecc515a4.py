# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\examples.py\multi_agent_debate.py\multi_agent_debate_advanced_a5abecc515a4.py
