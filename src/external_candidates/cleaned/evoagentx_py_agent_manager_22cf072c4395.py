# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\agents.py\agent_manager_22cf072c4395.py
    ...
    def update_tools(self, agent_data: dict) -> None:
        ...
        if tool_names:
            ...
            if missing_tools:
                ...
                raise ValueError(
                    f"The following tools are not available: {missing_tools}. Available tools: {available_tools}"
                )
