# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\loaders.py\base_io_8da6a55254c4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\loaders\base_io.py
...
class PdfFile(File):
    ...
    def from_bytes(cls, file: BytesIO, filename: str) -> "PdfFile":
        ...
        try:
            ...
            raise ImportError("Please install `PyMuPDF` first. You can install it by running `pip install PyMuPDF`.")
...
class HtmlFile(File):
    ...
    def from_bytes(cls, file: BytesIO, filename: str) -> "HtmlFile":
        ...
        try:
            ...
            raise ImportError(
                "Please install `beautifulsoup4` first. You can install it by running `pip install beautifulsoup4`."
            )
