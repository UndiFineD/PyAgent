# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\commands.py\windows.py\activedirectory.py\getdomaincontrollers_0462b94f7e27.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\commands\windows\activedirectory\getdomaincontrollers.py
...
class GetDomainControllersCommand(Command):
    ...
    def execute(self, args):
        ...
        parser.add_argument(
            ...
            action="store_true",
            dest="enterprise",
            help="Enumerate DCs across the entire forest",
        )
