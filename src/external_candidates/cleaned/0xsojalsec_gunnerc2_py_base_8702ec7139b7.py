# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_gunnerc2.py\core.py\gunnershell.py\bofs.py\base_8702ec7139b7.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-GunnerC2\core\gunnershell\bofs\base.py
...
def _resolve_bof_bytes(
    name_or_path: str,
    bofarch: str,
    zargs: List[str] | None = None,
    Zargs: List[str] | None = None,
    int16: List[int] | None = None,
