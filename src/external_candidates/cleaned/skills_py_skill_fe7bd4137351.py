...
def scan_market(balance: float, top_n: int = 5, categories: Optional[list] = None) -> list:
    ...
    try:
        ...
        opportunities = agent.market_scanner.scan_market(categories=categories, top_n=top_n)
...
Examples:
  ...
  python skill.py analyze ETH/USDT
    ...
    scan_parser.add_argument("--top", type=int, default=5, help="Number of top opportunities (default: 5)")

    scan_parser.add_argument("--categories", nargs="+", help="Market categories to scan")
