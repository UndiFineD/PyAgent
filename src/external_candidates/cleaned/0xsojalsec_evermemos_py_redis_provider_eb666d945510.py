# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\redis_provider_eb666d945510.py
...
class RedisProvider:
    ...
    def __init__(self):
        ...
        if self.redis_password:
            ...
            self.redis_url = f"{protocol}://{self.redis_host}:{self.redis_port}/{self.redis_db}"
    ...
    async def get_named_client(self, name: str, **overrides) -> redis.Redis:
        ...
        async with self._lock:
            ...
            try:
                ...
                logger.info("Building Redis client connection params: %s, %s", name, conn_params)
    ...
    async def delete(self, *keys: str) -> int:
        ...
        try:
            ...
            logger.error("Redis DELETE operation failed: keys=%s, error=%s", keys, str(e))
    ...
    async def keys(self, pattern: str) -> list:
        ...
        try:
            ...
            logger.error("Redis KEYS operation failed: pattern=%s, error=%s", pattern, str(e))
    ...
    async def close(self):
        ...
        for name, client in self._named_clients.items():
            try:
                ...
                logger.error("Failed to close named Redis client: %s, error=%s", name, str(e))
