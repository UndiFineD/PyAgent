# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Kimi-Audio\kimia_infer\models\tokenizer\glm4_tokenizer.py
import os
...
class Glm4Tokenizer(nn.Module):
    ...
    def tokenize(self, speech=None, audio_path=None, sr=16000):
        ...
        audio_tokens = extract_speech_token(self.whisper_model, self.feature_extractor, [audio_info])[0]
