# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-Kimi-Audio\kimia_infer\models\tokenizer\glm4_utils.py
import glob
import io
import math
import os
...
from .glm4.speech_tokenizer.modeling_whisper import (
    WhisperVQEncoder,
