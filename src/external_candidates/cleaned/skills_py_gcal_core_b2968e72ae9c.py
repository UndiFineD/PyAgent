# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\bilalmohamed187_cpu.py\gcal_pro_calendar.py\scripts.py\gcal_core_b2968e72ae9c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\bilalmohamed187-cpu\gcal-pro-calendar\scripts\gcal_core.py
...
def create_event(
    ...
    event_body = {
        ...
        "end": {"dateTime": format_datetime_iso(end), "timeZone": str(get_timezone())},
    }
...
def delete_event(event_id: str, calendar_id: str = "primary", confirmed: bool = False) -> bool:
    """
