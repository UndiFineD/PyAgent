# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2022.py\some2.py\announcement_75ce30170135.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2022\some2\announcement.py
...
class IntersectionAndUnion(InteractiveScene):
    def construct(self):
        ...
        self.play(Write(by_ind), FlashUnder(by_ind, run_time=3, color=TEAL, buff=0.1))
        ...
        self.play(DrawBorderThenFill(inter), circles.animate.set_fill(opacity=0.25))
...
class Winners(InteractiveScene):
    def construct(self):
        ...
        self.play(
            LaggedStart(*(pi.change("hooray").set_opacity(1) for pi in winners)),
            lag_ratio=0.2,
        )
