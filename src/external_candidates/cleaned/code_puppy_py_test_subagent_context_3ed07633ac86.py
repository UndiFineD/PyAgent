# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\tools.py\test_subagent_context_3ed07633ac86.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_subagent_context.py
...
spec = importlib.util.spec_from_file_location(
    ...
    Path(__file__).parent.parent.parent / "code_puppy" / "tools" / "subagent_context.py",
)
