# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\command_line.py\test_add_model_menu_0213ed9e6262.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\command_line\test_add_model_menu.py
...
class TestAddModelMenuInitialization:
    ...
    def test_menu_initialization_registry_not_found(self, mock_emit_error, mock_registry_class):
        """Test initialization when models registry is not found."""

        mock_registry_class.side_effect = FileNotFoundError("models_dev_api.json not found")
    ...
    @patch("code_puppy.command_line.add_model_menu.ModelsDevRegistry")
    @patch("code_puppy.command_line.add_model_menu.emit_error")
    def test_menu_initialization_registry_error(self, mock_emit_error, mock_registry_class):
    ...
    @patch("code_puppy.command_line.add_model_menu.ModelsDevRegistry")
    @patch("code_puppy.command_line.add_model_menu.emit_error")
    def test_menu_initialization_empty_providers(self, mock_emit_error, mock_registry_class):
...
class TestProviderNavigation:
    ...
    def test_provider_navigation_down(self, mock_registry_class):
        ...
        menu.selected_provider_idx = min(len(providers) - 1, menu.selected_provider_idx + 1)
...
class TestModelAddition:
    ...
    @patch("code_puppy.command_line.add_model_menu.set_config_value")
    @patch("code_puppy.command_line.add_model_menu.ModelsDevRegistry")
    def test_add_model_shows_success_message(self, mock_registry_class, mock_set_config, mock_emit_info):
