# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\coqui_ai_tts.py\recipes.py\thorsten_de.py\align_tts.py\train_aligntts_ca4639d18fb3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\coqui-ai-TTS\recipes\thorsten_DE\align_tts\train_aligntts.py
