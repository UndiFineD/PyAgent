# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\tools.py\browser.py\browser_navigation_109e1fc3dabe.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\browser\browser_navigation.py
...
async def wait_for_load_state(state: str = "domcontentloaded", timeout: int = 30000) -> Dict[str, Any]:
...
def register_reload_page(agent):
    ...
    @agent.tool
    async def browser_reload(context: RunContext, wait_until: str = "domcontentloaded") -> Dict[str, Any]:
        """
