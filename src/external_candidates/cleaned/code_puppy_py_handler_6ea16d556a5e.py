# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\command_line.py\mcp.py\handler_6ea16d556a5e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp\handler.py
    ...
    def handle_mcp_command(self, command: str) -> bool:
        ...
        try:
            ...
            if command_handler:
                ...
                emit_info(
                    Text.from_markup(f"[yellow]Unknown MCP subcommand: {subcommand}[/yellow]"),
                    message_group=group_id,
                )
