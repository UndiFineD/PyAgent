# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\events.py\base_event_92bf5e9a4258.py
...
class BaseEvent(ABC):
    ...
    created_at: str = field(default_factory=lambda: to_iso_format(get_now_with_timezone()))
