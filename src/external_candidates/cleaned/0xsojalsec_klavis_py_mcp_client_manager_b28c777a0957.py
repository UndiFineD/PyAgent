# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_klavis.py\open_strata.py\src.py\strata.py\mcp_client_manager_b28c777a0957.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-klavis\open-strata\src\strata\mcp_client_manager.py
...
class MCPClientManager:
    ...
    async def sync_with_config(self, new_servers: Dict[str, MCPServerConfig]) -> None:
        ...
        async with self._sync_lock:
            ...
            servers_to_remove = set(self.active_clients.keys()) - set(new_servers.keys())
                ...
                try:
                    ...
                    if new_config.enabled:
                        if not is_active:
                            ...
                            logger.info(f"Reconnected MCP server with new config: {server_name}")
