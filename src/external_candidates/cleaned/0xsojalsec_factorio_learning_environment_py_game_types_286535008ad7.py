# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\game_types_286535008ad7.py
...
class RecipeName(enum.Enum):
    ...
    AdvancedOilProcessing = (
        "advanced-oil-processing"  # Recipe for producing petroleum gas, heavy oil and light oil with a oil refinery
    )
