# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pi0_lerobot.py\src.py\pi0_lerobot.py\apis.py\visualize_dataset_rerun_7186167b6b45.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pi0-lerobot\src\pi0_lerobot\apis\visualize_dataset_rerun.py
    ...
    for batch in tqdm.tqdm(dataloader, total=len(dataloader)):
        ...
        for i in range(len(batch["index"])):
            ...
            for key in dataset.meta.camera_keys:
                rr.log(
                    key,
                    rr.Image(to_hwc_uint8_numpy(batch[key][i])).compress(jpeg_quality=95),
                )
