...
class BookingManager(RoutedAgent):
    ...
    async def handle_user_message(self, message: Message, ctx: MessageContext) -> Message:
        ...
        create_result = await self._model_client.create(messages=session, cancellation_token=ctx.cancellation_token)
...
class FlightAgent(RoutedAgent):
    ...
    async def handle_user_message(self, message: Message, ctx: MessageContext) -> Message:
        ...
        final_result = await self._model_client.create(messages=session, cancellation_token=ctx.cancellation_token)
