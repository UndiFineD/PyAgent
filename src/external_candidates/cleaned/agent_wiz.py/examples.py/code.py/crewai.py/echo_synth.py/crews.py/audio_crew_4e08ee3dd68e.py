# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\crewai\echo_synth\crews\audio_crew.py
...
class AudioProcessingCrew:
    ...
    def image_summary_writer(self) -> Agent:
        return Agent(config=self.agents_config["image_summary_writer"], verbose=True)
