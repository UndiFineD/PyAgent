# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\google_adk\agents\customer-service\customer_service\entities\customer.py
...
class Customer(BaseModel):
    ...
    def get_customer(current_customer_id: str) -> Optional["Customer"]:
        ...
        return Customer(
            ...
            years_as_customer=2,
            billing_address=Address(street="123 Main St", city="Anytown", state="CA", zip="12345"),
            ...
            communication_preferences=CommunicationPreferences(email=True, sms=False, push_notifications=True),
            garden_profile=GardenProfile(
                type="backyard",
                size="medium",
