# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\google_adk\agents\personalized-shopping\personalized_shopping\shared_libraries\web_agent_site\envs\web_agent_text_env.py
...
register(
    ...
    entry_point=("personalized_shopping.shared_libraries.web_agent_site.envs.web_agent_text_env:WebAgentTextEnv"),
)
