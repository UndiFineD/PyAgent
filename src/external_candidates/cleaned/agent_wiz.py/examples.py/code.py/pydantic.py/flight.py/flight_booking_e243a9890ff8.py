# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\examples\code\pydantic\flight\flight_booking.py
import datetime
    ...
    while True:
        ...
        if isinstance(result.data, NoFlightFound):
            ...
            if answer == "buy":
                ...
                message_history = result.all_messages(result_tool_return_content="Please suggest another flight")
