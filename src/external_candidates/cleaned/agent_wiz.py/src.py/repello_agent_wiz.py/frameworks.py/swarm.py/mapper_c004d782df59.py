# Extracted from: C:\DEV\PyAgent\.external\agent_wiz\src\repello_agent_wiz\frameworks\swarm\mapper.py
import ast
import json
import os
import sys
...
def extract_swarm_graph(directory, output_file):
    ...
    for visitor in visitors:
        for func, returned_var in visitor.function_returns.items():
            ...
            if source_agent_name and target_agent_name:
                visitor.agent_routing_edges.append((source_agent_name, target_agent_name, func))
    ...
    graph_data = {
        "metadata": {"framework": "OpenAI Swarm"},
        "nodes": all_nodes,
        "edges": all_edges,
    }
