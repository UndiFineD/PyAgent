...
class MemCell:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "foresights": ([item.to_dict() for item in self.foresights] if self.foresights else None),
            "event_log": (
                (self.event_log.to_dict() if hasattr(self.event_log, "to_dict") else self.event_log)
                if self.event_log
                else None
            ),
            "extend": self.extend,
