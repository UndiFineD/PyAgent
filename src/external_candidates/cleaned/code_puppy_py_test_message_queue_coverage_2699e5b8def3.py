# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\messaging.py\test_message_queue_coverage_2699e5b8def3.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\messaging\test_message_queue_coverage.py
...
class TestMessageQueueAsyncOperations:
    ...
    async def test_async_queue_receives_messages(self):
        ...
        async def init_and_wait():
            ...
            asyncio.get_event_loop().call_soon(lambda: None)  # Ensure event loop is running
...
class TestEmitPrompt:
    ...
    def test_emit_prompt(self):
        ...
        with patch("code_puppy.command_line.utils.safe_input", return_value="user input") as mock_input:
