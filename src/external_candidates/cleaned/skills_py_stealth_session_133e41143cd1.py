# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\mayuqi_crypto.py\stealth_browser.py\scripts.py\stealth_session_133e41143cd1.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\mayuqi-crypto\stealth-browser\scripts\stealth_session.py
...
def main():
    ...
    parser.add_argument("--rotate-proxy", action="store_true", help="Use rotating proxy from config")

    parser.add_argument("--save", action="store_true", help="Save session after operation")

    parser.add_argument("--load", action="store_true", help="Load existing session")

    parser.add_argument("--screenshot", help="Take screenshot to path")

    parser.add_argument("--wait", type=int, default=5, help="Wait seconds after page load")
