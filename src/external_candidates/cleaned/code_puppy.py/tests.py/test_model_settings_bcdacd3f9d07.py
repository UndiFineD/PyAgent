# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_model_settings.py
...
class TestPerModelSettings:
    ...
    def test_set_model_setting_stores_value(self, mock_set_config_value):
        ...
        mock_set_config_value.assert_called_once_with("model_settings_gpt_5_temperature", "0.8")
    ...
    def test_set_model_setting_clears_value_when_none(self, mock_set_config_value):
        ...
        mock_set_config_value.assert_called_once_with("model_settings_gpt_5_temperature", "")
