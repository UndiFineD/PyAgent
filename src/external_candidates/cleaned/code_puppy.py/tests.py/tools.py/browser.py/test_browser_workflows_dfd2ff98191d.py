# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_workflows.py
...
class TestSaveWorkflow(BrowserWorkflowsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_save_workflow_success(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_workflow_with_special_chars(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_workflow_already_exists(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_directory_creation_error(self, mock_get_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_workflow_file_write_error(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_workflow_empty_name(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_save_workflow_with_md_extension(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
...
class TestListWorkflows(BrowserWorkflowsBaseTest):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_list_workflows_empty_directory(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_list_workflows_multiple_files(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_list_workflows_ignores_non_md_files(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_list_workflows_file_read_error(self, mock_get_dir, temp_workflows_dir):
...
class TestReadWorkflow(BrowserWorkflowsBaseTest):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_read_workflow_success(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_read_workflow_with_extension(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_read_workflow_file_read_error(self, mock_get_dir, temp_workflows_dir):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_read_workflow_unicode_content(self, mock_get_dir, temp_workflows_dir):
...
class TestIntegrationScenarios(BrowserWorkflowsBaseTest):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_complete_workflow_lifecycle(self, mock_get_dir, temp_workflows_dir, sample_workflow_content):
    ...
    @patch("tools.browser.browser_workflows.get_workflows_directory")
    @pytest.mark.asyncio
    async def test_workflow_name_sanitization_cycle(self, mock_get_dir, temp_workflows_dir):
