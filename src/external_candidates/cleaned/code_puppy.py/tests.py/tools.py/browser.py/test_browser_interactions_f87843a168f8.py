# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_interactions.py
...
class TestClickElement(BrowserInteractionsBaseTest):
    ...
    async def test_click_element_basic(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            locator.click.assert_called_once_with(force=False, button="left", timeout=10000)
...
class TestDoubleClickElement(BrowserInteractionsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_double_click_element_success(self, mock_browser_manager, mock_locator):
    ...
    @pytest.mark.asyncio
    async def test_double_click_element_with_force(self, mock_browser_manager, mock_locator):
...
class TestSetElementText(BrowserInteractionsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_set_element_text_clear_and_fill(self, mock_browser_manager, mock_locator):
...
class TestGetElementValue(BrowserInteractionsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_get_element_value_exception(self, mock_browser_manager, mock_locator):
...
class TestSelectOption(BrowserInteractionsBaseTest):
    ...
    async def test_select_option_by_value(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            locator.select_option.assert_called_once_with(value="option1", timeout=10000)
    ...
    async def test_select_option_by_label(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            locator.select_option.assert_called_once_with(label="Option Label", timeout=10000)
    ...
    @pytest.mark.asyncio
    async def test_select_option_no_selection_params(self, mock_browser_manager, mock_locator):
...
class TestCheckElement(BrowserInteractionsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_check_element_custom_timeout(self, mock_browser_manager, mock_locator):
...
class TestIntegrationScenarios(BrowserInteractionsBaseTest):
    ...
    async def test_dropdown_interaction_sequence(self, mock_browser_manager):
        ...
        with patch(
            ...
            dropdown_locator1.wait_for.assert_called_once_with(state="visible", timeout=10000)
            dropdown_locator1.select_option.assert_called_once_with(value="option1", timeout=10000)

            dropdown_locator2.wait_for.assert_called_once_with(state="visible", timeout=10000)
            dropdown_locator2.select_option.assert_called_once_with(label="Another option", timeout=10000)
