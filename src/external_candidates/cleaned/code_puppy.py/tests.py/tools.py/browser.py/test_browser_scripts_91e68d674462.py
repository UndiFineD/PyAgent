...
class TestScrollPage(BrowserScriptsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_scroll_page_element_scrolling(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            result = await scroll_page(direction="down", amount=3, element_selector="#scrollable-div")
...
class TestScrollToElement(BrowserScriptsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_scroll_to_element_not_visible(self, mock_browser_manager, mock_locator):
...
class TestSetViewportSize(BrowserScriptsBaseTest):
    ...
    async def test_set_viewport_size_success(self, mock_browser_manager):
        ...
        with patch(
            ...
            page.set_viewport_size.assert_called_once_with({"width": 1200, "height": 800})
    ...
    async def test_set_viewport_size_mobile(self, mock_browser_manager):
        ...
        with patch(
            ...
            page.set_viewport_size.assert_called_once_with({"width": 375, "height": 667})
...
class TestWaitForElement(BrowserScriptsBaseTest):
    ...
    async def test_wait_for_element_visible(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            result = await wait_for_element("#dynamic-element", state="visible", timeout=5000)
...
class TestHighlightElement(BrowserScriptsBaseTest):
    ...
    @pytest.mark.asyncio
    async def test_highlight_element_blue_color(self, mock_browser_manager, mock_locator):
...
class TestIntegrationScenarios(BrowserScriptsBaseTest):
    ...
    async def test_page_manipulation_workflow(self, mock_browser_manager, mock_locator):
        ...
        with patch(
            ...
            assert all(r["success"] for r in [viewport_result, js_result, scroll_result, highlight_result])
