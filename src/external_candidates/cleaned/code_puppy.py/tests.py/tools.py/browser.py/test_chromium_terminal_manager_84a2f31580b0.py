# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_chromium_terminal_manager.py
...
class TestChromiumTerminalManagerAsyncInit(TestChromiumTerminalManagerBase):
    ...
    async def test_async_initialize_success(self, mock_playwright):
        ...
        with patch("tools.browser.chromium_terminal_manager.async_playwright") as mock_pw_func:
