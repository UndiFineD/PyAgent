# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\browser\test_browser_locators_simple.py
...
async def test_find_by_role_basic():
    ...
    with patch(
        ...
        with patch("code_puppy.tools.browser.browser_locators.emit_info"):  # Mock emit_info to avoid side effects
