...
class TestRunTerminalCommand:
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch("code_puppy.tools.browser.terminal_command_tools.emit_info"):
                        with patch("code_puppy.tools.browser.terminal_command_tools.emit_success"):
                            result = await run_terminal_command("ls -la", capture_screenshot=True)
    ...
    async def test_run_command_no_active_page(self):
        ...
        with patch(
            ...
            with patch("code_puppy.tools.browser.terminal_command_tools.emit_info"):
                with patch("code_puppy.tools.browser.terminal_command_tools.emit_error") as mock_error:
    ...
    async def test_run_command_keyboard_error(self):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch("code_puppy.tools.browser.terminal_command_tools.emit_info"):
                    with patch("code_puppy.tools.browser.terminal_command_tools.emit_error"):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch("code_puppy.tools.browser.terminal_command_tools.emit_info"):
                        with patch("code_puppy.tools.browser.terminal_command_tools.emit_success"):
                            result = await run_terminal_command("ls", capture_screenshot=True)
