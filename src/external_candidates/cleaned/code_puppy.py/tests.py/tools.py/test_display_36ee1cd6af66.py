# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_display.py
...
class TestDisplayNonStreamedResult:
    ...
    def test_basic_display_with_provided_console(
        ...
        mock_renderer_class.assert_called_once_with(output=mock_console.file, width=mock_console.width)
    ...
    def test_console_print_called_for_banner(
        ...
        # Call the function
        display_non_streamed_result(content="test", console=mock_console, banner_text="MY BANNER")
    ...
    def test_custom_banner_text_displayed(
        ...
        display_non_streamed_result(content="test", console=mock_console, banner_text=custom_text)
