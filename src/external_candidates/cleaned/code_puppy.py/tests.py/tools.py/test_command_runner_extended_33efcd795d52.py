# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\tools\test_command_runner_extended.py
...
class TestKeyboardContextManager:
    ...
    def test_keyboard_context_sets_up_listener(self, monkeypatch):
        ...
        monkeypatch.setattr(command_runner_module, "_spawn_ctrl_x_key_listener", mock_spawn)
...
class TestRunShellCommandAsync:
    ...
    def test_run_shell_command_blocked_by_callback(self):
        ...
        with patch("code_puppy.callbacks.on_run_shell_command", new_callable=AsyncMock) as mock_callback:
...
class TestReasoningOutput:
    ...
    def test_share_your_reasoning_basic(self, monkeypatch):
        ...
        with patch("code_puppy.tools.command_runner.get_message_bus", return_value=mock_bus):
