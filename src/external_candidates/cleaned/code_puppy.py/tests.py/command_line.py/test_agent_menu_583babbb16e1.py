# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\command_line\test_agent_menu.py
...
class TestRenderMenuPanel:
    ...
    def test_marks_current_agent(self):
        ...
        result = _render_menu_panel(entries, page=0, selected_idx=0, current_agent_name="agent2")
    ...
    def test_pagination_page_zero(self):
        ...
        entries = [(f"agent_{i:02d}", f"Agent {i:02d}", f"Desc {i:02d}") for i in range(25)]
    ...
    def test_pagination_page_one(self):
        ...
        result = _render_menu_panel(entries, page=1, selected_idx=10, current_agent_name="")
    ...
    def test_pagination_last_page(self):
        ...
        result = _render_menu_panel(entries, page=2, selected_idx=20, current_agent_name="")
    ...
    def test_selected_agent_on_second_page(self):
        ...
        entries = [(f"agent_{i:02d}", f"Agent {i:02d}", f"Desc {i:02d}") for i in range(15)]

        # Select agent 12 on page 1 (indices 10-14)
        result = _render_menu_panel(entries, page=1, selected_idx=12, current_agent_name="")
    ...
    def test_current_agent_indicator_with_selection(self):
        ...
        result = _render_menu_panel(entries, page=0, selected_idx=1, current_agent_name="agent2")
...
class TestRenderPanelEdgeCases:
    ...
    def test_menu_panel_with_exact_page_size_entries(self):
        ...
        entries = [(f"agent_{i:02d}", f"Agent {i:02d}", f"Desc {i:02d}") for i in range(PAGE_SIZE)]
    ...
    def test_menu_panel_with_page_size_plus_one(self):
        ...
        entries = [(f"agent_{i:02d}", f"Agent {i:02d}", f"Desc {i:02d}") for i in range(PAGE_SIZE + 1)]
    ...
    def test_menu_panel_last_item_on_page_selected(self):
        ...
        result = _render_menu_panel(entries, page=0, selected_idx=9, current_agent_name="")
...
class TestMenuPanelStyling:
    ...
    def test_styling_includes_cyan_for_current(self):
        ...
        result = _render_menu_panel(entries, page=0, selected_idx=0, current_agent_name="agent1")
...
class TestApplyPinnedModelWithJSONAgents:
    ...
    @patch("code_puppy.agents.json_agent.discover_json_agents")
    def test_pins_builtin_agent(self, mock_json_agents, mock_reload, mock_emit, mock_set_pin):
    ...
    @patch("code_puppy.command_line.agent_menu._reload_agent_if_current")
    @patch("code_puppy.agents.json_agent.discover_json_agents")
    def test_unpins_builtin_agent(self, mock_json_agents, mock_reload, mock_emit, mock_clear_pin):
    ...
    @patch("code_puppy.agents.json_agent.discover_json_agents")
    def test_handles_json_agent_write_error(self, mock_json_agents, mock_emit_warning, mock_emit_success):
