# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\command_line\test_clipboard.py
...
class TestCaptureClipboardImageToPending:
    ...
    def test_returns_none_when_no_image(self):
        ...
        with patch("code_puppy.command_line.clipboard.get_clipboard_image", return_value=None):
