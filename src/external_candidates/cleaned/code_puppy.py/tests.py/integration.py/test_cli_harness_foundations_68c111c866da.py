# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\integration\test_cli_harness_foundations.py
...
def test_selective_cleanup_only_removes_test_files(
    ...
    result = cli_harness.spawn(args=["--help"], env=integration_env, existing_home=existing_home)
