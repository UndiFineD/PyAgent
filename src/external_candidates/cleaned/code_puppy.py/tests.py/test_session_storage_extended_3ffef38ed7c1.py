# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_session_storage_extended.py
...
class TestSessionStorageExtended:
    ...
    def test_save_and_load_session(
        ...
        assert metadata.total_tokens == sum(token_estimator(msg) for msg in sample_history)
    ...
    def test_save_empty_session(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
    ...
    def test_cleanup_sessions(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
    ...
    def test_unicode_content(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
    ...
    def test_complex_data_types(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
    ...
    def test_large_session_data(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
    ...
    def test_session_name_variations(self, tmp_path: Path, token_estimator: Callable[[Any], int]):
