...
class TestProcessToolCall:
    ...
    async def test_process_tool_call_emits_info_and_calls_tool(self):
        ...
        mock_call_tool.assert_called_once_with("test_tool", {"arg1": "value1"}, {"deps": mock_ctx.deps})
...
class TestCreateServerHTTP:
    ...
    def test_http_with_timeout(self):
        ...
        with patch("code_puppy.mcp_.managed_server.MCPServerStreamableHTTP") as mock_http:
