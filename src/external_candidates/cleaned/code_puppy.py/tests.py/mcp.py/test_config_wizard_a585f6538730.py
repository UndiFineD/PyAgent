# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_config_wizard.py
"""
...
class TestPromptServerName:
    ...
    def wizard(self):
        ...
        with patch("code_puppy.mcp_.config_wizard.get_mcp_manager", return_value=mock_manager):
            return MCPConfigWizard()
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_error")
    def test_prompt_server_name_invalid_format(self, mock_emit_error, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_error")
    def test_prompt_server_name_exists(self, mock_emit_error, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_error")
    def test_prompt_server_name_retry_after_invalid(self, mock_emit_error, mock_confirm, mock_prompt, wizard):
...
class TestPromptServerType:
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_error")
    @patch("code_puppy.mcp_.config_wizard.prompt_ask")
    def test_prompt_server_type_invalid(self, mock_prompt, mock_error, mock_info, wizard):
...
class TestPromptSSEConfig:
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_sse_config_basic(self, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_sse_config_with_headers(self, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_sse_config_invalid_timeout(self, mock_info, mock_confirm, mock_prompt, wizard):
...
class TestPromptHTTPConfig:
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_http_config_basic(self, mock_info, mock_confirm, mock_prompt, wizard):
...
class TestPromptStdioConfig:
    ...
    def test_prompt_stdio_config_basic(self, mock_warn, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    @patch("code_puppy.mcp_.config_wizard.emit_warning")
    def test_prompt_stdio_config_with_args(self, mock_warn, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    @patch("code_puppy.mcp_.config_wizard.emit_warning")
    def test_prompt_stdio_config_with_cwd(self, mock_warn, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    @patch("code_puppy.mcp_.config_wizard.emit_warning")
    def test_prompt_stdio_config_invalid_cwd(self, mock_warn, mock_info, mock_confirm, mock_prompt, wizard):
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    @patch("code_puppy.mcp_.config_wizard.emit_warning")
    def test_prompt_stdio_config_with_env(self, mock_warn, mock_info, mock_confirm, mock_prompt, wizard):
...
class TestPromptURL:
    ...
    @patch("code_puppy.mcp_.config_wizard.emit_error")
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    def test_prompt_url_invalid_then_valid(self, mock_confirm, mock_error, mock_prompt, wizard):
...
class TestPromptHeaders:
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_headers_multiple(self, mock_info, mock_confirm, mock_prompt, wizard):
...
class TestPromptEnvVars:
    ...
    @patch("code_puppy.mcp_.config_wizard.confirm_ask")
    @patch("code_puppy.mcp_.config_wizard.emit_info")
    def test_prompt_env_vars_multiple(self, mock_info, mock_confirm, mock_prompt, wizard):
        ...
        with patch.object(wizard, "prompt_server_name", return_value="test"):
            with patch.object(wizard, "prompt_server_type", return_value="stdio"):
                with patch.object(
                    ...
                    with patch.object(wizard, "prompt_confirmation", return_value=False):
                        result = wizard.run_wizard()
        assert result is None
