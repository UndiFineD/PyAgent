# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_blocking_startup_coverage.py
"""
...
class TestStderrFileCaptureMonitoring:
    ...
    def test_monitor_file_emits_to_user_when_enabled(self, mock_emit_info, mock_write_log, mock_get_path, mock_rotate):
        ...
        try:
            ...
            capture = StderrFileCapture("test-server", emit_to_user=True, message_group=msg_group)
            capture.start()
            ...
            assert (
                any("New stderr line" in str(call) or "test-server" in str(call) for call in emit_calls)
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_monitor_file_handles_missing_file(self, mock_write_log, mock_get_path, mock_rotate):
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_monitor_file_skips_empty_lines(self, mock_write_log, mock_get_path, mock_rotate):
...
class TestStderrFileCaptureStopBranches:
    ...
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    @patch("code_puppy.mcp_.blocking_startup.emit_info")
    def test_stop_reads_remaining_content_with_emit(self, mock_emit_info, mock_write_log, mock_get_path, mock_rotate):
        ...
        try:
            mock_get_path.return_value = temp_path
            capture = StderrFileCapture("test-server", emit_to_user=True, message_group=uuid.uuid4())
            capture.start()
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_stop_handles_log_file_close_exception(self, mock_write_log, mock_get_path, mock_rotate):
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_stop_handles_read_remaining_exception(self, mock_write_log, mock_get_path, mock_rotate):
...
class TestSimpleCapturedMCPServerStdioClientStreams:
    ...
    async def test_client_streams_creates_stderr_capture(self):
        ...
        with (
            ...
            patch("code_puppy.mcp_.blocking_startup.rotate_log_if_needed"),
            patch("code_puppy.mcp_.blocking_startup.get_log_file_path") as mock_get_path,
            patch("code_puppy.mcp_.blocking_startup.write_log"),
        ):
...
class TestBlockingMCPServerStdioExceptionGroup:
    ...
    async def test_aenter_unwraps_exception_group(self):
        ...
        with (
            patch.object(SimpleCapturedMCPServerStdio, "__aenter__", new_callable=AsyncMock) as mock_aenter,
...
class TestStartupMonitorEdgeCases:
    ...
    async def test_wait_all_ready_reports_correct_counts(self):
        ...
        with patch("code_puppy.mcp_.blocking_startup.emit_info", side_effect=capture_emit):
...
class TestOsPathExistsEdgeCases:
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_stop_when_log_path_not_exists(self, mock_write_log, mock_get_path, mock_rotate):
    ...
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    @patch("code_puppy.mcp_.blocking_startup.emit_info")
    def test_stop_deduplicates_captured_lines(self, mock_emit_info, mock_write_log, mock_get_path, mock_rotate):
