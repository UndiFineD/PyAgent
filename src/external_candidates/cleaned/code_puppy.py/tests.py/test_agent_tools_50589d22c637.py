...
class TestSessionSaveLoad:
    ...
    def test_save_with_invalid_session_id_raises_error(self, temp_session_dir, mock_messages):
    ...
    def test_txt_file_updates_on_subsequent_saves(self, temp_session_dir, mock_messages):
...
class TestSessionIntegration:
    ...
    def test_session_metadata_tracks_message_count(self, temp_session_dir, mock_messages):
