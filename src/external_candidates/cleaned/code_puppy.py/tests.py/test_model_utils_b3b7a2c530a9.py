# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_model_utils.py
...
class TestPreparePromptForModel:
    ...
    def test_claude_code_swaps_instructions(self):
        ...
        result = prepare_prompt_for_model("claude-code-sonnet", "You are a helpful assistant.", "Hello world")
    ...
    def test_non_claude_code_keeps_original_instructions(self):
        ...
        result = prepare_prompt_for_model("gpt-4", "You are a helpful assistant.", "Hello world")
    ...
    def test_empty_user_prompt(self):
        ...
        result = prepare_prompt_for_model("claude-code-sonnet", "You are a helpful assistant.", "")
...
class TestPreparedPromptDataclass:
    ...
    def test_dataclass_equality(self):
        ...
        prompt1 = PreparedPrompt(instructions="test", user_prompt="hello", is_claude_code=False)
        prompt2 = PreparedPrompt(instructions="test", user_prompt="hello", is_claude_code=False)
