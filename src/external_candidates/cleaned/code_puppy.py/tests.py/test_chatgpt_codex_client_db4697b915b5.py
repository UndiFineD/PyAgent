# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_chatgpt_codex_client.py
...
class TestInjectCodexFields:
    ...
    def test_preserve_existing_reasoning(self):
        ...
        body = json.dumps({"model": "gpt-5", "reasoning": {"effort": "high", "summary": "detailed"}}).encode()
        result, _ = ChatGPTCodexAsyncClient._inject_codex_fields(body)
