# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_ralph_test_plugin.py
...
class TestAgentResponseCompleteCallback:
    ...
    async def test_agent_response_complete_triggers_async_callbacks(self):
        ...
        async def capture_completion(agent_name, response_text, session_id=None, metadata=None):
    ...
    async def test_agent_response_complete_triggers_sync_callbacks(self):
        ...
        def capture_completion(agent_name, response_text, session_id=None, metadata=None):
            callback_data["agent_name"] = agent_name
            callback_data["response_text"] = response_text
    ...
    async def test_agent_response_complete_detects_completion_signal(self):
        ...
        async def check_for_complete(agent_name, response_text, session_id=None, metadata=None):
...
class TestRalphTestPluginIntegration:
    ...
    def test_ralph_test_plugin_loads_successfully(self):
        ...
        assert any(cb.__module__ == "code_puppy.plugins.ralph_test.register_callbacks" for cb in tools_callbacks)
        assert any(cb.__module__ == "code_puppy.plugins.ralph_test.register_callbacks" for cb in agents_callbacks)
        assert any(cb.__module__ == "code_puppy.plugins.ralph_test.register_callbacks" for cb in complete_callbacks)
