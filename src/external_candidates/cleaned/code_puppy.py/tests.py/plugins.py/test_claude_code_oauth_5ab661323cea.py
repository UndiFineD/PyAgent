# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_claude_code_oauth.py
...
class TestTokenStorage:
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.get_token_storage_path")
    def test_load_stored_tokens_existing_file(self, mock_path, tmp_path, sample_token_data):
...
class TestTokenRefresh:
    ...
    def test_refresh_access_token_success(self, mock_save, mock_load, mock_post, expired_token_data):
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.requests.post")
    @patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens")
    def test_refresh_access_token_network_error(self, mock_load, mock_post, expired_token_data):
    ...
    def test_refresh_access_token_forced_refresh(self, mock_load, sample_token_data):
        ...
        with patch("code_puppy.plugins.claude_code_oauth.utils.requests.post") as mock_post:
            ...
            with patch("code_puppy.plugins.claude_code_oauth.utils.save_tokens") as mock_save:
                mock_save.return_value = True
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens")
    @patch("code_puppy.plugins.claude_code_oauth.utils.save_tokens")
    def test_refresh_access_token_missing_expires_in_reuses_existing(self, mock_save, mock_load, mock_post):
...
class TestValidAccessToken:
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens")
    def test_get_valid_access_token_refresh_fails_but_token_still_valid(self, mock_load, mock_refresh):
        ...
        token_expires_soon = {
            ...
            "refresh_token": "refresh_token",
            "expires_at": now + 299,  # Expires in 299 seconds (just under 5 minute buffer)
        }
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.refresh_access_token")
    @patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens")
    def test_get_valid_access_token_expired_refreshes(self, mock_load, mock_refresh, expired_token_data):
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.refresh_access_token")
    @patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens")
    def test_get_valid_access_token_refresh_fails(self, mock_load, mock_refresh, expired_token_data):
