# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_storage.py
...
class TestLoadAccounts:
    ...
    def test_load_migration_failure_logs_warning(self, temp_storage_path, monkeypatch, caplog):
...
class TestClearAccounts:
    ...
    def test_clear_handles_permission_errors(self, temp_storage_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.ERROR):
            ...
            assert any("Failed to clear account storage" in record.message for record in caplog.records)
