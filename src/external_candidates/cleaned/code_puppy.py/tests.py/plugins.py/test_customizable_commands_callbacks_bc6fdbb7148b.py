# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_customizable_commands_callbacks.py
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                ...
                with patch.object(Path, "read_text", mock_read_text):
                    with patch("code_puppy.plugins.customizable_commands.register_callbacks.emit_error") as mock_emit:
                        _load_markdown_commands()
...
class TestCustomHelp:
    ...
    def test_reloads_commands_on_each_call(self):
        ...
        with patch("code_puppy.plugins.customizable_commands.register_callbacks._load_markdown_commands") as mock_load:
...
class TestHandleCustomCommand:
    ...
    def test_returns_markdown_result_for_valid_command(self):
        ...
        with patch("code_puppy.plugins.customizable_commands.register_callbacks.emit_info"):
    ...
    def test_emits_info_message(self):
        ...
        with patch("code_puppy.plugins.customizable_commands.register_callbacks.emit_info") as mock_emit:
...
class TestCallbackRegistration:
    ...
    def test_custom_command_callback_registered(self):
        ...
        assert any(
            cb is _handle_custom_command or getattr(cb, "__wrapped__", None) is _handle_custom_command
            for cb in callbacks
        )
