# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_claude_code_oauth_models.py
...
class TestModelDiscovery:
    ...
    def test_fetch_claude_code_models_success(self, mock_get, sample_access_token, sample_models_response):
        ...
        assert f"Bearer {sample_access_token}" in call_args[1]["headers"]["Authorization"]
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.requests.get")
    def test_fetch_claude_code_models_network_error(self, mock_get, sample_access_token):
    ...
    @patch("code_puppy.plugins.claude_code_oauth.utils.requests.get")
    def test_fetch_claude_code_models_invalid_response(self, mock_get, sample_access_token):
...
class TestUpdateModelTokens:
    ...
    def test_update_claude_code_model_tokens(self, mock_save, mock_load):
        ...
        assert result is True
        saved_models = mock_save.call_args[0][0]
        assert saved_models["claude-code-opus"]["custom_endpoint"]["api_key"] == new_token
