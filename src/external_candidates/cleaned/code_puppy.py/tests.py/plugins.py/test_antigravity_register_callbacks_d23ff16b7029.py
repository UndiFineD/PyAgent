# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_register_callbacks.py
...
class TestAwaitCallback:
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks._start_callback_server")
...
class TestPerformAuthentication:
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.add_models_to_config")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.exchange_code_for_tokens")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks._await_callback")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.prepare_oauth_context")
    ...
    def test_perform_authentication_success(
        ...
        with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.AccountManager") as mock_manager_class:
            mock_manager = MagicMock()
            mock_manager.account_count = 0
            mock_manager_class.load_from_disk.return_value = mock_manager

            with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.reload_current_agent"):
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks._await_callback")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.prepare_oauth_context")
    def test_perform_authentication_callback_failure(self, mock_prepare_context, mock_await_callback):
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.reload_current_agent")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.add_models_to_config")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.save_tokens")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.exchange_code_for_tokens")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks._await_callback")
    ...
    def test_perform_authentication_add_account_flag(
        ...
        with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.AccountManager") as mock_manager_class:
            ...
            with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_success") as mock_emit_success:
...
class TestHandleStatus:
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.load_antigravity_models")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.fetch_antigravity_status")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_success")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_info")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.load_stored_tokens")
    def test_handle_status_authenticated(
        ...
        mock_load_models.return_value = {"antigravity-gemini-3-pro": {"oauth_source": "antigravity-plugin"}}
    ...
    def test_handle_status_no_email(
        ...
        with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.fetch_antigravity_status") as mock_fetch:
            mock_status = AntigravityStatus(
                project_id="project_123",
                is_onboarded=True,
                current_tier="free-tier",
            ...
            with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.AccountManager") as mock_manager_class:
                ...
                with patch(
                    ...
                    with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_info"):
                        _handle_status()

    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_warning")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.fetch_antigravity_status")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.load_stored_tokens")
    def test_handle_status_fetch_error(self, mock_load_tokens, mock_fetch_status, mock_emit_warning):
        ...
        with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.AccountManager") as mock_manager_class:
            ...
            with patch(
                ...
                with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_success"):
                    with patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_info"):
                        _handle_status()
...
class TestHandleLogout:
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.remove_antigravity_models")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.clear_accounts")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.get_accounts_storage_path")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.get_token_storage_path")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_success")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_info")
...
class TestHandleCustomCommand:
    ...
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.set_model_and_reload_agent")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks._perform_authentication")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.load_stored_tokens")
    @patch("code_puppy.plugins.antigravity_oauth.register_callbacks.emit_info")
