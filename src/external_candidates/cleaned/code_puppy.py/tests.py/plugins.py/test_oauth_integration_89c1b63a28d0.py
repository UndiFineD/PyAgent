# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_oauth_integration.py
...
class TestOAuthFlowIntegration:
    ...
    def test_complete_chatgpt_oauth_flow(self, mock_browser, mock_post, mock_token_storage):
        ...
        with patch(
            ...
            with patch("code_puppy.plugins.chatgpt_oauth.utils.parse_jwt_claims") as mock_jwt:
    ...
    @patch("requests.get")
    @patch("requests.post")
    def test_chatgpt_model_registration_flow(self, mock_post, mock_get, mock_token_storage, mock_models_storage):
    ...
    def test_claude_complete_oauth_flow(self, mock_post, mock_get, tmp_path):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch("code_puppy.plugins.claude_code_oauth.utils.load_stored_tokens") as mock_load_tokens:
...
class TestOAuthSecurityScenarios:
    ...
    def test_csrf_state_validation_integration(self):
        ...
        with patch.object(context1, "redirect_uri", "http://localhost:1455/auth/callback"):
        ...
        with patch.object(context2, "redirect_uri", "http://localhost:1455/auth/callback"):
...
class TestOAuthDataIntegrity:
    ...
    def test_token_data_integrity_roundtrip(self, mock_token_storage, sample_oauth_tokens):
...
class TestOAuthPerformanceAndLimits:
    ...
    def test_oauth_context_generation_performance(self):
        ...
        assert elapsed < 1.0, f"Context generation too slow: {elapsed}s for 100 contexts"
    ...
    def test_model_list_handling_limits(self):
        ...
        assert elapsed < 0.1, f"Model filtering too slow: {elapsed}s for {len(large_model_list)} models"
