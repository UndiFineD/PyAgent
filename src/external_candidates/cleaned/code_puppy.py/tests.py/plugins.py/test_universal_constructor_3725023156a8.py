# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_universal_constructor.py
...
class TestUCToolInfo:
    ...
    def test_full_name_with_namespace(self):
        ...
        info = UCToolInfo(meta=meta, signature="weather()", source_path="/tmp/api/weather.py")
...
class TestResponseModels:
    ...
    def test_uc_call_output_success(self):
        ...
        output = UCCallOutput(success=True, tool_name="greet", result="Hello, World!", execution_time=0.05)
    ...
    def test_uc_call_output_failure(self):
        ...
        output = UCCallOutput(success=False, tool_name="broken", error="Tool raised exception")
    ...
    def test_uc_info_output(self):
        ...
        tool = UCToolInfo(meta=meta, signature="info_test()", source_path="/tmp/test.py")
        output = UCInfoOutput(success=True, tool=tool, source_code="def info_test(): pass")
        assert output.success is True
...
class TestCallbackRegistration:
    ...
    def test_startup_callback_registered(self):
        ...
        assert any(cb is _on_startup or getattr(cb, "__wrapped__", None) is _on_startup for cb in callbacks)
...
class TestHandleInfoAction:
    ...
    def test_info_tool_not_found(self):
        ...
        context = Mock()
        with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
            mock_registry = Mock()
...
class TestHandleUpdateAction:
    ...
    def test_update_tool_not_found(self):
        ...
        with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
            ...
            result = _handle_update_action(context, "nonexistent", "def foo(): pass", None)
            assert result.success is False
            assert "not found" in result.error
...
"""
            ...
            with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                ...
                result = _handle_update_action(context, "test_tool", "def broken(", None)
                assert result.success is False
...
"""
            ...
            with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                ...
                result = _handle_update_action(context, "test_tool", "def foo(): pass", None)
                assert result.success is False
...
"""
    ...
    def test_update_no_source_path(self):
        ...
        with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
            ...
            result = _handle_update_action(context, "no_path", "TOOL_META = {}\ndef foo(): pass", None)
            assert result.success is False
...
def greet(name: str = "World") -> str:
    ...
    return f"Hello, {name}!"
'''
            with patch("code_puppy.plugins.universal_constructor.USER_UC_DIR", tools_dir):
                with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                    mock_registry = Mock()
                    mock_get_registry.return_value = mock_registry
                    ...
                    assert "TOOL_META was auto-generated" in result.create_result.validation_warnings
...
"""
            with patch("code_puppy.plugins.universal_constructor.USER_UC_DIR", tools_dir):
                with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                    ...
                    result = _handle_create_action(context, "custom_name", code, "Custom description")
...
"""
            with patch("code_puppy.plugins.universal_constructor.USER_UC_DIR", tools_dir):
                with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                    ...
                    result = _handle_create_action(context, "api.weather", code, "Weather API tool")
...
"""
            with patch("code_puppy.plugins.universal_constructor.USER_UC_DIR", tools_dir):
                with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                    ...
                    assert "TOOL_META was auto-generated" not in result.create_result.validation_warnings
...
"""
            with patch("code_puppy.plugins.universal_constructor.USER_UC_DIR", tools_dir):
                with patch("code_puppy.plugins.universal_constructor.registry.get_registry") as mock_get_registry:
                    ...
                    result = _handle_create_action(context, "api.finance.stocks", code, "Stock API")
