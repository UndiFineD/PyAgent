# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\agents\test_agent_terminal_qa.py
...
class TestTerminalQAAgentProperties:
    ...
    def test_description(self, agent):
        ...
        assert "visual" in agent.description.lower() or "tui" in agent.description.lower()
