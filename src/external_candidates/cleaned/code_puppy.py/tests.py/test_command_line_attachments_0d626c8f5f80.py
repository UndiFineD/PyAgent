# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_command_line_attachments.py
...
def test_parse_prompt_handles_long_paragraph_paste() -> None:
    ...
    long_text = (
        ...
        "line 948, in apply_transformation return processor.apply_transformation(ti) " * 20
    )
