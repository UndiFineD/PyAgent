# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_config_and_storage_edge_cases.py
...
class TestDBOSConfiguration:
    ...
    def test_get_use_dbos_returns_true_for_truthy_values(self, mock_config_paths, truthy_value):
    ...
    def test_get_use_dbos_returns_false_for_falsy_values(self, mock_config_paths, falsy_value):
...
class TestSubagentVerbose:
    ...
    @pytest.mark.parametrize("truthy_value", ["1", "true", "True", "yes", "on", "YES", "ON"])
    def test_get_subagent_verbose_returns_true_for_truthy_values(self, mock_config_paths, truthy_value):
    ...
    @pytest.mark.parametrize("falsy_value", ["0", "false", "no", "off", ""])
    def test_get_subagent_verbose_returns_false_for_falsy_values(self, mock_config_paths, falsy_value):
...
class TestAllowRecursion:
    ...
    def test_get_allow_recursion_respects_truthy_values(self, mock_config_paths, truthy):
