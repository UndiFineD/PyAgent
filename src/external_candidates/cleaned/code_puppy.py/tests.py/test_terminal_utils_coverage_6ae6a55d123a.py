# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_terminal_utils_coverage.py
    ...
    def test_enable_ctrl_c_full_success_path(self):
        ...
        with patch.dict(sys.modules, {"ctypes": mock_ctypes}):
            with patch("platform.system", return_value="Windows"):
                ...
                mock_kernel32.SetConsoleMode.assert_called_once_with(stdin_handle, 0x0007)
