# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_config_extended_part1.py
import configparser
import os
import tempfile
...
class TestConfigExtendedPart1:
    ...
    def test_get_global_model_name_with_valid_stored_model(self, mock_default, mock_validate, mock_config_file):
    ...
    @patch("code_puppy.config._validate_model_exists")
    @patch("code_puppy.config._default_model_from_models_json")
    def test_get_global_model_name_with_invalid_stored_model(self, mock_default, mock_validate, mock_config_file):
    ...
    @patch("code_puppy.config._validate_model_exists")
    @patch("code_puppy.config._default_model_from_models_json")
    def test_get_global_model_name_no_stored_model(self, mock_default, mock_validate, temp_config_dir):
