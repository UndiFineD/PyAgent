# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\browser\browser_manager.py
...
_browser_session_var: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar("browser_session", default=None)
