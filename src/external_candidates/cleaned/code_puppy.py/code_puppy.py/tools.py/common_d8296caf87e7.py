# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\common.py
import asyncio
import fnmatch
import functools
import hashlib
...
def arrow_select(message: str, choices: list[str]) -> str:
    ...
    try:
        ...
        raise RuntimeError("arrow_select() called from async context. Use arrow_select_async() instead.")
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs) -> Any:
            ...
            try:
                ...
                asyncio.create_task(callbacks.on_pre_tool_call(tool_name, tool_args, context))
            except ImportError:
            ...
            try:
                ...
                try:
                    ...
                    asyncio.create_task(
                        callbacks.on_post_tool_call(tool_name, tool_args, final_result, duration_ms, context)
                    )
                except ImportError:
