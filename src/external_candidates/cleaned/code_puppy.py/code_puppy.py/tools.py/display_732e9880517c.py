# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\tools\display.py
...
def display_non_streamed_result(
    ...
    console.print(Text.from_markup(f"[bold white on {banner_color}] {banner_text} [/bold white on {banner_color}]"))
