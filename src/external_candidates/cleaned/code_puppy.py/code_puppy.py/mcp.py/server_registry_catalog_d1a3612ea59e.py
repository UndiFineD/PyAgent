# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\mcp_\server_registry_catalog.py
"""
...
MCP_SERVER_REGISTRY: List[MCPServerTemplate] = [
    ...
    MCPServerTemplate(
        ...
        verified=True,
        requires=MCPServerRequirements(required_tools=["python", "pip"], package_dependencies=["mcp-server-pypi"]),
    ),
]
