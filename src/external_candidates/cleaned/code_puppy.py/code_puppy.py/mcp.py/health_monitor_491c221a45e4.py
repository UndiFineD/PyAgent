# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\mcp_\health_monitor.py
"""
...
class HealthMonitor:
    ...
    async def start_monitoring(self, server_id: str, server: ManagedMCPServer) -> None:
        ...
        task = asyncio.create_task(self._monitoring_loop(server_id, server), name=f"health_monitor_{server_id}")
