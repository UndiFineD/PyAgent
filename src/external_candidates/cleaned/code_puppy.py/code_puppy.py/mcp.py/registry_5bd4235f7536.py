# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\mcp_\registry.py
"""
    ...
    def validate_config(self, config: ServerConfig) -> List[str]:
        ...
        if server_type in ["sse", "http"]:
            ...
            if "env" in server_config:
                ...
                elif not all(isinstance(k, str) and isinstance(v, str) for k, v in server_config["env"].items()):
