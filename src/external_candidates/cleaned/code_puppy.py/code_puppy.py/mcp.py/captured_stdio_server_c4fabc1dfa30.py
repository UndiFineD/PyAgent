# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\mcp_\captured_stdio_server.py
"""
    ...
    def clear(self, server_name: Optional[str] = None):
        ...
        if server_name:
            if server_name in self.servers:
                ...
                self.all_lines = [entry for entry in self.all_lines if entry["server"] != server_name]
        else:
            self.servers.clear()
