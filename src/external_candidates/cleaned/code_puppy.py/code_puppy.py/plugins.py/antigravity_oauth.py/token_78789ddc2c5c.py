# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\antigravity_oauth\token.py
    ...
    try:
        ...
        if not response.ok:
            ...
            if error_code == "invalid_grant":
                logger.warning("Google revoked the stored refresh token - reauthentication required")
