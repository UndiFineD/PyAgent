# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\antigravity_oauth\test_plugin.py
    ...
    def test_thinking_models_have_budget(self):
        ...
        for model_id, config in ANTIGRAVITY_MODELS.items():
            if "thinking" in model_id:
                assert "thinking_budget" in config, f"{model_id} missing thinking_budget"
