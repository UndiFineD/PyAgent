# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\universal_constructor\register_callbacks.py
...
def _on_startup() -> None:
    ...
    logger.debug(f"UC plugin loaded: {len(enabled)}/{len(tools)} tools enabled from {USER_UC_DIR}")
