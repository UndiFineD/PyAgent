# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\plugins\universal_constructor\registry.py
...
class UCRegistry:
    ...
    def _load_tool_file(self, file_path: Path) -> Optional[UCToolInfo]:
        ...
        raw_meta = dict(getattr(module, "TOOL_META"))  # Copy to avoid mutating module constant
    ...
    def _find_tool_function(self, module: ModuleType, tool_name: str) -> Tuple[Optional[Callable], str]:
