# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\pin_command_completion.py
import json
...
class PinCompleter(Completer):
    ...
    def get_completions(self, document: Document, complete_event) -> Iterable[Completion]:
        ...
        command_part = text_before_cursor[trigger_pos + len(self.trigger) + 1 :].lstrip()
        ...
        # Case 2: Completing first argument (agent name)
            ...
            if command_part.endswith(" ") and cursor_at_end and text_before_cursor.endswith(" "):
