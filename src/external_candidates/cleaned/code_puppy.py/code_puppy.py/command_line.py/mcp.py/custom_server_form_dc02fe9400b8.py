# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp\custom_server_form.py
...
class CustomServerForm:
    ...
    def __init__(
        ...
        self.selected_type_idx = SERVER_TYPES.index(existing_type) if existing_type in SERVER_TYPES else 0
        ...
        try:
            ...
            if self.edit_mode and self.original_name:
                ...
                if existing_config:
                    ...
                    success = self.manager.update_server(existing_config.id, server_config)
            ...
            if self.edit_mode and self.original_name and self.original_name != server_name:
