# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp\utils.py
"""
...
def suggest_similar_servers(manager, server_name: str, group_id: Optional[str] = None) -> None:
    """
