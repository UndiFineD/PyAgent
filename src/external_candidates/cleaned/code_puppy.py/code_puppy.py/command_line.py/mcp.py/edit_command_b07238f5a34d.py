# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\command_line\mcp\edit_command.py
...
class EditCommand(MCPCommandBase):
    ...
    def _load_server_config(self, server_name: str, group_id: str) -> Optional[tuple[str, dict]]:
