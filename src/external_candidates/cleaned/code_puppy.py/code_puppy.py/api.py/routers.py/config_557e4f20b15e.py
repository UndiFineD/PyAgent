# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\api\routers\config.py
...
async def get_config_value(key: str) -> ConfigValue:
    ...
    if key not in valid_keys:
        raise HTTPException(404, f"Config key '{key}' not found. Valid keys: {valid_keys}")
