# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\alirezarezvani.py\tdd_guide.py\scripts.py\fixture_generator_0bdfde6b4d19.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\alirezarezvani\tdd-guide\scripts\fixture_generator.py
...
class FixtureGenerator:
    ...
    def generate_boundary_values(self, data_type: str, constraints: Optional[Dict[str, Any]] = None) -> List[Any]:
        """
    ...
    def generate_edge_cases(self, scenario: str, context: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _generate_field_value(self, field_type: str, field_def: Dict[str, Any]) -> Any:
        ...
        if field_type == "string":
            ...
            return [self._generate_field_value(item_type, field_def.get("items", {})) for _ in range(size)]
