# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\src.py\audio.py\resampler_22cd434785e4.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\src\audio\resampler.py
...
def resample_audio(
    ...
    *,
    ...
    converted, new_state = audioop.ratecv(pcm_bytes, sample_width, channels, source_rate, target_rate, state)
