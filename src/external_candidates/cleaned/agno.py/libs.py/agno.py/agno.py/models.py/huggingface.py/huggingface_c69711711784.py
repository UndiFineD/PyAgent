# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\agno\models\huggingface\huggingface.py
import json
        ...
        _dict.update(
            {
                ...
                "tools": self._tools,
                "tool_choice": (
                    self.tool_choice if (self._tools is not None and self.tool_choice is not None) else "auto"
                ),
            }
        )
