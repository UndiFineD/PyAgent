# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\agno\models\anthropic\claude.py
import json
...
class Claude(Model):
    ...
    def parse_provider_response_delta(
        self,
        response: Union[ContentBlockDeltaEvent, ContentBlockStopEvent, MessageDeltaEvent],
    ) -> ModelResponse:
        """
