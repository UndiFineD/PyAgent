# Extracted from: C:\DEV\PyAgent\.external\agno\libs\agno\agno\agent\agent.py
...
class Agent:
    ...
    async def _arun(
        ...
        **kwargs: Any,
        ...
        log_debug(
            f"Async Agent Run Start: {self.run_response.run_id}",
            center=True,
            symbol="*",
        )
                        ...
                        for i, step in enumerate(reasoning_steps, 1):
                            ...
                            if show_full_reasoning:
                                ...
                                if step.reasoning is not None:
                                    step_content.append(
                                        Text.from_markup(
                                            f"\n[bold]Reasoning:[/bold] {step.reasoning}",
                                            style="dim",
                                        )
                                    )
                                if step.confidence is not None:
                                    step_content.append(
                                        Text.from_markup(
                                            f"\n[bold]Confidence:[/bold] {step.confidence}",
                                            style="dim",
                                        )
                                    )
                    ...
                    if isinstance(run_response.content, str):
                        ...
                        try:
                            response_content_batch = JSON(
                                run_response.content.model_dump_json(exclude_none=True),
                                indent=2,
                            )
                        except Exception as e:
