# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\teams\reasoning_multi_purpose_team.py
"""
...
local_python_agent = Agent(
    ...
    tools=[
        ...
        PythonTools(base_dir=Path(cwd), list_files=True, run_files=True, uv_pip_install=True),
    ],
)
