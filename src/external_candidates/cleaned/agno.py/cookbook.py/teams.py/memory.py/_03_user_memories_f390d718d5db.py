# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\teams\memory\03_user_memories.py
"""
...
stock_searcher = Agent(
    ...
    storage=SqliteAgentStorage(table_name="agent_sessions", db_file="tmp/persistent_memory.db"),
    memory=memory,
)
...
team = Team(
    ...
    storage=SqliteAgentStorage(table_name="team_sessions", db_file="tmp/persistent_memory.db"),
...
team.print_response("What have we been talking about, do you know my name?", stream=True)
