# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\teams\memory\02_persistent_chat_history.py
"""
...
team = Team(
    ...
    storage=SqliteStorage(table_name="team_sessions", db_file="tmp/persistent_memory.db"),
