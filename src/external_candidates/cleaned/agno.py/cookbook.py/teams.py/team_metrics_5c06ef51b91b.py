# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\teams\team_metrics.py
...
run_stream: Iterator[RunResponse] = team.run("What is the stock price of NVDA", stream=True)
