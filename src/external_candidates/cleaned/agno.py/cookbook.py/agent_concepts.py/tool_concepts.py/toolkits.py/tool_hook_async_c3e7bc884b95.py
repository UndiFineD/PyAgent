# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\tool_concepts\toolkits\tool_hook_async.py
...
async def logger_hook(function_name: str, function_call: Callable, arguments: Dict[str, Any]):
