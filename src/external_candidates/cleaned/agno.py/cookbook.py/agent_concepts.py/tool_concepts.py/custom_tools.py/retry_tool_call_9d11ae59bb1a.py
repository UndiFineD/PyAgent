# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\tool_concepts\custom_tools\retry_tool_call.py
...
def add_item(agent: Agent, item: str) -> str:
    ...
    if len_shopping_list < 3:
        logger.info(f"Asking the model to add {3 - len_shopping_list} more items to the shopping list.")
        raise RetryAgentRun(
