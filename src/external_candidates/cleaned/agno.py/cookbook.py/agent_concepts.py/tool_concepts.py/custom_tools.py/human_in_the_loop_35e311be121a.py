# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\tool_concepts\custom_tools\human_in_the_loop.py
...
agent.print_response("Fetch the top 2 hackernews stories?", stream=True, console=console)
