# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\memory_legacy\07_persistent_memory_mongodb.py
"""
...
def print_chat_history(agent):
    ...
    console.print(
        Panel(
            JSON(
                json.dumps([m.model_dump(include={"role", "content"}) for m in agent.memory.messages]),
                indent=4,
            ),
