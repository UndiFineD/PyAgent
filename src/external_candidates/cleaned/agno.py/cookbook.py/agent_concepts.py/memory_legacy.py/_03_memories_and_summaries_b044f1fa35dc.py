# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\memory_legacy\03_memories_and_summaries.py
"""
...
def print_agent_memory(agent):
    ...
    console.print(
        render_panel(
            ...
            json.dumps(
                [m.model_dump(include={"memory", "input"}) for m in agent.memory.memories],
                indent=4,
            ),
        )
    )
