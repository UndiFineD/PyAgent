# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\state\session_state_user_id.py
"""
...
def remove_item(agent: Agent, item: str) -> str:
    ...
    if item not in shopping_list[current_user_id][current_session_id]:
        return (
            f"Item '{item}' not found in the shopping list for user {current_user_id} and session {current_session_id}"
        )
