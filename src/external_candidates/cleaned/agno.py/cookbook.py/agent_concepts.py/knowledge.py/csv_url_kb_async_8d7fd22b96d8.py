# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\knowledge\csv_url_kb_async.py
import asyncio
...
if __name__ == "__main__":
    ...
    asyncio.run(agent.aprint_response("What genre of movies are present here?", markdown=True))
