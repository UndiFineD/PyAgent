# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\knowledge\custom\retriever.py
...
def retriever(query: str, agent: Optional[Agent] = None, num_documents: int = 5, **kwargs) -> Optional[list[dict]]:
    """
