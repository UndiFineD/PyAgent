# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\memory\02_persistent_memory.py
"""
...
memory.add_user_memory(
    memory=UserMemory(memory="The user works at a software company called Agno", topics=["work"]),
    user_id=john_doe_id,
)
