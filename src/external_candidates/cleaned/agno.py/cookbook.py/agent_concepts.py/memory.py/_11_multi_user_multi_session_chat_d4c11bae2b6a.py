# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\memory\11_multi_user_multi_session_chat.py
"""
...
async def run_chat_agent():
    ...
    # Chat with user 2
    await chat_agent.aprint_response("Hi my name is John Doe.", user_id=user_2_id, session_id=user_2_session_1_id)
    await chat_agent.aprint_response(
    ...
    # Chat with user 3
    await chat_agent.aprint_response("Hi my name is Jane Smith.", user_id=user_3_id, session_id=user_3_session_1_id)
    await chat_agent.aprint_response(
