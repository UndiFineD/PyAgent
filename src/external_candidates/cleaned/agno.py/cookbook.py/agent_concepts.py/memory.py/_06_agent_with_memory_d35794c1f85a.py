# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\agent_concepts\memory\06_agent_with_memory.py
"""
...
agent.print_response("What are my hobbies?", stream=True, user_id=john_doe_id, session_id=session_id)
