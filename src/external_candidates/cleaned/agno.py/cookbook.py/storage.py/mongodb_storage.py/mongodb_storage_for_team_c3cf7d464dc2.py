# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\storage\mongodb_storage\mongodb_storage_for_team.py
"""
...
hn_team = Team(
    ...
    storage=MongoDbStorage(collection_name="team_sessions", db_url=db_url, db_name="agno"),
    instructions=[
