# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\storage\dynamodb_storage\dynamodb_storage_for_workflow.py
import json
...
if __name__ == "__main__":
    ...
    report: Iterator[RunResponse] = HackerNewsReporter(
        storage=DynamoDbStorage(table_name="workflow_sessions", region_name="us-east-1"),
        debug_mode=False,
    ).run(num_stories=5)
    # Print the report
