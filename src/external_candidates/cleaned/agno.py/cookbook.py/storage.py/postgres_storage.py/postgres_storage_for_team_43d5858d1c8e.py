# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\storage\postgres_storage\postgres_storage_for_team.py
"""
...
hn_team = Team(
    ...
    storage=PostgresStorage(table_name="team_sessions", db_url=db_url, auto_upgrade_schema=True),
    instructions=[
