# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\playground\groq_agents.py
"""Usage:
...
web_agent = Agent(
    ...
    + common_instructions,
    storage=SqliteStorage(table_name="web_agent", db_file=xai_agent_storage, auto_upgrade_schema=True),
...
finance_agent = Agent(
    ...
    storage=SqliteStorage(table_name="finance_agent", db_file=xai_agent_storage, auto_upgrade_schema=True),
    show_tool_calls=True,
    add_history_to_messages=True,
...
youtube_agent = Agent(
    ...
    + common_instructions,
    storage=SqliteStorage(table_name="youtube_agent", db_file=xai_agent_storage, auto_upgrade_schema=True),
    show_tool_calls=True,
    add_history_to_messages=True,
    num_history_responses=5,
    add_name_to_instructions=True,
