# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\playground\reasoning_demo.py
...
cot_agent = Agent(
    ...
    storage=SqliteStorage(table_name="cot_agent", db_file=agent_storage_file, auto_upgrade_schema=True),
    add_history_to_messages=True,
