# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\mcp\airbnb.py
...
if __name__ == "__main__":
    asyncio.run(
        run_agent("What listings are available in San Francisco for 2 people for 3 nights from 1 to 4 August 2025?")
    )
