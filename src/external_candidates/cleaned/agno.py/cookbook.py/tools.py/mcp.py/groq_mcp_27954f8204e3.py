# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\mcp\groq_mcp.py
...
if __name__ == "__main__":
    ...
    asyncio.run(run_agent("Show me the README.md and explain how Groq with MCP enables fast file analysis"))
