# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\mcp\filesystem.py
...
if __name__ == "__main__":
    ...
    asyncio.run(run_agent("Show me the content of README.md and explain what this project does"))
