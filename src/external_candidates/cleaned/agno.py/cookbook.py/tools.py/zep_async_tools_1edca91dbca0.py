# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\zep_async_tools.py
"""
...
async def main():
    ...
    zep_tools = ZepAsyncTools(user_id="agno", session_id="agno-async-session", add_instructions=True)
