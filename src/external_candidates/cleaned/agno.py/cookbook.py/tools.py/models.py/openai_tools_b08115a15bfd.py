# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\models\openai_tools.py
"""
...
transcription_agent.print_response(f"Transcribe the audio file for this file: {local_audio_path}")
