# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\slack_tools.py
...
agent.print_response("Send a message 'Hello from Agno!' to the channel #bot-test", markdown=True)
