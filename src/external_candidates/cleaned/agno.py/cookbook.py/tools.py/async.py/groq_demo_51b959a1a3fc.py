# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\async\groq-demo.py
import asyncio
import time
...
# Streaming response
asyncio.run(async_agent.aprint_response("Please run all tasks with a delay of 3s", stream=True))
