# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\e2b_tools.py
"""
...
agent.print_response("Write Python code to generate the first 10 Fibonacci numbers and calculate their sum and average")
