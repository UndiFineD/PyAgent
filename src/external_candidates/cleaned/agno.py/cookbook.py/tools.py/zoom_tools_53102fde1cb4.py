# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\zoom_tools.py
"""
...
zoom_tools = ZoomTools(account_id=ACCOUNT_ID, client_id=CLIENT_ID, client_secret=CLIENT_SECRET)
...
agent.print_response("Schedule a meeting titled 'Team Sync' for tomorrow at 2 PM UTC for 45 minutes")
