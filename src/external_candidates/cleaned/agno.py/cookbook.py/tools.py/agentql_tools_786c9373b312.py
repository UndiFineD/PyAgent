# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\tools\agentql_tools.py
"""
...
agent = Agent(model=OpenAIChat(id="gpt-4o"), tools=[AgentQLTools()], show_tool_calls=True)
...
custom_agent = Agent(model=OpenAIChat(id="gpt-4o"), tools=[custom_scraper], show_tool_calls=True)
