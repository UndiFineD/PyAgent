# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\models\openai\chat\audio_input_and_output_multi_turn.py
...
agent.print_response("What is in this audio?", audio={"data": wav_data, "format": "wav"})
