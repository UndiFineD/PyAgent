# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\models\groq\reasoning_agent.py
...
reasoning_agent = Agent(
    ...
    reasoning_model=Groq(id="deepseek-r1-distill-llama-70b", temperature=0.6, max_tokens=1024, top_p=0.95),
)
