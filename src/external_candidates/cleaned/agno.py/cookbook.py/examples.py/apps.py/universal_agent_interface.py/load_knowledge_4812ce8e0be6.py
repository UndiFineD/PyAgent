# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\universal_agent_interface\load_knowledge.py
"""
...
def load_knowledge(recreate: bool = False):
    ...
    with Progress(SpinnerColumn(), TextColumn("[bold blue]{task.description}"), console=console) as progress:
        task = progress.add_task("Loading Universal Agent Interface knowledge...", total=None)
