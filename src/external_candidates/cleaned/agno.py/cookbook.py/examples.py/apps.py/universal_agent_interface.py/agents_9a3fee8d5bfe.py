# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\universal_agent_interface\agents.py
...
def get_agent(agent_name: str, model: Model, memory: Memory, knowledge: AgentKnowledge) -> Optional[Agent]:
