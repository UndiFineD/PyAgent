...
uagi_memory = Memory(db=SqliteMemoryDb(table_name="uagi_memory", db_file=str(MEMORY_PATH)))
...
def create_uagi(config: UAgIConfig, session_id: Optional[str] = None, debug_mode: bool = True) -> Team:
