# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\paperpal\technical_writer.py
import os
...
# Initialize tools
arxiv_toolkit = ArxivTools(download_dir=Path(__file__).parent.parent.parent.parent.joinpath("wip", "arxiv_pdfs"))
exa_tools = ExaTools()
