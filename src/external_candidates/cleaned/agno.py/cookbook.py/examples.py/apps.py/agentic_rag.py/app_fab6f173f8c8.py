# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\agentic_rag\app.py
import os
import tempfile
...
def main():
    ...
    session_id_exists = (
        "agentic_rag_agent_session_id" in st.session_state and st.session_state["agentic_rag_agent_session_id"]
    )
