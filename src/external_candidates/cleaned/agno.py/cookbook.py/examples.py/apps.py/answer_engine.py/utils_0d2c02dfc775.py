# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\answer_engine\utils.py
            ...
            try:
                ...
                if selected_session_obj and selected_session_obj.memory and "runs" in selected_session_obj.memory:
                    ...
                    for run in selected_session_obj.memory["runs"]:
                        ...
                        elif "message" in run and isinstance(run["message"], dict) and "content" in run["message"]:
