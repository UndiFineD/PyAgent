# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\image_generation\app.py
import base64
import io
...
def main() -> None:
    ...
    use_default = st.sidebar.checkbox("Use default sample recipe book", value=(uploaded_file is None))
    pdf_path = None
    if uploaded_file:
        import tempfile
        ...
        with st.chat_message("assistant"):
            ...
            with st.spinner("🤔 Thinking..."):
                ...
                try:
                    ...
                    run_response = recipe_agent.run(question, stream=True, stream_intermediate_steps=True)
