# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\examples\apps\mcp_agent\app.py
import asyncio
...
async def main() -> None:
    ...
    try:
        ...
        try:
            ...
            st.warning(f"Could not create Agent session: {str(e)}. Is the database running?")
            return
