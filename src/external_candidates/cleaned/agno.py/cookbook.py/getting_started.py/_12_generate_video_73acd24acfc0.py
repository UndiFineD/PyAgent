# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\getting_started\12_generate_video.py
...
# Example usage
video_agent.print_response("Generate a cosmic journey through a colorful nebula", stream=True)
