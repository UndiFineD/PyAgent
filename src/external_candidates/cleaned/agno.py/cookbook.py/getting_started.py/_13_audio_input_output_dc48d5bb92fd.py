# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\getting_started\13_audio_input_output.py
...
if agent.run_response.response_audio is not None:
    write_audio_to_file(audio=agent.run_response.response_audio.content, filename="tmp/response.wav")
