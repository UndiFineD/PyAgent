# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\getting_started\18_retry_function_call.py
...
def pre_hook(fc: FunctionCall):
    ...
    num_calls += 1
    if num_calls < 2:
        raise RetryAgentRun("This wasn't interesting enough, please retry with a different argument")
