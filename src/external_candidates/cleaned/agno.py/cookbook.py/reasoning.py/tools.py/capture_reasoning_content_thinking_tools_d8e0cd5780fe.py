# Extracted from: C:\DEV\PyAgent\.external\agno\cookbook\reasoning\tools\capture_reasoning_content_thinking_tools.py
"""
...
response = agent.print_response("What is the sum of the first 10 natural numbers?", stream=False)
