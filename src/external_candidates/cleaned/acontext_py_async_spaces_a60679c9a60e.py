# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\acontext.py\src.py\client.py\acontext_py.py\src.py\acontext.py\resources.py\async_spaces_a60679c9a60e.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Acontext\src\client\acontext-py\src\acontext\resources\async_spaces.py
...
class AsyncSpacesAPI:
    ...
    async def experience_search(
        ...
        *,
        ...
        data = await self._requester.request("GET", f"/space/{space_id}/experience_search", params=params or None)
    ...
    async def semantic_glob(
        ...
        *,
        ...
        data = await self._requester.request("GET", f"/space/{space_id}/semantic_glob", params=params or None)
    ...
    async def semantic_grep(
        ...
        *,
        ...
        data = await self._requester.request("GET", f"/space/{space_id}/semantic_grep", params=params or None)
