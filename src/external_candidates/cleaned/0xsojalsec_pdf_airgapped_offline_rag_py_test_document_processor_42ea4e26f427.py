# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pdf_airgapped_offline_rag.py\tests.py\test_document_processor_42ea4e26f427.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pdf-airgapped-offline-Rag\tests\test_document_processor.py
