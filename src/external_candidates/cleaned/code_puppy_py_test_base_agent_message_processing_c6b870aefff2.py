# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\agents.py\test_base_agent_message_processing_c6b870aefff2.py
...
class TestBaseAgentMessageProcessing:
    ...
    def test_stringify_message_part_tool_call(self, agent):
        ...
        part = ToolCallPart(tool_call_id="test123", tool_name="test_tool", args={"param": "value"})
    ...
    def test_is_tool_return_part_with_tool_return_part(self, agent):
        ...
        part = ToolReturnPart(tool_call_id="test123", tool_name="test_tool", content="Success")
    ...
    def test_prune_interrupted_tool_calls_matched_calls(self, agent):
        ...
        messages = [
            ...
            ModelRequest(parts=[ToolReturnPart(tool_call_id="call123", tool_name="test_tool", content="Success")]),
        ]
