# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\test_audio_resampler_43ff235d75e6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\Asterisk-AI-Voice-Agent\tests\test_audio_resampler.py
...
def test_mulaw_round_trip_identity():
    ...
    assert restored_rms == pytest.approx(original_rms, abs=8)
