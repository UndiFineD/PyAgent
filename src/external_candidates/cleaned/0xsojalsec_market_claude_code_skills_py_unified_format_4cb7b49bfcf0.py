# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_market_claude_code_skills.py\transcript_fixer.py\scripts.py\utils.py\diff_formats.py\unified_format_4cb7b49bfcf0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-market-claude-code-skills\transcript-fixer\scripts\utils\diff_formats\unified_format.py
