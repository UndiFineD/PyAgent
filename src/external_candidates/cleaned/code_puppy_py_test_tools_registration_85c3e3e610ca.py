# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_tools_registration_85c3e3e610ca.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_tools_registration.py
...
class TestToolRegistration:
    ...
    def test_register_tools_by_category(self):
        ...
        register_tools_for_agent(mock_agent, ["read_file", "delete_file", "agent_share_your_reasoning"])
