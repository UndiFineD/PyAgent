# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\finance_news.py\scripts.py\alerts_ac42b150a05f.py
...
def check_alerts() -> dict:
    ...
    active_alerts = [a for a in alerts if not a.get("snooze_until") or datetime.fromisoformat(a["snooze_until"]) <= now]
