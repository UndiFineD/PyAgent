# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_maltego_telegram.py\transforms.py\channeltostickerset_bc2083188cc9.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-maltego-telegram\transforms\ChannelToStickerSet.py
...
from settings import app, bot_token, limit, loop
...
class ChannelToStickerSet(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        for sticker_set in sticker_sets:
            ...
            stickerset_entity.addProperty("properties.title", value=sticker_set.set_name)
