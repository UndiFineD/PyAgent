# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_pi0_lerobot.py\src.py\pi0_lerobot.py\vggt_load_utils_f3b77171988b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-pi0-lerobot\src\pi0_lerobot\vggt_load_utils.py
