# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_version_checker_f0ed53d065bb.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_version_checker.py
...
class TestFetchLatestVersion:
    ...
    def test_fetch_latest_version_success(self, mock_get):
        ...
        mock_get.assert_called_once_with("https://pypi.org/pypi/test-package/json", timeout=5.0)
...
class TestDefaultVersionMismatchBehavior:
    ...
    @patch("code_puppy.version_checker.emit_info")
    @patch("code_puppy.version_checker.fetch_latest_version")
    def test_update_message_content(self, mock_fetch, mock_emit_info, mock_emit_warning, mock_emit_success, mock_bus):
    ...
    def test_none_current_version_handled_gracefully(
        ...
        mock_emit_warning.assert_any_call("Could not detect current version, using fallback")
