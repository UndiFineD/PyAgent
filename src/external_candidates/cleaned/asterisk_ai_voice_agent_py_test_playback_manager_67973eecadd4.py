# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\asterisk_ai_voice_agent.py\tests.py\test_playback_manager_67973eecadd4.py
...
class TestPlaybackManager:
    ...
    async def test_play_audio_success(self, playback_manager, sample_session):
        ...
        with (
            ...
            playback_id = await playback_manager.play_audio("test_call_123", audio_bytes, "response")
    ...
    async def test_play_audio_session_not_found(self, playback_manager):
        ...
        playback_id = await playback_manager.play_audio("nonexistent_call", audio_bytes, "response")
    ...
    async def test_multiple_playbacks_gating(self, playback_manager, sample_session):
        ...
        with (
            ...
            playback_id_1 = await playback_manager.play_audio("test_call_123", audio_bytes, "response")

            assert playback_id_1 is not None

            # Start second playback

            playback_id_2 = await playback_manager.play_audio("test_call_123", audio_bytes, "response")
