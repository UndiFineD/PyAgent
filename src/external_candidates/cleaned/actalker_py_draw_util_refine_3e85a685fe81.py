# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\src.py\utils.py\mediapipe.py\draw_util_refine_3e85a685fe81.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\utils\mediapipe\draw_util_refine.py
...
class FaceMeshVisualizer:
    ...
    def draw_landmarks(self, image_size, keypoints, L_E=None, R_E=None, normed=False):
        ...
        if L_E is not None:
            ...
            image = cv2.circle(
                img=image,
                center=(left_iris_x, left_iris_y),
                radius=3,
                color=(0, 0, 255),
                thickness=3,
            )
            ...
            image = cv2.circle(
                img=image,
                center=(right_iris_x, right_iris_y),
                radius=3,
                color=(0, 0, 255),
                thickness=3,
            )
