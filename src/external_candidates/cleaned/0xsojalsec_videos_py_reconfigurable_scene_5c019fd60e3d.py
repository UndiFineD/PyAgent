# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\once_useful_constructs.py\reconfigurable_scene_5c019fd60e3d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\once_useful_constructs\reconfigurable_scene.py
...
class ReconfigurableScene(Scene):
    ...
    def transition_to_alt_config(
        ...
        **new_config,
        ...
        alt_scene = self.__class__(skip_animations=True, allow_recursion=False, **new_config)
        ...
        if return_to_original_configuration:
            ...
            self.transition_between_states(state_copy, alt_state, **transformation_kwargs)

            self.transition_between_states(state_copy, original_state, **transformation_kwargs)
            ...
            self.transition_between_states(original_state, alt_state, **transformation_kwargs)
