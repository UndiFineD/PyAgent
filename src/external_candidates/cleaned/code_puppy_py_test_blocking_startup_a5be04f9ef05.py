# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\mcp.py\test_blocking_startup_a5be04f9ef05.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\mcp\test_blocking_startup.py
...
class TestStderrFileCapture:
    ...
    @patch("code_puppy.mcp_.blocking_startup.get_log_file_path")
    @patch("code_puppy.mcp_.blocking_startup.write_log")
    def test_monitor_thread_stops_cleanly(self, mock_write_log, mock_get_path, mock_rotate):
...
class TestBlockingMCPServerStdio:
    ...
    async def test_aenter_success(self):
        ...
        with patch.object(SimpleCapturedMCPServerStdio, "__aenter__", new_callable=AsyncMock) as mock:
