# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\run_dd4525fc0d1b.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-EverMemOS\src\run.py
...
def parse_args():
    ...
    parser.add_argument("--port", type=int, default=1995, help="Server listening port (default: 1995)")
...
def main():
    ...
    if args.mock or (os.getenv("MOCK_MODE") and os.getenv("MOCK_MODE").lower() == "true"):
        enable_mock_mode()
