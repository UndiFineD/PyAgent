# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\tasks.py\task_definitions.py\unbounded.py\unbounded_tasks_8830ede548c5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\eval\tasks\task_definitions\unbounded\unbounded_tasks.py
...
IRON_GEAR_WHEEL_THROUGHPUT_UNBOUNDED = "iron_gear_wheel_throughput_unbounded_steps_show_steps_true"
