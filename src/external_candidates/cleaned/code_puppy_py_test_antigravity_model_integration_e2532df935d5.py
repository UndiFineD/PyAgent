# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\plugins.py\test_antigravity_model_integration_e2532df935d5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\plugins\test_antigravity_model_integration.py
...
class TestIntegrationScenarios:
    ...
    @pytest.mark.asyncio
    async def test_full_conversation_flow(self, mock_google_model, mock_httpx_client) -> None:
