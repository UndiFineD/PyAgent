# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\tests.py\test_model_utils_coverage_9848f777c093.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\tests\test_model_utils_coverage.py
...
class TestPreparePromptForAntigravity:
    ...
    def test_antigravity_gets_antigravity_instructions(self):
        ...
        result = prepare_prompt_for_model("antigravity-gemini", "You are a helpful assistant.", "Hello world")
    ...
    def test_antigravity_prepends_override_to_user_prompt(self):
        ...
        result = prepare_prompt_for_model("antigravity-gemini", "Custom system prompt", "Do the task")
