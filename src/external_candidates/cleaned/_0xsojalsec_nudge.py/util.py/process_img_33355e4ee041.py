# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-nudge\util\process_img.py
import argparse
import pickle
...
if __name__ == "__main__":
    ...
    parser.add_argument("data_path", type=str, help="Directory for to store processed data files")
    parser.add_argument("coco_path", type=str, help="Directory for unprocessed coco files")
