# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\action.py\knowledge.py\reader.py\file.py\sevenzip_reader_7e57dacd36d4.py
...
class SevenZipReader(Reader):
    ...
    def _load_data(
        ...
        try:
            ...
            raise ImportError("py7zr is required to read 7Z files: `pip install py7zr`")
                ...
                for entry_name in entries:
                    ...
                    if compressed_size > 0:
                        ...
                        if ratio > max_compression_ratio:
                            raise ValueError(f"7Z entry has suspicious compression ratio: {entry_name}")
