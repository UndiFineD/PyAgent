# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\adamkristopher.py\seo_dataforseo.py\scripts.py\config.py\settings_a6fe51d98da8.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\adamkristopher\seo-dataforseo\scripts\config\settings.py
