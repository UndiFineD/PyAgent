# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\plan.py\planner.py\react_planner.py\react_planner_07f93773b603.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\plan\planner\react_planner\react_planner.py
...
class ReActPlanner(Planner):
    ...
    def get_run_config(agent_model: AgentModel, input_object: InputObject) -> RunnableConfig:
        ...
        callbacks.append(
            InvokeCallbackHandler(
                source=agent_model.info.get("name"),
