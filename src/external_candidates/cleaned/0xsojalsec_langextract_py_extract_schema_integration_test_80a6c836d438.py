# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_langextract.py\tests.py\extract_schema_integration_test_80a6c836d438.py
                ...
                with mock.patch(
                    ...
                    with warnings.catch_warnings(record=True) as w:
                        ...
                        deprecation_warnings = [
                            warning
                            for warning in w
                            if issubclass(warning.category, FutureWarning) and "gemini_schema" in str(warning.message)
                        ]
