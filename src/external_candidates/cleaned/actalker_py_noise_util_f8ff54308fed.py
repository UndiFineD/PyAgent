# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\actalker.py\src.py\utils.py\noise_util_f8ff54308fed.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\ACTalker\src\utils\noise_util.py
...
def random_noise(
    ...
    if noise_offset is not None:
        ...
        noise += noise_offset * torch.randn((tensor.shape[0], tensor.shape[1], 1, 1, 1), device)
