# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\cache.py\work.py\copilot_tmp.py\chunk_0_utils_2261ce23e03c.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\cache\work\copilot_tmp\chunk_0_utils.py

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\benchmark\lcb_utils\utils.py
