# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\kesslerio.py\dialpad.py\make_call_b9eea2186b13.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\kesslerio\dialpad\make_call.py
...
def make_call(to_number, from_number=None, user_id=None, text_to_speak=None):
    ...
    if text_to_speak:
        ...
        payload["command"] = json.dumps({"actions": [{"say": text_to_speak}]})
...
def main():
    ...
    parser.add_argument("--text", dest="text_to_speak", help="Text to speak (Text-to-Speech)")
