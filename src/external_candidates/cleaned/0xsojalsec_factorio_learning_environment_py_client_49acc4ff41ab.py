# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\env.py\tools.py\agent.py\shift_entity.py\client_49acc4ff41ab.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-factorio-learning-environment\fle\env\tools\agent\shift_entity\client.py

from typing import Union

from fle.env import DirectionInternal as DirectionA

from fle.env.entities import Direction, Entity
