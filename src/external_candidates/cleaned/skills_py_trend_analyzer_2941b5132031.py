# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\veeramanikandanr48.py\cryptocurrency_trader_skill.py\scripts.py\patterns.py\trend_analyzer_2941b5132031.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\veeramanikandanr48\cryptocurrency-trader-skill\scripts\patterns\trend_analyzer.py
...
class TrendAnalyzer:
    ...
    def _calculate_trend(self, prices: np.ndarray) -> Dict:
        ...
        try:
            ...
            logger.debug(f"Trend calculated: {direction}, slope={slope:.4f}, R²={r_value**2:.2f}")
    ...
    def detect_trend_change(self, df: pd.DataFrame, lookback: int = 5) -> Dict:
        ...
        try:
            ...
            if change_detected:
                confidence = min(
                    100,
                    int((recent_trend["r_squared"] + previous_trend["r_squared"]) * 50),
                )
