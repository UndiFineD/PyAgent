# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MuseTalk\musetalk\whisper\whisper\transcribe.py
import argparse
import os
import warnings
...
from .audio import HOP_LENGTH, N_FRAMES, SAMPLE_RATE, log_mel_spectrogram, pad_or_trim
