# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MuseTalk\musetalk\whisper\audio2feature.py
import os
import sys
import time
...
class Audio2Feature:
    def __init__(self, whisper_model_type="tiny", model_path="./models/whisper/tiny.pt"):
