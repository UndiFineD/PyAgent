# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MuseTalk\musetalk\data\dataset.py
import json
import math
import os
import random
...
class FaceDataset(Dataset):
    ...
    def generate_random_value(self):
        ...
        if self.random_margin_method == "uniform":
            ...
            random_value = np.random.normal(loc=self.jaw2edge_margin_mean, scale=self.jaw2edge_margin_std)
