...
VGG_FACE_PATH = (
    "/apdcephfs_cq8/share_1367250/zhentaoyu/Driving/00_VASA/00_data/models/pretrain_models/resnet50_ft_weight.pkl"
)
...
class _ConvBlock(torch.nn.Module):
    ...
    def __init__(self, *units):
        ...
        self.convs = torch.nn.ModuleList(
            [torch.nn.Conv2d(in_, out, 3, 1, 1) for in_, out in zip(units[:-1], units[1:])]
        )
