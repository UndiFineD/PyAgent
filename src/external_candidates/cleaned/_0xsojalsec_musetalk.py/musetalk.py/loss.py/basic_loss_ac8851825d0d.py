# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-MuseTalk\musetalk\loss\basic_loss.py
...
if __name__ == "__main__":
    ...
    scheduler_D = CosineAnnealingLR(optimizer_D, T_max=cfg.discriminator_train_params.epochs, eta_min=1e-6)
