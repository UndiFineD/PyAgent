# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\ai_eng.py\registry.py\access_control.py\rbac.py\interface_96fbdc2150b1.py
...
class RBAC(ABC):
    ...
    def validate_project_access_users(
        ...
        self, project: str, user: str, access: str
