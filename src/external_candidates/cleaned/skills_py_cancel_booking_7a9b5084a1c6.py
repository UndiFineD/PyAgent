# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\skills.py\skills.py\khj809.py\srt.py\scripts.py\cancel_booking_7a9b5084a1c6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\skills\skills\khj809\srt\scripts\cancel_booking.py
...
def cancel_booking(credentials, args):
    ...
    if not getattr(args, "confirm", False):
        ...
        print(
            f"   출발: {getattr(reservation, 'dep_station_name', 'N/A')} {getattr(reservation, 'journey_time', 'N/A')}"
        )
