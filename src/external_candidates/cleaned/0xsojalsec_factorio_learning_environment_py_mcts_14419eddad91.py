# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_factorio_learning_environment.py\fle.py\eval.py\algorithms.py\mcts.py\mcts_14419eddad91.py
...
class MCTS:
    ...
    async def _process_openai_response(
        ...
        if hasattr(response, "usage"):
            ...
            prompt_tokens = (
                response.usage.prompt_tokens if response.usage.prompt_tokens else response.usage.promptTokens
            )
