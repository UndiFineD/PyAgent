# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\evoagentx.py\evoagentx.py\tools.py\image_tools.py\openrouter_image_tools.py\image_analysis_51c52face23d.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\EvoAgentX\evoagentx\tools\image_tools\openrouter_image_tools\image_analysis.py
...
class ImageAnalysisTool(Tool):
    ...
    inputs: Dict[str, Dict[str, str]] = {
        "prompt": {
            "type": "string",
            "description": "Question or instruction for image/PDF analysis.",
        },
        "image_url": {"type": "string", "description": "URL of the image (optional)."},
        "image_path": {
            "type": "string",
            "description": "Local image file path (optional).",
        },
        "pdf_path": {
            "type": "string",
            "description": "Local PDF file path (optional).",
        },
    }
    ...
    def __call__(
        ...
        try:
            ...
            return {
                "error": f"Failed to parse OpenRouter response: {e}",
                "raw": response.text,
            }
