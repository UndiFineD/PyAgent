# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-WindTerm\src\Onigmo\tool\CaseFolding.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
def print_case_folding_data(filename):
    pattern = re.compile("([0-9A-F]{4,6}); ([CFT]); " + "([0-9A-F]{4,6})(?: ([0-9A-F]{4,6}))?(?: ([0-9A-F]{4,6}))?;")
