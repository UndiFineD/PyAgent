# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\code_puppy.py\code_puppy.py\model_switching_2e5448c50dc6.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\code_puppy\code_puppy\model_switching.py
    ...
    try:
        ...
        if warn_on_pinned_mismatch:
            ...
            if effective_model and effective_model != model_name:
                display_name = getattr(current_agent, "display_name", current_agent.name)
