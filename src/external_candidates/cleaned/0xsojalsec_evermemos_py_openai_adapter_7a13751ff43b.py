# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_evermemos.py\src.py\core.py\component.py\llm.py\llm_adapter.py\openai_adapter_7a13751ff43b.py
...
class OpenAIAdapter(LLMBackendAdapter):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.client = openai.AsyncOpenAI(api_key=self.api_key, base_url=self.base_url, timeout=self.timeout)
