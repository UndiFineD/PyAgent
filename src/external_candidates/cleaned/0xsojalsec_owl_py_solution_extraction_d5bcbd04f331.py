# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_owl.py\owl.py\camel.py\prompts.py\solution_extraction_d5bcbd04f331.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-owl\owl\camel\prompts\solution_extraction.py
...
class SolutionExtractionPromptTemplateDict(TextPromptDict):
    ...
    ASSISTANT_PROMPT = TextPrompt("""You are an experienced solution extracting agent. 
