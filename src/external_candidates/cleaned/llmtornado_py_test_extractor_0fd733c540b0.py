# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\llmtornado.py\src.py\llmtornado.py\static.py\files.py\skills.py\codebase_context_extractor.py\test_extractor_0fd733c540b0.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\LLMTornado\src\LlmTornado.Tests\Static\Files\Skills\codebase-context-extractor\test_extractor.py
...
def test_output_formatters():
    ...
    from context_extractor import CodeEntity, FileContext
