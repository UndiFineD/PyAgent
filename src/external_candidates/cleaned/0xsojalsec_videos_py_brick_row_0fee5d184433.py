# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_videos.py\_2018.py\eop.py\reusables.py\brick_row_0fee5d184433.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-videos\_2018\eop\reusables\brick_row.py
...
class BrickRow(VMobject):
    ...
    def init_points(self):
        ...
        self.border = SurroundingRectangle(self, buff=0, color=WHITE)
