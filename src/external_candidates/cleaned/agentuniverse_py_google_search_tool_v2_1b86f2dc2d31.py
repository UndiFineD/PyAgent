# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\agentuniverse.py\agentuniverse.py\agent.py\action.py\tool.py\common_tool.py\google_search_tool_v2_1b86f2dc2d31.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\agentUniverse\agentuniverse\agent\action\tool\common_tool\google_search_tool_v2.py
...
class GoogleSearchTool(Tool):
    ...
    def execute(
        ...
        **kwargs,
        ...
        try:
            search = GoogleSerperAPIWrapper(serper_api_key=self.serper_api_key, k=k, gl=gl, hl=hl, type=search_type)
...
class GoogleScholarSearchTool(Tool):
    ...
    def execute(
        ...
        **kwargs,
        ...
        try:
            search = GoogleSerperAPIWrapper(serper_api_key=self.serper_api_key, k=k, gl="us", hl="en", type="search")
    ...
    def _build_scholar_query(self, query: str, year: str = None, author: str = None, journal: str = None) -> str:
        """构建学术搜索查询"""
