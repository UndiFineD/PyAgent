# Extracted from: C:\DEV\PyAgent\src\external_candidates\ingested\_0xsojalsec_labelllm.py\backend.py\app.py\schemas.py\operator.py\stats_281405fa67a5.py
# NOTE: extracted with static-only rules; review before use

# Extracted from: C:\DEV\PyAgent\.external\0xSojalSec-LabelLLM\backend\app\schemas\operator\stats.py
...
class ExportDataProjectModel(BaseModel):
    custom: ExportDataCustomProjectModel | None = Field(description="自定义字段", default=None)
