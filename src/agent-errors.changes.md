...
- Updated companion documentation to reflect the current code in `src/agent-errors.py`.
- Refreshed `agent-errors.description.md` fingerprint to match the current SHA256.
