...
class DialogManager:
    ...
    def show_settings_dialog(self, config_manager: Any) -> None:
        ...
        ttk.Label(dialog, text="ΓÜÖ∩╕Å Configuration", font=("Segoe UI", 12, "bold")).pack(pady=10)
    ...
    def show_bmad_wizard(self, setup_callback: Callable[[dict[str, Any]], Any]) -> None:
        ...
        ttk.Label(wizard, text="≡ƒÜÇ Initialize BMAD Methodology", font=("Segoe UI", 12, "bold")).pack(pady=10)
    ...
    def show_memory_dialog(
        ...
        ttk.Label(
            dialog,
            text=f"≡ƒºá Context Memory: {agent_name}",
        ...
        def redraw() -> None:
            ...
            for i, msg in enumerate(temp_history):
                ...
                keep_text: str = "Retained Γ£à" if is_kept else "Retain fact"
                ttk.Button(
                    btn_bar,
                    text=keep_text,
                    width=12,
