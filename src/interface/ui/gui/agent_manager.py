...
class AgentManager:
    ...
    def add_agent(self, name, preset_data=None) -> AgentColumn:
        ...
        callbacks = {
            ...
            "stop": self.main_app.stop_process,
            "browse_file": self.main_app.browse_file,
            "voice": self.main_app.voice_input,
            "remove": self.remove_agent,
    ...
    def load_state(self, state) -> None:
        ...
        for s in state:
            ...
            col.phase_var.set(s.get("phase", "None"))
