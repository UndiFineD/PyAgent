...
BMAD_TEMPLATES: dict[str, str] = {
    "Select Template...": "",
    "Quick Spec (ΓÜí)": """# QUICK SPEC: [Feature/Bug Name]
## Problem Description
...
- [ ] Criterion 2
""",
    "PRD (≡ƒôï)": """# PRODUCT REQUIREMENTS DOCUMENT: [Project Name]
## Executive Summary
[High-level goal]
...
- Security: ...
""",
    "Technical Spec (≡ƒÅù∩╕Å)": """# TECHNICAL SPECIFICATION: [Project Name]
...
2. [Step 2]
""",
    "Test Plan (≡ƒº¬)": """# TEST PLAN: [Feature Name]
## Test Strategy
