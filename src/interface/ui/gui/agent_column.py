...
class AgentColumn:
    ...
    def setup_ui(self) -> None:
        ...
        # Minimize Toggle
        self.min_btn = ttk.Button(header_frame, text="Γû╝", width=3, command=self.toggle_minimize)
        ...
        ttk.Button(mini_toolbar, text="ΓÜÖ∩╕Å", width=3, command=self.show_settings_callback).pack(side=tk.LEFT, padx=1)
