...
WHAT IT DOES:
- Adds the project root to sys.path so relative imports resolve, imports main from src.logic.agents.cognitive.context.knowledge_main, and calls main() when run as __main__.
