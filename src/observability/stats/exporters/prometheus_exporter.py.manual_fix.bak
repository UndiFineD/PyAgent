...
- Serializes metrics into a simple text/plain Prometheus scrape response prefixed with "pyagent_"."- Supplies static Grafana integration metadata to help dashboard provisioning.
