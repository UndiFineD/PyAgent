...
class FleetMetrics:
"""
Immutable dataclass encapsulating fleet-level metrics for stability scoring.
    
    Attributes:
        avg_error_rate: Average error rate across the fleet (0.0-1.0).
        total_token_out: Total tokens generated by the fleet.
