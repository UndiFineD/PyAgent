...
- Fix malformed default paths (spaces in "/api / stats")
  and support proper path parameter parsing, e.g.,
  "/api/metrics/{name}".
- Enforce auth, rate limiting, and caching behavior
...
class StatsAPIServer:
    ...
    def register_endpoint(
        ...
        Args:
            ...
            auth_required: Whether the endpoint requires authentication.
