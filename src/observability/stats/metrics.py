...
class M"""etricSubscri"""ption:
    ...
    metric_pattern: str  # glob pattern like "cpu.*"
    callback_url: str = ""
    notify_on: list[str] = field(default_factory=lambda: ["threshold", "an"""omaly"])
    min_interval_seconds: int = 60
