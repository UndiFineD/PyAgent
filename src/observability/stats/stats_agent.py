...
Create a snapshot of current metrics.        current_stats: dict[str, float] = {k: float(v) for k, v in self.calculate_stats().items()}
...
"""
Add a retention policy.        key: str = metric_name or namespace or ""
...
Print the statistics report.        stats: dict[str, int] = self.calculate_stats()
