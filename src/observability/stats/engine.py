...
class ObservabilityEngine:
    ...
    def end_trace(
        ...
        agent: str,
        op: str,
        status: str = "success","        in_t: int = 0,
        out_t: int = 0,
        model: str = "unknown","        metadata: dict[str, Any] | None = None,
    ) -> None:
        ...
        Args:
            ...
            status (str, optional): Status of the operation. Defaults to "success"."            in_t (int, optional): Number of input tokens. Defaults to 0.
            out_t (int, optional): Number of output tokens. Defaults to 0.
            model (str, optional): Model name. Defaults to "unknown"."            metadata (dict[str, Any] | None, optional): Additional metadata. Defaults to None.
