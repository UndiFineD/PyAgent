...
_LAZY_REGISTRY = {
    "AccessController": (
        "src.observability.reports.access_controller",
        "AccessController",
    ),
    "AggregatedReport": (
        "src.observability.reports.aggregated_report",
        "AggregatedReport",
    ),
    "AnnotationManager": (
        "src.observability.reports.annotation_manager",
        "AnnotationManager",
    ),
    ...
    "ChangelogLocalizer": (
        "src.observability.reports.changelog_localizer",
        "ChangelogLocalizer",
    ),
    "ChangelogSearcher": (
        "src.observability.reports.changelog_searcher",
        "ChangelogSearcher",
    ),
    "ChangelogTemplate": (
        "src.observability.reports.changelog_template",
        "ChangelogTemplate",
    ),
    ...
    "GrafanaGenerator": (
        "src.observability.reports.grafana_generator",
        "GrafanaGenerator",
    ),
    ...
    "LocalizedString": (
        "src.observability.reports.localized_string",
        "LocalizedString",
    ),
    "MetricsCollector": (
        "src.observability.reports.metrics_collector",
        "MetricsCollector",
    ),
    "PermissionLevel": (
        "src.observability.reports.permission_level",
        "PermissionLevel",
    ),
    "ReleaseNotesGenerator": (
        "src.observability.reports.release_notes_generator",
        "ReleaseNotesGenerator",
    ),
    "ReportAgent": ("src.observability.reports.reports_agent", "ReportAgent"),
    "ReportAggregator": (
        "src.observability.reports.report_aggregator",
        "ReportAggregator",
    ),
    "ReportAnnotation": (
        "src.observability.reports.report_annotation",
        "ReportAnnotation",
    ),
    ...
    "ReportCacheManager": (
        "src.observability.reports.report_cache_manager",
        "ReportCacheManager",
    ),
    "ReportComparator": (
        "src.observability.reports.report_comparator",
        "ReportComparator",
    ),
    "ReportComparison": (
        "src.observability.reports.report_comparison",
        "ReportComparison",
    ),
    ...
    "ReportGenerator": (
        "src.observability.reports.report_generator",
        "ReportGenerator",
    ),
    "ReportGeneratorCli": (
        "src.observability.reports.report_generator_cli",
        "ReportGeneratorCli",
    ),
    "ReportLocalizer": (
        "src.observability.reports.report_localizer",
        "ReportLocalizer",
    ),
    ...
    "ReportPermission": (
        "src.observability.reports.report_permission",
        "ReportPermission",
    ),
    "ReportScheduler": (
        "src.observability.reports.report_scheduler",
        "ReportScheduler",
    ),
    "ReportSearchEngine": (
        "src.observability.reports.report_search_engine",
        "ReportSearchEngine",
    ),
    "ReportSearchResult": (
        "src.observability.reports.report_search_result",
        "ReportSearchResult",
    ),
    "ReportSubscription": (
    ...
    "ReportValidator": (
        "src.observability.reports.report_validator",
        "ReportValidator",
    ),
    "SeverityLevel": ("src.observability.reports.severity_level", "SeverityLevel"),
    "SubscriptionFrequency": (
        "src.observability.reports.subscription_frequency",
        "SubscriptionFrequency",
    ),
    "SubscriptionManager": (
        "src.observability.reports.subscription_manager",
        "SubscriptionManager",
    ),
    "SwarmTopologyReporter": (
        "src.observability.reports.swarm_topology_reporter",
        "SwarmTopologyReporter",
    ),
    "ValidationResult": (
        "src.observability.reports.validation_result",
        "ValidationResult",
    ),
}
