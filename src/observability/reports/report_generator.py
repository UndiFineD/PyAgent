...
if __name__ == "__main__":
    ...
    agent_dir = Path(args.src) if args.src else (base_dir / "src")
    output_dir = Path(args.out) if args.out else (base_dir / "docs" / "autodoc")
    ...
    if not args.no_dashboard:
        ...
        dashboard_path = output_dir / "AUTODOC_DASHBOARD.md"
