...
_LAZY_REGISTRY = {
    ...
    "AnalysisToolType": (
        "src.observability.improvements.analysis_tool_type",
        "AnalysisToolType",
    ),
    "AnalyticsEngine": (
        "src.observability.improvements.analytics_engine",
        "AnalyticsEngine",
    ),
    "ArchiveManager": (
        "src.observability.improvements.archive_manager",
        "ArchiveManager",
    ),
    "ArchivedImprovement": (
        "src.observability.improvements.archived_improvement",
        "ArchivedImprovement",
    ),
    "AssignmentManager": (
        "src.observability.improvements.assignment_manager",
        "AssignmentManager",
    ),
    "BranchComparer": (
        "src.observability.improvements.branch_comparer",
        "BranchComparer",
    ),
    "BranchComparison": (
        "src.observability.improvements.branch_comparison",
        "BranchComparison",
    ),
    "BranchComparisonStatus": (
        "src.observability.improvements.branch_comparison_status",
        "BranchComparisonStatus",
    ),
    "BulkManager": ("src.observability.improvements.bulk_manager", "BulkManager"),
    "BulkOperationResult": (
        "src.observability.improvements.bulk_operation_result",
        "BulkOperationResult",
    ),
    "CodeAnalyzer": ("src.observability.improvements.code_analyzer", "CodeAnalyzer"),
    "CompletionTrend": (
        "src.observability.improvements.completion_trend",
        "CompletionTrend",
    ),
    "ConflictResolution": (
        "src.observability.improvements.conflict_resolution",
        "ConflictResolution",
    ),
    "DEFAULT_TEMPLATES": (
        "src.observability.improvements.improvement_manager",
        "DEFAULT_TEMPLATES",
    ),
    "DependencyResolver": (
        "src.observability.improvements.dependency_resolver",
        "DependencyResolver",
    ),
    "DocGenerator": ("src.observability.improvements.doc_generator", "DocGenerator"),
    "EffortEstimate": (
        "src.observability.improvements.effort_estimate",
        "EffortEstimate",
    ),
    "EffortEstimateResult": (
        "src.observability.improvements.effort_estimate_result",
        "EffortEstimateResult",
    ),
    "EffortEstimator": (
        "src.observability.improvements.effort_estimator",
        "EffortEstimator",
    ),
    ...
    "ImprovementArchive": (
        "src.observability.improvements.improvement_archive",
        "ImprovementArchive",
    ),
    "ImprovementCategory": (
        "src.observability.improvements.improvement_category",
        "ImprovementCategory",
    ),
    ...
    "ImprovementDiff": (
        "src.observability.improvements.improvement_diff",
        "ImprovementDiff",
    ),
    "ImprovementDiffType": (
        "src.observability.improvements.improvement_diff_type",
        "ImprovementDiffType",
    ),
    "ImprovementExporter": (
        "src.observability.improvements.improvement_exporter",
        "ImprovementExporter",
    ),
    "ImprovementManager": (
        "src.observability.improvements.improvement_manager",
    ...
    "ImprovementPriority": (
        "src.observability.improvements.improvement_priority",
        "ImprovementPriority",
    ),
    "ImprovementScheduler": (
        "src.observability.improvements.improvement_scheduler",
        "ImprovementScheduler",
    ),
    "ImprovementStatus": (
        "src.observability.improvements.improvement_status",
        "ImprovementStatus",
    ),
    "ImprovementTemplate": (
        "src.observability.improvements.improvement_template",
        "ImprovementTemplate",
    ),
    "ImprovementValidator": (
        "src.observability.improvements.improvement_validator",
        "ImprovementValidator",
    ),
    "ImprovementsAgent": (
        "src.observability.improvements.improvements_agent",
        "ImprovementsAgent",
    ),
    "MergeCandidate": (
        "src.observability.improvements.merge_candidate",
        "MergeCandidate",
    ),
    "MergeDetector": ("src.observability.improvements.merge_detector", "MergeDetector"),
    "NotificationManager": (
        "src.observability.improvements.notification_manager",
        "NotificationManager",
    ),
    "ProgressDashboard": (
        "src.observability.improvements.progress_dashboard",
        "ProgressDashboard",
    ),
    "ProgressReport": (
        "src.observability.improvements.progress_report",
        "ProgressReport",
    ),
    "ResourceAllocation": (
        "src.observability.improvements.resource_allocation",
        "ResourceAllocation",
    ),
    "RollbackManager": (
        "src.observability.improvements.rollback_manager",
        "RollbackManager",
    ),
    "RollbackPoint": ("src.observability.improvements.rollback_point", "RollbackPoint"),
    "RollbackRecord": (
        "src.observability.improvements.rollback_record",
        "RollbackRecord",
    ),
    "RollbackTracker": (
        "src.observability.improvements.rollback_tracker",
        "RollbackTracker",
    ),
    "SLAConfiguration": (
        "src.observability.improvements.sla_configuration",
        "SLAConfiguration",
    ),
    ...
    "ScheduleStatus": (
        "src.observability.improvements.schedule_status",
        "ScheduleStatus",
    ),
    "ScheduledEntry": (
        "src.observability.improvements.scheduled_entry",
        "ScheduledEntry",
    ),
    "ScheduledImprovement": (
        "src.observability.improvements.scheduled_improvement",
        "ScheduledImprovement",
    ),
    "ToolIntegration": (
        "src.observability.improvements.tool_integration",
        "ToolIntegration",
    ),
    "ToolSuggestion": (
        "src.observability.improvements.tool_suggestion",
        "ToolSuggestion",
    ),
    "TransitionResult": (
        "src.observability.improvements.transition_result",
        "TransitionResult",
    ),
    "ValidationResult": (
        "src.observability.improvements.validation_result",
        "ValidationResult",
    ),
    "ValidationSeverity": (
        "src.observability.improvements.validation_severity",
        "ValidationSeverity",
    ),
    "VotingSystem": ("src.observability.improvements.voting_system", "VotingSystem"),
    "WorkflowEngine": (
        "src.observability.improvements.workflow_engine",
        "WorkflowEngine",
    ),
    "_ScheduleStore": (
        "src.observability.improvements.schedule_store",
        "_ScheduleStore",
    ),
}
