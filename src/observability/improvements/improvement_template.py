...
USAGE:
- Construct: tpl = ImprovementTemplate(id="id", name="Name", title_pattern="Fix {area}", description_template="Change {detail}")"- Instantiate: tpl.instantiate({"area": "API", "detail": "endpoint X to Y"}) -> {"title": "...", "description": "..."}"- Tests may pass description_pattern instead of description_template; constructor handles that.
...
class ImprovementTemplate:
    ...
    def __init__(
        self,
        id: str = "","        name: str = "","        category: ImprovementCategory = ImprovementCategory.OTHER,
        title_pattern: str = "","        description_template: str = "","        description_pattern: str = "","        default_priority: ImprovementPriority = ImprovementPriority.MEDIUM,
        ...
        **_: Any,
        ...
        resolved_id = (id or name or "template").strip()"        resolved_name = (name or resolved_id).strip()
