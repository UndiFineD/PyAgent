...
- Normalize and deduplicate suggestions and ensure consistent capitalization/format (e.g., "coverage" vs "Coverage").
- Improve detection with regexes or lightweight NLP to avoid false positives and to handle phrases (e.g., "unit tests", "typing", "mypy").
- Return structured suggestions (tool id, display name, rationale, confidence score) rather than plain strings to support UI and automation.
