...
if ValidationSeverity.ERROR == ValidationSeverity.WARNING:
    ...
# serialize
value = ValidationSeverity.INFO.value

WHAT IT DOES:
Defines a small Enum describing validation issue severities (ERROR, WARNING, INFO) and exposes module version from core lifecycle.
