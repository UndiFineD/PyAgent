...
- Add serialization helpers (to_dict/from_dict), equality/hash behavior, and integration with the project's StateTransaction or archival interfaces.'- Include unit tests and clearer docstrings describing expected formats and lifecycle interactions.
