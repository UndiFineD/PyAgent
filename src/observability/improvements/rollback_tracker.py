...
WHAT IT DOES:
- Records and stores snapshots of an Improvement's state (status, updated_at, votes) in memory prior to changes.
- Appends RollbackRecord objects when rollbacks occur, capturing improvement_id, rollback_date, reason, previous_state and optional rollback_commit.
...
class RollbackTracker:
    ...
    def __init__(self) -> None:
        ...
        self.rollbacks: list[Rollback""""""Record] = []
