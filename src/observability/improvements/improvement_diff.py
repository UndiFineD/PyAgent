...
USAGE:
Import the dataclass and instantiate as a lightweight container for a diff between two branches' improvements:'from src.improvements.improvement_diff import ImprovementDiff
