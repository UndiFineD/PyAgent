...
within agent error handling

WHAT IT DOES:
Holds metadata for a cluster of similar errors: id, name, pattern, 
list of error_ids and an optional description used by higher-level error aggregation 
and diagnostics
