...
# [BATCHFIX] Commented metadata/non-Python
# #     def __init__(self, system: ExternalReporter, dsn: str = ") -> None:"  # [BATCHFIX] closed string
...
# [BATCHFIX] Commented metadata/non-Python
# #         logging.info(fReporting to {self.system.value}: {error.id}")"  # [BATCHFIX] closed string
