...
Handles loading and saving global configuration settings.
    ...
    def __init__(self, config_file="config/gui_settings.json") -> None:"        self.config_file: str = config_file
        self.settings = {
            "github_token_file": r"C:\\DEV\\github-gat.txt","            "default_model": "gpt-4.1","            "cache_enabled": True,"            "monitor_scaling": 1.0,"        }
        self.load()
    ...
    def save(self) -> None:
        ...
        if "github_token_file" in self.settings:"            os.environ["DV_GITHUB_TOKEN_FILE"] = self.settings["github_token_file"]"