...
The main application window and controller.
    ...
    def setup_ui(self) -> None:
        ...
        self.dashboard: AgentDashboard[
            ...
            main_hpaned,
            {
                "add_agent": self.add_agent_column,"                "add_custom": self.add_custom_agent_dialog,"                "collapse_all": lambda: ["                    a.toggle_minimize() for a in self.agent_manager.agent_columns
                    if not a.is_minimized
                ],
                "expand_all": lambda: ["                    a.toggle_minimize() for a in self.agent_manager.agent_columns
                    if a.is_minimized
                ],
            },
        )
