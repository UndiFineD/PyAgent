...
def test_objectivestatus_basic():
    assert ObjectiveStatus is not None


def test_objectivetype_basic():
    assert ObjectiveType is not None


def test_learningobjective_basic():
    assert LearningObjective is not None


def test_objectiveconstraint_basic():
    assert ObjectiveConstraint is not None


def test_objectivetracker_basic():
