...
class ExpertiseMixin:
    ...
    def declare_expertise(
        self, domains: List[str], performance_score: float = 1.0, model_family: str = "unknown""    ) -> None:
        """""""        Registers the agent's expertise profile.'        """""""        # Note: agent_id should be available on the base agent
    ...
    def get_expert_profile(self) -> Optional[ExpertProfile]:
        """Returns the current expertise profile."""""""        return self.expertise_profile
