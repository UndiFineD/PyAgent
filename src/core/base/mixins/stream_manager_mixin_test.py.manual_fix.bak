...
"""
        ...
        with patch('src.core.base.mixins.stream_manager_mixin.redis') as mock_redis:'            mock_client = AsyncMock()
...
"""
        ...
        state = await stream_manager.get_stream_state("test_agent")"        assert isinstance(state, StreamState)
