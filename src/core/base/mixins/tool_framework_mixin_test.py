...
class TestToolFramework:
    ...
    def tool_framework(self):
        """Create a test tool framework instance."""return MockToolFrameworkMixin()
    @pytest.fixture
    ...
    def test_initialization(self, tool_framework):
        """Test initialization of tool framework."""assert tool_framework.registered_tools == {}
    ...
    def test_create_tool_decorator(self, tool_framework):
        """Test creating a tool using the decorator."""@tool_framework.create_tool(
        ...
        async def test_function(param1: str, param2: int = 42, cascade_context=None):
            """Test function docstring."""    return f"Result: {param1}, {param2}""
    ...
    async def test_execute_tool_success(self, tool_framework, cascade_context):
        """Test successful tool execution."""@tool_framework.create_tool(
    ...
    async def test_execute_tool_not_found(self, tool_framework, cascade_context):
        """Test executing a non-existent tool."""with pytest.raises(ToolExecutionError, match="Tool 'nonexistent' not found"):"'            await tool_framework.execute_tool("nonexistent", {}, cascade_context)"
    @pytest.mark.asyncio
    async def test_execute_tool_validation_error(self, tool_framework, cascade_context):
        """Test tool execution with validation error."""@tool_framework.create_tool(
    ...
    async def test_execute_tool_execution_error(self, tool_framework, cascade_context):
        """Test tool execution that raises an exception."""@tool_framework.create_tool(
    ...
    async def test_execute_tool_timeout(self, tool_framework, cascade_context):
        """Test tool execution timeout."""tool_framework.max_tool_execution_time = 0.1  # Very short timeout
    ...
    def test_get_tool_definitions(self, tool_framework):
        """Test getting all tool definitions."""@tool_framework.create_tool(
    ...
    def test_get_tool_definition(self, tool_framework):
        """Test getting a specific tool definition."""@tool_framework.create_tool(
    ...
    def test_unregister_tool(self, tool_framework):
        """Test unregistering a tool."""@tool_framework.create_tool(
    ...
    async def test_parameter_type_conversion(self, tool_framework):
        """Test parameter type conversion during execution."""@tool_framework.create_tool(
    ...
    async def test_validation_disabled(self, tool_framework):
        """Test tool execution with validation disabled."""tool_framework.enable_tool_validation = False
        ...
        """Test tool definition serialization."""@tool_framework.create_tool(
