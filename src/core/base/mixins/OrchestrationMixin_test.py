...
try:
    from core.base.mixins.OrchestrationMixin import *
...
def test_orchestrationmixin_instantiation():
    """Test that OrchestrationMixin can be instantiated."""
    instance = OrchestrationMixin()
