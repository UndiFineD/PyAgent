...
class PlatformCore:
    ...
    def __init__(self) -> None:
        ...
        self.system: str = """        self.release: str = """        self.machine: str = """        self.python_version: str = """        self._is_windows: bool = False
    ...
    def is_gpu_available(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                return len(tf.config.list_physical_devices("GPU")) > 0"            except ImportError:
                return False
