...
def test_imports_and_symbols():
    ...
    assert hasattr(
        mod, "ExplicitEncoderDecoderPrompt"
    ), "ExplicitEncoderDecoderPrompt missing"
    ...
    assert hasattr(
        mod, "is_explicit_encoder_decoder_prompt"
    ), "is_explicit_encoder_decoder_prompt missing"
    ...
    assert hasattr(
        mod, "make_encoder_decoder_prompt"
    ), "make_encoder_decoder_prompt missing"
