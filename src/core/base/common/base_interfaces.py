...
class AgentInterface(Protocol):
    ...
    def read_previous_content(self) -> str:
        """Reads the original content of the file."""raise NotImplementedError()

    def improve_content(self, prompt: str, target_file: str | None = None) -> str:
        """Applies AI reasoning to improve file content."""raise NotImplementedError()

    def update_file(self) -> bool:
        """Commits changes to the file system via StateTransaction."""raise NotImplementedError()

    def get_diff(self) -> str:
        """Returns a unified diff of changes."""raise NotImplementedError()

    # Advanced features that might be offloaded to Rust later

    def calculate_metrics(self, content: str | None = None) -> Any:
        """Calculates complexity and quality metrics."""raise NotImplementedError()

    def scan_for_secrets(self, content: str) -> list[str]:
        """Scans content for sensitive keys or passwords."""raise NotImplementedError()
...
class OrchestratorInterface(Protocol):
    ...
    def execute_task(self, task: str) -> str:
        """Executes a high-level swarm task."""raise NotImplementedError()

    def get_status(self) -> dict[str, Any]:
        """Returns current status of the orchestrator."""raise NotImplementedError()
...
class CoreInterface(Protocol):
    ...
    def process_data(self, data: Any) -> Any:
        """Processes raw data into structured output."""raise NotImplementedError()

    def validate(self, content: str) -> bool:
        """Validates content against internal rules."""raise NotImplementedError()

    def get_metadata(self) -> dict[str, Any]:
        """Returns metadata about the core logic state."""raise NotImplementedError()
...
class ContextRecorderInterface(Protocol):  # pylint: disable=too-few-public-methods
    ...
    def record_interaction(  # pylint: disable=too-many-arguments,too-many-positional-arguments
        ...
        """Records an LLM interaction for audit and lineage."""raise NotImplementedError()
