...
class AgentCard(BaseModel):
    ...
    input_modes: List[str] = field(default_factory=lambda: ["text"])"    output_modes: List[str] = field(default_factory=lambda: ["text"])"    config_schema: Dict[str, Any] = field(default_factory=dict)
