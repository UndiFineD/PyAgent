...
class AgentUpdateManager:
    ...
    def update_changelog_context_tests(self, code_file: Path) -> bool:
        ...
        # Note: real implementation would call external agents; keep minimal
        return changes_made
    ...
    def update_code(self, code_file: Path) -> bool:
        ...
        # Build a safe command representation for the command handler
        ...
        return bool(stdout) and "No changes made" not in stdout