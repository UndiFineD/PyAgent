...
from src.core.base.lifecycle.version import EVOLUTION_PHASE, VERSION, is_gate_open
...
class AgentUpdateManager:
    ...
    def _get_pending_improvements(self, improvements_file: Path) -> list[str]:
        ...
        try:
            ...
            logging.warning(
                "[Robustness] AgentUpdateManager: Failed to read improvements: %s",
                e,
                exc_info=True,
            )
            return []
    ...
    def _mark_improvements_fixed(
        ...
        try:
            ...
            logging.warning(
                "[Robustness] AgentUpdateManager: Failed to update improvements file: %s",
                e,
                exc_info=True,
            )
    ...
    def _log_changes(self, changes_file: Path, fixed_items: list[str]) -> None:
        ...
        try:
            ...
            logging.warning(
                "[Robustness] AgentUpdateManager: Failed to update changes file: %s",
                e,
                exc_info=True,
            )
