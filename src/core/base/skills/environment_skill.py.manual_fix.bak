...
if not self.agent.manifest.permissions.get("fs_write", False):"            logger.warning("Security: FS Write permission denied for role '%s'", self.agent.manifest.role)"'            return False
