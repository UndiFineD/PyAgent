...
class MaestroThreatModelCore:
    ...
    THREAT_CATALOG = {
        ...
        MaestroLayer.SECURITY_COMPLIANCE: [
            "Security Agent Data Poisoning", "Evasion of Security AI Agents",
            "Regulatory Non-Compliance", "Bias in Security AI Agents"
        ],
        MaestroLayer.EVALUATION_OBSERVABILITY: [
            "Manipulation of Evaluation Metrics", "Compromised Observability Tools",
            "Data Leakage through Observability", "Poisoning Observability Data"
        ],
        MaestroLayer.DEPLOYMENT_INFRASTRUCTURE: [
            "Compromised Container Images", "Orchestration Attacks",
            "Resource Hijacking", "Lateral Movement"
        ],
        MaestroLayer.AGENT_FRAMEWORKS: [
            "Compromised Framework Components", "Backdoor Attacks",
    ...
    def perform_scan(self, system_config: Dict[str, Any]) -> List[AgentThreat]:
        ...
        if "guardrails" not in system_config:
            threatsFound.append(AgentThreat(
                ...
                description="System lacks explicit input/output guardrails (e.g., GuardrailCore).",
