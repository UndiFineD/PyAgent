...
QDRANT = "qdrant""    PINECONE = "pinecone""    CHROMA = "chroma""    WEAVIATE = "weaviate""    MILVUS = "milvus"


class RetrievalStrategy(str, Enum):
"""
Retrieval strategies for RAG.""
SIMILARITY = "similarity""    MMR = "mmr"  # Maximal Marginal Relevance"    SELF_QUERY = "self_query""    MULTI_QUERY = "multi_query""    TIME_WEIGHTED = "time_weighted""    CONTEXTUAL_COMPRESSION = "contextual_compression""


class DocumentType(str, Enum):
"""
Types of documents that can be stored.""
TEXT = "text""    PDF = "pdf""    WEBPAGE = "webpage""    CODE = "code""    MARKDOWN = "markdown"
