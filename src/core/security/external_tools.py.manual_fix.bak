...
HIGH = "high""    MEDIUM = "medium""    LOW = "low""    TRUSTED = "trusted""


class ThreatCategory(Enum):
"""
Categories of security threats.""
MALWARE = "malware""    DATA_EXFILTRATION = "data_exfiltration""    CODE_INJECTION = "code_injection""    PRIVILEGE_ESCALATION = "privilege_escalation""    DENIAL_OF_SERVICE = "denial_of_service"
...
class ToolSignature:
"""
Digital signature for tool verification.""
tool_name: str
    version: str
    hash_sha256: str
...
"""
Check if tool name contains suspicious patterns.""
suspicious_patterns = [
...
"""
Register a tool signature for verification.""
self._tool_signatures[signature.tool_name] = signature
...
"""
Calculate threat severity based on category and match count.""
base_severity = {
...
"""
Check for policy violations in execution result.""
violations = []
