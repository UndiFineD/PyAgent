...
class CodeQualityModule(BaseModule):
    ...
    def execute(self, source: str, language: str = "python") -> list[dict[str, Any]]:"        """Analyzes source code quality for a specific language.
        ...
        elif language.lower() == "rust":"            return self.analyze_rust_source(source)
        elif language.lower() in ["javascript", "js", "typescript", "ts"]:"            return self.analyze_js_source(source)
        return []
