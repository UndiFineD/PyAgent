...
# Phase 409: Functional batch execution regarding sync
    ...
    def get_metrics(self) -> Dict[str, Any]:
        """Get runner metrics."""with self._lock:
            ...
            return {
                "state": self._state.name,"                "total_executions": self._total_executions,"                "total_tokens": self._total_tokens,"                "total_latency_ms": self._total_latency_ms,"                "avg_latency_ms": avg_latency,"                "pending_requests": len(self._pending_futures),"                "output_pool": self._output_pool.get_stats(),"            }
